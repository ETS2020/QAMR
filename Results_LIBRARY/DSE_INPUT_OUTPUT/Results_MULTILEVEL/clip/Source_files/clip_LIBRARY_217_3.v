...
module FAU ( 
  ...
  aoi21  g56(.a(x7), .b(new_n37_), .c(x2), .O(new_n71_));
  aoi21  g57(.a(new_n71_), .b(x1), .c(new_n38_), .O(new_n72_));
  inv1   g58(.a(new_n72_), .O(new_n73_));
  nand2  g59(.a(new_n73_), .b(new_n64_), .O(new_n74_));
  nand3  g60(.a(new_n74_), .b(new_n70_), .c(new_n15_), .O(new_n75_));
  nand2  g61(.a(new_n75_), .b(x6), .O(new_n76_));
  nand3  g62(.a(new_n58_), .b(new_n37_), .c(new_n17_), .O(new_n77_));
  nand3  g63(.a(new_n77_), .b(new_n76_), .c(new_n67_), .O(z2));
  nand2  g64(.a(new_n63_), .b(new_n52_), .O(new_n79_));
  aoi21  g65(.a(new_n79_), .b(new_n29_), .c(x0), .O(new_n80_));
  inv1   g66(.a(x0), .O(new_n81_));
  nand3  g67(.a(new_n47_), .b(new_n29_), .c(new_n25_), .O(new_n82_));
  inv1   g68(.a(x3), .O(new_n83_));
  oai21  g69(.a(new_n23_), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  nand3  g70(.a(new_n54_), .b(new_n35_), .c(new_n37_), .O(new_n85_));
  nand3  g71(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(new_n86_));
  inv1   g72(.a(new_n86_), .O(new_n87_));
  aoi21  g73(.a(new_n87_), .b(x5), .c(new_n81_), .O(new_n88_));
  oai21  g74(.a(new_n88_), .b(new_n80_), .c(new_n16_), .O(new_n89_));
  oai21  g75(.a(new_n72_), .b(new_n55_), .c(new_n57_), .O(new_n90_));
  nand2  g76(.a(new_n90_), .b(new_n81_), .O(new_n91_));
  nand2  g77(.a(new_n91_), .b(new_n15_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(x6), .O(new_n93_));
  inv1   g79(.a(new_n38_), .O(new_n94_));
  nand3  g80(.a(new_n57_), .b(new_n94_), .c(new_n20_), .O(new_n95_));
  oai21  g81(.a(new_n36_), .b(x8), .c(new_n83_), .O(new_n96_));
  nand3  g82(.a(x8), .b(x7), .c(new_n37_), .O(new_n97_));
  nand3  g83(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand3  g84(.a(new_n98_), .b(new_n15_), .c(x0), .O(new_n99_));
  nand3  g85(.a(new_n99_), .b(new_n93_), .c(new_n89_), .O(z3));
  nand3  g86(.a(new_n90_), .b(x6), .c(new_n15_), .O(new_n101_));
  nand2  g87(.a(new_n16_), .b(x5), .O(new_n102_));
  nand2  g88(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g89(.a(new_n103_), .b(new_n81_), .O(new_n104_));
  nand4  g90(.a(new_n86_), .b(new_n16_), .c(x5), .d(x0), .O(new_n105_));
