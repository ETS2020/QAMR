...
module FAU ( 
  ...
  nand4  g085(.a(new_n99_), .b(new_n97_), .c(new_n89_), .d(new_n73_), .O(z2));
  nand2  g086(.a(new_n92_), .b(x7), .O(new_n101_));
  aoi21  g087(.a(new_n101_), .b(new_n70_), .c(new_n33_), .O(new_n102_));
  nand2  g088(.a(new_n42_), .b(new_n15_), .O(new_n103_));
  aoi21  g089(.a(new_n103_), .b(x3), .c(new_n20_), .O(new_n104_));
  ...
  nand3  g093(.a(new_n91_), .b(new_n46_), .c(x8), .O(new_n108_));
  ...
  nand2  g097(.a(new_n85_), .b(new_n46_), .O(new_n112_));
  nand3  g098(.a(new_n112_), .b(new_n20_), .c(new_n28_), .O(new_n113_));
  nand3  g099(.a(new_n113_), .b(new_n111_), .c(new_n105_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(x0), .O(new_n115_));
  nand3  g101(.a(new_n46_), .b(x2), .c(x1), .O(new_n116_));
  aoi22  g102(.a(new_n116_), .b(new_n45_), .c(new_n20_), .d(new_n32_), .O(new_n117_));
  ...
  nand3  g106(.a(new_n54_), .b(new_n17_), .c(x1), .O(new_n121_));
  aoi21  g107(.a(new_n121_), .b(new_n36_), .c(new_n21_), .O(new_n122_));
  oai21  g108(.a(new_n122_), .b(new_n33_), .c(new_n26_), .O(new_n123_));
  nand2  g109(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand2  g110(.a(new_n124_), .b(new_n48_), .O(new_n125_));
  nand3  g111(.a(new_n125_), .b(new_n115_), .c(new_n99_), .O(z3));
  nand2  g112(.a(new_n34_), .b(new_n26_), .O(new_n127_));
  oai21  g113(.a(new_n127_), .b(new_n122_), .c(new_n48_), .O(new_n128_));
  nand3  g114(.a(new_n118_), .b(new_n58_), .c(new_n45_), .O(new_n129_));
  ...
  nand3  g120(.a(new_n134_), .b(new_n128_), .c(new_n99_), .O(z4));
endmodule
