...
module FAU ( 
  ...
  aoi21  g050(.a(new_n64_), .b(new_n43_), .c(x0), .O(new_n65_));
  nand2  g051(.a(new_n29_), .b(x0), .O(new_n66_));
  aoi21  g052(.a(new_n66_), .b(new_n43_), .c(new_n25_), .O(new_n67_));
  oai22  g053(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(new_n62_), .O(new_n68_));
  nand3  g054(.a(new_n35_), .b(new_n15_), .c(x1), .O(new_n69_));
  nand2  g055(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  nand2  g056(.a(x8), .b(x3), .O(new_n71_));
  nand2  g057(.a(new_n20_), .b(new_n28_), .O(new_n72_));
  ...
  oai21  g061(.a(new_n29_), .b(new_n21_), .c(new_n15_), .O(new_n76_));
  nand2  g062(.a(new_n29_), .b(new_n49_), .O(new_n77_));
  nand2  g063(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g064(.a(new_n78_), .b(new_n40_), .O(new_n79_));
  nand2  g065(.a(x4), .b(x1), .O(new_n80_));
  nand3  g066(.a(new_n80_), .b(x8), .c(new_n28_), .O(new_n81_));
  ...
  oai21  g071(.a(new_n85_), .b(new_n49_), .c(new_n40_), .O(new_n86_));
  nand2  g072(.a(new_n86_), .b(new_n73_), .O(new_n87_));
  nand3  g073(.a(new_n87_), .b(new_n84_), .c(new_n79_), .O(new_n88_));
  nand3  g074(.a(new_n88_), .b(new_n59_), .c(new_n19_), .O(new_n89_));
  nand3  g075(.a(new_n89_), .b(new_n75_), .c(new_n68_), .O(z2));
  nand2  g076(.a(new_n80_), .b(x7), .O(new_n91_));
  aoi21  g077(.a(new_n91_), .b(new_n33_), .c(new_n29_), .O(new_n92_));
  nand2  g078(.a(new_n34_), .b(new_n49_), .O(new_n93_));
  aoi21  g079(.a(new_n93_), .b(x3), .c(new_n20_), .O(new_n94_));
  oai21  g080(.a(new_n94_), .b(new_n92_), .c(x6), .O(new_n95_));
  oai21  g081(.a(x7), .b(x6), .c(x4), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(new_n49_), .O(new_n97_));
  aoi21  g083(.a(x7), .b(x4), .c(x2), .O(new_n98_));
  nand2  g084(.a(new_n41_), .b(x8), .O(new_n99_));
  oai21  g085(.a(new_n99_), .b(new_n98_), .c(new_n19_), .O(new_n100_));
  nand2  g086(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n28_), .O(new_n102_));
  oai21  g088(.a(new_n15_), .b(new_n49_), .c(new_n40_), .O(new_n103_));
  nand2  g089(.a(new_n103_), .b(new_n41_), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n20_), .c(new_n19_), .O(new_n105_));
  nand3  g091(.a(new_n105_), .b(new_n102_), .c(new_n95_), .O(new_n106_));
  nand3  g092(.a(new_n106_), .b(x5), .c(x0), .O(new_n107_));
  nand2  g093(.a(new_n86_), .b(new_n72_), .O(new_n108_));
  nand2  g094(.a(new_n108_), .b(new_n71_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(new_n19_), .O(new_n110_));
  aoi21  g096(.a(new_n69_), .b(new_n32_), .c(new_n21_), .O(new_n111_));
  ...
  nand2  g101(.a(x5), .b(new_n24_), .O(new_n116_));
  nand2  g102(.a(new_n30_), .b(new_n24_), .O(new_n117_));
  oai21  g103(.a(new_n117_), .b(new_n111_), .c(x6), .O(new_n118_));
  nand3  g104(.a(new_n105_), .b(new_n102_), .c(x5), .O(new_n119_));
  nand2  g105(.a(new_n119_), .b(x0), .O(new_n120_));
  nand3  g106(.a(new_n120_), .b(new_n118_), .c(new_n116_), .O(z4));
endmodule
