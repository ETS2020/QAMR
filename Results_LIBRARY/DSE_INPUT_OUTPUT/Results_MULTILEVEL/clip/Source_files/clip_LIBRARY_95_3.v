...
module FAU ( 
  ...
  oai21  g055(.a(new_n27_), .b(new_n26_), .c(new_n69_), .O(new_n70_));
  ...
  nor2   g059(.a(new_n27_), .b(x6), .O(new_n74_));
  oai21  g060(.a(new_n74_), .b(new_n73_), .c(new_n16_), .O(new_n75_));
  nand2  g061(.a(x7), .b(new_n38_), .O(new_n76_));
  nand3  g062(.a(new_n76_), .b(new_n75_), .c(new_n71_), .O(new_n77_));
  nand2  g063(.a(new_n77_), .b(new_n15_), .O(new_n78_));
  nand4  g064(.a(new_n78_), .b(new_n67_), .c(new_n56_), .d(new_n44_), .O(z1));
  nor2   g065(.a(new_n22_), .b(x3), .O(new_n80_));
  inv1   g066(.a(new_n80_), .O(new_n81_));
  nand2  g067(.a(new_n22_), .b(x3), .O(new_n82_));
  nand2  g068(.a(new_n27_), .b(x4), .O(new_n83_));
  nand2  g069(.a(new_n83_), .b(x2), .O(new_n84_));
  nand2  g070(.a(x4), .b(x1), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(x7), .O(new_n86_));
  aoi22  g072(.a(new_n86_), .b(new_n84_), .c(new_n82_), .d(new_n81_), .O(new_n87_));
  nand3  g073(.a(new_n49_), .b(new_n16_), .c(x1), .O(new_n88_));
  nand2  g074(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  inv1   g075(.a(new_n89_), .O(new_n90_));
  nand3  g076(.a(new_n21_), .b(new_n22_), .c(new_n32_), .O(new_n91_));
  aoi21  g077(.a(new_n91_), .b(new_n35_), .c(new_n90_), .O(new_n92_));
  oai21  g078(.a(new_n92_), .b(new_n87_), .c(x6), .O(new_n93_));
  nand2  g079(.a(new_n33_), .b(x0), .O(new_n94_));
  nand2  g080(.a(new_n82_), .b(new_n81_), .O(new_n95_));
  ...
  nand3  g084(.a(new_n28_), .b(x2), .c(x1), .O(new_n99_));
  nand2  g085(.a(new_n99_), .b(new_n30_), .O(new_n100_));
  nand2  g086(.a(new_n22_), .b(new_n32_), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n35_), .O(new_n102_));
  nand2  g088(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand3  g089(.a(new_n103_), .b(new_n98_), .c(new_n94_), .O(new_n104_));
  nand2  g090(.a(new_n104_), .b(new_n26_), .O(new_n105_));
  aoi21  g091(.a(new_n82_), .b(new_n81_), .c(x4), .O(new_n106_));
  aoi21  g092(.a(new_n106_), .b(new_n38_), .c(new_n40_), .O(new_n107_));
  nand3  g093(.a(new_n107_), .b(new_n105_), .c(new_n93_), .O(z2));
  oai21  g094(.a(x8), .b(x5), .c(new_n32_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(new_n89_), .O(new_n110_));
  aoi21  g096(.a(new_n110_), .b(new_n82_), .c(new_n26_), .O(new_n111_));
  nand2  g097(.a(new_n101_), .b(new_n100_), .O(new_n112_));
  aoi21  g098(.a(new_n112_), .b(new_n35_), .c(x6), .O(new_n113_));
  oai21  g099(.a(new_n113_), .b(new_n111_), .c(new_n20_), .O(new_n114_));
  aoi21  g100(.a(new_n85_), .b(x7), .c(x8), .O(new_n115_));
  aoi21  g101(.a(new_n115_), .b(new_n84_), .c(new_n26_), .O(new_n116_));
  oai21  g102(.a(new_n68_), .b(new_n15_), .c(new_n38_), .O(new_n117_));
  oai21  g103(.a(x7), .b(x4), .c(x8), .O(new_n118_));
  oai21  g104(.a(new_n118_), .b(new_n96_), .c(new_n26_), .O(new_n119_));
  nand2  g105(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  oai21  g106(.a(new_n120_), .b(new_n116_), .c(x5), .O(new_n121_));
  nand2  g107(.a(x7), .b(new_n39_), .O(new_n122_));
  aoi21  g108(.a(new_n122_), .b(x4), .c(x1), .O(new_n123_));
  aoi21  g109(.a(new_n84_), .b(new_n49_), .c(x5), .O(new_n124_));
  oai21  g110(.a(new_n124_), .b(new_n123_), .c(new_n82_), .O(new_n125_));
  oai21  g111(.a(new_n80_), .b(new_n26_), .c(new_n39_), .O(new_n126_));
  nand3  g112(.a(new_n126_), .b(new_n125_), .c(new_n121_), .O(new_n127_));
  nand2  g113(.a(new_n127_), .b(x0), .O(new_n128_));
  nand3  g114(.a(new_n128_), .b(new_n114_), .c(new_n44_), .O(z3));
  nor2   g115(.a(x6), .b(x3), .O(new_n130_));
  nand4  g116(.a(new_n130_), .b(new_n119_), .c(new_n117_), .d(x0), .O(new_n131_));
  nand2  g117(.a(new_n131_), .b(x5), .O(new_n132_));
  oai21  g118(.a(new_n90_), .b(new_n80_), .c(new_n82_), .O(new_n133_));
  nand3  g119(.a(new_n133_), .b(x6), .c(new_n20_), .O(new_n134_));
