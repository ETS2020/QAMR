...
module FAU ( 
  ...
  nand4  g18(.a(new_n32_), .b(new_n19_), .c(new_n18_), .d(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n17_), .O(z0));
  nand2  g20(.a(x7), .b(new_n21_), .O(new_n35_));
  nand2  g21(.a(new_n22_), .b(x4), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  inv1   g23(.a(x2), .O(new_n38_));
  nand3  g24(.a(new_n29_), .b(new_n18_), .c(x0), .O(new_n39_));
  aoi21  g25(.a(new_n39_), .b(new_n19_), .c(new_n38_), .O(new_n40_));
  oai21  g26(.a(new_n19_), .b(x5), .c(new_n38_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x1), .O(new_n42_));
  oai21  g28(.a(new_n42_), .b(new_n40_), .c(new_n37_), .O(new_n43_));
  nand2  g29(.a(new_n25_), .b(new_n23_), .O(new_n44_));
  xnor2a g30(.a(x6), .b(x2), .O(new_n45_));
  oai21  g31(.a(new_n45_), .b(new_n20_), .c(new_n15_), .O(new_n46_));
  nand2  g32(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand3  g33(.a(x8), .b(new_n22_), .c(new_n21_), .O(new_n48_));
  nand2  g34(.a(new_n48_), .b(new_n25_), .O(new_n49_));
  ...
  nand3  g47(.a(new_n23_), .b(x2), .c(x1), .O(new_n62_));
  nand2  g48(.a(new_n62_), .b(new_n25_), .O(new_n63_));
  nand2  g49(.a(new_n31_), .b(new_n29_), .O(new_n64_));
  ...
  nand2  g53(.a(new_n36_), .b(x2), .O(new_n68_));
  oai21  g54(.a(new_n21_), .b(new_n20_), .c(x7), .O(new_n69_));
  nand2  g55(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g56(.a(new_n70_), .b(new_n58_), .O(new_n71_));
  nand3  g57(.a(new_n35_), .b(new_n38_), .c(x1), .O(new_n72_));
  ...
  nand3  g62(.a(new_n58_), .b(new_n21_), .c(new_n20_), .O(new_n77_));
  nand3  g63(.a(new_n77_), .b(new_n76_), .c(new_n67_), .O(z2));
  aoi21  g64(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(new_n79_));
  aoi21  g65(.a(new_n21_), .b(new_n20_), .c(new_n27_), .O(new_n80_));
  oai21  g66(.a(new_n80_), .b(new_n28_), .c(x6), .O(new_n81_));
  oai21  g67(.a(new_n81_), .b(new_n79_), .c(new_n18_), .O(new_n82_));
  aoi21  g68(.a(new_n22_), .b(x5), .c(new_n21_), .O(new_n83_));
  ...
  nand2  g74(.a(new_n88_), .b(new_n25_), .O(new_n89_));
  nand2  g75(.a(new_n89_), .b(new_n23_), .O(new_n90_));
  nand3  g76(.a(new_n90_), .b(new_n28_), .c(x5), .O(new_n91_));
  nand3  g77(.a(new_n91_), .b(new_n87_), .c(new_n82_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(x0), .O(new_n93_));
  inv1   g79(.a(x0), .O(new_n94_));
  nand2  g80(.a(new_n63_), .b(new_n29_), .O(new_n95_));
  aoi21  g81(.a(new_n95_), .b(new_n31_), .c(x6), .O(new_n96_));
  nand2  g82(.a(new_n73_), .b(new_n55_), .O(new_n97_));
  aoi21  g83(.a(new_n97_), .b(new_n57_), .c(new_n19_), .O(new_n98_));
  oai21  g84(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(new_n99_));
  nand3  g85(.a(new_n99_), .b(new_n93_), .c(new_n15_), .O(z3));
  oai21  g86(.a(new_n98_), .b(x5), .c(new_n94_), .O(new_n101_));
  nand3  g87(.a(new_n88_), .b(new_n31_), .c(new_n25_), .O(new_n102_));
  nand2  g88(.a(new_n84_), .b(new_n27_), .O(new_n103_));
  nand3  g89(.a(new_n28_), .b(new_n22_), .c(new_n21_), .O(new_n104_));
  nand3  g90(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(new_n105_));
  nand2  g91(.a(new_n105_), .b(x0), .O(new_n106_));
  nand2  g92(.a(new_n106_), .b(new_n19_), .O(new_n107_));
