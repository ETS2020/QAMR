...
module FAU ( 
  ...
  nand3  g68(.a(x8), .b(x7), .c(new_n37_), .O(new_n83_));
  ...
  nand2  g73(.a(new_n31_), .b(new_n15_), .O(new_n88_));
  aoi21  g74(.a(new_n63_), .b(new_n51_), .c(new_n88_), .O(new_n89_));
  nand2  g75(.a(x2), .b(x1), .O(new_n90_));
  nand3  g76(.a(new_n90_), .b(new_n31_), .c(new_n27_), .O(new_n91_));
  oai21  g77(.a(new_n25_), .b(new_n53_), .c(new_n55_), .O(new_n92_));
  nand3  g78(.a(new_n53_), .b(new_n35_), .c(new_n37_), .O(new_n93_));
  nand3  g79(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n94_));
  nand3  g80(.a(new_n94_), .b(x5), .c(x0), .O(new_n95_));
  oai21  g81(.a(new_n89_), .b(x5), .c(new_n95_), .O(new_n96_));
  nand2  g82(.a(new_n96_), .b(new_n24_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(new_n87_), .O(z3));
  aoi21  g84(.a(new_n79_), .b(x6), .c(x5), .O(new_n99_));
  aoi21  g85(.a(new_n94_), .b(x0), .c(x6), .O(new_n100_));
  oai22  g86(.a(new_n100_), .b(new_n23_), .c(new_n99_), .d(x0), .O(z4));
endmodule
