...
module FAU ( 
  ...
  aoi22  g027(.a(new_n41_), .b(new_n37_), .c(new_n31_), .d(x3), .O(new_n42_));
  ...
  nand2  g036(.a(x6), .b(new_n25_), .O(new_n51_));
  nand2  g037(.a(new_n30_), .b(x2), .O(new_n52_));
  ...
  nand3  g041(.a(new_n55_), .b(new_n30_), .c(x0), .O(new_n56_));
  nand3  g042(.a(new_n56_), .b(new_n54_), .c(new_n48_), .O(new_n57_));
  nand2  g043(.a(new_n57_), .b(new_n45_), .O(new_n58_));
  inv1   g044(.a(x3), .O(new_n59_));
  nand4  g045(.a(x8), .b(x6), .c(new_n59_), .d(new_n25_), .O(new_n60_));
  nand2  g046(.a(new_n60_), .b(new_n52_), .O(new_n61_));
  nand3  g047(.a(new_n61_), .b(new_n50_), .c(x1), .O(new_n62_));
  nand2  g048(.a(x2), .b(x1), .O(new_n63_));
  nand3  g049(.a(new_n63_), .b(new_n46_), .c(new_n30_), .O(new_n64_));
  oai21  g050(.a(new_n30_), .b(new_n25_), .c(x1), .O(new_n65_));
  nand3  g051(.a(x8), .b(new_n35_), .c(x4), .O(new_n66_));
  aoi21  g052(.a(new_n66_), .b(new_n39_), .c(x3), .O(new_n67_));
  nor3   g053(.a(new_n31_), .b(new_n35_), .c(x4), .O(new_n68_));
  oai21  g054(.a(new_n68_), .b(new_n67_), .c(new_n65_), .O(new_n69_));
  nand3  g055(.a(new_n69_), .b(new_n64_), .c(new_n62_), .O(new_n70_));
  nand2  g056(.a(new_n70_), .b(new_n29_), .O(new_n71_));
  nand2  g057(.a(new_n71_), .b(new_n58_), .O(z1));
  nand2  g058(.a(new_n20_), .b(x0), .O(new_n73_));
  oai21  g059(.a(x7), .b(x4), .c(x2), .O(new_n74_));
  oai21  g060(.a(new_n74_), .b(new_n15_), .c(new_n17_), .O(new_n75_));
  nand3  g061(.a(new_n75_), .b(new_n31_), .c(new_n59_), .O(new_n76_));
  aoi21  g062(.a(new_n76_), .b(new_n73_), .c(x6), .O(new_n77_));
  aoi21  g063(.a(x7), .b(new_n38_), .c(x2), .O(new_n78_));
  nand2  g064(.a(new_n78_), .b(x1), .O(new_n79_));
  nand2  g065(.a(new_n79_), .b(new_n36_), .O(new_n80_));
  nand2  g066(.a(new_n22_), .b(new_n20_), .O(new_n81_));
  nand2  g067(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  xor2a  g068(.a(x8), .b(x3), .O(new_n83_));
  nand3  g069(.a(new_n83_), .b(new_n36_), .c(new_n26_), .O(new_n84_));
  nand3  g070(.a(new_n83_), .b(x7), .c(new_n38_), .O(new_n85_));
  and2   g071(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  aoi21  g072(.a(new_n86_), .b(new_n82_), .c(new_n30_), .O(new_n87_));
  oai21  g073(.a(new_n87_), .b(new_n77_), .c(new_n45_), .O(new_n88_));
  nand2  g074(.a(new_n31_), .b(x3), .O(new_n89_));
  nand2  g075(.a(new_n83_), .b(new_n25_), .O(new_n90_));
  oai21  g076(.a(new_n89_), .b(x1), .c(new_n90_), .O(new_n91_));
  nand2  g077(.a(new_n91_), .b(new_n17_), .O(new_n92_));
  nand2  g078(.a(x4), .b(x1), .O(new_n93_));
  nand3  g079(.a(new_n93_), .b(x8), .c(new_n59_), .O(new_n94_));
  nand3  g080(.a(new_n31_), .b(new_n38_), .c(x3), .O(new_n95_));
  aoi21  g081(.a(new_n95_), .b(new_n94_), .c(x7), .O(new_n96_));
  aoi21  g082(.a(new_n81_), .b(new_n75_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g086(.a(x7), .b(new_n38_), .c(x2), .O(new_n101_));
  aoi21  g087(.a(new_n39_), .b(new_n101_), .c(new_n30_), .O(new_n102_));
  oai21  g088(.a(new_n102_), .b(new_n100_), .c(x8), .O(new_n103_));
  nor2   g089(.a(new_n103_), .b(x3), .O(new_n104_));
  oai21  g090(.a(new_n104_), .b(new_n98_), .c(new_n29_), .O(new_n105_));
  nand2  g091(.a(new_n105_), .b(new_n88_), .O(z2));
  nor2   g092(.a(x7), .b(new_n38_), .O(new_n107_));
  aoi21  g093(.a(new_n78_), .b(x1), .c(new_n107_), .O(new_n108_));
  oai21  g094(.a(new_n108_), .b(new_n32_), .c(new_n89_), .O(new_n109_));
  nand3  g095(.a(new_n109_), .b(x6), .c(new_n29_), .O(new_n110_));
  nand3  g096(.a(new_n36_), .b(new_n89_), .c(new_n26_), .O(new_n111_));
  oai21  g097(.a(new_n40_), .b(x8), .c(new_n59_), .O(new_n112_));
  nor2   g098(.a(new_n68_), .b(new_n30_), .O(new_n113_));
  ...
  nand2  g103(.a(new_n75_), .b(new_n20_), .O(new_n118_));
  nand2  g104(.a(new_n118_), .b(new_n22_), .O(new_n119_));
  nand3  g105(.a(new_n119_), .b(new_n30_), .c(new_n29_), .O(new_n120_));
  nand2  g106(.a(new_n120_), .b(new_n117_), .O(z3));
  nand2  g107(.a(new_n110_), .b(new_n45_), .O(z4));
endmodule
