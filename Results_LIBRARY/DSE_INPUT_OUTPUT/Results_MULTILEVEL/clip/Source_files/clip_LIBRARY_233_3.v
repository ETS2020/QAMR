...
module FAU ( 
  ...
  nand2  g031(.a(x8), .b(new_n21_), .O(new_n46_));
  ...
  nand2  g045(.a(new_n22_), .b(new_n34_), .O(new_n60_));
  nand3  g046(.a(new_n60_), .b(x7), .c(new_n18_), .O(new_n61_));
  nand3  g047(.a(new_n61_), .b(new_n59_), .c(new_n41_), .O(new_n62_));
  nand2  g048(.a(x7), .b(x5), .O(new_n63_));
  nand3  g049(.a(new_n63_), .b(new_n17_), .c(x4), .O(new_n64_));
  oai21  g050(.a(new_n26_), .b(new_n34_), .c(new_n64_), .O(new_n65_));
  nand2  g051(.a(new_n65_), .b(new_n23_), .O(new_n66_));
  oai21  g052(.a(x4), .b(new_n34_), .c(x5), .O(new_n67_));
  nand4  g053(.a(new_n67_), .b(x8), .c(new_n17_), .d(x3), .O(new_n68_));
  nand2  g054(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  aoi22  g055(.a(new_n69_), .b(x0), .c(new_n62_), .d(new_n56_), .O(new_n70_));
  nand4  g056(.a(new_n70_), .b(new_n55_), .c(new_n50_), .d(new_n43_), .O(z1));
  oai21  g057(.a(new_n19_), .b(new_n17_), .c(x4), .O(new_n72_));
  nand2  g058(.a(new_n72_), .b(new_n56_), .O(new_n73_));
  nand3  g059(.a(x7), .b(x6), .c(new_n18_), .O(new_n74_));
  nand2  g060(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g061(.a(x5), .b(new_n15_), .O(new_n76_));
  nand3  g062(.a(new_n76_), .b(new_n22_), .c(x3), .O(new_n77_));
  ...
  oai21  g067(.a(new_n80_), .b(new_n34_), .c(new_n81_), .O(new_n82_));
  nand2  g068(.a(new_n82_), .b(x0), .O(new_n83_));
  nand2  g069(.a(new_n22_), .b(x3), .O(new_n84_));
  oai22  g070(.a(new_n80_), .b(x2), .c(new_n84_), .d(x1), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n44_), .O(new_n86_));
  nand2  g072(.a(x4), .b(x1), .O(new_n87_));
  nand3  g073(.a(new_n87_), .b(x8), .c(new_n21_), .O(new_n88_));
  nand3  g074(.a(new_n22_), .b(new_n18_), .c(x3), .O(new_n89_));
  ...
  aoi22  g080(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(new_n19_), .O(new_n95_));
  ...
  aoi21  g087(.a(x7), .b(new_n18_), .c(x2), .O(new_n102_));
  aoi21  g088(.a(new_n102_), .b(x1), .c(new_n52_), .O(new_n103_));
  nand2  g089(.a(new_n94_), .b(new_n76_), .O(new_n104_));
  ...
  nand4  g093(.a(new_n107_), .b(new_n106_), .c(new_n97_), .d(new_n79_), .O(z2));
  nand2  g094(.a(new_n93_), .b(new_n44_), .O(new_n109_));
  nand4  g095(.a(new_n109_), .b(new_n23_), .c(x5), .d(new_n34_), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(new_n17_), .O(new_n111_));
  nand2  g097(.a(new_n51_), .b(x2), .O(new_n112_));
  nand2  g098(.a(x8), .b(x6), .O(new_n113_));
  nand4  g099(.a(new_n113_), .b(new_n112_), .c(new_n73_), .d(new_n26_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(new_n21_), .O(new_n115_));
  aoi21  g101(.a(x6), .b(new_n56_), .c(x2), .O(new_n116_));
  oai21  g102(.a(new_n116_), .b(new_n52_), .c(new_n74_), .O(new_n117_));
  nand2  g103(.a(new_n117_), .b(x8), .O(new_n118_));
  nand3  g104(.a(new_n118_), .b(new_n115_), .c(new_n111_), .O(new_n119_));
  nand2  g105(.a(new_n119_), .b(x0), .O(new_n120_));
  oai21  g106(.a(x2), .b(new_n56_), .c(x7), .O(new_n121_));
  nand4  g107(.a(new_n121_), .b(new_n46_), .c(x6), .d(new_n16_), .O(new_n122_));
  nand3  g108(.a(new_n23_), .b(x7), .c(new_n17_), .O(new_n123_));
  aoi21  g109(.a(new_n123_), .b(new_n122_), .c(new_n18_), .O(new_n124_));
  nand4  g110(.a(new_n46_), .b(new_n19_), .c(new_n34_), .d(x1), .O(new_n125_));
  ...
  nand3  g116(.a(new_n23_), .b(new_n20_), .c(new_n17_), .O(new_n131_));
  oai21  g117(.a(new_n131_), .b(new_n56_), .c(new_n16_), .O(new_n132_));
  nand2  g118(.a(new_n132_), .b(x2), .O(new_n133_));
  nand3  g119(.a(new_n133_), .b(new_n130_), .c(new_n120_), .O(z3));
  nor2   g120(.a(x2), .b(new_n15_), .O(new_n135_));
  nand4  g121(.a(new_n135_), .b(new_n109_), .c(new_n23_), .d(new_n17_), .O(new_n136_));
  nand2  g122(.a(new_n136_), .b(x5), .O(new_n137_));
  inv1   g123(.a(new_n46_), .O(new_n138_));
  oai21  g124(.a(new_n103_), .b(new_n138_), .c(new_n84_), .O(new_n139_));
