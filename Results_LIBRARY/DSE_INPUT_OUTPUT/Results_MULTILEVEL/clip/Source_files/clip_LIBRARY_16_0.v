...
module FAU ( 
  ...
  aoi21  g038(.a(new_n24_), .b(new_n20_), .c(new_n33_), .O(new_n53_));
  oai21  g039(.a(new_n53_), .b(new_n52_), .c(new_n31_), .O(new_n54_));
  ...
  aoi21  g085(.a(new_n70_), .b(new_n36_), .c(new_n52_), .O(new_n100_));
  nand3  g086(.a(new_n50_), .b(new_n38_), .c(new_n34_), .O(new_n101_));
  oai21  g087(.a(x7), .b(x4), .c(x8), .O(new_n102_));
  nand2  g088(.a(new_n102_), .b(new_n20_), .O(new_n103_));
  nand3  g089(.a(new_n24_), .b(new_n46_), .c(new_n26_), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(new_n105_));
  nand2  g091(.a(new_n105_), .b(x0), .O(new_n106_));
  oai21  g092(.a(new_n100_), .b(x0), .c(new_n106_), .O(new_n107_));
  nor2   g093(.a(x5), .b(new_n19_), .O(new_n108_));
  aoi21  g094(.a(new_n107_), .b(x5), .c(new_n108_), .O(new_n109_));
  nand3  g095(.a(new_n47_), .b(new_n25_), .c(new_n17_), .O(new_n110_));
  oai21  g096(.a(new_n49_), .b(x8), .c(new_n20_), .O(new_n111_));
  nand3  g097(.a(x8), .b(x7), .c(new_n26_), .O(new_n112_));
  nand3  g098(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand3  g099(.a(new_n113_), .b(x6), .c(x0), .O(new_n114_));
  oai21  g100(.a(new_n109_), .b(x6), .c(new_n114_), .O(z3));
  aoi21  g101(.a(new_n105_), .b(x0), .c(x6), .O(new_n116_));
  oai21  g102(.a(new_n116_), .b(new_n31_), .c(x0), .O(z4));
endmodule
