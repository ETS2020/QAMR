...
module FAU ( 
  ...
  nand2  g029(.a(new_n28_), .b(new_n43_), .O(new_n44_));
  xnor2a g030(.a(x6), .b(x2), .O(new_n45_));
  oai21  g031(.a(new_n45_), .b(new_n32_), .c(new_n44_), .O(new_n46_));
  inv1   g032(.a(new_n33_), .O(new_n47_));
  nand2  g033(.a(new_n34_), .b(new_n47_), .O(new_n48_));
  ...
  nand2  g039(.a(new_n36_), .b(new_n47_), .O(new_n54_));
  nand2  g040(.a(new_n54_), .b(new_n38_), .O(new_n55_));
  nand3  g041(.a(new_n55_), .b(new_n50_), .c(new_n31_), .O(new_n56_));
  nand3  g042(.a(new_n56_), .b(new_n53_), .c(new_n46_), .O(new_n57_));
  nand2  g043(.a(new_n57_), .b(x0), .O(new_n58_));
  nand4  g044(.a(x8), .b(x6), .c(new_n20_), .d(new_n15_), .O(new_n59_));
  ...
  nor3   g052(.a(new_n24_), .b(new_n42_), .c(x4), .O(new_n67_));
  ...
  oai21  g058(.a(new_n72_), .b(new_n32_), .c(new_n34_), .O(new_n73_));
  nand3  g059(.a(new_n73_), .b(new_n24_), .c(new_n20_), .O(new_n74_));
  nand2  g060(.a(new_n36_), .b(new_n31_), .O(new_n75_));
  aoi21  g061(.a(new_n75_), .b(new_n74_), .c(x6), .O(new_n76_));
  nand3  g062(.a(new_n28_), .b(new_n15_), .c(x1), .O(new_n77_));
  nand2  g063(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  nand2  g064(.a(new_n38_), .b(new_n36_), .O(new_n79_));
  ...
  nand3  g068(.a(new_n81_), .b(x7), .c(new_n26_), .O(new_n83_));
  and2   g069(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  aoi21  g070(.a(new_n84_), .b(new_n80_), .c(new_n50_), .O(new_n85_));
  oai21  g071(.a(new_n85_), .b(new_n76_), .c(x0), .O(new_n86_));
  nand2  g072(.a(new_n81_), .b(new_n15_), .O(new_n87_));
  oai21  g073(.a(new_n25_), .b(x1), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g077(.a(new_n24_), .b(new_n26_), .c(x3), .O(new_n92_));
  nand2  g078(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  aoi22  g079(.a(new_n93_), .b(new_n42_), .c(new_n79_), .d(new_n73_), .O(new_n94_));
  ...
  aoi21  g083(.a(new_n28_), .b(new_n27_), .c(new_n50_), .O(new_n98_));
  oai21  g084(.a(new_n98_), .b(new_n97_), .c(x8), .O(new_n99_));
  nor2   g085(.a(new_n99_), .b(x3), .O(new_n100_));
  oai21  g086(.a(new_n100_), .b(new_n95_), .c(x5), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n86_), .O(z2));
  oai21  g088(.a(new_n50_), .b(new_n19_), .c(new_n31_), .O(new_n103_));
  ...
  aoi21  g094(.a(new_n108_), .b(new_n106_), .c(new_n19_), .O(new_n109_));
  nand2  g095(.a(new_n73_), .b(new_n36_), .O(new_n110_));
  aoi21  g096(.a(new_n110_), .b(new_n38_), .c(x0), .O(new_n111_));
  oai21  g097(.a(new_n111_), .b(new_n109_), .c(new_n50_), .O(new_n112_));
  nand3  g098(.a(new_n28_), .b(new_n27_), .c(new_n24_), .O(new_n113_));
  aoi21  g099(.a(new_n113_), .b(x6), .c(new_n97_), .O(new_n114_));
  nor2   g100(.a(new_n114_), .b(x3), .O(new_n115_));
  inv1   g101(.a(new_n28_), .O(new_n116_));
  and2   g102(.a(new_n43_), .b(new_n17_), .O(new_n117_));
  oai21  g103(.a(new_n117_), .b(new_n116_), .c(x8), .O(new_n118_));
  nor2   g104(.a(new_n118_), .b(new_n50_), .O(new_n119_));
  oai21  g105(.a(new_n119_), .b(new_n115_), .c(x0), .O(new_n120_));
  nand3  g106(.a(new_n120_), .b(new_n112_), .c(new_n103_), .O(z3));
  nand3  g107(.a(new_n62_), .b(new_n38_), .c(new_n34_), .O(new_n122_));
  oai21  g108(.a(new_n33_), .b(new_n24_), .c(new_n20_), .O(new_n123_));
  nand3  g109(.a(new_n24_), .b(new_n42_), .c(new_n26_), .O(new_n124_));
  nor2   g110(.a(x6), .b(new_n19_), .O(new_n125_));
  nand4  g111(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  and2   g112(.a(new_n126_), .b(x5), .O(z4));
endmodule
