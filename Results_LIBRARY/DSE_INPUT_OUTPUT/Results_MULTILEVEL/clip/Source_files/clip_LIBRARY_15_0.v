...
module FAU ( 
  ...
  aoi22  g111(.a(x7), .b(x4), .c(x2), .d(x1), .O(new_n126_));
  oai21  g112(.a(new_n126_), .b(new_n83_), .c(new_n21_), .O(new_n127_));
  ...
  oai21  g130(.a(new_n140_), .b(x5), .c(new_n31_), .O(new_n145_));
  oai21  g131(.a(new_n15_), .b(x2), .c(x1), .O(new_n146_));
  nand3  g132(.a(new_n146_), .b(new_n51_), .c(new_n26_), .O(new_n147_));
  nand2  g133(.a(new_n123_), .b(new_n20_), .O(new_n148_));
  nand3  g134(.a(new_n21_), .b(new_n23_), .c(new_n17_), .O(new_n149_));
  nand3  g135(.a(new_n149_), .b(new_n148_), .c(new_n19_), .O(new_n150_));
  aoi21  g136(.a(new_n150_), .b(x5), .c(new_n116_), .O(new_n151_));
  nand3  g137(.a(new_n151_), .b(new_n147_), .c(new_n145_), .O(z4));
endmodule
