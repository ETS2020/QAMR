...
module FAU ( 
  ...
  nand3  g059(.a(new_n23_), .b(x3), .c(new_n32_), .O(new_n74_));
  inv1   g060(.a(new_n74_), .O(new_n75_));
  oai21  g061(.a(new_n75_), .b(new_n73_), .c(new_n34_), .O(new_n76_));
  nand2  g062(.a(x4), .b(x1), .O(new_n77_));
  nand3  g063(.a(new_n77_), .b(x8), .c(new_n19_), .O(new_n78_));
  nand3  g064(.a(new_n23_), .b(new_n28_), .c(x3), .O(new_n79_));
  nand2  g065(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g066(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  nand3  g067(.a(new_n46_), .b(x2), .c(x1), .O(new_n82_));
  nand2  g068(.a(new_n82_), .b(new_n34_), .O(new_n83_));
  nand2  g069(.a(new_n38_), .b(new_n36_), .O(new_n84_));
  nand2  g070(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand4  g071(.a(new_n85_), .b(new_n81_), .c(new_n76_), .d(new_n72_), .O(new_n86_));
  nand2  g072(.a(new_n86_), .b(new_n49_), .O(new_n87_));
  inv1   g073(.a(new_n20_), .O(new_n88_));
  nor2   g074(.a(x8), .b(x5), .O(new_n89_));
  aoi21  g075(.a(new_n89_), .b(x3), .c(new_n88_), .O(new_n90_));
  aoi22  g076(.a(new_n77_), .b(x7), .c(new_n26_), .d(x2), .O(new_n91_));
  aoi21  g077(.a(x7), .b(new_n28_), .c(x2), .O(new_n92_));
  nand2  g078(.a(new_n92_), .b(x1), .O(new_n93_));
  nand2  g079(.a(new_n93_), .b(new_n26_), .O(new_n94_));
  nand3  g080(.a(new_n94_), .b(new_n84_), .c(new_n42_), .O(new_n95_));
  oai21  g081(.a(new_n91_), .b(new_n90_), .c(new_n95_), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(x6), .O(new_n97_));
  nor2   g083(.a(new_n90_), .b(x4), .O(new_n98_));
  aoi22  g084(.a(new_n98_), .b(new_n32_), .c(x5), .d(x0), .O(new_n99_));
  nand3  g085(.a(new_n99_), .b(new_n97_), .c(new_n87_), .O(z2));
  nor2   g086(.a(x7), .b(new_n28_), .O(new_n101_));
  aoi21  g087(.a(new_n92_), .b(x1), .c(new_n101_), .O(new_n102_));
  oai21  g088(.a(new_n102_), .b(new_n88_), .c(new_n24_), .O(new_n103_));
  nand3  g089(.a(new_n103_), .b(x6), .c(new_n58_), .O(new_n104_));
  nand3  g090(.a(new_n26_), .b(new_n24_), .c(new_n17_), .O(new_n105_));
  nand2  g091(.a(new_n29_), .b(new_n23_), .O(new_n106_));
  nand2  g092(.a(new_n106_), .b(new_n19_), .O(new_n107_));
  nor2   g093(.a(new_n67_), .b(new_n49_), .O(new_n108_));
  ...
  nand2  g098(.a(new_n83_), .b(new_n36_), .O(new_n113_));
  ...
  nand2  g102(.a(new_n104_), .b(new_n42_), .O(z4));
endmodule
