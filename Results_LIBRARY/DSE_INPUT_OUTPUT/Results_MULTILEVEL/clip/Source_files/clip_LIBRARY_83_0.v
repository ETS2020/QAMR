...
module FAU ( 
  ...
  aoi22  g026(.a(new_n40_), .b(new_n36_), .c(new_n22_), .d(x3), .O(new_n41_));
  oai21  g027(.a(new_n41_), .b(new_n33_), .c(x5), .O(new_n42_));
  oai21  g028(.a(new_n31_), .b(new_n15_), .c(new_n42_), .O(z0));
  nand2  g029(.a(new_n38_), .b(new_n35_), .O(new_n44_));
  xnor2a g030(.a(x6), .b(x2), .O(new_n45_));
  oai21  g031(.a(new_n45_), .b(new_n17_), .c(new_n44_), .O(new_n46_));
  inv1   g032(.a(new_n18_), .O(new_n47_));
  nand2  g033(.a(new_n19_), .b(new_n47_), .O(new_n48_));
  nand2  g034(.a(x6), .b(new_n28_), .O(new_n49_));
  ...
  nand2  g039(.a(new_n23_), .b(new_n47_), .O(new_n54_));
  nand2  g040(.a(new_n54_), .b(new_n25_), .O(new_n55_));
  nand3  g041(.a(new_n55_), .b(new_n50_), .c(new_n16_), .O(new_n56_));
  nand3  g042(.a(new_n56_), .b(new_n53_), .c(new_n46_), .O(new_n57_));
  nand2  g043(.a(new_n57_), .b(x0), .O(new_n58_));
  nand4  g044(.a(x8), .b(x6), .c(new_n21_), .d(new_n28_), .O(new_n59_));
  ...
  oai21  g049(.a(new_n50_), .b(new_n28_), .c(x1), .O(new_n64_));
  nand3  g050(.a(x8), .b(new_n34_), .c(x4), .O(new_n65_));
  aoi21  g051(.a(new_n65_), .b(new_n38_), .c(x3), .O(new_n66_));
  nor3   g052(.a(new_n22_), .b(new_n34_), .c(x4), .O(new_n67_));
  ...
  oai21  g058(.a(new_n72_), .b(new_n17_), .c(new_n19_), .O(new_n73_));
  nand3  g059(.a(new_n73_), .b(new_n22_), .c(new_n21_), .O(new_n74_));
  nand2  g060(.a(new_n23_), .b(new_n16_), .O(new_n75_));
  aoi21  g061(.a(new_n75_), .b(new_n74_), .c(x6), .O(new_n76_));
  nand3  g062(.a(new_n38_), .b(new_n28_), .c(x1), .O(new_n77_));
  ...
  nand3  g067(.a(new_n81_), .b(new_n35_), .c(new_n29_), .O(new_n82_));
  ...
  nand2  g072(.a(new_n22_), .b(x3), .O(new_n87_));
  nand2  g073(.a(new_n81_), .b(new_n28_), .O(new_n88_));
  ...
  nand3  g078(.a(new_n22_), .b(new_n37_), .c(x3), .O(new_n93_));
  nand2  g079(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  aoi22  g080(.a(new_n94_), .b(new_n34_), .c(new_n79_), .d(new_n73_), .O(new_n95_));
  ...
  aoi21  g085(.a(new_n38_), .b(new_n99_), .c(new_n50_), .O(new_n100_));
  oai21  g086(.a(new_n100_), .b(new_n98_), .c(x8), .O(new_n101_));
  nor2   g087(.a(new_n101_), .b(x3), .O(new_n102_));
  oai21  g088(.a(new_n102_), .b(new_n96_), .c(x5), .O(new_n103_));
  nand2  g089(.a(new_n103_), .b(new_n86_), .O(z2));
  oai21  g090(.a(new_n50_), .b(new_n15_), .c(new_n16_), .O(new_n105_));
  nand2  g091(.a(new_n73_), .b(new_n23_), .O(new_n106_));
  aoi21  g092(.a(new_n106_), .b(new_n25_), .c(x0), .O(new_n107_));
  nand3  g093(.a(new_n62_), .b(new_n25_), .c(new_n19_), .O(new_n108_));
  oai21  g094(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n109_));
  nand3  g095(.a(new_n22_), .b(new_n34_), .c(new_n37_), .O(new_n110_));
  nand3  g096(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(new_n111_));
  nand3  g097(.a(new_n111_), .b(x5), .c(x0), .O(new_n112_));
  inv1   g098(.a(new_n112_), .O(new_n113_));
  oai21  g099(.a(new_n113_), .b(new_n107_), .c(new_n50_), .O(new_n114_));
  inv1   g100(.a(new_n67_), .O(new_n115_));
  nand3  g101(.a(new_n35_), .b(new_n87_), .c(new_n29_), .O(new_n116_));
  oai21  g102(.a(new_n39_), .b(x8), .c(new_n21_), .O(new_n117_));
  nand3  g103(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nand3  g104(.a(new_n118_), .b(x6), .c(x0), .O(new_n119_));
  nand3  g105(.a(new_n119_), .b(new_n114_), .c(new_n105_), .O(z3));
  aoi21  g106(.a(new_n111_), .b(x0), .c(x6), .O(new_n121_));
  oai21  g107(.a(new_n121_), .b(new_n16_), .c(x0), .O(z4));
endmodule
