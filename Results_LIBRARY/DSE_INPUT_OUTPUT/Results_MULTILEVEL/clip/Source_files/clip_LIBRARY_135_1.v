...
module FAU ( 
  ...
  nor2   g017(.a(x8), .b(new_n29_), .O(new_n32_));
  ...
  oai22  g024(.a(new_n38_), .b(new_n25_), .c(new_n36_), .d(x1), .O(new_n39_));
  aoi21  g025(.a(new_n39_), .b(new_n33_), .c(new_n31_), .O(new_n40_));
  nand2  g026(.a(new_n40_), .b(new_n27_), .O(z0));
  nand2  g027(.a(new_n34_), .b(new_n37_), .O(new_n42_));
  ...
  nand2  g031(.a(new_n38_), .b(new_n35_), .O(new_n46_));
  nand2  g032(.a(new_n46_), .b(x2), .O(new_n47_));
  nand2  g033(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g034(.a(new_n48_), .b(x6), .O(new_n49_));
  aoi21  g035(.a(new_n46_), .b(new_n18_), .c(x8), .O(new_n50_));
  nand3  g036(.a(new_n50_), .b(new_n49_), .c(new_n43_), .O(new_n51_));
  nand2  g037(.a(new_n51_), .b(new_n15_), .O(new_n52_));
  oai21  g038(.a(new_n16_), .b(x3), .c(new_n28_), .O(new_n53_));
  nand3  g039(.a(new_n53_), .b(x6), .c(new_n24_), .O(new_n54_));
  oai21  g040(.a(x6), .b(new_n24_), .c(new_n54_), .O(new_n55_));
  nand3  g041(.a(new_n55_), .b(new_n44_), .c(x1), .O(new_n56_));
  oai21  g042(.a(new_n17_), .b(new_n24_), .c(x1), .O(new_n57_));
  ...
  nand3  g050(.a(x8), .b(x7), .c(new_n37_), .O(new_n65_));
  ...
  aoi21  g056(.a(new_n38_), .b(new_n36_), .c(new_n17_), .O(new_n71_));
  oai21  g057(.a(new_n15_), .b(x0), .c(new_n16_), .O(new_n72_));
  nor2   g058(.a(new_n72_), .b(new_n29_), .O(new_n73_));
  ...
  oai21  g063(.a(new_n75_), .b(new_n32_), .c(new_n24_), .O(new_n78_));
  nand2  g064(.a(new_n32_), .b(new_n18_), .O(new_n79_));
  aoi21  g065(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  nand2  g066(.a(x4), .b(x1), .O(new_n81_));
  nand4  g067(.a(new_n81_), .b(x8), .c(x5), .d(new_n29_), .O(new_n82_));
  nand3  g068(.a(new_n16_), .b(new_n37_), .c(x3), .O(new_n83_));
  ...
  oai21  g072(.a(new_n86_), .b(new_n18_), .c(new_n20_), .O(new_n87_));
  ...
  nand3  g079(.a(new_n38_), .b(new_n24_), .c(x1), .O(new_n94_));
  nand2  g080(.a(new_n94_), .b(new_n35_), .O(new_n95_));
  nand2  g081(.a(new_n89_), .b(x0), .O(new_n96_));
  nand3  g082(.a(new_n16_), .b(new_n15_), .c(new_n29_), .O(new_n97_));
  ...
  oai21  g087(.a(new_n101_), .b(new_n32_), .c(new_n87_), .O(new_n102_));
  aoi21  g088(.a(new_n102_), .b(new_n88_), .c(x0), .O(new_n103_));
  oai21  g089(.a(new_n15_), .b(x3), .c(x8), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n59_), .c(new_n20_), .O(new_n105_));
  nand3  g091(.a(new_n34_), .b(x5), .c(new_n37_), .O(new_n106_));
  aoi21  g092(.a(new_n106_), .b(x8), .c(x3), .O(new_n107_));
  aoi21  g093(.a(new_n42_), .b(x5), .c(x8), .O(new_n108_));
  nor2   g094(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  aoi21  g095(.a(new_n109_), .b(new_n105_), .c(new_n28_), .O(new_n110_));
  oai21  g096(.a(new_n110_), .b(new_n103_), .c(new_n17_), .O(new_n111_));
  nand3  g097(.a(new_n94_), .b(new_n35_), .c(new_n29_), .O(new_n112_));
  nand4  g098(.a(new_n112_), .b(new_n16_), .c(new_n15_), .d(new_n28_), .O(new_n113_));
  nand2  g099(.a(new_n35_), .b(new_n25_), .O(new_n114_));
  nand3  g100(.a(new_n114_), .b(new_n38_), .c(x3), .O(new_n115_));
  nand4  g101(.a(new_n115_), .b(x8), .c(x5), .d(x0), .O(new_n116_));
  nand2  g102(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand2  g103(.a(new_n114_), .b(new_n38_), .O(new_n118_));
  nand4  g104(.a(new_n118_), .b(new_n16_), .c(new_n29_), .d(x0), .O(new_n119_));
  ...
  and2   g108(.a(new_n112_), .b(x6), .O(new_n123_));
  nand2  g109(.a(new_n59_), .b(new_n20_), .O(new_n124_));
  nor2   g110(.a(new_n19_), .b(new_n29_), .O(new_n125_));
  aoi21  g111(.a(new_n125_), .b(new_n124_), .c(new_n15_), .O(new_n126_));
  aoi21  g112(.a(new_n123_), .b(new_n28_), .c(new_n126_), .O(new_n127_));
  aoi21  g113(.a(new_n124_), .b(new_n42_), .c(x3), .O(new_n128_));
  nand2  g114(.a(new_n17_), .b(x0), .O(new_n129_));
  oai21  g115(.a(new_n129_), .b(new_n128_), .c(x5), .O(new_n130_));
  oai21  g116(.a(new_n127_), .b(x8), .c(new_n130_), .O(z4));
endmodule
