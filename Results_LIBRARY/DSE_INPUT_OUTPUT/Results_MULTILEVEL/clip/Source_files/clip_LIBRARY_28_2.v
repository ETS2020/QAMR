...
module FAU ( 
  ...
  nand3  g028(.a(new_n24_), .b(x5), .c(new_n20_), .O(new_n43_));
  ...
  aoi21  g034(.a(x5), .b(new_n20_), .c(new_n48_), .O(new_n49_));
  nor2   g035(.a(new_n17_), .b(new_n15_), .O(new_n50_));
  ...
  nand3  g039(.a(x8), .b(new_n30_), .c(x4), .O(new_n54_));
  aoi21  g040(.a(new_n54_), .b(new_n34_), .c(x3), .O(new_n55_));
  nor3   g041(.a(new_n22_), .b(new_n30_), .c(x4), .O(new_n56_));
  oai21  g042(.a(new_n56_), .b(new_n55_), .c(new_n53_), .O(new_n57_));
  nand4  g043(.a(new_n57_), .b(new_n52_), .c(new_n46_), .d(new_n38_), .O(z1));
  nand2  g044(.a(x7), .b(x6), .O(new_n59_));
  aoi21  g045(.a(new_n59_), .b(x4), .c(x1), .O(new_n60_));
  inv1   g046(.a(x6), .O(new_n61_));
  aoi21  g047(.a(new_n34_), .b(new_n32_), .c(new_n61_), .O(new_n62_));
  nand3  g048(.a(new_n22_), .b(new_n37_), .c(x3), .O(new_n63_));
  aoi21  g049(.a(new_n63_), .b(new_n24_), .c(x0), .O(new_n64_));
  nand2  g050(.a(new_n28_), .b(x0), .O(new_n65_));
  aoi21  g051(.a(new_n65_), .b(new_n24_), .c(new_n37_), .O(new_n66_));
  oai22  g052(.a(new_n66_), .b(new_n64_), .c(new_n62_), .d(new_n60_), .O(new_n67_));
  nand3  g053(.a(new_n34_), .b(new_n17_), .c(x1), .O(new_n68_));
  ...
  xnor2a g058(.a(x5), .b(x0), .O(new_n73_));
  nand4  g059(.a(new_n73_), .b(new_n72_), .c(new_n69_), .d(x6), .O(new_n74_));
  oai21  g060(.a(new_n28_), .b(new_n23_), .c(new_n17_), .O(new_n75_));
  nand2  g061(.a(new_n28_), .b(new_n15_), .O(new_n76_));
  nand2  g062(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g063(.a(new_n77_), .b(new_n40_), .O(new_n78_));
  nand2  g064(.a(x4), .b(x1), .O(new_n79_));
  nand3  g065(.a(new_n79_), .b(x8), .c(new_n27_), .O(new_n80_));
  nand3  g066(.a(new_n22_), .b(new_n33_), .c(x3), .O(new_n81_));
  ...
  oai21  g070(.a(new_n84_), .b(new_n15_), .c(new_n40_), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n72_), .O(new_n86_));
  nand3  g072(.a(new_n86_), .b(new_n83_), .c(new_n78_), .O(new_n87_));
  nand3  g073(.a(new_n87_), .b(new_n38_), .c(new_n61_), .O(new_n88_));
  nand3  g074(.a(new_n88_), .b(new_n74_), .c(new_n67_), .O(z2));
  nand2  g075(.a(new_n79_), .b(x7), .O(new_n90_));
  aoi21  g076(.a(new_n90_), .b(new_n32_), .c(new_n28_), .O(new_n91_));
  nand2  g077(.a(new_n33_), .b(new_n15_), .O(new_n92_));
  aoi21  g078(.a(new_n92_), .b(x3), .c(new_n22_), .O(new_n93_));
  ...
  oai21  g084(.a(new_n98_), .b(new_n97_), .c(new_n61_), .O(new_n99_));
  nand2  g085(.a(new_n99_), .b(new_n96_), .O(new_n100_));
  nand2  g086(.a(new_n100_), .b(new_n27_), .O(new_n101_));
  inv1   g087(.a(new_n50_), .O(new_n102_));
  nand2  g088(.a(new_n102_), .b(new_n40_), .O(new_n103_));
  nand2  g089(.a(new_n103_), .b(new_n41_), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n22_), .c(new_n61_), .O(new_n105_));
  nand3  g091(.a(new_n105_), .b(new_n101_), .c(new_n94_), .O(new_n106_));
  nand3  g092(.a(new_n106_), .b(x5), .c(x0), .O(new_n107_));
  nand2  g093(.a(new_n85_), .b(new_n71_), .O(new_n108_));
  nand2  g094(.a(new_n108_), .b(new_n70_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(new_n61_), .O(new_n110_));
  aoi21  g096(.a(new_n68_), .b(new_n31_), .c(new_n23_), .O(new_n111_));
  oai21  g097(.a(new_n111_), .b(new_n28_), .c(x6), .O(new_n112_));
  ...
  and2   g101(.a(new_n112_), .b(new_n37_), .O(new_n116_));
  nand3  g102(.a(new_n70_), .b(new_n102_), .c(new_n40_), .O(new_n117_));
  nand2  g103(.a(new_n98_), .b(new_n27_), .O(new_n118_));
  nand3  g104(.a(new_n22_), .b(new_n30_), .c(new_n33_), .O(new_n119_));
  nand4  g105(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n61_), .O(new_n120_));
