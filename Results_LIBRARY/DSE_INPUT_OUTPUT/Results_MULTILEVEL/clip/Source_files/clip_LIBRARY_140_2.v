...
module FAU ( 
  ...
  nand2  g053(.a(new_n30_), .b(x5), .O(new_n68_));
  nand4  g054(.a(new_n68_), .b(new_n46_), .c(x6), .d(x1), .O(new_n69_));
  nand3  g055(.a(new_n24_), .b(x5), .c(x3), .O(new_n70_));
  ...
  aoi21  g059(.a(new_n30_), .b(x5), .c(x7), .O(new_n74_));
  ...
  nand2  g065(.a(new_n20_), .b(new_n79_), .O(new_n80_));
  nand3  g066(.a(new_n37_), .b(new_n35_), .c(x1), .O(new_n81_));
  nand2  g067(.a(new_n81_), .b(new_n27_), .O(new_n82_));
  nand3  g068(.a(new_n82_), .b(x6), .c(new_n16_), .O(new_n83_));
  nand3  g069(.a(x7), .b(new_n17_), .c(x4), .O(new_n84_));
  aoi21  g070(.a(new_n84_), .b(new_n83_), .c(x0), .O(new_n85_));
  oai21  g071(.a(new_n19_), .b(new_n48_), .c(new_n45_), .O(new_n86_));
  nand2  g072(.a(new_n86_), .b(new_n17_), .O(new_n87_));
  nand4  g073(.a(new_n26_), .b(x6), .c(x4), .d(x0), .O(new_n88_));
  aoi21  g074(.a(new_n88_), .b(new_n87_), .c(new_n35_), .O(new_n89_));
  oai21  g075(.a(new_n89_), .b(new_n85_), .c(new_n80_), .O(new_n90_));
  inv1   g076(.a(new_n27_), .O(new_n91_));
  nand3  g077(.a(new_n56_), .b(new_n24_), .c(x3), .O(new_n92_));
  aoi21  g078(.a(new_n92_), .b(new_n30_), .c(new_n91_), .O(new_n93_));
  nand3  g079(.a(new_n24_), .b(new_n26_), .c(new_n16_), .O(new_n94_));
  nor3   g080(.a(new_n94_), .b(new_n36_), .c(x3), .O(new_n95_));
  oai21  g081(.a(new_n95_), .b(new_n93_), .c(x6), .O(new_n96_));
  nand3  g082(.a(new_n79_), .b(new_n16_), .c(x0), .O(new_n97_));
  nand2  g083(.a(new_n45_), .b(new_n48_), .O(new_n98_));
  nand2  g084(.a(new_n98_), .b(new_n44_), .O(new_n99_));
  nand3  g085(.a(new_n99_), .b(new_n24_), .c(x3), .O(new_n100_));
  nand4  g086(.a(x8), .b(new_n26_), .c(new_n29_), .d(new_n48_), .O(new_n101_));
  ...
  nand4  g090(.a(new_n104_), .b(x8), .c(new_n36_), .d(new_n29_), .O(new_n105_));
  nand3  g091(.a(new_n105_), .b(new_n103_), .c(new_n96_), .O(new_n106_));
  nand2  g092(.a(new_n106_), .b(x2), .O(new_n107_));
  nand2  g093(.a(new_n30_), .b(new_n25_), .O(new_n108_));
  nand4  g094(.a(new_n108_), .b(new_n45_), .c(new_n17_), .d(new_n35_), .O(new_n109_));
  oai21  g095(.a(new_n91_), .b(x1), .c(new_n37_), .O(new_n110_));
  nand3  g096(.a(new_n24_), .b(new_n16_), .c(x3), .O(new_n111_));
  nand2  g097(.a(new_n111_), .b(new_n30_), .O(new_n112_));
  nand3  g098(.a(new_n112_), .b(new_n110_), .c(x6), .O(new_n113_));
  nand2  g099(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(new_n15_), .O(new_n115_));
  nand3  g101(.a(new_n115_), .b(new_n107_), .c(new_n90_), .O(z2));
  nand4  g102(.a(new_n44_), .b(new_n79_), .c(x1), .d(new_n15_), .O(new_n117_));
  aoi21  g103(.a(x7), .b(x4), .c(x1), .O(new_n118_));
  oai21  g104(.a(new_n118_), .b(new_n19_), .c(new_n24_), .O(new_n119_));
  oai21  g105(.a(x7), .b(x1), .c(x8), .O(new_n120_));
  nand2  g106(.a(new_n120_), .b(new_n29_), .O(new_n121_));
  nand3  g107(.a(new_n121_), .b(new_n119_), .c(x5), .O(new_n122_));
  nand2  g108(.a(new_n122_), .b(x0), .O(new_n123_));
  aoi21  g109(.a(new_n123_), .b(new_n117_), .c(x6), .O(new_n124_));
  nand2  g110(.a(new_n30_), .b(new_n28_), .O(new_n125_));
  nand2  g111(.a(new_n125_), .b(x6), .O(new_n126_));
  nand3  g112(.a(new_n104_), .b(new_n36_), .c(new_n29_), .O(new_n127_));
  aoi21  g113(.a(new_n127_), .b(new_n126_), .c(new_n15_), .O(new_n128_));
  oai21  g114(.a(new_n128_), .b(new_n124_), .c(x2), .O(new_n129_));
  oai21  g115(.a(x2), .b(new_n48_), .c(x7), .O(new_n130_));
  nand4  g116(.a(new_n130_), .b(new_n30_), .c(x6), .d(new_n16_), .O(new_n131_));
  nand2  g117(.a(new_n63_), .b(new_n17_), .O(new_n132_));
  aoi21  g118(.a(new_n132_), .b(new_n131_), .c(new_n36_), .O(new_n133_));
  nand4  g119(.a(new_n30_), .b(new_n26_), .c(new_n35_), .d(x1), .O(new_n134_));
  nand2  g120(.a(new_n134_), .b(new_n25_), .O(new_n135_));
  nand3  g121(.a(new_n135_), .b(x6), .c(new_n16_), .O(new_n136_));
  nand3  g122(.a(x8), .b(new_n17_), .c(x3), .O(new_n137_));
  nand2  g123(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  oai21  g124(.a(new_n138_), .b(new_n133_), .c(new_n15_), .O(new_n139_));
  nand2  g125(.a(new_n139_), .b(new_n129_), .O(z3));
  nand2  g126(.a(new_n82_), .b(new_n30_), .O(new_n141_));
  nand2  g127(.a(new_n141_), .b(new_n25_), .O(new_n142_));
  aoi21  g128(.a(new_n142_), .b(x6), .c(x5), .O(new_n143_));
  nand2  g129(.a(new_n99_), .b(new_n20_), .O(new_n144_));
  nand3  g130(.a(new_n144_), .b(new_n79_), .c(new_n17_), .O(new_n145_));
  nand3  g131(.a(new_n145_), .b(x5), .c(x2), .O(new_n146_));
