...
module FAU ( 
  ...
  nand2  g107(.a(new_n30_), .b(new_n27_), .O(new_n122_));
  oai21  g108(.a(new_n122_), .b(new_n117_), .c(x6), .O(new_n123_));
  nand3  g109(.a(new_n111_), .b(new_n108_), .c(x5), .O(new_n124_));
  nand2  g110(.a(new_n124_), .b(x0), .O(new_n125_));
  nand2  g111(.a(x5), .b(new_n27_), .O(new_n126_));
  nand3  g112(.a(new_n126_), .b(new_n125_), .c(new_n123_), .O(z4));
endmodule
