...
module FAU ( 
  ...
  nand3  g93(.a(new_n107_), .b(new_n27_), .c(new_n20_), .O(new_n108_));
  oai21  g94(.a(new_n44_), .b(new_n25_), .c(new_n24_), .O(new_n109_));
  nand3  g95(.a(new_n25_), .b(new_n18_), .c(new_n17_), .O(new_n110_));
