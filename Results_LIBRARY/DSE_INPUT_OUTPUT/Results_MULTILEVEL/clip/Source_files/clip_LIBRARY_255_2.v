...
module FAU ( 
  ...
  nor2   g21(.a(x6), .b(new_n19_), .O(new_n36_));
  aoi21  g22(.a(new_n35_), .b(new_n26_), .c(new_n36_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n24_), .O(z0));
  nand2  g24(.a(x7), .b(x4), .O(new_n39_));
  nand2  g25(.a(new_n32_), .b(new_n28_), .O(new_n40_));
  ...
  nand3  g30(.a(new_n44_), .b(x2), .c(new_n19_), .O(new_n45_));
  nand2  g31(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand3  g32(.a(new_n46_), .b(new_n41_), .c(x1), .O(new_n47_));
  nand3  g33(.a(new_n20_), .b(new_n17_), .c(x6), .O(new_n48_));
  nand2  g34(.a(x2), .b(x1), .O(new_n49_));
  nand3  g35(.a(new_n49_), .b(new_n44_), .c(new_n19_), .O(new_n50_));
  ...
  nand3  g45(.a(new_n20_), .b(new_n25_), .c(x3), .O(new_n60_));
  nand2  g46(.a(new_n60_), .b(new_n22_), .O(new_n61_));
  nand3  g47(.a(new_n61_), .b(new_n30_), .c(new_n17_), .O(new_n62_));
  aoi21  g48(.a(x7), .b(new_n28_), .c(x2), .O(new_n63_));
  aoi21  g49(.a(new_n63_), .b(x1), .c(new_n29_), .O(new_n64_));
  nand2  g50(.a(x8), .b(x3), .O(new_n65_));
  nand2  g51(.a(new_n25_), .b(new_n21_), .O(new_n66_));
  nand2  g52(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  inv1   g53(.a(new_n67_), .O(new_n68_));
  nand4  g54(.a(new_n25_), .b(x7), .c(new_n28_), .d(x3), .O(new_n69_));
  oai21  g55(.a(new_n68_), .b(new_n64_), .c(new_n69_), .O(new_n70_));
  nand2  g56(.a(new_n70_), .b(new_n20_), .O(new_n71_));
  nand4  g57(.a(x8), .b(x7), .c(new_n28_), .d(new_n21_), .O(new_n72_));
  nand3  g58(.a(new_n72_), .b(new_n71_), .c(new_n62_), .O(new_n73_));
  nand2  g59(.a(new_n73_), .b(x6), .O(new_n74_));
  aoi21  g60(.a(new_n26_), .b(new_n22_), .c(x2), .O(new_n75_));
  nand3  g61(.a(new_n25_), .b(x3), .c(new_n27_), .O(new_n76_));
  inv1   g62(.a(new_n76_), .O(new_n77_));
  oai21  g63(.a(new_n77_), .b(new_n75_), .c(new_n39_), .O(new_n78_));
  nand2  g64(.a(x4), .b(x1), .O(new_n79_));
  nand3  g65(.a(new_n79_), .b(x8), .c(new_n21_), .O(new_n80_));
  nand3  g66(.a(new_n25_), .b(new_n28_), .c(x3), .O(new_n81_));
  nand2  g67(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  oai21  g68(.a(x7), .b(x4), .c(x2), .O(new_n83_));
  oai21  g69(.a(new_n83_), .b(new_n27_), .c(new_n39_), .O(new_n84_));
  aoi22  g70(.a(new_n84_), .b(new_n67_), .c(new_n82_), .d(new_n32_), .O(new_n85_));
  aoi21  g71(.a(new_n85_), .b(new_n78_), .c(x6), .O(new_n86_));
  nand4  g72(.a(x8), .b(new_n28_), .c(new_n21_), .d(new_n27_), .O(new_n87_));
  inv1   g73(.a(new_n87_), .O(new_n88_));
  oai21  g74(.a(new_n88_), .b(new_n86_), .c(new_n19_), .O(new_n89_));
  nand2  g75(.a(new_n89_), .b(new_n74_), .O(z2));
  inv1   g76(.a(x5), .O(new_n91_));
  inv1   g77(.a(new_n22_), .O(new_n92_));
  oai21  g78(.a(new_n64_), .b(new_n92_), .c(new_n26_), .O(new_n93_));
  nand3  g79(.a(new_n93_), .b(new_n91_), .c(new_n19_), .O(new_n94_));
  nand3  g80(.a(new_n30_), .b(new_n26_), .c(new_n17_), .O(new_n95_));
  oai21  g81(.a(new_n33_), .b(x8), .c(new_n21_), .O(new_n96_));
  nand3  g82(.a(new_n96_), .b(new_n95_), .c(new_n56_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(x0), .O(new_n98_));
  nand2  g84(.a(new_n98_), .b(new_n94_), .O(new_n99_));
  nand2  g85(.a(new_n99_), .b(x6), .O(new_n100_));
  nand2  g86(.a(new_n84_), .b(new_n66_), .O(new_n101_));
  nand2  g87(.a(new_n101_), .b(new_n65_), .O(new_n102_));
  nand3  g88(.a(new_n102_), .b(new_n44_), .c(new_n19_), .O(new_n103_));
  nand2  g89(.a(new_n103_), .b(new_n100_), .O(z3));
  nand3  g90(.a(new_n93_), .b(x6), .c(new_n19_), .O(new_n105_));
  oai21  g91(.a(new_n36_), .b(new_n91_), .c(new_n105_), .O(z4));
endmodule
