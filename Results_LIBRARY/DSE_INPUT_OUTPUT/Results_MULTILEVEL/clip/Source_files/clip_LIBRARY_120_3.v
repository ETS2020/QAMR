...
module FAU ( 
  ...
  nand2  g060(.a(x8), .b(new_n33_), .O(new_n75_));
  nand2  g061(.a(new_n23_), .b(x3), .O(new_n76_));
  nand2  g062(.a(new_n69_), .b(x2), .O(new_n77_));
  nand2  g063(.a(x4), .b(x1), .O(new_n78_));
  nand2  g064(.a(new_n78_), .b(x7), .O(new_n79_));
  aoi22  g065(.a(new_n79_), .b(new_n77_), .c(new_n76_), .d(new_n75_), .O(new_n80_));
  nand3  g066(.a(new_n65_), .b(new_n16_), .c(x1), .O(new_n81_));
  nand3  g067(.a(new_n22_), .b(new_n23_), .c(new_n33_), .O(new_n82_));
  aoi22  g068(.a(new_n82_), .b(new_n38_), .c(new_n81_), .d(new_n69_), .O(new_n83_));
  oai21  g069(.a(new_n83_), .b(new_n80_), .c(x6), .O(new_n84_));
  nand2  g070(.a(new_n36_), .b(x0), .O(new_n85_));
  nand2  g071(.a(new_n76_), .b(new_n75_), .O(new_n86_));
  ...
  nand3  g075(.a(new_n48_), .b(x2), .c(x1), .O(new_n90_));
  nand2  g076(.a(new_n90_), .b(new_n31_), .O(new_n91_));
  nand2  g077(.a(new_n54_), .b(new_n38_), .O(new_n92_));
  ...
  aoi21  g081(.a(new_n76_), .b(new_n75_), .c(x4), .O(new_n96_));
  aoi22  g082(.a(new_n96_), .b(new_n29_), .c(x5), .d(x3), .O(new_n97_));
  nand3  g083(.a(new_n97_), .b(new_n95_), .c(new_n84_), .O(z2));
  aoi21  g084(.a(new_n78_), .b(x7), .c(x8), .O(new_n99_));
  aoi21  g085(.a(new_n99_), .b(new_n77_), .c(new_n28_), .O(new_n100_));
  oai21  g086(.a(x7), .b(x6), .c(x4), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n29_), .O(new_n102_));
  oai21  g088(.a(x7), .b(x4), .c(x8), .O(new_n103_));
  oai21  g089(.a(new_n103_), .b(new_n87_), .c(new_n28_), .O(new_n104_));
  nand2  g090(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  oai21  g091(.a(new_n105_), .b(new_n100_), .c(new_n33_), .O(new_n106_));
  nand2  g092(.a(new_n69_), .b(new_n25_), .O(new_n107_));
  aoi21  g093(.a(new_n107_), .b(new_n65_), .c(new_n23_), .O(new_n108_));
  oai21  g094(.a(new_n108_), .b(new_n28_), .c(new_n34_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(x0), .O(new_n111_));
  oai22  g097(.a(new_n75_), .b(x0), .c(x5), .d(new_n33_), .O(new_n112_));
  nand2  g098(.a(new_n112_), .b(new_n91_), .O(new_n113_));
  oai21  g099(.a(new_n35_), .b(new_n33_), .c(new_n113_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(new_n28_), .O(new_n115_));
  nand2  g101(.a(new_n81_), .b(new_n69_), .O(new_n116_));
  nand2  g102(.a(new_n116_), .b(new_n75_), .O(new_n117_));
  nand2  g103(.a(new_n117_), .b(new_n76_), .O(new_n118_));
  nand4  g104(.a(new_n118_), .b(x6), .c(new_n34_), .d(new_n21_), .O(new_n119_));
  nand3  g105(.a(new_n119_), .b(new_n115_), .c(new_n111_), .O(z3));
  oai21  g106(.a(new_n16_), .b(new_n29_), .c(new_n31_), .O(new_n121_));
  nor2   g107(.a(new_n103_), .b(x6), .O(new_n122_));
  nand4  g108(.a(new_n122_), .b(new_n121_), .c(new_n33_), .d(x0), .O(new_n123_));
  nand2  g109(.a(new_n123_), .b(x5), .O(new_n124_));
  nand3  g110(.a(new_n118_), .b(x6), .c(new_n21_), .O(new_n125_));
