...
module FAU ( 
  ...
  nand3  g26(.a(new_n40_), .b(new_n23_), .c(x0), .O(new_n41_));
  aoi21  g27(.a(new_n41_), .b(new_n24_), .c(new_n19_), .O(new_n42_));
  oai21  g28(.a(x6), .b(x2), .c(x1), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(new_n44_));
  nand2  g30(.a(new_n27_), .b(new_n26_), .O(new_n45_));
  xor2a  g31(.a(x6), .b(x2), .O(new_n46_));
  nand3  g32(.a(new_n46_), .b(new_n45_), .c(x1), .O(new_n47_));
  nand3  g33(.a(x8), .b(new_n37_), .c(new_n35_), .O(new_n48_));
  ...
  nand4  g38(.a(new_n52_), .b(new_n24_), .c(new_n23_), .d(x0), .O(new_n53_));
  nand4  g39(.a(new_n53_), .b(new_n47_), .c(new_n44_), .d(new_n16_), .O(z1));
  inv1   g40(.a(x3), .O(new_n55_));
  nand2  g41(.a(x8), .b(new_n55_), .O(new_n56_));
  inv1   g42(.a(x8), .O(new_n57_));
  nand2  g43(.a(new_n57_), .b(x3), .O(new_n58_));
  ...
  oai21  g48(.a(x7), .b(x4), .c(x2), .O(new_n63_));
  oai21  g49(.a(new_n63_), .b(new_n17_), .c(new_n27_), .O(new_n64_));
  nand2  g50(.a(new_n31_), .b(new_n40_), .O(new_n65_));
  nand2  g51(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g52(.a(new_n66_), .b(new_n62_), .c(new_n41_), .O(new_n67_));
  nand2  g53(.a(new_n67_), .b(new_n24_), .O(new_n68_));
  nand2  g54(.a(new_n38_), .b(x2), .O(new_n69_));
  oai21  g55(.a(new_n35_), .b(new_n17_), .c(x7), .O(new_n70_));
  aoi22  g56(.a(new_n70_), .b(new_n69_), .c(new_n58_), .d(new_n56_), .O(new_n71_));
  nand3  g57(.a(new_n36_), .b(new_n19_), .c(x1), .O(new_n72_));
  nand2  g58(.a(new_n72_), .b(new_n38_), .O(new_n73_));
  and2   g59(.a(new_n73_), .b(new_n65_), .O(new_n74_));
  oai21  g60(.a(new_n74_), .b(new_n71_), .c(x6), .O(new_n75_));
  nand3  g61(.a(new_n59_), .b(new_n35_), .c(new_n17_), .O(new_n76_));
  nand4  g62(.a(new_n76_), .b(new_n75_), .c(new_n68_), .d(new_n16_), .O(z2));
  nand2  g63(.a(new_n64_), .b(new_n40_), .O(new_n78_));
  ...
  oai21  g67(.a(new_n25_), .b(new_n57_), .c(new_n55_), .O(new_n82_));
  nand3  g68(.a(new_n57_), .b(new_n37_), .c(new_n35_), .O(new_n83_));
  nand3  g69(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  nand2  g70(.a(new_n84_), .b(x5), .O(new_n85_));
  nand2  g71(.a(new_n23_), .b(x0), .O(new_n86_));
  nand2  g72(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  oai21  g73(.a(new_n87_), .b(new_n79_), .c(new_n24_), .O(new_n88_));
  inv1   g74(.a(new_n58_), .O(new_n89_));
  aoi21  g75(.a(new_n73_), .b(new_n56_), .c(new_n89_), .O(new_n90_));
  nand3  g76(.a(new_n58_), .b(new_n38_), .c(new_n20_), .O(new_n91_));
  oai21  g77(.a(new_n37_), .b(x4), .c(new_n57_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(new_n55_), .O(new_n93_));
  nand3  g79(.a(x8), .b(x7), .c(new_n35_), .O(new_n94_));
  nand3  g80(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(new_n95_));
  nand2  g81(.a(new_n95_), .b(x0), .O(new_n96_));
  oai21  g82(.a(new_n90_), .b(x0), .c(new_n96_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(x6), .O(new_n98_));
  nand3  g84(.a(new_n98_), .b(new_n88_), .c(new_n16_), .O(z3));
  nand2  g85(.a(new_n73_), .b(new_n56_), .O(new_n100_));
  nand2  g86(.a(new_n100_), .b(new_n58_), .O(new_n101_));
  aoi21  g87(.a(new_n101_), .b(x6), .c(x5), .O(new_n102_));
  oai21  g88(.a(new_n84_), .b(x6), .c(x5), .O(new_n103_));
  oai21  g89(.a(new_n102_), .b(x0), .c(new_n103_), .O(z4));
endmodule
