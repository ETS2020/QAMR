...
module FAU ( 
  ...
  nand2  g64(.a(new_n64_), .b(new_n39_), .O(new_n79_));
  aoi21  g65(.a(new_n79_), .b(new_n31_), .c(x0), .O(new_n80_));
  nand2  g66(.a(x2), .b(x1), .O(new_n81_));
  nand3  g67(.a(new_n81_), .b(new_n31_), .c(new_n27_), .O(new_n82_));
  oai21  g68(.a(new_n25_), .b(new_n54_), .c(new_n56_), .O(new_n83_));
  nand3  g69(.a(new_n54_), .b(new_n35_), .c(new_n37_), .O(new_n84_));
  ...
  oai21  g73(.a(new_n87_), .b(new_n80_), .c(new_n24_), .O(new_n88_));
  inv1   g74(.a(new_n57_), .O(new_n89_));
  oai21  g75(.a(new_n74_), .b(new_n55_), .c(new_n89_), .O(new_n90_));
  nand3  g76(.a(new_n90_), .b(new_n23_), .c(new_n15_), .O(new_n91_));
  nand3  g77(.a(new_n89_), .b(new_n69_), .c(new_n20_), .O(new_n92_));
  oai21  g78(.a(new_n36_), .b(x8), .c(new_n56_), .O(new_n93_));
  nand3  g79(.a(x8), .b(x7), .c(new_n37_), .O(new_n94_));
  nand3  g80(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nand2  g81(.a(new_n95_), .b(x0), .O(new_n96_));
  nand2  g82(.a(new_n96_), .b(new_n91_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(x6), .O(new_n98_));
  nand3  g84(.a(new_n98_), .b(new_n88_), .c(new_n16_), .O(z3));
  nand2  g85(.a(x5), .b(x0), .O(new_n100_));
  nand2  g86(.a(new_n100_), .b(new_n91_), .O(new_n101_));
  nand2  g87(.a(new_n101_), .b(x6), .O(new_n102_));
  nand4  g88(.a(new_n85_), .b(new_n24_), .c(x5), .d(x0), .O(new_n103_));
