...
module FAU ( 
  ...
  nand3  g090(.a(new_n62_), .b(new_n40_), .c(new_n36_), .O(new_n105_));
  oai21  g091(.a(new_n35_), .b(new_n20_), .c(new_n25_), .O(new_n106_));
  nand3  g092(.a(new_n20_), .b(new_n28_), .c(new_n31_), .O(new_n107_));
  nand3  g093(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(new_n108_));
  inv1   g094(.a(new_n108_), .O(new_n109_));
  nand3  g095(.a(new_n109_), .b(new_n45_), .c(x5), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(x0), .O(new_n111_));
  nand2  g097(.a(new_n92_), .b(new_n38_), .O(new_n112_));
  nand2  g098(.a(new_n112_), .b(new_n40_), .O(new_n113_));
  nand3  g099(.a(new_n113_), .b(new_n45_), .c(new_n96_), .O(new_n114_));
  aoi21  g100(.a(new_n73_), .b(new_n49_), .c(new_n21_), .O(new_n115_));
  or2    g101(.a(new_n115_), .b(new_n26_), .O(new_n116_));
  nand3  g102(.a(new_n116_), .b(x6), .c(new_n44_), .O(new_n117_));
  nand3  g103(.a(new_n117_), .b(new_n114_), .c(new_n111_), .O(z3));
  nor3   g104(.a(new_n115_), .b(new_n26_), .c(x0), .O(new_n119_));
  oai21  g105(.a(new_n108_), .b(new_n96_), .c(x5), .O(new_n120_));
  oai21  g106(.a(new_n119_), .b(new_n45_), .c(new_n120_), .O(z4));
endmodule
