...
module FAU ( 
  ...
  aoi21  g097(.a(new_n111_), .b(x5), .c(new_n96_), .O(new_n112_));
  oai21  g098(.a(new_n112_), .b(new_n106_), .c(new_n45_), .O(new_n113_));
  aoi21  g099(.a(new_n73_), .b(new_n49_), .c(new_n21_), .O(new_n114_));
  or2    g100(.a(new_n114_), .b(new_n26_), .O(new_n115_));
  nand4  g101(.a(new_n115_), .b(x6), .c(new_n44_), .d(new_n96_), .O(new_n116_));
  nand2  g102(.a(new_n116_), .b(new_n113_), .O(z3));
  nor3   g103(.a(new_n114_), .b(new_n26_), .c(x0), .O(new_n118_));
  aoi21  g104(.a(new_n110_), .b(new_n45_), .c(new_n96_), .O(new_n119_));
  oai22  g105(.a(new_n119_), .b(new_n44_), .c(new_n118_), .d(new_n45_), .O(z4));
endmodule
