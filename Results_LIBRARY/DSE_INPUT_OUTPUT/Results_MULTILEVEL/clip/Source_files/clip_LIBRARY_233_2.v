...
module FAU ( 
  ...
  nor2   g053(.a(x5), .b(new_n15_), .O(new_n68_));
  aoi21  g054(.a(new_n67_), .b(new_n17_), .c(new_n68_), .O(new_n69_));
  nand3  g055(.a(new_n69_), .b(new_n64_), .c(new_n54_), .O(z1));
  ...
  nor2   g066(.a(new_n72_), .b(x5), .O(new_n81_));
  ...
  nand2  g091(.a(new_n37_), .b(x2), .O(new_n106_));
  nand2  g092(.a(new_n88_), .b(x7), .O(new_n107_));
  aoi21  g093(.a(new_n107_), .b(new_n106_), .c(new_n84_), .O(new_n108_));
  nand2  g094(.a(new_n21_), .b(new_n17_), .O(new_n109_));
  aoi21  g095(.a(new_n109_), .b(x3), .c(new_n27_), .O(new_n110_));
  ...
  aoi21  g100(.a(new_n43_), .b(new_n15_), .c(new_n114_), .O(new_n115_));
  oai21  g101(.a(new_n115_), .b(x6), .c(new_n113_), .O(new_n116_));
  ...
  oai21  g106(.a(new_n120_), .b(new_n18_), .c(new_n19_), .O(new_n121_));
  nand3  g107(.a(new_n121_), .b(new_n117_), .c(new_n111_), .O(new_n122_));
  nand2  g108(.a(new_n122_), .b(x0), .O(new_n123_));
  nand3  g109(.a(new_n44_), .b(x2), .c(x1), .O(new_n124_));
  aoi21  g110(.a(new_n124_), .b(new_n43_), .c(new_n72_), .O(new_n125_));
  oai21  g111(.a(new_n125_), .b(new_n71_), .c(new_n19_), .O(new_n126_));
  nor2   g112(.a(x7), .b(new_n21_), .O(new_n127_));
  aoi21  g113(.a(x7), .b(new_n21_), .c(new_n17_), .O(new_n128_));
  oai21  g114(.a(new_n128_), .b(new_n127_), .c(new_n39_), .O(new_n129_));
  nand2  g115(.a(new_n129_), .b(new_n35_), .O(new_n130_));
  nand3  g116(.a(new_n130_), .b(x6), .c(new_n18_), .O(new_n131_));
  nand2  g117(.a(new_n131_), .b(new_n126_), .O(new_n132_));
  nand2  g118(.a(new_n132_), .b(new_n16_), .O(new_n133_));
  nand3  g119(.a(new_n133_), .b(new_n123_), .c(new_n105_), .O(z3));
  aoi21  g120(.a(new_n129_), .b(new_n35_), .c(new_n19_), .O(new_n135_));
  oai21  g121(.a(new_n135_), .b(x5), .c(new_n16_), .O(new_n136_));
  inv1   g122(.a(new_n71_), .O(new_n137_));
  nand3  g123(.a(new_n118_), .b(new_n137_), .c(new_n43_), .O(new_n138_));
  nand2  g124(.a(new_n114_), .b(new_n20_), .O(new_n139_));
  nand3  g125(.a(new_n27_), .b(new_n36_), .c(new_n21_), .O(new_n140_));
  nand4  g126(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n19_), .O(new_n141_));
  aoi21  g127(.a(new_n141_), .b(x5), .c(new_n68_), .O(new_n142_));
  nand2  g128(.a(new_n142_), .b(new_n136_), .O(z4));
endmodule
