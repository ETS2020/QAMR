...
module FAU ( 
  ...
  nand3  g050(.a(new_n20_), .b(new_n25_), .c(x3), .O(new_n65_));
  aoi21  g051(.a(new_n65_), .b(new_n43_), .c(x0), .O(new_n66_));
  nand2  g052(.a(new_n29_), .b(x0), .O(new_n67_));
  aoi21  g053(.a(new_n67_), .b(new_n43_), .c(new_n25_), .O(new_n68_));
  oai22  g054(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n63_), .O(new_n69_));
  nand3  g055(.a(new_n35_), .b(new_n15_), .c(x1), .O(new_n70_));
  nand2  g056(.a(new_n70_), .b(new_n32_), .O(new_n71_));
  nand2  g057(.a(x8), .b(x3), .O(new_n72_));
  nand2  g058(.a(new_n20_), .b(new_n28_), .O(new_n73_));
  nand2  g059(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  xnor2a g060(.a(x5), .b(x0), .O(new_n75_));
  nand4  g061(.a(new_n75_), .b(new_n74_), .c(new_n71_), .d(x6), .O(new_n76_));
  oai21  g062(.a(new_n29_), .b(new_n21_), .c(new_n15_), .O(new_n77_));
  nand2  g063(.a(new_n29_), .b(new_n49_), .O(new_n78_));
  nand2  g064(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g065(.a(new_n79_), .b(new_n40_), .O(new_n80_));
  nand2  g066(.a(x4), .b(x1), .O(new_n81_));
  nand3  g067(.a(new_n81_), .b(x8), .c(new_n28_), .O(new_n82_));
  nand3  g068(.a(new_n20_), .b(new_n34_), .c(x3), .O(new_n83_));
  ...
  oai21  g072(.a(new_n86_), .b(new_n49_), .c(new_n40_), .O(new_n87_));
  nand2  g073(.a(new_n87_), .b(new_n74_), .O(new_n88_));
  nand3  g074(.a(new_n88_), .b(new_n85_), .c(new_n80_), .O(new_n89_));
  nand3  g075(.a(new_n89_), .b(new_n60_), .c(new_n19_), .O(new_n90_));
  nand3  g076(.a(new_n90_), .b(new_n76_), .c(new_n69_), .O(z2));
  nand2  g077(.a(new_n81_), .b(x7), .O(new_n92_));
  aoi21  g078(.a(new_n92_), .b(new_n33_), .c(new_n29_), .O(new_n93_));
  nand2  g079(.a(new_n34_), .b(new_n49_), .O(new_n94_));
  aoi21  g080(.a(new_n94_), .b(x3), .c(new_n20_), .O(new_n95_));
  oai21  g081(.a(new_n95_), .b(new_n93_), .c(x6), .O(new_n96_));
  oai21  g082(.a(x7), .b(x6), .c(x4), .O(new_n97_));
  nand2  g083(.a(new_n97_), .b(new_n49_), .O(new_n98_));
  aoi21  g084(.a(x7), .b(x4), .c(x2), .O(new_n99_));
  nand2  g085(.a(new_n41_), .b(x8), .O(new_n100_));
  oai21  g086(.a(new_n100_), .b(new_n99_), .c(new_n19_), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  nand2  g088(.a(new_n102_), .b(new_n28_), .O(new_n103_));
  inv1   g089(.a(new_n52_), .O(new_n104_));
  nand2  g090(.a(new_n104_), .b(new_n40_), .O(new_n105_));
  nand2  g091(.a(new_n105_), .b(new_n41_), .O(new_n106_));
  nand3  g092(.a(new_n106_), .b(new_n20_), .c(new_n19_), .O(new_n107_));
  nand3  g093(.a(new_n107_), .b(new_n103_), .c(new_n96_), .O(new_n108_));
  nand3  g094(.a(new_n108_), .b(x5), .c(x0), .O(new_n109_));
  nand2  g095(.a(new_n87_), .b(new_n73_), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(new_n72_), .O(new_n111_));
  nand2  g097(.a(new_n111_), .b(new_n19_), .O(new_n112_));
  aoi21  g098(.a(new_n70_), .b(new_n32_), .c(new_n21_), .O(new_n113_));
  oai21  g099(.a(new_n113_), .b(new_n29_), .c(x6), .O(new_n114_));
  ...
  and2   g103(.a(new_n114_), .b(new_n25_), .O(new_n118_));
  nand3  g104(.a(new_n72_), .b(new_n104_), .c(new_n40_), .O(new_n119_));
  nand2  g105(.a(new_n100_), .b(new_n28_), .O(new_n120_));
  nand3  g106(.a(new_n20_), .b(new_n31_), .c(new_n34_), .O(new_n121_));
