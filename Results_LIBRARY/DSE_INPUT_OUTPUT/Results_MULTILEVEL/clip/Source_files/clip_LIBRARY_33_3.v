...
module FAU ( 
  ...
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(new_n28_), .d(new_n26_), .O(z0));
  nand2  g18(.a(new_n20_), .b(new_n19_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n29_), .c(x1), .O(new_n34_));
  nand2  g20(.a(x7), .b(new_n17_), .O(new_n35_));
  nand2  g21(.a(new_n18_), .b(x4), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(new_n38_));
  aoi21  g24(.a(new_n38_), .b(new_n34_), .c(new_n16_), .O(new_n39_));
  ...
  oai21  g30(.a(new_n44_), .b(new_n39_), .c(new_n15_), .O(new_n45_));
  ...
  nor2   g41(.a(x8), .b(new_n54_), .O(new_n56_));
  ...
  nand3  g47(.a(new_n19_), .b(x2), .c(x1), .O(new_n62_));
  ...
  oai21  g54(.a(new_n17_), .b(new_n27_), .c(x7), .O(new_n69_));
  nand2  g55(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g56(.a(new_n70_), .b(new_n58_), .O(new_n71_));
  nand3  g57(.a(new_n35_), .b(new_n29_), .c(x1), .O(new_n72_));
  ...
  nand3  g62(.a(new_n58_), .b(new_n17_), .c(new_n27_), .O(new_n77_));
  ...
  aoi21  g66(.a(new_n17_), .b(new_n27_), .c(new_n54_), .O(new_n81_));
  oai21  g67(.a(new_n81_), .b(new_n80_), .c(x6), .O(new_n82_));
  oai21  g68(.a(new_n82_), .b(new_n79_), .c(new_n15_), .O(new_n83_));
  aoi21  g69(.a(new_n18_), .b(x5), .c(new_n17_), .O(new_n84_));
  oai21  g70(.a(x7), .b(x4), .c(x8), .O(new_n85_));
  oai21  g71(.a(new_n85_), .b(new_n59_), .c(x5), .O(new_n86_));
  oai21  g72(.a(new_n84_), .b(x1), .c(new_n86_), .O(new_n87_));
  nand2  g73(.a(new_n87_), .b(new_n54_), .O(new_n88_));
  oai21  g74(.a(new_n48_), .b(new_n21_), .c(new_n19_), .O(new_n89_));
  ...
  nand2  g79(.a(new_n63_), .b(new_n52_), .O(new_n94_));
  aoi21  g80(.a(new_n94_), .b(new_n24_), .c(x6), .O(new_n95_));
  nand2  g81(.a(new_n73_), .b(new_n55_), .O(new_n96_));
  aoi21  g82(.a(new_n96_), .b(new_n57_), .c(new_n16_), .O(new_n97_));
  oai21  g83(.a(new_n97_), .b(new_n95_), .c(new_n93_), .O(new_n98_));
  nand3  g84(.a(new_n98_), .b(new_n92_), .c(new_n31_), .O(z3));
  oai21  g85(.a(new_n97_), .b(x5), .c(new_n93_), .O(new_n100_));
  nand3  g86(.a(new_n47_), .b(new_n24_), .c(new_n20_), .O(new_n101_));
  nand2  g87(.a(new_n85_), .b(new_n54_), .O(new_n102_));
  nand3  g88(.a(new_n80_), .b(new_n18_), .c(new_n17_), .O(new_n103_));
  nand3  g89(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nand2  g90(.a(new_n104_), .b(x0), .O(new_n105_));
  nand2  g91(.a(new_n105_), .b(new_n16_), .O(new_n106_));
