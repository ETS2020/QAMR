...
module FAU ( 
  ...
  nand3  g063(.a(new_n27_), .b(new_n15_), .c(x1), .O(new_n78_));
  ...
  nand3  g068(.a(new_n82_), .b(new_n43_), .c(new_n17_), .O(new_n83_));
  nand3  g069(.a(new_n82_), .b(x7), .c(new_n25_), .O(new_n84_));
  and2   g070(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  aoi21  g071(.a(new_n85_), .b(new_n81_), .c(new_n50_), .O(new_n86_));
  oai21  g072(.a(new_n86_), .b(new_n77_), .c(new_n41_), .O(new_n87_));
  nand2  g073(.a(new_n82_), .b(new_n15_), .O(new_n88_));
  oai21  g074(.a(new_n24_), .b(x1), .c(new_n88_), .O(new_n89_));
  nand2  g075(.a(new_n89_), .b(new_n32_), .O(new_n90_));
  nand2  g076(.a(x4), .b(x1), .O(new_n91_));
  nand3  g077(.a(new_n91_), .b(x8), .c(new_n59_), .O(new_n92_));
  nand3  g078(.a(new_n19_), .b(new_n25_), .c(x3), .O(new_n93_));
  aoi21  g079(.a(new_n93_), .b(new_n92_), .c(x7), .O(new_n94_));
  aoi21  g080(.a(new_n80_), .b(new_n75_), .c(new_n94_), .O(new_n95_));
  ...
  aoi21  g084(.a(new_n27_), .b(new_n26_), .c(new_n50_), .O(new_n99_));
  oai21  g085(.a(new_n99_), .b(new_n98_), .c(x8), .O(new_n100_));
  nor2   g086(.a(new_n100_), .b(x3), .O(new_n101_));
  oai21  g087(.a(new_n101_), .b(new_n96_), .c(new_n58_), .O(new_n102_));
  nand2  g088(.a(new_n102_), .b(new_n87_), .O(z2));
  inv1   g089(.a(new_n24_), .O(new_n104_));
  aoi21  g090(.a(new_n78_), .b(new_n43_), .c(new_n20_), .O(new_n105_));
  oai21  g091(.a(new_n105_), .b(new_n104_), .c(x6), .O(new_n106_));
  nand3  g092(.a(new_n43_), .b(new_n24_), .c(new_n17_), .O(new_n107_));
  nand2  g093(.a(new_n27_), .b(new_n19_), .O(new_n108_));
  nand2  g094(.a(new_n108_), .b(new_n59_), .O(new_n109_));
  nor2   g095(.a(new_n19_), .b(new_n42_), .O(new_n110_));
  aoi21  g096(.a(new_n110_), .b(new_n25_), .c(new_n50_), .O(new_n111_));
  nand3  g097(.a(new_n111_), .b(new_n109_), .c(new_n107_), .O(new_n112_));
  nand2  g098(.a(new_n112_), .b(x0), .O(new_n113_));
  oai21  g099(.a(new_n106_), .b(x0), .c(new_n113_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(new_n41_), .O(new_n115_));
  nand2  g101(.a(new_n75_), .b(new_n35_), .O(new_n116_));
  nand2  g102(.a(new_n116_), .b(new_n37_), .O(new_n117_));
  nand3  g103(.a(new_n117_), .b(new_n50_), .c(new_n58_), .O(new_n118_));
  nand2  g104(.a(new_n118_), .b(new_n115_), .O(z3));
  aoi21  g105(.a(new_n106_), .b(new_n41_), .c(x0), .O(z4));
endmodule
