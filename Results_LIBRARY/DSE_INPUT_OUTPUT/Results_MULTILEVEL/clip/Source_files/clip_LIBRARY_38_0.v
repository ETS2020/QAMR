...
module FAU ( 
  ...
  nand2  g029(.a(new_n30_), .b(new_n27_), .O(new_n44_));
  nand2  g030(.a(x6), .b(x2), .O(new_n45_));
  inv1   g031(.a(x6), .O(new_n46_));
  nand2  g032(.a(new_n46_), .b(new_n15_), .O(new_n47_));
  nand3  g033(.a(new_n47_), .b(new_n45_), .c(x1), .O(new_n48_));
  nand2  g034(.a(new_n48_), .b(new_n44_), .O(new_n49_));
  nand2  g035(.a(new_n26_), .b(new_n29_), .O(new_n50_));
  nand2  g036(.a(new_n36_), .b(new_n50_), .O(new_n51_));
  nand2  g037(.a(x6), .b(new_n15_), .O(new_n52_));
  nand2  g038(.a(new_n46_), .b(x2), .O(new_n53_));
  nand2  g039(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand3  g040(.a(new_n54_), .b(new_n51_), .c(x1), .O(new_n55_));
  nand2  g041(.a(new_n38_), .b(new_n50_), .O(new_n56_));
  nand2  g042(.a(new_n56_), .b(new_n40_), .O(new_n57_));
  nand3  g043(.a(new_n57_), .b(new_n46_), .c(new_n33_), .O(new_n58_));
  nand3  g044(.a(new_n58_), .b(new_n55_), .c(new_n49_), .O(new_n59_));
  nand2  g045(.a(new_n59_), .b(x0), .O(new_n60_));
  nand4  g046(.a(x8), .b(x6), .c(new_n20_), .d(new_n15_), .O(new_n61_));
  nand2  g047(.a(new_n61_), .b(new_n53_), .O(new_n62_));
  nand3  g048(.a(new_n62_), .b(new_n51_), .c(x1), .O(new_n63_));
  nand2  g049(.a(x2), .b(x1), .O(new_n64_));
  nand3  g050(.a(new_n64_), .b(new_n44_), .c(new_n46_), .O(new_n65_));
  nand2  g051(.a(new_n45_), .b(x1), .O(new_n66_));
  nand3  g052(.a(x8), .b(new_n26_), .c(x4), .O(new_n67_));
  aoi21  g053(.a(new_n67_), .b(new_n30_), .c(x3), .O(new_n68_));
  nor3   g054(.a(new_n24_), .b(new_n26_), .c(x4), .O(new_n69_));
  ...
  nand2  g059(.a(new_n38_), .b(new_n33_), .O(new_n74_));
  xnor2a g060(.a(x8), .b(x3), .O(new_n75_));
  nand3  g061(.a(new_n24_), .b(x3), .c(new_n34_), .O(new_n76_));
  oai21  g062(.a(new_n75_), .b(x2), .c(new_n76_), .O(new_n77_));
  nand2  g063(.a(new_n77_), .b(new_n36_), .O(new_n78_));
  nand2  g064(.a(x4), .b(x1), .O(new_n79_));
  nand3  g065(.a(new_n79_), .b(x8), .c(new_n20_), .O(new_n80_));
  nand3  g066(.a(new_n24_), .b(new_n29_), .c(x3), .O(new_n81_));
  ...
  oai21  g070(.a(new_n84_), .b(new_n34_), .c(new_n36_), .O(new_n85_));
  nand2  g071(.a(new_n40_), .b(new_n38_), .O(new_n86_));
  ...
  oai21  g075(.a(new_n25_), .b(new_n19_), .c(new_n21_), .O(new_n90_));
  nand2  g076(.a(new_n79_), .b(x7), .O(new_n91_));
  ...
  nand3  g081(.a(new_n95_), .b(new_n86_), .c(x0), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nand2  g083(.a(new_n97_), .b(x6), .O(new_n98_));
  and2   g084(.a(new_n90_), .b(new_n29_), .O(new_n99_));
  aoi22  g085(.a(new_n99_), .b(new_n34_), .c(new_n33_), .d(new_n19_), .O(new_n100_));
  nand3  g086(.a(new_n100_), .b(new_n98_), .c(new_n89_), .O(z2));
  oai21  g087(.a(new_n46_), .b(new_n19_), .c(new_n33_), .O(new_n102_));
  nand2  g088(.a(new_n85_), .b(new_n38_), .O(new_n103_));
  aoi21  g089(.a(new_n103_), .b(new_n40_), .c(x0), .O(new_n104_));
  nand3  g090(.a(new_n64_), .b(new_n40_), .c(new_n36_), .O(new_n105_));
  oai21  g091(.a(x7), .b(x4), .c(x8), .O(new_n106_));
  nand2  g092(.a(new_n106_), .b(new_n20_), .O(new_n107_));
  nand3  g093(.a(new_n24_), .b(new_n26_), .c(new_n29_), .O(new_n108_));
  ...
  oai21  g097(.a(new_n111_), .b(new_n104_), .c(new_n46_), .O(new_n112_));
  nand3  g098(.a(new_n27_), .b(new_n25_), .c(new_n17_), .O(new_n113_));
  nand2  g099(.a(new_n30_), .b(new_n24_), .O(new_n114_));
  aoi21  g100(.a(new_n114_), .b(new_n20_), .c(new_n69_), .O(new_n115_));
  nand2  g101(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g102(.a(new_n116_), .b(x6), .c(x0), .O(new_n117_));
  nand3  g103(.a(new_n117_), .b(new_n112_), .c(new_n102_), .O(z3));
  aoi21  g104(.a(new_n109_), .b(x0), .c(x6), .O(new_n119_));
  oai21  g105(.a(new_n119_), .b(new_n33_), .c(x0), .O(z4));
endmodule
