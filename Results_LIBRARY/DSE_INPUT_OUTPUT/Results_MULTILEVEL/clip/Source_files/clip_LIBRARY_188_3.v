...
module FAU ( 
  ...
  nand3  g83(.a(new_n60_), .b(new_n22_), .c(new_n19_), .O(new_n98_));
  oai21  g84(.a(new_n51_), .b(new_n31_), .c(new_n28_), .O(new_n99_));
  nand3  g85(.a(new_n31_), .b(new_n33_), .c(new_n37_), .O(new_n100_));
  nor2   g86(.a(x6), .b(new_n15_), .O(new_n101_));
  nand4  g87(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(new_n102_));
  nand2  g88(.a(new_n102_), .b(x0), .O(new_n103_));
  nand2  g89(.a(new_n75_), .b(new_n72_), .O(new_n104_));
  nand2  g90(.a(new_n104_), .b(new_n22_), .O(new_n105_));
  nand3  g91(.a(new_n105_), .b(new_n17_), .c(new_n16_), .O(new_n106_));
  nand2  g92(.a(new_n91_), .b(new_n29_), .O(new_n107_));
  nand2  g93(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  nand3  g94(.a(new_n108_), .b(x6), .c(new_n15_), .O(new_n109_));
  nand3  g95(.a(new_n109_), .b(new_n106_), .c(new_n103_), .O(z3));
  aoi21  g96(.a(new_n108_), .b(x6), .c(x5), .O(new_n111_));
  nand3  g97(.a(new_n100_), .b(new_n99_), .c(new_n98_), .O(new_n112_));
  nand3  g98(.a(new_n112_), .b(new_n17_), .c(x5), .O(new_n113_));
