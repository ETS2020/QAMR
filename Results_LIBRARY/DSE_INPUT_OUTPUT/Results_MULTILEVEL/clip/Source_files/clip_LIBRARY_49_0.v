...
module FAU ( 
  ...
  nand4  g009(.a(new_n23_), .b(new_n16_), .c(x4), .d(x0), .O(new_n24_));
  ...
  nand3  g027(.a(x7), .b(new_n27_), .c(x1), .O(new_n42_));
  inv1   g028(.a(x7), .O(new_n43_));
  nand2  g029(.a(new_n43_), .b(x2), .O(new_n44_));
  aoi21  g030(.a(new_n44_), .b(new_n42_), .c(new_n16_), .O(new_n45_));
  nand2  g031(.a(x8), .b(new_n17_), .O(new_n46_));
  nand3  g032(.a(new_n46_), .b(x5), .c(new_n31_), .O(new_n47_));
  oai21  g033(.a(new_n45_), .b(new_n21_), .c(new_n47_), .O(new_n48_));
  nand3  g034(.a(new_n19_), .b(new_n15_), .c(x0), .O(new_n49_));
  nand2  g035(.a(x2), .b(x1), .O(new_n50_));
  nand2  g036(.a(new_n50_), .b(new_n43_), .O(new_n51_));
  nand3  g037(.a(x7), .b(x2), .c(x1), .O(new_n52_));
  ...
  aoi21  g045(.a(new_n59_), .b(new_n57_), .c(new_n31_), .O(new_n60_));
  nand3  g046(.a(new_n35_), .b(x7), .c(x2), .O(new_n61_));
  nand3  g047(.a(x8), .b(new_n43_), .c(new_n17_), .O(new_n62_));
  oai21  g048(.a(new_n62_), .b(new_n28_), .c(new_n61_), .O(new_n63_));
  oai21  g049(.a(new_n63_), .b(new_n60_), .c(x6), .O(new_n64_));
  inv1   g050(.a(new_n50_), .O(new_n65_));
  oai21  g051(.a(new_n35_), .b(x0), .c(new_n25_), .O(new_n66_));
  oai21  g052(.a(new_n65_), .b(x6), .c(new_n66_), .O(new_n67_));
  nand2  g053(.a(new_n67_), .b(x7), .O(new_n68_));
  nand3  g054(.a(new_n65_), .b(new_n43_), .c(new_n16_), .O(new_n69_));
  nand3  g055(.a(new_n69_), .b(new_n68_), .c(new_n64_), .O(new_n70_));
  nand3  g056(.a(new_n70_), .b(x5), .c(new_n36_), .O(new_n71_));
  nand2  g057(.a(new_n71_), .b(new_n56_), .O(z1));
  nand2  g058(.a(x7), .b(x6), .O(new_n73_));
  aoi21  g059(.a(new_n73_), .b(x4), .c(x1), .O(new_n74_));
  aoi21  g060(.a(new_n38_), .b(new_n37_), .c(new_n16_), .O(new_n75_));
  oai21  g061(.a(new_n35_), .b(new_n31_), .c(new_n46_), .O(new_n76_));
  oai21  g062(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(new_n77_));
  nand2  g063(.a(x7), .b(x4), .O(new_n78_));
  aoi21  g064(.a(new_n35_), .b(new_n46_), .c(x2), .O(new_n79_));
  nand3  g065(.a(new_n18_), .b(x3), .c(new_n25_), .O(new_n80_));
  inv1   g066(.a(new_n80_), .O(new_n81_));
  oai21  g067(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(new_n82_));
  nand2  g068(.a(x4), .b(x1), .O(new_n83_));
  nand3  g069(.a(new_n83_), .b(x8), .c(new_n17_), .O(new_n84_));
  nand3  g070(.a(new_n18_), .b(new_n36_), .c(x3), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g072(.a(new_n86_), .b(new_n43_), .O(new_n87_));
  oai21  g073(.a(x7), .b(x4), .c(x2), .O(new_n88_));
  oai21  g074(.a(new_n88_), .b(new_n25_), .c(new_n78_), .O(new_n89_));
  nand2  g075(.a(new_n22_), .b(new_n19_), .O(new_n90_));
  nand2  g076(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g077(.a(new_n91_), .b(new_n87_), .c(new_n82_), .d(new_n49_), .O(new_n92_));
  nand2  g078(.a(new_n92_), .b(new_n16_), .O(new_n93_));
  aoi21  g079(.a(new_n27_), .b(x1), .c(new_n43_), .O(new_n94_));
  aoi21  g080(.a(x4), .b(x0), .c(new_n15_), .O(new_n95_));
  nand3  g081(.a(new_n58_), .b(x1), .c(x0), .O(new_n96_));
  ...
  nand2  g089(.a(new_n15_), .b(new_n36_), .O(new_n104_));
  nand4  g090(.a(new_n104_), .b(new_n103_), .c(new_n93_), .d(new_n77_), .O(z2));
  oai21  g091(.a(new_n94_), .b(new_n32_), .c(new_n35_), .O(new_n106_));
  nand3  g092(.a(new_n106_), .b(new_n15_), .c(new_n31_), .O(new_n107_));
  nand3  g093(.a(new_n35_), .b(new_n28_), .c(x7), .O(new_n108_));
  nand2  g094(.a(new_n108_), .b(new_n46_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(x0), .O(new_n110_));
  aoi21  g096(.a(new_n110_), .b(new_n107_), .c(new_n16_), .O(new_n111_));
  nand2  g097(.a(new_n51_), .b(new_n19_), .O(new_n112_));
  nand2  g098(.a(new_n112_), .b(new_n22_), .O(new_n113_));
  nand2  g099(.a(new_n113_), .b(new_n31_), .O(new_n114_));
  nand2  g100(.a(new_n15_), .b(x0), .O(new_n115_));
  aoi21  g101(.a(new_n115_), .b(new_n114_), .c(x6), .O(new_n116_));
  oai21  g102(.a(new_n116_), .b(new_n111_), .c(x4), .O(new_n117_));
  nand4  g103(.a(new_n19_), .b(x7), .c(x2), .d(x1), .O(new_n118_));
  aoi21  g104(.a(new_n118_), .b(new_n22_), .c(x0), .O(new_n119_));
  aoi21  g105(.a(x7), .b(x4), .c(x2), .O(new_n120_));
  aoi21  g106(.a(x4), .b(x1), .c(x7), .O(new_n121_));
  oai21  g107(.a(new_n121_), .b(new_n120_), .c(new_n22_), .O(new_n122_));
  oai21  g108(.a(x4), .b(x1), .c(x3), .O(new_n123_));
  ...
  inv1   g115(.a(new_n58_), .O(new_n130_));
  nand3  g116(.a(new_n130_), .b(new_n35_), .c(x6), .O(new_n131_));
  aoi21  g117(.a(new_n131_), .b(new_n129_), .c(x4), .O(new_n132_));
  nor2   g118(.a(new_n127_), .b(x3), .O(new_n133_));
  ...
  nand2  g122(.a(new_n136_), .b(new_n117_), .O(z3));
  aoi21  g123(.a(new_n106_), .b(x6), .c(x5), .O(new_n138_));
  oai21  g124(.a(x7), .b(new_n15_), .c(x4), .O(new_n139_));
  nand3  g125(.a(new_n139_), .b(new_n50_), .c(new_n22_), .O(new_n140_));
  oai22  g126(.a(x8), .b(new_n15_), .c(x7), .d(x4), .O(new_n141_));
  nand2  g127(.a(new_n141_), .b(new_n17_), .O(new_n142_));
  oai21  g128(.a(x8), .b(x7), .c(x5), .O(new_n143_));
  aoi22  g129(.a(new_n143_), .b(new_n36_), .c(x6), .d(x5), .O(new_n144_));
  nand3  g130(.a(new_n144_), .b(new_n142_), .c(new_n140_), .O(new_n145_));
  inv1   g131(.a(new_n145_), .O(new_n146_));
  oai21  g132(.a(new_n138_), .b(x0), .c(new_n146_), .O(z4));
endmodule
