...
module FAU ( 
  ...
  aoi22  g049(.a(new_n63_), .b(new_n15_), .c(new_n62_), .d(new_n60_), .O(new_n64_));
  nand2  g050(.a(new_n39_), .b(new_n15_), .O(new_n65_));
  nand4  g051(.a(new_n65_), .b(new_n20_), .c(x7), .d(new_n40_), .O(new_n66_));
  ...
  nand3  g061(.a(new_n52_), .b(new_n17_), .c(x2), .O(new_n76_));
  nand4  g062(.a(new_n44_), .b(x6), .c(new_n16_), .d(new_n18_), .O(new_n77_));
  aoi21  g063(.a(new_n77_), .b(new_n76_), .c(new_n24_), .O(new_n78_));
  nand2  g064(.a(x7), .b(new_n17_), .O(new_n79_));
  nand3  g065(.a(new_n61_), .b(x6), .c(new_n16_), .O(new_n80_));
  aoi21  g066(.a(new_n80_), .b(new_n79_), .c(new_n40_), .O(new_n81_));
  oai22  g067(.a(new_n81_), .b(new_n78_), .c(new_n33_), .d(new_n28_), .O(new_n82_));
  nand2  g068(.a(x7), .b(x6), .O(new_n83_));
  aoi21  g069(.a(new_n83_), .b(x4), .c(x1), .O(new_n84_));
  nor2   g070(.a(new_n83_), .b(x4), .O(new_n85_));
  nand3  g071(.a(new_n32_), .b(new_n16_), .c(x3), .O(new_n86_));
  nand2  g072(.a(new_n86_), .b(new_n63_), .O(new_n87_));
  oai21  g073(.a(new_n85_), .b(new_n84_), .c(new_n87_), .O(new_n88_));
  nand2  g074(.a(new_n29_), .b(x0), .O(new_n89_));
  xnor2a g075(.a(x8), .b(x3), .O(new_n90_));
  nand3  g076(.a(new_n32_), .b(x3), .c(new_n24_), .O(new_n91_));
  oai21  g077(.a(new_n90_), .b(x2), .c(new_n91_), .O(new_n92_));
  nand2  g078(.a(new_n92_), .b(new_n26_), .O(new_n93_));
  nand2  g079(.a(x4), .b(x1), .O(new_n94_));
  nand3  g080(.a(new_n94_), .b(x8), .c(new_n31_), .O(new_n95_));
  nand3  g081(.a(new_n32_), .b(new_n40_), .c(x3), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  aoi21  g083(.a(new_n97_), .b(new_n61_), .c(x5), .O(new_n98_));
  nand3  g084(.a(new_n98_), .b(new_n93_), .c(new_n89_), .O(new_n99_));
  aoi21  g085(.a(x7), .b(new_n40_), .c(x2), .O(new_n100_));
  aoi21  g086(.a(new_n100_), .b(x1), .c(new_n41_), .O(new_n101_));
  nor2   g087(.a(x8), .b(new_n17_), .O(new_n102_));
  aoi21  g088(.a(new_n102_), .b(new_n31_), .c(new_n33_), .O(new_n103_));
  nand4  g089(.a(new_n32_), .b(x7), .c(new_n40_), .d(x3), .O(new_n104_));
  oai21  g090(.a(new_n103_), .b(new_n101_), .c(new_n104_), .O(new_n105_));
  aoi22  g091(.a(new_n105_), .b(x0), .c(new_n99_), .d(new_n17_), .O(new_n106_));
  nand4  g092(.a(new_n106_), .b(new_n88_), .c(new_n82_), .d(new_n75_), .O(z2));
  inv1   g093(.a(new_n39_), .O(new_n108_));
  nand3  g094(.a(new_n42_), .b(new_n108_), .c(new_n20_), .O(new_n109_));
  oai21  g095(.a(new_n45_), .b(x8), .c(new_n31_), .O(new_n110_));
  nor2   g096(.a(new_n32_), .b(new_n61_), .O(new_n111_));
  aoi21  g097(.a(new_n111_), .b(new_n40_), .c(new_n17_), .O(new_n112_));
  nand3  g098(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(new_n113_));
  nand2  g099(.a(new_n113_), .b(x0), .O(new_n114_));
  nand3  g100(.a(new_n52_), .b(x2), .c(x1), .O(new_n115_));
  aoi21  g101(.a(new_n115_), .b(new_n26_), .c(new_n28_), .O(new_n116_));
  nand2  g102(.a(new_n34_), .b(new_n16_), .O(new_n117_));
  oai21  g103(.a(new_n117_), .b(new_n116_), .c(new_n17_), .O(new_n118_));
  nor2   g104(.a(new_n32_), .b(x3), .O(new_n119_));
  oai21  g105(.a(new_n101_), .b(new_n119_), .c(new_n108_), .O(new_n120_));
  nand4  g106(.a(new_n120_), .b(x6), .c(new_n16_), .d(new_n15_), .O(new_n121_));
  nand3  g107(.a(new_n121_), .b(new_n118_), .c(new_n114_), .O(z3));
  nand3  g108(.a(new_n120_), .b(x6), .c(new_n15_), .O(new_n123_));
  nand2  g109(.a(new_n123_), .b(new_n16_), .O(z4));
endmodule
