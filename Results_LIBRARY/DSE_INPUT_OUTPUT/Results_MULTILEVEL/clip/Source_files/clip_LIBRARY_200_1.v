...
module FAU ( 
  ...
  nand2  g034(.a(new_n26_), .b(x4), .O(new_n49_));
  ...
  aoi21  g085(.a(x7), .b(new_n17_), .c(x2), .O(new_n100_));
  aoi21  g086(.a(new_n100_), .b(x1), .c(new_n18_), .O(new_n101_));
  nand3  g087(.a(new_n76_), .b(x8), .c(x3), .O(new_n102_));
  aoi21  g088(.a(new_n102_), .b(new_n62_), .c(new_n101_), .O(new_n103_));
  aoi21  g089(.a(new_n103_), .b(x6), .c(new_n55_), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n99_), .c(new_n80_), .O(z2));
  ...
  oai21  g106(.a(new_n101_), .b(new_n81_), .c(new_n84_), .O(new_n121_));
  nand4  g107(.a(new_n121_), .b(x6), .c(new_n25_), .d(new_n20_), .O(new_n122_));
  nand3  g108(.a(new_n122_), .b(new_n120_), .c(new_n116_), .O(z3));
  nand2  g109(.a(new_n49_), .b(x8), .O(new_n124_));
  aoi21  g110(.a(new_n100_), .b(x1), .c(new_n124_), .O(new_n125_));
  oai21  g111(.a(new_n125_), .b(new_n21_), .c(new_n25_), .O(new_n126_));
  aoi22  g112(.a(x7), .b(x4), .c(x2), .d(x1), .O(new_n127_));
  oai21  g113(.a(new_n127_), .b(new_n38_), .c(new_n61_), .O(new_n128_));
  aoi21  g114(.a(new_n128_), .b(new_n21_), .c(new_n25_), .O(new_n129_));
  aoi21  g115(.a(new_n126_), .b(new_n20_), .c(new_n129_), .O(new_n130_));
  nor2   g116(.a(new_n101_), .b(x8), .O(new_n131_));
  nand4  g117(.a(new_n131_), .b(x6), .c(new_n25_), .d(new_n20_), .O(new_n132_));
  oai21  g118(.a(new_n130_), .b(new_n35_), .c(new_n132_), .O(z4));
endmodule
