...
module FAU ( 
  ...
  nor2   g100(.a(new_n43_), .b(new_n47_), .O(new_n115_));
  nand4  g101(.a(new_n115_), .b(x6), .c(x4), .d(x1), .O(new_n116_));
  nand4  g102(.a(new_n85_), .b(new_n69_), .c(new_n33_), .d(x5), .O(new_n117_));
  oai21  g103(.a(new_n116_), .b(x0), .c(new_n117_), .O(new_n118_));
  nand2  g104(.a(new_n118_), .b(new_n17_), .O(new_n119_));
  nand4  g105(.a(new_n15_), .b(x7), .c(x6), .d(x3), .O(new_n120_));
  oai21  g106(.a(x6), .b(new_n29_), .c(new_n120_), .O(new_n121_));
  nand2  g107(.a(new_n121_), .b(new_n23_), .O(new_n122_));
  inv1   g108(.a(new_n25_), .O(new_n123_));
  aoi21  g109(.a(x7), .b(x4), .c(x1), .O(new_n124_));
  oai21  g110(.a(new_n124_), .b(new_n71_), .c(new_n69_), .O(new_n125_));
  aoi21  g111(.a(new_n125_), .b(new_n31_), .c(x6), .O(new_n126_));
  oai21  g112(.a(new_n126_), .b(new_n123_), .c(x5), .O(new_n127_));
  nand3  g113(.a(new_n127_), .b(new_n122_), .c(new_n119_), .O(z4));
endmodule
