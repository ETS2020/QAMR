...
module FAU ( 
  ...
  inv1   g088(.a(new_n38_), .O(new_n103_));
  aoi21  g089(.a(new_n73_), .b(new_n36_), .c(new_n103_), .O(new_n104_));
  nand3  g090(.a(new_n62_), .b(new_n38_), .c(new_n34_), .O(new_n105_));
  oai21  g091(.a(x7), .b(x4), .c(x8), .O(new_n106_));
  nand2  g092(.a(new_n106_), .b(new_n20_), .O(new_n107_));
  nand3  g093(.a(new_n24_), .b(new_n42_), .c(new_n26_), .O(new_n108_));
  ...
  nor2   g097(.a(x5), .b(new_n19_), .O(new_n112_));
  aoi21  g098(.a(new_n111_), .b(x5), .c(new_n112_), .O(new_n113_));
  nand3  g099(.a(new_n43_), .b(new_n25_), .c(new_n17_), .O(new_n114_));
  nand2  g100(.a(new_n28_), .b(new_n24_), .O(new_n115_));
  aoi21  g101(.a(new_n115_), .b(new_n20_), .c(new_n67_), .O(new_n116_));
  ...
  oai21  g106(.a(new_n120_), .b(new_n31_), .c(x0), .O(z4));
endmodule
