...
module FAU ( 
  ...
  oai21  g090(.a(new_n104_), .b(new_n103_), .c(new_n38_), .O(new_n105_));
  oai21  g091(.a(x4), .b(x1), .c(x3), .O(new_n106_));
  aoi21  g092(.a(new_n106_), .b(new_n24_), .c(new_n31_), .O(new_n107_));
  aoi21  g093(.a(new_n107_), .b(new_n105_), .c(new_n19_), .O(new_n108_));
  nand2  g094(.a(new_n73_), .b(new_n36_), .O(new_n109_));
  aoi21  g095(.a(new_n109_), .b(new_n38_), .c(new_n31_), .O(new_n110_));
  aoi21  g096(.a(new_n110_), .b(new_n19_), .c(new_n108_), .O(new_n111_));
  ...
  nor2   g101(.a(new_n42_), .b(x4), .O(new_n116_));
  aoi21  g102(.a(new_n43_), .b(new_n17_), .c(new_n116_), .O(new_n117_));
  nor3   g103(.a(new_n117_), .b(new_n24_), .c(new_n50_), .O(new_n118_));
  oai21  g104(.a(new_n118_), .b(new_n115_), .c(x0), .O(new_n119_));
  oai21  g105(.a(new_n111_), .b(x6), .c(new_n119_), .O(z3));
  nand3  g106(.a(new_n62_), .b(new_n38_), .c(new_n34_), .O(new_n121_));
  oai21  g107(.a(new_n33_), .b(new_n24_), .c(new_n20_), .O(new_n122_));
  nand3  g108(.a(new_n24_), .b(new_n42_), .c(new_n26_), .O(new_n123_));
  nor2   g109(.a(x6), .b(new_n19_), .O(new_n124_));
  nand4  g110(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  and2   g111(.a(new_n125_), .b(x5), .O(z4));
endmodule
