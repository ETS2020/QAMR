...
module FAU ( 
  ...
  nand4  g027(.a(new_n20_), .b(new_n15_), .c(x3), .d(x0), .O(new_n42_));
  xnor2a g028(.a(x7), .b(x4), .O(new_n43_));
  nand3  g029(.a(new_n43_), .b(x2), .c(x1), .O(new_n44_));
  xor2a  g030(.a(x7), .b(x4), .O(new_n45_));
  oai21  g031(.a(new_n27_), .b(new_n25_), .c(new_n45_), .O(new_n46_));
  nand3  g032(.a(new_n46_), .b(new_n44_), .c(new_n42_), .O(new_n47_));
  nand2  g033(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nand2  g034(.a(new_n46_), .b(new_n44_), .O(new_n49_));
  ...
  nand3  g038(.a(new_n43_), .b(new_n27_), .c(x1), .O(new_n53_));
  nand2  g039(.a(new_n19_), .b(x4), .O(new_n54_));
  ...
  aoi21  g045(.a(x8), .b(new_n32_), .c(x0), .O(new_n60_));
  nand2  g046(.a(new_n16_), .b(new_n15_), .O(new_n61_));
  oai21  g047(.a(new_n60_), .b(new_n15_), .c(new_n61_), .O(new_n62_));
  oai21  g048(.a(new_n59_), .b(new_n57_), .c(new_n62_), .O(new_n63_));
  oai21  g049(.a(new_n17_), .b(new_n27_), .c(x1), .O(new_n64_));
  oai21  g050(.a(new_n35_), .b(x0), .c(x5), .O(new_n65_));
  nand2  g051(.a(new_n65_), .b(new_n61_), .O(new_n66_));
  nand4  g052(.a(new_n66_), .b(new_n64_), .c(x7), .d(new_n18_), .O(new_n67_));
  nand3  g053(.a(new_n67_), .b(new_n63_), .c(new_n52_), .O(z1));
  nand2  g054(.a(x7), .b(x6), .O(new_n69_));
  aoi21  g055(.a(new_n69_), .b(x4), .c(x1), .O(new_n70_));
  aoi21  g056(.a(new_n38_), .b(new_n37_), .c(new_n17_), .O(new_n71_));
  ...
  nor2   g062(.a(x8), .b(new_n32_), .O(new_n77_));
  oai21  g063(.a(new_n75_), .b(new_n77_), .c(new_n27_), .O(new_n78_));
  nand2  g064(.a(new_n77_), .b(new_n25_), .O(new_n79_));
  aoi22  g065(.a(new_n79_), .b(new_n78_), .c(x7), .d(x4), .O(new_n80_));
  ...
  nand2  g073(.a(new_n16_), .b(new_n32_), .O(new_n88_));
  oai21  g074(.a(new_n74_), .b(new_n32_), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g079(.a(new_n38_), .b(new_n27_), .c(x1), .O(new_n94_));
  nand2  g080(.a(new_n94_), .b(new_n54_), .O(new_n95_));
  nand2  g081(.a(new_n89_), .b(x0), .O(new_n96_));
  oai21  g082(.a(new_n61_), .b(x3), .c(new_n96_), .O(new_n97_));
  nand3  g083(.a(new_n97_), .b(new_n95_), .c(x6), .O(new_n98_));
  nand3  g084(.a(new_n98_), .b(new_n93_), .c(new_n76_), .O(z2));
  nand2  g085(.a(x8), .b(x3), .O(new_n100_));
  aoi21  g086(.a(x7), .b(x4), .c(x2), .O(new_n101_));
  aoi21  g087(.a(x4), .b(x1), .c(x7), .O(new_n102_));
  ...
  aoi21  g091(.a(new_n105_), .b(new_n103_), .c(new_n31_), .O(new_n106_));
  nand2  g092(.a(new_n88_), .b(new_n87_), .O(new_n107_));
  aoi21  g093(.a(new_n107_), .b(new_n100_), .c(x0), .O(new_n108_));
  oai21  g094(.a(new_n108_), .b(new_n106_), .c(new_n17_), .O(new_n109_));
  aoi21  g095(.a(new_n19_), .b(x4), .c(x3), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(new_n94_), .O(new_n111_));
  nand3  g097(.a(new_n111_), .b(new_n15_), .c(new_n31_), .O(new_n112_));
  inv1   g098(.a(new_n112_), .O(new_n113_));
  aoi21  g099(.a(x4), .b(x1), .c(new_n19_), .O(new_n114_));
  oai21  g100(.a(new_n114_), .b(new_n36_), .c(new_n35_), .O(new_n115_));
  nand2  g101(.a(new_n104_), .b(x8), .O(new_n116_));
  aoi21  g102(.a(new_n116_), .b(new_n115_), .c(new_n31_), .O(new_n117_));
  oai21  g103(.a(new_n117_), .b(new_n113_), .c(x6), .O(new_n118_));
  nand2  g104(.a(x8), .b(new_n15_), .O(new_n119_));
  inv1   g105(.a(new_n119_), .O(new_n120_));
  nand3  g106(.a(new_n18_), .b(new_n32_), .c(new_n25_), .O(new_n121_));
  nand2  g107(.a(new_n119_), .b(new_n121_), .O(new_n122_));
  aoi22  g108(.a(new_n122_), .b(x0), .c(new_n120_), .d(new_n32_), .O(new_n123_));
  nand3  g109(.a(new_n123_), .b(new_n118_), .c(new_n109_), .O(z3));
  nand4  g110(.a(new_n38_), .b(x6), .c(x1), .d(new_n31_), .O(new_n125_));
  nand3  g111(.a(new_n100_), .b(new_n22_), .c(x5), .O(new_n126_));
  nand2  g112(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g113(.a(new_n127_), .b(new_n27_), .O(new_n128_));
  oai21  g114(.a(new_n110_), .b(new_n17_), .c(new_n15_), .O(new_n129_));
  nand2  g115(.a(new_n129_), .b(new_n31_), .O(new_n130_));
  nand2  g116(.a(new_n22_), .b(new_n25_), .O(new_n131_));
  aoi22  g117(.a(new_n131_), .b(new_n20_), .c(x8), .d(x3), .O(new_n132_));
  nand2  g118(.a(new_n88_), .b(new_n17_), .O(new_n133_));
  oai21  g119(.a(new_n133_), .b(new_n132_), .c(x5), .O(new_n134_));
  nand4  g120(.a(new_n134_), .b(new_n130_), .c(new_n128_), .d(new_n119_), .O(z4));
endmodule
