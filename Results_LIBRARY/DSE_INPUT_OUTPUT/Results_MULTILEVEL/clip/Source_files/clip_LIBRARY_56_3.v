...
module FAU ( 
  ...
  nor2   g033(.a(x7), .b(new_n38_), .O(new_n48_));
  ...
  oai21  g046(.a(new_n30_), .b(new_n25_), .c(x1), .O(new_n61_));
  nand3  g047(.a(new_n31_), .b(x5), .c(x3), .O(new_n62_));
  nand4  g048(.a(new_n62_), .b(new_n61_), .c(x7), .d(new_n38_), .O(new_n63_));
  nand2  g049(.a(x5), .b(x0), .O(new_n64_));
  nand4  g050(.a(new_n64_), .b(new_n63_), .c(new_n60_), .d(new_n53_), .O(z1));
  nand2  g051(.a(new_n20_), .b(x0), .O(new_n66_));
  inv1   g052(.a(x3), .O(new_n67_));
  oai21  g053(.a(x7), .b(x4), .c(x2), .O(new_n68_));
  oai21  g054(.a(new_n68_), .b(new_n15_), .c(new_n17_), .O(new_n69_));
  nand3  g055(.a(new_n69_), .b(new_n31_), .c(new_n67_), .O(new_n70_));
  aoi21  g056(.a(new_n70_), .b(new_n66_), .c(x6), .O(new_n71_));
  aoi21  g057(.a(x7), .b(new_n38_), .c(x2), .O(new_n72_));
  nand2  g058(.a(new_n72_), .b(x1), .O(new_n73_));
  nand2  g059(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand2  g060(.a(new_n22_), .b(new_n20_), .O(new_n75_));
  nand2  g061(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  xor2a  g062(.a(x8), .b(x3), .O(new_n77_));
  nand3  g063(.a(new_n77_), .b(new_n36_), .c(new_n26_), .O(new_n78_));
  nand3  g064(.a(new_n77_), .b(x7), .c(new_n38_), .O(new_n79_));
  and2   g065(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  aoi21  g066(.a(new_n80_), .b(new_n76_), .c(new_n30_), .O(new_n81_));
  oai21  g067(.a(new_n81_), .b(new_n71_), .c(new_n54_), .O(new_n82_));
  nand2  g068(.a(new_n31_), .b(x3), .O(new_n83_));
  nand2  g069(.a(new_n77_), .b(new_n25_), .O(new_n84_));
  oai21  g070(.a(new_n83_), .b(x1), .c(new_n84_), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n17_), .O(new_n86_));
  nand2  g072(.a(x4), .b(x1), .O(new_n87_));
  nand3  g073(.a(new_n87_), .b(x8), .c(new_n67_), .O(new_n88_));
  nand3  g074(.a(new_n31_), .b(new_n38_), .c(x3), .O(new_n89_));
  aoi21  g075(.a(new_n89_), .b(new_n88_), .c(x7), .O(new_n90_));
  aoi21  g076(.a(new_n75_), .b(new_n69_), .c(new_n90_), .O(new_n91_));
  ...
  oai21  g080(.a(x7), .b(new_n38_), .c(x2), .O(new_n95_));
  aoi21  g081(.a(new_n39_), .b(new_n95_), .c(new_n30_), .O(new_n96_));
  ...
  aoi21  g086(.a(new_n72_), .b(x1), .c(new_n48_), .O(new_n101_));
  oai21  g087(.a(new_n101_), .b(new_n32_), .c(new_n83_), .O(new_n102_));
  nand3  g088(.a(new_n102_), .b(x6), .c(new_n29_), .O(new_n103_));
  nand3  g089(.a(new_n36_), .b(new_n83_), .c(new_n26_), .O(new_n104_));
  oai21  g090(.a(new_n40_), .b(x8), .c(new_n67_), .O(new_n105_));
  nor2   g091(.a(new_n31_), .b(new_n35_), .O(new_n106_));
  aoi21  g092(.a(new_n106_), .b(new_n38_), .c(new_n30_), .O(new_n107_));
  ...
  nand2  g096(.a(new_n110_), .b(new_n54_), .O(new_n111_));
  nand2  g097(.a(new_n69_), .b(new_n20_), .O(new_n112_));
  nand2  g098(.a(new_n112_), .b(new_n22_), .O(new_n113_));
  nand3  g099(.a(new_n113_), .b(new_n30_), .c(new_n29_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(new_n111_), .O(z3));
  nand2  g101(.a(new_n103_), .b(new_n54_), .O(z4));
endmodule
