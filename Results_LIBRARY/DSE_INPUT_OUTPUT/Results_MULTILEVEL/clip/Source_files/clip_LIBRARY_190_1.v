...
module FAU ( 
  ...
  nand2  g40(.a(x8), .b(new_n21_), .O(new_n55_));
  nand2  g41(.a(new_n22_), .b(x3), .O(new_n56_));
  nand2  g42(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nor2   g43(.a(new_n44_), .b(x2), .O(new_n58_));
  aoi21  g44(.a(x4), .b(x1), .c(x7), .O(new_n59_));
  oai21  g45(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  oai21  g46(.a(x7), .b(x4), .c(x2), .O(new_n61_));
  oai21  g47(.a(new_n61_), .b(new_n17_), .c(new_n19_), .O(new_n62_));
  nand2  g48(.a(new_n25_), .b(new_n23_), .O(new_n63_));
  nand2  g49(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g50(.a(new_n64_), .b(new_n60_), .c(new_n39_), .O(new_n65_));
  nand2  g51(.a(new_n65_), .b(new_n16_), .O(new_n66_));
  aoi21  g52(.a(new_n36_), .b(x4), .c(new_n29_), .O(new_n67_));
  aoi21  g53(.a(x4), .b(x1), .c(new_n36_), .O(new_n68_));
  oai21  g54(.a(new_n68_), .b(new_n67_), .c(new_n57_), .O(new_n69_));
  nand3  g55(.a(new_n35_), .b(new_n29_), .c(x1), .O(new_n70_));
  nand2  g56(.a(new_n70_), .b(new_n37_), .O(new_n71_));
  nand2  g57(.a(new_n71_), .b(new_n63_), .O(new_n72_));
  nand3  g58(.a(new_n72_), .b(new_n69_), .c(x0), .O(new_n73_));
  nand2  g59(.a(new_n73_), .b(x6), .O(new_n74_));
  nand3  g60(.a(new_n57_), .b(new_n34_), .c(new_n17_), .O(new_n75_));
  nand3  g61(.a(new_n75_), .b(new_n74_), .c(new_n66_), .O(z2));
  nand2  g62(.a(new_n62_), .b(new_n23_), .O(new_n77_));
  nand3  g63(.a(new_n77_), .b(new_n25_), .c(new_n16_), .O(new_n78_));
  nand2  g64(.a(new_n78_), .b(new_n31_), .O(new_n79_));
  nand3  g65(.a(new_n56_), .b(new_n37_), .c(new_n30_), .O(new_n80_));
  nand2  g66(.a(new_n35_), .b(new_n22_), .O(new_n81_));
  nand2  g67(.a(new_n81_), .b(new_n21_), .O(new_n82_));
  nand3  g68(.a(x8), .b(x7), .c(new_n34_), .O(new_n83_));
  nand3  g69(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(new_n84_));
  nand2  g70(.a(new_n84_), .b(x6), .O(new_n85_));
  nand2  g71(.a(x2), .b(x1), .O(new_n86_));
  nand3  g72(.a(new_n86_), .b(new_n25_), .c(new_n19_), .O(new_n87_));
  oai21  g73(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n88_));
  nand3  g74(.a(new_n22_), .b(new_n36_), .c(new_n34_), .O(new_n89_));
  nand3  g75(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  inv1   g76(.a(new_n90_), .O(new_n91_));
  nand2  g77(.a(new_n91_), .b(x5), .O(new_n92_));
  nand3  g78(.a(new_n92_), .b(new_n16_), .c(x0), .O(new_n93_));
  nand3  g79(.a(new_n93_), .b(new_n85_), .c(new_n79_), .O(z3));
  oai21  g80(.a(x6), .b(x5), .c(new_n31_), .O(new_n95_));
  aoi21  g81(.a(new_n90_), .b(x0), .c(x6), .O(new_n96_));
  oai21  g82(.a(new_n96_), .b(new_n15_), .c(new_n95_), .O(z4));
endmodule
