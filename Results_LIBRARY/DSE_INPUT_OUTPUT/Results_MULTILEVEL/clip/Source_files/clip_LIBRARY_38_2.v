...
module FAU ( 
  ...
  nand3  g054(.a(new_n21_), .b(new_n26_), .c(x3), .O(new_n69_));
  nand2  g055(.a(new_n69_), .b(new_n23_), .O(new_n70_));
  oai21  g056(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(new_n71_));
  aoi21  g057(.a(new_n27_), .b(new_n23_), .c(x2), .O(new_n72_));
  nand3  g058(.a(new_n26_), .b(x3), .c(new_n15_), .O(new_n73_));
  inv1   g059(.a(new_n73_), .O(new_n74_));
  oai21  g060(.a(new_n74_), .b(new_n72_), .c(new_n38_), .O(new_n75_));
  nand2  g061(.a(x4), .b(x1), .O(new_n76_));
  nand3  g062(.a(new_n76_), .b(x8), .c(new_n22_), .O(new_n77_));
  nand3  g063(.a(new_n26_), .b(new_n31_), .c(x3), .O(new_n78_));
  nand2  g064(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g065(.a(new_n79_), .b(new_n28_), .O(new_n80_));
  nand3  g066(.a(new_n39_), .b(x2), .c(x1), .O(new_n81_));
  nand2  g067(.a(new_n81_), .b(new_n38_), .O(new_n82_));
  nand2  g068(.a(x8), .b(x3), .O(new_n83_));
  nand2  g069(.a(new_n26_), .b(new_n22_), .O(new_n84_));
  nand2  g070(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand3  g072(.a(new_n86_), .b(new_n80_), .c(new_n75_), .O(new_n87_));
  nand2  g073(.a(new_n87_), .b(new_n41_), .O(new_n88_));
  nand3  g074(.a(new_n32_), .b(new_n17_), .c(x1), .O(new_n89_));
  nand2  g075(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  nand4  g076(.a(new_n90_), .b(new_n85_), .c(new_n21_), .d(x6), .O(new_n91_));
  nand4  g077(.a(new_n91_), .b(new_n88_), .c(new_n71_), .d(new_n36_), .O(z2));
  ...
  nand2  g082(.a(new_n96_), .b(new_n26_), .O(new_n97_));
  aoi21  g083(.a(new_n97_), .b(new_n95_), .c(new_n20_), .O(new_n98_));
  nand2  g084(.a(new_n84_), .b(new_n82_), .O(new_n99_));
  aoi21  g085(.a(new_n99_), .b(new_n83_), .c(x0), .O(new_n100_));
  oai21  g086(.a(new_n100_), .b(new_n98_), .c(new_n41_), .O(new_n101_));
  aoi21  g087(.a(x4), .b(x1), .c(new_n28_), .O(new_n102_));
  oai21  g088(.a(new_n102_), .b(new_n29_), .c(new_n27_), .O(new_n103_));
  nand2  g089(.a(new_n96_), .b(x8), .O(new_n104_));
  aoi21  g090(.a(new_n104_), .b(new_n103_), .c(new_n20_), .O(new_n105_));
  nand2  g091(.a(new_n90_), .b(new_n23_), .O(new_n106_));
  aoi21  g092(.a(new_n106_), .b(new_n27_), .c(x5), .O(new_n107_));
  oai21  g093(.a(new_n107_), .b(new_n105_), .c(x6), .O(new_n108_));
  nor3   g094(.a(x4), .b(x3), .c(x1), .O(new_n109_));
  oai21  g095(.a(new_n109_), .b(new_n35_), .c(x0), .O(new_n110_));
  nand3  g096(.a(new_n110_), .b(new_n108_), .c(new_n101_), .O(z3));
  nand3  g097(.a(new_n106_), .b(new_n27_), .c(new_n20_), .O(new_n112_));
  ...
  nand2  g101(.a(new_n39_), .b(x8), .O(new_n116_));
  oai21  g102(.a(new_n116_), .b(new_n93_), .c(new_n41_), .O(new_n117_));
  aoi21  g103(.a(new_n117_), .b(new_n115_), .c(x3), .O(new_n118_));
  nand2  g104(.a(new_n56_), .b(new_n38_), .O(new_n119_));
  nand2  g105(.a(new_n119_), .b(new_n39_), .O(new_n120_));
  nand3  g106(.a(new_n120_), .b(new_n26_), .c(new_n41_), .O(new_n121_));
  nand2  g107(.a(new_n121_), .b(x5), .O(new_n122_));
  oai21  g108(.a(new_n122_), .b(new_n118_), .c(x0), .O(new_n123_));
  nand3  g109(.a(new_n123_), .b(new_n113_), .c(new_n21_), .O(z4));
endmodule
