...
module FAU ( 
  ...
  nand3  g055(.a(new_n26_), .b(new_n35_), .c(x3), .O(new_n70_));
  aoi21  g056(.a(new_n70_), .b(new_n23_), .c(x0), .O(new_n71_));
  nor2   g057(.a(x8), .b(new_n22_), .O(new_n72_));
  nand2  g058(.a(new_n72_), .b(x0), .O(new_n73_));
  aoi21  g059(.a(new_n73_), .b(new_n23_), .c(new_n35_), .O(new_n74_));
  oai22  g060(.a(new_n74_), .b(new_n71_), .c(new_n69_), .d(new_n68_), .O(new_n75_));
  nand3  g061(.a(new_n32_), .b(new_n17_), .c(x1), .O(new_n76_));
  nand2  g062(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  nand2  g063(.a(x8), .b(x3), .O(new_n78_));
  nand2  g064(.a(new_n26_), .b(new_n22_), .O(new_n79_));
  nand2  g065(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g066(.a(new_n80_), .b(new_n77_), .c(new_n55_), .d(x6), .O(new_n81_));
  aoi21  g067(.a(new_n27_), .b(new_n23_), .c(x2), .O(new_n82_));
  nand2  g068(.a(new_n72_), .b(new_n15_), .O(new_n83_));
  inv1   g069(.a(new_n83_), .O(new_n84_));
  oai21  g070(.a(new_n84_), .b(new_n82_), .c(new_n38_), .O(new_n85_));
  nand2  g071(.a(x4), .b(x1), .O(new_n86_));
  nand3  g072(.a(new_n86_), .b(x8), .c(new_n22_), .O(new_n87_));
  nand3  g073(.a(new_n26_), .b(new_n31_), .c(x3), .O(new_n88_));
  nand2  g074(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g075(.a(new_n89_), .b(new_n28_), .O(new_n90_));
  oai21  g076(.a(x7), .b(x4), .c(x2), .O(new_n91_));
  oai21  g077(.a(new_n91_), .b(new_n15_), .c(new_n38_), .O(new_n92_));
  nand2  g078(.a(new_n92_), .b(new_n80_), .O(new_n93_));
  nand3  g079(.a(new_n93_), .b(new_n90_), .c(new_n85_), .O(new_n94_));
  nand3  g080(.a(new_n94_), .b(new_n36_), .c(new_n42_), .O(new_n95_));
  nand3  g081(.a(new_n95_), .b(new_n81_), .c(new_n75_), .O(z2));
  aoi21  g082(.a(x7), .b(x4), .c(x2), .O(new_n97_));
  aoi21  g083(.a(x4), .b(x1), .c(x7), .O(new_n98_));
  oai21  g084(.a(new_n98_), .b(new_n97_), .c(new_n78_), .O(new_n99_));
  oai21  g085(.a(x4), .b(x1), .c(x3), .O(new_n100_));
  aoi21  g086(.a(new_n100_), .b(new_n26_), .c(new_n35_), .O(new_n101_));
  aoi21  g087(.a(new_n101_), .b(new_n99_), .c(new_n20_), .O(new_n102_));
  nand2  g088(.a(new_n92_), .b(new_n79_), .O(new_n103_));
  aoi21  g089(.a(new_n103_), .b(new_n78_), .c(x0), .O(new_n104_));
  oai21  g090(.a(new_n104_), .b(new_n102_), .c(new_n42_), .O(new_n105_));
  aoi21  g091(.a(x4), .b(x1), .c(new_n28_), .O(new_n106_));
  oai21  g092(.a(new_n106_), .b(new_n29_), .c(new_n27_), .O(new_n107_));
  nand2  g093(.a(new_n100_), .b(x8), .O(new_n108_));
  aoi21  g094(.a(new_n108_), .b(new_n107_), .c(new_n20_), .O(new_n109_));
  nand2  g095(.a(new_n77_), .b(new_n23_), .O(new_n110_));
  aoi21  g096(.a(new_n110_), .b(new_n27_), .c(x5), .O(new_n111_));
  oai21  g097(.a(new_n111_), .b(new_n109_), .c(x6), .O(new_n112_));
  nand4  g098(.a(new_n31_), .b(new_n22_), .c(new_n15_), .d(x0), .O(new_n113_));
  nand3  g099(.a(new_n113_), .b(new_n112_), .c(new_n105_), .O(z3));
  nand2  g100(.a(new_n110_), .b(new_n27_), .O(new_n115_));
  aoi21  g101(.a(new_n115_), .b(x6), .c(x5), .O(new_n116_));
  nand3  g102(.a(new_n78_), .b(new_n57_), .c(new_n38_), .O(new_n117_));
  oai21  g103(.a(new_n39_), .b(new_n26_), .c(new_n22_), .O(new_n118_));
  nand3  g104(.a(new_n26_), .b(new_n28_), .c(new_n31_), .O(new_n119_));
  nand4  g105(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n42_), .O(new_n120_));
