...
module FAU ( 
  ...
  nand3  g75(.a(new_n26_), .b(new_n24_), .c(new_n17_), .O(new_n90_));
  nand2  g76(.a(new_n90_), .b(x5), .O(new_n91_));
  aoi21  g77(.a(new_n89_), .b(new_n16_), .c(new_n91_), .O(new_n92_));
  aoi21  g78(.a(new_n92_), .b(new_n88_), .c(new_n22_), .O(new_n93_));
  ...
  nand2  g90(.a(new_n96_), .b(new_n22_), .O(new_n105_));
  nand2  g91(.a(new_n105_), .b(new_n23_), .O(new_n106_));
  nand3  g92(.a(x4), .b(x2), .c(x1), .O(new_n107_));
  nand3  g93(.a(new_n107_), .b(new_n62_), .c(x5), .O(new_n108_));
  inv1   g94(.a(new_n108_), .O(new_n109_));
  aoi21  g95(.a(new_n106_), .b(x6), .c(new_n109_), .O(new_n110_));
  nand3  g96(.a(new_n62_), .b(new_n59_), .c(new_n17_), .O(new_n111_));
  nand3  g97(.a(new_n111_), .b(new_n27_), .c(x0), .O(new_n112_));
  nand3  g98(.a(new_n112_), .b(new_n30_), .c(x5), .O(new_n113_));
  oai21  g99(.a(new_n110_), .b(x7), .c(new_n113_), .O(z4));
endmodule
