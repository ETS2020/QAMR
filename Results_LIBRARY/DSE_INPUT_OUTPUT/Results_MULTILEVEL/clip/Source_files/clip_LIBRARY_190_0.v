...
module FAU ( 
  ...
  nor3   g056(.a(new_n23_), .b(new_n25_), .c(x4), .O(new_n71_));
  oai21  g057(.a(new_n71_), .b(new_n70_), .c(new_n68_), .O(new_n72_));
  nand4  g058(.a(new_n72_), .b(new_n67_), .c(new_n60_), .d(new_n52_), .O(z1));
  nand2  g059(.a(x7), .b(x6), .O(new_n74_));
  aoi21  g060(.a(new_n74_), .b(x4), .c(x1), .O(new_n75_));
  aoi21  g061(.a(new_n29_), .b(new_n27_), .c(new_n33_), .O(new_n76_));
  oai21  g062(.a(new_n24_), .b(new_n32_), .c(new_n20_), .O(new_n77_));
  oai21  g063(.a(new_n76_), .b(new_n75_), .c(new_n77_), .O(new_n78_));
  nand2  g064(.a(new_n55_), .b(x5), .O(new_n79_));
  nand3  g065(.a(new_n79_), .b(new_n29_), .c(new_n15_), .O(new_n80_));
  nand3  g066(.a(new_n53_), .b(new_n33_), .c(x2), .O(new_n81_));
  aoi21  g067(.a(new_n81_), .b(new_n80_), .c(new_n34_), .O(new_n82_));
  nand2  g068(.a(new_n79_), .b(new_n25_), .O(new_n83_));
  nand2  g069(.a(x7), .b(new_n33_), .O(new_n84_));
  aoi21  g070(.a(new_n84_), .b(new_n83_), .c(new_n28_), .O(new_n85_));
  oai21  g071(.a(new_n85_), .b(new_n82_), .c(x8), .O(new_n86_));
  nand2  g072(.a(new_n26_), .b(new_n17_), .O(new_n87_));
  aoi21  g073(.a(new_n87_), .b(new_n29_), .c(x5), .O(new_n88_));
  nand2  g074(.a(x2), .b(x1), .O(new_n89_));
  nand2  g075(.a(new_n89_), .b(new_n36_), .O(new_n90_));
  aoi21  g076(.a(new_n90_), .b(new_n53_), .c(x6), .O(new_n91_));
  oai21  g077(.a(new_n91_), .b(new_n88_), .c(new_n23_), .O(new_n92_));
  nand2  g078(.a(new_n33_), .b(new_n46_), .O(new_n93_));
  nand3  g079(.a(new_n93_), .b(new_n92_), .c(new_n86_), .O(new_n94_));
  nand2  g080(.a(new_n94_), .b(x3), .O(new_n95_));
  nand2  g081(.a(x5), .b(new_n32_), .O(new_n96_));
  nand4  g082(.a(new_n96_), .b(new_n29_), .c(x6), .d(new_n15_), .O(new_n97_));
  aoi21  g083(.a(new_n97_), .b(new_n81_), .c(new_n34_), .O(new_n98_));
  nand3  g084(.a(new_n96_), .b(new_n25_), .c(x6), .O(new_n99_));
  aoi21  g085(.a(new_n99_), .b(new_n84_), .c(new_n28_), .O(new_n100_));
  oai21  g086(.a(new_n100_), .b(new_n98_), .c(new_n23_), .O(new_n101_));
  nand2  g087(.a(new_n36_), .b(new_n15_), .O(new_n102_));
  oai21  g088(.a(new_n28_), .b(new_n34_), .c(new_n25_), .O(new_n103_));
  nand2  g089(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(x8), .c(new_n33_), .O(new_n105_));
  nand2  g091(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand2  g092(.a(new_n106_), .b(new_n19_), .O(new_n107_));
  oai21  g093(.a(new_n23_), .b(x5), .c(x0), .O(new_n108_));
  nand2  g094(.a(new_n108_), .b(new_n33_), .O(new_n109_));
  nand4  g095(.a(new_n109_), .b(new_n107_), .c(new_n95_), .d(new_n78_), .O(z2));
  nand3  g096(.a(new_n29_), .b(new_n15_), .c(x1), .O(new_n111_));
  ...
  aoi21  g100(.a(new_n114_), .b(new_n46_), .c(new_n33_), .O(new_n115_));
  nand3  g101(.a(new_n26_), .b(new_n24_), .c(new_n17_), .O(new_n116_));
  aoi21  g102(.a(new_n29_), .b(new_n23_), .c(x3), .O(new_n117_));
  nor2   g103(.a(new_n117_), .b(new_n71_), .O(new_n118_));
  aoi21  g104(.a(new_n118_), .b(new_n116_), .c(new_n33_), .O(new_n119_));
  nand3  g105(.a(new_n89_), .b(new_n39_), .c(new_n36_), .O(new_n120_));
  oai21  g106(.a(new_n35_), .b(new_n23_), .c(new_n19_), .O(new_n121_));
  nand3  g107(.a(new_n23_), .b(new_n25_), .c(new_n28_), .O(new_n122_));
  ...
  aoi21  g111(.a(new_n119_), .b(x0), .c(new_n125_), .O(new_n126_));
  oai21  g112(.a(new_n115_), .b(x0), .c(new_n126_), .O(z3));
  nand3  g113(.a(new_n113_), .b(new_n24_), .c(x6), .O(new_n128_));
  nand2  g114(.a(new_n128_), .b(new_n32_), .O(new_n129_));
  oai21  g115(.a(new_n123_), .b(x6), .c(x5), .O(new_n130_));
