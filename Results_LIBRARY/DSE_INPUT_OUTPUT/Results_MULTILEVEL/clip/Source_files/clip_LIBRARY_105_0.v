...
module FAU ( 
  ...
  nor2   g035(.a(x7), .b(new_n39_), .O(new_n50_));
  ...
  nand2  g051(.a(new_n34_), .b(new_n15_), .O(new_n66_));
  ...
  nand3  g065(.a(new_n79_), .b(new_n36_), .c(new_n29_), .O(new_n80_));
  ...
  nand3  g076(.a(new_n22_), .b(new_n39_), .c(x3), .O(new_n91_));
  nand2  g077(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  aoi22  g078(.a(new_n92_), .b(new_n35_), .c(new_n77_), .d(new_n71_), .O(new_n93_));
  ...
  oai21  g082(.a(x7), .b(new_n39_), .c(x2), .O(new_n97_));
  aoi21  g083(.a(new_n40_), .b(new_n97_), .c(new_n46_), .O(new_n98_));
  ...
  oai21  g088(.a(new_n46_), .b(new_n15_), .c(new_n16_), .O(new_n103_));
  ...
  aoi21  g096(.a(new_n110_), .b(new_n25_), .c(x0), .O(new_n111_));
  oai21  g097(.a(new_n111_), .b(new_n109_), .c(new_n46_), .O(new_n112_));
  nand3  g098(.a(new_n40_), .b(new_n97_), .c(new_n22_), .O(new_n113_));
  aoi21  g099(.a(new_n113_), .b(x6), .c(new_n96_), .O(new_n114_));
  nor2   g100(.a(new_n114_), .b(x3), .O(new_n115_));
  aoi21  g101(.a(new_n36_), .b(new_n29_), .c(new_n41_), .O(new_n116_));
  nor3   g102(.a(new_n116_), .b(new_n22_), .c(new_n46_), .O(new_n117_));
  oai21  g103(.a(new_n117_), .b(new_n115_), .c(x0), .O(new_n118_));
  nand3  g104(.a(new_n118_), .b(new_n112_), .c(new_n103_), .O(z3));
  nand3  g105(.a(new_n51_), .b(new_n25_), .c(new_n19_), .O(new_n120_));
  oai21  g106(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n121_));
  nand3  g107(.a(new_n22_), .b(new_n35_), .c(new_n39_), .O(new_n122_));
