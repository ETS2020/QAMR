...
module FAU ( 
  ...
  nand3  g40(.a(new_n26_), .b(new_n16_), .c(x0), .O(new_n55_));
  xnor2a g41(.a(x8), .b(x3), .O(new_n56_));
  nand2  g42(.a(new_n37_), .b(x2), .O(new_n57_));
  oai21  g43(.a(new_n18_), .b(new_n17_), .c(x7), .O(new_n58_));
  aoi21  g44(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand3  g45(.a(new_n36_), .b(new_n32_), .c(x1), .O(new_n60_));
  ...
  nand3  g50(.a(new_n64_), .b(new_n18_), .c(new_n17_), .O(new_n65_));
  nand3  g51(.a(new_n65_), .b(new_n63_), .c(new_n55_), .O(new_n66_));
  nand2  g52(.a(new_n66_), .b(new_n15_), .O(new_n67_));
  nand3  g53(.a(new_n20_), .b(x2), .c(x1), .O(new_n68_));
  aoi21  g54(.a(new_n68_), .b(new_n22_), .c(new_n61_), .O(new_n69_));
  nand2  g55(.a(x2), .b(x1), .O(new_n70_));
  nand3  g56(.a(new_n70_), .b(new_n64_), .c(new_n22_), .O(new_n71_));
  nand3  g57(.a(new_n64_), .b(new_n19_), .c(new_n18_), .O(new_n72_));
  nand2  g58(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  oai21  g59(.a(new_n73_), .b(new_n69_), .c(new_n16_), .O(new_n74_));
  nand2  g60(.a(new_n74_), .b(new_n67_), .O(z2));
  nor2   g61(.a(x8), .b(new_n24_), .O(new_n76_));
  aoi21  g62(.a(new_n58_), .b(new_n57_), .c(new_n76_), .O(new_n77_));
  aoi21  g63(.a(new_n18_), .b(new_n17_), .c(new_n24_), .O(new_n78_));
  oai21  g64(.a(new_n78_), .b(new_n25_), .c(x6), .O(new_n79_));
  oai21  g65(.a(new_n79_), .b(new_n77_), .c(new_n15_), .O(new_n80_));
  oai21  g66(.a(x7), .b(new_n15_), .c(x4), .O(new_n81_));
  nand2  g67(.a(new_n81_), .b(new_n17_), .O(new_n82_));
  oai21  g68(.a(x7), .b(x4), .c(x8), .O(new_n83_));
  aoi21  g69(.a(new_n22_), .b(new_n32_), .c(new_n83_), .O(new_n84_));
  oai21  g70(.a(new_n84_), .b(new_n15_), .c(new_n82_), .O(new_n85_));
  nand2  g71(.a(new_n85_), .b(new_n24_), .O(new_n86_));
  nand2  g72(.a(new_n70_), .b(new_n22_), .O(new_n87_));
  nand2  g73(.a(new_n87_), .b(new_n20_), .O(new_n88_));
  nand3  g74(.a(new_n88_), .b(new_n25_), .c(x5), .O(new_n89_));
  nand3  g75(.a(new_n89_), .b(new_n86_), .c(new_n80_), .O(new_n90_));
  nand2  g76(.a(new_n90_), .b(x0), .O(new_n91_));
  inv1   g77(.a(x0), .O(new_n92_));
  nand2  g78(.a(new_n68_), .b(new_n22_), .O(new_n93_));
  nand2  g79(.a(new_n93_), .b(new_n26_), .O(new_n94_));
  aoi21  g80(.a(new_n94_), .b(new_n28_), .c(x6), .O(new_n95_));
  inv1   g81(.a(new_n76_), .O(new_n96_));
  nand2  g82(.a(x8), .b(new_n24_), .O(new_n97_));
  nand2  g83(.a(new_n60_), .b(new_n37_), .O(new_n98_));
  nand2  g84(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  aoi21  g85(.a(new_n99_), .b(new_n96_), .c(new_n16_), .O(new_n100_));
  oai21  g86(.a(new_n100_), .b(new_n95_), .c(new_n92_), .O(new_n101_));
  nand3  g87(.a(new_n101_), .b(new_n91_), .c(new_n34_), .O(z3));
  oai21  g88(.a(new_n100_), .b(x5), .c(new_n92_), .O(new_n103_));
  nand3  g89(.a(new_n70_), .b(new_n28_), .c(new_n22_), .O(new_n104_));
  nand2  g90(.a(new_n83_), .b(new_n24_), .O(new_n105_));
  nand3  g91(.a(new_n25_), .b(new_n19_), .c(new_n18_), .O(new_n106_));
  nand3  g92(.a(new_n106_), .b(new_n105_), .c(new_n104_), .O(new_n107_));
  nand2  g93(.a(new_n107_), .b(x0), .O(new_n108_));
  nand2  g94(.a(new_n108_), .b(new_n16_), .O(new_n109_));
  nand2  g95(.a(new_n109_), .b(x5), .O(new_n110_));
  nand2  g96(.a(new_n110_), .b(new_n103_), .O(z4));
endmodule
