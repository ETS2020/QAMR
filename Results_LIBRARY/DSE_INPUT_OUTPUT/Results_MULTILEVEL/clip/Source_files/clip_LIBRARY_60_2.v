...
module FAU ( 
  ...
  nand2  g101(.a(new_n29_), .b(new_n20_), .O(new_n116_));
  oai21  g102(.a(new_n116_), .b(new_n111_), .c(x6), .O(new_n117_));
  nand3  g103(.a(new_n105_), .b(new_n102_), .c(x5), .O(new_n118_));
  nand2  g104(.a(new_n118_), .b(x0), .O(new_n119_));
  nand3  g105(.a(new_n119_), .b(new_n117_), .c(new_n21_), .O(z4));
endmodule
