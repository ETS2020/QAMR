...
module FAU ( 
  ...
  inv1   g62(.a(new_n55_), .O(new_n77_));
  oai21  g63(.a(new_n72_), .b(new_n53_), .c(new_n77_), .O(new_n78_));
  nand3  g64(.a(new_n78_), .b(new_n15_), .c(new_n30_), .O(new_n79_));
  nand3  g65(.a(new_n77_), .b(new_n67_), .c(new_n29_), .O(new_n80_));
  oai21  g66(.a(new_n34_), .b(x8), .c(new_n54_), .O(new_n81_));
  nand3  g67(.a(x8), .b(x7), .c(new_n35_), .O(new_n82_));
  nand3  g68(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  nand2  g69(.a(new_n83_), .b(x0), .O(new_n84_));
  nand2  g70(.a(new_n84_), .b(new_n79_), .O(new_n85_));
  nand2  g71(.a(new_n85_), .b(x6), .O(new_n86_));
  nand2  g72(.a(new_n23_), .b(new_n30_), .O(new_n87_));
  aoi21  g73(.a(new_n62_), .b(new_n37_), .c(new_n87_), .O(new_n88_));
  nand2  g74(.a(x2), .b(x1), .O(new_n89_));
  nand3  g75(.a(new_n89_), .b(new_n23_), .c(new_n19_), .O(new_n90_));
  oai21  g76(.a(new_n17_), .b(new_n52_), .c(new_n54_), .O(new_n91_));
  nand3  g77(.a(new_n52_), .b(new_n33_), .c(new_n35_), .O(new_n92_));
  nand3  g78(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  nand3  g79(.a(new_n93_), .b(x5), .c(x0), .O(new_n94_));
  oai21  g80(.a(new_n88_), .b(x5), .c(new_n94_), .O(new_n95_));
  nand2  g81(.a(new_n95_), .b(new_n16_), .O(new_n96_));
  nand2  g82(.a(new_n96_), .b(new_n86_), .O(z3));
  aoi21  g83(.a(new_n78_), .b(x6), .c(x5), .O(new_n98_));
  aoi21  g84(.a(new_n93_), .b(x0), .c(x6), .O(new_n99_));
  oai22  g85(.a(new_n99_), .b(new_n15_), .c(new_n98_), .d(x0), .O(z4));
endmodule
