...
module FAU ( 
  ...
  nand2  g030(.a(new_n38_), .b(new_n36_), .O(new_n45_));
  ...
  nand2  g035(.a(new_n47_), .b(new_n44_), .O(new_n50_));
  ...
  nand3  g039(.a(new_n43_), .b(new_n27_), .c(x1), .O(new_n54_));
  ...
  nand3  g053(.a(new_n67_), .b(new_n63_), .c(new_n53_), .O(z1));
  ...
  inv1   g063(.a(new_n35_), .O(new_n78_));
  oai21  g064(.a(new_n75_), .b(new_n78_), .c(new_n27_), .O(new_n79_));
  nand2  g065(.a(new_n78_), .b(new_n25_), .O(new_n80_));
  aoi21  g066(.a(new_n80_), .b(new_n79_), .c(new_n77_), .O(new_n81_));
  nand2  g067(.a(x4), .b(x1), .O(new_n82_));
  nand4  g068(.a(new_n82_), .b(x8), .c(x5), .d(new_n32_), .O(new_n83_));
  nand3  g069(.a(new_n16_), .b(new_n18_), .c(x3), .O(new_n84_));
  nand2  g070(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n19_), .O(new_n86_));
  nand3  g072(.a(new_n20_), .b(x2), .c(x1), .O(new_n87_));
  nand2  g073(.a(new_n87_), .b(new_n22_), .O(new_n88_));
  nand3  g074(.a(x8), .b(x5), .c(x3), .O(new_n89_));
  oai21  g075(.a(x8), .b(x3), .c(new_n89_), .O(new_n90_));
  nand2  g076(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand4  g077(.a(new_n16_), .b(new_n15_), .c(x3), .d(x0), .O(new_n92_));
  nand3  g078(.a(new_n92_), .b(new_n91_), .c(new_n86_), .O(new_n93_));
  oai21  g079(.a(new_n93_), .b(new_n81_), .c(new_n17_), .O(new_n94_));
  nand3  g080(.a(new_n38_), .b(new_n27_), .c(x1), .O(new_n95_));
  nand2  g081(.a(new_n95_), .b(new_n36_), .O(new_n96_));
  nand2  g082(.a(new_n90_), .b(x0), .O(new_n97_));
  oai21  g083(.a(new_n61_), .b(x3), .c(new_n97_), .O(new_n98_));
  nand3  g084(.a(new_n98_), .b(new_n96_), .c(x6), .O(new_n99_));
  nand3  g085(.a(new_n99_), .b(new_n94_), .c(new_n76_), .O(z2));
  nand2  g086(.a(new_n74_), .b(new_n35_), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n88_), .O(new_n102_));
  aoi21  g088(.a(new_n102_), .b(new_n89_), .c(x0), .O(new_n103_));
  oai21  g089(.a(new_n15_), .b(x3), .c(x8), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n46_), .c(new_n22_), .O(new_n105_));
  ...
  nand3  g097(.a(new_n95_), .b(new_n36_), .c(new_n32_), .O(new_n112_));
  nand4  g098(.a(new_n112_), .b(new_n16_), .c(new_n15_), .d(new_n31_), .O(new_n113_));
  nand2  g099(.a(new_n36_), .b(new_n28_), .O(new_n114_));
  ...
  nand4  g108(.a(new_n38_), .b(x6), .c(x1), .d(new_n31_), .O(new_n123_));
  ...
  aoi21  g113(.a(new_n36_), .b(new_n32_), .c(new_n17_), .O(new_n128_));
