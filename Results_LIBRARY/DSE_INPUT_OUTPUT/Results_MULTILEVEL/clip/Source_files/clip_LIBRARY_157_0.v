...
module FAU ( 
  ...
  inv1   g090(.a(new_n25_), .O(new_n105_));
  aoi21  g091(.a(new_n73_), .b(new_n23_), .c(new_n105_), .O(new_n106_));
  nand3  g092(.a(new_n62_), .b(new_n25_), .c(new_n19_), .O(new_n107_));
  oai21  g093(.a(x7), .b(x4), .c(x8), .O(new_n108_));
  ...
  aoi21  g100(.a(new_n113_), .b(x5), .c(new_n114_), .O(new_n115_));
  inv1   g101(.a(new_n67_), .O(new_n116_));
  nand3  g102(.a(new_n35_), .b(new_n87_), .c(new_n29_), .O(new_n117_));
  oai21  g103(.a(new_n39_), .b(x8), .c(new_n21_), .O(new_n118_));
  nand3  g104(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(new_n119_));
  nand3  g105(.a(new_n119_), .b(x6), .c(x0), .O(new_n120_));
  oai21  g106(.a(new_n115_), .b(x6), .c(new_n120_), .O(z3));
  aoi21  g107(.a(new_n111_), .b(x0), .c(x6), .O(new_n122_));
