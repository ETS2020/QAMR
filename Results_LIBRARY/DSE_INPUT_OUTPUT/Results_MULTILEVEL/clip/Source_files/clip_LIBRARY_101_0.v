...
module FAU ( 
  ...
  nand3  g112(.a(new_n115_), .b(x6), .c(x4), .O(new_n127_));
  nand2  g113(.a(new_n127_), .b(new_n15_), .O(new_n128_));
  nand2  g114(.a(new_n128_), .b(new_n28_), .O(new_n129_));
  nand3  g115(.a(new_n77_), .b(new_n51_), .c(new_n19_), .O(new_n130_));
  oai21  g116(.a(x7), .b(x4), .c(x8), .O(new_n131_));
  nand2  g117(.a(new_n131_), .b(new_n29_), .O(new_n132_));
  nand3  g118(.a(new_n34_), .b(new_n43_), .c(new_n36_), .O(new_n133_));
  nand4  g119(.a(new_n133_), .b(new_n132_), .c(new_n130_), .d(new_n16_), .O(new_n134_));
  nand2  g120(.a(new_n134_), .b(x5), .O(new_n135_));
  nand2  g121(.a(new_n135_), .b(new_n129_), .O(z4));
endmodule
