...
module FAU ( 
  ...
  nand4  g025(.a(new_n87_), .b(x39), .c(new_n83_), .d(new_n78_), .O(new_n88_));
  oai21  g026(.a(new_n82_), .b(x04), .c(new_n88_), .O(z01));
  ...
  nand2  g032(.a(new_n79_), .b(x30), .O(new_n95_));
  ...
  oai21  g055(.a(new_n117_), .b(new_n79_), .c(new_n80_), .O(z08));
  nand4  g056(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n80_), .O(z09));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n117_), .b(x39), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n95_), .c(new_n121_), .O(new_n123_));
  ...
  nand2  g068(.a(new_n83_), .b(new_n78_), .O(new_n131_));
  ...
  nand3  g079(.a(new_n141_), .b(x27), .c(new_n65_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(x39), .c(new_n78_), .d(new_n136_), .O(new_n145_));
  ...
  aoi21  g087(.a(x40), .b(new_n65_), .c(new_n149_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(x39), .O(new_n151_));
  nor2   g089(.a(new_n149_), .b(x39), .O(new_n152_));
  ...
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n117_), .O(new_n157_));
  ...
  nand4  g106(.a(new_n156_), .b(new_n83_), .c(new_n78_), .d(x28), .O(new_n169_));
  ...
  nand3  g113(.a(new_n175_), .b(new_n83_), .c(new_n78_), .O(new_n176_));
  ...
  nand2  g125(.a(new_n141_), .b(new_n64_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n137_), .c(new_n140_), .O(new_n189_));
  nand2  g127(.a(new_n142_), .b(new_n136_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n189_), .c(x39), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n78_), .O(z18));
  nand2  g130(.a(new_n144_), .b(new_n136_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x39), .c(x30), .O(z19));
  aoi21  g132(.a(x35), .b(x27), .c(x08), .O(new_n195_));
  nand2  g133(.a(x28), .b(new_n64_), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(x35), .c(x40), .d(x29), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n136_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(x39), .c(x30), .O(z20));
endmodule
