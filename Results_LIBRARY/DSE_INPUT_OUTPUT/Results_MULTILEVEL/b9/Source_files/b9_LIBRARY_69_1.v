...
module FAU ( 
  ...
  oai21  g039(.a(new_n83_), .b(new_n97_), .c(new_n65_), .O(new_n102_));
  ...
  aoi21  g063(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(new_n126_));
  nand4  g064(.a(new_n126_), .b(x39), .c(x05), .d(new_n71_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(z10));
  inv1   g066(.a(new_n84_), .O(new_n129_));
  aoi21  g067(.a(x39), .b(new_n91_), .c(new_n74_), .O(new_n130_));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n129_), .c(new_n130_), .O(new_n132_));
  ...
  oai21  g077(.a(new_n139_), .b(new_n97_), .c(new_n73_), .O(new_n140_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(new_n97_), .O(new_n150_));
  nand2  g088(.a(new_n81_), .b(new_n80_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n143_), .c(new_n71_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x39), .c(new_n74_), .O(new_n153_));
  or2    g091(.a(new_n153_), .b(new_n150_), .O(z13));
  nand3  g092(.a(x40), .b(new_n143_), .c(new_n71_), .O(new_n155_));
  ...
  aoi22  g098(.a(new_n160_), .b(new_n144_), .c(new_n65_), .d(new_n159_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n83_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n81_), .c(new_n80_), .O(new_n163_));
  ...
  nand2  g110(.a(x40), .b(x29), .O(new_n173_));
  oai21  g111(.a(new_n84_), .b(x27), .c(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n97_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n129_), .c(x09), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n64_), .d(new_n80_), .O(z18));
  inv1   g116(.a(x09), .O(new_n179_));
  nand2  g117(.a(new_n131_), .b(new_n83_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n173_), .O(new_n181_));
  aoi21  g119(.a(x40), .b(new_n63_), .c(x27), .O(new_n182_));
  nand2  g120(.a(x39), .b(new_n159_), .O(new_n183_));
  nand2  g121(.a(x40), .b(x04), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n183_), .c(new_n83_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n182_), .c(new_n90_), .O(new_n186_));
  inv1   g124(.a(new_n130_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n159_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n186_), .c(new_n181_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n80_), .c(new_n179_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n64_), .O(z19));
  aoi21  g129(.a(x28), .b(new_n97_), .c(new_n159_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n130_), .O(new_n193_));
  aoi21  g131(.a(new_n183_), .b(new_n133_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(new_n80_), .O(new_n195_));
