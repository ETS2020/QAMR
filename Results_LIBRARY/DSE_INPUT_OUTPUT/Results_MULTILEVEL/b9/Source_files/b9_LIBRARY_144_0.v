...
module FAU ( 
  ...
  nand4  g012(.a(new_n74_), .b(x39), .c(x30), .d(new_n64_), .O(new_n75_));
  ...
  nand3  g019(.a(new_n81_), .b(new_n77_), .c(x04), .O(new_n82_));
  oai21  g020(.a(new_n77_), .b(x04), .c(new_n82_), .O(z01));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n87_), .d(new_n84_), .O(z02));
  ...
  nand4  g037(.a(new_n99_), .b(new_n95_), .c(new_n84_), .d(new_n96_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n84_), .c(new_n67_), .O(z05));
  ...
  nand2  g053(.a(new_n92_), .b(new_n84_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n84_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(z09));
  nand3  g057(.a(new_n84_), .b(x37), .c(x06), .O(new_n120_));
  nand4  g058(.a(new_n92_), .b(new_n80_), .c(x30), .d(x07), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(x04), .c(new_n120_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x27), .O(new_n123_));
  inv1   g061(.a(x04), .O(new_n124_));
  nand4  g062(.a(new_n93_), .b(x30), .c(x05), .d(new_n124_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n123_), .O(z10));
  inv1   g064(.a(x09), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(x29), .O(new_n128_));
  oai21  g066(.a(new_n89_), .b(x27), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x08), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x04), .c(x30), .O(z11));
  nor3   g070(.a(x37), .b(x36), .c(x35), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n66_), .c(new_n71_), .O(new_n134_));
  inv1   g072(.a(new_n69_), .O(new_n135_));
  oai21  g073(.a(new_n92_), .b(x04), .c(new_n135_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n134_), .c(new_n84_), .O(z12));
  inv1   g075(.a(x13), .O(new_n138_));
  nand2  g076(.a(new_n93_), .b(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x30), .c(x04), .O(new_n140_));
  inv1   g078(.a(x19), .O(new_n141_));
  nand3  g079(.a(new_n69_), .b(x20), .c(new_n141_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(x18), .O(new_n143_));
  or2    g081(.a(new_n143_), .b(new_n140_), .O(z13));
  inv1   g082(.a(x18), .O(new_n145_));
  nand4  g083(.a(x27), .b(x20), .c(new_n141_), .d(new_n145_), .O(new_n146_));
  aoi21  g084(.a(new_n68_), .b(new_n67_), .c(new_n146_), .O(new_n147_));
  nor2   g085(.a(new_n147_), .b(new_n140_), .O(z14));
  nand4  g086(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n84_), .O(z15));
  inv1   g088(.a(x23), .O(new_n151_));
  nand4  g089(.a(new_n84_), .b(new_n151_), .c(x22), .d(x01), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(z16));
  inv1   g091(.a(x01), .O(new_n154_));
  inv1   g092(.a(x24), .O(new_n155_));
  nand4  g093(.a(new_n84_), .b(new_n155_), .c(x23), .d(x22), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(new_n154_), .O(z17));
  nand2  g095(.a(new_n131_), .b(x04), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n77_), .O(z18));
  nand4  g097(.a(new_n130_), .b(new_n77_), .c(new_n127_), .d(x04), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z19));
  inv1   g099(.a(new_n128_), .O(new_n162_));
  nor2   g100(.a(new_n78_), .b(new_n66_), .O(new_n163_));
  aoi21  g101(.a(x28), .b(new_n66_), .c(new_n78_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n162_), .c(new_n163_), .d(x08), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n127_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(x04), .c(x30), .O(z20));
endmodule
