...
module FAU ( 
  ...
  aoi21  g038(.a(new_n98_), .b(new_n66_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n97_), .c(new_n78_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n64_), .c(new_n98_), .O(z05));
  ...
  nand3  g079(.a(new_n98_), .b(new_n81_), .c(new_n129_), .O(new_n142_));
  ...
  nand2  g090(.a(new_n96_), .b(new_n98_), .O(new_n153_));
  ...
  nand4  g093(.a(new_n153_), .b(new_n132_), .c(x20), .d(new_n152_), .O(new_n156_));
  ...
  nand4  g097(.a(new_n159_), .b(x39), .c(new_n147_), .d(new_n72_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x39), .b(new_n147_), .c(new_n72_), .O(new_n162_));
  nand4  g100(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n67_), .c(new_n162_), .O(new_n164_));
  ...
  nand3  g107(.a(new_n169_), .b(new_n164_), .c(new_n64_), .O(z14));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n129_), .O(new_n182_));
  ...
  nand2  g124(.a(new_n134_), .b(new_n130_), .O(new_n187_));
  nor2   g125(.a(new_n132_), .b(new_n131_), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  oai21  g129(.a(new_n180_), .b(new_n83_), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n183_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n64_), .O(z19));
  oai21  g133(.a(new_n129_), .b(new_n66_), .c(new_n191_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n66_), .c(new_n129_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n188_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n183_), .O(new_n199_));
