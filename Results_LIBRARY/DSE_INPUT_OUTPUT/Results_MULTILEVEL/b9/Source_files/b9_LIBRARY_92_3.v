...
module FAU ( 
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n80_), .d(new_n76_), .O(z02));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n70_), .c(new_n97_), .O(z05));
  ...
  nand2  g053(.a(new_n80_), .b(new_n75_), .O(z08));
  nand4  g054(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n80_), .O(z09));
  inv1   g056(.a(x18), .O(new_n119_));
  nand2  g057(.a(x05), .b(new_n65_), .O(new_n120_));
  oai21  g058(.a(new_n120_), .b(new_n75_), .c(new_n119_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(x30), .O(new_n122_));
  ...
  nand3  g064(.a(new_n76_), .b(x32), .c(x05), .O(new_n127_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n122_), .O(z10));
  ...
  nand3  g075(.a(new_n137_), .b(x27), .c(new_n65_), .O(new_n138_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n80_), .O(z12));
  ...
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n82_), .d(new_n148_), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n72_), .b(x20), .c(new_n153_), .d(new_n119_), .O(new_n154_));
  oai21  g092(.a(new_n152_), .b(x04), .c(new_n154_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand2  g094(.a(x30), .b(new_n119_), .O(new_n157_));
  nand2  g095(.a(x32), .b(new_n82_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n157_), .c(new_n149_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n156_), .O(z13));
  nand3  g099(.a(x20), .b(new_n153_), .c(new_n119_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(new_n150_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n84_), .c(x27), .O(new_n165_));
  nor2   g103(.a(x13), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n76_), .c(new_n119_), .O(new_n167_));
  ...
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n119_), .O(new_n171_));
  ...
  nand2  g114(.a(new_n176_), .b(new_n80_), .O(z16));
  ...
  nand2  g119(.a(new_n137_), .b(new_n64_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n133_), .c(new_n136_), .O(new_n183_));
  nand2  g121(.a(new_n138_), .b(new_n132_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n183_), .c(new_n82_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n157_), .O(z18));
  inv1   g124(.a(new_n141_), .O(z19));
  inv1   g125(.a(new_n133_), .O(new_n188_));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(new_n136_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n82_), .c(new_n132_), .O(new_n192_));
