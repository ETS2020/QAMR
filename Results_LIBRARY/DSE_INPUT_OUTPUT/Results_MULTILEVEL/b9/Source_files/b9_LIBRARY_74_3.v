// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:40 2020
...
module FAU ( 
  ...
  oai21  g032(.a(new_n94_), .b(new_n91_), .c(new_n81_), .O(new_n95_));
  ...
  nand3  g043(.a(new_n105_), .b(new_n83_), .c(new_n70_), .O(z05));
  oai21  g044(.a(new_n104_), .b(x37), .c(new_n83_), .O(z06));
  ...
  nand3  g054(.a(new_n116_), .b(new_n83_), .c(x03), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z07));
  aoi21  g056(.a(new_n75_), .b(new_n81_), .c(new_n76_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n83_), .O(z09));
  nor2   g059(.a(new_n87_), .b(x36), .O(new_n122_));
  ...
  nand2  g064(.a(new_n76_), .b(x07), .O(new_n127_));
  ...
  nand4  g068(.a(new_n130_), .b(x40), .c(x39), .d(new_n81_), .O(new_n131_));
  nor2   g069(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  aoi21  g070(.a(new_n128_), .b(x27), .c(new_n132_), .O(new_n133_));
  nand4  g071(.a(new_n76_), .b(x37), .c(x27), .d(x06), .O(new_n134_));
  oai21  g072(.a(new_n133_), .b(x04), .c(new_n134_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  aoi21  g074(.a(x40), .b(x06), .c(x27), .O(new_n137_));
  nand2  g075(.a(new_n87_), .b(new_n65_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n81_), .c(new_n137_), .O(new_n139_));
  aoi21  g077(.a(x39), .b(x29), .c(x06), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n87_), .O(new_n142_));
  oai21  g080(.a(new_n140_), .b(new_n76_), .c(new_n142_), .O(new_n143_));
  oai21  g081(.a(new_n139_), .b(x08), .c(new_n143_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n85_), .c(new_n136_), .O(new_n145_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n149_), .c(new_n82_), .O(new_n151_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(x06), .O(new_n160_));
  nand4  g098(.a(new_n72_), .b(new_n76_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand2  g101(.a(new_n130_), .b(x40), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(new_n75_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n153_), .c(new_n81_), .d(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z13));
  nand3  g105(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n168_));
  nand4  g106(.a(new_n154_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  nand3  g108(.a(new_n77_), .b(new_n153_), .c(new_n65_), .O(new_n171_));
  ...
  aoi21  g113(.a(new_n171_), .b(new_n149_), .c(new_n82_), .O(new_n176_));
  ...
  nand2  g122(.a(new_n184_), .b(new_n83_), .O(z17));
  ...
  nand2  g126(.a(new_n85_), .b(new_n136_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n103_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n77_), .b(x29), .O(new_n191_));
  inv1   g129(.a(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(x08), .c(new_n81_), .O(new_n193_));
  oai21  g131(.a(new_n190_), .b(new_n82_), .c(new_n193_), .O(z18));
  nand2  g132(.a(new_n191_), .b(new_n142_), .O(new_n195_));
  inv1   g133(.a(x08), .O(new_n196_));
  nand2  g134(.a(x35), .b(new_n103_), .O(new_n197_));
  oai21  g135(.a(new_n186_), .b(new_n197_), .c(new_n196_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n195_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n85_), .c(new_n136_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n83_), .O(z19));
  oai21  g139(.a(new_n66_), .b(new_n64_), .c(new_n196_), .O(new_n202_));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n192_), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n85_), .c(new_n136_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n83_), .O(z20));
endmodule
