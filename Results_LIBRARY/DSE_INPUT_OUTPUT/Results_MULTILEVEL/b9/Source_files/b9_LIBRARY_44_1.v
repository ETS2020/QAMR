...
module FAU ( 
  ...
  nor2   g049(.a(new_n67_), .b(new_n70_), .O(z08));
  ...
  aoi21  g061(.a(new_n76_), .b(new_n75_), .c(new_n67_), .O(new_n124_));
  ...
  aoi21  g065(.a(x39), .b(new_n127_), .c(new_n67_), .O(new_n128_));
  ...
  nand3  g091(.a(x40), .b(new_n141_), .c(new_n116_), .O(new_n154_));
  ...
  nand2  g113(.a(x40), .b(x04), .O(new_n176_));
