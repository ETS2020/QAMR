...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_,
    ...
    new_n80_, new_n81_, new_n83_, new_n85_, new_n86_, new_n89_, new_n90_,
  ...
  aoi21  g18(.a(new_n66_), .b(new_n80_), .c(new_n79_), .O(new_n81_));
  aoi21  g19(.a(new_n81_), .b(new_n78_), .c(new_n64_), .O(z03));
  aoi21  g20(.a(new_n66_), .b(new_n80_), .c(x21), .O(new_n83_));
  aoi21  g21(.a(new_n83_), .b(new_n78_), .c(new_n64_), .O(z04));
  inv1   g22(.a(x28), .O(new_n85_));
  oai21  g23(.a(new_n85_), .b(new_n80_), .c(new_n66_), .O(new_n86_));
  ...
  nand2  g46(.a(new_n109_), .b(z02), .O(z10));
  ...
  nand4  g51(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n85_), .O(new_n115_));
  nand4  g52(.a(new_n115_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n116_));
  inv1   g53(.a(new_n116_), .O(z11));
  nand3  g54(.a(new_n68_), .b(z02), .c(x27), .O(z12));
  nand4  g55(.a(new_n68_), .b(z02), .c(x27), .d(x20), .O(new_n119_));
  ...
  aoi21  g60(.a(new_n123_), .b(new_n68_), .c(new_n64_), .O(z14));
  ...
  nand3  g74(.a(new_n137_), .b(x35), .c(new_n85_), .O(new_n138_));
  nand4  g75(.a(new_n138_), .b(z02), .c(new_n71_), .d(new_n111_), .O(z18));
  oai21  g76(.a(new_n113_), .b(new_n72_), .c(z02), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(new_n112_), .c(new_n85_), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n71_), .c(new_n111_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(z02), .O(z19));
  oai21  g80(.a(x28), .b(new_n135_), .c(new_n80_), .O(new_n144_));
  nand2  g81(.a(new_n144_), .b(x35), .O(new_n145_));
  nand4  g82(.a(new_n145_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n146_));
