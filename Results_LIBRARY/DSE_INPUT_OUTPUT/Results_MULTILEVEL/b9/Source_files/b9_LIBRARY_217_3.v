// Benchmark "FAU" written by ABC on Thu Aug 13 18:18:22 2020
...
module FAU ( 
  ...
  aoi21  g039(.a(new_n64_), .b(new_n99_), .c(x21), .O(new_n102_));
  ...
  nand2  g059(.a(new_n121_), .b(new_n70_), .O(new_n122_));
  ...
  nand3  g064(.a(new_n94_), .b(x32), .c(x05), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n70_), .O(new_n129_));
  nand3  g067(.a(x37), .b(x27), .c(x06), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n123_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x40), .b(x39), .c(x29), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(new_n134_));
  nand2  g072(.a(new_n82_), .b(new_n78_), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n81_), .c(x27), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n78_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n70_), .c(x08), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n137_), .c(new_n132_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n63_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n99_), .c(new_n72_), .O(new_n144_));
  oai21  g082(.a(new_n93_), .b(x04), .c(new_n67_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n63_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x40), .c(x39), .d(new_n147_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand4  g090(.a(new_n66_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(x04), .O(new_n154_));
  nand4  g092(.a(new_n66_), .b(new_n78_), .c(x20), .d(new_n152_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  aoi21  g095(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n147_), .d(new_n70_), .O(new_n159_));
  ...
  nand3  g101(.a(new_n94_), .b(new_n147_), .c(new_n70_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(new_n161_), .O(new_n165_));
  inv1   g103(.a(x35), .O(new_n166_));
  nand3  g104(.a(new_n64_), .b(new_n166_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n79_), .c(new_n78_), .O(new_n169_));
  aoi21  g107(.a(new_n164_), .b(new_n67_), .c(new_n96_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n165_), .O(z14));
  inv1   g109(.a(x12), .O(new_n172_));
  nand4  g110(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n172_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x22), .c(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n63_), .O(z16));
  inv1   g115(.a(x24), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(x23), .c(x22), .d(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n63_), .O(z17));
  nand2  g118(.a(new_n139_), .b(new_n70_), .O(new_n181_));
  inv1   g119(.a(x08), .O(new_n182_));
  nand3  g120(.a(x35), .b(new_n81_), .c(new_n99_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n133_), .c(new_n182_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(x09), .c(new_n78_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n181_), .O(z18));
  oai21  g124(.a(new_n166_), .b(new_n99_), .c(new_n182_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n99_), .c(new_n166_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n134_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n78_), .c(new_n132_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z20));
  nand2  g129(.a(new_n141_), .b(new_n63_), .O(z19));
endmodule
