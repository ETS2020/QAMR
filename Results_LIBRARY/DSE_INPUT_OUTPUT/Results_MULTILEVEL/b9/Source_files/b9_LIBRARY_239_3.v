...
module FAU ( 
  ...
  nand3  g018(.a(new_n80_), .b(new_n76_), .c(x16), .O(z00));
  ...
  aoi21  g026(.a(new_n88_), .b(x04), .c(new_n79_), .O(z01));
  ...
  oai21  g031(.a(new_n93_), .b(new_n90_), .c(new_n77_), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(x40), .O(z02));
  inv1   g033(.a(x37), .O(new_n96_));
  aoi21  g034(.a(x35), .b(x28), .c(new_n64_), .O(new_n97_));
  aoi21  g035(.a(new_n96_), .b(new_n64_), .c(new_n97_), .O(new_n98_));
  oai21  g036(.a(new_n98_), .b(x40), .c(x21), .O(z03));
  nand2  g037(.a(new_n78_), .b(x21), .O(new_n100_));
  oai21  g038(.a(new_n98_), .b(new_n79_), .c(new_n100_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n80_), .c(new_n96_), .O(z05));
  ...
  nand2  g052(.a(new_n114_), .b(new_n80_), .O(z07));
  inv1   g053(.a(x39), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n77_), .c(new_n78_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n80_), .O(z09));
  ...
  nand3  g060(.a(new_n122_), .b(new_n86_), .c(x27), .O(new_n123_));
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n80_), .O(z10));
  inv1   g068(.a(x08), .O(new_n131_));
  inv1   g069(.a(x09), .O(new_n132_));
  nand4  g070(.a(new_n82_), .b(new_n132_), .c(new_n131_), .d(x04), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n77_), .O(new_n134_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n85_), .c(new_n136_), .O(new_n138_));
  oai21  g076(.a(new_n85_), .b(new_n64_), .c(new_n131_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n82_), .c(new_n132_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n135_), .O(z11));
  nor2   g080(.a(new_n70_), .b(new_n64_), .O(new_n143_));
  nand3  g081(.a(new_n96_), .b(new_n67_), .c(new_n66_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n65_), .c(new_n143_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n77_), .O(new_n147_));
  oai21  g085(.a(new_n143_), .b(x40), .c(new_n147_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n78_), .O(new_n151_));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n152_), .c(x21), .O(new_n157_));
  nand4  g095(.a(new_n155_), .b(new_n78_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand4  g098(.a(new_n125_), .b(new_n77_), .c(new_n149_), .d(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  nand4  g101(.a(new_n150_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n164_));
  ...
  nand4  g110(.a(new_n172_), .b(new_n170_), .c(new_n167_), .d(new_n80_), .O(z14));
  nand4  g111(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n80_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(x22), .c(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n80_), .O(z16));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n80_), .O(z17));
  oai21  g119(.a(new_n85_), .b(x27), .c(new_n136_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n79_), .b(x09), .O(new_n184_));
  nand4  g122(.a(x35), .b(new_n84_), .c(x27), .d(new_n65_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n82_), .O(z18));
  ...
  nand2  g127(.a(new_n189_), .b(new_n80_), .O(z19));
  ...
  nand3  g132(.a(new_n194_), .b(new_n82_), .c(new_n132_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n80_), .O(z20));
endmodule
