...
module FAU ( 
  ...
  nand3  g028(.a(new_n90_), .b(new_n86_), .c(new_n81_), .O(new_n91_));
  nand3  g029(.a(new_n91_), .b(new_n85_), .c(x04), .O(z01));
  ...
  nand3  g035(.a(new_n97_), .b(new_n95_), .c(x40), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(x39), .O(new_n99_));
  oai21  g037(.a(x39), .b(x30), .c(new_n99_), .O(z02));
  ...
  aoi21  g041(.a(new_n103_), .b(new_n101_), .c(new_n82_), .O(z03));
  nand2  g042(.a(new_n70_), .b(new_n64_), .O(new_n105_));
  nand4  g043(.a(new_n105_), .b(new_n101_), .c(new_n85_), .d(new_n102_), .O(z04));
  nor2   g044(.a(new_n87_), .b(new_n64_), .O(new_n107_));
  inv1   g045(.a(new_n107_), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n85_), .c(new_n70_), .O(z05));
  oai21  g047(.a(new_n107_), .b(x37), .c(new_n85_), .O(z06));
  ...
  nand2  g059(.a(new_n121_), .b(new_n85_), .O(z07));
  inv1   g060(.a(x11), .O(new_n123_));
  nand4  g061(.a(new_n85_), .b(x34), .c(x27), .d(x26), .O(new_n124_));
  nor2   g062(.a(new_n124_), .b(new_n123_), .O(z09));
  nand2  g063(.a(x40), .b(x05), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(x04), .c(x39), .O(new_n127_));
  ...
  nand3  g069(.a(new_n131_), .b(new_n89_), .c(x27), .O(new_n132_));
  nand3  g070(.a(z08), .b(x32), .c(x05), .O(new_n133_));
  ...
  aoi22  g088(.a(new_n72_), .b(x27), .c(x40), .d(new_n65_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(x39), .O(new_n152_));
  inv1   g090(.a(x39), .O(new_n153_));
  nand2  g091(.a(new_n72_), .b(x27), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n153_), .c(new_n81_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n152_), .O(z12));
  inv1   g094(.a(x13), .O(new_n157_));
  inv1   g095(.a(x40), .O(new_n158_));
  nand2  g096(.a(x36), .b(x35), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x28), .c(new_n158_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n157_), .d(new_n65_), .O(new_n161_));
  ...
  oai21  g104(.a(new_n153_), .b(new_n86_), .c(new_n81_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x40), .c(new_n157_), .d(new_n65_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n166_), .c(new_n85_), .O(z13));
  nand3  g107(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n170_));
  nand4  g108(.a(new_n159_), .b(new_n86_), .c(new_n81_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  nand3  g110(.a(z08), .b(new_n157_), .c(new_n65_), .O(new_n173_));
  ...
  nand3  g114(.a(new_n176_), .b(new_n86_), .c(new_n81_), .O(new_n177_));
  aoi21  g115(.a(new_n173_), .b(new_n154_), .c(new_n82_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n174_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nor2   g118(.a(new_n124_), .b(new_n180_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x22), .c(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n85_), .O(z16));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(x23), .c(x22), .d(x01), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n85_), .O(z17));
  oai21  g125(.a(new_n88_), .b(x27), .c(new_n139_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n144_), .c(new_n81_), .d(new_n138_), .O(z18));
  nand2  g128(.a(x40), .b(x29), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n141_), .O(new_n192_));
  oai21  g130(.a(new_n153_), .b(new_n143_), .c(new_n66_), .O(new_n193_));
  nand3  g131(.a(new_n87_), .b(x27), .c(new_n65_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n143_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n193_), .c(new_n192_), .O(new_n196_));
  aoi21  g134(.a(new_n140_), .b(new_n87_), .c(x39), .O(new_n197_));
  aoi21  g135(.a(new_n196_), .b(new_n81_), .c(new_n197_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(x09), .c(new_n85_), .O(z19));
  inv1   g137(.a(new_n139_), .O(new_n200_));
  oai21  g138(.a(new_n66_), .b(new_n64_), .c(new_n143_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n81_), .c(new_n138_), .O(new_n204_));
