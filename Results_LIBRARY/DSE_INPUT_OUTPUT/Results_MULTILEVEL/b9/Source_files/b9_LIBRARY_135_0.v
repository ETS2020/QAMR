...
module FAU ( 
  ...
  nand3  g039(.a(new_n101_), .b(new_n88_), .c(new_n96_), .O(z05));
  ...
  nand3  g051(.a(new_n113_), .b(new_n88_), .c(x03), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z07));
  inv1   g053(.a(x39), .O(new_n116_));
  inv1   g054(.a(x40), .O(new_n117_));
  nor3   g055(.a(new_n78_), .b(new_n117_), .c(new_n116_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n88_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n119_), .O(z09));
  nand4  g059(.a(new_n84_), .b(new_n72_), .c(x27), .d(x07), .O(new_n122_));
  aoi21  g060(.a(new_n73_), .b(x05), .c(new_n81_), .O(new_n123_));
  ...
  oai21  g067(.a(new_n83_), .b(x27), .c(new_n129_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x08), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x04), .c(x30), .O(z11));
  nand3  g071(.a(new_n96_), .b(new_n67_), .c(new_n66_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(x27), .c(x10), .O(new_n135_));
  nor2   g073(.a(new_n70_), .b(new_n64_), .O(new_n136_));
  nor2   g074(.a(new_n136_), .b(new_n73_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n135_), .c(x30), .O(new_n138_));
  oai21  g076(.a(new_n70_), .b(new_n64_), .c(x04), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  aoi21  g079(.a(new_n73_), .b(new_n141_), .c(new_n81_), .O(new_n142_));
  inv1   g080(.a(x18), .O(new_n143_));
  inv1   g081(.a(x19), .O(new_n144_));
  nand4  g082(.a(new_n136_), .b(x20), .c(new_n144_), .d(new_n143_), .O(new_n145_));
  oai21  g083(.a(new_n142_), .b(x04), .c(new_n145_), .O(z13));
  nand2  g084(.a(new_n141_), .b(new_n65_), .O(new_n147_));
  nand4  g085(.a(x27), .b(x20), .c(new_n144_), .d(new_n143_), .O(new_n148_));
  oai22  g086(.a(new_n148_), .b(new_n70_), .c(new_n147_), .d(new_n72_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n88_), .O(z14));
  nand4  g088(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n88_), .O(z15));
  inv1   g090(.a(x23), .O(new_n153_));
  nand4  g091(.a(new_n88_), .b(new_n153_), .c(x22), .d(x01), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(z16));
  inv1   g093(.a(x01), .O(new_n156_));
  inv1   g094(.a(x24), .O(new_n157_));
  nand4  g095(.a(new_n88_), .b(new_n157_), .c(x23), .d(x22), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(new_n156_), .O(z17));
  nand2  g097(.a(new_n132_), .b(x04), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n81_), .O(z18));
  nand3  g099(.a(x35), .b(new_n82_), .c(new_n64_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n129_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n81_), .c(new_n128_), .d(x04), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z19));
  inv1   g104(.a(new_n129_), .O(new_n167_));
  aoi21  g105(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n168_));
  nor2   g106(.a(new_n66_), .b(new_n64_), .O(new_n169_));
  oai22  g107(.a(new_n169_), .b(x08), .c(new_n168_), .d(new_n167_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n81_), .c(new_n128_), .d(x04), .O(new_n171_));
