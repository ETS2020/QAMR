...
module FAU ( 
  ...
  aoi21  g058(.a(new_n75_), .b(new_n74_), .c(new_n67_), .O(new_n121_));
  ...
  aoi21  g094(.a(new_n143_), .b(new_n116_), .c(new_n142_), .O(new_n157_));
  ...
  nand2  g116(.a(new_n74_), .b(new_n127_), .O(new_n179_));
  aoi21  g117(.a(new_n178_), .b(new_n77_), .c(new_n179_), .O(new_n180_));
  oai22  g118(.a(new_n180_), .b(new_n71_), .c(new_n174_), .d(new_n84_), .O(z18));
  oai21  g119(.a(new_n176_), .b(new_n78_), .c(new_n131_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n130_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n74_), .c(new_n127_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n98_), .O(z19));
  nor2   g123(.a(new_n67_), .b(new_n128_), .O(new_n186_));
  oai21  g124(.a(new_n175_), .b(new_n92_), .c(new_n131_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n92_), .c(new_n175_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n74_), .c(new_n127_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n98_), .O(z20));
