...
module FAU ( 
  ...
  nand2  g030(.a(x35), .b(new_n82_), .O(new_n93_));
  ...
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n80_), .d(x21), .O(z03));
  ...
  nand3  g041(.a(new_n102_), .b(new_n80_), .c(new_n70_), .O(new_n104_));
  ...
  nand3  g063(.a(x37), .b(new_n82_), .c(x06), .O(new_n126_));
  ...
  oai21  g074(.a(new_n64_), .b(new_n65_), .c(new_n136_), .O(new_n137_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n82_), .c(x04), .O(new_n150_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(x04), .O(new_n159_));
  nand4  g097(.a(new_n72_), .b(new_n82_), .c(x20), .d(new_n157_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n131_), .b(new_n152_), .c(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n162_), .O(z13));
  nand3  g102(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n165_));
  nand3  g103(.a(new_n153_), .b(new_n83_), .c(x28), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n65_), .c(x30), .O(new_n167_));
  aoi21  g105(.a(new_n76_), .b(new_n152_), .c(x04), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  aoi21  g107(.a(x32), .b(new_n65_), .c(x27), .O(new_n170_));
  nand2  g108(.a(new_n71_), .b(x04), .O(new_n171_));
  nand3  g109(.a(new_n66_), .b(new_n83_), .c(x28), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(x37), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n170_), .c(new_n82_), .O(new_n174_));
  nand2  g112(.a(new_n76_), .b(new_n152_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n149_), .c(new_n65_), .O(new_n176_));
