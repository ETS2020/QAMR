...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(new_n66_), .c(x10), .d(new_n74_), .O(new_n78_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x10), .O(new_n93_));
  ...
  nand4  g065(.a(new_n127_), .b(x10), .c(x05), .d(new_n74_), .O(new_n128_));
  ...
  nand2  g070(.a(new_n132_), .b(x10), .O(new_n133_));
  ...
  oai21  g077(.a(new_n84_), .b(new_n96_), .c(new_n130_), .O(new_n140_));
  ...
  nor3   g081(.a(new_n76_), .b(new_n75_), .c(x04), .O(new_n144_));
  ...
  nand4  g086(.a(new_n148_), .b(x39), .c(new_n146_), .d(new_n74_), .O(new_n149_));
  inv1   g087(.a(x18), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n70_), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n63_), .O(new_n153_));
  nand4  g091(.a(new_n70_), .b(new_n76_), .c(x20), .d(new_n151_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  nand4  g094(.a(new_n127_), .b(new_n146_), .c(x10), .d(new_n74_), .O(new_n157_));
  ...
  oai21  g117(.a(new_n84_), .b(x27), .c(new_n135_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n96_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n136_), .c(x30), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n64_), .d(new_n131_), .O(z18));
  nand2  g122(.a(new_n64_), .b(new_n96_), .O(new_n185_));
  oai21  g123(.a(new_n84_), .b(x04), .c(x10), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(x08), .O(new_n187_));
  nand2  g125(.a(x39), .b(x29), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(x10), .c(new_n76_), .O(new_n189_));
  aoi21  g127(.a(new_n137_), .b(new_n136_), .c(new_n189_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n187_), .c(new_n80_), .O(new_n191_));
  nor2   g129(.a(new_n191_), .b(x09), .O(z19));
  aoi21  g130(.a(x28), .b(new_n96_), .c(new_n164_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n189_), .O(new_n194_));
  oai21  g132(.a(new_n164_), .b(new_n96_), .c(x10), .O(new_n195_));
  nand2  g133(.a(new_n76_), .b(new_n96_), .O(new_n196_));
