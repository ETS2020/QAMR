...
module FAU ( 
  ...
  nand2  g24(.a(new_n85_), .b(new_n67_), .O(new_n87_));
  nand2  g25(.a(new_n87_), .b(z02), .O(z06));
  ...
  nand3  g43(.a(new_n75_), .b(x07), .c(new_n105_), .O(new_n106_));
  ...
  nand4  g54(.a(new_n116_), .b(z02), .c(new_n72_), .d(new_n111_), .O(new_n117_));
  inv1   g55(.a(new_n117_), .O(z11));
  nor2   g56(.a(new_n69_), .b(z08), .O(z12));
  inv1   g57(.a(x19), .O(new_n120_));
  nand3  g58(.a(new_n69_), .b(x20), .c(new_n120_), .O(new_n121_));
  oai21  g59(.a(new_n121_), .b(x18), .c(z02), .O(z13));
  nand2  g60(.a(new_n68_), .b(new_n67_), .O(new_n123_));
  nor2   g61(.a(x19), .b(x18), .O(new_n124_));
  nor2   g62(.a(z08), .b(new_n66_), .O(new_n125_));
  nand4  g63(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(x20), .O(z14));
  ...
  nand4  g77(.a(new_n139_), .b(z02), .c(new_n72_), .d(new_n111_), .O(z18));
  oai21  g78(.a(new_n114_), .b(new_n73_), .c(z02), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n113_), .c(new_n112_), .O(new_n142_));
  nand3  g80(.a(new_n142_), .b(new_n72_), .c(new_n111_), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(z02), .O(z19));
  oai21  g82(.a(x28), .b(new_n136_), .c(new_n66_), .O(new_n145_));
  nand2  g83(.a(new_n145_), .b(x35), .O(new_n146_));
  nand4  g84(.a(new_n146_), .b(z02), .c(new_n72_), .d(new_n111_), .O(new_n147_));
