...
module FAU ( 
  ...
  nand4  g064(.a(x40), .b(x39), .c(new_n72_), .d(x05), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n82_), .O(new_n128_));
  nand3  g066(.a(new_n63_), .b(x37), .c(x06), .O(new_n129_));
  inv1   g067(.a(new_n129_), .O(new_n130_));
  aoi21  g068(.a(new_n128_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  ...
  oai21  g074(.a(new_n131_), .b(new_n67_), .c(new_n136_), .O(z10));
  ...
  aoi21  g079(.a(x39), .b(x29), .c(x33), .O(new_n142_));
  ...
  nor2   g089(.a(new_n74_), .b(new_n132_), .O(new_n152_));
  ...
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n156_), .d(new_n125_), .O(new_n159_));
  ...
  nand4  g103(.a(new_n133_), .b(x39), .c(new_n156_), .d(new_n125_), .O(new_n166_));
  ...
  nand3  g110(.a(new_n152_), .b(new_n156_), .c(new_n125_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(new_n170_), .O(new_n174_));
  inv1   g112(.a(x35), .O(new_n175_));
  nand3  g113(.a(new_n68_), .b(new_n175_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n80_), .c(new_n79_), .O(new_n178_));
  aoi21  g116(.a(new_n173_), .b(new_n151_), .c(new_n64_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n178_), .c(new_n174_), .O(z14));
  ...
  nand2  g126(.a(x27), .b(new_n125_), .O(new_n189_));
  nand2  g127(.a(new_n67_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n175_), .O(new_n191_));
  nand2  g129(.a(new_n79_), .b(new_n138_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n81_), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n152_), .b(new_n72_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n88_), .c(new_n193_), .d(new_n64_), .O(z18));
  nor2   g133(.a(new_n142_), .b(new_n74_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n67_), .c(new_n175_), .O(new_n197_));
  aoi21  g135(.a(new_n175_), .b(new_n72_), .c(new_n139_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(x08), .c(new_n197_), .d(new_n196_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n79_), .c(new_n138_), .O(new_n200_));
  inv1   g138(.a(new_n200_), .O(z20));
  inv1   g139(.a(new_n147_), .O(z19));
endmodule
