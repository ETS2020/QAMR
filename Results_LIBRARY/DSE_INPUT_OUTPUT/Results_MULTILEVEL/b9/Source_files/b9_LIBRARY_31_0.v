...
module FAU ( 
  ...
  nand2  g034(.a(new_n70_), .b(new_n69_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n65_), .d(x21), .O(z03));
  aoi21  g036(.a(new_n70_), .b(new_n69_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n66_), .O(z04));
  nor2   g038(.a(new_n83_), .b(new_n69_), .O(new_n101_));
  ...
  nand3  g075(.a(new_n133_), .b(x27), .c(new_n74_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n80_), .c(new_n130_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n65_), .O(z11));
  nand3  g080(.a(new_n70_), .b(new_n82_), .c(new_n132_), .O(new_n143_));
  ...
  inv1   g084(.a(new_n72_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(x40), .c(new_n63_), .O(new_n148_));
  ...
  nand4  g104(.a(x40), .b(x39), .c(new_n150_), .d(new_n74_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n70_), .b(new_n132_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n81_), .c(new_n80_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n147_), .c(new_n66_), .O(new_n172_));
  ...
  oai21  g120(.a(new_n84_), .b(x27), .c(new_n131_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n66_), .b(x30), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n138_), .d(new_n130_), .O(z18));
  nand2  g124(.a(new_n65_), .b(new_n69_), .O(new_n187_));
  nand3  g125(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n188_));
  ...
  aoi22  g130(.a(new_n192_), .b(new_n94_), .c(new_n134_), .d(new_n133_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n190_), .c(new_n80_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(x09), .O(z19));
  inv1   g133(.a(new_n131_), .O(new_n196_));
  oai21  g134(.a(new_n132_), .b(new_n69_), .c(new_n137_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n69_), .c(new_n132_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n130_), .O(new_n200_));
