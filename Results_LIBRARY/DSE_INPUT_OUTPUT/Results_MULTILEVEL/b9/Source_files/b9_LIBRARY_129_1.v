...
module FAU ( 
  ...
  oai21  g039(.a(new_n80_), .b(new_n68_), .c(new_n97_), .O(new_n102_));
  ...
  aoi21  g054(.a(new_n116_), .b(x32), .c(new_n73_), .O(z08));
  ...
  nand4  g060(.a(new_n122_), .b(new_n82_), .c(x27), .d(x07), .O(new_n123_));
  ...
  nand2  g070(.a(new_n78_), .b(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n131_), .c(x32), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x40), .O(new_n135_));
  nand2  g073(.a(new_n124_), .b(x29), .O(new_n136_));
  nor2   g074(.a(new_n94_), .b(x28), .O(new_n137_));
  ...
  oai21  g078(.a(new_n81_), .b(new_n68_), .c(new_n130_), .O(new_n141_));
  ...
  nand3  g082(.a(new_n97_), .b(new_n79_), .c(new_n94_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n121_), .c(new_n70_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x32), .O(new_n148_));
  oai21  g086(.a(new_n69_), .b(new_n68_), .c(new_n73_), .O(new_n149_));
  ...
  nand3  g092(.a(x39), .b(new_n154_), .c(new_n121_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x32), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x40), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n153_), .O(z13));
  nand2  g096(.a(new_n154_), .b(new_n121_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n160_));
  oai22  g098(.a(new_n160_), .b(new_n69_), .c(new_n159_), .d(new_n122_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n64_), .O(z14));
  inv1   g100(.a(x12), .O(new_n163_));
  nor2   g101(.a(new_n119_), .b(new_n163_), .O(z15));
  inv1   g102(.a(x23), .O(new_n165_));
  nand4  g103(.a(new_n64_), .b(new_n165_), .c(x22), .d(x01), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z16));
  inv1   g105(.a(x01), .O(new_n168_));
  inv1   g106(.a(x24), .O(new_n169_));
  nand4  g107(.a(new_n64_), .b(new_n169_), .c(x23), .d(x22), .O(new_n170_));
  nor2   g108(.a(new_n170_), .b(new_n168_), .O(z17));
  nand2  g109(.a(x27), .b(new_n121_), .O(new_n172_));
  nand2  g110(.a(new_n68_), .b(x08), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(new_n94_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n80_), .c(new_n133_), .O(new_n175_));
  nand2  g113(.a(new_n124_), .b(x32), .O(new_n176_));
  oai22  g114(.a(new_n176_), .b(new_n87_), .c(new_n175_), .d(new_n65_), .O(z18));
  nand2  g115(.a(new_n64_), .b(new_n68_), .O(new_n178_));
  nand2  g116(.a(x40), .b(x04), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(x35), .c(new_n80_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x32), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n178_), .c(x08), .O(new_n182_));
  nand2  g120(.a(x39), .b(x29), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(x32), .c(new_n73_), .O(new_n184_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n184_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n182_), .c(new_n78_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z19));
  inv1   g125(.a(new_n136_), .O(new_n188_));
  oai21  g126(.a(new_n94_), .b(new_n68_), .c(new_n130_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n68_), .c(new_n94_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n78_), .c(new_n132_), .O(new_n192_));
