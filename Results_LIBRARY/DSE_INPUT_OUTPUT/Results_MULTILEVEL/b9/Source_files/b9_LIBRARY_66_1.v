...
module FAU ( 
  ...
  aoi21  g035(.a(new_n97_), .b(new_n66_), .c(new_n96_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n93_), .O(z03));
  nand2  g037(.a(new_n97_), .b(new_n66_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n95_), .c(new_n64_), .d(new_n96_), .O(z04));
  ...
  nand3  g060(.a(new_n122_), .b(new_n83_), .c(new_n72_), .O(new_n123_));
  ...
  aoi21  g064(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(x39), .c(x05), .d(new_n72_), .O(new_n128_));
  ...
  nand4  g075(.a(new_n137_), .b(x35), .c(new_n136_), .d(x27), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n79_), .c(new_n130_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n64_), .O(z11));
  nand3  g080(.a(new_n97_), .b(new_n82_), .c(new_n81_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  nor2   g082(.a(new_n68_), .b(new_n72_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x39), .O(new_n146_));
  oai21  g084(.a(new_n68_), .b(x40), .c(new_n146_), .O(z12));
  ...
  nand2  g091(.a(new_n94_), .b(new_n97_), .O(new_n154_));
  ...
  nand3  g095(.a(new_n157_), .b(new_n148_), .c(new_n72_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x39), .c(new_n74_), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n156_), .O(z13));
  nand3  g098(.a(x40), .b(new_n148_), .c(new_n72_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n67_), .c(new_n161_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n136_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n80_), .c(new_n79_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n163_), .c(new_n64_), .O(z14));
  ...
  nand2  g119(.a(new_n79_), .b(new_n130_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n136_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n93_), .c(new_n121_), .d(new_n88_), .O(z18));
  inv1   g122(.a(x29), .O(new_n185_));
  aoi21  g123(.a(x39), .b(new_n185_), .c(new_n74_), .O(new_n186_));
  aoi21  g124(.a(new_n132_), .b(new_n89_), .c(new_n186_), .O(new_n187_));
  nand2  g125(.a(new_n64_), .b(new_n66_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n136_), .c(new_n72_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x39), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n188_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n187_), .c(new_n79_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z19));
  aoi21  g131(.a(x28), .b(new_n66_), .c(new_n81_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n186_), .O(new_n195_));
  nand2  g133(.a(x39), .b(new_n81_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n188_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n79_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z20));
  buf    g137(.a(x40), .O(z08));
endmodule
