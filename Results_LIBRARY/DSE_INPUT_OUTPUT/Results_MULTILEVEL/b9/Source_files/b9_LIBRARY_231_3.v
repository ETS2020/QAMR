...
module FAU ( 
  ...
  inv1   g21(.a(x28), .O(new_n85_));
  oai21  g22(.a(new_n85_), .b(new_n66_), .c(new_n67_), .O(new_n86_));
  ...
  nand2  g46(.a(new_n109_), .b(new_n63_), .O(z10));
  ...
  nand4  g52(.a(new_n115_), .b(new_n63_), .c(new_n72_), .d(new_n111_), .O(new_n116_));
  inv1   g53(.a(new_n116_), .O(z11));
  nor2   g54(.a(new_n69_), .b(z08), .O(z12));
  inv1   g55(.a(x18), .O(new_n119_));
  inv1   g56(.a(x19), .O(new_n120_));
  nand4  g57(.a(new_n69_), .b(x20), .c(new_n120_), .d(new_n119_), .O(new_n121_));
  nand2  g58(.a(new_n121_), .b(new_n63_), .O(z13));
  nand4  g59(.a(x27), .b(x20), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  aoi21  g60(.a(new_n68_), .b(new_n67_), .c(new_n123_), .O(new_n124_));
  nor2   g61(.a(new_n124_), .b(z08), .O(z14));
  nand4  g62(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n126_));
  nand2  g63(.a(new_n126_), .b(new_n63_), .O(z15));
  inv1   g64(.a(x23), .O(new_n128_));
  nand4  g65(.a(new_n63_), .b(new_n128_), .c(x22), .d(x01), .O(new_n129_));
  inv1   g66(.a(new_n129_), .O(z16));
  inv1   g67(.a(x24), .O(new_n131_));
  nand4  g68(.a(new_n131_), .b(x23), .c(x22), .d(x01), .O(new_n132_));
  nand2  g69(.a(new_n132_), .b(new_n63_), .O(z17));
  nand2  g70(.a(x27), .b(new_n105_), .O(new_n134_));
  oai21  g71(.a(x27), .b(new_n113_), .c(new_n134_), .O(new_n135_));
  nand3  g72(.a(new_n135_), .b(x35), .c(new_n85_), .O(new_n136_));
  nand4  g73(.a(new_n136_), .b(new_n63_), .c(new_n72_), .d(new_n111_), .O(z18));
  oai21  g74(.a(x28), .b(new_n113_), .c(new_n66_), .O(new_n138_));
  nand2  g75(.a(new_n138_), .b(x35), .O(new_n139_));
  nand4  g76(.a(new_n139_), .b(new_n63_), .c(new_n72_), .d(new_n111_), .O(new_n140_));
  inv1   g77(.a(new_n140_), .O(z20));
  one    g78(.O(z02));
