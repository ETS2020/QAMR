...
module FAU ( 
  ...
  nand4  g075(.a(x35), .b(new_n82_), .c(x27), .d(new_n67_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n88_), .c(new_n80_), .d(new_n133_), .O(new_n141_));
  ...
  oai21  g086(.a(new_n69_), .b(new_n68_), .c(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n126_), .c(new_n64_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x40), .c(x39), .d(new_n148_), .O(new_n152_));
  nor2   g090(.a(new_n152_), .b(x04), .O(z13));
  nand3  g091(.a(new_n150_), .b(new_n81_), .c(new_n80_), .O(new_n154_));
  nand3  g092(.a(new_n75_), .b(new_n148_), .c(new_n67_), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n154_), .c(new_n64_), .O(z14));
  nand4  g095(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n88_), .O(z15));
  ...
  nand2  g102(.a(new_n164_), .b(new_n88_), .O(z17));
  oai21  g103(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n166_));
  nand3  g104(.a(new_n138_), .b(new_n80_), .c(new_n133_), .O(new_n167_));
  aoi21  g105(.a(new_n166_), .b(x08), .c(new_n167_), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(new_n64_), .O(z18));
  oai21  g107(.a(new_n68_), .b(new_n66_), .c(new_n137_), .O(new_n170_));
  nand2  g108(.a(new_n134_), .b(new_n68_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(new_n64_), .O(new_n172_));
  oai21  g110(.a(x28), .b(x04), .c(new_n137_), .O(new_n173_));
  oai21  g111(.a(new_n135_), .b(x28), .c(new_n134_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n172_), .c(new_n80_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(x09), .c(new_n88_), .O(z19));
  inv1   g115(.a(new_n134_), .O(new_n178_));
  aoi21  g116(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n178_), .c(new_n170_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n88_), .c(new_n80_), .d(new_n133_), .O(new_n181_));
