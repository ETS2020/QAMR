...
module FAU ( 
  ...
  nor2   g066(.a(new_n113_), .b(new_n128_), .O(new_n129_));
  ...
  nand4  g073(.a(new_n135_), .b(x35), .c(new_n81_), .d(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n78_), .c(new_n127_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n64_), .O(z11));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n94_), .c(new_n73_), .O(new_n142_));
  oai21  g080(.a(new_n113_), .b(x04), .c(new_n68_), .O(new_n143_));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n148_), .c(new_n94_), .O(new_n152_));
  nand3  g090(.a(new_n121_), .b(new_n145_), .c(new_n71_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x40), .c(new_n113_), .O(new_n154_));
  ...
  oai21  g096(.a(new_n156_), .b(new_n113_), .c(new_n158_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n82_), .b(x27), .c(new_n130_), .O(new_n175_));
  ...
  aoi21  g117(.a(x40), .b(new_n128_), .c(new_n113_), .O(new_n180_));
  aoi21  g118(.a(new_n131_), .b(new_n89_), .c(new_n180_), .O(new_n181_));
  nand2  g119(.a(new_n64_), .b(new_n94_), .O(new_n182_));
  nand3  g120(.a(new_n135_), .b(x35), .c(new_n81_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x40), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n182_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n181_), .c(new_n78_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z19));
  oai21  g125(.a(new_n88_), .b(new_n94_), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n94_), .c(new_n88_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n129_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n78_), .c(new_n127_), .O(new_n191_));
