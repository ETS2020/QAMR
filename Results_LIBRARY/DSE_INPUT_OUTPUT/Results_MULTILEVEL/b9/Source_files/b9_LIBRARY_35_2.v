...
module FAU ( 
  ...
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n81_), .O(z05));
  ...
  nand3  g061(.a(new_n123_), .b(new_n88_), .c(x27), .O(new_n124_));
  ...
  oai21  g073(.a(new_n135_), .b(new_n87_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand2  g075(.a(x27), .b(new_n65_), .O(new_n138_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n82_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n149_), .O(new_n157_));
  nand4  g095(.a(new_n72_), .b(new_n80_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n127_), .b(new_n150_), .c(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand3  g100(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  nand4  g101(.a(new_n151_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n164_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n146_), .c(new_n81_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n82_), .O(z15));
  nand2  g112(.a(x22), .b(x01), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(x23), .O(z16));
  nor4   g114(.a(new_n175_), .b(new_n149_), .c(x24), .d(new_n80_), .O(z17));
  nand2  g115(.a(new_n64_), .b(x08), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n138_), .c(new_n66_), .O(new_n179_));
  nand2  g117(.a(new_n84_), .b(new_n133_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(new_n86_), .c(new_n180_), .O(new_n181_));
  oai22  g119(.a(new_n181_), .b(new_n81_), .c(new_n93_), .d(new_n75_), .O(z18));
  inv1   g120(.a(new_n134_), .O(new_n183_));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n84_), .c(new_n133_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n82_), .O(z20));
  nand2  g126(.a(new_n141_), .b(new_n82_), .O(z19));
endmodule
