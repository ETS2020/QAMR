...
module FAU ( 
  ...
  inv1   g033(.a(x06), .O(new_n96_));
  nand2  g034(.a(new_n76_), .b(new_n96_), .O(new_n97_));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n70_), .c(new_n100_), .O(z05));
  ...
  nor2   g062(.a(new_n85_), .b(x36), .O(new_n125_));
  aoi21  g063(.a(x40), .b(x39), .c(x06), .O(new_n126_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n128_), .c(new_n125_), .O(new_n130_));
  ...
  nand4  g072(.a(x40), .b(x37), .c(x27), .d(x06), .O(new_n135_));
  ...
  nor2   g103(.a(new_n164_), .b(x06), .O(new_n166_));
  ...
  inv1   g107(.a(new_n97_), .O(new_n170_));
  nand3  g108(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n171_));
  nand4  g109(.a(new_n159_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n172_));
  ...
  aoi21  g130(.a(new_n192_), .b(new_n145_), .c(new_n66_), .O(new_n193_));
  nand2  g131(.a(new_n83_), .b(new_n137_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n143_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n100_), .c(new_n90_), .d(new_n120_), .O(z18));
  oai22  g134(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n96_), .O(new_n198_));
  nand2  g136(.a(new_n139_), .b(new_n143_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n138_), .O(new_n200_));
  nand2  g138(.a(x35), .b(x27), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(x04), .c(new_n142_), .O(new_n202_));
  ...
  nand2  g144(.a(x28), .b(new_n142_), .O(new_n207_));
  nand4  g145(.a(new_n207_), .b(new_n206_), .c(new_n200_), .d(new_n198_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n83_), .c(new_n137_), .O(new_n209_));
  nand2  g147(.a(new_n209_), .b(new_n81_), .O(z19));
  ...
  nand2  g151(.a(new_n81_), .b(new_n64_), .O(new_n214_));
  nand2  g152(.a(x40), .b(new_n66_), .O(new_n215_));
  aoi21  g153(.a(new_n215_), .b(new_n214_), .c(x08), .O(new_n216_));
  oai21  g154(.a(new_n216_), .b(new_n213_), .c(new_n83_), .O(new_n217_));
