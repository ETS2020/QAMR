...
module FAU ( 
  ...
  nor2   g057(.a(new_n63_), .b(new_n89_), .O(new_n120_));
  ...
  nand2  g063(.a(x40), .b(new_n89_), .O(new_n126_));
  ...
  nor2   g078(.a(new_n89_), .b(new_n96_), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n90_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  nand2  g082(.a(new_n105_), .b(x27), .O(new_n145_));
  oai21  g083(.a(new_n96_), .b(new_n71_), .c(x35), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n91_), .O(new_n147_));
  oai21  g085(.a(new_n144_), .b(new_n141_), .c(new_n147_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n78_), .c(new_n140_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n64_), .O(z11));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n92_), .c(new_n73_), .O(new_n152_));
  oai21  g090(.a(new_n121_), .b(x04), .c(new_n68_), .O(new_n153_));
  ...
  nor2   g101(.a(new_n136_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n71_), .c(new_n102_), .O(new_n165_));
  ...
  nand3  g107(.a(new_n120_), .b(new_n155_), .c(new_n71_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .O(new_n171_));
  nand3  g109(.a(new_n65_), .b(new_n80_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n79_), .c(new_n78_), .O(new_n174_));
  aoi21  g112(.a(new_n170_), .b(new_n68_), .c(new_n102_), .O(new_n175_));
  ...
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n80_), .O(new_n189_));
  nand2  g127(.a(new_n78_), .b(new_n140_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n105_), .c(new_n190_), .O(new_n191_));
  nand3  g129(.a(new_n120_), .b(x29), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n191_), .b(new_n102_), .c(new_n192_), .O(z18));
  aoi22  g131(.a(new_n142_), .b(new_n90_), .c(new_n126_), .d(x29), .O(new_n194_));
  nand2  g132(.a(new_n64_), .b(new_n92_), .O(new_n195_));
  oai21  g133(.a(new_n146_), .b(x28), .c(x40), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n195_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n78_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z19));
  oai21  g137(.a(new_n80_), .b(new_n92_), .c(new_n91_), .O(new_n200_));
  aoi21  g138(.a(x28), .b(new_n92_), .c(new_n80_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n141_), .c(new_n200_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n78_), .c(new_n140_), .O(new_n203_));
