...
module FAU ( 
  ...
  nor2   g001(.a(new_n63_), .b(x22), .O(new_n64_));
  ...
  oai21  g053(.a(new_n111_), .b(x33), .c(new_n115_), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n63_), .O(new_n117_));
  nand3  g055(.a(new_n114_), .b(x22), .c(new_n112_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n117_), .c(new_n107_), .O(z07));
  inv1   g057(.a(x39), .O(new_n120_));
  inv1   g058(.a(x40), .O(new_n121_));
  nor3   g059(.a(new_n64_), .b(new_n121_), .c(new_n120_), .O(z08));
  inv1   g060(.a(x11), .O(new_n123_));
  nand4  g061(.a(new_n91_), .b(x34), .c(x27), .d(x26), .O(new_n124_));
  ...
  aoi21  g073(.a(new_n135_), .b(new_n134_), .c(new_n64_), .O(z10));
  ...
  nand4  g079(.a(x35), .b(new_n85_), .c(x27), .d(new_n67_), .O(new_n142_));
  ...
  nand2  g083(.a(new_n145_), .b(new_n91_), .O(z11));
  ...
  nor2   g120(.a(new_n64_), .b(x30), .O(new_n183_));
  ...
  oai21  g129(.a(new_n191_), .b(x09), .c(new_n91_), .O(z19));
  ...
  nand4  g133(.a(new_n195_), .b(new_n91_), .c(new_n83_), .d(new_n137_), .O(new_n196_));
