...
module FAU ( 
  ...
  nand3  g075(.a(new_n67_), .b(new_n81_), .c(new_n89_), .O(new_n138_));
  ...
  oai21  g079(.a(new_n69_), .b(x39), .c(new_n141_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x28), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x39), .c(new_n143_), .d(new_n73_), .O(new_n146_));
  ...
  aoi21  g090(.a(new_n152_), .b(x40), .c(new_n114_), .O(new_n153_));
  ...
  oai21  g095(.a(new_n155_), .b(new_n114_), .c(new_n157_), .O(new_n158_));
  ...
  nand4  g100(.a(new_n162_), .b(x40), .c(new_n80_), .d(new_n79_), .O(new_n163_));
  ...
  nor2   g113(.a(new_n114_), .b(new_n128_), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(new_n177_));
  oai21  g115(.a(new_n83_), .b(x27), .c(new_n177_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nand3  g117(.a(new_n90_), .b(x27), .c(new_n73_), .O(new_n180_));
  nor2   g118(.a(new_n95_), .b(x30), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n175_), .O(z18));
  nand2  g120(.a(new_n130_), .b(new_n90_), .O(new_n183_));
  ...
  nand3  g125(.a(new_n187_), .b(new_n79_), .c(new_n175_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n64_), .O(z19));
  oai21  g127(.a(new_n89_), .b(new_n66_), .c(new_n185_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n66_), .c(new_n89_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n176_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n79_), .c(new_n175_), .O(new_n193_));
