...
module FAU ( 
  ...
  aoi21  g059(.a(x35), .b(new_n90_), .c(x36), .O(new_n122_));
  ...
  nor3   g065(.a(new_n79_), .b(new_n66_), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g072(.a(new_n129_), .b(new_n99_), .c(new_n134_), .O(z10));
  nand2  g073(.a(new_n65_), .b(new_n99_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n90_), .c(new_n72_), .O(new_n137_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n83_), .c(new_n141_), .d(new_n96_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n139_), .c(new_n80_), .O(new_n144_));
  ...
  nor2   g096(.a(new_n132_), .b(x13), .O(new_n159_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand4  g102(.a(x40), .b(x39), .c(new_n150_), .d(new_n72_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n66_), .b(new_n82_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n81_), .c(new_n80_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n69_), .c(new_n79_), .O(new_n170_));
  ...
  nand2  g118(.a(x27), .b(new_n72_), .O(new_n181_));
  nand2  g119(.a(new_n99_), .b(x08), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n82_), .O(new_n183_));
  inv1   g121(.a(x09), .O(new_n184_));
  nand2  g122(.a(new_n80_), .b(new_n184_), .O(new_n185_));
  aoi21  g123(.a(new_n183_), .b(new_n90_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n79_), .c(new_n118_), .d(new_n88_), .O(z18));
  nor2   g125(.a(new_n82_), .b(new_n99_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n99_), .c(new_n82_), .O(new_n189_));
  nand3  g127(.a(x40), .b(x39), .c(x29), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n189_), .c(new_n188_), .d(x08), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n184_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n65_), .O(z20));
  nor2   g132(.a(new_n144_), .b(x09), .O(z19));
endmodule
