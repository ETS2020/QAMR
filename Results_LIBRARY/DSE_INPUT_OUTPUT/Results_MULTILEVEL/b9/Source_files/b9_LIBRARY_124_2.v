...
module FAU ( 
  ...
  nor2   g035(.a(x40), .b(x14), .O(new_n98_));
  ...
  nand4  g054(.a(new_n116_), .b(x40), .c(new_n113_), .d(new_n112_), .O(new_n117_));
  inv1   g055(.a(x14), .O(new_n118_));
  nand2  g056(.a(x38), .b(new_n114_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x00), .c(new_n118_), .O(new_n120_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n86_), .c(new_n145_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n83_), .c(new_n139_), .O(new_n149_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n65_), .c(new_n101_), .O(new_n168_));
  ...
  aoi21  g115(.a(new_n173_), .b(new_n155_), .c(new_n101_), .O(new_n178_));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n146_), .c(new_n66_), .O(new_n190_));
  nand2  g128(.a(new_n83_), .b(new_n139_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n85_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n101_), .c(new_n92_), .d(new_n154_), .O(z18));
  nand2  g131(.a(new_n81_), .b(new_n64_), .O(new_n194_));
  ...
  aoi21  g135(.a(new_n197_), .b(x40), .c(new_n98_), .O(new_n198_));
  aoi21  g136(.a(new_n142_), .b(new_n141_), .c(new_n198_), .O(new_n199_));
  ...
  nand3  g143(.a(new_n205_), .b(new_n83_), .c(new_n139_), .O(new_n206_));
