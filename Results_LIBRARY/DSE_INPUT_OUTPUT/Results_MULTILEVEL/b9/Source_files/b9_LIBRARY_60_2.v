...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x34), .O(new_n96_));
  ...
  aoi21  g062(.a(x40), .b(new_n119_), .c(new_n96_), .O(new_n125_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n100_), .c(new_n75_), .O(new_n149_));
  inv1   g087(.a(z08), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(x04), .c(new_n71_), .O(new_n151_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n96_), .c(new_n165_), .O(new_n170_));
  ...
  nand3  g114(.a(new_n71_), .b(new_n63_), .c(new_n121_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n170_), .O(z14));
  nand3  g116(.a(x27), .b(x26), .c(x12), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(x40), .c(new_n121_), .O(z15));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n171_), .O(new_n190_));
  ...
  oai22  g131(.a(new_n193_), .b(new_n65_), .c(new_n150_), .d(new_n90_), .O(z18));
  nor2   g132(.a(new_n171_), .b(new_n100_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n100_), .c(new_n171_), .O(new_n196_));
  nand2  g134(.a(z08), .b(x29), .O(new_n197_));
  inv1   g135(.a(new_n197_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n196_), .c(new_n195_), .d(x08), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n191_), .O(new_n200_));
