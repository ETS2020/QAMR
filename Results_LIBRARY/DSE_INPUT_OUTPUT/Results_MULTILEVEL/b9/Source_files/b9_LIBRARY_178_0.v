...
module FAU ( 
  ...
  nand3  g089(.a(new_n151_), .b(x40), .c(new_n75_), .O(new_n152_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n151_), .c(new_n100_), .O(new_n175_));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n142_), .c(new_n66_), .O(new_n187_));
  nand2  g125(.a(new_n83_), .b(new_n136_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n92_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n100_), .c(new_n90_), .d(new_n185_), .O(z18));
  nand2  g128(.a(new_n81_), .b(new_n64_), .O(new_n191_));
  nand3  g129(.a(x35), .b(new_n92_), .c(new_n65_), .O(new_n192_));
  ...
  aoi22  g134(.a(new_n196_), .b(new_n98_), .c(new_n138_), .d(new_n85_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n83_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z19));
  inv1   g137(.a(new_n137_), .O(new_n200_));
  oai21  g138(.a(new_n66_), .b(new_n64_), .c(new_n141_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n83_), .c(new_n136_), .O(new_n204_));
