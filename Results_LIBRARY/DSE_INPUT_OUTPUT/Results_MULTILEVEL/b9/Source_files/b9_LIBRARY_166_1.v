...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(new_n66_), .d(x06), .O(new_n78_));
  ...
  oai21  g029(.a(new_n91_), .b(new_n87_), .c(x06), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x40), .O(z02));
  nand2  g031(.a(new_n69_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x27), .O(new_n95_));
  nand2  g033(.a(new_n68_), .b(new_n95_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n64_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n68_), .b(new_n95_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n65_), .O(z04));
  inv1   g037(.a(x28), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n95_), .O(new_n101_));
  ...
  nand3  g053(.a(x40), .b(x39), .c(x06), .O(new_n116_));
  ...
  nand4  g066(.a(new_n128_), .b(x40), .c(x39), .d(x06), .O(new_n129_));
  ...
  nand2  g074(.a(new_n136_), .b(x06), .O(new_n137_));
  ...
  oai21  g080(.a(new_n88_), .b(new_n95_), .c(new_n134_), .O(new_n143_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n95_), .c(new_n74_), .O(new_n148_));
  inv1   g086(.a(x04), .O(new_n149_));
  nand3  g087(.a(x40), .b(x39), .c(new_n149_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n71_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n148_), .c(new_n64_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n75_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n153_), .d(new_n149_), .O(new_n156_));
  ...
  nand4  g098(.a(new_n70_), .b(new_n75_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  inv1   g101(.a(x39), .O(new_n164_));
  nand2  g102(.a(new_n128_), .b(x40), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n153_), .c(x06), .d(new_n149_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n163_), .O(z13));
  nand3  g106(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n169_));
  nand4  g107(.a(new_n154_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n170_));
  nand3  g108(.a(x39), .b(new_n153_), .c(new_n149_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n63_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n75_), .c(new_n169_), .O(new_n174_));
  nand3  g112(.a(new_n68_), .b(new_n82_), .c(x28), .O(new_n175_));
  ...
  nand2  g116(.a(new_n178_), .b(x06), .O(new_n179_));
  nand2  g117(.a(new_n71_), .b(new_n75_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n179_), .c(new_n174_), .O(z14));
  ...
  oai21  g129(.a(new_n88_), .b(x27), .c(new_n139_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n95_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n83_), .c(x30), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n64_), .d(new_n135_), .O(z18));
  nand2  g134(.a(new_n64_), .b(new_n95_), .O(new_n197_));
  nand2  g135(.a(x40), .b(x04), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(x35), .c(new_n100_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(x06), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n197_), .c(x08), .O(new_n201_));
  nand2  g139(.a(x39), .b(x29), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(x06), .c(new_n75_), .O(new_n203_));
  aoi21  g141(.a(new_n140_), .b(new_n83_), .c(new_n203_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n201_), .c(new_n80_), .O(new_n205_));
  nor2   g143(.a(new_n205_), .b(x09), .O(z19));
  inv1   g144(.a(new_n139_), .O(new_n207_));
  oai21  g145(.a(new_n82_), .b(new_n95_), .c(new_n134_), .O(new_n208_));
  aoi21  g146(.a(x28), .b(new_n95_), .c(new_n82_), .O(new_n209_));
  oai21  g147(.a(new_n209_), .b(new_n207_), .c(new_n208_), .O(new_n210_));
