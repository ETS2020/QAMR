...
module FAU ( 
  ...
  nor3   g053(.a(new_n65_), .b(new_n75_), .c(new_n115_), .O(z08));
  ...
  nand3  g061(.a(new_n94_), .b(x32), .c(x05), .O(new_n124_));
  ...
  nand2  g067(.a(new_n94_), .b(x29), .O(new_n130_));
  nor2   g068(.a(new_n68_), .b(new_n63_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n83_), .c(new_n130_), .O(new_n132_));
  inv1   g070(.a(x08), .O(new_n133_));
  inv1   g071(.a(x35), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(x28), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x27), .c(new_n63_), .O(new_n136_));
  ...
  nand2  g114(.a(new_n135_), .b(new_n68_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n130_), .c(new_n133_), .O(new_n178_));
  nand2  g116(.a(new_n136_), .b(new_n129_), .O(new_n179_));
  ...
  oai21  g121(.a(new_n134_), .b(new_n68_), .c(new_n133_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n68_), .c(new_n134_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n73_), .c(new_n129_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n64_), .O(z20));
  nand2  g126(.a(new_n139_), .b(new_n64_), .O(z19));
endmodule
