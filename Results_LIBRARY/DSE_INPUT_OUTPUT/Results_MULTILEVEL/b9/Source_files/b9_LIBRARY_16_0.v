...
module FAU ( 
  ...
  nor2   g000(.a(x20), .b(x19), .O(new_n63_));
  ...
  nand2  g020(.a(new_n82_), .b(new_n68_), .O(new_n83_));
  ...
  nand4  g030(.a(new_n92_), .b(new_n90_), .c(new_n74_), .d(new_n87_), .O(z02));
  oai21  g031(.a(new_n67_), .b(new_n81_), .c(x27), .O(new_n94_));
  inv1   g032(.a(x21), .O(new_n95_));
  inv1   g033(.a(x37), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n65_), .c(new_n95_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n94_), .c(new_n63_), .O(z03));
  aoi21  g036(.a(new_n96_), .b(new_n65_), .c(x21), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n94_), .c(new_n87_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n87_), .c(new_n96_), .O(z05));
  ...
  nand2  g051(.a(new_n113_), .b(new_n87_), .O(z07));
  ...
  nand4  g056(.a(new_n87_), .b(x34), .c(x27), .d(x26), .O(new_n119_));
  ...
  oai21  g067(.a(new_n129_), .b(new_n125_), .c(new_n66_), .O(new_n130_));
  nand3  g068(.a(x37), .b(x27), .c(x06), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n63_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nor2   g072(.a(new_n65_), .b(new_n66_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n82_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n81_), .c(x27), .d(new_n66_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n87_), .c(new_n79_), .d(new_n133_), .O(new_n141_));
  ...
  oai22  g083(.a(new_n73_), .b(x04), .c(new_n71_), .d(new_n65_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n87_), .O(z12));
  ...
  nor2   g090(.a(new_n71_), .b(x19), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n65_), .O(new_n155_));
  nor3   g093(.a(new_n128_), .b(x13), .c(x04), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n155_), .c(x20), .O(new_n157_));
  aoi21  g095(.a(new_n149_), .b(x28), .c(new_n65_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n127_), .c(x40), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(new_n115_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x19), .c(new_n148_), .d(new_n66_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n157_), .O(z13));
  and2   g100(.a(x20), .b(x18), .O(new_n163_));
  nand4  g101(.a(new_n149_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(new_n74_), .b(new_n148_), .c(new_n66_), .O(new_n166_));
  oai22  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .d(x19), .O(new_n167_));
  nand3  g105(.a(new_n96_), .b(new_n67_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n80_), .c(new_n79_), .O(new_n170_));
  oai21  g108(.a(new_n71_), .b(new_n65_), .c(new_n166_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x20), .O(new_n173_));
  nand4  g111(.a(new_n80_), .b(new_n79_), .c(new_n65_), .d(x19), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n167_), .O(z14));
  nand4  g113(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n87_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x22), .c(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n87_), .O(z16));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(x23), .c(x22), .d(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n87_), .O(z17));
  oai21  g121(.a(new_n82_), .b(x27), .c(new_n134_), .O(new_n184_));
  nand3  g122(.a(new_n138_), .b(new_n79_), .c(new_n133_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(x08), .c(new_n185_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n63_), .O(z18));
  oai21  g125(.a(new_n67_), .b(new_n65_), .c(new_n137_), .O(new_n188_));
  nand2  g126(.a(new_n134_), .b(new_n67_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n63_), .O(new_n190_));
  oai21  g128(.a(x28), .b(x04), .c(new_n137_), .O(new_n191_));
  oai21  g129(.a(new_n135_), .b(x28), .c(new_n134_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n190_), .c(new_n79_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(x09), .c(new_n87_), .O(z19));
  inv1   g133(.a(new_n134_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n196_), .c(new_n188_), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n87_), .c(new_n79_), .d(new_n133_), .O(new_n199_));
