...
module FAU ( 
  ...
  nand2  g015(.a(new_n77_), .b(x37), .O(new_n78_));
  ...
  nand2  g033(.a(new_n78_), .b(new_n95_), .O(new_n96_));
  nand2  g034(.a(x35), .b(x28), .O(new_n97_));
  oai21  g035(.a(new_n77_), .b(new_n64_), .c(x37), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  inv1   g037(.a(x37), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n64_), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n99_), .c(new_n96_), .O(z03));
  nand2  g040(.a(new_n97_), .b(x27), .O(new_n103_));
  nand2  g041(.a(x40), .b(x37), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n64_), .c(new_n96_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n103_), .O(z04));
  nand3  g044(.a(new_n100_), .b(x28), .c(x27), .O(new_n107_));
  nand2  g045(.a(new_n107_), .b(new_n104_), .O(z05));
  aoi21  g046(.a(x28), .b(x27), .c(x37), .O(z06));
  ...
  nand2  g060(.a(x27), .b(x06), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x40), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x37), .O(new_n125_));
  ...
  nand3  g066(.a(new_n128_), .b(new_n85_), .c(x27), .O(new_n129_));
  ...
  nand2  g073(.a(new_n135_), .b(new_n125_), .O(z10));
  nand2  g074(.a(new_n78_), .b(new_n64_), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n83_), .c(new_n65_), .O(new_n138_));
  ...
  nor2   g080(.a(x40), .b(x37), .O(new_n143_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n140_), .c(new_n81_), .O(new_n147_));
  ...
  aoi21  g089(.a(x39), .b(new_n65_), .c(x37), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n77_), .c(new_n97_), .O(new_n153_));
  aoi21  g091(.a(new_n100_), .b(x27), .c(x40), .O(new_n154_));
  aoi21  g092(.a(x39), .b(new_n65_), .c(x27), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n153_), .c(new_n151_), .O(z12));
  ...
  nand4  g101(.a(x37), .b(x20), .c(new_n163_), .d(new_n162_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n161_), .c(new_n77_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n100_), .b(x35), .c(x28), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n165_), .c(x27), .O(new_n169_));
  nand3  g107(.a(new_n132_), .b(new_n158_), .c(new_n65_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(z13));
  nand4  g109(.a(new_n159_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(z08), .c(new_n158_), .d(new_n65_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n166_), .O(new_n174_));
  nand3  g112(.a(new_n100_), .b(new_n66_), .c(x28), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n82_), .c(new_n81_), .O(new_n177_));
  nand3  g115(.a(x39), .b(new_n158_), .c(new_n65_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n100_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n97_), .O(new_n181_));
  aoi21  g119(.a(new_n178_), .b(new_n64_), .c(new_n154_), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n181_), .c(new_n177_), .d(new_n174_), .O(z14));
  inv1   g121(.a(x12), .O(new_n184_));
  nand4  g122(.a(new_n78_), .b(x34), .c(x27), .d(x26), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n184_), .O(z15));
  inv1   g124(.a(x23), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(x22), .c(x01), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n78_), .O(z16));
  inv1   g127(.a(x24), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(x23), .c(x22), .d(x01), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n78_), .O(z17));
  ...
  nand2  g134(.a(new_n81_), .b(new_n196_), .O(new_n197_));
  aoi21  g135(.a(new_n195_), .b(new_n83_), .c(new_n197_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n80_), .c(new_n90_), .d(new_n72_), .O(z18));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(new_n144_), .O(new_n201_));
  nand2  g139(.a(x40), .b(new_n66_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n137_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n81_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(x09), .O(z20));
  nor2   g143(.a(new_n147_), .b(x09), .O(z19));
endmodule
