...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g034(.a(new_n64_), .O(new_n97_));
  aoi21  g035(.a(new_n94_), .b(new_n66_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n93_), .c(new_n97_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n64_), .c(new_n94_), .O(z05));
  ...
  nand3  g056(.a(new_n118_), .b(new_n83_), .c(new_n72_), .O(new_n119_));
  ...
  nand3  g063(.a(new_n125_), .b(x05), .c(new_n72_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n122_), .O(z10));
  inv1   g065(.a(x29), .O(new_n128_));
  aoi21  g066(.a(x40), .b(new_n128_), .c(new_n123_), .O(new_n129_));
  ...
  nand3  g070(.a(x35), .b(new_n81_), .c(new_n72_), .O(new_n133_));
  ...
  nand3  g076(.a(new_n94_), .b(new_n80_), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g080(.a(new_n68_), .b(x39), .c(new_n142_), .O(z12));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n147_), .c(new_n63_), .O(new_n152_));
  nand4  g090(.a(new_n150_), .b(new_n123_), .c(x20), .d(new_n149_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x18), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(x27), .O(new_n155_));
  nand3  g093(.a(new_n125_), .b(new_n144_), .c(new_n72_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(x39), .b(new_n144_), .c(new_n72_), .O(new_n158_));
  nand4  g096(.a(x27), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n67_), .c(new_n158_), .O(new_n160_));
  nand3  g098(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n161_));
  aoi22  g099(.a(new_n161_), .b(new_n145_), .c(new_n94_), .d(new_n138_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n81_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n79_), .c(new_n78_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n160_), .c(new_n64_), .O(z14));
  ...
  nand2  g110(.a(new_n172_), .b(new_n64_), .O(z17));
  ...
  nand2  g127(.a(new_n189_), .b(new_n138_), .O(new_n190_));
  ...
  aoi21  g131(.a(x28), .b(new_n66_), .c(new_n138_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n129_), .O(new_n195_));
  aoi21  g133(.a(new_n185_), .b(new_n132_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n195_), .c(new_n78_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(x09), .O(z20));
  buf    g136(.a(x39), .O(z08));
endmodule
