...
module FAU ( 
  ...
  aoi21  g027(.a(new_n89_), .b(x04), .c(new_n80_), .O(z01));
  ...
  nand2  g054(.a(new_n81_), .b(new_n75_), .O(z08));
  ...
  nand3  g060(.a(new_n122_), .b(new_n87_), .c(x27), .O(new_n123_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n81_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(new_n76_), .b(x29), .O(new_n133_));
  nor2   g071(.a(new_n64_), .b(new_n65_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n86_), .c(new_n133_), .O(new_n135_));
  inv1   g073(.a(x08), .O(new_n136_));
  nand2  g074(.a(x27), .b(new_n65_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n86_), .c(new_n136_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n83_), .c(new_n132_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n81_), .O(z11));
  ...
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n81_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x40), .c(new_n148_), .d(new_n65_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n72_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n124_), .O(new_n155_));
  nand4  g093(.a(new_n72_), .b(x40), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n126_), .b(new_n148_), .c(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand3  g098(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n161_));
  nand4  g099(.a(new_n149_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n162_));
  nand3  g100(.a(x40), .b(new_n148_), .c(new_n65_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n162_), .c(new_n124_), .O(new_n165_));
  inv1   g103(.a(x40), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(x39), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(new_n161_), .O(new_n168_));
  ...
  nand2  g109(.a(new_n163_), .b(new_n145_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x39), .O(new_n174_));
  nand3  g112(.a(new_n145_), .b(x40), .c(new_n124_), .O(new_n175_));
  ...
  aoi21  g123(.a(new_n185_), .b(new_n137_), .c(new_n66_), .O(new_n186_));
  nand2  g124(.a(new_n83_), .b(new_n132_), .O(new_n187_));
  aoi21  g125(.a(new_n186_), .b(new_n85_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n80_), .c(new_n92_), .d(new_n75_), .O(z18));
  inv1   g127(.a(new_n133_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n136_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n83_), .c(new_n132_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n81_), .O(z20));
  nand2  g133(.a(new_n140_), .b(new_n81_), .O(z19));
endmodule
