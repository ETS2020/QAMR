...
module FAU ( 
  ...
  nor2   g032(.a(new_n75_), .b(new_n94_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n89_), .d(x00), .O(z02));
  ...
  aoi21  g053(.a(new_n94_), .b(x00), .c(new_n75_), .O(z08));
  ...
  nand2  g061(.a(new_n123_), .b(x00), .O(new_n124_));
  ...
  nand4  g098(.a(new_n131_), .b(new_n149_), .c(new_n73_), .d(x00), .O(new_n161_));
  ...
  nand3  g103(.a(new_n95_), .b(new_n149_), .c(new_n73_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n69_), .b(new_n82_), .c(x28), .O(new_n168_));
  ...
  nand2  g120(.a(new_n95_), .b(x29), .O(new_n183_));
  oai21  g121(.a(new_n91_), .b(x27), .c(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n65_), .b(x09), .O(new_n186_));
  nand3  g124(.a(new_n83_), .b(x27), .c(new_n73_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n80_), .O(z18));
  inv1   g126(.a(x09), .O(new_n189_));
  nand2  g127(.a(new_n139_), .b(new_n83_), .O(new_n190_));
  nand2  g128(.a(new_n183_), .b(new_n190_), .O(new_n191_));
  inv1   g129(.a(x08), .O(new_n192_));
  nand2  g130(.a(new_n187_), .b(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n80_), .c(new_n189_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n64_), .O(z19));
  inv1   g134(.a(new_n183_), .O(new_n197_));
  oai21  g135(.a(new_n82_), .b(new_n68_), .c(new_n192_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n82_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n189_), .O(new_n201_));
