...
module FAU ( 
  ...
  oai21  g032(.a(new_n94_), .b(new_n89_), .c(x39), .O(new_n95_));
  nand2  g033(.a(x40), .b(new_n75_), .O(new_n96_));
  ...
  nor3   g066(.a(new_n98_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n98_), .O(new_n150_));
  ...
  nand4  g092(.a(new_n154_), .b(x40), .c(new_n152_), .d(new_n65_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n72_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n75_), .O(new_n159_));
  nand4  g097(.a(new_n72_), .b(x40), .c(x20), .d(new_n157_), .O(new_n160_));
  ...
  nand4  g103(.a(new_n153_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(z08), .b(new_n152_), .c(new_n65_), .O(new_n168_));
  ...
  nand2  g119(.a(new_n181_), .b(new_n81_), .O(z17));
  oai21  g120(.a(new_n91_), .b(x27), .c(new_n136_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n98_), .b(x30), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n141_), .d(new_n135_), .O(z18));
  nand2  g124(.a(new_n81_), .b(new_n64_), .O(new_n187_));
  nand3  g125(.a(x35), .b(new_n90_), .c(new_n65_), .O(new_n188_));
  ...
  aoi22  g130(.a(new_n192_), .b(new_n96_), .c(new_n137_), .d(new_n85_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n190_), .c(new_n83_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(x09), .O(z19));
  nand2  g133(.a(x28), .b(new_n64_), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(x35), .c(new_n192_), .d(new_n96_), .O(new_n197_));
  nand2  g135(.a(x39), .b(new_n66_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n187_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n83_), .O(new_n200_));
