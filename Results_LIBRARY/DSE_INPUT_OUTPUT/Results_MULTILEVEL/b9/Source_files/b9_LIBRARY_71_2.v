...
module FAU ( 
  ...
  nand3  g057(.a(new_n119_), .b(new_n83_), .c(new_n72_), .O(new_n120_));
  ...
  aoi21  g061(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(new_n124_));
  nand4  g062(.a(new_n124_), .b(x39), .c(x05), .d(new_n72_), .O(new_n125_));
  ...
  aoi21  g092(.a(new_n154_), .b(x40), .c(new_n128_), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n152_), .O(z13));
  nand3  g094(.a(x39), .b(new_n144_), .c(new_n72_), .O(new_n157_));
  ...
  aoi22  g098(.a(new_n160_), .b(new_n145_), .c(new_n94_), .d(new_n138_), .O(new_n161_));
  ...
  oai21  g111(.a(new_n82_), .b(x27), .c(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n66_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n88_), .c(x09), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n64_), .d(new_n78_), .O(z18));
  inv1   g116(.a(x09), .O(new_n179_));
  nand2  g117(.a(new_n130_), .b(new_n81_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n173_), .O(new_n181_));
  inv1   g119(.a(x08), .O(new_n182_));
  aoi21  g120(.a(new_n63_), .b(x39), .c(x27), .O(new_n183_));
  nand2  g121(.a(x40), .b(new_n138_), .O(new_n184_));
  nand2  g122(.a(x39), .b(x04), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n184_), .c(new_n81_), .O(new_n186_));
  ...
  nand3  g128(.a(new_n190_), .b(new_n78_), .c(new_n179_), .O(new_n191_));
  ...
  oai21  g133(.a(new_n195_), .b(new_n194_), .c(new_n78_), .O(new_n196_));
