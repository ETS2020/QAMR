...
module FAU ( 
  ...
  nand3  g040(.a(new_n102_), .b(new_n65_), .c(new_n70_), .O(z05));
  ...
  nand2  g055(.a(new_n94_), .b(x07), .O(new_n118_));
  ...
  aoi21  g081(.a(x40), .b(new_n74_), .c(new_n72_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x39), .O(new_n145_));
  inv1   g083(.a(new_n72_), .O(new_n146_));
  ...
  nand4  g089(.a(new_n151_), .b(x40), .c(new_n149_), .d(new_n74_), .O(new_n152_));
  ...
  nand3  g098(.a(new_n123_), .b(new_n149_), .c(new_n74_), .O(new_n161_));
  ...
  nand3  g103(.a(z08), .b(new_n149_), .c(new_n74_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n70_), .b(new_n133_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n81_), .c(new_n80_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n146_), .c(new_n66_), .O(new_n171_));
  ...
  nand2  g119(.a(x27), .b(new_n74_), .O(new_n182_));
  nand2  g120(.a(new_n69_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n133_), .O(new_n184_));
  inv1   g122(.a(x09), .O(new_n185_));
  nand2  g123(.a(new_n80_), .b(new_n185_), .O(new_n186_));
  aoi21  g124(.a(new_n184_), .b(new_n83_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n66_), .c(new_n94_), .d(new_n90_), .O(z18));
  nand2  g126(.a(new_n138_), .b(new_n134_), .O(new_n189_));
  nand2  g127(.a(z08), .b(x29), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  inv1   g129(.a(x08), .O(new_n192_));
  oai21  g130(.a(new_n182_), .b(new_n84_), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n80_), .c(new_n185_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n65_), .O(z19));
  inv1   g134(.a(new_n190_), .O(new_n197_));
  oai21  g135(.a(new_n133_), .b(new_n69_), .c(new_n192_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n69_), .c(new_n133_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n185_), .O(new_n201_));
