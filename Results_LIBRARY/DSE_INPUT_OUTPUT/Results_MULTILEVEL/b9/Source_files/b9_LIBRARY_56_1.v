...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(x22), .d(new_n72_), .O(new_n77_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x22), .O(new_n93_));
  ...
  aoi21  g060(.a(new_n122_), .b(x22), .c(new_n74_), .O(new_n123_));
  nand4  g061(.a(x40), .b(x39), .c(x22), .d(x05), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(new_n121_), .c(new_n124_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n85_), .c(new_n120_), .O(new_n126_));
  ...
  nor3   g068(.a(new_n130_), .b(new_n122_), .c(new_n64_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x05), .c(new_n120_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n129_), .O(z10));
  inv1   g071(.a(x08), .O(new_n134_));
  inv1   g072(.a(x09), .O(new_n135_));
  nand4  g073(.a(new_n80_), .b(new_n135_), .c(new_n134_), .d(x04), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x22), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x40), .O(new_n138_));
  nor2   g076(.a(new_n74_), .b(new_n122_), .O(new_n139_));
  ...
  oai21  g082(.a(new_n84_), .b(new_n96_), .c(new_n134_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n80_), .c(new_n135_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n138_), .O(z11));
  nor3   g086(.a(x37), .b(x36), .c(x35), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n96_), .c(new_n73_), .O(new_n150_));
  nand2  g088(.a(new_n139_), .b(new_n120_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n69_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n150_), .c(new_n65_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n74_), .O(new_n156_));
  ...
  nand4  g099(.a(new_n68_), .b(new_n74_), .c(x20), .d(new_n159_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n131_), .b(new_n154_), .c(new_n120_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  nand3  g104(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n167_));
  nand4  g105(.a(new_n155_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n139_), .b(new_n154_), .c(new_n120_), .O(new_n170_));
  ...
  aoi21  g113(.a(new_n170_), .b(new_n69_), .c(new_n79_), .O(new_n176_));
  ...
  nor2   g121(.a(new_n183_), .b(x24), .O(z17));
  oai21  g122(.a(new_n84_), .b(x27), .c(new_n140_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n96_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n141_), .c(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n65_), .d(new_n135_), .O(z18));
  nand2  g127(.a(new_n65_), .b(new_n96_), .O(new_n190_));
  oai21  g128(.a(new_n84_), .b(x04), .c(x22), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x08), .O(new_n192_));
  nand2  g130(.a(x39), .b(x29), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x22), .c(new_n74_), .O(new_n194_));
  aoi21  g132(.a(new_n142_), .b(new_n141_), .c(new_n194_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n192_), .c(new_n80_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z19));
  aoi21  g135(.a(x28), .b(new_n96_), .c(new_n172_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(new_n194_), .O(new_n199_));
  oai21  g137(.a(new_n172_), .b(new_n96_), .c(x22), .O(new_n200_));
  nand2  g138(.a(new_n74_), .b(new_n96_), .O(new_n201_));
