...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n181_, new_n182_, new_n183_, new_n185_, new_n186_, new_n189_,
    new_n190_, new_n191_, new_n192_, new_n193_;
  nand2  g000(.a(x30), .b(x29), .O(new_n63_));
  ...
  nand3  g058(.a(new_n78_), .b(x05), .c(new_n67_), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(x29), .c(x30), .O(new_n123_));
  ...
  nor2   g075(.a(new_n68_), .b(x28), .O(new_n138_));
  ...
  nand3  g105(.a(new_n78_), .b(new_n150_), .c(new_n67_), .O(new_n168_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n147_), .c(new_n64_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nand4  g113(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n176_));
  ...
  nand4  g124(.a(new_n186_), .b(new_n139_), .c(new_n83_), .d(new_n133_), .O(z18));
  nand2  g125(.a(new_n142_), .b(new_n63_), .O(z19));
