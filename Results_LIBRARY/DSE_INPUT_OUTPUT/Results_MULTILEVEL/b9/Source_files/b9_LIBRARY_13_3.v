...
module FAU ( 
  ...
  nand2  g001(.a(x39), .b(x09), .O(new_n64_));
  ...
  aoi21  g036(.a(new_n65_), .b(new_n95_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n98_), .O(z04));
  inv1   g038(.a(x28), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n95_), .O(new_n102_));
  ...
  oai21  g060(.a(x40), .b(x09), .c(x39), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x07), .O(new_n124_));
  inv1   g062(.a(x39), .O(new_n125_));
  nor2   g063(.a(new_n74_), .b(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n71_), .c(x05), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n124_), .c(new_n122_), .O(new_n128_));
  nand3  g066(.a(new_n64_), .b(x37), .c(x06), .O(new_n129_));
  inv1   g067(.a(new_n129_), .O(new_n130_));
  aoi21  g068(.a(new_n128_), .b(new_n121_), .c(new_n130_), .O(new_n131_));
  oai21  g069(.a(x32), .b(x30), .c(x40), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(new_n125_), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(new_n71_), .c(x05), .d(new_n121_), .O(new_n134_));
  oai21  g072(.a(new_n131_), .b(new_n95_), .c(new_n134_), .O(z10));
  nand2  g073(.a(new_n126_), .b(x29), .O(new_n136_));
  oai21  g074(.a(new_n95_), .b(new_n121_), .c(new_n82_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand3  g077(.a(new_n82_), .b(x27), .c(new_n121_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n79_), .c(new_n71_), .O(new_n143_));
  ...
  nand2  g084(.a(new_n126_), .b(new_n121_), .O(new_n147_));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(x09), .O(new_n157_));
  nand4  g095(.a(new_n67_), .b(new_n125_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand4  g098(.a(new_n133_), .b(new_n150_), .c(new_n71_), .d(new_n121_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n126_), .b(new_n150_), .c(new_n121_), .O(new_n166_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n68_), .c(new_n98_), .O(new_n171_));
  ...
  nand2  g119(.a(new_n82_), .b(new_n95_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n136_), .c(new_n139_), .O(new_n183_));
  nand2  g121(.a(new_n140_), .b(new_n79_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n183_), .c(new_n71_), .O(new_n185_));
  oai21  g123(.a(x39), .b(new_n71_), .c(new_n185_), .O(z18));
  inv1   g124(.a(new_n143_), .O(z19));
  inv1   g125(.a(new_n136_), .O(new_n188_));
  oai21  g126(.a(new_n81_), .b(new_n95_), .c(new_n139_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n95_), .c(new_n81_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n79_), .c(new_n71_), .O(new_n192_));
