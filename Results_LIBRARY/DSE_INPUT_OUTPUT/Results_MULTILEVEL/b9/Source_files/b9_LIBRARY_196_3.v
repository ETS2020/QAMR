...
module FAU ( 
  ...
  nand2  g017(.a(x24), .b(x19), .O(new_n80_));
  ...
  inv1   g028(.a(new_n80_), .O(new_n91_));
  ...
  nand2  g033(.a(new_n64_), .b(new_n95_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(x35), .c(new_n85_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(x04), .c(new_n75_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n91_), .O(z02));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n100_), .c(new_n91_), .O(z03));
  nand2  g041(.a(new_n70_), .b(new_n64_), .O(new_n104_));
  nand4  g042(.a(new_n104_), .b(new_n100_), .c(new_n80_), .d(new_n101_), .O(z04));
  nand2  g043(.a(x28), .b(x27), .O(new_n106_));
  aoi21  g044(.a(new_n106_), .b(new_n70_), .c(new_n91_), .O(z05));
  ...
  nand2  g057(.a(new_n119_), .b(new_n80_), .O(z07));
  nand2  g058(.a(new_n80_), .b(new_n75_), .O(z08));
  nand4  g059(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n80_), .O(z09));
  ...
  nand2  g065(.a(new_n84_), .b(new_n83_), .O(new_n128_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(new_n80_), .O(z10));
  ...
  nand2  g076(.a(new_n138_), .b(new_n95_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n80_), .c(new_n83_), .d(new_n134_), .O(new_n141_));
  ...
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n91_), .O(z12));
  ...
  nand3  g096(.a(new_n128_), .b(x40), .c(x39), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n91_), .O(new_n161_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n80_), .O(z17));
  oai21  g118(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n181_));
  nand3  g119(.a(new_n138_), .b(new_n83_), .c(new_n134_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(x08), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n91_), .O(z18));
  inv1   g122(.a(new_n135_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n95_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n80_), .c(new_n83_), .d(new_n134_), .O(new_n189_));
