...
module FAU ( 
  ...
  aoi21  g068(.a(x39), .b(new_n90_), .c(new_n74_), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n130_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n64_), .b(new_n98_), .O(new_n134_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n98_), .c(new_n73_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n124_), .b(x39), .c(new_n144_), .d(new_n71_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  aoi21  g094(.a(new_n144_), .b(new_n71_), .c(new_n63_), .O(new_n157_));
  ...
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n80_), .d(new_n79_), .O(new_n165_));
  ...
  oai22  g114(.a(new_n83_), .b(x27), .c(new_n74_), .d(new_n90_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n98_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n130_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n178_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g119(.a(x40), .b(x04), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x35), .c(new_n82_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x39), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n134_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n133_), .c(new_n79_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z19));
  nor2   g125(.a(new_n74_), .b(new_n90_), .O(new_n188_));
  inv1   g126(.a(x35), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n98_), .c(new_n89_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n98_), .c(new_n189_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n190_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n79_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(x09), .c(new_n64_), .O(z20));
