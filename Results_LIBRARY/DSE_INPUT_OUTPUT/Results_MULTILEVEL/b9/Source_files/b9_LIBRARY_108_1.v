...
module FAU ( 
  ...
  nor2   g026(.a(new_n88_), .b(new_n69_), .O(z08));
  ...
  aoi21  g093(.a(new_n155_), .b(x39), .c(new_n88_), .O(new_n156_));
  or2    g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x40), .b(new_n146_), .c(new_n117_), .O(new_n158_));
  ...
  aoi21  g119(.a(x40), .b(new_n69_), .c(x27), .O(new_n182_));
  nand2  g120(.a(x39), .b(new_n140_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n133_), .c(new_n77_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n132_), .O(new_n185_));
  oai21  g123(.a(new_n69_), .b(x29), .c(x40), .O(new_n186_));
