...
module FAU ( 
  ...
  nor2   g019(.a(new_n81_), .b(x19), .O(new_n82_));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n94_), .c(new_n82_), .O(z02));
  ...
  nand2  g043(.a(new_n105_), .b(new_n99_), .O(z06));
  ...
  nand2  g057(.a(new_n99_), .b(new_n75_), .O(z08));
  inv1   g058(.a(x11), .O(new_n121_));
  nand4  g059(.a(new_n99_), .b(x34), .c(x27), .d(x26), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n121_), .O(z09));
  nand2  g061(.a(x05), .b(new_n65_), .O(new_n124_));
  oai21  g062(.a(new_n124_), .b(new_n75_), .c(x19), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x30), .O(new_n126_));
  ...
  nand3  g067(.a(new_n129_), .b(new_n88_), .c(x27), .O(new_n130_));
  nand3  g068(.a(new_n76_), .b(x32), .c(x05), .O(new_n131_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n126_), .O(z10));
  ...
  nand3  g078(.a(new_n95_), .b(x27), .c(new_n65_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n81_), .c(new_n136_), .O(new_n144_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n82_), .O(z12));
  ...
  nand4  g104(.a(new_n153_), .b(new_n85_), .c(new_n81_), .d(x28), .O(new_n167_));
  ...
  nand3  g110(.a(new_n172_), .b(new_n85_), .c(new_n81_), .O(new_n173_));
  nand3  g111(.a(new_n72_), .b(new_n81_), .c(x27), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n169_), .c(new_n82_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n173_), .c(new_n170_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n99_), .O(z15));
  inv1   g116(.a(x23), .O(new_n179_));
  nand4  g117(.a(new_n99_), .b(new_n179_), .c(x22), .d(x01), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z16));
  inv1   g119(.a(x01), .O(new_n182_));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n99_), .b(new_n183_), .c(x23), .d(x22), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n182_), .O(z17));
  nand2  g123(.a(new_n95_), .b(new_n64_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n137_), .c(new_n140_), .O(new_n187_));
  nand2  g125(.a(new_n141_), .b(new_n136_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n187_), .c(new_n81_), .O(new_n189_));
  nand2  g127(.a(x30), .b(x19), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n189_), .O(z18));
  nand2  g129(.a(new_n144_), .b(new_n99_), .O(z19));
  inv1   g130(.a(new_n137_), .O(new_n193_));
  oai21  g131(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n81_), .c(new_n136_), .O(new_n197_));
