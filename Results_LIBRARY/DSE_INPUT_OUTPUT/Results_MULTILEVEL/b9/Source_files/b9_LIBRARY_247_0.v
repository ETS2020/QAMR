...
module FAU ( 
  ...
  nor2   g039(.a(new_n86_), .b(new_n66_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n99_), .c(new_n67_), .O(z05));
  ...
  nand2  g055(.a(new_n117_), .b(new_n99_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n99_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  ...
  oai21  g072(.a(new_n129_), .b(new_n66_), .c(new_n134_), .O(z10));
  oai21  g073(.a(x40), .b(x39), .c(new_n66_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n86_), .c(new_n71_), .O(new_n137_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n81_), .c(new_n141_), .d(new_n93_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n139_), .c(new_n78_), .O(new_n144_));
  ...
  inv1   g088(.a(new_n69_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(x40), .c(new_n92_), .O(new_n152_));
  ...
  nor2   g101(.a(new_n132_), .b(x13), .O(new_n164_));
  ...
  nand4  g107(.a(x40), .b(x39), .c(new_n154_), .d(new_n71_), .O(new_n170_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n151_), .c(new_n63_), .O(new_n175_));
  ...
  nand2  g118(.a(new_n180_), .b(new_n99_), .O(z16));
  ...
  oai22  g124(.a(new_n117_), .b(new_n186_), .c(new_n87_), .d(x27), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n66_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n81_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n99_), .d(new_n78_), .O(z18));
  inv1   g129(.a(x09), .O(new_n192_));
  inv1   g130(.a(x08), .O(new_n193_));
  oai21  g131(.a(new_n80_), .b(x04), .c(x39), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n136_), .c(new_n86_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand2  g134(.a(x39), .b(new_n80_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n142_), .c(new_n86_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n140_), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n80_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n142_), .c(new_n86_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n92_), .O(new_n202_));
  ...
  aoi22  g144(.a(new_n206_), .b(x35), .c(new_n141_), .d(new_n93_), .O(new_n207_));
  aoi21  g145(.a(new_n197_), .b(new_n136_), .c(x08), .O(new_n208_));
