...
module FAU ( 
  ...
  inv1   g023(.a(x10), .O(new_n86_));
  nor2   g024(.a(new_n86_), .b(new_n63_), .O(new_n87_));
  inv1   g025(.a(new_n87_), .O(new_n88_));
  nand3  g026(.a(new_n88_), .b(new_n85_), .c(x04), .O(z01));
  inv1   g027(.a(new_n67_), .O(new_n90_));
  ...
  oai21  g032(.a(new_n94_), .b(new_n82_), .c(x04), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n88_), .d(new_n90_), .O(z02));
  nand2  g034(.a(new_n75_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x27), .O(new_n98_));
  nand2  g036(.a(new_n70_), .b(new_n98_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n97_), .c(new_n88_), .d(x21), .O(z03));
  inv1   g038(.a(x21), .O(new_n101_));
  nand4  g039(.a(new_n99_), .b(new_n97_), .c(new_n88_), .d(new_n101_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n70_), .c(new_n87_), .O(z05));
  nand3  g042(.a(new_n103_), .b(new_n88_), .c(new_n70_), .O(new_n105_));
  ...
  nand2  g056(.a(new_n118_), .b(new_n88_), .O(z07));
  nand2  g057(.a(new_n88_), .b(new_n67_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n88_), .O(z09));
  nand2  g060(.a(new_n67_), .b(x07), .O(new_n123_));
  ...
  nor2   g068(.a(new_n70_), .b(new_n98_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n87_), .O(new_n132_));
  ...
  nand4  g075(.a(x35), .b(new_n81_), .c(x27), .d(new_n64_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n79_), .c(new_n63_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n98_), .c(new_n86_), .O(new_n144_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n144_), .c(new_n88_), .O(z12));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n64_), .c(new_n87_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n90_), .b(new_n149_), .c(new_n64_), .O(new_n166_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n146_), .c(new_n87_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n88_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x22), .c(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n88_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n88_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  oai21  g119(.a(new_n82_), .b(x27), .c(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n138_), .c(new_n79_), .d(new_n63_), .O(z18));
  inv1   g122(.a(new_n134_), .O(new_n185_));
  oai21  g123(.a(new_n71_), .b(new_n98_), .c(new_n137_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n98_), .c(new_n71_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n79_), .c(new_n63_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n88_), .O(z20));
