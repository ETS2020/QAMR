...
module FAU ( 
  ...
  oai21  g021(.a(new_n69_), .b(x28), .c(new_n70_), .O(new_n84_));
  aoi21  g022(.a(new_n84_), .b(x27), .c(x32), .O(new_n85_));
  oai21  g023(.a(new_n85_), .b(x12), .c(new_n63_), .O(new_n86_));
  ...
  nand2  g039(.a(new_n101_), .b(new_n73_), .O(new_n102_));
  ...
  oai21  g060(.a(new_n78_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g076(.a(new_n91_), .b(x27), .c(new_n68_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n63_), .c(new_n133_), .d(new_n132_), .O(new_n142_));
  ...
  oai22  g084(.a(new_n78_), .b(x04), .c(new_n76_), .d(new_n67_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n146_), .c(new_n65_), .O(z12));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(x12), .O(new_n156_));
  ...
  nand2  g097(.a(x32), .b(new_n133_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n63_), .c(new_n117_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n149_), .d(new_n68_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  nand3  g101(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n164_));
  nand4  g102(.a(new_n150_), .b(new_n125_), .c(new_n63_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n79_), .b(new_n149_), .c(new_n68_), .O(new_n167_));
  ...
  oai21  g108(.a(new_n170_), .b(x12), .c(new_n63_), .O(new_n171_));
  oai21  g109(.a(new_n76_), .b(new_n67_), .c(new_n167_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n168_), .O(z14));
  inv1   g111(.a(x34), .O(new_n174_));
  nand4  g112(.a(x30), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  ...
  nand2  g121(.a(new_n91_), .b(new_n67_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n134_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(x12), .b(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n139_), .d(new_n63_), .O(z18));
  inv1   g126(.a(new_n134_), .O(new_n189_));
  oai21  g127(.a(new_n69_), .b(new_n67_), .c(new_n138_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n63_), .c(new_n133_), .d(new_n132_), .O(new_n193_));
