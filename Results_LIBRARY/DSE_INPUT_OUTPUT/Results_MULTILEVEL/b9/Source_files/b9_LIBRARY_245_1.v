...
module FAU ( 
  ...
  aoi22  g048(.a(new_n110_), .b(x38), .c(x17), .d(new_n63_), .O(new_n111_));
  nand4  g049(.a(new_n111_), .b(new_n108_), .c(new_n107_), .d(x14), .O(new_n112_));
  inv1   g050(.a(x40), .O(new_n113_));
  inv1   g051(.a(x00), .O(new_n114_));
  nand3  g052(.a(x38), .b(new_n109_), .c(new_n114_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(new_n113_), .c(new_n80_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n112_), .c(new_n106_), .O(z07));
  nand3  g055(.a(x40), .b(x39), .c(x14), .O(new_n118_));
  ...
  aoi21  g075(.a(new_n137_), .b(x14), .c(new_n113_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n136_), .c(new_n138_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n135_), .c(new_n84_), .O(new_n141_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n81_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n113_), .O(new_n151_));
  ...
  nand2  g096(.a(new_n158_), .b(x14), .O(new_n159_));
  ...
  nand4  g100(.a(new_n150_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n163_));
  nand3  g101(.a(x39), .b(new_n149_), .c(new_n65_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n80_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n113_), .c(new_n162_), .O(new_n167_));
  ...
  nand2  g108(.a(new_n164_), .b(new_n146_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x14), .O(new_n173_));
  nand2  g111(.a(new_n146_), .b(new_n113_), .O(new_n174_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n81_), .O(z16));
  ...
  nand2  g126(.a(new_n84_), .b(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n187_), .b(new_n86_), .c(new_n189_), .O(new_n190_));
  nand4  g128(.a(new_n76_), .b(x29), .c(x14), .d(x08), .O(new_n191_));
  oai21  g129(.a(new_n190_), .b(new_n83_), .c(new_n191_), .O(z18));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n138_), .O(new_n194_));
  oai21  g132(.a(new_n66_), .b(new_n64_), .c(x14), .O(new_n195_));
  nand2  g133(.a(new_n113_), .b(new_n64_), .O(new_n196_));
  ...
  nor2   g137(.a(new_n141_), .b(x09), .O(z19));
endmodule
