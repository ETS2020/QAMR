...
module FAU ( 
  ...
  oai21  g023(.a(new_n85_), .b(x27), .c(new_n84_), .O(new_n86_));
  ...
  nand3  g035(.a(new_n71_), .b(x30), .c(x27), .O(new_n98_));
  inv1   g036(.a(new_n98_), .O(new_n99_));
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(new_n99_), .O(new_n100_));
  oai21  g038(.a(new_n81_), .b(x21), .c(new_n100_), .O(z03));
  nand2  g039(.a(new_n88_), .b(x21), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n100_), .O(z04));
  aoi21  g041(.a(x28), .b(x27), .c(x37), .O(new_n104_));
  oai22  g042(.a(new_n104_), .b(new_n84_), .c(new_n70_), .d(x27), .O(z05));
  inv1   g043(.a(new_n104_), .O(new_n106_));
  nand2  g044(.a(new_n106_), .b(new_n88_), .O(z06));
  ...
  nand3  g055(.a(new_n117_), .b(new_n88_), .c(x03), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z07));
  inv1   g057(.a(x39), .O(new_n120_));
  inv1   g058(.a(x40), .O(new_n121_));
  nor3   g059(.a(new_n81_), .b(new_n121_), .c(new_n120_), .O(z08));
  inv1   g060(.a(x34), .O(new_n123_));
  nand4  g061(.a(x30), .b(x27), .c(x26), .d(x11), .O(new_n124_));
  nor2   g062(.a(new_n124_), .b(new_n123_), .O(z09));
  oai21  g063(.a(x32), .b(x30), .c(x40), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(new_n120_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x05), .O(new_n128_));
  nand2  g066(.a(new_n91_), .b(new_n67_), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(new_n75_), .c(x27), .d(x07), .O(new_n130_));
  ...
  nand2  g071(.a(new_n133_), .b(x30), .O(new_n134_));
  ...
  oai21  g076(.a(new_n75_), .b(new_n138_), .c(new_n91_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x08), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n84_), .c(new_n64_), .d(new_n137_), .O(new_n141_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n88_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand3  g086(.a(new_n127_), .b(new_n148_), .c(new_n65_), .O(new_n149_));
  ...
  nand2  g092(.a(new_n154_), .b(new_n149_), .O(z13));
  nand3  g093(.a(new_n76_), .b(new_n148_), .c(new_n65_), .O(new_n156_));
  nand4  g094(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n73_), .c(new_n156_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n86_), .O(z14));
  nand4  g097(.a(x30), .b(x27), .c(x26), .d(x12), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(new_n123_), .O(z15));
  inv1   g099(.a(x23), .O(new_n162_));
  nand4  g100(.a(new_n88_), .b(new_n162_), .c(x22), .d(x01), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x23), .c(x22), .d(x01), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n88_), .O(z17));
  aoi21  g105(.a(new_n139_), .b(x08), .c(x09), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(x27), .c(new_n84_), .O(z18));
  inv1   g107(.a(new_n141_), .O(z19));
  inv1   g108(.a(new_n141_), .O(z20));
endmodule
