...
module FAU ( 
  ...
  nand2  g032(.a(new_n64_), .b(x29), .O(new_n95_));
  ...
  aoi21  g062(.a(new_n124_), .b(new_n95_), .c(new_n122_), .O(new_n125_));
  nand3  g063(.a(x40), .b(x39), .c(x05), .O(new_n126_));
  inv1   g064(.a(new_n126_), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n125_), .c(new_n84_), .O(new_n128_));
  ...
  nand2  g073(.a(new_n135_), .b(new_n72_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n131_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  inv1   g076(.a(new_n118_), .O(new_n139_));
  ...
  nand2  g083(.a(x27), .b(new_n72_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n83_), .c(new_n145_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n79_), .c(new_n138_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n65_), .O(z11));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n98_), .c(new_n74_), .O(new_n152_));
  oai21  g090(.a(new_n118_), .b(x04), .c(new_n69_), .O(new_n153_));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n72_), .c(new_n101_), .O(new_n165_));
  ...
  nand3  g107(.a(new_n139_), .b(new_n155_), .c(new_n72_), .O(new_n170_));
  ...
  aoi21  g113(.a(new_n170_), .b(new_n69_), .c(new_n101_), .O(new_n176_));
  ...
  nand2  g125(.a(new_n98_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n146_), .c(new_n172_), .O(new_n189_));
  nand2  g127(.a(new_n79_), .b(new_n138_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n82_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n101_), .c(new_n118_), .d(new_n89_), .O(z18));
  nand2  g130(.a(new_n65_), .b(new_n98_), .O(new_n193_));
  oai21  g131(.a(new_n83_), .b(x04), .c(x29), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(x08), .O(new_n195_));
  nand2  g133(.a(new_n118_), .b(x29), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n63_), .O(new_n197_));
  aoi22  g135(.a(new_n197_), .b(new_n196_), .c(new_n142_), .d(new_n141_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n79_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z19));
  inv1   g138(.a(new_n140_), .O(new_n201_));
  oai21  g139(.a(new_n172_), .b(new_n98_), .c(new_n145_), .O(new_n202_));
  aoi21  g140(.a(x28), .b(new_n98_), .c(new_n172_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n79_), .c(new_n138_), .O(new_n205_));
