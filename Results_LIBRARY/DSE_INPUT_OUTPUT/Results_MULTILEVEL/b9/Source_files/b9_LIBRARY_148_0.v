...
module FAU ( 
  ...
  nand2  g037(.a(new_n76_), .b(x11), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n99_), .O(z02));
  nand2  g039(.a(new_n71_), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n70_), .b(new_n64_), .c(new_n84_), .O(new_n103_));
  ...
  aoi21  g045(.a(new_n107_), .b(new_n70_), .c(new_n84_), .O(z05));
  nand3  g046(.a(new_n107_), .b(new_n82_), .c(new_n70_), .O(new_n109_));
  ...
  nand3  g057(.a(new_n119_), .b(new_n82_), .c(x03), .O(new_n120_));
  ...
  aoi21  g063(.a(new_n125_), .b(new_n100_), .c(new_n124_), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x05), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n126_), .c(new_n89_), .O(new_n129_));
  nand3  g067(.a(new_n82_), .b(x37), .c(x06), .O(new_n130_));
  oai21  g068(.a(new_n129_), .b(x04), .c(new_n130_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x27), .O(new_n132_));
  inv1   g070(.a(x05), .O(new_n133_));
  nand2  g071(.a(new_n86_), .b(new_n85_), .O(new_n134_));
  ...
  nand2  g077(.a(z08), .b(x29), .O(new_n140_));
  inv1   g078(.a(new_n88_), .O(new_n141_));
  ...
  nand2  g083(.a(x27), .b(new_n65_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n88_), .c(new_n145_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n85_), .c(new_n139_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n82_), .O(z11));
  inv1   g088(.a(x10), .O(new_n151_));
  nor3   g089(.a(x37), .b(x36), .c(x35), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n64_), .c(new_n151_), .O(new_n153_));
  inv1   g091(.a(z08), .O(new_n154_));
  nand2  g092(.a(new_n72_), .b(x27), .O(new_n155_));
  oai21  g093(.a(new_n154_), .b(x04), .c(new_n155_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n153_), .c(new_n82_), .O(z12));
  ...
  nor2   g104(.a(new_n135_), .b(x13), .O(new_n167_));
  ...
  nand4  g108(.a(new_n159_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  nand3  g110(.a(z08), .b(new_n158_), .c(new_n65_), .O(new_n173_));
  ...
  nand3  g114(.a(new_n176_), .b(new_n86_), .c(new_n85_), .O(new_n177_));
  aoi21  g115(.a(new_n173_), .b(new_n155_), .c(new_n84_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n174_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nand4  g118(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n180_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(x22), .c(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n82_), .O(z16));
  inv1   g123(.a(x01), .O(new_n186_));
  inv1   g124(.a(x24), .O(new_n187_));
  nand4  g125(.a(new_n82_), .b(new_n187_), .c(x23), .d(x22), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(new_n186_), .O(z17));
  nand2  g127(.a(new_n64_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n146_), .c(new_n66_), .O(new_n191_));
  nand2  g129(.a(new_n85_), .b(new_n139_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n87_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n84_), .c(new_n94_), .d(new_n154_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n96_), .c(x11), .O(new_n196_));
  nand2  g134(.a(new_n142_), .b(new_n87_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n140_), .O(new_n198_));
  nand2  g136(.a(x35), .b(x27), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(x04), .c(new_n145_), .O(new_n200_));
  nand2  g138(.a(x39), .b(x29), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n66_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n200_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(x40), .O(new_n204_));
  nand2  g142(.a(x28), .b(new_n145_), .O(new_n205_));
  nand4  g143(.a(new_n205_), .b(new_n204_), .c(new_n198_), .d(new_n196_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n85_), .c(new_n139_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n82_), .O(z19));
  nand2  g146(.a(x28), .b(new_n64_), .O(new_n209_));
  nand2  g147(.a(new_n201_), .b(x40), .O(new_n210_));
  aoi22  g148(.a(new_n210_), .b(new_n100_), .c(new_n209_), .d(x35), .O(new_n211_));
  nand2  g149(.a(new_n82_), .b(new_n64_), .O(new_n212_));
  nand2  g150(.a(x40), .b(new_n66_), .O(new_n213_));
  aoi21  g151(.a(new_n213_), .b(new_n212_), .c(x08), .O(new_n214_));
  oai21  g152(.a(new_n214_), .b(new_n211_), .c(new_n85_), .O(new_n215_));
