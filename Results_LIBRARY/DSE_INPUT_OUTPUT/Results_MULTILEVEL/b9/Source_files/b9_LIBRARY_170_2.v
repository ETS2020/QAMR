...
module FAU ( 
  ...
  aoi21  g036(.a(new_n65_), .b(new_n98_), .c(new_n78_), .O(new_n99_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n98_), .c(new_n73_), .O(new_n148_));
  oai21  g086(.a(new_n117_), .b(x04), .c(new_n68_), .O(new_n149_));
  ...
  oai21  g097(.a(new_n63_), .b(new_n79_), .c(new_n80_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n151_), .d(new_n71_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n64_), .O(z13));
  ...
  nand3  g103(.a(new_n129_), .b(new_n151_), .c(new_n71_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n65_), .b(new_n139_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n80_), .c(new_n79_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n68_), .c(new_n78_), .O(new_n171_));
  ...
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n139_), .O(new_n183_));
  ...
  oai22  g124(.a(new_n186_), .b(new_n78_), .c(new_n117_), .d(new_n89_), .O(z18));
  nand2  g125(.a(new_n143_), .b(new_n140_), .O(new_n188_));
  nand2  g126(.a(new_n129_), .b(x29), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  oai21  g129(.a(new_n181_), .b(new_n83_), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n184_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n64_), .O(z19));
  inv1   g133(.a(new_n189_), .O(new_n196_));
  oai21  g134(.a(new_n139_), .b(new_n98_), .c(new_n191_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n98_), .c(new_n139_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n79_), .c(new_n184_), .O(new_n200_));
