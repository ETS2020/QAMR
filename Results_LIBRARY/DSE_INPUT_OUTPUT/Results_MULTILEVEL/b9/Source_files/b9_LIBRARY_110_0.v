...
module FAU ( 
  ...
  nand3  g061(.a(new_n123_), .b(new_n89_), .c(x27), .O(new_n124_));
  ...
  nand3  g086(.a(new_n148_), .b(x40), .c(new_n80_), .O(new_n149_));
  ...
  nand3  g099(.a(new_n126_), .b(new_n151_), .c(new_n65_), .O(new_n162_));
  ...
  nand2  g119(.a(new_n181_), .b(new_n82_), .O(z17));
  ...
  nand2  g124(.a(new_n85_), .b(new_n186_), .O(new_n187_));
  aoi21  g125(.a(new_n185_), .b(new_n87_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n84_), .c(new_n94_), .d(new_n75_), .O(z18));
  nor2   g127(.a(new_n66_), .b(new_n64_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n191_));
  nand3  g129(.a(x40), .b(x39), .c(x29), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n191_), .c(new_n190_), .d(x08), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n85_), .c(new_n186_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n82_), .O(z20));
  nor2   g134(.a(new_n142_), .b(x09), .O(z19));
endmodule
