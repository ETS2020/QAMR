...
module FAU ( 
  ...
  nor2   g031(.a(x40), .b(x38), .O(new_n94_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n79_), .O(z10));
  oai21  g073(.a(x40), .b(new_n63_), .c(new_n67_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n83_), .c(new_n72_), .O(new_n137_));
  ...
  aoi21  g087(.a(x39), .b(new_n72_), .c(new_n70_), .O(new_n150_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n158_), .c(new_n74_), .O(new_n163_));
  nand4  g101(.a(new_n161_), .b(new_n63_), .c(x20), .d(new_n160_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n130_), .b(new_n155_), .c(new_n72_), .O(new_n167_));
  ...
  nand4  g109(.a(x40), .b(x39), .c(new_n155_), .d(new_n72_), .O(new_n172_));
  ...
  aoi21  g114(.a(new_n172_), .b(new_n152_), .c(new_n64_), .O(new_n177_));
  ...
  oai22  g125(.a(new_n119_), .b(new_n187_), .c(new_n84_), .d(x27), .O(new_n188_));
  ...
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n79_), .d(new_n80_), .O(z18));
  inv1   g130(.a(x09), .O(new_n193_));
  inv1   g131(.a(x08), .O(new_n194_));
  oai21  g132(.a(new_n147_), .b(x04), .c(x40), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n136_), .c(new_n83_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n194_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n147_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n143_), .c(new_n83_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n141_), .O(new_n200_));
  nand2  g138(.a(new_n63_), .b(new_n147_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n143_), .c(new_n83_), .O(new_n202_));
  ...
  aoi21  g144(.a(x28), .b(new_n67_), .c(new_n147_), .O(new_n207_));
  nor2   g145(.a(new_n207_), .b(new_n142_), .O(new_n208_));
  aoi21  g146(.a(new_n198_), .b(new_n136_), .c(x08), .O(new_n209_));
