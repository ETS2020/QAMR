...
module FAU ( 
  ...
  nand2  g014(.a(x40), .b(x31), .O(new_n77_));
  ...
  nor2   g029(.a(new_n72_), .b(x31), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(new_n91_), .c(new_n89_), .O(z02));
  oai21  g031(.a(new_n66_), .b(new_n81_), .c(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  inv1   g033(.a(new_n77_), .O(new_n96_));
  ...
  nand3  g040(.a(new_n102_), .b(new_n77_), .c(new_n95_), .O(z05));
  oai21  g041(.a(new_n101_), .b(x37), .c(new_n77_), .O(z06));
  ...
  oai21  g052(.a(new_n110_), .b(x33), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g058(.a(new_n120_), .b(new_n106_), .c(new_n117_), .O(z08));
  inv1   g059(.a(x11), .O(new_n122_));
  nand4  g060(.a(new_n77_), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  nor2   g061(.a(new_n123_), .b(new_n122_), .O(z09));
  inv1   g062(.a(x05), .O(new_n125_));
  nand2  g063(.a(new_n72_), .b(x07), .O(new_n126_));
  oai21  g064(.a(new_n72_), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n77_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n81_), .c(new_n65_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(new_n106_), .c(new_n77_), .d(new_n64_), .O(new_n138_));
  aoi21  g076(.a(x39), .b(x29), .c(x31), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(x35), .c(new_n81_), .O(new_n141_));
  oai21  g079(.a(new_n139_), .b(new_n117_), .c(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n138_), .b(x08), .c(new_n142_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n79_), .c(new_n136_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z11));
  nor2   g083(.a(new_n70_), .b(new_n64_), .O(new_n146_));
  nand3  g084(.a(new_n95_), .b(new_n67_), .c(new_n66_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x27), .c(x10), .O(new_n148_));
  aoi21  g086(.a(x39), .b(new_n65_), .c(new_n146_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n106_), .O(new_n150_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(x31), .O(new_n160_));
  nand4  g098(.a(new_n158_), .b(new_n117_), .c(x20), .d(new_n157_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n130_), .b(new_n106_), .c(new_n152_), .d(new_n65_), .O(new_n164_));
  ...
  inv1   g111(.a(new_n146_), .O(new_n174_));
  nand2  g112(.a(new_n169_), .b(new_n174_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n173_), .c(new_n170_), .d(new_n77_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n77_), .O(z15));
  inv1   g116(.a(x23), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(x22), .c(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n77_), .O(z16));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(x23), .c(x22), .d(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n77_), .O(z17));
  inv1   g122(.a(new_n92_), .O(new_n185_));
  ...
  nand2  g126(.a(new_n79_), .b(new_n136_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n81_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n96_), .c(new_n185_), .d(new_n88_), .O(z18));
  nand2  g129(.a(new_n73_), .b(x29), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n141_), .O(new_n193_));
  inv1   g131(.a(x08), .O(new_n194_));
  oai21  g132(.a(new_n186_), .b(new_n82_), .c(new_n194_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n79_), .c(new_n136_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n77_), .O(z19));
  inv1   g136(.a(new_n192_), .O(new_n199_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n79_), .c(new_n136_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n77_), .O(z20));
endmodule
