...
module FAU ( 
  ...
  aoi21  g040(.a(new_n102_), .b(new_n65_), .c(new_n78_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n64_), .c(new_n65_), .O(new_n104_));
  ...
  oai22  g059(.a(new_n93_), .b(new_n120_), .c(x39), .d(new_n121_), .O(new_n122_));
  ...
  aoi21  g064(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(x39), .c(x05), .d(new_n71_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n126_), .O(z10));
  inv1   g067(.a(new_n83_), .O(new_n130_));
  inv1   g068(.a(x29), .O(new_n131_));
  inv1   g069(.a(x39), .O(new_n132_));
  aoi21  g070(.a(x40), .b(new_n131_), .c(new_n132_), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n130_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n64_), .b(new_n97_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n137_));
  ...
  oai21  g080(.a(new_n142_), .b(new_n97_), .c(new_n73_), .O(new_n143_));
  oai21  g081(.a(new_n132_), .b(x04), .c(new_n68_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n64_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x39), .c(new_n146_), .d(new_n71_), .O(new_n149_));
  inv1   g087(.a(x18), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n67_), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n97_), .O(new_n153_));
  nand2  g091(.a(new_n80_), .b(new_n79_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n146_), .c(new_n71_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n132_), .O(new_n156_));
  or2    g094(.a(new_n156_), .b(new_n153_), .O(z13));
  aoi21  g095(.a(new_n146_), .b(new_n71_), .c(new_n63_), .O(new_n158_));
  nor2   g096(.a(x19), .b(x18), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n67_), .c(x27), .d(x20), .O(new_n160_));
  oai21  g098(.a(new_n158_), .b(new_n132_), .c(new_n160_), .O(new_n161_));
  ...
  oai21  g102(.a(new_n164_), .b(new_n82_), .c(x27), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x40), .c(new_n80_), .d(new_n79_), .O(new_n166_));
  ...
  nand2  g118(.a(new_n79_), .b(new_n180_), .O(new_n181_));
  aoi21  g119(.a(new_n179_), .b(new_n82_), .c(new_n181_), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n78_), .c(new_n93_), .d(new_n89_), .O(z18));
  aoi21  g121(.a(x28), .b(new_n97_), .c(new_n176_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n133_), .O(new_n185_));
  nand2  g123(.a(x40), .b(new_n176_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n136_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n79_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(x09), .O(z20));
  nor2   g127(.a(new_n140_), .b(x09), .O(z19));
endmodule
