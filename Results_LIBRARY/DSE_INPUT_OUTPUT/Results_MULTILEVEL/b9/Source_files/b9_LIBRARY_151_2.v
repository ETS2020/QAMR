...
module FAU ( 
  ...
  nand4  g034(.a(new_n96_), .b(new_n90_), .c(new_n70_), .d(new_n91_), .O(z04));
  ...
  aoi21  g067(.a(x40), .b(new_n129_), .c(new_n124_), .O(new_n130_));
  ...
  nand3  g077(.a(new_n93_), .b(new_n76_), .c(new_n84_), .O(new_n140_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n148_), .c(new_n69_), .O(new_n153_));
  nand4  g091(.a(new_n151_), .b(new_n124_), .c(x20), .d(new_n150_), .O(new_n154_));
  ...
  nand3  g096(.a(x39), .b(new_n145_), .c(new_n116_), .O(new_n159_));
  ...
  nand4  g108(.a(new_n70_), .b(new_n170_), .c(x22), .d(x01), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z16));
  inv1   g110(.a(x01), .O(new_n173_));
  inv1   g111(.a(x24), .O(new_n174_));
  nand4  g112(.a(new_n70_), .b(new_n174_), .c(x23), .d(x22), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n173_), .O(z17));
  oai22  g114(.a(new_n78_), .b(x27), .c(new_n124_), .d(new_n129_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n92_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n85_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n178_), .c(new_n70_), .d(new_n74_), .O(z18));
  aoi21  g119(.a(x28), .b(new_n92_), .c(new_n84_), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n130_), .O(new_n183_));
  nand2  g121(.a(x40), .b(new_n84_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n133_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n74_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z20));
  buf    g125(.a(x39), .O(z08));
