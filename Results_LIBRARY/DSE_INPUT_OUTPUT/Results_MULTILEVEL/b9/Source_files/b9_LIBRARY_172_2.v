...
module FAU ( 
  ...
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n70_), .O(z10));
  inv1   g064(.a(new_n78_), .O(new_n127_));
  inv1   g065(.a(x39), .O(new_n128_));
  aoi21  g066(.a(x40), .b(new_n85_), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(x27), .b(x04), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n127_), .c(new_n129_), .O(new_n131_));
  nand2  g069(.a(new_n70_), .b(new_n92_), .O(new_n132_));
  ...
  nor2   g075(.a(new_n64_), .b(new_n92_), .O(new_n138_));
  inv1   g076(.a(x35), .O(new_n139_));
  nand3  g077(.a(new_n93_), .b(new_n76_), .c(new_n139_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x27), .c(x10), .O(new_n141_));
  nor2   g079(.a(new_n138_), .b(new_n116_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n141_), .c(x40), .O(new_n143_));
  oai21  g081(.a(new_n138_), .b(x39), .c(new_n143_), .O(z12));
  ...
  aoi21  g094(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n145_), .d(new_n116_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(z13));
  aoi21  g097(.a(new_n145_), .b(new_n116_), .c(new_n69_), .O(new_n160_));
  nand4  g098(.a(x27), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n161_));
  oai22  g099(.a(new_n161_), .b(new_n64_), .c(new_n160_), .d(new_n128_), .O(new_n162_));
  ...
  oai22  g115(.a(new_n78_), .b(x27), .c(new_n128_), .d(new_n85_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nor2   g117(.a(new_n92_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n127_), .c(x09), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n179_), .c(new_n70_), .d(new_n74_), .O(z18));
  nand2  g120(.a(x39), .b(x04), .O(new_n183_));
  ...
  oai21  g124(.a(new_n186_), .b(new_n131_), .c(new_n74_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(x09), .O(z19));
  nor2   g126(.a(new_n128_), .b(new_n85_), .O(new_n189_));
  oai21  g127(.a(new_n139_), .b(new_n92_), .c(new_n84_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n92_), .c(new_n139_), .O(new_n191_));
