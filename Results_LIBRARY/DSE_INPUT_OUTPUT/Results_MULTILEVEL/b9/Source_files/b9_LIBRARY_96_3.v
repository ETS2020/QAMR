...
module FAU ( 
  ...
  aoi21  g23(.a(new_n85_), .b(new_n66_), .c(new_n64_), .O(z05));
  nand3  g24(.a(new_n85_), .b(z02), .c(new_n66_), .O(new_n87_));
  ...
  nand2  g52(.a(new_n80_), .b(new_n115_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(new_n114_), .c(x35), .d(new_n113_), .O(new_n117_));
  nand3  g54(.a(new_n117_), .b(new_n71_), .c(new_n112_), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(z02), .O(z11));
  aoi21  g56(.a(new_n68_), .b(x27), .c(new_n64_), .O(z12));
  nand4  g57(.a(new_n68_), .b(z02), .c(x27), .d(x20), .O(new_n121_));
  nor3   g58(.a(new_n121_), .b(x19), .c(x18), .O(z13));
  nor2   g59(.a(x19), .b(x18), .O(new_n123_));
  nand3  g60(.a(new_n123_), .b(x27), .c(x20), .O(new_n124_));
  inv1   g61(.a(new_n124_), .O(new_n125_));
  aoi21  g62(.a(new_n125_), .b(new_n68_), .c(new_n64_), .O(z14));
  ...
  nand2  g72(.a(x27), .b(new_n106_), .O(new_n136_));
  oai21  g73(.a(x27), .b(new_n115_), .c(new_n136_), .O(new_n137_));
  nand3  g74(.a(new_n137_), .b(x35), .c(new_n113_), .O(new_n138_));
  nand4  g75(.a(new_n138_), .b(z02), .c(new_n71_), .d(new_n112_), .O(z18));
  oai21  g76(.a(x28), .b(new_n115_), .c(new_n80_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n71_), .c(new_n112_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(z02), .O(z20));
  zero   g80(.O(z08));
  nand2  g81(.a(new_n118_), .b(z02), .O(z19));
endmodule
