...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(x27), .O(new_n81_));
  ...
  nand3  g026(.a(new_n88_), .b(new_n84_), .c(new_n80_), .O(new_n89_));
  oai21  g027(.a(new_n81_), .b(x04), .c(new_n89_), .O(z01));
  inv1   g028(.a(x02), .O(new_n91_));
  nand2  g029(.a(x29), .b(x08), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g031(.a(x08), .b(new_n65_), .c(new_n80_), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  aoi21  g033(.a(new_n86_), .b(x04), .c(new_n75_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(z02));
  nor3   g035(.a(x37), .b(x30), .c(x27), .O(new_n98_));
  aoi21  g036(.a(new_n71_), .b(x27), .c(new_n98_), .O(new_n99_));
  oai21  g037(.a(new_n81_), .b(x21), .c(new_n99_), .O(z03));
  nand2  g038(.a(new_n82_), .b(x21), .O(new_n101_));
  ...
  oai21  g042(.a(new_n70_), .b(x30), .c(new_n64_), .O(new_n105_));
  ...
  nor3   g057(.a(new_n81_), .b(new_n119_), .c(new_n118_), .O(z08));
  ...
  nand4  g063(.a(x40), .b(x39), .c(x30), .d(x05), .O(new_n126_));
  inv1   g064(.a(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n87_), .c(new_n127_), .O(new_n128_));
  nand4  g066(.a(new_n76_), .b(x32), .c(new_n80_), .d(x05), .O(new_n129_));
  oai21  g067(.a(new_n128_), .b(new_n64_), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n80_), .c(new_n134_), .O(new_n141_));
  ...
  nand4  g120(.a(new_n182_), .b(new_n138_), .c(new_n80_), .d(new_n134_), .O(z18));
  inv1   g121(.a(new_n135_), .O(new_n184_));
  oai21  g122(.a(new_n80_), .b(new_n64_), .c(new_n86_), .O(new_n185_));
  nand3  g123(.a(new_n80_), .b(x27), .c(x04), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n184_), .O(new_n187_));
  oai21  g125(.a(new_n86_), .b(x04), .c(new_n80_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(x27), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n134_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n82_), .O(z19));
  nand2  g129(.a(new_n66_), .b(new_n80_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(x27), .c(x08), .O(new_n193_));
  nand2  g131(.a(new_n86_), .b(new_n64_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n192_), .c(new_n184_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n134_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n82_), .O(z20));
endmodule
