...
module FAU ( 
  ...
  aoi21  g034(.a(new_n65_), .b(new_n96_), .c(new_n78_), .O(new_n97_));
  ...
  nand3  g057(.a(new_n119_), .b(new_n84_), .c(new_n71_), .O(new_n120_));
  ...
  nor2   g067(.a(new_n124_), .b(new_n90_), .O(new_n130_));
  ...
  nand4  g075(.a(new_n137_), .b(x35), .c(new_n82_), .d(x27), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n89_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n79_), .c(new_n129_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n64_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n96_), .c(new_n73_), .O(new_n144_));
  oai21  g082(.a(new_n124_), .b(x04), .c(new_n68_), .O(new_n145_));
  ...
  nand4  g092(.a(new_n67_), .b(new_n124_), .c(x20), .d(new_n152_), .O(new_n155_));
  ...
  oai21  g100(.a(new_n160_), .b(new_n124_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g117(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n96_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n133_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g122(.a(x40), .b(new_n90_), .c(new_n124_), .O(new_n185_));
  aoi21  g123(.a(new_n134_), .b(new_n133_), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n64_), .b(new_n96_), .O(new_n187_));
  nand3  g125(.a(new_n137_), .b(x35), .c(new_n82_), .O(new_n188_));
  ...
  oai21  g130(.a(new_n132_), .b(new_n96_), .c(new_n89_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n96_), .c(new_n132_), .O(new_n194_));
