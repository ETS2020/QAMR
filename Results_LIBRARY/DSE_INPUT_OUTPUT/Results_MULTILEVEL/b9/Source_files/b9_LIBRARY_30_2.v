// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:20 2020
...
module FAU ( 
  ...
  oai21  g040(.a(new_n82_), .b(new_n68_), .c(new_n69_), .O(new_n103_));
  ...
  oai21  g055(.a(new_n63_), .b(new_n94_), .c(new_n64_), .O(z08));
  ...
  nor2   g060(.a(x40), .b(x14), .O(new_n123_));
  aoi21  g061(.a(x40), .b(new_n94_), .c(new_n123_), .O(new_n124_));
  ...
  nand2  g072(.a(new_n134_), .b(new_n73_), .O(new_n135_));
  ...
  inv1   g078(.a(new_n123_), .O(new_n141_));
  oai21  g079(.a(new_n94_), .b(new_n90_), .c(x40), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n141_), .O(new_n144_));
  ...
  nor2   g089(.a(new_n71_), .b(x40), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n111_), .O(new_n153_));
  ...
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n73_), .O(new_n158_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n73_), .c(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(z13));
  nand3  g105(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n168_));
  nand4  g106(.a(new_n156_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n169_));
  nand3  g107(.a(x39), .b(new_n155_), .c(new_n73_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n63_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n123_), .c(new_n168_), .O(new_n173_));
  nand3  g111(.a(new_n69_), .b(new_n147_), .c(x28), .O(new_n174_));
  ...
  nand3  g116(.a(new_n178_), .b(new_n173_), .c(new_n153_), .O(z14));
  ...
  nand2  g126(.a(new_n95_), .b(x29), .O(new_n189_));
  oai21  g127(.a(new_n83_), .b(x27), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n68_), .b(x04), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n140_), .c(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g132(.a(new_n189_), .O(new_n195_));
  oai21  g133(.a(new_n147_), .b(new_n68_), .c(new_n89_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n68_), .c(new_n147_), .O(new_n197_));
