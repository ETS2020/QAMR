...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x02), .O(new_n64_));
  ...
  aoi21  g039(.a(new_n65_), .b(new_n99_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n96_), .O(z04));
  oai21  g041(.a(new_n81_), .b(new_n99_), .c(new_n65_), .O(new_n104_));
  ...
  nand2  g055(.a(new_n93_), .b(new_n64_), .O(z08));
  ...
  nand2  g062(.a(new_n79_), .b(new_n78_), .O(new_n125_));
  ...
  nand3  g075(.a(new_n134_), .b(x27), .c(new_n71_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n88_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n78_), .c(new_n131_), .O(new_n141_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n71_), .c(new_n96_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  nand3  g097(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n160_));
  nand4  g098(.a(new_n148_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand3  g100(.a(new_n94_), .b(new_n147_), .c(new_n71_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n65_), .b(new_n133_), .c(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n79_), .c(new_n78_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n68_), .c(new_n96_), .O(new_n168_));
  ...
  oai21  g116(.a(new_n82_), .b(x27), .c(new_n132_), .O(new_n179_));
  ...
  nand2  g120(.a(new_n64_), .b(new_n99_), .O(new_n183_));
  nand3  g121(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n184_));
  ...
  nand2  g126(.a(new_n63_), .b(new_n87_), .O(new_n189_));
