...
module FAU ( 
  ...
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n97_), .O(new_n143_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n76_), .c(x26), .O(new_n151_));
  ...
  nand4  g098(.a(new_n72_), .b(x26), .c(x20), .d(new_n158_), .O(new_n161_));
  ...
  nand2  g114(.a(new_n176_), .b(new_n82_), .O(z15));
  ...
  nand4  g120(.a(new_n82_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  ...
  nand3  g134(.a(new_n196_), .b(new_n84_), .c(new_n185_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n82_), .O(z19));
  ...
  nand3  g140(.a(new_n202_), .b(new_n84_), .c(new_n185_), .O(new_n203_));
