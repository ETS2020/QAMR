...
module FAU ( 
  ...
  inv1   g018(.a(x19), .O(new_n81_));
  nor2   g019(.a(x24), .b(new_n81_), .O(new_n82_));
  ...
  nand2  g027(.a(new_n89_), .b(new_n67_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(x27), .O(new_n91_));
  nand3  g029(.a(new_n91_), .b(new_n87_), .c(new_n86_), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(new_n85_), .c(x04), .O(z01));
  ...
  nand2  g035(.a(new_n64_), .b(new_n97_), .O(new_n98_));
  nand3  g036(.a(new_n98_), .b(x35), .c(new_n88_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(x04), .c(new_n75_), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n82_), .O(z02));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n102_), .c(new_n82_), .O(z03));
  nand2  g043(.a(new_n70_), .b(new_n64_), .O(new_n106_));
  nand4  g044(.a(new_n106_), .b(new_n102_), .c(new_n85_), .d(new_n103_), .O(z04));
  oai21  g045(.a(new_n88_), .b(new_n64_), .c(new_n70_), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(new_n85_), .O(z06));
  ...
  nand2  g060(.a(new_n85_), .b(new_n75_), .O(z08));
  nand4  g061(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n85_), .O(z09));
  ...
  nand3  g066(.a(new_n128_), .b(new_n90_), .c(x27), .O(new_n129_));
  nand2  g067(.a(new_n87_), .b(new_n86_), .O(new_n130_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n85_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x40), .b(x39), .c(x29), .O(new_n137_));
  nor2   g075(.a(new_n64_), .b(new_n65_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n89_), .c(new_n137_), .O(new_n139_));
  nand4  g077(.a(x35), .b(new_n88_), .c(x27), .d(new_n65_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n97_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(new_n85_), .c(new_n86_), .d(new_n136_), .O(new_n143_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n82_), .O(z12));
  ...
  nand4  g094(.a(new_n72_), .b(x20), .c(new_n81_), .d(new_n156_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n130_), .b(x40), .c(x39), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n82_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  nand3  g101(.a(x20), .b(new_n81_), .c(new_n156_), .O(new_n164_));
  nand4  g102(.a(new_n153_), .b(new_n87_), .c(new_n86_), .d(x28), .O(new_n165_));
  ...
  nand3  g108(.a(new_n170_), .b(new_n87_), .c(new_n86_), .O(new_n171_));
  ...
  nand2  g112(.a(new_n174_), .b(new_n85_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand4  g114(.a(new_n85_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z16));
  nand3  g116(.a(x23), .b(x22), .c(x01), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n81_), .c(x24), .O(z17));
  oai21  g118(.a(new_n89_), .b(x27), .c(new_n137_), .O(new_n181_));
  nand3  g119(.a(new_n140_), .b(new_n86_), .c(new_n136_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(x08), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n82_), .O(z18));
  inv1   g122(.a(new_n137_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n97_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n85_), .c(new_n86_), .d(new_n136_), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(z20));
  inv1   g128(.a(new_n143_), .O(z19));
endmodule
