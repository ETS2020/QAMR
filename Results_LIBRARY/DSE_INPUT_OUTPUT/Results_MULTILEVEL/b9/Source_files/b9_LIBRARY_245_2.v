...
module FAU ( 
  ...
  nor2   g036(.a(x40), .b(x14), .O(new_n99_));
  ...
  aoi22  g052(.a(new_n114_), .b(x38), .c(x17), .d(new_n63_), .O(new_n115_));
  nand4  g053(.a(new_n115_), .b(x40), .c(new_n112_), .d(new_n111_), .O(new_n116_));
  inv1   g054(.a(x14), .O(new_n117_));
  nand2  g055(.a(x38), .b(new_n113_), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x00), .c(new_n117_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n116_), .c(new_n110_), .O(z07));
  ...
  nand2  g070(.a(new_n81_), .b(new_n64_), .O(new_n133_));
  ...
  aoi21  g076(.a(new_n138_), .b(x40), .c(new_n99_), .O(new_n139_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n81_), .O(z12));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n80_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n99_), .c(new_n163_), .O(new_n168_));
  ...
  nand3  g112(.a(new_n147_), .b(new_n80_), .c(new_n117_), .O(new_n175_));
  ...
  oai22  g129(.a(new_n191_), .b(new_n83_), .c(new_n93_), .d(new_n75_), .O(z18));
