...
module FAU ( 
  ...
  nand2  g037(.a(new_n99_), .b(new_n66_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n98_), .c(new_n64_), .d(x21), .O(z03));
  aoi21  g039(.a(new_n99_), .b(new_n66_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n98_), .c(new_n79_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n64_), .c(new_n99_), .O(z05));
  ...
  aoi21  g061(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(new_n124_));
  ...
  nand3  g079(.a(new_n99_), .b(new_n82_), .c(new_n130_), .O(new_n142_));
  ...
  oai21  g083(.a(new_n68_), .b(x40), .c(new_n145_), .O(z12));
  ...
  nand2  g090(.a(new_n97_), .b(new_n99_), .O(new_n153_));
  ...
  nand4  g096(.a(new_n124_), .b(x39), .c(new_n147_), .d(new_n72_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand3  g098(.a(x40), .b(new_n147_), .c(new_n72_), .O(new_n161_));
  ...
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n130_), .O(new_n181_));
  inv1   g119(.a(x09), .O(new_n182_));
  nand2  g120(.a(new_n80_), .b(new_n182_), .O(new_n183_));
  aoi21  g121(.a(new_n181_), .b(new_n83_), .c(new_n183_), .O(new_n184_));
  oai22  g122(.a(new_n184_), .b(new_n79_), .c(new_n94_), .d(new_n90_), .O(z18));
  nand2  g123(.a(new_n134_), .b(new_n131_), .O(new_n186_));
  nor2   g124(.a(new_n74_), .b(new_n132_), .O(new_n187_));
  inv1   g125(.a(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n186_), .O(new_n189_));
  inv1   g127(.a(x08), .O(new_n190_));
  oai21  g128(.a(new_n179_), .b(new_n84_), .c(new_n190_), .O(new_n191_));
  ...
  oai21  g132(.a(new_n130_), .b(new_n66_), .c(new_n190_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n66_), .c(new_n130_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n187_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n182_), .O(new_n198_));
