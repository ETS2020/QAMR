...
module FAU ( 
  ...
  nand3  g43(.a(new_n73_), .b(x07), .c(new_n105_), .O(new_n106_));
  nand2  g44(.a(x37), .b(x06), .O(new_n107_));
  nand2  g45(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g46(.a(new_n108_), .b(x27), .O(new_n109_));
  nand2  g47(.a(new_n109_), .b(z02), .O(z10));
  ...
  nand3  g53(.a(new_n115_), .b(new_n70_), .c(new_n111_), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(z02), .O(z11));
  ...
  aoi21  g61(.a(new_n123_), .b(new_n66_), .c(z08), .O(z14));
  ...
  inv1   g67(.a(x01), .O(new_n130_));
  inv1   g68(.a(x24), .O(new_n131_));
  nand4  g69(.a(z02), .b(new_n131_), .c(x23), .d(x22), .O(new_n132_));
  nor2   g70(.a(new_n132_), .b(new_n130_), .O(z17));
  nand2  g71(.a(x27), .b(new_n105_), .O(new_n134_));
  oai21  g72(.a(x27), .b(new_n113_), .c(new_n134_), .O(new_n135_));
  nand3  g73(.a(new_n135_), .b(x35), .c(new_n85_), .O(new_n136_));
  nor2   g74(.a(x30), .b(x09), .O(new_n137_));
  aoi21  g75(.a(new_n137_), .b(new_n136_), .c(z08), .O(z18));
  oai21  g76(.a(x28), .b(new_n113_), .c(new_n80_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x35), .O(new_n140_));
  nand3  g78(.a(new_n140_), .b(new_n70_), .c(new_n111_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(z02), .O(z20));
  nand2  g80(.a(new_n116_), .b(z02), .O(z19));
endmodule
