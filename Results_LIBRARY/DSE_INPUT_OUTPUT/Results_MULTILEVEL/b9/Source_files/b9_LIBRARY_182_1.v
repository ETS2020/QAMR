...
module FAU ( 
  ...
  nor2   g067(.a(x30), .b(new_n129_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n76_), .c(x32), .d(new_n65_), .O(new_n131_));
  ...
  inv1   g075(.a(new_n85_), .O(new_n138_));
  ...
  nand3  g096(.a(new_n76_), .b(x32), .c(new_n150_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n82_), .c(x04), .O(new_n160_));
  ...
  nand2  g106(.a(new_n168_), .b(new_n83_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n147_), .c(new_n95_), .O(new_n170_));
  ...
  oai21  g117(.a(new_n85_), .b(x27), .c(new_n134_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n139_), .c(new_n82_), .d(new_n133_), .O(z18));
  ...
  nand3  g124(.a(new_n186_), .b(new_n82_), .c(new_n133_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n80_), .O(z20));
  inv1   g126(.a(new_n142_), .O(z19));
endmodule
