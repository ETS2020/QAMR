...
module FAU ( 
  ...
  nor2   g040(.a(new_n82_), .b(new_n98_), .O(new_n103_));
  ...
  oai21  g070(.a(x40), .b(x39), .c(new_n98_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n134_));
  ...
  oai21  g084(.a(new_n118_), .b(x04), .c(new_n68_), .O(new_n147_));
  ...
  nand3  g104(.a(new_n65_), .b(new_n137_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n80_), .c(new_n79_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n68_), .c(new_n63_), .O(new_n170_));
  ...
  oai22  g119(.a(new_n118_), .b(new_n181_), .c(new_n83_), .d(x27), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n98_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n138_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n183_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g124(.a(x09), .O(new_n187_));
  inv1   g125(.a(x08), .O(new_n188_));
  oai21  g126(.a(new_n137_), .b(x04), .c(x39), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n133_), .c(new_n82_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand2  g129(.a(x39), .b(new_n137_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n141_), .c(new_n82_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n139_), .O(new_n194_));
  nand2  g132(.a(x40), .b(new_n137_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n141_), .c(new_n82_), .O(new_n196_));
  ...
  nand2  g137(.a(new_n199_), .b(new_n64_), .O(z19));
  nand2  g138(.a(x28), .b(new_n98_), .O(new_n201_));
  aoi22  g139(.a(new_n201_), .b(x35), .c(new_n140_), .d(new_n94_), .O(new_n202_));
  aoi21  g140(.a(new_n192_), .b(new_n133_), .c(x08), .O(new_n203_));
