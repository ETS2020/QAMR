...
module FAU ( 
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n76_), .d(new_n91_), .O(z02));
  ...
  oai21  g080(.a(new_n86_), .b(new_n64_), .c(new_n134_), .O(new_n143_));
  ...
  nand4  g100(.a(new_n128_), .b(x39), .c(new_n154_), .d(new_n65_), .O(new_n163_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n151_), .c(new_n98_), .O(new_n175_));
  ...
  oai21  g124(.a(new_n86_), .b(x27), .c(new_n139_), .O(new_n187_));
  ...
  aoi21  g130(.a(x40), .b(x14), .c(x27), .O(new_n193_));
  nand2  g131(.a(x40), .b(x04), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(x35), .c(new_n85_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n91_), .c(new_n193_), .O(new_n196_));
  aoi21  g134(.a(x39), .b(x29), .c(x14), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n120_), .c(new_n141_), .O(new_n198_));
  oai21  g136(.a(new_n196_), .b(x08), .c(new_n198_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n83_), .c(new_n135_), .O(new_n200_));
