...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n76_), .d(new_n90_), .O(z02));
  ...
  nor2   g040(.a(new_n84_), .b(new_n64_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n80_), .c(new_n70_), .O(z05));
  oai21  g043(.a(new_n103_), .b(x37), .c(new_n80_), .O(z06));
  ...
  nand2  g052(.a(x38), .b(new_n111_), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(x00), .c(new_n90_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n114_), .c(new_n107_), .O(z07));
  inv1   g055(.a(x39), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n90_), .c(new_n110_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n80_), .O(z09));
  ...
  nor2   g064(.a(new_n126_), .b(new_n118_), .O(new_n127_));
  ...
  nand2  g073(.a(new_n82_), .b(new_n135_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(new_n90_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x40), .O(new_n138_));
  nand2  g076(.a(new_n76_), .b(x29), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(x35), .c(new_n84_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  oai21  g080(.a(new_n85_), .b(new_n64_), .c(new_n133_), .O(new_n143_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n149_), .c(new_n80_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n110_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(x14), .O(new_n160_));
  nand4  g098(.a(new_n72_), .b(new_n110_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n127_), .b(new_n90_), .c(new_n153_), .d(new_n65_), .O(new_n164_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n150_), .c(new_n98_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n170_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nand4  g114(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n177_));
  ...
  aoi21  g126(.a(new_n188_), .b(new_n84_), .c(new_n136_), .O(new_n189_));
  inv1   g127(.a(new_n139_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n90_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n189_), .b(new_n98_), .c(new_n191_), .O(z18));
  nand2  g130(.a(x40), .b(x04), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(x35), .c(new_n84_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n90_), .c(new_n80_), .d(new_n64_), .O(new_n195_));
  aoi21  g133(.a(x39), .b(x29), .c(x14), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n110_), .c(new_n141_), .O(new_n197_));
  oai21  g135(.a(new_n195_), .b(x08), .c(new_n197_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n82_), .c(new_n135_), .O(new_n199_));
  inv1   g137(.a(new_n199_), .O(z19));
  oai21  g138(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n190_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n82_), .c(new_n135_), .O(new_n204_));
