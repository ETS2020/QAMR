...
module FAU ( 
  ...
  nand4  g075(.a(x35), .b(new_n82_), .c(x27), .d(new_n120_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n64_), .c(new_n79_), .d(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nand3  g080(.a(new_n69_), .b(new_n64_), .c(new_n68_), .O(new_n143_));
  oai21  g081(.a(x27), .b(new_n63_), .c(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n93_), .b(x04), .c(new_n144_), .O(new_n145_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n150_), .d(new_n120_), .O(new_n154_));
  ...
  nand3  g097(.a(new_n127_), .b(new_n150_), .c(new_n120_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n65_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n94_), .b(new_n150_), .c(new_n120_), .O(new_n165_));
  ...
  aoi21  g108(.a(new_n165_), .b(new_n71_), .c(new_n65_), .O(new_n171_));
  ...
  oai21  g119(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n65_), .b(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n138_), .d(new_n79_), .O(z18));
  nand3  g123(.a(new_n140_), .b(new_n79_), .c(new_n133_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n64_), .O(z19));
  inv1   g125(.a(new_n134_), .O(new_n188_));
  oai21  g126(.a(new_n167_), .b(new_n98_), .c(new_n137_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n98_), .c(new_n167_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n79_), .c(new_n133_), .O(new_n192_));
