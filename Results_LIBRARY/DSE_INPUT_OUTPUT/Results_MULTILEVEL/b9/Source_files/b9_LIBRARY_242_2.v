...
module FAU ( 
  ...
  nor2   g031(.a(x40), .b(x11), .O(new_n94_));
  ...
  nor2   g040(.a(new_n83_), .b(new_n98_), .O(new_n103_));
  ...
  aoi21  g059(.a(new_n121_), .b(x40), .c(new_n120_), .O(z09));
  inv1   g060(.a(x05), .O(new_n123_));
  nand2  g061(.a(new_n118_), .b(x07), .O(new_n124_));
  oai21  g062(.a(new_n118_), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g080(.a(new_n138_), .b(x27), .c(new_n74_), .O(new_n143_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n98_), .c(new_n75_), .O(new_n149_));
  oai21  g087(.a(new_n118_), .b(x04), .c(new_n71_), .O(new_n150_));
  ...
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n74_), .O(new_n155_));
  ...
  nor2   g097(.a(new_n158_), .b(x11), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n129_), .b(new_n152_), .c(new_n74_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  nand3  g101(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n164_));
  nand4  g102(.a(new_n153_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n165_));
  nand3  g103(.a(x39), .b(new_n152_), .c(new_n74_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n63_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n94_), .c(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n68_), .b(new_n137_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n81_), .c(new_n80_), .O(new_n172_));
  oai21  g110(.a(new_n167_), .b(new_n72_), .c(new_n172_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x40), .O(new_n174_));
  nand3  g112(.a(new_n71_), .b(new_n63_), .c(new_n120_), .O(new_n175_));
  ...
  oai21  g124(.a(new_n84_), .b(x27), .c(new_n136_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n65_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n143_), .d(new_n135_), .O(z18));
  nor2   g128(.a(x40), .b(x35), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n90_), .c(new_n120_), .O(new_n192_));
  nand2  g130(.a(new_n139_), .b(new_n83_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n136_), .O(new_n194_));
  nand2  g132(.a(x35), .b(x27), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(x04), .c(new_n142_), .O(new_n196_));
  nand2  g134(.a(x39), .b(x29), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n137_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n196_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(x40), .O(new_n200_));
  nand2  g138(.a(x28), .b(new_n142_), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n200_), .c(new_n194_), .d(new_n192_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n80_), .c(new_n135_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n64_), .O(z19));
  aoi21  g142(.a(x28), .b(new_n98_), .c(new_n137_), .O(new_n205_));
  nand2  g143(.a(new_n197_), .b(x40), .O(new_n206_));
  aoi21  g144(.a(new_n206_), .b(new_n95_), .c(new_n205_), .O(new_n207_));
  nand2  g145(.a(new_n64_), .b(new_n98_), .O(new_n208_));
  nand2  g146(.a(x40), .b(new_n137_), .O(new_n209_));
  aoi21  g147(.a(new_n209_), .b(new_n208_), .c(x08), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n207_), .c(new_n80_), .O(new_n211_));
