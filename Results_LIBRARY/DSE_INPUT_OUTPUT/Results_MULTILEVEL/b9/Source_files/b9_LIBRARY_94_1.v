...
module FAU ( 
  ...
  oai21  g040(.a(new_n83_), .b(new_n98_), .c(new_n65_), .O(new_n103_));
  ...
  oai22  g059(.a(new_n94_), .b(new_n120_), .c(x40), .d(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n85_), .c(new_n71_), .O(new_n123_));
  ...
  aoi21  g064(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(new_n127_));
  ...
  nor2   g069(.a(new_n74_), .b(new_n131_), .O(new_n132_));
  ...
  nand4  g078(.a(new_n140_), .b(x35), .c(new_n83_), .d(x27), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n80_), .c(new_n130_), .O(new_n144_));
  ...
  oai21  g085(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n148_));
  ...
  aoi21  g097(.a(new_n159_), .b(x39), .c(new_n74_), .O(new_n160_));
  ...
  oai21  g102(.a(new_n162_), .b(new_n74_), .c(new_n164_), .O(new_n165_));
  ...
  nand4  g107(.a(new_n169_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n170_));
  ...
  nand2  g119(.a(new_n98_), .b(x08), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n134_), .O(new_n183_));
  nand2  g121(.a(new_n80_), .b(new_n130_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(new_n83_), .c(new_n184_), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n79_), .c(new_n94_), .d(new_n90_), .O(z18));
  aoi21  g124(.a(x39), .b(new_n131_), .c(new_n74_), .O(new_n187_));
  aoi21  g125(.a(new_n136_), .b(new_n135_), .c(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n98_), .O(new_n189_));
  nand3  g127(.a(new_n140_), .b(x35), .c(new_n83_), .O(new_n190_));
  ...
  oai21  g132(.a(new_n134_), .b(new_n98_), .c(new_n139_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n98_), .c(new_n134_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n132_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n130_), .O(new_n198_));
