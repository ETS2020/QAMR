...
module FAU ( 
  ...
  oai21  g011(.a(new_n73_), .b(x19), .c(new_n72_), .O(new_n74_));
  ...
  aoi21  g030(.a(new_n92_), .b(new_n88_), .c(new_n64_), .O(z02));
  ...
  nand3  g040(.a(new_n100_), .b(new_n102_), .c(new_n68_), .O(new_n103_));
  ...
  nand2  g053(.a(new_n91_), .b(new_n102_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n102_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  ...
  nand2  g084(.a(new_n145_), .b(x10), .O(new_n147_));
  ...
  nand3  g092(.a(new_n154_), .b(x20), .c(new_n63_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(x18), .c(new_n153_), .O(new_n156_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n120_), .c(new_n64_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  inv1   g099(.a(x18), .O(new_n162_));
  aoi21  g100(.a(x20), .b(new_n162_), .c(x19), .O(new_n163_));
  nor2   g101(.a(new_n63_), .b(new_n72_), .O(new_n164_));
  nand4  g102(.a(new_n151_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand4  g104(.a(x40), .b(x39), .c(new_n149_), .d(new_n120_), .O(new_n167_));
  oai22  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .d(new_n163_), .O(new_n168_));
  nand3  g106(.a(new_n68_), .b(new_n141_), .c(x28), .O(new_n169_));
  ...
  inv1   g110(.a(new_n167_), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n70_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n172_), .c(new_n63_), .O(new_n175_));
  nand4  g113(.a(new_n78_), .b(new_n77_), .c(new_n67_), .d(x10), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n168_), .O(z14));
  nand4  g115(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n102_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand4  g118(.a(new_n102_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  inv1   g119(.a(new_n181_), .O(z16));
  inv1   g120(.a(x01), .O(new_n183_));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n102_), .b(new_n184_), .c(x23), .d(x22), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n183_), .O(z17));
  oai21  g124(.a(new_n81_), .b(x27), .c(new_n132_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n64_), .b(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n136_), .d(new_n77_), .O(z18));
  inv1   g128(.a(new_n132_), .O(new_n191_));
  oai21  g129(.a(new_n141_), .b(new_n67_), .c(new_n135_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n67_), .c(new_n141_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n102_), .c(new_n77_), .d(new_n131_), .O(new_n195_));
