...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x20), .O(new_n81_));
  ...
  aoi21  g063(.a(x40), .b(new_n75_), .c(new_n97_), .O(new_n126_));
  ...
  aoi21  g070(.a(new_n85_), .b(new_n84_), .c(new_n76_), .O(new_n133_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n84_), .c(new_n136_), .O(new_n143_));
  ...
  oai22  g085(.a(new_n120_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n148_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n158_), .c(new_n76_), .O(z13));
  nand3  g099(.a(x39), .b(new_n150_), .c(new_n65_), .O(new_n162_));
  nand3  g100(.a(x27), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n73_), .c(x40), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x20), .O(new_n165_));
  ...
  aoi21  g109(.a(new_n169_), .b(new_n151_), .c(new_n171_), .O(new_n172_));
  oai22  g110(.a(new_n172_), .b(new_n167_), .c(new_n76_), .d(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n85_), .c(new_n84_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n166_), .c(new_n98_), .O(z14));
  ...
  oai21  g122(.a(new_n87_), .b(x27), .c(new_n137_), .O(new_n185_));
  ...
  nand3  g130(.a(new_n192_), .b(new_n84_), .c(new_n136_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n81_), .O(z20));
  nand2  g132(.a(new_n143_), .b(new_n81_), .O(z19));
endmodule
