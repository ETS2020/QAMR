// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:45 2020
...
module FAU ( 
  ...
  nand2  g012(.a(x19), .b(x15), .O(new_n75_));
  and2   g013(.a(new_n75_), .b(x16), .O(new_n76_));
  nand2  g014(.a(new_n76_), .b(new_n74_), .O(z00));
  ...
  nand3  g022(.a(new_n84_), .b(new_n75_), .c(x04), .O(z01));
  inv1   g023(.a(new_n75_), .O(new_n86_));
  ...
  nor2   g028(.a(new_n66_), .b(x28), .O(new_n91_));
  oai21  g029(.a(x27), .b(x08), .c(new_n91_), .O(new_n92_));
  aoi21  g030(.a(new_n92_), .b(x04), .c(new_n90_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(new_n89_), .c(new_n86_), .O(z02));
  oai21  g032(.a(new_n66_), .b(new_n80_), .c(x27), .O(new_n95_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(new_n86_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n86_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n75_), .c(new_n96_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(z06));
  inv1   g042(.a(x03), .O(new_n105_));
  inv1   g043(.a(x31), .O(new_n106_));
  inv1   g044(.a(x33), .O(new_n107_));
  inv1   g045(.a(x19), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(x15), .O(new_n109_));
  oai21  g047(.a(x17), .b(x15), .c(new_n109_), .O(new_n110_));
  inv1   g048(.a(x00), .O(new_n111_));
  oai21  g049(.a(x25), .b(new_n111_), .c(x38), .O(new_n112_));
  nand4  g050(.a(new_n112_), .b(new_n110_), .c(new_n107_), .d(new_n106_), .O(new_n113_));
  inv1   g051(.a(x14), .O(new_n114_));
  inv1   g052(.a(x25), .O(new_n115_));
  nand3  g053(.a(x38), .b(new_n115_), .c(new_n111_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n75_), .c(new_n114_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n113_), .c(new_n105_), .O(z07));
  nand3  g056(.a(new_n75_), .b(x40), .c(x39), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(z08));
  inv1   g058(.a(x11), .O(new_n121_));
  nand4  g059(.a(new_n75_), .b(x34), .c(x27), .d(x26), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n121_), .O(z09));
  nand2  g061(.a(new_n90_), .b(x07), .O(new_n124_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(new_n75_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nor2   g073(.a(new_n64_), .b(new_n65_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n81_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n91_), .b(x27), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n78_), .c(new_n134_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n75_), .O(z11));
  ...
  oai22  g084(.a(new_n90_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n75_), .O(z12));
  ...
  inv1   g092(.a(x20), .O(new_n155_));
  nor2   g093(.a(new_n70_), .b(new_n155_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n108_), .c(new_n154_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n128_), .b(x40), .c(x39), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n86_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  aoi21  g101(.a(x20), .b(new_n154_), .c(x19), .O(new_n164_));
  nor2   g102(.a(new_n108_), .b(x15), .O(new_n165_));
  nand4  g103(.a(new_n151_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand4  g105(.a(x40), .b(x39), .c(new_n149_), .d(new_n65_), .O(new_n168_));
  oai22  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .d(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n96_), .b(new_n66_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n79_), .c(new_n78_), .O(new_n172_));
  oai21  g110(.a(new_n70_), .b(new_n64_), .c(new_n168_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n108_), .O(new_n175_));
  nand4  g113(.a(new_n79_), .b(new_n78_), .c(new_n64_), .d(new_n63_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  nand4  g115(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n75_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand4  g118(.a(new_n75_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  inv1   g119(.a(new_n181_), .O(z16));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(x23), .c(x22), .d(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n75_), .O(z17));
  oai21  g123(.a(new_n81_), .b(x27), .c(new_n135_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n86_), .b(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n139_), .d(new_n78_), .O(z18));
  ...
  nand2  g132(.a(new_n194_), .b(new_n75_), .O(z20));
  nand2  g133(.a(new_n142_), .b(new_n75_), .O(z19));
endmodule
