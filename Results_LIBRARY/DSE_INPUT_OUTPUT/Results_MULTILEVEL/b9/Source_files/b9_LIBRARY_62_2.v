...
module FAU ( 
  ...
  aoi21  g051(.a(new_n113_), .b(new_n111_), .c(new_n63_), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n110_), .c(new_n93_), .O(z07));
  ...
  nand3  g081(.a(new_n69_), .b(new_n81_), .c(new_n136_), .O(new_n144_));
  ...
  inv1   g085(.a(new_n71_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n63_), .c(new_n93_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z12));
  inv1   g088(.a(x19), .O(new_n151_));
  nand2  g089(.a(new_n70_), .b(new_n69_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n64_), .c(x20), .d(new_n151_), .O(new_n153_));
  ...
  nand3  g097(.a(new_n126_), .b(new_n154_), .c(new_n73_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand2  g099(.a(x20), .b(new_n151_), .O(new_n162_));
  nand4  g100(.a(new_n155_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(z08), .b(new_n154_), .c(new_n73_), .O(new_n165_));
  oai22  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(x18), .O(new_n166_));
  nand3  g104(.a(new_n69_), .b(new_n136_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n80_), .c(new_n79_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n148_), .c(new_n65_), .O(new_n170_));
  ...
  nand3  g122(.a(new_n137_), .b(x27), .c(new_n73_), .O(new_n185_));
  nor2   g123(.a(new_n65_), .b(x30), .O(new_n186_));
  ...
  oai21  g133(.a(new_n136_), .b(new_n68_), .c(new_n190_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n68_), .c(new_n136_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n181_), .O(new_n199_));
