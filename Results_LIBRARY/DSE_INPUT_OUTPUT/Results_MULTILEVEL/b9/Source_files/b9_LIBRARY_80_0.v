...
module FAU ( 
  ...
  oai21  g029(.a(new_n91_), .b(new_n88_), .c(x39), .O(new_n92_));
  nand2  g030(.a(x40), .b(new_n63_), .O(new_n93_));
  ...
  nand2  g069(.a(new_n65_), .b(new_n98_), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n133_));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n137_), .c(new_n139_), .d(new_n93_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n135_), .c(new_n79_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(x09), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n98_), .c(new_n74_), .O(new_n145_));
  oai21  g083(.a(new_n117_), .b(x04), .c(new_n69_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n65_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n64_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n72_), .O(new_n151_));
  ...
  nor2   g095(.a(new_n157_), .b(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n72_), .c(new_n95_), .O(new_n159_));
  ...
  nand3  g101(.a(z08), .b(new_n148_), .c(new_n72_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(new_n161_), .O(new_n165_));
  nand3  g103(.a(new_n66_), .b(new_n136_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n80_), .c(new_n79_), .O(new_n168_));
  aoi21  g106(.a(new_n164_), .b(new_n69_), .c(new_n95_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n168_), .c(new_n165_), .O(z14));
  nand4  g108(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n65_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand4  g111(.a(new_n65_), .b(new_n173_), .c(x22), .d(x01), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(z16));
  inv1   g113(.a(x24), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(x23), .c(x22), .d(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n65_), .O(z17));
  oai22  g116(.a(new_n117_), .b(new_n138_), .c(new_n83_), .d(x27), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n98_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n137_), .c(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n180_), .c(new_n65_), .d(new_n79_), .O(z18));
  aoi21  g121(.a(x28), .b(new_n98_), .c(new_n136_), .O(new_n184_));
  aoi21  g122(.a(new_n139_), .b(new_n93_), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(x39), .b(new_n136_), .O(new_n186_));
  ...
  nor2   g127(.a(new_n142_), .b(x09), .O(z19));
endmodule
