...
module FAU ( 
  ...
  oai21  g031(.a(new_n93_), .b(new_n88_), .c(x40), .O(new_n94_));
  nor2   g032(.a(x40), .b(new_n63_), .O(new_n95_));
  ...
  nand2  g037(.a(new_n69_), .b(new_n99_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n98_), .c(new_n65_), .d(x21), .O(z03));
  aoi21  g039(.a(new_n69_), .b(new_n99_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n98_), .c(new_n66_), .O(z04));
  nor2   g041(.a(new_n89_), .b(new_n99_), .O(new_n104_));
  ...
  nor2   g060(.a(new_n84_), .b(x36), .O(new_n123_));
  nor2   g061(.a(new_n64_), .b(x39), .O(new_n124_));
  oai21  g062(.a(new_n124_), .b(new_n95_), .c(x07), .O(new_n125_));
  ...
  nor2   g066(.a(new_n128_), .b(new_n119_), .O(new_n129_));
  ...
  nand2  g074(.a(new_n136_), .b(new_n84_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand3  g077(.a(new_n84_), .b(x27), .c(new_n75_), .O(new_n140_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n99_), .c(new_n76_), .O(new_n146_));
  nand2  g084(.a(z08), .b(new_n75_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n72_), .O(new_n148_));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n75_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n71_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  ...
  nand3  g097(.a(new_n129_), .b(new_n150_), .c(new_n75_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n162_));
  nand4  g100(.a(new_n151_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n163_));
  nand3  g101(.a(x39), .b(new_n150_), .c(new_n75_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n64_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n95_), .c(new_n162_), .O(new_n167_));
  nand3  g105(.a(new_n69_), .b(new_n83_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n82_), .c(new_n81_), .O(new_n170_));
  oai21  g108(.a(new_n165_), .b(new_n73_), .c(new_n170_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x40), .O(new_n172_));
  nand3  g110(.a(new_n72_), .b(new_n64_), .c(x06), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n167_), .O(z14));
  ...
  oai21  g122(.a(new_n90_), .b(x27), .c(new_n135_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n66_), .b(x30), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n140_), .d(new_n134_), .O(z18));
  nand2  g126(.a(new_n65_), .b(new_n99_), .O(new_n189_));
  oai21  g127(.a(new_n90_), .b(x04), .c(x40), .O(new_n190_));
  ...
  aoi22  g131(.a(new_n193_), .b(new_n96_), .c(new_n136_), .d(new_n84_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n191_), .c(new_n81_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z19));
  inv1   g134(.a(new_n135_), .O(new_n197_));
  oai21  g135(.a(new_n83_), .b(new_n99_), .c(new_n139_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n99_), .c(new_n83_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n81_), .c(new_n134_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n65_), .O(z20));
endmodule
