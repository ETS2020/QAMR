...
module FAU ( 
  ...
  nand3  g075(.a(x35), .b(new_n90_), .c(new_n65_), .O(new_n138_));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n85_), .c(new_n142_), .d(new_n96_), .O(new_n144_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n151_), .c(new_n98_), .O(new_n174_));
  ...
  oai21  g124(.a(new_n91_), .b(x27), .c(new_n186_), .O(new_n187_));
