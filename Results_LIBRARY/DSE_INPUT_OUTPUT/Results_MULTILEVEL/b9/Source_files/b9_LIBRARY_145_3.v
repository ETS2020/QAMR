...
module FAU ( 
  ...
  nand2  g001(.a(x40), .b(x22), .O(new_n64_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(new_n72_), .O(new_n93_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n65_), .c(new_n79_), .O(z05));
  ...
  oai21  g087(.a(new_n122_), .b(x04), .c(new_n68_), .O(new_n150_));
  ...
  nand4  g100(.a(new_n128_), .b(new_n72_), .c(new_n152_), .d(new_n120_), .O(new_n163_));
  ...
  nand3  g105(.a(new_n140_), .b(new_n152_), .c(new_n120_), .O(new_n168_));
  ...
  aoi21  g111(.a(new_n168_), .b(new_n68_), .c(new_n79_), .O(new_n174_));
  ...
  nand4  g117(.a(new_n74_), .b(new_n179_), .c(x22), .d(x01), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z16));
  nand3  g119(.a(x23), .b(x22), .c(x01), .O(new_n182_));
  nor3   g120(.a(new_n182_), .b(x40), .c(x24), .O(z17));
  nand2  g121(.a(x27), .b(new_n120_), .O(new_n184_));
  nand2  g122(.a(new_n97_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(new_n170_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n83_), .c(new_n137_), .O(new_n187_));
  inv1   g125(.a(new_n141_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n72_), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n187_), .b(new_n79_), .c(new_n189_), .O(z18));
  oai21  g128(.a(new_n184_), .b(new_n84_), .c(new_n134_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n143_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n136_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n64_), .O(z19));
  oai21  g132(.a(new_n170_), .b(new_n97_), .c(new_n134_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n97_), .c(new_n170_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n188_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n136_), .O(new_n198_));
