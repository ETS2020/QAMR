...
module FAU ( 
  ...
  nand2  g015(.a(x40), .b(x20), .O(new_n78_));
  ...
  oai21  g031(.a(new_n93_), .b(new_n88_), .c(new_n87_), .O(new_n94_));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n64_), .c(new_n80_), .O(new_n99_));
  ...
  nand3  g042(.a(new_n103_), .b(new_n78_), .c(new_n98_), .O(new_n105_));
  ...
  oai21  g055(.a(x39), .b(x20), .c(x40), .O(new_n118_));
  ...
  aoi21  g060(.a(x35), .b(new_n89_), .c(x36), .O(new_n123_));
  nand2  g061(.a(new_n118_), .b(x07), .O(new_n124_));
  nand4  g062(.a(x40), .b(x39), .c(new_n87_), .d(x05), .O(new_n125_));
  ...
  nor2   g068(.a(new_n130_), .b(new_n72_), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n87_), .c(x05), .d(new_n65_), .O(new_n132_));
  oai21  g070(.a(new_n129_), .b(new_n64_), .c(new_n132_), .O(z10));
  inv1   g071(.a(x08), .O(new_n134_));
  inv1   g072(.a(x09), .O(new_n135_));
  nand4  g073(.a(new_n81_), .b(new_n135_), .c(new_n134_), .d(x04), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n87_), .O(new_n137_));
  ...
  oai21  g079(.a(new_n90_), .b(new_n64_), .c(new_n134_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n81_), .c(new_n135_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n138_), .O(z11));
  ...
  nand2  g086(.a(new_n74_), .b(new_n65_), .O(new_n149_));
  oai21  g087(.a(new_n70_), .b(new_n64_), .c(new_n149_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n78_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n73_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n87_), .d(new_n152_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  aoi21  g095(.a(new_n96_), .b(new_n98_), .c(x40), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n159_));
  oai21  g097(.a(new_n155_), .b(x04), .c(new_n159_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand4  g099(.a(new_n131_), .b(new_n87_), .c(new_n152_), .d(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  nor3   g101(.a(x32), .b(x30), .c(x20), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n73_), .c(new_n64_), .O(new_n165_));
  nand4  g103(.a(new_n153_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n74_), .c(new_n152_), .d(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n87_), .O(new_n168_));
  nand2  g106(.a(new_n157_), .b(new_n156_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n70_), .c(new_n73_), .O(new_n170_));
  ...
  oai21  g118(.a(new_n90_), .b(x27), .c(new_n139_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n80_), .b(x09), .O(new_n183_));
  nand3  g121(.a(new_n83_), .b(x27), .c(new_n65_), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n81_), .O(z18));
  nand2  g123(.a(new_n184_), .b(new_n134_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n141_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n81_), .c(new_n135_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n78_), .O(z19));
  inv1   g127(.a(new_n139_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n134_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n81_), .c(new_n135_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n78_), .O(z20));
endmodule
