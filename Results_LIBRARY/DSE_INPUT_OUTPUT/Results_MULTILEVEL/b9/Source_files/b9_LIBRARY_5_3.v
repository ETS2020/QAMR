...
module FAU ( 
  ...
  nand2  g000(.a(x10), .b(x06), .O(new_n63_));
  ...
  aoi21  g022(.a(new_n84_), .b(x04), .c(new_n77_), .O(z01));
  ...
  nand2  g031(.a(new_n65_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x21), .O(new_n95_));
  inv1   g033(.a(x27), .O(new_n96_));
  aoi21  g034(.a(new_n64_), .b(new_n96_), .c(new_n95_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n94_), .c(new_n77_), .O(z03));
  nand2  g036(.a(new_n64_), .b(new_n96_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n94_), .c(new_n63_), .d(new_n95_), .O(z04));
  inv1   g038(.a(x28), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n96_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n63_), .c(new_n64_), .O(z05));
  oai21  g042(.a(new_n102_), .b(x37), .c(new_n63_), .O(z06));
  inv1   g043(.a(x33), .O(new_n106_));
  nand2  g044(.a(x17), .b(new_n70_), .O(new_n107_));
  ...
  nand3  g055(.a(new_n63_), .b(x40), .c(x39), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n63_), .O(z09));
  inv1   g059(.a(x10), .O(new_n122_));
  oai21  g060(.a(new_n64_), .b(new_n96_), .c(new_n122_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x06), .O(new_n124_));
  inv1   g062(.a(x04), .O(new_n125_));
  nand2  g063(.a(new_n91_), .b(x07), .O(new_n126_));
  ...
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n151_), .d(new_n125_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n66_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n125_), .c(new_n77_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z13));
  nand3  g102(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n165_));
  nand4  g103(.a(new_n153_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand4  g105(.a(x40), .b(x39), .c(new_n151_), .d(new_n125_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  nand3  g107(.a(new_n64_), .b(new_n80_), .c(x28), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(x27), .c(x32), .O(new_n171_));
  aoi22  g109(.a(new_n171_), .b(new_n78_), .c(new_n168_), .d(new_n67_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n169_), .c(new_n77_), .O(z14));
  ...
  nand2  g120(.a(new_n89_), .b(new_n96_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n136_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n141_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n63_), .d(new_n135_), .O(z18));
  inv1   g125(.a(new_n136_), .O(new_n188_));
  nor2   g126(.a(new_n80_), .b(new_n96_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n96_), .c(new_n80_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .d(x08), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n63_), .c(new_n78_), .d(new_n135_), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(z20));
  inv1   g131(.a(new_n143_), .O(z19));
endmodule
