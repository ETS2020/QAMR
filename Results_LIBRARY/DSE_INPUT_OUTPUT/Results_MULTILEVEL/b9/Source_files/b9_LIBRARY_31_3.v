...
module FAU ( 
  ...
  nand2  g23(.a(new_n84_), .b(new_n67_), .O(new_n86_));
  ...
  oai21  g72(.a(x27), .b(new_n112_), .c(new_n134_), .O(new_n135_));
  nand3  g73(.a(new_n135_), .b(x35), .c(new_n110_), .O(new_n136_));
  nand4  g74(.a(new_n136_), .b(z02), .c(new_n72_), .d(new_n109_), .O(z18));
  nand4  g75(.a(new_n114_), .b(z02), .c(new_n72_), .d(new_n109_), .O(new_n138_));
  inv1   g76(.a(new_n138_), .O(z19));
  oai21  g77(.a(x28), .b(new_n112_), .c(new_n66_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(x35), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n72_), .c(new_n109_), .O(new_n142_));
