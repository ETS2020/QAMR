...
module FAU ( 
  ...
  nand2  g061(.a(x40), .b(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n96_), .c(new_n122_), .O(new_n125_));
  ...
  nor2   g070(.a(new_n132_), .b(new_n123_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x05), .c(new_n72_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n131_), .O(z10));
  nand2  g073(.a(new_n65_), .b(new_n99_), .O(new_n136_));
  oai21  g074(.a(new_n84_), .b(x04), .c(x29), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(x08), .O(new_n138_));
  inv1   g076(.a(new_n84_), .O(new_n139_));
  nor2   g077(.a(new_n64_), .b(x29), .O(new_n140_));
  aoi21  g078(.a(new_n118_), .b(x29), .c(new_n140_), .O(new_n141_));
  ...
  oai21  g085(.a(new_n118_), .b(x04), .c(new_n69_), .O(new_n148_));
  ...
  nand4  g095(.a(new_n68_), .b(x29), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n133_), .b(new_n150_), .c(new_n72_), .O(new_n161_));
  ...
  nand4  g103(.a(x40), .b(x39), .c(new_n150_), .d(new_n72_), .O(new_n166_));
  ...
  aoi21  g109(.a(new_n166_), .b(new_n69_), .c(new_n79_), .O(new_n172_));
  ...
  nand2  g120(.a(x27), .b(new_n72_), .O(new_n183_));
  nand2  g121(.a(new_n99_), .b(x08), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(new_n168_), .O(new_n185_));
  inv1   g123(.a(x09), .O(new_n186_));
  nand2  g124(.a(new_n80_), .b(new_n186_), .O(new_n187_));
  aoi21  g125(.a(new_n185_), .b(new_n83_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n79_), .c(new_n118_), .d(new_n90_), .O(z18));
  aoi21  g127(.a(x28), .b(new_n99_), .c(new_n168_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(new_n141_), .O(new_n191_));
  nand2  g129(.a(new_n168_), .b(x29), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n136_), .c(x08), .O(new_n193_));
