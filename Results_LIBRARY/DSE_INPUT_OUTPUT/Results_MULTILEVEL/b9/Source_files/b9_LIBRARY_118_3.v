...
module FAU ( 
  ...
  nand4  g063(.a(x40), .b(x39), .c(new_n83_), .d(x05), .O(new_n126_));
  aoi22  g064(.a(new_n126_), .b(new_n125_), .c(new_n93_), .d(new_n67_), .O(new_n127_));
  ...
  nand2  g070(.a(x30), .b(new_n132_), .O(new_n133_));
  nand2  g071(.a(x32), .b(new_n83_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n133_), .c(new_n131_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x39), .c(x05), .d(new_n65_), .O(new_n136_));
  oai21  g074(.a(new_n130_), .b(new_n64_), .c(new_n136_), .O(z10));
  ...
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n131_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n72_), .b(x20), .c(new_n157_), .d(new_n132_), .O(new_n158_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n65_), .c(new_n97_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  nand2  g103(.a(x20), .b(new_n157_), .O(new_n166_));
  ...
  nand2  g108(.a(new_n154_), .b(x18), .O(new_n171_));
  nand3  g109(.a(new_n70_), .b(new_n66_), .c(new_n83_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(new_n92_), .O(new_n173_));
  nor2   g111(.a(x30), .b(x27), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(new_n84_), .O(new_n175_));
  nand3  g113(.a(new_n72_), .b(x27), .c(new_n132_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n169_), .c(new_n97_), .O(new_n177_));
  ...
  nand4  g119(.a(new_n80_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  ...
  aoi21  g126(.a(new_n188_), .b(new_n139_), .c(new_n142_), .O(new_n189_));
  nand2  g127(.a(new_n143_), .b(new_n138_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n189_), .c(new_n83_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n133_), .O(z18));
  nand2  g130(.a(new_n146_), .b(new_n80_), .O(z19));
