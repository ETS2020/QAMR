...
module FAU ( 
  ...
  nand3  g035(.a(new_n97_), .b(new_n95_), .c(new_n77_), .O(z02));
  ...
  nand4  g049(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n81_), .O(new_n112_));
  ...
  nand2  g062(.a(new_n76_), .b(x31), .O(new_n125_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n76_), .c(x31), .O(new_n152_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n151_), .c(new_n84_), .O(new_n175_));
  ...
  oai22  g130(.a(new_n192_), .b(new_n84_), .c(new_n94_), .d(new_n119_), .O(z18));
  nor2   g131(.a(new_n66_), .b(new_n64_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  nand2  g133(.a(new_n77_), .b(x29), .O(new_n196_));
  inv1   g134(.a(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n195_), .c(new_n194_), .d(x08), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n85_), .c(new_n190_), .O(new_n199_));
