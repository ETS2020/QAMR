...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n196_, new_n197_;
  nor2   g000(.a(x21), .b(x05), .O(new_n63_));
  ...
  nor2   g030(.a(new_n67_), .b(x28), .O(new_n93_));
  oai21  g031(.a(x27), .b(x08), .c(new_n93_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(x04), .c(new_n76_), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n63_), .O(z02));
  inv1   g034(.a(x21), .O(new_n97_));
  nor2   g035(.a(x37), .b(x27), .O(new_n98_));
  aoi21  g036(.a(new_n72_), .b(x27), .c(new_n98_), .O(new_n99_));
  nand2  g037(.a(new_n97_), .b(x05), .O(new_n100_));
  oai21  g038(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(z03));
  nand2  g039(.a(new_n72_), .b(x27), .O(new_n102_));
  inv1   g040(.a(new_n98_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n102_), .c(new_n97_), .d(x05), .O(z04));
  inv1   g042(.a(new_n63_), .O(new_n105_));
  nor2   g043(.a(new_n84_), .b(new_n65_), .O(new_n106_));
  inv1   g044(.a(new_n106_), .O(new_n107_));
  nand3  g045(.a(new_n107_), .b(new_n105_), .c(new_n71_), .O(z05));
  ...
  nand2  g062(.a(new_n124_), .b(new_n105_), .O(z09));
  inv1   g063(.a(x05), .O(new_n126_));
  aoi21  g064(.a(x40), .b(x39), .c(x07), .O(new_n127_));
  nand2  g065(.a(new_n76_), .b(x07), .O(new_n128_));
  ...
  nor2   g069(.a(new_n131_), .b(new_n121_), .O(new_n132_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n105_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  nand3  g076(.a(x40), .b(x39), .c(x29), .O(new_n139_));
  nor2   g077(.a(new_n65_), .b(new_n66_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n85_), .c(new_n139_), .O(new_n141_));
  inv1   g079(.a(x08), .O(new_n142_));
  nand3  g080(.a(new_n93_), .b(x27), .c(new_n66_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(new_n105_), .c(new_n82_), .d(new_n138_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(z11));
  inv1   g085(.a(x10), .O(new_n148_));
  nor3   g086(.a(x37), .b(x36), .c(x35), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n65_), .c(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n73_), .b(x27), .O(new_n151_));
  oai21  g089(.a(new_n76_), .b(x04), .c(new_n151_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n150_), .c(new_n63_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n122_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n154_), .d(new_n66_), .O(new_n157_));
  ...
  nand3  g100(.a(new_n132_), .b(new_n154_), .c(new_n66_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n162_), .c(new_n63_), .O(z13));
  nand3  g102(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n165_));
  nand4  g103(.a(new_n155_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n77_), .b(new_n154_), .c(new_n66_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  nand3  g107(.a(new_n71_), .b(new_n67_), .c(x28), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(x27), .c(x32), .O(new_n171_));
  aoi22  g109(.a(new_n171_), .b(new_n82_), .c(new_n168_), .d(new_n151_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n169_), .c(new_n63_), .O(z14));
  nand4  g111(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n105_), .O(z15));
  ...
  oai21  g119(.a(new_n85_), .b(x27), .c(new_n139_), .O(new_n182_));
  nand3  g120(.a(new_n143_), .b(new_n82_), .c(new_n138_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(x08), .c(new_n183_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n63_), .O(z18));
  oai21  g123(.a(new_n67_), .b(new_n65_), .c(new_n142_), .O(new_n186_));
  nand2  g124(.a(new_n139_), .b(new_n67_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n63_), .O(new_n188_));
  oai21  g126(.a(x28), .b(x04), .c(new_n142_), .O(new_n189_));
  oai21  g127(.a(new_n140_), .b(x28), .c(new_n139_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n82_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(x09), .c(new_n105_), .O(z19));
  inv1   g131(.a(new_n139_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n194_), .c(new_n186_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n105_), .c(new_n82_), .d(new_n138_), .O(new_n197_));
