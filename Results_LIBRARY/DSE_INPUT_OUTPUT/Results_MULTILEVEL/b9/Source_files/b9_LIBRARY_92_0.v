...
module FAU ( 
  ...
  oai21  g026(.a(new_n88_), .b(new_n83_), .c(new_n84_), .O(new_n89_));
  ...
  nand3  g059(.a(new_n121_), .b(new_n87_), .c(x27), .O(new_n122_));
  ...
  nand3  g072(.a(x40), .b(x39), .c(x04), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x35), .c(new_n85_), .d(x27), .O(new_n136_));
  ...
  aoi21  g077(.a(new_n139_), .b(x18), .c(x30), .O(z11));
  ...
  nand4  g087(.a(new_n149_), .b(x39), .c(x18), .d(new_n146_), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  aoi21  g089(.a(new_n71_), .b(new_n70_), .c(new_n84_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x20), .c(new_n151_), .d(new_n83_), .O(new_n153_));
  oai21  g091(.a(new_n150_), .b(x04), .c(new_n153_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand2  g093(.a(x32), .b(x18), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n84_), .c(new_n147_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n146_), .d(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  nand2  g097(.a(new_n148_), .b(x28), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x27), .c(x32), .O(new_n161_));
  nand3  g099(.a(new_n76_), .b(new_n146_), .c(new_n65_), .O(new_n162_));
  aoi21  g100(.a(new_n161_), .b(new_n84_), .c(new_n162_), .O(new_n163_));
  nand4  g101(.a(new_n72_), .b(x27), .c(x20), .d(new_n151_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(x30), .O(new_n165_));
  oai21  g103(.a(new_n163_), .b(new_n83_), .c(new_n165_), .O(z14));
  ...
  nand2  g108(.a(new_n170_), .b(new_n81_), .O(z16));
  ...
  nand3  g113(.a(x35), .b(new_n85_), .c(new_n64_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n131_), .c(new_n134_), .O(new_n177_));
  nand4  g115(.a(x35), .b(new_n85_), .c(x27), .d(new_n65_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n130_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n177_), .c(x18), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n84_), .O(z18));
  nand2  g119(.a(new_n178_), .b(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n133_), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n84_), .c(x18), .d(new_n130_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z19));
  inv1   g123(.a(new_n131_), .O(new_n186_));
  oai21  g124(.a(new_n66_), .b(new_n64_), .c(new_n134_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n84_), .c(x18), .d(new_n130_), .O(new_n190_));
