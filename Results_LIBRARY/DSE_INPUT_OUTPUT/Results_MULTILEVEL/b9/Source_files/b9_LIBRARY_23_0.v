...
module FAU ( 
  ...
  aoi21  g012(.a(new_n74_), .b(new_n63_), .c(new_n64_), .O(new_n75_));
  nand4  g013(.a(new_n75_), .b(x39), .c(new_n73_), .d(new_n72_), .O(new_n76_));
  ...
  nand2  g029(.a(new_n64_), .b(x10), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n91_), .O(z02));
  nand2  g031(.a(new_n67_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x27), .O(new_n95_));
  nand2  g033(.a(new_n66_), .b(new_n95_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n65_), .d(x21), .O(z03));
  inv1   g035(.a(new_n65_), .O(new_n98_));
  aoi21  g036(.a(new_n66_), .b(new_n95_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n98_), .O(z04));
  nor2   g038(.a(new_n81_), .b(new_n95_), .O(new_n101_));
  ...
  nand2  g060(.a(x40), .b(new_n116_), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n92_), .c(new_n122_), .O(new_n124_));
  ...
  nor2   g069(.a(new_n131_), .b(new_n116_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x05), .c(new_n72_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(z10));
  nand2  g072(.a(new_n117_), .b(x29), .O(new_n135_));
  ...
  nand3  g078(.a(new_n137_), .b(x27), .c(new_n72_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(x08), .c(new_n140_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n78_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(x09), .c(new_n65_), .O(z11));
  oai21  g083(.a(new_n118_), .b(x04), .c(new_n69_), .O(new_n146_));
  nand3  g084(.a(new_n66_), .b(new_n80_), .c(new_n136_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(x40), .c(x27), .O(new_n148_));
  ...
  nand3  g098(.a(new_n132_), .b(new_n151_), .c(new_n72_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n117_), .b(new_n151_), .c(new_n72_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n66_), .b(new_n136_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n79_), .c(new_n78_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n69_), .c(new_n98_), .O(new_n171_));
  ...
  nand4  g114(.a(new_n65_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  ...
  oai21  g120(.a(new_n82_), .b(x27), .c(new_n135_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n142_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n65_), .d(new_n78_), .O(z18));
  nand2  g124(.a(new_n65_), .b(new_n95_), .O(new_n187_));
  ...
  aoi21  g128(.a(x39), .b(x29), .c(new_n64_), .O(new_n191_));
  aoi21  g129(.a(new_n64_), .b(x10), .c(new_n191_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n189_), .c(new_n78_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(x09), .O(z19));
  aoi21  g133(.a(x28), .b(new_n95_), .c(new_n136_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(new_n192_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n136_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n187_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n78_), .O(new_n200_));
