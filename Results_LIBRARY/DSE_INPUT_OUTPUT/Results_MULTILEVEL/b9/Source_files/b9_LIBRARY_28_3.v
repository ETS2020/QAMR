...
module FAU ( 
  ...
  nand3  g54(.a(new_n117_), .b(new_n63_), .c(x27), .O(z12));
  ...
  nand2  g66(.a(new_n129_), .b(new_n63_), .O(z16));
  ...
  nand4  g75(.a(new_n114_), .b(new_n63_), .c(new_n71_), .d(new_n110_), .O(new_n139_));
  ...
  nand2  g80(.a(new_n143_), .b(new_n63_), .O(z20));
  one    g81(.O(z02));
endmodule
