...
module FAU ( 
  ...
  nor3   g058(.a(new_n82_), .b(new_n120_), .c(new_n119_), .O(z08));
  inv1   g059(.a(x11), .O(new_n122_));
  nand4  g060(.a(new_n92_), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n81_), .O(new_n148_));
  ...
  nand2  g098(.a(x32), .b(new_n152_), .O(new_n161_));
  ...
  nand3  g132(.a(new_n194_), .b(new_n81_), .c(new_n134_), .O(new_n195_));
