...
module FAU ( 
  ...
  oai21  g024(.a(new_n86_), .b(x19), .c(new_n80_), .O(new_n87_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n89_), .O(z02));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n89_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n70_), .c(new_n89_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n81_), .c(new_n70_), .O(new_n104_));
  ...
  nor3   g056(.a(new_n89_), .b(new_n118_), .c(new_n117_), .O(z08));
  ...
  inv1   g061(.a(x19), .O(new_n124_));
  nand3  g062(.a(new_n76_), .b(new_n124_), .c(x05), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n123_), .c(new_n84_), .O(new_n126_));
  inv1   g064(.a(x06), .O(new_n127_));
  nand2  g065(.a(new_n81_), .b(x37), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  aoi21  g067(.a(new_n126_), .b(new_n65_), .c(new_n129_), .O(new_n130_));
  nand2  g068(.a(x32), .b(new_n124_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n80_), .c(new_n118_), .O(new_n132_));
  ...
  nand3  g078(.a(new_n93_), .b(x27), .c(new_n65_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n80_), .c(new_n124_), .d(new_n135_), .O(new_n144_));
  ...
  oai22  g086(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n81_), .O(z12));
  ...
  nand4  g093(.a(new_n72_), .b(x20), .c(new_n124_), .d(new_n155_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nor2   g096(.a(x13), .b(x04), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n76_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x30), .O(new_n161_));
  oai21  g099(.a(x32), .b(x30), .c(x40), .O(new_n162_));
  nor3   g100(.a(new_n162_), .b(new_n117_), .c(x13), .O(new_n163_));
  aoi22  g101(.a(new_n163_), .b(new_n65_), .c(new_n161_), .d(x19), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n158_), .O(z13));
  nand2  g103(.a(x20), .b(new_n155_), .O(new_n166_));
  inv1   g104(.a(x32), .O(new_n167_));
  nand4  g105(.a(new_n152_), .b(new_n167_), .c(new_n80_), .d(x28), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n159_), .c(new_n76_), .O(new_n169_));
  ...
  nand3  g110(.a(new_n172_), .b(new_n167_), .c(new_n80_), .O(new_n173_));
  oai21  g111(.a(new_n73_), .b(new_n64_), .c(new_n160_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n170_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n124_), .O(new_n176_));
  nand3  g114(.a(new_n160_), .b(x30), .c(x19), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n176_), .O(z14));
  ...
  nand2  g125(.a(new_n93_), .b(new_n64_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n136_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(x19), .b(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n141_), .d(new_n80_), .O(z18));
  inv1   g130(.a(new_n136_), .O(new_n193_));
  aoi21  g131(.a(new_n66_), .b(new_n124_), .c(x28), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n137_), .c(new_n193_), .O(new_n195_));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(new_n124_), .O(new_n196_));
  nor2   g134(.a(x28), .b(x04), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n135_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n124_), .c(x30), .O(z19));
  oai21  g138(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n193_), .c(new_n201_), .O(new_n203_));
  nand4  g141(.a(new_n203_), .b(new_n80_), .c(new_n124_), .d(new_n135_), .O(new_n204_));
