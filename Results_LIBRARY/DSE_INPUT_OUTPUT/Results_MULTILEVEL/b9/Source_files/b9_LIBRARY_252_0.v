...
module FAU ( 
  ...
  nor2   g014(.a(x40), .b(x07), .O(new_n77_));
  ...
  aoi21  g035(.a(new_n95_), .b(new_n64_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n77_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n78_), .c(new_n95_), .O(z05));
  ...
  nand3  g049(.a(new_n111_), .b(new_n78_), .c(x03), .O(new_n112_));
  inv1   g050(.a(new_n112_), .O(z07));
  inv1   g051(.a(x11), .O(new_n114_));
  nand4  g052(.a(new_n78_), .b(x34), .c(x27), .d(x26), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  inv1   g054(.a(x05), .O(new_n117_));
  nand2  g055(.a(new_n72_), .b(x07), .O(new_n118_));
  oai21  g056(.a(new_n72_), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(new_n84_), .c(new_n65_), .O(new_n120_));
  nand3  g058(.a(new_n78_), .b(x37), .c(x06), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x27), .O(new_n123_));
  nand2  g061(.a(new_n81_), .b(new_n80_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(x40), .c(x39), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(new_n117_), .O(new_n126_));
  ...
  nor2   g068(.a(new_n66_), .b(x28), .O(new_n131_));
  ...
  nand3  g073(.a(new_n131_), .b(x27), .c(new_n65_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n80_), .c(new_n129_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n78_), .O(z11));
  nand3  g078(.a(new_n95_), .b(new_n67_), .c(new_n66_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  nor2   g080(.a(new_n70_), .b(new_n64_), .O(new_n143_));
  aoi21  g081(.a(x39), .b(new_n65_), .c(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n142_), .c(x40), .O(new_n145_));
  nor2   g083(.a(new_n143_), .b(x40), .O(new_n146_));
  ...
  nor2   g097(.a(new_n125_), .b(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n77_), .O(new_n161_));
  ...
  nand3  g102(.a(x39), .b(new_n149_), .c(new_n65_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n150_), .O(new_n167_));
  nand2  g105(.a(new_n150_), .b(x07), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(new_n163_), .O(new_n170_));
  nand3  g108(.a(new_n95_), .b(new_n66_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n81_), .c(new_n80_), .O(new_n173_));
  oai21  g111(.a(new_n166_), .b(new_n143_), .c(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x40), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n170_), .c(new_n147_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nor2   g115(.a(new_n115_), .b(new_n177_), .O(z15));
  inv1   g116(.a(x23), .O(new_n179_));
  nand4  g117(.a(new_n78_), .b(new_n179_), .c(x22), .d(x01), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z16));
  inv1   g119(.a(x01), .O(new_n182_));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n78_), .b(new_n183_), .c(x23), .d(x22), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n182_), .O(z17));
  oai21  g123(.a(new_n83_), .b(x27), .c(new_n130_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n77_), .b(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n136_), .d(new_n129_), .O(z18));
  nor2   g127(.a(x40), .b(x35), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n91_), .c(x07), .O(new_n191_));
  nand2  g129(.a(new_n132_), .b(new_n82_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n130_), .O(new_n193_));
  nand2  g131(.a(x35), .b(x27), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(x04), .c(new_n135_), .O(new_n195_));
  nand2  g133(.a(x39), .b(x29), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n66_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n195_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(x40), .O(new_n199_));
  nand2  g137(.a(x28), .b(new_n135_), .O(new_n200_));
  nand4  g138(.a(new_n200_), .b(new_n199_), .c(new_n193_), .d(new_n191_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n80_), .c(new_n129_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n78_), .O(z19));
  nand2  g141(.a(x28), .b(new_n64_), .O(new_n204_));
  nand2  g142(.a(new_n196_), .b(x40), .O(new_n205_));
  aoi22  g143(.a(new_n205_), .b(new_n168_), .c(new_n204_), .d(x35), .O(new_n206_));
  nand2  g144(.a(new_n78_), .b(new_n64_), .O(new_n207_));
  nand2  g145(.a(x40), .b(new_n66_), .O(new_n208_));
