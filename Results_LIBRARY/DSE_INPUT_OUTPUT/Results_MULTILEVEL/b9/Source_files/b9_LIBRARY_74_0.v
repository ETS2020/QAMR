...
module FAU ( 
  ...
  nand3  g034(.a(new_n96_), .b(new_n92_), .c(x39), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(x40), .O(new_n98_));
  nor2   g036(.a(x40), .b(new_n81_), .O(new_n99_));
  ...
  aoi21  g045(.a(new_n107_), .b(new_n103_), .c(new_n102_), .O(z04));
  nor2   g046(.a(new_n93_), .b(new_n64_), .O(new_n109_));
  inv1   g047(.a(new_n109_), .O(new_n110_));
  nand3  g048(.a(new_n110_), .b(new_n82_), .c(new_n70_), .O(z05));
  oai21  g049(.a(new_n109_), .b(x37), .c(new_n82_), .O(z06));
  ...
  oai21  g077(.a(new_n94_), .b(x04), .c(x40), .O(new_n140_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n86_), .c(new_n143_), .d(new_n100_), .O(new_n145_));
  ...
  oai21  g089(.a(new_n124_), .b(x04), .c(new_n151_), .O(new_n152_));
  ...
  nor2   g099(.a(new_n160_), .b(new_n81_), .O(new_n162_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n151_), .c(new_n102_), .O(new_n174_));
  ...
  nand2  g125(.a(new_n84_), .b(new_n187_), .O(new_n188_));
  aoi21  g126(.a(new_n186_), .b(new_n93_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n102_), .c(new_n91_), .d(new_n124_), .O(z18));
  nand2  g128(.a(new_n144_), .b(new_n86_), .O(new_n191_));
  nand2  g129(.a(new_n77_), .b(x29), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  inv1   g131(.a(x08), .O(new_n194_));
  oai21  g132(.a(new_n184_), .b(new_n94_), .c(new_n194_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n84_), .c(new_n187_), .O(new_n197_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n84_), .c(new_n187_), .O(new_n203_));
