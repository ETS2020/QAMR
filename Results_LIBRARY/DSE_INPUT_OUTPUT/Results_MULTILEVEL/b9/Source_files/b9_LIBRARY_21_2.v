...
module FAU ( 
  ...
  nor2   g001(.a(x10), .b(new_n63_), .O(new_n64_));
  ...
  oai21  g012(.a(new_n74_), .b(x00), .c(new_n73_), .O(new_n75_));
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(new_n87_), .O(z02));
  ...
  nand3  g041(.a(new_n103_), .b(new_n87_), .c(new_n67_), .O(z05));
  inv1   g042(.a(z05), .O(z06));
  inv1   g043(.a(x33), .O(new_n106_));
  nand2  g044(.a(x17), .b(new_n65_), .O(new_n107_));
  oai21  g045(.a(x25), .b(new_n63_), .c(x38), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(new_n109_));
  inv1   g047(.a(x25), .O(new_n110_));
  nand3  g048(.a(x38), .b(new_n110_), .c(new_n63_), .O(new_n111_));
  ...
  nand2  g053(.a(new_n93_), .b(new_n87_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n87_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  ...
  nor2   g072(.a(new_n98_), .b(new_n120_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n82_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n81_), .c(x27), .d(new_n120_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n87_), .c(new_n78_), .d(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  oai21  g080(.a(new_n93_), .b(x04), .c(new_n68_), .O(new_n143_));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n80_), .b(new_n144_), .c(new_n73_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n143_), .c(x37), .O(new_n146_));
  nor2   g084(.a(x27), .b(x10), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n63_), .O(new_n148_));
  nand2  g086(.a(new_n94_), .b(new_n120_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n70_), .c(x10), .O(new_n150_));
  ...
  nand3  g104(.a(new_n94_), .b(new_n152_), .c(new_n120_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n67_), .b(new_n144_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n79_), .c(new_n78_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n70_), .c(new_n64_), .O(new_n172_));
  ...
  nor2   g122(.a(new_n64_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n138_), .d(new_n78_), .O(z18));
  nand3  g124(.a(new_n140_), .b(new_n78_), .c(new_n133_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n87_), .O(z19));
  inv1   g126(.a(new_n134_), .O(new_n189_));
  oai21  g127(.a(new_n144_), .b(new_n98_), .c(new_n137_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n98_), .c(new_n144_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n78_), .c(new_n133_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n87_), .O(z20));
endmodule
