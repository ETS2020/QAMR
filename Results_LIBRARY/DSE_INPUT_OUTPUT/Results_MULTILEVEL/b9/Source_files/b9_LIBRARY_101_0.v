...
module FAU ( 
  ...
  oai21  g033(.a(x40), .b(new_n63_), .c(new_n95_), .O(z02));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n79_), .O(z04));
  ...
  nand2  g069(.a(new_n65_), .b(new_n99_), .O(new_n132_));
  ...
  nand2  g075(.a(new_n118_), .b(x29), .O(new_n138_));
  nand2  g076(.a(x40), .b(new_n63_), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(new_n137_), .c(new_n139_), .d(new_n138_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n99_), .c(new_n74_), .O(new_n145_));
  ...
  nand4  g101(.a(x40), .b(x39), .c(new_n148_), .d(new_n72_), .O(new_n164_));
  ...
  aoi21  g106(.a(new_n164_), .b(new_n69_), .c(new_n79_), .O(new_n169_));
  ...
  nand2  g112(.a(new_n174_), .b(new_n65_), .O(z16));
  ...
  oai21  g119(.a(new_n84_), .b(x27), .c(new_n181_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand3  g121(.a(new_n137_), .b(x27), .c(new_n72_), .O(new_n184_));
  nor2   g122(.a(new_n79_), .b(x30), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n180_), .O(z18));
  nand2  g124(.a(new_n140_), .b(new_n137_), .O(new_n187_));
  nand2  g125(.a(new_n181_), .b(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n184_), .b(new_n90_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n80_), .c(new_n180_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n65_), .O(z19));
  inv1   g130(.a(new_n181_), .O(new_n193_));
  oai21  g131(.a(new_n136_), .b(new_n99_), .c(new_n90_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n99_), .c(new_n136_), .O(new_n195_));
