...
module FAU ( 
  ...
  nor2   g017(.a(x10), .b(x05), .O(new_n80_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n80_), .O(z04));
  ...
  nand3  g057(.a(new_n81_), .b(x37), .c(x06), .O(new_n120_));
  inv1   g058(.a(x05), .O(new_n121_));
  aoi21  g059(.a(x40), .b(x39), .c(x07), .O(new_n122_));
  nand3  g060(.a(new_n75_), .b(x10), .c(x07), .O(new_n123_));
  ...
  nand3  g083(.a(new_n145_), .b(x27), .c(x05), .O(new_n146_));
  ...
  nand3  g096(.a(new_n130_), .b(new_n149_), .c(new_n65_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n158_), .c(new_n80_), .O(z13));
  ...
  aoi22  g105(.a(new_n167_), .b(new_n83_), .c(new_n164_), .d(new_n143_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n165_), .c(new_n80_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  nand4  g108(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(new_n170_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x22), .c(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n81_), .O(z16));
  ...
  nor2   g120(.a(new_n182_), .b(new_n80_), .O(z18));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n184_));
  nand2  g122(.a(new_n134_), .b(new_n66_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(new_n80_), .O(new_n186_));
  ...
  oai21  g128(.a(new_n190_), .b(new_n186_), .c(new_n83_), .O(new_n191_));
