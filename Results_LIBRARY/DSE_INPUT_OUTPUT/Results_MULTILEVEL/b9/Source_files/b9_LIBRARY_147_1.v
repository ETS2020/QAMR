...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(x34), .d(new_n66_), .O(new_n78_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x34), .O(new_n93_));
  ...
  nand3  g040(.a(new_n102_), .b(new_n64_), .c(new_n68_), .O(z05));
  ...
  aoi21  g054(.a(new_n116_), .b(x34), .c(new_n75_), .O(z08));
  ...
  nand4  g059(.a(x40), .b(x39), .c(x34), .d(x05), .O(new_n122_));
  oai21  g060(.a(z08), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n85_), .c(new_n120_), .O(new_n124_));
  ...
  nor2   g067(.a(new_n129_), .b(new_n116_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(x34), .c(x05), .d(new_n120_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n127_), .O(z10));
  nand2  g070(.a(new_n64_), .b(new_n97_), .O(new_n133_));
  oai21  g071(.a(new_n84_), .b(x04), .c(x34), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n133_), .c(x08), .O(new_n135_));
  inv1   g073(.a(new_n84_), .O(new_n136_));
  nand2  g074(.a(x39), .b(x29), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x34), .c(new_n75_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n136_), .c(new_n138_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n135_), .c(new_n80_), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(x09), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n97_), .c(new_n74_), .O(new_n144_));
  nand2  g082(.a(x40), .b(x39), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(x04), .c(new_n71_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n64_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n75_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n120_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n70_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n97_), .O(new_n155_));
  nand4  g093(.a(new_n128_), .b(x39), .c(new_n148_), .d(new_n120_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x34), .c(new_n75_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand3  g096(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n159_));
  nand4  g097(.a(new_n149_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n160_));
  nand3  g098(.a(x39), .b(new_n148_), .c(new_n120_), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n160_), .c(new_n63_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n75_), .c(new_n159_), .O(new_n164_));
  inv1   g102(.a(x35), .O(new_n165_));
  nand3  g103(.a(new_n68_), .b(new_n165_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n81_), .c(new_n80_), .O(new_n168_));
  oai21  g106(.a(new_n162_), .b(new_n72_), .c(new_n168_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x34), .O(new_n170_));
  nand2  g108(.a(new_n71_), .b(new_n75_), .O(new_n171_));
  ...
  inv1   g119(.a(x29), .O(new_n182_));
  oai22  g120(.a(new_n145_), .b(new_n182_), .c(new_n84_), .d(x27), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n97_), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n136_), .c(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n184_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g125(.a(x28), .b(new_n97_), .c(new_n165_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(new_n138_), .O(new_n189_));
  nand2  g127(.a(new_n165_), .b(x34), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n133_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n80_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z20));
  nor2   g131(.a(new_n141_), .b(x09), .O(z19));
endmodule
