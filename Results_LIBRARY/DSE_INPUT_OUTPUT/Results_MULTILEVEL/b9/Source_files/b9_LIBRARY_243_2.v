...
module FAU ( 
  ...
  nor2   g059(.a(x40), .b(x31), .O(new_n122_));
  ...
  nand4  g128(.a(new_n190_), .b(new_n189_), .c(new_n142_), .d(new_n136_), .O(z18));
  nand2  g129(.a(new_n64_), .b(new_n68_), .O(new_n192_));
  oai21  g130(.a(new_n83_), .b(x04), .c(x40), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(x08), .O(new_n194_));
  inv1   g132(.a(new_n122_), .O(new_n195_));
  oai21  g133(.a(new_n94_), .b(new_n90_), .c(x40), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(new_n195_), .c(new_n139_), .d(new_n138_), .O(new_n197_));
  ...
  oai21  g138(.a(new_n147_), .b(new_n68_), .c(new_n89_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n68_), .c(new_n147_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n79_), .c(new_n136_), .O(new_n204_));
