...
module FAU ( 
  ...
  nand3  g028(.a(new_n90_), .b(x35), .c(new_n81_), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(x04), .c(new_n87_), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n63_), .c(x39), .O(z02));
  nand2  g031(.a(new_n66_), .b(x27), .O(new_n94_));
  inv1   g032(.a(new_n64_), .O(new_n95_));
  aoi21  g033(.a(new_n65_), .b(new_n89_), .c(new_n95_), .O(new_n96_));
  ...
  nor2   g069(.a(new_n89_), .b(new_n71_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n82_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(x39), .b(x04), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(x35), .c(new_n81_), .d(x27), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n88_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n78_), .c(new_n130_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n64_), .O(z11));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n89_), .c(new_n73_), .O(new_n141_));
  oai21  g079(.a(new_n115_), .b(x04), .c(new_n68_), .O(new_n142_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n89_), .O(new_n151_));
  nand3  g089(.a(new_n124_), .b(new_n144_), .c(new_n71_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x40), .c(new_n115_), .O(new_n153_));
  or2    g091(.a(new_n153_), .b(new_n151_), .O(z13));
  nand3  g092(.a(x39), .b(new_n144_), .c(new_n71_), .O(new_n155_));
  nor2   g093(.a(x19), .b(x18), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n67_), .c(x27), .d(x20), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  inv1   g096(.a(x35), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n160_));
  aoi22  g098(.a(new_n160_), .b(new_n145_), .c(new_n65_), .d(new_n159_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n81_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n79_), .c(new_n78_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n158_), .c(new_n64_), .O(z14));
  ...
  nand2  g106(.a(new_n168_), .b(new_n64_), .O(z16));
  inv1   g107(.a(x24), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x23), .c(x22), .d(x01), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n64_), .O(z17));
  nand2  g110(.a(x27), .b(new_n71_), .O(new_n173_));
  nand2  g111(.a(new_n89_), .b(x08), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(new_n159_), .O(new_n175_));
  nand2  g113(.a(new_n78_), .b(new_n130_), .O(new_n176_));
  aoi21  g114(.a(new_n175_), .b(new_n81_), .c(new_n176_), .O(new_n177_));
  nand3  g115(.a(z08), .b(x29), .c(x08), .O(new_n178_));
  oai21  g116(.a(new_n177_), .b(new_n95_), .c(new_n178_), .O(z18));
  oai21  g117(.a(new_n132_), .b(x28), .c(new_n131_), .O(new_n180_));
  aoi21  g118(.a(new_n63_), .b(x39), .c(x27), .O(new_n181_));
  nand2  g119(.a(x40), .b(new_n159_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n134_), .c(new_n81_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n88_), .O(new_n184_));
  oai21  g122(.a(new_n63_), .b(x29), .c(x39), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n159_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n184_), .c(new_n180_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n78_), .c(new_n130_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n64_), .O(z19));
  oai21  g127(.a(new_n81_), .b(x27), .c(x35), .O(new_n190_));
  and2   g128(.a(new_n190_), .b(new_n185_), .O(new_n191_));
  nand2  g129(.a(new_n64_), .b(new_n89_), .O(new_n192_));
  aoi21  g130(.a(new_n182_), .b(new_n192_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n78_), .O(new_n194_));
