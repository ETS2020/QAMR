...
module FAU ( 
  ...
  nor2   g008(.a(new_n67_), .b(x39), .O(new_n71_));
  ...
  nand4  g033(.a(new_n95_), .b(new_n92_), .c(new_n90_), .d(x21), .O(z03));
  ...
  nand3  g037(.a(new_n99_), .b(new_n90_), .c(new_n94_), .O(z05));
  ...
  nand3  g049(.a(new_n111_), .b(new_n90_), .c(x03), .O(new_n112_));
  inv1   g050(.a(new_n112_), .O(z07));
  nand4  g051(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n90_), .O(z09));
  ...
  nand3  g058(.a(new_n90_), .b(x37), .c(x06), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x27), .O(new_n123_));
  aoi21  g061(.a(new_n75_), .b(new_n74_), .c(new_n67_), .O(new_n124_));
  ...
  nor2   g066(.a(new_n93_), .b(new_n116_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n78_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(x40), .b(x04), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(x35), .c(new_n77_), .d(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n84_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n74_), .c(new_n127_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n90_), .O(z11));
  nor3   g074(.a(x37), .b(x36), .c(x35), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n93_), .c(new_n66_), .O(new_n138_));
  oai22  g076(.a(new_n64_), .b(new_n93_), .c(new_n67_), .d(x04), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n90_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  nand2  g079(.a(x36), .b(x35), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x28), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(x40), .c(new_n141_), .d(new_n116_), .O(new_n144_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n144_), .c(new_n93_), .O(new_n149_));
  nand2  g087(.a(new_n75_), .b(new_n74_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n141_), .c(new_n116_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x39), .c(new_n67_), .O(new_n152_));
  or2    g090(.a(new_n152_), .b(new_n149_), .O(z13));
  inv1   g091(.a(x39), .O(new_n154_));
  aoi21  g092(.a(new_n141_), .b(new_n116_), .c(new_n154_), .O(new_n155_));
  nand4  g093(.a(x27), .b(x20), .c(new_n146_), .d(new_n145_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n64_), .c(new_n155_), .d(new_n67_), .O(new_n157_));
  ...
  oai21  g098(.a(new_n160_), .b(new_n77_), .c(x27), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n75_), .d(new_n74_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n157_), .O(z14));
  nand4  g101(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n90_), .O(z15));
  inv1   g103(.a(x23), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(x22), .c(x01), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n90_), .O(z16));
  inv1   g106(.a(x24), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(x23), .c(x22), .d(x01), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n90_), .O(z17));
  oai21  g109(.a(new_n78_), .b(x27), .c(new_n128_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(x35), .b(new_n77_), .c(x27), .d(new_n116_), .O(new_n174_));
  nor2   g112(.a(new_n71_), .b(x30), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n174_), .c(new_n173_), .d(new_n127_), .O(z18));
  nand2  g114(.a(new_n174_), .b(new_n84_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n130_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n74_), .c(new_n127_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n90_), .O(z19));
  inv1   g118(.a(new_n128_), .O(new_n181_));
  inv1   g119(.a(x35), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n93_), .c(new_n84_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n93_), .c(new_n182_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n181_), .c(new_n183_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n74_), .c(new_n127_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n90_), .O(z20));
  buf    g125(.a(x40), .O(z08));
endmodule
