...
module FAU ( 
  ...
  nand3  g030(.a(new_n92_), .b(x35), .c(new_n83_), .O(new_n93_));
  ...
  nor2   g040(.a(new_n83_), .b(new_n66_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n64_), .c(new_n98_), .O(z05));
  ...
  oai22  g074(.a(new_n136_), .b(new_n84_), .c(new_n74_), .d(new_n135_), .O(new_n137_));
  ...
  nand2  g093(.a(new_n96_), .b(new_n98_), .O(new_n156_));
  ...
  nand3  g099(.a(new_n131_), .b(new_n150_), .c(new_n72_), .O(new_n162_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n83_), .c(x27), .O(new_n170_));
  ...
  nand2  g122(.a(new_n80_), .b(new_n134_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n83_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n79_), .c(new_n118_), .d(new_n90_), .O(z18));
  oai21  g125(.a(new_n182_), .b(new_n84_), .c(new_n91_), .O(new_n188_));
  ...
  nor2   g129(.a(new_n74_), .b(new_n135_), .O(new_n192_));
  oai21  g130(.a(new_n144_), .b(new_n66_), .c(new_n91_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n66_), .c(new_n144_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n80_), .c(new_n134_), .O(new_n196_));
