...
module FAU ( 
  ...
  nand4  g067(.a(new_n129_), .b(x40), .c(x39), .d(x06), .O(new_n130_));
  ...
  nand2  g075(.a(new_n81_), .b(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n136_), .c(x06), .O(new_n139_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(x06), .O(new_n153_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n159_), .c(new_n78_), .O(new_n164_));
  ...
  nand4  g107(.a(new_n169_), .b(new_n156_), .c(x06), .d(new_n65_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n167_), .O(z13));
  nand3  g109(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n172_));
  nand4  g110(.a(new_n157_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n173_));
  ...
  nand2  g119(.a(new_n181_), .b(x06), .O(new_n182_));
  ...
  nand4  g128(.a(new_n79_), .b(new_n190_), .c(x23), .d(x22), .O(new_n191_));
  ...
  nand2  g134(.a(x08), .b(x06), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n141_), .c(new_n196_), .d(new_n97_), .O(z18));
  oai21  g136(.a(new_n66_), .b(new_n64_), .c(x06), .O(new_n199_));
  nand2  g137(.a(x40), .b(x04), .O(new_n200_));
  nand2  g138(.a(new_n73_), .b(new_n64_), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n200_), .c(new_n199_), .d(new_n94_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n135_), .O(new_n203_));
  nand2  g141(.a(x39), .b(x29), .O(new_n204_));
  nand2  g142(.a(new_n66_), .b(x06), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n142_), .c(new_n94_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n204_), .O(new_n207_));
  nand2  g145(.a(new_n143_), .b(new_n73_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n207_), .c(new_n203_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n81_), .c(new_n137_), .O(new_n210_));
  nand2  g148(.a(new_n210_), .b(new_n79_), .O(z19));
  aoi21  g149(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n212_));
  aoi21  g150(.a(new_n204_), .b(x06), .c(new_n73_), .O(new_n213_));
  nor2   g151(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  aoi21  g152(.a(new_n201_), .b(new_n199_), .c(x08), .O(new_n215_));
  oai21  g153(.a(new_n215_), .b(new_n214_), .c(new_n81_), .O(new_n216_));
