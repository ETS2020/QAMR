...
module FAU ( 
  ...
  nand2  g051(.a(new_n113_), .b(new_n83_), .O(z07));
  ...
  oai22  g072(.a(new_n91_), .b(x04), .c(new_n67_), .d(new_n66_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n83_), .O(z12));
  nand2  g074(.a(new_n92_), .b(x30), .O(new_n137_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n124_), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n137_), .c(new_n140_), .d(x18), .O(z13));
  oai21  g081(.a(new_n91_), .b(x13), .c(x30), .O(new_n144_));
  nand2  g082(.a(x27), .b(x20), .O(new_n145_));
  nor4   g083(.a(new_n145_), .b(new_n67_), .c(x19), .d(x18), .O(new_n146_));
  aoi21  g084(.a(new_n144_), .b(new_n124_), .c(new_n146_), .O(z14));
  inv1   g085(.a(x12), .O(new_n148_));
  nor2   g086(.a(new_n118_), .b(new_n148_), .O(z15));
  inv1   g087(.a(x23), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(x22), .c(x01), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n83_), .O(z16));
  inv1   g090(.a(x01), .O(new_n153_));
  inv1   g091(.a(x24), .O(new_n154_));
  nand4  g092(.a(new_n83_), .b(new_n154_), .c(x23), .d(x22), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(new_n153_), .O(z17));
  nand4  g094(.a(new_n130_), .b(new_n76_), .c(new_n127_), .d(x04), .O(z18));
  nand3  g095(.a(x35), .b(new_n87_), .c(new_n66_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n128_), .O(new_n159_));
  ...
  inv1   g100(.a(new_n128_), .O(new_n163_));
  aoi21  g101(.a(x28), .b(new_n66_), .c(new_n77_), .O(new_n164_));
  nor2   g102(.a(new_n77_), .b(new_n66_), .O(new_n165_));
  oai22  g103(.a(new_n165_), .b(x08), .c(new_n164_), .d(new_n163_), .O(new_n166_));
