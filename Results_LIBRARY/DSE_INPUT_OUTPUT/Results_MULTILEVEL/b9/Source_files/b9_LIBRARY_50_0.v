...
module FAU ( 
  ...
  nor2   g018(.a(x10), .b(x06), .O(new_n81_));
  ...
  nand2  g058(.a(new_n100_), .b(new_n75_), .O(z08));
  inv1   g059(.a(x11), .O(new_n122_));
  nand4  g060(.a(new_n100_), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  ...
  nand3  g069(.a(new_n131_), .b(new_n100_), .c(new_n65_), .O(new_n132_));
  ...
  nand4  g080(.a(new_n142_), .b(new_n100_), .c(new_n84_), .d(new_n135_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z11));
  oai21  g082(.a(new_n75_), .b(x04), .c(new_n71_), .O(new_n145_));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n65_), .c(new_n81_), .O(new_n167_));
  ...
  nand3  g109(.a(new_n76_), .b(new_n155_), .c(new_n65_), .O(new_n172_));
  ...
  aoi22  g113(.a(new_n175_), .b(new_n84_), .c(new_n172_), .d(new_n152_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n173_), .c(new_n81_), .O(z14));
  ...
  oai21  g123(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n186_));
  nand3  g124(.a(new_n140_), .b(new_n84_), .c(new_n135_), .O(new_n187_));
  aoi21  g125(.a(new_n186_), .b(x08), .c(new_n187_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(new_n81_), .O(z18));
  nand3  g127(.a(new_n142_), .b(new_n84_), .c(new_n135_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n100_), .O(z19));
  inv1   g129(.a(new_n136_), .O(new_n192_));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n95_), .O(new_n193_));
  ...
  nand2  g134(.a(new_n196_), .b(new_n100_), .O(z20));
endmodule
