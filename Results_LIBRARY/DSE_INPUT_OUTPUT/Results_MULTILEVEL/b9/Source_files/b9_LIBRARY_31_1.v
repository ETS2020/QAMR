...
module FAU ( 
  ...
  nand3  g041(.a(new_n103_), .b(new_n64_), .c(new_n97_), .O(z05));
  ...
  nand3  g080(.a(new_n97_), .b(new_n82_), .c(new_n90_), .O(new_n143_));
  ...
  nand2  g091(.a(new_n95_), .b(new_n97_), .O(new_n154_));
  ...
  nand3  g094(.a(new_n123_), .b(new_n148_), .c(new_n72_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x39), .c(new_n74_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n156_), .O(z13));
  nand3  g097(.a(x40), .b(new_n148_), .c(new_n72_), .O(new_n160_));
  nand4  g098(.a(x27), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n67_), .c(new_n160_), .O(new_n162_));
  ...
  oai21  g103(.a(new_n165_), .b(new_n83_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n81_), .c(new_n80_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n162_), .c(new_n64_), .O(z14));
  ...
  oai21  g115(.a(new_n84_), .b(x27), .c(new_n132_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nor2   g117(.a(new_n66_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n91_), .c(x09), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n179_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g120(.a(x39), .b(new_n130_), .c(new_n74_), .O(new_n183_));
  aoi21  g121(.a(new_n133_), .b(new_n91_), .c(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n64_), .b(new_n66_), .O(new_n185_));
  nand3  g123(.a(new_n137_), .b(x35), .c(new_n83_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x39), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n185_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n184_), .c(new_n80_), .O(new_n189_));
  ...
  oai21  g130(.a(new_n192_), .b(new_n131_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n80_), .c(new_n129_), .O(new_n194_));
