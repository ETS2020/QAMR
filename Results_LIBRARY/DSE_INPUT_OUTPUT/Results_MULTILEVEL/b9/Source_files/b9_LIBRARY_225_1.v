...
module FAU ( 
  ...
  nor2   g036(.a(new_n82_), .b(new_n68_), .O(new_n99_));
  ...
  oai21  g081(.a(new_n71_), .b(new_n63_), .c(new_n143_), .O(z12));
  inv1   g082(.a(x19), .O(new_n145_));
  nand2  g083(.a(new_n70_), .b(new_n69_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(new_n64_), .c(x20), .d(new_n145_), .O(new_n147_));
  ...
  oai21  g114(.a(new_n83_), .b(x27), .c(new_n129_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n135_), .c(new_n73_), .d(new_n128_), .O(z18));
  nand2  g117(.a(new_n138_), .b(new_n64_), .O(z19));
  inv1   g118(.a(new_n129_), .O(new_n181_));
  oai21  g119(.a(new_n133_), .b(new_n68_), .c(new_n132_), .O(new_n182_));
  aoi21  g120(.a(x28), .b(new_n68_), .c(new_n133_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n182_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n73_), .c(new_n128_), .O(new_n185_));
