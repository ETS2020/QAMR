...
module FAU ( 
  ...
  aoi21  g032(.a(new_n65_), .b(new_n94_), .c(new_n78_), .O(new_n95_));
  ...
  nand2  g051(.a(new_n113_), .b(new_n64_), .O(z09));
  ...
  nand3  g056(.a(new_n118_), .b(new_n83_), .c(new_n71_), .O(new_n119_));
  nand3  g057(.a(new_n64_), .b(x37), .c(x06), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(x27), .O(new_n122_));
  aoi21  g060(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n123_));
  nand4  g061(.a(new_n123_), .b(x39), .c(x05), .d(new_n71_), .O(new_n124_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n89_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n64_), .b(new_n94_), .O(new_n131_));
  inv1   g069(.a(x28), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n132_), .c(new_n71_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x40), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n131_), .c(x08), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n130_), .c(new_n79_), .O(new_n136_));
  nor2   g074(.a(new_n136_), .b(x09), .O(z11));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n94_), .c(new_n73_), .O(new_n139_));
  oai21  g077(.a(new_n127_), .b(x04), .c(new_n68_), .O(new_n140_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n145_), .c(new_n94_), .O(new_n149_));
  nand2  g087(.a(new_n80_), .b(new_n79_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n142_), .c(new_n71_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x40), .c(new_n127_), .O(new_n152_));
  or2    g090(.a(new_n152_), .b(new_n149_), .O(z13));
  nand3  g091(.a(x39), .b(new_n142_), .c(new_n71_), .O(new_n154_));
  nor2   g092(.a(x19), .b(x18), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n67_), .c(x27), .d(x20), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g095(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n158_));
  nor2   g096(.a(x37), .b(x35), .O(new_n159_));
  aoi21  g097(.a(new_n158_), .b(new_n143_), .c(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n132_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n80_), .c(new_n79_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n157_), .c(new_n64_), .O(z14));
  nand4  g101(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n64_), .O(z15));
  inv1   g103(.a(x23), .O(new_n166_));
  nand4  g104(.a(new_n64_), .b(new_n166_), .c(x22), .d(x01), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z16));
  inv1   g106(.a(x01), .O(new_n169_));
  inv1   g107(.a(x24), .O(new_n170_));
  nand4  g108(.a(new_n64_), .b(new_n170_), .c(x23), .d(x22), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(new_n169_), .O(z17));
  nand2  g110(.a(x27), .b(new_n71_), .O(new_n173_));
  nand2  g111(.a(new_n94_), .b(x08), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(new_n81_), .O(new_n175_));
  inv1   g113(.a(x09), .O(new_n176_));
  nand2  g114(.a(new_n79_), .b(new_n176_), .O(new_n177_));
  aoi21  g115(.a(new_n175_), .b(new_n132_), .c(new_n177_), .O(new_n178_));
  oai22  g116(.a(new_n178_), .b(new_n78_), .c(new_n117_), .d(new_n88_), .O(z18));
  nand2  g117(.a(x39), .b(x04), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x35), .c(new_n132_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n131_), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n130_), .c(new_n79_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(x09), .O(z19));
  nor2   g123(.a(new_n81_), .b(new_n94_), .O(new_n186_));
  nor2   g124(.a(new_n127_), .b(new_n126_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n94_), .c(new_n81_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(x08), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n79_), .c(new_n176_), .O(new_n190_));
