...
module FAU ( 
  ...
  aoi21  g058(.a(new_n76_), .b(new_n75_), .c(new_n67_), .O(new_n121_));
  ...
  aoi21  g067(.a(x39), .b(new_n129_), .c(new_n67_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n121_), .b(x39), .c(new_n143_), .d(new_n116_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand3  g094(.a(x40), .b(new_n143_), .c(new_n116_), .O(new_n157_));
  ...
  nand3  g101(.a(new_n163_), .b(new_n76_), .c(new_n75_), .O(new_n164_));
  ...
  nand2  g111(.a(x40), .b(x39), .O(new_n174_));
  nand2  g112(.a(x27), .b(new_n116_), .O(new_n175_));
  nand2  g113(.a(new_n92_), .b(x08), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n175_), .c(new_n127_), .O(new_n177_));
  inv1   g115(.a(x09), .O(new_n178_));
  nand2  g116(.a(new_n75_), .b(new_n178_), .O(new_n179_));
  aoi21  g117(.a(new_n177_), .b(new_n78_), .c(new_n179_), .O(new_n180_));
  oai22  g118(.a(new_n180_), .b(new_n74_), .c(new_n174_), .d(new_n85_), .O(z18));
  nand2  g119(.a(new_n131_), .b(new_n128_), .O(new_n182_));
  nor2   g120(.a(new_n67_), .b(new_n129_), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  inv1   g123(.a(x08), .O(new_n186_));
  oai21  g124(.a(new_n175_), .b(new_n79_), .c(new_n186_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n185_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n75_), .c(new_n178_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n71_), .O(z19));
  oai21  g128(.a(new_n127_), .b(new_n92_), .c(new_n186_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n92_), .c(new_n127_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n183_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n75_), .c(new_n178_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n71_), .O(z20));
