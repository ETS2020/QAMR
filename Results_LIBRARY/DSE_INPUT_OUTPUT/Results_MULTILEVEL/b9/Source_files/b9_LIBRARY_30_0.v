...
module FAU ( 
  ...
  nand2  g051(.a(new_n113_), .b(new_n63_), .O(new_n114_));
  ...
  oai21  g055(.a(new_n64_), .b(new_n95_), .c(new_n65_), .O(z08));
  ...
  nand2  g061(.a(new_n64_), .b(x14), .O(new_n124_));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n141_), .c(new_n142_), .d(new_n124_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n140_), .c(new_n80_), .O(new_n145_));
  ...
  nand2  g090(.a(new_n152_), .b(x14), .O(new_n153_));
  ...
  nand2  g127(.a(new_n96_), .b(x29), .O(new_n190_));
  oai21  g128(.a(new_n84_), .b(x27), .c(new_n190_), .O(new_n191_));
  ...
  oai21  g134(.a(new_n147_), .b(new_n69_), .c(new_n90_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n69_), .c(new_n147_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n80_), .O(new_n200_));
