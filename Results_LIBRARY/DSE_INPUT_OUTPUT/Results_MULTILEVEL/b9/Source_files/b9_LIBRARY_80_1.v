...
module FAU ( 
  ...
  aoi21  g070(.a(new_n132_), .b(new_n90_), .c(new_n131_), .O(new_n133_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n97_), .O(new_n151_));
  ...
  aoi21  g098(.a(new_n159_), .b(new_n145_), .c(new_n160_), .O(new_n161_));
  ...
  oai22  g110(.a(new_n83_), .b(x27), .c(new_n74_), .d(new_n130_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nor2   g112(.a(new_n97_), .b(x04), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n90_), .c(x09), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n174_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g115(.a(x28), .b(new_n97_), .c(new_n89_), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n131_), .O(new_n179_));
  nand2  g117(.a(x39), .b(new_n89_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n134_), .c(x08), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n179_), .c(new_n79_), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(x09), .O(z20));
  nor2   g121(.a(new_n138_), .b(x09), .O(z19));
endmodule
