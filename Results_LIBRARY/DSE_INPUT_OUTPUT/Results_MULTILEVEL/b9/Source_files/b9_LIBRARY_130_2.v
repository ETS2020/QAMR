...
module FAU ( 
  ...
  nand2  g070(.a(new_n64_), .b(new_n98_), .O(new_n133_));
  ...
  nor2   g075(.a(x40), .b(x24), .O(new_n138_));
  aoi21  g076(.a(new_n137_), .b(x40), .c(new_n138_), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n136_), .c(new_n139_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n98_), .c(new_n75_), .O(new_n145_));
  oai21  g083(.a(new_n94_), .b(x04), .c(new_n71_), .O(new_n146_));
  ...
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n74_), .O(new_n151_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n74_), .c(new_n65_), .O(new_n158_));
  ...
  nand3  g099(.a(x39), .b(new_n148_), .c(new_n74_), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n161_), .c(new_n63_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n138_), .c(new_n160_), .O(new_n165_));
  ...
  oai21  g107(.a(new_n163_), .b(new_n72_), .c(new_n169_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x40), .O(new_n171_));
  inv1   g109(.a(x24), .O(new_n172_));
  nand3  g110(.a(new_n71_), .b(new_n63_), .c(new_n172_), .O(new_n173_));
  ...
  nand4  g117(.a(new_n172_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  ...
  oai21  g127(.a(new_n189_), .b(new_n92_), .c(new_n172_), .O(new_n190_));
  ...
  nand2  g133(.a(new_n137_), .b(new_n166_), .O(new_n196_));
  ...
  nand2  g139(.a(new_n201_), .b(new_n64_), .O(z19));
  aoi21  g140(.a(x28), .b(new_n98_), .c(new_n166_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(new_n139_), .O(new_n204_));
  nand2  g142(.a(x40), .b(new_n166_), .O(new_n205_));
