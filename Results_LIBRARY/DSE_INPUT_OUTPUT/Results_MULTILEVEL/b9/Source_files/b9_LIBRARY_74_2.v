...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x06), .O(new_n81_));
  ...
  inv1   g035(.a(x06), .O(new_n98_));
  nand2  g036(.a(new_n76_), .b(new_n98_), .O(new_n99_));
  ...
  nor2   g045(.a(new_n92_), .b(new_n64_), .O(new_n108_));
  inv1   g046(.a(new_n108_), .O(new_n109_));
  nand3  g047(.a(new_n109_), .b(new_n81_), .c(new_n70_), .O(z05));
  oai21  g048(.a(new_n108_), .b(x37), .c(new_n81_), .O(z06));
  ...
  nand2  g061(.a(new_n81_), .b(new_n123_), .O(z08));
  ...
  aoi21  g065(.a(x40), .b(x39), .c(x06), .O(new_n128_));
  nor2   g066(.a(new_n76_), .b(x39), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n128_), .c(x07), .O(new_n130_));
  nand2  g068(.a(new_n77_), .b(x05), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n127_), .O(new_n132_));
  oai21  g070(.a(x32), .b(x30), .c(x40), .O(new_n133_));
  nor2   g071(.a(new_n133_), .b(new_n75_), .O(new_n134_));
  and2   g072(.a(new_n134_), .b(x05), .O(new_n135_));
  aoi21  g073(.a(new_n132_), .b(x27), .c(new_n135_), .O(new_n136_));
  nand4  g074(.a(x40), .b(x37), .c(x27), .d(x06), .O(new_n137_));
  oai21  g075(.a(new_n136_), .b(x04), .c(new_n137_), .O(z10));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n85_), .c(new_n143_), .d(new_n99_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n141_), .c(new_n83_), .O(new_n146_));
  ...
  oai21  g089(.a(new_n123_), .b(x04), .c(new_n151_), .O(new_n152_));
  ...
  nor2   g099(.a(new_n160_), .b(x06), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n161_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n134_), .b(new_n154_), .c(new_n65_), .O(new_n164_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n151_), .c(new_n101_), .O(new_n174_));
  ...
  nand2  g125(.a(new_n83_), .b(new_n187_), .O(new_n188_));
  aoi21  g126(.a(new_n186_), .b(new_n92_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n101_), .c(new_n90_), .d(new_n123_), .O(z18));
  nand2  g128(.a(new_n144_), .b(new_n85_), .O(new_n191_));
  nand2  g129(.a(new_n77_), .b(x29), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  inv1   g131(.a(x08), .O(new_n194_));
  oai21  g132(.a(new_n184_), .b(new_n93_), .c(new_n194_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n83_), .c(new_n187_), .O(new_n197_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n83_), .c(new_n187_), .O(new_n203_));
