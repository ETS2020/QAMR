// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:37 2020
...
module FAU ( 
  ...
  nand2  g017(.a(x30), .b(x19), .O(new_n80_));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n88_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n70_), .c(new_n88_), .O(z05));
  ...
  nand3  g060(.a(new_n76_), .b(new_n82_), .c(x05), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nor2   g062(.a(new_n88_), .b(new_n70_), .O(new_n125_));
  aoi22  g063(.a(new_n125_), .b(x06), .c(new_n124_), .d(new_n65_), .O(new_n126_));
  inv1   g064(.a(x40), .O(new_n127_));
  inv1   g065(.a(x19), .O(new_n128_));
  nand2  g066(.a(x30), .b(new_n128_), .O(new_n129_));
  nand2  g067(.a(x32), .b(new_n82_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n127_), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(x39), .c(x05), .d(new_n65_), .O(new_n132_));
  oai21  g070(.a(new_n126_), .b(new_n64_), .c(new_n132_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand2  g072(.a(new_n76_), .b(x29), .O(new_n135_));
  oai21  g073(.a(new_n64_), .b(new_n65_), .c(new_n84_), .O(new_n136_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n82_), .c(new_n134_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n80_), .O(z12));
  ...
  nand4  g091(.a(new_n72_), .b(x20), .c(new_n128_), .d(new_n153_), .O(new_n154_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n65_), .c(new_n88_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n156_), .O(z13));
  nand3  g099(.a(x20), .b(new_n128_), .c(new_n153_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(new_n150_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n120_), .c(x27), .O(new_n165_));
  nor2   g103(.a(x13), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n76_), .c(new_n128_), .O(new_n167_));
  aoi21  g105(.a(new_n165_), .b(new_n83_), .c(new_n167_), .O(new_n168_));
  nand2  g106(.a(new_n166_), .b(new_n76_), .O(new_n169_));
  nand4  g107(.a(new_n72_), .b(x27), .c(x20), .d(new_n153_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n128_), .O(new_n171_));
  oai21  g109(.a(new_n168_), .b(x30), .c(new_n171_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nor2   g111(.a(new_n118_), .b(new_n173_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand4  g113(.a(new_n80_), .b(new_n175_), .c(x22), .d(x01), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n80_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  nand2  g119(.a(new_n84_), .b(new_n64_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n135_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n139_), .c(new_n82_), .d(new_n134_), .O(z18));
  nand2  g123(.a(new_n142_), .b(new_n80_), .O(z19));
  inv1   g124(.a(new_n135_), .O(new_n187_));
  oai21  g125(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n82_), .c(new_n134_), .O(new_n191_));
