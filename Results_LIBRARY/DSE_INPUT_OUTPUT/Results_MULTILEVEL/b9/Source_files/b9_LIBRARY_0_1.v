...
module FAU ( 
  ...
  nand2  g067(.a(x30), .b(x18), .O(new_n130_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n89_), .O(z12));
  ...
  nand4  g093(.a(new_n72_), .b(x20), .c(new_n155_), .d(new_n80_), .O(new_n156_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n89_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n158_), .O(z13));
  nand3  g101(.a(x20), .b(new_n155_), .c(new_n80_), .O(new_n164_));
  ...
  nand3  g109(.a(new_n72_), .b(new_n83_), .c(x27), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n167_), .c(new_n89_), .O(new_n173_));
  ...
  nand2  g122(.a(new_n184_), .b(new_n136_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n141_), .c(new_n83_), .d(new_n135_), .O(z18));
  nand2  g125(.a(new_n144_), .b(new_n81_), .O(z19));
  ...
  nand3  g130(.a(new_n192_), .b(new_n83_), .c(new_n135_), .O(new_n193_));
