...
module FAU ( 
  ...
  nand2  g042(.a(new_n103_), .b(new_n73_), .O(new_n105_));
  ...
  nand3  g056(.a(new_n115_), .b(x18), .c(new_n113_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n118_), .c(new_n107_), .O(z07));
  inv1   g058(.a(x39), .O(new_n121_));
  nand2  g059(.a(new_n64_), .b(x40), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n121_), .O(z08));
  ...
  nand2  g074(.a(new_n79_), .b(x29), .O(new_n137_));
  oai21  g075(.a(new_n67_), .b(new_n68_), .c(new_n93_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  inv1   g077(.a(x08), .O(new_n140_));
  nand3  g078(.a(new_n93_), .b(x27), .c(new_n68_), .O(new_n141_));
  ...
  oai22  g086(.a(new_n78_), .b(x04), .c(new_n76_), .d(new_n67_), .O(new_n149_));
  ...
  nand4  g090(.a(new_n152_), .b(new_n64_), .c(x40), .d(x39), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x13), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n75_), .b(new_n108_), .c(x20), .d(new_n155_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  aoi21  g095(.a(new_n154_), .b(new_n68_), .c(new_n157_), .O(new_n158_));
  inv1   g096(.a(x13), .O(new_n159_));
  nand4  g097(.a(new_n130_), .b(new_n64_), .c(x40), .d(x39), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n68_), .O(new_n162_));
  oai21  g100(.a(new_n158_), .b(new_n67_), .c(new_n162_), .O(z13));
  aoi21  g101(.a(x20), .b(new_n155_), .c(x33), .O(new_n164_));
  nand4  g102(.a(new_n151_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n79_), .b(new_n159_), .c(new_n68_), .O(new_n167_));
  ...
  nand2  g111(.a(new_n173_), .b(new_n108_), .O(new_n174_));
  nand4  g112(.a(new_n85_), .b(new_n84_), .c(new_n67_), .d(x18), .O(new_n175_));
  ...
  nand2  g123(.a(new_n93_), .b(new_n67_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n137_), .O(new_n187_));
  nand3  g125(.a(new_n141_), .b(new_n84_), .c(new_n136_), .O(new_n188_));
  ...
  oai21  g129(.a(new_n69_), .b(new_n67_), .c(new_n140_), .O(new_n192_));
  ...
  nand2  g134(.a(new_n144_), .b(new_n64_), .O(z19));
endmodule
