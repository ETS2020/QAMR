...
module FAU ( 
  ...
  nor2   g023(.a(new_n85_), .b(x27), .O(new_n86_));
  oai21  g024(.a(new_n86_), .b(new_n65_), .c(new_n81_), .O(new_n87_));
  inv1   g025(.a(x28), .O(new_n88_));
  nand2  g026(.a(x35), .b(new_n88_), .O(new_n89_));
  nand4  g027(.a(new_n89_), .b(new_n66_), .c(new_n84_), .d(new_n83_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(new_n87_), .O(z01));
  ...
  nor2   g036(.a(x40), .b(x36), .O(new_n99_));
  ...
  nand3  g042(.a(new_n104_), .b(new_n102_), .c(x21), .O(z03));
  inv1   g043(.a(x21), .O(new_n106_));
  nand3  g044(.a(new_n104_), .b(new_n102_), .c(new_n106_), .O(z04));
  nand2  g045(.a(x28), .b(x27), .O(new_n108_));
  aoi21  g046(.a(new_n108_), .b(new_n70_), .c(new_n103_), .O(z05));
  ...
  nand2  g060(.a(new_n81_), .b(new_n75_), .O(z08));
  nand4  g061(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n81_), .O(z09));
  oai21  g063(.a(new_n67_), .b(x28), .c(new_n66_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(x39), .c(x05), .O(new_n127_));
  nand3  g065(.a(new_n75_), .b(x35), .c(new_n88_), .O(new_n128_));
  inv1   g066(.a(x39), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x36), .O(new_n130_));
  ...
  nand3  g072(.a(new_n85_), .b(x40), .c(x39), .O(new_n135_));
  ...
  oai21  g092(.a(new_n75_), .b(x04), .c(new_n154_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(new_n81_), .O(z12));
  inv1   g094(.a(x13), .O(new_n157_));
  nand2  g095(.a(x36), .b(x35), .O(new_n158_));
  oai21  g096(.a(new_n80_), .b(x28), .c(new_n158_), .O(new_n159_));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n65_), .c(new_n103_), .O(new_n167_));
  ...
  aoi21  g131(.a(new_n191_), .b(new_n88_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n103_), .c(new_n93_), .d(new_n75_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n174_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(new_n146_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n174_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n141_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n83_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z20));
  nor2   g139(.a(new_n149_), .b(x09), .O(z19));
endmodule
