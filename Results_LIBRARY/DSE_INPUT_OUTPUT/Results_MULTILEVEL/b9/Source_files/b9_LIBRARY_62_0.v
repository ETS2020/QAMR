...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(x03), .O(new_n94_));
  ...
  nand2  g057(.a(new_n116_), .b(x07), .O(new_n120_));
  ...
  nand2  g069(.a(new_n65_), .b(new_n69_), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n133_));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n94_), .c(new_n138_), .d(new_n137_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n135_), .c(new_n80_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(x09), .O(z11));
  nand3  g081(.a(new_n70_), .b(new_n82_), .c(new_n136_), .O(new_n144_));
  ...
  nand3  g097(.a(new_n126_), .b(new_n154_), .c(new_n74_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand2  g099(.a(x20), .b(new_n151_), .O(new_n162_));
  nand4  g100(.a(new_n155_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(z08), .b(new_n154_), .c(new_n74_), .O(new_n165_));
  oai22  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(x18), .O(new_n166_));
  nand3  g104(.a(new_n70_), .b(new_n136_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n81_), .c(new_n80_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n148_), .c(new_n66_), .O(new_n170_));
  ...
  nand4  g116(.a(new_n65_), .b(new_n178_), .c(x23), .d(x22), .O(new_n179_));
  ...
  nand3  g122(.a(new_n137_), .b(x27), .c(new_n74_), .O(new_n185_));
  nor2   g123(.a(new_n66_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n181_), .O(z18));
  nand2  g125(.a(new_n138_), .b(new_n137_), .O(new_n188_));
  nand2  g126(.a(new_n182_), .b(new_n188_), .O(new_n189_));
  inv1   g127(.a(x08), .O(new_n190_));
  nand2  g128(.a(new_n185_), .b(new_n190_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n181_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n65_), .O(z19));
  inv1   g132(.a(new_n182_), .O(new_n195_));
  oai21  g133(.a(new_n136_), .b(new_n69_), .c(new_n190_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n69_), .c(new_n136_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n80_), .c(new_n181_), .O(new_n199_));
