...
module FAU ( 
  ...
  aoi21  g21(.a(new_n81_), .b(new_n66_), .c(x21), .O(new_n84_));
  ...
  nor2   g56(.a(new_n64_), .b(new_n66_), .O(new_n120_));
  nand2  g57(.a(new_n120_), .b(new_n119_), .O(z12));
  inv1   g58(.a(x19), .O(new_n122_));
  nand3  g59(.a(new_n68_), .b(x20), .c(new_n122_), .O(new_n123_));
  oai21  g60(.a(new_n123_), .b(x18), .c(z02), .O(z13));
  nor2   g61(.a(x19), .b(x18), .O(new_n125_));
  nand4  g62(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(x20), .O(z14));
  nand4  g63(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(z02), .O(z15));
  ...
  nand4  g74(.a(new_n137_), .b(z02), .c(new_n71_), .d(new_n112_), .O(z18));
  oai21  g75(.a(x28), .b(new_n114_), .c(new_n66_), .O(new_n139_));
