...
module FAU ( 
  ...
  oai21  g035(.a(new_n97_), .b(new_n89_), .c(x04), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n85_), .d(new_n76_), .O(z02));
  nand2  g037(.a(new_n71_), .b(x27), .O(new_n100_));
  nand2  g038(.a(new_n70_), .b(new_n64_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n100_), .c(new_n85_), .d(x21), .O(z03));
  inv1   g040(.a(x21), .O(new_n103_));
  nand4  g041(.a(new_n101_), .b(new_n100_), .c(new_n85_), .d(new_n103_), .O(z04));
  nand2  g042(.a(x28), .b(x27), .O(new_n105_));
  aoi21  g043(.a(new_n105_), .b(new_n70_), .c(new_n82_), .O(z05));
  nand3  g044(.a(new_n105_), .b(new_n85_), .c(new_n70_), .O(new_n107_));
  ...
  nand2  g057(.a(new_n119_), .b(new_n85_), .O(z07));
  nand2  g058(.a(new_n85_), .b(new_n75_), .O(z08));
  nand4  g059(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n85_), .O(z09));
  ...
  nand3  g064(.a(new_n126_), .b(new_n90_), .c(x27), .O(new_n127_));
  nand2  g065(.a(new_n87_), .b(new_n86_), .O(new_n128_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(new_n85_), .O(z10));
  nand2  g071(.a(new_n76_), .b(x29), .O(new_n134_));
  nor2   g072(.a(new_n64_), .b(new_n65_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n89_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n88_), .c(x27), .d(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n86_), .c(new_n81_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(x27), .c(new_n81_), .O(new_n146_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n82_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  nand4  g101(.a(new_n151_), .b(new_n87_), .c(new_n86_), .d(x28), .O(new_n164_));
  ...
  nand3  g107(.a(new_n169_), .b(new_n87_), .c(new_n86_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n143_), .c(new_n82_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n85_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x22), .c(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n85_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n85_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  oai21  g119(.a(new_n89_), .b(x27), .c(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n138_), .c(new_n86_), .d(new_n81_), .O(z18));
  inv1   g122(.a(new_n134_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n86_), .c(new_n81_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n85_), .O(z20));
