...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n195_;
  nand2  g000(.a(x30), .b(x08), .O(new_n63_));
  ...
  nand3  g042(.a(new_n104_), .b(new_n63_), .c(new_n72_), .O(z05));
  ...
  nand2  g055(.a(new_n77_), .b(new_n63_), .O(z08));
  ...
  oai21  g060(.a(new_n122_), .b(new_n77_), .c(new_n121_), .O(new_n123_));
  ...
  nor2   g096(.a(new_n157_), .b(x08), .O(new_n159_));
  ...
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n150_), .d(new_n67_), .O(new_n164_));
  ...
  nand3  g106(.a(new_n78_), .b(new_n150_), .c(new_n67_), .O(new_n169_));
  ...
  nand2  g123(.a(new_n138_), .b(new_n66_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n135_), .c(new_n121_), .O(new_n187_));
  ...
  oai21  g129(.a(new_n68_), .b(new_n66_), .c(new_n121_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n193_));
  ...
  nand2  g134(.a(new_n142_), .b(new_n63_), .O(z19));
endmodule
