...
module FAU ( 
  ...
  oai21  g023(.a(new_n85_), .b(new_n64_), .c(new_n63_), .O(new_n86_));
  ...
  nor2   g031(.a(new_n64_), .b(new_n93_), .O(z08));
  nand3  g032(.a(z08), .b(new_n92_), .c(new_n90_), .O(z02));
  nand2  g033(.a(new_n70_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x27), .O(new_n97_));
  aoi21  g035(.a(new_n69_), .b(new_n97_), .c(new_n66_), .O(new_n98_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n69_), .c(new_n66_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n65_), .c(new_n69_), .O(new_n104_));
  ...
  nand2  g057(.a(x40), .b(new_n93_), .O(new_n120_));
  nand2  g058(.a(new_n64_), .b(x30), .O(new_n121_));
  ...
  oai21  g062(.a(new_n124_), .b(new_n122_), .c(new_n84_), .O(new_n125_));
  ...
  nor2   g067(.a(new_n129_), .b(new_n93_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n75_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(x39), .b(x29), .O(new_n134_));
  nor2   g072(.a(new_n97_), .b(new_n75_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n83_), .c(new_n134_), .O(new_n136_));
  nand4  g074(.a(x35), .b(new_n82_), .c(x27), .d(new_n75_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(x08), .c(new_n136_), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(x40), .c(new_n63_), .d(new_n133_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n97_), .c(new_n76_), .O(new_n143_));
  nand2  g081(.a(z08), .b(new_n75_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n72_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n143_), .c(new_n65_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n147_), .d(new_n75_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand4  g090(.a(new_n71_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(new_n64_), .O(new_n154_));
  nand4  g092(.a(new_n71_), .b(x30), .c(x20), .d(new_n152_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand3  g095(.a(new_n130_), .b(new_n147_), .c(new_n75_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  inv1   g097(.a(new_n121_), .O(new_n160_));
  nand3  g098(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n161_));
  inv1   g099(.a(x32), .O(new_n162_));
  nand4  g100(.a(new_n148_), .b(new_n162_), .c(new_n63_), .d(x28), .O(new_n163_));
  nand3  g101(.a(x39), .b(new_n147_), .c(new_n75_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n64_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n160_), .c(new_n161_), .O(new_n167_));
  inv1   g105(.a(x35), .O(new_n168_));
  nand3  g106(.a(new_n69_), .b(new_n168_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n162_), .c(new_n63_), .O(new_n171_));
  oai21  g109(.a(new_n165_), .b(new_n73_), .c(new_n171_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x40), .O(new_n173_));
  nand3  g111(.a(new_n72_), .b(new_n64_), .c(x30), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n167_), .O(z14));
  ...
  oai21  g121(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n64_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n137_), .d(new_n133_), .O(z18));
  nand2  g125(.a(new_n139_), .b(new_n133_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(x40), .c(x30), .O(z19));
  aoi21  g127(.a(x35), .b(x27), .c(x08), .O(new_n190_));
  nand2  g128(.a(x28), .b(new_n97_), .O(new_n191_));
  aoi22  g129(.a(new_n191_), .b(x35), .c(x39), .d(x29), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n133_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x40), .c(x30), .O(z20));
endmodule
