...
module FAU ( 
  ...
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n80_), .O(z10));
  ...
  nand4  g079(.a(new_n141_), .b(new_n81_), .c(new_n83_), .d(new_n134_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z11));
  nor2   g081(.a(new_n73_), .b(new_n64_), .O(new_n144_));
  nor2   g082(.a(new_n75_), .b(x04), .O(new_n145_));
  inv1   g083(.a(x10), .O(new_n146_));
  nand3  g084(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(x27), .c(x19), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  oai21  g087(.a(new_n145_), .b(new_n144_), .c(new_n149_), .O(z12));
  ...
  nor3   g096(.a(new_n129_), .b(x13), .c(x04), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x10), .O(new_n160_));
  aoi21  g098(.a(new_n152_), .b(x28), .c(new_n64_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n128_), .c(x40), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n117_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x19), .c(new_n151_), .d(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  aoi21  g103(.a(x20), .b(new_n155_), .c(new_n146_), .O(new_n166_));
  nand4  g104(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n76_), .b(new_n151_), .c(new_n65_), .O(new_n169_));
  oai22  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .d(x19), .O(new_n170_));
  ...
  oai21  g112(.a(new_n171_), .b(new_n144_), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x10), .O(new_n176_));
  nand4  g114(.a(new_n84_), .b(new_n83_), .c(new_n64_), .d(x19), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n170_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nand4  g117(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n180_));
  ...
  oai21  g125(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n80_), .b(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n189_), .c(new_n139_), .d(new_n83_), .O(z18));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n192_));
  nand2  g130(.a(new_n135_), .b(new_n66_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(new_n80_), .O(new_n194_));
  oai21  g132(.a(x28), .b(x04), .c(new_n138_), .O(new_n195_));
  oai21  g133(.a(new_n136_), .b(x28), .c(new_n135_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n83_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(x09), .c(new_n81_), .O(z19));
  ...
  nand4  g140(.a(new_n202_), .b(new_n81_), .c(new_n83_), .d(new_n134_), .O(new_n203_));
