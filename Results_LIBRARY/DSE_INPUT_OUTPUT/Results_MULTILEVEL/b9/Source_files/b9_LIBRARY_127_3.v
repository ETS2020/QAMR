...
module FAU ( 
  ...
  nand2  g001(.a(x40), .b(x06), .O(new_n64_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(new_n71_), .O(z02));
  nand2  g032(.a(new_n66_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x27), .O(new_n96_));
  aoi21  g034(.a(new_n65_), .b(new_n96_), .c(new_n79_), .O(new_n97_));
  ...
  nand4  g066(.a(new_n128_), .b(x40), .c(x39), .d(new_n71_), .O(new_n129_));
  nor2   g067(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  aoi21  g068(.a(new_n126_), .b(x27), .c(new_n130_), .O(new_n131_));
  nand4  g069(.a(new_n74_), .b(x37), .c(x27), .d(x06), .O(new_n132_));
  oai21  g070(.a(new_n131_), .b(x04), .c(new_n132_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nor2   g072(.a(new_n79_), .b(x27), .O(new_n135_));
  inv1   g073(.a(x04), .O(new_n136_));
  nand2  g074(.a(new_n83_), .b(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n71_), .c(new_n135_), .O(new_n138_));
  nand2  g076(.a(x39), .b(x29), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n71_), .c(new_n74_), .O(new_n140_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n80_), .c(new_n134_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(z11));
  nor3   g085(.a(x37), .b(x36), .c(x35), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n96_), .c(new_n73_), .O(new_n149_));
  oai21  g087(.a(new_n92_), .b(x04), .c(new_n68_), .O(new_n150_));
  ...
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n136_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n67_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(x06), .O(new_n159_));
  nand4  g097(.a(new_n67_), .b(new_n74_), .c(x20), .d(new_n157_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  inv1   g100(.a(x39), .O(new_n163_));
  nand2  g101(.a(new_n128_), .b(x40), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n152_), .c(new_n71_), .d(new_n136_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n162_), .O(z13));
  nand3  g105(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n168_));
  nand4  g106(.a(new_n153_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  nand3  g108(.a(new_n93_), .b(new_n152_), .c(new_n136_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand3  g110(.a(new_n65_), .b(new_n82_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n81_), .c(new_n80_), .O(new_n175_));
  aoi21  g113(.a(new_n171_), .b(new_n68_), .c(new_n79_), .O(new_n176_));
  ...
  inv1   g124(.a(x28), .O(new_n187_));
  nand2  g125(.a(x27), .b(new_n136_), .O(new_n188_));
  nand2  g126(.a(new_n96_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n82_), .O(new_n190_));
  nand2  g128(.a(new_n80_), .b(new_n134_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n187_), .c(new_n191_), .O(new_n192_));
  nand4  g130(.a(new_n93_), .b(x29), .c(x08), .d(new_n71_), .O(new_n193_));
  oai21  g131(.a(new_n192_), .b(new_n79_), .c(new_n193_), .O(z18));
  inv1   g132(.a(x08), .O(new_n195_));
  aoi21  g133(.a(x35), .b(x27), .c(x06), .O(new_n196_));
  nand2  g134(.a(x40), .b(x04), .O(new_n197_));
  nor2   g135(.a(x40), .b(x27), .O(new_n198_));
  inv1   g136(.a(new_n198_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n197_), .c(new_n187_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n196_), .c(new_n195_), .O(new_n201_));
  nand2  g139(.a(new_n82_), .b(new_n71_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n142_), .c(new_n187_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n139_), .O(new_n204_));
  nand2  g142(.a(new_n143_), .b(new_n74_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n201_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n80_), .c(new_n134_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n64_), .O(z19));
  aoi21  g146(.a(x28), .b(new_n96_), .c(new_n82_), .O(new_n209_));
  oai21  g147(.a(new_n198_), .b(new_n196_), .c(new_n195_), .O(new_n210_));
  oai21  g148(.a(new_n209_), .b(new_n140_), .c(new_n210_), .O(new_n211_));
  nand3  g149(.a(new_n211_), .b(new_n80_), .c(new_n134_), .O(new_n212_));
