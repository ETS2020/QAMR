...
module FAU ( 
  ...
  aoi21  g034(.a(new_n65_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n65_), .c(new_n96_), .O(z05));
  ...
  inv1   g066(.a(new_n83_), .O(new_n129_));
  ...
  nand3  g072(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n135_));
  ...
  nand2  g089(.a(new_n80_), .b(new_n79_), .O(new_n152_));
