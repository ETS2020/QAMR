...
module FAU ( 
  ...
  nor2   g016(.a(x30), .b(x19), .O(new_n79_));
  ...
  nand4  g023(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(x19), .O(new_n86_));
  oai21  g024(.a(new_n79_), .b(x04), .c(new_n86_), .O(z01));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n90_), .c(new_n79_), .O(z02));
  inv1   g033(.a(new_n79_), .O(new_n96_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n79_), .O(z04));
  ...
  nand3  g052(.a(new_n114_), .b(new_n96_), .c(x03), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(z07));
  nand2  g054(.a(new_n96_), .b(new_n91_), .O(z08));
  inv1   g055(.a(x11), .O(new_n118_));
  nand4  g056(.a(new_n96_), .b(x34), .c(x27), .d(x26), .O(new_n119_));
  nor2   g057(.a(new_n119_), .b(new_n118_), .O(z09));
  nand2  g058(.a(new_n91_), .b(x07), .O(new_n121_));
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n96_), .O(z10));
  ...
  nand3  g072(.a(new_n134_), .b(x35), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n133_), .c(x27), .d(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n82_), .c(x19), .d(new_n131_), .O(new_n141_));
  ...
  oai22  g083(.a(new_n91_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n145_), .c(new_n79_), .O(z12));
  ...
  oai21  g091(.a(new_n150_), .b(x04), .c(new_n153_), .O(new_n154_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n65_), .c(new_n79_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  aoi21  g097(.a(new_n149_), .b(x27), .c(x32), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n152_), .c(new_n82_), .O(new_n161_));
  nand2  g099(.a(new_n148_), .b(new_n65_), .O(new_n162_));
  nand4  g100(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n73_), .c(new_n162_), .d(new_n91_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z14));
  nand4  g103(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n96_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand4  g106(.a(new_n96_), .b(new_n168_), .c(x22), .d(x01), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(z16));
  inv1   g108(.a(x01), .O(new_n171_));
  inv1   g109(.a(x24), .O(new_n172_));
  nand4  g110(.a(new_n96_), .b(new_n172_), .c(x23), .d(x22), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n171_), .O(z17));
  nand2  g112(.a(new_n92_), .b(new_n64_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n132_), .c(new_n137_), .O(new_n176_));
  nand2  g114(.a(new_n138_), .b(new_n131_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n176_), .c(x19), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n82_), .O(z18));
  inv1   g117(.a(new_n132_), .O(new_n180_));
  aoi21  g118(.a(new_n66_), .b(x19), .c(x28), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n134_), .c(new_n180_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(x19), .O(new_n183_));
  nor2   g121(.a(x28), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n182_), .c(new_n131_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(x19), .c(x30), .O(z19));
  oai21  g125(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n180_), .c(new_n188_), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n82_), .c(x19), .d(new_n131_), .O(new_n191_));
