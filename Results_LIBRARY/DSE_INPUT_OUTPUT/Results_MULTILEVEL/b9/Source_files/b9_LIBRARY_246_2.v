...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x32), .O(new_n81_));
  ...
  nor2   g033(.a(x40), .b(x32), .O(new_n96_));
  ...
  oai21  g072(.a(new_n64_), .b(new_n65_), .c(new_n85_), .O(new_n135_));
  ...
  aoi21  g083(.a(new_n145_), .b(new_n144_), .c(new_n100_), .O(new_n146_));
  ...
  nand4  g093(.a(new_n72_), .b(new_n84_), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n130_), .b(new_n148_), .c(new_n65_), .O(new_n159_));
  ...
  aoi21  g106(.a(new_n164_), .b(new_n144_), .c(new_n100_), .O(new_n169_));
  ...
  nand2  g115(.a(new_n177_), .b(new_n81_), .O(z17));
  oai21  g116(.a(new_n86_), .b(x27), .c(new_n134_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n100_), .b(x30), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n137_), .d(new_n133_), .O(z18));
  ...
  nand3  g124(.a(new_n186_), .b(new_n83_), .c(new_n133_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n81_), .O(z20));
  nand2  g126(.a(new_n140_), .b(new_n81_), .O(z19));
endmodule
