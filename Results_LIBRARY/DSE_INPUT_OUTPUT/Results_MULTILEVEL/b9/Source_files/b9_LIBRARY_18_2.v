...
module FAU ( 
  ...
  nor2   g042(.a(new_n82_), .b(new_n100_), .O(new_n105_));
  ...
  nand2  g079(.a(new_n64_), .b(new_n100_), .O(new_n142_));
  oai21  g080(.a(new_n83_), .b(x04), .c(x40), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(new_n142_), .c(x08), .O(new_n144_));
  inv1   g082(.a(new_n83_), .O(new_n145_));
  nand2  g083(.a(x39), .b(x29), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x40), .c(new_n95_), .O(new_n147_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n100_), .c(new_n73_), .O(new_n153_));
  oai21  g091(.a(new_n125_), .b(x04), .c(new_n68_), .O(new_n154_));
  ...
  nand4  g101(.a(new_n67_), .b(new_n110_), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n139_), .b(new_n156_), .c(new_n71_), .O(new_n167_));
  ...
  nand3  g109(.a(new_n124_), .b(new_n156_), .c(new_n71_), .O(new_n172_));
  ...
  aoi21  g115(.a(new_n172_), .b(new_n68_), .c(new_n78_), .O(new_n178_));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n174_), .O(new_n190_));
  ...
  oai22  g131(.a(new_n193_), .b(new_n78_), .c(new_n125_), .d(new_n89_), .O(z18));
  inv1   g132(.a(x08), .O(new_n195_));
  oai21  g133(.a(new_n174_), .b(x04), .c(x40), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n142_), .c(new_n82_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n195_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n174_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n148_), .c(new_n82_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n146_), .O(new_n201_));
  nand2  g139(.a(new_n174_), .b(new_n110_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n148_), .c(new_n82_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n63_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n201_), .c(new_n198_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n79_), .c(new_n191_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n64_), .O(z19));
  aoi21  g145(.a(x28), .b(new_n100_), .c(new_n174_), .O(new_n208_));
  nor2   g146(.a(new_n208_), .b(new_n147_), .O(new_n209_));
  aoi21  g147(.a(new_n199_), .b(new_n142_), .c(x08), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n209_), .c(new_n79_), .O(new_n211_));
