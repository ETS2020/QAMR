...
module FAU ( 
  ...
  nand3  g046(.a(new_n108_), .b(new_n106_), .c(new_n72_), .O(new_n109_));
  ...
  aoi22  g073(.a(new_n135_), .b(new_n72_), .c(new_n63_), .d(new_n67_), .O(new_n136_));
  aoi21  g074(.a(x39), .b(x29), .c(x33), .O(new_n137_));
  nor2   g075(.a(new_n67_), .b(new_n121_), .O(new_n138_));
  oai22  g076(.a(new_n138_), .b(new_n83_), .c(new_n137_), .d(new_n74_), .O(new_n139_));
  ...
  nand3  g081(.a(new_n68_), .b(new_n81_), .c(new_n143_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n121_), .c(new_n70_), .O(new_n146_));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n121_), .O(new_n153_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(x33), .O(new_n158_));
  nand4  g096(.a(new_n156_), .b(new_n74_), .c(x20), .d(new_n155_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  nand4  g099(.a(new_n128_), .b(new_n72_), .c(new_n150_), .d(new_n121_), .O(new_n162_));
  ...
  nand3  g103(.a(x39), .b(new_n150_), .c(new_n121_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(x33), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n74_), .c(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n68_), .b(new_n143_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  oai21  g110(.a(new_n167_), .b(new_n70_), .c(new_n172_), .O(new_n173_));
  ...
  nand2  g122(.a(x27), .b(new_n121_), .O(new_n185_));
  nand2  g123(.a(new_n67_), .b(x08), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n143_), .O(new_n187_));
  nand2  g125(.a(new_n79_), .b(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n82_), .c(new_n188_), .O(new_n189_));
  inv1   g127(.a(new_n123_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n72_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n89_), .c(new_n189_), .d(new_n64_), .O(z18));
  nand2  g130(.a(x40), .b(x04), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(x35), .c(new_n82_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n72_), .c(new_n63_), .d(new_n67_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(x08), .c(new_n139_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n79_), .c(new_n134_), .O(new_n197_));
  inv1   g135(.a(new_n197_), .O(z19));
  nor2   g136(.a(new_n143_), .b(new_n67_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n67_), .c(new_n143_), .O(new_n200_));
  nand2  g138(.a(new_n190_), .b(x29), .O(new_n201_));
  inv1   g139(.a(new_n201_), .O(new_n202_));
  oai22  g140(.a(new_n202_), .b(new_n200_), .c(new_n199_), .d(x08), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n79_), .c(new_n134_), .O(new_n204_));
