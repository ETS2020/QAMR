...
module FAU ( 
  ...
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n83_), .O(z05));
  ...
  nand4  g094(.a(new_n72_), .b(x20), .c(new_n123_), .d(new_n156_), .O(new_n157_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n83_), .O(new_n163_));
  ...
  nand2  g107(.a(new_n153_), .b(x19), .O(new_n170_));
  nand3  g108(.a(new_n70_), .b(new_n66_), .c(new_n84_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(new_n86_), .O(new_n172_));
  nor2   g110(.a(x30), .b(x27), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(new_n85_), .O(new_n174_));
  nand3  g112(.a(new_n72_), .b(x27), .c(new_n123_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n168_), .c(new_n83_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n174_), .c(new_n169_), .O(z14));
  nand4  g115(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n80_), .O(z15));
  ...
  nand2  g124(.a(new_n95_), .b(new_n64_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n137_), .c(new_n140_), .O(new_n188_));
  nand2  g126(.a(new_n141_), .b(new_n136_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(new_n84_), .O(new_n190_));
  nand2  g128(.a(x30), .b(new_n123_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n190_), .O(z18));
  nand2  g130(.a(new_n144_), .b(new_n80_), .O(z19));
  inv1   g131(.a(new_n137_), .O(new_n194_));
  ...
  nand3  g135(.a(new_n197_), .b(new_n84_), .c(new_n136_), .O(new_n198_));
