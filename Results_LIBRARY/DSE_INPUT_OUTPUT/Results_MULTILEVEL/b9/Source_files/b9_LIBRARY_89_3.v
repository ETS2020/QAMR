...
module FAU ( 
  ...
  aoi21  g20(.a(new_n82_), .b(new_n79_), .c(new_n64_), .O(z03));
  ...
  nand2  g25(.a(new_n86_), .b(new_n81_), .O(new_n88_));
  nand2  g26(.a(new_n88_), .b(z02), .O(z06));
  ...
  nand2  g41(.a(new_n104_), .b(z02), .O(z09));
  inv1   g42(.a(x04), .O(new_n106_));
  nand3  g43(.a(new_n74_), .b(x07), .c(new_n106_), .O(new_n107_));
  nand2  g44(.a(x37), .b(x06), .O(new_n108_));
  nand2  g45(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g46(.a(new_n109_), .b(x27), .O(new_n110_));
  nand2  g47(.a(new_n110_), .b(z02), .O(z10));
  inv1   g48(.a(x09), .O(new_n112_));
  nand2  g49(.a(x27), .b(x04), .O(new_n113_));
  inv1   g50(.a(x08), .O(new_n114_));
  nand2  g51(.a(new_n66_), .b(new_n114_), .O(new_n115_));
  nand4  g52(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n78_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(z02), .c(new_n71_), .d(new_n112_), .O(new_n117_));
  inv1   g54(.a(new_n117_), .O(z11));
  inv1   g55(.a(new_n67_), .O(new_n119_));
  nand3  g56(.a(new_n119_), .b(z02), .c(x27), .O(z12));
  inv1   g57(.a(x18), .O(new_n121_));
  inv1   g58(.a(x19), .O(new_n122_));
  nand4  g59(.a(new_n68_), .b(x20), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  nand2  g60(.a(new_n123_), .b(z02), .O(z13));
  nand4  g61(.a(x27), .b(x20), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  inv1   g62(.a(new_n125_), .O(new_n126_));
  aoi21  g63(.a(new_n126_), .b(new_n119_), .c(new_n64_), .O(z14));
  inv1   g64(.a(x12), .O(new_n128_));
  nand4  g65(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n129_));
  nor2   g66(.a(new_n129_), .b(new_n128_), .O(z15));
  inv1   g67(.a(x23), .O(new_n131_));
  nand4  g68(.a(z02), .b(new_n131_), .c(x22), .d(x01), .O(new_n132_));
  inv1   g69(.a(new_n132_), .O(z16));
  inv1   g70(.a(x01), .O(new_n134_));
  inv1   g71(.a(x24), .O(new_n135_));
  nand4  g72(.a(z02), .b(new_n135_), .c(x23), .d(x22), .O(new_n136_));
  nor2   g73(.a(new_n136_), .b(new_n134_), .O(z17));
  nand2  g74(.a(x27), .b(new_n106_), .O(new_n138_));
  oai21  g75(.a(x27), .b(new_n114_), .c(new_n138_), .O(new_n139_));
  nand3  g76(.a(new_n139_), .b(x35), .c(new_n78_), .O(new_n140_));
  nor2   g77(.a(x30), .b(x09), .O(new_n141_));
  aoi21  g78(.a(new_n141_), .b(new_n140_), .c(new_n64_), .O(z18));
  oai21  g79(.a(x28), .b(new_n114_), .c(new_n66_), .O(new_n143_));
  nand2  g80(.a(new_n143_), .b(x35), .O(new_n144_));
  nand3  g81(.a(new_n144_), .b(new_n71_), .c(new_n112_), .O(new_n145_));
  nand2  g82(.a(new_n145_), .b(z02), .O(z20));
  zero   g83(.O(z08));
  inv1   g84(.a(new_n117_), .O(z19));
endmodule
