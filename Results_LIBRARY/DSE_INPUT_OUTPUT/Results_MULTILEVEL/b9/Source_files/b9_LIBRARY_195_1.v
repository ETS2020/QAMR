...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(x05), .O(new_n81_));
  ...
  nand4  g040(.a(new_n100_), .b(new_n99_), .c(new_n82_), .d(new_n102_), .O(z04));
  ...
  inv1   g058(.a(x34), .O(new_n121_));
  nand4  g059(.a(x27), .b(x26), .c(x11), .d(x05), .O(new_n122_));
  ...
  nand3  g064(.a(new_n75_), .b(new_n80_), .c(x07), .O(new_n127_));
  ...
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n119_), .O(new_n155_));
  ...
  nor2   g099(.a(new_n133_), .b(x13), .O(new_n162_));
  ...
  aoi22  g109(.a(new_n171_), .b(new_n84_), .c(new_n168_), .d(new_n150_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n169_), .c(new_n81_), .O(z14));
  ...
  nand2  g118(.a(new_n180_), .b(new_n82_), .O(z17));
  oai21  g119(.a(new_n87_), .b(x27), .c(new_n138_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n81_), .b(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n142_), .d(new_n84_), .O(z18));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n141_), .O(new_n186_));
  nand2  g124(.a(new_n138_), .b(new_n66_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n81_), .O(new_n188_));
  inv1   g126(.a(new_n138_), .O(new_n189_));
  nor2   g127(.a(x28), .b(x04), .O(new_n190_));
  aoi21  g128(.a(x27), .b(x04), .c(x28), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .d(x08), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n188_), .c(new_n84_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(x09), .c(new_n82_), .O(z19));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n189_), .c(new_n186_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n82_), .c(new_n84_), .d(new_n137_), .O(new_n197_));
