...
module FAU ( 
  ...
  nor3   g065(.a(new_n63_), .b(new_n65_), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g072(.a(new_n129_), .b(new_n97_), .c(new_n134_), .O(z10));
  oai21  g073(.a(x40), .b(x39), .c(new_n97_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n121_), .c(new_n71_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x39), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n136_), .c(x08), .O(new_n139_));
  nand2  g077(.a(x40), .b(new_n93_), .O(new_n140_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n97_), .c(new_n73_), .O(new_n148_));
  oai21  g086(.a(new_n116_), .b(x04), .c(new_n68_), .O(new_n149_));
  ...
  nand3  g103(.a(new_n94_), .b(new_n151_), .c(new_n71_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n65_), .b(new_n81_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n80_), .c(new_n79_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n68_), .c(new_n63_), .O(new_n171_));
  ...
  oai22  g118(.a(new_n116_), .b(new_n88_), .c(new_n90_), .d(x27), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n97_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n82_), .c(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n182_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g123(.a(x09), .O(new_n186_));
  oai21  g124(.a(new_n81_), .b(x04), .c(x39), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n136_), .c(new_n121_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n87_), .O(new_n189_));
  nand2  g127(.a(x39), .b(new_n81_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n143_), .c(new_n121_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n141_), .O(new_n192_));
  nand2  g130(.a(x40), .b(new_n81_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n143_), .c(new_n121_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n93_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n192_), .c(new_n189_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n79_), .c(new_n186_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n64_), .O(z19));
  nand2  g136(.a(x28), .b(new_n97_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n142_), .d(new_n140_), .O(new_n200_));
  aoi21  g138(.a(new_n190_), .b(new_n136_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n79_), .O(new_n202_));
