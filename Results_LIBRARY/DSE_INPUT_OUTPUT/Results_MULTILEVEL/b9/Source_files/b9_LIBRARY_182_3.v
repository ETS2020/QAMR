...
module FAU ( 
  ...
  aoi21  g021(.a(new_n83_), .b(new_n67_), .c(new_n64_), .O(new_n84_));
  nor2   g022(.a(x30), .b(new_n65_), .O(new_n85_));
  oai21  g023(.a(new_n84_), .b(x32), .c(new_n85_), .O(z01));
  aoi21  g024(.a(x29), .b(x08), .c(x02), .O(new_n87_));
  oai21  g025(.a(new_n87_), .b(new_n75_), .c(new_n80_), .O(new_n88_));
  inv1   g026(.a(x30), .O(new_n89_));
  nor2   g027(.a(x27), .b(x08), .O(new_n90_));
  oai21  g028(.a(new_n90_), .b(new_n83_), .c(new_n89_), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n65_), .c(new_n88_), .O(z02));
  ...
  nand2  g051(.a(new_n80_), .b(new_n75_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n115_), .O(z09));
  nand2  g055(.a(new_n83_), .b(new_n67_), .O(new_n118_));
  ...
  nand3  g062(.a(x37), .b(new_n89_), .c(x06), .O(new_n125_));
  ...
  aoi21  g067(.a(new_n128_), .b(new_n89_), .c(new_n129_), .O(new_n130_));
  ...
  nand4  g075(.a(x35), .b(new_n82_), .c(x27), .d(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n89_), .c(new_n133_), .O(new_n141_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n80_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n129_), .O(new_n151_));
  ...
  oai21  g095(.a(new_n128_), .b(x04), .c(new_n89_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x40), .c(x39), .d(new_n149_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n157_), .c(new_n80_), .O(z13));
  nand3  g098(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n161_));
  nand4  g099(.a(new_n150_), .b(new_n128_), .c(new_n89_), .d(x28), .O(new_n162_));
  ...
  nand3  g105(.a(new_n167_), .b(new_n128_), .c(new_n89_), .O(new_n168_));
  aoi21  g106(.a(new_n164_), .b(new_n146_), .c(new_n93_), .O(new_n169_));
  ...
  oai21  g116(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n138_), .c(new_n89_), .d(new_n133_), .O(z18));
  inv1   g119(.a(new_n134_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n183_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n89_), .c(new_n133_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n80_), .O(z20));
  inv1   g125(.a(new_n141_), .O(z19));
endmodule
