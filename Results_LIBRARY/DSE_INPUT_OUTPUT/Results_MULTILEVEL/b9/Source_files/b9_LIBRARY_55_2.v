...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x21), .O(new_n96_));
  ...
  oai21  g038(.a(new_n100_), .b(new_n63_), .c(x21), .O(z03));
  nand2  g039(.a(x40), .b(x21), .O(new_n102_));
  oai21  g040(.a(new_n100_), .b(new_n65_), .c(new_n102_), .O(z04));
  ...
  nor2   g069(.a(new_n131_), .b(new_n119_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x05), .c(new_n74_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(z10));
  inv1   g072(.a(x27), .O(new_n135_));
  nand2  g073(.a(new_n64_), .b(new_n135_), .O(new_n136_));
  ...
  inv1   g088(.a(x21), .O(new_n151_));
  nand3  g089(.a(new_n71_), .b(new_n63_), .c(new_n151_), .O(new_n152_));
  ...
  nand4  g099(.a(new_n70_), .b(new_n151_), .c(x20), .d(new_n159_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n132_), .b(new_n154_), .c(new_n74_), .O(new_n165_));
  ...
  nand3  g107(.a(z08), .b(new_n154_), .c(new_n74_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .O(new_n171_));
  nand3  g109(.a(new_n68_), .b(new_n146_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n81_), .c(new_n80_), .O(new_n174_));
  aoi21  g112(.a(new_n170_), .b(new_n71_), .c(new_n65_), .O(new_n175_));
  ...
  nand2  g124(.a(x27), .b(new_n74_), .O(new_n187_));
  nand2  g125(.a(new_n135_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n146_), .O(new_n189_));
  ...
  oai22  g130(.a(new_n192_), .b(new_n65_), .c(new_n186_), .d(new_n90_), .O(z18));
  aoi21  g131(.a(x28), .b(new_n135_), .c(new_n146_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n141_), .O(new_n195_));
  nand2  g133(.a(x40), .b(new_n146_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n136_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n80_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z20));
  nor2   g137(.a(new_n144_), .b(x09), .O(z19));
endmodule
