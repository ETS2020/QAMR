...
module FAU ( 
  ...
  nand2  g017(.a(x30), .b(x26), .O(new_n80_));
  ...
  oai21  g026(.a(new_n83_), .b(x04), .c(new_n88_), .O(z01));
  ...
  nand4  g034(.a(new_n96_), .b(new_n92_), .c(new_n80_), .d(new_n76_), .O(z02));
  ...
  nor2   g041(.a(new_n93_), .b(new_n64_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n80_), .b(x40), .c(x39), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(z08));
  inv1   g059(.a(x26), .O(new_n122_));
  nand3  g060(.a(x34), .b(x27), .c(x11), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n84_), .c(new_n122_), .O(z09));
  nand3  g062(.a(new_n80_), .b(new_n75_), .c(x07), .O(new_n125_));
  nand4  g063(.a(x40), .b(x39), .c(new_n84_), .d(x05), .O(new_n126_));
  aoi22  g064(.a(new_n126_), .b(new_n125_), .c(new_n94_), .d(new_n67_), .O(new_n127_));
  ...
  nand2  g069(.a(x30), .b(new_n122_), .O(new_n132_));
  nand2  g070(.a(x32), .b(new_n84_), .O(new_n133_));
  ...
  oai21  g077(.a(new_n139_), .b(new_n94_), .c(new_n138_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n84_), .c(new_n137_), .O(new_n145_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n76_), .c(new_n83_), .O(new_n168_));
  nand4  g106(.a(new_n153_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(x27), .c(x32), .O(new_n173_));
  aoi22  g111(.a(new_n167_), .b(new_n76_), .c(new_n72_), .d(x27), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(new_n84_), .O(new_n175_));
  nand2  g113(.a(new_n174_), .b(new_n122_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n171_), .O(z14));
  nand3  g115(.a(x34), .b(x27), .c(x12), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n84_), .c(new_n122_), .O(z15));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n138_), .c(new_n141_), .O(new_n187_));
  nand2  g125(.a(new_n142_), .b(new_n137_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n187_), .c(new_n84_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n132_), .O(z18));
  nand2  g128(.a(new_n145_), .b(new_n80_), .O(z19));
  ...
  nand3  g133(.a(new_n195_), .b(new_n84_), .c(new_n137_), .O(new_n196_));
