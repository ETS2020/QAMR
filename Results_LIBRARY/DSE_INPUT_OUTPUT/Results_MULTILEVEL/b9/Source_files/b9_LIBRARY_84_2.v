...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n93_, new_n96_, new_n97_, new_n99_, new_n101_, new_n102_,
  ...
  nand4  g048(.a(new_n110_), .b(x40), .c(new_n107_), .d(new_n106_), .O(new_n111_));
  inv1   g049(.a(x14), .O(new_n112_));
  nand2  g050(.a(x38), .b(new_n108_), .O(new_n113_));
  oai21  g051(.a(new_n113_), .b(x00), .c(new_n112_), .O(new_n114_));
  ...
  nor2   g056(.a(x40), .b(x14), .O(new_n119_));
  aoi21  g057(.a(x40), .b(new_n93_), .c(new_n119_), .O(new_n120_));
  nand3  g058(.a(x40), .b(x39), .c(x05), .O(new_n121_));
  oai21  g059(.a(new_n120_), .b(new_n118_), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n84_), .c(new_n73_), .O(new_n123_));
  ...
  nand2  g075(.a(x27), .b(new_n73_), .O(new_n138_));
  ...
  nand2  g086(.a(new_n148_), .b(new_n112_), .O(new_n149_));
  ...
  nor2   g097(.a(new_n158_), .b(x14), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n128_), .b(new_n151_), .c(new_n73_), .O(new_n162_));
  ...
  oai21  g106(.a(new_n168_), .b(new_n119_), .c(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n69_), .b(new_n143_), .c(x28), .O(new_n170_));
  ...
  nand2  g122(.a(new_n68_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n138_), .c(new_n143_), .O(new_n186_));
  nand2  g124(.a(new_n79_), .b(new_n131_), .O(new_n187_));
  aoi21  g125(.a(new_n186_), .b(new_n82_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n65_), .c(new_n184_), .d(new_n89_), .O(z18));
  nand2  g127(.a(new_n64_), .b(new_n68_), .O(new_n190_));
  oai21  g128(.a(new_n83_), .b(x04), .c(x40), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x08), .O(new_n192_));
  nand2  g130(.a(x39), .b(x29), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x40), .c(new_n119_), .O(new_n194_));
  aoi21  g132(.a(new_n134_), .b(new_n133_), .c(new_n194_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n192_), .c(new_n79_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z19));
  aoi21  g135(.a(x28), .b(new_n68_), .c(new_n143_), .O(new_n198_));
