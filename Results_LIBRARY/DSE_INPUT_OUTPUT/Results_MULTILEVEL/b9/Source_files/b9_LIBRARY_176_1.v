...
module FAU ( 
  ...
  aoi21  g033(.a(new_n65_), .b(new_n95_), .c(new_n79_), .O(new_n96_));
  ...
  oai22  g056(.a(new_n118_), .b(new_n116_), .c(x40), .d(new_n117_), .O(new_n119_));
  ...
  aoi21  g065(.a(x39), .b(new_n127_), .c(new_n74_), .O(new_n128_));
  nand2  g066(.a(x27), .b(x04), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n90_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n64_), .b(new_n95_), .O(new_n131_));
  ...
  oai21  g073(.a(new_n135_), .b(new_n130_), .c(new_n80_), .O(new_n136_));
  ...
  oai21  g077(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n140_));
  ...
  nand4  g082(.a(new_n144_), .b(x40), .c(new_n142_), .d(new_n71_), .O(new_n145_));
  inv1   g083(.a(x18), .O(new_n146_));
  inv1   g084(.a(x19), .O(new_n147_));
  nand4  g085(.a(new_n67_), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n145_), .c(new_n95_), .O(new_n149_));
  nand2  g087(.a(new_n81_), .b(new_n80_), .O(new_n150_));
  ...
  nand3  g091(.a(x40), .b(new_n142_), .c(new_n71_), .O(new_n154_));
  ...
  nand2  g111(.a(new_n95_), .b(x08), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(new_n82_), .O(new_n175_));
  inv1   g113(.a(x09), .O(new_n176_));
  nand2  g114(.a(new_n80_), .b(new_n176_), .O(new_n177_));
  aoi21  g115(.a(new_n175_), .b(new_n132_), .c(new_n177_), .O(new_n178_));
  oai22  g116(.a(new_n178_), .b(new_n79_), .c(new_n118_), .d(new_n89_), .O(z18));
  ...
  oai21  g121(.a(new_n183_), .b(new_n130_), .c(new_n80_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(x09), .O(z19));
  nor2   g123(.a(new_n82_), .b(new_n95_), .O(new_n186_));
  nor2   g124(.a(new_n74_), .b(new_n127_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n95_), .c(new_n82_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(x08), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n80_), .c(new_n176_), .O(new_n190_));
