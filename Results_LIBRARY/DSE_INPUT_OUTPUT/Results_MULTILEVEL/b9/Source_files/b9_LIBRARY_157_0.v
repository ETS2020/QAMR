...
module FAU ( 
  ...
  nand3  g034(.a(new_n96_), .b(new_n92_), .c(new_n77_), .O(z02));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n81_), .O(z04));
  ...
  oai21  g075(.a(new_n137_), .b(new_n94_), .c(new_n136_), .O(new_n138_));
  ...
  oai21  g086(.a(new_n117_), .b(x04), .c(new_n148_), .O(new_n149_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n81_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nor2   g100(.a(new_n76_), .b(x39), .O(new_n163_));
  ...
  nand3  g113(.a(new_n148_), .b(x40), .c(new_n75_), .O(new_n176_));
  ...
  oai21  g123(.a(new_n94_), .b(x27), .c(new_n136_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n81_), .b(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n140_), .d(new_n135_), .O(z18));
  ...
  nand3  g131(.a(new_n193_), .b(new_n84_), .c(new_n135_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n82_), .O(z20));
  nand2  g133(.a(new_n143_), .b(new_n82_), .O(z19));
endmodule
