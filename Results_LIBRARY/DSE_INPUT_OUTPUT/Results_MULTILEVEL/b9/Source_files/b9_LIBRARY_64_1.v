...
module FAU ( 
  ...
  inv1   g012(.a(x22), .O(new_n75_));
  nor2   g013(.a(new_n75_), .b(x19), .O(new_n76_));
  inv1   g014(.a(new_n76_), .O(new_n77_));
  nand3  g015(.a(new_n77_), .b(new_n74_), .c(x16), .O(z00));
  ...
  nand2  g029(.a(new_n64_), .b(new_n91_), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(x35), .c(new_n81_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(x04), .c(new_n90_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n89_), .c(new_n76_), .O(z02));
  oai21  g033(.a(new_n66_), .b(new_n81_), .c(x27), .O(new_n96_));
  inv1   g034(.a(x21), .O(new_n97_));
  inv1   g035(.a(x37), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n64_), .c(new_n97_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n76_), .O(z03));
  nand2  g038(.a(new_n98_), .b(new_n64_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n96_), .c(new_n77_), .d(new_n97_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n77_), .c(new_n98_), .O(z05));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n128_), .c(new_n76_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x29), .O(new_n132_));
  nor2   g070(.a(new_n64_), .b(new_n65_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n82_), .c(new_n132_), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n81_), .c(x27), .d(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n91_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(new_n77_), .c(new_n79_), .d(new_n131_), .O(new_n138_));
  ...
  oai22  g080(.a(new_n90_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n77_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  inv1   g083(.a(x40), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n146_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x39), .c(new_n145_), .d(new_n65_), .O(new_n149_));
  inv1   g087(.a(x18), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  inv1   g089(.a(x20), .O(new_n152_));
  nor2   g090(.a(new_n70_), .b(new_n152_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n151_), .c(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n149_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n125_), .b(x40), .c(x39), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n65_), .c(new_n76_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z13));
  aoi21  g098(.a(x20), .b(new_n150_), .c(x22), .O(new_n161_));
  nand4  g099(.a(new_n147_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  nand4  g101(.a(x40), .b(x39), .c(new_n145_), .d(new_n65_), .O(new_n164_));
  ...
  nand4  g109(.a(new_n80_), .b(new_n79_), .c(new_n64_), .d(x19), .O(new_n172_));
  ...
  aoi21  g115(.a(new_n177_), .b(x19), .c(new_n75_), .O(z16));
  nand4  g116(.a(x23), .b(x22), .c(x19), .d(x01), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(x24), .O(z17));
  oai21  g118(.a(new_n82_), .b(x27), .c(new_n132_), .O(new_n181_));
  nand3  g119(.a(new_n135_), .b(new_n79_), .c(new_n131_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(x08), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n76_), .O(z18));
  inv1   g122(.a(new_n132_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n77_), .c(new_n79_), .d(new_n131_), .O(new_n189_));
