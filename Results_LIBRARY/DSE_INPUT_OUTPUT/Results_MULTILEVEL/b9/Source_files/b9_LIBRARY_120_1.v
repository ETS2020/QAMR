...
module FAU ( 
  ...
  nand3  g060(.a(new_n122_), .b(new_n83_), .c(new_n90_), .O(new_n123_));
  ...
  nand4  g067(.a(new_n129_), .b(x29), .c(x05), .d(new_n90_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n126_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nor2   g070(.a(new_n74_), .b(new_n116_), .O(new_n133_));
  ...
  nand4  g077(.a(new_n139_), .b(x35), .c(new_n101_), .d(x27), .O(new_n140_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n87_), .c(new_n73_), .O(new_n146_));
  oai21  g084(.a(new_n134_), .b(x04), .c(new_n69_), .O(new_n147_));
  ...
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n149_), .d(new_n90_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand4  g092(.a(new_n68_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(new_n87_), .O(new_n156_));
  nand4  g094(.a(new_n127_), .b(x39), .c(new_n149_), .d(new_n90_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x29), .c(new_n74_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n156_), .O(z13));
  nand3  g097(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n160_));
  nand4  g098(.a(new_n150_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand3  g100(.a(new_n133_), .b(new_n149_), .c(new_n90_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n66_), .b(new_n81_), .c(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n80_), .c(new_n79_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n69_), .c(new_n98_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n167_), .c(new_n164_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  nand4  g108(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n171_));
  ...
  nand2  g117(.a(x27), .b(new_n90_), .O(new_n180_));
  nand2  g118(.a(new_n87_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n81_), .O(new_n182_));
  nand2  g120(.a(new_n79_), .b(new_n132_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(new_n101_), .c(new_n183_), .O(new_n184_));
  nand3  g122(.a(new_n133_), .b(x29), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n184_), .b(new_n98_), .c(new_n185_), .O(z18));
  aoi21  g124(.a(new_n135_), .b(new_n91_), .c(z08), .O(new_n187_));
  nand2  g125(.a(new_n65_), .b(new_n87_), .O(new_n188_));
  nand3  g126(.a(new_n139_), .b(x35), .c(new_n101_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x29), .O(new_n190_));
  ...
  oai21  g131(.a(new_n81_), .b(new_n87_), .c(new_n138_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n87_), .c(new_n81_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n133_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n79_), .c(new_n132_), .O(new_n197_));
