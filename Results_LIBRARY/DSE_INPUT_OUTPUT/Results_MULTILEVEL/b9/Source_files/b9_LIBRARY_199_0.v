...
module FAU ( 
  ...
  nor2   g052(.a(new_n64_), .b(new_n114_), .O(z08));
  ...
  aoi21  g058(.a(new_n120_), .b(new_n91_), .c(new_n119_), .O(new_n121_));
  nand3  g059(.a(x40), .b(x39), .c(x05), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n121_), .c(new_n82_), .O(new_n124_));
  ...
  nor2   g074(.a(new_n94_), .b(new_n72_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n81_), .c(new_n136_), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n80_), .c(x27), .d(new_n72_), .O(new_n139_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n94_), .c(new_n74_), .O(new_n145_));
  ...
  nor2   g095(.a(new_n131_), .b(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n72_), .c(new_n97_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  nand3  g098(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n161_));
  nand4  g099(.a(new_n150_), .b(new_n129_), .c(new_n63_), .d(x28), .O(new_n162_));
  ...
  oai21  g106(.a(new_n168_), .b(new_n64_), .c(new_n63_), .O(new_n169_));
  nand2  g107(.a(new_n164_), .b(new_n69_), .O(new_n170_));
  ...
  oai21  g118(.a(new_n81_), .b(x27), .c(new_n136_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n64_), .b(x30), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n182_), .c(new_n139_), .d(new_n135_), .O(z18));
  aoi21  g122(.a(x35), .b(x27), .c(x08), .O(new_n185_));
  nand2  g123(.a(x28), .b(new_n94_), .O(new_n186_));
  aoi22  g124(.a(new_n186_), .b(x35), .c(x39), .d(x29), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n135_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(x40), .c(x30), .O(z20));
  aoi21  g127(.a(new_n142_), .b(x40), .c(x30), .O(z19));
endmodule
