...
module FAU ( 
  ...
  nand2  g034(.a(new_n66_), .b(new_n96_), .O(new_n97_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n66_), .c(new_n79_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n65_), .c(new_n66_), .O(new_n103_));
  ...
  oai21  g070(.a(new_n127_), .b(new_n96_), .c(new_n132_), .O(z10));
  nand2  g071(.a(new_n65_), .b(new_n96_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n119_), .c(new_n72_), .O(new_n135_));
  ...
  oai21  g084(.a(new_n92_), .b(x04), .c(new_n69_), .O(new_n147_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n72_), .c(new_n79_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  inv1   g098(.a(new_n138_), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  nand4  g100(.a(new_n150_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n163_));
  nand3  g101(.a(x40), .b(new_n149_), .c(new_n72_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n63_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n161_), .c(new_n162_), .O(new_n167_));
  nand3  g105(.a(new_n66_), .b(new_n82_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n81_), .c(new_n80_), .O(new_n170_));
  nand2  g108(.a(new_n164_), .b(new_n69_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x39), .O(new_n173_));
  nand3  g111(.a(new_n69_), .b(x40), .c(new_n63_), .O(new_n174_));
  ...
  nand2  g121(.a(x27), .b(new_n72_), .O(new_n184_));
  nand2  g122(.a(new_n96_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(new_n82_), .O(new_n186_));
  inv1   g124(.a(x09), .O(new_n187_));
  nand2  g125(.a(new_n80_), .b(new_n187_), .O(new_n188_));
  aoi21  g126(.a(new_n186_), .b(new_n119_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n79_), .c(new_n92_), .d(new_n88_), .O(z18));
  nand2  g128(.a(x28), .b(new_n96_), .O(new_n191_));
  aoi22  g129(.a(new_n191_), .b(x35), .c(new_n140_), .d(new_n138_), .O(new_n192_));
  nand2  g130(.a(x39), .b(new_n82_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n134_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n80_), .O(new_n195_));
