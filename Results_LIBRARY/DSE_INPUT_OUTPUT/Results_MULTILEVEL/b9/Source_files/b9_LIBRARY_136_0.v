...
module FAU ( 
  ...
  nand4  g035(.a(new_n97_), .b(new_n92_), .c(new_n84_), .d(new_n93_), .O(z04));
  ...
  nand2  g050(.a(new_n86_), .b(new_n84_), .O(z08));
  inv1   g051(.a(x11), .O(new_n114_));
  nand4  g052(.a(new_n84_), .b(x34), .c(x27), .d(x26), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  nand3  g054(.a(new_n84_), .b(x37), .c(x06), .O(new_n117_));
  nand4  g055(.a(new_n86_), .b(new_n80_), .c(x30), .d(x07), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x04), .c(new_n117_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(x27), .O(new_n120_));
  inv1   g058(.a(x04), .O(new_n121_));
  inv1   g059(.a(new_n86_), .O(new_n122_));
  nand4  g060(.a(new_n122_), .b(x30), .c(x05), .d(new_n121_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n120_), .O(z10));
  inv1   g062(.a(x09), .O(new_n125_));
  nand2  g063(.a(new_n122_), .b(x29), .O(new_n126_));
  ...
  aoi21  g067(.a(new_n129_), .b(x04), .c(x30), .O(z11));
  nor3   g068(.a(x37), .b(x36), .c(x35), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n66_), .c(new_n70_), .O(new_n132_));
  oai22  g070(.a(new_n86_), .b(x04), .c(new_n67_), .d(new_n66_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n84_), .O(z12));
  nand2  g072(.a(new_n122_), .b(x30), .O(new_n135_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n121_), .O(new_n140_));
  oai22  g078(.a(new_n140_), .b(new_n135_), .c(new_n138_), .d(x18), .O(z13));
  inv1   g079(.a(x18), .O(new_n142_));
  nand4  g080(.a(x27), .b(x20), .c(new_n136_), .d(new_n142_), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n67_), .c(new_n140_), .d(new_n86_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n84_), .O(z14));
  inv1   g083(.a(x12), .O(new_n146_));
  nor2   g084(.a(new_n115_), .b(new_n146_), .O(z15));
  inv1   g085(.a(x23), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(x22), .c(x01), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n84_), .O(z16));
  inv1   g088(.a(x01), .O(new_n151_));
  inv1   g089(.a(x24), .O(new_n152_));
  nand4  g090(.a(new_n84_), .b(new_n152_), .c(x23), .d(x22), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(new_n151_), .O(z17));
  nand4  g092(.a(new_n128_), .b(new_n76_), .c(new_n125_), .d(x04), .O(z18));
  inv1   g093(.a(new_n126_), .O(new_n156_));
  oai21  g094(.a(new_n78_), .b(x27), .c(x35), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x04), .c(x27), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x08), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n125_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x04), .c(x30), .O(z19));
  nor2   g099(.a(new_n91_), .b(new_n66_), .O(new_n162_));
  nand2  g100(.a(new_n157_), .b(new_n126_), .O(new_n163_));
  oai21  g101(.a(new_n162_), .b(x08), .c(new_n163_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n76_), .c(new_n125_), .d(x04), .O(new_n165_));
