...
module FAU ( 
  ...
  nand2  g017(.a(x30), .b(x25), .O(new_n80_));
  ...
  nand3  g025(.a(new_n87_), .b(new_n80_), .c(x04), .O(z01));
  ...
  nand4  g033(.a(new_n95_), .b(new_n91_), .c(new_n80_), .d(new_n76_), .O(z02));
  nand2  g034(.a(new_n71_), .b(x27), .O(new_n97_));
  inv1   g035(.a(new_n80_), .O(new_n98_));
  ...
  nand3  g042(.a(new_n103_), .b(new_n80_), .c(new_n70_), .O(new_n105_));
  ...
  nand2  g056(.a(new_n80_), .b(new_n75_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  nand3  g060(.a(new_n80_), .b(new_n75_), .c(x07), .O(new_n123_));
  nand4  g061(.a(x40), .b(x39), .c(new_n83_), .d(x05), .O(new_n124_));
  aoi22  g062(.a(new_n124_), .b(new_n123_), .c(new_n93_), .d(new_n67_), .O(new_n125_));
  nand3  g063(.a(new_n80_), .b(x37), .c(x06), .O(new_n126_));
  inv1   g064(.a(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n65_), .c(new_n127_), .O(new_n128_));
  inv1   g066(.a(x40), .O(new_n129_));
  nand2  g067(.a(x30), .b(new_n113_), .O(new_n130_));
  nand2  g068(.a(x32), .b(new_n83_), .O(new_n131_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n98_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n129_), .O(new_n153_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n98_), .O(new_n163_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n148_), .c(new_n98_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n80_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(x22), .c(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n80_), .O(z16));
  inv1   g117(.a(x01), .O(new_n180_));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n80_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  nand2  g121(.a(new_n85_), .b(new_n64_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n136_), .c(new_n139_), .O(new_n185_));
  nand2  g123(.a(new_n140_), .b(new_n135_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(new_n83_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n130_), .O(z18));
  nand2  g126(.a(new_n143_), .b(new_n80_), .O(z19));
  inv1   g127(.a(new_n136_), .O(new_n190_));
  ...
  nand3  g131(.a(new_n193_), .b(new_n83_), .c(new_n135_), .O(new_n194_));
