...
module FAU ( 
  ...
  aoi21  g022(.a(new_n84_), .b(x04), .c(new_n78_), .O(z01));
  ...
  nand3  g032(.a(z08), .b(new_n92_), .c(new_n88_), .O(z02));
  nand2  g033(.a(new_n66_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x27), .O(new_n97_));
  aoi21  g035(.a(new_n65_), .b(new_n97_), .c(new_n78_), .O(new_n98_));
  ...
  oai21  g039(.a(new_n89_), .b(new_n97_), .c(new_n65_), .O(new_n102_));
  ...
  nor2   g056(.a(new_n82_), .b(x36), .O(new_n119_));
  aoi21  g057(.a(x40), .b(x39), .c(x06), .O(new_n120_));
  nor2   g058(.a(new_n63_), .b(x39), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(new_n120_), .c(x07), .O(new_n122_));
  nand2  g060(.a(z08), .b(x05), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n119_), .O(new_n124_));
  oai21  g062(.a(x32), .b(x30), .c(x40), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(new_n93_), .O(new_n126_));
  and2   g064(.a(new_n126_), .b(x05), .O(new_n127_));
  aoi21  g065(.a(new_n124_), .b(x27), .c(new_n127_), .O(new_n128_));
  nand4  g066(.a(x40), .b(x37), .c(x27), .d(x06), .O(new_n129_));
  oai21  g067(.a(new_n128_), .b(x04), .c(new_n129_), .O(z10));
  nand2  g068(.a(new_n64_), .b(new_n97_), .O(new_n131_));
  oai21  g069(.a(new_n90_), .b(x04), .c(x40), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(x08), .O(new_n133_));
  nand2  g071(.a(x39), .b(x29), .O(new_n134_));
  nor2   g072(.a(x40), .b(x06), .O(new_n135_));
  aoi21  g073(.a(new_n134_), .b(x40), .c(new_n135_), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n82_), .c(new_n136_), .O(new_n138_));
  ...
  oai21  g079(.a(new_n141_), .b(new_n97_), .c(new_n73_), .O(new_n142_));
  inv1   g080(.a(z08), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x04), .c(new_n68_), .O(new_n144_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n63_), .O(new_n153_));
  nor2   g091(.a(new_n152_), .b(x06), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(x27), .O(new_n155_));
  nand3  g093(.a(new_n126_), .b(new_n146_), .c(new_n71_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n158_));
  nand4  g096(.a(new_n147_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  nand3  g098(.a(z08), .b(new_n146_), .c(new_n71_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  nand3  g100(.a(new_n65_), .b(new_n81_), .c(x28), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x27), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n80_), .c(new_n79_), .O(new_n165_));
  aoi21  g103(.a(new_n161_), .b(new_n68_), .c(new_n78_), .O(new_n166_));
  ...
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(new_n81_), .O(new_n179_));
  inv1   g117(.a(x09), .O(new_n180_));
  nand2  g118(.a(new_n79_), .b(new_n180_), .O(new_n181_));
  aoi21  g119(.a(new_n179_), .b(new_n89_), .c(new_n181_), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n78_), .c(new_n143_), .d(new_n87_), .O(z18));
  inv1   g121(.a(x06), .O(new_n184_));
  nor2   g122(.a(x40), .b(x35), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n91_), .c(new_n184_), .O(new_n186_));
  nand2  g124(.a(new_n137_), .b(new_n89_), .O(new_n187_));
  ...
  oai21  g129(.a(new_n191_), .b(x04), .c(new_n190_), .O(new_n192_));
  nand2  g130(.a(new_n134_), .b(new_n81_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x40), .O(new_n195_));
  nand2  g133(.a(x28), .b(new_n190_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n195_), .c(new_n189_), .d(new_n186_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n79_), .c(new_n180_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n64_), .O(z19));
  aoi21  g137(.a(x28), .b(new_n97_), .c(new_n81_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(new_n136_), .O(new_n201_));
  nand2  g139(.a(x40), .b(new_n81_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n131_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n79_), .O(new_n204_));
