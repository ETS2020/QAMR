...
module FAU ( 
  ...
  aoi21  g091(.a(new_n153_), .b(new_n149_), .c(new_n63_), .O(new_n154_));
  nand4  g092(.a(new_n152_), .b(new_n115_), .c(x20), .d(new_n151_), .O(new_n155_));
  ...
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n146_), .d(new_n72_), .O(new_n159_));
  ...
  aoi22  g102(.a(new_n164_), .b(new_n147_), .c(new_n96_), .d(new_n140_), .O(new_n165_));
  ...
  nand2  g115(.a(x39), .b(x29), .O(new_n178_));
  oai21  g116(.a(new_n83_), .b(x27), .c(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n66_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n89_), .c(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n180_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g121(.a(x09), .O(new_n184_));
  nand2  g122(.a(new_n132_), .b(new_n82_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n178_), .O(new_n186_));
  inv1   g124(.a(x08), .O(new_n187_));
  aoi21  g125(.a(new_n63_), .b(x39), .c(x27), .O(new_n188_));
  nand2  g126(.a(x40), .b(new_n140_), .O(new_n189_));
  nand2  g127(.a(x39), .b(x04), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n189_), .c(new_n82_), .O(new_n191_));
  ...
  nand3  g132(.a(new_n194_), .b(new_n192_), .c(new_n186_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n79_), .c(new_n184_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n64_), .O(z19));
  aoi21  g135(.a(x28), .b(new_n66_), .c(new_n140_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(new_n131_), .O(new_n199_));
  aoi21  g137(.a(new_n189_), .b(new_n134_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n79_), .O(new_n201_));
