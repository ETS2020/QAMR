...
module FAU ( 
  ...
  oai21  g086(.a(new_n119_), .b(x04), .c(new_n69_), .O(new_n149_));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n139_), .O(new_n190_));
  ...
  oai22  g131(.a(new_n193_), .b(new_n79_), .c(new_n119_), .d(new_n90_), .O(z18));
  nand2  g132(.a(x28), .b(new_n100_), .O(new_n195_));
  aoi22  g133(.a(new_n195_), .b(x35), .c(new_n142_), .d(new_n96_), .O(new_n196_));
  nand2  g134(.a(x39), .b(new_n139_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n135_), .c(x08), .O(new_n198_));
