...
module FAU ( 
  ...
  nor2   g041(.a(new_n84_), .b(new_n99_), .O(new_n104_));
  ...
  inv1   g056(.a(new_n96_), .O(new_n119_));
  ...
  nand2  g062(.a(new_n64_), .b(x17), .O(new_n125_));
  ...
  nand2  g074(.a(new_n65_), .b(new_n99_), .O(new_n137_));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n125_), .O(new_n144_));
  ...
  nand3  g089(.a(new_n72_), .b(new_n64_), .c(x17), .O(new_n152_));
  ...
  nand3  g101(.a(new_n134_), .b(new_n154_), .c(new_n75_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand3  g103(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n166_));
  nand4  g104(.a(new_n155_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n96_), .b(new_n154_), .c(new_n75_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n69_), .b(new_n147_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n82_), .c(new_n81_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n72_), .c(new_n66_), .O(new_n174_));
  ...
  nand2  g122(.a(x27), .b(new_n75_), .O(new_n185_));
  nand2  g123(.a(new_n99_), .b(x08), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n147_), .O(new_n187_));
  inv1   g125(.a(x09), .O(new_n188_));
  nand2  g126(.a(new_n81_), .b(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n187_), .b(new_n84_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n66_), .c(new_n119_), .d(new_n91_), .O(z18));
  nand2  g129(.a(new_n143_), .b(new_n140_), .O(new_n192_));
  nand2  g130(.a(new_n96_), .b(x29), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  inv1   g132(.a(x08), .O(new_n195_));
  oai21  g133(.a(new_n185_), .b(new_n85_), .c(new_n195_), .O(new_n196_));
  ...
  inv1   g137(.a(new_n193_), .O(new_n200_));
  oai21  g138(.a(new_n147_), .b(new_n99_), .c(new_n195_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n99_), .c(new_n147_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n81_), .c(new_n188_), .O(new_n204_));
