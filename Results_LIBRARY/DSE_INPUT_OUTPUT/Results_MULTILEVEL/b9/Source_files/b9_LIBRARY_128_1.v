...
module FAU ( 
  ...
  nand2  g030(.a(new_n73_), .b(x31), .O(new_n93_));
  ...
  nor2   g040(.a(new_n82_), .b(new_n64_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n78_), .c(new_n97_), .O(z05));
  ...
  nand4  g050(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n77_), .O(new_n113_));
  ...
  aoi21  g060(.a(new_n122_), .b(x31), .c(new_n108_), .O(z08));
  ...
  oai21  g066(.a(new_n72_), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  ...
  nor2   g085(.a(new_n70_), .b(new_n64_), .O(new_n148_));
  nand3  g086(.a(new_n97_), .b(new_n67_), .c(new_n66_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x27), .c(x10), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n65_), .c(new_n148_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(x31), .O(new_n152_));
  oai21  g090(.a(new_n148_), .b(x40), .c(new_n152_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n108_), .O(new_n156_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n157_), .c(new_n77_), .O(new_n162_));
  nand4  g100(.a(new_n160_), .b(new_n108_), .c(x20), .d(new_n159_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand4  g103(.a(new_n132_), .b(x31), .c(new_n154_), .d(new_n65_), .O(new_n166_));
  ...
  nand3  g108(.a(new_n73_), .b(new_n154_), .c(new_n65_), .O(new_n171_));
  ...
  nand2  g114(.a(new_n171_), .b(new_n176_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n172_), .d(new_n78_), .O(z14));
  ...
  aoi21  g129(.a(new_n189_), .b(new_n82_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n98_), .c(new_n93_), .d(new_n89_), .O(z18));
  nand2  g131(.a(new_n144_), .b(new_n141_), .O(new_n194_));
  nand2  g132(.a(new_n73_), .b(x29), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  inv1   g134(.a(x08), .O(new_n197_));
  oai21  g135(.a(new_n187_), .b(new_n83_), .c(new_n197_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n196_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n190_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n78_), .O(z19));
  inv1   g139(.a(new_n195_), .O(new_n202_));
  oai21  g140(.a(new_n66_), .b(new_n64_), .c(new_n197_), .O(new_n203_));
  aoi21  g141(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n203_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n80_), .c(new_n190_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n78_), .O(z20));
endmodule
