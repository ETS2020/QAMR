...
module FAU ( 
  ...
  aoi21  g069(.a(x39), .b(new_n131_), .c(new_n74_), .O(new_n132_));
  nand2  g070(.a(x27), .b(x04), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n90_), .c(new_n132_), .O(new_n134_));
  ...
  nand3  g079(.a(new_n97_), .b(new_n82_), .c(new_n141_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n125_), .b(x39), .c(new_n147_), .d(new_n72_), .O(new_n159_));
  ...
  aoi22  g102(.a(new_n164_), .b(new_n148_), .c(new_n97_), .d(new_n141_), .O(new_n165_));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n90_), .c(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n180_), .c(new_n64_), .d(new_n80_), .O(z18));
  inv1   g121(.a(x09), .O(new_n184_));
  nand2  g122(.a(new_n133_), .b(new_n83_), .O(new_n185_));
  ...
  nand3  g133(.a(new_n195_), .b(new_n80_), .c(new_n184_), .O(new_n196_));
