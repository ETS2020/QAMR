...
module FAU ( 
  ...
  oai21  g036(.a(x40), .b(x21), .c(new_n98_), .O(z02));
  inv1   g037(.a(x40), .O(new_n100_));
  nor2   g038(.a(x37), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n71_), .b(x27), .c(new_n101_), .O(new_n102_));
  oai21  g040(.a(new_n102_), .b(new_n100_), .c(x21), .O(z03));
  nand2  g041(.a(x40), .b(x21), .O(new_n104_));
  oai21  g042(.a(new_n102_), .b(new_n81_), .c(new_n104_), .O(z04));
  ...
  nand3  g087(.a(new_n149_), .b(new_n100_), .c(new_n80_), .O(new_n150_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n100_), .O(new_n159_));
  nand4  g097(.a(new_n72_), .b(new_n80_), .c(x20), .d(new_n157_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n129_), .b(new_n152_), .c(new_n65_), .O(new_n163_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n149_), .c(new_n81_), .O(new_n173_));
  ...
  oai21  g120(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n183_));
  ...
  nand2  g130(.a(new_n143_), .b(new_n82_), .O(z19));
endmodule
