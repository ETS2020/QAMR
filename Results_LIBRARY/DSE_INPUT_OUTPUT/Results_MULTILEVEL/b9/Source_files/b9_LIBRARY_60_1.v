...
module FAU ( 
  ...
  nand2  g032(.a(new_n94_), .b(x34), .O(new_n95_));
  ...
  aoi21  g061(.a(new_n123_), .b(x34), .c(new_n75_), .O(new_n124_));
  nand4  g062(.a(x40), .b(x39), .c(x34), .d(x05), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(new_n122_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n85_), .c(new_n121_), .O(new_n127_));
  ...
  nor2   g085(.a(new_n75_), .b(new_n123_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n121_), .O(new_n149_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n98_), .O(new_n159_));
  nand4  g097(.a(new_n131_), .b(x39), .c(new_n152_), .d(new_n121_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x34), .c(new_n75_), .O(new_n161_));
  ...
  nand3  g102(.a(x39), .b(new_n152_), .c(new_n121_), .O(new_n165_));
  ...
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n169_), .O(new_n188_));
  ...
  nand2  g129(.a(new_n148_), .b(x34), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n90_), .c(new_n191_), .d(new_n65_), .O(z18));
  ...
  oai21  g135(.a(new_n197_), .b(new_n143_), .c(new_n80_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z19));
  inv1   g137(.a(x08), .O(new_n200_));
  oai21  g138(.a(new_n169_), .b(new_n98_), .c(new_n200_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n98_), .c(new_n169_), .O(new_n202_));
  nand2  g140(.a(new_n148_), .b(x29), .O(new_n203_));
  inv1   g141(.a(new_n203_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n201_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n80_), .c(new_n189_), .O(new_n206_));
