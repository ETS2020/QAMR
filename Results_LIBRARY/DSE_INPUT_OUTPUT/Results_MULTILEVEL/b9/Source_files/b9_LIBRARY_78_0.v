...
module FAU ( 
  ...
  nand3  g018(.a(new_n80_), .b(new_n77_), .c(x16), .O(z00));
  ...
  nand3  g032(.a(new_n94_), .b(new_n90_), .c(x40), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x39), .O(new_n96_));
  nand2  g034(.a(x40), .b(new_n78_), .O(new_n97_));
  ...
  nor2   g043(.a(new_n105_), .b(new_n100_), .O(z05));
  ...
  nand2  g070(.a(new_n83_), .b(new_n82_), .O(new_n133_));
  ...
  oai21  g074(.a(new_n131_), .b(new_n64_), .c(new_n136_), .O(z10));
  nand2  g075(.a(new_n80_), .b(new_n64_), .O(new_n138_));
  nand3  g076(.a(x35), .b(new_n91_), .c(new_n65_), .O(new_n139_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n84_), .c(new_n143_), .d(new_n97_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n141_), .c(new_n82_), .O(new_n146_));
  ...
  aoi22  g087(.a(new_n72_), .b(x27), .c(x40), .d(new_n65_), .O(new_n150_));
  ...
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n79_), .O(new_n157_));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n65_), .c(new_n100_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(z13));
  inv1   g104(.a(new_n97_), .O(new_n167_));
  nand3  g105(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n168_));
  nand4  g106(.a(new_n156_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n169_));
  nand3  g107(.a(x40), .b(new_n155_), .c(new_n65_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n78_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n167_), .c(new_n168_), .O(new_n173_));
  nand3  g111(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n83_), .c(new_n82_), .O(new_n176_));
  nand2  g114(.a(new_n170_), .b(new_n152_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x39), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n173_), .c(new_n153_), .O(z14));
  nand4  g118(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n80_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand4  g121(.a(new_n80_), .b(new_n183_), .c(x22), .d(x01), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z16));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(x23), .c(x22), .d(x01), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n80_), .O(z17));
  ...
  nand2  g130(.a(new_n82_), .b(new_n192_), .O(new_n193_));
  aoi21  g131(.a(new_n191_), .b(new_n91_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n100_), .c(new_n89_), .d(new_n119_), .O(z18));
  nand2  g133(.a(new_n144_), .b(new_n84_), .O(new_n196_));
  nand3  g134(.a(x40), .b(x39), .c(x29), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  inv1   g136(.a(x08), .O(new_n199_));
  oai21  g137(.a(new_n189_), .b(new_n92_), .c(new_n199_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n198_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n82_), .c(new_n192_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n80_), .O(z19));
  inv1   g141(.a(new_n197_), .O(new_n204_));
  oai21  g142(.a(new_n66_), .b(new_n64_), .c(new_n199_), .O(new_n205_));
  aoi21  g143(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n204_), .c(new_n205_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n82_), .c(new_n192_), .O(new_n208_));
  nand2  g146(.a(new_n208_), .b(new_n80_), .O(z20));
endmodule
