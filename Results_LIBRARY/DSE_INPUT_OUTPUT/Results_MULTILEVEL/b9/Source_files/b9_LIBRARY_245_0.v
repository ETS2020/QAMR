...
module FAU ( 
  ...
  nand2  g037(.a(new_n81_), .b(x14), .O(new_n100_));
  ...
  nand4  g053(.a(new_n115_), .b(new_n112_), .c(new_n111_), .d(x14), .O(new_n116_));
  inv1   g054(.a(x00), .O(new_n117_));
  nand3  g055(.a(x38), .b(new_n113_), .c(new_n117_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(x40), .c(new_n80_), .O(new_n119_));
  ...
  nand2  g070(.a(new_n82_), .b(new_n64_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n87_), .c(new_n65_), .O(new_n134_));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n137_), .c(new_n139_), .d(new_n100_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n136_), .c(new_n85_), .O(new_n142_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n82_), .O(z12));
  ...
  inv1   g100(.a(new_n100_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n164_));
  nand4  g102(.a(new_n151_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n165_));
  ...
  nand3  g113(.a(new_n147_), .b(new_n81_), .c(x14), .O(new_n176_));
  ...
  nand2  g128(.a(new_n85_), .b(new_n190_), .O(new_n191_));
  aoi21  g129(.a(new_n189_), .b(new_n87_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n84_), .c(new_n94_), .d(new_n75_), .O(z18));
  nand2  g131(.a(x28), .b(new_n64_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(x35), .c(new_n139_), .d(new_n100_), .O(new_n195_));
  nand2  g133(.a(x40), .b(new_n66_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n133_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n85_), .O(new_n198_));
