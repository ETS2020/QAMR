...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n75_), .c(new_n80_), .O(new_n91_));
  nor2   g029(.a(x27), .b(x08), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n85_), .c(new_n82_), .O(new_n93_));
  oai21  g031(.a(new_n93_), .b(new_n65_), .c(new_n91_), .O(z02));
  inv1   g032(.a(new_n80_), .O(new_n95_));
  ...
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n80_), .d(new_n97_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n70_), .c(new_n95_), .O(z05));
  ...
  nand3  g063(.a(new_n76_), .b(x32), .c(x05), .O(new_n126_));
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n122_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x29), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(new_n133_));
  nand2  g071(.a(new_n85_), .b(new_n82_), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n84_), .c(x27), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n82_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n65_), .c(x08), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n136_), .c(new_n131_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n80_), .O(z11));
  ...
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n80_), .O(z12));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(x04), .O(new_n155_));
  nand4  g093(.a(new_n72_), .b(new_n82_), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  inv1   g096(.a(x40), .O(new_n159_));
  aoi21  g097(.a(new_n83_), .b(new_n82_), .c(new_n159_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n163_));
  nand3  g101(.a(new_n149_), .b(new_n83_), .c(x28), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n65_), .c(x30), .O(new_n165_));
  aoi21  g103(.a(new_n76_), .b(new_n148_), .c(x04), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  aoi21  g105(.a(x32), .b(new_n65_), .c(x27), .O(new_n168_));
  nand2  g106(.a(new_n71_), .b(x04), .O(new_n169_));
  nand3  g107(.a(new_n66_), .b(new_n83_), .c(x28), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n169_), .c(x37), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n168_), .c(new_n82_), .O(new_n172_));
  nand2  g110(.a(new_n76_), .b(new_n148_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n145_), .c(new_n65_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n172_), .c(new_n167_), .O(z14));
  ...
  oai21  g122(.a(new_n85_), .b(x27), .c(new_n132_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nand4  g124(.a(x35), .b(new_n84_), .c(x27), .d(new_n65_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n82_), .d(new_n131_), .O(z18));
  nand3  g126(.a(new_n135_), .b(x35), .c(new_n84_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n132_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  nand2  g129(.a(new_n187_), .b(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n82_), .c(new_n131_), .O(new_n194_));
  inv1   g132(.a(new_n194_), .O(z19));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(new_n191_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n133_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n82_), .c(new_n131_), .O(new_n199_));
