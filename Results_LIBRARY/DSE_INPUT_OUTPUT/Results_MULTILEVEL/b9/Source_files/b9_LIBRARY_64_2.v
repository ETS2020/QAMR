...
module FAU ( 
  ...
  inv1   g012(.a(x19), .O(new_n75_));
  nor2   g013(.a(x22), .b(new_n75_), .O(new_n76_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n65_), .c(new_n76_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  aoi21  g097(.a(x20), .b(new_n150_), .c(x19), .O(new_n160_));
  and2   g098(.a(x22), .b(x19), .O(new_n161_));
  ...
  oai22  g102(.a(new_n164_), .b(new_n163_), .c(new_n161_), .d(new_n160_), .O(new_n165_));
  ...
  nand4  g109(.a(new_n80_), .b(new_n79_), .c(new_n64_), .d(x22), .O(new_n172_));
