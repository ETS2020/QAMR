...
module FAU ( 
  ...
  aoi21  g031(.a(new_n93_), .b(new_n89_), .c(new_n63_), .O(z02));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n66_), .c(new_n63_), .O(z05));
  inv1   g041(.a(new_n63_), .O(new_n104_));
  nand3  g042(.a(new_n102_), .b(new_n104_), .c(new_n66_), .O(new_n105_));
  ...
  nand2  g054(.a(new_n116_), .b(new_n104_), .O(z07));
  nand2  g055(.a(new_n92_), .b(new_n104_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n104_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  ...
  nor2   g072(.a(new_n97_), .b(new_n122_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n82_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n81_), .c(x27), .d(new_n122_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n104_), .c(new_n78_), .d(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nand3  g080(.a(x40), .b(x39), .c(new_n122_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n67_), .O(new_n144_));
  inv1   g082(.a(x35), .O(new_n145_));
  nand3  g083(.a(new_n80_), .b(new_n145_), .c(new_n72_), .O(new_n146_));
  ...
  nand3  g087(.a(new_n143_), .b(new_n69_), .c(x10), .O(new_n150_));
  ...
  nand3  g094(.a(new_n68_), .b(x20), .c(new_n73_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x18), .c(new_n156_), .O(new_n158_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n122_), .c(new_n63_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  inv1   g101(.a(x18), .O(new_n164_));
  aoi21  g102(.a(x20), .b(new_n164_), .c(new_n72_), .O(new_n165_));
  nand4  g103(.a(new_n154_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand4  g105(.a(x40), .b(x39), .c(new_n152_), .d(new_n122_), .O(new_n168_));
  oai22  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .d(x19), .O(new_n169_));
  nand3  g107(.a(new_n66_), .b(new_n145_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n79_), .c(new_n78_), .O(new_n172_));
  nand2  g110(.a(new_n168_), .b(new_n69_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x10), .O(new_n175_));
  nand4  g113(.a(new_n79_), .b(new_n78_), .c(new_n97_), .d(x19), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  nand4  g115(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n104_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand4  g118(.a(new_n104_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  inv1   g119(.a(new_n181_), .O(z16));
  inv1   g120(.a(x01), .O(new_n183_));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n104_), .b(new_n184_), .c(x23), .d(x22), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n183_), .O(z17));
  oai21  g124(.a(new_n82_), .b(x27), .c(new_n134_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n63_), .b(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n138_), .d(new_n78_), .O(z18));
  inv1   g128(.a(new_n134_), .O(new_n191_));
  oai21  g129(.a(new_n145_), .b(new_n97_), .c(new_n137_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n97_), .c(new_n145_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n104_), .c(new_n78_), .d(new_n133_), .O(new_n195_));
