...
module FAU ( 
  ...
  nand2  g017(.a(x30), .b(x13), .O(new_n80_));
  ...
  oai21  g028(.a(new_n83_), .b(x04), .c(new_n90_), .O(z01));
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n80_), .d(new_n76_), .O(z02));
  nand2  g035(.a(new_n71_), .b(x27), .O(new_n98_));
  nand2  g036(.a(new_n70_), .b(new_n64_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n98_), .c(new_n80_), .d(x21), .O(z03));
  aoi21  g038(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n83_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n70_), .c(new_n83_), .O(z05));
  ...
  nand2  g055(.a(new_n80_), .b(new_n75_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n119_), .O(z09));
  inv1   g059(.a(x13), .O(new_n122_));
  nand2  g060(.a(x05), .b(new_n65_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n75_), .c(new_n122_), .O(new_n124_));
  ...
  nand3  g067(.a(new_n76_), .b(x32), .c(x05), .O(new_n130_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n87_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand4  g077(.a(x35), .b(new_n86_), .c(x27), .d(new_n65_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n84_), .c(new_n135_), .O(new_n143_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n80_), .O(z12));
  inv1   g088(.a(x40), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n151_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n122_), .d(new_n65_), .O(new_n154_));
  ...
  oai21  g097(.a(new_n85_), .b(x13), .c(new_n84_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x40), .c(x39), .d(new_n65_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n80_), .O(z13));
  ...
  nand3  g103(.a(new_n76_), .b(new_n122_), .c(new_n65_), .O(new_n166_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n148_), .c(new_n83_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nor2   g111(.a(new_n120_), .b(new_n173_), .O(z15));
  ...
  oai21  g119(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n140_), .c(new_n84_), .d(new_n135_), .O(z18));
  nand2  g122(.a(new_n143_), .b(new_n80_), .O(z19));
  inv1   g123(.a(new_n136_), .O(new_n186_));
  oai21  g124(.a(new_n66_), .b(new_n64_), .c(new_n139_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n84_), .c(new_n135_), .O(new_n190_));
