...
module FAU ( 
  ...
  nor2   g017(.a(x26), .b(x19), .O(new_n80_));
  ...
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(new_n80_), .O(z10));
  ...
  nand4  g080(.a(new_n142_), .b(new_n81_), .c(new_n83_), .d(new_n135_), .O(new_n143_));
  ...
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(x26), .O(new_n159_));
  aoi21  g097(.a(new_n151_), .b(x28), .c(new_n64_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n129_), .c(x40), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(new_n118_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x19), .c(new_n150_), .d(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n159_), .O(z13));
  inv1   g102(.a(x26), .O(new_n165_));
  aoi21  g103(.a(x20), .b(new_n154_), .c(new_n165_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n167_));
  ...
  oai21  g124(.a(new_n86_), .b(x27), .c(new_n136_), .O(new_n187_));
  nand3  g125(.a(new_n140_), .b(new_n83_), .c(new_n135_), .O(new_n188_));
  ...
  nand2  g129(.a(new_n136_), .b(new_n66_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n80_), .O(new_n193_));
  oai21  g131(.a(x28), .b(x04), .c(new_n139_), .O(new_n194_));
  oai21  g132(.a(new_n137_), .b(x28), .c(new_n136_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n83_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(x09), .c(new_n81_), .O(z19));
  ...
  nand4  g139(.a(new_n201_), .b(new_n81_), .c(new_n83_), .d(new_n135_), .O(new_n202_));
