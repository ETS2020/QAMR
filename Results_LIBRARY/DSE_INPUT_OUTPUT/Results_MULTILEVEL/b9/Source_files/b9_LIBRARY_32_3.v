...
module FAU ( 
  ...
  oai22  g015(.a(new_n77_), .b(x03), .c(new_n72_), .d(new_n65_), .O(z00));
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(new_n63_), .O(z02));
  ...
  nand3  g042(.a(new_n104_), .b(new_n79_), .c(new_n69_), .O(z05));
  oai21  g043(.a(new_n103_), .b(x37), .c(new_n79_), .O(z06));
  ...
  aoi21  g057(.a(new_n119_), .b(new_n63_), .c(new_n64_), .O(z08));
  ...
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n79_), .O(z10));
  ...
  nand2  g075(.a(new_n95_), .b(x29), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x35), .c(new_n83_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  oai21  g079(.a(new_n84_), .b(new_n68_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n80_), .c(new_n134_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n137_), .O(z11));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n69_), .b(new_n82_), .c(new_n146_), .O(new_n147_));
  ...
  nand2  g089(.a(new_n151_), .b(new_n64_), .O(new_n152_));
  ...
  nand4  g101(.a(new_n127_), .b(x39), .c(new_n154_), .d(new_n73_), .O(new_n164_));
  ...
  inv1   g126(.a(new_n84_), .O(new_n189_));
  nor2   g127(.a(new_n68_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n79_), .d(new_n134_), .O(z18));
  aoi21  g130(.a(x40), .b(x03), .c(x27), .O(new_n193_));
  nand3  g131(.a(x35), .b(new_n83_), .c(new_n73_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n63_), .c(new_n193_), .O(new_n195_));
  aoi21  g133(.a(x39), .b(x29), .c(x03), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n64_), .c(new_n140_), .O(new_n197_));
  oai21  g135(.a(new_n195_), .b(x08), .c(new_n197_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n80_), .c(new_n134_), .O(new_n199_));
  inv1   g137(.a(new_n199_), .O(z19));
  nor2   g138(.a(new_n196_), .b(new_n64_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n68_), .c(new_n146_), .O(new_n202_));
  aoi21  g140(.a(x35), .b(x27), .c(x03), .O(new_n203_));
  nor2   g141(.a(x40), .b(x27), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n203_), .c(new_n133_), .O(new_n205_));
  oai21  g143(.a(new_n202_), .b(new_n201_), .c(new_n205_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n80_), .c(new_n134_), .O(new_n207_));
