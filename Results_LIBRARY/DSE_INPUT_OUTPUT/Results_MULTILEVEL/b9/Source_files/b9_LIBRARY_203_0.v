...
module FAU ( 
  ...
  oai21  g024(.a(new_n86_), .b(x32), .c(x25), .O(new_n87_));
  ...
  nor2   g034(.a(x30), .b(x25), .O(new_n97_));
  ...
  nand3  g043(.a(new_n104_), .b(new_n82_), .c(new_n70_), .O(new_n106_));
  ...
  nand3  g050(.a(x38), .b(new_n80_), .c(new_n110_), .O(new_n113_));
  ...
  nand3  g060(.a(new_n82_), .b(new_n75_), .c(x07), .O(new_n123_));
  nand3  g061(.a(new_n76_), .b(x25), .c(x05), .O(new_n124_));
  ...
  aoi21  g065(.a(x32), .b(x25), .c(x30), .O(new_n128_));
  nor3   g066(.a(new_n128_), .b(new_n119_), .c(new_n118_), .O(new_n129_));
  ...
  aoi21  g079(.a(new_n141_), .b(x25), .c(x30), .O(z11));
  ...
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n119_), .O(new_n151_));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(new_n80_), .O(new_n156_));
  nand4  g094(.a(new_n72_), .b(x30), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n129_), .b(new_n149_), .c(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  nand3  g100(.a(new_n76_), .b(new_n149_), .c(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n82_), .O(new_n164_));
  aoi21  g102(.a(x36), .b(x35), .c(x32), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n81_), .c(x28), .d(x25), .O(new_n166_));
  ...
  nand2  g108(.a(new_n170_), .b(new_n81_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  and2   g110(.a(new_n163_), .b(new_n146_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(x25), .O(new_n174_));
  ...
  nand2  g122(.a(new_n93_), .b(new_n64_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n133_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n80_), .b(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n138_), .d(new_n81_), .O(z18));
  nand4  g127(.a(new_n140_), .b(new_n81_), .c(x25), .d(new_n132_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z19));
  inv1   g129(.a(new_n133_), .O(new_n192_));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n81_), .c(x25), .d(new_n132_), .O(new_n196_));
