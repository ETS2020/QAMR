...
module FAU ( 
  ...
  nor2   g032(.a(new_n75_), .b(new_n63_), .O(z08));
  nand3  g033(.a(z08), .b(new_n94_), .c(new_n92_), .O(z02));
  nand2  g034(.a(new_n68_), .b(x27), .O(new_n97_));
  aoi22  g035(.a(x40), .b(new_n63_), .c(new_n67_), .d(new_n66_), .O(new_n98_));
  ...
  nor2   g039(.a(new_n83_), .b(new_n66_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n64_), .c(new_n67_), .O(z05));
  ...
  nand2  g065(.a(new_n127_), .b(new_n73_), .O(new_n128_));
  ...
  aoi21  g069(.a(x39), .b(new_n91_), .c(new_n75_), .O(new_n132_));
  nand2  g070(.a(x27), .b(x04), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n131_), .c(new_n132_), .O(new_n134_));
  nand2  g072(.a(new_n64_), .b(new_n66_), .O(new_n135_));
  ...
  oai21  g076(.a(new_n138_), .b(new_n134_), .c(new_n80_), .O(new_n139_));
  nor2   g077(.a(new_n139_), .b(x09), .O(z11));
  inv1   g078(.a(x35), .O(new_n141_));
  nand3  g079(.a(new_n67_), .b(new_n82_), .c(new_n141_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n125_), .b(x39), .c(new_n147_), .d(new_n73_), .O(new_n159_));
  ...
  nand2  g123(.a(new_n133_), .b(new_n83_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n179_), .O(new_n187_));
  aoi21  g125(.a(x40), .b(new_n63_), .c(x27), .O(new_n188_));
  nand2  g126(.a(x39), .b(new_n141_), .O(new_n189_));
  ...
  aoi21  g135(.a(x28), .b(new_n66_), .c(new_n141_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(new_n132_), .O(new_n199_));
  aoi21  g137(.a(new_n189_), .b(new_n135_), .c(x08), .O(new_n200_));
