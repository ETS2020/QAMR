...
module FAU ( 
  ...
  nand3  g061(.a(new_n76_), .b(x05), .c(new_n83_), .O(new_n124_));
  aoi22  g062(.a(new_n124_), .b(new_n123_), .c(new_n93_), .d(new_n67_), .O(new_n125_));
  inv1   g063(.a(x06), .O(new_n126_));
  nor3   g064(.a(new_n84_), .b(new_n70_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n65_), .c(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n85_), .b(x02), .c(new_n80_), .O(new_n129_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n93_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n86_), .b(x27), .c(new_n65_), .O(new_n139_));
  ...
  aoi21  g080(.a(new_n142_), .b(new_n83_), .c(x30), .O(z11));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n84_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(x02), .O(new_n157_));
  nand4  g095(.a(new_n72_), .b(x30), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n131_), .b(new_n150_), .c(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand3  g100(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  nand3  g101(.a(new_n76_), .b(new_n150_), .c(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n81_), .O(new_n165_));
  aoi21  g103(.a(x36), .b(x35), .c(x32), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n80_), .c(x28), .d(new_n83_), .O(new_n167_));
  ...
  nand3  g109(.a(new_n171_), .b(new_n85_), .c(new_n80_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  and2   g111(.a(new_n164_), .b(new_n147_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(new_n83_), .O(new_n175_));
  ...
  oai21  g123(.a(new_n93_), .b(x27), .c(new_n135_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(x09), .b(x02), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n139_), .d(new_n80_), .O(z18));
  nand4  g127(.a(new_n141_), .b(new_n80_), .c(new_n134_), .d(new_n83_), .O(new_n190_));
  ...
  aoi21  g134(.a(new_n196_), .b(new_n83_), .c(x30), .O(z20));
endmodule
