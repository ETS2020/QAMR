...
module FAU ( 
  ...
  nor2   g031(.a(x39), .b(x09), .O(new_n94_));
  ...
  aoi21  g074(.a(new_n136_), .b(new_n135_), .c(new_n63_), .O(new_n137_));
  oai21  g075(.a(new_n98_), .b(new_n71_), .c(new_n83_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(new_n139_));
  inv1   g077(.a(x08), .O(new_n140_));
  nand3  g078(.a(new_n83_), .b(x27), .c(new_n71_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n135_), .c(new_n140_), .O(new_n142_));
  oai21  g080(.a(new_n139_), .b(new_n137_), .c(new_n142_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n79_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n64_), .O(z11));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n98_), .c(new_n73_), .O(new_n147_));
  nand2  g085(.a(z08), .b(new_n71_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n68_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n64_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x28), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x40), .c(new_n151_), .d(new_n71_), .O(new_n154_));
  ...
  nand3  g119(.a(new_n83_), .b(new_n98_), .c(new_n135_), .O(new_n182_));
  nand2  g120(.a(z08), .b(x29), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nand2  g123(.a(new_n141_), .b(new_n79_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n135_), .O(new_n187_));
  nand2  g125(.a(x39), .b(x09), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n187_), .c(new_n185_), .O(z18));
  inv1   g127(.a(new_n183_), .O(new_n190_));
  nand2  g128(.a(new_n141_), .b(new_n140_), .O(new_n191_));
  oai21  g129(.a(new_n190_), .b(new_n139_), .c(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n79_), .c(new_n135_), .O(new_n193_));
  inv1   g131(.a(new_n193_), .O(z19));
  oai21  g132(.a(new_n82_), .b(new_n98_), .c(new_n140_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n98_), .c(new_n82_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n190_), .c(new_n195_), .O(new_n197_));
