...
module FAU ( 
  ...
  nand3  g038(.a(new_n100_), .b(new_n78_), .c(new_n69_), .O(z05));
  ...
  nand3  g061(.a(new_n93_), .b(x32), .c(x05), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n119_), .O(new_n126_));
  ...
  nand4  g091(.a(x39), .b(x32), .c(new_n144_), .d(new_n119_), .O(new_n154_));
  ...
  nand3  g096(.a(new_n145_), .b(new_n79_), .c(x28), .O(new_n159_));
  nand3  g097(.a(x39), .b(new_n144_), .c(new_n119_), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n159_), .c(x30), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n64_), .c(new_n158_), .O(new_n163_));
  inv1   g101(.a(x35), .O(new_n164_));
  nand3  g102(.a(new_n69_), .b(new_n164_), .c(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(x27), .c(x32), .O(new_n166_));
  nor2   g104(.a(new_n161_), .b(new_n71_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n63_), .O(new_n168_));
  nand2  g106(.a(new_n141_), .b(new_n64_), .O(new_n169_));
  ...
  nand3  g118(.a(x35), .b(new_n81_), .c(new_n68_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n130_), .c(new_n133_), .O(new_n182_));
  nand2  g120(.a(new_n134_), .b(new_n129_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n182_), .c(new_n63_), .O(new_n184_));
  oai21  g122(.a(x40), .b(new_n63_), .c(new_n184_), .O(z18));
  inv1   g123(.a(new_n130_), .O(new_n186_));
  oai21  g124(.a(new_n164_), .b(new_n68_), .c(new_n133_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n68_), .c(new_n164_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n63_), .c(new_n129_), .O(new_n190_));
