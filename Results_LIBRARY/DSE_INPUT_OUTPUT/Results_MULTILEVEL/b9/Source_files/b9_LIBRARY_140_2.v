...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x34), .O(new_n81_));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n101_), .O(z05));
  ...
  nor2   g057(.a(new_n119_), .b(new_n80_), .O(z09));
  ...
  inv1   g085(.a(x34), .O(new_n148_));
  nand2  g086(.a(new_n72_), .b(x27), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n80_), .c(new_n148_), .O(new_n150_));
  ...
  nand4  g097(.a(new_n72_), .b(new_n148_), .c(x20), .d(new_n157_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n127_), .b(new_n152_), .c(new_n65_), .O(new_n163_));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n80_), .O(new_n169_));
  nor2   g107(.a(x40), .b(x34), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n165_), .O(new_n171_));
  ...
  nand2  g112(.a(new_n167_), .b(new_n149_), .O(new_n175_));
  ...
  aoi21  g117(.a(new_n179_), .b(x40), .c(new_n148_), .O(z15));
  ...
  nor2   g126(.a(new_n101_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n139_), .d(new_n133_), .O(z18));
  nand2  g128(.a(new_n81_), .b(new_n64_), .O(new_n191_));
  nand3  g129(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x40), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n191_), .c(x08), .O(new_n194_));
  inv1   g132(.a(new_n170_), .O(new_n195_));
  oai21  g133(.a(new_n125_), .b(new_n93_), .c(x40), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(new_n195_), .c(new_n136_), .d(new_n135_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n83_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z19));
  inv1   g137(.a(new_n134_), .O(new_n200_));
  oai21  g138(.a(new_n66_), .b(new_n64_), .c(new_n92_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n83_), .c(new_n133_), .O(new_n204_));
