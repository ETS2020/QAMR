...
module FAU ( 
  ...
  oai21  g23(.a(new_n85_), .b(new_n64_), .c(new_n65_), .O(new_n86_));
  ...
  nand4  g51(.a(new_n113_), .b(new_n111_), .c(x35), .d(new_n85_), .O(new_n114_));
  ...
  nand3  g56(.a(new_n67_), .b(x20), .c(new_n118_), .O(new_n119_));
  oai21  g57(.a(new_n119_), .b(x18), .c(z02), .O(z13));
  nand2  g58(.a(new_n66_), .b(new_n65_), .O(new_n121_));
  nor2   g59(.a(x19), .b(x18), .O(new_n122_));
  nor2   g60(.a(z08), .b(new_n64_), .O(new_n123_));
  ...
  oai21  g73(.a(x27), .b(new_n112_), .c(new_n135_), .O(new_n136_));
  nand3  g74(.a(new_n136_), .b(x35), .c(new_n85_), .O(new_n137_));
  nand4  g75(.a(new_n137_), .b(z02), .c(new_n71_), .d(new_n110_), .O(z18));
  oai21  g76(.a(x28), .b(new_n112_), .c(new_n64_), .O(new_n139_));
