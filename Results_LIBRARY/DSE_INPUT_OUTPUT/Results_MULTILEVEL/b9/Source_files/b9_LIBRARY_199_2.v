...
module FAU ( 
  ...
  nor2   g030(.a(x40), .b(x30), .O(new_n93_));
  ...
  aoi21  g038(.a(new_n65_), .b(new_n97_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n100_), .O(z04));
  inv1   g040(.a(x28), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(new_n97_), .c(new_n65_), .O(new_n104_));
  ...
  aoi21  g062(.a(x40), .b(new_n124_), .c(new_n93_), .O(new_n125_));
  nand2  g063(.a(z08), .b(x05), .O(new_n126_));
  oai21  g064(.a(new_n125_), .b(new_n123_), .c(new_n126_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n84_), .c(new_n71_), .O(new_n128_));
  ...
  aoi21  g069(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(x39), .c(x05), .d(new_n71_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  inv1   g073(.a(x29), .O(new_n136_));
  nor2   g074(.a(new_n124_), .b(new_n136_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(x30), .c(x40), .O(new_n138_));
  oai21  g076(.a(new_n97_), .b(new_n71_), .c(new_n82_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  inv1   g078(.a(x08), .O(new_n141_));
  nor2   g079(.a(new_n97_), .b(x04), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n82_), .c(x30), .O(new_n143_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n97_), .c(new_n73_), .O(new_n149_));
  oai21  g087(.a(new_n118_), .b(x04), .c(new_n68_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n64_), .O(z12));
  ...
  nand4  g095(.a(new_n67_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x27), .O(new_n160_));
  oai21  g098(.a(new_n63_), .b(new_n79_), .c(new_n78_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n152_), .d(new_n71_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n160_), .c(new_n64_), .O(z13));
  ...
  nand3  g104(.a(z08), .b(new_n152_), .c(new_n71_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n65_), .b(new_n81_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n79_), .c(new_n78_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n68_), .c(new_n100_), .O(new_n172_));
  ...
  oai22  g120(.a(new_n118_), .b(new_n136_), .c(new_n83_), .d(x27), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n143_), .c(new_n135_), .O(z18));
  oai21  g123(.a(new_n103_), .b(x27), .c(x35), .O(new_n186_));
  oai21  g124(.a(new_n81_), .b(new_n97_), .c(new_n141_), .O(new_n187_));
  oai21  g125(.a(new_n124_), .b(new_n136_), .c(new_n186_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  aoi22  g127(.a(new_n189_), .b(new_n78_), .c(new_n186_), .d(new_n63_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(x09), .c(new_n64_), .O(z20));
  nand2  g129(.a(new_n146_), .b(new_n64_), .O(z19));
endmodule
