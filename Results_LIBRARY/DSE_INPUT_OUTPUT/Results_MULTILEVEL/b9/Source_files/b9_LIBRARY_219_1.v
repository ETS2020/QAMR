...
module FAU ( 
  ...
  nor2   g016(.a(new_n78_), .b(x13), .O(new_n79_));
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n73_), .d(x13), .O(z02));
  inv1   g033(.a(new_n79_), .O(new_n96_));
  oai21  g034(.a(new_n66_), .b(new_n84_), .c(x27), .O(new_n97_));
  ...
  nand3  g041(.a(new_n103_), .b(new_n96_), .c(new_n98_), .O(z05));
  ...
  nand3  g053(.a(new_n115_), .b(new_n96_), .c(x03), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z07));
  nand3  g055(.a(x40), .b(x39), .c(x13), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n96_), .O(z09));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n96_), .O(z10));
  inv1   g069(.a(x08), .O(new_n132_));
  inv1   g070(.a(x09), .O(new_n133_));
  nand4  g071(.a(new_n82_), .b(new_n133_), .c(new_n132_), .d(x04), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x13), .O(new_n135_));
  ...
  oai21  g077(.a(new_n85_), .b(new_n64_), .c(new_n132_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n82_), .c(new_n133_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n96_), .O(z12));
  inv1   g086(.a(x19), .O(new_n149_));
  inv1   g087(.a(new_n70_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x27), .c(x20), .d(new_n149_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(x18), .c(new_n96_), .O(z13));
  nor2   g090(.a(x19), .b(x18), .O(new_n153_));
  nor2   g091(.a(new_n79_), .b(new_n64_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n153_), .c(new_n150_), .d(x20), .O(z14));
  nand4  g093(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n96_), .O(z15));
  inv1   g095(.a(x23), .O(new_n158_));
  nand4  g096(.a(new_n96_), .b(new_n158_), .c(x22), .d(x01), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x23), .c(x22), .d(x01), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n96_), .O(z17));
  oai21  g101(.a(new_n85_), .b(x27), .c(new_n137_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nor2   g103(.a(new_n79_), .b(x09), .O(new_n166_));
  nand4  g104(.a(x35), .b(new_n84_), .c(x27), .d(new_n65_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(new_n82_), .O(z18));
  nand2  g106(.a(new_n167_), .b(new_n132_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n139_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n82_), .c(new_n133_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n96_), .O(z19));
  inv1   g110(.a(new_n137_), .O(new_n173_));
  ...
  nand3  g114(.a(new_n176_), .b(new_n82_), .c(new_n133_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n96_), .O(z20));
endmodule
