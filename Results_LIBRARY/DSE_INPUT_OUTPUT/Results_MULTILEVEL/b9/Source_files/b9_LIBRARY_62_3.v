...
module FAU ( 
  ...
  nand2  g000(.a(x40), .b(x03), .O(new_n63_));
  ...
  oai22  g015(.a(new_n77_), .b(x03), .c(new_n71_), .d(new_n64_), .O(z00));
  ...
  aoi21  g050(.a(new_n112_), .b(new_n110_), .c(x40), .O(new_n113_));
  aoi21  g051(.a(new_n113_), .b(new_n109_), .c(new_n88_), .O(z07));
  nand3  g052(.a(x40), .b(x39), .c(new_n88_), .O(new_n115_));
  ...
  oai21  g059(.a(new_n120_), .b(new_n119_), .c(new_n121_), .O(new_n122_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n63_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(new_n88_), .c(new_n63_), .d(new_n67_), .O(new_n134_));
  aoi21  g072(.a(x39), .b(x29), .c(x03), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(x35), .c(new_n82_), .O(new_n137_));
  oai21  g075(.a(new_n135_), .b(new_n74_), .c(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n134_), .b(x08), .c(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n79_), .c(new_n132_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z11));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n68_), .b(new_n81_), .c(new_n142_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  aoi21  g082(.a(x39), .b(new_n72_), .c(new_n70_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n88_), .O(new_n146_));
  oai21  g084(.a(new_n70_), .b(x40), .c(new_n146_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n74_), .O(new_n150_));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n151_), .c(x03), .O(new_n156_));
  nand4  g094(.a(new_n154_), .b(new_n74_), .c(x20), .d(new_n153_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand4  g097(.a(new_n126_), .b(new_n148_), .c(new_n72_), .d(new_n88_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n162_));
  nand4  g100(.a(new_n149_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  inv1   g102(.a(new_n120_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n148_), .c(new_n72_), .O(new_n166_));
  ...
  nand2  g120(.a(new_n165_), .b(x29), .O(new_n183_));
  oai21  g121(.a(new_n83_), .b(x27), .c(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n64_), .b(x09), .O(new_n186_));
  nand4  g124(.a(x35), .b(new_n82_), .c(x27), .d(new_n72_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n79_), .O(z18));
  nand2  g126(.a(new_n183_), .b(new_n137_), .O(new_n189_));
  inv1   g127(.a(x08), .O(new_n190_));
  nand2  g128(.a(new_n187_), .b(new_n190_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n79_), .c(new_n132_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n63_), .O(z19));
  inv1   g132(.a(new_n183_), .O(new_n195_));
  oai21  g133(.a(new_n142_), .b(new_n67_), .c(new_n190_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n67_), .c(new_n142_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n132_), .O(new_n199_));
