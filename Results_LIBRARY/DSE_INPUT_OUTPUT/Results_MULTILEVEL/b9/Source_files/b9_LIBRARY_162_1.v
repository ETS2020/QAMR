...
module FAU ( 
  ...
  nor2   g027(.a(new_n89_), .b(x28), .O(new_n90_));
  ...
  aoi22  g033(.a(x40), .b(new_n63_), .c(new_n65_), .d(new_n95_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n94_), .c(x21), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  nand3  g036(.a(new_n96_), .b(new_n94_), .c(new_n98_), .O(z04));
  oai21  g037(.a(new_n82_), .b(new_n95_), .c(new_n65_), .O(new_n100_));
  and2   g038(.a(new_n100_), .b(new_n64_), .O(z05));
  inv1   g039(.a(z05), .O(z06));
  inv1   g040(.a(x33), .O(new_n103_));
  nand2  g041(.a(x17), .b(new_n72_), .O(new_n104_));
  ...
  nor2   g051(.a(new_n74_), .b(new_n63_), .O(z08));
  ...
  nand3  g057(.a(new_n119_), .b(new_n84_), .c(x27), .O(new_n120_));
  nand2  g058(.a(new_n80_), .b(new_n79_), .O(new_n121_));
  nand3  g059(.a(new_n121_), .b(x40), .c(x05), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n71_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n64_), .O(z10));
  inv1   g064(.a(x09), .O(new_n127_));
  inv1   g065(.a(x29), .O(new_n128_));
  nor2   g066(.a(new_n74_), .b(new_n128_), .O(new_n129_));
  inv1   g067(.a(new_n129_), .O(new_n130_));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n90_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  inv1   g071(.a(x08), .O(new_n134_));
  nand2  g072(.a(x40), .b(x04), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x35), .c(new_n82_), .d(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n79_), .c(new_n127_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n64_), .O(z11));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n95_), .c(new_n73_), .O(new_n142_));
  oai21  g080(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n64_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x40), .c(new_n145_), .d(new_n71_), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nand4  g088(.a(new_n67_), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n148_), .c(new_n95_), .O(new_n152_));
  nand3  g090(.a(new_n121_), .b(new_n145_), .c(new_n71_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x39), .c(new_n74_), .O(new_n154_));
  or2    g092(.a(new_n154_), .b(new_n152_), .O(z13));
  aoi21  g093(.a(new_n145_), .b(new_n71_), .c(new_n63_), .O(new_n156_));
  nor2   g094(.a(x19), .b(x18), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n67_), .c(x27), .d(x20), .O(new_n158_));
  oai21  g096(.a(new_n156_), .b(new_n74_), .c(new_n158_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n160_));
  nor2   g098(.a(x37), .b(x35), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(new_n146_), .c(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n82_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n80_), .d(new_n79_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n159_), .O(z14));
  nand4  g103(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n64_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x22), .c(x01), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n64_), .O(z16));
  ...
  oai21  g112(.a(new_n83_), .b(x27), .c(new_n130_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n95_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n90_), .c(x09), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g117(.a(x39), .b(new_n128_), .c(new_n74_), .O(new_n180_));
  aoi21  g118(.a(new_n131_), .b(new_n90_), .c(new_n180_), .O(new_n181_));
  nand2  g119(.a(new_n64_), .b(new_n95_), .O(new_n182_));
  nand3  g120(.a(new_n135_), .b(x35), .c(new_n82_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x39), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n182_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n181_), .c(new_n79_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z19));
  oai21  g125(.a(new_n89_), .b(new_n95_), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n95_), .c(new_n89_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n129_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n79_), .c(new_n127_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n64_), .O(z20));
endmodule
