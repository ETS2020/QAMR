...
module FAU ( 
  ...
  nand2  g053(.a(new_n115_), .b(new_n80_), .O(new_n116_));
  oai21  g054(.a(new_n113_), .b(x31), .c(new_n116_), .O(new_n117_));
  ...
  nand3  g076(.a(new_n135_), .b(x27), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n93_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n84_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n82_), .O(z11));
  ...
  nand3  g086(.a(new_n148_), .b(new_n81_), .c(x14), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n81_), .O(new_n153_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n99_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  nand3  g101(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n164_));
  nand4  g102(.a(new_n152_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n165_));
  ...
  aoi21  g109(.a(new_n167_), .b(new_n148_), .c(new_n99_), .O(new_n172_));
  ...
  nand4  g115(.a(new_n82_), .b(new_n177_), .c(x22), .d(x01), .O(new_n178_));
  ...
  oai21  g121(.a(new_n87_), .b(x27), .c(new_n134_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n99_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n139_), .d(new_n133_), .O(z18));
  nand2  g125(.a(new_n82_), .b(new_n64_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n189_));
  ...
  nand2  g131(.a(new_n81_), .b(x14), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n193_), .c(new_n136_), .d(new_n135_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n191_), .c(new_n84_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z19));
  inv1   g135(.a(new_n134_), .O(new_n198_));
  oai21  g136(.a(new_n66_), .b(new_n64_), .c(new_n93_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n199_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n84_), .c(new_n133_), .O(new_n202_));
