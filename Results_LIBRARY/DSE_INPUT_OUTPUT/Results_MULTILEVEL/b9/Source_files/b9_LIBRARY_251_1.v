...
module FAU ( 
  ...
  nor2   g019(.a(new_n81_), .b(x13), .O(new_n82_));
  ...
  oai21  g041(.a(new_n86_), .b(new_n64_), .c(new_n70_), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(new_n92_), .O(z06));
  ...
  nand2  g055(.a(new_n117_), .b(new_n92_), .O(z07));
  nand2  g056(.a(new_n92_), .b(new_n75_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n92_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  nand2  g060(.a(x05), .b(new_n65_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n75_), .c(x13), .O(new_n124_));
  ...
  nand2  g098(.a(x32), .b(new_n65_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n75_), .c(new_n81_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n151_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z13));
  nand3  g102(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n165_));
  nand3  g103(.a(new_n153_), .b(new_n85_), .c(x28), .O(new_n166_));
  ...
  nand2  g109(.a(new_n171_), .b(new_n85_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n148_), .c(new_n82_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nor2   g113(.a(new_n121_), .b(new_n175_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand4  g115(.a(new_n92_), .b(new_n177_), .c(x22), .d(x01), .O(new_n178_));
  ...
  oai21  g121(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n140_), .c(new_n81_), .d(new_n135_), .O(z18));
  nand2  g124(.a(new_n143_), .b(new_n92_), .O(z19));
  ...
  nand3  g129(.a(new_n191_), .b(new_n81_), .c(new_n135_), .O(new_n192_));
