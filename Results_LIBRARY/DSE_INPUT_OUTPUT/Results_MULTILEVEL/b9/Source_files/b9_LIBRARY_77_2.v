...
module FAU ( 
  ...
  oai21  g024(.a(new_n86_), .b(x25), .c(new_n80_), .O(new_n87_));
  ...
  nand4  g032(.a(new_n94_), .b(new_n91_), .c(new_n81_), .d(new_n76_), .O(z02));
  ...
  nand3  g059(.a(new_n76_), .b(new_n111_), .c(x05), .O(new_n122_));
  ...
  nand2  g066(.a(x32), .b(new_n111_), .O(new_n129_));
  ...
  nand4  g079(.a(new_n141_), .b(new_n80_), .c(new_n111_), .d(new_n133_), .O(new_n142_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n97_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n128_), .O(new_n152_));
  ...
  nand4  g103(.a(new_n151_), .b(new_n165_), .c(new_n80_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n76_), .b(new_n150_), .c(new_n65_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(x27), .c(x32), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(x25), .c(new_n80_), .O(new_n172_));
  nand2  g110(.a(new_n168_), .b(new_n147_), .O(new_n173_));
  ...
  nand2  g121(.a(new_n92_), .b(new_n64_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n134_), .c(new_n138_), .O(new_n185_));
  nand2  g123(.a(new_n139_), .b(new_n133_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(new_n111_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n80_), .O(z18));
  inv1   g126(.a(new_n134_), .O(new_n189_));
  aoi21  g127(.a(new_n66_), .b(new_n111_), .c(x28), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n135_), .c(new_n189_), .O(new_n191_));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n111_), .O(new_n192_));
  nor2   g130(.a(x28), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n191_), .c(new_n133_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n111_), .c(x30), .O(z19));
  oai21  g134(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n189_), .c(new_n197_), .O(new_n199_));
  nand4  g137(.a(new_n199_), .b(new_n80_), .c(new_n111_), .d(new_n133_), .O(new_n200_));
