...
module FAU ( 
  ...
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n90_), .O(z05));
  ...
  nand3  g059(.a(new_n82_), .b(new_n75_), .c(x07), .O(new_n122_));
  nand3  g060(.a(new_n76_), .b(x19), .c(x05), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n85_), .O(new_n124_));
  inv1   g062(.a(x06), .O(new_n125_));
  nor3   g063(.a(new_n90_), .b(new_n70_), .c(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n124_), .b(new_n65_), .c(new_n126_), .O(new_n127_));
  inv1   g065(.a(x40), .O(new_n128_));
  nand2  g066(.a(x32), .b(x19), .O(new_n129_));
  ...
  nand2  g071(.a(x35), .b(new_n84_), .O(new_n134_));
  ...
  nand3  g076(.a(new_n94_), .b(x27), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n81_), .c(x19), .d(new_n133_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n82_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  oai21  g087(.a(new_n67_), .b(new_n66_), .c(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x40), .c(x39), .d(new_n149_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  nand4  g090(.a(new_n72_), .b(x20), .c(new_n80_), .d(new_n152_), .O(new_n153_));
  oai21  g091(.a(new_n151_), .b(x04), .c(new_n153_), .O(new_n154_));
  ...
  aoi21  g098(.a(new_n150_), .b(x27), .c(x32), .O(new_n161_));
  nand3  g099(.a(new_n76_), .b(new_n149_), .c(new_n65_), .O(new_n162_));
  aoi21  g100(.a(new_n161_), .b(new_n81_), .c(new_n162_), .O(new_n163_));
  nand4  g101(.a(new_n72_), .b(x27), .c(x20), .d(new_n152_), .O(new_n164_));
  ...
  nand2  g105(.a(new_n167_), .b(new_n82_), .O(z15));
  ...
  aoi21  g114(.a(new_n176_), .b(new_n135_), .c(new_n138_), .O(new_n177_));
  nand2  g115(.a(new_n139_), .b(new_n133_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n177_), .c(x19), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n81_), .O(z18));
  inv1   g118(.a(new_n135_), .O(new_n181_));
  oai21  g119(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n182_));
  aoi21  g120(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n182_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n133_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(x19), .c(x30), .O(z20));
