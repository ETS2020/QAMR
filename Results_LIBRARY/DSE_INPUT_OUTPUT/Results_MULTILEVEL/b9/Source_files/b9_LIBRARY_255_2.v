...
module FAU ( 
  ...
  inv1   g021(.a(x06), .O(new_n84_));
  inv1   g022(.a(x28), .O(new_n85_));
  aoi21  g023(.a(x35), .b(new_n85_), .c(x36), .O(new_n86_));
  nor2   g024(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  oai21  g025(.a(new_n87_), .b(x32), .c(new_n84_), .O(new_n88_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n93_), .c(new_n79_), .d(new_n64_), .O(z02));
  ...
  oai21  g040(.a(new_n85_), .b(new_n67_), .c(new_n73_), .O(new_n103_));
  ...
  oai21  g064(.a(new_n126_), .b(x06), .c(new_n63_), .O(new_n127_));
  ...
  nand4  g068(.a(x37), .b(x30), .c(x27), .d(x06), .O(new_n131_));
  ...
  nor2   g075(.a(new_n69_), .b(x28), .O(new_n138_));
  ...
  aoi21  g080(.a(new_n142_), .b(new_n84_), .c(x30), .O(z11));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(x06), .O(new_n156_));
  ...
  nand3  g097(.a(new_n129_), .b(new_n149_), .c(new_n68_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  nand4  g100(.a(new_n150_), .b(new_n126_), .c(new_n63_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n79_), .b(new_n149_), .c(new_n68_), .O(new_n165_));
  ...
  oai21  g106(.a(new_n168_), .b(x06), .c(new_n63_), .O(new_n169_));
  oai21  g107(.a(new_n76_), .b(new_n67_), .c(new_n165_), .O(new_n170_));
  ...
  nand2  g118(.a(new_n138_), .b(new_n67_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n134_), .c(new_n137_), .O(new_n182_));
  nand2  g120(.a(new_n139_), .b(new_n133_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n182_), .c(new_n84_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n63_), .O(z18));
  inv1   g123(.a(new_n134_), .O(new_n186_));
  oai21  g124(.a(new_n69_), .b(new_n67_), .c(new_n137_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n133_), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n84_), .c(x30), .O(z20));
  aoi21  g129(.a(new_n142_), .b(new_n84_), .c(x30), .O(z19));
endmodule
