...
module FAU ( 
  ...
  nand2  g018(.a(x29), .b(new_n80_), .O(new_n81_));
  ...
  aoi21  g029(.a(x10), .b(new_n90_), .c(new_n91_), .O(new_n92_));
  ...
  oai22  g033(.a(new_n95_), .b(new_n83_), .c(new_n92_), .d(x02), .O(z02));
  ...
  nor3   g056(.a(new_n83_), .b(new_n118_), .c(new_n117_), .O(z08));
  ...
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n83_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(z10));
  nand2  g070(.a(new_n81_), .b(new_n64_), .O(new_n133_));
  inv1   g071(.a(x28), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n134_), .c(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x10), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n133_), .c(x08), .O(new_n137_));
  aoi21  g075(.a(new_n75_), .b(x10), .c(new_n91_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n93_), .c(new_n138_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n137_), .c(new_n84_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n91_), .c(x27), .O(new_n146_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n65_), .c(new_n83_), .O(new_n160_));
  ...
  aoi21  g107(.a(new_n165_), .b(new_n143_), .c(new_n83_), .O(new_n170_));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n66_), .O(new_n182_));
  inv1   g120(.a(x09), .O(new_n183_));
  nand2  g121(.a(new_n84_), .b(new_n183_), .O(new_n184_));
  aoi21  g122(.a(new_n182_), .b(new_n134_), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n76_), .b(x29), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(x10), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n185_), .b(new_n83_), .c(new_n188_), .O(z18));
  nand2  g127(.a(x29), .b(x04), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(x35), .c(new_n134_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x10), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n133_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n140_), .c(new_n84_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(x09), .O(z19));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n187_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n84_), .c(new_n183_), .O(new_n199_));
