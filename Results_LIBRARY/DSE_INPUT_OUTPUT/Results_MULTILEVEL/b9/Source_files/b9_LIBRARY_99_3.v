...
module FAU ( 
  ...
  nand2  g023(.a(x40), .b(x15), .O(new_n86_));
  nand3  g024(.a(new_n86_), .b(new_n85_), .c(x04), .O(z01));
  ...
  inv1   g033(.a(new_n86_), .O(new_n96_));
  nand2  g034(.a(new_n70_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi21  g036(.a(new_n69_), .b(new_n63_), .c(new_n98_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n97_), .c(new_n96_), .O(z03));
  aoi21  g038(.a(new_n69_), .b(new_n63_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n97_), .c(new_n96_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n69_), .c(new_n96_), .O(z05));
  nand3  g042(.a(new_n103_), .b(new_n86_), .c(new_n69_), .O(new_n105_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n86_), .O(z10));
  inv1   g072(.a(x08), .O(new_n135_));
  inv1   g073(.a(x09), .O(new_n136_));
  nand4  g074(.a(new_n78_), .b(new_n136_), .c(new_n135_), .d(x04), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  nand2  g077(.a(new_n94_), .b(x29), .O(new_n140_));
  ...
  oai21  g081(.a(new_n82_), .b(new_n63_), .c(new_n135_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n78_), .c(new_n136_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n139_), .O(z11));
  aoi21  g085(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(new_n148_));
  inv1   g086(.a(x35), .O(new_n149_));
  nand3  g087(.a(new_n69_), .b(new_n80_), .c(new_n149_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x27), .c(x10), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n64_), .c(new_n148_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n65_), .O(new_n153_));
  oai21  g091(.a(new_n148_), .b(x40), .c(new_n153_), .O(z12));
  inv1   g092(.a(x13), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n110_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n64_), .O(new_n158_));
  inv1   g096(.a(x18), .O(new_n159_));
  inv1   g097(.a(x19), .O(new_n160_));
  nand4  g098(.a(new_n71_), .b(x20), .c(new_n160_), .d(new_n159_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(x15), .O(new_n162_));
  nand4  g100(.a(new_n71_), .b(new_n110_), .c(x20), .d(new_n160_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand4  g103(.a(new_n129_), .b(new_n65_), .c(new_n155_), .d(new_n64_), .O(new_n166_));
  ...
  nand3  g108(.a(new_n94_), .b(new_n155_), .c(new_n64_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand3  g110(.a(new_n69_), .b(new_n149_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n79_), .c(new_n78_), .O(new_n175_));
  inv1   g113(.a(new_n148_), .O(new_n176_));
  aoi21  g114(.a(new_n171_), .b(new_n176_), .c(new_n96_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n175_), .c(new_n172_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nand4  g117(.a(new_n86_), .b(x34), .c(x27), .d(x26), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n179_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x22), .c(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n86_), .O(z16));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(x23), .c(x22), .d(x01), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n86_), .O(z17));
  oai21  g125(.a(new_n82_), .b(x27), .c(new_n140_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  inv1   g127(.a(new_n82_), .O(new_n190_));
  nor2   g128(.a(new_n63_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n189_), .c(new_n86_), .d(new_n136_), .O(z18));
  nand2  g131(.a(x40), .b(x04), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(x35), .c(new_n81_), .O(new_n195_));
  aoi22  g133(.a(new_n195_), .b(new_n65_), .c(new_n86_), .d(new_n63_), .O(new_n196_));
  aoi21  g134(.a(x39), .b(x29), .c(x15), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n110_), .c(new_n142_), .O(new_n198_));
  oai21  g136(.a(new_n196_), .b(x08), .c(new_n198_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n78_), .c(new_n136_), .O(new_n200_));
  inv1   g138(.a(new_n200_), .O(z19));
  inv1   g139(.a(new_n140_), .O(new_n202_));
  oai21  g140(.a(new_n149_), .b(new_n63_), .c(new_n135_), .O(new_n203_));
  aoi21  g141(.a(x28), .b(new_n63_), .c(new_n149_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n203_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n78_), .c(new_n136_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n86_), .O(z20));
endmodule
