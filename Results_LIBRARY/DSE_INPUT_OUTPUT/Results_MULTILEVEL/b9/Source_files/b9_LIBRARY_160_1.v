...
module FAU ( 
  ...
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(new_n71_), .O(z10));
  inv1   g067(.a(new_n78_), .O(new_n130_));
  aoi21  g068(.a(x39), .b(new_n85_), .c(new_n67_), .O(new_n131_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n92_), .c(new_n66_), .O(new_n141_));
  oai22  g079(.a(new_n64_), .b(new_n92_), .c(new_n67_), .d(x04), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n71_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x40), .c(new_n144_), .d(new_n118_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand2  g087(.a(new_n90_), .b(new_n93_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n147_), .c(new_n70_), .O(new_n152_));
  nand4  g090(.a(new_n150_), .b(new_n67_), .c(x20), .d(new_n149_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x18), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(x27), .O(new_n155_));
  nand4  g093(.a(new_n124_), .b(x39), .c(new_n144_), .d(new_n118_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(x40), .b(new_n144_), .c(new_n118_), .O(new_n158_));
  ...
  aoi21  g115(.a(new_n177_), .b(new_n130_), .c(x09), .O(new_n178_));
  ...
  aoi21  g120(.a(new_n182_), .b(new_n134_), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n133_), .c(new_n74_), .O(new_n184_));
