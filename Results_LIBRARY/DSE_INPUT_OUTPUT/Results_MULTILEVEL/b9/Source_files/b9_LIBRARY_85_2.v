...
module FAU ( 
  ...
  nand3  g041(.a(new_n103_), .b(new_n79_), .c(new_n68_), .O(z05));
  nand2  g042(.a(new_n103_), .b(new_n68_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n79_), .O(z06));
  ...
  oai21  g062(.a(x39), .b(new_n63_), .c(new_n124_), .O(new_n125_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n79_), .O(z11));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n68_), .b(new_n82_), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n72_), .c(new_n70_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x40), .O(new_n148_));
  inv1   g086(.a(new_n70_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n74_), .c(new_n63_), .O(new_n150_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n72_), .c(new_n64_), .O(new_n164_));
  ...
  nand3  g106(.a(z08), .b(new_n152_), .c(new_n72_), .O(new_n169_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n149_), .c(new_n64_), .O(new_n174_));
  ...
  aoi21  g122(.a(new_n184_), .b(new_n139_), .c(new_n144_), .O(new_n185_));
  nand2  g123(.a(new_n80_), .b(new_n134_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(new_n83_), .c(new_n186_), .O(new_n187_));
  nand3  g125(.a(z08), .b(x29), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n187_), .b(new_n64_), .c(new_n188_), .O(z18));
  inv1   g127(.a(new_n135_), .O(new_n190_));
  oai21  g128(.a(new_n144_), .b(new_n67_), .c(new_n138_), .O(new_n191_));
  ...
  nand2  g133(.a(new_n142_), .b(new_n79_), .O(z19));
endmodule
