...
module FAU ( 
  ...
  nand2  g017(.a(x40), .b(x30), .O(new_n80_));
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n76_), .d(new_n83_), .O(z02));
  ...
  nand3  g056(.a(x40), .b(x39), .c(new_n83_), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n80_), .O(z09));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n80_), .O(z10));
  ...
  nand4  g074(.a(x35), .b(new_n85_), .c(x27), .d(new_n65_), .O(new_n137_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n83_), .O(new_n145_));
  ...
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n146_), .O(new_n152_));
  ...
  nand4  g096(.a(x39), .b(x32), .c(new_n150_), .d(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n83_), .O(new_n160_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n147_), .c(new_n100_), .O(new_n171_));
  ...
  oai21  g119(.a(new_n86_), .b(x27), .c(new_n133_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n137_), .c(new_n83_), .d(new_n132_), .O(z18));
  nand2  g122(.a(new_n140_), .b(new_n80_), .O(z19));
  inv1   g123(.a(new_n133_), .O(new_n186_));
  oai21  g124(.a(new_n66_), .b(new_n64_), .c(new_n136_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n83_), .c(new_n132_), .O(new_n190_));
