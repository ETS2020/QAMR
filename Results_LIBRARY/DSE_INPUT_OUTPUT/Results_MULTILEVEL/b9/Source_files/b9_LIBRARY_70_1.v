...
module FAU ( 
  ...
  nor2   g026(.a(new_n83_), .b(x18), .O(new_n89_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n89_), .O(z04));
  ...
  aoi21  g086(.a(new_n148_), .b(x28), .c(new_n126_), .O(new_n149_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n65_), .c(new_n89_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n154_), .O(z13));
  nand3  g097(.a(x20), .b(new_n151_), .c(new_n80_), .O(new_n160_));
  nor2   g098(.a(x37), .b(x35), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(new_n148_), .c(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n119_), .c(x27), .O(new_n163_));
  nor2   g101(.a(x13), .b(x04), .O(new_n164_));
  nand2  g102(.a(x27), .b(x20), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x19), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n72_), .c(new_n164_), .d(new_n76_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n84_), .c(new_n167_), .O(new_n168_));
  nand2  g106(.a(new_n164_), .b(new_n76_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x18), .O(new_n170_));
  oai21  g108(.a(new_n168_), .b(x30), .c(new_n170_), .O(z14));
  inv1   g109(.a(x12), .O(new_n172_));
  nand4  g110(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n173_));
  ...
  nand2  g118(.a(new_n85_), .b(new_n64_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n133_), .c(new_n136_), .O(new_n182_));
  nand2  g120(.a(new_n137_), .b(new_n132_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n182_), .c(new_n83_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n127_), .O(z18));
