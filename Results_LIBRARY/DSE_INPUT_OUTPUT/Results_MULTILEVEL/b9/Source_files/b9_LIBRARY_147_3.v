...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n87_), .c(new_n72_), .O(new_n91_));
  ...
  oai21  g051(.a(x39), .b(x34), .c(x40), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z08));
  nand4  g053(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(x40), .O(z09));
  inv1   g055(.a(x04), .O(new_n118_));
  aoi21  g056(.a(x35), .b(new_n81_), .c(x36), .O(new_n119_));
  ...
  nand4  g067(.a(new_n129_), .b(new_n72_), .c(x05), .d(new_n118_), .O(new_n130_));
  oai21  g068(.a(new_n125_), .b(new_n67_), .c(new_n130_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  aoi21  g070(.a(x40), .b(x34), .c(x27), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n81_), .c(new_n118_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n72_), .c(new_n133_), .O(new_n135_));
  aoi21  g073(.a(x39), .b(x29), .c(x34), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(x35), .c(new_n81_), .O(new_n138_));
  oai21  g076(.a(new_n136_), .b(new_n74_), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n67_), .c(new_n73_), .O(new_n144_));
  nand2  g082(.a(new_n69_), .b(new_n68_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  nand2  g084(.a(x40), .b(x39), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(x04), .c(new_n146_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n144_), .c(new_n63_), .O(z12));
  ...
  nand4  g096(.a(new_n127_), .b(x39), .c(new_n150_), .d(new_n118_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n72_), .O(new_n160_));
  ...
  nand4  g101(.a(new_n151_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n164_));
  nand3  g102(.a(x39), .b(new_n150_), .c(new_n118_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(x34), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n74_), .c(new_n163_), .O(new_n168_));
  inv1   g106(.a(x35), .O(new_n169_));
  nand3  g107(.a(new_n68_), .b(new_n169_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  nand2  g110(.a(new_n165_), .b(new_n146_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n72_), .O(new_n175_));
  nand2  g113(.a(new_n146_), .b(new_n74_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n168_), .O(z14));
  nand3  g115(.a(x27), .b(x26), .c(x12), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n74_), .c(new_n72_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x22), .c(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n63_), .O(z16));
  inv1   g120(.a(x01), .O(new_n183_));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n63_), .b(new_n184_), .c(x23), .d(x22), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n183_), .O(z17));
  inv1   g124(.a(x29), .O(new_n187_));
  oai22  g125(.a(new_n147_), .b(new_n187_), .c(new_n82_), .d(x27), .O(new_n188_));
  ...
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n63_), .d(new_n79_), .O(z18));
  nor2   g130(.a(new_n136_), .b(new_n74_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n67_), .c(new_n169_), .O(new_n194_));
  nor2   g132(.a(x35), .b(x34), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n133_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(x08), .c(new_n194_), .d(new_n193_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n79_), .c(new_n132_), .O(new_n198_));
  inv1   g136(.a(new_n198_), .O(z20));
  inv1   g137(.a(new_n141_), .O(z19));
endmodule
