...
module FAU ( 
  ...
  nand4  g016(.a(new_n78_), .b(x39), .c(new_n74_), .d(new_n66_), .O(new_n79_));
  oai22  g017(.a(new_n79_), .b(x04), .c(new_n73_), .d(new_n65_), .O(z00));
  ...
  nand3  g024(.a(new_n86_), .b(new_n81_), .c(new_n74_), .O(new_n87_));
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(new_n64_), .O(z02));
  nand2  g034(.a(new_n69_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x27), .O(new_n98_));
  aoi21  g036(.a(new_n68_), .b(new_n98_), .c(new_n65_), .O(new_n99_));
  ...
  oai21  g040(.a(new_n83_), .b(new_n98_), .c(new_n68_), .O(new_n103_));
  ...
  nor3   g055(.a(new_n65_), .b(new_n76_), .c(new_n117_), .O(z08));
  ...
  nand3  g079(.a(new_n141_), .b(x27), .c(new_n63_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n74_), .c(new_n135_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n64_), .O(z11));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n98_), .c(new_n75_), .O(new_n148_));
  oai21  g086(.a(new_n94_), .b(x04), .c(new_n71_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n64_), .O(z12));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n70_), .b(new_n64_), .c(x20), .d(new_n151_), .O(new_n152_));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n76_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n74_), .d(new_n153_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(x04), .c(new_n152_), .d(x18), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand4  g096(.a(new_n132_), .b(new_n74_), .c(new_n153_), .d(new_n63_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand2  g098(.a(x20), .b(new_n151_), .O(new_n161_));
  nand3  g099(.a(new_n154_), .b(new_n81_), .c(x28), .O(new_n162_));
  nor2   g100(.a(new_n94_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n162_), .c(x30), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(x04), .c(new_n161_), .d(x18), .O(new_n165_));
  nand3  g103(.a(new_n68_), .b(new_n140_), .c(x28), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(x27), .c(x32), .O(new_n167_));
  nor2   g105(.a(new_n163_), .b(new_n72_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n74_), .O(new_n169_));
  nand2  g107(.a(new_n71_), .b(x04), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n165_), .O(z14));
  inv1   g109(.a(x12), .O(new_n172_));
  nor2   g110(.a(new_n120_), .b(new_n172_), .O(z15));
  ...
  oai21  g118(.a(new_n84_), .b(x27), .c(new_n136_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n142_), .c(new_n74_), .d(new_n135_), .O(z18));
  inv1   g121(.a(new_n136_), .O(new_n184_));
  oai21  g122(.a(new_n140_), .b(new_n98_), .c(new_n139_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n98_), .c(new_n140_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n74_), .c(new_n135_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n64_), .O(z20));
  nand2  g127(.a(new_n145_), .b(new_n64_), .O(z19));
endmodule
