...
module FAU ( 
  ...
  aoi21  g062(.a(new_n74_), .b(new_n73_), .c(new_n69_), .O(new_n125_));
  nand4  g063(.a(new_n125_), .b(x39), .c(x05), .d(new_n116_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n124_), .O(z10));
  inv1   g065(.a(x29), .O(new_n128_));
  inv1   g066(.a(x39), .O(new_n129_));
  aoi21  g067(.a(x40), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  ...
  oai21  g081(.a(new_n139_), .b(x39), .c(new_n143_), .O(z12));
  ...
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n129_), .O(new_n156_));
  ...
  oai22  g097(.a(new_n159_), .b(new_n64_), .c(new_n158_), .d(new_n129_), .O(new_n160_));
  ...
  nand4  g102(.a(new_n164_), .b(x40), .c(new_n74_), .d(new_n73_), .O(new_n165_));
  ...
  nor2   g120(.a(new_n129_), .b(new_n128_), .O(new_n183_));
