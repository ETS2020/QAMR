...
module FAU ( 
  ...
  nor2   g022(.a(new_n68_), .b(x28), .O(new_n85_));
  oai21  g023(.a(new_n85_), .b(x36), .c(x27), .O(new_n86_));
  nand4  g024(.a(new_n86_), .b(new_n84_), .c(new_n83_), .d(new_n63_), .O(new_n87_));
  oai21  g025(.a(new_n64_), .b(x04), .c(new_n87_), .O(z01));
  nand2  g026(.a(new_n83_), .b(x12), .O(new_n89_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n92_), .c(new_n78_), .d(new_n89_), .O(z02));
  nand2  g035(.a(new_n73_), .b(x27), .O(new_n98_));
  nand2  g036(.a(new_n72_), .b(new_n66_), .O(new_n99_));
  ...
  oai21  g040(.a(new_n93_), .b(new_n66_), .c(new_n72_), .O(new_n103_));
  and2   g041(.a(new_n103_), .b(new_n89_), .O(z05));
  ...
  nand3  g060(.a(new_n77_), .b(new_n89_), .c(x07), .O(new_n123_));
  nand3  g061(.a(new_n78_), .b(new_n63_), .c(x05), .O(new_n124_));
  aoi22  g062(.a(new_n124_), .b(new_n123_), .c(new_n94_), .d(new_n69_), .O(new_n125_));
  inv1   g063(.a(x06), .O(new_n126_));
  nor3   g064(.a(new_n64_), .b(new_n72_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n67_), .c(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n84_), .b(x12), .c(new_n83_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(x40), .c(x39), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x05), .c(new_n67_), .O(new_n132_));
  oai21  g070(.a(new_n128_), .b(new_n66_), .c(new_n132_), .O(z10));
  ...
  nand3  g076(.a(new_n85_), .b(x27), .c(new_n67_), .O(new_n139_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n89_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(x12), .O(new_n157_));
  nand4  g095(.a(new_n74_), .b(x30), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n131_), .b(new_n150_), .c(new_n67_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand3  g100(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  nand3  g101(.a(new_n78_), .b(new_n150_), .c(new_n67_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n89_), .O(new_n165_));
  aoi21  g103(.a(x36), .b(x35), .c(x32), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n83_), .c(x28), .d(new_n63_), .O(new_n167_));
  ...
  inv1   g115(.a(x34), .O(new_n178_));
  nand4  g116(.a(x30), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  ...
  nand2  g124(.a(new_n85_), .b(new_n66_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n135_), .c(new_n138_), .O(new_n188_));
  nand2  g126(.a(new_n139_), .b(new_n134_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(new_n63_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n83_), .O(z18));
  nand4  g129(.a(new_n141_), .b(new_n83_), .c(new_n63_), .d(new_n134_), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(z19));
  inv1   g131(.a(new_n135_), .O(new_n194_));
  oai21  g132(.a(new_n68_), .b(new_n66_), .c(new_n138_), .O(new_n195_));
  ...
  aoi21  g136(.a(new_n198_), .b(new_n63_), .c(x30), .O(z20));
endmodule
