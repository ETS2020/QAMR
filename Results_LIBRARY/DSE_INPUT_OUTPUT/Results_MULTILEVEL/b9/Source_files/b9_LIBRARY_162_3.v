...
module FAU ( 
  ...
  nand4  g50(.a(new_n113_), .b(new_n111_), .c(x35), .d(new_n78_), .O(new_n114_));
  nand3  g51(.a(new_n114_), .b(new_n71_), .c(new_n110_), .O(new_n115_));
  nand2  g52(.a(new_n115_), .b(z02), .O(z11));
  inv1   g53(.a(new_n67_), .O(new_n117_));
  nand3  g54(.a(new_n117_), .b(z02), .c(x27), .O(z12));
  inv1   g55(.a(x18), .O(new_n119_));
  inv1   g56(.a(x19), .O(new_n120_));
  nand4  g57(.a(new_n68_), .b(x20), .c(new_n120_), .d(new_n119_), .O(new_n121_));
  ...
  aoi21  g61(.a(new_n124_), .b(new_n117_), .c(new_n64_), .O(z14));
  ...
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n78_), .O(new_n137_));
  nand4  g74(.a(new_n137_), .b(z02), .c(new_n71_), .d(new_n110_), .O(z18));
  nand4  g75(.a(new_n114_), .b(z02), .c(new_n71_), .d(new_n110_), .O(new_n139_));
  inv1   g76(.a(new_n139_), .O(z19));
  oai21  g77(.a(x28), .b(new_n112_), .c(new_n66_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(x35), .O(new_n142_));
  nand3  g79(.a(new_n142_), .b(new_n71_), .c(new_n110_), .O(new_n143_));
