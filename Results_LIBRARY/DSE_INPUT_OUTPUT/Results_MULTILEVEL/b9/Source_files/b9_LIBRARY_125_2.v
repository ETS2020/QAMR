...
module FAU ( 
  ...
  nor2   g032(.a(x40), .b(x10), .O(new_n95_));
  ...
  aoi21  g037(.a(new_n65_), .b(new_n99_), .c(new_n78_), .O(new_n100_));
  ...
  nand2  g086(.a(new_n67_), .b(new_n73_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n63_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n146_), .O(z12));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n71_), .c(new_n78_), .O(new_n163_));
  ...
  nand3  g107(.a(new_n65_), .b(new_n134_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n68_), .c(new_n78_), .O(new_n173_));
  ...
  nand4  g119(.a(new_n64_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  nand2  g121(.a(new_n99_), .b(x08), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n140_), .c(new_n134_), .O(new_n185_));
  nand2  g123(.a(new_n79_), .b(new_n132_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(new_n82_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n78_), .c(new_n118_), .d(new_n89_), .O(z18));
  nand2  g126(.a(new_n64_), .b(new_n99_), .O(new_n189_));
  nand3  g127(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n190_));
  ...
  aoi21  g131(.a(new_n193_), .b(x40), .c(new_n95_), .O(new_n194_));
  aoi21  g132(.a(new_n136_), .b(new_n135_), .c(new_n194_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n192_), .c(new_n79_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z19));
  aoi21  g135(.a(x28), .b(new_n99_), .c(new_n134_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(new_n194_), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n134_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n189_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n79_), .O(new_n202_));
