...
module FAU ( 
  ...
  nand3  g014(.a(new_n76_), .b(new_n71_), .c(new_n70_), .O(new_n77_));
  inv1   g015(.a(x15), .O(new_n78_));
  inv1   g016(.a(x40), .O(new_n79_));
  nand2  g017(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g018(.a(new_n80_), .b(new_n77_), .c(x04), .O(z01));
  ...
  oai21  g024(.a(new_n86_), .b(new_n74_), .c(x04), .O(new_n87_));
  nand2  g025(.a(x40), .b(x39), .O(new_n88_));
  inv1   g026(.a(new_n88_), .O(new_n89_));
  nand3  g027(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(z02));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n93_), .c(new_n91_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n91_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n80_), .c(new_n96_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(z06));
  inv1   g042(.a(x03), .O(new_n105_));
  inv1   g043(.a(x31), .O(new_n106_));
  inv1   g044(.a(x33), .O(new_n107_));
  oai21  g045(.a(new_n79_), .b(x17), .c(new_n78_), .O(new_n108_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n80_), .c(new_n112_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n111_), .c(new_n105_), .O(z07));
  nand2  g054(.a(new_n88_), .b(new_n80_), .O(z08));
  ...
  nand3  g061(.a(new_n123_), .b(new_n75_), .c(x27), .O(new_n124_));
  ...
  nand2  g071(.a(new_n89_), .b(x29), .O(new_n134_));
  ...
  nand3  g077(.a(new_n136_), .b(x27), .c(new_n120_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n83_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n70_), .c(new_n133_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n80_), .O(z11));
  nand3  g082(.a(new_n96_), .b(new_n72_), .c(new_n135_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  nand2  g084(.a(new_n92_), .b(new_n96_), .O(new_n147_));
  aoi22  g085(.a(new_n147_), .b(x27), .c(x39), .d(new_n120_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n146_), .c(x40), .O(new_n149_));
  nand2  g087(.a(new_n147_), .b(x27), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n79_), .c(x15), .O(new_n151_));
  ...
  nor2   g098(.a(new_n159_), .b(new_n78_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n160_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n127_), .b(new_n153_), .c(new_n120_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n162_), .O(z13));
  nand3  g102(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n165_));
  nand4  g103(.a(new_n154_), .b(new_n71_), .c(new_n70_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n89_), .b(new_n153_), .c(new_n120_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  nand3  g107(.a(new_n96_), .b(new_n135_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n71_), .c(new_n70_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n150_), .c(new_n91_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nand4  g113(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n176_));
  ...
  oai21  g121(.a(new_n74_), .b(x27), .c(new_n134_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n91_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n140_), .d(new_n133_), .O(z18));
  nand2  g125(.a(new_n80_), .b(new_n95_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n73_), .c(new_n120_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x40), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n188_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n125_), .b(new_n84_), .c(x40), .O(new_n192_));
  nand2  g130(.a(new_n79_), .b(x15), .O(new_n193_));
  aoi22  g131(.a(new_n193_), .b(new_n192_), .c(new_n137_), .d(new_n136_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n191_), .c(new_n70_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z19));
  inv1   g134(.a(new_n134_), .O(new_n197_));
  oai21  g135(.a(new_n135_), .b(new_n95_), .c(new_n83_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n95_), .c(new_n135_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n70_), .c(new_n133_), .O(new_n201_));
