// Benchmark "FAU" written by ABC on Thu Aug 13 18:18:20 2020
...
module FAU ( 
  ...
  nand2  g000(.a(x10), .b(x00), .O(new_n63_));
  ...
  inv1   g009(.a(x00), .O(new_n72_));
  nand2  g010(.a(x10), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(new_n63_), .O(z02));
  nand2  g032(.a(new_n65_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x21), .O(new_n96_));
  inv1   g034(.a(x27), .O(new_n97_));
  aoi21  g035(.a(new_n64_), .b(new_n97_), .c(new_n96_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n77_), .O(z03));
  aoi21  g037(.a(new_n64_), .b(new_n97_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n77_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n63_), .c(new_n64_), .O(z05));
  inv1   g041(.a(z05), .O(z06));
  inv1   g042(.a(x03), .O(new_n105_));
  inv1   g043(.a(x31), .O(new_n106_));
  inv1   g044(.a(x33), .O(new_n107_));
  nand2  g045(.a(x17), .b(new_n70_), .O(new_n108_));
  inv1   g046(.a(x25), .O(new_n109_));
  inv1   g047(.a(x38), .O(new_n110_));
  aoi21  g048(.a(new_n109_), .b(x00), .c(new_n110_), .O(new_n111_));
  oai22  g049(.a(new_n111_), .b(x10), .c(x38), .d(x00), .O(new_n112_));
  nand4  g050(.a(new_n112_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(new_n113_));
  inv1   g051(.a(x14), .O(new_n114_));
  aoi21  g052(.a(x38), .b(new_n109_), .c(x00), .O(new_n115_));
  nor2   g053(.a(x10), .b(new_n72_), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n113_), .c(new_n105_), .O(z07));
  nand2  g056(.a(new_n92_), .b(new_n63_), .O(z08));
  ...
  nand2  g069(.a(new_n131_), .b(new_n122_), .O(new_n132_));
  nand3  g070(.a(x37), .b(x27), .c(x06), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(new_n77_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  nor2   g074(.a(new_n97_), .b(new_n122_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n82_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand4  g077(.a(x35), .b(new_n81_), .c(x27), .d(new_n122_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n78_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n63_), .O(z11));
  nand3  g082(.a(new_n65_), .b(new_n63_), .c(new_n64_), .O(new_n145_));
  oai21  g083(.a(x27), .b(x00), .c(new_n145_), .O(new_n146_));
  oai21  g084(.a(new_n92_), .b(x04), .c(new_n146_), .O(new_n147_));
  inv1   g085(.a(x35), .O(new_n148_));
  nor2   g086(.a(x37), .b(x36), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n97_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(x10), .c(new_n147_), .O(z12));
  ...
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n152_), .d(new_n122_), .O(new_n156_));
  ...
  nand3  g099(.a(new_n129_), .b(new_n152_), .c(new_n122_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n77_), .O(z13));
  nand3  g101(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n164_));
  nand4  g102(.a(new_n154_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n93_), .b(new_n152_), .c(new_n122_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n64_), .b(new_n148_), .c(x28), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(x27), .c(x32), .O(new_n170_));
  aoi22  g108(.a(new_n170_), .b(new_n78_), .c(new_n167_), .d(new_n67_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n168_), .c(new_n77_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nand4  g111(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n174_));
  ...
  oai21  g120(.a(new_n82_), .b(x27), .c(new_n136_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n77_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n140_), .d(new_n78_), .O(z18));
  nand4  g124(.a(new_n142_), .b(new_n63_), .c(new_n78_), .d(new_n135_), .O(new_n187_));
  inv1   g125(.a(new_n187_), .O(z19));
  inv1   g126(.a(new_n136_), .O(new_n189_));
  oai21  g127(.a(new_n148_), .b(new_n97_), .c(new_n139_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n97_), .c(new_n148_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n78_), .c(new_n135_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n63_), .O(z20));
endmodule
