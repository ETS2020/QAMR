...
module FAU ( 
  ...
  aoi21  g061(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n124_));
  nand4  g062(.a(new_n124_), .b(x39), .c(x05), .d(new_n71_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n123_), .O(z10));
  inv1   g064(.a(x09), .O(new_n127_));
  inv1   g065(.a(x39), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n90_), .O(new_n129_));
  ...
  nand3  g077(.a(new_n139_), .b(new_n79_), .c(new_n127_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n64_), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n96_), .c(new_n73_), .O(new_n143_));
  oai21  g081(.a(new_n128_), .b(x04), .c(new_n68_), .O(new_n144_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n96_), .O(new_n153_));
  nand2  g091(.a(new_n80_), .b(new_n79_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n146_), .c(new_n71_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n128_), .O(new_n156_));
  ...
  oai21  g098(.a(new_n158_), .b(new_n128_), .c(new_n160_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n83_), .b(x27), .c(new_n130_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n96_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n132_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n178_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g119(.a(x40), .b(new_n90_), .c(new_n128_), .O(new_n182_));
  aoi21  g120(.a(new_n133_), .b(new_n132_), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n64_), .b(new_n96_), .O(new_n184_));
  nand3  g122(.a(new_n136_), .b(x35), .c(new_n82_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x40), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n184_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n183_), .c(new_n79_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(x09), .O(z19));
  oai21  g127(.a(new_n131_), .b(new_n96_), .c(new_n89_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n96_), .c(new_n131_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n129_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n79_), .c(new_n127_), .O(new_n193_));
