...
module FAU ( 
  ...
  nand4  g41(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n105_));
  nor2   g42(.a(new_n105_), .b(new_n104_), .O(z09));
  inv1   g43(.a(x04), .O(new_n107_));
  nand3  g44(.a(new_n74_), .b(x07), .c(new_n107_), .O(new_n108_));
  nand2  g45(.a(x37), .b(x06), .O(new_n109_));
  nand2  g46(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g47(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g48(.a(new_n111_), .b(z02), .O(z10));
  inv1   g49(.a(x09), .O(new_n113_));
  nand2  g50(.a(x27), .b(x04), .O(new_n114_));
  nor2   g51(.a(x27), .b(x08), .O(new_n115_));
  inv1   g52(.a(new_n115_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(new_n114_), .c(x35), .d(new_n78_), .O(new_n117_));
  nand4  g54(.a(new_n117_), .b(z02), .c(new_n71_), .d(new_n113_), .O(new_n118_));
  inv1   g55(.a(new_n118_), .O(z11));
  inv1   g56(.a(new_n67_), .O(new_n120_));
  nor2   g57(.a(new_n64_), .b(new_n66_), .O(new_n121_));
  nand2  g58(.a(new_n121_), .b(new_n120_), .O(z12));
  inv1   g59(.a(x19), .O(new_n123_));
  nand3  g60(.a(new_n68_), .b(x20), .c(new_n123_), .O(new_n124_));
  oai21  g61(.a(new_n124_), .b(x18), .c(z02), .O(z13));
  nor2   g62(.a(x19), .b(x18), .O(new_n126_));
  nand4  g63(.a(new_n126_), .b(new_n121_), .c(new_n120_), .d(x20), .O(z14));
  nand4  g64(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n128_));
  nand2  g65(.a(new_n128_), .b(z02), .O(z15));
  inv1   g66(.a(x23), .O(new_n130_));
  nand4  g67(.a(z02), .b(new_n130_), .c(x22), .d(x01), .O(new_n131_));
  ...
  inv1   g73(.a(x08), .O(new_n137_));
  nand2  g74(.a(x27), .b(new_n107_), .O(new_n138_));
  oai21  g75(.a(x27), .b(new_n137_), .c(new_n138_), .O(new_n139_));
  nand3  g76(.a(new_n139_), .b(x35), .c(new_n78_), .O(new_n140_));
  nand4  g77(.a(new_n140_), .b(z02), .c(new_n71_), .d(new_n113_), .O(z18));
  oai21  g78(.a(new_n115_), .b(new_n72_), .c(z02), .O(new_n142_));
  nand3  g79(.a(new_n142_), .b(new_n114_), .c(new_n78_), .O(new_n143_));
  nand3  g80(.a(new_n143_), .b(new_n71_), .c(new_n113_), .O(new_n144_));
  nand2  g81(.a(new_n144_), .b(z02), .O(z19));
  oai21  g82(.a(x28), .b(new_n137_), .c(new_n66_), .O(new_n146_));
  nand2  g83(.a(new_n146_), .b(x35), .O(new_n147_));
  nand4  g84(.a(new_n147_), .b(z02), .c(new_n71_), .d(new_n113_), .O(new_n148_));
  inv1   g85(.a(new_n148_), .O(z20));
  zero   g86(.O(z08));
endmodule
