...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(new_n72_), .d(x06), .O(new_n77_));
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n89_), .d(x06), .O(z02));
  nand2  g034(.a(new_n67_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x27), .O(new_n98_));
  aoi21  g036(.a(new_n66_), .b(new_n98_), .c(new_n79_), .O(new_n99_));
  ...
  oai21  g040(.a(new_n90_), .b(new_n98_), .c(new_n66_), .O(new_n103_));
  and2   g041(.a(new_n103_), .b(new_n65_), .O(z05));
  ...
  nand3  g054(.a(x40), .b(x39), .c(x06), .O(new_n117_));
  ...
  nand2  g063(.a(new_n125_), .b(x06), .O(new_n126_));
  nand2  g064(.a(new_n74_), .b(x07), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n122_), .O(new_n128_));
  inv1   g066(.a(x05), .O(new_n129_));
  nand2  g067(.a(new_n81_), .b(new_n80_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(x40), .c(x39), .d(x06), .O(new_n131_));
  ...
  nand2  g073(.a(new_n65_), .b(new_n98_), .O(new_n136_));
  oai21  g074(.a(new_n91_), .b(x04), .c(x06), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(x08), .O(new_n138_));
  nand2  g076(.a(x39), .b(x29), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x06), .c(new_n74_), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n83_), .c(new_n140_), .O(new_n142_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n98_), .c(new_n73_), .O(new_n146_));
  oai21  g084(.a(new_n94_), .b(x04), .c(new_n69_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n65_), .O(z12));
  inv1   g086(.a(x04), .O(new_n149_));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n74_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n149_), .O(new_n153_));
  ...
  nand4  g095(.a(new_n68_), .b(new_n74_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  inv1   g098(.a(x39), .O(new_n161_));
  nand2  g099(.a(new_n130_), .b(x40), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n150_), .c(x06), .d(new_n149_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  nand3  g103(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n95_), .b(new_n150_), .c(new_n149_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n66_), .b(new_n82_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n81_), .c(new_n80_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n69_), .c(new_n79_), .O(new_n174_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n65_), .O(z16));
  inv1   g118(.a(x01), .O(new_n181_));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n65_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n181_), .O(z17));
  nand2  g122(.a(x27), .b(new_n149_), .O(new_n185_));
  nand2  g123(.a(new_n98_), .b(x08), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n82_), .O(new_n187_));
  inv1   g125(.a(x09), .O(new_n188_));
  nand2  g126(.a(new_n80_), .b(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n187_), .b(new_n90_), .c(new_n189_), .O(new_n190_));
  nand4  g128(.a(new_n95_), .b(x29), .c(x08), .d(x06), .O(new_n191_));
  oai21  g129(.a(new_n190_), .b(new_n79_), .c(new_n191_), .O(z18));
  inv1   g130(.a(x08), .O(new_n193_));
  oai21  g131(.a(new_n82_), .b(new_n98_), .c(x06), .O(new_n194_));
  nand2  g132(.a(x40), .b(x04), .O(new_n195_));
  nand2  g133(.a(new_n74_), .b(new_n98_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n195_), .c(new_n194_), .d(new_n90_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n193_), .O(new_n198_));
  nand2  g136(.a(new_n82_), .b(x06), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n141_), .c(new_n90_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n139_), .O(new_n201_));
  nand2  g139(.a(new_n141_), .b(new_n83_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n74_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n201_), .c(new_n198_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n80_), .c(new_n188_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n65_), .O(z19));
  aoi21  g144(.a(x28), .b(new_n98_), .c(new_n82_), .O(new_n207_));
  nor2   g145(.a(new_n207_), .b(new_n140_), .O(new_n208_));
  aoi21  g146(.a(new_n196_), .b(new_n194_), .c(x08), .O(new_n209_));
