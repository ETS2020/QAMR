...
module FAU ( 
  ...
  nor2   g032(.a(x40), .b(x33), .O(new_n95_));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n65_), .c(new_n78_), .O(z05));
  ...
  nand2  g057(.a(new_n119_), .b(new_n110_), .O(new_n120_));
  nand3  g058(.a(new_n117_), .b(x40), .c(new_n115_), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(new_n120_), .c(new_n109_), .O(z07));
  inv1   g060(.a(x39), .O(new_n123_));
  nor2   g061(.a(new_n63_), .b(new_n123_), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n64_), .O(z08));
  ...
  aoi21  g068(.a(x40), .b(new_n123_), .c(new_n95_), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x05), .O(new_n132_));
  oai21  g070(.a(new_n131_), .b(new_n130_), .c(new_n132_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n84_), .c(new_n71_), .O(new_n134_));
  ...
  nor2   g104(.a(new_n140_), .b(x13), .O(new_n167_));
  ...
  nand3  g110(.a(new_n124_), .b(new_n158_), .c(new_n71_), .O(new_n173_));
  ...
  aoi21  g116(.a(new_n173_), .b(new_n68_), .c(new_n78_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n178_), .c(new_n174_), .O(z14));
  inv1   g118(.a(x12), .O(new_n181_));
  nor2   g119(.a(new_n128_), .b(new_n181_), .O(z15));
  ...
  oai22  g132(.a(new_n194_), .b(new_n78_), .c(new_n125_), .d(new_n89_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n100_), .c(new_n175_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(new_n149_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n175_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n144_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n79_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z20));
  nor2   g139(.a(new_n152_), .b(x09), .O(z19));
endmodule
