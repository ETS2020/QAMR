...
module FAU ( 
  ...
  nand4  g050(.a(new_n112_), .b(x40), .c(new_n109_), .d(new_n108_), .O(new_n113_));
  inv1   g051(.a(x14), .O(new_n114_));
  nand2  g052(.a(x38), .b(new_n110_), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(x00), .c(new_n114_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n113_), .c(new_n107_), .O(z07));
  ...
  oai21  g078(.a(new_n140_), .b(new_n86_), .c(new_n139_), .O(new_n141_));
  ...
  nor2   g096(.a(new_n157_), .b(x14), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n127_), .b(new_n151_), .c(new_n65_), .O(new_n161_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n148_), .c(new_n98_), .O(new_n171_));
  ...
  aoi21  g121(.a(new_n183_), .b(new_n140_), .c(new_n66_), .O(new_n184_));
  nand2  g122(.a(new_n83_), .b(new_n133_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n85_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n98_), .c(new_n92_), .d(new_n75_), .O(z18));
  ...
  nand2  g131(.a(new_n80_), .b(new_n114_), .O(new_n194_));
