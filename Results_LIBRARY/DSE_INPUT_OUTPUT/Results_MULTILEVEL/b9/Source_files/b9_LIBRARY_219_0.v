...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x13), .O(new_n81_));
  ...
  nand3  g042(.a(new_n104_), .b(new_n98_), .c(new_n70_), .O(z05));
  ...
  nand3  g054(.a(new_n116_), .b(new_n98_), .c(x03), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z07));
  nand4  g056(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n98_), .O(z09));
  ...
  nand2  g062(.a(new_n85_), .b(new_n84_), .O(new_n125_));
  ...
  nand4  g073(.a(x35), .b(new_n86_), .c(x27), .d(new_n65_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n84_), .c(new_n131_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n98_), .O(z11));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n64_), .O(new_n153_));
  nand3  g091(.a(new_n125_), .b(x39), .c(new_n65_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x40), .c(x13), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n153_), .O(z13));
  nand3  g094(.a(x39), .b(new_n146_), .c(new_n65_), .O(new_n157_));
  nand4  g095(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n73_), .c(new_n157_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n160_));
  nor2   g098(.a(x37), .b(x35), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(new_n147_), .c(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n86_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n85_), .c(new_n84_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n159_), .c(new_n98_), .O(z14));
  nand4  g103(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n98_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand4  g106(.a(new_n98_), .b(new_n168_), .c(x22), .d(x01), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(z16));
  inv1   g108(.a(x24), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(x23), .c(x22), .d(x01), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n98_), .O(z17));
  oai21  g111(.a(new_n87_), .b(x27), .c(new_n132_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n81_), .b(x30), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n175_), .c(new_n136_), .d(new_n131_), .O(z18));
  inv1   g115(.a(new_n132_), .O(new_n178_));
  oai21  g116(.a(new_n66_), .b(new_n64_), .c(new_n135_), .O(new_n179_));
  aoi21  g117(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n178_), .c(new_n179_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n84_), .c(new_n131_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n98_), .O(z20));
  nand2  g121(.a(new_n139_), .b(new_n98_), .O(z19));
endmodule
