...
module FAU ( 
  ...
  oai21  g053(.a(new_n115_), .b(x14), .c(new_n112_), .O(new_n116_));
  ...
  nor2   g061(.a(x40), .b(x31), .O(new_n124_));
  ...
  aoi21  g078(.a(new_n140_), .b(x40), .c(new_n124_), .O(new_n141_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n76_), .c(new_n107_), .O(new_n151_));
  ...
  nand4  g098(.a(new_n72_), .b(new_n107_), .c(x20), .d(new_n158_), .O(new_n161_));
  ...
  oai22  g129(.a(new_n191_), .b(new_n83_), .c(new_n93_), .d(new_n119_), .O(z18));
  nor2   g130(.a(new_n66_), .b(new_n64_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  nand2  g132(.a(new_n77_), .b(x29), .O(new_n195_));
  inv1   g133(.a(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n194_), .c(new_n193_), .d(x08), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n84_), .c(new_n189_), .O(new_n198_));
