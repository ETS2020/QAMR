...
module FAU ( 
  ...
  aoi21  g19(.a(new_n81_), .b(new_n79_), .c(z08), .O(z03));
  ...
  nand3  g23(.a(new_n85_), .b(z02), .c(new_n67_), .O(z05));
  ...
  nand3  g42(.a(new_n75_), .b(x07), .c(new_n104_), .O(new_n105_));
  ...
  nand2  g51(.a(new_n66_), .b(new_n113_), .O(new_n114_));
  nand4  g52(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n111_), .O(new_n115_));
  nand3  g53(.a(new_n115_), .b(new_n72_), .c(new_n110_), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(z02), .O(z11));
  nor2   g55(.a(new_n69_), .b(z08), .O(z12));
  inv1   g56(.a(x19), .O(new_n119_));
  nand3  g57(.a(new_n69_), .b(x20), .c(new_n119_), .O(new_n120_));
  oai21  g58(.a(new_n120_), .b(x18), .c(z02), .O(z13));
  nand2  g59(.a(new_n68_), .b(new_n67_), .O(new_n122_));
  nor2   g60(.a(x19), .b(x18), .O(new_n123_));
  nor2   g61(.a(z08), .b(new_n66_), .O(new_n124_));
  nand4  g62(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(x20), .O(z14));
  inv1   g63(.a(x12), .O(new_n126_));
  nor2   g64(.a(new_n102_), .b(new_n126_), .O(z15));
  inv1   g65(.a(x23), .O(new_n128_));
  nand4  g66(.a(z02), .b(new_n128_), .c(x22), .d(x01), .O(new_n129_));
  inv1   g67(.a(new_n129_), .O(z16));
  ...
  nand2  g72(.a(x27), .b(new_n104_), .O(new_n135_));
  oai21  g73(.a(x27), .b(new_n113_), .c(new_n135_), .O(new_n136_));
  nand3  g74(.a(new_n136_), .b(x35), .c(new_n111_), .O(new_n137_));
  nor2   g75(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g76(.a(new_n138_), .b(new_n137_), .c(z08), .O(z18));
  nand4  g77(.a(new_n115_), .b(z02), .c(new_n72_), .d(new_n110_), .O(new_n140_));
  inv1   g78(.a(new_n140_), .O(z19));
  oai21  g79(.a(x28), .b(new_n113_), .c(new_n66_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g81(.a(new_n143_), .b(z02), .c(new_n72_), .d(new_n110_), .O(new_n144_));
