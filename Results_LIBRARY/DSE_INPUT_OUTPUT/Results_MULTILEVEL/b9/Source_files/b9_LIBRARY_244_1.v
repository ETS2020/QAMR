...
module FAU ( 
  ...
  aoi22  g030(.a(x40), .b(new_n70_), .c(new_n92_), .d(new_n91_), .O(new_n93_));
  ...
  aoi21  g118(.a(x39), .b(new_n180_), .c(new_n67_), .O(new_n181_));
  ...
  nand2  g128(.a(x39), .b(new_n84_), .O(new_n191_));
