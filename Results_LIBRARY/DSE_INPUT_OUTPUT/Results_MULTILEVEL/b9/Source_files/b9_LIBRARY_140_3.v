...
module FAU ( 
  ...
  nand2  g014(.a(x40), .b(x34), .O(new_n77_));
  ...
  nand4  g030(.a(new_n92_), .b(new_n90_), .c(new_n73_), .d(new_n87_), .O(z02));
  oai21  g031(.a(new_n66_), .b(new_n81_), .c(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n64_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n77_), .d(x21), .O(z03));
  inv1   g035(.a(new_n77_), .O(new_n98_));
  aoi21  g036(.a(new_n95_), .b(new_n64_), .c(x21), .O(new_n99_));
  ...
  nand3  g040(.a(new_n101_), .b(new_n77_), .c(new_n95_), .O(new_n103_));
  ...
  nand2  g052(.a(new_n114_), .b(new_n77_), .O(z07));
  nand3  g053(.a(x40), .b(x39), .c(new_n87_), .O(new_n116_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n77_), .O(z10));
  inv1   g069(.a(x08), .O(new_n132_));
  inv1   g070(.a(x09), .O(new_n133_));
  nand4  g071(.a(new_n79_), .b(new_n133_), .c(new_n132_), .d(x04), .O(new_n134_));
  ...
  oai21  g078(.a(new_n82_), .b(new_n64_), .c(new_n132_), .O(new_n141_));
  ...
  nand3  g082(.a(new_n95_), .b(new_n67_), .c(new_n66_), .O(new_n145_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n146_), .c(new_n87_), .O(new_n149_));
  inv1   g087(.a(x40), .O(new_n150_));
  oai21  g088(.a(new_n70_), .b(new_n64_), .c(new_n150_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n150_), .O(new_n155_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n156_), .c(x34), .O(new_n161_));
  nand4  g099(.a(new_n159_), .b(new_n150_), .c(x20), .d(new_n158_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand4  g102(.a(new_n126_), .b(new_n87_), .c(new_n153_), .d(new_n65_), .O(new_n165_));
  ...
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(x34), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n150_), .c(new_n167_), .O(new_n172_));
  nand3  g110(.a(new_n95_), .b(new_n66_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n80_), .c(new_n79_), .O(new_n175_));
  oai21  g113(.a(new_n170_), .b(new_n147_), .c(new_n175_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n87_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n172_), .c(new_n151_), .O(z14));
  nand3  g116(.a(x27), .b(x26), .c(x12), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n150_), .c(new_n87_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand4  g119(.a(new_n77_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z16));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(x23), .c(x22), .d(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n77_), .O(z17));
  oai21  g124(.a(new_n82_), .b(x27), .c(new_n137_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  inv1   g126(.a(new_n82_), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n77_), .d(new_n79_), .O(z18));
  nand2  g130(.a(x40), .b(x04), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(x35), .c(new_n81_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n87_), .c(new_n77_), .d(new_n64_), .O(new_n195_));
  aoi21  g133(.a(x39), .b(x29), .c(x34), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n150_), .c(new_n139_), .O(new_n197_));
  ...
  inv1   g138(.a(new_n137_), .O(new_n201_));
  oai21  g139(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n202_));
  ...
  nand2  g143(.a(new_n205_), .b(new_n77_), .O(z20));
endmodule
