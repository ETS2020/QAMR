...
module FAU ( 
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n95_), .O(z03));
  aoi21  g039(.a(new_n99_), .b(new_n66_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n95_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n99_), .c(new_n95_), .O(z05));
  nand3  g043(.a(new_n104_), .b(new_n64_), .c(new_n99_), .O(new_n106_));
  ...
  oai22  g060(.a(new_n92_), .b(new_n121_), .c(x39), .d(new_n122_), .O(new_n123_));
  ...
  nand3  g082(.a(new_n99_), .b(new_n80_), .c(new_n144_), .O(new_n145_));
  ...
  nand2  g093(.a(new_n96_), .b(new_n99_), .O(new_n156_));
  ...
  nand4  g096(.a(new_n156_), .b(new_n128_), .c(x20), .d(new_n155_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n130_), .b(new_n150_), .c(new_n72_), .O(new_n162_));
  ...
  aoi22  g105(.a(new_n167_), .b(new_n151_), .c(new_n99_), .d(new_n144_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n81_), .c(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n79_), .c(new_n78_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n166_), .c(new_n64_), .O(z14));
  ...
  nand2  g119(.a(x27), .b(new_n72_), .O(new_n182_));
  nand2  g120(.a(new_n66_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n144_), .O(new_n184_));
  nand2  g122(.a(new_n78_), .b(new_n133_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n81_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n95_), .c(new_n92_), .d(new_n88_), .O(z18));
  oai21  g125(.a(new_n135_), .b(x28), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n63_), .b(x39), .c(x27), .O(new_n189_));
  nand2  g127(.a(x40), .b(new_n144_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n138_), .c(new_n81_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n137_), .O(new_n192_));
  oai21  g130(.a(new_n63_), .b(x29), .c(x39), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n144_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n192_), .c(new_n188_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n78_), .c(new_n133_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n64_), .O(z19));
  oai21  g135(.a(new_n81_), .b(x27), .c(x35), .O(new_n198_));
  and2   g136(.a(new_n198_), .b(new_n193_), .O(new_n199_));
  nand2  g137(.a(new_n64_), .b(new_n66_), .O(new_n200_));
  aoi21  g138(.a(new_n190_), .b(new_n200_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n78_), .O(new_n202_));
