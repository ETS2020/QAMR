...
module FAU ( 
  ...
  nand3  g051(.a(new_n113_), .b(new_n104_), .c(x03), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z07));
  nor2   g053(.a(new_n73_), .b(new_n92_), .O(z08));
  nand4  g054(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n104_), .O(z09));
  aoi21  g056(.a(x35), .b(new_n86_), .c(x36), .O(new_n119_));
  ...
  oai21  g069(.a(new_n126_), .b(new_n66_), .c(new_n131_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(z08), .b(x29), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n81_), .O(new_n136_));
  ...
  nand2  g087(.a(new_n149_), .b(new_n92_), .O(new_n150_));
  ...
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n92_), .O(new_n170_));
  ...
  oai21  g128(.a(x40), .b(x39), .c(new_n66_), .O(new_n191_));
  oai21  g129(.a(new_n80_), .b(x04), .c(x39), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n191_), .c(new_n86_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n138_), .O(new_n194_));
  nand2  g132(.a(x40), .b(x29), .O(new_n195_));
  nand2  g133(.a(x39), .b(new_n80_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n135_), .c(new_n86_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n195_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n80_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n135_), .c(new_n86_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n92_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n198_), .c(new_n194_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n78_), .c(new_n133_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n104_), .O(z19));
  nand2  g142(.a(x28), .b(new_n66_), .O(new_n205_));
  nand2  g143(.a(new_n195_), .b(x39), .O(new_n206_));
  aoi22  g144(.a(new_n206_), .b(new_n93_), .c(new_n205_), .d(x35), .O(new_n207_));
