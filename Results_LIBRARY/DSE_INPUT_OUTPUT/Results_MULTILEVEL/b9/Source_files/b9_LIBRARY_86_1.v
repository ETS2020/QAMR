...
module FAU ( 
  ...
  nand2  g010(.a(x10), .b(new_n65_), .O(new_n73_));
  ...
  nor2   g022(.a(new_n72_), .b(x15), .O(new_n85_));
  ...
  aoi21  g030(.a(new_n92_), .b(x04), .c(new_n74_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(new_n90_), .c(new_n85_), .O(z02));
  oai21  g032(.a(new_n66_), .b(new_n80_), .c(x27), .O(new_n95_));
  inv1   g033(.a(x37), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(new_n64_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n86_), .d(x21), .O(z03));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n85_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n86_), .c(new_n96_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(z06));
  inv1   g042(.a(x03), .O(new_n105_));
  inv1   g043(.a(x31), .O(new_n106_));
  inv1   g044(.a(x33), .O(new_n107_));
  oai21  g045(.a(x19), .b(x17), .c(new_n63_), .O(new_n108_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n86_), .c(new_n112_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n111_), .c(new_n105_), .O(z07));
  inv1   g054(.a(x39), .O(new_n117_));
  inv1   g055(.a(x40), .O(new_n118_));
  nor3   g056(.a(new_n85_), .b(new_n118_), .c(new_n117_), .O(z08));
  ...
  nand3  g075(.a(new_n91_), .b(x27), .c(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n78_), .c(new_n133_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n86_), .O(z11));
  ...
  oai22  g083(.a(new_n74_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n86_), .O(z12));
  ...
  nand3  g092(.a(new_n154_), .b(new_n72_), .c(new_n152_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n65_), .c(new_n85_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  aoi21  g099(.a(x20), .b(new_n152_), .c(x19), .O(new_n162_));
  nor2   g100(.a(new_n72_), .b(new_n63_), .O(new_n163_));
  nand4  g101(.a(new_n149_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand4  g103(.a(x40), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n166_));
  oai22  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .d(new_n162_), .O(new_n167_));
  ...
  oai21  g108(.a(new_n70_), .b(new_n64_), .c(new_n166_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n72_), .O(new_n173_));
  nand4  g111(.a(new_n79_), .b(new_n78_), .c(new_n64_), .d(x15), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n167_), .O(z14));
  nand4  g113(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n86_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand4  g116(.a(new_n86_), .b(new_n178_), .c(x22), .d(x01), .O(new_n179_));
  inv1   g117(.a(new_n179_), .O(z16));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(x23), .c(x22), .d(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n86_), .O(z17));
  oai21  g121(.a(new_n81_), .b(x27), .c(new_n134_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n85_), .b(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n138_), .d(new_n78_), .O(z18));
  inv1   g125(.a(new_n134_), .O(new_n188_));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n189_));
  ...
  nand2  g130(.a(new_n192_), .b(new_n86_), .O(z20));
  nand2  g131(.a(new_n141_), .b(new_n86_), .O(z19));
endmodule
