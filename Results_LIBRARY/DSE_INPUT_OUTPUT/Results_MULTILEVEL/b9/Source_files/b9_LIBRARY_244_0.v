...
module FAU ( 
  ...
  nand2  g056(.a(new_n81_), .b(new_n118_), .O(z08));
  ...
  nor3   g066(.a(new_n99_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  nand2  g073(.a(new_n77_), .b(x29), .O(new_n136_));
  ...
  inv1   g102(.a(new_n96_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n166_));
  nand4  g104(.a(new_n153_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x40), .b(new_n152_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n75_), .O(new_n170_));
  ...
  nand3  g115(.a(new_n149_), .b(x40), .c(new_n75_), .O(new_n178_));
  ...
  oai21  g126(.a(new_n91_), .b(x27), .c(new_n136_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n99_), .b(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n141_), .d(new_n135_), .O(z18));
  nand2  g130(.a(new_n81_), .b(new_n64_), .O(new_n193_));
  nand3  g131(.a(x35), .b(new_n90_), .c(new_n65_), .O(new_n194_));
  ...
  aoi22  g136(.a(new_n198_), .b(new_n96_), .c(new_n137_), .d(new_n85_), .O(new_n199_));
  ...
  aoi22  g140(.a(new_n202_), .b(x35), .c(new_n198_), .d(new_n96_), .O(new_n203_));
  nand2  g141(.a(x39), .b(new_n66_), .O(new_n204_));
  aoi21  g142(.a(new_n204_), .b(new_n193_), .c(x08), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n203_), .c(new_n83_), .O(new_n206_));
