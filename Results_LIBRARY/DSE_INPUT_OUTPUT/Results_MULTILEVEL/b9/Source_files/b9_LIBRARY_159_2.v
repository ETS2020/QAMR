...
module FAU ( 
  ...
  nand4  g038(.a(new_n100_), .b(new_n99_), .c(new_n85_), .d(x21), .O(z03));
  ...
  nand3  g043(.a(new_n104_), .b(new_n85_), .c(new_n70_), .O(new_n106_));
  ...
  nand2  g058(.a(new_n120_), .b(new_n85_), .O(z09));
  nand2  g059(.a(x39), .b(x05), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(x04), .c(x40), .O(new_n123_));
  ...
  nand3  g066(.a(z08), .b(x32), .c(x05), .O(new_n129_));
  ...
  nand3  g074(.a(new_n136_), .b(x35), .c(new_n87_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand4  g077(.a(x35), .b(new_n87_), .c(x27), .d(new_n65_), .O(new_n140_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n81_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n149_), .O(new_n155_));
  ...
  oai21  g099(.a(new_n149_), .b(new_n86_), .c(new_n81_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n85_), .O(z13));
  nand3  g102(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n165_));
  nand4  g103(.a(new_n154_), .b(new_n86_), .c(new_n81_), .d(x28), .O(new_n166_));
  ...
  nand3  g109(.a(new_n171_), .b(new_n86_), .c(new_n81_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n150_), .c(new_n82_), .O(new_n173_));
  ...
  nand2  g116(.a(new_n178_), .b(new_n85_), .O(z16));
  inv1   g117(.a(x01), .O(new_n180_));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n85_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  oai21  g121(.a(new_n88_), .b(x27), .c(new_n135_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n140_), .c(new_n81_), .d(new_n134_), .O(z18));
  nand2  g124(.a(x39), .b(x29), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n137_), .O(new_n188_));
  oai21  g126(.a(new_n149_), .b(new_n139_), .c(new_n66_), .O(new_n189_));
  nand3  g127(.a(new_n87_), .b(x27), .c(new_n65_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n139_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n189_), .c(new_n188_), .O(new_n192_));
  aoi21  g130(.a(new_n136_), .b(new_n87_), .c(x40), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n81_), .c(new_n193_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(x09), .c(new_n85_), .O(z19));
  inv1   g133(.a(new_n135_), .O(new_n196_));
  oai21  g134(.a(new_n66_), .b(new_n64_), .c(new_n139_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n81_), .c(new_n134_), .O(new_n200_));
