...
module FAU ( 
  ...
  nand2  g018(.a(x27), .b(new_n80_), .O(new_n81_));
  ...
  oai21  g026(.a(new_n88_), .b(new_n80_), .c(x27), .O(new_n89_));
  ...
  aoi21  g030(.a(new_n87_), .b(x04), .c(new_n75_), .O(new_n93_));
  oai21  g031(.a(new_n92_), .b(x02), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g038(.a(new_n71_), .b(x27), .c(x12), .O(new_n101_));
  nand2  g039(.a(new_n70_), .b(new_n64_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(z03));
  oai21  g041(.a(new_n71_), .b(new_n80_), .c(x27), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n102_), .c(new_n99_), .O(z04));
  aoi21  g043(.a(x28), .b(x27), .c(x37), .O(new_n106_));
  oai22  g044(.a(new_n106_), .b(new_n80_), .c(new_n70_), .d(x27), .O(z05));
  nand2  g045(.a(new_n86_), .b(x12), .O(new_n108_));
  ...
  nand2  g058(.a(new_n81_), .b(new_n75_), .O(z08));
  inv1   g059(.a(x34), .O(new_n122_));
  nand4  g060(.a(x27), .b(x26), .c(x12), .d(x11), .O(new_n123_));
  ...
  nand2  g073(.a(new_n135_), .b(x12), .O(new_n136_));
  ...
  nand2  g078(.a(new_n87_), .b(new_n81_), .O(new_n141_));
  nand3  g079(.a(x27), .b(x12), .c(x04), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  nand3  g081(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x12), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x08), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n143_), .c(new_n84_), .O(new_n147_));
  ...
  nand3  g100(.a(new_n162_), .b(new_n159_), .c(x12), .O(new_n163_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n152_), .c(new_n83_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n171_), .O(z14));
  nand2  g114(.a(x34), .b(x26), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(x12), .c(new_n64_), .O(z15));
  ...
  nand2  g124(.a(new_n145_), .b(x27), .O(new_n187_));
  oai21  g125(.a(new_n87_), .b(x27), .c(new_n139_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n84_), .d(new_n186_), .O(z18));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n96_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n140_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n84_), .c(new_n186_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n81_), .O(z20));
  nor2   g133(.a(new_n147_), .b(x09), .O(z19));
endmodule
