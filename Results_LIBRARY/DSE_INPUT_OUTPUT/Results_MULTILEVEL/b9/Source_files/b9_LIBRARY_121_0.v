...
module FAU ( 
  ...
  nand2  g052(.a(new_n114_), .b(new_n83_), .O(z07));
  inv1   g053(.a(x39), .O(new_n116_));
  nor3   g054(.a(new_n63_), .b(new_n71_), .c(new_n116_), .O(z08));
  ...
  aoi21  g071(.a(new_n133_), .b(x04), .c(x30), .O(z11));
  nand3  g072(.a(new_n95_), .b(new_n78_), .c(new_n77_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(x27), .c(x10), .O(new_n136_));
  inv1   g074(.a(new_n67_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x27), .c(new_n92_), .O(new_n138_));
  ...
  nand4  g083(.a(new_n92_), .b(x30), .c(new_n145_), .d(new_n121_), .O(new_n146_));
  oai21  g084(.a(new_n144_), .b(x18), .c(new_n146_), .O(z13));
  oai21  g085(.a(new_n91_), .b(x13), .c(x30), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  nand4  g087(.a(x27), .b(x20), .c(new_n142_), .d(new_n149_), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  aoi22  g089(.a(new_n151_), .b(new_n137_), .c(new_n148_), .d(new_n121_), .O(z14));
  ...
  inv1   g098(.a(x08), .O(new_n161_));
  aoi21  g099(.a(new_n130_), .b(new_n129_), .c(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x09), .c(x04), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n76_), .O(z18));
  nand3  g102(.a(x35), .b(new_n87_), .c(new_n66_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n129_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n128_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x04), .c(x30), .O(z19));
  inv1   g107(.a(new_n129_), .O(new_n170_));
  aoi21  g108(.a(x28), .b(new_n66_), .c(new_n77_), .O(new_n171_));
  oai21  g109(.a(new_n77_), .b(new_n66_), .c(new_n161_), .O(new_n172_));
  oai21  g110(.a(new_n171_), .b(new_n170_), .c(new_n172_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n128_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(x04), .c(x30), .O(z20));
endmodule
