...
module FAU ( 
  ...
  nand2  g037(.a(new_n66_), .b(new_n99_), .O(new_n100_));
  ...
  oai21  g070(.a(new_n129_), .b(new_n99_), .c(new_n132_), .O(z10));
  nand2  g071(.a(new_n65_), .b(new_n99_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n90_), .c(new_n72_), .O(new_n135_));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n83_), .c(new_n139_), .d(new_n96_), .O(new_n141_));
  ...
  nand3  g096(.a(new_n131_), .b(new_n148_), .c(new_n72_), .O(new_n159_));
  ...
  nand4  g109(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n172_));
  ...
  nand2  g125(.a(new_n140_), .b(new_n83_), .O(new_n188_));
  nand3  g126(.a(x40), .b(x39), .c(x29), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  oai21  g129(.a(new_n181_), .b(new_n91_), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n80_), .c(new_n184_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n65_), .O(z19));
  inv1   g133(.a(new_n189_), .O(new_n196_));
  oai21  g134(.a(new_n82_), .b(new_n99_), .c(new_n191_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n99_), .c(new_n82_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n184_), .O(new_n200_));
