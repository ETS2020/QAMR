...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x11), .O(new_n81_));
  ...
  nor2   g036(.a(x40), .b(x11), .O(new_n99_));
  ...
  nor2   g060(.a(new_n122_), .b(new_n76_), .O(z09));
  inv1   g061(.a(x07), .O(new_n124_));
  aoi21  g062(.a(x40), .b(new_n75_), .c(new_n99_), .O(new_n125_));
  ...
  nand2  g081(.a(x27), .b(new_n65_), .O(new_n144_));
  ...
  nand3  g108(.a(z08), .b(new_n156_), .c(new_n65_), .O(new_n171_));
  ...
  aoi21  g113(.a(new_n171_), .b(new_n153_), .c(new_n83_), .O(new_n176_));
  ...
  inv1   g125(.a(x28), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n144_), .c(new_n66_), .O(new_n190_));
  nand2  g128(.a(new_n84_), .b(new_n138_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n188_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n83_), .c(new_n93_), .d(new_n152_), .O(z18));
  inv1   g131(.a(x11), .O(new_n194_));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n95_), .c(new_n194_), .O(new_n196_));
  nand2  g134(.a(new_n140_), .b(new_n188_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n139_), .O(new_n198_));
  nand2  g136(.a(x35), .b(x27), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(x04), .c(new_n143_), .O(new_n200_));
  ...
  nand2  g142(.a(x28), .b(new_n143_), .O(new_n205_));
  ...
  aoi21  g148(.a(new_n210_), .b(new_n100_), .c(new_n209_), .O(new_n211_));
  nand2  g149(.a(new_n81_), .b(new_n64_), .O(new_n212_));
  nand2  g150(.a(x40), .b(new_n66_), .O(new_n213_));
  aoi21  g151(.a(new_n213_), .b(new_n212_), .c(x08), .O(new_n214_));
  oai21  g152(.a(new_n214_), .b(new_n211_), .c(new_n84_), .O(new_n215_));
