// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:32 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n189_;
  nor2   g000(.a(x19), .b(x10), .O(new_n63_));
  ...
  inv1   g010(.a(x19), .O(new_n73_));
  oai21  g011(.a(x36), .b(x35), .c(x27), .O(new_n74_));
  oai21  g012(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand4  g013(.a(new_n75_), .b(x40), .c(x39), .d(new_n64_), .O(new_n76_));
  oai22  g014(.a(new_n76_), .b(x04), .c(new_n71_), .d(new_n63_), .O(z00));
  ...
  nand3  g030(.a(new_n92_), .b(x35), .c(new_n81_), .O(new_n93_));
  nand2  g031(.a(x40), .b(x39), .O(new_n94_));
  aoi21  g032(.a(new_n93_), .b(x04), .c(new_n94_), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n89_), .c(new_n63_), .O(z02));
  nand2  g034(.a(new_n67_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi21  g036(.a(new_n66_), .b(new_n91_), .c(new_n98_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n97_), .c(new_n63_), .O(z03));
  aoi21  g038(.a(new_n66_), .b(new_n91_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n97_), .c(new_n63_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n66_), .c(new_n63_), .O(z05));
  inv1   g042(.a(new_n63_), .O(new_n105_));
  nand3  g043(.a(new_n103_), .b(new_n105_), .c(new_n66_), .O(new_n106_));
  ...
  nand2  g056(.a(new_n94_), .b(new_n105_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n105_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  inv1   g060(.a(x04), .O(new_n123_));
  nand2  g061(.a(new_n94_), .b(x07), .O(new_n124_));
  nand3  g062(.a(x40), .b(x39), .c(x05), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n83_), .c(x27), .O(new_n127_));
  nand2  g065(.a(new_n79_), .b(new_n78_), .O(new_n128_));
  nand4  g066(.a(new_n128_), .b(x40), .c(x39), .d(x05), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n123_), .O(new_n131_));
  nand3  g069(.a(x37), .b(x27), .c(x06), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n63_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nor2   g073(.a(new_n91_), .b(new_n123_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n82_), .c(new_n135_), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n81_), .c(x27), .d(new_n123_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n90_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n105_), .c(new_n78_), .d(new_n134_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  oai21  g080(.a(new_n94_), .b(x04), .c(new_n69_), .O(new_n143_));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n66_), .b(new_n80_), .c(new_n144_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(x27), .c(x19), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n72_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n143_), .O(z12));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n149_), .d(new_n123_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  nand4  g092(.a(new_n68_), .b(x20), .c(new_n73_), .d(new_n154_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n123_), .c(new_n63_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  nand3  g099(.a(x20), .b(new_n73_), .c(new_n154_), .O(new_n162_));
  nand4  g100(.a(new_n151_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand4  g102(.a(x40), .b(x39), .c(new_n149_), .d(new_n123_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n66_), .b(new_n144_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n79_), .c(new_n78_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n69_), .c(new_n63_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n166_), .O(z14));
  nand4  g109(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n105_), .O(z15));
  inv1   g111(.a(x23), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(x22), .c(x01), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n105_), .O(z16));
  inv1   g114(.a(x01), .O(new_n177_));
  inv1   g115(.a(x24), .O(new_n178_));
  nand4  g116(.a(new_n105_), .b(new_n178_), .c(x23), .d(x22), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(new_n177_), .O(z17));
  oai21  g118(.a(new_n82_), .b(x27), .c(new_n135_), .O(new_n181_));
  nand3  g119(.a(new_n138_), .b(new_n78_), .c(new_n134_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(x08), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n63_), .O(z18));
  inv1   g122(.a(new_n135_), .O(new_n185_));
  oai21  g123(.a(new_n144_), .b(new_n91_), .c(new_n90_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n91_), .c(new_n144_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n78_), .c(new_n134_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n105_), .O(z20));
  inv1   g128(.a(new_n141_), .O(z19));
endmodule
