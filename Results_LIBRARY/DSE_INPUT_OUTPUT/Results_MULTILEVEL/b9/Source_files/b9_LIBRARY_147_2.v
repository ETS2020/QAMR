...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x34), .O(new_n64_));
  ...
  nor2   g031(.a(x40), .b(x34), .O(new_n94_));
  ...
  nor2   g058(.a(new_n120_), .b(new_n63_), .O(z09));
  ...
  nand3  g064(.a(new_n126_), .b(new_n85_), .c(new_n74_), .O(new_n127_));
  ...
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n94_), .O(new_n142_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n99_), .c(new_n75_), .O(new_n148_));
  oai21  g086(.a(new_n118_), .b(x04), .c(new_n71_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n64_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n63_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n74_), .O(new_n154_));
  ...
  nor2   g097(.a(new_n133_), .b(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n74_), .c(new_n65_), .O(new_n161_));
  ...
  nand3  g102(.a(x39), .b(new_n151_), .c(new_n74_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n63_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n94_), .c(new_n163_), .O(new_n168_));
  ...
  oai21  g110(.a(new_n166_), .b(new_n72_), .c(new_n172_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x40), .O(new_n174_));
  inv1   g112(.a(x34), .O(new_n175_));
  nand3  g113(.a(new_n71_), .b(new_n63_), .c(new_n175_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n174_), .c(new_n168_), .O(z14));
  nand3  g115(.a(x27), .b(x26), .c(x12), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(x40), .c(new_n175_), .O(z15));
  ...
  oai22  g125(.a(new_n118_), .b(new_n187_), .c(new_n84_), .d(x27), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n99_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n140_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g130(.a(x28), .b(new_n99_), .c(new_n169_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n142_), .O(new_n194_));
  nand2  g132(.a(x40), .b(new_n169_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n137_), .c(x08), .O(new_n196_));
