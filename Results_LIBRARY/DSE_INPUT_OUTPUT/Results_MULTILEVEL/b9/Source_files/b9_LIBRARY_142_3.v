...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n90_), .c(new_n89_), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(x40), .O(z02));
  nand2  g035(.a(new_n71_), .b(x27), .O(new_n98_));
  aoi22  g036(.a(x40), .b(x14), .c(new_n70_), .d(new_n64_), .O(new_n99_));
  ...
  nand2  g050(.a(new_n112_), .b(new_n89_), .O(new_n113_));
  ...
  oai21  g054(.a(x39), .b(x14), .c(x40), .O(new_n117_));
  ...
  nand4  g068(.a(new_n130_), .b(new_n89_), .c(x05), .d(new_n65_), .O(new_n131_));
  oai21  g069(.a(new_n127_), .b(new_n64_), .c(new_n131_), .O(z10));
  inv1   g070(.a(x08), .O(new_n133_));
  inv1   g071(.a(x09), .O(new_n134_));
  nand4  g072(.a(new_n83_), .b(new_n134_), .c(new_n133_), .d(x04), .O(new_n135_));
  ...
  oai21  g079(.a(new_n92_), .b(new_n64_), .c(new_n133_), .O(new_n142_));
  ...
  nand4  g099(.a(new_n128_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n162_));
  ...
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(x14), .O(new_n170_));
  ...
  oai21  g127(.a(new_n92_), .b(x27), .c(new_n138_), .O(new_n190_));
  ...
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n81_), .d(new_n134_), .O(z18));
  nand2  g132(.a(x35), .b(x27), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n89_), .O(new_n196_));
  nand2  g134(.a(x40), .b(x04), .O(new_n197_));
  nand2  g135(.a(new_n76_), .b(new_n64_), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n197_), .c(new_n196_), .d(new_n91_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n133_), .O(new_n200_));
  nand2  g138(.a(x39), .b(x29), .O(new_n201_));
  nand2  g139(.a(new_n66_), .b(new_n89_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n139_), .c(new_n91_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n201_), .O(new_n204_));
  nand2  g142(.a(new_n140_), .b(new_n76_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n83_), .c(new_n134_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n81_), .O(z19));
  aoi21  g146(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n209_));
  aoi21  g147(.a(new_n201_), .b(new_n89_), .c(new_n76_), .O(new_n210_));
  nand2  g148(.a(new_n198_), .b(new_n196_), .O(new_n211_));
  nand2  g149(.a(new_n211_), .b(new_n133_), .O(new_n212_));
  oai21  g150(.a(new_n210_), .b(new_n209_), .c(new_n212_), .O(new_n213_));
  nand3  g151(.a(new_n213_), .b(new_n83_), .c(new_n134_), .O(new_n214_));
