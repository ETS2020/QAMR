...
module FAU ( 
  ...
  nor2   g054(.a(new_n64_), .b(new_n116_), .O(z08));
  ...
  nand2  g059(.a(x40), .b(new_n116_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n94_), .c(new_n121_), .O(new_n123_));
  nand3  g061(.a(x40), .b(x39), .c(x05), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n123_), .c(new_n85_), .O(new_n126_));
  ...
  nor2   g068(.a(new_n130_), .b(new_n116_), .O(new_n131_));
  ...
  nand3  g077(.a(new_n136_), .b(x27), .c(new_n72_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x08), .c(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n80_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x09), .c(new_n65_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n97_), .c(new_n74_), .O(new_n146_));
  nand2  g084(.a(z08), .b(new_n72_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n69_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n65_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n64_), .O(new_n157_));
  nand4  g095(.a(new_n68_), .b(x22), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n131_), .b(new_n150_), .c(new_n72_), .O(new_n161_));
  ...
  nand3  g103(.a(z08), .b(new_n150_), .c(new_n72_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n66_), .b(new_n135_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n81_), .c(new_n80_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n69_), .c(new_n79_), .O(new_n171_));
  ...
  nand2  g114(.a(new_n176_), .b(new_n65_), .O(z16));
  nand3  g115(.a(x23), .b(x22), .c(x01), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(x24), .O(z17));
  oai21  g117(.a(new_n84_), .b(x27), .c(new_n134_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n141_), .b(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n181_), .c(new_n65_), .d(new_n80_), .O(z18));
  nand2  g121(.a(new_n65_), .b(new_n97_), .O(new_n184_));
  oai21  g122(.a(new_n84_), .b(x04), .c(x40), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(x08), .O(new_n186_));
  inv1   g124(.a(new_n138_), .O(new_n187_));
  aoi21  g125(.a(x39), .b(x29), .c(new_n64_), .O(new_n188_));
  aoi21  g126(.a(new_n64_), .b(x22), .c(new_n188_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n186_), .c(new_n80_), .O(new_n191_));
  nor2   g129(.a(new_n191_), .b(x09), .O(z19));
  aoi21  g130(.a(x28), .b(new_n97_), .c(new_n135_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n189_), .O(new_n194_));
  nand2  g132(.a(x40), .b(new_n135_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n184_), .c(x08), .O(new_n196_));
