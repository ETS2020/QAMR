...
module FAU ( 
  ...
  nor2   g015(.a(new_n77_), .b(x10), .O(new_n78_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n79_), .d(new_n73_), .O(z02));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n78_), .O(z03));
  aoi21  g037(.a(new_n97_), .b(new_n64_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n78_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n79_), .c(new_n97_), .O(z05));
  ...
  oai21  g067(.a(new_n129_), .b(new_n125_), .c(new_n65_), .O(new_n130_));
  nand3  g068(.a(x37), .b(x27), .c(x06), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n78_), .O(z10));
  ...
  nand4  g075(.a(x35), .b(new_n83_), .c(x27), .d(new_n65_), .O(new_n138_));
  ...
  nor2   g081(.a(new_n72_), .b(x04), .O(new_n144_));
  inv1   g082(.a(x10), .O(new_n145_));
  nand3  g083(.a(new_n97_), .b(new_n67_), .c(new_n66_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(x27), .c(new_n77_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  oai21  g086(.a(new_n144_), .b(new_n143_), .c(new_n148_), .O(z12));
  ...
  nor3   g096(.a(new_n128_), .b(x13), .c(x04), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(new_n77_), .O(new_n160_));
  aoi21  g098(.a(new_n151_), .b(x28), .c(new_n64_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n127_), .c(x40), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n116_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n150_), .c(x10), .d(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  aoi21  g103(.a(x20), .b(new_n154_), .c(x19), .O(new_n166_));
  nor2   g104(.a(new_n77_), .b(new_n145_), .O(new_n167_));
  nand4  g105(.a(new_n151_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n73_), .b(new_n150_), .c(new_n65_), .O(new_n170_));
  oai22  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .d(new_n166_), .O(new_n171_));
  inv1   g109(.a(new_n170_), .O(new_n172_));
  ...
  oai21  g113(.a(new_n172_), .b(new_n143_), .c(new_n175_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n77_), .O(new_n177_));
  nand4  g115(.a(new_n82_), .b(new_n81_), .c(new_n64_), .d(x10), .O(new_n178_));
  ...
  oai21  g126(.a(new_n84_), .b(x27), .c(new_n134_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n78_), .b(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n138_), .d(new_n81_), .O(z18));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n193_));
  nand2  g131(.a(new_n134_), .b(new_n66_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(new_n78_), .O(new_n195_));
  oai21  g133(.a(x28), .b(x04), .c(new_n137_), .O(new_n196_));
  oai21  g134(.a(new_n135_), .b(x28), .c(new_n134_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n81_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(x09), .c(new_n79_), .O(z19));
  inv1   g138(.a(new_n134_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n201_), .c(new_n193_), .O(new_n203_));
  nand4  g141(.a(new_n203_), .b(new_n79_), .c(new_n81_), .d(new_n133_), .O(new_n204_));
