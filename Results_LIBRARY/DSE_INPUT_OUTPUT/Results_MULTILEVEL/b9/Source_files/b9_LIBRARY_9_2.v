...
module FAU ( 
  ...
  aoi22  g030(.a(new_n92_), .b(x04), .c(new_n89_), .d(new_n88_), .O(new_n93_));
  ...
  aoi21  g070(.a(new_n132_), .b(new_n91_), .c(new_n131_), .O(new_n133_));
  ...
  oai21  g079(.a(new_n125_), .b(x04), .c(new_n68_), .O(new_n142_));
  ...
  nand4  g089(.a(new_n67_), .b(new_n125_), .c(x20), .d(new_n149_), .O(new_n152_));
  ...
  nand3  g094(.a(x39), .b(new_n144_), .c(new_n71_), .O(new_n157_));
  ...
  nand2  g115(.a(new_n96_), .b(x08), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(new_n90_), .O(new_n179_));
  ...
  oai22  g120(.a(new_n182_), .b(new_n78_), .c(new_n119_), .d(new_n89_), .O(z18));
  nand2  g121(.a(new_n132_), .b(new_n91_), .O(new_n184_));
  nor2   g122(.a(new_n125_), .b(new_n130_), .O(new_n185_));
  ...
  oai21  g130(.a(new_n90_), .b(new_n96_), .c(new_n188_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n96_), .c(new_n90_), .O(new_n194_));
