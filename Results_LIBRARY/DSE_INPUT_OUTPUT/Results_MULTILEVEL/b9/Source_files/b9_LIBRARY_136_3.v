...
module FAU ( 
  ...
  aoi21  g037(.a(new_n99_), .b(new_n64_), .c(new_n92_), .O(z05));
  ...
  nand2  g050(.a(new_n86_), .b(new_n63_), .O(z08));
  ...
  nand3  g061(.a(x37), .b(new_n88_), .c(x06), .O(new_n124_));
  ...
  nand3  g067(.a(new_n129_), .b(x05), .c(new_n70_), .O(new_n130_));
  ...
  nand2  g072(.a(new_n81_), .b(new_n88_), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  oai21  g075(.a(new_n81_), .b(new_n78_), .c(new_n88_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n70_), .c(x08), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n137_), .c(new_n132_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n63_), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n78_), .c(new_n72_), .O(new_n143_));
  oai21  g081(.a(new_n86_), .b(x04), .c(new_n67_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n63_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x40), .c(x39), .d(new_n146_), .O(new_n149_));
  inv1   g087(.a(x18), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n66_), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(x04), .O(new_n153_));
  nand4  g091(.a(new_n66_), .b(new_n88_), .c(x20), .d(new_n151_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n129_), .b(new_n146_), .c(new_n70_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n159_));
  inv1   g097(.a(x32), .O(new_n160_));
  nand4  g098(.a(new_n147_), .b(new_n160_), .c(new_n88_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand4  g100(.a(x40), .b(x39), .c(new_n146_), .d(new_n70_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n159_), .O(new_n164_));
  inv1   g102(.a(x35), .O(new_n165_));
  nand3  g103(.a(new_n64_), .b(new_n165_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n160_), .c(new_n88_), .O(new_n168_));
  ...
  oai21  g117(.a(new_n81_), .b(x27), .c(new_n133_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  inv1   g119(.a(new_n81_), .O(new_n182_));
  nor2   g120(.a(new_n78_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(x30), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n181_), .c(new_n132_), .O(z18));
  nor2   g123(.a(new_n165_), .b(new_n78_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n78_), .c(new_n165_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n134_), .c(new_n186_), .d(x08), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n88_), .c(new_n132_), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(z20));
  nand2  g128(.a(new_n140_), .b(new_n63_), .O(z19));
endmodule
