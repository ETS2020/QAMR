...
module FAU ( 
  ...
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n79_), .O(new_n137_));
  nand4  g74(.a(new_n137_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(z18));
  oai21  g75(.a(new_n113_), .b(new_n72_), .c(new_n63_), .O(new_n139_));
  nand3  g76(.a(new_n139_), .b(new_n112_), .c(new_n79_), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(new_n71_), .c(new_n111_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(new_n63_), .O(z19));
  oai21  g79(.a(x28), .b(new_n134_), .c(new_n66_), .O(new_n143_));
  nand2  g80(.a(new_n143_), .b(x35), .O(new_n144_));
  nand4  g81(.a(new_n144_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(new_n145_));
