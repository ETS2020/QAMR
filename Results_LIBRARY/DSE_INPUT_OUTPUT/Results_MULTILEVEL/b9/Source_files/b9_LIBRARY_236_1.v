...
module FAU ( 
  ...
  nand3  g044(.a(new_n106_), .b(new_n101_), .c(new_n105_), .O(z04));
  oai21  g045(.a(new_n87_), .b(new_n64_), .c(new_n70_), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(new_n105_), .O(z06));
  ...
  nand2  g059(.a(new_n121_), .b(new_n105_), .O(z07));
  nand2  g060(.a(new_n105_), .b(new_n75_), .O(z08));
  inv1   g061(.a(x11), .O(new_n124_));
  nand4  g062(.a(new_n105_), .b(x34), .c(x27), .d(x26), .O(new_n125_));
  ...
  nand3  g067(.a(new_n129_), .b(new_n89_), .c(x27), .O(new_n130_));
  ...
  nand3  g087(.a(new_n149_), .b(x27), .c(new_n81_), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(x10), .c(new_n148_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  inv1   g091(.a(x40), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n154_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n157_));
  ...
  nand3  g100(.a(new_n131_), .b(x40), .c(x39), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n65_), .c(new_n82_), .O(new_n165_));
  ...
  nand3  g107(.a(new_n76_), .b(new_n153_), .c(new_n65_), .O(new_n170_));
  ...
  aoi22  g111(.a(new_n173_), .b(new_n85_), .c(new_n170_), .d(new_n147_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(new_n82_), .O(z14));
  nand4  g113(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n105_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x22), .c(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n105_), .O(z16));
  inv1   g118(.a(x01), .O(new_n181_));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n105_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n181_), .O(z17));
  oai21  g122(.a(new_n88_), .b(x27), .c(new_n138_), .O(new_n185_));
  nand3  g123(.a(new_n142_), .b(new_n85_), .c(new_n137_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(x08), .c(new_n186_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n82_), .O(z18));
  nand3  g126(.a(new_n144_), .b(new_n85_), .c(new_n137_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n105_), .O(z19));
  inv1   g128(.a(new_n138_), .O(new_n191_));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n96_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n85_), .c(new_n137_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n105_), .O(z20));
endmodule
