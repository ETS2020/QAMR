...
module FAU ( 
  ...
  nand3  g109(.a(x34), .b(x27), .c(x26), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(x24), .c(new_n171_), .O(z15));
  inv1   g111(.a(x23), .O(new_n174_));
  nand4  g112(.a(new_n64_), .b(new_n174_), .c(x22), .d(x01), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(z16));
  nand3  g114(.a(x23), .b(x22), .c(x01), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n171_), .c(x24), .O(z17));
