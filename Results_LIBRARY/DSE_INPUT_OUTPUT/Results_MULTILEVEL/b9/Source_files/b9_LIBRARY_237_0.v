...
module FAU ( 
  ...
  nand3  g044(.a(new_n105_), .b(new_n65_), .c(new_n66_), .O(new_n107_));
  ...
  nand2  g081(.a(new_n65_), .b(new_n100_), .O(new_n144_));
  ...
  aoi21  g085(.a(x39), .b(x29), .c(new_n64_), .O(new_n148_));
  aoi21  g086(.a(new_n64_), .b(x33), .c(new_n148_), .O(new_n149_));
  ...
  oai21  g092(.a(new_n154_), .b(new_n100_), .c(new_n74_), .O(new_n155_));
  oai21  g093(.a(new_n124_), .b(x04), .c(new_n69_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n155_), .c(new_n65_), .O(z12));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n72_), .c(new_n79_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(z13));
  nand3  g107(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n170_));
  nand4  g108(.a(new_n159_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  nand3  g110(.a(new_n123_), .b(new_n158_), .c(new_n72_), .O(new_n173_));
