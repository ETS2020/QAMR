...
module FAU ( 
  ...
  nand3  g068(.a(new_n75_), .b(x32), .c(x05), .O(new_n131_));
  ...
  oai21  g079(.a(new_n141_), .b(new_n85_), .c(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n82_), .c(new_n136_), .O(new_n144_));
  ...
  aoi21  g085(.a(new_n72_), .b(x27), .c(new_n75_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n65_), .O(new_n149_));
  nand2  g087(.a(new_n72_), .b(x27), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n82_), .c(x04), .O(new_n151_));
  ...
  oai21  g100(.a(new_n83_), .b(x04), .c(new_n82_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x40), .c(x39), .d(new_n153_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(new_n79_), .O(z13));
  nand3  g103(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n166_));
  nand3  g104(.a(new_n155_), .b(new_n83_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n65_), .c(x30), .O(new_n168_));
  aoi21  g106(.a(new_n75_), .b(new_n153_), .c(x04), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  aoi21  g108(.a(x32), .b(new_n65_), .c(x27), .O(new_n171_));
  nand2  g109(.a(new_n71_), .b(x04), .O(new_n172_));
  nand3  g110(.a(new_n66_), .b(new_n83_), .c(x28), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(x37), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n171_), .c(new_n82_), .O(new_n175_));
  nand2  g113(.a(new_n75_), .b(new_n153_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n150_), .c(new_n65_), .O(new_n177_));
  ...
  oai21  g124(.a(new_n85_), .b(new_n64_), .c(new_n82_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n65_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n84_), .c(new_n64_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n137_), .c(new_n140_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(x09), .c(new_n82_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n188_), .O(z18));
