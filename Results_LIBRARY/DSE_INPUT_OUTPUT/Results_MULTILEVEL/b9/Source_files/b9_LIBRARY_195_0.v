...
module FAU ( 
  ...
  nor2   g017(.a(x11), .b(x05), .O(new_n80_));
  ...
  nand4  g039(.a(new_n99_), .b(new_n98_), .c(new_n81_), .d(new_n101_), .O(z04));
  ...
  nand3  g062(.a(new_n75_), .b(x11), .c(x07), .O(new_n125_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n80_), .O(z12));
  ...
  aoi22  g107(.a(new_n169_), .b(new_n83_), .c(new_n166_), .d(new_n148_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n167_), .c(new_n80_), .O(z14));
  ...
  oai21  g117(.a(new_n86_), .b(x27), .c(new_n136_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n80_), .b(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n181_), .c(new_n140_), .d(new_n83_), .O(z18));
  ...
  nand4  g132(.a(new_n194_), .b(new_n81_), .c(new_n83_), .d(new_n135_), .O(new_n195_));
