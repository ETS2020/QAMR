...
module FAU ( 
  ...
  nand3  g53(.a(new_n116_), .b(new_n70_), .c(new_n111_), .O(new_n117_));
  nand2  g54(.a(new_n117_), .b(z02), .O(z11));
  aoi21  g55(.a(new_n66_), .b(x27), .c(new_n77_), .O(z12));
  nand4  g56(.a(z02), .b(new_n66_), .c(x27), .d(x20), .O(new_n120_));
  nor3   g57(.a(new_n120_), .b(x19), .c(x18), .O(z13));
  nor2   g58(.a(x19), .b(x18), .O(new_n122_));
  nor2   g59(.a(new_n77_), .b(new_n80_), .O(new_n123_));
  nand4  g60(.a(new_n123_), .b(new_n122_), .c(new_n66_), .d(x20), .O(z14));
  ...
  nand2  g65(.a(new_n128_), .b(z02), .O(z16));
  ...
  aoi21  g73(.a(new_n136_), .b(new_n135_), .c(new_n77_), .O(z18));
  nand4  g74(.a(new_n116_), .b(z02), .c(new_n70_), .d(new_n111_), .O(new_n138_));
  inv1   g75(.a(new_n138_), .O(z19));
  oai21  g76(.a(x28), .b(new_n114_), .c(new_n80_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n70_), .c(new_n111_), .O(new_n142_));
