...
module FAU ( 
  ...
  nor2   g019(.a(x30), .b(new_n81_), .O(new_n82_));
  ...
  nand4  g028(.a(new_n90_), .b(new_n86_), .c(new_n85_), .d(new_n81_), .O(new_n91_));
  ...
  oai21  g042(.a(new_n87_), .b(new_n64_), .c(new_n70_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n93_), .O(z06));
  ...
  nand2  g056(.a(new_n118_), .b(new_n93_), .O(z07));
  nand2  g057(.a(new_n93_), .b(new_n75_), .O(z08));
  inv1   g058(.a(x11), .O(new_n121_));
  nand4  g059(.a(new_n93_), .b(x34), .c(x27), .d(x26), .O(new_n122_));
  ...
  nand4  g079(.a(new_n141_), .b(new_n85_), .c(new_n81_), .d(new_n134_), .O(new_n142_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n93_), .O(z12));
  inv1   g087(.a(x40), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n150_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n81_), .d(new_n65_), .O(new_n153_));
  ...
  nand3  g103(.a(new_n76_), .b(new_n81_), .c(new_n65_), .O(new_n166_));
  ...
  oai21  g107(.a(new_n169_), .b(x13), .c(new_n85_), .O(new_n170_));
  ...
  nand4  g113(.a(new_n93_), .b(new_n175_), .c(x22), .d(x01), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n93_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  oai21  g119(.a(new_n88_), .b(x27), .c(new_n135_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(x13), .b(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n139_), .d(new_n85_), .O(z18));
  inv1   g123(.a(new_n135_), .O(new_n186_));
  aoi21  g124(.a(new_n66_), .b(new_n81_), .c(x28), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n136_), .c(new_n186_), .O(new_n188_));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(new_n81_), .O(new_n189_));
  nor2   g127(.a(x28), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n134_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n81_), .c(x30), .O(z19));
  ...
  nand4  g134(.a(new_n196_), .b(new_n85_), .c(new_n81_), .d(new_n134_), .O(new_n197_));
