...
module FAU ( 
  ...
  aoi21  g18(.a(new_n81_), .b(new_n66_), .c(z08), .O(new_n82_));
  ...
  aoi21  g23(.a(new_n86_), .b(new_n81_), .c(z08), .O(z05));
  nand3  g24(.a(new_n86_), .b(new_n63_), .c(new_n81_), .O(new_n88_));
  inv1   g25(.a(new_n88_), .O(z06));
  inv1   g26(.a(x31), .O(new_n90_));
  inv1   g27(.a(x33), .O(new_n91_));
  nand2  g28(.a(x17), .b(new_n65_), .O(new_n92_));
  ...
  nand3  g37(.a(new_n100_), .b(new_n63_), .c(x03), .O(new_n101_));
  inv1   g38(.a(new_n101_), .O(z07));
  inv1   g39(.a(x11), .O(new_n103_));
  nand4  g40(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n104_));
  ...
  nand3  g46(.a(new_n109_), .b(new_n63_), .c(x27), .O(new_n110_));
  ...
  nand4  g52(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n79_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(new_n63_), .c(new_n71_), .d(new_n112_), .O(new_n117_));
  inv1   g54(.a(new_n117_), .O(z11));
  inv1   g55(.a(new_n67_), .O(new_n119_));
  nand3  g56(.a(new_n119_), .b(new_n63_), .c(x27), .O(z12));
  inv1   g57(.a(x18), .O(new_n121_));
  inv1   g58(.a(x19), .O(new_n122_));
  nand4  g59(.a(new_n68_), .b(x20), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  nand2  g60(.a(new_n123_), .b(new_n63_), .O(z13));
  nand4  g61(.a(x27), .b(x20), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  inv1   g62(.a(new_n125_), .O(new_n126_));
  aoi21  g63(.a(new_n126_), .b(new_n119_), .c(z08), .O(z14));
  nand4  g64(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n128_));
  nand2  g65(.a(new_n128_), .b(new_n63_), .O(z15));
  inv1   g66(.a(x23), .O(new_n130_));
  nand4  g67(.a(new_n63_), .b(new_n130_), .c(x22), .d(x01), .O(new_n131_));
  inv1   g68(.a(new_n131_), .O(z16));
  inv1   g69(.a(x01), .O(new_n133_));
  inv1   g70(.a(x24), .O(new_n134_));
  nand4  g71(.a(new_n63_), .b(new_n134_), .c(x23), .d(x22), .O(new_n135_));
  nor2   g72(.a(new_n135_), .b(new_n133_), .O(z17));
  nand2  g73(.a(x27), .b(new_n106_), .O(new_n137_));
  oai21  g74(.a(x27), .b(new_n114_), .c(new_n137_), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(x35), .c(new_n79_), .O(new_n139_));
  nand4  g76(.a(new_n139_), .b(new_n63_), .c(new_n71_), .d(new_n112_), .O(z18));
  oai21  g77(.a(x28), .b(new_n114_), .c(new_n66_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(x35), .O(new_n142_));
  nand4  g79(.a(new_n142_), .b(new_n63_), .c(new_n71_), .d(new_n112_), .O(new_n143_));
