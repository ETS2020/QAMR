...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n189_;
  nor2   g000(.a(x17), .b(x09), .O(new_n63_));
  ...
  nand3  g038(.a(new_n100_), .b(new_n96_), .c(new_n82_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n82_), .c(new_n71_), .O(z05));
  ...
  nor2   g064(.a(new_n126_), .b(new_n116_), .O(new_n127_));
  ...
  nand3  g076(.a(new_n92_), .b(x27), .c(new_n66_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n83_), .c(x17), .d(new_n133_), .O(new_n142_));
  ...
  nand3  g096(.a(new_n127_), .b(new_n150_), .c(new_n66_), .O(new_n159_));
  ...
  aoi21  g106(.a(new_n164_), .b(new_n147_), .c(new_n63_), .O(new_n169_));
  ...
  nand2  g117(.a(new_n92_), .b(new_n65_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n134_), .c(new_n138_), .O(new_n181_));
  nand2  g119(.a(new_n139_), .b(new_n83_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(x17), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n133_), .O(z18));
  inv1   g122(.a(new_n134_), .O(new_n185_));
  oai21  g123(.a(new_n67_), .b(new_n65_), .c(new_n138_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n83_), .c(x17), .d(new_n133_), .O(new_n189_));
