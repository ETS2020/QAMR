...
module FAU ( 
  ...
  nor2   g037(.a(new_n81_), .b(new_n68_), .O(new_n100_));
  inv1   g038(.a(new_n100_), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n78_), .c(new_n69_), .O(z05));
  oai21  g040(.a(new_n100_), .b(x37), .c(new_n78_), .O(z06));
  ...
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n147_), .d(new_n120_), .O(new_n150_));
  ...
  nand4  g094(.a(x39), .b(x32), .c(new_n147_), .d(new_n120_), .O(new_n157_));
  ...
  nand3  g100(.a(x39), .b(new_n147_), .c(new_n120_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n162_), .c(x30), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n64_), .c(new_n161_), .O(new_n166_));
  nand3  g104(.a(new_n69_), .b(new_n140_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x27), .c(x32), .O(new_n168_));
  nor2   g106(.a(new_n164_), .b(new_n71_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n63_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n166_), .c(new_n145_), .O(z14));
  inv1   g109(.a(x12), .O(new_n172_));
  nand4  g110(.a(new_n78_), .b(x34), .c(x27), .d(x26), .O(new_n173_));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n131_), .c(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n135_), .b(new_n130_), .O(new_n183_));
  ...
  oai21  g124(.a(new_n140_), .b(new_n68_), .c(new_n134_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n68_), .c(new_n140_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n63_), .c(new_n130_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z20));
  nand2  g129(.a(new_n138_), .b(new_n78_), .O(z19));
endmodule
