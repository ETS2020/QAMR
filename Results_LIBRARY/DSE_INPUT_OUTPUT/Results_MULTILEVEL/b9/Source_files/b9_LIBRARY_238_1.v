// Benchmark "FAU" written by ABC on Thu Aug 13 18:18:29 2020
...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(x24), .d(new_n66_), .O(new_n78_));
  oai22  g016(.a(new_n78_), .b(x04), .c(new_n73_), .d(new_n65_), .O(z00));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x24), .O(new_n93_));
  ...
  aoi21  g035(.a(new_n68_), .b(new_n97_), .c(new_n96_), .O(new_n98_));
  ...
  aoi21  g055(.a(new_n117_), .b(x24), .c(new_n75_), .O(z08));
  ...
  nand4  g060(.a(x40), .b(x39), .c(x24), .d(x05), .O(new_n123_));
  oai21  g061(.a(z08), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n85_), .c(new_n121_), .O(new_n125_));
  nand3  g063(.a(new_n64_), .b(x37), .c(x06), .O(new_n126_));
  ...
  nor3   g067(.a(new_n129_), .b(new_n117_), .c(new_n63_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n121_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(z10));
  inv1   g070(.a(x08), .O(new_n133_));
  inv1   g071(.a(x09), .O(new_n134_));
  nand4  g072(.a(new_n80_), .b(new_n134_), .c(new_n133_), .d(x04), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x24), .O(new_n136_));
  ...
  oai21  g080(.a(new_n84_), .b(new_n97_), .c(new_n133_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n80_), .c(new_n134_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n137_), .O(z11));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n97_), .c(new_n74_), .O(new_n148_));
  nand3  g086(.a(x40), .b(x39), .c(new_n121_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n71_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n64_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n75_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n121_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n70_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n63_), .O(new_n159_));
  nand4  g097(.a(new_n70_), .b(new_n75_), .c(x20), .d(new_n157_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n130_), .b(new_n152_), .c(new_n121_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n162_), .O(z13));
  nand3  g102(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n165_));
  nand4  g103(.a(new_n153_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n166_));
  nand3  g104(.a(x39), .b(new_n152_), .c(new_n121_), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n63_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n75_), .c(new_n165_), .O(new_n170_));
  inv1   g108(.a(x35), .O(new_n171_));
  nand3  g109(.a(new_n68_), .b(new_n171_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n81_), .c(new_n80_), .O(new_n174_));
  oai21  g112(.a(new_n168_), .b(new_n72_), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x24), .O(new_n176_));
  nand2  g114(.a(new_n71_), .b(new_n75_), .O(new_n177_));
  ...
  nand3  g122(.a(x23), .b(x22), .c(x01), .O(new_n185_));
  nor3   g123(.a(new_n185_), .b(x40), .c(x24), .O(z17));
  oai21  g124(.a(new_n84_), .b(x27), .c(new_n138_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n97_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n139_), .c(x30), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n64_), .d(new_n134_), .O(z18));
  oai21  g129(.a(new_n171_), .b(new_n97_), .c(x24), .O(new_n192_));
  nand2  g130(.a(x40), .b(x04), .O(new_n193_));
  nand2  g131(.a(new_n75_), .b(new_n97_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n193_), .c(new_n192_), .d(new_n83_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n133_), .O(new_n196_));
  nand2  g134(.a(x39), .b(x29), .O(new_n197_));
  nand2  g135(.a(new_n171_), .b(x24), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n140_), .c(new_n83_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n197_), .O(new_n200_));
  nand2  g138(.a(new_n141_), .b(new_n75_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n200_), .c(new_n196_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n80_), .c(new_n134_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n64_), .O(z19));
  aoi21  g142(.a(x28), .b(new_n97_), .c(new_n171_), .O(new_n205_));
  aoi21  g143(.a(new_n197_), .b(x24), .c(new_n75_), .O(new_n206_));
  nor2   g144(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  aoi21  g145(.a(new_n194_), .b(new_n192_), .c(x08), .O(new_n208_));
  oai21  g146(.a(new_n208_), .b(new_n207_), .c(new_n80_), .O(new_n209_));
