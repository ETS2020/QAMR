...
module FAU ( 
  ...
  nor2   g000(.a(x10), .b(x00), .O(new_n63_));
  ...
  oai21  g080(.a(new_n93_), .b(x04), .c(new_n67_), .O(new_n143_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x00), .O(new_n148_));
  nand2  g086(.a(new_n94_), .b(new_n120_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n69_), .c(x10), .O(new_n150_));
  ...
  nor2   g122(.a(new_n63_), .b(x09), .O(new_n185_));
