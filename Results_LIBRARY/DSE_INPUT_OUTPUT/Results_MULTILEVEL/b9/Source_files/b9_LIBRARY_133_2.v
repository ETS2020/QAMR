...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x31), .O(new_n96_));
  ...
  aoi21  g064(.a(x40), .b(new_n75_), .c(new_n96_), .O(new_n127_));
  ...
  nand3  g092(.a(new_n154_), .b(new_n76_), .c(new_n111_), .O(new_n155_));
  ...
  nand4  g102(.a(new_n72_), .b(new_n111_), .c(x20), .d(new_n162_), .O(new_n165_));
  ...
  oai21  g126(.a(new_n86_), .b(x27), .c(new_n139_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n99_), .b(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n145_), .d(new_n138_), .O(z18));
  nand2  g130(.a(new_n81_), .b(new_n64_), .O(new_n193_));
  oai21  g131(.a(new_n86_), .b(x04), .c(x40), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(x08), .O(new_n195_));
  nand2  g133(.a(x39), .b(x29), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(x40), .c(new_n96_), .O(new_n197_));
  aoi21  g135(.a(new_n141_), .b(new_n140_), .c(new_n197_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n83_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z19));
  inv1   g138(.a(new_n139_), .O(new_n201_));
  oai21  g139(.a(new_n66_), .b(new_n64_), .c(new_n144_), .O(new_n202_));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n83_), .c(new_n138_), .O(new_n205_));
