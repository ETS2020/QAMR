...
module FAU ( 
  ...
  nor2   g029(.a(x40), .b(x10), .O(new_n92_));
  ...
  nand2  g034(.a(new_n65_), .b(new_n96_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g036(.a(new_n64_), .O(new_n99_));
  aoi21  g037(.a(new_n65_), .b(new_n96_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n99_), .O(z04));
  nor2   g039(.a(new_n81_), .b(new_n96_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n64_), .c(new_n65_), .O(z05));
  oai21  g042(.a(new_n102_), .b(x37), .c(new_n64_), .O(z06));
  ...
  nor2   g067(.a(new_n129_), .b(new_n117_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n71_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(z10));
  nor2   g070(.a(new_n63_), .b(new_n117_), .O(new_n133_));
  ...
  nand3  g077(.a(new_n136_), .b(x27), .c(new_n71_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x08), .c(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n78_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x09), .c(new_n64_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n96_), .c(new_n73_), .O(new_n146_));
  oai21  g084(.a(new_n117_), .b(x04), .c(new_n68_), .O(new_n147_));
  nand2  g085(.a(new_n67_), .b(new_n73_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n63_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n146_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x28), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n71_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n67_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n154_), .c(new_n63_), .O(new_n158_));
  nor2   g096(.a(new_n157_), .b(x10), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n130_), .b(new_n151_), .c(new_n71_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand3  g100(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n163_));
  nand4  g101(.a(new_n152_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(new_n133_), .b(new_n151_), .c(new_n71_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n65_), .b(new_n135_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n79_), .c(new_n78_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n68_), .c(new_n99_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nand4  g111(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n174_));
  ...
  nand4  g118(.a(new_n64_), .b(new_n180_), .c(x23), .d(x22), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n179_), .O(z17));
  oai21  g120(.a(new_n82_), .b(x27), .c(new_n134_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n141_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n64_), .d(new_n78_), .O(z18));
  nand2  g124(.a(new_n64_), .b(new_n96_), .O(new_n187_));
  oai21  g125(.a(new_n82_), .b(x04), .c(x40), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(x08), .O(new_n189_));
  nand2  g127(.a(x39), .b(x29), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(x40), .c(new_n92_), .O(new_n191_));
  aoi21  g129(.a(new_n137_), .b(new_n136_), .c(new_n191_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n189_), .c(new_n78_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(x09), .O(z19));
  aoi21  g132(.a(x28), .b(new_n96_), .c(new_n135_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n191_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n135_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n187_), .c(x08), .O(new_n198_));
