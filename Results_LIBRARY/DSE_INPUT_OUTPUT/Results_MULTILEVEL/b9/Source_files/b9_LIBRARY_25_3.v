...
module FAU ( 
  ...
  nor2   g095(.a(new_n156_), .b(x12), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(x27), .O(new_n159_));
  nand2  g097(.a(x30), .b(new_n120_), .O(new_n160_));
  nand2  g098(.a(x32), .b(new_n83_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n160_), .c(new_n150_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x39), .c(new_n149_), .d(new_n67_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n159_), .O(z13));
  nand3  g102(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n165_));
  nand4  g103(.a(new_n151_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n78_), .b(new_n149_), .c(new_n67_), .O(new_n168_));
  ...
  nand3  g113(.a(x27), .b(x26), .c(x12), .O(new_n176_));
  nor3   g114(.a(new_n176_), .b(new_n175_), .c(x30), .O(z15));
  ...
  nand2  g122(.a(new_n92_), .b(new_n66_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n134_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n138_), .c(new_n83_), .d(new_n133_), .O(z18));
  inv1   g126(.a(new_n134_), .O(new_n189_));
  oai21  g127(.a(new_n68_), .b(new_n66_), .c(new_n137_), .O(new_n190_));
