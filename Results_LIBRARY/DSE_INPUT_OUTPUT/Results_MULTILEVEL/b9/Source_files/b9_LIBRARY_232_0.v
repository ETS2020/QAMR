...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x29), .O(new_n63_));
  ...
  nor2   g027(.a(new_n82_), .b(x08), .O(new_n90_));
  aoi21  g028(.a(x30), .b(new_n82_), .c(new_n90_), .O(new_n91_));
  ...
  oai22  g032(.a(new_n94_), .b(new_n63_), .c(new_n91_), .d(x02), .O(z02));
  ...
  nand2  g038(.a(new_n71_), .b(new_n65_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n96_), .c(new_n100_), .d(new_n97_), .O(z04));
  nor2   g040(.a(new_n84_), .b(new_n65_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n100_), .c(new_n71_), .O(z05));
  oai21  g043(.a(new_n103_), .b(x37), .c(new_n100_), .O(z06));
  ...
  nand3  g053(.a(new_n115_), .b(new_n100_), .c(x03), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z07));
  nand2  g055(.a(new_n76_), .b(new_n100_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n100_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  ...
  oai21  g073(.a(new_n135_), .b(new_n85_), .c(new_n76_), .O(new_n136_));
  ...
  aoi21  g080(.a(new_n142_), .b(x29), .c(x30), .O(z11));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n150_), .d(new_n66_), .O(new_n154_));
  ...
  nor3   g097(.a(new_n127_), .b(new_n126_), .c(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n66_), .c(new_n63_), .O(new_n161_));
  ...
  nand2  g102(.a(new_n164_), .b(new_n100_), .O(new_n165_));
  aoi21  g103(.a(x36), .b(x35), .c(x32), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n83_), .c(x29), .d(x28), .O(new_n167_));
  ...
  nand2  g110(.a(new_n164_), .b(new_n147_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x29), .O(new_n175_));
  nand3  g113(.a(new_n164_), .b(new_n147_), .c(x30), .O(new_n176_));
  ...
  nand2  g119(.a(new_n181_), .b(new_n100_), .O(z16));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(x23), .c(x22), .d(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n100_), .O(z17));
  oai21  g123(.a(new_n85_), .b(x27), .c(new_n76_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand3  g125(.a(new_n92_), .b(x27), .c(new_n66_), .O(new_n188_));
  nor2   g126(.a(x30), .b(new_n82_), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n187_), .d(new_n134_), .O(z18));
  nand2  g128(.a(new_n188_), .b(new_n137_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n136_), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n83_), .c(x29), .d(new_n134_), .O(new_n193_));
  ...
  oai21  g134(.a(new_n196_), .b(new_n77_), .c(new_n195_), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n83_), .c(x29), .d(new_n134_), .O(new_n198_));
