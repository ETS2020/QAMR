...
module FAU ( 
  ...
  nand2  g000(.a(x24), .b(x12), .O(new_n63_));
  ...
  nand4  g076(.a(x35), .b(new_n85_), .c(x27), .d(new_n67_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n63_), .c(new_n83_), .d(new_n134_), .O(new_n142_));
  ...
  nand3  g097(.a(new_n128_), .b(new_n150_), .c(new_n67_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n64_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n78_), .b(new_n150_), .c(new_n67_), .O(new_n165_));
  ...
  aoi22  g106(.a(new_n168_), .b(new_n83_), .c(new_n165_), .d(new_n147_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n166_), .c(new_n64_), .O(z14));
  inv1   g108(.a(x12), .O(new_n171_));
  inv1   g109(.a(x24), .O(new_n172_));
  nand3  g110(.a(x34), .b(x27), .c(x26), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(new_n171_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand4  g113(.a(new_n63_), .b(new_n175_), .c(x22), .d(x01), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z16));
  nand4  g115(.a(new_n172_), .b(x23), .c(x22), .d(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n63_), .O(z17));
  oai21  g117(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n180_));
  nand3  g118(.a(new_n139_), .b(new_n83_), .c(new_n134_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(x08), .c(new_n181_), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n64_), .O(z18));
  inv1   g121(.a(new_n135_), .O(new_n184_));
  oai21  g122(.a(new_n68_), .b(new_n66_), .c(new_n138_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n186_));
