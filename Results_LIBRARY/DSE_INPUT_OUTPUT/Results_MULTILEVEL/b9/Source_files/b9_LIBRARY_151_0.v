...
module FAU ( 
  ...
  nor2   g043(.a(new_n105_), .b(new_n83_), .O(z05));
  ...
  nor3   g067(.a(new_n83_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g074(.a(x35), .b(new_n91_), .c(new_n65_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x39), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n136_), .c(x08), .O(new_n139_));
  inv1   g077(.a(x29), .O(new_n140_));
  oai21  g078(.a(new_n76_), .b(new_n140_), .c(x39), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n86_), .c(new_n141_), .d(new_n97_), .O(new_n143_));
  ...
  nand3  g088(.a(new_n150_), .b(x40), .c(new_n75_), .O(new_n151_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n150_), .c(new_n83_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n170_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nor2   g114(.a(new_n122_), .b(new_n176_), .O(z15));
  ...
  oai22  g122(.a(new_n92_), .b(x27), .c(new_n119_), .d(new_n140_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n64_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n86_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n81_), .d(new_n84_), .O(z18));
  aoi21  g127(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n190_));
  aoi21  g128(.a(new_n141_), .b(new_n97_), .c(new_n190_), .O(new_n191_));
  nand2  g129(.a(x39), .b(new_n66_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n136_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n84_), .O(new_n194_));
