...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n196_;
  nor2   g000(.a(x30), .b(x12), .O(new_n63_));
  ...
  nor2   g021(.a(new_n67_), .b(x28), .O(new_n84_));
  oai21  g022(.a(new_n84_), .b(x36), .c(x27), .O(new_n85_));
  nand4  g023(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(x12), .O(new_n86_));
  oai21  g024(.a(new_n63_), .b(x04), .c(new_n86_), .O(z01));
  inv1   g025(.a(x12), .O(new_n88_));
  nand2  g026(.a(new_n82_), .b(new_n88_), .O(new_n89_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n92_), .c(new_n77_), .d(new_n89_), .O(z02));
  nand2  g035(.a(new_n72_), .b(x27), .O(new_n98_));
  nand2  g036(.a(new_n71_), .b(new_n65_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n98_), .c(new_n89_), .d(x21), .O(z03));
  aoi21  g038(.a(new_n71_), .b(new_n65_), .c(x21), .O(new_n101_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n89_), .c(x03), .O(new_n115_));
  ...
  nand4  g058(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  nand3  g060(.a(new_n76_), .b(new_n89_), .c(x07), .O(new_n123_));
  nand3  g061(.a(new_n77_), .b(x12), .c(x05), .O(new_n124_));
  aoi22  g062(.a(new_n124_), .b(new_n123_), .c(new_n94_), .d(new_n68_), .O(new_n125_));
  inv1   g063(.a(x06), .O(new_n126_));
  nor3   g064(.a(new_n63_), .b(new_n71_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n66_), .c(new_n127_), .O(new_n128_));
  aoi21  g066(.a(x32), .b(x12), .c(x30), .O(new_n129_));
  nor3   g067(.a(new_n129_), .b(new_n118_), .c(new_n117_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n66_), .O(new_n131_));
  oai21  g069(.a(new_n128_), .b(new_n65_), .c(new_n131_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(new_n77_), .b(x29), .O(new_n134_));
  nor2   g072(.a(new_n65_), .b(new_n66_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n94_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand3  g075(.a(new_n84_), .b(x27), .c(new_n66_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n133_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x12), .c(x30), .O(z11));
  ...
  nand2  g083(.a(new_n73_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n76_), .b(x04), .c(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n89_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n118_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n149_), .d(new_n66_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand4  g092(.a(new_n73_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(new_n88_), .O(new_n156_));
  nand4  g094(.a(new_n73_), .b(x30), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n130_), .b(new_n149_), .c(new_n66_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  nand3  g100(.a(new_n77_), .b(new_n149_), .c(new_n66_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n89_), .O(new_n164_));
  aoi21  g102(.a(x36), .b(x35), .c(x32), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n82_), .c(x28), .d(x12), .O(new_n166_));
  ...
  and2   g110(.a(new_n163_), .b(new_n146_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(x12), .O(new_n174_));
  nand2  g112(.a(new_n173_), .b(x30), .O(new_n175_));
  ...
  nand2  g118(.a(new_n180_), .b(new_n89_), .O(z16));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(x23), .c(x22), .d(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n89_), .O(z17));
  nand2  g122(.a(new_n84_), .b(new_n65_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n134_), .c(new_n137_), .O(new_n186_));
  nand2  g124(.a(new_n138_), .b(new_n133_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(x12), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n82_), .O(z18));
  nand4  g127(.a(new_n140_), .b(new_n82_), .c(x12), .d(new_n133_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z19));
  inv1   g129(.a(new_n134_), .O(new_n192_));
  oai21  g130(.a(new_n67_), .b(new_n65_), .c(new_n137_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n133_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(x12), .c(x30), .O(z20));
endmodule
