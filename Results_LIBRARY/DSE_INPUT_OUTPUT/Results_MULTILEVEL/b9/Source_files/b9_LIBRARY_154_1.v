...
module FAU ( 
  ...
  aoi21  g024(.a(new_n86_), .b(x04), .c(new_n81_), .O(z01));
  ...
  nand4  g032(.a(new_n94_), .b(new_n90_), .c(new_n74_), .d(x06), .O(z02));
  ...
  oai21  g040(.a(new_n91_), .b(new_n64_), .c(new_n98_), .O(new_n103_));
  ...
  oai21  g072(.a(new_n92_), .b(x04), .c(x06), .O(new_n135_));
  ...
  aoi21  g077(.a(new_n139_), .b(new_n84_), .c(new_n138_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(new_n82_), .O(new_n141_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n144_), .c(x06), .O(new_n147_));
  ...
  nand4  g096(.a(new_n128_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x06), .c(new_n73_), .O(new_n160_));
  ...
  nand3  g101(.a(x39), .b(new_n150_), .c(new_n65_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n78_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n73_), .c(new_n162_), .O(new_n167_));
  nand3  g105(.a(new_n98_), .b(new_n66_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n83_), .c(new_n82_), .O(new_n170_));
  oai21  g108(.a(new_n165_), .b(new_n145_), .c(new_n170_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x06), .O(new_n172_));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n84_), .c(x30), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n185_), .c(new_n79_), .d(new_n182_), .O(z18));
  nand2  g126(.a(x40), .b(x04), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(x35), .c(new_n91_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x06), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n134_), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n140_), .c(new_n82_), .O(new_n193_));
  ...
  nand3  g136(.a(new_n198_), .b(new_n82_), .c(new_n182_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n79_), .O(z20));
endmodule
