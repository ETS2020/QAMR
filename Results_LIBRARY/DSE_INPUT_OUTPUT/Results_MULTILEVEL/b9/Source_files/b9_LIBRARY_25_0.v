...
module FAU ( 
  ...
  nor3   g055(.a(new_n63_), .b(new_n117_), .c(new_n116_), .O(z08));
  nand4  g056(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n104_), .O(z09));
  ...
  aoi21  g084(.a(new_n146_), .b(new_n145_), .c(new_n63_), .O(z12));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n82_), .O(new_n155_));
  nand4  g093(.a(new_n73_), .b(x30), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand2  g096(.a(x32), .b(x12), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n83_), .c(new_n117_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n148_), .d(new_n66_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n163_));
  nand4  g101(.a(new_n149_), .b(new_n125_), .c(new_n83_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(new_n77_), .b(new_n148_), .c(new_n66_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n71_), .b(new_n67_), .c(x28), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x27), .c(x32), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n82_), .c(new_n83_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(new_n65_), .c(new_n166_), .O(new_n171_));
  ...
  nand2  g114(.a(new_n176_), .b(new_n104_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n104_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  nand2  g119(.a(new_n91_), .b(new_n65_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n133_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n82_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n138_), .d(new_n83_), .O(z18));
  ...
  nand4  g128(.a(new_n190_), .b(new_n83_), .c(x12), .d(new_n132_), .O(new_n191_));
