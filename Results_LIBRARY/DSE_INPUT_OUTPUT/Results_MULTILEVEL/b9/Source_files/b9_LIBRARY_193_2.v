...
module FAU ( 
  ...
  oai21  g012(.a(new_n74_), .b(x06), .c(new_n73_), .O(new_n75_));
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(new_n78_), .O(z02));
  nand2  g033(.a(new_n68_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x27), .O(new_n97_));
  nand2  g035(.a(new_n67_), .b(new_n97_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n78_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n67_), .b(new_n97_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n64_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n67_), .c(new_n64_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n78_), .c(new_n67_), .O(new_n104_));
  ...
  oai21  g060(.a(new_n67_), .b(new_n97_), .c(x10), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x06), .O(new_n124_));
  inv1   g062(.a(x04), .O(new_n125_));
  nand2  g063(.a(new_n93_), .b(x07), .O(new_n126_));
  ...
  nand2  g072(.a(new_n134_), .b(new_n124_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x40), .b(x39), .c(x29), .O(new_n137_));
  nor2   g075(.a(new_n97_), .b(new_n125_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n83_), .c(new_n137_), .O(new_n139_));
  inv1   g077(.a(x08), .O(new_n140_));
  nand4  g078(.a(x35), .b(new_n82_), .c(x27), .d(new_n125_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n78_), .c(new_n79_), .d(new_n136_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z11));
  oai21  g083(.a(new_n93_), .b(x04), .c(new_n68_), .O(new_n146_));
  inv1   g084(.a(x35), .O(new_n147_));
  nand3  g085(.a(new_n81_), .b(new_n147_), .c(new_n73_), .O(new_n148_));
  ...
  nand2  g089(.a(new_n94_), .b(new_n125_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n70_), .c(x10), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n151_), .O(z12));
  inv1   g092(.a(x13), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n118_), .O(new_n157_));
  ...
  nand3  g101(.a(new_n131_), .b(new_n155_), .c(new_n125_), .O(new_n164_));
  ...
  nand3  g106(.a(new_n94_), .b(new_n155_), .c(new_n125_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n67_), .b(new_n147_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n80_), .c(new_n79_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n70_), .c(new_n64_), .O(new_n174_));
  ...
  oai21  g121(.a(new_n83_), .b(x27), .c(new_n137_), .O(new_n184_));
  nand3  g122(.a(new_n141_), .b(new_n79_), .c(new_n136_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(x08), .c(new_n185_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n64_), .O(z18));
  nand3  g125(.a(new_n143_), .b(new_n79_), .c(new_n136_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n78_), .O(z19));
  inv1   g127(.a(new_n137_), .O(new_n190_));
  oai21  g128(.a(new_n147_), .b(new_n97_), .c(new_n140_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n97_), .c(new_n147_), .O(new_n192_));
