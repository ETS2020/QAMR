...
module FAU ( 
  ...
  nor2   g037(.a(new_n81_), .b(new_n95_), .O(new_n100_));
  inv1   g038(.a(new_n100_), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n64_), .c(new_n65_), .O(z05));
  oai21  g040(.a(new_n100_), .b(x37), .c(new_n64_), .O(z06));
  ...
  aoi21  g068(.a(x40), .b(new_n130_), .c(new_n115_), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n88_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n64_), .b(new_n95_), .O(new_n134_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n95_), .c(new_n73_), .O(new_n141_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n95_), .O(new_n151_));
  ...
  nand2  g103(.a(new_n165_), .b(new_n64_), .O(z15));
  inv1   g104(.a(x23), .O(new_n167_));
  nand4  g105(.a(new_n64_), .b(new_n167_), .c(x22), .d(x01), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z16));
  inv1   g107(.a(x01), .O(new_n170_));
  inv1   g108(.a(x24), .O(new_n171_));
  nand4  g109(.a(new_n64_), .b(new_n171_), .c(x23), .d(x22), .O(new_n172_));
  nor2   g110(.a(new_n172_), .b(new_n170_), .O(z17));
  nand2  g111(.a(x39), .b(x29), .O(new_n174_));
  oai21  g112(.a(new_n82_), .b(x27), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n95_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n88_), .c(x09), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n64_), .d(new_n78_), .O(z18));
  inv1   g117(.a(x09), .O(new_n180_));
  nand2  g118(.a(new_n132_), .b(new_n81_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n174_), .O(new_n182_));
  inv1   g120(.a(x08), .O(new_n183_));
  aoi21  g121(.a(new_n63_), .b(x39), .c(x27), .O(new_n184_));
  nand2  g122(.a(x40), .b(new_n159_), .O(new_n185_));
  nand2  g123(.a(x39), .b(x04), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n185_), .c(new_n81_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n184_), .c(new_n183_), .O(new_n188_));
  inv1   g126(.a(new_n131_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n159_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n188_), .c(new_n182_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n78_), .c(new_n180_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n64_), .O(z19));
  aoi21  g131(.a(x28), .b(new_n95_), .c(new_n159_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n131_), .O(new_n195_));
  aoi21  g133(.a(new_n185_), .b(new_n134_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n195_), .c(new_n78_), .O(new_n197_));
