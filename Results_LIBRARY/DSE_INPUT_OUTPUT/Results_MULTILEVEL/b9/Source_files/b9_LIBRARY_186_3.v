...
module FAU ( 
  ...
  nand3  g23(.a(new_n85_), .b(new_n63_), .c(new_n66_), .O(new_n87_));
  ...
  nand2  g39(.a(new_n102_), .b(new_n63_), .O(z09));
  ...
  nand3  g44(.a(new_n107_), .b(new_n63_), .c(x27), .O(new_n108_));
  ...
  nand3  g52(.a(new_n115_), .b(new_n71_), .c(new_n110_), .O(new_n116_));
  nand2  g53(.a(new_n116_), .b(new_n63_), .O(z11));
  aoi21  g54(.a(new_n68_), .b(x27), .c(z08), .O(z12));
  nand4  g55(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n119_));
  nor3   g56(.a(new_n119_), .b(x19), .c(x18), .O(z13));
  nor2   g57(.a(x19), .b(x18), .O(new_n121_));
  nor2   g58(.a(z08), .b(new_n80_), .O(new_n122_));
  nand4  g59(.a(new_n122_), .b(new_n121_), .c(new_n68_), .d(x20), .O(z14));
  nand4  g60(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n124_));
  nand2  g61(.a(new_n124_), .b(new_n63_), .O(z15));
  inv1   g62(.a(x23), .O(new_n126_));
  nand3  g63(.a(new_n126_), .b(x22), .c(x01), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(new_n63_), .O(z16));
  inv1   g65(.a(x01), .O(new_n129_));
  inv1   g66(.a(x24), .O(new_n130_));
  nand4  g67(.a(new_n63_), .b(new_n130_), .c(x23), .d(x22), .O(new_n131_));
  nor2   g68(.a(new_n131_), .b(new_n129_), .O(z17));
  nand2  g69(.a(x27), .b(new_n104_), .O(new_n133_));
  oai21  g70(.a(x27), .b(new_n113_), .c(new_n133_), .O(new_n134_));
  nand3  g71(.a(new_n134_), .b(x35), .c(new_n111_), .O(new_n135_));
  nand4  g72(.a(new_n135_), .b(new_n63_), .c(new_n71_), .d(new_n110_), .O(z18));
  nand4  g73(.a(new_n115_), .b(new_n63_), .c(new_n71_), .d(new_n110_), .O(new_n137_));
  inv1   g74(.a(new_n137_), .O(z19));
  ...
  nand2  g78(.a(new_n141_), .b(new_n63_), .O(z20));
  one    g79(.O(z02));
endmodule
