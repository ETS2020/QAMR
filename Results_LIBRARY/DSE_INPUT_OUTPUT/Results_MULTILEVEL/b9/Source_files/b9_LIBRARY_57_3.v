...
module FAU ( 
  ...
  aoi21  g033(.a(new_n95_), .b(new_n89_), .c(new_n77_), .O(z02));
  ...
  nand2  g055(.a(new_n94_), .b(new_n63_), .O(z08));
  ...
  nor2   g072(.a(new_n91_), .b(new_n122_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n82_), .c(new_n134_), .O(new_n136_));
  nand4  g074(.a(x35), .b(new_n81_), .c(x27), .d(new_n122_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n90_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(new_n63_), .c(new_n78_), .d(new_n133_), .O(new_n140_));
  ...
  oai21  g082(.a(new_n94_), .b(x04), .c(new_n67_), .O(new_n145_));
  ...
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n147_), .d(new_n122_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  nand4  g090(.a(new_n66_), .b(x20), .c(new_n72_), .d(new_n152_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n127_), .b(x40), .c(x39), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x13), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n122_), .c(new_n77_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  nand3  g097(.a(x20), .b(new_n72_), .c(new_n152_), .O(new_n160_));
  nand4  g098(.a(new_n149_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand4  g100(.a(x40), .b(x39), .c(new_n147_), .d(new_n122_), .O(new_n163_));
  ...
  aoi21  g106(.a(new_n163_), .b(new_n67_), .c(new_n77_), .O(new_n169_));
  ...
  oai21  g117(.a(new_n82_), .b(x27), .c(new_n134_), .O(new_n180_));
  nand3  g118(.a(new_n137_), .b(new_n78_), .c(new_n133_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(x08), .c(new_n181_), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n77_), .O(z18));
  inv1   g121(.a(new_n134_), .O(new_n184_));
  oai21  g122(.a(new_n165_), .b(new_n91_), .c(new_n90_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n91_), .c(new_n165_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n78_), .c(new_n133_), .O(new_n188_));
