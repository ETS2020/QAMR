...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(x29), .d(new_n72_), .O(new_n77_));
  ...
  aoi21  g028(.a(new_n90_), .b(x02), .c(x08), .O(new_n91_));
  inv1   g029(.a(x04), .O(new_n92_));
  inv1   g030(.a(new_n84_), .O(new_n93_));
  oai21  g031(.a(new_n93_), .b(new_n92_), .c(x39), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n91_), .c(x29), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x40), .O(z02));
  nand2  g034(.a(new_n67_), .b(x27), .O(new_n97_));
  aoi21  g035(.a(new_n66_), .b(new_n89_), .c(new_n79_), .O(new_n98_));
  ...
  nor3   g065(.a(new_n127_), .b(new_n116_), .c(new_n64_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x05), .c(new_n92_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n126_), .O(z10));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n93_), .c(z08), .O(new_n132_));
  nand2  g070(.a(new_n65_), .b(new_n89_), .O(new_n133_));
  oai21  g071(.a(new_n84_), .b(x04), .c(x29), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n133_), .c(x08), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n132_), .c(new_n80_), .O(new_n136_));
  nor2   g074(.a(new_n136_), .b(x09), .O(z11));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n89_), .c(new_n73_), .O(new_n139_));
  nor2   g077(.a(new_n74_), .b(new_n116_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n92_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n69_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n139_), .c(new_n65_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x28), .c(new_n74_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n92_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand4  g087(.a(new_n68_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n64_), .O(new_n151_));
  nand4  g089(.a(new_n68_), .b(new_n74_), .c(x20), .d(new_n149_), .O(new_n152_));
  nor2   g090(.a(new_n152_), .b(x18), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(x27), .O(new_n154_));
  nand3  g092(.a(new_n128_), .b(new_n144_), .c(new_n92_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand3  g094(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n157_));
  nand4  g095(.a(new_n145_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  nand3  g097(.a(new_n140_), .b(new_n144_), .c(new_n92_), .O(new_n160_));
  ...
  nand2  g114(.a(x27), .b(new_n92_), .O(new_n177_));
  nand2  g115(.a(new_n89_), .b(x08), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(new_n162_), .O(new_n179_));
  ...
  nand3  g120(.a(new_n140_), .b(x29), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n182_), .b(new_n79_), .c(new_n183_), .O(z18));
  aoi21  g122(.a(x28), .b(new_n89_), .c(new_n162_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(z08), .O(new_n186_));
  nand2  g124(.a(new_n162_), .b(x29), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n133_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n80_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z20));
  nor2   g128(.a(new_n136_), .b(x09), .O(z19));
endmodule
