...
module FAU ( 
  ...
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n89_), .O(z03));
  nand2  g037(.a(new_n70_), .b(new_n64_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n81_), .d(new_n97_), .O(z04));
  ...
  nor2   g062(.a(new_n89_), .b(new_n70_), .O(new_n125_));
  aoi22  g063(.a(new_n125_), .b(x06), .c(new_n124_), .d(new_n65_), .O(new_n126_));
  inv1   g064(.a(x40), .O(new_n127_));
  nand2  g065(.a(x30), .b(x19), .O(new_n128_));
  nand2  g066(.a(x32), .b(new_n83_), .O(new_n129_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n81_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n127_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  nand4  g090(.a(new_n72_), .b(x20), .c(new_n80_), .d(new_n152_), .O(new_n153_));
  ...
  nand3  g098(.a(x20), .b(new_n80_), .c(new_n152_), .O(new_n161_));
  nor2   g099(.a(x37), .b(x35), .O(new_n162_));
  aoi21  g100(.a(new_n161_), .b(new_n149_), .c(new_n162_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n120_), .c(x27), .O(new_n164_));
  ...
  nand2  g121(.a(new_n138_), .b(new_n133_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n183_), .c(new_n83_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n128_), .O(z18));
  ...
  nand3  g128(.a(new_n190_), .b(new_n83_), .c(new_n133_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n81_), .O(z20));
