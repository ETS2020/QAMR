...
module FAU ( 
  ...
  nand4  g050(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n80_), .O(new_n113_));
  ...
  nand3  g057(.a(new_n116_), .b(x31), .c(new_n114_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n119_), .c(new_n108_), .O(z07));
  nand2  g059(.a(new_n82_), .b(new_n75_), .O(z08));
  ...
  nand3  g092(.a(new_n154_), .b(new_n81_), .c(x31), .O(new_n155_));
  ...
  nand4  g102(.a(new_n72_), .b(x31), .c(x20), .d(new_n162_), .O(new_n165_));
  ...
  aoi21  g115(.a(new_n173_), .b(new_n154_), .c(new_n99_), .O(new_n178_));
  ...
  oai22  g131(.a(new_n193_), .b(new_n99_), .c(new_n93_), .d(new_n75_), .O(z18));
  ...
  oai21  g136(.a(new_n188_), .b(new_n87_), .c(new_n198_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n197_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n84_), .c(new_n191_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n82_), .O(z19));
  ...
  nand3  g144(.a(new_n206_), .b(new_n84_), .c(new_n191_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n82_), .O(z20));
endmodule
