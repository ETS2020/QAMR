...
module FAU ( 
  ...
  nand3  g052(.a(new_n114_), .b(x40), .c(x03), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(z07));
  nand2  g054(.a(new_n93_), .b(new_n64_), .O(z08));
  ...
  nand3  g075(.a(new_n133_), .b(x27), .c(new_n73_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n69_), .b(new_n81_), .c(new_n132_), .O(new_n143_));
  ...
  oai21  g086(.a(new_n148_), .b(x03), .c(new_n146_), .O(z12));
  ...
  nand3  g104(.a(new_n94_), .b(new_n150_), .c(new_n73_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n69_), .b(new_n132_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n80_), .c(new_n79_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n147_), .c(new_n65_), .O(new_n172_));
  ...
  oai21  g120(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n65_), .b(x30), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n138_), .d(new_n130_), .O(z18));
  nand2  g124(.a(new_n64_), .b(new_n68_), .O(new_n187_));
  nand3  g125(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n188_));
  ...
  nor2   g129(.a(x40), .b(x03), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(x40), .c(new_n192_), .O(new_n193_));
  aoi21  g131(.a(new_n134_), .b(new_n133_), .c(new_n193_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n190_), .c(new_n79_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z19));
  aoi21  g134(.a(x28), .b(new_n68_), .c(new_n132_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n193_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n132_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n187_), .c(x08), .O(new_n200_));
