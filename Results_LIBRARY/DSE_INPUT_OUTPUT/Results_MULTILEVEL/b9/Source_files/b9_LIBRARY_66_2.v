...
module FAU ( 
  ...
  nand3  g059(.a(new_n121_), .b(new_n82_), .c(new_n72_), .O(new_n122_));
  ...
  nand4  g074(.a(new_n136_), .b(x35), .c(new_n135_), .d(x27), .O(new_n137_));
  ...
  nand3  g079(.a(new_n96_), .b(new_n81_), .c(new_n80_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x27), .c(x10), .O(new_n143_));
  nor2   g081(.a(new_n68_), .b(new_n72_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x40), .O(new_n145_));
  oai21  g083(.a(new_n68_), .b(x39), .c(new_n145_), .O(z12));
  ...
  nand2  g090(.a(new_n93_), .b(new_n96_), .O(new_n153_));
  ...
  nand2  g094(.a(new_n79_), .b(new_n78_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n147_), .c(new_n72_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x40), .c(new_n156_), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n155_), .O(z13));
  nand3  g098(.a(x39), .b(new_n147_), .c(new_n72_), .O(new_n161_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n135_), .c(x27), .O(new_n167_));
  ...
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n80_), .O(new_n181_));
  nand2  g119(.a(new_n78_), .b(new_n129_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n135_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n92_), .c(new_n120_), .d(new_n87_), .O(z18));
  inv1   g122(.a(x29), .O(new_n185_));
  aoi21  g123(.a(x40), .b(new_n185_), .c(new_n156_), .O(new_n186_));
  aoi21  g124(.a(new_n131_), .b(new_n88_), .c(new_n186_), .O(new_n187_));
  nand2  g125(.a(new_n64_), .b(new_n66_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n135_), .c(new_n72_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x40), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n188_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n187_), .c(new_n78_), .O(new_n192_));
  ...
  nand2  g133(.a(x40), .b(new_n80_), .O(new_n196_));
