...
module FAU ( 
  ...
  aoi21  g041(.a(new_n103_), .b(new_n64_), .c(new_n100_), .O(z05));
  ...
  nand2  g073(.a(new_n82_), .b(new_n78_), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  nand3  g076(.a(x35), .b(new_n81_), .c(x27), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n78_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n70_), .c(x08), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n138_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n63_), .O(z11));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n64_), .b(new_n80_), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi21  g084(.a(new_n66_), .b(x27), .c(new_n94_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n70_), .O(new_n148_));
  nand3  g086(.a(new_n67_), .b(new_n78_), .c(x04), .O(new_n149_));
  ...
  nand4  g096(.a(new_n66_), .b(new_n78_), .c(x20), .d(new_n156_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  aoi21  g099(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x39), .c(new_n151_), .d(new_n70_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n161_), .O(z13));
  nand3  g102(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n165_));
  nand3  g103(.a(new_n152_), .b(new_n79_), .c(x28), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n70_), .c(x30), .O(new_n167_));
  aoi21  g105(.a(new_n94_), .b(new_n151_), .c(x04), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  aoi21  g107(.a(x32), .b(new_n70_), .c(x27), .O(new_n170_));
  nand2  g108(.a(new_n65_), .b(x04), .O(new_n171_));
  nand3  g109(.a(new_n144_), .b(new_n79_), .c(x28), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(x37), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n170_), .c(new_n78_), .O(new_n174_));
  nand2  g112(.a(new_n94_), .b(new_n151_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n67_), .c(new_n70_), .O(new_n176_));
  ...
  nand2  g123(.a(new_n140_), .b(new_n70_), .O(new_n186_));
  inv1   g124(.a(x08), .O(new_n187_));
  nand3  g125(.a(x35), .b(new_n81_), .c(new_n97_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n134_), .c(new_n187_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(x09), .c(new_n78_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n186_), .O(z18));
  oai21  g129(.a(new_n144_), .b(new_n97_), .c(new_n187_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n97_), .c(new_n144_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n135_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n78_), .c(new_n133_), .O(new_n195_));
