...
module FAU ( 
  ...
  nand4  g094(.a(new_n121_), .b(x39), .c(new_n145_), .d(new_n116_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  aoi21  g096(.a(new_n145_), .b(new_n116_), .c(new_n70_), .O(new_n159_));
  ...
  oai21  g102(.a(new_n164_), .b(new_n78_), .c(x27), .O(new_n165_));
  ...
  nand4  g112(.a(new_n71_), .b(new_n174_), .c(x23), .d(x22), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n173_), .O(z17));
  nand2  g114(.a(x40), .b(x39), .O(new_n177_));
  nand2  g115(.a(x27), .b(new_n116_), .O(new_n178_));
  nand2  g116(.a(new_n92_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n129_), .O(new_n180_));
  nand2  g118(.a(new_n75_), .b(new_n127_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(new_n78_), .c(new_n181_), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n74_), .c(new_n177_), .d(new_n85_), .O(z18));
  inv1   g121(.a(x29), .O(new_n184_));
  aoi21  g122(.a(x39), .b(new_n184_), .c(new_n67_), .O(new_n185_));
  aoi21  g123(.a(new_n131_), .b(new_n130_), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n71_), .b(new_n92_), .O(new_n187_));
  nand3  g125(.a(x35), .b(new_n78_), .c(new_n116_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x39), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n187_), .c(x08), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n186_), .c(new_n75_), .O(new_n191_));
  nor2   g129(.a(new_n191_), .b(x09), .O(z19));
  aoi21  g130(.a(x28), .b(new_n92_), .c(new_n129_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n185_), .O(new_n194_));
  nand2  g132(.a(x39), .b(new_n129_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n187_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n75_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(x09), .O(z20));
  buf    g136(.a(x40), .O(z08));
endmodule
