...
module FAU ( 
  ...
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n89_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n70_), .c(new_n89_), .O(z05));
  ...
  nor3   g055(.a(new_n89_), .b(new_n117_), .c(new_n116_), .O(z08));
  ...
  nand3  g061(.a(new_n81_), .b(new_n75_), .c(x07), .O(new_n124_));
  nand3  g062(.a(new_n76_), .b(new_n83_), .c(x05), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(new_n126_));
  nor2   g064(.a(new_n89_), .b(new_n70_), .O(new_n127_));
  aoi22  g065(.a(new_n127_), .b(x06), .c(new_n126_), .d(new_n65_), .O(new_n128_));
  nand2  g066(.a(x30), .b(x19), .O(new_n129_));
  nand2  g067(.a(x32), .b(new_n83_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n117_), .O(new_n131_));
  ...
  nor3   g095(.a(new_n157_), .b(new_n116_), .c(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n65_), .c(new_n89_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z13));
  nand3  g098(.a(x20), .b(new_n80_), .c(new_n153_), .O(new_n161_));
  nor2   g099(.a(x37), .b(x35), .O(new_n162_));
  aoi21  g100(.a(new_n161_), .b(new_n150_), .c(new_n162_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n122_), .c(x27), .O(new_n164_));
  nor2   g102(.a(x13), .b(x04), .O(new_n165_));
  nand2  g103(.a(x27), .b(x20), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(x18), .O(new_n167_));
  aoi22  g105(.a(new_n167_), .b(new_n72_), .c(new_n165_), .d(new_n76_), .O(new_n168_));
  aoi21  g106(.a(new_n164_), .b(new_n84_), .c(new_n168_), .O(new_n169_));
  nand2  g107(.a(new_n165_), .b(new_n76_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x19), .O(new_n171_));
  oai21  g109(.a(new_n169_), .b(x30), .c(new_n171_), .O(z14));
  ...
  nand2  g119(.a(new_n85_), .b(new_n64_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n135_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n139_), .c(new_n83_), .d(new_n134_), .O(z18));
  nand2  g123(.a(new_n142_), .b(new_n81_), .O(z19));
  ...
  nand3  g128(.a(new_n190_), .b(new_n83_), .c(new_n134_), .O(new_n191_));
