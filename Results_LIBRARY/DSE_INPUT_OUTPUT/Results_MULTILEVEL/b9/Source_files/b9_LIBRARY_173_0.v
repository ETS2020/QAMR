...
module FAU ( 
  ...
  nand2  g034(.a(new_n76_), .b(x26), .O(new_n97_));
  ...
  aoi21  g060(.a(new_n122_), .b(new_n97_), .c(new_n121_), .O(new_n123_));
  nand3  g061(.a(x40), .b(x39), .c(x05), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n123_), .c(new_n88_), .O(new_n126_));
  ...
  nand3  g078(.a(new_n137_), .b(x27), .c(new_n65_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n144_), .b(x09), .c(new_n82_), .O(z11));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n102_), .O(new_n150_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n102_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(z13));
  nor2   g101(.a(x40), .b(new_n81_), .O(new_n164_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n164_), .c(new_n165_), .O(new_n170_));
  ...
  nand2  g111(.a(new_n167_), .b(new_n148_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand3  g114(.a(new_n148_), .b(new_n76_), .c(x26), .O(new_n177_));
  ...
  oai21  g124(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n142_), .b(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n82_), .d(new_n84_), .O(z18));
  nand2  g128(.a(new_n82_), .b(new_n64_), .O(new_n191_));
  oai21  g129(.a(new_n87_), .b(x04), .c(x40), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(x08), .O(new_n193_));
  aoi21  g131(.a(x39), .b(x29), .c(new_n76_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n164_), .O(new_n195_));
  aoi21  g133(.a(new_n138_), .b(new_n137_), .c(new_n195_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n84_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(x09), .O(z19));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n195_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n191_), .c(x08), .O(new_n202_));
