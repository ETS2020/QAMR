...
module FAU ( 
  ...
  nand3  g041(.a(new_n102_), .b(new_n78_), .c(new_n66_), .O(new_n104_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n78_), .O(z10));
  ...
  nand4  g080(.a(new_n142_), .b(new_n78_), .c(new_n79_), .d(new_n135_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z11));
  oai21  g082(.a(new_n93_), .b(x04), .c(new_n67_), .O(new_n145_));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n81_), .b(new_n146_), .c(new_n73_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(x37), .O(new_n148_));
  nor2   g086(.a(x27), .b(x10), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(x06), .O(new_n150_));
  nand2  g088(.a(new_n94_), .b(new_n123_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n69_), .c(x10), .O(new_n152_));
  ...
  oai21  g120(.a(new_n83_), .b(x27), .c(new_n136_), .O(new_n183_));
  nand3  g121(.a(new_n140_), .b(new_n79_), .c(new_n135_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(x08), .c(new_n184_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n63_), .O(z18));
  nand3  g124(.a(new_n142_), .b(new_n79_), .c(new_n135_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n78_), .O(z19));
  inv1   g126(.a(new_n136_), .O(new_n189_));
  oai21  g127(.a(new_n146_), .b(new_n97_), .c(new_n139_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n97_), .c(new_n146_), .O(new_n191_));
