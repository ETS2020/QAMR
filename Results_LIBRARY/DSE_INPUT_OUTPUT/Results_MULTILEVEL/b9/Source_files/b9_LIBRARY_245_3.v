...
module FAU ( 
  ...
  oai21  g053(.a(new_n115_), .b(x00), .c(new_n92_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n114_), .c(new_n107_), .O(z07));
  nand3  g055(.a(x40), .b(x39), .c(new_n92_), .O(new_n118_));
  ...
  aoi21  g070(.a(x40), .b(x14), .c(x27), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n92_), .c(new_n133_), .O(new_n135_));
  aoi21  g073(.a(x39), .b(x29), .c(x14), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(x35), .c(new_n86_), .O(new_n138_));
  oai21  g076(.a(new_n136_), .b(new_n110_), .c(new_n138_), .O(new_n139_));
  oai21  g077(.a(new_n135_), .b(x08), .c(new_n139_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n84_), .c(new_n132_), .O(new_n141_));
  ...
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n110_), .O(new_n151_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(x14), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n110_), .c(new_n162_), .O(new_n167_));
  ...
  nand2  g110(.a(new_n172_), .b(new_n92_), .O(new_n173_));
  nand2  g111(.a(new_n146_), .b(new_n110_), .O(new_n174_));
  ...
  nand2  g125(.a(new_n84_), .b(new_n132_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n86_), .c(new_n188_), .O(new_n189_));
  nand4  g127(.a(new_n76_), .b(x29), .c(new_n92_), .d(x08), .O(new_n190_));
  oai21  g128(.a(new_n189_), .b(new_n83_), .c(new_n190_), .O(z18));
  nor2   g129(.a(new_n136_), .b(new_n110_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  nand2  g131(.a(x35), .b(x27), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n92_), .c(new_n110_), .d(new_n64_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(x08), .c(new_n193_), .d(new_n192_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n84_), .c(new_n132_), .O(new_n197_));
  inv1   g135(.a(new_n197_), .O(z20));
  inv1   g136(.a(new_n141_), .O(z19));
endmodule
