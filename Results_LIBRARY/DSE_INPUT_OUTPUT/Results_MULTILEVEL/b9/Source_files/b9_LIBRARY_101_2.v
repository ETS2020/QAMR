...
module FAU ( 
  ...
  aoi21  g034(.a(new_n96_), .b(new_n93_), .c(new_n71_), .O(new_n97_));
  oai21  g035(.a(new_n97_), .b(new_n91_), .c(x40), .O(new_n98_));
  inv1   g036(.a(x29), .O(new_n99_));
  nand2  g037(.a(new_n63_), .b(new_n99_), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n98_), .c(new_n90_), .O(z02));
  nand2  g039(.a(new_n66_), .b(x27), .O(new_n102_));
  inv1   g040(.a(x21), .O(new_n103_));
  aoi21  g041(.a(new_n65_), .b(new_n95_), .c(new_n103_), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n102_), .c(new_n78_), .O(z03));
  aoi21  g043(.a(new_n65_), .b(new_n95_), .c(x21), .O(new_n106_));
  aoi21  g044(.a(new_n106_), .b(new_n102_), .c(new_n78_), .O(z04));
  nand2  g045(.a(x28), .b(x27), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n64_), .c(new_n65_), .O(z05));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n64_), .O(z10));
  aoi21  g073(.a(x40), .b(new_n91_), .c(new_n99_), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n93_), .c(new_n136_), .O(new_n138_));
  nand2  g076(.a(new_n64_), .b(new_n95_), .O(new_n139_));
  nand3  g077(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x40), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n139_), .c(x08), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n138_), .c(new_n79_), .O(new_n143_));
  nor2   g081(.a(new_n143_), .b(x09), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n95_), .c(new_n73_), .O(new_n146_));
  oai21  g084(.a(new_n122_), .b(x04), .c(new_n68_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n64_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n63_), .O(new_n151_));
  ...
  nand3  g095(.a(new_n130_), .b(x40), .c(x39), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x13), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n71_), .c(new_n78_), .O(new_n160_));
  ...
  nand4  g102(.a(x40), .b(x39), .c(new_n149_), .d(new_n71_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n65_), .b(new_n92_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n80_), .c(new_n79_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n68_), .c(new_n78_), .O(new_n170_));
  ...
  nor2   g119(.a(new_n91_), .b(new_n99_), .O(new_n182_));
  ...
  nand3  g123(.a(new_n93_), .b(x27), .c(new_n71_), .O(new_n186_));
  nor2   g124(.a(new_n78_), .b(x30), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n181_), .O(z18));
  nand2  g126(.a(new_n137_), .b(new_n93_), .O(new_n189_));
  nand2  g127(.a(new_n183_), .b(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n186_), .b(new_n94_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n79_), .c(new_n181_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n64_), .O(z19));
  oai21  g132(.a(new_n92_), .b(new_n95_), .c(new_n94_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n95_), .c(new_n92_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n182_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n79_), .c(new_n181_), .O(new_n198_));
