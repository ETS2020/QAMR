...
module FAU ( 
  ...
  oai21  g025(.a(new_n87_), .b(new_n72_), .c(new_n86_), .O(new_n88_));
  ...
  oai21  g031(.a(new_n66_), .b(new_n89_), .c(x27), .O(new_n94_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n78_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n86_), .c(new_n96_), .O(z05));
  ...
  nand2  g053(.a(new_n86_), .b(new_n72_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n86_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(z09));
  nand3  g057(.a(new_n86_), .b(x37), .c(x06), .O(new_n120_));
  nand4  g058(.a(new_n82_), .b(new_n72_), .c(x30), .d(x07), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(x04), .c(new_n120_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x27), .O(new_n123_));
  nand4  g061(.a(new_n73_), .b(x30), .c(x05), .d(new_n65_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(z10));
  inv1   g063(.a(x09), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x29), .O(new_n127_));
  oai21  g065(.a(new_n90_), .b(x27), .c(new_n127_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(new_n81_), .c(new_n126_), .d(x04), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(z11));
  inv1   g069(.a(x10), .O(new_n132_));
  nor3   g070(.a(x37), .b(x36), .c(x35), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n64_), .c(new_n132_), .O(new_n134_));
  oai22  g072(.a(new_n72_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n86_), .O(z12));
  inv1   g074(.a(x13), .O(new_n137_));
  aoi21  g075(.a(new_n73_), .b(new_n137_), .c(new_n81_), .O(new_n138_));
  ...
  oai21  g080(.a(new_n138_), .b(x04), .c(new_n142_), .O(z13));
  nand2  g081(.a(new_n137_), .b(new_n65_), .O(new_n144_));
  nand4  g082(.a(x27), .b(x20), .c(new_n140_), .d(new_n139_), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n70_), .c(new_n144_), .d(new_n72_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n86_), .O(z14));
  nand4  g085(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n86_), .O(z15));
  inv1   g087(.a(x23), .O(new_n150_));
  nand4  g088(.a(new_n86_), .b(new_n150_), .c(x22), .d(x01), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(z16));
  inv1   g090(.a(x24), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x23), .c(x22), .d(x01), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n86_), .O(z17));
  nand4  g093(.a(new_n129_), .b(new_n81_), .c(new_n126_), .d(x04), .O(z18));
  inv1   g094(.a(new_n127_), .O(new_n157_));
  nor2   g095(.a(new_n66_), .b(new_n64_), .O(new_n158_));
  aoi21  g096(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n159_));
  oai22  g097(.a(new_n159_), .b(new_n157_), .c(new_n158_), .d(x08), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n126_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(x04), .c(x30), .O(z20));
  inv1   g100(.a(new_n130_), .O(z19));
endmodule
