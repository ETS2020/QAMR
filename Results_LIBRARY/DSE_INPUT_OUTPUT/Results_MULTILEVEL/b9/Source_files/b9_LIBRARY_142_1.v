...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n92_), .c(x14), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(x40), .O(z02));
  nand2  g035(.a(new_n71_), .b(x27), .O(new_n98_));
  aoi22  g036(.a(x40), .b(new_n81_), .c(new_n70_), .d(new_n64_), .O(new_n99_));
  ...
  nand2  g050(.a(new_n112_), .b(new_n81_), .O(new_n113_));
  oai21  g051(.a(new_n110_), .b(x31), .c(new_n113_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(x03), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n82_), .O(z07));
  aoi21  g054(.a(new_n75_), .b(x14), .c(new_n76_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n82_), .O(z09));
  inv1   g057(.a(x07), .O(new_n120_));
  nand4  g058(.a(x40), .b(x39), .c(x14), .d(x05), .O(new_n121_));
  oai21  g059(.a(z08), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n88_), .c(new_n65_), .O(new_n123_));
  nand3  g061(.a(new_n82_), .b(x37), .c(x06), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  nand2  g064(.a(new_n85_), .b(new_n84_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x40), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n75_), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(x14), .c(x05), .d(new_n65_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n126_), .O(z10));
  inv1   g069(.a(x08), .O(new_n132_));
  inv1   g070(.a(x09), .O(new_n133_));
  nand4  g071(.a(new_n84_), .b(new_n133_), .c(new_n132_), .d(x04), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x14), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  nand2  g074(.a(new_n77_), .b(x29), .O(new_n137_));
  inv1   g075(.a(new_n87_), .O(new_n138_));
  ...
  nand2  g087(.a(new_n77_), .b(new_n65_), .O(new_n150_));
  ...
  nand4  g098(.a(new_n127_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(x14), .c(new_n76_), .O(new_n162_));
  ...
  nand3  g103(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n81_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n76_), .c(new_n164_), .O(new_n169_));
  ...
  nand2  g110(.a(new_n166_), .b(new_n149_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x14), .O(new_n175_));
  nand2  g113(.a(new_n149_), .b(new_n76_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  inv1   g115(.a(x12), .O(new_n178_));
  nand4  g116(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(new_n178_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand4  g119(.a(new_n82_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z16));
  inv1   g121(.a(x01), .O(new_n184_));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n82_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  oai21  g125(.a(new_n87_), .b(x27), .c(new_n137_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n138_), .c(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n82_), .d(new_n133_), .O(z18));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(x14), .O(new_n193_));
  nand2  g131(.a(x40), .b(x04), .O(new_n194_));
  nand2  g132(.a(new_n76_), .b(new_n64_), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n194_), .c(new_n193_), .d(new_n86_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n132_), .O(new_n197_));
  nand2  g135(.a(x39), .b(x29), .O(new_n198_));
  nand2  g136(.a(new_n66_), .b(x14), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n139_), .c(new_n86_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n198_), .O(new_n201_));
  nand2  g139(.a(new_n140_), .b(new_n76_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n201_), .c(new_n197_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n84_), .c(new_n133_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n82_), .O(z19));
  aoi21  g143(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n206_));
  aoi21  g144(.a(new_n198_), .b(x14), .c(new_n76_), .O(new_n207_));
  nor2   g145(.a(new_n207_), .b(new_n206_), .O(new_n208_));
  aoi21  g146(.a(new_n195_), .b(new_n193_), .c(x08), .O(new_n209_));
  oai21  g147(.a(new_n209_), .b(new_n208_), .c(new_n84_), .O(new_n210_));
