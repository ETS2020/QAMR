...
module FAU ( 
  ...
  nand3  g043(.a(new_n105_), .b(new_n81_), .c(new_n71_), .O(z05));
  ...
  nand2  g058(.a(new_n120_), .b(new_n81_), .O(z09));
  oai21  g059(.a(new_n66_), .b(x28), .c(new_n67_), .O(new_n122_));
  ...
  nand3  g065(.a(new_n76_), .b(new_n67_), .c(x35), .O(new_n128_));
  nor3   g066(.a(new_n128_), .b(x28), .c(new_n127_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n126_), .c(new_n65_), .O(new_n130_));
  ...
  nor2   g071(.a(new_n84_), .b(new_n68_), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(x39), .c(x05), .d(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(z10));
  nand2  g074(.a(new_n77_), .b(x29), .O(new_n137_));
  oai21  g075(.a(new_n64_), .b(new_n65_), .c(new_n88_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g077(.a(new_n88_), .b(x27), .c(new_n65_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x08), .c(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n86_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x09), .c(new_n81_), .O(z11));
  ...
  nand2  g085(.a(new_n73_), .b(x27), .O(new_n148_));
  oai21  g086(.a(new_n76_), .b(x04), .c(new_n148_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n81_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  oai21  g090(.a(new_n68_), .b(x28), .c(new_n152_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n73_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand4  g097(.a(new_n134_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n159_), .c(new_n81_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n87_), .c(new_n86_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n77_), .b(new_n151_), .c(new_n65_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n71_), .b(new_n66_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n87_), .c(new_n86_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n148_), .c(new_n83_), .O(new_n170_));
  ...
  nand4  g112(.a(new_n81_), .b(new_n174_), .c(x22), .d(x01), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(z16));
  inv1   g114(.a(x01), .O(new_n177_));
  inv1   g115(.a(x24), .O(new_n178_));
  nand4  g116(.a(new_n81_), .b(new_n178_), .c(x23), .d(x22), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(new_n177_), .O(z17));
  oai21  g118(.a(new_n89_), .b(x27), .c(new_n137_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n141_), .b(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n182_), .c(new_n81_), .d(new_n86_), .O(z18));
  nand2  g122(.a(new_n81_), .b(new_n64_), .O(new_n185_));
  oai21  g123(.a(new_n89_), .b(x04), .c(x40), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(x08), .O(new_n187_));
  inv1   g125(.a(new_n138_), .O(new_n188_));
  nand2  g126(.a(x39), .b(x29), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(x40), .c(new_n97_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n187_), .c(new_n86_), .O(new_n192_));
  ...
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n86_), .O(new_n198_));
