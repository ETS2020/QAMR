...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n92_), .c(x26), .O(new_n96_));
  ...
  aoi21  g060(.a(new_n75_), .b(x26), .c(new_n76_), .O(new_n123_));
  ...
  nand4  g070(.a(new_n132_), .b(x26), .c(x05), .d(new_n65_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n129_), .O(z10));
  inv1   g072(.a(x08), .O(new_n135_));
  inv1   g073(.a(x09), .O(new_n136_));
  nand4  g074(.a(new_n84_), .b(new_n136_), .c(new_n135_), .d(x04), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x26), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  nand2  g077(.a(new_n77_), .b(x29), .O(new_n140_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n151_), .c(new_n101_), .O(new_n153_));
  ...
  aoi21  g101(.a(new_n163_), .b(x26), .c(new_n76_), .O(new_n164_));
  ...
  nand2  g114(.a(new_n176_), .b(x26), .O(new_n177_));
  nand2  g115(.a(new_n151_), .b(new_n76_), .O(new_n178_));
  ...
  oai21  g125(.a(new_n87_), .b(x27), .c(new_n140_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n141_), .c(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n82_), .d(new_n136_), .O(z18));
  nand2  g130(.a(new_n82_), .b(new_n64_), .O(new_n193_));
  oai21  g131(.a(new_n87_), .b(x04), .c(x26), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(x08), .O(new_n195_));
  nand2  g133(.a(x39), .b(x29), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(x26), .c(new_n76_), .O(new_n197_));
  aoi21  g135(.a(new_n142_), .b(new_n141_), .c(new_n197_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n84_), .O(new_n199_));
  ...
  oai21  g140(.a(new_n66_), .b(new_n64_), .c(x26), .O(new_n203_));
  nand2  g141(.a(new_n76_), .b(new_n64_), .O(new_n204_));
  aoi21  g142(.a(new_n204_), .b(new_n203_), .c(x08), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n202_), .c(new_n84_), .O(new_n206_));
