...
module FAU ( 
  ...
  nor2   g027(.a(new_n80_), .b(new_n65_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(new_n89_), .O(z01));
  ...
  oai21  g034(.a(x40), .b(x04), .c(new_n96_), .O(z02));
  ...
  nor2   g042(.a(new_n85_), .b(new_n64_), .O(new_n105_));
  ...
  nand3  g066(.a(x40), .b(x37), .c(x06), .O(new_n129_));
  ...
  aoi22  g077(.a(new_n80_), .b(x04), .c(x35), .d(new_n85_), .O(new_n140_));
  nand3  g078(.a(x40), .b(x27), .c(x04), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n140_), .c(new_n139_), .O(new_n143_));
  aoi22  g081(.a(x40), .b(x08), .c(x35), .d(new_n85_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n93_), .c(new_n65_), .O(new_n145_));
  inv1   g083(.a(x08), .O(new_n146_));
  nand3  g084(.a(x40), .b(new_n146_), .c(x04), .O(new_n147_));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n65_), .c(new_n98_), .O(new_n167_));
  ...
  nor2   g108(.a(new_n75_), .b(x13), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(x04), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n90_), .c(new_n169_), .O(new_n173_));
  ...
  oai21  g114(.a(new_n75_), .b(x13), .c(new_n154_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n65_), .O(new_n179_));
  nand3  g117(.a(new_n154_), .b(x40), .c(x04), .O(new_n180_));
  ...
  oai21  g129(.a(x30), .b(x09), .c(new_n81_), .O(new_n192_));
  nand3  g130(.a(x40), .b(new_n64_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n93_), .b(x04), .c(new_n193_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(x35), .c(new_n85_), .O(new_n195_));
  nand3  g133(.a(new_n76_), .b(x29), .c(x08), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n195_), .c(new_n192_), .O(z18));
  oai21  g135(.a(new_n66_), .b(new_n64_), .c(new_n146_), .O(new_n198_));
  ...
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n198_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n83_), .c(new_n138_), .O(new_n203_));
