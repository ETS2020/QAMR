...
module FAU ( 
  ...
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n79_), .d(x21), .O(z03));
  aoi21  g036(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n81_), .O(z04));
  oai21  g038(.a(new_n84_), .b(new_n64_), .c(new_n70_), .O(new_n101_));
  and2   g039(.a(new_n101_), .b(new_n79_), .O(z05));
  ...
  nand3  g046(.a(x38), .b(new_n78_), .c(new_n106_), .O(new_n109_));
  inv1   g047(.a(new_n109_), .O(new_n110_));
  oai22  g048(.a(new_n110_), .b(x14), .c(new_n108_), .d(x31), .O(new_n111_));
  ...
  aoi21  g053(.a(new_n114_), .b(x25), .c(new_n115_), .O(z08));
  ...
  nand2  g061(.a(new_n83_), .b(new_n82_), .O(new_n124_));
  ...
  aoi21  g066(.a(new_n128_), .b(x06), .c(new_n81_), .O(new_n129_));
  ...
  oai21  g072(.a(new_n134_), .b(new_n132_), .c(x25), .O(new_n135_));
  ...
  oai21  g079(.a(new_n85_), .b(new_n64_), .c(new_n131_), .O(new_n142_));
  ...
  nand4  g098(.a(new_n124_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x25), .O(new_n162_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n115_), .c(new_n165_), .O(new_n170_));
  ...
  nand2  g113(.a(new_n175_), .b(x25), .O(new_n176_));
  nand2  g114(.a(new_n149_), .b(new_n115_), .O(new_n177_));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n84_), .c(new_n134_), .O(new_n192_));
  inv1   g130(.a(new_n137_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(x25), .c(x08), .O(new_n194_));
  ...
  nand2  g136(.a(new_n198_), .b(x25), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n196_), .c(x08), .O(new_n200_));
  nand2  g138(.a(x39), .b(x29), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(x25), .c(new_n115_), .O(new_n202_));
  aoi21  g140(.a(new_n139_), .b(new_n138_), .c(new_n202_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n200_), .c(new_n82_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(x09), .O(z19));
  oai21  g143(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n206_));
  aoi21  g144(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(new_n193_), .c(new_n206_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n82_), .c(new_n133_), .O(new_n209_));
