...
module FAU ( 
  ...
  nand4  g75(.a(new_n115_), .b(new_n68_), .c(new_n71_), .d(new_n110_), .O(new_n139_));
  inv1   g76(.a(new_n139_), .O(z19));
  oai21  g77(.a(x28), .b(new_n113_), .c(new_n80_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(x35), .O(new_n142_));
  nand4  g79(.a(new_n142_), .b(new_n68_), .c(new_n71_), .d(new_n110_), .O(new_n143_));
