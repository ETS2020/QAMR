...
module FAU ( 
  ...
  nand3  g024(.a(new_n86_), .b(x35), .c(new_n84_), .O(new_n87_));
  nand3  g025(.a(new_n87_), .b(x30), .c(x04), .O(new_n88_));
  oai21  g026(.a(new_n83_), .b(new_n64_), .c(new_n88_), .O(z02));
  nand2  g027(.a(new_n69_), .b(x27), .O(new_n90_));
  inv1   g028(.a(x21), .O(new_n91_));
  aoi21  g029(.a(new_n68_), .b(new_n67_), .c(new_n91_), .O(new_n92_));
  aoi21  g030(.a(new_n92_), .b(new_n90_), .c(new_n64_), .O(z03));
  aoi21  g031(.a(new_n68_), .b(new_n67_), .c(x21), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n90_), .c(new_n64_), .O(z04));
  inv1   g033(.a(new_n64_), .O(new_n96_));
  nand2  g034(.a(x28), .b(x27), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(new_n96_), .c(new_n68_), .O(z05));
  ...
  nand2  g053(.a(x35), .b(new_n84_), .O(new_n116_));
  ...
  nand2  g067(.a(x29), .b(x08), .O(new_n130_));
  oai21  g068(.a(new_n82_), .b(new_n130_), .c(new_n116_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n86_), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(new_n78_), .c(new_n129_), .d(new_n63_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  inv1   g072(.a(x35), .O(new_n135_));
  nand3  g073(.a(new_n68_), .b(new_n115_), .c(new_n135_), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x27), .c(x10), .O(new_n137_));
  inv1   g075(.a(new_n82_), .O(new_n138_));
  nor2   g076(.a(new_n138_), .b(new_n70_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n137_), .c(new_n63_), .O(new_n140_));
  ...
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(z12));
  ...
  nand4  g090(.a(new_n141_), .b(x30), .c(x20), .d(new_n150_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x18), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(x27), .O(new_n155_));
  nand3  g093(.a(new_n123_), .b(new_n145_), .c(new_n63_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n158_));
  inv1   g096(.a(x32), .O(new_n159_));
  nand4  g097(.a(new_n146_), .b(new_n159_), .c(new_n78_), .d(x28), .O(new_n160_));
  nor2   g098(.a(new_n82_), .b(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n160_), .c(x04), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n79_), .c(new_n158_), .O(new_n163_));
  nand3  g101(.a(new_n68_), .b(new_n135_), .c(x28), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n159_), .c(new_n78_), .O(new_n166_));
  inv1   g104(.a(new_n161_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n142_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n63_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n163_), .c(new_n143_), .O(z14));
  ...
  nand2  g116(.a(new_n178_), .b(new_n96_), .O(z17));
  nand3  g117(.a(x40), .b(x39), .c(x29), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n116_), .c(new_n85_), .O(new_n181_));
  oai21  g119(.a(new_n116_), .b(new_n67_), .c(new_n129_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(new_n63_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n78_), .O(z18));
  nand2  g122(.a(new_n132_), .b(new_n129_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n63_), .c(x30), .O(z19));
  inv1   g124(.a(new_n180_), .O(new_n187_));
  oai21  g125(.a(new_n135_), .b(new_n67_), .c(new_n85_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n67_), .c(new_n135_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n129_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n63_), .c(x30), .O(z20));
endmodule
