...
module FAU ( 
  ...
  oai21  g019(.a(new_n81_), .b(new_n80_), .c(new_n64_), .O(new_n82_));
  ...
  aoi21  g031(.a(new_n65_), .b(new_n84_), .c(new_n93_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n92_), .c(new_n91_), .O(z03));
  nand2  g033(.a(new_n65_), .b(new_n84_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n92_), .c(new_n64_), .d(new_n93_), .O(z04));
  nand2  g035(.a(x28), .b(x27), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n65_), .O(new_n99_));
  and2   g037(.a(new_n99_), .b(new_n64_), .O(z05));
  ...
  nand2  g050(.a(new_n81_), .b(new_n64_), .O(z08));
  ...
  oai21  g055(.a(new_n86_), .b(x28), .c(new_n117_), .O(new_n118_));
  nand2  g056(.a(new_n81_), .b(x07), .O(new_n119_));
  ...
  oai21  g073(.a(new_n135_), .b(new_n87_), .c(new_n85_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n71_), .c(x30), .O(z11));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n84_), .c(new_n73_), .O(new_n140_));
  oai21  g078(.a(new_n81_), .b(x04), .c(new_n68_), .O(new_n141_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(x04), .O(new_n150_));
  nand4  g088(.a(new_n67_), .b(x30), .c(x20), .d(new_n148_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(x18), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(x27), .O(new_n153_));
  nand3  g091(.a(new_n130_), .b(new_n143_), .c(new_n71_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand3  g093(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n156_));
  inv1   g094(.a(x32), .O(new_n157_));
  nand4  g095(.a(new_n144_), .b(new_n157_), .c(new_n63_), .d(x28), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  inv1   g097(.a(new_n81_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n143_), .c(new_n71_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(new_n156_), .O(new_n162_));
  nand3  g100(.a(new_n65_), .b(new_n86_), .c(x28), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(x27), .c(x32), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(x04), .c(new_n63_), .O(new_n165_));
  nand2  g103(.a(new_n161_), .b(new_n68_), .O(new_n166_));
  ...
  nand2  g114(.a(new_n160_), .b(x29), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n87_), .c(x08), .O(new_n179_));
  aoi21  g117(.a(new_n87_), .b(x27), .c(x30), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n179_), .c(new_n133_), .d(new_n71_), .O(z18));
  aoi21  g119(.a(new_n86_), .b(new_n71_), .c(x28), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n135_), .c(new_n85_), .d(x04), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n133_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n71_), .c(x30), .O(z19));
  oai21  g123(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n84_), .c(new_n86_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n178_), .c(new_n186_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n63_), .c(new_n133_), .d(new_n71_), .O(new_n189_));
