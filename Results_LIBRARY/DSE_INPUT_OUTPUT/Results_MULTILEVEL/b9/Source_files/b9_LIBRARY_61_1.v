...
module FAU ( 
  ...
  nand3  g025(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n88_));
  oai21  g026(.a(new_n84_), .b(x04), .c(new_n88_), .O(z01));
  inv1   g027(.a(x08), .O(new_n90_));
  oai21  g028(.a(x27), .b(new_n65_), .c(x02), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  inv1   g030(.a(x29), .O(new_n93_));
  oai21  g031(.a(x30), .b(new_n93_), .c(new_n80_), .O(new_n94_));
  oai21  g032(.a(new_n66_), .b(x28), .c(x04), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n94_), .c(new_n92_), .d(new_n76_), .O(z02));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n84_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n70_), .c(new_n84_), .O(z05));
  ...
  aoi21  g061(.a(x35), .b(new_n123_), .c(x36), .O(new_n124_));
  nand3  g062(.a(new_n81_), .b(new_n75_), .c(x07), .O(new_n125_));
  nand3  g063(.a(new_n76_), .b(new_n83_), .c(x05), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  inv1   g065(.a(x06), .O(new_n128_));
  nor3   g066(.a(new_n84_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  aoi21  g067(.a(new_n127_), .b(new_n65_), .c(new_n129_), .O(new_n130_));
  nand2  g068(.a(x30), .b(x02), .O(new_n131_));
  nand2  g069(.a(x32), .b(new_n83_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n118_), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(x39), .c(x05), .d(new_n65_), .O(new_n134_));
  oai21  g072(.a(new_n130_), .b(new_n64_), .c(new_n134_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand2  g074(.a(new_n76_), .b(x29), .O(new_n137_));
  oai21  g075(.a(new_n64_), .b(new_n65_), .c(new_n86_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n83_), .c(new_n136_), .O(new_n143_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n84_), .O(z12));
  inv1   g087(.a(x19), .O(new_n150_));
  nand4  g088(.a(new_n81_), .b(new_n72_), .c(x20), .d(new_n150_), .O(new_n151_));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n118_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n83_), .d(new_n152_), .O(new_n155_));
  oai22  g093(.a(new_n155_), .b(x04), .c(new_n151_), .d(x18), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  nand4  g095(.a(new_n133_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand2  g097(.a(x20), .b(new_n150_), .O(new_n160_));
  nor2   g098(.a(x13), .b(x04), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n76_), .c(new_n84_), .O(new_n162_));
  nand4  g100(.a(new_n153_), .b(new_n85_), .c(new_n83_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n162_), .c(new_n160_), .d(x18), .O(new_n165_));
  nand3  g103(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(x27), .c(x32), .O(new_n167_));
  aoi22  g105(.a(new_n161_), .b(new_n76_), .c(new_n72_), .d(x27), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n83_), .O(new_n169_));
  nand2  g107(.a(new_n168_), .b(x02), .O(new_n170_));
  ...
  nand2  g117(.a(new_n86_), .b(new_n64_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n137_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n140_), .c(new_n83_), .d(new_n136_), .O(z18));
  inv1   g121(.a(new_n143_), .O(z19));
  inv1   g122(.a(new_n137_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n83_), .c(new_n136_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n81_), .O(z20));
endmodule
