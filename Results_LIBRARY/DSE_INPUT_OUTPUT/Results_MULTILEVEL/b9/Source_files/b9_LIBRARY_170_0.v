...
module FAU ( 
  ...
  aoi22  g078(.a(new_n140_), .b(new_n137_), .c(new_n139_), .d(new_n95_), .O(new_n141_));
  ...
  nand4  g099(.a(new_n149_), .b(new_n63_), .c(new_n80_), .d(x28), .O(new_n162_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n64_), .c(new_n63_), .O(new_n168_));
  nand2  g106(.a(new_n164_), .b(new_n69_), .O(new_n169_));
  ...
  nand2  g117(.a(new_n98_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n136_), .O(new_n181_));
  ...
  oai22  g122(.a(new_n184_), .b(new_n79_), .c(new_n117_), .d(new_n89_), .O(z18));
  nand2  g123(.a(new_n140_), .b(new_n137_), .O(new_n186_));
  nand3  g124(.a(x40), .b(x39), .c(x29), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  inv1   g126(.a(x08), .O(new_n189_));
  oai21  g127(.a(new_n179_), .b(new_n83_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n80_), .c(new_n182_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n65_), .O(z19));
  inv1   g131(.a(new_n187_), .O(new_n194_));
  oai21  g132(.a(new_n136_), .b(new_n98_), .c(new_n189_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n98_), .c(new_n136_), .O(new_n196_));
