...
module FAU ( 
  ...
  nand4  g049(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n78_), .O(new_n112_));
  ...
  nand3  g056(.a(new_n115_), .b(x31), .c(new_n113_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n118_), .c(new_n107_), .O(z07));
  nand3  g058(.a(x40), .b(x39), .c(x31), .O(new_n121_));
  ...
  nor3   g071(.a(new_n133_), .b(new_n72_), .c(new_n78_), .O(new_n134_));
  ...
  nand4  g076(.a(new_n81_), .b(new_n138_), .c(new_n137_), .d(x04), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x31), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x40), .O(new_n141_));
  nand2  g079(.a(new_n74_), .b(x29), .O(new_n142_));
  ...
  oai21  g084(.a(new_n84_), .b(new_n64_), .c(new_n137_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n81_), .c(new_n138_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n141_), .O(z11));
  nor2   g088(.a(new_n70_), .b(new_n64_), .O(new_n151_));
  nand3  g089(.a(new_n98_), .b(new_n67_), .c(new_n66_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x27), .c(x10), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n65_), .c(new_n151_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(x31), .O(new_n155_));
  ...
  nand3  g106(.a(new_n134_), .b(new_n157_), .c(new_n65_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(z13));
  nand3  g108(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n171_));
  nand4  g109(.a(new_n158_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n172_));
  ...
  nand3  g113(.a(new_n98_), .b(new_n66_), .c(x28), .O(new_n176_));
  ...
  nand2  g133(.a(new_n79_), .b(new_n64_), .O(new_n196_));
  nand2  g134(.a(x40), .b(x04), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(x35), .c(new_n83_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(x31), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n196_), .c(x08), .O(new_n200_));
  nand2  g138(.a(x39), .b(x29), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(x31), .c(new_n73_), .O(new_n202_));
  aoi21  g140(.a(new_n144_), .b(new_n143_), .c(new_n202_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n200_), .c(new_n81_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(x09), .O(z19));
  inv1   g143(.a(new_n142_), .O(new_n206_));
  oai21  g144(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n207_));
  aoi21  g145(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n208_));
  oai21  g146(.a(new_n208_), .b(new_n206_), .c(new_n207_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n81_), .c(new_n138_), .O(new_n210_));
  nand2  g148(.a(new_n210_), .b(new_n79_), .O(z20));
endmodule
