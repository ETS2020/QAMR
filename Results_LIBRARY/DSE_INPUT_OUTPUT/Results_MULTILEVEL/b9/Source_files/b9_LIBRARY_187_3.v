...
module FAU ( 
  ...
  aoi21  g17(.a(new_n66_), .b(new_n79_), .c(new_n64_), .O(new_n80_));
  nand3  g18(.a(new_n80_), .b(new_n78_), .c(x21), .O(z03));
  inv1   g19(.a(x21), .O(new_n82_));
  nand3  g20(.a(new_n80_), .b(new_n78_), .c(new_n82_), .O(z04));
  inv1   g21(.a(x28), .O(new_n84_));
  oai21  g22(.a(new_n84_), .b(new_n79_), .c(new_n66_), .O(new_n85_));
  ...
  nand3  g44(.a(new_n107_), .b(z02), .c(x27), .O(new_n108_));
  inv1   g45(.a(new_n108_), .O(z10));
  inv1   g46(.a(x09), .O(new_n110_));
  nand2  g47(.a(x27), .b(x04), .O(new_n111_));
  inv1   g48(.a(x08), .O(new_n112_));
  nand2  g49(.a(new_n79_), .b(new_n112_), .O(new_n113_));
  nand4  g50(.a(new_n113_), .b(new_n111_), .c(x35), .d(new_n84_), .O(new_n114_));
  nand4  g51(.a(new_n114_), .b(z02), .c(new_n71_), .d(new_n110_), .O(new_n115_));
  inv1   g52(.a(new_n115_), .O(z11));
  aoi21  g53(.a(new_n68_), .b(x27), .c(new_n64_), .O(z12));
  nand4  g54(.a(new_n68_), .b(z02), .c(x27), .d(x20), .O(new_n118_));
  ...
  aoi21  g59(.a(new_n122_), .b(new_n68_), .c(new_n64_), .O(z14));
  inv1   g60(.a(x12), .O(new_n124_));
  nand4  g61(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n125_));
  nor2   g62(.a(new_n125_), .b(new_n124_), .O(z15));
  inv1   g63(.a(x23), .O(new_n127_));
  nand4  g64(.a(z02), .b(new_n127_), .c(x22), .d(x01), .O(new_n128_));
  inv1   g65(.a(new_n128_), .O(z16));
  inv1   g66(.a(x24), .O(new_n130_));
  nand4  g67(.a(new_n130_), .b(x23), .c(x22), .d(x01), .O(new_n131_));
  nand2  g68(.a(new_n131_), .b(z02), .O(z17));
  nand2  g69(.a(x27), .b(new_n104_), .O(new_n133_));
  oai21  g70(.a(x27), .b(new_n112_), .c(new_n133_), .O(new_n134_));
  nand3  g71(.a(new_n134_), .b(x35), .c(new_n84_), .O(new_n135_));
  nor2   g72(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g73(.a(new_n136_), .b(new_n135_), .c(new_n64_), .O(z18));
  oai21  g74(.a(x28), .b(new_n112_), .c(new_n79_), .O(new_n138_));
