...
module FAU ( 
  ...
  nor2   g042(.a(new_n86_), .b(new_n64_), .O(new_n105_));
  ...
  oai21  g077(.a(new_n81_), .b(new_n94_), .c(x39), .O(new_n140_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n149_), .c(new_n102_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nor2   g113(.a(new_n122_), .b(new_n175_), .O(z15));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n139_), .c(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n185_), .c(new_n82_), .d(new_n84_), .O(z18));
  inv1   g126(.a(new_n183_), .O(new_n189_));
  oai21  g127(.a(new_n66_), .b(new_n64_), .c(new_n93_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n84_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(x09), .c(new_n82_), .O(z20));
