...
module FAU ( 
  ...
  nand2  g001(.a(x17), .b(new_n63_), .O(new_n64_));
  ...
  oai21  g012(.a(new_n74_), .b(x17), .c(new_n63_), .O(new_n75_));
  nand4  g013(.a(new_n75_), .b(x40), .c(x39), .d(new_n66_), .O(new_n76_));
  oai22  g014(.a(new_n76_), .b(x04), .c(new_n73_), .d(new_n65_), .O(z00));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n89_), .c(new_n65_), .O(z02));
  nand2  g034(.a(new_n69_), .b(x27), .O(new_n97_));
  nand2  g035(.a(new_n68_), .b(new_n91_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n97_), .c(new_n64_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n68_), .b(new_n91_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n65_), .O(z04));
  ...
  nand2  g066(.a(new_n128_), .b(new_n119_), .O(new_n129_));
  ...
  nor2   g071(.a(new_n91_), .b(new_n119_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n82_), .c(new_n133_), .O(new_n135_));
  nand4  g073(.a(x35), .b(new_n81_), .c(x27), .d(new_n119_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n90_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n64_), .c(new_n78_), .d(new_n132_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  oai21  g078(.a(new_n94_), .b(x04), .c(new_n69_), .O(new_n141_));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n80_), .b(new_n142_), .c(new_n63_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  aoi22  g082(.a(new_n144_), .b(new_n68_), .c(new_n91_), .d(new_n63_), .O(new_n145_));
  inv1   g083(.a(new_n94_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n119_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n71_), .c(x10), .O(new_n148_));
  oai21  g086(.a(new_n145_), .b(x17), .c(new_n148_), .O(z12));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n150_), .d(new_n119_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n70_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n126_), .b(new_n150_), .c(new_n119_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n65_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n146_), .b(new_n150_), .c(new_n119_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n68_), .b(new_n142_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x27), .c(x32), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n78_), .c(new_n165_), .d(new_n71_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n166_), .c(new_n65_), .O(z14));
  inv1   g108(.a(x12), .O(new_n171_));
  nand4  g109(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n172_));
  ...
  oai21  g118(.a(new_n82_), .b(x27), .c(new_n133_), .O(new_n181_));
  nand3  g119(.a(new_n136_), .b(new_n78_), .c(new_n132_), .O(new_n182_));
  ...
  oai21  g123(.a(new_n142_), .b(new_n91_), .c(new_n90_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n91_), .c(new_n142_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n78_), .c(new_n132_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n64_), .O(z20));
  inv1   g128(.a(new_n139_), .O(z19));
endmodule
