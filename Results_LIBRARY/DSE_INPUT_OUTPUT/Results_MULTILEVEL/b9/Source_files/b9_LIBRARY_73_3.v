...
module FAU ( 
  ...
  nand3  g43(.a(new_n106_), .b(z02), .c(x27), .O(new_n107_));
  ...
  nor2   g57(.a(new_n64_), .b(new_n79_), .O(new_n121_));
  nand4  g58(.a(new_n121_), .b(new_n120_), .c(new_n68_), .d(x20), .O(z14));
  nand4  g59(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n123_));
  nand2  g60(.a(new_n123_), .b(z02), .O(z15));
  inv1   g61(.a(x23), .O(new_n125_));
  nand3  g62(.a(new_n125_), .b(x22), .c(x01), .O(new_n126_));
  nand2  g63(.a(new_n126_), .b(z02), .O(z16));
  inv1   g64(.a(x24), .O(new_n128_));
  nand4  g65(.a(new_n128_), .b(x23), .c(x22), .d(x01), .O(new_n129_));
  nand2  g66(.a(new_n129_), .b(z02), .O(z17));
  nand2  g67(.a(x27), .b(new_n103_), .O(new_n131_));
  oai21  g68(.a(x27), .b(new_n112_), .c(new_n131_), .O(new_n132_));
  nand3  g69(.a(new_n132_), .b(x35), .c(new_n110_), .O(new_n133_));
  nand4  g70(.a(new_n133_), .b(z02), .c(new_n71_), .d(new_n109_), .O(z18));
  oai21  g71(.a(x28), .b(new_n112_), .c(new_n79_), .O(new_n135_));
  nand2  g72(.a(new_n135_), .b(x35), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(new_n71_), .c(new_n109_), .O(new_n137_));
  nand2  g74(.a(new_n137_), .b(z02), .O(z20));
  zero   g75(.O(z08));
