...
module FAU ( 
  ...
  nand2  g016(.a(new_n78_), .b(x15), .O(new_n79_));
  ...
  aoi21  g044(.a(new_n106_), .b(new_n70_), .c(new_n81_), .O(z05));
  nand3  g045(.a(new_n106_), .b(new_n79_), .c(new_n70_), .O(new_n108_));
  ...
  nand2  g059(.a(new_n79_), .b(new_n121_), .O(z08));
  ...
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n79_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  nand3  g076(.a(x40), .b(x39), .c(x29), .O(new_n139_));
  nor2   g077(.a(new_n64_), .b(new_n65_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n85_), .c(new_n139_), .O(new_n141_));
  inv1   g079(.a(x08), .O(new_n142_));
  nand2  g080(.a(x27), .b(new_n65_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n85_), .c(new_n142_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n82_), .c(new_n138_), .O(new_n146_));
  ...
  oai21  g089(.a(new_n121_), .b(x04), .c(new_n151_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n150_), .c(new_n79_), .O(z12));
  ...
  nor2   g099(.a(new_n160_), .b(x15), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n161_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n132_), .b(new_n154_), .c(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand3  g103(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n166_));
  nand4  g104(.a(new_n155_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x39), .b(new_n154_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n78_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n97_), .c(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n83_), .c(new_n82_), .O(new_n174_));
  nand2  g112(.a(new_n168_), .b(new_n151_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  nand3  g115(.a(new_n151_), .b(new_n78_), .c(new_n63_), .O(new_n178_));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n143_), .c(new_n66_), .O(new_n190_));
  nand2  g128(.a(new_n82_), .b(new_n138_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n84_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n81_), .c(new_n91_), .d(new_n121_), .O(z18));
  inv1   g131(.a(new_n139_), .O(new_n194_));
  oai21  g132(.a(new_n66_), .b(new_n64_), .c(new_n142_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n82_), .c(new_n138_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n79_), .O(z20));
  nand2  g137(.a(new_n146_), .b(new_n79_), .O(z19));
endmodule
