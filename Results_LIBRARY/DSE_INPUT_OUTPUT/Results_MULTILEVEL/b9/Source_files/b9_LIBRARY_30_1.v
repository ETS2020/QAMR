...
module FAU ( 
  ...
  nand2  g049(.a(new_n111_), .b(new_n63_), .O(new_n112_));
  oai21  g050(.a(new_n109_), .b(x31), .c(new_n112_), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(x03), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n64_), .O(z07));
  aoi21  g053(.a(new_n93_), .b(x14), .c(new_n74_), .O(z08));
  ...
  nand4  g059(.a(x40), .b(x39), .c(x14), .d(x05), .O(new_n122_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x14), .O(new_n147_));
  or2    g085(.a(new_n71_), .b(x40), .O(new_n148_));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n120_), .O(new_n153_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(new_n68_), .O(new_n158_));
  nand4  g096(.a(new_n128_), .b(x39), .c(new_n150_), .d(new_n120_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x14), .c(new_n74_), .O(new_n160_));
  or2    g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n162_));
  nand4  g100(.a(new_n151_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n163_));
  nand3  g101(.a(x39), .b(new_n150_), .c(new_n120_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n63_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n74_), .c(new_n162_), .O(new_n167_));
  nand3  g105(.a(new_n69_), .b(new_n143_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n80_), .c(new_n79_), .O(new_n170_));
  oai21  g108(.a(new_n165_), .b(new_n71_), .c(new_n170_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x14), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n167_), .c(new_n148_), .O(z14));
  ...
  nand2  g121(.a(new_n94_), .b(x29), .O(new_n184_));
  oai21  g122(.a(new_n83_), .b(x27), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n68_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n136_), .c(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n64_), .d(new_n183_), .O(z18));
  nand2  g127(.a(x40), .b(x04), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(x35), .c(new_n82_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x14), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n133_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n140_), .c(new_n79_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(x09), .O(z19));
  inv1   g133(.a(new_n184_), .O(new_n196_));
  inv1   g134(.a(x08), .O(new_n197_));
  oai21  g135(.a(new_n143_), .b(new_n68_), .c(new_n197_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n143_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n196_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n183_), .O(new_n201_));
