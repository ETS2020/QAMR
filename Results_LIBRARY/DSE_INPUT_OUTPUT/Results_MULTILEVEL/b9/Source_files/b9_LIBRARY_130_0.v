...
module FAU ( 
  ...
  aoi21  g036(.a(new_n66_), .b(new_n98_), .c(new_n63_), .O(new_n99_));
  ...
  nand3  g042(.a(new_n104_), .b(new_n79_), .c(new_n66_), .O(z05));
  ...
  oai21  g060(.a(new_n94_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  ...
  nand2  g070(.a(new_n79_), .b(new_n98_), .O(new_n133_));
  oai21  g071(.a(new_n84_), .b(x04), .c(x40), .O(new_n134_));
  ...
  nand2  g076(.a(new_n74_), .b(x24), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(new_n136_), .c(new_n139_), .d(new_n138_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n135_), .c(new_n80_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(x09), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n98_), .c(new_n73_), .O(new_n145_));
  oai21  g083(.a(new_n94_), .b(x04), .c(new_n69_), .O(new_n146_));
  ...
  oai21  g103(.a(new_n165_), .b(new_n160_), .c(new_n161_), .O(new_n166_));
  ...
  oai21  g108(.a(new_n164_), .b(new_n70_), .c(new_n170_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x40), .O(new_n172_));
  nand3  g110(.a(new_n69_), .b(new_n74_), .c(x24), .O(new_n173_));
  ...
  nand3  g117(.a(x23), .b(x22), .c(x01), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(x40), .c(x24), .O(z17));
  nand2  g119(.a(new_n95_), .b(x29), .O(new_n182_));
  oai21  g120(.a(new_n84_), .b(x27), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n98_), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n136_), .c(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n184_), .c(new_n79_), .d(new_n80_), .O(z18));
  inv1   g125(.a(x09), .O(new_n188_));
  nor2   g126(.a(x40), .b(x35), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n92_), .c(x24), .O(new_n190_));
  nand2  g128(.a(new_n140_), .b(new_n83_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n182_), .O(new_n192_));
  inv1   g130(.a(x08), .O(new_n193_));
  nand2  g131(.a(x35), .b(x27), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(x04), .c(new_n193_), .O(new_n195_));
  nand2  g133(.a(new_n137_), .b(new_n167_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(x40), .O(new_n198_));
  nand2  g136(.a(x28), .b(new_n193_), .O(new_n199_));
  nand4  g137(.a(new_n199_), .b(new_n198_), .c(new_n192_), .d(new_n190_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n188_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n79_), .O(z19));
  nand2  g140(.a(x28), .b(new_n98_), .O(new_n203_));
  aoi22  g141(.a(new_n203_), .b(x35), .c(new_n139_), .d(new_n138_), .O(new_n204_));
  nand2  g142(.a(x40), .b(new_n167_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n133_), .c(x08), .O(new_n206_));
