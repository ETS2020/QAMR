...
module FAU ( 
  ...
  nand2  g017(.a(new_n79_), .b(x30), .O(new_n80_));
  nand3  g018(.a(new_n80_), .b(new_n78_), .c(x16), .O(z00));
  inv1   g019(.a(x28), .O(new_n82_));
  aoi21  g020(.a(x35), .b(new_n82_), .c(x36), .O(new_n83_));
  nor3   g021(.a(new_n83_), .b(x30), .c(new_n64_), .O(new_n84_));
  oai21  g022(.a(new_n84_), .b(x32), .c(x04), .O(z01));
  ...
  nand4  g062(.a(new_n75_), .b(x32), .c(x05), .d(new_n65_), .O(new_n125_));
  ...
  nand2  g073(.a(new_n135_), .b(new_n80_), .O(z11));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(x30), .O(new_n150_));
  nand4  g088(.a(new_n72_), .b(x32), .c(x20), .d(new_n148_), .O(new_n151_));
  ...
  nand3  g092(.a(new_n154_), .b(new_n75_), .c(x32), .O(new_n155_));
  ...
  nand4  g115(.a(new_n177_), .b(new_n132_), .c(new_n120_), .d(new_n127_), .O(z18));
  inv1   g116(.a(new_n135_), .O(z19));
  inv1   g117(.a(new_n128_), .O(new_n180_));
  oai21  g118(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n181_));
  aoi21  g119(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n180_), .c(new_n181_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n120_), .c(new_n127_), .O(new_n184_));
