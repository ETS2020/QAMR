...
module FAU ( 
  ...
  nand2  g034(.a(new_n76_), .b(x33), .O(new_n97_));
  ...
  nand3  g050(.a(new_n112_), .b(new_n110_), .c(new_n81_), .O(new_n113_));
  ...
  nand2  g091(.a(new_n153_), .b(x33), .O(new_n154_));
  ...
  nand2  g127(.a(new_n77_), .b(x29), .O(new_n190_));
  oai21  g128(.a(new_n87_), .b(x27), .c(new_n190_), .O(new_n191_));
  ...
  inv1   g133(.a(new_n190_), .O(new_n196_));
  inv1   g134(.a(x08), .O(new_n197_));
  oai21  g135(.a(new_n66_), .b(new_n64_), .c(new_n197_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n196_), .c(new_n198_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n84_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(x09), .c(new_n82_), .O(z20));
