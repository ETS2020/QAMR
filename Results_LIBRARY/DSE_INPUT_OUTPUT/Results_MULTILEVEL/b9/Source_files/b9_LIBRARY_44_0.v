...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n90_), .c(x39), .O(new_n96_));
  nand2  g034(.a(x40), .b(new_n75_), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n96_), .O(z02));
  nand2  g036(.a(new_n71_), .b(x27), .O(new_n99_));
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(new_n83_), .O(new_n100_));
  ...
  nand3  g073(.a(x35), .b(new_n91_), .c(new_n65_), .O(new_n136_));
  ...
  aoi22  g079(.a(new_n141_), .b(new_n86_), .c(new_n140_), .d(new_n97_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n138_), .c(new_n84_), .O(new_n143_));
  ...
  oai21  g119(.a(new_n92_), .b(x27), .c(new_n181_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n64_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n86_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n183_), .c(new_n81_), .d(new_n84_), .O(z18));
  inv1   g124(.a(new_n181_), .O(new_n187_));
  nor2   g125(.a(new_n66_), .b(new_n64_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .d(x08), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n84_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(x09), .c(new_n81_), .O(z20));
  nor2   g130(.a(new_n143_), .b(x09), .O(z19));
endmodule
