...
module FAU ( 
  ...
  aoi21  g023(.a(new_n85_), .b(x04), .c(new_n82_), .O(new_n86_));
  ...
  nand4  g072(.a(new_n134_), .b(x35), .c(new_n76_), .d(x27), .O(new_n135_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n70_), .O(z11));
  nor2   g077(.a(new_n64_), .b(new_n92_), .O(new_n140_));
  nand3  g078(.a(new_n93_), .b(new_n75_), .c(new_n83_), .O(new_n141_));
  ...
  nand3  g093(.a(new_n122_), .b(new_n146_), .c(new_n117_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x39), .c(new_n155_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n154_), .O(z13));
  aoi21  g096(.a(new_n146_), .b(new_n117_), .c(new_n69_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n160_));
  oai22  g098(.a(new_n160_), .b(new_n64_), .c(new_n159_), .d(new_n155_), .O(new_n161_));
  ...
  oai21  g102(.a(new_n164_), .b(new_n76_), .c(x27), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n74_), .d(new_n73_), .O(new_n166_));
  ...
  nand2  g109(.a(new_n171_), .b(new_n70_), .O(z16));
  inv1   g110(.a(x24), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(x23), .c(x22), .d(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n70_), .O(z17));
  oai21  g113(.a(new_n77_), .b(x27), .c(new_n129_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  nor2   g115(.a(new_n92_), .b(x04), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n84_), .c(x09), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n177_), .c(new_n70_), .d(new_n73_), .O(z18));
  inv1   g118(.a(x29), .O(new_n181_));
  aoi21  g119(.a(x39), .b(new_n181_), .c(new_n155_), .O(new_n182_));
  aoi21  g120(.a(new_n130_), .b(new_n84_), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n70_), .b(new_n92_), .O(new_n184_));
  nand3  g122(.a(x35), .b(new_n76_), .c(new_n117_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x39), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n184_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n183_), .c(new_n73_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(x09), .O(z19));
  aoi21  g127(.a(x28), .b(new_n92_), .c(new_n83_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(new_n182_), .O(new_n191_));
  nand2  g129(.a(x39), .b(new_n83_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n184_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n73_), .O(new_n194_));
