...
module FAU ( 
  ...
  nand2  g001(.a(x40), .b(x33), .O(new_n64_));
  ...
  or2    g022(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g023(.a(new_n85_), .b(new_n81_), .c(new_n80_), .O(new_n86_));
  aoi21  g024(.a(new_n86_), .b(x04), .c(new_n79_), .O(z01));
  inv1   g025(.a(x02), .O(new_n88_));
  nand2  g026(.a(x29), .b(x08), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g028(.a(x35), .b(new_n83_), .O(new_n91_));
  nor2   g029(.a(x27), .b(x08), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n91_), .c(x04), .O(new_n93_));
  nand3  g031(.a(new_n93_), .b(new_n90_), .c(x39), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x40), .O(z02));
  nand2  g034(.a(new_n66_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi21  g036(.a(new_n65_), .b(new_n82_), .c(new_n98_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n97_), .c(new_n79_), .O(z03));
  nand2  g038(.a(new_n65_), .b(new_n82_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n97_), .c(new_n64_), .d(new_n98_), .O(z04));
  nor2   g040(.a(new_n83_), .b(new_n82_), .O(new_n103_));
  inv1   g041(.a(new_n103_), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n64_), .c(new_n65_), .O(z05));
  ...
  aoi21  g056(.a(new_n118_), .b(new_n117_), .c(new_n107_), .O(z07));
  oai21  g057(.a(x39), .b(x33), .c(x40), .O(new_n120_));
  ...
  nand2  g063(.a(new_n120_), .b(x07), .O(new_n126_));
  inv1   g064(.a(x39), .O(new_n127_));
  nor2   g065(.a(new_n74_), .b(new_n127_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n72_), .c(x05), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n126_), .c(new_n84_), .O(new_n130_));
  ...
  nor3   g072(.a(new_n134_), .b(new_n127_), .c(x33), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x05), .c(new_n125_), .O(new_n136_));
  oai21  g074(.a(new_n133_), .b(new_n82_), .c(new_n136_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  aoi21  g076(.a(x40), .b(x33), .c(x27), .O(new_n139_));
  nand3  g077(.a(x35), .b(new_n83_), .c(new_n125_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n72_), .c(new_n139_), .O(new_n141_));
  nand2  g079(.a(x39), .b(x29), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n72_), .c(new_n74_), .O(new_n143_));
  nand2  g081(.a(x27), .b(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(x35), .c(new_n83_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  oai22  g084(.a(new_n146_), .b(new_n143_), .c(new_n141_), .d(x08), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n80_), .c(new_n138_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(z11));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n82_), .c(new_n73_), .O(new_n151_));
  nand2  g089(.a(new_n128_), .b(new_n125_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n68_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n151_), .c(new_n64_), .O(z12));
  inv1   g092(.a(x13), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n74_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n125_), .O(new_n158_));
  inv1   g096(.a(x18), .O(new_n159_));
  inv1   g097(.a(x19), .O(new_n160_));
  nand4  g098(.a(new_n67_), .b(x20), .c(new_n160_), .d(new_n159_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(x33), .O(new_n162_));
  nand4  g100(.a(new_n67_), .b(new_n74_), .c(x20), .d(new_n160_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n135_), .b(new_n155_), .c(new_n125_), .O(new_n166_));
  ...
  nand3  g108(.a(new_n128_), .b(new_n155_), .c(new_n125_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  inv1   g110(.a(x35), .O(new_n173_));
  nand3  g111(.a(new_n65_), .b(new_n173_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n81_), .c(new_n80_), .O(new_n176_));
  aoi21  g114(.a(new_n171_), .b(new_n68_), .c(new_n79_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n172_), .O(z14));
  nand4  g116(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n64_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x22), .c(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n64_), .O(z16));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(x23), .c(x22), .d(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n64_), .O(z17));
  nand2  g124(.a(x27), .b(new_n125_), .O(new_n187_));
  nand2  g125(.a(new_n82_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n173_), .O(new_n189_));
  nand2  g127(.a(new_n80_), .b(new_n138_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n83_), .c(new_n190_), .O(new_n191_));
  nand2  g129(.a(new_n128_), .b(new_n72_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n89_), .c(new_n191_), .d(new_n79_), .O(z18));
  inv1   g131(.a(x08), .O(new_n194_));
  nand2  g132(.a(new_n173_), .b(new_n72_), .O(new_n195_));
  nand2  g133(.a(x40), .b(x04), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n195_), .c(new_n83_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n139_), .c(new_n194_), .O(new_n198_));
  nand3  g136(.a(new_n195_), .b(new_n144_), .c(new_n83_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n142_), .O(new_n200_));
  nand2  g138(.a(new_n145_), .b(new_n74_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n200_), .c(new_n198_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n80_), .c(new_n138_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n64_), .O(z19));
  aoi21  g142(.a(x28), .b(new_n82_), .c(new_n173_), .O(new_n205_));
  inv1   g143(.a(new_n195_), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n139_), .c(new_n194_), .O(new_n207_));
  oai21  g145(.a(new_n205_), .b(new_n143_), .c(new_n207_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n80_), .c(new_n138_), .O(new_n209_));
  inv1   g147(.a(new_n209_), .O(z20));
endmodule
