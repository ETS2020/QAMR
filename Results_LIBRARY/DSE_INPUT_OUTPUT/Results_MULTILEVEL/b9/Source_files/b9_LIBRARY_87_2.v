...
module FAU ( 
  ...
  nand4  g023(.a(new_n85_), .b(x40), .c(new_n80_), .d(new_n79_), .O(new_n86_));
  ...
  oai21  g030(.a(x40), .b(x04), .c(new_n92_), .O(z02));
  ...
  nor2   g037(.a(new_n82_), .b(new_n68_), .O(new_n100_));
  ...
  nand3  g063(.a(x40), .b(x37), .c(x06), .O(new_n126_));
  ...
  oai21  g076(.a(new_n63_), .b(new_n138_), .c(new_n83_), .O(new_n139_));
  oai21  g077(.a(new_n68_), .b(x04), .c(new_n138_), .O(new_n140_));
  ...
  nor2   g084(.a(z08), .b(new_n71_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n73_), .O(new_n148_));
  nor2   g086(.a(new_n71_), .b(new_n63_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x04), .O(new_n150_));
  ...
  nand4  g092(.a(new_n154_), .b(x40), .c(x39), .d(new_n152_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(x04), .O(new_n160_));
  ...
  nand3  g101(.a(new_n131_), .b(new_n152_), .c(new_n73_), .O(new_n164_));
  ...
  nor2   g105(.a(new_n115_), .b(x13), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n167_), .c(x04), .O(new_n169_));
  nor2   g107(.a(new_n63_), .b(new_n73_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n69_), .b(new_n144_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n80_), .c(new_n79_), .O(new_n174_));
  oai21  g112(.a(new_n168_), .b(new_n71_), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n73_), .O(new_n176_));
  ...
  oai21  g123(.a(x30), .b(x09), .c(new_n64_), .O(new_n186_));
  nand3  g124(.a(x40), .b(new_n68_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n89_), .b(x04), .c(new_n187_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(x35), .c(new_n82_), .O(new_n189_));
  nand3  g127(.a(z08), .b(x29), .c(x08), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n189_), .c(new_n186_), .O(z18));
  inv1   g129(.a(new_n89_), .O(new_n192_));
  and2   g130(.a(x40), .b(x08), .O(new_n193_));
  nand2  g131(.a(new_n134_), .b(x27), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n83_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n192_), .c(x04), .O(new_n197_));
  nand2  g135(.a(x28), .b(new_n68_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n135_), .c(x35), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n134_), .O(new_n200_));
  nand2  g138(.a(x35), .b(x27), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(x04), .c(new_n138_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n200_), .c(new_n63_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n197_), .c(new_n79_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(x09), .O(z19));
  oai21  g143(.a(new_n68_), .b(x04), .c(new_n63_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n144_), .O(new_n207_));
  nand3  g145(.a(x40), .b(x28), .c(new_n68_), .O(new_n208_));
  aoi22  g146(.a(new_n208_), .b(new_n207_), .c(x39), .d(x29), .O(new_n209_));
  nand3  g147(.a(new_n201_), .b(new_n64_), .c(new_n138_), .O(new_n210_));
  nand2  g148(.a(new_n198_), .b(x35), .O(new_n211_));
  nand3  g149(.a(new_n211_), .b(new_n63_), .c(new_n73_), .O(new_n212_));
  nand2  g150(.a(new_n212_), .b(new_n210_), .O(new_n213_));
  oai21  g151(.a(new_n213_), .b(new_n209_), .c(new_n79_), .O(new_n214_));
