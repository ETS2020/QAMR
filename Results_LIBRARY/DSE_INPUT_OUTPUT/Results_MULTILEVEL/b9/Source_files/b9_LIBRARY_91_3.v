...
module FAU ( 
  ...
  nand2  g000(.a(x40), .b(x33), .O(new_n63_));
  ...
  nand2  g051(.a(new_n113_), .b(new_n72_), .O(new_n114_));
  nand3  g052(.a(new_n111_), .b(new_n74_), .c(new_n109_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n114_), .c(new_n103_), .O(z07));
  ...
  nand4  g073(.a(new_n79_), .b(new_n135_), .c(new_n134_), .d(x04), .O(new_n136_));
  ...
  oai21  g080(.a(new_n83_), .b(new_n67_), .c(new_n134_), .O(new_n143_));
  ...
  nand3  g085(.a(new_n68_), .b(new_n81_), .c(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi21  g087(.a(x39), .b(new_n122_), .c(new_n70_), .O(new_n150_));
  ...
  nand2  g091(.a(new_n153_), .b(new_n74_), .O(new_n154_));
  ...
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n156_), .d(new_n122_), .O(new_n159_));
  ...
  nand4  g102(.a(new_n128_), .b(x39), .c(new_n156_), .d(new_n122_), .O(new_n165_));
  ...
  nand3  g108(.a(x39), .b(new_n156_), .c(new_n122_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(x33), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n74_), .c(new_n169_), .O(new_n174_));
  nand3  g112(.a(new_n68_), .b(new_n147_), .c(x28), .O(new_n175_));
  ...
  nor2   g120(.a(new_n120_), .b(new_n182_), .O(z15));
  ...
  nand2  g126(.a(new_n188_), .b(new_n63_), .O(z17));
  oai21  g127(.a(new_n83_), .b(x27), .c(new_n139_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  inv1   g129(.a(new_n83_), .O(new_n192_));
  nor2   g130(.a(new_n67_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n191_), .c(new_n63_), .d(new_n79_), .O(z18));
  aoi21  g133(.a(x40), .b(x33), .c(x27), .O(new_n196_));
  nand3  g134(.a(x35), .b(new_n82_), .c(new_n122_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n72_), .c(new_n196_), .O(new_n198_));
  aoi21  g136(.a(x39), .b(x29), .c(x33), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n74_), .c(new_n141_), .O(new_n200_));
  oai21  g138(.a(new_n198_), .b(x08), .c(new_n200_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n79_), .c(new_n135_), .O(new_n202_));
  inv1   g140(.a(new_n202_), .O(z19));
  nor2   g141(.a(new_n199_), .b(new_n74_), .O(new_n204_));
  aoi21  g142(.a(x28), .b(new_n67_), .c(new_n147_), .O(new_n205_));
  nor2   g143(.a(x35), .b(x33), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n196_), .c(new_n134_), .O(new_n207_));
  oai21  g145(.a(new_n205_), .b(new_n204_), .c(new_n207_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n79_), .c(new_n135_), .O(new_n209_));
