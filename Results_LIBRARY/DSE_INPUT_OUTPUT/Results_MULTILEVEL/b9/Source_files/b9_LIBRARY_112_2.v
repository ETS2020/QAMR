...
module FAU ( 
  ...
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n83_), .O(z12));
  ...
  nand3  g095(.a(new_n128_), .b(new_n149_), .c(new_n67_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n157_), .c(new_n64_), .O(z13));
  ...
  nand3  g100(.a(new_n78_), .b(new_n149_), .c(new_n67_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n72_), .b(new_n68_), .c(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n85_), .c(new_n84_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n146_), .c(new_n64_), .O(new_n168_));
  ...
  nand2  g111(.a(new_n173_), .b(new_n83_), .O(z16));
  inv1   g112(.a(x01), .O(new_n175_));
  inv1   g113(.a(x24), .O(new_n176_));
  nand4  g114(.a(new_n83_), .b(new_n176_), .c(x23), .d(x22), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n175_), .O(z17));
  nand2  g116(.a(new_n93_), .b(new_n66_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n134_), .c(new_n137_), .O(new_n180_));
  nand2  g118(.a(new_n138_), .b(new_n84_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n180_), .c(new_n63_), .O(new_n182_));
  nand2  g120(.a(x17), .b(x09), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n182_), .O(z18));
  ...
  nand3  g126(.a(new_n188_), .b(new_n84_), .c(new_n63_), .O(new_n189_));
