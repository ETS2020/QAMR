...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(new_n66_), .c(x10), .d(new_n74_), .O(new_n77_));
  oai21  g015(.a(new_n73_), .b(new_n65_), .c(new_n77_), .O(z00));
  ...
  oai21  g029(.a(new_n91_), .b(new_n88_), .c(x10), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x40), .O(z02));
  nand2  g031(.a(new_n69_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x27), .O(new_n95_));
  aoi21  g033(.a(new_n68_), .b(new_n95_), .c(new_n65_), .O(new_n96_));
  ...
  nand3  g038(.a(new_n100_), .b(new_n64_), .c(new_n68_), .O(z05));
  ...
  nand3  g051(.a(x40), .b(x39), .c(x10), .O(new_n114_));
  ...
  nand2  g062(.a(new_n124_), .b(new_n74_), .O(new_n125_));
  ...
  nand2  g068(.a(new_n79_), .b(new_n130_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n129_), .c(x10), .O(new_n132_));
  ...
  oai21  g077(.a(new_n83_), .b(new_n95_), .c(new_n128_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n79_), .c(new_n130_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n133_), .O(z11));
  nor2   g081(.a(new_n75_), .b(x04), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n72_), .c(new_n64_), .O(z12));
  ...
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n146_), .d(new_n74_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand4  g090(.a(new_n70_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand4  g093(.a(new_n122_), .b(x39), .c(new_n146_), .d(new_n74_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x10), .O(new_n157_));
  ...
  nand3  g100(.a(new_n76_), .b(new_n146_), .c(new_n74_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n68_), .b(new_n135_), .c(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n80_), .c(new_n79_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n71_), .c(new_n65_), .O(new_n168_));
  ...
  nand2  g116(.a(x27), .b(new_n74_), .O(new_n179_));
  nand2  g117(.a(new_n95_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n135_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n82_), .c(new_n131_), .O(new_n182_));
  nand2  g120(.a(x10), .b(x08), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n134_), .c(new_n182_), .d(new_n65_), .O(z18));
  nand2  g122(.a(new_n64_), .b(new_n95_), .O(new_n185_));
  nand3  g123(.a(x35), .b(new_n82_), .c(new_n74_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x10), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n185_), .c(x08), .O(new_n188_));
  nand2  g126(.a(x39), .b(x29), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(x10), .c(new_n147_), .O(new_n190_));
  aoi21  g128(.a(new_n137_), .b(new_n136_), .c(new_n190_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n79_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z19));
  aoi21  g131(.a(x28), .b(new_n95_), .c(new_n135_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n190_), .O(new_n195_));
  oai21  g133(.a(new_n135_), .b(new_n95_), .c(x10), .O(new_n196_));
  nand2  g134(.a(new_n147_), .b(new_n95_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n79_), .O(new_n199_));
