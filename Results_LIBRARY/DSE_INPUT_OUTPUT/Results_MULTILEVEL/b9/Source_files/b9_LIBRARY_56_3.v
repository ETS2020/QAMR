...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n87_), .c(new_n72_), .O(new_n93_));
  ...
  nand3  g052(.a(x40), .b(x39), .c(new_n72_), .O(new_n115_));
  ...
  oai21  g059(.a(x39), .b(x22), .c(x40), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x07), .O(new_n123_));
  inv1   g061(.a(x39), .O(new_n124_));
  nor2   g062(.a(new_n74_), .b(new_n124_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n72_), .c(x05), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n123_), .c(new_n121_), .O(new_n127_));
  nand3  g065(.a(new_n64_), .b(x37), .c(x06), .O(new_n128_));
  inv1   g066(.a(new_n128_), .O(new_n129_));
  aoi21  g067(.a(new_n127_), .b(new_n120_), .c(new_n129_), .O(new_n130_));
  oai21  g068(.a(x32), .b(x30), .c(x40), .O(new_n131_));
  nor3   g069(.a(new_n131_), .b(new_n124_), .c(x22), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x05), .c(new_n120_), .O(new_n133_));
  oai21  g071(.a(new_n130_), .b(new_n96_), .c(new_n133_), .O(z10));
  inv1   g072(.a(x08), .O(new_n135_));
  inv1   g073(.a(x09), .O(new_n136_));
  nand4  g074(.a(new_n80_), .b(new_n136_), .c(new_n135_), .d(x04), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n72_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  nand2  g077(.a(new_n125_), .b(x29), .O(new_n140_));
  ...
  oai21  g081(.a(new_n89_), .b(new_n96_), .c(new_n135_), .O(new_n144_));
  ...
  nand2  g087(.a(new_n125_), .b(new_n120_), .O(new_n150_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(x22), .O(new_n160_));
  nand4  g098(.a(new_n67_), .b(new_n74_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n132_), .b(new_n153_), .c(new_n120_), .O(new_n164_));
  ...
  nand3  g106(.a(new_n125_), .b(new_n153_), .c(new_n120_), .O(new_n169_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n68_), .c(new_n79_), .O(new_n174_));
  ...
  aoi21  g117(.a(new_n179_), .b(new_n74_), .c(new_n72_), .O(z16));
  nand3  g118(.a(x23), .b(x22), .c(x01), .O(new_n181_));
  nor3   g119(.a(new_n181_), .b(x40), .c(x24), .O(z17));
  oai21  g120(.a(new_n89_), .b(x27), .c(new_n140_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n96_), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n83_), .c(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n184_), .c(new_n64_), .d(new_n136_), .O(z18));
  inv1   g125(.a(new_n142_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n88_), .c(new_n120_), .O(new_n189_));
  aoi22  g127(.a(new_n189_), .b(new_n72_), .c(new_n64_), .d(new_n96_), .O(new_n190_));
  nand2  g128(.a(x39), .b(x29), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n72_), .c(new_n74_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n188_), .c(new_n190_), .d(x08), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n80_), .c(new_n136_), .O(new_n194_));
  inv1   g132(.a(new_n194_), .O(z19));
  aoi21  g133(.a(x28), .b(new_n96_), .c(new_n82_), .O(new_n196_));
  aoi21  g134(.a(x35), .b(x27), .c(x22), .O(new_n197_));
  nor2   g135(.a(x40), .b(x27), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n197_), .c(new_n135_), .O(new_n199_));
  oai21  g137(.a(new_n196_), .b(new_n192_), .c(new_n199_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n136_), .O(new_n201_));
