...
module FAU ( 
  ...
  nand2  g054(.a(new_n94_), .b(new_n78_), .O(z08));
  ...
  oai21  g069(.a(x40), .b(x34), .c(new_n66_), .O(new_n132_));
  ...
  nand2  g077(.a(new_n73_), .b(x34), .O(new_n140_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n73_), .c(x34), .O(new_n150_));
  ...
  nand4  g098(.a(new_n158_), .b(x34), .c(x20), .d(new_n157_), .O(new_n161_));
  ...
  nand3  g106(.a(new_n95_), .b(new_n152_), .c(new_n71_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n67_), .b(new_n136_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n80_), .c(new_n79_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n149_), .c(new_n63_), .O(new_n174_));
  ...
  oai22  g122(.a(new_n94_), .b(new_n90_), .c(new_n83_), .d(x27), .O(new_n185_));
  ...
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n78_), .d(new_n79_), .O(z18));
  inv1   g127(.a(x09), .O(new_n190_));
  oai21  g128(.a(new_n136_), .b(x04), .c(x40), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n132_), .c(new_n82_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n89_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n136_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n141_), .c(new_n82_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n138_), .O(new_n196_));
  nand2  g134(.a(new_n136_), .b(x34), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n141_), .c(new_n82_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n73_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n196_), .c(new_n193_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n190_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n78_), .O(z19));
  nand2  g140(.a(x28), .b(new_n66_), .O(new_n203_));
  aoi22  g141(.a(new_n203_), .b(x35), .c(new_n140_), .d(new_n139_), .O(new_n204_));
  aoi21  g142(.a(new_n194_), .b(new_n132_), .c(x08), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n204_), .c(new_n79_), .O(new_n206_));
