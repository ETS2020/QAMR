...
module FAU ( 
  ...
  oai21  g031(.a(new_n93_), .b(new_n90_), .c(x39), .O(new_n94_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n66_), .O(z04));
  ...
  oai21  g071(.a(x40), .b(x39), .c(new_n99_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n84_), .c(new_n75_), .O(new_n135_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n95_), .O(new_n143_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n99_), .c(new_n76_), .O(new_n147_));
  oai21  g085(.a(new_n119_), .b(x04), .c(new_n72_), .O(new_n148_));
  ...
  nand4  g090(.a(new_n152_), .b(x40), .c(new_n150_), .d(new_n75_), .O(new_n153_));
  ...
  nand4  g095(.a(new_n71_), .b(x40), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n128_), .b(new_n150_), .c(new_n75_), .O(new_n161_));
  ...
  nand3  g103(.a(x40), .b(new_n150_), .c(new_n75_), .O(new_n166_));
  ...
  nand3  g107(.a(new_n69_), .b(new_n138_), .c(x28), .O(new_n170_));
  ...
  nand3  g112(.a(new_n72_), .b(x40), .c(new_n63_), .O(new_n175_));
  ...
  oai22  g125(.a(new_n119_), .b(new_n187_), .c(new_n85_), .d(x27), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n99_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n139_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n65_), .d(new_n81_), .O(z18));
  inv1   g130(.a(x09), .O(new_n193_));
  inv1   g131(.a(x08), .O(new_n194_));
  oai21  g132(.a(new_n138_), .b(x04), .c(x39), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n134_), .c(new_n84_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n194_), .O(new_n197_));
  nand2  g135(.a(x39), .b(new_n138_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n142_), .c(new_n84_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n140_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n138_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n142_), .c(new_n84_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n63_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n200_), .c(new_n197_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n81_), .c(new_n193_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n65_), .O(z19));
  nand2  g144(.a(x28), .b(new_n99_), .O(new_n207_));
  aoi22  g145(.a(new_n207_), .b(x35), .c(new_n141_), .d(new_n95_), .O(new_n208_));
  aoi21  g146(.a(new_n198_), .b(new_n134_), .c(x08), .O(new_n209_));
