...
module FAU ( 
  ...
  nand2  g052(.a(new_n114_), .b(new_n81_), .O(new_n115_));
  ...
  nand2  g061(.a(x40), .b(new_n75_), .O(new_n124_));
  ...
  oai21  g065(.a(new_n127_), .b(new_n125_), .c(new_n88_), .O(new_n128_));
  ...
  nand2  g076(.a(new_n77_), .b(x29), .O(new_n139_));
  ...
  nand3  g082(.a(new_n140_), .b(x27), .c(new_n65_), .O(new_n145_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n65_), .c(new_n100_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(z13));
  inv1   g105(.a(new_n97_), .O(new_n168_));
  ...
  nand3  g118(.a(new_n153_), .b(new_n76_), .c(x14), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n174_), .O(z14));
  inv1   g120(.a(x12), .O(new_n183_));
  nand4  g121(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n183_), .O(z15));
  inv1   g123(.a(x23), .O(new_n186_));
  nand4  g124(.a(new_n82_), .b(new_n186_), .c(x22), .d(x01), .O(new_n187_));
  ...
  oai21  g130(.a(new_n87_), .b(x27), .c(new_n139_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  nor2   g132(.a(new_n100_), .b(x30), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n194_), .c(new_n145_), .d(new_n138_), .O(z18));
  nor2   g134(.a(x40), .b(x35), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n93_), .c(x14), .O(new_n198_));
  nand2  g136(.a(new_n141_), .b(new_n86_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n139_), .O(new_n200_));
  nand2  g138(.a(x35), .b(x27), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(x04), .c(new_n144_), .O(new_n202_));
  nand2  g140(.a(x39), .b(x29), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n66_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n202_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(x40), .O(new_n206_));
  nand2  g144(.a(x28), .b(new_n144_), .O(new_n207_));
  nand4  g145(.a(new_n207_), .b(new_n206_), .c(new_n200_), .d(new_n198_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n84_), .c(new_n138_), .O(new_n209_));
  nand2  g147(.a(new_n209_), .b(new_n82_), .O(z19));
  nand2  g148(.a(x28), .b(new_n64_), .O(new_n211_));
  nand2  g149(.a(new_n203_), .b(x40), .O(new_n212_));
  aoi22  g150(.a(new_n212_), .b(new_n97_), .c(new_n211_), .d(x35), .O(new_n213_));
  nand2  g151(.a(new_n82_), .b(new_n64_), .O(new_n214_));
  nand2  g152(.a(x40), .b(new_n66_), .O(new_n215_));
  aoi21  g153(.a(new_n215_), .b(new_n214_), .c(x08), .O(new_n216_));
  oai21  g154(.a(new_n216_), .b(new_n213_), .c(new_n84_), .O(new_n217_));
