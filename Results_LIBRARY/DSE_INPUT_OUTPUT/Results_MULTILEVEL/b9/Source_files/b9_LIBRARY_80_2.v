...
module FAU ( 
  ...
  oai22  g110(.a(new_n82_), .b(x27), .c(new_n115_), .d(new_n130_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nor2   g112(.a(new_n96_), .b(x04), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n89_), .c(x09), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n174_), .c(new_n64_), .d(new_n78_), .O(z18));
  aoi21  g115(.a(x28), .b(new_n96_), .c(new_n88_), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n131_), .O(new_n179_));
  nand2  g117(.a(x40), .b(new_n88_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n134_), .c(x08), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n179_), .c(new_n78_), .O(new_n182_));
