...
module FAU ( 
  ...
  nand3  g54(.a(new_n117_), .b(new_n70_), .c(new_n112_), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(z02), .O(z11));
  nor2   g56(.a(new_n77_), .b(new_n80_), .O(new_n120_));
  nand2  g57(.a(new_n120_), .b(new_n66_), .O(z12));
  nand4  g58(.a(z02), .b(new_n66_), .c(x27), .d(x20), .O(new_n122_));
  nor3   g59(.a(new_n122_), .b(x19), .c(x18), .O(z13));
  nor2   g60(.a(x19), .b(x18), .O(new_n124_));
  nand4  g61(.a(new_n124_), .b(new_n120_), .c(new_n66_), .d(x20), .O(z14));
  ...
  nand2  g70(.a(x27), .b(new_n106_), .O(new_n134_));
  oai21  g71(.a(x27), .b(new_n115_), .c(new_n134_), .O(new_n135_));
  nand3  g72(.a(new_n135_), .b(x35), .c(new_n113_), .O(new_n136_));
  nand4  g73(.a(new_n136_), .b(z02), .c(new_n70_), .d(new_n112_), .O(z18));
  nand4  g74(.a(new_n117_), .b(z02), .c(new_n70_), .d(new_n112_), .O(new_n138_));
  inv1   g75(.a(new_n138_), .O(z19));
  oai21  g76(.a(x28), .b(new_n115_), .c(new_n80_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g78(.a(new_n141_), .b(z02), .c(new_n70_), .d(new_n112_), .O(new_n142_));
