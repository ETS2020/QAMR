...
module FAU ( 
  ...
  nor2   g019(.a(new_n81_), .b(x30), .O(new_n82_));
  ...
  nand4  g028(.a(new_n90_), .b(new_n81_), .c(new_n86_), .d(new_n85_), .O(new_n91_));
  oai21  g029(.a(new_n82_), .b(x04), .c(new_n91_), .O(z01));
  ...
  aoi21  g038(.a(new_n70_), .b(new_n64_), .c(new_n82_), .O(new_n101_));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n70_), .c(new_n82_), .O(z05));
  ...
  nand3  g050(.a(x30), .b(new_n112_), .c(x00), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(x38), .O(new_n114_));
  nand4  g052(.a(new_n114_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n115_));
  inv1   g053(.a(x14), .O(new_n116_));
  oai21  g054(.a(x25), .b(x00), .c(x30), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(x38), .O(new_n118_));
  ...
  nand4  g081(.a(new_n143_), .b(new_n81_), .c(new_n85_), .d(new_n136_), .O(new_n144_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n148_), .c(new_n82_), .O(z12));
  ...
  oai21  g109(.a(new_n171_), .b(x38), .c(new_n85_), .O(new_n172_));
  nand2  g110(.a(new_n168_), .b(new_n149_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n93_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(x22), .c(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n93_), .O(z16));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(x23), .c(x22), .d(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n93_), .O(z17));
  oai21  g120(.a(new_n88_), .b(x27), .c(new_n137_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(x38), .b(x30), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n141_), .d(new_n136_), .O(z18));
  nand2  g124(.a(new_n143_), .b(new_n136_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n81_), .c(x30), .O(z19));
  inv1   g126(.a(new_n137_), .O(new_n189_));
  oai21  g127(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n190_));
  ...
  aoi21  g131(.a(new_n193_), .b(new_n81_), .c(x30), .O(z20));
endmodule
