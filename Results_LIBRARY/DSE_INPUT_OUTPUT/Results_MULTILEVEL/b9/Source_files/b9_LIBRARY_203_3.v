...
module FAU ( 
  ...
  nand2  g016(.a(x30), .b(x25), .O(new_n79_));
  ...
  nand4  g029(.a(new_n91_), .b(new_n89_), .c(new_n79_), .d(new_n75_), .O(z02));
  inv1   g030(.a(new_n79_), .O(new_n93_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n70_), .c(new_n93_), .O(z05));
  nand3  g039(.a(new_n100_), .b(new_n79_), .c(new_n70_), .O(new_n102_));
  ...
  nand3  g052(.a(new_n79_), .b(x40), .c(x39), .O(new_n115_));
  ...
  nand3  g059(.a(new_n79_), .b(new_n121_), .c(x07), .O(new_n122_));
  nand3  g060(.a(new_n75_), .b(new_n81_), .c(x05), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n120_), .O(new_n124_));
  nor2   g062(.a(new_n93_), .b(new_n70_), .O(new_n125_));
  aoi22  g063(.a(new_n125_), .b(x06), .c(new_n124_), .d(new_n65_), .O(new_n126_));
  nand2  g064(.a(x30), .b(new_n109_), .O(new_n127_));
  ...
  oai21  g069(.a(new_n126_), .b(new_n64_), .c(new_n131_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(new_n75_), .b(x29), .O(new_n134_));
  oai21  g072(.a(new_n64_), .b(new_n65_), .c(new_n83_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand3  g075(.a(new_n83_), .b(x27), .c(new_n65_), .O(new_n138_));
  ...
  oai22  g083(.a(new_n121_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n79_), .O(z12));
  ...
  nand4  g094(.a(new_n72_), .b(new_n109_), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n130_), .b(new_n148_), .c(new_n65_), .O(new_n160_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n75_), .c(new_n93_), .O(new_n164_));
  nand4  g102(.a(new_n150_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n165_));
  ...
  aoi22  g107(.a(new_n163_), .b(new_n75_), .c(new_n72_), .d(x27), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n81_), .O(new_n171_));
  nand2  g109(.a(new_n170_), .b(new_n109_), .O(new_n172_));
  ...
  nand2  g119(.a(new_n83_), .b(new_n64_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n134_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n138_), .c(new_n81_), .d(new_n133_), .O(z18));
