...
module FAU ( 
  ...
  aoi21  g18(.a(new_n81_), .b(new_n64_), .c(new_n70_), .O(new_n82_));
  ...
  nand2  g24(.a(new_n86_), .b(new_n81_), .O(new_n88_));
  nand2  g25(.a(new_n88_), .b(new_n68_), .O(z06));
  ...
  nand2  g40(.a(new_n104_), .b(new_n68_), .O(z09));
  ...
  nor2   g49(.a(x27), .b(x08), .O(new_n114_));
  inv1   g50(.a(new_n114_), .O(new_n115_));
  nand4  g51(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n79_), .O(new_n116_));
  nand4  g52(.a(new_n116_), .b(new_n68_), .c(new_n71_), .d(new_n112_), .O(new_n117_));
  inv1   g53(.a(new_n117_), .O(z11));
  inv1   g54(.a(new_n65_), .O(new_n119_));
  nor2   g55(.a(new_n70_), .b(new_n64_), .O(new_n120_));
  nand2  g56(.a(new_n120_), .b(new_n119_), .O(z12));
  inv1   g57(.a(x19), .O(new_n122_));
  nand3  g58(.a(new_n66_), .b(x20), .c(new_n122_), .O(new_n123_));
  oai21  g59(.a(new_n123_), .b(x18), .c(new_n68_), .O(z13));
  nor2   g60(.a(x19), .b(x18), .O(new_n125_));
  nand4  g61(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(x20), .O(z14));
  inv1   g62(.a(x12), .O(new_n127_));
  nand4  g63(.a(new_n68_), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  nor2   g64(.a(new_n128_), .b(new_n127_), .O(z15));
  inv1   g65(.a(x23), .O(new_n130_));
  nand4  g66(.a(new_n68_), .b(new_n130_), .c(x22), .d(x01), .O(new_n131_));
  inv1   g67(.a(new_n131_), .O(z16));
  inv1   g68(.a(x24), .O(new_n133_));
  nand4  g69(.a(new_n133_), .b(x23), .c(x22), .d(x01), .O(new_n134_));
  nand2  g70(.a(new_n134_), .b(new_n68_), .O(z17));
  inv1   g71(.a(x08), .O(new_n136_));
  nand2  g72(.a(x27), .b(new_n106_), .O(new_n137_));
  oai21  g73(.a(x27), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  nand3  g74(.a(new_n138_), .b(x35), .c(new_n79_), .O(new_n139_));
  nand4  g75(.a(new_n139_), .b(new_n68_), .c(new_n71_), .d(new_n112_), .O(z18));
  oai21  g76(.a(new_n114_), .b(new_n72_), .c(new_n68_), .O(new_n141_));
  nand3  g77(.a(new_n141_), .b(new_n113_), .c(new_n79_), .O(new_n142_));
  nand3  g78(.a(new_n142_), .b(new_n71_), .c(new_n112_), .O(new_n143_));
  nand2  g79(.a(new_n143_), .b(new_n68_), .O(z19));
  oai21  g80(.a(x28), .b(new_n136_), .c(new_n64_), .O(new_n145_));
  nand2  g81(.a(new_n145_), .b(x35), .O(new_n146_));
  nand4  g82(.a(new_n146_), .b(new_n68_), .c(new_n71_), .d(new_n112_), .O(new_n147_));
