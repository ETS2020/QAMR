...
module FAU ( 
  ...
  nand2  g054(.a(new_n116_), .b(new_n71_), .O(z09));
  inv1   g055(.a(x04), .O(new_n118_));
  inv1   g056(.a(x05), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  oai22  g058(.a(new_n114_), .b(new_n119_), .c(x39), .d(new_n120_), .O(new_n121_));
  ...
  nor2   g064(.a(new_n126_), .b(new_n67_), .O(new_n127_));
  ...
  nand3  g073(.a(x35), .b(new_n135_), .c(new_n118_), .O(new_n136_));
  ...
  nand3  g094(.a(new_n127_), .b(new_n145_), .c(new_n118_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  aoi21  g096(.a(new_n145_), .b(new_n118_), .c(new_n70_), .O(new_n159_));
  ...
  nand4  g103(.a(new_n165_), .b(x40), .c(new_n75_), .d(new_n74_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n161_), .O(z14));
  inv1   g105(.a(x12), .O(new_n168_));
  nand4  g106(.a(new_n71_), .b(x34), .c(x27), .d(x26), .O(new_n169_));
  ...
  aoi21  g120(.a(new_n180_), .b(new_n135_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n88_), .c(new_n114_), .d(new_n83_), .O(z18));
  nand2  g122(.a(x39), .b(x04), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(x35), .c(new_n135_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x40), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n134_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n133_), .c(new_n74_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z19));
  nor2   g128(.a(new_n76_), .b(new_n92_), .O(new_n191_));
  nor2   g129(.a(new_n67_), .b(new_n130_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n92_), .c(new_n76_), .O(new_n193_));
