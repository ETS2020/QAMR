...
module FAU ( 
  ...
  aoi21  g036(.a(new_n95_), .b(new_n66_), .c(x21), .O(new_n99_));
  ...
  nand3  g058(.a(new_n120_), .b(new_n84_), .c(new_n72_), .O(new_n121_));
  ...
  aoi21  g062(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(new_n125_));
  nand4  g063(.a(new_n125_), .b(x39), .c(x05), .d(new_n72_), .O(new_n126_));
  ...
  nand3  g076(.a(new_n95_), .b(new_n81_), .c(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x27), .c(x10), .O(new_n140_));
  nor2   g078(.a(new_n68_), .b(new_n72_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(x39), .O(new_n142_));
  oai21  g080(.a(new_n68_), .b(x40), .c(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x40), .c(new_n144_), .d(new_n72_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand2  g087(.a(new_n93_), .b(new_n95_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n147_), .c(new_n66_), .O(new_n152_));
  nand2  g090(.a(new_n80_), .b(new_n79_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n144_), .c(new_n72_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x39), .c(new_n74_), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n152_), .O(z13));
  nand3  g094(.a(x40), .b(new_n144_), .c(new_n72_), .O(new_n157_));
  nand4  g095(.a(x27), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n67_), .c(new_n157_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n160_));
  aoi22  g098(.a(new_n160_), .b(new_n145_), .c(new_n95_), .d(new_n138_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n82_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n80_), .c(new_n79_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n159_), .c(new_n64_), .O(z14));
  ...
  oai21  g111(.a(new_n83_), .b(x27), .c(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n66_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n89_), .c(x09), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g116(.a(x09), .O(new_n179_));
  nand2  g117(.a(new_n130_), .b(new_n82_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n173_), .O(new_n181_));
  inv1   g119(.a(x08), .O(new_n182_));
  aoi21  g120(.a(x40), .b(new_n63_), .c(x27), .O(new_n183_));
  nand2  g121(.a(x39), .b(new_n138_), .O(new_n184_));
  nand2  g122(.a(x40), .b(x04), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n184_), .c(new_n82_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n183_), .c(new_n182_), .O(new_n187_));
  inv1   g125(.a(new_n129_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n138_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n187_), .c(new_n181_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n79_), .c(new_n179_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n64_), .O(z19));
  aoi21  g130(.a(x28), .b(new_n66_), .c(new_n138_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n129_), .O(new_n194_));
  aoi21  g132(.a(new_n184_), .b(new_n132_), .c(x08), .O(new_n195_));
