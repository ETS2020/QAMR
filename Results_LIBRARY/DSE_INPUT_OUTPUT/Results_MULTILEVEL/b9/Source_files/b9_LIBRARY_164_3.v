...
module FAU ( 
  ...
  nand2  g20(.a(new_n66_), .b(new_n81_), .O(new_n84_));
  nand4  g21(.a(new_n84_), .b(new_n79_), .c(new_n63_), .d(new_n80_), .O(z04));
  inv1   g22(.a(x28), .O(new_n86_));
  oai21  g23(.a(new_n86_), .b(new_n81_), .c(new_n66_), .O(new_n87_));
  ...
  nand3  g54(.a(new_n68_), .b(new_n63_), .c(x27), .O(z12));
  ...
  aoi21  g60(.a(new_n123_), .b(new_n68_), .c(z08), .O(z14));
  inv1   g61(.a(x12), .O(new_n125_));
  nand4  g62(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n126_));
  ...
  nand4  g69(.a(new_n63_), .b(new_n132_), .c(x23), .d(x22), .O(new_n133_));
  nor2   g70(.a(new_n133_), .b(new_n131_), .O(z17));
  nand2  g71(.a(x27), .b(new_n105_), .O(new_n135_));
  oai21  g72(.a(x27), .b(new_n113_), .c(new_n135_), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n86_), .O(new_n137_));
  nand4  g74(.a(new_n137_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(z18));
  oai21  g75(.a(x28), .b(new_n113_), .c(new_n81_), .O(new_n139_));
