...
module FAU ( 
  ...
  nand2  g012(.a(x10), .b(x00), .O(new_n75_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n65_), .O(z03));
  aoi21  g038(.a(new_n68_), .b(new_n98_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n65_), .O(z04));
  ...
  oai21  g049(.a(x38), .b(x10), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g053(.a(x38), .b(new_n115_), .c(x10), .O(new_n116_));
  ...
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(new_n65_), .O(z10));
  ...
  oai21  g087(.a(new_n149_), .b(new_n98_), .c(new_n148_), .O(new_n150_));
  ...
  nand3  g104(.a(new_n94_), .b(new_n152_), .c(new_n122_), .O(new_n167_));
  ...
  aoi22  g109(.a(new_n171_), .b(new_n79_), .c(new_n167_), .d(new_n71_), .O(new_n172_));
  ...
  oai21  g121(.a(new_n83_), .b(x27), .c(new_n136_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n65_), .b(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n140_), .d(new_n79_), .O(z18));
  nand4  g125(.a(new_n142_), .b(new_n64_), .c(new_n79_), .d(new_n135_), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(z19));
  inv1   g127(.a(new_n136_), .O(new_n190_));
  oai21  g128(.a(new_n169_), .b(new_n98_), .c(new_n139_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n98_), .c(new_n169_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n135_), .O(new_n194_));
