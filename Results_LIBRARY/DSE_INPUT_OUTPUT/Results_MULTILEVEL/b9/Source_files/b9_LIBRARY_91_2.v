...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x33), .O(new_n64_));
  ...
  nor2   g030(.a(x40), .b(x33), .O(new_n93_));
  ...
  oai21  g039(.a(new_n82_), .b(new_n68_), .c(new_n69_), .O(new_n102_));
  ...
  nand2  g054(.a(new_n116_), .b(new_n106_), .O(new_n117_));
  nand3  g055(.a(new_n114_), .b(x40), .c(new_n112_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n117_), .c(new_n105_), .O(z07));
  ...
  nand3  g065(.a(new_n127_), .b(new_n84_), .c(x27), .O(new_n128_));
  ...
  nand2  g069(.a(new_n131_), .b(new_n73_), .O(new_n132_));
  ...
  nand3  g080(.a(new_n138_), .b(x27), .c(new_n73_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n79_), .c(new_n135_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n64_), .O(z11));
  nand3  g085(.a(new_n69_), .b(new_n81_), .c(new_n137_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi21  g087(.a(x39), .b(new_n73_), .c(new_n71_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n151_));
  nand2  g089(.a(new_n70_), .b(new_n69_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n63_), .c(new_n106_), .O(new_n154_));
  ...
  nand3  g102(.a(new_n129_), .b(x40), .c(x39), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x13), .O(new_n166_));
  ...
  nand3  g108(.a(x39), .b(new_n156_), .c(new_n73_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n63_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n93_), .c(new_n169_), .O(new_n174_));
  nand3  g112(.a(new_n69_), .b(new_n137_), .c(x28), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n80_), .c(new_n79_), .O(new_n177_));
  nand2  g115(.a(new_n171_), .b(new_n153_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n174_), .c(new_n154_), .O(z14));
  inv1   g119(.a(x12), .O(new_n182_));
  nor2   g120(.a(new_n123_), .b(new_n182_), .O(z15));
  inv1   g121(.a(x23), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(x22), .c(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n64_), .O(z16));
  inv1   g124(.a(x24), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(x23), .c(x22), .d(x01), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n64_), .O(z17));
  oai21  g127(.a(new_n83_), .b(x27), .c(new_n136_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n65_), .b(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n191_), .c(new_n143_), .d(new_n135_), .O(z18));
  nand2  g131(.a(new_n64_), .b(new_n68_), .O(new_n194_));
  nand3  g132(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(x40), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n194_), .c(x08), .O(new_n197_));
  nand2  g135(.a(x39), .b(x29), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(x40), .c(new_n93_), .O(new_n199_));
  aoi21  g137(.a(new_n139_), .b(new_n138_), .c(new_n199_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n197_), .c(new_n79_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z19));
  aoi21  g140(.a(x28), .b(new_n68_), .c(new_n137_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(new_n199_), .O(new_n204_));
  nand2  g142(.a(x40), .b(new_n137_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n194_), .c(x08), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n204_), .c(new_n79_), .O(new_n207_));
