...
module FAU ( 
  ...
  nor2   g017(.a(x40), .b(x21), .O(new_n80_));
  ...
  oai21  g036(.a(x40), .b(new_n91_), .c(new_n98_), .O(z02));
  nor2   g037(.a(x37), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n71_), .b(x27), .c(new_n100_), .O(new_n101_));
  nand2  g039(.a(x40), .b(new_n91_), .O(new_n102_));
  oai21  g040(.a(new_n101_), .b(new_n80_), .c(new_n102_), .O(z03));
  inv1   g041(.a(x40), .O(new_n104_));
  oai21  g042(.a(new_n101_), .b(new_n104_), .c(new_n91_), .O(z04));
  ...
  nand4  g077(.a(x35), .b(new_n85_), .c(x27), .d(new_n65_), .O(new_n140_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n104_), .c(x21), .O(new_n150_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n104_), .O(new_n159_));
  nand4  g097(.a(new_n72_), .b(x21), .c(x20), .d(new_n157_), .O(new_n160_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n149_), .c(new_n80_), .O(new_n173_));
  ...
  nor2   g122(.a(new_n80_), .b(x30), .O(new_n185_));
  ...
  nand3  g128(.a(new_n190_), .b(new_n83_), .c(new_n135_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n81_), .O(z20));
  nand2  g130(.a(new_n143_), .b(new_n81_), .O(z19));
endmodule
