...
module FAU ( 
  ...
  nor2   g039(.a(new_n101_), .b(new_n66_), .O(new_n102_));
  ...
  oai22  g060(.a(new_n117_), .b(new_n121_), .c(x40), .d(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n84_), .c(new_n73_), .O(new_n124_));
  ...
  nand4  g076(.a(new_n138_), .b(x35), .c(new_n101_), .d(x27), .O(new_n139_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n101_), .c(x27), .O(new_n170_));
  ...
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n82_), .O(new_n184_));
  nand2  g122(.a(new_n80_), .b(new_n132_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n101_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n94_), .c(new_n117_), .d(new_n89_), .O(z18));
  inv1   g125(.a(x29), .O(new_n188_));
  aoi21  g126(.a(x39), .b(new_n188_), .c(new_n75_), .O(new_n189_));
  aoi21  g127(.a(new_n134_), .b(new_n90_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n64_), .b(new_n66_), .O(new_n191_));
  nand3  g129(.a(x35), .b(new_n101_), .c(new_n73_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x39), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n191_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n190_), .c(new_n80_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z19));
  aoi21  g134(.a(x28), .b(new_n66_), .c(new_n82_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n189_), .O(new_n198_));
  nand2  g136(.a(x39), .b(new_n82_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n191_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n80_), .O(new_n201_));
