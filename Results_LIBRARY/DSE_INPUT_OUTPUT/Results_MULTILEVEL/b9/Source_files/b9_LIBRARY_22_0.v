...
module FAU ( 
  ...
  nand2  g053(.a(new_n115_), .b(new_n88_), .O(z07));
  ...
  nand2  g058(.a(new_n120_), .b(new_n88_), .O(z09));
  ...
  nand3  g068(.a(x35), .b(new_n82_), .c(new_n64_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n129_), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(x30), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n128_), .c(x04), .O(new_n134_));
  ...
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n88_), .O(z12));
  ...
  oai21  g084(.a(new_n142_), .b(x04), .c(new_n146_), .O(z13));
  nand2  g085(.a(new_n141_), .b(new_n65_), .O(new_n148_));
  nand4  g086(.a(x27), .b(x20), .c(new_n144_), .d(new_n143_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n70_), .c(new_n148_), .d(new_n72_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n88_), .O(z14));
  inv1   g089(.a(x12), .O(new_n152_));
  nand4  g090(.a(new_n88_), .b(x34), .c(x27), .d(x26), .O(new_n153_));
  ...
  nand4  g097(.a(new_n88_), .b(new_n159_), .c(x23), .d(x22), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(new_n158_), .O(z17));
  oai21  g099(.a(new_n132_), .b(x09), .c(x04), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n81_), .O(z18));
  inv1   g101(.a(new_n130_), .O(new_n164_));
  oai21  g102(.a(new_n66_), .b(new_n64_), .c(new_n129_), .O(new_n165_));
  aoi21  g103(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(new_n165_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n128_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x04), .c(x30), .O(z20));
