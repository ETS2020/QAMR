...
module FAU ( 
  ...
  aoi21  g038(.a(new_n100_), .b(new_n66_), .c(new_n99_), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n96_), .O(z03));
  aoi21  g040(.a(new_n100_), .b(new_n66_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n98_), .c(new_n96_), .O(z04));
  nand2  g042(.a(x28), .b(x27), .O(new_n105_));
  aoi21  g043(.a(new_n105_), .b(new_n100_), .c(new_n96_), .O(z05));
  nand3  g044(.a(new_n105_), .b(new_n64_), .c(new_n100_), .O(new_n107_));
  ...
  oai22  g061(.a(new_n93_), .b(new_n122_), .c(x40), .d(new_n123_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n100_), .b(new_n81_), .c(new_n144_), .O(new_n145_));
  ...
  oai21  g086(.a(new_n68_), .b(x40), .c(new_n148_), .O(z12));
  ...
  nand2  g093(.a(new_n97_), .b(new_n100_), .O(new_n156_));
  ...
  nand3  g101(.a(x40), .b(new_n150_), .c(new_n72_), .O(new_n164_));
  ...
  aoi22  g105(.a(new_n167_), .b(new_n151_), .c(new_n100_), .d(new_n144_), .O(new_n168_));
  ...
  nand2  g122(.a(new_n79_), .b(new_n133_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n82_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n96_), .c(new_n93_), .d(new_n89_), .O(z18));
  oai21  g125(.a(new_n135_), .b(x28), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(x40), .b(new_n63_), .c(x27), .O(new_n189_));
  nand2  g127(.a(x39), .b(new_n144_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n138_), .c(new_n82_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n137_), .O(new_n192_));
  oai21  g130(.a(new_n63_), .b(x29), .c(x40), .O(new_n193_));
  ...
  oai21  g135(.a(new_n82_), .b(x27), .c(x35), .O(new_n198_));
