...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n93_, new_n96_, new_n97_, new_n98_, new_n99_, new_n101_, new_n103_,
  ...
  oai21  g040(.a(new_n82_), .b(new_n98_), .c(new_n65_), .O(new_n103_));
  ...
  aoi21  g071(.a(x40), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n131_), .c(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n64_), .b(new_n98_), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n137_), .c(x08), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(new_n79_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n133_), .b(x04), .c(new_n68_), .O(new_n145_));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(new_n98_), .O(new_n154_));
  nand3  g092(.a(new_n124_), .b(new_n147_), .c(new_n71_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n133_), .O(new_n156_));
  ...
  oai21  g098(.a(new_n158_), .b(new_n133_), .c(new_n160_), .O(new_n161_));
  ...
  nand2  g115(.a(new_n98_), .b(x08), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(new_n130_), .O(new_n179_));
  ...
  nand2  g121(.a(new_n135_), .b(new_n131_), .O(new_n184_));
  nor2   g122(.a(new_n133_), .b(new_n132_), .O(new_n185_));
  inv1   g123(.a(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n184_), .O(new_n187_));
  inv1   g125(.a(x08), .O(new_n188_));
  oai21  g126(.a(new_n177_), .b(new_n83_), .c(new_n188_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n79_), .c(new_n180_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n64_), .O(z19));
  oai21  g130(.a(new_n130_), .b(new_n98_), .c(new_n188_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n98_), .c(new_n130_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n185_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n79_), .c(new_n180_), .O(new_n196_));
