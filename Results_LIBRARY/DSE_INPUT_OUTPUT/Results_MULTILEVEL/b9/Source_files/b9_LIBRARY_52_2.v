...
module FAU ( 
  ...
  oai21  g004(.a(new_n66_), .b(new_n65_), .c(x17), .O(new_n67_));
  ...
  inv1   g026(.a(new_n79_), .O(new_n89_));
  ...
  oai21  g031(.a(new_n93_), .b(new_n83_), .c(x04), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n89_), .d(new_n88_), .O(z02));
  nand2  g033(.a(new_n74_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x27), .O(new_n97_));
  nand2  g035(.a(new_n69_), .b(new_n97_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n89_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n69_), .b(new_n97_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n79_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n89_), .c(new_n69_), .O(z05));
  inv1   g041(.a(z05), .O(z06));
  inv1   g042(.a(x03), .O(new_n105_));
  inv1   g043(.a(x31), .O(new_n106_));
  inv1   g044(.a(x33), .O(new_n107_));
  nand2  g045(.a(x17), .b(x15), .O(new_n108_));
  oai21  g046(.a(x17), .b(x10), .c(new_n108_), .O(new_n109_));
  inv1   g047(.a(x00), .O(new_n110_));
  oai21  g048(.a(x25), .b(new_n110_), .c(x38), .O(new_n111_));
  nand4  g049(.a(new_n111_), .b(new_n109_), .c(new_n107_), .d(new_n106_), .O(new_n112_));
  inv1   g050(.a(x14), .O(new_n113_));
  inv1   g051(.a(x25), .O(new_n114_));
  nand3  g052(.a(x38), .b(new_n114_), .c(new_n110_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(new_n89_), .c(new_n113_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n112_), .c(new_n105_), .O(z07));
  inv1   g055(.a(x39), .O(new_n118_));
  inv1   g056(.a(x40), .O(new_n119_));
  nor3   g057(.a(new_n79_), .b(new_n119_), .c(new_n118_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n89_), .O(z09));
  nand2  g060(.a(new_n66_), .b(x07), .O(new_n123_));
  ...
  nor2   g068(.a(new_n69_), .b(new_n97_), .O(new_n131_));
  ...
  nor2   g073(.a(new_n97_), .b(new_n63_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n83_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n82_), .c(x27), .d(new_n63_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n80_), .c(new_n134_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n89_), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n97_), .c(new_n78_), .O(new_n145_));
  nand2  g083(.a(new_n74_), .b(new_n69_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  oai21  g085(.a(new_n66_), .b(x04), .c(new_n147_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n145_), .c(new_n89_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n119_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n63_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n146_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n63_), .c(new_n79_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n88_), .b(new_n150_), .c(new_n63_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n69_), .b(new_n70_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n81_), .c(new_n80_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n147_), .c(new_n79_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nand4  g111(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n174_));
  nor2   g112(.a(new_n174_), .b(new_n173_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand4  g114(.a(new_n89_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z16));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n89_), .O(z17));
  oai21  g119(.a(new_n83_), .b(x27), .c(new_n135_), .O(new_n182_));
  nand3  g120(.a(new_n139_), .b(new_n80_), .c(new_n134_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(x08), .c(new_n183_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n79_), .O(z18));
  inv1   g123(.a(new_n135_), .O(new_n186_));
  oai21  g124(.a(new_n70_), .b(new_n97_), .c(new_n138_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n97_), .c(new_n70_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n80_), .c(new_n134_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n89_), .O(z20));
  nand2  g129(.a(new_n142_), .b(new_n89_), .O(z19));
endmodule
