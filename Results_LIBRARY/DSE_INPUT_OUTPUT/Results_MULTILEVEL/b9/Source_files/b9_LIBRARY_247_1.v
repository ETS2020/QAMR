...
module FAU ( 
  ...
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n79_), .O(z03));
  ...
  nand3  g072(.a(x35), .b(new_n83_), .c(new_n72_), .O(new_n135_));
  ...
  nand3  g078(.a(new_n97_), .b(new_n82_), .c(new_n140_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n68_), .b(x40), .c(new_n144_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x40), .c(new_n146_), .d(new_n72_), .O(new_n149_));
  ...
  nand2  g092(.a(new_n81_), .b(new_n80_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n146_), .c(new_n72_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x39), .c(new_n74_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n154_), .O(z13));
  nand3  g096(.a(x40), .b(new_n146_), .c(new_n72_), .O(new_n159_));
  ...
  aoi22  g100(.a(new_n162_), .b(new_n147_), .c(new_n97_), .d(new_n140_), .O(new_n163_));
  ...
  nand3  g131(.a(new_n193_), .b(new_n80_), .c(new_n182_), .O(new_n194_));
