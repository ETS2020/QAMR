...
module FAU ( 
  ...
  nor2   g019(.a(x38), .b(new_n81_), .O(new_n82_));
  ...
  nand3  g027(.a(new_n89_), .b(new_n85_), .c(new_n81_), .O(new_n90_));
  oai21  g028(.a(new_n82_), .b(x04), .c(new_n90_), .O(z01));
  ...
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(new_n82_), .O(new_n100_));
  ...
  nand2  g051(.a(new_n113_), .b(new_n81_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand4  g053(.a(new_n115_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n116_));
  ...
  aoi21  g058(.a(new_n120_), .b(new_n116_), .c(new_n107_), .O(z07));
  inv1   g059(.a(x39), .O(new_n122_));
  inv1   g060(.a(x40), .O(new_n123_));
  nor3   g061(.a(new_n82_), .b(new_n123_), .c(new_n122_), .O(z08));
  nand4  g062(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n92_), .O(z09));
  nand2  g064(.a(x05), .b(new_n65_), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n75_), .c(x38), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x30), .O(new_n129_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n88_), .c(x27), .O(new_n133_));
  nand3  g071(.a(new_n76_), .b(x32), .c(x05), .O(new_n134_));
  ...
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(new_n129_), .O(z10));
  inv1   g076(.a(x09), .O(new_n139_));
  nand3  g077(.a(x40), .b(x39), .c(x29), .O(new_n140_));
  nor2   g078(.a(new_n64_), .b(new_n65_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n87_), .c(new_n140_), .O(new_n142_));
  inv1   g080(.a(x08), .O(new_n143_));
  nand4  g081(.a(x35), .b(new_n86_), .c(x27), .d(new_n65_), .O(new_n144_));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n151_), .c(new_n82_), .O(z12));
  inv1   g092(.a(x13), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n123_), .O(new_n157_));
  ...
  oai21  g101(.a(x32), .b(x30), .c(x40), .O(new_n164_));
  nor3   g102(.a(new_n164_), .b(new_n122_), .c(x13), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n65_), .c(new_n82_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z13));
  nand3  g105(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n168_));
  nand4  g106(.a(new_n156_), .b(new_n85_), .c(new_n81_), .d(x28), .O(new_n169_));
  ...
  nand3  g112(.a(new_n174_), .b(new_n85_), .c(new_n81_), .O(new_n175_));
  aoi21  g113(.a(new_n171_), .b(new_n152_), .c(new_n82_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n172_), .O(z14));
  nand4  g115(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n92_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x22), .c(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n92_), .O(z16));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(x23), .c(x22), .d(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n92_), .O(z17));
  oai21  g123(.a(new_n87_), .b(x27), .c(new_n140_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n144_), .c(new_n81_), .d(new_n139_), .O(z18));
  nand2  g126(.a(new_n147_), .b(new_n92_), .O(z19));
  inv1   g127(.a(new_n140_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n143_), .O(new_n191_));
