...
module FAU ( 
  ...
  oai21  g023(.a(new_n68_), .b(x28), .c(new_n69_), .O(new_n86_));
  ...
  nor2   g030(.a(new_n68_), .b(x28), .O(new_n93_));
  oai21  g031(.a(x27), .b(x08), .c(new_n93_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(x04), .c(new_n77_), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n64_), .O(z02));
  ...
  nand3  g039(.a(new_n101_), .b(new_n97_), .c(new_n83_), .O(z04));
  ...
  nand4  g058(.a(new_n83_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  ...
  nand3  g077(.a(new_n93_), .b(x27), .c(new_n67_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(new_n84_), .c(new_n63_), .d(new_n134_), .O(new_n143_));
  ...
  nand3  g097(.a(new_n128_), .b(new_n151_), .c(new_n67_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n64_), .O(z13));
  ...
  nand3  g102(.a(new_n78_), .b(new_n151_), .c(new_n67_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n72_), .b(new_n68_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n85_), .c(new_n84_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n148_), .c(new_n64_), .O(new_n170_));
  ...
  nand2  g113(.a(new_n175_), .b(new_n83_), .O(z16));
  inv1   g114(.a(x01), .O(new_n177_));
  inv1   g115(.a(x24), .O(new_n178_));
  nand4  g116(.a(new_n83_), .b(new_n178_), .c(x23), .d(x22), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(new_n177_), .O(z17));
  nand2  g118(.a(new_n93_), .b(new_n66_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n135_), .c(new_n139_), .O(new_n182_));
  nand2  g120(.a(new_n140_), .b(new_n84_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n182_), .c(new_n63_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n134_), .O(z18));
  inv1   g123(.a(new_n135_), .O(new_n186_));
  oai21  g124(.a(new_n68_), .b(new_n66_), .c(new_n139_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n84_), .c(new_n63_), .d(new_n134_), .O(new_n190_));
