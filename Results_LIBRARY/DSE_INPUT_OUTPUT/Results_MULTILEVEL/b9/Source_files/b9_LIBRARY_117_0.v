...
module FAU ( 
  ...
  nand3  g035(.a(new_n97_), .b(new_n95_), .c(new_n93_), .O(z02));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n69_), .c(new_n66_), .O(z05));
  nand3  g044(.a(new_n105_), .b(new_n65_), .c(new_n69_), .O(new_n107_));
  inv1   g045(.a(new_n107_), .O(z06));
  inv1   g046(.a(x33), .O(new_n109_));
  nand2  g047(.a(x17), .b(new_n67_), .O(new_n110_));
  oai21  g048(.a(x25), .b(new_n63_), .c(x38), .O(new_n111_));
  nand3  g049(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  inv1   g050(.a(x25), .O(new_n113_));
  nand3  g051(.a(x38), .b(new_n113_), .c(new_n63_), .O(new_n114_));
  ...
  oai21  g056(.a(new_n64_), .b(new_n96_), .c(new_n65_), .O(z08));
  ...
  nand2  g061(.a(x40), .b(new_n96_), .O(new_n124_));
  nand2  g062(.a(new_n64_), .b(x00), .O(new_n125_));
  ...
  oai21  g079(.a(new_n96_), .b(new_n92_), .c(x40), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n125_), .c(new_n141_), .d(new_n140_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n139_), .c(new_n81_), .O(new_n144_));
  nor2   g082(.a(new_n144_), .b(x09), .O(z11));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n69_), .b(new_n83_), .c(new_n146_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x27), .c(x10), .O(new_n148_));
  aoi21  g086(.a(x39), .b(new_n75_), .c(new_n73_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(x40), .O(new_n150_));
  nand3  g088(.a(new_n72_), .b(new_n64_), .c(x00), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z12));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n71_), .b(new_n65_), .c(x20), .d(new_n153_), .O(new_n154_));
  ...
  nand3  g098(.a(new_n134_), .b(new_n155_), .c(new_n75_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand2  g100(.a(x20), .b(new_n153_), .O(new_n163_));
  nand4  g101(.a(new_n156_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(new_n97_), .b(new_n155_), .c(new_n75_), .O(new_n166_));
  oai22  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .d(x18), .O(new_n167_));
  nand3  g105(.a(new_n69_), .b(new_n146_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n82_), .c(new_n81_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n72_), .c(new_n66_), .O(new_n171_));
