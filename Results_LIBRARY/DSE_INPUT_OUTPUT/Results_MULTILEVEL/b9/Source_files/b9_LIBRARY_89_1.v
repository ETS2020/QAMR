...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n63_), .c(x40), .O(z02));
  ...
  nand3  g061(.a(new_n123_), .b(x40), .c(x05), .O(new_n124_));
  ...
  nand2  g070(.a(new_n64_), .b(new_n95_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n100_), .c(new_n71_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x39), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n133_), .c(x08), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n132_), .c(new_n79_), .O(new_n137_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(new_n95_), .O(new_n150_));
  nand3  g088(.a(new_n123_), .b(new_n143_), .c(new_n71_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x39), .c(new_n74_), .O(new_n152_));
  ...
  oai21  g094(.a(new_n154_), .b(new_n74_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g098(.a(new_n160_), .b(new_n100_), .c(x27), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n80_), .d(new_n79_), .O(new_n162_));
  ...
  nand2  g112(.a(new_n95_), .b(x08), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n174_), .c(new_n81_), .O(new_n176_));
  inv1   g114(.a(x09), .O(new_n177_));
  nand2  g115(.a(new_n79_), .b(new_n177_), .O(new_n178_));
  aoi21  g116(.a(new_n176_), .b(new_n100_), .c(new_n178_), .O(new_n179_));
  nand3  g117(.a(z08), .b(x29), .c(x08), .O(new_n180_));
  oai21  g118(.a(new_n179_), .b(new_n92_), .c(new_n180_), .O(z18));
  nand2  g119(.a(x40), .b(x04), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x35), .c(new_n100_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x39), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n133_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n132_), .c(new_n79_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z19));
  nor2   g125(.a(new_n81_), .b(new_n95_), .O(new_n188_));
  nor2   g126(.a(new_n74_), .b(new_n129_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n95_), .c(new_n81_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(x08), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n79_), .c(new_n177_), .O(new_n192_));
