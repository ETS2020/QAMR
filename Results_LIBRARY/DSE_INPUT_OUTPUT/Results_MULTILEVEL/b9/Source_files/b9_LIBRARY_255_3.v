// Benchmark "FAU" written by ABC on Thu Aug 13 18:18:36 2020
...
module FAU ( 
  ...
  nand3  g027(.a(new_n89_), .b(new_n85_), .c(new_n64_), .O(new_n90_));
  nand3  g028(.a(new_n90_), .b(new_n84_), .c(x04), .O(z01));
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n79_), .d(new_n84_), .O(z02));
  nand2  g035(.a(new_n74_), .b(x27), .O(new_n98_));
  aoi21  g036(.a(new_n73_), .b(new_n67_), .c(new_n65_), .O(new_n99_));
  ...
  oai21  g040(.a(new_n86_), .b(new_n67_), .c(new_n73_), .O(new_n103_));
  ...
  nand3  g054(.a(new_n84_), .b(x40), .c(x39), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n84_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n119_), .O(z09));
  nand2  g059(.a(new_n78_), .b(x07), .O(new_n122_));
  ...
  nand3  g063(.a(new_n79_), .b(x32), .c(x05), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(new_n65_), .O(new_n127_));
  nand2  g065(.a(new_n63_), .b(x05), .O(new_n128_));
  nor3   g066(.a(new_n128_), .b(new_n78_), .c(new_n64_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n127_), .c(new_n68_), .O(new_n130_));
  nand4  g068(.a(x37), .b(new_n64_), .c(x27), .d(x06), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(new_n79_), .b(x29), .O(new_n134_));
  nor2   g072(.a(new_n67_), .b(new_n68_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n87_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  inv1   g075(.a(new_n87_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(x27), .c(new_n68_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n64_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n84_), .O(z11));
  inv1   g081(.a(x10), .O(new_n144_));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n67_), .c(new_n144_), .O(new_n146_));
  nand2  g084(.a(new_n75_), .b(x27), .O(new_n147_));
  oai21  g085(.a(new_n78_), .b(x04), .c(new_n147_), .O(new_n148_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n150_), .d(new_n68_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n75_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n154_), .c(x30), .O(new_n158_));
  nor2   g096(.a(new_n157_), .b(x06), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand2  g098(.a(x30), .b(new_n63_), .O(new_n161_));
  nand2  g099(.a(x32), .b(new_n64_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n151_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n150_), .d(new_n68_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  nand3  g103(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n166_));
  nand4  g104(.a(new_n152_), .b(new_n85_), .c(new_n64_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n79_), .b(new_n150_), .c(new_n68_), .O(new_n169_));
  ...
  nand3  g110(.a(new_n172_), .b(new_n85_), .c(new_n64_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n147_), .c(new_n65_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n170_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nor2   g114(.a(new_n120_), .b(new_n176_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand4  g116(.a(new_n84_), .b(new_n178_), .c(x22), .d(x01), .O(new_n179_));
  inv1   g117(.a(new_n179_), .O(z16));
  inv1   g118(.a(x01), .O(new_n181_));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n84_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n181_), .O(z17));
  nand2  g122(.a(new_n138_), .b(new_n67_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n134_), .c(new_n137_), .O(new_n186_));
  nand2  g124(.a(new_n139_), .b(new_n133_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n64_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n161_), .O(z18));
  inv1   g127(.a(new_n134_), .O(new_n190_));
  oai21  g128(.a(new_n69_), .b(new_n67_), .c(new_n137_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n64_), .c(new_n133_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n84_), .O(z20));
  nand2  g133(.a(new_n142_), .b(new_n84_), .O(z19));
endmodule
