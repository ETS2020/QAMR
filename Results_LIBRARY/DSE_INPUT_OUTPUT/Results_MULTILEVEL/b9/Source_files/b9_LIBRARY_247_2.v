...
module FAU ( 
  ...
  nand2  g036(.a(new_n96_), .b(new_n66_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n94_), .c(new_n64_), .d(new_n95_), .O(z04));
  nor2   g038(.a(new_n82_), .b(new_n66_), .O(new_n101_));
  inv1   g039(.a(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n64_), .c(new_n96_), .O(z05));
  ...
  nand4  g064(.a(new_n126_), .b(x39), .c(x05), .d(new_n72_), .O(new_n127_));
  ...
  nand2  g071(.a(new_n64_), .b(new_n66_), .O(new_n134_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n133_), .c(new_n79_), .O(new_n138_));
  nor2   g076(.a(new_n138_), .b(x09), .O(z11));
  inv1   g077(.a(x35), .O(new_n140_));
  nand3  g078(.a(new_n96_), .b(new_n81_), .c(new_n140_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  nor2   g080(.a(new_n68_), .b(new_n72_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(x40), .O(new_n144_));
  oai21  g082(.a(new_n68_), .b(x39), .c(new_n144_), .O(z12));
  ...
  nand2  g089(.a(new_n93_), .b(new_n96_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n149_), .c(new_n66_), .O(new_n154_));
  nand2  g092(.a(new_n80_), .b(new_n79_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n146_), .c(new_n72_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x40), .c(new_n130_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n154_), .O(z13));
  nand3  g096(.a(x39), .b(new_n146_), .c(new_n72_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n67_), .c(new_n159_), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n162_));
  aoi22  g100(.a(new_n162_), .b(new_n147_), .c(new_n96_), .d(new_n140_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n82_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n80_), .c(new_n79_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n161_), .c(new_n64_), .O(z14));
  ...
  nand2  g108(.a(new_n170_), .b(new_n64_), .O(z16));
  ...
  oai21  g114(.a(new_n83_), .b(x27), .c(new_n176_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n66_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n89_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n178_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g119(.a(x09), .O(new_n182_));
  nand2  g120(.a(new_n132_), .b(new_n82_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n176_), .O(new_n184_));
  inv1   g122(.a(x08), .O(new_n185_));
  aoi21  g123(.a(new_n63_), .b(x39), .c(x27), .O(new_n186_));
  nand2  g124(.a(x40), .b(new_n140_), .O(new_n187_));
  nand2  g125(.a(x39), .b(x04), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n187_), .c(new_n82_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n186_), .c(new_n185_), .O(new_n190_));
  inv1   g128(.a(new_n131_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n140_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n190_), .c(new_n184_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n182_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n64_), .O(z19));
  aoi21  g133(.a(x28), .b(new_n66_), .c(new_n140_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(new_n131_), .O(new_n197_));
  aoi21  g135(.a(new_n187_), .b(new_n134_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n197_), .c(new_n79_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z20));
  buf    g138(.a(x39), .O(z08));
endmodule
