...
module FAU ( 
  ...
  nand4  g023(.a(new_n85_), .b(x40), .c(new_n63_), .d(new_n80_), .O(new_n86_));
  oai21  g024(.a(new_n66_), .b(x04), .c(new_n86_), .O(z01));
  ...
  nand2  g032(.a(new_n64_), .b(x32), .O(new_n95_));
  ...
  nand2  g063(.a(new_n63_), .b(new_n80_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n80_), .c(new_n132_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n65_), .O(z11));
  nand3  g082(.a(new_n70_), .b(new_n81_), .c(new_n134_), .O(new_n145_));
  ...
  inv1   g086(.a(new_n72_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n64_), .c(x32), .O(new_n150_));
  ...
  nand2  g095(.a(new_n71_), .b(new_n70_), .O(new_n158_));
  ...
  nand4  g104(.a(new_n153_), .b(new_n63_), .c(new_n80_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand4  g106(.a(x40), .b(x39), .c(new_n152_), .d(new_n74_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n70_), .b(new_n134_), .c(x28), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(x27), .c(x30), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n64_), .c(new_n63_), .O(new_n173_));
  nand2  g111(.a(new_n169_), .b(new_n149_), .O(new_n174_));
  ...
  nand2  g122(.a(new_n69_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n140_), .c(new_n134_), .O(new_n186_));
  nand2  g124(.a(new_n80_), .b(new_n132_), .O(new_n187_));
  aoi21  g125(.a(new_n186_), .b(new_n82_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n66_), .c(new_n117_), .d(new_n89_), .O(z18));
  nand2  g127(.a(new_n65_), .b(new_n69_), .O(new_n190_));
  nand3  g128(.a(x35), .b(new_n82_), .c(new_n74_), .O(new_n191_));
  ...
  aoi22  g133(.a(new_n195_), .b(new_n95_), .c(new_n136_), .d(new_n135_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n80_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(x09), .O(z19));
  inv1   g136(.a(new_n133_), .O(new_n199_));
  oai21  g137(.a(new_n134_), .b(new_n69_), .c(new_n139_), .O(new_n200_));
  aoi21  g138(.a(x28), .b(new_n69_), .c(new_n134_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n200_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n80_), .c(new_n132_), .O(new_n203_));
