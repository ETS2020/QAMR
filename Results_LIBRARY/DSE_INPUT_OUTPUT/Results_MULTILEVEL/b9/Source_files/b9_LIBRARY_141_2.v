...
module FAU ( 
  ...
  oai21  g004(.a(new_n66_), .b(new_n65_), .c(x29), .O(new_n67_));
  ...
  oai21  g020(.a(new_n70_), .b(x28), .c(new_n71_), .O(new_n83_));
  ...
  nand2  g026(.a(new_n78_), .b(new_n88_), .O(new_n89_));
  oai21  g027(.a(new_n78_), .b(x08), .c(new_n89_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(new_n87_), .O(new_n91_));
  nor2   g029(.a(new_n70_), .b(x28), .O(new_n92_));
  oai21  g030(.a(x27), .b(x08), .c(new_n92_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(x04), .c(new_n66_), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n80_), .c(new_n91_), .O(z02));
  ...
  nand2  g069(.a(new_n79_), .b(new_n98_), .O(new_n132_));
  inv1   g070(.a(x28), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n133_), .c(new_n63_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x29), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n132_), .c(x08), .O(new_n136_));
  nand2  g074(.a(new_n66_), .b(x29), .O(new_n137_));
  nand2  g075(.a(x27), .b(x04), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(new_n92_), .c(new_n137_), .d(new_n89_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n136_), .c(new_n81_), .O(new_n140_));
  nor2   g078(.a(new_n140_), .b(x09), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n98_), .c(new_n88_), .O(new_n143_));
  nand2  g081(.a(new_n74_), .b(new_n69_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  oai21  g083(.a(new_n66_), .b(x04), .c(new_n145_), .O(new_n146_));
  ...
  nand4  g091(.a(new_n144_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n63_), .c(new_n80_), .O(new_n159_));
  ...
  inv1   g101(.a(new_n66_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n148_), .c(new_n63_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(new_n161_), .O(new_n166_));
  nand3  g104(.a(new_n69_), .b(new_n70_), .c(x28), .O(new_n167_));
  ...
  nand2  g113(.a(new_n175_), .b(new_n79_), .O(z16));
  inv1   g114(.a(x24), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(x23), .c(x22), .d(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n79_), .O(z17));
  nand2  g117(.a(x27), .b(new_n63_), .O(new_n180_));
  nand2  g118(.a(new_n98_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n70_), .O(new_n182_));
  inv1   g120(.a(x09), .O(new_n183_));
  nand2  g121(.a(new_n81_), .b(new_n183_), .O(new_n184_));
  aoi21  g122(.a(new_n182_), .b(new_n133_), .c(new_n184_), .O(new_n185_));
  nand3  g123(.a(new_n164_), .b(x29), .c(x08), .O(new_n186_));
  oai21  g124(.a(new_n185_), .b(new_n80_), .c(new_n186_), .O(z18));
  nor2   g125(.a(new_n70_), .b(new_n98_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n98_), .c(new_n70_), .O(new_n189_));
  ...
  nand3  g130(.a(new_n192_), .b(new_n81_), .c(new_n183_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n79_), .O(z20));
  nor2   g132(.a(new_n140_), .b(x09), .O(z19));
endmodule
