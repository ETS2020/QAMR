...
module FAU ( 
  ...
  aoi21  g015(.a(new_n77_), .b(new_n73_), .c(new_n68_), .O(new_n78_));
  nand2  g016(.a(x40), .b(x39), .O(new_n79_));
  inv1   g017(.a(new_n79_), .O(new_n80_));
  nand3  g018(.a(new_n80_), .b(x10), .c(new_n69_), .O(new_n81_));
  inv1   g019(.a(new_n81_), .O(new_n82_));
  oai21  g020(.a(new_n82_), .b(new_n78_), .c(new_n67_), .O(new_n83_));
  aoi21  g021(.a(new_n83_), .b(x16), .c(new_n66_), .O(z00));
  inv1   g022(.a(x28), .O(new_n85_));
  aoi21  g023(.a(x35), .b(new_n85_), .c(x36), .O(new_n86_));
  nor2   g024(.a(new_n86_), .b(new_n68_), .O(new_n87_));
  oai21  g025(.a(new_n87_), .b(x32), .c(x06), .O(new_n88_));
  ...
  nand2  g031(.a(x35), .b(new_n85_), .O(new_n94_));
  nor2   g032(.a(x27), .b(x08), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n94_), .c(x04), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n93_), .c(new_n80_), .d(new_n65_), .O(z02));
  nand2  g035(.a(new_n75_), .b(x27), .O(new_n98_));
  aoi21  g036(.a(new_n74_), .b(new_n68_), .c(new_n66_), .O(new_n99_));
  ...
  nor3   g056(.a(new_n66_), .b(new_n118_), .c(new_n117_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  nand3  g060(.a(new_n79_), .b(new_n65_), .c(x07), .O(new_n123_));
  nand3  g061(.a(new_n80_), .b(x06), .c(x05), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n123_), .c(new_n86_), .O(new_n125_));
  inv1   g063(.a(x32), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n63_), .c(new_n64_), .O(new_n127_));
  ...
  nand2  g071(.a(new_n80_), .b(x29), .O(new_n134_));
  nor2   g072(.a(new_n68_), .b(new_n69_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n94_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nor2   g075(.a(new_n70_), .b(x28), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(x27), .c(new_n69_), .O(new_n139_));
  ...
  aoi21  g080(.a(new_n142_), .b(x06), .c(x30), .O(z11));
  inv1   g081(.a(x10), .O(new_n144_));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n68_), .c(new_n144_), .O(new_n146_));
  oai22  g084(.a(new_n79_), .b(x04), .c(new_n77_), .d(new_n68_), .O(new_n147_));
  ...
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n149_), .d(new_n69_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand4  g092(.a(new_n76_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(new_n63_), .O(new_n156_));
  nand4  g094(.a(new_n76_), .b(x30), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  and2   g097(.a(new_n127_), .b(x40), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n149_), .d(new_n69_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  nand4  g101(.a(new_n150_), .b(new_n126_), .c(new_n64_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(new_n80_), .b(new_n149_), .c(new_n69_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n74_), .b(new_n70_), .c(x28), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x27), .c(x32), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n63_), .c(new_n64_), .O(new_n170_));
  oai21  g108(.a(new_n77_), .b(new_n68_), .c(new_n166_), .O(new_n171_));
  ...
  nand4  g117(.a(new_n65_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  nand2  g119(.a(new_n138_), .b(new_n68_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n134_), .c(new_n137_), .O(new_n183_));
  nand2  g121(.a(new_n139_), .b(new_n133_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n183_), .c(x06), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n64_), .O(z18));
  inv1   g124(.a(new_n134_), .O(new_n187_));
  oai21  g125(.a(new_n70_), .b(new_n68_), .c(new_n137_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n68_), .c(new_n70_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n133_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(x06), .c(x30), .O(z20));
  aoi21  g130(.a(new_n142_), .b(x06), .c(x30), .O(z19));
endmodule
