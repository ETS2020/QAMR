...
module FAU ( 
  ...
  nand3  g054(.a(x40), .b(x39), .c(x31), .O(new_n117_));
  ...
  aoi21  g061(.a(new_n93_), .b(x31), .c(new_n74_), .O(new_n124_));
  nand4  g062(.a(x40), .b(x39), .c(x31), .d(x05), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(new_n123_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n84_), .c(new_n122_), .O(new_n127_));
  ...
  nor3   g069(.a(new_n131_), .b(new_n93_), .c(new_n63_), .O(new_n132_));
  ...
  aoi21  g089(.a(x39), .b(new_n122_), .c(new_n71_), .O(new_n152_));
  ...
  nand3  g109(.a(new_n94_), .b(new_n155_), .c(new_n122_), .O(new_n172_));
  ...
  aoi21  g115(.a(new_n172_), .b(new_n177_), .c(new_n65_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n176_), .c(new_n173_), .O(z14));
  ...
  oai21  g126(.a(new_n83_), .b(x27), .c(new_n140_), .O(new_n189_));
  ...
  aoi21  g131(.a(x40), .b(new_n63_), .c(x27), .O(new_n194_));
  nand2  g132(.a(new_n149_), .b(x31), .O(new_n195_));
  nand2  g133(.a(x40), .b(x04), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n195_), .c(new_n82_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n135_), .O(new_n198_));
  nand2  g136(.a(x39), .b(x29), .O(new_n199_));
  nand3  g137(.a(new_n195_), .b(new_n142_), .c(new_n82_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand2  g139(.a(new_n143_), .b(new_n74_), .O(new_n202_));
  ...
  aoi21  g143(.a(x28), .b(new_n68_), .c(new_n149_), .O(new_n206_));
  aoi21  g144(.a(new_n199_), .b(x31), .c(new_n74_), .O(new_n207_));
  nor2   g145(.a(new_n207_), .b(new_n206_), .O(new_n208_));
  inv1   g146(.a(new_n194_), .O(new_n209_));
  aoi21  g147(.a(new_n195_), .b(new_n209_), .c(x08), .O(new_n210_));
