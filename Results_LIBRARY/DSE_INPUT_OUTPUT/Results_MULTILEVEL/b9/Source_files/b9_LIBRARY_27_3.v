...
module FAU ( 
  ...
  nand2  g060(.a(new_n122_), .b(new_n86_), .O(new_n123_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n82_), .c(x04), .O(new_n149_));
  ...
  nand4  g096(.a(new_n72_), .b(new_n82_), .c(x20), .d(new_n156_), .O(new_n159_));
  ...
  nand3  g102(.a(new_n152_), .b(new_n83_), .c(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n65_), .c(x30), .O(new_n166_));
  aoi21  g104(.a(new_n76_), .b(new_n151_), .c(x04), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  aoi21  g106(.a(x32), .b(new_n65_), .c(x27), .O(new_n169_));
  nand2  g107(.a(new_n71_), .b(x04), .O(new_n170_));
  nand3  g108(.a(new_n66_), .b(new_n83_), .c(x28), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(x37), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n169_), .c(new_n82_), .O(new_n173_));
  nand2  g111(.a(new_n76_), .b(new_n151_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n148_), .c(new_n65_), .O(new_n175_));
  ...
  oai21  g123(.a(new_n85_), .b(new_n64_), .c(new_n82_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n65_), .O(new_n187_));
  nand3  g125(.a(x35), .b(new_n84_), .c(new_n64_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n135_), .c(new_n138_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(x09), .c(new_n82_), .O(new_n190_));
  ...
  nand3  g133(.a(new_n195_), .b(new_n82_), .c(new_n134_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n80_), .O(z20));
  inv1   g135(.a(new_n142_), .O(z19));
endmodule
