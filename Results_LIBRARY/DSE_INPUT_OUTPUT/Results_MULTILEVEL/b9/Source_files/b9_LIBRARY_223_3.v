...
module FAU ( 
  ...
  nand4  g047(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n88_), .O(new_n110_));
  ...
  oai21  g054(.a(x39), .b(x31), .c(x40), .O(new_n117_));
  ...
  nand3  g059(.a(new_n74_), .b(new_n88_), .c(x05), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n121_), .c(new_n84_), .O(new_n123_));
  ...
  nor3   g065(.a(new_n127_), .b(new_n72_), .c(x31), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x05), .c(new_n65_), .O(new_n129_));
  oai21  g067(.a(new_n126_), .b(new_n64_), .c(new_n129_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n83_), .c(new_n65_), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(new_n88_), .c(new_n78_), .d(new_n64_), .O(new_n133_));
  aoi21  g071(.a(x39), .b(x29), .c(x31), .O(new_n134_));
  nor2   g072(.a(new_n64_), .b(new_n65_), .O(new_n135_));
  oai22  g073(.a(new_n135_), .b(new_n92_), .c(new_n134_), .d(new_n73_), .O(new_n136_));
  oai21  g074(.a(new_n133_), .b(x08), .c(new_n136_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n81_), .c(new_n131_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  nor2   g077(.a(new_n70_), .b(new_n64_), .O(new_n140_));
  nand3  g078(.a(new_n98_), .b(new_n67_), .c(new_n66_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  aoi21  g080(.a(x39), .b(new_n65_), .c(new_n140_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(new_n88_), .O(new_n144_));
  oai21  g082(.a(new_n140_), .b(x40), .c(new_n144_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n73_), .O(new_n148_));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n149_), .c(x31), .O(new_n154_));
  nand4  g092(.a(new_n152_), .b(new_n73_), .c(x20), .d(new_n151_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand3  g095(.a(new_n128_), .b(new_n146_), .c(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n160_));
  nand4  g098(.a(new_n147_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand3  g100(.a(new_n74_), .b(new_n146_), .c(new_n65_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n98_), .b(new_n66_), .c(x28), .O(new_n165_));
  ...
  nand2  g106(.a(new_n163_), .b(new_n168_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n167_), .c(new_n164_), .d(new_n78_), .O(z14));
  inv1   g108(.a(x12), .O(new_n171_));
  nand4  g109(.a(new_n78_), .b(x34), .c(x27), .d(x26), .O(new_n172_));
  ...
  nand2  g118(.a(new_n74_), .b(new_n88_), .O(new_n181_));
  ...
  nand2  g122(.a(new_n81_), .b(new_n131_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n83_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n80_), .c(new_n181_), .d(new_n90_), .O(z18));
  nand2  g125(.a(x40), .b(x04), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(x35), .c(new_n83_), .O(new_n189_));
  aoi22  g127(.a(new_n189_), .b(new_n88_), .c(new_n78_), .d(new_n64_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(x08), .c(new_n136_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n81_), .c(new_n131_), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(z19));
  inv1   g131(.a(x08), .O(new_n194_));
  oai21  g132(.a(new_n66_), .b(new_n64_), .c(new_n194_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n196_));
  nand2  g134(.a(new_n74_), .b(x29), .O(new_n197_));
  inv1   g135(.a(new_n197_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n195_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n81_), .c(new_n131_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n78_), .O(z20));
endmodule
