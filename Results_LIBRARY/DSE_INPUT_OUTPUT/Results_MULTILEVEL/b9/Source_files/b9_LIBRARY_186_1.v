...
module FAU ( 
  ...
  nand3  g042(.a(new_n103_), .b(new_n64_), .c(new_n98_), .O(new_n105_));
  ...
  nor2   g069(.a(new_n74_), .b(new_n91_), .O(new_n132_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n80_), .c(new_n131_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n64_), .O(z11));
  nand3  g082(.a(new_n98_), .b(new_n82_), .c(new_n134_), .O(new_n145_));
  ...
  nand4  g123(.a(new_n185_), .b(new_n183_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g124(.a(x39), .b(new_n91_), .c(new_n74_), .O(new_n187_));
  aoi21  g125(.a(new_n136_), .b(new_n135_), .c(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n66_), .O(new_n189_));
  nand3  g127(.a(new_n139_), .b(x35), .c(new_n83_), .O(new_n190_));
  ...
  oai21  g132(.a(new_n134_), .b(new_n66_), .c(new_n90_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n66_), .c(new_n134_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n132_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n131_), .O(new_n198_));
