...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x32), .O(new_n81_));
  ...
  nand3  g042(.a(new_n104_), .b(new_n103_), .c(new_n70_), .O(z05));
  ...
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n103_), .O(z12));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n149_), .O(new_n166_));
  nor2   g104(.a(x40), .b(new_n85_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n162_), .O(new_n168_));
  ...
  nand2  g109(.a(new_n164_), .b(new_n145_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x40), .O(new_n174_));
  nand3  g112(.a(new_n145_), .b(new_n149_), .c(x32), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n168_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nor2   g115(.a(new_n120_), .b(new_n177_), .O(z15));
  inv1   g116(.a(x23), .O(new_n179_));
  nand4  g117(.a(new_n103_), .b(new_n179_), .c(x22), .d(x01), .O(new_n180_));
  ...
  oai21  g122(.a(new_n87_), .b(x27), .c(new_n133_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n81_), .b(x30), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n137_), .d(new_n132_), .O(z18));
  inv1   g126(.a(new_n133_), .O(new_n189_));
  oai21  g127(.a(new_n66_), .b(new_n64_), .c(new_n136_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n84_), .c(new_n132_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n103_), .O(z20));
  nand2  g132(.a(new_n140_), .b(new_n103_), .O(z19));
endmodule
