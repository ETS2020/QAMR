...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x14), .O(new_n96_));
  ...
  nand3  g116(.a(new_n152_), .b(new_n76_), .c(new_n113_), .O(new_n179_));
  ...
  oai21  g128(.a(new_n86_), .b(x27), .c(new_n139_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n100_), .b(x30), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n192_), .c(new_n144_), .d(new_n138_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n92_), .c(new_n113_), .O(new_n196_));
  inv1   g134(.a(x28), .O(new_n197_));
  nand2  g135(.a(new_n140_), .b(new_n197_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n139_), .O(new_n199_));
  nand2  g137(.a(x35), .b(x27), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(x04), .c(new_n143_), .O(new_n201_));
  ...
  nand2  g143(.a(x28), .b(new_n143_), .O(new_n206_));
  nand4  g144(.a(new_n206_), .b(new_n205_), .c(new_n199_), .d(new_n196_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n83_), .c(new_n138_), .O(new_n208_));
  nand2  g146(.a(new_n208_), .b(new_n81_), .O(z19));
  aoi21  g147(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n210_));
  nand2  g148(.a(new_n202_), .b(x40), .O(new_n211_));
  aoi21  g149(.a(new_n211_), .b(new_n97_), .c(new_n210_), .O(new_n212_));
  nand2  g150(.a(new_n81_), .b(new_n64_), .O(new_n213_));
  nand2  g151(.a(x40), .b(new_n66_), .O(new_n214_));
  aoi21  g152(.a(new_n214_), .b(new_n213_), .c(x08), .O(new_n215_));
  oai21  g153(.a(new_n215_), .b(new_n212_), .c(new_n83_), .O(new_n216_));
