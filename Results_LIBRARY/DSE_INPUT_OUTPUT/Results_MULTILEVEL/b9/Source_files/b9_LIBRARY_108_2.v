...
module FAU ( 
  ...
  nor2   g026(.a(new_n69_), .b(new_n88_), .O(z08));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n92_), .c(new_n73_), .O(z03));
  nand2  g035(.a(new_n95_), .b(new_n94_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n92_), .c(new_n70_), .d(new_n93_), .O(z04));
  oai21  g037(.a(new_n77_), .b(new_n94_), .c(new_n95_), .O(new_n100_));
  and2   g038(.a(new_n100_), .b(new_n70_), .O(z05));
  ...
  nand2  g053(.a(new_n115_), .b(new_n70_), .O(z09));
  ...
  nor2   g067(.a(new_n94_), .b(new_n117_), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(new_n78_), .c(new_n129_), .O(new_n131_));
  inv1   g069(.a(x08), .O(new_n132_));
  nand2  g070(.a(x39), .b(x04), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(x35), .c(new_n77_), .d(x27), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n74_), .c(new_n128_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n70_), .O(z11));
  nor2   g076(.a(new_n64_), .b(new_n94_), .O(new_n139_));
  inv1   g077(.a(x35), .O(new_n140_));
  nand3  g078(.a(new_n95_), .b(new_n76_), .c(new_n140_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  nor2   g080(.a(new_n139_), .b(new_n117_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(x40), .O(new_n144_));
  oai21  g082(.a(new_n139_), .b(x39), .c(new_n144_), .O(z12));
  ...
  nand2  g089(.a(new_n91_), .b(new_n95_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n149_), .c(new_n94_), .O(new_n154_));
  nand3  g092(.a(new_n122_), .b(new_n146_), .c(new_n117_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n88_), .O(new_n156_));
  or2    g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x39), .b(new_n146_), .c(new_n117_), .O(new_n158_));
  ...
  aoi22  g099(.a(new_n161_), .b(new_n147_), .c(new_n95_), .d(new_n140_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n77_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n75_), .c(new_n74_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n160_), .c(new_n70_), .O(z14));
  inv1   g103(.a(x12), .O(new_n166_));
  nand4  g104(.a(new_n70_), .b(x34), .c(x27), .d(x26), .O(new_n167_));
  ...
  oai21  g112(.a(new_n78_), .b(x27), .c(new_n129_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  inv1   g114(.a(new_n78_), .O(new_n177_));
  nor2   g115(.a(new_n94_), .b(x04), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(x09), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n176_), .c(new_n70_), .d(new_n74_), .O(z18));
  oai21  g118(.a(new_n130_), .b(x28), .c(new_n129_), .O(new_n181_));
  aoi21  g119(.a(new_n69_), .b(x39), .c(x27), .O(new_n182_));
  nand2  g120(.a(x40), .b(new_n140_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n133_), .c(new_n77_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n132_), .O(new_n185_));
  oai21  g123(.a(new_n69_), .b(x29), .c(x39), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n140_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n185_), .c(new_n181_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n74_), .c(new_n128_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n70_), .O(z19));
  oai21  g128(.a(new_n77_), .b(x27), .c(x35), .O(new_n191_));
  and2   g129(.a(new_n191_), .b(new_n186_), .O(new_n192_));
  nand2  g130(.a(new_n70_), .b(new_n94_), .O(new_n193_));
  aoi21  g131(.a(new_n183_), .b(new_n193_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n74_), .O(new_n195_));
