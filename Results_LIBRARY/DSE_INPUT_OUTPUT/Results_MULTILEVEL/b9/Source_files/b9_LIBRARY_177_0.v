...
module FAU ( 
  ...
  nand3  g031(.a(new_n93_), .b(new_n91_), .c(new_n88_), .O(z02));
  nand2  g032(.a(new_n67_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x27), .O(new_n96_));
  nor2   g034(.a(x40), .b(x39), .O(new_n97_));
  aoi21  g035(.a(new_n66_), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n66_), .c(new_n97_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n65_), .c(new_n66_), .O(new_n104_));
  ...
  nand2  g054(.a(new_n92_), .b(new_n65_), .O(z08));
  ...
  nand2  g071(.a(new_n133_), .b(new_n72_), .O(new_n134_));
  oai21  g072(.a(new_n129_), .b(new_n96_), .c(new_n134_), .O(z10));
  nand2  g073(.a(new_n65_), .b(new_n96_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n121_), .c(new_n72_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x39), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n136_), .c(x08), .O(new_n139_));
  nand2  g077(.a(x40), .b(new_n63_), .O(new_n140_));
  inv1   g078(.a(x29), .O(new_n141_));
  oai21  g079(.a(new_n64_), .b(new_n141_), .c(x39), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi22  g081(.a(new_n143_), .b(new_n82_), .c(new_n142_), .d(new_n140_), .O(new_n144_));
  ...
  oai21  g086(.a(new_n92_), .b(x04), .c(new_n69_), .O(new_n149_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n72_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n68_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nor2   g097(.a(new_n132_), .b(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n72_), .c(new_n97_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  inv1   g100(.a(new_n140_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n164_));
  nand4  g102(.a(new_n152_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n165_));
  nand3  g103(.a(x40), .b(new_n151_), .c(new_n72_), .O(new_n166_));
  ...
  nand3  g107(.a(new_n66_), .b(new_n81_), .c(x28), .O(new_n170_));
  ...
  oai22  g124(.a(new_n92_), .b(new_n141_), .c(new_n89_), .d(x27), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n96_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n82_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n65_), .d(new_n79_), .O(z18));
  aoi21  g129(.a(x28), .b(new_n96_), .c(new_n81_), .O(new_n192_));
  aoi21  g130(.a(new_n142_), .b(new_n140_), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(x39), .b(new_n81_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n136_), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n79_), .O(new_n196_));
