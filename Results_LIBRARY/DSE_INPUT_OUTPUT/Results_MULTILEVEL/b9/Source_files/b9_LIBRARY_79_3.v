...
module FAU ( 
  ...
  oai22  g015(.a(new_n77_), .b(x02), .c(new_n72_), .d(new_n65_), .O(z00));
  ...
  nand3  g027(.a(x40), .b(x39), .c(x29), .O(new_n90_));
  inv1   g028(.a(new_n90_), .O(new_n91_));
  nand4  g029(.a(new_n91_), .b(new_n89_), .c(x08), .d(new_n63_), .O(z02));
  ...
  oai21  g036(.a(new_n83_), .b(new_n68_), .c(new_n69_), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n79_), .O(z06));
  ...
  aoi21  g052(.a(new_n114_), .b(new_n63_), .c(new_n64_), .O(z08));
  ...
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n79_), .O(z10));
  inv1   g066(.a(x08), .O(new_n129_));
  inv1   g067(.a(x09), .O(new_n130_));
  nand4  g068(.a(new_n80_), .b(new_n130_), .c(new_n129_), .d(x04), .O(new_n131_));
  ...
  oai21  g074(.a(new_n84_), .b(new_n68_), .c(new_n129_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n80_), .c(new_n130_), .O(new_n139_));
  ...
  oai21  g081(.a(new_n118_), .b(x04), .c(new_n143_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n142_), .c(new_n79_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n64_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x39), .c(new_n146_), .d(new_n73_), .O(new_n149_));
  ...
  nand4  g093(.a(new_n123_), .b(x39), .c(new_n146_), .d(new_n73_), .O(new_n156_));
  ...
  oai21  g117(.a(new_n84_), .b(x27), .c(new_n90_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  inv1   g119(.a(new_n84_), .O(new_n182_));
  nor2   g120(.a(new_n68_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(x30), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n181_), .c(new_n79_), .d(new_n130_), .O(z18));
  aoi21  g123(.a(x40), .b(x02), .c(x27), .O(new_n186_));
  nand2  g124(.a(x40), .b(x04), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(x35), .c(new_n83_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n63_), .c(new_n186_), .O(new_n189_));
  aoi21  g127(.a(x39), .b(x29), .c(x02), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n64_), .c(new_n135_), .O(new_n191_));
  oai21  g129(.a(new_n189_), .b(x08), .c(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n130_), .O(new_n193_));
  inv1   g131(.a(new_n193_), .O(z19));
  oai21  g132(.a(new_n165_), .b(new_n68_), .c(new_n129_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n68_), .c(new_n165_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n91_), .c(new_n195_), .O(new_n197_));
