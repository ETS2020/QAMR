...
module FAU ( 
  ...
  nand2  g016(.a(x32), .b(x30), .O(new_n79_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n79_), .O(z11));
  ...
  oai21  g082(.a(new_n114_), .b(x04), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n143_), .c(new_n93_), .O(z12));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(x30), .O(new_n155_));
  ...
  nand4  g099(.a(new_n149_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  nand3  g101(.a(new_n75_), .b(new_n147_), .c(new_n65_), .O(new_n164_));
  ...
  aoi21  g106(.a(new_n164_), .b(new_n144_), .c(new_n93_), .O(new_n169_));
  ...
  nand2  g117(.a(new_n83_), .b(new_n64_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n132_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n136_), .c(new_n81_), .d(new_n131_), .O(z18));
