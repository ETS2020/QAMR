...
module FAU ( 
  ...
  aoi21  g034(.a(new_n96_), .b(new_n93_), .c(new_n79_), .O(z03));
  aoi21  g035(.a(new_n65_), .b(new_n95_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n93_), .c(new_n79_), .O(z04));
  ...
  aoi21  g059(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(new_n122_));
  ...
  aoi21  g066(.a(x39), .b(new_n128_), .c(new_n74_), .O(new_n129_));
  nand2  g067(.a(x27), .b(x04), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n89_), .c(new_n129_), .O(new_n131_));
  nand2  g069(.a(new_n64_), .b(new_n95_), .O(new_n132_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n131_), .c(new_n80_), .O(new_n137_));
  nor2   g075(.a(new_n137_), .b(x09), .O(z11));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n95_), .c(new_n73_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n122_), .b(x39), .c(new_n143_), .d(new_n71_), .O(new_n154_));
  ...
  oai21  g100(.a(new_n162_), .b(new_n133_), .c(x27), .O(new_n163_));
  ...
  nand2  g112(.a(x27), .b(new_n71_), .O(new_n175_));
  nand2  g113(.a(new_n95_), .b(x08), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n175_), .c(new_n82_), .O(new_n177_));
  inv1   g115(.a(x09), .O(new_n178_));
  nand2  g116(.a(new_n80_), .b(new_n178_), .O(new_n179_));
  aoi21  g117(.a(new_n177_), .b(new_n133_), .c(new_n179_), .O(new_n180_));
  nand3  g118(.a(z08), .b(x29), .c(x08), .O(new_n181_));
  oai21  g119(.a(new_n180_), .b(new_n79_), .c(new_n181_), .O(z18));
  aoi21  g120(.a(x28), .b(new_n95_), .c(new_n82_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n129_), .O(new_n184_));
  nand2  g122(.a(x39), .b(new_n82_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n132_), .c(x08), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n80_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(x09), .O(z20));
  nor2   g126(.a(new_n137_), .b(x09), .O(z19));
endmodule
