...
module FAU ( 
  ...
  inv1   g020(.a(new_n77_), .O(new_n83_));
  oai21  g021(.a(x27), .b(x08), .c(new_n83_), .O(new_n84_));
  aoi21  g022(.a(new_n84_), .b(x04), .c(new_n82_), .O(new_n85_));
  oai21  g023(.a(new_n85_), .b(new_n69_), .c(x39), .O(z02));
  inv1   g024(.a(new_n70_), .O(new_n87_));
  ...
  aoi21  g031(.a(new_n93_), .b(new_n89_), .c(new_n87_), .O(z03));
  nand2  g032(.a(new_n92_), .b(new_n91_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n89_), .c(new_n70_), .d(new_n90_), .O(z04));
  oai21  g034(.a(new_n76_), .b(new_n91_), .c(new_n92_), .O(new_n97_));
  and2   g035(.a(new_n97_), .b(new_n70_), .O(z05));
  ...
  nand3  g047(.a(new_n109_), .b(new_n70_), .c(x03), .O(new_n110_));
  ...
  nand3  g055(.a(new_n117_), .b(new_n78_), .c(new_n114_), .O(new_n118_));
  ...
  nand4  g060(.a(new_n122_), .b(x39), .c(x05), .d(new_n114_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n121_), .O(z10));
  inv1   g062(.a(x29), .O(new_n125_));
  inv1   g063(.a(x39), .O(new_n126_));
  aoi21  g064(.a(x40), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand2  g065(.a(x27), .b(x04), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n83_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n70_), .b(new_n91_), .O(new_n130_));
  nand3  g068(.a(x35), .b(new_n76_), .c(new_n114_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x40), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n130_), .c(x08), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n129_), .c(new_n73_), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(x09), .O(z11));
  nor2   g073(.a(new_n64_), .b(new_n91_), .O(new_n136_));
  inv1   g074(.a(x35), .O(new_n137_));
  nand3  g075(.a(new_n92_), .b(new_n75_), .c(new_n137_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x27), .c(x10), .O(new_n139_));
  nor2   g077(.a(new_n136_), .b(new_n114_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n139_), .c(x40), .O(new_n141_));
  oai21  g079(.a(new_n136_), .b(x39), .c(new_n141_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x28), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x39), .c(new_n143_), .d(new_n114_), .O(new_n146_));
  inv1   g084(.a(x18), .O(new_n147_));
  inv1   g085(.a(x19), .O(new_n148_));
  nand2  g086(.a(new_n88_), .b(new_n92_), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x20), .c(new_n148_), .d(new_n147_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n146_), .c(new_n91_), .O(new_n151_));
  nand2  g089(.a(new_n74_), .b(new_n73_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n143_), .c(new_n114_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x40), .c(new_n126_), .O(new_n154_));
  or2    g092(.a(new_n154_), .b(new_n151_), .O(z13));
  nand3  g093(.a(x39), .b(new_n143_), .c(new_n114_), .O(new_n156_));
  nand4  g094(.a(x27), .b(x20), .c(new_n148_), .d(new_n147_), .O(new_n157_));
  ...
  oai21  g099(.a(new_n161_), .b(new_n76_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n74_), .c(new_n73_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n158_), .c(new_n70_), .O(z14));
  inv1   g102(.a(x12), .O(new_n165_));
  nand4  g103(.a(new_n70_), .b(x34), .c(x27), .d(x26), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n165_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x22), .c(x01), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n70_), .O(z16));
  inv1   g108(.a(x01), .O(new_n171_));
  inv1   g109(.a(x24), .O(new_n172_));
  nand4  g110(.a(new_n70_), .b(new_n172_), .c(x23), .d(x22), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n171_), .O(z17));
  oai22  g112(.a(new_n77_), .b(x27), .c(new_n126_), .d(new_n125_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n91_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n83_), .c(x09), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n70_), .d(new_n73_), .O(z18));
  nand2  g117(.a(x39), .b(x04), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x35), .c(new_n76_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n130_), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n129_), .c(new_n73_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(x09), .O(z19));
  nor2   g123(.a(new_n126_), .b(new_n125_), .O(new_n186_));
  nor2   g124(.a(new_n137_), .b(new_n91_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n91_), .c(new_n137_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .d(x08), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n73_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(x09), .c(new_n70_), .O(z20));
  buf    g129(.a(x39), .O(z08));
endmodule
