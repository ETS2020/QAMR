...
module FAU ( 
  ...
  nand3  g055(.a(new_n117_), .b(new_n79_), .c(x27), .O(new_n118_));
  nand2  g056(.a(new_n75_), .b(new_n74_), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(x39), .c(x05), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  ...
  aoi21  g065(.a(x40), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand2  g066(.a(x27), .b(x04), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n125_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n70_), .b(new_n91_), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n77_), .c(new_n114_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x40), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n131_), .c(x08), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n130_), .c(new_n74_), .O(new_n135_));
  nor2   g073(.a(new_n135_), .b(x09), .O(z11));
  nor2   g074(.a(new_n64_), .b(new_n91_), .O(new_n137_));
  inv1   g075(.a(x35), .O(new_n138_));
  nand3  g076(.a(new_n92_), .b(new_n76_), .c(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x27), .c(x10), .O(new_n140_));
  nor2   g078(.a(new_n137_), .b(new_n114_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(x40), .O(new_n142_));
  oai21  g080(.a(new_n137_), .b(x39), .c(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n114_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand2  g087(.a(new_n89_), .b(new_n92_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n147_), .c(new_n69_), .O(new_n152_));
  nand4  g090(.a(new_n150_), .b(new_n127_), .c(x20), .d(new_n149_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x18), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(x27), .O(new_n155_));
  aoi21  g093(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n144_), .d(new_n114_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand3  g096(.a(x39), .b(new_n144_), .c(new_n114_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n64_), .c(new_n159_), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(new_n145_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n77_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n75_), .c(new_n74_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n161_), .c(new_n70_), .O(z14));
  inv1   g105(.a(x12), .O(new_n168_));
  nand4  g106(.a(new_n70_), .b(x34), .c(x27), .d(x26), .O(new_n169_));
  ...
  nand2  g113(.a(new_n175_), .b(new_n70_), .O(z17));
  nand2  g114(.a(x40), .b(x39), .O(new_n177_));
  nand2  g115(.a(x27), .b(new_n114_), .O(new_n178_));
  nand2  g116(.a(new_n91_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n138_), .O(new_n180_));
  inv1   g118(.a(x09), .O(new_n181_));
  nand2  g119(.a(new_n74_), .b(new_n181_), .O(new_n182_));
  aoi21  g120(.a(new_n180_), .b(new_n77_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n73_), .c(new_n177_), .d(new_n84_), .O(z18));
  nand2  g122(.a(x39), .b(x04), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(x35), .c(new_n77_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x40), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n131_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n130_), .c(new_n74_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z19));
  nor2   g128(.a(new_n138_), .b(new_n91_), .O(new_n191_));
  nor2   g129(.a(new_n127_), .b(new_n126_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n91_), .c(new_n138_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n192_), .c(new_n191_), .d(x08), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n74_), .c(new_n181_), .O(new_n195_));
