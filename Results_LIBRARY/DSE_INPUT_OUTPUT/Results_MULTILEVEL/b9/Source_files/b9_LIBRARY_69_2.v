...
module FAU ( 
  ...
  oai21  g038(.a(new_n82_), .b(new_n96_), .c(new_n65_), .O(new_n101_));
  ...
  nand3  g058(.a(new_n120_), .b(new_n84_), .c(new_n71_), .O(new_n121_));
  ...
  aoi21  g067(.a(x40), .b(new_n90_), .c(new_n129_), .O(new_n130_));
  ...
  oai21  g078(.a(new_n129_), .b(x04), .c(new_n68_), .O(new_n141_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(new_n96_), .O(new_n150_));
  nand2  g088(.a(new_n80_), .b(new_n79_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n143_), .c(new_n71_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x40), .c(new_n129_), .O(new_n153_));
  or2    g091(.a(new_n153_), .b(new_n150_), .O(z13));
  nand3  g092(.a(x39), .b(new_n143_), .c(new_n71_), .O(new_n155_));
  ...
  nand2  g110(.a(x39), .b(x29), .O(new_n173_));
  oai21  g111(.a(new_n83_), .b(x27), .c(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n96_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n128_), .c(x09), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g116(.a(x09), .O(new_n179_));
  nand2  g117(.a(new_n131_), .b(new_n82_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n173_), .O(new_n181_));
  aoi21  g119(.a(new_n63_), .b(x39), .c(x27), .O(new_n182_));
  nand2  g120(.a(x40), .b(new_n159_), .O(new_n183_));
  nand2  g121(.a(x39), .b(x04), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n183_), .c(new_n82_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n182_), .c(new_n89_), .O(new_n186_));
  ...
  nand3  g127(.a(new_n189_), .b(new_n79_), .c(new_n179_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n64_), .O(z19));
  aoi21  g129(.a(x28), .b(new_n96_), .c(new_n159_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n130_), .O(new_n193_));
  aoi21  g131(.a(new_n183_), .b(new_n133_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(new_n79_), .O(new_n195_));
