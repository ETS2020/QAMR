...
module FAU ( 
  ...
  oai21  g022(.a(new_n84_), .b(new_n74_), .c(new_n79_), .O(new_n85_));
  ...
  aoi21  g034(.a(new_n65_), .b(new_n96_), .c(new_n63_), .O(new_n97_));
  ...
  nand2  g056(.a(new_n92_), .b(x07), .O(new_n119_));
  ...
  nand2  g061(.a(new_n123_), .b(new_n79_), .O(new_n124_));
  ...
  nand4  g073(.a(x35), .b(new_n81_), .c(x27), .d(new_n71_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(x40), .c(new_n79_), .d(new_n130_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n96_), .c(new_n73_), .O(new_n142_));
  oai21  g080(.a(new_n92_), .b(x04), .c(new_n68_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n64_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x28), .c(new_n74_), .O(new_n147_));
  ...
  nand3  g091(.a(new_n124_), .b(x40), .c(x39), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x13), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n71_), .c(new_n63_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n153_), .O(z13));
  nand3  g095(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n158_));
  nand4  g096(.a(new_n146_), .b(new_n123_), .c(new_n79_), .d(x28), .O(new_n159_));
  nand3  g097(.a(x39), .b(new_n145_), .c(new_n71_), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n159_), .c(new_n74_), .O(new_n162_));
  nor2   g100(.a(x40), .b(new_n79_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n158_), .O(new_n164_));
  inv1   g102(.a(x35), .O(new_n165_));
  nand3  g103(.a(new_n65_), .b(new_n165_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n123_), .c(new_n79_), .O(new_n168_));
  nand2  g106(.a(new_n160_), .b(new_n68_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x40), .O(new_n171_));
  nand3  g109(.a(new_n68_), .b(new_n74_), .c(x30), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n164_), .O(z14));
  ...
  nand3  g121(.a(x35), .b(new_n81_), .c(new_n96_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n131_), .c(new_n135_), .O(new_n185_));
  nand2  g123(.a(new_n136_), .b(new_n130_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(x40), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n79_), .O(z18));
  inv1   g126(.a(new_n131_), .O(new_n189_));
  oai21  g127(.a(new_n165_), .b(new_n96_), .c(new_n135_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n96_), .c(new_n165_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(x40), .c(new_n79_), .d(new_n130_), .O(new_n193_));
  inv1   g131(.a(new_n193_), .O(z20));
  inv1   g132(.a(new_n139_), .O(z19));
endmodule
