...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x33), .O(new_n93_));
  ...
  nand3  g042(.a(new_n104_), .b(new_n79_), .c(new_n98_), .O(z05));
  ...
  nand3  g047(.a(new_n109_), .b(new_n107_), .c(new_n78_), .O(new_n110_));
  ...
  nor2   g066(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(x33), .c(x05), .d(new_n65_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n126_), .O(z10));
  nand2  g069(.a(new_n79_), .b(new_n64_), .O(new_n132_));
  oai21  g070(.a(new_n84_), .b(x04), .c(x33), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(x08), .O(new_n134_));
  inv1   g072(.a(new_n84_), .O(new_n135_));
  nand2  g073(.a(x39), .b(x29), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x33), .c(new_n73_), .O(new_n137_));
  nand2  g075(.a(x27), .b(x04), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n135_), .c(new_n137_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n134_), .c(new_n81_), .O(new_n140_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n143_), .c(x33), .O(new_n146_));
  oai21  g084(.a(new_n70_), .b(new_n64_), .c(new_n73_), .O(new_n147_));
  ...
  nand4  g095(.a(new_n127_), .b(x39), .c(new_n149_), .d(new_n65_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x33), .c(new_n73_), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n157_), .O(z13));
  nand3  g098(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n161_));
  nand4  g099(.a(new_n150_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n162_));
  nand3  g100(.a(x39), .b(new_n149_), .c(new_n65_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n162_), .c(new_n78_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n73_), .c(new_n161_), .O(new_n166_));
  nand3  g104(.a(new_n98_), .b(new_n66_), .c(x28), .O(new_n167_));
  ...
  nand2  g108(.a(new_n170_), .b(x33), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n166_), .c(new_n147_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nand4  g111(.a(new_n79_), .b(x34), .c(x27), .d(x26), .O(new_n174_));
  ...
  nand2  g119(.a(new_n74_), .b(x29), .O(new_n182_));
  oai21  g120(.a(new_n84_), .b(x27), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n64_), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n135_), .c(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n184_), .c(new_n79_), .d(new_n81_), .O(z18));
  nand2  g125(.a(x40), .b(x04), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(x35), .c(new_n83_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x33), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n132_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n139_), .c(new_n81_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z19));
  inv1   g131(.a(x09), .O(new_n194_));
  inv1   g132(.a(new_n182_), .O(new_n195_));
  ...
  nand3  g137(.a(new_n199_), .b(new_n81_), .c(new_n194_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n79_), .O(z20));
endmodule
