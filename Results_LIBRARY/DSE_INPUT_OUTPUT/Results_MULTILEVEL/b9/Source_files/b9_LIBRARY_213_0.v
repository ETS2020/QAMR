...
module FAU ( 
  ...
  oai21  g013(.a(new_n75_), .b(new_n63_), .c(new_n64_), .O(new_n76_));
  ...
  aoi21  g024(.a(new_n86_), .b(x04), .c(new_n66_), .O(z01));
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(new_n65_), .O(z02));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n66_), .O(z03));
  aoi21  g038(.a(new_n69_), .b(new_n98_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n66_), .O(z04));
  ...
  nand2  g047(.a(x38), .b(x25), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(x00), .O(new_n111_));
  oai21  g049(.a(x38), .b(new_n64_), .c(new_n111_), .O(new_n112_));
  nand4  g050(.a(new_n112_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n113_));
  inv1   g051(.a(x14), .O(new_n114_));
  inv1   g052(.a(x25), .O(new_n115_));
  aoi21  g053(.a(x38), .b(new_n115_), .c(new_n64_), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(x00), .c(new_n114_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n113_), .c(new_n106_), .O(z07));
  nand2  g056(.a(new_n93_), .b(new_n65_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n65_), .O(z09));
  inv1   g059(.a(x04), .O(new_n122_));
  nand2  g060(.a(new_n93_), .b(x07), .O(new_n123_));
  ...
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(new_n66_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  nor2   g074(.a(new_n98_), .b(new_n122_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n83_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand4  g077(.a(x35), .b(new_n82_), .c(x27), .d(new_n122_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n79_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n65_), .O(z11));
  oai21  g082(.a(new_n93_), .b(x04), .c(new_n70_), .O(new_n145_));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n81_), .b(new_n146_), .c(new_n64_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(x37), .O(new_n148_));
  nor2   g086(.a(x27), .b(x10), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(x00), .O(new_n150_));
  nand2  g088(.a(new_n94_), .b(new_n122_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n72_), .c(x10), .O(new_n152_));
  ...
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n154_), .d(new_n122_), .O(new_n158_));
  ...
  nand3  g101(.a(new_n129_), .b(new_n154_), .c(new_n122_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n163_), .c(new_n66_), .O(z13));
  nand3  g103(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n166_));
  nand4  g104(.a(new_n156_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n94_), .b(new_n154_), .c(new_n122_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n69_), .b(new_n146_), .c(x28), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(x27), .c(x32), .O(new_n172_));
  aoi22  g110(.a(new_n172_), .b(new_n79_), .c(new_n169_), .d(new_n72_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n170_), .c(new_n66_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nand4  g113(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n176_));
  ...
  oai21  g122(.a(new_n83_), .b(x27), .c(new_n136_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n66_), .b(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n140_), .d(new_n79_), .O(z18));
  nand4  g126(.a(new_n142_), .b(new_n65_), .c(new_n79_), .d(new_n135_), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(z19));
  inv1   g128(.a(new_n136_), .O(new_n191_));
  oai21  g129(.a(new_n146_), .b(new_n98_), .c(new_n139_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n98_), .c(new_n146_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n79_), .c(new_n135_), .O(new_n195_));
