...
module FAU ( 
  ...
  oai21  g027(.a(new_n89_), .b(new_n88_), .c(new_n65_), .O(new_n90_));
  ...
  nand4  g038(.a(new_n100_), .b(new_n95_), .c(new_n65_), .d(new_n96_), .O(z04));
  ...
  nor3   g054(.a(new_n94_), .b(new_n75_), .c(new_n116_), .O(z08));
  ...
  nand2  g059(.a(new_n89_), .b(x07), .O(new_n122_));
  oai21  g060(.a(new_n89_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n84_), .c(x27), .O(new_n124_));
  inv1   g062(.a(new_n89_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(x32), .c(x05), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n124_), .c(new_n73_), .O(new_n127_));
  ...
  oai21  g082(.a(new_n89_), .b(x04), .c(new_n69_), .O(new_n145_));
  ...
  nand4  g093(.a(new_n155_), .b(new_n125_), .c(x32), .d(new_n64_), .O(new_n156_));
  ...
  nand3  g098(.a(new_n125_), .b(new_n149_), .c(new_n64_), .O(new_n161_));
  ...
  aoi21  g103(.a(new_n161_), .b(new_n69_), .c(new_n94_), .O(new_n166_));
  ...
  oai21  g113(.a(new_n83_), .b(x27), .c(new_n132_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n138_), .c(new_n73_), .d(new_n131_), .O(z18));
  inv1   g116(.a(new_n132_), .O(new_n179_));
  oai21  g117(.a(new_n136_), .b(new_n97_), .c(new_n135_), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n97_), .c(new_n136_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n179_), .c(new_n180_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n73_), .c(new_n131_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n65_), .O(z20));
  inv1   g122(.a(new_n141_), .O(z19));
endmodule
