...
module FAU ( 
  ...
  inv1   g026(.a(new_n80_), .O(new_n89_));
  ...
  aoi22  g062(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n67_), .O(new_n125_));
  ...
  nand2  g068(.a(x30), .b(new_n130_), .O(new_n131_));
  nand2  g069(.a(x32), .b(new_n83_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n129_), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(x39), .c(x05), .d(new_n65_), .O(new_n134_));
  oai21  g072(.a(new_n128_), .b(new_n64_), .c(new_n134_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x40), .b(x39), .c(x29), .O(new_n137_));
  nor2   g075(.a(new_n64_), .b(new_n65_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n122_), .c(new_n137_), .O(new_n139_));
  ...
  nand3  g081(.a(new_n143_), .b(new_n83_), .c(new_n136_), .O(new_n144_));
  ...
  nand4  g093(.a(new_n72_), .b(x20), .c(new_n155_), .d(new_n130_), .O(new_n156_));
  ...
  nand2  g101(.a(x20), .b(new_n155_), .O(new_n164_));
  ...
  nand2  g106(.a(new_n152_), .b(x18), .O(new_n169_));
  nand3  g107(.a(new_n70_), .b(new_n66_), .c(new_n83_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n169_), .c(new_n121_), .O(new_n171_));
  nor2   g109(.a(x30), .b(x27), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n171_), .c(new_n84_), .O(new_n173_));
  nand3  g111(.a(new_n72_), .b(x27), .c(new_n130_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n167_), .c(new_n89_), .O(new_n175_));
  ...
  oai21  g123(.a(new_n122_), .b(x27), .c(new_n137_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n141_), .c(new_n83_), .d(new_n136_), .O(z18));
  nand2  g126(.a(new_n144_), .b(new_n80_), .O(z19));
  inv1   g127(.a(new_n137_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n83_), .c(new_n136_), .O(new_n194_));
