...
module FAU ( 
  ...
  nand2  g032(.a(new_n64_), .b(x34), .O(new_n95_));
  ...
  oai21  g087(.a(new_n149_), .b(new_n99_), .c(new_n76_), .O(new_n150_));
  oai21  g088(.a(new_n118_), .b(x04), .c(new_n72_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n65_), .O(z12));
  ...
  nand4  g103(.a(new_n154_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n166_));
  nand3  g104(.a(x39), .b(new_n153_), .c(new_n75_), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n64_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n142_), .c(new_n165_), .O(new_n170_));
  ...
  oai21  g112(.a(new_n168_), .b(new_n73_), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand3  g114(.a(new_n72_), .b(new_n64_), .c(x34), .O(new_n177_));
  ...
  oai22  g126(.a(new_n118_), .b(new_n188_), .c(new_n85_), .d(x27), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n99_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n141_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n65_), .d(new_n81_), .O(z18));
  aoi21  g131(.a(x28), .b(new_n99_), .c(new_n171_), .O(new_n194_));
