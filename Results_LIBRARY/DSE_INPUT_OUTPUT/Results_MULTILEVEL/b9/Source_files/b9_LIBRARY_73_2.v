...
module FAU ( 
  ...
  nor2   g064(.a(new_n126_), .b(new_n115_), .O(new_n127_));
  ...
  nand3  g078(.a(new_n96_), .b(new_n81_), .c(new_n89_), .O(new_n141_));
  ...
  nand2  g089(.a(new_n94_), .b(new_n96_), .O(new_n152_));
  ...
  nand3  g097(.a(x39), .b(new_n146_), .c(new_n72_), .O(new_n160_));
  ...
  oai21  g114(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nand3  g116(.a(new_n90_), .b(x27), .c(new_n72_), .O(new_n179_));
  nor2   g117(.a(new_n78_), .b(x30), .O(new_n180_));
  ...
  oai21  g124(.a(new_n89_), .b(new_n66_), .c(new_n134_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n66_), .c(new_n89_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n79_), .c(new_n130_), .O(new_n190_));
