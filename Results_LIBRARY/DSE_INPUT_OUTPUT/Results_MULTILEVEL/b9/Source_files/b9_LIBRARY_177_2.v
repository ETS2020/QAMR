...
module FAU ( 
  ...
  aoi21  g033(.a(new_n65_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n93_), .c(x21), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  nand3  g036(.a(new_n96_), .b(new_n93_), .c(new_n98_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n65_), .c(new_n95_), .O(z05));
  ...
  nand3  g058(.a(new_n120_), .b(new_n83_), .c(new_n71_), .O(new_n121_));
  ...
  aoi21  g062(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(new_n125_));
  nand4  g063(.a(new_n125_), .b(x39), .c(x05), .d(new_n71_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n124_), .O(z10));
  inv1   g065(.a(new_n82_), .O(new_n128_));
  inv1   g066(.a(x29), .O(new_n129_));
  inv1   g067(.a(x39), .O(new_n130_));
  aoi21  g068(.a(x40), .b(new_n129_), .c(new_n130_), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n128_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n64_), .b(new_n94_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n134_), .c(x08), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n133_), .c(new_n78_), .O(new_n138_));
  nor2   g076(.a(new_n138_), .b(x09), .O(z11));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n94_), .c(new_n73_), .O(new_n141_));
  oai21  g079(.a(new_n130_), .b(x04), .c(new_n68_), .O(new_n142_));
  ...
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n71_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand4  g087(.a(new_n67_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n94_), .O(new_n151_));
  nand2  g089(.a(new_n79_), .b(new_n78_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n144_), .c(new_n71_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x40), .c(new_n130_), .O(new_n154_));
  or2    g092(.a(new_n154_), .b(new_n151_), .O(z13));
  aoi21  g093(.a(new_n144_), .b(new_n71_), .c(new_n63_), .O(new_n156_));
  nor2   g094(.a(x19), .b(x18), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n67_), .c(x27), .d(x20), .O(new_n158_));
  oai21  g096(.a(new_n156_), .b(new_n130_), .c(new_n158_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n160_));
  nor2   g098(.a(x37), .b(x35), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(new_n145_), .c(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n81_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x40), .c(new_n79_), .d(new_n78_), .O(new_n164_));
  ...
  oai22  g112(.a(new_n82_), .b(x27), .c(new_n130_), .d(new_n129_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n94_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n128_), .c(x09), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n64_), .d(new_n78_), .O(z18));
  inv1   g117(.a(x35), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n94_), .c(new_n180_), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n131_), .O(new_n182_));
  nand2  g120(.a(x40), .b(new_n180_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n134_), .c(x08), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n78_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(x09), .O(z20));
  buf    g124(.a(x39), .O(z08));
  nor2   g125(.a(new_n138_), .b(x09), .O(z19));
endmodule
