...
module FAU ( 
  ...
  aoi21  g20(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n83_));
  aoi21  g21(.a(new_n83_), .b(new_n79_), .c(new_n64_), .O(z04));
  inv1   g22(.a(x28), .O(new_n85_));
  oai21  g23(.a(new_n85_), .b(new_n66_), .c(new_n67_), .O(new_n86_));
  ...
  nand3  g52(.a(new_n115_), .b(new_n72_), .c(new_n111_), .O(new_n116_));
  nand2  g53(.a(new_n116_), .b(z02), .O(z11));
  ...
  nor2   g61(.a(new_n124_), .b(new_n64_), .O(z14));
  ...
  nand4  g75(.a(new_n138_), .b(z02), .c(new_n72_), .d(new_n111_), .O(z18));
  oai21  g76(.a(new_n113_), .b(new_n73_), .c(z02), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(new_n112_), .c(new_n85_), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n72_), .c(new_n111_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(z02), .O(z19));
  oai21  g80(.a(x28), .b(new_n135_), .c(new_n66_), .O(new_n144_));
  nand2  g81(.a(new_n144_), .b(x35), .O(new_n145_));
  nand4  g82(.a(new_n145_), .b(z02), .c(new_n72_), .d(new_n111_), .O(new_n146_));
