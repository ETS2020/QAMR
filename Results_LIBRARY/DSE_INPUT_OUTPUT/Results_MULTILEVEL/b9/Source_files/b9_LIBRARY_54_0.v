...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x17), .O(new_n63_));
  ...
  nor2   g039(.a(new_n84_), .b(new_n65_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n90_), .c(new_n71_), .O(z05));
  oai21  g042(.a(new_n102_), .b(x37), .c(new_n90_), .O(z06));
  ...
  nand2  g054(.a(new_n76_), .b(new_n90_), .O(z08));
  inv1   g055(.a(x11), .O(new_n118_));
  nand4  g056(.a(new_n90_), .b(x34), .c(x27), .d(x26), .O(new_n119_));
  nor2   g057(.a(new_n119_), .b(new_n118_), .O(z09));
  inv1   g058(.a(x05), .O(new_n121_));
  nand2  g059(.a(new_n76_), .b(x07), .O(new_n122_));
  oai21  g060(.a(new_n76_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n86_), .c(x27), .O(new_n124_));
  inv1   g062(.a(x32), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n83_), .O(new_n126_));
  ...
  nand2  g078(.a(new_n140_), .b(new_n132_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x17), .c(x30), .O(z11));
  ...
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n90_), .O(z12));
  ...
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n148_), .d(new_n66_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand4  g092(.a(new_n73_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(new_n82_), .O(new_n156_));
  ...
  nand2  g097(.a(x32), .b(x17), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n83_), .c(new_n149_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n148_), .d(new_n66_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  nand3  g101(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n164_));
  nand4  g102(.a(new_n150_), .b(new_n125_), .c(new_n83_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n77_), .b(new_n148_), .c(new_n66_), .O(new_n167_));
  ...
  oai21  g108(.a(new_n170_), .b(new_n82_), .c(new_n83_), .O(new_n171_));
  ...
  nand2  g112(.a(new_n174_), .b(new_n90_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(x22), .c(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n90_), .O(z16));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n90_), .O(z17));
  oai21  g119(.a(new_n85_), .b(x27), .c(new_n133_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n82_), .b(x09), .O(new_n184_));
  nand4  g122(.a(x35), .b(new_n84_), .c(x27), .d(new_n66_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n83_), .O(z18));
  nand2  g124(.a(new_n185_), .b(new_n136_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n135_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n132_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(x17), .c(x30), .O(z19));
  inv1   g128(.a(new_n133_), .O(new_n191_));
  oai21  g129(.a(new_n67_), .b(new_n65_), .c(new_n136_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n132_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(x17), .c(x30), .O(z20));
endmodule
