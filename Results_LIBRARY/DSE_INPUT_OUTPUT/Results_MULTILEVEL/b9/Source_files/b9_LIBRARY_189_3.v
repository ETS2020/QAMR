...
module FAU ( 
  ...
  nand2  g017(.a(x39), .b(x30), .O(new_n80_));
  ...
  oai21  g032(.a(new_n94_), .b(new_n91_), .c(new_n83_), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x39), .O(z02));
  ...
  nand4  g040(.a(new_n102_), .b(new_n98_), .c(new_n80_), .d(new_n99_), .O(z04));
  ...
  nand2  g056(.a(new_n118_), .b(new_n80_), .O(z07));
  nand3  g057(.a(x40), .b(x39), .c(new_n83_), .O(new_n120_));
  ...
  nand4  g076(.a(x35), .b(new_n85_), .c(x27), .d(new_n65_), .O(new_n139_));
  ...
  aoi22  g083(.a(new_n72_), .b(x27), .c(x40), .d(new_n65_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n83_), .O(new_n147_));
  ...
  nand4  g099(.a(x40), .b(x32), .c(new_n152_), .d(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n83_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x39), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z13));
  nand3  g103(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n166_));
  nand3  g104(.a(new_n154_), .b(new_n84_), .c(x28), .O(new_n167_));
  ...
  nand2  g110(.a(new_n172_), .b(new_n84_), .O(new_n173_));
  ...
  nor2   g114(.a(new_n123_), .b(new_n176_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x22), .c(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n80_), .O(z16));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(x23), .c(x22), .d(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n80_), .O(z17));
  oai21  g121(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n139_), .c(new_n83_), .d(new_n134_), .O(z18));
  nand2  g124(.a(new_n142_), .b(new_n80_), .O(z19));
  inv1   g125(.a(new_n135_), .O(new_n188_));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n83_), .c(new_n134_), .O(new_n192_));
