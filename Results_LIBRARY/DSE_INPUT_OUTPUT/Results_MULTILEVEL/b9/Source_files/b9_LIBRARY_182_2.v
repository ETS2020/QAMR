...
module FAU ( 
  ...
  nand2  g020(.a(x30), .b(x04), .O(z01));
  and2   g021(.a(x29), .b(x08), .O(new_n84_));
  oai21  g022(.a(new_n84_), .b(x02), .c(new_n76_), .O(new_n85_));
  nand2  g023(.a(new_n85_), .b(new_n81_), .O(new_n86_));
  inv1   g024(.a(x08), .O(new_n87_));
  nand2  g025(.a(new_n64_), .b(new_n87_), .O(new_n88_));
  nor2   g026(.a(new_n66_), .b(x28), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand3  g028(.a(new_n90_), .b(x30), .c(x04), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n86_), .O(z02));
  ...
  nand3  g038(.a(new_n100_), .b(new_n81_), .c(new_n70_), .O(z05));
  ...
  nand2  g051(.a(new_n81_), .b(new_n75_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n115_), .O(z09));
  oai21  g055(.a(new_n66_), .b(x28), .c(new_n67_), .O(new_n118_));
  ...
  nand2  g067(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x40), .c(x39), .O(new_n131_));
  nor2   g069(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n65_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n127_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(new_n84_), .b(new_n76_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n89_), .c(new_n88_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n80_), .c(new_n135_), .d(new_n65_), .O(new_n139_));
  ...
  oai21  g082(.a(new_n75_), .b(x04), .c(new_n144_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n143_), .c(new_n81_), .O(z12));
  ...
  nor2   g094(.a(new_n131_), .b(x13), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n65_), .c(new_n93_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(z13));
  nand3  g097(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n160_));
  nand4  g098(.a(new_n149_), .b(new_n129_), .c(new_n80_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand3  g100(.a(new_n76_), .b(new_n147_), .c(new_n65_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(x04), .c(new_n80_), .O(new_n167_));
  nand2  g105(.a(new_n163_), .b(new_n144_), .O(new_n168_));
  ...
  nand2  g115(.a(new_n76_), .b(x29), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n89_), .c(x08), .O(new_n180_));
  aoi21  g118(.a(new_n89_), .b(x27), .c(x30), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n135_), .d(new_n65_), .O(z18));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n87_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n179_), .c(new_n183_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n135_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n65_), .c(x30), .O(z20));
