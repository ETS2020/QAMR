...
module FAU ( 
  ...
  oai21  g23(.a(new_n86_), .b(new_n64_), .c(new_n65_), .O(new_n87_));
  nand2  g24(.a(new_n87_), .b(new_n69_), .O(z06));
  ...
  nand4  g51(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n86_), .O(new_n116_));
  nand3  g52(.a(new_n116_), .b(new_n72_), .c(new_n112_), .O(new_n117_));
  nand2  g53(.a(new_n117_), .b(new_n69_), .O(z11));
  nor2   g54(.a(new_n71_), .b(new_n67_), .O(z12));
  inv1   g55(.a(x19), .O(new_n120_));
  nand3  g56(.a(new_n67_), .b(x20), .c(new_n120_), .O(new_n121_));
  oai21  g57(.a(new_n121_), .b(x18), .c(new_n69_), .O(z13));
  nand2  g58(.a(new_n66_), .b(new_n65_), .O(new_n123_));
  nor2   g59(.a(x19), .b(x18), .O(new_n124_));
  nor2   g60(.a(new_n71_), .b(new_n64_), .O(new_n125_));
  nand4  g61(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(x20), .O(z14));
  inv1   g62(.a(x12), .O(new_n127_));
  nand4  g63(.a(new_n69_), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  ...
  nand3  g74(.a(new_n138_), .b(x35), .c(new_n86_), .O(new_n139_));
  nand4  g75(.a(new_n139_), .b(new_n69_), .c(new_n72_), .d(new_n112_), .O(z18));
  oai21  g76(.a(new_n114_), .b(new_n73_), .c(new_n69_), .O(new_n141_));
  nand3  g77(.a(new_n141_), .b(new_n113_), .c(new_n86_), .O(new_n142_));
  nand3  g78(.a(new_n142_), .b(new_n72_), .c(new_n112_), .O(new_n143_));
  nand2  g79(.a(new_n143_), .b(new_n69_), .O(z19));
  oai21  g80(.a(x28), .b(new_n136_), .c(new_n64_), .O(new_n145_));
  nand2  g81(.a(new_n145_), .b(x35), .O(new_n146_));
  nand4  g82(.a(new_n146_), .b(new_n69_), .c(new_n72_), .d(new_n112_), .O(new_n147_));
