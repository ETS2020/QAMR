...
module FAU ( 
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n73_), .d(x32), .O(z02));
  oai21  g033(.a(new_n66_), .b(new_n84_), .c(x27), .O(new_n96_));
  inv1   g034(.a(x37), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n64_), .c(new_n79_), .O(new_n98_));
  ...
  nand3  g053(.a(new_n115_), .b(new_n102_), .c(x03), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z07));
  nand3  g055(.a(x40), .b(x39), .c(x32), .O(new_n118_));
  ...
  nand4  g060(.a(new_n86_), .b(new_n72_), .c(x27), .d(x07), .O(new_n123_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n102_), .O(z10));
  inv1   g066(.a(x08), .O(new_n129_));
  inv1   g067(.a(x09), .O(new_n130_));
  nand4  g068(.a(new_n82_), .b(new_n130_), .c(new_n129_), .d(x04), .O(new_n131_));
  ...
  oai21  g074(.a(new_n85_), .b(new_n64_), .c(new_n129_), .O(new_n137_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n102_), .O(z12));
  ...
  nand3  g088(.a(x39), .b(new_n150_), .c(new_n65_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x32), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x40), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n149_), .O(z13));
  nand4  g092(.a(x27), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(new_n70_), .O(new_n156_));
  aoi21  g094(.a(new_n152_), .b(x40), .c(new_n156_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  nor2   g096(.a(new_n121_), .b(new_n158_), .O(z15));
  inv1   g097(.a(x23), .O(new_n160_));
  nand4  g098(.a(new_n102_), .b(new_n160_), .c(x22), .d(x01), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x23), .c(x22), .d(x01), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n102_), .O(z17));
  oai21  g103(.a(new_n85_), .b(x27), .c(new_n134_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand4  g105(.a(x35), .b(new_n84_), .c(x27), .d(new_n65_), .O(new_n168_));
  nor2   g106(.a(new_n79_), .b(x30), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n130_), .O(z18));
  nand2  g108(.a(new_n168_), .b(new_n129_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n136_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n82_), .c(new_n130_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n102_), .O(z19));
  inv1   g112(.a(new_n134_), .O(new_n175_));
  oai21  g113(.a(new_n66_), .b(new_n64_), .c(new_n129_), .O(new_n176_));
  aoi21  g114(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n175_), .c(new_n176_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n82_), .c(new_n130_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n102_), .O(z20));
endmodule
