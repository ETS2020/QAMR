...
module FAU ( 
  ...
  nand3  g029(.a(new_n91_), .b(x35), .c(new_n82_), .O(new_n92_));
  ...
  aoi21  g034(.a(new_n65_), .b(new_n90_), .c(new_n96_), .O(new_n97_));
  ...
  nor2   g069(.a(new_n90_), .b(new_n71_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n83_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(x40), .b(x04), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(x35), .c(new_n82_), .d(x27), .O(new_n135_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n90_), .c(new_n73_), .O(new_n141_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n90_), .O(new_n151_));
  ...
  nand2  g111(.a(new_n90_), .b(x08), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(new_n159_), .O(new_n175_));
  nand2  g113(.a(new_n79_), .b(new_n130_), .O(new_n176_));
  aoi21  g114(.a(new_n175_), .b(new_n82_), .c(new_n176_), .O(new_n177_));
  nand3  g115(.a(z08), .b(x29), .c(x08), .O(new_n178_));
  oai21  g116(.a(new_n177_), .b(new_n96_), .c(new_n178_), .O(z18));
  oai21  g117(.a(new_n132_), .b(x28), .c(new_n131_), .O(new_n180_));
  aoi21  g118(.a(x40), .b(new_n63_), .c(x27), .O(new_n181_));
  nand2  g119(.a(x39), .b(new_n159_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n134_), .c(new_n82_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n89_), .O(new_n184_));
  oai21  g122(.a(new_n63_), .b(x29), .c(x40), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n159_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n184_), .c(new_n180_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n79_), .c(new_n130_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n64_), .O(z19));
  oai21  g127(.a(new_n82_), .b(x27), .c(x35), .O(new_n190_));
  and2   g128(.a(new_n190_), .b(new_n185_), .O(new_n191_));
  nand2  g129(.a(new_n64_), .b(new_n90_), .O(new_n192_));
  aoi21  g130(.a(new_n182_), .b(new_n192_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n79_), .O(new_n194_));
