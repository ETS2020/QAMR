...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n194_;
  nor2   g000(.a(x10), .b(x06), .O(new_n63_));
  ...
  nand4  g012(.a(new_n74_), .b(x40), .c(x39), .d(new_n64_), .O(new_n75_));
  oai22  g013(.a(new_n75_), .b(x04), .c(new_n70_), .d(new_n63_), .O(z00));
  inv1   g014(.a(x30), .O(new_n77_));
  inv1   g015(.a(x32), .O(new_n78_));
  inv1   g016(.a(x35), .O(new_n79_));
  inv1   g017(.a(x36), .O(new_n80_));
  oai21  g018(.a(new_n79_), .b(x28), .c(new_n80_), .O(new_n81_));
  ...
  nor2   g025(.a(new_n79_), .b(x28), .O(new_n88_));
  ...
  aoi21  g029(.a(new_n91_), .b(new_n87_), .c(new_n63_), .O(z02));
  ...
  nand3  g036(.a(new_n98_), .b(new_n93_), .c(new_n97_), .O(z04));
  inv1   g037(.a(x28), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n66_), .O(new_n101_));
  inv1   g039(.a(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n97_), .c(new_n67_), .O(z05));
  oai21  g041(.a(new_n101_), .b(x37), .c(new_n97_), .O(z06));
  ...
  nand3  g063(.a(new_n125_), .b(new_n81_), .c(x27), .O(new_n126_));
  nand2  g064(.a(new_n78_), .b(new_n77_), .O(new_n127_));
  ...
  nand3  g073(.a(new_n135_), .b(x35), .c(new_n100_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n100_), .c(x27), .d(new_n122_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(x08), .c(new_n137_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n97_), .c(new_n77_), .d(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  oai21  g080(.a(new_n90_), .b(x04), .c(new_n68_), .O(new_n143_));
  nand3  g081(.a(new_n80_), .b(new_n79_), .c(new_n72_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n143_), .c(x37), .O(new_n145_));
  nor2   g083(.a(x27), .b(x10), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x06), .O(new_n147_));
  inv1   g085(.a(new_n69_), .O(new_n148_));
  inv1   g086(.a(new_n90_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n122_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(x10), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n147_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n118_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n153_), .d(new_n122_), .O(new_n156_));
  inv1   g094(.a(x18), .O(new_n157_));
  inv1   g095(.a(x19), .O(new_n158_));
  nand2  g096(.a(new_n68_), .b(new_n67_), .O(new_n159_));
  ...
  nand3  g100(.a(new_n127_), .b(x40), .c(x39), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n122_), .c(new_n63_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(z13));
  nand3  g104(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n167_));
  nand4  g105(.a(new_n154_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n149_), .b(new_n153_), .c(new_n122_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .O(new_n171_));
  nand3  g109(.a(new_n67_), .b(new_n79_), .c(x28), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(x27), .c(x32), .O(new_n173_));
  aoi22  g111(.a(new_n173_), .b(new_n77_), .c(new_n170_), .d(new_n148_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(new_n63_), .O(z14));
  nand4  g113(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n97_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand4  g116(.a(new_n97_), .b(new_n178_), .c(x22), .d(x01), .O(new_n179_));
  inv1   g117(.a(new_n179_), .O(z16));
  inv1   g118(.a(x01), .O(new_n181_));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n97_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n181_), .O(z17));
  nand2  g122(.a(new_n88_), .b(new_n66_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n134_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n139_), .b(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n97_), .d(new_n133_), .O(z18));
  inv1   g127(.a(new_n134_), .O(new_n190_));
  nor2   g128(.a(new_n79_), .b(new_n66_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n66_), .c(new_n79_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .d(x08), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n97_), .c(new_n77_), .d(new_n133_), .O(new_n194_));
  inv1   g132(.a(new_n194_), .O(z20));
  inv1   g133(.a(new_n141_), .O(z19));
endmodule
