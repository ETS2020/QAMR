...
module FAU ( 
  ...
  nand2  g017(.a(x40), .b(x13), .O(new_n80_));
  ...
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n76_), .d(new_n92_), .O(z02));
  ...
  nand3  g056(.a(x40), .b(x39), .c(new_n92_), .O(new_n119_));
  ...
  nand4  g072(.a(new_n84_), .b(new_n134_), .c(new_n133_), .d(x04), .O(new_n135_));
  ...
  oai21  g078(.a(new_n87_), .b(new_n64_), .c(new_n133_), .O(new_n141_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n147_), .c(new_n80_), .O(z12));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x40), .c(x39), .d(new_n65_), .O(new_n152_));
  ...
  nand3  g095(.a(new_n127_), .b(x39), .c(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n92_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x40), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  nand4  g099(.a(x27), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n73_), .c(new_n75_), .d(x04), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n164_));
  nor2   g102(.a(x37), .b(x35), .O(new_n165_));
  aoi21  g103(.a(new_n164_), .b(new_n150_), .c(new_n165_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n86_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n85_), .c(new_n84_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n163_), .c(new_n80_), .O(z14));
  nand4  g107(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n80_), .O(z15));
  inv1   g109(.a(x23), .O(new_n172_));
  nand4  g110(.a(new_n80_), .b(new_n172_), .c(x22), .d(x01), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z16));
  inv1   g112(.a(x24), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(x23), .c(x22), .d(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n80_), .O(z17));
  oai21  g115(.a(new_n87_), .b(x27), .c(new_n138_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nor2   g117(.a(new_n83_), .b(x09), .O(new_n180_));
  nand4  g118(.a(x35), .b(new_n86_), .c(x27), .d(new_n65_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n84_), .O(z18));
  nand2  g120(.a(new_n181_), .b(new_n133_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n140_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n84_), .c(new_n134_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n80_), .O(z19));
  inv1   g124(.a(new_n138_), .O(new_n187_));
  oai21  g125(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n84_), .c(new_n134_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n80_), .O(z20));
endmodule
