...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x30), .O(new_n63_));
  ...
  oai21  g025(.a(new_n87_), .b(new_n83_), .c(new_n82_), .O(new_n88_));
  ...
  aoi21  g080(.a(new_n142_), .b(x34), .c(x30), .O(z11));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n63_), .O(z12));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n66_), .c(new_n63_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n162_));
  nand3  g100(.a(new_n77_), .b(new_n150_), .c(new_n66_), .O(new_n163_));
  and2   g101(.a(new_n163_), .b(new_n90_), .O(new_n164_));
  inv1   g102(.a(x32), .O(new_n165_));
  nand4  g103(.a(new_n151_), .b(x34), .c(new_n165_), .d(new_n82_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n84_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n164_), .c(new_n162_), .O(new_n168_));
  nand3  g106(.a(new_n71_), .b(new_n67_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n165_), .c(new_n82_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  and2   g110(.a(new_n163_), .b(new_n147_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(x34), .O(new_n174_));
  ...
  nand2  g118(.a(new_n180_), .b(new_n90_), .O(z16));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(x23), .c(x22), .d(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n90_), .O(z17));
  oai21  g122(.a(new_n85_), .b(x27), .c(new_n134_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nand4  g124(.a(x35), .b(new_n84_), .c(x27), .d(new_n66_), .O(new_n187_));
  nor2   g125(.a(new_n83_), .b(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n133_), .O(z18));
  nand2  g127(.a(new_n187_), .b(new_n137_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n136_), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(x34), .c(new_n82_), .d(new_n133_), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(z19));
  inv1   g131(.a(new_n134_), .O(new_n194_));
  oai21  g132(.a(new_n67_), .b(new_n65_), .c(new_n137_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n195_), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(x34), .c(new_n82_), .d(new_n133_), .O(new_n198_));
