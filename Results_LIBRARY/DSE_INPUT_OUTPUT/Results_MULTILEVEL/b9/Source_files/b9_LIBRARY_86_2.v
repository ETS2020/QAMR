...
module FAU ( 
  ...
  nor2   g013(.a(x19), .b(new_n63_), .O(new_n76_));
  nor2   g014(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g015(.a(new_n77_), .b(new_n74_), .O(z00));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n90_), .c(new_n76_), .O(z02));
  ...
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n79_), .O(z10));
  ...
  nand3  g077(.a(new_n92_), .b(x27), .c(new_n65_), .O(new_n140_));
  ...
  oai22  g085(.a(new_n91_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n148_));
  ...
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n154_), .O(new_n158_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n76_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z13));
  aoi21  g102(.a(x20), .b(new_n154_), .c(x15), .O(new_n165_));
  nand4  g103(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand4  g105(.a(x40), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n168_));
  ...
  nand2  g112(.a(new_n174_), .b(new_n63_), .O(new_n175_));
  nand4  g113(.a(new_n81_), .b(new_n80_), .c(new_n64_), .d(x19), .O(new_n176_));
  ...
  nand4  g118(.a(new_n79_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  inv1   g119(.a(new_n181_), .O(z16));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(x23), .c(x22), .d(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n79_), .O(z17));
  oai21  g123(.a(new_n83_), .b(x27), .c(new_n136_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n76_), .b(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n140_), .d(new_n80_), .O(z18));
  ...
  nand3  g131(.a(new_n193_), .b(new_n80_), .c(new_n135_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n79_), .O(z20));
  nand2  g133(.a(new_n143_), .b(new_n79_), .O(z19));
endmodule
