...
module FAU ( 
  ...
  nand2  g031(.a(new_n93_), .b(x33), .O(new_n94_));
  ...
  nor2   g039(.a(new_n82_), .b(new_n68_), .O(new_n102_));
  ...
  nand3  g046(.a(new_n108_), .b(new_n106_), .c(new_n63_), .O(new_n109_));
  ...
  aoi21  g054(.a(new_n116_), .b(x33), .c(new_n74_), .O(z08));
  ...
  aoi21  g084(.a(x39), .b(new_n121_), .c(new_n71_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x33), .O(new_n148_));
  ...
  nand4  g100(.a(new_n128_), .b(x33), .c(new_n151_), .d(new_n121_), .O(new_n163_));
  ...
  nand3  g104(.a(x39), .b(new_n151_), .c(new_n121_), .O(new_n167_));
  ...
  nand2  g112(.a(new_n174_), .b(x33), .O(new_n175_));
  ...
  inv1   g129(.a(new_n123_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x33), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n89_), .c(new_n191_), .d(new_n65_), .O(z18));
  nand2  g132(.a(x40), .b(x04), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(x35), .c(new_n82_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(x33), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n134_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n141_), .c(new_n79_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z19));
  nor2   g138(.a(new_n144_), .b(new_n68_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n68_), .c(new_n144_), .O(new_n202_));
  nand2  g140(.a(new_n192_), .b(x29), .O(new_n203_));
  inv1   g141(.a(new_n203_), .O(new_n204_));
  oai22  g142(.a(new_n204_), .b(new_n202_), .c(new_n201_), .d(x08), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n79_), .c(new_n189_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n64_), .O(z20));
endmodule
