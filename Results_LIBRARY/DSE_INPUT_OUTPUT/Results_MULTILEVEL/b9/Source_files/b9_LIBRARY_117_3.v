...
module FAU ( 
  ...
  nand2  g000(.a(x40), .b(x00), .O(new_n63_));
  ...
  oai22  g015(.a(new_n77_), .b(x00), .c(new_n71_), .d(new_n64_), .O(z00));
  ...
  oai21  g043(.a(x25), .b(new_n86_), .c(x38), .O(new_n106_));
  nand3  g044(.a(new_n106_), .b(new_n105_), .c(new_n104_), .O(new_n107_));
  inv1   g045(.a(x25), .O(new_n108_));
  nand3  g046(.a(x38), .b(new_n108_), .c(new_n86_), .O(new_n109_));
  ...
  aoi21  g051(.a(new_n92_), .b(new_n86_), .c(new_n74_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n115_), .O(z09));
  nor2   g055(.a(new_n82_), .b(x36), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand3  g057(.a(x40), .b(x39), .c(x05), .O(new_n120_));
  oai21  g058(.a(x39), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n86_), .O(new_n122_));
  nand2  g060(.a(new_n74_), .b(x07), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n118_), .O(new_n124_));
  nand3  g062(.a(new_n63_), .b(x37), .c(x06), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n124_), .b(new_n72_), .c(new_n126_), .O(new_n127_));
  oai21  g065(.a(x32), .b(x30), .c(x40), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n92_), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(x05), .c(new_n72_), .d(new_n86_), .O(new_n130_));
  oai21  g068(.a(new_n127_), .b(new_n67_), .c(new_n130_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nor2   g070(.a(new_n64_), .b(x27), .O(new_n133_));
  nand2  g071(.a(new_n82_), .b(new_n72_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n86_), .c(new_n133_), .O(new_n135_));
  aoi21  g073(.a(x39), .b(x29), .c(x00), .O(new_n136_));
  ...
  nand3  g081(.a(new_n68_), .b(new_n143_), .c(new_n81_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n72_), .c(new_n70_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n86_), .O(new_n147_));
  oai21  g085(.a(new_n70_), .b(x40), .c(new_n147_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n152_), .c(x00), .O(new_n157_));
  nand4  g095(.a(new_n155_), .b(new_n74_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand4  g098(.a(new_n129_), .b(new_n149_), .c(new_n72_), .d(new_n86_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n93_), .b(new_n149_), .c(new_n72_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n68_), .b(new_n81_), .c(x28), .O(new_n168_));
  ...
  aoi21  g109(.a(new_n166_), .b(new_n171_), .c(new_n64_), .O(new_n172_));
  ...
  nand2  g120(.a(new_n82_), .b(new_n67_), .O(new_n183_));
  nand2  g121(.a(new_n93_), .b(x29), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n64_), .b(x09), .O(new_n187_));
  nand3  g125(.a(new_n82_), .b(x27), .c(new_n72_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n79_), .O(z18));
  nand2  g127(.a(new_n184_), .b(new_n138_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  nand2  g129(.a(new_n188_), .b(new_n191_), .O(new_n192_));
  ...
  inv1   g133(.a(new_n184_), .O(new_n196_));
  oai21  g134(.a(new_n81_), .b(new_n67_), .c(new_n191_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n67_), .c(new_n81_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n79_), .c(new_n132_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n63_), .O(z20));
endmodule
