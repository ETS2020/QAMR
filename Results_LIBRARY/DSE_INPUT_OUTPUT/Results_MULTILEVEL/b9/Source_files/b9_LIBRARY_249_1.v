...
module FAU ( 
  ...
  nor3   g022(.a(new_n84_), .b(x32), .c(new_n67_), .O(new_n85_));
  ...
  nand4  g062(.a(new_n78_), .b(x30), .c(x05), .d(new_n68_), .O(new_n125_));
  ...
  nand3  g070(.a(new_n90_), .b(x27), .c(new_n68_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n120_), .c(new_n63_), .d(new_n127_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n67_), .c(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n75_), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n114_), .b(x04), .c(new_n141_), .O(new_n142_));
  ...
  nand4  g085(.a(new_n147_), .b(x39), .c(new_n144_), .d(new_n68_), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nand4  g088(.a(new_n75_), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n148_), .c(x32), .O(new_n152_));
  nand4  g090(.a(new_n75_), .b(x30), .c(x20), .d(new_n150_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x18), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(x27), .O(new_n155_));
  nand4  g093(.a(new_n78_), .b(x30), .c(new_n144_), .d(new_n68_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n158_));
  nand3  g096(.a(new_n78_), .b(new_n144_), .c(new_n68_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n64_), .O(new_n160_));
  nand4  g098(.a(new_n146_), .b(new_n120_), .c(new_n63_), .d(x28), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  nand3  g101(.a(new_n73_), .b(new_n69_), .c(x28), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(x27), .c(x30), .O(new_n165_));
  nand3  g103(.a(new_n159_), .b(new_n73_), .c(new_n83_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(new_n120_), .O(new_n168_));
  nand3  g106(.a(new_n159_), .b(new_n141_), .c(x30), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n168_), .c(new_n163_), .O(z14));
  ...
  nand2  g117(.a(new_n90_), .b(new_n67_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n128_), .c(new_n132_), .O(new_n181_));
  nand2  g119(.a(new_n133_), .b(new_n127_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(new_n120_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n63_), .O(z18));
  inv1   g122(.a(new_n128_), .O(new_n185_));
  oai21  g123(.a(new_n69_), .b(new_n67_), .c(new_n132_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n120_), .c(new_n63_), .d(new_n127_), .O(new_n189_));
