...
module FAU ( 
  ...
  oai21  g024(.a(new_n65_), .b(x04), .c(new_n86_), .O(z01));
  ...
  nand2  g062(.a(new_n117_), .b(x07), .O(new_n125_));
  ...
  inv1   g066(.a(new_n117_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(x30), .c(x05), .O(new_n130_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n124_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(new_n129_), .b(x29), .O(new_n136_));
  ...
  nand2  g080(.a(x27), .b(new_n73_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n83_), .c(new_n142_), .O(new_n144_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n63_), .c(new_n80_), .O(new_n153_));
  ...
  oai21  g102(.a(new_n63_), .b(new_n79_), .c(new_n80_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n155_), .d(new_n73_), .O(new_n166_));
  ...
  aoi21  g125(.a(new_n187_), .b(new_n143_), .c(new_n137_), .O(new_n188_));
  nand2  g126(.a(new_n79_), .b(new_n135_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n82_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n65_), .c(new_n117_), .d(new_n89_), .O(z18));
  nand2  g129(.a(new_n64_), .b(new_n68_), .O(new_n192_));
  nand3  g130(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n193_));
  ...
  aoi22  g135(.a(new_n197_), .b(new_n95_), .c(new_n139_), .d(new_n138_), .O(new_n198_));
  ...
  oai21  g139(.a(new_n137_), .b(new_n68_), .c(new_n142_), .O(new_n202_));
