...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x11), .O(new_n81_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n81_), .d(new_n76_), .O(z02));
  ...
  nand4  g056(.a(x33), .b(x27), .c(x26), .d(x11), .O(new_n119_));
  ...
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n83_), .O(z10));
  ...
  nand2  g079(.a(new_n141_), .b(new_n81_), .O(z11));
  ...
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n83_), .O(z12));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n158_), .c(new_n83_), .O(z13));
  nand3  g098(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n161_));
  nand4  g099(.a(new_n151_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n162_));
  ...
  aoi21  g106(.a(new_n164_), .b(new_n146_), .c(new_n83_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n168_), .c(new_n165_), .O(z14));
  nand4  g108(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n81_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand4  g111(.a(new_n81_), .b(new_n173_), .c(x22), .d(x01), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(z16));
  inv1   g113(.a(x01), .O(new_n176_));
  inv1   g114(.a(x24), .O(new_n177_));
  nand4  g115(.a(new_n81_), .b(new_n177_), .c(x23), .d(x22), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n176_), .O(z17));
  oai21  g117(.a(new_n87_), .b(x27), .c(new_n134_), .O(new_n180_));
  nand3  g118(.a(new_n138_), .b(new_n84_), .c(new_n133_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(x08), .c(new_n181_), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n83_), .O(z18));
  nand4  g121(.a(new_n140_), .b(new_n81_), .c(new_n84_), .d(new_n133_), .O(new_n184_));
  ...
  nand3  g127(.a(new_n189_), .b(new_n84_), .c(new_n133_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n81_), .O(z20));
endmodule
