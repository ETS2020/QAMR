...
module FAU ( 
  ...
  aoi21  g17(.a(new_n65_), .b(new_n64_), .c(z08), .O(new_n80_));
  ...
  oai21  g22(.a(new_n84_), .b(new_n64_), .c(new_n65_), .O(new_n85_));
  ...
  nand2  g50(.a(new_n64_), .b(new_n112_), .O(new_n113_));
  ...
  nor2   g54(.a(z08), .b(new_n67_), .O(z12));
  ...
  nand2  g70(.a(x27), .b(new_n104_), .O(new_n133_));
  oai21  g71(.a(x27), .b(new_n112_), .c(new_n133_), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(x35), .c(new_n84_), .O(new_n135_));
  nor2   g73(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g74(.a(new_n136_), .b(new_n135_), .c(z08), .O(z18));
  nand3  g75(.a(new_n114_), .b(new_n71_), .c(new_n110_), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(z02), .O(z19));
  oai21  g77(.a(x28), .b(new_n112_), .c(new_n64_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(x35), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n71_), .c(new_n110_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(z02), .O(z20));
endmodule
