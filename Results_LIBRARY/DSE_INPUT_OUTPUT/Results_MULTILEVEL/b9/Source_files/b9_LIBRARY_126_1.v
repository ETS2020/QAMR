...
module FAU ( 
  ...
  oai21  g004(.a(new_n66_), .b(new_n65_), .c(x05), .O(new_n67_));
  ...
  nor2   g016(.a(new_n78_), .b(x05), .O(new_n79_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n69_), .c(new_n79_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n89_), .c(new_n69_), .O(new_n104_));
  ...
  nand2  g054(.a(new_n89_), .b(new_n66_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n89_), .O(z09));
  nand3  g057(.a(new_n89_), .b(x37), .c(x06), .O(new_n120_));
  inv1   g058(.a(x05), .O(new_n121_));
  aoi21  g059(.a(x40), .b(x39), .c(x07), .O(new_n122_));
  nand3  g060(.a(new_n66_), .b(new_n78_), .c(x07), .O(new_n123_));
  oai21  g061(.a(new_n122_), .b(new_n121_), .c(new_n123_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n84_), .c(new_n63_), .O(new_n125_));
  ...
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n63_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n127_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nor2   g072(.a(new_n97_), .b(new_n63_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n83_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n82_), .c(x27), .d(new_n63_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n80_), .c(new_n133_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n89_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n97_), .c(new_n78_), .O(new_n144_));
  nand2  g082(.a(new_n74_), .b(new_n69_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n66_), .b(x04), .c(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n144_), .c(new_n89_), .O(z12));
  ...
  nand3  g096(.a(new_n130_), .b(new_n149_), .c(new_n63_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n158_), .c(new_n79_), .O(z13));
  nand3  g098(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n161_));
  nand4  g099(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  nand3  g101(.a(new_n88_), .b(new_n149_), .c(new_n63_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(new_n161_), .O(new_n165_));
  nand3  g103(.a(new_n69_), .b(new_n70_), .c(x28), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(x27), .c(x32), .O(new_n167_));
  aoi22  g105(.a(new_n167_), .b(new_n80_), .c(new_n164_), .d(new_n146_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n165_), .c(new_n79_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  nand4  g108(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(new_n170_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x22), .c(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n89_), .O(z16));
  inv1   g113(.a(x01), .O(new_n176_));
  inv1   g114(.a(x24), .O(new_n177_));
  nand4  g115(.a(new_n89_), .b(new_n177_), .c(x23), .d(x22), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n176_), .O(z17));
  oai21  g117(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n180_));
  nand3  g118(.a(new_n138_), .b(new_n80_), .c(new_n133_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(x08), .c(new_n181_), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n79_), .O(z18));
  oai21  g121(.a(new_n70_), .b(new_n97_), .c(new_n137_), .O(new_n184_));
  nand2  g122(.a(new_n134_), .b(new_n70_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(new_n79_), .O(new_n186_));
  ...
  oai21  g129(.a(new_n191_), .b(x09), .c(new_n89_), .O(z19));
  aoi21  g130(.a(x28), .b(new_n97_), .c(new_n70_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n187_), .c(new_n184_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n89_), .c(new_n80_), .d(new_n133_), .O(new_n195_));
