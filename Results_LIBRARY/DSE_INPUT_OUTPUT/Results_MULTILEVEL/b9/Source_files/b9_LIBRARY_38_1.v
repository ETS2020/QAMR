...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(x34), .O(z02));
  nand2  g034(.a(new_n70_), .b(x27), .O(new_n97_));
  aoi21  g035(.a(new_n69_), .b(new_n68_), .c(new_n65_), .O(new_n98_));
  ...
  aoi21  g055(.a(new_n117_), .b(x34), .c(new_n74_), .O(z08));
  ...
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x34), .O(new_n148_));
  ...
  nand4  g099(.a(new_n127_), .b(x34), .c(new_n150_), .d(new_n121_), .O(new_n162_));
  ...
  nand3  g104(.a(new_n95_), .b(new_n150_), .c(new_n121_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n69_), .b(new_n144_), .c(x28), .O(new_n169_));
  ...
  oai22  g121(.a(new_n94_), .b(new_n90_), .c(new_n83_), .d(x27), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n68_), .b(x04), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n137_), .c(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n185_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g126(.a(x09), .O(new_n189_));
  nand2  g127(.a(new_n144_), .b(x34), .O(new_n190_));
  nand2  g128(.a(x40), .b(x04), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n190_), .c(new_n82_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n133_), .c(new_n89_), .O(new_n193_));
  nand3  g131(.a(new_n190_), .b(new_n140_), .c(new_n82_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n138_), .O(new_n195_));
  nand2  g133(.a(new_n140_), .b(new_n137_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n74_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n195_), .c(new_n193_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n189_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n64_), .O(z19));
  aoi21  g138(.a(x28), .b(new_n68_), .c(new_n144_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(new_n139_), .O(new_n202_));
  aoi21  g140(.a(new_n190_), .b(new_n134_), .c(x08), .O(new_n203_));
