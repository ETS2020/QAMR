...
module FAU ( 
  ...
  nand3  g044(.a(new_n106_), .b(new_n65_), .c(new_n66_), .O(z05));
  ...
  nand3  g050(.a(new_n112_), .b(new_n110_), .c(new_n63_), .O(new_n113_));
  ...
  nand3  g057(.a(new_n116_), .b(x33), .c(new_n114_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n119_), .c(new_n109_), .O(z07));
  inv1   g059(.a(x39), .O(new_n122_));
  nor2   g060(.a(new_n64_), .b(new_n122_), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n65_), .O(z08));
  ...
  nand2  g067(.a(x40), .b(new_n122_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n96_), .c(new_n129_), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x05), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n131_), .c(new_n85_), .O(new_n134_));
  nand3  g072(.a(new_n65_), .b(x37), .c(x06), .O(new_n135_));
  ...
  nor2   g076(.a(new_n138_), .b(new_n122_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x05), .c(new_n72_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(z10));
  nand2  g079(.a(new_n65_), .b(new_n100_), .O(new_n142_));
  oai21  g080(.a(new_n84_), .b(x04), .c(x40), .O(new_n143_));
  ...
  and2   g085(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  nand2  g086(.a(x27), .b(x04), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n145_), .c(new_n148_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n144_), .c(new_n80_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(x09), .O(z11));
  nor3   g090(.a(x37), .b(x36), .c(x35), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n100_), .c(new_n74_), .O(new_n154_));
  oai21  g092(.a(new_n124_), .b(x04), .c(new_n69_), .O(new_n155_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n160_), .c(new_n64_), .O(new_n164_));
  nand4  g102(.a(new_n68_), .b(x33), .c(x20), .d(new_n162_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n139_), .b(new_n157_), .c(new_n72_), .O(new_n168_));
  ...
  nand3  g110(.a(new_n123_), .b(new_n157_), .c(new_n72_), .O(new_n173_));
  ...
  aoi21  g116(.a(new_n173_), .b(new_n69_), .c(new_n79_), .O(new_n179_));
  ...
  nand2  g130(.a(new_n80_), .b(new_n192_), .O(new_n193_));
  aoi21  g131(.a(new_n191_), .b(new_n83_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n79_), .c(new_n124_), .d(new_n90_), .O(z18));
  inv1   g133(.a(x08), .O(new_n196_));
  oai21  g134(.a(new_n175_), .b(x04), .c(x40), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n142_), .c(new_n83_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n196_), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n175_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n149_), .c(new_n83_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n146_), .O(new_n202_));
  nand2  g140(.a(new_n175_), .b(x33), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n149_), .c(new_n83_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n64_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n202_), .c(new_n199_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n80_), .c(new_n192_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n65_), .O(z19));
  aoi21  g146(.a(x28), .b(new_n100_), .c(new_n175_), .O(new_n209_));
  nor2   g147(.a(new_n209_), .b(new_n148_), .O(new_n210_));
  aoi21  g148(.a(new_n200_), .b(new_n142_), .c(x08), .O(new_n211_));
  oai21  g149(.a(new_n211_), .b(new_n210_), .c(new_n80_), .O(new_n212_));
