...
module FAU ( 
  ...
  nand4  g030(.a(new_n92_), .b(new_n90_), .c(new_n88_), .d(new_n63_), .O(z02));
  nand2  g031(.a(new_n65_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x27), .O(new_n95_));
  nand2  g033(.a(new_n64_), .b(new_n95_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n63_), .d(x21), .O(z03));
  inv1   g035(.a(new_n63_), .O(new_n98_));
  aoi21  g036(.a(new_n64_), .b(new_n95_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n98_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n64_), .c(new_n98_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n63_), .c(new_n64_), .O(new_n103_));
  ...
  oai21  g059(.a(new_n64_), .b(new_n95_), .c(new_n121_), .O(new_n122_));
  ...
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n152_), .d(new_n124_), .O(new_n156_));
  ...
  nand3  g099(.a(new_n131_), .b(new_n152_), .c(new_n124_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n98_), .O(z13));
  nand3  g101(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n164_));
  nand4  g102(.a(new_n154_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n92_), .b(new_n152_), .c(new_n124_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  inv1   g106(.a(x35), .O(new_n169_));
  nand3  g107(.a(new_n64_), .b(new_n169_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n78_), .c(new_n77_), .O(new_n172_));
  aoi21  g110(.a(new_n167_), .b(new_n67_), .c(new_n98_), .O(new_n173_));
  ...
  oai21  g120(.a(new_n81_), .b(x27), .c(new_n137_), .O(new_n183_));
  nand3  g121(.a(new_n141_), .b(new_n77_), .c(new_n136_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(x08), .c(new_n184_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n98_), .O(z18));
  nand3  g124(.a(new_n143_), .b(new_n77_), .c(new_n136_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n63_), .O(z19));
  inv1   g126(.a(new_n137_), .O(new_n189_));
  oai21  g127(.a(new_n169_), .b(new_n95_), .c(new_n140_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n95_), .c(new_n169_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n77_), .c(new_n136_), .O(new_n193_));
