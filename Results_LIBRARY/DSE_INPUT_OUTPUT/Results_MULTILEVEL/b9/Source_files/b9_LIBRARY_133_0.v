...
module FAU ( 
  ...
  nand2  g034(.a(new_n76_), .b(x31), .O(new_n97_));
  ...
  nand4  g052(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n81_), .O(new_n115_));
  ...
  nand3  g059(.a(new_n118_), .b(x31), .c(new_n116_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n121_), .c(new_n110_), .O(z07));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n97_), .c(new_n126_), .O(new_n128_));
  ...
  nand3  g083(.a(new_n141_), .b(x27), .c(new_n65_), .O(new_n146_));
  ...
  nand3  g093(.a(new_n155_), .b(new_n76_), .c(x31), .O(new_n156_));
  ...
  nand4  g103(.a(new_n72_), .b(x31), .c(x20), .d(new_n163_), .O(new_n166_));
  ...
  nand3  g111(.a(z08), .b(new_n158_), .c(new_n65_), .O(new_n174_));
  ...
  aoi21  g116(.a(new_n174_), .b(new_n155_), .c(new_n99_), .O(new_n179_));
  ...
  oai21  g127(.a(new_n87_), .b(x27), .c(new_n140_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n99_), .b(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n191_), .c(new_n146_), .d(new_n139_), .O(z18));
  nand2  g131(.a(new_n82_), .b(new_n64_), .O(new_n194_));
  oai21  g132(.a(new_n87_), .b(x04), .c(x40), .O(new_n195_));
  ...
  aoi22  g136(.a(new_n198_), .b(new_n97_), .c(new_n142_), .d(new_n141_), .O(new_n199_));
  ...
  oai21  g140(.a(new_n66_), .b(new_n64_), .c(new_n145_), .O(new_n203_));
  aoi21  g141(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n203_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n84_), .c(new_n139_), .O(new_n206_));
