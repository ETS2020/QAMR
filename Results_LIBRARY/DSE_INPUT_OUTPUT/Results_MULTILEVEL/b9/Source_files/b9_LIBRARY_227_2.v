...
module FAU ( 
  ...
  nand3  g079(.a(new_n141_), .b(new_n83_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n81_), .O(z11));
  ...
  nand3  g086(.a(new_n148_), .b(new_n80_), .c(new_n113_), .O(new_n149_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n98_), .O(new_n162_));
  ...
  aoi21  g109(.a(new_n167_), .b(new_n148_), .c(new_n98_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n168_), .O(z14));
  inv1   g111(.a(x12), .O(new_n174_));
  nand4  g112(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n174_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand4  g115(.a(new_n81_), .b(new_n177_), .c(x22), .d(x01), .O(new_n178_));
  ...
  oai21  g121(.a(new_n86_), .b(x27), .c(new_n134_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n98_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n139_), .d(new_n133_), .O(z18));
  nand2  g125(.a(new_n81_), .b(new_n64_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n189_));
