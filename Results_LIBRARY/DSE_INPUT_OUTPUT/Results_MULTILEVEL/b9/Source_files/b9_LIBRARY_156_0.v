...
module FAU ( 
  ...
  nor2   g017(.a(x40), .b(x14), .O(new_n80_));
  ...
  nand2  g071(.a(new_n81_), .b(new_n64_), .O(new_n134_));
  oai21  g072(.a(new_n86_), .b(x04), .c(x40), .O(new_n135_));
  ...
  nand2  g078(.a(new_n140_), .b(x14), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n137_), .c(new_n141_), .d(new_n139_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n136_), .c(new_n83_), .O(new_n144_));
  ...
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n140_), .O(new_n154_));
  ...
  nor3   g098(.a(new_n127_), .b(new_n126_), .c(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n80_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(z13));
  inv1   g101(.a(new_n141_), .O(new_n164_));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n140_), .O(new_n169_));
  ...
  nand3  g114(.a(new_n149_), .b(new_n140_), .c(x14), .O(new_n177_));
  ...
  nand2  g125(.a(new_n76_), .b(x29), .O(new_n188_));
  oai21  g126(.a(new_n86_), .b(x27), .c(new_n188_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n64_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n137_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n81_), .d(new_n83_), .O(z18));
  inv1   g131(.a(x09), .O(new_n194_));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n94_), .c(x14), .O(new_n196_));
  nand2  g134(.a(new_n142_), .b(new_n85_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n188_), .O(new_n198_));
  inv1   g136(.a(x08), .O(new_n199_));
  nand2  g137(.a(x35), .b(x27), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(x04), .c(new_n199_), .O(new_n201_));
  nand2  g139(.a(new_n138_), .b(new_n66_), .O(new_n202_));
  ...
  nand3  g144(.a(new_n206_), .b(new_n83_), .c(new_n194_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n81_), .O(z19));
  nand2  g146(.a(x28), .b(new_n64_), .O(new_n209_));
  aoi22  g147(.a(new_n209_), .b(x35), .c(new_n141_), .d(new_n139_), .O(new_n210_));
  nand2  g148(.a(x40), .b(new_n66_), .O(new_n211_));
  aoi21  g149(.a(new_n211_), .b(new_n134_), .c(x08), .O(new_n212_));
  oai21  g150(.a(new_n212_), .b(new_n210_), .c(new_n83_), .O(new_n213_));
