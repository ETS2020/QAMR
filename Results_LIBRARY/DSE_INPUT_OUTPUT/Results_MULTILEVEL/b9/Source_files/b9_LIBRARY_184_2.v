...
module FAU ( 
  ...
  nor2   g034(.a(x40), .b(x25), .O(new_n97_));
  ...
  nand4  g039(.a(new_n101_), .b(new_n100_), .c(new_n79_), .d(x21), .O(z03));
  aoi21  g040(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n100_), .c(new_n81_), .O(z04));
  oai21  g042(.a(new_n84_), .b(new_n64_), .c(new_n70_), .O(new_n105_));
  and2   g043(.a(new_n105_), .b(new_n79_), .O(z05));
  ...
  nand2  g057(.a(new_n79_), .b(new_n119_), .O(z08));
  ...
  oai21  g106(.a(new_n168_), .b(new_n97_), .c(new_n164_), .O(new_n169_));
  ...
  nand3  g113(.a(new_n148_), .b(new_n78_), .c(new_n113_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  inv1   g115(.a(x12), .O(new_n178_));
  nand4  g116(.a(new_n79_), .b(x34), .c(x27), .d(x26), .O(new_n179_));
  ...
  nand4  g123(.a(new_n79_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  nand2  g125(.a(new_n64_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n140_), .c(new_n66_), .O(new_n189_));
  nand2  g127(.a(new_n82_), .b(new_n133_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n84_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n81_), .c(new_n91_), .d(new_n119_), .O(z18));
  nand2  g130(.a(new_n79_), .b(new_n64_), .O(new_n193_));
  nand3  g131(.a(x35), .b(new_n84_), .c(new_n65_), .O(new_n194_));
  ...
  aoi22  g136(.a(new_n198_), .b(new_n98_), .c(new_n136_), .d(new_n135_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n196_), .c(new_n82_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z19));
  inv1   g139(.a(new_n134_), .O(new_n202_));
  oai21  g140(.a(new_n66_), .b(new_n64_), .c(new_n139_), .O(new_n203_));
  aoi21  g141(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n203_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n82_), .c(new_n133_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n79_), .O(z20));
endmodule
