...
module FAU ( 
  ...
  oai21  g012(.a(new_n74_), .b(x19), .c(new_n73_), .O(new_n75_));
  ...
  oai21  g080(.a(new_n94_), .b(x04), .c(new_n70_), .O(new_n143_));
  ...
  nand4  g092(.a(new_n69_), .b(x20), .c(new_n63_), .d(new_n154_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n123_), .c(new_n64_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  nand3  g099(.a(x20), .b(new_n63_), .c(new_n154_), .O(new_n162_));
  ...
  nand3  g104(.a(new_n67_), .b(new_n144_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n79_), .c(new_n78_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n70_), .c(new_n64_), .O(new_n170_));
