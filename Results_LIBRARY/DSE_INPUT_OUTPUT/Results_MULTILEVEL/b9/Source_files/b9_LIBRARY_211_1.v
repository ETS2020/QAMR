...
module FAU ( 
  ...
  oai21  g004(.a(new_n66_), .b(new_n65_), .c(x09), .O(new_n67_));
  ...
  inv1   g022(.a(x10), .O(new_n85_));
  nor2   g023(.a(new_n85_), .b(x09), .O(new_n86_));
  inv1   g024(.a(new_n86_), .O(new_n87_));
  nand3  g025(.a(new_n87_), .b(new_n84_), .c(x04), .O(z01));
  inv1   g026(.a(new_n66_), .O(new_n89_));
  ...
  oai21  g031(.a(new_n93_), .b(new_n81_), .c(x04), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n87_), .d(new_n89_), .O(z02));
  nand2  g033(.a(new_n74_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x27), .O(new_n97_));
  nand2  g035(.a(new_n69_), .b(new_n97_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n87_), .d(x21), .O(z03));
  inv1   g037(.a(x21), .O(new_n100_));
  nand4  g038(.a(new_n98_), .b(new_n96_), .c(new_n87_), .d(new_n100_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n69_), .c(new_n86_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n87_), .c(new_n69_), .O(new_n104_));
  ...
  nand2  g055(.a(new_n117_), .b(new_n87_), .O(z07));
  nand2  g056(.a(new_n87_), .b(new_n66_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n87_), .O(z09));
  nand2  g059(.a(new_n66_), .b(x07), .O(new_n122_));
  ...
  nand2  g063(.a(new_n79_), .b(new_n78_), .O(new_n126_));
  nand4  g064(.a(new_n126_), .b(x40), .c(x39), .d(x05), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n63_), .O(new_n129_));
  nor2   g067(.a(new_n69_), .b(new_n97_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n86_), .O(new_n131_));
  ...
  nand3  g073(.a(new_n135_), .b(x35), .c(new_n80_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n80_), .c(x27), .d(new_n63_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n78_), .c(new_n85_), .d(new_n133_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n97_), .c(new_n85_), .O(new_n145_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n145_), .c(new_n87_), .O(z12));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n150_), .d(new_n63_), .O(new_n154_));
  ...
  nand3  g097(.a(new_n126_), .b(x40), .c(x39), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n63_), .c(new_n86_), .O(new_n162_));
  ...
  nand3  g104(.a(new_n89_), .b(new_n150_), .c(new_n63_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n69_), .b(new_n70_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n79_), .c(new_n78_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n147_), .c(new_n86_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n168_), .O(z14));
  nand4  g111(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n87_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(x22), .c(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n87_), .O(z16));
  inv1   g116(.a(x01), .O(new_n179_));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n87_), .b(new_n180_), .c(x23), .d(x22), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n179_), .O(z17));
  oai21  g120(.a(new_n81_), .b(x27), .c(new_n134_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(x10), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n139_), .d(new_n78_), .O(z18));
  inv1   g124(.a(new_n134_), .O(new_n187_));
  oai21  g125(.a(new_n70_), .b(new_n97_), .c(new_n138_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n97_), .c(new_n70_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n78_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n85_), .c(x09), .O(z20));
  inv1   g130(.a(new_n142_), .O(z19));
endmodule
