...
module FAU ( 
  ...
  oai21  g024(.a(new_n86_), .b(new_n69_), .c(x39), .O(z02));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n92_), .c(new_n73_), .O(z05));
  ...
  nor2   g051(.a(new_n69_), .b(new_n113_), .O(z08));
  ...
  nand3  g059(.a(new_n121_), .b(new_n79_), .c(x27), .O(new_n122_));
  ...
  aoi21  g067(.a(x40), .b(new_n129_), .c(new_n113_), .O(new_n130_));
  ...
  nand3  g071(.a(x35), .b(new_n77_), .c(new_n118_), .O(new_n134_));
  ...
  nand3  g078(.a(new_n92_), .b(new_n76_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g092(.a(new_n123_), .b(new_n146_), .c(new_n118_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n113_), .O(new_n156_));
  or2    g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x39), .b(new_n146_), .c(new_n118_), .O(new_n158_));
  ...
  aoi22  g099(.a(new_n161_), .b(new_n147_), .c(new_n92_), .d(new_n140_), .O(new_n162_));
  ...
  nor2   g104(.a(new_n116_), .b(new_n166_), .O(z15));
  ...
  nand2  g112(.a(x39), .b(x29), .O(new_n175_));
  oai21  g113(.a(new_n78_), .b(x27), .c(new_n175_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  nor2   g115(.a(new_n91_), .b(x04), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n84_), .c(x09), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n177_), .c(new_n70_), .d(new_n74_), .O(z18));
  inv1   g118(.a(x09), .O(new_n181_));
  nand2  g119(.a(new_n131_), .b(new_n77_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n175_), .O(new_n183_));
  inv1   g121(.a(x08), .O(new_n184_));
  aoi21  g122(.a(new_n69_), .b(x39), .c(x27), .O(new_n185_));
  nand2  g123(.a(x40), .b(new_n140_), .O(new_n186_));
  nand2  g124(.a(x39), .b(x04), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n186_), .c(new_n77_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n185_), .c(new_n184_), .O(new_n189_));
  inv1   g127(.a(new_n130_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n140_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n189_), .c(new_n183_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n74_), .c(new_n181_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n70_), .O(z19));
  aoi21  g132(.a(x28), .b(new_n91_), .c(new_n140_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n130_), .O(new_n196_));
  aoi21  g134(.a(new_n186_), .b(new_n133_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n196_), .c(new_n74_), .O(new_n198_));
