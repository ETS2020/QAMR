...
module FAU ( 
  ...
  nand3  g041(.a(new_n103_), .b(new_n64_), .c(new_n69_), .O(z05));
  ...
  nor2   g071(.a(new_n68_), .b(new_n73_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n83_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(x29), .b(x04), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(x35), .c(new_n82_), .d(x27), .O(new_n137_));
  ...
  nand3  g080(.a(new_n69_), .b(new_n81_), .c(new_n142_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  aoi21  g082(.a(x39), .b(new_n73_), .c(new_n71_), .O(new_n145_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n63_), .c(new_n90_), .O(new_n149_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n90_), .c(x20), .d(new_n156_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n126_), .b(new_n151_), .c(new_n73_), .O(new_n162_));
  ...
  nand3  g114(.a(new_n176_), .b(new_n170_), .c(new_n149_), .O(z14));
  ...
  oai21  g124(.a(new_n83_), .b(x27), .c(new_n133_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nand4  g126(.a(x35), .b(new_n82_), .c(x27), .d(new_n73_), .O(new_n189_));
  nor2   g127(.a(new_n65_), .b(x30), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(new_n132_), .O(z18));
  nand2  g129(.a(new_n189_), .b(new_n89_), .O(new_n192_));
  ...
  oai21  g134(.a(new_n142_), .b(new_n68_), .c(new_n89_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n68_), .c(new_n142_), .O(new_n198_));
