...
module FAU ( 
  ...
  oai21  g066(.a(new_n125_), .b(new_n95_), .c(new_n128_), .O(z10));
  ...
  nand3  g072(.a(new_n83_), .b(x27), .c(new_n72_), .O(new_n135_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n95_), .c(new_n74_), .O(new_n141_));
  oai21  g079(.a(new_n91_), .b(x04), .c(new_n69_), .O(new_n142_));
  ...
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n135_), .d(new_n130_), .O(z18));
  ...
  aoi22  g130(.a(new_n192_), .b(new_n157_), .c(new_n132_), .d(new_n83_), .O(new_n193_));
