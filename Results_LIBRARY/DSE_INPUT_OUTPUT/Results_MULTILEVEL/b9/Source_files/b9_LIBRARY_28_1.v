...
module FAU ( 
  ...
  oai21  g040(.a(new_n82_), .b(new_n97_), .c(new_n65_), .O(new_n103_));
  and2   g041(.a(new_n103_), .b(new_n64_), .O(z05));
  ...
  oai22  g058(.a(new_n93_), .b(new_n119_), .c(x40), .d(new_n120_), .O(new_n121_));
  ...
  aoi21  g063(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(new_n126_));
  ...
  nor2   g068(.a(new_n74_), .b(new_n130_), .O(new_n131_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n79_), .c(new_n129_), .O(new_n143_));
  ...
  oai21  g084(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n147_));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n152_), .c(new_n97_), .O(new_n156_));
  nand2  g094(.a(new_n80_), .b(new_n79_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n149_), .c(new_n71_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x39), .c(new_n74_), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n156_), .O(z13));
  aoi21  g098(.a(new_n149_), .b(new_n71_), .c(new_n63_), .O(new_n161_));
  ...
  aoi21  g104(.a(new_n165_), .b(new_n150_), .c(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n82_), .c(x27), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(x39), .c(new_n80_), .d(new_n79_), .O(new_n169_));
  ...
  nand2  g116(.a(x27), .b(new_n71_), .O(new_n179_));
  nand2  g117(.a(new_n97_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n133_), .O(new_n181_));
  nand2  g119(.a(new_n79_), .b(new_n129_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n82_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n100_), .c(new_n93_), .d(new_n89_), .O(z18));
  aoi21  g122(.a(x39), .b(new_n130_), .c(new_n74_), .O(new_n185_));
  aoi21  g123(.a(new_n135_), .b(new_n134_), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n64_), .b(new_n97_), .O(new_n187_));
  nand3  g125(.a(new_n139_), .b(x35), .c(new_n82_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x39), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n187_), .c(x08), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n186_), .c(new_n79_), .O(new_n191_));
  nor2   g129(.a(new_n191_), .b(x09), .O(z19));
  oai21  g130(.a(new_n133_), .b(new_n97_), .c(new_n138_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n97_), .c(new_n133_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n131_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n79_), .c(new_n129_), .O(new_n196_));
