...
module FAU ( 
  ...
  nand3  g059(.a(new_n121_), .b(new_n85_), .c(new_n72_), .O(new_n122_));
  ...
  nand3  g078(.a(new_n97_), .b(new_n82_), .c(new_n90_), .O(new_n141_));
  ...
  nand2  g089(.a(new_n95_), .b(new_n97_), .O(new_n152_));
  ...
  nand4  g092(.a(new_n152_), .b(new_n74_), .c(x20), .d(new_n151_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand3  g095(.a(new_n127_), .b(new_n146_), .c(new_n72_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x40), .b(new_n146_), .c(new_n72_), .O(new_n160_));
  ...
  oai21  g114(.a(new_n84_), .b(x27), .c(new_n131_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nand3  g116(.a(new_n91_), .b(x27), .c(new_n72_), .O(new_n179_));
  nor2   g117(.a(new_n79_), .b(x30), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n179_), .c(new_n178_), .d(new_n130_), .O(z18));
  nand2  g119(.a(new_n179_), .b(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n133_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n80_), .c(new_n130_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n64_), .O(z19));
  inv1   g123(.a(new_n131_), .O(new_n186_));
  oai21  g124(.a(new_n90_), .b(new_n66_), .c(new_n134_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n66_), .c(new_n90_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n80_), .c(new_n130_), .O(new_n190_));
