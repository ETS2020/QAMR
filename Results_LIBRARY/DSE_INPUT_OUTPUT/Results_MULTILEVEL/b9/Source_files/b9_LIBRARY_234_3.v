...
module FAU ( 
  ...
  aoi21  g22(.a(new_n85_), .b(new_n64_), .c(z08), .O(z05));
  nand3  g23(.a(new_n85_), .b(new_n68_), .c(new_n64_), .O(new_n87_));
  ...
  nand2  g45(.a(new_n108_), .b(new_n68_), .O(z10));
  inv1   g46(.a(x09), .O(new_n110_));
  inv1   g47(.a(x28), .O(new_n111_));
  nand2  g48(.a(x27), .b(x04), .O(new_n112_));
  inv1   g49(.a(x08), .O(new_n113_));
  nand2  g50(.a(new_n80_), .b(new_n113_), .O(new_n114_));
  nand4  g51(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n111_), .O(new_n115_));
  nand4  g52(.a(new_n115_), .b(new_n68_), .c(new_n71_), .d(new_n110_), .O(new_n116_));
  inv1   g53(.a(new_n116_), .O(z11));
  nor2   g54(.a(z08), .b(new_n80_), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(new_n66_), .O(z12));
  nand4  g56(.a(new_n68_), .b(new_n66_), .c(x27), .d(x20), .O(new_n120_));
  nor3   g57(.a(new_n120_), .b(x19), .c(x18), .O(z13));
  nor2   g58(.a(x19), .b(x18), .O(new_n122_));
  nand4  g59(.a(new_n122_), .b(new_n118_), .c(new_n66_), .d(x20), .O(z14));
  nand4  g60(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n124_));
  nand2  g61(.a(new_n124_), .b(new_n68_), .O(z15));
  inv1   g62(.a(x23), .O(new_n126_));
  nand3  g63(.a(new_n126_), .b(x22), .c(x01), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(new_n68_), .O(z16));
  inv1   g65(.a(x24), .O(new_n129_));
  nand4  g66(.a(new_n129_), .b(x23), .c(x22), .d(x01), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(new_n68_), .O(z17));
  nand2  g68(.a(x27), .b(new_n104_), .O(new_n132_));
  oai21  g69(.a(x27), .b(new_n113_), .c(new_n132_), .O(new_n133_));
  nand3  g70(.a(new_n133_), .b(x35), .c(new_n111_), .O(new_n134_));
  nor2   g71(.a(x30), .b(x09), .O(new_n135_));
  aoi21  g72(.a(new_n135_), .b(new_n134_), .c(z08), .O(z18));
  nand3  g73(.a(new_n115_), .b(new_n71_), .c(new_n110_), .O(new_n137_));
  nand2  g74(.a(new_n137_), .b(new_n68_), .O(z19));
  oai21  g75(.a(x28), .b(new_n113_), .c(new_n80_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(x35), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(new_n71_), .c(new_n110_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(new_n68_), .O(z20));
  one    g79(.O(z02));
endmodule
