...
module FAU ( 
  ...
  nand2  g054(.a(new_n116_), .b(new_n82_), .O(z07));
  nand2  g055(.a(new_n82_), .b(new_n75_), .O(z08));
  ...
  nand2  g070(.a(x35), .b(new_n84_), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nor2   g072(.a(new_n64_), .b(new_n65_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n133_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand3  g075(.a(new_n94_), .b(x27), .c(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n81_), .c(x18), .d(new_n132_), .O(new_n141_));
  ...
  oai22  g083(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n82_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  oai21  g086(.a(new_n67_), .b(new_n66_), .c(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x40), .c(x39), .d(new_n148_), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n72_), .b(x20), .c(new_n151_), .d(new_n80_), .O(new_n152_));
  oai21  g090(.a(new_n150_), .b(x04), .c(new_n152_), .O(new_n153_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n65_), .c(new_n90_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n154_), .O(z13));
  aoi21  g097(.a(new_n149_), .b(x27), .c(x32), .O(new_n160_));
  nand3  g098(.a(new_n76_), .b(new_n148_), .c(new_n65_), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(new_n81_), .c(new_n161_), .O(new_n162_));
  nand4  g100(.a(new_n72_), .b(x27), .c(x20), .d(new_n151_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(x30), .O(new_n164_));
  oai21  g102(.a(new_n162_), .b(new_n80_), .c(new_n164_), .O(z14));
  inv1   g103(.a(x12), .O(new_n166_));
  nand4  g104(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n167_));
  ...
  nand2  g111(.a(new_n173_), .b(new_n82_), .O(z17));
  nand2  g112(.a(new_n94_), .b(new_n64_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n134_), .c(new_n137_), .O(new_n176_));
  nand2  g114(.a(new_n138_), .b(new_n132_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n176_), .c(x18), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n81_), .O(z18));
  inv1   g117(.a(new_n134_), .O(new_n180_));
  oai21  g118(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n181_));
  ...
  aoi21  g122(.a(new_n184_), .b(x18), .c(x30), .O(z20));
