...
module FAU ( 
  ...
  nand2  g035(.a(new_n76_), .b(x34), .O(new_n98_));
  ...
  nand2  g059(.a(x40), .b(new_n75_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n98_), .c(new_n121_), .O(new_n123_));
  nand3  g061(.a(x40), .b(x39), .c(x05), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n123_), .c(new_n89_), .O(new_n126_));
  ...
  nand2  g068(.a(new_n86_), .b(new_n85_), .O(new_n131_));
  ...
  oai21  g074(.a(new_n88_), .b(x04), .c(x40), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(x08), .O(new_n138_));
  inv1   g076(.a(new_n88_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x40), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n98_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(new_n85_), .O(new_n144_));
  nor2   g082(.a(new_n144_), .b(x09), .O(z11));
  nor2   g083(.a(x37), .b(x36), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n66_), .c(new_n64_), .O(new_n147_));
  nand2  g085(.a(new_n72_), .b(x27), .O(new_n148_));
  nand2  g086(.a(z08), .b(new_n65_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n84_), .O(new_n150_));
  oai21  g088(.a(new_n147_), .b(x10), .c(new_n150_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n76_), .O(new_n154_));
  ...
  nor2   g098(.a(new_n132_), .b(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n65_), .c(new_n84_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(z13));
  nand3  g101(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n164_));
  nand4  g102(.a(new_n153_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(z08), .b(new_n152_), .c(new_n65_), .O(new_n167_));
  ...
  aoi21  g109(.a(new_n167_), .b(new_n148_), .c(new_n84_), .O(new_n172_));
  ...
  nand4  g114(.a(new_n82_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  ...
  nand2  g121(.a(z08), .b(x29), .O(new_n184_));
  oai21  g122(.a(new_n88_), .b(x27), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nand3  g124(.a(new_n139_), .b(x27), .c(new_n65_), .O(new_n187_));
  nor2   g125(.a(new_n84_), .b(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n183_), .O(z18));
  nand2  g127(.a(new_n142_), .b(new_n139_), .O(new_n190_));
  nand2  g128(.a(new_n184_), .b(new_n190_), .O(new_n191_));
  inv1   g129(.a(x08), .O(new_n192_));
  nand2  g130(.a(new_n187_), .b(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n85_), .c(new_n183_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n82_), .O(z19));
  inv1   g134(.a(new_n184_), .O(new_n197_));
  oai21  g135(.a(new_n66_), .b(new_n64_), .c(new_n192_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n85_), .c(new_n183_), .O(new_n201_));
