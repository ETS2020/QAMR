...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(new_n66_), .d(x11), .O(new_n78_));
  ...
  nand3  g053(.a(x40), .b(x39), .c(x11), .O(new_n116_));
  ...
  nand2  g068(.a(new_n130_), .b(new_n120_), .O(new_n131_));
  ...
  nand2  g074(.a(new_n136_), .b(x11), .O(new_n137_));
  ...
  oai21  g081(.a(new_n84_), .b(new_n96_), .c(new_n134_), .O(new_n144_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n96_), .c(new_n74_), .O(new_n149_));
  oai21  g087(.a(new_n122_), .b(x04), .c(new_n71_), .O(new_n150_));
  ...
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n120_), .O(new_n155_));
  ...
  nand4  g100(.a(new_n128_), .b(new_n152_), .c(x11), .d(new_n120_), .O(new_n163_));
  ...
  nand3  g104(.a(x39), .b(new_n152_), .c(new_n120_), .O(new_n167_));
  ...
  nand2  g113(.a(new_n175_), .b(x11), .O(new_n176_));
  ...
  oai21  g126(.a(new_n84_), .b(x27), .c(new_n139_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n96_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n140_), .c(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n64_), .d(new_n135_), .O(z18));
  oai21  g131(.a(new_n171_), .b(new_n96_), .c(x11), .O(new_n194_));
  nand2  g132(.a(x40), .b(x04), .O(new_n195_));
  nand2  g133(.a(new_n75_), .b(new_n96_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n195_), .c(new_n194_), .d(new_n83_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n134_), .O(new_n198_));
  nand2  g136(.a(x39), .b(x29), .O(new_n199_));
  nand2  g137(.a(new_n171_), .b(x11), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n141_), .c(new_n83_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n199_), .O(new_n202_));
  nand2  g140(.a(new_n142_), .b(new_n75_), .O(new_n203_));
  ...
  aoi21  g144(.a(x28), .b(new_n96_), .c(new_n171_), .O(new_n207_));
  aoi21  g145(.a(new_n199_), .b(x11), .c(new_n75_), .O(new_n208_));
  nor2   g146(.a(new_n208_), .b(new_n207_), .O(new_n209_));
  aoi21  g147(.a(new_n196_), .b(new_n194_), .c(x08), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n209_), .c(new_n80_), .O(new_n211_));
