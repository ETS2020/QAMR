...
module FAU ( 
  ...
  nor3   g054(.a(new_n65_), .b(new_n75_), .c(new_n116_), .O(z08));
  ...
  oai21  g082(.a(new_n71_), .b(new_n63_), .c(new_n144_), .O(z12));
  ...
  nand4  g093(.a(new_n155_), .b(new_n94_), .c(x32), .d(new_n63_), .O(new_n156_));
  ...
  nand2  g110(.a(new_n172_), .b(new_n64_), .O(z16));
  ...
  oai21  g115(.a(new_n83_), .b(x27), .c(new_n130_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n136_), .c(new_n73_), .d(new_n129_), .O(z18));
  inv1   g118(.a(new_n130_), .O(new_n181_));
  oai21  g119(.a(new_n134_), .b(new_n68_), .c(new_n133_), .O(new_n182_));
  aoi21  g120(.a(x28), .b(new_n68_), .c(new_n134_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n182_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n73_), .c(new_n129_), .O(new_n185_));
  inv1   g123(.a(new_n185_), .O(z20));
  nand2  g124(.a(new_n139_), .b(new_n64_), .O(z19));
endmodule
