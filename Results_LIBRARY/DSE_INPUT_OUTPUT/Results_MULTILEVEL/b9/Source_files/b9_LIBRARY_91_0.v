...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(x33), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n93_), .O(z02));
  nand2  g033(.a(new_n71_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x21), .O(new_n97_));
  aoi21  g035(.a(new_n70_), .b(new_n69_), .c(new_n97_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n66_), .O(z03));
  aoi21  g037(.a(new_n70_), .b(new_n69_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n66_), .O(z04));
  ...
  nand4  g047(.a(new_n109_), .b(new_n107_), .c(new_n63_), .d(new_n106_), .O(new_n110_));
  ...
  nand2  g053(.a(new_n115_), .b(x40), .O(new_n116_));
  nand3  g054(.a(new_n113_), .b(x33), .c(new_n111_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n116_), .c(new_n105_), .O(z07));
  ...
  nand2  g068(.a(new_n130_), .b(new_n74_), .O(new_n131_));
  ...
  nand3  g079(.a(new_n137_), .b(x27), .c(new_n74_), .O(new_n142_));
  ...
  nand3  g084(.a(new_n70_), .b(new_n82_), .c(new_n136_), .O(new_n147_));
  ...
  nand3  g101(.a(new_n128_), .b(x40), .c(x39), .O(new_n164_));
  ...
  inv1   g105(.a(new_n94_), .O(new_n168_));
  ...
  nand3  g112(.a(new_n70_), .b(new_n136_), .c(x28), .O(new_n175_));
  ...
  nor2   g120(.a(new_n122_), .b(new_n182_), .O(z15));
  ...
  nand2  g126(.a(new_n188_), .b(new_n65_), .O(z17));
  oai21  g127(.a(new_n84_), .b(x27), .c(new_n135_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n66_), .b(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n191_), .c(new_n142_), .d(new_n134_), .O(z18));
  nand2  g131(.a(new_n65_), .b(new_n69_), .O(new_n194_));
  nand3  g132(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n195_));
  ...
  aoi22  g137(.a(new_n199_), .b(new_n94_), .c(new_n138_), .d(new_n137_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n197_), .c(new_n80_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z19));
  nand2  g140(.a(x28), .b(new_n69_), .O(new_n203_));
  aoi22  g141(.a(new_n203_), .b(x35), .c(new_n199_), .d(new_n94_), .O(new_n204_));
  nand2  g142(.a(x40), .b(new_n136_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n194_), .c(x08), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n204_), .c(new_n80_), .O(new_n207_));
