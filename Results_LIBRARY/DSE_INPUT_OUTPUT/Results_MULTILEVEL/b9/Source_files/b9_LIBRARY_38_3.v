...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(new_n72_), .O(z02));
  nand2  g034(.a(new_n69_), .b(x27), .O(new_n97_));
  aoi21  g035(.a(new_n68_), .b(new_n67_), .c(new_n64_), .O(new_n98_));
  ...
  nor2   g039(.a(new_n82_), .b(new_n67_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n63_), .c(new_n68_), .O(z05));
  oai21  g042(.a(new_n102_), .b(x37), .c(new_n63_), .O(z06));
  ...
  aoi21  g055(.a(new_n117_), .b(new_n72_), .c(new_n74_), .O(z08));
  nand4  g056(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n119_));
  nor2   g057(.a(new_n119_), .b(x40), .O(z09));
  inv1   g058(.a(x04), .O(new_n121_));
  inv1   g059(.a(x05), .O(new_n122_));
  nand2  g060(.a(new_n94_), .b(x07), .O(new_n123_));
  oai21  g061(.a(new_n94_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g071(.a(x40), .b(x34), .c(x27), .O(new_n134_));
  ...
  aoi21  g075(.a(new_n137_), .b(new_n72_), .c(new_n74_), .O(new_n138_));
  ...
  oai22  g081(.a(new_n143_), .b(new_n138_), .c(new_n136_), .d(x08), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n79_), .c(new_n133_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(z11));
  nand3  g084(.a(new_n68_), .b(new_n81_), .c(new_n139_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x27), .c(x10), .O(new_n148_));
  aoi21  g086(.a(x39), .b(new_n121_), .c(new_n70_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n72_), .O(new_n150_));
  oai21  g088(.a(new_n70_), .b(x40), .c(new_n150_), .O(z12));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(x34), .O(new_n160_));
  nand4  g098(.a(new_n158_), .b(new_n74_), .c(x20), .d(new_n157_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n127_), .b(new_n72_), .c(new_n152_), .d(new_n121_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand3  g103(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n166_));
  nand4  g104(.a(new_n153_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n95_), .b(new_n152_), .c(new_n121_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n68_), .b(new_n139_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n80_), .c(new_n79_), .O(new_n173_));
  inv1   g111(.a(new_n70_), .O(new_n174_));
  aoi21  g112(.a(new_n169_), .b(new_n174_), .c(new_n64_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n173_), .c(new_n170_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(x40), .O(z15));
  ...
  oai22  g123(.a(new_n94_), .b(new_n90_), .c(new_n83_), .d(x27), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n67_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n140_), .c(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n63_), .d(new_n79_), .O(z18));
  nand2  g128(.a(new_n139_), .b(new_n72_), .O(new_n191_));
  nand2  g129(.a(x40), .b(x04), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n191_), .c(new_n82_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n134_), .c(new_n89_), .O(new_n194_));
  nand3  g132(.a(new_n191_), .b(new_n141_), .c(new_n82_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n137_), .O(new_n196_));
  nand2  g134(.a(new_n142_), .b(new_n74_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n196_), .c(new_n194_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n133_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n63_), .O(z19));
  aoi21  g138(.a(x28), .b(new_n67_), .c(new_n139_), .O(new_n201_));
  inv1   g139(.a(new_n191_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n134_), .c(new_n89_), .O(new_n203_));
  oai21  g141(.a(new_n201_), .b(new_n138_), .c(new_n203_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n79_), .c(new_n133_), .O(new_n205_));
