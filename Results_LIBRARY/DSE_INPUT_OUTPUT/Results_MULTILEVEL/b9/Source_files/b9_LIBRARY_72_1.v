...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(x12), .O(new_n81_));
  ...
  nand3  g024(.a(new_n86_), .b(new_n84_), .c(new_n80_), .O(new_n87_));
  oai21  g025(.a(new_n81_), .b(x04), .c(new_n87_), .O(z01));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n81_), .O(z02));
  ...
  oai21  g073(.a(new_n64_), .b(new_n65_), .c(new_n92_), .O(new_n136_));
  ...
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n117_), .O(new_n152_));
  ...
  nor2   g096(.a(new_n156_), .b(new_n158_), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand2  g098(.a(x30), .b(x12), .O(new_n161_));
  nand2  g099(.a(x32), .b(new_n80_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n117_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  nand3  g103(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n84_), .c(new_n80_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n76_), .b(new_n150_), .c(new_n65_), .O(new_n169_));
  ...
  nand3  g110(.a(new_n172_), .b(new_n84_), .c(new_n80_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n147_), .c(new_n81_), .O(new_n174_));
  ...
  nand2  g122(.a(new_n92_), .b(new_n64_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n135_), .c(new_n138_), .O(new_n186_));
  nand2  g124(.a(new_n139_), .b(new_n134_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n80_), .O(new_n188_));
  ...
  nand3  g131(.a(new_n193_), .b(new_n80_), .c(new_n134_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n82_), .O(z20));
  nand2  g133(.a(new_n142_), .b(new_n82_), .O(z19));
endmodule
