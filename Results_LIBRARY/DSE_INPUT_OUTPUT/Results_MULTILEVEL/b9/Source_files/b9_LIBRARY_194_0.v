...
module FAU ( 
  ...
  nor2   g018(.a(x38), .b(x30), .O(new_n81_));
  ...
  nand4  g027(.a(new_n89_), .b(x38), .c(new_n85_), .d(new_n84_), .O(new_n90_));
  oai21  g028(.a(new_n81_), .b(x04), .c(new_n90_), .O(z01));
  inv1   g029(.a(new_n81_), .O(new_n92_));
  ...
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(new_n81_), .O(new_n100_));
  ...
  nor2   g042(.a(new_n104_), .b(new_n81_), .O(z05));
  ...
  nand2  g051(.a(new_n113_), .b(x30), .O(new_n114_));
  ...
  nor3   g061(.a(new_n81_), .b(new_n123_), .c(new_n122_), .O(z08));
  ...
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n92_), .O(z10));
  ...
  nand4  g082(.a(new_n144_), .b(x38), .c(new_n84_), .d(new_n137_), .O(new_n145_));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n149_), .c(new_n81_), .O(z12));
  ...
  nand3  g099(.a(new_n131_), .b(x40), .c(x39), .O(new_n162_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n113_), .c(new_n84_), .O(new_n173_));
  nand2  g111(.a(new_n169_), .b(new_n150_), .O(new_n174_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n92_), .O(z16));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(x23), .c(x22), .d(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n92_), .O(z17));
  oai21  g121(.a(new_n87_), .b(x27), .c(new_n138_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n113_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n142_), .d(new_n137_), .O(z18));
  nand2  g125(.a(new_n144_), .b(new_n137_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(x38), .c(x30), .O(z19));
  inv1   g127(.a(new_n138_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n141_), .O(new_n191_));
  ...
  aoi21  g132(.a(new_n194_), .b(x38), .c(x30), .O(z20));
endmodule
