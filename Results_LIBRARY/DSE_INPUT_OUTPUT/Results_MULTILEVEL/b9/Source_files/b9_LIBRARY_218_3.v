...
module FAU ( 
  ...
  aoi21  g18(.a(new_n80_), .b(new_n64_), .c(z08), .O(new_n81_));
  ...
  aoi21  g23(.a(new_n85_), .b(new_n80_), .c(z08), .O(z05));
  nand3  g24(.a(new_n85_), .b(z02), .c(new_n80_), .O(new_n87_));
  ...
  nand4  g52(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n78_), .O(new_n115_));
  nand4  g53(.a(new_n115_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n116_));
  inv1   g54(.a(new_n116_), .O(z11));
  inv1   g55(.a(new_n65_), .O(new_n118_));
  nand3  g56(.a(z02), .b(new_n118_), .c(x27), .O(z12));
  inv1   g57(.a(x18), .O(new_n120_));
  inv1   g58(.a(x19), .O(new_n121_));
  nand4  g59(.a(new_n66_), .b(x20), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  ...
  aoi21  g63(.a(new_n125_), .b(new_n118_), .c(z08), .O(z14));
  nand4  g64(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  nand2  g65(.a(new_n127_), .b(z02), .O(z15));
  ...
  inv1   g73(.a(x08), .O(new_n136_));
  nand2  g74(.a(x27), .b(new_n105_), .O(new_n137_));
  oai21  g75(.a(x27), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(x35), .c(new_n78_), .O(new_n139_));
  nand4  g77(.a(new_n139_), .b(z02), .c(new_n71_), .d(new_n111_), .O(z18));
  oai21  g78(.a(new_n113_), .b(new_n72_), .c(z02), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n112_), .c(new_n78_), .O(new_n142_));
  nand3  g80(.a(new_n142_), .b(new_n71_), .c(new_n111_), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(z02), .O(z19));
  oai21  g82(.a(x28), .b(new_n136_), .c(new_n64_), .O(new_n145_));
  nand2  g83(.a(new_n145_), .b(x35), .O(new_n146_));
  nand4  g84(.a(new_n146_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n147_));
  inv1   g85(.a(new_n147_), .O(z20));
endmodule
