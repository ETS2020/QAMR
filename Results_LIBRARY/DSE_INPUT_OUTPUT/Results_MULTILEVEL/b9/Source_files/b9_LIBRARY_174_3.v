...
module FAU ( 
  ...
  nand2  g20(.a(new_n66_), .b(new_n80_), .O(new_n83_));
  ...
  inv1   g51(.a(new_n114_), .O(new_n115_));
  ...
  nor2   g59(.a(new_n64_), .b(new_n80_), .O(new_n123_));
  nand4  g60(.a(new_n123_), .b(new_n122_), .c(new_n68_), .d(x20), .O(z14));
  nand4  g61(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n125_));
  nand2  g62(.a(new_n125_), .b(z02), .O(z15));
  ...
  nand4  g68(.a(z02), .b(new_n131_), .c(x23), .d(x22), .O(new_n132_));
  nor2   g69(.a(new_n132_), .b(new_n130_), .O(z17));
  inv1   g70(.a(x08), .O(new_n134_));
  nand2  g71(.a(x27), .b(new_n105_), .O(new_n135_));
  oai21  g72(.a(x27), .b(new_n134_), .c(new_n135_), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n112_), .O(new_n137_));
  nand4  g74(.a(new_n137_), .b(z02), .c(new_n71_), .d(new_n111_), .O(z18));
  oai21  g75(.a(new_n114_), .b(new_n72_), .c(z02), .O(new_n139_));
  nand3  g76(.a(new_n139_), .b(new_n113_), .c(new_n112_), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(new_n71_), .c(new_n111_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(z02), .O(z19));
  oai21  g79(.a(x28), .b(new_n134_), .c(new_n80_), .O(new_n143_));
  nand2  g80(.a(new_n143_), .b(x35), .O(new_n144_));
  nand4  g81(.a(new_n144_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n145_));
