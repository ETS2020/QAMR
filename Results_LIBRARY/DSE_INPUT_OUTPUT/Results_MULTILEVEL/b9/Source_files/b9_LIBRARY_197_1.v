...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(x10), .O(new_n81_));
  ...
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(new_n80_), .O(new_n163_));
  aoi21  g101(.a(new_n155_), .b(x28), .c(new_n64_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n128_), .c(x40), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n118_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n154_), .c(x10), .d(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n163_), .O(z13));
  nand3  g106(.a(x20), .b(new_n80_), .c(new_n158_), .O(new_n169_));
  nand4  g107(.a(new_n155_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  nand3  g109(.a(new_n76_), .b(new_n154_), .c(new_n65_), .O(new_n172_));
  ...
  aoi21  g114(.a(new_n172_), .b(new_n151_), .c(new_n81_), .O(new_n177_));
  ...
  oai21  g124(.a(new_n87_), .b(x27), .c(new_n135_), .O(new_n187_));
  nand3  g125(.a(new_n139_), .b(new_n84_), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(x08), .c(new_n188_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n81_), .O(z18));
  ...
  nand4  g132(.a(new_n194_), .b(new_n82_), .c(new_n84_), .d(new_n134_), .O(new_n195_));
