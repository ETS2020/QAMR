...
module FAU ( 
  ...
  nand3  g036(.a(new_n98_), .b(new_n96_), .c(new_n76_), .O(z02));
  nand2  g037(.a(new_n71_), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n70_), .b(new_n64_), .c(new_n84_), .O(new_n101_));
  ...
  nor2   g065(.a(new_n127_), .b(new_n80_), .O(new_n128_));
  ...
  nand3  g072(.a(x35), .b(new_n87_), .c(new_n65_), .O(new_n135_));
  ...
  oai21  g076(.a(new_n81_), .b(new_n95_), .c(x39), .O(new_n139_));
  nand2  g077(.a(x40), .b(new_n80_), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  aoi22  g079(.a(new_n141_), .b(new_n138_), .c(new_n140_), .d(new_n139_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n137_), .c(new_n85_), .O(new_n143_));
  ...
  aoi22  g084(.a(new_n72_), .b(x27), .c(x40), .d(new_n65_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x39), .O(new_n148_));
  nand2  g086(.a(new_n72_), .b(x27), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(x40), .c(new_n80_), .O(new_n150_));
  ...
  inv1   g102(.a(new_n140_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n166_));
  nand4  g104(.a(new_n153_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n167_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n82_), .O(z15));
  ...
  oai21  g126(.a(new_n88_), .b(x27), .c(new_n188_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n64_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n138_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n82_), .d(new_n85_), .O(z18));
  inv1   g131(.a(new_n188_), .O(new_n194_));
  ...
  nand2  g135(.a(new_n197_), .b(new_n85_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(x09), .c(new_n82_), .O(z20));
