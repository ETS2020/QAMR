...
module FAU ( 
  ...
  aoi21  g057(.a(x35), .b(new_n87_), .c(x36), .O(new_n120_));
  ...
  nand3  g072(.a(x35), .b(new_n87_), .c(new_n71_), .O(new_n135_));
  ...
  nand3  g082(.a(new_n67_), .b(new_n144_), .c(new_n81_), .O(new_n145_));
  ...
  nand3  g087(.a(new_n149_), .b(x40), .c(new_n93_), .O(new_n150_));
  ...
  nand3  g107(.a(new_n67_), .b(new_n81_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n149_), .c(new_n63_), .O(new_n173_));
  ...
  oai22  g121(.a(new_n115_), .b(new_n183_), .c(new_n88_), .d(x27), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n66_), .b(x04), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n82_), .c(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n185_), .c(new_n78_), .d(new_n79_), .O(z18));
  inv1   g126(.a(x09), .O(new_n189_));
  inv1   g127(.a(x08), .O(new_n190_));
  oai21  g128(.a(new_n81_), .b(x04), .c(x39), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n134_), .c(new_n87_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand2  g131(.a(x39), .b(new_n81_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n140_), .c(new_n87_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n138_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n81_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n140_), .c(new_n87_), .O(new_n198_));
  ...
  aoi22  g141(.a(new_n203_), .b(x35), .c(new_n139_), .d(new_n94_), .O(new_n204_));
  aoi21  g142(.a(new_n194_), .b(new_n134_), .c(x08), .O(new_n205_));
