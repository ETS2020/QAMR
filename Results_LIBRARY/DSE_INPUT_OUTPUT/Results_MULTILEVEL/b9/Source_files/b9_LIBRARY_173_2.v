...
module FAU ( 
  ...
  aoi21  g059(.a(x40), .b(new_n75_), .c(new_n96_), .O(new_n122_));
  nand3  g060(.a(x40), .b(x39), .c(x05), .O(new_n123_));
  oai21  g061(.a(new_n122_), .b(new_n121_), .c(new_n123_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n87_), .c(new_n65_), .O(new_n125_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n83_), .O(new_n143_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n102_), .O(new_n149_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n102_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nand3  g100(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n163_));
  nand4  g101(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n164_));
  nand3  g102(.a(x39), .b(new_n151_), .c(new_n65_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n76_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n96_), .c(new_n163_), .O(new_n168_));
  ...
  oai21  g123(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n141_), .b(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n81_), .d(new_n83_), .O(z18));
  nand2  g127(.a(new_n81_), .b(new_n64_), .O(new_n190_));
  oai21  g128(.a(new_n86_), .b(x04), .c(x40), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x08), .O(new_n192_));
  nand2  g130(.a(x39), .b(x29), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x40), .c(new_n96_), .O(new_n194_));
  aoi21  g132(.a(new_n137_), .b(new_n136_), .c(new_n194_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n192_), .c(new_n83_), .O(new_n196_));
  ...
  aoi21  g138(.a(new_n200_), .b(new_n190_), .c(x08), .O(new_n201_));
