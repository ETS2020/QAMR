...
module FAU ( 
  ...
  aoi21  g034(.a(new_n64_), .b(new_n78_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n64_), .c(new_n96_), .O(z05));
  ...
  nand3  g064(.a(x37), .b(new_n89_), .c(x06), .O(new_n127_));
  ...
  nand3  g070(.a(new_n132_), .b(x05), .c(new_n70_), .O(new_n133_));
  ...
  nand2  g075(.a(new_n81_), .b(new_n89_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n138_), .c(new_n137_), .O(new_n140_));
  oai21  g078(.a(new_n81_), .b(new_n78_), .c(new_n89_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n70_), .c(x08), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n140_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n63_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n78_), .c(new_n72_), .O(new_n146_));
  oai21  g084(.a(new_n92_), .b(x04), .c(new_n67_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n63_), .O(z12));
  ...
  nand4  g094(.a(new_n66_), .b(new_n89_), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n132_), .b(new_n149_), .c(new_n70_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  inv1   g100(.a(x32), .O(new_n163_));
  nand3  g101(.a(new_n150_), .b(new_n163_), .c(x28), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n70_), .c(x30), .O(new_n165_));
  aoi21  g103(.a(new_n93_), .b(new_n149_), .c(x04), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n162_), .O(new_n167_));
  aoi21  g105(.a(x32), .b(new_n70_), .c(x27), .O(new_n168_));
  nand2  g106(.a(new_n65_), .b(x04), .O(new_n169_));
  inv1   g107(.a(x35), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n163_), .c(x28), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(x37), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n168_), .c(new_n89_), .O(new_n173_));
  nand2  g111(.a(new_n93_), .b(new_n149_), .O(new_n174_));
  ...
  oai21  g123(.a(new_n81_), .b(x27), .c(new_n136_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  inv1   g125(.a(new_n81_), .O(new_n188_));
  nor2   g126(.a(new_n78_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(x30), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n187_), .c(new_n135_), .O(z18));
  nor2   g129(.a(new_n170_), .b(new_n78_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n78_), .c(new_n170_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n137_), .c(new_n192_), .d(x08), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n89_), .c(new_n135_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n63_), .O(z20));
  nand2  g134(.a(new_n143_), .b(new_n63_), .O(z19));
endmodule
