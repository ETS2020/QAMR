...
module FAU ( 
  ...
  aoi21  g040(.a(new_n102_), .b(new_n99_), .c(new_n81_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n81_), .O(z05));
  nand3  g043(.a(new_n104_), .b(new_n98_), .c(new_n70_), .O(new_n106_));
  ...
  nand3  g055(.a(new_n117_), .b(new_n98_), .c(x03), .O(new_n118_));
  ...
  nand2  g064(.a(new_n126_), .b(new_n84_), .O(new_n127_));
  ...
  nand4  g101(.a(new_n151_), .b(new_n126_), .c(new_n84_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(z08), .b(new_n150_), .c(new_n65_), .O(new_n166_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n85_), .c(new_n84_), .O(new_n170_));
  nand2  g108(.a(new_n166_), .b(new_n147_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n98_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x22), .c(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n98_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n98_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  oai21  g119(.a(new_n87_), .b(x27), .c(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n85_), .b(x30), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n138_), .d(new_n133_), .O(z18));
  inv1   g123(.a(new_n134_), .O(new_n186_));
  aoi21  g124(.a(x40), .b(new_n66_), .c(x28), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n135_), .c(new_n186_), .O(new_n188_));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(x40), .O(new_n189_));
  nor2   g127(.a(x28), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n133_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(x40), .c(x30), .O(z19));
  nor2   g131(.a(new_n66_), .b(new_n64_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n186_), .c(new_n194_), .d(x08), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(x40), .c(new_n84_), .d(new_n133_), .O(new_n197_));
