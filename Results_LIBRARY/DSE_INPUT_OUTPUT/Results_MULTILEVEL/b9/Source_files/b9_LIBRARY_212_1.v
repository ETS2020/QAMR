...
module FAU ( 
  ...
  oai21  g025(.a(new_n87_), .b(x34), .c(new_n83_), .O(new_n88_));
  ...
  nand3  g041(.a(new_n102_), .b(new_n90_), .c(new_n72_), .O(new_n104_));
  ...
  aoi21  g058(.a(new_n120_), .b(x30), .c(new_n63_), .O(z09));
  ...
  oai21  g073(.a(new_n135_), .b(new_n85_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand2  g075(.a(x39), .b(x04), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(x35), .c(new_n84_), .d(x27), .O(new_n139_));
  ...
  aoi21  g080(.a(new_n142_), .b(new_n63_), .c(x30), .O(z11));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n64_), .O(z12));
  ...
  nor3   g096(.a(new_n126_), .b(new_n117_), .c(x13), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n67_), .c(new_n64_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n162_));
  nand3  g100(.a(new_n78_), .b(new_n150_), .c(new_n67_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n90_), .O(new_n164_));
  inv1   g102(.a(x32), .O(new_n165_));
  aoi21  g103(.a(x36), .b(x35), .c(x34), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n165_), .c(new_n83_), .d(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n162_), .O(new_n169_));
  nand3  g107(.a(new_n72_), .b(new_n68_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n165_), .c(new_n83_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  and2   g111(.a(new_n163_), .b(new_n147_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(new_n63_), .O(new_n175_));
  nand2  g113(.a(new_n174_), .b(x30), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  nand4  g115(.a(x30), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n63_), .O(z15));
  ...
  nand2  g122(.a(new_n184_), .b(new_n90_), .O(z17));
  oai21  g123(.a(new_n85_), .b(x27), .c(new_n134_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand4  g125(.a(x35), .b(new_n84_), .c(x27), .d(new_n67_), .O(new_n188_));
  nor2   g126(.a(x34), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n187_), .d(new_n133_), .O(z18));
  nand2  g128(.a(new_n188_), .b(new_n137_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n136_), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n63_), .c(new_n83_), .d(new_n133_), .O(new_n193_));
  inv1   g131(.a(new_n193_), .O(z19));
  inv1   g132(.a(new_n134_), .O(new_n195_));
  oai21  g133(.a(new_n68_), .b(new_n66_), .c(new_n137_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n63_), .c(new_n83_), .d(new_n133_), .O(new_n199_));
