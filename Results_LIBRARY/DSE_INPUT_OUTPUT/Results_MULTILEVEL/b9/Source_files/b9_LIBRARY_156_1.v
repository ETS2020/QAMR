...
module FAU ( 
  ...
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n76_), .d(x14), .O(z02));
  ...
  nand2  g052(.a(new_n114_), .b(new_n80_), .O(new_n115_));
  ...
  aoi21  g058(.a(new_n119_), .b(x14), .c(new_n120_), .O(z08));
  ...
  aoi21  g078(.a(new_n140_), .b(x14), .c(new_n120_), .O(new_n141_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n120_), .c(new_n165_), .O(new_n170_));
  ...
  nand2  g113(.a(new_n175_), .b(x14), .O(new_n176_));
  nand2  g114(.a(new_n149_), .b(new_n120_), .O(new_n177_));
  ...
  oai22  g126(.a(new_n87_), .b(x27), .c(new_n75_), .d(new_n94_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n64_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n139_), .c(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n81_), .d(new_n188_), .O(z18));
  nand2  g131(.a(x35), .b(x27), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x14), .O(new_n195_));
  nand2  g133(.a(x40), .b(x04), .O(new_n196_));
  nand2  g134(.a(new_n120_), .b(new_n64_), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n196_), .c(new_n195_), .d(new_n86_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n93_), .O(new_n199_));
  nand2  g137(.a(new_n66_), .b(x14), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n142_), .c(new_n86_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n140_), .O(new_n202_));
  nand2  g140(.a(new_n142_), .b(new_n139_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n120_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n202_), .c(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n84_), .c(new_n188_), .O(new_n206_));
  ...
  aoi21  g147(.a(new_n197_), .b(new_n195_), .c(x08), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n209_), .c(new_n84_), .O(new_n211_));
