...
module FAU ( 
  ...
  nand2  g024(.a(new_n86_), .b(new_n81_), .O(new_n87_));
  ...
  nand2  g039(.a(new_n68_), .b(new_n99_), .O(new_n102_));
  ...
  nand2  g055(.a(new_n94_), .b(new_n64_), .O(z08));
  ...
  nor2   g069(.a(x30), .b(new_n131_), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(new_n95_), .c(x32), .d(new_n63_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(new_n95_), .b(x29), .O(new_n136_));
  nor2   g074(.a(new_n99_), .b(new_n63_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n63_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n70_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n154_), .c(new_n99_), .O(new_n158_));
  nand3  g096(.a(new_n95_), .b(x32), .c(new_n151_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n74_), .c(x04), .O(new_n160_));
  or2    g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand3  g100(.a(new_n152_), .b(new_n81_), .c(x28), .O(new_n163_));
  nor2   g101(.a(new_n94_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n163_), .c(x30), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(x04), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n68_), .b(new_n140_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x27), .c(x32), .O(new_n168_));
  nor2   g106(.a(new_n164_), .b(new_n72_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n74_), .O(new_n170_));
  nand2  g108(.a(new_n71_), .b(x04), .O(new_n171_));
  ...
  nand2  g119(.a(new_n141_), .b(new_n99_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n136_), .c(new_n139_), .O(new_n183_));
  nand2  g121(.a(new_n142_), .b(new_n135_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n183_), .c(new_n74_), .O(new_n185_));
  oai21  g123(.a(new_n74_), .b(new_n63_), .c(new_n185_), .O(z18));
  inv1   g124(.a(new_n145_), .O(z19));
  inv1   g125(.a(new_n136_), .O(new_n188_));
  oai21  g126(.a(new_n140_), .b(new_n99_), .c(new_n139_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n99_), .c(new_n140_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n74_), .c(new_n135_), .O(new_n192_));
