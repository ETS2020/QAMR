...
module FAU ( 
  ...
  aoi21  g031(.a(new_n93_), .b(x04), .c(new_n90_), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n63_), .c(x40), .O(z02));
  nand2  g033(.a(new_n68_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x21), .O(new_n97_));
  aoi21  g035(.a(new_n67_), .b(new_n66_), .c(new_n97_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n80_), .O(z03));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n67_), .c(new_n80_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n64_), .c(new_n67_), .O(new_n104_));
  ...
  nor2   g054(.a(new_n75_), .b(new_n63_), .O(z08));
  ...
  nand2  g070(.a(x40), .b(x29), .O(new_n133_));
  nor2   g071(.a(new_n66_), .b(new_n73_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n85_), .c(new_n133_), .O(new_n135_));
  inv1   g073(.a(x08), .O(new_n136_));
  nand2  g074(.a(x40), .b(x04), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(x35), .c(new_n84_), .d(x27), .O(new_n138_));
  ...
  nand3  g080(.a(new_n67_), .b(new_n83_), .c(new_n91_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  nor2   g082(.a(new_n69_), .b(new_n73_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x39), .O(new_n146_));
  oai21  g084(.a(new_n69_), .b(x40), .c(new_n146_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x40), .c(new_n148_), .d(new_n73_), .O(new_n151_));
  ...
  nand4  g094(.a(new_n154_), .b(new_n75_), .c(x20), .d(new_n153_), .O(new_n157_));
  ...
  oai21  g118(.a(new_n85_), .b(x27), .c(new_n133_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nand3  g120(.a(new_n92_), .b(x27), .c(new_n73_), .O(new_n183_));
  nor2   g121(.a(new_n80_), .b(x30), .O(new_n184_));
  ...
  oai21  g128(.a(new_n91_), .b(new_n66_), .c(new_n136_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n66_), .c(new_n91_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n81_), .c(new_n132_), .O(new_n194_));
