...
module FAU ( 
  ...
  aoi21  g037(.a(new_n65_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n79_), .O(z03));
  nand2  g039(.a(new_n65_), .b(new_n99_), .O(new_n102_));
  nand4  g040(.a(new_n102_), .b(new_n97_), .c(new_n64_), .d(new_n98_), .O(z04));
  oai21  g041(.a(new_n83_), .b(new_n99_), .c(new_n65_), .O(new_n104_));
  and2   g042(.a(new_n104_), .b(new_n64_), .O(z05));
  inv1   g043(.a(z05), .O(z06));
  inv1   g044(.a(x33), .O(new_n107_));
  nand2  g045(.a(x17), .b(new_n72_), .O(new_n108_));
  ...
  nand3  g053(.a(new_n115_), .b(new_n64_), .c(x03), .O(new_n116_));
  ...
  nand3  g061(.a(new_n123_), .b(new_n85_), .c(x27), .O(new_n124_));
  ...
  nand2  g065(.a(new_n127_), .b(new_n71_), .O(new_n128_));
  ...
  aoi21  g071(.a(x39), .b(new_n133_), .c(new_n74_), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n132_), .c(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n64_), .b(new_n99_), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n83_), .c(new_n71_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x39), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n137_), .c(x08), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(new_n80_), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(x09), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n99_), .c(new_n73_), .O(new_n144_));
  oai21  g082(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n64_), .O(z12));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(new_n99_), .O(new_n154_));
  nand3  g092(.a(new_n125_), .b(new_n147_), .c(new_n71_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x39), .c(new_n74_), .O(new_n156_));
  or2    g094(.a(new_n156_), .b(new_n154_), .O(z13));
  aoi21  g095(.a(new_n147_), .b(new_n71_), .c(new_n63_), .O(new_n158_));
  nor2   g096(.a(x19), .b(x18), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n67_), .c(x27), .d(x20), .O(new_n160_));
  oai21  g098(.a(new_n158_), .b(new_n74_), .c(new_n160_), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(new_n148_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n83_), .c(x27), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n161_), .O(z14));
  ...
  nand2  g115(.a(new_n99_), .b(x08), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(new_n131_), .O(new_n179_));
  ...
  oai22  g120(.a(new_n182_), .b(new_n79_), .c(new_n94_), .d(new_n90_), .O(z18));
  nand2  g121(.a(new_n135_), .b(new_n132_), .O(new_n184_));
  nor2   g122(.a(new_n74_), .b(new_n133_), .O(new_n185_));
  ...
  oai21  g130(.a(new_n131_), .b(new_n99_), .c(new_n188_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n99_), .c(new_n131_), .O(new_n194_));
