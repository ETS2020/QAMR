...
module FAU ( 
  ...
  nor2   g019(.a(new_n81_), .b(x04), .O(new_n82_));
  ...
  nand2  g027(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  aoi21  g028(.a(new_n90_), .b(x04), .c(x30), .O(z01));
  inv1   g029(.a(new_n82_), .O(new_n92_));
  ...
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n92_), .d(new_n76_), .O(z02));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n82_), .O(z03));
  aoi21  g040(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n99_), .c(new_n82_), .O(z04));
  oai21  g042(.a(new_n86_), .b(new_n64_), .c(new_n70_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n92_), .O(z06));
  ...
  nand2  g056(.a(new_n118_), .b(new_n92_), .O(z07));
  inv1   g057(.a(x39), .O(new_n120_));
  inv1   g058(.a(x40), .O(new_n121_));
  nor3   g059(.a(new_n82_), .b(new_n121_), .c(new_n120_), .O(z08));
  nand4  g060(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n92_), .O(z09));
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n81_), .O(new_n130_));
  ...
  nand3  g077(.a(new_n139_), .b(x27), .c(new_n65_), .O(new_n140_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n92_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n121_), .O(new_n153_));
  ...
  nand2  g097(.a(x32), .b(new_n151_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n75_), .c(new_n81_), .O(new_n161_));
  ...
  nand3  g102(.a(new_n152_), .b(new_n85_), .c(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n76_), .b(new_n151_), .c(new_n65_), .O(new_n167_));
  ...
  nand2  g108(.a(new_n170_), .b(new_n85_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n148_), .c(new_n82_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n168_), .O(z14));
  inv1   g111(.a(x12), .O(new_n174_));
  nand4  g112(.a(new_n92_), .b(x34), .c(x27), .d(x26), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n174_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(x22), .c(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n92_), .O(z16));
  inv1   g117(.a(x01), .O(new_n180_));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n92_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  nand2  g121(.a(new_n139_), .b(new_n64_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n135_), .c(new_n138_), .O(new_n185_));
  nand2  g123(.a(new_n140_), .b(new_n134_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(new_n81_), .O(new_n187_));
  nand2  g125(.a(x30), .b(x04), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n187_), .O(z18));
  ...
  nand3  g131(.a(new_n193_), .b(new_n81_), .c(new_n134_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n92_), .O(z20));
  inv1   g133(.a(new_n143_), .O(z19));
endmodule
