...
module FAU ( 
  ...
  nand3  g048(.a(x40), .b(new_n110_), .c(x00), .O(new_n111_));
  nand2  g049(.a(new_n111_), .b(x38), .O(new_n112_));
  nand4  g050(.a(new_n112_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n113_));
  inv1   g051(.a(x14), .O(new_n114_));
  oai21  g052(.a(x25), .b(x00), .c(x40), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(x38), .O(new_n116_));
  ...
  aoi21  g060(.a(x40), .b(new_n93_), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g079(.a(new_n138_), .b(x27), .c(new_n73_), .O(new_n142_));
  ...
  nand3  g084(.a(new_n69_), .b(new_n81_), .c(new_n137_), .O(new_n147_));
  ...
  nand3  g111(.a(new_n69_), .b(new_n137_), .c(x28), .O(new_n174_));
  ...
  nor2   g129(.a(new_n143_), .b(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n191_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g131(.a(new_n64_), .b(new_n68_), .O(new_n194_));
  oai21  g132(.a(new_n83_), .b(x04), .c(x40), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n194_), .c(x08), .O(new_n196_));
  nand2  g134(.a(x39), .b(x29), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(x40), .c(new_n122_), .O(new_n198_));
  aoi21  g136(.a(new_n139_), .b(new_n138_), .c(new_n198_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n196_), .c(new_n79_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z19));
  aoi21  g139(.a(x28), .b(new_n68_), .c(new_n137_), .O(new_n202_));
  nor2   g140(.a(new_n202_), .b(new_n198_), .O(new_n203_));
  nand2  g141(.a(x40), .b(new_n137_), .O(new_n204_));
  aoi21  g142(.a(new_n204_), .b(new_n194_), .c(x08), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n203_), .c(new_n79_), .O(new_n206_));
