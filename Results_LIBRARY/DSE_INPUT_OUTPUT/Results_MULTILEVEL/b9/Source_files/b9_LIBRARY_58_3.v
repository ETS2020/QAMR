...
module FAU ( 
  ...
  nand2  g18(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  nand4  g19(.a(new_n81_), .b(new_n79_), .c(z02), .d(x21), .O(z03));
  aoi21  g20(.a(new_n80_), .b(new_n64_), .c(x21), .O(new_n83_));
  ...
  nand3  g51(.a(new_n113_), .b(new_n71_), .c(new_n109_), .O(new_n114_));
  nand2  g52(.a(new_n114_), .b(z02), .O(z11));
  inv1   g53(.a(new_n65_), .O(new_n116_));
  nand3  g54(.a(z02), .b(new_n116_), .c(x27), .O(z12));
  inv1   g55(.a(x18), .O(new_n118_));
  inv1   g56(.a(x19), .O(new_n119_));
  nand4  g57(.a(new_n66_), .b(x20), .c(new_n119_), .d(new_n118_), .O(new_n120_));
  ...
  aoi21  g61(.a(new_n123_), .b(new_n116_), .c(z08), .O(z14));
  ...
  inv1   g71(.a(x08), .O(new_n134_));
  nand2  g72(.a(x27), .b(new_n103_), .O(new_n135_));
  oai21  g73(.a(x27), .b(new_n134_), .c(new_n135_), .O(new_n136_));
  ...
  oai21  g77(.a(new_n111_), .b(new_n72_), .c(z02), .O(new_n140_));
  nand3  g78(.a(new_n140_), .b(new_n110_), .c(new_n78_), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n71_), .c(new_n109_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(z02), .O(z19));
  oai21  g81(.a(x28), .b(new_n134_), .c(new_n64_), .O(new_n144_));
  nand2  g82(.a(new_n144_), .b(x35), .O(new_n145_));
  nand4  g83(.a(new_n145_), .b(z02), .c(new_n71_), .d(new_n109_), .O(new_n146_));
