...
module FAU ( 
  ...
  oai21  g042(.a(new_n94_), .b(new_n64_), .c(new_n70_), .O(new_n105_));
  ...
  oai21  g056(.a(new_n76_), .b(new_n75_), .c(new_n81_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n81_), .O(z09));
  nor2   g059(.a(new_n86_), .b(x36), .O(new_n122_));
  ...
  nand2  g063(.a(new_n77_), .b(x05), .O(new_n126_));
  ...
  oai21  g073(.a(new_n95_), .b(x04), .c(x40), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n135_), .c(x08), .O(new_n137_));
  oai21  g075(.a(new_n75_), .b(new_n92_), .c(x40), .O(new_n138_));
  inv1   g076(.a(x06), .O(new_n139_));
