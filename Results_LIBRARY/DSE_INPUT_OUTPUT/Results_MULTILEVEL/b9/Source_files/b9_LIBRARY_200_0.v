...
module FAU ( 
  ...
  nand2  g068(.a(new_n65_), .b(new_n99_), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n83_), .c(new_n72_), .O(new_n132_));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n135_), .O(new_n187_));
  ...
  oai22  g128(.a(new_n190_), .b(new_n79_), .c(new_n94_), .d(new_n90_), .O(z18));
  nand2  g129(.a(new_n140_), .b(new_n136_), .O(new_n192_));
  nand2  g130(.a(z08), .b(x29), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  inv1   g132(.a(x08), .O(new_n195_));
  oai21  g133(.a(new_n185_), .b(new_n84_), .c(new_n195_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n194_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n188_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n65_), .O(z19));
  inv1   g137(.a(new_n193_), .O(new_n200_));
  oai21  g138(.a(new_n135_), .b(new_n99_), .c(new_n195_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n99_), .c(new_n135_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n80_), .c(new_n188_), .O(new_n204_));
