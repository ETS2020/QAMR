...
module FAU ( 
  ...
  nand4  g019(.a(new_n81_), .b(new_n63_), .c(new_n77_), .d(new_n76_), .O(new_n82_));
  ...
  nand3  g028(.a(new_n90_), .b(new_n86_), .c(x39), .O(new_n91_));
  ...
  oai21  g039(.a(new_n87_), .b(new_n67_), .c(new_n96_), .O(new_n102_));
  ...
  nand3  g053(.a(new_n115_), .b(new_n101_), .c(x03), .O(new_n116_));
  ...
  nand4  g062(.a(new_n124_), .b(new_n80_), .c(x27), .d(x07), .O(new_n125_));
  inv1   g063(.a(new_n124_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x05), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n123_), .O(new_n129_));
  nor2   g067(.a(new_n96_), .b(new_n67_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n64_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  oai21  g072(.a(x27), .b(x08), .c(new_n134_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n88_), .c(new_n133_), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n63_), .c(x30), .O(z11));
  nand3  g075(.a(new_n96_), .b(new_n79_), .c(new_n78_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x27), .c(x10), .O(new_n139_));
  nand2  g077(.a(new_n94_), .b(new_n96_), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(x27), .c(x39), .d(new_n123_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n139_), .c(x30), .O(new_n142_));
  oai21  g080(.a(new_n68_), .b(new_n67_), .c(new_n63_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(z12));
  inv1   g082(.a(x19), .O(new_n145_));
  nor2   g083(.a(new_n68_), .b(new_n64_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x27), .c(x20), .d(new_n145_), .O(new_n147_));
  inv1   g085(.a(x13), .O(new_n148_));
  nand4  g086(.a(new_n126_), .b(x30), .c(new_n148_), .d(new_n123_), .O(new_n149_));
  oai21  g087(.a(new_n147_), .b(x18), .c(new_n149_), .O(z13));
  nand3  g088(.a(x39), .b(new_n148_), .c(new_n123_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x30), .c(new_n63_), .O(new_n152_));
  nand2  g090(.a(x27), .b(x20), .O(new_n153_));
  nor4   g091(.a(new_n153_), .b(new_n68_), .c(x19), .d(x18), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(new_n152_), .O(z14));
  inv1   g093(.a(x12), .O(new_n156_));
  nor2   g094(.a(new_n121_), .b(new_n156_), .O(z15));
  inv1   g095(.a(x23), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(x22), .c(x01), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n101_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x23), .c(x22), .d(x01), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n101_), .O(z17));
  nand2  g101(.a(x27), .b(new_n123_), .O(new_n164_));
  nand2  g102(.a(new_n67_), .b(x08), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n164_), .c(new_n78_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n87_), .c(x09), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(x40), .c(new_n76_), .O(z18));
  aoi21  g106(.a(new_n87_), .b(x08), .c(x27), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n78_), .c(new_n133_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n63_), .c(x30), .O(z20));
  aoi21  g109(.a(new_n136_), .b(new_n63_), .c(x30), .O(z19));
endmodule
