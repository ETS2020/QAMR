...
module FAU ( 
  ...
  nor2   g038(.a(new_n82_), .b(new_n96_), .O(new_n101_));
  ...
  nand2  g071(.a(new_n64_), .b(new_n96_), .O(new_n134_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n96_), .c(new_n73_), .O(new_n141_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n96_), .O(new_n151_));
  ...
  nand3  g092(.a(x40), .b(new_n144_), .c(new_n71_), .O(new_n155_));
  ...
  oai21  g099(.a(new_n161_), .b(new_n82_), .c(x27), .O(new_n162_));
  ...
  oai21  g112(.a(new_n83_), .b(x27), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n96_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n89_), .c(x09), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g117(.a(x09), .O(new_n180_));
  nand2  g118(.a(new_n132_), .b(new_n82_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n174_), .O(new_n182_));
  inv1   g120(.a(x08), .O(new_n183_));
  aoi21  g121(.a(x40), .b(new_n63_), .c(x27), .O(new_n184_));
  nand2  g122(.a(x39), .b(new_n159_), .O(new_n185_));
  nand2  g123(.a(x40), .b(x04), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n185_), .c(new_n82_), .O(new_n187_));
  ...
  nand3  g129(.a(new_n191_), .b(new_n79_), .c(new_n180_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n64_), .O(z19));
  aoi21  g131(.a(x28), .b(new_n96_), .c(new_n159_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n131_), .O(new_n195_));
  aoi21  g133(.a(new_n185_), .b(new_n134_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n195_), .c(new_n79_), .O(new_n197_));
