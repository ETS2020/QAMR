...
module FAU ( 
  ...
  nand2  g015(.a(x39), .b(x30), .O(new_n78_));
  ...
  oai21  g031(.a(new_n93_), .b(new_n88_), .c(new_n82_), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(x39), .O(z02));
  oai21  g033(.a(new_n66_), .b(new_n89_), .c(x27), .O(new_n96_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n81_), .O(z04));
  ...
  nand4  g068(.a(new_n130_), .b(new_n74_), .c(x32), .d(new_n65_), .O(new_n131_));
  ...
  aoi21  g083(.a(x40), .b(new_n65_), .c(new_n145_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n144_), .c(new_n82_), .O(new_n147_));
  oai21  g085(.a(new_n70_), .b(new_n64_), .c(new_n72_), .O(new_n148_));
  ...
  nand4  g097(.a(x40), .b(x32), .c(new_n150_), .d(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n82_), .O(new_n161_));
  ...
  nand3  g102(.a(new_n151_), .b(new_n83_), .c(x28), .O(new_n165_));
  nand3  g103(.a(x40), .b(new_n150_), .c(new_n65_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(x30), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n72_), .c(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n98_), .b(new_n66_), .c(x28), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(x27), .c(x32), .O(new_n171_));
  nor2   g109(.a(new_n167_), .b(new_n145_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n171_), .c(new_n82_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n169_), .c(new_n148_), .O(z14));
  ...
  nand2  g120(.a(new_n84_), .b(new_n64_), .O(new_n183_));
  ...
  nand2  g124(.a(new_n72_), .b(x30), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n186_), .O(z18));
  nand2  g126(.a(new_n141_), .b(new_n78_), .O(z19));
  inv1   g127(.a(new_n134_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n82_), .c(new_n133_), .O(new_n194_));
