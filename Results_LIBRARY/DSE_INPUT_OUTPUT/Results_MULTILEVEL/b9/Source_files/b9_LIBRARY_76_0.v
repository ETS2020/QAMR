...
module FAU ( 
  ...
  nor2   g000(.a(x40), .b(x30), .O(new_n63_));
  ...
  nand4  g022(.a(new_n84_), .b(x40), .c(new_n79_), .d(new_n78_), .O(new_n85_));
  ...
  nand3  g050(.a(new_n112_), .b(new_n103_), .c(x03), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z07));
  nand2  g052(.a(x40), .b(x39), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n103_), .O(z08));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n103_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(x39), .b(x29), .O(new_n133_));
  nor2   g071(.a(new_n66_), .b(new_n71_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n82_), .c(new_n133_), .O(new_n135_));
  inv1   g073(.a(x08), .O(new_n136_));
  nand4  g074(.a(x35), .b(new_n81_), .c(x27), .d(new_n71_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n132_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x40), .c(x30), .O(z11));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n67_), .b(new_n80_), .c(new_n142_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  aoi21  g082(.a(x39), .b(new_n71_), .c(new_n69_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x40), .O(new_n146_));
  nand2  g084(.a(new_n68_), .b(new_n67_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n73_), .c(x30), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n146_), .O(z12));
  ...
  nand4  g094(.a(new_n147_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n154_), .c(new_n73_), .O(new_n158_));
  nand4  g096(.a(new_n147_), .b(x30), .c(x20), .d(new_n156_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n126_), .b(new_n151_), .c(new_n71_), .O(new_n162_));
  ...
  nand3  g103(.a(x39), .b(new_n151_), .c(new_n71_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n73_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n92_), .c(new_n164_), .O(new_n169_));
  nand3  g107(.a(new_n67_), .b(new_n142_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n79_), .c(new_n78_), .O(new_n172_));
  nand2  g110(.a(new_n166_), .b(new_n148_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x40), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n169_), .c(new_n149_), .O(z14));
  ...
  nand2  g118(.a(new_n180_), .b(new_n103_), .O(z16));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(x23), .c(x22), .d(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n103_), .O(z17));
  nand3  g122(.a(x35), .b(new_n81_), .c(new_n66_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n133_), .c(new_n136_), .O(new_n186_));
  nand2  g124(.a(new_n137_), .b(new_n132_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(x40), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n78_), .O(z18));
  aoi21  g127(.a(x35), .b(x27), .c(x08), .O(new_n190_));
  nand2  g128(.a(x28), .b(new_n66_), .O(new_n191_));
  aoi22  g129(.a(new_n191_), .b(x35), .c(x39), .d(x29), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n132_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x40), .c(x30), .O(z20));
  aoi21  g132(.a(new_n140_), .b(x40), .c(x30), .O(z19));
endmodule
