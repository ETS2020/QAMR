...
module FAU ( 
  ...
  aoi21  g067(.a(x39), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  ...
  nand4  g091(.a(new_n151_), .b(new_n129_), .c(x20), .d(new_n150_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n125_), .b(new_n145_), .c(new_n116_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x40), .b(new_n145_), .c(new_n116_), .O(new_n159_));
  ...
  oai22  g114(.a(new_n78_), .b(x27), .c(new_n129_), .d(new_n128_), .O(new_n177_));
  ...
  nand2  g121(.a(x39), .b(new_n84_), .O(new_n184_));
