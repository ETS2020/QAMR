...
module FAU ( 
  ...
  nor2   g000(.a(x17), .b(x10), .O(new_n63_));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n89_), .c(new_n63_), .O(z02));
  ...
  oai21  g049(.a(x17), .b(new_n72_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(new_n63_), .O(z10));
  ...
  nand3  g083(.a(new_n66_), .b(new_n80_), .c(new_n90_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(x27), .c(x17), .O(new_n147_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n124_), .c(new_n63_), .O(new_n162_));
  ...
  nand4  g104(.a(x40), .b(x39), .c(new_n150_), .d(new_n124_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n66_), .b(new_n90_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n79_), .c(new_n78_), .O(new_n171_));
  aoi21  g109(.a(new_n167_), .b(new_n69_), .c(new_n63_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n168_), .O(z14));
  inv1   g111(.a(x12), .O(new_n174_));
  nand4  g112(.a(new_n105_), .b(x34), .c(x27), .d(x26), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n174_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand4  g115(.a(new_n105_), .b(new_n177_), .c(x22), .d(x01), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(z16));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(x23), .c(x22), .d(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n105_), .O(z17));
  oai21  g120(.a(new_n82_), .b(x27), .c(new_n136_), .O(new_n183_));
  nand3  g121(.a(new_n140_), .b(new_n78_), .c(new_n135_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(x08), .c(new_n184_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n63_), .O(z18));
  inv1   g124(.a(new_n136_), .O(new_n187_));
  oai21  g125(.a(new_n90_), .b(new_n98_), .c(new_n139_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n98_), .c(new_n90_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n78_), .c(new_n135_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n105_), .O(z20));
  nand2  g130(.a(new_n143_), .b(new_n105_), .O(z19));
endmodule
