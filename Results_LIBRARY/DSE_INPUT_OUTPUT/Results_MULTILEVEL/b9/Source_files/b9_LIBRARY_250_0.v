...
module FAU ( 
  ...
  nand3  g033(.a(new_n95_), .b(new_n91_), .c(new_n76_), .O(z02));
  ...
  nand4  g063(.a(new_n125_), .b(x35), .c(new_n124_), .d(x07), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n123_), .c(new_n80_), .O(new_n127_));
  nand3  g065(.a(new_n75_), .b(x36), .c(x07), .O(new_n128_));
  ...
  aoi21  g078(.a(x39), .b(x29), .c(new_n80_), .O(new_n141_));
  nor2   g079(.a(x40), .b(new_n67_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g081(.a(x27), .b(x04), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n92_), .c(new_n143_), .O(new_n145_));
  ...
  nor2   g088(.a(new_n73_), .b(new_n64_), .O(new_n151_));
  ...
  nand4  g100(.a(new_n72_), .b(x36), .c(x20), .d(new_n160_), .O(new_n163_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n142_), .c(new_n168_), .O(new_n173_));
  ...
  nand3  g116(.a(new_n152_), .b(new_n80_), .c(x36), .O(new_n179_));
  ...
  aoi21  g132(.a(new_n192_), .b(new_n124_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n97_), .c(new_n90_), .d(new_n75_), .O(z18));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n143_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n66_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n138_), .c(x08), .O(new_n200_));
