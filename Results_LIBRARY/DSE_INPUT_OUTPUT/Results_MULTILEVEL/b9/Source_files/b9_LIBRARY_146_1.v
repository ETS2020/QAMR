...
module FAU ( 
  ...
  nor2   g001(.a(new_n63_), .b(x10), .O(new_n64_));
  ...
  oai21  g012(.a(new_n74_), .b(x17), .c(new_n73_), .O(new_n75_));
  ...
  oai21  g048(.a(new_n65_), .b(new_n73_), .c(x17), .O(new_n111_));
  ...
  nand3  g055(.a(new_n117_), .b(new_n105_), .c(new_n115_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n114_), .c(new_n108_), .O(z07));
  nand2  g057(.a(new_n93_), .b(new_n105_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n105_), .O(z09));
  ...
  nor2   g073(.a(new_n98_), .b(new_n123_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n82_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n91_), .b(x27), .c(new_n123_), .O(new_n139_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n105_), .O(z11));
  oai21  g081(.a(new_n93_), .b(x04), .c(new_n70_), .O(new_n144_));
  nand3  g082(.a(new_n67_), .b(new_n80_), .c(new_n90_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(x27), .c(new_n63_), .O(new_n146_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n123_), .c(new_n64_), .O(new_n161_));
  ...
  nand4  g103(.a(x40), .b(x39), .c(new_n149_), .d(new_n123_), .O(new_n166_));
  ...
  oai21  g119(.a(new_n82_), .b(x27), .c(new_n135_), .O(new_n182_));
  nand3  g120(.a(new_n139_), .b(new_n78_), .c(new_n134_), .O(new_n183_));
  ...
  oai21  g124(.a(new_n90_), .b(new_n98_), .c(new_n138_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n98_), .c(new_n90_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n78_), .c(new_n134_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n105_), .O(z20));
  nand2  g129(.a(new_n142_), .b(new_n105_), .O(z19));
endmodule
