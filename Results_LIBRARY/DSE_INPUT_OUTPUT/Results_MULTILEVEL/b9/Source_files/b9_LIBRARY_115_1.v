...
module FAU ( 
  ...
  aoi21  g041(.a(new_n103_), .b(new_n65_), .c(new_n79_), .O(z05));
  nand3  g042(.a(new_n103_), .b(new_n64_), .c(new_n65_), .O(new_n105_));
  ...
  oai22  g060(.a(new_n94_), .b(new_n121_), .c(x40), .d(new_n122_), .O(new_n123_));
  ...
  aoi21  g065(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(new_n128_));
  nand4  g066(.a(new_n128_), .b(x39), .c(x05), .d(new_n71_), .O(new_n129_));
  ...
  nand2  g073(.a(new_n64_), .b(new_n98_), .O(new_n136_));
  ...
  oai21  g080(.a(new_n142_), .b(new_n98_), .c(new_n73_), .O(new_n143_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n98_), .O(new_n153_));
  ...
  aoi21  g121(.a(x28), .b(new_n98_), .c(new_n176_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n133_), .O(new_n185_));
  nand2  g123(.a(x39), .b(new_n176_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n136_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n80_), .O(new_n188_));
