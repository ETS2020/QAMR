...
module FAU ( 
  ...
  nor2   g027(.a(x30), .b(x19), .O(new_n90_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n90_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n70_), .c(new_n90_), .O(z05));
  ...
  nand3  g053(.a(new_n115_), .b(new_n82_), .c(x03), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z07));
  inv1   g055(.a(x39), .O(new_n118_));
  inv1   g056(.a(x40), .O(new_n119_));
  nor3   g057(.a(new_n90_), .b(new_n119_), .c(new_n118_), .O(z08));
  ...
  nand3  g062(.a(new_n76_), .b(x19), .c(x05), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n124_), .c(new_n85_), .O(new_n126_));
  inv1   g064(.a(x06), .O(new_n127_));
  nor3   g065(.a(new_n90_), .b(new_n70_), .c(new_n127_), .O(new_n128_));
  aoi21  g066(.a(new_n126_), .b(new_n65_), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(x32), .b(x19), .O(new_n130_));
  ...
  nand4  g091(.a(new_n72_), .b(x20), .c(new_n80_), .d(new_n153_), .O(new_n154_));
  ...
  nor3   g095(.a(new_n157_), .b(new_n118_), .c(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n65_), .c(new_n90_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z13));
  aoi21  g098(.a(new_n151_), .b(x27), .c(x32), .O(new_n161_));
  nand3  g099(.a(new_n76_), .b(new_n150_), .c(new_n65_), .O(new_n162_));
  aoi21  g100(.a(new_n161_), .b(new_n81_), .c(new_n162_), .O(new_n163_));
  nand4  g101(.a(new_n72_), .b(x27), .c(x20), .d(new_n153_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(x30), .O(new_n165_));
  oai21  g103(.a(new_n163_), .b(new_n80_), .c(new_n165_), .O(z14));
  inv1   g104(.a(x12), .O(new_n167_));
  nor2   g105(.a(new_n122_), .b(new_n167_), .O(z15));
  ...
  nand2  g113(.a(new_n94_), .b(new_n64_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n135_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n80_), .b(x09), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n178_), .c(new_n140_), .d(new_n81_), .O(z18));
  inv1   g118(.a(new_n135_), .O(new_n181_));
  aoi21  g119(.a(new_n66_), .b(x19), .c(x28), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n136_), .c(new_n181_), .O(new_n183_));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(x19), .O(new_n184_));
  nor2   g122(.a(x28), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(x08), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n183_), .c(new_n134_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(x19), .c(x30), .O(z19));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(new_n139_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n181_), .c(new_n189_), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n81_), .c(x19), .d(new_n134_), .O(new_n192_));
