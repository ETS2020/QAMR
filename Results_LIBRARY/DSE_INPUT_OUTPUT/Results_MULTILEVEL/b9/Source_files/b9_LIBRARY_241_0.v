...
module FAU ( 
  ...
  aoi21  g035(.a(new_n97_), .b(new_n92_), .c(new_n63_), .O(z04));
  ...
  nand4  g057(.a(new_n85_), .b(new_n79_), .c(x27), .d(x07), .O(new_n120_));
  inv1   g058(.a(new_n85_), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(x05), .c(new_n76_), .O(new_n122_));
  ...
  nand3  g067(.a(x35), .b(new_n87_), .c(new_n66_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  inv1   g069(.a(new_n131_), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(new_n76_), .c(new_n127_), .d(x04), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  nand3  g072(.a(new_n94_), .b(new_n78_), .c(new_n77_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(x27), .c(x10), .O(new_n136_));
  inv1   g074(.a(new_n67_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x27), .c(new_n121_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n136_), .c(x30), .O(new_n139_));
  oai21  g077(.a(new_n67_), .b(new_n66_), .c(x04), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(z12));
  inv1   g079(.a(x19), .O(new_n142_));
  nor2   g080(.a(new_n67_), .b(new_n63_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(x27), .c(x20), .d(new_n142_), .O(new_n144_));
  inv1   g082(.a(x13), .O(new_n145_));
  nand4  g083(.a(new_n121_), .b(x30), .c(new_n145_), .d(new_n119_), .O(new_n146_));
  oai21  g084(.a(new_n144_), .b(x18), .c(new_n146_), .O(z13));
  oai21  g085(.a(new_n85_), .b(x13), .c(x30), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  nand4  g087(.a(x27), .b(x20), .c(new_n142_), .d(new_n149_), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  aoi22  g089(.a(new_n151_), .b(new_n137_), .c(new_n148_), .d(new_n119_), .O(z14));
  nand4  g090(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n83_), .O(z15));
  inv1   g092(.a(x23), .O(new_n155_));
  nand4  g093(.a(new_n83_), .b(new_n155_), .c(x22), .d(x01), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x23), .c(x22), .d(x01), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n83_), .O(z17));
  oai21  g098(.a(new_n131_), .b(x09), .c(x04), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n76_), .O(z18));
  nand3  g100(.a(x35), .b(new_n87_), .c(new_n66_), .O(new_n163_));
  ...
  aoi21  g104(.a(new_n166_), .b(x04), .c(x30), .O(z19));
  inv1   g105(.a(new_n129_), .O(new_n168_));
  aoi21  g106(.a(x28), .b(new_n66_), .c(new_n77_), .O(new_n169_));
  oai21  g107(.a(new_n77_), .b(new_n66_), .c(new_n128_), .O(new_n170_));
  oai21  g108(.a(new_n169_), .b(new_n168_), .c(new_n170_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n127_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(x04), .c(x30), .O(z20));
endmodule
