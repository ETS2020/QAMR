...
module FAU ( 
  ...
  oai21  g012(.a(new_n74_), .b(x00), .c(new_n63_), .O(new_n75_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(new_n64_), .O(z02));
  ...
  oai22  g049(.a(new_n111_), .b(new_n63_), .c(x38), .d(x00), .O(new_n112_));
  ...
  nor2   g054(.a(new_n63_), .b(new_n116_), .O(new_n117_));
  oai21  g055(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n113_), .c(new_n105_), .O(z07));
  nand2  g057(.a(new_n92_), .b(new_n64_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n64_), .O(z09));
  inv1   g060(.a(x04), .O(new_n123_));
  nand2  g061(.a(new_n92_), .b(x07), .O(new_n124_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n133_), .c(new_n65_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x40), .b(x39), .c(x29), .O(new_n137_));
  nor2   g075(.a(new_n97_), .b(new_n123_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n82_), .c(new_n137_), .O(new_n139_));
  inv1   g077(.a(x08), .O(new_n140_));
  nand4  g078(.a(x35), .b(new_n81_), .c(x27), .d(new_n123_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n78_), .c(new_n136_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n64_), .O(z11));
  oai21  g083(.a(new_n92_), .b(x04), .c(new_n69_), .O(new_n146_));
  inv1   g084(.a(x35), .O(new_n147_));
  nand3  g085(.a(new_n80_), .b(new_n147_), .c(new_n63_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(x37), .O(new_n149_));
  nor2   g087(.a(x27), .b(x10), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n116_), .O(new_n151_));
  nand2  g089(.a(new_n93_), .b(new_n123_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n71_), .c(x10), .O(new_n153_));
  ...
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n155_), .d(new_n123_), .O(new_n159_));
  inv1   g097(.a(x18), .O(new_n160_));
  inv1   g098(.a(x19), .O(new_n161_));
  nand4  g099(.a(new_n70_), .b(x20), .c(new_n161_), .d(new_n160_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x27), .O(new_n164_));
  nand3  g102(.a(new_n130_), .b(new_n155_), .c(new_n123_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n164_), .c(new_n65_), .O(z13));
  nand3  g104(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n167_));
  nand4  g105(.a(new_n157_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n93_), .b(new_n155_), .c(new_n123_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .O(new_n171_));
  nand3  g109(.a(new_n68_), .b(new_n147_), .c(x28), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(x27), .c(x32), .O(new_n173_));
  aoi22  g111(.a(new_n173_), .b(new_n78_), .c(new_n170_), .d(new_n71_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(new_n65_), .O(z14));
  ...
  oai21  g123(.a(new_n82_), .b(x27), .c(new_n137_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n65_), .b(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n141_), .d(new_n78_), .O(z18));
  nand4  g127(.a(new_n143_), .b(new_n64_), .c(new_n78_), .d(new_n136_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z19));
  inv1   g129(.a(new_n137_), .O(new_n192_));
  oai21  g130(.a(new_n147_), .b(new_n97_), .c(new_n140_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n97_), .c(new_n147_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n78_), .c(new_n136_), .O(new_n196_));
