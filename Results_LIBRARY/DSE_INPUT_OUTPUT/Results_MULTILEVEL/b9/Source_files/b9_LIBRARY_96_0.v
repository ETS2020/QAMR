...
module FAU ( 
  ...
  nand2  g027(.a(new_n89_), .b(x40), .O(new_n90_));
  oai21  g028(.a(new_n90_), .b(new_n85_), .c(x39), .O(new_n91_));
  nor2   g029(.a(new_n73_), .b(x39), .O(new_n92_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n67_), .c(new_n63_), .O(z05));
  inv1   g040(.a(new_n63_), .O(new_n103_));
  nand3  g041(.a(new_n101_), .b(new_n103_), .c(new_n67_), .O(new_n104_));
  ...
  nand2  g053(.a(new_n115_), .b(new_n103_), .O(z07));
  inv1   g054(.a(x39), .O(new_n117_));
  nor2   g055(.a(new_n73_), .b(new_n117_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n103_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n119_), .O(z09));
  aoi21  g059(.a(x35), .b(new_n86_), .c(x36), .O(new_n122_));
  ...
  nor3   g065(.a(new_n63_), .b(new_n67_), .c(new_n127_), .O(new_n128_));
  aoi21  g066(.a(new_n126_), .b(new_n71_), .c(new_n128_), .O(new_n129_));
  oai21  g067(.a(x32), .b(x30), .c(x40), .O(new_n130_));
  nor2   g068(.a(new_n130_), .b(new_n117_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x05), .c(new_n71_), .O(new_n132_));
  oai21  g070(.a(new_n129_), .b(new_n66_), .c(new_n132_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nor2   g073(.a(new_n66_), .b(new_n71_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n87_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n81_), .b(x27), .c(new_n71_), .O(new_n139_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n103_), .O(z11));
  inv1   g081(.a(x36), .O(new_n144_));
  nand3  g082(.a(new_n67_), .b(new_n144_), .c(new_n80_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi21  g084(.a(x40), .b(new_n71_), .c(new_n69_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x39), .O(new_n148_));
  inv1   g086(.a(new_n69_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(x40), .c(new_n117_), .O(new_n150_));
  ...
  nand4  g092(.a(new_n154_), .b(x40), .c(new_n152_), .d(new_n71_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand2  g095(.a(new_n68_), .b(new_n67_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(new_n117_), .O(new_n160_));
  nand4  g098(.a(new_n158_), .b(x40), .c(x20), .d(new_n157_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n131_), .b(new_n152_), .c(new_n71_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand3  g103(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n166_));
  nand4  g104(.a(new_n153_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x40), .b(new_n152_), .c(new_n71_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n117_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n92_), .c(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n67_), .b(new_n80_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n79_), .c(new_n78_), .O(new_n174_));
  nand2  g112(.a(new_n168_), .b(new_n149_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x39), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n171_), .c(new_n150_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nor2   g117(.a(new_n120_), .b(new_n179_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x22), .c(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n103_), .O(z16));
  inv1   g121(.a(x01), .O(new_n184_));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n103_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  ...
  nor2   g127(.a(new_n63_), .b(x30), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n189_), .c(new_n139_), .d(new_n134_), .O(z18));
  inv1   g129(.a(new_n135_), .O(new_n192_));
  oai21  g130(.a(new_n80_), .b(new_n66_), .c(new_n138_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n66_), .c(new_n80_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n78_), .c(new_n134_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n103_), .O(z20));
  nand2  g135(.a(new_n142_), .b(new_n103_), .O(z19));
endmodule
