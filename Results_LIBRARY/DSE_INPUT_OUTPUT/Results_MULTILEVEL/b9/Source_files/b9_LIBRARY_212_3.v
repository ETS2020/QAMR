...
module FAU ( 
  ...
  nand2  g000(.a(x34), .b(x30), .O(new_n63_));
  ...
  nand3  g027(.a(new_n89_), .b(new_n63_), .c(x04), .O(z01));
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n78_), .d(new_n63_), .O(z02));
  nand2  g034(.a(new_n73_), .b(x27), .O(new_n97_));
  nand2  g035(.a(new_n72_), .b(new_n66_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n97_), .c(new_n63_), .d(x21), .O(z03));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n72_), .c(new_n64_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n63_), .c(new_n72_), .O(new_n104_));
  ...
  nand3  g054(.a(new_n63_), .b(x40), .c(x39), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z08));
  inv1   g056(.a(x34), .O(new_n119_));
  nand3  g057(.a(x27), .b(x26), .c(x11), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n83_), .c(new_n119_), .O(z09));
  nand2  g059(.a(x05), .b(new_n67_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n77_), .c(new_n119_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x30), .O(new_n124_));
  inv1   g062(.a(x05), .O(new_n125_));
  nand2  g063(.a(new_n77_), .b(x07), .O(new_n126_));
  oai21  g064(.a(new_n77_), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n87_), .c(x27), .O(new_n128_));
  nand3  g066(.a(new_n78_), .b(x32), .c(x05), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n67_), .O(new_n131_));
  ...
  nor2   g073(.a(new_n66_), .b(new_n67_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n86_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nor2   g076(.a(new_n68_), .b(x28), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x27), .c(new_n67_), .O(new_n140_));
  ...
  oai22  g085(.a(new_n77_), .b(x04), .c(new_n75_), .d(new_n66_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n64_), .O(z12));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n67_), .c(new_n64_), .O(new_n163_));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n78_), .c(new_n64_), .O(new_n167_));
  nand4  g105(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(new_n165_), .O(new_n170_));
  nand3  g108(.a(new_n72_), .b(new_n68_), .c(x28), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(x27), .c(x32), .O(new_n172_));
  aoi22  g110(.a(new_n166_), .b(new_n78_), .c(new_n74_), .d(x27), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(new_n83_), .O(new_n174_));
  nand2  g112(.a(new_n173_), .b(new_n119_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n170_), .O(z14));
  nand3  g114(.a(x27), .b(x26), .c(x12), .O(new_n177_));
  nor3   g115(.a(new_n177_), .b(new_n119_), .c(x30), .O(z15));
  ...
  oai21  g122(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n140_), .c(new_n83_), .d(new_n134_), .O(z18));
  inv1   g125(.a(new_n143_), .O(z19));
  inv1   g126(.a(new_n135_), .O(new_n189_));
  oai21  g127(.a(new_n68_), .b(new_n66_), .c(new_n138_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n83_), .c(new_n134_), .O(new_n193_));
