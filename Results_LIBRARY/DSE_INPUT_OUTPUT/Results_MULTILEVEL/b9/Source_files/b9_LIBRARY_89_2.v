...
module FAU ( 
  ...
  nor2   g024(.a(new_n80_), .b(x28), .O(new_n87_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n91_), .O(z03));
  nand2  g034(.a(new_n65_), .b(new_n94_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n92_), .c(new_n64_), .d(new_n93_), .O(z04));
  inv1   g036(.a(x28), .O(new_n99_));
  nor2   g037(.a(new_n99_), .b(new_n94_), .O(new_n100_));
  ...
  nand2  g060(.a(new_n79_), .b(new_n78_), .O(new_n123_));
  ...
  aoi21  g067(.a(x40), .b(new_n129_), .c(new_n115_), .O(new_n130_));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n87_), .c(new_n130_), .O(new_n132_));
  nand2  g070(.a(new_n64_), .b(new_n94_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n99_), .c(new_n71_), .O(new_n134_));
  ...
  oai21  g078(.a(new_n115_), .b(x04), .c(new_n68_), .O(new_n141_));
  ...
  nand3  g088(.a(new_n123_), .b(new_n143_), .c(new_n71_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x40), .c(new_n115_), .O(new_n152_));
  or2    g090(.a(new_n152_), .b(new_n150_), .O(z13));
  aoi21  g091(.a(new_n143_), .b(new_n71_), .c(new_n63_), .O(new_n154_));
  nor2   g092(.a(x19), .b(x18), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n67_), .c(x27), .d(x20), .O(new_n156_));
  oai21  g094(.a(new_n154_), .b(new_n115_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g098(.a(new_n160_), .b(new_n99_), .c(x27), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x40), .c(new_n79_), .d(new_n78_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n157_), .O(z14));
  inv1   g101(.a(x12), .O(new_n164_));
  nand4  g102(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n164_), .O(z15));
  ...
  nand2  g111(.a(x27), .b(new_n71_), .O(new_n174_));
  nand2  g112(.a(new_n94_), .b(x08), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n174_), .c(new_n80_), .O(new_n176_));
  inv1   g114(.a(x09), .O(new_n177_));
  nand2  g115(.a(new_n78_), .b(new_n177_), .O(new_n178_));
  aoi21  g116(.a(new_n176_), .b(new_n99_), .c(new_n178_), .O(new_n179_));
  nand3  g117(.a(z08), .b(x29), .c(x08), .O(new_n180_));
  oai21  g118(.a(new_n179_), .b(new_n91_), .c(new_n180_), .O(z18));
  nand2  g119(.a(x39), .b(x04), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x35), .c(new_n99_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x40), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n133_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n132_), .c(new_n78_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(x09), .O(z19));
  nor2   g125(.a(new_n80_), .b(new_n94_), .O(new_n188_));
  nor2   g126(.a(new_n115_), .b(new_n129_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n94_), .c(new_n80_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(x08), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n78_), .c(new_n177_), .O(new_n192_));
