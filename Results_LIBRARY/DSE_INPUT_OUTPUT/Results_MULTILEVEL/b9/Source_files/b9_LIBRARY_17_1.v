...
module FAU ( 
  ...
  oai21  g034(.a(new_n96_), .b(new_n93_), .c(x34), .O(new_n97_));
  ...
  oai21  g041(.a(new_n87_), .b(new_n64_), .c(new_n70_), .O(new_n104_));
  and2   g042(.a(new_n104_), .b(new_n82_), .O(z05));
  ...
  nand3  g055(.a(x40), .b(x39), .c(x34), .O(new_n118_));
  ...
  aoi21  g060(.a(new_n75_), .b(x34), .c(new_n76_), .O(new_n123_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n84_), .O(new_n149_));
  ...
  nand4  g096(.a(new_n130_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x34), .c(new_n76_), .O(new_n160_));
  or2    g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n163_));
  ...
  nand3  g106(.a(new_n168_), .b(new_n86_), .c(new_n85_), .O(new_n169_));
  aoi21  g107(.a(new_n165_), .b(new_n147_), .c(new_n84_), .O(new_n170_));
  ...
  nand4  g112(.a(new_n82_), .b(new_n174_), .c(x22), .d(x01), .O(new_n175_));
  ...
  nand2  g119(.a(new_n77_), .b(x29), .O(new_n182_));
  oai21  g120(.a(new_n88_), .b(x27), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand3  g122(.a(new_n138_), .b(x27), .c(new_n65_), .O(new_n185_));
  nor2   g123(.a(new_n84_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n181_), .O(z18));
  nand2  g125(.a(new_n141_), .b(new_n138_), .O(new_n188_));
  ...
  nand3  g130(.a(new_n192_), .b(new_n85_), .c(new_n181_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n82_), .O(z19));
  inv1   g132(.a(new_n182_), .O(new_n195_));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(new_n190_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n85_), .c(new_n181_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n82_), .O(z20));
endmodule
