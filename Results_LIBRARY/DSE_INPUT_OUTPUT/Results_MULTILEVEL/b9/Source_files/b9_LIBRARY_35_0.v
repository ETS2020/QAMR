...
module FAU ( 
  ...
  nor2   g017(.a(x40), .b(x23), .O(new_n80_));
  ...
  nand4  g112(.a(x40), .b(new_n174_), .c(x22), .d(x01), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(z16));
  nand3  g114(.a(x23), .b(x22), .c(x01), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(x24), .O(z17));
  nand2  g116(.a(new_n64_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n137_), .c(new_n66_), .O(new_n180_));
  nand2  g118(.a(new_n83_), .b(new_n132_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(new_n85_), .c(new_n181_), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n80_), .c(new_n92_), .d(new_n75_), .O(z18));
  ...
  nand3  g125(.a(new_n187_), .b(new_n83_), .c(new_n132_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n81_), .O(z20));
  nand2  g127(.a(new_n140_), .b(new_n81_), .O(z19));
endmodule
