...
module FAU ( 
  ...
  aoi21  g059(.a(new_n121_), .b(x30), .c(new_n84_), .O(z09));
  ...
  nand2  g068(.a(x32), .b(new_n84_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n80_), .c(new_n119_), .O(new_n132_));
  ...
  nor3   g098(.a(new_n160_), .b(new_n118_), .c(x13), .O(new_n161_));
  ...
  nand4  g102(.a(x40), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(x36), .b(x35), .c(x32), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n80_), .c(x28), .d(new_n84_), .O(new_n168_));
  oai21  g106(.a(new_n166_), .b(new_n83_), .c(new_n168_), .O(new_n169_));
  ...
  nand3  g110(.a(new_n172_), .b(new_n85_), .c(new_n80_), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(new_n174_));
  aoi21  g112(.a(new_n72_), .b(x27), .c(new_n166_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n174_), .c(new_n84_), .O(new_n176_));
  ...
  aoi21  g117(.a(new_n179_), .b(x30), .c(new_n84_), .O(z15));
  ...
  nand2  g124(.a(new_n86_), .b(new_n64_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n136_), .c(new_n140_), .O(new_n188_));
  nand2  g126(.a(new_n141_), .b(new_n135_), .O(new_n189_));
  ...
  aoi21  g130(.a(new_n66_), .b(new_n84_), .c(x28), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n137_), .c(new_n192_), .O(new_n194_));
  oai21  g132(.a(new_n66_), .b(new_n64_), .c(new_n84_), .O(new_n195_));
  nor2   g133(.a(x28), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n195_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n135_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n84_), .c(x30), .O(z19));
  oai21  g137(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n200_));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n192_), .c(new_n200_), .O(new_n202_));
  nand4  g140(.a(new_n202_), .b(new_n80_), .c(new_n84_), .d(new_n135_), .O(new_n203_));
