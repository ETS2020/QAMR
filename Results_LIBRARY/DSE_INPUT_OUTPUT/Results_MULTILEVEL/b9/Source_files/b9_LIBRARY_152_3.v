...
module FAU ( 
  ...
  nand2  g035(.a(new_n64_), .b(new_n91_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n97_), .c(new_n63_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n64_), .b(new_n91_), .c(x21), .O(new_n100_));
  ...
  nand2  g053(.a(new_n94_), .b(new_n63_), .O(z08));
  ...
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n86_), .O(z10));
  ...
  nand4  g073(.a(x35), .b(new_n80_), .c(x27), .d(new_n119_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n90_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n63_), .c(new_n77_), .d(new_n132_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  nand3  g078(.a(new_n65_), .b(new_n63_), .c(new_n64_), .O(new_n141_));
  oai21  g079(.a(x27), .b(x17), .c(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n94_), .b(x04), .c(new_n142_), .O(new_n143_));
  inv1   g081(.a(x35), .O(new_n144_));
  nor2   g082(.a(x37), .b(x36), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n144_), .c(new_n91_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(x10), .c(new_n143_), .O(z12));
  ...
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n148_), .d(new_n119_), .O(new_n152_));
  ...
  nand3  g095(.a(new_n126_), .b(new_n148_), .c(new_n119_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n157_), .c(new_n86_), .O(z13));
  nand3  g097(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n160_));
  nand4  g098(.a(new_n150_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nand4  g100(.a(x40), .b(x39), .c(new_n148_), .d(new_n119_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n64_), .b(new_n144_), .c(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(x27), .c(x32), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n77_), .c(new_n163_), .d(new_n67_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n164_), .c(new_n86_), .O(z14));
  ...
  oai21  g116(.a(new_n81_), .b(x27), .c(new_n133_), .O(new_n179_));
  nand3  g117(.a(new_n136_), .b(new_n77_), .c(new_n132_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(x08), .c(new_n180_), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n86_), .O(z18));
  inv1   g120(.a(new_n133_), .O(new_n183_));
  oai21  g121(.a(new_n144_), .b(new_n91_), .c(new_n90_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n91_), .c(new_n144_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n77_), .c(new_n132_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n63_), .O(z20));
  inv1   g126(.a(new_n139_), .O(z19));
endmodule
