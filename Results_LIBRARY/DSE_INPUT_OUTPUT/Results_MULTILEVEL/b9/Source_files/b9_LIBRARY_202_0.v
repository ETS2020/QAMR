...
module FAU ( 
  ...
  nand2  g063(.a(new_n76_), .b(x09), .O(new_n126_));
  ...
  nand3  g082(.a(new_n144_), .b(x27), .c(new_n65_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x40), .c(new_n84_), .d(new_n81_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(z11));
  inv1   g087(.a(x10), .O(new_n150_));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n64_), .c(new_n150_), .O(new_n152_));
  nand2  g090(.a(new_n72_), .b(x27), .O(new_n153_));
  oai21  g091(.a(new_n119_), .b(x04), .c(new_n153_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n152_), .c(new_n82_), .O(z12));
  ...
  nand3  g108(.a(new_n77_), .b(new_n156_), .c(new_n65_), .O(new_n171_));
  ...
  aoi21  g113(.a(new_n171_), .b(new_n153_), .c(new_n99_), .O(new_n176_));
  ...
  nand4  g118(.a(new_n82_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  ...
  nand2  g124(.a(new_n144_), .b(new_n64_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n140_), .c(new_n143_), .O(new_n188_));
  nand2  g126(.a(new_n145_), .b(new_n84_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(x40), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n81_), .O(z18));
  nand2  g129(.a(new_n147_), .b(new_n84_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(x40), .c(x09), .O(z19));
  aoi21  g131(.a(x35), .b(x27), .c(x08), .O(new_n194_));
  nand2  g132(.a(x28), .b(new_n64_), .O(new_n195_));
  aoi22  g133(.a(new_n195_), .b(x35), .c(x39), .d(x29), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n84_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(x40), .c(x09), .O(z20));
endmodule
