...
module FAU ( 
  ...
  nor2   g036(.a(new_n77_), .b(new_n92_), .O(new_n99_));
  inv1   g037(.a(new_n99_), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n71_), .c(new_n93_), .O(z05));
  oai21  g039(.a(new_n99_), .b(x37), .c(new_n71_), .O(z06));
  ...
  aoi21  g067(.a(x40), .b(new_n85_), .c(new_n67_), .O(new_n130_));
  ...
  aoi21  g092(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n143_), .d(new_n118_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x39), .b(new_n143_), .c(new_n118_), .O(new_n158_));
  ...
  nand3  g102(.a(new_n164_), .b(new_n75_), .c(new_n74_), .O(new_n165_));
  ...
  nand4  g107(.a(new_n71_), .b(new_n169_), .c(x22), .d(x01), .O(new_n170_));
  ...
  oai22  g112(.a(new_n78_), .b(x27), .c(new_n67_), .d(new_n85_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n92_), .b(x04), .O(new_n177_));
  ...
  nand3  g118(.a(new_n180_), .b(x35), .c(new_n77_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n133_), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n132_), .c(new_n74_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(x09), .O(z19));
  nor2   g123(.a(new_n67_), .b(new_n85_), .O(new_n186_));
  inv1   g124(.a(x35), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n92_), .c(new_n84_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n92_), .c(new_n187_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n186_), .c(new_n188_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n74_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(x09), .c(new_n71_), .O(z20));
