...
module FAU ( 
  ...
  nand2  g012(.a(x10), .b(new_n65_), .O(new_n75_));
  nand2  g013(.a(x40), .b(x39), .O(new_n76_));
  oai21  g014(.a(new_n76_), .b(new_n75_), .c(x17), .O(new_n77_));
  ...
  nor2   g024(.a(x17), .b(x15), .O(new_n87_));
  inv1   g025(.a(new_n87_), .O(new_n88_));
  nand3  g026(.a(new_n88_), .b(new_n86_), .c(x04), .O(z01));
  inv1   g027(.a(new_n76_), .O(new_n90_));
  ...
  oai21  g032(.a(new_n94_), .b(new_n83_), .c(x04), .O(new_n95_));
  ...
  nand4  g036(.a(new_n98_), .b(new_n97_), .c(new_n88_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n87_), .O(z04));
  aoi21  g039(.a(x28), .b(x27), .c(x37), .O(new_n102_));
  nor2   g040(.a(new_n102_), .b(new_n87_), .O(z05));
  ...
  nand3  g046(.a(x38), .b(new_n108_), .c(new_n107_), .O(new_n109_));
  nand3  g047(.a(new_n109_), .b(new_n88_), .c(new_n106_), .O(new_n110_));
  inv1   g048(.a(x31), .O(new_n111_));
  inv1   g049(.a(x33), .O(new_n112_));
  oai21  g050(.a(x25), .b(new_n107_), .c(x38), .O(new_n113_));
  nand4  g051(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(x15), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n110_), .c(new_n105_), .O(z07));
  inv1   g053(.a(x39), .O(new_n116_));
  inv1   g054(.a(x40), .O(new_n117_));
  nor3   g055(.a(new_n87_), .b(new_n117_), .c(new_n116_), .O(z08));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n88_), .O(z10));
  ...
  nand4  g074(.a(x35), .b(new_n82_), .c(x27), .d(new_n65_), .O(new_n137_));
  ...
  nand2  g078(.a(new_n140_), .b(new_n88_), .O(z11));
  ...
  oai21  g083(.a(new_n76_), .b(x04), .c(new_n145_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n144_), .c(new_n87_), .O(z12));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n65_), .c(new_n87_), .O(new_n159_));
  ...
  nand3  g101(.a(new_n90_), .b(new_n148_), .c(new_n65_), .O(new_n164_));
  ...
  aoi22  g105(.a(new_n167_), .b(new_n80_), .c(new_n164_), .d(new_n145_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n165_), .c(new_n87_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  nor2   g108(.a(new_n120_), .b(new_n170_), .O(z15));
  inv1   g109(.a(x23), .O(new_n172_));
  nand4  g110(.a(new_n88_), .b(new_n172_), .c(x22), .d(x01), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z16));
  inv1   g112(.a(x24), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(x23), .c(x22), .d(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n88_), .O(z17));
  oai21  g115(.a(new_n83_), .b(x27), .c(new_n133_), .O(new_n178_));
  nand3  g116(.a(new_n137_), .b(new_n80_), .c(new_n132_), .O(new_n179_));
  aoi21  g117(.a(new_n178_), .b(x08), .c(new_n179_), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n87_), .O(z18));
  nand4  g119(.a(new_n139_), .b(new_n88_), .c(new_n80_), .d(new_n132_), .O(new_n182_));
  ...
  nand4  g125(.a(new_n187_), .b(new_n88_), .c(new_n80_), .d(new_n132_), .O(new_n188_));
