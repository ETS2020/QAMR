...
module FAU ( 
  ...
  nor2   g012(.a(x22), .b(x19), .O(new_n75_));
  ...
  nand2  g028(.a(new_n64_), .b(new_n90_), .O(new_n91_));
  nand3  g029(.a(new_n91_), .b(x35), .c(new_n80_), .O(new_n92_));
  aoi21  g030(.a(new_n92_), .b(x04), .c(new_n89_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(new_n88_), .c(new_n75_), .O(z02));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n75_), .O(z03));
  nand2  g037(.a(new_n97_), .b(new_n64_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n95_), .c(new_n76_), .d(new_n96_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n76_), .c(new_n97_), .O(z05));
  ...
  nand2  g053(.a(new_n76_), .b(new_n89_), .O(z08));
  ...
  aoi21  g066(.a(new_n128_), .b(new_n127_), .c(new_n75_), .O(z10));
  ...
  nand4  g071(.a(x35), .b(new_n80_), .c(x27), .d(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n90_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(new_n76_), .c(new_n78_), .d(new_n130_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  inv1   g076(.a(x10), .O(new_n139_));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n64_), .c(new_n139_), .O(new_n141_));
  oai22  g079(.a(new_n89_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n76_), .O(z12));
  ...
  nand4  g085(.a(new_n147_), .b(x39), .c(new_n144_), .d(new_n65_), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  inv1   g088(.a(x20), .O(new_n151_));
  nor2   g089(.a(new_n70_), .b(new_n151_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n150_), .c(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n124_), .b(x40), .c(x39), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x13), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n65_), .c(new_n75_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  inv1   g097(.a(x22), .O(new_n160_));
  aoi21  g098(.a(x20), .b(new_n149_), .c(new_n160_), .O(new_n161_));
  nand4  g099(.a(new_n146_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  nand4  g101(.a(x40), .b(x39), .c(new_n144_), .d(new_n65_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n163_), .c(new_n161_), .d(x19), .O(new_n165_));
  nand3  g103(.a(new_n97_), .b(new_n66_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n79_), .c(new_n78_), .O(new_n168_));
  oai21  g106(.a(new_n70_), .b(new_n64_), .c(new_n164_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x22), .O(new_n171_));
  nand4  g109(.a(new_n79_), .b(new_n78_), .c(new_n64_), .d(x19), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n165_), .O(z14));
  inv1   g111(.a(x12), .O(new_n174_));
  nor2   g112(.a(new_n118_), .b(new_n174_), .O(z15));
  ...
  oai21  g118(.a(new_n81_), .b(x27), .c(new_n131_), .O(new_n181_));
  nand3  g119(.a(new_n134_), .b(new_n78_), .c(new_n130_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(x08), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n75_), .O(z18));
  ...
  nand4  g126(.a(new_n188_), .b(new_n76_), .c(new_n78_), .d(new_n130_), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(z20));
  inv1   g128(.a(new_n137_), .O(z19));
endmodule
