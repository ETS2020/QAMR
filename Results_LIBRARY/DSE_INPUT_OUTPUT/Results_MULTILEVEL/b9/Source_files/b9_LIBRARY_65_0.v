// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:36 2020
...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n92_), .c(x39), .O(new_n96_));
  nand2  g034(.a(x40), .b(new_n80_), .O(new_n97_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n88_), .c(x27), .O(new_n128_));
  ...
  nand2  g073(.a(new_n76_), .b(x29), .O(new_n136_));
  ...
  nand3  g079(.a(new_n137_), .b(x27), .c(new_n65_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n84_), .c(new_n135_), .O(new_n145_));
  ...
  nand3  g100(.a(new_n129_), .b(x40), .c(x39), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n65_), .c(new_n99_), .O(new_n165_));
  ...
  nand4  g106(.a(new_n155_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n169_));
  nand3  g107(.a(x40), .b(new_n154_), .c(new_n65_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n80_), .O(new_n172_));
  ...
  nand3  g117(.a(new_n179_), .b(new_n173_), .c(new_n152_), .O(z14));
  inv1   g118(.a(x12), .O(new_n181_));
  nor2   g119(.a(new_n123_), .b(new_n181_), .O(z15));
  ...
  oai21  g126(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n99_), .b(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n142_), .d(new_n135_), .O(z18));
  nand2  g130(.a(new_n82_), .b(new_n64_), .O(new_n193_));
  nand3  g131(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x39), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n193_), .c(x08), .O(new_n196_));
  nand2  g134(.a(x40), .b(x29), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(x39), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(new_n97_), .c(new_n138_), .d(new_n137_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n196_), .c(new_n84_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z19));
  nand2  g139(.a(x28), .b(new_n64_), .O(new_n202_));
  aoi22  g140(.a(new_n202_), .b(x35), .c(new_n198_), .d(new_n97_), .O(new_n203_));
  nand2  g141(.a(x39), .b(new_n66_), .O(new_n204_));
  aoi21  g142(.a(new_n204_), .b(new_n193_), .c(x08), .O(new_n205_));
