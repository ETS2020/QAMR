...
module FAU ( 
  ...
  oai21  g040(.a(new_n85_), .b(new_n66_), .c(new_n72_), .O(new_n103_));
  and2   g041(.a(new_n103_), .b(new_n83_), .O(z05));
  ...
  oai21  g060(.a(new_n122_), .b(new_n77_), .c(x29), .O(new_n123_));
  ...
  nand2  g086(.a(new_n74_), .b(x27), .O(new_n149_));
  oai21  g087(.a(new_n77_), .b(x04), .c(new_n149_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n148_), .c(new_n64_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n118_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n67_), .O(new_n155_));
  ...
  nor3   g099(.a(new_n161_), .b(new_n117_), .c(x13), .O(new_n162_));
  ...
  nand4  g103(.a(new_n153_), .b(new_n84_), .c(new_n63_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n78_), .b(new_n152_), .c(new_n67_), .O(new_n168_));
  ...
  nand3  g109(.a(new_n171_), .b(new_n84_), .c(new_n63_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n149_), .c(new_n64_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nand4  g113(.a(new_n83_), .b(x34), .c(x27), .d(x26), .O(new_n176_));
  nor2   g114(.a(new_n176_), .b(new_n175_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x22), .c(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n83_), .O(z16));
  inv1   g118(.a(x01), .O(new_n181_));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n83_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  ...
  nand4  g124(.a(new_n186_), .b(new_n141_), .c(new_n63_), .d(new_n134_), .O(z18));
  nand2  g125(.a(new_n137_), .b(new_n77_), .O(new_n188_));
  nand2  g126(.a(new_n92_), .b(new_n68_), .O(new_n189_));
  nand3  g127(.a(new_n85_), .b(x27), .c(new_n67_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n139_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n189_), .c(new_n188_), .O(new_n192_));
  aoi21  g130(.a(new_n136_), .b(new_n85_), .c(x29), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n63_), .c(new_n193_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(x09), .c(new_n83_), .O(z19));
  inv1   g133(.a(new_n135_), .O(new_n196_));
  oai21  g134(.a(new_n68_), .b(new_n66_), .c(new_n139_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n63_), .c(new_n134_), .O(new_n200_));
