...
module FAU ( 
  ...
  nor2   g032(.a(new_n83_), .b(x25), .O(new_n95_));
  ...
  nand3  g048(.a(x38), .b(new_n80_), .c(new_n108_), .O(new_n111_));
  inv1   g049(.a(new_n111_), .O(new_n112_));
  oai22  g050(.a(new_n112_), .b(x14), .c(new_n110_), .d(x31), .O(new_n113_));
  ...
  nor3   g055(.a(new_n95_), .b(new_n117_), .c(new_n116_), .O(z08));
  ...
  nor2   g063(.a(new_n95_), .b(new_n70_), .O(new_n126_));
  aoi22  g064(.a(new_n126_), .b(x06), .c(new_n125_), .d(new_n65_), .O(new_n127_));
  nand2  g065(.a(x30), .b(x25), .O(new_n128_));
  oai21  g066(.a(new_n84_), .b(x30), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g094(.a(new_n72_), .b(x25), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n131_), .b(new_n149_), .c(new_n65_), .O(new_n160_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n76_), .c(new_n95_), .O(new_n164_));
  ...
  aoi22  g107(.a(new_n163_), .b(new_n76_), .c(new_n72_), .d(x27), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n83_), .O(new_n171_));
  nand2  g109(.a(new_n170_), .b(x25), .O(new_n172_));
