...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n84_), .c(x39), .O(z02));
  ...
  aoi21  g095(.a(new_n76_), .b(new_n75_), .c(new_n84_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n146_), .d(new_n118_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  aoi21  g098(.a(new_n146_), .b(new_n118_), .c(new_n84_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .d(new_n70_), .O(new_n163_));
  ...
  nand4  g105(.a(new_n167_), .b(x40), .c(new_n76_), .d(new_n75_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n163_), .O(z14));
  nand4  g107(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n74_), .O(z15));
  inv1   g109(.a(x23), .O(new_n172_));
  nand4  g110(.a(new_n74_), .b(new_n172_), .c(x22), .d(x01), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z16));
  inv1   g112(.a(x01), .O(new_n175_));
  inv1   g113(.a(x24), .O(new_n176_));
  nand4  g114(.a(new_n74_), .b(new_n176_), .c(x23), .d(x22), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n175_), .O(z17));
  nand2  g116(.a(x27), .b(new_n118_), .O(new_n179_));
  nand2  g117(.a(new_n87_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n140_), .O(new_n181_));
  nand2  g119(.a(new_n75_), .b(new_n129_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n78_), .c(new_n182_), .O(new_n183_));
  nand4  g121(.a(x40), .b(x39), .c(x29), .d(x08), .O(new_n184_));
  oai21  g122(.a(new_n183_), .b(new_n71_), .c(new_n184_), .O(z18));
  oai21  g123(.a(new_n179_), .b(new_n79_), .c(new_n86_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n132_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n75_), .c(new_n129_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n74_), .O(z19));
  nor2   g127(.a(new_n70_), .b(new_n130_), .O(new_n190_));
  oai21  g128(.a(new_n140_), .b(new_n87_), .c(new_n86_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n87_), .c(new_n140_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n75_), .c(new_n129_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n74_), .O(z20));
