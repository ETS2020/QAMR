...
module FAU ( 
  ...
  nor2   g001(.a(x34), .b(new_n63_), .O(new_n64_));
  ...
  nand3  g041(.a(new_n102_), .b(new_n83_), .c(new_n72_), .O(new_n104_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n83_), .c(x03), .O(new_n115_));
  ...
  nand2  g058(.a(new_n120_), .b(new_n83_), .O(z09));
  nand2  g059(.a(x05), .b(new_n67_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n77_), .c(x34), .O(new_n123_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n63_), .c(new_n134_), .O(new_n143_));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n67_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n74_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  ...
  nor3   g097(.a(new_n159_), .b(new_n117_), .c(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n67_), .c(new_n64_), .O(new_n161_));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n78_), .c(new_n64_), .O(new_n165_));
  nand4  g103(.a(new_n151_), .b(new_n84_), .c(new_n63_), .d(x28), .O(new_n166_));
  ...
  aoi22  g108(.a(new_n164_), .b(new_n78_), .c(new_n74_), .d(x27), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n63_), .O(new_n172_));
  nand2  g110(.a(new_n171_), .b(x34), .O(new_n173_));
  ...
  nand2  g116(.a(new_n178_), .b(new_n83_), .O(z16));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(x23), .c(x22), .d(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n83_), .O(z17));
  oai21  g120(.a(new_n86_), .b(x27), .c(new_n135_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n140_), .c(new_n63_), .d(new_n134_), .O(z18));
  inv1   g123(.a(new_n143_), .O(z19));
  inv1   g124(.a(new_n135_), .O(new_n187_));
  oai21  g125(.a(new_n68_), .b(new_n66_), .c(new_n138_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n63_), .c(new_n134_), .O(new_n191_));
