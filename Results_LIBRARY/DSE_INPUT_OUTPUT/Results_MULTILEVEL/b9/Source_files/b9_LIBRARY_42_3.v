...
module FAU ( 
  ...
  oai21  g025(.a(x27), .b(x08), .c(new_n80_), .O(new_n88_));
  inv1   g026(.a(x30), .O(new_n89_));
  ...
  nand3  g031(.a(new_n93_), .b(new_n91_), .c(new_n87_), .O(z02));
  ...
  nand2  g057(.a(new_n119_), .b(new_n72_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(x30), .O(new_n121_));
  nand2  g059(.a(new_n81_), .b(new_n79_), .O(new_n122_));
  ...
  nand3  g063(.a(new_n93_), .b(x32), .c(x05), .O(new_n126_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n72_), .O(new_n146_));
  inv1   g084(.a(new_n70_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n89_), .c(x04), .O(new_n148_));
  ...
  nand4  g090(.a(new_n152_), .b(x40), .c(x39), .d(new_n150_), .O(new_n153_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(x04), .O(new_n158_));
  nand4  g096(.a(new_n156_), .b(new_n89_), .c(x20), .d(new_n155_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  inv1   g099(.a(x32), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n89_), .c(new_n74_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n150_), .d(new_n72_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z13));
  nand3  g103(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n162_), .c(new_n89_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n93_), .b(new_n150_), .c(new_n72_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n68_), .b(new_n142_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n162_), .c(new_n89_), .O(new_n173_));
  aoi21  g111(.a(new_n169_), .b(new_n147_), .c(new_n64_), .O(new_n174_));
  ...
  oai21  g122(.a(new_n81_), .b(x27), .c(new_n132_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  inv1   g124(.a(new_n81_), .O(new_n187_));
  nor2   g125(.a(new_n67_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(x30), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n186_), .c(new_n131_), .O(z18));
  nor2   g128(.a(new_n142_), .b(new_n67_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n67_), .c(new_n142_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n133_), .c(new_n191_), .d(x08), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n89_), .c(new_n131_), .O(new_n194_));
