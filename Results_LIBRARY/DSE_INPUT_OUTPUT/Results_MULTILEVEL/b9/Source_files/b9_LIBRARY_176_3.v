...
module FAU ( 
  ...
  aoi21  g18(.a(new_n80_), .b(new_n66_), .c(z08), .O(new_n81_));
  ...
  nand2  g39(.a(new_n101_), .b(z02), .O(z09));
  ...
  nand2  g49(.a(new_n66_), .b(new_n111_), .O(new_n112_));
  nand4  g50(.a(new_n112_), .b(new_n110_), .c(x35), .d(new_n78_), .O(new_n113_));
  nand4  g51(.a(new_n113_), .b(z02), .c(new_n71_), .d(new_n109_), .O(new_n114_));
  inv1   g52(.a(new_n114_), .O(z11));
  inv1   g53(.a(new_n67_), .O(new_n116_));
  nor2   g54(.a(z08), .b(new_n66_), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(new_n116_), .O(z12));
  inv1   g56(.a(x19), .O(new_n119_));
  nand3  g57(.a(new_n68_), .b(x20), .c(new_n119_), .O(new_n120_));
  oai21  g58(.a(new_n120_), .b(x18), .c(z02), .O(z13));
  nor2   g59(.a(x19), .b(x18), .O(new_n122_));
  nand4  g60(.a(new_n122_), .b(new_n117_), .c(new_n116_), .d(x20), .O(z14));
  nand4  g61(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(z02), .O(z15));
  ...
  nand2  g70(.a(x27), .b(new_n103_), .O(new_n133_));
  oai21  g71(.a(x27), .b(new_n111_), .c(new_n133_), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(x35), .c(new_n78_), .O(new_n135_));
  nor2   g73(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g74(.a(new_n136_), .b(new_n135_), .c(z08), .O(z18));
  oai21  g75(.a(x28), .b(new_n111_), .c(new_n66_), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(x35), .O(new_n139_));
  nand3  g77(.a(new_n139_), .b(new_n71_), .c(new_n109_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(z02), .O(z20));
  inv1   g79(.a(new_n114_), .O(z19));
endmodule
