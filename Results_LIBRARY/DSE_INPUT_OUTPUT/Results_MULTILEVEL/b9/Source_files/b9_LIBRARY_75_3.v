...
module FAU ( 
  ...
  aoi21  g20(.a(new_n82_), .b(new_n78_), .c(new_n64_), .O(z04));
  nand2  g21(.a(x28), .b(x27), .O(new_n84_));
  nand3  g22(.a(new_n84_), .b(z02), .c(new_n66_), .O(z05));
  nand2  g23(.a(new_n84_), .b(new_n66_), .O(new_n86_));
  ...
  nand3  g53(.a(new_n116_), .b(new_n71_), .c(new_n111_), .O(new_n117_));
  ...
  nor2   g59(.a(new_n64_), .b(new_n79_), .O(new_n123_));
  ...
  oai21  g71(.a(x27), .b(new_n114_), .c(new_n134_), .O(new_n135_));
  nand3  g72(.a(new_n135_), .b(x35), .c(new_n112_), .O(new_n136_));
  nor2   g73(.a(x30), .b(x09), .O(new_n137_));
  aoi21  g74(.a(new_n137_), .b(new_n136_), .c(new_n64_), .O(z18));
  oai21  g75(.a(x28), .b(new_n114_), .c(new_n79_), .O(new_n139_));
  ...
  zero   g79(.O(z08));
  nand2  g80(.a(new_n117_), .b(z02), .O(z19));
endmodule
