...
module FAU ( 
  ...
  nand2  g017(.a(x30), .b(x12), .O(new_n80_));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n82_), .O(z02));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n70_), .c(new_n82_), .O(z05));
  ...
  nand3  g051(.a(new_n113_), .b(new_n80_), .c(x03), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z07));
  nand3  g053(.a(new_n80_), .b(x40), .c(x39), .O(new_n116_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n82_), .O(z12));
  ...
  nor2   g096(.a(new_n157_), .b(x12), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand2  g098(.a(x30), .b(new_n121_), .O(new_n161_));
  nand2  g099(.a(x32), .b(new_n83_), .O(new_n162_));
  ...
  nand2  g123(.a(new_n92_), .b(new_n64_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n135_), .c(new_n138_), .O(new_n187_));
  nand2  g125(.a(new_n139_), .b(new_n134_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n187_), .c(new_n83_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n161_), .O(z18));
  ...
  nand3  g132(.a(new_n194_), .b(new_n83_), .c(new_n134_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n80_), .O(z20));
  nand2  g134(.a(new_n142_), .b(new_n80_), .O(z19));
endmodule
