...
module FAU ( 
  ...
  nand2  g034(.a(new_n94_), .b(new_n93_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n91_), .c(new_n71_), .d(new_n92_), .O(z04));
  ...
  nor2   g052(.a(new_n70_), .b(new_n67_), .O(z08));
  ...
  nand2  g079(.a(new_n141_), .b(new_n71_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n93_), .c(new_n66_), .O(new_n144_));
  oai22  g082(.a(new_n64_), .b(new_n93_), .c(new_n67_), .d(x04), .O(new_n145_));
  ...
  nand3  g098(.a(x39), .b(new_n147_), .c(new_n119_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .O(new_n163_));
  ...
  nand3  g105(.a(new_n167_), .b(new_n75_), .c(new_n74_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n163_), .c(new_n71_), .O(z14));
  ...
  oai21  g115(.a(new_n78_), .b(x27), .c(new_n132_), .O(new_n178_));
  ...
  aoi21  g121(.a(x40), .b(new_n183_), .c(new_n67_), .O(new_n184_));
  aoi21  g122(.a(new_n133_), .b(new_n85_), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n71_), .b(new_n93_), .O(new_n186_));
  nand3  g124(.a(x35), .b(new_n77_), .c(new_n119_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x40), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n186_), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n185_), .c(new_n74_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(x09), .O(z19));
  aoi21  g129(.a(x28), .b(new_n93_), .c(new_n84_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n184_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n84_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n186_), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n74_), .O(new_n196_));
