...
module FAU ( 
  ...
  aoi21  g17(.a(new_n64_), .b(new_n80_), .c(z08), .O(new_n81_));
  ...
  oai21  g22(.a(new_n85_), .b(new_n80_), .c(new_n64_), .O(new_n86_));
  nand2  g23(.a(new_n86_), .b(new_n68_), .O(z06));
  ...
  nand4  g50(.a(new_n113_), .b(new_n111_), .c(x35), .d(new_n85_), .O(new_n114_));
  nand4  g51(.a(new_n114_), .b(new_n68_), .c(new_n71_), .d(new_n110_), .O(new_n115_));
  inv1   g52(.a(new_n115_), .O(z11));
  aoi21  g53(.a(new_n66_), .b(x27), .c(z08), .O(z12));
  nand4  g54(.a(new_n68_), .b(new_n66_), .c(x27), .d(x20), .O(new_n118_));
  nor3   g55(.a(new_n118_), .b(x19), .c(x18), .O(z13));
  nor2   g56(.a(x19), .b(x18), .O(new_n120_));
  nor2   g57(.a(z08), .b(new_n80_), .O(new_n121_));
  nand4  g58(.a(new_n121_), .b(new_n120_), .c(new_n66_), .d(x20), .O(z14));
  ...
  oai21  g69(.a(x27), .b(new_n112_), .c(new_n132_), .O(new_n133_));
  nand3  g70(.a(new_n133_), .b(x35), .c(new_n85_), .O(new_n134_));
  nor2   g71(.a(x30), .b(x09), .O(new_n135_));
  aoi21  g72(.a(new_n135_), .b(new_n134_), .c(z08), .O(z18));
  oai21  g73(.a(x28), .b(new_n112_), .c(new_n80_), .O(new_n137_));
  nand2  g74(.a(new_n137_), .b(x35), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(new_n71_), .c(new_n110_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(new_n68_), .O(z20));
  one    g77(.O(z02));
  inv1   g78(.a(new_n115_), .O(z19));
endmodule
