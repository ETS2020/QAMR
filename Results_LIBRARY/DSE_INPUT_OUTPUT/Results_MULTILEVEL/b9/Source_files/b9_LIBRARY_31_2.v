...
module FAU ( 
  ...
  nand3  g078(.a(new_n140_), .b(new_n79_), .c(new_n128_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n64_), .O(z11));
  nand3  g080(.a(new_n96_), .b(new_n81_), .c(new_n89_), .O(new_n143_));
  ...
  oai21  g084(.a(new_n68_), .b(x39), .c(new_n146_), .O(z12));
  ...
  nand2  g091(.a(new_n94_), .b(new_n96_), .O(new_n154_));
  ...
  nand3  g094(.a(new_n122_), .b(new_n148_), .c(new_n72_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x40), .c(new_n130_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n156_), .O(z13));
  nand3  g097(.a(x39), .b(new_n148_), .c(new_n72_), .O(new_n160_));
  ...
  oai21  g115(.a(new_n83_), .b(x27), .c(new_n132_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nor2   g117(.a(new_n66_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n90_), .c(x09), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n179_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g120(.a(x40), .b(new_n129_), .c(new_n130_), .O(new_n183_));
  aoi21  g121(.a(new_n133_), .b(new_n90_), .c(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n64_), .b(new_n66_), .O(new_n185_));
  nand3  g123(.a(new_n137_), .b(x35), .c(new_n82_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x40), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n185_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n184_), .c(new_n79_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z19));
  oai21  g128(.a(new_n89_), .b(new_n66_), .c(new_n136_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n66_), .c(new_n89_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n131_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n128_), .O(new_n194_));
