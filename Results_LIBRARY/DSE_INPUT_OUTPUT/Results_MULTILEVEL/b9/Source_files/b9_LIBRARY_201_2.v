...
module FAU ( 
  ...
  aoi22  g028(.a(new_n90_), .b(x04), .c(new_n88_), .d(new_n87_), .O(new_n91_));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n93_), .O(z04));
  ...
  nand2  g056(.a(new_n118_), .b(new_n64_), .O(z09));
  inv1   g057(.a(x05), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  oai22  g059(.a(new_n116_), .b(new_n120_), .c(x39), .d(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n83_), .c(new_n73_), .O(new_n123_));
  ...
  nand2  g072(.a(new_n134_), .b(new_n89_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand2  g075(.a(x39), .b(x04), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(x35), .c(new_n100_), .d(x27), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n79_), .c(new_n132_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n64_), .O(z11));
  nand3  g081(.a(new_n67_), .b(new_n82_), .c(new_n81_), .O(new_n144_));
  ...
  oai21  g085(.a(new_n69_), .b(x39), .c(new_n147_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n149_), .d(new_n73_), .O(new_n152_));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n152_), .c(new_n63_), .O(new_n157_));
  nand4  g095(.a(new_n155_), .b(new_n127_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n129_), .b(new_n149_), .c(new_n73_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  aoi21  g100(.a(new_n149_), .b(new_n73_), .c(new_n63_), .O(new_n163_));
  nor2   g101(.a(x19), .b(x18), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n155_), .c(x27), .d(x20), .O(new_n165_));
  oai21  g103(.a(new_n163_), .b(new_n127_), .c(new_n165_), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n167_));
  nor2   g105(.a(x37), .b(x35), .O(new_n168_));
  aoi21  g106(.a(new_n167_), .b(new_n150_), .c(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n100_), .c(x27), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x40), .c(new_n80_), .d(new_n79_), .O(new_n171_));
  ...
  nand2  g119(.a(x27), .b(new_n73_), .O(new_n182_));
  nand2  g120(.a(new_n66_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n81_), .O(new_n184_));
  nand2  g122(.a(new_n79_), .b(new_n132_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n100_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n93_), .c(new_n116_), .d(new_n88_), .O(z18));
  inv1   g125(.a(x29), .O(new_n188_));
  aoi21  g126(.a(x40), .b(new_n188_), .c(new_n127_), .O(new_n189_));
  aoi21  g127(.a(new_n134_), .b(new_n89_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n64_), .b(new_n66_), .O(new_n191_));
  nand3  g129(.a(x35), .b(new_n100_), .c(new_n73_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x40), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n191_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n190_), .c(new_n79_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z19));
  aoi21  g134(.a(x28), .b(new_n66_), .c(new_n81_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n189_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n81_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n191_), .c(x08), .O(new_n200_));
