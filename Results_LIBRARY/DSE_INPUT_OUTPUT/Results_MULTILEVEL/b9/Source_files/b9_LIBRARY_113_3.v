...
module FAU ( 
  ...
  nand3  g40(.a(new_n74_), .b(x07), .c(new_n104_), .O(new_n105_));
  nand2  g41(.a(x37), .b(x06), .O(new_n106_));
  nand2  g42(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g43(.a(new_n107_), .b(x27), .O(new_n108_));
  nand2  g44(.a(new_n108_), .b(new_n63_), .O(z10));
  inv1   g45(.a(x09), .O(new_n110_));
  inv1   g46(.a(x28), .O(new_n111_));
  nand2  g47(.a(x27), .b(x04), .O(new_n112_));
  inv1   g48(.a(x08), .O(new_n113_));
  nand2  g49(.a(new_n80_), .b(new_n113_), .O(new_n114_));
  nand4  g50(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n111_), .O(new_n115_));
  nand4  g51(.a(new_n115_), .b(new_n63_), .c(new_n71_), .d(new_n110_), .O(new_n116_));
  inv1   g52(.a(new_n116_), .O(z11));
  aoi21  g53(.a(new_n68_), .b(x27), .c(new_n64_), .O(z12));
  nand4  g54(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n119_));
  nor3   g55(.a(new_n119_), .b(x19), .c(x18), .O(z13));
  nor2   g56(.a(x19), .b(x18), .O(new_n121_));
  nor2   g57(.a(new_n64_), .b(new_n80_), .O(new_n122_));
  nand4  g58(.a(new_n122_), .b(new_n121_), .c(new_n68_), .d(x20), .O(z14));
  nand4  g59(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n124_));
  nand2  g60(.a(new_n124_), .b(new_n63_), .O(z15));
  inv1   g61(.a(x23), .O(new_n126_));
  nand3  g62(.a(new_n126_), .b(x22), .c(x01), .O(new_n127_));
  nand2  g63(.a(new_n127_), .b(new_n63_), .O(z16));
  inv1   g64(.a(x01), .O(new_n129_));
  inv1   g65(.a(x24), .O(new_n130_));
  nand4  g66(.a(new_n63_), .b(new_n130_), .c(x23), .d(x22), .O(new_n131_));
  nor2   g67(.a(new_n131_), .b(new_n129_), .O(z17));
  nand2  g68(.a(x27), .b(new_n104_), .O(new_n133_));
  oai21  g69(.a(x27), .b(new_n113_), .c(new_n133_), .O(new_n134_));
  nand3  g70(.a(new_n134_), .b(x35), .c(new_n111_), .O(new_n135_));
  nor2   g71(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g72(.a(new_n136_), .b(new_n135_), .c(new_n64_), .O(z18));
  nand3  g73(.a(new_n115_), .b(new_n71_), .c(new_n110_), .O(new_n138_));
  nand2  g74(.a(new_n138_), .b(new_n63_), .O(z19));
  oai21  g75(.a(x28), .b(new_n113_), .c(new_n80_), .O(new_n140_));
  nand2  g76(.a(new_n140_), .b(x35), .O(new_n141_));
  nand3  g77(.a(new_n141_), .b(new_n71_), .c(new_n110_), .O(new_n142_));
  nand2  g78(.a(new_n142_), .b(new_n63_), .O(z20));
  one    g79(.O(z02));
  zero   g80(.O(z08));
endmodule
