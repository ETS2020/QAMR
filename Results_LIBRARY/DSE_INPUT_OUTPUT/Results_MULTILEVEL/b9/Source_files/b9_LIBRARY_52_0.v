...
module FAU ( 
  ...
  nand4  g038(.a(new_n100_), .b(new_n99_), .c(new_n92_), .d(x21), .O(z03));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n92_), .O(z10));
  ...
  nand2  g082(.a(new_n144_), .b(new_n92_), .O(z11));
  ...
  nand2  g087(.a(new_n149_), .b(new_n110_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n146_), .c(new_n81_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nand4  g113(.a(new_n92_), .b(x34), .c(x27), .d(x26), .O(new_n176_));
  nor2   g114(.a(new_n176_), .b(new_n175_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand4  g116(.a(new_n92_), .b(new_n178_), .c(x22), .d(x01), .O(new_n179_));
  ...
  nand2  g130(.a(new_n192_), .b(new_n92_), .O(z20));
  nand2  g131(.a(new_n144_), .b(new_n92_), .O(z19));
endmodule
