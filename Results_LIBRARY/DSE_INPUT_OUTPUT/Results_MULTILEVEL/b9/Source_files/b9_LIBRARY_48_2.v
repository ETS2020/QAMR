...
module FAU ( 
  ...
  aoi22  g034(.a(new_n63_), .b(x30), .c(new_n65_), .d(new_n96_), .O(new_n97_));
  ...
  nand2  g052(.a(new_n92_), .b(new_n64_), .O(z08));
  ...
  oai21  g060(.a(new_n92_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n83_), .c(x27), .O(new_n124_));
  nand3  g062(.a(new_n93_), .b(x32), .c(x05), .O(new_n125_));
  ...
  nor2   g069(.a(new_n96_), .b(new_n71_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n82_), .c(new_n131_), .O(new_n133_));
  inv1   g071(.a(x08), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n81_), .c(x27), .d(new_n71_), .O(new_n135_));
  ...
  nand2  g090(.a(x40), .b(x32), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n78_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n144_), .d(new_n71_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n64_), .O(z13));
  nand3  g094(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n157_));
  nand3  g095(.a(new_n145_), .b(new_n79_), .c(x28), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x40), .c(x30), .O(new_n159_));
  nand3  g097(.a(x39), .b(new_n144_), .c(new_n71_), .O(new_n160_));
  and2   g098(.a(new_n160_), .b(x40), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(new_n157_), .O(new_n162_));
  nand2  g100(.a(new_n153_), .b(new_n96_), .O(new_n163_));
  inv1   g101(.a(x35), .O(new_n164_));
  oai21  g102(.a(x32), .b(new_n81_), .c(x40), .O(new_n165_));
  nor2   g103(.a(x40), .b(x28), .O(new_n166_));
  aoi21  g104(.a(new_n165_), .b(new_n164_), .c(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(x37), .c(new_n163_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n78_), .O(new_n169_));
  nand3  g107(.a(new_n160_), .b(new_n68_), .c(x40), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n162_), .O(z14));
  ...
  nand4  g119(.a(x35), .b(new_n78_), .c(new_n81_), .d(new_n96_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n131_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nand2  g122(.a(new_n135_), .b(new_n130_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n78_), .O(new_n186_));
  nand2  g124(.a(x40), .b(x30), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n186_), .c(new_n184_), .O(z18));
  inv1   g126(.a(new_n131_), .O(new_n189_));
  oai21  g127(.a(new_n164_), .b(new_n96_), .c(new_n134_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n96_), .c(new_n164_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n78_), .c(new_n130_), .O(new_n193_));
  inv1   g131(.a(new_n193_), .O(z20));
  inv1   g132(.a(new_n138_), .O(z19));
endmodule
