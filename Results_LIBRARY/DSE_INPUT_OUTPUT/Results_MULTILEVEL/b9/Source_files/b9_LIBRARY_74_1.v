...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n90_), .c(x06), .O(new_n96_));
  ...
  nor2   g042(.a(new_n91_), .b(new_n64_), .O(new_n105_));
  ...
  nand4  g069(.a(new_n131_), .b(x40), .c(x39), .d(x06), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  aoi21  g071(.a(new_n129_), .b(x27), .c(new_n133_), .O(new_n134_));
  ...
  oai21  g075(.a(new_n92_), .b(x04), .c(x06), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n137_), .c(x08), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x06), .c(new_n76_), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n86_), .c(new_n141_), .O(new_n143_));
  ...
  nand2  g086(.a(new_n77_), .b(new_n65_), .O(new_n149_));
  ...
  nand2  g100(.a(new_n131_), .b(x40), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n75_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n152_), .c(x06), .d(new_n65_), .O(new_n165_));
  ...
  nand3  g107(.a(new_n77_), .b(new_n152_), .c(new_n65_), .O(new_n170_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n148_), .c(new_n98_), .O(new_n175_));
  ...
  aoi21  g127(.a(new_n187_), .b(new_n91_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n77_), .b(x29), .O(new_n191_));
  inv1   g129(.a(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(x08), .c(x06), .O(new_n193_));
  oai21  g131(.a(new_n190_), .b(new_n98_), .c(new_n193_), .O(z18));
  nand2  g132(.a(new_n142_), .b(new_n86_), .O(new_n195_));
  nand2  g133(.a(new_n191_), .b(new_n195_), .O(new_n196_));
  inv1   g134(.a(x08), .O(new_n197_));
  oai21  g135(.a(new_n185_), .b(new_n92_), .c(new_n197_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n196_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n84_), .c(new_n188_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n82_), .O(z19));
  oai21  g139(.a(new_n66_), .b(new_n64_), .c(new_n197_), .O(new_n202_));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n192_), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n84_), .c(new_n188_), .O(new_n205_));
