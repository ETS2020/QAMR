...
module FAU ( 
  ...
  nand3  g057(.a(new_n119_), .b(new_n84_), .c(new_n72_), .O(new_n120_));
  ...
  nand3  g095(.a(x40), .b(new_n144_), .c(new_n72_), .O(new_n158_));
  ...
  aoi22  g099(.a(new_n161_), .b(new_n145_), .c(new_n95_), .d(new_n138_), .O(new_n162_));
