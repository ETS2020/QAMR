...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n93_, new_n95_, new_n96_, new_n98_, new_n99_, new_n101_, new_n104_,
  ...
  inv1   g065(.a(new_n84_), .O(new_n128_));
  inv1   g066(.a(x29), .O(new_n129_));
  aoi21  g067(.a(x39), .b(new_n129_), .c(new_n75_), .O(new_n130_));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n128_), .c(new_n130_), .O(new_n132_));
  nand2  g070(.a(new_n64_), .b(new_n66_), .O(new_n133_));
  ...
  nand3  g077(.a(new_n67_), .b(new_n82_), .c(new_n139_), .O(new_n140_));
  ...
  oai21  g081(.a(new_n69_), .b(x40), .c(new_n143_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x40), .c(new_n145_), .d(new_n73_), .O(new_n148_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n148_), .c(new_n66_), .O(new_n153_));
  nand3  g091(.a(new_n122_), .b(new_n145_), .c(new_n73_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x39), .c(new_n75_), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n153_), .O(z13));
  aoi21  g094(.a(new_n145_), .b(new_n73_), .c(new_n63_), .O(new_n157_));
  nor2   g095(.a(x19), .b(x18), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n151_), .c(x27), .d(x20), .O(new_n159_));
  oai21  g097(.a(new_n157_), .b(new_n75_), .c(new_n159_), .O(new_n160_));
  ...
  nand2  g111(.a(new_n173_), .b(new_n64_), .O(z17));
  oai22  g112(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n129_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n66_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n128_), .c(x09), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g117(.a(x28), .b(new_n66_), .c(new_n139_), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n130_), .O(new_n181_));
  nand2  g119(.a(x39), .b(new_n139_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n133_), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n80_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(x09), .O(z20));
  buf    g123(.a(x40), .O(z08));
  nor2   g124(.a(new_n137_), .b(x09), .O(z19));
endmodule
