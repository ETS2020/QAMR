...
module FAU ( 
  ...
  oai21  g008(.a(new_n70_), .b(x15), .c(x16), .O(new_n71_));
  nand2  g009(.a(new_n71_), .b(new_n66_), .O(new_n72_));
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(new_n73_), .d(new_n63_), .O(new_n78_));
  ...
  nor2   g022(.a(x30), .b(new_n63_), .O(new_n85_));
  ...
  nand2  g028(.a(x35), .b(new_n64_), .O(new_n91_));
  ...
  aoi21  g035(.a(new_n67_), .b(new_n80_), .c(new_n97_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n65_), .O(z03));
  nand2  g037(.a(new_n67_), .b(new_n80_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n66_), .d(new_n97_), .O(z04));
  oai21  g039(.a(new_n82_), .b(new_n80_), .c(new_n67_), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n66_), .O(z06));
  ...
  nand3  g054(.a(new_n66_), .b(x40), .c(x39), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n66_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  ...
  nand2  g062(.a(new_n83_), .b(new_n81_), .O(new_n125_));
  ...
  nand3  g066(.a(new_n94_), .b(x32), .c(x05), .O(new_n129_));
  ...
  oai21  g096(.a(new_n158_), .b(x04), .c(new_n64_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(x40), .c(x39), .d(new_n149_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n157_), .c(new_n66_), .O(z13));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  nand4  g100(.a(new_n150_), .b(new_n158_), .c(new_n64_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n94_), .b(new_n149_), .c(new_n63_), .O(new_n165_));
  ...
  nand3  g107(.a(new_n169_), .b(new_n158_), .c(new_n64_), .O(new_n170_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n66_), .O(z17));
  oai21  g118(.a(new_n83_), .b(x27), .c(new_n135_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n140_), .c(new_n64_), .d(new_n134_), .O(z18));
  inv1   g121(.a(new_n135_), .O(new_n184_));
  nand2  g122(.a(new_n83_), .b(new_n64_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n136_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(x35), .b(new_n82_), .c(x27), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n64_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n63_), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n186_), .c(new_n134_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n66_), .O(z19));
  oai21  g129(.a(new_n167_), .b(new_n80_), .c(new_n139_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n80_), .c(new_n167_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n184_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n64_), .c(new_n134_), .O(new_n195_));
