...
module FAU ( 
  ...
  nor2   g001(.a(x20), .b(new_n63_), .O(new_n64_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n75_), .d(new_n88_), .O(z02));
  oai21  g032(.a(new_n68_), .b(new_n82_), .c(x27), .O(new_n95_));
  inv1   g033(.a(x21), .O(new_n96_));
  inv1   g034(.a(x37), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n66_), .c(new_n96_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n64_), .O(z03));
  aoi21  g037(.a(new_n97_), .b(new_n66_), .c(x21), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n95_), .c(new_n88_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n88_), .c(new_n97_), .O(z05));
  ...
  nand2  g052(.a(new_n114_), .b(new_n88_), .O(z07));
  inv1   g053(.a(x39), .O(new_n116_));
  inv1   g054(.a(x40), .O(new_n117_));
  nor3   g055(.a(new_n64_), .b(new_n117_), .c(new_n116_), .O(z08));
  ...
  oai21  g068(.a(new_n130_), .b(new_n126_), .c(new_n67_), .O(new_n131_));
  ...
  nand4  g076(.a(x35), .b(new_n82_), .c(x27), .d(new_n67_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n88_), .c(new_n80_), .d(new_n134_), .O(new_n142_));
  ...
  oai22  g084(.a(new_n74_), .b(x04), .c(new_n72_), .d(new_n66_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n88_), .O(z12));
  ...
  nor2   g092(.a(new_n72_), .b(new_n154_), .O(new_n155_));
  ...
  nor2   g099(.a(new_n161_), .b(new_n116_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x20), .c(new_n149_), .d(new_n67_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n159_), .O(z13));
  aoi21  g102(.a(x20), .b(new_n153_), .c(x19), .O(new_n165_));
  nor2   g103(.a(new_n154_), .b(new_n63_), .O(new_n166_));
  nand4  g104(.a(new_n150_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n75_), .b(new_n149_), .c(new_n67_), .O(new_n169_));
  oai22  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .d(new_n165_), .O(new_n170_));
  nand3  g108(.a(new_n97_), .b(new_n68_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n81_), .c(new_n80_), .O(new_n173_));
  oai21  g111(.a(new_n72_), .b(new_n66_), .c(new_n169_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n63_), .O(new_n176_));
  nand4  g114(.a(new_n81_), .b(new_n80_), .c(new_n66_), .d(x20), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n170_), .O(z14));
  nand4  g116(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n88_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x22), .c(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n88_), .O(z16));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(x23), .c(x22), .d(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n88_), .O(z17));
  oai21  g124(.a(new_n83_), .b(x27), .c(new_n135_), .O(new_n187_));
  nand3  g125(.a(new_n139_), .b(new_n80_), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(x08), .c(new_n188_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n64_), .O(z18));
  oai21  g128(.a(new_n68_), .b(new_n66_), .c(new_n138_), .O(new_n191_));
  nand2  g129(.a(new_n135_), .b(new_n68_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n64_), .O(new_n193_));
  ...
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n80_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(x09), .c(new_n88_), .O(z19));
  inv1   g136(.a(new_n135_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n191_), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n88_), .c(new_n80_), .d(new_n134_), .O(new_n202_));
