...
module FAU ( 
  ...
  aoi21  g20(.a(new_n65_), .b(new_n64_), .c(x21), .O(new_n83_));
  aoi21  g21(.a(new_n83_), .b(new_n79_), .c(new_n71_), .O(z04));
  ...
  nand4  g54(.a(new_n117_), .b(z02), .c(new_n72_), .d(new_n112_), .O(new_n118_));
  inv1   g55(.a(new_n118_), .O(z11));
  nor2   g56(.a(new_n71_), .b(new_n67_), .O(z12));
  inv1   g57(.a(x19), .O(new_n121_));
  nand3  g58(.a(new_n67_), .b(x20), .c(new_n121_), .O(new_n122_));
  oai21  g59(.a(new_n122_), .b(x18), .c(z02), .O(z13));
  nand2  g60(.a(new_n66_), .b(new_n65_), .O(new_n124_));
  nor2   g61(.a(x19), .b(x18), .O(new_n125_));
  nor2   g62(.a(new_n71_), .b(new_n64_), .O(new_n126_));
  nand4  g63(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(x20), .O(z14));
  inv1   g64(.a(x12), .O(new_n128_));
  nor2   g65(.a(new_n104_), .b(new_n128_), .O(z15));
  ...
  nand3  g76(.a(new_n139_), .b(x35), .c(new_n113_), .O(new_n140_));
  nand4  g77(.a(new_n140_), .b(z02), .c(new_n72_), .d(new_n112_), .O(z18));
  oai21  g78(.a(new_n115_), .b(new_n73_), .c(z02), .O(new_n142_));
  nand3  g79(.a(new_n142_), .b(new_n114_), .c(new_n113_), .O(new_n143_));
  nand3  g80(.a(new_n143_), .b(new_n72_), .c(new_n112_), .O(new_n144_));
  nand2  g81(.a(new_n144_), .b(z02), .O(z19));
  oai21  g82(.a(x28), .b(new_n137_), .c(new_n64_), .O(new_n146_));
  nand2  g83(.a(new_n146_), .b(x35), .O(new_n147_));
  nand4  g84(.a(new_n147_), .b(z02), .c(new_n72_), .d(new_n112_), .O(new_n148_));
