...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(x23), .O(new_n81_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n76_), .d(x23), .O(z02));
  ...
  aoi21  g056(.a(new_n118_), .b(x23), .c(new_n80_), .O(z08));
  ...
  nand2  g073(.a(new_n84_), .b(new_n135_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(x23), .O(new_n137_));
  ...
  oai21  g079(.a(new_n87_), .b(new_n64_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n84_), .c(new_n135_), .O(new_n144_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(new_n152_), .O(new_n160_));
  nand4  g098(.a(new_n72_), .b(new_n80_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n127_), .b(x23), .c(new_n153_), .d(new_n65_), .O(new_n164_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n149_), .c(new_n81_), .O(new_n174_));
  ...
  nand4  g115(.a(new_n80_), .b(new_n152_), .c(x22), .d(x01), .O(new_n178_));
  ...
  aoi21  g122(.a(new_n184_), .b(new_n86_), .c(new_n136_), .O(new_n185_));
  inv1   g123(.a(new_n139_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(x23), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n185_), .b(new_n81_), .c(new_n187_), .O(z18));
  oai21  g126(.a(new_n182_), .b(new_n87_), .c(new_n133_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n141_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n84_), .c(new_n135_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n82_), .O(z19));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n186_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n84_), .c(new_n135_), .O(new_n196_));
