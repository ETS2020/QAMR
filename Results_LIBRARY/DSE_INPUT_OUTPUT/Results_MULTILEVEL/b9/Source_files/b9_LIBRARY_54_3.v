...
module FAU ( 
  ...
  nand2  g000(.a(x30), .b(x17), .O(new_n63_));
  ...
  nand3  g041(.a(new_n103_), .b(new_n63_), .c(new_n72_), .O(z05));
  ...
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n63_), .O(z12));
  ...
  nor2   g097(.a(new_n158_), .b(x17), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(x27), .O(new_n161_));
  nand2  g099(.a(x30), .b(new_n121_), .O(new_n162_));
  nand2  g100(.a(x32), .b(new_n83_), .O(new_n163_));
  ...
  oai21  g126(.a(new_n68_), .b(new_n66_), .c(new_n138_), .O(new_n189_));
  ...
  nand2  g131(.a(new_n143_), .b(new_n63_), .O(z19));
endmodule
