...
module FAU ( 
  ...
  oai21  g027(.a(new_n89_), .b(new_n88_), .c(new_n63_), .O(new_n90_));
  ...
  inv1   g033(.a(new_n65_), .O(new_n96_));
  ...
  aoi21  g039(.a(new_n66_), .b(new_n99_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n96_), .O(z04));
  aoi21  g041(.a(x28), .b(x27), .c(x37), .O(new_n104_));
  nor2   g042(.a(new_n104_), .b(new_n96_), .O(z05));
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n65_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand2  g069(.a(new_n94_), .b(x29), .O(new_n132_));
  ...
  nand3  g075(.a(new_n134_), .b(x27), .c(new_n72_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n88_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n79_), .c(new_n131_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n65_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n99_), .c(new_n74_), .O(new_n144_));
  oai21  g082(.a(new_n93_), .b(x04), .c(new_n69_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n65_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x28), .c(new_n64_), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n147_), .d(new_n72_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand4  g090(.a(new_n68_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n125_), .b(x40), .c(x39), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x13), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n72_), .c(new_n96_), .O(new_n158_));
  ...
  nand3  g100(.a(new_n94_), .b(new_n147_), .c(new_n72_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n66_), .b(new_n133_), .c(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n80_), .c(new_n79_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n69_), .c(new_n96_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n167_), .c(new_n164_), .O(z14));
  ...
  oai21  g116(.a(new_n83_), .b(x27), .c(new_n132_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n96_), .b(x30), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n138_), .d(new_n131_), .O(z18));
  nand2  g120(.a(new_n65_), .b(new_n99_), .O(new_n183_));
  nand3  g121(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x40), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n183_), .c(x08), .O(new_n186_));
  nand2  g124(.a(x39), .b(x29), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x40), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(x02), .O(new_n189_));
  aoi22  g127(.a(new_n189_), .b(new_n188_), .c(new_n135_), .d(new_n134_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n186_), .c(new_n79_), .O(new_n191_));
  nor2   g129(.a(new_n191_), .b(x09), .O(z19));
  inv1   g130(.a(new_n132_), .O(new_n193_));
  oai21  g131(.a(new_n133_), .b(new_n99_), .c(new_n88_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n99_), .c(new_n133_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n79_), .c(new_n131_), .O(new_n197_));
