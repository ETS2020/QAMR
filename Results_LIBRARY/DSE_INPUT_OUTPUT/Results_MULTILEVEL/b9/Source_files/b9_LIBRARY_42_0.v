...
module FAU ( 
  ...
  nor2   g028(.a(new_n71_), .b(new_n90_), .O(new_n91_));
  ...
  nor3   g052(.a(new_n63_), .b(new_n71_), .c(new_n90_), .O(z08));
  ...
  nand4  g057(.a(new_n119_), .b(new_n80_), .c(x27), .d(x07), .O(new_n120_));
  aoi21  g058(.a(new_n91_), .b(x05), .c(new_n76_), .O(new_n121_));
  ...
  oai21  g065(.a(new_n79_), .b(x27), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g069(.a(new_n96_), .b(new_n77_), .c(new_n93_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x27), .c(x10), .O(new_n133_));
  nor2   g071(.a(new_n91_), .b(new_n68_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n133_), .c(x30), .O(new_n135_));
  oai21  g073(.a(new_n68_), .b(new_n118_), .c(new_n135_), .O(z12));
  inv1   g074(.a(x19), .O(new_n137_));
  nor2   g075(.a(new_n67_), .b(new_n63_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(x27), .c(x20), .d(new_n137_), .O(new_n139_));
  inv1   g077(.a(x13), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n118_), .O(new_n141_));
  nand2  g079(.a(new_n91_), .b(x30), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n141_), .c(new_n139_), .d(x18), .O(z13));
  inv1   g081(.a(x18), .O(new_n144_));
  nand4  g082(.a(x27), .b(x20), .c(new_n137_), .d(new_n144_), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n67_), .c(new_n141_), .d(new_n119_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n84_), .O(z14));
  nand4  g085(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n84_), .O(z15));
  inv1   g087(.a(x23), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(x22), .c(x01), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n84_), .O(z16));
  inv1   g090(.a(x01), .O(new_n153_));
  inv1   g091(.a(x24), .O(new_n154_));
  nand4  g092(.a(new_n84_), .b(new_n154_), .c(x23), .d(x22), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(new_n153_), .O(z17));
  nand4  g094(.a(new_n129_), .b(new_n76_), .c(new_n126_), .d(x04), .O(z18));
  ...
  nand2  g099(.a(new_n161_), .b(new_n126_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(x04), .c(x30), .O(z19));
  nor2   g101(.a(new_n93_), .b(new_n66_), .O(new_n164_));
  nand2  g102(.a(new_n159_), .b(new_n127_), .O(new_n165_));
  oai21  g103(.a(new_n164_), .b(x08), .c(new_n165_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n76_), .c(new_n126_), .d(x04), .O(new_n167_));
