...
module FAU ( 
  ...
  nand2  g030(.a(x30), .b(x29), .O(new_n93_));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n84_), .O(z05));
  ...
  nand3  g063(.a(new_n76_), .b(x05), .c(x02), .O(new_n126_));
  aoi22  g064(.a(new_n126_), .b(new_n125_), .c(new_n96_), .d(new_n67_), .O(new_n127_));
  ...
  aoi21  g068(.a(x32), .b(x02), .c(x30), .O(new_n131_));
  nor3   g069(.a(new_n131_), .b(new_n120_), .c(new_n119_), .O(new_n132_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n96_), .c(new_n136_), .O(new_n138_));
  ...
  aoi21  g080(.a(new_n142_), .b(x02), .c(x30), .O(z11));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n80_), .O(new_n157_));
  ...
  nand3  g098(.a(new_n132_), .b(new_n150_), .c(new_n65_), .O(new_n161_));
  ...
  nand2  g102(.a(new_n164_), .b(new_n82_), .O(new_n165_));
  aoi21  g103(.a(x36), .b(x35), .c(x32), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n81_), .c(x28), .d(x02), .O(new_n167_));
  ...
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(x02), .O(new_n175_));
  ...
  oai21  g123(.a(new_n96_), .b(x27), .c(new_n136_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(x09), .b(new_n80_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n139_), .d(new_n81_), .O(z18));
  nand4  g127(.a(new_n141_), .b(new_n81_), .c(new_n135_), .d(x02), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z19));
  inv1   g129(.a(new_n136_), .O(new_n192_));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n193_));
  ...
  aoi21  g134(.a(new_n196_), .b(x02), .c(x30), .O(z20));
endmodule
