...
module FAU ( 
  ...
  nand2  g001(.a(x24), .b(new_n63_), .O(new_n64_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n79_), .d(new_n64_), .O(z02));
  nand2  g035(.a(new_n74_), .b(x27), .O(new_n98_));
  nand2  g036(.a(new_n73_), .b(new_n67_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n98_), .c(new_n64_), .d(x21), .O(z03));
  aoi21  g038(.a(new_n73_), .b(new_n67_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n65_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n73_), .c(new_n65_), .O(z05));
  nand3  g042(.a(new_n103_), .b(new_n64_), .c(new_n73_), .O(new_n105_));
  ...
  nor3   g057(.a(new_n65_), .b(new_n119_), .c(new_n118_), .O(z08));
  ...
  nand2  g073(.a(new_n79_), .b(x29), .O(new_n136_));
  ...
  nand4  g080(.a(new_n142_), .b(new_n64_), .c(new_n84_), .d(new_n135_), .O(new_n143_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n68_), .O(new_n154_));
  ...
  nand3  g097(.a(new_n129_), .b(new_n151_), .c(new_n68_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n65_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n79_), .b(new_n151_), .c(new_n68_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand3  g104(.a(new_n73_), .b(new_n69_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x27), .c(x32), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n84_), .c(new_n165_), .d(new_n148_), .O(new_n169_));
  ...
  oai21  g116(.a(new_n87_), .b(x27), .c(new_n136_), .O(new_n179_));
  nand3  g117(.a(new_n140_), .b(new_n84_), .c(new_n135_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(x08), .c(new_n180_), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n65_), .O(z18));
  inv1   g120(.a(new_n136_), .O(new_n183_));
  oai21  g121(.a(new_n69_), .b(new_n67_), .c(new_n139_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n84_), .c(new_n135_), .O(new_n187_));
