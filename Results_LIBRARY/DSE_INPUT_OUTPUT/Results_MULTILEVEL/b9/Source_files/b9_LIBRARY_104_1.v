...
module FAU ( 
  ...
  nand4  g024(.a(new_n86_), .b(new_n77_), .c(new_n82_), .d(new_n81_), .O(new_n87_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x30), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x39), .O(z02));
  ...
  oai21  g055(.a(x40), .b(new_n81_), .c(x39), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n102_), .O(z09));
  nand3  g059(.a(new_n102_), .b(x37), .c(x06), .O(new_n122_));
  nand4  g060(.a(new_n118_), .b(new_n85_), .c(x07), .d(new_n65_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x27), .O(new_n125_));
  nand4  g063(.a(new_n72_), .b(x30), .c(x05), .d(new_n65_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n125_), .O(z10));
  inv1   g065(.a(x09), .O(new_n128_));
  aoi21  g066(.a(x27), .b(x04), .c(new_n90_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(x35), .c(new_n83_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n77_), .c(new_n81_), .d(new_n128_), .O(new_n131_));
  inv1   g069(.a(new_n131_), .O(z11));
  nand3  g070(.a(new_n97_), .b(new_n67_), .c(new_n66_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(x27), .c(x10), .O(new_n134_));
  nor2   g072(.a(new_n70_), .b(new_n64_), .O(new_n135_));
  aoi21  g073(.a(x40), .b(new_n65_), .c(new_n135_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(x30), .O(new_n137_));
  oai21  g075(.a(new_n70_), .b(new_n64_), .c(new_n77_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(z12));
  inv1   g077(.a(x18), .O(new_n140_));
  inv1   g078(.a(x19), .O(new_n141_));
  nand4  g079(.a(new_n135_), .b(x20), .c(new_n141_), .d(new_n140_), .O(new_n142_));
  ...
  nor2   g086(.a(new_n148_), .b(new_n70_), .O(new_n149_));
  aoi21  g087(.a(new_n145_), .b(x39), .c(new_n149_), .O(z14));
  nand4  g088(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n102_), .O(z15));
  inv1   g090(.a(x23), .O(new_n153_));
  nand4  g091(.a(new_n102_), .b(new_n153_), .c(x22), .d(x01), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(z16));
  inv1   g093(.a(x24), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x23), .c(x22), .d(x01), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n102_), .O(z17));
  nand2  g096(.a(x27), .b(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n64_), .b(x08), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n66_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n83_), .c(x09), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x39), .c(new_n81_), .O(z18));
  nand2  g101(.a(new_n130_), .b(new_n128_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n77_), .c(x30), .O(z19));
  aoi21  g103(.a(new_n83_), .b(x08), .c(x27), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n66_), .c(new_n128_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n77_), .c(x30), .O(z20));
endmodule
