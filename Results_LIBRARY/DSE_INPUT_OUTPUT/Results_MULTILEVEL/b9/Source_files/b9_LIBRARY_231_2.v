...
module FAU ( 
  ...
  oai21  g037(.a(new_n82_), .b(new_n66_), .c(new_n67_), .O(new_n100_));
  ...
  aoi21  g069(.a(new_n131_), .b(new_n127_), .c(new_n130_), .O(new_n132_));
  ...
  nand3  g091(.a(new_n121_), .b(new_n145_), .c(new_n73_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x40), .c(new_n129_), .O(new_n155_));
  ...
  oai21  g097(.a(new_n157_), .b(new_n129_), .c(new_n159_), .O(new_n160_));
  ...
  oai22  g112(.a(new_n83_), .b(x27), .c(new_n129_), .d(new_n128_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n66_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n127_), .c(x09), .O(new_n178_));
  ...
  nand2  g119(.a(x40), .b(new_n139_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n133_), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n79_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(x09), .O(z20));
  buf    g123(.a(x39), .O(z08));
