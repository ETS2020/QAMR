...
module FAU ( 
  ...
  nand2  g24(.a(new_n85_), .b(new_n66_), .O(new_n87_));
  ...
  nand4  g76(.a(new_n117_), .b(z02), .c(new_n71_), .d(new_n112_), .O(new_n140_));
  inv1   g77(.a(new_n140_), .O(z19));
  oai21  g78(.a(x28), .b(new_n115_), .c(new_n80_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g80(.a(new_n143_), .b(z02), .c(new_n71_), .d(new_n112_), .O(new_n144_));
