...
module FAU ( 
  ...
  aoi21  g23(.a(new_n85_), .b(new_n65_), .c(z08), .O(z05));
  ...
  nand2  g52(.a(new_n64_), .b(new_n114_), .O(new_n115_));
  nand4  g53(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n112_), .O(new_n116_));
  nand3  g54(.a(new_n116_), .b(new_n71_), .c(new_n111_), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(z02), .O(z11));
  nor2   g56(.a(z08), .b(new_n67_), .O(z12));
  inv1   g57(.a(x18), .O(new_n120_));
  inv1   g58(.a(x19), .O(new_n121_));
  nand4  g59(.a(new_n67_), .b(x20), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  nand2  g60(.a(new_n122_), .b(z02), .O(z13));
  nand4  g61(.a(x27), .b(x20), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  aoi21  g62(.a(new_n66_), .b(new_n65_), .c(new_n124_), .O(new_n125_));
  nor2   g63(.a(new_n125_), .b(z08), .O(z14));
  inv1   g64(.a(x12), .O(new_n127_));
  nor2   g65(.a(new_n103_), .b(new_n127_), .O(z15));
  inv1   g66(.a(x23), .O(new_n129_));
  nand3  g67(.a(new_n129_), .b(x22), .c(x01), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(z02), .O(z16));
  inv1   g69(.a(x24), .O(new_n132_));
  nand4  g70(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(z02), .O(z17));
  nand2  g72(.a(x27), .b(new_n105_), .O(new_n135_));
  oai21  g73(.a(x27), .b(new_n114_), .c(new_n135_), .O(new_n136_));
  nand3  g74(.a(new_n136_), .b(x35), .c(new_n112_), .O(new_n137_));
  nand4  g75(.a(new_n137_), .b(z02), .c(new_n71_), .d(new_n111_), .O(z18));
  nand4  g76(.a(new_n116_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n139_));
  inv1   g77(.a(new_n139_), .O(z19));
  oai21  g78(.a(x28), .b(new_n114_), .c(new_n64_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(x35), .O(new_n142_));
  nand4  g80(.a(new_n142_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n143_));
