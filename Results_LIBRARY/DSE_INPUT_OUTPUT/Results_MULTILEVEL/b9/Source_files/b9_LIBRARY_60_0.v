...
module FAU ( 
  ...
  nand2  g034(.a(new_n64_), .b(x34), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n96_), .O(z02));
  nand2  g036(.a(new_n70_), .b(x27), .O(new_n99_));
  inv1   g037(.a(x27), .O(new_n100_));
  nand2  g038(.a(new_n69_), .b(new_n100_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n99_), .c(new_n65_), .d(x21), .O(z03));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n97_), .O(new_n145_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n100_), .c(new_n76_), .O(new_n149_));
  inv1   g087(.a(z08), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(x04), .c(new_n72_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n149_), .c(new_n65_), .O(z12));
  ...
  nor2   g099(.a(new_n134_), .b(x13), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n75_), .c(new_n66_), .O(new_n163_));
  ...
  nand3  g105(.a(x39), .b(new_n153_), .c(new_n75_), .O(new_n168_));
  ...
  oai21  g113(.a(new_n169_), .b(new_n73_), .c(new_n175_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  nand3  g115(.a(new_n72_), .b(new_n64_), .c(x34), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n171_), .O(z14));
  nand4  g117(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n65_), .O(z15));
  ...
  nand2  g126(.a(x27), .b(new_n75_), .O(new_n189_));
  ...
  aoi21  g131(.a(new_n191_), .b(new_n84_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n66_), .c(new_n150_), .d(new_n91_), .O(z18));
  nor2   g133(.a(new_n172_), .b(new_n100_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n100_), .c(new_n172_), .O(new_n197_));
  nand2  g135(.a(z08), .b(x29), .O(new_n198_));
  inv1   g136(.a(new_n198_), .O(new_n199_));
  oai22  g137(.a(new_n199_), .b(new_n197_), .c(new_n196_), .d(x08), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n81_), .c(new_n192_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n65_), .O(z20));
  nor2   g140(.a(new_n146_), .b(x09), .O(z19));
endmodule
