...
module FAU ( 
  ...
  aoi21  g094(.a(new_n156_), .b(x40), .c(new_n155_), .O(new_n157_));
  ...
  nand4  g103(.a(new_n165_), .b(x40), .c(new_n74_), .d(new_n73_), .O(new_n166_));
  ...
  aoi21  g119(.a(x40), .b(new_n181_), .c(new_n155_), .O(new_n182_));
  ...
  nand2  g129(.a(x40), .b(new_n83_), .O(new_n192_));
