...
module FAU ( 
  ...
  nand2  g017(.a(x30), .b(x02), .O(new_n80_));
  ...
  oai21  g025(.a(new_n82_), .b(x04), .c(new_n87_), .O(z01));
  inv1   g026(.a(x02), .O(new_n89_));
  nand2  g027(.a(x29), .b(x08), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g029(.a(x27), .b(x08), .c(new_n85_), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x04), .O(new_n93_));
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n80_), .d(new_n76_), .O(z02));
  nand2  g032(.a(new_n71_), .b(x27), .O(new_n95_));
  nand2  g033(.a(new_n70_), .b(new_n64_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n95_), .c(new_n80_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n82_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n70_), .c(new_n82_), .O(z05));
  nand3  g039(.a(new_n100_), .b(new_n80_), .c(new_n70_), .O(new_n102_));
  ...
  nand3  g050(.a(new_n112_), .b(new_n80_), .c(x03), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z07));
  nand3  g052(.a(new_n80_), .b(x40), .c(x39), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(z09));
  inv1   g057(.a(x28), .O(new_n120_));
  aoi21  g058(.a(x35), .b(new_n120_), .c(x36), .O(new_n121_));
  nand3  g059(.a(new_n80_), .b(new_n75_), .c(x07), .O(new_n122_));
  nand3  g060(.a(new_n76_), .b(new_n83_), .c(x05), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nand3  g062(.a(new_n80_), .b(x37), .c(x06), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n124_), .b(new_n65_), .c(new_n126_), .O(new_n127_));
  inv1   g065(.a(x40), .O(new_n128_));
  nand2  g066(.a(x30), .b(new_n89_), .O(new_n129_));
  nand2  g067(.a(x32), .b(new_n83_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  ...
  oai21  g073(.a(new_n64_), .b(new_n65_), .c(new_n85_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n83_), .c(new_n134_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n80_), .O(z11));
  ...
  aoi21  g085(.a(new_n147_), .b(new_n146_), .c(new_n82_), .O(z12));
  inv1   g086(.a(x19), .O(new_n149_));
  nand4  g087(.a(new_n80_), .b(new_n72_), .c(x20), .d(new_n149_), .O(new_n150_));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n128_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n83_), .d(new_n151_), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(x04), .c(new_n150_), .d(x18), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand4  g094(.a(new_n131_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand2  g096(.a(x20), .b(new_n149_), .O(new_n159_));
  nor2   g097(.a(x13), .b(x04), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n76_), .c(new_n82_), .O(new_n161_));
  nand4  g099(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n161_), .c(new_n159_), .d(x18), .O(new_n164_));
  nand3  g102(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(x27), .c(x32), .O(new_n166_));
  aoi22  g104(.a(new_n160_), .b(new_n76_), .c(new_n72_), .d(x27), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n83_), .O(new_n168_));
  nand2  g106(.a(new_n167_), .b(new_n89_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n168_), .c(new_n164_), .O(z14));
  inv1   g108(.a(x12), .O(new_n171_));
  nor2   g109(.a(new_n118_), .b(new_n171_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x22), .c(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n80_), .O(z16));
  inv1   g113(.a(x24), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(x23), .c(x22), .d(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n80_), .O(z17));
  nand2  g116(.a(new_n85_), .b(new_n64_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n135_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n139_), .c(new_n83_), .d(new_n134_), .O(z18));
  inv1   g120(.a(new_n142_), .O(z19));
  inv1   g121(.a(new_n135_), .O(new_n184_));
  oai21  g122(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n83_), .c(new_n134_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n80_), .O(z20));
endmodule
