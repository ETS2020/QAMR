...
module FAU ( 
  ...
  nor2   g041(.a(new_n85_), .b(new_n64_), .O(new_n104_));
  inv1   g042(.a(new_n104_), .O(new_n105_));
  nand3  g043(.a(new_n105_), .b(new_n80_), .c(new_n70_), .O(z05));
  oai21  g044(.a(new_n104_), .b(x37), .c(new_n80_), .O(z06));
  ...
  nand2  g052(.a(new_n114_), .b(new_n91_), .O(new_n115_));
  oai21  g053(.a(new_n112_), .b(x31), .c(new_n115_), .O(new_n116_));
  ...
  aoi21  g058(.a(new_n119_), .b(new_n91_), .c(new_n120_), .O(z08));
  inv1   g059(.a(x11), .O(new_n122_));
  nand4  g060(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  ...
  aoi21  g075(.a(x39), .b(x29), .c(x14), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x35), .c(new_n85_), .O(new_n140_));
  oai21  g078(.a(new_n138_), .b(new_n120_), .c(new_n140_), .O(new_n141_));
  ...
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n120_), .O(new_n153_));
  ...
  nand4  g097(.a(new_n129_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n160_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(x14), .O(new_n168_));
  ...
  nand2  g112(.a(new_n174_), .b(new_n91_), .O(new_n175_));
  nand2  g113(.a(new_n148_), .b(new_n120_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  inv1   g115(.a(x12), .O(new_n178_));
  nor2   g116(.a(new_n123_), .b(new_n178_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x22), .c(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n80_), .O(z16));
  inv1   g120(.a(x01), .O(new_n183_));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n80_), .b(new_n184_), .c(x23), .d(x22), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n183_), .O(z17));
  oai22  g124(.a(new_n86_), .b(x27), .c(new_n75_), .d(new_n94_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  inv1   g126(.a(new_n86_), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n80_), .d(new_n135_), .O(z18));
  nand2  g130(.a(x35), .b(x27), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n91_), .O(new_n194_));
  nand2  g132(.a(x40), .b(x04), .O(new_n195_));
  nand2  g133(.a(new_n120_), .b(new_n64_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n195_), .c(new_n194_), .d(new_n85_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n93_), .O(new_n198_));
  nand2  g136(.a(x39), .b(x29), .O(new_n199_));
  nand2  g137(.a(new_n66_), .b(new_n91_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n139_), .c(new_n85_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n199_), .O(new_n202_));
  nand2  g140(.a(new_n140_), .b(new_n120_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n202_), .c(new_n198_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n83_), .c(new_n135_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n80_), .O(z19));
  nor2   g144(.a(new_n138_), .b(new_n120_), .O(new_n207_));
  aoi21  g145(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n208_));
  nand2  g146(.a(new_n196_), .b(new_n194_), .O(new_n209_));
  nand2  g147(.a(new_n209_), .b(new_n93_), .O(new_n210_));
  oai21  g148(.a(new_n208_), .b(new_n207_), .c(new_n210_), .O(new_n211_));
  nand3  g149(.a(new_n211_), .b(new_n83_), .c(new_n135_), .O(new_n212_));
