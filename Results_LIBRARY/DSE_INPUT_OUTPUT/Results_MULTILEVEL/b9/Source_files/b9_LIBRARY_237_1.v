...
module FAU ( 
  ...
  nor2   g073(.a(new_n135_), .b(new_n121_), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(x33), .c(x05), .d(new_n126_), .O(new_n137_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(new_n99_), .O(new_n162_));
  nand4  g100(.a(new_n134_), .b(x39), .c(new_n155_), .d(new_n126_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(x33), .c(new_n74_), .O(new_n164_));
  or2    g102(.a(new_n164_), .b(new_n162_), .O(z13));
  nand3  g103(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n166_));
  nand4  g104(.a(new_n156_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n151_), .b(new_n155_), .c(new_n126_), .O(new_n169_));
  ...
  aoi21  g112(.a(new_n169_), .b(new_n69_), .c(new_n79_), .O(new_n175_));
  ...
  nand2  g122(.a(x27), .b(new_n126_), .O(new_n185_));
  nand2  g123(.a(new_n99_), .b(x08), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n171_), .O(new_n187_));
  ...
  nand2  g128(.a(new_n151_), .b(x33), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n90_), .c(new_n190_), .d(new_n79_), .O(z18));
  aoi21  g130(.a(x28), .b(new_n99_), .c(new_n171_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n144_), .O(new_n194_));
  nand2  g132(.a(new_n171_), .b(x33), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n139_), .c(x08), .O(new_n196_));
