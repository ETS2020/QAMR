...
module FAU ( 
  ...
  nand2  g022(.a(new_n84_), .b(new_n70_), .O(new_n85_));
  ...
  inv1   g026(.a(new_n65_), .O(new_n89_));
  ...
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n76_), .d(new_n89_), .O(z02));
  oai21  g033(.a(new_n69_), .b(new_n83_), .c(x27), .O(new_n96_));
  inv1   g034(.a(x21), .O(new_n97_));
  inv1   g035(.a(x37), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n67_), .c(new_n97_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n65_), .O(z03));
  aoi21  g038(.a(new_n98_), .b(new_n67_), .c(x21), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n96_), .c(new_n89_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n89_), .c(new_n98_), .O(z05));
  ...
  nand3  g054(.a(new_n89_), .b(x40), .c(x39), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  ...
  oai22  g084(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n67_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n89_), .O(z12));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n149_), .d(new_n68_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  nor2   g092(.a(new_n73_), .b(new_n64_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n67_), .O(new_n157_));
  nor3   g095(.a(new_n129_), .b(x13), .c(x04), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n63_), .O(new_n159_));
  inv1   g097(.a(x39), .O(new_n160_));
  aoi21  g098(.a(new_n151_), .b(x28), .c(new_n67_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n128_), .c(x40), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n64_), .c(new_n149_), .d(new_n68_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n159_), .O(z13));
  oai21  g103(.a(x19), .b(new_n154_), .c(x20), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n76_), .b(new_n149_), .c(new_n68_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n98_), .b(new_n69_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n82_), .c(new_n81_), .O(new_n173_));
  oai21  g111(.a(new_n73_), .b(new_n67_), .c(new_n169_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n63_), .O(new_n176_));
  nand4  g114(.a(new_n82_), .b(new_n81_), .c(new_n67_), .d(new_n64_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n170_), .O(z14));
  nand4  g116(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n89_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x22), .c(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n89_), .O(z16));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(x23), .c(x22), .d(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n89_), .O(z17));
  ...
  nor2   g127(.a(new_n189_), .b(new_n65_), .O(z18));
  oai21  g128(.a(new_n69_), .b(new_n67_), .c(new_n138_), .O(new_n191_));
  nand2  g129(.a(new_n135_), .b(new_n69_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n65_), .O(new_n193_));
  ...
  oai21  g135(.a(new_n197_), .b(x09), .c(new_n89_), .O(z19));
  inv1   g136(.a(new_n135_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n191_), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n89_), .c(new_n81_), .d(new_n134_), .O(new_n202_));
