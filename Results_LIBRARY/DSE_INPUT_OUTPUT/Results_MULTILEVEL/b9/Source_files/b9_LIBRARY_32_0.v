...
module FAU ( 
  ...
  aoi21  g055(.a(new_n117_), .b(new_n113_), .c(new_n63_), .O(z07));
  nand2  g056(.a(new_n95_), .b(new_n65_), .O(z08));
  ...
  nand2  g070(.a(new_n96_), .b(x29), .O(new_n133_));
  ...
  nand3  g076(.a(new_n135_), .b(x27), .c(new_n74_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n90_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n80_), .c(new_n132_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n65_), .O(z11));
  nand3  g081(.a(new_n70_), .b(new_n82_), .c(new_n134_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n74_), .c(new_n72_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x40), .O(new_n147_));
  inv1   g085(.a(new_n72_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n64_), .c(x03), .O(new_n149_));
  ...
  nand3  g098(.a(new_n126_), .b(x40), .c(x39), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x13), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n74_), .c(new_n66_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z13));
  nand3  g102(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n165_));
  nand4  g103(.a(new_n152_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n96_), .b(new_n151_), .c(new_n74_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  nand3  g107(.a(new_n70_), .b(new_n134_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n81_), .c(new_n80_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n148_), .c(new_n66_), .O(new_n173_));
  ...
  nand2  g116(.a(new_n178_), .b(new_n65_), .O(z16));
  ...
  oai21  g121(.a(new_n84_), .b(x27), .c(new_n133_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n66_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n139_), .d(new_n132_), .O(z18));
  nand2  g125(.a(new_n65_), .b(new_n69_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n189_));
  ...
  nand2  g131(.a(new_n64_), .b(x03), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n193_), .c(new_n136_), .d(new_n135_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n191_), .c(new_n80_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z19));
  nand2  g135(.a(x28), .b(new_n69_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n194_), .d(new_n193_), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n134_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n188_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n80_), .O(new_n202_));
