...
module FAU ( 
  ...
  or2    g019(.a(new_n81_), .b(new_n66_), .O(new_n82_));
  ...
  nand2  g025(.a(x35), .b(new_n80_), .O(new_n88_));
  nor2   g026(.a(x27), .b(x08), .O(new_n89_));
  oai21  g027(.a(new_n89_), .b(new_n88_), .c(x04), .O(new_n90_));
  nand3  g028(.a(new_n90_), .b(new_n87_), .c(x40), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x39), .O(new_n92_));
  oai21  g030(.a(new_n73_), .b(x39), .c(new_n92_), .O(z02));
  ...
  nor2   g037(.a(new_n80_), .b(new_n66_), .O(new_n100_));
  inv1   g038(.a(new_n100_), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n94_), .c(new_n67_), .O(z05));
  oai21  g040(.a(new_n100_), .b(x37), .c(new_n94_), .O(z06));
  ...
  nor2   g053(.a(new_n73_), .b(new_n115_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n94_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  ...
  aoi21  g060(.a(new_n122_), .b(new_n121_), .c(new_n81_), .O(new_n123_));
  ...
  nand3  g085(.a(new_n147_), .b(x40), .c(new_n115_), .O(new_n148_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(new_n115_), .O(new_n158_));
  ...
  nand3  g099(.a(new_n128_), .b(new_n150_), .c(new_n71_), .O(new_n162_));
  ...
  nand2  g112(.a(new_n174_), .b(new_n94_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand4  g114(.a(new_n94_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z16));
  inv1   g116(.a(x01), .O(new_n179_));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n94_), .b(new_n180_), .c(x23), .d(x22), .O(new_n181_));
  ...
  nand2  g123(.a(new_n78_), .b(new_n131_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(new_n80_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n63_), .c(new_n183_), .d(new_n86_), .O(z18));
  inv1   g126(.a(new_n132_), .O(new_n189_));
  oai21  g127(.a(new_n141_), .b(new_n66_), .c(new_n135_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n66_), .c(new_n141_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n78_), .c(new_n131_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n94_), .O(z20));
  nand2  g132(.a(new_n139_), .b(new_n94_), .O(z19));
endmodule
