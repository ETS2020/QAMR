...
module FAU ( 
  ...
  nand2  g053(.a(new_n94_), .b(new_n65_), .O(z08));
  ...
  oai21  g074(.a(new_n64_), .b(new_n136_), .c(x39), .O(new_n137_));
  ...
  aoi21  g082(.a(x40), .b(new_n74_), .c(new_n72_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x39), .O(new_n146_));
  nand2  g084(.a(new_n71_), .b(new_n70_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(x40), .c(new_n63_), .O(new_n149_));
  ...
  oai22  g123(.a(new_n94_), .b(new_n136_), .c(new_n84_), .d(x27), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n69_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n135_), .c(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n65_), .d(new_n80_), .O(z18));
  aoi21  g128(.a(x28), .b(new_n69_), .c(new_n134_), .O(new_n191_));
  aoi21  g129(.a(new_n138_), .b(new_n137_), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(x39), .b(new_n134_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n130_), .c(x08), .O(new_n194_));
