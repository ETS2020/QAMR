...
module FAU ( 
  ...
  oai21  g080(.a(new_n142_), .b(new_n136_), .c(new_n85_), .O(new_n143_));
  ...
  nand2  g123(.a(new_n85_), .b(new_n185_), .O(new_n186_));
  aoi21  g124(.a(new_n184_), .b(new_n87_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n84_), .c(new_n94_), .d(new_n75_), .O(z18));
  nand2  g126(.a(new_n141_), .b(new_n137_), .O(new_n189_));
  nand2  g127(.a(new_n76_), .b(x29), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  inv1   g129(.a(x08), .O(new_n192_));
  oai21  g130(.a(new_n182_), .b(new_n88_), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n85_), .c(new_n185_), .O(new_n195_));
  ...
  nand3  g138(.a(new_n200_), .b(new_n85_), .c(new_n185_), .O(new_n201_));
