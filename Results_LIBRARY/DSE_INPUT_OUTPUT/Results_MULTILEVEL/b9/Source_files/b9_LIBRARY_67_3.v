...
module FAU ( 
  ...
  nand4  g010(.a(new_n72_), .b(x40), .c(x39), .d(new_n64_), .O(new_n73_));
  aoi21  g011(.a(x35), .b(x28), .c(x37), .O(new_n74_));
  nand2  g012(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g013(.a(new_n75_), .b(x27), .c(new_n65_), .O(new_n76_));
  nand3  g014(.a(new_n76_), .b(new_n69_), .c(x16), .O(z00));
  ...
  oai21  g033(.a(new_n70_), .b(new_n82_), .c(x27), .O(new_n96_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n79_), .O(z03));
  aoi21  g039(.a(new_n99_), .b(new_n98_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n96_), .c(new_n79_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n89_), .c(new_n99_), .O(z05));
  ...
  nand2  g054(.a(new_n116_), .b(new_n89_), .O(z07));
  nand3  g055(.a(new_n89_), .b(x40), .c(x39), .O(new_n118_));
  ...
  oai21  g068(.a(new_n130_), .b(new_n126_), .c(new_n64_), .O(new_n131_));
  nand3  g069(.a(x37), .b(x27), .c(x06), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n79_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nor2   g073(.a(new_n98_), .b(new_n64_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n83_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n82_), .c(x27), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n89_), .c(new_n80_), .d(new_n134_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n98_), .c(new_n78_), .O(new_n145_));
  oai22  g083(.a(new_n74_), .b(new_n98_), .c(new_n67_), .d(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n89_), .O(z12));
  ...
  nor2   g092(.a(new_n74_), .b(new_n154_), .O(new_n155_));
  ...
  aoi21  g098(.a(new_n150_), .b(x28), .c(new_n98_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n128_), .c(x40), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n148_), .c(new_n78_), .d(new_n64_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n159_), .O(z13));
  aoi21  g103(.a(x20), .b(new_n153_), .c(x19), .O(new_n166_));
  nor2   g104(.a(new_n63_), .b(x10), .O(new_n167_));
  nand4  g105(.a(new_n150_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n88_), .b(new_n148_), .c(new_n64_), .O(new_n170_));
  oai22  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .d(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n99_), .b(new_n70_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n81_), .c(new_n80_), .O(new_n174_));
  oai21  g112(.a(new_n74_), .b(new_n98_), .c(new_n170_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n63_), .O(new_n177_));
  nand4  g115(.a(new_n81_), .b(new_n80_), .c(new_n98_), .d(new_n78_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n171_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nand4  g118(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n180_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand4  g121(.a(new_n89_), .b(new_n183_), .c(x22), .d(x01), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z16));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(x23), .c(x22), .d(x01), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n89_), .O(z17));
  oai21  g126(.a(new_n83_), .b(x27), .c(new_n135_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n79_), .b(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n139_), .d(new_n80_), .O(z18));
  oai21  g130(.a(new_n70_), .b(new_n98_), .c(new_n138_), .O(new_n193_));
  nand2  g131(.a(new_n135_), .b(new_n70_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(new_n79_), .O(new_n195_));
  oai21  g133(.a(x28), .b(x04), .c(new_n138_), .O(new_n196_));
  oai21  g134(.a(new_n136_), .b(x28), .c(new_n135_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n80_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(x09), .c(new_n89_), .O(z19));
  inv1   g138(.a(new_n135_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n98_), .c(new_n70_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n201_), .c(new_n193_), .O(new_n203_));
  nand4  g141(.a(new_n203_), .b(new_n89_), .c(new_n80_), .d(new_n134_), .O(new_n204_));
