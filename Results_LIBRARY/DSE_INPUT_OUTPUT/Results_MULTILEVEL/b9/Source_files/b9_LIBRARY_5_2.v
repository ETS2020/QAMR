...
module FAU ( 
  ...
  oai21  g011(.a(new_n73_), .b(x06), .c(new_n72_), .O(new_n74_));
  nand4  g012(.a(new_n74_), .b(x40), .c(x39), .d(new_n65_), .O(new_n75_));
  ...
  aoi21  g029(.a(new_n91_), .b(new_n87_), .c(new_n64_), .O(z02));
  ...
  nor2   g038(.a(new_n100_), .b(new_n67_), .O(new_n101_));
  inv1   g039(.a(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n97_), .c(new_n68_), .O(z05));
  ...
  oai21  g059(.a(new_n68_), .b(new_n67_), .c(x10), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x06), .O(new_n123_));
  inv1   g061(.a(x04), .O(new_n124_));
  nand2  g062(.a(new_n90_), .b(x07), .O(new_n125_));
  ...
  nand2  g070(.a(new_n132_), .b(new_n123_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(x35), .c(new_n100_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n100_), .c(x27), .d(new_n124_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(x08), .c(new_n138_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n97_), .c(new_n77_), .d(new_n134_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z11));
  oai21  g081(.a(new_n90_), .b(x04), .c(new_n69_), .O(new_n144_));
  nand3  g082(.a(new_n80_), .b(new_n79_), .c(new_n72_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n144_), .c(x37), .O(new_n146_));
  ...
  inv1   g087(.a(new_n90_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n124_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n149_), .c(x10), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n148_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n118_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n154_), .d(new_n124_), .O(new_n157_));
  inv1   g095(.a(x18), .O(new_n158_));
  inv1   g096(.a(x19), .O(new_n159_));
  nand2  g097(.a(new_n69_), .b(new_n68_), .O(new_n160_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n124_), .c(new_n64_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z13));
  nand3  g105(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n168_));
  nand4  g106(.a(new_n155_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  nand3  g108(.a(new_n150_), .b(new_n154_), .c(new_n124_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand3  g110(.a(new_n68_), .b(new_n79_), .c(x28), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(x27), .c(x32), .O(new_n174_));
  aoi22  g112(.a(new_n174_), .b(new_n77_), .c(new_n171_), .d(new_n149_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n172_), .c(new_n64_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n97_), .O(z15));
  inv1   g116(.a(x23), .O(new_n179_));
  nand4  g117(.a(new_n97_), .b(new_n179_), .c(x22), .d(x01), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z16));
  inv1   g119(.a(x01), .O(new_n182_));
  inv1   g120(.a(x24), .O(new_n183_));
  nand4  g121(.a(new_n97_), .b(new_n183_), .c(x23), .d(x22), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n182_), .O(z17));
  nand2  g123(.a(new_n88_), .b(new_n67_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n135_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n140_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n97_), .d(new_n134_), .O(z18));
  inv1   g128(.a(new_n135_), .O(new_n191_));
  nor2   g129(.a(new_n79_), .b(new_n67_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n67_), .c(new_n79_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .d(x08), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n97_), .c(new_n77_), .d(new_n134_), .O(new_n195_));
