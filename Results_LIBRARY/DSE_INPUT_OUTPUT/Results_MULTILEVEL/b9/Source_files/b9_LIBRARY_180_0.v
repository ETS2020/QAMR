...
module FAU ( 
  ...
  nor2   g017(.a(x33), .b(x11), .O(new_n80_));
  ...
  aoi21  g035(.a(new_n70_), .b(new_n64_), .c(new_n80_), .O(new_n98_));
  ...
  oai21  g042(.a(new_n102_), .b(x37), .c(new_n81_), .O(z06));
  ...
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n80_), .O(z10));
  ...
  aoi21  g084(.a(new_n146_), .b(new_n144_), .c(new_n80_), .O(z12));
  ...
  nand4  g098(.a(new_n150_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n161_));
  ...
  nand3  g104(.a(new_n166_), .b(new_n84_), .c(new_n83_), .O(new_n167_));
  aoi21  g105(.a(new_n163_), .b(new_n145_), .c(new_n80_), .O(new_n168_));
  ...
  oai21  g116(.a(new_n86_), .b(x27), .c(new_n133_), .O(new_n179_));
  nand3  g117(.a(new_n137_), .b(new_n83_), .c(new_n132_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(x08), .c(new_n180_), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n80_), .O(z18));
  nand4  g120(.a(new_n139_), .b(new_n81_), .c(new_n83_), .d(new_n132_), .O(new_n183_));
  ...
  nand3  g126(.a(new_n188_), .b(new_n83_), .c(new_n132_), .O(new_n189_));
