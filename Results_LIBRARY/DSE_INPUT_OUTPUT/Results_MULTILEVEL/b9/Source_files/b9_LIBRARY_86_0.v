...
module FAU ( 
  ...
  nand2  g009(.a(x10), .b(new_n65_), .O(new_n72_));
  nand2  g010(.a(x40), .b(x39), .O(new_n73_));
  oai21  g011(.a(new_n73_), .b(new_n72_), .c(x19), .O(new_n74_));
  ...
  nor2   g021(.a(x19), .b(x15), .O(new_n84_));
  ...
  aoi21  g029(.a(new_n91_), .b(x04), .c(new_n73_), .O(new_n92_));
  aoi21  g030(.a(new_n92_), .b(new_n89_), .c(new_n84_), .O(z02));
  oai21  g031(.a(new_n66_), .b(new_n79_), .c(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n64_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n85_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n95_), .b(new_n64_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n84_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n84_), .O(z05));
  nand3  g039(.a(new_n100_), .b(new_n85_), .c(new_n95_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(z06));
  inv1   g041(.a(x03), .O(new_n104_));
  inv1   g042(.a(x31), .O(new_n105_));
  inv1   g043(.a(x33), .O(new_n106_));
  inv1   g044(.a(x19), .O(new_n107_));
  oai21  g045(.a(new_n107_), .b(x17), .c(new_n63_), .O(new_n108_));
  inv1   g046(.a(x00), .O(new_n109_));
  oai21  g047(.a(x25), .b(new_n109_), .c(x38), .O(new_n110_));
  nand4  g048(.a(new_n110_), .b(new_n108_), .c(new_n106_), .d(new_n105_), .O(new_n111_));
  inv1   g049(.a(x14), .O(new_n112_));
  inv1   g050(.a(x25), .O(new_n113_));
  nand3  g051(.a(x38), .b(new_n113_), .c(new_n109_), .O(new_n114_));
  nand3  g052(.a(new_n114_), .b(new_n85_), .c(new_n112_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n111_), .c(new_n104_), .O(z07));
  inv1   g054(.a(x39), .O(new_n117_));
  inv1   g055(.a(x40), .O(new_n118_));
  nor3   g056(.a(new_n84_), .b(new_n118_), .c(new_n117_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n85_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n77_), .c(new_n133_), .O(new_n141_));
  ...
  oai22  g083(.a(new_n73_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n85_), .O(z12));
  ...
  nand3  g092(.a(new_n154_), .b(new_n107_), .c(new_n152_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n65_), .c(new_n84_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  aoi21  g099(.a(x20), .b(new_n152_), .c(new_n63_), .O(new_n162_));
  nand4  g100(.a(new_n149_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand4  g102(.a(x40), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n165_));
  oai22  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(x19), .O(new_n166_));
  nand3  g104(.a(new_n95_), .b(new_n66_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n78_), .c(new_n77_), .O(new_n169_));
  oai21  g107(.a(new_n70_), .b(new_n64_), .c(new_n165_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x15), .O(new_n172_));
  nand4  g110(.a(new_n78_), .b(new_n77_), .c(new_n64_), .d(x19), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n166_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n85_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand4  g115(.a(new_n85_), .b(new_n177_), .c(x22), .d(x01), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(z16));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(x23), .c(x22), .d(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n85_), .O(z17));
  oai21  g120(.a(new_n80_), .b(x27), .c(new_n134_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n84_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n138_), .d(new_n77_), .O(z18));
  inv1   g124(.a(new_n134_), .O(new_n187_));
  oai21  g125(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n77_), .c(new_n133_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n85_), .O(z20));
  nand2  g130(.a(new_n141_), .b(new_n85_), .O(z19));
endmodule
