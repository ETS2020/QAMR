...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n91_), .c(new_n81_), .d(new_n76_), .O(z02));
  ...
  nor2   g041(.a(new_n92_), .b(new_n64_), .O(new_n104_));
  ...
  aoi21  g062(.a(x35), .b(new_n92_), .c(x36), .O(new_n125_));
  nand3  g063(.a(new_n81_), .b(new_n75_), .c(x07), .O(new_n126_));
  nand3  g064(.a(new_n76_), .b(new_n83_), .c(x05), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  inv1   g066(.a(x06), .O(new_n129_));
  nand2  g067(.a(new_n81_), .b(x37), .O(new_n130_));
  nor2   g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  aoi21  g069(.a(new_n128_), .b(new_n65_), .c(new_n131_), .O(new_n132_));
  nand2  g070(.a(x30), .b(x18), .O(new_n133_));
  nand2  g071(.a(x32), .b(new_n83_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n133_), .c(new_n120_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x39), .c(x05), .d(new_n65_), .O(new_n136_));
  oai21  g074(.a(new_n132_), .b(new_n64_), .c(new_n136_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  nand2  g076(.a(new_n76_), .b(x29), .O(new_n139_));
  nor2   g077(.a(new_n64_), .b(new_n65_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n93_), .c(new_n139_), .O(new_n141_));
  inv1   g079(.a(x08), .O(new_n142_));
  nand3  g080(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n143_));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n150_), .c(new_n97_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n120_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n72_), .b(x20), .c(new_n157_), .d(new_n80_), .O(new_n158_));
  ...
  nor3   g099(.a(new_n161_), .b(new_n119_), .c(x13), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n97_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z13));
  nand3  g102(.a(x20), .b(new_n157_), .c(new_n80_), .O(new_n165_));
  nand4  g103(.a(new_n154_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n76_), .b(new_n153_), .c(new_n65_), .O(new_n168_));
  ...
  nand3  g110(.a(new_n72_), .b(new_n83_), .c(x27), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n168_), .c(new_n97_), .O(new_n174_));
  ...
  nand2  g122(.a(new_n85_), .b(new_n64_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n139_), .c(new_n142_), .O(new_n186_));
  nand2  g124(.a(new_n143_), .b(new_n138_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n83_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n133_), .O(z18));
  nand2  g127(.a(new_n146_), .b(new_n81_), .O(z19));
  inv1   g128(.a(new_n139_), .O(new_n191_));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n142_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n83_), .c(new_n138_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n81_), .O(z20));
endmodule
