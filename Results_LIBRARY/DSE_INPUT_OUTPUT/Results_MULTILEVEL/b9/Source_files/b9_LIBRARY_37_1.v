...
module FAU ( 
  ...
  nor2   g026(.a(new_n82_), .b(x28), .O(new_n89_));
  oai21  g027(.a(x27), .b(x08), .c(new_n89_), .O(new_n90_));
  aoi21  g028(.a(new_n90_), .b(x04), .c(new_n88_), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n63_), .c(x40), .O(z02));
  inv1   g030(.a(new_n64_), .O(new_n93_));
  ...
  nand4  g036(.a(new_n98_), .b(new_n94_), .c(new_n64_), .d(new_n95_), .O(z04));
  inv1   g037(.a(x28), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n66_), .O(new_n101_));
  inv1   g039(.a(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n64_), .c(new_n67_), .O(z05));
  ...
  nor2   g053(.a(new_n75_), .b(new_n63_), .O(z08));
  ...
  nand2  g064(.a(new_n126_), .b(new_n73_), .O(new_n127_));
  ...
  nand4  g093(.a(new_n153_), .b(new_n75_), .c(x20), .d(new_n152_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand4  g096(.a(new_n124_), .b(x39), .c(new_n147_), .d(new_n73_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  aoi21  g098(.a(new_n147_), .b(new_n73_), .c(new_n63_), .O(new_n161_));
  nor2   g099(.a(x19), .b(x18), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n153_), .c(x27), .d(x20), .O(new_n163_));
  oai21  g101(.a(new_n161_), .b(new_n75_), .c(new_n163_), .O(new_n164_));
  nand3  g102(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n165_));
  nor2   g103(.a(x37), .b(x35), .O(new_n166_));
  aoi21  g104(.a(new_n165_), .b(new_n148_), .c(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n100_), .c(x27), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n164_), .O(z14));
  nand4  g108(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n64_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x22), .c(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n64_), .O(z16));
  inv1   g113(.a(x24), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(x23), .c(x22), .d(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n64_), .O(z17));
  nand2  g116(.a(x27), .b(new_n73_), .O(new_n179_));
  nand2  g117(.a(new_n66_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n82_), .O(new_n181_));
  nand2  g119(.a(new_n80_), .b(new_n130_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n100_), .c(new_n182_), .O(new_n183_));
  nand3  g121(.a(z08), .b(x29), .c(x08), .O(new_n184_));
  oai21  g122(.a(new_n183_), .b(new_n93_), .c(new_n184_), .O(z18));
  inv1   g123(.a(x29), .O(new_n186_));
  aoi21  g124(.a(x39), .b(new_n186_), .c(new_n75_), .O(new_n187_));
  aoi21  g125(.a(new_n132_), .b(new_n89_), .c(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n66_), .O(new_n189_));
  nand3  g127(.a(x35), .b(new_n100_), .c(new_n73_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x39), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n189_), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n188_), .c(new_n80_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(x09), .O(z19));
  aoi21  g132(.a(x28), .b(new_n66_), .c(new_n82_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n187_), .O(new_n196_));
  nand2  g134(.a(x39), .b(new_n82_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n189_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n80_), .O(new_n199_));
