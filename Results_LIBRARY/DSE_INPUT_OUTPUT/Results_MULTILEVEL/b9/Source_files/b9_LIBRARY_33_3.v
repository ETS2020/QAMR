...
module FAU ( 
  ...
  nand3  g23(.a(new_n85_), .b(z02), .c(new_n66_), .O(z05));
  ...
  nand4  g53(.a(new_n116_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n117_));
  inv1   g54(.a(new_n117_), .O(z11));
  nand3  g55(.a(new_n68_), .b(z02), .c(x27), .O(z12));
  nand4  g56(.a(new_n68_), .b(z02), .c(x27), .d(x20), .O(new_n120_));
  ...
  aoi21  g61(.a(new_n124_), .b(new_n68_), .c(new_n64_), .O(z14));
  ...
  aoi21  g75(.a(new_n138_), .b(new_n137_), .c(new_n64_), .O(z18));
  oai21  g76(.a(x28), .b(new_n114_), .c(new_n80_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g78(.a(new_n141_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n142_));
  inv1   g79(.a(new_n142_), .O(z20));
  zero   g80(.O(z08));
  inv1   g81(.a(new_n117_), .O(z19));
endmodule
