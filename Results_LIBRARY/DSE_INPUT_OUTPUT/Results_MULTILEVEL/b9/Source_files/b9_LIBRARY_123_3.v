...
module FAU ( 
  ...
  nand2  g015(.a(x40), .b(x25), .O(new_n78_));
  ...
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n78_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n97_), .b(new_n64_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n80_), .O(z04));
  nor2   g039(.a(new_n83_), .b(new_n64_), .O(new_n102_));
  inv1   g040(.a(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n78_), .c(new_n97_), .O(z05));
  oai21  g042(.a(new_n102_), .b(x37), .c(new_n78_), .O(z06));
  ...
  aoi21  g048(.a(x38), .b(new_n110_), .c(x25), .O(new_n111_));
  nor2   g049(.a(x40), .b(x38), .O(new_n112_));
  or2    g050(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g051(.a(new_n113_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n114_));
  inv1   g052(.a(x14), .O(new_n115_));
  nor2   g053(.a(x40), .b(new_n88_), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(new_n111_), .c(new_n115_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n114_), .c(new_n106_), .O(z07));
  oai21  g056(.a(x39), .b(x25), .c(x40), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(z08));
  inv1   g058(.a(x11), .O(new_n121_));
  nand4  g059(.a(new_n78_), .b(x34), .c(x27), .d(x26), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n121_), .O(z09));
  nand2  g061(.a(new_n119_), .b(x07), .O(new_n124_));
  nand3  g062(.a(new_n74_), .b(new_n88_), .c(x05), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n124_), .c(new_n84_), .O(new_n126_));
  nand3  g064(.a(new_n78_), .b(x37), .c(x06), .O(new_n127_));
  ...
  nor3   g068(.a(new_n130_), .b(new_n72_), .c(x25), .O(new_n131_));
  ...
  nand3  g072(.a(x35), .b(new_n83_), .c(new_n65_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(new_n88_), .c(new_n78_), .d(new_n64_), .O(new_n136_));
  aoi21  g074(.a(x39), .b(x29), .c(x25), .O(new_n137_));
  nor2   g075(.a(new_n64_), .b(new_n65_), .O(new_n138_));
  oai22  g076(.a(new_n138_), .b(new_n90_), .c(new_n137_), .d(new_n73_), .O(new_n139_));
  oai21  g077(.a(new_n136_), .b(x08), .c(new_n139_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n81_), .c(new_n134_), .O(new_n141_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(x25), .O(new_n158_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(x25), .O(new_n168_));
  ...
  nand2  g114(.a(new_n176_), .b(new_n78_), .O(z15));
  inv1   g115(.a(x23), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x22), .c(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n78_), .O(z16));
  inv1   g118(.a(x01), .O(new_n181_));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n78_), .b(new_n182_), .c(x23), .d(x22), .O(new_n183_));
  ...
  nand2  g125(.a(new_n81_), .b(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n83_), .c(new_n188_), .O(new_n189_));
  nand2  g127(.a(new_n74_), .b(x29), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n88_), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n189_), .b(new_n80_), .c(new_n192_), .O(z18));
  nand2  g131(.a(x40), .b(x04), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(x35), .c(new_n83_), .O(new_n195_));
  aoi22  g133(.a(new_n195_), .b(new_n88_), .c(new_n78_), .d(new_n64_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(x08), .c(new_n139_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n81_), .c(new_n134_), .O(new_n198_));
  inv1   g136(.a(new_n198_), .O(z19));
  inv1   g137(.a(x08), .O(new_n200_));
  oai21  g138(.a(new_n66_), .b(new_n64_), .c(new_n200_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n191_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n81_), .c(new_n134_), .O(new_n204_));
