...
module FAU ( 
  ...
  nand3  g022(.a(new_n84_), .b(new_n72_), .c(new_n79_), .O(new_n85_));
  oai21  g023(.a(new_n64_), .b(x04), .c(new_n85_), .O(z01));
  ...
  nand2  g030(.a(new_n92_), .b(new_n72_), .O(new_n93_));
  ...
  inv1   g064(.a(new_n122_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(x30), .c(x05), .O(new_n128_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(new_n72_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x40), .O(new_n138_));
  nand3  g076(.a(x40), .b(x39), .c(x29), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(x35), .c(new_n81_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  oai21  g080(.a(new_n82_), .b(new_n67_), .c(new_n133_), .O(new_n143_));
  ...
  nand3  g085(.a(new_n68_), .b(new_n80_), .c(new_n147_), .O(new_n148_));
  ...
  inv1   g089(.a(new_n70_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n74_), .O(new_n153_));
  ...
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n121_), .O(new_n158_));
  inv1   g096(.a(x18), .O(new_n159_));
  inv1   g097(.a(x19), .O(new_n160_));
  nand2  g098(.a(new_n69_), .b(new_n68_), .O(new_n161_));
  ...
  nand4  g102(.a(x39), .b(x30), .c(new_n155_), .d(new_n121_), .O(new_n165_));
  ...
  nand3  g107(.a(new_n156_), .b(new_n79_), .c(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  nand3  g109(.a(new_n127_), .b(new_n155_), .c(new_n121_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n171_), .c(new_n169_), .O(new_n173_));
  nand3  g111(.a(new_n68_), .b(new_n147_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n79_), .O(new_n176_));
  nand2  g114(.a(new_n172_), .b(new_n152_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n176_), .c(new_n173_), .d(new_n63_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nor2   g117(.a(new_n119_), .b(new_n179_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand4  g119(.a(new_n63_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z16));
  inv1   g121(.a(x01), .O(new_n184_));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n63_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  nand2  g125(.a(x27), .b(new_n121_), .O(new_n188_));
  nand2  g126(.a(new_n67_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n147_), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n81_), .c(new_n136_), .O(new_n191_));
  nand2  g129(.a(new_n127_), .b(new_n72_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n88_), .c(new_n191_), .d(new_n64_), .O(z18));
  aoi21  g131(.a(x40), .b(x32), .c(x27), .O(new_n194_));
  nand2  g132(.a(x40), .b(x04), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(x35), .c(new_n81_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n72_), .c(new_n194_), .O(new_n197_));
  aoi21  g135(.a(x39), .b(x29), .c(x32), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n74_), .c(new_n141_), .O(new_n199_));
  oai21  g137(.a(new_n197_), .b(x08), .c(new_n199_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n135_), .O(new_n201_));
  inv1   g139(.a(new_n201_), .O(z19));
  inv1   g140(.a(new_n139_), .O(new_n203_));
  oai21  g141(.a(new_n147_), .b(new_n67_), .c(new_n133_), .O(new_n204_));
  aoi21  g142(.a(x28), .b(new_n67_), .c(new_n147_), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n203_), .c(new_n204_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n79_), .c(new_n135_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n63_), .O(z20));
endmodule
