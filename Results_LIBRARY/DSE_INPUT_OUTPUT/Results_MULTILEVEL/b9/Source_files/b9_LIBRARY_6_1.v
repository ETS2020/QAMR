...
module FAU ( 
  ...
  inv1   g035(.a(x05), .O(new_n98_));
  nor2   g036(.a(x37), .b(x27), .O(new_n99_));
  aoi21  g037(.a(new_n73_), .b(x27), .c(new_n99_), .O(new_n100_));
  oai21  g038(.a(new_n100_), .b(new_n98_), .c(x21), .O(z03));
  nand2  g039(.a(new_n73_), .b(x27), .O(new_n102_));
  inv1   g040(.a(new_n99_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n102_), .c(new_n63_), .O(z04));
  inv1   g042(.a(new_n64_), .O(new_n105_));
  nor2   g043(.a(new_n85_), .b(new_n66_), .O(new_n106_));
  inv1   g044(.a(new_n106_), .O(new_n107_));
  nand3  g045(.a(new_n107_), .b(new_n105_), .c(new_n72_), .O(z05));
  ...
  nor3   g060(.a(new_n64_), .b(new_n122_), .c(new_n121_), .O(z08));
  ...
  oai21  g065(.a(new_n126_), .b(new_n98_), .c(new_n127_), .O(new_n128_));
  ...
  nand4  g082(.a(new_n144_), .b(new_n105_), .c(new_n83_), .d(new_n137_), .O(new_n145_));
  ...
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n122_), .O(new_n155_));
  ...
  nand4  g133(.a(new_n195_), .b(new_n105_), .c(new_n83_), .d(new_n137_), .O(new_n196_));
