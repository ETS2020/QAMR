...
module FAU ( 
  ...
  oai21  g004(.a(new_n66_), .b(new_n65_), .c(x19), .O(new_n67_));
  ...
  nand4  g010(.a(new_n72_), .b(x40), .c(x39), .d(new_n63_), .O(new_n73_));
  nand2  g011(.a(x35), .b(x28), .O(new_n74_));
  nand3  g012(.a(new_n74_), .b(new_n73_), .c(new_n69_), .O(new_n75_));
  nand3  g013(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n76_));
  nand3  g014(.a(new_n76_), .b(new_n68_), .c(x16), .O(z00));
  inv1   g015(.a(x30), .O(new_n78_));
  inv1   g016(.a(x32), .O(new_n79_));
  inv1   g017(.a(x28), .O(new_n80_));
  nand2  g018(.a(x35), .b(new_n80_), .O(new_n81_));
  nand2  g019(.a(new_n81_), .b(new_n71_), .O(new_n82_));
  nand2  g020(.a(new_n82_), .b(x27), .O(new_n83_));
  nand3  g021(.a(new_n83_), .b(new_n79_), .c(new_n78_), .O(new_n84_));
  inv1   g022(.a(x19), .O(new_n85_));
  nand2  g023(.a(new_n85_), .b(x10), .O(new_n86_));
  nand3  g024(.a(new_n86_), .b(new_n84_), .c(x04), .O(z01));
  inv1   g025(.a(new_n66_), .O(new_n88_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n81_), .c(x04), .O(new_n93_));
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n86_), .d(new_n88_), .O(z02));
  ...
  aoi21  g036(.a(new_n69_), .b(new_n98_), .c(new_n97_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n95_), .O(z03));
  aoi21  g038(.a(new_n69_), .b(new_n98_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n95_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n86_), .c(new_n69_), .O(z05));
  inv1   g042(.a(z05), .O(z06));
  inv1   g043(.a(x33), .O(new_n106_));
  nand2  g044(.a(x17), .b(new_n64_), .O(new_n107_));
  ...
  nor3   g056(.a(new_n95_), .b(new_n118_), .c(new_n117_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n86_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  inv1   g060(.a(x05), .O(new_n123_));
  nand2  g061(.a(new_n66_), .b(x07), .O(new_n124_));
  oai21  g062(.a(new_n66_), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  ...
  nand2  g067(.a(new_n129_), .b(new_n63_), .O(new_n130_));
  nand3  g068(.a(x37), .b(x27), .c(x06), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n86_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(new_n88_), .b(x29), .O(new_n134_));
  nor2   g072(.a(new_n98_), .b(new_n63_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n81_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n80_), .c(x27), .d(new_n63_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n86_), .c(new_n78_), .d(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nand3  g080(.a(new_n86_), .b(new_n74_), .c(new_n69_), .O(new_n143_));
  oai21  g081(.a(x27), .b(new_n85_), .c(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n66_), .b(x04), .c(new_n144_), .O(new_n145_));
  inv1   g083(.a(x10), .O(new_n146_));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n98_), .c(new_n146_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n145_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n118_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n63_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  nand2  g092(.a(new_n74_), .b(new_n69_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x20), .c(new_n85_), .d(new_n154_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n98_), .O(new_n157_));
  nand3  g095(.a(new_n127_), .b(x40), .c(x39), .O(new_n158_));
  nor3   g096(.a(new_n158_), .b(x13), .c(x04), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(new_n146_), .O(new_n160_));
  aoi21  g098(.a(new_n151_), .b(x28), .c(new_n98_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n127_), .c(x40), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n117_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x19), .c(new_n150_), .d(new_n63_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n160_), .O(z13));
  nand3  g103(.a(x20), .b(new_n85_), .c(new_n154_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n88_), .b(new_n150_), .c(new_n63_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g108(.a(new_n69_), .b(new_n70_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n79_), .c(new_n78_), .O(new_n173_));
  nand2  g111(.a(new_n155_), .b(x27), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n169_), .c(new_n95_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n173_), .c(new_n170_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n86_), .O(z15));
  inv1   g116(.a(x23), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(x22), .c(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n86_), .O(z16));
  inv1   g119(.a(x24), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(x23), .c(x22), .d(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n86_), .O(z17));
  oai21  g122(.a(new_n81_), .b(x27), .c(new_n134_), .O(new_n185_));
  nand3  g123(.a(new_n138_), .b(new_n78_), .c(new_n133_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(x08), .c(new_n186_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n95_), .O(z18));
  inv1   g126(.a(new_n134_), .O(new_n189_));
  oai21  g127(.a(new_n70_), .b(new_n98_), .c(new_n137_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n98_), .c(new_n70_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n86_), .c(new_n78_), .d(new_n133_), .O(new_n193_));
  inv1   g131(.a(new_n193_), .O(z20));
  inv1   g132(.a(new_n141_), .O(z19));
endmodule
