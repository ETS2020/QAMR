// Benchmark "FAU" written by ABC on Thu Aug 13 18:17:16 2020
...
module FAU ( 
  ...
  nand2  g024(.a(new_n64_), .b(new_n86_), .O(new_n87_));
  nand4  g025(.a(new_n87_), .b(x35), .c(x30), .d(new_n85_), .O(new_n88_));
  aoi21  g026(.a(new_n88_), .b(x04), .c(new_n75_), .O(new_n89_));
  oai21  g027(.a(new_n84_), .b(x02), .c(new_n89_), .O(z02));
  nand2  g028(.a(new_n71_), .b(x27), .O(new_n91_));
  inv1   g029(.a(x21), .O(new_n92_));
  aoi21  g030(.a(new_n70_), .b(new_n64_), .c(new_n92_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(new_n91_), .c(new_n81_), .O(z03));
  aoi21  g032(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n91_), .c(new_n81_), .O(z04));
  inv1   g034(.a(new_n81_), .O(new_n97_));
  oai21  g035(.a(new_n85_), .b(new_n64_), .c(new_n70_), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n97_), .O(z06));
  ...
  nand2  g049(.a(new_n111_), .b(new_n97_), .O(z07));
  ...
  nand2  g054(.a(new_n116_), .b(new_n97_), .O(z09));
  nand2  g055(.a(x35), .b(new_n85_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n67_), .O(new_n119_));
  nand2  g057(.a(new_n75_), .b(x07), .O(new_n120_));
  nand3  g058(.a(x40), .b(x39), .c(x05), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n119_), .c(x27), .O(new_n123_));
  inv1   g061(.a(x30), .O(new_n124_));
  inv1   g062(.a(x32), .O(new_n125_));
  ...
  nand2  g066(.a(new_n128_), .b(z01), .O(new_n129_));
  nand3  g067(.a(x37), .b(x27), .c(x06), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n97_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(new_n84_), .b(new_n76_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n118_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n87_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n124_), .c(new_n132_), .d(z01), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n64_), .c(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n72_), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n75_), .b(x04), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n140_), .c(new_n97_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x28), .c(new_n114_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(z01), .O(new_n147_));
  ...
  nand3  g090(.a(new_n126_), .b(x40), .c(x39), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x13), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(z01), .c(new_n81_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n152_), .O(z13));
  nand3  g094(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n157_));
  nand4  g095(.a(new_n145_), .b(new_n125_), .c(new_n124_), .d(x28), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  nand3  g097(.a(new_n76_), .b(new_n144_), .c(z01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(new_n157_), .O(new_n161_));
  nand3  g099(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(x27), .c(x32), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(x04), .c(new_n124_), .O(new_n164_));
  nand2  g102(.a(new_n160_), .b(new_n141_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n164_), .c(new_n161_), .O(z14));
  inv1   g104(.a(x12), .O(new_n167_));
  nand4  g105(.a(new_n97_), .b(x34), .c(x27), .d(x26), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(new_n167_), .O(z15));
  inv1   g107(.a(x23), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(x22), .c(x01), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n97_), .O(z16));
  inv1   g110(.a(x01), .O(new_n173_));
  inv1   g111(.a(x24), .O(new_n174_));
  nand4  g112(.a(new_n97_), .b(new_n174_), .c(x23), .d(x22), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n173_), .O(z17));
  nand3  g114(.a(x40), .b(x39), .c(x29), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n118_), .c(new_n86_), .O(new_n178_));
  oai21  g116(.a(new_n118_), .b(new_n64_), .c(new_n132_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n178_), .c(z01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n124_), .O(z18));
  inv1   g119(.a(new_n177_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n86_), .O(new_n183_));
