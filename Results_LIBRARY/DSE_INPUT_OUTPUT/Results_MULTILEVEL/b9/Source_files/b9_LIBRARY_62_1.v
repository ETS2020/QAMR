...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x03), .O(new_n93_));
  ...
  oai21  g038(.a(new_n83_), .b(new_n68_), .c(new_n69_), .O(new_n101_));
  ...
  nand3  g052(.a(x40), .b(x39), .c(x03), .O(new_n115_));
  ...
  nand4  g097(.a(new_n126_), .b(new_n148_), .c(new_n73_), .d(x03), .O(new_n160_));
  ...
  nand3  g103(.a(new_n165_), .b(new_n148_), .c(new_n73_), .O(new_n166_));
  ...
  nand3  g124(.a(new_n135_), .b(x27), .c(new_n73_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n80_), .O(z18));
  inv1   g126(.a(x09), .O(new_n189_));
  nand2  g127(.a(new_n138_), .b(new_n135_), .O(new_n190_));
  ...
  oai21  g135(.a(new_n142_), .b(new_n68_), .c(new_n192_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n142_), .O(new_n199_));
