...
module FAU ( 
  ...
  nor2   g023(.a(new_n80_), .b(x28), .O(new_n86_));
  ...
  nor2   g067(.a(new_n69_), .b(new_n68_), .O(new_n130_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n88_), .c(new_n86_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n99_), .c(new_n78_), .d(new_n133_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n68_), .c(new_n73_), .O(new_n139_));
  inv1   g077(.a(new_n71_), .O(new_n140_));
  oai21  g078(.a(new_n121_), .b(x04), .c(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n139_), .c(new_n99_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x28), .c(new_n64_), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x39), .c(new_n143_), .d(new_n120_), .O(new_n146_));
  ...
  nand4  g090(.a(new_n126_), .b(x39), .c(new_n143_), .d(new_n120_), .O(new_n153_));
  ...
  nand4  g097(.a(x40), .b(x39), .c(new_n143_), .d(new_n120_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(new_n157_), .O(new_n161_));
  nand3  g099(.a(new_n69_), .b(new_n80_), .c(x28), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n79_), .c(new_n78_), .O(new_n164_));
  aoi21  g102(.a(new_n160_), .b(new_n140_), .c(new_n65_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n164_), .c(new_n161_), .O(z14));
  nand4  g104(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n99_), .O(z15));
  inv1   g106(.a(x23), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(x22), .c(x01), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n99_), .O(z16));
  inv1   g109(.a(x01), .O(new_n172_));
  inv1   g110(.a(x24), .O(new_n173_));
  nand4  g111(.a(new_n99_), .b(new_n173_), .c(x23), .d(x22), .O(new_n174_));
  nor2   g112(.a(new_n174_), .b(new_n172_), .O(z17));
  inv1   g113(.a(x28), .O(new_n176_));
  nand2  g114(.a(x27), .b(new_n120_), .O(new_n177_));
  oai21  g115(.a(x27), .b(new_n87_), .c(new_n177_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x35), .c(new_n176_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n99_), .c(new_n78_), .d(new_n133_), .O(z18));
  nand3  g118(.a(new_n135_), .b(new_n78_), .c(new_n133_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n99_), .O(z19));
  oai21  g120(.a(x28), .b(new_n87_), .c(new_n68_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x35), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n78_), .c(new_n133_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n99_), .O(z20));
endmodule
