...
module FAU ( 
  ...
  oai21  g026(.a(new_n63_), .b(x08), .c(x29), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  inv1   g028(.a(x39), .O(new_n91_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n71_), .O(new_n96_));
  oai21  g034(.a(new_n96_), .b(new_n91_), .c(x40), .O(new_n97_));
  inv1   g035(.a(x29), .O(new_n98_));
  nand2  g036(.a(new_n63_), .b(new_n98_), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n97_), .c(new_n90_), .O(z02));
  nand2  g038(.a(new_n66_), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n65_), .b(new_n94_), .c(new_n78_), .O(new_n102_));
  ...
  nand3  g044(.a(new_n106_), .b(new_n64_), .c(new_n65_), .O(z05));
  ...
  oai21  g067(.a(new_n129_), .b(new_n127_), .c(new_n84_), .O(new_n130_));
  ...
  nor2   g072(.a(new_n134_), .b(new_n91_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x05), .c(new_n71_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(z10));
  aoi21  g075(.a(x40), .b(new_n91_), .c(new_n98_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n92_), .c(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n64_), .b(new_n94_), .O(new_n141_));
  oai21  g079(.a(new_n83_), .b(x04), .c(x40), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n141_), .c(x08), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n140_), .c(new_n79_), .O(new_n144_));
  nor2   g082(.a(new_n144_), .b(x09), .O(z11));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n94_), .c(new_n73_), .O(new_n147_));
  oai21  g085(.a(new_n121_), .b(x04), .c(new_n68_), .O(new_n148_));
  ...
  nand4  g095(.a(new_n67_), .b(new_n98_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n135_), .b(new_n150_), .c(new_n71_), .O(new_n161_));
  ...
  nand2  g121(.a(new_n94_), .b(x08), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(new_n168_), .O(new_n185_));
  ...
  nand3  g126(.a(new_n120_), .b(x29), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n188_), .b(new_n78_), .c(new_n189_), .O(z18));
  aoi21  g128(.a(x28), .b(new_n94_), .c(new_n168_), .O(new_n191_));
  nor2   g129(.a(new_n191_), .b(new_n138_), .O(new_n192_));
  nand2  g130(.a(x40), .b(new_n168_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n141_), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n79_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z20));
  nor2   g134(.a(new_n144_), .b(x09), .O(z19));
endmodule
