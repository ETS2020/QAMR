...
module FAU ( 
  ...
  nor2   g001(.a(x24), .b(new_n63_), .O(new_n64_));
  ...
  nand4  g091(.a(new_n153_), .b(x20), .c(new_n63_), .d(new_n152_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand4  g094(.a(new_n126_), .b(x39), .c(new_n148_), .d(new_n67_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n156_), .c(new_n102_), .O(z13));
  aoi21  g096(.a(x20), .b(new_n152_), .c(x19), .O(new_n159_));
  and2   g097(.a(x24), .b(x19), .O(new_n160_));
  ...
  nand3  g108(.a(new_n125_), .b(new_n66_), .c(x24), .O(new_n171_));
  ...
  nand4  g115(.a(x23), .b(x22), .c(new_n63_), .d(x01), .O(new_n178_));
