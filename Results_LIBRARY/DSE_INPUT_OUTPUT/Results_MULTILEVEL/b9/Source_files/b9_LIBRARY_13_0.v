...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(x09), .O(new_n94_));
  ...
  nor2   g040(.a(new_n83_), .b(new_n97_), .O(new_n103_));
  ...
  nor2   g072(.a(new_n97_), .b(new_n72_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n84_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  inv1   g075(.a(new_n84_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(x27), .c(new_n72_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n80_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x39), .c(x09), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n97_), .c(new_n74_), .O(new_n145_));
  nand2  g083(.a(z08), .b(new_n72_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n69_), .O(new_n147_));
  ...
  nand2  g118(.a(new_n138_), .b(new_n97_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n134_), .c(new_n137_), .O(new_n182_));
  nand2  g120(.a(new_n139_), .b(new_n80_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n182_), .c(x39), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n63_), .O(z18));
  nand4  g123(.a(new_n141_), .b(x39), .c(new_n80_), .d(new_n63_), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(z19));
  inv1   g125(.a(new_n134_), .O(new_n188_));
  oai21  g126(.a(new_n166_), .b(new_n97_), .c(new_n137_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n97_), .c(new_n166_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(x39), .c(new_n80_), .d(new_n63_), .O(new_n192_));
