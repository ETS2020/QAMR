...
module FAU ( 
  ...
  inv1   g020(.a(new_n63_), .O(new_n83_));
  ...
  nand2  g028(.a(new_n90_), .b(new_n86_), .O(z02));
  oai21  g029(.a(new_n77_), .b(new_n87_), .c(x27), .O(new_n92_));
  inv1   g030(.a(x21), .O(new_n93_));
  inv1   g031(.a(x37), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n66_), .c(new_n93_), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n63_), .O(z03));
  nand2  g034(.a(new_n94_), .b(new_n66_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n92_), .c(new_n83_), .d(new_n93_), .O(z04));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n83_), .c(new_n94_), .O(z05));
  ...
  nand3  g050(.a(new_n112_), .b(new_n83_), .c(x03), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z07));
  inv1   g052(.a(x39), .O(new_n115_));
  nor3   g053(.a(new_n63_), .b(new_n71_), .c(new_n115_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n83_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(z09));
  inv1   g057(.a(x04), .O(new_n120_));
  nand4  g058(.a(new_n85_), .b(new_n79_), .c(x27), .d(x07), .O(new_n121_));
  inv1   g059(.a(new_n85_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(x05), .c(new_n76_), .O(new_n123_));
  ...
  oai21  g067(.a(new_n88_), .b(x27), .c(new_n129_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n76_), .c(new_n128_), .d(x04), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(z11));
  nor3   g071(.a(x37), .b(x36), .c(x35), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n66_), .c(new_n70_), .O(new_n135_));
  oai22  g073(.a(new_n85_), .b(x04), .c(new_n67_), .d(new_n66_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n83_), .O(z12));
  inv1   g075(.a(x19), .O(new_n138_));
  nor2   g076(.a(new_n67_), .b(new_n63_), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(x27), .c(x20), .d(new_n138_), .O(new_n140_));
  inv1   g078(.a(x13), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n120_), .O(new_n142_));
  nand2  g080(.a(new_n122_), .b(x30), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(x18), .O(z13));
  inv1   g082(.a(x18), .O(new_n145_));
  nand4  g083(.a(x27), .b(x20), .c(new_n138_), .d(new_n145_), .O(new_n146_));
  oai22  g084(.a(new_n146_), .b(new_n67_), .c(new_n142_), .d(new_n85_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n83_), .O(z14));
  inv1   g086(.a(x12), .O(new_n149_));
  nor2   g087(.a(new_n118_), .b(new_n149_), .O(z15));
  inv1   g088(.a(x23), .O(new_n151_));
  nand4  g089(.a(new_n83_), .b(new_n151_), .c(x22), .d(x01), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(z16));
  inv1   g091(.a(x24), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x23), .c(x22), .d(x01), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n83_), .O(z17));
  nand4  g094(.a(new_n131_), .b(new_n76_), .c(new_n128_), .d(x04), .O(z18));
  inv1   g095(.a(new_n129_), .O(new_n158_));
  inv1   g096(.a(x08), .O(new_n159_));
  oai21  g097(.a(new_n77_), .b(new_n66_), .c(new_n159_), .O(new_n160_));
  aoi21  g098(.a(x28), .b(new_n66_), .c(new_n77_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n158_), .c(new_n160_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n128_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(x04), .c(x30), .O(z20));
  inv1   g102(.a(new_n132_), .O(z19));
endmodule
