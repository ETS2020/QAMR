...
module FAU ( 
  ...
  oai21  g037(.a(new_n82_), .b(new_n68_), .c(new_n69_), .O(new_n100_));
  ...
  nand3  g045(.a(x38), .b(new_n107_), .c(x00), .O(new_n108_));
  nand2  g046(.a(new_n74_), .b(new_n63_), .O(new_n109_));
  nand2  g047(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g048(.a(new_n110_), .b(new_n106_), .c(new_n105_), .d(new_n104_), .O(new_n111_));
  inv1   g049(.a(x14), .O(new_n112_));
  oai21  g050(.a(x25), .b(x00), .c(x38), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n111_), .c(new_n103_), .O(z07));
  inv1   g054(.a(x39), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(x38), .c(new_n74_), .O(z08));
  ...
  aoi21  g086(.a(x39), .b(new_n122_), .c(new_n71_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n129_), .b(x38), .c(new_n152_), .d(new_n122_), .O(new_n164_));
  ...
  nand4  g106(.a(x40), .b(x39), .c(new_n152_), .d(new_n122_), .O(new_n169_));
  ...
  aoi21  g141(.a(x28), .b(new_n68_), .c(new_n146_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(new_n141_), .O(new_n205_));
  aoi21  g143(.a(new_n193_), .b(new_n136_), .c(x08), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n205_), .c(new_n79_), .O(new_n207_));
