...
module FAU ( 
  ...
  nand2  g011(.a(x32), .b(x10), .O(new_n74_));
  ...
  nand4  g020(.a(new_n82_), .b(new_n63_), .c(new_n79_), .d(new_n78_), .O(new_n83_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n87_), .d(new_n64_), .O(z02));
  ...
  aoi21  g059(.a(x35), .b(new_n88_), .c(x36), .O(new_n122_));
  nand3  g060(.a(new_n92_), .b(new_n64_), .c(x07), .O(new_n123_));
  nand3  g061(.a(new_n93_), .b(new_n78_), .c(x05), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n125_));
  inv1   g063(.a(x06), .O(new_n126_));
  nand2  g064(.a(new_n64_), .b(x37), .O(new_n127_));
  nor2   g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  aoi21  g066(.a(new_n125_), .b(new_n121_), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(x30), .b(new_n78_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n63_), .c(new_n117_), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(x39), .c(x05), .d(new_n121_), .O(new_n132_));
  oai21  g070(.a(new_n129_), .b(new_n68_), .c(new_n132_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand2  g072(.a(new_n93_), .b(x29), .O(new_n135_));
  nor2   g073(.a(new_n68_), .b(new_n121_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n89_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n81_), .b(x27), .c(new_n121_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n64_), .c(new_n79_), .d(new_n134_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n68_), .c(new_n78_), .O(new_n145_));
  ...
  nor3   g097(.a(new_n159_), .b(new_n116_), .c(x13), .O(new_n160_));
  ...
  nand4  g101(.a(x40), .b(x39), .c(new_n149_), .d(new_n121_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(x36), .b(x35), .c(x32), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n79_), .c(x28), .d(new_n78_), .O(new_n167_));
  oai21  g105(.a(new_n165_), .b(new_n65_), .c(new_n167_), .O(new_n168_));
  ...
  nand3  g109(.a(new_n171_), .b(new_n63_), .c(new_n79_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  nor2   g111(.a(new_n165_), .b(new_n71_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(new_n78_), .O(new_n175_));
  nand2  g113(.a(new_n174_), .b(x32), .O(new_n176_));
  ...
  oai21  g124(.a(new_n89_), .b(x27), .c(new_n135_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n65_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n139_), .d(new_n134_), .O(z18));
  inv1   g128(.a(new_n135_), .O(new_n191_));
  oai21  g129(.a(new_n80_), .b(new_n68_), .c(new_n138_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n68_), .c(new_n80_), .O(new_n193_));
