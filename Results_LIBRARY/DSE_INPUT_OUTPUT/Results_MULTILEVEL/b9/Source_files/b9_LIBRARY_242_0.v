...
module FAU ( 
  ...
  nand3  g053(.a(new_n115_), .b(new_n65_), .c(x03), .O(new_n116_));
  ...
  nand2  g068(.a(new_n130_), .b(new_n75_), .O(new_n131_));
  ...
  nor2   g074(.a(new_n136_), .b(x28), .O(new_n137_));
  ...
  nand3  g079(.a(new_n137_), .b(x27), .c(new_n75_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n81_), .c(new_n134_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n65_), .O(z11));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n98_), .c(new_n76_), .O(new_n148_));
  oai21  g086(.a(new_n118_), .b(x04), .c(new_n72_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n65_), .O(z12));
  ...
  nor2   g096(.a(new_n157_), .b(new_n63_), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n128_), .b(new_n151_), .c(new_n75_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  inv1   g100(.a(new_n95_), .O(new_n163_));
  ...
  nand3  g107(.a(new_n69_), .b(new_n136_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n82_), .c(new_n81_), .O(new_n172_));
  oai21  g110(.a(new_n167_), .b(new_n73_), .c(new_n172_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x40), .O(new_n174_));
  nand3  g112(.a(new_n72_), .b(new_n64_), .c(x11), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n169_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nand4  g115(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n178_));
  ...
  oai21  g124(.a(new_n85_), .b(x27), .c(new_n135_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n66_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n142_), .d(new_n134_), .O(z18));
  nor2   g128(.a(x40), .b(x35), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n91_), .c(x11), .O(new_n192_));
  nand2  g130(.a(new_n138_), .b(new_n84_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n135_), .O(new_n194_));
  nand2  g132(.a(x35), .b(x27), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(x04), .c(new_n141_), .O(new_n196_));
  nand2  g134(.a(x39), .b(x29), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n136_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n196_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(x40), .O(new_n200_));
  nand2  g138(.a(x28), .b(new_n141_), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n200_), .c(new_n194_), .d(new_n192_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n81_), .c(new_n134_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n65_), .O(z19));
  nand2  g142(.a(x28), .b(new_n98_), .O(new_n205_));
  nand2  g143(.a(new_n197_), .b(x40), .O(new_n206_));
  aoi22  g144(.a(new_n206_), .b(new_n95_), .c(new_n205_), .d(x35), .O(new_n207_));
  nand2  g145(.a(new_n65_), .b(new_n98_), .O(new_n208_));
  nand2  g146(.a(x40), .b(new_n136_), .O(new_n209_));
  aoi21  g147(.a(new_n209_), .b(new_n208_), .c(x08), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n207_), .c(new_n81_), .O(new_n211_));
