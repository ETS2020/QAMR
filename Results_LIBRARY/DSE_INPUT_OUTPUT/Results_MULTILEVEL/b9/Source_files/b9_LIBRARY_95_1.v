...
module FAU ( 
  ...
  aoi21  g038(.a(new_n67_), .b(new_n66_), .c(new_n100_), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n80_), .O(z03));
  nand2  g040(.a(new_n67_), .b(new_n66_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n99_), .c(new_n64_), .d(new_n100_), .O(z04));
  oai21  g042(.a(new_n84_), .b(new_n66_), .c(new_n67_), .O(new_n105_));
  and2   g043(.a(new_n105_), .b(new_n64_), .O(z05));
  ...
  oai22  g061(.a(new_n96_), .b(new_n122_), .c(x40), .d(new_n123_), .O(new_n124_));
  ...
  inv1   g069(.a(new_n85_), .O(new_n132_));
  aoi21  g070(.a(x39), .b(new_n92_), .c(new_n75_), .O(new_n133_));
  ...
  oai21  g077(.a(new_n139_), .b(new_n135_), .c(new_n81_), .O(new_n140_));
  nor2   g078(.a(new_n140_), .b(x09), .O(z11));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n67_), .b(new_n83_), .c(new_n142_), .O(new_n143_));
  ...
  nand2  g094(.a(new_n82_), .b(new_n81_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n148_), .c(new_n73_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x39), .c(new_n75_), .O(new_n159_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n84_), .c(x27), .O(new_n168_));
  ...
  oai21  g117(.a(new_n85_), .b(x27), .c(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n66_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n132_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n64_), .d(new_n81_), .O(z18));
  inv1   g122(.a(x09), .O(new_n185_));
  nand2  g123(.a(new_n134_), .b(new_n84_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n179_), .O(new_n187_));
  aoi21  g125(.a(x40), .b(new_n63_), .c(x27), .O(new_n188_));
  nand2  g126(.a(x39), .b(new_n142_), .O(new_n189_));
  nand2  g127(.a(x40), .b(x04), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n189_), .c(new_n84_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n91_), .O(new_n192_));
  ...
  nand3  g133(.a(new_n195_), .b(new_n81_), .c(new_n185_), .O(new_n196_));
  ...
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n81_), .O(new_n201_));
