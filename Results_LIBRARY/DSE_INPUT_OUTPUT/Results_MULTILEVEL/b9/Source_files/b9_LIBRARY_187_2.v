...
module FAU ( 
  ...
  oai21  g037(.a(new_n99_), .b(new_n66_), .c(new_n67_), .O(new_n100_));
  ...
  oai22  g057(.a(new_n114_), .b(new_n118_), .c(x39), .d(new_n119_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n83_), .c(new_n73_), .O(new_n121_));
  ...
  nand3  g065(.a(new_n127_), .b(x05), .c(new_n73_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n124_), .O(z10));
  inv1   g067(.a(x29), .O(new_n130_));
  aoi21  g068(.a(x40), .b(new_n130_), .c(new_n125_), .O(new_n131_));
  ...
  nand3  g072(.a(x35), .b(new_n99_), .c(new_n73_), .O(new_n135_));
  ...
  nand3  g077(.a(new_n67_), .b(new_n82_), .c(new_n81_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n151_), .b(new_n125_), .c(x20), .d(new_n150_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n127_), .b(new_n145_), .c(new_n73_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  aoi21  g096(.a(new_n145_), .b(new_n73_), .c(new_n63_), .O(new_n159_));
  nor2   g097(.a(x19), .b(x18), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n151_), .c(x27), .d(x20), .O(new_n161_));
  oai21  g099(.a(new_n159_), .b(new_n125_), .c(new_n161_), .O(new_n162_));
  ...
  oai21  g103(.a(new_n165_), .b(new_n99_), .c(x27), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(x40), .c(new_n80_), .d(new_n79_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n162_), .O(z14));
  inv1   g106(.a(x12), .O(new_n169_));
  nand4  g107(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n170_));
  ...
  nand2  g115(.a(x27), .b(new_n73_), .O(new_n178_));
  nand2  g116(.a(new_n66_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n81_), .O(new_n180_));
  inv1   g118(.a(x09), .O(new_n181_));
  nand2  g119(.a(new_n79_), .b(new_n181_), .O(new_n182_));
  aoi21  g120(.a(new_n180_), .b(new_n99_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n94_), .c(new_n114_), .d(new_n88_), .O(z18));
  nand2  g122(.a(x39), .b(x04), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(x35), .c(new_n99_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x40), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n134_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n133_), .c(new_n79_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z19));
  nor2   g128(.a(new_n81_), .b(new_n66_), .O(new_n191_));
  nor2   g129(.a(new_n125_), .b(new_n130_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n66_), .c(new_n81_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n192_), .c(new_n191_), .d(x08), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n79_), .c(new_n181_), .O(new_n195_));
