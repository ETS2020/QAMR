...
module FAU ( 
  ...
  nor3   g057(.a(new_n83_), .b(new_n119_), .c(new_n118_), .O(z08));
  ...
  nand3  g062(.a(new_n76_), .b(new_n84_), .c(x05), .O(new_n125_));
  ...
  nand2  g068(.a(x30), .b(x26), .O(new_n131_));
  nand2  g069(.a(x32), .b(new_n84_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n119_), .O(new_n133_));
  ...
  nor3   g099(.a(new_n161_), .b(new_n118_), .c(x13), .O(new_n162_));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n76_), .c(new_n83_), .O(new_n167_));
  ...
  aoi22  g110(.a(new_n166_), .b(new_n76_), .c(new_n72_), .d(x27), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(new_n84_), .O(new_n174_));
  nand2  g112(.a(new_n173_), .b(x26), .O(new_n175_));
  ...
  aoi21  g123(.a(new_n185_), .b(new_n137_), .c(new_n141_), .O(new_n186_));
  nand2  g124(.a(new_n142_), .b(new_n136_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n84_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n131_), .O(z18));
  nand2  g127(.a(new_n145_), .b(new_n81_), .O(z19));
  ...
  nand3  g132(.a(new_n194_), .b(new_n84_), .c(new_n136_), .O(new_n195_));
