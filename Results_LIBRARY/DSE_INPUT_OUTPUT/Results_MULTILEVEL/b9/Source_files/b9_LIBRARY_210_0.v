...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x39), .O(new_n93_));
  nand2  g031(.a(x40), .b(new_n63_), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n93_), .O(z02));
  nand2  g033(.a(new_n71_), .b(x27), .O(new_n96_));
  aoi21  g034(.a(new_n70_), .b(new_n69_), .c(new_n66_), .O(new_n97_));
  ...
  nand2  g056(.a(new_n115_), .b(x07), .O(new_n119_));
  ...
  nand2  g060(.a(new_n81_), .b(new_n80_), .O(new_n123_));
  nand4  g061(.a(new_n123_), .b(x40), .c(x39), .d(x05), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n74_), .O(new_n126_));
  nand3  g064(.a(x37), .b(x27), .c(x06), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n65_), .O(z10));
  nand2  g066(.a(new_n65_), .b(new_n69_), .O(new_n129_));
  nand3  g067(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n130_));
  ...
  aoi22  g075(.a(new_n137_), .b(new_n134_), .c(new_n136_), .d(new_n94_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n132_), .c(new_n80_), .O(new_n139_));
  nor2   g077(.a(new_n139_), .b(x09), .O(z11));
  nand3  g078(.a(new_n70_), .b(new_n82_), .c(new_n133_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  aoi21  g080(.a(x40), .b(new_n74_), .c(new_n72_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(x39), .O(new_n144_));
  nand2  g082(.a(new_n71_), .b(new_n70_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(x40), .c(new_n63_), .O(new_n147_));
  ...
  nand4  g092(.a(new_n145_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  nand3  g095(.a(new_n123_), .b(x40), .c(x39), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x13), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n74_), .c(new_n66_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  inv1   g099(.a(new_n94_), .O(new_n162_));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  nand4  g101(.a(new_n150_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n164_));
  nand3  g102(.a(x40), .b(new_n149_), .c(new_n74_), .O(new_n165_));
  ...
  nand3  g106(.a(new_n70_), .b(new_n133_), .c(x28), .O(new_n169_));
  ...
  nand3  g112(.a(new_n174_), .b(new_n168_), .c(new_n147_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nand4  g114(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n177_));
  ...
  nand3  g127(.a(new_n134_), .b(x27), .c(new_n74_), .O(new_n190_));
  nor2   g128(.a(new_n66_), .b(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n186_), .O(z18));
  nand2  g130(.a(new_n137_), .b(new_n134_), .O(new_n193_));
  nand2  g131(.a(new_n187_), .b(new_n193_), .O(new_n194_));
  inv1   g132(.a(x08), .O(new_n195_));
  nand2  g133(.a(new_n190_), .b(new_n195_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n194_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n186_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n65_), .O(z19));
  inv1   g137(.a(new_n187_), .O(new_n200_));
  oai21  g138(.a(new_n133_), .b(new_n69_), .c(new_n195_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n69_), .c(new_n133_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n201_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n80_), .c(new_n186_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n65_), .O(z20));
endmodule
