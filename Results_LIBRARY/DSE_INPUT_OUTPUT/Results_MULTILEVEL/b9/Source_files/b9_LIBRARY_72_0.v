...
module FAU ( 
  ...
  nor2   g017(.a(x30), .b(x12), .O(new_n80_));
  ...
  nand4  g026(.a(new_n88_), .b(new_n84_), .c(new_n83_), .d(x12), .O(new_n89_));
  ...
  aoi21  g034(.a(new_n96_), .b(new_n93_), .c(new_n80_), .O(z02));
  ...
  nand3  g076(.a(x40), .b(x39), .c(x04), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(x35), .c(new_n85_), .d(x27), .O(new_n140_));
  ...
  aoi21  g081(.a(new_n143_), .b(x12), .c(x30), .O(z11));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n80_), .O(z12));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n154_), .c(new_n150_), .O(new_n158_));
  ...
  nand2  g099(.a(x32), .b(x12), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n83_), .c(new_n119_), .O(new_n163_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n150_), .c(new_n83_), .O(new_n173_));
  ...
  nand2  g122(.a(new_n94_), .b(new_n64_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n135_), .c(new_n138_), .O(new_n186_));
  nand3  g124(.a(new_n94_), .b(x27), .c(new_n65_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n134_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(x12), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n83_), .O(z18));
  nand2  g128(.a(new_n187_), .b(new_n138_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n137_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n134_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(x12), .c(x30), .O(z19));
  inv1   g132(.a(new_n135_), .O(new_n195_));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n196_));
  ...
  aoi21  g137(.a(new_n199_), .b(x12), .c(x30), .O(z20));
endmodule
