...
module FAU ( 
  ...
  nand2  g49(.a(new_n79_), .b(new_n111_), .O(new_n112_));
  ...
  nor2   g53(.a(z08), .b(new_n79_), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(new_n68_), .O(z12));
  nand4  g55(.a(new_n68_), .b(z02), .c(x27), .d(x20), .O(new_n118_));
  nor3   g56(.a(new_n118_), .b(x19), .c(x18), .O(z13));
  nor2   g57(.a(x19), .b(x18), .O(new_n120_));
  nand4  g58(.a(new_n120_), .b(new_n116_), .c(new_n68_), .d(x20), .O(z14));
  inv1   g59(.a(x12), .O(new_n122_));
  nand4  g60(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  nor2   g61(.a(new_n123_), .b(new_n122_), .O(z15));
  ...
  nand2  g69(.a(x27), .b(new_n102_), .O(new_n132_));
  oai21  g70(.a(x27), .b(new_n111_), .c(new_n132_), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(x35), .c(new_n109_), .O(new_n134_));
  nor2   g72(.a(x30), .b(x09), .O(new_n135_));
  aoi21  g73(.a(new_n135_), .b(new_n134_), .c(z08), .O(z18));
  nand3  g74(.a(new_n113_), .b(new_n71_), .c(new_n108_), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(z02), .O(z19));
  oai21  g76(.a(x28), .b(new_n111_), .c(new_n79_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x35), .O(new_n140_));
  nand3  g78(.a(new_n140_), .b(new_n71_), .c(new_n108_), .O(new_n141_));
