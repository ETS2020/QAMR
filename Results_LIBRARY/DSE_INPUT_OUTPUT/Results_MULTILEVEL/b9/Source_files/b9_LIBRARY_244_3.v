...
module FAU ( 
  ...
  nand2  g14(.a(new_n65_), .b(x27), .O(new_n77_));
  inv1   g15(.a(x27), .O(new_n78_));
  inv1   g16(.a(z02), .O(z08));
  aoi21  g17(.a(new_n64_), .b(new_n78_), .c(z08), .O(new_n80_));
  nand3  g18(.a(new_n80_), .b(new_n77_), .c(x21), .O(z03));
  inv1   g19(.a(x21), .O(new_n82_));
  nand3  g20(.a(new_n80_), .b(new_n77_), .c(new_n82_), .O(z04));
  inv1   g21(.a(x28), .O(new_n84_));
  oai21  g22(.a(new_n84_), .b(new_n78_), .c(new_n64_), .O(new_n85_));
  ...
  nand3  g42(.a(new_n73_), .b(x07), .c(new_n104_), .O(new_n105_));
  ...
  nand2  g50(.a(new_n78_), .b(new_n112_), .O(new_n113_));
  nand4  g51(.a(new_n113_), .b(new_n111_), .c(x35), .d(new_n84_), .O(new_n114_));
  nand3  g52(.a(new_n114_), .b(new_n70_), .c(new_n110_), .O(new_n115_));
  nand2  g53(.a(new_n115_), .b(z02), .O(z11));
  nand3  g54(.a(z02), .b(new_n66_), .c(x27), .O(z12));
  ...
  nand4  g73(.a(new_n135_), .b(z02), .c(new_n70_), .d(new_n110_), .O(z18));
  nand4  g74(.a(new_n114_), .b(z02), .c(new_n70_), .d(new_n110_), .O(new_n137_));
  inv1   g75(.a(new_n137_), .O(z19));
  oai21  g76(.a(x28), .b(new_n112_), .c(new_n78_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x35), .O(new_n140_));
  nand4  g78(.a(new_n140_), .b(z02), .c(new_n70_), .d(new_n110_), .O(new_n141_));
