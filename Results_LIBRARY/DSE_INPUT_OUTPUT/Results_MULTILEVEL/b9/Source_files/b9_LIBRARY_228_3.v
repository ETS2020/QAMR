...
module FAU ( 
  ...
  aoi21  g07(.a(new_n69_), .b(x16), .c(new_n64_), .O(z00));
  ...
  aoi21  g17(.a(new_n66_), .b(new_n80_), .c(new_n64_), .O(new_n81_));
  ...
  nand2  g23(.a(new_n85_), .b(new_n66_), .O(new_n87_));
  nand2  g24(.a(new_n87_), .b(new_n63_), .O(z06));
  ...
  inv1   g38(.a(x11), .O(new_n103_));
  nand4  g39(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n104_));
  nor2   g40(.a(new_n104_), .b(new_n103_), .O(z09));
  inv1   g41(.a(x04), .O(new_n106_));
  nand3  g42(.a(new_n74_), .b(x07), .c(new_n106_), .O(new_n107_));
  nand2  g43(.a(x37), .b(x06), .O(new_n108_));
  nand2  g44(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g45(.a(new_n109_), .b(x27), .O(new_n110_));
  nand2  g46(.a(new_n110_), .b(new_n63_), .O(z10));
  inv1   g47(.a(x09), .O(new_n112_));
  inv1   g48(.a(x28), .O(new_n113_));
  nand2  g49(.a(x27), .b(x04), .O(new_n114_));
  nor2   g50(.a(x27), .b(x08), .O(new_n115_));
  inv1   g51(.a(new_n115_), .O(new_n116_));
  nand4  g52(.a(new_n116_), .b(new_n114_), .c(x35), .d(new_n113_), .O(new_n117_));
  nand4  g53(.a(new_n117_), .b(new_n63_), .c(new_n71_), .d(new_n112_), .O(new_n118_));
  inv1   g54(.a(new_n118_), .O(z11));
  aoi21  g55(.a(new_n68_), .b(x27), .c(new_n64_), .O(z12));
  nand4  g56(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n121_));
  nor3   g57(.a(new_n121_), .b(x19), .c(x18), .O(z13));
  nor2   g58(.a(x19), .b(x18), .O(new_n123_));
  nand3  g59(.a(new_n123_), .b(x27), .c(x20), .O(new_n124_));
  inv1   g60(.a(new_n124_), .O(new_n125_));
  aoi21  g61(.a(new_n125_), .b(new_n68_), .c(new_n64_), .O(z14));
  nand4  g62(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  nand2  g63(.a(new_n127_), .b(new_n63_), .O(z15));
  inv1   g64(.a(x23), .O(new_n129_));
  nand4  g65(.a(new_n63_), .b(new_n129_), .c(x22), .d(x01), .O(new_n130_));
  inv1   g66(.a(new_n130_), .O(z16));
  inv1   g67(.a(x24), .O(new_n132_));
  nand4  g68(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  nand2  g69(.a(new_n133_), .b(new_n63_), .O(z17));
  inv1   g70(.a(x08), .O(new_n135_));
  nand2  g71(.a(x27), .b(new_n106_), .O(new_n136_));
  oai21  g72(.a(x27), .b(new_n135_), .c(new_n136_), .O(new_n137_));
  nand3  g73(.a(new_n137_), .b(x35), .c(new_n113_), .O(new_n138_));
  nand4  g74(.a(new_n138_), .b(new_n63_), .c(new_n71_), .d(new_n112_), .O(z18));
  oai21  g75(.a(new_n115_), .b(new_n72_), .c(new_n63_), .O(new_n140_));
  nand3  g76(.a(new_n140_), .b(new_n114_), .c(new_n113_), .O(new_n141_));
  nand3  g77(.a(new_n141_), .b(new_n71_), .c(new_n112_), .O(new_n142_));
  nand2  g78(.a(new_n142_), .b(new_n63_), .O(z19));
  oai21  g79(.a(x28), .b(new_n135_), .c(new_n80_), .O(new_n144_));
  nand2  g80(.a(new_n144_), .b(x35), .O(new_n145_));
  nand4  g81(.a(new_n145_), .b(new_n63_), .c(new_n71_), .d(new_n112_), .O(new_n146_));
  inv1   g82(.a(new_n146_), .O(z20));
  one    g83(.O(z02));
  zero   g84(.O(z08));
endmodule
