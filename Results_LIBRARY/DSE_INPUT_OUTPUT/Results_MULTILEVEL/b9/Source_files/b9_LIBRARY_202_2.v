...
module FAU ( 
  ...
  nor2   g042(.a(new_n104_), .b(new_n64_), .O(new_n105_));
  ...
  nor2   g063(.a(x40), .b(x09), .O(new_n126_));
  ...
  oai21  g079(.a(new_n64_), .b(new_n65_), .c(new_n85_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g081(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(x08), .c(new_n143_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n83_), .c(new_n140_), .O(new_n147_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n152_), .c(new_n99_), .O(new_n175_));
  ...
  nand3  g123(.a(new_n85_), .b(new_n64_), .c(new_n140_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n141_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  oai21  g126(.a(new_n145_), .b(x30), .c(new_n140_), .O(new_n189_));
  nand2  g127(.a(x40), .b(x09), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n189_), .c(new_n188_), .O(z18));
  nor2   g129(.a(new_n75_), .b(new_n93_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(x09), .c(x40), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n142_), .O(new_n194_));
  nand3  g132(.a(new_n144_), .b(new_n140_), .c(new_n92_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n83_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n81_), .O(z19));
  oai21  g136(.a(new_n104_), .b(x27), .c(x35), .O(new_n199_));
  oai21  g137(.a(new_n66_), .b(new_n64_), .c(new_n92_), .O(new_n200_));
  oai21  g138(.a(new_n75_), .b(new_n93_), .c(new_n199_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n200_), .O(new_n202_));
  aoi22  g140(.a(new_n202_), .b(new_n140_), .c(new_n199_), .d(new_n76_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(x30), .c(new_n81_), .O(z20));
endmodule
