...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n73_), .c(x40), .O(z02));
  ...
  aoi21  g066(.a(x39), .b(new_n128_), .c(new_n70_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n144_), .b(x40), .c(new_n142_), .d(new_n117_), .O(new_n145_));
  ...
  aoi21  g088(.a(new_n150_), .b(x39), .c(new_n70_), .O(new_n151_));
  ...
  nand4  g097(.a(new_n159_), .b(x39), .c(new_n79_), .d(new_n78_), .O(new_n160_));
  ...
  nand2  g108(.a(x40), .b(x29), .O(new_n171_));
  ...
  nand2  g120(.a(x39), .b(new_n182_), .O(new_n183_));
