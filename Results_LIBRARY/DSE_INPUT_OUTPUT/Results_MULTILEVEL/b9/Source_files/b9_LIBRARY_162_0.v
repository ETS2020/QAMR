...
module FAU ( 
  ...
  nand3  g075(.a(new_n133_), .b(x27), .c(new_n72_), .O(new_n138_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n96_), .c(new_n74_), .O(new_n144_));
  oai21  g082(.a(new_n116_), .b(x04), .c(new_n69_), .O(new_n145_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n72_), .c(new_n97_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  inv1   g097(.a(new_n93_), .O(new_n160_));
  ...
  nand3  g104(.a(new_n66_), .b(new_n132_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n80_), .c(new_n79_), .O(new_n169_));
  nand2  g107(.a(new_n163_), .b(new_n69_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x39), .O(new_n172_));
  nand3  g110(.a(new_n69_), .b(x40), .c(new_n63_), .O(new_n173_));
  ...
  oai21  g121(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n97_), .b(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n138_), .d(new_n130_), .O(z18));
  nand2  g125(.a(new_n65_), .b(new_n96_), .O(new_n188_));
  nand3  g126(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x39), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n188_), .c(x08), .O(new_n191_));
  nand2  g129(.a(x40), .b(x29), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x39), .O(new_n193_));
  aoi22  g131(.a(new_n193_), .b(new_n93_), .c(new_n134_), .d(new_n133_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n191_), .c(new_n79_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(x09), .O(z19));
  inv1   g134(.a(new_n131_), .O(new_n197_));
  oai21  g135(.a(new_n132_), .b(new_n96_), .c(new_n137_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n96_), .c(new_n132_), .O(new_n199_));
