...
module FAU ( 
  ...
  nand4  g037(.a(new_n99_), .b(new_n94_), .c(new_n84_), .d(new_n95_), .O(z04));
  ...
  nand4  g054(.a(new_n84_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(z09));
  inv1   g056(.a(x04), .O(new_n119_));
  inv1   g057(.a(new_n91_), .O(new_n120_));
  nand4  g058(.a(new_n120_), .b(new_n80_), .c(x27), .d(x07), .O(new_n121_));
  aoi21  g059(.a(new_n91_), .b(x05), .c(new_n76_), .O(new_n122_));
  ...
  oai21  g066(.a(new_n79_), .b(x27), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x08), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n76_), .c(new_n127_), .d(x04), .O(new_n131_));
  inv1   g069(.a(new_n131_), .O(z11));
  nor3   g070(.a(x37), .b(x36), .c(x35), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n66_), .c(new_n70_), .O(new_n134_));
  oai22  g072(.a(new_n120_), .b(x04), .c(new_n67_), .d(new_n66_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n84_), .O(z12));
  inv1   g074(.a(x13), .O(new_n137_));
  aoi21  g075(.a(new_n91_), .b(new_n137_), .c(new_n76_), .O(new_n138_));
  inv1   g076(.a(x18), .O(new_n139_));
  inv1   g077(.a(x19), .O(new_n140_));
  nand4  g078(.a(new_n68_), .b(x20), .c(new_n140_), .d(new_n139_), .O(new_n141_));
  oai21  g079(.a(new_n138_), .b(x04), .c(new_n141_), .O(z13));
  nand3  g080(.a(new_n91_), .b(new_n137_), .c(new_n119_), .O(new_n143_));
  nand4  g081(.a(x27), .b(x20), .c(new_n140_), .d(new_n139_), .O(new_n144_));
  ...
  nand4  g090(.a(new_n152_), .b(x23), .c(x22), .d(x01), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n84_), .O(z17));
  nand4  g092(.a(new_n130_), .b(new_n76_), .c(new_n127_), .d(x04), .O(z18));
  inv1   g093(.a(new_n128_), .O(new_n156_));
  ...
  nand2  g097(.a(new_n159_), .b(new_n127_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x04), .c(x30), .O(z19));
  nor2   g099(.a(new_n93_), .b(new_n66_), .O(new_n162_));
  nand2  g100(.a(new_n157_), .b(new_n128_), .O(new_n163_));
  oai21  g101(.a(new_n162_), .b(x08), .c(new_n163_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n76_), .c(new_n127_), .d(x04), .O(new_n165_));
