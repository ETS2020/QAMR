...
module FAU ( 
  ...
  oai21  g085(.a(new_n120_), .b(x04), .c(new_n69_), .O(new_n148_));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n138_), .O(new_n190_));
  ...
  oai22  g131(.a(new_n193_), .b(new_n97_), .c(new_n120_), .d(new_n89_), .O(z18));
  inv1   g132(.a(x08), .O(new_n195_));
  oai21  g133(.a(new_n138_), .b(new_n100_), .c(new_n195_), .O(new_n196_));
  ...
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n191_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n65_), .O(z20));
  nor2   g140(.a(new_n144_), .b(x09), .O(z19));
endmodule
