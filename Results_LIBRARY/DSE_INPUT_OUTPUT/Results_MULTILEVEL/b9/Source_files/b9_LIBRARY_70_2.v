...
module FAU ( 
  ...
  nand2  g017(.a(new_n79_), .b(x18), .O(new_n80_));
  ...
  oai21  g023(.a(new_n85_), .b(x18), .c(new_n79_), .O(new_n86_));
  ...
  nand2  g054(.a(new_n80_), .b(new_n92_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n80_), .O(z09));
  nand3  g057(.a(new_n80_), .b(new_n92_), .c(x07), .O(new_n120_));
  inv1   g058(.a(x18), .O(new_n121_));
  nand3  g059(.a(new_n75_), .b(new_n121_), .c(x05), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n120_), .c(new_n83_), .O(new_n123_));
  inv1   g061(.a(x06), .O(new_n124_));
  nand2  g062(.a(new_n80_), .b(x37), .O(new_n125_));
  ...
  oai22  g084(.a(new_n92_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n80_), .O(z12));
  nor2   g086(.a(x13), .b(x04), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n75_), .c(new_n79_), .O(new_n150_));
  or2    g088(.a(new_n150_), .b(new_n121_), .O(new_n151_));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n128_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n72_), .b(x20), .c(new_n156_), .d(new_n121_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  inv1   g097(.a(x32), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n79_), .c(new_n128_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n159_), .c(new_n151_), .O(z13));
  nand2  g101(.a(x20), .b(new_n156_), .O(new_n164_));
  nand4  g102(.a(new_n153_), .b(new_n160_), .c(new_n79_), .d(x28), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n149_), .c(new_n75_), .O(new_n166_));
  ...
  nand3  g107(.a(new_n169_), .b(new_n160_), .c(new_n79_), .O(new_n170_));
  nand2  g108(.a(new_n149_), .b(new_n75_), .O(new_n171_));
  oai21  g109(.a(new_n73_), .b(new_n64_), .c(new_n171_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n170_), .c(new_n167_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n121_), .O(new_n174_));
  nand2  g112(.a(new_n150_), .b(x18), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nand4  g115(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n177_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand4  g118(.a(new_n80_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  ...
  nand2  g123(.a(new_n93_), .b(new_n64_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n135_), .c(new_n138_), .O(new_n187_));
  nand2  g125(.a(new_n139_), .b(new_n133_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n187_), .c(new_n121_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n79_), .O(z18));
  ...
  nand2  g132(.a(new_n194_), .b(new_n133_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n121_), .c(x30), .O(z20));
