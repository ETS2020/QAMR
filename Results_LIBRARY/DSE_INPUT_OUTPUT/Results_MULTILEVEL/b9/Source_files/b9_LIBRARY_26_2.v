...
module FAU ( 
  ...
  nor2   g015(.a(x26), .b(new_n77_), .O(new_n78_));
  ...
  aoi21  g031(.a(new_n93_), .b(x04), .c(new_n72_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n78_), .O(z02));
  ...
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(new_n78_), .O(z10));
  ...
  nand3  g076(.a(new_n92_), .b(x27), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n79_), .c(new_n81_), .d(new_n134_), .O(new_n142_));
  ...
  aoi21  g085(.a(new_n147_), .b(new_n146_), .c(new_n78_), .O(z12));
  ...
  nor3   g095(.a(new_n129_), .b(x13), .c(x04), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n77_), .O(new_n159_));
  aoi21  g097(.a(new_n150_), .b(x28), .c(new_n64_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n128_), .c(x40), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(new_n117_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x26), .c(new_n149_), .d(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n159_), .O(z13));
  aoi21  g102(.a(x20), .b(new_n153_), .c(x19), .O(new_n165_));
  and2   g103(.a(x26), .b(x19), .O(new_n166_));
  nand4  g104(.a(new_n150_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n73_), .b(new_n149_), .c(new_n65_), .O(new_n169_));
  oai22  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .d(new_n165_), .O(new_n170_));
  nand3  g108(.a(new_n97_), .b(new_n66_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n82_), .c(new_n81_), .O(new_n173_));
  oai21  g111(.a(new_n70_), .b(new_n64_), .c(new_n169_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n77_), .O(new_n176_));
  nand4  g114(.a(new_n82_), .b(new_n81_), .c(new_n64_), .d(x26), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n170_), .O(z14));
  nand4  g116(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n79_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x22), .c(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n79_), .O(z16));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(x23), .c(x22), .d(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n79_), .O(z17));
  oai21  g124(.a(new_n84_), .b(x27), .c(new_n135_), .O(new_n187_));
  nand3  g125(.a(new_n139_), .b(new_n81_), .c(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(x08), .c(new_n188_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n78_), .O(z18));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n191_));
  nand2  g129(.a(new_n135_), .b(new_n66_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n78_), .O(new_n193_));
  oai21  g131(.a(x28), .b(x04), .c(new_n138_), .O(new_n194_));
  oai21  g132(.a(new_n136_), .b(x28), .c(new_n135_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n81_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(x09), .c(new_n79_), .O(z19));
  inv1   g136(.a(new_n135_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n191_), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n79_), .c(new_n81_), .d(new_n134_), .O(new_n202_));
