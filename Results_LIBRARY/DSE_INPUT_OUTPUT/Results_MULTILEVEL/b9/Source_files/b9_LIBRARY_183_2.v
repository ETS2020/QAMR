...
module FAU ( 
  ...
  nor2   g018(.a(x17), .b(new_n63_), .O(new_n81_));
  ...
  xnor2a g047(.a(x17), .b(x15), .O(new_n110_));
  ...
  nand3  g054(.a(new_n116_), .b(new_n84_), .c(new_n114_), .O(new_n117_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n85_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n84_), .O(z11));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n81_), .O(z12));
  ...
  aoi22  g108(.a(new_n170_), .b(new_n85_), .c(new_n167_), .d(new_n148_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n168_), .c(new_n81_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nor2   g111(.a(new_n123_), .b(new_n173_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand4  g113(.a(new_n84_), .b(new_n175_), .c(x22), .d(x01), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z16));
  inv1   g115(.a(x24), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(x23), .c(x22), .d(x01), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n84_), .O(z17));
  oai21  g118(.a(new_n88_), .b(x27), .c(new_n136_), .O(new_n181_));
  nand3  g119(.a(new_n140_), .b(new_n85_), .c(new_n135_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(x08), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n81_), .O(z18));
  nand4  g122(.a(new_n142_), .b(new_n84_), .c(new_n85_), .d(new_n135_), .O(new_n185_));
  ...
  nand4  g128(.a(new_n190_), .b(new_n84_), .c(new_n85_), .d(new_n135_), .O(new_n191_));
