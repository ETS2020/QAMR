...
module FAU ( 
  ...
  nand2  g018(.a(x40), .b(x11), .O(new_n81_));
  ...
  aoi21  g060(.a(x35), .b(new_n92_), .c(x36), .O(new_n123_));
  oai21  g061(.a(x39), .b(x11), .c(x40), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x07), .O(new_n125_));
  nand4  g063(.a(x40), .b(x39), .c(new_n90_), .d(x05), .O(new_n126_));
  ...
  nand4  g071(.a(new_n133_), .b(new_n90_), .c(x05), .d(new_n65_), .O(new_n134_));
  ...
  oai21  g077(.a(new_n139_), .b(new_n137_), .c(new_n90_), .O(new_n140_));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n152_), .c(new_n83_), .O(new_n154_));
  ...
  aoi21  g114(.a(new_n172_), .b(new_n152_), .c(new_n83_), .O(new_n177_));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n92_), .c(new_n139_), .O(new_n192_));
  nand2  g130(.a(new_n90_), .b(x08), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n142_), .c(new_n192_), .d(new_n83_), .O(z18));
  nand2  g132(.a(x35), .b(x27), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n90_), .O(new_n196_));
  nand2  g134(.a(x40), .b(x04), .O(new_n197_));
  nand2  g135(.a(new_n76_), .b(new_n64_), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n197_), .c(new_n196_), .d(new_n92_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n136_), .O(new_n200_));
  nand2  g138(.a(x39), .b(x29), .O(new_n201_));
  nand2  g139(.a(new_n66_), .b(new_n90_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n143_), .c(new_n92_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n201_), .O(new_n204_));
  nand2  g142(.a(new_n144_), .b(new_n76_), .O(new_n205_));
  ...
  aoi21  g147(.a(new_n201_), .b(new_n90_), .c(new_n76_), .O(new_n210_));
  nand2  g148(.a(new_n198_), .b(new_n196_), .O(new_n211_));
  nand2  g149(.a(new_n211_), .b(new_n136_), .O(new_n212_));
  oai21  g150(.a(new_n210_), .b(new_n209_), .c(new_n212_), .O(new_n213_));
  nand3  g151(.a(new_n213_), .b(new_n84_), .c(new_n138_), .O(new_n214_));
