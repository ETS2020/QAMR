// Benchmark "FAU" written by ABC on Thu Aug 13 18:18:16 2020
...
module FAU ( 
  ...
  nor2   g018(.a(new_n76_), .b(x09), .O(new_n81_));
  ...
  inv1   g032(.a(new_n87_), .O(new_n95_));
  ...
  nand4  g037(.a(new_n99_), .b(new_n94_), .c(new_n77_), .d(x09), .O(z02));
  nand2  g038(.a(new_n71_), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n70_), .b(new_n64_), .c(new_n81_), .O(new_n102_));
  ...
  nor2   g043(.a(new_n86_), .b(new_n64_), .O(new_n106_));
  inv1   g044(.a(new_n106_), .O(new_n107_));
  nand3  g045(.a(new_n107_), .b(new_n82_), .c(new_n70_), .O(z05));
  oai21  g046(.a(new_n106_), .b(x37), .c(new_n82_), .O(z06));
  ...
  aoi21  g058(.a(new_n75_), .b(x09), .c(new_n76_), .O(z08));
  ...
  nand4  g063(.a(x40), .b(x39), .c(x09), .d(x05), .O(new_n126_));
  ...
  nand4  g072(.a(new_n134_), .b(x09), .c(x05), .d(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n131_), .O(z10));
  inv1   g074(.a(x09), .O(new_n137_));
  nand2  g075(.a(x27), .b(x04), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n97_), .c(new_n95_), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(new_n76_), .c(new_n84_), .d(new_n137_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z11));
  nor2   g079(.a(x37), .b(x36), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n66_), .c(new_n64_), .O(new_n143_));
  nand2  g081(.a(new_n72_), .b(x27), .O(new_n144_));
  nand2  g082(.a(new_n77_), .b(new_n65_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n144_), .c(new_n81_), .O(new_n146_));
  oai21  g084(.a(new_n143_), .b(x10), .c(new_n146_), .O(z12));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n64_), .O(new_n155_));
  nand4  g093(.a(new_n132_), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x09), .c(new_n76_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand3  g096(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n159_));
  nand4  g097(.a(new_n149_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  nand3  g099(.a(new_n77_), .b(new_n148_), .c(new_n65_), .O(new_n162_));
  ...
  nand3  g103(.a(new_n165_), .b(new_n85_), .c(new_n84_), .O(new_n166_));
  aoi21  g104(.a(new_n162_), .b(new_n144_), .c(new_n81_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n163_), .O(z14));
  nand4  g106(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n82_), .O(z15));
  inv1   g108(.a(x23), .O(new_n171_));
  nand4  g109(.a(new_n82_), .b(new_n171_), .c(x22), .d(x01), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z16));
  inv1   g111(.a(x01), .O(new_n174_));
  inv1   g112(.a(x24), .O(new_n175_));
  nand4  g113(.a(new_n82_), .b(new_n175_), .c(x23), .d(x22), .O(new_n176_));
  nor2   g114(.a(new_n176_), .b(new_n174_), .O(z17));
  nand2  g115(.a(x27), .b(new_n65_), .O(new_n178_));
  nand2  g116(.a(new_n64_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n66_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n86_), .c(x30), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(x40), .c(new_n137_), .O(z18));
  nand2  g120(.a(new_n139_), .b(new_n84_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n76_), .c(x09), .O(z19));
  aoi21  g122(.a(new_n86_), .b(x08), .c(x27), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n66_), .c(new_n84_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n76_), .c(x09), .O(z20));
endmodule
