...
module FAU ( 
  ...
  nand2  g035(.a(new_n79_), .b(x25), .O(new_n98_));
  ...
  nor2   g043(.a(new_n105_), .b(new_n82_), .O(z05));
  ...
  nand3  g050(.a(x38), .b(new_n78_), .c(new_n110_), .O(new_n113_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n83_), .c(new_n132_), .O(new_n142_));
  ...
  inv1   g100(.a(new_n98_), .O(new_n163_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n79_), .O(new_n168_));
  ...
  nand3  g113(.a(new_n147_), .b(new_n79_), .c(x25), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n169_), .O(z14));
  inv1   g115(.a(x12), .O(new_n178_));
  nand4  g116(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n179_));
  ...
  nand4  g123(.a(new_n80_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  nand2  g125(.a(new_n64_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n139_), .c(new_n66_), .O(new_n189_));
  nand2  g127(.a(new_n83_), .b(new_n132_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n85_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n82_), .c(new_n92_), .d(new_n118_), .O(z18));
  nand2  g130(.a(new_n80_), .b(new_n64_), .O(new_n193_));
  nand3  g131(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n194_));
  ...
  aoi22  g136(.a(new_n198_), .b(new_n98_), .c(new_n135_), .d(new_n134_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n196_), .c(new_n83_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z19));
  inv1   g139(.a(new_n133_), .O(new_n202_));
  oai21  g140(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n203_));
