...
module FAU ( 
  ...
  nand2  g018(.a(x30), .b(new_n80_), .O(new_n81_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n81_), .d(new_n76_), .O(z02));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n70_), .c(new_n96_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n81_), .c(new_n70_), .O(new_n103_));
  ...
  nand3  g047(.a(x38), .b(new_n80_), .c(new_n107_), .O(new_n110_));
  ...
  nand3  g058(.a(new_n81_), .b(new_n75_), .c(x07), .O(new_n121_));
  nand3  g059(.a(new_n76_), .b(new_n83_), .c(x05), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  inv1   g061(.a(x06), .O(new_n124_));
  nand2  g062(.a(new_n81_), .b(x37), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  aoi21  g064(.a(new_n123_), .b(new_n65_), .c(new_n126_), .O(new_n127_));
  inv1   g065(.a(x40), .O(new_n128_));
  nand2  g066(.a(x30), .b(x25), .O(new_n129_));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n96_), .O(z12));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n96_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n159_), .O(z13));
  nand3  g102(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n165_));
  nand4  g103(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n76_), .b(new_n151_), .c(new_n65_), .O(new_n168_));
  ...
  aoi21  g110(.a(new_n168_), .b(new_n148_), .c(new_n96_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n169_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n81_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(x22), .c(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n81_), .O(z16));
  inv1   g117(.a(x01), .O(new_n180_));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n81_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  nand2  g121(.a(new_n85_), .b(new_n64_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n135_), .c(new_n139_), .O(new_n185_));
  nand2  g123(.a(new_n140_), .b(new_n134_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(new_n83_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n129_), .O(z18));
  nand2  g126(.a(new_n143_), .b(new_n81_), .O(z19));
  inv1   g127(.a(new_n135_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n139_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n83_), .c(new_n134_), .O(new_n194_));
