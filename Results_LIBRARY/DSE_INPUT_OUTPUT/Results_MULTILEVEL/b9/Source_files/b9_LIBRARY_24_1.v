...
module FAU ( 
  ...
  aoi21  g062(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(new_n125_));
  ...
  nor2   g066(.a(new_n74_), .b(new_n91_), .O(new_n129_));
  ...
  nand3  g077(.a(new_n139_), .b(new_n80_), .c(new_n128_), .O(new_n140_));
  ...
  oai21  g114(.a(new_n84_), .b(x27), .c(new_n130_), .O(new_n177_));
  ...
  aoi21  g119(.a(x39), .b(new_n91_), .c(new_n74_), .O(new_n182_));
  aoi21  g120(.a(new_n133_), .b(new_n132_), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n64_), .b(new_n97_), .O(new_n184_));
  nand3  g122(.a(new_n136_), .b(x35), .c(new_n83_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x39), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n184_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n183_), .c(new_n80_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(x09), .O(z19));
  oai21  g127(.a(new_n131_), .b(new_n97_), .c(new_n90_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n97_), .c(new_n131_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n129_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n128_), .O(new_n193_));
