...
module FAU ( 
  ...
  nand4  g013(.a(new_n75_), .b(x39), .c(x30), .d(new_n66_), .O(new_n76_));
  ...
  oai21  g019(.a(new_n81_), .b(x40), .c(new_n63_), .O(new_n82_));
  ...
  oai21  g031(.a(new_n78_), .b(new_n87_), .c(x27), .O(new_n94_));
  ...
  oai21  g037(.a(new_n87_), .b(new_n68_), .c(new_n95_), .O(new_n100_));
  ...
  oai21  g060(.a(x39), .b(new_n63_), .c(x40), .O(new_n123_));
  nand4  g061(.a(new_n123_), .b(new_n80_), .c(x07), .d(new_n122_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  and2   g064(.a(x40), .b(x39), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(x30), .c(x05), .d(new_n122_), .O(new_n128_));
  ...
  oai21  g070(.a(new_n132_), .b(new_n88_), .c(new_n130_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n73_), .c(x30), .O(z11));
  nor3   g072(.a(x37), .b(x36), .c(x35), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n68_), .c(new_n72_), .O(new_n136_));
  nand2  g074(.a(new_n127_), .b(new_n122_), .O(new_n137_));
  oai21  g075(.a(new_n69_), .b(new_n68_), .c(new_n137_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n136_), .c(new_n64_), .O(z12));
  ...
  nand3  g085(.a(new_n127_), .b(new_n143_), .c(new_n122_), .O(new_n148_));
  nand4  g086(.a(x27), .b(x20), .c(new_n141_), .d(new_n140_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n69_), .c(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n64_), .O(z14));
  nand4  g089(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n64_), .O(z15));
  inv1   g091(.a(x23), .O(new_n154_));
  nand4  g092(.a(new_n64_), .b(new_n154_), .c(x22), .d(x01), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(z16));
  inv1   g094(.a(x01), .O(new_n157_));
  inv1   g095(.a(x24), .O(new_n158_));
  nand4  g096(.a(new_n64_), .b(new_n158_), .c(x23), .d(x22), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(new_n157_), .O(z17));
  nand2  g098(.a(new_n68_), .b(x08), .O(new_n161_));
  oai21  g099(.a(new_n68_), .b(x04), .c(new_n161_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(x35), .c(new_n87_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n73_), .c(new_n63_), .d(new_n130_), .O(z18));
  aoi21  g102(.a(new_n87_), .b(x08), .c(x27), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n78_), .c(new_n130_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n73_), .c(x30), .O(z20));
  aoi21  g105(.a(new_n133_), .b(new_n73_), .c(x30), .O(z19));
endmodule
