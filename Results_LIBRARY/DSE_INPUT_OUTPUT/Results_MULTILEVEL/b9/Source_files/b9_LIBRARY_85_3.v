...
module FAU ( 
  ...
  nand3  g039(.a(new_n101_), .b(new_n78_), .c(new_n69_), .O(z05));
  nand2  g040(.a(new_n101_), .b(new_n69_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n78_), .O(z06));
  ...
  nand2  g067(.a(new_n129_), .b(new_n123_), .O(new_n130_));
  nor2   g068(.a(new_n69_), .b(new_n68_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n65_), .O(new_n132_));
  ...
  aoi21  g087(.a(x39), .b(new_n123_), .c(new_n71_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n63_), .O(new_n151_));
  inv1   g089(.a(new_n71_), .O(new_n152_));
  ...
  nand4  g102(.a(new_n127_), .b(x39), .c(new_n155_), .d(new_n123_), .O(new_n165_));
  ...
  nand4  g109(.a(x40), .b(x39), .c(new_n155_), .d(new_n123_), .O(new_n172_));
  ...
  aoi21  g114(.a(new_n172_), .b(new_n152_), .c(new_n65_), .O(new_n177_));
  ...
  nand2  g124(.a(x27), .b(new_n123_), .O(new_n187_));
  nand2  g125(.a(new_n68_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n147_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n82_), .c(new_n137_), .O(new_n190_));
  inv1   g128(.a(new_n140_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(x08), .c(new_n63_), .O(new_n192_));
  oai21  g130(.a(new_n190_), .b(new_n65_), .c(new_n192_), .O(z18));
  oai21  g131(.a(new_n187_), .b(new_n83_), .c(new_n134_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n142_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n79_), .c(new_n136_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n78_), .O(z19));
  oai21  g135(.a(new_n147_), .b(new_n68_), .c(new_n134_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n147_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n191_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n136_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n78_), .O(z20));
endmodule
