...
module FAU ( 
  ...
  nor2   g041(.a(new_n82_), .b(new_n68_), .O(new_n104_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n96_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n139_), .c(new_n79_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(x09), .O(z11));
  nand3  g085(.a(new_n69_), .b(new_n81_), .c(new_n140_), .O(new_n148_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n63_), .c(new_n108_), .O(new_n154_));
  ...
  nand4  g101(.a(new_n152_), .b(new_n108_), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n130_), .b(new_n156_), .c(new_n73_), .O(new_n167_));
  ...
  nand3  g112(.a(new_n69_), .b(new_n140_), .c(x28), .O(new_n175_));
  ...
  nand2  g128(.a(x27), .b(new_n73_), .O(new_n191_));
  nand2  g129(.a(new_n68_), .b(x08), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n140_), .O(new_n193_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n65_), .c(new_n119_), .d(new_n89_), .O(z18));
  nor2   g135(.a(new_n140_), .b(new_n68_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n140_), .O(new_n199_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n79_), .c(new_n194_), .O(new_n203_));
