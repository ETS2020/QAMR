...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(x17), .d(new_n66_), .O(new_n77_));
  ...
  nor2   g031(.a(new_n74_), .b(new_n93_), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(x17), .O(z02));
  ...
  nor2   g038(.a(new_n82_), .b(new_n68_), .O(new_n101_));
  inv1   g039(.a(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n64_), .c(new_n69_), .O(z05));
  ...
  aoi21  g053(.a(new_n93_), .b(x17), .c(new_n74_), .O(z08));
  ...
  nand4  g058(.a(x40), .b(x39), .c(x17), .d(x05), .O(new_n121_));
  oai21  g059(.a(z08), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n84_), .c(new_n119_), .O(new_n123_));
  ...
  nor3   g065(.a(new_n127_), .b(new_n93_), .c(new_n63_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x05), .c(new_n119_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n126_), .O(z10));
  nand2  g068(.a(new_n64_), .b(new_n68_), .O(new_n131_));
  oai21  g069(.a(new_n83_), .b(x04), .c(x17), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(x08), .O(new_n133_));
  inv1   g071(.a(new_n83_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(x17), .c(new_n74_), .O(new_n136_));
  ...
  nand3  g079(.a(new_n69_), .b(new_n81_), .c(new_n141_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x27), .c(x10), .O(new_n143_));
  aoi21  g081(.a(x39), .b(new_n119_), .c(new_n71_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x17), .O(new_n145_));
  oai21  g083(.a(new_n71_), .b(x40), .c(new_n145_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x28), .c(new_n74_), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n147_), .d(new_n119_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand2  g090(.a(new_n70_), .b(new_n69_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n150_), .c(new_n63_), .O(new_n155_));
  nand4  g093(.a(new_n153_), .b(new_n74_), .c(x20), .d(new_n152_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n128_), .b(new_n147_), .c(new_n119_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand3  g098(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n161_));
  nand4  g099(.a(new_n148_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  nand3  g101(.a(new_n94_), .b(new_n147_), .c(new_n119_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(new_n161_), .O(new_n165_));
  nand3  g103(.a(new_n69_), .b(new_n141_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n80_), .c(new_n79_), .O(new_n168_));
  inv1   g106(.a(new_n71_), .O(new_n169_));
  aoi21  g107(.a(new_n164_), .b(new_n169_), .c(new_n65_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n168_), .c(new_n165_), .O(z14));
  inv1   g109(.a(x12), .O(new_n172_));
  nand4  g110(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n173_));
  ...
  nand2  g118(.a(x27), .b(new_n119_), .O(new_n181_));
  nand2  g119(.a(new_n68_), .b(x08), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n141_), .O(new_n183_));
  inv1   g121(.a(x09), .O(new_n184_));
  nand2  g122(.a(new_n79_), .b(new_n184_), .O(new_n185_));
  aoi21  g123(.a(new_n183_), .b(new_n82_), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n94_), .b(x29), .O(new_n187_));
  inv1   g125(.a(new_n187_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(x17), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n186_), .b(new_n65_), .c(new_n189_), .O(z18));
  nand2  g128(.a(new_n137_), .b(new_n134_), .O(new_n191_));
  nand2  g129(.a(new_n187_), .b(new_n191_), .O(new_n192_));
  inv1   g130(.a(x08), .O(new_n193_));
  oai21  g131(.a(new_n181_), .b(new_n83_), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n192_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n79_), .c(new_n184_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n64_), .O(z19));
  oai21  g135(.a(new_n141_), .b(new_n68_), .c(new_n193_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n141_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n188_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n184_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n64_), .O(z20));
endmodule
