...
module FAU ( 
  ...
  nor2   g051(.a(new_n113_), .b(new_n69_), .O(z08));
  ...
  aoi21  g067(.a(x39), .b(new_n129_), .c(new_n113_), .O(new_n130_));
  ...
  aoi21  g093(.a(new_n155_), .b(x39), .c(new_n113_), .O(new_n156_));
  or2    g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x40), .b(new_n146_), .c(new_n118_), .O(new_n158_));
  ...
  aoi21  g122(.a(x40), .b(new_n69_), .c(x27), .O(new_n185_));
  nand2  g123(.a(x39), .b(new_n140_), .O(new_n186_));
