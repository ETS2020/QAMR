...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x23), .O(new_n96_));
  ...
  nor2   g057(.a(new_n63_), .b(new_n119_), .O(new_n120_));
  ...
  aoi21  g063(.a(x40), .b(new_n119_), .c(new_n96_), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x05), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n85_), .c(new_n74_), .O(new_n129_));
  ...
  nand2  g077(.a(new_n120_), .b(x29), .O(new_n140_));
  ...
  nand3  g111(.a(new_n120_), .b(new_n159_), .c(new_n74_), .O(new_n174_));
  ...
  aoi21  g116(.a(new_n174_), .b(new_n71_), .c(new_n65_), .O(new_n179_));
  ...
  aoi21  g124(.a(new_n186_), .b(x40), .c(new_n156_), .O(z17));
  nand2  g125(.a(new_n100_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n146_), .c(new_n151_), .O(new_n189_));
  nand2  g127(.a(new_n80_), .b(new_n139_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n83_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n65_), .c(new_n121_), .d(new_n90_), .O(z18));
  nand2  g130(.a(new_n64_), .b(new_n100_), .O(new_n193_));
  ...
  oai21  g139(.a(new_n151_), .b(new_n100_), .c(new_n145_), .O(new_n202_));
  aoi21  g140(.a(x28), .b(new_n100_), .c(new_n151_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n80_), .c(new_n139_), .O(new_n205_));
