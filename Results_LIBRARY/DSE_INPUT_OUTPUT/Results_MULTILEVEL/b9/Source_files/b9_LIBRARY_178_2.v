...
module FAU ( 
  ...
  oai22  g057(.a(new_n113_), .b(new_n118_), .c(x39), .d(new_n119_), .O(new_n120_));
  ...
  nor2   g069(.a(new_n125_), .b(new_n131_), .O(new_n132_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n73_), .c(new_n130_), .O(new_n143_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n117_), .O(new_n154_));
  ...
  nand4  g097(.a(new_n157_), .b(new_n125_), .c(x20), .d(new_n156_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n127_), .b(new_n151_), .c(new_n117_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n162_), .O(z13));
  nand3  g102(.a(x39), .b(new_n151_), .c(new_n117_), .O(new_n165_));
  ...
  nand3  g136(.a(new_n198_), .b(new_n73_), .c(new_n130_), .O(new_n199_));
