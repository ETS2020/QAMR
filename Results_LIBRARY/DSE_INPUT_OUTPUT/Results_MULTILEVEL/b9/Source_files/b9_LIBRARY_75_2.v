...
module FAU ( 
  ...
  oai22  g074(.a(new_n136_), .b(new_n83_), .c(new_n129_), .d(new_n135_), .O(new_n137_));
  ...
  nand3  g082(.a(new_n97_), .b(new_n81_), .c(new_n144_), .O(new_n145_));
  ...
  nand4  g096(.a(new_n156_), .b(new_n129_), .c(x20), .d(new_n155_), .O(new_n159_));
  ...
  nand2  g122(.a(new_n79_), .b(new_n134_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n82_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n78_), .c(new_n117_), .d(new_n89_), .O(z18));
  oai21  g125(.a(new_n182_), .b(new_n83_), .c(new_n90_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n137_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n79_), .c(new_n134_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n64_), .O(z19));
  nor2   g129(.a(new_n129_), .b(new_n135_), .O(new_n192_));
  oai21  g130(.a(new_n144_), .b(new_n66_), .c(new_n90_), .O(new_n193_));
