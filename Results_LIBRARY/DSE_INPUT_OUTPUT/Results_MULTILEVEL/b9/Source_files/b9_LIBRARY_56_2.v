...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x22), .O(new_n64_));
  ...
  nor2   g030(.a(x40), .b(x22), .O(new_n93_));
  ...
  aoi21  g059(.a(x40), .b(new_n116_), .c(new_n93_), .O(new_n122_));
  nand3  g060(.a(x40), .b(x39), .c(x05), .O(new_n123_));
  oai21  g061(.a(new_n122_), .b(new_n121_), .c(new_n123_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n84_), .c(new_n71_), .O(new_n125_));
  ...
  nand3  g076(.a(new_n135_), .b(x27), .c(new_n71_), .O(new_n139_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n97_), .c(new_n73_), .O(new_n145_));
  nand2  g083(.a(z08), .b(new_n71_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n68_), .O(new_n147_));
  ...
  nand4  g095(.a(new_n67_), .b(new_n157_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n156_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n130_), .b(new_n149_), .c(new_n71_), .O(new_n161_));
  ...
  nand3  g103(.a(z08), .b(new_n149_), .c(new_n71_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n65_), .b(new_n134_), .c(x28), .O(new_n168_));
  ...
  nand2  g113(.a(new_n175_), .b(x01), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(x40), .c(new_n157_), .O(z16));
  nand3  g115(.a(x23), .b(x22), .c(x01), .O(new_n178_));
  nor3   g116(.a(new_n178_), .b(new_n63_), .c(x24), .O(z17));
  oai21  g117(.a(new_n83_), .b(x27), .c(new_n133_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n140_), .b(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n181_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g121(.a(new_n64_), .b(new_n97_), .O(new_n184_));
  oai21  g122(.a(new_n83_), .b(x04), .c(x40), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(x08), .O(new_n186_));
  nand2  g124(.a(x39), .b(x29), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(x40), .c(new_n93_), .O(new_n188_));
  aoi21  g126(.a(new_n136_), .b(new_n135_), .c(new_n188_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n186_), .c(new_n79_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(x09), .O(z19));
  aoi21  g129(.a(x28), .b(new_n97_), .c(new_n134_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n188_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n134_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n184_), .c(x08), .O(new_n195_));
