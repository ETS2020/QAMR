...
module FAU ( 
  ...
  nand2  g000(.a(x19), .b(x10), .O(new_n63_));
  ...
  aoi21  g031(.a(new_n93_), .b(new_n89_), .c(new_n77_), .O(z02));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n64_), .c(new_n77_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n63_), .c(new_n64_), .O(new_n104_));
  ...
  nand2  g054(.a(new_n92_), .b(new_n63_), .O(z08));
  ...
  nand3  g062(.a(new_n124_), .b(new_n83_), .c(x27), .O(new_n125_));
  ...
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n77_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x40), .b(x39), .c(x29), .O(new_n133_));
  nor2   g071(.a(new_n97_), .b(new_n121_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n82_), .c(new_n133_), .O(new_n135_));
  inv1   g073(.a(x08), .O(new_n136_));
  nand4  g074(.a(x35), .b(new_n81_), .c(x27), .d(new_n121_), .O(new_n137_));
  ...
  nand3  g091(.a(new_n66_), .b(x20), .c(new_n72_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(x18), .c(new_n153_), .O(new_n155_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n121_), .c(new_n77_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z13));
  inv1   g098(.a(x18), .O(new_n161_));
  aoi21  g099(.a(x20), .b(new_n161_), .c(x19), .O(new_n162_));
  nor2   g100(.a(new_n72_), .b(x10), .O(new_n163_));
  ...
  nand2  g109(.a(new_n166_), .b(new_n67_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n72_), .O(new_n174_));
  nand4  g112(.a(new_n79_), .b(new_n78_), .c(new_n97_), .d(new_n145_), .O(new_n175_));
  ...
  oai21  g123(.a(new_n82_), .b(x27), .c(new_n133_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n77_), .b(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n137_), .d(new_n78_), .O(z18));
  inv1   g127(.a(new_n133_), .O(new_n190_));
  oai21  g128(.a(new_n168_), .b(new_n97_), .c(new_n136_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n97_), .c(new_n168_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n63_), .c(new_n78_), .d(new_n132_), .O(new_n194_));
