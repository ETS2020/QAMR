...
module FAU ( 
  ...
  nor2   g034(.a(x40), .b(x34), .O(new_n97_));
  ...
  aoi21  g041(.a(new_n103_), .b(new_n100_), .c(new_n83_), .O(z04));
  oai21  g042(.a(new_n86_), .b(new_n64_), .c(new_n70_), .O(new_n105_));
  and2   g043(.a(new_n105_), .b(new_n81_), .O(z05));
  ...
  nor2   g057(.a(new_n119_), .b(new_n76_), .O(z09));
  inv1   g058(.a(x07), .O(new_n121_));
  aoi21  g059(.a(x40), .b(new_n75_), .c(new_n97_), .O(new_n122_));
  nand3  g060(.a(x40), .b(x39), .c(x05), .O(new_n123_));
  oai21  g061(.a(new_n122_), .b(new_n121_), .c(new_n123_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n88_), .c(new_n65_), .O(new_n125_));
  nand3  g063(.a(new_n81_), .b(x37), .c(x06), .O(new_n126_));
  ...
  nand2  g071(.a(new_n133_), .b(new_n128_), .O(z10));
  ...
  aoi21  g077(.a(new_n139_), .b(x40), .c(new_n97_), .O(new_n140_));
  ...
  aoi21  g083(.a(new_n145_), .b(new_n66_), .c(new_n64_), .O(new_n146_));
  nand2  g084(.a(new_n72_), .b(x27), .O(new_n147_));
  nand2  g085(.a(z08), .b(new_n65_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n83_), .O(new_n149_));
  ...
  nor2   g097(.a(new_n131_), .b(x13), .O(new_n160_));
  ...
  nand3  g103(.a(z08), .b(new_n151_), .c(new_n65_), .O(new_n166_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n147_), .c(new_n83_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n76_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand4  g113(.a(new_n81_), .b(new_n175_), .c(x22), .d(x01), .O(new_n176_));
  ...
  nand2  g120(.a(z08), .b(x29), .O(new_n183_));
  oai21  g121(.a(new_n87_), .b(x27), .c(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nand3  g123(.a(new_n138_), .b(x27), .c(new_n65_), .O(new_n186_));
  nor2   g124(.a(new_n83_), .b(x30), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n182_), .O(z18));
  nand2  g126(.a(new_n141_), .b(new_n138_), .O(new_n189_));
  nand2  g127(.a(new_n183_), .b(new_n189_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  nand2  g129(.a(new_n186_), .b(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n84_), .c(new_n182_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n81_), .O(z19));
  inv1   g133(.a(new_n183_), .O(new_n196_));
  oai21  g134(.a(new_n66_), .b(new_n64_), .c(new_n191_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n84_), .c(new_n182_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n81_), .O(z20));
endmodule
