...
module FAU ( 
  ...
  oai21  g023(.a(new_n85_), .b(new_n69_), .c(x40), .O(z02));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n92_), .c(new_n87_), .O(z05));
  nand3  g036(.a(new_n97_), .b(new_n70_), .c(new_n92_), .O(new_n99_));
  inv1   g037(.a(new_n99_), .O(z06));
  ...
  oai22  g057(.a(new_n113_), .b(new_n118_), .c(x40), .d(new_n119_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n77_), .c(new_n117_), .O(new_n121_));
  ...
  nor2   g063(.a(new_n125_), .b(new_n69_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(x05), .c(new_n117_), .O(new_n127_));
  ...
  inv1   g075(.a(x28), .O(new_n138_));
  nand2  g076(.a(x40), .b(x04), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(x35), .c(new_n138_), .d(x27), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n73_), .c(new_n129_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n70_), .O(z11));
  nor2   g082(.a(new_n64_), .b(new_n91_), .O(new_n145_));
  nand3  g083(.a(new_n92_), .b(new_n76_), .c(new_n75_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x27), .c(x10), .O(new_n147_));
  nor2   g085(.a(new_n145_), .b(new_n117_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(x39), .O(new_n149_));
  ...
  nand4  g091(.a(new_n153_), .b(x40), .c(new_n151_), .d(new_n117_), .O(new_n154_));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand2  g094(.a(new_n88_), .b(new_n92_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n154_), .c(new_n69_), .O(new_n159_));
  nand4  g097(.a(new_n157_), .b(new_n131_), .c(x20), .d(new_n156_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n126_), .b(new_n151_), .c(new_n117_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n162_), .O(z13));
  nand3  g102(.a(x40), .b(new_n151_), .c(new_n117_), .O(new_n165_));
  nand4  g103(.a(x27), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n64_), .c(new_n165_), .O(new_n167_));
  nand3  g105(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n168_));
  nor2   g106(.a(x37), .b(x35), .O(new_n169_));
  aoi21  g107(.a(new_n168_), .b(new_n152_), .c(new_n169_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n138_), .c(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n74_), .c(new_n73_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n167_), .c(new_n70_), .O(z14));
  ...
  nand2  g115(.a(new_n177_), .b(new_n70_), .O(z16));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n70_), .O(z17));
  nand2  g119(.a(x27), .b(new_n117_), .O(new_n182_));
  nand2  g120(.a(new_n91_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n75_), .O(new_n184_));
  nand2  g122(.a(new_n73_), .b(new_n129_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n138_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n87_), .c(new_n113_), .d(new_n82_), .O(z18));
  aoi21  g125(.a(x39), .b(new_n130_), .c(new_n131_), .O(new_n188_));
  aoi21  g126(.a(new_n134_), .b(new_n83_), .c(new_n188_), .O(new_n189_));
  nand2  g127(.a(new_n70_), .b(new_n91_), .O(new_n190_));
  nand3  g128(.a(new_n139_), .b(x35), .c(new_n138_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x39), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n190_), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n189_), .c(new_n73_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(x09), .O(z19));
  oai21  g133(.a(new_n75_), .b(new_n91_), .c(new_n137_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n91_), .c(new_n75_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n132_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n73_), .c(new_n129_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n70_), .O(z20));
endmodule
