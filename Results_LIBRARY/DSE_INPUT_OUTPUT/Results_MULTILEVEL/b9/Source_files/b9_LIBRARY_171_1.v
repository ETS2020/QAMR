...
module FAU ( 
  ...
  nor2   g015(.a(new_n73_), .b(x20), .O(new_n78_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n89_), .c(x20), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x40), .O(z02));
  oai21  g032(.a(new_n66_), .b(new_n83_), .c(x27), .O(new_n95_));
  inv1   g033(.a(x37), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n64_), .c(new_n78_), .O(new_n97_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n78_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n79_), .c(new_n96_), .O(new_n103_));
  ...
  aoi21  g053(.a(new_n72_), .b(x20), .c(new_n73_), .O(z08));
  ...
  nand4  g058(.a(x40), .b(x39), .c(x20), .d(x05), .O(new_n121_));
  oai21  g059(.a(z08), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n85_), .c(new_n65_), .O(new_n123_));
  ...
  nand4  g066(.a(new_n128_), .b(x20), .c(x05), .d(new_n65_), .O(new_n129_));
  ...
  nand2  g073(.a(new_n74_), .b(x29), .O(new_n136_));
  nor2   g074(.a(new_n66_), .b(x28), .O(new_n137_));
  oai21  g075(.a(new_n64_), .b(new_n65_), .c(new_n137_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  oai21  g077(.a(new_n84_), .b(new_n64_), .c(new_n131_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n81_), .c(new_n132_), .O(new_n142_));
  ...
  nand2  g084(.a(new_n74_), .b(new_n65_), .O(new_n147_));
  oai21  g085(.a(new_n70_), .b(new_n64_), .c(new_n147_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n79_), .O(z12));
  inv1   g087(.a(x20), .O(new_n150_));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n73_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n154_));
  or2    g092(.a(new_n70_), .b(x19), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(x18), .c(new_n154_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  nand3  g095(.a(new_n128_), .b(new_n151_), .c(new_n65_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n157_), .c(new_n150_), .O(z13));
  nand4  g097(.a(new_n152_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n160_));
  nand3  g098(.a(x39), .b(new_n151_), .c(new_n65_), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n160_), .c(new_n150_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n73_), .c(x19), .d(x18), .O(new_n164_));
  nand3  g102(.a(new_n96_), .b(new_n66_), .c(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n82_), .c(new_n81_), .O(new_n167_));
  oai21  g105(.a(new_n70_), .b(new_n64_), .c(new_n161_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x20), .O(new_n170_));
  nand2  g108(.a(x27), .b(x20), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n70_), .c(new_n73_), .O(new_n172_));
  ...
  nand4  g114(.a(new_n79_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z16));
  inv1   g116(.a(x01), .O(new_n179_));
  inv1   g117(.a(x24), .O(new_n180_));
  nand4  g118(.a(new_n79_), .b(new_n180_), .c(x23), .d(x22), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n179_), .O(z17));
  oai21  g120(.a(new_n84_), .b(x27), .c(new_n136_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n78_), .b(x09), .O(new_n185_));
  nand3  g123(.a(new_n137_), .b(x27), .c(new_n65_), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n81_), .O(z18));
  nand2  g125(.a(new_n186_), .b(new_n131_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n139_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n81_), .c(new_n132_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n79_), .O(z19));
  inv1   g129(.a(new_n136_), .O(new_n192_));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n81_), .c(new_n132_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n79_), .O(z20));
endmodule
