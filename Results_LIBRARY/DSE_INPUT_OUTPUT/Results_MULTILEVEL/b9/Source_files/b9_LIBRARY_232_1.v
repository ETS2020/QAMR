...
module FAU ( 
  ...
  nand3  g024(.a(new_n86_), .b(new_n84_), .c(new_n63_), .O(new_n87_));
  nand3  g025(.a(new_n87_), .b(new_n83_), .c(x04), .O(z01));
  inv1   g026(.a(x08), .O(new_n89_));
  nor2   g027(.a(x30), .b(x29), .O(new_n90_));
  aoi21  g028(.a(x29), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  ...
  oai22  g032(.a(new_n94_), .b(new_n64_), .c(new_n91_), .d(x02), .O(z02));
  ...
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n83_), .d(new_n97_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n83_), .c(new_n72_), .O(z05));
  nand2  g041(.a(new_n102_), .b(new_n72_), .O(new_n104_));
  ...
  oai21  g059(.a(new_n121_), .b(new_n77_), .c(x29), .O(new_n122_));
  ...
  aoi21  g072(.a(new_n77_), .b(new_n63_), .c(new_n134_), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n92_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(new_n138_));
  nand3  g076(.a(new_n92_), .b(x27), .c(new_n67_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n63_), .c(new_n89_), .O(new_n140_));
  oai21  g078(.a(new_n138_), .b(new_n135_), .c(new_n140_), .O(new_n141_));
  ...
  aoi21  g085(.a(new_n147_), .b(new_n146_), .c(new_n64_), .O(z12));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n67_), .c(new_n64_), .O(new_n162_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n78_), .c(new_n64_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n84_), .c(new_n63_), .d(x28), .O(new_n167_));
  ...
  aoi22  g109(.a(new_n165_), .b(new_n78_), .c(new_n74_), .d(x27), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n171_), .c(new_n63_), .O(new_n173_));
  nand2  g111(.a(new_n172_), .b(x29), .O(new_n174_));
  ...
  nand2  g120(.a(new_n182_), .b(new_n83_), .O(z17));
  nand2  g121(.a(new_n92_), .b(new_n66_), .O(new_n184_));
  nand2  g122(.a(new_n78_), .b(x29), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n139_), .c(new_n63_), .d(new_n133_), .O(z18));
  inv1   g126(.a(new_n185_), .O(new_n189_));
  nand2  g127(.a(new_n139_), .b(new_n89_), .O(new_n190_));
  oai21  g128(.a(new_n189_), .b(new_n138_), .c(new_n190_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n63_), .c(new_n133_), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(z19));
  oai21  g131(.a(new_n68_), .b(new_n66_), .c(new_n89_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n189_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n63_), .c(new_n133_), .O(new_n197_));
