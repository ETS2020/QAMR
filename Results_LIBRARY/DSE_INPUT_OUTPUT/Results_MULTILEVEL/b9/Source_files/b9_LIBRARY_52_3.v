...
module FAU ( 
  ...
  nand2  g022(.a(new_n84_), .b(new_n72_), .O(new_n85_));
  ...
  inv1   g026(.a(new_n67_), .O(new_n89_));
  inv1   g027(.a(new_n80_), .O(new_n90_));
  ...
  oai21  g032(.a(new_n94_), .b(new_n84_), .c(x04), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n90_), .d(new_n89_), .O(z02));
  nand2  g034(.a(new_n75_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x27), .O(new_n98_));
  nand2  g036(.a(new_n70_), .b(new_n98_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n97_), .c(new_n90_), .d(x21), .O(z03));
  aoi21  g038(.a(new_n70_), .b(new_n98_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n97_), .c(new_n80_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n90_), .c(new_n70_), .O(z05));
  inv1   g042(.a(z05), .O(z06));
  inv1   g043(.a(x03), .O(new_n106_));
  inv1   g044(.a(x31), .O(new_n107_));
  inv1   g045(.a(x33), .O(new_n108_));
  oai21  g046(.a(new_n65_), .b(x10), .c(x17), .O(new_n109_));
  ...
  nor2   g067(.a(new_n70_), .b(new_n98_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n80_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nor2   g072(.a(new_n98_), .b(new_n64_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n84_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n83_), .c(x27), .d(new_n64_), .O(new_n138_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n90_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n98_), .c(new_n79_), .O(new_n144_));
  nand2  g082(.a(new_n75_), .b(new_n70_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n67_), .b(x04), .c(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n144_), .c(new_n90_), .O(z12));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n149_), .d(new_n64_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n145_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n64_), .c(new_n80_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n89_), .b(new_n149_), .c(new_n64_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n70_), .b(new_n71_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n82_), .c(new_n81_), .O(new_n170_));
  aoi21  g108(.a(new_n166_), .b(new_n146_), .c(new_n80_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nand4  g111(.a(new_n90_), .b(x34), .c(x27), .d(x26), .O(new_n174_));
  nor2   g112(.a(new_n174_), .b(new_n173_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand4  g114(.a(new_n90_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z16));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n90_), .O(z17));
  oai21  g119(.a(new_n84_), .b(x27), .c(new_n134_), .O(new_n182_));
  nand3  g120(.a(new_n138_), .b(new_n81_), .c(new_n133_), .O(new_n183_));
  ...
  oai21  g124(.a(new_n71_), .b(new_n98_), .c(new_n137_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n98_), .c(new_n71_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n81_), .c(new_n133_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n90_), .O(z20));
  nand2  g129(.a(new_n141_), .b(new_n90_), .O(z19));
endmodule
