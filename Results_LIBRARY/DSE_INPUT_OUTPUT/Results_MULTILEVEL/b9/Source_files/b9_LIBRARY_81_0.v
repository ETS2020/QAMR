...
module FAU ( 
  ...
  nand3  g032(.a(new_n94_), .b(new_n92_), .c(x40), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x39), .O(new_n96_));
  nor2   g034(.a(new_n79_), .b(x39), .O(new_n97_));
  ...
  nand2  g046(.a(new_n108_), .b(new_n80_), .O(z06));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(new_n78_), .O(new_n162_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n97_), .c(new_n168_), .O(new_n173_));
  ...
  aoi21  g128(.a(new_n190_), .b(new_n143_), .c(new_n66_), .O(new_n191_));
  nand2  g129(.a(new_n82_), .b(new_n138_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n84_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n100_), .c(new_n91_), .d(new_n122_), .O(z18));
  inv1   g132(.a(new_n139_), .O(new_n195_));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(new_n142_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n82_), .c(new_n138_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n80_), .O(z20));
  nand2  g138(.a(new_n146_), .b(new_n80_), .O(z19));
endmodule
