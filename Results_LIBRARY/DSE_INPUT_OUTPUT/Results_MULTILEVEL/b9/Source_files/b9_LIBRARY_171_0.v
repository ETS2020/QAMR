...
module FAU ( 
  ...
  nand2  g035(.a(new_n76_), .b(x20), .O(new_n98_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n98_), .c(new_n125_), .O(new_n127_));
  ...
  oai21  g082(.a(new_n144_), .b(x08), .c(new_n141_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n85_), .c(new_n138_), .O(new_n146_));
  ...
  oai22  g088(.a(new_n120_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n82_), .O(z12));
  ...
  nand3  g099(.a(new_n135_), .b(new_n153_), .c(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  nand3  g101(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n164_));
  nand4  g102(.a(x27), .b(x20), .c(new_n158_), .d(new_n157_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n73_), .c(new_n164_), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n167_));
  nor2   g105(.a(x37), .b(x35), .O(new_n168_));
  aoi21  g106(.a(new_n167_), .b(new_n154_), .c(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n87_), .c(x27), .O(new_n170_));
  ...
  nand4  g111(.a(new_n72_), .b(x27), .c(new_n158_), .d(new_n157_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n76_), .c(x20), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n173_), .O(z14));
