...
module FAU ( 
  ...
  oai21  g004(.a(new_n66_), .b(x04), .c(x40), .O(new_n67_));
  aoi21  g005(.a(new_n65_), .b(x27), .c(new_n67_), .O(new_n68_));
  oai21  g006(.a(new_n68_), .b(x15), .c(x16), .O(z00));
  ...
  nand3  g025(.a(new_n87_), .b(new_n85_), .c(x39), .O(new_n88_));
  nand2  g026(.a(new_n88_), .b(x40), .O(new_n89_));
  nor2   g027(.a(x40), .b(new_n70_), .O(new_n90_));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n73_), .O(z03));
  aoi21  g037(.a(new_n97_), .b(new_n96_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n94_), .c(new_n73_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n73_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n72_), .c(new_n97_), .O(new_n104_));
  ...
  nand2  g053(.a(new_n115_), .b(new_n72_), .O(z07));
  nand2  g054(.a(x40), .b(x39), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n72_), .O(z08));
  inv1   g056(.a(x11), .O(new_n119_));
  nand4  g057(.a(new_n72_), .b(x34), .c(x27), .d(x26), .O(new_n120_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n72_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  nor2   g074(.a(new_n96_), .b(new_n122_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n78_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand2  g077(.a(x27), .b(new_n122_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n78_), .c(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n74_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n72_), .O(z11));
  inv1   g082(.a(x10), .O(new_n145_));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n96_), .c(new_n145_), .O(new_n147_));
  nand2  g085(.a(new_n93_), .b(new_n97_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  oai21  g087(.a(new_n117_), .b(x04), .c(new_n149_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n147_), .c(new_n72_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x28), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n122_), .O(new_n155_));
  inv1   g093(.a(x18), .O(new_n156_));
  inv1   g094(.a(x19), .O(new_n157_));
  nand4  g095(.a(new_n148_), .b(x20), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n71_), .O(new_n159_));
  nor2   g097(.a(new_n158_), .b(new_n70_), .O(new_n160_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n75_), .c(new_n74_), .d(x28), .O(new_n165_));
  nand3  g103(.a(x39), .b(new_n152_), .c(new_n122_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n71_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n90_), .c(new_n164_), .O(new_n169_));
  inv1   g107(.a(x35), .O(new_n170_));
  nand3  g108(.a(new_n97_), .b(new_n170_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n75_), .c(new_n74_), .O(new_n173_));
  nand2  g111(.a(new_n166_), .b(new_n149_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand3  g114(.a(new_n149_), .b(new_n71_), .c(x15), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n169_), .O(z14));
  nand4  g116(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n72_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand4  g119(.a(new_n72_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z16));
  inv1   g121(.a(x01), .O(new_n184_));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n72_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  nand2  g125(.a(new_n96_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n140_), .c(new_n170_), .O(new_n189_));
  nand2  g127(.a(new_n74_), .b(new_n135_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n77_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n73_), .c(new_n117_), .d(new_n84_), .O(z18));
  inv1   g130(.a(new_n136_), .O(new_n193_));
  oai21  g131(.a(new_n170_), .b(new_n96_), .c(new_n139_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n96_), .c(new_n170_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n74_), .c(new_n135_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n72_), .O(z20));
  nand2  g136(.a(new_n143_), .b(new_n72_), .O(z19));
endmodule
