...
module FAU ( 
  ...
  nand2  g017(.a(x11), .b(x05), .O(new_n80_));
  ...
  nand4  g037(.a(new_n97_), .b(new_n96_), .c(new_n80_), .d(new_n99_), .O(z04));
  ...
  nand4  g058(.a(x27), .b(x26), .c(x11), .d(new_n120_), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n119_), .O(z09));
  nand2  g060(.a(x35), .b(new_n101_), .O(new_n123_));
  nand3  g061(.a(new_n80_), .b(new_n75_), .c(x07), .O(new_n124_));
  inv1   g062(.a(x11), .O(new_n125_));
  nand4  g063(.a(x40), .b(x39), .c(new_n125_), .d(x05), .O(new_n126_));
  aoi22  g064(.a(new_n126_), .b(new_n124_), .c(new_n123_), .d(new_n67_), .O(new_n127_));
  ...
  nor2   g070(.a(new_n132_), .b(x11), .O(new_n133_));
  ...
  oai21  g076(.a(new_n138_), .b(new_n123_), .c(new_n137_), .O(new_n139_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n148_), .c(new_n83_), .O(z12));
  ...
  aoi22  g109(.a(new_n171_), .b(new_n84_), .c(new_n168_), .d(new_n149_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n169_), .c(new_n83_), .O(z14));
  ...
  oai21  g119(.a(new_n123_), .b(x27), .c(new_n137_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n83_), .b(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n141_), .d(new_n84_), .O(z18));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n186_));
  nand2  g124(.a(new_n137_), .b(new_n66_), .O(new_n187_));
  ...
  oai21  g131(.a(new_n193_), .b(x09), .c(new_n80_), .O(z19));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n189_), .c(new_n186_), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n80_), .c(new_n84_), .d(new_n136_), .O(new_n197_));
