...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(x19), .O(new_n81_));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n94_), .c(new_n81_), .O(z02));
  ...
  nand4  g060(.a(x27), .b(x26), .c(x19), .d(x11), .O(new_n123_));
  ...
  oai21  g071(.a(new_n133_), .b(new_n129_), .c(new_n65_), .O(new_n134_));
  nand3  g072(.a(x37), .b(x27), .c(x06), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n134_), .c(new_n81_), .O(z10));
  ...
  nand3  g079(.a(new_n95_), .b(x27), .c(new_n65_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(new_n82_), .c(new_n84_), .d(new_n137_), .O(new_n145_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n149_), .c(new_n81_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n120_), .O(new_n154_));
  ...
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(new_n80_), .O(new_n161_));
  aoi21  g099(.a(new_n153_), .b(x28), .c(new_n64_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n131_), .c(x40), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n119_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x19), .c(new_n152_), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n161_), .O(z13));
  aoi21  g104(.a(x20), .b(new_n156_), .c(x26), .O(new_n167_));
  nand4  g105(.a(new_n153_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n76_), .b(new_n152_), .c(new_n65_), .O(new_n170_));
  oai22  g108(.a(new_n170_), .b(new_n169_), .c(new_n167_), .d(x19), .O(new_n171_));
  ...
  oai21  g112(.a(new_n73_), .b(new_n64_), .c(new_n170_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n80_), .O(new_n177_));
  nand4  g115(.a(new_n85_), .b(new_n84_), .c(new_n64_), .d(x19), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n171_), .O(z14));
  nand3  g117(.a(x34), .b(x27), .c(x12), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(x19), .c(new_n80_), .O(z15));
  ...
  oai21  g125(.a(new_n87_), .b(x27), .c(new_n138_), .O(new_n188_));
  nand3  g126(.a(new_n142_), .b(new_n84_), .c(new_n137_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(x08), .c(new_n189_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(new_n81_), .O(z18));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n141_), .O(new_n192_));
  nand2  g130(.a(new_n138_), .b(new_n66_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(new_n81_), .O(new_n194_));
  oai21  g132(.a(x28), .b(x04), .c(new_n141_), .O(new_n195_));
  oai21  g133(.a(new_n139_), .b(x28), .c(new_n138_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n194_), .c(new_n84_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(x09), .c(new_n82_), .O(z19));
  inv1   g137(.a(new_n138_), .O(new_n200_));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n192_), .O(new_n202_));
  nand4  g140(.a(new_n202_), .b(new_n82_), .c(new_n84_), .d(new_n137_), .O(new_n203_));
