...
module FAU ( 
  ...
  oai21  g039(.a(new_n81_), .b(new_n97_), .c(new_n65_), .O(new_n102_));
  ...
  aoi21  g067(.a(x40), .b(new_n89_), .c(new_n129_), .O(new_n130_));
  ...
  nand4  g088(.a(new_n67_), .b(new_n129_), .c(x20), .d(new_n148_), .O(new_n151_));
  ...
  oai21  g101(.a(new_n163_), .b(new_n81_), .c(x27), .O(new_n164_));
  ...
  oai22  g114(.a(new_n82_), .b(x27), .c(new_n129_), .d(new_n89_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n97_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n128_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n178_), .c(new_n64_), .d(new_n78_), .O(z18));
  nand2  g119(.a(x39), .b(x04), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x35), .c(new_n81_), .O(new_n183_));
  ...
  nor2   g125(.a(new_n129_), .b(new_n89_), .O(new_n188_));
  inv1   g126(.a(x35), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n97_), .c(new_n88_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n97_), .c(new_n189_), .O(new_n191_));
