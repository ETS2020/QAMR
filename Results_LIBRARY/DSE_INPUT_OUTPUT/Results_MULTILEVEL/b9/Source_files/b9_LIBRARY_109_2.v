...
module FAU ( 
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n81_), .O(z10));
  nand2  g068(.a(new_n81_), .b(new_n64_), .O(new_n131_));
  oai21  g069(.a(new_n87_), .b(x04), .c(x40), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(x08), .O(new_n133_));
  inv1   g071(.a(new_n87_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  nor2   g073(.a(x40), .b(x19), .O(new_n136_));
  ...
  oai21  g077(.a(new_n139_), .b(new_n133_), .c(new_n84_), .O(new_n140_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n80_), .c(new_n146_), .O(new_n148_));
  ...
  nand4  g092(.a(new_n72_), .b(x20), .c(new_n146_), .d(new_n154_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n153_), .c(new_n64_), .O(new_n156_));
  nor3   g094(.a(new_n126_), .b(x13), .c(x04), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x39), .b(new_n150_), .c(new_n65_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n146_), .d(new_n154_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n73_), .c(new_n159_), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n146_), .c(new_n154_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(new_n151_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n86_), .c(x27), .O(new_n165_));
  ...
  nand4  g106(.a(new_n72_), .b(x27), .c(x20), .d(new_n154_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n80_), .c(new_n146_), .O(new_n170_));
  ...
  nand2  g118(.a(new_n76_), .b(x29), .O(new_n181_));
  oai21  g119(.a(new_n87_), .b(x27), .c(new_n181_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n64_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n134_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n183_), .c(new_n81_), .d(new_n84_), .O(z18));
  nor2   g124(.a(x40), .b(x35), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n95_), .c(new_n146_), .O(new_n188_));
  nand2  g126(.a(new_n138_), .b(new_n86_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n181_), .O(new_n190_));
  inv1   g128(.a(x08), .O(new_n191_));
  nand2  g129(.a(x35), .b(x27), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(x04), .c(new_n191_), .O(new_n193_));
  nand2  g131(.a(new_n135_), .b(new_n66_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(x40), .O(new_n196_));
  nand2  g134(.a(x28), .b(new_n191_), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n196_), .c(new_n190_), .d(new_n188_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n84_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(x09), .c(new_n81_), .O(z19));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(new_n137_), .O(new_n202_));
  nand2  g140(.a(x40), .b(new_n66_), .O(new_n203_));
  aoi21  g141(.a(new_n203_), .b(new_n131_), .c(x08), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n84_), .O(new_n205_));
