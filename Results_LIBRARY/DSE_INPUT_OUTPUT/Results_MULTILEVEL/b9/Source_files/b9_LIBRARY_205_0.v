...
module FAU ( 
  ...
  oai21  g030(.a(new_n82_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  ...
  nor2   g071(.a(new_n67_), .b(x28), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n76_), .O(new_n137_));
  nand3  g075(.a(new_n134_), .b(x27), .c(new_n66_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n92_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n83_), .c(x29), .d(new_n133_), .O(new_n141_));
  ...
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n63_), .O(z12));
  ...
  nor3   g095(.a(new_n126_), .b(new_n117_), .c(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n66_), .c(new_n63_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  nand3  g098(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n161_));
  inv1   g099(.a(x32), .O(new_n162_));
  nand4  g100(.a(new_n150_), .b(new_n162_), .c(new_n83_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n77_), .b(new_n149_), .c(new_n66_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n161_), .O(new_n166_));
  nand3  g104(.a(new_n71_), .b(new_n67_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x27), .c(x32), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n82_), .c(new_n83_), .O(new_n169_));
  nand2  g107(.a(new_n165_), .b(new_n146_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n166_), .O(z14));
  inv1   g109(.a(x12), .O(new_n172_));
  nand4  g110(.a(new_n90_), .b(x34), .c(x27), .d(x26), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n172_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x22), .c(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n90_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n90_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(z17));
  oai21  g119(.a(new_n85_), .b(x27), .c(new_n76_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(x30), .b(new_n82_), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n138_), .d(new_n133_), .O(z18));
  aoi21  g123(.a(new_n67_), .b(x29), .c(x28), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n135_), .c(new_n77_), .O(new_n187_));
  oai21  g125(.a(new_n67_), .b(new_n65_), .c(x29), .O(new_n188_));
  nor2   g126(.a(x28), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(x08), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n187_), .c(new_n133_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(x29), .c(x30), .O(z19));
  oai21  g130(.a(new_n67_), .b(new_n65_), .c(new_n92_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n77_), .c(new_n193_), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n83_), .c(x29), .d(new_n133_), .O(new_n196_));
