...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(x23), .d(new_n66_), .O(new_n77_));
  ...
  oai21  g029(.a(new_n91_), .b(new_n88_), .c(x23), .O(new_n92_));
  ...
  nand3  g037(.a(new_n99_), .b(new_n64_), .c(new_n69_), .O(z05));
  ...
  aoi21  g051(.a(new_n113_), .b(x23), .c(new_n74_), .O(z08));
  ...
  nand4  g056(.a(x40), .b(x39), .c(x23), .d(x05), .O(new_n119_));
  oai21  g057(.a(z08), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n84_), .c(new_n117_), .O(new_n121_));
  nand3  g059(.a(new_n64_), .b(x37), .c(x06), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x27), .O(new_n124_));
  nand2  g062(.a(new_n80_), .b(new_n79_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x40), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(new_n113_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(x23), .c(x05), .d(new_n117_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n124_), .O(z10));
  inv1   g067(.a(x08), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x04), .O(new_n131_));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(new_n79_), .b(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n131_), .c(x23), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x40), .O(new_n135_));
  nor2   g073(.a(new_n74_), .b(new_n113_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x29), .O(new_n137_));
  inv1   g075(.a(new_n83_), .O(new_n138_));
  ...
  oai21  g079(.a(new_n83_), .b(new_n68_), .c(new_n130_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n79_), .c(new_n132_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n135_), .O(z11));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n69_), .b(new_n81_), .c(new_n146_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x27), .c(x10), .O(new_n148_));
  aoi21  g086(.a(x39), .b(new_n117_), .c(new_n71_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(x23), .O(new_n150_));
  oai21  g088(.a(new_n71_), .b(x40), .c(new_n150_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n74_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n117_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(new_n68_), .O(new_n160_));
  nand4  g098(.a(new_n125_), .b(x39), .c(new_n152_), .d(new_n117_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(x23), .c(new_n74_), .O(new_n162_));
  or2    g100(.a(new_n162_), .b(new_n160_), .O(z13));
  nand3  g101(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n164_));
  nand4  g102(.a(new_n153_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n136_), .b(new_n152_), .c(new_n117_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n69_), .b(new_n146_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n80_), .c(new_n79_), .O(new_n171_));
  inv1   g109(.a(new_n71_), .O(new_n172_));
  aoi21  g110(.a(new_n167_), .b(new_n172_), .c(new_n65_), .O(new_n173_));
  ...
  nand4  g114(.a(new_n74_), .b(new_n63_), .c(x22), .d(x01), .O(new_n177_));
  ...
  nand2  g119(.a(x27), .b(new_n117_), .O(new_n182_));
  nand2  g120(.a(new_n68_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n146_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n82_), .c(new_n133_), .O(new_n185_));
  inv1   g123(.a(new_n137_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(x23), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n185_), .b(new_n65_), .c(new_n187_), .O(z18));
  nand2  g126(.a(new_n64_), .b(new_n68_), .O(new_n189_));
  nand2  g127(.a(x40), .b(x04), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(x35), .c(new_n82_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x23), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n189_), .c(x08), .O(new_n193_));
  nand2  g131(.a(x39), .b(x29), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(x23), .c(new_n74_), .O(new_n195_));
  aoi21  g133(.a(new_n139_), .b(new_n138_), .c(new_n195_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n79_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(x09), .O(z19));
  oai21  g136(.a(new_n146_), .b(new_n68_), .c(new_n130_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n68_), .c(new_n146_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n186_), .c(new_n199_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n79_), .c(new_n132_), .O(new_n202_));
