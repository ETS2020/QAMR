...
module FAU ( 
  ...
  nand2  g016(.a(x30), .b(x04), .O(new_n79_));
  ...
  oai21  g030(.a(x27), .b(x08), .c(new_n84_), .O(new_n93_));
  nand2  g031(.a(x35), .b(new_n82_), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n93_), .c(x04), .O(new_n95_));
  nand3  g033(.a(new_n95_), .b(new_n92_), .c(new_n75_), .O(z02));
  ...
  nand3  g056(.a(new_n79_), .b(x40), .c(x39), .O(new_n119_));
  ...
  nand3  g067(.a(new_n75_), .b(x32), .c(x05), .O(new_n130_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n82_), .c(new_n135_), .O(new_n143_));
  ...
  oai21  g086(.a(new_n126_), .b(x04), .c(new_n148_), .O(new_n149_));
  ...
  oai21  g098(.a(new_n83_), .b(x04), .c(new_n82_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x40), .c(x39), .d(new_n151_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n160_), .c(new_n79_), .O(z13));
  nand3  g101(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n164_));
  nand4  g102(.a(new_n153_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand3  g104(.a(new_n75_), .b(new_n151_), .c(new_n65_), .O(new_n167_));
  ...
  aoi21  g109(.a(new_n167_), .b(new_n148_), .c(new_n97_), .O(new_n172_));
  ...
  oai21  g121(.a(new_n85_), .b(new_n64_), .c(new_n82_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n65_), .O(new_n185_));
  nand3  g123(.a(x35), .b(new_n84_), .c(new_n64_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n136_), .c(new_n139_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(x09), .c(new_n82_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n185_), .O(z18));
  ...
  nand3  g131(.a(new_n193_), .b(new_n82_), .c(new_n135_), .O(new_n194_));
