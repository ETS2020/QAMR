...
module FAU ( 
  ...
  wire new_n63_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_,
    ...
    new_n139_, new_n141_, new_n143_, new_n144_, new_n145_;
  ...
  nand2  g18(.a(new_n81_), .b(new_n66_), .O(new_n82_));
  nand4  g19(.a(new_n82_), .b(new_n80_), .c(new_n63_), .d(x21), .O(z03));
  aoi21  g20(.a(new_n81_), .b(new_n66_), .c(x21), .O(new_n84_));
  aoi21  g21(.a(new_n84_), .b(new_n80_), .c(z08), .O(z04));
  oai21  g22(.a(new_n79_), .b(new_n66_), .c(new_n81_), .O(new_n86_));
  ...
  nand2  g50(.a(new_n66_), .b(new_n113_), .O(new_n114_));
  nand4  g51(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n79_), .O(new_n115_));
  nand3  g52(.a(new_n115_), .b(new_n71_), .c(new_n111_), .O(new_n116_));
  nand2  g53(.a(new_n116_), .b(new_n63_), .O(z11));
  inv1   g54(.a(new_n67_), .O(new_n118_));
  nand3  g55(.a(new_n118_), .b(new_n63_), .c(x27), .O(z12));
  ...
  aoi21  g62(.a(new_n125_), .b(new_n118_), .c(z08), .O(z14));
  inv1   g63(.a(x12), .O(new_n127_));
  nor2   g64(.a(new_n103_), .b(new_n127_), .O(z15));
  inv1   g65(.a(x23), .O(new_n129_));
  nand3  g66(.a(new_n129_), .b(x22), .c(x01), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(new_n63_), .O(z16));
  inv1   g68(.a(x01), .O(new_n132_));
  inv1   g69(.a(x24), .O(new_n133_));
  nand4  g70(.a(new_n63_), .b(new_n133_), .c(x23), .d(x22), .O(new_n134_));
  nor2   g71(.a(new_n134_), .b(new_n132_), .O(z17));
  nand2  g72(.a(x27), .b(new_n105_), .O(new_n136_));
  oai21  g73(.a(x27), .b(new_n113_), .c(new_n136_), .O(new_n137_));
  nand3  g74(.a(new_n137_), .b(x35), .c(new_n79_), .O(new_n138_));
  nor2   g75(.a(x30), .b(x09), .O(new_n139_));
  aoi21  g76(.a(new_n139_), .b(new_n138_), .c(z08), .O(z18));
  nand4  g77(.a(new_n115_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(new_n141_));
  inv1   g78(.a(new_n141_), .O(z19));
  oai21  g79(.a(x28), .b(new_n113_), .c(new_n66_), .O(new_n143_));
  nand2  g80(.a(new_n143_), .b(x35), .O(new_n144_));
  nand3  g81(.a(new_n144_), .b(new_n71_), .c(new_n111_), .O(new_n145_));
  nand2  g82(.a(new_n145_), .b(new_n63_), .O(z20));
  one    g83(.O(z02));
endmodule
