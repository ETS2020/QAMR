...
module FAU ( 
  ...
  nor2   g001(.a(x19), .b(new_n63_), .O(new_n64_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n89_), .c(new_n64_), .O(z02));
  nand2  g034(.a(new_n68_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi21  g036(.a(new_n67_), .b(new_n91_), .c(new_n98_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n97_), .c(new_n64_), .O(z03));
  aoi21  g038(.a(new_n67_), .b(new_n91_), .c(x21), .O(new_n101_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n91_), .c(new_n63_), .O(new_n144_));
  oai21  g082(.a(new_n94_), .b(x04), .c(new_n70_), .O(new_n145_));
  ...
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n147_), .d(new_n123_), .O(new_n151_));
  ...
  nand3  g094(.a(new_n128_), .b(x40), .c(x39), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n123_), .c(new_n64_), .O(new_n159_));
  ...
  oai21  g123(.a(new_n166_), .b(new_n91_), .c(new_n90_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n91_), .c(new_n166_), .O(new_n187_));
