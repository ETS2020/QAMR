...
module FAU ( 
  ...
  oai21  g033(.a(x40), .b(new_n88_), .c(new_n95_), .O(z02));
  ...
  nor2   g073(.a(new_n99_), .b(new_n71_), .O(new_n136_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n99_), .c(new_n73_), .O(new_n145_));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n74_), .O(new_n155_));
  nand4  g093(.a(new_n67_), .b(x22), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n128_), .b(new_n148_), .c(new_n71_), .O(new_n159_));
  ...
  nand3  g101(.a(z08), .b(new_n148_), .c(new_n71_), .O(new_n164_));
  ...
  nand2  g116(.a(new_n99_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n139_), .c(new_n166_), .O(new_n180_));
  nand2  g118(.a(new_n79_), .b(new_n134_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(new_n82_), .c(new_n181_), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n63_), .c(new_n118_), .d(new_n90_), .O(z18));
  inv1   g121(.a(new_n135_), .O(new_n184_));
  oai21  g122(.a(new_n166_), .b(new_n99_), .c(new_n138_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n99_), .c(new_n166_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n79_), .c(new_n134_), .O(new_n188_));
