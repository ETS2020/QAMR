...
module FAU ( 
  ...
  oai21  g059(.a(new_n121_), .b(new_n77_), .c(x12), .O(new_n122_));
  ...
  nor2   g095(.a(new_n155_), .b(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand2  g097(.a(x30), .b(x12), .O(new_n160_));
  nand2  g098(.a(x32), .b(new_n63_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n160_), .c(new_n117_), .O(new_n162_));
  ...
  nand4  g103(.a(new_n150_), .b(new_n84_), .c(new_n63_), .d(x28), .O(new_n166_));
  ...
  nand4  g119(.a(new_n83_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  ...
  nand4  g124(.a(new_n186_), .b(new_n138_), .c(new_n63_), .d(new_n133_), .O(z18));
