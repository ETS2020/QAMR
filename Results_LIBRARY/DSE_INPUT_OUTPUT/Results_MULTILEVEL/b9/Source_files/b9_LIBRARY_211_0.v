...
module FAU ( 
  ...
  nor2   g018(.a(x10), .b(x09), .O(new_n81_));
  ...
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n84_), .d(new_n76_), .O(z02));
  nand2  g036(.a(new_n71_), .b(x27), .O(new_n99_));
  nand2  g037(.a(new_n70_), .b(new_n64_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n99_), .c(new_n84_), .d(x21), .O(z03));
  inv1   g039(.a(x21), .O(new_n102_));
  nand4  g040(.a(new_n100_), .b(new_n99_), .c(new_n84_), .d(new_n102_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n81_), .O(z05));
  nand3  g043(.a(new_n104_), .b(new_n84_), .c(new_n70_), .O(new_n106_));
  ...
  nand2  g056(.a(new_n118_), .b(new_n84_), .O(z07));
  nand2  g057(.a(new_n84_), .b(new_n75_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n84_), .O(z09));
  ...
  nand2  g064(.a(new_n86_), .b(new_n85_), .O(new_n127_));
  ...
  nand3  g084(.a(new_n146_), .b(x27), .c(x09), .O(new_n147_));
  ...
  aoi21  g109(.a(new_n167_), .b(new_n143_), .c(new_n81_), .O(new_n172_));
  ...
  nand4  g118(.a(new_n84_), .b(new_n180_), .c(x23), .d(x22), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n179_), .O(z17));
  oai21  g120(.a(new_n88_), .b(x27), .c(new_n134_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n145_), .b(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n138_), .d(new_n85_), .O(z18));
  ...
  nand2  g128(.a(new_n190_), .b(new_n85_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(x10), .c(x09), .O(z20));
  inv1   g130(.a(new_n141_), .O(z19));
endmodule
