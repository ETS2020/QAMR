...
module FAU ( 
  ...
  nor2   g001(.a(x37), .b(x14), .O(new_n64_));
  ...
  oai21  g016(.a(new_n78_), .b(x15), .c(new_n69_), .O(z00));
  ...
  aoi21  g028(.a(new_n90_), .b(x04), .c(new_n67_), .O(new_n91_));
  ...
  oai21  g033(.a(new_n94_), .b(new_n70_), .c(new_n95_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n93_), .c(x21), .O(z03));
  nand2  g035(.a(new_n96_), .b(x21), .O(new_n98_));
  nand3  g036(.a(new_n76_), .b(new_n65_), .c(x27), .O(new_n99_));
  nand3  g037(.a(new_n95_), .b(new_n94_), .c(x14), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n99_), .c(new_n98_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n95_), .c(x14), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n95_), .c(x14), .O(new_n104_));
  ...
  nand4  g050(.a(new_n112_), .b(new_n108_), .c(new_n107_), .d(x14), .O(new_n113_));
  inv1   g051(.a(x00), .O(new_n114_));
  nand3  g052(.a(x38), .b(new_n110_), .c(new_n114_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x37), .c(new_n70_), .O(new_n116_));
  ...
  nand2  g061(.a(new_n67_), .b(x07), .O(new_n124_));
  oai21  g062(.a(new_n67_), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n65_), .c(new_n71_), .O(new_n131_));
  ...
  oai21  g096(.a(new_n158_), .b(x04), .c(new_n154_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x27), .O(new_n160_));
  nor3   g098(.a(new_n127_), .b(new_n64_), .c(new_n119_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n155_), .d(new_n71_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(z13));
  nand3  g101(.a(new_n135_), .b(new_n155_), .c(new_n71_), .O(new_n164_));
  nor2   g102(.a(x19), .b(x18), .O(new_n165_));
  and2   g103(.a(x27), .b(x20), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n165_), .c(new_n64_), .O(new_n167_));
  nand2  g105(.a(new_n148_), .b(x14), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(new_n164_), .O(new_n170_));
  nand3  g108(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n73_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n171_), .b(x37), .O(new_n175_));
  nand2  g113(.a(new_n95_), .b(x14), .O(new_n176_));
  ...
  nand2  g118(.a(new_n180_), .b(new_n170_), .O(z14));
  ...
  nand2  g128(.a(new_n89_), .b(new_n94_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n136_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n64_), .b(x30), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n193_), .c(new_n141_), .d(new_n134_), .O(z18));
  inv1   g133(.a(new_n136_), .O(new_n196_));
  oai21  g134(.a(new_n72_), .b(new_n94_), .c(new_n140_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n94_), .c(new_n72_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n134_), .O(new_n200_));
