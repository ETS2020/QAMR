...
module FAU ( 
  ...
  nand3  g031(.a(new_n93_), .b(new_n90_), .c(x40), .O(new_n94_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n99_), .c(new_n78_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n79_), .c(new_n70_), .O(z05));
  ...
  aoi21  g062(.a(new_n124_), .b(new_n123_), .c(new_n84_), .O(new_n125_));
  inv1   g063(.a(x06), .O(new_n126_));
  nor3   g064(.a(new_n78_), .b(new_n70_), .c(new_n126_), .O(new_n127_));
  ...
  oai21  g076(.a(new_n118_), .b(new_n136_), .c(new_n138_), .O(new_n139_));
  ...
  nand2  g082(.a(new_n144_), .b(new_n79_), .O(z11));
  ...
  oai21  g087(.a(new_n118_), .b(x04), .c(new_n149_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n79_), .O(z12));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n78_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n161_), .O(z13));
  inv1   g102(.a(new_n97_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n166_));
  nand4  g104(.a(new_n154_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x40), .b(new_n152_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n96_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n165_), .c(new_n166_), .O(new_n171_));
  ...
  nand3  g115(.a(new_n149_), .b(x40), .c(new_n96_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n171_), .O(z14));
  nand4  g117(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n79_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand4  g120(.a(new_n79_), .b(new_n182_), .c(x22), .d(x01), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z16));
  inv1   g122(.a(x01), .O(new_n185_));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n79_), .b(new_n186_), .c(x23), .d(x22), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n185_), .O(z17));
  nand2  g126(.a(new_n64_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n141_), .c(new_n66_), .O(new_n190_));
  nand2  g128(.a(new_n81_), .b(new_n135_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n83_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n78_), .c(new_n89_), .d(new_n118_), .O(z18));
  oai21  g131(.a(x40), .b(x39), .c(new_n64_), .O(new_n194_));
  oai21  g132(.a(new_n66_), .b(x04), .c(x39), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n194_), .c(new_n83_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n140_), .O(new_n197_));
  nand2  g135(.a(x40), .b(x29), .O(new_n198_));
  nand2  g136(.a(x39), .b(new_n66_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n137_), .c(new_n83_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n198_), .O(new_n201_));
  nand2  g139(.a(x40), .b(new_n66_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n137_), .c(new_n83_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n96_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n201_), .c(new_n197_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n81_), .c(new_n135_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n79_), .O(z19));
  nand2  g145(.a(x28), .b(new_n64_), .O(new_n208_));
  nand2  g146(.a(new_n198_), .b(x39), .O(new_n209_));
  aoi22  g147(.a(new_n209_), .b(new_n97_), .c(new_n208_), .d(x35), .O(new_n210_));
  aoi21  g148(.a(new_n199_), .b(new_n194_), .c(x08), .O(new_n211_));
  oai21  g149(.a(new_n211_), .b(new_n210_), .c(new_n81_), .O(new_n212_));
