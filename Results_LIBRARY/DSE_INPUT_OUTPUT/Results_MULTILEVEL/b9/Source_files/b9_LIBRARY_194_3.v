...
module FAU ( 
  ...
  nand2  g017(.a(x38), .b(x30), .O(new_n80_));
  ...
  nand3  g048(.a(new_n84_), .b(new_n110_), .c(x00), .O(new_n111_));
  ...
  nor2   g052(.a(x25), .b(x00), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(x30), .c(x38), .O(new_n116_));
  ...
  nand3  g060(.a(new_n76_), .b(x05), .c(new_n65_), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(new_n124_));
  oai21  g062(.a(new_n124_), .b(x38), .c(x30), .O(new_n125_));
  ...
  nand4  g104(.a(new_n153_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n167_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n148_), .c(new_n83_), .O(new_n174_));
  ...
  nand4  g123(.a(new_n185_), .b(new_n140_), .c(new_n84_), .d(new_n135_), .O(z18));
  nand2  g124(.a(new_n143_), .b(new_n80_), .O(z19));
  ...
  nand3  g129(.a(new_n191_), .b(new_n84_), .c(new_n135_), .O(new_n192_));
