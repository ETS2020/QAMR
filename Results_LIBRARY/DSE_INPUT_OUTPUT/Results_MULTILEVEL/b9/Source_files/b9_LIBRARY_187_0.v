...
module FAU ( 
  ...
  nand2  g070(.a(new_n79_), .b(new_n66_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n90_), .c(new_n71_), .O(new_n134_));
  ...
  nand3  g081(.a(new_n67_), .b(new_n143_), .c(new_n82_), .O(new_n144_));
  ...
  nand3  g086(.a(new_n148_), .b(x40), .c(new_n78_), .O(new_n149_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n154_), .c(new_n78_), .O(new_n159_));
  ...
  nand3  g100(.a(new_n130_), .b(new_n151_), .c(new_n71_), .O(new_n163_));
  ...
  nand4  g104(.a(new_n152_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x40), .b(new_n151_), .c(new_n71_), .O(new_n168_));
  ...
  nand2  g124(.a(new_n186_), .b(new_n79_), .O(z17));
  ...
  aoi21  g130(.a(new_n190_), .b(new_n90_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n63_), .c(new_n117_), .d(new_n88_), .O(z18));
  inv1   g132(.a(x08), .O(new_n195_));
  oai21  g133(.a(new_n82_), .b(new_n66_), .c(new_n195_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n66_), .c(new_n82_), .O(new_n197_));
  nand2  g135(.a(z08), .b(x29), .O(new_n198_));
  inv1   g136(.a(new_n198_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n196_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n191_), .O(new_n201_));
