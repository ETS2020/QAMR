...
module FAU ( 
  ...
  nand4  g103(.a(new_n153_), .b(new_n87_), .c(new_n86_), .d(x28), .O(new_n166_));
  ...
  nand3  g109(.a(new_n171_), .b(new_n87_), .c(new_n86_), .O(new_n172_));
  ...
  nand4  g117(.a(new_n81_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n85_), .O(z17));
  oai21  g119(.a(new_n89_), .b(x27), .c(new_n137_), .O(new_n182_));
  nand3  g120(.a(new_n140_), .b(new_n86_), .c(new_n136_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(x08), .c(new_n183_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n82_), .O(z18));
  inv1   g123(.a(new_n137_), .O(new_n186_));
  oai21  g124(.a(new_n66_), .b(new_n64_), .c(new_n97_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n85_), .c(new_n86_), .d(new_n136_), .O(new_n190_));
