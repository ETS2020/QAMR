...
module FAU ( 
  ...
  aoi21  g035(.a(new_n65_), .b(new_n97_), .c(new_n79_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n120_), .b(new_n85_), .c(new_n71_), .O(new_n121_));
  ...
  nor2   g067(.a(new_n74_), .b(new_n91_), .O(new_n130_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n80_), .c(new_n129_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n64_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n97_), .c(new_n73_), .O(new_n144_));
  ...
  nand4  g092(.a(new_n67_), .b(new_n74_), .c(x20), .d(new_n152_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand3  g095(.a(new_n126_), .b(new_n147_), .c(new_n71_), .O(new_n158_));
  ...
  oai21  g100(.a(new_n160_), .b(new_n74_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n83_), .c(x27), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n163_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  nand4  g108(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n171_));
  ...
  oai21  g117(.a(new_n84_), .b(x27), .c(new_n131_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n97_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n133_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g122(.a(x39), .b(new_n91_), .c(new_n74_), .O(new_n185_));
  aoi21  g123(.a(new_n134_), .b(new_n133_), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n64_), .b(new_n97_), .O(new_n187_));
  nand3  g125(.a(new_n137_), .b(x35), .c(new_n83_), .O(new_n188_));
  ...
  oai21  g130(.a(new_n132_), .b(new_n97_), .c(new_n90_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n97_), .c(new_n132_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n130_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n80_), .c(new_n129_), .O(new_n196_));
