...
module FAU ( 
  ...
  nor2   g031(.a(new_n63_), .b(new_n93_), .O(new_n94_));
  ...
  nor2   g058(.a(x40), .b(x17), .O(new_n121_));
  aoi21  g059(.a(x40), .b(new_n93_), .c(new_n121_), .O(new_n122_));
  ...
  oai21  g088(.a(new_n150_), .b(x17), .c(new_n148_), .O(z12));
  ...
  nor2   g098(.a(new_n159_), .b(x17), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n160_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n130_), .b(new_n152_), .c(new_n73_), .O(new_n163_));
  ...
  nand3  g105(.a(new_n94_), .b(new_n152_), .c(new_n73_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  nand3  g107(.a(new_n69_), .b(new_n144_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n149_), .c(new_n65_), .O(new_n173_));
  ...
  nand2  g121(.a(x27), .b(new_n73_), .O(new_n184_));
  nand2  g122(.a(new_n68_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(new_n144_), .O(new_n186_));
  inv1   g124(.a(x09), .O(new_n187_));
  nand2  g125(.a(new_n79_), .b(new_n187_), .O(new_n188_));
  aoi21  g126(.a(new_n186_), .b(new_n82_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n65_), .c(new_n116_), .d(new_n89_), .O(z18));
  nand2  g128(.a(new_n94_), .b(x29), .O(new_n191_));
  inv1   g129(.a(new_n191_), .O(new_n192_));
  inv1   g130(.a(x08), .O(new_n193_));
  oai21  g131(.a(new_n184_), .b(new_n83_), .c(new_n193_), .O(new_n194_));
  oai21  g132(.a(new_n192_), .b(new_n140_), .c(new_n194_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n79_), .c(new_n187_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n64_), .O(z19));
  oai21  g135(.a(new_n144_), .b(new_n68_), .c(new_n193_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n144_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n192_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n187_), .O(new_n201_));
