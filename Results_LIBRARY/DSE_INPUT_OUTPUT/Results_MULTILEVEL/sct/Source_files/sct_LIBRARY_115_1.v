...
module FAU ( 
  ...
  oai21  g28(.a(x17), .b(x09), .c(new_n57_), .O(new_n63_));
  ...
  oai21  g36(.a(x17), .b(x10), .c(new_n57_), .O(new_n71_));
  ...
  nand3  g46(.a(new_n35_), .b(x10), .c(new_n57_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n72_), .O(z06));
  oai21  g48(.a(x17), .b(x11), .c(new_n57_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n51_), .O(new_n84_));
  and2   g50(.a(new_n78_), .b(x11), .O(new_n85_));
  nor4   g51(.a(new_n64_), .b(x11), .c(x10), .d(x09), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n85_), .c(x06), .O(new_n87_));
  nand3  g53(.a(new_n35_), .b(x11), .c(new_n57_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n84_), .O(z07));
  oai21  g55(.a(x17), .b(x12), .c(new_n57_), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  or2    g57(.a(new_n86_), .b(new_n91_), .O(new_n92_));
  inv1   g58(.a(x11), .O(new_n93_));
  nand4  g59(.a(new_n91_), .b(new_n93_), .c(new_n76_), .d(new_n75_), .O(new_n94_));
  nor3   g60(.a(new_n94_), .b(new_n64_), .c(new_n57_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(new_n44_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n92_), .c(new_n90_), .d(new_n50_), .O(z08));
  oai21  g63(.a(x17), .b(x13), .c(new_n57_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n51_), .O(new_n99_));
  nand3  g65(.a(new_n91_), .b(new_n93_), .c(new_n76_), .O(new_n100_));
  ...
  nand3  g71(.a(new_n35_), .b(x13), .c(new_n57_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n105_), .c(new_n99_), .O(z09));
  inv1   g73(.a(x00), .O(new_n108_));
  aoi21  g74(.a(new_n103_), .b(new_n108_), .c(new_n49_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n75_), .c(x08), .d(x07), .O(new_n110_));
  nand2  g76(.a(new_n49_), .b(x14), .O(new_n111_));
  oai21  g77(.a(new_n110_), .b(new_n57_), .c(new_n111_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n53_), .O(z10));
  nand2  g80(.a(new_n53_), .b(new_n37_), .O(z11));
  aoi21  g81(.a(x16), .b(new_n37_), .c(x03), .O(new_n116_));
  oai21  g82(.a(new_n116_), .b(new_n44_), .c(new_n53_), .O(z12));
  nand2  g83(.a(new_n53_), .b(new_n44_), .O(z13));
  aoi21  g84(.a(x06), .b(new_n44_), .c(new_n35_), .O(z14));
endmodule
