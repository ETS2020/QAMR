...
module FAU ( 
  ...
  nand3  g08(.a(x06), .b(x05), .c(new_n42_), .O(new_n43_));
  ...
  oai21  g26(.a(x09), .b(x05), .c(new_n55_), .O(new_n61_));
  inv1   g27(.a(x07), .O(new_n62_));
  inv1   g28(.a(x08), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(new_n62_), .c(x09), .O(new_n64_));
  nor2   g30(.a(new_n62_), .b(new_n55_), .O(new_n65_));
  nor2   g31(.a(x09), .b(new_n63_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n65_), .c(new_n42_), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n64_), .c(new_n61_), .d(new_n48_), .O(z05));
  oai21  g34(.a(x10), .b(x05), .c(new_n55_), .O(new_n69_));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n65_), .c(new_n42_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n69_), .d(new_n48_), .O(z06));
  oai21  g42(.a(x11), .b(x05), .c(new_n55_), .O(new_n77_));
  nor2   g43(.a(new_n63_), .b(new_n62_), .O(new_n78_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n77_), .d(new_n48_), .O(z07));
  oai21  g51(.a(x12), .b(x05), .c(new_n55_), .O(new_n86_));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n82_), .c(new_n42_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n88_), .c(new_n86_), .d(new_n48_), .O(z08));
  oai21  g60(.a(x13), .b(x05), .c(new_n55_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n49_), .O(new_n96_));
  ...
  nand3  g69(.a(x13), .b(new_n55_), .c(new_n36_), .O(new_n104_));
  ...
  oai21  g76(.a(new_n109_), .b(new_n55_), .c(new_n110_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n51_), .O(z10));
  nor2   g79(.a(new_n37_), .b(new_n35_), .O(z11));
  oai21  g80(.a(new_n46_), .b(x02), .c(new_n45_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n51_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nor2   g83(.a(new_n37_), .b(new_n42_), .O(z13));
