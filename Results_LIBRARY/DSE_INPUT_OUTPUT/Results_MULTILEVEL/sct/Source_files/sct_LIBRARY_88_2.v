...
module FAU ( 
  ...
  nand3  g15(.a(x07), .b(new_n49_), .c(new_n35_), .O(new_n50_));
  ...
  nand3  g20(.a(x08), .b(new_n49_), .c(new_n35_), .O(new_n55_));
  ...
  oai21  g24(.a(x09), .b(x05), .c(new_n49_), .O(new_n59_));
  ...
  nand4  g32(.a(new_n66_), .b(new_n62_), .c(new_n59_), .d(new_n46_), .O(z05));
  oai21  g33(.a(x10), .b(x05), .c(new_n49_), .O(new_n68_));
  ...
  nand3  g38(.a(new_n60_), .b(new_n72_), .c(new_n63_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x06), .O(new_n75_));
  nand3  g41(.a(x10), .b(new_n49_), .c(new_n35_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(z06));
  oai21  g43(.a(x11), .b(x05), .c(new_n49_), .O(new_n78_));
  nand2  g44(.a(new_n73_), .b(x11), .O(new_n79_));
  nand2  g45(.a(new_n60_), .b(x06), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n72_), .c(new_n63_), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n81_), .c(new_n43_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n79_), .c(new_n78_), .d(new_n46_), .O(z07));
  oai21  g52(.a(x12), .b(x05), .c(new_n49_), .O(new_n87_));
  oai21  g53(.a(new_n83_), .b(new_n61_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n82_), .c(new_n72_), .d(new_n63_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n81_), .c(new_n43_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(z08));
  oai21  g59(.a(x13), .b(x05), .c(new_n49_), .O(new_n94_));
  nand3  g60(.a(new_n89_), .b(new_n82_), .c(new_n72_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n70_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n89_), .c(new_n82_), .d(new_n72_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n65_), .c(new_n43_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n94_), .d(new_n46_), .O(z09));
  inv1   g67(.a(x07), .O(new_n102_));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n98_), .b(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n46_), .c(new_n63_), .d(x08), .O(new_n105_));
  ...
  nand3  g82(.a(new_n116_), .b(new_n113_), .c(x04), .O(new_n117_));
  inv1   g83(.a(new_n117_), .O(z12));
  nand2  g84(.a(new_n113_), .b(new_n43_), .O(z13));
  nand2  g85(.a(x17), .b(x04), .O(new_n120_));
  nand2  g86(.a(new_n120_), .b(new_n113_), .O(z14));
endmodule
