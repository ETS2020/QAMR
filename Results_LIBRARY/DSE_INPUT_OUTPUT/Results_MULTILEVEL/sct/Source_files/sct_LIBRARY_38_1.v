...
module FAU ( 
  ...
  oai21  g06(.a(x07), .b(x05), .c(new_n36_), .O(new_n41_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n68_), .c(new_n46_), .d(x04), .O(z07));
  nor2   g38(.a(x12), .b(new_n36_), .O(new_n73_));
  nand2  g39(.a(new_n70_), .b(new_n61_), .O(new_n74_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n76_), .c(new_n46_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(new_n81_));
  oai21  g47(.a(new_n73_), .b(x07), .c(new_n81_), .O(z08));
  nand2  g48(.a(new_n79_), .b(x13), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n78_), .c(new_n77_), .d(new_n84_), .O(new_n86_));
  or2    g52(.a(new_n86_), .b(new_n62_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n83_), .c(new_n46_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n86_), .b(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n46_), .c(new_n61_), .d(x08), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n45_), .c(x04), .O(new_n92_));
  ...
  oai21  g64(.a(new_n98_), .b(new_n36_), .c(new_n37_), .O(z12));
