...
module FAU ( 
  ...
  nand4  g18(.a(new_n48_), .b(x08), .c(new_n36_), .d(x04), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(z04));
  nor2   g20(.a(x09), .b(x06), .O(new_n55_));
  ...
  oai21  g31(.a(new_n59_), .b(x13), .c(new_n36_), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n57_), .c(new_n35_), .O(z12));
