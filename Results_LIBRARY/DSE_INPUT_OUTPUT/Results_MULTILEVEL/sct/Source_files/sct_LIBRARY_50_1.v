...
module FAU ( 
  ...
  oai21  g27(.a(x09), .b(x06), .c(new_n35_), .O(new_n62_));
  ...
  oai21  g50(.a(new_n84_), .b(new_n81_), .c(x01), .O(new_n85_));
  ...
  oai21  g57(.a(new_n91_), .b(new_n89_), .c(x01), .O(new_n92_));
  nand2  g58(.a(x12), .b(new_n39_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n71_), .O(z08));
  oai21  g60(.a(x13), .b(x06), .c(new_n35_), .O(new_n95_));
