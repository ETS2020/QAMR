...
module FAU ( 
  ...
  oai21  g28(.a(x10), .b(new_n36_), .c(new_n45_), .O(new_n63_));
  ...
  oai21  g36(.a(x11), .b(new_n36_), .c(new_n45_), .O(new_n71_));
  ...
  oai21  g45(.a(x12), .b(new_n36_), .c(new_n45_), .O(new_n80_));
  nand2  g46(.a(x08), .b(x07), .O(new_n81_));
  nand2  g47(.a(new_n75_), .b(new_n60_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n81_), .c(x12), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n66_), .b(new_n74_), .c(new_n85_), .d(new_n84_), .O(new_n86_));
  ...
  or2    g59(.a(new_n93_), .b(new_n61_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n46_), .d(x04), .O(z09));
