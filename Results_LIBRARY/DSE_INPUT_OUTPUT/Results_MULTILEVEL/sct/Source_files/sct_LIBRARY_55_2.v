...
module FAU ( 
  ...
  oai21  g02(.a(x12), .b(new_n35_), .c(new_n36_), .O(new_n37_));
  ...
  nand2  g09(.a(new_n36_), .b(x12), .O(new_n44_));
  ...
  nand4  g14(.a(new_n48_), .b(new_n44_), .c(new_n46_), .d(x04), .O(new_n49_));
  ...
  nand4  g22(.a(new_n56_), .b(new_n48_), .c(new_n44_), .d(x04), .O(new_n57_));
  ...
  and2   g29(.a(new_n63_), .b(new_n44_), .O(z05));
  nor2   g30(.a(x10), .b(x09), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n44_), .c(x04), .O(new_n67_));
  ...
  aoi21  g41(.a(new_n66_), .b(x11), .c(new_n75_), .O(new_n76_));
  aoi21  g42(.a(new_n76_), .b(new_n48_), .c(new_n70_), .O(z07));
  inv1   g43(.a(new_n48_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n42_), .c(new_n44_), .O(new_n79_));
  nand3  g45(.a(new_n74_), .b(x14), .c(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n65_), .b(new_n73_), .c(new_n81_), .d(new_n72_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .O(z08));
  oai21  g49(.a(new_n36_), .b(x13), .c(x12), .O(new_n84_));
  oai21  g50(.a(new_n78_), .b(new_n42_), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n74_), .b(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n65_), .b(new_n73_), .c(new_n87_), .d(new_n72_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n81_), .O(new_n90_));
  nand3  g56(.a(x14), .b(x13), .c(x12), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n85_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand3  g59(.a(new_n87_), .b(new_n72_), .c(new_n71_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n48_), .c(new_n81_), .O(new_n96_));
  nand2  g62(.a(x14), .b(x00), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(x09), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(x08), .c(x07), .d(x06), .O(new_n99_));
  nand2  g65(.a(new_n78_), .b(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n42_), .O(z10));
  nor2   g67(.a(new_n70_), .b(new_n47_), .O(z11));
  ...
  nor2   g73(.a(new_n70_), .b(new_n42_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n44_), .O(z14));
endmodule
