...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n46_), .c(new_n63_), .O(new_n65_));
  aoi21  g31(.a(x08), .b(x07), .c(x12), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n35_), .c(x09), .O(new_n67_));
  nor2   g33(.a(x12), .b(x09), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(x08), .c(x07), .d(x06), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .O(z05));
  ...
  nand4  g44(.a(new_n78_), .b(new_n36_), .c(new_n76_), .d(new_n71_), .O(new_n79_));
  ...
  oai21  g48(.a(new_n82_), .b(new_n72_), .c(new_n36_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  aoi21  g50(.a(new_n79_), .b(x11), .c(new_n46_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n49_), .O(z07));
  inv1   g52(.a(x11), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n76_), .c(new_n71_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n77_), .c(x04), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n64_), .c(new_n36_), .O(new_n90_));
  oai21  g56(.a(new_n36_), .b(x06), .c(new_n90_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n87_), .c(new_n76_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n72_), .c(new_n36_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand3  g61(.a(new_n81_), .b(new_n76_), .c(new_n71_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n77_), .c(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n95_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n49_), .c(new_n71_), .d(x08), .O(new_n101_));
  nor2   g67(.a(new_n101_), .b(new_n52_), .O(new_n102_));
  nor2   g68(.a(new_n49_), .b(new_n41_), .O(new_n103_));
  aoi21  g69(.a(new_n102_), .b(x06), .c(new_n103_), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n46_), .c(new_n63_), .O(z10));
  nor2   g71(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n38_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n46_), .c(new_n63_), .O(z12));
  nor2   g74(.a(new_n37_), .b(new_n46_), .O(z13));
  nand3  g75(.a(new_n63_), .b(x17), .c(x04), .O(new_n110_));
