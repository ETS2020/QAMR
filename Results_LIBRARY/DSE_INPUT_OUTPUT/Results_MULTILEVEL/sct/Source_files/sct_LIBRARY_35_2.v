...
module FAU ( 
  ...
  oai21  g24(.a(x09), .b(x00), .c(new_n53_), .O(new_n59_));
  ...
  nor2   g30(.a(new_n64_), .b(new_n53_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n63_), .c(x08), .O(new_n66_));
  inv1   g32(.a(new_n66_), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n43_), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n62_), .c(new_n59_), .d(new_n46_), .O(z05));
  oai21  g35(.a(x10), .b(x00), .c(new_n53_), .O(new_n70_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n65_), .c(new_n43_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n72_), .c(new_n70_), .d(new_n46_), .O(z06));
  oai21  g43(.a(x11), .b(x00), .c(new_n53_), .O(new_n78_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n82_), .c(new_n43_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n78_), .d(new_n46_), .O(z07));
  oai21  g51(.a(x12), .b(x00), .c(new_n53_), .O(new_n86_));
  ...
  nand3  g59(.a(x12), .b(new_n53_), .c(new_n38_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n87_), .O(z08));
  oai21  g61(.a(x13), .b(x00), .c(new_n53_), .O(new_n96_));
  ...
  nand4  g67(.a(new_n101_), .b(new_n97_), .c(new_n96_), .d(new_n46_), .O(z09));
  nand2  g68(.a(new_n99_), .b(new_n38_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n46_), .c(new_n63_), .d(x08), .O(new_n104_));
  ...
  nand3  g74(.a(new_n105_), .b(x14), .c(new_n38_), .O(new_n109_));
  ...
  oai21  g78(.a(new_n112_), .b(new_n43_), .c(new_n49_), .O(z12));
