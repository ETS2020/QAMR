...
module FAU ( 
  ...
  nand2  g18(.a(x08), .b(new_n37_), .O(new_n53_));
  oai21  g19(.a(new_n52_), .b(new_n37_), .c(new_n53_), .O(new_n54_));
  ...
  aoi21  g32(.a(new_n60_), .b(x10), .c(new_n66_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(new_n36_), .c(new_n65_), .O(z06));
  nand2  g34(.a(x07), .b(x06), .O(new_n69_));
  nand2  g35(.a(new_n62_), .b(x08), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(new_n69_), .c(x11), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(x11), .O(new_n73_));
  inv1   g39(.a(new_n57_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n59_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n46_), .d(x04), .O(z07));
  nand2  g42(.a(new_n75_), .b(x12), .O(new_n77_));
  inv1   g43(.a(x12), .O(new_n78_));
  nand4  g44(.a(new_n62_), .b(new_n74_), .c(new_n78_), .d(new_n73_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n46_), .d(x04), .O(z08));
  nand3  g46(.a(new_n59_), .b(x08), .c(x07), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n73_), .d(new_n72_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n81_), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  aoi21  g51(.a(new_n79_), .b(x13), .c(new_n66_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n36_), .c(new_n85_), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  nand2  g54(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  ...
  nand2  g58(.a(new_n66_), .b(x14), .O(new_n93_));
  ...
  nand2  g63(.a(x06), .b(new_n36_), .O(z13));
