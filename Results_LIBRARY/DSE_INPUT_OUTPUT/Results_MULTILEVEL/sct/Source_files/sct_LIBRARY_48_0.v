...
module FAU ( 
  ...
  nand3  g34(.a(x17), .b(x09), .c(new_n55_), .O(new_n69_));
  ...
  oai21  g42(.a(new_n61_), .b(x11), .c(new_n55_), .O(new_n77_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n81_), .c(new_n43_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n79_), .c(new_n77_), .d(new_n48_), .O(z07));
  oai21  g53(.a(new_n61_), .b(x12), .c(new_n55_), .O(new_n88_));
  ...
  aoi21  g59(.a(new_n93_), .b(new_n81_), .c(new_n43_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n88_), .d(new_n48_), .O(z08));
  oai21  g61(.a(new_n61_), .b(x13), .c(new_n55_), .O(new_n96_));
  ...
  nand3  g69(.a(x17), .b(x13), .c(new_n55_), .O(new_n104_));
