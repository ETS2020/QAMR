...
module FAU ( 
  ...
  oai21  g26(.a(new_n48_), .b(new_n43_), .c(new_n52_), .O(new_n61_));
  ...
  nor2   g32(.a(new_n62_), .b(x09), .O(new_n67_));
  ...
  nand3  g41(.a(x11), .b(new_n75_), .c(new_n70_), .O(new_n76_));
  ...
  oai21  g45(.a(new_n76_), .b(new_n63_), .c(x06), .O(new_n80_));
  aoi21  g46(.a(x11), .b(new_n35_), .c(new_n43_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n49_), .O(z07));
  nor2   g48(.a(x12), .b(new_n43_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n49_), .c(new_n36_), .O(z08));
  nor2   g50(.a(x13), .b(new_n43_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n49_), .c(new_n36_), .O(z09));
  ...
  nand3  g59(.a(new_n48_), .b(x14), .c(new_n35_), .O(new_n94_));
  ...
  nand3  g63(.a(new_n97_), .b(new_n52_), .c(x04), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(z12));
  nor2   g65(.a(new_n36_), .b(new_n43_), .O(z13));
  nand2  g66(.a(x17), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n52_), .O(z14));
endmodule
