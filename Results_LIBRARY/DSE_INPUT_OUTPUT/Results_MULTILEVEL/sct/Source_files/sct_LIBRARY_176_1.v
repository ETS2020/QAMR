...
module FAU ( 
  ...
  nand3  g17(.a(new_n48_), .b(x07), .c(new_n35_), .O(new_n52_));
  ...
  nand3  g22(.a(new_n48_), .b(x08), .c(new_n35_), .O(new_n57_));
  ...
  oai21  g26(.a(x11), .b(x09), .c(new_n35_), .O(new_n61_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n63_), .c(new_n61_), .d(new_n49_), .O(z05));
  oai21  g36(.a(x11), .b(x10), .c(new_n35_), .O(new_n71_));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n66_), .c(new_n45_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n71_), .d(new_n49_), .O(z06));
  inv1   g44(.a(new_n49_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n45_), .c(new_n36_), .O(new_n80_));
  inv1   g46(.a(new_n62_), .O(new_n81_));
  nand2  g47(.a(new_n74_), .b(new_n81_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x11), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  nand4  g50(.a(new_n81_), .b(new_n48_), .c(new_n84_), .d(new_n64_), .O(new_n85_));
  ...
  nor3   g57(.a(new_n91_), .b(new_n62_), .c(new_n35_), .O(new_n92_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n98_), .c(new_n48_), .d(new_n84_), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n68_), .c(new_n45_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n97_), .c(new_n95_), .d(new_n49_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand2  g70(.a(new_n100_), .b(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n49_), .c(new_n64_), .d(x08), .O(new_n106_));
  nand2  g72(.a(new_n79_), .b(x14), .O(new_n107_));
  oai21  g73(.a(new_n106_), .b(new_n65_), .c(new_n107_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x06), .O(new_n109_));
  nand3  g75(.a(new_n79_), .b(x14), .c(new_n48_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n45_), .O(z10));
  nand2  g77(.a(new_n36_), .b(new_n38_), .O(z11));
  aoi21  g78(.a(x16), .b(new_n38_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n45_), .c(new_n36_), .O(z12));
  nand2  g80(.a(new_n36_), .b(new_n45_), .O(z13));
  nand2  g81(.a(new_n36_), .b(x17), .O(new_n116_));
  nor2   g82(.a(new_n116_), .b(new_n45_), .O(z14));
endmodule
