...
module FAU ( 
  ...
  nor2   g03(.a(new_n37_), .b(x14), .O(new_n38_));
  inv1   g04(.a(new_n38_), .O(new_n39_));
  nand2  g05(.a(new_n39_), .b(new_n36_), .O(z11));
  inv1   g06(.a(x14), .O(new_n41_));
  nand3  g07(.a(new_n37_), .b(new_n41_), .c(new_n35_), .O(new_n42_));
  oai21  g08(.a(z11), .b(new_n35_), .c(new_n42_), .O(z00));
  ...
  nand4  g19(.a(new_n53_), .b(new_n39_), .c(new_n49_), .d(x04), .O(new_n54_));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n53_), .c(new_n38_), .O(z05));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(x08), .c(x07), .d(x06), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n39_), .c(x04), .O(new_n73_));
  aoi21  g39(.a(new_n67_), .b(x10), .c(new_n73_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n53_), .O(z06));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n53_), .c(new_n38_), .O(z07));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n53_), .c(new_n38_), .O(z08));
  ...
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n53_), .d(x04), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n90_), .b(new_n94_), .O(new_n95_));
  oai21  g61(.a(new_n52_), .b(x15), .c(new_n41_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n66_), .d(x08), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(x07), .c(x06), .O(new_n99_));
  nand2  g65(.a(new_n52_), .b(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n46_), .O(z10));
  aoi21  g67(.a(x16), .b(new_n36_), .c(x03), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n46_), .c(new_n39_), .O(z12));
  nor2   g69(.a(new_n38_), .b(new_n46_), .O(z13));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n39_), .O(z14));
endmodule
