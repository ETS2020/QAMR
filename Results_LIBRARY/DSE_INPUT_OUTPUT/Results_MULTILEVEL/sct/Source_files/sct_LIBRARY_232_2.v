...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n65_), .O(new_n79_));
  and2   g45(.a(new_n79_), .b(new_n47_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n52_), .d(x04), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n70_), .b(new_n78_), .c(new_n82_), .d(new_n77_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n79_), .b(x12), .c(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n52_), .c(new_n36_), .O(z08));
  oai21  g52(.a(new_n51_), .b(new_n41_), .c(new_n47_), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(x13), .O(new_n88_));
  and2   g54(.a(x08), .b(x07), .O(new_n89_));
  nor2   g55(.a(new_n48_), .b(x05), .O(new_n90_));
  nor3   g56(.a(x13), .b(x12), .c(x11), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n70_), .d(new_n89_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n87_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand4  g60(.a(new_n42_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n51_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n65_), .c(x08), .d(x07), .O(new_n97_));
  nand2  g63(.a(new_n51_), .b(x14), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n48_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n47_), .O(z10));
  nor2   g67(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n37_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n41_), .c(new_n47_), .O(z12));
  nor2   g70(.a(new_n36_), .b(new_n41_), .O(z13));
  nand2  g71(.a(x17), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n47_), .O(z14));
endmodule
