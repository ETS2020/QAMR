...
module FAU ( 
  ...
  nand3  g20(.a(new_n54_), .b(x06), .c(new_n39_), .O(new_n55_));
  ...
  nand3  g26(.a(new_n60_), .b(x06), .c(new_n39_), .O(new_n61_));
  ...
  oai21  g30(.a(x09), .b(x06), .c(x01), .O(new_n65_));
  ...
  oai21  g40(.a(x10), .b(x06), .c(x01), .O(new_n75_));
  ...
  oai21  g53(.a(new_n87_), .b(new_n84_), .c(new_n39_), .O(new_n88_));
  ...
  oai21  g60(.a(new_n94_), .b(new_n92_), .c(new_n39_), .O(new_n95_));
  nand2  g61(.a(x12), .b(new_n36_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n82_), .O(z08));
  oai21  g63(.a(x13), .b(x06), .c(x01), .O(new_n98_));
  ...
  nand2  g78(.a(new_n47_), .b(new_n35_), .O(z11));
  ...
  nand3  g83(.a(new_n47_), .b(x17), .c(x04), .O(new_n118_));
