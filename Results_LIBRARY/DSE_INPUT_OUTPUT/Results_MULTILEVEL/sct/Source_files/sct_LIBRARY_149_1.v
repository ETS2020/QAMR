...
module FAU ( 
  ...
  aoi21  g15(.a(new_n49_), .b(new_n36_), .c(x06), .O(z02));
  ...
  nand2  g22(.a(x08), .b(new_n55_), .O(new_n57_));
  ...
  oai21  g26(.a(x12), .b(x09), .c(new_n55_), .O(new_n61_));
  ...
  nand3  g34(.a(new_n36_), .b(x09), .c(new_n55_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n68_), .c(new_n62_), .O(z05));
  oai21  g36(.a(x12), .b(x10), .c(new_n55_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n49_), .O(new_n72_));
  ...
  nand3  g43(.a(new_n36_), .b(x10), .c(new_n55_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(z06));
  nor2   g45(.a(x12), .b(x11), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(x06), .c(new_n49_), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  aoi21  g48(.a(new_n74_), .b(new_n65_), .c(new_n82_), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  nand3  g50(.a(new_n82_), .b(new_n84_), .c(new_n63_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n83_), .c(x06), .O(new_n87_));
  nand3  g53(.a(new_n36_), .b(x11), .c(new_n55_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n81_), .O(z07));
  nand2  g55(.a(new_n65_), .b(x06), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n85_), .c(x12), .O(new_n91_));
  nand4  g57(.a(new_n80_), .b(new_n74_), .c(new_n65_), .d(x06), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n48_), .d(x04), .O(z08));
  oai21  g59(.a(x13), .b(x12), .c(new_n55_), .O(new_n94_));
  nand2  g60(.a(new_n80_), .b(new_n84_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n66_), .c(x13), .O(new_n96_));
  nand4  g62(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n36_), .c(new_n82_), .d(new_n84_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nor2   g66(.a(new_n100_), .b(new_n42_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n96_), .c(new_n94_), .d(new_n48_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  aoi21  g69(.a(new_n99_), .b(new_n103_), .c(new_n47_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n63_), .c(x08), .d(x07), .O(new_n105_));
  nand2  g71(.a(new_n47_), .b(x14), .O(new_n106_));
  oai21  g72(.a(new_n105_), .b(new_n55_), .c(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n51_), .O(z10));
  nand2  g75(.a(new_n51_), .b(new_n35_), .O(z11));
  oai21  g76(.a(new_n46_), .b(x02), .c(new_n45_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n51_), .c(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z12));
  nor2   g79(.a(new_n37_), .b(new_n42_), .O(z13));
  nand2  g80(.a(x17), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n51_), .O(z14));
endmodule
