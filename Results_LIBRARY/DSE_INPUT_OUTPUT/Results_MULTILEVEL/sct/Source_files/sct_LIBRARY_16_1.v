...
module FAU ( 
  ...
  nand3  g24(.a(new_n58_), .b(x08), .c(x04), .O(new_n59_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n52_), .d(x04), .O(z05));
  oai21  g35(.a(x10), .b(new_n45_), .c(new_n35_), .O(new_n70_));
  nand3  g36(.a(new_n67_), .b(x08), .c(x06), .O(new_n71_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n52_), .d(x04), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n52_), .d(x04), .O(z08));
  oai21  g53(.a(x13), .b(new_n45_), .c(new_n35_), .O(new_n88_));
  nand3  g54(.a(new_n85_), .b(new_n80_), .c(new_n79_), .O(new_n89_));
  ...
  or2    g58(.a(new_n92_), .b(new_n68_), .O(new_n93_));
  ...
  nand4  g64(.a(new_n98_), .b(new_n52_), .c(new_n67_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  or2    g67(.a(new_n52_), .b(new_n40_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(z10));
  nand2  g69(.a(new_n50_), .b(new_n37_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n37_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n45_), .c(new_n50_), .O(z12));
  nand2  g72(.a(new_n35_), .b(new_n45_), .O(z13));
  nand2  g73(.a(x17), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n50_), .O(z14));
endmodule
