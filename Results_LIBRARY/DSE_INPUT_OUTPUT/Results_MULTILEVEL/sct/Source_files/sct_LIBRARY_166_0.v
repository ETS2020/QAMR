...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(new_n36_), .c(new_n46_), .d(x04), .O(new_n51_));
  ...
  nand4  g33(.a(new_n67_), .b(new_n63_), .c(new_n50_), .d(x04), .O(z05));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n50_), .c(new_n35_), .O(z06));
  inv1   g39(.a(x10), .O(new_n74_));
  inv1   g40(.a(x11), .O(new_n75_));
  inv1   g41(.a(new_n62_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n64_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  aoi21  g44(.a(new_n70_), .b(x11), .c(new_n78_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n50_), .c(new_n35_), .O(z07));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n69_), .b(new_n76_), .c(new_n81_), .d(new_n75_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n36_), .c(x04), .O(new_n83_));
  aoi21  g49(.a(new_n77_), .b(x12), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n50_), .O(z08));
  nand2  g51(.a(new_n82_), .b(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n81_), .c(new_n75_), .d(new_n74_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n66_), .c(new_n35_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n50_), .d(x04), .O(z09));
  ...
  oai21  g61(.a(new_n94_), .b(new_n46_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n36_), .O(z10));
  nor2   g64(.a(new_n35_), .b(new_n38_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n38_), .c(x03), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n43_), .c(new_n36_), .O(z12));
  nor2   g67(.a(new_n35_), .b(new_n43_), .O(z13));
