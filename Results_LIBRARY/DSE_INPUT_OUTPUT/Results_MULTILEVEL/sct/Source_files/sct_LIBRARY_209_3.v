...
module FAU ( 
  ...
  nand3  g19(.a(new_n53_), .b(x06), .c(new_n35_), .O(new_n54_));
  ...
  nand3  g24(.a(x08), .b(new_n53_), .c(new_n35_), .O(new_n59_));
  inv1   g25(.a(x08), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x07), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(new_n59_), .c(new_n36_), .O(new_n62_));
  ...
  oai21  g31(.a(new_n49_), .b(new_n44_), .c(new_n58_), .O(new_n66_));
  inv1   g32(.a(x09), .O(new_n67_));
  nor2   g33(.a(new_n60_), .b(new_n53_), .O(new_n68_));
  ...
  oai21  g38(.a(new_n72_), .b(new_n69_), .c(new_n35_), .O(new_n73_));
  nand2  g39(.a(x09), .b(new_n36_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(z05));
  oai21  g41(.a(x10), .b(x06), .c(x05), .O(new_n76_));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n70_), .c(new_n44_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n76_), .d(new_n50_), .O(z06));
  ...
  oai21  g54(.a(new_n88_), .b(new_n84_), .c(new_n35_), .O(new_n89_));
  nand2  g55(.a(x11), .b(new_n36_), .O(new_n90_));
  ...
  oai21  g61(.a(new_n95_), .b(new_n93_), .c(new_n35_), .O(new_n96_));
  nand2  g62(.a(x12), .b(new_n36_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n66_), .O(z08));
  oai21  g64(.a(x13), .b(x06), .c(x05), .O(new_n99_));
  ...
  aoi21  g70(.a(new_n104_), .b(new_n72_), .c(new_n44_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n100_), .c(new_n99_), .d(new_n50_), .O(z09));
  ...
  oai21  g76(.a(new_n109_), .b(new_n36_), .c(new_n110_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n58_), .O(z10));
  nand2  g79(.a(new_n58_), .b(new_n38_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n38_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n44_), .c(new_n58_), .O(z12));
  nand2  g82(.a(new_n58_), .b(new_n44_), .O(z13));
  nand3  g83(.a(new_n58_), .b(x17), .c(x04), .O(new_n118_));
