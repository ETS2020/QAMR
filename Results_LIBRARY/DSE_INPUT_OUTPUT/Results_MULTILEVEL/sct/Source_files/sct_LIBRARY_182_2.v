...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(new_n38_), .c(x06), .O(z02));
  inv1   g17(.a(x06), .O(new_n52_));
  nand3  g18(.a(x07), .b(new_n52_), .c(new_n38_), .O(new_n53_));
  ...
  nand3  g23(.a(x08), .b(new_n52_), .c(new_n38_), .O(new_n58_));
  ...
  oai21  g27(.a(x09), .b(x01), .c(new_n52_), .O(new_n62_));
  ...
  oai21  g36(.a(x10), .b(x01), .c(new_n52_), .O(new_n71_));
  ...
  oai21  g44(.a(x11), .b(x01), .c(new_n52_), .O(new_n79_));
  ...
  nand3  g51(.a(x11), .b(new_n52_), .c(new_n38_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n80_), .O(z07));
  oai21  g53(.a(x12), .b(x01), .c(new_n52_), .O(new_n88_));
  ...
  nand4  g58(.a(new_n92_), .b(new_n90_), .c(new_n81_), .d(new_n91_), .O(new_n93_));
  oai21  g59(.a(new_n84_), .b(new_n90_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand3  g61(.a(x12), .b(new_n52_), .c(new_n38_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z08));
  oai21  g63(.a(x13), .b(x01), .c(new_n52_), .O(new_n98_));
  nand2  g64(.a(new_n93_), .b(x13), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n90_), .c(new_n81_), .d(new_n91_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n68_), .c(new_n43_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n99_), .c(new_n98_), .d(new_n49_), .O(z09));
  inv1   g70(.a(new_n39_), .O(new_n105_));
  ...
  oai21  g75(.a(new_n108_), .b(new_n52_), .c(new_n109_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n105_), .O(z10));
  nand2  g78(.a(new_n105_), .b(new_n35_), .O(z11));
  oai21  g79(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n105_), .c(x04), .O(new_n115_));
  inv1   g81(.a(new_n115_), .O(z12));
  nand2  g82(.a(new_n105_), .b(new_n43_), .O(z13));
  inv1   g83(.a(x17), .O(new_n118_));
  nor3   g84(.a(new_n39_), .b(new_n118_), .c(new_n43_), .O(z14));
endmodule
