...
module FAU ( 
  ...
  nand4  g39(.a(new_n73_), .b(new_n69_), .c(new_n49_), .d(x04), .O(z06));
  oai21  g40(.a(x11), .b(new_n43_), .c(new_n35_), .O(new_n75_));
  oai21  g41(.a(new_n71_), .b(new_n62_), .c(x11), .O(new_n76_));
  ...
  nand4  g52(.a(new_n78_), .b(new_n72_), .c(new_n86_), .d(new_n85_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n49_), .d(x04), .O(z08));
  oai21  g54(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n89_));
  nand3  g55(.a(new_n64_), .b(x08), .c(x07), .O(new_n90_));
  nand3  g56(.a(new_n86_), .b(new_n85_), .c(new_n70_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n90_), .c(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  inv1   g59(.a(new_n65_), .O(new_n94_));
  nand4  g60(.a(new_n79_), .b(new_n94_), .c(new_n93_), .d(new_n86_), .O(new_n95_));
  ...
  nand2  g66(.a(new_n70_), .b(x04), .O(new_n101_));
  nand3  g67(.a(new_n93_), .b(new_n86_), .c(new_n85_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n49_), .c(new_n64_), .d(x08), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n99_), .c(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x06), .O(new_n106_));
  inv1   g72(.a(new_n49_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(x14), .c(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n106_), .O(z10));
  nand2  g75(.a(new_n48_), .b(new_n37_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n37_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n43_), .c(new_n48_), .O(z12));
