...
module FAU ( 
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n55_), .d(x04), .O(z05));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n65_), .c(new_n41_), .O(new_n72_));
  aoi21  g38(.a(new_n69_), .b(x10), .c(new_n54_), .O(new_n73_));
  oai22  g39(.a(new_n73_), .b(new_n41_), .c(new_n72_), .d(new_n43_), .O(z06));
  nor3   g40(.a(x11), .b(x10), .c(x09), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n65_), .c(new_n41_), .O(new_n76_));
  nand4  g42(.a(new_n71_), .b(x08), .c(x07), .d(x06), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(x11), .c(new_n54_), .O(new_n78_));
  oai22  g44(.a(new_n78_), .b(new_n41_), .c(new_n76_), .d(new_n43_), .O(z07));
  nand3  g45(.a(new_n68_), .b(x08), .c(x07), .O(new_n80_));
  ...
  oai21  g50(.a(new_n84_), .b(new_n80_), .c(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  nand3  g52(.a(new_n75_), .b(new_n65_), .c(x06), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(x12), .c(new_n54_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n41_), .c(new_n86_), .O(z08));
  nand3  g55(.a(new_n71_), .b(new_n83_), .c(new_n82_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n66_), .c(x13), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n93_));
  or2    g59(.a(new_n93_), .b(new_n69_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  aoi21  g62(.a(new_n93_), .b(new_n96_), .c(new_n54_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n68_), .c(x08), .d(x07), .O(new_n98_));
  nand2  g64(.a(new_n54_), .b(x14), .O(new_n99_));
  oai21  g65(.a(new_n98_), .b(new_n43_), .c(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n58_), .O(z10));
  nor2   g68(.a(new_n35_), .b(new_n36_), .O(z11));
  nand2  g69(.a(x16), .b(new_n36_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n48_), .c(new_n41_), .O(z12));
