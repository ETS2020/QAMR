...
module FAU ( 
  ...
  nand4  g30(.a(new_n64_), .b(new_n62_), .c(new_n48_), .d(x04), .O(z05));
  ...
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n48_), .O(new_n71_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n48_), .d(x04), .O(z07));
  nand2  g45(.a(new_n78_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n69_), .b(new_n77_), .c(new_n81_), .d(new_n76_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n48_), .d(x04), .O(z08));
  oai21  g49(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n84_));
  nand3  g50(.a(new_n81_), .b(new_n76_), .c(new_n75_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n67_), .c(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n81_), .c(new_n76_), .d(new_n75_), .O(new_n88_));
  or2    g54(.a(new_n88_), .b(new_n64_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n48_), .O(new_n90_));
