...
module FAU ( 
  ...
  nand3  g22(.a(x17), .b(x08), .c(new_n55_), .O(new_n57_));
  ...
  nor2   g35(.a(new_n69_), .b(new_n42_), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n65_), .c(new_n62_), .d(new_n48_), .O(z05));
  ...
  aoi21  g43(.a(new_n77_), .b(new_n67_), .c(new_n42_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n72_), .d(new_n48_), .O(z06));
  oai21  g45(.a(new_n61_), .b(x11), .c(new_n55_), .O(new_n80_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n84_), .c(new_n42_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n82_), .c(new_n80_), .d(new_n48_), .O(z07));
  ...
  nand3  g61(.a(x17), .b(x12), .c(new_n55_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z08));
  oai21  g63(.a(new_n61_), .b(x13), .c(new_n55_), .O(new_n98_));
  ...
  aoi21  g68(.a(new_n102_), .b(new_n69_), .c(new_n42_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n99_), .c(new_n98_), .d(new_n48_), .O(z09));
  ...
  nand2  g77(.a(new_n51_), .b(new_n36_), .O(z11));
  ...
  nand2  g81(.a(new_n51_), .b(new_n42_), .O(z13));
  oai21  g82(.a(new_n61_), .b(new_n42_), .c(new_n51_), .O(z14));
endmodule
