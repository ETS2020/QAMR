...
module FAU ( 
  ...
  aoi21  g32(.a(new_n66_), .b(new_n50_), .c(new_n42_), .O(z05));
  nor2   g33(.a(x10), .b(x09), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(x08), .c(x07), .d(x06), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n46_), .c(x04), .O(new_n70_));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n50_), .c(new_n42_), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n50_), .c(new_n42_), .O(z08));
  ...
  nand4  g55(.a(new_n89_), .b(new_n85_), .c(new_n50_), .d(x04), .O(z09));
  ...
  oai21  g60(.a(new_n93_), .b(new_n45_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n36_), .O(new_n96_));
  nand3  g62(.a(new_n92_), .b(new_n35_), .c(new_n63_), .O(new_n97_));
  ...
  nand2  g67(.a(new_n46_), .b(new_n101_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n101_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n41_), .c(new_n46_), .O(z12));
  nor2   g70(.a(new_n42_), .b(new_n41_), .O(z13));
