...
module FAU ( 
  ...
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n47_), .d(x04), .O(z08));
  ...
  nand4  g47(.a(new_n81_), .b(new_n78_), .c(new_n47_), .d(x04), .O(z09));
  inv1   g48(.a(x07), .O(new_n83_));
  inv1   g49(.a(x00), .O(new_n84_));
  nand2  g50(.a(new_n80_), .b(new_n84_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n47_), .c(new_n61_), .d(x08), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n83_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  inv1   g54(.a(new_n47_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(x14), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n88_), .O(z10));
  nand2  g57(.a(new_n46_), .b(new_n37_), .O(z11));
  aoi21  g58(.a(x16), .b(new_n37_), .c(x03), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n41_), .O(z12));
  nand2  g60(.a(new_n35_), .b(new_n41_), .O(z13));
