...
module FAU ( 
  ...
  nand4  g30(.a(x13), .b(x08), .c(x07), .d(x06), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(x09), .c(new_n43_), .O(new_n66_));
  ...
  nand2  g35(.a(new_n69_), .b(x13), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x06), .O(new_n71_));
  nand2  g37(.a(x07), .b(x06), .O(new_n72_));
  nand3  g38(.a(x13), .b(new_n61_), .c(x08), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n72_), .c(x10), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n49_), .d(x04), .O(z06));
  oai21  g41(.a(new_n48_), .b(new_n43_), .c(new_n52_), .O(new_n76_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n68_), .c(x13), .d(new_n78_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n77_), .c(new_n76_), .O(z07));
  inv1   g48(.a(x10), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n78_), .c(new_n83_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n62_), .c(x13), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nand2  g53(.a(new_n81_), .b(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n49_), .d(x04), .O(z08));
  nand3  g55(.a(new_n68_), .b(new_n84_), .c(new_n78_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n79_), .c(x13), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n76_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n46_), .b(x02), .O(new_n94_));
  ...
  nand3  g65(.a(new_n48_), .b(x14), .c(new_n35_), .O(new_n100_));
  ...
  nand3  g69(.a(new_n103_), .b(new_n52_), .c(x04), .O(new_n104_));
