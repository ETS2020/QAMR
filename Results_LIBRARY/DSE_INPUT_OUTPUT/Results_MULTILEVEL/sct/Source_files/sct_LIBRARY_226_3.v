...
module FAU ( 
  ...
  oai21  g29(.a(new_n51_), .b(new_n46_), .c(new_n38_), .O(new_n64_));
  ...
  nor2   g34(.a(x17), .b(x09), .O(new_n69_));
  ...
  nor2   g42(.a(x17), .b(x10), .O(new_n77_));
  ...
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(z07));
  ...
  nor3   g63(.a(x17), .b(x13), .c(x12), .O(new_n98_));
  ...
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n51_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n72_), .c(x08), .d(x07), .O(new_n105_));
  nand2  g71(.a(new_n51_), .b(x14), .O(new_n106_));
  ...
  oai21  g77(.a(new_n111_), .b(new_n46_), .c(new_n38_), .O(z12));
  aoi21  g78(.a(x17), .b(x06), .c(new_n46_), .O(z13));
