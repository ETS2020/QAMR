...
module FAU ( 
  ...
  nand2  g19(.a(x08), .b(new_n37_), .O(new_n54_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n36_), .c(new_n76_), .O(z07));
  ...
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n46_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n86_), .b(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n46_), .c(new_n58_), .d(x08), .O(new_n91_));
