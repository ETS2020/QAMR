...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(new_n48_), .c(new_n35_), .O(z02));
  oai21  g17(.a(x03), .b(new_n38_), .c(x16), .O(new_n52_));
  nand4  g18(.a(new_n52_), .b(x07), .c(new_n36_), .d(x04), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(z03));
  nand2  g20(.a(new_n52_), .b(x08), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n36_), .c(new_n35_), .O(z04));
  nor2   g22(.a(x09), .b(x06), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(new_n52_), .c(x04), .O(z05));
  aoi21  g24(.a(new_n47_), .b(x02), .c(new_n49_), .O(new_n59_));
  oai21  g25(.a(new_n59_), .b(x10), .c(new_n36_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z06));
  oai21  g27(.a(new_n59_), .b(x11), .c(new_n36_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x04), .O(z07));
  oai21  g29(.a(new_n59_), .b(x12), .c(new_n36_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z08));
  inv1   g31(.a(x13), .O(new_n66_));
  nand4  g32(.a(new_n52_), .b(new_n66_), .c(new_n36_), .d(x04), .O(z09));
  nand2  g33(.a(new_n59_), .b(x14), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(new_n36_), .c(new_n35_), .O(z10));
  nor2   g35(.a(new_n37_), .b(new_n38_), .O(z11));
  oai21  g36(.a(new_n49_), .b(x02), .c(new_n47_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n36_), .c(x04), .O(new_n72_));
  inv1   g38(.a(new_n72_), .O(z12));
  nor2   g39(.a(x06), .b(new_n35_), .O(z13));
