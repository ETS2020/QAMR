...
module FAU ( 
  ...
  oai21  g29(.a(new_n63_), .b(new_n43_), .c(new_n46_), .O(z04));
  ...
  nand4  g34(.a(x17), .b(x08), .c(x07), .d(x06), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(x09), .c(new_n43_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n50_), .O(z05));
  oai21  g37(.a(new_n49_), .b(new_n43_), .c(new_n46_), .O(new_n72_));
  nand2  g38(.a(new_n68_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  nor2   g40(.a(new_n58_), .b(new_n53_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(x17), .c(new_n74_), .d(new_n65_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n73_), .c(new_n72_), .O(z06));
  inv1   g45(.a(x17), .O(new_n80_));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n80_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n35_), .c(x11), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand4  g50(.a(new_n81_), .b(new_n77_), .c(x17), .d(new_n84_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(new_n72_), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n74_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n66_), .c(x17), .O(new_n89_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n87_), .c(new_n84_), .d(new_n74_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n66_), .c(x17), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand4  g62(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand4  g63(.a(x17), .b(new_n87_), .c(new_n84_), .d(new_n74_), .O(new_n98_));
  ...
  oai21  g75(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n46_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nand2  g78(.a(new_n46_), .b(new_n43_), .O(z13));
  nor2   g79(.a(new_n80_), .b(new_n43_), .O(z14));
endmodule
