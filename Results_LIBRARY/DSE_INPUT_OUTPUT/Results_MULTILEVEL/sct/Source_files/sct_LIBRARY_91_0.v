...
module FAU ( 
  ...
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n56_), .d(x04), .O(z05));
  ...
  inv1   g38(.a(new_n56_), .O(new_n73_));
  aoi21  g39(.a(new_n67_), .b(x10), .c(new_n73_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n40_), .c(new_n72_), .O(z06));
  ...
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n56_), .d(x04), .O(z07));
  nand3  g49(.a(new_n66_), .b(x08), .c(x07), .O(new_n84_));
  ...
  aoi21  g54(.a(new_n82_), .b(x12), .c(new_n73_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n40_), .c(new_n88_), .O(z08));
  inv1   g56(.a(x12), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n80_), .d(new_n79_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n84_), .c(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand3  g61(.a(new_n85_), .b(new_n69_), .c(new_n81_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(x13), .c(new_n73_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n40_), .c(new_n95_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n56_), .c(new_n66_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  nand2  g69(.a(new_n73_), .b(x14), .O(new_n104_));
  ...
  oai21  g73(.a(new_n107_), .b(new_n40_), .c(new_n52_), .O(z12));
  inv1   g74(.a(new_n43_), .O(z13));
