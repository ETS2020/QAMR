...
module FAU ( 
  ...
  aoi21  g12(.a(new_n46_), .b(x10), .c(x06), .O(z02));
  ...
  oai21  g24(.a(new_n58_), .b(x09), .c(new_n52_), .O(new_n59_));
  ...
  nand3  g31(.a(x10), .b(x09), .c(new_n52_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n60_), .O(z05));
  nand2  g33(.a(new_n46_), .b(new_n48_), .O(new_n68_));
  inv1   g34(.a(x07), .O(new_n69_));
  nor2   g35(.a(new_n69_), .b(new_n52_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n61_), .c(x08), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x10), .O(new_n72_));
  nand4  g38(.a(new_n70_), .b(new_n58_), .c(new_n61_), .d(x08), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n68_), .O(z06));
  nand2  g40(.a(new_n63_), .b(x11), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  nand4  g42(.a(new_n62_), .b(new_n76_), .c(new_n58_), .d(new_n61_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x06), .O(new_n79_));
  nand2  g45(.a(x11), .b(x10), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n68_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nor2   g48(.a(x11), .b(x09), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n62_), .c(new_n82_), .O(new_n84_));
  nor4   g50(.a(new_n63_), .b(x12), .c(x11), .d(x10), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n84_), .c(x06), .O(new_n86_));
  nand2  g52(.a(x12), .b(x10), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n68_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nor3   g55(.a(x12), .b(x11), .c(x09), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n62_), .c(new_n89_), .O(new_n91_));
  nand4  g57(.a(new_n89_), .b(new_n82_), .c(new_n76_), .d(new_n58_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n63_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n91_), .c(x06), .O(new_n94_));
  nand2  g60(.a(x13), .b(x10), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n68_), .O(z09));
  ...
  oai21  g67(.a(new_n99_), .b(new_n69_), .c(new_n101_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x06), .O(new_n103_));
  nand3  g69(.a(new_n100_), .b(x14), .c(x10), .O(new_n104_));
