...
module FAU ( 
  ...
  nand4  g17(.a(new_n51_), .b(new_n35_), .c(new_n47_), .d(x04), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z02));
  nand3  g19(.a(new_n35_), .b(x07), .c(new_n47_), .O(new_n54_));
  ...
  oai21  g26(.a(new_n59_), .b(new_n47_), .c(new_n60_), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n51_), .c(x04), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n58_), .O(z04));
  oai21  g29(.a(x11), .b(x09), .c(new_n47_), .O(new_n64_));
  ...
  nand3  g36(.a(new_n35_), .b(x09), .c(new_n47_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z05));
  oai21  g38(.a(x11), .b(x10), .c(new_n47_), .O(new_n73_));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n75_), .c(new_n44_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n74_), .c(new_n73_), .d(new_n51_), .O(z06));
  oai21  g46(.a(new_n50_), .b(new_n44_), .c(new_n58_), .O(new_n81_));
  nand2  g47(.a(new_n76_), .b(new_n67_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x11), .O(new_n83_));
  nor2   g49(.a(x11), .b(x10), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n67_), .c(new_n66_), .O(new_n85_));
  and2   g51(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n47_), .c(new_n81_), .O(z07));
  oai21  g53(.a(x12), .b(x11), .c(new_n47_), .O(new_n88_));
  nand2  g54(.a(new_n85_), .b(x12), .O(new_n89_));
  nand2  g55(.a(new_n67_), .b(x06), .O(new_n90_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n89_), .c(new_n88_), .d(new_n51_), .O(z08));
  oai21  g61(.a(x13), .b(x11), .c(new_n47_), .O(new_n96_));
  inv1   g62(.a(x10), .O(new_n97_));
  nand2  g63(.a(new_n91_), .b(new_n97_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n68_), .c(x13), .O(new_n99_));
  nand3  g65(.a(new_n75_), .b(new_n66_), .c(x08), .O(new_n100_));
  nor2   g66(.a(x13), .b(x12), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  nor2   g68(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n44_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n99_), .c(new_n96_), .d(new_n51_), .O(z09));
  ...
  nand2  g77(.a(new_n111_), .b(new_n58_), .O(z10));
  nand2  g78(.a(new_n58_), .b(new_n37_), .O(z11));
  oai21  g79(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n58_), .c(x04), .O(new_n115_));
  inv1   g81(.a(new_n115_), .O(z12));
  nor2   g82(.a(new_n36_), .b(new_n44_), .O(z13));
  nand2  g83(.a(x17), .b(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n58_), .O(z14));
endmodule
