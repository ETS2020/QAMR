...
module FAU ( 
  ...
  nand4  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n58_), .O(new_n75_));
  ...
  or2    g49(.a(new_n83_), .b(new_n66_), .O(new_n84_));
  ...
  nand4  g53(.a(new_n87_), .b(new_n46_), .c(new_n58_), .d(x08), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(x07), .c(x06), .O(new_n90_));
  nand2  g56(.a(new_n62_), .b(x14), .O(new_n91_));
  ...
  oai21  g60(.a(new_n94_), .b(new_n39_), .c(new_n49_), .O(z12));
  nand2  g61(.a(x08), .b(new_n39_), .O(z13));
  nand2  g62(.a(x17), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n49_), .O(z14));
endmodule
