...
module FAU ( 
  ...
  nor2   g23(.a(x11), .b(x06), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(new_n47_), .c(x04), .O(z07));
  inv1   g25(.a(x03), .O(new_n60_));
  inv1   g26(.a(x16), .O(new_n61_));
  aoi21  g27(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(x12), .c(new_n46_), .O(new_n63_));
  ...
  oai21  g35(.a(new_n61_), .b(x02), .c(new_n60_), .O(new_n70_));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n46_), .c(new_n40_), .O(z14));
endmodule
