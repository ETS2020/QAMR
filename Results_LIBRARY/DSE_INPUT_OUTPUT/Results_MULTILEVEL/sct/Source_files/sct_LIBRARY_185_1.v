...
module FAU ( 
  ...
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n64_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n49_), .d(x04), .O(z07));
  oai21  g48(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n83_));
  nand2  g49(.a(new_n80_), .b(new_n64_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n62_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n79_), .b(new_n72_), .c(new_n87_), .d(new_n86_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n85_), .c(new_n49_), .O(new_n89_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n92_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n95_), .b(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n49_), .c(new_n64_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  or2    g68(.a(new_n49_), .b(new_n40_), .O(new_n103_));
  ...
  oai21  g72(.a(new_n106_), .b(new_n43_), .c(new_n48_), .O(z12));
