...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n63_, new_n65_, new_n67_, new_n69_, new_n72_, new_n73_, new_n76_;
  ...
  aoi21  g27(.a(new_n48_), .b(x02), .c(new_n50_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(x11), .c(new_n36_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z07));
  nor2   g30(.a(x12), .b(x06), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n53_), .c(x04), .O(z08));
  oai21  g32(.a(new_n62_), .b(x13), .c(new_n36_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x04), .O(z09));
  nand3  g34(.a(new_n62_), .b(x14), .c(new_n36_), .O(new_n69_));
  nor2   g35(.a(new_n69_), .b(new_n35_), .O(z10));
  ...
  nor2   g40(.a(x06), .b(new_n35_), .O(z13));
