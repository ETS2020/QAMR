...
module FAU ( 
  ...
  oai21  g33(.a(new_n67_), .b(new_n40_), .c(new_n64_), .O(z05));
  nand2  g34(.a(new_n61_), .b(x08), .O(new_n69_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n46_), .d(x04), .O(z06));
  ...
  aoi21  g45(.a(new_n73_), .b(x11), .c(new_n65_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n40_), .c(new_n79_), .O(z07));
  inv1   g47(.a(x10), .O(new_n82_));
  nor2   g48(.a(x12), .b(x11), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n62_), .c(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  inv1   g52(.a(new_n66_), .O(new_n87_));
  nand3  g53(.a(new_n76_), .b(new_n87_), .c(new_n61_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(x12), .c(new_n65_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n40_), .c(new_n86_), .O(z08));
  inv1   g56(.a(x11), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n82_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n62_), .c(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand3  g62(.a(new_n83_), .b(new_n72_), .c(new_n87_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x13), .c(new_n65_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n40_), .c(new_n96_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand2  g66(.a(new_n94_), .b(new_n100_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n46_), .c(new_n61_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x07), .c(x06), .O(new_n104_));
  nand2  g70(.a(new_n65_), .b(x14), .O(new_n105_));
  ...
  oai21  g74(.a(new_n108_), .b(new_n40_), .c(new_n49_), .O(z12));
