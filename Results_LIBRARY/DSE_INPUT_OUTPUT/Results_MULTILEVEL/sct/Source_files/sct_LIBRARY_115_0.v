...
module FAU ( 
  ...
  nand4  g35(.a(new_n69_), .b(new_n65_), .c(new_n63_), .d(new_n49_), .O(z05));
  oai21  g36(.a(new_n62_), .b(x10), .c(new_n56_), .O(new_n71_));
  ...
  nand3  g46(.a(x17), .b(x10), .c(new_n56_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n72_), .O(z06));
  oai21  g48(.a(new_n62_), .b(x11), .c(new_n56_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n50_), .O(new_n84_));
  ...
  nand3  g53(.a(x17), .b(x11), .c(new_n56_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n84_), .O(z07));
  oai21  g55(.a(new_n62_), .b(x12), .c(new_n56_), .O(new_n90_));
  ...
  nor3   g60(.a(new_n94_), .b(new_n64_), .c(new_n56_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(new_n43_), .O(new_n96_));
  ...
  nand3  g71(.a(x17), .b(x13), .c(new_n56_), .O(new_n106_));
  ...
  oai21  g77(.a(new_n110_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n52_), .O(z10));
  nand2  g80(.a(new_n52_), .b(new_n36_), .O(z11));
  aoi21  g81(.a(x16), .b(new_n36_), .c(x03), .O(new_n116_));
  oai21  g82(.a(new_n116_), .b(new_n43_), .c(new_n52_), .O(z12));
  nand2  g83(.a(new_n52_), .b(new_n43_), .O(z13));
  oai21  g84(.a(new_n62_), .b(new_n43_), .c(new_n52_), .O(z14));
endmodule
