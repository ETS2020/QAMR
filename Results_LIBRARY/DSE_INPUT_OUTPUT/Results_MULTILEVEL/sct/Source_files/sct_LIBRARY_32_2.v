...
module FAU ( 
  ...
  nand3  g43(.a(x11), .b(new_n77_), .c(new_n72_), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n66_), .c(x06), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n76_), .c(new_n64_), .O(z06));
  oai21  g47(.a(new_n78_), .b(new_n65_), .c(x06), .O(new_n82_));
  aoi21  g48(.a(x11), .b(new_n50_), .c(new_n47_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n51_), .O(z07));
  nor2   g50(.a(x12), .b(new_n47_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n51_), .c(new_n37_), .O(z08));
  nor2   g52(.a(x13), .b(new_n47_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n51_), .c(new_n37_), .O(z09));
  nand4  g54(.a(new_n51_), .b(new_n72_), .c(x08), .d(x07), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  nor2   g56(.a(new_n51_), .b(new_n41_), .O(new_n91_));
  aoi21  g57(.a(new_n90_), .b(x00), .c(new_n91_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n47_), .c(new_n36_), .O(z10));
  nor2   g59(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g60(.a(x16), .b(new_n38_), .c(x03), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n47_), .c(new_n36_), .O(z12));
  nand2  g62(.a(new_n36_), .b(new_n47_), .O(z13));
  nand2  g63(.a(new_n36_), .b(x17), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n47_), .O(z14));
endmodule
