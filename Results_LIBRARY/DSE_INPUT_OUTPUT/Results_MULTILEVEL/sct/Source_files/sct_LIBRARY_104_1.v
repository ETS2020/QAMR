...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(x07), .c(new_n46_), .O(new_n53_));
  ...
  oai21  g46(.a(x12), .b(x11), .c(new_n46_), .O(new_n81_));
  ...
  nand2  g54(.a(new_n63_), .b(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n85_), .b(new_n66_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x12), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  nand4  g58(.a(new_n75_), .b(new_n35_), .c(new_n92_), .d(new_n74_), .O(new_n93_));
  and2   g59(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n46_), .c(new_n89_), .O(z08));
  oai21  g61(.a(x13), .b(x12), .c(new_n46_), .O(new_n96_));
  nand2  g62(.a(new_n93_), .b(x13), .O(new_n97_));
  nand4  g63(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n98_));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n35_), .c(new_n92_), .d(new_n74_), .O(new_n100_));
  nor2   g66(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nor2   g67(.a(new_n101_), .b(new_n43_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n97_), .c(new_n96_), .d(new_n50_), .O(z09));
  ...
  nand2  g75(.a(new_n109_), .b(new_n88_), .O(z10));
  nor2   g76(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n37_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n43_), .c(new_n88_), .O(z12));
  nor2   g79(.a(new_n36_), .b(new_n43_), .O(z13));
