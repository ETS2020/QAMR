...
module FAU ( 
  ...
  nand4  g47(.a(new_n81_), .b(new_n74_), .c(new_n68_), .d(new_n63_), .O(new_n82_));
  or2    g48(.a(new_n82_), .b(new_n58_), .O(new_n83_));
  ...
  aoi21  g61(.a(x16), .b(new_n35_), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n46_), .c(new_n36_), .O(z12));
  nor2   g63(.a(new_n95_), .b(new_n36_), .O(z13));
