...
module FAU ( 
  ...
  nand4  g40(.a(new_n74_), .b(new_n70_), .c(new_n49_), .d(x04), .O(z07));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n72_), .d(new_n71_), .O(new_n82_));
  or2    g48(.a(new_n82_), .b(new_n64_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g50(.a(x00), .O(new_n85_));
  nand2  g51(.a(new_n82_), .b(new_n85_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n49_), .c(new_n63_), .d(x08), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(x07), .c(x06), .O(new_n89_));
  or2    g55(.a(new_n49_), .b(new_n40_), .O(new_n90_));
  ...
  nor2   g59(.a(new_n93_), .b(new_n43_), .O(z12));
  nand2  g60(.a(new_n35_), .b(new_n43_), .O(z13));
