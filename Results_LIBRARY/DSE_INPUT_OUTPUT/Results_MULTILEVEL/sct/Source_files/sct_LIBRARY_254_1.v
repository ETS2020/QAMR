...
module FAU ( 
  ...
  nand2  g22(.a(new_n56_), .b(new_n45_), .O(z04));
  ...
  oai21  g28(.a(x10), .b(new_n40_), .c(new_n36_), .O(new_n63_));
  nand3  g29(.a(new_n60_), .b(x08), .c(x07), .O(new_n64_));
  ...
  nand2  g35(.a(new_n69_), .b(new_n63_), .O(z06));
  nand2  g36(.a(new_n67_), .b(x11), .O(new_n71_));
  inv1   g37(.a(new_n58_), .O(new_n72_));
  nor2   g38(.a(x11), .b(x10), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n60_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n46_), .d(x04), .O(z07));
  oai21  g41(.a(x12), .b(new_n40_), .c(new_n36_), .O(new_n76_));
  nand2  g42(.a(x08), .b(x07), .O(new_n77_));
  nand2  g43(.a(new_n73_), .b(new_n60_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n66_), .b(new_n72_), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  ...
  or2    g55(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n46_), .d(x04), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n89_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n46_), .c(new_n60_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  inv1   g62(.a(x14), .O(new_n97_));
  or2    g63(.a(new_n46_), .b(new_n97_), .O(new_n98_));
  ...
  nand2  g68(.a(new_n36_), .b(new_n40_), .O(z13));
