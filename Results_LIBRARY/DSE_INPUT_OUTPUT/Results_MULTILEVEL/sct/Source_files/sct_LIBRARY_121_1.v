...
module FAU ( 
  ...
  nand4  g14(.a(new_n48_), .b(new_n47_), .c(new_n36_), .d(x04), .O(new_n49_));
  inv1   g15(.a(new_n49_), .O(z02));
  nand4  g16(.a(new_n48_), .b(new_n47_), .c(x06), .d(x04), .O(new_n51_));
  ...
  nor2   g26(.a(new_n60_), .b(x08), .O(new_n61_));
  nor2   g27(.a(x09), .b(new_n53_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x07), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n61_), .c(x06), .O(new_n65_));
  nand2  g31(.a(x09), .b(new_n47_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n59_), .O(z05));
  inv1   g33(.a(x10), .O(new_n68_));
  nor2   g34(.a(x10), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(x08), .c(x07), .O(new_n70_));
  oai21  g36(.a(new_n62_), .b(new_n68_), .c(new_n70_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x06), .O(new_n72_));
  nand2  g38(.a(x10), .b(new_n47_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n59_), .O(z06));
  inv1   g40(.a(x11), .O(new_n75_));
  aoi21  g41(.a(new_n69_), .b(x08), .c(new_n75_), .O(new_n76_));
  nand2  g42(.a(x08), .b(x07), .O(new_n77_));
  nand3  g43(.a(new_n75_), .b(new_n68_), .c(new_n60_), .O(new_n78_));
  nor2   g44(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n76_), .c(x06), .O(new_n80_));
  nand2  g46(.a(x11), .b(new_n47_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n59_), .O(z07));
  oai21  g48(.a(x12), .b(x07), .c(new_n36_), .O(new_n83_));
  oai21  g49(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n84_));
  nor3   g50(.a(x12), .b(x11), .c(x10), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n64_), .c(new_n44_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n83_), .d(new_n48_), .O(z08));
  oai21  g53(.a(x13), .b(x07), .c(new_n36_), .O(new_n88_));
  nand2  g54(.a(new_n85_), .b(new_n64_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x13), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n75_), .d(new_n68_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n64_), .c(new_n44_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n90_), .c(new_n88_), .d(new_n48_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n93_), .b(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n48_), .c(new_n60_), .d(x08), .O(new_n99_));
  nand2  g65(.a(new_n58_), .b(x14), .O(new_n100_));
  oai21  g66(.a(new_n99_), .b(new_n47_), .c(new_n100_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n37_), .O(z10));
  ...
  nand2  g72(.a(new_n37_), .b(new_n44_), .O(z13));
  nand2  g73(.a(new_n37_), .b(x17), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n44_), .O(z14));
endmodule
