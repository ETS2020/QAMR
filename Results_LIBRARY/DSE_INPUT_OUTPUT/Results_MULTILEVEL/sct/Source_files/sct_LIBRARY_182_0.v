...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(x01), .c(x06), .O(z02));
  inv1   g17(.a(x06), .O(new_n52_));
  nand3  g18(.a(x07), .b(new_n52_), .c(x01), .O(new_n53_));
  ...
  nand3  g23(.a(x08), .b(new_n52_), .c(x01), .O(new_n58_));
  ...
  oai21  g27(.a(x09), .b(new_n35_), .c(new_n52_), .O(new_n62_));
  ...
  oai21  g36(.a(x10), .b(new_n35_), .c(new_n52_), .O(new_n71_));
  ...
  oai21  g44(.a(x11), .b(new_n35_), .c(new_n52_), .O(new_n79_));
  ...
  nand3  g51(.a(x11), .b(new_n52_), .c(x01), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n80_), .O(z07));
  oai21  g53(.a(x12), .b(new_n35_), .c(new_n52_), .O(new_n88_));
  ...
  nand3  g61(.a(x12), .b(new_n52_), .c(x01), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z08));
  oai21  g63(.a(x13), .b(new_n35_), .c(new_n52_), .O(new_n98_));
  ...
  nand2  g79(.a(new_n105_), .b(new_n113_), .O(z11));
  oai21  g80(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n105_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n105_), .b(new_n43_), .O(z13));
  inv1   g84(.a(x17), .O(new_n119_));
  nor3   g85(.a(new_n39_), .b(new_n119_), .c(new_n43_), .O(z14));
endmodule
