...
module FAU ( 
  ...
  nand3  g17(.a(x08), .b(new_n46_), .c(x06), .O(new_n52_));
  oai21  g18(.a(x08), .b(new_n46_), .c(new_n52_), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(x06), .c(new_n35_), .O(z04));
  ...
  nand4  g28(.a(new_n62_), .b(new_n57_), .c(new_n49_), .d(x04), .O(z05));
  nand2  g29(.a(new_n60_), .b(x10), .O(new_n64_));
  inv1   g30(.a(x10), .O(new_n65_));
  inv1   g31(.a(new_n56_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n59_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n49_), .O(new_n68_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n72_), .c(new_n65_), .d(new_n59_), .O(new_n73_));
  and2   g39(.a(new_n73_), .b(x06), .O(new_n74_));
  ...
  aoi21  g43(.a(new_n77_), .b(new_n61_), .c(new_n58_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n49_), .d(x04), .O(z08));
  nand2  g45(.a(new_n77_), .b(new_n61_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x13), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n72_), .d(new_n65_), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n61_), .c(new_n58_), .O(new_n86_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n49_), .c(new_n59_), .d(x08), .O(new_n90_));
  ...
  nor2   g65(.a(new_n58_), .b(new_n35_), .O(z13));
  inv1   g66(.a(x17), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(x06), .c(new_n35_), .O(z14));
endmodule
