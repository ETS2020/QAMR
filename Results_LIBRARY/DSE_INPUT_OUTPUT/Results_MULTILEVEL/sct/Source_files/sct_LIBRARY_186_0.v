...
module FAU ( 
  ...
  xnor2a g16(.a(x08), .b(x07), .O(new_n51_));
  nand2  g17(.a(x08), .b(new_n40_), .O(new_n52_));
  oai21  g18(.a(new_n51_), .b(new_n40_), .c(new_n52_), .O(new_n53_));
  ...
  inv1   g25(.a(new_n45_), .O(new_n60_));
  nand3  g26(.a(x08), .b(x07), .c(x06), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(x09), .c(new_n60_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n39_), .c(new_n59_), .O(z05));
  nand2  g29(.a(new_n56_), .b(x08), .O(new_n64_));
  nand2  g30(.a(x07), .b(x06), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n64_), .c(x10), .O(new_n66_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n56_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n70_), .c(new_n45_), .d(x04), .O(z07));
  ...
  oai21  g47(.a(new_n81_), .b(new_n57_), .c(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  aoi21  g49(.a(new_n78_), .b(x13), .c(new_n60_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n39_), .c(new_n83_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n81_), .b(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n45_), .c(new_n56_), .d(x08), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(x07), .c(x06), .O(new_n90_));
  nand2  g56(.a(new_n60_), .b(x14), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(new_n39_), .O(z10));
  nor2   g58(.a(new_n36_), .b(new_n35_), .O(z11));
  inv1   g59(.a(new_n36_), .O(new_n94_));
  aoi21  g60(.a(x16), .b(new_n35_), .c(x03), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n39_), .c(new_n94_), .O(z12));
  nand2  g62(.a(x06), .b(new_n39_), .O(z13));
