...
module FAU ( 
  ...
  nand3  g25(.a(new_n59_), .b(x18), .c(x06), .O(new_n60_));
  ...
  nand2  g31(.a(new_n65_), .b(x18), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x06), .O(new_n67_));
  nand4  g33(.a(x18), .b(x08), .c(x07), .d(x06), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(x09), .c(new_n43_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n50_), .O(z05));
  oai21  g36(.a(new_n49_), .b(new_n43_), .c(new_n46_), .O(new_n71_));
  nand2  g37(.a(new_n67_), .b(x10), .O(new_n72_));
  nor2   g38(.a(new_n58_), .b(new_n53_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x06), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  nor2   g41(.a(new_n41_), .b(x10), .O(new_n76_));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n73_), .c(new_n41_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n35_), .c(x11), .O(new_n81_));
  nor2   g47(.a(new_n41_), .b(x11), .O(new_n82_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n73_), .c(new_n41_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n35_), .c(x12), .O(new_n87_));
  nor2   g53(.a(x09), .b(new_n58_), .O(new_n88_));
  nor2   g54(.a(new_n53_), .b(new_n35_), .O(new_n89_));
  nor2   g55(.a(x11), .b(x10), .O(new_n90_));
  nor2   g56(.a(new_n41_), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n87_), .c(new_n71_), .O(z08));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n65_), .c(x18), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x06), .O(new_n97_));
  aoi21  g63(.a(new_n92_), .b(x13), .c(new_n43_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n50_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n95_), .b(new_n100_), .c(new_n49_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n64_), .c(x08), .d(x07), .O(new_n102_));
  nand2  g68(.a(new_n49_), .b(x14), .O(new_n103_));
  ...
  nand2  g72(.a(new_n46_), .b(new_n37_), .O(z11));
  oai21  g73(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n46_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nor2   g76(.a(new_n36_), .b(new_n43_), .O(z13));
  inv1   g77(.a(x17), .O(new_n112_));
  nor3   g78(.a(new_n36_), .b(new_n112_), .c(new_n43_), .O(z14));
endmodule
