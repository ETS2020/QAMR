...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(new_n47_), .c(x04), .O(z09));
  nand3  g32(.a(new_n60_), .b(x14), .c(new_n46_), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n40_), .O(z10));
  nand2  g34(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g35(.a(x16), .b(new_n37_), .c(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n58_), .c(new_n40_), .O(z12));
  nor2   g37(.a(x06), .b(new_n40_), .O(z13));
