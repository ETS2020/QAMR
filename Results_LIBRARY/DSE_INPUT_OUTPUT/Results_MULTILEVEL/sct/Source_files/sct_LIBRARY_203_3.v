...
module FAU ( 
  ...
  oai21  g21(.a(new_n55_), .b(x09), .c(new_n45_), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(x04), .O(z05));
  oai21  g23(.a(new_n55_), .b(x10), .c(new_n45_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x04), .O(z06));
  oai21  g25(.a(new_n55_), .b(x11), .c(new_n45_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z07));
  oai21  g27(.a(new_n55_), .b(x12), .c(new_n45_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x04), .O(z08));
  oai21  g29(.a(new_n55_), .b(x13), .c(new_n45_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z09));
  nand2  g31(.a(new_n55_), .b(x14), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n45_), .c(new_n42_), .O(z10));
  aoi21  g33(.a(x06), .b(x04), .c(new_n35_), .O(z11));
  oai21  g34(.a(new_n54_), .b(x02), .c(new_n53_), .O(new_n69_));
