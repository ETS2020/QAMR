...
module FAU ( 
  ...
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n48_), .d(x04), .O(z07));
  nand2  g41(.a(new_n74_), .b(x12), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  inv1   g43(.a(x12), .O(new_n78_));
  nand4  g44(.a(new_n68_), .b(new_n72_), .c(new_n78_), .d(new_n77_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n48_), .d(x04), .O(z08));
  oai21  g46(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n81_));
  nand3  g47(.a(new_n64_), .b(x08), .c(x07), .O(new_n82_));
  ...
  nand4  g53(.a(new_n73_), .b(new_n87_), .c(new_n86_), .d(new_n78_), .O(new_n88_));
  ...
  nand2  g59(.a(new_n83_), .b(x04), .O(new_n94_));
  nand3  g60(.a(new_n86_), .b(new_n78_), .c(new_n77_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n92_), .c(x04), .O(new_n98_));
  ...
  nand2  g68(.a(new_n54_), .b(new_n37_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n37_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n43_), .c(new_n54_), .O(z12));
