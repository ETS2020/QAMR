...
module FAU ( 
  ...
  nor2   g07(.a(x06), .b(new_n41_), .O(new_n42_));
  ...
  nand4  g15(.a(new_n49_), .b(new_n45_), .c(x04), .d(new_n41_), .O(new_n50_));
  ...
  nand3  g22(.a(x08), .b(new_n45_), .c(new_n41_), .O(new_n57_));
  ...
  oai21  g26(.a(x09), .b(x01), .c(new_n45_), .O(new_n61_));
  ...
  nand3  g35(.a(x09), .b(new_n45_), .c(new_n41_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(z05));
  oai21  g37(.a(x10), .b(x01), .c(new_n45_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n62_), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  inv1   g40(.a(new_n67_), .O(new_n75_));
  nand3  g41(.a(new_n66_), .b(new_n74_), .c(new_n64_), .O(new_n76_));
  oai21  g42(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x06), .O(new_n78_));
  nand3  g44(.a(x10), .b(new_n45_), .c(new_n41_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(z06));
  oai21  g46(.a(x11), .b(x01), .c(new_n45_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n62_), .O(new_n82_));
  and2   g48(.a(new_n76_), .b(x11), .O(new_n83_));
  nor4   g49(.a(new_n65_), .b(x11), .c(x10), .d(x09), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n83_), .c(x06), .O(new_n85_));
  nand3  g51(.a(x11), .b(new_n45_), .c(new_n41_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z07));
  oai21  g53(.a(x12), .b(x01), .c(new_n45_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n62_), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  nand4  g57(.a(new_n75_), .b(new_n90_), .c(new_n91_), .d(new_n74_), .O(new_n92_));
  oai21  g58(.a(new_n84_), .b(new_n90_), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x06), .O(new_n94_));
  nand3  g60(.a(x12), .b(new_n45_), .c(new_n41_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z08));
  oai21  g62(.a(x13), .b(x01), .c(new_n45_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n62_), .O(new_n98_));
  nand2  g64(.a(new_n92_), .b(x13), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n90_), .c(new_n91_), .d(new_n74_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n67_), .c(new_n99_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x06), .O(new_n103_));
  nand3  g69(.a(x13), .b(new_n45_), .c(new_n41_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n98_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  aoi21  g72(.a(new_n101_), .b(new_n106_), .c(new_n48_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n64_), .c(x08), .d(x07), .O(new_n108_));
  nand2  g74(.a(new_n48_), .b(x14), .O(new_n109_));
  oai21  g75(.a(new_n108_), .b(new_n45_), .c(new_n109_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n52_), .O(z10));
  nor2   g78(.a(new_n42_), .b(new_n35_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n35_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n40_), .c(new_n52_), .O(z12));
  nor2   g81(.a(new_n42_), .b(new_n40_), .O(z13));
  inv1   g82(.a(x17), .O(new_n117_));
  nor3   g83(.a(new_n42_), .b(new_n117_), .c(new_n40_), .O(z14));
endmodule
