...
module FAU ( 
  ...
  nand3  g17(.a(x07), .b(new_n36_), .c(x04), .O(new_n52_));
  oai21  g18(.a(x07), .b(new_n36_), .c(new_n52_), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n48_), .O(z03));
  xnor2a g21(.a(x08), .b(x07), .O(new_n56_));
  nand2  g22(.a(x08), .b(new_n36_), .O(new_n57_));
  ...
  oai21  g31(.a(x10), .b(new_n45_), .c(new_n36_), .O(new_n66_));
  ...
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n63_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n49_), .d(x04), .O(z07));
  oai21  g44(.a(x12), .b(new_n45_), .c(new_n36_), .O(new_n79_));
  nand2  g45(.a(x08), .b(x07), .O(new_n80_));
  nand2  g46(.a(new_n76_), .b(new_n63_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n80_), .c(x12), .O(new_n82_));
  inv1   g48(.a(x11), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n69_), .b(new_n75_), .c(new_n84_), .d(new_n83_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n82_), .c(new_n49_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n79_), .O(z08));
  oai21  g54(.a(x13), .b(new_n45_), .c(new_n36_), .O(new_n89_));
  inv1   g55(.a(x10), .O(new_n90_));
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(new_n90_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n67_), .c(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n84_), .c(new_n83_), .d(new_n90_), .O(new_n94_));
  or2    g60(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n92_), .c(new_n49_), .O(new_n96_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n49_), .c(new_n63_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  inv1   g69(.a(x14), .O(new_n104_));
  or2    g70(.a(new_n49_), .b(new_n104_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n103_), .c(new_n45_), .O(z10));
  nor2   g72(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n35_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n45_), .c(new_n48_), .O(z12));
  inv1   g75(.a(new_n43_), .O(z13));
