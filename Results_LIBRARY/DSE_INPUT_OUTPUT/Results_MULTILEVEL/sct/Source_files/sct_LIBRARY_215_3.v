...
module FAU ( 
  ...
  oai21  g27(.a(new_n50_), .b(new_n44_), .c(new_n47_), .O(new_n62_));
  and2   g28(.a(x08), .b(x07), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(x17), .c(x06), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x09), .O(new_n65_));
  nor2   g31(.a(x17), .b(x09), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n65_), .c(new_n62_), .O(z05));
  ...
  aoi21  g38(.a(new_n67_), .b(x10), .c(new_n44_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n51_), .O(z06));
  nand2  g40(.a(new_n72_), .b(x11), .O(new_n75_));
  nor2   g41(.a(x17), .b(x11), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n69_), .c(new_n63_), .d(x06), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n62_), .O(z07));
  nor3   g44(.a(x11), .b(x10), .c(x09), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n63_), .c(x17), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n35_), .c(x12), .O(new_n81_));
  ...
  nor2   g51(.a(x17), .b(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n81_), .c(new_n62_), .O(z08));
  nand3  g54(.a(new_n83_), .b(x08), .c(x07), .O(new_n89_));
  nor2   g55(.a(x13), .b(x12), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n82_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n89_), .c(new_n36_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  nand2  g59(.a(new_n87_), .b(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n93_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  aoi21  g62(.a(new_n91_), .b(new_n96_), .c(new_n50_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n83_), .c(x08), .d(x07), .O(new_n98_));
  ...
  nand3  g67(.a(new_n50_), .b(x14), .c(new_n35_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n44_), .O(z10));
  nor2   g69(.a(new_n37_), .b(new_n38_), .O(z11));
  oai21  g70(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n47_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  oai21  g73(.a(new_n36_), .b(new_n35_), .c(new_n44_), .O(z13));
  nand3  g74(.a(x17), .b(new_n35_), .c(x04), .O(new_n109_));
