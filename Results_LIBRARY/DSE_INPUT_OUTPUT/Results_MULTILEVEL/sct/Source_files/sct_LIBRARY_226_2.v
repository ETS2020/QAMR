...
module FAU ( 
  ...
  nand3  g24(.a(new_n58_), .b(x17), .c(x06), .O(new_n59_));
  ...
  oai21  g28(.a(new_n50_), .b(new_n45_), .c(new_n37_), .O(new_n63_));
  ...
  nor2   g42(.a(new_n64_), .b(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n66_), .c(new_n69_), .d(x06), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n63_), .O(z06));
  ...
  aoi21  g49(.a(new_n78_), .b(x11), .c(new_n45_), .O(new_n84_));
  ...
  aoi21  g76(.a(x16), .b(new_n39_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n45_), .c(new_n37_), .O(z12));
  nor2   g78(.a(new_n36_), .b(new_n45_), .O(z13));
  nor2   g79(.a(new_n64_), .b(new_n45_), .O(z14));
endmodule
