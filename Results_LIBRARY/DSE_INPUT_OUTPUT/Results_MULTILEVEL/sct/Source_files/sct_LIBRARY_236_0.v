...
module FAU ( 
  ...
  nand3  g45(.a(new_n66_), .b(x08), .c(x07), .O(new_n80_));
  ...
  or2    g52(.a(new_n75_), .b(new_n64_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(x12), .c(new_n50_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n41_), .c(new_n86_), .O(z08));
  nand3  g55(.a(new_n70_), .b(new_n83_), .c(new_n82_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n64_), .c(x13), .O(new_n91_));
  nor2   g57(.a(x13), .b(x12), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n74_), .O(new_n93_));
  or2    g59(.a(new_n93_), .b(new_n67_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  aoi21  g62(.a(new_n93_), .b(new_n96_), .c(new_n50_), .O(new_n97_));
  ...
  nand2  g67(.a(new_n101_), .b(new_n57_), .O(z10));
  ...
  nand2  g72(.a(new_n106_), .b(new_n57_), .O(z14));
  buf    g73(.a(x04), .O(z13));
endmodule
