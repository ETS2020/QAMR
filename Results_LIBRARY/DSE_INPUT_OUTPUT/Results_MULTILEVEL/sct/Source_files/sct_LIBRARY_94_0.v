...
module FAU ( 
  ...
  nand2  g21(.a(new_n48_), .b(x16), .O(new_n56_));
  ...
  oai21  g26(.a(new_n59_), .b(new_n42_), .c(new_n60_), .O(new_n61_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n40_), .c(new_n67_), .O(z05));
  nand4  g37(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  nor2   g39(.a(x10), .b(x09), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(x08), .c(x07), .d(x06), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n56_), .d(x04), .O(z06));
  ...
  aoi21  g48(.a(new_n75_), .b(x11), .c(new_n68_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n40_), .c(new_n82_), .O(z07));
  oai21  g50(.a(new_n80_), .b(new_n69_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  inv1   g52(.a(new_n69_), .O(new_n87_));
  nand4  g53(.a(new_n74_), .b(new_n87_), .c(new_n86_), .d(new_n79_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n56_), .d(x04), .O(z08));
  nand2  g55(.a(new_n88_), .b(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n86_), .c(new_n79_), .d(new_n78_), .O(new_n92_));
  or2    g58(.a(new_n92_), .b(new_n72_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n56_), .d(x04), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n92_), .b(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n56_), .c(new_n64_), .d(x08), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(x07), .c(x06), .O(new_n99_));
  nand2  g65(.a(new_n68_), .b(x14), .O(new_n100_));
  ...
  oai21  g69(.a(new_n103_), .b(new_n40_), .c(new_n52_), .O(z12));
