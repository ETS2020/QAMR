...
module FAU ( 
  ...
  aoi21  g37(.a(new_n66_), .b(x10), .c(new_n48_), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(new_n40_), .c(new_n71_), .O(z06));
  nand2  g39(.a(x07), .b(x06), .O(new_n74_));
  nand2  g40(.a(new_n68_), .b(x08), .O(new_n75_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n49_), .d(x04), .O(z07));
  nand2  g47(.a(new_n80_), .b(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n68_), .b(new_n79_), .c(new_n83_), .d(new_n78_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n49_), .d(x04), .O(z08));
  nand3  g51(.a(new_n65_), .b(x08), .c(x07), .O(new_n86_));
  ...
  aoi21  g56(.a(new_n84_), .b(x13), .c(new_n48_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n40_), .c(new_n90_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  aoi21  g59(.a(new_n88_), .b(new_n93_), .c(new_n48_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n65_), .c(x08), .d(x07), .O(new_n95_));
  nand2  g61(.a(new_n48_), .b(x14), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n41_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n52_), .O(z10));
  nor2   g65(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n36_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n40_), .c(new_n52_), .O(z12));
  nand2  g68(.a(x17), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n52_), .O(z14));
  buf    g70(.a(x04), .O(z13));
endmodule
