...
module FAU ( 
  ...
  oai21  g24(.a(new_n56_), .b(x10), .c(new_n46_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z06));
  oai21  g26(.a(new_n56_), .b(x11), .c(new_n46_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z07));
  oai21  g28(.a(new_n56_), .b(x12), .c(new_n46_), .O(new_n63_));
  ...
  oai21  g35(.a(new_n55_), .b(x02), .c(new_n54_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n46_), .c(x04), .O(new_n71_));
  inv1   g37(.a(new_n71_), .O(z12));
  nor2   g38(.a(x06), .b(new_n40_), .O(z13));
  nand2  g39(.a(z13), .b(x17), .O(new_n74_));
