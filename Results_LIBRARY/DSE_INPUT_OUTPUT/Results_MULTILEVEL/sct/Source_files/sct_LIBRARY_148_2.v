...
module FAU ( 
  ...
  inv1   g06(.a(x13), .O(new_n41_));
  oai21  g07(.a(new_n41_), .b(new_n40_), .c(x05), .O(new_n42_));
  inv1   g08(.a(x18), .O(new_n43_));
  oai21  g09(.a(new_n43_), .b(x15), .c(new_n36_), .O(new_n44_));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n51_), .c(new_n37_), .O(z05));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n51_), .c(new_n37_), .O(z06));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n51_), .c(new_n37_), .O(z07));
  ...
  nand2  g50(.a(new_n84_), .b(new_n51_), .O(z08));
  oai21  g51(.a(new_n50_), .b(new_n40_), .c(new_n47_), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(x13), .O(new_n87_));
  and2   g53(.a(x08), .b(x07), .O(new_n88_));
  nor2   g54(.a(new_n46_), .b(x05), .O(new_n89_));
  nor3   g55(.a(x13), .b(x12), .c(x11), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n69_), .d(new_n88_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n86_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand4  g59(.a(new_n41_), .b(new_n81_), .c(new_n75_), .d(new_n74_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n50_), .O(new_n95_));
  ...
  nand2  g66(.a(new_n47_), .b(new_n35_), .O(z11));
  oai21  g67(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n47_), .c(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z12));
  nand2  g70(.a(new_n47_), .b(new_n40_), .O(z13));
