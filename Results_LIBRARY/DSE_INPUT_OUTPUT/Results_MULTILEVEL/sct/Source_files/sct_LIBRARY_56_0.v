...
module FAU ( 
  ...
  nand3  g16(.a(x15), .b(x07), .c(new_n50_), .O(new_n51_));
  ...
  nand3  g21(.a(x15), .b(x08), .c(new_n50_), .O(new_n56_));
  ...
  oai21  g26(.a(new_n60_), .b(x09), .c(new_n50_), .O(new_n61_));
  ...
  nand3  g33(.a(x15), .b(x09), .c(new_n50_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n62_), .O(z05));
  oai21  g35(.a(new_n60_), .b(x10), .c(new_n50_), .O(new_n70_));
  ...
  oai21  g44(.a(new_n60_), .b(x11), .c(new_n50_), .O(new_n79_));
  ...
  oai21  g52(.a(new_n60_), .b(x12), .c(new_n50_), .O(new_n87_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n89_), .c(new_n87_), .d(new_n47_), .O(z08));
  oai21  g61(.a(new_n60_), .b(x13), .c(new_n50_), .O(new_n96_));
  ...
  oai21  g68(.a(new_n102_), .b(new_n65_), .c(new_n100_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x06), .O(new_n104_));
  nand3  g70(.a(x15), .b(x13), .c(new_n50_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n104_), .c(new_n97_), .O(z09));
  inv1   g72(.a(new_n35_), .O(new_n107_));
  inv1   g73(.a(x00), .O(new_n108_));
  aoi21  g74(.a(new_n102_), .b(new_n108_), .c(new_n46_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n63_), .c(x08), .d(x07), .O(new_n110_));
  nand2  g76(.a(new_n46_), .b(x14), .O(new_n111_));
  oai21  g77(.a(new_n110_), .b(new_n50_), .c(new_n111_), .O(new_n112_));
  ...
  oai21  g82(.a(new_n116_), .b(new_n72_), .c(new_n107_), .O(z12));
  nand2  g83(.a(new_n107_), .b(new_n72_), .O(z13));
  inv1   g84(.a(x17), .O(new_n119_));
  nor3   g85(.a(new_n35_), .b(new_n119_), .c(new_n72_), .O(z14));
endmodule
