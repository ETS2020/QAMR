...
module FAU ( 
  ...
  oai21  g29(.a(new_n51_), .b(new_n45_), .c(new_n48_), .O(new_n64_));
  and2   g30(.a(x08), .b(x07), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(x18), .c(x06), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x09), .O(new_n67_));
  nor2   g33(.a(x18), .b(x09), .O(new_n68_));
  ...
  nor2   g57(.a(x18), .b(x11), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n76_), .c(new_n71_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n77_), .c(x12), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n52_), .d(x04), .O(z08));
  nor2   g61(.a(x13), .b(x12), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n81_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n72_), .c(new_n36_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x06), .O(new_n99_));
  nand4  g65(.a(new_n71_), .b(x08), .c(x07), .d(x06), .O(new_n100_));
  nand3  g66(.a(new_n81_), .b(new_n36_), .c(new_n88_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n100_), .c(x13), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n99_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  aoi21  g70(.a(new_n97_), .b(new_n104_), .c(new_n51_), .O(new_n105_));
  ...
  nand3  g82(.a(new_n48_), .b(x17), .c(x04), .O(new_n117_));
