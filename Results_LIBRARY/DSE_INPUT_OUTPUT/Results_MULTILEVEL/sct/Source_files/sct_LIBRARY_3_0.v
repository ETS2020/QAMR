...
module FAU ( 
  ...
  nor2   g00(.a(x15), .b(x09), .O(new_n35_));
  inv1   g01(.a(x02), .O(new_n36_));
  nand2  g02(.a(new_n36_), .b(x01), .O(new_n37_));
  or2    g03(.a(x14), .b(x01), .O(new_n38_));
  aoi21  g04(.a(new_n38_), .b(new_n37_), .c(new_n35_), .O(z00));
  aoi21  g05(.a(x09), .b(x05), .c(x15), .O(new_n40_));
  inv1   g06(.a(x18), .O(new_n41_));
  aoi21  g07(.a(new_n41_), .b(x09), .c(x15), .O(new_n42_));
  ...
  oai21  g26(.a(new_n48_), .b(new_n60_), .c(new_n45_), .O(new_n61_));
  ...
  nand4  g32(.a(new_n66_), .b(x15), .c(new_n64_), .d(x08), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n63_), .c(new_n61_), .O(z05));
  inv1   g34(.a(x10), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x08), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(new_n65_), .c(x15), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  nand2  g38(.a(new_n67_), .b(x10), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n49_), .d(x04), .O(z06));
  nor2   g40(.a(x11), .b(x10), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n66_), .c(x08), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x15), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n64_), .O(new_n78_));
  nand3  g44(.a(x15), .b(new_n69_), .c(new_n64_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n62_), .c(x11), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n49_), .d(x04), .O(z07));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n69_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n62_), .c(x15), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  nand4  g52(.a(x15), .b(new_n82_), .c(new_n69_), .d(new_n64_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n62_), .c(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n49_), .d(x04), .O(z08));
  nand2  g55(.a(new_n86_), .b(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand3  g57(.a(x15), .b(new_n91_), .c(new_n83_), .O(new_n92_));
  nor3   g58(.a(new_n92_), .b(x11), .c(x10), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n66_), .c(new_n64_), .d(x08), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n90_), .c(new_n61_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand3  g62(.a(new_n75_), .b(new_n91_), .c(new_n83_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n48_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n64_), .c(x08), .d(x07), .O(new_n99_));
  nand2  g65(.a(new_n48_), .b(x14), .O(new_n100_));
  oai21  g66(.a(new_n99_), .b(new_n44_), .c(new_n100_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x15), .O(new_n102_));
  nand3  g68(.a(new_n48_), .b(x14), .c(x09), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n60_), .O(z10));
  ...
  nand2  g74(.a(new_n45_), .b(new_n60_), .O(z13));
  inv1   g75(.a(x17), .O(new_n110_));
  nor3   g76(.a(new_n35_), .b(new_n110_), .c(new_n60_), .O(z14));
endmodule
