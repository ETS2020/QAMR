...
module FAU ( 
  ...
  nand3  g19(.a(new_n53_), .b(x06), .c(x05), .O(new_n54_));
  ...
  nand3  g24(.a(new_n58_), .b(x06), .c(x05), .O(new_n59_));
  ...
  oai21  g29(.a(x09), .b(x06), .c(new_n41_), .O(new_n64_));
  ...
  nor2   g36(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n66_), .c(new_n64_), .d(new_n50_), .O(z05));
  oai21  g38(.a(new_n49_), .b(new_n67_), .c(new_n46_), .O(new_n73_));
  ...
  oai21  g47(.a(x11), .b(x06), .c(new_n41_), .O(new_n82_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n83_), .c(new_n82_), .d(new_n50_), .O(z07));
  oai21  g55(.a(x12), .b(x06), .c(new_n41_), .O(new_n90_));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n86_), .c(new_n67_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n91_), .c(new_n90_), .d(new_n50_), .O(z08));
  oai21  g62(.a(x13), .b(x06), .c(new_n41_), .O(new_n97_));
  oai21  g63(.a(new_n93_), .b(new_n65_), .c(x13), .O(new_n98_));
  ...
  aoi21  g67(.a(new_n101_), .b(new_n70_), .c(new_n67_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n98_), .c(new_n97_), .d(new_n50_), .O(z09));
  ...
  nand2  g74(.a(new_n108_), .b(x05), .O(new_n109_));
  nand3  g75(.a(new_n49_), .b(x14), .c(new_n35_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n67_), .O(z10));
  nor2   g77(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g78(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n46_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n46_), .b(new_n67_), .O(z13));
  nand2  g82(.a(x17), .b(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n46_), .O(z14));
endmodule
