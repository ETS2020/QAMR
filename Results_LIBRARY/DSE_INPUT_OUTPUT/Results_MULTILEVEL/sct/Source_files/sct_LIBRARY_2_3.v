...
module FAU ( 
  ...
  nand4  g24(.a(new_n58_), .b(new_n50_), .c(new_n38_), .d(x04), .O(new_n59_));
  ...
  nand4  g32(.a(new_n66_), .b(new_n62_), .c(new_n50_), .d(x04), .O(z05));
  nor2   g33(.a(x10), .b(x09), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(x08), .c(x07), .d(x06), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n38_), .c(x04), .O(new_n70_));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n50_), .c(new_n37_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n68_), .b(new_n75_), .c(new_n80_), .d(new_n74_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n38_), .c(x04), .O(new_n82_));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n50_), .c(new_n37_), .O(z09));
  ...
  nor2   g62(.a(new_n37_), .b(new_n40_), .O(z11));
  inv1   g63(.a(x04), .O(new_n98_));
  aoi21  g64(.a(x16), .b(new_n40_), .c(x03), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n98_), .c(new_n38_), .O(z12));
  oai21  g66(.a(new_n36_), .b(new_n35_), .c(new_n98_), .O(z13));
  nor3   g67(.a(x18), .b(new_n35_), .c(new_n98_), .O(z14));
endmodule
