...
module FAU ( 
  ...
  nand3  g20(.a(x11), .b(x08), .c(new_n53_), .O(new_n55_));
  ...
  nor2   g29(.a(new_n61_), .b(new_n53_), .O(new_n64_));
  nor2   g30(.a(x09), .b(new_n62_), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(new_n64_), .c(new_n43_), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n46_), .O(z05));
  oai21  g33(.a(new_n59_), .b(x10), .c(new_n53_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n47_), .O(new_n69_));
  ...
  nor2   g39(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nor2   g40(.a(new_n62_), .b(new_n61_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n70_), .c(new_n71_), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n74_), .c(x06), .O(new_n78_));
  nand3  g44(.a(x11), .b(x10), .c(new_n53_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n69_), .O(z06));
  nand2  g46(.a(new_n47_), .b(new_n49_), .O(new_n81_));
  inv1   g47(.a(new_n64_), .O(new_n82_));
  nand3  g48(.a(new_n70_), .b(new_n71_), .c(x08), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n82_), .c(x11), .O(new_n84_));
  nor3   g50(.a(x11), .b(x10), .c(x09), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n75_), .c(x06), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n84_), .c(new_n81_), .O(z07));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n73_), .b(new_n88_), .c(new_n59_), .d(new_n70_), .O(new_n89_));
  oai21  g55(.a(new_n77_), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand2  g57(.a(x12), .b(x11), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n81_), .O(z08));
  oai21  g59(.a(x13), .b(new_n59_), .c(new_n53_), .O(new_n94_));
  nand2  g60(.a(new_n89_), .b(x13), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n88_), .c(new_n59_), .d(new_n70_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n73_), .c(new_n43_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n95_), .c(new_n94_), .d(new_n46_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n97_), .b(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n46_), .c(new_n71_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n46_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(x14), .O(new_n105_));
  oai21  g71(.a(new_n103_), .b(new_n61_), .c(new_n105_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x06), .O(new_n107_));
  nand3  g73(.a(new_n104_), .b(x14), .c(x11), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n43_), .O(z10));
  nand2  g75(.a(new_n49_), .b(new_n36_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n36_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n43_), .c(new_n49_), .O(z12));
  nand2  g78(.a(new_n49_), .b(new_n43_), .O(z13));
  inv1   g79(.a(x17), .O(new_n114_));
  nor3   g80(.a(new_n35_), .b(new_n114_), .c(new_n43_), .O(z14));
endmodule
