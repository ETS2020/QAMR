...
module FAU ( 
  ...
  nand4  g15(.a(new_n47_), .b(new_n35_), .c(x06), .d(x04), .O(new_n50_));
  ...
  nand3  g42(.a(new_n75_), .b(new_n68_), .c(new_n60_), .O(new_n77_));
  nor3   g43(.a(new_n77_), .b(new_n52_), .c(new_n35_), .O(new_n78_));
  ...
  oai21  g47(.a(x12), .b(x07), .c(new_n46_), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  or2    g49(.a(new_n78_), .b(new_n83_), .O(new_n84_));
  nor3   g50(.a(x12), .b(x11), .c(x10), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n64_), .c(new_n43_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n82_), .d(new_n47_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  aoi21  g54(.a(new_n85_), .b(new_n62_), .c(new_n88_), .O(new_n89_));
  nand4  g55(.a(new_n88_), .b(new_n83_), .c(new_n75_), .d(new_n68_), .O(new_n90_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n47_), .c(new_n60_), .d(x08), .O(new_n97_));
  ...
  nand3  g66(.a(new_n58_), .b(x14), .c(new_n35_), .O(new_n101_));
  ...
  nand3  g72(.a(new_n106_), .b(new_n57_), .c(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z12));
  nand2  g74(.a(new_n57_), .b(new_n43_), .O(z13));
  nand2  g75(.a(x17), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n57_), .O(z14));
endmodule
