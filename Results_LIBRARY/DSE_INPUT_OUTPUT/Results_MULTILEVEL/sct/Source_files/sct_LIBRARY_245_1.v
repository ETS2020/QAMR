...
module FAU ( 
  ...
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n50_), .d(x04), .O(z07));
  oai21  g41(.a(x12), .b(new_n38_), .c(new_n45_), .O(new_n76_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n79_), .c(new_n50_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n76_), .O(z08));
  oai21  g51(.a(x13), .b(new_n38_), .c(new_n45_), .O(new_n86_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n81_), .c(new_n80_), .d(new_n88_), .O(new_n92_));
  ...
  or2    g67(.a(new_n50_), .b(new_n36_), .O(new_n102_));
