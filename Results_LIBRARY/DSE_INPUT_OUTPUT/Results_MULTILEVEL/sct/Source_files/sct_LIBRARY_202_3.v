...
module FAU ( 
  ...
  nor2   g27(.a(x09), .b(new_n56_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x07), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(new_n37_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x06), .O(new_n65_));
  nor2   g31(.a(new_n51_), .b(new_n36_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n37_), .c(x08), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(x09), .c(new_n43_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n65_), .c(new_n48_), .O(z05));
  inv1   g35(.a(new_n38_), .O(new_n70_));
  inv1   g36(.a(new_n48_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n43_), .c(new_n70_), .O(new_n72_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n37_), .c(new_n75_), .d(new_n74_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n73_), .c(new_n72_), .O(z06));
  ...
  aoi21  g50(.a(new_n78_), .b(x11), .c(new_n43_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n48_), .O(z07));
  nand2  g52(.a(new_n84_), .b(x12), .O(new_n87_));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n81_), .c(new_n66_), .d(new_n62_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n87_), .c(new_n72_), .O(z08));
  nor2   g56(.a(x12), .b(x11), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n77_), .c(new_n75_), .d(new_n74_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n48_), .c(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n37_), .O(new_n94_));
  oai21  g60(.a(new_n37_), .b(x06), .c(new_n94_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  inv1   g62(.a(x11), .O(new_n97_));
  inv1   g63(.a(x12), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n75_), .O(new_n99_));
  aoi22  g65(.a(new_n99_), .b(new_n96_), .c(new_n47_), .d(x16), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n74_), .c(x08), .d(x07), .O(new_n101_));
  nand2  g67(.a(new_n71_), .b(x14), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n36_), .c(new_n102_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n37_), .O(new_n104_));
  nand3  g70(.a(new_n71_), .b(x14), .c(new_n36_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n43_), .O(z10));
  nand2  g72(.a(new_n70_), .b(new_n35_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n35_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n43_), .c(new_n70_), .O(z12));
  nor2   g75(.a(new_n38_), .b(new_n43_), .O(z13));
  nand2  g76(.a(x17), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n70_), .O(z14));
endmodule
