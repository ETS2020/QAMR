...
module FAU ( 
  ...
  oai21  g31(.a(x10), .b(new_n45_), .c(new_n35_), .O(new_n66_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n50_), .d(x04), .O(z08));
  ...
  or2    g59(.a(new_n50_), .b(new_n40_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n45_), .O(z10));
  inv1   g61(.a(new_n36_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n37_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n37_), .c(x03), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n45_), .c(new_n96_), .O(z12));
  nand2  g65(.a(new_n35_), .b(new_n45_), .O(z13));
  nand2  g66(.a(x17), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n96_), .O(z14));
endmodule
