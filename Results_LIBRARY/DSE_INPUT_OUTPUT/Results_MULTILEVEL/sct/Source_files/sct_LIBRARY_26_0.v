...
module FAU ( 
  ...
  aoi21  g31(.a(new_n65_), .b(x09), .c(new_n47_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n39_), .c(new_n64_), .O(z05));
  ...
  nand3  g45(.a(new_n79_), .b(new_n75_), .c(new_n74_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n62_), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  aoi21  g48(.a(new_n77_), .b(x12), .c(new_n47_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n39_), .c(new_n82_), .O(z08));
  nand3  g50(.a(new_n70_), .b(new_n79_), .c(new_n75_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n65_), .c(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n79_), .c(new_n75_), .d(new_n74_), .O(new_n88_));
  or2    g54(.a(new_n88_), .b(new_n68_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  aoi21  g57(.a(new_n88_), .b(new_n91_), .c(new_n47_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n61_), .c(x08), .d(x07), .O(new_n93_));
  nand2  g59(.a(new_n47_), .b(x14), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n40_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x04), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n54_), .O(z10));
  nor2   g63(.a(new_n36_), .b(new_n35_), .O(z11));
  aoi21  g64(.a(x16), .b(new_n35_), .c(x03), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n39_), .c(new_n54_), .O(z12));
