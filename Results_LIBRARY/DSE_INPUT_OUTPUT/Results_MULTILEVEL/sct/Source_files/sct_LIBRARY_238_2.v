...
module FAU ( 
  ...
  nor2   g43(.a(x12), .b(x11), .O(new_n79_));
  nand3  g44(.a(new_n79_), .b(new_n63_), .c(new_n67_), .O(new_n80_));
  ...
  nand2  g48(.a(new_n79_), .b(new_n67_), .O(new_n84_));
  oai21  g49(.a(new_n84_), .b(new_n62_), .c(x13), .O(new_n85_));
  nor2   g50(.a(x13), .b(x12), .O(new_n86_));
  nand3  g51(.a(new_n86_), .b(new_n73_), .c(new_n63_), .O(new_n87_));
  nand3  g52(.a(new_n87_), .b(new_n85_), .c(new_n51_), .O(new_n88_));
  nand2  g53(.a(new_n88_), .b(x06), .O(new_n89_));
  nand2  g54(.a(new_n89_), .b(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n91_));
  nand2  g56(.a(new_n86_), .b(new_n73_), .O(new_n92_));
  aoi21  g57(.a(new_n92_), .b(new_n91_), .c(new_n50_), .O(new_n93_));
  nand4  g58(.a(new_n93_), .b(new_n61_), .c(x08), .d(x07), .O(new_n94_));
  aoi21  g59(.a(new_n50_), .b(x14), .c(new_n60_), .O(new_n95_));
  aoi21  g60(.a(new_n95_), .b(new_n94_), .c(new_n35_), .O(z10));
  nor2   g61(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g62(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n98_));
