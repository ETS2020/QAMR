...
module FAU ( 
  ...
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(new_n91_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n68_), .c(x13), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n85_), .c(new_n84_), .d(new_n91_), .O(new_n95_));
  or2    g61(.a(new_n95_), .b(new_n65_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n93_), .c(new_n48_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n90_), .O(z09));
  ...
  or2    g70(.a(new_n48_), .b(new_n40_), .O(new_n105_));
