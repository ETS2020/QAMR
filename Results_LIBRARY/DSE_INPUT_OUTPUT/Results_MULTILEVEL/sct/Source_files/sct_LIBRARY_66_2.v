...
module FAU ( 
  ...
  and2   g29(.a(new_n64_), .b(x06), .O(new_n65_));
  nand4  g30(.a(new_n65_), .b(new_n62_), .c(new_n49_), .d(x04), .O(z06));
  nand2  g31(.a(new_n64_), .b(x11), .O(new_n67_));
  inv1   g32(.a(x11), .O(new_n68_));
  nand4  g33(.a(new_n56_), .b(new_n68_), .c(new_n63_), .d(new_n55_), .O(new_n69_));
  nand3  g34(.a(new_n69_), .b(new_n67_), .c(new_n49_), .O(new_n70_));
  nand2  g35(.a(new_n70_), .b(x06), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(x04), .O(z07));
  nand2  g37(.a(new_n69_), .b(x12), .O(new_n73_));
  inv1   g38(.a(new_n58_), .O(new_n74_));
  nor3   g39(.a(x12), .b(x11), .c(x10), .O(new_n75_));
  aoi21  g40(.a(new_n75_), .b(new_n74_), .c(new_n36_), .O(new_n76_));
  nand4  g41(.a(new_n76_), .b(new_n73_), .c(new_n49_), .d(x04), .O(z08));
  nand2  g42(.a(new_n75_), .b(new_n74_), .O(new_n78_));
  nand2  g43(.a(new_n78_), .b(x13), .O(new_n79_));
  inv1   g44(.a(x12), .O(new_n80_));
  inv1   g45(.a(x13), .O(new_n81_));
  nand4  g46(.a(new_n81_), .b(new_n80_), .c(new_n68_), .d(new_n63_), .O(new_n82_));
  inv1   g47(.a(new_n82_), .O(new_n83_));
  aoi21  g48(.a(new_n83_), .b(new_n74_), .c(new_n36_), .O(new_n84_));
  nand4  g49(.a(new_n84_), .b(new_n79_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g50(.a(x00), .O(new_n86_));
  nand2  g51(.a(new_n82_), .b(new_n86_), .O(new_n87_));
  nand4  g52(.a(new_n87_), .b(new_n49_), .c(new_n55_), .d(x08), .O(new_n88_));
  nand2  g53(.a(new_n57_), .b(x14), .O(new_n89_));
  oai21  g54(.a(new_n88_), .b(new_n48_), .c(new_n89_), .O(new_n90_));
  nand3  g55(.a(new_n90_), .b(x06), .c(x04), .O(new_n91_));
  inv1   g56(.a(new_n91_), .O(z10));
  nand2  g57(.a(new_n37_), .b(new_n38_), .O(z11));
  inv1   g58(.a(x03), .O(new_n94_));
  aoi21  g59(.a(x16), .b(new_n38_), .c(new_n36_), .O(new_n95_));
  aoi21  g60(.a(new_n95_), .b(new_n94_), .c(new_n44_), .O(z12));
  nor2   g61(.a(new_n36_), .b(new_n44_), .O(z13));
  inv1   g62(.a(x17), .O(new_n98_));
  aoi21  g63(.a(new_n98_), .b(x06), .c(new_n44_), .O(z14));
  zero   g64(.O(z02));
endmodule
