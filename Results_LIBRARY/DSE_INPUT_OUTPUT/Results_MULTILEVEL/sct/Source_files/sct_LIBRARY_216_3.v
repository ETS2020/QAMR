...
module FAU ( 
  ...
  nand2  g00(.a(x18), .b(x15), .O(new_n35_));
  ...
  inv1   g08(.a(new_n35_), .O(new_n43_));
  ...
  nand4  g24(.a(new_n58_), .b(new_n50_), .c(new_n35_), .d(x04), .O(new_n59_));
  ...
  aoi21  g32(.a(new_n66_), .b(new_n50_), .c(new_n43_), .O(z05));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n50_), .c(new_n43_), .O(z06));
  ...
  and2   g43(.a(new_n77_), .b(new_n35_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n73_), .c(new_n50_), .d(x04), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n50_), .c(new_n43_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n64_), .c(x04), .O(new_n87_));
  aoi21  g53(.a(new_n81_), .b(x13), .c(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n50_), .c(new_n43_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  aoi21  g56(.a(new_n86_), .b(new_n90_), .c(new_n49_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n63_), .c(x08), .d(x07), .O(new_n92_));
  nand2  g58(.a(new_n49_), .b(x14), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n46_), .c(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n35_), .c(x04), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(z10));
  nor2   g62(.a(new_n43_), .b(new_n37_), .O(z11));
  oai21  g63(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n35_), .c(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z12));
  nor2   g66(.a(new_n43_), .b(new_n42_), .O(z13));
  nand3  g67(.a(new_n35_), .b(x17), .c(x04), .O(new_n102_));
