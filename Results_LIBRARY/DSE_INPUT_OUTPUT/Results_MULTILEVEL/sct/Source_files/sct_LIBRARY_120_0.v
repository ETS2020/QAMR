...
module FAU ( 
  ...
  aoi21  g18(.a(new_n47_), .b(x02), .c(new_n49_), .O(new_n53_));
  ...
  nand2  g25(.a(x08), .b(new_n42_), .O(new_n60_));
  ...
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n53_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n40_), .c(new_n67_), .O(z05));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n69_), .c(new_n40_), .O(new_n74_));
  nand4  g40(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(x10), .c(new_n53_), .O(new_n76_));
  oai22  g42(.a(new_n76_), .b(new_n40_), .c(new_n74_), .d(new_n42_), .O(z06));
  inv1   g43(.a(x10), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n64_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n68_), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  nand4  g48(.a(new_n73_), .b(x08), .c(x07), .d(x06), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(x11), .c(new_n53_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n40_), .c(new_n82_), .O(z07));
  oai21  g51(.a(new_n80_), .b(new_n70_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(new_n70_), .O(new_n88_));
  nand4  g54(.a(new_n73_), .b(new_n88_), .c(new_n87_), .d(new_n79_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n54_), .d(x04), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n79_), .d(new_n78_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n65_), .c(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x06), .O(new_n94_));
  aoi21  g60(.a(new_n89_), .b(x13), .c(new_n53_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n40_), .c(new_n94_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  aoi21  g63(.a(new_n92_), .b(new_n97_), .c(new_n53_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n64_), .c(x08), .d(x07), .O(new_n99_));
  ...
  nand2  g68(.a(new_n102_), .b(new_n57_), .O(z10));
  nor2   g69(.a(new_n36_), .b(new_n35_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n35_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n40_), .c(new_n57_), .O(z12));
