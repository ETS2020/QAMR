...
module FAU ( 
  ...
  aoi21  g56(.a(new_n84_), .b(x13), .c(new_n54_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n41_), .c(new_n90_), .O(z09));
  inv1   g58(.a(new_n35_), .O(new_n93_));
  inv1   g59(.a(x00), .O(new_n94_));
  aoi21  g60(.a(new_n88_), .b(new_n94_), .c(new_n54_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n65_), .c(x08), .d(x07), .O(new_n96_));
  nand2  g62(.a(new_n54_), .b(x14), .O(new_n97_));
  ...
  aoi21  g68(.a(new_n102_), .b(new_n48_), .c(new_n41_), .O(z12));
  nand2  g69(.a(x06), .b(new_n41_), .O(z13));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n93_), .O(z14));
endmodule
