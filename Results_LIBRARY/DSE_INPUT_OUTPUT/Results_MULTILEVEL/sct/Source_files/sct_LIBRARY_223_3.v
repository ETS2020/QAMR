...
module FAU ( 
  ...
  nand2  g00(.a(x08), .b(x06), .O(new_n35_));
  ...
  nor2   g27(.a(x09), .b(new_n44_), .O(new_n62_));
  aoi21  g28(.a(new_n62_), .b(new_n50_), .c(new_n36_), .O(z05));
  inv1   g29(.a(x10), .O(new_n64_));
  nand4  g30(.a(new_n50_), .b(new_n35_), .c(new_n64_), .d(x04), .O(z06));
  inv1   g31(.a(x11), .O(new_n66_));
  nand4  g32(.a(new_n50_), .b(new_n35_), .c(new_n66_), .d(x04), .O(z07));
  inv1   g33(.a(x12), .O(new_n68_));
  nand4  g34(.a(new_n50_), .b(new_n35_), .c(new_n68_), .d(x04), .O(z08));
  nor2   g35(.a(x13), .b(new_n44_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n50_), .c(new_n36_), .O(z09));
  nand4  g37(.a(new_n49_), .b(x16), .c(x14), .d(x04), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n35_), .O(z10));
  nor2   g39(.a(new_n36_), .b(new_n37_), .O(z11));
  inv1   g40(.a(x16), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(x02), .c(new_n48_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n35_), .c(x04), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(z12));
  nand2  g44(.a(new_n35_), .b(new_n44_), .O(z13));
  nand2  g45(.a(x17), .b(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n35_), .O(z14));
endmodule
