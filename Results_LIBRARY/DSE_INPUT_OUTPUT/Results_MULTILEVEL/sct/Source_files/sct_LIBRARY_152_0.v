...
module FAU ( 
  ...
  nand3  g16(.a(x17), .b(x07), .c(new_n50_), .O(new_n51_));
  ...
  oai21  g27(.a(new_n61_), .b(x09), .c(new_n50_), .O(new_n62_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n64_), .c(new_n62_), .d(new_n47_), .O(z05));
  oai21  g35(.a(new_n61_), .b(x10), .c(new_n50_), .O(new_n70_));
  ...
  nand3  g44(.a(x17), .b(x10), .c(new_n50_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z06));
  oai21  g46(.a(new_n61_), .b(x11), .c(new_n50_), .O(new_n81_));
  ...
  nand3  g51(.a(x17), .b(x11), .c(new_n50_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z07));
  oai21  g53(.a(new_n61_), .b(x12), .c(new_n50_), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  or2    g55(.a(new_n84_), .b(new_n89_), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  nand4  g57(.a(new_n89_), .b(new_n91_), .c(new_n74_), .d(new_n65_), .O(new_n92_));
  nor3   g58(.a(new_n92_), .b(new_n63_), .c(new_n50_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n42_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n88_), .d(new_n47_), .O(z08));
  oai21  g61(.a(new_n61_), .b(x13), .c(new_n50_), .O(new_n96_));
  nand3  g62(.a(new_n89_), .b(new_n91_), .c(new_n74_), .O(new_n97_));
  ...
  aoi21  g67(.a(new_n101_), .b(new_n67_), .c(new_n42_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n98_), .c(new_n96_), .d(new_n47_), .O(z09));
  ...
  nand4  g76(.a(new_n46_), .b(x17), .c(x16), .d(x14), .O(new_n111_));
  ...
  nand3  g81(.a(new_n115_), .b(new_n55_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n55_), .b(new_n42_), .O(z13));
  nor2   g84(.a(new_n61_), .b(new_n42_), .O(z14));
endmodule
