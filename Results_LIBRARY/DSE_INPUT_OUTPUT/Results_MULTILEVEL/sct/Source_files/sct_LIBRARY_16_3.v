...
module FAU ( 
  ...
  oai21  g05(.a(x07), .b(x05), .c(x04), .O(new_n40_));
  ...
  nand4  g15(.a(new_n47_), .b(new_n45_), .c(x06), .d(x04), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z03));
  nand2  g17(.a(new_n47_), .b(x08), .O(new_n52_));
  aoi21  g18(.a(new_n52_), .b(new_n45_), .c(new_n42_), .O(z04));
  nor2   g19(.a(x09), .b(x07), .O(new_n54_));
  ...
  oai21  g24(.a(new_n58_), .b(x10), .c(new_n45_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z06));
  nor2   g26(.a(x11), .b(x07), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n47_), .c(x04), .O(z07));
  nor2   g28(.a(x12), .b(x07), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n47_), .c(x04), .O(z08));
  oai21  g30(.a(new_n58_), .b(x13), .c(new_n45_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(z09));
  nand3  g32(.a(new_n58_), .b(x14), .c(new_n45_), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n42_), .O(z10));
  oai21  g34(.a(new_n45_), .b(new_n42_), .c(new_n35_), .O(z11));
  aoi21  g35(.a(x16), .b(new_n35_), .c(x07), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n56_), .c(new_n42_), .O(z12));
