...
module FAU ( 
  ...
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .d(new_n64_), .O(new_n77_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n75_), .c(new_n69_), .d(new_n64_), .O(new_n84_));
  ...
  aoi21  g61(.a(x16), .b(new_n35_), .c(new_n82_), .O(new_n96_));
