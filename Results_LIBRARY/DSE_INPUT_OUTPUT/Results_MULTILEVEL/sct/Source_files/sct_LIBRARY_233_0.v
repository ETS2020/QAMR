...
module FAU ( 
  ...
  aoi21  g34(.a(new_n68_), .b(x09), .c(new_n48_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n40_), .c(new_n67_), .O(z05));
  ...
  or2    g54(.a(new_n88_), .b(new_n71_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  aoi21  g57(.a(new_n88_), .b(new_n91_), .c(new_n48_), .O(new_n92_));
  ...
  nand2  g62(.a(new_n96_), .b(new_n52_), .O(z10));
  nor2   g63(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g64(.a(x16), .b(new_n36_), .c(x03), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n40_), .c(new_n52_), .O(z12));
  nand2  g66(.a(x06), .b(new_n40_), .O(z13));
