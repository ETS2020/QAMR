...
module FAU ( 
  ...
  nand4  g32(.a(new_n66_), .b(new_n63_), .c(new_n50_), .d(x04), .O(z06));
  ...
  nand3  g41(.a(new_n75_), .b(new_n69_), .c(new_n64_), .O(new_n76_));
  ...
  oai21  g46(.a(new_n76_), .b(new_n59_), .c(x13), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n75_), .c(new_n69_), .d(new_n64_), .O(new_n83_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n50_), .c(new_n56_), .d(x08), .O(new_n90_));
  nand3  g56(.a(new_n49_), .b(x16), .c(x14), .O(new_n91_));
