...
module FAU ( 
  ...
  aoi21  g17(.a(new_n51_), .b(x17), .c(x06), .O(z02));
  ...
  nand3  g23(.a(x17), .b(x08), .c(new_n56_), .O(new_n58_));
  ...
  oai21  g28(.a(new_n62_), .b(x09), .c(new_n56_), .O(new_n63_));
  ...
  nand3  g35(.a(x17), .b(x09), .c(new_n56_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z05));
  oai21  g37(.a(new_n62_), .b(x10), .c(new_n56_), .O(new_n72_));
  ...
  oai21  g46(.a(new_n62_), .b(x11), .c(new_n56_), .O(new_n81_));
  ...
  oai21  g53(.a(new_n62_), .b(x12), .c(new_n56_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n51_), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  aoi21  g56(.a(new_n85_), .b(new_n66_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g61(.a(x17), .b(x12), .c(new_n56_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z08));
  oai21  g63(.a(new_n62_), .b(x13), .c(new_n56_), .O(new_n98_));
  ...
  oai22  g67(.a(new_n101_), .b(new_n67_), .c(new_n94_), .d(new_n100_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x06), .O(new_n103_));
  nand3  g69(.a(x17), .b(x13), .c(new_n56_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(z09));
  ...
  nand2  g77(.a(new_n111_), .b(new_n36_), .O(z10));
  nand2  g78(.a(new_n36_), .b(new_n38_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n38_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n44_), .c(new_n36_), .O(z12));
  nor2   g81(.a(new_n35_), .b(new_n44_), .O(z13));
  nor2   g82(.a(new_n62_), .b(new_n44_), .O(z14));
endmodule
