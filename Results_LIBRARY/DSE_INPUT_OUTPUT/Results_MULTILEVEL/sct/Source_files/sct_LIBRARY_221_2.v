...
module FAU ( 
  ...
  nand2  g40(.a(new_n74_), .b(new_n62_), .O(new_n75_));
  nor2   g41(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n72_), .c(new_n49_), .d(x04), .O(z08));
  oai21  g44(.a(new_n75_), .b(new_n57_), .c(x13), .O(new_n79_));
  inv1   g45(.a(new_n57_), .O(new_n80_));
  nor2   g46(.a(x13), .b(x12), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n67_), .c(new_n80_), .O(new_n82_));
  ...
  aoi21  g55(.a(new_n48_), .b(x14), .c(new_n73_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n36_), .O(z10));
  oai21  g57(.a(x06), .b(new_n36_), .c(new_n35_), .O(z11));
  oai21  g58(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x06), .c(x04), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(z12));
  nor2   g61(.a(new_n73_), .b(new_n36_), .O(z13));
