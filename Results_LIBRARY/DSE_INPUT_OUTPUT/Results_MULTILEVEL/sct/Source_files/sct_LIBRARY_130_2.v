...
module FAU ( 
  ...
  nand4  g36(.a(new_n70_), .b(new_n59_), .c(x08), .d(x07), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n50_), .O(new_n72_));
  ...
  oai21  g59(.a(x06), .b(new_n35_), .c(new_n37_), .O(z11));
