...
module FAU ( 
  ...
  oai21  g08(.a(x13), .b(new_n42_), .c(x05), .O(new_n43_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n52_), .c(new_n37_), .O(z08));
  oai21  g52(.a(new_n51_), .b(new_n42_), .c(new_n47_), .O(new_n87_));
  nand3  g53(.a(new_n83_), .b(x13), .c(new_n35_), .O(new_n88_));
  nand4  g54(.a(new_n36_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n67_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n88_), .c(new_n87_), .O(z09));
  ...
  oai21  g67(.a(new_n101_), .b(new_n42_), .c(new_n47_), .O(z12));
  nor2   g68(.a(new_n37_), .b(new_n42_), .O(z13));
