...
module FAU ( 
  ...
  nand3  g36(.a(new_n70_), .b(new_n37_), .c(x04), .O(new_n71_));
  aoi21  g37(.a(new_n65_), .b(x10), .c(new_n71_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n51_), .O(z06));
  ...
  oai21  g65(.a(new_n99_), .b(new_n42_), .c(new_n37_), .O(z12));
  oai21  g66(.a(x18), .b(new_n35_), .c(new_n42_), .O(z13));
  nand3  g67(.a(x18), .b(x17), .c(x04), .O(new_n102_));
