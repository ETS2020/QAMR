...
module FAU ( 
  ...
  nor2   g29(.a(new_n63_), .b(new_n36_), .O(new_n64_));
  nand4  g30(.a(new_n64_), .b(new_n60_), .c(new_n48_), .d(x04), .O(z05));
  inv1   g31(.a(x10), .O(new_n66_));
  oai21  g32(.a(new_n63_), .b(x13), .c(new_n66_), .O(new_n67_));
  aoi21  g33(.a(new_n62_), .b(x10), .c(new_n43_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n48_), .O(z06));
  inv1   g35(.a(new_n48_), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(new_n43_), .c(new_n47_), .O(new_n71_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n74_), .c(new_n35_), .d(new_n73_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n72_), .c(new_n71_), .O(z07));
  nand2  g43(.a(x07), .b(x06), .O(new_n78_));
  nand3  g44(.a(new_n73_), .b(new_n61_), .c(x08), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n78_), .c(new_n35_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n66_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x12), .O(new_n82_));
  nor2   g48(.a(x13), .b(x12), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n63_), .c(new_n73_), .d(new_n66_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n82_), .c(new_n71_), .O(z08));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n75_), .b(new_n74_), .c(new_n86_), .d(new_n73_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n48_), .c(new_n35_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  inv1   g55(.a(x03), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x02), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(x16), .c(x09), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(x08), .c(x07), .d(x06), .O(new_n93_));
  nand2  g59(.a(new_n70_), .b(x14), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n89_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n47_), .O(new_n96_));
  nand4  g62(.a(new_n48_), .b(new_n35_), .c(new_n86_), .d(new_n73_), .O(new_n97_));
  nor3   g63(.a(new_n97_), .b(x10), .c(x09), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(x08), .c(x07), .d(x06), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n96_), .c(new_n43_), .O(z10));
  nor2   g66(.a(new_n36_), .b(new_n37_), .O(z11));
  inv1   g67(.a(x16), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(x02), .c(new_n90_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n47_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z12));
  nor2   g71(.a(new_n36_), .b(new_n43_), .O(z13));
  inv1   g72(.a(x17), .O(new_n107_));
  nor3   g73(.a(new_n36_), .b(new_n107_), .c(new_n43_), .O(z14));
endmodule
