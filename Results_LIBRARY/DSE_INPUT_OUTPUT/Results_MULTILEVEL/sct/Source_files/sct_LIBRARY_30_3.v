...
module FAU ( 
  ...
  nand2  g26(.a(new_n60_), .b(new_n36_), .O(new_n61_));
  nand4  g27(.a(x08), .b(new_n35_), .c(new_n49_), .d(x02), .O(new_n62_));
  aoi21  g28(.a(new_n62_), .b(new_n61_), .c(new_n45_), .O(z04));
  ...
  nand2  g38(.a(new_n48_), .b(new_n45_), .O(z13));
  oai21  g39(.a(new_n50_), .b(x10), .c(new_n35_), .O(new_n74_));
  inv1   g40(.a(x10), .O(new_n75_));
  nor2   g41(.a(new_n55_), .b(new_n35_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n64_), .d(x08), .O(new_n77_));
  oai21  g43(.a(new_n66_), .b(new_n75_), .c(new_n77_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n36_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(z13), .O(z06));
  nand2  g46(.a(x08), .b(x07), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n75_), .c(new_n64_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n81_), .c(new_n36_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  nand3  g51(.a(new_n82_), .b(new_n49_), .c(x02), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x16), .O(new_n87_));
  nand2  g53(.a(new_n77_), .b(x11), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n85_), .d(x04), .O(z07));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n82_), .c(new_n75_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n65_), .c(new_n36_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  nand3  g59(.a(new_n90_), .b(new_n49_), .c(x02), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x16), .O(new_n95_));
  oai21  g61(.a(new_n83_), .b(new_n70_), .c(x12), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n93_), .d(x04), .O(z08));
  oai21  g63(.a(new_n50_), .b(x13), .c(new_n35_), .O(new_n98_));
  oai21  g64(.a(new_n91_), .b(new_n65_), .c(x13), .O(new_n99_));
  nand3  g65(.a(new_n76_), .b(new_n64_), .c(x08), .O(new_n100_));
  inv1   g66(.a(x13), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n90_), .c(new_n82_), .d(new_n75_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n36_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n98_), .c(z13), .O(z09));
