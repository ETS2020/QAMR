...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n50_), .d(x04), .O(z08));
  oai21  g45(.a(x13), .b(new_n38_), .c(new_n45_), .O(new_n80_));
  nand3  g46(.a(new_n63_), .b(x08), .c(x07), .O(new_n81_));
  nand3  g47(.a(new_n77_), .b(new_n72_), .c(new_n71_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n81_), .c(x13), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n77_), .c(new_n72_), .d(new_n71_), .O(new_n85_));
  or2    g51(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n83_), .c(new_n50_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n80_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n50_), .c(new_n63_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x07), .c(x06), .O(new_n94_));
  or2    g60(.a(new_n50_), .b(new_n36_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n38_), .O(z10));
  nand2  g62(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n40_), .c(x03), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n38_), .O(z12));
  nand2  g65(.a(x17), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n39_), .O(z14));
  buf    g67(.a(x04), .O(z13));
endmodule
