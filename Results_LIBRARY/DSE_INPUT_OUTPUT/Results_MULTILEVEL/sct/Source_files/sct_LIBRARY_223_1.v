...
module FAU ( 
  ...
  nand4  g21(.a(new_n55_), .b(new_n49_), .c(x06), .d(x04), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z04));
  inv1   g23(.a(new_n49_), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n45_), .c(new_n36_), .O(new_n59_));
  inv1   g25(.a(x09), .O(new_n60_));
  nor2   g26(.a(new_n60_), .b(x07), .O(new_n61_));
  nand3  g27(.a(new_n60_), .b(x08), .c(x07), .O(new_n62_));
  inv1   g28(.a(new_n62_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(new_n61_), .c(x06), .O(new_n64_));
  nand2  g30(.a(x09), .b(new_n48_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n59_), .O(z05));
  oai21  g32(.a(x10), .b(x08), .c(new_n35_), .O(new_n67_));
  nand2  g33(.a(new_n62_), .b(x10), .O(new_n68_));
  inv1   g34(.a(x10), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n60_), .c(x08), .d(x07), .O(new_n70_));
  and2   g36(.a(new_n70_), .b(x04), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n49_), .O(z06));
  oai21  g38(.a(x11), .b(x08), .c(new_n35_), .O(new_n73_));
  nand2  g39(.a(new_n70_), .b(x11), .O(new_n74_));
  nor2   g40(.a(x11), .b(x10), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n60_), .c(x08), .d(x07), .O(new_n76_));
  and2   g42(.a(new_n76_), .b(x04), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n73_), .d(new_n49_), .O(z07));
  oai21  g44(.a(x12), .b(x08), .c(new_n35_), .O(new_n79_));
  nand2  g45(.a(new_n76_), .b(x12), .O(new_n80_));
  nor3   g46(.a(x12), .b(x11), .c(x10), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n63_), .c(new_n45_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n49_), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  inv1   g50(.a(x07), .O(new_n85_));
  nor2   g51(.a(x09), .b(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n81_), .c(new_n84_), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n84_), .b(new_n89_), .c(new_n88_), .d(new_n69_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n62_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n87_), .c(x06), .O(new_n92_));
  nand2  g58(.a(x13), .b(new_n48_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n59_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n90_), .b(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n49_), .c(new_n60_), .d(x08), .O(new_n97_));
  nand2  g63(.a(new_n58_), .b(x14), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n85_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n36_), .O(z10));
  ...
  nand2  g73(.a(new_n36_), .b(new_n45_), .O(z13));
