...
module FAU ( 
  ...
  oai21  g43(.a(x11), .b(x06), .c(x05), .O(new_n78_));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n81_), .c(new_n44_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n78_), .d(new_n50_), .O(z07));
  ...
  oai21  g55(.a(new_n89_), .b(new_n86_), .c(new_n35_), .O(new_n90_));
  nand2  g56(.a(x12), .b(new_n36_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n62_), .O(z08));
  oai21  g58(.a(x13), .b(x06), .c(x05), .O(new_n93_));
  ...
  nor2   g64(.a(new_n98_), .b(new_n44_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n94_), .c(new_n93_), .d(new_n50_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n97_), .b(new_n101_), .c(new_n49_), .O(new_n102_));
  ...
  nand3  g72(.a(new_n49_), .b(x14), .c(new_n36_), .O(new_n107_));
  ...
  oai21  g76(.a(new_n110_), .b(new_n44_), .c(new_n53_), .O(z12));
  nor2   g77(.a(new_n37_), .b(new_n44_), .O(z13));
  nand3  g78(.a(new_n53_), .b(x17), .c(x04), .O(new_n113_));
