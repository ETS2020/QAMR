...
module FAU ( 
  ...
  oai21  g26(.a(new_n49_), .b(new_n41_), .c(new_n42_), .O(new_n61_));
  ...
  nand2  g36(.a(new_n70_), .b(x18), .O(new_n71_));
  ...
  nand4  g42(.a(new_n76_), .b(x18), .c(new_n74_), .d(new_n69_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n73_), .c(new_n61_), .O(z06));
  nor2   g44(.a(x11), .b(x10), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n63_), .c(new_n69_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x18), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  nand2  g48(.a(new_n77_), .b(x11), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n50_), .d(x04), .O(z07));
  inv1   g50(.a(x11), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n74_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n70_), .c(x18), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  nand4  g55(.a(x18), .b(new_n85_), .c(new_n74_), .d(new_n69_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n75_), .c(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n89_), .c(new_n50_), .d(x04), .O(z08));
  nor2   g58(.a(x13), .b(x12), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n79_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n70_), .c(x18), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand4  g62(.a(new_n69_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand3  g63(.a(new_n79_), .b(x18), .c(new_n86_), .O(new_n98_));
  ...
  nand2  g72(.a(new_n106_), .b(new_n42_), .O(z10));
  nand2  g73(.a(new_n42_), .b(new_n37_), .O(z11));
