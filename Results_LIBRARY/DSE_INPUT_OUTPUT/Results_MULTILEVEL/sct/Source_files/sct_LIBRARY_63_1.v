...
module FAU ( 
  ...
  nand2  g27(.a(new_n61_), .b(new_n45_), .O(z04));
  oai21  g28(.a(x13), .b(x09), .c(new_n53_), .O(new_n63_));
  oai21  g29(.a(new_n49_), .b(new_n42_), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g36(.a(new_n36_), .b(x09), .c(new_n53_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z05));
  oai21  g38(.a(x13), .b(x10), .c(new_n53_), .O(new_n73_));
  nand2  g39(.a(new_n68_), .b(x10), .O(new_n74_));
  nor2   g40(.a(new_n53_), .b(new_n46_), .O(new_n75_));
  nor2   g41(.a(x10), .b(x09), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x08), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(new_n75_), .c(new_n42_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n74_), .c(new_n73_), .d(new_n50_), .O(z06));
  oai21  g46(.a(x13), .b(x11), .c(new_n53_), .O(new_n81_));
  inv1   g47(.a(new_n76_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n65_), .c(x11), .O(new_n83_));
  nand3  g49(.a(x08), .b(x07), .c(x06), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  nor3   g51(.a(x11), .b(x10), .c(x09), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n85_), .c(new_n42_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n83_), .c(new_n81_), .d(new_n50_), .O(z07));
  oai21  g54(.a(x13), .b(x12), .c(new_n53_), .O(new_n89_));
  inv1   g55(.a(new_n86_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n65_), .c(x12), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(x12), .O(new_n93_));
  nand4  g59(.a(new_n85_), .b(new_n76_), .c(new_n93_), .d(new_n92_), .O(new_n94_));
  and2   g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n91_), .c(new_n89_), .d(new_n50_), .O(z08));
  nand2  g62(.a(new_n94_), .b(x13), .O(new_n97_));
  inv1   g63(.a(x10), .O(new_n98_));
  nand4  g64(.a(new_n36_), .b(new_n93_), .c(new_n92_), .d(new_n98_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n75_), .c(new_n67_), .d(x08), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n97_), .c(new_n50_), .d(x04), .O(z09));
  ...
  nand2  g74(.a(new_n108_), .b(new_n45_), .O(z10));
  nand2  g75(.a(new_n45_), .b(new_n35_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n35_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n42_), .c(new_n45_), .O(z12));
  nand2  g78(.a(new_n45_), .b(new_n42_), .O(z13));
  inv1   g79(.a(x17), .O(new_n114_));
  nor3   g80(.a(new_n37_), .b(new_n114_), .c(new_n42_), .O(z14));
endmodule
