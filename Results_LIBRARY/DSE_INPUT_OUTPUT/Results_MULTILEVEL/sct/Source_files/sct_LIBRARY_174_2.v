...
module FAU ( 
  ...
  nand3  g22(.a(new_n56_), .b(x15), .c(x06), .O(new_n57_));
  ...
  nand3  g33(.a(new_n67_), .b(x15), .c(x08), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(x09), .c(new_n65_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n64_), .c(new_n49_), .O(z05));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(x08), .c(x07), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x15), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x06), .O(new_n74_));
  inv1   g40(.a(x09), .O(new_n75_));
  nand3  g41(.a(x15), .b(new_n75_), .c(x08), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n66_), .c(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n49_), .d(x04), .O(z06));
  oai21  g44(.a(new_n48_), .b(new_n65_), .c(new_n37_), .O(new_n79_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n71_), .c(x15), .d(new_n81_), .O(new_n84_));
  ...
  oai21  g54(.a(new_n88_), .b(new_n62_), .c(x15), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  aoi21  g56(.a(new_n84_), .b(x12), .c(new_n65_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n49_), .O(z08));
  nand2  g58(.a(new_n90_), .b(x13), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand3  g60(.a(x15), .b(new_n94_), .c(new_n87_), .O(new_n95_));
  nor3   g61(.a(new_n95_), .b(x11), .c(x10), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n67_), .c(new_n61_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n93_), .c(new_n79_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand4  g65(.a(new_n94_), .b(new_n87_), .c(new_n81_), .d(new_n86_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n48_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n75_), .c(x08), .d(x07), .O(new_n102_));
  ...
  nor2   g72(.a(new_n36_), .b(new_n39_), .O(z11));
  oai21  g73(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n37_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nor2   g76(.a(new_n36_), .b(new_n65_), .O(z13));
