...
module FAU ( 
  ...
  oai21  g40(.a(x16), .b(x09), .c(x03), .O(new_n75_));
  nor2   g41(.a(new_n63_), .b(new_n54_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  inv1   g43(.a(new_n61_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x04), .O(new_n79_));
  aoi21  g45(.a(new_n77_), .b(x09), .c(new_n79_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n75_), .c(new_n74_), .O(z05));
  ...
  nand4  g52(.a(new_n71_), .b(x08), .c(x07), .d(x06), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(x10), .c(new_n79_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n85_), .O(z06));
  inv1   g55(.a(x10), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  nand4  g57(.a(new_n76_), .b(new_n91_), .c(new_n90_), .d(new_n71_), .O(new_n92_));
  ...
  aoi21  g62(.a(new_n96_), .b(x11), .c(new_n79_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(z07));
  nand2  g64(.a(new_n47_), .b(new_n44_), .O(new_n99_));
  nor2   g65(.a(new_n48_), .b(new_n35_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(x12), .c(new_n36_), .O(new_n101_));
  and2   g67(.a(new_n92_), .b(x12), .O(new_n102_));
  inv1   g68(.a(x12), .O(new_n103_));
  nand3  g69(.a(new_n82_), .b(new_n103_), .c(new_n91_), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n77_), .c(new_n78_), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n102_), .c(new_n35_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n101_), .c(new_n99_), .O(z08));
  oai21  g73(.a(new_n100_), .b(x13), .c(new_n36_), .O(new_n108_));
  nand3  g74(.a(new_n103_), .b(new_n91_), .c(new_n90_), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n72_), .c(x13), .O(new_n110_));
  inv1   g76(.a(x13), .O(new_n111_));
  nand4  g77(.a(new_n111_), .b(new_n103_), .c(new_n91_), .d(new_n90_), .O(new_n112_));
  or2    g78(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n110_), .c(new_n78_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n35_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n108_), .c(new_n99_), .O(z09));
  inv1   g82(.a(x00), .O(new_n117_));
  aoi21  g83(.a(new_n112_), .b(new_n117_), .c(new_n61_), .O(new_n118_));
  nand4  g84(.a(new_n118_), .b(new_n71_), .c(x08), .d(x07), .O(new_n119_));
