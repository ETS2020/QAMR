...
module FAU ( 
  ...
  aoi21  g20(.a(new_n46_), .b(x02), .c(new_n48_), .O(new_n55_));
  ...
  nand2  g26(.a(x08), .b(new_n41_), .O(new_n61_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n56_), .d(x04), .O(z08));
  ...
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n56_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  aoi21  g55(.a(new_n86_), .b(new_n89_), .c(new_n55_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n67_), .c(x08), .d(x07), .O(new_n91_));
  nand2  g57(.a(new_n55_), .b(x14), .O(new_n92_));
  oai21  g58(.a(new_n91_), .b(new_n41_), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n51_), .O(z10));
  nand2  g61(.a(new_n51_), .b(new_n36_), .O(z11));
  nand2  g62(.a(x16), .b(new_n36_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n46_), .c(new_n40_), .O(z12));
  nand2  g64(.a(x06), .b(new_n40_), .O(z13));
