...
module FAU ( 
  ...
  oai21  g48(.a(x11), .b(x06), .c(x01), .O(new_n83_));
  ...
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(new_n39_), .O(new_n94_));
  nand2  g60(.a(x12), .b(new_n36_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n74_), .O(z08));
  oai21  g62(.a(x13), .b(x06), .c(x01), .O(new_n97_));
  ...
  nand2  g75(.a(new_n109_), .b(new_n39_), .O(new_n110_));
  ...
  nand3  g82(.a(new_n47_), .b(x17), .c(x04), .O(new_n117_));
