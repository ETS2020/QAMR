...
module FAU ( 
  ...
  nand4  g49(.a(new_n67_), .b(new_n77_), .c(new_n83_), .d(new_n76_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n48_), .d(x04), .O(z08));
  nand2  g51(.a(new_n84_), .b(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n83_), .c(new_n76_), .d(new_n75_), .O(new_n88_));
  or2    g54(.a(new_n88_), .b(new_n62_), .O(new_n89_));
