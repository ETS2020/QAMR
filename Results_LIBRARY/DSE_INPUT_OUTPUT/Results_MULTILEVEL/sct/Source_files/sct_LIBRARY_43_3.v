...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(new_n51_), .c(x06), .O(new_n58_));
  ...
  nor2   g27(.a(new_n56_), .b(new_n50_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x06), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n47_), .c(new_n51_), .d(x04), .O(z05));
  inv1   g30(.a(new_n47_), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n43_), .c(new_n35_), .O(new_n66_));
  inv1   g32(.a(x10), .O(new_n67_));
  nand2  g33(.a(x07), .b(x06), .O(new_n68_));
  nand2  g34(.a(new_n67_), .b(x08), .O(new_n69_));
  oai22  g35(.a(new_n69_), .b(new_n68_), .c(new_n62_), .d(new_n67_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(new_n51_), .O(new_n71_));
  nand2  g37(.a(x10), .b(new_n46_), .O(new_n72_));
  ...
  nand2  g41(.a(new_n75_), .b(new_n51_), .O(new_n76_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n77_), .c(new_n47_), .O(z07));
  nor2   g47(.a(x12), .b(x11), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n62_), .c(new_n67_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n51_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  nand2  g51(.a(new_n74_), .b(new_n51_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n63_), .c(x12), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n47_), .d(x04), .O(z08));
  nand3  g54(.a(new_n67_), .b(x08), .c(x07), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n89_), .c(new_n51_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand2  g61(.a(new_n82_), .b(new_n78_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n63_), .c(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n95_), .c(new_n47_), .d(x04), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand4  g65(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n67_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n47_), .c(x08), .d(x07), .O(new_n102_));
  ...
  nand2  g71(.a(new_n105_), .b(new_n35_), .O(z10));
  nor2   g72(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n37_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n43_), .c(new_n35_), .O(z12));
  nand2  g75(.a(new_n35_), .b(new_n43_), .O(z13));
  nand2  g76(.a(x17), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n35_), .O(z14));
endmodule
