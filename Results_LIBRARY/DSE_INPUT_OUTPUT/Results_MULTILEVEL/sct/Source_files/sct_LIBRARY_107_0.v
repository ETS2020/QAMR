...
module FAU ( 
  ...
  nand3  g19(.a(x14), .b(x07), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g28(.a(new_n39_), .b(x09), .c(new_n53_), .O(new_n63_));
  ...
  nand3  g35(.a(x14), .b(x09), .c(new_n53_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z05));
  oai21  g37(.a(new_n39_), .b(x10), .c(new_n53_), .O(new_n72_));
  ...
  nand3  g44(.a(x14), .b(x10), .c(new_n53_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(z06));
  oai21  g46(.a(new_n39_), .b(x11), .c(new_n53_), .O(new_n81_));
  ...
  oai21  g53(.a(new_n39_), .b(x12), .c(new_n53_), .O(new_n88_));
  ...
  nand3  g61(.a(x14), .b(x12), .c(new_n53_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z08));
  oai21  g63(.a(new_n39_), .b(x13), .c(new_n53_), .O(new_n98_));
  ...
  nand3  g69(.a(x14), .b(x13), .c(new_n53_), .O(new_n104_));
  ...
  nand2  g74(.a(new_n47_), .b(x02), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n40_), .c(x16), .O(new_n110_));
  oai21  g76(.a(new_n108_), .b(new_n53_), .c(new_n110_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n37_), .O(z10));
  nand2  g79(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n35_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n44_), .c(new_n37_), .O(z12));
  nand2  g82(.a(new_n37_), .b(new_n44_), .O(z13));
