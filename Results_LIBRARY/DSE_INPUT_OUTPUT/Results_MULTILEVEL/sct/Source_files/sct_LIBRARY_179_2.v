...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(x15), .c(x06), .O(new_n58_));
  ...
  oai21  g29(.a(new_n48_), .b(new_n63_), .c(new_n37_), .O(new_n64_));
  ...
  oai21  g40(.a(new_n74_), .b(new_n65_), .c(x15), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  nand2  g42(.a(new_n71_), .b(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n49_), .d(x04), .O(z06));
  ...
  oai21  g64(.a(new_n98_), .b(new_n88_), .c(x15), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g66(.a(new_n70_), .b(new_n69_), .c(x08), .O(new_n101_));
  nand3  g67(.a(new_n80_), .b(x15), .c(new_n90_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n101_), .c(x13), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n100_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  aoi21  g71(.a(new_n98_), .b(new_n105_), .c(new_n48_), .O(new_n106_));
  ...
  nand3  g76(.a(new_n48_), .b(x14), .c(new_n35_), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n63_), .O(z10));
  nor2   g78(.a(new_n36_), .b(new_n39_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n39_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n63_), .c(new_n37_), .O(z12));
  nand2  g81(.a(new_n37_), .b(new_n63_), .O(z13));
