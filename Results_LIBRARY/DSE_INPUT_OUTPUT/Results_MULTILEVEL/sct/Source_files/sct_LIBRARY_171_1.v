...
module FAU ( 
  ...
  nand4  g56(.a(new_n90_), .b(new_n49_), .c(new_n62_), .d(x08), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n88_), .c(x04), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  inv1   g59(.a(new_n49_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(x14), .c(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n93_), .O(z10));
  nor2   g62(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n37_), .c(x03), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n43_), .O(z12));
