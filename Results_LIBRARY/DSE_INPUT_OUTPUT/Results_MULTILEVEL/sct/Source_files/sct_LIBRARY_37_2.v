...
module FAU ( 
  ...
  nand4  g17(.a(new_n51_), .b(new_n36_), .c(x04), .d(new_n47_), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z02));
  nand3  g19(.a(x07), .b(new_n36_), .c(new_n47_), .O(new_n54_));
  oai21  g20(.a(x07), .b(new_n36_), .c(new_n54_), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n51_), .c(x04), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z03));
  xnor2a g23(.a(x08), .b(x07), .O(new_n58_));
  nand2  g24(.a(x08), .b(new_n36_), .O(new_n59_));
  oai21  g25(.a(new_n58_), .b(new_n36_), .c(new_n59_), .O(new_n60_));
  nand3  g26(.a(new_n60_), .b(new_n51_), .c(x04), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n37_), .O(z04));
  oai21  g28(.a(x09), .b(x00), .c(new_n36_), .O(new_n63_));
  oai21  g29(.a(new_n50_), .b(new_n44_), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g35(.a(x09), .b(new_n36_), .c(new_n47_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z05));
  oai21  g37(.a(x10), .b(x00), .c(new_n36_), .O(new_n72_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n72_), .d(new_n51_), .O(z06));
  oai21  g43(.a(x11), .b(x00), .c(new_n36_), .O(new_n78_));
  nand2  g44(.a(new_n74_), .b(new_n66_), .O(new_n79_));
  ...
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n65_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n44_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n80_), .c(new_n78_), .d(new_n51_), .O(z07));
  ...
  nand3  g57(.a(new_n74_), .b(new_n91_), .c(new_n83_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n81_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n44_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n88_), .d(new_n51_), .O(z08));
  oai21  g61(.a(x13), .b(x00), .c(new_n36_), .O(new_n96_));
  oai21  g62(.a(new_n50_), .b(new_n44_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g67(.a(new_n101_), .b(new_n67_), .c(new_n99_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x06), .O(new_n103_));
  nand3  g69(.a(x13), .b(new_n36_), .c(new_n47_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n97_), .O(z09));
  inv1   g71(.a(x07), .O(new_n106_));
  nand2  g72(.a(new_n82_), .b(x06), .O(new_n107_));
  nand3  g73(.a(new_n100_), .b(new_n91_), .c(new_n83_), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n107_), .c(new_n47_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n51_), .c(new_n65_), .d(x08), .O(new_n110_));
  ...
  nand2  g84(.a(new_n37_), .b(new_n44_), .O(z13));
