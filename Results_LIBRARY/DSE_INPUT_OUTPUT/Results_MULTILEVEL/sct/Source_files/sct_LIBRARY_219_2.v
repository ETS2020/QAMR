...
module FAU ( 
  ...
  nand3  g18(.a(x13), .b(new_n52_), .c(x06), .O(new_n53_));
  ...
  nand3  g24(.a(x13), .b(x08), .c(new_n52_), .O(new_n59_));
  aoi21  g25(.a(new_n59_), .b(new_n58_), .c(new_n36_), .O(new_n60_));
  nor2   g26(.a(new_n57_), .b(x06), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n43_), .c(new_n46_), .O(z04));
  inv1   g29(.a(new_n49_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n43_), .c(new_n46_), .O(new_n65_));
  inv1   g31(.a(x13), .O(new_n66_));
  nor2   g32(.a(new_n57_), .b(new_n52_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(new_n66_), .c(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x09), .O(new_n69_));
  inv1   g35(.a(x09), .O(new_n70_));
  nor2   g36(.a(new_n52_), .b(new_n36_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(x13), .c(new_n70_), .d(x08), .O(new_n72_));
  ...
  nand4  g46(.a(new_n80_), .b(x13), .c(new_n78_), .d(new_n70_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n77_), .c(new_n65_), .O(z06));
  nor2   g48(.a(x10), .b(x09), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n67_), .c(new_n66_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n36_), .c(x11), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  nand4  g52(.a(new_n83_), .b(new_n80_), .c(x13), .d(new_n86_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n65_), .O(z07));
  ...
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n49_), .d(x04), .O(z08));
  nand4  g60(.a(x13), .b(new_n89_), .c(new_n86_), .d(new_n78_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n74_), .c(x06), .O(new_n96_));
  aoi21  g62(.a(x13), .b(new_n36_), .c(new_n43_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n49_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  aoi21  g65(.a(new_n48_), .b(x16), .c(x09), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(x08), .c(x07), .d(x06), .O(new_n101_));
  nand2  g67(.a(new_n64_), .b(x14), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x13), .O(new_n104_));
  nand3  g70(.a(new_n64_), .b(x14), .c(new_n36_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n43_), .O(z10));
  nor2   g72(.a(new_n37_), .b(new_n35_), .O(z11));
  inv1   g73(.a(x16), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(x02), .c(new_n47_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n46_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nor2   g77(.a(new_n37_), .b(new_n43_), .O(z13));
