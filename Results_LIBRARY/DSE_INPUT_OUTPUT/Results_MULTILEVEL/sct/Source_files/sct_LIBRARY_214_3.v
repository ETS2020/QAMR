...
module FAU ( 
  ...
  nand4  g16(.a(new_n48_), .b(new_n46_), .c(x06), .d(x04), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(z03));
  nand2  g18(.a(new_n48_), .b(x08), .O(new_n53_));
  aoi21  g19(.a(new_n53_), .b(new_n46_), .c(new_n40_), .O(z04));
  ...
  oai21  g25(.a(new_n57_), .b(x10), .c(new_n46_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z06));
  nor2   g27(.a(x11), .b(x07), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n48_), .c(x04), .O(z07));
  nor2   g29(.a(x12), .b(x07), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n48_), .c(x04), .O(z08));
  oai21  g31(.a(new_n57_), .b(x13), .c(new_n46_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x04), .O(z09));
  nand3  g33(.a(new_n57_), .b(x14), .c(new_n46_), .O(new_n68_));
  nor2   g34(.a(new_n68_), .b(new_n40_), .O(z10));
  nand2  g35(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g36(.a(x16), .b(new_n37_), .c(x07), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n55_), .c(new_n40_), .O(z12));
