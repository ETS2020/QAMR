...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(x07), .c(new_n47_), .O(new_n53_));
  ...
  oai21  g27(.a(x17), .b(x09), .c(new_n47_), .O(new_n62_));
  ...
  nand3  g35(.a(new_n35_), .b(x09), .c(new_n47_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z05));
  oai21  g37(.a(x17), .b(x10), .c(new_n47_), .O(new_n72_));
  ...
  oai21  g46(.a(x17), .b(x11), .c(new_n47_), .O(new_n81_));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n84_), .c(new_n44_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n82_), .c(new_n81_), .d(new_n50_), .O(z07));
  oai21  g55(.a(x17), .b(x12), .c(new_n47_), .O(new_n90_));
  ...
  aoi21  g61(.a(new_n95_), .b(new_n84_), .c(new_n44_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n92_), .c(new_n90_), .d(new_n50_), .O(z08));
  oai21  g63(.a(x17), .b(x13), .c(new_n47_), .O(new_n98_));
  ...
  nand3  g71(.a(new_n35_), .b(x13), .c(new_n47_), .O(new_n106_));
  ...
  nand4  g76(.a(new_n110_), .b(new_n50_), .c(new_n65_), .d(x08), .O(new_n111_));
  nand3  g77(.a(new_n49_), .b(x16), .c(x14), .O(new_n112_));
  oai21  g78(.a(new_n111_), .b(new_n108_), .c(new_n112_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(x06), .O(new_n114_));
  nand4  g80(.a(new_n49_), .b(new_n35_), .c(x16), .d(x14), .O(new_n115_));
  aoi21  g81(.a(new_n115_), .b(new_n114_), .c(new_n44_), .O(z10));
  nand2  g82(.a(new_n37_), .b(new_n39_), .O(z11));
  inv1   g83(.a(x16), .O(new_n118_));
  oai21  g84(.a(new_n118_), .b(x02), .c(new_n48_), .O(new_n119_));
  nand3  g85(.a(new_n119_), .b(new_n37_), .c(x04), .O(new_n120_));
  inv1   g86(.a(new_n120_), .O(z12));
  nor2   g87(.a(new_n36_), .b(new_n44_), .O(z13));
  aoi21  g88(.a(x06), .b(new_n44_), .c(new_n35_), .O(z14));
endmodule
