...
module FAU ( 
  ...
  nand2  g24(.a(x08), .b(new_n57_), .O(new_n59_));
  ...
  nand3  g36(.a(new_n35_), .b(x09), .c(new_n57_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z05));
  oai21  g38(.a(x13), .b(x10), .c(new_n57_), .O(new_n73_));
  ...
  oai21  g46(.a(x13), .b(x11), .c(new_n57_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  inv1   g48(.a(x11), .O(new_n83_));
  aoi21  g49(.a(new_n76_), .b(new_n67_), .c(new_n83_), .O(new_n84_));
  ...
  nor2   g57(.a(new_n85_), .b(new_n91_), .O(new_n92_));
  nor4   g58(.a(new_n68_), .b(x12), .c(x11), .d(x10), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n92_), .c(x06), .O(new_n94_));
  nand3  g60(.a(new_n35_), .b(x12), .c(new_n57_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(z08));
  nand2  g62(.a(new_n67_), .b(x06), .O(new_n97_));
  nand3  g63(.a(new_n76_), .b(new_n91_), .c(new_n83_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n97_), .c(x13), .O(new_n99_));
  inv1   g65(.a(x10), .O(new_n100_));
  nand4  g66(.a(new_n35_), .b(new_n91_), .c(new_n83_), .d(new_n100_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n75_), .c(new_n65_), .d(x08), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n99_), .c(new_n50_), .d(x04), .O(z09));
  ...
  oai21  g74(.a(new_n107_), .b(new_n57_), .c(new_n108_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n53_), .O(z10));
  nand2  g77(.a(new_n53_), .b(new_n37_), .O(z11));
  aoi21  g78(.a(x16), .b(new_n37_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n44_), .c(new_n53_), .O(z12));
