...
module FAU ( 
  ...
  inv1   g22(.a(x06), .O(new_n58_));
  inv1   g23(.a(x09), .O(new_n59_));
  nand3  g24(.a(new_n59_), .b(x08), .c(x07), .O(new_n60_));
  inv1   g25(.a(new_n60_), .O(new_n61_));
  nor2   g26(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand4  g27(.a(new_n62_), .b(new_n57_), .c(new_n50_), .d(x04), .O(z05));
  ...
  nand4  g35(.a(new_n70_), .b(new_n59_), .c(x08), .d(x07), .O(new_n71_));
  ...
  nand3  g42(.a(new_n77_), .b(new_n75_), .c(new_n50_), .O(new_n78_));
  ...
  nand3  g49(.a(new_n84_), .b(new_n82_), .c(new_n50_), .O(new_n85_));
