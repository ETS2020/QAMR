...
module FAU ( 
  ...
  oai21  g36(.a(x11), .b(new_n43_), .c(new_n35_), .O(new_n71_));
  nand3  g37(.a(new_n68_), .b(x08), .c(x07), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x11), .O(new_n73_));
  inv1   g39(.a(new_n62_), .O(new_n74_));
  nor2   g40(.a(x11), .b(x10), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n64_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n73_), .c(new_n48_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n71_), .O(z07));
  oai21  g45(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n80_));
  nand2  g46(.a(x08), .b(x07), .O(new_n81_));
  nand2  g47(.a(new_n75_), .b(new_n64_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n81_), .c(x12), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n68_), .b(new_n74_), .c(new_n85_), .d(new_n84_), .O(new_n86_));
  ...
  nand4  g58(.a(new_n92_), .b(new_n85_), .c(new_n84_), .d(new_n91_), .O(new_n93_));
  or2    g59(.a(new_n93_), .b(new_n65_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n48_), .d(x04), .O(z09));
  ...
  nand2  g74(.a(new_n108_), .b(new_n54_), .O(z14));
  buf    g75(.a(x04), .O(z13));
endmodule
