...
module FAU ( 
  ...
  and2   g13(.a(x16), .b(x04), .O(new_n48_));
  aoi21  g14(.a(new_n48_), .b(new_n47_), .c(x06), .O(z02));
  ...
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n54_), .d(x04), .O(z07));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n54_), .d(x04), .O(z08));
  ...
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n54_), .d(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n83_), .b(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n54_), .c(new_n64_), .d(x08), .O(new_n88_));
  ...
  nor2   g58(.a(new_n35_), .b(new_n36_), .O(z11));
  nand2  g59(.a(x16), .b(new_n36_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n46_), .c(new_n40_), .O(z12));
  nand2  g61(.a(x06), .b(new_n40_), .O(z13));
