...
module FAU ( 
  ...
  nand3  g23(.a(new_n35_), .b(x08), .c(new_n46_), .O(new_n58_));
  ...
  oai21  g27(.a(x12), .b(x09), .c(new_n46_), .O(new_n62_));
  ...
  oai21  g35(.a(x12), .b(x10), .c(new_n46_), .O(new_n70_));
  oai21  g36(.a(new_n49_), .b(new_n43_), .c(new_n70_), .O(new_n71_));
  ...
  oai22  g47(.a(new_n81_), .b(x06), .c(new_n49_), .d(new_n43_), .O(new_n82_));
  inv1   g48(.a(x11), .O(new_n83_));
  aoi21  g49(.a(new_n75_), .b(new_n74_), .c(new_n83_), .O(new_n84_));
  inv1   g50(.a(x10), .O(new_n85_));
  nand3  g51(.a(new_n83_), .b(new_n85_), .c(new_n65_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(new_n63_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n84_), .c(x06), .O(new_n88_));
  nand3  g54(.a(new_n35_), .b(x11), .c(new_n46_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n82_), .O(z07));
  nand2  g56(.a(new_n74_), .b(x06), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n86_), .c(x12), .O(new_n92_));
  nand4  g58(.a(new_n81_), .b(new_n75_), .c(new_n74_), .d(x06), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n50_), .d(x04), .O(z08));
  oai21  g60(.a(x13), .b(x12), .c(new_n46_), .O(new_n95_));
  nand2  g61(.a(new_n81_), .b(new_n85_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n72_), .c(x13), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n35_), .c(new_n83_), .d(new_n85_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n67_), .c(new_n43_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n97_), .c(new_n95_), .d(new_n50_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  aoi21  g69(.a(new_n99_), .b(new_n103_), .c(new_n49_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n65_), .c(x08), .d(x07), .O(new_n105_));
  ...
  oai21  g77(.a(new_n111_), .b(new_n43_), .c(new_n53_), .O(z12));
  nor2   g78(.a(new_n36_), .b(new_n43_), .O(z13));
  nand2  g79(.a(x17), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n53_), .O(z14));
endmodule
