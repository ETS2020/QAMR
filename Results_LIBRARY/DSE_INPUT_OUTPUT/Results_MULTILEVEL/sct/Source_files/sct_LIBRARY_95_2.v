...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(x18), .c(x06), .O(new_n58_));
  ...
  oai21  g27(.a(new_n49_), .b(new_n43_), .c(new_n46_), .O(new_n62_));
  inv1   g28(.a(x07), .O(new_n63_));
  nor2   g29(.a(new_n56_), .b(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n41_), .c(x06), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x09), .O(new_n66_));
  inv1   g32(.a(x09), .O(new_n67_));
  nor2   g33(.a(new_n63_), .b(new_n35_), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(x18), .c(new_n67_), .d(x08), .O(new_n69_));
  ...
  nand4  g43(.a(new_n77_), .b(x18), .c(new_n75_), .d(new_n67_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n74_), .c(new_n62_), .O(z06));
  nor2   g45(.a(x11), .b(x10), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n64_), .c(new_n67_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x18), .O(new_n82_));
  ...
  oai21  g54(.a(new_n88_), .b(new_n71_), .c(x18), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  nand4  g56(.a(x18), .b(new_n86_), .c(new_n75_), .d(new_n67_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n76_), .c(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n90_), .c(new_n50_), .d(x04), .O(z08));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n80_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n71_), .c(x18), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x06), .O(new_n97_));
  nand3  g63(.a(new_n68_), .b(new_n67_), .c(x08), .O(new_n98_));
  nand3  g64(.a(new_n80_), .b(x18), .c(new_n87_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n98_), .c(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n97_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n95_), .b(new_n102_), .c(new_n49_), .O(new_n103_));
  ...
  oai21  g76(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n46_), .c(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z12));
  nand2  g79(.a(new_n46_), .b(new_n43_), .O(z13));
