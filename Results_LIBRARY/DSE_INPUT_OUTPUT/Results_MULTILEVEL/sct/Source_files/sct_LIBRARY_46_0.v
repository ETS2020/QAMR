...
module FAU ( 
  ...
  oai21  g49(.a(new_n83_), .b(new_n61_), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  inv1   g51(.a(new_n65_), .O(new_n86_));
  nand3  g52(.a(new_n75_), .b(new_n86_), .c(new_n60_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(x12), .c(new_n64_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n40_), .c(new_n85_), .O(z08));
  ...
  oai21  g59(.a(new_n93_), .b(new_n61_), .c(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand3  g61(.a(new_n82_), .b(new_n71_), .c(new_n86_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(x13), .c(new_n64_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n40_), .c(new_n95_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n52_), .c(new_n60_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  nand2  g69(.a(new_n64_), .b(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n40_), .O(z10));
  inv1   g71(.a(new_n35_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n36_), .O(z11));
  nand2  g73(.a(x16), .b(new_n36_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n46_), .c(new_n40_), .O(z12));
  nand2  g75(.a(x06), .b(new_n40_), .O(z13));
  nand2  g76(.a(x17), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n106_), .O(z14));
endmodule
