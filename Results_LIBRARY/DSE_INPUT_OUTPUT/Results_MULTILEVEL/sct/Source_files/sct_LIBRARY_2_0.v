...
module FAU ( 
  ...
  nor2   g09(.a(x18), .b(new_n43_), .O(new_n44_));
  aoi21  g10(.a(x18), .b(x15), .c(new_n44_), .O(new_n45_));
  oai21  g11(.a(new_n45_), .b(x05), .c(new_n42_), .O(z01));
  ...
  nand4  g25(.a(new_n59_), .b(new_n51_), .c(new_n36_), .d(x04), .O(new_n60_));
  ...
  and2   g31(.a(new_n65_), .b(new_n36_), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n63_), .c(new_n51_), .d(x04), .O(z05));
  ...
  nand2  g61(.a(new_n95_), .b(new_n36_), .O(z10));
  nor2   g62(.a(new_n35_), .b(new_n38_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n38_), .c(x03), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n41_), .c(new_n36_), .O(z12));
  nand2  g65(.a(new_n36_), .b(new_n41_), .O(z13));
  nor2   g66(.a(new_n43_), .b(new_n41_), .O(z14));
endmodule
