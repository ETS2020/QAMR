...
module FAU ( 
  ...
  inv1   g39(.a(new_n46_), .O(new_n74_));
  aoi21  g40(.a(new_n66_), .b(x11), .c(new_n74_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n36_), .c(new_n73_), .O(z07));
  ...
  nand4  g46(.a(new_n80_), .b(new_n77_), .c(new_n46_), .d(x04), .O(z08));
  ...
  nand4  g51(.a(new_n85_), .b(new_n82_), .c(new_n46_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n84_), .b(new_n87_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n46_), .c(new_n61_), .d(x08), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(x07), .c(x06), .O(new_n91_));
  nand2  g57(.a(new_n74_), .b(x14), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n36_), .O(z10));
  nand2  g59(.a(new_n38_), .b(new_n39_), .O(z11));
  aoi21  g60(.a(x16), .b(new_n39_), .c(x03), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n36_), .c(new_n38_), .O(z12));
  nand2  g62(.a(x17), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n38_), .O(z14));
  buf    g64(.a(x04), .O(z13));
endmodule
