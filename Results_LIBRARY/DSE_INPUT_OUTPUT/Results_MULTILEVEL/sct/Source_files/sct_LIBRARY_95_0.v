...
module FAU ( 
  ...
  aoi21  g14(.a(new_n48_), .b(x18), .c(x06), .O(z02));
  ...
  nand3  g21(.a(x18), .b(x08), .c(new_n54_), .O(new_n56_));
  ...
  nand3  g32(.a(x18), .b(x09), .c(new_n54_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n61_), .O(z05));
  oai21  g34(.a(new_n40_), .b(x10), .c(new_n54_), .O(new_n69_));
  ...
  nand3  g41(.a(x18), .b(x10), .c(new_n54_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n70_), .O(z06));
  oai21  g43(.a(new_n40_), .b(x11), .c(new_n54_), .O(new_n78_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n81_), .c(new_n42_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n79_), .c(new_n78_), .d(new_n47_), .O(z07));
  oai21  g52(.a(new_n40_), .b(x12), .c(new_n54_), .O(new_n87_));
  inv1   g53(.a(new_n63_), .O(new_n88_));
  oai21  g54(.a(new_n83_), .b(new_n88_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n82_), .c(new_n72_), .d(new_n62_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n81_), .c(new_n42_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n87_), .d(new_n47_), .O(z08));
  oai21  g60(.a(new_n40_), .b(x13), .c(new_n54_), .O(new_n95_));
  nand3  g61(.a(new_n90_), .b(new_n82_), .c(new_n72_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n64_), .c(x13), .O(new_n97_));
  nand4  g63(.a(new_n62_), .b(x08), .c(x07), .d(x06), .O(new_n98_));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n90_), .c(new_n82_), .d(new_n72_), .O(new_n100_));
  nor2   g66(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nor2   g67(.a(new_n101_), .b(new_n42_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n97_), .c(new_n95_), .d(new_n47_), .O(z09));
  ...
  nand4  g76(.a(new_n46_), .b(x18), .c(x16), .d(x14), .O(new_n111_));
  ...
  nand2  g83(.a(new_n50_), .b(new_n42_), .O(z13));
  inv1   g84(.a(x17), .O(new_n119_));
  nor3   g85(.a(new_n35_), .b(new_n119_), .c(new_n42_), .O(z14));
endmodule
