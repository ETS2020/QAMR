...
module FAU ( 
  ...
  oai21  g25(.a(new_n57_), .b(x10), .c(new_n36_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z06));
  nor2   g27(.a(x11), .b(x06), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n48_), .c(x04), .O(z07));
  oai21  g29(.a(new_n57_), .b(x12), .c(new_n36_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z08));
  oai21  g31(.a(new_n57_), .b(x13), .c(new_n36_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x04), .O(z09));
  nand3  g33(.a(new_n57_), .b(x14), .c(new_n36_), .O(new_n68_));
