...
module FAU ( 
  ...
  nand2  g04(.a(x16), .b(new_n36_), .O(new_n39_));
  ...
  aoi21  g20(.a(new_n48_), .b(x02), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g44(.a(new_n55_), .b(x14), .O(new_n79_));
  oai21  g45(.a(new_n78_), .b(new_n40_), .c(new_n79_), .O(z07));
  nand2  g46(.a(new_n76_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n70_), .b(new_n75_), .c(new_n82_), .d(new_n74_), .O(new_n83_));
  ...
  or2    g53(.a(new_n87_), .b(new_n67_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n85_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n39_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n79_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n87_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n39_), .c(new_n66_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n79_), .c(new_n44_), .O(z10));
  inv1   g63(.a(x02), .O(new_n98_));
  nand2  g64(.a(new_n39_), .b(new_n98_), .O(z11));
  nand2  g65(.a(new_n39_), .b(x03), .O(new_n100_));
  nand3  g66(.a(x16), .b(x14), .c(new_n98_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n44_), .O(z12));
