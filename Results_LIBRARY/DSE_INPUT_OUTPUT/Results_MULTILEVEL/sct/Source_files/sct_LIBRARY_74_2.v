...
module FAU ( 
  ...
  nand4  g17(.a(new_n49_), .b(x07), .c(new_n48_), .d(x04), .O(new_n52_));
  ...
  oai21  g29(.a(new_n61_), .b(x08), .c(new_n63_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x07), .O(new_n65_));
  nand2  g31(.a(x09), .b(new_n48_), .O(new_n66_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n83_), .c(new_n91_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n75_), .c(x07), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nor2   g61(.a(new_n54_), .b(new_n35_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n85_), .c(new_n69_), .d(x06), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x13), .c(new_n45_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n95_), .c(new_n49_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n92_), .b(new_n83_), .c(new_n91_), .d(new_n68_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n49_), .c(new_n61_), .d(x08), .O(new_n103_));
  ...
  nand2  g72(.a(new_n106_), .b(new_n36_), .O(z10));
  nand2  g73(.a(new_n36_), .b(new_n38_), .O(z11));
  aoi21  g74(.a(x16), .b(new_n38_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n45_), .c(new_n36_), .O(z12));
  nor2   g76(.a(new_n37_), .b(new_n45_), .O(z13));
  nand2  g77(.a(x17), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n36_), .O(z14));
endmodule
