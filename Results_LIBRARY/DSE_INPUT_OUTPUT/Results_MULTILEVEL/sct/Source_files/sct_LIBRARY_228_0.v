...
module FAU ( 
  ...
  inv1   g45(.a(new_n48_), .O(new_n80_));
  aoi21  g46(.a(new_n73_), .b(x12), .c(new_n80_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n36_), .c(new_n79_), .O(z08));
  nand3  g48(.a(new_n66_), .b(new_n76_), .c(new_n71_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n60_), .c(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n76_), .c(new_n71_), .d(new_n70_), .O(new_n86_));
  or2    g52(.a(new_n86_), .b(new_n63_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n86_), .b(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(x07), .c(x06), .O(new_n93_));
  nand2  g59(.a(new_n80_), .b(x14), .O(new_n94_));
