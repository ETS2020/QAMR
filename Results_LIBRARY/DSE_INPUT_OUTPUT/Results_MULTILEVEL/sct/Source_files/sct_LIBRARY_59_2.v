...
module FAU ( 
  ...
  aoi21  g17(.a(new_n52_), .b(x06), .c(new_n44_), .O(z03));
  xor2a  g18(.a(x08), .b(x07), .O(new_n54_));
  nand2  g19(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  aoi21  g20(.a(new_n55_), .b(x06), .c(new_n44_), .O(z04));
  ...
  aoi21  g62(.a(x16), .b(new_n38_), .c(new_n36_), .O(new_n98_));
  aoi21  g63(.a(new_n98_), .b(new_n49_), .c(new_n44_), .O(z12));
  inv1   g64(.a(x17), .O(new_n100_));
  aoi21  g65(.a(new_n100_), .b(x06), .c(new_n44_), .O(z14));
  zero   g66(.O(z02));
  buf    g67(.a(x04), .O(z13));
endmodule
