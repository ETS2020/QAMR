...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n55_, new_n56_, new_n57_, new_n58_, new_n60_, new_n62_, new_n64_,
  ...
  oai21  g23(.a(new_n57_), .b(x10), .c(new_n45_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x04), .O(z06));
  nor2   g25(.a(x11), .b(x06), .O(new_n60_));
  nand3  g26(.a(new_n60_), .b(new_n46_), .c(x04), .O(z07));
  nor2   g27(.a(x12), .b(x06), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n46_), .c(x04), .O(z08));
  nor2   g29(.a(x13), .b(x06), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n46_), .c(x04), .O(z09));
  nand3  g31(.a(new_n57_), .b(x14), .c(new_n45_), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(new_n42_), .O(z10));
  oai21  g33(.a(new_n45_), .b(new_n42_), .c(new_n35_), .O(z11));
  aoi21  g34(.a(x16), .b(new_n35_), .c(x06), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n55_), .c(new_n42_), .O(z12));
  inv1   g36(.a(x17), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n45_), .c(new_n42_), .O(z14));
  buf    g38(.a(x04), .O(z13));
endmodule
