...
module FAU ( 
  ...
  nand4  g17(.a(new_n51_), .b(new_n37_), .c(new_n47_), .d(x04), .O(new_n52_));
  ...
  nand3  g31(.a(new_n58_), .b(new_n65_), .c(x08), .O(new_n66_));
  inv1   g32(.a(new_n66_), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n36_), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n64_), .c(new_n51_), .d(x04), .O(z05));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n58_), .c(x08), .O(new_n71_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n65_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x04), .O(new_n79_));
  aoi21  g45(.a(new_n71_), .b(x11), .c(new_n79_), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(new_n51_), .c(new_n36_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n70_), .b(new_n77_), .c(new_n82_), .d(new_n76_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n37_), .c(x04), .O(new_n84_));
  aoi21  g50(.a(new_n78_), .b(x12), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n51_), .O(z08));
  nand2  g52(.a(new_n83_), .b(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n82_), .c(new_n76_), .d(new_n75_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n67_), .c(new_n36_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  aoi21  g59(.a(new_n89_), .b(new_n93_), .c(new_n50_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n65_), .c(x08), .d(x07), .O(new_n95_));
  nand2  g61(.a(new_n50_), .b(x14), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n47_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n37_), .O(z10));
  nor2   g65(.a(new_n36_), .b(new_n39_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n39_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n44_), .c(new_n37_), .O(z12));
  nor2   g68(.a(new_n36_), .b(new_n44_), .O(z13));
  aoi21  g69(.a(x18), .b(new_n44_), .c(new_n35_), .O(z14));
endmodule
