...
module FAU ( 
  ...
  nand2  g25(.a(x09), .b(new_n53_), .O(new_n60_));
  inv1   g26(.a(x09), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x08), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n47_), .c(new_n60_), .O(new_n63_));
  ...
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n59_), .O(z06));
  ...
  nor3   g43(.a(new_n77_), .b(new_n53_), .c(new_n47_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n75_), .c(x07), .O(new_n79_));
  nand2  g45(.a(x11), .b(new_n47_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n59_), .O(z07));
  inv1   g47(.a(x10), .O(new_n82_));
  nor2   g48(.a(x12), .b(x11), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n62_), .c(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  nand3  g52(.a(x08), .b(x07), .c(x06), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n76_), .c(new_n61_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x12), .c(new_n44_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n86_), .c(new_n48_), .O(z08));
  nand2  g57(.a(new_n68_), .b(x08), .O(new_n92_));
  inv1   g58(.a(x12), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n74_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n92_), .c(x07), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x06), .O(new_n97_));
  nand3  g63(.a(new_n88_), .b(new_n83_), .c(new_n68_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x13), .c(new_n44_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n48_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand4  g67(.a(new_n94_), .b(new_n93_), .c(new_n74_), .d(new_n82_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n48_), .c(new_n61_), .d(x08), .O(new_n104_));
  nand2  g70(.a(new_n58_), .b(x14), .O(new_n105_));
  ...
  oai21  g76(.a(new_n110_), .b(new_n44_), .c(new_n37_), .O(z12));
  nand2  g77(.a(new_n37_), .b(new_n44_), .O(z13));
  nand2  g78(.a(new_n37_), .b(x17), .O(new_n113_));
  nor2   g79(.a(new_n113_), .b(new_n44_), .O(z14));
endmodule
