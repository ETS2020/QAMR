...
module FAU ( 
  ...
  nand4  g12(.a(new_n46_), .b(x09), .c(new_n45_), .d(x04), .O(new_n47_));
  inv1   g13(.a(new_n47_), .O(z02));
  nand3  g14(.a(x09), .b(x07), .c(new_n45_), .O(new_n49_));
  ...
  nand3  g19(.a(x09), .b(x08), .c(new_n45_), .O(new_n54_));
  ...
  nor2   g28(.a(new_n62_), .b(new_n45_), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n59_), .c(new_n46_), .d(x04), .O(z05));
  inv1   g30(.a(new_n35_), .O(new_n65_));
  inv1   g31(.a(new_n46_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n42_), .c(new_n65_), .O(new_n67_));
  ...
  oai21  g40(.a(x11), .b(new_n60_), .c(new_n45_), .O(new_n75_));
  nand2  g41(.a(new_n70_), .b(x11), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  nand4  g43(.a(new_n69_), .b(new_n77_), .c(new_n68_), .d(new_n60_), .O(new_n78_));
  and2   g44(.a(new_n78_), .b(x04), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n75_), .d(new_n46_), .O(z07));
  oai21  g46(.a(x12), .b(new_n60_), .c(new_n45_), .O(new_n81_));
  nand2  g47(.a(new_n78_), .b(x12), .O(new_n82_));
  nor3   g48(.a(x12), .b(x11), .c(x10), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n62_), .c(new_n42_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n46_), .O(z08));
  oai21  g51(.a(x13), .b(new_n60_), .c(new_n45_), .O(new_n86_));
  nand2  g52(.a(new_n83_), .b(new_n62_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x13), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n77_), .d(new_n68_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n62_), .c(new_n42_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n88_), .c(new_n86_), .d(new_n46_), .O(z09));
  inv1   g60(.a(x07), .O(new_n95_));
  inv1   g61(.a(x00), .O(new_n96_));
  nand2  g62(.a(new_n91_), .b(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n46_), .c(new_n60_), .d(x08), .O(new_n98_));
  nand2  g64(.a(new_n66_), .b(x14), .O(new_n99_));
  oai21  g65(.a(new_n98_), .b(new_n95_), .c(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n65_), .O(z10));
  nor2   g68(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n36_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n42_), .c(new_n65_), .O(z12));
  nand2  g71(.a(new_n65_), .b(new_n42_), .O(z13));
  nand2  g72(.a(x17), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n65_), .O(z14));
endmodule
