...
module FAU ( 
  ...
  nand4  g12(.a(new_n46_), .b(new_n45_), .c(x05), .d(x04), .O(new_n47_));
  ...
  nand2  g22(.a(new_n56_), .b(new_n49_), .O(z04));
  oai21  g23(.a(x09), .b(new_n40_), .c(new_n45_), .O(new_n58_));
  ...
  nand3  g31(.a(x09), .b(new_n45_), .c(x05), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n60_), .O(z05));
  oai21  g33(.a(x10), .b(new_n40_), .c(new_n45_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n59_), .O(new_n69_));
  nand2  g35(.a(new_n63_), .b(x10), .O(new_n70_));
  inv1   g36(.a(x10), .O(new_n71_));
  nand3  g37(.a(new_n62_), .b(new_n71_), .c(new_n61_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x06), .O(new_n74_));
  nand3  g40(.a(x10), .b(new_n45_), .c(x05), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(z06));
  oai21  g42(.a(x11), .b(new_n40_), .c(new_n45_), .O(new_n77_));
  nand2  g43(.a(new_n72_), .b(x11), .O(new_n78_));
  inv1   g44(.a(x04), .O(new_n79_));
  nand2  g45(.a(new_n62_), .b(x06), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(new_n81_));
  nor3   g47(.a(x11), .b(x10), .c(x09), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n78_), .c(new_n77_), .d(new_n46_), .O(z07));
  oai21  g50(.a(x12), .b(new_n40_), .c(new_n45_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n59_), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  aoi21  g53(.a(new_n82_), .b(new_n62_), .c(new_n87_), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  nand3  g55(.a(new_n87_), .b(new_n89_), .c(new_n71_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n63_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n88_), .c(x06), .O(new_n92_));
  nand3  g58(.a(x12), .b(new_n45_), .c(x05), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n86_), .O(z08));
  oai21  g60(.a(x13), .b(new_n40_), .c(new_n45_), .O(new_n95_));
  oai21  g61(.a(new_n90_), .b(new_n63_), .c(x13), .O(new_n96_));
  nand4  g62(.a(new_n61_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n87_), .c(new_n89_), .d(new_n71_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nor2   g66(.a(new_n100_), .b(new_n79_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n96_), .c(new_n95_), .d(new_n46_), .O(z09));
  inv1   g68(.a(x07), .O(new_n103_));
  inv1   g69(.a(x00), .O(new_n104_));
  nand2  g70(.a(new_n99_), .b(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n46_), .c(new_n61_), .d(x08), .O(new_n106_));
  ...
  nand3  g76(.a(new_n107_), .b(x14), .c(x05), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(z10));
  nor2   g78(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n36_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n79_), .c(new_n49_), .O(z12));
  nor2   g81(.a(new_n35_), .b(new_n79_), .O(z13));
  inv1   g82(.a(x17), .O(new_n117_));
  nor3   g83(.a(new_n35_), .b(new_n117_), .c(new_n79_), .O(z14));
endmodule
