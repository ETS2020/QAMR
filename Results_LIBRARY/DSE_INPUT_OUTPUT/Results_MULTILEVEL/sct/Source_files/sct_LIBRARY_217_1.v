...
module FAU ( 
  ...
  nand3  g19(.a(x11), .b(new_n48_), .c(x02), .O(new_n54_));
  ...
  oai21  g25(.a(new_n58_), .b(new_n47_), .c(new_n59_), .O(new_n60_));
  ...
  nand2  g37(.a(new_n46_), .b(new_n43_), .O(z13));
  oai21  g38(.a(new_n70_), .b(new_n49_), .c(x11), .O(new_n73_));
  inv1   g39(.a(x11), .O(new_n74_));
  inv1   g40(.a(new_n63_), .O(new_n75_));
  nand4  g41(.a(new_n69_), .b(new_n75_), .c(new_n35_), .d(new_n74_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n73_), .c(z13), .O(z07));
  oai21  g43(.a(new_n49_), .b(x12), .c(x11), .O(new_n78_));
  ...
  nand3  g49(.a(new_n83_), .b(new_n78_), .c(z13), .O(z08));
  oai21  g50(.a(new_n49_), .b(x13), .c(x11), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nor3   g52(.a(x12), .b(x10), .c(x09), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n75_), .c(new_n86_), .O(new_n88_));
  inv1   g54(.a(x10), .O(new_n89_));
  nand4  g55(.a(new_n86_), .b(new_n80_), .c(new_n74_), .d(new_n89_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n66_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n88_), .c(new_n35_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n85_), .c(z13), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  oai21  g60(.a(new_n49_), .b(new_n94_), .c(new_n90_), .O(new_n95_));
  ...
  nand2  g67(.a(new_n46_), .b(x03), .O(new_n102_));
  nand3  g68(.a(x16), .b(x11), .c(new_n37_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z12));
