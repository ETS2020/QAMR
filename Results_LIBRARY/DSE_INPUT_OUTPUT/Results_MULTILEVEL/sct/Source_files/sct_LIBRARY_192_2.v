...
module FAU ( 
  ...
  nand4  g14(.a(new_n48_), .b(new_n45_), .c(x06), .d(x04), .O(new_n49_));
  inv1   g15(.a(new_n49_), .O(z03));
  nand3  g16(.a(x08), .b(new_n45_), .c(x06), .O(new_n51_));
  oai21  g17(.a(x08), .b(new_n45_), .c(new_n51_), .O(new_n52_));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n48_), .d(x04), .O(z08));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n75_), .c(new_n74_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n80_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(new_n87_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n48_), .c(new_n57_), .d(x08), .O(new_n89_));
  nand3  g55(.a(new_n47_), .b(x16), .c(x14), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n45_), .c(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(x06), .c(x04), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(z10));
  nor2   g59(.a(z02), .b(new_n35_), .O(z11));
  aoi21  g60(.a(x16), .b(new_n35_), .c(new_n74_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n46_), .c(new_n36_), .O(z12));
  nor2   g62(.a(new_n74_), .b(new_n36_), .O(z13));
  inv1   g63(.a(x17), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x06), .c(new_n36_), .O(z14));
endmodule
