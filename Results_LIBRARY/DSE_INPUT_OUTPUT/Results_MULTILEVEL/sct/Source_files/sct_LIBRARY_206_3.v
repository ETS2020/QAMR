...
module FAU ( 
  ...
  nand4  g35(.a(new_n37_), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n37_), .c(new_n75_), .d(new_n66_), .O(new_n79_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n51_), .c(new_n37_), .d(x04), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  aoi21  g50(.a(new_n81_), .b(new_n76_), .c(new_n84_), .O(new_n85_));
  nand3  g51(.a(new_n84_), .b(new_n75_), .c(new_n66_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(new_n77_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n85_), .c(new_n37_), .O(new_n88_));
  nand2  g54(.a(x12), .b(new_n36_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n73_), .O(z08));
  inv1   g56(.a(new_n76_), .O(new_n91_));
  oai21  g57(.a(new_n86_), .b(new_n91_), .c(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand3  g59(.a(new_n81_), .b(new_n93_), .c(new_n84_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n77_), .c(new_n92_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n37_), .O(new_n96_));
  nand2  g62(.a(x13), .b(new_n36_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n73_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n48_), .b(x02), .O(new_n100_));
  nand3  g66(.a(new_n93_), .b(new_n84_), .c(new_n75_), .O(new_n101_));
  aoi22  g67(.a(new_n101_), .b(new_n99_), .c(new_n100_), .d(x16), .O(new_n102_));
  ...
  nand3  g72(.a(new_n50_), .b(x14), .c(new_n36_), .O(new_n107_));
  ...
  nor2   g78(.a(new_n38_), .b(new_n44_), .O(z13));
