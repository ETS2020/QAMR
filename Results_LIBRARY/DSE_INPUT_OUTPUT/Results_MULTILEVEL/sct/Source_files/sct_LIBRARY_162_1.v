...
module FAU ( 
  ...
  nand3  g16(.a(x07), .b(new_n36_), .c(x04), .O(new_n51_));
  oai21  g17(.a(x07), .b(new_n36_), .c(new_n51_), .O(new_n52_));
  ...
  oai21  g30(.a(x10), .b(new_n42_), .c(new_n36_), .O(new_n65_));
  nand3  g31(.a(new_n62_), .b(x08), .c(x07), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x10), .O(new_n67_));
  nor2   g33(.a(x10), .b(x09), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(x08), .c(x07), .d(x06), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n47_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x04), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n65_), .O(z06));
  oai21  g38(.a(x11), .b(new_n42_), .c(new_n36_), .O(new_n73_));
  ...
  inv1   g43(.a(new_n60_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n62_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n75_), .c(new_n47_), .O(new_n80_));
  ...
  nand4  g50(.a(new_n68_), .b(new_n78_), .c(new_n84_), .d(new_n77_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n47_), .d(x04), .O(z08));
  oai21  g52(.a(x13), .b(new_n42_), .c(new_n36_), .O(new_n87_));
  nand3  g53(.a(new_n84_), .b(new_n77_), .c(new_n76_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n66_), .c(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n91_));
  or2    g57(.a(new_n91_), .b(new_n63_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n89_), .c(new_n47_), .O(new_n93_));
  ...
  nand4  g63(.a(new_n97_), .b(new_n47_), .c(new_n62_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(x07), .c(x06), .O(new_n100_));
  inv1   g66(.a(x14), .O(new_n101_));
  or2    g67(.a(new_n47_), .b(new_n101_), .O(new_n102_));
  ...
  nor2   g71(.a(new_n105_), .b(new_n42_), .O(z12));
  nand2  g72(.a(x17), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n50_), .O(z14));
  buf    g74(.a(x04), .O(z13));
endmodule
