...
module FAU ( 
  ...
  nand3  g06(.a(x18), .b(new_n40_), .c(new_n36_), .O(new_n41_));
  ...
  oai21  g51(.a(new_n50_), .b(new_n43_), .c(new_n47_), .O(new_n86_));
  nand3  g52(.a(new_n82_), .b(x13), .c(x05), .O(new_n87_));
  nand4  g53(.a(new_n36_), .b(new_n81_), .c(new_n75_), .d(new_n74_), .O(new_n88_));
  or2    g54(.a(new_n88_), .b(new_n65_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  aoi21  g57(.a(new_n88_), .b(new_n91_), .c(new_n50_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n64_), .c(x08), .d(x07), .O(new_n93_));
  ...
  nand3  g65(.a(new_n99_), .b(new_n47_), .c(x04), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(z12));
  nand2  g67(.a(new_n47_), .b(new_n43_), .O(z13));
