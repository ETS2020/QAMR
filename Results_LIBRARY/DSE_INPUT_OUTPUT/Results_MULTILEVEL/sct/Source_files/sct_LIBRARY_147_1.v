...
module FAU ( 
  ...
  oai21  g28(.a(x09), .b(new_n38_), .c(new_n45_), .O(new_n63_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n77_), .d(new_n64_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n76_), .c(new_n50_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n74_), .O(z07));
  nand2  g50(.a(new_n81_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n80_), .b(new_n71_), .c(new_n86_), .d(new_n78_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n50_), .d(x04), .O(z08));
  nand2  g54(.a(new_n87_), .b(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n78_), .d(new_n77_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n50_), .c(new_n64_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  or2    g64(.a(new_n50_), .b(new_n36_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n38_), .O(z10));
  nand2  g66(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n40_), .c(x03), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n38_), .c(new_n39_), .O(z12));
  nand2  g69(.a(new_n45_), .b(new_n38_), .O(z13));
