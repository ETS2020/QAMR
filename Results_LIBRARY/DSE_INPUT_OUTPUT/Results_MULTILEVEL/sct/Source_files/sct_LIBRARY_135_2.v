...
module FAU ( 
  ...
  nand4  g31(.a(new_n66_), .b(new_n60_), .c(x08), .d(x07), .O(new_n67_));
  and2   g32(.a(new_n67_), .b(x06), .O(new_n68_));
  nand4  g33(.a(new_n68_), .b(new_n65_), .c(new_n52_), .d(x04), .O(z06));
  nand2  g34(.a(new_n67_), .b(x11), .O(new_n70_));
  inv1   g35(.a(x11), .O(new_n71_));
  nand3  g36(.a(new_n71_), .b(new_n66_), .c(new_n60_), .O(new_n72_));
  nor2   g37(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  nor2   g38(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand4  g39(.a(new_n74_), .b(new_n70_), .c(new_n52_), .d(x04), .O(z07));
  oai21  g40(.a(new_n72_), .b(new_n58_), .c(x12), .O(new_n76_));
  nor3   g41(.a(x12), .b(x11), .c(x10), .O(new_n77_));
  nand2  g42(.a(new_n77_), .b(new_n62_), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n76_), .c(new_n52_), .O(new_n79_));
  nand2  g44(.a(new_n79_), .b(x06), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(x04), .O(z08));
  nand2  g46(.a(new_n78_), .b(x13), .O(new_n82_));
  ...
  aoi21  g51(.a(new_n86_), .b(new_n62_), .c(new_n36_), .O(new_n87_));
  ...
  aoi21  g64(.a(new_n99_), .b(x06), .c(new_n44_), .O(z14));
  zero   g65(.O(z02));
endmodule
