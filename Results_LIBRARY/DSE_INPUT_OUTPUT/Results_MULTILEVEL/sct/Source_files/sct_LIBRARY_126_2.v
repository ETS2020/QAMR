...
module FAU ( 
  ...
  oai21  g58(.a(x06), .b(new_n35_), .c(new_n37_), .O(z11));
  aoi21  g59(.a(x16), .b(new_n37_), .c(new_n74_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n47_), .c(new_n35_), .O(z12));
  inv1   g61(.a(x17), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(x06), .c(new_n35_), .O(z14));
  buf    g63(.a(x04), .O(z13));
endmodule
