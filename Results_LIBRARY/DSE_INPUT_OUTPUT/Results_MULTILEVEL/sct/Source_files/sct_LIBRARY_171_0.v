...
module FAU ( 
  ...
  aoi21  g43(.a(new_n70_), .b(x11), .c(new_n54_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n41_), .c(new_n77_), .O(z07));
  oai21  g45(.a(new_n75_), .b(new_n63_), .c(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  inv1   g47(.a(new_n63_), .O(new_n82_));
  nand4  g48(.a(new_n69_), .b(new_n82_), .c(new_n81_), .d(new_n74_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n55_), .d(x04), .O(z08));
  nand2  g50(.a(new_n83_), .b(x13), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n81_), .c(new_n74_), .d(new_n73_), .O(new_n87_));
  or2    g53(.a(new_n87_), .b(new_n66_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g55(.a(new_n35_), .O(new_n90_));
  inv1   g56(.a(x00), .O(new_n91_));
  aoi21  g57(.a(new_n87_), .b(new_n91_), .c(new_n54_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n65_), .c(x08), .d(x07), .O(new_n93_));
  nand2  g59(.a(new_n54_), .b(x14), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n43_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x04), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n90_), .O(z10));
  nor2   g63(.a(new_n35_), .b(new_n36_), .O(z11));
  nand2  g64(.a(x16), .b(new_n36_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n48_), .c(new_n41_), .O(z12));
  nand2  g66(.a(x17), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n90_), .O(z14));
  buf    g68(.a(x04), .O(z13));
endmodule
