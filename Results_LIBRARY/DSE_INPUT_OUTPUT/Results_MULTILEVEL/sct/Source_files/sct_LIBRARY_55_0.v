...
module FAU ( 
  ...
  nor2   g08(.a(x14), .b(x12), .O(new_n43_));
  ...
  nand3  g32(.a(new_n66_), .b(new_n63_), .c(x04), .O(new_n67_));
  inv1   g33(.a(new_n67_), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(new_n51_), .c(new_n43_), .O(z05));
  ...
  nand2  g39(.a(new_n73_), .b(new_n51_), .O(z06));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n51_), .c(new_n43_), .O(z07));
  oai21  g46(.a(new_n50_), .b(new_n42_), .c(new_n47_), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(x12), .O(new_n82_));
  inv1   g48(.a(new_n66_), .O(new_n83_));
  nand4  g49(.a(new_n76_), .b(new_n83_), .c(x14), .d(new_n36_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z08));
  and2   g51(.a(new_n77_), .b(x14), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(x12), .c(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n76_), .b(x14), .c(new_n88_), .d(new_n36_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n83_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n81_), .O(z09));
  oai21  g58(.a(new_n50_), .b(new_n36_), .c(new_n37_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x00), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n89_), .c(x09), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(x08), .c(x07), .d(x06), .O(new_n96_));
  nand2  g62(.a(new_n50_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n42_), .O(z10));
  inv1   g64(.a(x02), .O(new_n99_));
  nor2   g65(.a(new_n43_), .b(new_n99_), .O(z11));
  oai21  g66(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n47_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  nor2   g69(.a(new_n43_), .b(new_n42_), .O(z13));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n47_), .O(z14));
endmodule
