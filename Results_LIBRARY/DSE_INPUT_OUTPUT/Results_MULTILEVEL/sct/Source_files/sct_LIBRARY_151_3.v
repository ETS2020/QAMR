...
module FAU ( 
  ...
  nand3  g26(.a(new_n60_), .b(x06), .c(new_n35_), .O(new_n61_));
  ...
  oai21  g31(.a(new_n59_), .b(new_n54_), .c(x09), .O(new_n66_));
  ...
  oai21  g38(.a(x10), .b(x06), .c(x05), .O(new_n73_));
  ...
  oai21  g44(.a(x11), .b(x06), .c(x05), .O(new_n79_));
  ...
  nand4  g52(.a(new_n86_), .b(new_n80_), .c(new_n79_), .d(new_n51_), .O(z07));
  oai21  g53(.a(x12), .b(x06), .c(x05), .O(new_n88_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n88_), .d(new_n51_), .O(z08));
  oai21  g60(.a(x13), .b(x06), .c(x05), .O(new_n95_));
  ...
  nor2   g65(.a(new_n99_), .b(new_n44_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n95_), .d(new_n51_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n98_), .b(new_n102_), .c(new_n50_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n67_), .c(x08), .d(x07), .O(new_n104_));
  nand2  g70(.a(new_n50_), .b(x14), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(new_n36_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g76(.a(new_n110_), .b(new_n44_), .c(new_n47_), .O(z12));
