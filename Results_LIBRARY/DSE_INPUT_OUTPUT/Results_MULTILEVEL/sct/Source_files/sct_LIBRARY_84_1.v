...
module FAU ( 
  ...
  nand2  g45(.a(new_n76_), .b(new_n64_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n62_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n75_), .b(new_n70_), .c(new_n83_), .d(new_n82_), .O(new_n84_));
  ...
  oai21  g53(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n88_));
  nand3  g54(.a(new_n64_), .b(x08), .c(x07), .O(new_n89_));
  ...
  or2    g60(.a(new_n94_), .b(new_n65_), .O(new_n95_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  or2    g69(.a(new_n48_), .b(new_n40_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n43_), .O(z10));
  nand2  g71(.a(new_n51_), .b(new_n37_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n37_), .c(x03), .O(new_n107_));
  nor2   g73(.a(new_n107_), .b(new_n43_), .O(z12));
  nand2  g74(.a(new_n35_), .b(new_n43_), .O(z13));
  nand2  g75(.a(x17), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n51_), .O(z14));
endmodule
