...
module FAU ( 
  ...
  nand2  g22(.a(x08), .b(new_n43_), .O(new_n57_));
  ...
  aoi21  g47(.a(new_n74_), .b(x12), .c(new_n81_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n41_), .c(new_n80_), .O(z08));
  inv1   g49(.a(x12), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n72_), .d(new_n71_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n76_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nand3  g54(.a(new_n77_), .b(new_n67_), .c(new_n73_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x13), .c(new_n81_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n41_), .c(new_n88_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n86_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n48_), .c(new_n63_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  nand2  g62(.a(new_n81_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n41_), .O(z10));
  nand2  g64(.a(new_n54_), .b(new_n36_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n36_), .c(x03), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n41_), .c(new_n54_), .O(z12));
