...
module FAU ( 
  ...
  oai21  g55(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n90_));
  nand3  g56(.a(new_n64_), .b(x08), .c(x07), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n85_), .c(new_n84_), .d(new_n92_), .O(new_n96_));
  or2    g62(.a(new_n96_), .b(new_n65_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n94_), .c(new_n48_), .O(new_n98_));
  ...
  or2    g71(.a(new_n48_), .b(new_n40_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n43_), .O(z10));
  nand2  g73(.a(new_n54_), .b(new_n37_), .O(z11));
  aoi21  g74(.a(x16), .b(new_n37_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n43_), .c(new_n54_), .O(z12));
  nand2  g76(.a(new_n35_), .b(new_n43_), .O(z13));
