...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(x02), .c(new_n36_), .O(new_n51_));
  ...
  nand3  g21(.a(new_n35_), .b(new_n50_), .c(x02), .O(new_n56_));
  ...
  nand2  g33(.a(new_n67_), .b(new_n48_), .O(z04));
  nand3  g34(.a(x08), .b(x07), .c(x06), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x09), .O(new_n70_));
  nor2   g36(.a(new_n64_), .b(new_n49_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n35_), .c(x08), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n57_), .d(x04), .O(z05));
  oai21  g39(.a(x16), .b(x10), .c(x09), .O(new_n74_));
  nand2  g40(.a(new_n69_), .b(x10), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n35_), .c(x08), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(new_n71_), .c(new_n45_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n74_), .d(new_n52_), .O(z06));
  oai21  g46(.a(x16), .b(x11), .c(x09), .O(new_n81_));
  nand3  g47(.a(new_n71_), .b(new_n76_), .c(x08), .O(new_n82_));
  ...
  nand4  g52(.a(new_n86_), .b(new_n83_), .c(new_n81_), .d(new_n52_), .O(z07));
  oai21  g53(.a(x16), .b(x12), .c(x09), .O(new_n88_));
  nor2   g54(.a(x11), .b(x10), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n71_), .c(x08), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x12), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(x12), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n76_), .d(new_n35_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n84_), .c(new_n45_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n91_), .c(new_n88_), .d(new_n52_), .O(z08));
  oai21  g63(.a(x16), .b(x13), .c(x09), .O(new_n98_));
  nand3  g64(.a(new_n93_), .b(new_n92_), .c(new_n76_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n69_), .c(x13), .O(new_n100_));
  nor2   g66(.a(x13), .b(x12), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n89_), .O(new_n102_));
  nor2   g68(.a(new_n102_), .b(new_n72_), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n45_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n100_), .c(new_n98_), .d(new_n52_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  aoi21  g72(.a(new_n102_), .b(new_n106_), .c(new_n51_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n35_), .c(x08), .d(x07), .O(new_n108_));
  nand2  g74(.a(new_n51_), .b(x14), .O(new_n109_));
  oai21  g75(.a(new_n108_), .b(new_n49_), .c(new_n109_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n48_), .O(z10));
  nand2  g78(.a(new_n48_), .b(new_n38_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n38_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n45_), .c(new_n48_), .O(z12));
  nor2   g81(.a(new_n37_), .b(new_n45_), .O(z13));
  nand2  g82(.a(x17), .b(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n48_), .O(z14));
endmodule
