...
module FAU ( 
  ...
  nand4  g41(.a(new_n59_), .b(new_n75_), .c(new_n70_), .d(new_n63_), .O(new_n76_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n75_), .c(new_n70_), .d(new_n63_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n59_), .c(new_n56_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n48_), .c(new_n57_), .d(x08), .O(new_n88_));
  ...
  oai21  g60(.a(new_n94_), .b(x02), .c(new_n46_), .O(new_n95_));
