...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n49_), .d(x04), .O(z07));
  nand2  g45(.a(new_n78_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n70_), .b(new_n76_), .c(new_n82_), .d(new_n81_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n49_), .d(x04), .O(z08));
  oai21  g50(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n85_));
  nand3  g51(.a(new_n82_), .b(new_n81_), .c(new_n65_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n68_), .c(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  inv1   g54(.a(new_n63_), .O(new_n89_));
  nand4  g55(.a(new_n77_), .b(new_n89_), .c(new_n88_), .d(new_n82_), .O(new_n90_));
  ...
  oai21  g62(.a(new_n96_), .b(new_n66_), .c(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n49_), .c(new_n62_), .d(x08), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n94_), .c(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x06), .O(new_n100_));
  inv1   g66(.a(new_n49_), .O(new_n101_));
  ...
  nor2   g71(.a(new_n105_), .b(new_n43_), .O(z12));
  nand2  g72(.a(new_n35_), .b(new_n43_), .O(z13));
