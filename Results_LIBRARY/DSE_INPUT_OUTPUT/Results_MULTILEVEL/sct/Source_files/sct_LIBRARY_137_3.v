...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n107_, new_n109_, new_n111_, new_n112_, new_n115_;
  ...
  oai21  g28(.a(new_n47_), .b(new_n41_), .c(new_n62_), .O(new_n63_));
  nor2   g29(.a(new_n56_), .b(new_n51_), .O(new_n64_));
  ...
  aoi21  g39(.a(new_n68_), .b(x10), .c(new_n41_), .O(new_n74_));
  ...
  nand3  g58(.a(new_n83_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  ...
  nor3   g62(.a(x14), .b(x13), .c(x12), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n87_), .c(new_n84_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n63_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nor2   g66(.a(x13), .b(x12), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n47_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n85_), .c(x08), .d(x07), .O(new_n104_));
  ...
  nand2  g73(.a(new_n107_), .b(new_n62_), .O(z10));
  inv1   g74(.a(x02), .O(new_n109_));
  nor2   g75(.a(new_n42_), .b(new_n109_), .O(z11));
  oai21  g76(.a(new_n46_), .b(x02), .c(new_n45_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n62_), .c(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z12));
  nand2  g79(.a(new_n62_), .b(new_n41_), .O(z13));
  nand2  g80(.a(x17), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n62_), .O(z14));
endmodule
