...
module FAU ( 
  ...
  oai21  g47(.a(new_n81_), .b(new_n60_), .c(x13), .O(new_n82_));
  nor2   g48(.a(x13), .b(x12), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n70_), .c(new_n61_), .O(new_n84_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n59_), .c(x08), .d(x07), .O(new_n91_));
  aoi21  g57(.a(new_n48_), .b(x14), .c(new_n58_), .O(new_n92_));
