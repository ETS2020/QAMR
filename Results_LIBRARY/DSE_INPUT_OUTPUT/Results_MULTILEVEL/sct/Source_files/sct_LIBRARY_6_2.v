...
module FAU ( 
  ...
  nor2   g26(.a(new_n61_), .b(new_n35_), .O(new_n62_));
  ...
  nand4  g32(.a(new_n67_), .b(new_n64_), .c(new_n51_), .d(x04), .O(z06));
  nand2  g33(.a(new_n66_), .b(x11), .O(new_n69_));
  nor2   g34(.a(x11), .b(x10), .O(new_n70_));
  nand2  g35(.a(new_n70_), .b(new_n59_), .O(new_n71_));
  nor2   g36(.a(new_n71_), .b(new_n57_), .O(new_n72_));
  nor2   g37(.a(new_n72_), .b(new_n35_), .O(new_n73_));
  nand4  g38(.a(new_n73_), .b(new_n69_), .c(new_n51_), .d(x04), .O(z07));
  oai21  g39(.a(new_n71_), .b(new_n57_), .c(x12), .O(new_n75_));
  nor2   g40(.a(x12), .b(x11), .O(new_n76_));
  nand3  g41(.a(new_n76_), .b(new_n61_), .c(new_n65_), .O(new_n77_));
  nand3  g42(.a(new_n77_), .b(new_n75_), .c(new_n51_), .O(new_n78_));
  nand2  g43(.a(new_n78_), .b(x06), .O(new_n79_));
  nand2  g44(.a(new_n79_), .b(x04), .O(z08));
  nand2  g45(.a(new_n76_), .b(new_n65_), .O(new_n81_));
  oai21  g46(.a(new_n81_), .b(new_n60_), .c(x13), .O(new_n82_));
  nor2   g47(.a(x13), .b(x12), .O(new_n83_));
  nand3  g48(.a(new_n83_), .b(new_n70_), .c(new_n61_), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(new_n82_), .c(new_n51_), .O(new_n85_));
  ...
  nand4  g55(.a(new_n90_), .b(new_n59_), .c(x08), .d(x07), .O(new_n91_));
  ...
  oai21  g59(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n95_));
  nand3  g60(.a(new_n95_), .b(x06), .c(x04), .O(new_n96_));
  inv1   g61(.a(new_n96_), .O(z12));
  nor2   g62(.a(new_n35_), .b(new_n43_), .O(z13));
  inv1   g63(.a(x17), .O(new_n99_));
  aoi21  g64(.a(new_n99_), .b(x06), .c(new_n43_), .O(z14));
  zero   g65(.O(z02));
endmodule
