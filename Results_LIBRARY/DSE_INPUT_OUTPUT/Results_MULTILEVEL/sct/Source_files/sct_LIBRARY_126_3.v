...
module FAU ( 
  ...
  nand3  g25(.a(new_n59_), .b(new_n51_), .c(x04), .O(z06));
  oai21  g26(.a(new_n56_), .b(x11), .c(new_n50_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z07));
  nor2   g28(.a(x12), .b(x06), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n51_), .c(x04), .O(z08));
  oai21  g30(.a(new_n56_), .b(x13), .c(new_n50_), .O(new_n65_));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n50_), .c(new_n42_), .O(z14));
  buf    g39(.a(x04), .O(z13));
endmodule
