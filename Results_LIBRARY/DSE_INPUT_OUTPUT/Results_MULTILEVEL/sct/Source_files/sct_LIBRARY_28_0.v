...
module FAU ( 
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n54_), .d(x04), .O(z06));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n54_), .d(x04), .O(z07));
  nand3  g44(.a(new_n66_), .b(x08), .c(x07), .O(new_n79_));
  ...
  aoi21  g49(.a(new_n77_), .b(x12), .c(new_n53_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n40_), .c(new_n83_), .O(z08));
  nor2   g51(.a(x13), .b(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n75_), .c(new_n74_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n79_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  nand3  g55(.a(new_n80_), .b(new_n70_), .c(new_n76_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x13), .c(new_n53_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n40_), .c(new_n89_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  aoi21  g59(.a(new_n87_), .b(new_n93_), .c(new_n53_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n66_), .c(x08), .d(x07), .O(new_n95_));
  nand2  g61(.a(new_n53_), .b(x14), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n42_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n57_), .O(z10));
  nor2   g65(.a(new_n36_), .b(new_n35_), .O(z11));
  nand2  g66(.a(x16), .b(new_n35_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n47_), .c(new_n40_), .O(z12));
