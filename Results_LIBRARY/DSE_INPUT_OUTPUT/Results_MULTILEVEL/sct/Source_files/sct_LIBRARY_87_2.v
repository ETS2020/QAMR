...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n94_, new_n97_, new_n98_, new_n100_;
  ...
  nand2  g15(.a(new_n50_), .b(new_n47_), .O(new_n51_));
  aoi21  g16(.a(new_n51_), .b(x06), .c(new_n35_), .O(z03));
  ...
  or2    g42(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  ...
  nand4  g55(.a(new_n90_), .b(new_n50_), .c(new_n58_), .d(x08), .O(new_n91_));
  ...
  inv1   g61(.a(x06), .O(new_n97_));
  aoi21  g62(.a(x16), .b(new_n37_), .c(new_n97_), .O(new_n98_));
  aoi21  g63(.a(new_n98_), .b(new_n48_), .c(new_n35_), .O(z12));
  inv1   g64(.a(x17), .O(new_n100_));
  aoi21  g65(.a(new_n100_), .b(x06), .c(new_n35_), .O(z14));
  zero   g66(.O(z02));
  buf    g67(.a(x04), .O(z13));
endmodule
