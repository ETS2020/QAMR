...
module FAU ( 
  ...
  nand4  g47(.a(new_n81_), .b(new_n50_), .c(new_n36_), .d(x04), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  aoi21  g49(.a(new_n80_), .b(new_n64_), .c(new_n83_), .O(new_n84_));
  nand3  g50(.a(new_n83_), .b(new_n75_), .c(new_n70_), .O(new_n85_));
  ...
  oai21  g55(.a(new_n85_), .b(new_n63_), .c(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand3  g57(.a(new_n80_), .b(new_n91_), .c(new_n83_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n76_), .c(new_n90_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n36_), .O(new_n94_));
  nand2  g60(.a(x13), .b(new_n35_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n62_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n47_), .b(x02), .O(new_n98_));
  nand3  g64(.a(new_n91_), .b(new_n83_), .c(new_n75_), .O(new_n99_));
  aoi22  g65(.a(new_n99_), .b(new_n97_), .c(new_n98_), .d(x16), .O(new_n100_));
  ...
  nand3  g70(.a(new_n49_), .b(x14), .c(new_n35_), .O(new_n105_));
  ...
  nand3  g74(.a(new_n108_), .b(new_n53_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nor2   g76(.a(new_n37_), .b(new_n44_), .O(z13));
