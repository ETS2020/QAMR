...
module FAU ( 
  ...
  nand2  g26(.a(new_n49_), .b(new_n51_), .O(new_n61_));
  and2   g27(.a(x08), .b(x07), .O(new_n62_));
  inv1   g28(.a(new_n62_), .O(new_n63_));
  nand3  g29(.a(new_n36_), .b(x08), .c(x07), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  aoi21  g31(.a(new_n63_), .b(x09), .c(new_n65_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n55_), .c(new_n61_), .O(z05));
  nor2   g33(.a(x10), .b(x09), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(x06), .c(new_n49_), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  nand2  g36(.a(x07), .b(x06), .O(new_n71_));
  nand2  g37(.a(new_n70_), .b(x08), .O(new_n72_));
  oai22  g38(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(x06), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand3  g40(.a(new_n64_), .b(x10), .c(x06), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(z06));
  oai21  g42(.a(x11), .b(x09), .c(new_n55_), .O(new_n77_));
  ...
  oai21  g61(.a(x13), .b(x09), .c(new_n55_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n49_), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand3  g64(.a(new_n80_), .b(new_n98_), .c(new_n91_), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n90_), .c(new_n98_), .d(x06), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n36_), .O(new_n101_));
  nand4  g67(.a(new_n65_), .b(new_n91_), .c(new_n79_), .d(new_n70_), .O(new_n102_));
  ...
  aoi21  g71(.a(new_n99_), .b(new_n105_), .c(new_n47_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n36_), .c(x08), .d(x07), .O(new_n107_));
  nand2  g73(.a(new_n47_), .b(x14), .O(new_n108_));
  oai21  g74(.a(new_n107_), .b(new_n55_), .c(new_n108_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n51_), .O(z10));
  nor2   g77(.a(new_n37_), .b(new_n35_), .O(z11));
  oai21  g78(.a(new_n46_), .b(x02), .c(new_n45_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n51_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nor2   g81(.a(new_n37_), .b(new_n42_), .O(z13));
  inv1   g82(.a(x17), .O(new_n117_));
  nor3   g83(.a(new_n37_), .b(new_n117_), .c(new_n42_), .O(z14));
endmodule
