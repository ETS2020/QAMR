...
module FAU ( 
  ...
  nand4  g40(.a(new_n74_), .b(new_n36_), .c(new_n72_), .d(new_n63_), .O(new_n75_));
  ...
  aoi21  g47(.a(new_n75_), .b(x11), .c(new_n42_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n51_), .O(z07));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n72_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n64_), .c(new_n36_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nor2   g54(.a(x15), .b(x11), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n72_), .c(new_n63_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n73_), .c(x12), .O(new_n91_));
  ...
  oai21  g60(.a(new_n94_), .b(new_n64_), .c(new_n36_), .O(new_n95_));
  ...
  oai21  g75(.a(new_n109_), .b(new_n42_), .c(new_n43_), .O(z12));
  nand2  g76(.a(new_n43_), .b(new_n42_), .O(z13));
  nand3  g77(.a(new_n43_), .b(x17), .c(x04), .O(new_n112_));
