...
module FAU ( 
  ...
  nand3  g24(.a(new_n58_), .b(new_n36_), .c(x06), .O(new_n59_));
  ...
  nor2   g37(.a(new_n57_), .b(new_n67_), .O(new_n72_));
  ...
  nand4  g43(.a(new_n68_), .b(new_n36_), .c(new_n77_), .d(x08), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(x10), .c(new_n44_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n76_), .c(new_n51_), .O(z06));
  nor2   g46(.a(x11), .b(x10), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n72_), .c(new_n77_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n36_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nor3   g50(.a(x17), .b(x10), .c(x09), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n72_), .c(x06), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(x11), .c(new_n44_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n51_), .O(z07));
  oai21  g54(.a(new_n50_), .b(new_n44_), .c(new_n47_), .O(new_n89_));
  nand2  g55(.a(new_n84_), .b(x12), .O(new_n90_));
  nor2   g56(.a(x17), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n81_), .c(new_n68_), .d(new_n63_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n90_), .c(new_n89_), .O(z08));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n81_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n64_), .c(new_n36_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x06), .O(new_n97_));
  aoi21  g63(.a(new_n92_), .b(x13), .c(new_n44_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n51_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n95_), .b(new_n100_), .c(new_n50_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n77_), .c(x08), .d(x07), .O(new_n102_));
  ...
  nand2  g72(.a(new_n47_), .b(new_n38_), .O(z11));
  oai21  g73(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n47_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nand2  g76(.a(new_n47_), .b(new_n44_), .O(z13));
  aoi21  g77(.a(new_n35_), .b(new_n44_), .c(new_n36_), .O(z14));
endmodule
