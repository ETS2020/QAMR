...
module FAU ( 
  ...
  aoi21  g33(.a(new_n67_), .b(new_n65_), .c(new_n42_), .O(new_n68_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n72_), .c(new_n70_), .d(new_n50_), .O(z06));
  oai21  g43(.a(x15), .b(x11), .c(new_n56_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(new_n63_), .O(new_n81_));
  aoi21  g47(.a(new_n73_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  nor4   g48(.a(new_n63_), .b(x11), .c(x10), .d(x09), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n82_), .c(x06), .O(new_n84_));
  nand3  g50(.a(new_n35_), .b(x11), .c(new_n56_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n79_), .O(z07));
  oai21  g52(.a(x15), .b(x12), .c(new_n56_), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  or2    g54(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n73_), .b(new_n88_), .c(new_n80_), .O(new_n90_));
  nor3   g56(.a(new_n90_), .b(new_n63_), .c(new_n56_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(new_n42_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n89_), .c(new_n87_), .d(new_n50_), .O(z08));
  oai21  g59(.a(x15), .b(x13), .c(new_n56_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n51_), .O(new_n95_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n88_), .c(new_n80_), .d(new_n96_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n71_), .c(new_n98_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x06), .O(new_n102_));
  nand3  g68(.a(new_n35_), .b(x13), .c(new_n56_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n102_), .c(new_n95_), .O(z09));
  inv1   g70(.a(x09), .O(new_n105_));
  inv1   g71(.a(x00), .O(new_n106_));
  aoi21  g72(.a(new_n100_), .b(new_n106_), .c(new_n49_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n105_), .c(x08), .d(x07), .O(new_n108_));
  ...
  oai21  g79(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n37_), .c(x04), .O(new_n115_));
  inv1   g81(.a(new_n115_), .O(z12));
  nor2   g82(.a(new_n36_), .b(new_n42_), .O(z13));
