...
module FAU ( 
  ...
  oai21  g30(.a(new_n50_), .b(new_n42_), .c(new_n43_), .O(new_n65_));
  ...
  aoi21  g42(.a(new_n71_), .b(x10), .c(new_n42_), .O(new_n77_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n94_), .c(new_n51_), .d(x04), .O(z08));
  nand2  g63(.a(new_n94_), .b(x13), .O(new_n98_));
  nor3   g64(.a(x15), .b(x13), .c(x12), .O(new_n99_));
  ...
  aoi21  g70(.a(new_n104_), .b(new_n102_), .c(new_n50_), .O(new_n105_));
  ...
  nand2  g75(.a(new_n109_), .b(new_n43_), .O(z10));
  nor2   g76(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n38_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n42_), .c(new_n43_), .O(z12));
  nand2  g79(.a(new_n43_), .b(new_n42_), .O(z13));
  nand3  g80(.a(new_n43_), .b(x17), .c(x04), .O(new_n115_));
