...
module FAU ( 
  ...
  oai21  g32(.a(new_n66_), .b(x13), .c(x06), .O(new_n67_));
  ...
  aoi21  g42(.a(new_n71_), .b(x10), .c(new_n47_), .O(new_n77_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n73_), .c(new_n36_), .d(new_n80_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n63_), .O(z07));
  nor3   g50(.a(x11), .b(x10), .c(x09), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n66_), .c(x13), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n35_), .c(x12), .O(new_n87_));
  nor2   g53(.a(x11), .b(x10), .O(new_n88_));
  nor2   g54(.a(x09), .b(new_n65_), .O(new_n89_));
  nor2   g55(.a(x13), .b(x12), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n70_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n63_), .O(z08));
  inv1   g58(.a(x12), .O(new_n93_));
  nand4  g59(.a(new_n82_), .b(new_n73_), .c(new_n93_), .d(new_n80_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n51_), .c(new_n36_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  inv1   g62(.a(x10), .O(new_n97_));
  nand3  g63(.a(new_n93_), .b(new_n80_), .c(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n51_), .c(new_n69_), .d(x08), .O(new_n100_));
  nor2   g66(.a(new_n100_), .b(new_n64_), .O(new_n101_));
  nor2   g67(.a(new_n51_), .b(new_n41_), .O(new_n102_));
  aoi21  g68(.a(new_n101_), .b(x06), .c(new_n102_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n47_), .c(new_n50_), .O(z10));
  nand2  g70(.a(new_n50_), .b(new_n38_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n38_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n47_), .c(new_n50_), .O(z12));
  nor2   g73(.a(new_n37_), .b(new_n47_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n50_), .O(z14));
endmodule
