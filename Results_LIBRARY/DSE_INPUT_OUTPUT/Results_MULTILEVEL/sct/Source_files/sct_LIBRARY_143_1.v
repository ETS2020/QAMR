...
module FAU ( 
  ...
  oai21  g25(.a(x11), .b(x09), .c(new_n54_), .O(new_n60_));
  ...
  nor2   g31(.a(new_n65_), .b(new_n44_), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n62_), .c(new_n60_), .d(new_n47_), .O(z05));
  inv1   g33(.a(x10), .O(new_n68_));
  nand2  g34(.a(new_n35_), .b(new_n68_), .O(new_n69_));
  inv1   g35(.a(new_n69_), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(x06), .c(new_n48_), .O(new_n71_));
  nand3  g37(.a(new_n63_), .b(x08), .c(x07), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  inv1   g39(.a(new_n61_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n68_), .c(new_n63_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  nand3  g43(.a(new_n35_), .b(x10), .c(new_n54_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n71_), .O(z06));
  nand2  g45(.a(new_n48_), .b(new_n50_), .O(new_n80_));
  nand2  g46(.a(new_n75_), .b(x11), .O(new_n81_));
  nand3  g47(.a(new_n70_), .b(new_n74_), .c(new_n63_), .O(new_n82_));
  and2   g48(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n54_), .c(new_n80_), .O(z07));
  oai21  g50(.a(x12), .b(x11), .c(new_n54_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n48_), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand2  g53(.a(new_n74_), .b(x06), .O(new_n88_));
  nand3  g54(.a(new_n87_), .b(new_n68_), .c(new_n63_), .O(new_n89_));
  oai22  g55(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x06), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n35_), .O(new_n91_));
  nand3  g57(.a(new_n82_), .b(x12), .c(x06), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n86_), .O(z08));
  oai21  g59(.a(x13), .b(x11), .c(new_n54_), .O(new_n94_));
  nand3  g60(.a(new_n87_), .b(new_n35_), .c(new_n68_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n72_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n87_), .c(new_n35_), .d(new_n68_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n65_), .c(new_n44_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n94_), .d(new_n47_), .O(z09));
  ...
  nand3  g75(.a(new_n106_), .b(x14), .c(new_n35_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n44_), .O(z10));
  nand2  g77(.a(new_n50_), .b(new_n37_), .O(z11));
  aoi21  g78(.a(x16), .b(new_n37_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n44_), .c(new_n50_), .O(z12));
  nand2  g80(.a(new_n50_), .b(new_n44_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n36_), .b(new_n116_), .c(new_n44_), .O(z14));
endmodule
