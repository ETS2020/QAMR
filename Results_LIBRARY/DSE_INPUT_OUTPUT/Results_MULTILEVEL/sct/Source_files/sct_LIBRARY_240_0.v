...
module FAU ( 
  ...
  nor2   g03(.a(x14), .b(x02), .O(new_n38_));
  ...
  nand2  g31(.a(new_n65_), .b(new_n45_), .O(new_n66_));
  nand2  g32(.a(x14), .b(new_n35_), .O(new_n67_));
  oai21  g33(.a(new_n47_), .b(new_n35_), .c(new_n67_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x16), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(new_n66_), .O(z05));
  inv1   g36(.a(x14), .O(new_n71_));
  oai21  g37(.a(x16), .b(new_n71_), .c(new_n35_), .O(new_n72_));
  ...
  aoi21  g42(.a(new_n64_), .b(x10), .c(new_n76_), .O(new_n77_));
  ...
  and2   g49(.a(new_n83_), .b(new_n75_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n79_), .c(new_n72_), .d(x04), .O(z07));
  ...
  nand2  g55(.a(new_n89_), .b(new_n72_), .O(z08));
  ...
  nand2  g61(.a(new_n95_), .b(new_n45_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n69_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n93_), .b(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n75_), .b(x02), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n67_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n99_), .c(new_n63_), .d(x08), .O(new_n102_));
  ...
  aoi21  g72(.a(x16), .b(x04), .c(new_n71_), .O(new_n107_));
  oai22  g73(.a(new_n107_), .b(x02), .c(new_n42_), .d(new_n47_), .O(z12));
  nand2  g74(.a(new_n45_), .b(new_n42_), .O(z13));
  inv1   g75(.a(x17), .O(new_n110_));
  nor3   g76(.a(new_n38_), .b(new_n110_), .c(new_n42_), .O(z14));
  buf    g77(.a(x02), .O(z11));
endmodule
