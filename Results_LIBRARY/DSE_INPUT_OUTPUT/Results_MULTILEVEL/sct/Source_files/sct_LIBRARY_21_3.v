...
module FAU ( 
  ...
  aoi21  g17(.a(new_n51_), .b(new_n45_), .c(new_n42_), .O(z04));
  ...
  nor2   g24(.a(x12), .b(x06), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(new_n46_), .c(x04), .O(z08));
  inv1   g26(.a(x03), .O(new_n61_));
  inv1   g27(.a(x16), .O(new_n62_));
  aoi21  g28(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(x13), .c(new_n45_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z09));
  nand2  g31(.a(new_n63_), .b(x14), .O(new_n66_));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n61_), .c(new_n42_), .O(z12));
  nor2   g36(.a(x06), .b(new_n42_), .O(z13));
