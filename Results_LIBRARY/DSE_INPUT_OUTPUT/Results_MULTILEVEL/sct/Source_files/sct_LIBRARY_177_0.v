...
module FAU ( 
  ...
  nand2  g20(.a(x08), .b(new_n40_), .O(new_n55_));
  oai21  g21(.a(new_n54_), .b(new_n40_), .c(new_n55_), .O(new_n56_));
  ...
  aoi21  g38(.a(new_n66_), .b(x11), .c(new_n47_), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n39_), .c(new_n72_), .O(z07));
  ...
  nand3  g47(.a(new_n69_), .b(new_n81_), .c(new_n61_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(x12), .c(new_n47_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n39_), .c(new_n80_), .O(z08));
  ...
  nand3  g54(.a(new_n77_), .b(new_n65_), .c(new_n81_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x13), .c(new_n47_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n39_), .c(new_n88_), .O(z09));
  inv1   g57(.a(new_n36_), .O(new_n92_));
  inv1   g58(.a(x00), .O(new_n93_));
  aoi21  g59(.a(new_n86_), .b(new_n93_), .c(new_n47_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n61_), .c(x08), .d(x07), .O(new_n95_));
  nand2  g61(.a(new_n47_), .b(x14), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n40_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n92_), .O(z10));
  nor2   g65(.a(new_n36_), .b(new_n35_), .O(z11));
  nand2  g66(.a(x16), .b(new_n35_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n45_), .c(new_n39_), .O(z12));
