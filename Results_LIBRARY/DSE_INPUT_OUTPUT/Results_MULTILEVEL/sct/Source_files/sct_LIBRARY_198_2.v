...
module FAU ( 
  ...
  nor2   g01(.a(x05), .b(new_n35_), .O(new_n36_));
  inv1   g02(.a(x02), .O(new_n37_));
  nand2  g03(.a(new_n37_), .b(x01), .O(new_n38_));
  or2    g04(.a(x14), .b(x01), .O(new_n39_));
  aoi21  g05(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(z00));
  inv1   g06(.a(x15), .O(new_n41_));
  nand3  g07(.a(x18), .b(new_n41_), .c(new_n35_), .O(new_n42_));
  ...
  nand2  g34(.a(x05), .b(x03), .O(new_n69_));
  ...
  nand2  g45(.a(x16), .b(new_n37_), .O(new_n80_));
  ...
  aoi21  g61(.a(x16), .b(new_n37_), .c(new_n95_), .O(new_n96_));
  ...
  nand2  g70(.a(new_n62_), .b(new_n37_), .O(z11));
  nand3  g71(.a(x16), .b(new_n35_), .c(new_n37_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n69_), .c(new_n44_), .O(z12));
  nand2  g73(.a(new_n62_), .b(new_n44_), .O(z13));
