...
module FAU ( 
  ...
  nand4  g27(.a(new_n61_), .b(new_n59_), .c(new_n47_), .d(x04), .O(z05));
  nand2  g28(.a(new_n61_), .b(x10), .O(new_n63_));
  nor2   g29(.a(x10), .b(x09), .O(new_n64_));
  nand4  g30(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n63_), .c(new_n47_), .d(x04), .O(z06));
  nand2  g32(.a(new_n65_), .b(x11), .O(new_n67_));
  inv1   g33(.a(new_n58_), .O(new_n68_));
  nor2   g34(.a(x11), .b(x10), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n68_), .c(new_n60_), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n67_), .c(new_n47_), .d(x04), .O(z07));
  oai21  g37(.a(x12), .b(new_n41_), .c(new_n35_), .O(new_n72_));
  nand2  g38(.a(x08), .b(x07), .O(new_n73_));
  nand2  g39(.a(new_n69_), .b(new_n60_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n73_), .c(x12), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand4  g43(.a(new_n64_), .b(new_n68_), .c(new_n77_), .d(new_n76_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n47_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n72_), .O(z08));
  oai21  g47(.a(x13), .b(new_n41_), .c(new_n35_), .O(new_n82_));
  nand3  g48(.a(new_n60_), .b(x08), .c(x07), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  nand3  g50(.a(new_n77_), .b(new_n76_), .c(new_n84_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n83_), .c(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  inv1   g53(.a(new_n61_), .O(new_n88_));
  nand4  g54(.a(new_n69_), .b(new_n88_), .c(new_n87_), .d(new_n77_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n47_), .O(new_n90_));
  ...
  nand2  g60(.a(new_n84_), .b(x04), .O(new_n95_));
  nand3  g61(.a(new_n87_), .b(new_n77_), .c(new_n76_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n47_), .c(new_n60_), .d(x08), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n93_), .c(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x06), .O(new_n100_));
  inv1   g66(.a(new_n47_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x14), .c(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n100_), .O(z10));
  nand2  g69(.a(new_n46_), .b(new_n37_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n37_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n41_), .c(new_n46_), .O(z12));
