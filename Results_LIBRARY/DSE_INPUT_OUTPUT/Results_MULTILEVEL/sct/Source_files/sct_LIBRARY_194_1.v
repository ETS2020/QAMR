...
module FAU ( 
  ...
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n66_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n50_), .d(x04), .O(z07));
  oai21  g43(.a(x12), .b(new_n45_), .c(new_n35_), .O(new_n78_));
  nand2  g44(.a(x08), .b(x07), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(new_n66_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n79_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n70_), .b(new_n74_), .c(new_n83_), .d(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n50_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n78_), .O(z08));
  oai21  g53(.a(x13), .b(new_n45_), .c(new_n35_), .O(new_n88_));
  nand3  g54(.a(new_n66_), .b(x08), .c(x07), .O(new_n89_));
  inv1   g55(.a(x10), .O(new_n90_));
  nand3  g56(.a(new_n83_), .b(new_n82_), .c(new_n90_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n89_), .c(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n83_), .c(new_n82_), .d(new_n90_), .O(new_n94_));
  or2    g60(.a(new_n94_), .b(new_n67_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n92_), .c(new_n50_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n88_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n94_), .b(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n50_), .c(new_n66_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  or2    g69(.a(new_n50_), .b(new_n40_), .O(new_n104_));
  ...
  oai21  g73(.a(new_n107_), .b(new_n45_), .c(new_n56_), .O(z12));
