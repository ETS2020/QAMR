...
module FAU ( 
  ...
  nor2   g35(.a(new_n60_), .b(new_n55_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x06), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(x09), .c(new_n50_), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(new_n41_), .c(new_n69_), .O(z05));
  nor2   g39(.a(x10), .b(x09), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n70_), .c(new_n41_), .O(new_n75_));
  nand4  g41(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n76_));
  aoi21  g42(.a(new_n76_), .b(x10), .c(new_n50_), .O(new_n77_));
  oai22  g43(.a(new_n77_), .b(new_n41_), .c(new_n75_), .d(new_n43_), .O(z06));
  inv1   g44(.a(new_n70_), .O(new_n79_));
  inv1   g45(.a(x10), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n66_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n79_), .c(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nand4  g50(.a(new_n74_), .b(x08), .c(x07), .d(x06), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(x11), .c(new_n50_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n41_), .c(new_n84_), .O(z07));
  oai21  g53(.a(new_n82_), .b(new_n71_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(new_n71_), .O(new_n90_));
  ...
  or2    g61(.a(new_n95_), .b(new_n76_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n93_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  aoi21  g64(.a(new_n95_), .b(new_n98_), .c(new_n50_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n66_), .c(x08), .d(x07), .O(new_n100_));
