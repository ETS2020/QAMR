...
module FAU ( 
  ...
  nand2  g18(.a(new_n52_), .b(new_n42_), .O(z03));
  xnor2a g19(.a(x08), .b(x07), .O(new_n54_));
  nand3  g20(.a(new_n35_), .b(x08), .c(new_n47_), .O(new_n55_));
  ...
  oai21  g24(.a(x15), .b(x09), .c(new_n47_), .O(new_n59_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n62_), .c(new_n59_), .d(new_n48_), .O(z05));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n65_), .c(new_n41_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n72_), .c(new_n70_), .d(new_n48_), .O(z06));
  oai21  g43(.a(x15), .b(x11), .c(new_n47_), .O(new_n78_));
  nand2  g44(.a(new_n73_), .b(new_n60_), .O(new_n79_));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n82_), .c(new_n41_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n80_), .c(new_n78_), .d(new_n48_), .O(z07));
  oai21  g54(.a(x15), .b(x12), .c(new_n47_), .O(new_n89_));
  oai21  g55(.a(new_n85_), .b(new_n61_), .c(x12), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand3  g57(.a(new_n73_), .b(new_n91_), .c(new_n84_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n82_), .c(new_n41_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n89_), .d(new_n48_), .O(z08));
  oai21  g61(.a(x15), .b(x13), .c(new_n47_), .O(new_n96_));
  ...
  aoi21  g67(.a(new_n101_), .b(new_n67_), .c(new_n41_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n98_), .c(new_n96_), .d(new_n48_), .O(z09));
