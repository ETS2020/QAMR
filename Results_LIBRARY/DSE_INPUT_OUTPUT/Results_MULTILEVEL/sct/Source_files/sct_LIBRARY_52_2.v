...
module FAU ( 
  ...
  nor2   g26(.a(new_n61_), .b(new_n51_), .O(new_n62_));
  ...
  nand4  g32(.a(new_n67_), .b(new_n64_), .c(new_n52_), .d(x04), .O(z06));
  nand2  g33(.a(new_n66_), .b(x11), .O(new_n69_));
  inv1   g34(.a(x11), .O(new_n70_));
  nand4  g35(.a(new_n59_), .b(new_n70_), .c(new_n65_), .d(new_n58_), .O(new_n71_));
  nand3  g36(.a(new_n71_), .b(new_n69_), .c(new_n52_), .O(new_n72_));
  nand2  g37(.a(new_n72_), .b(x06), .O(new_n73_));
  nand2  g38(.a(new_n73_), .b(x04), .O(z07));
  nand2  g39(.a(new_n71_), .b(x12), .O(new_n75_));
  inv1   g40(.a(new_n60_), .O(new_n76_));
  nor3   g41(.a(x12), .b(x11), .c(x10), .O(new_n77_));
  aoi21  g42(.a(new_n77_), .b(new_n76_), .c(new_n36_), .O(new_n78_));
  nand4  g43(.a(new_n78_), .b(new_n75_), .c(new_n52_), .d(x04), .O(z08));
  ...
  nand4  g48(.a(new_n83_), .b(new_n82_), .c(new_n70_), .d(new_n65_), .O(new_n84_));
  inv1   g49(.a(new_n84_), .O(new_n85_));
  aoi21  g50(.a(new_n85_), .b(new_n76_), .c(new_n36_), .O(new_n86_));
  nand4  g51(.a(new_n86_), .b(new_n81_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n88_));
  aoi21  g53(.a(new_n84_), .b(new_n88_), .c(new_n51_), .O(new_n89_));
  nand4  g54(.a(new_n89_), .b(new_n58_), .c(x08), .d(x07), .O(new_n90_));
  aoi21  g55(.a(new_n51_), .b(x14), .c(new_n36_), .O(new_n91_));
  aoi21  g56(.a(new_n91_), .b(new_n90_), .c(new_n44_), .O(z10));
  nand2  g57(.a(new_n37_), .b(new_n38_), .O(z11));
  oai21  g58(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n94_));
  nand3  g59(.a(new_n94_), .b(x06), .c(x04), .O(new_n95_));
  inv1   g60(.a(new_n95_), .O(z12));
  inv1   g61(.a(x17), .O(new_n97_));
  aoi21  g62(.a(new_n97_), .b(x06), .c(new_n44_), .O(z14));
  zero   g63(.O(z02));
  buf    g64(.a(x04), .O(z13));
endmodule
