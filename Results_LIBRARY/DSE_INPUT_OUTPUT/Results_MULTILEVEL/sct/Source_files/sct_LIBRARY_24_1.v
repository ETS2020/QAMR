...
module FAU ( 
  ...
  oai21  g09(.a(x18), .b(new_n42_), .c(new_n43_), .O(new_n44_));
  oai21  g10(.a(new_n35_), .b(x15), .c(new_n42_), .O(new_n45_));
  ...
  nand2  g20(.a(new_n54_), .b(new_n37_), .O(z02));
  ...
  oai21  g29(.a(x18), .b(x09), .c(new_n43_), .O(new_n64_));
  oai21  g30(.a(new_n52_), .b(new_n46_), .c(new_n64_), .O(new_n65_));
  inv1   g31(.a(x09), .O(new_n66_));
  nand2  g32(.a(x07), .b(x06), .O(new_n67_));
  inv1   g33(.a(new_n67_), .O(new_n68_));
  nand3  g34(.a(new_n66_), .b(x07), .c(x06), .O(new_n69_));
  oai21  g35(.a(new_n68_), .b(new_n66_), .c(new_n69_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x08), .O(new_n71_));
  nand3  g37(.a(new_n35_), .b(x09), .c(new_n43_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n65_), .O(z05));
  oai21  g39(.a(x18), .b(x10), .c(new_n43_), .O(new_n74_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n74_), .d(new_n53_), .O(z06));
  oai21  g46(.a(x18), .b(x11), .c(new_n43_), .O(new_n81_));
  ...
  nand4  g53(.a(new_n87_), .b(new_n83_), .c(new_n81_), .d(new_n53_), .O(z07));
  oai21  g54(.a(x18), .b(x12), .c(new_n43_), .O(new_n89_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n91_), .c(new_n89_), .d(new_n53_), .O(z08));
  oai21  g63(.a(x18), .b(x13), .c(new_n43_), .O(new_n98_));
  oai21  g64(.a(new_n52_), .b(new_n46_), .c(new_n98_), .O(new_n99_));
  inv1   g65(.a(x10), .O(new_n100_));
  nand3  g66(.a(new_n93_), .b(new_n92_), .c(new_n100_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n69_), .c(x13), .O(new_n102_));
  inv1   g68(.a(x13), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n93_), .c(new_n92_), .d(new_n100_), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n69_), .c(new_n102_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x08), .O(new_n106_));
  nand3  g72(.a(new_n35_), .b(x13), .c(new_n43_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n106_), .c(new_n99_), .O(z09));
  inv1   g74(.a(x00), .O(new_n109_));
  aoi21  g75(.a(new_n104_), .b(new_n109_), .c(new_n52_), .O(new_n110_));
  ...
  oai21  g82(.a(new_n51_), .b(x02), .c(new_n50_), .O(new_n117_));
  nand3  g83(.a(new_n117_), .b(new_n37_), .c(x04), .O(new_n118_));
  inv1   g84(.a(new_n118_), .O(z12));
  nor2   g85(.a(new_n36_), .b(new_n46_), .O(z13));
