...
module FAU ( 
  ...
  nand2  g41(.a(x11), .b(new_n46_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n70_), .O(z07));
  inv1   g43(.a(x12), .O(new_n78_));
  nand4  g44(.a(new_n59_), .b(new_n78_), .c(new_n71_), .d(new_n62_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n58_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(new_n58_), .d(x06), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(x12), .c(new_n43_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n47_), .O(z08));
  and2   g50(.a(new_n79_), .b(x13), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n78_), .c(new_n71_), .d(new_n62_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(new_n60_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n85_), .c(new_n58_), .O(new_n89_));
  nand2  g55(.a(x13), .b(new_n46_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n70_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n87_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n47_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(new_n69_), .b(x14), .O(new_n95_));
  ...
  nand3  g68(.a(new_n102_), .b(new_n36_), .c(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z12));
  nor2   g70(.a(new_n37_), .b(new_n43_), .O(z13));
  nand3  g71(.a(new_n36_), .b(x17), .c(x04), .O(new_n106_));
