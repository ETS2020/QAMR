...
module FAU ( 
  ...
  aoi21  g47(.a(new_n74_), .b(x11), .c(new_n67_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n36_), .c(new_n81_), .O(z07));
  oai21  g49(.a(new_n79_), .b(new_n68_), .c(x12), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  inv1   g51(.a(new_n68_), .O(new_n86_));
  nand4  g52(.a(new_n73_), .b(new_n86_), .c(new_n85_), .d(new_n78_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n54_), .d(x04), .O(z08));
  nand2  g54(.a(new_n87_), .b(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n91_));
  or2    g57(.a(new_n91_), .b(new_n71_), .O(new_n92_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n54_), .c(new_n63_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  nand2  g64(.a(new_n67_), .b(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n36_), .O(z10));
  nand2  g66(.a(new_n38_), .b(new_n39_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n39_), .c(x03), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n36_), .c(new_n38_), .O(z12));
  nand2  g69(.a(x06), .b(new_n36_), .O(z13));
