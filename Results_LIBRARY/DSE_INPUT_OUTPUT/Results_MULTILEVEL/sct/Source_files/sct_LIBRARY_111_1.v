...
module FAU ( 
  ...
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n61_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n72_), .c(new_n48_), .d(x04), .O(z07));
  oai21  g42(.a(x12), .b(new_n38_), .c(new_n47_), .O(new_n77_));
  nand2  g43(.a(x08), .b(x07), .O(new_n78_));
  nand2  g44(.a(new_n74_), .b(new_n61_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n78_), .c(x12), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n67_), .b(new_n73_), .c(new_n82_), .d(new_n81_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n80_), .c(new_n48_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n77_), .O(z08));
  oai21  g52(.a(x13), .b(new_n38_), .c(new_n47_), .O(new_n87_));
  inv1   g53(.a(x10), .O(new_n88_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n88_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n65_), .c(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n82_), .c(new_n81_), .d(new_n88_), .O(new_n92_));
  or2    g58(.a(new_n92_), .b(new_n62_), .O(new_n93_));
  ...
  nor2   g71(.a(new_n105_), .b(new_n38_), .O(z12));
  nand2  g72(.a(new_n47_), .b(new_n38_), .O(z13));
