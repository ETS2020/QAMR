...
module FAU ( 
  ...
  nand3  g26(.a(new_n36_), .b(x08), .c(new_n54_), .O(new_n61_));
  ...
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n44_), .O(new_n71_));
  ...
  nor2   g41(.a(new_n59_), .b(new_n54_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n36_), .c(new_n75_), .d(new_n66_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(new_n73_), .O(z06));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n76_), .c(x17), .O(new_n82_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n75_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n67_), .c(new_n36_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n51_), .d(x04), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n87_), .c(new_n84_), .d(new_n75_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n67_), .c(new_n36_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand4  g62(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand4  g63(.a(new_n36_), .b(new_n87_), .c(new_n84_), .d(new_n75_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n97_), .c(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n94_), .b(new_n101_), .c(new_n50_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n66_), .c(x08), .d(x07), .O(new_n103_));
  ...
  oai21  g78(.a(new_n36_), .b(new_n35_), .c(new_n44_), .O(z13));
  nand3  g79(.a(x17), .b(new_n35_), .c(x04), .O(new_n114_));
