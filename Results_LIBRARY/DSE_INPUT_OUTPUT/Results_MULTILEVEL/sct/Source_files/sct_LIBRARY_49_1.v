...
module FAU ( 
  ...
  oai21  g27(.a(x09), .b(new_n43_), .c(new_n35_), .O(new_n62_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n65_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n74_), .c(new_n49_), .d(x04), .O(z07));
  nand2  g46(.a(new_n79_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n78_), .b(new_n71_), .c(new_n82_), .d(new_n76_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n49_), .d(x04), .O(z08));
  ...
  nor2   g65(.a(new_n99_), .b(new_n43_), .O(z12));
