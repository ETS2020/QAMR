...
module FAU ( 
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n51_), .d(x04), .O(z08));
  ...
  or2    g52(.a(new_n86_), .b(new_n69_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n51_), .d(x04), .O(z09));
  ...
  nand2  g59(.a(new_n65_), .b(x14), .O(new_n94_));
  ...
  oai21  g63(.a(new_n97_), .b(new_n39_), .c(new_n54_), .O(z12));
  nand2  g64(.a(x17), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n54_), .O(z14));
  buf    g66(.a(x04), .O(z13));
endmodule
