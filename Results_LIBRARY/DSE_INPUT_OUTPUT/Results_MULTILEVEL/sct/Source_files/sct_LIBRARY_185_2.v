...
module FAU ( 
  ...
  aoi21  g17(.a(new_n51_), .b(x06), .c(new_n35_), .O(z03));
  ...
  nand3  g32(.a(new_n66_), .b(new_n63_), .c(new_n50_), .O(new_n67_));
  ...
  and2   g38(.a(new_n72_), .b(x06), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n50_), .d(x04), .O(z07));
  nand2  g40(.a(new_n72_), .b(x12), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  inv1   g42(.a(new_n59_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n71_), .d(new_n64_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n50_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x06), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(z08));
  nand2  g47(.a(new_n78_), .b(x13), .O(new_n82_));
  inv1   g48(.a(x06), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n76_), .c(new_n71_), .d(new_n64_), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n77_), .c(new_n83_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n82_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n85_), .b(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n50_), .c(new_n58_), .d(x08), .O(new_n91_));
  nand3  g57(.a(new_n49_), .b(x16), .c(x14), .O(new_n92_));
  ...
  nand2  g61(.a(new_n41_), .b(new_n37_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n37_), .c(new_n83_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n48_), .c(new_n35_), .O(z12));
  inv1   g64(.a(x17), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(x06), .c(new_n35_), .O(z14));
  buf    g66(.a(x04), .O(z13));
endmodule
