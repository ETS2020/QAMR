...
module FAU ( 
  ...
  nand2  g23(.a(x08), .b(new_n42_), .O(new_n58_));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n63_), .c(new_n40_), .O(new_n70_));
  aoi21  g36(.a(new_n67_), .b(x10), .c(new_n53_), .O(new_n71_));
  oai22  g37(.a(new_n71_), .b(new_n40_), .c(new_n70_), .d(new_n42_), .O(z06));
  inv1   g38(.a(x10), .O(new_n73_));
  inv1   g39(.a(x11), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n62_), .c(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  nand4  g43(.a(new_n69_), .b(x08), .c(x07), .d(x06), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(x11), .c(new_n53_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n40_), .c(new_n77_), .O(z07));
  oai21  g46(.a(new_n75_), .b(new_n64_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  inv1   g48(.a(new_n64_), .O(new_n83_));
  nand4  g49(.a(new_n69_), .b(new_n83_), .c(new_n82_), .d(new_n74_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n54_), .d(x04), .O(z08));
  nand3  g51(.a(new_n66_), .b(x08), .c(x07), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n82_), .c(new_n74_), .d(new_n73_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n86_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  aoi21  g56(.a(new_n84_), .b(x13), .c(new_n53_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n40_), .c(new_n90_), .O(z09));
  inv1   g58(.a(new_n36_), .O(new_n93_));
  inv1   g59(.a(x00), .O(new_n94_));
  aoi21  g60(.a(new_n88_), .b(new_n94_), .c(new_n53_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n66_), .c(x08), .d(x07), .O(new_n96_));
  nand2  g62(.a(new_n53_), .b(x14), .O(new_n97_));
  oai21  g63(.a(new_n96_), .b(new_n42_), .c(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n93_), .O(z10));
