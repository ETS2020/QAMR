...
module FAU ( 
  ...
  nand2  g21(.a(new_n55_), .b(new_n35_), .O(z04));
  inv1   g22(.a(x09), .O(new_n57_));
  nand4  g23(.a(new_n48_), .b(new_n35_), .c(new_n57_), .d(x04), .O(z05));
  ...
  nand2  g39(.a(new_n35_), .b(new_n44_), .O(z13));
  nand3  g40(.a(new_n35_), .b(x17), .c(x04), .O(new_n75_));
