...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(new_n36_), .c(x08), .O(new_n66_));
  ...
  nand4  g38(.a(new_n65_), .b(new_n36_), .c(new_n61_), .d(x08), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x10), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n49_), .d(x04), .O(z06));
  inv1   g41(.a(new_n49_), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n44_), .c(new_n52_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n69_), .c(new_n36_), .d(new_n79_), .O(new_n82_));
  ...
  oai21  g52(.a(new_n86_), .b(new_n62_), .c(new_n36_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nand2  g54(.a(new_n82_), .b(x12), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n49_), .d(x04), .O(z08));
  nand4  g56(.a(new_n81_), .b(new_n69_), .c(new_n85_), .d(new_n79_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n49_), .c(x04), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n36_), .O(new_n93_));
  oai21  g59(.a(new_n36_), .b(x06), .c(new_n93_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  aoi22  g61(.a(new_n86_), .b(new_n95_), .c(new_n48_), .d(x16), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n61_), .c(x08), .d(x07), .O(new_n97_));
  nand2  g63(.a(new_n76_), .b(x14), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n35_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n36_), .O(new_n100_));
  nand3  g66(.a(new_n76_), .b(x14), .c(new_n35_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n44_), .O(z10));
  nand2  g68(.a(new_n52_), .b(new_n38_), .O(z11));
  inv1   g69(.a(x16), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(x02), .c(new_n47_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n52_), .c(x04), .O(new_n106_));
