...
module FAU ( 
  ...
  aoi21  g41(.a(new_n67_), .b(x10), .c(new_n75_), .O(new_n76_));
  ...
  oai21  g49(.a(new_n83_), .b(new_n37_), .c(new_n71_), .O(z07));
  nand2  g50(.a(new_n81_), .b(x12), .O(new_n85_));
  nand4  g51(.a(new_n73_), .b(new_n80_), .c(new_n35_), .d(new_n79_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n50_), .d(x04), .O(z08));
  oai21  g53(.a(x16), .b(x13), .c(x12), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n44_), .O(new_n89_));
  nand2  g55(.a(new_n81_), .b(x13), .O(new_n90_));
  nor2   g56(.a(x13), .b(x11), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n73_), .c(new_n80_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n90_), .c(new_n56_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n35_), .O(new_n94_));
  nand3  g60(.a(new_n36_), .b(x13), .c(x12), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z09));
  nand2  g62(.a(new_n50_), .b(x00), .O(new_n97_));
  aoi21  g63(.a(new_n55_), .b(x16), .c(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n35_), .c(new_n79_), .d(new_n78_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n97_), .c(x09), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(x08), .c(x07), .d(x06), .O(new_n101_));
  nand3  g67(.a(new_n70_), .b(x14), .c(new_n35_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n44_), .O(z10));
  nand2  g69(.a(new_n53_), .b(new_n38_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n38_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n44_), .c(new_n53_), .O(z12));
  nor2   g72(.a(new_n37_), .b(new_n44_), .O(z13));
