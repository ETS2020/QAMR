...
module FAU ( 
  ...
  nand2  g03(.a(x16), .b(x14), .O(new_n38_));
  ...
  nand3  g15(.a(new_n35_), .b(new_n49_), .c(x02), .O(new_n50_));
  ...
  oai21  g20(.a(x03), .b(new_n37_), .c(x16), .O(new_n55_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n51_), .d(x04), .O(z06));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(x11), .O(new_n73_));
  inv1   g39(.a(new_n63_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n65_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(new_n76_));
  aoi21  g42(.a(new_n70_), .b(x11), .c(new_n76_), .O(new_n77_));
  or2    g43(.a(new_n55_), .b(x14), .O(new_n78_));
  oai21  g44(.a(new_n77_), .b(new_n39_), .c(new_n78_), .O(z07));
  nand2  g45(.a(new_n75_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n69_), .b(new_n74_), .c(new_n81_), .d(new_n73_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n51_), .d(x04), .O(z08));
  nand2  g49(.a(new_n82_), .b(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n73_), .d(new_n72_), .O(new_n86_));
  or2    g52(.a(new_n86_), .b(new_n66_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n38_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n78_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand2  g57(.a(new_n86_), .b(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n51_), .c(new_n65_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x07), .c(x06), .d(x04), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(z10));
  nand2  g62(.a(new_n38_), .b(new_n37_), .O(z11));
  nand2  g63(.a(new_n38_), .b(x03), .O(new_n98_));
  nand3  g64(.a(x16), .b(new_n35_), .c(new_n37_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n45_), .O(z12));
