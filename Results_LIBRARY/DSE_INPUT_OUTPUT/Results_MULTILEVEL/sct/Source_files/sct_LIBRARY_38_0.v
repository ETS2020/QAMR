...
module FAU ( 
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n50_), .d(x04), .O(z06));
  ...
  nand4  g40(.a(new_n74_), .b(new_n70_), .c(new_n50_), .d(x04), .O(z07));
  nand3  g41(.a(new_n63_), .b(x08), .c(x06), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n72_), .c(new_n71_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n76_), .c(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x07), .O(new_n80_));
  aoi21  g46(.a(new_n74_), .b(x12), .c(new_n49_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n36_), .c(new_n80_), .O(z08));
  nand3  g48(.a(new_n67_), .b(new_n77_), .c(new_n72_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n61_), .c(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n77_), .c(new_n72_), .d(new_n71_), .O(new_n86_));
  or2    g52(.a(new_n86_), .b(new_n64_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  aoi21  g55(.a(new_n86_), .b(new_n89_), .c(new_n49_), .O(new_n90_));
  ...
  aoi21  g62(.a(x16), .b(new_n39_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n36_), .c(new_n38_), .O(z12));
  nand2  g64(.a(x17), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n38_), .O(z14));
  buf    g66(.a(x04), .O(z13));
endmodule
