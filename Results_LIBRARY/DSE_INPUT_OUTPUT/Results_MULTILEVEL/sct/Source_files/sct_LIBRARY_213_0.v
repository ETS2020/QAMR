...
module FAU ( 
  ...
  aoi21  g43(.a(new_n77_), .b(new_n67_), .c(new_n44_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n72_), .d(new_n51_), .O(z06));
  oai21  g45(.a(new_n63_), .b(x11), .c(new_n57_), .O(new_n80_));
  ...
  oai21  g53(.a(new_n63_), .b(x12), .c(new_n57_), .O(new_n88_));
  ...
  oai21  g62(.a(new_n63_), .b(x13), .c(new_n57_), .O(new_n97_));
  ...
  oai21  g82(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n117_));
  nand3  g83(.a(new_n117_), .b(new_n36_), .c(x04), .O(new_n118_));
  inv1   g84(.a(new_n118_), .O(z12));
  nor2   g85(.a(new_n35_), .b(new_n44_), .O(z13));
  oai21  g86(.a(new_n63_), .b(new_n44_), .c(new_n36_), .O(z14));
endmodule
