...
module FAU ( 
  ...
  oai21  g09(.a(x08), .b(x05), .c(new_n43_), .O(new_n44_));
  ...
  nand3  g32(.a(new_n62_), .b(x07), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x10), .O(new_n68_));
  nor2   g34(.a(x10), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n63_), .c(x08), .O(new_n70_));
  ...
  oai21  g44(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n79_));
  nand3  g45(.a(new_n76_), .b(new_n63_), .c(new_n62_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n69_), .b(new_n75_), .c(new_n83_), .d(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n49_), .O(new_n85_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n83_), .c(new_n82_), .d(new_n89_), .O(new_n91_));
  or2    g57(.a(new_n91_), .b(new_n64_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n91_), .b(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n49_), .c(new_n62_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  or2    g64(.a(new_n49_), .b(new_n40_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z10));
  inv1   g66(.a(new_n36_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n37_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n37_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n43_), .c(new_n101_), .O(z12));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n101_), .O(z14));
  buf    g72(.a(x04), .O(z13));
endmodule
