...
module FAU ( 
  ...
  oai21  g28(.a(x09), .b(new_n40_), .c(new_n62_), .O(new_n63_));
  oai21  g29(.a(new_n49_), .b(new_n61_), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g36(.a(x09), .b(new_n62_), .c(x05), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z05));
  oai21  g38(.a(x10), .b(new_n40_), .c(new_n62_), .O(new_n73_));
  ...
  oai21  g44(.a(x11), .b(new_n40_), .c(new_n62_), .O(new_n79_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n83_), .c(new_n61_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n79_), .d(new_n50_), .O(z07));
  oai21  g52(.a(x12), .b(new_n40_), .c(new_n62_), .O(new_n87_));
  ...
  aoi21  g59(.a(new_n93_), .b(new_n83_), .c(new_n61_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n89_), .c(new_n87_), .d(new_n50_), .O(z08));
  oai21  g61(.a(x13), .b(new_n40_), .c(new_n62_), .O(new_n96_));
  ...
  nor2   g69(.a(new_n103_), .b(new_n61_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n99_), .c(new_n96_), .d(new_n50_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  aoi21  g72(.a(new_n102_), .b(new_n106_), .c(new_n49_), .O(new_n107_));
  ...
  oai21  g80(.a(new_n114_), .b(new_n61_), .c(new_n46_), .O(z12));
  nor2   g81(.a(new_n35_), .b(new_n61_), .O(z13));
