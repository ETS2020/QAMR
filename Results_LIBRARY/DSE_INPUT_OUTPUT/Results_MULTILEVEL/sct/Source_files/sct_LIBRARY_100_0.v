...
module FAU ( 
  ...
  aoi21  g39(.a(new_n73_), .b(x10), .c(new_n47_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n39_), .c(new_n72_), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n62_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n48_), .d(x04), .O(z07));
  ...
  aoi21  g59(.a(new_n90_), .b(new_n93_), .c(new_n47_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n62_), .c(x08), .d(x07), .O(new_n95_));
  ...
  nand2  g64(.a(new_n98_), .b(new_n51_), .O(z10));
  nor2   g65(.a(new_n36_), .b(new_n35_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n35_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n39_), .c(new_n51_), .O(z12));
  nand2  g68(.a(x06), .b(new_n39_), .O(z13));
