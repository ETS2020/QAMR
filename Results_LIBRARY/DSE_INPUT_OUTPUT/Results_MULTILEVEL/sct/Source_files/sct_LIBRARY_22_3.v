...
module FAU ( 
  ...
  oai21  g28(.a(new_n62_), .b(x18), .c(x06), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x09), .O(new_n64_));
  nor2   g30(.a(x18), .b(x09), .O(new_n65_));
  ...
  nand2  g39(.a(new_n62_), .b(x06), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n36_), .c(new_n73_), .d(new_n68_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n72_), .c(new_n61_), .O(z06));
  nor2   g43(.a(x11), .b(x10), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n62_), .c(new_n68_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n36_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand2  g47(.a(new_n76_), .b(x11), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n49_), .d(x04), .O(z07));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n73_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n69_), .c(new_n36_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nor2   g54(.a(x18), .b(x11), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n73_), .c(new_n68_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n74_), .c(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n49_), .d(x04), .O(z08));
  nor2   g58(.a(x13), .b(x12), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n78_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n69_), .c(new_n36_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand4  g62(.a(new_n68_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand3  g63(.a(new_n78_), .b(new_n36_), .c(new_n85_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n97_), .c(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n94_), .b(new_n101_), .c(new_n48_), .O(new_n102_));
  ...
  nand2  g73(.a(new_n45_), .b(new_n38_), .O(z11));
  oai21  g74(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n45_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nor2   g77(.a(new_n37_), .b(new_n60_), .O(z13));
