...
module FAU ( 
  ...
  oai21  g29(.a(x17), .b(x09), .c(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n51_), .b(new_n45_), .c(new_n64_), .O(new_n65_));
  ...
  nand3  g37(.a(new_n35_), .b(x09), .c(new_n63_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n65_), .O(z05));
  oai21  g39(.a(x17), .b(x10), .c(new_n63_), .O(new_n74_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n74_), .d(new_n52_), .O(z06));
  oai21  g45(.a(x17), .b(x11), .c(new_n63_), .O(new_n80_));
  ...
  oai21  g53(.a(x17), .b(x12), .c(new_n63_), .O(new_n88_));
  ...
  oai21  g62(.a(x17), .b(x13), .c(new_n63_), .O(new_n97_));
  ...
  nand3  g71(.a(new_n35_), .b(x13), .c(new_n63_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n105_), .c(new_n98_), .O(z09));
  inv1   g73(.a(x00), .O(new_n108_));
  aoi21  g74(.a(new_n103_), .b(new_n108_), .c(new_n51_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n68_), .c(x08), .d(x07), .O(new_n110_));
  nand2  g76(.a(new_n51_), .b(x14), .O(new_n111_));
  oai21  g77(.a(new_n110_), .b(new_n48_), .c(new_n111_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n37_), .O(z10));
  nor2   g80(.a(new_n36_), .b(new_n39_), .O(z11));
  oai21  g81(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n37_), .c(x04), .O(new_n117_));
  inv1   g83(.a(new_n117_), .O(z12));
  nand2  g84(.a(new_n37_), .b(new_n45_), .O(z13));
  aoi21  g85(.a(x07), .b(new_n45_), .c(new_n35_), .O(z14));
endmodule
