...
module FAU ( 
  ...
  nand3  g23(.a(new_n35_), .b(x08), .c(new_n47_), .O(new_n58_));
  ...
  oai21  g27(.a(x15), .b(x09), .c(new_n47_), .O(new_n62_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n65_), .c(new_n62_), .d(new_n51_), .O(z05));
  oai21  g36(.a(x15), .b(x10), .c(new_n47_), .O(new_n71_));
  oai21  g37(.a(new_n50_), .b(new_n41_), .c(new_n71_), .O(new_n72_));
  nand3  g38(.a(new_n66_), .b(x08), .c(x07), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x10), .O(new_n74_));
  inv1   g40(.a(x10), .O(new_n75_));
  nand3  g41(.a(new_n63_), .b(new_n75_), .c(new_n66_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x06), .O(new_n78_));
  nand3  g44(.a(new_n35_), .b(x10), .c(new_n47_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n72_), .O(z06));
  oai21  g46(.a(x15), .b(x11), .c(new_n47_), .O(new_n81_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n84_), .c(new_n41_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n82_), .c(new_n81_), .d(new_n51_), .O(z07));
  oai21  g53(.a(x15), .b(x12), .c(new_n47_), .O(new_n88_));
  nand2  g54(.a(new_n85_), .b(new_n63_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x12), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n75_), .d(new_n66_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n84_), .c(new_n41_), .O(new_n95_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n92_), .c(new_n91_), .d(new_n75_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n68_), .c(new_n41_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n99_), .c(new_n97_), .d(new_n51_), .O(z09));
  ...
  nand2  g76(.a(new_n110_), .b(new_n42_), .O(z10));
  nor2   g77(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g78(.a(x16), .b(new_n37_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n41_), .c(new_n42_), .O(z12));
  nand2  g80(.a(new_n42_), .b(new_n41_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n36_), .b(new_n116_), .c(new_n41_), .O(z14));
endmodule
