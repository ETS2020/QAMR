...
module FAU ( 
  ...
  oai21  g24(.a(x09), .b(new_n38_), .c(new_n47_), .O(new_n59_));
  ...
  oai21  g31(.a(x10), .b(new_n38_), .c(new_n47_), .O(new_n66_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n74_), .c(new_n48_), .d(x04), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n48_), .d(x04), .O(z08));
  nand2  g50(.a(new_n83_), .b(x13), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n82_), .c(new_n76_), .d(new_n75_), .O(new_n87_));
  or2    g53(.a(new_n87_), .b(new_n62_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n87_), .b(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n48_), .c(new_n60_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x07), .c(x06), .O(new_n94_));
  or2    g60(.a(new_n48_), .b(new_n36_), .O(new_n95_));
  ...
  nand2  g65(.a(new_n47_), .b(new_n38_), .O(z13));
