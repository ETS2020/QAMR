...
module FAU ( 
  ...
  nand3  g24(.a(new_n36_), .b(x08), .c(new_n52_), .O(new_n59_));
  aoi21  g25(.a(new_n59_), .b(new_n58_), .c(new_n35_), .O(new_n60_));
  nor2   g26(.a(new_n57_), .b(x06), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n42_), .c(new_n44_), .O(z04));
  oai21  g29(.a(new_n48_), .b(new_n42_), .c(new_n44_), .O(new_n64_));
  nand2  g30(.a(x08), .b(x07), .O(new_n65_));
  inv1   g31(.a(new_n65_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(x14), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x09), .O(new_n68_));
  nor2   g34(.a(x14), .b(x09), .O(new_n69_));
  ...
  nor2   g42(.a(x14), .b(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n66_), .c(new_n72_), .d(x06), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n64_), .O(z06));
  nor2   g45(.a(x11), .b(x10), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n66_), .c(new_n72_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n36_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  aoi21  g49(.a(new_n78_), .b(x11), .c(new_n42_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n49_), .O(z07));
  ...
  nand4  g55(.a(new_n89_), .b(new_n80_), .c(new_n36_), .d(new_n87_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n86_), .c(new_n64_), .O(z08));
  inv1   g57(.a(x10), .O(new_n92_));
  inv1   g58(.a(x11), .O(new_n93_));
  nand3  g59(.a(new_n87_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n73_), .c(new_n36_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x13), .O(new_n97_));
  nor3   g63(.a(x14), .b(x13), .c(x12), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n89_), .c(new_n80_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n64_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nor2   g67(.a(x13), .b(x12), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n80_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n48_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n72_), .c(x08), .d(x07), .O(new_n105_));
  nand2  g71(.a(new_n48_), .b(x14), .O(new_n106_));
  oai21  g72(.a(new_n105_), .b(new_n35_), .c(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n44_), .O(z10));
  inv1   g75(.a(x02), .O(new_n110_));
  nand2  g76(.a(new_n44_), .b(new_n110_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n110_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n42_), .c(new_n44_), .O(z12));
  nand2  g79(.a(new_n44_), .b(new_n42_), .O(z13));
