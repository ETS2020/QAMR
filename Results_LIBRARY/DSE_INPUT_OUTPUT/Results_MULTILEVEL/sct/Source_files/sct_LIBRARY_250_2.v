...
module FAU ( 
  ...
  nand3  g18(.a(x14), .b(new_n52_), .c(x06), .O(new_n53_));
  ...
  nand3  g24(.a(x14), .b(x08), .c(new_n52_), .O(new_n59_));
  aoi21  g25(.a(new_n59_), .b(new_n58_), .c(new_n40_), .O(new_n60_));
  nor2   g26(.a(new_n57_), .b(x06), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n46_), .c(new_n38_), .O(z04));
  nand2  g29(.a(new_n49_), .b(x04), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(new_n38_), .O(new_n65_));
  nor2   g31(.a(new_n57_), .b(new_n52_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n37_), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x09), .O(new_n68_));
  nor2   g34(.a(new_n52_), .b(new_n40_), .O(new_n69_));
  nor2   g35(.a(new_n37_), .b(x09), .O(new_n70_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n66_), .c(new_n37_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n40_), .c(x12), .O(new_n85_));
  nor2   g51(.a(x11), .b(x10), .O(new_n86_));
  nor2   g52(.a(x09), .b(new_n57_), .O(new_n87_));
  nor2   g53(.a(new_n37_), .b(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n69_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n85_), .c(new_n65_), .O(z08));
  nand2  g56(.a(new_n87_), .b(x07), .O(new_n91_));
  inv1   g57(.a(x10), .O(new_n92_));
  inv1   g58(.a(x11), .O(new_n93_));
  inv1   g59(.a(x12), .O(new_n94_));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n91_), .c(x14), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x06), .O(new_n98_));
  aoi21  g64(.a(new_n89_), .b(x13), .c(new_n46_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(new_n49_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n96_), .b(new_n101_), .c(x09), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(x08), .c(x07), .d(x06), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n49_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x14), .c(x04), .O(new_n105_));
  ...
  nand3  g75(.a(new_n109_), .b(new_n38_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n38_), .b(new_n46_), .O(z13));
  nand2  g78(.a(new_n38_), .b(x17), .O(new_n113_));
  nor2   g79(.a(new_n113_), .b(new_n46_), .O(z14));
endmodule
