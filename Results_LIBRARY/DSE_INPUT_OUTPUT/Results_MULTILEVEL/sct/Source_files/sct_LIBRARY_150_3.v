...
module FAU ( 
  ...
  nand3  g20(.a(x07), .b(new_n47_), .c(new_n35_), .O(new_n55_));
  ...
  nand3  g25(.a(new_n59_), .b(x07), .c(new_n35_), .O(new_n60_));
  ...
  oai21  g30(.a(new_n51_), .b(new_n44_), .c(new_n48_), .O(new_n65_));
  inv1   g31(.a(x09), .O(new_n66_));
  aoi21  g32(.a(x08), .b(x06), .c(new_n66_), .O(new_n67_));
  nand4  g33(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n68_));
  inv1   g34(.a(new_n68_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n67_), .c(new_n35_), .O(new_n70_));
  nand2  g36(.a(x09), .b(new_n36_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z05));
  oai21  g38(.a(x10), .b(x07), .c(x05), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n73_), .d(new_n52_), .O(z06));
  oai21  g44(.a(x11), .b(x07), .c(x05), .O(new_n79_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n66_), .O(new_n85_));
  and2   g51(.a(new_n85_), .b(x04), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n80_), .c(new_n79_), .d(new_n52_), .O(z07));
  oai21  g53(.a(x12), .b(x07), .c(x05), .O(new_n88_));
  nand2  g54(.a(new_n85_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n75_), .b(new_n90_), .c(new_n82_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n84_), .c(new_n44_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n88_), .d(new_n52_), .O(z08));
  oai21  g60(.a(x13), .b(x07), .c(x05), .O(new_n95_));
  oai21  g61(.a(new_n91_), .b(new_n83_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n90_), .c(new_n82_), .d(new_n81_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n69_), .c(new_n44_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n95_), .d(new_n52_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n98_), .b(new_n102_), .c(new_n51_), .O(new_n103_));
  ...
  nand3  g73(.a(new_n51_), .b(x14), .c(new_n36_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z10));
  nand2  g75(.a(new_n48_), .b(new_n38_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n38_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n44_), .c(new_n48_), .O(z12));
