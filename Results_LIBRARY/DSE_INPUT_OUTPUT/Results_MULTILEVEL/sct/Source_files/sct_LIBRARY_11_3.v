...
module FAU ( 
  ...
  nand4  g36(.a(new_n70_), .b(new_n66_), .c(new_n51_), .d(x04), .O(z05));
  ...
  nand4  g42(.a(new_n68_), .b(new_n36_), .c(new_n63_), .d(x08), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(x10), .c(new_n42_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n51_), .O(z06));
  nor2   g45(.a(x11), .b(x10), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n72_), .c(new_n63_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n36_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  nand2  g49(.a(new_n72_), .b(x06), .O(new_n84_));
  inv1   g50(.a(x10), .O(new_n85_));
  nand3  g51(.a(new_n36_), .b(new_n85_), .c(new_n63_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n84_), .c(x11), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n83_), .c(new_n51_), .d(x04), .O(z07));
  inv1   g54(.a(x11), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n85_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n64_), .c(new_n36_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  nand3  g59(.a(new_n73_), .b(new_n36_), .c(new_n89_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n84_), .c(x12), .O(new_n95_));
  ...
  oai21  g64(.a(new_n98_), .b(new_n64_), .c(new_n36_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g66(.a(new_n68_), .b(new_n63_), .c(x08), .O(new_n101_));
  nand3  g67(.a(new_n80_), .b(new_n36_), .c(new_n90_), .O(new_n102_));
  ...
  nand2  g78(.a(new_n43_), .b(new_n38_), .O(z11));
  oai21  g79(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n43_), .c(x04), .O(new_n115_));
  inv1   g81(.a(new_n115_), .O(z12));
  nand2  g82(.a(new_n43_), .b(new_n42_), .O(z13));
  nand2  g83(.a(x17), .b(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n43_), .O(z14));
endmodule
