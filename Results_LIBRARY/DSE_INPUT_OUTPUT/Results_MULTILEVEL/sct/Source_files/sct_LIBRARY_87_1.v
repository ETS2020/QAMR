...
module FAU ( 
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n48_), .d(x04), .O(z07));
  ...
  oai21  g60(.a(new_n94_), .b(new_n70_), .c(x13), .O(new_n95_));
  ...
  or2    g72(.a(new_n48_), .b(new_n40_), .O(new_n107_));
  ...
  oai21  g76(.a(new_n110_), .b(new_n43_), .c(new_n51_), .O(z12));
  nand2  g77(.a(new_n35_), .b(new_n43_), .O(z13));
  nand2  g78(.a(x17), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n51_), .O(z14));
endmodule
