...
module FAU ( 
  ...
  and2   g15(.a(new_n49_), .b(x16), .O(new_n50_));
  ...
  nand3  g26(.a(new_n60_), .b(new_n37_), .c(x06), .O(new_n61_));
  ...
  nor2   g34(.a(new_n54_), .b(new_n36_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n37_), .c(x08), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n44_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n68_), .c(new_n51_), .O(z05));
  nor2   g38(.a(new_n59_), .b(new_n54_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n69_), .b(new_n37_), .c(new_n65_), .d(x08), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(x10), .c(new_n44_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n51_), .O(z06));
  nand3  g46(.a(new_n74_), .b(new_n69_), .c(x08), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n51_), .c(new_n37_), .d(x04), .O(z07));
  inv1   g48(.a(new_n73_), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n83_), .c(new_n37_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nand2  g54(.a(new_n73_), .b(x06), .O(new_n89_));
  nand3  g55(.a(new_n37_), .b(new_n84_), .c(new_n65_), .O(new_n90_));
  ...
  nand3  g59(.a(new_n93_), .b(new_n85_), .c(new_n84_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n66_), .c(new_n37_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand3  g62(.a(new_n74_), .b(new_n85_), .c(new_n37_), .O(new_n97_));
  ...
  aoi22  g66(.a(new_n94_), .b(new_n100_), .c(new_n49_), .d(x16), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n65_), .c(x08), .d(x07), .O(new_n102_));
  nand2  g68(.a(new_n50_), .b(x14), .O(new_n103_));
  oai21  g69(.a(new_n102_), .b(new_n36_), .c(new_n103_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n37_), .O(new_n105_));
  nand3  g71(.a(new_n50_), .b(x14), .c(new_n36_), .O(new_n106_));
