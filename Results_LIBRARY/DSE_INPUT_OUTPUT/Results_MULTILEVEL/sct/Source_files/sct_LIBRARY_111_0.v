...
module FAU ( 
  ...
  aoi21  g47(.a(new_n75_), .b(x12), .c(new_n66_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n36_), .c(new_n81_), .O(z08));
  inv1   g49(.a(x12), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n73_), .d(new_n72_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n77_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nand3  g54(.a(new_n78_), .b(new_n62_), .c(new_n74_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x13), .c(new_n66_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n36_), .c(new_n88_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n86_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n46_), .c(new_n59_), .d(x08), .O(new_n94_));
