...
module FAU ( 
  ...
  aoi21  g18(.a(new_n53_), .b(x06), .c(new_n44_), .O(z03));
  xor2a  g19(.a(x08), .b(x07), .O(new_n55_));
  nand2  g20(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  ...
  nor2   g27(.a(new_n62_), .b(new_n36_), .O(new_n63_));
  nand4  g28(.a(new_n63_), .b(new_n59_), .c(new_n52_), .d(x04), .O(z05));
  ...
  nand3  g33(.a(new_n68_), .b(new_n65_), .c(new_n52_), .O(new_n69_));
  ...
  nand3  g39(.a(new_n74_), .b(new_n72_), .c(new_n52_), .O(new_n75_));
  nand2  g40(.a(new_n75_), .b(x06), .O(new_n76_));
  nand2  g41(.a(new_n76_), .b(x04), .O(z07));
  nand3  g42(.a(new_n73_), .b(new_n66_), .c(new_n60_), .O(new_n78_));
  oai21  g43(.a(new_n78_), .b(new_n58_), .c(x12), .O(new_n79_));
  nor3   g44(.a(x12), .b(x11), .c(x10), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  nand3  g46(.a(new_n81_), .b(new_n79_), .c(new_n52_), .O(new_n82_));
  nand2  g47(.a(new_n82_), .b(x06), .O(new_n83_));
  nand2  g48(.a(new_n83_), .b(x04), .O(z08));
  nand2  g49(.a(new_n81_), .b(x13), .O(new_n85_));
  inv1   g50(.a(x12), .O(new_n86_));
  inv1   g51(.a(x13), .O(new_n87_));
  nand4  g52(.a(new_n87_), .b(new_n86_), .c(new_n73_), .d(new_n66_), .O(new_n88_));
  inv1   g53(.a(new_n88_), .O(new_n89_));
  aoi21  g54(.a(new_n89_), .b(new_n62_), .c(new_n36_), .O(new_n90_));
  nand4  g55(.a(new_n90_), .b(new_n85_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g56(.a(x00), .O(new_n92_));
  aoi21  g57(.a(new_n88_), .b(new_n92_), .c(new_n51_), .O(new_n93_));
  nand4  g58(.a(new_n93_), .b(new_n60_), .c(x08), .d(x07), .O(new_n94_));
  aoi21  g59(.a(new_n51_), .b(x14), .c(new_n36_), .O(new_n95_));
  aoi21  g60(.a(new_n95_), .b(new_n94_), .c(new_n44_), .O(z10));
