...
module FAU ( 
  ...
  nand3  g29(.a(new_n56_), .b(new_n63_), .c(new_n55_), .O(new_n64_));
  and2   g30(.a(new_n64_), .b(x06), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n48_), .d(x04), .O(z06));
  nand2  g32(.a(new_n64_), .b(x11), .O(new_n67_));
  inv1   g33(.a(x11), .O(new_n68_));
  nand4  g34(.a(new_n56_), .b(new_n68_), .c(new_n63_), .d(new_n55_), .O(new_n69_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n68_), .d(new_n63_), .O(new_n83_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n48_), .c(new_n55_), .d(x08), .O(new_n89_));
