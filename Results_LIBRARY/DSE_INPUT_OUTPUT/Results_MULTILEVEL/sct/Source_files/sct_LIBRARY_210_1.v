...
module FAU ( 
  ...
  oai21  g48(.a(x12), .b(new_n38_), .c(new_n47_), .O(new_n83_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n87_), .c(new_n86_), .d(new_n93_), .O(new_n95_));
  or2    g61(.a(new_n95_), .b(new_n65_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n92_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n95_), .b(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  or2    g68(.a(new_n48_), .b(new_n36_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n38_), .O(z10));
  nand2  g70(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n40_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n38_), .c(new_n39_), .O(z12));
  nand2  g73(.a(new_n47_), .b(new_n38_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n39_), .O(z14));
endmodule
