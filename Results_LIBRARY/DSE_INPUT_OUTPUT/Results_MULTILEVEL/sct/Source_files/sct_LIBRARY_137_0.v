...
module FAU ( 
  ...
  nand2  g05(.a(new_n39_), .b(x06), .O(new_n40_));
  ...
  nand4  g17(.a(new_n51_), .b(x14), .c(new_n47_), .d(x04), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z02));
  nand3  g19(.a(x14), .b(x07), .c(new_n47_), .O(new_n54_));
  ...
  nand3  g24(.a(x14), .b(x08), .c(new_n47_), .O(new_n59_));
  ...
  oai21  g28(.a(new_n39_), .b(x09), .c(new_n47_), .O(new_n63_));
  ...
  nand3  g37(.a(x14), .b(x09), .c(new_n47_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n65_), .O(z05));
  oai21  g39(.a(new_n39_), .b(x10), .c(new_n47_), .O(new_n74_));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n76_), .c(new_n44_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n74_), .d(new_n51_), .O(z06));
  oai21  g47(.a(new_n39_), .b(x11), .c(new_n47_), .O(new_n82_));
  ...
  nand3  g53(.a(x14), .b(x11), .c(new_n47_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n83_), .O(z07));
  oai21  g55(.a(new_n39_), .b(x12), .c(new_n47_), .O(new_n90_));
  ...
  nand3  g63(.a(x14), .b(x12), .c(new_n47_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n91_), .O(z08));
  oai21  g65(.a(new_n39_), .b(x13), .c(new_n47_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n64_), .O(new_n101_));
  ...
  nand3  g72(.a(x14), .b(x13), .c(new_n47_), .O(new_n107_));
  ...
  nand2  g77(.a(new_n48_), .b(x02), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n40_), .c(x16), .O(new_n113_));
  oai21  g79(.a(new_n111_), .b(new_n47_), .c(new_n113_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n37_), .O(z10));
  nor2   g82(.a(new_n36_), .b(new_n35_), .O(z11));
  ...
  nand2  g86(.a(new_n37_), .b(new_n44_), .O(z13));
