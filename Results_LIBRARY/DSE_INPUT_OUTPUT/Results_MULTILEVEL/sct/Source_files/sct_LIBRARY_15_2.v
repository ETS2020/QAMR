...
module FAU ( 
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n52_), .d(x04), .O(z05));
  oai21  g37(.a(new_n51_), .b(new_n45_), .c(new_n37_), .O(new_n72_));
  ...
  nand4  g42(.a(new_n76_), .b(x17), .c(new_n74_), .d(new_n65_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n73_), .c(new_n72_), .O(z06));
  inv1   g44(.a(x17), .O(new_n79_));
  nor2   g45(.a(new_n58_), .b(new_n48_), .O(new_n80_));
  ...
  nand4  g50(.a(new_n81_), .b(new_n76_), .c(x17), .d(new_n84_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(new_n72_), .O(z07));
  nor3   g52(.a(x11), .b(x10), .c(x09), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n80_), .c(new_n79_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n35_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nor2   g56(.a(x11), .b(x10), .O(new_n91_));
  nand3  g57(.a(new_n60_), .b(new_n65_), .c(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n91_), .c(x17), .d(new_n90_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n89_), .c(new_n72_), .O(z08));
  nand3  g61(.a(new_n90_), .b(new_n84_), .c(new_n74_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n66_), .c(x17), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x07), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x13), .O(new_n99_));
  nor2   g65(.a(new_n79_), .b(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n93_), .c(new_n91_), .d(new_n90_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(new_n72_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nor2   g69(.a(x13), .b(x12), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n91_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n103_), .c(new_n51_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n65_), .c(x08), .d(x07), .O(new_n107_));
  nand2  g73(.a(new_n51_), .b(x14), .O(new_n108_));
  ...
  oai21  g79(.a(new_n113_), .b(new_n45_), .c(new_n37_), .O(z12));
  nand2  g80(.a(new_n37_), .b(new_n45_), .O(z13));
  nor2   g81(.a(new_n79_), .b(new_n45_), .O(z14));
endmodule
