...
module FAU ( 
  ...
  nand2  g27(.a(x08), .b(new_n43_), .O(new_n62_));
  oai21  g28(.a(new_n61_), .b(new_n43_), .c(new_n62_), .O(new_n63_));
  ...
  aoi21  g51(.a(new_n79_), .b(x12), .c(new_n57_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n41_), .c(new_n85_), .O(z08));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n77_), .c(new_n76_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n81_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand3  g57(.a(new_n82_), .b(new_n72_), .c(new_n78_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x13), .c(new_n57_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n41_), .c(new_n91_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  aoi21  g61(.a(new_n89_), .b(new_n95_), .c(new_n57_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n68_), .c(x08), .d(x07), .O(new_n97_));
  nand2  g63(.a(new_n57_), .b(x14), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n43_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n53_), .O(z10));
  nor2   g67(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n36_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n41_), .c(new_n53_), .O(z12));
