...
module FAU ( 
  ...
  oai21  g28(.a(new_n51_), .b(new_n44_), .c(new_n48_), .O(new_n63_));
  ...
  oai21  g36(.a(x10), .b(x07), .c(x05), .O(new_n71_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n72_), .c(new_n71_), .d(new_n52_), .O(z06));
  oai21  g42(.a(x11), .b(x07), .c(x05), .O(new_n77_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n78_), .c(new_n77_), .d(new_n52_), .O(z07));
  oai21  g51(.a(x12), .b(x07), .c(x05), .O(new_n86_));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n82_), .c(new_n44_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n86_), .d(new_n52_), .O(z08));
  oai21  g58(.a(x13), .b(x07), .c(x05), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n97_), .b(new_n67_), .c(new_n44_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n94_), .c(new_n93_), .d(new_n52_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n96_), .b(new_n100_), .c(new_n51_), .O(new_n101_));
  ...
  oai21  g74(.a(new_n108_), .b(new_n44_), .c(new_n48_), .O(z12));
