...
module FAU ( 
  ...
  nand2  g22(.a(new_n56_), .b(new_n54_), .O(z03));
  ...
  nand2  g27(.a(new_n61_), .b(new_n54_), .O(z04));
  ...
  nand3  g33(.a(new_n67_), .b(new_n36_), .c(x08), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x09), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n66_), .c(new_n51_), .d(x04), .O(z05));
  ...
  nand4  g42(.a(new_n67_), .b(new_n36_), .c(new_n63_), .d(x08), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(x10), .c(new_n45_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n51_), .O(z06));
  inv1   g45(.a(x10), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand3  g47(.a(new_n36_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n64_), .c(new_n36_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nand2  g50(.a(new_n72_), .b(x06), .O(new_n85_));
  nand3  g51(.a(new_n36_), .b(new_n80_), .c(new_n63_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n85_), .c(x11), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n51_), .d(x04), .O(z07));
  nand3  g54(.a(new_n81_), .b(new_n80_), .c(new_n63_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n85_), .c(x04), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n50_), .c(new_n36_), .O(new_n91_));
  oai21  g57(.a(new_n36_), .b(x06), .c(new_n91_), .O(z08));
  oai21  g58(.a(new_n50_), .b(new_n45_), .c(new_n54_), .O(new_n93_));
  oai21  g59(.a(new_n89_), .b(new_n71_), .c(x13), .O(new_n94_));
  inv1   g60(.a(x13), .O(new_n95_));
  nand3  g61(.a(new_n73_), .b(new_n95_), .c(new_n81_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n85_), .c(new_n94_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n36_), .O(new_n98_));
  nand2  g64(.a(x13), .b(new_n35_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(new_n93_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n48_), .b(x02), .O(new_n102_));
  nand3  g68(.a(new_n95_), .b(new_n81_), .c(new_n80_), .O(new_n103_));
  aoi22  g69(.a(new_n103_), .b(new_n101_), .c(new_n102_), .d(x16), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n63_), .c(x08), .d(x07), .O(new_n105_));
  nand2  g71(.a(new_n50_), .b(x14), .O(new_n106_));
  oai21  g72(.a(new_n105_), .b(new_n35_), .c(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n36_), .O(new_n108_));
  nand3  g74(.a(new_n50_), .b(x14), .c(new_n35_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n45_), .O(z10));
  nor2   g76(.a(new_n37_), .b(new_n38_), .O(z11));
  oai21  g77(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n54_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nor2   g80(.a(new_n37_), .b(new_n45_), .O(z13));
  nand3  g81(.a(new_n54_), .b(x17), .c(x04), .O(new_n116_));
