...
module FAU ( 
  ...
  aoi21  g19(.a(new_n54_), .b(x06), .c(new_n44_), .O(z04));
  ...
  inv1   g39(.a(new_n59_), .O(new_n75_));
  ...
  nand4  g47(.a(new_n82_), .b(new_n81_), .c(new_n69_), .d(new_n64_), .O(new_n83_));
  ...
  nand4  g53(.a(new_n88_), .b(new_n49_), .c(new_n56_), .d(x08), .O(new_n89_));
  nand2  g54(.a(new_n58_), .b(x14), .O(new_n90_));
