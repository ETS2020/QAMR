...
module FAU ( 
  ...
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n46_), .O(new_n71_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n46_), .d(x04), .O(z07));
  nand2  g44(.a(new_n77_), .b(x12), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n69_), .b(new_n75_), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n79_), .c(new_n46_), .d(x04), .O(z08));
  oai21  g49(.a(x13), .b(new_n41_), .c(new_n35_), .O(new_n84_));
  nand3  g50(.a(new_n81_), .b(new_n80_), .c(new_n64_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n67_), .c(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  inv1   g53(.a(new_n62_), .O(new_n88_));
  nand4  g54(.a(new_n76_), .b(new_n88_), .c(new_n87_), .d(new_n81_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n46_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n84_), .O(z09));
  inv1   g58(.a(x07), .O(new_n93_));
  inv1   g59(.a(x00), .O(new_n94_));
  nand3  g60(.a(new_n87_), .b(new_n81_), .c(new_n80_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n65_), .c(new_n94_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n46_), .c(new_n61_), .d(x08), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n93_), .c(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x06), .O(new_n99_));
  inv1   g65(.a(new_n46_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x14), .c(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n99_), .O(z10));
  nor2   g68(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n37_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n41_), .c(new_n49_), .O(z12));
  nand2  g71(.a(x17), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n49_), .O(z14));
  buf    g73(.a(x04), .O(z13));
endmodule
