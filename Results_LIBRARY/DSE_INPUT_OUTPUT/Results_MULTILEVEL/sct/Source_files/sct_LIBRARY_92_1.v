...
module FAU ( 
  ...
  nand3  g20(.a(new_n35_), .b(x08), .c(new_n53_), .O(new_n55_));
  ...
  oai21  g24(.a(x18), .b(x09), .c(new_n53_), .O(new_n59_));
  ...
  nor2   g31(.a(new_n65_), .b(new_n53_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n64_), .c(x08), .O(new_n67_));
  inv1   g33(.a(new_n67_), .O(new_n68_));
  nor2   g34(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n62_), .c(new_n59_), .d(new_n46_), .O(z05));
  oai21  g36(.a(x18), .b(x10), .c(new_n53_), .O(new_n71_));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n66_), .c(new_n63_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n71_), .d(new_n46_), .O(z06));
  oai21  g44(.a(x18), .b(x11), .c(new_n53_), .O(new_n79_));
  nand3  g45(.a(new_n60_), .b(new_n74_), .c(new_n64_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x11), .O(new_n81_));
  nand2  g47(.a(new_n60_), .b(x06), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  nor3   g49(.a(x11), .b(x10), .c(x09), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n83_), .c(new_n63_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n79_), .d(new_n46_), .O(z07));
  oai21  g52(.a(x18), .b(x12), .c(new_n53_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n47_), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  aoi21  g55(.a(new_n84_), .b(new_n60_), .c(new_n89_), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  nand3  g57(.a(new_n89_), .b(new_n91_), .c(new_n74_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n72_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(x06), .O(new_n94_));
  nand3  g60(.a(new_n35_), .b(x12), .c(new_n53_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n88_), .O(z08));
  oai21  g62(.a(x18), .b(x13), .c(new_n53_), .O(new_n97_));
  oai21  g63(.a(new_n92_), .b(new_n72_), .c(x13), .O(new_n98_));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n89_), .c(new_n91_), .d(new_n74_), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n68_), .c(new_n63_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n98_), .c(new_n97_), .d(new_n46_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand2  g70(.a(new_n100_), .b(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n46_), .c(new_n64_), .d(x08), .O(new_n106_));
  nand3  g72(.a(new_n45_), .b(x16), .c(x14), .O(new_n107_));
  oai21  g73(.a(new_n106_), .b(new_n65_), .c(new_n107_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x06), .O(new_n109_));
  nand4  g75(.a(new_n45_), .b(new_n35_), .c(x16), .d(x14), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n63_), .O(z10));
  nor2   g77(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g78(.a(x16), .b(new_n37_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n63_), .c(new_n49_), .O(z12));
  nor2   g80(.a(new_n36_), .b(new_n63_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n36_), .b(new_n116_), .c(new_n63_), .O(z14));
endmodule
