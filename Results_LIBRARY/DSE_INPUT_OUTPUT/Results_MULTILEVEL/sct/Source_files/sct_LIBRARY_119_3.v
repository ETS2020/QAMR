...
module FAU ( 
  ...
  oai21  g29(.a(new_n63_), .b(new_n45_), .c(new_n48_), .O(new_n64_));
  inv1   g30(.a(x07), .O(new_n65_));
  nor2   g31(.a(new_n57_), .b(new_n65_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(x13), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x09), .O(new_n68_));
  inv1   g34(.a(x09), .O(new_n69_));
  nor2   g35(.a(new_n65_), .b(new_n35_), .O(new_n70_));
  ...
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n64_), .O(z07));
  ...
  nand3  g65(.a(new_n93_), .b(new_n80_), .c(new_n99_), .O(new_n100_));
  aoi22  g66(.a(new_n100_), .b(new_n98_), .c(new_n50_), .d(x16), .O(new_n101_));
  ...
  nand2  g78(.a(new_n112_), .b(new_n48_), .O(z14));
endmodule
