...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n45_), .c(x06), .d(x04), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z03));
  nand3  g17(.a(x08), .b(new_n45_), .c(x06), .O(new_n52_));
  oai21  g18(.a(x08), .b(new_n45_), .c(new_n52_), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(x06), .c(new_n36_), .O(z04));
  inv1   g21(.a(x09), .O(new_n56_));
  aoi21  g22(.a(x08), .b(x07), .c(new_n56_), .O(new_n57_));
  nand3  g23(.a(new_n56_), .b(x08), .c(x07), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(new_n49_), .O(new_n59_));
  oai21  g25(.a(new_n59_), .b(new_n57_), .c(x06), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z05));
  nand2  g27(.a(new_n58_), .b(x10), .O(new_n62_));
  inv1   g28(.a(x10), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n56_), .c(x08), .d(x07), .O(new_n64_));
  and2   g30(.a(new_n64_), .b(x06), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n49_), .d(x04), .O(z06));
  nand2  g32(.a(new_n64_), .b(x11), .O(new_n67_));
  nor2   g33(.a(x11), .b(x10), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n56_), .c(x08), .d(x07), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n49_), .O(new_n70_));
  ...
  nand3  g42(.a(new_n76_), .b(new_n73_), .c(new_n49_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x06), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x04), .O(z08));
  nand2  g45(.a(new_n75_), .b(new_n63_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n58_), .c(x13), .O(new_n81_));
  nor2   g47(.a(x13), .b(x12), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n68_), .c(new_n74_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n49_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n82_), .b(new_n68_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n87_), .c(new_n48_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n56_), .c(x08), .d(x07), .O(new_n90_));
  inv1   g56(.a(x06), .O(new_n91_));
  aoi21  g57(.a(new_n48_), .b(x14), .c(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n90_), .c(new_n36_), .O(z10));
  nor2   g59(.a(z02), .b(new_n35_), .O(z11));
  oai21  g60(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n95_));
