...
module FAU ( 
  ...
  nor2   g06(.a(new_n35_), .b(x15), .O(new_n41_));
  oai21  g07(.a(new_n41_), .b(x05), .c(x04), .O(z01));
  ...
  nand2  g41(.a(new_n35_), .b(new_n75_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n74_), .O(z07));
  nand2  g43(.a(new_n72_), .b(x12), .O(new_n78_));
  inv1   g44(.a(x12), .O(new_n79_));
  nand4  g45(.a(new_n65_), .b(new_n71_), .c(new_n79_), .d(new_n70_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n47_), .d(x04), .O(z08));
  nand2  g47(.a(new_n80_), .b(x13), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n70_), .d(new_n69_), .O(new_n84_));
  or2    g50(.a(new_n84_), .b(new_n62_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n82_), .c(new_n47_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n76_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  aoi21  g55(.a(new_n84_), .b(new_n89_), .c(new_n46_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n61_), .c(x08), .d(x07), .O(new_n91_));
  nand2  g57(.a(new_n46_), .b(x14), .O(new_n92_));
  oai21  g58(.a(new_n91_), .b(new_n43_), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n50_), .O(z10));
  nor2   g61(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n37_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n75_), .c(new_n50_), .O(z12));
  nand2  g64(.a(x17), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n50_), .O(z14));
  buf    g66(.a(x04), .O(z13));
endmodule
