...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n113_, new_n114_, new_n117_, new_n119_;
  ...
  oai21  g24(.a(x09), .b(new_n43_), .c(new_n35_), .O(new_n59_));
  ...
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n62_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n80_), .c(new_n48_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n77_), .O(z07));
  oai21  g53(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n88_));
  nand3  g54(.a(new_n83_), .b(new_n78_), .c(new_n62_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x12), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  nand4  g58(.a(new_n82_), .b(new_n72_), .c(new_n92_), .d(new_n91_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n90_), .c(new_n48_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n88_), .O(z08));
  oai21  g62(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n97_));
  nand3  g63(.a(new_n92_), .b(new_n91_), .c(new_n67_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n70_), .c(x13), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  inv1   g66(.a(new_n63_), .O(new_n101_));
  nand4  g67(.a(new_n83_), .b(new_n101_), .c(new_n100_), .d(new_n92_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n99_), .c(new_n48_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n97_), .O(z09));
  inv1   g71(.a(x07), .O(new_n106_));
  inv1   g72(.a(x00), .O(new_n107_));
  nand3  g73(.a(new_n100_), .b(new_n92_), .c(new_n91_), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n68_), .c(new_n107_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n106_), .c(x04), .O(new_n111_));
  ...
  aoi21  g82(.a(x16), .b(new_n37_), .c(x03), .O(new_n117_));
  nor2   g83(.a(new_n117_), .b(new_n43_), .O(z12));
  nand2  g84(.a(x17), .b(x04), .O(new_n119_));
  oai21  g85(.a(new_n35_), .b(x04), .c(new_n119_), .O(z14));
  buf    g86(.a(x04), .O(z13));
endmodule
