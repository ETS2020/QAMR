...
module FAU ( 
  ...
  oai21  g52(.a(new_n51_), .b(new_n44_), .c(new_n47_), .O(new_n87_));
  nand3  g53(.a(new_n83_), .b(x13), .c(x05), .O(new_n88_));
  nand4  g54(.a(new_n35_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n89_));
