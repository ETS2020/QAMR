...
module FAU ( 
  ...
  nand3  g19(.a(new_n37_), .b(new_n53_), .c(x06), .O(new_n54_));
  ...
  inv1   g23(.a(new_n38_), .O(new_n58_));
  inv1   g24(.a(x08), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x07), .O(new_n60_));
  nand3  g26(.a(new_n37_), .b(x08), .c(new_n53_), .O(new_n61_));
  ...
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n58_), .O(z04));
  ...
  nor2   g35(.a(new_n53_), .b(new_n36_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n37_), .c(x08), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x09), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n69_), .c(new_n50_), .d(x04), .O(z05));
  ...
  nand4  g43(.a(new_n70_), .b(new_n37_), .c(new_n66_), .d(x08), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x10), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n50_), .d(x04), .O(z06));
  oai21  g46(.a(new_n49_), .b(new_n44_), .c(new_n58_), .O(new_n81_));
  ...
  nand4  g51(.a(new_n85_), .b(new_n74_), .c(new_n37_), .d(new_n83_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n81_), .O(z07));
  inv1   g53(.a(x10), .O(new_n88_));
  nor2   g54(.a(x12), .b(x11), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n67_), .c(new_n37_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x06), .O(new_n92_));
  aoi21  g58(.a(new_n86_), .b(x12), .c(new_n44_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n50_), .O(z08));
  nand3  g60(.a(new_n89_), .b(new_n85_), .c(new_n74_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n50_), .c(x04), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n37_), .O(new_n97_));
  oai21  g63(.a(new_n37_), .b(x06), .c(new_n97_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  inv1   g65(.a(x12), .O(new_n100_));
  nand4  g66(.a(new_n37_), .b(new_n100_), .c(new_n83_), .d(new_n88_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n49_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n66_), .c(x08), .d(x07), .O(new_n103_));
  nand2  g69(.a(new_n49_), .b(x14), .O(new_n104_));
  oai21  g70(.a(new_n103_), .b(new_n36_), .c(new_n104_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n58_), .O(z10));
  nand2  g73(.a(new_n58_), .b(new_n35_), .O(z11));
  oai21  g74(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n58_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nor2   g77(.a(new_n38_), .b(new_n44_), .O(z13));
  nand3  g78(.a(new_n58_), .b(x17), .c(x04), .O(new_n113_));
