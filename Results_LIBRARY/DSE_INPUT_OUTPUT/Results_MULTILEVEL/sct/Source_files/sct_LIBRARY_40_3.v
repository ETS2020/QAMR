...
module FAU ( 
  ...
  oai21  g27(.a(new_n48_), .b(new_n43_), .c(new_n52_), .O(new_n62_));
  inv1   g28(.a(x07), .O(new_n63_));
  nor2   g29(.a(new_n56_), .b(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(x11), .c(x06), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x09), .O(new_n66_));
  nor2   g32(.a(x11), .b(x09), .O(new_n67_));
  ...
  nand2  g37(.a(new_n71_), .b(new_n37_), .O(new_n72_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n37_), .c(new_n75_), .d(new_n70_), .O(new_n78_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n49_), .c(new_n37_), .d(x04), .O(z07));
  nor3   g48(.a(x12), .b(x10), .c(x09), .O(new_n83_));
  and2   g49(.a(new_n83_), .b(new_n64_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(x11), .c(x06), .O(new_n85_));
  nand2  g51(.a(new_n78_), .b(x12), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n49_), .d(x04), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand3  g55(.a(new_n80_), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  oai22  g56(.a(new_n90_), .b(new_n76_), .c(new_n84_), .d(new_n88_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n37_), .O(new_n92_));
  nand2  g58(.a(x13), .b(new_n36_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n62_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n46_), .b(x02), .O(new_n96_));
  nand3  g62(.a(new_n88_), .b(new_n89_), .c(new_n75_), .O(new_n97_));
  aoi22  g63(.a(new_n97_), .b(new_n95_), .c(new_n96_), .d(x16), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n70_), .c(x08), .d(x07), .O(new_n99_));
  nand2  g65(.a(new_n48_), .b(x14), .O(new_n100_));
  oai21  g66(.a(new_n99_), .b(new_n36_), .c(new_n100_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n37_), .O(new_n102_));
  nand3  g68(.a(new_n48_), .b(x14), .c(new_n36_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z10));
  nor2   g70(.a(new_n38_), .b(new_n35_), .O(z11));
  oai21  g71(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n52_), .c(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z12));
  nand2  g74(.a(new_n52_), .b(new_n43_), .O(z13));
  nand3  g75(.a(new_n52_), .b(x17), .c(x04), .O(new_n110_));
