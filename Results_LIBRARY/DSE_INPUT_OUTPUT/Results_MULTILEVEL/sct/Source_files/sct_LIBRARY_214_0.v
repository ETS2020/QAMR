...
module FAU ( 
  ...
  nand2  g22(.a(new_n56_), .b(new_n38_), .O(z04));
  ...
  oai21  g30(.a(new_n64_), .b(new_n36_), .c(new_n61_), .O(z05));
  ...
  nand4  g35(.a(new_n58_), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(x10), .c(new_n62_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n36_), .c(new_n69_), .O(z06));
  nand2  g38(.a(x07), .b(x06), .O(new_n73_));
  nand2  g39(.a(new_n66_), .b(x08), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n73_), .c(x11), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  inv1   g43(.a(new_n63_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n58_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n47_), .d(x04), .O(z07));
  nand2  g46(.a(new_n79_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n66_), .b(new_n78_), .c(new_n82_), .d(new_n77_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n47_), .d(x04), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n59_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x07), .O(new_n88_));
  aoi21  g54(.a(new_n83_), .b(x13), .c(new_n62_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n36_), .c(new_n88_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand2  g57(.a(new_n86_), .b(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n47_), .c(new_n58_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(x07), .c(x06), .O(new_n95_));
  nand2  g61(.a(new_n62_), .b(x14), .O(new_n96_));
  ...
  nand2  g66(.a(x07), .b(new_n36_), .O(z13));
