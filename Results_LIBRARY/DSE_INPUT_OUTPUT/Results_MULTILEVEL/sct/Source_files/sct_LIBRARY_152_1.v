...
module FAU ( 
  ...
  nand3  g17(.a(new_n35_), .b(x07), .c(new_n51_), .O(new_n52_));
  ...
  oai21  g24(.a(new_n57_), .b(new_n51_), .c(new_n58_), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(new_n48_), .c(x04), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n56_), .O(z04));
  oai21  g27(.a(x17), .b(x09), .c(new_n51_), .O(new_n62_));
  ...
  oai21  g35(.a(x17), .b(x10), .c(new_n51_), .O(new_n70_));
  ...
  nand3  g44(.a(new_n35_), .b(x10), .c(new_n51_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z06));
  oai21  g46(.a(x17), .b(x11), .c(new_n51_), .O(new_n81_));
  ...
  nand3  g51(.a(new_n35_), .b(x11), .c(new_n51_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z07));
  oai21  g53(.a(x17), .b(x12), .c(new_n51_), .O(new_n88_));
  ...
  aoi21  g67(.a(new_n101_), .b(new_n67_), .c(new_n43_), .O(new_n102_));
  ...
  nand4  g76(.a(new_n47_), .b(new_n35_), .c(x16), .d(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n43_), .O(z10));
  nor2   g78(.a(new_n36_), .b(new_n37_), .O(z11));
  inv1   g79(.a(x16), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(x02), .c(new_n46_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n56_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  oai21  g83(.a(new_n35_), .b(x06), .c(new_n43_), .O(z13));
  nand3  g84(.a(x17), .b(x06), .c(x04), .O(new_n119_));
