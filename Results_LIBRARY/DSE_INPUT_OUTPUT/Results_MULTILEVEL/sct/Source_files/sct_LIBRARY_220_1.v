...
module FAU ( 
  ...
  nand4  g21(.a(new_n55_), .b(new_n47_), .c(new_n46_), .d(x04), .O(new_n56_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n47_), .c(new_n36_), .d(x04), .O(z07));
  inv1   g40(.a(x12), .O(new_n75_));
  nand4  g41(.a(new_n69_), .b(new_n75_), .c(new_n68_), .d(new_n60_), .O(new_n76_));
  oai21  g42(.a(new_n62_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n36_), .O(new_n78_));
  nand2  g44(.a(x12), .b(x10), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n66_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n75_), .c(new_n60_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n58_), .c(new_n36_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  nand3  g50(.a(new_n72_), .b(new_n75_), .c(new_n36_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n58_), .c(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n47_), .d(x04), .O(z09));
  ...
  nand2  g58(.a(new_n65_), .b(x14), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n88_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n46_), .O(new_n95_));
  nand4  g61(.a(new_n47_), .b(new_n81_), .c(new_n75_), .d(new_n36_), .O(new_n96_));
  nor3   g62(.a(new_n96_), .b(x10), .c(x09), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(x08), .c(x07), .d(x06), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n95_), .c(new_n42_), .O(z10));
  nor2   g65(.a(new_n37_), .b(new_n35_), .O(z11));
  inv1   g66(.a(x16), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(x02), .c(new_n89_), .O(new_n102_));
