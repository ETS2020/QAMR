...
module FAU ( 
  ...
  nor2   g35(.a(new_n69_), .b(new_n36_), .O(new_n70_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n53_), .c(new_n36_), .O(z06));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n53_), .c(new_n36_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n72_), .b(new_n79_), .c(new_n84_), .d(new_n78_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n37_), .c(x04), .O(new_n86_));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n69_), .c(new_n36_), .O(new_n93_));
  ...
  aoi21  g68(.a(x16), .b(new_n39_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n46_), .c(new_n37_), .O(z12));
  nor2   g70(.a(new_n36_), .b(new_n46_), .O(z13));
  oai21  g71(.a(new_n43_), .b(new_n46_), .c(new_n37_), .O(z14));
endmodule
