...
module FAU ( 
  ...
  aoi21  g15(.a(new_n49_), .b(x13), .c(x06), .O(z02));
  ...
  nand3  g22(.a(x13), .b(x08), .c(new_n55_), .O(new_n57_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n64_), .c(new_n62_), .d(new_n48_), .O(z05));
  oai21  g35(.a(new_n61_), .b(x10), .c(new_n55_), .O(new_n70_));
  ...
  nand3  g44(.a(x13), .b(x10), .c(new_n55_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z06));
  oai21  g46(.a(new_n61_), .b(x11), .c(new_n55_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n49_), .O(new_n82_));
  inv1   g48(.a(x11), .O(new_n83_));
  aoi21  g49(.a(new_n75_), .b(new_n74_), .c(new_n83_), .O(new_n84_));
  nor3   g50(.a(x11), .b(x10), .c(x09), .O(new_n85_));
  and2   g51(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n84_), .c(x06), .O(new_n87_));
  nand3  g53(.a(x13), .b(x11), .c(new_n55_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n82_), .O(z07));
  oai21  g55(.a(new_n61_), .b(x12), .c(new_n55_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n49_), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  aoi21  g58(.a(new_n85_), .b(new_n74_), .c(new_n92_), .O(new_n93_));
  inv1   g59(.a(x10), .O(new_n94_));
  nand3  g60(.a(new_n92_), .b(new_n83_), .c(new_n94_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(new_n72_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n93_), .c(x06), .O(new_n97_));
  nand3  g63(.a(x13), .b(x12), .c(new_n55_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n91_), .O(z08));
  nand2  g65(.a(new_n49_), .b(new_n51_), .O(new_n100_));
  nand2  g66(.a(new_n74_), .b(x06), .O(new_n101_));
  nand3  g67(.a(new_n75_), .b(new_n92_), .c(new_n83_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n101_), .c(x13), .O(new_n103_));
  nand4  g69(.a(new_n61_), .b(new_n92_), .c(new_n83_), .d(new_n94_), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n67_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n103_), .c(new_n100_), .O(z09));
  inv1   g73(.a(x07), .O(new_n108_));
  nand2  g74(.a(x06), .b(x00), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n104_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n48_), .c(new_n65_), .d(x08), .O(new_n111_));
  nand3  g77(.a(new_n47_), .b(x16), .c(x14), .O(new_n112_));
  oai21  g78(.a(new_n111_), .b(new_n108_), .c(new_n112_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n51_), .O(z10));
  nand2  g81(.a(new_n51_), .b(new_n36_), .O(z11));
  aoi21  g82(.a(x16), .b(new_n36_), .c(x03), .O(new_n117_));
  oai21  g83(.a(new_n117_), .b(new_n43_), .c(new_n51_), .O(z12));
  nand2  g84(.a(new_n51_), .b(new_n43_), .O(z13));
  inv1   g85(.a(x17), .O(new_n120_));
  nor3   g86(.a(new_n35_), .b(new_n120_), .c(new_n43_), .O(z14));
endmodule
