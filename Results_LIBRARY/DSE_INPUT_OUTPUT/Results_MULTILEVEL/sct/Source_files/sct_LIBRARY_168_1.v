...
module FAU ( 
  ...
  oai21  g32(.a(x11), .b(new_n40_), .c(new_n36_), .O(new_n67_));
  ...
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n60_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n69_), .c(new_n46_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x04), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n67_), .O(z07));
  oai21  g41(.a(x12), .b(new_n40_), .c(new_n36_), .O(new_n76_));
  nand2  g42(.a(x08), .b(x07), .O(new_n77_));
  nand2  g43(.a(new_n71_), .b(new_n60_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n64_), .b(new_n70_), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  ...
  oai21  g67(.a(new_n101_), .b(new_n40_), .c(new_n45_), .O(z12));
