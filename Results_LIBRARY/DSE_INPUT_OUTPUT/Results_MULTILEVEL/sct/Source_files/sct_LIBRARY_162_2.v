...
module FAU ( 
  ...
  nand4  g17(.a(new_n52_), .b(new_n49_), .c(x06), .d(x04), .O(new_n53_));
  ...
  nand3  g40(.a(new_n75_), .b(new_n69_), .c(new_n63_), .O(new_n76_));
  nor2   g41(.a(new_n76_), .b(new_n58_), .O(new_n77_));
  nor2   g42(.a(new_n77_), .b(new_n36_), .O(new_n78_));
  nand4  g43(.a(new_n78_), .b(new_n74_), .c(new_n49_), .d(x04), .O(z08));
  oai21  g44(.a(new_n76_), .b(new_n58_), .c(x13), .O(new_n80_));
  inv1   g45(.a(x13), .O(new_n81_));
  nand4  g46(.a(new_n81_), .b(new_n75_), .c(new_n69_), .d(new_n63_), .O(new_n82_));
  or2    g47(.a(new_n82_), .b(new_n58_), .O(new_n83_));
  nand3  g48(.a(new_n83_), .b(new_n80_), .c(new_n49_), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(x06), .O(new_n85_));
  nand2  g50(.a(new_n85_), .b(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n87_));
  nand2  g52(.a(new_n82_), .b(new_n87_), .O(new_n88_));
  ...
  aoi21  g58(.a(new_n36_), .b(x04), .c(new_n38_), .O(z11));
  ...
  nor2   g64(.a(new_n36_), .b(new_n44_), .O(z13));
