...
module FAU ( 
  ...
  oai21  g27(.a(x09), .b(new_n45_), .c(new_n35_), .O(new_n62_));
  ...
  oai21  g35(.a(x10), .b(new_n45_), .c(new_n35_), .O(new_n70_));
  ...
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n65_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n51_), .d(x04), .O(z07));
  oai21  g49(.a(x12), .b(new_n45_), .c(new_n35_), .O(new_n84_));
  nand2  g50(.a(new_n81_), .b(new_n65_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n63_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x11), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n80_), .b(new_n73_), .c(new_n88_), .d(new_n87_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n51_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n84_), .O(z08));
  ...
  or2    g62(.a(new_n96_), .b(new_n66_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n93_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n96_), .b(new_n99_), .O(new_n100_));
  ...
  nor2   g73(.a(new_n107_), .b(new_n45_), .O(z12));
