...
module FAU ( 
  ...
  nand3  g15(.a(x11), .b(x07), .c(new_n46_), .O(new_n50_));
  ...
  oai21  g28(.a(new_n60_), .b(new_n43_), .c(new_n62_), .O(new_n63_));
  ...
  nand3  g34(.a(x11), .b(x09), .c(new_n46_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n68_), .c(new_n63_), .O(z05));
  oai21  g36(.a(new_n61_), .b(x10), .c(new_n46_), .O(new_n71_));
  ...
  oai21  g42(.a(new_n60_), .b(new_n43_), .c(new_n54_), .O(new_n77_));
  nand2  g43(.a(new_n74_), .b(x11), .O(new_n78_));
  inv1   g44(.a(x10), .O(new_n79_));
  nand3  g45(.a(new_n61_), .b(new_n79_), .c(new_n64_), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n65_), .c(x06), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(new_n77_), .O(z07));
  oai21  g49(.a(x12), .b(new_n61_), .c(new_n46_), .O(new_n84_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n84_), .d(new_n47_), .O(z08));
  oai21  g56(.a(x13), .b(new_n61_), .c(new_n46_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n61_), .d(new_n79_), .O(new_n96_));
