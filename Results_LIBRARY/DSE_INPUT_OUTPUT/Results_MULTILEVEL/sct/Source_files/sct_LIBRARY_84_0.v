...
module FAU ( 
  ...
  oai21  g47(.a(new_n81_), .b(new_n61_), .c(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  aoi21  g49(.a(new_n78_), .b(x12), .c(new_n64_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n40_), .c(new_n83_), .O(z08));
  inv1   g51(.a(x12), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n76_), .d(new_n75_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n61_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  nand3  g56(.a(new_n80_), .b(new_n71_), .c(new_n77_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n46_), .c(new_n60_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  nand2  g64(.a(new_n64_), .b(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n40_), .O(z10));
  nand2  g66(.a(new_n49_), .b(new_n36_), .O(z11));
