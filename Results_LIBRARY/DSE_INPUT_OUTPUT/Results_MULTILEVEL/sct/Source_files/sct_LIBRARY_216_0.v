...
module FAU ( 
  ...
  nor2   g00(.a(x18), .b(x15), .O(new_n35_));
  ...
  nand4  g24(.a(new_n58_), .b(new_n50_), .c(new_n36_), .d(x04), .O(new_n59_));
  ...
  aoi21  g32(.a(new_n66_), .b(new_n50_), .c(new_n35_), .O(z05));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n50_), .c(new_n35_), .O(z06));
  ...
  and2   g43(.a(new_n77_), .b(new_n36_), .O(new_n78_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n50_), .c(new_n35_), .O(z08));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n50_), .c(new_n35_), .O(z09));
  ...
  nand3  g60(.a(new_n94_), .b(new_n36_), .c(x04), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(z10));
  nor2   g62(.a(new_n35_), .b(new_n38_), .O(z11));
  oai21  g63(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n36_), .c(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z12));
  nor2   g66(.a(new_n35_), .b(new_n43_), .O(z13));
  inv1   g67(.a(x17), .O(new_n102_));
  nor3   g68(.a(new_n35_), .b(new_n102_), .c(new_n43_), .O(z14));
endmodule
