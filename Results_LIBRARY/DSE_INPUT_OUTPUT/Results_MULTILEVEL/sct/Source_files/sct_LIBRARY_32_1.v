...
module FAU ( 
  ...
  oai21  g28(.a(x11), .b(x09), .c(new_n57_), .O(new_n63_));
  ...
  nand3  g35(.a(new_n35_), .b(x09), .c(new_n57_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z05));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(x06), .c(new_n51_), .O(new_n73_));
  ...
  oai21  g43(.a(new_n75_), .b(new_n74_), .c(new_n77_), .O(new_n78_));
  ...
  nand2  g47(.a(x07), .b(x06), .O(new_n82_));
  nand2  g48(.a(new_n76_), .b(x08), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n82_), .c(x11), .O(new_n84_));
  nand4  g50(.a(new_n72_), .b(new_n66_), .c(new_n65_), .d(x06), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n50_), .d(x04), .O(z07));
  oai21  g52(.a(x12), .b(x11), .c(new_n57_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n51_), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand2  g55(.a(new_n66_), .b(x06), .O(new_n90_));
  nand3  g56(.a(new_n89_), .b(new_n74_), .c(new_n65_), .O(new_n91_));
  oai22  g57(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(x06), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n35_), .O(new_n93_));
  nand3  g59(.a(new_n72_), .b(new_n66_), .c(new_n65_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(x12), .c(x06), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n93_), .c(new_n88_), .O(z08));
  oai21  g62(.a(x13), .b(x11), .c(new_n57_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n51_), .O(new_n98_));
  inv1   g64(.a(x13), .O(new_n99_));
  nand3  g65(.a(new_n76_), .b(new_n99_), .c(new_n89_), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n90_), .c(new_n99_), .d(x06), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n35_), .O(new_n102_));
  nand4  g68(.a(new_n75_), .b(new_n89_), .c(new_n35_), .d(new_n74_), .O(new_n103_));
  ...
  nand3  g72(.a(new_n72_), .b(new_n99_), .c(new_n89_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n106_), .c(new_n49_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n65_), .c(x08), .d(x07), .O(new_n109_));
  nand2  g75(.a(new_n49_), .b(x14), .O(new_n110_));
  oai21  g76(.a(new_n109_), .b(new_n57_), .c(new_n110_), .O(new_n111_));
  ...
  oai21  g81(.a(new_n115_), .b(new_n44_), .c(new_n53_), .O(z12));
  nand2  g82(.a(new_n53_), .b(new_n44_), .O(z13));
