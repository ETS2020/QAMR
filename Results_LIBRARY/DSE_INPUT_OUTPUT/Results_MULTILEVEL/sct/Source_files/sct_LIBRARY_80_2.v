...
module FAU ( 
  ...
  nand3  g17(.a(x13), .b(new_n51_), .c(x06), .O(new_n52_));
  ...
  nand3  g24(.a(x13), .b(x08), .c(new_n51_), .O(new_n59_));
  ...
  oai21  g28(.a(new_n62_), .b(new_n43_), .c(new_n56_), .O(z04));
  inv1   g29(.a(new_n48_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n43_), .c(new_n56_), .O(new_n65_));
  inv1   g31(.a(x13), .O(new_n66_));
  nor2   g32(.a(new_n57_), .b(new_n51_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(new_n66_), .c(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x09), .O(new_n69_));
  inv1   g35(.a(x09), .O(new_n70_));
  nor2   g36(.a(new_n51_), .b(new_n35_), .O(new_n71_));
  ...
  aoi21  g43(.a(new_n72_), .b(x10), .c(new_n43_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n48_), .O(z06));
  inv1   g45(.a(new_n67_), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n74_), .c(new_n70_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n80_), .c(x13), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nand2  g50(.a(new_n67_), .b(x06), .O(new_n85_));
  nand3  g51(.a(x13), .b(new_n74_), .c(new_n70_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n85_), .c(x11), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n48_), .d(x04), .O(z07));
  nand2  g54(.a(new_n84_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(x13), .b(new_n90_), .c(new_n81_), .d(new_n74_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n71_), .c(new_n70_), .d(x08), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n89_), .c(new_n65_), .O(z08));
  nand3  g60(.a(new_n70_), .b(x08), .c(x07), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n91_), .c(x06), .O(new_n96_));
  aoi21  g62(.a(x13), .b(new_n35_), .c(new_n43_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n48_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  aoi21  g65(.a(new_n47_), .b(x16), .c(x09), .O(new_n100_));
  ...
  nand3  g70(.a(new_n64_), .b(x14), .c(new_n35_), .O(new_n105_));
  ...
  oai21  g74(.a(new_n108_), .b(new_n43_), .c(new_n56_), .O(z12));
  nand2  g75(.a(new_n56_), .b(new_n43_), .O(z13));
  inv1   g76(.a(x17), .O(new_n111_));
  nor3   g77(.a(new_n36_), .b(new_n111_), .c(new_n43_), .O(z14));
endmodule
