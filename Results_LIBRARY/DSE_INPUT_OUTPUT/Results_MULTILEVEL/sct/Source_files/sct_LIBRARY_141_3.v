...
module FAU ( 
  ...
  aoi21  g28(.a(new_n46_), .b(x02), .c(new_n48_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(x12), .c(new_n51_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z08));
  oai21  g31(.a(new_n63_), .b(x13), .c(new_n51_), .O(new_n66_));
  ...
  aoi21  g36(.a(x16), .b(new_n35_), .c(x06), .O(new_n71_));
