...
module FAU ( 
  ...
  nand4  g31(.a(new_n65_), .b(new_n63_), .c(new_n52_), .d(x04), .O(z05));
  nor2   g32(.a(x10), .b(x09), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n61_), .c(new_n36_), .O(new_n68_));
  inv1   g34(.a(new_n52_), .O(new_n69_));
  aoi21  g35(.a(new_n65_), .b(x10), .c(new_n69_), .O(new_n70_));
  oai22  g36(.a(new_n70_), .b(new_n36_), .c(new_n68_), .d(new_n37_), .O(z06));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(x11), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n64_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n60_), .c(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  nand4  g42(.a(new_n67_), .b(x08), .c(x07), .d(x06), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(x11), .c(new_n69_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n36_), .c(new_n76_), .O(z07));
  oai21  g45(.a(new_n74_), .b(new_n62_), .c(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  inv1   g47(.a(new_n62_), .O(new_n82_));
  nand4  g48(.a(new_n67_), .b(new_n82_), .c(new_n81_), .d(new_n73_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n52_), .d(x04), .O(z08));
  ...
  or2    g53(.a(new_n87_), .b(new_n65_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n87_), .b(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n52_), .c(new_n64_), .d(x08), .O(new_n92_));
  ...
  nand2  g63(.a(x16), .b(new_n39_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n46_), .c(new_n36_), .O(z12));
