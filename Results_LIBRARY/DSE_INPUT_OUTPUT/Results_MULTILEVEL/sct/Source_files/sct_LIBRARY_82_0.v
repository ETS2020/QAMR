...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n115_;
  nor2   g00(.a(x17), .b(x06), .O(new_n35_));
  ...
  nand4  g16(.a(new_n50_), .b(x17), .c(new_n46_), .d(x04), .O(new_n51_));
  ...
  oai21  g28(.a(new_n62_), .b(x09), .c(new_n46_), .O(new_n63_));
  ...
  aoi21  g34(.a(new_n68_), .b(new_n66_), .c(new_n43_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n65_), .c(new_n63_), .d(new_n50_), .O(z05));
  oai21  g36(.a(new_n62_), .b(x10), .c(new_n46_), .O(new_n71_));
  nand2  g37(.a(new_n68_), .b(x07), .O(new_n72_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n71_), .d(new_n50_), .O(z06));
  oai21  g44(.a(new_n62_), .b(x11), .c(new_n46_), .O(new_n79_));
  oai21  g45(.a(new_n49_), .b(new_n43_), .c(new_n79_), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(new_n64_), .O(new_n82_));
  ...
  nand3  g51(.a(x17), .b(x11), .c(new_n46_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n80_), .O(z07));
  oai21  g53(.a(new_n62_), .b(x12), .c(new_n46_), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  or2    g55(.a(new_n84_), .b(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n74_), .b(new_n89_), .c(new_n81_), .O(new_n91_));
  nor3   g57(.a(new_n91_), .b(new_n64_), .c(new_n46_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n43_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n88_), .d(new_n50_), .O(z08));
  oai21  g60(.a(new_n62_), .b(x13), .c(new_n46_), .O(new_n95_));
  oai21  g61(.a(new_n49_), .b(new_n43_), .c(new_n95_), .O(new_n96_));
  inv1   g62(.a(x10), .O(new_n97_));
  nand3  g63(.a(new_n89_), .b(new_n81_), .c(new_n97_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n72_), .c(x13), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n89_), .c(new_n81_), .d(new_n97_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n72_), .c(new_n99_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x06), .O(new_n103_));
  nand3  g69(.a(x17), .b(x13), .c(new_n46_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n96_), .O(z09));
  inv1   g71(.a(x09), .O(new_n106_));
  inv1   g72(.a(x00), .O(new_n107_));
  aoi21  g73(.a(new_n101_), .b(new_n107_), .c(new_n49_), .O(new_n108_));
  ...
  nand2  g78(.a(new_n112_), .b(new_n53_), .O(z10));
  nor2   g79(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n36_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n43_), .c(new_n53_), .O(z12));
  nand2  g82(.a(new_n53_), .b(new_n43_), .O(z13));
  nor2   g83(.a(new_n62_), .b(new_n43_), .O(z14));
endmodule
