...
module FAU ( 
  ...
  nand3  g18(.a(x11), .b(new_n52_), .c(x06), .O(new_n53_));
  ...
  nand3  g24(.a(x11), .b(x08), .c(new_n52_), .O(new_n59_));
  ...
  nand2  g31(.a(new_n65_), .b(x11), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x06), .O(new_n67_));
  nand4  g33(.a(x11), .b(x08), .c(x07), .d(x06), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(x09), .c(new_n43_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n49_), .O(z05));
  inv1   g36(.a(new_n49_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n43_), .c(new_n46_), .O(new_n72_));
  nand2  g38(.a(new_n67_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  nand3  g40(.a(x11), .b(new_n74_), .c(new_n64_), .O(new_n75_));
  ...
  oai21  g45(.a(new_n75_), .b(new_n79_), .c(x06), .O(new_n80_));
  aoi21  g46(.a(x11), .b(new_n36_), .c(new_n43_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n49_), .O(z07));
  nor2   g48(.a(x12), .b(new_n43_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n49_), .c(new_n37_), .O(z08));
  nor2   g50(.a(x13), .b(new_n43_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n49_), .c(new_n37_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  aoi21  g53(.a(new_n48_), .b(x16), .c(x09), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(x08), .c(x07), .d(x06), .O(new_n89_));
  nand2  g55(.a(new_n71_), .b(x14), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n87_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x11), .O(new_n92_));
  nand3  g58(.a(new_n71_), .b(x14), .c(new_n36_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z10));
  nand2  g60(.a(new_n46_), .b(new_n35_), .O(z11));
  inv1   g61(.a(x16), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(x02), .c(new_n47_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n46_), .c(x04), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(z12));
  nor2   g65(.a(new_n37_), .b(new_n43_), .O(z13));
  nand2  g66(.a(x17), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n46_), .O(z14));
endmodule
