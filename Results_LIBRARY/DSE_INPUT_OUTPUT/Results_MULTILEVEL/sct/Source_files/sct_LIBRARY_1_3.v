...
module FAU ( 
  ...
  aoi21  g51(.a(new_n79_), .b(new_n66_), .c(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n66_), .b(x06), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  nand3  g54(.a(new_n85_), .b(new_n88_), .c(new_n69_), .O(new_n89_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n64_), .O(z08));
  ...
  nand3  g68(.a(new_n96_), .b(new_n85_), .c(new_n88_), .O(new_n103_));
  aoi22  g69(.a(new_n103_), .b(new_n102_), .c(new_n50_), .d(x16), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n69_), .c(x08), .d(x07), .O(new_n105_));
  nand2  g71(.a(new_n63_), .b(x14), .O(new_n106_));
  oai21  g72(.a(new_n105_), .b(new_n35_), .c(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n36_), .O(new_n108_));
  nand3  g74(.a(new_n63_), .b(x14), .c(new_n35_), .O(new_n109_));
  ...
  oai21  g78(.a(new_n112_), .b(new_n45_), .c(new_n48_), .O(z12));
