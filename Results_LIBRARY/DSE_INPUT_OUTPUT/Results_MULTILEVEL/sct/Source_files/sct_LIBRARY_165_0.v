...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n102_, new_n103_, new_n106_, new_n107_, new_n109_;
  ...
  nand2  g32(.a(new_n66_), .b(new_n50_), .O(z05));
  ...
  oai21  g37(.a(new_n71_), .b(new_n35_), .c(new_n50_), .O(z06));
  inv1   g38(.a(x11), .O(new_n73_));
  oai22  g39(.a(x16), .b(new_n73_), .c(x03), .d(new_n38_), .O(new_n74_));
  nand2  g40(.a(new_n69_), .b(x16), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  aoi21  g42(.a(new_n69_), .b(x11), .c(new_n43_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(z07));
  nand2  g44(.a(new_n36_), .b(new_n43_), .O(z13));
  nand2  g45(.a(new_n69_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  inv1   g47(.a(new_n61_), .O(new_n82_));
  nand4  g48(.a(new_n68_), .b(new_n82_), .c(new_n81_), .d(new_n73_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n47_), .d(x02), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x16), .O(new_n85_));
  nand2  g51(.a(x12), .b(x11), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(z13), .O(z08));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n68_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n61_), .c(x16), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n73_), .O(new_n91_));
  inv1   g57(.a(x10), .O(new_n92_));
  nand4  g58(.a(x16), .b(new_n81_), .c(new_n73_), .d(new_n92_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n64_), .c(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nor2   g62(.a(x10), .b(x03), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n88_), .c(new_n73_), .d(x02), .O(new_n98_));
  oai21  g64(.a(new_n49_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n63_), .c(x08), .d(x07), .O(new_n100_));
  nand2  g66(.a(new_n49_), .b(x14), .O(new_n101_));
  ...
  nand2  g71(.a(new_n36_), .b(x03), .O(new_n106_));
  nand2  g72(.a(x16), .b(new_n38_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n106_), .c(new_n43_), .O(z12));
