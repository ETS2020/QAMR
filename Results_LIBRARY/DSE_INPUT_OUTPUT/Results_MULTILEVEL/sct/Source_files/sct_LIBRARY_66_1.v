...
module FAU ( 
  ...
  oai21  g34(.a(x11), .b(new_n38_), .c(new_n47_), .O(new_n69_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n71_), .c(new_n48_), .O(new_n76_));
  ...
  or2    g58(.a(new_n48_), .b(new_n36_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n38_), .O(z10));
  nand2  g60(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g61(.a(x16), .b(new_n40_), .c(x03), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n38_), .c(new_n39_), .O(z12));
  nand2  g63(.a(x17), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n39_), .O(z14));
  buf    g65(.a(x04), .O(z13));
endmodule
