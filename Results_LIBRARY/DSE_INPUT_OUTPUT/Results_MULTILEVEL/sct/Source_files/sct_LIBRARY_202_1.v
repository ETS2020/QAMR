...
module FAU ( 
  ...
  nand3  g14(.a(new_n36_), .b(x07), .c(new_n45_), .O(new_n49_));
  ...
  oai21  g23(.a(x13), .b(x09), .c(new_n45_), .O(new_n58_));
  inv1   g24(.a(x07), .O(new_n59_));
  inv1   g25(.a(x08), .O(new_n60_));
  oai21  g26(.a(new_n60_), .b(new_n59_), .c(x09), .O(new_n61_));
  nor2   g27(.a(new_n59_), .b(new_n45_), .O(new_n62_));
  nor2   g28(.a(x09), .b(new_n60_), .O(new_n63_));
  aoi21  g29(.a(new_n63_), .b(new_n62_), .c(new_n42_), .O(new_n64_));
  nand4  g30(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n46_), .O(z05));
  oai21  g31(.a(x13), .b(x10), .c(new_n45_), .O(new_n66_));
  nand2  g32(.a(new_n46_), .b(x04), .O(new_n67_));
  ...
  nor2   g38(.a(new_n60_), .b(new_n59_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n69_), .c(new_n70_), .O(new_n74_));
  oai21  g40(.a(new_n72_), .b(new_n69_), .c(new_n74_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  nand3  g42(.a(new_n36_), .b(x10), .c(new_n45_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n68_), .O(z06));
  oai21  g44(.a(x13), .b(x11), .c(new_n45_), .O(new_n79_));
  nand2  g45(.a(new_n74_), .b(x11), .O(new_n80_));
  nand2  g46(.a(new_n73_), .b(x06), .O(new_n81_));
  inv1   g47(.a(new_n81_), .O(new_n82_));
  nor3   g48(.a(x11), .b(x10), .c(x09), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n82_), .c(new_n42_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n79_), .d(new_n46_), .O(z07));
  oai21  g51(.a(x13), .b(x12), .c(new_n45_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  aoi21  g54(.a(new_n83_), .b(new_n73_), .c(new_n88_), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  nand4  g56(.a(new_n72_), .b(new_n88_), .c(new_n90_), .d(new_n69_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n89_), .c(x06), .O(new_n93_));
  nand3  g59(.a(new_n36_), .b(x12), .c(new_n45_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n87_), .O(z08));
  inv1   g61(.a(new_n37_), .O(new_n96_));
  nand2  g62(.a(new_n67_), .b(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n36_), .b(new_n88_), .c(new_n90_), .d(new_n69_), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n71_), .O(new_n99_));
  aoi21  g65(.a(new_n91_), .b(x13), .c(new_n99_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n45_), .c(new_n97_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  nand2  g68(.a(new_n98_), .b(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n46_), .c(new_n70_), .d(x08), .O(new_n104_));
  inv1   g70(.a(new_n46_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x14), .O(new_n106_));
  oai21  g72(.a(new_n104_), .b(new_n59_), .c(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x06), .O(new_n108_));
  nand3  g74(.a(new_n105_), .b(x14), .c(new_n36_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n42_), .O(z10));
  nand2  g76(.a(new_n96_), .b(new_n35_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n35_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n42_), .c(new_n96_), .O(z12));
  nor2   g79(.a(new_n37_), .b(new_n42_), .O(z13));
  nand2  g80(.a(x17), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n96_), .O(z14));
endmodule
