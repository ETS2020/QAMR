...
module FAU ( 
  ...
  nand4  g35(.a(new_n69_), .b(new_n56_), .c(x08), .d(x07), .O(new_n70_));
  ...
  nor2   g44(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n74_), .c(new_n49_), .d(x04), .O(z08));
  oai21  g46(.a(new_n77_), .b(new_n58_), .c(x13), .O(new_n81_));
  inv1   g47(.a(new_n58_), .O(new_n82_));
  nor2   g48(.a(x13), .b(x12), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n69_), .c(new_n82_), .O(new_n84_));
  ...
  nand2  g54(.a(new_n83_), .b(new_n69_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n56_), .c(x08), .d(x07), .O(new_n91_));
  aoi21  g57(.a(new_n48_), .b(x14), .c(new_n75_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n36_), .O(z10));
  nor2   g59(.a(z02), .b(new_n35_), .O(z11));
  aoi21  g60(.a(x16), .b(new_n35_), .c(new_n75_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n46_), .c(new_n36_), .O(z12));
  nor2   g62(.a(new_n75_), .b(new_n36_), .O(z13));
