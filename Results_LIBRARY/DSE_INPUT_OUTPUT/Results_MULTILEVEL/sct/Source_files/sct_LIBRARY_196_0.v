...
module FAU ( 
  ...
  nand3  g35(.a(x13), .b(x09), .c(new_n55_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(z05));
  oai21  g37(.a(new_n61_), .b(x10), .c(new_n55_), .O(new_n72_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n72_), .d(new_n48_), .O(z06));
  oai21  g43(.a(new_n61_), .b(x11), .c(new_n55_), .O(new_n78_));
  ...
  and2   g48(.a(new_n82_), .b(new_n66_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n81_), .c(x06), .O(new_n84_));
  nand3  g50(.a(x13), .b(x11), .c(new_n55_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n79_), .O(z07));
  oai21  g52(.a(new_n61_), .b(x12), .c(new_n55_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n49_), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  aoi21  g55(.a(new_n82_), .b(new_n66_), .c(new_n89_), .O(new_n90_));
  inv1   g56(.a(x10), .O(new_n91_));
  nand3  g57(.a(new_n89_), .b(new_n80_), .c(new_n91_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n67_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(x06), .O(new_n94_));
  nand3  g60(.a(x13), .b(x12), .c(new_n55_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n88_), .O(z08));
  oai21  g62(.a(new_n92_), .b(new_n67_), .c(x13), .O(new_n97_));
  nand4  g63(.a(new_n61_), .b(new_n89_), .c(new_n80_), .d(new_n91_), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n67_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(new_n55_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n97_), .c(new_n48_), .d(x04), .O(z09));
  ...
  nand3  g71(.a(new_n47_), .b(x16), .c(x14), .O(new_n106_));
  oai21  g72(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(new_n107_));
  ...
  nor2   g78(.a(new_n35_), .b(new_n43_), .O(z13));
  nand2  g79(.a(x17), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n51_), .O(z14));
endmodule
