...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n36_), .c(new_n35_), .d(x04), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z02));
  inv1   g17(.a(new_n39_), .O(new_n52_));
  ...
  nand3  g22(.a(new_n36_), .b(x08), .c(new_n35_), .O(new_n57_));
  ...
  oai21  g26(.a(x14), .b(x09), .c(new_n35_), .O(new_n61_));
  ...
  nand3  g35(.a(new_n36_), .b(x09), .c(new_n35_), .O(new_n70_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n72_), .d(new_n49_), .O(z06));
  oai21  g43(.a(x14), .b(x11), .c(new_n35_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n62_), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  aoi21  g46(.a(new_n74_), .b(new_n66_), .c(new_n80_), .O(new_n81_));
  inv1   g47(.a(x10), .O(new_n82_));
  nand3  g48(.a(new_n80_), .b(new_n82_), .c(new_n64_), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n65_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n81_), .c(x06), .O(new_n85_));
  nand3  g51(.a(new_n36_), .b(x11), .c(new_n35_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(z07));
  oai21  g53(.a(x14), .b(x12), .c(new_n35_), .O(new_n88_));
  oai21  g54(.a(new_n83_), .b(new_n65_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n74_), .b(new_n90_), .c(new_n80_), .O(new_n91_));
  nor3   g57(.a(new_n91_), .b(new_n65_), .c(new_n35_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n44_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n88_), .d(new_n49_), .O(z08));
  oai21  g60(.a(x14), .b(x13), .c(new_n35_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n62_), .O(new_n96_));
  ...
  nand3  g68(.a(new_n36_), .b(x13), .c(new_n35_), .O(new_n103_));
  ...
  nand4  g73(.a(new_n107_), .b(new_n49_), .c(new_n64_), .d(x08), .O(new_n108_));
  nand3  g74(.a(new_n48_), .b(x16), .c(x14), .O(new_n109_));
  oai21  g75(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(x06), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z10));
  nand2  g78(.a(new_n52_), .b(new_n38_), .O(z11));
  inv1   g79(.a(x16), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(x02), .c(new_n47_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n52_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nor2   g83(.a(new_n39_), .b(new_n44_), .O(z13));
  nand2  g84(.a(x17), .b(x04), .O(new_n119_));
  nand2  g85(.a(new_n119_), .b(new_n52_), .O(z14));
endmodule
