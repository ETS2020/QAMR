...
module FAU ( 
  ...
  oai21  g32(.a(x10), .b(new_n43_), .c(new_n35_), .O(new_n67_));
  ...
  nand2  g50(.a(x08), .b(x07), .O(new_n85_));
  nand2  g51(.a(new_n79_), .b(new_n64_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n85_), .c(x12), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n70_), .b(new_n78_), .c(new_n89_), .d(new_n88_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n87_), .c(new_n49_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n84_), .O(z08));
  nand2  g59(.a(new_n90_), .b(x13), .O(new_n94_));
  inv1   g60(.a(x10), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n89_), .c(new_n88_), .d(new_n95_), .O(new_n97_));
  or2    g63(.a(new_n97_), .b(new_n65_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n94_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g65(.a(x07), .O(new_n100_));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n97_), .b(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n49_), .c(new_n64_), .d(x08), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n100_), .c(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(x06), .O(new_n105_));
  inv1   g71(.a(new_n49_), .O(new_n106_));
