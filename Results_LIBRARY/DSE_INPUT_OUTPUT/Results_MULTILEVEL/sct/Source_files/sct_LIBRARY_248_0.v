...
module FAU ( 
  ...
  nand3  g17(.a(new_n51_), .b(new_n37_), .c(x04), .O(new_n52_));
  ...
  nand4  g35(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  ...
  aoi21  g46(.a(new_n73_), .b(x11), .c(new_n50_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n36_), .c(new_n80_), .O(z07));
  oai21  g48(.a(new_n78_), .b(new_n67_), .c(x12), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  inv1   g50(.a(new_n67_), .O(new_n85_));
  nand4  g51(.a(new_n72_), .b(new_n85_), .c(new_n84_), .d(new_n77_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n83_), .c(new_n51_), .d(x04), .O(z08));
  nand2  g53(.a(new_n86_), .b(x13), .O(new_n88_));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n90_));
  or2    g56(.a(new_n90_), .b(new_n70_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  aoi21  g59(.a(new_n90_), .b(new_n93_), .c(new_n50_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n63_), .c(x08), .d(x07), .O(new_n95_));
  nand2  g61(.a(new_n50_), .b(x14), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n37_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n38_), .O(z10));
  nand2  g65(.a(new_n38_), .b(new_n39_), .O(z11));
  nand2  g66(.a(x16), .b(new_n39_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n48_), .c(new_n36_), .O(z12));
