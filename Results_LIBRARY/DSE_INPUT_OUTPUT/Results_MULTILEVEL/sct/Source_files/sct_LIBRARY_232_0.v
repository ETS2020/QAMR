...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n105_;
  nor2   g00(.a(x13), .b(x05), .O(new_n35_));
  ...
  nand3  g06(.a(x18), .b(new_n40_), .c(x13), .O(new_n41_));
  ...
  and2   g31(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  ...
  and2   g43(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n73_), .c(new_n51_), .d(x04), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n51_), .c(new_n35_), .O(z08));
  oai21  g50(.a(new_n50_), .b(new_n43_), .c(new_n46_), .O(new_n85_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n92_), .c(new_n50_), .O(new_n95_));
  ...
  nor2   g69(.a(new_n35_), .b(new_n43_), .O(z13));
