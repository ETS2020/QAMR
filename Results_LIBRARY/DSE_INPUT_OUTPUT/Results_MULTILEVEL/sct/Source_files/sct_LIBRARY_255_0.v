...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n51_), .d(x04), .O(z07));
  nand3  g42(.a(new_n64_), .b(x08), .c(x07), .O(new_n77_));
  nor2   g43(.a(x12), .b(x11), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n72_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n77_), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  aoi21  g47(.a(new_n75_), .b(x12), .c(new_n50_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n41_), .c(new_n81_), .O(z08));
  nor2   g49(.a(x13), .b(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n73_), .c(new_n72_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n77_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nand3  g53(.a(new_n78_), .b(new_n68_), .c(new_n74_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(x13), .c(new_n50_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n41_), .c(new_n87_), .O(z09));
  inv1   g56(.a(new_n35_), .O(new_n91_));
  inv1   g57(.a(x00), .O(new_n92_));
  aoi21  g58(.a(new_n85_), .b(new_n92_), .c(new_n50_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n64_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(new_n50_), .b(x14), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n43_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n91_), .O(z10));
  nand2  g64(.a(new_n91_), .b(new_n36_), .O(z11));
  nand2  g65(.a(x16), .b(new_n36_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n48_), .c(new_n41_), .O(z12));
  nand2  g67(.a(x06), .b(new_n41_), .O(z13));
  nand2  g68(.a(x17), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n91_), .O(z14));
endmodule
