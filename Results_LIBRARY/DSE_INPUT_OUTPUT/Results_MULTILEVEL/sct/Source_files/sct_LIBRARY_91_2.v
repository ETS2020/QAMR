...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(new_n62_), .c(new_n48_), .O(new_n66_));
  ...
  oai21  g46(.a(new_n76_), .b(new_n58_), .c(x13), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n75_), .c(new_n70_), .d(new_n63_), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n59_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n48_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n83_), .b(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n48_), .c(new_n57_), .d(x08), .O(new_n91_));
  nand3  g57(.a(new_n47_), .b(x16), .c(x14), .O(new_n92_));
  oai21  g58(.a(new_n91_), .b(new_n45_), .c(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x06), .c(x04), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(z10));
  nor2   g61(.a(z02), .b(new_n35_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n35_), .c(new_n56_), .O(new_n97_));
