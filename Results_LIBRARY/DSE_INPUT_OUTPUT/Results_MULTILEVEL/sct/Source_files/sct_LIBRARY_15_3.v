...
module FAU ( 
  ...
  oai21  g38(.a(new_n52_), .b(new_n46_), .c(new_n38_), .O(new_n73_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n36_), .c(new_n76_), .d(new_n75_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(new_n73_), .O(z06));
  nor2   g46(.a(new_n59_), .b(new_n49_), .O(new_n81_));
  nor2   g47(.a(x10), .b(x09), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n81_), .c(x17), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n35_), .c(x11), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nand4  g51(.a(new_n82_), .b(new_n78_), .c(new_n36_), .d(new_n85_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n84_), .c(new_n73_), .O(z07));
  nor3   g53(.a(x11), .b(x10), .c(x09), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n81_), .c(x17), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n35_), .c(x12), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nor2   g57(.a(x11), .b(x10), .O(new_n92_));
  nand2  g58(.a(new_n66_), .b(new_n61_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n92_), .c(new_n36_), .d(new_n91_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n90_), .c(new_n73_), .O(z08));
  nand3  g62(.a(new_n91_), .b(new_n85_), .c(new_n76_), .O(new_n97_));
  ...
  nor3   g66(.a(x17), .b(x13), .c(x12), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n94_), .c(new_n92_), .O(new_n102_));
  ...
  aoi21  g72(.a(new_n106_), .b(new_n104_), .c(new_n52_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n75_), .c(x08), .d(x07), .O(new_n108_));
  nand2  g74(.a(new_n52_), .b(x14), .O(new_n109_));
  ...
  nand2  g78(.a(new_n38_), .b(new_n40_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n40_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n46_), .c(new_n38_), .O(z12));
  oai21  g81(.a(new_n36_), .b(new_n35_), .c(new_n46_), .O(z13));
