...
module FAU ( 
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n51_), .d(x04), .O(z07));
  ...
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n51_), .d(x04), .O(z08));
  nand3  g48(.a(new_n66_), .b(x08), .c(x07), .O(new_n83_));
  ...
  aoi21  g53(.a(new_n81_), .b(x13), .c(new_n50_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n41_), .c(new_n87_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  aoi21  g56(.a(new_n85_), .b(new_n90_), .c(new_n50_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n66_), .c(x08), .d(x07), .O(new_n92_));
  nand2  g58(.a(new_n50_), .b(x14), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n43_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n57_), .O(z10));
  nand2  g62(.a(new_n57_), .b(new_n36_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n36_), .c(x03), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n41_), .c(new_n57_), .O(z12));
