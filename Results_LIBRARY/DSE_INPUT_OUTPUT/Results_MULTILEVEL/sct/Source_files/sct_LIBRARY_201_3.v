...
module FAU ( 
  ...
  oai21  g27(.a(new_n49_), .b(new_n44_), .c(new_n53_), .O(new_n62_));
  ...
  nor2   g32(.a(x13), .b(x09), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(x08), .c(x07), .d(x06), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n62_), .O(z05));
  ...
  nand2  g41(.a(new_n64_), .b(x06), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n36_), .c(new_n75_), .d(new_n70_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n74_), .c(new_n62_), .O(z06));
  inv1   g45(.a(x11), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n75_), .c(new_n70_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n63_), .c(new_n36_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  nand2  g49(.a(new_n78_), .b(x11), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n50_), .d(x04), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n80_), .c(new_n75_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n71_), .c(new_n36_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  nor2   g55(.a(x10), .b(x09), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n36_), .c(new_n80_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n76_), .c(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n89_), .c(new_n50_), .d(x04), .O(z08));
  nand4  g59(.a(new_n90_), .b(new_n77_), .c(new_n86_), .d(new_n80_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n50_), .c(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n36_), .O(new_n96_));
  oai21  g62(.a(new_n36_), .b(x06), .c(new_n96_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n36_), .b(new_n86_), .c(new_n80_), .d(new_n75_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n49_), .O(new_n100_));
  ...
  nand2  g70(.a(new_n104_), .b(new_n53_), .O(z10));
  nor2   g71(.a(new_n37_), .b(new_n38_), .O(z11));
  oai21  g72(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n53_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nand2  g75(.a(new_n53_), .b(new_n44_), .O(z13));
  nand3  g76(.a(new_n53_), .b(x17), .c(x04), .O(new_n111_));
