...
module FAU ( 
  ...
  nand4  g34(.a(new_n55_), .b(new_n68_), .c(new_n62_), .d(new_n54_), .O(new_n69_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n74_), .c(new_n68_), .d(new_n62_), .O(new_n76_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n74_), .c(new_n68_), .d(new_n62_), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n75_), .c(new_n81_), .O(new_n85_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n48_), .c(new_n54_), .d(x08), .O(new_n89_));
  ...
  oai21  g61(.a(new_n95_), .b(x02), .c(new_n46_), .O(new_n96_));
