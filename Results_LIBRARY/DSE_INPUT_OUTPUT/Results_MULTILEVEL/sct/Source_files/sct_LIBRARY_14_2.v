...
module FAU ( 
  ...
  nand3  g24(.a(new_n56_), .b(x08), .c(x07), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(new_n49_), .O(new_n60_));
  oai21  g26(.a(new_n60_), .b(new_n58_), .c(x06), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z05));
  nand2  g28(.a(new_n59_), .b(x10), .O(new_n63_));
  inv1   g29(.a(x10), .O(new_n64_));
  nand3  g30(.a(new_n57_), .b(new_n64_), .c(new_n56_), .O(new_n65_));
  and2   g31(.a(new_n65_), .b(x06), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n63_), .c(new_n49_), .d(x04), .O(z06));
  nand2  g33(.a(new_n65_), .b(x11), .O(new_n68_));
  inv1   g34(.a(x11), .O(new_n69_));
  nand4  g35(.a(new_n57_), .b(new_n69_), .c(new_n64_), .d(new_n56_), .O(new_n70_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n69_), .d(new_n64_), .O(new_n84_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n49_), .c(new_n56_), .d(x08), .O(new_n90_));
  ...
  oai21  g60(.a(x06), .b(new_n35_), .c(new_n37_), .O(z11));
  ...
  nor2   g65(.a(new_n75_), .b(new_n35_), .O(z13));
