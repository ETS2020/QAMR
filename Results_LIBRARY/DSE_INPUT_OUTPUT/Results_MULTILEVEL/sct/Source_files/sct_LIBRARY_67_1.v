...
module FAU ( 
  ...
  oai21  g36(.a(new_n67_), .b(x13), .c(new_n70_), .O(new_n71_));
  aoi21  g37(.a(new_n66_), .b(x10), .c(new_n44_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n52_), .O(z06));
  oai21  g39(.a(new_n51_), .b(new_n44_), .c(new_n47_), .O(new_n74_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n35_), .d(new_n76_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n75_), .c(new_n74_), .O(z07));
  nor2   g46(.a(x12), .b(x11), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n65_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n63_), .c(new_n35_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n70_), .O(new_n84_));
  aoi21  g50(.a(new_n79_), .b(x12), .c(new_n44_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n52_), .O(z08));
  nand3  g52(.a(new_n81_), .b(new_n78_), .c(new_n77_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n52_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n35_), .O(new_n89_));
  oai21  g55(.a(new_n35_), .b(new_n70_), .c(new_n89_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  nand4  g58(.a(new_n35_), .b(new_n92_), .c(new_n76_), .d(new_n70_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n51_), .O(new_n94_));
