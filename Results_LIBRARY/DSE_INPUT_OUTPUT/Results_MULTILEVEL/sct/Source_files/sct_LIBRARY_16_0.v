...
module FAU ( 
  ...
  inv1   g35(.a(new_n50_), .O(new_n70_));
  aoi21  g36(.a(new_n64_), .b(x10), .c(new_n70_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n41_), .c(new_n69_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n63_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n50_), .d(x04), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n50_), .d(x04), .O(z08));
  nand3  g50(.a(new_n63_), .b(x08), .c(x06), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n85_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x07), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x13), .c(new_n70_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n41_), .c(new_n89_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n87_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n50_), .c(new_n63_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  nand2  g62(.a(new_n70_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n41_), .O(z10));
  nand2  g64(.a(new_n48_), .b(new_n36_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n36_), .c(x03), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n41_), .c(new_n48_), .O(z12));
  nand2  g67(.a(x07), .b(new_n41_), .O(z13));
  nand2  g68(.a(x17), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n48_), .O(z14));
endmodule
