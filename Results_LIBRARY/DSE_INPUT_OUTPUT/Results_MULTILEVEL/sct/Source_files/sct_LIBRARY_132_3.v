...
module FAU ( 
  ...
  oai21  g08(.a(x18), .b(new_n42_), .c(x06), .O(new_n43_));
  oai21  g09(.a(new_n36_), .b(x15), .c(new_n42_), .O(new_n44_));
  ...
  nand3  g23(.a(new_n57_), .b(new_n52_), .c(x04), .O(new_n58_));
  inv1   g24(.a(new_n58_), .O(z03));
  inv1   g25(.a(x08), .O(new_n60_));
  xor2a  g26(.a(x08), .b(x07), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n36_), .c(x06), .O(new_n62_));
  oai21  g28(.a(new_n60_), .b(x06), .c(new_n62_), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n52_), .c(x04), .O(new_n64_));
  ...
  nand4  g35(.a(new_n36_), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n45_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n52_), .O(z05));
  oai21  g38(.a(new_n51_), .b(new_n45_), .c(new_n48_), .O(new_n73_));
  nand2  g39(.a(new_n69_), .b(x10), .O(new_n74_));
  nor2   g40(.a(new_n60_), .b(new_n55_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  nor3   g43(.a(x18), .b(x10), .c(x09), .O(new_n78_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(x18), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n35_), .c(x11), .O(new_n83_));
  nor2   g49(.a(x18), .b(x11), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n77_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(new_n73_), .O(z07));
  nor3   g52(.a(x11), .b(x10), .c(x09), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n75_), .c(x18), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n35_), .c(x12), .O(new_n89_));
  nor2   g55(.a(x09), .b(new_n60_), .O(new_n90_));
  nor2   g56(.a(new_n55_), .b(new_n35_), .O(new_n91_));
  nor2   g57(.a(x11), .b(x10), .O(new_n92_));
  nor2   g58(.a(x18), .b(x12), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  ...
  oai21  g63(.a(new_n97_), .b(new_n67_), .c(new_n36_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x06), .O(new_n99_));
  aoi21  g65(.a(new_n94_), .b(x13), .c(new_n45_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n99_), .c(new_n52_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n97_), .b(new_n102_), .c(new_n51_), .O(new_n103_));
  ...
  nand2  g74(.a(new_n48_), .b(new_n38_), .O(z11));
  oai21  g75(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n48_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nor2   g78(.a(new_n37_), .b(new_n45_), .O(z13));
  nand3  g79(.a(new_n48_), .b(x17), .c(x04), .O(new_n114_));
