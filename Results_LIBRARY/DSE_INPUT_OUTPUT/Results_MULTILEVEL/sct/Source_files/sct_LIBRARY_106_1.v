...
module FAU ( 
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n49_), .d(x04), .O(z06));
  nand2  g35(.a(new_n68_), .b(x11), .O(new_n70_));
  inv1   g36(.a(new_n61_), .O(new_n71_));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n63_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n49_), .d(x04), .O(z07));
  oai21  g40(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n75_));
  nand2  g41(.a(x08), .b(x07), .O(new_n76_));
  nand2  g42(.a(new_n72_), .b(new_n63_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n76_), .c(x12), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n67_), .b(new_n71_), .c(new_n80_), .d(new_n79_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n49_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n75_), .O(z08));
  oai21  g50(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n85_));
  nand3  g51(.a(new_n63_), .b(x08), .c(x07), .O(new_n86_));
  inv1   g52(.a(x10), .O(new_n87_));
  nand3  g53(.a(new_n80_), .b(new_n79_), .c(new_n87_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n86_), .c(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  inv1   g56(.a(new_n64_), .O(new_n91_));
  nand4  g57(.a(new_n72_), .b(new_n91_), .c(new_n90_), .d(new_n80_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n89_), .c(new_n49_), .O(new_n93_));
