...
module FAU ( 
  ...
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n49_), .O(z05));
  oai21  g34(.a(new_n48_), .b(new_n65_), .c(new_n45_), .O(new_n69_));
  ...
  nand4  g40(.a(new_n74_), .b(x15), .c(new_n71_), .d(new_n61_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n70_), .c(new_n69_), .O(z06));
  inv1   g42(.a(x15), .O(new_n77_));
  nor2   g43(.a(x10), .b(x09), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(new_n72_), .c(new_n77_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n35_), .c(x11), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand4  g47(.a(new_n78_), .b(new_n74_), .c(x15), .d(new_n81_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n69_), .O(z07));
  nor3   g49(.a(x11), .b(x10), .c(x09), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n72_), .c(new_n77_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n35_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nor2   g53(.a(x11), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n61_), .b(x08), .c(x07), .d(x06), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(x15), .d(new_n87_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n86_), .c(new_n69_), .O(z08));
  nand3  g58(.a(new_n87_), .b(new_n81_), .c(new_n71_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n62_), .c(x15), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x13), .O(new_n96_));
  nor2   g62(.a(new_n77_), .b(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n90_), .c(new_n88_), .d(new_n87_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n69_), .O(z09));
  ...
  nand4  g69(.a(new_n103_), .b(new_n61_), .c(x08), .d(x07), .O(new_n104_));
  ...
  oai21  g76(.a(new_n110_), .b(new_n65_), .c(new_n45_), .O(z12));
  nor2   g77(.a(new_n36_), .b(new_n65_), .O(z13));
