...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n69_), .d(new_n68_), .O(new_n79_));
  or2    g45(.a(new_n79_), .b(new_n61_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n77_), .c(new_n46_), .d(x04), .O(z09));
  inv1   g47(.a(x07), .O(new_n82_));
  inv1   g48(.a(x00), .O(new_n83_));
  nand2  g49(.a(new_n79_), .b(new_n83_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n46_), .c(new_n60_), .d(x08), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n82_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  inv1   g53(.a(new_n46_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(x14), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n87_), .O(z10));
  nor2   g56(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g57(.a(x16), .b(new_n35_), .c(x03), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n40_), .c(new_n45_), .O(z12));
  nand2  g59(.a(new_n36_), .b(new_n40_), .O(z13));
