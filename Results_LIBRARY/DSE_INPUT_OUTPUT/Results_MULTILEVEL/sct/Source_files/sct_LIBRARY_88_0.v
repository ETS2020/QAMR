...
module FAU ( 
  ...
  aoi21  g12(.a(new_n46_), .b(x05), .c(x06), .O(z02));
  inv1   g13(.a(x06), .O(new_n48_));
  nand3  g14(.a(x07), .b(new_n48_), .c(x05), .O(new_n49_));
  ...
  nand3  g19(.a(x08), .b(new_n48_), .c(x05), .O(new_n54_));
  ...
  oai21  g23(.a(x09), .b(new_n40_), .c(new_n48_), .O(new_n58_));
  ...
  nand4  g32(.a(new_n66_), .b(new_n61_), .c(new_n58_), .d(new_n45_), .O(z05));
  oai21  g33(.a(x10), .b(new_n40_), .c(new_n48_), .O(new_n68_));
  ...
  nand3  g38(.a(new_n59_), .b(new_n72_), .c(new_n63_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x06), .O(new_n75_));
  nand3  g41(.a(x10), .b(new_n48_), .c(x05), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(z06));
  oai21  g43(.a(x11), .b(new_n40_), .c(new_n48_), .O(new_n78_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n81_), .c(new_n62_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n79_), .c(new_n78_), .d(new_n45_), .O(z07));
  oai21  g52(.a(x12), .b(new_n40_), .c(new_n48_), .O(new_n87_));
  oai21  g53(.a(new_n83_), .b(new_n60_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n82_), .c(new_n72_), .d(new_n63_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n81_), .c(new_n62_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n87_), .d(new_n45_), .O(z08));
  oai21  g59(.a(x13), .b(new_n40_), .c(new_n48_), .O(new_n94_));
  ...
  aoi21  g65(.a(new_n99_), .b(new_n65_), .c(new_n62_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n94_), .d(new_n45_), .O(z09));
  inv1   g67(.a(x07), .O(new_n102_));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n98_), .b(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n45_), .c(new_n63_), .d(x08), .O(new_n105_));
  ...
  nand3  g75(.a(new_n106_), .b(x14), .c(x05), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n62_), .O(z10));
  ...
  nand2  g84(.a(new_n113_), .b(new_n62_), .O(z13));
