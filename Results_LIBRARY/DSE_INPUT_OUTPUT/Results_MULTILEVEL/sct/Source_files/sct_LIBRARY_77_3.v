...
module FAU ( 
  ...
  oai21  g27(.a(new_n61_), .b(new_n44_), .c(new_n47_), .O(new_n62_));
  nand2  g28(.a(x08), .b(x07), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(x10), .c(x06), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x09), .O(new_n66_));
  inv1   g32(.a(x09), .O(new_n67_));
  and2   g33(.a(x07), .b(x06), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n36_), .c(new_n67_), .d(x08), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n62_), .O(z05));
  nand3  g36(.a(new_n68_), .b(new_n67_), .c(x08), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n50_), .c(x04), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  oai21  g39(.a(new_n36_), .b(x06), .c(new_n73_), .O(z06));
  nand3  g40(.a(new_n67_), .b(x08), .c(x07), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x11), .O(new_n76_));
  nor2   g42(.a(x11), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n68_), .c(x08), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n36_), .O(new_n80_));
  nand2  g46(.a(x11), .b(new_n35_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n62_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  aoi21  g49(.a(new_n77_), .b(new_n64_), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n64_), .b(x06), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  nand3  g52(.a(new_n83_), .b(new_n86_), .c(new_n67_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n84_), .c(new_n36_), .O(new_n89_));
  nand2  g55(.a(x12), .b(new_n35_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n62_), .O(z08));
  oai21  g57(.a(new_n87_), .b(new_n63_), .c(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand3  g59(.a(new_n77_), .b(new_n93_), .c(new_n83_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n85_), .c(new_n92_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n36_), .O(new_n96_));
  nand2  g62(.a(x13), .b(new_n35_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n62_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand3  g65(.a(new_n93_), .b(new_n83_), .c(new_n86_), .O(new_n100_));
  aoi22  g66(.a(new_n100_), .b(new_n99_), .c(new_n49_), .d(x16), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n67_), .c(x08), .d(x07), .O(new_n102_));
  nand2  g68(.a(new_n61_), .b(x14), .O(new_n103_));
  oai21  g69(.a(new_n102_), .b(new_n35_), .c(new_n103_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n36_), .O(new_n105_));
  nand3  g71(.a(new_n61_), .b(x14), .c(new_n35_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n44_), .O(z10));
  nor2   g73(.a(new_n37_), .b(new_n38_), .O(z11));
  inv1   g74(.a(x16), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(x02), .c(new_n48_), .O(new_n110_));
