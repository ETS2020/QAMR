...
module FAU ( 
  ...
  nor2   g00(.a(x18), .b(x04), .O(new_n35_));
  ...
  nand2  g54(.a(new_n88_), .b(new_n77_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  aoi21  g56(.a(new_n85_), .b(new_n90_), .c(new_n48_), .O(new_n91_));
  ...
  nand2  g61(.a(new_n95_), .b(new_n52_), .O(z10));
  nor2   g62(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n36_), .c(x03), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n42_), .c(new_n52_), .O(z12));
  nand2  g65(.a(x17), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n52_), .O(z14));
  buf    g67(.a(x04), .O(z13));
endmodule
