...
module FAU ( 
  ...
  aoi21  g19(.a(new_n45_), .b(x02), .c(new_n47_), .O(new_n54_));
  ...
  nand2  g25(.a(x08), .b(new_n40_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n55_), .O(new_n62_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n55_), .d(x04), .O(z07));
  ...
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n55_), .d(x04), .O(z08));
  ...
  or2    g51(.a(new_n85_), .b(new_n67_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n83_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  aoi21  g54(.a(new_n85_), .b(new_n88_), .c(new_n54_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n66_), .c(x08), .d(x07), .O(new_n90_));
  nand2  g56(.a(new_n54_), .b(x14), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n40_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n50_), .O(z10));
  nor2   g60(.a(new_n36_), .b(new_n35_), .O(z11));
  aoi21  g61(.a(x16), .b(new_n35_), .c(x03), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n39_), .c(new_n50_), .O(z12));
  nand2  g63(.a(x06), .b(new_n39_), .O(z13));
