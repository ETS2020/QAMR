...
module FAU ( 
  ...
  wire new_n35_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n87_, new_n88_, new_n89_, new_n90_, new_n93_, new_n94_, new_n96_;
  ...
  nand3  g11(.a(new_n45_), .b(new_n44_), .c(new_n41_), .O(z01));
  ...
  aoi21  g18(.a(new_n52_), .b(x06), .c(new_n35_), .O(z03));
  ...
  nand3  g24(.a(new_n57_), .b(x08), .c(x07), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(x06), .c(x04), .O(new_n60_));
  nor2   g26(.a(new_n60_), .b(new_n50_), .O(new_n61_));
  oai21  g27(.a(new_n58_), .b(new_n57_), .c(new_n61_), .O(z05));
  nand2  g28(.a(new_n59_), .b(x10), .O(new_n63_));
  inv1   g29(.a(x10), .O(new_n64_));
  nand3  g30(.a(new_n58_), .b(new_n64_), .c(new_n57_), .O(new_n65_));
  and2   g31(.a(new_n65_), .b(x06), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n63_), .c(new_n51_), .d(x04), .O(z06));
  nand2  g33(.a(new_n65_), .b(x11), .O(new_n68_));
  inv1   g34(.a(x11), .O(new_n69_));
  nand4  g35(.a(new_n58_), .b(new_n69_), .c(new_n64_), .d(new_n57_), .O(new_n70_));
  and2   g36(.a(new_n70_), .b(x06), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n68_), .c(new_n51_), .d(x04), .O(z07));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n51_), .d(x04), .O(z08));
  ...
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n69_), .d(new_n64_), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n75_), .c(new_n74_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n80_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  aoi21  g53(.a(new_n83_), .b(new_n87_), .c(new_n50_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n57_), .c(x08), .d(x07), .O(new_n89_));
  aoi21  g55(.a(new_n50_), .b(x14), .c(new_n74_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n35_), .O(z10));
  nand2  g57(.a(new_n41_), .b(new_n37_), .O(z11));
  oai21  g58(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n93_));
