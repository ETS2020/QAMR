...
module FAU ( 
  ...
  oai21  g37(.a(new_n50_), .b(new_n44_), .c(new_n47_), .O(new_n72_));
  ...
  nand4  g44(.a(new_n78_), .b(x17), .c(new_n75_), .d(new_n74_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n73_), .c(new_n72_), .O(z06));
  ...
  nand4  g51(.a(new_n82_), .b(new_n78_), .c(x17), .d(new_n85_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n84_), .c(new_n72_), .O(z07));
  inv1   g53(.a(x12), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n85_), .c(new_n75_), .O(new_n89_));
  ...
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n51_), .d(x04), .O(z08));
  ...
  nand3  g64(.a(new_n98_), .b(new_n94_), .c(new_n72_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n95_), .b(new_n88_), .c(new_n85_), .d(new_n75_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n50_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n74_), .c(x08), .d(x07), .O(new_n103_));
  ...
  nand2  g73(.a(new_n47_), .b(new_n37_), .O(z11));
  ...
  oai21  g77(.a(new_n81_), .b(new_n44_), .c(new_n47_), .O(z14));
endmodule
