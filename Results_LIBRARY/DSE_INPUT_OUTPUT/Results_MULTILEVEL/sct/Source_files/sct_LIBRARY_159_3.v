...
module FAU ( 
  ...
  nand3  g07(.a(new_n41_), .b(new_n39_), .c(new_n35_), .O(z00));
  ...
  nand2  g19(.a(x07), .b(new_n36_), .O(new_n54_));
  inv1   g20(.a(x07), .O(new_n55_));
  nand3  g21(.a(new_n37_), .b(new_n55_), .c(x06), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(new_n51_), .c(x04), .O(new_n58_));
  inv1   g24(.a(new_n58_), .O(z03));
  nand2  g25(.a(x08), .b(new_n36_), .O(new_n60_));
  nand3  g26(.a(new_n37_), .b(x07), .c(x06), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n51_), .c(x04), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(z04));
  inv1   g30(.a(x09), .O(new_n65_));
  nand4  g31(.a(new_n51_), .b(new_n39_), .c(new_n65_), .d(x04), .O(z05));
  nor2   g32(.a(x10), .b(new_n46_), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n51_), .c(new_n38_), .O(z06));
  nor2   g34(.a(x11), .b(new_n46_), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n51_), .c(new_n38_), .O(z07));
  inv1   g36(.a(x12), .O(new_n71_));
  nand4  g37(.a(new_n51_), .b(new_n39_), .c(new_n71_), .d(x04), .O(z08));
  inv1   g38(.a(x13), .O(new_n73_));
  nand4  g39(.a(new_n51_), .b(new_n39_), .c(new_n73_), .d(x04), .O(z09));
  nand4  g40(.a(new_n50_), .b(x16), .c(x14), .d(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n39_), .O(z10));
  nor2   g42(.a(new_n38_), .b(new_n40_), .O(z11));
  aoi21  g43(.a(x16), .b(new_n40_), .c(x03), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n46_), .c(new_n39_), .O(z12));
  nor2   g45(.a(new_n38_), .b(new_n46_), .O(z13));
  nand2  g46(.a(x17), .b(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n39_), .O(z14));
endmodule
