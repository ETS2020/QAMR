...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(x06), .c(x04), .O(new_n53_));
  oai21  g19(.a(new_n35_), .b(x06), .c(new_n53_), .O(new_n54_));
  ...
  nand2  g27(.a(new_n61_), .b(new_n50_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n48_), .O(z04));
  ...
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n50_), .d(x04), .O(z05));
  oai21  g34(.a(x10), .b(new_n43_), .c(new_n35_), .O(new_n69_));
  nand3  g35(.a(new_n66_), .b(x08), .c(x06), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(x08), .c(x07), .d(x06), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n50_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n69_), .O(z06));
  oai21  g42(.a(x11), .b(new_n43_), .c(new_n35_), .O(new_n77_));
  nand3  g43(.a(new_n72_), .b(x08), .c(x06), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x11), .O(new_n79_));
  inv1   g45(.a(x10), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(new_n64_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n66_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n50_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n77_), .O(z07));
  nand2  g52(.a(new_n83_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n72_), .b(new_n82_), .c(new_n88_), .d(new_n81_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n50_), .d(x04), .O(z08));
  nand2  g56(.a(new_n89_), .b(x13), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n81_), .d(new_n80_), .O(new_n93_));
  or2    g59(.a(new_n93_), .b(new_n67_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand2  g62(.a(new_n93_), .b(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n50_), .c(new_n66_), .d(x08), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n49_), .c(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x07), .O(new_n100_));
  inv1   g66(.a(new_n50_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x14), .c(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n100_), .O(z10));
  nand2  g69(.a(new_n48_), .b(new_n37_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n37_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n43_), .c(new_n48_), .O(z12));
