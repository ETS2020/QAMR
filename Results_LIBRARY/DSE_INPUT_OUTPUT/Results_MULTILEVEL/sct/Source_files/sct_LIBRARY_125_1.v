...
module FAU ( 
  ...
  nor2   g37(.a(new_n71_), .b(new_n44_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n68_), .c(new_n65_), .d(new_n51_), .O(z05));
  oai21  g39(.a(new_n50_), .b(new_n44_), .c(new_n47_), .O(new_n74_));
  ...
  nand2  g45(.a(new_n79_), .b(x01), .O(new_n80_));
  nand2  g46(.a(x10), .b(new_n36_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(z06));
  oai21  g48(.a(x11), .b(x06), .c(new_n35_), .O(new_n83_));
  ...
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n83_), .d(new_n51_), .O(z07));
  inv1   g54(.a(x12), .O(new_n89_));
  aoi21  g55(.a(new_n86_), .b(new_n66_), .c(new_n89_), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  nand3  g57(.a(new_n77_), .b(new_n89_), .c(new_n91_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n67_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(x01), .O(new_n94_));
  nand2  g60(.a(x12), .b(new_n36_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n74_), .O(z08));
  oai21  g62(.a(x13), .b(x06), .c(new_n35_), .O(new_n97_));
  oai21  g63(.a(new_n92_), .b(new_n67_), .c(x13), .O(new_n98_));
  inv1   g64(.a(x10), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n89_), .c(new_n91_), .d(new_n99_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n71_), .c(new_n44_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n98_), .c(new_n97_), .d(new_n51_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  aoi21  g71(.a(new_n101_), .b(new_n105_), .c(new_n50_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n69_), .c(x08), .d(x07), .O(new_n107_));
  nand2  g73(.a(new_n50_), .b(x14), .O(new_n108_));
  oai21  g74(.a(new_n107_), .b(new_n36_), .c(new_n108_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x01), .O(new_n110_));
  nand3  g76(.a(new_n50_), .b(x14), .c(new_n36_), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n44_), .O(z10));
  inv1   g78(.a(x02), .O(new_n113_));
  nand2  g79(.a(new_n47_), .b(new_n113_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n113_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n44_), .c(new_n47_), .O(z12));
  nand2  g82(.a(new_n47_), .b(new_n44_), .O(z13));
  inv1   g83(.a(x17), .O(new_n118_));
  nor3   g84(.a(new_n40_), .b(new_n118_), .c(new_n44_), .O(z14));
endmodule
