...
module FAU ( 
  ...
  nand3  g18(.a(x07), .b(new_n45_), .c(x04), .O(new_n53_));
  oai21  g19(.a(x07), .b(new_n45_), .c(new_n53_), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n50_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(new_n39_), .O(z03));
  xnor2a g22(.a(x08), .b(x07), .O(new_n57_));
  nand3  g23(.a(x08), .b(new_n45_), .c(x04), .O(new_n58_));
  ...
  oai21  g27(.a(x09), .b(new_n38_), .c(new_n45_), .O(new_n62_));
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n50_), .d(x04), .O(z06));
  ...
  oai21  g45(.a(x12), .b(new_n38_), .c(new_n45_), .O(new_n80_));
  nand2  g46(.a(new_n77_), .b(new_n65_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n63_), .c(x12), .O(new_n82_));
  inv1   g48(.a(x11), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n76_), .b(new_n71_), .c(new_n84_), .d(new_n83_), .O(new_n85_));
  ...
  oai21  g54(.a(x13), .b(new_n38_), .c(new_n45_), .O(new_n89_));
  nand3  g55(.a(new_n65_), .b(x08), .c(x07), .O(new_n90_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n91_), .O(new_n95_));
  or2    g61(.a(new_n95_), .b(new_n66_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n93_), .c(new_n50_), .O(new_n97_));
  ...
  nand4  g67(.a(new_n101_), .b(new_n50_), .c(new_n65_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x07), .c(x06), .O(new_n104_));
  or2    g70(.a(new_n50_), .b(new_n36_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n38_), .O(z10));
  nand2  g72(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n40_), .c(x03), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n38_), .O(z12));
  nand2  g75(.a(new_n45_), .b(new_n38_), .O(z13));
