...
module FAU ( 
  ...
  nand4  g31(.a(new_n62_), .b(x08), .c(x07), .d(x06), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(new_n48_), .O(new_n67_));
  ...
  nand3  g38(.a(new_n62_), .b(x08), .c(x07), .O(new_n73_));
  ...
  oai21  g45(.a(x11), .b(new_n42_), .c(new_n36_), .O(new_n80_));
  nand2  g46(.a(new_n75_), .b(new_n64_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x11), .O(new_n82_));
  nand2  g48(.a(new_n64_), .b(x06), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  nor2   g50(.a(x11), .b(x10), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n62_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(new_n87_));
  ...
  nand4  g58(.a(new_n84_), .b(new_n75_), .c(new_n92_), .d(new_n91_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n48_), .d(x04), .O(z08));
  oai21  g60(.a(x13), .b(new_n42_), .c(new_n36_), .O(new_n95_));
  nand3  g61(.a(new_n92_), .b(new_n91_), .c(new_n70_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n73_), .c(x13), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  inv1   g64(.a(new_n66_), .O(new_n99_));
  nand4  g65(.a(new_n85_), .b(new_n99_), .c(new_n98_), .d(new_n92_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n97_), .c(new_n48_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n95_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand3  g70(.a(new_n98_), .b(new_n92_), .c(new_n91_), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n71_), .c(new_n104_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n63_), .c(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x06), .O(new_n109_));
  inv1   g75(.a(new_n48_), .O(new_n110_));
  ...
  oai21  g80(.a(new_n114_), .b(new_n42_), .c(new_n47_), .O(z12));
