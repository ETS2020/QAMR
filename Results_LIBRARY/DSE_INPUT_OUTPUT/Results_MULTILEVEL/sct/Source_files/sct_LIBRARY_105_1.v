...
module FAU ( 
  ...
  nand3  g25(.a(new_n35_), .b(new_n59_), .c(x07), .O(new_n60_));
  aoi21  g26(.a(new_n60_), .b(new_n58_), .c(new_n46_), .O(new_n61_));
  nor2   g27(.a(new_n59_), .b(x06), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(new_n63_));
  nor2   g29(.a(new_n63_), .b(new_n43_), .O(z04));
  oai21  g30(.a(x10), .b(x09), .c(new_n59_), .O(new_n65_));
  oai21  g31(.a(new_n57_), .b(new_n46_), .c(x09), .O(new_n66_));
  inv1   g32(.a(x09), .O(new_n67_));
  nor2   g33(.a(new_n57_), .b(new_n46_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(x08), .O(new_n69_));
  inv1   g35(.a(new_n69_), .O(new_n70_));
  nor2   g36(.a(new_n70_), .b(new_n43_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n66_), .c(new_n65_), .d(new_n51_), .O(z05));
  oai21  g38(.a(new_n50_), .b(new_n43_), .c(new_n47_), .O(new_n73_));
  nand3  g39(.a(new_n67_), .b(x07), .c(x06), .O(new_n74_));
  nand3  g40(.a(new_n68_), .b(new_n35_), .c(new_n67_), .O(new_n75_));
  inv1   g41(.a(new_n75_), .O(new_n76_));
  aoi21  g42(.a(new_n74_), .b(x10), .c(new_n76_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n59_), .c(new_n73_), .O(z06));
  nor2   g44(.a(x11), .b(x10), .O(new_n79_));
  inv1   g45(.a(new_n79_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n59_), .O(new_n81_));
  ...
  oai21  g53(.a(x12), .b(x10), .c(new_n59_), .O(new_n88_));
  oai21  g54(.a(new_n50_), .b(new_n43_), .c(new_n88_), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  nand3  g57(.a(new_n90_), .b(new_n91_), .c(new_n67_), .O(new_n92_));
  oai22  g58(.a(new_n92_), .b(new_n83_), .c(new_n90_), .d(x08), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n35_), .O(new_n94_));
  nand2  g60(.a(new_n85_), .b(new_n68_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x12), .c(x08), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n94_), .c(new_n89_), .O(z08));
  oai21  g63(.a(x13), .b(x10), .c(new_n59_), .O(new_n98_));
  nand3  g64(.a(new_n90_), .b(new_n91_), .c(new_n35_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n74_), .c(x13), .O(new_n100_));
  inv1   g66(.a(x13), .O(new_n101_));
  nand3  g67(.a(new_n79_), .b(new_n101_), .c(new_n90_), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n70_), .c(new_n43_), .O(new_n104_));
  ...
  nand2  g78(.a(new_n47_), .b(new_n37_), .O(z11));
  ...
  nand2  g82(.a(new_n47_), .b(new_n43_), .O(z13));
