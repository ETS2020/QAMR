...
module FAU ( 
  ...
  oai21  g37(.a(x17), .b(x10), .c(new_n57_), .O(new_n72_));
  ...
  nand3  g44(.a(new_n35_), .b(x10), .c(new_n57_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(z06));
  oai21  g46(.a(x17), .b(x11), .c(new_n57_), .O(new_n81_));
  ...
  oai21  g53(.a(x17), .b(x12), .c(new_n57_), .O(new_n88_));
  ...
  nand2  g64(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  ...
  aoi21  g81(.a(x17), .b(new_n57_), .c(new_n45_), .O(z13));
  nand3  g82(.a(x17), .b(x06), .c(x04), .O(new_n117_));
