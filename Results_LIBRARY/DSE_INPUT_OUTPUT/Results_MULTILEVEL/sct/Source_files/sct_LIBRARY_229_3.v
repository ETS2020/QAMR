...
module FAU ( 
  ...
  nor2   g24(.a(x10), .b(new_n44_), .O(new_n59_));
  aoi21  g25(.a(new_n59_), .b(new_n48_), .c(new_n36_), .O(z06));
  nor2   g26(.a(x11), .b(new_n44_), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(new_n48_), .c(new_n36_), .O(z07));
  inv1   g28(.a(x12), .O(new_n63_));
  nand4  g29(.a(new_n48_), .b(new_n35_), .c(new_n63_), .d(x04), .O(z08));
  nor2   g30(.a(x13), .b(new_n44_), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(new_n48_), .c(new_n36_), .O(z09));
  ...
  nor2   g36(.a(new_n36_), .b(new_n37_), .O(z11));
  inv1   g37(.a(x16), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(x02), .c(new_n67_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n35_), .c(x04), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(z12));
  nand2  g41(.a(new_n35_), .b(new_n44_), .O(z13));
  nand2  g42(.a(x17), .b(x04), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n35_), .O(z14));
endmodule
