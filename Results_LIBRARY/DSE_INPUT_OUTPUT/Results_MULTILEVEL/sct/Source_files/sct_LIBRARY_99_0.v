...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n45_), .c(x04), .d(x01), .O(new_n50_));
  ...
  nand3  g22(.a(x08), .b(new_n45_), .c(x01), .O(new_n57_));
  ...
  oai21  g26(.a(x09), .b(new_n35_), .c(new_n45_), .O(new_n61_));
  ...
  nand3  g35(.a(x09), .b(new_n45_), .c(x01), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(z05));
  oai21  g37(.a(x10), .b(new_n35_), .c(new_n45_), .O(new_n72_));
  ...
  nand3  g44(.a(x10), .b(new_n45_), .c(x01), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(z06));
  oai21  g46(.a(x11), .b(new_n35_), .c(new_n45_), .O(new_n81_));
  ...
  nand3  g51(.a(x11), .b(new_n45_), .c(x01), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z07));
  oai21  g53(.a(x12), .b(new_n35_), .c(new_n45_), .O(new_n88_));
  ...
  nand3  g60(.a(x12), .b(new_n45_), .c(x01), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z08));
  oai21  g62(.a(x13), .b(new_n35_), .c(new_n45_), .O(new_n97_));
  ...
  nand3  g69(.a(x13), .b(new_n45_), .c(x01), .O(new_n104_));
  ...
  nor2   g79(.a(new_n42_), .b(new_n113_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n113_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n41_), .c(new_n52_), .O(z12));
  nor2   g82(.a(new_n42_), .b(new_n41_), .O(z13));
  inv1   g83(.a(x17), .O(new_n118_));
  nor3   g84(.a(new_n42_), .b(new_n118_), .c(new_n41_), .O(z14));
endmodule
