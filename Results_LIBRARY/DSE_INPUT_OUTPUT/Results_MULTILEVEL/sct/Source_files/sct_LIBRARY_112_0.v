...
module FAU ( 
  ...
  oai21  g32(.a(new_n66_), .b(new_n36_), .c(new_n63_), .O(z05));
  ...
  oai21  g39(.a(new_n73_), .b(new_n36_), .c(new_n71_), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n52_), .d(x04), .O(z07));
  nand2  g48(.a(new_n81_), .b(x12), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n68_), .b(new_n80_), .c(new_n84_), .d(new_n79_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n52_), .d(x04), .O(z08));
  ...
  nand4  g56(.a(new_n90_), .b(new_n87_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n89_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n52_), .c(new_n60_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  nand2  g62(.a(new_n64_), .b(x14), .O(new_n97_));
  ...
  aoi21  g66(.a(new_n100_), .b(new_n46_), .c(new_n36_), .O(z12));
  nand2  g67(.a(x06), .b(new_n36_), .O(z13));
