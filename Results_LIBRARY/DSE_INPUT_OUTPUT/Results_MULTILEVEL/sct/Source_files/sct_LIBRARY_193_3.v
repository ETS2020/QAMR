...
module FAU ( 
  ...
  oai21  g31(.a(new_n50_), .b(new_n45_), .c(new_n65_), .O(new_n66_));
  ...
  nor2   g36(.a(x18), .b(x09), .O(new_n71_));
  ...
  nor2   g44(.a(x18), .b(x10), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n68_), .c(new_n74_), .d(x06), .O(new_n80_));
  ...
  aoi21  g51(.a(new_n80_), .b(x11), .c(new_n45_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n51_), .O(z07));
  nand2  g53(.a(new_n85_), .b(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n74_), .b(x08), .c(x07), .d(x06), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n82_), .c(new_n36_), .d(new_n89_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n66_), .O(z08));
  inv1   g59(.a(x10), .O(new_n94_));
  inv1   g60(.a(x11), .O(new_n95_));
  nand3  g61(.a(new_n89_), .b(new_n95_), .c(new_n94_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n75_), .c(new_n36_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x06), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x13), .O(new_n99_));
  nor3   g65(.a(x18), .b(x13), .c(x12), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n91_), .c(new_n82_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(new_n66_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nor2   g69(.a(x13), .b(x12), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n103_), .c(new_n50_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n74_), .c(x08), .d(x07), .O(new_n107_));
