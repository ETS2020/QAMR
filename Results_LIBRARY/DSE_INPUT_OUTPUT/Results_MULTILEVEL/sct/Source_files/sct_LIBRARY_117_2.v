...
module FAU ( 
  ...
  nand4  g35(.a(new_n58_), .b(new_n70_), .c(new_n64_), .d(new_n57_), .O(new_n71_));
  ...
  nand4  g43(.a(new_n78_), .b(new_n74_), .c(new_n51_), .d(x04), .O(z08));
  ...
  nand4  g51(.a(new_n86_), .b(new_n81_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n88_));
  aoi21  g53(.a(new_n84_), .b(new_n88_), .c(new_n50_), .O(new_n89_));
  nand4  g54(.a(new_n89_), .b(new_n57_), .c(x08), .d(x07), .O(new_n90_));
  aoi21  g55(.a(new_n50_), .b(x14), .c(new_n75_), .O(new_n91_));
  aoi21  g56(.a(new_n91_), .b(new_n90_), .c(new_n35_), .O(z10));
  nor2   g57(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g58(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n94_));
