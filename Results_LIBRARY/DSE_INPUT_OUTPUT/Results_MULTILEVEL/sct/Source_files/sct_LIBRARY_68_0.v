...
module FAU ( 
  ...
  nand2  g27(.a(new_n61_), .b(new_n51_), .O(z04));
  ...
  oai21  g34(.a(new_n68_), .b(new_n39_), .c(new_n66_), .O(z05));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n48_), .d(x04), .O(z06));
  ...
  or2    g53(.a(new_n87_), .b(new_n70_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  aoi21  g56(.a(new_n87_), .b(new_n90_), .c(new_n47_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n63_), .c(x08), .d(x07), .O(new_n92_));
  nand2  g58(.a(new_n47_), .b(x14), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n40_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n51_), .O(z10));
  nor2   g62(.a(new_n36_), .b(new_n35_), .O(z11));
  nand2  g63(.a(x16), .b(new_n35_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n45_), .c(new_n39_), .O(z12));
