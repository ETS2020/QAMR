...
module FAU ( 
  ...
  nand3  g37(.a(new_n71_), .b(new_n37_), .c(x04), .O(new_n72_));
  ...
  aoi21  g43(.a(new_n71_), .b(x11), .c(new_n44_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n51_), .O(z07));
  oai21  g45(.a(new_n50_), .b(new_n44_), .c(new_n37_), .O(new_n80_));
  ...
  oai21  g69(.a(new_n103_), .b(new_n44_), .c(new_n37_), .O(z12));
  nand2  g70(.a(new_n37_), .b(new_n44_), .O(z13));
