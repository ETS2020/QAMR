...
module FAU ( 
  ...
  nor2   g04(.a(new_n36_), .b(x06), .O(new_n39_));
  ...
  aoi21  g18(.a(new_n52_), .b(new_n36_), .c(x06), .O(z02));
  ...
  nand3  g24(.a(new_n36_), .b(x08), .c(new_n35_), .O(new_n59_));
  ...
  oai21  g28(.a(x14), .b(x09), .c(new_n35_), .O(new_n63_));
  ...
  nor2   g35(.a(new_n69_), .b(new_n45_), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n65_), .c(new_n63_), .d(new_n51_), .O(z05));
  oai21  g37(.a(x14), .b(x10), .c(new_n35_), .O(new_n72_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n72_), .d(new_n51_), .O(z06));
  oai21  g45(.a(x14), .b(x11), .c(new_n35_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(new_n64_), .O(new_n83_));
  aoi21  g49(.a(new_n75_), .b(new_n83_), .c(new_n82_), .O(new_n84_));
  nor4   g50(.a(new_n64_), .b(x11), .c(x10), .d(x09), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n84_), .c(x06), .O(new_n86_));
  nand3  g52(.a(new_n36_), .b(x11), .c(new_n35_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n81_), .O(z07));
  oai21  g54(.a(x14), .b(x12), .c(new_n35_), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  or2    g56(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n75_), .b(new_n90_), .c(new_n82_), .O(new_n92_));
  nor3   g58(.a(new_n92_), .b(new_n64_), .c(new_n35_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n45_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n89_), .d(new_n51_), .O(z08));
  oai21  g61(.a(x14), .b(x13), .c(new_n35_), .O(new_n96_));
  inv1   g62(.a(x10), .O(new_n97_));
  nand3  g63(.a(new_n90_), .b(new_n82_), .c(new_n97_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n73_), .c(x13), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n90_), .c(new_n82_), .d(new_n97_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n69_), .c(new_n45_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n99_), .c(new_n96_), .d(new_n51_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  aoi21  g71(.a(new_n101_), .b(new_n105_), .c(new_n50_), .O(new_n106_));
  ...
  nand2  g76(.a(new_n110_), .b(new_n54_), .O(z10));
  nand2  g77(.a(new_n54_), .b(new_n38_), .O(z11));
  oai21  g78(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n54_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n54_), .b(new_n45_), .O(z13));
