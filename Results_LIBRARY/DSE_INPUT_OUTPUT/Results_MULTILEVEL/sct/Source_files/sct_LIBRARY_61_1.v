...
module FAU ( 
  ...
  oai21  g26(.a(x09), .b(new_n42_), .c(new_n36_), .O(new_n61_));
  ...
  oai21  g48(.a(x12), .b(new_n42_), .c(new_n36_), .O(new_n83_));
  ...
  oai21  g57(.a(x13), .b(new_n42_), .c(new_n36_), .O(new_n92_));
  ...
  or2    g74(.a(new_n48_), .b(new_n108_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n42_), .O(z10));
  nor2   g76(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n35_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n42_), .c(new_n47_), .O(z12));
