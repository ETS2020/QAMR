...
module FAU ( 
  ...
  nand4  g24(.a(new_n58_), .b(new_n50_), .c(new_n46_), .d(x04), .O(new_n59_));
  ...
  nand3  g40(.a(new_n74_), .b(new_n68_), .c(new_n50_), .O(new_n75_));
  and2   g41(.a(new_n75_), .b(new_n46_), .O(z06));
  inv1   g42(.a(x10), .O(new_n77_));
  nand3  g43(.a(x15), .b(new_n77_), .c(new_n63_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n61_), .c(x11), .O(new_n79_));
  inv1   g45(.a(new_n61_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n35_), .c(new_n77_), .d(new_n63_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n50_), .d(x04), .O(z07));
  inv1   g48(.a(x15), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(x12), .c(x11), .O(new_n84_));
  oai21  g50(.a(new_n49_), .b(new_n69_), .c(new_n84_), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nor2   g52(.a(new_n73_), .b(new_n86_), .O(new_n87_));
  nor4   g53(.a(new_n61_), .b(x12), .c(x10), .d(x09), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n87_), .c(new_n35_), .O(new_n89_));
  nand3  g55(.a(x15), .b(x12), .c(x11), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n85_), .O(z08));
  oai21  g57(.a(new_n83_), .b(x13), .c(x11), .O(new_n92_));
  oai21  g58(.a(new_n49_), .b(new_n69_), .c(new_n92_), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n71_), .b(new_n80_), .c(new_n94_), .d(new_n86_), .O(new_n95_));
  oai21  g61(.a(new_n88_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n35_), .O(new_n97_));
  nand3  g63(.a(x15), .b(x13), .c(x11), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n93_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n94_), .b(new_n86_), .c(new_n35_), .d(new_n77_), .O(new_n101_));
  ...
  nor2   g77(.a(new_n36_), .b(new_n69_), .O(z13));
  inv1   g78(.a(x17), .O(new_n113_));
  nor3   g79(.a(new_n36_), .b(new_n113_), .c(new_n69_), .O(z14));
endmodule
