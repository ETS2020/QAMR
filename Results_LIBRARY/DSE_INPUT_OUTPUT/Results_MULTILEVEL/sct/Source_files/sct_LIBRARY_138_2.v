...
module FAU ( 
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n50_), .d(x04), .O(z08));
  ...
  nand4  g54(.a(new_n88_), .b(new_n56_), .c(x08), .d(x07), .O(new_n89_));
  aoi21  g55(.a(new_n49_), .b(x14), .c(new_n74_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n35_), .O(z10));
  nor2   g57(.a(z02), .b(new_n37_), .O(z11));
  oai21  g58(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x06), .c(x04), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(z12));
  nor2   g61(.a(new_n74_), .b(new_n35_), .O(z13));
