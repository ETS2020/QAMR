...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n70_, new_n72_, new_n74_, new_n76_, new_n79_, new_n80_, new_n83_;
  ...
  oai21  g32(.a(new_n64_), .b(new_n37_), .c(new_n66_), .O(z05));
  nor2   g33(.a(x10), .b(new_n43_), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(new_n51_), .c(new_n37_), .O(z06));
  nor2   g35(.a(new_n37_), .b(x11), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n51_), .c(x04), .O(z07));
  nor2   g37(.a(x12), .b(new_n43_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n51_), .c(new_n37_), .O(z08));
  nor2   g39(.a(x13), .b(new_n43_), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n51_), .c(new_n37_), .O(z09));
  nand3  g41(.a(new_n50_), .b(x14), .c(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n46_), .O(z10));
  nor2   g43(.a(new_n37_), .b(new_n35_), .O(z11));
  oai21  g44(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n46_), .c(x04), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(z12));
  nor2   g47(.a(new_n37_), .b(new_n43_), .O(z13));
  nand2  g48(.a(x17), .b(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n46_), .O(z14));
endmodule
