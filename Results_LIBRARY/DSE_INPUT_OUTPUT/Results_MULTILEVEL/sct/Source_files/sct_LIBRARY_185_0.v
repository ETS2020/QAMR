...
module FAU ( 
  ...
  nand2  g20(.a(new_n47_), .b(x16), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(new_n51_), .O(z03));
  xnor2a g23(.a(x08), .b(x07), .O(new_n58_));
  nand2  g24(.a(x08), .b(new_n41_), .O(new_n59_));
  oai21  g25(.a(new_n58_), .b(new_n41_), .c(new_n59_), .O(new_n60_));
  ...
  oai21  g35(.a(new_n69_), .b(new_n40_), .c(new_n66_), .O(z05));
  ...
  nand4  g40(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(x10), .c(new_n67_), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n40_), .c(new_n74_), .O(z06));
  nand2  g43(.a(x07), .b(x06), .O(new_n78_));
  nand2  g44(.a(new_n71_), .b(x08), .O(new_n79_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n63_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n55_), .d(x04), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n81_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n64_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  aoi21  g55(.a(new_n84_), .b(x12), .c(new_n67_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n40_), .c(new_n89_), .O(z08));
  nand3  g57(.a(new_n71_), .b(new_n86_), .c(new_n82_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n68_), .c(x13), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n86_), .c(new_n82_), .d(new_n81_), .O(new_n95_));
  or2    g61(.a(new_n95_), .b(new_n75_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n93_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n95_), .b(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n55_), .c(new_n63_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n67_), .b(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n40_), .O(z10));
  nand2  g70(.a(new_n51_), .b(new_n36_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n36_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n40_), .c(new_n51_), .O(z12));
  nand2  g73(.a(x06), .b(new_n40_), .O(z13));
