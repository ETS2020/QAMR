...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(x11), .c(x06), .O(new_n58_));
  ...
  nand2  g30(.a(new_n64_), .b(x11), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x06), .O(new_n66_));
  nand4  g32(.a(x11), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n63_), .c(x08), .d(x07), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x11), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x06), .O(new_n73_));
  nand2  g39(.a(x07), .b(x06), .O(new_n74_));
  nand3  g40(.a(x11), .b(new_n63_), .c(x08), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n74_), .c(x10), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n51_), .d(x04), .O(z06));
  nand2  g43(.a(new_n51_), .b(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n36_), .O(new_n79_));
  nand3  g45(.a(new_n70_), .b(new_n63_), .c(x08), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n74_), .c(x11), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n79_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n51_), .b(new_n36_), .c(new_n83_), .d(x04), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n51_), .b(new_n36_), .c(new_n85_), .d(x04), .O(z09));
  nand4  g52(.a(new_n51_), .b(new_n63_), .c(x08), .d(x07), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(new_n50_), .O(new_n88_));
  nor2   g54(.a(new_n51_), .b(new_n41_), .O(new_n89_));
  aoi21  g55(.a(new_n88_), .b(x00), .c(new_n89_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n47_), .c(new_n36_), .O(z10));
  nor2   g57(.a(new_n37_), .b(new_n38_), .O(z11));
  inv1   g58(.a(x03), .O(new_n93_));
  inv1   g59(.a(x16), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(x02), .c(new_n93_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n36_), .c(x04), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(z12));
  nand2  g63(.a(new_n36_), .b(new_n47_), .O(z13));
  nand2  g64(.a(x17), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n36_), .O(z14));
endmodule
