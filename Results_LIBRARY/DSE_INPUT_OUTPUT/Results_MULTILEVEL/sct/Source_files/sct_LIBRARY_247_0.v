...
module FAU ( 
  ...
  nand4  g21(.a(new_n55_), .b(new_n38_), .c(new_n51_), .d(x04), .O(new_n56_));
  ...
  nand2  g27(.a(x08), .b(new_n51_), .O(new_n62_));
  oai21  g28(.a(new_n61_), .b(new_n51_), .c(new_n62_), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n55_), .c(x04), .O(new_n64_));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n55_), .c(new_n37_), .O(z05));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(x08), .c(x07), .d(x06), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n38_), .c(x04), .O(new_n75_));
  aoi21  g41(.a(new_n69_), .b(x10), .c(new_n75_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n55_), .O(z06));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n55_), .c(new_n37_), .O(z07));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n55_), .c(new_n37_), .O(z08));
  ...
  nor2   g59(.a(new_n93_), .b(new_n37_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand2  g62(.a(new_n92_), .b(new_n96_), .O(new_n97_));
  oai21  g63(.a(new_n54_), .b(new_n44_), .c(new_n40_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n68_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  nand2  g67(.a(new_n54_), .b(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n48_), .O(z10));
  aoi21  g69(.a(x16), .b(new_n36_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n48_), .c(new_n38_), .O(z12));
  nor2   g71(.a(new_n37_), .b(new_n48_), .O(z13));
