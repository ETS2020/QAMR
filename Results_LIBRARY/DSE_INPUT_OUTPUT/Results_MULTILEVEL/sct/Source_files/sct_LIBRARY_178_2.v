...
module FAU ( 
  ...
  aoi21  g39(.a(new_n73_), .b(new_n51_), .c(new_n43_), .O(z06));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n51_), .c(new_n43_), .O(z08));
  oai21  g51(.a(new_n50_), .b(new_n41_), .c(new_n46_), .O(new_n86_));
  nand3  g52(.a(new_n82_), .b(x14), .c(x13), .O(new_n87_));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n76_), .c(new_n67_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(z09));
  aoi21  g56(.a(new_n88_), .b(new_n76_), .c(x00), .O(new_n91_));
  nand2  g57(.a(x13), .b(x00), .O(new_n92_));
  oai21  g58(.a(new_n91_), .b(new_n50_), .c(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n65_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(new_n48_), .b(x02), .O(new_n95_));
  nand2  g61(.a(new_n36_), .b(new_n42_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  oai21  g63(.a(new_n94_), .b(new_n47_), .c(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n46_), .O(z10));
  inv1   g66(.a(x02), .O(new_n101_));
  nor2   g67(.a(new_n43_), .b(new_n101_), .O(z11));
  ...
  nor3   g73(.a(new_n43_), .b(new_n107_), .c(new_n41_), .O(z14));
endmodule
