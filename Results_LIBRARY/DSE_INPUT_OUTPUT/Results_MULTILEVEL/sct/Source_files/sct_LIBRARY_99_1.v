...
module FAU ( 
  ...
  nor2   g09(.a(new_n37_), .b(x01), .O(new_n44_));
  ...
  nand3  g23(.a(new_n57_), .b(x06), .c(x01), .O(new_n58_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n43_), .c(new_n53_), .O(new_n63_));
  inv1   g29(.a(x09), .O(new_n64_));
  nand2  g30(.a(x08), .b(x07), .O(new_n65_));
  inv1   g31(.a(new_n65_), .O(new_n66_));
  nand4  g32(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  oai21  g33(.a(new_n66_), .b(new_n64_), .c(new_n67_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x01), .O(new_n69_));
  nand2  g35(.a(x09), .b(new_n37_), .O(new_n70_));
  ...
  nand2  g43(.a(x10), .b(new_n37_), .O(new_n78_));
  ...
  nand2  g47(.a(new_n66_), .b(x06), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  nand3  g49(.a(new_n80_), .b(new_n83_), .c(new_n64_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n81_), .c(x01), .O(new_n86_));
  nand2  g52(.a(x11), .b(new_n37_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n63_), .O(z07));
  oai21  g54(.a(new_n84_), .b(new_n65_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n74_), .b(new_n90_), .c(new_n80_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n82_), .c(new_n89_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x01), .O(new_n93_));
  nand2  g59(.a(x12), .b(new_n37_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n63_), .O(z08));
  nand3  g61(.a(new_n90_), .b(new_n80_), .c(new_n83_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n72_), .c(x13), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n90_), .c(new_n80_), .d(new_n83_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n67_), .c(new_n97_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x01), .O(new_n101_));
  nand2  g67(.a(x13), .b(new_n37_), .O(new_n102_));
  ...
  oai21  g73(.a(new_n106_), .b(new_n37_), .c(new_n107_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n53_), .O(z10));
  nor2   g76(.a(new_n44_), .b(new_n35_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n35_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n43_), .c(new_n53_), .O(z12));
  nor2   g79(.a(new_n44_), .b(new_n43_), .O(z13));
  inv1   g80(.a(x17), .O(new_n115_));
  nor3   g81(.a(new_n44_), .b(new_n115_), .c(new_n43_), .O(z14));
endmodule
