...
module FAU ( 
  ...
  aoi21  g17(.a(new_n51_), .b(x06), .c(new_n36_), .O(z03));
  ...
  nand3  g37(.a(new_n71_), .b(new_n65_), .c(new_n58_), .O(new_n72_));
  ...
  nor2   g44(.a(new_n78_), .b(new_n59_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n50_), .d(x04), .O(z08));
  oai21  g47(.a(new_n78_), .b(new_n59_), .c(x13), .O(new_n82_));
  inv1   g48(.a(new_n59_), .O(new_n83_));
  nor2   g49(.a(x13), .b(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n71_), .c(new_n83_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n82_), .c(new_n50_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n84_), .b(new_n71_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n49_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n58_), .c(x08), .d(x07), .O(new_n92_));
  aoi21  g58(.a(new_n49_), .b(x14), .c(new_n76_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n36_), .O(z10));
  nand2  g60(.a(new_n40_), .b(new_n35_), .O(z11));
  aoi21  g61(.a(x16), .b(new_n35_), .c(new_n76_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n47_), .c(new_n36_), .O(z12));
