...
module FAU ( 
  ...
  aoi21  g33(.a(new_n67_), .b(x09), .c(new_n49_), .O(new_n68_));
  ...
  nand4  g39(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(x10), .c(new_n49_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n40_), .c(new_n73_), .O(z06));
  nand2  g42(.a(x07), .b(x06), .O(new_n77_));
  nand2  g43(.a(new_n70_), .b(x08), .O(new_n78_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n63_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n50_), .d(x04), .O(z07));
  nand2  g50(.a(new_n83_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n70_), .b(new_n82_), .c(new_n86_), .d(new_n81_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n50_), .d(x04), .O(z08));
  nand2  g54(.a(new_n87_), .b(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n81_), .d(new_n80_), .O(new_n91_));
  or2    g57(.a(new_n91_), .b(new_n74_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n89_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  aoi21  g60(.a(new_n91_), .b(new_n94_), .c(new_n49_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n63_), .c(x08), .d(x07), .O(new_n96_));
  nand2  g62(.a(new_n49_), .b(x14), .O(new_n97_));
  oai21  g63(.a(new_n96_), .b(new_n42_), .c(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n56_), .O(z10));
  nor2   g66(.a(new_n36_), .b(new_n35_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n35_), .c(x03), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n40_), .c(new_n56_), .O(z12));
  inv1   g69(.a(new_n43_), .O(z13));
