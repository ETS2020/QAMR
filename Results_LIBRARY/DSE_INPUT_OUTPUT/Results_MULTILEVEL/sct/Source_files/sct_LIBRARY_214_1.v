...
module FAU ( 
  ...
  oai21  g27(.a(x09), .b(new_n38_), .c(new_n61_), .O(new_n62_));
  oai21  g28(.a(new_n56_), .b(new_n47_), .c(x09), .O(new_n63_));
  inv1   g29(.a(x09), .O(new_n64_));
  nand4  g30(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n63_), .c(new_n48_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x04), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n62_), .O(z05));
  oai21  g34(.a(x10), .b(new_n38_), .c(new_n61_), .O(new_n69_));
  nand3  g35(.a(new_n64_), .b(x08), .c(x06), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(x08), .c(x07), .d(x06), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n48_), .O(new_n74_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n78_), .d(new_n64_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n77_), .c(new_n48_), .d(x04), .O(z07));
  nand2  g49(.a(new_n82_), .b(x12), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n81_), .b(new_n72_), .c(new_n85_), .d(new_n79_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n48_), .d(x04), .O(z08));
  oai21  g53(.a(x13), .b(new_n38_), .c(new_n61_), .O(new_n88_));
  nand3  g54(.a(new_n85_), .b(new_n79_), .c(new_n78_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n70_), .c(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n85_), .c(new_n79_), .d(new_n78_), .O(new_n92_));
  or2    g58(.a(new_n92_), .b(new_n65_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n90_), .c(new_n48_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n88_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n92_), .b(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  or2    g67(.a(new_n48_), .b(new_n36_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n38_), .O(z10));
  nand2  g69(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n40_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n38_), .c(new_n39_), .O(z12));
  nand2  g72(.a(new_n61_), .b(new_n38_), .O(z13));
