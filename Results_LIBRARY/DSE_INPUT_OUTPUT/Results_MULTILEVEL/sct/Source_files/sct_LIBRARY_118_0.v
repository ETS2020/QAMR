...
module FAU ( 
  ...
  oai21  g34(.a(new_n68_), .b(new_n40_), .c(new_n66_), .O(z05));
  ...
  nand2  g40(.a(x08), .b(x06), .O(new_n75_));
  ...
  oai21  g47(.a(new_n81_), .b(new_n40_), .c(new_n80_), .O(z07));
  ...
  nand2  g65(.a(new_n46_), .b(new_n36_), .O(z11));
  nand2  g66(.a(x16), .b(new_n36_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n48_), .c(new_n40_), .O(z12));
