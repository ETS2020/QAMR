...
module FAU ( 
  ...
  nand3  g33(.a(x10), .b(x09), .c(new_n49_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n62_), .O(z05));
  nand2  g35(.a(new_n65_), .b(x10), .O(new_n70_));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n64_), .c(new_n49_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n46_), .d(x04), .O(z06));
  nand2  g39(.a(new_n47_), .b(new_n54_), .O(new_n74_));
  nand2  g40(.a(new_n65_), .b(x11), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  nand4  g42(.a(new_n64_), .b(new_n76_), .c(new_n60_), .d(new_n63_), .O(new_n77_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n64_), .c(new_n82_), .O(new_n84_));
  nor4   g50(.a(new_n65_), .b(x12), .c(x11), .d(x10), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n84_), .c(x06), .O(new_n86_));
  nand2  g52(.a(x12), .b(x10), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n74_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nor3   g55(.a(x12), .b(x11), .c(x09), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n64_), .c(new_n89_), .O(new_n91_));
  nand4  g57(.a(new_n89_), .b(new_n82_), .c(new_n76_), .d(new_n60_), .O(new_n92_));
  ...
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n74_), .O(z09));
  inv1   g62(.a(x07), .O(new_n97_));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n92_), .b(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n46_), .c(new_n63_), .d(x08), .O(new_n100_));
  ...
  nand2  g72(.a(new_n54_), .b(new_n36_), .O(z11));
  inv1   g73(.a(x03), .O(new_n108_));
  inv1   g74(.a(x16), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(x02), .c(new_n108_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n54_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nand2  g78(.a(new_n54_), .b(new_n43_), .O(z13));
  nand2  g79(.a(x17), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n54_), .O(z14));
endmodule
