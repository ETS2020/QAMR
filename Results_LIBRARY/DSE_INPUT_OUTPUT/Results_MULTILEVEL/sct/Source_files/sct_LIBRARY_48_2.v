...
module FAU ( 
  ...
  nand4  g35(.a(new_n69_), .b(x17), .c(new_n68_), .d(x08), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n67_), .c(new_n62_), .O(z05));
  inv1   g37(.a(x10), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n64_), .c(x17), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x06), .O(new_n75_));
  nand2  g41(.a(new_n70_), .b(x10), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n51_), .d(x04), .O(z06));
  nor2   g43(.a(x11), .b(x10), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n65_), .c(new_n68_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x17), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand2  g47(.a(new_n65_), .b(x06), .O(new_n82_));
  nand3  g48(.a(x17), .b(new_n72_), .c(new_n68_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n82_), .c(x11), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n51_), .d(x04), .O(z07));
  ...
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n72_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n88_), .c(x17), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  nand4  g59(.a(x17), .b(new_n89_), .c(new_n72_), .d(new_n68_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n82_), .c(x12), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n93_), .c(new_n51_), .d(x04), .O(z08));
  nand2  g62(.a(new_n93_), .b(x13), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand3  g64(.a(x17), .b(new_n98_), .c(new_n90_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n87_), .c(new_n78_), .d(new_n69_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n97_), .c(new_n62_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand3  g69(.a(new_n78_), .b(new_n98_), .c(new_n90_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n50_), .O(new_n105_));
  ...
  nor2   g82(.a(new_n63_), .b(new_n44_), .O(z14));
endmodule
