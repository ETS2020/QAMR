...
module FAU ( 
  ...
  nand3  g18(.a(new_n36_), .b(x07), .c(new_n46_), .O(new_n53_));
  ...
  oai21  g28(.a(x13), .b(x09), .c(new_n46_), .O(new_n63_));
  ...
  oai21  g36(.a(x13), .b(x10), .c(new_n46_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n36_), .b(x11), .c(new_n46_), .O(new_n86_));
  ...
  oai21  g60(.a(new_n49_), .b(new_n43_), .c(new_n57_), .O(new_n95_));
  ...
  nand4  g64(.a(new_n36_), .b(new_n89_), .c(new_n81_), .d(new_n96_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n72_), .c(new_n98_), .O(new_n100_));
  ...
  aoi21  g70(.a(new_n99_), .b(new_n104_), .c(new_n49_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n103_), .c(x08), .d(x07), .O(new_n106_));
  ...
  nand2  g75(.a(new_n109_), .b(new_n57_), .O(z10));
  nand2  g76(.a(new_n57_), .b(new_n35_), .O(z11));
  oai21  g77(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n57_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nor2   g80(.a(new_n37_), .b(new_n43_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n37_), .b(new_n116_), .c(new_n43_), .O(z14));
endmodule
