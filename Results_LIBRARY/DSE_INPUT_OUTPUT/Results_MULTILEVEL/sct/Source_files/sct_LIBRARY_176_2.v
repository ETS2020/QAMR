...
module FAU ( 
  ...
  nand3  g17(.a(x11), .b(new_n51_), .c(x06), .O(new_n52_));
  ...
  nor2   g31(.a(new_n51_), .b(new_n35_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(x11), .c(x08), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x09), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n65_), .c(new_n48_), .d(x04), .O(z05));
  inv1   g35(.a(x10), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n62_), .c(x08), .d(x07), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x11), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x06), .O(new_n73_));
  inv1   g39(.a(new_n66_), .O(new_n74_));
  nand3  g40(.a(x11), .b(new_n62_), .c(x08), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n74_), .c(x10), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n48_), .d(x04), .O(z06));
  inv1   g43(.a(new_n36_), .O(new_n78_));
  inv1   g44(.a(new_n48_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n43_), .c(new_n78_), .O(new_n80_));
  nand3  g46(.a(new_n70_), .b(new_n62_), .c(x08), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n74_), .c(x11), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n80_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n48_), .b(new_n78_), .c(new_n84_), .d(x04), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n48_), .b(new_n78_), .c(new_n86_), .d(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  aoi21  g54(.a(new_n47_), .b(x16), .c(x09), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(x08), .c(x07), .d(x06), .O(new_n90_));
  nand2  g56(.a(new_n79_), .b(x14), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n88_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x11), .O(new_n93_));
  nand3  g59(.a(new_n79_), .b(x14), .c(new_n35_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n43_), .O(z10));
  nand2  g61(.a(new_n78_), .b(new_n37_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n37_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n43_), .c(new_n78_), .O(z12));
  nand2  g64(.a(new_n78_), .b(new_n43_), .O(z13));
  inv1   g65(.a(x17), .O(new_n100_));
  nor3   g66(.a(new_n36_), .b(new_n100_), .c(new_n43_), .O(z14));
endmodule
