...
module FAU ( 
  ...
  oai21  g47(.a(x12), .b(new_n38_), .c(new_n47_), .O(new_n82_));
  nand2  g48(.a(x08), .b(x07), .O(new_n83_));
  nand2  g49(.a(new_n77_), .b(new_n62_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n83_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n68_), .b(new_n76_), .c(new_n87_), .d(new_n86_), .O(new_n88_));
  ...
  oai21  g57(.a(x13), .b(new_n38_), .c(new_n47_), .O(new_n92_));
  inv1   g58(.a(x10), .O(new_n93_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n93_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n66_), .c(x13), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n87_), .c(new_n86_), .d(new_n93_), .O(new_n97_));
  or2    g63(.a(new_n97_), .b(new_n63_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n95_), .c(new_n48_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n92_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  nand2  g68(.a(new_n97_), .b(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(x07), .c(x06), .O(new_n106_));
  or2    g72(.a(new_n48_), .b(new_n36_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n106_), .c(new_n38_), .O(z10));
  nand2  g74(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g75(.a(x16), .b(new_n40_), .c(x03), .O(new_n110_));
  nor2   g76(.a(new_n110_), .b(new_n38_), .O(z12));
  nand2  g77(.a(new_n47_), .b(new_n38_), .O(z13));
