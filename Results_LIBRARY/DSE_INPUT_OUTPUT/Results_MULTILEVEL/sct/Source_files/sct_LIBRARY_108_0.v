...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(x14), .c(new_n36_), .d(x04), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(z02));
  nand3  g18(.a(x14), .b(x07), .c(new_n36_), .O(new_n53_));
  oai21  g19(.a(x07), .b(new_n36_), .c(new_n53_), .O(new_n54_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n65_), .c(new_n62_), .d(new_n50_), .O(z05));
  oai21  g36(.a(new_n37_), .b(x10), .c(new_n36_), .O(new_n71_));
  oai21  g37(.a(new_n49_), .b(new_n44_), .c(new_n71_), .O(new_n72_));
  ...
  nand3  g44(.a(x14), .b(x10), .c(new_n36_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n72_), .O(z06));
  oai21  g46(.a(new_n37_), .b(x11), .c(new_n36_), .O(new_n81_));
  ...
  nand2  g62(.a(new_n47_), .b(x02), .O(new_n97_));
  nand2  g63(.a(new_n36_), .b(new_n44_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  oai21  g65(.a(new_n37_), .b(x13), .c(new_n36_), .O(new_n100_));
  ...
  nand4  g69(.a(new_n103_), .b(new_n92_), .c(new_n91_), .d(new_n75_), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n68_), .c(new_n44_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n102_), .c(new_n100_), .d(new_n99_), .O(z09));
  inv1   g73(.a(new_n40_), .O(new_n108_));
  inv1   g74(.a(x00), .O(new_n109_));
  aoi21  g75(.a(new_n104_), .b(new_n109_), .c(new_n49_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n66_), .c(x08), .d(x07), .O(new_n111_));
  nand2  g77(.a(new_n37_), .b(x06), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n97_), .c(x16), .O(new_n113_));
  oai21  g79(.a(new_n111_), .b(new_n36_), .c(new_n113_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n108_), .O(z10));
  inv1   g82(.a(x02), .O(new_n117_));
  nor2   g83(.a(new_n40_), .b(new_n117_), .O(z11));
  oai21  g84(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n119_));
  nand3  g85(.a(new_n119_), .b(new_n108_), .c(x04), .O(new_n120_));
  inv1   g86(.a(new_n120_), .O(z12));
  nand2  g87(.a(new_n108_), .b(new_n44_), .O(z13));
