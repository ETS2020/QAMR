...
module FAU ( 
  ...
  aoi21  g17(.a(new_n51_), .b(x07), .c(new_n41_), .O(z02));
  nand4  g18(.a(new_n50_), .b(x07), .c(new_n47_), .d(x04), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(z03));
  nand3  g20(.a(x08), .b(x07), .c(new_n47_), .O(new_n55_));
  oai21  g21(.a(x08), .b(new_n47_), .c(new_n55_), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(new_n50_), .O(new_n57_));
  aoi21  g23(.a(new_n57_), .b(x07), .c(new_n41_), .O(z04));
  ...
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n61_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n50_), .O(new_n70_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n74_), .c(new_n67_), .d(new_n61_), .O(new_n75_));
  and2   g41(.a(new_n75_), .b(x07), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n50_), .d(x04), .O(z07));
  nand2  g43(.a(new_n75_), .b(x12), .O(new_n78_));
  inv1   g44(.a(x12), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(new_n67_), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n36_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n50_), .d(x04), .O(z08));
  oai21  g49(.a(new_n80_), .b(new_n62_), .c(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n79_), .c(new_n74_), .d(new_n67_), .O(new_n86_));
  or2    g52(.a(new_n86_), .b(new_n62_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n50_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x07), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand2  g57(.a(new_n86_), .b(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n50_), .c(new_n61_), .d(x08), .O(new_n93_));
  nand3  g59(.a(new_n49_), .b(x16), .c(x14), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n47_), .c(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x04), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(z10));
  nand2  g63(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g64(.a(x16), .b(new_n38_), .c(new_n36_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n48_), .c(new_n41_), .O(z12));
  inv1   g66(.a(x17), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(x07), .c(new_n41_), .O(z14));
  buf    g68(.a(x04), .O(z13));
endmodule
