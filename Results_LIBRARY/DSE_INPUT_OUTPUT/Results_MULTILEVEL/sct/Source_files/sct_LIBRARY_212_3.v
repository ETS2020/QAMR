...
module FAU ( 
  ...
  aoi21  g21(.a(new_n55_), .b(new_n51_), .c(new_n40_), .O(z04));
  ...
  nand3  g27(.a(new_n61_), .b(new_n52_), .c(x04), .O(z07));
  nor2   g28(.a(x12), .b(x06), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n52_), .c(x04), .O(z08));
  inv1   g30(.a(x13), .O(new_n65_));
  nand4  g31(.a(new_n52_), .b(new_n65_), .c(new_n51_), .d(x04), .O(z09));
  nand3  g32(.a(new_n47_), .b(x16), .c(x14), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n51_), .c(new_n40_), .O(z10));
  aoi21  g34(.a(x06), .b(x04), .c(new_n37_), .O(z11));
  aoi21  g35(.a(x16), .b(new_n37_), .c(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n46_), .c(new_n40_), .O(z12));
  nand3  g37(.a(x17), .b(new_n51_), .c(x04), .O(new_n72_));
