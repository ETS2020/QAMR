...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(x17), .c(x06), .O(new_n58_));
  ...
  nand2  g29(.a(new_n63_), .b(x17), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x06), .O(new_n65_));
  inv1   g31(.a(x07), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(new_n35_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(x17), .c(x08), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(x09), .c(new_n43_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n65_), .c(new_n50_), .O(z05));
  inv1   g36(.a(x09), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  nor2   g38(.a(new_n56_), .b(new_n66_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x17), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  inv1   g42(.a(new_n67_), .O(new_n77_));
  nand3  g43(.a(x17), .b(new_n71_), .c(x08), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n77_), .c(x10), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n50_), .d(x04), .O(z06));
  nor2   g46(.a(x11), .b(x10), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n73_), .c(new_n71_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x17), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nand2  g50(.a(new_n73_), .b(x06), .O(new_n85_));
  nand3  g51(.a(x17), .b(new_n72_), .c(new_n71_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n85_), .c(x11), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n50_), .d(x04), .O(z07));
  oai21  g54(.a(new_n49_), .b(new_n43_), .c(new_n46_), .O(new_n89_));
  nand2  g55(.a(new_n84_), .b(x12), .O(new_n90_));
  inv1   g56(.a(x17), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n81_), .c(new_n67_), .d(new_n62_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n90_), .c(new_n89_), .O(z08));
  nor2   g60(.a(x13), .b(x12), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n63_), .c(x17), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x06), .O(new_n98_));
  aoi21  g64(.a(new_n93_), .b(x13), .c(new_n43_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(new_n50_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n96_), .b(new_n101_), .c(new_n49_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n71_), .c(x08), .d(x07), .O(new_n103_));
  ...
  nand2  g73(.a(new_n46_), .b(new_n37_), .O(z11));
  ...
  oai21  g78(.a(new_n91_), .b(new_n43_), .c(new_n46_), .O(z14));
endmodule
