...
module FAU ( 
  ...
  oai21  g26(.a(x09), .b(new_n38_), .c(new_n47_), .O(new_n61_));
  ...
  oai21  g37(.a(x11), .b(new_n38_), .c(new_n47_), .O(new_n72_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n62_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(new_n48_), .O(new_n80_));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n48_), .d(x04), .O(z08));
  nand2  g52(.a(new_n85_), .b(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n84_), .c(new_n76_), .d(new_n75_), .O(new_n89_));
  or2    g55(.a(new_n89_), .b(new_n64_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n87_), .c(new_n48_), .d(x04), .O(z09));
