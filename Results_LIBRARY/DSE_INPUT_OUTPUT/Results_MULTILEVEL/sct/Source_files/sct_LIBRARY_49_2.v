...
module FAU ( 
  ...
  and2   g33(.a(new_n67_), .b(x06), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n64_), .c(new_n50_), .d(x04), .O(z06));
  nand2  g35(.a(new_n67_), .b(x11), .O(new_n70_));
  inv1   g36(.a(x11), .O(new_n71_));
  nand4  g37(.a(new_n66_), .b(new_n71_), .c(new_n65_), .d(new_n59_), .O(new_n72_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n50_), .d(x04), .O(z08));
  nand2  g46(.a(new_n78_), .b(new_n77_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x13), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n71_), .d(new_n65_), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n77_), .c(new_n76_), .O(new_n87_));
  ...
  aoi21  g57(.a(new_n49_), .b(x14), .c(new_n76_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n35_), .O(z10));
  nor2   g59(.a(z02), .b(new_n37_), .O(z11));
  oai21  g60(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x06), .c(x04), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(z12));
  nor2   g63(.a(new_n76_), .b(new_n35_), .O(z13));
