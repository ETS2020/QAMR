...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(new_n36_), .c(new_n35_), .O(z03));
  ...
  oai21  g22(.a(new_n56_), .b(x09), .c(new_n36_), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(x04), .O(z05));
  oai21  g24(.a(new_n56_), .b(x10), .c(new_n36_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z06));
  oai21  g26(.a(new_n56_), .b(x11), .c(new_n36_), .O(new_n61_));
  ...
  aoi21  g35(.a(x16), .b(new_n38_), .c(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n54_), .c(new_n35_), .O(z12));
  inv1   g37(.a(x17), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n36_), .c(new_n35_), .O(z14));
  buf    g39(.a(x04), .O(z13));
endmodule
