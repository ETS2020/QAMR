...
module FAU ( 
  ...
  aoi21  g25(.a(new_n36_), .b(new_n49_), .c(new_n35_), .O(new_n60_));
  nor2   g26(.a(new_n35_), .b(new_n49_), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n36_), .c(new_n59_), .O(new_n62_));
  oai21  g28(.a(new_n60_), .b(new_n59_), .c(new_n62_), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n53_), .c(x04), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(z04));
  nor2   g31(.a(x09), .b(new_n59_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n36_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x07), .O(new_n69_));
  nand3  g35(.a(new_n61_), .b(new_n36_), .c(x08), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n46_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n53_), .O(z05));
  ...
  nand4  g43(.a(new_n61_), .b(new_n36_), .c(new_n77_), .d(x08), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x10), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n53_), .d(x04), .O(z06));
  nand2  g46(.a(x08), .b(x06), .O(new_n81_));
  nor2   g47(.a(x11), .b(x10), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n77_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n81_), .c(new_n36_), .O(new_n84_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n36_), .c(new_n86_), .d(new_n77_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x11), .c(new_n46_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n85_), .c(new_n53_), .O(z07));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(x12), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n86_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n67_), .c(new_n36_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x07), .O(new_n96_));
  nand4  g62(.a(new_n88_), .b(new_n73_), .c(new_n36_), .d(new_n92_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x12), .c(new_n46_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n53_), .O(z08));
  oai21  g65(.a(new_n52_), .b(new_n46_), .c(new_n38_), .O(new_n100_));
  nand2  g66(.a(new_n96_), .b(x13), .O(new_n101_));
  nor3   g67(.a(x17), .b(x13), .c(x12), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n82_), .c(new_n66_), .d(new_n61_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n101_), .c(new_n100_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nor2   g71(.a(x13), .b(x12), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n82_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n105_), .c(new_n52_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n77_), .c(x08), .d(x07), .O(new_n109_));
  nand2  g75(.a(new_n52_), .b(x14), .O(new_n110_));
  oai21  g76(.a(new_n109_), .b(new_n49_), .c(new_n110_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n38_), .O(z10));
  nor2   g79(.a(new_n37_), .b(new_n40_), .O(z11));
  ...
  nor2   g83(.a(new_n37_), .b(new_n46_), .O(z13));
  aoi21  g84(.a(new_n35_), .b(new_n46_), .c(new_n36_), .O(z14));
endmodule
