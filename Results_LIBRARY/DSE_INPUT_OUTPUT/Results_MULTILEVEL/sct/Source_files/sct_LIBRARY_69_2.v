...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(x14), .c(x06), .O(new_n58_));
  nand2  g24(.a(x08), .b(new_n47_), .O(new_n59_));
  ...
  nand2  g33(.a(x14), .b(x08), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(new_n67_), .c(x09), .O(new_n69_));
  ...
  nand3  g40(.a(x14), .b(new_n63_), .c(x08), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n67_), .c(x10), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n51_), .d(x04), .O(z06));
  oai21  g43(.a(new_n50_), .b(new_n44_), .c(new_n39_), .O(new_n78_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n71_), .c(x14), .d(new_n80_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n78_), .O(z07));
  inv1   g50(.a(x10), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n80_), .c(new_n85_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n64_), .c(x14), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  nand2  g55(.a(new_n83_), .b(x12), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n51_), .d(x04), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n86_), .c(new_n80_), .d(new_n85_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n64_), .c(x14), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand4  g61(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n96_));
  nand4  g62(.a(x14), .b(new_n86_), .c(new_n80_), .d(new_n85_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n96_), .c(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n95_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n93_), .b(new_n100_), .c(x09), .O(new_n101_));
  ...
  inv1   g72(.a(x02), .O(new_n107_));
  nand2  g73(.a(new_n39_), .b(new_n107_), .O(z11));
  oai21  g74(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n39_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n39_), .b(new_n44_), .O(z13));
  nand2  g78(.a(x17), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n39_), .O(z14));
endmodule
