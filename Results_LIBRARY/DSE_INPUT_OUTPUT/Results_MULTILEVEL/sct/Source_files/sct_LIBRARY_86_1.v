...
module FAU ( 
  ...
  oai21  g34(.a(x11), .b(new_n42_), .c(new_n36_), .O(new_n69_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n62_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n71_), .c(new_n48_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n69_), .O(z07));
  oai21  g43(.a(x12), .b(new_n42_), .c(new_n36_), .O(new_n78_));
  nand2  g44(.a(x08), .b(x07), .O(new_n79_));
  nand2  g45(.a(new_n73_), .b(new_n62_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n79_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n66_), .b(new_n72_), .c(new_n83_), .d(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n48_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n78_), .O(z08));
  ...
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g59(.a(x07), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n91_), .b(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n97_));
  ...
  oai21  g70(.a(new_n104_), .b(new_n42_), .c(new_n47_), .O(z12));
  nand2  g71(.a(new_n36_), .b(new_n42_), .O(z13));
