...
module FAU ( 
  ...
  nor2   g00(.a(x05), .b(x04), .O(new_n35_));
  ...
  nand2  g11(.a(x05), .b(new_n42_), .O(new_n46_));
  ...
  nand2  g32(.a(new_n66_), .b(new_n46_), .O(z05));
  ...
  nand3  g42(.a(new_n76_), .b(new_n72_), .c(new_n49_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n46_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n49_), .d(x04), .O(z08));
  nand2  g49(.a(new_n82_), .b(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n74_), .d(new_n73_), .O(new_n86_));
  ...
  nand2  g55(.a(new_n89_), .b(new_n46_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand2  g57(.a(new_n86_), .b(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n49_), .c(new_n63_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(x07), .c(x06), .O(new_n95_));
  or2    g61(.a(new_n49_), .b(new_n39_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n95_), .c(new_n42_), .O(z10));
  nand2  g63(.a(new_n55_), .b(new_n36_), .O(z11));
  aoi21  g64(.a(x16), .b(new_n36_), .c(x03), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n42_), .c(new_n55_), .O(z12));
