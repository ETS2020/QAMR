...
module FAU ( 
  ...
  nand2  g01(.a(x09), .b(x07), .O(new_n36_));
  ...
  nand3  g22(.a(new_n56_), .b(new_n50_), .c(x07), .O(new_n57_));
  oai21  g23(.a(new_n55_), .b(x07), .c(new_n57_), .O(new_n58_));
  ...
  oai21  g29(.a(new_n50_), .b(x07), .c(new_n63_), .O(z05));
  inv1   g30(.a(new_n47_), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n43_), .c(new_n36_), .O(new_n66_));
  inv1   g32(.a(x10), .O(new_n67_));
  nor2   g33(.a(new_n55_), .b(new_n46_), .O(new_n68_));
  inv1   g34(.a(x07), .O(new_n69_));
  nor2   g35(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n67_), .c(x08), .O(new_n71_));
  oai21  g37(.a(new_n68_), .b(new_n67_), .c(new_n71_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n50_), .O(new_n73_));
  nand2  g39(.a(x10), .b(new_n69_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(z06));
  nor2   g41(.a(x11), .b(x10), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n68_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n50_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x07), .O(new_n79_));
  nand4  g45(.a(new_n70_), .b(new_n67_), .c(new_n50_), .d(x08), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(x11), .c(new_n43_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n79_), .c(new_n47_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  aoi21  g49(.a(new_n76_), .b(new_n68_), .c(new_n83_), .O(new_n84_));
  inv1   g50(.a(new_n61_), .O(new_n85_));
  nor3   g51(.a(x12), .b(x11), .c(x10), .O(new_n86_));
  and2   g52(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n84_), .c(new_n50_), .O(new_n88_));
  nand2  g54(.a(x12), .b(new_n69_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n66_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  aoi21  g57(.a(new_n86_), .b(new_n68_), .c(new_n91_), .O(new_n92_));
  inv1   g58(.a(x11), .O(new_n93_));
  nand4  g59(.a(new_n91_), .b(new_n83_), .c(new_n93_), .d(new_n67_), .O(new_n94_));
  nor2   g60(.a(new_n94_), .b(new_n61_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n92_), .c(new_n50_), .O(new_n96_));
  nand2  g62(.a(x13), .b(new_n69_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n66_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n94_), .b(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n47_), .c(x08), .d(x07), .O(new_n101_));
