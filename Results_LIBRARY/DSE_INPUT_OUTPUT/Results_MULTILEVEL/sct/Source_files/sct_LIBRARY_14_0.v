...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n54_), .d(x04), .O(z06));
  ...
  oai21  g49(.a(new_n83_), .b(new_n41_), .c(new_n82_), .O(z07));
  ...
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n54_), .d(x04), .O(z08));
  ...
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n54_), .d(x04), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n92_), .b(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n54_), .c(new_n64_), .d(x08), .O(new_n97_));
  ...
  nand2  g67(.a(new_n57_), .b(new_n36_), .O(z11));
  nand2  g68(.a(x16), .b(new_n36_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n48_), .c(new_n41_), .O(z12));
