...
module FAU ( 
  ...
  aoi21  g30(.a(new_n64_), .b(x09), .c(new_n51_), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n39_), .c(new_n63_), .O(z05));
  nand2  g32(.a(new_n60_), .b(x08), .O(new_n67_));
  nand2  g33(.a(x07), .b(x06), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(new_n67_), .c(x10), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(x08), .c(x07), .d(x06), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n52_), .d(x04), .O(z06));
  nand2  g38(.a(x08), .b(x07), .O(new_n73_));
  nor2   g39(.a(x11), .b(x10), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n60_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n73_), .c(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  aoi21  g43(.a(new_n71_), .b(x11), .c(new_n51_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n39_), .c(new_n77_), .O(z07));
  inv1   g45(.a(x10), .O(new_n80_));
  nor2   g46(.a(x12), .b(x11), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n61_), .c(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  inv1   g50(.a(new_n64_), .O(new_n85_));
  nand3  g51(.a(new_n74_), .b(new_n85_), .c(new_n60_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(x12), .c(new_n51_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n39_), .c(new_n84_), .O(z08));
  nor2   g54(.a(x13), .b(x12), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n74_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n61_), .c(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x06), .O(new_n92_));
  nand3  g58(.a(new_n81_), .b(new_n70_), .c(new_n85_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x13), .c(new_n51_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n39_), .c(new_n92_), .O(z09));
  inv1   g61(.a(new_n36_), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  aoi21  g63(.a(new_n90_), .b(new_n97_), .c(new_n51_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n60_), .c(x08), .d(x07), .O(new_n99_));
  nand2  g65(.a(new_n51_), .b(x14), .O(new_n100_));
  oai21  g66(.a(new_n99_), .b(new_n40_), .c(new_n100_), .O(new_n101_));
  ...
  aoi21  g71(.a(new_n105_), .b(new_n45_), .c(new_n39_), .O(z12));
