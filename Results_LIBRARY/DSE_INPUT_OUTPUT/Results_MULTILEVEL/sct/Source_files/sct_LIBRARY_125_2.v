...
module FAU ( 
  ...
  nor2   g04(.a(x06), .b(new_n38_), .O(new_n39_));
  ...
  aoi21  g13(.a(new_n47_), .b(new_n38_), .c(x06), .O(z02));
  inv1   g14(.a(x06), .O(new_n49_));
  nand3  g15(.a(x07), .b(new_n49_), .c(new_n38_), .O(new_n50_));
  ...
  nand3  g20(.a(x08), .b(new_n49_), .c(new_n38_), .O(new_n55_));
  ...
  oai21  g24(.a(x09), .b(x01), .c(new_n49_), .O(new_n59_));
  ...
  oai21  g33(.a(x10), .b(x01), .c(new_n49_), .O(new_n68_));
  ...
  nand3  g41(.a(x10), .b(new_n49_), .c(new_n38_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(z06));
  oai21  g43(.a(x11), .b(x01), .c(new_n49_), .O(new_n78_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n78_), .d(new_n46_), .O(z07));
  oai21  g50(.a(x12), .b(x01), .c(new_n49_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  aoi21  g53(.a(new_n82_), .b(new_n60_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g58(.a(x12), .b(new_n49_), .c(new_n38_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n86_), .O(z08));
  oai21  g60(.a(x13), .b(x01), .c(new_n49_), .O(new_n95_));
  oai21  g61(.a(new_n90_), .b(new_n70_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n87_), .c(new_n89_), .d(new_n72_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n65_), .c(new_n43_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n95_), .d(new_n46_), .O(z09));
  ...
  nand3  g75(.a(new_n106_), .b(x14), .c(new_n38_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n43_), .O(z10));
  inv1   g77(.a(new_n39_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n35_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n35_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n43_), .c(new_n112_), .O(z12));
  nand2  g81(.a(new_n112_), .b(new_n43_), .O(z13));
