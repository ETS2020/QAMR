...
module FAU ( 
  ...
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n50_), .d(x04), .O(z06));
  nand2  g32(.a(new_n64_), .b(x11), .O(new_n67_));
  inv1   g33(.a(x11), .O(new_n68_));
  nand4  g34(.a(new_n57_), .b(new_n68_), .c(new_n63_), .d(new_n56_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n50_), .O(new_n70_));
