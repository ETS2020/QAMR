...
module FAU ( 
  ...
  inv1   g08(.a(new_n39_), .O(new_n43_));
  ...
  nand3  g20(.a(x13), .b(new_n54_), .c(x06), .O(new_n55_));
  ...
  nand3  g26(.a(x13), .b(x08), .c(new_n54_), .O(new_n61_));
  ...
  oai21  g30(.a(new_n64_), .b(new_n47_), .c(new_n39_), .O(z04));
  ...
  nand4  g35(.a(x13), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n47_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n51_), .O(z05));
  ...
  nand3  g43(.a(x13), .b(new_n66_), .c(x08), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n77_), .c(x10), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n51_), .d(x04), .O(z06));
  nand2  g46(.a(new_n51_), .b(x04), .O(new_n81_));
  ...
  nand4  g52(.a(new_n86_), .b(new_n73_), .c(x13), .d(new_n84_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n83_), .c(new_n82_), .O(z07));
  inv1   g54(.a(x10), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n84_), .c(new_n89_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n67_), .c(x13), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  nand2  g59(.a(new_n87_), .b(x12), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n93_), .c(new_n51_), .d(x04), .O(z08));
  nand3  g61(.a(new_n73_), .b(new_n90_), .c(new_n84_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n85_), .c(x13), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n82_), .O(z09));
  nand4  g64(.a(new_n51_), .b(new_n66_), .c(x08), .d(x07), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(new_n50_), .O(new_n100_));
  nor2   g66(.a(new_n51_), .b(new_n36_), .O(new_n101_));
  aoi21  g67(.a(new_n100_), .b(x00), .c(new_n101_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n47_), .c(new_n39_), .O(z10));
  ...
  nor2   g75(.a(new_n43_), .b(new_n47_), .O(z13));
  nand2  g76(.a(new_n39_), .b(x17), .O(new_n111_));
