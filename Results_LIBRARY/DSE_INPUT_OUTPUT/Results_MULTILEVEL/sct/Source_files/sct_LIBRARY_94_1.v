...
module FAU ( 
  ...
  oai21  g37(.a(x11), .b(new_n45_), .c(new_n36_), .O(new_n72_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n49_), .c(new_n62_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  inv1   g62(.a(x14), .O(new_n97_));
  or2    g63(.a(new_n49_), .b(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n96_), .c(new_n45_), .O(z10));
  nor2   g65(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n35_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n45_), .c(new_n48_), .O(z12));
  inv1   g68(.a(new_n43_), .O(z13));
