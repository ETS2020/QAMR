...
module FAU ( 
  ...
  oai21  g29(.a(x10), .b(new_n41_), .c(new_n35_), .O(new_n64_));
  ...
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n46_), .O(new_n69_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n72_), .c(new_n46_), .d(x04), .O(z07));
  ...
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n46_), .d(x04), .O(z08));
  nand2  g47(.a(new_n80_), .b(x13), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n74_), .d(new_n73_), .O(new_n84_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n46_), .c(new_n61_), .d(x08), .O(new_n90_));
  ...
  nor2   g63(.a(new_n97_), .b(new_n41_), .O(z12));
  nand2  g64(.a(x17), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n49_), .O(z14));
  buf    g66(.a(x04), .O(z13));
endmodule
