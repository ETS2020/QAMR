...
module FAU ( 
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n46_), .d(x04), .O(z08));
  nand3  g50(.a(new_n63_), .b(x08), .c(x07), .O(new_n85_));
  ...
  oai21  g56(.a(new_n90_), .b(new_n40_), .c(new_n89_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n87_), .b(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n46_), .c(new_n63_), .d(x08), .O(new_n94_));
  ...
  nand2  g64(.a(new_n49_), .b(new_n36_), .O(z11));
