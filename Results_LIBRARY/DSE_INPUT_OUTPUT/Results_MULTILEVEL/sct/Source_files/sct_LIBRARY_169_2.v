...
module FAU ( 
  ...
  oai21  g04(.a(x05), .b(x01), .c(new_n36_), .O(new_n39_));
  ...
  inv1   g14(.a(x01), .O(new_n49_));
  nor2   g15(.a(x04), .b(new_n49_), .O(new_n50_));
  ...
  nand2  g36(.a(new_n36_), .b(new_n49_), .O(new_n71_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n47_), .d(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  aoi21  g56(.a(new_n87_), .b(new_n90_), .c(new_n46_), .O(new_n91_));
  ...
  nor2   g62(.a(new_n50_), .b(new_n35_), .O(z11));
  nand2  g63(.a(x16), .b(new_n35_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n44_), .c(new_n36_), .O(z12));
