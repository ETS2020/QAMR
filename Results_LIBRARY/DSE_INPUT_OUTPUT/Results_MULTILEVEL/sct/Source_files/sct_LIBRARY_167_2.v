...
module FAU ( 
  ...
  nand4  g17(.a(new_n51_), .b(new_n47_), .c(x04), .d(new_n38_), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z02));
  nand3  g19(.a(x07), .b(new_n47_), .c(new_n38_), .O(new_n54_));
  ...
  oai21  g29(.a(x09), .b(x00), .c(new_n47_), .O(new_n64_));
  ...
  nand3  g36(.a(x09), .b(new_n47_), .c(new_n38_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z05));
  oai21  g38(.a(x10), .b(x00), .c(new_n47_), .O(new_n73_));
  ...
  oai21  g44(.a(x11), .b(x00), .c(new_n47_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(new_n67_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x11), .O(new_n81_));
  nand2  g47(.a(new_n67_), .b(x06), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n66_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(new_n44_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n81_), .c(new_n79_), .d(new_n51_), .O(z07));
  oai21  g54(.a(x12), .b(x00), .c(new_n47_), .O(new_n89_));
  inv1   g55(.a(new_n67_), .O(new_n90_));
  oai21  g56(.a(new_n85_), .b(new_n90_), .c(x12), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  nand3  g58(.a(new_n75_), .b(new_n92_), .c(new_n84_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  nor2   g60(.a(new_n94_), .b(new_n44_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n91_), .c(new_n89_), .d(new_n51_), .O(z08));
  oai21  g62(.a(x13), .b(x00), .c(new_n47_), .O(new_n97_));
  nand3  g63(.a(new_n92_), .b(new_n84_), .c(new_n83_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n68_), .c(x13), .O(new_n99_));
  nand4  g65(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n100_));
  inv1   g66(.a(x13), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n92_), .c(new_n84_), .d(new_n83_), .O(new_n102_));
  nor2   g68(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n44_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n99_), .c(new_n97_), .d(new_n51_), .O(z09));
  inv1   g71(.a(x07), .O(new_n106_));
  nand2  g72(.a(new_n83_), .b(x06), .O(new_n107_));
  nand3  g73(.a(new_n101_), .b(new_n92_), .c(new_n84_), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n107_), .c(new_n38_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n51_), .c(new_n66_), .d(x08), .O(new_n110_));
  ...
  nand2  g79(.a(new_n113_), .b(new_n58_), .O(z10));
  nand2  g80(.a(new_n58_), .b(new_n35_), .O(z11));
  oai21  g81(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n58_), .c(x04), .O(new_n117_));
  inv1   g83(.a(new_n117_), .O(z12));
  nor2   g84(.a(new_n39_), .b(new_n44_), .O(z13));
  nand2  g85(.a(x17), .b(x04), .O(new_n120_));
  nand2  g86(.a(new_n120_), .b(new_n58_), .O(z14));
endmodule
