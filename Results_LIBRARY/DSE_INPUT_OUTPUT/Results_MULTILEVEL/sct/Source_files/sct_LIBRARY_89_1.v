...
module FAU ( 
  ...
  nand3  g16(.a(x07), .b(new_n43_), .c(x04), .O(new_n51_));
  oai21  g17(.a(x07), .b(new_n43_), .c(new_n51_), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n37_), .O(z03));
  xnor2a g20(.a(x08), .b(x07), .O(new_n55_));
  nand2  g21(.a(x08), .b(new_n43_), .O(new_n56_));
  oai21  g22(.a(new_n55_), .b(new_n43_), .c(new_n56_), .O(new_n57_));
  ...
  nand2  g32(.a(new_n66_), .b(new_n43_), .O(new_n67_));
  ...
  nand2  g39(.a(new_n73_), .b(new_n67_), .O(z06));
  nand2  g40(.a(new_n71_), .b(x11), .O(new_n75_));
  inv1   g41(.a(new_n60_), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n62_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n48_), .d(x04), .O(z07));
  oai21  g45(.a(x12), .b(new_n36_), .c(new_n43_), .O(new_n80_));
  nand2  g46(.a(x08), .b(x07), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(new_n62_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n81_), .c(x12), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n70_), .b(new_n76_), .c(new_n85_), .d(new_n84_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n83_), .c(new_n48_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n80_), .O(z08));
  oai21  g55(.a(x13), .b(new_n36_), .c(new_n43_), .O(new_n90_));
  nand3  g56(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n68_), .c(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  inv1   g59(.a(new_n63_), .O(new_n94_));
  nand4  g60(.a(new_n77_), .b(new_n94_), .c(new_n93_), .d(new_n85_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n92_), .c(new_n48_), .O(new_n96_));
  ...
  nand3  g66(.a(new_n93_), .b(new_n85_), .c(new_n84_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n66_), .c(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n99_), .c(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(x06), .O(new_n105_));
  inv1   g71(.a(new_n48_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(x14), .c(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n105_), .O(z10));
  nand2  g74(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g75(.a(x16), .b(new_n38_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n36_), .c(new_n37_), .O(z12));
