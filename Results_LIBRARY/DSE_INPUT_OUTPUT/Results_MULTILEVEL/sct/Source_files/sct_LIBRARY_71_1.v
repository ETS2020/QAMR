...
module FAU ( 
  ...
  nand4  g33(.a(new_n67_), .b(new_n64_), .c(new_n49_), .d(x04), .O(z05));
  oai21  g34(.a(x10), .b(x09), .c(new_n56_), .O(new_n69_));
  nand3  g35(.a(new_n36_), .b(x08), .c(x07), .O(new_n70_));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n66_), .c(new_n43_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n69_), .d(new_n49_), .O(z06));
  oai21  g42(.a(x11), .b(x09), .c(new_n56_), .O(new_n77_));
  ...
  oai22  g47(.a(new_n81_), .b(new_n65_), .c(new_n79_), .d(x06), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n36_), .O(new_n83_));
  nand2  g49(.a(new_n72_), .b(new_n62_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(x11), .c(x06), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(new_n78_), .O(z07));
  oai21  g52(.a(x12), .b(x09), .c(new_n56_), .O(new_n87_));
  nand3  g53(.a(new_n80_), .b(new_n62_), .c(new_n36_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n72_), .b(new_n90_), .c(new_n79_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(new_n63_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n43_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n87_), .d(new_n49_), .O(z08));
  oai21  g60(.a(x13), .b(x09), .c(new_n56_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n50_), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand3  g63(.a(new_n80_), .b(new_n97_), .c(new_n90_), .O(new_n98_));
  oai22  g64(.a(new_n98_), .b(new_n63_), .c(new_n97_), .d(x06), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n36_), .O(new_n100_));
  inv1   g66(.a(new_n70_), .O(new_n101_));
  nor3   g67(.a(x12), .b(x11), .c(x10), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x13), .c(x06), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n100_), .c(new_n96_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  aoi21  g72(.a(new_n98_), .b(new_n106_), .c(new_n48_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n36_), .c(x08), .d(x07), .O(new_n108_));
  ...
  nand2  g77(.a(new_n111_), .b(new_n52_), .O(z10));
  nor2   g78(.a(new_n37_), .b(new_n35_), .O(z11));
  oai21  g79(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n52_), .c(x04), .O(new_n115_));
  inv1   g81(.a(new_n115_), .O(z12));
  nor2   g82(.a(new_n37_), .b(new_n43_), .O(z13));
  inv1   g83(.a(x17), .O(new_n118_));
  nor3   g84(.a(new_n37_), .b(new_n118_), .c(new_n43_), .O(z14));
endmodule
