...
module FAU ( 
  ...
  nand3  g09(.a(x07), .b(x05), .c(new_n43_), .O(new_n44_));
  ...
  oai21  g28(.a(x09), .b(x05), .c(new_n62_), .O(new_n63_));
  oai21  g29(.a(new_n50_), .b(new_n43_), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g36(.a(x09), .b(new_n62_), .c(new_n35_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z05));
  oai21  g38(.a(x10), .b(x05), .c(new_n62_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n73_), .d(new_n51_), .O(z06));
  oai21  g44(.a(x11), .b(x05), .c(new_n62_), .O(new_n79_));
  inv1   g45(.a(new_n75_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n65_), .c(x11), .O(new_n81_));
  ...
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n79_), .d(new_n51_), .O(z07));
  oai21  g52(.a(x12), .b(x05), .c(new_n62_), .O(new_n87_));
  inv1   g53(.a(new_n84_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n65_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand3  g57(.a(new_n75_), .b(new_n91_), .c(new_n90_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n83_), .c(new_n43_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n89_), .c(new_n87_), .d(new_n51_), .O(z08));
  oai21  g61(.a(x13), .b(x05), .c(new_n62_), .O(new_n96_));
  ...
  nand4  g65(.a(new_n67_), .b(x08), .c(x07), .d(x06), .O(new_n100_));
  ...
  nor2   g69(.a(new_n103_), .b(new_n43_), .O(new_n104_));
  ...
  oai21  g80(.a(new_n114_), .b(new_n43_), .c(new_n47_), .O(z12));
