...
module FAU ( 
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n76_), .d(new_n64_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n75_), .c(new_n48_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n73_), .O(z07));
  nand2  g49(.a(new_n80_), .b(x12), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n79_), .b(new_n70_), .c(new_n85_), .d(new_n77_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n48_), .d(x04), .O(z08));
  nand2  g53(.a(new_n86_), .b(x13), .O(new_n88_));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n85_), .c(new_n77_), .d(new_n76_), .O(new_n90_));
  or2    g56(.a(new_n90_), .b(new_n65_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n90_), .b(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n62_), .c(x04), .O(new_n96_));
  ...
  nand2  g66(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n38_), .c(x03), .O(new_n102_));
  nor2   g68(.a(new_n102_), .b(new_n36_), .O(z12));
