...
module FAU ( 
  ...
  nor2   g25(.a(x12), .b(x06), .O(new_n60_));
  nand3  g26(.a(new_n60_), .b(new_n47_), .c(x04), .O(z08));
  inv1   g27(.a(x03), .O(new_n62_));
  inv1   g28(.a(x16), .O(new_n63_));
  aoi21  g29(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(x13), .c(new_n46_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(z09));
  nand3  g32(.a(new_n64_), .b(x14), .c(new_n46_), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n43_), .O(z10));
  nand2  g34(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g35(.a(new_n63_), .b(x02), .c(new_n62_), .O(new_n70_));
