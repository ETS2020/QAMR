...
module FAU ( 
  ...
  nand4  g32(.a(new_n66_), .b(new_n64_), .c(new_n46_), .d(x04), .O(z06));
  ...
  inv1   g38(.a(new_n46_), .O(new_n73_));
  aoi21  g39(.a(new_n66_), .b(x11), .c(new_n73_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n40_), .c(new_n72_), .O(z07));
  nand3  g41(.a(new_n61_), .b(x08), .c(x07), .O(new_n76_));
  ...
  nand3  g48(.a(new_n69_), .b(new_n82_), .c(new_n61_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(x12), .c(new_n73_), .O(new_n84_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n77_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n76_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand3  g57(.a(new_n78_), .b(new_n65_), .c(new_n82_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x13), .c(new_n73_), .O(new_n93_));
  ...
  nand2  g67(.a(new_n52_), .b(new_n36_), .O(z11));
