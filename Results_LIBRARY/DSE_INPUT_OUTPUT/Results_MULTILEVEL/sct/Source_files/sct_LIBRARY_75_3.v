...
module FAU ( 
  ...
  nand4  g34(.a(new_n68_), .b(new_n65_), .c(new_n51_), .d(x04), .O(z05));
  ...
  nand4  g39(.a(new_n66_), .b(new_n36_), .c(new_n62_), .d(x08), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x10), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n51_), .d(x04), .O(z06));
  oai21  g42(.a(new_n50_), .b(new_n44_), .c(new_n47_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n70_), .c(new_n36_), .d(new_n79_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(new_n77_), .O(z07));
  inv1   g49(.a(x10), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n79_), .c(new_n84_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n63_), .c(new_n36_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x06), .O(new_n88_));
  nand2  g54(.a(new_n82_), .b(x12), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n51_), .d(x04), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n85_), .c(new_n79_), .d(new_n84_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n63_), .c(new_n36_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x06), .O(new_n94_));
  nand3  g60(.a(new_n66_), .b(new_n62_), .c(x08), .O(new_n95_));
  nand4  g61(.a(new_n36_), .b(new_n85_), .c(new_n79_), .d(new_n84_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n95_), .c(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n94_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  aoi21  g65(.a(new_n92_), .b(new_n99_), .c(new_n50_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n62_), .c(x08), .d(x07), .O(new_n101_));
  nand2  g67(.a(new_n50_), .b(x14), .O(new_n102_));
  ...
  nand2  g71(.a(new_n47_), .b(new_n38_), .O(z11));
  ...
  nor2   g75(.a(new_n37_), .b(new_n44_), .O(z13));
