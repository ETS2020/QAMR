...
module FAU ( 
  ...
  aoi21  g23(.a(x08), .b(x07), .c(new_n58_), .O(new_n59_));
  nand3  g24(.a(new_n58_), .b(x08), .c(x07), .O(new_n60_));
  nand2  g25(.a(new_n60_), .b(new_n52_), .O(new_n61_));
  ...
  nand3  g31(.a(new_n66_), .b(new_n64_), .c(new_n52_), .O(new_n67_));
  ...
  nand4  g36(.a(new_n71_), .b(new_n58_), .c(x08), .d(x07), .O(new_n72_));
  nand3  g37(.a(new_n72_), .b(new_n70_), .c(new_n52_), .O(new_n73_));
  ...
  nor2   g42(.a(x12), .b(x11), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n77_), .c(new_n65_), .O(new_n79_));
  nand3  g44(.a(new_n79_), .b(new_n76_), .c(new_n52_), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(x06), .O(new_n81_));
  nand2  g46(.a(new_n81_), .b(x04), .O(z08));
  nand2  g47(.a(new_n78_), .b(new_n65_), .O(new_n83_));
  oai21  g48(.a(new_n83_), .b(new_n60_), .c(x13), .O(new_n84_));
  nor2   g49(.a(x13), .b(x12), .O(new_n85_));
  nand3  g50(.a(new_n85_), .b(new_n71_), .c(new_n77_), .O(new_n86_));
  nand3  g51(.a(new_n86_), .b(new_n84_), .c(new_n52_), .O(new_n87_));
  nand2  g52(.a(new_n87_), .b(x06), .O(new_n88_));
  nand2  g53(.a(new_n88_), .b(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n90_));
  nand2  g55(.a(new_n85_), .b(new_n71_), .O(new_n91_));
  aoi21  g56(.a(new_n91_), .b(new_n90_), .c(new_n51_), .O(new_n92_));
  nand4  g57(.a(new_n92_), .b(new_n58_), .c(x08), .d(x07), .O(new_n93_));
  ...
  oai21  g61(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n97_));
