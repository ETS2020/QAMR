...
module FAU ( 
  ...
  aoi21  g46(.a(new_n74_), .b(x11), .c(new_n57_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n41_), .c(new_n80_), .O(z07));
  nand3  g48(.a(new_n69_), .b(x08), .c(x07), .O(new_n83_));
  ...
  nand3  g55(.a(new_n77_), .b(new_n89_), .c(new_n69_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x12), .c(new_n57_), .O(new_n91_));
  ...
  oai21  g60(.a(new_n94_), .b(new_n83_), .c(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand3  g62(.a(new_n85_), .b(new_n73_), .c(new_n89_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x13), .c(new_n57_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n41_), .c(new_n96_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n94_), .b(new_n100_), .c(new_n57_), .O(new_n101_));
  ...
  nand2  g71(.a(new_n105_), .b(new_n53_), .O(z10));
  nand2  g72(.a(new_n53_), .b(new_n36_), .O(z11));
  nand2  g73(.a(x16), .b(new_n36_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n48_), .c(new_n41_), .O(z12));
