...
module FAU ( 
  ...
  aoi21  g33(.a(new_n67_), .b(x09), .c(new_n48_), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(new_n36_), .c(new_n65_), .O(z05));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n66_), .c(new_n36_), .O(new_n71_));
  nand4  g37(.a(new_n62_), .b(x08), .c(x07), .d(x06), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(x10), .c(new_n48_), .O(new_n73_));
  oai22  g39(.a(new_n73_), .b(new_n36_), .c(new_n71_), .d(new_n37_), .O(z06));
  nor3   g40(.a(x11), .b(x10), .c(x09), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n66_), .c(new_n36_), .O(new_n76_));
  nand4  g42(.a(new_n70_), .b(x08), .c(x07), .d(x06), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(x11), .c(new_n48_), .O(new_n78_));
  oai22  g44(.a(new_n78_), .b(new_n36_), .c(new_n76_), .d(new_n37_), .O(z07));
  ...
  aoi21  g60(.a(new_n94_), .b(x13), .c(new_n48_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n36_), .c(new_n93_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  aoi21  g63(.a(new_n91_), .b(new_n97_), .c(new_n48_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n62_), .c(x08), .d(x07), .O(new_n99_));
  ...
  aoi21  g71(.a(new_n105_), .b(new_n46_), .c(new_n36_), .O(z12));
  nand2  g72(.a(x06), .b(new_n36_), .O(z13));
