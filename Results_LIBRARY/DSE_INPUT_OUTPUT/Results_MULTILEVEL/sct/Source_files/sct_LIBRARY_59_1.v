...
module FAU ( 
  ...
  nand3  g16(.a(x07), .b(new_n47_), .c(x04), .O(new_n51_));
  oai21  g17(.a(x07), .b(new_n47_), .c(new_n51_), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n39_), .O(z03));
  xnor2a g20(.a(x08), .b(x07), .O(new_n55_));
  nand3  g21(.a(x08), .b(new_n47_), .c(x04), .O(new_n56_));
  ...
  oai21  g30(.a(x10), .b(new_n38_), .c(new_n47_), .O(new_n65_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n62_), .O(new_n77_));
  ...
  oai21  g48(.a(x13), .b(new_n38_), .c(new_n47_), .O(new_n83_));
  nand3  g49(.a(new_n80_), .b(new_n75_), .c(new_n74_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n66_), .c(x13), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n87_));
  or2    g53(.a(new_n87_), .b(new_n63_), .O(new_n88_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  or2    g62(.a(new_n48_), .b(new_n36_), .O(new_n97_));
  ...
  oai21  g66(.a(new_n100_), .b(new_n38_), .c(new_n39_), .O(z12));
  nand2  g67(.a(new_n47_), .b(new_n38_), .O(z13));
