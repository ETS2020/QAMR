...
module FAU ( 
  ...
  aoi21  g22(.a(x08), .b(x07), .c(new_n57_), .O(new_n58_));
  nand3  g23(.a(new_n57_), .b(x08), .c(x07), .O(new_n59_));
  nand2  g24(.a(new_n59_), .b(new_n51_), .O(new_n60_));
  ...
  nand4  g29(.a(new_n64_), .b(new_n57_), .c(x08), .d(x07), .O(new_n65_));
  ...
  nand4  g35(.a(new_n70_), .b(new_n57_), .c(x08), .d(x07), .O(new_n71_));
  nand3  g36(.a(new_n71_), .b(new_n69_), .c(new_n51_), .O(new_n72_));
  nand2  g37(.a(new_n72_), .b(x06), .O(new_n73_));
  nand2  g38(.a(new_n73_), .b(x04), .O(z07));
  nand2  g39(.a(new_n71_), .b(x12), .O(new_n75_));
  inv1   g40(.a(new_n59_), .O(new_n76_));
  nor2   g41(.a(x12), .b(x11), .O(new_n77_));
  nand3  g42(.a(new_n77_), .b(new_n76_), .c(new_n64_), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n75_), .c(new_n51_), .O(new_n79_));
  nand2  g44(.a(new_n79_), .b(x06), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(x04), .O(z08));
  nand2  g46(.a(new_n77_), .b(new_n64_), .O(new_n82_));
  oai21  g47(.a(new_n82_), .b(new_n59_), .c(x13), .O(new_n83_));
  nor2   g48(.a(x13), .b(x12), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(new_n70_), .c(new_n76_), .O(new_n85_));
  nand3  g50(.a(new_n85_), .b(new_n83_), .c(new_n51_), .O(new_n86_));
  nand2  g51(.a(new_n86_), .b(x06), .O(new_n87_));
  nand2  g52(.a(new_n87_), .b(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n89_));
  nand2  g54(.a(new_n84_), .b(new_n70_), .O(new_n90_));
  aoi21  g55(.a(new_n90_), .b(new_n89_), .c(new_n50_), .O(new_n91_));
  nand4  g56(.a(new_n91_), .b(new_n57_), .c(x08), .d(x07), .O(new_n92_));
  aoi21  g57(.a(new_n50_), .b(x14), .c(new_n35_), .O(new_n93_));
  aoi21  g58(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z10));
  aoi21  g59(.a(new_n35_), .b(x04), .c(new_n36_), .O(z11));
  oai21  g60(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n96_));
  nand3  g61(.a(new_n96_), .b(x06), .c(x04), .O(new_n97_));
  inv1   g62(.a(new_n97_), .O(z12));
  nor2   g63(.a(new_n35_), .b(new_n43_), .O(z13));
  inv1   g64(.a(x17), .O(new_n100_));
  aoi21  g65(.a(new_n100_), .b(x06), .c(new_n43_), .O(z14));
  zero   g66(.O(z02));
endmodule
