...
module FAU ( 
  ...
  aoi21  g10(.a(x06), .b(new_n41_), .c(new_n44_), .O(new_n45_));
  ...
  nand4  g33(.a(new_n68_), .b(new_n64_), .c(new_n51_), .d(x04), .O(z06));
  ...
  nand4  g38(.a(new_n73_), .b(new_n70_), .c(new_n51_), .d(x04), .O(z07));
  nand2  g39(.a(new_n72_), .b(x12), .O(new_n75_));
  inv1   g40(.a(x12), .O(new_n76_));
  nand3  g41(.a(new_n76_), .b(new_n71_), .c(new_n65_), .O(new_n77_));
  nor2   g42(.a(new_n77_), .b(new_n60_), .O(new_n78_));
  nor2   g43(.a(new_n78_), .b(new_n36_), .O(new_n79_));
  nand4  g44(.a(new_n79_), .b(new_n75_), .c(new_n51_), .d(x04), .O(z08));
  oai21  g45(.a(new_n77_), .b(new_n60_), .c(x13), .O(new_n81_));
  inv1   g46(.a(x13), .O(new_n82_));
  nand4  g47(.a(new_n82_), .b(new_n76_), .c(new_n71_), .d(new_n65_), .O(new_n83_));
  inv1   g48(.a(new_n83_), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(new_n61_), .O(new_n85_));
  nand3  g50(.a(new_n85_), .b(new_n81_), .c(new_n51_), .O(new_n86_));
  nand2  g51(.a(new_n86_), .b(x06), .O(new_n87_));
  nand2  g52(.a(new_n87_), .b(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n89_));
  nand2  g54(.a(new_n83_), .b(new_n89_), .O(new_n90_));
  nand4  g55(.a(new_n90_), .b(new_n51_), .c(new_n59_), .d(x08), .O(new_n91_));
  ...
  nor2   g65(.a(new_n36_), .b(new_n44_), .O(z13));
  inv1   g66(.a(x17), .O(new_n102_));
  aoi21  g67(.a(new_n102_), .b(x06), .c(new_n44_), .O(z14));
  zero   g68(.O(z02));
endmodule
