...
module FAU ( 
  ...
  nand2  g23(.a(x08), .b(new_n39_), .O(new_n58_));
  oai21  g24(.a(new_n57_), .b(new_n39_), .c(new_n58_), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(new_n50_), .c(x04), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n53_), .O(z04));
  oai21  g27(.a(x09), .b(x06), .c(x01), .O(new_n62_));
  ...
  oai21  g36(.a(new_n49_), .b(new_n44_), .c(new_n53_), .O(new_n71_));
  ...
  aoi21  g46(.a(new_n74_), .b(new_n63_), .c(new_n80_), .O(new_n81_));
  inv1   g47(.a(new_n64_), .O(new_n82_));
  nor3   g48(.a(x11), .b(x10), .c(x09), .O(new_n83_));
  and2   g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n81_), .c(new_n38_), .O(new_n85_));
  nand2  g51(.a(x11), .b(new_n39_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n71_), .O(z07));
  inv1   g53(.a(x12), .O(new_n88_));
  aoi21  g54(.a(new_n83_), .b(new_n63_), .c(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n74_), .b(new_n88_), .c(new_n80_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n64_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n89_), .c(new_n38_), .O(new_n92_));
  nand2  g58(.a(x12), .b(new_n39_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n71_), .O(z08));
  oai21  g60(.a(x13), .b(x06), .c(x01), .O(new_n95_));
  oai21  g61(.a(new_n90_), .b(new_n64_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x10), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n88_), .c(new_n80_), .d(new_n97_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n68_), .c(new_n44_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n96_), .c(new_n95_), .d(new_n50_), .O(z09));
  ...
  oai21  g72(.a(new_n105_), .b(new_n39_), .c(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n38_), .O(new_n108_));
  nand3  g74(.a(new_n49_), .b(x14), .c(new_n39_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n44_), .O(z10));
  nand2  g76(.a(new_n53_), .b(new_n35_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n35_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n44_), .c(new_n53_), .O(z12));
  nand2  g79(.a(new_n53_), .b(new_n44_), .O(z13));
