...
module FAU ( 
  ...
  nand3  g20(.a(x13), .b(x08), .c(new_n53_), .O(new_n55_));
  ...
  nand3  g33(.a(x13), .b(x09), .c(new_n53_), .O(new_n68_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n71_), .c(new_n70_), .d(new_n46_), .O(z06));
  oai21  g44(.a(new_n59_), .b(x11), .c(new_n53_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n47_), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  aoi21  g47(.a(new_n74_), .b(new_n64_), .c(new_n81_), .O(new_n82_));
  nor3   g48(.a(x11), .b(x10), .c(x09), .O(new_n83_));
  and2   g49(.a(new_n83_), .b(new_n64_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n82_), .c(x06), .O(new_n85_));
  nand3  g51(.a(x13), .b(x11), .c(new_n53_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n80_), .O(z07));
  oai21  g53(.a(new_n59_), .b(x12), .c(new_n53_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nor2   g56(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  nor4   g57(.a(new_n65_), .b(x12), .c(x11), .d(x10), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n91_), .c(x06), .O(new_n93_));
  nand3  g59(.a(x13), .b(x12), .c(new_n53_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n89_), .O(z08));
  nand2  g61(.a(new_n47_), .b(new_n49_), .O(new_n96_));
  nand2  g62(.a(new_n64_), .b(x06), .O(new_n97_));
  nand3  g63(.a(new_n74_), .b(new_n90_), .c(new_n81_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n97_), .c(x13), .O(new_n99_));
  inv1   g65(.a(x10), .O(new_n100_));
  nand4  g66(.a(new_n59_), .b(new_n90_), .c(new_n81_), .d(new_n100_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n73_), .c(new_n62_), .d(x08), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n99_), .c(new_n96_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nand2  g71(.a(new_n101_), .b(new_n105_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n46_), .c(new_n62_), .d(x08), .O(new_n107_));
  inv1   g73(.a(new_n46_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x14), .O(new_n109_));
  oai21  g75(.a(new_n107_), .b(new_n72_), .c(new_n109_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x06), .O(new_n111_));
  nand3  g77(.a(new_n108_), .b(x14), .c(x13), .O(new_n112_));
  ...
  oai21  g81(.a(new_n115_), .b(new_n43_), .c(new_n49_), .O(z12));
  nand2  g82(.a(new_n49_), .b(new_n43_), .O(z13));
  nand2  g83(.a(x17), .b(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n49_), .O(z14));
endmodule
