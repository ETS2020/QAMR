...
module FAU ( 
  ...
  aoi21  g21(.a(x08), .b(x07), .c(new_n55_), .O(new_n56_));
  ...
  nand4  g28(.a(new_n62_), .b(new_n55_), .c(x08), .d(x07), .O(new_n63_));
  ...
  nand4  g33(.a(new_n67_), .b(new_n55_), .c(x08), .d(x07), .O(new_n68_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n72_), .c(new_n49_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(z08));
  nand2  g44(.a(new_n74_), .b(new_n62_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n57_), .c(x13), .O(new_n80_));
  nor2   g46(.a(x13), .b(x12), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n67_), .c(new_n73_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n49_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n81_), .b(new_n67_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n86_), .c(new_n48_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n55_), .c(x08), .d(x07), .O(new_n89_));
  inv1   g55(.a(x06), .O(new_n90_));
  aoi21  g56(.a(new_n48_), .b(x14), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n89_), .c(new_n36_), .O(z10));
  nor2   g58(.a(z02), .b(new_n35_), .O(z11));
  oai21  g59(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(x06), .c(x04), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(z12));
  nor2   g62(.a(new_n90_), .b(new_n36_), .O(z13));
