...
module FAU ( 
  ...
  nand4  g47(.a(new_n81_), .b(new_n80_), .c(new_n67_), .d(new_n61_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n74_), .c(new_n73_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n79_), .c(new_n47_), .d(x04), .O(z09));
  ...
  nor2   g64(.a(new_n73_), .b(new_n36_), .O(z13));
  inv1   g65(.a(x17), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(x06), .c(new_n36_), .O(z14));
endmodule
