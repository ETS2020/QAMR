...
module FAU ( 
  ...
  nand2  g33(.a(new_n64_), .b(new_n57_), .O(new_n68_));
  ...
  oai21  g41(.a(x12), .b(new_n36_), .c(new_n45_), .O(new_n76_));
  nand3  g42(.a(new_n71_), .b(new_n57_), .c(new_n60_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x12), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n64_), .b(new_n70_), .c(new_n80_), .d(new_n79_), .O(new_n81_));
  ...
  oai21  g50(.a(x13), .b(new_n36_), .c(new_n45_), .O(new_n85_));
  nand3  g51(.a(new_n60_), .b(x08), .c(x07), .O(new_n86_));
  ...
  inv1   g56(.a(new_n61_), .O(new_n91_));
  nand4  g57(.a(new_n71_), .b(new_n91_), .c(new_n90_), .d(new_n80_), .O(new_n92_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n46_), .c(new_n60_), .d(x08), .O(new_n101_));
  ...
  aoi21  g72(.a(x06), .b(new_n36_), .c(new_n38_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n38_), .c(x03), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n36_), .O(z12));
