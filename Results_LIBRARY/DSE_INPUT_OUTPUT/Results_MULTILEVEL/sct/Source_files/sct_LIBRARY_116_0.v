...
module FAU ( 
  ...
  aoi21  g19(.a(new_n46_), .b(x02), .c(new_n48_), .O(new_n54_));
  ...
  aoi21  g40(.a(new_n74_), .b(x10), .c(new_n54_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n36_), .c(new_n73_), .O(z06));
  ...
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n55_), .d(x04), .O(z07));
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n55_), .d(x04), .O(z08));
  ...
  oai21  g69(.a(new_n103_), .b(new_n36_), .c(new_n38_), .O(z12));
  nand2  g70(.a(x06), .b(new_n36_), .O(z13));
