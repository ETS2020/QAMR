...
module FAU ( 
  ...
  nand3  g02(.a(new_n36_), .b(x11), .c(new_n35_), .O(new_n37_));
  oai21  g03(.a(x02), .b(new_n35_), .c(new_n37_), .O(z00));
  inv1   g04(.a(x18), .O(new_n39_));
  nor2   g05(.a(new_n39_), .b(x15), .O(new_n40_));
  inv1   g06(.a(x04), .O(new_n41_));
  nor2   g07(.a(x11), .b(x01), .O(new_n42_));
  ...
  nand4  g22(.a(new_n56_), .b(new_n48_), .c(new_n45_), .d(x04), .O(new_n57_));
  ...
  and2   g28(.a(new_n62_), .b(new_n45_), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n60_), .c(new_n48_), .d(x04), .O(z05));
  nor2   g30(.a(x10), .b(x09), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n45_), .c(x04), .O(new_n67_));
  aoi21  g33(.a(new_n62_), .b(x10), .c(new_n67_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n48_), .O(z06));
  inv1   g35(.a(x11), .O(new_n70_));
  nand2  g36(.a(new_n66_), .b(x01), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  aoi21  g38(.a(new_n66_), .b(x11), .c(new_n41_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n48_), .O(z07));
  oai21  g40(.a(x12), .b(new_n70_), .c(new_n35_), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand3  g42(.a(new_n70_), .b(new_n76_), .c(new_n61_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n59_), .c(x12), .O(new_n78_));
  inv1   g44(.a(new_n59_), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nand3  g46(.a(new_n65_), .b(new_n80_), .c(new_n70_), .O(new_n81_));
  inv1   g47(.a(new_n81_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n79_), .c(new_n41_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n78_), .c(new_n75_), .d(new_n48_), .O(z08));
  inv1   g50(.a(x03), .O(new_n85_));
  inv1   g51(.a(x16), .O(new_n86_));
  aoi21  g52(.a(new_n85_), .b(x02), .c(new_n86_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n41_), .c(new_n45_), .O(new_n88_));
  inv1   g54(.a(x13), .O(new_n89_));
  nor3   g55(.a(x12), .b(x10), .c(x09), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n79_), .c(new_n89_), .O(new_n91_));
  nand4  g57(.a(new_n89_), .b(new_n80_), .c(new_n70_), .d(new_n76_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n62_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n91_), .c(x01), .O(new_n94_));
  ...
  oai22  g65(.a(new_n99_), .b(new_n97_), .c(new_n48_), .d(new_n36_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n45_), .O(new_n101_));
  nand4  g67(.a(new_n48_), .b(new_n89_), .c(new_n80_), .d(new_n70_), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n76_), .c(new_n61_), .d(x08), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x07), .c(x06), .d(x01), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n101_), .c(new_n41_), .O(z10));
  nand2  g73(.a(new_n45_), .b(new_n47_), .O(z11));
  oai21  g74(.a(new_n86_), .b(x02), .c(new_n85_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n45_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n45_), .b(new_n41_), .O(z13));
