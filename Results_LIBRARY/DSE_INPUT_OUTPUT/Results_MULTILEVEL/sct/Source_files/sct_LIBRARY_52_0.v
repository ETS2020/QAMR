...
module FAU ( 
  ...
  or2    g52(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  aoi21  g55(.a(new_n86_), .b(new_n89_), .c(new_n48_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n64_), .c(x08), .d(x07), .O(new_n91_));
