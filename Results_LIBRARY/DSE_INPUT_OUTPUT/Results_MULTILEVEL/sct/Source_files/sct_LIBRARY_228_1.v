...
module FAU ( 
  ...
  nand3  g22(.a(new_n56_), .b(x08), .c(x04), .O(new_n57_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n72_), .c(new_n50_), .d(x04), .O(z07));
  oai21  g42(.a(x12), .b(new_n38_), .c(new_n45_), .O(new_n77_));
  nand2  g43(.a(x08), .b(x07), .O(new_n78_));
  nand2  g44(.a(new_n74_), .b(new_n65_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n78_), .c(x12), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n69_), .b(new_n73_), .c(new_n82_), .d(new_n81_), .O(new_n83_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n82_), .c(new_n81_), .d(new_n88_), .O(new_n90_));
  or2    g56(.a(new_n90_), .b(new_n66_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n50_), .d(x04), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n90_), .b(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n50_), .c(new_n65_), .d(x08), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(x07), .c(x06), .O(new_n97_));
  or2    g63(.a(new_n50_), .b(new_n36_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n38_), .O(z10));
  nand2  g65(.a(new_n39_), .b(new_n40_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n40_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n38_), .c(new_n39_), .O(z12));
