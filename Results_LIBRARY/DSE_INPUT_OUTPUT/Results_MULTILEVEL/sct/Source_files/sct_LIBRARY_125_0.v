...
module FAU ( 
  ...
  aoi21  g14(.a(new_n48_), .b(x01), .c(x06), .O(z02));
  inv1   g15(.a(x06), .O(new_n50_));
  nand3  g16(.a(x07), .b(new_n50_), .c(x01), .O(new_n51_));
  ...
  nand3  g21(.a(x08), .b(new_n50_), .c(x01), .O(new_n56_));
  ...
  oai21  g25(.a(x09), .b(new_n35_), .c(new_n50_), .O(new_n60_));
  ...
  oai21  g34(.a(x10), .b(new_n35_), .c(new_n50_), .O(new_n69_));
  ...
  nand3  g42(.a(x10), .b(new_n50_), .c(x01), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n70_), .O(z06));
  oai21  g44(.a(x11), .b(new_n35_), .c(new_n50_), .O(new_n79_));
  nand2  g45(.a(new_n74_), .b(x11), .O(new_n80_));
  nand2  g46(.a(new_n61_), .b(x06), .O(new_n81_));
  ...
  oai21  g51(.a(x12), .b(new_n35_), .c(new_n50_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n48_), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  aoi21  g54(.a(new_n83_), .b(new_n61_), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g59(.a(x12), .b(new_n50_), .c(x01), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n87_), .O(z08));
  oai21  g61(.a(x13), .b(new_n35_), .c(new_n50_), .O(new_n96_));
  ...
  nand4  g67(.a(new_n101_), .b(new_n97_), .c(new_n96_), .d(new_n47_), .O(z09));
  inv1   g68(.a(x07), .O(new_n103_));
  inv1   g69(.a(x00), .O(new_n104_));
  nand2  g70(.a(new_n99_), .b(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n47_), .c(new_n64_), .d(x08), .O(new_n106_));
  ...
  inv1   g78(.a(new_n39_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n46_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n46_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n43_), .c(new_n113_), .O(z12));
  nand2  g82(.a(new_n113_), .b(new_n43_), .O(z13));
