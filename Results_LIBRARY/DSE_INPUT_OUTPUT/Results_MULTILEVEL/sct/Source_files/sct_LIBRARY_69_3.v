...
module FAU ( 
  ...
  nand3  g18(.a(new_n52_), .b(new_n38_), .c(x04), .O(new_n53_));
  ...
  nand3  g24(.a(new_n58_), .b(new_n35_), .c(x06), .O(new_n59_));
  nand2  g25(.a(x08), .b(new_n38_), .O(new_n60_));
  ...
  nand3  g34(.a(new_n68_), .b(new_n35_), .c(x08), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n67_), .c(new_n52_), .d(x04), .O(z05));
  ...
  nand4  g41(.a(new_n68_), .b(new_n35_), .c(new_n64_), .d(x08), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n52_), .d(x04), .O(z06));
  oai21  g44(.a(new_n51_), .b(new_n45_), .c(new_n48_), .O(new_n79_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n72_), .c(new_n35_), .d(new_n81_), .O(new_n84_));
  ...
  oai21  g54(.a(new_n88_), .b(new_n65_), .c(new_n35_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  nand2  g56(.a(new_n84_), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n52_), .d(x04), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n87_), .c(new_n81_), .d(new_n86_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n65_), .c(new_n35_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand3  g62(.a(new_n68_), .b(new_n64_), .c(x08), .O(new_n97_));
  nand4  g63(.a(new_n35_), .b(new_n87_), .c(new_n81_), .d(new_n86_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n97_), .c(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n94_), .b(new_n101_), .c(new_n51_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n64_), .c(x08), .d(x07), .O(new_n103_));
  nand2  g69(.a(new_n51_), .b(x14), .O(new_n104_));
  oai21  g70(.a(new_n103_), .b(new_n38_), .c(new_n104_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n48_), .O(z10));
  nand2  g73(.a(new_n48_), .b(new_n37_), .O(z11));
