...
module FAU ( 
  ...
  oai21  g28(.a(x17), .b(x09), .c(new_n47_), .O(new_n63_));
  ...
  oai21  g36(.a(x17), .b(x10), .c(new_n47_), .O(new_n71_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n71_), .d(new_n51_), .O(z06));
  oai21  g44(.a(x17), .b(x11), .c(new_n47_), .O(new_n79_));
  oai21  g45(.a(new_n50_), .b(new_n44_), .c(new_n79_), .O(new_n80_));
  ...
  nand3  g51(.a(new_n35_), .b(x11), .c(new_n47_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n80_), .O(z07));
  oai21  g53(.a(x17), .b(x12), .c(new_n47_), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  or2    g55(.a(new_n84_), .b(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n74_), .b(new_n89_), .c(new_n81_), .O(new_n91_));
  nor3   g57(.a(new_n91_), .b(new_n64_), .c(new_n47_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n44_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n88_), .d(new_n51_), .O(z08));
  oai21  g60(.a(x17), .b(x13), .c(new_n47_), .O(new_n95_));
  oai21  g61(.a(new_n50_), .b(new_n44_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g69(.a(new_n35_), .b(x13), .c(new_n47_), .O(new_n104_));
  ...
  nand2  g78(.a(new_n112_), .b(new_n54_), .O(z10));
  nor2   g79(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n37_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n44_), .c(new_n54_), .O(z12));
  oai21  g82(.a(new_n35_), .b(x06), .c(new_n44_), .O(z13));
