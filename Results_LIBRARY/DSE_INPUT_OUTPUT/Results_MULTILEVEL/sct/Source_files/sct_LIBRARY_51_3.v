...
module FAU ( 
  ...
  nand4  g28(.a(new_n50_), .b(new_n35_), .c(new_n62_), .d(x04), .O(z05));
  inv1   g29(.a(x10), .O(new_n64_));
  nand4  g30(.a(new_n50_), .b(new_n35_), .c(new_n64_), .d(x04), .O(z06));
  nor2   g31(.a(x11), .b(new_n44_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n50_), .c(new_n36_), .O(z07));
  ...
  nand4  g37(.a(new_n49_), .b(new_n35_), .c(x16), .d(x14), .O(new_n72_));
  nor2   g38(.a(new_n72_), .b(new_n44_), .O(z10));
  nor2   g39(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g40(.a(x16), .b(new_n37_), .c(x03), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n44_), .c(new_n35_), .O(z12));
