...
module FAU ( 
  ...
  oai21  g08(.a(new_n42_), .b(x03), .c(x05), .O(new_n43_));
  inv1   g09(.a(x18), .O(new_n44_));
  oai21  g10(.a(new_n44_), .b(x15), .c(new_n36_), .O(new_n45_));
  nand2  g11(.a(new_n45_), .b(new_n43_), .O(z01));
  inv1   g12(.a(x06), .O(new_n47_));
  inv1   g13(.a(x16), .O(new_n48_));
  oai21  g14(.a(new_n48_), .b(x02), .c(new_n35_), .O(new_n49_));
  nand2  g15(.a(new_n48_), .b(new_n36_), .O(new_n50_));
  nand2  g16(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g17(.a(new_n51_), .b(new_n47_), .O(new_n52_));
  nor2   g18(.a(new_n52_), .b(new_n42_), .O(z02));
  xor2a  g19(.a(x07), .b(x06), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  nor2   g21(.a(new_n55_), .b(new_n42_), .O(z03));
  ...
  nand2  g34(.a(new_n36_), .b(x03), .O(new_n69_));
  oai21  g35(.a(x03), .b(x02), .c(new_n69_), .O(new_n70_));
  ...
  aoi21  g41(.a(new_n66_), .b(x10), .c(new_n75_), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n37_), .c(new_n71_), .O(z06));
  nand2  g43(.a(new_n50_), .b(x03), .O(new_n78_));
  nand2  g44(.a(new_n74_), .b(x11), .O(new_n79_));
  nand2  g45(.a(x16), .b(new_n38_), .O(new_n80_));
  inv1   g46(.a(x10), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(new_n63_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n65_), .O(new_n84_));
  and2   g50(.a(new_n84_), .b(new_n80_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n79_), .c(new_n78_), .d(x04), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n73_), .b(new_n83_), .c(new_n87_), .d(new_n82_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n80_), .c(x04), .O(new_n89_));
  aoi21  g55(.a(new_n84_), .b(x12), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n78_), .O(z08));
  nand2  g57(.a(new_n88_), .b(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n87_), .c(new_n82_), .d(new_n81_), .O(new_n94_));
  nor2   g60(.a(new_n94_), .b(new_n66_), .O(new_n95_));
  aoi21  g61(.a(x16), .b(new_n38_), .c(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n92_), .c(new_n78_), .d(x04), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n94_), .b(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n51_), .c(new_n65_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand3  g68(.a(new_n70_), .b(x16), .c(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n42_), .O(z10));
  nand2  g70(.a(new_n62_), .b(new_n38_), .O(z11));
  nand3  g71(.a(x16), .b(new_n35_), .c(new_n38_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n69_), .c(new_n42_), .O(z12));
  nand2  g73(.a(new_n62_), .b(new_n42_), .O(z13));
  nand3  g74(.a(new_n62_), .b(x17), .c(x04), .O(new_n109_));
