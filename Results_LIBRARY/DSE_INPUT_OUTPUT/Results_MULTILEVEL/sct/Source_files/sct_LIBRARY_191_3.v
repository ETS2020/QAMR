...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(new_n46_), .c(new_n43_), .O(z03));
  nand2  g17(.a(new_n47_), .b(x08), .O(new_n52_));
  aoi21  g18(.a(new_n52_), .b(new_n46_), .c(new_n43_), .O(z04));
  ...
  nor2   g33(.a(new_n67_), .b(new_n43_), .O(z10));
  ...
  aoi21  g39(.a(new_n73_), .b(new_n46_), .c(new_n43_), .O(z14));
  buf    g40(.a(x04), .O(z13));
endmodule
