...
module FAU ( 
  ...
  nand3  g18(.a(x18), .b(new_n52_), .c(x06), .O(new_n53_));
  ...
  nand3  g24(.a(new_n58_), .b(x18), .c(x06), .O(new_n59_));
  ...
  inv1   g28(.a(new_n36_), .O(new_n63_));
  oai21  g29(.a(new_n48_), .b(new_n43_), .c(new_n63_), .O(new_n64_));
  nor2   g30(.a(new_n57_), .b(new_n52_), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n41_), .c(x06), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x09), .O(new_n67_));
  inv1   g33(.a(x09), .O(new_n68_));
  nor2   g34(.a(new_n52_), .b(new_n35_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(x18), .c(new_n68_), .d(x08), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n67_), .c(new_n64_), .O(z05));
  nand3  g37(.a(new_n68_), .b(x08), .c(x07), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x18), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x06), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x10), .O(new_n75_));
  nor2   g41(.a(new_n41_), .b(x10), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n65_), .c(new_n68_), .d(x06), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n64_), .O(z06));
  nor2   g44(.a(x11), .b(x10), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n65_), .c(new_n68_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x18), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  aoi21  g48(.a(new_n77_), .b(x11), .c(new_n43_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n49_), .O(z07));
  nand2  g50(.a(new_n82_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n69_), .b(new_n68_), .c(x08), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n79_), .c(x18), .d(new_n86_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n85_), .c(new_n64_), .O(z08));
  inv1   g56(.a(x10), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  nand3  g58(.a(new_n86_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n72_), .c(x18), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x13), .O(new_n96_));
  nor2   g62(.a(new_n41_), .b(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n88_), .c(new_n79_), .d(new_n86_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n64_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nor2   g66(.a(x13), .b(x12), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n79_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n48_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n68_), .c(x08), .d(x07), .O(new_n104_));
  nand2  g70(.a(new_n48_), .b(x14), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(new_n35_), .c(new_n105_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n63_), .O(z10));
  nor2   g74(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g75(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n63_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nor2   g78(.a(new_n36_), .b(new_n43_), .O(z13));
  nand2  g79(.a(x17), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n63_), .O(z14));
endmodule
