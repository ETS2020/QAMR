...
module FAU ( 
  ...
  oai21  g28(.a(new_n51_), .b(new_n45_), .c(new_n37_), .O(new_n63_));
  inv1   g29(.a(x17), .O(new_n64_));
  inv1   g30(.a(x08), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n48_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n64_), .c(x07), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x09), .O(new_n68_));
  inv1   g34(.a(x09), .O(new_n69_));
  nor2   g35(.a(new_n35_), .b(new_n48_), .O(new_n70_));
  ...
  nand2  g46(.a(new_n80_), .b(x17), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x07), .O(new_n82_));
  nand3  g48(.a(x08), .b(x07), .c(x06), .O(new_n83_));
  nand3  g49(.a(x17), .b(new_n73_), .c(new_n69_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n83_), .c(x11), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n82_), .c(new_n52_), .d(x04), .O(z07));
  nor2   g52(.a(x09), .b(new_n65_), .O(new_n87_));
  ...
  nand4  g59(.a(x17), .b(new_n89_), .c(new_n73_), .d(new_n69_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n83_), .c(x12), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n93_), .c(new_n52_), .d(x04), .O(z08));
  ...
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n51_), .O(new_n105_));
