...
module FAU ( 
  ...
  nand2  g01(.a(x11), .b(new_n35_), .O(new_n36_));
  ...
  nand4  g18(.a(new_n52_), .b(new_n48_), .c(new_n35_), .d(x04), .O(new_n53_));
  ...
  oai21  g28(.a(x11), .b(x09), .c(new_n35_), .O(new_n63_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n65_), .c(new_n63_), .d(new_n52_), .O(z05));
  oai21  g37(.a(x11), .b(x10), .c(new_n35_), .O(new_n72_));
  ...
  oai21  g45(.a(new_n51_), .b(new_n45_), .c(new_n36_), .O(new_n80_));
  ...
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n66_), .O(new_n85_));
  and2   g51(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n35_), .c(new_n80_), .O(z07));
  oai21  g53(.a(x12), .b(x11), .c(new_n35_), .O(new_n88_));
  nand2  g54(.a(new_n85_), .b(x12), .O(new_n89_));
  nor2   g55(.a(x12), .b(x11), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n75_), .O(new_n91_));
  nor3   g57(.a(new_n91_), .b(new_n64_), .c(new_n35_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n45_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n88_), .d(new_n52_), .O(z08));
  oai21  g60(.a(x13), .b(x11), .c(new_n35_), .O(new_n95_));
  ...
  nand3  g66(.a(new_n84_), .b(new_n100_), .c(new_n99_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n69_), .c(new_n45_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n98_), .c(new_n95_), .d(new_n52_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  aoi21  g71(.a(new_n101_), .b(new_n105_), .c(new_n51_), .O(new_n106_));
  ...
  nand2  g76(.a(new_n110_), .b(new_n36_), .O(z10));
  nor2   g77(.a(new_n37_), .b(new_n38_), .O(z11));
  oai21  g78(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n36_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n36_), .b(new_n45_), .O(z13));
  nand2  g82(.a(x17), .b(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n36_), .O(z14));
endmodule
