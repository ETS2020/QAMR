...
module FAU ( 
  ...
  nand4  g20(.a(new_n52_), .b(x08), .c(new_n36_), .d(x04), .O(new_n55_));
  ...
  aoi21  g26(.a(new_n47_), .b(x02), .c(new_n49_), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(x11), .c(new_n36_), .O(new_n62_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n36_), .c(new_n35_), .O(z14));
endmodule
