...
module FAU ( 
  ...
  nand2  g33(.a(new_n67_), .b(new_n61_), .O(z05));
  nand2  g34(.a(new_n65_), .b(x10), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(x08), .c(x07), .d(x06), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n48_), .d(x04), .O(z06));
  oai21  g38(.a(x11), .b(new_n43_), .c(new_n35_), .O(new_n73_));
  ...
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n64_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n75_), .c(new_n48_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n73_), .O(z07));
  oai21  g48(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n83_));
  nand2  g49(.a(new_n78_), .b(new_n64_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n62_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n77_), .b(new_n70_), .c(new_n87_), .d(new_n86_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n85_), .c(new_n48_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n83_), .O(z08));
  oai21  g57(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n92_));
  nand3  g58(.a(new_n64_), .b(x08), .c(x07), .O(new_n93_));
  inv1   g59(.a(x10), .O(new_n94_));
  nand3  g60(.a(new_n87_), .b(new_n86_), .c(new_n94_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n93_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n87_), .c(new_n86_), .d(new_n94_), .O(new_n98_));
  or2    g64(.a(new_n98_), .b(new_n65_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n96_), .c(new_n48_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n92_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n98_), .b(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(x07), .c(x06), .O(new_n107_));
  or2    g73(.a(new_n48_), .b(new_n40_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n43_), .O(z10));
  nand2  g75(.a(new_n51_), .b(new_n37_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n37_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n43_), .c(new_n51_), .O(z12));
  nand2  g78(.a(new_n35_), .b(new_n43_), .O(z13));
