...
module FAU ( 
  ...
  nand2  g24(.a(x08), .b(new_n43_), .O(new_n59_));
  oai21  g25(.a(new_n58_), .b(new_n43_), .c(new_n59_), .O(new_n60_));
  ...
  aoi21  g37(.a(new_n66_), .b(x10), .c(new_n54_), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(new_n41_), .c(new_n71_), .O(z06));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n55_), .d(x04), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n55_), .d(x04), .O(z08));
  ...
  or2    g54(.a(new_n88_), .b(new_n66_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g56(.a(new_n35_), .O(new_n91_));
  inv1   g57(.a(x00), .O(new_n92_));
  aoi21  g58(.a(new_n88_), .b(new_n92_), .c(new_n54_), .O(new_n93_));
  ...
  nand2  g68(.a(new_n102_), .b(new_n91_), .O(z14));
  buf    g69(.a(x04), .O(z13));
endmodule
