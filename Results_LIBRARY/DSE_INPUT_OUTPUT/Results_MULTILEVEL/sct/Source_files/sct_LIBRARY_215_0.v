...
module FAU ( 
  ...
  aoi21  g14(.a(new_n48_), .b(x17), .c(x06), .O(z02));
  ...
  oai21  g26(.a(new_n60_), .b(x09), .c(new_n54_), .O(new_n61_));
  ...
  nand3  g34(.a(x17), .b(x09), .c(new_n54_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n68_), .c(new_n62_), .O(z05));
  oai21  g36(.a(new_n60_), .b(x10), .c(new_n54_), .O(new_n71_));
  ...
  oai21  g42(.a(new_n60_), .b(x11), .c(new_n54_), .O(new_n77_));
  ...
  nand3  g48(.a(x17), .b(x11), .c(new_n54_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n78_), .O(z07));
  oai21  g50(.a(new_n60_), .b(x12), .c(new_n54_), .O(new_n85_));
  ...
  nand3  g58(.a(x17), .b(x12), .c(new_n54_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n86_), .O(z08));
  oai21  g60(.a(new_n60_), .b(x13), .c(new_n54_), .O(new_n95_));
