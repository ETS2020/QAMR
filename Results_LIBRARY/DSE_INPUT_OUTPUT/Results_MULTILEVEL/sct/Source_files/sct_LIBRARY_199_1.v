...
module FAU ( 
  ...
  nand4  g59(.a(new_n93_), .b(new_n49_), .c(new_n66_), .d(x08), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n48_), .c(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x07), .O(new_n96_));
  inv1   g62(.a(new_n49_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x14), .c(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n96_), .O(z10));
