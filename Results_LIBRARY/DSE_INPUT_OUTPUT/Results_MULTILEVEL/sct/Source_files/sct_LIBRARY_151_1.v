...
module FAU ( 
  ...
  nand3  g25(.a(new_n59_), .b(x06), .c(x05), .O(new_n60_));
  ...
  oai21  g30(.a(new_n49_), .b(new_n64_), .c(new_n46_), .O(new_n65_));
  oai21  g31(.a(new_n58_), .b(new_n53_), .c(x09), .O(new_n66_));
  ...
  nand2  g36(.a(x09), .b(new_n35_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z05));
  oai21  g38(.a(x10), .b(x06), .c(new_n41_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n73_), .d(new_n50_), .O(z06));
  oai21  g44(.a(x11), .b(x06), .c(new_n41_), .O(new_n79_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n67_), .O(new_n85_));
  and2   g51(.a(new_n85_), .b(x04), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n80_), .c(new_n79_), .d(new_n50_), .O(z07));
  oai21  g53(.a(x12), .b(x06), .c(new_n41_), .O(new_n88_));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n84_), .c(new_n64_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n88_), .d(new_n50_), .O(z08));
  oai21  g60(.a(x13), .b(x06), .c(new_n41_), .O(new_n95_));
  ...
  nor2   g64(.a(new_n98_), .b(new_n68_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(new_n64_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n95_), .d(new_n50_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n98_), .b(new_n102_), .c(new_n49_), .O(new_n103_));
  ...
  oai21  g76(.a(new_n110_), .b(new_n64_), .c(new_n46_), .O(z12));
  nor2   g77(.a(new_n36_), .b(new_n64_), .O(z13));
