...
module FAU ( 
  ...
  oai21  g07(.a(x13), .b(new_n41_), .c(x05), .O(new_n42_));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n51_), .c(new_n38_), .O(z05));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n51_), .c(new_n38_), .O(z06));
  ...
  oai21  g51(.a(new_n50_), .b(new_n41_), .c(new_n47_), .O(new_n86_));
  nand3  g52(.a(new_n82_), .b(x13), .c(new_n36_), .O(new_n87_));
  nand4  g53(.a(new_n37_), .b(new_n81_), .c(new_n75_), .d(new_n74_), .O(new_n88_));
  ...
  nand2  g67(.a(new_n47_), .b(new_n41_), .O(z13));
