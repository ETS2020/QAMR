...
module FAU ( 
  ...
  nand3  g25(.a(new_n59_), .b(new_n36_), .c(x06), .O(new_n60_));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n76_), .c(x13), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n35_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n36_), .b(new_n90_), .c(new_n84_), .d(new_n75_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n69_), .c(new_n64_), .d(x08), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n89_), .c(new_n73_), .O(z08));
  nand4  g60(.a(new_n81_), .b(new_n78_), .c(new_n90_), .d(new_n84_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n52_), .c(x04), .O(new_n96_));
  ...
  aoi21  g66(.a(new_n91_), .b(new_n100_), .c(new_n51_), .O(new_n101_));
  ...
  nand2  g72(.a(new_n48_), .b(new_n38_), .O(z11));
  ...
  nand3  g76(.a(new_n48_), .b(x17), .c(x04), .O(new_n111_));
