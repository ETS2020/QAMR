...
module FAU ( 
  ...
  nand4  g35(.a(new_n56_), .b(new_n69_), .c(new_n63_), .d(new_n55_), .O(new_n70_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .d(new_n63_), .O(new_n77_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n75_), .c(new_n69_), .d(new_n63_), .O(new_n84_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n49_), .c(new_n55_), .d(x08), .O(new_n90_));
