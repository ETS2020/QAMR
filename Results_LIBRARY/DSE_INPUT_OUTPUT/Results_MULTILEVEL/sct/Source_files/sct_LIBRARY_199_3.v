...
module FAU ( 
  ...
  oai21  g08(.a(x07), .b(x05), .c(x04), .O(new_n43_));
  ...
  nor2   g20(.a(x09), .b(x07), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n48_), .c(x04), .O(z05));
  ...
  oai21  g36(.a(new_n58_), .b(x02), .c(new_n57_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n36_), .c(x04), .O(new_n72_));
  inv1   g38(.a(new_n72_), .O(z12));
  nor2   g39(.a(x07), .b(new_n35_), .O(z13));
