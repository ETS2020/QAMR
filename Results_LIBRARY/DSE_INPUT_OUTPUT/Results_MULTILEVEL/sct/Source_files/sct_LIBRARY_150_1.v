...
module FAU ( 
  ...
  nand3  g19(.a(x07), .b(new_n46_), .c(x05), .O(new_n54_));
  oai21  g20(.a(x07), .b(new_n46_), .c(new_n54_), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n51_), .c(x04), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z03));
  xor2a  g23(.a(x08), .b(x06), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(x07), .c(x05), .O(new_n59_));
  ...
  oai21  g30(.a(new_n50_), .b(new_n64_), .c(new_n47_), .O(new_n65_));
  ...
  oai21  g35(.a(new_n69_), .b(new_n67_), .c(x05), .O(new_n70_));
  nand2  g36(.a(x09), .b(new_n35_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z05));
  oai21  g38(.a(x10), .b(x07), .c(new_n41_), .O(new_n73_));
  ...
  oai21  g44(.a(x11), .b(x07), .c(new_n41_), .O(new_n79_));
  ...
  oai21  g53(.a(x12), .b(x07), .c(new_n41_), .O(new_n88_));
  ...
  oai21  g60(.a(x13), .b(x07), .c(new_n41_), .O(new_n95_));
  ...
  aoi21  g65(.a(new_n99_), .b(new_n69_), .c(new_n64_), .O(new_n100_));
  ...
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n64_), .O(z10));
  nand2  g75(.a(new_n47_), .b(new_n37_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n37_), .c(x03), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n64_), .c(new_n47_), .O(z12));
  nand2  g78(.a(new_n47_), .b(new_n64_), .O(z13));
  inv1   g79(.a(x17), .O(new_n114_));
  nor3   g80(.a(new_n36_), .b(new_n114_), .c(new_n64_), .O(z14));
endmodule
