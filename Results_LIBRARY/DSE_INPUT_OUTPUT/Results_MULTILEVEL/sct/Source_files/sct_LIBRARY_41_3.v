...
module FAU ( 
  ...
  nor2   g33(.a(new_n67_), .b(new_n35_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n36_), .c(x08), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n66_), .c(new_n50_), .d(x04), .O(z05));
  ...
  nand4  g41(.a(new_n68_), .b(new_n36_), .c(new_n63_), .d(x08), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n50_), .d(x04), .O(z06));
  nand3  g44(.a(new_n72_), .b(new_n68_), .c(x08), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n50_), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n36_), .O(new_n81_));
  oai21  g47(.a(new_n36_), .b(x06), .c(new_n81_), .O(z07));
  inv1   g48(.a(x10), .O(new_n83_));
  nor2   g49(.a(x12), .b(x11), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n64_), .c(new_n36_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nand3  g53(.a(x08), .b(x07), .c(x06), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n36_), .c(new_n83_), .d(new_n63_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x12), .c(new_n47_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n50_), .O(z08));
  inv1   g58(.a(x12), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n83_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n64_), .c(new_n36_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x06), .O(new_n97_));
  nand3  g63(.a(new_n89_), .b(new_n84_), .c(new_n72_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x13), .c(new_n47_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n50_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n95_), .b(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n50_), .c(new_n63_), .d(x08), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n67_), .O(new_n104_));
  nor2   g70(.a(new_n50_), .b(new_n41_), .O(new_n105_));
  aoi21  g71(.a(new_n104_), .b(x06), .c(new_n105_), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n47_), .c(new_n53_), .O(z10));
  ...
  nand2  g79(.a(new_n53_), .b(new_n47_), .O(z13));
