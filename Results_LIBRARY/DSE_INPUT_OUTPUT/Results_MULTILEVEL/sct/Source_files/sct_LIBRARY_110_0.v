...
module FAU ( 
  ...
  aoi21  g14(.a(new_n48_), .b(x15), .c(x06), .O(z02));
  ...
  nand3  g21(.a(x15), .b(x08), .c(new_n54_), .O(new_n56_));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n63_), .c(new_n61_), .d(new_n47_), .O(z05));
  oai21  g35(.a(new_n60_), .b(x10), .c(new_n54_), .O(new_n70_));
  ...
  nand3  g44(.a(x15), .b(x10), .c(new_n54_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z06));
  oai21  g46(.a(new_n60_), .b(x11), .c(new_n54_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n48_), .O(new_n82_));
  and2   g48(.a(new_n76_), .b(x11), .O(new_n83_));
  nor4   g49(.a(new_n62_), .b(x11), .c(x10), .d(x09), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n83_), .c(x06), .O(new_n85_));
  nand3  g51(.a(x15), .b(x11), .c(new_n54_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z07));
  oai21  g53(.a(new_n60_), .b(x12), .c(new_n54_), .O(new_n88_));
  ...
  nand3  g60(.a(x15), .b(x12), .c(new_n54_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z08));
  oai21  g62(.a(new_n60_), .b(x13), .c(new_n54_), .O(new_n97_));
  ...
  nand3  g69(.a(x15), .b(x13), .c(new_n54_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n98_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  aoi21  g72(.a(new_n101_), .b(new_n106_), .c(new_n46_), .O(new_n107_));
  ...
  oai21  g80(.a(new_n114_), .b(new_n64_), .c(new_n50_), .O(z12));
  nor2   g81(.a(new_n35_), .b(new_n64_), .O(z13));
