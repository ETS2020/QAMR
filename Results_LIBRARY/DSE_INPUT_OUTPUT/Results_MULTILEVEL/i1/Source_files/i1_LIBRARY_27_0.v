...
module FAU ( 
  ...
  nand4  g31(.a(new_n72_), .b(new_n64_), .c(new_n50_), .d(new_n57_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x19), .c(x05), .O(new_n74_));
  ...
  nand4  g45(.a(new_n78_), .b(new_n84_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x23), .O(new_n89_));
  nand2  g48(.a(new_n78_), .b(new_n84_), .O(new_n90_));
