...
module FAU ( 
  ...
  and2   g14(.a(x22), .b(x00), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n55_), .c(new_n43_), .O(z01));
  ...
  nand3  g27(.a(new_n68_), .b(x22), .c(x19), .O(new_n69_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x22), .O(new_n77_));
  ...
  inv1   g43(.a(new_n44_), .O(new_n85_));
  oai21  g44(.a(new_n81_), .b(new_n83_), .c(new_n85_), .O(z09));
  nand2  g45(.a(x22), .b(x14), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(x24), .O(z10));
  nand2  g47(.a(x22), .b(x17), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(x24), .O(z11));
  nand3  g49(.a(new_n81_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n85_), .O(z12));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(x23), .d(x17), .O(new_n93_));
