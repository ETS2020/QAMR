...
module FAU ( 
  ...
  oai21  g32(.a(new_n73_), .b(new_n62_), .c(new_n71_), .O(new_n74_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n42_), .O(z09));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n81_), .b(x22), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n42_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n42_), .O(z11));
  nand4  g46(.a(new_n42_), .b(new_n81_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n81_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n42_), .O(z13));
