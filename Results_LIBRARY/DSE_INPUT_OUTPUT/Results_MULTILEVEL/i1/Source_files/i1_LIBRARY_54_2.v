...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n78_, new_n82_, new_n84_, new_n86_, new_n88_,
  ...
  nand4  g33(.a(new_n65_), .b(x19), .c(new_n66_), .d(new_n53_), .O(new_n75_));
  oai22  g34(.a(new_n75_), .b(new_n63_), .c(new_n44_), .d(new_n74_), .O(z05));
  inv1   g35(.a(x18), .O(new_n77_));
  inv1   g36(.a(x24), .O(new_n78_));
  nor3   g37(.a(new_n44_), .b(new_n78_), .c(new_n77_), .O(z07));
  nor2   g38(.a(new_n47_), .b(new_n43_), .O(z08));
  aoi21  g39(.a(new_n78_), .b(x19), .c(new_n43_), .O(z09));
  nand3  g40(.a(new_n78_), .b(x22), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n45_), .O(z10));
  nand4  g42(.a(new_n45_), .b(new_n78_), .c(x22), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z11));
  nand4  g44(.a(new_n45_), .b(new_n78_), .c(x23), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  nand3  g46(.a(new_n78_), .b(x23), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z13));
  nand2  g48(.a(new_n78_), .b(x16), .O(new_n90_));
