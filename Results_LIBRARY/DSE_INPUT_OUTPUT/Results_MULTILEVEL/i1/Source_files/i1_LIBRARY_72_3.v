...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(x17), .O(new_n69_));
  ...
  oai21  g35(.a(new_n76_), .b(x17), .c(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n75_), .O(z05));
  nor2   g37(.a(new_n44_), .b(x17), .O(z06));
  ...
  nand2  g47(.a(new_n85_), .b(x22), .O(new_n89_));
  ...
  aoi21  g52(.a(new_n92_), .b(new_n44_), .c(new_n43_), .O(z13));
