...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n79_, new_n82_, new_n84_, new_n85_,
    new_n86_, new_n88_, new_n90_, new_n91_, new_n92_, new_n94_, new_n97_,
    new_n98_, new_n99_;
  ...
  nor2   g13(.a(x16), .b(new_n42_), .O(new_n55_));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(x16), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n60_), .c(new_n44_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nand2  g27(.a(x19), .b(x16), .O(new_n69_));
  ...
  aoi21  g54(.a(x24), .b(new_n44_), .c(new_n73_), .O(z14));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x13), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nand4  g58(.a(new_n99_), .b(new_n69_), .c(new_n98_), .d(new_n97_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
