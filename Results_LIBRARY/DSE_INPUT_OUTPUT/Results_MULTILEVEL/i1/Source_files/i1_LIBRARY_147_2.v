...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n93_, new_n95_, new_n97_;
  ...
  nand4  g49(.a(new_n45_), .b(new_n81_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n81_), .b(x23), .c(x17), .O(new_n93_));
  ...
  nand3  g56(.a(new_n97_), .b(new_n43_), .c(new_n86_), .O(z15));
endmodule
