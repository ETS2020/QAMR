...
module FAU ( 
  ...
  nand3  g15(.a(new_n56_), .b(x19), .c(x11), .O(new_n57_));
  ...
  nand3  g27(.a(new_n68_), .b(x19), .c(x11), .O(new_n69_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n63_), .c(x11), .O(new_n78_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n74_), .O(z10));
  nand4  g47(.a(new_n74_), .b(new_n82_), .c(x22), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand4  g49(.a(new_n74_), .b(new_n82_), .c(x23), .d(x14), .O(new_n91_));
