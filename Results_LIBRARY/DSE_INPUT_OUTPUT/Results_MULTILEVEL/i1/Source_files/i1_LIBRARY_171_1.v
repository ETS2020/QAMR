...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n78_, new_n79_, new_n81_, new_n84_, new_n86_,
  ...
  nor4   g43(.a(x24), .b(new_n43_), .c(new_n60_), .d(new_n84_), .O(z10));
  nand2  g44(.a(new_n79_), .b(x17), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(x19), .c(new_n43_), .O(z11));
  nand2  g46(.a(new_n79_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n84_), .c(new_n45_), .O(z12));
