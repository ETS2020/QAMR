...
module FAU ( 
  ...
  oai21  g17(.a(new_n43_), .b(x01), .c(x24), .O(new_n59_));
  ...
  nand2  g24(.a(new_n65_), .b(new_n51_), .O(z10));
  nand4  g25(.a(new_n51_), .b(new_n64_), .c(x22), .d(x17), .O(new_n67_));
  ...
  oai21  g32(.a(new_n43_), .b(x01), .c(new_n64_), .O(new_n74_));
