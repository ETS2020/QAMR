...
module FAU ( 
  ...
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(new_n50_), .O(z09));
  nand4  g21(.a(new_n50_), .b(new_n61_), .c(x22), .d(x14), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z10));
  nand4  g23(.a(new_n50_), .b(new_n61_), .c(x22), .d(x17), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z11));
  inv1   g25(.a(x14), .O(new_n67_));
  nand2  g26(.a(new_n61_), .b(x23), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n67_), .c(new_n50_), .O(z12));
  inv1   g28(.a(x17), .O(new_n70_));
  oai21  g29(.a(new_n68_), .b(new_n70_), .c(new_n50_), .O(z13));
