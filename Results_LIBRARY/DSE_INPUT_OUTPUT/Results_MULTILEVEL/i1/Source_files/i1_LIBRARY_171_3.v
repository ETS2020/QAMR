...
module FAU ( 
  ...
  nor2   g14(.a(x22), .b(new_n42_), .O(new_n56_));
  ...
  nand3  g30(.a(new_n71_), .b(new_n58_), .c(x19), .O(new_n72_));
  ...
  nor2   g38(.a(x22), .b(new_n45_), .O(z06));
  nand3  g39(.a(z06), .b(new_n61_), .c(new_n79_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n78_), .c(new_n77_), .O(z05));
  nand3  g41(.a(new_n43_), .b(x24), .c(x18), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  inv1   g44(.a(new_n43_), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n85_), .O(z08));
  inv1   g46(.a(x24), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n85_), .c(new_n43_), .O(z09));
  nand4  g48(.a(new_n88_), .b(x22), .c(new_n45_), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z10));
  nand2  g50(.a(new_n88_), .b(x17), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n45_), .c(new_n58_), .O(z11));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n86_), .O(z15));
endmodule
