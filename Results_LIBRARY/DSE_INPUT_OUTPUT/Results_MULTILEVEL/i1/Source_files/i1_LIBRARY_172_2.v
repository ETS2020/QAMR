...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n88_, new_n90_, new_n92_, new_n95_, new_n96_;
  ...
  oai21  g15(.a(new_n46_), .b(x00), .c(x07), .O(new_n57_));
  nor3   g16(.a(x03), .b(x02), .c(x01), .O(new_n58_));
  nor3   g17(.a(x06), .b(x05), .c(x04), .O(new_n59_));
  ...
  nand4  g23(.a(new_n64_), .b(new_n63_), .c(x08), .d(new_n43_), .O(new_n65_));
  ...
  inv1   g32(.a(new_n62_), .O(new_n74_));
  nor2   g33(.a(new_n46_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n74_), .c(new_n64_), .d(new_n43_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n70_), .c(new_n73_), .O(z05));
  inv1   g36(.a(x18), .O(new_n78_));
  nand2  g37(.a(new_n70_), .b(x24), .O(new_n79_));
  ...
  nor2   g42(.a(new_n44_), .b(x24), .O(new_n84_));
