...
module FAU ( 
  ...
  nand4  g28(.a(new_n69_), .b(new_n68_), .c(new_n50_), .d(new_n62_), .O(new_n70_));
  ...
  inv1   g36(.a(new_n63_), .O(new_n78_));
  inv1   g37(.a(x19), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x08), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n64_), .c(new_n78_), .d(new_n52_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n45_), .c(new_n77_), .O(z05));
  nand2  g41(.a(new_n79_), .b(new_n43_), .O(z06));
