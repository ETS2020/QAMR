...
module FAU ( 
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x24), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nor2   g38(.a(new_n56_), .b(new_n43_), .O(z06));
  and2   g39(.a(x24), .b(x18), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n44_), .b(new_n82_), .O(z08));
  oai21  g42(.a(new_n56_), .b(new_n82_), .c(new_n71_), .O(z09));
  nand4  g43(.a(new_n56_), .b(x22), .c(new_n43_), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z10));
  nand4  g45(.a(new_n56_), .b(x22), .c(new_n43_), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand4  g47(.a(new_n56_), .b(x23), .c(new_n43_), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand4  g49(.a(new_n56_), .b(x23), .c(new_n43_), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z13));
  inv1   g51(.a(x16), .O(new_n93_));
  aoi21  g52(.a(new_n43_), .b(new_n93_), .c(x24), .O(z14));
