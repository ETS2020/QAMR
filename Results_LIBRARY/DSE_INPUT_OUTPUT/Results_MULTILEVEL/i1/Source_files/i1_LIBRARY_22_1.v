...
module FAU ( 
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(x18), .O(new_n68_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n62_), .c(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n75_), .O(z05));
  inv1   g38(.a(x24), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n42_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n71_), .b(new_n82_), .O(z08));
  nor3   g42(.a(new_n71_), .b(new_n80_), .c(new_n82_), .O(z09));
  nand4  g43(.a(new_n43_), .b(new_n80_), .c(x22), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z10));
  nand3  g45(.a(new_n80_), .b(x22), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n43_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n80_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n43_), .O(z13));
  inv1   g52(.a(x16), .O(new_n94_));
  nor3   g53(.a(new_n71_), .b(x24), .c(new_n94_), .O(z14));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  nor3   g55(.a(new_n71_), .b(x13), .c(x12), .O(new_n97_));
