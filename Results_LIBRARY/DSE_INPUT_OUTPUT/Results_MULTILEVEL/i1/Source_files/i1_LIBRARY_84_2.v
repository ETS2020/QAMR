...
module FAU ( 
  ...
  nand3  g16(.a(new_n43_), .b(new_n49_), .c(new_n48_), .O(new_n58_));
  inv1   g17(.a(x04), .O(new_n59_));
  nor2   g18(.a(x07), .b(x06), .O(new_n60_));
  nand3  g19(.a(new_n60_), .b(new_n50_), .c(new_n59_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n58_), .c(x00), .O(new_n62_));
  nand4  g21(.a(new_n59_), .b(new_n43_), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  ...
  nand4  g33(.a(new_n50_), .b(new_n59_), .c(new_n49_), .d(new_n48_), .O(new_n75_));
  nand3  g34(.a(new_n60_), .b(x19), .c(new_n66_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  oai21  g37(.a(new_n47_), .b(new_n74_), .c(new_n78_), .O(z05));
  ...
  nand4  g51(.a(new_n45_), .b(new_n92_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n92_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n45_), .O(z13));
  nand2  g55(.a(new_n92_), .b(x16), .O(new_n97_));
