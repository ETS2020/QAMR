...
module FAU ( 
  ...
  inv1   g33(.a(new_n58_), .O(new_n75_));
  nor2   g34(.a(new_n43_), .b(x08), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n59_), .c(new_n75_), .d(new_n51_), .O(new_n77_));
  ...
  nand4  g50(.a(new_n44_), .b(new_n83_), .c(x23), .d(x17), .O(new_n92_));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n71_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
