...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n63_), .c(x22), .O(new_n71_));
  ...
  nor2   g39(.a(x22), .b(new_n46_), .O(z06));
  ...
  nand4  g48(.a(new_n88_), .b(x22), .c(new_n46_), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z10));
  nand4  g50(.a(new_n88_), .b(x22), .c(new_n46_), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  nand3  g52(.a(new_n43_), .b(new_n88_), .c(x23), .O(new_n94_));
