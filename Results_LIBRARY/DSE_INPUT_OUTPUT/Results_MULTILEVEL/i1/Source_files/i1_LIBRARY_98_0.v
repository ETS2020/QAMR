...
module FAU ( 
  ...
  nand4  g34(.a(new_n60_), .b(x19), .c(new_n75_), .d(new_n51_), .O(new_n76_));
  oai22  g35(.a(new_n76_), .b(new_n58_), .c(new_n43_), .d(new_n74_), .O(z05));
  nand2  g36(.a(new_n45_), .b(x07), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  nand2  g38(.a(new_n72_), .b(x24), .O(new_n80_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n72_), .O(z10));
  nand4  g46(.a(new_n72_), .b(new_n85_), .c(x22), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand4  g48(.a(new_n72_), .b(new_n85_), .c(x23), .d(x14), .O(new_n90_));
  ...
  nand2  g53(.a(new_n94_), .b(new_n72_), .O(z14));
