...
module FAU ( 
  ...
  nand4  g35(.a(new_n76_), .b(new_n66_), .c(new_n65_), .d(new_n51_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n45_), .c(new_n75_), .O(z05));
  nand2  g37(.a(x22), .b(new_n59_), .O(z06));
  ...
  nand2  g44(.a(x22), .b(x14), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(x24), .O(z10));
  nand2  g46(.a(x22), .b(x17), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(x24), .O(z11));
  nand3  g48(.a(new_n81_), .b(x23), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n45_), .O(z12));
  nand4  g50(.a(new_n45_), .b(new_n81_), .c(x23), .d(x17), .O(new_n92_));
