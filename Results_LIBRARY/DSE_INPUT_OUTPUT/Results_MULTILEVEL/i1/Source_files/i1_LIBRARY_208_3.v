...
module FAU ( 
  ...
  nand2  g01(.a(x19), .b(x16), .O(new_n43_));
  ...
  nor2   g15(.a(x16), .b(new_n42_), .O(new_n57_));
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x16), .O(new_n71_));
  ...
  nor2   g37(.a(new_n46_), .b(x16), .O(z06));
  ...
  aoi21  g56(.a(x24), .b(new_n46_), .c(new_n97_), .O(z14));
