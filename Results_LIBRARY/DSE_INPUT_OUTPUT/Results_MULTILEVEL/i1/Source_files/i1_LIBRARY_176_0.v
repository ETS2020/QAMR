...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n74_, new_n76_,
    new_n78_, new_n80_, new_n82_, new_n83_, new_n85_, new_n87_, new_n90_,
    new_n91_;
  ...
  oai21  g37(.a(new_n78_), .b(new_n76_), .c(new_n44_), .O(z09));
  nand3  g38(.a(new_n78_), .b(x22), .c(x14), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n44_), .O(z10));
  nor2   g40(.a(new_n43_), .b(x24), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x22), .c(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand3  g43(.a(new_n82_), .b(x23), .c(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand3  g45(.a(new_n78_), .b(x23), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z13));
  and2   g47(.a(new_n82_), .b(x16), .O(z14));
