...
module FAU ( 
  ...
  nand3  g13(.a(x19), .b(new_n43_), .c(new_n54_), .O(new_n55_));
  ...
  nand4  g25(.a(new_n63_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(new_n68_));
  nand2  g27(.a(new_n51_), .b(new_n50_), .O(new_n69_));
  nand3  g28(.a(new_n43_), .b(x08), .c(new_n52_), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi22  g30(.a(new_n71_), .b(new_n68_), .c(new_n66_), .d(x00), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n62_), .c(new_n45_), .O(z02));
  ...
  nor4   g37(.a(new_n69_), .b(new_n62_), .c(x08), .d(x07), .O(new_n79_));
  ...
  nand2  g47(.a(new_n45_), .b(new_n86_), .O(new_n89_));
  ...
  nand4  g53(.a(new_n45_), .b(new_n86_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n86_), .b(x23), .c(x17), .O(new_n97_));
