...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n83_, new_n84_, new_n87_, new_n88_, new_n90_, new_n93_,
    new_n95_, new_n97_, new_n98_, new_n100_, new_n103_, new_n104_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x16), .b(x02), .O(new_n43_));
  ...
  nor2   g12(.a(new_n53_), .b(x05), .O(new_n54_));
  nand4  g13(.a(new_n54_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(x16), .O(new_n56_));
  ...
  nor3   g20(.a(x04), .b(x03), .c(x01), .O(new_n62_));
  nor3   g21(.a(x07), .b(x06), .c(x05), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(x02), .c(x00), .O(new_n65_));
  ...
  nand3  g28(.a(x16), .b(new_n69_), .c(x08), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n65_), .c(new_n60_), .O(z02));
  inv1   g32(.a(x20), .O(new_n74_));
  nor2   g33(.a(new_n43_), .b(new_n74_), .O(z03));
  ...
  nand3  g40(.a(new_n66_), .b(x19), .c(new_n81_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(x16), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n78_), .O(z05));
  nand2  g44(.a(new_n44_), .b(new_n60_), .O(z06));
  inv1   g45(.a(x18), .O(new_n87_));
  inv1   g46(.a(x24), .O(new_n88_));
  nor3   g47(.a(new_n43_), .b(new_n88_), .c(new_n87_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nand2  g49(.a(new_n44_), .b(new_n90_), .O(z08));
  oai21  g50(.a(new_n88_), .b(new_n90_), .c(new_n44_), .O(z09));
  nand4  g51(.a(new_n44_), .b(new_n88_), .c(x22), .d(x14), .O(new_n93_));
  ...
  nand2  g56(.a(new_n88_), .b(x23), .O(new_n98_));
  ...
  nor2   g60(.a(x24), .b(new_n61_), .O(z14));
