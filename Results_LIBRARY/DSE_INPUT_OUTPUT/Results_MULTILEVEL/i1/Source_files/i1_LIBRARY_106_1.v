...
module FAU ( 
  ...
  nand4  g20(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n61_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n60_), .c(x00), .O(new_n63_));
  nand4  g22(.a(new_n61_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n64_));
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(new_n43_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n63_), .c(new_n47_), .O(z02));
  and2   g29(.a(new_n44_), .b(x20), .O(z03));
  ...
  nand3  g34(.a(new_n75_), .b(new_n52_), .c(new_n51_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n64_), .c(x13), .O(new_n77_));
  ...
  nand4  g45(.a(new_n44_), .b(new_n86_), .c(x22), .d(x14), .O(new_n87_));
  ...
  nand4  g51(.a(new_n44_), .b(new_n86_), .c(x23), .d(x17), .O(new_n93_));
