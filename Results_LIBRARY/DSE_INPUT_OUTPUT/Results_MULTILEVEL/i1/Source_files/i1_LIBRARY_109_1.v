...
module FAU ( 
  ...
  nor2   g14(.a(new_n55_), .b(x07), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n54_), .O(z05));
  inv1   g16(.a(x18), .O(new_n58_));
  oai21  g17(.a(new_n55_), .b(x07), .c(x24), .O(new_n59_));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n56_), .O(z15));
  buf    g36(.a(x19), .O(z06));
endmodule
