...
module FAU ( 
  ...
  nand3  g40(.a(z06), .b(new_n61_), .c(new_n79_), .O(new_n82_));
  ...
  nand2  g46(.a(new_n74_), .b(new_n87_), .O(z08));
  oai21  g47(.a(new_n85_), .b(new_n87_), .c(new_n74_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n85_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n74_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n74_), .O(z11));
  nand4  g53(.a(new_n74_), .b(new_n85_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n85_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n74_), .O(z13));
  inv1   g57(.a(x16), .O(new_n99_));
  nor3   g58(.a(new_n44_), .b(x24), .c(new_n99_), .O(z14));
  nor3   g59(.a(x15), .b(x14), .c(x13), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(x19), .c(new_n80_), .O(z15));
endmodule
