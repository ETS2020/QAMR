...
module FAU ( 
  ...
  oai21  g16(.a(new_n43_), .b(x07), .c(x24), .O(new_n58_));
  ...
  nand2  g23(.a(new_n64_), .b(new_n53_), .O(z10));
  nand4  g24(.a(new_n53_), .b(new_n63_), .c(x22), .d(x17), .O(new_n66_));
  ...
  nand2  g29(.a(new_n70_), .b(new_n53_), .O(z13));
  nand2  g30(.a(new_n63_), .b(x16), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n53_), .O(z14));
