...
module FAU ( 
  ...
  oai21  g34(.a(new_n75_), .b(new_n63_), .c(new_n45_), .O(new_n76_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n45_), .O(z09));
  nand3  g42(.a(new_n43_), .b(new_n82_), .c(x22), .O(new_n84_));
  ...
  nand2  g49(.a(new_n82_), .b(x23), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(z12));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n43_), .O(z13));
