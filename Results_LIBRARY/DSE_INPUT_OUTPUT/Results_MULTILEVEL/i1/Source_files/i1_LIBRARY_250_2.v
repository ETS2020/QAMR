...
module FAU ( 
  ...
  nand2  g01(.a(new_n42_), .b(x05), .O(new_n43_));
  ...
  nand3  g17(.a(new_n58_), .b(new_n48_), .c(new_n57_), .O(new_n59_));
  oai21  g18(.a(new_n59_), .b(new_n56_), .c(x00), .O(new_n60_));
  nand4  g19(.a(new_n57_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n61_));
  ...
  aoi21  g25(.a(new_n66_), .b(new_n60_), .c(new_n42_), .O(z02));
  ...
  nand4  g49(.a(new_n43_), .b(new_n84_), .c(x23), .d(x17), .O(new_n91_));
