...
module FAU ( 
  ...
  oai21  g24(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(new_n66_));
  nand3  g25(.a(new_n66_), .b(x19), .c(new_n45_), .O(new_n67_));
  ...
  nand3  g31(.a(new_n43_), .b(new_n72_), .c(new_n69_), .O(z04));
  ...
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n43_), .b(new_n82_), .O(z08));
  nand3  g42(.a(new_n43_), .b(x24), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x24), .O(new_n86_));
  nand3  g45(.a(new_n43_), .b(new_n86_), .c(x22), .O(new_n87_));
  ...
  nand2  g52(.a(new_n86_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n43_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n43_), .O(z13));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n70_), .O(z15));
  buf    g61(.a(x19), .O(z06));
endmodule
