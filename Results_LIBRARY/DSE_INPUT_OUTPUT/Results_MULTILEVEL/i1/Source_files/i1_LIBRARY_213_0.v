...
module FAU ( 
  ...
  nand2  g32(.a(x23), .b(x20), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n73_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nor4   g35(.a(new_n67_), .b(new_n59_), .c(x08), .d(x07), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n65_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n45_), .c(new_n76_), .O(z05));
  nand2  g38(.a(new_n45_), .b(new_n59_), .O(z06));
  ...
  nand4  g47(.a(new_n45_), .b(new_n82_), .c(x22), .d(x17), .O(new_n89_));
