...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n79_, new_n82_, new_n84_, new_n86_, new_n88_,
  ...
  nand4  g40(.a(new_n69_), .b(new_n77_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n77_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n69_), .O(z11));
  nand4  g44(.a(new_n69_), .b(new_n77_), .c(x23), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  nand3  g46(.a(new_n77_), .b(x23), .c(x17), .O(new_n88_));
