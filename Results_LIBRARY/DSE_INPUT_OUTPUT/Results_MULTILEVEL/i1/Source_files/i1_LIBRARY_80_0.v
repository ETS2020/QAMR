...
module FAU ( 
  ...
  nand3  g32(.a(new_n59_), .b(new_n73_), .c(new_n71_), .O(z04));
  ...
  oai21  g40(.a(new_n78_), .b(new_n80_), .c(new_n59_), .O(z09));
  ...
  oai21  g47(.a(new_n88_), .b(new_n83_), .c(new_n59_), .O(z12));
  oai21  g48(.a(new_n88_), .b(new_n86_), .c(new_n59_), .O(z13));
