...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n67_, new_n70_, new_n72_, new_n74_, new_n76_, new_n78_,
  ...
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n67_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n67_), .O(z11));
  nand2  g41(.a(new_n76_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n78_), .c(new_n67_), .O(z12));
  oai21  g43(.a(new_n83_), .b(new_n81_), .c(new_n67_), .O(z13));
