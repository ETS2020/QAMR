...
module FAU ( 
  ...
  nor2   g14(.a(x03), .b(new_n42_), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n55_), .c(new_n45_), .O(z01));
  nand3  g16(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n58_));
  nand3  g17(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n59_));
  oai21  g18(.a(new_n59_), .b(new_n58_), .c(x00), .O(new_n60_));
  nand4  g19(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n61_));
  inv1   g20(.a(x09), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(x08), .c(new_n51_), .d(new_n50_), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(x03), .O(new_n65_));
  ...
  nor2   g33(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(x03), .c(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n72_), .O(z05));
  nor2   g36(.a(new_n45_), .b(x03), .O(z06));
  ...
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(z10));
  ...
  nand4  g50(.a(new_n43_), .b(new_n83_), .c(x23), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z13));
  nand3  g52(.a(new_n43_), .b(new_n83_), .c(x16), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z14));
  nor2   g54(.a(x13), .b(x12), .O(new_n96_));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n69_), .O(z15));
endmodule
