...
module FAU ( 
  ...
  nand3  g19(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n60_), .c(x00), .O(new_n62_));
  nand4  g21(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  inv1   g22(.a(x09), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(x08), .c(new_n53_), .d(new_n52_), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(x06), .O(new_n67_));
  ...
  nand3  g30(.a(new_n46_), .b(new_n71_), .c(new_n69_), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  inv1   g32(.a(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n75_));
  ...
  nor2   g37(.a(new_n44_), .b(x06), .O(z06));
