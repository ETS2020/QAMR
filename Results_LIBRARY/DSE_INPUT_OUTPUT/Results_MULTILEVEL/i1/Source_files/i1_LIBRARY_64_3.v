...
module FAU ( 
  ...
  aoi21  g31(.a(new_n72_), .b(new_n69_), .c(x24), .O(new_n73_));
  ...
  nor2   g39(.a(x24), .b(new_n43_), .O(z06));
  nand3  g40(.a(z06), .b(new_n63_), .c(new_n70_), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n80_), .c(new_n45_), .d(new_n79_), .O(z05));
  nand3  g42(.a(x24), .b(new_n43_), .c(x18), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  aoi21  g45(.a(x24), .b(x19), .c(new_n86_), .O(z08));
  nand3  g46(.a(x24), .b(new_n43_), .c(x11), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n44_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n46_), .O(z11));
  nand2  g53(.a(new_n44_), .b(x23), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n90_), .c(new_n46_), .O(z12));
  oai21  g55(.a(new_n95_), .b(new_n93_), .c(new_n46_), .O(z13));
  inv1   g56(.a(x16), .O(new_n98_));
  nor2   g57(.a(x24), .b(new_n98_), .O(z14));
