...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n77_, new_n79_, new_n82_, new_n84_, new_n86_,
  ...
  oai21  g37(.a(new_n60_), .b(x18), .c(x24), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n60_), .O(z06));
  inv1   g39(.a(new_n79_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  oai21  g41(.a(new_n43_), .b(x19), .c(new_n82_), .O(z08));
  nand3  g42(.a(x24), .b(x19), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n43_), .b(x22), .O(new_n87_));
  ...
  nand3  g51(.a(new_n43_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n46_), .O(z13));
  inv1   g53(.a(x16), .O(new_n95_));
  nor2   g54(.a(x24), .b(new_n95_), .O(z14));
