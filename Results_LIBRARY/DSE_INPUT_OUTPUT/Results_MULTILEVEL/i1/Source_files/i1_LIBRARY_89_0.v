...
module FAU ( 
  ...
  nand4  g32(.a(new_n65_), .b(new_n59_), .c(new_n66_), .d(new_n52_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(x04), .O(new_n75_));
  ...
  nand3  g44(.a(new_n78_), .b(x22), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z11));
  nand3  g46(.a(new_n78_), .b(x23), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z12));
  nand3  g48(.a(new_n83_), .b(x23), .c(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z13));
  and2   g50(.a(new_n83_), .b(x16), .O(z14));
