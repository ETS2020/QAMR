...
module FAU ( 
  ...
  aoi21  g06(.a(x01), .b(new_n42_), .c(new_n43_), .O(z02));
  ...
  oai21  g24(.a(new_n65_), .b(new_n64_), .c(new_n51_), .O(z10));
  inv1   g25(.a(x17), .O(new_n67_));
  oai21  g26(.a(new_n65_), .b(new_n67_), .c(new_n51_), .O(z11));
  nand4  g27(.a(new_n51_), .b(new_n62_), .c(x23), .d(x14), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z12));
  nand4  g29(.a(new_n51_), .b(new_n62_), .c(x23), .d(x17), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z13));
  inv1   g31(.a(x16), .O(new_n73_));
  oai21  g32(.a(new_n43_), .b(x01), .c(new_n62_), .O(new_n74_));
