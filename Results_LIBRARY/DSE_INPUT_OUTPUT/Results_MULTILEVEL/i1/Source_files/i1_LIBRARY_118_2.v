...
module FAU ( 
  ...
  oai21  g16(.a(new_n47_), .b(x00), .c(x07), .O(new_n58_));
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(x08), .d(new_n43_), .O(new_n66_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n65_), .d(new_n43_), .O(new_n77_));
  ...
  nand3  g44(.a(new_n81_), .b(x22), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n45_), .O(z10));
  nand4  g46(.a(new_n45_), .b(new_n81_), .c(x22), .d(x17), .O(new_n88_));
  ...
  nand2  g54(.a(new_n81_), .b(x16), .O(new_n96_));
