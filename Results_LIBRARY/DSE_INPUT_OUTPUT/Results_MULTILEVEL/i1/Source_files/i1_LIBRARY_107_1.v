...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n75_, new_n78_, new_n79_, new_n80_, new_n81_,
  ...
  nand4  g39(.a(new_n61_), .b(x19), .c(x14), .d(new_n80_), .O(new_n81_));
  ...
  nand2  g47(.a(new_n87_), .b(x22), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n56_), .c(new_n75_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n75_), .O(z11));
  nand3  g51(.a(new_n87_), .b(x23), .c(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand4  g53(.a(new_n75_), .b(new_n87_), .c(x23), .d(x17), .O(new_n95_));
  ...
  oai21  g58(.a(new_n99_), .b(x19), .c(new_n56_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
