...
module FAU ( 
  ...
  nand4  g36(.a(new_n77_), .b(new_n51_), .c(new_n45_), .d(new_n50_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n60_), .c(new_n75_), .O(z05));
  nand2  g38(.a(new_n76_), .b(x06), .O(z06));
  ...
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n74_), .O(z09));
  ...
  nand2  g56(.a(new_n97_), .b(new_n74_), .O(z14));
