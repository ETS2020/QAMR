...
module FAU ( 
  ...
  nor2   g14(.a(x05), .b(new_n42_), .O(new_n56_));
  ...
  nor2   g23(.a(new_n64_), .b(x05), .O(new_n65_));
  ...
  nor2   g31(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(x05), .c(x19), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n70_), .O(z05));
  nor2   g34(.a(new_n45_), .b(x05), .O(z06));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n43_), .O(z09));
  nand3  g41(.a(new_n81_), .b(x22), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n43_), .O(z10));
  nand4  g43(.a(new_n43_), .b(new_n81_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n81_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n43_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n43_), .O(z13));
