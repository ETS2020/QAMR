...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n76_, new_n78_, new_n79_, new_n81_, new_n83_,
  ...
  aoi21  g30(.a(new_n71_), .b(new_n68_), .c(x13), .O(new_n72_));
  ...
  aoi22  g35(.a(new_n76_), .b(new_n74_), .c(x19), .d(x13), .O(z04));
  nand2  g36(.a(new_n43_), .b(x10), .O(new_n78_));
  nand3  g37(.a(new_n65_), .b(new_n61_), .c(new_n48_), .O(new_n79_));
  nor2   g38(.a(new_n59_), .b(x13), .O(z06));
  nand3  g39(.a(z06), .b(new_n62_), .c(new_n69_), .O(new_n81_));
  ...
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n43_), .O(z09));
  nand3  g47(.a(new_n43_), .b(new_n87_), .c(x22), .O(new_n89_));
  ...
  nand4  g53(.a(new_n43_), .b(new_n87_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n87_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n43_), .O(z13));
  inv1   g57(.a(x16), .O(new_n99_));
  oai21  g58(.a(x24), .b(new_n99_), .c(new_n43_), .O(z14));
  nor3   g59(.a(x15), .b(x14), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n59_), .b(x13), .O(new_n102_));
  oai21  g61(.a(new_n101_), .b(x13), .c(new_n102_), .O(z15));
endmodule
