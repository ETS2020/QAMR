...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n73_, new_n77_, new_n78_, new_n79_, new_n81_, new_n83_,
  ...
  nand3  g31(.a(new_n72_), .b(x20), .c(x19), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z02));
  nand2  g33(.a(new_n57_), .b(new_n43_), .O(z03));
  ...
  nand4  g54(.a(new_n45_), .b(new_n87_), .c(x23), .d(x14), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z12));
  nand3  g56(.a(new_n87_), .b(x23), .c(x17), .O(new_n98_));
