...
module FAU ( 
  ...
  nand4  g45(.a(new_n73_), .b(new_n82_), .c(x22), .d(x14), .O(new_n87_));
  ...
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n73_), .O(z12));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n73_), .O(z13));
