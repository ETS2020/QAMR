...
module FAU ( 
  ...
  aoi21  g31(.a(new_n72_), .b(new_n69_), .c(x17), .O(new_n73_));
  ...
  nand4  g39(.a(new_n63_), .b(x19), .c(new_n43_), .d(new_n70_), .O(new_n81_));
  ...
  nand2  g49(.a(new_n87_), .b(x22), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n44_), .c(new_n43_), .O(z11));
  nand4  g51(.a(new_n46_), .b(new_n87_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand2  g53(.a(new_n87_), .b(x23), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n44_), .c(new_n43_), .O(z13));
  ...
  nand4  g60(.a(new_n101_), .b(new_n46_), .c(new_n100_), .d(new_n99_), .O(z15));
  buf    g61(.a(x19), .O(z06));
endmodule
