...
module FAU ( 
  ...
  nand2  g02(.a(new_n43_), .b(x01), .O(new_n44_));
  ...
  oai21  g15(.a(new_n43_), .b(x00), .c(x01), .O(new_n57_));
  ...
  nand3  g31(.a(new_n44_), .b(new_n72_), .c(new_n69_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nand4  g33(.a(new_n49_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n75_));
  nand4  g34(.a(x19), .b(new_n63_), .c(new_n51_), .d(new_n50_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  oai21  g37(.a(new_n43_), .b(new_n74_), .c(new_n78_), .O(z05));
  nand2  g38(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n44_), .O(z09));
  nand4  g45(.a(new_n44_), .b(new_n85_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n85_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n44_), .O(z11));
  nand4  g49(.a(new_n44_), .b(new_n85_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n85_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z13));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n70_), .O(z15));
endmodule
