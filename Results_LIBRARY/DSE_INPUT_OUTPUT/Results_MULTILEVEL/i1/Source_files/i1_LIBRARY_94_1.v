...
module FAU ( 
  ...
  nand3  g26(.a(new_n45_), .b(new_n67_), .c(new_n65_), .O(z04));
  ...
  nand2  g36(.a(new_n77_), .b(new_n45_), .O(z10));
  ...
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z12));
  nand4  g41(.a(new_n45_), .b(new_n75_), .c(x23), .d(x17), .O(new_n83_));
  ...
  nor3   g46(.a(new_n44_), .b(x13), .c(x12), .O(new_n88_));
