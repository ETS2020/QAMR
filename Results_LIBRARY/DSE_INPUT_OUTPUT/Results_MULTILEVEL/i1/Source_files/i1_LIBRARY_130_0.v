...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n78_, new_n79_, new_n81_, new_n84_, new_n85_, new_n87_,
  ...
  nand2  g35(.a(x21), .b(new_n45_), .O(z06));
  inv1   g36(.a(x18), .O(new_n78_));
  nand2  g37(.a(new_n57_), .b(x24), .O(new_n79_));
  ...
  nand2  g51(.a(new_n92_), .b(new_n57_), .O(z13));
