...
module FAU ( 
  ...
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n45_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n45_), .O(z11));
  nand4  g50(.a(new_n45_), .b(new_n87_), .c(x23), .d(x14), .O(new_n92_));
