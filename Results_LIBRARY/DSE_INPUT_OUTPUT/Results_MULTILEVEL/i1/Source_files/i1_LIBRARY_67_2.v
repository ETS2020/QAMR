...
module FAU ( 
  ...
  nand4  g46(.a(new_n65_), .b(x22), .c(new_n43_), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand2  g48(.a(x22), .b(x17), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n43_), .c(x24), .O(z11));
  nand4  g50(.a(new_n65_), .b(x23), .c(new_n43_), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand4  g52(.a(new_n65_), .b(x23), .c(new_n43_), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  aoi21  g55(.a(new_n43_), .b(new_n96_), .c(x24), .O(z14));
