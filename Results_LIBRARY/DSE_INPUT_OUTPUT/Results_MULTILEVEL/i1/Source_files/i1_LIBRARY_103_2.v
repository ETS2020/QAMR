...
module FAU ( 
  ...
  nand3  g42(.a(new_n80_), .b(x22), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n72_), .O(z10));
  nand4  g44(.a(new_n72_), .b(new_n80_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  nand4  g46(.a(new_n72_), .b(new_n80_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n80_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n72_), .O(z13));
