...
module FAU ( 
  ...
  nand3  g32(.a(new_n60_), .b(x19), .c(new_n73_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n63_), .c(new_n72_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n45_), .O(new_n76_));
  oai21  g35(.a(x19), .b(new_n72_), .c(new_n76_), .O(z05));
  ...
  aoi22  g56(.a(new_n97_), .b(new_n96_), .c(x19), .d(x07), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
