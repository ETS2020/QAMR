...
module FAU ( 
  ...
  nand4  g11(.a(new_n52_), .b(new_n51_), .c(new_n43_), .d(new_n50_), .O(new_n53_));
  ...
  inv1   g17(.a(x14), .O(new_n59_));
  aoi21  g18(.a(x19), .b(x00), .c(new_n59_), .O(new_n60_));
  ...
  nand4  g23(.a(new_n64_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n65_));
  inv1   g24(.a(x08), .O(new_n66_));
  nor2   g25(.a(x09), .b(new_n66_), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n51_), .c(new_n43_), .d(new_n50_), .O(new_n68_));
  ...
  nand4  g34(.a(x19), .b(new_n66_), .c(new_n51_), .d(new_n50_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n65_), .c(new_n75_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  oai21  g37(.a(new_n59_), .b(new_n75_), .c(new_n78_), .O(z05));
  inv1   g38(.a(x19), .O(new_n80_));
  nand2  g39(.a(new_n45_), .b(new_n80_), .O(z06));
