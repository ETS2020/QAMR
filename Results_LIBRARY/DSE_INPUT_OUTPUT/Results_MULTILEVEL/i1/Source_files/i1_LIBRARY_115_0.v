...
module FAU ( 
  ...
  nand4  g20(.a(new_n61_), .b(x08), .c(new_n51_), .d(new_n50_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n60_), .c(x19), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n45_), .O(new_n64_));
  nor3   g23(.a(x03), .b(x02), .c(x01), .O(new_n65_));
  nor2   g24(.a(x05), .b(x04), .O(new_n66_));
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(new_n45_), .d(new_n51_), .O(new_n67_));
  ...
  nor2   g33(.a(x08), .b(x06), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n66_), .c(new_n65_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(x07), .O(new_n77_));
  or2    g36(.a(new_n77_), .b(x10), .O(z05));
  inv1   g37(.a(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x07), .O(z06));
  inv1   g39(.a(x18), .O(new_n81_));
  nand2  g40(.a(new_n73_), .b(x24), .O(new_n82_));
  ...
  nor2   g45(.a(new_n43_), .b(x24), .O(new_n87_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n73_), .O(z11));
  ...
  and2   g55(.a(new_n87_), .b(x16), .O(z14));
  nor2   g56(.a(x13), .b(x12), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z15));
endmodule
