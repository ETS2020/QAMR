...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(new_n60_), .c(x08), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n59_), .c(x19), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n46_), .O(new_n64_));
  nand4  g23(.a(new_n61_), .b(new_n58_), .c(new_n57_), .d(new_n46_), .O(new_n65_));
  ...
  nor3   g31(.a(x04), .b(x03), .c(x02), .O(new_n73_));
  nor2   g32(.a(x08), .b(x07), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n73_), .c(new_n50_), .d(new_n49_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x19), .c(x01), .O(new_n76_));
  or2    g35(.a(new_n76_), .b(x10), .O(z05));
  nand2  g36(.a(new_n45_), .b(x01), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  nand2  g38(.a(new_n69_), .b(x24), .O(new_n80_));
  ...
  nand2  g51(.a(new_n92_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n91_), .c(new_n69_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n69_), .O(z13));
