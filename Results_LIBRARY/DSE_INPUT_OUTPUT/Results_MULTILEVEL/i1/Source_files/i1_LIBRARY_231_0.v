...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  nor3   g23(.a(x03), .b(x02), .c(x01), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n61_), .c(new_n50_), .d(new_n58_), .O(new_n66_));
  nand3  g25(.a(new_n66_), .b(x19), .c(x00), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n64_), .O(z02));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n44_), .O(z11));
  nand2  g46(.a(new_n81_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n83_), .c(new_n44_), .O(z12));
  oai21  g48(.a(new_n88_), .b(new_n86_), .c(new_n44_), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  nor3   g50(.a(new_n43_), .b(x24), .c(new_n91_), .O(z14));
