...
module FAU ( 
  ...
  nand3  g29(.a(new_n70_), .b(new_n46_), .c(x19), .O(new_n71_));
  ...
  nand3  g40(.a(new_n81_), .b(new_n46_), .c(new_n77_), .O(z05));
  nor2   g41(.a(new_n45_), .b(new_n79_), .O(z06));
  inv1   g42(.a(x24), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n43_), .c(new_n44_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n46_), .b(new_n86_), .O(z08));
  nand3  g46(.a(new_n46_), .b(x24), .c(x11), .O(new_n88_));
  ...
  nand3  g51(.a(new_n84_), .b(x22), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n46_), .O(z11));
  ...
  nand2  g60(.a(new_n44_), .b(x15), .O(new_n102_));
