...
module FAU ( 
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x11), .O(new_n77_));
  ...
  nand2  g43(.a(new_n43_), .b(new_n80_), .O(z08));
  nor2   g44(.a(new_n83_), .b(new_n80_), .O(z09));
  ...
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(z11));
  nand3  g51(.a(new_n83_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n90_), .O(z12));
