...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n90_, new_n91_, new_n93_, new_n95_, new_n97_,
    new_n98_, new_n99_;
  ...
  nand3  g19(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n60_), .c(x00), .O(new_n62_));
  nand4  g21(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n63_));
  inv1   g22(.a(x09), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(x08), .c(new_n51_), .d(new_n50_), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(x07), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n62_), .c(new_n59_), .O(z02));
  inv1   g27(.a(x20), .O(new_n69_));
  nand2  g28(.a(new_n43_), .b(new_n69_), .O(z03));
  inv1   g29(.a(x21), .O(new_n71_));
  aoi22  g30(.a(new_n71_), .b(new_n69_), .c(x19), .d(x07), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  inv1   g32(.a(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n60_), .c(new_n45_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n73_), .O(z05));
  nand3  g37(.a(new_n43_), .b(x24), .c(x18), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n43_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n43_), .O(z09));
  nand3  g43(.a(new_n83_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n43_), .O(z10));
  nand4  g45(.a(new_n43_), .b(new_n83_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand3  g47(.a(new_n43_), .b(new_n83_), .c(x23), .O(new_n89_));
  ...
  oai21  g54(.a(x24), .b(new_n95_), .c(new_n43_), .O(z14));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x13), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nand4  g58(.a(new_n99_), .b(new_n43_), .c(new_n98_), .d(new_n97_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
