...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n79_, new_n82_, new_n83_, new_n85_, new_n87_, new_n89_,
  ...
  nand2  g38(.a(new_n69_), .b(new_n79_), .O(z08));
  oai21  g39(.a(new_n77_), .b(new_n79_), .c(new_n69_), .O(z09));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n77_), .b(x22), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n69_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n69_), .O(z11));
  nand4  g45(.a(new_n69_), .b(new_n77_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n77_), .b(x23), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n69_), .O(z13));
  nand2  g49(.a(new_n77_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n69_), .O(z14));
