...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(new_n59_), .O(new_n66_));
  nor3   g25(.a(x03), .b(x02), .c(x01), .O(new_n67_));
  nor2   g26(.a(x07), .b(x06), .O(new_n68_));
  nand4  g27(.a(new_n68_), .b(new_n67_), .c(new_n49_), .d(new_n60_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x19), .c(x00), .O(new_n70_));
  oai21  g29(.a(new_n66_), .b(x09), .c(new_n70_), .O(z02));
  ...
  nand4  g36(.a(new_n77_), .b(new_n63_), .c(new_n62_), .d(new_n51_), .O(new_n78_));
