...
module FAU ( 
  ...
  oai21  g31(.a(new_n70_), .b(new_n42_), .c(new_n43_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor2   g33(.a(new_n42_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n65_), .c(new_n64_), .d(new_n51_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(new_n74_), .O(z05));
  nand2  g36(.a(x21), .b(new_n42_), .O(z06));
  ...
  nand4  g51(.a(new_n44_), .b(new_n86_), .c(x23), .d(x14), .O(new_n93_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n71_), .O(z15));
endmodule
