...
module FAU ( 
  ...
  aoi21  g26(.a(new_n67_), .b(new_n52_), .c(new_n46_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n64_), .c(new_n43_), .O(z02));
  ...
  oai21  g40(.a(new_n78_), .b(new_n80_), .c(new_n75_), .O(z09));
  nand4  g41(.a(new_n75_), .b(new_n78_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n78_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n75_), .O(z11));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n78_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n75_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n75_), .O(z13));
  nand2  g50(.a(new_n78_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n75_), .O(z14));
