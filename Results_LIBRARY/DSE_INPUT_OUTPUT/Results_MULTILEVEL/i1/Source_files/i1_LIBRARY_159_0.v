...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n79_, new_n82_, new_n84_, new_n86_, new_n87_,
  ...
  nand2  g38(.a(new_n79_), .b(new_n78_), .O(z08));
  oai21  g39(.a(new_n76_), .b(new_n78_), .c(new_n79_), .O(z09));
  nand3  g40(.a(new_n76_), .b(x22), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n79_), .O(z10));
  nand4  g42(.a(new_n79_), .b(new_n76_), .c(x22), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z11));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n76_), .b(x23), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n79_), .O(z12));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n79_), .O(z13));
  nand2  g49(.a(new_n76_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n79_), .O(z14));
