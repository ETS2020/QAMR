...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n87_, new_n89_, new_n91_, new_n93_, new_n95_,
  ...
  nand3  g36(.a(new_n65_), .b(new_n66_), .c(new_n52_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n64_), .c(new_n43_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n77_), .O(z05));
  nand3  g40(.a(new_n75_), .b(x24), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  nand3  g42(.a(x24), .b(new_n44_), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x24), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x22), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n75_), .O(z10));
  nand4  g47(.a(new_n75_), .b(new_n86_), .c(x22), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand4  g49(.a(new_n75_), .b(new_n86_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n86_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n75_), .O(z13));
  nand2  g53(.a(new_n86_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n75_), .O(z14));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x13), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nand4  g58(.a(new_n99_), .b(new_n75_), .c(new_n98_), .d(new_n97_), .O(z15));
  buf    g59(.a(x19), .O(z06));
  buf    g60(.a(x11), .O(z08));
endmodule
