...
module FAU ( 
  ...
  nor2   g39(.a(new_n44_), .b(x13), .O(z06));
  ...
  oai21  g53(.a(new_n94_), .b(new_n88_), .c(new_n73_), .O(z12));
  oai21  g54(.a(new_n94_), .b(new_n92_), .c(new_n73_), .O(z13));
  nand3  g55(.a(new_n73_), .b(new_n89_), .c(x16), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z14));
  nor3   g57(.a(x15), .b(x14), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n44_), .b(x13), .O(new_n100_));
  oai21  g59(.a(new_n99_), .b(x13), .c(new_n100_), .O(z15));
endmodule
