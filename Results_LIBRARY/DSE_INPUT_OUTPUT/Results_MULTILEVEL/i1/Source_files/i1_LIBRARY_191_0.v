...
module FAU ( 
  ...
  nand4  g35(.a(new_n62_), .b(x19), .c(new_n76_), .d(new_n45_), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n60_), .c(new_n43_), .d(new_n75_), .O(z05));
  ...
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n81_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n81_), .O(z11));
  nand4  g51(.a(new_n81_), .b(new_n86_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n86_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n81_), .O(z13));
  nand2  g55(.a(new_n86_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n81_), .O(z14));
