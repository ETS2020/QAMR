...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n77_, new_n78_, new_n81_, new_n84_, new_n86_,
  ...
  oai21  g41(.a(new_n64_), .b(new_n81_), .c(new_n45_), .O(z09));
  nand2  g42(.a(x22), .b(x14), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n43_), .c(x24), .O(z10));
  nand2  g44(.a(x22), .b(x17), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n43_), .c(x24), .O(z11));
  nand2  g46(.a(x23), .b(x14), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n43_), .c(x24), .O(z12));
  nand2  g48(.a(x23), .b(x17), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n43_), .c(x24), .O(z13));
  nand3  g50(.a(new_n64_), .b(new_n43_), .c(x16), .O(new_n92_));
