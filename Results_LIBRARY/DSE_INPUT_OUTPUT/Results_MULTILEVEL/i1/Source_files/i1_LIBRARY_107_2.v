...
module FAU ( 
  ...
  nand2  g43(.a(new_n83_), .b(x22), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x19), .c(new_n43_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n46_), .O(z11));
  nor2   g47(.a(new_n60_), .b(new_n43_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n83_), .c(x23), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand2  g50(.a(new_n60_), .b(x14), .O(new_n92_));
  nand4  g51(.a(new_n92_), .b(new_n83_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n83_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n46_), .O(z14));
  inv1   g55(.a(new_n89_), .O(new_n97_));
  nor3   g56(.a(x15), .b(x13), .c(x12), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(x14), .c(new_n97_), .O(z15));
endmodule
