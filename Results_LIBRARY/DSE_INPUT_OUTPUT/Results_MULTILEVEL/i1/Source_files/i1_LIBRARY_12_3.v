...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n70_, new_n71_, new_n72_, new_n75_, new_n77_,
  ...
  nor2   g32(.a(new_n71_), .b(x08), .O(z06));
  ...
  oai21  g39(.a(new_n80_), .b(new_n77_), .c(new_n42_), .O(z09));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n80_), .b(x22), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n42_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n42_), .O(z11));
  nand3  g45(.a(new_n42_), .b(new_n80_), .c(x23), .O(new_n87_));
  ...
  nand3  g51(.a(new_n42_), .b(new_n80_), .c(x16), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z14));
  nor2   g53(.a(x13), .b(x12), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n78_), .O(z15));
endmodule
