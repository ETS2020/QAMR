...
module FAU ( 
  ...
  nand2  g50(.a(new_n91_), .b(new_n82_), .O(z11));
  nand3  g51(.a(new_n90_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n82_), .O(z12));
  ...
  nand4  g60(.a(new_n101_), .b(new_n82_), .c(new_n100_), .d(new_n99_), .O(z15));
  buf    g61(.a(x11), .O(z08));
endmodule
