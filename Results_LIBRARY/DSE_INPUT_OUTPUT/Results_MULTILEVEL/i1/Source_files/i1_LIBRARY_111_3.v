...
module FAU ( 
  ...
  nand3  g26(.a(new_n42_), .b(new_n67_), .c(new_n65_), .O(z04));
  ...
  nand3  g33(.a(new_n42_), .b(x24), .c(x18), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nand2  g36(.a(new_n42_), .b(new_n77_), .O(z08));
  ...
  nand2  g41(.a(new_n82_), .b(new_n42_), .O(z10));
  nand4  g42(.a(new_n42_), .b(new_n81_), .c(x22), .d(x17), .O(new_n84_));
  ...
  nand4  g55(.a(new_n96_), .b(new_n42_), .c(new_n95_), .d(new_n94_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
