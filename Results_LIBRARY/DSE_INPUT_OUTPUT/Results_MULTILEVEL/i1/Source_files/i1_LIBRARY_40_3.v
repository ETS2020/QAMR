...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n87_, new_n89_, new_n90_, new_n92_, new_n94_,
  ...
  nor2   g14(.a(x12), .b(new_n42_), .O(new_n56_));
  ...
  nand3  g30(.a(new_n71_), .b(x19), .c(new_n58_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z02));
  inv1   g32(.a(x20), .O(new_n74_));
  aoi21  g33(.a(x19), .b(x12), .c(new_n74_), .O(z03));
  inv1   g34(.a(x21), .O(new_n76_));
  nand3  g35(.a(new_n43_), .b(new_n76_), .c(new_n74_), .O(z04));
  nand2  g36(.a(new_n43_), .b(x10), .O(new_n78_));
  nand3  g37(.a(new_n64_), .b(new_n60_), .c(new_n48_), .O(new_n79_));
  inv1   g38(.a(x08), .O(new_n80_));
  nand4  g39(.a(new_n61_), .b(x19), .c(new_n58_), .d(new_n80_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(z05));
  nand2  g41(.a(x24), .b(x18), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n43_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nand2  g44(.a(new_n43_), .b(new_n85_), .O(z08));
  nand3  g45(.a(new_n43_), .b(x24), .c(x11), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z09));
  inv1   g47(.a(x24), .O(new_n89_));
  nand4  g48(.a(new_n43_), .b(new_n89_), .c(x22), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z10));
  nand3  g50(.a(new_n89_), .b(x22), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n43_), .O(z11));
  nand3  g52(.a(new_n89_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n43_), .O(z12));
  nand4  g54(.a(new_n43_), .b(new_n89_), .c(x23), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  inv1   g56(.a(x16), .O(new_n98_));
  oai21  g57(.a(x24), .b(new_n98_), .c(new_n43_), .O(z14));
  nor3   g58(.a(x15), .b(x14), .c(x13), .O(new_n100_));
  nand2  g59(.a(new_n45_), .b(x12), .O(new_n101_));
  oai21  g60(.a(new_n100_), .b(x12), .c(new_n101_), .O(z15));
  buf    g61(.a(x19), .O(z06));
endmodule
