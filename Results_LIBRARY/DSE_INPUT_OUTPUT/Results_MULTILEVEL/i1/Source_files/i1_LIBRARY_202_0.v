...
module FAU ( 
  ...
  nand4  g32(.a(new_n73_), .b(new_n63_), .c(new_n62_), .d(new_n51_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n69_), .c(new_n72_), .O(z05));
  ...
  nor3   g52(.a(x15), .b(x14), .c(x12), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n45_), .c(new_n93_), .O(z15));
  buf    g54(.a(x19), .O(z06));
endmodule
