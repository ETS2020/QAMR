...
module FAU ( 
  ...
  nor2   g34(.a(new_n45_), .b(x08), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n63_), .d(new_n51_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n57_), .c(new_n74_), .O(z05));
  ...
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n57_), .O(z09));
  nand3  g43(.a(new_n80_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n57_), .O(z10));
  nand4  g45(.a(new_n57_), .b(new_n80_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n80_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n57_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n57_), .O(z13));
