...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n86_,
  ...
  nand4  g19(.a(new_n60_), .b(x08), .c(new_n52_), .d(new_n50_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(x19), .O(new_n62_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n59_), .c(new_n73_), .O(z05));
  nand2  g35(.a(new_n46_), .b(x06), .O(z06));
  ...
  nor3   g41(.a(new_n43_), .b(new_n82_), .c(new_n80_), .O(z09));
  inv1   g42(.a(x22), .O(new_n84_));
  nand2  g43(.a(new_n44_), .b(new_n82_), .O(new_n85_));
  ...
  nand4  g51(.a(new_n44_), .b(new_n82_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  inv1   g53(.a(x16), .O(new_n95_));
  nor2   g54(.a(new_n85_), .b(new_n95_), .O(z14));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  nor3   g56(.a(new_n43_), .b(x13), .c(x12), .O(new_n98_));
