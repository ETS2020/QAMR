...
module FAU ( 
  ...
  nand3  g30(.a(new_n71_), .b(x19), .c(x18), .O(new_n72_));
  ...
  nand3  g36(.a(new_n65_), .b(new_n61_), .c(new_n49_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  inv1   g38(.a(x18), .O(new_n80_));
  nor2   g39(.a(new_n43_), .b(new_n80_), .O(z06));
  nand3  g40(.a(z06), .b(new_n62_), .c(new_n79_), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n78_), .c(new_n44_), .d(new_n77_), .O(z05));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n80_), .c(new_n45_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nor2   g45(.a(new_n44_), .b(new_n86_), .O(z08));
  nor3   g46(.a(new_n44_), .b(new_n84_), .c(new_n86_), .O(z09));
  ...
  oai21  g53(.a(new_n94_), .b(new_n89_), .c(new_n45_), .O(z12));
  oai21  g54(.a(new_n94_), .b(new_n92_), .c(new_n45_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  nor3   g56(.a(new_n44_), .b(x24), .c(new_n97_), .O(z14));
