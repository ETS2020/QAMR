...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n92_, new_n94_,
  ...
  nand4  g40(.a(new_n62_), .b(new_n44_), .c(x19), .d(new_n81_), .O(new_n82_));
  ...
  oai21  g45(.a(new_n44_), .b(new_n43_), .c(new_n86_), .O(z08));
  ...
  nand3  g50(.a(new_n44_), .b(x22), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n77_), .O(z11));
  nand2  g52(.a(x23), .b(x14), .O(new_n94_));
  nor2   g53(.a(new_n94_), .b(x24), .O(z12));
  nand3  g54(.a(new_n44_), .b(x23), .c(x17), .O(new_n96_));
