...
module FAU ( 
  ...
  nand4  g32(.a(new_n73_), .b(new_n64_), .c(new_n50_), .d(new_n57_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(x05), .O(new_n75_));
  or2    g34(.a(new_n75_), .b(x10), .O(z05));
  nand2  g35(.a(new_n45_), .b(x05), .O(z06));
  ...
  oai21  g41(.a(new_n79_), .b(new_n81_), .c(new_n71_), .O(z09));
  ...
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n71_), .O(z12));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n71_), .O(z13));
