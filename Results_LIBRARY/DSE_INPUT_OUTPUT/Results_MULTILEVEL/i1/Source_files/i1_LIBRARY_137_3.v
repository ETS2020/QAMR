...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n61_, new_n63_, new_n64_, new_n65_, new_n67_, new_n69_,
  ...
  nand2  g22(.a(new_n57_), .b(new_n45_), .O(new_n64_));
  ...
  and2   g29(.a(new_n43_), .b(x11), .O(z08));
  nand3  g30(.a(new_n43_), .b(x24), .c(x11), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z09));
  inv1   g32(.a(x24), .O(new_n74_));
  nand4  g33(.a(new_n43_), .b(new_n74_), .c(x22), .d(x14), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand3  g35(.a(new_n74_), .b(x22), .c(x17), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(z11));
  nand3  g37(.a(new_n43_), .b(new_n74_), .c(x23), .O(new_n79_));
