...
module FAU ( 
  ...
  inv1   g00(.a(x23), .O(new_n42_));
  nand2  g01(.a(new_n42_), .b(x21), .O(new_n43_));
  ...
  nand2  g30(.a(x23), .b(x21), .O(new_n72_));
  oai21  g31(.a(x21), .b(new_n70_), .c(new_n72_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor4   g33(.a(new_n66_), .b(new_n58_), .c(x08), .d(x07), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n64_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n43_), .c(new_n74_), .O(z05));
  nand2  g36(.a(new_n43_), .b(new_n58_), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(x24), .O(new_n80_));
  inv1   g39(.a(new_n43_), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n43_), .b(new_n83_), .O(z08));
  oai21  g43(.a(new_n80_), .b(new_n83_), .c(new_n43_), .O(z09));
  nand3  g44(.a(new_n80_), .b(x22), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n43_), .O(z10));
  nand4  g46(.a(new_n43_), .b(new_n80_), .c(x22), .d(x17), .O(new_n88_));
  ...
  nor3   g53(.a(new_n81_), .b(x24), .c(new_n94_), .O(z14));
  nor2   g54(.a(x13), .b(x12), .O(new_n96_));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n81_), .O(z15));
endmodule
