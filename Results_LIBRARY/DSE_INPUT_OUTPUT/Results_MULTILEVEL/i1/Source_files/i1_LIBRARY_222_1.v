...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n78_, new_n80_, new_n81_, new_n83_, new_n86_,
  ...
  oai21  g31(.a(x21), .b(new_n69_), .c(new_n72_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor2   g33(.a(new_n42_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n64_), .c(new_n63_), .d(new_n50_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n43_), .c(new_n74_), .O(z05));
  inv1   g36(.a(x21), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n42_), .O(z06));
  inv1   g38(.a(x18), .O(new_n80_));
  nand2  g39(.a(new_n43_), .b(x24), .O(new_n81_));
  ...
  nand2  g46(.a(new_n43_), .b(new_n87_), .O(new_n88_));
  ...
  nand4  g52(.a(new_n43_), .b(new_n87_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n87_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(z13));
