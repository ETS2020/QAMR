...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n78_, new_n81_, new_n83_, new_n86_,
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(x24), .O(new_n68_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(new_n44_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nor2   g38(.a(x24), .b(new_n43_), .O(z06));
  nand3  g39(.a(x24), .b(new_n43_), .c(x18), .O(new_n81_));
  ...
  nor3   g50(.a(x24), .b(new_n91_), .c(new_n86_), .O(z12));
  nor3   g51(.a(x24), .b(new_n91_), .c(new_n89_), .O(z13));
  nand2  g52(.a(new_n44_), .b(x16), .O(new_n94_));
