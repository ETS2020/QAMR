// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:51 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n80_, new_n82_, new_n84_, new_n86_,
  ...
  nor3   g18(.a(x04), .b(x03), .c(x02), .O(new_n60_));
  nor2   g19(.a(x07), .b(x06), .O(new_n61_));
  nand3  g20(.a(new_n61_), .b(new_n60_), .c(new_n50_), .O(new_n62_));
  ...
  oai21  g25(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(x19), .c(new_n43_), .O(new_n68_));
  ...
  nand4  g33(.a(new_n74_), .b(new_n60_), .c(new_n51_), .d(new_n50_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n43_), .c(new_n44_), .O(new_n76_));
  or2    g35(.a(new_n76_), .b(x10), .O(z05));
  nor2   g36(.a(new_n44_), .b(x01), .O(z06));
  inv1   g37(.a(new_n45_), .O(new_n79_));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n79_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n79_), .b(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z09));
  nand4  g44(.a(new_n79_), .b(new_n84_), .c(x22), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand3  g46(.a(new_n84_), .b(x22), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n79_), .O(z11));
  nand3  g48(.a(new_n84_), .b(x23), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n79_), .O(z12));
  nand4  g50(.a(new_n79_), .b(new_n84_), .c(x23), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z13));
  nand2  g52(.a(new_n84_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n79_), .O(z14));
  inv1   g54(.a(x12), .O(new_n96_));
  inv1   g55(.a(x13), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nand4  g57(.a(new_n98_), .b(new_n79_), .c(new_n97_), .d(new_n96_), .O(z15));
endmodule
