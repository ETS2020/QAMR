...
module FAU ( 
  ...
  nand2  g01(.a(x21), .b(new_n42_), .O(new_n43_));
  ...
  nand2  g27(.a(x21), .b(x19), .O(new_n69_));
  oai21  g28(.a(x21), .b(new_n67_), .c(new_n69_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nor2   g30(.a(new_n42_), .b(x08), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n62_), .c(new_n61_), .d(new_n50_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n43_), .c(new_n71_), .O(z05));
  inv1   g33(.a(x18), .O(new_n75_));
  inv1   g34(.a(x24), .O(new_n76_));
  inv1   g35(.a(new_n43_), .O(new_n77_));
  nor3   g36(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n43_), .b(new_n79_), .O(z08));
  oai21  g39(.a(new_n76_), .b(new_n79_), .c(new_n43_), .O(z09));
  inv1   g40(.a(x22), .O(new_n82_));
  nor3   g41(.a(new_n77_), .b(x24), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g46(.a(new_n43_), .b(new_n76_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n76_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n43_), .O(z13));
  nand2  g50(.a(new_n76_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n43_), .O(z14));
  nor2   g52(.a(x13), .b(x12), .O(new_n94_));
  nor2   g53(.a(x15), .b(x14), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n77_), .O(z15));
  buf    g55(.a(x19), .O(z06));
endmodule
