...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n75_, new_n76_, new_n79_, new_n81_, new_n83_, new_n85_,
  ...
  nand2  g30(.a(x21), .b(new_n43_), .O(new_n72_));
  oai21  g31(.a(new_n43_), .b(new_n60_), .c(new_n72_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor2   g33(.a(new_n60_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n67_), .c(new_n66_), .d(new_n52_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n45_), .c(new_n74_), .O(z05));
  nand2  g36(.a(new_n43_), .b(new_n60_), .O(z06));
  ...
  nand4  g45(.a(new_n45_), .b(new_n83_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand3  g47(.a(new_n83_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z12));
  nand4  g49(.a(new_n45_), .b(new_n83_), .c(x23), .d(x17), .O(new_n91_));
