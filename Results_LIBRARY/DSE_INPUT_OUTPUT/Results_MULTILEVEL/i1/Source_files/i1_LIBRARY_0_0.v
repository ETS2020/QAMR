// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:00 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n77_, new_n80_, new_n81_, new_n83_, new_n86_,
  ...
  nand3  g20(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n62_));
  nand4  g21(.a(new_n46_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n62_), .c(x00), .O(new_n64_));
  nand4  g23(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n65_));
  ...
  nand4  g28(.a(new_n69_), .b(new_n67_), .c(new_n66_), .d(new_n46_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n64_), .c(new_n61_), .O(z02));
  ...
  nand4  g35(.a(new_n67_), .b(x19), .c(new_n68_), .d(new_n46_), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n65_), .c(new_n43_), .d(new_n76_), .O(z05));
  nand2  g37(.a(new_n61_), .b(x07), .O(z06));
  ...
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n44_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n44_), .O(z11));
  inv1   g49(.a(x23), .O(new_n91_));
  nor3   g50(.a(new_n43_), .b(x24), .c(new_n91_), .O(new_n92_));
