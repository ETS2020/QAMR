...
module FAU ( 
  ...
  aoi21  g16(.a(new_n57_), .b(new_n51_), .c(x09), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x00), .c(new_n45_), .O(z01));
  ...
  nand4  g23(.a(x08), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n51_), .c(x09), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(new_n45_), .O(z02));
  ...
  oai21  g33(.a(new_n58_), .b(new_n45_), .c(new_n74_), .O(z05));
  nor2   g34(.a(new_n45_), .b(x09), .O(z06));
  ...
  nor2   g41(.a(new_n71_), .b(x24), .O(new_n83_));
