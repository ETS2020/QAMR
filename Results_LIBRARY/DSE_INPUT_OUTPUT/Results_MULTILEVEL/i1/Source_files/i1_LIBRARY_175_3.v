...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(x17), .O(new_n70_));
  ...
  nand4  g45(.a(new_n46_), .b(new_n86_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand2  g47(.a(new_n86_), .b(x22), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n44_), .c(new_n43_), .O(z11));
  nand3  g49(.a(new_n86_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n46_), .O(z12));
  nand4  g51(.a(new_n86_), .b(x23), .c(new_n44_), .d(x17), .O(new_n93_));
