...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n78_, new_n79_, new_n81_, new_n84_, new_n85_,
  ...
  nand4  g17(.a(new_n51_), .b(new_n43_), .c(new_n50_), .d(new_n58_), .O(new_n59_));
  ...
  nand4  g30(.a(x19), .b(new_n64_), .c(new_n51_), .d(new_n50_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n62_), .c(x10), .O(new_n74_));
  nand2  g33(.a(x19), .b(x10), .O(new_n75_));
  oai21  g34(.a(new_n74_), .b(x06), .c(new_n75_), .O(z05));
  inv1   g35(.a(x18), .O(new_n77_));
  inv1   g36(.a(new_n44_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x24), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n77_), .O(z07));
  ...
  nand2  g47(.a(new_n88_), .b(new_n78_), .O(z11));
