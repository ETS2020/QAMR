...
module FAU ( 
  ...
  nor3   g17(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  nor2   g18(.a(x07), .b(x06), .O(new_n60_));
  nand3  g19(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(new_n61_));
  ...
  nand4  g34(.a(new_n75_), .b(new_n59_), .c(new_n50_), .d(new_n49_), .O(new_n76_));
  ...
  nand3  g48(.a(new_n43_), .b(new_n85_), .c(x23), .O(new_n90_));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n70_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
