...
module FAU ( 
  ...
  nand2  g40(.a(new_n45_), .b(x24), .O(new_n82_));
  ...
  nand4  g48(.a(new_n45_), .b(new_n87_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand3  g50(.a(new_n87_), .b(x23), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n45_), .O(z12));
  nand4  g52(.a(new_n45_), .b(new_n87_), .c(x23), .d(x17), .O(new_n94_));
  ...
  oai21  g58(.a(new_n98_), .b(x15), .c(new_n99_), .O(z15));
endmodule
