...
module FAU ( 
  ...
  nand4  g18(.a(new_n59_), .b(new_n58_), .c(new_n52_), .d(new_n51_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x00), .O(new_n61_));
  nor2   g20(.a(x04), .b(x03), .O(new_n62_));
  inv1   g21(.a(x09), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x08), .c(new_n52_), .O(new_n64_));
  nor3   g23(.a(new_n64_), .b(x06), .c(x05), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n66_));
  ...
  nand3  g31(.a(new_n72_), .b(new_n59_), .c(new_n58_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n44_), .b(new_n78_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  inv1   g45(.a(x23), .O(new_n87_));
  nand2  g46(.a(new_n44_), .b(new_n78_), .O(new_n88_));
