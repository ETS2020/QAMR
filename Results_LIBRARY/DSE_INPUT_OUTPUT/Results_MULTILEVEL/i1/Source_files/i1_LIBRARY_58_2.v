...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(new_n51_), .d(new_n59_), .O(new_n68_));
  ...
  nand3  g34(.a(new_n61_), .b(x19), .c(new_n53_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n60_), .c(new_n75_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  oai21  g37(.a(new_n47_), .b(new_n75_), .c(new_n78_), .O(z05));
  nand2  g38(.a(new_n47_), .b(new_n43_), .O(z06));
  ...
  nand3  g52(.a(new_n85_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z13));
