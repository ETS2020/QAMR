...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n49_, new_n51_, new_n53_,
    new_n54_, new_n55_, new_n57_, new_n58_, new_n60_, new_n62_, new_n64_,
  ...
  nor2   g10(.a(new_n51_), .b(new_n44_), .O(z04));
  ...
  nand2  g19(.a(new_n55_), .b(new_n60_), .O(z08));
  inv1   g20(.a(x24), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n60_), .c(new_n55_), .O(z09));
  nand4  g22(.a(new_n55_), .b(new_n62_), .c(x22), .d(x14), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(z10));
  nand4  g24(.a(new_n55_), .b(new_n62_), .c(x22), .d(x17), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z11));
  nand4  g26(.a(new_n55_), .b(new_n62_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  nand3  g28(.a(new_n62_), .b(x23), .c(x17), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n55_), .O(z13));
  ...
  nand4  g36(.a(new_n77_), .b(new_n55_), .c(new_n76_), .d(new_n75_), .O(z15));
  buf    g37(.a(x19), .O(z06));
endmodule
