...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    new_n53_, new_n54_, new_n56_, new_n58_, new_n59_, new_n61_, new_n64_,
  ...
  nand2  g12(.a(x19), .b(new_n53_), .O(new_n54_));
  nand3  g13(.a(new_n54_), .b(new_n52_), .c(new_n50_), .O(z04));
  ...
  nand2  g24(.a(new_n65_), .b(new_n54_), .O(z10));
  nand4  g25(.a(new_n54_), .b(new_n64_), .c(x22), .d(x17), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z11));
  nand4  g27(.a(new_n54_), .b(new_n64_), .c(x23), .d(x14), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z12));
  nand3  g29(.a(new_n64_), .b(x23), .c(x17), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n54_), .O(z13));
