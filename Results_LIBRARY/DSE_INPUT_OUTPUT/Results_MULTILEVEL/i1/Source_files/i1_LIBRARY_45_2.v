...
module FAU ( 
  ...
  nor2   g32(.a(new_n43_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n61_), .c(new_n73_), .O(z05));
  ...
  nor3   g42(.a(new_n70_), .b(x24), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g54(.a(x19), .b(x13), .O(new_n96_));
  oai21  g55(.a(new_n95_), .b(x13), .c(new_n96_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
