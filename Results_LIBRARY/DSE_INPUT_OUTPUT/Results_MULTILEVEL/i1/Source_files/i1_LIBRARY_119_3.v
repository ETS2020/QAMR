...
module FAU ( 
  ...
  aoi21  g33(.a(x19), .b(x10), .c(new_n74_), .O(z04));
  nand3  g34(.a(new_n64_), .b(new_n60_), .c(new_n48_), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  inv1   g36(.a(x19), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(x10), .O(z06));
  nand3  g38(.a(z06), .b(new_n61_), .c(new_n77_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n76_), .c(x19), .d(new_n45_), .O(z05));
  ...
  nand3  g51(.a(new_n43_), .b(new_n88_), .c(x23), .O(new_n93_));
