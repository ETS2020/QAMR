...
module FAU ( 
  ...
  nor2   g02(.a(x07), .b(new_n43_), .O(new_n44_));
  ...
  nand4  g13(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(new_n43_), .O(new_n55_));
  ...
  aoi21  g19(.a(new_n60_), .b(new_n59_), .c(x05), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(x07), .c(x00), .O(new_n62_));
  ...
  nand4  g33(.a(x19), .b(new_n67_), .c(new_n53_), .d(new_n52_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n65_), .c(x10), .O(new_n77_));
  nand2  g36(.a(x10), .b(x07), .O(new_n78_));
