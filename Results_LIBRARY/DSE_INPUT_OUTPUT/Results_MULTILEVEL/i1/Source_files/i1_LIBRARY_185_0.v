...
module FAU ( 
  ...
  nand4  g10(.a(new_n51_), .b(new_n42_), .c(new_n50_), .d(new_n49_), .O(new_n52_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n58_), .c(x08), .O(new_n60_));
  ...
  nand4  g23(.a(new_n64_), .b(new_n63_), .c(new_n49_), .d(new_n56_), .O(new_n65_));
  ...
  nand4  g33(.a(new_n59_), .b(x19), .c(new_n74_), .d(new_n42_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n57_), .c(new_n73_), .O(z05));
  ...
  nand2  g43(.a(new_n44_), .b(new_n84_), .O(new_n85_));
