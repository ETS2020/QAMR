...
module FAU ( 
  ...
  nand3  g23(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(z04));
  inv1   g24(.a(x10), .O(new_n66_));
  nand2  g25(.a(new_n58_), .b(new_n43_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x19), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n66_), .O(z05));
  nor2   g28(.a(new_n44_), .b(x08), .O(z06));
  ...
  nand3  g43(.a(new_n64_), .b(new_n75_), .c(x16), .O(new_n85_));
