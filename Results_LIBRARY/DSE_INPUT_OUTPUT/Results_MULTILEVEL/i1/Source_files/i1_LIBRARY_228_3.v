...
module FAU ( 
  ...
  nor2   g15(.a(x05), .b(new_n42_), .O(new_n57_));
  ...
  nand3  g39(.a(new_n74_), .b(x24), .c(x18), .O(new_n81_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n74_), .O(z11));
  ...
  nand4  g60(.a(new_n101_), .b(new_n74_), .c(new_n100_), .d(new_n99_), .O(z15));
  buf    g61(.a(x19), .O(z06));
endmodule
