...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(x11), .O(new_n70_));
  ...
  nor2   g41(.a(x19), .b(new_n78_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n45_), .c(new_n78_), .O(z09));
  ...
  nand3  g49(.a(new_n43_), .b(new_n84_), .c(x23), .O(new_n91_));
  ...
  nand3  g55(.a(new_n43_), .b(new_n84_), .c(x16), .O(new_n97_));
