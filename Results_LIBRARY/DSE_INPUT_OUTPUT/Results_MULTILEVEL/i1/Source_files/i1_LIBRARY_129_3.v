...
module FAU ( 
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(x12), .O(new_n68_));
  ...
  oai21  g36(.a(new_n77_), .b(x12), .c(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nor2   g38(.a(new_n46_), .b(x12), .O(z06));
  ...
  nand3  g45(.a(new_n43_), .b(new_n85_), .c(x22), .O(new_n87_));
  ...
  nand4  g51(.a(new_n43_), .b(new_n85_), .c(x23), .d(x14), .O(new_n93_));
