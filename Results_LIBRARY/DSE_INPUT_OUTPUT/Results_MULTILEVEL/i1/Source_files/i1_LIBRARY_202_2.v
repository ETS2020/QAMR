...
module FAU ( 
  ...
  nand2  g01(.a(new_n42_), .b(x13), .O(new_n43_));
  ...
  nor3   g49(.a(new_n78_), .b(x24), .c(new_n90_), .O(z14));
  nor3   g50(.a(x15), .b(x14), .c(x12), .O(new_n92_));
  nand2  g51(.a(x19), .b(x13), .O(new_n93_));
  oai21  g52(.a(new_n92_), .b(x13), .c(new_n93_), .O(z15));
  buf    g53(.a(x19), .O(z06));
endmodule
