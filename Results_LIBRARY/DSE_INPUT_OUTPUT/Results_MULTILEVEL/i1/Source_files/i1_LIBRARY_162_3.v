...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n99_, new_n100_;
  nand2  g00(.a(x21), .b(x19), .O(new_n42_));
  ...
  nand3  g26(.a(new_n67_), .b(new_n44_), .c(x19), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nand2  g29(.a(new_n42_), .b(new_n70_), .O(z03));
  nand2  g30(.a(new_n44_), .b(x20), .O(new_n72_));
  oai21  g31(.a(new_n44_), .b(x19), .c(new_n72_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nand3  g33(.a(new_n63_), .b(new_n64_), .c(new_n50_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n62_), .c(new_n44_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n74_), .O(z05));
  inv1   g37(.a(x19), .O(new_n79_));
  nor2   g38(.a(x21), .b(new_n79_), .O(z06));
  nand3  g39(.a(new_n42_), .b(x24), .c(x18), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n42_), .b(new_n83_), .O(z08));
  inv1   g43(.a(x24), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n42_), .O(z09));
  ...
  nand4  g51(.a(new_n42_), .b(new_n85_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n85_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n42_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  oai21  g56(.a(x24), .b(new_n97_), .c(new_n42_), .O(z14));
  nor2   g57(.a(x13), .b(x12), .O(new_n99_));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  aoi22  g59(.a(new_n100_), .b(new_n99_), .c(x21), .d(x19), .O(z15));
endmodule
