...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n63_), .c(new_n43_), .d(new_n50_), .O(new_n68_));
  ...
  nand4  g33(.a(new_n74_), .b(new_n67_), .c(new_n51_), .d(new_n50_), .O(new_n75_));
  ...
  nand4  g56(.a(new_n97_), .b(new_n45_), .c(new_n96_), .d(new_n95_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
