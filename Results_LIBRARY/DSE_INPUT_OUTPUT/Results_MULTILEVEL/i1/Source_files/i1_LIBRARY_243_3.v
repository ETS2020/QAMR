...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n80_, new_n82_, new_n83_, new_n85_, new_n87_,
  ...
  nand4  g31(.a(new_n72_), .b(new_n58_), .c(new_n49_), .d(new_n48_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n44_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(z05));
  nand3  g35(.a(new_n42_), .b(x24), .c(x18), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z07));
  and2   g37(.a(new_n42_), .b(x11), .O(z08));
  nand3  g38(.a(new_n42_), .b(x24), .c(x11), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z09));
  inv1   g40(.a(x24), .O(new_n82_));
  nand4  g41(.a(new_n42_), .b(new_n82_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n82_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n42_), .O(z11));
  nand3  g45(.a(new_n42_), .b(new_n82_), .c(x23), .O(new_n87_));
  ...
  oai21  g52(.a(x24), .b(new_n93_), .c(new_n42_), .O(z14));
  nor2   g53(.a(x13), .b(x12), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n95_), .c(x19), .d(x07), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
