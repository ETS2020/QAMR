...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n88_, new_n90_, new_n92_, new_n94_, new_n96_,
  ...
  nand3  g29(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(new_n71_));
  ...
  nor2   g40(.a(new_n44_), .b(x11), .O(z06));
  nand3  g41(.a(z06), .b(new_n63_), .c(new_n81_), .O(new_n83_));
  oai22  g42(.a(new_n83_), .b(new_n80_), .c(new_n45_), .d(new_n79_), .O(z05));
  nand3  g43(.a(new_n46_), .b(x24), .c(x18), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z07));
  nor2   g45(.a(x19), .b(new_n43_), .O(z08));
  inv1   g46(.a(x24), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n44_), .c(new_n43_), .O(z09));
  nand3  g48(.a(new_n88_), .b(x22), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n46_), .O(z10));
  nand4  g50(.a(new_n46_), .b(new_n88_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  nand4  g52(.a(new_n46_), .b(new_n88_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n88_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n46_), .O(z13));
