...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n92_, new_n95_, new_n97_, new_n98_;
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n75_), .O(z05));
  nor2   g37(.a(new_n43_), .b(new_n63_), .O(z06));
  ...
  nand4  g45(.a(new_n80_), .b(new_n85_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n85_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n80_), .O(z11));
  inv1   g49(.a(x14), .O(new_n91_));
  nand2  g50(.a(new_n85_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n80_), .O(z12));
  oai21  g52(.a(new_n92_), .b(new_n63_), .c(new_n80_), .O(z13));
  nand2  g53(.a(new_n85_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n80_), .O(z14));
