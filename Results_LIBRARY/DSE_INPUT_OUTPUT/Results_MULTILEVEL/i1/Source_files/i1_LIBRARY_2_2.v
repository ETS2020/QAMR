...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n77_, new_n78_, new_n79_, new_n82_, new_n84_,
  ...
  nor2   g28(.a(x09), .b(new_n43_), .O(new_n70_));
  ...
  nor2   g36(.a(new_n62_), .b(x08), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n69_), .c(new_n68_), .d(new_n52_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n45_), .c(new_n77_), .O(z05));
  nand2  g39(.a(new_n62_), .b(new_n43_), .O(z06));
  ...
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z10));
  nand4  g48(.a(new_n45_), .b(new_n86_), .c(x22), .d(x17), .O(new_n90_));
