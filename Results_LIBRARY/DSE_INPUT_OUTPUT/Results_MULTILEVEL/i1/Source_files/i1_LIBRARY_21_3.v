...
module FAU ( 
  ...
  nor2   g40(.a(x24), .b(new_n43_), .O(z06));
  ...
  aoi21  g44(.a(new_n43_), .b(new_n85_), .c(new_n44_), .O(z07));
  inv1   g45(.a(x11), .O(new_n87_));
  nand2  g46(.a(new_n46_), .b(new_n87_), .O(z08));
  aoi21  g47(.a(new_n43_), .b(new_n87_), .c(new_n44_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  inv1   g49(.a(x22), .O(new_n91_));
  nor3   g50(.a(x24), .b(new_n91_), .c(new_n90_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  nor3   g52(.a(x24), .b(new_n91_), .c(new_n93_), .O(z11));
  inv1   g53(.a(x23), .O(new_n95_));
  nor3   g54(.a(x24), .b(new_n95_), .c(new_n90_), .O(z12));
  nor3   g55(.a(x24), .b(new_n95_), .c(new_n93_), .O(z13));
