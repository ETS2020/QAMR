...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n89_, new_n90_, new_n93_, new_n95_, new_n96_;
  ...
  nand3  g35(.a(new_n76_), .b(new_n70_), .c(new_n74_), .O(z05));
  nand2  g36(.a(new_n43_), .b(new_n46_), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n70_), .O(z07));
  ...
  nand2  g43(.a(new_n83_), .b(x14), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x19), .c(new_n43_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  nor4   g46(.a(x24), .b(new_n43_), .c(new_n46_), .d(new_n87_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n83_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n70_), .O(z12));
  oai21  g50(.a(new_n90_), .b(new_n87_), .c(new_n70_), .O(z13));
  nand2  g51(.a(new_n83_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n70_), .O(z14));
