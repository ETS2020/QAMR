...
module FAU ( 
  ...
  oai21  g28(.a(new_n69_), .b(new_n44_), .c(new_n45_), .O(z02));
  and2   g29(.a(new_n45_), .b(x20), .O(z03));
  ...
  nand4  g35(.a(new_n76_), .b(x19), .c(new_n66_), .d(new_n52_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n98_), .b(x19), .c(new_n43_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
