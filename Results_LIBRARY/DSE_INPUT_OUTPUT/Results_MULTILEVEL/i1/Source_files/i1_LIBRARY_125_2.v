...
module FAU ( 
  ...
  nand4  g35(.a(new_n76_), .b(new_n66_), .c(new_n67_), .d(new_n52_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n43_), .c(new_n60_), .O(z05));
  ...
  nand2  g51(.a(new_n84_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n46_), .O(z13));
