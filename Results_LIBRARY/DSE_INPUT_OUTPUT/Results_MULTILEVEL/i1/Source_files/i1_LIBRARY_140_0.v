...
module FAU ( 
  ...
  nand3  g30(.a(new_n71_), .b(new_n68_), .c(x19), .O(z04));
  ...
  nand2  g34(.a(x21), .b(new_n45_), .O(z06));
  ...
  nand2  g50(.a(new_n91_), .b(new_n69_), .O(z12));
  nand4  g51(.a(new_n69_), .b(new_n84_), .c(x23), .d(x17), .O(new_n93_));
