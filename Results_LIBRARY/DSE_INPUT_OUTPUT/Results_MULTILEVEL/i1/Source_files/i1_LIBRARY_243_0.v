...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n67_, new_n68_, new_n71_, new_n72_, new_n73_, new_n76_,
  ...
  nand4  g41(.a(new_n68_), .b(new_n82_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n82_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n68_), .O(z11));
