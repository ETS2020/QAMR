...
module FAU ( 
  ...
  nand2  g35(.a(x24), .b(new_n46_), .O(z06));
  oai21  g36(.a(x24), .b(new_n46_), .c(x18), .O(new_n78_));
  ...
  nand3  g41(.a(x22), .b(x19), .c(x14), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x24), .O(z10));
  nand2  g43(.a(x22), .b(x17), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x19), .c(x24), .O(z11));
  nand3  g45(.a(x23), .b(x19), .c(x14), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(x24), .O(z12));
  nand3  g47(.a(x23), .b(x19), .c(x17), .O(new_n89_));
