...
module FAU ( 
  ...
  nand3  g14(.a(new_n45_), .b(new_n44_), .c(new_n55_), .O(new_n56_));
  inv1   g15(.a(x05), .O(new_n57_));
  nand4  g16(.a(new_n48_), .b(new_n47_), .c(new_n57_), .d(new_n46_), .O(new_n58_));
  oai21  g17(.a(new_n58_), .b(new_n56_), .c(x00), .O(new_n59_));
  nand4  g18(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n60_));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n59_), .c(new_n54_), .O(z02));
  ...
  nor2   g32(.a(new_n54_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n62_), .c(new_n61_), .d(new_n48_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n71_), .c(new_n73_), .O(z05));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n71_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n71_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n71_), .O(z09));
  nand3  g41(.a(new_n81_), .b(x22), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n71_), .O(z10));
  nand4  g43(.a(new_n71_), .b(new_n81_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  inv1   g45(.a(x23), .O(new_n87_));
  nand2  g46(.a(new_n71_), .b(new_n81_), .O(new_n88_));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n68_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
