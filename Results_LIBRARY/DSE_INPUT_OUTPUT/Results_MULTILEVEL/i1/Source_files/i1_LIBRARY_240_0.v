...
module FAU ( 
  ...
  nor2   g01(.a(x20), .b(x15), .O(new_n43_));
  ...
  nand2  g30(.a(x21), .b(x15), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n71_), .O(z04));
  nor4   g32(.a(new_n67_), .b(new_n59_), .c(x08), .d(x07), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n65_), .c(x10), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n43_), .O(z05));
  nor2   g35(.a(new_n43_), .b(new_n59_), .O(z06));
  ...
  nand4  g44(.a(new_n45_), .b(new_n82_), .c(x22), .d(x17), .O(new_n86_));
