...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n78_, new_n80_, new_n82_, new_n83_, new_n85_,
    new_n87_, new_n88_, new_n89_, new_n91_, new_n93_, new_n95_, new_n96_;
  ...
  nor4   g30(.a(new_n68_), .b(new_n60_), .c(x08), .d(x07), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n66_), .c(x10), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n44_), .O(z05));
  nor2   g33(.a(new_n44_), .b(new_n60_), .O(z06));
  nand2  g34(.a(x24), .b(x18), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n46_), .O(z07));
