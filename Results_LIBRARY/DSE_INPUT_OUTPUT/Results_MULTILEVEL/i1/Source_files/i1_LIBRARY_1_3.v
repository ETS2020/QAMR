...
module FAU ( 
  ...
  nand2  g30(.a(x21), .b(new_n58_), .O(new_n72_));
  oai21  g31(.a(new_n58_), .b(x19), .c(new_n72_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nand3  g33(.a(new_n65_), .b(new_n66_), .c(new_n51_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n64_), .c(new_n58_), .O(new_n76_));
  ...
  nand4  g46(.a(new_n43_), .b(new_n85_), .c(x22), .d(x17), .O(new_n88_));
  ...
  aoi22  g56(.a(new_n97_), .b(new_n96_), .c(x20), .d(x19), .O(z15));
  buf    g57(.a(x20), .O(z03));
  buf    g58(.a(x19), .O(z06));
endmodule
