...
module FAU ( 
  ...
  and2   g01(.a(x19), .b(x07), .O(new_n43_));
  ...
  nand3  g16(.a(new_n57_), .b(x19), .c(new_n46_), .O(new_n58_));
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(new_n46_), .O(new_n68_));
  ...
  nand2  g49(.a(new_n88_), .b(x23), .O(new_n91_));
