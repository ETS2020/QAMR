...
module FAU ( 
  ...
  aoi22  g29(.a(new_n70_), .b(new_n68_), .c(new_n43_), .d(x15), .O(z04));
  nand2  g30(.a(new_n44_), .b(x10), .O(new_n72_));
  nand4  g31(.a(new_n63_), .b(x19), .c(new_n64_), .d(new_n51_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n61_), .c(new_n72_), .O(z05));
  ...
  nand4  g45(.a(new_n44_), .b(new_n82_), .c(x23), .d(x14), .O(new_n87_));
