...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n76_, new_n77_, new_n78_, new_n79_, new_n82_,
  ...
  aoi21  g21(.a(new_n62_), .b(new_n61_), .c(x07), .O(new_n63_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  inv1   g28(.a(x08), .O(new_n70_));
  nor2   g29(.a(x09), .b(new_n70_), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n69_), .c(new_n66_), .d(new_n43_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n65_), .c(new_n60_), .O(z02));
  inv1   g32(.a(x21), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n44_), .O(z04));
  nand3  g34(.a(new_n66_), .b(x19), .c(new_n70_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n69_), .c(x10), .O(new_n78_));
  nand2  g37(.a(new_n44_), .b(x10), .O(new_n79_));
  oai21  g38(.a(new_n78_), .b(x07), .c(new_n79_), .O(z05));
  nand2  g39(.a(new_n46_), .b(new_n60_), .O(z06));
