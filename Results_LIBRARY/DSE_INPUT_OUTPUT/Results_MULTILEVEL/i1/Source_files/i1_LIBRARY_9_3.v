...
module FAU ( 
  ...
  aoi21  g44(.a(new_n85_), .b(new_n45_), .c(new_n73_), .O(z10));
  nand2  g45(.a(new_n84_), .b(x17), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n45_), .c(new_n73_), .O(z11));
