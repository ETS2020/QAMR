...
module FAU ( 
  ...
  nand3  g31(.a(new_n72_), .b(x19), .c(new_n59_), .O(new_n73_));
  ...
  nand4  g40(.a(new_n62_), .b(x19), .c(new_n59_), .d(new_n81_), .O(new_n82_));
  ...
  aoi21  g51(.a(new_n91_), .b(new_n46_), .c(new_n59_), .O(z11));
  nand2  g52(.a(x19), .b(x17), .O(new_n94_));
  nand4  g53(.a(new_n94_), .b(new_n88_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand4  g55(.a(new_n88_), .b(x23), .c(new_n46_), .d(x17), .O(new_n97_));
