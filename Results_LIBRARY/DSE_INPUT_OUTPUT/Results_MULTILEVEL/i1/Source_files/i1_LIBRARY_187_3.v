...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(x12), .O(new_n70_));
  ...
  nand4  g47(.a(new_n43_), .b(new_n88_), .c(x22), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z10));
  nand3  g49(.a(new_n88_), .b(x22), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n43_), .O(z11));
  nand3  g51(.a(new_n88_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n43_), .O(z12));
