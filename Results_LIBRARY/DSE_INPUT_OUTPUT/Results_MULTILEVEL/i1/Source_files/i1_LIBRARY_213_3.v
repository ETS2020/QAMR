...
module FAU ( 
  ...
  oai21  g30(.a(new_n71_), .b(new_n61_), .c(new_n47_), .O(z02));
  ...
  nor4   g36(.a(new_n69_), .b(new_n61_), .c(x08), .d(x07), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n47_), .c(new_n77_), .O(z05));
  nand2  g39(.a(new_n47_), .b(new_n61_), .O(z06));
  nand3  g40(.a(new_n47_), .b(x24), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nand2  g43(.a(new_n47_), .b(new_n84_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n47_), .O(z09));
  nand3  g46(.a(new_n86_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n47_), .O(z10));
  nand4  g48(.a(new_n47_), .b(new_n86_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand2  g50(.a(new_n86_), .b(x14), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n43_), .c(new_n44_), .O(z12));
  nand4  g52(.a(new_n86_), .b(x23), .c(new_n43_), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  nand3  g54(.a(new_n47_), .b(new_n86_), .c(x16), .O(new_n96_));
