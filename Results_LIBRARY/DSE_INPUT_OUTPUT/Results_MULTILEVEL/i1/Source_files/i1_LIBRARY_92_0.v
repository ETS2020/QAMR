...
module FAU ( 
  ...
  nand2  g34(.a(new_n45_), .b(x12), .O(z06));
  ...
  nand2  g46(.a(new_n87_), .b(new_n69_), .O(z11));
  nand3  g47(.a(new_n86_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n69_), .O(z12));
  nand3  g49(.a(new_n83_), .b(x23), .c(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z13));
  and2   g51(.a(new_n83_), .b(x16), .O(z14));
  nor2   g52(.a(new_n45_), .b(x15), .O(new_n94_));
  nor3   g53(.a(x14), .b(x13), .c(x12), .O(new_n95_));
