...
module FAU ( 
  ...
  nand3  g35(.a(new_n64_), .b(x19), .c(new_n52_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n63_), .O(new_n78_));
  ...
  nand3  g49(.a(new_n86_), .b(x22), .c(x17), .O(new_n91_));
  ...
  and2   g55(.a(new_n88_), .b(x16), .O(z14));
