...
module FAU ( 
  ...
  nand4  g35(.a(x19), .b(new_n66_), .c(new_n51_), .d(new_n50_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n43_), .O(new_n79_));
  oai21  g38(.a(new_n59_), .b(new_n76_), .c(new_n79_), .O(z05));
  inv1   g39(.a(x19), .O(new_n81_));
  nand2  g40(.a(new_n46_), .b(new_n81_), .O(z06));
  ...
  nand4  g53(.a(new_n46_), .b(new_n87_), .c(x23), .d(x17), .O(new_n95_));
  ...
  nor3   g58(.a(x13), .b(x12), .c(x06), .O(new_n100_));
