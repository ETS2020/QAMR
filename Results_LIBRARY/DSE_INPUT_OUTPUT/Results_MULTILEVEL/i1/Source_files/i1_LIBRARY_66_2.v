...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n81_, new_n82_, new_n84_, new_n86_, new_n89_,
    new_n91_, new_n92_;
  ...
  nand3  g17(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n59_));
  inv1   g18(.a(x04), .O(new_n60_));
  nand4  g19(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n60_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(x00), .O(new_n62_));
  nand4  g21(.a(new_n60_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n65_), .c(new_n64_), .d(new_n53_), .O(new_n68_));
  ...
  nand4  g32(.a(new_n65_), .b(x19), .c(new_n66_), .d(new_n53_), .O(new_n74_));
  oai22  g33(.a(new_n74_), .b(new_n63_), .c(new_n44_), .d(new_n73_), .O(z05));
  inv1   g34(.a(x24), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(new_n43_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n44_), .b(new_n78_), .O(z08));
  nor3   g38(.a(new_n44_), .b(new_n76_), .c(new_n78_), .O(z09));
  ...
  nand2  g44(.a(new_n76_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n81_), .c(new_n45_), .O(z12));
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n45_), .O(z13));
  inv1   g47(.a(x16), .O(new_n89_));
  nor3   g48(.a(new_n44_), .b(x24), .c(new_n89_), .O(z14));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nor3   g50(.a(new_n44_), .b(x13), .c(x12), .O(new_n92_));
