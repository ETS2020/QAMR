...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(x13), .O(new_n69_));
  ...
  oai21  g36(.a(new_n77_), .b(x13), .c(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n76_), .O(z05));
  nor2   g38(.a(new_n44_), .b(x13), .O(z06));
  ...
  nand4  g47(.a(new_n72_), .b(new_n85_), .c(x22), .d(x17), .O(new_n89_));
  ...
  inv1   g57(.a(x15), .O(new_n99_));
  nand4  g58(.a(new_n99_), .b(new_n91_), .c(new_n43_), .d(new_n98_), .O(z15));
endmodule
