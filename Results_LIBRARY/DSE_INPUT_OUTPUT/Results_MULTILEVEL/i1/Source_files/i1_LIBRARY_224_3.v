...
module FAU ( 
  ...
  nand2  g00(.a(x21), .b(x20), .O(new_n42_));
  ...
  nand3  g13(.a(new_n54_), .b(new_n42_), .c(x19), .O(new_n55_));
  ...
  nand4  g19(.a(new_n60_), .b(new_n59_), .c(new_n47_), .d(new_n58_), .O(new_n61_));
  nand4  g20(.a(new_n58_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(new_n63_));
  inv1   g22(.a(x08), .O(new_n64_));
  nand2  g23(.a(new_n48_), .b(new_n47_), .O(new_n65_));
  nor4   g24(.a(new_n65_), .b(x09), .c(new_n64_), .d(x07), .O(new_n66_));
  aoi22  g25(.a(new_n66_), .b(new_n63_), .c(new_n61_), .d(x00), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n57_), .c(new_n42_), .O(z02));
  xor2a  g27(.a(x21), .b(x20), .O(z04));
  inv1   g28(.a(new_n42_), .O(new_n70_));
  nor4   g29(.a(new_n65_), .b(new_n57_), .c(x08), .d(x07), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n63_), .c(x10), .O(new_n72_));
  nor2   g31(.a(new_n72_), .b(new_n70_), .O(z05));
  nor2   g32(.a(new_n70_), .b(new_n57_), .O(z06));
  nand2  g33(.a(x24), .b(x18), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n42_), .O(z07));
  and2   g35(.a(new_n42_), .b(x11), .O(z08));
  nand3  g36(.a(new_n42_), .b(x24), .c(x11), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z09));
  inv1   g38(.a(x14), .O(new_n80_));
  inv1   g39(.a(x24), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x22), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n42_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n42_), .O(z11));
  nand3  g44(.a(new_n42_), .b(new_n81_), .c(x23), .O(new_n86_));
  ...
  nand3  g50(.a(new_n42_), .b(new_n81_), .c(x16), .O(new_n92_));
