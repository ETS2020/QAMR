...
module FAU ( 
  ...
  nand4  g36(.a(new_n69_), .b(x19), .c(new_n54_), .d(new_n52_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n67_), .c(new_n77_), .O(z05));
  nand2  g38(.a(new_n43_), .b(new_n55_), .O(z06));
  ...
  oai21  g52(.a(new_n93_), .b(new_n87_), .c(new_n44_), .O(z12));
  oai21  g53(.a(new_n93_), .b(new_n91_), .c(new_n44_), .O(z13));
