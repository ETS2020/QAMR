...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_, new_n95_,
  ...
  nor2   g37(.a(new_n45_), .b(x15), .O(z06));
  ...
  nor2   g48(.a(new_n73_), .b(x24), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(x22), .c(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand2  g51(.a(new_n90_), .b(x23), .O(new_n93_));
