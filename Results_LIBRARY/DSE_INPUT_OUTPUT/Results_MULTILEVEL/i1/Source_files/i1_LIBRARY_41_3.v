...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x15), .O(new_n71_));
  ...
  nor2   g38(.a(new_n46_), .b(x15), .O(z06));
  ...
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z10));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n43_), .O(z11));
  nand3  g52(.a(new_n43_), .b(new_n87_), .c(x23), .O(new_n94_));
  ...
  nand3  g58(.a(new_n43_), .b(new_n87_), .c(x16), .O(new_n100_));
