...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n73_, new_n75_, new_n76_,
  ...
  and2   g30(.a(new_n43_), .b(x10), .O(z05));
  ...
  nor2   g35(.a(new_n76_), .b(new_n75_), .O(z08));
  inv1   g36(.a(x24), .O(new_n78_));
  nor3   g37(.a(new_n76_), .b(new_n78_), .c(new_n75_), .O(z09));
  nand4  g38(.a(new_n43_), .b(new_n78_), .c(x22), .d(x14), .O(new_n80_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n76_), .O(z15));
  buf    g51(.a(x19), .O(z06));
endmodule
