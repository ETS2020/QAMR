...
module FAU ( 
  ...
  nand2  g34(.a(new_n73_), .b(new_n75_), .O(z05));
  nor2   g35(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n73_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n73_), .O(z11));
  nand2  g47(.a(new_n79_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n84_), .c(new_n73_), .O(z12));
  oai21  g49(.a(new_n89_), .b(new_n87_), .c(new_n73_), .O(z13));
