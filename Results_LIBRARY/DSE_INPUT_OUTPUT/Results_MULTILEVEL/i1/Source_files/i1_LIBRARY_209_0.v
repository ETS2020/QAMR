// Benchmark "FAU" written by ABC on Thu Aug 13 20:31:02 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n87_, new_n88_, new_n90_, new_n92_, new_n94_, new_n96_,
    new_n98_, new_n99_;
  ...
  nand4  g19(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n61_));
  inv1   g20(.a(x09), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(x08), .c(new_n52_), .d(new_n51_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n61_), .c(x19), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n46_), .O(new_n65_));
  nor3   g24(.a(x03), .b(x02), .c(x01), .O(new_n66_));
  nor2   g25(.a(x05), .b(x04), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(new_n52_), .d(new_n46_), .O(new_n68_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n67_), .c(new_n66_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(x06), .O(new_n77_));
  or2    g36(.a(new_n77_), .b(x10), .O(z05));
  ...
  nand2  g44(.a(new_n44_), .b(new_n80_), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  ...
  nand3  g50(.a(new_n80_), .b(x23), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n44_), .O(z12));
  nand4  g52(.a(new_n44_), .b(new_n80_), .c(x23), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  nor2   g55(.a(new_n86_), .b(new_n96_), .O(z14));
