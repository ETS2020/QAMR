...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n81_, new_n83_, new_n85_, new_n87_,
  ...
  nand2  g37(.a(x24), .b(new_n46_), .O(z06));
  ...
  aoi21  g44(.a(new_n85_), .b(x19), .c(x24), .O(z10));
  nand2  g45(.a(x22), .b(x17), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(x19), .c(x24), .O(z11));
