...
module FAU ( 
  ...
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n73_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  nand2  g44(.a(new_n83_), .b(x22), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n73_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n73_), .O(z11));
  nand3  g48(.a(new_n83_), .b(x23), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n73_), .O(z12));
  nand4  g50(.a(new_n73_), .b(new_n83_), .c(x23), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z13));
  nand3  g52(.a(new_n73_), .b(new_n83_), .c(x16), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z14));
  inv1   g54(.a(x12), .O(new_n96_));
  inv1   g55(.a(x13), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nand4  g57(.a(new_n98_), .b(new_n73_), .c(new_n97_), .d(new_n96_), .O(z15));
endmodule
