...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n88_, new_n89_, new_n90_, new_n92_, new_n94_, new_n96_,
  ...
  nor2   g38(.a(new_n44_), .b(x05), .O(z06));
  inv1   g39(.a(new_n45_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x24), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nand2  g43(.a(new_n81_), .b(new_n84_), .O(z08));
  nand3  g44(.a(new_n81_), .b(x24), .c(x11), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z09));
  inv1   g46(.a(x14), .O(new_n88_));
  inv1   g47(.a(x24), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x22), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n88_), .c(new_n81_), .O(z10));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n81_), .O(z11));
  nand3  g52(.a(new_n89_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n81_), .O(z12));
  nand4  g54(.a(new_n81_), .b(new_n89_), .c(x23), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  nand2  g56(.a(new_n89_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n81_), .O(z14));
