...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n88_, new_n89_, new_n91_, new_n93_, new_n95_,
    new_n97_, new_n99_;
  ...
  aoi21  g32(.a(x19), .b(new_n43_), .c(new_n73_), .O(z03));
  inv1   g33(.a(x21), .O(new_n75_));
  nand3  g34(.a(new_n44_), .b(new_n75_), .c(new_n73_), .O(z04));
  nand2  g35(.a(new_n44_), .b(x10), .O(new_n77_));
  nand3  g36(.a(new_n64_), .b(new_n60_), .c(new_n49_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  nand4  g38(.a(new_n61_), .b(x19), .c(x15), .d(new_n79_), .O(new_n80_));
  ...
  nand4  g49(.a(new_n44_), .b(new_n88_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand3  g51(.a(new_n88_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z12));
  nand4  g53(.a(new_n44_), .b(new_n88_), .c(x23), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z13));
  nand2  g55(.a(new_n88_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(z14));
  nor3   g57(.a(x14), .b(x13), .c(x12), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(x19), .c(new_n43_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
