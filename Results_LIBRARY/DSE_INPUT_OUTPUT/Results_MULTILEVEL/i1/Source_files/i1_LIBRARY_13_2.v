...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n79_, new_n82_, new_n83_, new_n85_, new_n87_,
    new_n88_, new_n89_, new_n90_, new_n92_, new_n94_, new_n96_, new_n97_;
  inv1   g00(.a(x19), .O(new_n42_));
  nand2  g01(.a(new_n42_), .b(x10), .O(new_n43_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n64_), .c(new_n63_), .d(new_n50_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n61_), .c(new_n42_), .O(z02));
  inv1   g27(.a(x20), .O(new_n69_));
  nand2  g28(.a(new_n43_), .b(new_n69_), .O(z03));
  or2    g29(.a(z03), .b(x21), .O(z04));
  inv1   g30(.a(x10), .O(new_n72_));
  nand4  g31(.a(new_n64_), .b(x19), .c(new_n65_), .d(new_n50_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n62_), .c(new_n72_), .O(z05));
  inv1   g33(.a(x18), .O(new_n75_));
  nand2  g34(.a(new_n43_), .b(x24), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n75_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  inv1   g37(.a(new_n43_), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n78_), .O(z08));
  nor2   g39(.a(new_n76_), .b(new_n78_), .O(z09));
  ...
  nand2  g46(.a(new_n43_), .b(new_n82_), .O(new_n88_));
