...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x02), .O(new_n43_));
  ...
  aoi21  g19(.a(new_n60_), .b(new_n59_), .c(x02), .O(new_n61_));
  nor2   g20(.a(x16), .b(new_n46_), .O(new_n62_));
  ...
  aoi21  g29(.a(new_n70_), .b(new_n63_), .c(new_n58_), .O(z02));
  and2   g30(.a(new_n43_), .b(x20), .O(z03));
  nor2   g31(.a(x21), .b(x20), .O(new_n73_));
  aoi21  g32(.a(x16), .b(x02), .c(new_n73_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nor2   g34(.a(new_n58_), .b(x08), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n67_), .c(new_n66_), .d(new_n50_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n43_), .c(new_n75_), .O(z05));
  nand2  g37(.a(new_n43_), .b(new_n58_), .O(z06));
  ...
  nand3  g53(.a(new_n84_), .b(x16), .c(new_n46_), .O(new_n95_));
