...
module FAU ( 
  ...
  nand2  g22(.a(new_n52_), .b(new_n51_), .O(new_n64_));
  inv1   g23(.a(x09), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(x08), .c(new_n53_), .O(new_n66_));
  nor3   g25(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
  aoi21  g26(.a(new_n62_), .b(x00), .c(new_n67_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n47_), .c(new_n45_), .O(z02));
  ...
  nand2  g36(.a(new_n43_), .b(new_n47_), .O(z06));
  ...
  nand2  g48(.a(new_n83_), .b(x14), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(x19), .c(new_n43_), .O(z12));
  nand2  g50(.a(new_n83_), .b(x17), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(x19), .c(new_n43_), .O(z13));
