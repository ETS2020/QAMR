...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n77_, new_n78_, new_n80_, new_n83_, new_n85_, new_n87_,
  ...
  nand3  g29(.a(new_n70_), .b(new_n69_), .c(x19), .O(z04));
  ...
  nand2  g34(.a(x20), .b(new_n45_), .O(z06));
  ...
  oai21  g40(.a(new_n78_), .b(new_n80_), .c(new_n57_), .O(z09));
  nand4  g41(.a(new_n57_), .b(new_n78_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n78_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n57_), .O(z11));
  nand4  g45(.a(new_n57_), .b(new_n78_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n78_), .b(x23), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n57_), .O(z13));
  nand2  g49(.a(new_n78_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n57_), .O(z14));
