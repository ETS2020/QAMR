...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n79_, new_n82_, new_n85_, new_n86_,
  ...
  aoi21  g42(.a(x19), .b(new_n82_), .c(new_n43_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  inv1   g44(.a(x22), .O(new_n86_));
  nor3   g45(.a(x24), .b(new_n86_), .c(new_n85_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  nor3   g47(.a(x24), .b(new_n86_), .c(new_n88_), .O(z11));
  nand2  g48(.a(new_n43_), .b(x23), .O(new_n90_));
