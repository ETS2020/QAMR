...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n77_, new_n78_, new_n79_, new_n82_, new_n84_,
  ...
  nor2   g14(.a(x11), .b(new_n42_), .O(new_n56_));
  ...
  nand3  g28(.a(new_n69_), .b(x19), .c(new_n58_), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(z02));
  and2   g30(.a(new_n43_), .b(x20), .O(z03));
  ...
  nand3  g35(.a(new_n65_), .b(new_n66_), .c(new_n51_), .O(new_n77_));
  ...
  nor2   g39(.a(new_n45_), .b(x11), .O(z06));
  nand3  g40(.a(new_n43_), .b(x24), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  nand3  g42(.a(x24), .b(new_n45_), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x24), .O(new_n86_));
  nand4  g45(.a(new_n43_), .b(new_n86_), .c(x22), .d(x14), .O(new_n87_));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n73_), .O(z15));
  buf    g59(.a(x11), .O(z08));
endmodule
