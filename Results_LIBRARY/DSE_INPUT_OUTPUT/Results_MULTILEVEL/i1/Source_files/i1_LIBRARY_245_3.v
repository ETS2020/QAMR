...
module FAU ( 
  ...
  nand4  g30(.a(x19), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n50_), .c(new_n71_), .O(new_n73_));
  ...
  nand3  g47(.a(new_n43_), .b(new_n84_), .c(x23), .O(new_n89_));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n68_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
