...
module FAU ( 
  ...
  nor2   g29(.a(new_n43_), .b(new_n46_), .O(z03));
  inv1   g30(.a(x21), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n43_), .O(z04));
  ...
  nand2  g41(.a(new_n58_), .b(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n58_), .O(z09));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n84_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n58_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n58_), .O(z11));
  nand3  g49(.a(new_n84_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n58_), .O(z12));
  nand4  g51(.a(new_n58_), .b(new_n84_), .c(x23), .d(x17), .O(new_n93_));
