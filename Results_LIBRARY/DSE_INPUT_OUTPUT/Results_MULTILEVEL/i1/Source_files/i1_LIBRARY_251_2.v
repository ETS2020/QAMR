...
module FAU ( 
  ...
  nand3  g31(.a(new_n72_), .b(x21), .c(x19), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z02));
  inv1   g33(.a(x20), .O(new_n75_));
  nand2  g34(.a(new_n44_), .b(new_n75_), .O(z03));
  nand3  g35(.a(new_n43_), .b(new_n75_), .c(new_n47_), .O(z04));
  nand2  g36(.a(new_n44_), .b(x10), .O(new_n78_));
  nand3  g37(.a(new_n65_), .b(new_n61_), .c(new_n50_), .O(new_n79_));
  inv1   g38(.a(x08), .O(new_n80_));
  nor2   g39(.a(new_n43_), .b(new_n47_), .O(z06));
  ...
  nand4  g51(.a(new_n44_), .b(new_n90_), .c(x22), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z11));
  inv1   g53(.a(x14), .O(new_n95_));
  nand2  g54(.a(new_n90_), .b(x23), .O(new_n96_));
  ...
  nor3   g61(.a(new_n45_), .b(x13), .c(x12), .O(new_n103_));
