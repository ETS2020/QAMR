...
module FAU ( 
  ...
  aoi21  g04(.a(x04), .b(x00), .c(new_n43_), .O(z01));
  nand3  g05(.a(x19), .b(x04), .c(x00), .O(new_n47_));
  ...
  oai21  g16(.a(new_n43_), .b(x04), .c(x24), .O(new_n58_));
  ...
  nand4  g24(.a(new_n51_), .b(new_n63_), .c(x22), .d(x17), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z11));
  nand4  g26(.a(new_n51_), .b(new_n63_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  nand4  g28(.a(new_n51_), .b(new_n63_), .c(x23), .d(x17), .O(new_n70_));
