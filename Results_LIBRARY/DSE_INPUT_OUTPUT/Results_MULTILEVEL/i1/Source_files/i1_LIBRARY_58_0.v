...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n78_, new_n80_, new_n82_, new_n84_, new_n86_, new_n87_,
  ...
  nand2  g35(.a(new_n46_), .b(x08), .O(z06));
  ...
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z10));
  nor2   g44(.a(new_n43_), .b(x24), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x22), .c(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand3  g47(.a(new_n86_), .b(x23), .c(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand3  g49(.a(new_n82_), .b(x23), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(z13));
  and2   g51(.a(new_n86_), .b(x16), .O(z14));
