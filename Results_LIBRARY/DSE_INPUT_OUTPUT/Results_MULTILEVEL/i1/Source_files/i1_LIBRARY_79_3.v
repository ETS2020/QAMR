// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:24 2020
...
module FAU ( 
  ...
  nor2   g15(.a(x04), .b(new_n42_), .O(new_n57_));
  ...
  nor2   g25(.a(new_n66_), .b(x04), .O(new_n67_));
  ...
  nand3  g33(.a(new_n60_), .b(x19), .c(new_n74_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n63_), .c(new_n73_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  oai21  g36(.a(x19), .b(new_n73_), .c(new_n77_), .O(z05));
  nor2   g37(.a(new_n44_), .b(x04), .O(z06));
  inv1   g38(.a(new_n45_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x24), .c(x18), .O(new_n81_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n80_), .O(z11));
  ...
  nand4  g59(.a(new_n100_), .b(new_n80_), .c(new_n99_), .d(new_n98_), .O(z15));
endmodule
