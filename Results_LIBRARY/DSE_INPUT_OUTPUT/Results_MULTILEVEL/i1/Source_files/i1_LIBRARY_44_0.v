...
module FAU ( 
  ...
  nand3  g31(.a(new_n72_), .b(new_n70_), .c(x19), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  inv1   g33(.a(new_n64_), .O(new_n75_));
  nor2   g34(.a(new_n46_), .b(x08), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n63_), .d(new_n52_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n44_), .c(new_n74_), .O(z05));
  nand2  g37(.a(x21), .b(new_n46_), .O(z06));
  ...
  nor3   g43(.a(new_n43_), .b(new_n84_), .c(new_n82_), .O(z09));
