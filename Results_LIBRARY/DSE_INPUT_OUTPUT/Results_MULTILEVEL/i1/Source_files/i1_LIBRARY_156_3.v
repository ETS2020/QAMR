...
module FAU ( 
  ...
  aoi21  g31(.a(new_n72_), .b(new_n69_), .c(x22), .O(new_n73_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n43_), .c(new_n44_), .O(z10));
  nand4  g51(.a(new_n90_), .b(x22), .c(new_n43_), .d(x17), .O(new_n93_));
  ...
  nand2  g58(.a(new_n99_), .b(new_n46_), .O(z14));
