...
module FAU ( 
  ...
  nand4  g39(.a(new_n62_), .b(x24), .c(x19), .d(new_n70_), .O(new_n81_));
  ...
  nor2   g44(.a(new_n65_), .b(new_n84_), .O(z09));
  nand4  g45(.a(new_n65_), .b(x22), .c(new_n43_), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand4  g47(.a(new_n65_), .b(x22), .c(new_n43_), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand4  g49(.a(new_n65_), .b(x23), .c(new_n43_), .d(x14), .O(new_n91_));
