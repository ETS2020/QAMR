...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n78_, new_n80_, new_n83_, new_n84_, new_n85_, new_n87_,
  ...
  nor2   g31(.a(new_n46_), .b(x08), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n64_), .c(new_n63_), .d(new_n52_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n44_), .c(new_n72_), .O(z05));
  nand2  g34(.a(new_n46_), .b(x11), .O(z06));
  ...
  nand2  g39(.a(x19), .b(new_n80_), .O(z08));
  oai21  g40(.a(new_n78_), .b(new_n80_), .c(new_n44_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  nor3   g42(.a(new_n43_), .b(x24), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g48(.a(new_n78_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n44_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n44_), .O(z13));
  nand2  g52(.a(new_n78_), .b(x16), .O(new_n94_));
