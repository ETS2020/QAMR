...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n62_));
  ...
  nand4  g27(.a(new_n68_), .b(new_n66_), .c(new_n65_), .d(new_n45_), .O(new_n69_));
  ...
  nand4  g34(.a(new_n66_), .b(x19), .c(new_n67_), .d(new_n45_), .O(new_n76_));
