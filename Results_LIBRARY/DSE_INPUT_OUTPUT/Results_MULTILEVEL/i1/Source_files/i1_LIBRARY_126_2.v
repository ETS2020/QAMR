...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(x22), .c(x19), .O(new_n58_));
  ...
  nor2   g38(.a(new_n64_), .b(new_n43_), .O(z06));
  ...
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n45_), .O(z09));
  ...
  nand4  g49(.a(new_n45_), .b(new_n85_), .c(x23), .d(x14), .O(new_n91_));
