...
module FAU ( 
  ...
  nand3  g38(.a(new_n65_), .b(new_n60_), .c(new_n48_), .O(new_n80_));
  nor2   g39(.a(new_n64_), .b(new_n43_), .O(z06));
  nand3  g40(.a(z06), .b(new_n61_), .c(new_n69_), .O(new_n82_));
