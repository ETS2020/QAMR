...
module FAU ( 
  ...
  nor3   g38(.a(new_n71_), .b(new_n79_), .c(new_n78_), .O(z07));
  nand3  g39(.a(x24), .b(x19), .c(x11), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z09));
  nand4  g41(.a(new_n44_), .b(new_n79_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n79_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n44_), .O(z11));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n79_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n44_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n44_), .O(z13));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n71_), .O(z15));
  buf    g55(.a(x19), .O(z06));
  buf    g56(.a(x11), .O(z08));
endmodule
