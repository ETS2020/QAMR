...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n79_, new_n80_, new_n82_, new_n85_, new_n87_,
  ...
  nand3  g33(.a(new_n45_), .b(new_n74_), .c(new_n71_), .O(z04));
  nand4  g34(.a(new_n66_), .b(new_n65_), .c(new_n67_), .d(new_n52_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x19), .c(new_n43_), .O(z05));
  nand2  g36(.a(new_n44_), .b(x10), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(x24), .O(new_n80_));
  nor3   g39(.a(new_n72_), .b(new_n80_), .c(new_n79_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n72_), .b(new_n82_), .O(z08));
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n45_), .O(z09));
  nand3  g43(.a(new_n80_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n45_), .O(z10));
  nand4  g45(.a(new_n45_), .b(new_n80_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x23), .O(new_n89_));
  nand2  g48(.a(new_n45_), .b(new_n80_), .O(new_n90_));
  ...
  nor3   g57(.a(new_n72_), .b(x13), .c(x12), .O(new_n99_));
