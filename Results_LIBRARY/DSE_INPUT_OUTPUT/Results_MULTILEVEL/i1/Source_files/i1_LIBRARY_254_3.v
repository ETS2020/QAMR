...
module FAU ( 
  ...
  nand3  g39(.a(new_n80_), .b(new_n47_), .c(new_n76_), .O(z05));
  nor2   g40(.a(new_n45_), .b(new_n78_), .O(z06));
  nand3  g41(.a(x24), .b(x18), .c(new_n43_), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z07));
  nor2   g43(.a(x24), .b(new_n43_), .O(z08));
  nand2  g44(.a(x22), .b(x14), .O(new_n87_));
  nor2   g45(.a(new_n87_), .b(x24), .O(z10));
  nand3  g46(.a(new_n44_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g47(.a(new_n89_), .b(new_n47_), .O(z11));
  nand2  g48(.a(x23), .b(x14), .O(new_n91_));
  nor2   g49(.a(new_n91_), .b(x24), .O(z12));
  nand3  g50(.a(new_n44_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g51(.a(new_n93_), .b(new_n47_), .O(z13));
  nand2  g52(.a(new_n44_), .b(x16), .O(new_n95_));
  nand2  g53(.a(new_n95_), .b(new_n47_), .O(z14));
  nor2   g54(.a(x13), .b(x12), .O(new_n97_));
  nor2   g55(.a(x15), .b(x14), .O(new_n98_));
  aoi21  g56(.a(new_n98_), .b(new_n97_), .c(new_n45_), .O(z15));
  zero   g57(.O(z09));
endmodule
