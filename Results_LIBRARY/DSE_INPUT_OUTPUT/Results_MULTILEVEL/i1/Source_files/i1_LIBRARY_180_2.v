...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n75_, new_n78_, new_n79_, new_n80_, new_n83_,
  ...
  nand3  g37(.a(new_n65_), .b(new_n60_), .c(new_n48_), .O(new_n79_));
  nand4  g38(.a(new_n61_), .b(x24), .c(x19), .d(new_n69_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .d(new_n78_), .O(z05));
  and2   g40(.a(x24), .b(x18), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n75_), .b(new_n83_), .O(z08));
  oai21  g43(.a(new_n64_), .b(new_n83_), .c(new_n75_), .O(z09));
  nand2  g44(.a(x22), .b(x14), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n43_), .c(x24), .O(z10));
  nand4  g46(.a(new_n64_), .b(x22), .c(new_n43_), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand2  g48(.a(x23), .b(x14), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n43_), .c(x24), .O(z12));
  nand4  g50(.a(new_n64_), .b(x23), .c(new_n43_), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z13));
  inv1   g52(.a(x16), .O(new_n94_));
  aoi21  g53(.a(new_n43_), .b(new_n94_), .c(x24), .O(z14));
