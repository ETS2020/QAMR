...
module FAU ( 
  ...
  nand2  g38(.a(new_n79_), .b(new_n42_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n42_), .b(new_n81_), .O(z08));
  nand3  g41(.a(new_n42_), .b(x24), .c(x11), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  inv1   g44(.a(x24), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n42_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n42_), .O(z11));
  nand3  g49(.a(new_n42_), .b(new_n86_), .c(x23), .O(new_n91_));
  ...
  nand3  g55(.a(new_n42_), .b(new_n86_), .c(x16), .O(new_n97_));
