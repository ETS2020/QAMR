...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n75_, new_n78_, new_n79_, new_n81_, new_n83_, new_n85_,
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(x20), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n63_), .c(new_n43_), .O(z02));
  inv1   g29(.a(x21), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n44_), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  nor4   g32(.a(new_n67_), .b(new_n64_), .c(x08), .d(x07), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(x20), .c(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n73_), .O(z05));
  nor2   g35(.a(x20), .b(new_n43_), .O(z06));
  inv1   g36(.a(new_n45_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x24), .c(x18), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n78_), .b(new_n81_), .O(z08));
