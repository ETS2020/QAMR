...
module FAU ( 
  ...
  nor2   g01(.a(x23), .b(x21), .O(new_n43_));
  ...
  nand3  g32(.a(x23), .b(new_n73_), .c(new_n71_), .O(z04));
  ...
  nand2  g37(.a(new_n44_), .b(new_n59_), .O(z06));
  ...
  nand4  g46(.a(new_n44_), .b(new_n81_), .c(x22), .d(x17), .O(new_n88_));
