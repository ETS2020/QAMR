...
module FAU ( 
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n62_));
  ...
  nand4  g24(.a(new_n65_), .b(x08), .c(new_n53_), .d(new_n52_), .O(new_n66_));
  ...
  nand2  g29(.a(new_n46_), .b(new_n70_), .O(z03));
  ...
  oai21  g35(.a(new_n76_), .b(new_n61_), .c(new_n43_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nand3  g38(.a(new_n46_), .b(x24), .c(x18), .O(new_n80_));
