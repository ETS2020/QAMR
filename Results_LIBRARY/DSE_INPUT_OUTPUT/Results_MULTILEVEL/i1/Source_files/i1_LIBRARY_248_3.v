...
module FAU ( 
  ...
  nor2   g15(.a(x22), .b(new_n42_), .O(new_n57_));
  ...
  nand3  g29(.a(new_n70_), .b(new_n59_), .c(x19), .O(new_n71_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n59_), .O(new_n78_));
  ...
  nand4  g45(.a(new_n85_), .b(x22), .c(new_n46_), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand4  g47(.a(new_n85_), .b(x22), .c(new_n46_), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand3  g49(.a(new_n85_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n43_), .O(z12));
  nand4  g51(.a(new_n43_), .b(new_n85_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand3  g53(.a(new_n43_), .b(new_n85_), .c(x16), .O(new_n95_));
