...
module FAU ( 
  ...
  oai21  g17(.a(new_n43_), .b(x00), .c(x05), .O(new_n59_));
  nor3   g18(.a(x03), .b(x02), .c(x01), .O(new_n60_));
  nor3   g19(.a(x07), .b(x06), .c(x04), .O(new_n61_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(x08), .d(new_n51_), .O(new_n67_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n66_), .c(new_n75_), .d(new_n51_), .O(new_n77_));
