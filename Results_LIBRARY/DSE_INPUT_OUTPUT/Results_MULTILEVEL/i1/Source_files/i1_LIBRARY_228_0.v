...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n92_, new_n93_, new_n94_, new_n96_,
  ...
  nand3  g19(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n61_));
  nand4  g20(.a(new_n51_), .b(new_n50_), .c(new_n45_), .d(new_n49_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nand4  g22(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n64_));
  ...
  nand2  g37(.a(new_n60_), .b(x05), .O(z06));
  inv1   g38(.a(x18), .O(new_n80_));
  nand2  g39(.a(new_n74_), .b(x24), .O(new_n81_));
  ...
  nand4  g45(.a(new_n74_), .b(new_n86_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n86_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n74_), .O(z11));
  inv1   g49(.a(x23), .O(new_n91_));
  nand2  g50(.a(new_n74_), .b(new_n86_), .O(new_n92_));
