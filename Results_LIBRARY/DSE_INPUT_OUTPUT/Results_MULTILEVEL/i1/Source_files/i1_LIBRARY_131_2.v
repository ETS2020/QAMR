...
module FAU ( 
  ...
  oai21  g15(.a(new_n43_), .b(x00), .c(x06), .O(new_n57_));
  nor3   g16(.a(x03), .b(x02), .c(x01), .O(new_n58_));
  nor3   g17(.a(x07), .b(x05), .c(x04), .O(new_n59_));
  ...
  nand4  g33(.a(x19), .b(new_n63_), .c(new_n51_), .d(new_n49_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n62_), .c(new_n74_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  oai21  g36(.a(new_n43_), .b(new_n74_), .c(new_n77_), .O(z05));
  nand2  g37(.a(new_n43_), .b(new_n50_), .O(z06));
  ...
  nand4  g49(.a(new_n44_), .b(new_n84_), .c(x23), .d(x14), .O(new_n91_));
