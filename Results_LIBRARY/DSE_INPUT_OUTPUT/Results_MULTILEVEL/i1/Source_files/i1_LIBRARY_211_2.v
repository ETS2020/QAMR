...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n73_, new_n75_,
  ...
  oai21  g32(.a(new_n73_), .b(new_n62_), .c(new_n43_), .O(z05));
  nand2  g33(.a(x24), .b(x18), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n70_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nor2   g36(.a(new_n44_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n70_), .O(z09));
  inv1   g39(.a(x14), .O(new_n81_));
  nand2  g40(.a(new_n79_), .b(x22), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n70_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n70_), .O(z11));
  nand3  g44(.a(new_n79_), .b(x23), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n70_), .O(z12));
  nand4  g46(.a(new_n70_), .b(new_n79_), .c(x23), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  nor3   g49(.a(new_n44_), .b(x24), .c(new_n90_), .O(z14));
