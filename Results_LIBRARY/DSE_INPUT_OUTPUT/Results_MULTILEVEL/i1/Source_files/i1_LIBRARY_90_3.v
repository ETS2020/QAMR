...
module FAU ( 
  ...
  nor2   g16(.a(x07), .b(new_n42_), .O(new_n58_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n65_), .c(new_n64_), .d(new_n61_), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  ...
  nand4  g35(.a(new_n66_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n60_), .c(new_n43_), .O(new_n78_));
