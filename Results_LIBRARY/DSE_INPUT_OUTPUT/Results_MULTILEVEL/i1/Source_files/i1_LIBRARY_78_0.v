...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n79_, new_n82_, new_n83_, new_n84_, new_n85_, new_n87_,
  ...
  nand2  g41(.a(new_n57_), .b(new_n77_), .O(new_n83_));
  ...
  nand4  g47(.a(new_n57_), .b(new_n77_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand3  g49(.a(new_n77_), .b(x23), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n57_), .O(z13));
  inv1   g51(.a(x16), .O(new_n93_));
  nor2   g52(.a(new_n83_), .b(new_n93_), .O(z14));
