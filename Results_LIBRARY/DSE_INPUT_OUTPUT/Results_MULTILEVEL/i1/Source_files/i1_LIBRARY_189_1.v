...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n88_, new_n90_, new_n92_, new_n93_, new_n95_, new_n97_,
    new_n99_, new_n100_;
  ...
  nor2   g40(.a(new_n43_), .b(new_n57_), .O(z06));
  inv1   g41(.a(x18), .O(new_n83_));
  inv1   g42(.a(x24), .O(new_n84_));
  nor3   g43(.a(new_n44_), .b(new_n84_), .c(new_n83_), .O(z07));
  nand2  g44(.a(new_n43_), .b(new_n57_), .O(z08));
  nor2   g45(.a(new_n84_), .b(new_n57_), .O(z09));
  nand4  g46(.a(new_n45_), .b(new_n84_), .c(x22), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand3  g48(.a(new_n84_), .b(x22), .c(x17), .O(new_n90_));
