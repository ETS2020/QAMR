...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n85_, new_n87_, new_n90_, new_n92_, new_n94_,
  ...
  nand4  g29(.a(new_n70_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(x19), .c(x13), .O(new_n73_));
  ...
  nand4  g40(.a(new_n62_), .b(x19), .c(x13), .d(new_n81_), .O(new_n82_));
  ...
  nor3   g58(.a(x15), .b(x14), .c(x12), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(x19), .c(new_n57_), .O(z15));
  buf    g60(.a(x19), .O(z06));
endmodule
