...
module FAU ( 
  ...
  nor2   g01(.a(x20), .b(x07), .O(new_n43_));
  ...
  nand2  g14(.a(new_n55_), .b(x20), .O(new_n56_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(new_n68_));
  nor2   g27(.a(x07), .b(x06), .O(new_n69_));
  nor2   g28(.a(new_n61_), .b(x09), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(x08), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n65_), .c(new_n60_), .O(z02));
  nand2  g31(.a(new_n61_), .b(x07), .O(z03));
  or2    g32(.a(z03), .b(x21), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  inv1   g34(.a(x08), .O(new_n76_));
  nand4  g35(.a(new_n69_), .b(x20), .c(x19), .d(new_n76_), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n67_), .c(new_n43_), .d(new_n75_), .O(z05));
  nand2  g37(.a(new_n44_), .b(new_n60_), .O(z06));
