...
module FAU ( 
  ...
  nor2   g02(.a(new_n43_), .b(x22), .O(new_n44_));
  ...
  nand2  g51(.a(new_n87_), .b(x14), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(x22), .c(new_n43_), .O(z12));
  nand3  g53(.a(x23), .b(x22), .c(x17), .O(new_n95_));
