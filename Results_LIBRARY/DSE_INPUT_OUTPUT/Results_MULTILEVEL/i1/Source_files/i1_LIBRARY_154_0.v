...
module FAU ( 
  ...
  aoi21  g23(.a(new_n64_), .b(new_n61_), .c(new_n58_), .O(new_n65_));
  nor3   g24(.a(x03), .b(x02), .c(x01), .O(new_n66_));
  nor2   g25(.a(x07), .b(x06), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(new_n48_), .d(new_n59_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x19), .c(x00), .O(new_n69_));
  oai21  g28(.a(new_n65_), .b(x09), .c(new_n69_), .O(z02));
  ...
  nand4  g35(.a(new_n76_), .b(new_n62_), .c(new_n61_), .d(new_n50_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n72_), .c(new_n75_), .O(z05));
  nand2  g37(.a(new_n58_), .b(x09), .O(z06));
  ...
  nand4  g45(.a(new_n72_), .b(new_n86_), .c(x22), .d(x14), .O(new_n87_));
