...
module FAU ( 
  ...
  nand3  g19(.a(new_n60_), .b(x08), .c(new_n52_), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n46_), .O(new_n63_));
  nor3   g22(.a(x03), .b(x02), .c(x01), .O(new_n64_));
  nor2   g23(.a(x07), .b(x06), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(new_n50_), .d(new_n58_), .O(new_n66_));
  nand3  g25(.a(new_n66_), .b(x19), .c(x00), .O(new_n67_));
  oai21  g26(.a(new_n63_), .b(x09), .c(new_n67_), .O(z02));
  ...
  nand4  g33(.a(new_n60_), .b(x19), .c(new_n74_), .d(new_n52_), .O(new_n75_));
  oai22  g34(.a(new_n75_), .b(new_n59_), .c(new_n43_), .d(new_n73_), .O(z05));
  nand2  g35(.a(new_n46_), .b(x09), .O(z06));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n44_), .O(z09));
  nand4  g42(.a(new_n44_), .b(new_n82_), .c(x22), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z10));
  nand3  g44(.a(new_n82_), .b(x22), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z11));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n82_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n44_), .O(z12));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n44_), .O(z13));
