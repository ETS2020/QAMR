...
module FAU ( 
  ...
  aoi22  g30(.a(x22), .b(new_n43_), .c(new_n71_), .d(new_n69_), .O(z04));
  ...
  nand2  g37(.a(new_n78_), .b(new_n43_), .O(z06));
  ...
  nand3  g44(.a(x22), .b(x19), .c(x14), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(x24), .O(z10));
  nand2  g46(.a(new_n84_), .b(x17), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(x19), .c(new_n78_), .O(z11));
