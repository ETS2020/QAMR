...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(x22), .O(new_n69_));
  ...
  oai21  g36(.a(new_n77_), .b(x22), .c(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n76_), .O(z05));
  nand3  g38(.a(new_n74_), .b(x24), .c(x18), .O(new_n80_));
  ...
  nand2  g44(.a(new_n84_), .b(x14), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n43_), .c(new_n44_), .O(z10));
  nand2  g46(.a(new_n84_), .b(x17), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n43_), .c(new_n44_), .O(z11));
  nand4  g48(.a(new_n74_), .b(new_n84_), .c(x23), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n84_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n74_), .O(z13));
  nand2  g52(.a(new_n84_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n74_), .O(z14));
