...
module FAU ( 
  ...
  oai21  g16(.a(new_n43_), .b(x00), .c(x07), .O(new_n58_));
  nor3   g17(.a(x03), .b(x02), .c(x01), .O(new_n59_));
  nor3   g18(.a(x06), .b(x05), .c(x04), .O(new_n60_));
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(x08), .d(new_n52_), .O(new_n66_));
  ...
  nand3  g34(.a(new_n65_), .b(x19), .c(new_n75_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(new_n74_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n52_), .O(new_n78_));
  oai21  g37(.a(new_n43_), .b(new_n74_), .c(new_n78_), .O(z05));
  nand2  g38(.a(new_n43_), .b(new_n52_), .O(z06));
  ...
  nand4  g48(.a(new_n44_), .b(new_n87_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand4  g50(.a(new_n44_), .b(new_n87_), .c(x23), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand3  g52(.a(new_n87_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(z13));
