...
module FAU ( 
  ...
  and2   g01(.a(x21), .b(x19), .O(new_n43_));
  ...
  nand4  g63(.a(new_n104_), .b(new_n74_), .c(new_n103_), .d(new_n102_), .O(z15));
  buf    g64(.a(x19), .O(z06));
endmodule
