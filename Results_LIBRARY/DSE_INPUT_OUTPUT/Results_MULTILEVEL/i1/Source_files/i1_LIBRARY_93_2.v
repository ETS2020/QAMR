...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n88_, new_n90_, new_n92_, new_n94_, new_n95_, new_n97_,
    new_n98_, new_n99_;
  ...
  nand3  g15(.a(new_n56_), .b(x23), .c(x19), .O(new_n57_));
  ...
  nand3  g27(.a(new_n68_), .b(x23), .c(x19), .O(new_n69_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n63_), .c(x23), .O(new_n76_));
  ...
  nand4  g44(.a(new_n44_), .b(new_n85_), .c(x22), .d(x14), .O(new_n86_));
  ...
  nor2   g54(.a(new_n95_), .b(new_n94_), .O(z14));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x13), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nand4  g58(.a(new_n99_), .b(new_n44_), .c(new_n98_), .d(new_n97_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
