...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n65_), .c(new_n64_), .d(new_n50_), .O(new_n68_));
  ...
  nand4  g34(.a(new_n65_), .b(x19), .c(new_n66_), .d(new_n50_), .O(new_n76_));
  oai22  g35(.a(new_n76_), .b(new_n63_), .c(new_n43_), .d(new_n75_), .O(z05));
  nand2  g36(.a(new_n58_), .b(x09), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  nand2  g38(.a(new_n73_), .b(x24), .O(new_n80_));
  ...
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n73_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n73_), .O(z11));
  nand2  g49(.a(new_n86_), .b(x23), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n85_), .c(new_n73_), .O(z12));
  oai21  g51(.a(new_n91_), .b(new_n89_), .c(new_n73_), .O(z13));
  nand2  g52(.a(new_n86_), .b(x16), .O(new_n94_));
