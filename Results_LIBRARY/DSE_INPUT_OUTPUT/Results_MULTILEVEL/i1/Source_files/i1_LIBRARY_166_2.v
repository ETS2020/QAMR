...
module FAU ( 
  ...
  nand2  g40(.a(new_n46_), .b(new_n78_), .O(z06));
  ...
  nand3  g47(.a(x23), .b(x22), .c(x14), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(x24), .O(z10));
  nand2  g49(.a(new_n87_), .b(x17), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(x23), .c(new_n43_), .O(z11));
  nand3  g51(.a(new_n87_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n46_), .O(z12));
  nand2  g53(.a(x23), .b(x17), .O(new_n95_));
  nor2   g54(.a(new_n95_), .b(x24), .O(z13));
  nand2  g55(.a(new_n87_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n46_), .O(z14));
