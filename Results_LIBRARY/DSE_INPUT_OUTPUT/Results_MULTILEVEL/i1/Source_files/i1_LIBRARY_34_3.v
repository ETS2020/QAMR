...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n81_, new_n82_, new_n84_, new_n86_,
  ...
  nor2   g29(.a(x24), .b(new_n70_), .O(z03));
  ...
  nand3  g37(.a(x24), .b(new_n70_), .c(x18), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  inv1   g40(.a(x24), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n70_), .c(new_n81_), .O(z08));
  nand3  g42(.a(x24), .b(new_n70_), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  nand2  g44(.a(x22), .b(x14), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(x24), .O(z10));
  nand3  g46(.a(new_n82_), .b(x22), .c(x17), .O(new_n88_));
