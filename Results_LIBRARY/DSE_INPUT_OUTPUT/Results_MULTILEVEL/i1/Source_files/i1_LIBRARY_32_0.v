...
module FAU ( 
  ...
  nand4  g33(.a(new_n65_), .b(x19), .c(new_n66_), .d(new_n50_), .O(new_n75_));
  oai22  g34(.a(new_n75_), .b(new_n63_), .c(new_n43_), .d(new_n74_), .O(z05));
  nand2  g35(.a(new_n58_), .b(x09), .O(z06));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n71_), .O(z09));
  nand3  g42(.a(new_n82_), .b(x22), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n71_), .O(z10));
  nand4  g44(.a(new_n71_), .b(new_n82_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  nand4  g46(.a(new_n71_), .b(new_n82_), .c(x23), .d(x14), .O(new_n88_));
