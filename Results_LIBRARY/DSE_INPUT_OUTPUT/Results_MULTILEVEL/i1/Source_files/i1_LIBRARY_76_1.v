...
module FAU ( 
  ...
  aoi21  g43(.a(new_n84_), .b(x15), .c(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n44_), .b(new_n86_), .O(z08));
  nor3   g46(.a(new_n72_), .b(new_n84_), .c(new_n86_), .O(z09));
  ...
  nor3   g60(.a(x14), .b(x13), .c(x12), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(x18), .c(new_n43_), .O(z15));
endmodule
