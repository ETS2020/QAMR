...
module FAU ( 
  ...
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n64_), .d(new_n52_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n58_), .c(new_n74_), .O(z05));
  nand2  g37(.a(new_n46_), .b(new_n43_), .O(z06));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n58_), .O(z07));
  ...
  nand4  g46(.a(new_n58_), .b(new_n84_), .c(x22), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand4  g48(.a(new_n58_), .b(new_n84_), .c(x23), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n84_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n58_), .O(z13));
  nand2  g52(.a(new_n84_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n58_), .O(z14));
