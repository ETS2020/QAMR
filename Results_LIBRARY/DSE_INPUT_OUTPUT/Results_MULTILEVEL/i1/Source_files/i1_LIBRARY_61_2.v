...
module FAU ( 
  ...
  nand3  g33(.a(new_n60_), .b(x19), .c(new_n52_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n59_), .c(new_n74_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  oai21  g36(.a(new_n46_), .b(new_n74_), .c(new_n77_), .O(z05));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(new_n44_), .O(new_n80_));
  ...
  nand2  g46(.a(new_n80_), .b(new_n87_), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  ...
  nand3  g52(.a(new_n87_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n80_), .O(z12));
  nand4  g54(.a(new_n80_), .b(new_n87_), .c(x23), .d(x17), .O(new_n96_));
