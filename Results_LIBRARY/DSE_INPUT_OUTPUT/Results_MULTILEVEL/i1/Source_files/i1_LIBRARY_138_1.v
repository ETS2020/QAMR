...
module FAU ( 
  ...
  nand2  g32(.a(new_n67_), .b(x24), .O(new_n74_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n67_), .O(z10));
  nand4  g40(.a(new_n67_), .b(new_n79_), .c(x22), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z11));
  nand4  g42(.a(new_n67_), .b(new_n79_), .c(x23), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z12));
  nand3  g44(.a(new_n79_), .b(x23), .c(x17), .O(new_n86_));
