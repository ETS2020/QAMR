...
module FAU ( 
  ...
  nand4  g27(.a(new_n68_), .b(new_n64_), .c(new_n61_), .d(new_n47_), .O(new_n69_));
  ...
  nand3  g35(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n77_));
  inv1   g36(.a(x08), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n79_));
