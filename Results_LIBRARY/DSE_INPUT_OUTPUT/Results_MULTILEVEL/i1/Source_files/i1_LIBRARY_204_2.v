...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(x00), .c(x07), .O(new_n60_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(x08), .d(new_n43_), .O(new_n68_));
  ...
  oai21  g39(.a(new_n59_), .b(new_n76_), .c(new_n80_), .O(z05));
  nand2  g40(.a(new_n59_), .b(new_n43_), .O(z06));
  inv1   g41(.a(x18), .O(new_n83_));
  nand2  g42(.a(new_n46_), .b(x24), .O(new_n84_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n46_), .O(z10));
  nand4  g50(.a(new_n46_), .b(new_n89_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  inv1   g52(.a(x14), .O(new_n94_));
  nand2  g53(.a(new_n89_), .b(x23), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n94_), .c(new_n46_), .O(z12));
  inv1   g55(.a(x17), .O(new_n97_));
  oai21  g56(.a(new_n95_), .b(new_n97_), .c(new_n46_), .O(z13));
