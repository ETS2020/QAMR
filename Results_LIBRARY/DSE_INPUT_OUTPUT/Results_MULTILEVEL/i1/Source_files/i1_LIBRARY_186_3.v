...
module FAU ( 
  ...
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n42_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n42_), .O(z11));
  ...
  nand3  g53(.a(new_n42_), .b(new_n84_), .c(x16), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z14));
  nor2   g55(.a(x13), .b(x12), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n60_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
