// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:37 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n70_, new_n71_, new_n73_, new_n74_,
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(new_n49_), .d(new_n57_), .O(new_n66_));
  nand3  g25(.a(new_n66_), .b(x19), .c(x00), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n63_), .O(z02));
  and2   g27(.a(new_n44_), .b(x20), .O(z03));
  ...
  inv1   g32(.a(new_n58_), .O(new_n74_));
  nor2   g33(.a(new_n43_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n59_), .c(new_n74_), .d(new_n51_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(new_n73_), .O(z05));
  nand2  g36(.a(x24), .b(x18), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n44_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nor2   g39(.a(new_n70_), .b(new_n80_), .O(z08));
  inv1   g40(.a(x24), .O(new_n82_));
  nor3   g41(.a(new_n70_), .b(new_n82_), .c(new_n80_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  nand2  g43(.a(new_n82_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n44_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n44_), .O(z11));
  nand3  g47(.a(new_n82_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n44_), .O(z12));
  nand4  g49(.a(new_n44_), .b(new_n82_), .c(x23), .d(x17), .O(new_n91_));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n70_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
