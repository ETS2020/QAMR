...
module FAU ( 
  ...
  nand3  g33(.a(new_n74_), .b(new_n64_), .c(new_n43_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand3  g35(.a(new_n65_), .b(new_n60_), .c(new_n48_), .O(new_n77_));
  nand4  g36(.a(new_n61_), .b(x20), .c(x19), .d(new_n69_), .O(new_n78_));
  ...
  nand4  g45(.a(new_n85_), .b(new_n81_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n81_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n85_), .O(z11));
  nand4  g49(.a(new_n85_), .b(new_n81_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n81_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n85_), .O(z13));
  nand2  g53(.a(new_n81_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n85_), .O(z14));
