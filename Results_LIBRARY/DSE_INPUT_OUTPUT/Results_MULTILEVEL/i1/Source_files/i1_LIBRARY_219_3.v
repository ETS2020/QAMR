...
module FAU ( 
  ...
  nor2   g39(.a(new_n44_), .b(x17), .O(z06));
  nand3  g40(.a(new_n73_), .b(x24), .c(x18), .O(new_n82_));
  ...
  nand2  g48(.a(new_n86_), .b(x22), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n44_), .c(new_n43_), .O(z11));
  nand2  g50(.a(x19), .b(x17), .O(new_n92_));
  nand4  g51(.a(new_n92_), .b(new_n86_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand4  g53(.a(new_n86_), .b(x23), .c(new_n44_), .d(x17), .O(new_n95_));
