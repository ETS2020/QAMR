...
module FAU ( 
  ...
  nor2   g42(.a(new_n83_), .b(new_n43_), .O(z08));
  nand4  g43(.a(new_n83_), .b(x22), .c(x14), .d(new_n43_), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z10));
  nand2  g45(.a(x22), .b(x17), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n43_), .c(x24), .O(z11));
  nand4  g47(.a(new_n83_), .b(x23), .c(x14), .d(new_n43_), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand2  g49(.a(x23), .b(x17), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n43_), .c(x24), .O(z13));
  inv1   g51(.a(x16), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n43_), .c(x24), .O(z14));
  nor2   g53(.a(x13), .b(x12), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n44_), .O(z15));
  nor2   g56(.a(new_n83_), .b(new_n43_), .O(z09));
endmodule
