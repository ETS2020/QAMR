...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n79_, new_n81_, new_n82_, new_n84_, new_n86_, new_n88_,
  ...
  nand4  g20(.a(new_n58_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n62_));
  nand2  g21(.a(new_n51_), .b(new_n50_), .O(new_n63_));
  ...
  oai21  g26(.a(new_n67_), .b(new_n46_), .c(new_n44_), .O(z02));
  ...
  aoi21  g31(.a(new_n61_), .b(x19), .c(x08), .O(new_n73_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z12));
  nand4  g46(.a(new_n44_), .b(new_n79_), .c(x23), .d(x17), .O(new_n88_));
