...
module FAU ( 
  ...
  nand4  g41(.a(new_n44_), .b(new_n76_), .c(x22), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand4  g43(.a(new_n44_), .b(new_n76_), .c(x23), .d(x14), .O(new_n85_));
  ...
  inv1   g49(.a(x15), .O(new_n91_));
  nor3   g50(.a(x14), .b(x13), .c(x12), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n46_), .c(new_n91_), .O(z15));
  buf    g52(.a(x19), .O(z06));
endmodule
