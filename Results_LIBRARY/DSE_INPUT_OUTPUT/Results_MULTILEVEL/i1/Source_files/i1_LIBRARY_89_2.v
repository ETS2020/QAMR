...
module FAU ( 
  ...
  nand4  g18(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n43_), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  nand4  g20(.a(new_n43_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n62_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n64_), .c(new_n63_), .d(new_n53_), .O(new_n67_));
  ...
  nand4  g33(.a(new_n74_), .b(new_n64_), .c(new_n63_), .d(new_n53_), .O(new_n75_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n45_), .O(z11));
