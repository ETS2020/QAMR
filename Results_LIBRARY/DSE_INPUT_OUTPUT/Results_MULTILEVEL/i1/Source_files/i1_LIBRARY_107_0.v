...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n89_, new_n91_, new_n93_, new_n95_;
  ...
  nand4  g33(.a(new_n66_), .b(x19), .c(new_n67_), .d(new_n51_), .O(new_n75_));
  oai22  g34(.a(new_n75_), .b(new_n64_), .c(new_n43_), .d(new_n74_), .O(z05));
  nand2  g35(.a(new_n59_), .b(x14), .O(z06));
  nand2  g36(.a(x24), .b(x18), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n45_), .O(z07));
  ...
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n45_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n45_), .O(z11));
  nand3  g47(.a(new_n82_), .b(x23), .c(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand4  g49(.a(new_n45_), .b(new_n82_), .c(x23), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z13));
  nand2  g51(.a(new_n82_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n45_), .O(z14));
  nor3   g53(.a(x15), .b(x13), .c(x12), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n59_), .c(new_n84_), .O(z15));
endmodule
