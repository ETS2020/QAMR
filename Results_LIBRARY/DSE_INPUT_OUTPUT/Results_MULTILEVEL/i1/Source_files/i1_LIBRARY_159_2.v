...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n78_, new_n80_, new_n81_, new_n84_, new_n86_,
  ...
  nand3  g30(.a(new_n63_), .b(x19), .c(new_n64_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n62_), .c(x10), .O(new_n74_));
  nand2  g33(.a(x19), .b(x10), .O(new_n75_));
  oai21  g34(.a(new_n74_), .b(x07), .c(new_n75_), .O(z05));
  ...
  inv1   g39(.a(new_n44_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n80_), .O(z08));
  oai21  g41(.a(new_n78_), .b(new_n80_), .c(new_n81_), .O(z09));
  nand3  g42(.a(new_n78_), .b(x22), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n81_), .O(z10));
  nand4  g44(.a(new_n81_), .b(new_n78_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n78_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n81_), .O(z12));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n81_), .O(z13));
  nand2  g51(.a(new_n78_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n81_), .O(z14));
