...
module FAU ( 
  ...
  aoi21  g39(.a(new_n80_), .b(new_n76_), .c(new_n44_), .O(z05));
  ...
  nand2  g52(.a(new_n84_), .b(x14), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(x20), .c(new_n43_), .O(z12));
  nor4   g54(.a(x24), .b(new_n43_), .c(new_n72_), .d(new_n92_), .O(z13));
