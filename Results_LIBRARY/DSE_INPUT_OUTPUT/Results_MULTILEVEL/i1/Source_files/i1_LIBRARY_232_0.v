...
module FAU ( 
  ...
  oai21  g32(.a(new_n71_), .b(new_n59_), .c(new_n73_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nor4   g34(.a(new_n67_), .b(new_n59_), .c(x08), .d(x07), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n65_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n44_), .c(new_n75_), .O(z05));
  nand2  g37(.a(x21), .b(new_n59_), .O(z06));
  ...
  nand2  g42(.a(x24), .b(x11), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z09));
  inv1   g44(.a(x22), .O(new_n86_));
  nor3   g45(.a(new_n43_), .b(x24), .c(new_n86_), .O(new_n87_));
  ...
  oai21  g57(.a(x24), .b(new_n98_), .c(new_n44_), .O(z14));
