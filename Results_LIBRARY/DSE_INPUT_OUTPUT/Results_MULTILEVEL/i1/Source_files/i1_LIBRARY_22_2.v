// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:07 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_,
  ...
  nand3  g31(.a(new_n72_), .b(new_n71_), .c(new_n69_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor2   g33(.a(new_n46_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n64_), .c(new_n63_), .d(new_n52_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n72_), .c(new_n74_), .O(z05));
  nand2  g36(.a(new_n46_), .b(new_n43_), .O(z06));
  nand3  g37(.a(x24), .b(x19), .c(x18), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n44_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n44_), .b(new_n83_), .c(new_n81_), .O(z09));
  nand4  g43(.a(new_n72_), .b(new_n83_), .c(x22), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z10));
  nand3  g45(.a(new_n83_), .b(x22), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n72_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n83_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n72_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n72_), .O(z13));
