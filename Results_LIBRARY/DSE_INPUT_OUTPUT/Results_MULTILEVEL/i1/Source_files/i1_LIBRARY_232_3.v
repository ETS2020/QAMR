...
module FAU ( 
  ...
  nor2   g14(.a(x21), .b(new_n42_), .O(new_n56_));
  ...
  aoi21  g25(.a(new_n66_), .b(new_n63_), .c(x21), .O(new_n67_));
  ...
  oai21  g31(.a(new_n71_), .b(x19), .c(new_n72_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor2   g33(.a(x08), .b(x07), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n50_), .c(new_n49_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n62_), .c(new_n71_), .O(new_n77_));
  ...
  aoi21  g41(.a(x21), .b(x19), .c(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n43_), .O(z09));
  nand3  g44(.a(new_n43_), .b(new_n84_), .c(x22), .O(new_n86_));
  ...
  nand3  g50(.a(new_n43_), .b(new_n84_), .c(x23), .O(new_n92_));
  ...
  nand4  g61(.a(new_n102_), .b(new_n43_), .c(new_n101_), .d(new_n100_), .O(z15));
  buf    g62(.a(x19), .O(z06));
endmodule
