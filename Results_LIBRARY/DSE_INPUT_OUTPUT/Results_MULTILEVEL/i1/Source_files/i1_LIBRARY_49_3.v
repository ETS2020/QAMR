...
module FAU ( 
  ...
  nor2   g15(.a(x15), .b(new_n42_), .O(new_n57_));
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(x15), .O(new_n68_));
  ...
  nand3  g35(.a(new_n76_), .b(new_n51_), .c(new_n50_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n63_), .c(new_n75_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n74_), .O(z05));
  nor2   g39(.a(new_n46_), .b(x15), .O(z06));
  ...
  nand2  g47(.a(new_n88_), .b(new_n43_), .O(z10));
  nand4  g48(.a(new_n43_), .b(new_n86_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n86_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n43_), .O(z13));
  nand3  g55(.a(new_n43_), .b(new_n86_), .c(x16), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z14));
  nor2   g57(.a(x13), .b(x12), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n75_), .c(new_n92_), .O(z15));
endmodule
