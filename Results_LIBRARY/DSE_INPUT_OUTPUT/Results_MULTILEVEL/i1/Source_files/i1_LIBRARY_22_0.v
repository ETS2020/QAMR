...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n88_,
  ...
  nand3  g30(.a(new_n71_), .b(new_n70_), .c(new_n68_), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  nor2   g32(.a(new_n45_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n63_), .c(new_n62_), .d(new_n51_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n71_), .c(new_n73_), .O(z05));
  nand2  g35(.a(new_n45_), .b(x18), .O(z06));
  ...
  nand4  g41(.a(new_n71_), .b(new_n81_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n81_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n71_), .O(z11));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n81_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n71_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n71_), .O(z13));
  inv1   g50(.a(x16), .O(new_n92_));
  nor3   g51(.a(new_n43_), .b(x24), .c(new_n92_), .O(z14));
  nor2   g52(.a(x15), .b(x14), .O(new_n94_));
  nor3   g53(.a(new_n43_), .b(x13), .c(x12), .O(new_n95_));
