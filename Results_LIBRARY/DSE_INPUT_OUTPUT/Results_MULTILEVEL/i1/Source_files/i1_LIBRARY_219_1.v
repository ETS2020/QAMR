...
module FAU ( 
  ...
  nand3  g15(.a(new_n56_), .b(x19), .c(x17), .O(new_n57_));
  ...
  nand3  g27(.a(new_n68_), .b(x19), .c(x17), .O(new_n69_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x17), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n75_), .O(z05));
  and2   g38(.a(x19), .b(x17), .O(z06));
  ...
  nand2  g43(.a(new_n72_), .b(new_n84_), .O(z08));
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n72_), .O(z09));
  nand4  g45(.a(new_n72_), .b(new_n82_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n82_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n72_), .O(z11));
  nand4  g49(.a(new_n72_), .b(new_n82_), .c(x23), .d(x14), .O(new_n91_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n72_), .O(z14));
