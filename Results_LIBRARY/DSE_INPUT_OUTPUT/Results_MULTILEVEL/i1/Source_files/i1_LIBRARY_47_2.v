...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n88_, new_n89_, new_n91_, new_n93_, new_n96_,
    new_n98_, new_n99_;
  ...
  nand2  g30(.a(x23), .b(x20), .O(new_n72_));
  oai21  g31(.a(new_n71_), .b(x20), .c(new_n72_), .O(z04));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n74_), .c(new_n75_), .O(z05));
  nor2   g39(.a(new_n75_), .b(new_n77_), .O(z06));
  inv1   g40(.a(x18), .O(new_n82_));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n75_), .b(new_n83_), .c(new_n82_), .O(z07));
  ...
  nor3   g53(.a(x24), .b(new_n43_), .c(new_n91_), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  nor3   g55(.a(new_n75_), .b(x24), .c(new_n96_), .O(z14));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nor3   g57(.a(new_n75_), .b(x13), .c(x12), .O(new_n99_));
