...
module FAU ( 
  ...
  oai21  g17(.a(new_n43_), .b(x05), .c(x24), .O(new_n59_));
  ...
  nor2   g22(.a(new_n59_), .b(new_n61_), .O(z09));
  inv1   g23(.a(x14), .O(new_n65_));
  inv1   g24(.a(x24), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(x22), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n65_), .c(new_n62_), .O(z10));
  inv1   g27(.a(x17), .O(new_n69_));
  oai21  g28(.a(new_n67_), .b(new_n69_), .c(new_n62_), .O(z11));
  nand3  g29(.a(new_n66_), .b(x23), .c(x14), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n62_), .O(z12));
  nand4  g31(.a(new_n62_), .b(new_n66_), .c(x23), .d(x17), .O(new_n73_));
