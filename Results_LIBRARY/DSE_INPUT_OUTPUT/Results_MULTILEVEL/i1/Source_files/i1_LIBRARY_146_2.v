...
module FAU ( 
  ...
  nand3  g23(.a(new_n43_), .b(x08), .c(new_n53_), .O(new_n65_));
  nor3   g24(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(new_n66_));
  aoi21  g25(.a(new_n62_), .b(x00), .c(new_n66_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n47_), .c(new_n45_), .O(z02));
