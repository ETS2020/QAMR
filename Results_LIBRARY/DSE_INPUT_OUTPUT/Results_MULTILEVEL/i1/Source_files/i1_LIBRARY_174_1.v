...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n87_, new_n89_, new_n91_, new_n93_, new_n95_, new_n96_;
  ...
  nand4  g34(.a(new_n75_), .b(new_n74_), .c(new_n64_), .d(new_n52_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n58_), .c(new_n73_), .O(z05));
  ...
  nand2  g40(.a(new_n58_), .b(new_n81_), .O(z08));
  oai21  g41(.a(new_n79_), .b(new_n81_), .c(new_n58_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  nand2  g43(.a(new_n79_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n58_), .O(z11));
  nand3  g47(.a(new_n79_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n58_), .O(z12));
  nand4  g49(.a(new_n58_), .b(new_n79_), .c(x23), .d(x17), .O(new_n91_));
