...
module FAU ( 
  ...
  nor2   g13(.a(new_n54_), .b(x05), .O(new_n55_));
  ...
  aoi21  g22(.a(new_n63_), .b(new_n62_), .c(x16), .O(new_n64_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n69_), .c(x08), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n65_), .c(new_n61_), .O(z02));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n43_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n47_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n78_), .O(z05));
  nand2  g44(.a(new_n45_), .b(new_n61_), .O(z06));
  ...
  oai21  g57(.a(new_n98_), .b(new_n97_), .c(new_n45_), .O(z12));
  inv1   g58(.a(x17), .O(new_n100_));
  oai21  g59(.a(new_n98_), .b(new_n100_), .c(new_n45_), .O(z13));
  nor3   g60(.a(x24), .b(new_n43_), .c(new_n47_), .O(z14));
