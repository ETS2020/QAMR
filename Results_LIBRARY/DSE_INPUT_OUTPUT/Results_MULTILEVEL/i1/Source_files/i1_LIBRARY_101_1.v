...
module FAU ( 
  ...
  nand2  g38(.a(new_n43_), .b(new_n47_), .O(z06));
  nand3  g39(.a(x24), .b(x19), .c(x18), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n45_), .b(new_n83_), .O(z08));
  aoi21  g43(.a(x19), .b(new_n83_), .c(new_n43_), .O(z09));
  ...
  nand2  g49(.a(new_n43_), .b(x23), .O(new_n91_));
