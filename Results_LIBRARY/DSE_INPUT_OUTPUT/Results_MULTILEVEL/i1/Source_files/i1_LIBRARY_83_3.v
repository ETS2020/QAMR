...
module FAU ( 
  ...
  nor2   g15(.a(x03), .b(new_n42_), .O(new_n57_));
  ...
  nor2   g24(.a(new_n65_), .b(x03), .O(new_n66_));
  ...
  nor2   g36(.a(new_n46_), .b(x03), .O(z06));
  ...
  nand3  g49(.a(new_n86_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n43_), .O(z12));
  nand4  g51(.a(new_n43_), .b(new_n86_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand3  g53(.a(new_n43_), .b(new_n86_), .c(x16), .O(new_n95_));
