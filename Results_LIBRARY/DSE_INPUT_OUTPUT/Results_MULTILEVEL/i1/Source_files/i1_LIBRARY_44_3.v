...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(x21), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n64_), .c(new_n43_), .O(z02));
  inv1   g30(.a(x20), .O(new_n72_));
  nor2   g31(.a(new_n45_), .b(new_n72_), .O(z03));
  nand2  g32(.a(new_n44_), .b(new_n72_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nor4   g34(.a(new_n68_), .b(new_n65_), .c(x08), .d(x07), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(x21), .c(x19), .O(new_n77_));
  ...
  nand3  g41(.a(new_n46_), .b(x24), .c(x11), .O(new_n83_));
  ...
  nand3  g51(.a(new_n92_), .b(x23), .c(x14), .O(new_n93_));
