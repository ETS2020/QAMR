...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(x00), .c(x06), .O(new_n60_));
  ...
  nand4  g37(.a(new_n78_), .b(new_n67_), .c(new_n77_), .d(new_n51_), .O(new_n79_));
  ...
  oai21  g52(.a(new_n93_), .b(new_n88_), .c(new_n45_), .O(z12));
  oai21  g53(.a(new_n93_), .b(new_n91_), .c(new_n45_), .O(z13));
