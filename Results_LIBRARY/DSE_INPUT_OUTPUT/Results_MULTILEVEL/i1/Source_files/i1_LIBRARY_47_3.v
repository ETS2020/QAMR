...
module FAU ( 
  ...
  oai21  g32(.a(x23), .b(new_n43_), .c(new_n73_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  inv1   g34(.a(new_n65_), .O(new_n76_));
  inv1   g35(.a(x19), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(x08), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n66_), .c(new_n76_), .d(new_n53_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n75_), .c(new_n45_), .O(z05));
  nor2   g39(.a(new_n45_), .b(new_n77_), .O(z06));
  ...
  nand2  g51(.a(new_n86_), .b(x14), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n43_), .c(new_n44_), .O(z12));
  nand4  g53(.a(new_n86_), .b(x23), .c(new_n43_), .d(x17), .O(new_n95_));
