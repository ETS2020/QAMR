...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n49_, new_n51_, new_n53_,
    new_n54_, new_n55_, new_n57_, new_n58_, new_n60_, new_n63_, new_n64_,
  ...
  nand2  g23(.a(new_n64_), .b(new_n55_), .O(z10));
  nand4  g24(.a(new_n55_), .b(new_n63_), .c(x22), .d(x17), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z11));
  nand4  g26(.a(new_n55_), .b(new_n63_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  nand4  g28(.a(new_n55_), .b(new_n63_), .c(x23), .d(x17), .O(new_n70_));
