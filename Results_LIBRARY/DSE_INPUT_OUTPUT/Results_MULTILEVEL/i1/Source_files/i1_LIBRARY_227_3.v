...
module FAU ( 
  ...
  aoi21  g41(.a(new_n43_), .b(new_n82_), .c(new_n44_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  aoi21  g43(.a(x24), .b(x19), .c(new_n84_), .O(z08));
  nand3  g44(.a(x24), .b(new_n43_), .c(x11), .O(new_n86_));
  ...
  nand3  g52(.a(new_n44_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n46_), .O(z13));
  nand2  g54(.a(new_n44_), .b(x16), .O(new_n96_));
