...
module FAU ( 
  ...
  nand2  g40(.a(new_n46_), .b(x24), .O(new_n82_));
  ...
  nand4  g46(.a(new_n46_), .b(new_n87_), .c(x22), .d(x14), .O(new_n88_));
  ...
  nand4  g52(.a(new_n46_), .b(new_n87_), .c(x23), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  nand2  g54(.a(new_n87_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n46_), .O(z14));
  nor3   g56(.a(x15), .b(x14), .c(x12), .O(new_n98_));
  nand2  g57(.a(x19), .b(x13), .O(new_n99_));
  oai21  g58(.a(new_n98_), .b(x13), .c(new_n99_), .O(z15));
endmodule
