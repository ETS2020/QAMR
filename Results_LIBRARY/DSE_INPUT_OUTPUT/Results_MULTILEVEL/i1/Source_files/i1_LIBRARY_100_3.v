...
module FAU ( 
  ...
  oai21  g15(.a(new_n56_), .b(new_n51_), .c(x00), .O(new_n57_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n77_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  nand2  g43(.a(new_n82_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n77_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n77_), .O(z11));
  nand3  g47(.a(new_n82_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n77_), .O(z12));
  nand4  g49(.a(new_n77_), .b(new_n82_), .c(x23), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z13));
  nand2  g51(.a(new_n82_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n77_), .O(z14));
  inv1   g53(.a(x12), .O(new_n95_));
  inv1   g54(.a(x13), .O(new_n96_));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  nand4  g56(.a(new_n97_), .b(new_n77_), .c(new_n96_), .d(new_n95_), .O(z15));
endmodule
