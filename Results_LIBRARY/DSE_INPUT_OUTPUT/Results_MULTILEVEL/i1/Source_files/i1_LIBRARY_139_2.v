...
module FAU ( 
  ...
  nand3  g34(.a(new_n63_), .b(x19), .c(new_n51_), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n62_), .O(new_n77_));
  ...
  inv1   g44(.a(new_n44_), .O(new_n86_));
  ...
  nand2  g51(.a(new_n86_), .b(new_n82_), .O(new_n93_));
