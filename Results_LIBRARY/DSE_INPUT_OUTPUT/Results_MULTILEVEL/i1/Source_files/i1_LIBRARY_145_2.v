...
module FAU ( 
  ...
  nand4  g37(.a(new_n78_), .b(new_n77_), .c(new_n67_), .d(new_n43_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n46_), .c(new_n76_), .O(z05));
  nand2  g39(.a(new_n59_), .b(new_n43_), .O(z06));
  ...
  nand4  g46(.a(new_n46_), .b(new_n83_), .c(x22), .d(x14), .O(new_n88_));
