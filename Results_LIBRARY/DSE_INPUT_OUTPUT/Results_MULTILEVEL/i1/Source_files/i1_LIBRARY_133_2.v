...
module FAU ( 
  ...
  nand3  g23(.a(new_n64_), .b(new_n45_), .c(x00), .O(new_n65_));
  nor2   g24(.a(x02), .b(x01), .O(new_n66_));
  nor3   g25(.a(x05), .b(x04), .c(x03), .O(new_n67_));
  inv1   g26(.a(x09), .O(new_n68_));
  nand3  g27(.a(x21), .b(new_n68_), .c(x08), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n67_), .c(new_n66_), .d(new_n63_), .O(new_n71_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n73_), .c(new_n43_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(x19), .b(new_n43_), .c(new_n52_), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(x06), .c(x05), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n66_), .c(new_n61_), .d(new_n49_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n45_), .c(new_n77_), .O(z05));
  nand2  g40(.a(new_n45_), .b(new_n60_), .O(z06));
