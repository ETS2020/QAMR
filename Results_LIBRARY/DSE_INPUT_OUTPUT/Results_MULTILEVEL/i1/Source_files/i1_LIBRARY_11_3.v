...
module FAU ( 
  ...
  nand2  g00(.a(x19), .b(x11), .O(new_n42_));
  ...
  nand2  g31(.a(new_n42_), .b(new_n72_), .O(z03));
  or2    g32(.a(z03), .b(x21), .O(z04));
  nand2  g33(.a(new_n42_), .b(x10), .O(new_n75_));
  nand3  g34(.a(new_n63_), .b(new_n59_), .c(new_n47_), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  nand4  g36(.a(new_n60_), .b(x19), .c(new_n44_), .d(new_n77_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(z05));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n42_), .O(z07));
  inv1   g40(.a(x19), .O(new_n82_));
  nand3  g41(.a(x24), .b(new_n82_), .c(x11), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  inv1   g43(.a(x24), .O(new_n85_));
  nand4  g44(.a(new_n42_), .b(new_n85_), .c(x22), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand3  g46(.a(new_n85_), .b(x22), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n42_), .O(z11));
  nand3  g48(.a(new_n42_), .b(new_n85_), .c(x23), .O(new_n90_));
