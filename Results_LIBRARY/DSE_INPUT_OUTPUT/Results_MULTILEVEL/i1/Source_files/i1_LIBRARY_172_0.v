...
module FAU ( 
  ...
  nand4  g18(.a(new_n59_), .b(x08), .c(new_n50_), .d(new_n49_), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n58_), .c(x19), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n51_), .O(new_n62_));
  nor3   g21(.a(x03), .b(x02), .c(x01), .O(new_n63_));
  nor2   g22(.a(x05), .b(x04), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(new_n63_), .c(new_n51_), .d(new_n50_), .O(new_n65_));
  ...
  nor2   g30(.a(x08), .b(x06), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(new_n64_), .c(new_n63_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x19), .c(x07), .O(new_n74_));
  or2    g33(.a(new_n74_), .b(x10), .O(z05));
  inv1   g34(.a(x18), .O(new_n76_));
  nand2  g35(.a(new_n69_), .b(x24), .O(new_n77_));
