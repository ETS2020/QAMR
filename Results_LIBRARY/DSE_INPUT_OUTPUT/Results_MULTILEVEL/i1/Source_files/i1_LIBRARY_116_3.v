...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n78_, new_n81_, new_n83_, new_n84_, new_n86_,
  ...
  aoi21  g25(.a(new_n66_), .b(new_n63_), .c(x15), .O(new_n67_));
  ...
  nand3  g32(.a(new_n73_), .b(new_n50_), .c(new_n49_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n62_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(x15), .c(x19), .O(new_n76_));
  ...
  aoi21  g44(.a(x19), .b(x15), .c(x24), .O(new_n86_));
  ...
  nand2  g51(.a(new_n86_), .b(x16), .O(new_n93_));
