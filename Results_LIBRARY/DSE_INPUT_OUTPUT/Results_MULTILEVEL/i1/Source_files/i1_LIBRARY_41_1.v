...
module FAU ( 
  ...
  nor2   g39(.a(new_n43_), .b(new_n56_), .O(z06));
  ...
  nand2  g43(.a(new_n84_), .b(new_n76_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n76_), .b(new_n86_), .O(z08));
  inv1   g46(.a(x24), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n76_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n88_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n76_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n76_), .O(z11));
  ...
  nand4  g62(.a(new_n103_), .b(new_n43_), .c(new_n56_), .d(new_n90_), .O(z15));
endmodule
