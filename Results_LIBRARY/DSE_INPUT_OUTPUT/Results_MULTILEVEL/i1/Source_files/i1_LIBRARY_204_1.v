...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n52_), .O(z10));
  nand4  g23(.a(new_n52_), .b(new_n62_), .c(x22), .d(x17), .O(new_n65_));
  ...
  nand4  g36(.a(new_n77_), .b(new_n52_), .c(new_n76_), .d(new_n75_), .O(z15));
  buf    g37(.a(x19), .O(z06));
endmodule
