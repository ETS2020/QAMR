...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_, new_n95_,
  ...
  inv1   g35(.a(new_n62_), .O(new_n77_));
  inv1   g36(.a(x19), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(x08), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n63_), .c(new_n77_), .d(new_n51_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n73_), .c(new_n76_), .O(z05));
  nand2  g40(.a(new_n78_), .b(new_n43_), .O(z06));
  ...
  nand2  g52(.a(new_n93_), .b(new_n73_), .O(z11));
  nand3  g53(.a(new_n92_), .b(x23), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n73_), .O(z12));
  nand3  g55(.a(new_n89_), .b(x23), .c(x17), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z13));
  and2   g57(.a(new_n89_), .b(x16), .O(z14));
