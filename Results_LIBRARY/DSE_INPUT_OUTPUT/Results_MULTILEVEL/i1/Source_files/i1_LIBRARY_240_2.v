...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n76_, new_n79_, new_n81_, new_n83_, new_n85_,
  ...
  oai21  g32(.a(new_n73_), .b(x15), .c(new_n72_), .O(z04));
  nor4   g33(.a(new_n68_), .b(new_n60_), .c(x08), .d(x07), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n66_), .c(x10), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n44_), .O(z05));
  nor2   g36(.a(new_n44_), .b(new_n60_), .O(z06));
  ...
  nand4  g45(.a(new_n46_), .b(new_n83_), .c(x22), .d(x17), .O(new_n87_));
