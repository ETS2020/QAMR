...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n81_, new_n82_, new_n84_, new_n86_, new_n88_,
  ...
  nand2  g37(.a(new_n69_), .b(new_n78_), .O(z08));
  oai21  g38(.a(new_n76_), .b(new_n78_), .c(new_n69_), .O(z09));
  ...
  nand4  g44(.a(new_n69_), .b(new_n76_), .c(x23), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  nand3  g46(.a(new_n76_), .b(x23), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n69_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  nor3   g49(.a(new_n43_), .b(x24), .c(new_n90_), .O(z14));
  inv1   g50(.a(x12), .O(new_n92_));
  nor3   g51(.a(x15), .b(x14), .c(x13), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n45_), .c(new_n92_), .O(z15));
  buf    g53(.a(x19), .O(z06));
endmodule
