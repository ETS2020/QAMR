...
module FAU ( 
  ...
  oai21  g17(.a(new_n43_), .b(x00), .c(x06), .O(new_n59_));
  nor3   g18(.a(x03), .b(x02), .c(x01), .O(new_n60_));
  nor3   g19(.a(x07), .b(x05), .c(x04), .O(new_n61_));
  ...
  nand4  g37(.a(new_n78_), .b(new_n66_), .c(new_n77_), .d(new_n51_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n44_), .c(new_n76_), .O(z05));
  ...
  nor2   g43(.a(new_n72_), .b(new_n84_), .O(z08));
  ...
  nand3  g52(.a(new_n82_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(z12));
  nand4  g54(.a(new_n44_), .b(new_n82_), .c(x23), .d(x17), .O(new_n96_));
