...
module FAU ( 
  ...
  nand4  g39(.a(new_n63_), .b(new_n44_), .c(x19), .d(new_n80_), .O(new_n81_));
  ...
  aoi21  g45(.a(new_n43_), .b(new_n85_), .c(new_n44_), .O(z09));
  inv1   g46(.a(x14), .O(new_n88_));
  inv1   g47(.a(x22), .O(new_n89_));
  nor3   g48(.a(x24), .b(new_n89_), .c(new_n88_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  nor3   g50(.a(x24), .b(new_n89_), .c(new_n91_), .O(z11));
  inv1   g51(.a(x23), .O(new_n93_));
  nor3   g52(.a(x24), .b(new_n93_), .c(new_n88_), .O(z12));
