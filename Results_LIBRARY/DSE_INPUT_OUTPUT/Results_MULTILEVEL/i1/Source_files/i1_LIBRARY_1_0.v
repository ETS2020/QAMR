...
module FAU ( 
  ...
  nand2  g30(.a(new_n71_), .b(x19), .O(z03));
  nand2  g31(.a(x21), .b(x19), .O(new_n73_));
  ...
  nand2  g37(.a(x20), .b(new_n59_), .O(z06));
  ...
  nand4  g50(.a(new_n44_), .b(new_n84_), .c(x23), .d(x17), .O(new_n92_));
