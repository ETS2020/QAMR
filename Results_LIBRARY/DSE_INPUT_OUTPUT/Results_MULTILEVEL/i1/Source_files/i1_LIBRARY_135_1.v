...
module FAU ( 
  ...
  aoi21  g23(.a(new_n64_), .b(x09), .c(new_n46_), .O(z02));
  ...
  nand4  g31(.a(new_n72_), .b(new_n55_), .c(new_n54_), .d(new_n53_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n51_), .c(x09), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(z05));
  nor2   g35(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  nand4  g49(.a(new_n44_), .b(new_n82_), .c(x23), .d(x14), .O(new_n91_));
  ...
  nor3   g56(.a(new_n68_), .b(x13), .c(x12), .O(new_n98_));
