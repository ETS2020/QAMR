...
module FAU ( 
  ...
  nand4  g18(.a(new_n52_), .b(new_n51_), .c(new_n43_), .d(new_n59_), .O(new_n60_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n45_), .O(z09));
  ...
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z12));
  nand3  g48(.a(new_n85_), .b(x23), .c(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z13));
  and2   g50(.a(new_n85_), .b(x16), .O(z14));
