...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n88_, new_n90_, new_n92_, new_n94_, new_n95_;
  ...
  nand2  g34(.a(new_n75_), .b(new_n73_), .O(z07));
  ...
  nor3   g40(.a(new_n44_), .b(x24), .c(new_n81_), .O(new_n82_));
  ...
  nand2  g46(.a(new_n79_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n73_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n73_), .O(z13));
