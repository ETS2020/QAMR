...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n77_, new_n78_, new_n79_, new_n81_, new_n83_,
  ...
  aoi21  g30(.a(new_n71_), .b(new_n68_), .c(x15), .O(new_n72_));
  ...
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n43_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n43_), .O(z11));
  nand3  g50(.a(new_n43_), .b(new_n85_), .c(x23), .O(new_n92_));
  ...
  nor3   g58(.a(x14), .b(x13), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n59_), .b(x15), .O(new_n101_));
  oai21  g60(.a(new_n100_), .b(x15), .c(new_n101_), .O(z15));
  buf    g61(.a(x19), .O(z06));
endmodule
