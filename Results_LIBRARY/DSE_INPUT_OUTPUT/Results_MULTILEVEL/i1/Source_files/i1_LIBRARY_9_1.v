...
module FAU ( 
  ...
  nand3  g37(.a(new_n78_), .b(new_n45_), .c(new_n76_), .O(z05));
  nand2  g38(.a(new_n43_), .b(new_n60_), .O(z06));
  ...
  nand2  g45(.a(new_n85_), .b(x14), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(x19), .c(new_n43_), .O(z10));
  nand2  g47(.a(new_n85_), .b(x17), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(x19), .c(new_n43_), .O(z11));
  nand3  g49(.a(new_n85_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n45_), .O(z12));
  nand4  g51(.a(new_n45_), .b(new_n85_), .c(x23), .d(x17), .O(new_n93_));
