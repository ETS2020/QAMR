...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x10), .O(new_n71_));
  ...
  nand4  g38(.a(new_n61_), .b(x19), .c(new_n77_), .d(new_n79_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n78_), .c(x19), .d(new_n77_), .O(z05));
  ...
  nand3  g46(.a(new_n43_), .b(new_n87_), .c(x22), .O(new_n88_));
  ...
  nand3  g57(.a(new_n43_), .b(new_n87_), .c(x16), .O(new_n99_));
