...
module FAU ( 
  ...
  nand2  g32(.a(new_n44_), .b(x20), .O(new_n74_));
  oai21  g33(.a(new_n44_), .b(x19), .c(new_n74_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand3  g35(.a(new_n65_), .b(new_n66_), .c(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n64_), .c(new_n44_), .O(new_n78_));
  ...
  nand3  g56(.a(new_n97_), .b(x23), .c(x17), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n81_), .O(z13));
