...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n68_, new_n69_, new_n71_, new_n74_, new_n76_, new_n78_,
  ...
  nor2   g08(.a(x08), .b(x07), .O(new_n50_));
  nand4  g09(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n51_));
  and2   g10(.a(new_n51_), .b(new_n46_), .O(new_n52_));
  ...
  nand3  g22(.a(new_n63_), .b(x19), .c(new_n46_), .O(new_n64_));
  ...
  nor2   g28(.a(new_n69_), .b(new_n68_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  oai21  g30(.a(new_n52_), .b(new_n45_), .c(new_n71_), .O(z05));
  nor2   g31(.a(new_n45_), .b(x09), .O(z06));
  nand3  g32(.a(new_n43_), .b(x24), .c(x18), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nor2   g35(.a(new_n68_), .b(new_n76_), .O(z08));
  ...
  nand3  g43(.a(new_n43_), .b(new_n78_), .c(x23), .O(new_n85_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n68_), .O(z15));
endmodule
