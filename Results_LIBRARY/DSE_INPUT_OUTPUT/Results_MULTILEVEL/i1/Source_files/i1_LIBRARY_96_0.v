...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n77_, new_n80_, new_n81_, new_n83_, new_n86_,
  ...
  nand4  g21(.a(new_n62_), .b(new_n61_), .c(new_n49_), .d(new_n45_), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(x00), .O(new_n64_));
  nand4  g23(.a(new_n45_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n65_));
  ...
  nand4  g34(.a(new_n67_), .b(new_n61_), .c(new_n68_), .d(new_n51_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(x04), .O(new_n77_));
  or2    g36(.a(new_n77_), .b(x10), .O(z05));
  nand2  g37(.a(new_n60_), .b(x04), .O(z06));
  inv1   g38(.a(x18), .O(new_n80_));
  nand2  g39(.a(new_n73_), .b(x24), .O(new_n81_));
  ...
  nand4  g47(.a(new_n73_), .b(new_n86_), .c(x22), .d(x17), .O(new_n89_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n73_), .O(z14));
