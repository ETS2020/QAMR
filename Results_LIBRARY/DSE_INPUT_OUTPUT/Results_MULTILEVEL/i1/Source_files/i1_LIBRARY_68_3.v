...
module FAU ( 
  ...
  nor2   g15(.a(x20), .b(new_n42_), .O(new_n57_));
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x20), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n63_), .c(new_n46_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(x19), .O(z03));
  nand2  g33(.a(x21), .b(new_n73_), .O(new_n75_));
  oai21  g34(.a(new_n73_), .b(x19), .c(new_n75_), .O(z04));
  nand2  g35(.a(new_n43_), .b(x10), .O(new_n77_));
  nand3  g36(.a(new_n64_), .b(new_n60_), .c(new_n49_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  nand4  g38(.a(new_n61_), .b(new_n73_), .c(x19), .d(new_n79_), .O(new_n80_));
  ...
  nand4  g52(.a(new_n43_), .b(new_n86_), .c(x23), .d(x17), .O(new_n94_));
