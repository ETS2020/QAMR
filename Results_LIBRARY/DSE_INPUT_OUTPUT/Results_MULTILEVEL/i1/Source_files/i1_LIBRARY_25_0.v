...
module FAU ( 
  ...
  nand4  g33(.a(new_n61_), .b(x19), .c(new_n74_), .d(new_n52_), .O(new_n75_));
  ...
  nand4  g44(.a(new_n44_), .b(new_n79_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  inv1   g46(.a(x23), .O(new_n88_));
  nand2  g47(.a(new_n44_), .b(new_n79_), .O(new_n89_));
