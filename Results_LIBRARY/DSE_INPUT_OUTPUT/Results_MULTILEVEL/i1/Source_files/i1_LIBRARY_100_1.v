...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n72_, new_n74_, new_n75_, new_n78_, new_n79_,
  ...
  nor2   g27(.a(new_n44_), .b(new_n68_), .O(z05));
  and2   g28(.a(x19), .b(x08), .O(z06));
  inv1   g29(.a(x18), .O(new_n71_));
  inv1   g30(.a(x24), .O(new_n72_));
  nor3   g31(.a(new_n44_), .b(new_n72_), .c(new_n71_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  inv1   g33(.a(new_n44_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(z08));
  oai21  g35(.a(new_n72_), .b(new_n74_), .c(new_n75_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n72_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n75_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n75_), .O(z11));
  nand3  g41(.a(new_n72_), .b(x23), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n75_), .O(z12));
  nand4  g43(.a(new_n75_), .b(new_n72_), .c(x23), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  nand2  g45(.a(new_n72_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n75_), .O(z14));
  nor2   g47(.a(x15), .b(x14), .O(new_n89_));
  nor3   g48(.a(new_n44_), .b(x13), .c(x12), .O(new_n90_));
