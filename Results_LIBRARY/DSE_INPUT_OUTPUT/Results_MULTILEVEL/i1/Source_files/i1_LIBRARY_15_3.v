...
module FAU ( 
  ...
  nand3  g25(.a(new_n66_), .b(new_n64_), .c(new_n60_), .O(new_n67_));
  ...
  aoi21  g30(.a(x19), .b(x07), .c(new_n71_), .O(z03));
  inv1   g31(.a(x21), .O(new_n73_));
  nand3  g32(.a(new_n43_), .b(new_n73_), .c(new_n71_), .O(z04));
  nand3  g33(.a(new_n60_), .b(x19), .c(new_n65_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n64_), .c(x10), .O(new_n77_));
  nand2  g36(.a(new_n45_), .b(x10), .O(new_n78_));
  ...
  nand4  g51(.a(new_n43_), .b(new_n88_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n88_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n43_), .O(z13));
  nand3  g55(.a(new_n43_), .b(new_n88_), .c(x16), .O(new_n97_));
