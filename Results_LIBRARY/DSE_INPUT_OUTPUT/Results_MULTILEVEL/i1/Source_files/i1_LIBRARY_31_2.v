...
module FAU ( 
  ...
  oai21  g15(.a(new_n46_), .b(x00), .c(x05), .O(new_n57_));
  nor3   g16(.a(x03), .b(x02), .c(x01), .O(new_n58_));
  nor3   g17(.a(x07), .b(x06), .c(x04), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(new_n60_));
  inv1   g19(.a(x04), .O(new_n61_));
  nand4  g20(.a(new_n61_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n62_));
  inv1   g21(.a(x08), .O(new_n63_));
  nor2   g22(.a(x09), .b(new_n63_), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(new_n51_), .c(new_n50_), .d(new_n43_), .O(new_n65_));
  ...
  nand4  g32(.a(x19), .b(new_n63_), .c(new_n51_), .d(new_n50_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n62_), .c(new_n73_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  oai21  g35(.a(new_n46_), .b(new_n73_), .c(new_n76_), .O(z05));
  nand2  g36(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n70_), .O(z09));
  nand3  g43(.a(new_n80_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n70_), .O(z10));
  nand4  g45(.a(new_n70_), .b(new_n80_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n80_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n70_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n70_), .O(z13));
  nand2  g52(.a(new_n80_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n70_), .O(z14));
