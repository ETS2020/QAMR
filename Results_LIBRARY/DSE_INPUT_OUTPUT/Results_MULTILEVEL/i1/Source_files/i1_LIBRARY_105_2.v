...
module FAU ( 
  ...
  nand3  g27(.a(new_n68_), .b(new_n66_), .c(new_n52_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n65_), .c(new_n64_), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(x24), .c(x19), .O(new_n71_));
  ...
  nand3  g35(.a(new_n66_), .b(new_n67_), .c(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(x24), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nor2   g42(.a(new_n44_), .b(new_n83_), .O(z08));
  oai21  g43(.a(new_n57_), .b(new_n83_), .c(new_n45_), .O(z09));
  nand4  g44(.a(new_n57_), .b(x22), .c(new_n43_), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand4  g46(.a(new_n57_), .b(x22), .c(new_n43_), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand2  g48(.a(x23), .b(x14), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n43_), .c(x24), .O(z12));
  nand2  g50(.a(x23), .b(x17), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n43_), .c(x24), .O(z13));
  nand3  g52(.a(new_n57_), .b(new_n43_), .c(x16), .O(new_n94_));
