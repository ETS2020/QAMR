...
module FAU ( 
  ...
  nand2  g43(.a(new_n60_), .b(x17), .O(new_n85_));
  nand4  g44(.a(new_n85_), .b(new_n83_), .c(x22), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nor2   g46(.a(new_n60_), .b(new_n43_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n83_), .c(x22), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand3  g49(.a(new_n83_), .b(x23), .c(x14), .O(new_n91_));
