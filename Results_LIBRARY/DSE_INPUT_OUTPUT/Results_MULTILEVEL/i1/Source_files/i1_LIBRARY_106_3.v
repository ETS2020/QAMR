...
module FAU ( 
  ...
  and2   g28(.a(new_n43_), .b(x20), .O(z03));
  ...
  nand3  g33(.a(new_n74_), .b(new_n51_), .c(new_n50_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n63_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(x13), .c(x19), .O(new_n77_));
  ...
  nand4  g44(.a(new_n43_), .b(new_n85_), .c(x22), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand3  g46(.a(new_n85_), .b(x22), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n43_), .O(z11));
  nand3  g48(.a(new_n85_), .b(x23), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n43_), .O(z12));
  nand4  g50(.a(new_n43_), .b(new_n85_), .c(x23), .d(x17), .O(new_n92_));
  ...
  nand2  g55(.a(new_n46_), .b(x13), .O(new_n97_));
  oai21  g56(.a(new_n96_), .b(x13), .c(new_n97_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
