...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n78_, new_n80_, new_n83_, new_n85_, new_n87_,
  ...
  nand3  g34(.a(new_n75_), .b(new_n70_), .c(new_n73_), .O(z05));
  ...
  oai21  g40(.a(new_n78_), .b(new_n80_), .c(new_n70_), .O(z09));
  nand4  g41(.a(new_n70_), .b(new_n78_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand2  g43(.a(new_n78_), .b(x22), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x19), .c(new_n43_), .O(z11));
  nand2  g45(.a(new_n46_), .b(x17), .O(new_n87_));
  nand4  g46(.a(new_n87_), .b(new_n78_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand4  g48(.a(new_n78_), .b(x23), .c(x19), .d(x17), .O(new_n90_));
