...
module FAU ( 
  ...
  nand3  g53(.a(new_n89_), .b(x23), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n45_), .O(z12));
  nand2  g55(.a(x23), .b(x17), .O(new_n97_));
  nor2   g56(.a(new_n97_), .b(x24), .O(z13));
