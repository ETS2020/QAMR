...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n88_, new_n89_, new_n91_, new_n93_, new_n94_, new_n96_,
  ...
  nand2  g39(.a(new_n80_), .b(x07), .O(z06));
  inv1   g40(.a(x18), .O(new_n82_));
  nand2  g41(.a(new_n74_), .b(x24), .O(new_n83_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n74_), .O(z10));
  nand4  g49(.a(new_n74_), .b(new_n88_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  inv1   g51(.a(x14), .O(new_n93_));
  nand2  g52(.a(new_n88_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n74_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n74_), .O(z13));
