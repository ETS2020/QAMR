...
module FAU ( 
  ...
  nand3  g32(.a(new_n43_), .b(new_n71_), .c(new_n59_), .O(z04));
  ...
  nor2   g40(.a(new_n72_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n72_), .b(new_n83_), .c(new_n81_), .O(z09));
  ...
  nand3  g50(.a(new_n83_), .b(x23), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n44_), .O(z12));
  nand4  g52(.a(new_n44_), .b(new_n83_), .c(x23), .d(x17), .O(new_n94_));
