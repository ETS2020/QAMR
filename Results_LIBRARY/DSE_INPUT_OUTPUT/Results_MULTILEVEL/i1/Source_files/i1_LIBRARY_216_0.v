...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  ...
  nand4  g34(.a(new_n61_), .b(x19), .c(new_n75_), .d(new_n52_), .O(new_n76_));
  oai22  g35(.a(new_n76_), .b(new_n59_), .c(new_n43_), .d(new_n74_), .O(z05));
  ...
  nand4  g47(.a(new_n44_), .b(new_n82_), .c(x23), .d(x14), .O(new_n89_));
