...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n76_, new_n78_, new_n79_, new_n80_, new_n83_,
  ...
  nand3  g20(.a(new_n61_), .b(new_n48_), .c(new_n47_), .O(new_n62_));
  nand3  g21(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n62_), .c(new_n43_), .O(new_n64_));
  oai21  g23(.a(new_n60_), .b(new_n43_), .c(new_n64_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x00), .O(new_n66_));
  nand4  g25(.a(new_n61_), .b(new_n48_), .c(new_n43_), .d(new_n47_), .O(new_n67_));
  ...
  nand4  g30(.a(new_n71_), .b(new_n69_), .c(new_n68_), .d(new_n51_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n66_), .c(new_n59_), .O(z02));
  ...
  nor2   g37(.a(new_n59_), .b(x08), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n69_), .c(new_n68_), .d(new_n51_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n45_), .c(new_n78_), .O(z05));
  nand2  g40(.a(new_n45_), .b(new_n59_), .O(z06));
  ...
  nor2   g56(.a(x24), .b(new_n60_), .O(z14));
