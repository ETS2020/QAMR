...
module FAU ( 
  ...
  nand3  g34(.a(new_n60_), .b(x19), .c(new_n65_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n64_), .c(x10), .O(new_n78_));
  nand2  g37(.a(new_n45_), .b(x10), .O(new_n79_));
  oai21  g38(.a(new_n78_), .b(x07), .c(new_n79_), .O(z05));
  ...
  nand3  g56(.a(new_n43_), .b(new_n85_), .c(x16), .O(new_n98_));
