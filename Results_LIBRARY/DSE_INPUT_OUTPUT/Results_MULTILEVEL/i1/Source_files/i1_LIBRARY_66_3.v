...
module FAU ( 
  ...
  nor2   g39(.a(new_n44_), .b(x18), .O(z06));
  nand3  g40(.a(z06), .b(new_n63_), .c(new_n80_), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n79_), .c(new_n45_), .d(new_n78_), .O(z05));
  inv1   g42(.a(x24), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n44_), .c(new_n43_), .O(z07));
  ...
  nand2  g49(.a(new_n84_), .b(x22), .O(new_n91_));
