...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n81_, new_n84_, new_n86_, new_n88_,
  ...
  and2   g41(.a(x24), .b(x11), .O(z09));
  nand2  g42(.a(x22), .b(x14), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(x19), .c(x24), .O(z10));
  nand2  g44(.a(x22), .b(x17), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(x19), .c(x24), .O(z11));
  nand3  g46(.a(x23), .b(x19), .c(x14), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(x24), .O(z12));
  nand2  g48(.a(x23), .b(x17), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(x19), .c(x24), .O(z13));
  nand2  g50(.a(x19), .b(x16), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(x24), .O(z14));
