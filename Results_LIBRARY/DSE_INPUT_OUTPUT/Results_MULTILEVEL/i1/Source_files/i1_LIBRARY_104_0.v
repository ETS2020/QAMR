...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n68_, new_n70_, new_n72_, new_n73_, new_n77_,
    new_n79_, new_n81_, new_n82_, new_n83_, new_n85_, new_n87_, new_n89_,
  ...
  nand2  g33(.a(new_n45_), .b(x18), .O(z06));
  ...
  nand2  g41(.a(new_n79_), .b(x22), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n82_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n82_), .O(z11));
  nand3  g45(.a(new_n79_), .b(x23), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n82_), .O(z12));
  nand4  g47(.a(new_n82_), .b(new_n79_), .c(x23), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z13));
  nand2  g49(.a(new_n79_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n82_), .O(z14));
