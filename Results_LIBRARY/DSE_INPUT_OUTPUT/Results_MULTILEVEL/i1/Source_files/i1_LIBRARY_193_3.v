...
module FAU ( 
  ...
  nand3  g30(.a(new_n43_), .b(new_n71_), .c(new_n69_), .O(z04));
  inv1   g31(.a(x08), .O(new_n73_));
  nand3  g32(.a(new_n60_), .b(x19), .c(new_n73_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n63_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(x10), .O(new_n76_));
  nand2  g35(.a(new_n46_), .b(x10), .O(new_n77_));
  ...
  nand4  g48(.a(new_n43_), .b(new_n83_), .c(x23), .d(x14), .O(new_n90_));
