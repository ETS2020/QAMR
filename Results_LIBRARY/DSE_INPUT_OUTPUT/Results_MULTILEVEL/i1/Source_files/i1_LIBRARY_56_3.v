...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n77_, new_n79_, new_n81_, new_n83_, new_n85_,
  ...
  nor2   g16(.a(x10), .b(new_n42_), .O(new_n58_));
  ...
  nand4  g35(.a(new_n66_), .b(x19), .c(new_n67_), .d(new_n53_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n43_), .O(z05));
  nand3  g37(.a(new_n46_), .b(x24), .c(x18), .O(new_n79_));
  ...
  nand2  g48(.a(new_n87_), .b(x23), .O(new_n90_));
