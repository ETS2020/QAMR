...
module FAU ( 
  ...
  nand4  g44(.a(new_n81_), .b(x22), .c(x19), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand2  g46(.a(new_n46_), .b(x14), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n81_), .c(x22), .d(x17), .O(new_n89_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n58_), .O(z13));
