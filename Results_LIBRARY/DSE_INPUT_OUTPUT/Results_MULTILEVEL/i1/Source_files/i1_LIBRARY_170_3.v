...
module FAU ( 
  ...
  nand4  g48(.a(new_n43_), .b(new_n87_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n87_), .b(x23), .O(new_n93_));
  ...
  nand3  g55(.a(new_n43_), .b(new_n87_), .c(x16), .O(new_n97_));
