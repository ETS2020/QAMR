...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n78_, new_n80_, new_n81_, new_n83_, new_n85_, new_n86_,
    new_n88_, new_n90_, new_n91_, new_n92_, new_n94_, new_n96_, new_n98_,
    new_n99_;
  nand2  g00(.a(x19), .b(x01), .O(new_n42_));
  ...
  nor2   g24(.a(new_n65_), .b(x01), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n61_), .c(new_n58_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nand2  g27(.a(new_n42_), .b(new_n68_), .O(z03));
  or2    g28(.a(z03), .b(x21), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  inv1   g30(.a(x08), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n59_), .c(new_n44_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(z05));
  nor2   g35(.a(new_n58_), .b(x01), .O(z06));
  nand2  g36(.a(x24), .b(x18), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n42_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  inv1   g39(.a(new_n42_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n80_), .c(new_n42_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  nand2  g44(.a(new_n83_), .b(x22), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n42_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n42_), .O(z11));
  nand3  g48(.a(new_n42_), .b(new_n83_), .c(x23), .O(new_n90_));
  ...
  nand3  g54(.a(new_n42_), .b(new_n83_), .c(x16), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z14));
  nor2   g56(.a(x13), .b(x12), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n81_), .O(z15));
endmodule
