...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n87_, new_n88_, new_n90_, new_n92_, new_n94_,
  ...
  nor2   g15(.a(x11), .b(new_n42_), .O(new_n57_));
  ...
  nand3  g29(.a(new_n70_), .b(x19), .c(new_n59_), .O(new_n71_));
  ...
  nand3  g36(.a(new_n66_), .b(new_n67_), .c(new_n52_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n65_), .c(new_n59_), .O(new_n79_));
  ...
  nand3  g54(.a(new_n43_), .b(new_n87_), .c(x16), .O(new_n96_));
