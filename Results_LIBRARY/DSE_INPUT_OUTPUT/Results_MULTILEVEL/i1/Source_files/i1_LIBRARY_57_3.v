...
module FAU ( 
  ...
  nor2   g14(.a(x17), .b(new_n42_), .O(new_n56_));
  ...
  nand4  g51(.a(new_n92_), .b(new_n91_), .c(x22), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z10));
  nor2   g53(.a(x19), .b(new_n58_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n91_), .c(x22), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z11));
  nand3  g56(.a(new_n91_), .b(x23), .c(x14), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n43_), .O(z12));
  nand3  g58(.a(new_n95_), .b(new_n91_), .c(x23), .O(new_n100_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n75_), .O(z15));
endmodule
