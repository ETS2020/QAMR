...
module FAU ( 
  ...
  nand4  g15(.a(x09), .b(new_n56_), .c(new_n55_), .d(new_n54_), .O(new_n57_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n56_), .c(new_n55_), .d(new_n54_), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n53_), .c(new_n47_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n65_), .c(new_n43_), .O(z02));
  ...
  nor2   g34(.a(new_n44_), .b(new_n75_), .O(z05));
  nor2   g35(.a(new_n43_), .b(new_n47_), .O(z06));
  ...
  nand3  g45(.a(new_n82_), .b(x22), .c(x17), .O(new_n87_));
  ...
  and2   g51(.a(new_n84_), .b(x16), .O(z14));
