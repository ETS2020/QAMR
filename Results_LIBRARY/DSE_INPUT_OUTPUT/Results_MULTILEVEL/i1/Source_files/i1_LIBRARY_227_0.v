...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n80_, new_n82_, new_n85_, new_n87_,
  ...
  nand2  g37(.a(x24), .b(new_n59_), .O(z06));
  oai21  g38(.a(x24), .b(new_n59_), .c(x18), .O(new_n80_));
  ...
  nand3  g47(.a(x23), .b(x19), .c(x14), .O(new_n89_));
  ...
  aoi21  g52(.a(x19), .b(new_n93_), .c(x24), .O(z14));
