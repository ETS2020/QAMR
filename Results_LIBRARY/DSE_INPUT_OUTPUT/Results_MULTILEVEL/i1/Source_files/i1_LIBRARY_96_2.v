...
module FAU ( 
  ...
  nand4  g20(.a(new_n52_), .b(new_n51_), .c(new_n50_), .d(new_n43_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nand4  g22(.a(new_n43_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n64_));
  ...
  nand4  g34(.a(new_n75_), .b(new_n66_), .c(new_n65_), .d(new_n52_), .O(new_n76_));
  ...
  nand4  g46(.a(new_n46_), .b(new_n85_), .c(x22), .d(x17), .O(new_n88_));
