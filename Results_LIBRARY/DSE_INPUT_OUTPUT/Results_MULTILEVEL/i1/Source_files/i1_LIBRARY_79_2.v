...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n87_, new_n89_, new_n91_, new_n92_, new_n93_, new_n94_,
  ...
  nand2  g17(.a(new_n58_), .b(new_n44_), .O(z01));
  oai21  g18(.a(new_n43_), .b(x00), .c(x04), .O(new_n60_));
  ...
  nor4   g26(.a(new_n67_), .b(new_n65_), .c(x06), .d(x05), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n63_), .c(x19), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n60_), .O(z02));
  ...
  nand4  g33(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n75_));
  inv1   g34(.a(x08), .O(new_n76_));
  nand4  g35(.a(x19), .b(new_n76_), .c(new_n52_), .d(new_n51_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n64_), .O(new_n79_));
  oai21  g38(.a(new_n43_), .b(new_n74_), .c(new_n79_), .O(z05));
  inv1   g39(.a(x18), .O(new_n81_));
  inv1   g40(.a(x24), .O(new_n82_));
  nor3   g41(.a(new_n45_), .b(new_n82_), .c(new_n81_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nand2  g43(.a(new_n44_), .b(new_n84_), .O(z08));
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n44_), .O(z09));
  nand4  g45(.a(new_n44_), .b(new_n82_), .c(x22), .d(x14), .O(new_n87_));
  ...
  nand2  g50(.a(new_n44_), .b(new_n82_), .O(new_n92_));
  ...
  nor3   g59(.a(new_n45_), .b(x13), .c(x12), .O(new_n101_));
