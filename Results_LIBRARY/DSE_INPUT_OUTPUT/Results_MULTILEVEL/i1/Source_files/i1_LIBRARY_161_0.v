...
module FAU ( 
  ...
  nand2  g37(.a(x22), .b(new_n45_), .O(z06));
  ...
  oai21  g43(.a(new_n81_), .b(new_n83_), .c(new_n57_), .O(z09));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n81_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n57_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n57_), .O(z11));
  nand4  g49(.a(new_n57_), .b(new_n81_), .c(x23), .d(x14), .O(new_n91_));
