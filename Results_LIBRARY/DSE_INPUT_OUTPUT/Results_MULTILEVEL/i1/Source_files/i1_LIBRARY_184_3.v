// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:55 2020
...
module FAU ( 
  ...
  nand2  g32(.a(x19), .b(x15), .O(new_n74_));
  ...
  nor2   g38(.a(new_n44_), .b(x15), .O(z06));
  ...
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n74_), .O(z09));
  nand3  g47(.a(new_n74_), .b(new_n87_), .c(x22), .O(new_n89_));
  ...
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(new_n74_), .O(z12));
  inv1   g56(.a(x17), .O(new_n98_));
  oai21  g57(.a(new_n96_), .b(new_n98_), .c(new_n74_), .O(z13));
  nand3  g58(.a(new_n74_), .b(new_n87_), .c(x16), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z14));
  nor2   g60(.a(x13), .b(x12), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n57_), .c(new_n95_), .O(z15));
endmodule
