...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x04), .c(new_n42_), .O(z00));
  ...
  nor2   g21(.a(x05), .b(x03), .O(new_n63_));
  ...
  nand2  g29(.a(x19), .b(x04), .O(new_n71_));
  ...
  nand3  g37(.a(new_n71_), .b(x24), .c(x18), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  and2   g39(.a(new_n71_), .b(x11), .O(z08));
  nand3  g40(.a(new_n71_), .b(x24), .c(x11), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z09));
  inv1   g42(.a(x24), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n71_), .O(z10));
  nand4  g45(.a(new_n71_), .b(new_n84_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand3  g47(.a(new_n71_), .b(new_n84_), .c(x23), .O(new_n89_));
  ...
  oai21  g54(.a(x24), .b(new_n95_), .c(new_n71_), .O(z14));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x13), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nand4  g58(.a(new_n99_), .b(new_n71_), .c(new_n98_), .d(new_n97_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
