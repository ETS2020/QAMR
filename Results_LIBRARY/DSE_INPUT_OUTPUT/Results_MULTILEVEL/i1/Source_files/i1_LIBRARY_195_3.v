...
module FAU ( 
  ...
  nand3  g22(.a(new_n43_), .b(new_n63_), .c(new_n61_), .O(z04));
  ...
  nand3  g42(.a(new_n43_), .b(new_n73_), .c(x16), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z14));
  inv1   g44(.a(x12), .O(new_n86_));
  inv1   g45(.a(x13), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n43_), .c(new_n87_), .d(new_n86_), .O(z15));
  buf    g48(.a(x19), .O(z06));
endmodule
