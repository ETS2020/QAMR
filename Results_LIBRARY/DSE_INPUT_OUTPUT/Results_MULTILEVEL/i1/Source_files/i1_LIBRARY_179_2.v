...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n90_, new_n91_, new_n93_, new_n95_, new_n97_, new_n98_;
  ...
  aoi21  g47(.a(new_n87_), .b(x19), .c(new_n43_), .O(z11));
  nand2  g48(.a(new_n60_), .b(x17), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(new_n84_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand4  g51(.a(new_n84_), .b(x23), .c(x19), .d(x17), .O(new_n93_));
