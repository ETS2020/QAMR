...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n68_, new_n71_, new_n72_, new_n74_, new_n75_,
  ...
  oai21  g31(.a(new_n72_), .b(new_n61_), .c(new_n71_), .O(z05));
  inv1   g32(.a(x18), .O(new_n74_));
  nand2  g33(.a(new_n44_), .b(x24), .O(new_n75_));
  ...
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z10));
  nand4  g41(.a(new_n44_), .b(new_n79_), .c(x22), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand4  g43(.a(new_n44_), .b(new_n79_), .c(x23), .d(x14), .O(new_n85_));
  ...
  oai21  g51(.a(new_n91_), .b(x15), .c(new_n92_), .O(z15));
  buf    g52(.a(x19), .O(z06));
endmodule
