...
module FAU ( 
  ...
  nor2   g27(.a(new_n43_), .b(new_n46_), .O(z03));
  nand2  g28(.a(x21), .b(new_n43_), .O(new_n70_));
  oai21  g29(.a(new_n43_), .b(new_n46_), .c(new_n70_), .O(z04));
