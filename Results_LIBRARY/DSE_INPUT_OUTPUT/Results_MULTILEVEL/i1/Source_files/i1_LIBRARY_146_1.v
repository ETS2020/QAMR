...
module FAU ( 
  ...
  nand3  g10(.a(new_n51_), .b(x08), .c(new_n50_), .O(new_n52_));
  ...
  aoi21  g19(.a(new_n60_), .b(x09), .c(new_n43_), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  nor2   g21(.a(new_n44_), .b(new_n62_), .O(z03));
  inv1   g22(.a(x21), .O(new_n64_));
  nand3  g23(.a(new_n45_), .b(new_n64_), .c(new_n62_), .O(z04));
  inv1   g24(.a(x10), .O(new_n66_));
  inv1   g25(.a(x08), .O(new_n67_));
  nand4  g26(.a(new_n51_), .b(x19), .c(new_n67_), .d(new_n50_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n49_), .c(new_n66_), .O(new_n69_));
