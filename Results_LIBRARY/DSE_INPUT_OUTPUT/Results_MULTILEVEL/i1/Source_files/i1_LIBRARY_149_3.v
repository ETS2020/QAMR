...
module FAU ( 
  ...
  nand3  g33(.a(new_n59_), .b(x19), .c(new_n74_), .O(new_n75_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n42_), .O(z10));
  nor2   g46(.a(new_n69_), .b(x24), .O(new_n88_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n42_), .O(z13));
