...
module FAU ( 
  ...
  nand4  g19(.a(new_n60_), .b(x08), .c(new_n51_), .d(new_n50_), .O(new_n61_));
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(new_n52_), .d(new_n51_), .O(new_n66_));
  ...
  nand3  g32(.a(new_n73_), .b(new_n65_), .c(new_n64_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(x07), .O(new_n75_));
  or2    g34(.a(new_n75_), .b(x10), .O(z05));
  nand2  g35(.a(new_n46_), .b(x07), .O(z06));
  ...
  oai21  g48(.a(new_n89_), .b(new_n84_), .c(new_n44_), .O(z12));
  oai21  g49(.a(new_n89_), .b(new_n87_), .c(new_n44_), .O(z13));
