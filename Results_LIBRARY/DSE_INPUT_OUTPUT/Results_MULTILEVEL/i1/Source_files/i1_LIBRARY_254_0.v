...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n78_, new_n83_, new_n85_, new_n87_,
    new_n89_, new_n91_, new_n93_, new_n94_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x24), .b(x11), .O(new_n43_));
  ...
  nand3  g41(.a(x22), .b(x14), .c(x11), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x24), .O(z10));
  nand2  g43(.a(x22), .b(x17), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x11), .c(x24), .O(z11));
  nand3  g45(.a(x23), .b(x14), .c(x11), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(x24), .O(z12));
  nand2  g47(.a(x23), .b(x17), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(x11), .c(x24), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(x11), .c(x24), .O(z14));
