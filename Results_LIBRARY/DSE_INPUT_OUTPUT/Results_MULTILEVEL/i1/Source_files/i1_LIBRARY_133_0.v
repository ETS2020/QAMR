...
module FAU ( 
  ...
  nand3  g22(.a(new_n63_), .b(new_n44_), .c(x00), .O(new_n64_));
  ...
  nand3  g33(.a(new_n74_), .b(new_n72_), .c(x08), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand3  g35(.a(new_n67_), .b(x19), .c(new_n51_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(x21), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n68_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  nand2  g39(.a(new_n44_), .b(new_n59_), .O(z06));
