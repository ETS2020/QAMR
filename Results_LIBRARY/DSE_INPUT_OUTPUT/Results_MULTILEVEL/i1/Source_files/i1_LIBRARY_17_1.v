...
module FAU ( 
  ...
  inv1   g34(.a(new_n68_), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(x19), .c(new_n67_), .d(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n75_), .O(z05));
  ...
  nand2  g45(.a(new_n80_), .b(x17), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(x19), .c(new_n43_), .O(z11));
  nand4  g47(.a(new_n45_), .b(new_n80_), .c(x23), .d(x14), .O(new_n89_));
