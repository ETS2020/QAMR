...
module FAU ( 
  ...
  nand2  g43(.a(new_n84_), .b(new_n43_), .O(z12));
  nand4  g44(.a(new_n43_), .b(new_n77_), .c(x23), .d(x17), .O(new_n86_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n65_), .O(z15));
endmodule
