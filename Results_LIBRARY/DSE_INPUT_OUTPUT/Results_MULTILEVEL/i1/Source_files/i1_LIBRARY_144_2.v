...
module FAU ( 
  ...
  nand4  g40(.a(new_n61_), .b(x23), .c(x19), .d(new_n81_), .O(new_n82_));
  ...
  oai21  g47(.a(new_n85_), .b(new_n87_), .c(new_n77_), .O(z09));
  ...
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n77_), .O(z11));
  nor3   g53(.a(x24), .b(new_n56_), .c(new_n90_), .O(z12));
  nand3  g54(.a(new_n85_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n77_), .O(z13));
