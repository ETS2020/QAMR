...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n88_, new_n89_, new_n92_, new_n94_, new_n95_;
  inv1   g00(.a(x19), .O(new_n42_));
  nand2  g01(.a(new_n42_), .b(x17), .O(new_n43_));
  ...
  inv1   g31(.a(new_n62_), .O(new_n73_));
  nor2   g32(.a(new_n42_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n73_), .c(new_n61_), .d(new_n50_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n43_), .c(new_n72_), .O(z05));
  ...
  nand4  g41(.a(new_n43_), .b(new_n81_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  nand2  g44(.a(new_n81_), .b(x22), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(x19), .c(new_n85_), .O(z11));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n81_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n43_), .O(z12));
  aoi21  g49(.a(new_n89_), .b(x19), .c(new_n85_), .O(z13));
