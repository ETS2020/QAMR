...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n88_, new_n90_, new_n91_, new_n92_, new_n93_, new_n95_, new_n97_,
    new_n99_, new_n100_;
  ...
  nand3  g33(.a(new_n65_), .b(x19), .c(new_n74_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n63_), .c(new_n73_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  oai21  g36(.a(new_n47_), .b(new_n73_), .c(new_n77_), .O(z05));
  ...
  nand2  g49(.a(new_n45_), .b(new_n81_), .O(new_n91_));
