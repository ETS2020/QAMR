...
module FAU ( 
  ...
  nand4  g34(.a(x19), .b(new_n66_), .c(new_n52_), .d(new_n51_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n65_), .c(new_n75_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  oai21  g37(.a(x14), .b(new_n75_), .c(new_n78_), .O(z05));
  inv1   g38(.a(x19), .O(new_n80_));
  nand2  g39(.a(new_n46_), .b(new_n80_), .O(z06));
  ...
  nand4  g46(.a(new_n86_), .b(x22), .c(x14), .d(new_n43_), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand3  g48(.a(new_n86_), .b(x22), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n46_), .O(z11));
  nand2  g50(.a(new_n86_), .b(x23), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n43_), .c(new_n44_), .O(z12));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n46_), .O(z13));
  nand2  g54(.a(new_n86_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n46_), .O(z14));
  nand2  g56(.a(x14), .b(new_n43_), .O(new_n98_));
  nor3   g57(.a(x15), .b(x13), .c(x12), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(x14), .c(new_n98_), .O(z15));
endmodule
