...
module FAU ( 
  ...
  nand3  g28(.a(new_n62_), .b(x19), .c(new_n50_), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n61_), .c(x10), .O(new_n72_));
  nand2  g31(.a(x19), .b(x10), .O(new_n73_));
  oai21  g32(.a(new_n72_), .b(x08), .c(new_n73_), .O(z05));
  ...
  nand2  g46(.a(new_n43_), .b(new_n80_), .O(new_n88_));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n78_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
