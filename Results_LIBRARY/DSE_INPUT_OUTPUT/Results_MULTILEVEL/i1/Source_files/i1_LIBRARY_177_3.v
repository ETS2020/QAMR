...
module FAU ( 
  ...
  nand4  g49(.a(new_n43_), .b(new_n86_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n86_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n43_), .O(z13));
  inv1   g53(.a(x16), .O(new_n95_));
  oai21  g54(.a(x24), .b(new_n95_), .c(new_n43_), .O(z14));
  nor3   g55(.a(x15), .b(x14), .c(x13), .O(new_n97_));
  nand2  g56(.a(new_n45_), .b(x12), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(x12), .c(new_n98_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
