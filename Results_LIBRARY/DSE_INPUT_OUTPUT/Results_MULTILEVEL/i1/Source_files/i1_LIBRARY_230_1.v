...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(x19), .c(x17), .O(new_n70_));
  ...
  nand3  g36(.a(new_n65_), .b(new_n66_), .c(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n64_), .c(x17), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n77_), .O(z05));
  nor2   g40(.a(new_n43_), .b(new_n56_), .O(z06));
  ...
  nand4  g47(.a(new_n73_), .b(new_n87_), .c(x22), .d(x14), .O(new_n89_));
