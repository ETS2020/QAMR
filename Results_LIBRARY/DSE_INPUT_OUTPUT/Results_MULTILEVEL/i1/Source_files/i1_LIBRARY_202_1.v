...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n88_, new_n89_, new_n90_, new_n92_, new_n94_, new_n97_,
    new_n99_;
  ...
  nand3  g27(.a(new_n68_), .b(x19), .c(x13), .O(new_n69_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x13), .O(new_n77_));
  ...
  nand2  g41(.a(new_n72_), .b(x24), .O(new_n83_));
  ...
  oai21  g49(.a(new_n90_), .b(new_n88_), .c(new_n72_), .O(z10));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n72_), .O(z11));
  nand2  g52(.a(new_n89_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n88_), .c(new_n72_), .O(z12));
  oai21  g54(.a(new_n94_), .b(new_n92_), .c(new_n72_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  nor3   g56(.a(new_n44_), .b(x24), .c(new_n97_), .O(z14));
  nor3   g57(.a(x15), .b(x14), .c(x12), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(x19), .c(new_n80_), .O(z15));
endmodule
