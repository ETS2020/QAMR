...
module FAU ( 
  ...
  nor2   g40(.a(new_n46_), .b(x17), .O(z06));
  ...
  aoi21  g51(.a(new_n92_), .b(new_n46_), .c(new_n59_), .O(z11));
  nand3  g52(.a(new_n89_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n43_), .O(z12));
  nand4  g54(.a(new_n89_), .b(x23), .c(new_n46_), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  nand3  g56(.a(new_n43_), .b(new_n89_), .c(x16), .O(new_n98_));
