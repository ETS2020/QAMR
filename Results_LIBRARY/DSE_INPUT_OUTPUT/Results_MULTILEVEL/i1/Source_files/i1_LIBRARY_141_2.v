...
module FAU ( 
  ...
  nand2  g37(.a(new_n60_), .b(new_n43_), .O(z06));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n45_), .O(z07));
  nor2   g40(.a(new_n60_), .b(new_n43_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x19), .c(new_n43_), .O(z09));
  ...
  nor3   g55(.a(new_n44_), .b(x24), .c(new_n96_), .O(z14));
