...
module FAU ( 
  ...
  nand3  g39(.a(x22), .b(x19), .c(x14), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(x24), .O(z10));
  nand2  g41(.a(x22), .b(x17), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x19), .c(x24), .O(z11));
  nand3  g43(.a(x23), .b(x19), .c(x14), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(x24), .O(z12));
  nand2  g45(.a(x23), .b(x17), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(x19), .c(x24), .O(z13));
