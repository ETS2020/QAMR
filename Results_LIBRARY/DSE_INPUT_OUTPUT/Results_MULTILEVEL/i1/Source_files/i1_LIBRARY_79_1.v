...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n48_, new_n50_, new_n52_, new_n54_,
    new_n56_, new_n57_, new_n59_, new_n60_, new_n62_, new_n64_, new_n66_,
  ...
  aoi21  g05(.a(x04), .b(new_n42_), .c(new_n43_), .O(z02));
  ...
  nor2   g13(.a(new_n43_), .b(new_n54_), .O(z06));
  inv1   g14(.a(x18), .O(new_n56_));
  oai21  g15(.a(new_n43_), .b(x04), .c(x24), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n56_), .O(z07));
  inv1   g17(.a(x11), .O(new_n59_));
  nand2  g18(.a(x19), .b(new_n54_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(new_n59_), .O(z08));
  inv1   g20(.a(x24), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n59_), .c(new_n60_), .O(z09));
  nand4  g22(.a(new_n60_), .b(new_n62_), .c(x22), .d(x14), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(z10));
  nand3  g24(.a(new_n62_), .b(x22), .c(x17), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n60_), .O(z11));
  nand4  g26(.a(new_n60_), .b(new_n62_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  nand4  g28(.a(new_n60_), .b(new_n62_), .c(x23), .d(x17), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(z13));
  inv1   g30(.a(x16), .O(new_n72_));
  oai21  g31(.a(new_n43_), .b(x04), .c(new_n62_), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z14));
  inv1   g33(.a(x12), .O(new_n75_));
  inv1   g34(.a(x13), .O(new_n76_));
  nor2   g35(.a(x15), .b(x14), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n60_), .c(new_n76_), .d(new_n75_), .O(z15));
endmodule
