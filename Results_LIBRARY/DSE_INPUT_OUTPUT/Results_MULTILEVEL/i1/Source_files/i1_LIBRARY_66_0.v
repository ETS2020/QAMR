...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n73_, new_n75_,
    new_n77_, new_n79_, new_n81_, new_n82_, new_n84_, new_n86_, new_n89_,
    new_n91_, new_n92_;
  ...
  nand4  g31(.a(new_n64_), .b(x19), .c(new_n65_), .d(new_n52_), .O(new_n73_));
  oai22  g32(.a(new_n73_), .b(new_n62_), .c(new_n43_), .d(new_n72_), .O(z05));
  nand2  g33(.a(x24), .b(x18), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n44_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nor2   g36(.a(new_n43_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  nor3   g38(.a(new_n43_), .b(new_n79_), .c(new_n77_), .O(z09));
  inv1   g39(.a(x14), .O(new_n81_));
  nand2  g40(.a(new_n79_), .b(x22), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n44_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n44_), .O(z11));
  nand2  g44(.a(new_n79_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n81_), .c(new_n44_), .O(z12));
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n44_), .O(z13));
  inv1   g47(.a(x16), .O(new_n89_));
  nor3   g48(.a(new_n43_), .b(x24), .c(new_n89_), .O(z14));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nor3   g50(.a(new_n43_), .b(x13), .c(x12), .O(new_n92_));
