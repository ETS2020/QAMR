...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n85_, new_n87_, new_n90_, new_n91_, new_n92_, new_n94_,
  ...
  nand2  g43(.a(new_n45_), .b(x24), .O(new_n85_));
  ...
  nand2  g50(.a(new_n91_), .b(x22), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n90_), .c(new_n45_), .O(z10));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n45_), .O(z11));
  nand4  g54(.a(new_n45_), .b(new_n91_), .c(x23), .d(x14), .O(new_n96_));
  ...
  nor2   g60(.a(x19), .b(x15), .O(new_n102_));
  nor2   g61(.a(x13), .b(x12), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n90_), .O(z15));
endmodule
