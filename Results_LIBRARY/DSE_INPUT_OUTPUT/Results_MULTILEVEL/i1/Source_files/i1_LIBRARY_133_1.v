...
module FAU ( 
  ...
  nand3  g35(.a(new_n68_), .b(x19), .c(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n66_), .c(new_n43_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  nand2  g39(.a(new_n45_), .b(new_n60_), .O(z06));
