...
module FAU ( 
  ...
  nor2   g10(.a(new_n51_), .b(x05), .O(new_n52_));
  ...
  nand4  g25(.a(new_n44_), .b(new_n63_), .c(x22), .d(x17), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z11));
  nand3  g27(.a(new_n63_), .b(x23), .c(x14), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n44_), .O(z12));
  nand4  g29(.a(new_n44_), .b(new_n63_), .c(x23), .d(x17), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z13));
  inv1   g31(.a(x16), .O(new_n73_));
  oai21  g32(.a(new_n51_), .b(x05), .c(new_n63_), .O(new_n74_));
