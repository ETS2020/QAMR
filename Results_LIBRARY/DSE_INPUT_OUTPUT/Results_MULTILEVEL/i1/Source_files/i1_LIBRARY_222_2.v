...
module FAU ( 
  ...
  oai21  g32(.a(new_n72_), .b(x19), .c(new_n56_), .O(z04));
  ...
  nand2  g40(.a(new_n81_), .b(x24), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n80_), .O(z07));
  ...
  nand2  g47(.a(new_n81_), .b(new_n88_), .O(new_n89_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n88_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n88_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n81_), .O(z13));
