// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:41 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n78_, new_n80_, new_n83_, new_n84_, new_n85_, new_n86_,
  ...
  nand2  g30(.a(new_n43_), .b(new_n69_), .O(z04));
  ...
  nand2  g34(.a(new_n43_), .b(new_n46_), .O(z06));
  inv1   g35(.a(x18), .O(new_n77_));
  nand2  g36(.a(new_n70_), .b(x24), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n77_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nand2  g39(.a(new_n70_), .b(new_n80_), .O(z08));
  nor2   g40(.a(new_n78_), .b(new_n80_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  inv1   g42(.a(x24), .O(new_n84_));
  nand2  g43(.a(new_n70_), .b(new_n84_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n70_), .O(z12));
  nand4  g51(.a(new_n70_), .b(new_n84_), .c(x23), .d(x17), .O(new_n93_));
