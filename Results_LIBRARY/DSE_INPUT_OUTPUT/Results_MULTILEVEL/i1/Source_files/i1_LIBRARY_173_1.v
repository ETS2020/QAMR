...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    new_n54_, new_n55_, new_n56_, new_n59_, new_n61_, new_n63_, new_n65_,
  ...
  nor2   g16(.a(new_n43_), .b(new_n55_), .O(z06));
  nand2  g17(.a(x24), .b(x18), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n56_), .O(z07));
  ...
  nand4  g23(.a(new_n56_), .b(new_n63_), .c(x22), .d(x14), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z10));
  nand3  g25(.a(new_n63_), .b(x22), .c(x17), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n56_), .O(z11));
  ...
  nand4  g36(.a(new_n77_), .b(new_n56_), .c(new_n76_), .d(new_n75_), .O(z15));
endmodule
