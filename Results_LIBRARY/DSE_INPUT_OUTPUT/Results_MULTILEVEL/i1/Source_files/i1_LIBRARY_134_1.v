...
module FAU ( 
  ...
  oai21  g18(.a(new_n43_), .b(x07), .c(x24), .O(new_n60_));
  ...
  nand2  g25(.a(new_n66_), .b(new_n54_), .O(z10));
  nand4  g26(.a(new_n54_), .b(new_n64_), .c(x22), .d(x17), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z11));
  nand3  g28(.a(new_n64_), .b(x23), .c(x14), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n54_), .O(z12));
  nand4  g30(.a(new_n54_), .b(new_n64_), .c(x23), .d(x17), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z13));
  inv1   g32(.a(x16), .O(new_n74_));
  oai21  g33(.a(new_n43_), .b(x07), .c(new_n64_), .O(new_n75_));
