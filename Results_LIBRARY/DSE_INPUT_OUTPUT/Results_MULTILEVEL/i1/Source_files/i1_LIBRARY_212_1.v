...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n56_, new_n58_, new_n59_, new_n61_, new_n64_,
  ...
  oai21  g17(.a(new_n51_), .b(x01), .c(x24), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n58_), .O(z07));
  inv1   g19(.a(x11), .O(new_n61_));
  nor2   g20(.a(new_n52_), .b(new_n61_), .O(z08));
  ...
  nand2  g26(.a(new_n67_), .b(new_n44_), .O(z11));
  nand4  g27(.a(new_n44_), .b(new_n64_), .c(x23), .d(x14), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z12));
  nand4  g29(.a(new_n44_), .b(new_n64_), .c(x23), .d(x17), .O(new_n71_));
