...
module FAU ( 
  ...
  nand2  g02(.a(x22), .b(new_n43_), .O(new_n44_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n62_), .d(new_n51_), .O(new_n77_));
  ...
  aoi21  g47(.a(new_n88_), .b(x19), .c(new_n87_), .O(z11));
  nand4  g48(.a(new_n44_), .b(new_n83_), .c(x23), .d(x14), .O(new_n90_));
