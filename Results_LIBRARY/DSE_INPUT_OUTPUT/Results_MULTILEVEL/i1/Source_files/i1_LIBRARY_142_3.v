...
module FAU ( 
  ...
  nand3  g36(.a(new_n65_), .b(new_n61_), .c(new_n50_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  nor2   g38(.a(x20), .b(new_n43_), .O(z06));
  nand3  g39(.a(z06), .b(new_n62_), .c(new_n79_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n78_), .c(new_n45_), .d(new_n77_), .O(z05));
  ...
  nand3  g57(.a(new_n98_), .b(x23), .c(x17), .O(new_n99_));
