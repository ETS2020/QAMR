...
module FAU ( 
  ...
  nand2  g43(.a(new_n81_), .b(new_n78_), .O(new_n85_));
  ...
  nand4  g49(.a(new_n81_), .b(new_n78_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n78_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n81_), .O(z13));
