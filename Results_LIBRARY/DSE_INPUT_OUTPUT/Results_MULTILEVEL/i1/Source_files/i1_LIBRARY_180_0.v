...
module FAU ( 
  ...
  nand2  g39(.a(new_n80_), .b(new_n57_), .O(z09));
  nand2  g40(.a(x22), .b(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x19), .c(x24), .O(z10));
  ...
  nand3  g46(.a(x23), .b(x19), .c(x17), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(x24), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  aoi21  g49(.a(x19), .b(new_n90_), .c(x24), .O(z14));
