...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n79_, new_n81_, new_n84_, new_n85_,
  ...
  aoi21  g41(.a(x19), .b(new_n81_), .c(new_n43_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  inv1   g43(.a(x22), .O(new_n85_));
  nor3   g44(.a(x24), .b(new_n85_), .c(new_n84_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  nor3   g46(.a(x24), .b(new_n85_), .c(new_n87_), .O(z11));
  inv1   g47(.a(x23), .O(new_n89_));
  nor3   g48(.a(x24), .b(new_n89_), .c(new_n84_), .O(z12));
  nor3   g49(.a(x24), .b(new_n89_), .c(new_n87_), .O(z13));
  nand2  g50(.a(new_n43_), .b(x16), .O(new_n92_));
