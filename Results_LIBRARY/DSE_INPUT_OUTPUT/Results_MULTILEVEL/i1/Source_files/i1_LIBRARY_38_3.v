...
module FAU ( 
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(x23), .O(new_n68_));
  ...
  oai21  g36(.a(new_n77_), .b(x23), .c(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nor2   g38(.a(x23), .b(new_n46_), .O(z06));
  ...
  nand4  g50(.a(new_n87_), .b(x23), .c(new_n46_), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand4  g52(.a(new_n87_), .b(x23), .c(new_n46_), .d(x17), .O(new_n94_));
