...
module FAU ( 
  ...
  oai21  g28(.a(new_n69_), .b(new_n46_), .c(new_n58_), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nand2  g30(.a(new_n58_), .b(new_n71_), .O(z03));
  ...
  nand4  g36(.a(new_n77_), .b(new_n76_), .c(new_n64_), .d(new_n52_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n58_), .c(new_n75_), .O(z05));
  ...
  oai21  g43(.a(new_n81_), .b(new_n83_), .c(new_n58_), .O(z09));
  nand3  g44(.a(new_n81_), .b(x22), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n58_), .O(z10));
  nand4  g46(.a(new_n58_), .b(new_n81_), .c(x22), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n81_), .b(x23), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n58_), .O(z12));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n58_), .O(z13));
  nand2  g53(.a(new_n81_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n58_), .O(z14));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x15), .O(new_n98_));
  nand4  g57(.a(new_n98_), .b(new_n90_), .c(new_n43_), .d(new_n97_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
