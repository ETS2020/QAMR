...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_,
  ...
  nand2  g37(.a(x24), .b(x11), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z09));
  nand3  g39(.a(new_n77_), .b(x22), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z10));
  nand4  g41(.a(new_n44_), .b(new_n77_), .c(x22), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand4  g43(.a(new_n44_), .b(new_n77_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand3  g45(.a(new_n77_), .b(x23), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z13));
  nand2  g47(.a(new_n77_), .b(x16), .O(new_n89_));
