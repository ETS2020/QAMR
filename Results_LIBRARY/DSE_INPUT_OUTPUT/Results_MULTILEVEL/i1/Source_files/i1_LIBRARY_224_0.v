...
module FAU ( 
  ...
  nor2   g01(.a(x21), .b(x20), .O(new_n43_));
  nor2   g02(.a(new_n43_), .b(new_n42_), .O(z00));
  inv1   g03(.a(new_n43_), .O(z04));
  ...
  nand3  g15(.a(new_n56_), .b(z04), .c(x19), .O(new_n57_));
  ...
  oai21  g28(.a(new_n69_), .b(new_n59_), .c(z04), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nand2  g30(.a(x21), .b(new_n71_), .O(z03));
  nor4   g31(.a(new_n67_), .b(new_n59_), .c(x08), .d(x07), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n65_), .c(x10), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n43_), .O(z05));
  nor2   g34(.a(new_n43_), .b(new_n59_), .O(z06));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(z04), .O(z07));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(z04), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(z04), .O(z11));
