...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n65_), .c(x24), .O(new_n79_));
  ...
  nor2   g44(.a(new_n57_), .b(new_n84_), .O(z09));
  nand4  g45(.a(new_n57_), .b(x22), .c(new_n43_), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand4  g47(.a(new_n57_), .b(x22), .c(new_n43_), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand4  g49(.a(new_n57_), .b(x23), .c(new_n43_), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand2  g51(.a(x23), .b(x17), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n43_), .c(x24), .O(z13));
  inv1   g53(.a(x16), .O(new_n95_));
  aoi21  g54(.a(new_n43_), .b(new_n95_), .c(x24), .O(z14));
