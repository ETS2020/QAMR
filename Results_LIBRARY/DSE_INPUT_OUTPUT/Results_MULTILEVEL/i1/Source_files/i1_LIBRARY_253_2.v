...
module FAU ( 
  ...
  aoi22  g29(.a(new_n70_), .b(new_n68_), .c(new_n43_), .d(x08), .O(z04));
  ...
  nand4  g43(.a(new_n44_), .b(new_n82_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  nand3  g45(.a(new_n82_), .b(x23), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z12));
  nand4  g47(.a(new_n44_), .b(new_n82_), .c(x23), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z13));
  nand2  g49(.a(new_n82_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(z14));
  inv1   g51(.a(x12), .O(new_n93_));
  inv1   g52(.a(x13), .O(new_n94_));
  nor2   g53(.a(x15), .b(x14), .O(new_n95_));
  nand4  g54(.a(new_n95_), .b(new_n44_), .c(new_n94_), .d(new_n93_), .O(z15));
  buf    g55(.a(x19), .O(z06));
endmodule
