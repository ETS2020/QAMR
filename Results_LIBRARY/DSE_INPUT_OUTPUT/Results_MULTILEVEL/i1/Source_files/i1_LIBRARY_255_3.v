// Benchmark "FAU" written by ABC on Thu Aug 13 20:31:16 2020
...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(new_n44_), .c(x19), .O(new_n70_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n64_), .c(new_n44_), .O(new_n79_));
  ...
  nand3  g44(.a(new_n73_), .b(x24), .c(x11), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z09));
  inv1   g46(.a(x24), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x14), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n43_), .c(new_n44_), .O(z10));
  nand4  g49(.a(new_n88_), .b(x22), .c(new_n43_), .d(x17), .O(new_n91_));
  ...
  nand4  g61(.a(new_n102_), .b(new_n73_), .c(new_n101_), .d(new_n100_), .O(z15));
  buf    g62(.a(x19), .O(z06));
endmodule
