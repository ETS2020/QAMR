...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n77_, new_n78_, new_n79_, new_n80_, new_n83_,
  ...
  nand3  g17(.a(new_n58_), .b(new_n47_), .c(x19), .O(new_n59_));
  ...
  nand3  g29(.a(new_n70_), .b(new_n47_), .c(x19), .O(new_n71_));
  ...
  nand4  g38(.a(new_n79_), .b(new_n66_), .c(new_n77_), .d(new_n53_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n76_), .c(new_n45_), .O(z05));
  nand2  g40(.a(new_n47_), .b(new_n78_), .O(z06));
  nand3  g41(.a(x24), .b(x18), .c(new_n43_), .O(new_n83_));
  ...
  nand3  g47(.a(new_n44_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n47_), .O(z10));
  nand2  g49(.a(x22), .b(x17), .O(new_n91_));
  nor2   g50(.a(new_n91_), .b(x24), .O(z11));
  nand3  g51(.a(new_n44_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n47_), .O(z12));
  nand2  g53(.a(x23), .b(x17), .O(new_n95_));
  nor2   g54(.a(new_n95_), .b(x24), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  nor2   g56(.a(x24), .b(new_n97_), .O(z14));
