// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:03 2020
...
module FAU ( 
  ...
  nand4  g12(.a(new_n53_), .b(x19), .c(new_n52_), .d(new_n51_), .O(new_n54_));
  ...
  nor2   g23(.a(new_n64_), .b(x09), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(x08), .c(new_n52_), .d(new_n51_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n63_), .c(new_n43_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n47_), .O(new_n68_));
  nor2   g27(.a(x03), .b(x02), .O(new_n69_));
  nor2   g28(.a(x05), .b(x04), .O(new_n70_));
  nor2   g29(.a(x07), .b(x06), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n48_), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(x19), .c(x00), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n68_), .O(z02));
  inv1   g33(.a(x20), .O(new_n75_));
  nand2  g34(.a(new_n45_), .b(new_n75_), .O(z03));
  or2    g35(.a(z03), .b(x21), .O(z04));
  inv1   g36(.a(x10), .O(new_n78_));
  nand3  g37(.a(new_n70_), .b(new_n61_), .c(new_n50_), .O(new_n79_));
  inv1   g38(.a(x08), .O(new_n80_));
  nand4  g39(.a(new_n71_), .b(x19), .c(new_n43_), .d(new_n80_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n79_), .c(new_n44_), .d(new_n78_), .O(z05));
  nand2  g41(.a(new_n45_), .b(new_n64_), .O(z06));
  ...
  nand2  g49(.a(x14), .b(x06), .O(new_n91_));
  nor3   g50(.a(new_n91_), .b(x24), .c(new_n90_), .O(z10));
  nand3  g51(.a(new_n85_), .b(x22), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n45_), .O(z11));
  nand2  g53(.a(new_n85_), .b(x23), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(x06), .c(new_n43_), .O(z12));
  inv1   g55(.a(x17), .O(new_n97_));
  oai21  g56(.a(new_n95_), .b(new_n97_), .c(new_n45_), .O(z13));
  nand2  g57(.a(new_n85_), .b(x16), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n45_), .O(z14));
  nor3   g59(.a(x15), .b(x13), .c(x12), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(x14), .c(new_n91_), .O(z15));
endmodule
