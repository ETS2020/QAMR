...
module FAU ( 
  ...
  nand2  g30(.a(new_n43_), .b(new_n70_), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  nor2   g32(.a(new_n47_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n65_), .c(new_n64_), .d(new_n53_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n45_), .c(new_n73_), .O(z05));
  nand2  g35(.a(new_n43_), .b(new_n47_), .O(z06));
  ...
  nand2  g44(.a(new_n45_), .b(new_n85_), .O(new_n86_));
  ...
  nand4  g50(.a(new_n45_), .b(new_n85_), .c(x23), .d(x14), .O(new_n92_));
