// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:39 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_,
    new_n96_, new_n99_, new_n100_;
  ...
  aoi21  g30(.a(new_n71_), .b(new_n68_), .c(new_n64_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n63_), .c(new_n43_), .O(z02));
  inv1   g32(.a(x20), .O(new_n74_));
  nor2   g33(.a(new_n44_), .b(new_n74_), .O(z03));
  nand3  g34(.a(new_n64_), .b(new_n74_), .c(new_n43_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n65_), .b(new_n60_), .c(new_n48_), .O(new_n78_));
  nand4  g37(.a(new_n61_), .b(x21), .c(x19), .d(new_n69_), .O(new_n79_));
  oai22  g38(.a(new_n79_), .b(new_n78_), .c(new_n44_), .d(new_n77_), .O(z05));
  inv1   g39(.a(x18), .O(new_n81_));
  inv1   g40(.a(new_n44_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x24), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n81_), .O(z07));
  ...
  nand2  g48(.a(new_n89_), .b(new_n82_), .O(z10));
  nor2   g49(.a(new_n44_), .b(x24), .O(new_n91_));
  ...
  nand3  g54(.a(new_n88_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n82_), .O(z13));
