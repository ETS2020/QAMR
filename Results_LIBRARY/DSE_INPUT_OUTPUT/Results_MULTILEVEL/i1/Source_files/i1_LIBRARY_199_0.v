...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n68_, new_n69_, new_n72_, new_n73_, new_n75_,
  ...
  nand2  g34(.a(new_n75_), .b(new_n69_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nand2  g36(.a(new_n69_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n69_), .O(z09));
  inv1   g39(.a(x14), .O(new_n81_));
  nand2  g40(.a(new_n79_), .b(x22), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n69_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n69_), .O(z11));
  nand4  g44(.a(new_n69_), .b(new_n79_), .c(x23), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  nand3  g46(.a(new_n79_), .b(x23), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n69_), .O(z13));
  nand2  g48(.a(new_n79_), .b(x16), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n69_), .O(z14));
  nor2   g50(.a(x15), .b(x14), .O(new_n92_));
  nor3   g51(.a(new_n43_), .b(x13), .c(x12), .O(new_n93_));
