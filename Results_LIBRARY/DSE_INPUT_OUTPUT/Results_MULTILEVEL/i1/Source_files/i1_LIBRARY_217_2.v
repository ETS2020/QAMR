...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n77_, new_n79_, new_n80_, new_n82_, new_n85_,
  ...
  nand4  g23(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n64_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n63_), .c(x00), .O(new_n66_));
  nand4  g25(.a(new_n64_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(new_n68_));
  nor2   g27(.a(x06), .b(x05), .O(new_n69_));
  nor2   g28(.a(x09), .b(new_n53_), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n51_), .O(new_n71_));
  ...
  nand4  g35(.a(new_n69_), .b(x19), .c(new_n53_), .d(new_n51_), .O(new_n77_));
  ...
  nor3   g54(.a(new_n60_), .b(x24), .c(new_n95_), .O(z14));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  nor3   g56(.a(new_n60_), .b(x13), .c(x12), .O(new_n98_));
