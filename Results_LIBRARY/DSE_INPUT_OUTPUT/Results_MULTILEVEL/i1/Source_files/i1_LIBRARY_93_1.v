...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n68_, new_n71_, new_n72_, new_n73_, new_n75_,
  ...
  nor2   g30(.a(new_n43_), .b(x08), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n63_), .c(new_n62_), .d(new_n51_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n44_), .c(new_n71_), .O(z05));
  inv1   g33(.a(x23), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(z06));
  ...
  aoi21  g49(.a(new_n90_), .b(x19), .c(new_n75_), .O(z13));
  inv1   g50(.a(x16), .O(new_n92_));
  nand2  g51(.a(new_n44_), .b(new_n83_), .O(new_n93_));
  nor2   g52(.a(new_n93_), .b(new_n92_), .O(z14));
