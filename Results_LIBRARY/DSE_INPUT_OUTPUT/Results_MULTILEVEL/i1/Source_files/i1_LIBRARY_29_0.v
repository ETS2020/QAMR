...
module FAU ( 
  ...
  nor3   g30(.a(x04), .b(x03), .c(x02), .O(new_n72_));
  nor2   g31(.a(x08), .b(x07), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n72_), .c(new_n50_), .d(new_n49_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(x01), .O(new_n75_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n69_), .O(z09));
