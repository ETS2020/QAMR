...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n83_, new_n84_,
  ...
  nand3  g33(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(z05));
  nand2  g34(.a(x24), .b(x18), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n72_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nand2  g37(.a(new_n72_), .b(new_n78_), .O(z08));
