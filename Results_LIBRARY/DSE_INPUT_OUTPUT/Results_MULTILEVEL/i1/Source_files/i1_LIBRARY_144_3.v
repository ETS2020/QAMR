...
module FAU ( 
  ...
  nor2   g15(.a(x23), .b(new_n42_), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n56_), .c(new_n46_), .O(z01));
  inv1   g17(.a(x23), .O(new_n59_));
  ...
  nand3  g31(.a(new_n72_), .b(new_n59_), .c(x19), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z02));
  inv1   g33(.a(x20), .O(new_n75_));
  nor2   g34(.a(new_n44_), .b(new_n75_), .O(z03));
  inv1   g35(.a(x21), .O(new_n77_));
  nand3  g36(.a(new_n43_), .b(new_n77_), .c(new_n75_), .O(z04));
  nand2  g37(.a(new_n43_), .b(x10), .O(new_n79_));
  nand3  g38(.a(new_n65_), .b(new_n61_), .c(new_n49_), .O(new_n80_));
  inv1   g39(.a(x08), .O(new_n81_));
  nand4  g40(.a(new_n62_), .b(new_n59_), .c(x19), .d(new_n81_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n79_), .O(z05));
  ...
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n43_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n88_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n43_), .O(z11));
  nand4  g53(.a(new_n88_), .b(x23), .c(new_n46_), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand2  g55(.a(new_n88_), .b(x17), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n46_), .c(new_n59_), .O(z13));
  nand3  g57(.a(new_n43_), .b(new_n88_), .c(x16), .O(new_n99_));
