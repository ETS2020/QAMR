...
module FAU ( 
  ...
  nand4  g31(.a(new_n65_), .b(new_n59_), .c(new_n66_), .d(new_n52_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x19), .c(x04), .O(new_n74_));
  ...
  nand4  g45(.a(new_n44_), .b(new_n80_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n80_), .b(x23), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n44_), .O(z13));
