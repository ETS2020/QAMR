...
module FAU ( 
  ...
  nand4  g33(.a(new_n74_), .b(new_n61_), .c(new_n52_), .d(new_n51_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n43_), .c(new_n44_), .O(new_n76_));
  or2    g35(.a(new_n76_), .b(x10), .O(z05));
  nor2   g36(.a(new_n44_), .b(x04), .O(z06));
