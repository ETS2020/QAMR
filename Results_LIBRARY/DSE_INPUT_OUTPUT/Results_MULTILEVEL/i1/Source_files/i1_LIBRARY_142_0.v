...
module FAU ( 
  ...
  nand2  g29(.a(new_n44_), .b(x19), .O(z03));
  or2    g30(.a(z03), .b(x21), .O(z04));
  nand2  g31(.a(new_n45_), .b(x10), .O(new_n73_));
  nand4  g32(.a(new_n66_), .b(x19), .c(new_n67_), .d(new_n52_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n64_), .c(new_n73_), .O(z05));
  nand2  g34(.a(x24), .b(x18), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n45_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  inv1   g37(.a(new_n45_), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n78_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  nor3   g40(.a(new_n79_), .b(new_n81_), .c(new_n78_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  nand2  g42(.a(new_n45_), .b(new_n81_), .O(new_n84_));
  ...
  nand4  g48(.a(new_n45_), .b(new_n81_), .c(x23), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n81_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n45_), .O(z13));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n79_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
