...
module FAU ( 
  ...
  nand3  g33(.a(new_n45_), .b(new_n74_), .c(new_n72_), .O(z04));
  nor4   g34(.a(new_n68_), .b(new_n60_), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n66_), .c(x10), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n44_), .O(z05));
  nand2  g37(.a(new_n45_), .b(new_n60_), .O(z06));
  ...
  nand2  g52(.a(x17), .b(x16), .O(new_n94_));
  nor2   g53(.a(new_n94_), .b(x24), .O(z14));
