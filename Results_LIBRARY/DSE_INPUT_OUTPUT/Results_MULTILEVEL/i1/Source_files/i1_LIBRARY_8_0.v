...
module FAU ( 
  ...
  nand2  g14(.a(new_n55_), .b(x14), .O(new_n56_));
  ...
  oai21  g24(.a(new_n65_), .b(new_n62_), .c(x14), .O(new_n66_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n60_), .c(new_n49_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  nand4  g38(.a(new_n70_), .b(x19), .c(x14), .d(new_n79_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n78_), .c(new_n43_), .d(new_n77_), .O(z05));
  nand2  g40(.a(new_n44_), .b(new_n63_), .O(z06));
  ...
  oai21  g59(.a(new_n100_), .b(new_n46_), .c(new_n93_), .O(z15));
endmodule
