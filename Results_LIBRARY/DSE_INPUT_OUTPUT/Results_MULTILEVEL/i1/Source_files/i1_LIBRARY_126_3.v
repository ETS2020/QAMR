...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(x22), .O(new_n70_));
  ...
  nor2   g38(.a(x22), .b(new_n43_), .O(z06));
  ...
  nand4  g45(.a(new_n85_), .b(x22), .c(new_n43_), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand2  g47(.a(new_n85_), .b(x17), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n43_), .c(new_n44_), .O(z11));
  nand4  g49(.a(new_n46_), .b(new_n85_), .c(x23), .d(x14), .O(new_n91_));
