...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n87_, new_n90_, new_n92_, new_n94_, new_n96_,
  ...
  nor2   g40(.a(new_n81_), .b(new_n43_), .O(z06));
  ...
  oai21  g47(.a(new_n81_), .b(new_n87_), .c(new_n45_), .O(z09));
  nand4  g48(.a(new_n81_), .b(x22), .c(new_n43_), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z10));
  nand4  g50(.a(new_n81_), .b(x22), .c(new_n43_), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  nand4  g52(.a(new_n81_), .b(x23), .c(new_n43_), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand4  g54(.a(new_n81_), .b(x23), .c(new_n43_), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  inv1   g56(.a(x16), .O(new_n98_));
  aoi21  g57(.a(new_n43_), .b(new_n98_), .c(x24), .O(z14));
