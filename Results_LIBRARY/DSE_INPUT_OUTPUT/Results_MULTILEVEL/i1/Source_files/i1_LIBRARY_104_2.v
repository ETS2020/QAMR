...
module FAU ( 
  ...
  nand3  g35(.a(x24), .b(x19), .c(x18), .O(new_n77_));
  ...
  nand2  g43(.a(new_n81_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n84_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n84_), .O(z11));
  nand3  g47(.a(new_n81_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n84_), .O(z12));
  nand4  g49(.a(new_n84_), .b(new_n81_), .c(x23), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z13));
  nand2  g51(.a(new_n81_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n84_), .O(z14));
