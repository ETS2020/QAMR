...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n42_), .O(z09));
  inv1   g39(.a(x14), .O(new_n81_));
  nand2  g40(.a(new_n79_), .b(x22), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n42_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n42_), .O(z11));
  nand4  g44(.a(new_n42_), .b(new_n79_), .c(x23), .d(x14), .O(new_n86_));
