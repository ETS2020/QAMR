...
module FAU ( 
  ...
  nand3  g14(.a(new_n55_), .b(x21), .c(x19), .O(new_n56_));
  ...
  nand2  g47(.a(new_n43_), .b(new_n88_), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n43_), .O(z12));
  nand4  g55(.a(new_n43_), .b(new_n88_), .c(x23), .d(x17), .O(new_n97_));
  ...
  nand4  g62(.a(new_n103_), .b(new_n43_), .c(new_n102_), .d(new_n101_), .O(z15));
  buf    g63(.a(x19), .O(z06));
endmodule
