...
module FAU ( 
  ...
  aoi21  g31(.a(x19), .b(x15), .c(new_n72_), .O(z03));
  ...
  nand4  g38(.a(new_n60_), .b(x19), .c(new_n79_), .d(new_n78_), .O(new_n80_));
  ...
  nand4  g49(.a(new_n43_), .b(new_n88_), .c(x22), .d(x17), .O(new_n91_));
  ...
  nand2  g58(.a(new_n45_), .b(x15), .O(new_n100_));
