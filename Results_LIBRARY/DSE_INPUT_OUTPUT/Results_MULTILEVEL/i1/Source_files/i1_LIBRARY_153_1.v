...
module FAU ( 
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n70_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n70_), .O(z11));
  nand3  g46(.a(new_n81_), .b(x23), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n70_), .O(z12));
  nand4  g48(.a(new_n70_), .b(new_n81_), .c(x23), .d(x17), .O(new_n90_));
