...
module FAU ( 
  ...
  nand2  g41(.a(new_n47_), .b(new_n79_), .O(z06));
  nand2  g42(.a(x24), .b(x18), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n47_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n47_), .b(new_n86_), .O(z08));
  nand3  g46(.a(new_n47_), .b(x24), .c(x11), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z09));
  inv1   g48(.a(x24), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(new_n44_), .c(x22), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z10));
  nand2  g51(.a(new_n90_), .b(x17), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n44_), .c(new_n43_), .O(z11));
  ...
  nand2  g58(.a(new_n99_), .b(new_n47_), .O(z14));
  nor2   g59(.a(x13), .b(x12), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(z15));
endmodule
