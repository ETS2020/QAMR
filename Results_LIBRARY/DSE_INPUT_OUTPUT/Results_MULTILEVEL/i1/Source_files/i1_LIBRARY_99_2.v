...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n89_, new_n92_, new_n94_, new_n95_;
  ...
  nand3  g30(.a(new_n64_), .b(x19), .c(new_n52_), .O(new_n72_));
  ...
  nand2  g37(.a(new_n78_), .b(new_n69_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nor2   g39(.a(new_n44_), .b(new_n80_), .O(z08));
  inv1   g40(.a(x24), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n69_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  nand2  g43(.a(new_n82_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n69_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n69_), .O(z11));
  nand2  g47(.a(new_n82_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n84_), .c(new_n69_), .O(z12));
  oai21  g49(.a(new_n89_), .b(new_n87_), .c(new_n69_), .O(z13));
