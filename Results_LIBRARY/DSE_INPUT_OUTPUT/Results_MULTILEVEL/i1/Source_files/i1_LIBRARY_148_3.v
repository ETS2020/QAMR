...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n86_, new_n88_, new_n90_, new_n92_, new_n94_, new_n96_,
    new_n97_, new_n98_;
  ...
  nor2   g13(.a(x20), .b(new_n42_), .O(new_n55_));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(x20), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n60_), .c(new_n44_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nand2  g27(.a(x21), .b(new_n68_), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(x19), .c(new_n69_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nor2   g30(.a(x08), .b(x07), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(new_n49_), .c(new_n48_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n61_), .c(new_n68_), .O(new_n74_));
  ...
  nand3  g52(.a(new_n77_), .b(new_n85_), .c(x16), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z14));
  inv1   g54(.a(x12), .O(new_n96_));
  inv1   g55(.a(x13), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nand4  g57(.a(new_n98_), .b(new_n77_), .c(new_n97_), .d(new_n96_), .O(z15));
  buf    g58(.a(x20), .O(z03));
  buf    g59(.a(x19), .O(z06));
endmodule
