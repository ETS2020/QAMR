...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n81_, new_n84_, new_n86_, new_n88_,
  ...
  nor2   g41(.a(new_n43_), .b(new_n81_), .O(z09));
  nand4  g42(.a(new_n43_), .b(x22), .c(new_n71_), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z10));
  nand2  g44(.a(x22), .b(x17), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n71_), .c(x24), .O(z11));
  nand4  g46(.a(new_n43_), .b(x23), .c(new_n71_), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand2  g48(.a(x23), .b(x17), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n71_), .c(x24), .O(z13));
  inv1   g50(.a(x16), .O(new_n92_));
  aoi21  g51(.a(new_n71_), .b(new_n92_), .c(x24), .O(z14));
  inv1   g52(.a(x12), .O(new_n94_));
  inv1   g53(.a(x13), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  nand4  g55(.a(new_n96_), .b(new_n44_), .c(new_n95_), .d(new_n94_), .O(z15));
endmodule
