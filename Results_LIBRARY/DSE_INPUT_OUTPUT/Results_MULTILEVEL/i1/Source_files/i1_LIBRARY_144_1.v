...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n92_, new_n94_, new_n96_, new_n97_;
  ...
  nand2  g37(.a(new_n43_), .b(new_n60_), .O(z06));
  ...
  oai21  g43(.a(new_n81_), .b(new_n83_), .c(new_n46_), .O(z09));
  ...
  nor4   g49(.a(x24), .b(new_n43_), .c(new_n60_), .d(new_n86_), .O(z12));
  nand2  g50(.a(new_n81_), .b(x17), .O(new_n92_));
