...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n88_, new_n90_, new_n91_, new_n93_, new_n95_, new_n96_;
  ...
  aoi22  g25(.a(new_n66_), .b(new_n62_), .c(new_n60_), .d(x00), .O(new_n67_));
  ...
  nand4  g34(.a(new_n75_), .b(new_n74_), .c(new_n62_), .d(new_n51_), .O(new_n76_));
  ...
  nand3  g44(.a(x22), .b(x19), .c(x17), .O(new_n86_));
  ...
  aoi21  g50(.a(new_n91_), .b(x19), .c(new_n90_), .O(z13));
