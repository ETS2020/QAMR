...
module FAU ( 
  ...
  nand2  g36(.a(new_n57_), .b(x24), .O(new_n78_));
  ...
  nand2  g43(.a(new_n57_), .b(new_n84_), .O(new_n85_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n57_), .O(z12));
  nand4  g51(.a(new_n57_), .b(new_n84_), .c(x23), .d(x17), .O(new_n93_));
