...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n79_, new_n82_, new_n84_, new_n85_, new_n87_,
  ...
  oai21  g39(.a(new_n77_), .b(new_n79_), .c(new_n71_), .O(z09));
  nand3  g40(.a(new_n77_), .b(x22), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n71_), .O(z10));
  ...
  nand2  g46(.a(new_n87_), .b(new_n71_), .O(z12));
