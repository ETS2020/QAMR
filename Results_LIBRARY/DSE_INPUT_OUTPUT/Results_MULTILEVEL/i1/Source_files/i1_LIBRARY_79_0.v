...
module FAU ( 
  ...
  nand4  g25(.a(new_n66_), .b(new_n62_), .c(new_n49_), .d(new_n45_), .O(new_n67_));
  ...
  nand4  g33(.a(new_n45_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n75_));
  inv1   g34(.a(x08), .O(new_n76_));
  nor2   g35(.a(x06), .b(x05), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(x19), .c(new_n76_), .d(new_n51_), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n75_), .c(new_n43_), .d(new_n74_), .O(z05));
