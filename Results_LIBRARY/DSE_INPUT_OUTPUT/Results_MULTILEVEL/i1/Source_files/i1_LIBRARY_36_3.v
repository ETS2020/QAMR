...
module FAU ( 
  ...
  nand2  g18(.a(new_n42_), .b(new_n59_), .O(z03));
  inv1   g19(.a(x21), .O(new_n61_));
  aoi22  g20(.a(new_n61_), .b(new_n59_), .c(x19), .d(x08), .O(z04));
  ...
  nand2  g28(.a(new_n69_), .b(new_n42_), .O(z07));
  ...
  nand3  g33(.a(new_n42_), .b(new_n74_), .c(x22), .O(new_n75_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n42_), .O(z12));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n42_), .O(z13));
