...
module FAU ( 
  ...
  nand3  g32(.a(new_n73_), .b(new_n71_), .c(x19), .O(z04));
  ...
  nand4  g45(.a(new_n45_), .b(new_n84_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n84_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n45_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n45_), .O(z13));
