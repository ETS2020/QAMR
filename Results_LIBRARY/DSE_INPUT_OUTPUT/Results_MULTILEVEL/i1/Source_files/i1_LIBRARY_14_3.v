...
module FAU ( 
  ...
  nand2  g48(.a(new_n89_), .b(new_n43_), .O(z10));
  nand4  g49(.a(new_n43_), .b(new_n87_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand4  g51(.a(new_n43_), .b(new_n87_), .c(x23), .d(x14), .O(new_n93_));
  ...
  nand2  g58(.a(new_n45_), .b(x13), .O(new_n100_));
