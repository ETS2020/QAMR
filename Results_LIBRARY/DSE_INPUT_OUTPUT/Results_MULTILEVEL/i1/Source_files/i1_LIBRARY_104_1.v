...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(x19), .c(x18), .O(new_n70_));
  ...
  nand4  g37(.a(new_n60_), .b(x19), .c(x18), .d(new_n78_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(z05));
  inv1   g39(.a(x24), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n42_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nor2   g42(.a(new_n73_), .b(new_n83_), .O(z08));
  nor3   g43(.a(new_n73_), .b(new_n81_), .c(new_n83_), .O(z09));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n81_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n43_), .O(z10));
  ...
  nand4  g51(.a(new_n43_), .b(new_n81_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n81_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n43_), .O(z14));
  nor2   g55(.a(x13), .b(x12), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n73_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
