...
module FAU ( 
  ...
  nor2   g26(.a(new_n67_), .b(x04), .O(new_n68_));
  ...
  nor2   g39(.a(new_n44_), .b(x04), .O(z06));
  ...
  nand4  g46(.a(new_n71_), .b(new_n86_), .c(x22), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand3  g48(.a(new_n86_), .b(x22), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n71_), .O(z11));
  nand4  g50(.a(new_n71_), .b(new_n86_), .c(x23), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand3  g52(.a(new_n86_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n71_), .O(z13));
  nand2  g54(.a(new_n86_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n71_), .O(z14));
