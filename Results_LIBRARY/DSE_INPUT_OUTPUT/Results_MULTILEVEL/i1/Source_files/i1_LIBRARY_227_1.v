...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n77_, new_n78_, new_n80_, new_n83_, new_n85_,
  ...
  oai21  g38(.a(new_n60_), .b(x18), .c(x24), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n60_), .O(z06));
  inv1   g40(.a(new_n80_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  aoi21  g42(.a(x24), .b(new_n60_), .c(new_n83_), .O(z08));
  nand3  g43(.a(x24), .b(x19), .c(x11), .O(new_n85_));
  ...
  nand2  g53(.a(new_n43_), .b(x16), .O(new_n95_));
