...
module FAU ( 
  ...
  nand3  g30(.a(new_n71_), .b(new_n69_), .c(x19), .O(z04));
  ...
  nand2  g35(.a(x21), .b(new_n46_), .O(z06));
  ...
  nand2  g44(.a(new_n44_), .b(new_n85_), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  ...
  nand4  g50(.a(new_n44_), .b(new_n85_), .c(x23), .d(x14), .O(new_n92_));
