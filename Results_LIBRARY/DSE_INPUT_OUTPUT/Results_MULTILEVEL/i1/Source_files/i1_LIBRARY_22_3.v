...
module FAU ( 
  ...
  nand3  g40(.a(x24), .b(new_n44_), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nor2   g43(.a(new_n45_), .b(new_n84_), .O(z08));
  nand3  g44(.a(new_n75_), .b(x24), .c(x11), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z09));
  inv1   g46(.a(x24), .O(new_n88_));
  nand4  g47(.a(new_n75_), .b(new_n88_), .c(x22), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z10));
  nand3  g49(.a(new_n88_), .b(x22), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n75_), .O(z11));
  inv1   g51(.a(x14), .O(new_n93_));
  nand2  g52(.a(new_n88_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n75_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n75_), .O(z13));
  nand3  g56(.a(new_n75_), .b(new_n88_), .c(x16), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z14));
  inv1   g58(.a(x12), .O(new_n100_));
  inv1   g59(.a(x13), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nand4  g61(.a(new_n102_), .b(new_n75_), .c(new_n101_), .d(new_n100_), .O(z15));
  buf    g62(.a(x19), .O(z06));
endmodule
