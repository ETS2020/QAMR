...
module FAU ( 
  ...
  nand4  g25(.a(new_n66_), .b(new_n63_), .c(new_n62_), .d(new_n61_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n60_), .c(new_n45_), .O(z02));
  ...
  nand4  g32(.a(new_n73_), .b(new_n63_), .c(new_n62_), .d(new_n47_), .O(new_n74_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n77_), .O(z12));
  nand4  g48(.a(new_n77_), .b(new_n82_), .c(x23), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z13));
  nand2  g50(.a(new_n82_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n77_), .O(z14));
