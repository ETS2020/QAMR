...
module FAU ( 
  ...
  nand3  g36(.a(new_n77_), .b(new_n74_), .c(new_n73_), .O(z05));
  ...
  nand2  g42(.a(new_n74_), .b(new_n83_), .O(z08));
  oai21  g43(.a(new_n81_), .b(new_n83_), .c(new_n74_), .O(z09));
  inv1   g44(.a(x22), .O(new_n86_));
  nand2  g45(.a(new_n74_), .b(new_n81_), .O(new_n87_));
  ...
  nand4  g51(.a(new_n74_), .b(new_n81_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n81_), .b(x23), .c(x17), .O(new_n95_));
