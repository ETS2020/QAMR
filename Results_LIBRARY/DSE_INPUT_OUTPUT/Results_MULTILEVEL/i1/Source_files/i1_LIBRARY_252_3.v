...
module FAU ( 
  ...
  nor2   g28(.a(new_n44_), .b(x19), .O(z03));
  nand2  g29(.a(x21), .b(new_n44_), .O(new_n71_));
  oai21  g30(.a(new_n44_), .b(x19), .c(new_n71_), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  nand3  g32(.a(new_n63_), .b(new_n64_), .c(new_n50_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n62_), .c(new_n44_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n73_), .O(z05));
  inv1   g36(.a(x19), .O(new_n78_));
  nor2   g37(.a(x20), .b(new_n78_), .O(z06));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n42_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n42_), .b(new_n82_), .O(z08));
  nand3  g42(.a(new_n42_), .b(x24), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x24), .O(new_n86_));
  nand3  g45(.a(new_n42_), .b(new_n86_), .c(x22), .O(new_n87_));
  ...
  nand3  g51(.a(new_n42_), .b(new_n86_), .c(x23), .O(new_n93_));
  ...
  oai21  g58(.a(x24), .b(new_n99_), .c(new_n42_), .O(z14));
  nor2   g59(.a(x13), .b(x12), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n101_), .c(x20), .d(x19), .O(z15));
endmodule
