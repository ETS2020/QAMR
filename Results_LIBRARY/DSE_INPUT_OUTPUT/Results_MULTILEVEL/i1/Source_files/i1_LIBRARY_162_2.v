...
module FAU ( 
  ...
  nand4  g52(.a(new_n72_), .b(new_n83_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n83_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n72_), .O(z13));
