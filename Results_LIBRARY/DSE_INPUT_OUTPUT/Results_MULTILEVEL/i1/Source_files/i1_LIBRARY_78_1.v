...
module FAU ( 
  ...
  nand2  g28(.a(new_n43_), .b(new_n69_), .O(z05));
  inv1   g29(.a(x18), .O(new_n71_));
  inv1   g30(.a(x24), .O(new_n72_));
  nor3   g31(.a(new_n66_), .b(new_n72_), .c(new_n71_), .O(z07));
  ...
  nand2  g36(.a(new_n43_), .b(new_n72_), .O(new_n78_));
