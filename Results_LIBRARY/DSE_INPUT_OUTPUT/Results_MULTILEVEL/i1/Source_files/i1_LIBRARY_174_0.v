...
module FAU ( 
  ...
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n57_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n57_), .O(z11));
  nand3  g47(.a(new_n79_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n57_), .O(z12));
  nand4  g49(.a(new_n57_), .b(new_n79_), .c(x23), .d(x17), .O(new_n91_));
