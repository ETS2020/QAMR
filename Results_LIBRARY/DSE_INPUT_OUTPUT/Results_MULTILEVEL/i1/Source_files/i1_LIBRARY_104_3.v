...
module FAU ( 
  ...
  nand4  g39(.a(new_n62_), .b(x19), .c(new_n43_), .d(new_n80_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n79_), .c(new_n45_), .d(new_n78_), .O(z05));
  nand3  g41(.a(x24), .b(new_n44_), .c(x18), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n45_), .b(new_n85_), .O(z08));
  inv1   g45(.a(new_n45_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x24), .c(x11), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  inv1   g49(.a(x24), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x22), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n90_), .c(new_n87_), .O(z10));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n87_), .O(z11));
  nand3  g54(.a(new_n91_), .b(x23), .c(x14), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n87_), .O(z12));
  nand4  g56(.a(new_n87_), .b(new_n91_), .c(x23), .d(x17), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z13));
  nand2  g58(.a(new_n91_), .b(x16), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n87_), .O(z14));
