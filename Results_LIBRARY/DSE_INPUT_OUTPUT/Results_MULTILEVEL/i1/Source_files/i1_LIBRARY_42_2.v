...
module FAU ( 
  ...
  nor2   g31(.a(new_n47_), .b(x08), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n64_), .c(new_n63_), .d(new_n53_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n45_), .c(new_n72_), .O(z05));
  ...
  nand4  g45(.a(new_n45_), .b(new_n80_), .c(x23), .d(x14), .O(new_n87_));
