...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n87_, new_n88_, new_n89_, new_n91_, new_n93_, new_n94_,
  ...
  nand3  g16(.a(new_n57_), .b(x19), .c(x16), .O(new_n58_));
  ...
  nand3  g28(.a(new_n69_), .b(x19), .c(x16), .O(new_n70_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n64_), .c(x16), .O(new_n78_));
  ...
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n45_), .O(z09));
  ...
  nand2  g52(.a(new_n82_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n45_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n45_), .O(z13));
  nand2  g56(.a(new_n82_), .b(x16), .O(new_n98_));
