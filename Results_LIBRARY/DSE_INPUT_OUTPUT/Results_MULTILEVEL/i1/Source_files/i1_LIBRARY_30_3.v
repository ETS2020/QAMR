...
module FAU ( 
  ...
  nor2   g39(.a(new_n45_), .b(x12), .O(z06));
  nand3  g40(.a(z06), .b(new_n61_), .c(new_n80_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n79_), .c(new_n78_), .O(z05));
  nand2  g42(.a(x24), .b(x18), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n43_), .O(z07));
  ...
  nand2  g56(.a(new_n90_), .b(x23), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n97_), .c(new_n43_), .O(z12));
  inv1   g58(.a(x17), .O(new_n100_));
  oai21  g59(.a(new_n98_), .b(new_n100_), .c(new_n43_), .O(z13));
  inv1   g60(.a(x16), .O(new_n102_));
  oai21  g61(.a(x24), .b(new_n102_), .c(new_n43_), .O(z14));
  nor3   g62(.a(x15), .b(x14), .c(x13), .O(new_n104_));
  nand2  g63(.a(new_n45_), .b(x12), .O(new_n105_));
  oai21  g64(.a(new_n104_), .b(x12), .c(new_n105_), .O(z15));
endmodule
