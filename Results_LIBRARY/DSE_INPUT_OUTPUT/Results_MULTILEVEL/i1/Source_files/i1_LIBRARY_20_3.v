...
module FAU ( 
  ...
  nor4   g34(.a(new_n67_), .b(new_n64_), .c(x08), .d(x07), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(x12), .c(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n75_), .O(z05));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n72_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n45_), .b(new_n81_), .O(z08));
  nand3  g41(.a(new_n72_), .b(x24), .c(x11), .O(new_n83_));
