...
module FAU ( 
  ...
  nor2   g24(.a(x09), .b(new_n43_), .O(new_n66_));
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n53_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n62_), .c(new_n47_), .O(z02));
  ...
  nand3  g31(.a(new_n65_), .b(x19), .c(new_n53_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n64_), .c(x10), .O(new_n75_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n45_), .O(z09));
