...
module FAU ( 
  ...
  nor2   g36(.a(x22), .b(new_n45_), .O(z06));
  ...
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n83_), .c(new_n43_), .O(z09));
  nand4  g46(.a(new_n86_), .b(x22), .c(new_n45_), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  inv1   g48(.a(x22), .O(new_n90_));
  nand2  g49(.a(new_n86_), .b(x17), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n45_), .c(new_n90_), .O(z11));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n84_), .O(z15));
endmodule
