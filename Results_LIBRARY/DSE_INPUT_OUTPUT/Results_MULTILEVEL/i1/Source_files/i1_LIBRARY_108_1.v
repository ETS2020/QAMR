...
module FAU ( 
  ...
  nand2  g01(.a(x23), .b(new_n42_), .O(new_n43_));
  ...
  nand4  g18(.a(new_n56_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n60_));
  nand2  g19(.a(new_n49_), .b(new_n48_), .O(new_n61_));
  inv1   g20(.a(x09), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(x08), .c(new_n50_), .O(new_n63_));
  nor3   g22(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(new_n64_));
  aoi21  g23(.a(new_n59_), .b(x00), .c(new_n64_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n42_), .c(new_n43_), .O(z02));
  ...
  nor2   g31(.a(new_n42_), .b(x08), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n60_), .c(new_n72_), .O(z05));
  ...
  nand4  g41(.a(new_n43_), .b(new_n82_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n82_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n43_), .O(z11));
  inv1   g45(.a(x23), .O(new_n87_));
  nand2  g46(.a(new_n82_), .b(x14), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(x19), .c(new_n87_), .O(z12));
  nand3  g48(.a(x23), .b(x19), .c(x17), .O(new_n90_));
  nor2   g49(.a(new_n90_), .b(x24), .O(z13));
  nand2  g50(.a(new_n82_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n43_), .O(z14));
  nor2   g52(.a(x15), .b(x14), .O(new_n94_));
  nor3   g53(.a(new_n69_), .b(x13), .c(x12), .O(new_n95_));
