// Benchmark "FAU" written by ABC on Thu Aug 13 20:30:20 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n84_, new_n87_, new_n89_, new_n91_, new_n93_, new_n95_,
    new_n97_, new_n98_;
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(new_n56_), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n63_), .c(new_n43_), .O(z02));
  inv1   g31(.a(x21), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(x19), .c(new_n56_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nand3  g34(.a(new_n64_), .b(new_n60_), .c(new_n48_), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  nand4  g36(.a(new_n61_), .b(x20), .c(x19), .d(new_n77_), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n76_), .c(new_n44_), .d(new_n75_), .O(z05));
  ...
  inv1   g42(.a(new_n44_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n83_), .O(z08));
  oai21  g44(.a(new_n81_), .b(new_n83_), .c(new_n84_), .O(z09));
  nand3  g45(.a(new_n81_), .b(x22), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n84_), .O(z10));
  nand4  g47(.a(new_n84_), .b(new_n81_), .c(x22), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand3  g49(.a(new_n81_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n84_), .O(z12));
  nand4  g51(.a(new_n84_), .b(new_n81_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n81_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n84_), .O(z14));
