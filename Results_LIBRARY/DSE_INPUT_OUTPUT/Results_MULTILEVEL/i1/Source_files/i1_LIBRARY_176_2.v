...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n82_, new_n84_, new_n86_,
  ...
  inv1   g31(.a(new_n58_), .O(new_n73_));
  nor2   g32(.a(new_n43_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n59_), .c(new_n73_), .d(new_n51_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n44_), .c(new_n72_), .O(z05));
  ...
  oai21  g41(.a(new_n82_), .b(new_n79_), .c(new_n44_), .O(z09));
  nand3  g42(.a(new_n82_), .b(x22), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z10));
  nor2   g44(.a(new_n80_), .b(x24), .O(new_n86_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n80_), .O(z15));
  buf    g55(.a(x19), .O(z06));
endmodule
