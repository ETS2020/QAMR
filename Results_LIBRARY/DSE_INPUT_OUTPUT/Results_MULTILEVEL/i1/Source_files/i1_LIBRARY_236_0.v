...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(new_n51_), .d(new_n50_), .O(new_n68_));
  ...
  nand4  g36(.a(new_n77_), .b(new_n52_), .c(new_n46_), .d(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n61_), .c(new_n75_), .O(z05));
  ...
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z10));
