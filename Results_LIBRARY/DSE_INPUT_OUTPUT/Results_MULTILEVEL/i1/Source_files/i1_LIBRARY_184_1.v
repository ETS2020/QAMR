...
module FAU ( 
  ...
  nand2  g49(.a(new_n75_), .b(new_n85_), .O(new_n91_));
  ...
  nand2  g56(.a(new_n85_), .b(x23), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n97_), .c(new_n75_), .O(z12));
  inv1   g58(.a(x17), .O(new_n100_));
  oai21  g59(.a(new_n98_), .b(new_n100_), .c(new_n75_), .O(z13));
  inv1   g60(.a(x16), .O(new_n102_));
  nor2   g61(.a(new_n91_), .b(new_n102_), .O(z14));
  nor2   g62(.a(x13), .b(x12), .O(new_n104_));
  nand4  g63(.a(new_n104_), .b(new_n43_), .c(new_n56_), .d(new_n97_), .O(z15));
endmodule
