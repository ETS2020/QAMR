...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n75_, new_n77_,
  ...
  nand2  g36(.a(new_n57_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  nor3   g38(.a(new_n43_), .b(new_n79_), .c(new_n77_), .O(z09));
  nand4  g39(.a(new_n57_), .b(new_n79_), .c(x22), .d(x14), .O(new_n81_));
  ...
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n57_), .O(z12));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n57_), .O(z13));
