...
module FAU ( 
  ...
  nand3  g30(.a(new_n71_), .b(x19), .c(new_n43_), .O(new_n72_));
  ...
  nor2   g39(.a(new_n44_), .b(x12), .O(z06));
  nand3  g40(.a(z06), .b(new_n62_), .c(new_n80_), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n79_), .c(new_n45_), .d(new_n78_), .O(z05));
  ...
  nand4  g53(.a(new_n75_), .b(new_n88_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n88_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n75_), .O(z13));
  nand3  g57(.a(new_n75_), .b(new_n88_), .c(x16), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z14));
  nor3   g59(.a(x15), .b(x14), .c(x13), .O(new_n101_));
  nand2  g60(.a(new_n44_), .b(x12), .O(new_n102_));
  oai21  g61(.a(new_n101_), .b(x12), .c(new_n102_), .O(z15));
endmodule
