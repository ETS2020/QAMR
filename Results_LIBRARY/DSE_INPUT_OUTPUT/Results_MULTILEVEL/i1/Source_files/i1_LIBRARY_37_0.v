...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n81_, new_n83_, new_n84_, new_n86_,
  ...
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z09));
  inv1   g41(.a(x14), .O(new_n83_));
  inv1   g42(.a(x22), .O(new_n84_));
  nor4   g43(.a(x24), .b(new_n84_), .c(new_n59_), .d(new_n83_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  nor4   g45(.a(x24), .b(new_n84_), .c(new_n59_), .d(new_n86_), .O(z11));
  inv1   g46(.a(x23), .O(new_n88_));
  nor4   g47(.a(x24), .b(new_n88_), .c(new_n59_), .d(new_n83_), .O(z12));
  nor4   g48(.a(x24), .b(new_n88_), .c(new_n59_), .d(new_n86_), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  aoi21  g50(.a(x19), .b(new_n91_), .c(x24), .O(z14));
