...
module FAU ( 
  ...
  nand2  g32(.a(new_n44_), .b(x10), .O(new_n74_));
  inv1   g33(.a(new_n67_), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(x19), .c(new_n66_), .d(new_n51_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n64_), .c(new_n74_), .O(z05));
  nand2  g36(.a(new_n59_), .b(x11), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z07));
  nand2  g39(.a(x24), .b(x11), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z09));
  inv1   g41(.a(x14), .O(new_n83_));
  inv1   g42(.a(x24), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n44_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n44_), .O(z11));
  inv1   g47(.a(x23), .O(new_n89_));
  nor3   g48(.a(new_n43_), .b(x24), .c(new_n89_), .O(new_n90_));
