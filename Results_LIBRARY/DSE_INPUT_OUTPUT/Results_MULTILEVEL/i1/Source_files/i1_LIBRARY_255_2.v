...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n88_, new_n90_, new_n91_, new_n94_, new_n96_, new_n97_;
  inv1   g00(.a(x22), .O(new_n42_));
  nand2  g01(.a(new_n42_), .b(x19), .O(new_n43_));
  ...
  nand3  g14(.a(new_n55_), .b(x22), .c(x19), .O(new_n56_));
  ...
  nand3  g26(.a(new_n67_), .b(x22), .c(x19), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nand2  g29(.a(new_n43_), .b(new_n70_), .O(z03));
  ...
  nand3  g34(.a(new_n63_), .b(new_n64_), .c(new_n50_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n62_), .c(x22), .O(new_n77_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n43_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  nor3   g47(.a(x24), .b(new_n42_), .c(new_n88_), .O(z11));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n84_), .b(x23), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(z12));
  oai21  g51(.a(new_n91_), .b(new_n88_), .c(new_n43_), .O(z13));
  nand2  g52(.a(new_n84_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n43_), .O(z14));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  nor3   g55(.a(new_n72_), .b(x13), .c(x12), .O(new_n97_));
