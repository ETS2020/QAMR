...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n78_, new_n81_, new_n83_, new_n85_, new_n87_,
  ...
  oai21  g36(.a(new_n47_), .b(x18), .c(x24), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n47_), .O(z06));
  inv1   g38(.a(new_n78_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  oai21  g40(.a(new_n43_), .b(x19), .c(new_n81_), .O(z08));
