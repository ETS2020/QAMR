...
module FAU ( 
  ...
  nand3  g14(.a(new_n55_), .b(x19), .c(x12), .O(new_n56_));
  ...
  nand3  g28(.a(new_n69_), .b(x19), .c(x12), .O(new_n70_));
  ...
  and2   g56(.a(new_n88_), .b(x16), .O(z14));
