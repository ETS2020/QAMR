...
module FAU ( 
  ...
  nand2  g42(.a(new_n72_), .b(x24), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n72_), .b(new_n86_), .O(z08));
  ...
  oai21  g50(.a(new_n91_), .b(new_n89_), .c(new_n72_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n72_), .O(z11));
  nand3  g53(.a(new_n90_), .b(x23), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n72_), .O(z12));
  nand4  g55(.a(new_n72_), .b(new_n90_), .c(x23), .d(x17), .O(new_n97_));
