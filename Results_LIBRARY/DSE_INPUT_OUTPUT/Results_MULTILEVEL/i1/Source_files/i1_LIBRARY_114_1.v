...
module FAU ( 
  ...
  nand4  g39(.a(new_n62_), .b(x19), .c(x17), .d(new_n70_), .O(new_n81_));
  ...
  nand4  g47(.a(new_n45_), .b(new_n84_), .c(x22), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z10));
  nand3  g49(.a(new_n84_), .b(x22), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n45_), .O(z11));
  nand4  g51(.a(new_n45_), .b(new_n84_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n84_), .b(x23), .c(x17), .O(new_n95_));
