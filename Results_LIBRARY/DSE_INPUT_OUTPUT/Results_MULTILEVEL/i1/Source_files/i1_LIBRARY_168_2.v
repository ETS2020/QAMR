...
module FAU ( 
  ...
  nand4  g38(.a(new_n62_), .b(x24), .c(x19), .d(new_n79_), .O(new_n80_));
  ...
  nand4  g46(.a(new_n86_), .b(x22), .c(new_n43_), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand4  g48(.a(new_n86_), .b(x22), .c(new_n43_), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand4  g50(.a(new_n86_), .b(x23), .c(new_n43_), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand4  g52(.a(new_n86_), .b(x23), .c(new_n43_), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  nand3  g54(.a(new_n86_), .b(new_n43_), .c(x16), .O(new_n96_));
