...
module FAU ( 
  ...
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(new_n61_));
  ...
  nand4  g23(.a(new_n64_), .b(x08), .c(new_n52_), .d(new_n51_), .O(new_n65_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n60_), .c(new_n43_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n73_), .O(z05));
  nor2   g37(.a(new_n44_), .b(x07), .O(z06));
  ...
  nor2   g44(.a(new_n45_), .b(x24), .O(new_n86_));
  ...
  nand2  g53(.a(new_n94_), .b(new_n70_), .O(z13));
