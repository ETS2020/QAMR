...
module FAU ( 
  ...
  nor2   g33(.a(new_n59_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n66_), .c(new_n65_), .d(new_n51_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(new_n74_), .O(z05));
  nand2  g36(.a(x24), .b(new_n59_), .O(z06));
  oai21  g37(.a(x24), .b(new_n59_), .c(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n43_), .b(new_n81_), .O(z08));
  nand2  g41(.a(x24), .b(x11), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n44_), .O(z09));
  ...
  aoi21  g48(.a(new_n89_), .b(x19), .c(x24), .O(z12));
  nand2  g49(.a(x23), .b(x17), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(x19), .c(x24), .O(z13));
  nand2  g51(.a(x19), .b(x16), .O(new_n93_));
