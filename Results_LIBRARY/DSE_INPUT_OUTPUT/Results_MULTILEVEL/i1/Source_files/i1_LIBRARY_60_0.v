...
module FAU ( 
  ...
  nand4  g16(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n58_));
  ...
  nand4  g32(.a(new_n57_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n74_));
  nor2   g33(.a(new_n45_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(z05));
  ...
  nand4  g42(.a(new_n69_), .b(new_n82_), .c(x22), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z10));
  nand3  g44(.a(new_n82_), .b(x22), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n69_), .O(z11));
  nand4  g46(.a(new_n69_), .b(new_n82_), .c(x23), .d(x14), .O(new_n88_));
