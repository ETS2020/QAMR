...
module FAU ( 
  ...
  nand3  g15(.a(new_n56_), .b(x19), .c(x10), .O(new_n57_));
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(x08), .d(new_n51_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n63_), .c(new_n62_), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(x19), .c(x10), .O(new_n68_));
  ...
  nand2  g33(.a(new_n43_), .b(new_n74_), .O(z05));
  nor2   g34(.a(new_n43_), .b(new_n74_), .O(z06));
  ...
  nand2  g47(.a(new_n88_), .b(new_n71_), .O(z12));
  nand4  g48(.a(new_n71_), .b(new_n81_), .c(x23), .d(x17), .O(new_n90_));
