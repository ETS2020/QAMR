...
module FAU ( 
  ...
  nand4  g21(.a(new_n52_), .b(new_n62_), .c(x22), .d(x14), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z10));
  nand3  g23(.a(new_n62_), .b(x22), .c(x17), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n52_), .O(z11));
  nand4  g25(.a(new_n52_), .b(new_n62_), .c(x23), .d(x14), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z12));
  nand3  g27(.a(new_n62_), .b(x23), .c(x17), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n52_), .O(z13));
  inv1   g29(.a(x16), .O(new_n71_));
  oai21  g30(.a(new_n43_), .b(x07), .c(new_n62_), .O(new_n72_));
