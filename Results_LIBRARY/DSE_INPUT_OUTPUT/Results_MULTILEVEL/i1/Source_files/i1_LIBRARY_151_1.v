...
module FAU ( 
  ...
  nor2   g28(.a(new_n43_), .b(new_n46_), .O(z03));
  inv1   g29(.a(x21), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n43_), .O(z04));
  ...
  oai21  g41(.a(new_n79_), .b(new_n81_), .c(new_n58_), .O(z09));
  nand4  g42(.a(new_n58_), .b(new_n79_), .c(x22), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z10));
  nand3  g44(.a(new_n79_), .b(x22), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n58_), .O(z11));
  nand4  g46(.a(new_n58_), .b(new_n79_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n79_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n58_), .O(z13));
  nand2  g50(.a(new_n79_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n58_), .O(z14));
