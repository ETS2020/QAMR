...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n64_), .c(new_n63_), .d(new_n62_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n61_), .c(new_n46_), .O(z02));
  ...
  nand4  g33(.a(new_n74_), .b(new_n64_), .c(new_n63_), .d(new_n48_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x19), .c(x01), .O(new_n76_));
  or2    g35(.a(new_n76_), .b(x10), .O(z05));
  nand2  g36(.a(new_n46_), .b(x01), .O(z06));
