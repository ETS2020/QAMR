...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n88_, new_n90_, new_n92_, new_n93_, new_n95_, new_n97_,
    new_n99_, new_n100_;
  ...
  nand4  g35(.a(new_n76_), .b(new_n64_), .c(new_n75_), .d(new_n51_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n72_), .c(new_n74_), .O(z05));
  ...
  oai21  g43(.a(new_n81_), .b(new_n83_), .c(new_n72_), .O(z09));
  ...
  nand2  g51(.a(new_n81_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n72_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n72_), .O(z13));
  nand2  g55(.a(new_n81_), .b(x16), .O(new_n97_));
