...
module FAU ( 
  ...
  nand2  g33(.a(new_n59_), .b(x10), .O(new_n75_));
  nor2   g34(.a(new_n58_), .b(x08), .O(new_n76_));
  ...
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n59_), .O(z09));
  nand3  g43(.a(new_n80_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n59_), .O(z10));
