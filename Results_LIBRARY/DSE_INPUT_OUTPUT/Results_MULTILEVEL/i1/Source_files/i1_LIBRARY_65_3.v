...
module FAU ( 
  ...
  nor2   g15(.a(x13), .b(new_n42_), .O(new_n57_));
  ...
  nand4  g19(.a(new_n52_), .b(new_n51_), .c(new_n50_), .d(new_n60_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(x00), .O(new_n62_));
  nand4  g21(.a(new_n60_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n63_));
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(x13), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n62_), .c(new_n44_), .O(z02));
  ...
  nor2   g33(.a(x08), .b(x07), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n51_), .c(new_n50_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(new_n43_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n71_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n45_), .b(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n71_), .O(z09));
  nand3  g44(.a(new_n84_), .b(x22), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n71_), .O(z10));
  nor2   g46(.a(new_n45_), .b(x24), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x22), .c(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand3  g49(.a(new_n84_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n71_), .O(z12));
  nand3  g51(.a(new_n88_), .b(x23), .c(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n88_), .b(x16), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z14));
  nor3   g55(.a(x15), .b(x14), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n44_), .b(x13), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(x13), .c(new_n98_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
