...
module FAU ( 
  ...
  nor2   g27(.a(new_n68_), .b(x07), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n64_), .c(new_n44_), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nor2   g30(.a(new_n45_), .b(new_n71_), .O(z03));
  inv1   g31(.a(x21), .O(new_n73_));
  nand3  g32(.a(new_n46_), .b(new_n73_), .c(new_n71_), .O(z04));
  ...
  nor2   g39(.a(new_n44_), .b(x07), .O(z06));
  ...
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n46_), .O(z09));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n86_), .b(x22), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n46_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n46_), .O(z11));
  nand4  g51(.a(new_n46_), .b(new_n86_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n86_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n46_), .O(z13));
  nand3  g55(.a(new_n46_), .b(new_n86_), .c(x16), .O(new_n97_));
