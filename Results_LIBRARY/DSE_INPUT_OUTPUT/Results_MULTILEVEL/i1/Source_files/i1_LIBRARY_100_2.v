...
module FAU ( 
  ...
  nand2  g42(.a(new_n83_), .b(new_n82_), .O(z08));
  oai21  g43(.a(new_n80_), .b(new_n82_), .c(new_n83_), .O(z09));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n80_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n83_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n83_), .O(z11));
  nand3  g49(.a(new_n80_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n83_), .O(z12));
  nand4  g51(.a(new_n83_), .b(new_n80_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n80_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n83_), .O(z14));
