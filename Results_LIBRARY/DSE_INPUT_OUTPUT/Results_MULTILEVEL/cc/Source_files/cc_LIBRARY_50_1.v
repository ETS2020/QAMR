...
module FAU ( 
  ...
  nand2  g27(.a(new_n68_), .b(x04), .O(new_n69_));
  ...
  nand2  g36(.a(new_n71_), .b(new_n77_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x15), .c(x04), .O(new_n79_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n43_), .O(new_n88_));
  nand2  g47(.a(x15), .b(x04), .O(new_n89_));
  ...
  nand2  g52(.a(new_n51_), .b(new_n60_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x04), .O(new_n95_));
  nand3  g54(.a(new_n71_), .b(x17), .c(new_n43_), .O(new_n96_));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n55_), .O(z17));
  ...
  nand3  g72(.a(x20), .b(x15), .c(x04), .O(new_n114_));
