...
module FAU ( 
  ...
  nand3  g08(.a(new_n49_), .b(new_n47_), .c(x11), .O(new_n50_));
  nor2   g09(.a(new_n50_), .b(new_n43_), .O(z01));
  oai21  g10(.a(new_n49_), .b(x14), .c(x12), .O(new_n52_));
  aoi21  g11(.a(new_n52_), .b(new_n43_), .c(x11), .O(z02));
  nand3  g12(.a(new_n49_), .b(new_n47_), .c(x12), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(x11), .c(new_n43_), .O(z03));
  nand2  g14(.a(new_n45_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  oai21  g16(.a(new_n43_), .b(x11), .c(new_n57_), .O(z05));
  nand2  g17(.a(x15), .b(x11), .O(new_n59_));
  ...
  nand2  g29(.a(new_n48_), .b(new_n43_), .O(new_n71_));
  ...
  nand2  g37(.a(new_n78_), .b(x11), .O(new_n79_));
