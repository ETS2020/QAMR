...
module FAU ( 
  ...
  aoi21  g33(.a(new_n75_), .b(new_n46_), .c(new_n45_), .O(z14));
  nand3  g34(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n77_));
  nand3  g35(.a(x10), .b(x08), .c(x03), .O(new_n78_));
  and2   g36(.a(new_n78_), .b(new_n46_), .O(new_n79_));
  aoi21  g37(.a(new_n79_), .b(new_n77_), .c(new_n45_), .O(z15));
  nand2  g38(.a(new_n51_), .b(x17), .O(new_n81_));
  nand3  g39(.a(x10), .b(x08), .c(x04), .O(new_n82_));
  and2   g40(.a(new_n82_), .b(new_n46_), .O(new_n83_));
  aoi21  g41(.a(new_n83_), .b(new_n81_), .c(new_n45_), .O(z16));
