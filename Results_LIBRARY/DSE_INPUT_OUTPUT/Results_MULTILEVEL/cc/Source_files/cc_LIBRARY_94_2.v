...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(x20), .c(x15), .d(new_n51_), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z03));
  nand2  g18(.a(new_n46_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  aoi21  g20(.a(new_n43_), .b(x15), .c(new_n61_), .O(z05));
  ...
  nand2  g30(.a(new_n46_), .b(new_n51_), .O(z11));
  nand2  g31(.a(x13), .b(x12), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x20), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x15), .O(new_n75_));
  nand2  g34(.a(new_n48_), .b(x13), .O(new_n76_));
  nand2  g35(.a(x08), .b(x00), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n52_), .c(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n75_), .O(z12));
  inv1   g39(.a(x12), .O(new_n81_));
  nand2  g40(.a(new_n48_), .b(new_n51_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x20), .c(x15), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x01), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n44_), .c(x14), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(z13));
  nand2  g45(.a(new_n48_), .b(x15), .O(new_n87_));
  nand2  g46(.a(x08), .b(x02), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n52_), .c(new_n87_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n46_), .O(z14));
  nand2  g50(.a(new_n48_), .b(new_n44_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n63_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n51_), .O(new_n94_));
  nand4  g53(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n81_), .O(z15));
  oai21  g55(.a(new_n65_), .b(new_n81_), .c(x20), .O(new_n97_));
  ...
  oai21  g70(.a(new_n61_), .b(new_n81_), .c(x20), .O(new_n112_));
  ...
  aoi21  g78(.a(new_n48_), .b(new_n43_), .c(new_n119_), .O(new_n120_));
  nand2  g79(.a(new_n48_), .b(x20), .O(new_n121_));
  nand2  g80(.a(new_n121_), .b(new_n44_), .O(new_n122_));
  oai21  g81(.a(new_n122_), .b(new_n120_), .c(x12), .O(new_n123_));
  nand2  g82(.a(new_n123_), .b(new_n46_), .O(z19));
endmodule
