...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x02), .c(new_n46_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(new_n46_), .b(x02), .c(x14), .O(new_n51_));
  ...
  aoi21  g17(.a(new_n58_), .b(x02), .c(new_n46_), .O(z03));
  ...
  nand2  g35(.a(new_n76_), .b(x02), .O(new_n77_));
  ...
  oai21  g40(.a(new_n57_), .b(new_n46_), .c(new_n52_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x12), .c(x02), .O(new_n83_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(x02), .O(new_n97_));
  ...
  nand3  g69(.a(x19), .b(x15), .c(x02), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n70_), .O(z18));
  nand2  g71(.a(new_n56_), .b(x20), .O(new_n113_));
  ...
  nand3  g75(.a(x20), .b(x15), .c(x02), .O(new_n117_));
