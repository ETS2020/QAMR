...
module FAU ( 
  ...
  nor2   g03(.a(x12), .b(new_n44_), .O(new_n45_));
  ...
  oai21  g36(.a(new_n48_), .b(new_n44_), .c(x14), .O(new_n78_));
  ...
  aoi22  g50(.a(new_n91_), .b(new_n75_), .c(new_n53_), .d(x17), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n72_), .c(new_n47_), .O(z16));
  nand2  g52(.a(new_n53_), .b(x18), .O(new_n94_));
  nand3  g53(.a(new_n75_), .b(x08), .c(x05), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n72_), .O(z17));
  nand2  g55(.a(new_n53_), .b(x19), .O(new_n97_));
  nand3  g56(.a(new_n75_), .b(x08), .c(x06), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n72_), .O(z18));
  nand2  g58(.a(new_n53_), .b(x20), .O(new_n100_));
  nand3  g59(.a(new_n75_), .b(x08), .c(x07), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n72_), .O(z19));
endmodule
