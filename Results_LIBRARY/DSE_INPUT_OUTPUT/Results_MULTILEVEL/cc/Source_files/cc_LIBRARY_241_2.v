...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(x20), .c(new_n44_), .O(z03));
  nand2  g15(.a(new_n46_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  aoi21  g17(.a(new_n43_), .b(x15), .c(new_n58_), .O(z05));
  nor2   g18(.a(new_n43_), .b(new_n44_), .O(z06));
  ...
  nand2  g26(.a(new_n46_), .b(new_n50_), .O(z11));
  ...
  nand2  g32(.a(new_n48_), .b(new_n50_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(x20), .c(x15), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n69_), .O(z13));
  nand2  g37(.a(new_n48_), .b(x15), .O(new_n79_));
  nand4  g38(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n80_));
  ...
  nand3  g61(.a(x20), .b(x18), .c(x15), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n69_), .O(z17));
  oai21  g63(.a(new_n58_), .b(new_n69_), .c(x20), .O(new_n105_));
  ...
  nand2  g70(.a(new_n51_), .b(new_n43_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x07), .O(new_n113_));
  nand2  g72(.a(new_n51_), .b(x20), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n69_), .O(z19));
endmodule
