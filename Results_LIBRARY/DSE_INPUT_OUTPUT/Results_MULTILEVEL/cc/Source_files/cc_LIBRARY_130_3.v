...
module FAU ( 
  ...
  nand4  g08(.a(new_n49_), .b(x10), .c(new_n44_), .d(x08), .O(new_n50_));
  ...
  nand2  g32(.a(new_n57_), .b(x13), .O(new_n74_));
  ...
  nand2  g49(.a(new_n57_), .b(new_n45_), .O(new_n91_));
  nand2  g50(.a(x15), .b(new_n44_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n64_), .b(new_n90_), .c(new_n44_), .O(new_n97_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n90_), .O(z17));
  oai21  g68(.a(new_n62_), .b(new_n90_), .c(new_n44_), .O(new_n110_));
  ...
  oai21  g75(.a(new_n43_), .b(new_n90_), .c(new_n44_), .O(new_n117_));
