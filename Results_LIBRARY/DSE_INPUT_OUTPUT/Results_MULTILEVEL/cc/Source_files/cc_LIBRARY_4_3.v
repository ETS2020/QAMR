...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n54_, new_n56_, new_n60_, new_n62_, new_n65_, new_n67_,
  ...
  nand2  g32(.a(new_n50_), .b(x02), .O(new_n75_));
  aoi21  g33(.a(new_n75_), .b(new_n45_), .c(new_n48_), .O(z14));
  nand3  g34(.a(new_n46_), .b(x16), .c(new_n65_), .O(new_n77_));
  ...
  nand2  g39(.a(new_n46_), .b(x17), .O(new_n82_));
  aoi21  g40(.a(new_n50_), .b(x04), .c(x15), .O(new_n83_));
  aoi21  g41(.a(new_n83_), .b(new_n82_), .c(new_n48_), .O(z16));
  ...
  aoi21  g48(.a(new_n50_), .b(x06), .c(x15), .O(new_n91_));
  aoi21  g49(.a(new_n91_), .b(new_n90_), .c(new_n48_), .O(z18));
