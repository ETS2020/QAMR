...
module FAU ( 
  ...
  oai21  g31(.a(new_n72_), .b(new_n43_), .c(new_n45_), .O(z12));
  ...
  nand3  g41(.a(new_n53_), .b(x16), .c(new_n48_), .O(new_n83_));
  ...
  nand3  g50(.a(new_n70_), .b(x08), .c(x05), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n43_), .O(z17));
  and2   g52(.a(x08), .b(x06), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n70_), .c(new_n53_), .d(x19), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n43_), .c(new_n45_), .O(z18));
  and2   g55(.a(x08), .b(x07), .O(new_n97_));
  aoi22  g56(.a(new_n97_), .b(new_n70_), .c(new_n53_), .d(x20), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n43_), .c(new_n45_), .O(z19));
  buf    g58(.a(x16), .O(z08));
endmodule
