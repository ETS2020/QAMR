...
module FAU ( 
  ...
  nand3  g31(.a(x18), .b(new_n53_), .c(x10), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(x08), .c(x00), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n72_), .c(new_n58_), .O(z12));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n58_), .O(z13));
  nand2  g39(.a(x08), .b(x02), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n54_), .c(new_n48_), .d(new_n53_), .O(new_n82_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n58_), .O(z16));
  ...
  nand2  g52(.a(new_n93_), .b(new_n51_), .O(z17));
  ...
  nand4  g60(.a(new_n53_), .b(x10), .c(x08), .d(x07), .O(new_n102_));
