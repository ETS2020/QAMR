...
module FAU ( 
  ...
  oai21  g32(.a(new_n73_), .b(x13), .c(x00), .O(new_n74_));
  ...
  nand3  g37(.a(new_n78_), .b(x14), .c(x00), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n72_), .O(z13));
  ...
  nand2  g43(.a(new_n84_), .b(new_n58_), .O(z14));
  ...
  nand2  g51(.a(new_n92_), .b(x00), .O(new_n93_));
  ...
  oai22  g61(.a(new_n102_), .b(new_n81_), .c(new_n48_), .d(new_n62_), .O(new_n103_));
  ...
  oai22  g66(.a(new_n107_), .b(new_n81_), .c(new_n48_), .d(new_n43_), .O(new_n108_));
