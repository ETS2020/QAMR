...
module FAU ( 
  ...
  nand3  g26(.a(new_n46_), .b(x09), .c(x08), .O(new_n68_));
  ...
  nand2  g38(.a(new_n73_), .b(new_n48_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x15), .c(new_n43_), .O(new_n81_));
  ...
  oai21  g51(.a(new_n64_), .b(new_n72_), .c(new_n43_), .O(new_n93_));
  ...
  nand2  g58(.a(new_n73_), .b(x18), .O(new_n100_));
  ...
  oai21  g64(.a(new_n60_), .b(new_n72_), .c(new_n43_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n73_), .b(x19), .O(new_n108_));
  ...
  nand2  g71(.a(new_n73_), .b(x20), .O(new_n113_));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n72_), .O(z19));
endmodule
