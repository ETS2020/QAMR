...
module FAU ( 
  ...
  nand4  g29(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(x15), .O(z14));
  ...
  and2   g38(.a(new_n79_), .b(new_n46_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n45_), .O(z16));
  nand2  g40(.a(new_n51_), .b(x18), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x05), .O(new_n83_));
  ...
  nand3  g53(.a(new_n94_), .b(new_n46_), .c(x12), .O(new_n95_));
