...
module FAU ( 
  ...
  nor2   g20(.a(new_n59_), .b(new_n51_), .O(z06));
  ...
  aoi21  g26(.a(x09), .b(x08), .c(new_n59_), .O(z10));
  ...
  nand3  g50(.a(new_n80_), .b(x08), .c(x05), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n43_), .O(z17));
  and2   g52(.a(x08), .b(x06), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n80_), .c(new_n52_), .d(x19), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n43_), .c(new_n44_), .O(z18));
  and2   g55(.a(x08), .b(x07), .O(new_n97_));
  aoi22  g56(.a(new_n97_), .b(new_n80_), .c(new_n52_), .d(x20), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n43_), .c(new_n44_), .O(z19));
endmodule
