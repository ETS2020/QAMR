...
module FAU ( 
  ...
  nor4   g16(.a(new_n47_), .b(new_n45_), .c(x14), .d(new_n57_), .O(z03));
  ...
  nand2  g25(.a(new_n46_), .b(x09), .O(new_n67_));
  ...
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(z12));
  ...
  oai21  g47(.a(new_n71_), .b(x15), .c(x17), .O(new_n89_));
  ...
  nand4  g61(.a(new_n52_), .b(x10), .c(x08), .d(x07), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n57_), .O(z19));
  buf    g63(.a(x15), .O(z06));
endmodule
