...
module FAU ( 
  ...
  oai21  g16(.a(new_n47_), .b(x12), .c(new_n57_), .O(z05));
  ...
  nand2  g32(.a(new_n68_), .b(new_n48_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x15), .O(new_n75_));
  inv1   g34(.a(x01), .O(new_n76_));
  oai21  g35(.a(new_n68_), .b(new_n76_), .c(x14), .O(new_n77_));
