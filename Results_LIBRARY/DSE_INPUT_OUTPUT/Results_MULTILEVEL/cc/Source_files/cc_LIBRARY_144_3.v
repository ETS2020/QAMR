...
module FAU ( 
  ...
  oai21  g63(.a(new_n59_), .b(new_n68_), .c(new_n44_), .O(new_n105_));
  ...
  nand2  g74(.a(new_n115_), .b(new_n49_), .O(z19));
  buf    g75(.a(x15), .O(z06));
endmodule
