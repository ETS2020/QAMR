...
module FAU ( 
  ...
  nand3  g38(.a(new_n79_), .b(x14), .c(x10), .O(new_n80_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n51_), .O(z15));
  nand3  g48(.a(new_n52_), .b(x08), .c(x04), .O(new_n90_));
  nand2  g49(.a(x17), .b(new_n66_), .O(new_n91_));
  ...
  nand3  g54(.a(new_n52_), .b(x08), .c(x05), .O(new_n96_));
  nand2  g55(.a(x18), .b(new_n66_), .O(new_n97_));
  ...
  nand3  g60(.a(x12), .b(x08), .c(x06), .O(new_n102_));
  ...
  nand3  g65(.a(x12), .b(x08), .c(x07), .O(new_n107_));
