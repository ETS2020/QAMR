...
module FAU ( 
  ...
  oai21  g36(.a(new_n77_), .b(new_n56_), .c(new_n50_), .O(z13));
  ...
  nand2  g41(.a(new_n82_), .b(new_n50_), .O(z14));
  nand2  g42(.a(new_n57_), .b(new_n44_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n51_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x16), .c(new_n47_), .O(new_n86_));
  nand3  g45(.a(new_n44_), .b(new_n51_), .c(x10), .O(new_n87_));
  ...
  nand2  g49(.a(new_n85_), .b(x17), .O(new_n91_));
  ...
  nand2  g60(.a(new_n101_), .b(new_n50_), .O(z18));
