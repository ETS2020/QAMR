...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n61_, new_n64_, new_n66_, new_n68_, new_n72_, new_n74_, new_n75_,
  ...
  nand2  g23(.a(new_n52_), .b(new_n64_), .O(z07));
  ...
  nand3  g30(.a(new_n54_), .b(x13), .c(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n52_), .O(z12));
  inv1   g32(.a(x12), .O(new_n74_));
  oai21  g33(.a(new_n49_), .b(x14), .c(x15), .O(new_n75_));
  nand2  g34(.a(new_n49_), .b(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x14), .c(new_n44_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(z13));
  nand2  g37(.a(new_n48_), .b(x15), .O(new_n79_));
  inv1   g38(.a(new_n54_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x02), .c(new_n44_), .O(new_n81_));
  ...
  nand2  g43(.a(new_n84_), .b(new_n53_), .O(new_n85_));
  ...
  nand3  g49(.a(new_n54_), .b(x17), .c(x12), .O(new_n91_));
