...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n59_, new_n60_, new_n62_,
  ...
  nor2   g19(.a(new_n60_), .b(new_n59_), .O(z08));
  inv1   g20(.a(x08), .O(new_n62_));
  nand2  g21(.a(new_n44_), .b(x09), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n62_), .O(z09));
  aoi21  g23(.a(x09), .b(x08), .c(new_n60_), .O(z10));
  nor2   g24(.a(new_n60_), .b(new_n50_), .O(z11));
  ...
  nand2  g30(.a(new_n48_), .b(new_n50_), .O(new_n72_));
  ...
  oai21  g40(.a(new_n59_), .b(x14), .c(x12), .O(new_n82_));
  ...
  nand3  g54(.a(new_n69_), .b(x08), .c(x06), .O(new_n96_));
