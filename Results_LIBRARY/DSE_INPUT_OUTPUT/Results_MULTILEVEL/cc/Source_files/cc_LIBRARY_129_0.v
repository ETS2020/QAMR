...
module FAU ( 
  ...
  oai21  g33(.a(new_n73_), .b(new_n71_), .c(new_n74_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n46_), .O(z12));
  aoi21  g36(.a(x14), .b(x12), .c(new_n51_), .O(new_n78_));
  aoi21  g37(.a(new_n47_), .b(new_n48_), .c(new_n51_), .O(new_n79_));
  aoi21  g38(.a(x10), .b(x01), .c(new_n48_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(x12), .O(new_n81_));
  oai21  g40(.a(new_n78_), .b(x08), .c(new_n81_), .O(z13));
  ...
  nand3  g49(.a(new_n51_), .b(x10), .c(x04), .O(new_n91_));
  nand2  g50(.a(x17), .b(new_n72_), .O(new_n92_));
  ...
  nand3  g55(.a(x12), .b(x10), .c(x05), .O(new_n97_));
  ...
  nand3  g65(.a(new_n51_), .b(x10), .c(x07), .O(new_n107_));
  nand2  g66(.a(x20), .b(new_n72_), .O(new_n108_));
