...
module FAU ( 
  ...
  nand2  g11(.a(new_n48_), .b(x10), .O(new_n53_));
  ...
  nand4  g15(.a(new_n49_), .b(x12), .c(x10), .d(x08), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x01), .c(new_n48_), .O(z03));
  ...
  nor2   g24(.a(new_n65_), .b(new_n52_), .O(z09));
  ...
  nor2   g29(.a(new_n48_), .b(new_n44_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n70_), .c(x13), .O(new_n72_));
  nand4  g31(.a(new_n48_), .b(x10), .c(x08), .d(x00), .O(new_n73_));
  ...
  nand3  g35(.a(new_n76_), .b(x15), .c(x01), .O(new_n77_));
  ...
  oai21  g52(.a(new_n61_), .b(new_n69_), .c(x01), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x15), .O(new_n95_));
  nand2  g54(.a(new_n75_), .b(x17), .O(new_n96_));
  ...
  nand2  g59(.a(new_n75_), .b(x18), .O(new_n101_));
  ...
  nand3  g63(.a(x18), .b(x15), .c(x01), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n69_), .O(z17));
  nand2  g65(.a(new_n75_), .b(x19), .O(new_n107_));
  nand3  g66(.a(x10), .b(x08), .c(x06), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n48_), .O(new_n110_));
  nand3  g69(.a(x19), .b(x15), .c(x01), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n69_), .O(z18));
  oai21  g71(.a(new_n43_), .b(new_n69_), .c(x01), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x15), .O(new_n114_));
  nand2  g73(.a(new_n75_), .b(x20), .O(new_n115_));
