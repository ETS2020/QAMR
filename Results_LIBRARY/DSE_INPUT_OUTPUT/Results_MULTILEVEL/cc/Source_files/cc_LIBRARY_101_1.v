...
module FAU ( 
  ...
  nand2  g33(.a(new_n74_), .b(x05), .O(new_n75_));
  ...
  nand3  g47(.a(new_n80_), .b(x16), .c(new_n47_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n80_), .b(x17), .O(new_n94_));
  ...
  nand3  g61(.a(new_n80_), .b(x18), .c(new_n44_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n69_), .O(z17));
  oai21  g63(.a(new_n58_), .b(new_n69_), .c(x05), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n80_), .b(x19), .O(new_n107_));
  ...
  oai21  g70(.a(new_n43_), .b(new_n69_), .c(x05), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x15), .O(new_n113_));
  nand2  g72(.a(new_n80_), .b(x20), .O(new_n114_));
