...
module FAU ( 
  ...
  nand3  g38(.a(new_n79_), .b(x15), .c(new_n44_), .O(new_n80_));
  ...
  nand3  g42(.a(x12), .b(x10), .c(x08), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n45_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x02), .O(new_n86_));
  nand3  g45(.a(new_n72_), .b(x15), .c(x12), .O(new_n87_));
  ...
  nand3  g50(.a(new_n72_), .b(x16), .c(new_n49_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n61_), .b(new_n78_), .c(new_n44_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n72_), .b(x17), .O(new_n99_));
  nand4  g58(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n100_));
  ...
  oai21  g70(.a(new_n59_), .b(new_n78_), .c(new_n44_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x15), .O(new_n113_));
  nand2  g72(.a(new_n72_), .b(x19), .O(new_n114_));
  nand4  g73(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n115_));
  ...
  oai21  g77(.a(new_n43_), .b(new_n78_), .c(new_n44_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x15), .O(new_n120_));
  nand2  g79(.a(new_n72_), .b(x20), .O(new_n121_));
  nand4  g80(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n122_));
