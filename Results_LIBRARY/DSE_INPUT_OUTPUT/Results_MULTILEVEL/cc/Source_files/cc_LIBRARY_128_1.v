...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n65_, new_n69_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  nor2   g11(.a(x17), .b(x15), .O(new_n53_));
  ...
  nor4   g17(.a(new_n47_), .b(new_n43_), .c(x14), .d(new_n58_), .O(z03));
  ...
  oai21  g33(.a(new_n52_), .b(x14), .c(x15), .O(new_n75_));
  nand2  g34(.a(new_n52_), .b(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n69_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n58_), .O(z13));
  nand2  g37(.a(new_n47_), .b(x15), .O(new_n79_));
  nand4  g38(.a(new_n53_), .b(x10), .c(x08), .d(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n58_), .O(z14));
  nand3  g40(.a(new_n71_), .b(x16), .c(new_n48_), .O(new_n82_));
  nand4  g41(.a(new_n53_), .b(x10), .c(x08), .d(x03), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n58_), .O(z15));
  nand4  g43(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n69_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z16));
  nand2  g47(.a(new_n47_), .b(x18), .O(new_n89_));
  nand4  g48(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n90_));
  ...
  nand4  g60(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n69_), .O(new_n104_));
  nand2  g63(.a(x20), .b(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n58_), .O(z19));
  buf    g65(.a(x17), .O(z07));
endmodule
