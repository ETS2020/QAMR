...
module FAU ( 
  ...
  nor2   g24(.a(new_n45_), .b(new_n50_), .O(z11));
  inv1   g25(.a(x12), .O(new_n67_));
  aoi21  g26(.a(x10), .b(x08), .c(x15), .O(new_n68_));
  nor2   g27(.a(new_n44_), .b(new_n42_), .O(new_n69_));
  ...
  aoi21  g32(.a(new_n73_), .b(new_n70_), .c(new_n67_), .O(z12));
  nand3  g33(.a(new_n51_), .b(x15), .c(x11), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n67_), .O(z13));
  nand3  g37(.a(new_n48_), .b(x15), .c(x11), .O(new_n79_));
  nand3  g38(.a(new_n72_), .b(x08), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n67_), .O(z14));
  nand3  g40(.a(x16), .b(new_n50_), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x11), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand3  g43(.a(new_n48_), .b(x16), .c(new_n50_), .O(new_n85_));
  nand4  g44(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  ...
  nand3  g52(.a(x17), .b(x15), .c(x11), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n67_), .O(z16));
  ...
  nand3  g58(.a(x18), .b(x15), .c(x11), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n67_), .O(z17));
  oai21  g60(.a(new_n57_), .b(new_n67_), .c(x11), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n48_), .b(x19), .O(new_n104_));
  nand4  g63(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n105_));
  ...
  oai21  g67(.a(new_n43_), .b(new_n67_), .c(x11), .O(new_n109_));
