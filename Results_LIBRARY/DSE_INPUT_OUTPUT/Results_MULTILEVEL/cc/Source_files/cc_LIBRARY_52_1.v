...
module FAU ( 
  ...
  nand2  g28(.a(new_n69_), .b(x06), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x15), .O(new_n71_));
  nand2  g30(.a(new_n54_), .b(x13), .O(new_n72_));
  ...
  nand2  g36(.a(new_n77_), .b(x06), .O(new_n78_));
  ...
  nand3  g42(.a(new_n54_), .b(x15), .c(x06), .O(new_n84_));
  ...
  nand2  g47(.a(new_n54_), .b(new_n43_), .O(new_n89_));
  nand2  g48(.a(x15), .b(x06), .O(new_n90_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n83_), .O(z15));
  oai21  g53(.a(new_n61_), .b(new_n83_), .c(x06), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n54_), .b(x17), .O(new_n97_));
  nand4  g56(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n96_), .O(z16));
  nand2  g60(.a(new_n54_), .b(x18), .O(new_n102_));
  ...
  nand3  g64(.a(x18), .b(x15), .c(x06), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n83_), .O(z17));
  nand2  g66(.a(new_n50_), .b(new_n59_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x06), .O(new_n109_));
  nand3  g68(.a(new_n54_), .b(x19), .c(new_n43_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n83_), .O(z18));
  nand2  g70(.a(new_n54_), .b(x20), .O(new_n112_));
  ...
  nand3  g74(.a(x20), .b(x15), .c(x06), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n83_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
