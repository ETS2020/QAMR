...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x04), .c(new_n43_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(new_n43_), .b(x04), .c(x14), .O(new_n51_));
  ...
  nand2  g30(.a(x15), .b(x04), .O(new_n72_));
  ...
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n69_), .O(z12));
  ...
  nand3  g52(.a(new_n70_), .b(x17), .c(new_n43_), .O(new_n94_));
  ...
  oai21  g62(.a(new_n59_), .b(new_n69_), .c(x04), .O(new_n104_));
  ...
  nand2  g69(.a(new_n70_), .b(x20), .O(new_n111_));
  ...
  nand3  g73(.a(x20), .b(x15), .c(x04), .O(new_n115_));
