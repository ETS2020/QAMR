...
module FAU ( 
  ...
  and2   g22(.a(new_n48_), .b(x16), .O(z08));
  ...
  nand2  g45(.a(new_n86_), .b(new_n48_), .O(z14));
  nand3  g46(.a(x16), .b(new_n54_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand3  g49(.a(new_n46_), .b(x16), .c(new_n54_), .O(new_n91_));
  ...
  nand3  g59(.a(new_n44_), .b(x17), .c(x15), .O(new_n101_));
  ...
  oai21  g69(.a(new_n61_), .b(new_n96_), .c(new_n44_), .O(new_n111_));
  ...
  nand2  g80(.a(new_n121_), .b(new_n48_), .O(z19));
  buf    g81(.a(x15), .O(z06));
endmodule
