...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n63_, new_n64_, new_n66_, new_n68_, new_n72_, new_n73_, new_n74_,
  ...
  oai21  g08(.a(x18), .b(new_n44_), .c(x14), .O(new_n50_));
  ...
  aoi21  g19(.a(z04), .b(x15), .c(new_n60_), .O(z05));
  nor2   g20(.a(z04), .b(new_n44_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  inv1   g22(.a(new_n45_), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n63_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nand2  g25(.a(new_n64_), .b(new_n66_), .O(z08));
  nand2  g26(.a(x09), .b(x08), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n64_), .O(z09));
  inv1   g28(.a(z09), .O(z10));
  nand2  g29(.a(new_n64_), .b(new_n47_), .O(z11));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n72_), .O(z16));
  nand2  g60(.a(new_n51_), .b(z04), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x05), .O(new_n103_));
  nand2  g62(.a(new_n51_), .b(x18), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n72_), .O(z17));
  oai21  g64(.a(new_n60_), .b(new_n72_), .c(x18), .O(new_n106_));
  ...
  oai21  g71(.a(new_n43_), .b(new_n72_), .c(x18), .O(new_n113_));
