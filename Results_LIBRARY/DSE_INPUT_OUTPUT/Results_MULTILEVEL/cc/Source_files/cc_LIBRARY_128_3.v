...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n64_, new_n68_, new_n69_, new_n70_, new_n71_, new_n72_,
  ...
  aoi21  g19(.a(x17), .b(x15), .c(x18), .O(z04));
  ...
  nand3  g36(.a(new_n77_), .b(new_n46_), .c(x15), .O(new_n78_));
  ...
  nand3  g40(.a(new_n69_), .b(new_n46_), .c(x15), .O(new_n82_));
  nand3  g41(.a(new_n74_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n68_), .O(z14));
  nand3  g43(.a(new_n72_), .b(x16), .c(new_n47_), .O(new_n85_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n42_), .O(z16));
  ...
  nand2  g57(.a(new_n69_), .b(x19), .O(new_n99_));
  ...
  nand2  g63(.a(new_n69_), .b(x20), .O(new_n105_));
  ...
  nand3  g67(.a(x20), .b(new_n46_), .c(x15), .O(new_n109_));
