...
module FAU ( 
  ...
  nand2  g31(.a(new_n72_), .b(x01), .O(new_n73_));
  ...
  oai22  g52(.a(new_n93_), .b(new_n82_), .c(new_n81_), .d(new_n63_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x01), .O(new_n95_));
  ...
  oai22  g63(.a(new_n104_), .b(new_n82_), .c(new_n81_), .d(new_n61_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x01), .O(new_n106_));
  nand2  g65(.a(x19), .b(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n58_), .O(z18));
  nand4  g67(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x01), .O(new_n110_));
