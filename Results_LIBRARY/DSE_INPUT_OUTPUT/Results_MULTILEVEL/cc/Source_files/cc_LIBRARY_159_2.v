...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n64_, new_n68_, new_n69_, new_n71_, new_n72_, new_n74_, new_n75_,
    new_n77_, new_n79_, new_n81_;
  ...
  oai21  g29(.a(x15), .b(new_n54_), .c(x14), .O(new_n71_));
  nand3  g30(.a(x15), .b(x10), .c(x08), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n68_), .O(z13));
  ...
  oai21  g37(.a(x15), .b(new_n54_), .c(x17), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n68_), .O(z16));
  nand2  g39(.a(x18), .b(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z17));
  oai21  g41(.a(new_n57_), .b(new_n68_), .c(new_n45_), .O(z18));
  oai21  g42(.a(new_n43_), .b(new_n68_), .c(new_n45_), .O(z19));
  buf    g43(.a(x15), .O(z06));
endmodule
