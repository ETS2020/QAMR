...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n52_, new_n55_, new_n56_, new_n57_, new_n59_, new_n61_, new_n63_,
  ...
  nor3   g11(.a(new_n52_), .b(new_n43_), .c(x14), .O(z03));
  ...
  nor3   g28(.a(new_n69_), .b(new_n43_), .c(new_n56_), .O(z13));
  nand3  g29(.a(x15), .b(x10), .c(x08), .O(new_n71_));
  and2   g30(.a(new_n71_), .b(x12), .O(z14));
  nand2  g31(.a(x16), .b(new_n46_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x15), .c(new_n56_), .O(z15));
  aoi21  g33(.a(new_n59_), .b(x15), .c(new_n56_), .O(z16));
