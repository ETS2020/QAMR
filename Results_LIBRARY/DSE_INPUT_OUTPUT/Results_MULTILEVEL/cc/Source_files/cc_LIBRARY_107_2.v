...
module FAU ( 
  ...
  nand4  g15(.a(new_n56_), .b(x20), .c(x15), .d(new_n50_), .O(new_n57_));
  ...
  nand2  g29(.a(new_n46_), .b(new_n50_), .O(z11));
  ...
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n50_), .O(new_n94_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n91_), .O(z16));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n91_), .O(z17));
