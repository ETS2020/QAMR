...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n61_, new_n63_, new_n65_, new_n67_, new_n68_, new_n71_, new_n72_,
  ...
  nand2  g07(.a(x15), .b(new_n44_), .O(new_n49_));
  oai21  g08(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(z01));
  nand2  g09(.a(x15), .b(x14), .O(new_n51_));
  nor2   g10(.a(x15), .b(x14), .O(new_n52_));
  ...
  nor4   g17(.a(new_n48_), .b(new_n58_), .c(x14), .d(new_n57_), .O(z03));
  ...
  nand2  g31(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  nand3  g32(.a(new_n58_), .b(x10), .c(x08), .O(new_n74_));
