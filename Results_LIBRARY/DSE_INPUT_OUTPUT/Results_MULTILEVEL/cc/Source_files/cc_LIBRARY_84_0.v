...
module FAU ( 
  ...
  oai22  g11(.a(z06), .b(new_n46_), .c(new_n43_), .d(new_n47_), .O(new_n53_));
  ...
  nand4  g50(.a(new_n91_), .b(x16), .c(new_n47_), .d(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n88_), .O(z15));
  nor2   g52(.a(new_n65_), .b(x04), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  ...
  nand3  g65(.a(new_n91_), .b(x19), .c(x12), .O(new_n107_));
