...
module FAU ( 
  ...
  nand2  g29(.a(new_n52_), .b(new_n47_), .O(z11));
  ...
  nand4  g39(.a(new_n53_), .b(x10), .c(x08), .d(x02), .O(new_n81_));
  oai21  g40(.a(new_n49_), .b(new_n53_), .c(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n52_), .O(z14));
  ...
  nand4  g46(.a(new_n54_), .b(x16), .c(new_n47_), .d(x12), .O(new_n88_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n58_), .O(z16));
  nand3  g54(.a(new_n54_), .b(x18), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n52_), .O(z17));
  nand4  g56(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n44_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  nand3  g59(.a(new_n54_), .b(x19), .c(x12), .O(new_n101_));
  ...
  nand3  g64(.a(new_n54_), .b(x20), .c(x12), .O(new_n106_));
