...
module FAU ( 
  ...
  and2   g21(.a(new_n52_), .b(x16), .O(z08));
  ...
  nand3  g48(.a(new_n54_), .b(x16), .c(new_n46_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n61_), .b(new_n76_), .c(new_n45_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n54_), .b(x17), .O(new_n97_));
  nand4  g56(.a(new_n42_), .b(x10), .c(x08), .d(x04), .O(new_n98_));
  ...
  nand3  g64(.a(x18), .b(x15), .c(new_n45_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n76_), .O(z17));
  oai21  g66(.a(new_n59_), .b(new_n76_), .c(new_n45_), .O(new_n108_));
  ...
  nand2  g74(.a(new_n115_), .b(new_n45_), .O(new_n116_));
