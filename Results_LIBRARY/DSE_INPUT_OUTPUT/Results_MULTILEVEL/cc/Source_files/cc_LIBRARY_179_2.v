...
module FAU ( 
  ...
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n57_), .O(z12));
  nand2  g35(.a(new_n48_), .b(new_n49_), .O(new_n77_));
  ...
  nand3  g44(.a(new_n48_), .b(x16), .c(new_n49_), .O(new_n86_));
  ...
  nand3  g48(.a(x16), .b(x15), .c(new_n49_), .O(new_n90_));
  ...
  aoi21  g56(.a(new_n48_), .b(new_n44_), .c(x15), .O(new_n98_));
  nor3   g57(.a(new_n98_), .b(new_n97_), .c(new_n57_), .O(z17));
