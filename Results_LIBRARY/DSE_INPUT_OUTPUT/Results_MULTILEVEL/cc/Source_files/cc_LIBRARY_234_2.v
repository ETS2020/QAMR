...
module FAU ( 
  ...
  nand3  g44(.a(new_n56_), .b(x19), .c(x15), .O(new_n86_));
  inv1   g45(.a(new_n52_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x08), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n85_), .O(z14));
  nand2  g48(.a(new_n56_), .b(new_n44_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n87_), .b(x08), .c(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n85_), .O(z15));
  ...
  nand3  g58(.a(x19), .b(x17), .c(x15), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n85_), .O(z16));
  ...
  aoi21  g69(.a(new_n56_), .b(new_n61_), .c(new_n110_), .O(new_n111_));
  nand2  g70(.a(new_n56_), .b(x19), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n44_), .O(new_n113_));
  oai21  g72(.a(new_n113_), .b(new_n111_), .c(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n50_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n85_), .c(x19), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n56_), .b(x20), .O(new_n118_));
  nand2  g77(.a(x08), .b(x07), .O(new_n119_));
  oai21  g78(.a(new_n119_), .b(new_n52_), .c(new_n118_), .O(new_n120_));
