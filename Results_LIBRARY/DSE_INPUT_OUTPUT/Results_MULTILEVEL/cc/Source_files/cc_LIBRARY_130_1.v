...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n51_,
  ...
  nor4   g08(.a(z10), .b(new_n44_), .c(x14), .d(new_n48_), .O(z01));
  ...
  nand3  g17(.a(new_n58_), .b(new_n52_), .c(x12), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(x09), .c(new_n44_), .O(z03));
  ...
  nand2  g37(.a(new_n78_), .b(x09), .O(new_n79_));
  ...
  nand2  g48(.a(new_n57_), .b(new_n44_), .O(new_n90_));
  nand2  g49(.a(x15), .b(x09), .O(new_n91_));
  ...
  oai21  g54(.a(new_n64_), .b(new_n89_), .c(x09), .O(new_n96_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n89_), .O(z17));
  oai21  g67(.a(new_n62_), .b(new_n89_), .c(x09), .O(new_n109_));
  ...
  oai21  g74(.a(new_n43_), .b(new_n89_), .c(x09), .O(new_n116_));
