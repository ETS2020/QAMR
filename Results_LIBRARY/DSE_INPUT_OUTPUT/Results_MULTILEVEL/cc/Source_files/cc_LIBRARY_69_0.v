...
module FAU ( 
  ...
  nand2  g32(.a(new_n46_), .b(new_n47_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x15), .O(new_n75_));
  inv1   g34(.a(x01), .O(new_n76_));
  oai21  g35(.a(new_n46_), .b(new_n76_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n56_), .O(z13));
  nand3  g37(.a(new_n46_), .b(x15), .c(x12), .O(new_n79_));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n46_), .b(new_n80_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n79_), .O(z14));
  ...
  nand3  g51(.a(new_n71_), .b(x08), .c(x05), .O(new_n93_));
  ...
  nand3  g59(.a(new_n71_), .b(x08), .c(x07), .O(new_n101_));
