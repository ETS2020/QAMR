...
module FAU ( 
  ...
  nand2  g19(.a(new_n49_), .b(new_n60_), .O(z07));
  inv1   g20(.a(x16), .O(new_n62_));
  nand2  g21(.a(new_n49_), .b(new_n62_), .O(z08));
  nand2  g22(.a(x09), .b(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n49_), .O(z09));
  inv1   g24(.a(z09), .O(z10));
  nand2  g25(.a(new_n49_), .b(new_n50_), .O(z11));
  inv1   g26(.a(x05), .O(new_n68_));
  aoi21  g27(.a(x13), .b(x12), .c(new_n68_), .O(new_n69_));
  ...
  aoi22  g32(.a(new_n73_), .b(new_n71_), .c(new_n72_), .d(x13), .O(new_n74_));
  oai22  g33(.a(new_n74_), .b(new_n55_), .c(new_n69_), .d(new_n44_), .O(z12));
  nand2  g34(.a(new_n72_), .b(new_n50_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x15), .c(x05), .O(new_n77_));
  inv1   g36(.a(new_n72_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n44_), .c(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n77_), .c(new_n55_), .O(z13));
  nand2  g40(.a(new_n44_), .b(x10), .O(new_n82_));
  nand2  g41(.a(x08), .b(x02), .O(new_n83_));
  oai22  g42(.a(new_n83_), .b(new_n82_), .c(new_n78_), .d(new_n44_), .O(new_n84_));
  ...
  nand3  g48(.a(new_n72_), .b(x16), .c(new_n50_), .O(new_n90_));
  nand2  g49(.a(x08), .b(x03), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n82_), .c(new_n90_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n72_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(new_n98_));
  nand3  g57(.a(x17), .b(x15), .c(x05), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n55_), .O(z16));
  inv1   g59(.a(x18), .O(new_n101_));
  aoi21  g60(.a(new_n51_), .b(new_n101_), .c(new_n68_), .O(new_n102_));
  and2   g61(.a(new_n51_), .b(x18), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n49_), .O(z17));
  inv1   g64(.a(x06), .O(new_n106_));
  nand2  g65(.a(new_n72_), .b(x19), .O(new_n107_));
  oai21  g66(.a(new_n72_), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n44_), .O(new_n109_));
  nand3  g68(.a(x19), .b(x15), .c(x05), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n55_), .O(z18));
  aoi21  g70(.a(x20), .b(x12), .c(new_n68_), .O(new_n112_));
  and2   g71(.a(x08), .b(x07), .O(new_n113_));
  aoi22  g72(.a(new_n113_), .b(new_n71_), .c(new_n72_), .d(x20), .O(new_n114_));
  oai22  g73(.a(new_n114_), .b(new_n55_), .c(new_n112_), .d(new_n44_), .O(z19));
  buf    g74(.a(x15), .O(z06));
endmodule
