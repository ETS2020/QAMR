...
module FAU ( 
  ...
  and2   g19(.a(new_n44_), .b(x19), .O(z05));
  inv1   g20(.a(new_n53_), .O(z06));
  ...
  aoi22  g27(.a(x18), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  nand2  g28(.a(new_n44_), .b(new_n46_), .O(z11));
  inv1   g29(.a(x12), .O(new_n71_));
  nand2  g30(.a(new_n47_), .b(z04), .O(new_n72_));
  ...
  nand3  g37(.a(new_n78_), .b(z04), .c(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n71_), .O(z13));
  nand4  g39(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n81_));
  oai21  g40(.a(new_n48_), .b(new_n43_), .c(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n44_), .O(z14));
  nand3  g43(.a(new_n73_), .b(x16), .c(new_n46_), .O(new_n85_));
  ...
  nand2  g50(.a(new_n91_), .b(z04), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z17));
  nand4  g53(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(z04), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(new_n97_));
  nand3  g56(.a(new_n43_), .b(x10), .c(x08), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(x19), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n97_), .O(z18));
  ...
  nand2  g62(.a(new_n103_), .b(z04), .O(new_n104_));
  nand2  g63(.a(x20), .b(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n71_), .O(z19));
endmodule
