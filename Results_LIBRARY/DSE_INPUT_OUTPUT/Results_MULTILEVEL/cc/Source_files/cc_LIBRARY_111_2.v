...
module FAU ( 
  ...
  nand3  g25(.a(new_n59_), .b(x09), .c(x08), .O(z10));
  nand2  g26(.a(new_n59_), .b(new_n47_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  nand2  g28(.a(new_n55_), .b(new_n44_), .O(new_n70_));
  nand2  g29(.a(x19), .b(x15), .O(new_n71_));
  ...
  oai21  g48(.a(new_n61_), .b(new_n69_), .c(x19), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n55_), .b(x17), .O(new_n92_));
  nand4  g51(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  ...
  inv1   g63(.a(x19), .O(new_n105_));
  nand2  g64(.a(new_n51_), .b(new_n105_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n43_), .b(new_n69_), .c(x19), .O(new_n110_));
