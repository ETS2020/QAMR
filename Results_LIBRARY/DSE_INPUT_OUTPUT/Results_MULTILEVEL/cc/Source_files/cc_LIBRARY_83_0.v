...
module FAU ( 
  ...
  nand3  g44(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n86_));
  nand3  g45(.a(new_n83_), .b(x08), .c(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n75_), .O(z15));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n75_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  oai21  g56(.a(new_n47_), .b(new_n97_), .c(x12), .O(new_n98_));
