...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(x07), .c(new_n44_), .O(z02));
  nand4  g15(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n57_));
  ...
  nand2  g29(.a(new_n46_), .b(new_n49_), .O(z11));
  ...
  nand3  g33(.a(new_n74_), .b(x12), .c(x07), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z12));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n48_), .b(new_n77_), .c(x14), .O(new_n78_));
  inv1   g37(.a(x07), .O(new_n79_));
  inv1   g38(.a(x10), .O(new_n80_));
  nor2   g39(.a(new_n52_), .b(new_n80_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x08), .c(new_n79_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n78_), .c(new_n44_), .O(z13));
  nand2  g42(.a(new_n48_), .b(x15), .O(new_n84_));
  nand4  g43(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(x07), .O(new_n86_));
  ...
  nand3  g49(.a(new_n90_), .b(x12), .c(x07), .O(new_n91_));
  ...
  nand3  g54(.a(new_n95_), .b(x12), .c(x07), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z16));
  nand2  g56(.a(new_n53_), .b(x18), .O(new_n98_));
  nor2   g57(.a(x15), .b(new_n80_), .O(new_n99_));
  and2   g58(.a(x08), .b(x05), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n79_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n98_), .c(new_n44_), .O(z17));
  ...
  nand3  g64(.a(new_n105_), .b(x12), .c(x07), .O(new_n106_));
  inv1   g65(.a(new_n106_), .O(z18));
  nand3  g66(.a(new_n53_), .b(new_n43_), .c(x07), .O(new_n108_));
  and2   g67(.a(new_n108_), .b(x12), .O(z19));
endmodule
