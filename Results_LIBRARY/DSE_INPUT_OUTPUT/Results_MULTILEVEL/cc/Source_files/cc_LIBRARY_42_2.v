...
module FAU ( 
  ...
  oai21  g23(.a(x15), .b(new_n52_), .c(x09), .O(new_n65_));
  ...
  aoi21  g28(.a(x15), .b(new_n69_), .c(new_n52_), .O(z12));
  aoi21  g29(.a(x10), .b(x08), .c(x14), .O(new_n71_));
  nor3   g30(.a(new_n71_), .b(new_n43_), .c(new_n52_), .O(z13));
  ...
  aoi21  g39(.a(new_n56_), .b(x15), .c(new_n52_), .O(z18));
