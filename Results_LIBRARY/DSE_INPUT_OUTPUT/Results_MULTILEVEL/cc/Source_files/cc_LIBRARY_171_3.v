...
module FAU ( 
  ...
  nand2  g37(.a(new_n47_), .b(new_n54_), .O(new_n79_));
  ...
  nand3  g47(.a(new_n47_), .b(x16), .c(new_n54_), .O(new_n89_));
  ...
  nand3  g56(.a(x17), .b(new_n55_), .c(x15), .O(new_n98_));
  ...
  nand3  g70(.a(x19), .b(new_n55_), .c(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n78_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n78_), .c(new_n55_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x15), .O(new_n115_));
  nand2  g74(.a(new_n47_), .b(x20), .O(new_n116_));
