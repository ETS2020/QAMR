...
module FAU ( 
  ...
  nor4   g07(.a(new_n48_), .b(x17), .c(new_n43_), .d(x14), .O(z01));
  ...
  nand4  g17(.a(new_n58_), .b(new_n44_), .c(x15), .d(new_n52_), .O(new_n59_));
  ...
  nand2  g28(.a(new_n46_), .b(new_n52_), .O(z11));
  inv1   g29(.a(x12), .O(new_n71_));
  aoi21  g30(.a(x10), .b(x08), .c(x15), .O(new_n72_));
  nor2   g31(.a(x17), .b(new_n43_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(x13), .O(new_n74_));
  nand4  g33(.a(new_n43_), .b(x10), .c(x08), .d(x00), .O(new_n75_));
  ...
  nand2  g58(.a(new_n99_), .b(new_n46_), .O(z16));
  ...
  nand3  g63(.a(x18), .b(new_n44_), .c(x15), .O(new_n105_));
  ...
  nand3  g69(.a(x19), .b(new_n44_), .c(x15), .O(new_n111_));
  ...
  nand3  g75(.a(x20), .b(new_n44_), .c(x15), .O(new_n117_));
