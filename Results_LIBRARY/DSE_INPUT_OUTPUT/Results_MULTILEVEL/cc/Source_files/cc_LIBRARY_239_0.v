...
module FAU ( 
  ...
  oai21  g16(.a(new_n57_), .b(new_n50_), .c(new_n43_), .O(z03));
  ...
  nand4  g48(.a(new_n74_), .b(x16), .c(new_n46_), .d(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(z15));
  nand2  g50(.a(new_n50_), .b(x20), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n52_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x17), .O(new_n94_));
  nand3  g53(.a(x20), .b(new_n52_), .c(x10), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(x08), .c(x04), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n94_), .c(new_n77_), .O(z16));
  nand2  g57(.a(new_n93_), .b(x18), .O(new_n99_));
  ...
  nand2  g61(.a(new_n102_), .b(x20), .O(new_n103_));
  ...
  nand3  g67(.a(new_n108_), .b(x20), .c(x12), .O(new_n109_));
