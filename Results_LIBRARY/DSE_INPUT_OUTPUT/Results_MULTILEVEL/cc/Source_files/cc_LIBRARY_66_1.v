...
module FAU ( 
  ...
  oai21  g31(.a(new_n72_), .b(new_n57_), .c(new_n44_), .O(new_n73_));
  ...
  oai21  g36(.a(new_n76_), .b(new_n72_), .c(new_n77_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n74_), .O(z12));
  aoi21  g39(.a(x08), .b(x01), .c(new_n48_), .O(new_n81_));
  nor2   g40(.a(new_n44_), .b(new_n75_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(x10), .O(new_n83_));
  nand3  g42(.a(new_n44_), .b(x14), .c(new_n51_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n57_), .O(z13));
  nand4  g44(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n86_));
  oai21  g45(.a(new_n44_), .b(x08), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n46_), .O(z14));
  nand3  g48(.a(x16), .b(new_n48_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n44_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n51_), .O(new_n92_));
  nand2  g51(.a(new_n44_), .b(x08), .O(new_n93_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n92_), .O(z15));
  inv1   g57(.a(x04), .O(new_n99_));
  oai22  g58(.a(new_n58_), .b(new_n99_), .c(new_n64_), .d(x10), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(new_n101_));
  nand3  g60(.a(new_n93_), .b(x17), .c(x10), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n57_), .O(z16));
  inv1   g62(.a(x05), .O(new_n104_));
  inv1   g63(.a(x18), .O(new_n105_));
  oai22  g64(.a(new_n58_), .b(new_n104_), .c(new_n105_), .d(x10), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n44_), .O(new_n107_));
  nand3  g66(.a(new_n93_), .b(x18), .c(x10), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n57_), .O(z17));
  oai21  g68(.a(new_n61_), .b(new_n57_), .c(new_n44_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n51_), .O(new_n111_));
  nand4  g70(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n112_));
  oai21  g71(.a(new_n76_), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n111_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n57_), .c(new_n44_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n51_), .O(new_n117_));
  nand4  g76(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n118_));
  oai21  g77(.a(new_n76_), .b(new_n43_), .c(new_n118_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x12), .O(new_n120_));
  nand2  g79(.a(new_n120_), .b(new_n117_), .O(z19));
endmodule
