...
module FAU ( 
  ...
  nor2   g04(.a(new_n42_), .b(new_n45_), .O(new_n46_));
  ...
  nand3  g13(.a(new_n54_), .b(x12), .c(new_n45_), .O(new_n55_));
  inv1   g14(.a(new_n55_), .O(z02));
  nor2   g15(.a(new_n48_), .b(x11), .O(new_n57_));
  nand3  g16(.a(new_n57_), .b(new_n49_), .c(x12), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(new_n52_), .O(z03));
  nand2  g18(.a(new_n47_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nand2  g20(.a(new_n47_), .b(new_n61_), .O(z05));
  nor2   g21(.a(new_n46_), .b(new_n52_), .O(z06));
  ...
  aoi21  g28(.a(x09), .b(x08), .c(new_n46_), .O(z10));
  nor2   g29(.a(new_n46_), .b(new_n49_), .O(z11));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(x11), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n72_), .c(new_n42_), .O(z12));
  ...
  nand3  g40(.a(new_n81_), .b(x12), .c(new_n45_), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  nand2  g42(.a(new_n48_), .b(x15), .O(new_n84_));
  nand4  g43(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(new_n45_), .O(new_n86_));
  and2   g45(.a(new_n86_), .b(x12), .O(z14));
  ...
  nand3  g49(.a(new_n90_), .b(x12), .c(new_n45_), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z15));
  nand2  g51(.a(new_n53_), .b(x17), .O(new_n93_));
  and2   g52(.a(x08), .b(x04), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n74_), .c(x11), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n42_), .O(z16));
  nand2  g55(.a(new_n53_), .b(x18), .O(new_n97_));
  and2   g56(.a(x08), .b(x05), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n74_), .c(x11), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n97_), .c(new_n42_), .O(z17));
  ...
  nand3  g62(.a(new_n103_), .b(x12), .c(new_n45_), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  nand2  g64(.a(new_n53_), .b(x20), .O(new_n106_));
  and2   g65(.a(x08), .b(x07), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n74_), .c(x11), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n106_), .c(new_n42_), .O(z19));
endmodule
