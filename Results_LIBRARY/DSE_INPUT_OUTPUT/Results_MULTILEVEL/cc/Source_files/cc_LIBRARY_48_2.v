...
module FAU ( 
  ...
  oai21  g33(.a(new_n74_), .b(new_n56_), .c(new_n46_), .O(z12));
  ...
  aoi22  g47(.a(new_n88_), .b(new_n72_), .c(new_n52_), .d(x17), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n56_), .c(new_n46_), .O(z16));
  and2   g49(.a(x08), .b(x05), .O(new_n91_));
  aoi22  g50(.a(new_n91_), .b(new_n72_), .c(new_n52_), .d(x18), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n56_), .c(new_n46_), .O(z17));
  ...
  oai21  g57(.a(new_n98_), .b(new_n56_), .c(new_n46_), .O(z19));
endmodule
