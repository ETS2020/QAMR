...
module FAU ( 
  ...
  inv1   g25(.a(new_n58_), .O(new_n67_));
  ...
  nand4  g48(.a(new_n75_), .b(x16), .c(new_n45_), .d(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(z15));
  aoi21  g50(.a(x10), .b(x08), .c(x20), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(x15), .c(x17), .O(new_n93_));
  nand4  g52(.a(new_n49_), .b(x10), .c(x08), .d(x04), .O(new_n94_));
  ...
  nand3  g57(.a(new_n75_), .b(x18), .c(x12), .O(new_n99_));
  ...
  nand3  g62(.a(new_n75_), .b(x19), .c(x12), .O(new_n104_));
  ...
  nand2  g67(.a(new_n108_), .b(new_n67_), .O(z19));
endmodule
