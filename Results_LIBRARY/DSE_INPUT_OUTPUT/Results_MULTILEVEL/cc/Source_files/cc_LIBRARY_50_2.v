...
module FAU ( 
  ...
  aoi21  g50(.a(new_n48_), .b(new_n43_), .c(x15), .O(new_n92_));
  nor3   g51(.a(new_n92_), .b(new_n64_), .c(new_n58_), .O(z16));
  nand2  g52(.a(new_n48_), .b(x18), .O(new_n94_));
  nand2  g53(.a(x08), .b(x05), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n81_), .c(new_n94_), .O(new_n96_));
  ...
  oai22  g59(.a(new_n100_), .b(new_n81_), .c(new_n49_), .d(new_n61_), .O(new_n101_));
  ...
  oai21  g65(.a(new_n106_), .b(new_n81_), .c(new_n105_), .O(new_n107_));
