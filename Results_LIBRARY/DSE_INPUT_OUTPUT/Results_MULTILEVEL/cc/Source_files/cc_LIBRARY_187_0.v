...
module FAU ( 
  ...
  nand2  g21(.a(new_n52_), .b(x05), .O(z06));
  ...
  nand2  g31(.a(new_n72_), .b(x05), .O(new_n73_));
  ...
  oai21  g54(.a(new_n82_), .b(x18), .c(x05), .O(new_n96_));
  nand2  g55(.a(x18), .b(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n58_), .O(z17));
  nand4  g57(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n99_));
  oai21  g58(.a(new_n48_), .b(new_n61_), .c(new_n99_), .O(new_n100_));
