...
module FAU ( 
  ...
  nand2  g49(.a(new_n48_), .b(new_n44_), .O(new_n91_));
  nand2  g50(.a(x19), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n52_), .O(new_n94_));
  ...
  aoi21  g70(.a(new_n48_), .b(new_n47_), .c(new_n111_), .O(new_n112_));
  ...
  nand2  g74(.a(new_n115_), .b(new_n50_), .O(z18));
  oai21  g75(.a(new_n43_), .b(new_n90_), .c(x19), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x15), .O(new_n118_));
  nand2  g77(.a(new_n48_), .b(x20), .O(new_n119_));
