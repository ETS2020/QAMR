...
module FAU ( 
  ...
  nor2   g16(.a(x14), .b(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(new_n55_), .c(new_n45_), .O(z03));
  nand2  g19(.a(x18), .b(new_n45_), .O(z04));
  inv1   g20(.a(x19), .O(new_n62_));
  oai21  g21(.a(new_n55_), .b(new_n45_), .c(new_n62_), .O(z05));
  nand2  g22(.a(new_n55_), .b(x15), .O(new_n64_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n55_), .O(new_n81_));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n57_), .O(z14));
  inv1   g47(.a(x14), .O(new_n89_));
  nand3  g48(.a(new_n75_), .b(x16), .c(new_n89_), .O(new_n90_));
  nand3  g49(.a(new_n77_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n57_), .O(z15));
  oai21  g51(.a(new_n66_), .b(new_n57_), .c(new_n55_), .O(new_n93_));
  ...
  aoi21  g59(.a(new_n46_), .b(new_n55_), .c(new_n100_), .O(new_n101_));
  aoi21  g60(.a(x10), .b(x08), .c(new_n55_), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(new_n103_));
  nor2   g62(.a(new_n103_), .b(new_n57_), .O(z17));
  oai21  g63(.a(new_n62_), .b(new_n57_), .c(new_n55_), .O(new_n105_));
  ...
  nand3  g74(.a(x20), .b(new_n55_), .c(x15), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n57_), .O(z19));
endmodule
