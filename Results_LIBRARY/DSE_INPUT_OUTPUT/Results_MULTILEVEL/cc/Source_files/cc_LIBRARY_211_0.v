...
module FAU ( 
  ...
  oai22  g11(.a(new_n52_), .b(new_n50_), .c(new_n43_), .d(new_n46_), .O(new_n53_));
  nand3  g12(.a(new_n53_), .b(x12), .c(new_n49_), .O(new_n54_));
  inv1   g13(.a(new_n54_), .O(z02));
  inv1   g14(.a(x12), .O(new_n56_));
  nor4   g15(.a(new_n50_), .b(new_n51_), .c(x14), .d(new_n56_), .O(z03));
  ...
  nand2  g27(.a(new_n68_), .b(x18), .O(new_n69_));
  ...
  nand2  g34(.a(new_n50_), .b(new_n46_), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  aoi22  g36(.a(new_n77_), .b(x14), .c(new_n76_), .d(x15), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n56_), .c(new_n44_), .O(z13));
  nand2  g38(.a(new_n50_), .b(x15), .O(new_n80_));
  nand3  g39(.a(x18), .b(new_n51_), .c(x10), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n80_), .c(new_n56_), .O(z14));
  nand2  g43(.a(new_n50_), .b(x18), .O(new_n85_));
  ...
  nand2  g49(.a(new_n90_), .b(x18), .O(new_n91_));
  ...
  nand3  g54(.a(new_n72_), .b(x08), .c(new_n95_), .O(new_n96_));
  ...
  nand2  g58(.a(new_n99_), .b(x18), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n51_), .O(new_n101_));
  nand3  g60(.a(new_n73_), .b(x19), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(z18));
  nand2  g62(.a(new_n50_), .b(x20), .O(new_n104_));
