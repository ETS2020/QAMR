...
module FAU ( 
  ...
  aoi21  g30(.a(new_n71_), .b(new_n68_), .c(new_n56_), .O(z12));
  nand2  g31(.a(new_n46_), .b(new_n47_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x15), .O(new_n74_));
  inv1   g33(.a(x01), .O(new_n75_));
  oai21  g34(.a(new_n46_), .b(new_n75_), .c(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n56_), .O(z13));
  nand3  g36(.a(new_n46_), .b(x15), .c(x12), .O(new_n78_));
  inv1   g37(.a(x02), .O(new_n79_));
  oai21  g38(.a(new_n46_), .b(new_n79_), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n51_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n78_), .O(z14));
  inv1   g41(.a(x03), .O(new_n83_));
  oai21  g42(.a(new_n46_), .b(new_n83_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n51_), .O(new_n85_));
  nand4  g44(.a(new_n52_), .b(x16), .c(new_n47_), .d(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  oai21  g47(.a(new_n46_), .b(new_n88_), .c(x12), .O(new_n89_));
  ...
  nand3  g52(.a(new_n70_), .b(x08), .c(x05), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n56_), .O(z17));
  nand2  g54(.a(new_n52_), .b(x19), .O(new_n96_));
  nand3  g55(.a(new_n70_), .b(x08), .c(x06), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n56_), .O(z18));
  nand2  g57(.a(new_n52_), .b(x20), .O(new_n99_));
  nand3  g58(.a(new_n70_), .b(x08), .c(x07), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n56_), .O(z19));
  buf    g60(.a(x15), .O(z06));
endmodule
