...
module FAU ( 
  ...
  nand2  g24(.a(new_n44_), .b(new_n47_), .O(z08));
  inv1   g25(.a(x08), .O(new_n67_));
  nand2  g26(.a(new_n45_), .b(x09), .O(new_n68_));
  ...
  nand2  g39(.a(new_n48_), .b(new_n55_), .O(new_n81_));
  ...
  nand3  g49(.a(new_n51_), .b(x16), .c(new_n55_), .O(new_n91_));
  nand4  g50(.a(new_n47_), .b(x10), .c(x08), .d(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n80_), .O(z15));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n80_), .O(z16));
  ...
  nand3  g70(.a(x19), .b(x16), .c(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n80_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n80_), .c(x16), .O(new_n114_));
