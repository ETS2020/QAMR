...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n59_, new_n61_, new_n62_,
  ...
  nand2  g20(.a(new_n44_), .b(x09), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n61_), .O(z09));
  aoi21  g22(.a(x09), .b(x08), .c(new_n55_), .O(z10));
  nor2   g23(.a(new_n55_), .b(new_n50_), .O(z11));
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n43_), .O(z12));
  ...
  nand3  g40(.a(new_n68_), .b(x08), .c(x03), .O(new_n82_));
  ...
  nand3  g49(.a(new_n68_), .b(x08), .c(x05), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(z17));
  oai21  g51(.a(x19), .b(new_n43_), .c(x15), .O(new_n93_));
  nand2  g52(.a(new_n47_), .b(x19), .O(new_n94_));
  nand4  g53(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n93_), .O(z18));
  nand2  g57(.a(new_n51_), .b(x20), .O(new_n99_));
  nand3  g58(.a(new_n68_), .b(x08), .c(x07), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n43_), .O(z19));
  nor4   g60(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  buf    g61(.a(x15), .O(z06));
endmodule
