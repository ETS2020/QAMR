...
module FAU ( 
  ...
  nand4  g17(.a(new_n58_), .b(z04), .c(x15), .d(new_n55_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z03));
  inv1   g19(.a(x19), .O(new_n61_));
  oai21  g20(.a(z04), .b(new_n45_), .c(new_n61_), .O(z05));
  nand2  g21(.a(z04), .b(x15), .O(new_n63_));
  ...
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(new_n73_));
  ...
  nand2  g37(.a(new_n46_), .b(new_n55_), .O(new_n79_));
  ...
  nand3  g47(.a(new_n74_), .b(x16), .c(new_n55_), .O(new_n89_));
  ...
  nand2  g60(.a(new_n101_), .b(new_n43_), .O(z17));
  oai21  g61(.a(new_n61_), .b(new_n72_), .c(z04), .O(new_n103_));
