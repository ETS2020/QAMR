...
module FAU ( 
  ...
  nand3  g14(.a(new_n55_), .b(x13), .c(x12), .O(new_n56_));
  nor3   g15(.a(new_n56_), .b(new_n43_), .c(x14), .O(z03));
  ...
  nor2   g26(.a(new_n44_), .b(new_n50_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  nand2  g28(.a(new_n51_), .b(new_n47_), .O(new_n70_));
  ...
  nand2  g35(.a(new_n55_), .b(x01), .O(new_n77_));
  ...
  nand3  g43(.a(x16), .b(new_n50_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x13), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand3  g46(.a(new_n48_), .b(x16), .c(new_n50_), .O(new_n88_));
  nand4  g47(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n87_), .O(z15));
  oai21  g51(.a(new_n61_), .b(new_n69_), .c(x13), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x15), .O(new_n94_));
  nand2  g53(.a(new_n48_), .b(x17), .O(new_n95_));
  nand4  g54(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n96_));
  ...
  nand4  g62(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n104_));
  ...
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n69_), .O(z18));
  ...
  nand3  g76(.a(x20), .b(x15), .c(x13), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n69_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
