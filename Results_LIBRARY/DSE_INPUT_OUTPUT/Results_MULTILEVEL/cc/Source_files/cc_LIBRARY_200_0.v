...
module FAU ( 
  ...
  nand2  g36(.a(new_n56_), .b(new_n46_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x15), .O(new_n79_));
  inv1   g38(.a(x01), .O(new_n80_));
  oai21  g39(.a(new_n56_), .b(new_n80_), .c(x14), .O(new_n81_));
