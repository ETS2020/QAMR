...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x17), .c(new_n44_), .O(z03));
  nor2   g16(.a(new_n45_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  aoi21  g18(.a(new_n48_), .b(x15), .c(new_n59_), .O(z05));
  nand2  g19(.a(x17), .b(x15), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(z06));
  nand2  g21(.a(new_n48_), .b(new_n44_), .O(z07));
  ...
  nand2  g36(.a(new_n49_), .b(new_n51_), .O(new_n78_));
  ...
  oai21  g61(.a(new_n59_), .b(new_n70_), .c(x17), .O(new_n103_));
  ...
  oai21  g68(.a(new_n43_), .b(new_n70_), .c(x17), .O(new_n110_));
