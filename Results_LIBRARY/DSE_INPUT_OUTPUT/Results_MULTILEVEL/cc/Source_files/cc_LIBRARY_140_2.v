...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x19), .c(new_n44_), .O(z01));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n83_), .O(z16));
  nand2  g59(.a(x18), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x19), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n55_), .b(x18), .O(new_n104_));
  ...
  inv1   g67(.a(x19), .O(new_n109_));
  nand2  g68(.a(new_n51_), .b(new_n109_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x06), .O(new_n111_));
  nand2  g70(.a(new_n51_), .b(x19), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n83_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n83_), .c(x19), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x15), .O(new_n115_));
  nand2  g74(.a(new_n55_), .b(x20), .O(new_n116_));
