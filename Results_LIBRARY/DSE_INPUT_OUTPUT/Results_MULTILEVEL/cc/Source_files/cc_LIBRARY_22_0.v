...
module FAU ( 
  ...
  nand2  g09(.a(x18), .b(new_n50_), .O(new_n51_));
  ...
  oai21  g15(.a(new_n56_), .b(new_n49_), .c(new_n55_), .O(z03));
  inv1   g16(.a(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n55_), .b(new_n59_), .O(z05));
  inv1   g19(.a(x17), .O(new_n61_));
  nand2  g20(.a(new_n55_), .b(new_n61_), .O(z07));
  inv1   g21(.a(x16), .O(new_n63_));
  nand2  g22(.a(new_n55_), .b(new_n63_), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n55_), .O(z09));
  nand3  g25(.a(new_n55_), .b(x09), .c(x08), .O(z10));
  nor2   g26(.a(new_n44_), .b(new_n46_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  nand2  g28(.a(new_n49_), .b(x18), .O(new_n70_));
  ...
  nand3  g42(.a(new_n71_), .b(x16), .c(new_n46_), .O(new_n84_));
  ...
  nand3  g54(.a(new_n91_), .b(x08), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n92_), .b(x19), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(z18));
  nand2  g62(.a(new_n49_), .b(x20), .O(new_n104_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n69_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
