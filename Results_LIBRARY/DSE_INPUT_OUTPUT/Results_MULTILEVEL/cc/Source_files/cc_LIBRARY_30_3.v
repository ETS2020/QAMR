...
module FAU ( 
  ...
  nor2   g30(.a(new_n43_), .b(x01), .O(new_n72_));
  ...
  nand2  g36(.a(new_n77_), .b(new_n42_), .O(new_n78_));
  nand2  g37(.a(new_n71_), .b(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n70_), .O(z13));
  ...
  oai21  g53(.a(new_n62_), .b(new_n70_), .c(new_n42_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n81_), .b(x17), .O(new_n97_));
  ...
  nand2  g60(.a(new_n81_), .b(x18), .O(new_n102_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n70_), .O(z17));
  ...
  nand3  g70(.a(x19), .b(x15), .c(new_n42_), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n70_), .O(z18));
  nand2  g72(.a(x20), .b(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n42_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n81_), .b(x20), .O(new_n117_));
