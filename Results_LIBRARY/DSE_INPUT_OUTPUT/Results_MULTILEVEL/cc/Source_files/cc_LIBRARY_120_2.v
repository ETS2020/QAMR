...
module FAU ( 
  ...
  nand3  g12(.a(new_n53_), .b(x12), .c(new_n44_), .O(new_n54_));
  ...
  nor2   g19(.a(x15), .b(x11), .O(new_n61_));
  ...
  nand4  g42(.a(new_n61_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n71_), .O(z18));
