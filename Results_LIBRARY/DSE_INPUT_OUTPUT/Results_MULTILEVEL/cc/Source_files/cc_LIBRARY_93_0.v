...
module FAU ( 
  ...
  nand2  g50(.a(new_n52_), .b(x19), .O(new_n92_));
  nand3  g51(.a(new_n73_), .b(x08), .c(x06), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n56_), .O(z18));
  nand2  g53(.a(new_n52_), .b(x20), .O(new_n95_));
  nand3  g54(.a(new_n73_), .b(x08), .c(x07), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n56_), .O(z19));
endmodule
