...
module FAU ( 
  ...
  aoi21  g25(.a(x15), .b(x06), .c(new_n47_), .O(z11));
  ...
  nand3  g37(.a(new_n78_), .b(x15), .c(new_n45_), .O(new_n79_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n46_), .O(new_n88_));
  nand2  g47(.a(x15), .b(new_n45_), .O(new_n89_));
  ...
  nand2  g73(.a(new_n71_), .b(x20), .O(new_n115_));
