...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    ...
    new_n64_, new_n68_, new_n70_, new_n71_, new_n72_, new_n74_, new_n75_,
    new_n77_, new_n80_, new_n83_;
  ...
  nor2   g20(.a(new_n55_), .b(new_n61_), .O(z08));
  ...
  nor2   g37(.a(new_n59_), .b(new_n70_), .O(z16));
  oai21  g38(.a(x15), .b(new_n43_), .c(x18), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n70_), .O(z17));
  oai21  g40(.a(new_n57_), .b(new_n70_), .c(new_n50_), .O(z18));
