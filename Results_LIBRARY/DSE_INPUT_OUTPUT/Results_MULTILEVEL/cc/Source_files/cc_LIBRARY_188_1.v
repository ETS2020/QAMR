...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x07), .c(new_n44_), .O(z01));
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n55_));
  nor3   g14(.a(new_n55_), .b(new_n44_), .c(x14), .O(z03));
  nor2   g15(.a(new_n45_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nand2  g17(.a(x15), .b(x07), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(x15), .c(new_n58_), .O(z05));
  inv1   g19(.a(new_n59_), .O(z06));
  ...
  nand3  g48(.a(new_n73_), .b(x16), .c(new_n48_), .O(new_n90_));
  nand3  g49(.a(new_n76_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n70_), .O(z15));
  oai21  g51(.a(new_n62_), .b(new_n70_), .c(x07), .O(new_n93_));
  ...
  nand2  g59(.a(new_n100_), .b(x07), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x15), .O(new_n102_));
  nand2  g61(.a(new_n71_), .b(x18), .O(new_n103_));
  ...
  nand3  g70(.a(x19), .b(x15), .c(x07), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n70_), .O(z18));
  nand2  g72(.a(new_n51_), .b(new_n43_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x07), .O(new_n115_));
  nand3  g74(.a(new_n71_), .b(x20), .c(new_n44_), .O(new_n116_));
