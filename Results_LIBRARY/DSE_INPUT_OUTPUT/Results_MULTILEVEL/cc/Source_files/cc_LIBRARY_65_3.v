...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n63_,
  ...
  and2   g19(.a(new_n49_), .b(x17), .O(z07));
  and2   g20(.a(new_n49_), .b(x16), .O(z08));
  nand3  g21(.a(new_n49_), .b(x09), .c(x08), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z09));
  aoi22  g23(.a(x20), .b(x15), .c(x09), .d(x08), .O(z10));
  nand2  g24(.a(new_n49_), .b(new_n55_), .O(z11));
  nand2  g25(.a(x13), .b(x12), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n44_), .O(new_n68_));
  ...
  nand2  g34(.a(new_n46_), .b(new_n55_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(x15), .O(new_n77_));
  ...
  nand3  g39(.a(new_n46_), .b(new_n44_), .c(x15), .O(new_n81_));
  inv1   g40(.a(new_n51_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n75_), .O(z14));
  nand2  g43(.a(new_n46_), .b(new_n43_), .O(new_n85_));
  nand2  g44(.a(new_n44_), .b(x15), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x16), .c(new_n55_), .O(new_n88_));
  ...
  nand3  g53(.a(new_n44_), .b(x17), .c(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n75_), .O(z16));
  ...
  nand3  g59(.a(new_n44_), .b(x18), .c(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n75_), .O(z17));
  ...
  nand3  g65(.a(new_n44_), .b(x19), .c(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n75_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  aoi21  g68(.a(new_n46_), .b(new_n44_), .c(new_n109_), .O(new_n110_));
  aoi21  g69(.a(x10), .b(x08), .c(new_n44_), .O(new_n111_));
  oai21  g70(.a(new_n111_), .b(new_n110_), .c(new_n43_), .O(new_n112_));
  nor2   g71(.a(new_n112_), .b(new_n75_), .O(z19));
  buf    g72(.a(x15), .O(z06));
endmodule
