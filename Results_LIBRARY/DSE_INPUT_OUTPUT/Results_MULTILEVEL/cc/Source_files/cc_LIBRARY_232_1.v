...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n62_, new_n64_, new_n68_, new_n69_, new_n70_, new_n71_, new_n73_,
  ...
  nand2  g32(.a(new_n48_), .b(new_n49_), .O(new_n74_));
  nand3  g33(.a(x10), .b(x08), .c(x01), .O(new_n75_));
  aoi22  g34(.a(new_n75_), .b(x14), .c(new_n74_), .d(x15), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n73_), .c(new_n47_), .O(z13));
  nand2  g36(.a(new_n48_), .b(x15), .O(new_n78_));
  nor2   g37(.a(x16), .b(x15), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(x10), .c(x08), .d(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n73_), .O(z14));
  nand4  g40(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  oai21  g41(.a(new_n44_), .b(x14), .c(new_n82_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n47_), .O(z15));
  nand2  g44(.a(new_n48_), .b(x17), .O(new_n86_));
  nand4  g45(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(new_n89_));
  nand2  g48(.a(x17), .b(x15), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n73_), .O(z16));
  nand2  g50(.a(new_n48_), .b(x18), .O(new_n92_));
  nand4  g51(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(new_n95_));
  nand2  g54(.a(x18), .b(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n73_), .O(z17));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n73_), .O(z18));
