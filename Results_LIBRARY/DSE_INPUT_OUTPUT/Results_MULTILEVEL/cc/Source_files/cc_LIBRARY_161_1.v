...
module FAU ( 
  ...
  oai21  g34(.a(new_n75_), .b(new_n71_), .c(new_n45_), .O(z12));
  ...
  nand4  g51(.a(new_n43_), .b(new_n52_), .c(x10), .d(x08), .O(new_n93_));
  ...
  nand2  g56(.a(x18), .b(x17), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n93_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x05), .O(new_n100_));
  nand3  g59(.a(new_n53_), .b(x18), .c(x17), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(z17));
  and2   g61(.a(x08), .b(x06), .O(new_n103_));
  aoi22  g62(.a(new_n103_), .b(new_n73_), .c(new_n53_), .d(x19), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n71_), .c(new_n45_), .O(z18));
