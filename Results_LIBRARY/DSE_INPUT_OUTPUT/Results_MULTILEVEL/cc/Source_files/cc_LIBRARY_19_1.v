...
module FAU ( 
  ...
  nand3  g35(.a(new_n68_), .b(x08), .c(x02), .O(new_n77_));
  ...
  nand3  g39(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n81_));
  nand4  g40(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  ...
  nand3  g51(.a(new_n68_), .b(x08), .c(x05), .O(new_n93_));
  ...
  nand3  g60(.a(new_n68_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n43_), .O(z19));
  nor4   g62(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  buf    g63(.a(x15), .O(z06));
endmodule
