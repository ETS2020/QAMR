...
module FAU ( 
  ...
  nor4   g17(.a(new_n46_), .b(new_n52_), .c(x14), .d(new_n58_), .O(z03));
  ...
  nand2  g30(.a(new_n52_), .b(x08), .O(new_n72_));
  ...
  oai21  g37(.a(new_n47_), .b(x10), .c(new_n46_), .O(new_n79_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(z14));
  nand3  g45(.a(new_n72_), .b(x16), .c(new_n47_), .O(new_n87_));
  nand3  g46(.a(new_n52_), .b(x08), .c(x03), .O(new_n88_));
  ...
  nand2  g51(.a(x12), .b(x08), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(x10), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n52_), .O(new_n95_));
  nand3  g54(.a(new_n72_), .b(x17), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n95_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  oai21  g57(.a(new_n93_), .b(new_n98_), .c(x10), .O(new_n99_));
  ...
  oai21  g62(.a(new_n93_), .b(new_n103_), .c(x10), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n52_), .O(new_n105_));
  nand3  g64(.a(new_n72_), .b(x19), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(z18));
  inv1   g66(.a(x07), .O(new_n108_));
  oai21  g67(.a(new_n93_), .b(new_n108_), .c(x10), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n52_), .O(new_n110_));
  nand3  g69(.a(new_n72_), .b(x20), .c(x12), .O(new_n111_));
