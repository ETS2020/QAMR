...
module FAU ( 
  ...
  oai21  g36(.a(new_n77_), .b(x14), .c(x15), .O(new_n78_));
  nand2  g37(.a(new_n77_), .b(x01), .O(new_n79_));
  ...
  oai21  g41(.a(new_n77_), .b(new_n51_), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g47(.a(new_n74_), .b(x16), .c(new_n47_), .d(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(z15));
  nor2   g49(.a(new_n64_), .b(x04), .O(new_n91_));
  ...
  nand3  g56(.a(new_n74_), .b(x18), .c(x12), .O(new_n98_));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n56_), .O(z18));
  ...
  nand3  g67(.a(new_n74_), .b(x20), .c(x12), .O(new_n109_));
