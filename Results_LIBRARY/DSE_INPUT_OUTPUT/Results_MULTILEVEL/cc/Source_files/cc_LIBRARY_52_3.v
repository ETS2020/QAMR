...
module FAU ( 
  ...
  aoi21  g27(.a(x15), .b(x06), .c(new_n47_), .O(z11));
  ...
  nand3  g43(.a(new_n56_), .b(x15), .c(new_n46_), .O(new_n85_));
  inv1   g44(.a(new_n52_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x08), .c(x02), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n84_), .O(z14));
  nand2  g47(.a(new_n56_), .b(new_n45_), .O(new_n89_));
  nand2  g48(.a(x15), .b(new_n46_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n63_), .b(new_n84_), .c(new_n46_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n56_), .b(x17), .O(new_n97_));
  nand2  g56(.a(x08), .b(x04), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n52_), .c(new_n97_), .O(new_n99_));
  ...
  nand3  g76(.a(x20), .b(x15), .c(new_n46_), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n84_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
