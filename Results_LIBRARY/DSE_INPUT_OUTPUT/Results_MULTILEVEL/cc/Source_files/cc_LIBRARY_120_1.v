...
module FAU ( 
  ...
  nor2   g17(.a(new_n55_), .b(new_n58_), .O(z05));
  ...
  nand2  g27(.a(new_n49_), .b(new_n45_), .O(new_n69_));
  nand2  g28(.a(x15), .b(x11), .O(new_n70_));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n72_), .c(new_n68_), .O(z12));
  ...
  nand3  g39(.a(new_n49_), .b(x15), .c(x11), .O(new_n81_));
  ...
  oai21  g45(.a(new_n60_), .b(new_n68_), .c(x11), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand2  g47(.a(new_n49_), .b(x17), .O(new_n89_));
  nand4  g48(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n90_));
  ...
  nand3  g64(.a(x19), .b(x15), .c(x11), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n68_), .O(z18));
  oai21  g66(.a(new_n43_), .b(new_n68_), .c(x11), .O(new_n108_));
