...
module FAU ( 
  ...
  nand2  g32(.a(new_n56_), .b(x12), .O(new_n74_));
  ...
  nand3  g38(.a(new_n71_), .b(x08), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n55_), .O(z14));
  nand3  g40(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n82_));
  nand3  g41(.a(new_n71_), .b(x08), .c(x03), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n55_), .O(z15));
  oai21  g43(.a(x17), .b(new_n55_), .c(x15), .O(new_n85_));
  nand2  g44(.a(new_n56_), .b(x17), .O(new_n86_));
  nand4  g45(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n85_), .O(z16));
  oai21  g49(.a(x18), .b(new_n55_), .c(x15), .O(new_n91_));
  nand2  g50(.a(new_n56_), .b(x18), .O(new_n92_));
  ...
  oai21  g55(.a(x19), .b(new_n55_), .c(x15), .O(new_n97_));
  nand2  g56(.a(new_n56_), .b(x19), .O(new_n98_));
  nand4  g57(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n97_), .O(z18));
  oai21  g61(.a(x20), .b(new_n55_), .c(x15), .O(new_n103_));
  nand2  g62(.a(new_n56_), .b(x20), .O(new_n104_));
  nand4  g63(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n103_), .O(z19));
  buf    g67(.a(x15), .O(z06));
endmodule
