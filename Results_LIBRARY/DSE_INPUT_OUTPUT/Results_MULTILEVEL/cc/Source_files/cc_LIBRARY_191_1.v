...
module FAU ( 
  ...
  nor2   g33(.a(x17), .b(x15), .O(new_n75_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n72_), .c(new_n47_), .O(z13));
  ...
  nand2  g47(.a(new_n75_), .b(new_n50_), .O(new_n89_));
  nand4  g48(.a(new_n89_), .b(x16), .c(new_n48_), .d(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n88_), .O(z15));
  nand4  g50(.a(new_n75_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n63_), .c(new_n72_), .O(z16));
  ...
  nand3  g55(.a(new_n54_), .b(x18), .c(x12), .O(new_n97_));
  ...
  nand3  g66(.a(new_n54_), .b(x20), .c(x12), .O(new_n108_));
