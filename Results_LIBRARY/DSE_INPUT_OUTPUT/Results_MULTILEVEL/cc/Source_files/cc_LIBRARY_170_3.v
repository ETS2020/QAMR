...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n56_, new_n62_, new_n66_,
  ...
  nand4  g14(.a(new_n50_), .b(x12), .c(x10), .d(x08), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n55_), .c(new_n45_), .O(z03));
  nand2  g16(.a(new_n42_), .b(x18), .O(z04));
  nor2   g17(.a(new_n55_), .b(x15), .O(z05));
  ...
  nand2  g23(.a(new_n42_), .b(new_n50_), .O(z11));
  inv1   g24(.a(x12), .O(new_n66_));
  aoi21  g25(.a(x10), .b(x08), .c(x15), .O(new_n67_));
  nor2   g26(.a(x19), .b(new_n45_), .O(new_n68_));
  ...
  aoi21  g30(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(z12));
  nand2  g31(.a(new_n46_), .b(new_n50_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n55_), .c(x15), .O(new_n74_));
  nand3  g33(.a(x10), .b(x08), .c(x01), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n45_), .c(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n66_), .O(z13));
  nand3  g36(.a(new_n46_), .b(new_n55_), .c(x15), .O(new_n78_));
  nand3  g37(.a(new_n70_), .b(x08), .c(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n66_), .O(z14));
  nand3  g39(.a(x16), .b(new_n50_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n55_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x15), .O(new_n83_));
  nand3  g42(.a(new_n46_), .b(x16), .c(new_n50_), .O(new_n84_));
  ...
  nand3  g51(.a(new_n55_), .b(x17), .c(x15), .O(new_n93_));
  ...
  nand3  g57(.a(new_n55_), .b(x18), .c(x15), .O(new_n99_));
  ...
  nand2  g63(.a(new_n104_), .b(new_n42_), .O(z18));
  ...
  nand3  g68(.a(x20), .b(new_n55_), .c(x15), .O(new_n110_));
