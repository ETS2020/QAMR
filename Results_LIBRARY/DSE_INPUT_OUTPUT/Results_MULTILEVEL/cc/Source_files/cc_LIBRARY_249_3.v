...
module FAU ( 
  ...
  aoi21  g24(.a(new_n46_), .b(new_n65_), .c(new_n45_), .O(z09));
  ...
  nand3  g49(.a(new_n54_), .b(x16), .c(new_n47_), .O(new_n91_));
  ...
  oai21  g55(.a(new_n61_), .b(new_n96_), .c(new_n45_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n54_), .b(x17), .O(new_n99_));
  ...
  nand2  g68(.a(new_n54_), .b(x19), .O(new_n110_));
  ...
  nand2  g74(.a(new_n54_), .b(x20), .O(new_n116_));
