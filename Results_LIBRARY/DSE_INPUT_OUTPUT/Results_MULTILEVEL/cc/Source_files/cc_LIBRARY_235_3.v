...
module FAU ( 
  ...
  nand2  g12(.a(x20), .b(x15), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n53_), .O(z02));
  nand3  g14(.a(x12), .b(x10), .c(x08), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n45_), .c(x15), .d(new_n46_), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z03));
  nand2  g18(.a(new_n54_), .b(x18), .O(z04));
  and2   g19(.a(new_n54_), .b(x19), .O(z05));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n54_), .b(new_n62_), .O(z07));
  and2   g22(.a(new_n54_), .b(x16), .O(z08));
  ...
  oai21  g33(.a(new_n74_), .b(new_n51_), .c(new_n73_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n71_), .O(z12));
  inv1   g36(.a(x12), .O(new_n78_));
  nand2  g37(.a(new_n72_), .b(new_n46_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n45_), .c(x15), .O(new_n80_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n54_), .O(z14));
  nand2  g47(.a(new_n72_), .b(new_n42_), .O(new_n89_));
  nand2  g48(.a(new_n45_), .b(x15), .O(new_n90_));
  ...
  oai21  g53(.a(new_n62_), .b(new_n78_), .c(new_n45_), .O(new_n95_));
  ...
  nand2  g63(.a(new_n72_), .b(x18), .O(new_n105_));
  nand2  g64(.a(x08), .b(x05), .O(new_n106_));
  oai21  g65(.a(new_n106_), .b(new_n51_), .c(new_n105_), .O(new_n107_));
  ...
  nand3  g72(.a(new_n45_), .b(x19), .c(x15), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n78_), .O(z18));
  inv1   g74(.a(x07), .O(new_n116_));
  aoi21  g75(.a(new_n72_), .b(new_n45_), .c(new_n116_), .O(new_n117_));
  aoi21  g76(.a(x10), .b(x08), .c(new_n45_), .O(new_n118_));
  oai21  g77(.a(new_n118_), .b(new_n117_), .c(new_n42_), .O(new_n119_));
  nor2   g78(.a(new_n119_), .b(new_n78_), .O(z19));
  buf    g79(.a(x15), .O(z06));
endmodule
