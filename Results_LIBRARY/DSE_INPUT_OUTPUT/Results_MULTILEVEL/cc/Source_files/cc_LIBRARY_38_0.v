...
module FAU ( 
  ...
  nand4  g45(.a(new_n53_), .b(x16), .c(new_n48_), .d(x12), .O(new_n87_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n69_), .O(z17));
  nand2  g53(.a(new_n53_), .b(x19), .O(new_n95_));
  nand3  g54(.a(new_n72_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n69_), .O(z18));
  nand2  g56(.a(new_n53_), .b(x20), .O(new_n98_));
  nand3  g57(.a(new_n72_), .b(x08), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n69_), .O(z19));
  buf    g59(.a(x15), .O(z06));
endmodule
