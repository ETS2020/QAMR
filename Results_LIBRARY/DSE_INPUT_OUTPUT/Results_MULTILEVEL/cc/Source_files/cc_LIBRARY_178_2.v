...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n61_, new_n64_, new_n66_, new_n68_, new_n71_, new_n72_, new_n73_,
  ...
  nand4  g05(.a(x15), .b(new_n44_), .c(x10), .d(x08), .O(new_n47_));
  inv1   g06(.a(new_n47_), .O(z01));
  nand2  g07(.a(x15), .b(x14), .O(new_n49_));
  nor2   g08(.a(x15), .b(x14), .O(new_n50_));
  ...
  nand2  g21(.a(new_n56_), .b(new_n44_), .O(z06));
  ...
  nand2  g27(.a(new_n68_), .b(new_n61_), .O(z09));
  inv1   g28(.a(z09), .O(z10));
  nand4  g29(.a(x12), .b(x10), .c(x08), .d(x00), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n44_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n56_), .O(new_n73_));
  nand3  g32(.a(new_n56_), .b(x10), .c(x08), .O(new_n74_));
  ...
  nand2  g38(.a(new_n79_), .b(new_n61_), .O(z13));
  ...
  nand2  g44(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  nand4  g45(.a(new_n74_), .b(x16), .c(new_n44_), .d(x12), .O(new_n87_));
  ...
  nand2  g63(.a(new_n57_), .b(x20), .O(new_n105_));
  nand4  g64(.a(new_n56_), .b(x10), .c(x08), .d(x07), .O(new_n106_));
