...
module FAU ( 
  ...
  nand2  g20(.a(new_n43_), .b(x15), .O(new_n62_));
  ...
  nand2  g33(.a(new_n57_), .b(x13), .O(new_n75_));
  ...
  nand3  g45(.a(new_n57_), .b(new_n43_), .c(x15), .O(new_n87_));
  ...
  nand2  g49(.a(new_n57_), .b(new_n42_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n62_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x16), .c(new_n48_), .O(new_n93_));
  nand3  g52(.a(new_n88_), .b(x08), .c(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n86_), .O(z15));
  oai21  g54(.a(new_n64_), .b(new_n86_), .c(new_n43_), .O(new_n96_));
  ...
  nand2  g64(.a(new_n57_), .b(x18), .O(new_n106_));
  ...
  aoi21  g70(.a(new_n57_), .b(new_n43_), .c(new_n111_), .O(new_n112_));
  aoi21  g71(.a(x10), .b(x08), .c(new_n43_), .O(new_n113_));
  oai21  g72(.a(new_n113_), .b(new_n112_), .c(new_n42_), .O(new_n114_));
  nor2   g73(.a(new_n114_), .b(new_n86_), .O(z18));
  nand2  g74(.a(x20), .b(x12), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n43_), .O(new_n117_));
