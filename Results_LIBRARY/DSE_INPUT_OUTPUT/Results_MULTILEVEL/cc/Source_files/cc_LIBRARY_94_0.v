...
module FAU ( 
  ...
  oai21  g32(.a(new_n49_), .b(x14), .c(x15), .O(new_n74_));
  nand2  g33(.a(new_n49_), .b(x01), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(x20), .c(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n57_), .O(z13));
  ...
  nor2   g44(.a(new_n43_), .b(x15), .O(new_n86_));
  ...
  nand2  g65(.a(new_n106_), .b(new_n45_), .O(z19));
  buf    g66(.a(x15), .O(z06));
endmodule
