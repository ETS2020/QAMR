...
module FAU ( 
  ...
  nand2  g21(.a(new_n51_), .b(x10), .O(z06));
  ...
  nand2  g30(.a(new_n51_), .b(x08), .O(new_n72_));
  ...
  aoi21  g37(.a(x14), .b(x12), .c(new_n51_), .O(new_n79_));
  aoi21  g38(.a(new_n58_), .b(new_n46_), .c(new_n51_), .O(new_n80_));
  aoi21  g39(.a(x08), .b(x01), .c(new_n46_), .O(new_n81_));
  ...
  nand3  g46(.a(x16), .b(new_n46_), .c(new_n73_), .O(new_n88_));
  ...
  nand2  g52(.a(x17), .b(new_n73_), .O(new_n94_));
  oai21  g53(.a(new_n72_), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g61(.a(new_n72_), .b(x18), .c(x12), .O(new_n103_));
  ...
  nand3  g66(.a(new_n72_), .b(x19), .c(x12), .O(new_n108_));
  ...
  nand3  g71(.a(new_n72_), .b(x20), .c(x12), .O(new_n113_));
