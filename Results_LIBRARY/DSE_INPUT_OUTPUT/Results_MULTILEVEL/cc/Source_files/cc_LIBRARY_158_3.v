...
module FAU ( 
  ...
  nand3  g15(.a(new_n56_), .b(new_n49_), .c(x12), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n42_), .c(new_n43_), .O(z03));
  nand2  g17(.a(new_n54_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  oai21  g19(.a(new_n43_), .b(new_n42_), .c(new_n60_), .O(z05));
  nand2  g20(.a(x15), .b(new_n42_), .O(new_n62_));
  ...
  nand3  g26(.a(new_n54_), .b(x09), .c(x08), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z09));
  aoi21  g28(.a(x09), .b(x08), .c(new_n53_), .O(z10));
  nand2  g29(.a(new_n54_), .b(new_n49_), .O(z11));
  inv1   g30(.a(x12), .O(new_n72_));
  nand2  g31(.a(new_n46_), .b(new_n43_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n62_), .O(new_n74_));
  ...
  nand3  g66(.a(x19), .b(x15), .c(new_n42_), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n72_), .O(z18));
