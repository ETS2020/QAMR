...
module FAU ( 
  ...
  nor2   g33(.a(new_n62_), .b(x15), .O(new_n75_));
  ...
  nand3  g39(.a(new_n80_), .b(x17), .c(x14), .O(new_n81_));
  ...
  nand4  g49(.a(new_n52_), .b(x16), .c(new_n48_), .d(x12), .O(new_n91_));
  ...
  nand2  g66(.a(new_n107_), .b(x17), .O(new_n108_));
