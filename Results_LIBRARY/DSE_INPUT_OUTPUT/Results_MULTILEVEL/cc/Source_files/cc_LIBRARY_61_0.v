...
module FAU ( 
  ...
  nand2  g20(.a(new_n51_), .b(x02), .O(z06));
  ...
  aoi21  g37(.a(new_n46_), .b(new_n47_), .c(new_n51_), .O(new_n79_));
  inv1   g38(.a(new_n46_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x01), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x14), .c(new_n79_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n72_), .c(new_n44_), .O(z13));
  ...
  nand2  g46(.a(new_n87_), .b(x02), .O(new_n88_));
  ...
  oai21  g51(.a(new_n80_), .b(new_n63_), .c(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x02), .O(new_n94_));
  ...
  nand2  g56(.a(new_n97_), .b(x02), .O(new_n98_));
  ...
  oai21  g61(.a(new_n80_), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x02), .O(new_n104_));
  nand2  g63(.a(x19), .b(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n72_), .O(z18));
  ...
  nand2  g68(.a(new_n109_), .b(x02), .O(new_n110_));
