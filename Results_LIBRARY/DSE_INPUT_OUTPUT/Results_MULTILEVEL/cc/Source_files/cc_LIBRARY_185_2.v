...
module FAU ( 
  ...
  nand3  g15(.a(x15), .b(new_n44_), .c(x12), .O(new_n57_));
  ...
  aoi22  g27(.a(new_n68_), .b(x14), .c(x09), .d(x08), .O(z10));
  inv1   g28(.a(new_n51_), .O(z11));
  nand4  g29(.a(x12), .b(x10), .c(x08), .d(x00), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n44_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  nand3  g32(.a(new_n68_), .b(x10), .c(x08), .O(new_n74_));
  ...
  nand4  g44(.a(new_n68_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  ...
  nand2  g61(.a(new_n102_), .b(new_n68_), .O(new_n103_));
  nand3  g62(.a(new_n74_), .b(x19), .c(x12), .O(new_n104_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n81_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
