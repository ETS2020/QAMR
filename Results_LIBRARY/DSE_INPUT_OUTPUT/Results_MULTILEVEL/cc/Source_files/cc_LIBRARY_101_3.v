...
module FAU ( 
  ...
  oai21  g18(.a(new_n46_), .b(new_n45_), .c(new_n59_), .O(z05));
  ...
  aoi21  g26(.a(x15), .b(x05), .c(new_n47_), .O(z11));
  ...
  nand2  g58(.a(new_n80_), .b(x18), .O(new_n100_));
  ...
  oai21  g64(.a(new_n59_), .b(new_n69_), .c(new_n45_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n80_), .b(x19), .O(new_n108_));
