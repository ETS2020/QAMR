...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n55_, new_n59_, new_n61_, new_n63_,
  ...
  nand2  g26(.a(new_n54_), .b(x13), .O(new_n68_));
  nand4  g27(.a(new_n44_), .b(x10), .c(x08), .d(x00), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x01), .O(new_n71_));
  nand2  g30(.a(x15), .b(x13), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(z12));
  nand2  g32(.a(new_n54_), .b(x01), .O(new_n74_));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n67_), .O(z13));
  nand2  g38(.a(new_n54_), .b(x15), .O(new_n80_));
  inv1   g39(.a(new_n50_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x02), .c(x01), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n67_), .O(z14));
  nand4  g42(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x01), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n44_), .O(new_n86_));
  nand4  g45(.a(new_n50_), .b(x16), .c(new_n47_), .d(x12), .O(new_n87_));
