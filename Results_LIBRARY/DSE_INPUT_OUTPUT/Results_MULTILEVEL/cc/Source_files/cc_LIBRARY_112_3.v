...
module FAU ( 
  ...
  aoi21  g27(.a(x20), .b(x15), .c(new_n46_), .O(z11));
  ...
  nand3  g39(.a(new_n80_), .b(new_n44_), .c(x15), .O(new_n81_));
  ...
  oai21  g56(.a(new_n62_), .b(new_n79_), .c(new_n44_), .O(new_n98_));
  ...
  oai21  g69(.a(new_n59_), .b(new_n79_), .c(new_n44_), .O(new_n111_));
  ...
  aoi21  g77(.a(new_n73_), .b(new_n44_), .c(new_n118_), .O(new_n119_));
  aoi21  g78(.a(x10), .b(x08), .c(new_n44_), .O(new_n120_));
  oai21  g79(.a(new_n120_), .b(new_n119_), .c(new_n43_), .O(new_n121_));
  nor2   g80(.a(new_n121_), .b(new_n79_), .O(z19));
endmodule
