...
module FAU ( 
  ...
  oai21  g27(.a(new_n46_), .b(new_n68_), .c(x12), .O(new_n69_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n79_), .c(new_n56_), .O(z14));
  nand3  g42(.a(new_n52_), .b(x16), .c(new_n47_), .O(new_n84_));
  ...
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n56_), .O(z16));
  nand2  g48(.a(new_n52_), .b(x18), .O(new_n90_));
  nand3  g49(.a(new_n81_), .b(x08), .c(x05), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n56_), .O(z17));
  inv1   g51(.a(x06), .O(new_n93_));
  oai21  g52(.a(new_n46_), .b(new_n93_), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n51_), .O(new_n95_));
  nand3  g54(.a(new_n52_), .b(x19), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n95_), .O(z18));
  nand2  g56(.a(new_n52_), .b(x20), .O(new_n98_));
  nand3  g57(.a(new_n81_), .b(x08), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n56_), .O(z19));
  buf    g59(.a(x15), .O(z06));
endmodule
