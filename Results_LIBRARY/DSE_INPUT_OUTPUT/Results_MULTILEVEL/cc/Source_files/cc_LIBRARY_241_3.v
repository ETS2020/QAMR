...
module FAU ( 
  ...
  aoi21  g18(.a(x20), .b(x15), .c(new_n59_), .O(z05));
  nor2   g19(.a(x20), .b(new_n43_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nor2   g21(.a(new_n53_), .b(new_n62_), .O(z07));
  ...
  nand2  g33(.a(new_n46_), .b(new_n49_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n44_), .c(x15), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n43_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n70_), .O(z13));
  nand2  g38(.a(new_n46_), .b(x15), .O(new_n80_));
  nand2  g39(.a(x08), .b(x02), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n50_), .c(new_n80_), .O(new_n82_));
  ...
  oai21  g51(.a(new_n62_), .b(new_n70_), .c(new_n44_), .O(new_n93_));
  ...
  nand3  g62(.a(new_n44_), .b(x18), .c(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n70_), .O(z17));
  oai21  g64(.a(new_n59_), .b(new_n70_), .c(new_n44_), .O(new_n106_));
  ...
  aoi21  g72(.a(new_n46_), .b(new_n44_), .c(new_n113_), .O(new_n114_));
  aoi21  g73(.a(x10), .b(x08), .c(new_n44_), .O(new_n115_));
  oai21  g74(.a(new_n115_), .b(new_n114_), .c(new_n43_), .O(new_n116_));
  nor2   g75(.a(new_n116_), .b(new_n70_), .O(z19));
endmodule
