...
module FAU ( 
  ...
  nand2  g42(.a(new_n83_), .b(new_n53_), .O(z14));
  ...
  nand3  g51(.a(new_n49_), .b(x17), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(z16));
  oai21  g53(.a(new_n70_), .b(x15), .c(x18), .O(new_n95_));
  nand4  g54(.a(new_n72_), .b(x10), .c(x08), .d(x05), .O(new_n96_));
  ...
  nand4  g62(.a(new_n72_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n69_), .O(z19));
  buf    g64(.a(x15), .O(z06));
endmodule
