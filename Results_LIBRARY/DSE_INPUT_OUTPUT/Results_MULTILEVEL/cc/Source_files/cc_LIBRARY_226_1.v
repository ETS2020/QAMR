...
module FAU ( 
  ...
  aoi21  g26(.a(x15), .b(new_n43_), .c(new_n48_), .O(z11));
  ...
  nand2  g33(.a(new_n55_), .b(x12), .O(new_n75_));
  ...
  inv1   g63(.a(x10), .O(new_n105_));
  nor2   g64(.a(x15), .b(new_n105_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(x08), .c(x06), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n104_), .c(new_n43_), .O(z18));
  nand2  g67(.a(new_n51_), .b(x20), .O(new_n109_));
  nand3  g68(.a(new_n106_), .b(x08), .c(x07), .O(new_n110_));
