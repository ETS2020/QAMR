...
module FAU ( 
  ...
  nand2  g34(.a(new_n55_), .b(x12), .O(new_n76_));
  ...
  nand4  g49(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n91_));
  ...
  nand4  g61(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n103_));
  ...
  nand2  g65(.a(new_n51_), .b(x20), .O(new_n107_));
  nand3  g66(.a(new_n73_), .b(x08), .c(x07), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n43_), .O(z19));
endmodule
