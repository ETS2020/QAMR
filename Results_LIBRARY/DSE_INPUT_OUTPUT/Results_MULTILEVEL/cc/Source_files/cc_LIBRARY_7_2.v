...
module FAU ( 
  ...
  nand2  g30(.a(new_n71_), .b(new_n47_), .O(z12));
  nand2  g31(.a(new_n48_), .b(new_n49_), .O(new_n73_));
  nand3  g32(.a(x10), .b(x08), .c(x01), .O(new_n74_));
  aoi22  g33(.a(new_n74_), .b(x14), .c(new_n73_), .d(x15), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n57_), .c(new_n47_), .O(z13));
  ...
  nand4  g43(.a(new_n53_), .b(x16), .c(new_n49_), .d(x12), .O(new_n85_));
