...
module FAU ( 
  ...
  nand2  g53(.a(new_n94_), .b(x06), .O(new_n95_));
  ...
  oai21  g57(.a(new_n81_), .b(x19), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n44_), .O(z18));
  nand2  g59(.a(new_n54_), .b(x20), .O(new_n101_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n69_), .O(z19));
  buf    g65(.a(x15), .O(z06));
endmodule
