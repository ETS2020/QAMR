...
module FAU ( 
  ...
  nand2  g28(.a(new_n47_), .b(x19), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x13), .O(new_n72_));
  nand3  g31(.a(x19), .b(new_n52_), .c(x10), .O(new_n73_));
  ...
  nand2  g35(.a(new_n47_), .b(new_n48_), .O(new_n77_));
  nand3  g36(.a(x10), .b(x08), .c(x01), .O(new_n78_));
  aoi22  g37(.a(new_n78_), .b(x14), .c(new_n77_), .d(x15), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n69_), .c(new_n46_), .O(z13));
  nand2  g39(.a(new_n47_), .b(x15), .O(new_n81_));
  nand3  g40(.a(new_n74_), .b(x08), .c(x02), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n69_), .O(z14));
  nand3  g42(.a(new_n71_), .b(x16), .c(new_n48_), .O(new_n84_));
  nand3  g43(.a(new_n74_), .b(x08), .c(x03), .O(new_n85_));
  ...
  nand3  g48(.a(new_n52_), .b(x10), .c(x08), .O(new_n90_));
  ...
  nand2  g52(.a(new_n93_), .b(x19), .O(new_n94_));
  ...
  nand3  g58(.a(new_n99_), .b(x19), .c(x12), .O(new_n100_));
  ...
  nand3  g63(.a(new_n90_), .b(x20), .c(x12), .O(new_n105_));
