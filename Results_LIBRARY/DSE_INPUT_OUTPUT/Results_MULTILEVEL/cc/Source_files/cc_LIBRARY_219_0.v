...
module FAU ( 
  ...
  nor2   g07(.a(new_n44_), .b(new_n48_), .O(z06));
  ...
  nand2  g20(.a(new_n61_), .b(x16), .O(z05));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n52_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x09), .O(new_n65_));
  nor3   g24(.a(new_n44_), .b(new_n65_), .c(new_n46_), .O(z09));
  ...
  oai21  g32(.a(new_n73_), .b(new_n69_), .c(new_n52_), .O(z12));
  ...
  nand2  g38(.a(new_n79_), .b(new_n52_), .O(z13));
  ...
  nand3  g42(.a(new_n83_), .b(new_n52_), .c(x12), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z14));
  nor2   g44(.a(new_n44_), .b(x15), .O(new_n86_));
  ...
  aoi22  g49(.a(new_n90_), .b(new_n71_), .c(new_n53_), .d(x17), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n69_), .c(new_n52_), .O(z16));
  and2   g51(.a(x08), .b(x05), .O(new_n93_));
  aoi22  g52(.a(new_n93_), .b(new_n71_), .c(new_n53_), .d(x18), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n69_), .c(new_n52_), .O(z17));
  nand4  g54(.a(x16), .b(new_n48_), .c(x10), .d(x08), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n61_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x06), .O(new_n98_));
  nand2  g57(.a(new_n53_), .b(x19), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n69_), .O(z18));
  and2   g59(.a(x08), .b(x07), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n71_), .c(new_n53_), .d(x20), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n69_), .c(new_n52_), .O(z19));
  buf    g62(.a(x16), .O(z08));
endmodule
