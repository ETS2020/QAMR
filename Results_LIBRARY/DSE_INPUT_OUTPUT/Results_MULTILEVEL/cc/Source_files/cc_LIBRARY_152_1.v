...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n60_, new_n61_, new_n65_,
  ...
  aoi21  g21(.a(x09), .b(x08), .c(new_n55_), .O(z10));
  ...
  nand3  g38(.a(new_n79_), .b(x08), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n77_), .c(new_n43_), .O(z14));
  nand3  g40(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n82_));
  nand3  g41(.a(new_n79_), .b(x08), .c(x03), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n43_), .O(z15));
  oai21  g43(.a(x17), .b(new_n43_), .c(x15), .O(new_n85_));
  nand2  g44(.a(new_n66_), .b(x17), .O(new_n86_));
  nand4  g45(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
