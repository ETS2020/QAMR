...
module FAU ( 
  ...
  oai21  g52(.a(new_n47_), .b(new_n93_), .c(x12), .O(new_n94_));
  ...
  nand3  g57(.a(new_n73_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n70_), .O(z18));
  nand2  g59(.a(new_n52_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n73_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n70_), .O(z19));
  buf    g62(.a(x15), .O(z06));
endmodule
