...
module FAU ( 
  ...
  aoi21  g20(.a(x15), .b(new_n51_), .c(new_n61_), .O(z05));
  ...
  oai22  g32(.a(new_n58_), .b(new_n72_), .c(new_n73_), .d(x10), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n44_), .O(new_n75_));
  nand2  g34(.a(new_n44_), .b(x08), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x13), .c(x10), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n57_), .O(z12));
  aoi21  g37(.a(x08), .b(x01), .c(new_n48_), .O(new_n79_));
  inv1   g38(.a(x08), .O(new_n80_));
  nor2   g39(.a(new_n44_), .b(new_n80_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(x10), .O(new_n82_));
  ...
  nand2  g44(.a(x15), .b(new_n80_), .O(new_n86_));
  oai21  g45(.a(new_n76_), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g51(.a(new_n76_), .b(x16), .c(new_n48_), .O(new_n93_));
