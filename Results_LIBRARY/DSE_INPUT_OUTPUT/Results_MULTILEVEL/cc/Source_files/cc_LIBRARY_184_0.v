...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n60_, new_n62_,
  ...
  nand2  g17(.a(x19), .b(new_n51_), .O(z06));
  ...
  nand2  g32(.a(new_n73_), .b(x08), .O(new_n74_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n56_), .c(new_n44_), .O(z13));
  ...
  nand3  g47(.a(x19), .b(new_n51_), .c(x10), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n88_), .c(new_n56_), .O(z15));
  nand2  g51(.a(new_n87_), .b(x17), .O(new_n93_));
  nand3  g52(.a(new_n90_), .b(x08), .c(x04), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n56_), .O(z16));
  nand2  g54(.a(new_n87_), .b(x18), .O(new_n96_));
  nand3  g55(.a(new_n90_), .b(x08), .c(x05), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n56_), .O(z17));
  nor2   g57(.a(new_n64_), .b(x06), .O(new_n99_));
  ...
  nand2  g61(.a(new_n46_), .b(x20), .O(new_n103_));
  nand4  g62(.a(new_n51_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x19), .O(new_n106_));
  nand2  g65(.a(x20), .b(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n56_), .O(z19));
  buf    g67(.a(x19), .O(z05));
endmodule
