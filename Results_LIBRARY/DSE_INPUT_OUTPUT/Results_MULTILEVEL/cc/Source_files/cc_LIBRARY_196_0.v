...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x03), .O(new_n43_));
  ...
  nand2  g18(.a(new_n49_), .b(x03), .O(z06));
  ...
  nand2  g60(.a(new_n54_), .b(x20), .O(new_n102_));
  nand4  g61(.a(new_n49_), .b(x10), .c(x08), .d(x07), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x03), .O(new_n105_));
  nand2  g64(.a(x20), .b(x15), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n74_), .O(z19));
endmodule
