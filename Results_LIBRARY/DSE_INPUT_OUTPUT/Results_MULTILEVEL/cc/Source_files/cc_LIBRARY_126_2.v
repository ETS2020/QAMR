...
module FAU ( 
  ...
  oai21  g08(.a(x20), .b(new_n46_), .c(x14), .O(new_n50_));
  ...
  nand4  g15(.a(new_n56_), .b(x20), .c(x15), .d(new_n47_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(z03));
  nand2  g17(.a(new_n44_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  oai21  g19(.a(x20), .b(new_n46_), .c(new_n60_), .O(z05));
  nor2   g20(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  nand3  g43(.a(new_n79_), .b(x20), .c(x15), .O(new_n85_));
  ...
  nand3  g49(.a(new_n79_), .b(x16), .c(new_n47_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n79_), .b(x17), .O(new_n96_));
  ...
  nand3  g58(.a(x20), .b(x17), .c(x15), .O(new_n100_));
  ...
  nand2  g63(.a(new_n79_), .b(x18), .O(new_n105_));
  ...
  oai21  g68(.a(new_n60_), .b(new_n72_), .c(x20), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n79_), .b(x19), .O(new_n112_));
