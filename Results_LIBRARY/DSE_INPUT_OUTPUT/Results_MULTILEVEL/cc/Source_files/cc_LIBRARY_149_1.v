...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n53_, new_n55_, new_n57_, new_n59_, new_n62_, new_n64_,
  ...
  oai21  g16(.a(new_n45_), .b(x11), .c(new_n57_), .O(z05));
  ...
  nand2  g25(.a(new_n55_), .b(new_n46_), .O(z11));
  ...
  nand2  g44(.a(new_n49_), .b(new_n45_), .O(new_n86_));
  ...
  oai21  g61(.a(new_n57_), .b(new_n76_), .c(x11), .O(new_n103_));
  ...
  oai21  g68(.a(new_n43_), .b(new_n76_), .c(x11), .O(new_n110_));
