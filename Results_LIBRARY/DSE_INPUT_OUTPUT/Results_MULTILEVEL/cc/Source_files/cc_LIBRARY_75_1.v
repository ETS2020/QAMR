...
module FAU ( 
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x01), .O(new_n55_));
  nor3   g14(.a(new_n55_), .b(new_n44_), .c(x14), .O(z03));
  inv1   g15(.a(new_n45_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(x15), .b(x01), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(x15), .c(new_n59_), .O(z05));
  inv1   g20(.a(new_n60_), .O(z06));
  ...
  nand2  g29(.a(new_n57_), .b(new_n47_), .O(z11));
  ...
  aoi21  g39(.a(x14), .b(x12), .c(x15), .O(new_n81_));
  ...
  oai21  g44(.a(new_n81_), .b(x01), .c(new_n85_), .O(z13));
  ...
  nand2  g49(.a(new_n90_), .b(new_n57_), .O(z14));
  inv1   g50(.a(x12), .O(new_n92_));
  nand2  g51(.a(new_n75_), .b(new_n44_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n60_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x16), .c(new_n47_), .O(new_n95_));
  nand4  g54(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n92_), .O(z15));
  ...
  nand3  g60(.a(x17), .b(x15), .c(x01), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n92_), .O(z16));
  nand2  g62(.a(new_n75_), .b(x18), .O(new_n104_));
  ...
  nand3  g66(.a(x18), .b(x15), .c(x01), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n92_), .O(z17));
  nand2  g68(.a(new_n75_), .b(x19), .O(new_n110_));
  ...
  nand3  g72(.a(x19), .b(x15), .c(x01), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n92_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n92_), .c(x01), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n75_), .b(x20), .O(new_n118_));
