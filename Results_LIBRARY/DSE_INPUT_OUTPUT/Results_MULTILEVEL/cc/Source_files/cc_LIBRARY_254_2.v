...
module FAU ( 
  ...
  aoi21  g27(.a(x15), .b(new_n68_), .c(new_n56_), .O(z12));
  nand2  g28(.a(x10), .b(x08), .O(new_n70_));
  nor2   g29(.a(new_n44_), .b(x14), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n56_), .O(z13));
  ...
  aoi21  g38(.a(new_n79_), .b(x15), .c(new_n56_), .O(z17));
  aoi21  g39(.a(new_n55_), .b(x15), .c(new_n56_), .O(z18));
