...
module FAU ( 
  ...
  nand2  g27(.a(new_n46_), .b(new_n55_), .O(z11));
  ...
  nand2  g37(.a(new_n78_), .b(x20), .O(new_n79_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n97_), .O(z17));
  oai21  g68(.a(new_n60_), .b(new_n97_), .c(x20), .O(new_n110_));
  ...
  nand2  g77(.a(new_n51_), .b(x20), .O(new_n119_));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n97_), .O(z19));
  buf    g79(.a(x15), .O(z06));
endmodule
