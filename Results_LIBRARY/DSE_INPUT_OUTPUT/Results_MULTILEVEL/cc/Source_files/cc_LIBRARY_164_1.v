...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n58_, new_n60_, new_n61_, new_n63_,
  ...
  aoi21  g22(.a(x09), .b(x08), .c(new_n63_), .O(z10));
  nor2   g23(.a(new_n63_), .b(new_n47_), .O(z11));
  ...
  nand3  g48(.a(new_n68_), .b(x08), .c(x05), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z17));
  nand2  g50(.a(new_n51_), .b(x19), .O(new_n92_));
  nand3  g51(.a(new_n68_), .b(x08), .c(x06), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z18));
  nand2  g53(.a(new_n51_), .b(x20), .O(new_n95_));
  nand3  g54(.a(new_n68_), .b(x08), .c(x07), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z19));
  aoi21  g56(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
  buf    g57(.a(x15), .O(z06));
endmodule
