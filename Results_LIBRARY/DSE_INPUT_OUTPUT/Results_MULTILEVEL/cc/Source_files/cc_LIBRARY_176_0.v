...
module FAU ( 
  ...
  nor2   g15(.a(x18), .b(new_n50_), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nand2  g17(.a(new_n44_), .b(new_n58_), .O(z05));
  nand2  g18(.a(x18), .b(new_n50_), .O(z06));
  ...
  nand4  g33(.a(new_n74_), .b(x18), .c(new_n50_), .d(x10), .O(new_n75_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n70_), .c(new_n44_), .O(z13));
