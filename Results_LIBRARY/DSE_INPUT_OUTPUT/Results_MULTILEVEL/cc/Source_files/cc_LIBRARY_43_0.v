...
module FAU ( 
  ...
  oai21  g15(.a(new_n56_), .b(new_n50_), .c(new_n44_), .O(z03));
  ...
  nand2  g30(.a(new_n50_), .b(x18), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n51_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x13), .O(new_n74_));
  nand3  g33(.a(x18), .b(new_n51_), .c(x10), .O(new_n75_));
  ...
  nand2  g37(.a(new_n50_), .b(new_n46_), .O(new_n79_));
  ...
  nand2  g49(.a(new_n90_), .b(x08), .O(new_n91_));
  nand4  g50(.a(new_n91_), .b(x16), .c(new_n46_), .d(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n88_), .O(z15));
  nand2  g52(.a(new_n73_), .b(x17), .O(new_n94_));
  nand3  g53(.a(new_n76_), .b(x08), .c(x04), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n71_), .O(z16));
  nor2   g55(.a(new_n66_), .b(x05), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n90_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(x18), .c(x12), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  nand2  g59(.a(new_n50_), .b(x19), .O(new_n101_));
  ...
  nand3  g68(.a(new_n91_), .b(x20), .c(x12), .O(new_n110_));
