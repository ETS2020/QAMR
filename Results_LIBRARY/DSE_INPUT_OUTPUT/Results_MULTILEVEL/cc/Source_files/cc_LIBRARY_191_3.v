...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n61_, new_n66_, new_n70_, new_n71_, new_n72_, new_n73_, new_n75_,
  ...
  aoi21  g27(.a(x17), .b(x15), .c(new_n47_), .O(z11));
  ...
  aoi21  g53(.a(new_n56_), .b(new_n46_), .c(new_n94_), .O(new_n95_));
  aoi21  g54(.a(x10), .b(x08), .c(new_n46_), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(new_n45_), .O(new_n97_));
  nor2   g56(.a(new_n97_), .b(new_n70_), .O(z16));
  ...
  nand3  g69(.a(x19), .b(new_n46_), .c(x15), .O(new_n111_));
