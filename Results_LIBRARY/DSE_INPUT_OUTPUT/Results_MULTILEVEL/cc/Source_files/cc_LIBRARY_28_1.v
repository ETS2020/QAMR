...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(x07), .c(new_n44_), .O(z03));
  ...
  nand2  g25(.a(new_n46_), .b(new_n50_), .O(z11));
  ...
  nand3  g37(.a(new_n78_), .b(x15), .c(x07), .O(new_n79_));
  ...
  nand3  g41(.a(new_n71_), .b(x15), .c(x07), .O(new_n83_));
  ...
  nand2  g47(.a(x15), .b(x07), .O(new_n89_));
  ...
  oai21  g66(.a(new_n58_), .b(new_n77_), .c(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n71_), .b(x19), .O(new_n110_));
  ...
  nand2  g73(.a(new_n51_), .b(new_n43_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x07), .O(new_n116_));
  nand3  g75(.a(new_n71_), .b(x20), .c(new_n44_), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n77_), .O(z19));
  buf    g77(.a(x15), .O(z06));
endmodule
