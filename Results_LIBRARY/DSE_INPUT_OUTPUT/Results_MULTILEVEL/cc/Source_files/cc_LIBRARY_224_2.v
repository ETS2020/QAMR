...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n62_, new_n65_, new_n66_, new_n70_, new_n71_, new_n72_,
  ...
  oai21  g09(.a(x17), .b(new_n47_), .c(x14), .O(new_n51_));
  ...
  nand4  g16(.a(new_n57_), .b(x17), .c(x15), .d(new_n48_), .O(new_n58_));
  ...
  nand3  g41(.a(new_n82_), .b(new_n47_), .c(x14), .O(new_n83_));
  ...
  aoi21  g57(.a(new_n73_), .b(new_n44_), .c(new_n98_), .O(new_n99_));
  ...
  nand2  g61(.a(new_n102_), .b(new_n45_), .O(z16));
  ...
  nand4  g79(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n121_));
