...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x02), .c(new_n44_), .O(z01));
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n55_));
  ...
  nor2   g25(.a(new_n45_), .b(new_n48_), .O(z11));
  nand2  g26(.a(x13), .b(x12), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x02), .O(new_n69_));
  ...
  nand3  g37(.a(new_n78_), .b(x15), .c(x02), .O(new_n79_));
  ...
  nand2  g47(.a(new_n88_), .b(x02), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand3  g49(.a(new_n71_), .b(x16), .c(new_n48_), .O(new_n91_));
  ...
  oai21  g54(.a(new_n60_), .b(new_n77_), .c(x02), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x15), .O(new_n97_));
  nand2  g56(.a(new_n71_), .b(x17), .O(new_n98_));
  ...
  nand2  g62(.a(new_n103_), .b(x02), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x15), .O(new_n105_));
  nand2  g64(.a(new_n71_), .b(x18), .O(new_n106_));
  ...
  oai21  g69(.a(new_n58_), .b(new_n77_), .c(x02), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n71_), .b(x19), .O(new_n113_));
  ...
  oai21  g76(.a(new_n43_), .b(new_n77_), .c(x02), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n71_), .b(x20), .O(new_n120_));
