...
module FAU ( 
  ...
  nor2   g38(.a(new_n52_), .b(new_n79_), .O(new_n80_));
  aoi22  g39(.a(new_n80_), .b(x08), .c(new_n47_), .d(x14), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n72_), .c(new_n58_), .O(z13));
  nand2  g41(.a(new_n47_), .b(x15), .O(new_n83_));
  inv1   g42(.a(new_n53_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x02), .c(x01), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n72_), .O(z14));
  nor2   g45(.a(new_n72_), .b(new_n79_), .O(new_n87_));
  ...
  oai21  g52(.a(new_n48_), .b(new_n64_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x01), .O(new_n95_));
  nand2  g54(.a(x17), .b(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n72_), .O(z16));
  nand3  g56(.a(new_n87_), .b(x08), .c(x05), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x01), .O(new_n99_));
  ...
  nand2  g62(.a(new_n103_), .b(x01), .O(new_n104_));
  ...
  oai21  g67(.a(new_n48_), .b(new_n43_), .c(new_n108_), .O(new_n109_));
