...
module FAU ( 
  ...
  nand2  g21(.a(new_n52_), .b(x04), .O(z06));
  ...
  nor2   g29(.a(new_n43_), .b(new_n46_), .O(z11));
  ...
  nand3  g37(.a(new_n78_), .b(x14), .c(x04), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n58_), .O(z13));
  nand2  g39(.a(new_n52_), .b(x10), .O(new_n81_));
  nand2  g40(.a(x08), .b(x02), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n81_), .c(new_n48_), .d(new_n52_), .O(new_n83_));
  ...
  nand2  g50(.a(new_n53_), .b(new_n64_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x04), .O(new_n93_));
  ...
  oai21  g56(.a(new_n97_), .b(new_n81_), .c(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x04), .O(new_n99_));
  nand2  g58(.a(x18), .b(x15), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n58_), .O(z17));
  nand2  g60(.a(x08), .b(x06), .O(new_n102_));
  oai22  g61(.a(new_n102_), .b(new_n81_), .c(new_n48_), .d(new_n61_), .O(new_n103_));
  ...
  oai21  g67(.a(new_n108_), .b(new_n81_), .c(new_n107_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g69(.a(x20), .b(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n58_), .O(z19));
endmodule
