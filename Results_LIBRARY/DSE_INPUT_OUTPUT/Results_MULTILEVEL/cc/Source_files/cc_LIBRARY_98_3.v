...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n55_, new_n57_, new_n60_, new_n64_, new_n65_, new_n66_,
  ...
  nor2   g21(.a(z03), .b(new_n49_), .O(z11));
  ...
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(z12));
  inv1   g27(.a(x01), .O(new_n69_));
  oai21  g28(.a(new_n46_), .b(new_n69_), .c(x14), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n45_), .c(new_n64_), .O(z13));
