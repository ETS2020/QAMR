...
module FAU ( 
  ...
  nor2   g02(.a(x19), .b(x17), .O(new_n44_));
  ...
  nand3  g42(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n84_));
  ...
  nand2  g47(.a(x19), .b(new_n51_), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n47_), .c(new_n60_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g50(.a(new_n52_), .b(x17), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n67_), .O(z16));
  and2   g52(.a(x08), .b(x05), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n69_), .c(new_n52_), .d(x18), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n67_), .c(new_n46_), .O(z17));
  inv1   g55(.a(x19), .O(new_n97_));
  nand2  g56(.a(x17), .b(new_n51_), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n47_), .c(new_n97_), .O(new_n99_));
  ...
  nand3  g64(.a(new_n105_), .b(new_n46_), .c(x12), .O(new_n106_));
