...
module FAU ( 
  ...
  nor2   g22(.a(new_n44_), .b(x04), .O(z06));
  ...
  nand3  g43(.a(new_n57_), .b(x15), .c(new_n43_), .O(new_n85_));
  ...
  nand3  g49(.a(new_n57_), .b(x16), .c(new_n48_), .O(new_n91_));
  ...
  oai21  g68(.a(new_n62_), .b(new_n73_), .c(new_n43_), .O(new_n110_));
  ...
  nand3  g79(.a(x20), .b(x15), .c(new_n43_), .O(new_n121_));
