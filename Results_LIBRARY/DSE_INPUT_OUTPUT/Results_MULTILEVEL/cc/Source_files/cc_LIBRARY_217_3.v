...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n58_, new_n61_, new_n64_,
  ...
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(x16), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n68_), .c(new_n55_), .O(z12));
  ...
  nand3  g41(.a(new_n82_), .b(new_n81_), .c(new_n49_), .O(new_n83_));
  and2   g42(.a(new_n83_), .b(x12), .O(z14));
  nand3  g43(.a(new_n70_), .b(x08), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n49_), .c(new_n55_), .O(z15));
  nand2  g45(.a(new_n51_), .b(x17), .O(new_n87_));
  nand4  g46(.a(new_n50_), .b(x10), .c(x08), .d(x04), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n49_), .c(x12), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z16));
  nand2  g50(.a(new_n51_), .b(x18), .O(new_n92_));
  nand4  g51(.a(new_n50_), .b(x10), .c(x08), .d(x05), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n49_), .c(x12), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z17));
  nand2  g55(.a(new_n51_), .b(x19), .O(new_n97_));
  and2   g56(.a(x08), .b(x06), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n70_), .c(x16), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n97_), .c(new_n55_), .O(z18));
  nand2  g59(.a(new_n51_), .b(x20), .O(new_n101_));
  and2   g60(.a(x08), .b(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n70_), .c(x16), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n101_), .c(new_n55_), .O(z19));
endmodule
