...
module FAU ( 
  ...
  oai21  g17(.a(new_n46_), .b(x12), .c(new_n58_), .O(z05));
  nor2   g18(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  aoi21  g26(.a(x15), .b(new_n43_), .c(new_n47_), .O(z11));
