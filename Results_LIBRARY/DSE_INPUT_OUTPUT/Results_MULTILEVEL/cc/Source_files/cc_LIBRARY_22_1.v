...
module FAU ( 
  ...
  nand2  g30(.a(new_n56_), .b(new_n71_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n43_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x13), .O(new_n74_));
  nand4  g33(.a(new_n51_), .b(x10), .c(x08), .d(x00), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(z12));
  nand2  g35(.a(new_n56_), .b(new_n47_), .O(new_n77_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n70_), .O(z14));
  ...
  nand3  g48(.a(new_n43_), .b(x10), .c(x08), .O(new_n90_));
  ...
  aoi21  g52(.a(new_n93_), .b(z04), .c(new_n70_), .O(z17));
  nand4  g53(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n71_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(new_n97_));
  nand3  g56(.a(new_n90_), .b(x19), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z18));
  nand2  g58(.a(new_n56_), .b(x20), .O(new_n100_));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n70_), .O(z19));
  buf    g64(.a(x15), .O(z06));
endmodule
