...
module FAU ( 
  ...
  aoi21  g24(.a(x09), .b(x08), .c(new_n65_), .O(z10));
  nor2   g25(.a(new_n65_), .b(new_n48_), .O(z11));
  ...
  nand2  g33(.a(new_n69_), .b(new_n48_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x15), .O(new_n76_));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n69_), .b(new_n77_), .c(x14), .O(new_n78_));
  ...
  nand2  g47(.a(new_n69_), .b(x17), .O(new_n89_));
  ...
  nand2  g56(.a(new_n69_), .b(x19), .O(new_n98_));
  ...
  nand2  g62(.a(new_n69_), .b(x20), .O(new_n104_));
  nand4  g63(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n105_));
  ...
  aoi21  g67(.a(new_n49_), .b(x12), .c(new_n47_), .O(z03));
endmodule
