...
module FAU ( 
  ...
  nand2  g33(.a(new_n56_), .b(x12), .O(new_n75_));
  ...
  nand3  g41(.a(new_n43_), .b(x12), .c(x10), .O(new_n83_));
  ...
  nand3  g45(.a(new_n56_), .b(x16), .c(new_n47_), .O(new_n87_));
  ...
  oai21  g50(.a(x17), .b(new_n55_), .c(x15), .O(new_n92_));
  ...
  oai21  g56(.a(x18), .b(new_n55_), .c(x15), .O(new_n98_));
  nand2  g57(.a(new_n56_), .b(x18), .O(new_n99_));
  nand4  g58(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n100_));
  ...
  oai21  g62(.a(x19), .b(new_n55_), .c(x15), .O(new_n104_));
  ...
  nand4  g69(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n111_));
