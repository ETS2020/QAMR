...
module FAU ( 
  ...
  nor2   g24(.a(new_n44_), .b(new_n51_), .O(z11));
  ...
  oai21  g41(.a(new_n61_), .b(x14), .c(x12), .O(new_n83_));
  ...
  nand2  g48(.a(new_n52_), .b(x17), .O(new_n90_));
  nand3  g49(.a(new_n80_), .b(x08), .c(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n47_), .O(z16));
  oai21  g51(.a(x18), .b(new_n47_), .c(x15), .O(new_n93_));
  nand2  g52(.a(new_n48_), .b(x18), .O(new_n94_));
  nand4  g53(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n95_));
  ...
  nand3  g58(.a(new_n80_), .b(x08), .c(x06), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n47_), .O(z18));
  oai21  g60(.a(x20), .b(new_n47_), .c(x15), .O(new_n102_));
  ...
  nor4   g66(.a(new_n48_), .b(new_n43_), .c(x14), .d(new_n47_), .O(z03));
  buf    g67(.a(x15), .O(z06));
endmodule
