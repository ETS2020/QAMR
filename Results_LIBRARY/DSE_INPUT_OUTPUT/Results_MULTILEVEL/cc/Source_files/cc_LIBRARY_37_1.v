...
module FAU ( 
  ...
  nor2   g03(.a(new_n44_), .b(x17), .O(new_n45_));
  ...
  nand2  g18(.a(x19), .b(x17), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z05));
  oai21  g20(.a(new_n44_), .b(x17), .c(new_n52_), .O(z06));
  ...
  nand2  g28(.a(new_n47_), .b(new_n49_), .O(z11));
  inv1   g29(.a(x12), .O(new_n71_));
  inv1   g30(.a(x10), .O(new_n72_));
  nor2   g31(.a(x15), .b(new_n72_), .O(new_n73_));
  and2   g32(.a(x08), .b(x00), .O(new_n74_));
  aoi22  g33(.a(new_n74_), .b(new_n73_), .c(new_n53_), .d(x13), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n71_), .c(new_n47_), .O(z12));
  ...
  nand3  g49(.a(new_n90_), .b(new_n47_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z15));
  nand4  g51(.a(new_n44_), .b(new_n52_), .c(x10), .d(x08), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n63_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g54(.a(new_n53_), .b(x17), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n71_), .O(z16));
  and2   g56(.a(x08), .b(x05), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n73_), .c(new_n53_), .d(x18), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n71_), .c(new_n47_), .O(z17));
  nand2  g59(.a(new_n93_), .b(new_n60_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x06), .O(new_n102_));
  nand3  g61(.a(new_n53_), .b(x19), .c(x17), .O(new_n103_));
  ...
  nand3  g66(.a(new_n107_), .b(new_n47_), .c(x12), .O(new_n108_));
