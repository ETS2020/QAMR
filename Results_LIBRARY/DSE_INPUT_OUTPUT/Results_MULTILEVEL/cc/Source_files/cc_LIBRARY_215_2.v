...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n56_, new_n58_, new_n60_, new_n64_,
  ...
  nand2  g02(.a(new_n43_), .b(x04), .O(new_n44_));
  ...
  oai21  g13(.a(new_n54_), .b(new_n53_), .c(new_n44_), .O(z03));
  ...
  nand2  g33(.a(new_n53_), .b(new_n46_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  aoi22  g35(.a(new_n76_), .b(x14), .c(new_n75_), .d(x15), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n74_), .c(new_n44_), .O(z13));
  nand2  g37(.a(new_n53_), .b(x15), .O(new_n79_));
  inv1   g38(.a(new_n49_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n60_), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n74_), .O(z14));
  ...
  nand4  g44(.a(new_n49_), .b(x16), .c(new_n46_), .d(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(z15));
  nand3  g46(.a(new_n49_), .b(x17), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z16));
