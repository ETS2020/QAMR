...
module FAU ( 
  ...
  nand2  g30(.a(new_n47_), .b(new_n48_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x15), .O(new_n73_));
  nand3  g32(.a(x10), .b(x08), .c(x01), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(x20), .c(x14), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n55_), .O(z13));
  nand2  g35(.a(new_n47_), .b(x15), .O(new_n77_));
  nand4  g36(.a(new_n42_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  ...
  nand2  g41(.a(new_n82_), .b(x20), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n42_), .O(new_n84_));
  nand4  g43(.a(new_n51_), .b(x16), .c(new_n48_), .d(x12), .O(new_n85_));
  ...
  nand2  g50(.a(new_n47_), .b(x20), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n42_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x18), .O(new_n94_));
  and2   g53(.a(x08), .b(x05), .O(new_n95_));
  nand4  g54(.a(new_n95_), .b(x20), .c(new_n42_), .d(x10), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n94_), .c(new_n55_), .O(z17));
  ...
  nand4  g62(.a(new_n42_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
