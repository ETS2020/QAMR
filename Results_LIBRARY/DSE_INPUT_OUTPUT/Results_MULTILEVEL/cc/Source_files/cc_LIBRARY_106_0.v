...
module FAU ( 
  ...
  nand2  g35(.a(new_n76_), .b(x04), .O(new_n77_));
  nand2  g36(.a(x15), .b(x13), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(z12));
  aoi21  g38(.a(new_n47_), .b(new_n46_), .c(new_n52_), .O(new_n80_));
  ...
  oai22  g43(.a(new_n84_), .b(new_n73_), .c(new_n48_), .d(new_n52_), .O(new_n85_));
  ...
  nand4  g50(.a(new_n53_), .b(x16), .c(new_n46_), .d(x12), .O(new_n92_));
  ...
  nand2  g69(.a(new_n110_), .b(x04), .O(new_n111_));
