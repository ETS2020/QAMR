...
module FAU ( 
  ...
  oai21  g02(.a(x20), .b(new_n42_), .c(new_n43_), .O(z00));
  inv1   g03(.a(x20), .O(new_n45_));
  nand2  g04(.a(x10), .b(x08), .O(new_n46_));
  nor4   g05(.a(new_n46_), .b(new_n45_), .c(new_n42_), .d(x14), .O(z01));
  inv1   g06(.a(x11), .O(new_n48_));
  oai21  g07(.a(x20), .b(new_n42_), .c(x14), .O(new_n49_));
  nand3  g08(.a(new_n42_), .b(x10), .c(x08), .O(new_n50_));
  ...
  nand4  g15(.a(new_n56_), .b(x20), .c(x15), .d(new_n54_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(z03));
  nor2   g17(.a(x20), .b(new_n42_), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  oai21  g20(.a(x20), .b(new_n42_), .c(new_n61_), .O(z05));
  ...
  nor2   g26(.a(new_n59_), .b(new_n67_), .O(z08));
  inv1   g27(.a(x08), .O(new_n69_));
  inv1   g28(.a(x09), .O(new_n70_));
  nor3   g29(.a(new_n59_), .b(new_n70_), .c(new_n69_), .O(z09));
  aoi21  g30(.a(x09), .b(x08), .c(new_n59_), .O(z10));
  inv1   g31(.a(new_n49_), .O(z11));
  inv1   g32(.a(x12), .O(new_n74_));
  nand2  g33(.a(new_n46_), .b(new_n42_), .O(new_n75_));
  ...
  nand3  g63(.a(x20), .b(x18), .c(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n74_), .O(z17));
  oai21  g65(.a(new_n61_), .b(new_n74_), .c(x20), .O(new_n107_));
  ...
  nand2  g72(.a(new_n50_), .b(new_n45_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x07), .O(new_n115_));
  nand2  g74(.a(new_n50_), .b(x20), .O(new_n116_));
