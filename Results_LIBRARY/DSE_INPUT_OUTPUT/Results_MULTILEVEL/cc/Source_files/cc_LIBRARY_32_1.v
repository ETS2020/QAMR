...
module FAU ( 
  ...
  nand2  g38(.a(new_n74_), .b(x15), .O(new_n80_));
  nand3  g39(.a(new_n71_), .b(x08), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n43_), .O(z14));
  oai21  g41(.a(new_n62_), .b(x14), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand3  g43(.a(new_n74_), .b(x16), .c(new_n48_), .O(new_n85_));
  ...
  oai21  g48(.a(x17), .b(new_n43_), .c(x15), .O(new_n90_));
  ...
  aoi21  g66(.a(new_n49_), .b(x12), .c(new_n47_), .O(z03));
endmodule
