...
module FAU ( 
  ...
  aoi21  g27(.a(x15), .b(new_n68_), .c(new_n55_), .O(z12));
  nor2   g28(.a(new_n44_), .b(x14), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n47_), .c(new_n55_), .O(z13));
  nand3  g30(.a(new_n47_), .b(x15), .c(x12), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z14));
  nand2  g32(.a(x16), .b(new_n48_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x15), .c(new_n55_), .O(z15));
  aoi21  g34(.a(new_n60_), .b(x15), .c(new_n55_), .O(z16));
  inv1   g35(.a(x18), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x15), .c(new_n55_), .O(z17));
  aoi21  g37(.a(new_n58_), .b(x15), .c(new_n55_), .O(z18));
  aoi21  g38(.a(new_n43_), .b(x15), .c(new_n55_), .O(z19));
  buf    g39(.a(x15), .O(z06));
endmodule
