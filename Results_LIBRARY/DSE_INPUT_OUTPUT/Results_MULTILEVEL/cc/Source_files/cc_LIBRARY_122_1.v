...
module FAU ( 
  ...
  oai21  g50(.a(x18), .b(new_n55_), .c(x15), .O(new_n92_));
  nand2  g51(.a(new_n56_), .b(x18), .O(new_n93_));
  nand4  g52(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n92_), .O(z17));
  oai21  g56(.a(x19), .b(new_n55_), .c(x15), .O(new_n98_));
  nand2  g57(.a(new_n56_), .b(x19), .O(new_n99_));
