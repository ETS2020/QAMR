...
module FAU ( 
  ...
  nand2  g37(.a(new_n48_), .b(new_n55_), .O(new_n79_));
  ...
  nand3  g42(.a(new_n48_), .b(x20), .c(x15), .O(new_n84_));
  ...
  nand2  g48(.a(x20), .b(x15), .O(new_n90_));
  ...
  nand3  g69(.a(x20), .b(x19), .c(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n78_), .O(z18));
  nand2  g71(.a(new_n51_), .b(new_n43_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x07), .O(new_n114_));
  nand2  g73(.a(new_n51_), .b(x20), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n78_), .O(z19));
  buf    g75(.a(x15), .O(z06));
endmodule
