...
module FAU ( 
  ...
  nand2  g15(.a(new_n56_), .b(new_n47_), .O(z02));
  nand3  g16(.a(x15), .b(new_n48_), .c(x12), .O(new_n58_));
  oai21  g17(.a(new_n58_), .b(new_n49_), .c(new_n47_), .O(z03));
  nand2  g18(.a(new_n47_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nand2  g20(.a(new_n47_), .b(new_n61_), .O(z05));
  nand2  g21(.a(new_n53_), .b(new_n44_), .O(z06));
  ...
  nand3  g33(.a(new_n54_), .b(x13), .c(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(z12));
  inv1   g35(.a(x12), .O(new_n77_));
  oai21  g36(.a(new_n50_), .b(x14), .c(x15), .O(new_n78_));
  nand2  g37(.a(new_n50_), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x14), .c(new_n44_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(z13));
  nand4  g40(.a(new_n53_), .b(x10), .c(x08), .d(x02), .O(new_n82_));
  oai21  g41(.a(new_n50_), .b(new_n53_), .c(new_n82_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n47_), .O(z14));
  nand3  g44(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n86_));
  ...
  nand3  g48(.a(x16), .b(x15), .c(new_n48_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n77_), .O(z15));
  nand2  g50(.a(new_n49_), .b(x17), .O(new_n92_));
  nand4  g51(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  ...
  nand4  g57(.a(new_n53_), .b(x10), .c(x08), .d(x05), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(new_n101_));
  nand2  g60(.a(x18), .b(x15), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n77_), .O(z17));
  aoi21  g62(.a(new_n49_), .b(new_n44_), .c(x15), .O(new_n104_));
  nor3   g63(.a(new_n104_), .b(new_n61_), .c(new_n77_), .O(z18));
  ...
  nand3  g67(.a(new_n54_), .b(x20), .c(x12), .O(new_n109_));
