...
module FAU ( 
  ...
  nand2  g36(.a(new_n72_), .b(x15), .O(new_n78_));
  nand3  g37(.a(new_n69_), .b(x08), .c(x02), .O(new_n79_));
  ...
  nand3  g41(.a(new_n72_), .b(x16), .c(new_n48_), .O(new_n83_));
  nand4  g42(.a(new_n47_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  ...
  nand3  g47(.a(new_n69_), .b(x08), .c(x04), .O(new_n89_));
