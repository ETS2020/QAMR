...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n55_), .c(new_n49_), .O(z13));
  ...
  nand2  g50(.a(new_n86_), .b(x17), .O(new_n92_));
  ...
  nand2  g54(.a(new_n95_), .b(x19), .O(new_n96_));
  ...
  nand2  g61(.a(new_n102_), .b(new_n49_), .O(z18));
