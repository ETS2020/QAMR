...
module FAU ( 
  ...
  aoi21  g19(.a(x15), .b(x09), .c(x18), .O(z04));
  ...
  oai21  g25(.a(x15), .b(x08), .c(x09), .O(z10));
  inv1   g26(.a(z10), .O(z09));
  inv1   g27(.a(new_n52_), .O(z11));
  inv1   g28(.a(x12), .O(new_n70_));
  nand2  g29(.a(new_n57_), .b(new_n46_), .O(new_n71_));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n70_), .O(z16));
  ...
  oai21  g64(.a(new_n62_), .b(new_n70_), .c(new_n45_), .O(new_n106_));
  ...
  nand2  g71(.a(new_n57_), .b(x20), .O(new_n113_));
