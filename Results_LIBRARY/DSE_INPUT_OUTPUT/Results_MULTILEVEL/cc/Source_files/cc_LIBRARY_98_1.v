...
module FAU ( 
  ...
  nor2   g22(.a(new_n57_), .b(new_n63_), .O(z08));
  ...
  nor2   g27(.a(new_n57_), .b(new_n50_), .O(z11));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n81_), .c(new_n43_), .O(z14));
  ...
  nand3  g64(.a(new_n83_), .b(x08), .c(x06), .O(new_n106_));
