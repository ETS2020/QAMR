...
module FAU ( 
  ...
  nor2   g18(.a(x19), .b(x15), .O(new_n60_));
  ...
  nand4  g46(.a(new_n73_), .b(x16), .c(new_n49_), .d(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z15));
  aoi21  g48(.a(x10), .b(x08), .c(x19), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(x15), .c(x17), .O(new_n91_));
  nand4  g50(.a(new_n60_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  ...
  nand4  g58(.a(new_n60_), .b(x10), .c(x08), .d(x06), .O(new_n100_));
