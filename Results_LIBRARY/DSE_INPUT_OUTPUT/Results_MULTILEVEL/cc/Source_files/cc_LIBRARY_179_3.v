...
module FAU ( 
  ...
  nand2  g00(.a(x15), .b(x05), .O(new_n42_));
  ...
  nand4  g14(.a(x12), .b(x10), .c(x08), .d(new_n45_), .O(new_n56_));
  nor3   g15(.a(new_n56_), .b(new_n46_), .c(x14), .O(z03));
  nand2  g16(.a(new_n42_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  aoi21  g18(.a(x15), .b(x05), .c(new_n59_), .O(z05));
  nand2  g19(.a(x15), .b(new_n45_), .O(new_n61_));
  ...
  aoi21  g28(.a(x15), .b(x05), .c(new_n47_), .O(z11));
  ...
  oai21  g51(.a(new_n63_), .b(new_n71_), .c(new_n45_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x15), .O(new_n94_));
  nand2  g53(.a(new_n72_), .b(x17), .O(new_n95_));
  ...
  oai21  g64(.a(new_n59_), .b(new_n71_), .c(new_n45_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n72_), .b(x19), .O(new_n108_));
  nand2  g67(.a(x08), .b(x06), .O(new_n109_));
  oai21  g68(.a(new_n109_), .b(new_n52_), .c(new_n108_), .O(new_n110_));
