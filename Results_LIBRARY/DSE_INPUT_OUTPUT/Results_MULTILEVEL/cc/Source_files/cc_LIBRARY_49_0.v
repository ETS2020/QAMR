...
module FAU ( 
  ...
  nand2  g33(.a(new_n55_), .b(new_n46_), .O(new_n75_));
  ...
  aoi21  g47(.a(new_n88_), .b(new_n85_), .c(new_n74_), .O(z15));
  ...
  nand3  g54(.a(new_n87_), .b(x08), .c(x05), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n74_), .O(z17));
  ...
  nand2  g61(.a(new_n50_), .b(x20), .O(new_n103_));
  nand3  g62(.a(new_n87_), .b(x08), .c(x07), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n74_), .O(z19));
endmodule
