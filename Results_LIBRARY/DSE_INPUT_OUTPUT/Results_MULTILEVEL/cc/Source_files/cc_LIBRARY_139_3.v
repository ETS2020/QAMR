...
module FAU ( 
  ...
  nand3  g06(.a(x10), .b(x08), .c(new_n42_), .O(new_n48_));
  nor3   g07(.a(new_n48_), .b(new_n43_), .c(x14), .O(z01));
  ...
  nand2  g27(.a(new_n68_), .b(new_n42_), .O(new_n69_));
  ...
  nand2  g36(.a(new_n71_), .b(new_n50_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x15), .c(new_n42_), .O(new_n79_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n42_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand3  g49(.a(new_n71_), .b(x16), .c(new_n50_), .O(new_n91_));
  ...
  nand3  g58(.a(x17), .b(x15), .c(new_n42_), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n77_), .O(z16));
  nand3  g60(.a(x12), .b(x10), .c(x08), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n43_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x05), .O(new_n104_));
  nand3  g63(.a(new_n51_), .b(x18), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(z17));
  nand2  g65(.a(new_n71_), .b(x19), .O(new_n107_));
  ...
  nand3  g69(.a(x19), .b(x15), .c(new_n42_), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n77_), .O(z18));
  nand2  g71(.a(x20), .b(x12), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(new_n42_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x15), .O(new_n115_));
  nand2  g74(.a(new_n71_), .b(x20), .O(new_n116_));
  nand4  g75(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n117_));
