...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n56_, new_n57_, new_n60_, new_n62_, new_n64_,
  ...
  nor2   g15(.a(x15), .b(new_n52_), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n56_), .O(z05));
  nand2  g17(.a(new_n43_), .b(new_n52_), .O(z06));
  ...
  aoi21  g27(.a(x15), .b(new_n68_), .c(new_n52_), .O(z12));
  aoi21  g28(.a(x10), .b(x08), .c(x14), .O(new_n70_));
  nor3   g29(.a(new_n70_), .b(new_n43_), .c(new_n52_), .O(z13));
  ...
  aoi21  g34(.a(new_n60_), .b(x15), .c(new_n52_), .O(z16));
