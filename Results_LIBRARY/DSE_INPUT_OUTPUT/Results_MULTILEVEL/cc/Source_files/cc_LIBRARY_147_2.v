...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n62_, new_n64_, new_n66_, new_n70_, new_n71_, new_n72_,
  ...
  aoi21  g08(.a(new_n49_), .b(x19), .c(new_n47_), .O(z01));
  ...
  nand4  g16(.a(new_n57_), .b(x19), .c(x15), .d(new_n48_), .O(new_n58_));
  ...
  nor2   g27(.a(new_n60_), .b(new_n48_), .O(z11));
  inv1   g28(.a(x12), .O(new_n70_));
  aoi21  g29(.a(x10), .b(x08), .c(x15), .O(new_n71_));
  nor2   g30(.a(new_n43_), .b(new_n47_), .O(new_n72_));
  ...
  oai21  g52(.a(new_n62_), .b(new_n70_), .c(x19), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x15), .O(new_n95_));
  nand2  g54(.a(new_n77_), .b(x17), .O(new_n96_));
  ...
  nand2  g62(.a(new_n77_), .b(x18), .O(new_n104_));
  ...
  aoi21  g68(.a(new_n77_), .b(new_n43_), .c(new_n109_), .O(new_n110_));
  nand2  g69(.a(new_n77_), .b(x19), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  oai21  g71(.a(new_n112_), .b(new_n110_), .c(x12), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(new_n44_), .O(z18));
  ...
  nand3  g77(.a(x20), .b(x19), .c(x15), .O(new_n119_));
