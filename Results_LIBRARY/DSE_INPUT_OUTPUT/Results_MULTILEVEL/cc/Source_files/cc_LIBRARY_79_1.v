...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n93_, new_n95_, new_n97_, new_n98_, new_n99_, new_n100_, new_n102_,
  ...
  nand2  g19(.a(new_n60_), .b(new_n43_), .O(z06));
  ...
  nand3  g45(.a(new_n71_), .b(x16), .c(new_n48_), .O(new_n87_));
  ...
  nand3  g53(.a(new_n74_), .b(x08), .c(x05), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(z04), .c(new_n55_), .O(z17));
  nand4  g55(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n60_), .O(new_n98_));
  ...
  nand2  g61(.a(new_n102_), .b(new_n60_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n43_), .O(new_n104_));
  nand3  g63(.a(new_n51_), .b(x20), .c(x12), .O(new_n105_));
