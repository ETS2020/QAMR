...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n58_, new_n60_, new_n63_,
  ...
  aoi21  g54(.a(new_n96_), .b(new_n94_), .c(new_n45_), .O(z19));
  zero   g55(.O(z03));
  buf    g56(.a(x15), .O(z06));
endmodule
