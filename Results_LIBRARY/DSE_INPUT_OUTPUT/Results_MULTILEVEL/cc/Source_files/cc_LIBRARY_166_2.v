...
module FAU ( 
  ...
  nand4  g12(.a(new_n46_), .b(x12), .c(x10), .d(x08), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(x20), .c(new_n45_), .O(z03));
  nor2   g14(.a(x20), .b(new_n45_), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  oai21  g18(.a(x20), .b(new_n45_), .c(new_n59_), .O(z05));
  nor2   g19(.a(new_n43_), .b(new_n45_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n57_), .b(new_n62_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nor2   g23(.a(new_n56_), .b(new_n64_), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n57_), .O(z09));
  inv1   g26(.a(z09), .O(z10));
  nand2  g27(.a(new_n57_), .b(new_n46_), .O(z11));
  ...
  nand2  g38(.a(new_n73_), .b(new_n46_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x20), .c(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n45_), .c(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(z13));
  nand3  g43(.a(new_n73_), .b(x20), .c(x15), .O(new_n85_));
  ...
  oai21  g54(.a(new_n62_), .b(new_n79_), .c(x20), .O(new_n96_));
  ...
  nand2  g64(.a(new_n73_), .b(x18), .O(new_n106_));
  ...
  nand3  g73(.a(x20), .b(x19), .c(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(z18));
  nand2  g75(.a(new_n50_), .b(new_n43_), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x07), .O(new_n118_));
  nand2  g77(.a(new_n50_), .b(x20), .O(new_n119_));
