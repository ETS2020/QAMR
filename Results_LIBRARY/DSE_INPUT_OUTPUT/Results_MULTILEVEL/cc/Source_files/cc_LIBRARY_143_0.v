...
module FAU ( 
  ...
  nand2  g18(.a(new_n49_), .b(x05), .O(z06));
  ...
  nand2  g35(.a(new_n54_), .b(new_n46_), .O(new_n77_));
  ...
  inv1   g40(.a(new_n50_), .O(new_n82_));
  ...
  nand2  g44(.a(new_n85_), .b(x05), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n49_), .O(new_n87_));
  nand4  g46(.a(new_n50_), .b(x16), .c(new_n46_), .d(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z15));
  nand2  g48(.a(new_n54_), .b(x17), .O(new_n90_));
  nand4  g49(.a(new_n49_), .b(x10), .c(x08), .d(x04), .O(new_n91_));
  ...
  oai21  g54(.a(new_n82_), .b(x18), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(z17));
  nand2  g56(.a(new_n54_), .b(x19), .O(new_n98_));
  nand4  g57(.a(new_n49_), .b(x10), .c(x08), .d(x06), .O(new_n99_));
