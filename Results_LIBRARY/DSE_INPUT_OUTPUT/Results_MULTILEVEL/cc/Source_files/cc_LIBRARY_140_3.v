...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n65_, new_n69_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  nand2  g30(.a(new_n57_), .b(x13), .O(new_n72_));
  ...
  nand3  g42(.a(new_n57_), .b(new_n46_), .c(x15), .O(new_n84_));
  ...
  nand3  g57(.a(new_n46_), .b(x17), .c(x15), .O(new_n99_));
  ...
  aoi21  g68(.a(new_n57_), .b(new_n46_), .c(new_n109_), .O(new_n110_));
  aoi21  g69(.a(x10), .b(x08), .c(new_n46_), .O(new_n111_));
  oai21  g70(.a(new_n111_), .b(new_n110_), .c(new_n45_), .O(new_n112_));
  nor2   g71(.a(new_n112_), .b(new_n83_), .O(z18));
