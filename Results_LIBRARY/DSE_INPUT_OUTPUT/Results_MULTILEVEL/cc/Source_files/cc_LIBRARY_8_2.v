...
module FAU ( 
  ...
  nand3  g36(.a(new_n77_), .b(x19), .c(x15), .O(new_n78_));
  ...
  nand3  g48(.a(new_n76_), .b(x16), .c(new_n47_), .O(new_n90_));
  ...
  aoi21  g66(.a(new_n76_), .b(new_n61_), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n76_), .b(x19), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n43_), .O(new_n110_));
  oai21  g69(.a(new_n110_), .b(new_n108_), .c(x12), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n45_), .O(z18));
  nand2  g71(.a(new_n76_), .b(x20), .O(new_n113_));
