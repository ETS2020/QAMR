...
module FAU ( 
  ...
  oai21  g34(.a(new_n75_), .b(new_n53_), .c(new_n74_), .O(new_n76_));
  ...
  nand2  g49(.a(new_n73_), .b(new_n45_), .O(new_n91_));
  nand2  g50(.a(new_n46_), .b(x15), .O(new_n92_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(z15));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n90_), .O(z16));
  ...
  nand3  g65(.a(new_n46_), .b(x18), .c(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n90_), .O(z17));
  ...
  nand2  g71(.a(new_n112_), .b(new_n43_), .O(z18));
  ...
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n90_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
