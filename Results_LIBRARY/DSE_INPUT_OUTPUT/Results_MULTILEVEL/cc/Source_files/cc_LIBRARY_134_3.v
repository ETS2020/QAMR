...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n58_, new_n62_, new_n63_, new_n64_, new_n65_, new_n67_,
    ...
    new_n87_, new_n89_, new_n90_, new_n91_, new_n92_;
  ...
  nand3  g16(.a(new_n42_), .b(x09), .c(x08), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z09));
  nand3  g18(.a(new_n42_), .b(x09), .c(x08), .O(z10));
  nand2  g19(.a(new_n42_), .b(new_n49_), .O(z11));
  inv1   g20(.a(x12), .O(new_n62_));
  nand2  g21(.a(new_n46_), .b(x13), .O(new_n63_));
  nand3  g22(.a(x10), .b(x08), .c(x00), .O(new_n64_));
  and2   g23(.a(new_n64_), .b(new_n45_), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(z12));
  inv1   g25(.a(x01), .O(new_n67_));
  oai21  g26(.a(new_n46_), .b(new_n67_), .c(x14), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n45_), .c(new_n62_), .O(z13));
  nand3  g28(.a(x10), .b(x08), .c(x02), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n45_), .c(new_n62_), .O(z14));
  nand3  g30(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n72_));
  nand3  g31(.a(x10), .b(x08), .c(x03), .O(new_n73_));
  and2   g32(.a(new_n73_), .b(new_n45_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n62_), .O(z15));
  nand2  g34(.a(new_n46_), .b(x17), .O(new_n76_));
  ...
  nand2  g39(.a(new_n46_), .b(x18), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x05), .O(new_n82_));
  and2   g41(.a(new_n82_), .b(new_n45_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n62_), .O(z17));
  nand2  g43(.a(new_n46_), .b(x19), .O(new_n85_));
  nand3  g44(.a(x10), .b(x08), .c(x06), .O(new_n86_));
  and2   g45(.a(new_n86_), .b(new_n45_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n62_), .O(z18));
