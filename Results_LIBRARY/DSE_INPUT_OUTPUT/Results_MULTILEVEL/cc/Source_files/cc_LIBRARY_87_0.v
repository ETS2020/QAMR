...
module FAU ( 
  ...
  nand2  g32(.a(new_n73_), .b(new_n58_), .O(z12));
  inv1   g33(.a(x12), .O(new_n75_));
  aoi21  g34(.a(new_n47_), .b(new_n46_), .c(new_n52_), .O(new_n76_));
  nand2  g35(.a(new_n48_), .b(x01), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x14), .c(new_n76_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n75_), .c(new_n58_), .O(z13));
  nand2  g38(.a(new_n52_), .b(x10), .O(new_n80_));
  nand2  g39(.a(x08), .b(x02), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n80_), .c(new_n48_), .d(new_n52_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n58_), .O(z14));
  nand3  g43(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n85_));
  nand2  g44(.a(x08), .b(x03), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n80_), .c(new_n85_), .O(new_n87_));
  ...
  oai22  g50(.a(new_n91_), .b(new_n80_), .c(new_n48_), .d(new_n64_), .O(new_n92_));
  ...
  oai21  g56(.a(new_n97_), .b(new_n80_), .c(new_n96_), .O(new_n98_));
  ...
  oai22  g61(.a(new_n102_), .b(new_n80_), .c(new_n48_), .d(new_n62_), .O(new_n103_));
  ...
  nand2  g66(.a(new_n107_), .b(x00), .O(new_n108_));
