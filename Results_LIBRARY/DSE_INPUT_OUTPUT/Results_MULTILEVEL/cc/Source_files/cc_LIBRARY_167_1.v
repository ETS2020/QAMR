...
module FAU ( 
  ...
  oai21  g15(.a(new_n43_), .b(x12), .c(new_n56_), .O(z05));
  ...
  oai21  g26(.a(x13), .b(new_n58_), .c(x15), .O(new_n68_));
  ...
  nand2  g33(.a(new_n69_), .b(new_n47_), .O(new_n75_));
  ...
  nand3  g45(.a(new_n69_), .b(x16), .c(new_n47_), .O(new_n87_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n92_), .c(new_n58_), .O(z16));
  oai21  g55(.a(x18), .b(new_n58_), .c(x15), .O(new_n97_));
  nand2  g56(.a(new_n69_), .b(x18), .O(new_n98_));
  nand4  g57(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n97_), .O(z17));
  oai21  g61(.a(x19), .b(new_n58_), .c(x15), .O(new_n103_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n58_), .O(z19));
  aoi21  g70(.a(new_n48_), .b(x12), .c(new_n43_), .O(z03));
endmodule
