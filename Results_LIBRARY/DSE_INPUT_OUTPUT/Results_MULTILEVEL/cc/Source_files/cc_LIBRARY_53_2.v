...
module FAU ( 
  ...
  nand3  g28(.a(new_n53_), .b(x13), .c(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n45_), .O(z12));
  oai21  g30(.a(new_n49_), .b(x14), .c(x15), .O(new_n72_));
  nand2  g31(.a(new_n49_), .b(x01), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x14), .c(new_n43_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n57_), .O(z13));
  nand2  g34(.a(new_n48_), .b(x15), .O(new_n76_));
  inv1   g35(.a(new_n53_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x02), .c(new_n43_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n57_), .O(z14));
  nand3  g38(.a(new_n48_), .b(x16), .c(new_n47_), .O(new_n80_));
  nand4  g39(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n81_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n57_), .O(z15));
