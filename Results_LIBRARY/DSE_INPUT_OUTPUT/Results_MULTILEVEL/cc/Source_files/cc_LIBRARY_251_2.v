...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x17), .c(new_n44_), .O(z01));
  ...
  aoi21  g20(.a(new_n60_), .b(x15), .c(new_n61_), .O(z05));
  nor2   g21(.a(new_n60_), .b(new_n44_), .O(z06));
  ...
  aoi21  g57(.a(new_n73_), .b(new_n60_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n79_), .O(z18));
  oai21  g76(.a(new_n43_), .b(new_n79_), .c(x17), .O(new_n118_));
