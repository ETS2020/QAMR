...
module FAU ( 
  ...
  aoi21  g03(.a(new_n44_), .b(new_n42_), .c(new_n43_), .O(z00));
  inv1   g04(.a(x08), .O(new_n46_));
  inv1   g05(.a(x10), .O(new_n47_));
  inv1   g06(.a(x14), .O(new_n48_));
  nand2  g07(.a(x11), .b(x03), .O(new_n49_));
  ...
  nand3  g13(.a(new_n54_), .b(x12), .c(new_n43_), .O(new_n55_));
  ...
  aoi21  g20(.a(x11), .b(x03), .c(new_n52_), .O(z06));
  and2   g21(.a(new_n49_), .b(x17), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nand2  g23(.a(new_n49_), .b(new_n64_), .O(z08));
  nand3  g24(.a(new_n49_), .b(x09), .c(x08), .O(new_n66_));
  ...
  nand2  g45(.a(new_n52_), .b(x12), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n76_), .c(new_n43_), .O(new_n88_));
  ...
  nand3  g60(.a(new_n101_), .b(new_n49_), .c(x12), .O(new_n102_));
  ...
  nand3  g65(.a(new_n106_), .b(new_n49_), .c(x12), .O(new_n107_));
