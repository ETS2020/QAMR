...
module FAU ( 
  ...
  nor2   g12(.a(new_n43_), .b(x15), .O(new_n54_));
  ...
  nor2   g21(.a(new_n54_), .b(new_n62_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nor2   g23(.a(new_n54_), .b(new_n64_), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n55_), .O(z09));
  inv1   g26(.a(z09), .O(z10));
  nand2  g27(.a(new_n55_), .b(new_n45_), .O(z11));
  ...
  nand2  g42(.a(new_n46_), .b(new_n43_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n50_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x16), .c(new_n45_), .O(new_n86_));
  nor2   g45(.a(x20), .b(x15), .O(new_n87_));
  nand4  g46(.a(new_n87_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n57_), .O(z15));
  ...
  nand2  g66(.a(new_n107_), .b(new_n55_), .O(z19));
  buf    g67(.a(x15), .O(z06));
endmodule
