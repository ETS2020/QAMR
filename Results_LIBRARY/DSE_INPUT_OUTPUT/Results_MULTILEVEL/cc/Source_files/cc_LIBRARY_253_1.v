...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n61_, new_n63_, new_n65_, new_n67_, new_n69_, new_n70_, new_n73_,
  ...
  oai21  g09(.a(new_n43_), .b(x09), .c(x14), .O(new_n51_));
  ...
  aoi21  g17(.a(new_n58_), .b(x09), .c(new_n43_), .O(z03));
  ...
  nand2  g28(.a(new_n43_), .b(new_n69_), .O(new_n70_));
  oai21  g29(.a(new_n69_), .b(x08), .c(new_n70_), .O(z10));
  aoi21  g30(.a(x15), .b(new_n69_), .c(new_n47_), .O(z11));
  inv1   g31(.a(x12), .O(new_n73_));
  nand2  g32(.a(new_n56_), .b(new_n43_), .O(new_n74_));
  nand2  g33(.a(x15), .b(x09), .O(new_n75_));
  ...
  nand2  g41(.a(new_n82_), .b(x09), .O(new_n83_));
  ...
  nand2  g46(.a(new_n56_), .b(x15), .O(new_n88_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n73_), .O(z15));
  ...
  nand2  g61(.a(new_n102_), .b(x09), .O(new_n103_));
  ...
  oai21  g68(.a(new_n61_), .b(new_n73_), .c(x09), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n56_), .b(x19), .O(new_n112_));
  nand4  g71(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n113_));
  ...
  nand2  g75(.a(new_n56_), .b(x20), .O(new_n117_));
  ...
  nand3  g79(.a(x20), .b(x15), .c(x09), .O(new_n121_));
