...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x20), .c(new_n44_), .O(z03));
  ...
  nor2   g29(.a(new_n43_), .b(new_n44_), .O(new_n71_));
  ...
  nand2  g35(.a(new_n48_), .b(new_n55_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x20), .c(x15), .O(new_n78_));
  ...
  nand3  g55(.a(x20), .b(x17), .c(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n69_), .O(z16));
  ...
  oai21  g65(.a(new_n59_), .b(new_n69_), .c(x20), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand2  g67(.a(new_n48_), .b(x19), .O(new_n109_));
  nand4  g68(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n110_));
  ...
  aoi21  g73(.a(new_n48_), .b(new_n43_), .c(new_n114_), .O(new_n115_));
  nand2  g74(.a(new_n48_), .b(x20), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n44_), .O(new_n117_));
  oai21  g76(.a(new_n117_), .b(new_n115_), .c(x12), .O(new_n118_));
