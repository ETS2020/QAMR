...
module FAU ( 
  ...
  nor2   g17(.a(new_n42_), .b(x18), .O(z04));
  ...
  nor3   g26(.a(new_n42_), .b(new_n67_), .c(new_n66_), .O(z09));
  aoi21  g27(.a(x09), .b(x08), .c(new_n42_), .O(z10));
  inv1   g28(.a(new_n51_), .O(z11));
  nand2  g29(.a(new_n50_), .b(x20), .O(new_n71_));
  ...
  nand2  g52(.a(new_n72_), .b(x18), .O(new_n94_));
  nand3  g53(.a(new_n75_), .b(x08), .c(x05), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n57_), .O(z17));
