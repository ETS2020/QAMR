...
module FAU ( 
  ...
  oai21  g56(.a(x20), .b(new_n43_), .c(x15), .O(new_n98_));
  nand2  g57(.a(new_n48_), .b(x20), .O(new_n99_));
  nand4  g58(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n98_), .O(z19));
  buf    g62(.a(x15), .O(z06));
endmodule
