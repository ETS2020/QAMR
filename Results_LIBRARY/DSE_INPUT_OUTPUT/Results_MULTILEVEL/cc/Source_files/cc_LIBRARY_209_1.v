...
module FAU ( 
  ...
  nand4  g29(.a(new_n44_), .b(x10), .c(x08), .d(x00), .O(new_n71_));
  ...
  nand3  g34(.a(new_n51_), .b(x15), .c(x11), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n44_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(z13));
  nand2  g38(.a(new_n48_), .b(x15), .O(new_n80_));
  nand4  g39(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n81_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(x11), .O(new_n97_));
  ...
  oai21  g65(.a(new_n57_), .b(new_n75_), .c(x11), .O(new_n107_));
  ...
  oai21  g72(.a(new_n43_), .b(new_n75_), .c(x11), .O(new_n114_));
