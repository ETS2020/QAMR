...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    ...
    new_n64_, new_n65_, new_n68_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  oai21  g08(.a(new_n44_), .b(x05), .c(x14), .O(new_n50_));
  ...
  nand2  g37(.a(new_n70_), .b(new_n68_), .O(new_n79_));
  ...
  nand3  g58(.a(new_n70_), .b(x18), .c(new_n44_), .O(new_n100_));
  ...
  nand3  g64(.a(x19), .b(x15), .c(x05), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n55_), .O(z18));
  oai21  g66(.a(new_n43_), .b(new_n55_), .c(x05), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n70_), .b(x20), .O(new_n110_));
  nand4  g69(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n111_));
