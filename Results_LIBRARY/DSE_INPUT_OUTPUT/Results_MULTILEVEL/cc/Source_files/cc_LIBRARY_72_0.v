...
module FAU ( 
  ...
  nand2  g20(.a(new_n52_), .b(x09), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n44_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nand2  g24(.a(new_n44_), .b(new_n65_), .O(z08));
  inv1   g25(.a(x09), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n51_), .c(new_n44_), .O(z09));
  nand2  g27(.a(x15), .b(new_n67_), .O(new_n69_));
  oai21  g28(.a(new_n67_), .b(x08), .c(new_n69_), .O(z10));
  aoi21  g29(.a(new_n52_), .b(new_n67_), .c(new_n47_), .O(z11));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n57_), .O(z17));
  ...
  nand2  g66(.a(new_n107_), .b(x09), .O(new_n108_));
  nand2  g67(.a(x19), .b(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n57_), .O(z18));
  ...
  nand2  g72(.a(new_n84_), .b(x08), .O(new_n114_));
