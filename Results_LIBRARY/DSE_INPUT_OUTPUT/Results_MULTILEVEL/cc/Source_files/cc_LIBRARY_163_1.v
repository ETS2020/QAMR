...
module FAU ( 
  ...
  oai21  g25(.a(x13), .b(new_n66_), .c(x15), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n84_), .c(new_n66_), .O(z15));
  oai21  g47(.a(x17), .b(new_n66_), .c(x15), .O(new_n89_));
  nand2  g48(.a(new_n68_), .b(x17), .O(new_n90_));
  ...
  nand3  g54(.a(new_n86_), .b(x08), .c(x05), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n66_), .O(z17));
  nand2  g56(.a(new_n51_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n86_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n66_), .O(z18));
  nand2  g59(.a(new_n51_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n86_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n66_), .O(z19));
  aoi21  g62(.a(new_n48_), .b(x12), .c(new_n43_), .O(z03));
  buf    g63(.a(x15), .O(z06));
endmodule
