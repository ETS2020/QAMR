...
module FAU ( 
  ...
  nor2   g03(.a(x20), .b(x13), .O(new_n45_));
  ...
  nand2  g31(.a(x20), .b(new_n51_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n47_), .c(new_n72_), .O(new_n74_));
  ...
  nand3  g40(.a(new_n81_), .b(new_n46_), .c(x12), .O(new_n82_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n46_), .O(z14));
  nand3  g49(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n91_));
  ...
  inv1   g53(.a(new_n94_), .O(z15));
  and2   g54(.a(x08), .b(x04), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n86_), .c(new_n52_), .d(x17), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n71_), .c(new_n46_), .O(z16));
  nand2  g57(.a(new_n52_), .b(x18), .O(new_n99_));
  nand3  g58(.a(new_n86_), .b(x08), .c(x05), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n46_), .c(x12), .O(new_n102_));
  ...
  nand3  g65(.a(new_n106_), .b(new_n46_), .c(x12), .O(new_n107_));
  inv1   g66(.a(new_n107_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  aoi21  g68(.a(new_n52_), .b(new_n43_), .c(new_n109_), .O(new_n110_));
  and2   g69(.a(new_n52_), .b(x20), .O(new_n111_));
  oai21  g70(.a(new_n111_), .b(new_n110_), .c(x12), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n46_), .O(z19));
endmodule
