...
module FAU ( 
  ...
  nand3  g13(.a(new_n47_), .b(x12), .c(x08), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(x10), .c(new_n44_), .O(z03));
  ...
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(new_n44_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  nor2   g33(.a(x15), .b(new_n66_), .O(new_n75_));
  nand4  g34(.a(new_n44_), .b(x10), .c(x08), .d(x00), .O(new_n76_));
  oai21  g35(.a(new_n75_), .b(new_n72_), .c(new_n76_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x12), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z12));
  aoi21  g38(.a(x08), .b(x01), .c(new_n47_), .O(new_n80_));
  nor2   g39(.a(new_n44_), .b(new_n66_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(x10), .O(new_n82_));
  nand3  g41(.a(new_n44_), .b(x14), .c(new_n58_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n71_), .O(z13));
  inv1   g43(.a(x02), .O(new_n85_));
  nand2  g44(.a(new_n44_), .b(x08), .O(new_n86_));
  nand2  g45(.a(x15), .b(new_n66_), .O(new_n87_));
  oai21  g46(.a(new_n86_), .b(new_n85_), .c(new_n87_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x12), .c(x10), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z14));
  nand3  g49(.a(x16), .b(new_n47_), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n58_), .O(new_n93_));
  nand3  g52(.a(new_n86_), .b(x16), .c(new_n47_), .O(new_n94_));
  ...
  nand2  g58(.a(x10), .b(x08), .O(new_n100_));
  oai22  g59(.a(new_n100_), .b(new_n99_), .c(new_n62_), .d(x10), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n44_), .O(new_n102_));
  nand3  g61(.a(new_n86_), .b(x17), .c(x10), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n71_), .O(z16));
  inv1   g63(.a(x05), .O(new_n105_));
  inv1   g64(.a(x18), .O(new_n106_));
  oai22  g65(.a(new_n100_), .b(new_n105_), .c(new_n106_), .d(x10), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n44_), .O(new_n108_));
  nand3  g67(.a(new_n86_), .b(x18), .c(x10), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n71_), .O(z17));
  oai21  g69(.a(new_n59_), .b(new_n71_), .c(new_n44_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n58_), .O(new_n112_));
  nand4  g71(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n113_));
  oai21  g72(.a(new_n75_), .b(new_n59_), .c(new_n113_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x12), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(new_n112_), .O(z18));
  oai21  g75(.a(new_n43_), .b(new_n71_), .c(new_n44_), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(new_n58_), .O(new_n118_));
