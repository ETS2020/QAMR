...
module FAU ( 
  ...
  nand2  g01(.a(x15), .b(x01), .O(new_n43_));
  ...
  aoi21  g18(.a(x15), .b(x01), .c(new_n59_), .O(z05));
  nor2   g19(.a(new_n45_), .b(x01), .O(z06));
  ...
  nand3  g46(.a(new_n81_), .b(x16), .c(new_n47_), .O(new_n88_));
  ...
  oai21  g51(.a(new_n62_), .b(new_n70_), .c(new_n46_), .O(new_n93_));
  ...
  nand2  g61(.a(new_n81_), .b(x18), .O(new_n103_));
  ...
  nand2  g72(.a(new_n81_), .b(x20), .O(new_n114_));
