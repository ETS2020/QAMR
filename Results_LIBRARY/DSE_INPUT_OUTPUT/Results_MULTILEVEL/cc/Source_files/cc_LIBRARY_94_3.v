...
module FAU ( 
  ...
  nand2  g21(.a(new_n44_), .b(x15), .O(new_n63_));
  ...
  nand2  g28(.a(new_n69_), .b(new_n54_), .O(z09));
  inv1   g29(.a(z09), .O(z10));
  nand2  g30(.a(new_n54_), .b(new_n49_), .O(z11));
  ...
  nand2  g40(.a(new_n46_), .b(new_n49_), .O(new_n82_));
  ...
  nand2  g45(.a(new_n46_), .b(x15), .O(new_n87_));
  nand2  g46(.a(x08), .b(x02), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n50_), .c(new_n87_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n54_), .O(z14));
  nand2  g50(.a(new_n46_), .b(new_n43_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n63_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n49_), .O(new_n94_));
  nand4  g53(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n81_), .O(z15));
  oai21  g55(.a(new_n65_), .b(new_n81_), .c(new_n44_), .O(new_n97_));
  ...
  nand2  g65(.a(new_n46_), .b(x18), .O(new_n107_));
  ...
  oai21  g70(.a(new_n61_), .b(new_n81_), .c(new_n44_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x15), .O(new_n113_));
  nand2  g72(.a(new_n46_), .b(x19), .O(new_n114_));
  ...
  oai21  g79(.a(new_n120_), .b(new_n50_), .c(new_n119_), .O(new_n121_));
  nand2  g80(.a(new_n121_), .b(x12), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(new_n54_), .O(z19));
endmodule
