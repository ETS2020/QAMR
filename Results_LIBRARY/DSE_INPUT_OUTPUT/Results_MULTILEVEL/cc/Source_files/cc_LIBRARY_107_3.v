...
module FAU ( 
  ...
  nand2  g51(.a(new_n46_), .b(new_n43_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n63_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x16), .c(new_n49_), .O(new_n95_));
  ...
  nand3  g60(.a(new_n44_), .b(x17), .c(x15), .O(new_n102_));
