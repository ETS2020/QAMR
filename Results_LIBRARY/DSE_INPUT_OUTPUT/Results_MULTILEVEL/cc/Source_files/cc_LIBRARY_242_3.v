...
module FAU ( 
  ...
  nand4  g42(.a(new_n45_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  ...
  nand3  g49(.a(new_n71_), .b(x16), .c(new_n47_), .O(new_n91_));
  ...
  nand2  g55(.a(new_n71_), .b(x17), .O(new_n97_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z16));
  ...
  aoi21  g70(.a(new_n71_), .b(new_n46_), .c(new_n111_), .O(new_n112_));
  aoi21  g71(.a(x10), .b(x08), .c(new_n46_), .O(new_n113_));
  oai21  g72(.a(new_n113_), .b(new_n112_), .c(new_n45_), .O(new_n114_));
  nor2   g73(.a(new_n114_), .b(new_n96_), .O(z18));
