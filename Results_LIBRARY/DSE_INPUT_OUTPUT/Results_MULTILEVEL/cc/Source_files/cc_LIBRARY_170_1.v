...
module FAU ( 
  ...
  nor2   g19(.a(new_n44_), .b(new_n53_), .O(z05));
  ...
  aoi21  g30(.a(x10), .b(x08), .c(x19), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(x15), .c(x13), .O(new_n73_));
  nand3  g32(.a(new_n44_), .b(new_n53_), .c(x10), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(x08), .c(x00), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n73_), .c(new_n71_), .O(z12));
  ...
  oai21  g48(.a(new_n72_), .b(x15), .c(x17), .O(new_n90_));
  nand3  g49(.a(new_n75_), .b(x08), .c(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n71_), .O(z16));
  oai21  g51(.a(new_n72_), .b(x15), .c(x18), .O(new_n93_));
  nand3  g52(.a(new_n75_), .b(x08), .c(x05), .O(new_n94_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n52_), .O(z18));
  nand2  g58(.a(new_n48_), .b(x20), .O(new_n100_));
  nand4  g59(.a(new_n53_), .b(x10), .c(x08), .d(x07), .O(new_n101_));
