...
module FAU ( 
  ...
  nor4   g07(.a(new_n48_), .b(z04), .c(new_n44_), .d(x14), .O(z01));
  ...
  nand4  g17(.a(new_n58_), .b(x18), .c(x15), .d(new_n52_), .O(new_n59_));
  ...
  nand2  g30(.a(new_n50_), .b(new_n52_), .O(z11));
  ...
  nand2  g38(.a(new_n48_), .b(new_n52_), .O(new_n80_));
  ...
  nand3  g48(.a(new_n75_), .b(x16), .c(new_n52_), .O(new_n90_));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n73_), .O(z16));
  inv1   g57(.a(x05), .O(new_n99_));
  aoi21  g58(.a(new_n48_), .b(z04), .c(new_n99_), .O(new_n100_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n50_), .O(z17));
  ...
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n73_), .O(z18));
  ...
  nand3  g73(.a(x20), .b(x18), .c(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n73_), .O(z19));
endmodule
