...
module FAU ( 
  ...
  oai21  g16(.a(new_n46_), .b(new_n45_), .c(new_n58_), .O(z05));
  nor2   g17(.a(new_n46_), .b(x12), .O(z06));
  inv1   g18(.a(x17), .O(new_n61_));
  nand2  g19(.a(new_n43_), .b(new_n61_), .O(z07));
  inv1   g20(.a(x16), .O(new_n63_));
  nand2  g21(.a(new_n43_), .b(new_n63_), .O(z08));
  nand3  g22(.a(new_n43_), .b(x09), .c(x08), .O(new_n65_));
  inv1   g23(.a(new_n65_), .O(z09));
  nand3  g24(.a(new_n43_), .b(x09), .c(x08), .O(z10));
  nor2   g25(.a(new_n56_), .b(new_n47_), .O(z11));
  nand2  g26(.a(new_n51_), .b(x13), .O(new_n69_));
  nand3  g27(.a(x10), .b(x08), .c(x00), .O(new_n70_));
  nand2  g28(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g29(.a(new_n71_), .b(new_n46_), .c(x12), .O(new_n72_));
  inv1   g30(.a(new_n72_), .O(z12));
  inv1   g31(.a(x01), .O(new_n74_));
  oai21  g32(.a(new_n51_), .b(new_n74_), .c(x14), .O(new_n75_));
  aoi21  g33(.a(new_n75_), .b(new_n46_), .c(new_n45_), .O(z13));
  nand3  g34(.a(x10), .b(x08), .c(x02), .O(new_n77_));
  aoi21  g35(.a(new_n77_), .b(new_n46_), .c(new_n45_), .O(z14));
  nand3  g36(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n79_));
  nand3  g37(.a(x10), .b(x08), .c(x03), .O(new_n80_));
  nand2  g38(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g39(.a(new_n81_), .b(new_n46_), .c(x12), .O(new_n82_));
  inv1   g40(.a(new_n82_), .O(z15));
  nand2  g41(.a(new_n51_), .b(x17), .O(new_n84_));
  nand3  g42(.a(x10), .b(x08), .c(x04), .O(new_n85_));
  and2   g43(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  aoi21  g44(.a(new_n86_), .b(new_n84_), .c(new_n45_), .O(z16));
  nand2  g45(.a(new_n51_), .b(x18), .O(new_n88_));
  nand3  g46(.a(x10), .b(x08), .c(x05), .O(new_n89_));
  and2   g47(.a(new_n89_), .b(new_n46_), .O(new_n90_));
  aoi21  g48(.a(new_n90_), .b(new_n88_), .c(new_n45_), .O(z17));
  nand2  g49(.a(new_n51_), .b(x19), .O(new_n92_));
  nand3  g50(.a(x10), .b(x08), .c(x06), .O(new_n93_));
  and2   g51(.a(new_n93_), .b(new_n46_), .O(new_n94_));
  aoi21  g52(.a(new_n94_), .b(new_n92_), .c(new_n45_), .O(z18));
  nand2  g53(.a(new_n51_), .b(x20), .O(new_n96_));
