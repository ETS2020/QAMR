...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n51_,
    new_n52_, new_n55_, new_n57_, new_n59_, new_n63_, new_n65_, new_n66_,
  ...
  nor4   g11(.a(new_n46_), .b(new_n52_), .c(x14), .d(new_n51_), .O(z03));
  ...
  aoi21  g19(.a(x09), .b(x08), .c(new_n43_), .O(z10));
  inv1   g20(.a(z10), .O(z09));
  inv1   g21(.a(x14), .O(new_n63_));
  nand2  g22(.a(x15), .b(new_n63_), .O(z11));
  nand2  g23(.a(new_n46_), .b(x14), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n52_), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(x13), .O(new_n67_));
  nand3  g26(.a(new_n52_), .b(x14), .c(x10), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x08), .c(x00), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(new_n51_), .O(z12));
  aoi21  g30(.a(new_n46_), .b(new_n63_), .c(new_n52_), .O(new_n72_));
  nand3  g31(.a(x10), .b(x08), .c(x01), .O(new_n73_));
  and2   g32(.a(new_n73_), .b(new_n52_), .O(new_n74_));
  ...
  nand4  g36(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n44_), .O(z14));
  nand3  g40(.a(new_n69_), .b(x08), .c(x03), .O(new_n82_));
  nand3  g41(.a(x16), .b(x15), .c(new_n63_), .O(new_n83_));
  ...
  nand3  g46(.a(new_n52_), .b(x10), .c(x08), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x17), .c(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n87_), .O(z16));
  nand2  g49(.a(new_n46_), .b(x18), .O(new_n91_));
  nand4  g50(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x14), .O(new_n94_));
  nand2  g53(.a(x18), .b(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n51_), .O(z17));
  ...
  nand3  g58(.a(new_n88_), .b(x19), .c(x12), .O(new_n100_));
  ...
  nand3  g63(.a(new_n88_), .b(x20), .c(x12), .O(new_n105_));
