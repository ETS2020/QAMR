...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(new_n49_), .c(new_n51_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n79_), .b(new_n44_), .c(x15), .O(new_n80_));
  ...
  nand3  g42(.a(new_n78_), .b(new_n44_), .c(x15), .O(new_n84_));
  ...
  nand3  g48(.a(new_n78_), .b(x16), .c(new_n46_), .O(new_n90_));
  ...
  nand2  g53(.a(new_n78_), .b(x17), .O(new_n95_));
  ...
  nand3  g57(.a(new_n44_), .b(x17), .c(x15), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n72_), .O(z16));
  nand2  g59(.a(x18), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n44_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n78_), .b(x18), .O(new_n104_));
  ...
  oai21  g67(.a(new_n61_), .b(new_n72_), .c(new_n44_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n78_), .b(x19), .O(new_n111_));
  ...
  aoi21  g75(.a(new_n78_), .b(new_n44_), .c(new_n116_), .O(new_n117_));
  aoi21  g76(.a(x10), .b(x08), .c(new_n44_), .O(new_n118_));
  oai21  g77(.a(new_n118_), .b(new_n117_), .c(new_n43_), .O(new_n119_));
  nor2   g78(.a(new_n119_), .b(new_n72_), .O(z19));
endmodule
