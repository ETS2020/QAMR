...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n62_, new_n66_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  nand4  g16(.a(new_n57_), .b(new_n47_), .c(x15), .d(new_n48_), .O(new_n58_));
  ...
  nor2   g22(.a(new_n47_), .b(x15), .O(z07));
  and2   g23(.a(new_n44_), .b(x16), .O(z08));
  nand3  g24(.a(new_n44_), .b(x09), .c(x08), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z09));
  aoi21  g26(.a(x09), .b(x08), .c(new_n60_), .O(z10));
  ...
  nand3  g39(.a(new_n80_), .b(new_n47_), .c(x15), .O(new_n81_));
  ...
  nand3  g51(.a(new_n73_), .b(x16), .c(new_n48_), .O(new_n93_));
  ...
  nand4  g57(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n44_), .O(z16));
  ...
  nand4  g65(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n107_));
  ...
  nand3  g73(.a(x19), .b(new_n47_), .c(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(z18));
  oai21  g75(.a(new_n43_), .b(new_n79_), .c(new_n47_), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x15), .O(new_n118_));
  nand2  g77(.a(new_n73_), .b(x20), .O(new_n119_));
  nand4  g78(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n120_));
