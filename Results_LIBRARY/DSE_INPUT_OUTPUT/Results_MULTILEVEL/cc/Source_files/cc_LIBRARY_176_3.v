...
module FAU ( 
  ...
  aoi21  g18(.a(new_n59_), .b(z04), .c(new_n43_), .O(z03));
  ...
  nor2   g31(.a(x18), .b(new_n43_), .O(new_n73_));
  ...
  nand2  g36(.a(new_n77_), .b(z04), .O(new_n78_));
  ...
  nand2  g47(.a(new_n88_), .b(z04), .O(new_n89_));
  ...
  oai21  g54(.a(new_n63_), .b(new_n71_), .c(z04), .O(new_n96_));
  ...
  nand2  g65(.a(new_n106_), .b(new_n46_), .O(z17));
  oai21  g66(.a(new_n61_), .b(new_n71_), .c(z04), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n57_), .b(x19), .O(new_n110_));
  ...
  nand3  g77(.a(x20), .b(z04), .c(x15), .O(new_n119_));
