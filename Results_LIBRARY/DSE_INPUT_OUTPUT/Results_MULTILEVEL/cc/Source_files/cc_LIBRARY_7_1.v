...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x00), .c(new_n44_), .O(z01));
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x00), .O(new_n55_));
  ...
  nand3  g24(.a(new_n50_), .b(x09), .c(x08), .O(z10));
  nand2  g25(.a(new_n50_), .b(new_n47_), .O(z11));
  inv1   g26(.a(x00), .O(new_n68_));
  inv1   g27(.a(x13), .O(new_n69_));
  aoi21  g28(.a(new_n51_), .b(new_n69_), .c(new_n68_), .O(new_n70_));
  ...
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z13));
  nand2  g39(.a(new_n44_), .b(x10), .O(new_n81_));
  nand2  g40(.a(x08), .b(x02), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n81_), .c(new_n77_), .d(new_n44_), .O(new_n83_));
  ...
  oai21  g50(.a(new_n91_), .b(new_n81_), .c(new_n90_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n88_), .O(z15));
  inv1   g53(.a(x12), .O(new_n95_));
  inv1   g54(.a(x04), .O(new_n96_));
  nand2  g55(.a(new_n89_), .b(x17), .O(new_n97_));
  oai21  g56(.a(new_n89_), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n44_), .O(new_n99_));
  nand3  g58(.a(x17), .b(x15), .c(x00), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(z16));
  aoi21  g60(.a(x18), .b(x12), .c(new_n68_), .O(new_n102_));
  nand2  g61(.a(new_n89_), .b(x18), .O(new_n103_));
  nand2  g62(.a(x08), .b(x05), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n81_), .c(new_n103_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x12), .O(new_n106_));
  oai21  g65(.a(new_n102_), .b(new_n44_), .c(new_n106_), .O(z17));
  inv1   g66(.a(x06), .O(new_n108_));
  nand2  g67(.a(new_n89_), .b(x19), .O(new_n109_));
  oai21  g68(.a(new_n89_), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n44_), .O(new_n111_));
  nand3  g70(.a(x19), .b(x15), .c(x00), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n95_), .O(z18));
  inv1   g72(.a(x07), .O(new_n114_));
  nand2  g73(.a(new_n89_), .b(x20), .O(new_n115_));
  oai21  g74(.a(new_n89_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n44_), .O(new_n117_));
  nand3  g76(.a(x20), .b(x15), .c(x00), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n95_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
