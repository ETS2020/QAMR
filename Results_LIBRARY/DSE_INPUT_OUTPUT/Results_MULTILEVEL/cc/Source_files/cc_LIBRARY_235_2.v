...
module FAU ( 
  ...
  nor2   g19(.a(new_n52_), .b(new_n60_), .O(z05));
  ...
  nand2  g47(.a(new_n88_), .b(new_n53_), .O(z14));
  nand2  g48(.a(new_n73_), .b(new_n45_), .O(new_n90_));
  nand2  g49(.a(x20), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x16), .c(new_n46_), .O(new_n93_));
  nand4  g52(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n79_), .O(z15));
  ...
  nand2  g75(.a(new_n49_), .b(new_n43_), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x07), .O(new_n118_));
  nand2  g77(.a(new_n49_), .b(x20), .O(new_n119_));
