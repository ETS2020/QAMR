...
module FAU ( 
  ...
  nand2  g30(.a(new_n47_), .b(new_n50_), .O(new_n72_));
  ...
  nand3  g42(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n84_));
  nand4  g43(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n85_));
  ...
  nand3  g48(.a(new_n69_), .b(x08), .c(x04), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z16));
  oai21  g50(.a(x18), .b(new_n43_), .c(x15), .O(new_n92_));
  ...
  nand2  g55(.a(new_n96_), .b(new_n92_), .O(z17));
  ...
  nand3  g63(.a(new_n69_), .b(x08), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n43_), .O(z19));
  nor4   g65(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
