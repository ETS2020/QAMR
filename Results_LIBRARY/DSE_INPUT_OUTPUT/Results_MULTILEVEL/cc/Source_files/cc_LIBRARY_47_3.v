...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    ...
    new_n59_, new_n62_, new_n64_, new_n65_, new_n68_, new_n72_, new_n73_,
  ...
  nand3  g43(.a(new_n46_), .b(new_n56_), .c(x15), .O(new_n85_));
  nand3  g44(.a(new_n76_), .b(x08), .c(x02), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n72_), .O(z14));
  nand3  g46(.a(new_n46_), .b(x16), .c(new_n55_), .O(new_n88_));
  ...
  oai21  g51(.a(new_n64_), .b(new_n72_), .c(new_n56_), .O(new_n93_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n56_), .O(new_n101_));
  ...
  nand3  g70(.a(x19), .b(new_n56_), .c(x15), .O(new_n112_));
  ...
  nand3  g76(.a(x20), .b(new_n56_), .c(x15), .O(new_n118_));
