...
module FAU ( 
  ...
  nand2  g30(.a(new_n71_), .b(x02), .O(new_n72_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n56_), .c(new_n46_), .O(z13));
  ...
  nand3  g40(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n82_));
  ...
  nand3  g44(.a(x16), .b(x15), .c(new_n48_), .O(new_n86_));
  ...
  nand2  g54(.a(new_n95_), .b(x02), .O(new_n96_));
  ...
  nand2  g65(.a(new_n106_), .b(x02), .O(new_n107_));
