...
module FAU ( 
  ...
  nand2  g20(.a(new_n51_), .b(x09), .O(z06));
  ...
  nand2  g27(.a(x15), .b(new_n50_), .O(new_n69_));
  oai21  g28(.a(new_n50_), .b(x08), .c(new_n69_), .O(z10));
  aoi21  g29(.a(new_n51_), .b(new_n50_), .c(new_n47_), .O(z11));
  ...
  nand2  g35(.a(new_n76_), .b(x09), .O(new_n77_));
  nand2  g36(.a(x15), .b(x13), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(z12));
  aoi21  g38(.a(new_n46_), .b(new_n47_), .c(new_n51_), .O(new_n80_));
  inv1   g39(.a(new_n46_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x01), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x14), .c(new_n80_), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n72_), .c(new_n44_), .O(z13));
  nand2  g43(.a(x08), .b(x02), .O(new_n85_));
  oai22  g44(.a(new_n85_), .b(new_n73_), .c(new_n81_), .d(new_n51_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z14));
  nand3  g47(.a(new_n46_), .b(x16), .c(new_n47_), .O(new_n89_));
  nand2  g48(.a(x08), .b(x03), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n73_), .c(new_n89_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x09), .O(new_n92_));
  nand3  g51(.a(x16), .b(x15), .c(new_n47_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n72_), .O(z15));
  nand2  g53(.a(x08), .b(x04), .O(new_n95_));
  oai22  g54(.a(new_n95_), .b(new_n73_), .c(new_n81_), .d(new_n63_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x09), .O(new_n97_));
  ...
  nand2  g59(.a(new_n100_), .b(x09), .O(new_n101_));
  ...
  oai21  g70(.a(new_n111_), .b(new_n73_), .c(new_n110_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x09), .O(new_n113_));
