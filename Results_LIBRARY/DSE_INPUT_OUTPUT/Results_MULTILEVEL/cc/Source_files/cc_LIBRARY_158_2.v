...
module FAU ( 
  ...
  nor2   g22(.a(new_n52_), .b(new_n63_), .O(z08));
  inv1   g23(.a(x08), .O(new_n65_));
  inv1   g24(.a(x09), .O(new_n66_));
  nor3   g25(.a(new_n52_), .b(new_n66_), .c(new_n65_), .O(z09));
  aoi21  g26(.a(x09), .b(x08), .c(new_n52_), .O(z10));
  nand2  g27(.a(new_n53_), .b(new_n45_), .O(z11));
  inv1   g28(.a(x12), .O(new_n70_));
  nand2  g29(.a(new_n55_), .b(x13), .O(new_n71_));
  nand4  g30(.a(new_n48_), .b(x10), .c(x08), .d(x00), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n42_), .O(new_n74_));
  nand2  g33(.a(x15), .b(x13), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(z12));
  nand2  g35(.a(new_n55_), .b(new_n45_), .O(new_n77_));
  nand3  g36(.a(x10), .b(x08), .c(x01), .O(new_n78_));
  aoi22  g37(.a(new_n78_), .b(x14), .c(new_n77_), .d(x15), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n70_), .c(new_n53_), .O(z13));
  nand2  g39(.a(new_n55_), .b(x15), .O(new_n81_));
  nor2   g40(.a(x15), .b(x11), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n70_), .O(z14));
  nand3  g43(.a(new_n55_), .b(x16), .c(new_n45_), .O(new_n85_));
  ...
  nand3  g47(.a(x16), .b(x15), .c(new_n45_), .O(new_n89_));
  ...
  nand3  g52(.a(new_n49_), .b(x17), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(z16));
  nand2  g54(.a(new_n55_), .b(x18), .O(new_n96_));
  nand4  g55(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n97_));
  ...
  nand2  g60(.a(new_n55_), .b(x19), .O(new_n102_));
  ...
  nand2  g66(.a(new_n55_), .b(x20), .O(new_n108_));
  nand4  g67(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n42_), .O(new_n111_));
  nand2  g70(.a(x20), .b(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n70_), .O(z19));
  buf    g72(.a(x15), .O(z06));
endmodule
