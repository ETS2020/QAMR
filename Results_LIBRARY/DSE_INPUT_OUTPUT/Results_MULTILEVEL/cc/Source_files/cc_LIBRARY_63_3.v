...
module FAU ( 
  ...
  nand4  g17(.a(new_n58_), .b(x15), .c(new_n48_), .d(new_n42_), .O(new_n59_));
  ...
  nand2  g29(.a(new_n45_), .b(new_n48_), .O(z11));
  ...
  nand2  g37(.a(new_n72_), .b(new_n48_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x15), .c(new_n42_), .O(new_n80_));
  ...
  nand3  g42(.a(new_n72_), .b(x15), .c(new_n42_), .O(new_n84_));
  nand4  g43(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n78_), .O(z14));
  ...
  nand3  g48(.a(new_n72_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n64_), .b(new_n78_), .c(new_n42_), .O(new_n95_));
  ...
  nand3  g64(.a(x18), .b(x15), .c(new_n42_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n78_), .O(z17));
  oai21  g66(.a(new_n62_), .b(new_n78_), .c(new_n42_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n72_), .b(x19), .O(new_n110_));
  ...
  nand2  g76(.a(new_n117_), .b(new_n43_), .O(new_n118_));
  nand3  g77(.a(x20), .b(x15), .c(new_n42_), .O(new_n119_));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n78_), .O(z19));
  buf    g79(.a(x15), .O(z06));
endmodule
