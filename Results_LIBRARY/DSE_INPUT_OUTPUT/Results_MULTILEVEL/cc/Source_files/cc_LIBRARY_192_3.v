...
module FAU ( 
  ...
  nor2   g19(.a(new_n53_), .b(new_n60_), .O(z05));
  ...
  nor2   g30(.a(x20), .b(new_n43_), .O(new_n72_));
  ...
  nand3  g56(.a(new_n44_), .b(x17), .c(x15), .O(new_n98_));
  ...
  oai21  g64(.a(new_n60_), .b(new_n70_), .c(new_n44_), .O(new_n106_));
