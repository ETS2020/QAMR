...
module FAU ( 
  ...
  aoi21  g07(.a(x18), .b(new_n43_), .c(new_n48_), .O(new_n49_));
  nand3  g08(.a(new_n49_), .b(new_n47_), .c(x10), .O(new_n50_));
  ...
  nand4  g14(.a(new_n49_), .b(new_n47_), .c(x12), .d(x10), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n46_), .O(z03));
  nand2  g16(.a(x18), .b(x16), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n44_), .b(new_n59_), .O(z05));
  aoi21  g19(.a(x18), .b(new_n43_), .c(x15), .O(new_n61_));
  ...
  oai21  g38(.a(new_n69_), .b(new_n46_), .c(x15), .O(new_n80_));
  ...
  aoi22  g47(.a(new_n88_), .b(new_n70_), .c(new_n52_), .d(x17), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n68_), .c(new_n44_), .O(z16));
  and2   g49(.a(x08), .b(x05), .O(new_n91_));
  aoi22  g50(.a(new_n91_), .b(new_n70_), .c(new_n52_), .d(x18), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n68_), .c(new_n44_), .O(z17));
  nand2  g52(.a(new_n52_), .b(x19), .O(new_n94_));
  nand4  g53(.a(new_n48_), .b(x10), .c(x08), .d(x06), .O(new_n95_));
  ...
  aoi22  g58(.a(new_n99_), .b(new_n70_), .c(new_n52_), .d(x20), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n68_), .c(new_n44_), .O(z19));
  buf    g60(.a(x16), .O(z08));
endmodule
