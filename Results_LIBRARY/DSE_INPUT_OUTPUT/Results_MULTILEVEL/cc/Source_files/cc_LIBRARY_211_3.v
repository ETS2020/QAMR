...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    ...
    new_n59_, new_n62_, new_n64_, new_n66_, new_n69_, new_n73_, new_n74_,
  ...
  oai21  g21(.a(new_n56_), .b(new_n45_), .c(new_n62_), .O(z05));
  ...
  nand2  g30(.a(new_n43_), .b(new_n55_), .O(z11));
  ...
  nand3  g46(.a(new_n46_), .b(new_n56_), .c(x15), .O(new_n88_));
  inv1   g47(.a(new_n51_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x08), .c(x02), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n88_), .c(new_n87_), .O(z14));
  nand2  g50(.a(new_n46_), .b(new_n45_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n64_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n55_), .O(new_n94_));
  nand3  g53(.a(new_n89_), .b(x08), .c(x03), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n87_), .O(z15));
  oai21  g55(.a(new_n66_), .b(new_n87_), .c(new_n56_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n46_), .b(x17), .O(new_n99_));
  nand2  g58(.a(x08), .b(x04), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n51_), .c(new_n99_), .O(new_n101_));
  ...
  nand2  g66(.a(new_n107_), .b(new_n43_), .O(z17));
  oai21  g67(.a(new_n62_), .b(new_n87_), .c(new_n56_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n46_), .b(x19), .O(new_n111_));
  nand2  g70(.a(x08), .b(x06), .O(new_n112_));
  oai21  g71(.a(new_n112_), .b(new_n51_), .c(new_n111_), .O(new_n113_));
  ...
  nand3  g78(.a(x20), .b(new_n56_), .c(x15), .O(new_n120_));
