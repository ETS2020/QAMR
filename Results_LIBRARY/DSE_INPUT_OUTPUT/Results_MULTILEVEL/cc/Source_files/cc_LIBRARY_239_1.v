...
module FAU ( 
  ...
  nand2  g45(.a(new_n86_), .b(new_n56_), .O(z14));
  ...
  nand4  g49(.a(new_n75_), .b(x16), .c(new_n45_), .d(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(z15));
  aoi21  g51(.a(x10), .b(x08), .c(x20), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(x15), .c(x17), .O(new_n94_));
  nand4  g53(.a(new_n49_), .b(x10), .c(x08), .d(x04), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n78_), .O(z16));
  oai21  g55(.a(new_n93_), .b(x15), .c(x18), .O(new_n97_));
  ...
  nand2  g60(.a(new_n101_), .b(new_n62_), .O(new_n102_));
  nand3  g61(.a(new_n75_), .b(x19), .c(x12), .O(new_n103_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n78_), .O(z19));
endmodule
