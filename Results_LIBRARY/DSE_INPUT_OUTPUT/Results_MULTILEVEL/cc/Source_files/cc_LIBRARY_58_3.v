...
module FAU ( 
  ...
  nand3  g43(.a(new_n73_), .b(x15), .c(new_n42_), .O(new_n85_));
  ...
  nand2  g48(.a(x15), .b(new_n42_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n62_), .b(new_n79_), .c(new_n42_), .O(new_n95_));
  ...
  oai21  g68(.a(new_n60_), .b(new_n79_), .c(new_n42_), .O(new_n110_));
  ...
  nand3  g79(.a(x20), .b(x15), .c(new_n42_), .O(new_n121_));
  aoi21  g80(.a(new_n121_), .b(new_n120_), .c(new_n79_), .O(z19));
  buf    g81(.a(x15), .O(z06));
endmodule
