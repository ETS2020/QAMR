...
module FAU ( 
  ...
  aoi21  g23(.a(x09), .b(x08), .c(new_n55_), .O(z10));
  ...
  nand2  g30(.a(new_n47_), .b(x12), .O(new_n72_));
  ...
  nand3  g38(.a(new_n51_), .b(x16), .c(new_n50_), .O(new_n80_));
  ...
  nand2  g45(.a(new_n47_), .b(x18), .O(new_n87_));
  ...
  nand3  g51(.a(new_n69_), .b(x08), .c(x06), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z18));
  oai21  g53(.a(x20), .b(new_n43_), .c(x15), .O(new_n95_));
  nand2  g54(.a(new_n47_), .b(x20), .O(new_n96_));
  nand4  g55(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n95_), .O(z19));
  nor4   g59(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  buf    g60(.a(x15), .O(z06));
endmodule
