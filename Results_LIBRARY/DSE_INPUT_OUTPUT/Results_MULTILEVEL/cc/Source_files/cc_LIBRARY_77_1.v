...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n58_, new_n61_, new_n65_,
  ...
  nand4  g26(.a(new_n46_), .b(x10), .c(x08), .d(x00), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n65_), .O(z12));
  nand2  g30(.a(new_n66_), .b(new_n47_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x15), .O(new_n73_));
  inv1   g32(.a(x01), .O(new_n74_));
  oai21  g33(.a(new_n66_), .b(new_n74_), .c(x14), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n43_), .O(z13));
  nand3  g35(.a(x12), .b(x10), .c(x08), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x15), .O(new_n78_));
  nand2  g37(.a(x08), .b(x02), .O(new_n79_));
  nand3  g38(.a(new_n46_), .b(x12), .c(x10), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(z14));
  nand3  g40(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n82_));
  inv1   g41(.a(x10), .O(new_n83_));
  nor2   g42(.a(x15), .b(new_n83_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x08), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n43_), .O(z15));
  oai21  g45(.a(x17), .b(new_n43_), .c(x15), .O(new_n87_));
  nand2  g46(.a(new_n66_), .b(x17), .O(new_n88_));
  nand4  g47(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n87_), .O(z16));
  oai21  g51(.a(x18), .b(new_n43_), .c(x15), .O(new_n93_));
  nand2  g52(.a(new_n66_), .b(x18), .O(new_n94_));
  nand4  g53(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n93_), .O(z17));
  nand2  g57(.a(new_n51_), .b(x19), .O(new_n99_));
  nand3  g58(.a(new_n84_), .b(x08), .c(x06), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n43_), .O(z18));
  oai21  g60(.a(x20), .b(new_n43_), .c(x15), .O(new_n102_));
  nand2  g61(.a(new_n66_), .b(x20), .O(new_n103_));
  nand4  g62(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n102_), .O(z19));
  aoi21  g66(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
  buf    g67(.a(x15), .O(z06));
endmodule
