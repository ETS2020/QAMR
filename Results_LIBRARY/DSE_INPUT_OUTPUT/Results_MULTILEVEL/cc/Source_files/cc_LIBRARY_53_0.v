...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n63_, new_n65_, new_n69_, new_n70_, new_n72_, new_n73_, new_n74_,
    new_n76_, new_n77_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
    new_n85_, new_n86_, new_n87_, new_n88_, new_n89_, new_n91_, new_n92_,
    new_n93_, new_n94_, new_n95_, new_n97_, new_n98_, new_n99_, new_n100_,
    new_n102_, new_n103_, new_n104_, new_n105_;
  nand2  g00(.a(x20), .b(x11), .O(new_n42_));
  nor2   g01(.a(x15), .b(x00), .O(new_n43_));
  ...
  inv1   g27(.a(new_n52_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(x13), .c(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n44_), .O(z12));
  oai21  g30(.a(new_n48_), .b(x14), .c(x15), .O(new_n72_));
  nand2  g31(.a(new_n48_), .b(x01), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x14), .c(x00), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n56_), .O(z13));
  nand2  g34(.a(new_n47_), .b(x15), .O(new_n76_));
  nand3  g35(.a(new_n69_), .b(x02), .c(x00), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n56_), .O(z14));
  nand3  g37(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n79_));
  nand4  g38(.a(new_n51_), .b(x10), .c(x08), .d(x03), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x00), .O(new_n82_));
  nand3  g41(.a(x16), .b(x15), .c(new_n46_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n56_), .O(z15));
  nand2  g43(.a(new_n47_), .b(x17), .O(new_n85_));
  nand4  g44(.a(new_n51_), .b(x10), .c(x08), .d(x04), .O(new_n86_));
  ...
  nand2  g56(.a(new_n97_), .b(x00), .O(new_n98_));
