...
module FAU ( 
  ...
  nand3  g47(.a(new_n50_), .b(x10), .c(x08), .O(new_n89_));
  nand4  g48(.a(new_n89_), .b(x16), .c(new_n45_), .d(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n88_), .O(z15));
  nand2  g50(.a(new_n73_), .b(x17), .O(new_n92_));
  nand3  g51(.a(new_n76_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n71_), .O(z16));
