...
module FAU ( 
  ...
  aoi21  g19(.a(x15), .b(x06), .c(new_n60_), .O(z05));
  ...
  nand2  g31(.a(new_n72_), .b(new_n42_), .O(new_n73_));
  ...
  nand2  g40(.a(new_n75_), .b(new_n48_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x15), .c(new_n42_), .O(new_n83_));
  ...
  nand2  g45(.a(new_n75_), .b(x15), .O(new_n87_));
  nand2  g46(.a(x08), .b(x02), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n53_), .c(new_n87_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n45_), .O(z14));
  nand2  g50(.a(new_n75_), .b(new_n43_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n62_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n48_), .O(new_n94_));
  nand4  g53(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n81_), .O(z15));
  oai21  g55(.a(new_n64_), .b(new_n81_), .c(new_n42_), .O(new_n97_));
  ...
  nand3  g74(.a(x19), .b(x15), .c(new_n42_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n81_), .O(z18));
  nand2  g76(.a(x20), .b(x12), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(new_n42_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x15), .O(new_n120_));
  nand2  g79(.a(new_n75_), .b(x20), .O(new_n121_));
