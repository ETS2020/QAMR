...
module FAU ( 
  ...
  nand3  g56(.a(new_n51_), .b(x18), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z17));
  nand3  g58(.a(new_n51_), .b(x19), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n45_), .O(z18));
  nand2  g60(.a(new_n55_), .b(x20), .O(new_n102_));
