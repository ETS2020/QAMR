...
module FAU ( 
  ...
  oai21  g15(.a(new_n56_), .b(new_n48_), .c(new_n47_), .O(z03));
  ...
  nand2  g35(.a(new_n76_), .b(new_n47_), .O(z13));
  ...
  nand4  g44(.a(new_n52_), .b(x16), .c(new_n44_), .d(x12), .O(new_n86_));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n68_), .O(z18));
