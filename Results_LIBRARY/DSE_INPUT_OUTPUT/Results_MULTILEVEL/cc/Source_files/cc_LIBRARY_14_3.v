...
module FAU ( 
  ...
  oai21  g14(.a(new_n55_), .b(x11), .c(new_n48_), .O(z02));
  ...
  nor2   g26(.a(new_n49_), .b(new_n46_), .O(z11));
  ...
  oai21  g33(.a(new_n57_), .b(new_n74_), .c(x14), .O(new_n75_));
  ...
  aoi21  g44(.a(x20), .b(x16), .c(x15), .O(new_n86_));
  nand4  g45(.a(new_n86_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  inv1   g46(.a(x20), .O(new_n88_));
  nand4  g47(.a(new_n53_), .b(new_n88_), .c(x16), .d(new_n46_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(z15));
  ...
  oai21  g53(.a(new_n94_), .b(new_n85_), .c(new_n48_), .O(z16));
  ...
  aoi22  g58(.a(new_n99_), .b(new_n92_), .c(new_n53_), .d(x19), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n85_), .c(new_n48_), .O(z18));
  and2   g60(.a(x08), .b(x07), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n92_), .c(new_n53_), .d(x20), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(new_n85_), .c(new_n48_), .O(z19));
  buf    g63(.a(x16), .O(z08));
endmodule
