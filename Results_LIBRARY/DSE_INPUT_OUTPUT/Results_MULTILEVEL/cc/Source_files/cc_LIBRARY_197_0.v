...
module FAU ( 
  ...
  nand3  g35(.a(new_n76_), .b(x14), .c(x05), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n55_), .O(z13));
  nand2  g37(.a(new_n46_), .b(x15), .O(new_n79_));
  inv1   g38(.a(new_n51_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x05), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n55_), .O(z14));
  ...
  nand2  g66(.a(new_n107_), .b(x05), .O(new_n108_));
