...
module FAU ( 
  ...
  oai21  g32(.a(new_n73_), .b(new_n69_), .c(new_n45_), .O(z12));
  ...
  nand3  g44(.a(new_n53_), .b(x16), .c(new_n48_), .O(new_n86_));
  ...
  nand4  g49(.a(new_n43_), .b(new_n52_), .c(x10), .d(x08), .O(new_n91_));
  nand2  g50(.a(x18), .b(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x04), .O(new_n94_));
  nand3  g53(.a(new_n53_), .b(x18), .c(x17), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n69_), .O(z16));
  nand2  g55(.a(new_n53_), .b(x18), .O(new_n97_));
  nand2  g56(.a(new_n91_), .b(z04), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x05), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n97_), .c(new_n69_), .O(z17));
  and2   g59(.a(x08), .b(x06), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n71_), .c(new_n53_), .d(x19), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n69_), .c(new_n45_), .O(z18));
