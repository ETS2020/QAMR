...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x13), .c(new_n44_), .O(z01));
  ...
  oai21  g19(.a(new_n44_), .b(x13), .c(new_n60_), .O(z05));
  nand2  g20(.a(x15), .b(x13), .O(new_n62_));
  ...
  nand3  g43(.a(new_n55_), .b(x15), .c(x13), .O(new_n85_));
  inv1   g44(.a(x10), .O(new_n86_));
  nor2   g45(.a(x15), .b(new_n86_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x08), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n85_), .c(new_n73_), .O(z14));
  nand2  g48(.a(new_n55_), .b(new_n44_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n62_), .O(new_n91_));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n73_), .O(z16));
  ...
  oai21  g71(.a(new_n43_), .b(new_n73_), .c(x13), .O(new_n113_));
