...
module FAU ( 
  ...
  nand3  g33(.a(new_n43_), .b(new_n52_), .c(x10), .O(new_n75_));
  ...
  nand3  g48(.a(new_n76_), .b(x08), .c(x04), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n62_), .c(new_n71_), .O(z16));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n71_), .O(z17));
