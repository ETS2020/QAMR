...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x05), .c(new_n46_), .O(z01));
  ...
  nand3  g39(.a(new_n80_), .b(x15), .c(x05), .O(new_n81_));
  ...
  nand3  g43(.a(new_n73_), .b(x15), .c(x05), .O(new_n85_));
  ...
  nand3  g49(.a(new_n73_), .b(x16), .c(new_n47_), .O(new_n91_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n79_), .O(z16));
  inv1   g60(.a(x18), .O(new_n102_));
  nand2  g61(.a(new_n50_), .b(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x05), .O(new_n104_));
  nand3  g63(.a(new_n73_), .b(x18), .c(new_n46_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n79_), .O(z17));
  ...
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(z18));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n79_), .O(z19));
endmodule
