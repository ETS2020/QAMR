...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n64_, new_n67_, new_n69_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  oai21  g08(.a(new_n43_), .b(x05), .c(x14), .O(new_n50_));
  ...
  nor4   g14(.a(new_n47_), .b(new_n43_), .c(x14), .d(new_n55_), .O(z03));
  ...
  nand2  g26(.a(new_n45_), .b(new_n67_), .O(z11));
  nand2  g27(.a(x13), .b(x12), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x05), .O(new_n70_));
  ...
  nand2  g37(.a(new_n78_), .b(x05), .O(new_n79_));
  ...
  nand3  g42(.a(new_n72_), .b(x15), .c(x05), .O(new_n84_));
  ...
  nand2  g47(.a(new_n72_), .b(new_n43_), .O(new_n89_));
  nand2  g48(.a(x15), .b(x05), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x16), .c(new_n67_), .O(new_n92_));
  nand3  g51(.a(new_n86_), .b(x08), .c(x03), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n55_), .O(z15));
  oai21  g53(.a(new_n60_), .b(new_n55_), .c(x05), .O(new_n95_));
  ...
  nand2  g61(.a(new_n51_), .b(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x05), .O(new_n104_));
  nand3  g63(.a(new_n72_), .b(x18), .c(new_n43_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n55_), .O(z17));
  ...
  nand3  g69(.a(x19), .b(x15), .c(x05), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n55_), .O(z18));
  ...
  nand3  g75(.a(x20), .b(x15), .c(x05), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n55_), .O(z19));
  buf    g77(.a(x15), .O(z06));
endmodule
