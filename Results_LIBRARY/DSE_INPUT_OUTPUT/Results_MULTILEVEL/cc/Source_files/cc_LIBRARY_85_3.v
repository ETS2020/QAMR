...
module FAU ( 
  ...
  nor2   g28(.a(x17), .b(new_n42_), .O(new_n70_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n43_), .c(x15), .O(new_n76_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n53_), .c(new_n80_), .O(new_n82_));
  ...
  aoi21  g52(.a(new_n74_), .b(new_n43_), .c(new_n93_), .O(new_n94_));
  aoi21  g53(.a(x10), .b(x08), .c(new_n43_), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n94_), .c(new_n42_), .O(new_n96_));
  nor2   g55(.a(new_n96_), .b(new_n68_), .O(z16));
  ...
  oai21  g64(.a(new_n60_), .b(new_n68_), .c(new_n43_), .O(new_n106_));
