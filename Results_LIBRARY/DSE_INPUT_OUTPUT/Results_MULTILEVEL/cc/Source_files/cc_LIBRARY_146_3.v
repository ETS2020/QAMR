...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n62_, new_n65_, new_n68_, new_n72_, new_n73_, new_n74_,
  ...
  aoi21  g21(.a(x16), .b(x15), .c(new_n62_), .O(z05));
  nor2   g22(.a(x16), .b(new_n45_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  aoi21  g24(.a(x16), .b(x15), .c(new_n65_), .O(z07));
  nor2   g25(.a(new_n46_), .b(x15), .O(z08));
  ...
  nand2  g53(.a(new_n94_), .b(new_n42_), .O(z15));
  oai21  g54(.a(new_n65_), .b(new_n87_), .c(new_n46_), .O(new_n96_));
  ...
  oai21  g69(.a(new_n62_), .b(new_n87_), .c(new_n46_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n75_), .b(x19), .O(new_n113_));
  ...
  nand3  g80(.a(x20), .b(new_n46_), .c(x15), .O(new_n122_));
