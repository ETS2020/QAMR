...
module FAU ( 
  ...
  aoi21  g48(.a(new_n89_), .b(new_n86_), .c(new_n75_), .O(z15));
  nand2  g49(.a(new_n53_), .b(x17), .O(new_n91_));
  nand3  g50(.a(new_n88_), .b(x08), .c(x04), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n75_), .O(z16));
  ...
  nand3  g61(.a(new_n88_), .b(x08), .c(x07), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n75_), .O(z19));
  buf    g63(.a(x15), .O(z06));
endmodule
