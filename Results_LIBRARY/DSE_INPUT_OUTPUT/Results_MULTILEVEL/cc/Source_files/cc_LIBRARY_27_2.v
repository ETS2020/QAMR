...
module FAU ( 
  ...
  oai21  g23(.a(x15), .b(new_n55_), .c(x09), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n64_), .O(z09));
  aoi21  g25(.a(x09), .b(x08), .c(new_n56_), .O(z10));
  nor2   g26(.a(new_n56_), .b(new_n48_), .O(z11));
