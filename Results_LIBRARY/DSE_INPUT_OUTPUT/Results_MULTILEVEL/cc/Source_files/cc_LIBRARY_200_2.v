...
module FAU ( 
  ...
  aoi21  g28(.a(x15), .b(new_n69_), .c(new_n49_), .O(z12));
  aoi21  g29(.a(x10), .b(x08), .c(x14), .O(new_n71_));
  nor3   g30(.a(new_n71_), .b(new_n43_), .c(new_n49_), .O(z13));
