...
module FAU ( 
  ...
  oai21  g40(.a(new_n63_), .b(x14), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x15), .O(new_n83_));
  nand3  g42(.a(new_n56_), .b(x16), .c(new_n47_), .O(new_n84_));
  nand4  g43(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n85_));
  ...
  nand3  g48(.a(new_n71_), .b(x08), .c(x04), .O(new_n90_));
  ...
  nand3  g54(.a(new_n71_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n55_), .O(z18));
  nand2  g56(.a(new_n51_), .b(x20), .O(new_n98_));
  nand3  g57(.a(new_n71_), .b(x08), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n55_), .O(z19));
  buf    g59(.a(x15), .O(z06));
endmodule
