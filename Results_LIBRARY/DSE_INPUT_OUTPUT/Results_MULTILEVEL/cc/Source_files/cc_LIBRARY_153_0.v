...
module FAU ( 
  ...
  nand2  g27(.a(new_n68_), .b(x07), .O(new_n69_));
  ...
  nand3  g33(.a(new_n74_), .b(x14), .c(x07), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n56_), .O(z13));
  nand2  g35(.a(new_n47_), .b(x15), .O(new_n77_));
  inv1   g36(.a(new_n52_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x07), .c(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n56_), .O(z14));
  nand3  g39(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n81_));
  ...
  nand3  g43(.a(x16), .b(x15), .c(new_n46_), .O(new_n85_));
  ...
  oai21  g63(.a(new_n78_), .b(x20), .c(x12), .O(new_n105_));
