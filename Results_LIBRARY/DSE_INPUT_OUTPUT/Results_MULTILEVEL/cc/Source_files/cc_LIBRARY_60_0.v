...
module FAU ( 
  ...
  nand2  g34(.a(new_n75_), .b(x06), .O(new_n76_));
  nand2  g35(.a(x15), .b(x13), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n71_), .O(z12));
  aoi21  g37(.a(new_n47_), .b(new_n46_), .c(new_n52_), .O(new_n79_));
  nand2  g38(.a(new_n48_), .b(x01), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x14), .c(new_n79_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n71_), .c(new_n44_), .O(z13));
  nand2  g41(.a(x08), .b(x02), .O(new_n83_));
  oai22  g42(.a(new_n83_), .b(new_n72_), .c(new_n48_), .d(new_n52_), .O(new_n84_));
  ...
  nand4  g48(.a(new_n53_), .b(x16), .c(new_n46_), .d(x12), .O(new_n90_));
  ...
  oai21  g57(.a(new_n98_), .b(new_n72_), .c(new_n97_), .O(new_n99_));
  ...
  oai21  g66(.a(new_n107_), .b(new_n72_), .c(new_n106_), .O(new_n108_));
