...
module FAU ( 
  ...
  nand3  g20(.a(new_n42_), .b(x09), .c(x08), .O(new_n63_));
  inv1   g21(.a(new_n63_), .O(z09));
  inv1   g22(.a(new_n42_), .O(new_n65_));
  aoi21  g23(.a(x09), .b(x08), .c(new_n65_), .O(z10));
  nor2   g24(.a(new_n65_), .b(new_n47_), .O(z11));
  nand2  g25(.a(x10), .b(x08), .O(new_n68_));
  nand2  g26(.a(new_n68_), .b(x13), .O(new_n69_));
  aoi21  g27(.a(new_n51_), .b(x00), .c(x15), .O(new_n70_));
  aoi21  g28(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(z12));
  ...
  nand3  g34(.a(new_n68_), .b(x16), .c(new_n47_), .O(new_n77_));
  ...
  nand2  g39(.a(new_n68_), .b(x17), .O(new_n82_));
  aoi21  g40(.a(new_n51_), .b(x04), .c(x15), .O(new_n83_));
  aoi21  g41(.a(new_n83_), .b(new_n82_), .c(new_n45_), .O(z16));
  nand2  g42(.a(new_n68_), .b(x18), .O(new_n85_));
  aoi21  g43(.a(new_n51_), .b(x05), .c(x15), .O(new_n86_));
  aoi21  g44(.a(new_n86_), .b(new_n85_), .c(new_n45_), .O(z17));
  nand2  g45(.a(new_n68_), .b(x19), .O(new_n88_));
  aoi21  g46(.a(new_n51_), .b(x06), .c(x15), .O(new_n89_));
  aoi21  g47(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(z18));
  nand2  g48(.a(new_n68_), .b(x20), .O(new_n91_));
