...
module FAU ( 
  ...
  nor4   g16(.a(new_n46_), .b(new_n43_), .c(x14), .d(new_n57_), .O(z03));
  nand2  g17(.a(new_n44_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n43_), .O(z05));
  inv1   g20(.a(new_n52_), .O(z06));
  ...
  nand3  g32(.a(new_n43_), .b(x10), .c(x08), .O(new_n74_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n57_), .c(new_n44_), .O(z13));
  ...
  nand2  g44(.a(new_n46_), .b(new_n60_), .O(new_n86_));
  ...
  nand2  g52(.a(new_n87_), .b(x18), .O(new_n94_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n57_), .O(z19));
endmodule
