...
module FAU ( 
  ...
  nand3  g25(.a(x12), .b(x09), .c(x08), .O(z10));
  inv1   g26(.a(z10), .O(z09));
  nor2   g27(.a(new_n44_), .b(new_n47_), .O(z11));
  nand3  g28(.a(new_n51_), .b(x10), .c(x00), .O(new_n70_));
  ...
  aoi21  g33(.a(x15), .b(x10), .c(new_n56_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x14), .c(x12), .O(new_n77_));
  oai21  g36(.a(new_n75_), .b(new_n43_), .c(new_n77_), .O(z13));
  nand3  g37(.a(new_n51_), .b(x10), .c(x02), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x08), .O(new_n81_));
  nand3  g40(.a(new_n57_), .b(x15), .c(x12), .O(new_n82_));
  ...
  nand3  g50(.a(new_n51_), .b(x10), .c(x05), .O(new_n92_));
  ...
  nand3  g55(.a(new_n51_), .b(x10), .c(x06), .O(new_n97_));
  ...
  nand3  g61(.a(new_n86_), .b(x08), .c(x07), .O(new_n103_));
