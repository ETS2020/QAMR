...
module FAU ( 
  ...
  nand3  g43(.a(new_n73_), .b(x15), .c(new_n43_), .O(new_n85_));
  ...
  nand2  g47(.a(new_n73_), .b(new_n44_), .O(new_n89_));
  nand2  g48(.a(x15), .b(new_n43_), .O(new_n90_));
  ...
  oai21  g67(.a(new_n60_), .b(new_n79_), .c(new_n43_), .O(new_n109_));
