...
module FAU ( 
  ...
  nand3  g06(.a(x10), .b(x08), .c(x03), .O(new_n48_));
  nor3   g07(.a(new_n48_), .b(new_n47_), .c(x14), .O(z01));
  oai21  g08(.a(new_n47_), .b(x03), .c(x14), .O(new_n50_));
  ...
  inv1   g24(.a(new_n50_), .O(z11));
  nand2  g25(.a(x13), .b(x12), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x03), .O(new_n68_));
  ...
  nand2  g35(.a(new_n70_), .b(new_n76_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x15), .c(x03), .O(new_n78_));
  ...
  nand3  g40(.a(new_n70_), .b(x15), .c(x03), .O(new_n82_));
  nand4  g41(.a(new_n47_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n55_), .O(z14));
  nand3  g43(.a(x16), .b(x15), .c(new_n76_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n51_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x03), .O(new_n87_));
  nand4  g46(.a(new_n70_), .b(x16), .c(new_n47_), .d(new_n76_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n55_), .O(z15));
  oai21  g48(.a(new_n60_), .b(new_n55_), .c(x03), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n70_), .b(x17), .O(new_n92_));
  ...
  oai21  g63(.a(new_n58_), .b(new_n55_), .c(x03), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n70_), .b(x19), .O(new_n107_));
  ...
  nand3  g74(.a(x20), .b(x15), .c(x03), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n55_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
