...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x08), .O(new_n43_));
  ...
  nor2   g19(.a(new_n43_), .b(new_n51_), .O(z06));
  ...
  oai21  g28(.a(x13), .b(new_n56_), .c(new_n69_), .O(new_n70_));
  ...
  oai21  g35(.a(x14), .b(new_n56_), .c(new_n69_), .O(new_n77_));
  ...
  oai21  g41(.a(x15), .b(new_n56_), .c(new_n69_), .O(new_n83_));
  nand2  g42(.a(new_n51_), .b(x10), .O(new_n84_));
  nand2  g43(.a(x15), .b(new_n71_), .O(new_n85_));
  nand2  g44(.a(x08), .b(x02), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n85_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n83_), .O(z14));
  nand3  g48(.a(new_n52_), .b(x16), .c(new_n47_), .O(new_n90_));
  nor2   g49(.a(x15), .b(new_n71_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n90_), .c(new_n56_), .O(z15));
  ...
  oai21  g55(.a(x18), .b(new_n56_), .c(new_n69_), .O(new_n97_));
  oai21  g56(.a(x15), .b(new_n71_), .c(x18), .O(new_n98_));
  ...
  oai21  g61(.a(x19), .b(new_n56_), .c(new_n69_), .O(new_n103_));
  oai21  g62(.a(x15), .b(new_n71_), .c(x19), .O(new_n104_));
  ...
  nand3  g68(.a(new_n91_), .b(x08), .c(x07), .O(new_n110_));
