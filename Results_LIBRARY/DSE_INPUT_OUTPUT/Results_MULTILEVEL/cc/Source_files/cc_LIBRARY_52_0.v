...
module FAU ( 
  ...
  nand2  g18(.a(new_n49_), .b(x06), .O(z06));
  ...
  nand2  g33(.a(new_n54_), .b(new_n46_), .O(new_n75_));
  ...
  nand3  g39(.a(new_n80_), .b(x06), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n74_), .O(z14));
  nand3  g41(.a(new_n54_), .b(x16), .c(new_n46_), .O(new_n83_));
  nand4  g42(.a(new_n49_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  ...
  nand2  g48(.a(new_n89_), .b(x06), .O(new_n90_));
  ...
  nand4  g53(.a(new_n49_), .b(x10), .c(x08), .d(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x06), .O(new_n97_));
  nand2  g56(.a(x18), .b(x15), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n74_), .O(z17));
  nand2  g58(.a(new_n50_), .b(new_n58_), .O(new_n100_));
