...
module FAU ( 
  ...
  nand4  g12(.a(new_n53_), .b(x13), .c(x12), .d(new_n50_), .O(new_n54_));
  inv1   g13(.a(new_n54_), .O(z02));
  inv1   g14(.a(x12), .O(new_n56_));
  nand4  g15(.a(x15), .b(new_n47_), .c(x10), .d(x08), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x13), .c(new_n56_), .O(z03));
  ...
  nand3  g30(.a(new_n51_), .b(x13), .c(x10), .O(new_n72_));
  nor3   g31(.a(new_n72_), .b(new_n46_), .c(x00), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n56_), .O(z12));
  ...
  nand3  g38(.a(new_n79_), .b(x13), .c(x12), .O(new_n80_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n43_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n94_), .b(x13), .c(x12), .O(new_n95_));
  ...
  nand3  g58(.a(new_n99_), .b(x13), .c(x12), .O(new_n100_));
  ...
  nand3  g63(.a(new_n104_), .b(x13), .c(x12), .O(new_n105_));
  inv1   g64(.a(new_n105_), .O(z18));
  nand2  g65(.a(new_n52_), .b(x20), .O(new_n107_));
  nand4  g66(.a(new_n51_), .b(x10), .c(x08), .d(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(x13), .c(x12), .O(new_n110_));
