...
module FAU ( 
  ...
  nor2   g04(.a(x20), .b(new_n45_), .O(new_n46_));
  ...
  nand2  g20(.a(new_n47_), .b(new_n52_), .O(z06));
  ...
  nor3   g27(.a(new_n46_), .b(new_n68_), .c(new_n67_), .O(z09));
  nand3  g28(.a(new_n47_), .b(x09), .c(x08), .O(z10));
  nor2   g29(.a(new_n46_), .b(new_n49_), .O(z11));
  inv1   g30(.a(x12), .O(new_n72_));
  nand2  g31(.a(new_n52_), .b(new_n45_), .O(new_n73_));
  oai22  g32(.a(new_n73_), .b(new_n48_), .c(new_n43_), .d(new_n45_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x00), .O(new_n75_));
  and2   g34(.a(new_n53_), .b(x20), .O(new_n76_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n47_), .O(z14));
  nand3  g50(.a(new_n53_), .b(x16), .c(new_n49_), .O(new_n92_));
  nand3  g51(.a(new_n87_), .b(x08), .c(x03), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n47_), .c(x12), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z15));
  and2   g55(.a(x08), .b(x04), .O(new_n97_));
  aoi22  g56(.a(new_n97_), .b(new_n87_), .c(new_n53_), .d(x17), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n72_), .c(new_n47_), .O(z16));
  nand2  g58(.a(new_n53_), .b(x18), .O(new_n100_));
  nand3  g59(.a(new_n87_), .b(x08), .c(x05), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n47_), .c(x12), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z17));
  nand2  g63(.a(new_n53_), .b(x19), .O(new_n105_));
  nand3  g64(.a(new_n87_), .b(x08), .c(x06), .O(new_n106_));
  ...
  aoi21  g69(.a(new_n53_), .b(new_n43_), .c(new_n110_), .O(new_n111_));
  oai21  g70(.a(new_n111_), .b(new_n76_), .c(x12), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n47_), .O(z19));
endmodule
