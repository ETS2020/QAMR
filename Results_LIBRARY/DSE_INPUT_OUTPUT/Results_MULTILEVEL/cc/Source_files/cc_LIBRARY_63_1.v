...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x13), .c(new_n47_), .O(z01));
  ...
  nor3   g15(.a(new_n56_), .b(new_n47_), .c(x14), .O(z03));
  ...
  nor2   g25(.a(new_n66_), .b(new_n51_), .O(z09));
  ...
  aoi21  g30(.a(new_n71_), .b(new_n43_), .c(new_n70_), .O(new_n72_));
  nand2  g31(.a(new_n71_), .b(x13), .O(new_n73_));
  ...
  nand2  g36(.a(new_n71_), .b(new_n48_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x15), .c(x13), .O(new_n79_));
  ...
  oai21  g52(.a(new_n62_), .b(new_n77_), .c(x13), .O(new_n94_));
  ...
  oai21  g65(.a(new_n60_), .b(new_n77_), .c(x13), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand2  g67(.a(new_n71_), .b(x19), .O(new_n109_));
  ...
  nand2  g72(.a(new_n71_), .b(x20), .O(new_n114_));
  ...
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n77_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
