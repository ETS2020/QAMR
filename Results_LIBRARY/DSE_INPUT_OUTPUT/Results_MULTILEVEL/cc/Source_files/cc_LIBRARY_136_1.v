...
module FAU ( 
  ...
  nand3  g06(.a(x10), .b(x08), .c(x06), .O(new_n48_));
  nor3   g07(.a(new_n48_), .b(new_n44_), .c(x14), .O(z01));
  oai21  g08(.a(new_n44_), .b(x06), .c(x14), .O(new_n50_));
  ...
  nand3  g16(.a(new_n57_), .b(new_n55_), .c(x12), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x06), .c(new_n44_), .O(z03));
  nor2   g18(.a(new_n45_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nand2  g20(.a(x15), .b(x06), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(x15), .c(new_n61_), .O(z05));
  inv1   g22(.a(new_n62_), .O(z06));
  ...
  nand2  g32(.a(new_n56_), .b(new_n44_), .O(new_n74_));
  ...
  nand2  g40(.a(new_n81_), .b(x06), .O(new_n82_));
  ...
  nand2  g45(.a(new_n56_), .b(x15), .O(new_n87_));
  ...
  nand3  g50(.a(new_n75_), .b(x16), .c(new_n55_), .O(new_n92_));
  nand3  g51(.a(new_n78_), .b(x08), .c(x03), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n73_), .O(z15));
  oai21  g53(.a(new_n65_), .b(new_n73_), .c(x06), .O(new_n95_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n73_), .O(z17));
  nand2  g66(.a(new_n51_), .b(new_n61_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x06), .O(new_n109_));
  nand3  g68(.a(new_n56_), .b(x19), .c(new_n44_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n73_), .O(z18));
  oai21  g70(.a(new_n43_), .b(new_n73_), .c(x06), .O(new_n112_));
