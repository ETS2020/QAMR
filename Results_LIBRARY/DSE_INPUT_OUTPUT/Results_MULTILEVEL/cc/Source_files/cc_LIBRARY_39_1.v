...
module FAU ( 
  ...
  nand2  g17(.a(x15), .b(x06), .O(new_n59_));
  ...
  nand2  g39(.a(new_n74_), .b(new_n47_), .O(new_n81_));
  ...
  oai21  g54(.a(new_n62_), .b(new_n80_), .c(x06), .O(new_n96_));
  ...
  oai21  g73(.a(new_n43_), .b(new_n80_), .c(x06), .O(new_n115_));
