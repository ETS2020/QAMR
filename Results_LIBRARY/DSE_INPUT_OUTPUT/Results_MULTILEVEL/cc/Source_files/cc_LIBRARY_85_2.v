...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n56_, new_n59_, new_n63_,
  ...
  aoi21  g15(.a(new_n56_), .b(x17), .c(new_n48_), .O(z03));
  nor2   g16(.a(new_n46_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n45_), .b(new_n59_), .O(z05));
  nand2  g19(.a(new_n44_), .b(new_n48_), .O(z07));
  ...
  nand2  g51(.a(new_n52_), .b(new_n44_), .O(new_n93_));
  ...
  nand2  g58(.a(new_n74_), .b(x18), .O(new_n100_));
  nand4  g59(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n101_));
  ...
  oai21  g63(.a(new_n59_), .b(new_n68_), .c(x17), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n74_), .b(x19), .O(new_n107_));
  nand4  g66(.a(new_n48_), .b(x10), .c(x08), .d(x06), .O(new_n108_));
  ...
  oai21  g70(.a(new_n43_), .b(new_n68_), .c(x17), .O(new_n112_));
