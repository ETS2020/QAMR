...
module FAU ( 
  ...
  nand2  g32(.a(x15), .b(new_n45_), .O(new_n74_));
  ...
  nand2  g38(.a(new_n72_), .b(new_n47_), .O(new_n80_));
  ...
  nand2  g43(.a(new_n72_), .b(x15), .O(new_n85_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(new_n45_), .O(new_n97_));
  ...
  oai21  g65(.a(new_n61_), .b(new_n71_), .c(new_n45_), .O(new_n107_));
