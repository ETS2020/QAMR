...
module FAU ( 
  ...
  nand2  g11(.a(x18), .b(new_n52_), .O(z06));
  oai22  g12(.a(z06), .b(new_n47_), .c(new_n43_), .d(new_n46_), .O(new_n54_));
  ...
  nand2  g30(.a(new_n47_), .b(x18), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n52_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x13), .O(new_n74_));
  nand3  g33(.a(x18), .b(new_n52_), .c(x10), .O(new_n75_));
  ...
  nor2   g53(.a(new_n66_), .b(x05), .O(new_n95_));
  ...
  nand2  g60(.a(new_n94_), .b(x08), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(x19), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n101_), .O(z18));
  ...
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n71_), .O(z19));
endmodule
