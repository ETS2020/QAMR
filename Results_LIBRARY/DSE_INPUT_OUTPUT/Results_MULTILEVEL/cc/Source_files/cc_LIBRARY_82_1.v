...
module FAU ( 
  ...
  nor2   g03(.a(z04), .b(x12), .O(new_n45_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n47_), .O(z14));
  ...
  aoi22  g52(.a(new_n93_), .b(new_n74_), .c(new_n53_), .d(x17), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n71_), .c(new_n47_), .O(z16));
  nand2  g54(.a(new_n53_), .b(z04), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x05), .O(new_n97_));
  nand2  g56(.a(new_n53_), .b(x18), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n71_), .O(z17));
  nand2  g58(.a(new_n53_), .b(x19), .O(new_n100_));
  nand3  g59(.a(new_n74_), .b(x08), .c(x06), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(z18));
  nand2  g61(.a(new_n53_), .b(x20), .O(new_n103_));
  nand3  g62(.a(new_n74_), .b(x08), .c(x07), .O(new_n104_));
