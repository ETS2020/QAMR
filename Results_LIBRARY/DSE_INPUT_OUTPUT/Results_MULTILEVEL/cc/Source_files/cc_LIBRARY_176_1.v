...
module FAU ( 
  ...
  nand2  g18(.a(z04), .b(new_n51_), .O(z06));
  ...
  aoi21  g29(.a(x10), .b(x08), .c(x18), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(x15), .c(x13), .O(new_n72_));
  nor2   g31(.a(x18), .b(x15), .O(new_n73_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n70_), .c(new_n45_), .O(z13));
  ...
  nand2  g44(.a(new_n85_), .b(z04), .O(new_n86_));
