...
module FAU ( 
  ...
  oai21  g07(.a(new_n44_), .b(x11), .c(new_n48_), .O(new_n49_));
  ...
  nand2  g26(.a(new_n53_), .b(new_n44_), .O(z11));
  ...
  nor2   g39(.a(x15), .b(x11), .O(new_n81_));
  ...
  nand4  g45(.a(new_n48_), .b(x16), .c(new_n44_), .d(x12), .O(new_n87_));
  ...
  nand3  g50(.a(new_n48_), .b(x17), .c(x12), .O(new_n92_));
  ...
  nand3  g55(.a(new_n48_), .b(x18), .c(x12), .O(new_n97_));
  ...
  nand3  g60(.a(new_n48_), .b(x19), .c(x12), .O(new_n102_));
  ...
  nand3  g65(.a(new_n48_), .b(x20), .c(x12), .O(new_n107_));
