...
module FAU ( 
  ...
  nand2  g26(.a(new_n67_), .b(x17), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n50_), .O(new_n69_));
  nand3  g28(.a(new_n51_), .b(x13), .c(x12), .O(new_n70_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n55_), .c(new_n44_), .O(z13));
  nand2  g34(.a(new_n46_), .b(x15), .O(new_n76_));
  and2   g35(.a(x08), .b(x02), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(x17), .c(new_n50_), .d(x10), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n55_), .O(z14));
