...
module FAU ( 
  ...
  nand3  g29(.a(new_n70_), .b(new_n46_), .c(x12), .O(new_n71_));
  ...
  nand4  g34(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(x15), .O(z14));
