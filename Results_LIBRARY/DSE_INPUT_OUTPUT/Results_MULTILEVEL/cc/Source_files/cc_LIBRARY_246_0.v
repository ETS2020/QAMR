...
module FAU ( 
  ...
  nor2   g02(.a(x10), .b(x07), .O(new_n44_));
  ...
  nand2  g19(.a(new_n49_), .b(new_n50_), .O(z06));
  ...
  aoi21  g31(.a(x13), .b(x12), .c(new_n72_), .O(new_n73_));
  ...
  aoi22  g36(.a(new_n77_), .b(new_n75_), .c(new_n76_), .d(x13), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n71_), .c(new_n73_), .d(x10), .O(z12));
  aoi21  g38(.a(x08), .b(x01), .c(new_n46_), .O(new_n80_));
  nor2   g39(.a(new_n50_), .b(new_n66_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(x10), .O(new_n82_));
  nand3  g41(.a(x14), .b(new_n74_), .c(x07), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n71_), .O(z13));
  aoi21  g43(.a(x15), .b(x12), .c(new_n72_), .O(new_n85_));
  and2   g44(.a(x08), .b(x02), .O(new_n86_));
  aoi22  g45(.a(new_n86_), .b(new_n75_), .c(x15), .d(new_n66_), .O(new_n87_));
  oai22  g46(.a(new_n87_), .b(new_n71_), .c(new_n85_), .d(x10), .O(z14));
  ...
  nand4  g51(.a(x16), .b(new_n46_), .c(new_n74_), .d(x07), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n71_), .O(z15));
  nor2   g53(.a(x15), .b(new_n66_), .O(new_n95_));
  nand3  g54(.a(new_n50_), .b(x08), .c(x04), .O(new_n96_));
  oai21  g55(.a(new_n95_), .b(new_n62_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x10), .O(new_n98_));
  nand3  g57(.a(x17), .b(new_n74_), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n71_), .O(z16));
  aoi21  g59(.a(x18), .b(x12), .c(new_n72_), .O(new_n101_));
  and2   g60(.a(x08), .b(x05), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n75_), .c(new_n76_), .d(x18), .O(new_n103_));
  oai22  g62(.a(new_n103_), .b(new_n71_), .c(new_n101_), .d(x10), .O(z17));
  oai21  g63(.a(new_n59_), .b(new_n71_), .c(x07), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n74_), .O(new_n106_));
  nand2  g65(.a(new_n76_), .b(x19), .O(new_n107_));
  nand3  g66(.a(new_n75_), .b(x08), .c(x06), .O(new_n108_));
  ...
  aoi21  g70(.a(new_n51_), .b(new_n43_), .c(new_n72_), .O(new_n112_));
  and2   g71(.a(new_n51_), .b(x20), .O(new_n113_));
  oai21  g72(.a(new_n113_), .b(new_n112_), .c(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n49_), .O(z19));
endmodule
