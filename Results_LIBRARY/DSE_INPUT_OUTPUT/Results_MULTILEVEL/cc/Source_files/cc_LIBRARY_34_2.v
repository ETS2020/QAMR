...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n67_, new_n69_, new_n71_, new_n72_, new_n74_, new_n77_;
  ...
  nor3   g28(.a(new_n69_), .b(new_n44_), .c(new_n50_), .O(z13));
  ...
  aoi21  g33(.a(new_n74_), .b(x15), .c(new_n50_), .O(z15));
  aoi21  g34(.a(new_n59_), .b(x15), .c(new_n50_), .O(z16));
  inv1   g35(.a(x18), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x15), .c(new_n50_), .O(z17));
  aoi21  g37(.a(new_n57_), .b(x15), .c(new_n50_), .O(z18));
