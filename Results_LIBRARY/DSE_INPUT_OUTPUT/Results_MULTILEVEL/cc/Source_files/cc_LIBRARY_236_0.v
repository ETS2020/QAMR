...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n51_,
    new_n52_, new_n55_, new_n57_, new_n59_, new_n61_, new_n62_, new_n65_,
  ...
  nor2   g18(.a(new_n44_), .b(new_n59_), .O(z08));
  ...
  nor2   g41(.a(x15), .b(new_n65_), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  nand3  g43(.a(x16), .b(x15), .c(new_n65_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n51_), .O(z15));
  nand2  g45(.a(new_n46_), .b(x17), .O(new_n87_));
  nand4  g46(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n88_));
  ...
  nand2  g51(.a(new_n46_), .b(x18), .O(new_n93_));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n51_), .O(z17));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n51_), .O(z18));
