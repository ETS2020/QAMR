...
module FAU ( 
  ...
  nor2   g19(.a(x18), .b(x15), .O(z04));
  inv1   g20(.a(x19), .O(new_n62_));
  oai21  g21(.a(x18), .b(new_n43_), .c(new_n62_), .O(z05));
  nand2  g22(.a(x18), .b(x15), .O(new_n64_));
  ...
  nand2  g33(.a(new_n48_), .b(new_n43_), .O(new_n75_));
  ...
  nand2  g40(.a(new_n48_), .b(new_n56_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x18), .c(x15), .O(new_n83_));
  ...
  nand3  g50(.a(new_n76_), .b(x16), .c(new_n56_), .O(new_n92_));
  nand3  g51(.a(new_n79_), .b(x08), .c(x03), .O(new_n93_));
  ...
  aoi21  g60(.a(new_n48_), .b(new_n47_), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g65(.a(new_n62_), .b(new_n74_), .c(x18), .O(new_n107_));
  ...
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n74_), .O(z19));
endmodule
