...
module FAU ( 
  ...
  nand2  g32(.a(new_n55_), .b(new_n46_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x15), .O(new_n75_));
  inv1   g34(.a(x01), .O(new_n76_));
  oai21  g35(.a(new_n55_), .b(new_n76_), .c(x14), .O(new_n77_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n79_), .c(new_n54_), .O(z14));
  ...
  nand2  g50(.a(new_n50_), .b(x18), .O(new_n92_));
  nand3  g51(.a(new_n81_), .b(x08), .c(x05), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n54_), .O(z17));
  nand2  g53(.a(new_n50_), .b(x19), .O(new_n95_));
  nand3  g54(.a(new_n81_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n54_), .O(z18));
  inv1   g56(.a(x07), .O(new_n98_));
  oai21  g57(.a(new_n55_), .b(new_n98_), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n49_), .O(new_n100_));
  nand3  g59(.a(new_n50_), .b(x20), .c(x12), .O(new_n101_));
