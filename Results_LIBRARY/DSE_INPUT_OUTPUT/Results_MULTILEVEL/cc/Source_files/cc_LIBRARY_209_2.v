...
module FAU ( 
  ...
  nand2  g26(.a(new_n67_), .b(new_n56_), .O(z09));
  nand3  g27(.a(new_n56_), .b(x09), .c(x08), .O(z10));
  nand2  g28(.a(new_n56_), .b(new_n45_), .O(z11));
  ...
  oai21  g35(.a(new_n47_), .b(x14), .c(x15), .O(new_n77_));
  nand2  g36(.a(new_n47_), .b(x01), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x14), .c(new_n42_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(z13));
  nand4  g39(.a(new_n50_), .b(x10), .c(x08), .d(x02), .O(new_n81_));
  oai21  g40(.a(new_n47_), .b(new_n50_), .c(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n56_), .O(z14));
  ...
  nand4  g46(.a(new_n51_), .b(x16), .c(new_n45_), .d(x12), .O(new_n88_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n76_), .O(z16));
