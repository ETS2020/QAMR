...
module FAU ( 
  ...
  aoi21  g11(.a(new_n52_), .b(new_n44_), .c(x11), .O(z02));
  nand4  g12(.a(x12), .b(x11), .c(x10), .d(x08), .O(new_n54_));
  ...
  nand2  g43(.a(new_n48_), .b(new_n44_), .O(new_n85_));
  nand2  g44(.a(x15), .b(x11), .O(new_n86_));
  ...
  oai21  g67(.a(new_n43_), .b(new_n75_), .c(x11), .O(new_n109_));
