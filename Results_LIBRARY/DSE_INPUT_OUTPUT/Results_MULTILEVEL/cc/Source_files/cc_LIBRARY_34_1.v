...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x12), .c(new_n43_), .O(z03));
  nor2   g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  aoi21  g18(.a(x15), .b(new_n47_), .c(new_n59_), .O(z05));
  nor2   g19(.a(new_n43_), .b(new_n47_), .O(z06));
  ...
  nand2  g27(.a(new_n45_), .b(new_n51_), .O(z11));
  ...
  oai21  g66(.a(x20), .b(new_n47_), .c(x15), .O(new_n108_));
  nand2  g67(.a(new_n48_), .b(x20), .O(new_n109_));
  nand4  g68(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n110_));
