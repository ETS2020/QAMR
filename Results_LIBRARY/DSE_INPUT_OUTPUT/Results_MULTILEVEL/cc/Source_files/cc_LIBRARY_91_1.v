...
module FAU ( 
  ...
  nand3  g44(.a(new_n56_), .b(x16), .c(new_n47_), .O(new_n86_));
  ...
  oai21  g49(.a(x17), .b(new_n55_), .c(x15), .O(new_n91_));
  ...
  oai21  g55(.a(x18), .b(new_n55_), .c(x15), .O(new_n97_));
  ...
  oai21  g61(.a(x19), .b(new_n55_), .c(x15), .O(new_n103_));
  ...
  oai21  g67(.a(x20), .b(new_n55_), .c(x15), .O(new_n109_));
