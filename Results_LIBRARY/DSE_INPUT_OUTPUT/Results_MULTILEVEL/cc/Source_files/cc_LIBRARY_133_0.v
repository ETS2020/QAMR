...
module FAU ( 
  ...
  nand2  g39(.a(new_n80_), .b(new_n49_), .O(z13));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n56_), .O(z14));
  ...
  oai21  g52(.a(new_n57_), .b(new_n93_), .c(x12), .O(new_n94_));
  ...
  oai21  g57(.a(new_n57_), .b(new_n98_), .c(x12), .O(new_n99_));
  ...
  oai21  g62(.a(new_n57_), .b(new_n103_), .c(x12), .O(new_n104_));
