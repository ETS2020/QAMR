...
module FAU ( 
  ...
  nand2  g34(.a(new_n55_), .b(new_n47_), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  aoi22  g36(.a(new_n77_), .b(x14), .c(new_n76_), .d(x15), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n75_), .c(new_n45_), .O(z13));
  nand2  g38(.a(new_n55_), .b(x15), .O(new_n80_));
  inv1   g39(.a(new_n51_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n43_), .c(x02), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n75_), .O(z14));
  nand4  g42(.a(new_n51_), .b(x16), .c(new_n47_), .d(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n45_), .O(z15));
  nand2  g44(.a(new_n55_), .b(x17), .O(new_n86_));
  nand4  g45(.a(new_n50_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n43_), .O(new_n89_));
  nand2  g48(.a(x17), .b(x15), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n75_), .O(z16));
  ...
  nand3  g53(.a(new_n51_), .b(x18), .c(x12), .O(new_n95_));
