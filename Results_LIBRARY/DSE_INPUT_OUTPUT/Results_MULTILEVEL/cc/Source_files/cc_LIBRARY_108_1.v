...
module FAU ( 
  ...
  oai21  g07(.a(new_n44_), .b(x00), .c(x14), .O(new_n49_));
  ...
  aoi21  g14(.a(new_n55_), .b(x00), .c(new_n44_), .O(z03));
  nor2   g15(.a(new_n45_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  oai21  g17(.a(new_n44_), .b(x00), .c(new_n58_), .O(z05));
  ...
  nand2  g28(.a(new_n66_), .b(new_n54_), .O(z11));
  ...
  nand3  g34(.a(new_n75_), .b(new_n44_), .c(x13), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(z12));
  nand2  g36(.a(new_n75_), .b(new_n54_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x15), .c(x00), .O(new_n79_));
  ...
  nand2  g41(.a(new_n75_), .b(x15), .O(new_n83_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n66_), .O(z14));
  nand2  g46(.a(new_n75_), .b(new_n44_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n60_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x16), .c(new_n54_), .O(new_n90_));
  nand4  g49(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n71_), .O(z15));
  oai21  g51(.a(new_n62_), .b(new_n71_), .c(x00), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x15), .O(new_n94_));
  nand2  g53(.a(new_n75_), .b(x17), .O(new_n95_));
  ...
  nand2  g66(.a(new_n75_), .b(x19), .O(new_n108_));
  ...
  nand2  g72(.a(new_n75_), .b(x20), .O(new_n114_));
