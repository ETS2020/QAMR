...
module FAU ( 
  ...
  oai21  g13(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(new_n55_));
  ...
  nand2  g21(.a(new_n53_), .b(new_n43_), .O(z06));
  ...
  aoi21  g26(.a(x15), .b(new_n52_), .c(new_n43_), .O(z09));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n58_), .O(z12));
  ...
  nand4  g42(.a(new_n83_), .b(new_n43_), .c(x08), .d(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n81_), .c(new_n58_), .O(z14));
  nand3  g44(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n86_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n58_), .O(z15));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n58_), .O(z18));
  nand4  g68(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n43_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n53_), .O(new_n112_));
  nand2  g71(.a(new_n83_), .b(x08), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(x20), .c(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n112_), .O(z19));
endmodule
