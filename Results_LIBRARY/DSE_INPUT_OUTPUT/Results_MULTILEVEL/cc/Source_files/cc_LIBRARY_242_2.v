...
module FAU ( 
  ...
  oai21  g09(.a(x19), .b(new_n47_), .c(x14), .O(new_n51_));
  ...
  nand2  g19(.a(new_n43_), .b(new_n47_), .O(z05));
  ...
  nand3  g50(.a(new_n72_), .b(x16), .c(new_n48_), .O(new_n92_));
  ...
  nand3  g60(.a(x19), .b(x17), .c(x15), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n97_), .O(z16));
  nand2  g62(.a(x18), .b(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x19), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n72_), .b(x18), .O(new_n107_));
  nand4  g66(.a(new_n47_), .b(x10), .c(x08), .d(x05), .O(new_n108_));
  ...
  nand2  g70(.a(new_n52_), .b(new_n43_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x06), .O(new_n113_));
  nand2  g72(.a(new_n52_), .b(x19), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n97_), .O(z18));
  ...
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n97_), .O(z19));
  buf    g80(.a(x15), .O(z06));
endmodule
