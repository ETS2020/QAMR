...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n55_, new_n57_, new_n62_,
  ...
  nor2   g18(.a(new_n44_), .b(new_n52_), .O(z05));
  ...
  aoi21  g28(.a(x10), .b(x08), .c(x19), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(x15), .c(x13), .O(new_n71_));
  nand3  g30(.a(new_n44_), .b(new_n52_), .c(x10), .O(new_n72_));
