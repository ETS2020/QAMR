...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x09), .c(new_n43_), .O(z01));
  ...
  aoi21  g15(.a(new_n56_), .b(x09), .c(new_n43_), .O(z03));
  ...
  oai21  g24(.a(new_n65_), .b(new_n51_), .c(new_n45_), .O(z09));
  nand2  g25(.a(new_n43_), .b(new_n65_), .O(new_n67_));
  oai21  g26(.a(new_n65_), .b(x08), .c(new_n67_), .O(z10));
  aoi21  g27(.a(x15), .b(new_n65_), .c(new_n47_), .O(z11));
  nand2  g28(.a(x13), .b(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x09), .O(new_n71_));
  ...
  nand2  g38(.a(new_n73_), .b(new_n47_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x15), .c(x09), .O(new_n81_));
  ...
  nand3  g43(.a(new_n73_), .b(x15), .c(x09), .O(new_n85_));
  ...
  nand2  g47(.a(new_n73_), .b(new_n43_), .O(new_n89_));
  nand2  g48(.a(x15), .b(x09), .O(new_n90_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n79_), .O(z15));
  ...
  nand3  g57(.a(x17), .b(x15), .c(x09), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n79_), .O(z16));
  nand2  g59(.a(x18), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x09), .O(new_n102_));
  ...
  nand3  g71(.a(x19), .b(x15), .c(x09), .O(new_n113_));
  ...
  nand3  g77(.a(x20), .b(x15), .c(x09), .O(new_n119_));
