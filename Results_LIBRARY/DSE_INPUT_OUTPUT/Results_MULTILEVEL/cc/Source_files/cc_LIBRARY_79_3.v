...
module FAU ( 
  ...
  oai21  g51(.a(new_n63_), .b(new_n71_), .c(new_n46_), .O(new_n93_));
  ...
  aoi21  g59(.a(new_n72_), .b(new_n46_), .c(new_n100_), .O(new_n101_));
  aoi21  g60(.a(x10), .b(x08), .c(new_n46_), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(new_n103_));
  nor2   g62(.a(new_n103_), .b(new_n71_), .O(z17));
