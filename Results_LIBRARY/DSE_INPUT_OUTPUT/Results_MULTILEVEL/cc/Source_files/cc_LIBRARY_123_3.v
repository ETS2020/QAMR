...
module FAU ( 
  ...
  nand2  g17(.a(x15), .b(new_n45_), .O(new_n59_));
  ...
  aoi21  g25(.a(x15), .b(x04), .c(new_n47_), .O(z11));
  ...
  nand2  g35(.a(new_n69_), .b(new_n47_), .O(new_n77_));
  ...
  nand3  g40(.a(new_n69_), .b(x15), .c(new_n45_), .O(new_n82_));
  nand3  g41(.a(new_n74_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n68_), .O(z14));
  nand3  g43(.a(new_n71_), .b(x16), .c(new_n47_), .O(new_n85_));
  ...
  nand2  g51(.a(new_n69_), .b(x18), .O(new_n93_));
  ...
  nand3  g55(.a(x18), .b(x15), .c(new_n45_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n68_), .O(z17));
  oai21  g57(.a(new_n57_), .b(new_n68_), .c(new_n45_), .O(new_n99_));
  ...
  nand2  g64(.a(new_n69_), .b(x20), .O(new_n106_));
