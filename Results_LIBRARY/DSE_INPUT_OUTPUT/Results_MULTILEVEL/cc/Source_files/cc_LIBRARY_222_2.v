...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n51_,
    new_n53_, new_n55_, new_n57_, new_n59_, new_n61_, new_n62_, new_n66_,
  ...
  nor2   g16(.a(new_n53_), .b(new_n57_), .O(z07));
  inv1   g17(.a(x16), .O(new_n59_));
  nor2   g18(.a(new_n53_), .b(new_n59_), .O(z08));
  inv1   g19(.a(x08), .O(new_n61_));
  oai21  g20(.a(x15), .b(new_n43_), .c(x09), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n61_), .O(z09));
  aoi21  g22(.a(x09), .b(x08), .c(new_n53_), .O(z10));
  nor2   g23(.a(new_n53_), .b(new_n46_), .O(z11));
  ...
  nor3   g28(.a(new_n69_), .b(new_n68_), .c(new_n43_), .O(z13));
