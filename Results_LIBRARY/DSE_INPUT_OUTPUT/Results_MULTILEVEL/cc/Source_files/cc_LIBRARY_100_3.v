...
module FAU ( 
  ...
  inv1   g21(.a(new_n56_), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n62_), .O(z08));
  nand3  g23(.a(new_n63_), .b(x09), .c(x08), .O(new_n65_));
  ...
  inv1   g42(.a(new_n50_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n77_), .O(z14));
  nand2  g45(.a(new_n46_), .b(new_n43_), .O(new_n87_));
  nand2  g46(.a(x15), .b(new_n42_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x16), .c(new_n49_), .O(new_n90_));
  nand3  g49(.a(new_n84_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n77_), .O(z15));
  oai21  g51(.a(new_n60_), .b(new_n77_), .c(new_n42_), .O(new_n93_));
  ...
  oai21  g64(.a(new_n58_), .b(new_n77_), .c(new_n42_), .O(new_n106_));
  ...
  oai21  g71(.a(new_n44_), .b(new_n77_), .c(new_n42_), .O(new_n113_));
