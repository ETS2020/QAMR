...
module FAU ( 
  ...
  oai21  g28(.a(new_n46_), .b(new_n69_), .c(x12), .O(new_n70_));
  ...
  nand3  g38(.a(new_n46_), .b(x15), .c(x12), .O(new_n80_));
  inv1   g39(.a(x02), .O(new_n81_));
  oai21  g40(.a(new_n46_), .b(new_n81_), .c(x12), .O(new_n82_));
  ...
  nand4  g46(.a(new_n52_), .b(x16), .c(new_n47_), .d(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  oai21  g49(.a(new_n46_), .b(new_n90_), .c(x12), .O(new_n91_));
