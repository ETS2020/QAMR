...
module FAU ( 
  ...
  nand2  g27(.a(new_n68_), .b(x16), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n51_), .O(new_n70_));
  nand3  g29(.a(new_n51_), .b(x10), .c(x08), .O(new_n71_));
  ...
  nand2  g41(.a(new_n82_), .b(x16), .O(new_n83_));
  ...
  nand2  g46(.a(new_n87_), .b(x16), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n51_), .O(new_n89_));
  nand3  g48(.a(new_n71_), .b(x17), .c(x12), .O(new_n90_));
  ...
  nand3  g53(.a(new_n71_), .b(x18), .c(x12), .O(new_n95_));
