...
module FAU ( 
  ...
  nand4  g07(.a(new_n48_), .b(x10), .c(new_n43_), .d(x08), .O(new_n49_));
  ...
  nand2  g51(.a(new_n57_), .b(x17), .O(new_n93_));
  ...
  nand3  g69(.a(x19), .b(x15), .c(new_n43_), .O(new_n111_));
