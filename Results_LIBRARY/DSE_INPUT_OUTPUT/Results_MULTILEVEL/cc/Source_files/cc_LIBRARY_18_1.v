...
module FAU ( 
  ...
  nand2  g28(.a(new_n47_), .b(new_n43_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n51_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x13), .O(new_n72_));
  nand3  g31(.a(new_n43_), .b(new_n51_), .c(x10), .O(new_n73_));
  ...
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n56_), .O(z13));
  ...
  nand2  g54(.a(new_n71_), .b(x19), .O(new_n96_));
  nand3  g55(.a(new_n74_), .b(x08), .c(x06), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n56_), .O(z18));
  nand4  g57(.a(new_n51_), .b(x10), .c(x08), .d(x07), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n43_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n46_), .O(z19));
endmodule
