...
module FAU ( 
  ...
  nand3  g33(.a(new_n74_), .b(x14), .c(new_n66_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n54_), .O(z13));
  nand2  g35(.a(new_n46_), .b(x15), .O(new_n77_));
  nor2   g36(.a(x15), .b(x11), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(x10), .c(x08), .d(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n54_), .O(z14));
  nand3  g39(.a(new_n46_), .b(x16), .c(new_n47_), .O(new_n81_));
  nand4  g40(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n66_), .O(new_n84_));
  ...
  nand4  g46(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n66_), .O(new_n90_));
  nand2  g49(.a(x17), .b(x15), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n54_), .O(z16));
  ...
  nand2  g54(.a(new_n95_), .b(new_n66_), .O(new_n96_));
  nand2  g55(.a(x18), .b(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n54_), .O(z17));
  nand4  g57(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n66_), .O(new_n100_));
