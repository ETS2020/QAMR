...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n58_, new_n60_, new_n62_, new_n66_,
  ...
  nand2  g26(.a(new_n53_), .b(x13), .O(new_n68_));
  ...
  nand2  g32(.a(new_n44_), .b(x14), .O(new_n74_));
  nand3  g33(.a(x15), .b(x10), .c(x08), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n66_), .O(z13));
  nand2  g35(.a(new_n53_), .b(x15), .O(new_n77_));
  inv1   g36(.a(new_n49_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x02), .c(new_n67_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n66_), .O(z14));
  nand4  g39(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n67_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n43_), .O(new_n83_));
  nand4  g42(.a(new_n49_), .b(x16), .c(new_n46_), .d(x12), .O(new_n84_));
  ...
  nand3  g47(.a(new_n49_), .b(x17), .c(x12), .O(new_n89_));
  ...
  nand3  g52(.a(new_n49_), .b(x18), .c(x12), .O(new_n94_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n66_), .O(z18));
  ...
  nand2  g63(.a(new_n104_), .b(new_n67_), .O(new_n105_));
  nand2  g64(.a(x20), .b(x15), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n66_), .O(z19));
  buf    g66(.a(x15), .O(z06));
endmodule
