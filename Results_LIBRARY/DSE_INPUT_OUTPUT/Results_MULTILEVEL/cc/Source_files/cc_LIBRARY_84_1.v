...
module FAU ( 
  ...
  nand3  g35(.a(new_n76_), .b(new_n75_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n68_), .O(z13));
  nand2  g37(.a(new_n46_), .b(x15), .O(new_n79_));
  nand4  g38(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n68_), .O(z14));
  nand4  g40(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n75_), .O(new_n83_));
  ...
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n68_), .O(z16));
  ...
  nand2  g55(.a(new_n96_), .b(new_n75_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n43_), .O(new_n98_));
  nand3  g57(.a(new_n43_), .b(x10), .c(x08), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(x19), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n98_), .O(z18));
  ...
  nand2  g63(.a(new_n104_), .b(new_n75_), .O(new_n105_));
