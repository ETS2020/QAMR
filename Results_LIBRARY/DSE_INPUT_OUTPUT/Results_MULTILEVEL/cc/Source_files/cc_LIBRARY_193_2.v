...
module FAU ( 
  ...
  oai21  g19(.a(x17), .b(new_n44_), .c(new_n60_), .O(z05));
  nand2  g20(.a(x17), .b(x15), .O(new_n62_));
  ...
  nand2  g30(.a(new_n49_), .b(new_n44_), .O(new_n72_));
  ...
  oai21  g61(.a(new_n60_), .b(new_n71_), .c(x17), .O(new_n103_));
  ...
  oai21  g68(.a(new_n43_), .b(new_n71_), .c(x17), .O(new_n110_));
