...
module FAU ( 
  ...
  nand4  g12(.a(x12), .b(x10), .c(x08), .d(new_n46_), .O(new_n54_));
  nor3   g13(.a(new_n54_), .b(new_n45_), .c(x14), .O(z03));
  nand2  g14(.a(new_n43_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  aoi21  g16(.a(x15), .b(x07), .c(new_n57_), .O(z05));
  nand2  g17(.a(x15), .b(new_n46_), .O(new_n59_));
  ...
  aoi21  g26(.a(x15), .b(x07), .c(new_n49_), .O(z11));
  ...
  nand2  g37(.a(new_n72_), .b(new_n49_), .O(new_n79_));
  ...
  nand3  g42(.a(new_n72_), .b(x15), .c(new_n46_), .O(new_n84_));
  inv1   g43(.a(x10), .O(new_n85_));
  nor2   g44(.a(x15), .b(new_n85_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x08), .c(x02), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n84_), .c(new_n78_), .O(z14));
  nand2  g47(.a(new_n72_), .b(new_n45_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n59_), .O(new_n90_));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n78_), .O(z17));
  nand2  g64(.a(new_n72_), .b(x19), .O(new_n106_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n78_), .O(z18));
  nand3  g70(.a(x12), .b(x10), .c(x08), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n45_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x07), .O(new_n114_));
  nand3  g73(.a(new_n50_), .b(x20), .c(x12), .O(new_n115_));
