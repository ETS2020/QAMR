...
module FAU ( 
  ...
  nand4  g10(.a(new_n43_), .b(new_n51_), .c(x10), .d(x08), .O(new_n52_));
  oai21  g11(.a(new_n44_), .b(new_n47_), .c(new_n52_), .O(new_n53_));
  ...
  nand3  g50(.a(new_n73_), .b(x17), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(z16));
  nand4  g52(.a(new_n51_), .b(x10), .c(x08), .d(x05), .O(new_n94_));
  ...
  nand2  g61(.a(new_n57_), .b(x20), .O(new_n103_));
