...
module FAU ( 
  ...
  aoi21  g19(.a(x15), .b(x01), .c(new_n60_), .O(z05));
  ...
  aoi22  g28(.a(x15), .b(x01), .c(x09), .d(x08), .O(z10));
  ...
  nand2  g49(.a(new_n90_), .b(new_n42_), .O(z14));
  inv1   g50(.a(x12), .O(new_n92_));
  nand2  g51(.a(new_n75_), .b(new_n46_), .O(new_n93_));
