...
module FAU ( 
  ...
  nand2  g31(.a(new_n55_), .b(new_n48_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n55_), .b(x16), .c(new_n48_), .O(new_n85_));
  ...
  nand3  g49(.a(new_n70_), .b(x08), .c(x04), .O(new_n91_));
  ...
  nand3  g61(.a(new_n70_), .b(x08), .c(x07), .O(new_n103_));
