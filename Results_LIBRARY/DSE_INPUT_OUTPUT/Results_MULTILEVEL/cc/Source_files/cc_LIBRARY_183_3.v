...
module FAU ( 
  ...
  nor4   g07(.a(new_n48_), .b(new_n44_), .c(x14), .d(x13), .O(z01));
  ...
  nand4  g15(.a(new_n56_), .b(x15), .c(new_n50_), .d(new_n43_), .O(new_n57_));
  ...
  aoi21  g30(.a(new_n48_), .b(new_n43_), .c(new_n71_), .O(new_n72_));
  aoi21  g31(.a(x10), .b(x08), .c(new_n43_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n70_), .O(z12));
  ...
  nand4  g41(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  ...
  nand3  g48(.a(new_n48_), .b(x16), .c(new_n50_), .O(new_n90_));
