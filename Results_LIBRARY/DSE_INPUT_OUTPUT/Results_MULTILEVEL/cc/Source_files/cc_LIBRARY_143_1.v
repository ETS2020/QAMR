...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x05), .c(new_n43_), .O(z03));
  ...
  nor2   g29(.a(new_n55_), .b(x15), .O(new_n71_));
  inv1   g30(.a(x05), .O(new_n72_));
  nor2   g31(.a(new_n43_), .b(new_n72_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n54_), .b(x15), .c(x05), .O(new_n85_));
  ...
  nand2  g47(.a(new_n88_), .b(x05), .O(new_n89_));
  ...
  oai21  g56(.a(new_n54_), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n43_), .O(new_n99_));
  nand3  g58(.a(x17), .b(x15), .c(x05), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n70_), .O(z16));
  inv1   g60(.a(x18), .O(new_n102_));
  aoi21  g61(.a(new_n50_), .b(new_n102_), .c(new_n72_), .O(new_n103_));
  and2   g62(.a(new_n50_), .b(x18), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n103_), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n45_), .O(z17));
  inv1   g65(.a(x06), .O(new_n107_));
  nand2  g66(.a(new_n54_), .b(x19), .O(new_n108_));
  oai21  g67(.a(new_n54_), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  ...
  aoi21  g71(.a(x20), .b(x12), .c(new_n72_), .O(new_n113_));
  and2   g72(.a(x08), .b(x07), .O(new_n114_));
  aoi22  g73(.a(new_n114_), .b(new_n76_), .c(new_n54_), .d(x20), .O(new_n115_));
  oai22  g74(.a(new_n115_), .b(new_n70_), .c(new_n113_), .d(new_n43_), .O(z19));
  buf    g75(.a(x15), .O(z06));
endmodule
