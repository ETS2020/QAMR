...
module FAU ( 
  ...
  oai21  g36(.a(new_n77_), .b(new_n57_), .c(new_n47_), .O(z13));
  nand2  g37(.a(new_n48_), .b(x15), .O(new_n79_));
  inv1   g38(.a(new_n53_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n44_), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n57_), .O(z14));
  nand2  g41(.a(new_n48_), .b(new_n44_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n52_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(x16), .c(new_n49_), .d(x12), .O(new_n85_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n57_), .O(z18));
