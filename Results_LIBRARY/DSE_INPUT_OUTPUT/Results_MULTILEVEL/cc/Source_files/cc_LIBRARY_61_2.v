...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(new_n47_), .c(x02), .O(new_n54_));
  ...
  nor2   g30(.a(new_n44_), .b(new_n47_), .O(z11));
  ...
  oai21  g41(.a(new_n82_), .b(new_n73_), .c(new_n45_), .O(z13));
  ...
  oai21  g60(.a(new_n49_), .b(new_n61_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n43_), .O(new_n103_));
  nand2  g62(.a(x19), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n73_), .O(z18));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n73_), .O(z19));
endmodule
