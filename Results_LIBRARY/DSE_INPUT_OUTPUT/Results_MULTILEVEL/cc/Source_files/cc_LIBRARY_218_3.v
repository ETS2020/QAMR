...
module FAU ( 
  ...
  nand2  g07(.a(x20), .b(x18), .O(new_n49_));
  nand3  g08(.a(new_n49_), .b(x15), .c(new_n48_), .O(new_n50_));
  nor3   g09(.a(new_n50_), .b(new_n47_), .c(new_n46_), .O(z01));
  inv1   g10(.a(x15), .O(new_n52_));
  nand3  g11(.a(new_n52_), .b(x10), .c(x08), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(new_n48_), .O(new_n54_));
  nand4  g13(.a(new_n54_), .b(new_n49_), .c(x12), .d(new_n42_), .O(new_n55_));
  inv1   g14(.a(new_n55_), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  nor4   g16(.a(new_n50_), .b(new_n57_), .c(new_n47_), .d(new_n46_), .O(z03));
  nand2  g17(.a(new_n44_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nand2  g19(.a(new_n49_), .b(new_n60_), .O(z05));
  aoi21  g20(.a(x20), .b(x18), .c(new_n52_), .O(z06));
  and2   g21(.a(new_n49_), .b(x17), .O(z07));
  ...
  nand2  g27(.a(new_n49_), .b(new_n48_), .O(z11));
  ...
  nand3  g31(.a(new_n72_), .b(new_n49_), .c(x12), .O(new_n73_));
  ...
  nand3  g38(.a(new_n79_), .b(new_n49_), .c(x12), .O(new_n80_));
  ...
  oai21  g53(.a(new_n94_), .b(new_n57_), .c(new_n49_), .O(z16));
  and2   g54(.a(x08), .b(x05), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n92_), .c(new_n53_), .d(x18), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n57_), .c(new_n49_), .O(z17));
  and2   g57(.a(x08), .b(x06), .O(new_n99_));
  aoi22  g58(.a(new_n99_), .b(new_n92_), .c(new_n53_), .d(x19), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n57_), .c(new_n49_), .O(z18));
  nand2  g60(.a(x20), .b(new_n43_), .O(new_n102_));
  nand2  g61(.a(new_n44_), .b(new_n52_), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(new_n76_), .c(new_n102_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x07), .O(new_n105_));
  nand3  g64(.a(new_n53_), .b(x20), .c(new_n43_), .O(new_n106_));
