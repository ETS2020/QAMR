...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n57_, new_n60_, new_n63_, new_n64_,
  ...
  nor4   g13(.a(new_n46_), .b(new_n50_), .c(x14), .d(new_n43_), .O(z03));
  ...
  aoi22  g24(.a(new_n43_), .b(x07), .c(x09), .d(x08), .O(z10));
  ...
  nand3  g46(.a(new_n70_), .b(x08), .c(x04), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n43_), .O(z16));
  and2   g48(.a(x08), .b(x05), .O(new_n90_));
  aoi22  g49(.a(new_n90_), .b(new_n70_), .c(new_n51_), .d(x18), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n43_), .c(new_n44_), .O(z17));
  ...
  nand2  g54(.a(new_n51_), .b(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x07), .O(new_n97_));
  nand3  g56(.a(new_n51_), .b(x20), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z19));
endmodule
