...
module FAU ( 
  ...
  nand3  g54(.a(new_n83_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n57_), .O(z18));
  nand2  g56(.a(new_n53_), .b(x20), .O(new_n98_));
  nand3  g57(.a(new_n83_), .b(x08), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n57_), .O(z19));
endmodule
