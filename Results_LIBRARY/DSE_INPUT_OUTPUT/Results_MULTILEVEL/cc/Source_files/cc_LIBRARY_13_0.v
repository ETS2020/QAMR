...
module FAU ( 
  ...
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n56_), .O(z13));
  ...
  nand3  g40(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n82_));
  ...
  nand3  g44(.a(new_n72_), .b(x08), .c(x04), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n56_), .O(z16));
  nand2  g46(.a(new_n52_), .b(x18), .O(new_n88_));
  nand3  g47(.a(new_n72_), .b(x08), .c(x05), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n56_), .O(z17));
  nand2  g49(.a(new_n52_), .b(x19), .O(new_n91_));
  nand3  g50(.a(new_n72_), .b(x08), .c(x06), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n56_), .O(z18));
  inv1   g52(.a(x07), .O(new_n94_));
  oai21  g53(.a(new_n47_), .b(new_n94_), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n51_), .O(new_n96_));
  nand3  g55(.a(new_n52_), .b(x20), .c(x12), .O(new_n97_));
