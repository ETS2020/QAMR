...
module FAU ( 
  ...
  nand3  g30(.a(x17), .b(new_n51_), .c(x10), .O(new_n72_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n68_), .c(new_n44_), .O(z13));
  ...
  nand3  g42(.a(new_n70_), .b(x16), .c(new_n46_), .O(new_n84_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n68_), .O(z17));
