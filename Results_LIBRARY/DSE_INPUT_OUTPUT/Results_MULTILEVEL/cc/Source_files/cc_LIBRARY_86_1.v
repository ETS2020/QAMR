...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x13), .c(new_n46_), .O(z03));
  inv1   g16(.a(new_n44_), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  aoi21  g19(.a(x15), .b(new_n43_), .c(new_n60_), .O(z05));
  nor2   g20(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  nand3  g38(.a(new_n79_), .b(x15), .c(x13), .O(new_n80_));
  ...
  nand3  g42(.a(new_n78_), .b(x15), .c(x13), .O(new_n84_));
  ...
  nand3  g48(.a(new_n78_), .b(x16), .c(new_n47_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n63_), .b(new_n72_), .c(x13), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n78_), .b(x17), .O(new_n97_));
  nand4  g56(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n98_));
  ...
  oai21  g68(.a(new_n60_), .b(new_n72_), .c(x13), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n78_), .b(x19), .O(new_n112_));
  nand4  g71(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n113_));
  ...
  nand2  g75(.a(new_n78_), .b(x20), .O(new_n117_));
