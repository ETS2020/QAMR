...
module FAU ( 
  ...
  nor2   g23(.a(new_n55_), .b(new_n64_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nand2  g25(.a(new_n56_), .b(new_n66_), .O(z08));
  inv1   g26(.a(x08), .O(new_n68_));
  inv1   g27(.a(x09), .O(new_n69_));
  nor3   g28(.a(new_n55_), .b(new_n69_), .c(new_n68_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n55_), .O(z10));
  nor2   g30(.a(new_n55_), .b(new_n45_), .O(z11));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n78_), .O(z14));
  nand3  g44(.a(new_n46_), .b(x16), .c(new_n45_), .O(new_n86_));
  ...
  nand3  g48(.a(x16), .b(x15), .c(new_n45_), .O(new_n90_));
