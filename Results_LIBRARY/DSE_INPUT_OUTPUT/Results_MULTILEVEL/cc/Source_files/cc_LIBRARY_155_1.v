...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x04), .c(new_n46_), .O(z03));
  inv1   g16(.a(new_n44_), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  oai21  g19(.a(new_n46_), .b(x04), .c(new_n60_), .O(z05));
  ...
  nand2  g53(.a(new_n50_), .b(new_n63_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x04), .O(new_n96_));
  nand3  g55(.a(new_n54_), .b(x17), .c(new_n46_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n71_), .O(z16));
  nand2  g57(.a(x18), .b(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x04), .O(new_n100_));
  ...
  oai21  g65(.a(new_n60_), .b(new_n71_), .c(x04), .O(new_n107_));
  ...
  nand3  g76(.a(x20), .b(x15), .c(x04), .O(new_n118_));
