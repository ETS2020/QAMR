...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n57_, new_n59_, new_n62_, new_n66_,
  ...
  aoi21  g12(.a(new_n53_), .b(new_n45_), .c(new_n46_), .O(z02));
