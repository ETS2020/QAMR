...
module FAU ( 
  ...
  nand3  g23(.a(new_n43_), .b(x09), .c(x08), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z09));
  aoi21  g25(.a(x09), .b(x08), .c(new_n60_), .O(z10));
  nand2  g26(.a(new_n43_), .b(new_n56_), .O(z11));
  ...
  nand2  g35(.a(new_n46_), .b(new_n56_), .O(new_n77_));
  ...
  nand3  g52(.a(z04), .b(x17), .c(x15), .O(new_n94_));
  ...
  oai21  g59(.a(new_n59_), .b(new_n69_), .c(z04), .O(new_n101_));
  ...
  nand3  g70(.a(x20), .b(z04), .c(x15), .O(new_n112_));
