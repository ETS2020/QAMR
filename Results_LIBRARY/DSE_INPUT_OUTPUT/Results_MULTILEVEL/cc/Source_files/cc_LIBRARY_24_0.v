...
module FAU ( 
  ...
  oai21  g46(.a(new_n56_), .b(new_n87_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n51_), .O(new_n89_));
  nand4  g48(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(z15));
  nand2  g50(.a(new_n52_), .b(x17), .O(new_n92_));
  nand3  g51(.a(new_n84_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n81_), .O(z16));
  nand2  g53(.a(new_n52_), .b(x18), .O(new_n95_));
  nand3  g54(.a(new_n84_), .b(x08), .c(x05), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n81_), .O(z17));
  ...
  nand3  g62(.a(new_n84_), .b(x08), .c(x07), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n81_), .O(z19));
  buf    g64(.a(x15), .O(z06));
endmodule
