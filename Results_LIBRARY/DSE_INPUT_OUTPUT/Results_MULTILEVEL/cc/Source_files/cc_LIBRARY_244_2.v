...
module FAU ( 
  ...
  oai21  g18(.a(x15), .b(new_n54_), .c(x17), .O(new_n60_));
  ...
  oai21  g27(.a(x15), .b(new_n54_), .c(x13), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n68_), .O(z12));
  aoi21  g29(.a(x12), .b(x08), .c(new_n44_), .O(new_n71_));
  nand2  g30(.a(x14), .b(x12), .O(new_n72_));
  oai21  g31(.a(new_n71_), .b(new_n54_), .c(new_n72_), .O(z13));
  nand2  g32(.a(x10), .b(x08), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(x15), .c(x12), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z14));
  nand4  g35(.a(new_n45_), .b(x16), .c(new_n47_), .d(x12), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z15));
  nor2   g37(.a(new_n60_), .b(new_n68_), .O(z16));
  nand2  g38(.a(x18), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n45_), .O(z17));
  oai21  g40(.a(new_n57_), .b(new_n68_), .c(new_n45_), .O(z18));
  oai21  g41(.a(new_n43_), .b(new_n68_), .c(new_n45_), .O(z19));
endmodule
