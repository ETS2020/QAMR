...
module FAU ( 
  ...
  nand3  g22(.a(new_n45_), .b(x09), .c(x08), .O(new_n64_));
  ...
  nand2  g34(.a(new_n75_), .b(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n43_), .c(x14), .O(new_n77_));
  nand2  g36(.a(z06), .b(new_n75_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n54_), .O(z13));
  ...
  nand3  g43(.a(new_n50_), .b(x16), .c(new_n42_), .O(new_n85_));
  ...
  nand3  g50(.a(x17), .b(x15), .c(new_n42_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n54_), .O(z16));
  nand2  g52(.a(new_n48_), .b(x18), .O(new_n94_));
  nand3  g53(.a(x10), .b(x08), .c(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(new_n97_));
  nand3  g56(.a(x18), .b(x15), .c(new_n42_), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n54_), .O(z17));
  ...
  nand3  g62(.a(x19), .b(x15), .c(new_n42_), .O(new_n104_));
  ...
  nand3  g68(.a(x20), .b(x15), .c(new_n42_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n54_), .O(z19));
  buf    g70(.a(x14), .O(z11));
endmodule
