...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n57_, new_n59_, new_n63_,
  ...
  nand2  g31(.a(new_n55_), .b(new_n47_), .O(new_n73_));
  ...
  nand3  g39(.a(new_n46_), .b(x12), .c(x10), .O(new_n81_));
  ...
  nand2  g45(.a(new_n55_), .b(x17), .O(new_n87_));
  nand4  g46(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n88_));
  ...
  nand2  g51(.a(new_n55_), .b(x18), .O(new_n93_));
  ...
  nand3  g57(.a(new_n70_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z18));
  nand2  g59(.a(new_n51_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n70_), .b(x08), .c(x07), .O(new_n102_));
