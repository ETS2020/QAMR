...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x09), .c(new_n47_), .O(z01));
  ...
  aoi21  g16(.a(new_n57_), .b(x09), .c(new_n47_), .O(z03));
  ...
  nand2  g25(.a(z10), .b(new_n44_), .O(z09));
  nand2  g26(.a(new_n44_), .b(new_n48_), .O(z11));
  nand2  g27(.a(x13), .b(x12), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x09), .O(new_n70_));
  ...
  nand2  g36(.a(new_n77_), .b(x09), .O(new_n78_));
  ...
  nand3  g49(.a(new_n55_), .b(x16), .c(new_n48_), .O(new_n91_));
  ...
  oai21  g55(.a(new_n62_), .b(new_n96_), .c(x09), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n55_), .b(x17), .O(new_n99_));
  ...
  nand3  g66(.a(x18), .b(x15), .c(x09), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n96_), .O(z17));
  nand2  g68(.a(new_n55_), .b(x19), .O(new_n110_));
  ...
  nand3  g72(.a(x19), .b(x15), .c(x09), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n96_), .O(z18));
  ...
  nand3  g78(.a(x20), .b(x15), .c(x09), .O(new_n120_));
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n96_), .O(z19));
  buf    g80(.a(x15), .O(z06));
endmodule
