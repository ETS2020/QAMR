...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(new_n51_), .c(new_n44_), .O(z03));
  ...
  nand4  g27(.a(new_n68_), .b(x10), .c(x08), .d(x00), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x11), .O(new_n71_));
  nand2  g30(.a(x15), .b(x13), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(z12));
  nand2  g32(.a(new_n51_), .b(new_n46_), .O(new_n74_));
  nand3  g33(.a(x10), .b(x08), .c(x01), .O(new_n75_));
  aoi22  g34(.a(new_n75_), .b(x14), .c(new_n74_), .d(x15), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n66_), .c(new_n44_), .O(z13));
  nand2  g36(.a(new_n51_), .b(x15), .O(new_n78_));
  and2   g37(.a(x08), .b(x02), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n68_), .c(x11), .d(x10), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n66_), .O(z14));
  nand3  g40(.a(new_n51_), .b(x16), .c(new_n46_), .O(new_n82_));
  nand4  g41(.a(new_n68_), .b(x10), .c(x08), .d(x03), .O(new_n83_));
