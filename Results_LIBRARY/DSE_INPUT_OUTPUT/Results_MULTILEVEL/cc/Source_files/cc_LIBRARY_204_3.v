...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n54_, new_n58_, new_n60_, new_n63_, new_n65_, new_n66_,
  ...
  nand2  g16(.a(new_n43_), .b(new_n58_), .O(z08));
  nand3  g17(.a(new_n43_), .b(x09), .c(x08), .O(new_n60_));
  inv1   g18(.a(new_n60_), .O(z09));
  aoi21  g19(.a(x09), .b(x08), .c(new_n54_), .O(z10));
  inv1   g20(.a(x14), .O(new_n63_));
  nor2   g21(.a(new_n54_), .b(new_n63_), .O(z11));
  ...
  nand2  g30(.a(new_n50_), .b(x02), .O(new_n73_));
  aoi21  g31(.a(new_n73_), .b(new_n45_), .c(new_n48_), .O(z14));
  nand3  g32(.a(new_n46_), .b(x16), .c(new_n63_), .O(new_n75_));
  ...
  aoi21  g38(.a(new_n50_), .b(x04), .c(x15), .O(new_n81_));
  aoi21  g39(.a(new_n81_), .b(new_n80_), .c(new_n48_), .O(z16));
  ...
  aoi21  g46(.a(new_n50_), .b(x06), .c(x15), .O(new_n89_));
  aoi21  g47(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(z18));
  nand2  g48(.a(new_n46_), .b(x20), .O(new_n91_));
  nand3  g49(.a(x10), .b(x08), .c(x07), .O(new_n92_));
  nand2  g50(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g51(.a(new_n93_), .b(new_n45_), .c(x12), .O(new_n94_));
