...
module FAU ( 
  ...
  nand2  g19(.a(new_n51_), .b(x02), .O(z06));
  ...
  nand2  g29(.a(new_n70_), .b(x02), .O(new_n71_));
  ...
  nand2  g33(.a(new_n46_), .b(new_n47_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x15), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x14), .c(x02), .O(new_n78_));
  ...
  nand2  g43(.a(new_n84_), .b(x02), .O(new_n85_));
  ...
  nand2  g48(.a(new_n89_), .b(x02), .O(new_n90_));
  ...
  nand2  g53(.a(new_n94_), .b(x02), .O(new_n95_));
  ...
  nand2  g58(.a(new_n99_), .b(x02), .O(new_n100_));
