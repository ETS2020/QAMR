...
module FAU ( 
  ...
  nand2  g29(.a(new_n51_), .b(x08), .O(new_n71_));
  inv1   g30(.a(x08), .O(new_n72_));
  nand2  g31(.a(x13), .b(new_n72_), .O(new_n73_));
  oai21  g32(.a(new_n71_), .b(new_n70_), .c(new_n73_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x10), .O(new_n75_));
  nand2  g34(.a(x15), .b(x13), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n57_), .O(z12));
  aoi21  g36(.a(x14), .b(x12), .c(new_n51_), .O(new_n78_));
  aoi21  g37(.a(new_n58_), .b(new_n46_), .c(new_n51_), .O(new_n79_));
  ...
  nand3  g45(.a(x16), .b(new_n46_), .c(new_n72_), .O(new_n87_));
  ...
  nand2  g51(.a(x17), .b(new_n72_), .O(new_n93_));
  oai21  g52(.a(new_n71_), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  ...
  nand2  g57(.a(x18), .b(new_n72_), .O(new_n99_));
  oai21  g58(.a(new_n71_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g65(.a(new_n71_), .b(x19), .c(x12), .O(new_n107_));
  ...
  nand3  g70(.a(new_n71_), .b(x20), .c(x12), .O(new_n112_));
