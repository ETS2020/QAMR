...
module FAU ( 
  ...
  nand4  g11(.a(new_n52_), .b(new_n45_), .c(x12), .d(new_n50_), .O(new_n53_));
  inv1   g12(.a(new_n53_), .O(z02));
  inv1   g13(.a(new_n42_), .O(z03));
  nand2  g14(.a(new_n42_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  oai21  g16(.a(new_n45_), .b(new_n46_), .c(new_n57_), .O(z05));
  nor2   g17(.a(new_n45_), .b(x12), .O(z06));
  ...
  and2   g27(.a(new_n68_), .b(new_n45_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n46_), .O(z12));
  inv1   g29(.a(x01), .O(new_n71_));
  oai21  g30(.a(new_n51_), .b(new_n71_), .c(x14), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n45_), .c(new_n46_), .O(z13));
