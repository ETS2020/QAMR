...
module FAU ( 
  ...
  nand2  g19(.a(new_n51_), .b(x06), .O(z06));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n74_), .O(z17));
  nand2  g60(.a(new_n52_), .b(new_n59_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x06), .O(new_n103_));
  nand2  g62(.a(x19), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n74_), .O(z18));
