...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n53_, new_n56_, new_n58_, new_n60_, new_n61_, new_n63_,
  ...
  nand2  g17(.a(new_n43_), .b(new_n58_), .O(z06));
  ...
  oai21  g24(.a(x15), .b(new_n58_), .c(x09), .O(new_n66_));
  ...
  nor3   g31(.a(new_n72_), .b(new_n43_), .c(new_n58_), .O(z13));
