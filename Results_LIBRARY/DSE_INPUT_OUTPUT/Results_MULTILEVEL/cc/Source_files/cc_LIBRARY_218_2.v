...
module FAU ( 
  ...
  aoi21  g07(.a(new_n43_), .b(x18), .c(new_n48_), .O(z06));
  ...
  nand4  g14(.a(z06), .b(new_n47_), .c(x12), .d(x10), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n46_), .O(z03));
  nand2  g16(.a(x20), .b(x18), .O(z04));
  ...
  nand4  g27(.a(new_n48_), .b(x10), .c(x08), .d(x00), .O(new_n69_));
  ...
  aoi22  g52(.a(new_n93_), .b(new_n92_), .c(new_n52_), .d(x17), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n90_), .c(new_n44_), .O(z16));
  and2   g54(.a(x08), .b(x05), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n92_), .c(new_n52_), .d(x18), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n90_), .c(new_n44_), .O(z17));
  and2   g57(.a(x08), .b(x06), .O(new_n99_));
  aoi22  g58(.a(new_n99_), .b(new_n92_), .c(new_n52_), .d(x19), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n90_), .c(new_n44_), .O(z18));
  inv1   g60(.a(x18), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n48_), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(new_n74_), .c(new_n43_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x07), .O(new_n105_));
  nand2  g64(.a(new_n52_), .b(x20), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n90_), .O(z19));
endmodule
