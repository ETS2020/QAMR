...
module FAU ( 
  ...
  nand2  g17(.a(new_n43_), .b(new_n54_), .O(z06));
  ...
  aoi21  g35(.a(new_n60_), .b(x15), .c(new_n54_), .O(z16));
  inv1   g36(.a(x18), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x15), .c(new_n54_), .O(z17));
