...
module FAU ( 
  ...
  oai21  g37(.a(new_n46_), .b(x10), .c(new_n58_), .O(new_n79_));
  ...
  nand2  g52(.a(x17), .b(new_n67_), .O(new_n94_));
  oai21  g53(.a(new_n73_), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g58(.a(x12), .b(x08), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n99_), .c(x10), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n51_), .O(new_n102_));
  nand3  g61(.a(new_n73_), .b(x18), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(z17));
  inv1   g63(.a(x06), .O(new_n105_));
  oai21  g64(.a(new_n100_), .b(new_n105_), .c(x10), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n51_), .O(new_n107_));
  nand3  g66(.a(new_n73_), .b(x19), .c(x12), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(z18));
  inv1   g68(.a(x07), .O(new_n110_));
  oai21  g69(.a(new_n100_), .b(new_n110_), .c(x10), .O(new_n111_));
