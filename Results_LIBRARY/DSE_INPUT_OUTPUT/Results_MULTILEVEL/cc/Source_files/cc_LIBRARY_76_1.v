...
module FAU ( 
  ...
  aoi21  g19(.a(x15), .b(new_n59_), .c(new_n60_), .O(z05));
  nor2   g20(.a(new_n43_), .b(new_n59_), .O(z06));
  ...
  oai21  g42(.a(new_n82_), .b(new_n52_), .c(new_n83_), .O(new_n84_));
  ...
  oai21  g53(.a(new_n63_), .b(new_n71_), .c(x02), .O(new_n95_));
  ...
  nand3  g72(.a(x19), .b(x15), .c(x02), .O(new_n114_));
