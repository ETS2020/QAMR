...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x00), .O(new_n43_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n86_), .c(new_n71_), .O(z15));
  and2   g49(.a(x08), .b(x04), .O(new_n91_));
  aoi22  g50(.a(new_n91_), .b(new_n88_), .c(new_n52_), .d(x17), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n71_), .c(new_n44_), .O(z16));
  and2   g52(.a(x08), .b(x05), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n88_), .c(new_n52_), .d(x18), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n71_), .c(new_n44_), .O(z17));
  and2   g55(.a(x08), .b(x06), .O(new_n97_));
  aoi22  g56(.a(new_n97_), .b(new_n88_), .c(new_n52_), .d(x19), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n71_), .c(new_n44_), .O(z18));
  and2   g58(.a(x08), .b(x07), .O(new_n100_));
  aoi22  g59(.a(new_n100_), .b(new_n88_), .c(new_n52_), .d(x20), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n71_), .c(new_n44_), .O(z19));
endmodule
