...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x19), .c(new_n43_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(x19), .b(new_n43_), .c(x14), .O(new_n51_));
  ...
  nand2  g49(.a(new_n73_), .b(new_n43_), .O(new_n91_));
  ...
  inv1   g68(.a(x19), .O(new_n110_));
  aoi21  g69(.a(new_n73_), .b(new_n110_), .c(new_n109_), .O(new_n111_));
  ...
  nand2  g73(.a(new_n114_), .b(new_n45_), .O(z18));
  ...
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n90_), .O(z19));
  buf    g80(.a(x19), .O(z05));
  buf    g81(.a(x15), .O(z06));
endmodule
