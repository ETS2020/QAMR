...
module FAU ( 
  ...
  nand3  g13(.a(new_n54_), .b(new_n53_), .c(x12), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(x20), .c(new_n45_), .O(z03));
  nand2  g15(.a(new_n43_), .b(x15), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  aoi21  g19(.a(new_n43_), .b(x15), .c(new_n60_), .O(z05));
  nor2   g20(.a(new_n43_), .b(new_n45_), .O(z06));
  ...
  nand3  g57(.a(x20), .b(x17), .c(x15), .O(new_n99_));
  ...
  oai21  g67(.a(new_n60_), .b(new_n71_), .c(x20), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n46_), .b(x19), .O(new_n111_));
  nand4  g70(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n112_));
