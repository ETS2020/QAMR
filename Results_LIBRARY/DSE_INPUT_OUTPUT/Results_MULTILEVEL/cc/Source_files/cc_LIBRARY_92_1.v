...
module FAU ( 
  ...
  nand3  g06(.a(x10), .b(x08), .c(x01), .O(new_n48_));
  nor3   g07(.a(new_n48_), .b(new_n47_), .c(x14), .O(z01));
  oai21  g08(.a(new_n47_), .b(x01), .c(x14), .O(new_n50_));
  ...
  aoi21  g15(.a(new_n56_), .b(x01), .c(new_n47_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  oai21  g18(.a(new_n47_), .b(x01), .c(new_n59_), .O(z05));
  nor2   g19(.a(new_n47_), .b(new_n43_), .O(z06));
  ...
  aoi21  g34(.a(x14), .b(x12), .c(x15), .O(new_n76_));
  ...
  oai21  g40(.a(new_n76_), .b(x01), .c(new_n81_), .O(z13));
  nand3  g41(.a(new_n77_), .b(x15), .c(x01), .O(new_n83_));
  nand3  g42(.a(new_n73_), .b(x08), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n69_), .O(z14));
  nand3  g44(.a(x16), .b(new_n55_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x01), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand3  g47(.a(new_n77_), .b(x16), .c(new_n55_), .O(new_n89_));
  ...
  nand3  g56(.a(x17), .b(x15), .c(x01), .O(new_n98_));
  ...
  nand2  g61(.a(new_n77_), .b(x18), .O(new_n103_));
  nand4  g62(.a(new_n47_), .b(x10), .c(x08), .d(x05), .O(new_n104_));
  ...
  oai21  g66(.a(new_n59_), .b(new_n69_), .c(x01), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n77_), .b(x19), .O(new_n110_));
  nand4  g69(.a(new_n47_), .b(x10), .c(x08), .d(x06), .O(new_n111_));
  ...
  nand2  g73(.a(new_n77_), .b(x20), .O(new_n115_));
  nand3  g74(.a(x10), .b(x08), .c(x07), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand3  g77(.a(x20), .b(x15), .c(x01), .O(new_n119_));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n69_), .O(z19));
endmodule
