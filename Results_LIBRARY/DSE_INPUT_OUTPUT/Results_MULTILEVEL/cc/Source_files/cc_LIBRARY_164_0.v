...
module FAU ( 
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n72_), .O(z17));
  nand2  g56(.a(new_n53_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n75_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n72_), .O(z18));
  nand2  g59(.a(new_n53_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n75_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n72_), .O(z19));
endmodule
