...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n57_, new_n58_, new_n60_, new_n63_,
  ...
  oai21  g32(.a(new_n45_), .b(new_n73_), .c(x14), .O(new_n74_));
  ...
  nand4  g38(.a(new_n49_), .b(x10), .c(x08), .d(x02), .O(new_n80_));
  ...
  nand2  g47(.a(new_n57_), .b(new_n49_), .O(new_n89_));
  nand2  g48(.a(new_n60_), .b(x17), .O(new_n90_));
  oai21  g49(.a(new_n89_), .b(new_n45_), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x04), .O(new_n92_));
  nand3  g51(.a(new_n50_), .b(new_n60_), .c(x17), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n67_), .O(z16));
  and2   g53(.a(x08), .b(x05), .O(new_n95_));
  aoi22  g54(.a(new_n95_), .b(new_n69_), .c(new_n50_), .d(x18), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n67_), .c(new_n42_), .O(z17));
  nand2  g56(.a(new_n60_), .b(new_n49_), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n45_), .c(new_n58_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g59(.a(new_n50_), .b(x19), .c(new_n57_), .O(new_n101_));
  ...
  nand3  g64(.a(new_n105_), .b(new_n42_), .c(x12), .O(new_n106_));
