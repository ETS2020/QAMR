...
module FAU ( 
  ...
  oai21  g20(.a(new_n45_), .b(new_n46_), .c(new_n61_), .O(z05));
  nand2  g21(.a(x15), .b(new_n46_), .O(new_n63_));
  ...
  nand2  g46(.a(new_n56_), .b(new_n45_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n63_), .O(new_n89_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(new_n46_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n87_), .O(z16));
  ...
  nand3  g61(.a(x18), .b(x15), .c(new_n46_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n87_), .O(z17));
  nand2  g63(.a(new_n56_), .b(x19), .O(new_n105_));
  ...
  nand3  g67(.a(x19), .b(x15), .c(new_n46_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n87_), .O(z18));
  ...
  nand4  g73(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n115_));
