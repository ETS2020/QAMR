...
module FAU ( 
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n76_), .O(z14));
  ...
  nand4  g45(.a(new_n73_), .b(x16), .c(new_n48_), .d(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(z15));
  aoi21  g47(.a(x10), .b(x08), .c(x19), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(x15), .c(x17), .O(new_n90_));
  nand4  g49(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n76_), .O(z16));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n61_), .c(new_n76_), .O(z18));
