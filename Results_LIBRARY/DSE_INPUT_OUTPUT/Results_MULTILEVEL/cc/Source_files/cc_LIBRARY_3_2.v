...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n57_, new_n60_, new_n61_, new_n63_,
  ...
  nand2  g17(.a(new_n43_), .b(new_n53_), .O(z06));
  inv1   g18(.a(x17), .O(new_n60_));
  nor2   g19(.a(x15), .b(new_n53_), .O(new_n61_));
  ...
  aoi21  g35(.a(new_n60_), .b(x15), .c(new_n53_), .O(z16));
