...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x05), .c(new_n47_), .O(z01));
  ...
  nand2  g39(.a(new_n80_), .b(x05), .O(new_n81_));
  ...
  nand3  g49(.a(new_n74_), .b(x16), .c(new_n48_), .O(new_n91_));
  nand3  g50(.a(new_n77_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n71_), .O(z15));
  oai21  g52(.a(new_n62_), .b(new_n71_), .c(x05), .O(new_n94_));
  ...
  nand3  g62(.a(new_n72_), .b(x18), .c(new_n47_), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n71_), .O(z17));
  oai21  g64(.a(new_n58_), .b(new_n71_), .c(x05), .O(new_n106_));
