...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_, new_n51_,
    new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n61_, new_n62_,
  ...
  nor2   g04(.a(x12), .b(x11), .O(new_n46_));
  nor2   g05(.a(new_n46_), .b(new_n45_), .O(z06));
  nand3  g06(.a(z06), .b(new_n44_), .c(x10), .O(new_n48_));
  ...
  nor4   g15(.a(new_n56_), .b(new_n45_), .c(x14), .d(new_n55_), .O(z03));
  nor2   g16(.a(new_n46_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n46_), .b(new_n59_), .O(z05));
  inv1   g19(.a(x17), .O(new_n61_));
  inv1   g20(.a(new_n46_), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n61_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nand2  g23(.a(new_n62_), .b(new_n64_), .O(z08));
  inv1   g24(.a(x09), .O(new_n66_));
  nor3   g25(.a(new_n46_), .b(new_n66_), .c(new_n43_), .O(z09));
  aoi21  g26(.a(x09), .b(x08), .c(new_n46_), .O(z10));
  nor2   g27(.a(new_n46_), .b(new_n44_), .O(z11));
  ...
  nand2  g41(.a(new_n82_), .b(new_n62_), .O(z14));
  nand3  g42(.a(new_n51_), .b(x16), .c(new_n44_), .O(new_n84_));
  nand4  g43(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n62_), .O(z15));
