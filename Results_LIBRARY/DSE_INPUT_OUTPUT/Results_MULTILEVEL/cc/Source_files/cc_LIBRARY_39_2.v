...
module FAU ( 
  ...
  nand3  g53(.a(new_n54_), .b(x17), .c(x12), .O(new_n95_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  nand3  g58(.a(new_n54_), .b(x18), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(z17));
  aoi21  g60(.a(new_n49_), .b(new_n44_), .c(x15), .O(new_n102_));
  nor3   g61(.a(new_n102_), .b(new_n61_), .c(new_n77_), .O(z18));
