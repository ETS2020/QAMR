...
module FAU ( 
  ...
  nand3  g05(.a(x10), .b(x08), .c(x04), .O(new_n47_));
  ...
  aoi21  g15(.a(new_n56_), .b(x04), .c(new_n43_), .O(z03));
  ...
  nand2  g46(.a(new_n87_), .b(x04), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x15), .O(new_n89_));
  nand3  g48(.a(new_n54_), .b(x16), .c(new_n49_), .O(new_n90_));
  nand3  g49(.a(new_n74_), .b(x08), .c(x03), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n89_), .O(z15));
  aoi21  g53(.a(new_n50_), .b(new_n61_), .c(new_n71_), .O(new_n95_));
  and2   g54(.a(new_n50_), .b(x17), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z16));
  aoi21  g57(.a(x18), .b(x12), .c(new_n71_), .O(new_n99_));
  and2   g58(.a(x08), .b(x05), .O(new_n100_));
  aoi22  g59(.a(new_n100_), .b(new_n74_), .c(new_n54_), .d(x18), .O(new_n101_));
  oai22  g60(.a(new_n101_), .b(new_n70_), .c(new_n99_), .d(new_n43_), .O(z17));
  aoi21  g61(.a(x19), .b(x12), .c(new_n71_), .O(new_n103_));
  and2   g62(.a(x08), .b(x06), .O(new_n104_));
  aoi22  g63(.a(new_n104_), .b(new_n74_), .c(new_n54_), .d(x19), .O(new_n105_));
  oai22  g64(.a(new_n105_), .b(new_n70_), .c(new_n103_), .d(new_n43_), .O(z18));
  aoi21  g65(.a(x20), .b(x12), .c(new_n71_), .O(new_n107_));
  and2   g66(.a(x08), .b(x07), .O(new_n108_));
  aoi22  g67(.a(new_n108_), .b(new_n74_), .c(new_n54_), .d(x20), .O(new_n109_));
  oai22  g68(.a(new_n109_), .b(new_n70_), .c(new_n107_), .d(new_n43_), .O(z19));
  buf    g69(.a(x15), .O(z06));
endmodule
