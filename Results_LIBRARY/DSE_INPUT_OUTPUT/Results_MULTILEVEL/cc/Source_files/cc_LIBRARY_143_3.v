...
module FAU ( 
  ...
  nand3  g55(.a(x17), .b(x15), .c(new_n47_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n68_), .O(z16));
  oai21  g57(.a(new_n77_), .b(x15), .c(x05), .O(new_n99_));
  ...
  nand3  g64(.a(x19), .b(x15), .c(new_n47_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n68_), .O(z18));
  oai21  g66(.a(new_n43_), .b(new_n68_), .c(new_n47_), .O(new_n108_));
