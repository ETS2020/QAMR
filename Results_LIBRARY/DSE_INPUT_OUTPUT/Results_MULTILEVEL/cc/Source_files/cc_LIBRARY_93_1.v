...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n58_, new_n62_, new_n63_,
  ...
  nand2  g30(.a(new_n55_), .b(new_n47_), .O(new_n72_));
  ...
  nand3  g38(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n80_));
  ...
  nand3  g42(.a(new_n69_), .b(x08), .c(x04), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n43_), .O(z16));
  nand2  g44(.a(new_n51_), .b(x18), .O(new_n86_));
  nand3  g45(.a(new_n69_), .b(x08), .c(x05), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n43_), .O(z17));
  nand2  g47(.a(new_n51_), .b(x19), .O(new_n89_));
  nand3  g48(.a(new_n69_), .b(x08), .c(x06), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z18));
  nand2  g50(.a(new_n51_), .b(x20), .O(new_n92_));
  nand3  g51(.a(new_n69_), .b(x08), .c(x07), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z19));
  buf    g53(.a(x15), .O(z06));
endmodule
