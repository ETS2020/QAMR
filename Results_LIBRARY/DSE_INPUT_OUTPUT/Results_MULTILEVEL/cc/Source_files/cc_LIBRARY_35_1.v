...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n57_, new_n62_, new_n63_,
  ...
  oai21  g44(.a(x18), .b(new_n43_), .c(x15), .O(new_n86_));
  nand2  g45(.a(new_n55_), .b(x18), .O(new_n87_));
  nand4  g46(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n88_));
  ...
  nand4  g52(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n94_));
