...
module FAU ( 
  ...
  nand2  g34(.a(new_n49_), .b(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x14), .c(new_n43_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n57_), .O(z13));
  nand2  g37(.a(new_n48_), .b(x15), .O(new_n79_));
  inv1   g38(.a(new_n53_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n43_), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n57_), .O(z14));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n57_), .O(z15));
