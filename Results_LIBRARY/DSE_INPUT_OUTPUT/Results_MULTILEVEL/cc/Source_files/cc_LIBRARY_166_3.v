...
module FAU ( 
  ...
  oai21  g19(.a(new_n45_), .b(new_n42_), .c(new_n60_), .O(z05));
  nor2   g20(.a(x20), .b(new_n42_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n51_), .b(new_n63_), .O(z07));
  and2   g23(.a(new_n51_), .b(x16), .O(z08));
  ...
  nand3  g39(.a(new_n80_), .b(new_n45_), .c(x15), .O(new_n81_));
  ...
  nand3  g43(.a(new_n73_), .b(new_n45_), .c(x15), .O(new_n85_));
  ...
  oai21  g54(.a(new_n63_), .b(new_n79_), .c(new_n45_), .O(new_n96_));
  ...
  nand3  g73(.a(new_n45_), .b(x19), .c(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(z18));
  inv1   g75(.a(x07), .O(new_n117_));
  aoi21  g76(.a(new_n73_), .b(new_n45_), .c(new_n117_), .O(new_n118_));
  aoi21  g77(.a(x10), .b(x08), .c(new_n45_), .O(new_n119_));
  oai21  g78(.a(new_n119_), .b(new_n118_), .c(new_n42_), .O(new_n120_));
  nor2   g79(.a(new_n120_), .b(new_n79_), .O(z19));
endmodule
