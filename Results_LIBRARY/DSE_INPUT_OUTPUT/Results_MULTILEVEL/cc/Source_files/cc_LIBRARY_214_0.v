...
module FAU ( 
  ...
  nand2  g28(.a(new_n56_), .b(new_n47_), .O(z11));
  ...
  oai21  g34(.a(new_n75_), .b(new_n71_), .c(new_n56_), .O(z12));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n71_), .O(z14));
  ...
  nand2  g46(.a(new_n87_), .b(new_n56_), .O(z15));
  ...
  aoi22  g54(.a(new_n95_), .b(new_n73_), .c(new_n52_), .d(x19), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n71_), .c(new_n56_), .O(z18));
  and2   g56(.a(x08), .b(x07), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n73_), .c(new_n52_), .d(x20), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n71_), .c(new_n56_), .O(z19));
endmodule
