...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n60_, new_n61_, new_n63_,
  ...
  aoi21  g24(.a(x09), .b(x08), .c(new_n61_), .O(z10));
  ...
  oai21  g43(.a(new_n60_), .b(x14), .c(x12), .O(new_n85_));
  ...
  nand3  g57(.a(new_n82_), .b(x08), .c(x05), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z17));
  nand2  g59(.a(new_n51_), .b(x19), .O(new_n101_));
  nand3  g60(.a(new_n82_), .b(x08), .c(x06), .O(new_n102_));
