...
module FAU ( 
  ...
  aoi21  g18(.a(x16), .b(x15), .c(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  aoi21  g20(.a(x16), .b(x15), .c(new_n61_), .O(z05));
  nor2   g21(.a(x16), .b(new_n45_), .O(z06));
  ...
  nand3  g55(.a(x17), .b(new_n46_), .c(x15), .O(new_n97_));
  ...
  nand3  g61(.a(x18), .b(new_n46_), .c(x15), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n84_), .O(z17));
  ...
  nand3  g67(.a(x19), .b(new_n46_), .c(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n84_), .O(z18));
