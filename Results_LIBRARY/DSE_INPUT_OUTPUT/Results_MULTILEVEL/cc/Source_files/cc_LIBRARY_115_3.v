...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n60_, new_n66_,
  ...
  oai21  g21(.a(x15), .b(x08), .c(x09), .O(z10));
  inv1   g22(.a(z10), .O(z09));
  aoi21  g23(.a(x15), .b(x09), .c(new_n47_), .O(z11));
  ...
  nand2  g34(.a(new_n69_), .b(new_n47_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x15), .c(new_n45_), .O(new_n77_));
  ...
  nand3  g39(.a(new_n69_), .b(x15), .c(new_n45_), .O(new_n81_));
  inv1   g40(.a(new_n52_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n75_), .O(z14));
  nand2  g43(.a(new_n69_), .b(new_n46_), .O(new_n85_));
  nand2  g44(.a(x15), .b(new_n45_), .O(new_n86_));
  ...
  nand3  g53(.a(x17), .b(x15), .c(new_n45_), .O(new_n95_));
  ...
  nand2  g58(.a(new_n69_), .b(x18), .O(new_n100_));
  ...
  nand2  g63(.a(new_n69_), .b(x19), .O(new_n105_));
  ...
  nand3  g67(.a(x19), .b(x15), .c(new_n45_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n75_), .O(z18));
  ...
  nand3  g73(.a(x20), .b(x15), .c(new_n45_), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n75_), .O(z19));
  buf    g75(.a(x15), .O(z06));
endmodule
