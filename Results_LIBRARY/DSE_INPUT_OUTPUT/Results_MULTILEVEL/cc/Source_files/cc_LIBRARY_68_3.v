...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(new_n53_), .c(new_n42_), .O(z03));
  nor2   g18(.a(new_n54_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  aoi21  g20(.a(x20), .b(x15), .c(new_n61_), .O(z05));
  nand2  g21(.a(new_n53_), .b(x15), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n55_), .b(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n55_), .b(new_n67_), .O(z08));
  nand2  g27(.a(x09), .b(x08), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n55_), .O(z09));
  inv1   g29(.a(z09), .O(z10));
  nor2   g30(.a(new_n54_), .b(new_n49_), .O(z11));
  inv1   g31(.a(x12), .O(new_n73_));
  nand2  g32(.a(new_n45_), .b(new_n42_), .O(new_n74_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n53_), .O(new_n81_));
  ...
  nand3  g44(.a(new_n45_), .b(new_n53_), .c(x15), .O(new_n86_));
  ...
  nand2  g50(.a(new_n45_), .b(x17), .O(new_n92_));
  ...
  nand3  g54(.a(new_n53_), .b(x17), .c(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n73_), .O(z16));
  nand2  g56(.a(new_n45_), .b(x18), .O(new_n98_));
  nand3  g57(.a(x10), .b(x08), .c(x05), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n42_), .O(new_n101_));
  nand3  g60(.a(new_n53_), .b(x18), .c(x15), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n73_), .O(z17));
  oai21  g62(.a(new_n61_), .b(new_n73_), .c(new_n53_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x15), .O(new_n105_));
  nand2  g64(.a(new_n45_), .b(x19), .O(new_n106_));
  ...
  aoi21  g70(.a(new_n45_), .b(new_n53_), .c(new_n111_), .O(new_n112_));
  aoi21  g71(.a(x10), .b(x08), .c(new_n53_), .O(new_n113_));
  oai21  g72(.a(new_n113_), .b(new_n112_), .c(new_n42_), .O(new_n114_));
  nor2   g73(.a(new_n114_), .b(new_n73_), .O(z19));
endmodule
