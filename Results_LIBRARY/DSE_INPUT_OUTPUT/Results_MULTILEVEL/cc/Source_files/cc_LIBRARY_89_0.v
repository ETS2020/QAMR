...
module FAU ( 
  ...
  nand2  g28(.a(new_n69_), .b(x03), .O(new_n70_));
  ...
  nand3  g38(.a(new_n79_), .b(x03), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n56_), .O(z14));
  ...
  nand2  g51(.a(new_n92_), .b(x03), .O(new_n93_));
  ...
  nand2  g58(.a(new_n99_), .b(x03), .O(new_n100_));
