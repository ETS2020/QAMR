...
module FAU ( 
  ...
  nand2  g31(.a(new_n47_), .b(new_n50_), .O(new_n73_));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n78_), .c(new_n43_), .O(z14));
  oai21  g41(.a(new_n61_), .b(x14), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand3  g43(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n85_));
  nand4  g44(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  ...
  nand3  g67(.a(new_n80_), .b(x08), .c(x07), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n43_), .O(z19));
  nor4   g69(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
