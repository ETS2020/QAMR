...
module FAU ( 
  ...
  nor2   g20(.a(x15), .b(x13), .O(new_n62_));
  ...
  nand4  g31(.a(new_n62_), .b(x10), .c(x08), .d(x00), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(z12));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(new_n75_));
  ...
  nand4  g44(.a(new_n53_), .b(x16), .c(new_n47_), .d(x12), .O(new_n86_));
