...
module FAU ( 
  ...
  oai21  g24(.a(new_n51_), .b(x08), .c(x09), .O(z10));
  ...
  nand4  g40(.a(new_n81_), .b(new_n51_), .c(x10), .d(new_n43_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n74_), .O(z14));
  ...
  nand4  g60(.a(new_n51_), .b(x10), .c(x08), .d(x06), .O(new_n102_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n74_), .O(z18));
  ...
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n74_), .O(z19));
endmodule
