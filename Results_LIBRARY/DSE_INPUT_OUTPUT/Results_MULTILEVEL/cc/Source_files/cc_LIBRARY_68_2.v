...
module FAU ( 
  ...
  nand2  g19(.a(x20), .b(x15), .O(new_n61_));
  ...
  nor2   g28(.a(new_n52_), .b(new_n48_), .O(z11));
  ...
  nand3  g43(.a(new_n46_), .b(x20), .c(x15), .O(new_n85_));
  ...
  nand3  g59(.a(x20), .b(x18), .c(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(z17));
  oai21  g61(.a(new_n59_), .b(new_n71_), .c(x20), .O(new_n103_));
  ...
  nand2  g68(.a(new_n49_), .b(new_n43_), .O(new_n110_));
