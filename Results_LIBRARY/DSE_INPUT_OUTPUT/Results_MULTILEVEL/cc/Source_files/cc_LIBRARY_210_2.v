...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(new_n44_), .O(z05));
  ...
  nand2  g34(.a(new_n55_), .b(x13), .O(new_n76_));
  ...
  nand2  g51(.a(new_n55_), .b(new_n44_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n64_), .b(new_n87_), .c(x19), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n55_), .b(x17), .O(new_n100_));
  ...
  nand2  g66(.a(new_n55_), .b(x18), .O(new_n108_));
  ...
  nand2  g71(.a(new_n51_), .b(new_n60_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x06), .O(new_n114_));
  nand2  g73(.a(new_n51_), .b(x19), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n87_), .O(z18));
  oai21  g75(.a(new_n43_), .b(new_n87_), .c(x19), .O(new_n117_));
