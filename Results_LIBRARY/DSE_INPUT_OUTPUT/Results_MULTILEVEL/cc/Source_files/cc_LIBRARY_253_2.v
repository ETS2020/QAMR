...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(new_n47_), .c(x09), .O(new_n54_));
  ...
  oai21  g26(.a(new_n52_), .b(x08), .c(x09), .O(z10));
  ...
  oai22  g52(.a(new_n93_), .b(new_n72_), .c(new_n49_), .d(new_n64_), .O(new_n94_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n72_), .c(new_n108_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n43_), .O(new_n111_));
  nand2  g70(.a(x20), .b(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n71_), .O(z19));
endmodule
