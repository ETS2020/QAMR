...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n53_, new_n54_, new_n56_, new_n59_, new_n61_, new_n63_,
  ...
  nand2  g10(.a(x17), .b(new_n51_), .O(z06));
  oai22  g11(.a(z06), .b(new_n47_), .c(new_n44_), .d(new_n48_), .O(new_n53_));
  ...
  nand3  g29(.a(x17), .b(new_n51_), .c(x10), .O(new_n71_));
  ...
  nand3  g36(.a(new_n77_), .b(x17), .c(x14), .O(new_n78_));
  ...
  nand3  g41(.a(new_n69_), .b(x16), .c(new_n48_), .O(new_n83_));
  ...
  nand3  g46(.a(new_n87_), .b(x17), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n46_), .O(z16));
  nand2  g48(.a(new_n47_), .b(x18), .O(new_n90_));
  nand4  g49(.a(new_n51_), .b(x10), .c(x08), .d(x05), .O(new_n91_));
  ...
  nand2  g60(.a(new_n47_), .b(x20), .O(new_n102_));
