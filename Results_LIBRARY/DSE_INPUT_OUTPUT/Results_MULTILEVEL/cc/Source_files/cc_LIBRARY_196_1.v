...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x03), .c(new_n43_), .O(z03));
  ...
  nor2   g28(.a(new_n44_), .b(new_n51_), .O(z11));
  ...
  nand2  g38(.a(new_n79_), .b(x03), .O(new_n80_));
  ...
  nand3  g44(.a(new_n56_), .b(x15), .c(x03), .O(new_n86_));
  nand4  g45(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
  ...
  nand3  g50(.a(new_n56_), .b(x16), .c(new_n51_), .O(new_n92_));
  ...
  nand3  g59(.a(x17), .b(x15), .c(x03), .O(new_n101_));
  ...
  nand2  g64(.a(new_n56_), .b(x18), .O(new_n106_));
  ...
  oai21  g69(.a(new_n61_), .b(new_n85_), .c(x03), .O(new_n111_));
  ...
  nand3  g80(.a(x20), .b(x15), .c(x03), .O(new_n122_));
  aoi21  g81(.a(new_n122_), .b(new_n121_), .c(new_n85_), .O(z19));
  buf    g82(.a(x15), .O(z06));
endmodule
