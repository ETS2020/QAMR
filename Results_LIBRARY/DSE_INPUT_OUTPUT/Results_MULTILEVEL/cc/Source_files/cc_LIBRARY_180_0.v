...
module FAU ( 
  ...
  nand2  g11(.a(x18), .b(new_n52_), .O(new_n53_));
  ...
  nand3  g32(.a(x18), .b(new_n52_), .c(x10), .O(new_n74_));
  ...
  oai21  g36(.a(new_n48_), .b(x14), .c(x15), .O(new_n78_));
  nand2  g37(.a(new_n48_), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x18), .c(x14), .O(new_n80_));
  ...
  nand3  g44(.a(new_n72_), .b(x16), .c(new_n46_), .O(new_n86_));
  nand3  g45(.a(new_n75_), .b(x08), .c(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n70_), .O(z15));
  ...
  nand3  g56(.a(new_n93_), .b(x08), .c(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(x18), .c(x12), .O(new_n99_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n70_), .O(z18));
