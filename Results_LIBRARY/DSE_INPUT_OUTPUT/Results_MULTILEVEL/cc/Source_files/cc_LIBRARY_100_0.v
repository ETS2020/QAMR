...
module FAU ( 
  ...
  nand3  g32(.a(new_n70_), .b(x10), .c(x08), .O(new_n74_));
  ...
  nand4  g41(.a(new_n59_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n77_), .O(z14));
  nand3  g43(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n85_));
  nand4  g44(.a(new_n70_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n77_), .O(z15));
  ...
  nand3  g63(.a(new_n74_), .b(x19), .c(x12), .O(new_n105_));
  ...
  nand2  g67(.a(new_n108_), .b(new_n70_), .O(new_n109_));
