...
module FAU ( 
  ...
  oai22  g40(.a(new_n81_), .b(new_n57_), .c(new_n79_), .d(x10), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  inv1   g42(.a(x08), .O(new_n84_));
  nand2  g43(.a(x15), .b(new_n84_), .O(new_n85_));
  oai21  g44(.a(new_n76_), .b(new_n83_), .c(new_n85_), .O(new_n86_));
  ...
  nand4  g51(.a(new_n76_), .b(x16), .c(new_n48_), .d(x10), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n57_), .O(z15));
  inv1   g53(.a(x04), .O(new_n95_));
  oai22  g54(.a(new_n58_), .b(new_n95_), .c(new_n64_), .d(x10), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(new_n97_));
  nand3  g56(.a(new_n76_), .b(x17), .c(x10), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n57_), .O(z16));
  inv1   g58(.a(x05), .O(new_n100_));
  inv1   g59(.a(x18), .O(new_n101_));
  oai22  g60(.a(new_n58_), .b(new_n100_), .c(new_n101_), .d(x10), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n44_), .O(new_n103_));
  nand3  g62(.a(new_n76_), .b(x18), .c(x10), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n57_), .O(z17));
  oai21  g64(.a(new_n61_), .b(new_n57_), .c(new_n44_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n51_), .O(new_n107_));
  nor2   g66(.a(x15), .b(new_n84_), .O(new_n108_));
  nand4  g67(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n109_));
  oai21  g68(.a(new_n108_), .b(new_n61_), .c(new_n109_), .O(new_n110_));
  ...
  oai21  g74(.a(new_n108_), .b(new_n43_), .c(new_n115_), .O(new_n116_));
