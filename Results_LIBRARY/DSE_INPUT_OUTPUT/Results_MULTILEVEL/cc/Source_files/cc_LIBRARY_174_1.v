...
module FAU ( 
  ...
  nor2   g23(.a(new_n57_), .b(new_n64_), .O(z08));
  inv1   g24(.a(x08), .O(new_n66_));
  nand2  g25(.a(new_n44_), .b(x09), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n66_), .O(z09));
  aoi21  g27(.a(x09), .b(x08), .c(new_n57_), .O(z10));
  nor2   g28(.a(new_n57_), .b(new_n50_), .O(z11));
  ...
  oai21  g44(.a(new_n64_), .b(x14), .c(x12), .O(new_n86_));
  ...
  nand3  g55(.a(new_n73_), .b(x08), .c(x05), .O(new_n97_));
  ...
  nand3  g61(.a(new_n73_), .b(x08), .c(x07), .O(new_n103_));
