...
module FAU ( 
  ...
  oai21  g21(.a(new_n45_), .b(new_n46_), .c(new_n62_), .O(z05));
  nor2   g22(.a(new_n45_), .b(x01), .O(z06));
  ...
  nand3  g42(.a(new_n57_), .b(x15), .c(new_n46_), .O(new_n84_));
  ...
  nand3  g57(.a(x17), .b(x15), .c(new_n46_), .O(new_n99_));
  ...
  oai21  g67(.a(new_n62_), .b(new_n72_), .c(new_n46_), .O(new_n109_));
