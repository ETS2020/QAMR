...
module FAU ( 
  ...
  aoi21  g27(.a(x15), .b(new_n43_), .c(new_n47_), .O(z11));
  ...
  nand3  g42(.a(new_n46_), .b(x12), .c(x10), .O(new_n84_));
  ...
  nand3  g56(.a(new_n88_), .b(x08), .c(x05), .O(new_n98_));
  ...
  nand2  g64(.a(new_n51_), .b(x20), .O(new_n106_));
  nand3  g65(.a(new_n88_), .b(x08), .c(x07), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n43_), .O(z19));
endmodule
