...
module FAU ( 
  ...
  nor4   g16(.a(new_n47_), .b(new_n43_), .c(x14), .d(new_n57_), .O(z03));
  ...
  nor2   g45(.a(new_n44_), .b(x15), .O(new_n87_));
  nand4  g46(.a(new_n87_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n57_), .O(z15));
  nor2   g48(.a(new_n52_), .b(x04), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n71_), .O(new_n91_));
  ...
  nand4  g59(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n101_));
  ...
  nand4  g65(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n107_));
