...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n55_, new_n57_, new_n60_, new_n62_,
  ...
  nand2  g11(.a(x20), .b(new_n52_), .O(z06));
  oai21  g12(.a(z06), .b(new_n50_), .c(new_n51_), .O(new_n54_));
  ...
  nand2  g33(.a(new_n50_), .b(new_n47_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  aoi22  g35(.a(new_n76_), .b(x14), .c(new_n75_), .d(x15), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n57_), .c(new_n45_), .O(z13));
  nand2  g37(.a(new_n50_), .b(x15), .O(new_n79_));
  ...
  nand4  g45(.a(new_n72_), .b(x16), .c(new_n47_), .d(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(z15));
  nand2  g47(.a(new_n50_), .b(x20), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n52_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x17), .O(new_n91_));
  nor2   g50(.a(new_n43_), .b(x15), .O(new_n92_));
  nand4  g51(.a(new_n92_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n91_), .c(new_n57_), .O(z16));
