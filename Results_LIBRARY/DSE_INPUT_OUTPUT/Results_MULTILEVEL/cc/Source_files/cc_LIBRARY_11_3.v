...
module FAU ( 
  ...
  aoi21  g19(.a(x15), .b(x11), .c(new_n60_), .O(z05));
  nand2  g20(.a(x15), .b(new_n42_), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  inv1   g23(.a(new_n58_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n64_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n65_), .b(new_n67_), .O(z08));
  nand3  g27(.a(new_n65_), .b(x09), .c(x08), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z09));
  nand3  g29(.a(new_n65_), .b(x09), .c(x08), .O(z10));
  nor2   g30(.a(new_n58_), .b(new_n46_), .O(z11));
  inv1   g31(.a(x12), .O(new_n73_));
  nand2  g32(.a(new_n54_), .b(new_n43_), .O(new_n74_));
  ...
  nand2  g38(.a(new_n54_), .b(new_n46_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x15), .c(new_n42_), .O(new_n81_));
  ...
  nand2  g43(.a(new_n54_), .b(x15), .O(new_n85_));
  nand2  g44(.a(x08), .b(x02), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n50_), .c(new_n85_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n65_), .O(z14));
  nand3  g48(.a(new_n75_), .b(x16), .c(new_n46_), .O(new_n90_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(new_n42_), .O(new_n97_));
  ...
  nand3  g61(.a(x18), .b(x15), .c(new_n42_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n73_), .O(z17));
  oai21  g63(.a(new_n60_), .b(new_n73_), .c(new_n42_), .O(new_n105_));
  ...
  oai21  g70(.a(new_n44_), .b(new_n73_), .c(new_n42_), .O(new_n112_));
