...
module FAU ( 
  ...
  nand4  g11(.a(new_n48_), .b(x12), .c(x10), .d(x08), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n42_), .c(new_n43_), .O(z03));
  nor2   g13(.a(new_n43_), .b(new_n42_), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  nor2   g16(.a(new_n55_), .b(new_n57_), .O(z05));
  inv1   g17(.a(x17), .O(new_n59_));
  inv1   g18(.a(new_n55_), .O(new_n60_));
  ...
  nand3  g24(.a(new_n60_), .b(x09), .c(x08), .O(z10));
  nand2  g25(.a(new_n60_), .b(new_n48_), .O(z11));
  ...
  nand3  g36(.a(new_n77_), .b(x15), .c(new_n42_), .O(new_n78_));
  ...
  nand2  g44(.a(new_n85_), .b(new_n60_), .O(z14));
  ...
  nand3  g57(.a(x17), .b(x15), .c(new_n42_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n76_), .O(z16));
  ...
  oai21  g67(.a(new_n57_), .b(new_n76_), .c(new_n42_), .O(new_n109_));
  ...
  oai21  g74(.a(new_n44_), .b(new_n76_), .c(new_n42_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n46_), .b(x20), .O(new_n118_));
  nand4  g77(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n119_));
