...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n63_, new_n65_, new_n70_, new_n71_, new_n73_, new_n74_, new_n75_,
  ...
  nand2  g30(.a(new_n71_), .b(new_n51_), .O(z12));
  inv1   g31(.a(x12), .O(new_n73_));
  oai21  g32(.a(new_n48_), .b(x14), .c(x15), .O(new_n74_));
  nand2  g33(.a(new_n48_), .b(x01), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(x14), .c(x00), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(z13));
  nand2  g36(.a(new_n47_), .b(x15), .O(new_n78_));
  nand3  g37(.a(new_n70_), .b(x02), .c(x00), .O(new_n79_));
  ...
  nand4  g42(.a(new_n53_), .b(x16), .c(new_n46_), .d(x12), .O(new_n84_));
  ...
  nand3  g47(.a(new_n53_), .b(x17), .c(x12), .O(new_n89_));
  ...
  nand4  g55(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x00), .O(new_n99_));
  nand2  g58(.a(x19), .b(x15), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n73_), .O(z18));
