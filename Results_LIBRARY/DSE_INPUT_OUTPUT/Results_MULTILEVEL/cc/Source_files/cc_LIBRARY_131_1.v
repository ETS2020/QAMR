...
module FAU ( 
  ...
  nand3  g45(.a(new_n48_), .b(x16), .c(new_n51_), .O(new_n87_));
  ...
  oai21  g50(.a(x17), .b(new_n47_), .c(x15), .O(new_n92_));
  ...
  oai21  g56(.a(x18), .b(new_n47_), .c(x15), .O(new_n98_));
  ...
  oai21  g62(.a(x19), .b(new_n47_), .c(x15), .O(new_n104_));
  ...
  nand3  g69(.a(new_n72_), .b(x08), .c(x07), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n47_), .O(z19));
endmodule
