...
module FAU ( 
  ...
  oai21  g12(.a(new_n50_), .b(x11), .c(new_n53_), .O(z02));
  nand2  g13(.a(x10), .b(x08), .O(new_n55_));
  nand3  g14(.a(x15), .b(new_n44_), .c(x12), .O(new_n56_));
  ...
  nor2   g26(.a(new_n52_), .b(new_n44_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  nand2  g28(.a(new_n55_), .b(new_n51_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n47_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x13), .O(new_n72_));
  nor2   g31(.a(x20), .b(x15), .O(new_n73_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n69_), .c(new_n53_), .O(z13));
  nand2  g38(.a(new_n55_), .b(x15), .O(new_n80_));
  nand4  g39(.a(new_n73_), .b(x10), .c(x08), .d(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n69_), .O(z14));
  nand3  g41(.a(new_n71_), .b(x16), .c(new_n44_), .O(new_n83_));
  nand4  g42(.a(new_n73_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n69_), .O(z15));
  nand2  g44(.a(new_n71_), .b(x17), .O(new_n86_));
  nand4  g45(.a(new_n73_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n69_), .O(z16));
  nand2  g47(.a(new_n71_), .b(x18), .O(new_n89_));
  nand4  g48(.a(new_n73_), .b(x10), .c(x08), .d(x05), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n69_), .O(z17));
  ...
  nand3  g53(.a(new_n48_), .b(x19), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z18));
  nand2  g55(.a(x20), .b(x15), .O(new_n97_));
  nand4  g56(.a(new_n73_), .b(x10), .c(x08), .d(x07), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(z19));
  buf    g58(.a(x15), .O(z06));
endmodule
