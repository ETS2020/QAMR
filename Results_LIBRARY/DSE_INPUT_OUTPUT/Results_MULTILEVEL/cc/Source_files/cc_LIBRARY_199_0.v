...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(new_n50_), .c(new_n46_), .O(new_n53_));
  ...
  nand2  g47(.a(new_n88_), .b(x08), .O(new_n89_));
  nand4  g48(.a(new_n89_), .b(x16), .c(new_n46_), .d(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n86_), .O(z15));
  nor2   g50(.a(new_n50_), .b(x04), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x17), .c(x12), .O(new_n94_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n56_), .O(z17));
  nand2  g60(.a(new_n57_), .b(x19), .O(new_n102_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n56_), .O(z18));
