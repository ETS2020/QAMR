...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n62_, new_n64_, new_n66_, new_n68_, new_n69_, new_n73_,
  ...
  nand2  g31(.a(new_n59_), .b(new_n43_), .O(new_n73_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n58_), .O(new_n90_));
  nand3  g49(.a(new_n58_), .b(x10), .c(x08), .O(new_n91_));
  ...
  aoi21  g53(.a(new_n94_), .b(z04), .c(new_n57_), .O(z17));
  nand4  g54(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n58_), .O(new_n98_));
  nand3  g57(.a(new_n91_), .b(x19), .c(x12), .O(new_n99_));
  ...
  nand3  g62(.a(new_n91_), .b(x20), .c(x12), .O(new_n104_));
