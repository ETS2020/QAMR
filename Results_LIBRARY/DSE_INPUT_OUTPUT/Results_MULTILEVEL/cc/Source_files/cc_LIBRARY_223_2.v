...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n72_, new_n74_, new_n77_, new_n79_;
  ...
  aoi21  g27(.a(x15), .b(new_n68_), .c(new_n58_), .O(z12));
  ...
  aoi21  g34(.a(new_n60_), .b(x15), .c(new_n58_), .O(z16));
  inv1   g35(.a(x18), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x15), .c(new_n58_), .O(z17));
  nand3  g37(.a(x19), .b(x15), .c(x12), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z18));
  aoi21  g39(.a(new_n43_), .b(x15), .c(new_n58_), .O(z19));
endmodule
