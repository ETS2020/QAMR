...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x17), .c(new_n47_), .O(z01));
  ...
  nand4  g15(.a(new_n56_), .b(x17), .c(x15), .d(new_n48_), .O(new_n57_));
  ...
  nor2   g21(.a(new_n44_), .b(new_n47_), .O(z06));
  ...
  nand2  g29(.a(new_n70_), .b(x17), .O(new_n71_));
  ...
  nand3  g44(.a(new_n73_), .b(x17), .c(x15), .O(new_n86_));
  nand4  g45(.a(new_n47_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
  ...
  nand3  g50(.a(new_n73_), .b(x16), .c(new_n48_), .O(new_n92_));
  ...
  nand2  g55(.a(new_n51_), .b(new_n44_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g57(.a(new_n51_), .b(x17), .O(new_n99_));
  ...
  nand4  g63(.a(new_n47_), .b(x10), .c(x08), .d(x05), .O(new_n105_));
  ...
  nand3  g71(.a(x19), .b(x17), .c(x15), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n85_), .O(z18));
  oai21  g73(.a(new_n43_), .b(new_n85_), .c(x17), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n73_), .b(x20), .O(new_n117_));
  nand4  g76(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n118_));
