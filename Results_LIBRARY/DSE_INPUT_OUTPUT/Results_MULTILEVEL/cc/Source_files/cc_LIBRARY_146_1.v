...
module FAU ( 
  ...
  nand4  g11(.a(new_n44_), .b(new_n52_), .c(x10), .d(x08), .O(new_n53_));
  oai21  g12(.a(new_n45_), .b(new_n49_), .c(new_n53_), .O(new_n54_));
  ...
  nor2   g22(.a(new_n44_), .b(new_n52_), .O(z08));
  ...
  oai21  g37(.a(new_n78_), .b(new_n57_), .c(new_n47_), .O(z13));
  nand2  g38(.a(new_n48_), .b(x15), .O(new_n80_));
  nor2   g39(.a(x16), .b(x15), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(x10), .c(x08), .d(x02), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n57_), .O(z14));
  nand4  g42(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  oai21  g43(.a(new_n44_), .b(x14), .c(new_n84_), .O(new_n85_));
  ...
  nand3  g49(.a(new_n73_), .b(x17), .c(x12), .O(new_n91_));
  ...
  nand3  g54(.a(new_n73_), .b(x18), .c(x12), .O(new_n96_));
  ...
  nand3  g59(.a(new_n73_), .b(x19), .c(x12), .O(new_n101_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n57_), .O(z19));
  buf    g67(.a(x15), .O(z06));
endmodule
