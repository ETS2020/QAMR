...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(new_n55_), .c(new_n45_), .O(z03));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n55_), .c(new_n70_), .O(new_n71_));
  aoi21  g30(.a(x10), .b(x08), .c(new_n55_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(new_n45_), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n69_), .O(z12));
  ...
  nand3  g39(.a(new_n46_), .b(x15), .c(new_n55_), .O(new_n81_));
  inv1   g40(.a(new_n51_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n69_), .O(z14));
  nand2  g43(.a(new_n46_), .b(new_n45_), .O(new_n85_));
  nand2  g44(.a(x15), .b(new_n55_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x16), .c(new_n56_), .O(new_n88_));
  nand3  g47(.a(new_n82_), .b(x08), .c(x03), .O(new_n89_));
  ...
  nand3  g53(.a(x17), .b(x15), .c(new_n55_), .O(new_n95_));
  ...
  oai21  g60(.a(new_n101_), .b(new_n51_), .c(new_n100_), .O(new_n102_));
  ...
  nand3  g67(.a(x19), .b(x15), .c(new_n55_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n69_), .O(z18));
  nand2  g69(.a(x20), .b(x12), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n55_), .O(new_n112_));
