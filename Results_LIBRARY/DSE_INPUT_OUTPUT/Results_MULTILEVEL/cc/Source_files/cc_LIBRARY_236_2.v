...
module FAU ( 
  ...
  oai21  g33(.a(new_n49_), .b(x14), .c(x15), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n57_), .O(z13));
  nand4  g35(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n77_));
  oai21  g36(.a(new_n49_), .b(new_n52_), .c(new_n77_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n47_), .O(z14));
  nand2  g39(.a(new_n53_), .b(x16), .O(new_n81_));
  nand4  g40(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n44_), .c(x12), .O(new_n84_));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n57_), .O(z17));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n57_), .O(z18));
