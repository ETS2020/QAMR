...
module FAU ( 
  ...
  nand2  g37(.a(new_n47_), .b(new_n48_), .O(new_n79_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n71_), .O(new_n89_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n71_), .O(new_n99_));
  nand3  g58(.a(new_n75_), .b(x18), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(z17));
  aoi21  g60(.a(x10), .b(x08), .c(x20), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(x15), .c(x19), .O(new_n103_));
  nand4  g62(.a(new_n53_), .b(x10), .c(x08), .d(x06), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n78_), .O(z18));
  nand2  g64(.a(x20), .b(x15), .O(new_n106_));
  nand4  g65(.a(new_n53_), .b(x10), .c(x08), .d(x07), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n78_), .O(z19));
  buf    g67(.a(x15), .O(z06));
endmodule
