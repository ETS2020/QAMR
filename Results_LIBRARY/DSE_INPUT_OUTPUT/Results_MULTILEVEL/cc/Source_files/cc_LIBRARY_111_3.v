...
module FAU ( 
  ...
  aoi21  g22(.a(x19), .b(x15), .c(new_n63_), .O(z07));
  ...
  nand2  g29(.a(new_n57_), .b(new_n45_), .O(new_n71_));
  ...
  oai21  g48(.a(new_n63_), .b(new_n70_), .c(new_n46_), .O(new_n90_));
  ...
  aoi21  g64(.a(new_n57_), .b(new_n46_), .c(new_n105_), .O(new_n106_));
  aoi21  g65(.a(x10), .b(x08), .c(new_n46_), .O(new_n107_));
  oai21  g66(.a(new_n107_), .b(new_n106_), .c(new_n45_), .O(new_n108_));
  nor2   g67(.a(new_n108_), .b(new_n70_), .O(z18));
