...
module FAU ( 
  ...
  oai21  g15(.a(new_n45_), .b(new_n55_), .c(new_n56_), .O(z05));
  nor2   g16(.a(new_n45_), .b(x12), .O(z06));
  and2   g17(.a(new_n42_), .b(x17), .O(z07));
  and2   g18(.a(new_n42_), .b(x16), .O(z08));
  nand3  g19(.a(new_n42_), .b(x09), .c(x08), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(z09));
  aoi21  g21(.a(x09), .b(x08), .c(z03), .O(z10));
  nand2  g22(.a(new_n42_), .b(new_n49_), .O(z11));
  ...
  aoi21  g30(.a(new_n71_), .b(new_n45_), .c(new_n55_), .O(z13));
  nand4  g31(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(x15), .O(z14));
  nand3  g33(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n75_));
  ...
  and2   g45(.a(new_n86_), .b(new_n45_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n55_), .O(z17));
  nand2  g47(.a(new_n46_), .b(x19), .O(new_n89_));
  nand3  g48(.a(x10), .b(x08), .c(x06), .O(new_n90_));
  and2   g49(.a(new_n90_), .b(new_n45_), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n89_), .c(new_n55_), .O(z18));
  nand2  g51(.a(new_n46_), .b(x20), .O(new_n93_));
  nand3  g52(.a(x10), .b(x08), .c(x07), .O(new_n94_));
  and2   g53(.a(new_n94_), .b(new_n45_), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n55_), .O(z19));
endmodule
