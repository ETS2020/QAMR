...
module FAU ( 
  ...
  nand3  g39(.a(x19), .b(new_n51_), .c(x10), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n80_), .c(new_n75_), .O(z14));
  nand2  g43(.a(new_n47_), .b(x19), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n51_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x16), .c(new_n48_), .O(new_n87_));
  nand3  g46(.a(new_n82_), .b(x08), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n75_), .O(z15));
  nand2  g48(.a(new_n86_), .b(x17), .O(new_n90_));
  nand3  g49(.a(new_n82_), .b(x08), .c(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n75_), .O(z16));
