...
module FAU ( 
  ...
  nand2  g18(.a(x18), .b(new_n45_), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  aoi21  g20(.a(x18), .b(x15), .c(new_n61_), .O(z05));
  ...
  nand2  g37(.a(new_n46_), .b(new_n50_), .O(new_n79_));
  ...
  nand3  g54(.a(new_n55_), .b(x17), .c(x15), .O(new_n96_));
