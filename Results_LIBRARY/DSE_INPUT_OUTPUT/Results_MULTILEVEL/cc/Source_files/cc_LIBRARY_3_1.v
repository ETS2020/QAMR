...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(z12));
  ...
  oai21  g34(.a(new_n72_), .b(new_n75_), .c(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n66_), .O(z13));
  ...
  nand3  g41(.a(new_n72_), .b(x16), .c(new_n47_), .O(new_n83_));
  nand4  g42(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n82_), .O(z15));
  oai21  g46(.a(x17), .b(new_n66_), .c(x15), .O(new_n88_));
  ...
  nand3  g53(.a(new_n69_), .b(x08), .c(x05), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n66_), .O(z17));
  nand2  g55(.a(new_n51_), .b(x19), .O(new_n97_));
  nand3  g56(.a(new_n69_), .b(x08), .c(x06), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n66_), .O(z18));
  nand2  g58(.a(new_n51_), .b(x20), .O(new_n100_));
  nand3  g59(.a(new_n69_), .b(x08), .c(x07), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n66_), .O(z19));
  aoi21  g61(.a(new_n48_), .b(x12), .c(new_n43_), .O(z03));
  buf    g62(.a(x15), .O(z06));
endmodule
