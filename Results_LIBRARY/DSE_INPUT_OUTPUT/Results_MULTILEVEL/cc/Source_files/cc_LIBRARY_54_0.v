...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x07), .O(new_n43_));
  ...
  aoi22  g51(.a(new_n92_), .b(new_n72_), .c(new_n51_), .d(x18), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n55_), .c(new_n44_), .O(z17));
  ...
  aoi22  g57(.a(new_n98_), .b(new_n72_), .c(new_n51_), .d(x20), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n55_), .c(new_n44_), .O(z19));
endmodule
