...
module FAU ( 
  ...
  nand2  g18(.a(new_n50_), .b(x09), .O(z06));
  ...
  aoi21  g28(.a(new_n50_), .b(new_n67_), .c(new_n47_), .O(z11));
  ...
  nand3  g48(.a(x16), .b(x15), .c(new_n47_), .O(new_n90_));
  ...
  nand2  g53(.a(new_n94_), .b(x09), .O(new_n95_));
  ...
  nand2  g57(.a(new_n98_), .b(x09), .O(new_n99_));
  ...
  nand2  g70(.a(new_n111_), .b(x09), .O(new_n112_));
  nand2  g71(.a(x20), .b(x15), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n76_), .O(z19));
endmodule
