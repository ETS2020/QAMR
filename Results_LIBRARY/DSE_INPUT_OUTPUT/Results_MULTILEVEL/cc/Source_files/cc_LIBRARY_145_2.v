...
module FAU ( 
  ...
  oai21  g19(.a(x20), .b(new_n44_), .c(new_n60_), .O(z05));
  ...
  nand2  g45(.a(new_n55_), .b(x15), .O(new_n87_));
  ...
  nand3  g75(.a(x20), .b(x19), .c(x15), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n92_), .O(z18));
  nand2  g77(.a(new_n51_), .b(new_n43_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x07), .O(new_n120_));
  nand2  g79(.a(new_n51_), .b(x20), .O(new_n121_));
  aoi21  g80(.a(new_n121_), .b(new_n120_), .c(new_n92_), .O(z19));
endmodule
