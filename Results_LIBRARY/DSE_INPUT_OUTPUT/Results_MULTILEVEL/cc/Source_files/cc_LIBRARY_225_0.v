...
module FAU ( 
  ...
  nand2  g21(.a(new_n52_), .b(x10), .O(z06));
  ...
  aoi21  g32(.a(new_n52_), .b(x08), .c(new_n73_), .O(new_n74_));
  ...
  oai21  g42(.a(new_n52_), .b(x12), .c(new_n51_), .O(new_n84_));
  inv1   g43(.a(x02), .O(new_n85_));
  nand2  g44(.a(new_n52_), .b(x08), .O(new_n86_));
  nand2  g45(.a(x15), .b(new_n68_), .O(new_n87_));
  ...
  nand3  g49(.a(new_n52_), .b(x08), .c(x03), .O(new_n91_));
  nand3  g50(.a(x16), .b(new_n47_), .c(new_n68_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x10), .O(new_n94_));
  nand3  g53(.a(x16), .b(x15), .c(new_n47_), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n58_), .O(z15));
  nand3  g55(.a(x12), .b(x08), .c(x04), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x10), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  nand3  g58(.a(new_n86_), .b(x17), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(z16));
  inv1   g60(.a(x05), .O(new_n102_));
  nand2  g61(.a(x18), .b(new_n68_), .O(new_n103_));
  oai21  g62(.a(new_n86_), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g66(.a(x12), .b(x08), .c(x06), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x10), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n52_), .O(new_n110_));
  nand3  g69(.a(new_n86_), .b(x19), .c(x12), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n110_), .O(z18));
  inv1   g71(.a(x07), .O(new_n113_));
  nand2  g72(.a(x20), .b(new_n68_), .O(new_n114_));
  oai21  g73(.a(new_n86_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x10), .O(new_n116_));
  nand2  g75(.a(x20), .b(x15), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n58_), .O(z19));
endmodule
