...
module FAU ( 
  ...
  nand3  g29(.a(new_n57_), .b(x09), .c(x08), .O(z10));
  ...
  oai21  g49(.a(new_n74_), .b(x15), .c(x17), .O(new_n91_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n63_), .O(new_n96_));
  ...
  nand4  g62(.a(new_n63_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n43_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n57_), .O(z19));
endmodule
