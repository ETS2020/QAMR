...
module FAU ( 
  ...
  nand2  g03(.a(x20), .b(x12), .O(new_n45_));
  ...
  aoi21  g14(.a(new_n55_), .b(new_n50_), .c(new_n42_), .O(z02));
  nand3  g15(.a(x12), .b(x10), .c(x08), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(new_n50_), .c(x15), .d(new_n47_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z03));
  nand2  g19(.a(new_n45_), .b(x18), .O(z04));
  and2   g20(.a(new_n45_), .b(x19), .O(z05));
  ...
  and2   g25(.a(new_n45_), .b(x16), .O(z08));
  nand3  g26(.a(new_n45_), .b(x09), .c(x08), .O(new_n68_));
  ...
  nand3  g33(.a(new_n74_), .b(new_n50_), .c(x12), .O(new_n75_));
  ...
  nand3  g39(.a(new_n80_), .b(new_n50_), .c(x12), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  nand2  g41(.a(new_n46_), .b(x15), .O(new_n83_));
  nand4  g42(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n50_), .c(x12), .O(new_n86_));
  ...
  nand3  g49(.a(new_n90_), .b(new_n50_), .c(x12), .O(new_n91_));
  ...
  nand3  g54(.a(new_n95_), .b(new_n50_), .c(x12), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z16));
  nand2  g56(.a(new_n53_), .b(x18), .O(new_n98_));
  nand4  g57(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n50_), .c(x12), .O(new_n101_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(x20), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n103_), .c(new_n42_), .O(z18));
  nand4  g67(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n109_));
  nor3   g68(.a(new_n109_), .b(x20), .c(x15), .O(z19));
endmodule
