...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x01), .O(new_n55_));
  ...
  nand3  g34(.a(new_n54_), .b(x13), .c(x12), .O(new_n76_));
  ...
  nand3  g45(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n87_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n59_), .O(z15));
  nand2  g51(.a(x08), .b(x04), .O(new_n93_));
  oai22  g52(.a(new_n93_), .b(new_n82_), .c(new_n50_), .d(new_n64_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(new_n95_));
  nand2  g54(.a(x17), .b(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n59_), .O(z16));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n59_), .O(z17));
  nand2  g62(.a(x08), .b(x06), .O(new_n104_));
  oai22  g63(.a(new_n104_), .b(new_n82_), .c(new_n50_), .d(new_n62_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n44_), .O(new_n106_));
  nand2  g65(.a(x19), .b(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n59_), .O(z18));
  nand4  g67(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n44_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n53_), .O(new_n111_));
