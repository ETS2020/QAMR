...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n69_, new_n70_, new_n72_, new_n75_, new_n77_;
  ...
  and2   g18(.a(new_n45_), .b(x16), .O(z08));
  ...
  aoi21  g24(.a(x15), .b(new_n65_), .c(new_n50_), .O(z12));
  aoi21  g25(.a(x10), .b(x08), .c(x14), .O(new_n67_));
  nor3   g26(.a(new_n67_), .b(new_n44_), .c(new_n50_), .O(z13));
