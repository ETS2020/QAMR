...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n56_, new_n57_, new_n60_, new_n62_, new_n67_,
  ...
  nand2  g17(.a(new_n52_), .b(x14), .O(z06));
  ...
  nor2   g40(.a(x15), .b(new_n46_), .O(new_n82_));
  ...
  oai21  g44(.a(new_n62_), .b(x14), .c(new_n85_), .O(new_n86_));
