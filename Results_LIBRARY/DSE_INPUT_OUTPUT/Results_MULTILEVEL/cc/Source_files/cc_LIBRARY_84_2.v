...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n59_, new_n60_,
  ...
  aoi21  g07(.a(new_n48_), .b(x17), .c(new_n46_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(x17), .b(new_n46_), .c(x14), .O(new_n51_));
  ...
  nand3  g37(.a(new_n78_), .b(x17), .c(x15), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(x01), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n46_), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n69_), .O(z13));
  nand3  g41(.a(new_n77_), .b(x17), .c(x15), .O(new_n83_));
  ...
  nand3  g47(.a(new_n77_), .b(x16), .c(new_n47_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n52_), .b(new_n43_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g54(.a(new_n52_), .b(x17), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n69_), .O(z16));
  nand2  g56(.a(new_n77_), .b(x18), .O(new_n98_));
  ...
  oai21  g62(.a(new_n59_), .b(new_n69_), .c(x17), .O(new_n104_));
  ...
  nand2  g69(.a(new_n77_), .b(x20), .O(new_n111_));
  ...
  nand3  g73(.a(x20), .b(x17), .c(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n69_), .O(z19));
  buf    g75(.a(x15), .O(z06));
endmodule
