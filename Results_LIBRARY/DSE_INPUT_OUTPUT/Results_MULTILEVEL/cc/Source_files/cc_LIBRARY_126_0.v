// Benchmark "FAU" written by ABC on Thu Aug 13 17:54:56 2020
...
module FAU ( 
  ...
  nand2  g03(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  ...
  oai21  g10(.a(x20), .b(x15), .c(x14), .O(new_n52_));
  nand2  g11(.a(x20), .b(new_n42_), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(new_n47_), .c(new_n52_), .O(new_n54_));
  nand3  g13(.a(new_n54_), .b(x12), .c(new_n51_), .O(new_n55_));
  inv1   g14(.a(new_n55_), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  nor4   g16(.a(new_n47_), .b(new_n42_), .c(x14), .d(new_n57_), .O(z03));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n57_), .O(z14));
  ...
  nand3  g47(.a(new_n42_), .b(x10), .c(x08), .O(new_n89_));
  nand4  g48(.a(new_n89_), .b(x16), .c(new_n48_), .d(x12), .O(new_n90_));
  ...
  nand2  g54(.a(new_n95_), .b(x20), .O(new_n96_));
  ...
  nand2  g59(.a(new_n100_), .b(x20), .O(new_n101_));
  ...
  nand4  g64(.a(new_n42_), .b(x10), .c(x08), .d(new_n105_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(x20), .c(x12), .O(new_n107_));
