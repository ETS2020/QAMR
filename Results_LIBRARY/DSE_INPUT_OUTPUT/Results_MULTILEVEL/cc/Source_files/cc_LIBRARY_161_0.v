...
module FAU ( 
  ...
  nor2   g01(.a(x18), .b(x17), .O(new_n43_));
  ...
  nand2  g21(.a(x18), .b(new_n62_), .O(z07));
  ...
  nand2  g49(.a(x18), .b(new_n51_), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n46_), .c(new_n62_), .O(new_n92_));
  ...
  nand2  g54(.a(x17), .b(new_n51_), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n46_), .c(z04), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x05), .O(new_n98_));
  nand2  g57(.a(new_n52_), .b(x18), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n69_), .O(z17));
  and2   g59(.a(x08), .b(x06), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n71_), .c(new_n52_), .d(x19), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n69_), .c(new_n44_), .O(z18));
