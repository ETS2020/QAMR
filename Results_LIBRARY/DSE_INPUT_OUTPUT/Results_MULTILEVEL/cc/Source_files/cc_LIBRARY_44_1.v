...
module FAU ( 
  ...
  nand3  g45(.a(new_n74_), .b(x16), .c(new_n45_), .O(new_n87_));
  ...
  nand2  g53(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  nand3  g54(.a(new_n72_), .b(x10), .c(x08), .O(new_n96_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n72_), .O(new_n101_));
  nand3  g60(.a(new_n96_), .b(x19), .c(x12), .O(new_n102_));
