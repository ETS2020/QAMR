...
module FAU ( 
  ...
  nand2  g28(.a(new_n47_), .b(z04), .O(new_n70_));
  ...
  oai21  g38(.a(new_n48_), .b(new_n43_), .c(new_n79_), .O(new_n80_));
  ...
  nand4  g45(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  ...
  nand4  g51(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(z04), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n43_), .O(new_n95_));
  nand3  g54(.a(new_n43_), .b(x10), .c(x08), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(x19), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n95_), .O(z18));
  nand2  g57(.a(new_n47_), .b(x20), .O(new_n99_));
  nand4  g58(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(z04), .O(new_n102_));
  nand2  g61(.a(x20), .b(x15), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n58_), .O(z19));
  buf    g63(.a(x15), .O(z06));
endmodule
