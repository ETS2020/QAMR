...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n55_, new_n59_, new_n61_, new_n66_,
  ...
  oai21  g14(.a(new_n55_), .b(new_n54_), .c(new_n45_), .O(z03));
  ...
  nand2  g22(.a(z10), .b(new_n45_), .O(z09));
  nand2  g23(.a(new_n45_), .b(new_n47_), .O(z11));
  inv1   g24(.a(x13), .O(new_n66_));
  aoi21  g25(.a(new_n44_), .b(x10), .c(new_n66_), .O(new_n67_));
  nand3  g26(.a(new_n44_), .b(x10), .c(x00), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n67_), .c(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n45_), .O(z12));
  aoi21  g30(.a(x14), .b(x12), .c(new_n44_), .O(new_n72_));
  aoi21  g31(.a(new_n54_), .b(new_n47_), .c(new_n44_), .O(new_n73_));
  aoi21  g32(.a(x10), .b(x01), .c(new_n47_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(x12), .O(new_n75_));
  oai21  g34(.a(new_n72_), .b(x08), .c(new_n75_), .O(z13));
  oai21  g35(.a(new_n44_), .b(x12), .c(new_n43_), .O(new_n77_));
  inv1   g36(.a(x02), .O(new_n78_));
  inv1   g37(.a(x10), .O(new_n79_));
  nand2  g38(.a(x15), .b(new_n79_), .O(new_n80_));
  oai21  g39(.a(new_n50_), .b(new_n78_), .c(new_n80_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n77_), .O(z14));
  nand3  g42(.a(new_n50_), .b(x16), .c(new_n47_), .O(new_n84_));
  nand3  g43(.a(new_n44_), .b(x10), .c(x03), .O(new_n85_));
  ...
  nand3  g51(.a(new_n50_), .b(x17), .c(x12), .O(new_n93_));
  ...
  oai21  g59(.a(new_n90_), .b(new_n100_), .c(x08), .O(new_n101_));
