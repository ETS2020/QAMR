...
module FAU ( 
  ...
  nor2   g15(.a(x15), .b(new_n47_), .O(new_n57_));
  ...
  oai21  g24(.a(x15), .b(new_n47_), .c(x14), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z11));
  inv1   g26(.a(x12), .O(new_n68_));
  oai21  g27(.a(x15), .b(new_n47_), .c(x13), .O(new_n69_));
  ...
  nand3  g34(.a(x16), .b(new_n48_), .c(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n45_), .O(z15));
  oai21  g36(.a(new_n59_), .b(new_n68_), .c(new_n45_), .O(z16));
  nand2  g37(.a(x18), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n45_), .O(z17));
  oai21  g39(.a(new_n56_), .b(new_n68_), .c(new_n45_), .O(z18));
