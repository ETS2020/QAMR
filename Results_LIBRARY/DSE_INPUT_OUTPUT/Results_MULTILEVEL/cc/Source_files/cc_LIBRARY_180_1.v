...
module FAU ( 
  ...
  nand4  g12(.a(z04), .b(new_n53_), .c(x10), .d(x08), .O(new_n54_));
  ...
  nand2  g30(.a(new_n48_), .b(z04), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n53_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x13), .O(new_n74_));
  nor2   g33(.a(x18), .b(x15), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(x10), .c(x08), .d(x00), .O(new_n76_));
  ...
  nand3  g44(.a(new_n73_), .b(x16), .c(new_n47_), .O(new_n86_));
  nand4  g45(.a(new_n75_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n71_), .O(z15));
  nand4  g47(.a(x12), .b(x10), .c(x08), .d(x04), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(z04), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n53_), .O(new_n91_));
  nand3  g50(.a(new_n53_), .b(x10), .c(x08), .O(new_n92_));
  ...
  nand3  g66(.a(new_n92_), .b(x20), .c(x12), .O(new_n108_));
