...
module FAU ( 
  ...
  aoi22  g52(.a(new_n93_), .b(new_n74_), .c(new_n52_), .d(x17), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n58_), .c(new_n46_), .O(z16));
  inv1   g54(.a(new_n52_), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(x18), .c(x05), .O(new_n97_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n58_), .O(z18));
  nand2  g61(.a(new_n52_), .b(x20), .O(new_n103_));
  nand3  g62(.a(new_n74_), .b(x08), .c(x07), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n58_), .O(z19));
endmodule
