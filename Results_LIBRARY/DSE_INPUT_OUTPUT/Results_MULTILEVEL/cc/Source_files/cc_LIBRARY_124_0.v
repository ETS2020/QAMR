...
module FAU ( 
  ...
  nand2  g32(.a(new_n57_), .b(new_n46_), .O(new_n74_));
  ...
  nand3  g37(.a(new_n57_), .b(x15), .c(x12), .O(new_n79_));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n57_), .b(new_n80_), .c(x12), .O(new_n81_));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n84_), .c(new_n56_), .O(z15));
  ...
  oai21  g53(.a(new_n57_), .b(new_n94_), .c(x12), .O(new_n95_));
  ...
  nand3  g58(.a(new_n86_), .b(x08), .c(x06), .O(new_n100_));
