...
module FAU ( 
  ...
  nand3  g45(.a(new_n69_), .b(x16), .c(new_n48_), .O(new_n87_));
  ...
  inv1   g57(.a(x10), .O(new_n99_));
  nor2   g58(.a(x15), .b(new_n99_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(x08), .c(x05), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n98_), .c(new_n43_), .O(z17));
  nand2  g61(.a(new_n51_), .b(x19), .O(new_n103_));
  nand3  g62(.a(new_n100_), .b(x08), .c(x06), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n43_), .O(z18));
  nand2  g64(.a(new_n51_), .b(x20), .O(new_n106_));
  nand3  g65(.a(new_n100_), .b(x08), .c(x07), .O(new_n107_));
