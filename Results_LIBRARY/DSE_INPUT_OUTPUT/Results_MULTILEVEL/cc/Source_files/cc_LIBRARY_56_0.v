...
module FAU ( 
  ...
  nand2  g28(.a(new_n50_), .b(x13), .O(new_n70_));
  ...
  oai21  g51(.a(new_n55_), .b(new_n92_), .c(x12), .O(new_n93_));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  oai21  g59(.a(new_n55_), .b(new_n100_), .c(x12), .O(new_n101_));
