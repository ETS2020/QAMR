...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(new_n58_), .c(new_n45_), .O(z03));
  ...
  aoi21  g26(.a(new_n47_), .b(x04), .c(new_n43_), .O(z09));
  ...
  inv1   g36(.a(new_n58_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x01), .c(new_n48_), .O(new_n79_));
  ...
  aoi21  g53(.a(new_n54_), .b(new_n64_), .c(new_n94_), .O(new_n95_));
  and2   g54(.a(new_n54_), .b(x17), .O(new_n96_));
  ...
  nand2  g62(.a(new_n54_), .b(x19), .O(new_n104_));
  nand3  g63(.a(new_n73_), .b(x08), .c(x06), .O(new_n105_));
  ...
  nand3  g68(.a(new_n73_), .b(x08), .c(x07), .O(new_n110_));
