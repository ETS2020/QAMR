...
module FAU ( 
  ...
  nand2  g36(.a(new_n55_), .b(new_n47_), .O(new_n78_));
  nand3  g37(.a(x10), .b(x08), .c(x01), .O(new_n79_));
  aoi22  g38(.a(new_n79_), .b(x14), .c(new_n78_), .d(x15), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n71_), .c(new_n45_), .O(z13));
  nand2  g40(.a(new_n55_), .b(x15), .O(new_n82_));
  inv1   g41(.a(new_n51_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n43_), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n71_), .O(z14));
