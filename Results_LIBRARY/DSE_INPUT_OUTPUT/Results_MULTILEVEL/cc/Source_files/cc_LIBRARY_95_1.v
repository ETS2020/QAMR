...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n57_, new_n60_, new_n61_, new_n65_,
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(new_n43_), .O(z12));
  ...
  nand3  g37(.a(new_n46_), .b(x12), .c(x10), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(z14));
  nand3  g39(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n81_));
  nand3  g40(.a(new_n67_), .b(x08), .c(x03), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(z15));
  oai21  g42(.a(x17), .b(new_n43_), .c(x15), .O(new_n84_));
  nand2  g43(.a(new_n70_), .b(x17), .O(new_n85_));
  nand4  g44(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n86_));
