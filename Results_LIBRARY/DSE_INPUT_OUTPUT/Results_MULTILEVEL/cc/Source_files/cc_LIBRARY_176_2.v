...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n61_, new_n63_, new_n64_, new_n67_, new_n71_, new_n72_, new_n73_,
  ...
  aoi21  g07(.a(new_n48_), .b(x18), .c(new_n46_), .O(z01));
  ...
  aoi21  g17(.a(new_n58_), .b(x18), .c(new_n46_), .O(z03));
  ...
  nor2   g26(.a(new_n67_), .b(new_n51_), .O(z09));
  aoi21  g27(.a(x09), .b(x08), .c(new_n64_), .O(z10));
  nor2   g28(.a(new_n64_), .b(new_n47_), .O(z11));
  inv1   g29(.a(x12), .O(new_n71_));
  aoi21  g30(.a(x10), .b(x08), .c(x15), .O(new_n72_));
  nor2   g31(.a(new_n43_), .b(new_n46_), .O(new_n73_));
  ...
  oai21  g54(.a(new_n63_), .b(new_n71_), .c(x18), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x15), .O(new_n97_));
  nand2  g56(.a(new_n56_), .b(x17), .O(new_n98_));
  nand2  g57(.a(x08), .b(x04), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n52_), .c(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n97_), .O(z16));
  inv1   g61(.a(x05), .O(new_n103_));
  aoi21  g62(.a(new_n56_), .b(new_n43_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n56_), .b(x18), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n46_), .O(new_n106_));
  oai21  g65(.a(new_n106_), .b(new_n104_), .c(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n44_), .O(z17));
  oai21  g67(.a(new_n61_), .b(new_n71_), .c(x18), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n56_), .b(x19), .O(new_n111_));
  ...
  nand3  g78(.a(x20), .b(x18), .c(x15), .O(new_n120_));
