...
module FAU ( 
  ...
  nand2  g27(.a(new_n46_), .b(new_n49_), .O(z11));
  ...
  oai21  g37(.a(new_n78_), .b(new_n57_), .c(new_n46_), .O(z13));
  ...
  aoi21  g65(.a(new_n48_), .b(new_n44_), .c(x15), .O(new_n107_));
  nor3   g66(.a(new_n107_), .b(new_n43_), .c(new_n57_), .O(z19));
  buf    g67(.a(x15), .O(z06));
endmodule
