...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n57_, new_n59_, new_n63_, new_n64_, new_n65_, new_n66_,
  ...
  and2   g14(.a(new_n43_), .b(x17), .O(z07));
  inv1   g15(.a(x16), .O(new_n57_));
  nand2  g16(.a(new_n43_), .b(new_n57_), .O(z08));
  nand3  g17(.a(new_n43_), .b(x09), .c(x08), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z09));
  nand3  g19(.a(new_n43_), .b(x09), .c(x08), .O(z10));
  nor2   g20(.a(z03), .b(new_n49_), .O(z11));
  ...
  aoi21  g25(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(z12));
  ...
  aoi21  g30(.a(new_n71_), .b(new_n45_), .c(new_n63_), .O(z14));
  nand3  g31(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n73_));
  ...
  aoi21  g47(.a(new_n65_), .b(x06), .c(x15), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n63_), .O(z18));
  nand2  g49(.a(new_n46_), .b(x20), .O(new_n91_));
  nand3  g50(.a(x10), .b(x08), .c(x07), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n45_), .c(x12), .O(new_n94_));
