...
module FAU ( 
  ...
  nand2  g19(.a(new_n43_), .b(new_n48_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n53_), .b(new_n62_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nor2   g23(.a(new_n52_), .b(new_n64_), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n53_), .O(z09));
  inv1   g26(.a(z09), .O(z10));
  nor2   g27(.a(new_n52_), .b(new_n45_), .O(z11));
  inv1   g28(.a(x12), .O(new_n70_));
  aoi21  g29(.a(x10), .b(x08), .c(x20), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(x15), .c(x13), .O(new_n72_));
  nand3  g31(.a(new_n43_), .b(new_n48_), .c(x10), .O(new_n73_));
  ...
  nand4  g45(.a(new_n49_), .b(x16), .c(new_n45_), .d(x12), .O(new_n87_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n70_), .O(z16));
  oai21  g50(.a(new_n71_), .b(x15), .c(x18), .O(new_n92_));
  nand3  g51(.a(new_n74_), .b(x08), .c(x05), .O(new_n93_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n70_), .O(z19));
endmodule
