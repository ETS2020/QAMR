...
module FAU ( 
  ...
  aoi21  g33(.a(new_n75_), .b(new_n45_), .c(new_n74_), .O(z14));
  nand3  g34(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n77_));
  nand3  g35(.a(x10), .b(x08), .c(x03), .O(new_n78_));
  and2   g36(.a(new_n78_), .b(new_n45_), .O(new_n79_));
  aoi21  g37(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(z15));
