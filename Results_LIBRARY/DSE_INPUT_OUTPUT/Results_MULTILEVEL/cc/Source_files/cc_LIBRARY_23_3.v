...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n58_, new_n61_, new_n65_, new_n66_,
  ...
  aoi21  g30(.a(new_n72_), .b(new_n46_), .c(new_n45_), .O(z14));
  nand3  g31(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n74_));
  nand3  g32(.a(x10), .b(x08), .c(x03), .O(new_n75_));
  and2   g33(.a(new_n75_), .b(new_n46_), .O(new_n76_));
  aoi21  g34(.a(new_n76_), .b(new_n74_), .c(new_n45_), .O(z15));
  nand2  g35(.a(new_n51_), .b(x17), .O(new_n78_));
  nand3  g36(.a(x10), .b(x08), .c(x04), .O(new_n79_));
  and2   g37(.a(new_n79_), .b(new_n46_), .O(new_n80_));
  aoi21  g38(.a(new_n80_), .b(new_n78_), .c(new_n45_), .O(z16));
  nand2  g39(.a(new_n51_), .b(x18), .O(new_n82_));
  nand3  g40(.a(x10), .b(x08), .c(x05), .O(new_n83_));
  and2   g41(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  aoi21  g42(.a(new_n84_), .b(new_n82_), .c(new_n45_), .O(z17));
  nand2  g43(.a(new_n51_), .b(x19), .O(new_n86_));
  nand3  g44(.a(x10), .b(x08), .c(x06), .O(new_n87_));
  and2   g45(.a(new_n87_), .b(new_n46_), .O(new_n88_));
  aoi21  g46(.a(new_n88_), .b(new_n86_), .c(new_n45_), .O(z18));
  nand2  g47(.a(new_n51_), .b(x20), .O(new_n90_));
  nand3  g48(.a(x10), .b(x08), .c(x07), .O(new_n91_));
