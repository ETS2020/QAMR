...
module FAU ( 
  ...
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(new_n74_));
  nand3  g33(.a(x10), .b(x08), .c(x01), .O(new_n75_));
  aoi22  g34(.a(new_n75_), .b(x14), .c(new_n74_), .d(x15), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n56_), .c(new_n44_), .O(z13));
  nand4  g36(.a(new_n51_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  oai21  g37(.a(new_n48_), .b(new_n51_), .c(new_n78_), .O(new_n79_));
  ...
  nand4  g43(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n85_));
  ...
  nand3  g48(.a(new_n52_), .b(x17), .c(x12), .O(new_n90_));
  ...
  nand3  g53(.a(new_n52_), .b(x18), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z17));
  nand2  g55(.a(new_n47_), .b(x19), .O(new_n97_));
  nand4  g56(.a(new_n51_), .b(x10), .c(x08), .d(x06), .O(new_n98_));
  ...
  nand2  g61(.a(new_n47_), .b(x20), .O(new_n103_));
