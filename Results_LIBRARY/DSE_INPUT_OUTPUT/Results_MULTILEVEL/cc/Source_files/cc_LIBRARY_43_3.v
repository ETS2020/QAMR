...
module FAU ( 
  ...
  nor2   g29(.a(x18), .b(new_n46_), .O(new_n71_));
  ...
  nand2  g35(.a(new_n76_), .b(z04), .O(new_n77_));
  ...
  nand3  g55(.a(z04), .b(x17), .c(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n69_), .O(z16));
  inv1   g57(.a(x05), .O(new_n99_));
  aoi21  g58(.a(new_n47_), .b(z04), .c(new_n99_), .O(new_n100_));
  aoi21  g59(.a(x10), .b(x08), .c(z04), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n100_), .c(new_n46_), .O(new_n102_));
  nor2   g61(.a(new_n102_), .b(new_n69_), .O(z17));
  ...
  nand2  g65(.a(new_n106_), .b(new_n46_), .O(new_n107_));
  nand3  g66(.a(x19), .b(z04), .c(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n69_), .O(z18));
  oai21  g68(.a(new_n43_), .b(new_n69_), .c(z04), .O(new_n110_));
