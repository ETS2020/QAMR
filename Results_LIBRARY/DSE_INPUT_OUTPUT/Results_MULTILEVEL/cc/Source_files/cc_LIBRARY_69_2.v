...
module FAU ( 
  ...
  nor3   g28(.a(new_n69_), .b(new_n43_), .c(new_n57_), .O(z13));
  ...
  aoi21  g33(.a(new_n59_), .b(x15), .c(new_n57_), .O(z16));
  nand3  g34(.a(x18), .b(x15), .c(x12), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z17));
  aoi21  g36(.a(new_n55_), .b(x15), .c(new_n57_), .O(z18));
