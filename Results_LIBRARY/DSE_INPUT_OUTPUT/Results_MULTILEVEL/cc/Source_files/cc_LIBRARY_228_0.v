...
module FAU ( 
  ...
  oai21  g30(.a(new_n47_), .b(new_n71_), .c(x12), .O(new_n72_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n97_), .c(new_n76_), .O(z17));
  nand2  g60(.a(new_n53_), .b(x19), .O(new_n102_));
  nand3  g61(.a(new_n99_), .b(x08), .c(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n76_), .O(z18));
  nand2  g63(.a(new_n53_), .b(x20), .O(new_n105_));
  nand3  g64(.a(new_n99_), .b(x08), .c(x07), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n76_), .O(z19));
  buf    g66(.a(x15), .O(z06));
endmodule
