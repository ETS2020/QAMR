...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n53_, new_n54_, new_n57_, new_n60_, new_n62_, new_n64_,
  ...
  aoi21  g10(.a(new_n51_), .b(x15), .c(x11), .O(z02));
  inv1   g11(.a(x12), .O(new_n53_));
  inv1   g12(.a(x15), .O(new_n54_));
  nor4   g13(.a(new_n47_), .b(new_n54_), .c(x14), .d(new_n53_), .O(z03));
  nand2  g14(.a(new_n44_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  nor2   g16(.a(new_n43_), .b(new_n57_), .O(z05));
  nand2  g17(.a(new_n54_), .b(x11), .O(z06));
  ...
  nand2  g28(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  nand3  g29(.a(new_n54_), .b(x10), .c(x08), .O(new_n71_));
  ...
  nand3  g34(.a(new_n75_), .b(x14), .c(x11), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n53_), .O(z13));
  nand4  g36(.a(new_n54_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  oai21  g37(.a(new_n48_), .b(new_n54_), .c(new_n78_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n44_), .O(z14));
  nand3  g40(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n82_));
  nand4  g41(.a(new_n54_), .b(x10), .c(x08), .d(x03), .O(new_n83_));
