...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(x05), .c(new_n43_), .O(z03));
  nor2   g14(.a(new_n44_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  oai21  g16(.a(new_n43_), .b(x05), .c(new_n57_), .O(z05));
  nand2  g17(.a(x15), .b(x05), .O(new_n59_));
  ...
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n70_), .O(z12));
  nand2  g37(.a(new_n71_), .b(new_n49_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x15), .c(x05), .O(new_n80_));
  nand3  g39(.a(x10), .b(x08), .c(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n43_), .c(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n70_), .O(z13));
  nand2  g42(.a(new_n71_), .b(x15), .O(new_n84_));
  nand4  g43(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n45_), .O(z14));
  nand3  g47(.a(new_n73_), .b(x16), .c(new_n49_), .O(new_n89_));
  nand3  g48(.a(new_n76_), .b(x08), .c(x03), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n70_), .O(z15));
  oai21  g50(.a(new_n61_), .b(new_n70_), .c(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x15), .O(new_n93_));
  nand2  g52(.a(new_n71_), .b(x17), .O(new_n94_));
  nand4  g53(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n95_));
  ...
  nand2  g58(.a(new_n50_), .b(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x05), .O(new_n101_));
  nand3  g60(.a(new_n71_), .b(x18), .c(new_n43_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n70_), .O(z17));
  oai21  g62(.a(new_n57_), .b(new_n70_), .c(x05), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x15), .O(new_n105_));
  nand2  g64(.a(new_n71_), .b(x19), .O(new_n106_));
  nand4  g65(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n107_));
  ...
  nand3  g73(.a(x20), .b(x15), .c(x05), .O(new_n115_));
