...
module FAU ( 
  ...
  nand3  g42(.a(new_n55_), .b(x16), .c(new_n47_), .O(new_n84_));
  ...
  nand2  g53(.a(new_n55_), .b(x18), .O(new_n95_));
  nand4  g54(.a(new_n50_), .b(x10), .c(x08), .d(x05), .O(new_n96_));
  ...
  aoi21  g59(.a(new_n55_), .b(new_n43_), .c(x15), .O(new_n101_));
  nor3   g60(.a(new_n101_), .b(new_n59_), .c(new_n75_), .O(z18));
  nand2  g61(.a(new_n55_), .b(x20), .O(new_n103_));
  nand4  g62(.a(new_n50_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n75_), .O(z19));
endmodule
