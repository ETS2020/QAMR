...
module FAU ( 
  ...
  oai21  g16(.a(new_n46_), .b(new_n45_), .c(new_n57_), .O(z05));
  nor2   g17(.a(new_n46_), .b(x12), .O(z06));
  and2   g18(.a(new_n43_), .b(x17), .O(z07));
  and2   g19(.a(new_n43_), .b(x16), .O(z08));
  nand3  g20(.a(new_n43_), .b(x09), .c(x08), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(z09));
  aoi21  g22(.a(x09), .b(x08), .c(z03), .O(z10));
  nand2  g23(.a(new_n43_), .b(new_n47_), .O(z11));
  nand2  g24(.a(new_n51_), .b(x13), .O(new_n66_));
  nand3  g25(.a(x10), .b(x08), .c(x00), .O(new_n67_));
  and2   g26(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n45_), .O(z12));
  nand3  g28(.a(x10), .b(x08), .c(x01), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n46_), .c(x14), .d(x12), .O(new_n71_));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n45_), .O(z16));
