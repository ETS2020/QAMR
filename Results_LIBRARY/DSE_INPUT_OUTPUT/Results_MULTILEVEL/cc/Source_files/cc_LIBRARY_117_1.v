...
module FAU ( 
  ...
  nor4   g07(.a(new_n48_), .b(new_n44_), .c(x14), .d(new_n47_), .O(z01));
  ...
  nand2  g30(.a(new_n51_), .b(new_n47_), .O(new_n72_));
  ...
  nand3  g40(.a(new_n48_), .b(x15), .c(x13), .O(new_n82_));
  inv1   g41(.a(x10), .O(new_n83_));
  nor2   g42(.a(x15), .b(new_n83_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n71_), .O(z14));
  nand2  g45(.a(new_n48_), .b(new_n44_), .O(new_n87_));
  nand2  g46(.a(x15), .b(x13), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x16), .c(new_n55_), .O(new_n90_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(x13), .O(new_n97_));
  ...
  nand3  g69(.a(x19), .b(x15), .c(x13), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n71_), .O(z18));
  oai21  g71(.a(new_n43_), .b(new_n71_), .c(x13), .O(new_n113_));
