...
module FAU ( 
  ...
  nand2  g11(.a(x20), .b(new_n44_), .O(new_n53_));
  ...
  oai21  g16(.a(new_n57_), .b(new_n51_), .c(new_n45_), .O(z03));
  nand2  g17(.a(new_n45_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nand2  g19(.a(new_n45_), .b(new_n60_), .O(z05));
  nand2  g20(.a(x20), .b(new_n44_), .O(z06));
  ...
  nand2  g29(.a(new_n51_), .b(x20), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n44_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x13), .O(new_n73_));
  nand3  g32(.a(x20), .b(new_n44_), .c(x10), .O(new_n74_));
  ...
  nand3  g46(.a(new_n44_), .b(x10), .c(x08), .O(new_n88_));
