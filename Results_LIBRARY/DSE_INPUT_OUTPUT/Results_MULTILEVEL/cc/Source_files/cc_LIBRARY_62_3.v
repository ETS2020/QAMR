...
module FAU ( 
  ...
  aoi21  g26(.a(new_n51_), .b(x00), .c(x15), .O(new_n68_));
  ...
  nand3  g33(.a(new_n66_), .b(x16), .c(new_n47_), .O(new_n75_));
  ...
  nand2  g38(.a(new_n66_), .b(x17), .O(new_n80_));
  ...
  nand2  g43(.a(new_n66_), .b(x18), .O(new_n85_));
  aoi21  g44(.a(new_n51_), .b(x05), .c(x15), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n45_), .O(z17));
  nand2  g46(.a(new_n66_), .b(x19), .O(new_n88_));
  ...
  nand2  g51(.a(new_n66_), .b(x20), .O(new_n93_));
