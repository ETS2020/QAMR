...
module FAU ( 
  ...
  oai21  g29(.a(new_n64_), .b(new_n70_), .c(x14), .O(new_n71_));
  ...
  nand3  g33(.a(new_n64_), .b(x16), .c(new_n47_), .O(new_n75_));
  ...
  nand2  g38(.a(new_n64_), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n51_), .b(x04), .c(x15), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(z16));
  ...
  nand2  g51(.a(new_n64_), .b(x20), .O(new_n93_));
