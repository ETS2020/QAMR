...
module FAU ( 
  ...
  nor2   g05(.a(x12), .b(new_n46_), .O(new_n47_));
  inv1   g06(.a(new_n47_), .O(new_n48_));
  nand4  g07(.a(new_n48_), .b(x15), .c(new_n45_), .d(x10), .O(new_n49_));
  nor2   g08(.a(new_n49_), .b(new_n44_), .O(z01));
  inv1   g09(.a(x15), .O(new_n51_));
  nand3  g10(.a(new_n51_), .b(x10), .c(x08), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(new_n45_), .O(new_n53_));
  nand3  g12(.a(new_n53_), .b(x12), .c(new_n46_), .O(new_n54_));
  ...
  nor3   g26(.a(new_n47_), .b(new_n67_), .c(new_n44_), .O(z09));
  aoi21  g27(.a(x09), .b(x08), .c(new_n47_), .O(z10));
  nor2   g28(.a(new_n47_), .b(new_n45_), .O(z11));
  ...
  nand2  g47(.a(new_n88_), .b(new_n48_), .O(z15));
