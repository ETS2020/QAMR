...
module FAU ( 
  ...
  nor4   g04(.a(new_n45_), .b(new_n42_), .c(x14), .d(x11), .O(z01));
  inv1   g05(.a(x11), .O(new_n47_));
  inv1   g06(.a(x14), .O(new_n48_));
  nand3  g07(.a(new_n42_), .b(x10), .c(x08), .O(new_n49_));
  nand2  g08(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand3  g09(.a(new_n50_), .b(x12), .c(new_n47_), .O(new_n51_));
  nand2  g10(.a(x15), .b(x11), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(new_n51_), .O(z02));
  inv1   g12(.a(new_n45_), .O(new_n54_));
  nand3  g13(.a(new_n54_), .b(new_n48_), .c(x12), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n47_), .c(new_n42_), .O(z03));
  aoi21  g15(.a(x15), .b(x11), .c(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  aoi21  g17(.a(x15), .b(x11), .c(new_n58_), .O(z05));
  nor2   g18(.a(new_n42_), .b(x11), .O(z06));
  inv1   g19(.a(x17), .O(new_n61_));
  nand2  g20(.a(new_n52_), .b(new_n61_), .O(z07));
  inv1   g21(.a(x16), .O(new_n63_));
  nand2  g22(.a(new_n52_), .b(new_n63_), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n52_), .O(z09));
  nand3  g25(.a(new_n52_), .b(x09), .c(x08), .O(z10));
  nand2  g26(.a(new_n52_), .b(new_n48_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  aoi21  g28(.a(x10), .b(x08), .c(x15), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(z06), .c(x13), .O(new_n71_));
  inv1   g30(.a(x10), .O(new_n72_));
  nor2   g31(.a(x15), .b(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x08), .c(x00), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n71_), .c(new_n69_), .O(z12));
  nand3  g34(.a(x12), .b(x10), .c(x08), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n47_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x15), .O(new_n78_));
  nand2  g37(.a(new_n54_), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x14), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n78_), .O(z13));
  nand3  g40(.a(new_n45_), .b(x15), .c(new_n47_), .O(new_n82_));
  nand3  g41(.a(new_n73_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n69_), .O(z14));
  ...
  nand3  g46(.a(new_n45_), .b(x16), .c(new_n48_), .O(new_n88_));
  ...
  oai21  g51(.a(new_n61_), .b(new_n69_), .c(new_n47_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x15), .O(new_n94_));
  nand2  g53(.a(new_n45_), .b(x17), .O(new_n95_));
  nand4  g54(.a(new_n42_), .b(x10), .c(x08), .d(x04), .O(new_n96_));
  ...
  oai21  g66(.a(new_n58_), .b(new_n69_), .c(new_n47_), .O(new_n108_));
  ...
  nand2  g76(.a(new_n45_), .b(x20), .O(new_n118_));
