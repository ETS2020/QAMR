...
module FAU ( 
  ...
  nand2  g27(.a(new_n68_), .b(new_n46_), .O(new_n69_));
  ...
  oai21  g32(.a(new_n73_), .b(new_n52_), .c(new_n72_), .O(new_n74_));
  ...
  nand2  g37(.a(new_n71_), .b(new_n78_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x15), .c(new_n46_), .O(new_n80_));
  ...
  nand3  g42(.a(new_n71_), .b(x15), .c(new_n46_), .O(new_n84_));
  ...
  nand2  g62(.a(new_n71_), .b(x18), .O(new_n104_));
  ...
  oai21  g67(.a(new_n59_), .b(new_n77_), .c(new_n46_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n71_), .b(x19), .O(new_n111_));
  ...
  nand3  g78(.a(x20), .b(x15), .c(new_n46_), .O(new_n120_));
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n77_), .O(z19));
  buf    g80(.a(x15), .O(z06));
endmodule
