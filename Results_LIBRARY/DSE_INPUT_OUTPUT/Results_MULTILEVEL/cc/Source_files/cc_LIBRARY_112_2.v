...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x20), .c(new_n46_), .O(z01));
  ...
  nand4  g14(.a(new_n55_), .b(x20), .c(x15), .d(new_n47_), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  aoi21  g18(.a(new_n43_), .b(x15), .c(new_n59_), .O(z05));
  nor2   g19(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  aoi21  g27(.a(new_n43_), .b(x15), .c(new_n47_), .O(z11));
  ...
  oai21  g56(.a(new_n62_), .b(new_n79_), .c(x20), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n73_), .b(x17), .O(new_n100_));
  nand4  g59(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n101_));
  ...
  nand3  g67(.a(x20), .b(x18), .c(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n79_), .O(z17));
  oai21  g69(.a(new_n59_), .b(new_n79_), .c(x20), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n73_), .b(x19), .O(new_n113_));
  nand4  g72(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n114_));
  ...
  nand2  g76(.a(new_n50_), .b(new_n43_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x07), .O(new_n119_));
  nand2  g78(.a(new_n50_), .b(x20), .O(new_n120_));
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n79_), .O(z19));
endmodule
