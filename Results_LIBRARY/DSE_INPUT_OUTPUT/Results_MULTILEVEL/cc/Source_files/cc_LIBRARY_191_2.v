...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(x17), .c(new_n48_), .O(z01));
  ...
  nand3  g47(.a(new_n56_), .b(x16), .c(new_n49_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n52_), .b(new_n44_), .O(new_n94_));
  ...
  nand2  g59(.a(new_n56_), .b(x18), .O(new_n101_));
