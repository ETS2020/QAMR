...
module FAU ( 
  ...
  nand4  g12(.a(new_n53_), .b(x18), .c(x12), .d(new_n42_), .O(new_n54_));
  inv1   g13(.a(new_n54_), .O(z02));
  aoi21  g14(.a(new_n49_), .b(x18), .c(new_n44_), .O(z03));
  nor2   g15(.a(x18), .b(x12), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nor2   g17(.a(new_n45_), .b(new_n58_), .O(z05));
  nor2   g18(.a(new_n45_), .b(new_n51_), .O(z06));
  ...
  nand3  g31(.a(new_n72_), .b(x18), .c(x12), .O(new_n73_));
  ...
  nor2   g38(.a(new_n51_), .b(new_n79_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x08), .c(new_n78_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n77_), .c(new_n44_), .O(z13));
  nand2  g41(.a(new_n76_), .b(x15), .O(new_n83_));
  nand4  g42(.a(new_n51_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(x18), .O(new_n85_));
  and2   g44(.a(new_n85_), .b(x12), .O(z14));
  nand3  g45(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n87_));
  nor2   g46(.a(x15), .b(new_n79_), .O(new_n88_));
  and2   g47(.a(x08), .b(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n78_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n87_), .c(new_n44_), .O(z15));
  nand2  g50(.a(new_n52_), .b(x17), .O(new_n92_));
  and2   g51(.a(x08), .b(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n88_), .c(new_n78_), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n44_), .O(z16));
  nor2   g54(.a(new_n65_), .b(x05), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(x18), .c(x12), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  nand2  g58(.a(new_n52_), .b(x19), .O(new_n100_));
  nand4  g59(.a(new_n51_), .b(x10), .c(x08), .d(x06), .O(new_n101_));
  ...
  nand3  g66(.a(new_n107_), .b(x18), .c(x12), .O(new_n108_));
