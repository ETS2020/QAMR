...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(new_n47_), .c(x00), .O(new_n54_));
  ...
  aoi21  g32(.a(new_n48_), .b(new_n44_), .c(x15), .O(new_n74_));
  nor3   g33(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z12));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n72_), .O(z13));
  nand2  g38(.a(new_n52_), .b(x10), .O(new_n80_));
  nand2  g39(.a(x08), .b(x02), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n80_), .c(new_n49_), .d(new_n52_), .O(new_n82_));
  ...
  oai22  g60(.a(new_n101_), .b(new_n80_), .c(new_n49_), .d(new_n62_), .O(new_n102_));
  ...
  oai22  g65(.a(new_n106_), .b(new_n80_), .c(new_n49_), .d(new_n43_), .O(new_n107_));
