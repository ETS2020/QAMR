...
module FAU ( 
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n55_));
  nor3   g14(.a(new_n55_), .b(new_n44_), .c(x14), .O(z03));
  nor2   g15(.a(new_n45_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  oai21  g17(.a(new_n44_), .b(x03), .c(new_n58_), .O(z05));
  and2   g18(.a(x15), .b(x03), .O(z06));
  ...
  nand2  g37(.a(new_n78_), .b(x03), .O(new_n79_));
  ...
  nand3  g43(.a(new_n72_), .b(x15), .c(x03), .O(new_n85_));
  ...
  nand4  g49(.a(new_n72_), .b(x16), .c(new_n44_), .d(new_n47_), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n84_), .O(z15));
  oai21  g51(.a(new_n61_), .b(new_n84_), .c(x03), .O(new_n93_));
  ...
  nand3  g70(.a(x19), .b(x15), .c(x03), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n84_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n84_), .c(x03), .O(new_n114_));
