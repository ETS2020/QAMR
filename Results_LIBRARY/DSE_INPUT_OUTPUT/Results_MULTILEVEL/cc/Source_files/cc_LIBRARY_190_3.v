...
module FAU ( 
  ...
  aoi21  g39(.a(new_n51_), .b(x04), .c(x15), .O(new_n82_));
  aoi21  g40(.a(new_n82_), .b(new_n81_), .c(new_n45_), .O(z16));
  nand2  g41(.a(new_n67_), .b(x18), .O(new_n84_));
  ...
  aoi21  g47(.a(new_n51_), .b(x06), .c(x15), .O(new_n90_));
  aoi21  g48(.a(new_n90_), .b(new_n89_), .c(new_n45_), .O(z18));
  nand2  g49(.a(new_n67_), .b(x20), .O(new_n92_));
