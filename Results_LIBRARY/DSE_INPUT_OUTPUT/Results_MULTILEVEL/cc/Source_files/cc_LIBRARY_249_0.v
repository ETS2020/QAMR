...
module FAU ( 
  ...
  nand2  g33(.a(new_n48_), .b(new_n49_), .O(new_n75_));
  ...
  nand2  g43(.a(new_n84_), .b(x09), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n44_), .O(new_n86_));
  nand4  g45(.a(new_n52_), .b(x16), .c(new_n49_), .d(x12), .O(new_n87_));
  ...
  nand4  g53(.a(new_n44_), .b(x10), .c(x08), .d(x05), .O(new_n95_));
  ...
  nand4  g59(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n101_));
  ...
  nand2  g67(.a(new_n108_), .b(x09), .O(new_n109_));
  nand2  g68(.a(x20), .b(x15), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n74_), .O(z19));
endmodule
