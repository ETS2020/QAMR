...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(new_n47_), .c(x13), .O(new_n54_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n44_), .c(x10), .O(new_n75_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n73_), .c(new_n58_), .O(z13));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n73_), .O(z16));
  ...
  oai21  g61(.a(new_n49_), .b(new_n62_), .c(new_n102_), .O(new_n103_));
