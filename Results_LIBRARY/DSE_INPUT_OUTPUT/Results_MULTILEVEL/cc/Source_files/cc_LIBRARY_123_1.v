...
module FAU ( 
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x04), .O(new_n55_));
  nor3   g14(.a(new_n55_), .b(new_n44_), .c(x14), .O(z03));
  nand2  g15(.a(new_n50_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  oai21  g17(.a(new_n44_), .b(x04), .c(new_n58_), .O(z05));
  nand2  g18(.a(x15), .b(x04), .O(new_n60_));
  ...
  nand3  g26(.a(new_n50_), .b(x09), .c(x08), .O(z10));
  ...
  oai21  g31(.a(new_n72_), .b(x15), .c(new_n60_), .O(new_n73_));
  ...
  aoi21  g49(.a(new_n51_), .b(new_n62_), .c(new_n90_), .O(new_n91_));
  and2   g50(.a(new_n51_), .b(x17), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n50_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand2  g54(.a(new_n71_), .b(x18), .O(new_n96_));
  oai21  g55(.a(new_n71_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(new_n98_));
  nand3  g57(.a(x18), .b(x15), .c(x04), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n70_), .O(z17));
  oai21  g59(.a(new_n58_), .b(new_n70_), .c(x04), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x15), .O(new_n102_));
  nand2  g61(.a(new_n71_), .b(x19), .O(new_n103_));
  nand3  g62(.a(new_n76_), .b(x08), .c(x06), .O(new_n104_));
  ...
  nand2  g67(.a(new_n71_), .b(x20), .O(new_n109_));
  oai21  g68(.a(new_n71_), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n44_), .O(new_n111_));
  nand3  g70(.a(x20), .b(x15), .c(x04), .O(new_n112_));
