...
module FAU ( 
  ...
  nand2  g29(.a(x15), .b(x02), .O(new_n71_));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n73_), .c(new_n68_), .O(z12));
  nand3  g36(.a(x12), .b(x10), .c(x08), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x02), .O(new_n79_));
  ...
  nand2  g42(.a(new_n69_), .b(x15), .O(new_n84_));
  ...
  oai21  g49(.a(new_n60_), .b(new_n68_), .c(x02), .O(new_n91_));
  ...
  nand3  g60(.a(x18), .b(x15), .c(x02), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n68_), .O(z17));
  oai21  g62(.a(new_n58_), .b(new_n68_), .c(x02), .O(new_n104_));
  ...
  nand3  g73(.a(x20), .b(x15), .c(x02), .O(new_n115_));
