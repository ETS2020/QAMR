...
module FAU ( 
  ...
  nand2  g36(.a(new_n46_), .b(new_n47_), .O(new_n78_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n77_), .O(z14));
  ...
  oai21  g50(.a(new_n46_), .b(new_n91_), .c(x12), .O(new_n92_));
  ...
  nand3  g55(.a(new_n85_), .b(x08), .c(x05), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n77_), .O(z17));
  nand2  g57(.a(new_n53_), .b(x19), .O(new_n99_));
  nand3  g58(.a(new_n85_), .b(x08), .c(x06), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n77_), .O(z18));
  nand2  g60(.a(new_n53_), .b(x20), .O(new_n102_));
  nand3  g61(.a(new_n85_), .b(x08), .c(x07), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n77_), .O(z19));
endmodule
