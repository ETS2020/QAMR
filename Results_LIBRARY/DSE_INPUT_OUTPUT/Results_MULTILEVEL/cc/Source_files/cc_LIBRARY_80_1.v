...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n59_, new_n61_, new_n62_,
  ...
  oai21  g15(.a(new_n46_), .b(x12), .c(new_n56_), .O(z05));
  ...
  nor2   g26(.a(new_n62_), .b(new_n47_), .O(z11));
  ...
  oai21  g43(.a(new_n61_), .b(x14), .c(x12), .O(new_n85_));
  ...
  nand2  g56(.a(new_n51_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n71_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z18));
  oai21  g59(.a(x20), .b(new_n43_), .c(x15), .O(new_n101_));
  nand2  g60(.a(new_n74_), .b(x20), .O(new_n102_));
  nand4  g61(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n103_));
  ...
  aoi21  g65(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
endmodule
