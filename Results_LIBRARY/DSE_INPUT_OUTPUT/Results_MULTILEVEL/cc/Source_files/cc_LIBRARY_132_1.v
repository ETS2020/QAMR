...
module FAU ( 
  ...
  oai21  g18(.a(new_n46_), .b(x12), .c(new_n59_), .O(z05));
  ...
  nand4  g51(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n93_));
  ...
  nand4  g57(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n99_));
  ...
  nand3  g62(.a(new_n72_), .b(x08), .c(x07), .O(new_n104_));
