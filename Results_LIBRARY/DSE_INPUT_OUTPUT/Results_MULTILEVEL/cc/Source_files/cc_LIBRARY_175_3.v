...
module FAU ( 
  ...
  and2   g13(.a(new_n43_), .b(x19), .O(z05));
  inv1   g14(.a(x17), .O(new_n57_));
  nand2  g15(.a(new_n43_), .b(new_n57_), .O(z07));
  and2   g16(.a(new_n43_), .b(x16), .O(z08));
  nand2  g17(.a(x09), .b(x08), .O(new_n60_));
  nand2  g18(.a(new_n60_), .b(new_n43_), .O(z09));
  nand3  g19(.a(new_n43_), .b(x09), .c(x08), .O(z10));
  aoi21  g20(.a(x15), .b(x12), .c(new_n50_), .O(z11));
  nand2  g21(.a(new_n46_), .b(x13), .O(new_n64_));
  nand3  g22(.a(x10), .b(x08), .c(x00), .O(new_n65_));
  and2   g23(.a(new_n65_), .b(new_n45_), .O(new_n66_));
  aoi21  g24(.a(new_n66_), .b(new_n64_), .c(new_n48_), .O(z12));
  nand3  g25(.a(x10), .b(x08), .c(x01), .O(new_n68_));
  nand4  g26(.a(new_n68_), .b(new_n45_), .c(x14), .d(x12), .O(new_n69_));
  inv1   g27(.a(new_n69_), .O(z13));
  nand4  g28(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n71_));
  nor2   g29(.a(new_n71_), .b(x15), .O(z14));
  nand3  g30(.a(new_n46_), .b(x16), .c(new_n50_), .O(new_n73_));
  nand3  g31(.a(x10), .b(x08), .c(x03), .O(new_n74_));
  and2   g32(.a(new_n74_), .b(new_n45_), .O(new_n75_));
  aoi21  g33(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z15));
  nand2  g34(.a(new_n46_), .b(x17), .O(new_n77_));
  nand3  g35(.a(x10), .b(x08), .c(x04), .O(new_n78_));
  nand2  g36(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g37(.a(new_n79_), .b(new_n45_), .c(x12), .O(new_n80_));
  inv1   g38(.a(new_n80_), .O(z16));
  nand2  g39(.a(new_n46_), .b(x18), .O(new_n82_));
  nand3  g40(.a(x10), .b(x08), .c(x05), .O(new_n83_));
  and2   g41(.a(new_n83_), .b(new_n45_), .O(new_n84_));
  aoi21  g42(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(z17));
  nand2  g43(.a(new_n46_), .b(x19), .O(new_n86_));
  nand3  g44(.a(x10), .b(x08), .c(x06), .O(new_n87_));
  nand2  g45(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g46(.a(new_n88_), .b(new_n45_), .c(x12), .O(new_n89_));
  ...
  aoi21  g51(.a(new_n93_), .b(new_n91_), .c(new_n48_), .O(z19));
  zero   g52(.O(z03));
  buf    g53(.a(x15), .O(z06));
endmodule
