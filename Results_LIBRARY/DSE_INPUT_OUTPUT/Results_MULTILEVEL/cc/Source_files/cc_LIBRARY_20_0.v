...
module FAU ( 
  ...
  nand2  g19(.a(new_n51_), .b(x10), .O(z06));
  ...
  nand2  g50(.a(x12), .b(x08), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(x10), .O(new_n93_));
  ...
  oai21  g56(.a(new_n92_), .b(new_n97_), .c(x10), .O(new_n98_));
  ...
  oai21  g61(.a(new_n92_), .b(new_n102_), .c(x10), .O(new_n103_));
  ...
  oai21  g66(.a(new_n92_), .b(new_n107_), .c(x10), .O(new_n108_));
