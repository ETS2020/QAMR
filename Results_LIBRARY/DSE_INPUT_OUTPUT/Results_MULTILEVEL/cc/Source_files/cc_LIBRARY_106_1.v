...
module FAU ( 
  ...
  oai21  g08(.a(new_n43_), .b(x04), .c(x14), .O(new_n50_));
  ...
  aoi21  g17(.a(new_n58_), .b(x04), .c(new_n43_), .O(z03));
  ...
  and2   g31(.a(x15), .b(x04), .O(new_n73_));
  ...
  nand3  g46(.a(x16), .b(new_n55_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x04), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand3  g49(.a(new_n56_), .b(x16), .c(new_n55_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n51_), .b(new_n63_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x04), .O(new_n97_));
  nand3  g56(.a(new_n56_), .b(x17), .c(new_n43_), .O(new_n98_));
  ...
  oai21  g66(.a(new_n61_), .b(new_n71_), .c(x04), .O(new_n108_));
  ...
  nand2  g73(.a(new_n56_), .b(x20), .O(new_n115_));
  ...
  nand3  g77(.a(x20), .b(x15), .c(x04), .O(new_n119_));
