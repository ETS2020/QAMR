...
module FAU ( 
  ...
  oai21  g46(.a(x17), .b(new_n55_), .c(x15), .O(new_n88_));
  nand2  g47(.a(new_n56_), .b(x17), .O(new_n89_));
  nand4  g48(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n88_), .O(z16));
  oai21  g52(.a(x18), .b(new_n55_), .c(x15), .O(new_n94_));
  nand2  g53(.a(new_n56_), .b(x18), .O(new_n95_));
  nand4  g54(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n96_));
  ...
  nand3  g59(.a(new_n82_), .b(x08), .c(x06), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n55_), .O(z18));
