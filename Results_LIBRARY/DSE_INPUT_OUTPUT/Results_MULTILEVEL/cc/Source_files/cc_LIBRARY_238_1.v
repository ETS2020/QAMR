...
module FAU ( 
  ...
  nand2  g19(.a(x17), .b(x15), .O(new_n61_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n56_), .c(new_n45_), .O(z13));
  nand2  g37(.a(new_n47_), .b(x15), .O(new_n79_));
  nor2   g38(.a(x17), .b(x15), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(x10), .c(x08), .d(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n56_), .O(z14));
  ...
  nand3  g44(.a(new_n80_), .b(x10), .c(x08), .O(new_n86_));
  nand4  g45(.a(new_n86_), .b(x16), .c(new_n48_), .d(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n85_), .O(z15));
  nand4  g47(.a(new_n80_), .b(x10), .c(x08), .d(x04), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n61_), .c(new_n56_), .O(z16));
  ...
  nand2  g54(.a(new_n47_), .b(x19), .O(new_n96_));
  nand4  g55(.a(new_n51_), .b(x10), .c(x08), .d(x06), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n43_), .O(new_n99_));
  nand2  g58(.a(x19), .b(x15), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n56_), .O(z18));
