...
module FAU ( 
  ...
  aoi21  g25(.a(x09), .b(x08), .c(new_n66_), .O(z10));
  nor2   g26(.a(new_n66_), .b(new_n50_), .O(z11));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n92_), .c(new_n43_), .O(z16));
  ...
  nor4   g70(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
