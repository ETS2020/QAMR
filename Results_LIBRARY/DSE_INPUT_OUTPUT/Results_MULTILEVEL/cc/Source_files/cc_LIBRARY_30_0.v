...
module FAU ( 
  ...
  nand2  g19(.a(new_n51_), .b(x01), .O(z06));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n71_), .O(z13));
  ...
  nand2  g47(.a(new_n88_), .b(x01), .O(new_n89_));
  ...
  nand3  g71(.a(new_n52_), .b(x20), .c(x12), .O(new_n113_));
