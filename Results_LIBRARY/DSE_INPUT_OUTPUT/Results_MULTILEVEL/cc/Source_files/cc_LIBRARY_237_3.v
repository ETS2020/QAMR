...
module FAU ( 
  ...
  oai21  g17(.a(new_n43_), .b(new_n42_), .c(new_n58_), .O(z05));
  nor2   g18(.a(new_n43_), .b(x05), .O(z06));
  ...
  nand2  g37(.a(new_n72_), .b(new_n50_), .O(new_n79_));
  ...
  nand3  g50(.a(new_n72_), .b(x16), .c(new_n50_), .O(new_n92_));
  ...
  nand3  g59(.a(x17), .b(x15), .c(new_n42_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n78_), .O(z16));
  nand3  g61(.a(x12), .b(x10), .c(x08), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n43_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x05), .O(new_n105_));
  nand3  g64(.a(new_n51_), .b(x18), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(z17));
  oai21  g66(.a(new_n58_), .b(new_n78_), .c(new_n42_), .O(new_n108_));
