...
module FAU ( 
  ...
  nand4  g14(.a(new_n55_), .b(x17), .c(x15), .d(new_n47_), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  oai21  g18(.a(x17), .b(new_n46_), .c(new_n59_), .O(z05));
  ...
  nand2  g47(.a(new_n71_), .b(new_n46_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(x16), .c(new_n47_), .O(new_n91_));
  nand4  g50(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n88_), .O(z15));
  nand2  g52(.a(new_n50_), .b(new_n43_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g54(.a(new_n50_), .b(x17), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n88_), .O(z16));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n88_), .O(z17));
  nand2  g62(.a(new_n71_), .b(x19), .O(new_n104_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n88_), .O(z18));
  nand2  g68(.a(new_n71_), .b(x20), .O(new_n110_));
  ...
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n88_), .O(z19));
  buf    g74(.a(x17), .O(z07));
endmodule
