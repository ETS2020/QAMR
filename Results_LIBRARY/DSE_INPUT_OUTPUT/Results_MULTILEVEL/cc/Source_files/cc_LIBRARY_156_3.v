...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n57_, new_n62_, new_n66_, new_n67_,
  ...
  nor2   g17(.a(new_n45_), .b(x07), .O(z06));
  ...
  aoi21  g23(.a(x15), .b(x07), .c(new_n49_), .O(z11));
  ...
  nand3  g47(.a(new_n69_), .b(x16), .c(new_n49_), .O(new_n89_));
  ...
  nand2  g53(.a(new_n69_), .b(x17), .O(new_n95_));
  ...
  nand3  g63(.a(x18), .b(x15), .c(new_n46_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n94_), .O(z17));
  oai21  g65(.a(new_n57_), .b(new_n94_), .c(new_n46_), .O(new_n107_));
  ...
  nand2  g72(.a(new_n69_), .b(x20), .O(new_n114_));
  ...
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n94_), .O(z19));
endmodule
