...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x13), .c(new_n46_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(new_n46_), .b(x13), .c(x14), .O(new_n51_));
  ...
  aoi21  g27(.a(x09), .b(x08), .c(new_n58_), .O(z10));
  ...
  nand3  g41(.a(new_n77_), .b(x15), .c(x13), .O(new_n83_));
  ...
  oai21  g52(.a(new_n62_), .b(new_n71_), .c(x13), .O(new_n94_));
  ...
  nand2  g60(.a(new_n101_), .b(x13), .O(new_n102_));
  ...
  nand2  g67(.a(new_n77_), .b(x19), .O(new_n109_));
  ...
  nand3  g71(.a(x19), .b(x15), .c(x13), .O(new_n113_));
  ...
  nand3  g77(.a(x20), .b(x15), .c(x13), .O(new_n119_));
