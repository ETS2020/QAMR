...
module FAU ( 
  ...
  oai21  g19(.a(new_n44_), .b(new_n43_), .c(new_n60_), .O(z05));
  nor2   g20(.a(new_n44_), .b(x05), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n46_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nand2  g24(.a(new_n46_), .b(new_n65_), .O(z08));
  nand3  g25(.a(new_n46_), .b(x09), .c(x08), .O(new_n67_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n53_), .c(new_n75_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x12), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n73_), .O(z12));
  inv1   g38(.a(x12), .O(new_n80_));
  nand2  g39(.a(new_n74_), .b(new_n48_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x15), .c(new_n43_), .O(new_n82_));
  ...
  nand3  g44(.a(new_n74_), .b(x15), .c(new_n43_), .O(new_n86_));
  nand4  g45(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n80_), .O(z14));
  ...
  nand3  g50(.a(new_n74_), .b(x16), .c(new_n48_), .O(new_n92_));
  ...
  nand3  g59(.a(x17), .b(x15), .c(new_n43_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n80_), .O(z16));
  nand2  g61(.a(new_n74_), .b(x18), .O(new_n103_));
  ...
  nand3  g65(.a(x18), .b(x15), .c(new_n43_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n80_), .O(z17));
  nand2  g67(.a(new_n74_), .b(x19), .O(new_n109_));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n80_), .O(z18));
  nand2  g73(.a(new_n74_), .b(x20), .O(new_n115_));
  ...
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n80_), .O(z19));
endmodule
