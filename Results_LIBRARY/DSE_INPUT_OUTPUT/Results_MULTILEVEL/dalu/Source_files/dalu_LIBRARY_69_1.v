...
module FAU ( 
  ...
  oai21  g395(.a(new_n102_), .b(x00), .c(new_n486_), .O(new_n487_));
  nand3  g396(.a(new_n487_), .b(x71), .c(new_n108_), .O(new_n488_));
  nand2  g397(.a(new_n305_), .b(new_n204_), .O(new_n489_));
  nand3  g398(.a(new_n489_), .b(new_n119_), .c(x32), .O(new_n490_));
  oai21  g399(.a(new_n119_), .b(x32), .c(new_n490_), .O(new_n491_));
  ...
  aoi21  g405(.a(new_n414_), .b(new_n413_), .c(x73), .O(new_n497_));
  oai21  g406(.a(new_n497_), .b(new_n458_), .c(x72), .O(new_n498_));
  aoi21  g407(.a(new_n417_), .b(new_n416_), .c(new_n213_), .O(new_n499_));
  ...
  aoi21  g415(.a(new_n506_), .b(new_n494_), .c(new_n93_), .O(new_n507_));
  nand2  g416(.a(new_n125_), .b(x23), .O(new_n508_));
  oai21  g417(.a(new_n125_), .b(new_n119_), .c(new_n508_), .O(new_n509_));
  nand2  g418(.a(new_n509_), .b(x70), .O(new_n510_));
  oai21  g419(.a(new_n109_), .b(new_n102_), .c(new_n510_), .O(new_n511_));
  nand4  g420(.a(new_n511_), .b(new_n137_), .c(new_n93_), .d(x64), .O(new_n512_));
  inv1   g421(.a(new_n512_), .O(new_n513_));
  oai21  g422(.a(new_n513_), .b(new_n507_), .c(new_n92_), .O(new_n514_));
  nand3  g423(.a(new_n503_), .b(new_n96_), .c(new_n125_), .O(new_n515_));
  nand4  g424(.a(new_n487_), .b(x71), .c(new_n151_), .d(new_n150_), .O(new_n516_));
  nand2  g425(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  nand2  g426(.a(new_n517_), .b(new_n108_), .O(new_n518_));
  inv1   g427(.a(new_n492_), .O(new_n519_));
  nand3  g428(.a(new_n519_), .b(new_n151_), .c(new_n150_), .O(new_n520_));
  nand2  g429(.a(new_n520_), .b(new_n518_), .O(new_n521_));
  nand4  g430(.a(new_n521_), .b(x68), .c(x65), .d(new_n94_), .O(new_n522_));
  aoi21  g431(.a(new_n522_), .b(new_n514_), .c(x69), .O(z07));
  nand2  g432(.a(new_n178_), .b(x00), .O(new_n524_));
  nand2  g433(.a(new_n524_), .b(x08), .O(new_n525_));
  nand3  g434(.a(new_n178_), .b(new_n103_), .c(x00), .O(new_n526_));
  aoi21  g435(.a(new_n526_), .b(new_n525_), .c(new_n125_), .O(new_n527_));
  nand2  g436(.a(new_n527_), .b(new_n108_), .O(new_n528_));
  nand2  g437(.a(new_n197_), .b(x32), .O(new_n529_));
  nand2  g438(.a(new_n529_), .b(x40), .O(new_n530_));
  nand3  g439(.a(new_n197_), .b(new_n120_), .c(x32), .O(new_n531_));
  ...
  nand2  g444(.a(new_n137_), .b(x40), .O(new_n536_));
  nand2  g445(.a(new_n216_), .b(x56), .O(new_n537_));
  oai21  g446(.a(new_n458_), .b(new_n371_), .c(x72), .O(new_n538_));
  nand2  g447(.a(x74), .b(x53), .O(new_n539_));
  nand2  g448(.a(new_n214_), .b(x54), .O(new_n540_));
  aoi21  g449(.a(new_n540_), .b(new_n539_), .c(new_n213_), .O(new_n541_));
  nand3  g450(.a(x74), .b(new_n213_), .c(x55), .O(new_n542_));
  ...
  nand3  g454(.a(new_n545_), .b(new_n151_), .c(new_n150_), .O(new_n546_));
  nand2  g455(.a(new_n546_), .b(new_n536_), .O(new_n547_));
  nand4  g456(.a(new_n547_), .b(new_n125_), .c(new_n108_), .d(x64), .O(new_n548_));
  aoi21  g457(.a(new_n548_), .b(new_n535_), .c(new_n93_), .O(new_n549_));
  ...
  oai21  g464(.a(new_n555_), .b(new_n549_), .c(new_n92_), .O(new_n556_));
  nand3  g465(.a(new_n527_), .b(new_n151_), .c(new_n150_), .O(new_n557_));
  nand3  g466(.a(new_n545_), .b(new_n96_), .c(new_n125_), .O(new_n558_));
  nand2  g467(.a(new_n558_), .b(new_n557_), .O(new_n559_));
  nand2  g468(.a(new_n559_), .b(new_n108_), .O(new_n560_));
  nand4  g469(.a(new_n532_), .b(x70), .c(new_n151_), .d(new_n150_), .O(new_n561_));
  nand2  g470(.a(new_n561_), .b(new_n560_), .O(new_n562_));
  nand4  g471(.a(new_n562_), .b(x68), .c(x65), .d(new_n94_), .O(new_n563_));
  aoi21  g472(.a(new_n563_), .b(new_n556_), .c(x69), .O(z08));
  and2   g473(.a(new_n293_), .b(x00), .O(new_n565_));
  nand3  g474(.a(new_n293_), .b(new_n176_), .c(x00), .O(new_n566_));
  oai21  g475(.a(new_n565_), .b(new_n176_), .c(new_n566_), .O(new_n567_));
  nand3  g476(.a(new_n567_), .b(x71), .c(new_n108_), .O(new_n568_));
  and2   g477(.a(new_n309_), .b(x32), .O(new_n569_));
  ...
  nand2  g484(.a(new_n216_), .b(x57), .O(new_n576_));
  inv1   g485(.a(new_n328_), .O(new_n577_));
  oai21  g486(.a(new_n418_), .b(new_n577_), .c(x72), .O(new_n578_));
  nand2  g487(.a(x74), .b(x54), .O(new_n579_));
  nand2  g488(.a(new_n214_), .b(x55), .O(new_n580_));
  aoi21  g489(.a(new_n580_), .b(new_n579_), .c(new_n213_), .O(new_n581_));
  nand3  g490(.a(x74), .b(new_n213_), .c(x56), .O(new_n582_));
  inv1   g491(.a(new_n582_), .O(new_n583_));
  oai21  g492(.a(new_n583_), .b(new_n581_), .c(new_n211_), .O(new_n584_));
  ...
  aoi21  g497(.a(new_n588_), .b(new_n574_), .c(new_n93_), .O(new_n589_));
  nand2  g498(.a(new_n125_), .b(x25), .O(new_n590_));
  oai21  g499(.a(new_n125_), .b(new_n194_), .c(new_n590_), .O(new_n591_));
  nand2  g500(.a(new_n591_), .b(x70), .O(new_n592_));
  oai21  g501(.a(new_n109_), .b(new_n176_), .c(new_n592_), .O(new_n593_));
  nand4  g502(.a(new_n593_), .b(new_n137_), .c(new_n93_), .d(x64), .O(new_n594_));
  inv1   g503(.a(new_n594_), .O(new_n595_));
  oai21  g504(.a(new_n595_), .b(new_n589_), .c(new_n92_), .O(new_n596_));
  nand4  g505(.a(new_n567_), .b(x71), .c(new_n151_), .d(new_n150_), .O(new_n597_));
  nand3  g506(.a(new_n585_), .b(new_n96_), .c(new_n125_), .O(new_n598_));
  nand2  g507(.a(new_n598_), .b(new_n597_), .O(new_n599_));
  nand2  g508(.a(new_n599_), .b(new_n108_), .O(new_n600_));
  inv1   g509(.a(new_n572_), .O(new_n601_));
  nand3  g510(.a(new_n601_), .b(new_n151_), .c(new_n150_), .O(new_n602_));
  nand2  g511(.a(new_n602_), .b(new_n600_), .O(new_n603_));
  nand4  g512(.a(new_n603_), .b(x68), .c(x65), .d(new_n94_), .O(new_n604_));
  aoi21  g513(.a(new_n604_), .b(new_n596_), .c(x69), .O(z09));
  nor2   g514(.a(new_n299_), .b(new_n297_), .O(new_n606_));
  oai21  g515(.a(new_n606_), .b(new_n138_), .c(x10), .O(new_n607_));
  inv1   g516(.a(new_n606_), .O(new_n608_));
  nand3  g517(.a(new_n608_), .b(new_n291_), .c(x00), .O(new_n609_));
  nand2  g518(.a(new_n609_), .b(new_n607_), .O(new_n610_));
  nand3  g519(.a(new_n610_), .b(x71), .c(new_n108_), .O(new_n611_));
  nor2   g520(.a(new_n316_), .b(new_n314_), .O(new_n612_));
  oai21  g521(.a(new_n612_), .b(new_n131_), .c(x42), .O(new_n613_));
  nand2  g522(.a(new_n317_), .b(new_n124_), .O(new_n614_));
  nand3  g523(.a(new_n614_), .b(new_n307_), .c(x32), .O(new_n615_));
  aoi21  g524(.a(new_n615_), .b(new_n613_), .c(x71), .O(new_n616_));
  ...
  nand2  g529(.a(new_n216_), .b(x58), .O(new_n621_));
  aoi21  g530(.a(new_n540_), .b(new_n539_), .c(x73), .O(new_n622_));
  nand3  g531(.a(new_n214_), .b(x73), .c(x50), .O(new_n623_));
  inv1   g532(.a(new_n623_), .O(new_n624_));
  oai21  g533(.a(new_n624_), .b(new_n622_), .c(x72), .O(new_n625_));
  nand2  g534(.a(x74), .b(x55), .O(new_n626_));
  nand2  g535(.a(new_n214_), .b(x56), .O(new_n627_));
  aoi21  g536(.a(new_n627_), .b(new_n626_), .c(new_n213_), .O(new_n628_));
  nand3  g537(.a(x74), .b(new_n213_), .c(x57), .O(new_n629_));
  inv1   g538(.a(new_n629_), .O(new_n630_));
  oai21  g539(.a(new_n630_), .b(new_n628_), .c(new_n211_), .O(new_n631_));
  ...
  oai21  g548(.a(new_n109_), .b(new_n291_), .c(new_n639_), .O(new_n640_));
  ...
  nand3  g565(.a(new_n203_), .b(new_n312_), .c(x32), .O(new_n657_));
  nand2  g566(.a(new_n657_), .b(new_n656_), .O(new_n658_));
  nand3  g567(.a(new_n658_), .b(new_n125_), .c(x70), .O(new_n659_));
  nand2  g568(.a(new_n659_), .b(new_n655_), .O(new_n660_));
  nand3  g569(.a(new_n660_), .b(new_n96_), .c(new_n94_), .O(new_n661_));
  nand2  g570(.a(new_n137_), .b(x43), .O(new_n662_));
  nand2  g571(.a(new_n216_), .b(x59), .O(new_n663_));
  aoi21  g572(.a(new_n580_), .b(new_n579_), .c(x73), .O(new_n664_));
  nand3  g573(.a(new_n214_), .b(x73), .c(x51), .O(new_n665_));
  inv1   g574(.a(new_n665_), .O(new_n666_));
  oai21  g575(.a(new_n666_), .b(new_n664_), .c(x72), .O(new_n667_));
  nand2  g576(.a(x74), .b(x56), .O(new_n668_));
  nand2  g577(.a(new_n214_), .b(x57), .O(new_n669_));
  aoi21  g578(.a(new_n669_), .b(new_n668_), .c(new_n213_), .O(new_n670_));
  nand3  g579(.a(x74), .b(new_n213_), .c(x58), .O(new_n671_));
  inv1   g580(.a(new_n671_), .O(new_n672_));
  oai21  g581(.a(new_n672_), .b(new_n670_), .c(new_n211_), .O(new_n673_));
  nand3  g582(.a(new_n673_), .b(new_n667_), .c(new_n663_), .O(new_n674_));
  nand3  g583(.a(new_n674_), .b(new_n151_), .c(new_n150_), .O(new_n675_));
  nand2  g584(.a(new_n675_), .b(new_n662_), .O(new_n676_));
  nand4  g585(.a(new_n676_), .b(new_n125_), .c(new_n108_), .d(x64), .O(new_n677_));
  aoi21  g586(.a(new_n677_), .b(new_n661_), .c(new_n93_), .O(new_n678_));
  nand2  g587(.a(new_n125_), .b(x27), .O(new_n679_));
  oai21  g588(.a(new_n125_), .b(new_n312_), .c(new_n679_), .O(new_n680_));
  nand2  g589(.a(new_n680_), .b(x70), .O(new_n681_));
  oai21  g590(.a(new_n109_), .b(new_n147_), .c(new_n681_), .O(new_n682_));
  nand4  g591(.a(new_n682_), .b(new_n137_), .c(new_n93_), .d(x64), .O(new_n683_));
  inv1   g592(.a(new_n683_), .O(new_n684_));
  oai21  g593(.a(new_n684_), .b(new_n678_), .c(new_n92_), .O(new_n685_));
  nand4  g594(.a(new_n654_), .b(x71), .c(new_n151_), .d(new_n150_), .O(new_n686_));
  nand3  g595(.a(new_n674_), .b(new_n96_), .c(new_n125_), .O(new_n687_));
  aoi21  g596(.a(new_n687_), .b(new_n686_), .c(x70), .O(new_n688_));
  nor3   g597(.a(new_n659_), .b(x67), .c(x66), .O(new_n689_));
  or2    g598(.a(new_n689_), .b(new_n688_), .O(new_n690_));
  nand4  g599(.a(new_n690_), .b(x68), .c(x65), .d(new_n94_), .O(new_n691_));
  aoi21  g600(.a(new_n691_), .b(new_n685_), .c(x69), .O(z11));
  oai21  g601(.a(new_n300_), .b(new_n138_), .c(x12), .O(new_n693_));
  nand3  g602(.a(new_n299_), .b(new_n296_), .c(x00), .O(new_n694_));
  aoi21  g603(.a(new_n694_), .b(new_n693_), .c(new_n125_), .O(new_n695_));
  nand2  g604(.a(new_n695_), .b(new_n108_), .O(new_n696_));
  oai21  g605(.a(new_n317_), .b(new_n131_), .c(x44), .O(new_n697_));
  nand3  g606(.a(new_n316_), .b(new_n313_), .c(x32), .O(new_n698_));
  ...
  nand2  g612(.a(new_n216_), .b(x60), .O(new_n704_));
  aoi21  g613(.a(new_n627_), .b(new_n626_), .c(x73), .O(new_n705_));
  nand3  g614(.a(new_n214_), .b(x73), .c(x52), .O(new_n706_));
  inv1   g615(.a(new_n706_), .O(new_n707_));
  oai21  g616(.a(new_n707_), .b(new_n705_), .c(x72), .O(new_n708_));
  nand2  g617(.a(x74), .b(x57), .O(new_n709_));
  nand2  g618(.a(new_n214_), .b(x58), .O(new_n710_));
  aoi21  g619(.a(new_n710_), .b(new_n709_), .c(new_n213_), .O(new_n711_));
  nand3  g620(.a(x74), .b(new_n213_), .c(x59), .O(new_n712_));
  inv1   g621(.a(new_n712_), .O(new_n713_));
  oai21  g622(.a(new_n713_), .b(new_n711_), .c(new_n211_), .O(new_n714_));
  ...
  nand3  g628(.a(new_n719_), .b(new_n238_), .c(x68), .O(new_n720_));
  nand2  g629(.a(new_n125_), .b(x28), .O(new_n721_));
  oai21  g630(.a(new_n125_), .b(new_n313_), .c(new_n721_), .O(new_n722_));
  nand2  g631(.a(new_n722_), .b(x70), .O(new_n723_));
  oai21  g632(.a(new_n109_), .b(new_n296_), .c(new_n723_), .O(new_n724_));
  nand4  g633(.a(new_n724_), .b(new_n137_), .c(new_n93_), .d(x64), .O(new_n725_));
  nand2  g634(.a(new_n725_), .b(new_n720_), .O(new_n726_));
  nand2  g635(.a(new_n726_), .b(new_n92_), .O(new_n727_));
  nand3  g636(.a(new_n695_), .b(new_n151_), .c(new_n150_), .O(new_n728_));
  nand3  g637(.a(new_n715_), .b(new_n96_), .c(new_n125_), .O(new_n729_));
  nand2  g638(.a(new_n729_), .b(new_n728_), .O(new_n730_));
  nand2  g639(.a(new_n730_), .b(new_n108_), .O(new_n731_));
  inv1   g640(.a(new_n700_), .O(new_n732_));
  nand3  g641(.a(new_n732_), .b(new_n151_), .c(new_n150_), .O(new_n733_));
  aoi21  g642(.a(new_n733_), .b(new_n731_), .c(x69), .O(new_n734_));
  nand4  g643(.a(new_n734_), .b(x68), .c(x65), .d(new_n94_), .O(new_n735_));
  nand3  g644(.a(new_n735_), .b(new_n727_), .c(new_n286_), .O(z12));
  nor2   g645(.a(new_n152_), .b(x13), .O(new_n737_));
  nand2  g646(.a(new_n737_), .b(x00), .O(new_n738_));
  oai21  g647(.a(new_n152_), .b(new_n138_), .c(x13), .O(new_n739_));
  aoi21  g648(.a(new_n739_), .b(new_n738_), .c(new_n125_), .O(new_n740_));
  nand2  g649(.a(new_n740_), .b(new_n108_), .O(new_n741_));
  nor2   g650(.a(new_n196_), .b(x45), .O(new_n742_));
  nand2  g651(.a(new_n742_), .b(x32), .O(new_n743_));
  oai21  g652(.a(new_n196_), .b(new_n131_), .c(x45), .O(new_n744_));
  ...
  nand2  g658(.a(new_n216_), .b(x61), .O(new_n750_));
  aoi21  g659(.a(new_n669_), .b(new_n668_), .c(x73), .O(new_n751_));
  nand3  g660(.a(new_n214_), .b(x73), .c(x53), .O(new_n752_));
  inv1   g661(.a(new_n752_), .O(new_n753_));
  oai21  g662(.a(new_n753_), .b(new_n751_), .c(x72), .O(new_n754_));
  nand2  g663(.a(x74), .b(x58), .O(new_n755_));
  nand2  g664(.a(new_n214_), .b(x59), .O(new_n756_));
  aoi21  g665(.a(new_n756_), .b(new_n755_), .c(new_n213_), .O(new_n757_));
  nand3  g666(.a(x74), .b(new_n213_), .c(x60), .O(new_n758_));
  ...
  aoi21  g673(.a(new_n764_), .b(new_n748_), .c(new_n93_), .O(new_n765_));
  nand2  g674(.a(new_n125_), .b(x29), .O(new_n766_));
  oai21  g675(.a(new_n125_), .b(new_n308_), .c(new_n766_), .O(new_n767_));
  nand2  g676(.a(new_n767_), .b(x70), .O(new_n768_));
  oai21  g677(.a(new_n109_), .b(new_n292_), .c(new_n768_), .O(new_n769_));
  ...
  nand2  g689(.a(new_n780_), .b(x14), .O(new_n781_));
  inv1   g690(.a(x14), .O(new_n782_));
  nand3  g691(.a(x15), .b(new_n782_), .c(x00), .O(new_n783_));
  aoi21  g692(.a(new_n783_), .b(new_n781_), .c(new_n125_), .O(new_n784_));
  nand2  g693(.a(new_n784_), .b(new_n108_), .O(new_n785_));
  inv1   g694(.a(x47), .O(new_n786_));
  oai21  g695(.a(new_n786_), .b(new_n131_), .c(x46), .O(new_n787_));
  inv1   g696(.a(x46), .O(new_n788_));
  nand3  g697(.a(x47), .b(new_n788_), .c(x32), .O(new_n789_));
  nand2  g698(.a(new_n789_), .b(new_n787_), .O(new_n790_));
  nand3  g699(.a(new_n790_), .b(new_n125_), .c(x70), .O(new_n791_));
  nand2  g700(.a(new_n791_), .b(new_n785_), .O(new_n792_));
  nand3  g701(.a(new_n792_), .b(new_n96_), .c(new_n94_), .O(new_n793_));
  nand2  g702(.a(new_n137_), .b(x46), .O(new_n794_));
  nand2  g703(.a(new_n216_), .b(x62), .O(new_n795_));
  aoi21  g704(.a(new_n710_), .b(new_n709_), .c(x73), .O(new_n796_));
  nand3  g705(.a(new_n214_), .b(x73), .c(x54), .O(new_n797_));
  inv1   g706(.a(new_n797_), .O(new_n798_));
  oai21  g707(.a(new_n798_), .b(new_n796_), .c(x72), .O(new_n799_));
  nand2  g708(.a(x74), .b(x59), .O(new_n800_));
  nand2  g709(.a(new_n214_), .b(x60), .O(new_n801_));
  aoi21  g710(.a(new_n801_), .b(new_n800_), .c(new_n213_), .O(new_n802_));
  nand3  g711(.a(x74), .b(new_n213_), .c(x61), .O(new_n803_));
  ...
  nand3  g715(.a(new_n806_), .b(new_n151_), .c(new_n150_), .O(new_n807_));
  nand2  g716(.a(new_n807_), .b(new_n794_), .O(new_n808_));
  nand4  g717(.a(new_n808_), .b(new_n125_), .c(new_n108_), .d(x64), .O(new_n809_));
  aoi21  g718(.a(new_n809_), .b(new_n793_), .c(new_n93_), .O(new_n810_));
  nand2  g719(.a(new_n125_), .b(x30), .O(new_n811_));
  oai21  g720(.a(new_n125_), .b(new_n788_), .c(new_n811_), .O(new_n812_));
  nand2  g721(.a(new_n812_), .b(x70), .O(new_n813_));
  oai21  g722(.a(new_n109_), .b(new_n782_), .c(new_n813_), .O(new_n814_));
  nand4  g723(.a(new_n814_), .b(new_n137_), .c(new_n93_), .d(x64), .O(new_n815_));
  inv1   g724(.a(new_n815_), .O(new_n816_));
  oai21  g725(.a(new_n816_), .b(new_n810_), .c(new_n92_), .O(new_n817_));
  nand3  g726(.a(new_n784_), .b(new_n151_), .c(new_n150_), .O(new_n818_));
  nand3  g727(.a(new_n806_), .b(new_n96_), .c(new_n125_), .O(new_n819_));
  ...
  nand3  g734(.a(new_n125_), .b(new_n108_), .c(x68), .O(new_n826_));
  aoi21  g735(.a(new_n826_), .b(new_n825_), .c(new_n786_), .O(new_n827_));
  nand3  g736(.a(x71), .b(new_n108_), .c(x15), .O(new_n828_));
  nand2  g737(.a(new_n165_), .b(x31), .O(new_n829_));
  aoi21  g738(.a(new_n829_), .b(new_n828_), .c(x68), .O(new_n830_));
  oai21  g739(.a(new_n830_), .b(new_n827_), .c(new_n137_), .O(new_n831_));
  nand2  g740(.a(new_n216_), .b(x63), .O(new_n832_));
  aoi21  g741(.a(new_n756_), .b(new_n755_), .c(x73), .O(new_n833_));
  nand3  g742(.a(new_n214_), .b(x73), .c(x55), .O(new_n834_));
  inv1   g743(.a(new_n834_), .O(new_n835_));
  oai21  g744(.a(new_n835_), .b(new_n833_), .c(x72), .O(new_n836_));
  nand2  g745(.a(x74), .b(x60), .O(new_n837_));
  nand2  g746(.a(new_n214_), .b(x61), .O(new_n838_));
  aoi21  g747(.a(new_n838_), .b(new_n837_), .c(new_n213_), .O(new_n839_));
  nand3  g748(.a(x74), .b(new_n213_), .c(x62), .O(new_n840_));
  ...
  nand4  g752(.a(new_n843_), .b(new_n125_), .c(new_n108_), .d(x68), .O(new_n844_));
  inv1   g753(.a(new_n844_), .O(new_n845_));
  nand3  g754(.a(new_n845_), .b(new_n151_), .c(new_n150_), .O(new_n846_));
  aoi21  g755(.a(new_n846_), .b(new_n831_), .c(new_n94_), .O(new_n847_));
  oai21  g756(.a(new_n126_), .b(new_n786_), .c(new_n828_), .O(new_n848_));
  nand4  g757(.a(new_n848_), .b(new_n96_), .c(x68), .d(new_n94_), .O(new_n849_));
  ...
  nand2  g764(.a(new_n150_), .b(x47), .O(new_n856_));
  oai21  g765(.a(new_n856_), .b(new_n166_), .c(new_n855_), .O(new_n857_));
  nand4  g766(.a(new_n857_), .b(x68), .c(x65), .d(new_n94_), .O(new_n858_));
  aoi21  g767(.a(new_n858_), .b(new_n851_), .c(x69), .O(z15));
endmodule
