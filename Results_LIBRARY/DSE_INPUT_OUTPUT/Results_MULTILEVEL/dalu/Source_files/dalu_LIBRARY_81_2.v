...
module FAU ( 
  ...
  nor2   g077(.a(new_n142_), .b(x73), .O(new_n169_));
  ...
  aoi22  g102(.a(new_n103_), .b(x19), .c(x71), .d(x35), .O(new_n194_));
  or2    g103(.a(new_n194_), .b(new_n97_), .O(new_n195_));
  nand3  g104(.a(new_n105_), .b(x69), .c(x51), .O(new_n196_));
  ...
  xor2a  g108(.a(new_n136_), .b(new_n135_), .O(new_n200_));
  nand2  g109(.a(new_n200_), .b(x16), .O(new_n201_));
  inv1   g110(.a(x18), .O(new_n202_));
  inv1   g111(.a(new_n169_), .O(new_n203_));
  nand3  g112(.a(new_n142_), .b(x73), .c(x17), .O(new_n204_));
  oai21  g113(.a(new_n203_), .b(new_n202_), .c(new_n204_), .O(new_n205_));
  ...
  oai21  g121(.a(new_n203_), .b(new_n211_), .c(new_n212_), .O(new_n213_));
  ...
  aoi21  g126(.a(new_n217_), .b(new_n110_), .c(new_n198_), .O(new_n218_));
  nand3  g127(.a(new_n197_), .b(new_n110_), .c(x66), .O(new_n219_));
  ...
  nand4  g131(.a(new_n222_), .b(x69), .c(x65), .d(new_n120_), .O(new_n223_));
  ...
  oai21  g136(.a(new_n102_), .b(new_n226_), .c(new_n227_), .O(new_n228_));
  ...
  nand2  g142(.a(new_n165_), .b(x20), .O(new_n234_));
  aoi21  g143(.a(new_n234_), .b(new_n233_), .c(new_n135_), .O(new_n235_));
  nand2  g144(.a(x74), .b(x17), .O(new_n236_));
  oai21  g145(.a(x74), .b(new_n202_), .c(new_n236_), .O(new_n237_));
  ...
  oai21  g151(.a(new_n242_), .b(new_n235_), .c(new_n163_), .O(new_n243_));
  ...
  oai21  g157(.a(x74), .b(new_n211_), .c(new_n248_), .O(new_n249_));
  and2   g158(.a(new_n249_), .b(x73), .O(new_n250_));
  nand2  g159(.a(x74), .b(x51), .O(new_n251_));
  oai21  g160(.a(x74), .b(new_n244_), .c(new_n251_), .O(new_n252_));
  and2   g161(.a(new_n252_), .b(new_n144_), .O(new_n253_));
  ...
  nand2  g184(.a(new_n275_), .b(new_n203_), .O(new_n276_));
  nand2  g185(.a(new_n276_), .b(x16), .O(new_n277_));
  aoi22  g186(.a(new_n137_), .b(x17), .c(new_n165_), .d(x21), .O(new_n278_));
  ...
  oai21  g196(.a(new_n287_), .b(new_n279_), .c(new_n163_), .O(new_n288_));
  nand2  g197(.a(new_n137_), .b(x49), .O(new_n289_));
  nand2  g198(.a(new_n165_), .b(x53), .O(new_n290_));
  ...
  and2   g229(.a(new_n240_), .b(x73), .O(new_n321_));
  nand2  g230(.a(new_n169_), .b(x21), .O(new_n322_));
  ...
  nand2  g234(.a(new_n325_), .b(new_n163_), .O(new_n326_));
  ...
  and2   g240(.a(new_n252_), .b(x73), .O(new_n332_));
  nand2  g241(.a(new_n169_), .b(x53), .O(new_n333_));
  ...
  nand2  g282(.a(new_n185_), .b(x23), .O(new_n374_));
  ...
  nand2  g296(.a(new_n318_), .b(new_n241_), .O(new_n388_));
  ...
  nand2  g301(.a(new_n169_), .b(x23), .O(new_n393_));
  ...
  oai21  g307(.a(new_n330_), .b(new_n253_), .c(x72), .O(new_n399_));
  ...
  nand2  g311(.a(new_n169_), .b(x55), .O(new_n403_));
  ...
  oai21  g331(.a(new_n285_), .b(new_n422_), .c(x72), .O(new_n423_));
  ...
  oai21  g342(.a(new_n298_), .b(new_n433_), .c(x72), .O(new_n434_));
  ...
  oai21  g355(.a(new_n446_), .b(new_n445_), .c(new_n126_), .O(new_n447_));
  nand2  g356(.a(new_n185_), .b(x25), .O(new_n448_));
  nand2  g357(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  nand3  g358(.a(new_n449_), .b(new_n92_), .c(x64), .O(new_n450_));
  nand4  g359(.a(new_n443_), .b(new_n122_), .c(x69), .d(new_n126_), .O(new_n451_));
  nor2   g360(.a(new_n451_), .b(new_n92_), .O(new_n452_));
  aoi21  g361(.a(new_n452_), .b(new_n120_), .c(new_n155_), .O(new_n453_));
  ...
  aoi21  g369(.a(new_n391_), .b(new_n390_), .c(x73), .O(new_n461_));
  ...
  aoi21  g382(.a(new_n401_), .b(new_n400_), .c(x73), .O(new_n474_));
  ...
  nand2  g399(.a(new_n185_), .b(x26), .O(new_n491_));
  ...
  nand2  g414(.a(new_n274_), .b(x19), .O(new_n506_));
  ...
  nand2  g420(.a(new_n169_), .b(x26), .O(new_n512_));
  ...
  nand2  g427(.a(new_n274_), .b(x51), .O(new_n519_));
  ...
  nand2  g433(.a(new_n169_), .b(x58), .O(new_n525_));
  ...
  nand2  g533(.a(new_n185_), .b(x29), .O(new_n625_));
  ...
  nand2  g576(.a(new_n185_), .b(x30), .O(new_n668_));
  ...
  nand2  g591(.a(new_n274_), .b(x23), .O(new_n683_));
  ...
  nand2  g597(.a(new_n169_), .b(x30), .O(new_n689_));
  ...
  nand2  g604(.a(new_n274_), .b(x55), .O(new_n696_));
  ...
  nand2  g610(.a(new_n169_), .b(x62), .O(new_n702_));
