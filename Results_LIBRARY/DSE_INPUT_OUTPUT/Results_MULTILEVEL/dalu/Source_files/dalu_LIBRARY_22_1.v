...
module FAU ( 
  ...
  nand4  g203(.a(new_n294_), .b(new_n172_), .c(new_n181_), .d(new_n293_), .O(new_n295_));
  ...
  nand4  g218(.a(new_n309_), .b(new_n157_), .c(new_n205_), .d(new_n308_), .O(new_n310_));
  inv1   g219(.a(x42), .O(new_n311_));
  nand4  g220(.a(new_n200_), .b(new_n122_), .c(new_n211_), .d(new_n311_), .O(new_n312_));
  ...
  inv1   g234(.a(new_n223_), .O(new_n326_));
  nand2  g235(.a(new_n326_), .b(new_n222_), .O(new_n327_));
  nand2  g236(.a(new_n327_), .b(new_n271_), .O(new_n328_));
  nand2  g237(.a(new_n328_), .b(x48), .O(new_n329_));
  inv1   g238(.a(x50), .O(new_n330_));
  nand2  g239(.a(x74), .b(new_n224_), .O(new_n331_));
  nand3  g240(.a(new_n225_), .b(x73), .c(x49), .O(new_n332_));
  oai21  g241(.a(new_n331_), .b(new_n330_), .c(new_n332_), .O(new_n333_));
  ...
  nand2  g247(.a(new_n338_), .b(new_n323_), .O(new_n339_));
  ...
  nand3  g256(.a(new_n322_), .b(new_n149_), .c(new_n148_), .O(new_n348_));
  nand4  g257(.a(new_n335_), .b(new_n96_), .c(new_n123_), .d(new_n107_), .O(new_n349_));
  ...
  nand3  g262(.a(new_n353_), .b(new_n191_), .c(new_n180_), .O(new_n354_));
  nand3  g263(.a(new_n354_), .b(new_n293_), .c(x00), .O(new_n355_));
  oai21  g264(.a(new_n293_), .b(x00), .c(new_n355_), .O(new_n356_));
  nand3  g265(.a(new_n356_), .b(x71), .c(new_n107_), .O(new_n357_));
  nor2   g266(.a(x39), .b(x38), .O(new_n358_));
  nand3  g267(.a(new_n358_), .b(new_n215_), .c(new_n204_), .O(new_n359_));
  nand3  g268(.a(new_n359_), .b(new_n308_), .c(x32), .O(new_n360_));
  oai21  g269(.a(new_n308_), .b(x32), .c(new_n360_), .O(new_n361_));
  ...
  nor2   g274(.a(new_n326_), .b(new_n130_), .O(new_n366_));
  nand2  g275(.a(new_n326_), .b(x52), .O(new_n367_));
  ...
  oai21  g291(.a(new_n123_), .b(new_n308_), .c(new_n382_), .O(new_n383_));
  nand2  g292(.a(new_n383_), .b(x70), .O(new_n384_));
  oai21  g293(.a(new_n108_), .b(new_n293_), .c(new_n384_), .O(new_n385_));
  ...
  aoi21  g297(.a(x74), .b(x73), .c(new_n130_), .O(new_n389_));
  oai21  g298(.a(new_n389_), .b(new_n368_), .c(x72), .O(new_n390_));
  nand2  g299(.a(new_n390_), .b(new_n376_), .O(new_n391_));
  nand3  g300(.a(new_n391_), .b(new_n96_), .c(new_n123_), .O(new_n392_));
  ...
  aoi21  g308(.a(new_n399_), .b(new_n388_), .c(x69), .O(z04));
  nand3  g309(.a(new_n353_), .b(new_n191_), .c(new_n293_), .O(new_n401_));
  nand3  g310(.a(new_n401_), .b(new_n180_), .c(x00), .O(new_n402_));
  oai21  g311(.a(new_n180_), .b(x00), .c(new_n402_), .O(new_n403_));
  nand3  g312(.a(new_n403_), .b(x71), .c(new_n107_), .O(new_n404_));
  nand3  g313(.a(new_n358_), .b(new_n215_), .c(new_n308_), .O(new_n405_));
  nand3  g314(.a(new_n405_), .b(new_n204_), .c(x32), .O(new_n406_));
  oai21  g315(.a(new_n204_), .b(x32), .c(new_n406_), .O(new_n407_));
  ...
  nand2  g319(.a(new_n225_), .b(x73), .O(new_n411_));
  aoi21  g320(.a(new_n411_), .b(new_n331_), .c(new_n130_), .O(new_n412_));
  inv1   g321(.a(x53), .O(new_n413_));
  nand3  g322(.a(new_n225_), .b(new_n224_), .c(x49), .O(new_n414_));
  oai21  g323(.a(new_n223_), .b(new_n413_), .c(new_n414_), .O(new_n415_));
  oai21  g324(.a(new_n415_), .b(new_n412_), .c(x72), .O(new_n416_));
  nand2  g325(.a(x74), .b(x50), .O(new_n417_));
  nand2  g326(.a(new_n225_), .b(x51), .O(new_n418_));
  aoi21  g327(.a(new_n418_), .b(new_n417_), .c(new_n224_), .O(new_n419_));
  ...
  oai21  g331(.a(new_n422_), .b(new_n419_), .c(new_n222_), .O(new_n423_));
  nand2  g332(.a(new_n423_), .b(new_n416_), .O(new_n424_));
  nand3  g333(.a(new_n424_), .b(new_n149_), .c(new_n148_), .O(new_n425_));
  oai21  g334(.a(new_n131_), .b(new_n204_), .c(new_n425_), .O(new_n426_));
  nand4  g335(.a(new_n426_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n427_));
  aoi21  g336(.a(new_n427_), .b(new_n410_), .c(new_n93_), .O(new_n428_));
  nand2  g337(.a(new_n123_), .b(x21), .O(new_n429_));
  oai21  g338(.a(new_n123_), .b(new_n204_), .c(new_n429_), .O(new_n430_));
  nand2  g339(.a(new_n430_), .b(x70), .O(new_n431_));
  oai21  g340(.a(new_n108_), .b(new_n180_), .c(new_n431_), .O(new_n432_));
  ...
  nand4  g345(.a(new_n403_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n437_));
  nand2  g346(.a(new_n437_), .b(new_n436_), .O(new_n438_));
  nand2  g347(.a(new_n438_), .b(new_n107_), .O(new_n439_));
  inv1   g348(.a(new_n408_), .O(new_n440_));
  ...
  nand4  g353(.a(new_n191_), .b(new_n181_), .c(new_n180_), .d(new_n293_), .O(new_n445_));
  nand3  g354(.a(new_n445_), .b(new_n101_), .c(x00), .O(new_n446_));
  ...
  nand4  g358(.a(new_n215_), .b(new_n205_), .c(new_n204_), .d(new_n308_), .O(new_n450_));
  nand3  g359(.a(new_n450_), .b(new_n117_), .c(x32), .O(new_n451_));
  ...
  nand2  g365(.a(new_n227_), .b(x54), .O(new_n457_));
  aoi21  g366(.a(new_n371_), .b(new_n370_), .c(x73), .O(new_n458_));
  nand3  g367(.a(new_n225_), .b(x73), .c(x48), .O(new_n459_));
  inv1   g368(.a(new_n459_), .O(new_n460_));
  oai21  g369(.a(new_n460_), .b(new_n458_), .c(x72), .O(new_n461_));
  aoi21  g370(.a(new_n374_), .b(new_n373_), .c(new_n224_), .O(new_n462_));
  nand3  g371(.a(x74), .b(new_n224_), .c(x53), .O(new_n463_));
  inv1   g372(.a(new_n463_), .O(new_n464_));
  oai21  g373(.a(new_n464_), .b(new_n462_), .c(new_n222_), .O(new_n465_));
  nand3  g374(.a(new_n465_), .b(new_n461_), .c(new_n457_), .O(new_n466_));
  nand3  g375(.a(new_n466_), .b(new_n149_), .c(new_n148_), .O(new_n467_));
  oai21  g376(.a(new_n131_), .b(new_n117_), .c(new_n467_), .O(new_n468_));
  nand4  g377(.a(new_n468_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n469_));
  aoi21  g378(.a(new_n469_), .b(new_n456_), .c(new_n93_), .O(new_n470_));
  ...
  nand4  g387(.a(new_n448_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n479_));
  nand2  g388(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand2  g389(.a(new_n480_), .b(new_n107_), .O(new_n481_));
  inv1   g390(.a(new_n454_), .O(new_n482_));
  nand3  g391(.a(new_n482_), .b(new_n149_), .c(new_n148_), .O(new_n483_));
  ...
  nand2  g395(.a(new_n300_), .b(new_n191_), .O(new_n487_));
  nand3  g396(.a(new_n487_), .b(new_n181_), .c(x00), .O(new_n488_));
  ...
  nand2  g400(.a(new_n315_), .b(new_n215_), .O(new_n492_));
  nand3  g401(.a(new_n492_), .b(new_n205_), .c(x32), .O(new_n493_));
  nand2  g402(.a(x39), .b(new_n129_), .O(new_n494_));
  nand2  g403(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand3  g404(.a(new_n495_), .b(new_n123_), .c(x70), .O(new_n496_));
  nand2  g405(.a(new_n496_), .b(new_n491_), .O(new_n497_));
  nand3  g406(.a(new_n497_), .b(new_n96_), .c(new_n94_), .O(new_n498_));
  nand2  g407(.a(new_n135_), .b(x39), .O(new_n499_));
  nand2  g408(.a(new_n227_), .b(x55), .O(new_n500_));
  aoi21  g409(.a(new_n418_), .b(new_n417_), .c(x73), .O(new_n501_));
  oai21  g410(.a(new_n501_), .b(new_n460_), .c(x72), .O(new_n502_));
  aoi21  g411(.a(new_n421_), .b(new_n420_), .c(new_n224_), .O(new_n503_));
  ...
  nand3  g420(.a(new_n511_), .b(new_n170_), .c(x68), .O(new_n512_));
  nand2  g421(.a(new_n123_), .b(x23), .O(new_n513_));
  oai21  g422(.a(new_n123_), .b(new_n205_), .c(new_n513_), .O(new_n514_));
  nand2  g423(.a(new_n514_), .b(x70), .O(new_n515_));
  oai21  g424(.a(new_n108_), .b(new_n181_), .c(new_n515_), .O(new_n516_));
  ...
  nand3  g428(.a(new_n507_), .b(new_n96_), .c(new_n123_), .O(new_n520_));
  nand4  g429(.a(new_n490_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n521_));
  nand2  g430(.a(new_n521_), .b(new_n520_), .O(new_n522_));
  nand2  g431(.a(new_n522_), .b(new_n107_), .O(new_n523_));
  inv1   g432(.a(new_n496_), .O(new_n524_));
  nand3  g433(.a(new_n524_), .b(new_n149_), .c(new_n148_), .O(new_n525_));
  aoi21  g434(.a(new_n525_), .b(new_n523_), .c(x69), .O(new_n526_));
  nand4  g435(.a(new_n526_), .b(x68), .c(x65), .d(new_n94_), .O(new_n527_));
  nand3  g436(.a(new_n527_), .b(new_n519_), .c(new_n249_), .O(z07));
  nand2  g437(.a(new_n176_), .b(x00), .O(new_n529_));
  nand2  g438(.a(new_n529_), .b(x08), .O(new_n530_));
  nand3  g439(.a(new_n176_), .b(new_n182_), .c(x00), .O(new_n531_));
  aoi21  g440(.a(new_n531_), .b(new_n530_), .c(new_n123_), .O(new_n532_));
  nand2  g441(.a(new_n532_), .b(new_n107_), .O(new_n533_));
  nand2  g442(.a(new_n201_), .b(x32), .O(new_n534_));
  nand2  g443(.a(new_n534_), .b(x40), .O(new_n535_));
  nand3  g444(.a(new_n201_), .b(new_n206_), .c(x32), .O(new_n536_));
  ...
  nand2  g450(.a(new_n227_), .b(x56), .O(new_n542_));
  oai21  g451(.a(new_n460_), .b(new_n375_), .c(x72), .O(new_n543_));
  nand2  g452(.a(x74), .b(x53), .O(new_n544_));
  nand2  g453(.a(new_n225_), .b(x54), .O(new_n545_));
  aoi21  g454(.a(new_n545_), .b(new_n544_), .c(new_n224_), .O(new_n546_));
  nand3  g455(.a(x74), .b(new_n224_), .c(x55), .O(new_n547_));
  inv1   g456(.a(new_n547_), .O(new_n548_));
  oai21  g457(.a(new_n548_), .b(new_n546_), .c(new_n222_), .O(new_n549_));
  ...
  nand3  g463(.a(new_n554_), .b(new_n170_), .c(x68), .O(new_n555_));
  nand2  g464(.a(new_n123_), .b(x24), .O(new_n556_));
  oai21  g465(.a(new_n123_), .b(new_n206_), .c(new_n556_), .O(new_n557_));
  nand2  g466(.a(new_n557_), .b(x70), .O(new_n558_));
  oai21  g467(.a(new_n108_), .b(new_n182_), .c(new_n558_), .O(new_n559_));
  ...
  nand3  g478(.a(new_n569_), .b(new_n562_), .c(new_n249_), .O(z08));
  aoi21  g479(.a(new_n303_), .b(new_n302_), .c(new_n136_), .O(new_n571_));
  nand3  g480(.a(new_n297_), .b(new_n174_), .c(x00), .O(new_n572_));
  oai21  g481(.a(new_n571_), .b(new_n174_), .c(new_n572_), .O(new_n573_));
  nand3  g482(.a(new_n573_), .b(x71), .c(new_n107_), .O(new_n574_));
  aoi21  g483(.a(new_n317_), .b(new_n316_), .c(new_n129_), .O(new_n575_));
  nand3  g484(.a(new_n312_), .b(new_n198_), .c(x32), .O(new_n576_));
  ...
  nand2  g490(.a(new_n227_), .b(x57), .O(new_n582_));
  inv1   g491(.a(new_n332_), .O(new_n583_));
  oai21  g492(.a(new_n422_), .b(new_n583_), .c(x72), .O(new_n584_));
  nand2  g493(.a(x74), .b(x54), .O(new_n585_));
  nand2  g494(.a(new_n225_), .b(x55), .O(new_n586_));
  aoi21  g495(.a(new_n586_), .b(new_n585_), .c(new_n224_), .O(new_n587_));
  nand3  g496(.a(x74), .b(new_n224_), .c(x56), .O(new_n588_));
  inv1   g497(.a(new_n588_), .O(new_n589_));
  oai21  g498(.a(new_n589_), .b(new_n587_), .c(new_n222_), .O(new_n590_));
  ...
  nand3  g504(.a(new_n595_), .b(new_n170_), .c(x68), .O(new_n596_));
  nand2  g505(.a(new_n123_), .b(x25), .O(new_n597_));
  oai21  g506(.a(new_n123_), .b(new_n198_), .c(new_n597_), .O(new_n598_));
  nand2  g507(.a(new_n598_), .b(x70), .O(new_n599_));
  oai21  g508(.a(new_n108_), .b(new_n174_), .c(new_n599_), .O(new_n600_));
  ...
  nand3  g520(.a(new_n611_), .b(new_n603_), .c(new_n249_), .O(z09));
  aoi21  g521(.a(new_n303_), .b(new_n106_), .c(new_n136_), .O(new_n613_));
  nand2  g522(.a(new_n303_), .b(new_n106_), .O(new_n614_));
  nand3  g523(.a(new_n614_), .b(new_n296_), .c(x00), .O(new_n615_));
  oai21  g524(.a(new_n613_), .b(new_n296_), .c(new_n615_), .O(new_n616_));
  nand3  g525(.a(new_n616_), .b(x71), .c(new_n107_), .O(new_n617_));
  nand2  g526(.a(new_n317_), .b(new_n122_), .O(new_n618_));
  aoi21  g527(.a(new_n618_), .b(x32), .c(new_n311_), .O(new_n619_));
  nand3  g528(.a(new_n618_), .b(new_n311_), .c(x32), .O(new_n620_));
  inv1   g529(.a(new_n620_), .O(new_n621_));
  oai21  g530(.a(new_n621_), .b(new_n619_), .c(new_n123_), .O(new_n622_));
  oai21  g531(.a(new_n622_), .b(new_n107_), .c(new_n617_), .O(new_n623_));
  nand3  g532(.a(new_n623_), .b(new_n96_), .c(new_n94_), .O(new_n624_));
  nand2  g533(.a(new_n227_), .b(x58), .O(new_n625_));
  aoi21  g534(.a(new_n545_), .b(new_n544_), .c(x73), .O(new_n626_));
  nand3  g535(.a(new_n225_), .b(x73), .c(x50), .O(new_n627_));
  inv1   g536(.a(new_n627_), .O(new_n628_));
  oai21  g537(.a(new_n628_), .b(new_n626_), .c(x72), .O(new_n629_));
  nand2  g538(.a(x74), .b(x55), .O(new_n630_));
  nand2  g539(.a(new_n225_), .b(x56), .O(new_n631_));
  aoi21  g540(.a(new_n631_), .b(new_n630_), .c(new_n224_), .O(new_n632_));
  nand3  g541(.a(x74), .b(new_n224_), .c(x57), .O(new_n633_));
  ...
  oai21  g546(.a(new_n131_), .b(new_n311_), .c(new_n637_), .O(new_n638_));
  nand4  g547(.a(new_n638_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n639_));
  aoi21  g548(.a(new_n639_), .b(new_n624_), .c(new_n93_), .O(new_n640_));
  nand2  g549(.a(new_n123_), .b(x26), .O(new_n641_));
  oai21  g550(.a(new_n123_), .b(new_n311_), .c(new_n641_), .O(new_n642_));
  nand2  g551(.a(new_n642_), .b(x70), .O(new_n643_));
  oai21  g552(.a(new_n108_), .b(new_n296_), .c(new_n643_), .O(new_n644_));
  ...
  nand4  g556(.a(new_n616_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n648_));
  ...
  nor2   g560(.a(new_n622_), .b(new_n107_), .O(new_n652_));
  nand3  g561(.a(new_n652_), .b(new_n149_), .c(new_n148_), .O(new_n653_));
  ...
  oai21  g565(.a(new_n191_), .b(new_n136_), .c(x11), .O(new_n657_));
  nand3  g566(.a(new_n190_), .b(new_n145_), .c(x00), .O(new_n658_));
  nand2  g567(.a(new_n658_), .b(new_n657_), .O(new_n659_));
  nand3  g568(.a(new_n659_), .b(x71), .c(new_n107_), .O(new_n660_));
  oai21  g569(.a(new_n215_), .b(new_n129_), .c(x43), .O(new_n661_));
  inv1   g570(.a(x43), .O(new_n662_));
  nand3  g571(.a(new_n214_), .b(new_n662_), .c(x32), .O(new_n663_));
  ...
  nand2  g577(.a(new_n227_), .b(x59), .O(new_n669_));
  aoi21  g578(.a(new_n586_), .b(new_n585_), .c(x73), .O(new_n670_));
  nand3  g579(.a(new_n225_), .b(x73), .c(x51), .O(new_n671_));
  inv1   g580(.a(new_n671_), .O(new_n672_));
  oai21  g581(.a(new_n672_), .b(new_n670_), .c(x72), .O(new_n673_));
  nand2  g582(.a(x74), .b(x56), .O(new_n674_));
  nand2  g583(.a(new_n225_), .b(x57), .O(new_n675_));
  aoi21  g584(.a(new_n675_), .b(new_n674_), .c(new_n224_), .O(new_n676_));
  nand3  g585(.a(x74), .b(new_n224_), .c(x58), .O(new_n677_));
  inv1   g586(.a(new_n677_), .O(new_n678_));
  oai21  g587(.a(new_n678_), .b(new_n676_), .c(new_n222_), .O(new_n679_));
  ...
  nand3  g593(.a(new_n684_), .b(new_n170_), .c(x68), .O(new_n685_));
  nand2  g594(.a(new_n123_), .b(x27), .O(new_n686_));
  oai21  g595(.a(new_n123_), .b(new_n662_), .c(new_n686_), .O(new_n687_));
  ...
  nand4  g601(.a(new_n659_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n693_));
  ...
  oai21  g635(.a(new_n131_), .b(new_n210_), .c(new_n726_), .O(new_n727_));
  ...
  oai21  g639(.a(new_n123_), .b(new_n210_), .c(new_n730_), .O(new_n731_));
  nand2  g640(.a(new_n731_), .b(x70), .O(new_n732_));
  oai21  g641(.a(new_n108_), .b(new_n186_), .c(new_n732_), .O(new_n733_));
  ...
  oai21  g657(.a(x47), .b(x46), .c(new_n211_), .O(new_n749_));
  oai21  g658(.a(new_n200_), .b(new_n129_), .c(x45), .O(new_n750_));
  ...
  oai21  g674(.a(new_n765_), .b(new_n763_), .c(new_n222_), .O(new_n766_));
  ...
  nand3  g680(.a(new_n771_), .b(new_n170_), .c(x68), .O(new_n772_));
  nand2  g681(.a(new_n123_), .b(x29), .O(new_n773_));
  oai21  g682(.a(new_n123_), .b(new_n211_), .c(new_n773_), .O(new_n774_));
  nand2  g683(.a(new_n774_), .b(x70), .O(new_n775_));
  oai21  g684(.a(new_n108_), .b(new_n187_), .c(new_n775_), .O(new_n776_));
  ...
  oai21  g697(.a(new_n189_), .b(new_n136_), .c(x14), .O(new_n789_));
  nand3  g698(.a(x15), .b(new_n188_), .c(x00), .O(new_n790_));
  nand2  g699(.a(new_n790_), .b(new_n789_), .O(new_n791_));
  nand3  g700(.a(new_n791_), .b(x71), .c(new_n107_), .O(new_n792_));
  oai21  g701(.a(new_n213_), .b(new_n129_), .c(x46), .O(new_n793_));
  ...
  nand3  g724(.a(new_n815_), .b(new_n170_), .c(x68), .O(new_n816_));
  nand2  g725(.a(new_n123_), .b(x30), .O(new_n817_));
  oai21  g726(.a(new_n123_), .b(new_n212_), .c(new_n817_), .O(new_n818_));
  nand2  g727(.a(new_n818_), .b(x70), .O(new_n819_));
  oai21  g728(.a(new_n108_), .b(new_n188_), .c(new_n819_), .O(new_n820_));
  ...
  oai21  g732(.a(new_n189_), .b(new_n136_), .c(x14), .O(new_n824_));
  nand2  g733(.a(new_n824_), .b(new_n790_), .O(new_n825_));
  nand4  g734(.a(new_n825_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n826_));
  nand3  g735(.a(new_n811_), .b(new_n96_), .c(new_n123_), .O(new_n827_));
  nand2  g736(.a(new_n827_), .b(new_n826_), .O(new_n828_));
  nand2  g737(.a(new_n828_), .b(new_n107_), .O(new_n829_));
  inv1   g738(.a(new_n796_), .O(new_n830_));
  nand3  g739(.a(new_n830_), .b(new_n149_), .c(new_n148_), .O(new_n831_));
  ...
  nand3  g744(.a(new_n123_), .b(new_n107_), .c(x68), .O(new_n836_));
  aoi21  g745(.a(new_n836_), .b(new_n835_), .c(new_n213_), .O(new_n837_));
  nand3  g746(.a(x71), .b(new_n107_), .c(x15), .O(new_n838_));
  nand2  g747(.a(new_n163_), .b(x31), .O(new_n839_));
  aoi21  g748(.a(new_n839_), .b(new_n838_), .c(x68), .O(new_n840_));
  oai21  g749(.a(new_n840_), .b(new_n837_), .c(new_n135_), .O(new_n841_));
  ...
  nand4  g762(.a(new_n853_), .b(new_n123_), .c(new_n107_), .d(x68), .O(new_n854_));
  inv1   g763(.a(new_n854_), .O(new_n855_));
  nand3  g764(.a(new_n855_), .b(new_n149_), .c(new_n148_), .O(new_n856_));
  aoi21  g765(.a(new_n856_), .b(new_n841_), .c(new_n94_), .O(new_n857_));
  oai21  g766(.a(new_n124_), .b(new_n213_), .c(new_n838_), .O(new_n858_));
  ...
  nand2  g774(.a(new_n148_), .b(x47), .O(new_n866_));
  oai21  g775(.a(new_n866_), .b(new_n164_), .c(new_n865_), .O(new_n867_));
