...
module FAU ( 
  ...
  nor2   g12(.a(x12), .b(x08), .O(new_n32_));
  ...
  nand3  g17(.a(x12), .b(new_n36_), .c(new_n20_), .O(new_n37_));
  nand3  g18(.a(x13), .b(x09), .c(x08), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand3  g20(.a(new_n39_), .b(x04), .c(x02), .O(new_n40_));
  inv1   g21(.a(new_n40_), .O(new_n41_));
  nand2  g22(.a(new_n25_), .b(x12), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n20_), .c(new_n36_), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n41_), .c(x03), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n35_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n36_), .c(new_n20_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n24_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x04), .c(x02), .O(new_n49_));
  nand3  g30(.a(new_n20_), .b(x04), .c(x02), .O(new_n50_));
  nand3  g31(.a(new_n24_), .b(x12), .c(new_n36_), .O(new_n51_));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n28_), .c(new_n32_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n54_), .c(x05), .O(z2));
  inv1   g38(.a(x12), .O(new_n58_));
  nand4  g39(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n58_), .c(new_n20_), .O(new_n60_));
  aoi21  g41(.a(x13), .b(x09), .c(x11), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n36_), .c(x04), .d(x02), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n60_), .O(new_n63_));
  nor2   g44(.a(x07), .b(x03), .O(new_n64_));
  nor3   g45(.a(new_n64_), .b(new_n32_), .c(new_n29_), .O(new_n65_));
  oai21  g46(.a(new_n63_), .b(new_n28_), .c(new_n65_), .O(z3));
  inv1   g47(.a(x04), .O(new_n67_));
  nand3  g48(.a(new_n33_), .b(x13), .c(x09), .O(new_n68_));
