...
module FAU ( 
  ...
  nand2  g16(.a(new_n23_), .b(new_n25_), .O(new_n36_));
  ...
  nand2  g23(.a(x12), .b(x00), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(new_n42_), .c(new_n39_), .d(x05), .O(z1));
  ...
  nand3  g30(.a(new_n23_), .b(new_n45_), .c(new_n25_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n35_), .c(x11), .O(new_n51_));
  ...
  nand4  g39(.a(new_n48_), .b(new_n21_), .c(x04), .d(x02), .O(new_n59_));
  nand3  g40(.a(new_n23_), .b(new_n46_), .c(new_n45_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n26_), .c(x12), .O(new_n61_));
  ...
  nand3  g46(.a(new_n65_), .b(new_n43_), .c(x05), .O(new_n66_));
  inv1   g47(.a(new_n66_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n63_), .O(z3));
  nand4  g49(.a(new_n43_), .b(x13), .c(x09), .d(x04), .O(new_n69_));
