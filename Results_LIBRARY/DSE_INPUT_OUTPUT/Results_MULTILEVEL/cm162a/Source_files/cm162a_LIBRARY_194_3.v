...
module FAU ( 
  ...
  nor3   g33(.a(new_n52_), .b(x12), .c(new_n51_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n50_), .O(z2));
  nand4  g35(.a(new_n45_), .b(x04), .c(x03), .d(x02), .O(new_n55_));
  nor2   g36(.a(x07), .b(x03), .O(new_n56_));
  nor3   g37(.a(new_n56_), .b(x12), .c(new_n51_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n55_), .O(z3));
  oai22  g39(.a(new_n21_), .b(new_n23_), .c(new_n27_), .d(new_n51_), .O(z4));
endmodule
