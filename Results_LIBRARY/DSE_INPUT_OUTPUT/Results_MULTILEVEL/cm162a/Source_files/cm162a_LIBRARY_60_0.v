...
module FAU ( 
  ...
  oai21  g33(.a(x06), .b(x03), .c(new_n22_), .O(new_n53_));
  nor2   g34(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n51_), .O(z2));
  nand4  g36(.a(new_n46_), .b(new_n20_), .c(x04), .d(x02), .O(new_n56_));
  nand3  g37(.a(new_n31_), .b(new_n44_), .c(new_n36_), .O(new_n57_));
  ...
  nand2  g44(.a(new_n32_), .b(x04), .O(new_n64_));
