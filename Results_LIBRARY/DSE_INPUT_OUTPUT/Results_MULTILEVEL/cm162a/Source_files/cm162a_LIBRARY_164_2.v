...
module FAU ( 
  ...
  nand4  g35(.a(new_n33_), .b(new_n28_), .c(x04), .d(x02), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n54_), .c(new_n44_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x03), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n20_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n29_), .c(x05), .O(new_n60_));
