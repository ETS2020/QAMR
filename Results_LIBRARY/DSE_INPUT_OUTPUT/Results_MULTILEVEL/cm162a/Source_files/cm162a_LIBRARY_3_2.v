...
module FAU ( 
  ...
  aoi21  g34(.a(x07), .b(x05), .c(x03), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  nand3  g36(.a(x13), .b(x09), .c(x04), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n43_), .c(new_n42_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n28_), .c(x03), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x05), .c(new_n55_), .O(new_n59_));
  or2    g40(.a(new_n59_), .b(new_n54_), .O(z3));
  nand2  g41(.a(new_n55_), .b(x03), .O(new_n61_));
