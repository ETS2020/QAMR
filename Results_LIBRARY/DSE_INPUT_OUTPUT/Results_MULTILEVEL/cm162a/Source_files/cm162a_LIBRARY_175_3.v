...
module FAU ( 
  ...
  nand2  g17(.a(new_n36_), .b(x00), .O(new_n37_));
  ...
  nand2  g30(.a(new_n49_), .b(x00), .O(new_n50_));
  ...
  oai21  g52(.a(new_n71_), .b(new_n68_), .c(new_n31_), .O(new_n72_));
  ...
  aoi21  g57(.a(new_n25_), .b(new_n31_), .c(new_n21_), .O(z4));
endmodule
