...
module FAU ( 
  ...
  nand2  g02(.a(x06), .b(new_n21_), .O(new_n22_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n49_), .c(x05), .d(x03), .O(z2));
  ...
  oai21  g39(.a(new_n47_), .b(new_n37_), .c(x12), .O(new_n59_));
  ...
  oai21  g44(.a(new_n61_), .b(new_n21_), .c(new_n63_), .O(z3));
