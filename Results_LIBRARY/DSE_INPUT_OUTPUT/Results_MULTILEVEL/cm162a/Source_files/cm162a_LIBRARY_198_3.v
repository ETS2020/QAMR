...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n65_, new_n67_;
  nand2  g00(.a(x12), .b(x09), .O(new_n20_));
  ...
  nor2   g10(.a(new_n24_), .b(new_n21_), .O(new_n30_));
  nand4  g11(.a(new_n30_), .b(x13), .c(new_n29_), .d(x09), .O(new_n31_));
  ...
  aoi21  g20(.a(new_n22_), .b(new_n34_), .c(new_n39_), .O(new_n40_));
  nand4  g21(.a(new_n40_), .b(new_n29_), .c(x09), .d(x03), .O(new_n41_));
  ...
  nand4  g37(.a(new_n46_), .b(new_n29_), .c(x04), .d(x02), .O(new_n57_));
  inv1   g38(.a(x09), .O(new_n58_));
  nor2   g39(.a(x11), .b(x10), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n24_), .c(x04), .d(x02), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x12), .c(new_n58_), .O(new_n61_));
  ...
  aoi21  g48(.a(new_n67_), .b(new_n29_), .c(new_n58_), .O(z4));
endmodule
