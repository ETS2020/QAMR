...
module FAU ( 
  ...
  aoi21  g13(.a(new_n32_), .b(new_n25_), .c(new_n30_), .O(new_n33_));
  inv1   g14(.a(x02), .O(new_n34_));
  nor2   g15(.a(new_n30_), .b(new_n34_), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(new_n25_), .c(new_n20_), .O(new_n36_));
  aoi22  g17(.a(new_n36_), .b(x10), .c(new_n33_), .d(x02), .O(new_n37_));
  inv1   g18(.a(x01), .O(new_n38_));
  aoi21  g19(.a(new_n29_), .b(new_n38_), .c(new_n24_), .O(new_n39_));
  ...
  nand4  g26(.a(new_n25_), .b(new_n41_), .c(x04), .d(x02), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x11), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n45_), .c(new_n24_), .O(new_n48_));
  ...
  aoi22  g32(.a(new_n51_), .b(new_n29_), .c(x08), .d(new_n24_), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n54_), .b(new_n31_), .c(new_n56_), .O(new_n57_));
  ...
  aoi21  g45(.a(new_n64_), .b(new_n29_), .c(new_n24_), .O(new_n65_));
  oai21  g46(.a(new_n63_), .b(new_n29_), .c(new_n65_), .O(z3));
  inv1   g47(.a(x09), .O(new_n67_));
  oai21  g48(.a(x08), .b(x05), .c(x13), .O(new_n68_));
  nor3   g49(.a(new_n68_), .b(new_n67_), .c(new_n30_), .O(z4));
endmodule
