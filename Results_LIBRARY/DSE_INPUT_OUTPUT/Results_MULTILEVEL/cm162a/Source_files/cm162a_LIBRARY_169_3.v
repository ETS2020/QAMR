...
module FAU ( 
  ...
  nand4  g18(.a(new_n36_), .b(new_n24_), .c(x04), .d(x02), .O(new_n38_));
  ...
  nand3  g28(.a(new_n36_), .b(new_n34_), .c(new_n24_), .O(new_n48_));
  ...
  nand3  g41(.a(new_n60_), .b(new_n58_), .c(x12), .O(new_n61_));
