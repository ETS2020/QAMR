...
module FAU ( 
  ...
  nor2   g09(.a(x07), .b(x06), .O(new_n29_));
  ...
  nand2  g15(.a(new_n21_), .b(new_n23_), .O(new_n35_));
  ...
  nand3  g27(.a(new_n21_), .b(new_n42_), .c(new_n23_), .O(new_n47_));
  ...
  nand2  g32(.a(x07), .b(x03), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n51_), .c(new_n27_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n50_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n43_), .c(new_n42_), .d(new_n23_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n21_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  nand3  g39(.a(new_n21_), .b(new_n43_), .c(new_n42_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n24_), .c(x12), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n58_), .c(new_n29_), .O(new_n61_));
  nor2   g42(.a(new_n51_), .b(x05), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n61_), .c(x03), .O(new_n63_));
  nor2   g44(.a(x07), .b(new_n51_), .O(new_n64_));
  aoi22  g45(.a(new_n64_), .b(new_n20_), .c(x07), .d(new_n27_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n63_), .O(z3));
  inv1   g47(.a(x04), .O(new_n67_));
  oai22  g48(.a(new_n21_), .b(new_n67_), .c(x07), .d(x06), .O(z4));
endmodule
