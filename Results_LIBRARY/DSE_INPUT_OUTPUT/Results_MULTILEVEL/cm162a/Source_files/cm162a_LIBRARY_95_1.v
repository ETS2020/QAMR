...
module FAU ( 
  ...
  nand3  g27(.a(new_n21_), .b(new_n42_), .c(new_n33_), .O(new_n47_));
  ...
  nor2   g41(.a(new_n44_), .b(new_n32_), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n39_), .O(new_n62_));
  ...
  nand2  g47(.a(x12), .b(new_n27_), .O(new_n67_));
