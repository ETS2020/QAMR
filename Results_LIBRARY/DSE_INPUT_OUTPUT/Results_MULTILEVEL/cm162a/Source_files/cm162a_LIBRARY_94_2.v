...
module FAU ( 
  ...
  nand4  g29(.a(new_n24_), .b(new_n48_), .c(new_n33_), .d(new_n23_), .O(new_n49_));
  ...
  nand3  g40(.a(new_n35_), .b(new_n48_), .c(new_n33_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n25_), .c(x12), .O(new_n61_));
  inv1   g42(.a(x09), .O(new_n62_));
  nand4  g43(.a(new_n41_), .b(new_n48_), .c(new_n33_), .d(new_n62_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n25_), .c(new_n61_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x03), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n59_), .O(z3));
  nand2  g47(.a(x13), .b(x04), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(x12), .c(new_n62_), .O(z4));
endmodule
