...
module FAU ( 
  ...
  nand3  g35(.a(new_n48_), .b(new_n28_), .c(new_n23_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n20_), .c(new_n43_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n35_), .O(new_n61_));
  aoi21  g42(.a(x07), .b(new_n20_), .c(new_n35_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n43_), .c(x10), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  nand4  g45(.a(new_n29_), .b(x13), .c(x09), .d(x04), .O(new_n65_));
