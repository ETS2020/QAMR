...
module FAU ( 
  ...
  nand3  g26(.a(new_n41_), .b(new_n21_), .c(new_n33_), .O(new_n46_));
  ...
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x13), .O(new_n50_));
  ...
  nor2   g39(.a(new_n43_), .b(new_n32_), .O(new_n59_));
  nor2   g40(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  aoi21  g41(.a(new_n57_), .b(x04), .c(new_n60_), .O(new_n61_));
  inv1   g42(.a(x05), .O(new_n62_));
  oai21  g43(.a(x07), .b(x03), .c(x13), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  oai21  g45(.a(new_n61_), .b(new_n20_), .c(new_n64_), .O(z3));
  nand3  g46(.a(x13), .b(x09), .c(x04), .O(new_n66_));
  oai21  g47(.a(x13), .b(new_n62_), .c(new_n66_), .O(z4));
endmodule
