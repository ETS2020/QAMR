...
module FAU ( 
  ...
  inv1   g40(.a(new_n27_), .O(new_n60_));
  nand3  g41(.a(new_n23_), .b(new_n43_), .c(new_n42_), .O(new_n61_));
  inv1   g42(.a(new_n61_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n60_), .c(new_n54_), .O(new_n63_));
  ...
  oai21  g49(.a(x12), .b(x03), .c(x13), .O(new_n69_));
  nor3   g50(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z4));
endmodule
