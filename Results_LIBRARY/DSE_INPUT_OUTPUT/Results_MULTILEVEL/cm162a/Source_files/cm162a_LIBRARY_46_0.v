...
module FAU ( 
  ...
  nand2  g34(.a(new_n45_), .b(x03), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  inv1   g36(.a(new_n27_), .O(new_n56_));
  nand3  g37(.a(new_n23_), .b(new_n42_), .c(new_n41_), .O(new_n57_));
  inv1   g38(.a(new_n57_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(new_n53_), .O(new_n59_));
  oai21  g40(.a(x07), .b(x03), .c(x05), .O(new_n60_));
  aoi21  g41(.a(new_n59_), .b(x03), .c(new_n60_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n55_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n23_), .b(new_n63_), .c(x12), .d(x03), .O(z4));
endmodule
