...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n28_), .c(x04), .d(x02), .O(new_n39_));
  ...
  nand4  g38(.a(new_n21_), .b(new_n45_), .c(new_n36_), .d(new_n28_), .O(new_n58_));
  nand3  g39(.a(x13), .b(x09), .c(x04), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n58_), .c(new_n25_), .O(new_n60_));
  nand2  g41(.a(new_n28_), .b(x02), .O(new_n61_));
  nand3  g42(.a(new_n59_), .b(new_n45_), .c(new_n36_), .O(new_n62_));
  ...
  nand2  g50(.a(new_n59_), .b(new_n22_), .O(z4));
endmodule
