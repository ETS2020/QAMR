...
module FAU ( 
  ...
  nand4  g35(.a(new_n54_), .b(new_n43_), .c(new_n42_), .d(new_n23_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(x07), .c(x04), .d(x02), .O(new_n57_));
  ...
  inv1   g42(.a(new_n29_), .O(new_n62_));
  nor2   g43(.a(new_n54_), .b(x07), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(new_n20_), .c(new_n62_), .d(new_n27_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n61_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai21  g47(.a(new_n21_), .b(new_n66_), .c(new_n62_), .O(z4));
endmodule
