...
module FAU ( 
  ...
  nor2   g43(.a(new_n62_), .b(new_n55_), .O(new_n63_));
  inv1   g44(.a(new_n45_), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(new_n65_));
  aoi21  g46(.a(new_n60_), .b(x04), .c(new_n65_), .O(new_n66_));
  aoi21  g47(.a(x07), .b(x05), .c(x03), .O(new_n67_));
  aoi21  g48(.a(x12), .b(x10), .c(x05), .O(new_n68_));
  nor2   g49(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  oai21  g50(.a(new_n66_), .b(new_n20_), .c(new_n69_), .O(z3));
  oai22  g51(.a(new_n21_), .b(new_n62_), .c(x10), .d(x05), .O(z4));
endmodule
