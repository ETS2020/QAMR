...
module FAU ( 
  ...
  nand3  g14(.a(new_n33_), .b(new_n26_), .c(x05), .O(new_n34_));
  ...
  nand4  g28(.a(new_n47_), .b(new_n33_), .c(new_n26_), .d(x05), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n35_), .c(new_n32_), .O(new_n49_));
  nand2  g30(.a(new_n33_), .b(new_n26_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n24_), .c(x05), .O(new_n51_));
  ...
  nand2  g37(.a(new_n26_), .b(x05), .O(new_n57_));
  ...
  nand3  g43(.a(new_n47_), .b(new_n33_), .c(new_n26_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n24_), .c(x05), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n35_), .c(new_n58_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n62_), .c(x03), .O(new_n66_));
  nor2   g47(.a(x07), .b(new_n41_), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n23_), .c(new_n44_), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n66_), .O(z3));
  oai22  g50(.a(new_n35_), .b(new_n32_), .c(x09), .d(x05), .O(z4));
endmodule
