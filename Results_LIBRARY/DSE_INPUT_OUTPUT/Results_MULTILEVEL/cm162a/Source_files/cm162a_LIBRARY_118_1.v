...
module FAU ( 
  ...
  nand4  g20(.a(new_n23_), .b(new_n26_), .c(x04), .d(x02), .O(new_n40_));
  ...
  oai21  g28(.a(new_n47_), .b(new_n32_), .c(new_n21_), .O(new_n48_));
  inv1   g29(.a(x11), .O(new_n49_));
  nand2  g30(.a(new_n40_), .b(new_n37_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n49_), .O(new_n51_));
  nand3  g32(.a(new_n37_), .b(new_n49_), .c(new_n20_), .O(new_n52_));
  ...
  nand3  g36(.a(new_n49_), .b(new_n20_), .c(new_n26_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n23_), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(x04), .c(x03), .d(x02), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n31_), .c(new_n32_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n37_), .O(new_n62_));
  aoi21  g43(.a(x07), .b(new_n31_), .c(new_n37_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n32_), .c(x10), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  nand2  g46(.a(new_n46_), .b(new_n21_), .O(z4));
endmodule
