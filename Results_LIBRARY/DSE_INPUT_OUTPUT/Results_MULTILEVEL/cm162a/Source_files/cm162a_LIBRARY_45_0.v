...
module FAU ( 
  ...
  nor2   g22(.a(x12), .b(x02), .O(new_n42_));
  nor3   g23(.a(new_n42_), .b(new_n41_), .c(new_n31_), .O(new_n43_));
  ...
  nand3  g30(.a(new_n25_), .b(new_n45_), .c(new_n22_), .O(new_n50_));
  ...
  nor4   g49(.a(new_n42_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(z4));
endmodule
