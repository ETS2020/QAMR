...
module FAU ( 
  ...
  nand4  g11(.a(new_n21_), .b(new_n27_), .c(x04), .d(x02), .O(new_n31_));
  ...
  nand4  g26(.a(new_n45_), .b(new_n34_), .c(new_n28_), .d(new_n27_), .O(new_n46_));
  ...
  oai21  g31(.a(new_n35_), .b(new_n38_), .c(x12), .O(new_n51_));
