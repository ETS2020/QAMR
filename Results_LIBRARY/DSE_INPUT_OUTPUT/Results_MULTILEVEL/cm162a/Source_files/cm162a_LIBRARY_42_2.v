...
module FAU ( 
  ...
  nand4  g33(.a(new_n52_), .b(new_n42_), .c(new_n41_), .d(new_n26_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n23_), .c(new_n51_), .O(new_n54_));
  nand3  g35(.a(x13), .b(x12), .c(x09), .O(new_n55_));
  inv1   g36(.a(new_n55_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n54_), .c(x04), .O(new_n57_));
  oai21  g38(.a(new_n43_), .b(new_n33_), .c(x12), .O(new_n58_));
