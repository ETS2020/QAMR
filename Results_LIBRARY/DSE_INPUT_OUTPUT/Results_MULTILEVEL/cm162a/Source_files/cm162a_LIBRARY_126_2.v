...
module FAU ( 
  ...
  nand3  g10(.a(new_n29_), .b(new_n28_), .c(x08), .O(new_n30_));
  ...
  aoi21  g16(.a(new_n29_), .b(new_n35_), .c(new_n24_), .O(new_n36_));
  oai21  g17(.a(new_n36_), .b(new_n25_), .c(x08), .O(new_n37_));
  nand2  g18(.a(x06), .b(x05), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n24_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n37_), .O(z2));
  inv1   g21(.a(x12), .O(new_n41_));
  aoi21  g22(.a(new_n29_), .b(new_n41_), .c(new_n24_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n25_), .c(x08), .O(new_n43_));
  nand2  g24(.a(x07), .b(x05), .O(new_n44_));
