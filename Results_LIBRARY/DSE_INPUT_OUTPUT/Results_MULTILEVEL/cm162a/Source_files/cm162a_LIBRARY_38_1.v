...
module FAU ( 
  ...
  inv1   g09(.a(x02), .O(new_n29_));
  nand2  g10(.a(x04), .b(new_n29_), .O(new_n30_));
  nand4  g11(.a(new_n30_), .b(new_n28_), .c(new_n25_), .d(x05), .O(z0));
  inv1   g12(.a(x10), .O(new_n32_));
  oai21  g13(.a(new_n32_), .b(new_n27_), .c(new_n20_), .O(new_n33_));
  ...
  nor2   g18(.a(new_n37_), .b(new_n20_), .O(new_n38_));
  nor2   g19(.a(new_n35_), .b(x08), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(x04), .c(new_n32_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n38_), .c(x03), .O(new_n41_));
  inv1   g22(.a(x01), .O(new_n42_));
  nand2  g23(.a(new_n27_), .b(new_n42_), .O(new_n43_));
  ...
  nand3  g28(.a(new_n47_), .b(new_n32_), .c(new_n23_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n21_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x04), .O(new_n50_));
  nand3  g31(.a(new_n21_), .b(new_n32_), .c(new_n23_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x11), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n50_), .c(new_n29_), .O(new_n53_));
  nor2   g34(.a(new_n47_), .b(x04), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n53_), .c(x03), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n46_), .O(z2));
  oai21  g37(.a(x07), .b(x03), .c(x05), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n30_), .O(new_n58_));
  nor2   g39(.a(x12), .b(x11), .O(new_n59_));
  aoi22  g40(.a(new_n59_), .b(new_n36_), .c(x13), .d(x09), .O(new_n60_));
  nand2  g41(.a(new_n48_), .b(x12), .O(new_n61_));
  oai21  g42(.a(new_n60_), .b(new_n20_), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x12), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(x04), .O(new_n64_));
  aoi21  g45(.a(new_n62_), .b(x02), .c(new_n64_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n27_), .c(new_n58_), .O(z3));
  nand3  g47(.a(new_n35_), .b(x04), .c(x02), .O(new_n67_));
