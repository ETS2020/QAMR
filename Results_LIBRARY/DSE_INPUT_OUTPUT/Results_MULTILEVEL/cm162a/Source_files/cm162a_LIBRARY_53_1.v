...
module FAU ( 
  ...
  nor2   g40(.a(new_n44_), .b(new_n47_), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  aoi21  g42(.a(new_n58_), .b(x04), .c(new_n61_), .O(new_n62_));
  aoi21  g43(.a(new_n30_), .b(new_n20_), .c(new_n29_), .O(new_n63_));
  oai21  g44(.a(new_n62_), .b(new_n20_), .c(new_n63_), .O(z3));
  oai22  g45(.a(new_n21_), .b(new_n33_), .c(new_n30_), .d(x05), .O(z4));
endmodule
