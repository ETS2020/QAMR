...
module FAU ( 
  ...
  oai21  g06(.a(x08), .b(new_n25_), .c(new_n24_), .O(new_n26_));
  ...
  oai21  g13(.a(new_n32_), .b(new_n25_), .c(new_n31_), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n24_), .O(new_n34_));
  oai21  g15(.a(x10), .b(x08), .c(new_n27_), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(x04), .c(x02), .O(new_n36_));
  nand2  g17(.a(x04), .b(x02), .O(new_n37_));
  nand2  g18(.a(new_n27_), .b(new_n20_), .O(new_n38_));
  ...
  aoi21  g24(.a(new_n25_), .b(new_n42_), .c(new_n43_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n41_), .c(new_n34_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n25_), .c(new_n31_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n24_), .O(new_n48_));
  nand3  g29(.a(new_n46_), .b(new_n32_), .c(new_n20_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n27_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x04), .c(x02), .O(new_n51_));
  nand3  g32(.a(new_n27_), .b(new_n32_), .c(new_n20_), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n56_), .b(new_n25_), .c(new_n43_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(new_n48_), .O(z2));
  inv1   g39(.a(x12), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n46_), .c(new_n32_), .d(new_n20_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n27_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x04), .c(x02), .O(new_n62_));
  nand2  g43(.a(new_n20_), .b(x02), .O(new_n63_));
  nand3  g44(.a(new_n27_), .b(new_n46_), .c(new_n32_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n63_), .c(x12), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n62_), .c(new_n25_), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n25_), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(x05), .O(new_n69_));
  oai21  g50(.a(new_n69_), .b(new_n66_), .c(x00), .O(new_n70_));
  ...
  aoi21  g55(.a(new_n27_), .b(x00), .c(new_n31_), .O(z4));
endmodule
