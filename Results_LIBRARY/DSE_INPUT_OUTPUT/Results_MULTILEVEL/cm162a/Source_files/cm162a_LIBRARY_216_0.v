...
module FAU ( 
  ...
  oai22  g25(.a(new_n44_), .b(new_n43_), .c(x06), .d(x03), .O(new_n45_));
  oai21  g26(.a(new_n45_), .b(new_n30_), .c(new_n42_), .O(new_n46_));
  inv1   g27(.a(x10), .O(new_n47_));
  inv1   g28(.a(x11), .O(new_n48_));
  nand2  g29(.a(new_n35_), .b(x12), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n47_), .c(new_n48_), .O(new_n50_));
  nand3  g31(.a(x12), .b(new_n48_), .c(new_n47_), .O(new_n51_));
  ...
  inv1   g35(.a(x13), .O(new_n55_));
  aoi21  g36(.a(x04), .b(x02), .c(x12), .O(new_n56_));
  nor2   g37(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nor2   g38(.a(x11), .b(x10), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n24_), .c(x04), .d(x02), .O(new_n59_));
  aoi22  g40(.a(new_n59_), .b(x12), .c(new_n57_), .d(x09), .O(new_n60_));
  nor2   g41(.a(x07), .b(x03), .O(new_n61_));
  nor3   g42(.a(new_n61_), .b(new_n20_), .c(new_n30_), .O(new_n62_));
  oai21  g43(.a(new_n60_), .b(new_n29_), .c(new_n62_), .O(z3));
  nand2  g44(.a(new_n44_), .b(new_n42_), .O(z4));
endmodule
