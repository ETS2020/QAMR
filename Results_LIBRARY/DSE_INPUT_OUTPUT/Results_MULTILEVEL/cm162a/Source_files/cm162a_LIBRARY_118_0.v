...
module FAU ( 
  ...
  oai21  g18(.a(x10), .b(x08), .c(new_n24_), .O(new_n38_));
  nand4  g19(.a(new_n38_), .b(x12), .c(x04), .d(x02), .O(new_n39_));
  nand4  g20(.a(new_n24_), .b(new_n27_), .c(x04), .d(x02), .O(new_n40_));
  ...
  oai21  g28(.a(new_n47_), .b(new_n33_), .c(new_n22_), .O(new_n48_));
  inv1   g29(.a(x11), .O(new_n49_));
  nand2  g30(.a(new_n40_), .b(x12), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n49_), .O(new_n51_));
  nand3  g32(.a(x12), .b(new_n49_), .c(new_n20_), .O(new_n52_));
  ...
  nand3  g39(.a(x10), .b(x04), .c(x02), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n21_), .c(new_n58_), .O(new_n60_));
  nor2   g41(.a(x11), .b(x10), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n27_), .c(x04), .d(x02), .O(new_n62_));
  aoi22  g43(.a(new_n62_), .b(x12), .c(new_n60_), .d(x09), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n32_), .c(new_n57_), .O(z3));
  nand2  g45(.a(new_n46_), .b(new_n22_), .O(z4));
endmodule
