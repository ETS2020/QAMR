...
module FAU ( 
  ...
  aoi21  g10(.a(new_n29_), .b(new_n27_), .c(new_n20_), .O(new_n30_));
  oai21  g11(.a(new_n30_), .b(new_n23_), .c(new_n24_), .O(new_n31_));
  ...
  oai22  g40(.a(new_n25_), .b(new_n59_), .c(new_n24_), .d(new_n20_), .O(z4));
endmodule
