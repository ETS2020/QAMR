...
module FAU ( 
  ...
  nand2  g09(.a(new_n28_), .b(x07), .O(new_n29_));
  ...
  oai21  g37(.a(new_n21_), .b(x07), .c(new_n46_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  nor2   g39(.a(x07), .b(new_n20_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n28_), .O(new_n61_));
  nand3  g42(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n62_));
  inv1   g43(.a(new_n62_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n25_), .c(new_n28_), .O(new_n64_));
