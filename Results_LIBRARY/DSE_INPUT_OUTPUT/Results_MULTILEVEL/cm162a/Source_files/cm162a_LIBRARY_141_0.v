...
module FAU ( 
  ...
  aoi21  g20(.a(new_n36_), .b(x02), .c(new_n39_), .O(new_n40_));
  nor2   g21(.a(x03), .b(x01), .O(new_n41_));
  nor3   g22(.a(new_n41_), .b(new_n20_), .c(new_n30_), .O(new_n42_));
  oai21  g23(.a(new_n40_), .b(new_n29_), .c(new_n42_), .O(z1));
  oai21  g24(.a(x06), .b(x03), .c(x05), .O(new_n44_));
  oai21  g25(.a(x11), .b(x10), .c(new_n44_), .O(new_n45_));
  inv1   g26(.a(x11), .O(new_n46_));
  inv1   g27(.a(x13), .O(new_n47_));
  nand3  g28(.a(x10), .b(x04), .c(x02), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n46_), .c(new_n47_), .O(new_n49_));
  nand3  g30(.a(new_n37_), .b(new_n34_), .c(new_n24_), .O(new_n50_));
  aoi22  g31(.a(new_n50_), .b(x11), .c(new_n49_), .d(x09), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n29_), .c(new_n45_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand2  g34(.a(x04), .b(x02), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n21_), .c(new_n53_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x03), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n29_), .c(new_n30_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(new_n20_), .O(z3));
  inv1   g40(.a(x09), .O(new_n60_));
  nor4   g41(.a(new_n20_), .b(new_n47_), .c(new_n60_), .d(new_n33_), .O(z4));
endmodule
