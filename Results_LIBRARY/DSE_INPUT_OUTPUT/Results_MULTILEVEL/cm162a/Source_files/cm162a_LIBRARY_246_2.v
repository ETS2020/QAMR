...
module FAU ( 
  ...
  nand2  g07(.a(x09), .b(x05), .O(new_n27_));
  ...
  oai21  g18(.a(new_n37_), .b(new_n36_), .c(x09), .O(new_n38_));
  ...
  nand4  g31(.a(new_n50_), .b(new_n48_), .c(x09), .d(x05), .O(z2));
  ...
  oai21  g43(.a(x07), .b(x03), .c(x09), .O(new_n63_));
  ...
  oai21  g47(.a(x09), .b(new_n62_), .c(new_n66_), .O(z4));
endmodule
