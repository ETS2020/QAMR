...
module FAU ( 
  ...
  aoi21  g11(.a(new_n30_), .b(new_n27_), .c(new_n20_), .O(z0));
  oai21  g12(.a(x10), .b(x08), .c(new_n21_), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(x04), .c(x02), .O(new_n33_));
  nand4  g14(.a(new_n21_), .b(new_n24_), .c(x04), .d(x02), .O(new_n34_));
  ...
  nor3   g19(.a(new_n38_), .b(new_n20_), .c(new_n28_), .O(new_n39_));
  ...
  oai21  g25(.a(new_n44_), .b(new_n28_), .c(new_n41_), .O(new_n45_));
  inv1   g26(.a(x10), .O(new_n46_));
  inv1   g27(.a(x11), .O(new_n47_));
  nand2  g28(.a(new_n34_), .b(x12), .O(new_n48_));
  ...
  nand4  g38(.a(new_n47_), .b(new_n24_), .c(x04), .d(x02), .O(new_n58_));
  ...
  nor3   g44(.a(new_n63_), .b(new_n20_), .c(new_n28_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  nand3  g46(.a(new_n41_), .b(x13), .c(x09), .O(new_n66_));
