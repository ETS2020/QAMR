...
module FAU ( 
  ...
  aoi21  g22(.a(new_n41_), .b(new_n39_), .c(new_n30_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n38_), .O(z1));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n29_), .c(new_n24_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand2  g28(.a(new_n35_), .b(x11), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n47_), .c(new_n40_), .O(new_n49_));
  nor2   g30(.a(new_n44_), .b(new_n29_), .O(new_n50_));
  ...
  nand3  g38(.a(x13), .b(x09), .c(x05), .O(new_n58_));
  inv1   g39(.a(new_n58_), .O(new_n59_));
  aoi21  g40(.a(new_n57_), .b(new_n56_), .c(new_n59_), .O(new_n60_));
  nand4  g41(.a(x13), .b(x12), .c(x09), .d(x05), .O(new_n61_));
  oai21  g42(.a(new_n60_), .b(new_n55_), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x12), .O(new_n63_));
  inv1   g44(.a(x04), .O(new_n64_));
  nor2   g45(.a(new_n64_), .b(new_n55_), .O(new_n65_));
  inv1   g46(.a(new_n45_), .O(new_n66_));
  aoi21  g47(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(new_n67_));
  aoi21  g48(.a(new_n62_), .b(x04), .c(new_n67_), .O(new_n68_));
  inv1   g49(.a(x07), .O(new_n69_));
  aoi21  g50(.a(new_n69_), .b(new_n20_), .c(new_n40_), .O(new_n70_));
  oai21  g51(.a(new_n68_), .b(new_n20_), .c(new_n70_), .O(z3));
  inv1   g52(.a(x09), .O(new_n72_));
  oai21  g53(.a(x10), .b(x05), .c(x13), .O(new_n73_));
  nor3   g54(.a(new_n73_), .b(new_n72_), .c(new_n64_), .O(z4));
endmodule
