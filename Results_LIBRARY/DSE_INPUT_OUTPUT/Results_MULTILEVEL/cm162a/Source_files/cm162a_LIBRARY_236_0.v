...
module FAU ( 
  ...
  aoi21  g20(.a(new_n39_), .b(new_n20_), .c(new_n38_), .O(new_n40_));
  ...
  aoi21  g32(.a(new_n51_), .b(new_n20_), .c(new_n38_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand2  g35(.a(new_n46_), .b(x03), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  inv1   g37(.a(new_n27_), .O(new_n57_));
  nand3  g38(.a(new_n23_), .b(new_n43_), .c(new_n42_), .O(new_n58_));
  inv1   g39(.a(new_n58_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n57_), .c(new_n54_), .O(new_n60_));
  oai21  g41(.a(x07), .b(x03), .c(x05), .O(new_n61_));
  aoi21  g42(.a(new_n60_), .b(x03), .c(new_n61_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n56_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  oai22  g45(.a(new_n23_), .b(new_n64_), .c(x12), .d(x03), .O(z4));
endmodule
