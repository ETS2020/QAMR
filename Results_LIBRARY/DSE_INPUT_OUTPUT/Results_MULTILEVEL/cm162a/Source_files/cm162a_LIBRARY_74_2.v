...
module FAU ( 
  ...
  aoi21  g06(.a(new_n25_), .b(x04), .c(new_n20_), .O(new_n26_));
  ...
  nand3  g17(.a(new_n25_), .b(new_n28_), .c(x04), .O(new_n37_));
  ...
  nand3  g26(.a(new_n45_), .b(new_n40_), .c(new_n28_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n25_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand4  g29(.a(new_n25_), .b(new_n40_), .c(new_n28_), .d(x04), .O(new_n49_));
  ...
  oai21  g35(.a(new_n54_), .b(new_n51_), .c(x12), .O(new_n55_));
  nand2  g36(.a(x11), .b(x03), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n53_), .c(x05), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n55_), .O(z2));
  oai21  g40(.a(x07), .b(x03), .c(x05), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n21_), .O(new_n61_));
  nand3  g42(.a(new_n28_), .b(x04), .c(x02), .O(new_n62_));
  nand3  g43(.a(new_n25_), .b(new_n45_), .c(new_n40_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n62_), .c(x12), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n44_), .c(new_n61_), .O(z3));
  nand4  g46(.a(new_n21_), .b(x13), .c(x09), .d(x04), .O(new_n66_));
