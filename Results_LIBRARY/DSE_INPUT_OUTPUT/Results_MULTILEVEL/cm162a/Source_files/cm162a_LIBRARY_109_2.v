...
module FAU ( 
  ...
  nand3  g14(.a(new_n24_), .b(x12), .c(new_n20_), .O(new_n34_));
  ...
  nand2  g19(.a(new_n28_), .b(new_n38_), .O(new_n39_));
  inv1   g20(.a(x12), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x04), .O(new_n41_));
  nand4  g22(.a(new_n41_), .b(new_n39_), .c(new_n37_), .d(x05), .O(z1));
  ...
  nand4  g28(.a(new_n24_), .b(new_n43_), .c(new_n20_), .d(x02), .O(new_n48_));
  ...
  nand4  g41(.a(new_n60_), .b(new_n43_), .c(new_n20_), .d(x02), .O(new_n61_));
  nor2   g42(.a(new_n40_), .b(x04), .O(new_n62_));
  aoi21  g43(.a(new_n61_), .b(x04), .c(new_n62_), .O(new_n63_));
  inv1   g44(.a(x07), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n28_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n41_), .c(x05), .O(new_n66_));
