...
module FAU ( 
  ...
  oai21  g39(.a(new_n43_), .b(new_n34_), .c(x12), .O(new_n59_));
  ...
  nand2  g43(.a(new_n62_), .b(new_n30_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  inv1   g45(.a(x09), .O(new_n65_));
  oai21  g46(.a(x05), .b(x00), .c(x13), .O(new_n66_));
  nor3   g47(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(z4));
endmodule
