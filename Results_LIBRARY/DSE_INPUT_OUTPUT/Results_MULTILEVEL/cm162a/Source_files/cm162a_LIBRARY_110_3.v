...
module FAU ( 
  ...
  aoi21  g30(.a(new_n22_), .b(new_n49_), .c(new_n39_), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n29_), .c(x09), .d(x03), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n48_), .O(z2));
  inv1   g33(.a(x04), .O(new_n53_));
  nand4  g34(.a(new_n29_), .b(new_n49_), .c(new_n34_), .d(new_n24_), .O(new_n54_));
  nand2  g35(.a(x13), .b(x09), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(new_n56_));
  aoi22  g37(.a(new_n56_), .b(x02), .c(new_n45_), .d(x12), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n21_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n20_), .c(x05), .O(new_n60_));
  inv1   g41(.a(new_n60_), .O(new_n61_));
  oai21  g42(.a(new_n57_), .b(new_n21_), .c(new_n61_), .O(z3));
  nand2  g43(.a(x09), .b(x04), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n29_), .c(new_n39_), .O(z4));
endmodule
