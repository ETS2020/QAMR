...
module FAU ( 
  ...
  nand3  g39(.a(new_n24_), .b(new_n47_), .c(new_n46_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n28_), .c(x12), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  nand2  g43(.a(x12), .b(x03), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n20_), .c(new_n33_), .O(new_n64_));
