...
module FAU ( 
  ...
  oai21  g37(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(new_n57_));
  inv1   g38(.a(x12), .O(new_n58_));
  nor2   g39(.a(new_n41_), .b(new_n44_), .O(new_n59_));
  ...
  aoi21  g46(.a(new_n65_), .b(x05), .c(new_n50_), .O(z4));
endmodule
