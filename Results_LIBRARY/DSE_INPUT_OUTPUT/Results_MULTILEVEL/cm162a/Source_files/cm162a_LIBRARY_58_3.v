...
module FAU ( 
  ...
  aoi21  g34(.a(new_n53_), .b(new_n30_), .c(new_n21_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n52_), .c(x05), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n47_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x05), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand3  g41(.a(new_n22_), .b(new_n45_), .c(new_n44_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n26_), .c(x12), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(x05), .c(x03), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n59_), .O(z3));
