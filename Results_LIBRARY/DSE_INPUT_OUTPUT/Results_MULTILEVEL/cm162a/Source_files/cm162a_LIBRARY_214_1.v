...
module FAU ( 
  ...
  aoi21  g38(.a(x13), .b(x09), .c(x11), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n24_), .c(new_n42_), .d(x02), .O(new_n59_));
  ...
  oai22  g46(.a(new_n21_), .b(new_n23_), .c(new_n54_), .d(x05), .O(z4));
endmodule
