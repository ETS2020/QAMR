...
module FAU ( 
  ...
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x09), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(x05), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n42_), .c(new_n41_), .d(new_n23_), .O(new_n53_));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n55_), .c(new_n20_), .O(new_n58_));
  nor2   g39(.a(x07), .b(x03), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n58_), .c(x09), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x05), .O(z3));
  inv1   g42(.a(x05), .O(new_n62_));
  nand3  g43(.a(x13), .b(x09), .c(x04), .O(new_n63_));
  oai21  g44(.a(x09), .b(new_n62_), .c(new_n63_), .O(z4));
endmodule
