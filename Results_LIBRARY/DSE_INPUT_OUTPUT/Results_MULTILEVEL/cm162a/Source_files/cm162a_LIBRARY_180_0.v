...
module FAU ( 
  ...
  nor2   g08(.a(x12), .b(x06), .O(new_n28_));
  ...
  nor2   g35(.a(new_n51_), .b(x06), .O(new_n55_));
  aoi22  g36(.a(new_n55_), .b(new_n20_), .c(x06), .d(new_n54_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n53_), .O(z2));
  inv1   g38(.a(x06), .O(new_n58_));
  oai21  g39(.a(new_n21_), .b(new_n58_), .c(new_n45_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n51_), .c(x04), .d(x02), .O(new_n60_));
  ...
  nor3   g46(.a(new_n65_), .b(new_n28_), .c(new_n54_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  inv1   g48(.a(x04), .O(new_n68_));
  nand3  g49(.a(new_n29_), .b(x13), .c(x09), .O(new_n69_));
  nor2   g50(.a(new_n69_), .b(new_n68_), .O(z4));
endmodule
