...
module FAU ( 
  ...
  nor2   g39(.a(x07), .b(new_n31_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n49_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n20_), .O(new_n61_));
  inv1   g42(.a(new_n27_), .O(new_n62_));
  nand3  g43(.a(new_n23_), .b(new_n46_), .c(new_n45_), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n62_), .c(new_n20_), .O(new_n65_));
  oai21  g46(.a(x07), .b(x03), .c(x05), .O(new_n66_));
  aoi21  g47(.a(new_n65_), .b(x03), .c(new_n66_), .O(new_n67_));
