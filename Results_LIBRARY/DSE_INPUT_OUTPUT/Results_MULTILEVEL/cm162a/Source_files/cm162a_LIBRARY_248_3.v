...
module FAU ( 
  ...
  aoi21  g22(.a(x12), .b(x08), .c(x06), .O(new_n42_));
  nor2   g23(.a(x12), .b(x05), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n42_), .c(new_n20_), .O(new_n44_));
  oai21  g25(.a(x12), .b(x11), .c(x08), .O(new_n45_));
  ...
  nand4  g30(.a(new_n21_), .b(new_n32_), .c(x04), .d(x02), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(x11), .O(new_n51_));
  inv1   g32(.a(x11), .O(new_n52_));
  nand3  g33(.a(new_n36_), .b(new_n52_), .c(new_n32_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n51_), .c(x08), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x11), .c(x08), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n54_), .c(x03), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n49_), .c(new_n44_), .O(z2));
  nand3  g40(.a(new_n52_), .b(new_n32_), .c(new_n31_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n21_), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n55_), .c(x04), .d(x02), .O(new_n62_));
  nand3  g43(.a(new_n21_), .b(new_n52_), .c(new_n32_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n35_), .c(x12), .O(new_n64_));
  ...
  nand2  g52(.a(new_n47_), .b(new_n27_), .O(z4));
endmodule
