...
module FAU ( 
  ...
  nand3  g26(.a(new_n20_), .b(new_n45_), .c(new_n26_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n23_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n23_), .b(new_n45_), .c(new_n26_), .O(new_n49_));
  ...
  aoi21  g39(.a(new_n46_), .b(new_n23_), .c(new_n58_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(x02), .c(x12), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n31_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n21_), .c(x05), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  oai21  g45(.a(new_n60_), .b(new_n31_), .c(new_n64_), .O(z3));
  oai21  g46(.a(new_n23_), .b(new_n58_), .c(new_n21_), .O(z4));
endmodule
