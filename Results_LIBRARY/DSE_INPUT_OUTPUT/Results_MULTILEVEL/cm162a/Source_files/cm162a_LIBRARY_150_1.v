// Benchmark "FAU" written by ABC on Thu Aug 13 15:06:37 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(x05), .O(new_n51_));
  ...
  nand3  g42(.a(new_n61_), .b(x04), .c(x03), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  oai21  g44(.a(x12), .b(new_n63_), .c(new_n31_), .O(new_n64_));
  oai21  g45(.a(new_n46_), .b(new_n36_), .c(x12), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n64_), .c(x05), .O(new_n66_));
  inv1   g47(.a(new_n66_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n62_), .O(z3));
  oai21  g49(.a(x12), .b(x02), .c(x03), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(x12), .O(new_n70_));
  nand4  g51(.a(new_n70_), .b(x13), .c(x09), .d(x04), .O(new_n71_));
