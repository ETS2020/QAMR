...
module FAU ( 
  ...
  nand2  g08(.a(x12), .b(x00), .O(new_n28_));
  ...
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n42_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n61_), .c(x05), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai21  g46(.a(new_n21_), .b(new_n65_), .c(new_n28_), .O(z4));
endmodule
