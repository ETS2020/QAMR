...
module FAU ( 
  ...
  oai21  g14(.a(new_n20_), .b(new_n22_), .c(x01), .O(new_n34_));
  ...
  nand2  g21(.a(x05), .b(x03), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  inv1   g23(.a(x10), .O(new_n43_));
  nand2  g24(.a(new_n23_), .b(new_n43_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x13), .c(x03), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x05), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x09), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n42_), .c(new_n39_), .O(z1));
  inv1   g29(.a(x11), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(new_n43_), .c(new_n25_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n30_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(x04), .c(x02), .O(new_n52_));
  nand3  g33(.a(new_n30_), .b(new_n43_), .c(new_n25_), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n23_), .c(x11), .O(new_n54_));
  ...
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(new_n21_), .d(x05), .O(z2));
  inv1   g40(.a(x02), .O(new_n60_));
  nor2   g41(.a(x12), .b(x11), .O(new_n61_));
  aoi22  g42(.a(new_n61_), .b(new_n36_), .c(x13), .d(x09), .O(new_n62_));
  nand3  g43(.a(x13), .b(x12), .c(x09), .O(new_n63_));
  oai21  g44(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(new_n64_));
  inv1   g45(.a(x12), .O(new_n65_));
  nor2   g46(.a(new_n50_), .b(new_n23_), .O(new_n66_));
  nor2   g47(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  ...
  oai21  g53(.a(new_n68_), .b(new_n22_), .c(new_n72_), .O(z3));
  nand2  g54(.a(new_n31_), .b(x04), .O(new_n74_));
