...
module FAU ( 
  ...
  aoi21  g17(.a(new_n36_), .b(new_n25_), .c(new_n24_), .O(new_n37_));
  inv1   g18(.a(x10), .O(new_n38_));
  nor2   g19(.a(new_n20_), .b(new_n24_), .O(new_n39_));
  inv1   g20(.a(new_n25_), .O(new_n40_));
  nor2   g21(.a(new_n40_), .b(x08), .O(new_n41_));
  ...
  nand4  g27(.a(new_n46_), .b(new_n43_), .c(new_n21_), .d(x05), .O(z1));
  nor3   g28(.a(x11), .b(x10), .c(x08), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n40_), .c(x02), .O(new_n49_));
  nand2  g30(.a(new_n27_), .b(x02), .O(new_n50_));
  nand2  g31(.a(new_n25_), .b(new_n38_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(x11), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n49_), .c(new_n45_), .O(new_n53_));
  ...
  nand3  g37(.a(x11), .b(new_n20_), .c(x03), .O(new_n57_));
  oai21  g38(.a(x11), .b(x05), .c(new_n57_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n56_), .c(new_n30_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n55_), .O(z2));
  nor2   g41(.a(x12), .b(x11), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n35_), .c(new_n40_), .O(new_n62_));
  inv1   g43(.a(x11), .O(new_n63_));
  nand3  g44(.a(new_n25_), .b(new_n63_), .c(new_n38_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n50_), .c(x12), .O(new_n65_));
  oai21  g46(.a(new_n62_), .b(new_n24_), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g52(.a(new_n71_), .b(new_n69_), .c(new_n30_), .O(new_n72_));
