...
module FAU ( 
  ...
  aoi21  g40(.a(new_n59_), .b(new_n33_), .c(new_n22_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n58_), .c(x05), .O(z2));
  nand4  g42(.a(new_n52_), .b(new_n21_), .c(x04), .d(x02), .O(new_n62_));
  nand3  g43(.a(new_n26_), .b(new_n50_), .c(new_n37_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n54_), .c(x12), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x03), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n33_), .c(new_n22_), .O(new_n68_));
  nand3  g49(.a(new_n68_), .b(new_n66_), .c(x05), .O(z3));
  inv1   g50(.a(x04), .O(new_n70_));
  oai21  g51(.a(new_n26_), .b(new_n70_), .c(new_n23_), .O(z4));
endmodule
