...
module FAU ( 
  ...
  nand2  g35(.a(x13), .b(x09), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n49_), .c(new_n34_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n26_), .c(x12), .O(new_n57_));
  nand3  g38(.a(new_n44_), .b(new_n39_), .c(new_n20_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n26_), .c(new_n57_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n54_), .O(z3));
  nand4  g42(.a(x13), .b(x12), .c(x09), .d(x04), .O(new_n62_));
