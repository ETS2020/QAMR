...
module FAU ( 
  ...
  nor2   g01(.a(x10), .b(new_n20_), .O(new_n21_));
  ...
  nand2  g15(.a(new_n22_), .b(x08), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(x04), .c(x02), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(x03), .c(new_n20_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n34_), .O(new_n38_));
  and2   g19(.a(x04), .b(x02), .O(new_n39_));
  nand3  g20(.a(new_n39_), .b(new_n22_), .c(new_n25_), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(x10), .c(x03), .O(new_n41_));
  aoi21  g22(.a(new_n30_), .b(new_n20_), .c(new_n31_), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n38_), .O(z1));
  inv1   g24(.a(new_n21_), .O(new_n44_));
  ...
  oai21  g28(.a(new_n47_), .b(new_n31_), .c(new_n44_), .O(new_n48_));
  nand2  g29(.a(new_n40_), .b(x11), .O(new_n49_));
  nor3   g30(.a(x11), .b(x10), .c(x08), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n39_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n49_), .c(x01), .O(new_n52_));
  and2   g33(.a(x11), .b(x10), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n52_), .c(x03), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n48_), .O(z2));
  inv1   g36(.a(x02), .O(new_n56_));
  nor2   g37(.a(x10), .b(x08), .O(new_n57_));
  nor2   g38(.a(x12), .b(x11), .O(new_n58_));
  aoi22  g39(.a(new_n58_), .b(new_n57_), .c(x13), .d(x09), .O(new_n59_));
  nand3  g40(.a(x13), .b(x12), .c(x09), .O(new_n60_));
  oai21  g41(.a(new_n59_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  inv1   g42(.a(x12), .O(new_n62_));
  aoi21  g43(.a(new_n50_), .b(new_n39_), .c(new_n62_), .O(new_n63_));
  aoi21  g44(.a(new_n61_), .b(x04), .c(new_n63_), .O(new_n64_));
  oai21  g45(.a(x07), .b(x03), .c(x05), .O(new_n65_));
  nor2   g46(.a(new_n65_), .b(new_n21_), .O(new_n66_));
  oai21  g47(.a(new_n64_), .b(new_n30_), .c(new_n66_), .O(z3));
  nand2  g48(.a(new_n46_), .b(new_n44_), .O(z4));
endmodule
