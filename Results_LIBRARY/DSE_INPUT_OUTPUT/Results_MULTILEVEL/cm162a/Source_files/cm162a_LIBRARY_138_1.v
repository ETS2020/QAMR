...
module FAU ( 
  ...
  oai21  g28(.a(new_n47_), .b(new_n33_), .c(x11), .O(new_n48_));
  ...
  oai21  g34(.a(new_n21_), .b(new_n28_), .c(new_n44_), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n53_), .c(x04), .d(x02), .O(new_n55_));
  aoi21  g36(.a(x13), .b(x09), .c(x11), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n25_), .c(new_n42_), .O(new_n57_));
  ...
  nor2   g41(.a(x07), .b(new_n28_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n20_), .c(new_n39_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  oai22  g45(.a(new_n21_), .b(new_n64_), .c(new_n53_), .d(x05), .O(z4));
endmodule
