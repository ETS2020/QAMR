...
module FAU ( 
  ...
  nand3  g40(.a(new_n31_), .b(x11), .c(x10), .O(new_n60_));
  ...
  nand3  g44(.a(new_n57_), .b(new_n20_), .c(new_n41_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n24_), .O(new_n65_));
  nand4  g46(.a(new_n65_), .b(new_n31_), .c(x04), .d(x02), .O(new_n66_));
  ...
  aoi21  g53(.a(new_n72_), .b(new_n35_), .c(new_n32_), .O(new_n73_));
  nand3  g54(.a(new_n73_), .b(new_n71_), .c(x05), .O(z3));
  inv1   g55(.a(new_n32_), .O(new_n75_));
