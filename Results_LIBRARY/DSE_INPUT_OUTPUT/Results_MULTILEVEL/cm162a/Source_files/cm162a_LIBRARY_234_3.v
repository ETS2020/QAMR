...
module FAU ( 
  ...
  nand4  g35(.a(new_n54_), .b(new_n44_), .c(new_n32_), .d(new_n25_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n22_), .c(new_n53_), .O(new_n56_));
  ...
  oai21  g43(.a(new_n62_), .b(new_n61_), .c(new_n20_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x05), .O(z3));
  nand2  g45(.a(x06), .b(x05), .O(new_n65_));
