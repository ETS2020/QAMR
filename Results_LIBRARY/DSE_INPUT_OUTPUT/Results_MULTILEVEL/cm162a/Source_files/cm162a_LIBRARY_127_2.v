...
module FAU ( 
  ...
  nand2  g09(.a(new_n28_), .b(x00), .O(new_n29_));
  ...
  nand2  g16(.a(new_n21_), .b(new_n23_), .O(new_n36_));
  ...
  inv1   g23(.a(new_n29_), .O(new_n43_));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n52_), .c(new_n43_), .O(z2));
  nand4  g37(.a(new_n47_), .b(new_n28_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n58_));
  ...
  oai21  g48(.a(new_n21_), .b(new_n67_), .c(new_n29_), .O(z4));
endmodule
