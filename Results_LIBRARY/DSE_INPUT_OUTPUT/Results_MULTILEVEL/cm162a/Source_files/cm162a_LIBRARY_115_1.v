...
module FAU ( 
  ...
  nand3  g14(.a(new_n33_), .b(new_n24_), .c(new_n20_), .O(new_n34_));
  ...
  nor2   g20(.a(new_n39_), .b(x03), .O(new_n40_));
  nor2   g21(.a(x08), .b(x05), .O(new_n41_));
  aoi21  g22(.a(new_n40_), .b(new_n38_), .c(new_n41_), .O(new_n42_));
  ...
  nand4  g29(.a(new_n33_), .b(new_n24_), .c(new_n48_), .d(new_n20_), .O(new_n49_));
  ...
  nor2   g34(.a(x06), .b(new_n39_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n41_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n52_), .O(z2));
  inv1   g37(.a(x02), .O(new_n57_));
  nor2   g38(.a(x10), .b(x08), .O(new_n58_));
  inv1   g39(.a(new_n30_), .O(new_n59_));
  nor2   g40(.a(x12), .b(x11), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n58_), .c(new_n59_), .O(new_n61_));
  nand4  g42(.a(x13), .b(x12), .c(x09), .d(x05), .O(new_n62_));
  oai21  g43(.a(new_n61_), .b(new_n57_), .c(new_n62_), .O(new_n63_));
  nand3  g44(.a(new_n44_), .b(new_n33_), .c(new_n20_), .O(new_n64_));
  ...
  nor2   g48(.a(x07), .b(new_n39_), .O(new_n68_));
  aoi21  g49(.a(new_n68_), .b(new_n53_), .c(new_n41_), .O(new_n69_));
  oai21  g50(.a(new_n67_), .b(new_n53_), .c(new_n69_), .O(z3));
  nand2  g51(.a(x08), .b(new_n39_), .O(new_n71_));
