...
module FAU ( 
  ...
  nand4  g40(.a(new_n59_), .b(new_n57_), .c(new_n45_), .d(x05), .O(z2));
  nor2   g41(.a(x12), .b(x11), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n35_), .c(new_n34_), .O(new_n62_));
  nand2  g43(.a(new_n22_), .b(x02), .O(new_n63_));
  ...
  nand2  g49(.a(new_n67_), .b(new_n23_), .O(new_n69_));
  oai21  g50(.a(new_n68_), .b(new_n20_), .c(new_n69_), .O(z3));
  nand2  g51(.a(new_n34_), .b(x04), .O(new_n71_));
