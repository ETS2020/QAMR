...
module FAU ( 
  ...
  nand4  g25(.a(new_n33_), .b(new_n44_), .c(x04), .d(x02), .O(new_n45_));
  ...
  nand2  g34(.a(new_n47_), .b(x12), .O(new_n54_));
  inv1   g35(.a(x10), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n36_), .O(new_n56_));
  nand3  g37(.a(x13), .b(new_n44_), .c(x09), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n28_), .c(x04), .d(x02), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n54_), .c(new_n44_), .O(new_n60_));
  ...
  nand4  g47(.a(new_n29_), .b(x13), .c(x09), .d(x04), .O(new_n67_));
