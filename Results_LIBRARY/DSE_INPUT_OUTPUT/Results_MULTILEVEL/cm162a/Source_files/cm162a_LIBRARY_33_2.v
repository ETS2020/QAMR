...
module FAU ( 
  ...
  nand3  g35(.a(new_n20_), .b(new_n54_), .c(new_n26_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n23_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n44_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n23_), .b(new_n44_), .c(new_n54_), .O(new_n58_));
