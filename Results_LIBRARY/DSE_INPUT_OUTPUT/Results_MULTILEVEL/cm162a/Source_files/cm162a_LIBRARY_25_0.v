...
module FAU ( 
  ...
  nor2   g08(.a(x12), .b(x10), .O(new_n28_));
  ...
  nor3   g33(.a(new_n52_), .b(new_n28_), .c(new_n51_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n50_), .O(z2));
  inv1   g35(.a(x02), .O(new_n55_));
  inv1   g36(.a(x04), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n55_), .c(x10), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x13), .c(x09), .O(new_n58_));
  nand4  g39(.a(new_n43_), .b(new_n23_), .c(x04), .d(x02), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n42_), .O(new_n60_));
  nand2  g41(.a(x12), .b(x10), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n60_), .c(new_n58_), .O(new_n62_));
  ...
  nor2   g48(.a(new_n67_), .b(new_n56_), .O(z4));
endmodule
