...
module FAU ( 
  ...
  nand4  g40(.a(new_n48_), .b(new_n20_), .c(x04), .d(x02), .O(new_n60_));
  nor2   g41(.a(new_n32_), .b(new_n31_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand3  g44(.a(new_n23_), .b(new_n46_), .c(new_n45_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n27_), .c(x03), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x05), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(x12), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n63_), .O(z3));
  inv1   g49(.a(x04), .O(new_n69_));
  oai21  g50(.a(new_n23_), .b(new_n69_), .c(new_n21_), .O(z4));
endmodule
