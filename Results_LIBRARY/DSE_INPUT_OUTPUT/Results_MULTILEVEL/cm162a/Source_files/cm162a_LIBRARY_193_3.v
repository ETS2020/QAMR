...
module FAU ( 
  ...
  nor2   g04(.a(new_n23_), .b(x00), .O(new_n24_));
  inv1   g05(.a(x08), .O(new_n25_));
  nand3  g06(.a(new_n25_), .b(x04), .c(x02), .O(new_n26_));
  nand4  g07(.a(new_n26_), .b(new_n24_), .c(new_n22_), .d(x05), .O(z0));
  ...
  nand2  g12(.a(new_n20_), .b(new_n25_), .O(new_n32_));
  oai21  g13(.a(new_n32_), .b(new_n31_), .c(x10), .O(new_n33_));
  aoi21  g14(.a(new_n33_), .b(new_n30_), .c(new_n23_), .O(new_n34_));
  nor2   g15(.a(x03), .b(x01), .O(new_n35_));
  oai21  g16(.a(new_n35_), .b(new_n34_), .c(new_n28_), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(x05), .O(z1));
  inv1   g18(.a(x10), .O(new_n38_));
  inv1   g19(.a(x11), .O(new_n39_));
  nand3  g20(.a(new_n39_), .b(new_n38_), .c(new_n25_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n20_), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(x04), .c(x02), .O(new_n42_));
  nand3  g23(.a(new_n20_), .b(new_n38_), .c(new_n25_), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n31_), .c(x11), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n42_), .c(new_n23_), .O(new_n45_));
  nor2   g26(.a(x06), .b(x03), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n45_), .c(new_n28_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x05), .O(z2));
  inv1   g29(.a(x02), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n39_), .c(new_n38_), .d(new_n25_), .O(new_n51_));
  ...
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(new_n28_), .O(new_n59_));
