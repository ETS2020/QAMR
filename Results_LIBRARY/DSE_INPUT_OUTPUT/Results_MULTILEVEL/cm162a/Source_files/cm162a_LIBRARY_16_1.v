...
module FAU ( 
  ...
  nand3  g02(.a(x04), .b(x03), .c(x02), .O(new_n22_));
  ...
  nand3  g15(.a(new_n25_), .b(new_n21_), .c(new_n20_), .O(new_n35_));
  ...
  nand2  g20(.a(new_n29_), .b(new_n39_), .O(new_n40_));
  nand2  g21(.a(x12), .b(new_n20_), .O(new_n41_));
  nand4  g22(.a(new_n41_), .b(new_n40_), .c(new_n38_), .d(x05), .O(z1));
  ...
  nand3  g28(.a(new_n20_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n25_), .b(new_n21_), .c(new_n43_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n54_), .b(new_n41_), .c(x05), .O(new_n55_));
  inv1   g36(.a(new_n55_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n52_), .O(z2));
  inv1   g38(.a(x04), .O(new_n58_));
  aoi21  g39(.a(new_n45_), .b(new_n25_), .c(new_n58_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(x02), .c(x12), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n29_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n41_), .c(x05), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  oai21  g45(.a(new_n60_), .b(new_n29_), .c(new_n64_), .O(z3));
  oai21  g46(.a(new_n25_), .b(new_n58_), .c(new_n41_), .O(z4));
endmodule
