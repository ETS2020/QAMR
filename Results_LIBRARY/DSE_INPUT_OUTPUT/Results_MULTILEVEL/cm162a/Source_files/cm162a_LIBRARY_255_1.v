...
module FAU ( 
  ...
  nand4  g11(.a(new_n30_), .b(new_n27_), .c(new_n22_), .d(x05), .O(z0));
  ...
  aoi21  g18(.a(new_n37_), .b(new_n24_), .c(new_n33_), .O(new_n38_));
  aoi21  g19(.a(new_n36_), .b(x02), .c(new_n38_), .O(new_n39_));
  nor2   g20(.a(x03), .b(x01), .O(new_n40_));
  inv1   g21(.a(x12), .O(new_n41_));
  nand2  g22(.a(x13), .b(new_n41_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x05), .O(new_n43_));
  nor2   g24(.a(new_n43_), .b(new_n40_), .O(new_n44_));
  oai21  g25(.a(new_n39_), .b(new_n29_), .c(new_n44_), .O(z1));
  nand4  g26(.a(new_n33_), .b(new_n23_), .c(x04), .d(x02), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x11), .O(new_n47_));
  nor2   g28(.a(x11), .b(x10), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n24_), .c(new_n23_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n47_), .c(new_n29_), .O(new_n50_));
  oai21  g31(.a(x06), .b(x03), .c(x05), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(new_n42_), .O(new_n52_));
  inv1   g33(.a(x13), .O(new_n53_));
  nor2   g34(.a(new_n24_), .b(x11), .O(new_n54_));
  nor2   g35(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(x12), .c(x09), .d(x03), .O(new_n56_));
  ...
  nand3  g41(.a(new_n35_), .b(new_n60_), .c(new_n33_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n25_), .c(x12), .O(new_n62_));
  nand3  g43(.a(new_n48_), .b(new_n53_), .c(new_n41_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n25_), .c(new_n62_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x03), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n59_), .O(z3));
  nand4  g47(.a(x13), .b(x12), .c(x09), .d(x04), .O(new_n67_));
