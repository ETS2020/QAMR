...
module FAU ( 
  ...
  nand2  g21(.a(new_n26_), .b(new_n21_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n20_), .c(new_n35_), .O(new_n42_));
  ...
  nand3  g30(.a(new_n25_), .b(new_n21_), .c(new_n35_), .O(new_n50_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n53_), .c(new_n32_), .d(x05), .O(z2));
  inv1   g37(.a(x04), .O(new_n57_));
  nand3  g38(.a(x13), .b(new_n21_), .c(x09), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n46_), .c(new_n57_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(x02), .c(x12), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n29_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n32_), .c(x05), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  oai21  g45(.a(new_n60_), .b(new_n29_), .c(new_n64_), .O(z3));
  oai21  g46(.a(x12), .b(new_n29_), .c(x08), .O(new_n66_));
