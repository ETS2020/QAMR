...
module FAU ( 
  ...
  nand3  g24(.a(new_n21_), .b(new_n31_), .c(new_n30_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(x11), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n42_), .c(new_n20_), .O(new_n46_));
  oai21  g27(.a(x06), .b(x03), .c(x05), .O(new_n47_));
  or2    g28(.a(new_n47_), .b(new_n46_), .O(z2));
  inv1   g29(.a(x02), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n39_), .c(new_n31_), .d(new_n30_), .O(new_n51_));
  ...
  nand4  g36(.a(new_n39_), .b(new_n31_), .c(new_n30_), .d(x02), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x12), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n55_), .c(new_n27_), .O(new_n58_));
  nor2   g39(.a(new_n50_), .b(x04), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n58_), .c(x03), .O(new_n60_));
  nor2   g41(.a(x07), .b(new_n27_), .O(new_n61_));
  aoi22  g42(.a(new_n61_), .b(new_n20_), .c(new_n27_), .d(new_n23_), .O(new_n62_));
