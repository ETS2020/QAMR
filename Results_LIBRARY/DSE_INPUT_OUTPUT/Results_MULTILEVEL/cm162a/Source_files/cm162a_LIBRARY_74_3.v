...
module FAU ( 
  ...
  nand2  g00(.a(x12), .b(x02), .O(new_n20_));
  ...
  aoi21  g05(.a(new_n24_), .b(x04), .c(x12), .O(new_n25_));
  ...
  nand4  g40(.a(new_n47_), .b(x04), .c(x03), .d(x02), .O(new_n60_));
  inv1   g41(.a(new_n60_), .O(new_n61_));
  oai21  g42(.a(x07), .b(x03), .c(x05), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n61_), .c(new_n28_), .O(new_n63_));
  inv1   g44(.a(x05), .O(new_n64_));
  aoi21  g45(.a(x07), .b(new_n44_), .c(new_n28_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n64_), .c(new_n23_), .O(new_n66_));
