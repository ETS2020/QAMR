...
module FAU ( 
  ...
  nand4  g19(.a(new_n38_), .b(new_n36_), .c(x13), .d(x05), .O(z1));
  ...
  nand3  g25(.a(new_n40_), .b(new_n21_), .c(new_n24_), .O(new_n45_));
  ...
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x13), .O(new_n49_));
  ...
  oai21  g42(.a(x07), .b(x03), .c(x13), .O(new_n62_));
