...
module FAU ( 
  ...
  nor2   g08(.a(x12), .b(x07), .O(new_n28_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n51_), .c(new_n28_), .O(z2));
  inv1   g36(.a(x02), .O(new_n56_));
  inv1   g37(.a(x12), .O(new_n57_));
  nand4  g38(.a(new_n46_), .b(new_n57_), .c(x07), .d(x04), .O(new_n58_));
  ...
  nor2   g43(.a(new_n57_), .b(x07), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(new_n20_), .c(new_n29_), .d(new_n52_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  nand3  g47(.a(new_n29_), .b(x13), .c(x09), .O(new_n67_));
