...
module FAU ( 
  ...
  aoi21  g19(.a(new_n28_), .b(new_n38_), .c(new_n26_), .O(new_n39_));
  nor2   g20(.a(x07), .b(x03), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(x08), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(x05), .O(z3));
  nand2  g23(.a(new_n20_), .b(x05), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(x13), .c(x09), .d(x04), .O(new_n44_));
  inv1   g25(.a(new_n44_), .O(z4));
endmodule
