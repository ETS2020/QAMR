...
module FAU ( 
  ...
  oai21  g07(.a(x13), .b(x06), .c(x05), .O(new_n27_));
  ...
  nor2   g19(.a(new_n38_), .b(new_n27_), .O(new_n39_));
  ...
  oai22  g43(.a(x13), .b(x06), .c(x07), .d(x03), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(new_n51_), .O(new_n64_));
