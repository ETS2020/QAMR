...
module FAU ( 
  ...
  aoi21  g06(.a(new_n25_), .b(x02), .c(new_n20_), .O(new_n26_));
  oai21  g07(.a(new_n26_), .b(new_n24_), .c(x08), .O(new_n27_));
  inv1   g08(.a(x08), .O(new_n28_));
  nand4  g09(.a(x12), .b(new_n28_), .c(x04), .d(x02), .O(new_n29_));
  nand2  g10(.a(new_n29_), .b(new_n27_), .O(new_n30_));
  nand2  g11(.a(new_n30_), .b(x03), .O(new_n31_));
  nand2  g12(.a(new_n31_), .b(new_n23_), .O(z0));
  ...
  nand3  g17(.a(new_n25_), .b(new_n28_), .c(x02), .O(new_n37_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n40_), .c(new_n28_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n25_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n28_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n25_), .b(x12), .c(new_n40_), .O(new_n49_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n52_), .c(new_n21_), .d(x05), .O(z2));
  aoi21  g37(.a(x13), .b(x09), .c(x11), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n40_), .c(new_n28_), .d(x02), .O(new_n58_));
  nor2   g39(.a(new_n20_), .b(x04), .O(new_n59_));
  aoi21  g40(.a(new_n58_), .b(x04), .c(new_n59_), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n53_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n21_), .c(x05), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  oai21  g45(.a(new_n60_), .b(new_n53_), .c(new_n64_), .O(z3));
  nand4  g46(.a(x13), .b(x12), .c(x09), .d(x04), .O(new_n66_));
