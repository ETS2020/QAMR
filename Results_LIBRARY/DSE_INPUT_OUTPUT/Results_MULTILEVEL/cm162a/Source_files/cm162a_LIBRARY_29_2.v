...
module FAU ( 
  ...
  oai21  g08(.a(new_n27_), .b(new_n26_), .c(x09), .O(new_n28_));
  ...
  nand4  g19(.a(new_n38_), .b(new_n36_), .c(x09), .d(x05), .O(z1));
  ...
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x09), .O(new_n49_));
  ...
  oai21  g42(.a(x07), .b(x03), .c(x09), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  oai21  g44(.a(new_n60_), .b(new_n20_), .c(new_n63_), .O(z3));
