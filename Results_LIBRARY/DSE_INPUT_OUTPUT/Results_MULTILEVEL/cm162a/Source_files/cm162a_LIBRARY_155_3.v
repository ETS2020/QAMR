...
module FAU ( 
  ...
  nor3   g31(.a(new_n50_), .b(x07), .c(new_n49_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n48_), .O(z2));
  inv1   g33(.a(new_n28_), .O(new_n53_));
  inv1   g34(.a(x02), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n40_), .c(new_n32_), .d(new_n31_), .O(new_n56_));
  nand3  g37(.a(x13), .b(x09), .c(new_n27_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(new_n58_));
  nand4  g39(.a(x13), .b(x12), .c(x09), .d(new_n27_), .O(new_n59_));
  inv1   g40(.a(new_n59_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n58_), .c(x04), .O(new_n61_));
  oai21  g42(.a(new_n41_), .b(new_n44_), .c(x12), .O(new_n62_));
  nand4  g43(.a(new_n62_), .b(new_n61_), .c(new_n53_), .d(x03), .O(z3));
  nand2  g44(.a(x07), .b(x05), .O(new_n64_));
