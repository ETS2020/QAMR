...
module FAU ( 
  ...
  nand4  g31(.a(new_n50_), .b(new_n48_), .c(x12), .d(x05), .O(z2));
  nand3  g32(.a(new_n21_), .b(new_n41_), .c(new_n40_), .O(new_n52_));
  ...
  oai22  g39(.a(new_n21_), .b(new_n57_), .c(x12), .d(new_n58_), .O(z4));
endmodule
