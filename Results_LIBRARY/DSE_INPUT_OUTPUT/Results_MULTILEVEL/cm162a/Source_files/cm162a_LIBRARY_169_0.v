...
module FAU ( 
  ...
  aoi21  g18(.a(new_n37_), .b(new_n31_), .c(new_n35_), .O(new_n38_));
  nand4  g19(.a(new_n31_), .b(new_n26_), .c(x04), .d(x02), .O(new_n39_));
  aoi22  g20(.a(new_n39_), .b(x10), .c(new_n38_), .d(x02), .O(new_n40_));
  nor2   g21(.a(x03), .b(x01), .O(new_n41_));
  nand2  g22(.a(new_n22_), .b(x05), .O(new_n42_));
  nor2   g23(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  oai21  g24(.a(new_n40_), .b(new_n23_), .c(new_n43_), .O(z1));
  inv1   g25(.a(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n36_), .c(new_n26_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n31_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n31_), .b(new_n36_), .c(new_n26_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n24_), .c(x11), .O(new_n50_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n52_), .c(new_n22_), .d(x05), .O(z2));
  inv1   g36(.a(x09), .O(new_n56_));
  nand4  g37(.a(new_n20_), .b(new_n45_), .c(new_n36_), .d(new_n26_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  nand2  g40(.a(x12), .b(x09), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n59_), .c(new_n21_), .O(new_n61_));
  nor2   g42(.a(new_n46_), .b(new_n24_), .O(new_n62_));
  ...
  nand2  g46(.a(new_n65_), .b(new_n22_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  oai21  g48(.a(new_n31_), .b(new_n35_), .c(new_n22_), .O(z4));
endmodule
