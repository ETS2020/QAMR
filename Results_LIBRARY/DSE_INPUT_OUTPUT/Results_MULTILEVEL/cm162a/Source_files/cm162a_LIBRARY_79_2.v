...
module FAU ( 
  ...
  nor2   g16(.a(new_n35_), .b(new_n33_), .O(new_n36_));
  ...
  aoi21  g26(.a(new_n34_), .b(new_n37_), .c(new_n45_), .O(new_n46_));
  nor3   g27(.a(x11), .b(x10), .c(x08), .O(new_n47_));
  and2   g28(.a(new_n47_), .b(new_n37_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(new_n49_));
  nand2  g30(.a(new_n23_), .b(new_n45_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x09), .c(x03), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x05), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(x13), .O(new_n53_));
  ...
  oai21  g51(.a(new_n31_), .b(new_n33_), .c(new_n21_), .O(z4));
endmodule
