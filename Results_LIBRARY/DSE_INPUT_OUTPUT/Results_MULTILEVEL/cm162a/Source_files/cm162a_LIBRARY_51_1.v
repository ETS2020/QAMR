...
module FAU ( 
  ...
  nand4  g22(.a(new_n41_), .b(new_n39_), .c(new_n33_), .d(x05), .O(z1));
  inv1   g23(.a(x11), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n20_), .c(new_n24_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  inv1   g27(.a(x12), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n47_), .c(new_n20_), .O(new_n48_));
  ...
  nand3  g38(.a(x13), .b(new_n47_), .c(x09), .O(new_n58_));
  ...
  nand3  g43(.a(new_n62_), .b(new_n33_), .c(x05), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  oai21  g45(.a(new_n60_), .b(new_n29_), .c(new_n64_), .O(z3));
  oai21  g46(.a(x12), .b(new_n29_), .c(x10), .O(new_n66_));
