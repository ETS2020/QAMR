...
module FAU ( 
  ...
  nor2   g05(.a(x08), .b(new_n24_), .O(new_n25_));
  ...
  nor2   g10(.a(x12), .b(x05), .O(new_n30_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n42_), .c(new_n36_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  nand3  g27(.a(new_n21_), .b(new_n42_), .c(new_n36_), .O(new_n47_));
  ...
  nand2  g37(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n55_), .c(x04), .d(x02), .O(new_n58_));
  aoi21  g39(.a(x13), .b(x09), .c(x11), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n25_), .c(new_n42_), .d(x02), .O(new_n60_));
  ...
  oai22  g47(.a(new_n21_), .b(new_n24_), .c(new_n55_), .d(x05), .O(z4));
endmodule
