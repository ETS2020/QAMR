...
module FAU ( 
  ...
  nand3  g27(.a(new_n32_), .b(new_n35_), .c(new_n26_), .O(new_n47_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n50_), .c(new_n22_), .d(x05), .O(z2));
  ...
  nor2   g40(.a(new_n44_), .b(new_n24_), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n21_), .O(new_n61_));
  ...
  oai21  g47(.a(new_n32_), .b(new_n66_), .c(new_n22_), .O(z4));
endmodule
