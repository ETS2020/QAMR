...
module FAU ( 
  ...
  nand3  g24(.a(new_n22_), .b(new_n39_), .c(new_n25_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n33_), .c(x11), .O(new_n45_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n20_), .O(z2));
  inv1   g31(.a(x02), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n40_), .c(new_n39_), .d(new_n25_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n51_), .O(new_n54_));
  nand3  g35(.a(x13), .b(x12), .c(x09), .O(new_n55_));
  inv1   g36(.a(new_n55_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n54_), .c(x04), .O(new_n57_));
  oai21  g38(.a(new_n41_), .b(new_n33_), .c(x12), .O(new_n58_));
  ...
  nand2  g43(.a(x05), .b(x01), .O(new_n63_));
