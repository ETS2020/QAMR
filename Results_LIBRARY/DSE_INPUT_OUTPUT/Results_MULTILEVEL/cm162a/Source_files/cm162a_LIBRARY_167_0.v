...
module FAU ( 
  ...
  nand4  g37(.a(new_n51_), .b(new_n44_), .c(new_n43_), .d(new_n24_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n21_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(x06), .c(x04), .d(x02), .O(new_n59_));
  ...
  oai21  g49(.a(new_n21_), .b(new_n68_), .c(new_n64_), .O(z4));
endmodule
