...
module FAU ( 
  ...
  oai21  g10(.a(new_n29_), .b(new_n23_), .c(x06), .O(new_n30_));
  ...
  oai21  g18(.a(new_n37_), .b(new_n23_), .c(x06), .O(new_n38_));
  ...
  nand3  g31(.a(new_n50_), .b(x06), .c(x05), .O(z2));
  inv1   g32(.a(x02), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n43_), .c(new_n42_), .d(new_n27_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n24_), .c(new_n52_), .O(new_n55_));
