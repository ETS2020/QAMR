...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(new_n35_), .c(new_n34_), .d(new_n30_), .O(new_n46_));
  ...
  oai21  g31(.a(new_n36_), .b(new_n29_), .c(x12), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n50_), .c(x05), .d(x03), .O(z3));
  inv1   g33(.a(x05), .O(new_n53_));
  oai22  g34(.a(new_n21_), .b(new_n23_), .c(new_n53_), .d(x03), .O(z4));
endmodule
