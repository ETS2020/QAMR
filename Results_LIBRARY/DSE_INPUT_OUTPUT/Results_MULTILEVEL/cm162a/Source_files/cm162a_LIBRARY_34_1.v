...
module FAU ( 
  ...
  nand3  g16(.a(new_n35_), .b(new_n32_), .c(x05), .O(new_n36_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n42_), .c(new_n26_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n23_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  nand3  g27(.a(new_n23_), .b(new_n42_), .c(new_n26_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n33_), .c(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n46_), .c(x05), .O(new_n49_));
  ...
  oai21  g40(.a(new_n44_), .b(new_n33_), .c(x12), .O(new_n60_));
  ...
  nand2  g44(.a(new_n63_), .b(new_n38_), .O(new_n64_));
  oai21  g45(.a(new_n62_), .b(new_n21_), .c(new_n64_), .O(z3));
  nand2  g46(.a(x12), .b(new_n21_), .O(new_n66_));
