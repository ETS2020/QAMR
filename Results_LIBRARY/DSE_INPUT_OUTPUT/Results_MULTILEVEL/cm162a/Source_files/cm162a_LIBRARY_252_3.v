...
module FAU ( 
  ...
  aoi21  g05(.a(new_n24_), .b(x02), .c(x12), .O(new_n25_));
  ...
  nand3  g17(.a(new_n24_), .b(new_n27_), .c(x02), .O(new_n37_));
  ...
  nand3  g28(.a(new_n27_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n24_), .b(new_n28_), .c(new_n40_), .O(new_n49_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n52_), .c(new_n20_), .d(x05), .O(z2));
  nand3  g37(.a(x13), .b(new_n28_), .c(x09), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n45_), .c(new_n23_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x02), .c(x12), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n53_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n20_), .c(x05), .O(new_n62_));
  inv1   g43(.a(new_n62_), .O(new_n63_));
  oai21  g44(.a(new_n59_), .b(new_n53_), .c(new_n63_), .O(z3));
  nand4  g45(.a(x13), .b(new_n28_), .c(x09), .d(x04), .O(new_n65_));
