...
module FAU ( 
  ...
  nand4  g35(.a(new_n51_), .b(new_n42_), .c(new_n31_), .d(new_n30_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x05), .c(x02), .O(new_n57_));
  nand3  g38(.a(x13), .b(x12), .c(x09), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n57_), .c(new_n23_), .O(new_n59_));
  nor2   g40(.a(new_n43_), .b(new_n34_), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n51_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n59_), .c(x03), .O(new_n62_));
  nor2   g43(.a(x07), .b(new_n27_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n20_), .c(new_n52_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  oai21  g46(.a(new_n27_), .b(x03), .c(x12), .O(new_n66_));
