...
module FAU ( 
  ...
  nor3   g22(.a(x12), .b(x03), .c(x01), .O(new_n42_));
  aoi21  g23(.a(new_n31_), .b(x01), .c(new_n42_), .O(new_n43_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n30_), .c(new_n31_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n53_), .c(new_n21_), .O(z2));
  ...
  aoi21  g43(.a(new_n62_), .b(new_n30_), .c(new_n21_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n61_), .c(x05), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai22  g46(.a(new_n22_), .b(new_n65_), .c(new_n20_), .d(x01), .O(z4));
endmodule
