// Benchmark "FAU" written by ABC on Thu Aug 13 15:06:53 2020
...
module FAU ( 
  ...
  oai21  g26(.a(new_n45_), .b(new_n34_), .c(x11), .O(new_n46_));
  ...
  nand2  g30(.a(new_n49_), .b(new_n30_), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n43_), .b(new_n51_), .c(x04), .d(x02), .O(new_n52_));
  nand3  g33(.a(new_n21_), .b(new_n41_), .c(new_n40_), .O(new_n53_));
  ...
  oai22  g41(.a(new_n21_), .b(new_n60_), .c(x12), .d(x05), .O(z4));
endmodule
