...
module FAU ( 
  ...
  nand2  g04(.a(new_n23_), .b(x01), .O(new_n24_));
  ...
  aoi21  g26(.a(new_n20_), .b(new_n45_), .c(new_n32_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n44_), .c(new_n37_), .O(z1));
  inv1   g28(.a(x11), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n20_), .c(new_n21_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x01), .O(new_n50_));
  nand3  g31(.a(new_n48_), .b(new_n35_), .c(new_n22_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n25_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand3  g34(.a(new_n25_), .b(new_n35_), .c(new_n22_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n40_), .c(x11), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x03), .O(new_n57_));
  inv1   g38(.a(x06), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n20_), .c(new_n32_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n57_), .c(new_n50_), .O(z2));
  inv1   g41(.a(x12), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n48_), .c(new_n35_), .d(new_n22_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n25_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(x04), .c(x02), .O(new_n64_));
  nand2  g45(.a(new_n22_), .b(x02), .O(new_n65_));
  nand3  g46(.a(new_n25_), .b(new_n48_), .c(new_n35_), .O(new_n66_));
  oai21  g47(.a(new_n66_), .b(new_n65_), .c(x12), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n64_), .c(new_n20_), .O(new_n68_));
  inv1   g49(.a(x07), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n20_), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(x05), .O(new_n71_));
  oai21  g52(.a(new_n71_), .b(new_n68_), .c(new_n45_), .O(new_n72_));
  nand2  g53(.a(x12), .b(x03), .O(new_n73_));
  nand3  g54(.a(new_n73_), .b(new_n70_), .c(x05), .O(new_n74_));
  nand2  g55(.a(new_n74_), .b(new_n21_), .O(new_n75_));
  nand2  g56(.a(new_n75_), .b(new_n72_), .O(z3));
  aoi21  g57(.a(new_n25_), .b(new_n45_), .c(new_n21_), .O(z4));
endmodule
