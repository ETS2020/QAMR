...
module FAU ( 
  ...
  oai21  g33(.a(new_n21_), .b(new_n52_), .c(new_n42_), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n51_), .c(x04), .d(x02), .O(new_n54_));
  inv1   g35(.a(new_n25_), .O(new_n55_));
  aoi21  g36(.a(x13), .b(x09), .c(x11), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n40_), .O(new_n57_));
