...
module FAU ( 
  ...
  nand3  g39(.a(x13), .b(x09), .c(new_n58_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n46_), .O(new_n60_));
  ...
  nand3  g44(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n64_));
  inv1   g45(.a(new_n64_), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n25_), .c(new_n29_), .O(new_n66_));
  oai21  g47(.a(x07), .b(x03), .c(x05), .O(new_n67_));
  aoi21  g48(.a(new_n66_), .b(x03), .c(new_n67_), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n63_), .O(z3));
  nand4  g50(.a(new_n30_), .b(x13), .c(x09), .d(x04), .O(new_n70_));
