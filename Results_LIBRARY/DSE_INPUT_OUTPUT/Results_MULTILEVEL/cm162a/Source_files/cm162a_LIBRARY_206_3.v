...
module FAU ( 
  ...
  aoi21  g36(.a(new_n45_), .b(new_n25_), .c(new_n55_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x02), .c(x12), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n20_), .c(new_n23_), .O(new_n59_));
  oai21  g40(.a(new_n57_), .b(new_n20_), .c(new_n59_), .O(z3));
  oai22  g41(.a(new_n25_), .b(new_n55_), .c(new_n24_), .d(new_n20_), .O(z4));
endmodule
