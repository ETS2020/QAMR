...
module FAU ( 
  ...
  nor2   g14(.a(new_n29_), .b(new_n33_), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(new_n21_), .c(new_n23_), .O(new_n35_));
  aoi22  g16(.a(new_n35_), .b(x10), .c(new_n32_), .d(x02), .O(new_n36_));
  ...
  nand3  g27(.a(new_n21_), .b(new_n41_), .c(new_n23_), .O(new_n47_));
  inv1   g28(.a(new_n47_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n34_), .c(new_n42_), .O(new_n49_));
  ...
  oai21  g37(.a(new_n55_), .b(new_n33_), .c(new_n56_), .O(new_n57_));
  ...
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n38_), .O(new_n63_));
  oai21  g44(.a(new_n61_), .b(new_n20_), .c(new_n63_), .O(z3));
  oai22  g45(.a(new_n21_), .b(new_n29_), .c(x05), .d(x03), .O(z4));
endmodule
