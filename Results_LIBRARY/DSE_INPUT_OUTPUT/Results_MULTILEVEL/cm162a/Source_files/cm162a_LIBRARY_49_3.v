...
module FAU ( 
  ...
  inv1   g22(.a(new_n28_), .O(new_n42_));
  ...
  nand4  g37(.a(new_n46_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x05), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand3  g41(.a(new_n21_), .b(new_n44_), .c(new_n43_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n24_), .c(x12), .O(new_n62_));
  ...
  nand2  g46(.a(x12), .b(x07), .O(new_n66_));
