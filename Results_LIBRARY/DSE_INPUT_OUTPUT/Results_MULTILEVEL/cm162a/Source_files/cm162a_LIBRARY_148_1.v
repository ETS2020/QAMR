...
module FAU ( 
  ...
  nand3  g24(.a(new_n43_), .b(new_n28_), .c(new_n23_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  nand3  g27(.a(new_n21_), .b(new_n35_), .c(new_n28_), .O(new_n47_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n29_), .c(x05), .O(new_n53_));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n44_), .c(new_n56_), .O(new_n58_));
