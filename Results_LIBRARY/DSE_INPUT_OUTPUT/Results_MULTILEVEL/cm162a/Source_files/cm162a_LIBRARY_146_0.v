...
module FAU ( 
  ...
  nand3  g27(.a(new_n21_), .b(new_n41_), .c(new_n24_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n46_), .c(x11), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n45_), .c(new_n20_), .O(new_n49_));
  nor2   g30(.a(x06), .b(x03), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(x05), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n30_), .O(z2));
  ...
  oai21  g47(.a(new_n29_), .b(x03), .c(x12), .O(new_n67_));
