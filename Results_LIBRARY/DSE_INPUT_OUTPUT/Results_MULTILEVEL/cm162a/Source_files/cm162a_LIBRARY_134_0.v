...
module FAU ( 
  ...
  nand4  g12(.a(new_n24_), .b(new_n20_), .c(x04), .d(x02), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(x10), .c(x05), .O(new_n33_));
  ...
  nor2   g18(.a(new_n37_), .b(x03), .O(new_n38_));
  inv1   g19(.a(x04), .O(new_n39_));
  nor2   g20(.a(x05), .b(new_n39_), .O(new_n40_));
  aoi21  g21(.a(new_n38_), .b(new_n36_), .c(new_n40_), .O(new_n41_));
  ...
  nand3  g29(.a(new_n24_), .b(new_n48_), .c(new_n20_), .O(new_n49_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n37_), .O(new_n55_));
  ...
  aoi22  g40(.a(new_n59_), .b(new_n58_), .c(x13), .d(x09), .O(new_n60_));
  nand3  g41(.a(x13), .b(x12), .c(x09), .O(new_n61_));
  oai21  g42(.a(new_n60_), .b(new_n57_), .c(new_n61_), .O(new_n62_));
  nand4  g43(.a(new_n43_), .b(new_n20_), .c(x04), .d(x02), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(x12), .c(x05), .O(new_n64_));
  inv1   g45(.a(new_n64_), .O(new_n65_));
  aoi21  g46(.a(new_n62_), .b(x04), .c(new_n65_), .O(new_n66_));
  nor2   g47(.a(x07), .b(new_n37_), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n53_), .c(new_n40_), .O(new_n68_));
  oai21  g49(.a(new_n66_), .b(new_n53_), .c(new_n68_), .O(z3));
