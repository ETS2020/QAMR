...
module FAU ( 
  ...
  nor2   g14(.a(new_n23_), .b(new_n33_), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(new_n21_), .c(new_n32_), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(x10), .c(x05), .O(new_n36_));
  ...
  nor2   g21(.a(x05), .b(new_n23_), .O(new_n41_));
  ...
  nand4  g29(.a(new_n34_), .b(new_n21_), .c(new_n44_), .d(new_n32_), .O(new_n49_));
  ...
  oai21  g40(.a(new_n58_), .b(new_n33_), .c(new_n59_), .O(new_n60_));
  inv1   g41(.a(x12), .O(new_n61_));
  inv1   g42(.a(new_n46_), .O(new_n62_));
