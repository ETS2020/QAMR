...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n50_, new_n51_, new_n52_, new_n54_, new_n55_, new_n56_;
  ...
  nor3   g36(.a(new_n55_), .b(x12), .c(new_n50_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n54_), .O(z3));
  oai22  g38(.a(new_n22_), .b(new_n40_), .c(new_n20_), .d(new_n50_), .O(z4));
endmodule
