...
module FAU ( 
  ...
  nand3  g31(.a(new_n50_), .b(new_n47_), .c(x05), .O(new_n51_));
  ...
  oai21  g41(.a(new_n45_), .b(new_n48_), .c(x12), .O(new_n61_));
  ...
  oai21  g46(.a(new_n63_), .b(new_n31_), .c(new_n65_), .O(z3));
  oai22  g47(.a(new_n23_), .b(new_n34_), .c(new_n21_), .d(x03), .O(z4));
endmodule
