...
module FAU ( 
  ...
  aoi21  g33(.a(new_n52_), .b(new_n29_), .c(new_n20_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n51_), .c(x05), .O(z2));
  inv1   g35(.a(x02), .O(new_n55_));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n46_), .b(new_n56_), .c(x07), .d(x04), .O(new_n57_));
  nand3  g38(.a(new_n21_), .b(new_n44_), .c(new_n43_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n25_), .c(x12), .O(new_n59_));
  oai21  g40(.a(new_n57_), .b(new_n55_), .c(new_n59_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  nor2   g42(.a(new_n20_), .b(x05), .O(new_n62_));
  nor2   g43(.a(new_n56_), .b(x07), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n29_), .c(new_n62_), .O(new_n64_));
