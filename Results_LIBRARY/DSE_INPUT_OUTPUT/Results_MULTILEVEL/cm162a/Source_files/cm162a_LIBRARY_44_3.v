...
module FAU ( 
  ...
  nand3  g16(.a(new_n24_), .b(new_n28_), .c(new_n27_), .O(new_n36_));
  ...
  nand4  g23(.a(new_n42_), .b(new_n39_), .c(new_n20_), .d(x05), .O(z1));
  inv1   g24(.a(x10), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n44_), .c(new_n27_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n24_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n27_), .b(x04), .c(x02), .O(new_n49_));
  aoi21  g30(.a(x13), .b(x09), .c(x12), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n49_), .c(x11), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x03), .O(new_n54_));
  inv1   g35(.a(x06), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n41_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n20_), .c(x05), .O(new_n57_));
  inv1   g38(.a(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n54_), .O(z2));
  aoi21  g40(.a(new_n46_), .b(new_n24_), .c(new_n23_), .O(new_n60_));
  ...
  oai21  g46(.a(new_n61_), .b(new_n41_), .c(new_n65_), .O(z3));
  nor2   g47(.a(new_n50_), .b(new_n23_), .O(z4));
endmodule
