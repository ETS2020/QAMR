...
module FAU ( 
  ...
  nand3  g17(.a(new_n36_), .b(new_n33_), .c(x12), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x03), .O(new_n38_));
  inv1   g19(.a(x01), .O(new_n39_));
  aoi21  g20(.a(new_n20_), .b(new_n39_), .c(new_n23_), .O(new_n40_));
  ...
  nand3  g36(.a(new_n24_), .b(new_n43_), .c(new_n42_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n28_), .c(x03), .O(new_n57_));
  ...
  oai22  g42(.a(new_n24_), .b(new_n61_), .c(x12), .d(new_n20_), .O(z4));
endmodule
