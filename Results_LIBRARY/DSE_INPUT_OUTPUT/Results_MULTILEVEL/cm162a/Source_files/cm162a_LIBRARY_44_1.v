...
module FAU ( 
  ...
  nand2  g35(.a(new_n54_), .b(new_n35_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n21_), .c(x05), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n53_), .O(z2));
  nand4  g39(.a(new_n30_), .b(new_n45_), .c(new_n36_), .d(new_n27_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n25_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x04), .c(x02), .O(new_n61_));
  nand2  g42(.a(new_n27_), .b(x02), .O(new_n62_));
  nand3  g43(.a(new_n25_), .b(new_n45_), .c(new_n36_), .O(new_n63_));
  ...
  oai21  g52(.a(new_n30_), .b(new_n35_), .c(new_n20_), .O(new_n72_));
  nand3  g53(.a(new_n72_), .b(x13), .c(x09), .O(new_n73_));
  nand2  g54(.a(new_n73_), .b(new_n21_), .O(z4));
endmodule
