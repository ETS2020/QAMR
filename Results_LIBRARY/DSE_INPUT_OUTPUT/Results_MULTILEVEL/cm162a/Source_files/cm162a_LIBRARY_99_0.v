...
module FAU ( 
  ...
  nand3  g25(.a(new_n44_), .b(new_n35_), .c(new_n23_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n35_), .c(new_n23_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n40_), .c(x11), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(x03), .O(new_n51_));
  inv1   g32(.a(x05), .O(new_n52_));
  oai21  g33(.a(x06), .b(x03), .c(new_n30_), .O(new_n53_));
  nor2   g34(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n51_), .O(z2));
  nand4  g36(.a(new_n46_), .b(new_n28_), .c(x04), .d(x02), .O(new_n56_));
  nand3  g37(.a(new_n21_), .b(new_n44_), .c(new_n35_), .O(new_n57_));
  ...
  oai21  g41(.a(x07), .b(x03), .c(new_n30_), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n52_), .O(new_n62_));
