...
module FAU ( 
  ...
  nand2  g20(.a(x12), .b(x01), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(new_n30_), .c(new_n20_), .O(new_n41_));
  ...
  nand3  g36(.a(x13), .b(x09), .c(x03), .O(new_n56_));
  ...
  nand3  g42(.a(new_n22_), .b(new_n44_), .c(new_n43_), .O(new_n62_));
  inv1   g43(.a(new_n62_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n61_), .c(new_n55_), .O(new_n64_));
  ...
  oai21  g50(.a(x12), .b(x03), .c(x13), .O(new_n70_));
