...
module FAU ( 
  ...
  aoi21  g05(.a(x13), .b(x09), .c(x12), .O(new_n25_));
  ...
  nand3  g16(.a(new_n32_), .b(new_n20_), .c(new_n21_), .O(new_n36_));
  ...
  nand2  g35(.a(new_n54_), .b(new_n29_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n42_), .c(x05), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n53_), .O(z2));
  inv1   g39(.a(x04), .O(new_n59_));
  aoi21  g40(.a(new_n46_), .b(new_n32_), .c(new_n59_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(x02), .c(x12), .O(new_n61_));
  inv1   g42(.a(x07), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n29_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n42_), .c(x05), .O(new_n64_));
  inv1   g45(.a(new_n64_), .O(new_n65_));
  oai21  g46(.a(new_n61_), .b(new_n29_), .c(new_n65_), .O(z3));
  nor2   g47(.a(new_n25_), .b(new_n59_), .O(z4));
endmodule
