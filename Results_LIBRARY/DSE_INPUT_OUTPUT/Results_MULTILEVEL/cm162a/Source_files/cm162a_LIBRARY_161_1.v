...
module FAU ( 
  ...
  nor2   g09(.a(x12), .b(x05), .O(new_n29_));
  ...
  oai21  g34(.a(new_n21_), .b(new_n53_), .c(new_n43_), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n52_), .c(x04), .d(x02), .O(new_n55_));
  inv1   g36(.a(new_n25_), .O(new_n56_));
  aoi21  g37(.a(x13), .b(x09), .c(x11), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n56_), .c(new_n41_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x12), .c(x05), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n55_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  nor2   g42(.a(x07), .b(new_n53_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n29_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai22  g46(.a(new_n21_), .b(new_n65_), .c(new_n52_), .d(x05), .O(z4));
endmodule
