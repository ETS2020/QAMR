...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(new_n23_), .c(x04), .d(x02), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n44_), .c(new_n20_), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(x05), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(new_n30_), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand2  g31(.a(new_n40_), .b(new_n50_), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(x13), .c(x09), .d(x03), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n49_), .O(z2));
  nand3  g34(.a(new_n50_), .b(new_n35_), .c(new_n23_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n21_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n28_), .c(x04), .d(x02), .O(new_n56_));
  nand3  g37(.a(new_n21_), .b(new_n50_), .c(new_n35_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n24_), .c(x12), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x05), .O(new_n61_));
  oai21  g42(.a(x07), .b(x03), .c(new_n30_), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n60_), .O(z3));
