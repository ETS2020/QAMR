...
module FAU ( 
  ...
  nor3   g22(.a(new_n41_), .b(new_n21_), .c(new_n31_), .O(new_n42_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n52_), .c(new_n21_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand3  g37(.a(new_n48_), .b(new_n20_), .c(x03), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g39(.a(new_n22_), .b(new_n45_), .c(new_n44_), .O(new_n59_));
  or2    g40(.a(new_n59_), .b(new_n26_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x12), .c(x03), .O(new_n61_));
  aoi21  g42(.a(new_n20_), .b(new_n30_), .c(new_n31_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n61_), .c(new_n58_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  oai22  g45(.a(new_n22_), .b(new_n64_), .c(x12), .d(new_n20_), .O(z4));
endmodule
