...
module FAU ( 
  ...
  oai21  g28(.a(new_n47_), .b(new_n36_), .c(x11), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n43_), .c(new_n42_), .d(new_n24_), .O(new_n54_));
  ...
  oai21  g39(.a(new_n44_), .b(new_n36_), .c(x12), .O(new_n59_));
  ...
  nand2  g43(.a(new_n62_), .b(new_n31_), .O(z3));
  nand2  g44(.a(new_n30_), .b(x01), .O(new_n64_));
