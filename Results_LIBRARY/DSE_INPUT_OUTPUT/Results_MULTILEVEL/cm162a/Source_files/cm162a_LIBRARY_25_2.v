...
module FAU ( 
  ...
  nand4  g17(.a(new_n21_), .b(new_n32_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nand3  g27(.a(new_n21_), .b(new_n33_), .c(new_n32_), .O(new_n47_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n50_), .c(new_n28_), .d(x05), .O(z2));
  nand2  g34(.a(new_n42_), .b(new_n32_), .O(new_n54_));
  nand3  g35(.a(x13), .b(new_n33_), .c(x09), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n27_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n21_), .b(new_n42_), .c(new_n32_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n46_), .c(x12), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n57_), .c(new_n33_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  inv1   g42(.a(x07), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n20_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n28_), .c(x05), .O(new_n64_));
