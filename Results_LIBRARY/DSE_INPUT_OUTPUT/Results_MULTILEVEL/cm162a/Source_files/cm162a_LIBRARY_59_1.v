...
module FAU ( 
  ...
  nand2  g19(.a(new_n38_), .b(new_n29_), .O(z1));
  ...
  nand2  g30(.a(new_n49_), .b(new_n29_), .O(z2));
  ...
  oai21  g38(.a(new_n42_), .b(new_n33_), .c(x12), .O(new_n58_));
  ...
  nand2  g42(.a(new_n61_), .b(new_n29_), .O(z3));
  nand4  g43(.a(x13), .b(x09), .c(x05), .d(x04), .O(new_n63_));
