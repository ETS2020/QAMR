...
module FAU ( 
  ...
  nand4  g36(.a(new_n46_), .b(new_n55_), .c(x03), .d(x02), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  nand4  g38(.a(x13), .b(x12), .c(x09), .d(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x04), .O(new_n60_));
  oai21  g41(.a(x12), .b(new_n57_), .c(new_n20_), .O(new_n61_));
  nand3  g42(.a(new_n57_), .b(x04), .c(x02), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n45_), .c(x12), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n61_), .c(x05), .O(new_n64_));
  inv1   g45(.a(new_n64_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n60_), .O(z3));
  nand2  g47(.a(x12), .b(x07), .O(new_n67_));
