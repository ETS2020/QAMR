...
module FAU ( 
  ...
  aoi21  g19(.a(new_n38_), .b(new_n20_), .c(new_n37_), .O(new_n39_));
  ...
  oai21  g46(.a(x12), .b(x03), .c(x13), .O(new_n66_));
  nor3   g47(.a(new_n66_), .b(new_n65_), .c(new_n31_), .O(z4));
endmodule
