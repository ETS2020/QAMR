...
module FAU ( 
  ...
  nand4  g36(.a(new_n46_), .b(new_n39_), .c(x05), .d(x04), .O(new_n56_));
  nand3  g37(.a(new_n21_), .b(new_n44_), .c(new_n43_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n24_), .c(x12), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n55_), .c(new_n58_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  nor2   g41(.a(x07), .b(new_n28_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n20_), .c(new_n40_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  oai22  g45(.a(new_n21_), .b(new_n64_), .c(x12), .d(x05), .O(z4));
endmodule
