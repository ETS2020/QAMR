...
module FAU ( 
  ...
  nor3   g41(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  oai21  g42(.a(new_n58_), .b(new_n28_), .c(new_n61_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n20_), .b(new_n63_), .c(new_n59_), .d(new_n27_), .O(z4));
endmodule
