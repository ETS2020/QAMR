...
module FAU ( 
  ...
  oai21  g14(.a(new_n20_), .b(new_n32_), .c(new_n33_), .O(new_n34_));
  oai21  g15(.a(x10), .b(x08), .c(new_n25_), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(x04), .c(x02), .O(new_n36_));
  nand3  g17(.a(new_n25_), .b(new_n21_), .c(x02), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x10), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(new_n36_), .c(x06), .O(new_n39_));
  ...
  nand2  g28(.a(new_n21_), .b(x02), .O(new_n48_));
  nand2  g29(.a(new_n25_), .b(new_n40_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x11), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n47_), .c(x05), .d(x03), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  oai21  g33(.a(new_n44_), .b(new_n29_), .c(x05), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n32_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n44_), .c(new_n40_), .d(new_n21_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n25_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  nand3  g40(.a(new_n25_), .b(new_n44_), .c(new_n40_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n48_), .c(x12), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n59_), .c(new_n29_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n29_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x05), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n62_), .c(new_n20_), .O(new_n66_));
  nand2  g47(.a(x12), .b(x03), .O(new_n67_));
  nand3  g48(.a(new_n67_), .b(new_n64_), .c(x05), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n32_), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n66_), .O(z3));
  aoi21  g51(.a(new_n25_), .b(new_n20_), .c(new_n32_), .O(z4));
endmodule
