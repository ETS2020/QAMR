...
module FAU ( 
  ...
  nor3   g20(.a(new_n39_), .b(x12), .c(new_n38_), .O(new_n40_));
  ...
  nand3  g27(.a(new_n22_), .b(new_n42_), .c(new_n25_), .O(new_n47_));
  ...
  nor3   g32(.a(new_n51_), .b(x12), .c(new_n38_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  nand3  g34(.a(x13), .b(new_n20_), .c(x09), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n44_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(x04), .c(x03), .d(x02), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n21_), .c(x12), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n56_), .c(x05), .O(z3));
  nand2  g40(.a(x12), .b(x05), .O(new_n60_));
