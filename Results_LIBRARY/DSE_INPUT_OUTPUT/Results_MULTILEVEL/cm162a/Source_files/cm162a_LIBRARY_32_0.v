...
module FAU ( 
  ...
  nor2   g07(.a(x10), .b(x06), .O(new_n27_));
  ...
  oai21  g25(.a(new_n44_), .b(new_n20_), .c(new_n43_), .O(new_n45_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n44_), .c(new_n34_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n21_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(x04), .c(x02), .O(new_n52_));
  nand2  g33(.a(new_n35_), .b(x11), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n49_), .c(x03), .O(new_n55_));
  nand3  g36(.a(x10), .b(new_n43_), .c(new_n20_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n46_), .O(z2));
  inv1   g38(.a(x12), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(x06), .c(x02), .O(new_n59_));
  nand2  g40(.a(x12), .b(x06), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x13), .c(x09), .O(new_n62_));
  nor2   g43(.a(x12), .b(x11), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n44_), .c(new_n34_), .d(x02), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n62_), .c(new_n23_), .O(new_n65_));
  nand3  g46(.a(x06), .b(x04), .c(x02), .O(new_n66_));
  nor2   g47(.a(new_n66_), .b(new_n50_), .O(new_n67_));
  nor2   g48(.a(new_n67_), .b(new_n58_), .O(new_n68_));
  oai21  g49(.a(new_n68_), .b(new_n65_), .c(x03), .O(new_n69_));
  nor2   g50(.a(x07), .b(x03), .O(new_n70_));
  nor3   g51(.a(new_n70_), .b(new_n27_), .c(new_n42_), .O(new_n71_));
  nand2  g52(.a(new_n71_), .b(new_n69_), .O(z3));
  nand3  g53(.a(new_n28_), .b(x13), .c(x09), .O(new_n73_));
  nor2   g54(.a(new_n73_), .b(new_n23_), .O(z4));
endmodule
