...
module FAU ( 
  ...
  nand2  g15(.a(new_n34_), .b(new_n25_), .O(new_n35_));
  nand2  g16(.a(x13), .b(x09), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(new_n37_));
  nand4  g18(.a(new_n36_), .b(new_n25_), .c(x04), .d(x02), .O(new_n38_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n34_), .c(new_n25_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n36_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n36_), .b(new_n34_), .c(new_n25_), .O(new_n48_));
