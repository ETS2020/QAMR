...
module FAU ( 
  ...
  nand3  g24(.a(new_n27_), .b(new_n43_), .c(new_n35_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  nand3  g27(.a(new_n21_), .b(new_n43_), .c(new_n35_), .O(new_n47_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n28_), .c(x05), .O(new_n53_));
  inv1   g34(.a(new_n53_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n50_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n45_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  ...
  nand2  g42(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  aoi21  g43(.a(x07), .b(new_n20_), .c(new_n56_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n58_), .c(x11), .O(new_n64_));
