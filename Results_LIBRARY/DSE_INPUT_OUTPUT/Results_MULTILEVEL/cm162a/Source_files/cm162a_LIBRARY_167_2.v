...
module FAU ( 
  ...
  nand4  g38(.a(new_n20_), .b(new_n47_), .c(new_n46_), .d(new_n26_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n23_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n55_), .c(x04), .d(x02), .O(new_n60_));
  nand3  g41(.a(new_n23_), .b(new_n47_), .c(new_n46_), .O(new_n61_));
