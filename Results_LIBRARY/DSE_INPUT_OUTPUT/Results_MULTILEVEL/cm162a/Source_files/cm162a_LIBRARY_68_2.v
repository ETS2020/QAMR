...
module FAU ( 
  ...
  oai21  g15(.a(new_n34_), .b(new_n33_), .c(x02), .O(new_n35_));
  oai21  g16(.a(new_n33_), .b(x08), .c(x10), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n35_), .c(new_n21_), .O(new_n37_));
  ...
  oai21  g24(.a(new_n43_), .b(new_n20_), .c(new_n42_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n43_), .b(new_n38_), .c(new_n27_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n25_), .c(new_n42_), .O(new_n47_));
  nor2   g28(.a(x08), .b(new_n42_), .O(new_n48_));
  nor2   g29(.a(new_n33_), .b(x10), .O(new_n49_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n51_), .c(new_n45_), .d(x05), .O(z2));
  nor2   g35(.a(x12), .b(x11), .O(new_n55_));
  aoi22  g36(.a(new_n55_), .b(new_n34_), .c(x13), .d(x09), .O(new_n56_));
  nand4  g37(.a(new_n25_), .b(new_n43_), .c(new_n38_), .d(new_n27_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x12), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n42_), .c(new_n58_), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n20_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x05), .O(new_n62_));
  aoi21  g43(.a(new_n59_), .b(x03), .c(new_n62_), .O(new_n63_));
  nand2  g44(.a(x12), .b(x03), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n61_), .c(x05), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n42_), .O(new_n66_));
  oai21  g47(.a(new_n63_), .b(new_n21_), .c(new_n66_), .O(z3));
  oai21  g48(.a(new_n25_), .b(new_n21_), .c(new_n22_), .O(z4));
endmodule
