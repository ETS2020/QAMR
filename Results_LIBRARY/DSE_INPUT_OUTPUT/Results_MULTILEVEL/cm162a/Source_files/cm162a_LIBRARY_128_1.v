...
module FAU ( 
  ...
  aoi21  g35(.a(new_n54_), .b(new_n29_), .c(new_n27_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n52_), .O(z2));
  oai21  g37(.a(new_n29_), .b(new_n20_), .c(x07), .O(new_n57_));
  ...
  aoi22  g46(.a(new_n30_), .b(new_n27_), .c(new_n53_), .d(new_n20_), .O(new_n66_));
