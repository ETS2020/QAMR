...
module FAU ( 
  ...
  aoi21  g04(.a(new_n22_), .b(new_n21_), .c(new_n23_), .O(new_n24_));
  ...
  oai21  g29(.a(new_n37_), .b(x10), .c(new_n31_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(new_n39_), .O(z1));
  inv1   g32(.a(x11), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n46_), .c(new_n28_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n26_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  nand2  g36(.a(x04), .b(x02), .O(new_n56_));
  nand3  g37(.a(new_n26_), .b(new_n46_), .c(new_n28_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n56_), .c(x11), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n55_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x06), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n22_), .c(new_n20_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n60_), .c(x05), .O(z2));
  nand3  g44(.a(new_n41_), .b(new_n37_), .c(new_n52_), .O(new_n64_));
  nand3  g45(.a(x13), .b(x09), .c(x04), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n64_), .c(new_n25_), .O(new_n66_));
  nand2  g47(.a(new_n28_), .b(x02), .O(new_n67_));
  nand3  g48(.a(new_n65_), .b(new_n52_), .c(new_n46_), .O(new_n68_));
  oai21  g49(.a(new_n68_), .b(new_n67_), .c(x12), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(x04), .O(new_n70_));
  oai21  g51(.a(new_n70_), .b(new_n66_), .c(x03), .O(new_n71_));
