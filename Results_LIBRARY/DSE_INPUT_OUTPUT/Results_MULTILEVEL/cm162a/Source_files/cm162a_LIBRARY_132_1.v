...
module FAU ( 
  ...
  nand3  g34(.a(x13), .b(x09), .c(x05), .O(new_n54_));
  inv1   g35(.a(new_n54_), .O(new_n55_));
  aoi21  g36(.a(new_n53_), .b(new_n30_), .c(new_n55_), .O(new_n56_));
  nand4  g37(.a(x13), .b(x12), .c(x09), .d(x05), .O(new_n57_));
  oai21  g38(.a(new_n56_), .b(new_n52_), .c(new_n57_), .O(new_n58_));
  nand4  g39(.a(new_n39_), .b(new_n33_), .c(x04), .d(x02), .O(new_n59_));
  ...
  nor2   g43(.a(x12), .b(x05), .O(new_n63_));
  nor2   g44(.a(x07), .b(new_n27_), .O(new_n64_));
