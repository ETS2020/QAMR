...
module FAU ( 
  ...
  nor2   g16(.a(new_n31_), .b(x08), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(x02), .c(new_n35_), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(new_n34_), .c(x03), .O(new_n38_));
  inv1   g19(.a(x01), .O(new_n39_));
  aoi21  g20(.a(new_n27_), .b(new_n39_), .c(new_n28_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n38_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n35_), .c(new_n23_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n21_), .c(new_n20_), .O(new_n44_));
  nand2  g25(.a(new_n23_), .b(x02), .O(new_n45_));
  inv1   g26(.a(new_n45_), .O(new_n46_));
  nor2   g27(.a(new_n31_), .b(x10), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n46_), .c(new_n42_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n44_), .c(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n27_), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n49_), .c(x05), .d(x04), .O(z2));
  inv1   g33(.a(x04), .O(new_n53_));
  nor2   g34(.a(x12), .b(x11), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n32_), .c(new_n31_), .O(new_n55_));
  nand3  g36(.a(new_n21_), .b(new_n42_), .c(new_n35_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n45_), .c(x12), .O(new_n57_));
  oai21  g38(.a(new_n55_), .b(new_n20_), .c(new_n57_), .O(new_n58_));
  nor2   g39(.a(x07), .b(x03), .O(new_n59_));
  aoi21  g40(.a(new_n58_), .b(x03), .c(new_n59_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n53_), .c(x05), .O(z3));
  nand2  g42(.a(new_n31_), .b(x04), .O(new_n62_));
