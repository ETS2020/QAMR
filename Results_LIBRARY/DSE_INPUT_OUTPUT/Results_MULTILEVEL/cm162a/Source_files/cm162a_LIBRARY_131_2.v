...
module FAU ( 
  ...
  nand4  g16(.a(new_n35_), .b(new_n25_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand2  g20(.a(new_n23_), .b(new_n35_), .O(new_n40_));
  ...
  nand3  g34(.a(new_n49_), .b(new_n35_), .c(new_n25_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n30_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n53_), .c(x04), .d(x02), .O(new_n56_));
  inv1   g37(.a(x04), .O(new_n57_));
  nor2   g38(.a(x08), .b(new_n57_), .O(new_n58_));
  nor3   g39(.a(x11), .b(x10), .c(x09), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n58_), .c(x02), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x13), .c(x12), .O(new_n61_));
  ...
  nand2  g47(.a(new_n31_), .b(x04), .O(new_n67_));
