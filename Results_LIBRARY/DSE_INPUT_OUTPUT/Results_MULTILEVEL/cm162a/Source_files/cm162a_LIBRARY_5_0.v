...
module FAU ( 
  ...
  nand4  g35(.a(new_n44_), .b(new_n29_), .c(x05), .d(x04), .O(new_n55_));
  nand3  g36(.a(new_n21_), .b(new_n42_), .c(new_n41_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n25_), .c(x12), .O(new_n57_));
  oai21  g38(.a(new_n55_), .b(new_n54_), .c(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  nor2   g40(.a(x07), .b(new_n50_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n20_), .c(new_n30_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n21_), .b(new_n63_), .c(x12), .d(x05), .O(z4));
endmodule
