...
module FAU ( 
  ...
  oai21  g39(.a(new_n44_), .b(new_n34_), .c(x12), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n58_), .c(new_n20_), .O(new_n60_));
  nor2   g41(.a(x07), .b(x03), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n60_), .c(x06), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x05), .O(z3));
  inv1   g44(.a(x06), .O(new_n64_));
