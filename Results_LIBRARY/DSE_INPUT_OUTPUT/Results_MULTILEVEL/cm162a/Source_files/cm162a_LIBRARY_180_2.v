...
module FAU ( 
  ...
  nand2  g09(.a(new_n28_), .b(x06), .O(new_n29_));
  ...
  oai21  g23(.a(new_n28_), .b(new_n20_), .c(x06), .O(new_n43_));
  ...
  aoi22  g35(.a(new_n29_), .b(new_n53_), .c(new_n54_), .d(new_n20_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n52_), .O(z2));
  nand3  g37(.a(x13), .b(x09), .c(new_n54_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n46_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n28_), .c(x04), .d(x02), .O(new_n59_));
  nand3  g40(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n60_));
  ...
  nand4  g49(.a(new_n29_), .b(x13), .c(x09), .d(x04), .O(new_n69_));
