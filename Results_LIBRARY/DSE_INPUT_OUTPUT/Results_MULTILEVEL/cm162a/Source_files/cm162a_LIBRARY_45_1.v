...
module FAU ( 
  ...
  nand2  g17(.a(new_n26_), .b(new_n22_), .O(new_n37_));
  ...
  nand3  g30(.a(new_n26_), .b(new_n45_), .c(new_n22_), .O(new_n50_));
  ...
  nand2  g40(.a(new_n59_), .b(new_n43_), .O(new_n60_));
  nand3  g41(.a(new_n48_), .b(new_n23_), .c(x04), .O(new_n61_));
  nand2  g42(.a(new_n22_), .b(x04), .O(new_n62_));
  nand3  g43(.a(new_n26_), .b(new_n46_), .c(new_n45_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n62_), .c(x12), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(x03), .c(x02), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n60_), .O(z3));
  nand4  g48(.a(new_n43_), .b(x13), .c(x09), .d(x04), .O(new_n68_));
