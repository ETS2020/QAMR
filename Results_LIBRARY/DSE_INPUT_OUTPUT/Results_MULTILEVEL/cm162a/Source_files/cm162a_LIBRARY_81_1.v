...
module FAU ( 
  ...
  and2   g19(.a(x05), .b(x01), .O(new_n39_));
  oai21  g20(.a(new_n38_), .b(new_n20_), .c(new_n39_), .O(z1));
  ...
  nand3  g25(.a(new_n21_), .b(new_n31_), .c(new_n24_), .O(new_n45_));
  ...
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x01), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x05), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n41_), .c(new_n31_), .d(new_n24_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n21_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  nand3  g35(.a(new_n21_), .b(new_n41_), .c(new_n31_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n25_), .c(x12), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n54_), .c(new_n20_), .O(new_n57_));
  nor2   g38(.a(x07), .b(x03), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(x01), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x05), .O(z3));
  inv1   g41(.a(x05), .O(new_n61_));
  oai22  g42(.a(new_n21_), .b(new_n30_), .c(new_n61_), .d(x01), .O(z4));
endmodule
