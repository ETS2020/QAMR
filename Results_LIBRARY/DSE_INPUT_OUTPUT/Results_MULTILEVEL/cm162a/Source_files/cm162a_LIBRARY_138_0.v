...
module FAU ( 
  ...
  nand2  g33(.a(new_n52_), .b(new_n41_), .O(z2));
  inv1   g34(.a(x02), .O(new_n54_));
  nand4  g35(.a(new_n46_), .b(new_n39_), .c(x05), .d(x04), .O(new_n55_));
  nand3  g36(.a(new_n21_), .b(new_n44_), .c(new_n43_), .O(new_n56_));
  ...
  aoi21  g41(.a(new_n60_), .b(new_n20_), .c(new_n40_), .O(new_n61_));
