...
module FAU ( 
  ...
  nand2  g36(.a(new_n44_), .b(new_n26_), .O(new_n56_));
  nand3  g37(.a(x13), .b(new_n36_), .c(x09), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n20_), .c(x04), .d(x02), .O(new_n59_));
  nand3  g40(.a(new_n23_), .b(new_n44_), .c(new_n26_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n48_), .c(x12), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n59_), .c(new_n36_), .O(new_n62_));
