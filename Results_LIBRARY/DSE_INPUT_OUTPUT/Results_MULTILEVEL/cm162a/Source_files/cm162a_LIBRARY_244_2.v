...
module FAU ( 
  ...
  nand2  g05(.a(new_n24_), .b(x04), .O(new_n25_));
  ...
  nor2   g10(.a(new_n27_), .b(x02), .O(new_n30_));
  ...
  nand3  g17(.a(new_n24_), .b(new_n27_), .c(x04), .O(new_n37_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n40_), .c(new_n27_), .O(new_n45_));
  ...
  nand3  g32(.a(new_n24_), .b(new_n40_), .c(new_n27_), .O(new_n52_));
  inv1   g33(.a(new_n52_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n51_), .c(new_n44_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n48_), .c(x03), .O(new_n55_));
  nand3  g36(.a(new_n44_), .b(x03), .c(new_n49_), .O(new_n56_));
  ...
  oai21  g44(.a(new_n62_), .b(new_n49_), .c(new_n63_), .O(new_n64_));
  inv1   g45(.a(x12), .O(new_n65_));
  inv1   g46(.a(new_n45_), .O(new_n66_));
  aoi21  g47(.a(new_n51_), .b(new_n66_), .c(new_n65_), .O(new_n67_));
  aoi21  g48(.a(new_n64_), .b(x04), .c(new_n67_), .O(new_n68_));
  inv1   g49(.a(x07), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n59_), .O(new_n70_));
  nand3  g51(.a(new_n70_), .b(new_n21_), .c(x05), .O(new_n71_));
  inv1   g52(.a(new_n71_), .O(new_n72_));
  oai21  g53(.a(new_n68_), .b(new_n59_), .c(new_n72_), .O(z3));
  oai21  g54(.a(new_n24_), .b(new_n50_), .c(new_n21_), .O(z4));
endmodule
