...
module FAU ( 
  ...
  aoi21  g37(.a(new_n56_), .b(new_n29_), .c(new_n20_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(x05), .O(z2));
  nand4  g39(.a(new_n39_), .b(new_n48_), .c(new_n47_), .d(new_n24_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n21_), .O(new_n60_));
  nand4  g41(.a(new_n60_), .b(x04), .c(x02), .d(x01), .O(new_n61_));
  nand3  g42(.a(new_n21_), .b(new_n48_), .c(new_n47_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n25_), .c(x12), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x03), .O(new_n65_));
  inv1   g46(.a(new_n20_), .O(new_n66_));
  ...
  oai21  g51(.a(new_n21_), .b(new_n70_), .c(new_n66_), .O(z4));
endmodule
