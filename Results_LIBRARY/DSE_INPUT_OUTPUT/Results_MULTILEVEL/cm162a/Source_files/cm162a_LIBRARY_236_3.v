...
module FAU ( 
  ...
  nand3  g29(.a(new_n48_), .b(new_n46_), .c(new_n23_), .O(new_n49_));
  ...
  aoi21  g35(.a(new_n44_), .b(new_n21_), .c(new_n54_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(x02), .c(x12), .O(new_n56_));
  ...
  oai22  g40(.a(new_n21_), .b(new_n54_), .c(new_n23_), .d(new_n20_), .O(z4));
endmodule
