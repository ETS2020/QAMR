...
module FAU ( 
  ...
  nor2   g23(.a(new_n21_), .b(x06), .O(new_n43_));
  inv1   g24(.a(x12), .O(new_n44_));
  nor2   g25(.a(new_n44_), .b(x05), .O(new_n45_));
  oai21  g26(.a(new_n45_), .b(new_n43_), .c(new_n30_), .O(new_n46_));
  oai21  g27(.a(new_n44_), .b(x11), .c(x10), .O(new_n47_));
  ...
  nand2  g32(.a(new_n36_), .b(x11), .O(new_n52_));
  inv1   g33(.a(x11), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n25_), .c(x04), .d(x02), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n52_), .c(x10), .O(new_n55_));
  nand3  g36(.a(x12), .b(x11), .c(x10), .O(new_n56_));
  ...
  oai21  g40(.a(x11), .b(x08), .c(new_n22_), .O(new_n60_));
  nand4  g41(.a(new_n60_), .b(new_n44_), .c(x04), .d(x02), .O(new_n61_));
  nand2  g42(.a(x04), .b(x02), .O(new_n62_));
  nand3  g43(.a(new_n22_), .b(new_n53_), .c(new_n25_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n62_), .c(x12), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n61_), .c(new_n20_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x03), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n30_), .c(new_n21_), .O(new_n68_));
  nand3  g49(.a(new_n68_), .b(new_n66_), .c(x05), .O(z3));
  oai21  g50(.a(x12), .b(new_n20_), .c(new_n49_), .O(z4));
endmodule
