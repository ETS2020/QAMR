...
module FAU ( 
  ...
  nand4  g35(.a(new_n45_), .b(new_n54_), .c(x04), .d(x02), .O(new_n55_));
  nand3  g36(.a(new_n21_), .b(new_n43_), .c(new_n42_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n24_), .c(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  aoi21  g40(.a(x12), .b(x03), .c(x07), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n27_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n21_), .b(new_n63_), .c(x12), .d(x07), .O(z4));
endmodule
