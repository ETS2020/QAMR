...
module FAU ( 
  ...
  nand4  g28(.a(new_n36_), .b(new_n24_), .c(new_n43_), .d(new_n20_), .O(new_n48_));
  ...
  nor2   g32(.a(x06), .b(new_n40_), .O(new_n52_));
  aoi22  g33(.a(new_n52_), .b(new_n30_), .c(new_n40_), .d(x02), .O(new_n53_));
  ...
  oai21  g38(.a(new_n56_), .b(new_n35_), .c(new_n57_), .O(new_n58_));
  inv1   g39(.a(x12), .O(new_n59_));
  inv1   g40(.a(new_n45_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n36_), .c(new_n59_), .O(new_n61_));
  aoi21  g42(.a(new_n58_), .b(x04), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n30_), .c(new_n40_), .O(new_n64_));
  oai21  g45(.a(new_n62_), .b(new_n30_), .c(new_n64_), .O(z3));
  oai21  g46(.a(new_n40_), .b(x03), .c(x02), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n40_), .O(new_n67_));
