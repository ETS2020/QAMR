...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n21_), .c(new_n31_), .O(new_n34_));
  nand4  g15(.a(new_n21_), .b(new_n23_), .c(x04), .d(x02), .O(new_n35_));
  ...
  nand4  g21(.a(new_n40_), .b(new_n32_), .c(new_n23_), .d(x05), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n21_), .c(new_n31_), .O(new_n42_));
  nand4  g23(.a(new_n32_), .b(new_n23_), .c(x04), .d(x02), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(x05), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  aoi22  g26(.a(new_n45_), .b(x11), .c(new_n42_), .d(x02), .O(new_n46_));
  nor2   g27(.a(x06), .b(new_n28_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n20_), .c(x09), .d(new_n28_), .O(new_n48_));
  oai21  g29(.a(new_n46_), .b(new_n20_), .c(new_n48_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n40_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n33_), .c(new_n21_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand3  g34(.a(new_n21_), .b(new_n40_), .c(new_n32_), .O(new_n54_));
  ...
  oai22  g41(.a(new_n21_), .b(new_n31_), .c(x09), .d(x05), .O(z4));
endmodule
