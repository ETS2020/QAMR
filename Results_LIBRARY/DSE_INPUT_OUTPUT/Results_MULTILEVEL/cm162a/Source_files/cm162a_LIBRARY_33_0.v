...
module FAU ( 
  ...
  nand4  g29(.a(new_n48_), .b(x12), .c(x04), .d(x02), .O(new_n49_));
  ...
  nand3  g40(.a(x11), .b(x04), .c(x02), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n21_), .c(new_n59_), .O(new_n61_));
  nor2   g42(.a(x11), .b(x10), .O(new_n62_));
  nand4  g43(.a(new_n62_), .b(new_n27_), .c(x04), .d(x02), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(x12), .c(new_n61_), .d(x09), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n32_), .c(new_n58_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai21  g47(.a(new_n24_), .b(new_n66_), .c(new_n22_), .O(z4));
endmodule
