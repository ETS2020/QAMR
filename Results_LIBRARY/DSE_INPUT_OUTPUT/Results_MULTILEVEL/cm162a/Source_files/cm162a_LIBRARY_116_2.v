...
module FAU ( 
  ...
  aoi21  g18(.a(new_n37_), .b(new_n23_), .c(new_n35_), .O(new_n38_));
  nand4  g19(.a(new_n23_), .b(new_n26_), .c(x04), .d(x02), .O(new_n39_));
  ...
  oai21  g23(.a(new_n40_), .b(new_n31_), .c(new_n42_), .O(z1));
  ...
  nand3  g29(.a(new_n23_), .b(new_n36_), .c(new_n26_), .O(new_n49_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n52_), .c(new_n21_), .d(x05), .O(z2));
  nand3  g36(.a(x13), .b(new_n44_), .c(x09), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n37_), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n20_), .c(x04), .d(x02), .O(new_n58_));
  oai21  g39(.a(new_n49_), .b(new_n48_), .c(x12), .O(new_n59_));
