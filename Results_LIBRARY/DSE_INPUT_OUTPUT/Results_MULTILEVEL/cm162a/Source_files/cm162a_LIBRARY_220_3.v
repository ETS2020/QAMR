// Benchmark "FAU" written by ABC on Thu Aug 13 15:06:57 2020
...
module FAU ( 
  ...
  nand3  g31(.a(x13), .b(new_n20_), .c(x09), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n42_), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  inv1   g34(.a(x07), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n21_), .c(x12), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n53_), .c(x05), .O(z3));
