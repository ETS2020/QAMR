...
module FAU ( 
  ...
  aoi21  g28(.a(new_n47_), .b(new_n34_), .c(new_n41_), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n41_), .c(new_n31_), .d(new_n30_), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n56_), .c(new_n23_), .O(new_n58_));
  inv1   g39(.a(new_n42_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n34_), .c(new_n53_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n58_), .c(x03), .O(new_n61_));
  nor2   g42(.a(x07), .b(new_n27_), .O(new_n62_));
  aoi22  g43(.a(new_n62_), .b(new_n20_), .c(x12), .d(new_n27_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  oai21  g45(.a(new_n27_), .b(x03), .c(x12), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n27_), .O(new_n66_));
