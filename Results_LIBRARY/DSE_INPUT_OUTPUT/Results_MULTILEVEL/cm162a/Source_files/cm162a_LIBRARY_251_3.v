...
module FAU ( 
  ...
  aoi21  g21(.a(new_n30_), .b(new_n40_), .c(new_n31_), .O(new_n41_));
  ...
  nand3  g28(.a(new_n47_), .b(new_n45_), .c(x11), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n44_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n43_), .b(new_n54_), .c(new_n25_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n22_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n45_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n47_), .b(x12), .c(new_n43_), .O(new_n58_));
  ...
  nand4  g44(.a(new_n20_), .b(x13), .c(x09), .d(x04), .O(new_n64_));
