...
module FAU ( 
  ...
  nand3  g12(.a(new_n31_), .b(x08), .c(x03), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(new_n29_), .O(z0));
  nand2  g14(.a(new_n26_), .b(x10), .O(new_n34_));
  nor2   g15(.a(x10), .b(x08), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(x04), .c(x02), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n34_), .c(new_n22_), .O(new_n37_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n40_), .c(new_n25_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n30_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n30_), .b(new_n40_), .c(new_n25_), .O(new_n48_));
  ...
  aoi22  g37(.a(new_n56_), .b(new_n35_), .c(x13), .d(x09), .O(new_n57_));
  nand3  g38(.a(x13), .b(x12), .c(x09), .O(new_n58_));
  oai21  g39(.a(new_n57_), .b(new_n55_), .c(new_n58_), .O(new_n59_));
  inv1   g40(.a(x12), .O(new_n60_));
  nor2   g41(.a(new_n45_), .b(new_n23_), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  aoi21  g43(.a(new_n59_), .b(x04), .c(new_n62_), .O(new_n63_));
  inv1   g44(.a(x07), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n22_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n21_), .c(x05), .O(new_n66_));
  inv1   g47(.a(new_n66_), .O(new_n67_));
  oai21  g48(.a(new_n63_), .b(new_n22_), .c(new_n67_), .O(z3));
  nand2  g49(.a(new_n31_), .b(x04), .O(new_n69_));
