...
module FAU ( 
  ...
  nand3  g11(.a(new_n30_), .b(new_n23_), .c(x05), .O(z0));
  ...
  nand2  g21(.a(new_n22_), .b(new_n20_), .O(new_n41_));
  nand4  g22(.a(new_n41_), .b(new_n40_), .c(new_n38_), .d(x05), .O(z1));
  inv1   g23(.a(new_n41_), .O(new_n43_));
  ...
  nand3  g29(.a(new_n24_), .b(new_n44_), .c(new_n27_), .O(new_n49_));
  ...
  nand4  g37(.a(new_n47_), .b(new_n22_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n24_), .b(new_n45_), .c(new_n44_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n28_), .c(x12), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  oai21  g42(.a(x07), .b(x03), .c(new_n41_), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n53_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai21  g46(.a(new_n24_), .b(new_n65_), .c(new_n41_), .O(z4));
endmodule
