...
module FAU ( 
  ...
  oai21  g22(.a(new_n23_), .b(x04), .c(x05), .O(new_n42_));
  ...
  nand2  g28(.a(new_n22_), .b(x02), .O(new_n48_));
  inv1   g29(.a(x10), .O(new_n49_));
  nand2  g30(.a(new_n26_), .b(new_n49_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n48_), .c(x11), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n47_), .c(new_n21_), .O(new_n52_));
  oai21  g33(.a(x06), .b(x03), .c(x05), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n52_), .c(x04), .O(new_n54_));
  nand2  g35(.a(new_n53_), .b(new_n23_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(z2));
  inv1   g37(.a(x02), .O(new_n57_));
  nor2   g38(.a(x10), .b(x08), .O(new_n58_));
  nor2   g39(.a(x12), .b(x11), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n58_), .c(new_n45_), .O(new_n60_));
  nand3  g41(.a(new_n26_), .b(new_n23_), .c(new_n49_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n48_), .c(x12), .O(new_n62_));
  oai21  g43(.a(new_n60_), .b(new_n57_), .c(new_n62_), .O(new_n63_));
  oai21  g44(.a(x07), .b(x03), .c(x05), .O(new_n64_));
  aoi21  g45(.a(new_n63_), .b(x03), .c(new_n64_), .O(new_n65_));
  aoi21  g46(.a(x07), .b(x05), .c(x03), .O(new_n66_));
  nand3  g47(.a(x12), .b(new_n20_), .c(x03), .O(new_n67_));
  oai21  g48(.a(x12), .b(x05), .c(new_n67_), .O(new_n68_));
  oai21  g49(.a(new_n68_), .b(new_n66_), .c(new_n23_), .O(new_n69_));
  oai21  g50(.a(new_n65_), .b(new_n20_), .c(new_n69_), .O(z3));
  nand2  g51(.a(new_n45_), .b(x04), .O(new_n71_));
