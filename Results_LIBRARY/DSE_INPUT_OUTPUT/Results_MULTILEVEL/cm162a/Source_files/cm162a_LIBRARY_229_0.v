...
module FAU ( 
  ...
  nor2   g09(.a(x12), .b(x07), .O(new_n29_));
  ...
  nand3  g35(.a(x13), .b(x09), .c(x07), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n44_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n54_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n21_), .b(new_n43_), .c(new_n42_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n24_), .c(x12), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  aoi21  g42(.a(x12), .b(x03), .c(x07), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n27_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  inv1   g46(.a(x09), .O(new_n66_));
  inv1   g47(.a(x13), .O(new_n67_));
  nor4   g48(.a(new_n29_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(z4));
endmodule
