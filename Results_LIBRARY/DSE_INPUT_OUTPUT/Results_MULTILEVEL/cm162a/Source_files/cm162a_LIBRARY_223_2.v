...
module FAU ( 
  ...
  oai21  g11(.a(new_n27_), .b(new_n20_), .c(new_n30_), .O(new_n31_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n35_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n21_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  nand3  g26(.a(new_n21_), .b(new_n41_), .c(new_n35_), .O(new_n46_));
  ...
  nand2  g31(.a(new_n27_), .b(new_n30_), .O(new_n51_));
  ...
  oai22  g46(.a(new_n21_), .b(new_n23_), .c(x05), .d(new_n30_), .O(z4));
endmodule
