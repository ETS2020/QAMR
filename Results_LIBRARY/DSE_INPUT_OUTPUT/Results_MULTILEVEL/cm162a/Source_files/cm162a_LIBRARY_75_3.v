...
module FAU ( 
  ...
  nand3  g35(.a(x13), .b(new_n23_), .c(x09), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n44_), .c(new_n54_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x02), .c(x12), .O(new_n57_));
  ...
  nand2  g41(.a(x12), .b(x03), .O(new_n61_));
