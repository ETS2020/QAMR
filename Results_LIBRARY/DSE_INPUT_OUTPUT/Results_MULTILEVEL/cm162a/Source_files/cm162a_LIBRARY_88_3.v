...
module FAU ( 
  ...
  nand4  g36(.a(new_n20_), .b(new_n51_), .c(new_n36_), .d(new_n26_), .O(new_n56_));
  nand2  g37(.a(x13), .b(x09), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  aoi22  g39(.a(new_n58_), .b(x02), .c(new_n47_), .d(x12), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n31_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n34_), .c(x05), .O(new_n62_));
