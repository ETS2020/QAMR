...
module FAU ( 
  ...
  nand2  g43(.a(new_n62_), .b(new_n35_), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n61_), .c(new_n21_), .d(x05), .O(z2));
  nand4  g45(.a(new_n55_), .b(new_n30_), .c(x04), .d(x02), .O(new_n65_));
  nand2  g46(.a(new_n27_), .b(x02), .O(new_n66_));
  nand3  g47(.a(new_n25_), .b(new_n53_), .c(new_n52_), .O(new_n67_));
