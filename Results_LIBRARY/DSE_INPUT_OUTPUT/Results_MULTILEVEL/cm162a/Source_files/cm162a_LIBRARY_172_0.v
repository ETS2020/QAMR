...
module FAU ( 
  ...
  nand4  g26(.a(new_n35_), .b(new_n21_), .c(new_n41_), .d(new_n33_), .O(new_n46_));
  ...
  aoi22  g31(.a(new_n50_), .b(new_n20_), .c(new_n27_), .d(x02), .O(new_n51_));
  ...
  nand4  g35(.a(x13), .b(x12), .c(x09), .d(x05), .O(new_n55_));
  oai21  g36(.a(new_n54_), .b(new_n34_), .c(new_n55_), .O(new_n56_));
  inv1   g37(.a(x12), .O(new_n57_));
  inv1   g38(.a(new_n43_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n35_), .c(new_n57_), .O(new_n59_));
  ...
  oai21  g44(.a(new_n27_), .b(x03), .c(x02), .O(new_n64_));
