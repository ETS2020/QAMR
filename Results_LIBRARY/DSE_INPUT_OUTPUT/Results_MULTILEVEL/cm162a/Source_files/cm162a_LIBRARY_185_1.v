...
module FAU ( 
  ...
  aoi21  g16(.a(x11), .b(new_n20_), .c(x01), .O(new_n36_));
  nor2   g17(.a(x11), .b(x05), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n38_));
  inv1   g19(.a(new_n25_), .O(new_n39_));
  nor2   g20(.a(x10), .b(x08), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(x02), .O(new_n41_));
  nand3  g22(.a(new_n25_), .b(new_n27_), .c(x02), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x10), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n41_), .c(new_n20_), .O(new_n44_));
  nand3  g25(.a(new_n30_), .b(x10), .c(new_n20_), .O(new_n45_));
  ...
  oai21  g30(.a(new_n49_), .b(x04), .c(new_n48_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n47_), .c(new_n38_), .O(z1));
  nand2  g32(.a(new_n49_), .b(new_n27_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n25_), .c(new_n20_), .O(new_n53_));
  inv1   g34(.a(x10), .O(new_n54_));
  nand4  g35(.a(new_n25_), .b(new_n54_), .c(new_n27_), .d(x02), .O(new_n55_));
  aoi22  g36(.a(new_n55_), .b(x11), .c(new_n53_), .d(x02), .O(new_n56_));
  inv1   g37(.a(x06), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n35_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n21_), .c(x05), .O(new_n59_));
  inv1   g40(.a(new_n59_), .O(new_n60_));
  oai21  g41(.a(new_n56_), .b(new_n35_), .c(new_n60_), .O(z2));
  nor2   g42(.a(x12), .b(x11), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n40_), .c(new_n39_), .O(new_n63_));
  nand2  g44(.a(new_n27_), .b(x02), .O(new_n64_));
  nand3  g45(.a(new_n25_), .b(new_n30_), .c(new_n54_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n64_), .c(x12), .O(new_n66_));
  oai21  g47(.a(new_n63_), .b(new_n24_), .c(new_n66_), .O(new_n67_));
  oai21  g48(.a(x07), .b(x03), .c(x05), .O(new_n68_));
  aoi21  g49(.a(new_n67_), .b(x03), .c(new_n68_), .O(new_n69_));
  aoi21  g50(.a(x07), .b(x05), .c(x03), .O(new_n70_));
  nand3  g51(.a(x12), .b(new_n20_), .c(x03), .O(new_n71_));
  oai21  g52(.a(x12), .b(x05), .c(new_n71_), .O(new_n72_));
  oai21  g53(.a(new_n72_), .b(new_n70_), .c(new_n30_), .O(new_n73_));
  oai21  g54(.a(new_n69_), .b(new_n20_), .c(new_n73_), .O(z3));
  nand2  g55(.a(new_n39_), .b(x04), .O(new_n75_));
