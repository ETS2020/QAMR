...
module FAU ( 
  ...
  aoi21  g36(.a(new_n55_), .b(new_n31_), .c(new_n32_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n54_), .c(new_n22_), .O(z2));
  nand4  g38(.a(new_n48_), .b(new_n20_), .c(x04), .d(x02), .O(new_n58_));
  nand3  g39(.a(new_n23_), .b(new_n46_), .c(new_n38_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n27_), .c(x12), .O(new_n60_));
  oai21  g41(.a(new_n58_), .b(x01), .c(new_n60_), .O(new_n61_));
