...
module FAU ( 
  ...
  nand4  g17(.a(new_n36_), .b(x12), .c(x04), .d(x02), .O(new_n37_));
  and2   g18(.a(x04), .b(x02), .O(new_n38_));
  nand3  g19(.a(new_n38_), .b(new_n21_), .c(new_n23_), .O(new_n39_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n28_), .c(new_n23_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(x12), .c(new_n28_), .O(new_n48_));
  ...
  aoi21  g41(.a(new_n60_), .b(new_n38_), .c(new_n29_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n59_), .c(x03), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n20_), .O(new_n64_));
  nand4  g45(.a(new_n64_), .b(new_n62_), .c(new_n30_), .d(x05), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai21  g47(.a(new_n21_), .b(new_n66_), .c(new_n30_), .O(z4));
endmodule
