...
module FAU ( 
  ...
  nand3  g29(.a(new_n34_), .b(x04), .c(x02), .O(new_n49_));
  nand3  g30(.a(new_n25_), .b(x12), .c(new_n35_), .O(new_n50_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n20_), .c(new_n21_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n53_), .c(x05), .O(z2));
  nand4  g37(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n28_), .c(new_n34_), .O(new_n58_));
  nand4  g39(.a(new_n27_), .b(new_n25_), .c(new_n45_), .d(new_n35_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n34_), .c(new_n58_), .O(new_n60_));
  inv1   g41(.a(x05), .O(new_n61_));
  nor2   g42(.a(x07), .b(x03), .O(new_n62_));
  nor3   g43(.a(new_n62_), .b(new_n21_), .c(new_n61_), .O(new_n63_));
  oai21  g44(.a(new_n60_), .b(new_n20_), .c(new_n63_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  nand3  g46(.a(new_n22_), .b(x13), .c(x09), .O(new_n66_));
