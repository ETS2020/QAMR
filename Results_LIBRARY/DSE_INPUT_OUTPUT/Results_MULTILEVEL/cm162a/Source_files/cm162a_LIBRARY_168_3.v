...
module FAU ( 
  ...
  aoi21  g32(.a(new_n24_), .b(new_n20_), .c(new_n23_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n51_), .O(z2));
  inv1   g34(.a(x02), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n44_), .c(new_n43_), .d(new_n28_), .O(new_n56_));
