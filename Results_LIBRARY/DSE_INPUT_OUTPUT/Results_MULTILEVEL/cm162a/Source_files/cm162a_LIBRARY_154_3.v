...
module FAU ( 
  ...
  nor2   g29(.a(new_n32_), .b(x06), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n37_), .c(new_n35_), .O(new_n50_));
  oai21  g31(.a(x12), .b(x11), .c(x10), .O(new_n51_));
  inv1   g32(.a(x02), .O(new_n52_));
  inv1   g33(.a(x04), .O(new_n53_));
  nor4   g34(.a(new_n24_), .b(new_n53_), .c(new_n35_), .d(new_n52_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n29_), .c(new_n51_), .O(new_n55_));
  nand2  g36(.a(new_n42_), .b(x11), .O(new_n56_));
  inv1   g37(.a(x11), .O(new_n57_));
  nor2   g38(.a(new_n53_), .b(new_n52_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n57_), .c(new_n41_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n56_), .c(x10), .O(new_n60_));
  nand3  g41(.a(new_n31_), .b(x11), .c(x10), .O(new_n61_));
  inv1   g42(.a(new_n61_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n60_), .c(x03), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n55_), .c(new_n50_), .O(z2));
  nand3  g45(.a(new_n57_), .b(new_n20_), .c(new_n41_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n24_), .O(new_n66_));
  nand4  g47(.a(new_n66_), .b(new_n31_), .c(x04), .d(x02), .O(new_n67_));
  aoi21  g48(.a(x13), .b(x09), .c(x11), .O(new_n68_));
  nand3  g49(.a(new_n68_), .b(new_n58_), .c(new_n41_), .O(new_n69_));
  nand3  g50(.a(new_n69_), .b(x12), .c(new_n20_), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  nand2  g52(.a(new_n71_), .b(x03), .O(new_n72_));
  inv1   g53(.a(new_n32_), .O(new_n73_));
  oai21  g54(.a(x07), .b(x03), .c(x05), .O(new_n74_));
  nand2  g55(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g56(.a(new_n75_), .b(new_n72_), .O(z3));
  nand4  g57(.a(new_n73_), .b(x13), .c(x09), .d(x04), .O(new_n77_));
