...
module FAU ( 
  ...
  nor2   g14(.a(x12), .b(x02), .O(new_n34_));
  nor2   g15(.a(new_n34_), .b(x01), .O(new_n35_));
  inv1   g16(.a(x12), .O(new_n36_));
  nor2   g17(.a(new_n36_), .b(x05), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(new_n35_), .c(new_n21_), .O(new_n38_));
  and2   g19(.a(x13), .b(x09), .O(new_n39_));
  nor2   g20(.a(x10), .b(x08), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(x04), .O(new_n41_));
  nand3  g22(.a(new_n25_), .b(new_n22_), .c(x04), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x10), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n41_), .c(new_n21_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n31_), .c(x02), .O(new_n45_));
  ...
  nand3  g36(.a(new_n25_), .b(new_n50_), .c(new_n22_), .O(new_n56_));
  ...
  aoi21  g41(.a(new_n60_), .b(new_n21_), .c(new_n34_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n59_), .c(x05), .O(z2));
  oai21  g43(.a(new_n36_), .b(x03), .c(new_n20_), .O(new_n63_));
  oai21  g44(.a(new_n25_), .b(new_n20_), .c(new_n52_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n36_), .c(x04), .O(new_n65_));
  nand2  g46(.a(new_n22_), .b(x04), .O(new_n66_));
  nand3  g47(.a(new_n25_), .b(new_n51_), .c(new_n50_), .O(new_n67_));
  ...
  aoi21  g52(.a(new_n71_), .b(new_n21_), .c(new_n31_), .O(new_n72_));
  nand3  g53(.a(new_n72_), .b(new_n70_), .c(new_n63_), .O(z3));
  inv1   g54(.a(x04), .O(new_n74_));
  inv1   g55(.a(new_n34_), .O(new_n75_));
  nand3  g56(.a(new_n75_), .b(x13), .c(x09), .O(new_n76_));
  nor2   g57(.a(new_n76_), .b(new_n74_), .O(z4));
endmodule
