...
module FAU ( 
  ...
  nor3   g21(.a(new_n40_), .b(new_n20_), .c(new_n30_), .O(new_n41_));
  ...
  aoi21  g33(.a(new_n52_), .b(new_n29_), .c(new_n30_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n51_), .c(new_n20_), .O(z2));
