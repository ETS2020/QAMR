...
module FAU ( 
  ...
  nor2   g34(.a(new_n39_), .b(new_n31_), .O(new_n54_));
  nor2   g35(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  aoi21  g36(.a(new_n52_), .b(x04), .c(new_n55_), .O(new_n56_));
  inv1   g37(.a(x05), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n20_), .c(new_n57_), .O(new_n59_));
  oai21  g40(.a(new_n56_), .b(new_n20_), .c(new_n59_), .O(z3));
