...
module FAU ( 
  ...
  nand3  g29(.a(x13), .b(new_n20_), .c(x09), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(x02), .O(new_n51_));
  nand4  g32(.a(x13), .b(x12), .c(new_n20_), .d(x09), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n51_), .c(new_n45_), .O(new_n53_));
  nor2   g34(.a(x11), .b(x08), .O(new_n54_));
  aoi21  g35(.a(new_n38_), .b(new_n54_), .c(new_n47_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n53_), .c(x03), .O(new_n56_));
  inv1   g37(.a(x05), .O(new_n57_));
  nor2   g38(.a(x07), .b(x03), .O(new_n58_));
  nor3   g39(.a(new_n58_), .b(x10), .c(new_n57_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n56_), .O(z3));
  nand2  g41(.a(x10), .b(x05), .O(new_n61_));
