...
module FAU ( 
  ...
  nand2  g08(.a(x07), .b(x05), .O(new_n28_));
  ...
  aoi21  g32(.a(new_n50_), .b(new_n20_), .c(new_n51_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n49_), .c(x05), .O(z2));
  inv1   g34(.a(new_n28_), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  nand3  g36(.a(x13), .b(x09), .c(x07), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n43_), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n55_), .c(x04), .d(x02), .O(new_n58_));
  nand3  g39(.a(new_n21_), .b(new_n42_), .c(new_n41_), .O(new_n59_));
  ...
  nand2  g43(.a(new_n62_), .b(new_n54_), .O(z3));
  nand2  g44(.a(new_n51_), .b(x05), .O(new_n64_));
