...
module FAU ( 
  ...
  nand4  g41(.a(new_n60_), .b(new_n24_), .c(x04), .d(x02), .O(new_n61_));
  ...
  nor2   g46(.a(x07), .b(new_n65_), .O(new_n66_));
  aoi21  g47(.a(new_n66_), .b(new_n20_), .c(new_n29_), .O(new_n67_));
  oai21  g48(.a(new_n64_), .b(new_n20_), .c(new_n67_), .O(z3));
  nand2  g49(.a(x12), .b(new_n65_), .O(new_n69_));
