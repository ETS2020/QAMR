...
module FAU ( 
  ...
  oai21  g17(.a(new_n36_), .b(new_n27_), .c(x00), .O(new_n37_));
  ...
  oai21  g29(.a(new_n48_), .b(new_n27_), .c(x00), .O(new_n49_));
  nand2  g30(.a(x06), .b(x05), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n20_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n49_), .O(z2));
  or2    g33(.a(x12), .b(x02), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(x13), .c(x09), .d(x00), .O(new_n54_));
  nor2   g35(.a(x12), .b(x11), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n41_), .c(new_n33_), .d(x02), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n54_), .c(new_n23_), .O(new_n57_));
  oai21  g38(.a(new_n43_), .b(new_n32_), .c(x12), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x00), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n57_), .c(x03), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n20_), .c(new_n27_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  nand2  g44(.a(x03), .b(new_n26_), .O(new_n64_));
