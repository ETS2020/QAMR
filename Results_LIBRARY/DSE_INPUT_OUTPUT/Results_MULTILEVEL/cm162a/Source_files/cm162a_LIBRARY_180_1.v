...
module FAU ( 
  ...
  nor2   g09(.a(new_n28_), .b(x06), .O(new_n29_));
  ...
  nor2   g22(.a(new_n41_), .b(new_n31_), .O(new_n42_));
  ...
  aoi21  g31(.a(new_n50_), .b(new_n48_), .c(new_n29_), .O(new_n51_));
  nor2   g32(.a(x12), .b(x05), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x03), .O(new_n53_));
  inv1   g34(.a(x05), .O(new_n54_));
  nor2   g35(.a(x12), .b(x06), .O(new_n55_));
  aoi22  g36(.a(new_n55_), .b(new_n20_), .c(x06), .d(new_n54_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n53_), .O(z2));
  nand4  g38(.a(new_n47_), .b(new_n28_), .c(x04), .d(x02), .O(new_n58_));
  nand3  g39(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n59_));
  ...
  nand4  g46(.a(new_n30_), .b(x13), .c(x09), .d(x04), .O(new_n66_));
