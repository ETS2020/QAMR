...
module FAU ( 
  ...
  nand3  g25(.a(new_n44_), .b(new_n33_), .c(new_n21_), .O(new_n45_));
  ...
  nand3  g29(.a(new_n25_), .b(new_n34_), .c(new_n33_), .O(new_n49_));
  ...
  nand3  g37(.a(x13), .b(new_n34_), .c(x09), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n45_), .c(new_n56_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x02), .c(x12), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n20_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n22_), .c(x05), .O(new_n62_));
  inv1   g43(.a(new_n62_), .O(new_n63_));
  oai21  g44(.a(new_n59_), .b(new_n20_), .c(new_n63_), .O(z3));
  oai21  g45(.a(x12), .b(new_n20_), .c(x08), .O(new_n65_));
