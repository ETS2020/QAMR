...
module FAU ( 
  ...
  nor2   g09(.a(x07), .b(new_n28_), .O(new_n29_));
  ...
  aoi21  g23(.a(new_n20_), .b(new_n41_), .c(new_n42_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n40_), .c(new_n29_), .O(z1));
  ...
  nand3  g30(.a(new_n21_), .b(new_n45_), .c(new_n23_), .O(new_n50_));
  ...
  aoi21  g34(.a(x07), .b(x06), .c(x03), .O(new_n54_));
  nor2   g35(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n46_), .c(new_n45_), .d(new_n23_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n21_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x04), .c(x02), .O(new_n60_));
  nand3  g41(.a(new_n21_), .b(new_n46_), .c(new_n45_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n24_), .c(x12), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n60_), .c(new_n29_), .O(new_n63_));
  nor2   g44(.a(x06), .b(x05), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n63_), .c(x03), .O(new_n65_));
  nor2   g46(.a(x07), .b(x06), .O(new_n66_));
  aoi22  g47(.a(new_n66_), .b(new_n20_), .c(x07), .d(new_n42_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n65_), .O(z3));
  inv1   g49(.a(x04), .O(new_n69_));
  oai21  g50(.a(new_n21_), .b(new_n69_), .c(new_n30_), .O(z4));
endmodule
