...
module FAU ( 
  ...
  nand4  g39(.a(new_n35_), .b(new_n20_), .c(x04), .d(x02), .O(new_n59_));
  oai21  g40(.a(new_n50_), .b(new_n37_), .c(x12), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n59_), .c(new_n46_), .O(new_n61_));
