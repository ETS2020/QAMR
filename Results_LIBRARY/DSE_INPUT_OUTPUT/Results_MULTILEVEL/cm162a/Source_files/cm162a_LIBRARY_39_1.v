...
module FAU ( 
  ...
  nand4  g36(.a(new_n47_), .b(new_n20_), .c(x04), .d(x02), .O(new_n56_));
  nand3  g37(.a(new_n22_), .b(new_n45_), .c(new_n44_), .O(new_n57_));
