...
module FAU ( 
  ...
  nor2   g07(.a(new_n26_), .b(x01), .O(new_n27_));
  oai21  g08(.a(new_n25_), .b(new_n20_), .c(new_n27_), .O(z0));
  ...
  nand3  g16(.a(new_n35_), .b(new_n31_), .c(x03), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(new_n29_), .O(new_n37_));
  ...
  oai21  g28(.a(new_n47_), .b(new_n46_), .c(new_n29_), .O(new_n48_));
  ...
  nor3   g42(.a(new_n61_), .b(new_n60_), .c(x01), .O(new_n62_));
  oai21  g43(.a(new_n59_), .b(new_n20_), .c(new_n62_), .O(z3));
  oai22  g44(.a(new_n21_), .b(new_n23_), .c(new_n60_), .d(new_n29_), .O(z4));
endmodule
