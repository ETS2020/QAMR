...
module FAU ( 
  ...
  nand4  g35(.a(new_n21_), .b(new_n43_), .c(new_n35_), .d(new_n26_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n23_), .c(new_n31_), .O(new_n56_));
  ...
  oai21  g41(.a(x12), .b(new_n60_), .c(new_n31_), .O(new_n61_));
  oai21  g42(.a(new_n44_), .b(new_n47_), .c(x12), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n61_), .c(x05), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  oai21  g45(.a(new_n59_), .b(new_n34_), .c(new_n64_), .O(z3));
  oai22  g46(.a(new_n23_), .b(new_n34_), .c(new_n21_), .d(x03), .O(z4));
endmodule
