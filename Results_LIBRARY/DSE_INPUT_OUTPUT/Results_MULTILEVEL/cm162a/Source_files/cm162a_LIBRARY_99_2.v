...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n36_), .c(new_n29_), .O(new_n38_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n39_), .c(new_n23_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n39_), .c(new_n23_), .O(new_n48_));
  ...
  nor2   g41(.a(new_n45_), .b(new_n40_), .O(new_n61_));
  ...
  nand3  g46(.a(new_n65_), .b(new_n29_), .c(x05), .O(new_n66_));
