...
module FAU ( 
  ...
  nor2   g00(.a(x12), .b(x06), .O(new_n20_));
  ...
  nor2   g32(.a(new_n51_), .b(x05), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n50_), .c(x03), .O(new_n53_));
  nor2   g34(.a(new_n51_), .b(x06), .O(new_n54_));
  aoi22  g35(.a(new_n54_), .b(new_n29_), .c(x06), .d(new_n30_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(z2));
  inv1   g37(.a(x02), .O(new_n57_));
  nand4  g38(.a(new_n46_), .b(new_n51_), .c(x06), .d(x04), .O(new_n58_));
  nand3  g39(.a(new_n21_), .b(new_n44_), .c(new_n43_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n25_), .c(x12), .O(new_n60_));
  oai21  g41(.a(new_n58_), .b(new_n57_), .c(new_n60_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  inv1   g43(.a(new_n20_), .O(new_n63_));
  ...
  nand3  g48(.a(new_n63_), .b(x13), .c(x09), .O(new_n68_));
