...
module FAU ( 
  ...
  aoi21  g23(.a(new_n27_), .b(x08), .c(x06), .O(new_n43_));
  nor2   g24(.a(new_n27_), .b(x05), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(new_n20_), .O(new_n45_));
  oai21  g26(.a(new_n27_), .b(x11), .c(x08), .O(new_n46_));
  ...
  nand4  g31(.a(new_n21_), .b(new_n33_), .c(x04), .d(x02), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x11), .O(new_n52_));
  inv1   g33(.a(x11), .O(new_n53_));
  nand3  g34(.a(new_n37_), .b(new_n53_), .c(new_n33_), .O(new_n54_));
  ...
  oai21  g40(.a(x11), .b(x10), .c(new_n21_), .O(new_n60_));
  nand4  g41(.a(new_n60_), .b(new_n27_), .c(x04), .d(x02), .O(new_n61_));
  nand3  g42(.a(new_n21_), .b(new_n53_), .c(new_n33_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n36_), .c(x12), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n61_), .c(new_n32_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x03), .O(new_n65_));
  inv1   g46(.a(x07), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n20_), .O(new_n67_));
  nand4  g48(.a(new_n67_), .b(new_n65_), .c(new_n28_), .d(x05), .O(z3));
  nand2  g49(.a(new_n48_), .b(new_n28_), .O(z4));
endmodule
