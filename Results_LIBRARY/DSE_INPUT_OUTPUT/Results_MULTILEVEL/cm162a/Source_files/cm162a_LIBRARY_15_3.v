...
module FAU ( 
  ...
  nand4  g38(.a(new_n57_), .b(new_n45_), .c(new_n44_), .d(new_n25_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n22_), .c(new_n30_), .O(new_n59_));
  ...
  oai21  g44(.a(x12), .b(new_n63_), .c(new_n30_), .O(new_n64_));
  nand3  g45(.a(new_n63_), .b(x04), .c(x02), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n46_), .c(x12), .O(new_n66_));
  nand3  g47(.a(new_n66_), .b(new_n64_), .c(x05), .O(new_n67_));
  inv1   g48(.a(new_n67_), .O(new_n68_));
  oai21  g49(.a(new_n62_), .b(new_n56_), .c(new_n68_), .O(z3));
  oai21  g50(.a(new_n22_), .b(new_n56_), .c(new_n20_), .O(z4));
endmodule
