...
module FAU ( 
  ...
  nor2   g17(.a(new_n36_), .b(new_n33_), .O(new_n37_));
  nand4  g18(.a(new_n21_), .b(new_n24_), .c(x04), .d(x02), .O(new_n38_));
  ...
  nand3  g29(.a(new_n21_), .b(new_n43_), .c(new_n24_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x11), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n47_), .c(new_n20_), .O(new_n51_));
  nor2   g32(.a(x06), .b(x03), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x05), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n31_), .O(z2));
  ...
  aoi21  g39(.a(new_n56_), .b(new_n35_), .c(new_n58_), .O(new_n59_));
  nand4  g40(.a(x13), .b(x12), .c(x09), .d(x05), .O(new_n60_));
  oai21  g41(.a(new_n59_), .b(new_n55_), .c(new_n60_), .O(new_n61_));
  inv1   g42(.a(x12), .O(new_n62_));
  nor2   g43(.a(new_n45_), .b(new_n48_), .O(new_n63_));
  ...
  nand3  g49(.a(new_n34_), .b(x05), .c(x04), .O(new_n69_));
