...
module FAU ( 
  ...
  nand4  g19(.a(new_n38_), .b(new_n36_), .c(x07), .d(x05), .O(z1));
  ...
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x07), .O(new_n49_));
  ...
  nand3  g37(.a(new_n56_), .b(x07), .c(x05), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  inv1   g39(.a(x05), .O(new_n59_));
  oai22  g40(.a(new_n21_), .b(new_n58_), .c(x07), .d(new_n59_), .O(z4));
endmodule
