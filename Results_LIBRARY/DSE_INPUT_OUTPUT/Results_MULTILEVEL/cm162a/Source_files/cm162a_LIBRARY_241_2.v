...
module FAU ( 
  ...
  oai21  g31(.a(x06), .b(x03), .c(x12), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(new_n37_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  nand3  g34(.a(new_n21_), .b(new_n43_), .c(new_n42_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n25_), .c(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n20_), .c(new_n38_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(x05), .O(z3));
  nand2  g39(.a(new_n38_), .b(x05), .O(new_n59_));
