...
module FAU ( 
  ...
  nand2  g27(.a(new_n46_), .b(x02), .O(new_n47_));
  ...
  nand3  g36(.a(new_n55_), .b(new_n20_), .c(x05), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n52_), .O(z2));
  nand3  g39(.a(new_n46_), .b(x03), .c(x02), .O(new_n59_));
  inv1   g40(.a(x05), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n53_), .c(new_n60_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n28_), .O(new_n64_));
  aoi21  g45(.a(x07), .b(new_n53_), .c(new_n28_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n60_), .c(new_n23_), .O(new_n66_));
