...
module FAU ( 
  ...
  aoi21  g26(.a(new_n45_), .b(new_n41_), .c(new_n20_), .O(z1));
  ...
  aoi21  g37(.a(new_n56_), .b(new_n43_), .c(new_n20_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(x05), .O(z2));
  nand4  g39(.a(new_n50_), .b(new_n27_), .c(x04), .d(x02), .O(new_n59_));
  nand3  g40(.a(new_n21_), .b(new_n48_), .c(new_n47_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n25_), .c(x12), .O(new_n61_));
  oai21  g42(.a(new_n59_), .b(new_n30_), .c(new_n61_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  inv1   g44(.a(new_n20_), .O(new_n64_));
  ...
  nand3  g49(.a(new_n64_), .b(x13), .c(x09), .O(new_n69_));
