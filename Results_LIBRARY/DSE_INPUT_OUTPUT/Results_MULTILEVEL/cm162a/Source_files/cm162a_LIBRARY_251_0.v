...
module FAU ( 
  ...
  nand4  g27(.a(new_n46_), .b(x12), .c(x04), .d(x02), .O(new_n47_));
  ...
  inv1   g32(.a(new_n20_), .O(new_n52_));
  ...
  nand2  g37(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  inv1   g38(.a(x12), .O(new_n58_));
  oai21  g39(.a(new_n35_), .b(new_n44_), .c(new_n58_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x13), .c(x09), .O(new_n60_));
  ...
  nand3  g46(.a(new_n52_), .b(x13), .c(x09), .O(new_n66_));
