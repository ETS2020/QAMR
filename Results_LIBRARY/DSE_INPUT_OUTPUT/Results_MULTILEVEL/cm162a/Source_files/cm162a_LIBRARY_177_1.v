...
module FAU ( 
  ...
  nand3  g21(.a(new_n21_), .b(new_n36_), .c(new_n30_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n29_), .c(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n40_), .c(new_n34_), .O(z2));
  ...
  nor2   g31(.a(new_n38_), .b(new_n29_), .O(new_n51_));
  ...
  oai22  g35(.a(new_n21_), .b(new_n23_), .c(new_n33_), .d(x03), .O(z4));
endmodule
