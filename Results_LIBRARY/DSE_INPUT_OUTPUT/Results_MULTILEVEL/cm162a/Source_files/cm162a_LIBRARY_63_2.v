...
module FAU ( 
  ...
  nor2   g17(.a(new_n23_), .b(new_n36_), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n21_), .c(new_n35_), .O(new_n38_));
  aoi22  g19(.a(new_n38_), .b(x10), .c(new_n34_), .d(x02), .O(new_n39_));
  ...
  nand3  g29(.a(new_n21_), .b(new_n43_), .c(new_n35_), .O(new_n49_));
  inv1   g30(.a(new_n49_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n37_), .c(new_n44_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n48_), .c(x03), .O(new_n52_));
  aoi21  g33(.a(x13), .b(x06), .c(x03), .O(new_n53_));
  nor2   g34(.a(new_n53_), .b(new_n29_), .O(new_n54_));
