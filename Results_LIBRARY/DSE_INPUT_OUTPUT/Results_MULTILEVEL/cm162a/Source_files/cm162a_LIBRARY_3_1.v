...
module FAU ( 
  ...
  nand3  g13(.a(new_n32_), .b(new_n21_), .c(new_n31_), .O(new_n33_));
  ...
  oai21  g43(.a(new_n47_), .b(new_n37_), .c(x12), .O(new_n63_));
  ...
  oai21  g48(.a(new_n65_), .b(new_n21_), .c(new_n67_), .O(z3));
  nand4  g49(.a(new_n22_), .b(x13), .c(x09), .d(x04), .O(new_n69_));
