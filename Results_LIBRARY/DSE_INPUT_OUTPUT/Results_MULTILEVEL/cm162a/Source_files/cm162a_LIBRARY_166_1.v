...
module FAU ( 
  ...
  nor3   g22(.a(new_n41_), .b(new_n21_), .c(new_n30_), .O(new_n42_));
  ...
  nand3  g36(.a(new_n55_), .b(new_n52_), .c(x05), .O(z2));
  nand4  g37(.a(new_n47_), .b(new_n20_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n22_), .b(new_n45_), .c(new_n44_), .O(new_n58_));
  ...
  nand2  g44(.a(new_n63_), .b(new_n53_), .O(new_n64_));
