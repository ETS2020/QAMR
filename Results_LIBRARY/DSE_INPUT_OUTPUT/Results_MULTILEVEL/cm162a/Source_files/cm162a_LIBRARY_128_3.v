...
module FAU ( 
  ...
  nand2  g08(.a(x07), .b(x06), .O(new_n28_));
  ...
  aoi21  g23(.a(new_n42_), .b(new_n39_), .c(new_n32_), .O(z1));
  ...
  nand2  g34(.a(new_n53_), .b(x06), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n20_), .c(new_n29_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n52_), .O(z2));
  oai21  g37(.a(x06), .b(new_n20_), .c(x07), .O(new_n57_));
  inv1   g38(.a(x12), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n45_), .c(new_n44_), .d(new_n23_), .O(new_n59_));
  ...
  nand2  g45(.a(new_n64_), .b(new_n57_), .O(new_n65_));
  aoi22  g46(.a(new_n28_), .b(new_n41_), .c(new_n53_), .d(new_n20_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n65_), .O(z3));
  inv1   g48(.a(x04), .O(new_n68_));
  oai21  g49(.a(new_n21_), .b(new_n68_), .c(new_n28_), .O(z4));
endmodule
