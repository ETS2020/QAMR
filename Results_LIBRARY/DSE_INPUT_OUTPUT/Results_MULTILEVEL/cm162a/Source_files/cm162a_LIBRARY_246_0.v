...
module FAU ( 
  ...
  nand3  g13(.a(new_n32_), .b(new_n23_), .c(x05), .O(new_n33_));
  aoi21  g14(.a(new_n33_), .b(new_n21_), .c(new_n31_), .O(new_n34_));
  nand2  g15(.a(new_n24_), .b(x05), .O(new_n35_));
  ...
  aoi22  g20(.a(new_n39_), .b(new_n38_), .c(x09), .d(new_n28_), .O(new_n40_));
  ...
  nand3  g27(.a(new_n21_), .b(new_n32_), .c(new_n23_), .O(new_n47_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n42_), .c(new_n32_), .d(new_n23_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nand3  g38(.a(new_n21_), .b(new_n42_), .c(new_n32_), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n28_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  oai22  g45(.a(new_n21_), .b(new_n31_), .c(x09), .d(x05), .O(z4));
endmodule
