...
module FAU ( 
  ...
  nand2  g07(.a(x12), .b(x11), .O(new_n27_));
  ...
  nand4  g27(.a(new_n46_), .b(new_n33_), .c(x04), .d(x02), .O(new_n47_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n27_), .c(x05), .O(new_n53_));
  inv1   g34(.a(new_n53_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n50_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n44_), .b(new_n56_), .c(x04), .d(x02), .O(new_n57_));
  nand3  g38(.a(new_n47_), .b(x12), .c(new_n42_), .O(new_n58_));
  ...
  oai21  g44(.a(new_n21_), .b(new_n23_), .c(new_n27_), .O(z4));
endmodule
