...
module FAU ( 
  ...
  nor2   g36(.a(new_n39_), .b(new_n31_), .O(new_n56_));
  ...
  aoi21  g41(.a(new_n60_), .b(new_n20_), .c(new_n59_), .O(new_n61_));
  oai21  g42(.a(new_n58_), .b(new_n20_), .c(new_n61_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n21_), .b(new_n63_), .c(x05), .d(x03), .O(z4));
endmodule
