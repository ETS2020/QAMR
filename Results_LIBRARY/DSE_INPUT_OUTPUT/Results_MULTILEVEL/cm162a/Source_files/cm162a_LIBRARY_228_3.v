...
module FAU ( 
  ...
  nand4  g40(.a(new_n50_), .b(new_n29_), .c(x04), .d(x02), .O(new_n60_));
  nand3  g41(.a(new_n21_), .b(new_n48_), .c(new_n36_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n52_), .c(x12), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x03), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n20_), .c(new_n30_), .O(new_n66_));
  nand3  g47(.a(new_n66_), .b(new_n64_), .c(x05), .O(z3));
  inv1   g48(.a(new_n30_), .O(new_n68_));
