...
module FAU ( 
  ...
  nand3  g16(.a(new_n35_), .b(new_n34_), .c(new_n25_), .O(new_n36_));
  ...
  aoi21  g21(.a(new_n23_), .b(new_n34_), .c(new_n40_), .O(new_n41_));
  nand4  g22(.a(new_n41_), .b(x12), .c(x09), .d(x03), .O(new_n42_));
  ...
  nand3  g29(.a(new_n46_), .b(new_n34_), .c(new_n25_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n23_), .c(x11), .O(new_n50_));
  ...
  nand4  g40(.a(new_n59_), .b(new_n34_), .c(new_n25_), .d(x02), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n31_), .c(new_n58_), .O(new_n61_));
  ...
  aoi21  g47(.a(new_n66_), .b(new_n22_), .c(new_n65_), .O(new_n67_));
  nand3  g48(.a(new_n67_), .b(new_n64_), .c(new_n21_), .O(z3));
