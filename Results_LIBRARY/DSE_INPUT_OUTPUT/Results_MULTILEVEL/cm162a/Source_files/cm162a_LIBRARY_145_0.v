...
module FAU ( 
  ...
  oai21  g08(.a(x12), .b(x07), .c(x05), .O(new_n28_));
  ...
  nor2   g21(.a(x12), .b(x07), .O(new_n41_));
  ...
  aoi21  g34(.a(new_n53_), .b(new_n50_), .c(new_n41_), .O(z2));
  nand3  g35(.a(x13), .b(x09), .c(x07), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n44_), .c(x12), .O(new_n56_));
