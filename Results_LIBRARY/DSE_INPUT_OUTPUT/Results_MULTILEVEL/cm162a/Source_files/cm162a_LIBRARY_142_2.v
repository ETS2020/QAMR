...
module FAU ( 
  ...
  nand3  g29(.a(new_n21_), .b(new_n44_), .c(new_n36_), .O(new_n49_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n52_), .c(new_n29_), .d(x05), .O(z2));
  nand2  g36(.a(new_n44_), .b(new_n36_), .O(new_n56_));
  nand3  g37(.a(x13), .b(new_n45_), .c(x09), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n28_), .c(x04), .d(x02), .O(new_n59_));
  oai21  g40(.a(new_n49_), .b(new_n35_), .c(x12), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n59_), .c(new_n45_), .O(new_n61_));
  ...
  nand4  g48(.a(new_n29_), .b(x13), .c(x09), .d(x04), .O(new_n68_));
