...
module FAU ( 
  ...
  nand4  g13(.a(new_n32_), .b(x08), .c(x06), .d(x03), .O(new_n33_));
  ...
  aoi21  g19(.a(new_n38_), .b(new_n35_), .c(new_n23_), .O(new_n39_));
  oai21  g20(.a(x03), .b(x01), .c(x05), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(new_n22_), .O(new_n41_));
  inv1   g22(.a(x10), .O(new_n42_));
  aoi21  g23(.a(new_n24_), .b(new_n42_), .c(new_n31_), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(x09), .c(x06), .d(x03), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n41_), .O(z1));
  nand2  g26(.a(new_n38_), .b(x11), .O(new_n46_));
  nor3   g27(.a(x11), .b(x10), .c(x08), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n36_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n46_), .c(new_n21_), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand2  g31(.a(new_n24_), .b(new_n50_), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(x13), .c(x09), .d(x06), .O(new_n52_));
  oai21  g33(.a(x09), .b(x05), .c(new_n52_), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n49_), .c(x03), .O(new_n54_));
  inv1   g35(.a(x05), .O(new_n55_));
  nor2   g36(.a(x09), .b(x06), .O(new_n56_));
  aoi22  g37(.a(new_n56_), .b(new_n23_), .c(x06), .d(new_n55_), .O(new_n57_));
  ...
  aoi21  g45(.a(new_n47_), .b(new_n36_), .c(new_n64_), .O(new_n65_));
  aoi21  g46(.a(new_n63_), .b(x04), .c(new_n65_), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n23_), .O(new_n68_));
  nand3  g49(.a(new_n68_), .b(new_n22_), .c(x05), .O(new_n69_));
  inv1   g50(.a(new_n69_), .O(new_n70_));
  oai21  g51(.a(new_n66_), .b(new_n23_), .c(new_n70_), .O(z3));
  nand2  g52(.a(x13), .b(x04), .O(new_n72_));
  aoi21  g53(.a(new_n72_), .b(x06), .c(new_n20_), .O(z4));
endmodule
