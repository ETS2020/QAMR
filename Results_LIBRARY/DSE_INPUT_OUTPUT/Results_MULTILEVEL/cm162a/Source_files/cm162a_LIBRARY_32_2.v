...
module FAU ( 
  ...
  nand3  g16(.a(new_n35_), .b(new_n21_), .c(new_n34_), .O(new_n36_));
  ...
  nor2   g21(.a(new_n40_), .b(new_n29_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n39_), .O(z1));
  inv1   g23(.a(x05), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n35_), .b(x13), .c(x09), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n44_), .c(new_n20_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n43_), .c(x10), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  nand3  g29(.a(new_n44_), .b(new_n27_), .c(new_n34_), .O(new_n49_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n51_), .c(x05), .d(x03), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n48_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n47_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n20_), .c(x10), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x06), .O(new_n58_));
  nand2  g39(.a(x12), .b(x06), .O(new_n59_));
  ...
  nand4  g45(.a(new_n64_), .b(new_n27_), .c(new_n34_), .d(x02), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n63_), .c(new_n23_), .O(new_n66_));
  inv1   g47(.a(new_n49_), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n35_), .c(new_n56_), .O(new_n68_));
  oai21  g49(.a(new_n68_), .b(new_n66_), .c(x03), .O(new_n69_));
  inv1   g50(.a(x07), .O(new_n70_));
  aoi21  g51(.a(new_n70_), .b(new_n20_), .c(new_n43_), .O(new_n71_));
  nand3  g52(.a(new_n71_), .b(new_n69_), .c(new_n58_), .O(z3));
  nand4  g53(.a(new_n28_), .b(x13), .c(x09), .d(x04), .O(new_n73_));
