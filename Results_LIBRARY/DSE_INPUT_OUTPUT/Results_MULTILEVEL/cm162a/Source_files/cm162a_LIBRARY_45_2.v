...
module FAU ( 
  ...
  nand2  g21(.a(new_n40_), .b(x02), .O(new_n41_));
  ...
  nand3  g29(.a(new_n24_), .b(x12), .c(new_n43_), .O(new_n49_));
  ...
  nand2  g39(.a(new_n58_), .b(new_n41_), .O(new_n59_));
  nand3  g40(.a(new_n24_), .b(new_n44_), .c(new_n43_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n48_), .c(x12), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n28_), .c(new_n59_), .O(z3));
  nand4  g43(.a(new_n41_), .b(x13), .c(x09), .d(x04), .O(new_n63_));
