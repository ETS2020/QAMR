...
module FAU ( 
  ...
  oai21  g15(.a(x12), .b(new_n31_), .c(x01), .O(new_n35_));
  ...
  nand2  g26(.a(x05), .b(x03), .O(new_n46_));
  aoi22  g27(.a(new_n46_), .b(new_n44_), .c(new_n45_), .d(new_n32_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n43_), .O(z1));
  inv1   g29(.a(x10), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n49_), .c(new_n39_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand3  g34(.a(new_n22_), .b(new_n49_), .c(new_n39_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n38_), .c(x11), .O(new_n55_));
  ...
  aoi21  g40(.a(new_n59_), .b(new_n57_), .c(new_n21_), .O(z2));
  nand4  g41(.a(new_n52_), .b(new_n45_), .c(x04), .d(x02), .O(new_n61_));
  aoi21  g42(.a(x13), .b(x09), .c(x11), .O(new_n62_));
  nand4  g43(.a(new_n62_), .b(new_n26_), .c(new_n49_), .d(x02), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(x12), .c(new_n44_), .O(new_n64_));
