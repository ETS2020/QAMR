...
module FAU ( 
  ...
  nand3  g17(.a(new_n23_), .b(new_n25_), .c(x04), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x10), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(new_n36_), .c(new_n30_), .O(new_n39_));
  oai21  g20(.a(new_n39_), .b(new_n33_), .c(x02), .O(new_n40_));
  ...
  aoi22  g25(.a(new_n44_), .b(new_n25_), .c(x13), .d(x09), .O(new_n45_));
  inv1   g26(.a(x10), .O(new_n46_));
  nand4  g27(.a(new_n23_), .b(new_n46_), .c(new_n25_), .d(x04), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x11), .O(new_n48_));
  oai21  g29(.a(new_n45_), .b(new_n22_), .c(new_n48_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x03), .c(new_n33_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n21_), .c(new_n43_), .O(z2));
  nor2   g32(.a(x12), .b(x11), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n35_), .O(new_n53_));
  nand2  g34(.a(new_n34_), .b(x02), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n22_), .O(new_n55_));
  nand3  g36(.a(new_n44_), .b(new_n25_), .c(x04), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x02), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n55_), .c(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n30_), .c(new_n33_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  nand2  g43(.a(x03), .b(new_n21_), .O(new_n63_));
