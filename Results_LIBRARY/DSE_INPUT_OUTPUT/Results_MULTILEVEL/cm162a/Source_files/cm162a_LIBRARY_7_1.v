...
module FAU ( 
  ...
  nand4  g39(.a(new_n58_), .b(new_n24_), .c(new_n44_), .d(x02), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x12), .c(x07), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  nor2   g43(.a(x12), .b(x07), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(new_n20_), .c(new_n29_), .d(new_n26_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  oai21  g46(.a(new_n21_), .b(new_n23_), .c(new_n29_), .O(z4));
endmodule
