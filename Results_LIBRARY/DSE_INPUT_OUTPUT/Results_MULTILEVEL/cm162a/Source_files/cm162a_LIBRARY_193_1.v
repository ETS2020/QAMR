...
module FAU ( 
  ...
  and2   g06(.a(x05), .b(x00), .O(new_n26_));
  oai21  g07(.a(new_n25_), .b(new_n20_), .c(new_n26_), .O(z0));
  ...
  oai21  g13(.a(new_n32_), .b(new_n30_), .c(x10), .O(new_n33_));
  aoi21  g14(.a(new_n33_), .b(new_n29_), .c(new_n20_), .O(new_n34_));
  ...
  nand3  g20(.a(new_n39_), .b(new_n38_), .c(new_n31_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n21_), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(x04), .c(x02), .O(new_n42_));
  nand3  g23(.a(new_n21_), .b(new_n38_), .c(new_n31_), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n30_), .c(x11), .O(new_n44_));
  ...
  nand4  g31(.a(new_n50_), .b(new_n39_), .c(new_n38_), .d(new_n31_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n21_), .c(new_n49_), .O(new_n52_));
  nand3  g33(.a(x13), .b(x12), .c(x09), .O(new_n53_));
  inv1   g34(.a(new_n53_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n52_), .c(x04), .O(new_n55_));
  oai21  g36(.a(new_n40_), .b(new_n30_), .c(x12), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n55_), .c(new_n20_), .O(new_n57_));
  nor2   g38(.a(x07), .b(x03), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x05), .O(z3));
  inv1   g41(.a(x00), .O(new_n61_));
  nand2  g42(.a(x05), .b(new_n61_), .O(new_n62_));
