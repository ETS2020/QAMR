...
module FAU ( 
  ...
  oai21  g30(.a(x06), .b(x03), .c(x12), .O(new_n50_));
  ...
  oai21  g34(.a(new_n53_), .b(new_n25_), .c(x03), .O(new_n54_));
  oai21  g35(.a(x07), .b(x03), .c(new_n54_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x12), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x05), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  oai22  g39(.a(new_n21_), .b(new_n58_), .c(x12), .d(new_n49_), .O(z4));
endmodule
