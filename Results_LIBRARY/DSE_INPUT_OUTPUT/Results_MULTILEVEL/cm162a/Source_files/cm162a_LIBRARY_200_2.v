...
module FAU ( 
  ...
  nand3  g14(.a(new_n33_), .b(new_n23_), .c(new_n26_), .O(new_n34_));
  ...
  aoi21  g29(.a(new_n48_), .b(new_n33_), .c(new_n42_), .O(new_n49_));
  ...
  inv1   g44(.a(new_n43_), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n33_), .c(new_n63_), .O(new_n65_));
  aoi21  g46(.a(new_n62_), .b(x04), .c(new_n65_), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n20_), .c(new_n51_), .O(new_n68_));
  oai21  g49(.a(new_n66_), .b(new_n20_), .c(new_n68_), .O(z3));
  nand2  g50(.a(new_n51_), .b(x03), .O(new_n70_));
