...
module FAU ( 
  ...
  oai22  g35(.a(new_n24_), .b(x08), .c(x11), .d(x10), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n20_), .c(x04), .d(x02), .O(new_n56_));
  nand3  g37(.a(new_n24_), .b(new_n43_), .c(new_n34_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n47_), .c(x12), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n56_), .c(new_n27_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n32_), .O(new_n62_));
