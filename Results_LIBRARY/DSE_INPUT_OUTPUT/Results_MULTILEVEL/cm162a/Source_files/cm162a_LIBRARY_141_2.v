...
module FAU ( 
  ...
  nand2  g23(.a(new_n31_), .b(new_n42_), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(new_n41_), .c(new_n21_), .d(x05), .O(z1));
  inv1   g25(.a(x10), .O(new_n45_));
  oai21  g26(.a(x11), .b(x08), .c(new_n23_), .O(new_n46_));
  nand4  g27(.a(new_n46_), .b(new_n45_), .c(x04), .d(x02), .O(new_n47_));
  nand3  g28(.a(new_n23_), .b(new_n45_), .c(new_n26_), .O(new_n48_));
  ...
  oai22  g37(.a(new_n56_), .b(new_n55_), .c(x07), .d(x03), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n32_), .c(new_n21_), .O(new_n58_));
  inv1   g39(.a(x04), .O(new_n59_));
  inv1   g40(.a(x12), .O(new_n60_));
  nand4  g41(.a(new_n60_), .b(new_n20_), .c(new_n26_), .d(x02), .O(new_n61_));
  nand3  g42(.a(x13), .b(x12), .c(x09), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n61_), .c(new_n59_), .O(new_n63_));
  and2   g44(.a(new_n27_), .b(x12), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n63_), .c(new_n45_), .O(new_n65_));
  nand2  g46(.a(x12), .b(x11), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(x03), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n58_), .O(z3));
