...
module FAU ( 
  ...
  nor2   g11(.a(new_n30_), .b(new_n26_), .O(new_n31_));
  ...
  aoi21  g16(.a(new_n35_), .b(new_n21_), .c(new_n23_), .O(new_n36_));
  ...
  inv1   g25(.a(x09), .O(new_n45_));
  nand2  g26(.a(new_n35_), .b(new_n45_), .O(new_n46_));
  nand4  g27(.a(new_n46_), .b(new_n27_), .c(x04), .d(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n34_), .c(new_n33_), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n51_), .c(new_n29_), .d(x05), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n27_), .c(new_n34_), .d(new_n33_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n45_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  nand3  g39(.a(new_n34_), .b(new_n45_), .c(new_n33_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n37_), .c(x12), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n58_), .c(new_n20_), .O(new_n61_));
  inv1   g42(.a(x07), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n20_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x05), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n61_), .c(x13), .O(new_n65_));
  nand2  g46(.a(x12), .b(x03), .O(new_n66_));
  nand3  g47(.a(new_n66_), .b(new_n63_), .c(x05), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(x11), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n65_), .O(z3));
  oai21  g50(.a(new_n21_), .b(new_n23_), .c(new_n29_), .O(z4));
endmodule
