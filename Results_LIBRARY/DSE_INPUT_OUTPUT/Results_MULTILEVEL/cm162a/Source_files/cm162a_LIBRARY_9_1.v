...
module FAU ( 
  ...
  oai21  g19(.a(new_n38_), .b(new_n37_), .c(new_n28_), .O(new_n39_));
  ...
  nand4  g26(.a(new_n45_), .b(new_n32_), .c(x04), .d(x02), .O(new_n46_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n50_), .c(new_n35_), .d(new_n32_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nor3   g38(.a(x13), .b(x11), .c(x10), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n24_), .c(x02), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x12), .c(x09), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  oai21  g43(.a(x07), .b(x03), .c(x05), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n28_), .O(new_n64_));
