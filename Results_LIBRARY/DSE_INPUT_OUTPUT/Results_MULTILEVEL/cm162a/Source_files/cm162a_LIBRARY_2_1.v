...
module FAU ( 
  ...
  nand2  g22(.a(new_n41_), .b(new_n31_), .O(z1));
  inv1   g23(.a(x10), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(new_n36_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n43_), .c(new_n36_), .O(new_n48_));
  ...
  nand2  g38(.a(new_n57_), .b(new_n45_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(x04), .d(x02), .O(new_n59_));
  aoi21  g40(.a(x13), .b(x09), .c(x11), .O(new_n60_));
  nand4  g41(.a(new_n60_), .b(new_n25_), .c(new_n43_), .d(x02), .O(new_n61_));
  ...
  nor2   g45(.a(x07), .b(new_n52_), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n20_), .c(new_n30_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  oai22  g48(.a(new_n21_), .b(new_n24_), .c(new_n56_), .d(x05), .O(z4));
endmodule
