...
module FAU ( 
  ...
  nand2  g08(.a(x12), .b(x06), .O(new_n28_));
  ...
  oai21  g22(.a(x12), .b(new_n20_), .c(x06), .O(new_n42_));
  ...
  nand2  g31(.a(new_n50_), .b(new_n42_), .O(new_n51_));
  inv1   g32(.a(x05), .O(new_n52_));
  nor2   g33(.a(x06), .b(x03), .O(new_n53_));
  aoi21  g34(.a(new_n28_), .b(new_n52_), .c(new_n53_), .O(new_n54_));
