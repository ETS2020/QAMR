...
module FAU ( 
  ...
  nand3  g16(.a(new_n25_), .b(new_n20_), .c(new_n21_), .O(new_n36_));
  ...
  nand3  g30(.a(new_n25_), .b(new_n20_), .c(new_n44_), .O(new_n50_));
  ...
  nand4  g39(.a(new_n47_), .b(x04), .c(x03), .d(x02), .O(new_n59_));
  ...
  aoi21  g45(.a(x07), .b(new_n29_), .c(new_n20_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n30_), .c(new_n64_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n63_), .O(z3));
  nand4  g48(.a(x13), .b(new_n20_), .c(x09), .d(x04), .O(new_n68_));
