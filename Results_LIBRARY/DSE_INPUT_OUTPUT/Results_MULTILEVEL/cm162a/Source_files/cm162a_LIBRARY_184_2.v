...
module FAU ( 
  ...
  nand2  g29(.a(new_n27_), .b(x02), .O(new_n49_));
  nand2  g30(.a(new_n24_), .b(new_n40_), .O(new_n50_));
  ...
  oai21  g36(.a(new_n55_), .b(new_n52_), .c(x07), .O(new_n56_));
  ...
  nand4  g43(.a(new_n62_), .b(new_n45_), .c(new_n40_), .d(new_n27_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n24_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(x04), .c(x02), .O(new_n65_));
  nand3  g46(.a(new_n24_), .b(new_n45_), .c(new_n40_), .O(new_n66_));
  oai21  g47(.a(new_n66_), .b(new_n49_), .c(x12), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n65_), .c(new_n20_), .O(new_n68_));
  aoi21  g49(.a(new_n62_), .b(x05), .c(x04), .O(new_n69_));
  oai21  g50(.a(new_n69_), .b(new_n68_), .c(x03), .O(new_n70_));
  inv1   g51(.a(x05), .O(new_n71_));
  nor2   g52(.a(x07), .b(x04), .O(new_n72_));
  aoi22  g53(.a(new_n72_), .b(new_n44_), .c(x07), .d(new_n71_), .O(new_n73_));
  nand2  g54(.a(new_n73_), .b(new_n70_), .O(z3));
  aoi21  g55(.a(new_n24_), .b(x07), .c(new_n57_), .O(z4));
endmodule
