...
module FAU ( 
  ...
  nand4  g16(.a(new_n35_), .b(new_n23_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand2  g20(.a(x04), .b(x02), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n35_), .O(new_n41_));
  ...
  nand3  g26(.a(new_n45_), .b(new_n35_), .c(new_n23_), .O(new_n46_));
  nor2   g27(.a(new_n46_), .b(new_n40_), .O(new_n47_));
  inv1   g28(.a(new_n47_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n44_), .c(new_n20_), .O(new_n49_));
  oai21  g30(.a(x06), .b(x03), .c(x05), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(new_n30_), .O(new_n51_));
  nand2  g32(.a(new_n40_), .b(new_n45_), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(x13), .c(x09), .d(x03), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z2));
  inv1   g35(.a(x09), .O(new_n55_));
  nand2  g36(.a(new_n46_), .b(new_n55_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n28_), .c(x04), .d(x02), .O(new_n57_));
  nand2  g38(.a(x12), .b(x09), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n57_), .c(new_n29_), .O(new_n59_));
  nor2   g40(.a(new_n47_), .b(new_n28_), .O(new_n60_));
