...
module FAU ( 
  ...
  nand4  g15(.a(new_n21_), .b(new_n24_), .c(x04), .d(x02), .O(new_n35_));
  ...
  oai21  g28(.a(new_n47_), .b(new_n25_), .c(x11), .O(new_n48_));
  ...
  nand4  g38(.a(new_n43_), .b(new_n24_), .c(x04), .d(x02), .O(new_n58_));
  ...
  aoi21  g44(.a(new_n63_), .b(new_n29_), .c(new_n20_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n62_), .c(x05), .O(z3));
  inv1   g46(.a(x09), .O(new_n66_));
  inv1   g47(.a(x13), .O(new_n67_));
  nor4   g48(.a(new_n20_), .b(new_n67_), .c(new_n66_), .d(new_n55_), .O(z4));
endmodule
