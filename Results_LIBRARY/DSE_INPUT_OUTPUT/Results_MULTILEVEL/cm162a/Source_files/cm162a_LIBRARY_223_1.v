...
module FAU ( 
  ...
  nand3  g17(.a(new_n36_), .b(x03), .c(x01), .O(new_n37_));
  ...
  nand3  g24(.a(new_n21_), .b(new_n39_), .c(new_n33_), .O(new_n44_));
  ...
  nor2   g37(.a(new_n41_), .b(new_n32_), .O(new_n57_));
  ...
  nor3   g42(.a(new_n61_), .b(new_n60_), .c(new_n26_), .O(new_n62_));
  oai21  g43(.a(new_n59_), .b(new_n20_), .c(new_n62_), .O(z3));
  oai22  g44(.a(new_n21_), .b(new_n23_), .c(new_n60_), .d(x01), .O(z4));
endmodule
