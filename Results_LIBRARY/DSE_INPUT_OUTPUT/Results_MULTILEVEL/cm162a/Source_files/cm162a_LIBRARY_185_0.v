...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n72_, new_n74_;
  nor2   g00(.a(x11), .b(x04), .O(new_n20_));
  ...
  nand3  g11(.a(x11), .b(x08), .c(new_n30_), .O(new_n31_));
  ...
  nand3  g33(.a(new_n37_), .b(new_n46_), .c(new_n27_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n25_), .c(new_n24_), .O(new_n54_));
  nand4  g35(.a(new_n25_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x11), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x04), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n54_), .c(x03), .O(new_n58_));
  inv1   g39(.a(x06), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n35_), .c(new_n49_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n58_), .c(new_n21_), .O(z2));
  nor2   g42(.a(x12), .b(x11), .O(new_n62_));
  aoi22  g43(.a(new_n62_), .b(new_n41_), .c(x13), .d(x09), .O(new_n63_));
  nand2  g44(.a(new_n55_), .b(x12), .O(new_n64_));
  oai21  g45(.a(new_n63_), .b(new_n24_), .c(new_n64_), .O(new_n65_));
  inv1   g46(.a(x07), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n35_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(x05), .O(new_n68_));
  aoi21  g49(.a(new_n65_), .b(x03), .c(new_n68_), .O(new_n69_));
  nand2  g50(.a(x12), .b(x03), .O(new_n70_));
  nand3  g51(.a(new_n70_), .b(new_n67_), .c(x05), .O(new_n71_));
  nand2  g52(.a(new_n71_), .b(x11), .O(new_n72_));
  oai21  g53(.a(new_n69_), .b(new_n30_), .c(new_n72_), .O(z3));
