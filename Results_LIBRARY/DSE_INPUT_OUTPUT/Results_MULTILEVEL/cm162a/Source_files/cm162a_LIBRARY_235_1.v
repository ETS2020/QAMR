...
module FAU ( 
  ...
  aoi21  g15(.a(new_n34_), .b(new_n21_), .c(new_n32_), .O(new_n35_));
  nand4  g16(.a(new_n21_), .b(new_n24_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand2  g33(.a(new_n52_), .b(new_n30_), .O(z2));
