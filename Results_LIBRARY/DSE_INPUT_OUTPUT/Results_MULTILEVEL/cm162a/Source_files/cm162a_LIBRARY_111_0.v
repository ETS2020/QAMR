...
module FAU ( 
  ...
  nand2  g10(.a(new_n29_), .b(x01), .O(new_n30_));
  ...
  oai21  g38(.a(new_n43_), .b(new_n34_), .c(x12), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n57_), .c(new_n20_), .O(new_n59_));
  nor2   g40(.a(x07), .b(x03), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(x05), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n30_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  inv1   g44(.a(x09), .O(new_n64_));
  oai21  g45(.a(x05), .b(x01), .c(x13), .O(new_n65_));
