...
module FAU ( 
  ...
  nand3  g27(.a(new_n20_), .b(new_n46_), .c(new_n26_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n23_), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n45_), .c(x04), .d(x02), .O(new_n49_));
  nand3  g30(.a(new_n23_), .b(new_n46_), .c(new_n26_), .O(new_n50_));
  ...
  nand4  g37(.a(new_n48_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n31_), .c(new_n32_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n45_), .O(new_n61_));
  aoi21  g42(.a(x07), .b(new_n31_), .c(new_n45_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n32_), .c(x11), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai21  g46(.a(new_n23_), .b(new_n65_), .c(new_n21_), .O(z4));
endmodule
