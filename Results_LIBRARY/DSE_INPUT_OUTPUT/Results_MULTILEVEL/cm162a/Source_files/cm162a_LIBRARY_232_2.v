...
module FAU ( 
  ...
  nand4  g40(.a(new_n59_), .b(new_n57_), .c(new_n21_), .d(x05), .O(z2));
  oai22  g41(.a(new_n24_), .b(x08), .c(x11), .d(x10), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n20_), .c(x04), .d(x02), .O(new_n62_));
  nand3  g43(.a(new_n24_), .b(new_n49_), .c(new_n36_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n53_), .c(x12), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n62_), .c(new_n27_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x03), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n32_), .O(new_n68_));
