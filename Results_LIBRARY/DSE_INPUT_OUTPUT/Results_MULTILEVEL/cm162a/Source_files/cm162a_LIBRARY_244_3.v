...
module FAU ( 
  ...
  nand2  g00(.a(x06), .b(x02), .O(new_n20_));
  ...
  aoi21  g08(.a(new_n27_), .b(new_n25_), .c(x06), .O(new_n28_));
  nor2   g09(.a(new_n26_), .b(x02), .O(new_n29_));
  ...
  nand3  g16(.a(new_n23_), .b(new_n26_), .c(x04), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(x10), .O(new_n37_));
  aoi21  g18(.a(new_n37_), .b(new_n35_), .c(x06), .O(new_n38_));
  inv1   g19(.a(x10), .O(new_n39_));
  nor2   g20(.a(new_n39_), .b(x02), .O(new_n40_));
  ...
  oai21  g25(.a(new_n44_), .b(x02), .c(new_n43_), .O(new_n45_));
  inv1   g26(.a(x04), .O(new_n46_));
  nor3   g27(.a(x11), .b(x10), .c(x08), .O(new_n47_));
  inv1   g28(.a(new_n47_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n23_), .c(new_n46_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(x06), .c(x02), .O(new_n50_));
  nand3  g31(.a(new_n44_), .b(x04), .c(x02), .O(new_n51_));
  inv1   g32(.a(new_n51_), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n23_), .c(new_n39_), .d(new_n26_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x11), .c(x03), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n50_), .c(new_n45_), .d(x05), .O(z2));
  ...
  nor2   g43(.a(new_n46_), .b(new_n56_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n47_), .c(new_n62_), .O(new_n64_));
  aoi21  g45(.a(new_n61_), .b(x04), .c(new_n64_), .O(new_n65_));
  inv1   g46(.a(x07), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n43_), .O(new_n67_));
  nand3  g48(.a(new_n67_), .b(new_n20_), .c(x05), .O(new_n68_));
  inv1   g49(.a(new_n68_), .O(new_n69_));
  oai21  g50(.a(new_n65_), .b(new_n43_), .c(new_n69_), .O(z3));
  oai21  g51(.a(new_n23_), .b(new_n46_), .c(new_n20_), .O(z4));
endmodule
