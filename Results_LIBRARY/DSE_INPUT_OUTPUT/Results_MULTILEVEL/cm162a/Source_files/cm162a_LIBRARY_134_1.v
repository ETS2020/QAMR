...
module FAU ( 
  ...
  aoi21  g15(.a(new_n34_), .b(new_n32_), .c(new_n29_), .O(new_n35_));
  ...
  nand2  g23(.a(new_n23_), .b(x02), .O(new_n43_));
  inv1   g24(.a(new_n43_), .O(new_n44_));
  nor2   g25(.a(new_n30_), .b(x10), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n44_), .c(new_n40_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n42_), .c(x03), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n29_), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(new_n47_), .c(x05), .d(x04), .O(z2));
  inv1   g31(.a(x04), .O(new_n51_));
  nor2   g32(.a(x12), .b(x11), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n31_), .c(new_n30_), .O(new_n53_));
  nand3  g34(.a(new_n21_), .b(new_n40_), .c(new_n39_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n43_), .c(x12), .O(new_n55_));
  oai21  g36(.a(new_n53_), .b(new_n20_), .c(new_n55_), .O(new_n56_));
  nor2   g37(.a(x07), .b(x03), .O(new_n57_));
  aoi21  g38(.a(new_n56_), .b(x03), .c(new_n57_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n51_), .c(x05), .O(z3));
  nand2  g40(.a(new_n30_), .b(x04), .O(new_n60_));
