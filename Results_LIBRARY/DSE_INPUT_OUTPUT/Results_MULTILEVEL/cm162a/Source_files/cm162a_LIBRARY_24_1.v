...
module FAU ( 
  ...
  nor3   g12(.a(x12), .b(x03), .c(x00), .O(new_n32_));
  aoi21  g13(.a(new_n31_), .b(x00), .c(new_n32_), .O(new_n33_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n43_), .c(new_n31_), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n42_), .c(new_n21_), .O(z1));
  ...
  aoi21  g37(.a(new_n56_), .b(new_n44_), .c(new_n21_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(x05), .O(z2));
  ...
  nand3  g42(.a(new_n61_), .b(x12), .c(x00), .O(new_n62_));
