...
module FAU ( 
  ...
  nand4  g36(.a(new_n45_), .b(new_n29_), .c(x05), .d(x04), .O(new_n56_));
  nand3  g37(.a(new_n21_), .b(new_n43_), .c(new_n42_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n25_), .c(x12), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n55_), .c(new_n58_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  nor2   g41(.a(x07), .b(new_n51_), .O(new_n61_));
