...
module FAU ( 
  ...
  nand3  g30(.a(new_n47_), .b(new_n36_), .c(new_n26_), .O(new_n50_));
  ...
  nand3  g36(.a(new_n55_), .b(new_n34_), .c(x05), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n53_), .O(z2));
  nand4  g39(.a(new_n48_), .b(new_n20_), .c(x04), .d(x02), .O(new_n59_));
  oai21  g40(.a(new_n46_), .b(new_n24_), .c(x12), .O(new_n60_));
  ...
  nand3  g45(.a(new_n64_), .b(new_n34_), .c(x05), .O(new_n65_));
