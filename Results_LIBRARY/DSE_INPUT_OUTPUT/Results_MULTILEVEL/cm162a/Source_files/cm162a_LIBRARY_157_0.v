...
module FAU ( 
  ...
  nor2   g00(.a(x03), .b(x02), .O(new_n20_));
  ...
  aoi21  g42(.a(new_n42_), .b(new_n23_), .c(new_n61_), .O(new_n62_));
  aoi21  g43(.a(new_n60_), .b(x04), .c(new_n62_), .O(new_n63_));
  nand2  g44(.a(new_n61_), .b(x03), .O(new_n64_));
  oai21  g45(.a(x07), .b(x03), .c(x05), .O(new_n65_));
  aoi21  g46(.a(new_n64_), .b(new_n55_), .c(new_n65_), .O(new_n66_));
  oai21  g47(.a(new_n63_), .b(new_n54_), .c(new_n66_), .O(z3));
  inv1   g48(.a(x09), .O(new_n68_));
  inv1   g49(.a(x13), .O(new_n69_));
  nor4   g50(.a(new_n20_), .b(new_n69_), .c(new_n68_), .d(new_n22_), .O(z4));
endmodule
