...
module FAU ( 
  ...
  aoi21  g34(.a(new_n53_), .b(new_n51_), .c(new_n30_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand3  g36(.a(new_n47_), .b(new_n29_), .c(x03), .O(new_n56_));
  ...
  aoi21  g40(.a(new_n59_), .b(new_n25_), .c(new_n55_), .O(new_n60_));
  ...
  oai22  g45(.a(new_n21_), .b(new_n64_), .c(x12), .d(new_n29_), .O(z4));
endmodule
