...
module FAU ( 
  ...
  nand3  g31(.a(new_n24_), .b(new_n46_), .c(new_n27_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n38_), .c(x11), .O(new_n52_));
  ...
  nand4  g37(.a(new_n56_), .b(new_n54_), .c(new_n22_), .d(x05), .O(z2));
  nand4  g38(.a(new_n21_), .b(new_n47_), .c(new_n46_), .d(new_n27_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n24_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(x07), .c(x04), .d(x02), .O(new_n60_));
  nand3  g41(.a(new_n24_), .b(new_n47_), .c(new_n46_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n28_), .c(x12), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x03), .O(new_n64_));
  nor2   g45(.a(new_n21_), .b(x07), .O(new_n65_));
  aoi22  g46(.a(new_n65_), .b(new_n32_), .c(new_n22_), .d(new_n33_), .O(new_n66_));
