...
module FAU ( 
  ...
  nor3   g20(.a(new_n39_), .b(new_n20_), .c(new_n30_), .O(new_n40_));
  oai21  g21(.a(new_n38_), .b(new_n29_), .c(new_n40_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n34_), .c(new_n24_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n21_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  nand2  g26(.a(x04), .b(x02), .O(new_n46_));
  nand3  g27(.a(new_n21_), .b(new_n34_), .c(new_n24_), .O(new_n47_));
  ...
  nor3   g32(.a(new_n51_), .b(new_n20_), .c(new_n30_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  inv1   g34(.a(x02), .O(new_n54_));
  oai21  g35(.a(new_n33_), .b(new_n54_), .c(x11), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x13), .c(x09), .O(new_n56_));
  oai21  g37(.a(new_n46_), .b(new_n35_), .c(new_n42_), .O(new_n57_));
  nand2  g38(.a(x12), .b(x11), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n29_), .c(new_n20_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n60_), .c(x05), .O(z3));
  inv1   g44(.a(x09), .O(new_n64_));
  inv1   g45(.a(x13), .O(new_n65_));
  nor4   g46(.a(new_n20_), .b(new_n65_), .c(new_n64_), .d(new_n33_), .O(z4));
endmodule
