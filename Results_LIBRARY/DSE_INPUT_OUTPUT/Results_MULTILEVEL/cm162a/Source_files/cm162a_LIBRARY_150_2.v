...
module FAU ( 
  ...
  aoi21  g09(.a(new_n28_), .b(new_n26_), .c(new_n20_), .O(new_n29_));
  ...
  oai21  g18(.a(new_n37_), .b(new_n23_), .c(x12), .O(new_n38_));
  ...
  oai21  g30(.a(new_n49_), .b(new_n23_), .c(x12), .O(new_n50_));
  nand2  g31(.a(x06), .b(x05), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  nand4  g34(.a(new_n24_), .b(x12), .c(new_n43_), .d(new_n42_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n28_), .c(x03), .O(new_n55_));
