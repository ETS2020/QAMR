...
module FAU ( 
  ...
  nand3  g16(.a(x13), .b(new_n35_), .c(new_n20_), .O(new_n36_));
  ...
  oai21  g21(.a(x13), .b(x08), .c(x05), .O(new_n41_));
  ...
  oai21  g27(.a(new_n46_), .b(x08), .c(new_n24_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand3  g29(.a(new_n20_), .b(x04), .c(x02), .O(new_n49_));
  nand3  g30(.a(x13), .b(new_n44_), .c(new_n35_), .O(new_n50_));
  ...
  oai22  g34(.a(x13), .b(x08), .c(x06), .d(x03), .O(new_n54_));
  ...
  nand4  g39(.a(new_n58_), .b(new_n45_), .c(new_n44_), .d(new_n20_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n35_), .c(new_n57_), .O(new_n60_));
  nor2   g41(.a(new_n58_), .b(new_n35_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n60_), .c(x04), .O(new_n62_));
  oai21  g43(.a(new_n46_), .b(new_n34_), .c(x12), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n62_), .c(new_n28_), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n28_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(x05), .O(new_n67_));
  oai21  g48(.a(new_n67_), .b(new_n64_), .c(x13), .O(new_n68_));
  nand2  g49(.a(x12), .b(x03), .O(new_n69_));
  nand3  g50(.a(new_n69_), .b(new_n66_), .c(x05), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(x08), .O(new_n71_));
  nand2  g52(.a(new_n71_), .b(new_n68_), .O(z3));
  nand3  g53(.a(x13), .b(x09), .c(x04), .O(new_n73_));
