...
module FAU ( 
  ...
  nand3  g27(.a(new_n21_), .b(new_n31_), .c(new_n30_), .O(new_n47_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n42_), .c(new_n31_), .d(new_n30_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n21_), .c(new_n34_), .O(new_n56_));
  nand3  g37(.a(x13), .b(x12), .c(x09), .O(new_n57_));
  inv1   g38(.a(new_n57_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n56_), .c(x04), .O(new_n59_));
  oai21  g40(.a(new_n43_), .b(new_n46_), .c(x12), .O(new_n60_));
  ...
  oai22  g46(.a(new_n21_), .b(new_n23_), .c(x05), .d(new_n20_), .O(z4));
endmodule
