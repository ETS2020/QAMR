...
module FAU ( 
  ...
  nand4  g34(.a(new_n28_), .b(new_n50_), .c(new_n35_), .d(new_n23_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n21_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  oai21  g37(.a(new_n29_), .b(x12), .c(new_n46_), .O(new_n57_));
  nand3  g38(.a(x13), .b(x12), .c(x09), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
