...
module FAU ( 
  ...
  aoi21  g16(.a(new_n35_), .b(new_n25_), .c(new_n20_), .O(new_n36_));
  nand4  g17(.a(new_n25_), .b(new_n22_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nor2   g23(.a(new_n42_), .b(new_n39_), .O(new_n43_));
  oai21  g24(.a(new_n38_), .b(new_n21_), .c(new_n43_), .O(z1));
  inv1   g25(.a(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n34_), .c(new_n22_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n25_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand2  g29(.a(x04), .b(x02), .O(new_n49_));
  nand3  g30(.a(new_n25_), .b(new_n34_), .c(new_n22_), .O(new_n50_));
  ...
  oai21  g34(.a(x06), .b(x03), .c(new_n41_), .O(new_n54_));
  nor2   g35(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(z2));
  inv1   g37(.a(x02), .O(new_n57_));
  nand4  g38(.a(new_n40_), .b(new_n45_), .c(new_n34_), .d(new_n22_), .O(new_n58_));
  ...
  nand3  g42(.a(new_n59_), .b(new_n45_), .c(new_n34_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n61_), .c(x12), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x04), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n60_), .c(x03), .O(new_n65_));
  aoi21  g46(.a(x12), .b(x07), .c(x04), .O(new_n66_));
  oai21  g47(.a(x07), .b(x03), .c(x05), .O(new_n67_));
  nor2   g48(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n65_), .O(z3));
  nand2  g50(.a(new_n59_), .b(new_n41_), .O(z4));
endmodule
