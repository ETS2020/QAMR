...
module FAU ( 
  ...
  oai21  g00(.a(x03), .b(x00), .c(x05), .O(new_n20_));
  oai21  g01(.a(x04), .b(x02), .c(new_n20_), .O(new_n21_));
  inv1   g02(.a(x08), .O(new_n22_));
  xnor2a g03(.a(x04), .b(x02), .O(new_n23_));
  nand2  g04(.a(x13), .b(x09), .O(new_n24_));
  nand2  g05(.a(new_n24_), .b(x08), .O(new_n25_));
  nand3  g06(.a(new_n25_), .b(x04), .c(x02), .O(new_n26_));
  oai21  g07(.a(new_n23_), .b(new_n22_), .c(new_n26_), .O(new_n27_));
  nand2  g08(.a(new_n27_), .b(x03), .O(new_n28_));
  nand2  g09(.a(new_n28_), .b(new_n21_), .O(z0));
  ...
  nand3  g17(.a(new_n36_), .b(new_n24_), .c(new_n22_), .O(new_n37_));
  aoi22  g18(.a(new_n37_), .b(x10), .c(new_n34_), .d(x02), .O(new_n38_));
  inv1   g19(.a(x05), .O(new_n39_));
  nor2   g20(.a(x04), .b(x02), .O(new_n40_));
  nor2   g21(.a(x03), .b(x01), .O(new_n41_));
  nor3   g22(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(new_n42_));
  oai21  g23(.a(new_n38_), .b(new_n30_), .c(new_n42_), .O(z1));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n32_), .c(new_n22_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n24_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n24_), .b(new_n32_), .c(new_n22_), .O(new_n48_));
  ...
  nor2   g33(.a(new_n52_), .b(new_n40_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n44_), .c(new_n32_), .d(new_n22_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n24_), .c(new_n31_), .O(new_n57_));
  nor3   g38(.a(x11), .b(x10), .c(x08), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n36_), .c(new_n55_), .O(new_n59_));
  ...
  oai21  g43(.a(new_n60_), .b(new_n30_), .c(new_n62_), .O(z3));
