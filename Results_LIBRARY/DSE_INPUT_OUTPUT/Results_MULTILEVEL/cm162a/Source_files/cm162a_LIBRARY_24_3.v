...
module FAU ( 
  ...
  aoi22  g07(.a(new_n26_), .b(x02), .c(new_n24_), .d(x08), .O(new_n27_));
  inv1   g08(.a(x05), .O(new_n28_));
  nand2  g09(.a(x05), .b(x03), .O(new_n29_));
  aoi22  g10(.a(new_n29_), .b(new_n20_), .c(new_n21_), .d(new_n28_), .O(new_n30_));
  oai21  g11(.a(new_n27_), .b(new_n22_), .c(new_n30_), .O(z0));
  nand2  g12(.a(x12), .b(x00), .O(new_n32_));
  ...
  nand2  g18(.a(new_n23_), .b(new_n37_), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n36_), .c(x10), .O(new_n39_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n41_), .c(new_n33_), .O(z1));
  inv1   g26(.a(x10), .O(new_n46_));
  inv1   g27(.a(x11), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n46_), .c(new_n37_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n23_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x04), .c(x02), .O(new_n50_));
  nand3  g31(.a(new_n23_), .b(new_n46_), .c(new_n37_), .O(new_n51_));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n43_), .c(new_n33_), .O(new_n56_));
  ...
  nand4  g40(.a(new_n59_), .b(new_n26_), .c(new_n46_), .d(x02), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x12), .c(new_n20_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  oai21  g44(.a(x07), .b(x03), .c(x05), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n32_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n63_), .O(z3));
  nand4  g47(.a(new_n32_), .b(x13), .c(x09), .d(x04), .O(new_n67_));
