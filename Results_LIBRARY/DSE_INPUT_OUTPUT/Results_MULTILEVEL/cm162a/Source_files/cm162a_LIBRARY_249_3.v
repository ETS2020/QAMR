...
module FAU ( 
  ...
  nand4  g33(.a(new_n52_), .b(new_n41_), .c(new_n40_), .d(new_n25_), .O(new_n53_));
  ...
  nand4  g41(.a(new_n60_), .b(new_n58_), .c(new_n57_), .d(x03), .O(z3));
  inv1   g42(.a(x04), .O(new_n62_));
  oai22  g43(.a(new_n22_), .b(new_n62_), .c(new_n20_), .d(new_n59_), .O(z4));
endmodule
