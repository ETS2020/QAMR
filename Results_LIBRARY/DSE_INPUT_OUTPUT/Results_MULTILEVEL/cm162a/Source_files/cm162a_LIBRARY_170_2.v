...
module FAU ( 
  ...
  nor2   g38(.a(x07), .b(new_n20_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n48_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n29_), .O(new_n60_));
  nand3  g41(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n61_));
  inv1   g42(.a(new_n61_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n25_), .c(new_n29_), .O(new_n63_));
  ...
  oai21  g48(.a(new_n21_), .b(new_n67_), .c(new_n30_), .O(z4));
endmodule
