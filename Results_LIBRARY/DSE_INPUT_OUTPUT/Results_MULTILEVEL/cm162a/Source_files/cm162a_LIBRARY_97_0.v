// Benchmark "FAU" written by ABC on Thu Aug 13 15:06:21 2020
...
module FAU ( 
  ...
  nand3  g11(.a(x13), .b(x08), .c(new_n20_), .O(new_n31_));
  ...
  nand4  g17(.a(new_n26_), .b(new_n28_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nand4  g24(.a(new_n43_), .b(new_n40_), .c(new_n22_), .d(x05), .O(z1));
  ...
  inv1   g32(.a(x09), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(x04), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x13), .c(x11), .O(new_n54_));
  ...
  oai21  g40(.a(x11), .b(x05), .c(new_n59_), .O(new_n60_));
  aoi22  g41(.a(new_n60_), .b(x13), .c(new_n57_), .d(x04), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n56_), .O(z2));
  inv1   g43(.a(new_n26_), .O(new_n63_));
  nor2   g44(.a(x12), .b(x11), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n49_), .c(new_n63_), .O(new_n65_));
  nand2  g46(.a(new_n28_), .b(x02), .O(new_n66_));
  nand3  g47(.a(new_n26_), .b(new_n46_), .c(new_n45_), .O(new_n67_));
  oai21  g48(.a(new_n67_), .b(new_n66_), .c(x12), .O(new_n68_));
  oai21  g49(.a(new_n65_), .b(new_n25_), .c(new_n68_), .O(new_n69_));
  oai21  g50(.a(x07), .b(x03), .c(x05), .O(new_n70_));
  aoi21  g51(.a(new_n69_), .b(x03), .c(new_n70_), .O(new_n71_));
  aoi21  g52(.a(x07), .b(x05), .c(x03), .O(new_n72_));
  nand3  g53(.a(x12), .b(new_n20_), .c(x03), .O(new_n73_));
  oai21  g54(.a(x12), .b(x05), .c(new_n73_), .O(new_n74_));
  oai21  g55(.a(new_n74_), .b(new_n72_), .c(x13), .O(new_n75_));
  oai21  g56(.a(new_n71_), .b(new_n20_), .c(new_n75_), .O(z3));
  nand2  g57(.a(new_n63_), .b(x04), .O(new_n77_));
