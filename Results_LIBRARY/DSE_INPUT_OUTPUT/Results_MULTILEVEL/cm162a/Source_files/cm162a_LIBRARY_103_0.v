...
module FAU ( 
  ...
  nand3  g28(.a(new_n21_), .b(new_n43_), .c(new_n33_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n32_), .c(x11), .O(new_n49_));
  ...
  nand4  g33(.a(new_n39_), .b(new_n44_), .c(new_n43_), .d(new_n33_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n21_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x05), .c(x02), .O(new_n55_));
  nand3  g36(.a(x13), .b(x12), .c(x09), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n55_), .c(new_n23_), .O(new_n57_));
  nor2   g38(.a(new_n45_), .b(new_n32_), .O(new_n58_));
  nor2   g39(.a(new_n58_), .b(new_n39_), .O(new_n59_));
  ...
  oai21  g44(.a(new_n27_), .b(x03), .c(x12), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n27_), .O(new_n65_));
