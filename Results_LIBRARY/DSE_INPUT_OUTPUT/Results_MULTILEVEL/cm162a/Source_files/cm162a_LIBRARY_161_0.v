...
module FAU ( 
  ...
  nand4  g34(.a(new_n45_), .b(new_n29_), .c(x05), .d(x04), .O(new_n54_));
  nand3  g35(.a(new_n21_), .b(new_n43_), .c(new_n42_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n25_), .c(x12), .O(new_n56_));
  oai21  g37(.a(new_n54_), .b(new_n53_), .c(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x03), .O(new_n58_));
  inv1   g39(.a(x05), .O(new_n59_));
  nor2   g40(.a(x07), .b(new_n59_), .O(new_n60_));
