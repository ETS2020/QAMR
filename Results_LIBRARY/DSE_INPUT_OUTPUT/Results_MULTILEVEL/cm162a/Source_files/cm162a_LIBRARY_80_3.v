...
module FAU ( 
  ...
  nand3  g27(.a(new_n21_), .b(new_n42_), .c(new_n34_), .O(new_n47_));
  ...
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(new_n27_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x05), .O(z2));
  nand4  g33(.a(new_n45_), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  oai21  g34(.a(x07), .b(x03), .c(new_n53_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n27_), .O(new_n55_));
