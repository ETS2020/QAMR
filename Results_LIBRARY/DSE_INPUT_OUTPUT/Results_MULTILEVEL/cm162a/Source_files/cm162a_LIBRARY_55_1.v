...
module FAU ( 
  ...
  nand3  g26(.a(new_n21_), .b(new_n45_), .c(new_n24_), .O(new_n46_));
  ...
  nand4  g42(.a(new_n41_), .b(new_n24_), .c(x04), .d(x02), .O(new_n62_));
