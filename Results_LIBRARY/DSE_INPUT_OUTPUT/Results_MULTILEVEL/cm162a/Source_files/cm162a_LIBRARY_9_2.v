...
module FAU ( 
  ...
  nand4  g41(.a(new_n33_), .b(new_n51_), .c(new_n36_), .d(new_n60_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n26_), .c(new_n59_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n56_), .O(z3));
  nand2  g45(.a(x13), .b(x04), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(x12), .c(new_n60_), .O(z4));
endmodule
