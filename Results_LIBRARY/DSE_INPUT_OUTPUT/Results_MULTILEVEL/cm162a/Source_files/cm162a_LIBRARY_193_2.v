...
module FAU ( 
  ...
  nand2  g19(.a(new_n27_), .b(new_n26_), .O(new_n39_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n21_), .c(new_n52_), .O(new_n55_));
  nand3  g36(.a(x13), .b(x12), .c(x09), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n55_), .c(x04), .O(new_n58_));
  oai21  g39(.a(new_n43_), .b(new_n32_), .c(x12), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n58_), .c(new_n20_), .O(new_n60_));
  nor2   g41(.a(x07), .b(x03), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n60_), .c(x05), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n39_), .O(z3));
  nand2  g44(.a(new_n27_), .b(x00), .O(new_n64_));
