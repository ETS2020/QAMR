...
module FAU ( 
  ...
  nand4  g33(.a(new_n52_), .b(new_n43_), .c(new_n31_), .d(new_n24_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n21_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  nand3  g36(.a(new_n21_), .b(new_n43_), .c(new_n31_), .O(new_n56_));
  ...
  oai21  g40(.a(new_n59_), .b(new_n58_), .c(x06), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x05), .O(z3));
  inv1   g42(.a(x05), .O(new_n62_));
  oai22  g43(.a(new_n21_), .b(new_n30_), .c(x06), .d(new_n62_), .O(z4));
endmodule
