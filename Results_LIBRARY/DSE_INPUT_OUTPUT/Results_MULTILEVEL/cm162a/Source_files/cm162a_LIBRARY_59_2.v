...
module FAU ( 
  ...
  oai21  g17(.a(new_n36_), .b(new_n35_), .c(x09), .O(new_n37_));
  ...
  oai21  g28(.a(new_n47_), .b(new_n46_), .c(x09), .O(new_n48_));
  ...
  nor2   g34(.a(new_n21_), .b(new_n51_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n53_), .c(x04), .O(new_n55_));
  oai21  g36(.a(new_n41_), .b(new_n32_), .c(x12), .O(new_n56_));
