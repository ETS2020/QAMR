...
module FAU ( 
  ...
  nand2  g10(.a(new_n29_), .b(x07), .O(new_n30_));
  inv1   g11(.a(new_n30_), .O(new_n31_));
  nor3   g12(.a(new_n31_), .b(new_n28_), .c(new_n27_), .O(new_n32_));
  ...
  nand2  g17(.a(new_n21_), .b(new_n23_), .O(new_n37_));
  ...
  aoi21  g22(.a(new_n20_), .b(new_n41_), .c(new_n27_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n40_), .c(new_n31_), .O(z1));
  ...
  nand3  g29(.a(new_n21_), .b(new_n44_), .c(new_n23_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n54_), .b(new_n30_), .c(x05), .O(new_n55_));
  inv1   g36(.a(new_n55_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n52_), .O(z2));
  inv1   g38(.a(x07), .O(new_n58_));
  nand4  g39(.a(new_n47_), .b(new_n29_), .c(x04), .d(x02), .O(new_n59_));
  nor2   g40(.a(new_n27_), .b(new_n20_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand3  g43(.a(new_n21_), .b(new_n45_), .c(new_n44_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n24_), .c(x03), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x05), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x12), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n62_), .O(z3));
  inv1   g48(.a(x04), .O(new_n68_));
  oai21  g49(.a(new_n21_), .b(new_n68_), .c(new_n30_), .O(z4));
endmodule
