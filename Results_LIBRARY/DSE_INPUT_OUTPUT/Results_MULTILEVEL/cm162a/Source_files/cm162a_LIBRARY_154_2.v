...
module FAU ( 
  ...
  nor4   g34(.a(new_n24_), .b(new_n53_), .c(new_n34_), .d(new_n52_), .O(new_n54_));
  ...
  nand4  g45(.a(new_n64_), .b(new_n36_), .c(new_n20_), .d(x04), .O(new_n65_));
  nand3  g46(.a(new_n41_), .b(x04), .c(x02), .O(new_n66_));
  nand3  g47(.a(new_n24_), .b(new_n57_), .c(new_n20_), .O(new_n67_));
  oai21  g48(.a(new_n67_), .b(new_n66_), .c(x12), .O(new_n68_));
  oai21  g49(.a(new_n65_), .b(new_n52_), .c(new_n68_), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(x03), .O(new_n70_));
  inv1   g51(.a(new_n31_), .O(new_n71_));
  oai21  g52(.a(x07), .b(x03), .c(x05), .O(new_n72_));
  nand2  g53(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g54(.a(new_n73_), .b(new_n70_), .O(z3));
  nand4  g55(.a(new_n71_), .b(x13), .c(x09), .d(x04), .O(new_n75_));
