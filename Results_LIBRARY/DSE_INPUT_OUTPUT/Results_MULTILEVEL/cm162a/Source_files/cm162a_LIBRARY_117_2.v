// Benchmark "FAU" written by ABC on Thu Aug 13 15:06:27 2020
...
module FAU ( 
  ...
  nand3  g06(.a(new_n25_), .b(x12), .c(x08), .O(new_n26_));
  ...
  aoi21  g13(.a(new_n20_), .b(x08), .c(x01), .O(new_n33_));
  nor2   g14(.a(new_n20_), .b(x05), .O(new_n34_));
  ...
  oai21  g26(.a(new_n20_), .b(x10), .c(x08), .O(new_n46_));
  ...
  nand3  g40(.a(new_n59_), .b(new_n21_), .c(x05), .O(new_n60_));
  inv1   g41(.a(new_n60_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n57_), .O(z2));
  oai21  g43(.a(x11), .b(x10), .c(new_n24_), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n20_), .c(x04), .d(x02), .O(new_n64_));
  nand3  g45(.a(new_n24_), .b(new_n49_), .c(new_n36_), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n53_), .c(x12), .O(new_n66_));
  nand3  g47(.a(new_n66_), .b(new_n64_), .c(new_n27_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(x03), .O(new_n68_));
  inv1   g49(.a(x07), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  ...
  oai21  g55(.a(new_n24_), .b(new_n74_), .c(new_n21_), .O(z4));
endmodule
