...
module FAU ( 
  ...
  nand4  g39(.a(new_n47_), .b(new_n58_), .c(x04), .d(x02), .O(new_n59_));
  ...
  nand2  g44(.a(new_n58_), .b(x03), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n29_), .c(new_n27_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n63_), .O(z3));
  nand4  g47(.a(new_n30_), .b(x13), .c(x09), .d(x04), .O(new_n67_));
