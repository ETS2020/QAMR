...
module FAU ( 
  ...
  nand4  g37(.a(new_n47_), .b(new_n56_), .c(x03), .d(x02), .O(new_n57_));
  ...
  oai21  g42(.a(x12), .b(new_n58_), .c(new_n30_), .O(new_n62_));
  nand3  g43(.a(new_n58_), .b(x04), .c(x02), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n46_), .c(x12), .O(new_n64_));
