...
module FAU ( 
  ...
  nand2  g20(.a(new_n26_), .b(new_n29_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(x11), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n38_), .c(new_n25_), .O(new_n42_));
  ...
  nand3  g28(.a(new_n47_), .b(new_n35_), .c(new_n29_), .O(new_n48_));
  ...
  oai21  g33(.a(new_n39_), .b(new_n36_), .c(x12), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n52_), .c(new_n25_), .O(new_n54_));
