...
module FAU ( 
  ...
  nand2  g09(.a(x12), .b(x07), .O(new_n29_));
  ...
  aoi21  g21(.a(new_n20_), .b(new_n40_), .c(new_n27_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n39_), .c(new_n30_), .O(z1));
  ...
  nand3  g28(.a(new_n21_), .b(new_n43_), .c(new_n23_), .O(new_n48_));
  ...
  nand4  g36(.a(new_n46_), .b(x04), .c(x03), .d(x02), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x05), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  nand3  g40(.a(new_n21_), .b(new_n44_), .c(new_n43_), .O(new_n60_));
  ...
  nand2  g44(.a(new_n63_), .b(new_n58_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai21  g46(.a(new_n21_), .b(new_n65_), .c(new_n29_), .O(z4));
endmodule
