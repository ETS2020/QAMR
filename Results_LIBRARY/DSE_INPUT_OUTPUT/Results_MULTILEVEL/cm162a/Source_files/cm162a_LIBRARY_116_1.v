...
module FAU ( 
  ...
  aoi22  g12(.a(new_n31_), .b(new_n27_), .c(x12), .d(new_n20_), .O(z0));
  nand2  g13(.a(x12), .b(new_n20_), .O(new_n33_));
  oai21  g14(.a(x10), .b(x08), .c(new_n21_), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(x04), .c(x02), .O(new_n35_));
  nand2  g16(.a(x04), .b(x02), .O(new_n36_));
  nand2  g17(.a(new_n21_), .b(new_n24_), .O(new_n37_));
  ...
  nand4  g23(.a(new_n42_), .b(new_n40_), .c(new_n33_), .d(x05), .O(z1));
  inv1   g24(.a(x10), .O(new_n44_));
  nand3  g25(.a(new_n20_), .b(new_n44_), .c(new_n24_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n44_), .c(new_n24_), .O(new_n48_));
