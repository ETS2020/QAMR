...
module FAU ( 
  ...
  nand2  g18(.a(new_n23_), .b(x08), .O(new_n38_));
  nand4  g19(.a(new_n38_), .b(new_n20_), .c(x04), .d(x02), .O(new_n39_));
  nand4  g20(.a(new_n23_), .b(new_n26_), .c(x04), .d(x02), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n21_), .c(x10), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n39_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x03), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n37_), .O(z1));
  nor2   g25(.a(new_n22_), .b(x06), .O(new_n45_));
  nor2   g26(.a(x12), .b(x05), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n45_), .c(new_n31_), .O(new_n47_));
  oai21  g28(.a(x12), .b(x11), .c(x10), .O(new_n48_));
  ...
  nand2  g33(.a(new_n40_), .b(x11), .O(new_n53_));
  inv1   g34(.a(x11), .O(new_n54_));
  and2   g35(.a(x04), .b(x02), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n54_), .c(new_n26_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n53_), .c(x10), .O(new_n57_));
  nand3  g38(.a(new_n21_), .b(x11), .c(x10), .O(new_n58_));
  inv1   g39(.a(new_n58_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n57_), .c(x03), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n52_), .c(new_n47_), .O(z2));
  nand3  g42(.a(new_n54_), .b(new_n20_), .c(new_n26_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n23_), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n21_), .c(x04), .d(x02), .O(new_n64_));
  nand4  g45(.a(new_n55_), .b(new_n23_), .c(new_n54_), .d(new_n26_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(x12), .c(new_n20_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(x03), .O(new_n68_));
  oai21  g49(.a(x07), .b(x03), .c(x05), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n35_), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(new_n68_), .O(z3));
  nand2  g52(.a(new_n50_), .b(new_n35_), .O(z4));
endmodule
