...
module FAU ( 
  ...
  oai21  g25(.a(new_n20_), .b(new_n31_), .c(x06), .O(new_n45_));
  inv1   g26(.a(x10), .O(new_n46_));
  inv1   g27(.a(x11), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n46_), .c(new_n26_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n23_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x04), .c(x02), .O(new_n50_));
  nand3  g31(.a(new_n23_), .b(new_n46_), .c(new_n26_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n37_), .c(x11), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n45_), .O(new_n54_));
  inv1   g35(.a(x06), .O(new_n55_));
  aoi22  g36(.a(new_n21_), .b(new_n32_), .c(new_n55_), .d(new_n31_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n54_), .O(z2));
  inv1   g38(.a(x02), .O(new_n58_));
  nand4  g39(.a(new_n49_), .b(new_n20_), .c(new_n55_), .d(x04), .O(new_n59_));
  nand3  g40(.a(new_n23_), .b(new_n47_), .c(new_n46_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n27_), .c(x12), .O(new_n61_));
  oai21  g42(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(new_n62_));
