...
module FAU ( 
  ...
  oai21  g19(.a(new_n38_), .b(new_n23_), .c(new_n24_), .O(new_n39_));
  ...
  nand3  g30(.a(new_n49_), .b(new_n47_), .c(new_n24_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(x03), .O(new_n51_));
  inv1   g32(.a(x06), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n20_), .c(new_n23_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z2));
  inv1   g35(.a(x04), .O(new_n55_));
  nand3  g36(.a(x13), .b(new_n24_), .c(x09), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n45_), .c(new_n55_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(x02), .c(x12), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n20_), .c(new_n23_), .O(new_n60_));
  oai21  g41(.a(new_n58_), .b(new_n20_), .c(new_n60_), .O(z3));
  nand2  g42(.a(x12), .b(x03), .O(new_n62_));
