...
module FAU ( 
  ...
  nand3  g30(.a(new_n24_), .b(x12), .c(new_n44_), .O(new_n50_));
  ...
  oai21  g34(.a(x06), .b(x03), .c(new_n42_), .O(new_n54_));
  ...
  inv1   g41(.a(new_n34_), .O(new_n61_));
  nor3   g42(.a(x11), .b(x10), .c(x08), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n61_), .c(new_n41_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n60_), .c(x03), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n28_), .O(new_n66_));
  nand4  g47(.a(new_n66_), .b(new_n64_), .c(new_n42_), .d(x05), .O(z3));
  inv1   g48(.a(x04), .O(new_n68_));
  oai21  g49(.a(new_n24_), .b(new_n68_), .c(new_n42_), .O(z4));
endmodule
