...
module FAU ( 
  ...
  nand4  g34(.a(new_n38_), .b(new_n42_), .c(new_n32_), .d(new_n26_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n23_), .c(new_n21_), .O(new_n55_));
  ...
  oai21  g40(.a(x12), .b(new_n59_), .c(new_n21_), .O(new_n60_));
  oai21  g41(.a(new_n43_), .b(new_n46_), .c(x12), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n60_), .c(x05), .O(new_n62_));
  inv1   g43(.a(new_n62_), .O(new_n63_));
  oai21  g44(.a(new_n58_), .b(new_n31_), .c(new_n63_), .O(z3));
  oai22  g45(.a(new_n23_), .b(new_n31_), .c(new_n38_), .d(x03), .O(z4));
endmodule
