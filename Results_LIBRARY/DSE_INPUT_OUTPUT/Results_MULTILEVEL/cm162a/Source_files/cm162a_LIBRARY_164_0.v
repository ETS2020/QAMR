...
module FAU ( 
  ...
  nor2   g08(.a(x12), .b(x11), .O(new_n28_));
  ...
  aoi21  g21(.a(new_n40_), .b(new_n38_), .c(new_n28_), .O(z1));
  ...
  nand4  g26(.a(new_n45_), .b(x12), .c(x04), .d(x02), .O(new_n46_));
  ...
  inv1   g36(.a(x13), .O(new_n56_));
  aoi21  g37(.a(x04), .b(x02), .c(x12), .O(new_n57_));
  nor3   g38(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  inv1   g39(.a(x12), .O(new_n59_));
  inv1   g40(.a(new_n33_), .O(new_n60_));
  inv1   g41(.a(new_n44_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n58_), .c(x03), .O(new_n63_));
  inv1   g44(.a(x07), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n20_), .c(new_n28_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n63_), .c(x05), .O(z3));
  oai21  g47(.a(new_n21_), .b(new_n23_), .c(new_n51_), .O(z4));
endmodule
