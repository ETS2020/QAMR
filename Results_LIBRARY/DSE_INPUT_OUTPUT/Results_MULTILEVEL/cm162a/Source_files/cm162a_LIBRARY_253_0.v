...
module FAU ( 
  ...
  nor2   g12(.a(new_n21_), .b(new_n31_), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(x08), .c(x03), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n30_), .O(z0));
  inv1   g15(.a(x04), .O(new_n35_));
  inv1   g16(.a(new_n32_), .O(new_n36_));
  inv1   g17(.a(x10), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n26_), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(new_n36_), .c(new_n35_), .O(new_n39_));
  inv1   g20(.a(new_n24_), .O(new_n40_));
  nand3  g21(.a(new_n36_), .b(new_n40_), .c(new_n26_), .O(new_n41_));
  aoi22  g22(.a(new_n41_), .b(x10), .c(new_n39_), .d(x02), .O(new_n42_));
  nor2   g23(.a(x03), .b(x01), .O(new_n43_));
  nand2  g24(.a(new_n22_), .b(x05), .O(new_n44_));
  nor2   g25(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  oai21  g26(.a(new_n42_), .b(new_n23_), .c(new_n45_), .O(z1));
  nand2  g27(.a(new_n38_), .b(new_n31_), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n20_), .c(x04), .d(x02), .O(new_n48_));
  nand3  g29(.a(new_n36_), .b(new_n37_), .c(new_n26_), .O(new_n49_));
  ...
  nand4  g38(.a(new_n57_), .b(new_n20_), .c(new_n37_), .d(new_n26_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n31_), .c(new_n56_), .O(new_n59_));
  nor2   g40(.a(new_n57_), .b(new_n31_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(x04), .O(new_n61_));
  oai21  g42(.a(new_n38_), .b(new_n24_), .c(x12), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n61_), .c(new_n23_), .O(new_n63_));
  inv1   g44(.a(x07), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n23_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x05), .O(new_n66_));
  oai21  g47(.a(new_n66_), .b(new_n63_), .c(x13), .O(new_n67_));
  nand2  g48(.a(x12), .b(x03), .O(new_n68_));
  nand3  g49(.a(new_n68_), .b(new_n65_), .c(x05), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(x11), .O(new_n70_));
