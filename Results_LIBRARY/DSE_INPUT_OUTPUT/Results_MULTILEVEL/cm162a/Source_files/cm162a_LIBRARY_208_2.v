...
module FAU ( 
  ...
  nand2  g03(.a(new_n22_), .b(x12), .O(new_n23_));
  nand2  g04(.a(new_n23_), .b(x02), .O(new_n24_));
  nand2  g05(.a(x13), .b(x09), .O(new_n25_));
  nand4  g06(.a(new_n25_), .b(x12), .c(x04), .d(x02), .O(new_n26_));
  ...
  nand3  g19(.a(new_n25_), .b(new_n38_), .c(x04), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x10), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(new_n37_), .c(new_n32_), .O(new_n41_));
  inv1   g22(.a(x10), .O(new_n42_));
  nor2   g23(.a(new_n42_), .b(x02), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n41_), .c(x03), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n35_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n42_), .c(new_n38_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n25_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x04), .c(x02), .O(new_n49_));
  nand2  g30(.a(new_n21_), .b(x02), .O(new_n50_));
  nand3  g31(.a(new_n25_), .b(x12), .c(new_n42_), .O(new_n51_));
  ...
  nand4  g41(.a(new_n25_), .b(new_n21_), .c(new_n46_), .d(new_n42_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(x03), .c(new_n32_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n29_), .O(new_n64_));
  nand3  g45(.a(x12), .b(x03), .c(new_n60_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n64_), .c(x05), .O(new_n66_));
  inv1   g47(.a(new_n66_), .O(new_n67_));
  oai21  g48(.a(new_n62_), .b(new_n60_), .c(new_n67_), .O(z3));
  nand4  g49(.a(new_n33_), .b(x13), .c(x09), .d(x04), .O(new_n69_));
