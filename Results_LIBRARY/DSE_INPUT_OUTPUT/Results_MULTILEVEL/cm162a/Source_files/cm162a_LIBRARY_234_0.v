...
module FAU ( 
  ...
  nand2  g10(.a(x06), .b(new_n29_), .O(new_n30_));
  ...
  aoi21  g19(.a(new_n38_), .b(new_n37_), .c(new_n33_), .O(new_n39_));
  aoi21  g20(.a(new_n35_), .b(x02), .c(new_n39_), .O(new_n40_));
  inv1   g21(.a(x01), .O(new_n41_));
  aoi21  g22(.a(new_n20_), .b(new_n41_), .c(new_n29_), .O(new_n42_));
  oai21  g23(.a(new_n40_), .b(new_n20_), .c(new_n42_), .O(z1));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n33_), .c(new_n24_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n33_), .c(new_n24_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n36_), .c(x11), .O(new_n49_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n44_), .c(new_n33_), .d(new_n24_), .O(new_n56_));
  ...
  oai21  g41(.a(new_n45_), .b(new_n36_), .c(x12), .O(new_n61_));
  ...
  nand2  g45(.a(new_n64_), .b(new_n30_), .O(z3));
  inv1   g46(.a(x09), .O(new_n66_));
  oai21  g47(.a(x06), .b(x05), .c(x13), .O(new_n67_));
  nor3   g48(.a(new_n67_), .b(new_n66_), .c(new_n32_), .O(z4));
endmodule
