...
module FAU ( 
  ...
  oai21  g03(.a(new_n22_), .b(new_n21_), .c(x11), .O(new_n23_));
  ...
  nand4  g12(.a(new_n31_), .b(new_n29_), .c(new_n24_), .d(x05), .O(z0));
  nor2   g13(.a(x10), .b(x08), .O(new_n33_));
  inv1   g14(.a(new_n33_), .O(new_n34_));
  aoi21  g15(.a(new_n34_), .b(new_n25_), .c(new_n20_), .O(new_n35_));
  ...
  nor2   g22(.a(new_n41_), .b(new_n38_), .O(new_n42_));
  oai21  g23(.a(new_n37_), .b(new_n21_), .c(new_n42_), .O(z1));
  inv1   g24(.a(x10), .O(new_n44_));
  nand3  g25(.a(new_n39_), .b(new_n44_), .c(new_n22_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n25_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand2  g28(.a(x04), .b(x02), .O(new_n48_));
  nand3  g29(.a(new_n25_), .b(new_n44_), .c(new_n22_), .O(new_n49_));
