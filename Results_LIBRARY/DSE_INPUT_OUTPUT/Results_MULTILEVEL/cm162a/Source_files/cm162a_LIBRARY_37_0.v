...
module FAU ( 
  ...
  oai21  g25(.a(new_n37_), .b(new_n35_), .c(x11), .O(new_n45_));
  inv1   g26(.a(x11), .O(new_n46_));
  nand4  g27(.a(new_n38_), .b(new_n46_), .c(new_n34_), .d(new_n33_), .O(new_n47_));
  ...
  nand2  g31(.a(new_n37_), .b(new_n46_), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(x13), .c(x09), .d(x03), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  inv1   g34(.a(x09), .O(new_n54_));
  nand4  g35(.a(new_n27_), .b(new_n46_), .c(new_n34_), .d(new_n33_), .O(new_n55_));
  ...
  oai21  g45(.a(new_n21_), .b(new_n23_), .c(new_n29_), .O(z4));
endmodule
