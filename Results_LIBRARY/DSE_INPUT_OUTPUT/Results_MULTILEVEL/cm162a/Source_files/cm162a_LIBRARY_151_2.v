...
module FAU ( 
  ...
  nand4  g25(.a(new_n44_), .b(new_n25_), .c(x04), .d(x02), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n43_), .c(new_n22_), .O(new_n46_));
  oai21  g27(.a(x06), .b(x03), .c(x05), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n46_), .c(new_n21_), .O(new_n48_));
  inv1   g29(.a(x11), .O(new_n49_));
  aoi21  g30(.a(new_n23_), .b(new_n49_), .c(new_n39_), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(x12), .c(x09), .d(x03), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n48_), .O(z2));
  inv1   g33(.a(x04), .O(new_n53_));
  nor2   g34(.a(x12), .b(x11), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n34_), .c(new_n25_), .d(x02), .O(new_n55_));
  nand2  g36(.a(x13), .b(x09), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n55_), .c(new_n53_), .O(new_n57_));
  and2   g38(.a(new_n45_), .b(x12), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(x03), .O(new_n59_));
  inv1   g40(.a(x05), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n22_), .c(new_n60_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n59_), .c(new_n21_), .O(z3));
  inv1   g44(.a(x09), .O(new_n64_));
  nand2  g45(.a(x13), .b(x04), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(x12), .c(new_n64_), .O(z4));
endmodule
