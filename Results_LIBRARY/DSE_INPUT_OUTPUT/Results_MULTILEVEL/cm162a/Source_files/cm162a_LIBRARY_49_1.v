...
module FAU ( 
  ...
  inv1   g23(.a(new_n28_), .O(new_n43_));
  ...
  nand3  g29(.a(new_n21_), .b(new_n44_), .c(new_n35_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n34_), .c(x11), .O(new_n50_));
  ...
  nand4  g38(.a(new_n47_), .b(new_n57_), .c(x04), .d(x02), .O(new_n58_));
  aoi21  g39(.a(x13), .b(x09), .c(x11), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n24_), .c(new_n44_), .d(x02), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x12), .c(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  nor2   g44(.a(x12), .b(x07), .O(new_n64_));
  aoi22  g45(.a(new_n64_), .b(new_n20_), .c(new_n28_), .d(new_n53_), .O(new_n65_));
