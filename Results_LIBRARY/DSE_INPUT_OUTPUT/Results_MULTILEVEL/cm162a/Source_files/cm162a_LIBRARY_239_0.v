...
module FAU ( 
  ...
  nand2  g32(.a(x12), .b(x06), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n30_), .c(new_n20_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand2  g36(.a(new_n47_), .b(x03), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  inv1   g38(.a(new_n26_), .O(new_n58_));
  nand3  g39(.a(new_n22_), .b(new_n44_), .c(new_n43_), .O(new_n59_));
  inv1   g40(.a(new_n59_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n58_), .c(new_n55_), .O(new_n61_));
  oai21  g42(.a(x07), .b(x03), .c(x05), .O(new_n62_));
  aoi21  g43(.a(new_n61_), .b(x03), .c(new_n62_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n57_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai22  g46(.a(new_n22_), .b(new_n65_), .c(x12), .d(x03), .O(z4));
endmodule
