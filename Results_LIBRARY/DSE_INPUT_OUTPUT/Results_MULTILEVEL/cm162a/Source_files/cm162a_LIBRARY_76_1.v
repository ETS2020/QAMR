...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n24_), .c(new_n31_), .O(new_n34_));
  inv1   g15(.a(x02), .O(new_n35_));
  nor2   g16(.a(new_n31_), .b(new_n35_), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n24_), .c(new_n20_), .O(new_n37_));
  aoi22  g18(.a(new_n37_), .b(x10), .c(new_n34_), .d(x02), .O(new_n38_));
  inv1   g19(.a(x01), .O(new_n39_));
  inv1   g20(.a(x05), .O(new_n40_));
  aoi21  g21(.a(new_n30_), .b(new_n39_), .c(new_n40_), .O(new_n41_));
  oai21  g22(.a(new_n38_), .b(new_n30_), .c(new_n41_), .O(z1));
  inv1   g23(.a(x10), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(new_n20_), .O(new_n45_));
  ...
  nand4  g29(.a(new_n36_), .b(new_n24_), .c(new_n43_), .d(new_n20_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x11), .c(x05), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x03), .O(new_n52_));
  nor2   g33(.a(x06), .b(new_n40_), .O(new_n53_));
  aoi22  g34(.a(new_n53_), .b(new_n30_), .c(new_n20_), .d(new_n40_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  inv1   g36(.a(new_n46_), .O(new_n56_));
  nor2   g37(.a(x12), .b(x11), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n32_), .c(new_n56_), .O(new_n58_));
  nand4  g39(.a(x13), .b(x12), .c(x09), .d(x05), .O(new_n59_));
  oai21  g40(.a(new_n58_), .b(new_n35_), .c(new_n59_), .O(new_n60_));
  inv1   g41(.a(x12), .O(new_n61_));
  inv1   g42(.a(new_n45_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n36_), .c(new_n61_), .O(new_n63_));
  aoi21  g44(.a(new_n60_), .b(x04), .c(new_n63_), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n30_), .c(new_n40_), .O(new_n66_));
  oai21  g47(.a(new_n64_), .b(new_n30_), .c(new_n66_), .O(z3));
  nand2  g48(.a(x08), .b(new_n40_), .O(new_n68_));
