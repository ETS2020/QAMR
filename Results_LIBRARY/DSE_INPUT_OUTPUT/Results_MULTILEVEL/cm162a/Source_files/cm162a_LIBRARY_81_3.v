...
module FAU ( 
  ...
  nor3   g17(.a(new_n36_), .b(new_n21_), .c(x01), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n35_), .c(new_n32_), .O(z1));
  ...
  nand4  g31(.a(new_n50_), .b(new_n40_), .c(new_n39_), .d(new_n25_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand3  g34(.a(new_n22_), .b(new_n40_), .c(new_n39_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n26_), .c(x12), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n53_), .c(new_n21_), .O(new_n56_));
  ...
  oai22  g41(.a(new_n22_), .b(new_n60_), .c(new_n36_), .d(new_n20_), .O(z4));
endmodule
