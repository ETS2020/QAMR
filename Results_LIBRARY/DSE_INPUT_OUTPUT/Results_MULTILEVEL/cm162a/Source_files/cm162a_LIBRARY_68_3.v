...
module FAU ( 
  ...
  aoi21  g10(.a(x10), .b(x03), .c(new_n25_), .O(new_n30_));
  aoi21  g11(.a(new_n30_), .b(new_n29_), .c(new_n21_), .O(z1));
  ...
  nor2   g16(.a(x07), .b(x03), .O(new_n36_));
  aoi21  g17(.a(x12), .b(x03), .c(new_n36_), .O(new_n37_));
  aoi21  g18(.a(new_n37_), .b(x05), .c(new_n21_), .O(z3));
  inv1   g19(.a(x04), .O(new_n39_));
  aoi21  g20(.a(x13), .b(x09), .c(x02), .O(new_n40_));
  nor2   g21(.a(new_n40_), .b(new_n39_), .O(z4));
endmodule
