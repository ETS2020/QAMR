...
module FAU ( 
  ...
  nand3  g38(.a(new_n48_), .b(new_n49_), .c(new_n20_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n25_), .c(new_n57_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(x02), .c(x12), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n29_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n42_), .c(x05), .O(new_n63_));
