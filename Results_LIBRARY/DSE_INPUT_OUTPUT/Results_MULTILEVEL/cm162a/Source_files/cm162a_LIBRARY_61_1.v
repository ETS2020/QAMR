...
module FAU ( 
  ...
  nand3  g14(.a(new_n33_), .b(new_n30_), .c(new_n27_), .O(z1));
  inv1   g15(.a(x10), .O(new_n35_));
  inv1   g16(.a(x11), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n35_), .c(new_n23_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n20_), .O(new_n38_));
  nand3  g19(.a(new_n38_), .b(x04), .c(x02), .O(new_n39_));
  nand3  g20(.a(new_n20_), .b(new_n35_), .c(new_n23_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n28_), .c(x11), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n39_), .c(new_n33_), .O(z2));
  ...
  nor2   g30(.a(new_n37_), .b(new_n28_), .O(new_n50_));
  nor2   g31(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  aoi21  g32(.a(new_n48_), .b(x04), .c(new_n51_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n31_), .c(x05), .O(z3));
  inv1   g34(.a(x04), .O(new_n54_));
  oai22  g35(.a(new_n20_), .b(new_n54_), .c(new_n32_), .d(x03), .O(z4));
endmodule
