...
module FAU ( 
  ...
  aoi21  g01(.a(x12), .b(x03), .c(new_n20_), .O(new_n21_));
  ...
  aoi21  g07(.a(new_n23_), .b(x08), .c(new_n26_), .O(new_n27_));
  inv1   g08(.a(x05), .O(new_n28_));
  nand2  g09(.a(x05), .b(x03), .O(new_n29_));
  aoi22  g10(.a(new_n29_), .b(new_n20_), .c(x12), .d(new_n28_), .O(new_n30_));
  oai21  g11(.a(new_n27_), .b(new_n21_), .c(new_n30_), .O(z0));
  inv1   g12(.a(x12), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(x00), .O(new_n33_));
  ...
  nand2  g18(.a(new_n22_), .b(new_n24_), .O(new_n38_));
  ...
  nand3  g31(.a(new_n22_), .b(new_n46_), .c(new_n24_), .O(new_n51_));
  ...
  nand3  g37(.a(new_n56_), .b(new_n33_), .c(x05), .O(new_n57_));
  inv1   g38(.a(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n54_), .O(z2));
  nand3  g40(.a(x13), .b(x09), .c(new_n20_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n48_), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n32_), .c(x04), .d(x02), .O(new_n62_));
  nand3  g43(.a(new_n22_), .b(new_n47_), .c(new_n46_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n25_), .c(x12), .O(new_n64_));
  ...
  nand3  g49(.a(new_n68_), .b(new_n33_), .c(x05), .O(new_n69_));
  inv1   g50(.a(new_n69_), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(new_n66_), .O(z3));
  nand4  g52(.a(new_n33_), .b(x13), .c(x09), .d(x04), .O(new_n72_));
