...
module FAU ( 
  ...
  nand3  g26(.a(new_n28_), .b(new_n45_), .c(new_n36_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n21_), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n44_), .c(x04), .d(x02), .O(new_n48_));
  nand3  g29(.a(new_n21_), .b(new_n45_), .c(new_n36_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n35_), .c(x11), .O(new_n50_));
  ...
  nand3  g36(.a(x13), .b(new_n44_), .c(x09), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n46_), .c(new_n23_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(x02), .c(x12), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n29_), .c(x05), .O(new_n61_));
  inv1   g42(.a(new_n61_), .O(new_n62_));
  oai21  g43(.a(new_n58_), .b(new_n20_), .c(new_n62_), .O(z3));
  oai21  g44(.a(x12), .b(new_n20_), .c(x11), .O(new_n64_));
