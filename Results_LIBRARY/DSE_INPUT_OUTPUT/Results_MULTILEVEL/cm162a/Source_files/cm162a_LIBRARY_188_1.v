...
module FAU ( 
  ...
  nor2   g10(.a(new_n29_), .b(x02), .O(new_n30_));
  oai21  g11(.a(new_n30_), .b(new_n28_), .c(x04), .O(new_n31_));
  inv1   g12(.a(x04), .O(new_n32_));
  nand3  g13(.a(new_n20_), .b(x08), .c(new_n32_), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n31_), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(x03), .O(new_n35_));
  oai21  g16(.a(new_n25_), .b(new_n21_), .c(new_n35_), .O(z0));
  nor2   g17(.a(new_n21_), .b(x01), .O(new_n37_));
  nor2   g18(.a(x12), .b(x05), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n37_), .c(new_n23_), .O(new_n39_));
  inv1   g20(.a(new_n27_), .O(new_n40_));
  nor2   g21(.a(x10), .b(x08), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n40_), .c(x02), .O(new_n42_));
  nand3  g23(.a(new_n27_), .b(new_n29_), .c(x02), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(x10), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n42_), .c(new_n32_), .O(new_n45_));
  nand3  g26(.a(new_n20_), .b(x10), .c(new_n32_), .O(new_n46_));
  inv1   g27(.a(new_n46_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n45_), .c(x03), .O(new_n48_));
  nor2   g29(.a(x12), .b(x10), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(x04), .c(new_n24_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(new_n39_), .O(z1));
  inv1   g32(.a(x10), .O(new_n52_));
  inv1   g33(.a(x11), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n52_), .c(new_n29_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n27_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  nand2  g37(.a(x04), .b(x02), .O(new_n57_));
  nand3  g38(.a(new_n27_), .b(new_n52_), .c(new_n29_), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n62_), .b(new_n23_), .c(new_n21_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n61_), .c(x05), .O(z2));
  nor2   g45(.a(x12), .b(x11), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n41_), .c(new_n40_), .O(new_n66_));
  nand2  g47(.a(new_n29_), .b(x02), .O(new_n67_));
  nand3  g48(.a(new_n27_), .b(new_n53_), .c(new_n52_), .O(new_n68_));
  oai21  g49(.a(new_n68_), .b(new_n67_), .c(x12), .O(new_n69_));
  oai21  g50(.a(new_n66_), .b(new_n26_), .c(new_n69_), .O(new_n70_));
  oai21  g51(.a(x07), .b(x03), .c(x05), .O(new_n71_));
  aoi21  g52(.a(new_n70_), .b(x03), .c(new_n71_), .O(new_n72_));
  nand2  g53(.a(new_n71_), .b(new_n20_), .O(new_n73_));
  oai21  g54(.a(new_n72_), .b(new_n32_), .c(new_n73_), .O(z3));
  nand2  g55(.a(new_n40_), .b(x04), .O(new_n75_));
