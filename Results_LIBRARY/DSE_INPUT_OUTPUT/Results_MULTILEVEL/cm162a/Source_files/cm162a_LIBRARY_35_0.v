...
module FAU ( 
  ...
  nand2  g17(.a(new_n25_), .b(new_n22_), .O(new_n37_));
  ...
  nand3  g31(.a(new_n25_), .b(new_n46_), .c(new_n22_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n36_), .c(x11), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x03), .O(new_n54_));
  oai21  g35(.a(x06), .b(x03), .c(new_n44_), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n31_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n54_), .O(z2));
  nand4  g38(.a(new_n49_), .b(new_n43_), .c(x04), .d(x02), .O(new_n58_));
  nand3  g39(.a(new_n25_), .b(new_n47_), .c(new_n46_), .O(new_n59_));
  ...
  nand2  g44(.a(new_n63_), .b(new_n44_), .O(new_n64_));
