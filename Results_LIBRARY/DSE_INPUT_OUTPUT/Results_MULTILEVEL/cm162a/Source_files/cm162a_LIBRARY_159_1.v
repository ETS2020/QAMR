...
module FAU ( 
  ...
  oai21  g10(.a(new_n28_), .b(x13), .c(new_n29_), .O(new_n30_));
  ...
  nand3  g31(.a(new_n20_), .b(new_n46_), .c(new_n23_), .O(new_n51_));
  ...
  nand4  g40(.a(new_n20_), .b(new_n47_), .c(new_n46_), .d(new_n23_), .O(new_n60_));
  ...
  nand2  g48(.a(new_n59_), .b(x09), .O(new_n68_));
  aoi21  g49(.a(new_n68_), .b(x13), .c(x05), .O(new_n69_));
  aoi21  g50(.a(new_n67_), .b(new_n55_), .c(new_n69_), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(new_n66_), .O(z3));
  inv1   g52(.a(x04), .O(new_n72_));
  aoi21  g53(.a(x09), .b(new_n72_), .c(new_n20_), .O(z4));
endmodule
