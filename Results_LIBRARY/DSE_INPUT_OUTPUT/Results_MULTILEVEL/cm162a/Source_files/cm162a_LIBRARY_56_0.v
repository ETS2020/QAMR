...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(new_n26_), .c(x04), .d(x02), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n44_), .c(new_n23_), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(x05), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(new_n22_), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand2  g31(.a(new_n24_), .b(new_n50_), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(x13), .c(x09), .d(x03), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n49_), .O(z2));
  nand3  g34(.a(new_n50_), .b(new_n36_), .c(new_n26_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n20_), .c(x04), .d(x02), .O(new_n56_));
  nand3  g37(.a(new_n31_), .b(new_n50_), .c(new_n36_), .O(new_n57_));
  ...
  oai21  g42(.a(x07), .b(x03), .c(new_n22_), .O(new_n62_));
