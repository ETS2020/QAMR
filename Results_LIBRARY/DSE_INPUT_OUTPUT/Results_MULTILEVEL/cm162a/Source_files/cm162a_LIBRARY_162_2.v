...
module FAU ( 
  ...
  aoi21  g33(.a(x07), .b(x05), .c(x03), .O(new_n53_));
  inv1   g34(.a(x12), .O(new_n54_));
  nand3  g35(.a(x13), .b(x09), .c(x04), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n42_), .c(new_n41_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n24_), .c(x03), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(x05), .c(new_n54_), .O(new_n58_));
  or2    g39(.a(new_n58_), .b(new_n53_), .O(z3));
  nand2  g40(.a(new_n54_), .b(x03), .O(new_n60_));
