...
module FAU ( 
  ...
  oai21  g36(.a(new_n23_), .b(new_n55_), .c(x11), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x13), .c(x09), .O(new_n57_));
  nand2  g38(.a(new_n42_), .b(new_n34_), .O(new_n58_));
  oai21  g39(.a(new_n33_), .b(new_n58_), .c(new_n43_), .O(new_n59_));
  ...
  nor3   g44(.a(new_n63_), .b(new_n28_), .c(new_n26_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  nand3  g46(.a(new_n51_), .b(x13), .c(x09), .O(new_n66_));
  nor2   g47(.a(new_n66_), .b(new_n23_), .O(z4));
endmodule
