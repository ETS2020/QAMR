...
module FAU ( 
  ...
  nand2  g19(.a(x18), .b(x15), .O(new_n65_));
  oai21  g20(.a(new_n64_), .b(x18), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g25(.a(new_n70_), .b(new_n69_), .c(x18), .O(new_n71_));
  ...
  nand3  g44(.a(new_n89_), .b(new_n48_), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g49(.a(new_n58_), .b(x05), .c(x04), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n48_), .c(x15), .O(z09));
  nand4  g51(.a(new_n59_), .b(new_n48_), .c(new_n88_), .d(new_n69_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z10));
  nand3  g53(.a(new_n59_), .b(x17), .c(new_n58_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n48_), .c(x15), .O(z11));
  nand4  g55(.a(new_n59_), .b(x19), .c(new_n48_), .d(new_n69_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x07), .O(z12));
  nand3  g57(.a(new_n59_), .b(new_n62_), .c(new_n58_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n48_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n69_), .O(z13));
  nand3  g60(.a(new_n59_), .b(new_n69_), .c(new_n58_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n53_), .c(new_n48_), .O(z14));
  nand3  g63(.a(new_n107_), .b(new_n54_), .c(new_n48_), .O(z15));
  nand3  g64(.a(new_n59_), .b(new_n55_), .c(new_n58_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n48_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n69_), .O(z16));
  nand3  g67(.a(new_n59_), .b(new_n72_), .c(new_n58_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n48_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n69_), .O(z17));
  nand3  g70(.a(new_n107_), .b(new_n63_), .c(new_n48_), .O(z18));
endmodule
