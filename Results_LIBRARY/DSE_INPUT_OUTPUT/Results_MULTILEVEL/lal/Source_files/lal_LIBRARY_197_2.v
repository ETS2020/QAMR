...
module FAU ( 
  ...
  nand3  g020(.a(new_n60_), .b(new_n51_), .c(new_n52_), .O(new_n66_));
  ...
  oai21  g033(.a(new_n78_), .b(new_n71_), .c(new_n51_), .O(new_n79_));
  ...
  oai21  g040(.a(x13), .b(x08), .c(new_n51_), .O(z05));
  nand2  g041(.a(x14), .b(new_n46_), .O(new_n87_));
  nand2  g042(.a(new_n87_), .b(new_n51_), .O(z06));
  ...
  aoi21  g049(.a(new_n94_), .b(new_n52_), .c(new_n48_), .O(z08));
  nand4  g050(.a(new_n50_), .b(x05), .c(x04), .d(new_n47_), .O(new_n96_));
  nor2   g051(.a(new_n96_), .b(x15), .O(z09));
  nand4  g052(.a(new_n62_), .b(new_n54_), .c(new_n82_), .d(new_n50_), .O(new_n98_));
  nor2   g053(.a(new_n98_), .b(x02), .O(z10));
  xor2a  g054(.a(x18), .b(x17), .O(new_n100_));
  nand3  g055(.a(new_n100_), .b(new_n62_), .c(new_n50_), .O(new_n101_));
  aoi21  g056(.a(new_n101_), .b(new_n47_), .c(x15), .O(z11));
  ...
  nand4  g061(.a(new_n106_), .b(new_n62_), .c(new_n82_), .d(new_n50_), .O(new_n107_));
  nor2   g062(.a(new_n107_), .b(x02), .O(z12));
  nand3  g063(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(x20), .O(new_n110_));
  nand3  g065(.a(new_n104_), .b(new_n53_), .c(x19), .O(new_n111_));
  nand4  g066(.a(new_n111_), .b(new_n110_), .c(new_n62_), .d(new_n50_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n82_), .O(z13));
  nand2  g069(.a(new_n111_), .b(x21), .O(new_n115_));
  aoi21  g070(.a(x05), .b(x04), .c(x02), .O(new_n116_));
  nor2   g071(.a(x21), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n104_), .c(x19), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n82_), .c(new_n50_), .O(new_n119_));
  inv1   g074(.a(new_n119_), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(new_n116_), .c(new_n115_), .O(z14));
  ...
  nor2   g081(.a(new_n126_), .b(x20), .O(new_n127_));
  nand2  g082(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n122_), .c(new_n62_), .d(new_n50_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n82_), .O(z15));
  aoi21  g086(.a(new_n127_), .b(new_n123_), .c(new_n90_), .O(new_n132_));
  nand4  g087(.a(new_n117_), .b(new_n123_), .c(new_n90_), .d(new_n125_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n62_), .c(new_n50_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n132_), .c(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n82_), .O(z16));
  nand2  g091(.a(new_n133_), .b(x24), .O(new_n137_));
  inv1   g092(.a(new_n111_), .O(new_n138_));
  inv1   g093(.a(x24), .O(new_n139_));
  nor2   g094(.a(x22), .b(x21), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n139_), .c(new_n90_), .O(new_n141_));
  inv1   g096(.a(new_n141_), .O(new_n142_));
  aoi21  g097(.a(new_n142_), .b(new_n138_), .c(x15), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n137_), .c(new_n116_), .d(new_n50_), .O(z17));
  oai21  g099(.a(new_n141_), .b(new_n111_), .c(x25), .O(new_n145_));
  nand3  g100(.a(new_n52_), .b(new_n139_), .c(new_n90_), .O(new_n146_));
  nor2   g101(.a(new_n146_), .b(new_n126_), .O(new_n147_));
  aoi21  g102(.a(new_n147_), .b(new_n138_), .c(x15), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n145_), .c(new_n116_), .d(new_n50_), .O(z18));
endmodule
