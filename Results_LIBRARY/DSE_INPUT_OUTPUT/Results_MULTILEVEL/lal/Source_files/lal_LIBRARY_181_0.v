...
module FAU ( 
  ...
  nand3  g48(.a(new_n57_), .b(new_n86_), .c(new_n91_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(x18), .c(x15), .O(z10));
  inv1   g50(.a(x15), .O(new_n96_));
  nand4  g51(.a(new_n57_), .b(x18), .c(new_n86_), .d(new_n96_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z11));
  xor2a  g53(.a(x19), .b(x17), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n57_), .c(new_n91_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(x18), .c(x15), .O(z12));
  oai21  g56(.a(new_n88_), .b(new_n86_), .c(x20), .O(new_n102_));
  nor2   g57(.a(new_n58_), .b(x07), .O(new_n103_));
  nand3  g58(.a(new_n66_), .b(x19), .c(x17), .O(new_n104_));
  and2   g59(.a(new_n104_), .b(x18), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n96_), .O(z13));
  ...
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n57_), .d(new_n91_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x18), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n96_), .O(z14));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n53_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n108_), .c(new_n66_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n57_), .c(new_n91_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n114_), .c(x18), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n96_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  nand3  g75(.a(new_n49_), .b(new_n53_), .c(new_n52_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(new_n104_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(new_n67_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n120_), .c(new_n103_), .d(new_n96_), .O(z16));
  oai21  g79(.a(new_n121_), .b(new_n104_), .c(x24), .O(new_n125_));
  nor2   g80(.a(x20), .b(new_n88_), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n115_), .c(new_n126_), .d(x17), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n57_), .d(new_n91_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(x18), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n96_), .O(z17));
  ...
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n109_), .d(new_n108_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n57_), .d(new_n91_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(x18), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n96_), .O(z18));
endmodule
