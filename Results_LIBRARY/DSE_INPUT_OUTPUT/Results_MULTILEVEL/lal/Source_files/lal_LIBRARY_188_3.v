...
module FAU ( 
  ...
  nand3  g039(.a(new_n47_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g046(.a(new_n61_), .b(new_n54_), .O(new_n92_));
  oai21  g047(.a(new_n92_), .b(new_n55_), .c(new_n47_), .O(z09));
  ...
  nor2   g056(.a(new_n101_), .b(new_n94_), .O(new_n102_));
  nand3  g057(.a(new_n100_), .b(x18), .c(x17), .O(new_n103_));
  oai21  g058(.a(new_n102_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  nand4  g059(.a(new_n104_), .b(new_n55_), .c(new_n61_), .d(new_n54_), .O(new_n105_));
  inv1   g060(.a(new_n105_), .O(z12));
  oai21  g061(.a(x20), .b(x15), .c(new_n101_), .O(new_n107_));
  oai21  g062(.a(new_n100_), .b(new_n94_), .c(x20), .O(new_n108_));
  nor2   g063(.a(x20), .b(new_n100_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n102_), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n108_), .c(new_n55_), .d(new_n54_), .O(new_n111_));
  nand2  g066(.a(new_n111_), .b(new_n61_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n107_), .O(z13));
  oai21  g068(.a(x21), .b(x15), .c(new_n101_), .O(new_n114_));
  nand3  g069(.a(new_n58_), .b(x19), .c(x17), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(x21), .O(new_n116_));
  nor2   g071(.a(x21), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n102_), .c(x19), .O(new_n118_));
  nand4  g073(.a(new_n118_), .b(new_n116_), .c(new_n55_), .d(new_n54_), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(new_n61_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n114_), .O(z14));
  oai21  g076(.a(x22), .b(x15), .c(new_n101_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n127_), .b(new_n126_), .c(new_n58_), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n124_), .c(new_n55_), .d(new_n54_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n61_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n122_), .O(z15));
  inv1   g086(.a(new_n56_), .O(new_n132_));
  nand2  g087(.a(new_n128_), .b(x23), .O(new_n133_));
  nand4  g088(.a(new_n126_), .b(new_n117_), .c(new_n51_), .d(new_n50_), .O(new_n134_));
  nand4  g089(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n61_), .O(z16));
  oai21  g090(.a(x24), .b(x15), .c(new_n101_), .O(new_n136_));
  nand3  g091(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n115_), .c(x24), .O(new_n138_));
  nor2   g093(.a(x24), .b(x23), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n127_), .c(new_n109_), .d(new_n102_), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n138_), .c(new_n55_), .d(new_n54_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n61_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n136_), .O(z17));
  oai21  g098(.a(x25), .b(x15), .c(new_n101_), .O(new_n144_));
  nand4  g099(.a(new_n70_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n115_), .c(x25), .O(new_n146_));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n127_), .c(new_n109_), .d(new_n102_), .O(new_n148_));
