...
module FAU ( 
  ...
  nand2  g43(.a(new_n59_), .b(new_n52_), .O(new_n89_));
  ...
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n59_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n86_), .O(z13));
  ...
  oai21  g64(.a(new_n109_), .b(x07), .c(new_n86_), .O(z14));
  nand2  g65(.a(new_n107_), .b(x22), .O(new_n111_));
  nor2   g66(.a(new_n60_), .b(x07), .O(new_n112_));
  ...
  nor2   g72(.a(new_n115_), .b(new_n80_), .O(new_n118_));
  inv1   g73(.a(new_n99_), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n106_), .c(new_n119_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n59_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n118_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n86_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n113_), .O(new_n127_));
  or2    g82(.a(new_n127_), .b(new_n102_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n112_), .d(new_n86_), .O(z17));
  oai21  g84(.a(new_n127_), .b(new_n102_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n113_), .c(new_n101_), .d(new_n94_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n59_), .O(new_n133_));
