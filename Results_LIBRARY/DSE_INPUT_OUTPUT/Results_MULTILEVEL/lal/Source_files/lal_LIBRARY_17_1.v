...
module FAU ( 
  ...
  nand2  g017(.a(x18), .b(x12), .O(new_n63_));
  ...
  oai21  g044(.a(new_n72_), .b(x12), .c(new_n89_), .O(z04));
  ...
  nand3  g063(.a(x18), .b(new_n106_), .c(x12), .O(new_n109_));
  ...
  and2   g068(.a(x18), .b(x17), .O(new_n114_));
  ...
  inv1   g073(.a(new_n59_), .O(new_n119_));
  inv1   g074(.a(x12), .O(new_n120_));
  oai21  g075(.a(x20), .b(x18), .c(new_n120_), .O(new_n121_));
  ...
  nand4  g081(.a(new_n126_), .b(new_n123_), .c(new_n121_), .d(new_n119_), .O(z13));
  nand3  g082(.a(new_n58_), .b(new_n103_), .c(new_n57_), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n49_), .O(new_n129_));
  nand3  g084(.a(new_n61_), .b(x19), .c(x17), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(x21), .O(new_n131_));
  nor2   g086(.a(x21), .b(x20), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n114_), .c(x19), .O(new_n133_));
  ...
  oai21  g092(.a(x22), .b(x18), .c(new_n120_), .O(new_n138_));
  nand2  g093(.a(new_n133_), .b(x22), .O(new_n139_));
  inv1   g094(.a(new_n122_), .O(new_n140_));
  nand2  g095(.a(new_n53_), .b(new_n52_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(x20), .O(new_n142_));
  aoi21  g097(.a(new_n142_), .b(new_n140_), .c(x15), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n139_), .c(new_n138_), .d(new_n119_), .O(z15));
  oai21  g099(.a(x23), .b(x18), .c(new_n120_), .O(new_n145_));
  nand2  g100(.a(new_n142_), .b(new_n140_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(x23), .O(new_n147_));
  nand4  g102(.a(new_n132_), .b(new_n140_), .c(new_n54_), .d(new_n53_), .O(new_n148_));
  nand3  g103(.a(new_n148_), .b(new_n119_), .c(new_n103_), .O(new_n149_));
  inv1   g104(.a(new_n149_), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n147_), .c(new_n145_), .O(z16));
  nand3  g106(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n152_));
  oai21  g107(.a(new_n152_), .b(new_n130_), .c(x24), .O(new_n153_));
  nor2   g108(.a(x20), .b(new_n113_), .O(new_n154_));
  nor2   g109(.a(x22), .b(x21), .O(new_n155_));
  nor2   g110(.a(x24), .b(x23), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n114_), .O(new_n157_));
  nand2  g112(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(x12), .O(new_n159_));
  nand2  g114(.a(x24), .b(new_n47_), .O(new_n160_));
  nand3  g115(.a(new_n160_), .b(new_n159_), .c(new_n129_), .O(z17));
  oai21  g116(.a(x25), .b(x18), .c(new_n120_), .O(new_n162_));
  nand2  g117(.a(new_n157_), .b(x25), .O(new_n163_));
  nand3  g118(.a(new_n51_), .b(new_n95_), .c(new_n54_), .O(new_n164_));
  nor2   g119(.a(new_n164_), .b(new_n141_), .O(new_n165_));
  aoi21  g120(.a(new_n165_), .b(new_n125_), .c(x15), .O(new_n166_));
  nand4  g121(.a(new_n166_), .b(new_n163_), .c(new_n162_), .d(new_n119_), .O(z18));
endmodule
