...
module FAU ( 
  ...
  nand3  g20(.a(new_n64_), .b(new_n56_), .c(new_n48_), .O(new_n66_));
  ...
  aoi21  g28(.a(new_n72_), .b(x03), .c(new_n73_), .O(new_n74_));
  oai21  g29(.a(new_n72_), .b(x03), .c(new_n74_), .O(new_n75_));
  nor2   g30(.a(new_n75_), .b(new_n71_), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(new_n70_), .c(x08), .O(z04));
  inv1   g32(.a(x13), .O(new_n78_));
  nand3  g33(.a(x15), .b(new_n78_), .c(new_n46_), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z05));
  inv1   g35(.a(x14), .O(new_n81_));
  aoi21  g36(.a(x15), .b(new_n81_), .c(x08), .O(z06));
  oai21  g37(.a(new_n73_), .b(x06), .c(new_n46_), .O(z07));
  inv1   g38(.a(x24), .O(new_n84_));
  inv1   g39(.a(x22), .O(new_n85_));
  aoi21  g40(.a(new_n53_), .b(new_n49_), .c(new_n85_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(x21), .c(x23), .O(new_n87_));
  nor2   g42(.a(new_n60_), .b(x25), .O(new_n88_));
  oai21  g43(.a(new_n87_), .b(new_n84_), .c(new_n88_), .O(z08));
  nor4   g44(.a(new_n58_), .b(x15), .c(new_n46_), .d(x07), .O(z09));
  inv1   g45(.a(x07), .O(new_n91_));
  nand3  g46(.a(new_n58_), .b(new_n50_), .c(new_n91_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x08), .c(x15), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n58_), .c(new_n73_), .d(x08), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z11));
  nand2  g51(.a(x18), .b(x17), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand3  g53(.a(new_n52_), .b(x18), .c(x17), .O(new_n99_));
  oai21  g54(.a(new_n98_), .b(new_n52_), .c(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n58_), .c(new_n91_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(x08), .c(x15), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nor2   g59(.a(new_n59_), .b(x07), .O(new_n105_));
  nand4  g60(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nor2   g62(.a(new_n107_), .b(x15), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n105_), .c(new_n104_), .d(x08), .O(z13));
  inv1   g64(.a(x21), .O(new_n110_));
  nor2   g65(.a(new_n107_), .b(new_n110_), .O(new_n111_));
  ...
  oai21  g69(.a(new_n114_), .b(new_n111_), .c(x08), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n73_), .O(z14));
  nand3  g71(.a(new_n110_), .b(new_n49_), .c(x19), .O(new_n117_));
  ...
  nand2  g78(.a(new_n123_), .b(new_n73_), .O(z15));
  inv1   g79(.a(x23), .O(new_n125_));
  aoi21  g80(.a(new_n120_), .b(new_n119_), .c(new_n125_), .O(new_n126_));
  nand4  g81(.a(new_n112_), .b(new_n119_), .c(new_n125_), .d(new_n85_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n58_), .c(new_n91_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n126_), .c(x08), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n73_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  nand4  g86(.a(new_n84_), .b(new_n125_), .c(new_n85_), .d(new_n110_), .O(new_n132_));
  inv1   g87(.a(new_n132_), .O(new_n133_));
  aoi21  g88(.a(new_n133_), .b(new_n107_), .c(x15), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n131_), .c(new_n105_), .d(x08), .O(z17));
  oai21  g90(.a(new_n132_), .b(new_n106_), .c(x25), .O(new_n136_));
  nor2   g91(.a(x20), .b(new_n52_), .O(new_n137_));
  nor2   g92(.a(x22), .b(x21), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n98_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n136_), .c(new_n58_), .d(new_n91_), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(x08), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(new_n73_), .O(z18));
endmodule
