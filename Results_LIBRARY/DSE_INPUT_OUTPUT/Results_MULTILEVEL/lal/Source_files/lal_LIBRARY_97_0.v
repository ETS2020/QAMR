...
module FAU ( 
  ...
  nand2  g17(.a(new_n62_), .b(x15), .O(z02));
  ...
  nand4  g49(.a(new_n94_), .b(new_n86_), .c(x16), .d(new_n85_), .O(new_n95_));
  ...
  nand2  g55(.a(new_n100_), .b(x16), .O(new_n101_));
  ...
  nand3  g60(.a(new_n105_), .b(x16), .c(new_n85_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n103_), .c(new_n60_), .O(z14));
  inv1   g63(.a(new_n97_), .O(new_n109_));
  nor2   g64(.a(x22), .b(x21), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n51_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n86_), .c(new_n82_), .O(new_n112_));
  aoi21  g67(.a(new_n105_), .b(x22), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n62_), .c(new_n85_), .O(z15));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n104_), .c(new_n109_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(x16), .c(new_n85_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n115_), .c(new_n60_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  inv1   g76(.a(new_n99_), .O(new_n122_));
  nand3  g77(.a(new_n110_), .b(new_n49_), .c(new_n77_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  aoi21  g79(.a(new_n124_), .b(new_n122_), .c(new_n62_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n121_), .c(new_n60_), .d(new_n85_), .O(z17));
  oai21  g81(.a(new_n123_), .b(new_n99_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n110_), .c(new_n122_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n86_), .d(new_n82_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x16), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n85_), .O(z18));
endmodule
