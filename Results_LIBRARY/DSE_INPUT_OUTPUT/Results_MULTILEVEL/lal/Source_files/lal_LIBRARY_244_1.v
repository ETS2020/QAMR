...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n92_, new_n93_, new_n95_, new_n97_, new_n98_, new_n102_, new_n103_,
    new_n106_, new_n107_;
  ...
  nor4   g41(.a(new_n86_), .b(x19), .c(x15), .d(x07), .O(z09));
  inv1   g42(.a(x07), .O(new_n88_));
  inv1   g43(.a(x17), .O(new_n89_));
  nand3  g44(.a(new_n86_), .b(new_n89_), .c(new_n88_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n86_), .c(new_n47_), .d(new_n51_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x07), .O(z11));
  nand4  g49(.a(new_n86_), .b(x18), .c(x17), .d(new_n88_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n47_), .c(x15), .O(z12));
  nand2  g51(.a(new_n63_), .b(new_n51_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n56_), .c(new_n47_), .O(z13));
  nand3  g54(.a(new_n98_), .b(new_n58_), .c(new_n47_), .O(z14));
  nand3  g55(.a(new_n98_), .b(new_n59_), .c(new_n47_), .O(z15));
  nand3  g56(.a(new_n86_), .b(new_n79_), .c(new_n88_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n51_), .O(z16));
  nand3  g59(.a(new_n98_), .b(new_n54_), .c(new_n47_), .O(z17));
  nand3  g60(.a(new_n86_), .b(new_n55_), .c(new_n88_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n51_), .O(z18));
endmodule
