...
module FAU ( 
  ...
  nand2  g35(.a(new_n57_), .b(new_n53_), .O(new_n81_));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n52_), .c(new_n48_), .O(z08));
  nand3  g40(.a(new_n62_), .b(new_n47_), .c(new_n51_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(new_n61_), .b(new_n54_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n47_), .d(new_n51_), .O(new_n91_));
  ...
  nor2   g54(.a(new_n62_), .b(x07), .O(new_n100_));
  nor2   g55(.a(x20), .b(new_n56_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n47_), .O(z13));
  ...
  aoi21  g61(.a(new_n102_), .b(x21), .c(new_n106_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(x15), .c(new_n51_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n100_), .d(new_n47_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n104_), .c(new_n110_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n100_), .d(new_n47_), .O(z16));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n111_), .c(new_n101_), .d(new_n93_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n61_), .O(new_n120_));
  aoi21  g75(.a(new_n116_), .b(x24), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x15), .c(new_n51_), .O(z17));
  nor3   g77(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n111_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n102_), .c(new_n61_), .O(new_n125_));
  aoi21  g80(.a(new_n119_), .b(x25), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n51_), .O(z18));
endmodule
