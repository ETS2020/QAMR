...
module FAU ( 
  ...
  oai21  g04(.a(x15), .b(x04), .c(x05), .O(new_n50_));
  ...
  nand3  g15(.a(new_n60_), .b(new_n50_), .c(new_n49_), .O(z01));
  and2   g16(.a(new_n47_), .b(x16), .O(z02));
  nand3  g17(.a(new_n59_), .b(new_n47_), .c(new_n51_), .O(new_n63_));
  ...
  nand2  g32(.a(new_n56_), .b(new_n52_), .O(new_n78_));
  ...
  nand2  g39(.a(new_n49_), .b(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z09));
  nand2  g41(.a(x05), .b(x04), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n53_), .c(new_n84_), .d(new_n49_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n47_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n49_), .O(new_n91_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n87_), .d(new_n49_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  nand2  g57(.a(x15), .b(new_n83_), .O(new_n103_));
  ...
  nand3  g62(.a(new_n107_), .b(new_n87_), .c(new_n49_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n84_), .O(new_n109_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n87_), .c(new_n49_), .O(new_n114_));
  aoi21  g69(.a(new_n107_), .b(x22), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x15), .c(new_n103_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  aoi21  g72(.a(x05), .b(x04), .c(x07), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n106_), .c(new_n111_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .d(new_n84_), .O(z16));
  nand2  g76(.a(new_n120_), .b(x24), .O(new_n122_));
  inv1   g77(.a(new_n100_), .O(new_n123_));
  inv1   g78(.a(x24), .O(new_n124_));
  nand3  g79(.a(new_n112_), .b(new_n124_), .c(new_n77_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n118_), .d(new_n84_), .O(z17));
  oai21  g83(.a(new_n125_), .b(new_n100_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n112_), .c(new_n123_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n87_), .d(new_n49_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n84_), .O(new_n133_));
