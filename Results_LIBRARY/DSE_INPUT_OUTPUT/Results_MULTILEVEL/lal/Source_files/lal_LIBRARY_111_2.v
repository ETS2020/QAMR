...
module FAU ( 
  ...
  nor3   g34(.a(new_n79_), .b(x19), .c(x17), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(x15), .c(new_n54_), .O(new_n81_));
  inv1   g36(.a(x23), .O(new_n82_));
  oai21  g37(.a(new_n57_), .b(new_n52_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g48(.a(x19), .b(new_n53_), .O(new_n94_));
  nand3  g49(.a(new_n55_), .b(x18), .c(x17), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n94_), .c(x15), .O(new_n96_));
  nor2   g51(.a(new_n55_), .b(x18), .O(new_n97_));
  oai21  g52(.a(new_n97_), .b(new_n96_), .c(new_n61_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(x07), .c(new_n49_), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand2  g56(.a(new_n61_), .b(new_n86_), .O(new_n102_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n103_), .c(new_n101_), .d(new_n47_), .O(z13));
  nand2  g62(.a(new_n106_), .b(x21), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n104_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n103_), .d(new_n47_), .O(z14));
  nand2  g66(.a(x19), .b(x17), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n52_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n112_), .c(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x18), .O(new_n116_));
  aoi21  g71(.a(new_n110_), .b(x22), .c(new_n102_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(x15), .c(new_n116_), .O(z15));
  oai21  g73(.a(new_n114_), .b(new_n100_), .c(x23), .O(new_n119_));
  inv1   g74(.a(x22), .O(new_n120_));
  inv1   g75(.a(new_n100_), .O(new_n121_));
  nand4  g76(.a(new_n109_), .b(new_n121_), .c(new_n82_), .d(new_n120_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n119_), .c(new_n103_), .d(new_n47_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n113_), .c(new_n105_), .d(new_n104_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n103_), .d(new_n47_), .O(z17));
  nand3  g82(.a(new_n109_), .b(x19), .c(x17), .O(new_n128_));
  inv1   g83(.a(x24), .O(new_n129_));
  nand4  g84(.a(new_n51_), .b(new_n129_), .c(new_n82_), .d(new_n120_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n128_), .c(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(x18), .O(new_n132_));
  aoi21  g87(.a(new_n126_), .b(x25), .c(new_n102_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(x15), .c(new_n132_), .O(z18));
endmodule
