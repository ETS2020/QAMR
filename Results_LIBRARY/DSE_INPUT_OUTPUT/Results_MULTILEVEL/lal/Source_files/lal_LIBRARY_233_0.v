...
module FAU ( 
  ...
  nand3  g33(.a(new_n78_), .b(new_n48_), .c(new_n46_), .O(new_n79_));
  ...
  nor2   g60(.a(new_n100_), .b(new_n93_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n105_), .c(new_n55_), .d(new_n54_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x18), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n60_), .O(z14));
  inv1   g66(.a(x22), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(new_n106_), .c(new_n112_), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n106_), .c(new_n58_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n55_), .c(new_n54_), .O(new_n116_));
  ...
  nand3  g75(.a(new_n50_), .b(new_n112_), .c(new_n120_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(new_n102_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(new_n61_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n99_), .d(new_n60_), .O(z16));
  oai21  g79(.a(new_n121_), .b(new_n102_), .c(x24), .O(new_n125_));
  nor2   g80(.a(x20), .b(new_n100_), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n114_), .c(new_n126_), .d(x17), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n55_), .d(new_n54_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(x18), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n60_), .O(z17));
  nand4  g86(.a(new_n68_), .b(new_n50_), .c(new_n112_), .d(new_n120_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n102_), .c(x25), .O(new_n133_));
  nor2   g88(.a(x23), .b(x22), .O(new_n134_));
  nor2   g89(.a(x25), .b(x24), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n107_), .d(new_n106_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n55_), .d(new_n54_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(x18), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n60_), .O(z18));
  nor2   g94(.a(new_n94_), .b(x07), .O(z11));
endmodule
