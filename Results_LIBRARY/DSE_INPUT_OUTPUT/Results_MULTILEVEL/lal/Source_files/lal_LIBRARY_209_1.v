...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n62_), .c(new_n47_), .d(new_n85_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n62_), .c(new_n47_), .d(new_n85_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n62_), .d(new_n85_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  nand2  g57(.a(x15), .b(x06), .O(new_n103_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n64_), .d(new_n47_), .O(z14));
  ...
  nand4  g70(.a(new_n106_), .b(new_n110_), .c(new_n114_), .d(new_n80_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n62_), .c(new_n85_), .O(new_n117_));
  ...
  nand3  g77(.a(new_n122_), .b(new_n51_), .c(new_n114_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n64_), .d(new_n47_), .O(z17));
  ...
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n62_), .d(new_n85_), .O(new_n130_));
