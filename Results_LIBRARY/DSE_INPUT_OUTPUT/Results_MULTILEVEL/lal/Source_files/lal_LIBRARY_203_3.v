...
module FAU ( 
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n61_), .d(new_n48_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n64_), .O(z13));
  ...
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n108_), .d(new_n48_), .O(z16));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n113_), .c(new_n102_), .d(new_n95_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n61_), .c(new_n48_), .O(new_n124_));
  aoi21  g79(.a(new_n120_), .b(x24), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x07), .c(new_n64_), .O(z17));
  nand2  g81(.a(new_n123_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n113_), .c(new_n102_), .d(new_n95_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n108_), .d(new_n48_), .O(z18));
endmodule
