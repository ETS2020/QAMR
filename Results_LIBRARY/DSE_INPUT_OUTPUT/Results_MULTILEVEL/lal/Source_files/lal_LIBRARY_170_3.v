...
module FAU ( 
  ...
  nor2   g041(.a(x10), .b(new_n86_), .O(new_n87_));
  nor2   g042(.a(x15), .b(new_n47_), .O(new_n88_));
  aoi21  g043(.a(new_n88_), .b(new_n86_), .c(new_n87_), .O(new_n89_));
  aoi21  g044(.a(new_n89_), .b(new_n85_), .c(x08), .O(z04));
  oai21  g045(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  inv1   g046(.a(x08), .O(new_n92_));
  nand2  g047(.a(x14), .b(new_n92_), .O(new_n93_));
  nand2  g048(.a(new_n93_), .b(new_n50_), .O(z06));
  nand3  g049(.a(new_n50_), .b(new_n92_), .c(x06), .O(z07));
  ...
  nand2  g055(.a(new_n48_), .b(new_n100_), .O(new_n101_));
  oai21  g056(.a(new_n101_), .b(new_n66_), .c(new_n50_), .O(z09));
  nand4  g057(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n100_), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(new_n50_), .O(z10));
  xor2a  g059(.a(x18), .b(x17), .O(new_n105_));
  nand4  g060(.a(new_n105_), .b(new_n66_), .c(new_n48_), .d(new_n100_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z11));
  nor2   g062(.a(new_n57_), .b(new_n56_), .O(new_n108_));
  nand3  g063(.a(new_n58_), .b(x18), .c(x17), .O(new_n109_));
  oai21  g064(.a(new_n108_), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n66_), .c(new_n48_), .d(new_n100_), .O(new_n111_));
  nand2  g066(.a(new_n111_), .b(new_n50_), .O(z12));
  nand3  g067(.a(x19), .b(x18), .c(x17), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(x20), .O(new_n114_));
  nand4  g069(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n114_), .c(new_n66_), .d(new_n100_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n48_), .O(new_n117_));
  nand2  g072(.a(x15), .b(new_n47_), .O(new_n118_));
  nand2  g073(.a(new_n118_), .b(new_n117_), .O(z13));
  nand2  g074(.a(new_n115_), .b(x21), .O(new_n120_));
  aoi21  g075(.a(x05), .b(x04), .c(x07), .O(new_n121_));
  nand4  g076(.a(new_n108_), .b(new_n61_), .c(new_n55_), .d(x19), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n48_), .O(z14));
  nand2  g078(.a(new_n122_), .b(x22), .O(new_n124_));
  inv1   g079(.a(new_n113_), .O(new_n125_));
  nor2   g080(.a(x22), .b(x21), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n125_), .c(new_n55_), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n124_), .c(new_n121_), .d(new_n48_), .O(z15));
  nand2  g083(.a(new_n127_), .b(x23), .O(new_n129_));
  inv1   g084(.a(x23), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n62_), .c(new_n61_), .d(new_n55_), .O(new_n131_));
  inv1   g086(.a(new_n131_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n125_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n129_), .c(new_n121_), .d(new_n48_), .O(z16));
  oai21  g089(.a(new_n131_), .b(new_n113_), .c(x24), .O(new_n135_));
  nor2   g090(.a(x20), .b(new_n58_), .O(new_n136_));
  nor2   g091(.a(x24), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n126_), .c(new_n136_), .d(new_n108_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n135_), .c(new_n66_), .d(new_n100_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n48_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n118_), .O(z17));
  nand4  g096(.a(new_n53_), .b(new_n130_), .c(new_n62_), .d(new_n61_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n115_), .c(x25), .O(new_n143_));
  nor3   g098(.a(x25), .b(x24), .c(x23), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n126_), .c(new_n136_), .d(new_n108_), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n143_), .c(new_n66_), .d(new_n100_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n48_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n118_), .O(z18));
endmodule
