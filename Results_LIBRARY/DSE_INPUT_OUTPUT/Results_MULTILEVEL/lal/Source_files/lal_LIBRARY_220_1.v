...
module FAU ( 
  ...
  nand4  g17(.a(new_n62_), .b(new_n59_), .c(new_n58_), .d(new_n48_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nor2   g19(.a(new_n61_), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n62_), .b(new_n57_), .c(new_n49_), .O(new_n66_));
  ...
  nand3  g27(.a(new_n72_), .b(new_n60_), .c(new_n46_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(z04));
  aoi21  g29(.a(new_n60_), .b(x13), .c(x08), .O(z05));
  inv1   g30(.a(x14), .O(new_n76_));
  aoi21  g31(.a(new_n60_), .b(new_n76_), .c(x08), .O(z06));
  nand3  g32(.a(new_n60_), .b(new_n46_), .c(x06), .O(z07));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n49_), .c(new_n61_), .O(z08));
  nand2  g39(.a(new_n60_), .b(new_n48_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n59_), .c(new_n62_), .O(z09));
  nand4  g41(.a(new_n59_), .b(new_n51_), .c(new_n60_), .d(new_n48_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n62_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n59_), .c(new_n60_), .d(new_n48_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n62_), .O(z11));
  nor2   g46(.a(new_n52_), .b(new_n51_), .O(new_n92_));
  nand3  g47(.a(new_n53_), .b(x18), .c(x17), .O(new_n93_));
  oai21  g48(.a(new_n92_), .b(new_n53_), .c(new_n93_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n59_), .c(new_n60_), .d(new_n48_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n50_), .b(x19), .c(x18), .d(x17), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n60_), .O(z13));
  and2   g56(.a(new_n100_), .b(x21), .O(new_n102_));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n92_), .c(x19), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n59_), .c(new_n48_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(new_n102_), .c(new_n60_), .O(new_n106_));
  nand2  g61(.a(x15), .b(x08), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z14));
  nand2  g63(.a(new_n104_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n97_), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n50_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n99_), .d(new_n60_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  nand3  g70(.a(new_n103_), .b(new_n79_), .c(new_n115_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n110_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n99_), .d(new_n60_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n97_), .c(x24), .O(new_n120_));
  ...
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n59_), .d(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n60_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n107_), .O(z17));
  oai21  g83(.a(new_n123_), .b(new_n100_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n111_), .c(new_n121_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n59_), .d(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n60_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n107_), .O(z18));
endmodule
