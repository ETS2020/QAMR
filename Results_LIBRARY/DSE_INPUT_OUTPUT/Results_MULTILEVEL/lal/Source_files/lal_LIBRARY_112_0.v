...
module FAU ( 
  ...
  nand3  g37(.a(x15), .b(x14), .c(new_n46_), .O(new_n83_));
  ...
  aoi21  g46(.a(new_n91_), .b(x08), .c(x15), .O(z09));
  nand4  g47(.a(new_n61_), .b(new_n51_), .c(new_n75_), .d(x08), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x07), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n75_), .d(x08), .O(new_n96_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n61_), .c(new_n75_), .d(x08), .O(new_n102_));
  ...
  nand2  g62(.a(new_n107_), .b(x08), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n75_), .O(z13));
  nand2  g64(.a(new_n106_), .b(x21), .O(new_n110_));
  nor2   g65(.a(new_n62_), .b(x07), .O(new_n111_));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n99_), .c(x19), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n75_), .c(x08), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n111_), .c(new_n110_), .O(z14));
  nand3  g71(.a(new_n56_), .b(new_n50_), .c(x19), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n98_), .c(x22), .O(new_n118_));
  inv1   g73(.a(new_n104_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n50_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n61_), .d(new_n90_), .O(new_n122_));
  ...
  nand4  g81(.a(new_n112_), .b(new_n119_), .c(new_n126_), .d(new_n57_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n75_), .c(x08), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n111_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  nand4  g86(.a(new_n48_), .b(new_n126_), .c(new_n57_), .d(new_n56_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(new_n106_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(x15), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n131_), .c(new_n111_), .d(x08), .O(z17));
  ...
  nand4  g93(.a(new_n138_), .b(new_n120_), .c(new_n137_), .d(new_n99_), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n136_), .c(new_n61_), .d(new_n90_), .O(new_n140_));
  nand2  g95(.a(new_n140_), .b(x08), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(new_n75_), .O(z18));
endmodule
