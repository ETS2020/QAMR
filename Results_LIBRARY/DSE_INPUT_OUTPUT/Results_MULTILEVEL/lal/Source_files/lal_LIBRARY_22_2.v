...
module FAU ( 
  ...
  oai21  g25(.a(x09), .b(x08), .c(x15), .O(new_n71_));
  nand2  g26(.a(new_n71_), .b(x00), .O(new_n72_));
  nand2  g27(.a(x09), .b(new_n47_), .O(new_n73_));
  ...
  nand2  g33(.a(new_n78_), .b(new_n72_), .O(z04));
  oai21  g34(.a(x13), .b(x08), .c(new_n69_), .O(z05));
  inv1   g35(.a(x14), .O(new_n81_));
  nor3   g36(.a(new_n48_), .b(new_n81_), .c(x08), .O(z06));
  nand3  g37(.a(new_n69_), .b(new_n46_), .c(x06), .O(z07));
  ...
  oai21  g41(.a(new_n85_), .b(new_n50_), .c(new_n86_), .O(z08));
  inv1   g42(.a(x07), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(x05), .c(x04), .d(new_n47_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x15), .O(z09));
  inv1   g45(.a(x15), .O(new_n91_));
  nand4  g46(.a(new_n63_), .b(new_n53_), .c(new_n91_), .d(new_n88_), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(x00), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n63_), .c(new_n88_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n63_), .c(new_n91_), .d(new_n88_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(x00), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nor2   g58(.a(new_n64_), .b(x00), .O(new_n104_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n104_), .c(new_n103_), .d(new_n88_), .O(z13));
  aoi21  g64(.a(new_n105_), .b(new_n97_), .c(new_n58_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n97_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n63_), .c(new_n88_), .O(new_n113_));
  ...
  nand2  g72(.a(new_n59_), .b(new_n58_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(x20), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n63_), .d(new_n88_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n91_), .O(z15));
  inv1   g78(.a(x23), .O(new_n124_));
  aoi21  g79(.a(new_n119_), .b(new_n117_), .c(new_n124_), .O(new_n125_));
  nand4  g80(.a(new_n111_), .b(new_n117_), .c(new_n124_), .d(new_n59_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n63_), .c(new_n88_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n125_), .c(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n91_), .O(z16));
  ...
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n63_), .d(new_n88_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n91_), .O(z17));
  nand2  g91(.a(new_n133_), .b(x25), .O(new_n137_));
  nand3  g92(.a(new_n51_), .b(new_n50_), .c(new_n124_), .O(new_n138_));
  nor2   g93(.a(new_n138_), .b(new_n118_), .O(new_n139_));
  aoi21  g94(.a(new_n139_), .b(new_n107_), .c(x15), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n137_), .c(new_n104_), .d(new_n88_), .O(z18));
endmodule
