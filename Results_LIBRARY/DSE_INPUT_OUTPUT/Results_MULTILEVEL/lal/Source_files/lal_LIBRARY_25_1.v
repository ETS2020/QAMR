...
module FAU ( 
  ...
  nand2  g42(.a(new_n61_), .b(new_n52_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n47_), .d(new_n60_), .O(new_n91_));
  ...
  nand2  g57(.a(new_n102_), .b(new_n60_), .O(z13));
  ...
  nand2  g63(.a(new_n108_), .b(new_n60_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n110_), .d(new_n47_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand3  g72(.a(new_n105_), .b(new_n117_), .c(new_n82_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n112_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n111_), .d(new_n47_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n98_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x20), .b(new_n54_), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n113_), .c(new_n123_), .d(new_n93_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n61_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n60_), .O(z17));
  nand2  g83(.a(new_n124_), .b(new_n113_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n100_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n113_), .c(new_n123_), .d(new_n93_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n61_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n60_), .O(z18));
endmodule
