...
module FAU ( 
  ...
  nand3  g40(.a(new_n61_), .b(new_n85_), .c(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n60_), .b(new_n53_), .c(new_n85_), .d(new_n47_), .O(new_n88_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n60_), .c(new_n85_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n85_), .O(z14));
  ...
  oai21  g68(.a(new_n113_), .b(x07), .c(new_n85_), .O(z15));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n105_), .d(new_n85_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n100_), .O(new_n120_));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n110_), .O(new_n122_));
  ...
  nand3  g84(.a(new_n129_), .b(new_n110_), .c(new_n120_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n105_), .d(new_n85_), .O(z18));
endmodule
