...
module FAU ( 
  ...
  aoi22  g021(.a(x22), .b(x21), .c(x19), .d(new_n48_), .O(new_n67_));
  ...
  nand3  g047(.a(new_n57_), .b(new_n90_), .c(new_n56_), .O(new_n93_));
  aoi21  g048(.a(new_n93_), .b(new_n61_), .c(x17), .O(z10));
  nand2  g049(.a(new_n83_), .b(x17), .O(new_n95_));
  oai21  g050(.a(new_n62_), .b(x17), .c(new_n95_), .O(new_n96_));
  nand4  g051(.a(new_n96_), .b(new_n57_), .c(new_n90_), .d(new_n56_), .O(new_n97_));
  inv1   g052(.a(new_n97_), .O(z11));
  nand2  g053(.a(x19), .b(new_n83_), .O(new_n99_));
  oai21  g054(.a(new_n62_), .b(new_n48_), .c(new_n99_), .O(new_n100_));
  nand4  g055(.a(new_n100_), .b(new_n57_), .c(new_n90_), .d(new_n56_), .O(new_n101_));
  nand2  g056(.a(new_n101_), .b(new_n49_), .O(z12));
  inv1   g057(.a(new_n57_), .O(new_n103_));
  oai21  g058(.a(new_n91_), .b(new_n103_), .c(new_n49_), .O(new_n104_));
  nor2   g059(.a(new_n60_), .b(x18), .O(new_n105_));
  nand3  g060(.a(new_n60_), .b(x19), .c(x18), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(new_n107_));
  oai21  g062(.a(new_n107_), .b(new_n105_), .c(x17), .O(new_n108_));
  nand2  g063(.a(x20), .b(new_n61_), .O(new_n109_));
  nand3  g064(.a(new_n109_), .b(new_n108_), .c(new_n104_), .O(z13));
  inv1   g065(.a(new_n58_), .O(new_n111_));
  oai21  g066(.a(x21), .b(x19), .c(new_n48_), .O(new_n112_));
  nand2  g067(.a(new_n106_), .b(x21), .O(new_n113_));
  and2   g068(.a(x19), .b(x18), .O(new_n114_));
  nor2   g069(.a(x21), .b(x20), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n114_), .c(x15), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(z14));
  inv1   g072(.a(x21), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n60_), .c(x18), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(x22), .O(new_n120_));
  nor2   g075(.a(x22), .b(x21), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n114_), .c(new_n60_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(x17), .O(new_n124_));
  nand2  g079(.a(x22), .b(new_n61_), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n124_), .c(new_n104_), .O(z15));
  nor2   g081(.a(x20), .b(new_n83_), .O(new_n127_));
  aoi21  g082(.a(new_n127_), .b(new_n121_), .c(new_n52_), .O(new_n128_));
  nor2   g083(.a(x23), .b(x22), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n118_), .O(new_n130_));
  nor2   g085(.a(new_n130_), .b(new_n106_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(new_n128_), .c(x17), .O(new_n132_));
  nand2  g087(.a(x23), .b(new_n61_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n132_), .c(new_n104_), .O(z16));
  oai21  g089(.a(x24), .b(x19), .c(new_n48_), .O(new_n135_));
  oai21  g090(.a(new_n130_), .b(new_n106_), .c(x24), .O(new_n136_));
  nand3  g091(.a(new_n121_), .b(new_n69_), .c(new_n52_), .O(new_n137_));
  inv1   g092(.a(new_n137_), .O(new_n138_));
  aoi21  g093(.a(new_n138_), .b(new_n107_), .c(x15), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n136_), .c(new_n135_), .d(new_n111_), .O(z17));
  inv1   g095(.a(x22), .O(new_n141_));
  nand3  g096(.a(new_n69_), .b(new_n52_), .c(new_n141_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n119_), .c(x25), .O(new_n143_));
  nor2   g098(.a(x25), .b(x24), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n129_), .c(new_n115_), .d(new_n114_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(x17), .O(new_n147_));
  nand2  g102(.a(x25), .b(new_n61_), .O(new_n148_));
  nand3  g103(.a(new_n148_), .b(new_n147_), .c(new_n104_), .O(z18));
endmodule
