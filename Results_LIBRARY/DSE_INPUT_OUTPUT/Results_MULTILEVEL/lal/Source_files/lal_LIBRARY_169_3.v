...
module FAU ( 
  ...
  nand3  g20(.a(new_n64_), .b(new_n57_), .c(new_n49_), .O(new_n66_));
  ...
  oai21  g41(.a(new_n86_), .b(new_n59_), .c(new_n64_), .O(z09));
  nand4  g42(.a(new_n59_), .b(new_n51_), .c(new_n47_), .d(new_n85_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n59_), .c(new_n47_), .d(new_n85_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n47_), .d(new_n85_), .O(new_n96_));
  ...
  aoi21  g59(.a(new_n101_), .b(new_n93_), .c(new_n104_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n93_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n59_), .c(new_n85_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n47_), .O(new_n109_));
  nand2  g64(.a(x15), .b(new_n46_), .O(new_n110_));
  ...
  nand4  g73(.a(new_n118_), .b(new_n80_), .c(new_n104_), .d(new_n50_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n113_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n100_), .d(new_n47_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n98_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n114_), .c(new_n101_), .d(new_n93_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n59_), .d(new_n85_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n110_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n114_), .c(new_n101_), .d(new_n93_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n100_), .d(new_n47_), .O(z18));
endmodule
