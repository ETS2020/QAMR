...
module FAU ( 
  ...
  aoi21  g31(.a(new_n66_), .b(x06), .c(new_n62_), .O(z07));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(new_n62_), .O(z08));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n60_), .d(new_n86_), .O(z13));
  ...
  nand3  g62(.a(new_n107_), .b(new_n84_), .c(new_n86_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n85_), .O(new_n109_));
  nand2  g64(.a(new_n86_), .b(x07), .O(new_n110_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n112_), .c(new_n60_), .O(z15));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(new_n78_), .O(new_n117_));
  inv1   g72(.a(x22), .O(new_n118_));
  nand4  g73(.a(new_n106_), .b(new_n113_), .c(new_n78_), .d(new_n118_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n84_), .c(new_n86_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n117_), .c(new_n85_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n110_), .O(z16));
  nand3  g77(.a(new_n106_), .b(new_n78_), .c(new_n118_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n99_), .c(x24), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n101_), .d(new_n94_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n84_), .d(new_n86_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n85_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n110_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n125_), .c(new_n101_), .d(new_n94_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n60_), .d(new_n86_), .O(z18));
endmodule
