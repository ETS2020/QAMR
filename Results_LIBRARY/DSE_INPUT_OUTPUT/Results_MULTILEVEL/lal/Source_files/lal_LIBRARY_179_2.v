...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n60_), .c(new_n90_), .d(new_n47_), .O(new_n92_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n86_), .d(new_n90_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n86_), .d(new_n90_), .O(z14));
  ...
  nor2   g66(.a(new_n111_), .b(new_n61_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n108_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n90_), .O(z15));
  nor2   g70(.a(new_n111_), .b(new_n80_), .O(new_n116_));
  ...
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n86_), .d(new_n90_), .O(z17));
  oai21  g82(.a(new_n125_), .b(new_n102_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n109_), .c(new_n101_), .d(new_n94_), .O(new_n130_));
