...
module FAU ( 
  ...
  and2   g19(.a(new_n64_), .b(new_n60_), .O(new_n65_));
  nand4  g20(.a(new_n65_), .b(new_n52_), .c(new_n59_), .d(x15), .O(new_n66_));
  nand2  g21(.a(new_n66_), .b(new_n58_), .O(z01));
  inv1   g22(.a(x16), .O(new_n68_));
  nand2  g23(.a(new_n48_), .b(new_n68_), .O(z02));
  inv1   g24(.a(x24), .O(new_n70_));
  nor2   g25(.a(new_n51_), .b(new_n50_), .O(new_n71_));
  nand2  g26(.a(new_n64_), .b(new_n59_), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(new_n71_), .c(x23), .O(new_n73_));
  oai21  g28(.a(new_n73_), .b(new_n70_), .c(new_n60_), .O(new_n74_));
  ...
  nand3  g35(.a(new_n80_), .b(new_n48_), .c(new_n46_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z04));
  nor3   g37(.a(new_n47_), .b(x13), .c(x08), .O(z05));
  nand2  g38(.a(x14), .b(new_n46_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n48_), .O(z06));
  nand3  g40(.a(new_n48_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g41(.a(new_n64_), .b(new_n59_), .c(new_n51_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x21), .c(x23), .O(new_n88_));
  nor2   g43(.a(new_n47_), .b(x25), .O(new_n89_));
  oai21  g44(.a(new_n88_), .b(new_n70_), .c(new_n89_), .O(z08));
  nand3  g45(.a(new_n55_), .b(x05), .c(x04), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(x20), .c(x15), .O(z09));
  nand3  g47(.a(new_n56_), .b(new_n61_), .c(new_n55_), .O(new_n93_));
  ...
  aoi21  g51(.a(new_n96_), .b(x20), .c(x15), .O(z11));
  ...
  nand4  g56(.a(new_n101_), .b(new_n56_), .c(x20), .d(new_n55_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(x20), .c(x15), .O(z12));
  inv1   g58(.a(x15), .O(new_n104_));
  nand4  g59(.a(new_n98_), .b(new_n56_), .c(x19), .d(new_n104_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n56_), .c(x19), .d(new_n55_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n104_), .O(z13));
  inv1   g63(.a(new_n57_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n50_), .c(x20), .d(new_n104_), .O(z14));
  nand3  g65(.a(new_n56_), .b(new_n51_), .c(new_n55_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x20), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n104_), .O(z15));
  nand3  g68(.a(new_n56_), .b(new_n52_), .c(new_n55_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x20), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n104_), .O(z16));
  nand3  g71(.a(new_n56_), .b(new_n70_), .c(new_n55_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(x20), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n104_), .O(z17));
  nand3  g74(.a(new_n56_), .b(new_n60_), .c(new_n55_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x20), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n104_), .O(z18));
endmodule
