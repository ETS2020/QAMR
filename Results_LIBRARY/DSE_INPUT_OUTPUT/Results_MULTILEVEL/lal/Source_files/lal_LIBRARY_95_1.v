...
module FAU ( 
  ...
  oai21  g18(.a(new_n63_), .b(new_n53_), .c(new_n48_), .O(new_n64_));
  nand2  g19(.a(x05), .b(x04), .O(new_n65_));
  inv1   g20(.a(new_n65_), .O(new_n66_));
  nor3   g21(.a(new_n66_), .b(new_n49_), .c(x07), .O(new_n67_));
  ...
  nand3  g38(.a(new_n83_), .b(new_n48_), .c(x24), .O(new_n84_));
  nand2  g39(.a(x25), .b(x15), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n84_), .O(z08));
  nor4   g41(.a(new_n65_), .b(x25), .c(x15), .d(x07), .O(z09));
  inv1   g42(.a(x07), .O(new_n88_));
  nand3  g43(.a(new_n65_), .b(new_n55_), .c(new_n88_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n48_), .c(x15), .O(z10));
  inv1   g45(.a(x15), .O(new_n91_));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n65_), .c(new_n48_), .d(new_n91_), .O(new_n93_));
  ...
  nand3  g52(.a(new_n97_), .b(new_n65_), .c(new_n88_), .O(new_n98_));
  ...
  nor2   g56(.a(new_n66_), .b(x07), .O(new_n102_));
  nor2   g57(.a(x20), .b(new_n57_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n95_), .c(x25), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n91_), .O(z13));
  ...
  nand3  g66(.a(new_n111_), .b(new_n107_), .c(new_n102_), .O(z14));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n102_), .d(new_n91_), .O(z15));
  aoi21  g72(.a(new_n115_), .b(new_n114_), .c(new_n81_), .O(new_n118_));
  nand4  g73(.a(new_n108_), .b(new_n114_), .c(new_n81_), .d(new_n61_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n65_), .c(new_n88_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n91_), .O(z16));
  nand4  g77(.a(new_n81_), .b(new_n61_), .c(new_n60_), .d(new_n54_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n100_), .c(x24), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n103_), .d(new_n95_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n65_), .d(new_n88_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n91_), .O(z17));
  nand2  g85(.a(new_n127_), .b(new_n88_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n66_), .c(new_n48_), .O(new_n132_));
