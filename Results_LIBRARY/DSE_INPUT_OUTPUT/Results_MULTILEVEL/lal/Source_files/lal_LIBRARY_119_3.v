...
module FAU ( 
  ...
  aoi21  g31(.a(new_n65_), .b(x06), .c(new_n76_), .O(z07));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n51_), .c(new_n76_), .O(z08));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n83_), .d(new_n85_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  nand2  g57(.a(new_n85_), .b(x07), .O(new_n103_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n61_), .d(new_n85_), .O(z14));
  inv1   g63(.a(new_n98_), .O(new_n109_));
  nor3   g64(.a(x22), .b(x21), .c(x20), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n83_), .c(new_n85_), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(x22), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(x07), .c(new_n103_), .O(z15));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n78_), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n106_), .c(new_n109_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n83_), .c(new_n85_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n115_), .c(new_n84_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n103_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  inv1   g76(.a(new_n100_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n50_), .c(new_n78_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n121_), .c(new_n61_), .d(new_n85_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n83_), .d(new_n85_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n84_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n103_), .O(z18));
endmodule
