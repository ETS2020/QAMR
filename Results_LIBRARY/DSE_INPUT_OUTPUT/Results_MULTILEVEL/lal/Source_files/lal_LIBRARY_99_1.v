...
module FAU ( 
  ...
  nand4  g17(.a(new_n62_), .b(new_n61_), .c(new_n47_), .d(new_n50_), .O(z01));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n52_), .c(new_n48_), .O(z08));
  inv1   g38(.a(new_n62_), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(new_n47_), .c(new_n50_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z09));
  nand2  g41(.a(new_n62_), .b(new_n54_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n62_), .c(new_n47_), .d(new_n50_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n62_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n50_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n92_), .c(x19), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n62_), .O(new_n105_));
  ...
  aoi21  g65(.a(new_n110_), .b(new_n109_), .c(new_n84_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n50_), .O(z15));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n79_), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n103_), .c(new_n109_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n62_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n115_), .c(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n50_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  inv1   g76(.a(new_n99_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n51_), .c(new_n79_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n122_), .c(x15), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n121_), .c(new_n62_), .d(new_n50_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n99_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n123_), .c(new_n122_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n62_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n50_), .O(z18));
endmodule
