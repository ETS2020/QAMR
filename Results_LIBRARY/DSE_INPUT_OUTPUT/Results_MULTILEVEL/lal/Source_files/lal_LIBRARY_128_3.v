...
module FAU ( 
  ...
  nor2   g56(.a(new_n63_), .b(x07), .O(new_n102_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n62_), .c(new_n48_), .O(new_n109_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n112_), .c(new_n102_), .O(z15));
  nor2   g72(.a(new_n115_), .b(new_n82_), .O(new_n118_));
  inv1   g73(.a(new_n100_), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n107_), .c(new_n119_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n62_), .c(new_n48_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n118_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n65_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  inv1   g80(.a(x24), .O(new_n126_));
  nand3  g81(.a(new_n113_), .b(new_n126_), .c(new_n82_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n103_), .c(new_n95_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n62_), .d(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n65_), .O(z17));
  oai21  g87(.a(new_n127_), .b(new_n104_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n113_), .c(new_n103_), .d(new_n95_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n62_), .d(new_n48_), .O(new_n136_));
