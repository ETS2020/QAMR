...
module FAU ( 
  ...
  nand4  g17(.a(new_n62_), .b(new_n61_), .c(new_n47_), .d(new_n51_), .O(z01));
  ...
  nand2  g34(.a(new_n57_), .b(new_n53_), .O(new_n80_));
  ...
  inv1   g39(.a(new_n62_), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n47_), .c(new_n51_), .O(new_n86_));
  ...
  nand4  g45(.a(new_n90_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n96_));
  ...
  nand3  g55(.a(new_n93_), .b(new_n53_), .c(x19), .O(new_n101_));
  ...
  aoi21  g64(.a(new_n109_), .b(new_n108_), .c(new_n85_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n51_), .O(z15));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n79_), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n104_), .c(new_n108_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n62_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n114_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n51_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n120_), .c(new_n100_), .d(new_n47_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n100_), .d(new_n47_), .O(z18));
endmodule
