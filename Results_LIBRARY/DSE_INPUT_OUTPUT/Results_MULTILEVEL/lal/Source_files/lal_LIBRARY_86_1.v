...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n50_), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n50_), .d(new_n47_), .O(new_n96_));
  ...
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n85_), .O(new_n112_));
  ...
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n50_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  nor2   g77(.a(new_n85_), .b(x07), .O(new_n123_));
  inv1   g78(.a(new_n100_), .O(new_n124_));
  ...
  nand4  g84(.a(new_n129_), .b(new_n123_), .c(new_n122_), .d(new_n50_), .O(z17));
  ...
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n123_), .d(new_n50_), .O(z18));
endmodule
