...
module FAU ( 
  ...
  nand2  g018(.a(new_n48_), .b(x18), .O(new_n64_));
  ...
  aoi22  g023(.a(x22), .b(x21), .c(x19), .d(new_n63_), .O(new_n69_));
  ...
  nand3  g049(.a(new_n59_), .b(new_n92_), .c(new_n58_), .O(new_n95_));
  aoi21  g050(.a(new_n95_), .b(new_n48_), .c(x17), .O(z10));
  xor2a  g051(.a(x18), .b(x17), .O(new_n97_));
  nand4  g052(.a(new_n97_), .b(new_n59_), .c(new_n92_), .d(new_n58_), .O(new_n98_));
  nand2  g053(.a(new_n98_), .b(new_n50_), .O(z11));
  inv1   g054(.a(x18), .O(new_n100_));
  nand2  g055(.a(x19), .b(new_n100_), .O(new_n101_));
  oai21  g056(.a(new_n64_), .b(new_n63_), .c(new_n101_), .O(new_n102_));
  nand4  g057(.a(new_n102_), .b(new_n59_), .c(new_n92_), .d(new_n58_), .O(new_n103_));
  ...
  nor2   g061(.a(new_n62_), .b(x18), .O(new_n107_));
  ...
  nor2   g067(.a(x20), .b(new_n100_), .O(new_n113_));
  and2   g068(.a(x19), .b(x18), .O(new_n114_));
  nor2   g069(.a(x21), .b(x20), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  oai21  g071(.a(new_n113_), .b(new_n53_), .c(new_n116_), .O(new_n117_));
  nand2  g072(.a(new_n117_), .b(x17), .O(new_n118_));
  nand2  g073(.a(x21), .b(new_n48_), .O(new_n119_));
  nand3  g074(.a(new_n119_), .b(new_n118_), .c(new_n106_), .O(z14));
  nand3  g075(.a(new_n53_), .b(new_n62_), .c(x18), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(x22), .O(new_n122_));
  nor2   g077(.a(x22), .b(x21), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n114_), .c(new_n62_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(x17), .O(new_n126_));
  nand2  g081(.a(x22), .b(new_n48_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n126_), .c(new_n106_), .O(z15));
  aoi21  g083(.a(new_n123_), .b(new_n113_), .c(new_n55_), .O(new_n129_));
  ...
  nand3  g089(.a(new_n134_), .b(new_n133_), .c(new_n106_), .O(z16));
  inv1   g090(.a(new_n60_), .O(new_n136_));
  oai21  g091(.a(x24), .b(x19), .c(new_n63_), .O(new_n137_));
  oai21  g092(.a(new_n131_), .b(new_n108_), .c(x24), .O(new_n138_));
  nand3  g093(.a(new_n123_), .b(new_n71_), .c(new_n55_), .O(new_n139_));
  inv1   g094(.a(new_n139_), .O(new_n140_));
  aoi21  g095(.a(new_n140_), .b(new_n109_), .c(x15), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(z17));
  nand3  g097(.a(new_n71_), .b(new_n55_), .c(new_n54_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(new_n121_), .c(x25), .O(new_n144_));
  nor2   g099(.a(x25), .b(x24), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n130_), .c(new_n115_), .d(new_n114_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(x17), .O(new_n148_));
  nand2  g103(.a(x25), .b(new_n48_), .O(new_n149_));
  nand3  g104(.a(new_n149_), .b(new_n148_), .c(new_n106_), .O(z18));
endmodule
