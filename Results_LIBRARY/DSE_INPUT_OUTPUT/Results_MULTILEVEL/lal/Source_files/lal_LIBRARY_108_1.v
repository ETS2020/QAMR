...
module FAU ( 
  ...
  aoi21  g41(.a(new_n61_), .b(new_n47_), .c(x07), .O(z09));
  nand4  g42(.a(new_n61_), .b(new_n52_), .c(new_n47_), .d(new_n60_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n61_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n47_), .c(x07), .O(z11));
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n47_), .d(new_n60_), .O(new_n96_));
  ...
  nor2   g55(.a(x20), .b(new_n54_), .O(new_n101_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n100_), .d(new_n47_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n100_), .O(z15));
  inv1   g67(.a(x23), .O(new_n113_));
  aoi21  g68(.a(new_n110_), .b(new_n109_), .c(new_n113_), .O(new_n114_));
  nand3  g69(.a(new_n105_), .b(new_n113_), .c(new_n82_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n98_), .c(new_n61_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n60_), .O(z16));
  oai21  g73(.a(new_n115_), .b(new_n98_), .c(x24), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n120_), .c(new_n101_), .d(new_n93_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n61_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n60_), .O(z17));
  nand2  g80(.a(new_n122_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n120_), .c(new_n101_), .d(new_n93_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n100_), .d(new_n47_), .O(z18));
endmodule
