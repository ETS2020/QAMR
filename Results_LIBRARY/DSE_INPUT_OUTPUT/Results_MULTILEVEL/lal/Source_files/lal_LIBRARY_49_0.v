...
module FAU ( 
  ...
  nor2   g002(.a(x17), .b(x09), .O(new_n48_));
  ...
  inv1   g016(.a(x09), .O(new_n62_));
  inv1   g017(.a(x17), .O(new_n63_));
  nor2   g018(.a(x19), .b(x18), .O(new_n64_));
  oai21  g019(.a(new_n64_), .b(new_n62_), .c(new_n63_), .O(new_n65_));
  nand4  g020(.a(new_n65_), .b(new_n52_), .c(new_n53_), .d(new_n61_), .O(new_n66_));
  oai21  g021(.a(new_n60_), .b(new_n48_), .c(new_n66_), .O(z01));
  nand2  g022(.a(new_n56_), .b(new_n49_), .O(new_n68_));
  nand3  g023(.a(new_n65_), .b(new_n53_), .c(new_n61_), .O(new_n69_));
  aoi21  g024(.a(new_n69_), .b(new_n68_), .c(x25), .O(z03));
  aoi21  g025(.a(new_n46_), .b(x00), .c(new_n63_), .O(new_n71_));
  ...
  oai21  g033(.a(new_n71_), .b(x09), .c(new_n78_), .O(z04));
  ...
  aoi21  g040(.a(new_n85_), .b(new_n64_), .c(new_n62_), .O(new_n86_));
  oai21  g041(.a(new_n54_), .b(new_n61_), .c(new_n53_), .O(new_n87_));
  aoi21  g042(.a(new_n87_), .b(x24), .c(x25), .O(new_n88_));
  oai21  g043(.a(new_n86_), .b(x17), .c(new_n88_), .O(z08));
  inv1   g044(.a(x15), .O(new_n90_));
  nand2  g045(.a(new_n90_), .b(new_n57_), .O(new_n91_));
  oai21  g046(.a(new_n91_), .b(new_n58_), .c(new_n49_), .O(z09));
  nand4  g047(.a(new_n58_), .b(new_n63_), .c(new_n90_), .d(x09), .O(new_n93_));
  nor2   g048(.a(new_n93_), .b(x07), .O(z10));
  nand3  g049(.a(x18), .b(new_n63_), .c(x09), .O(new_n95_));
  oai21  g050(.a(x18), .b(new_n63_), .c(new_n95_), .O(new_n96_));
  nand4  g051(.a(new_n96_), .b(new_n58_), .c(new_n90_), .d(new_n57_), .O(new_n97_));
  inv1   g052(.a(new_n97_), .O(z11));
  xnor2a g053(.a(x19), .b(x18), .O(new_n99_));
  nand3  g054(.a(x19), .b(new_n63_), .c(x09), .O(new_n100_));
  oai21  g055(.a(new_n99_), .b(new_n63_), .c(new_n100_), .O(new_n101_));
  nand4  g056(.a(new_n101_), .b(new_n58_), .c(new_n90_), .d(new_n57_), .O(new_n102_));
  inv1   g057(.a(new_n102_), .O(z12));
  oai21  g058(.a(x20), .b(new_n62_), .c(new_n63_), .O(new_n104_));
  nand3  g059(.a(new_n58_), .b(new_n90_), .c(new_n57_), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  and2   g061(.a(x19), .b(x18), .O(new_n107_));
  nand3  g062(.a(new_n61_), .b(x19), .c(x18), .O(new_n108_));
  oai21  g063(.a(new_n107_), .b(new_n61_), .c(new_n108_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(x17), .O(new_n110_));
  nand3  g065(.a(x20), .b(new_n63_), .c(x09), .O(new_n111_));
  nand3  g066(.a(new_n111_), .b(new_n110_), .c(new_n106_), .O(z13));
  oai21  g067(.a(x21), .b(new_n62_), .c(new_n63_), .O(new_n113_));
  ...
  nand3  g075(.a(x21), .b(new_n63_), .c(x09), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n120_), .c(new_n114_), .O(z14));
  inv1   g077(.a(new_n59_), .O(new_n123_));
  oai21  g078(.a(x22), .b(new_n62_), .c(new_n63_), .O(new_n124_));
  ...
  oai21  g085(.a(x23), .b(new_n62_), .c(new_n63_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n105_), .O(new_n132_));
  aoi21  g087(.a(new_n128_), .b(new_n107_), .c(new_n53_), .O(new_n133_));
  ...
  nand3  g092(.a(x23), .b(new_n63_), .c(x09), .O(new_n138_));
  nand3  g093(.a(new_n138_), .b(new_n137_), .c(new_n132_), .O(z16));
  oai21  g094(.a(x24), .b(new_n62_), .c(new_n63_), .O(new_n140_));
  oai21  g095(.a(new_n135_), .b(new_n108_), .c(x24), .O(new_n141_));
  nand4  g096(.a(new_n61_), .b(x19), .c(x18), .d(x17), .O(new_n142_));
  inv1   g097(.a(x22), .O(new_n143_));
  inv1   g098(.a(x24), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n53_), .c(new_n143_), .d(new_n115_), .O(new_n145_));
  ...
  oai21  g103(.a(x25), .b(new_n62_), .c(new_n63_), .O(new_n149_));
  ...
  nand3  g110(.a(x25), .b(new_n63_), .c(x09), .O(new_n156_));
