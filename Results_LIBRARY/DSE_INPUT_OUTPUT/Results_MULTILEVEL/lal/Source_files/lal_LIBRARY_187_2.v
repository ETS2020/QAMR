...
module FAU ( 
  ...
  nand2  g43(.a(new_n61_), .b(new_n53_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n61_), .c(new_n86_), .d(new_n47_), .O(new_n92_));
  ...
  nand2  g51(.a(new_n96_), .b(new_n61_), .O(new_n97_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n63_), .d(new_n86_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n63_), .d(new_n86_), .O(z15));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n63_), .d(new_n86_), .O(z16));
  ...
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n63_), .d(new_n86_), .O(z17));
  ...
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n63_), .d(new_n86_), .O(z18));
endmodule
