...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(new_n47_), .c(new_n49_), .O(new_n62_));
  ...
  nand2  g31(.a(new_n54_), .b(new_n50_), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(x22), .c(x21), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(x24), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n49_), .c(new_n75_), .O(z08));
  ...
  nand4  g41(.a(new_n82_), .b(new_n51_), .c(new_n84_), .d(new_n83_), .O(new_n87_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n82_), .c(new_n84_), .d(new_n83_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n92_), .b(new_n50_), .c(x19), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n98_), .c(new_n59_), .d(new_n84_), .O(z13));
  nand2  g55(.a(new_n99_), .b(x21), .O(new_n101_));
  nor2   g56(.a(x21), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n92_), .c(x19), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n59_), .d(new_n84_), .O(z14));
  nand2  g59(.a(new_n103_), .b(x22), .O(new_n105_));
  inv1   g60(.a(new_n97_), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n50_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n105_), .c(new_n59_), .d(new_n84_), .O(z15));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n59_), .d(new_n84_), .O(z16));
  ...
  nand4  g74(.a(new_n119_), .b(new_n114_), .c(new_n59_), .d(new_n84_), .O(z17));
  ...
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n59_), .d(new_n84_), .O(z18));
endmodule
