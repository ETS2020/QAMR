...
module FAU ( 
  ...
  nand2  g23(.a(new_n64_), .b(new_n50_), .O(z03));
  ...
  nand3  g38(.a(new_n60_), .b(x22), .c(x21), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(new_n53_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x25), .c(new_n47_), .O(new_n86_));
  oai21  g41(.a(new_n53_), .b(new_n83_), .c(new_n54_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n48_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n86_), .O(z08));
  nand4  g44(.a(new_n47_), .b(new_n52_), .c(x05), .d(x04), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand4  g46(.a(new_n65_), .b(new_n56_), .c(new_n47_), .d(new_n52_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n50_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n65_), .c(new_n47_), .d(new_n52_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n65_), .c(new_n47_), .d(new_n52_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n50_), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n97_), .b(new_n55_), .c(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n65_), .d(new_n52_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n48_), .b(x15), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z13));
  and2   g63(.a(new_n104_), .b(x21), .O(new_n109_));
  nand4  g64(.a(new_n97_), .b(new_n61_), .c(new_n55_), .d(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n65_), .c(new_n52_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n109_), .c(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n107_), .O(z14));
  nand2  g68(.a(new_n110_), .b(x22), .O(new_n114_));
  nand2  g69(.a(new_n65_), .b(new_n52_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  inv1   g71(.a(new_n102_), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n55_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n114_), .d(new_n47_), .O(z15));
  nand3  g75(.a(new_n83_), .b(new_n61_), .c(new_n55_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n102_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n48_), .O(new_n123_));
  aoi21  g78(.a(new_n119_), .b(x23), .c(new_n115_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x15), .c(new_n123_), .O(z16));
  nand4  g80(.a(new_n83_), .b(new_n48_), .c(new_n61_), .d(new_n55_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n102_), .c(x24), .O(new_n127_));
  inv1   g82(.a(new_n104_), .O(new_n128_));
  nand4  g83(.a(new_n118_), .b(new_n128_), .c(new_n53_), .d(new_n83_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n116_), .d(new_n47_), .O(z17));
  nand2  g85(.a(new_n129_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n118_), .c(new_n128_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n116_), .d(new_n47_), .O(z18));
endmodule
