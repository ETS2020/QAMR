...
module FAU ( 
  ...
  nand4  g42(.a(new_n61_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n88_));
  ...
  nor2   g65(.a(new_n110_), .b(new_n98_), .O(new_n111_));
  nor2   g66(.a(new_n111_), .b(x15), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n108_), .c(new_n100_), .O(z15));
  nor2   g68(.a(new_n111_), .b(new_n80_), .O(new_n114_));
  inv1   g69(.a(new_n98_), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n103_), .c(new_n115_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n61_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n114_), .c(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n51_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  inv1   g76(.a(new_n101_), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n109_), .c(new_n122_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n100_), .d(new_n47_), .O(z17));
  nand2  g80(.a(new_n124_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n109_), .c(new_n122_), .O(new_n128_));
