...
module FAU ( 
  ...
  nand2  g37(.a(new_n82_), .b(new_n50_), .O(z04));
  ...
  nand3  g44(.a(new_n47_), .b(new_n89_), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g49(.a(new_n56_), .b(x05), .c(x04), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n47_), .c(x15), .O(z09));
  aoi21  g51(.a(x05), .b(x04), .c(x19), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n88_), .c(new_n69_), .O(new_n98_));
  nor2   g53(.a(new_n98_), .b(x07), .O(z10));
  xor2a  g54(.a(x18), .b(x17), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n57_), .c(new_n47_), .d(new_n69_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x07), .O(z11));
  nand4  g57(.a(new_n97_), .b(x18), .c(x17), .d(new_n69_), .O(new_n103_));
  nor2   g58(.a(new_n103_), .b(x07), .O(z12));
  nand3  g59(.a(new_n57_), .b(new_n69_), .c(new_n56_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n60_), .c(new_n47_), .O(z13));
  nand3  g62(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n69_), .O(z14));
  nand3  g65(.a(new_n106_), .b(new_n52_), .c(new_n47_), .O(z15));
  nand3  g66(.a(new_n57_), .b(new_n53_), .c(new_n56_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n69_), .O(z16));
  nand3  g69(.a(new_n57_), .b(new_n72_), .c(new_n56_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n69_), .O(z17));
  nand3  g72(.a(new_n57_), .b(new_n61_), .c(new_n56_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n69_), .O(z18));
endmodule
