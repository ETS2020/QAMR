...
module FAU ( 
  ...
  nand3  g58(.a(new_n97_), .b(new_n54_), .c(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n62_), .d(new_n48_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n65_), .O(z13));
  nand2  g62(.a(new_n104_), .b(x21), .O(new_n108_));
  nor2   g63(.a(new_n63_), .b(x07), .O(new_n109_));
  ...
  nand4  g74(.a(new_n110_), .b(new_n114_), .c(new_n119_), .d(new_n85_), .O(new_n120_));
  ...
  nand4  g78(.a(new_n115_), .b(new_n123_), .c(new_n84_), .d(new_n119_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n109_), .d(new_n48_), .O(z17));
  nand2  g80(.a(new_n124_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n115_), .c(new_n123_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n109_), .d(new_n48_), .O(z18));
endmodule
