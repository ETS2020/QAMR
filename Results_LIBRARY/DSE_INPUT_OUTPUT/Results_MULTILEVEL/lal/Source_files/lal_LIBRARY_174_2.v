...
module FAU ( 
  ...
  nand3  g41(.a(new_n63_), .b(new_n86_), .c(new_n48_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n62_), .b(new_n55_), .c(new_n86_), .d(new_n48_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(new_n86_), .d(new_n48_), .O(new_n92_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(new_n86_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n101_), .d(new_n86_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n109_), .c(new_n101_), .O(z15));
