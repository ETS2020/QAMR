...
module FAU ( 
  ...
  nor2   g15(.a(new_n47_), .b(new_n60_), .O(new_n61_));
  ...
  nand3  g35(.a(new_n59_), .b(x22), .c(x21), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(x25), .c(x15), .O(new_n83_));
  oai21  g38(.a(new_n52_), .b(new_n80_), .c(new_n53_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n83_), .O(z08));
  nor4   g41(.a(new_n64_), .b(x22), .c(x15), .d(x07), .O(z09));
  nand3  g42(.a(new_n64_), .b(new_n55_), .c(new_n51_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n64_), .c(new_n51_), .O(new_n91_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n64_), .c(new_n51_), .O(new_n96_));
  ...
  nand3  g55(.a(new_n93_), .b(new_n54_), .c(x19), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n64_), .d(new_n51_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n98_), .O(z13));
  and2   g59(.a(new_n101_), .b(x21), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n93_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n64_), .c(new_n51_), .O(new_n108_));
  ...
  nand4  g66(.a(new_n111_), .b(new_n107_), .c(new_n64_), .d(new_n51_), .O(z15));
  inv1   g67(.a(new_n99_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n80_), .c(new_n60_), .d(new_n54_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n64_), .c(new_n51_), .O(new_n115_));
  aoi21  g70(.a(new_n107_), .b(x23), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x22), .c(new_n98_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  aoi21  g73(.a(x05), .b(x04), .c(x07), .O(new_n119_));
  nand4  g74(.a(new_n106_), .b(new_n113_), .c(new_n52_), .d(new_n80_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n47_), .c(new_n98_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(z17));
  nand2  g78(.a(new_n120_), .b(x25), .O(new_n124_));
  nand4  g79(.a(new_n53_), .b(new_n52_), .c(new_n80_), .d(new_n60_), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(new_n101_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(x22), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n119_), .d(new_n98_), .O(z18));
endmodule
