...
module FAU ( 
  ...
  nor2   g40(.a(new_n61_), .b(x07), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x15), .O(z09));
  inv1   g42(.a(x15), .O(new_n88_));
  nand4  g43(.a(new_n60_), .b(new_n53_), .c(new_n88_), .d(new_n47_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n60_), .c(new_n88_), .d(new_n47_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nor2   g55(.a(x20), .b(new_n55_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n94_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n86_), .d(new_n88_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n86_), .d(new_n88_), .O(z14));
  inv1   g62(.a(new_n99_), .O(new_n108_));
  nor2   g63(.a(x22), .b(x21), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n52_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  aoi21  g66(.a(new_n106_), .b(x22), .c(new_n111_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(x07), .c(new_n88_), .O(z15));
  nand2  g68(.a(new_n110_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand4  g70(.a(new_n105_), .b(new_n108_), .c(new_n115_), .d(new_n81_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n86_), .d(new_n88_), .O(z16));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n109_), .c(new_n101_), .d(new_n94_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n60_), .O(new_n120_));
  aoi21  g75(.a(new_n116_), .b(x24), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x07), .c(new_n88_), .O(z17));
  nor3   g77(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n109_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n102_), .c(new_n60_), .O(new_n125_));
  aoi21  g80(.a(new_n119_), .b(x25), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x07), .c(new_n88_), .O(z18));
endmodule
