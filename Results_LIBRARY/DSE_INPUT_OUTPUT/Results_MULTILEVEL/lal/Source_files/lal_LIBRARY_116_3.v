...
module FAU ( 
  ...
  nand3  g17(.a(new_n57_), .b(new_n47_), .c(new_n49_), .O(new_n63_));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n49_), .c(new_n75_), .O(z08));
  ...
  nand4  g42(.a(new_n83_), .b(new_n51_), .c(new_n85_), .d(new_n84_), .O(new_n88_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n59_), .d(new_n85_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n59_), .d(new_n85_), .O(z14));
  inv1   g60(.a(new_n98_), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n50_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n83_), .c(new_n85_), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(x22), .c(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n85_), .b(x07), .O(new_n111_));
  oai21  g66(.a(new_n110_), .b(x07), .c(new_n111_), .O(z15));
  nand2  g67(.a(new_n108_), .b(x23), .O(new_n113_));
  inv1   g68(.a(x22), .O(new_n114_));
  nand3  g69(.a(new_n103_), .b(new_n77_), .c(new_n114_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n106_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n59_), .d(new_n85_), .O(z16));
  ...
  nand4  g79(.a(new_n124_), .b(new_n119_), .c(new_n83_), .d(new_n85_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n111_), .O(z17));
  oai21  g82(.a(new_n122_), .b(new_n100_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n107_), .c(new_n120_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n83_), .d(new_n85_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n84_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n111_), .O(z18));
endmodule
