...
module FAU ( 
  ...
  nand4  g42(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n88_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n53_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n62_), .O(new_n112_));
  aoi21  g67(.a(new_n105_), .b(x22), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(x15), .c(new_n51_), .O(z15));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  nor2   g70(.a(new_n85_), .b(x07), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n104_), .c(new_n109_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n115_), .d(new_n47_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n100_), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n110_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n116_), .d(new_n47_), .O(z17));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n110_), .c(new_n121_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n116_), .d(new_n47_), .O(z18));
endmodule
