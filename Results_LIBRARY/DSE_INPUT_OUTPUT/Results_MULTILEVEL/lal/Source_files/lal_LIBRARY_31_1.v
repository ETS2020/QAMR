...
module FAU ( 
  ...
  nand3  g42(.a(new_n64_), .b(new_n47_), .c(new_n87_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n63_), .b(new_n53_), .c(new_n47_), .d(new_n87_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n63_), .c(new_n47_), .d(new_n87_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n63_), .c(new_n47_), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n65_), .d(new_n47_), .O(z13));
  inv1   g58(.a(new_n102_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n58_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n95_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n63_), .c(new_n87_), .O(new_n108_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n65_), .d(new_n47_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  nand4  g72(.a(new_n106_), .b(new_n113_), .c(new_n82_), .d(new_n59_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n117_), .c(new_n65_), .d(new_n47_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  nand3  g75(.a(new_n114_), .b(new_n50_), .c(new_n82_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n104_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n120_), .c(new_n65_), .d(new_n47_), .O(z17));
  oai21  g79(.a(new_n121_), .b(new_n102_), .c(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n114_), .c(new_n104_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n63_), .d(new_n87_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n110_), .O(z18));
endmodule
