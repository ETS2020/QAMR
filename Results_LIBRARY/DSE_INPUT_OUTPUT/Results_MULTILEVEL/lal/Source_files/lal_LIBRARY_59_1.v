...
module FAU ( 
  ...
  oai21  g21(.a(new_n62_), .b(x23), .c(x24), .O(new_n67_));
  nand2  g22(.a(new_n67_), .b(new_n50_), .O(new_n68_));
  inv1   g23(.a(x23), .O(new_n69_));
  oai21  g24(.a(x18), .b(x17), .c(new_n48_), .O(new_n70_));
  oai21  g25(.a(new_n48_), .b(new_n53_), .c(new_n70_), .O(new_n71_));
  nand3  g26(.a(new_n71_), .b(new_n69_), .c(new_n58_), .O(new_n72_));
  ...
  nand3  g41(.a(new_n48_), .b(new_n86_), .c(new_n85_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n58_), .c(new_n61_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(x21), .c(x23), .O(new_n89_));
  nor2   g44(.a(new_n49_), .b(x25), .O(new_n90_));
  oai21  g45(.a(new_n89_), .b(new_n56_), .c(new_n90_), .O(z08));
  inv1   g46(.a(x07), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(x05), .c(x04), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n48_), .c(x15), .O(z09));
  nand2  g49(.a(x05), .b(x04), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n85_), .c(new_n92_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n48_), .c(x15), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n95_), .c(new_n92_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n48_), .c(x15), .O(z11));
  nand4  g55(.a(new_n95_), .b(x18), .c(x17), .d(new_n92_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n48_), .c(x15), .O(z12));
  nand3  g57(.a(new_n95_), .b(new_n58_), .c(new_n92_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n48_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n53_), .O(z13));
  nand3  g60(.a(new_n95_), .b(new_n60_), .c(new_n92_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n53_), .O(z14));
  nand2  g63(.a(new_n65_), .b(new_n53_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n61_), .c(new_n48_), .O(z15));
  nand3  g66(.a(new_n110_), .b(new_n69_), .c(new_n48_), .O(z16));
  nand3  g67(.a(new_n95_), .b(new_n56_), .c(new_n92_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n48_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n53_), .O(z17));
  nand3  g70(.a(new_n95_), .b(new_n57_), .c(new_n92_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n48_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n53_), .O(z18));
endmodule
