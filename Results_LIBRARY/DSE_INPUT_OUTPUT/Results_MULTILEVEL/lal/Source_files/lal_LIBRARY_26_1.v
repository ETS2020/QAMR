...
module FAU ( 
  ...
  nor2   g56(.a(new_n86_), .b(x07), .O(new_n102_));
  ...
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n86_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n107_), .b(new_n117_), .c(new_n81_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n100_), .c(new_n65_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n64_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n100_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x22), .b(x21), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n124_), .c(new_n103_), .d(new_n95_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n65_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n64_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n124_), .c(new_n103_), .d(new_n95_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n102_), .d(new_n48_), .O(z18));
endmodule
