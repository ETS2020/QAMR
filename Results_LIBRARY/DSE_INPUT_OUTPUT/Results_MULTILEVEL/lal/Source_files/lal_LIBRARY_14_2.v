...
module FAU ( 
  ...
  nand2  g02(.a(new_n47_), .b(x01), .O(new_n48_));
  ...
  nor2   g16(.a(new_n61_), .b(new_n47_), .O(new_n62_));
  inv1   g17(.a(new_n62_), .O(new_n63_));
  oai21  g18(.a(new_n60_), .b(new_n50_), .c(new_n63_), .O(z01));
  and2   g19(.a(new_n48_), .b(x16), .O(z02));
  nand3  g20(.a(new_n59_), .b(new_n48_), .c(new_n51_), .O(new_n66_));
  inv1   g21(.a(new_n66_), .O(z03));
  oai21  g22(.a(x10), .b(x08), .c(x04), .O(new_n68_));
  ...
  aoi21  g36(.a(new_n46_), .b(x06), .c(new_n50_), .O(z07));
  inv1   g37(.a(x23), .O(new_n83_));
  nand2  g38(.a(new_n56_), .b(new_n52_), .O(new_n84_));
  ...
  aoi21  g42(.a(new_n87_), .b(new_n51_), .c(new_n50_), .O(z08));
  inv1   g43(.a(x07), .O(new_n89_));
  inv1   g44(.a(x15), .O(new_n90_));
  nand3  g45(.a(new_n62_), .b(new_n90_), .c(new_n89_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n48_), .O(z09));
  nor2   g47(.a(x17), .b(x15), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n89_), .c(x01), .O(new_n94_));
  nand3  g49(.a(new_n93_), .b(new_n89_), .c(new_n61_), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(x04), .c(new_n95_), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n63_), .c(new_n90_), .d(new_n89_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n48_), .O(z11));
  nor2   g54(.a(new_n54_), .b(new_n53_), .O(new_n100_));
  nand3  g55(.a(new_n55_), .b(x18), .c(x17), .O(new_n101_));
  oai21  g56(.a(new_n100_), .b(new_n55_), .c(new_n101_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n63_), .c(new_n90_), .d(new_n89_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n48_), .O(z12));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n100_), .b(new_n52_), .c(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n90_), .d(new_n89_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n48_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n63_), .O(z13));
  ...
  nand3  g70(.a(new_n115_), .b(new_n90_), .c(new_n89_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n113_), .c(new_n48_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n63_), .O(z14));
  nand2  g73(.a(new_n115_), .b(x22), .O(new_n119_));
  nor2   g74(.a(new_n62_), .b(new_n50_), .O(new_n120_));
  ...
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n119_), .d(new_n89_), .O(z15));
  nor2   g80(.a(new_n123_), .b(new_n83_), .O(new_n126_));
  inv1   g81(.a(new_n105_), .O(new_n127_));
  nand4  g82(.a(new_n114_), .b(new_n127_), .c(new_n83_), .d(new_n121_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n90_), .c(new_n89_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n126_), .c(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n63_), .O(z16));
  nand2  g86(.a(new_n128_), .b(x24), .O(new_n132_));
  inv1   g87(.a(x24), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n83_), .c(new_n121_), .d(new_n111_), .O(new_n134_));
  inv1   g89(.a(new_n134_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n100_), .c(new_n52_), .d(x19), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n132_), .c(new_n90_), .d(new_n89_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n48_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n63_), .O(z17));
  nand2  g94(.a(new_n136_), .b(x25), .O(new_n140_));
  nand3  g95(.a(new_n51_), .b(new_n133_), .c(new_n83_), .O(new_n141_));
  nor2   g96(.a(new_n141_), .b(new_n122_), .O(new_n142_));
  aoi21  g97(.a(new_n142_), .b(new_n112_), .c(x15), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n140_), .c(new_n120_), .d(new_n89_), .O(z18));
endmodule
