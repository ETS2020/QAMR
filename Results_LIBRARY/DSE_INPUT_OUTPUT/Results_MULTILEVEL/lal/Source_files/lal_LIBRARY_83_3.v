...
module FAU ( 
  ...
  nand2  g22(.a(new_n61_), .b(new_n47_), .O(z03));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n51_), .c(new_n58_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(x21), .c(x23), .O(new_n83_));
  aoi21  g38(.a(x15), .b(x07), .c(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n49_), .c(new_n84_), .O(z08));
  ...
  nand4  g44(.a(new_n62_), .b(new_n52_), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n47_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n62_), .c(new_n87_), .d(new_n86_), .O(new_n93_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n64_), .d(new_n87_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n64_), .d(new_n87_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n64_), .O(z15));
  inv1   g67(.a(x23), .O(new_n113_));
  aoi21  g68(.a(new_n110_), .b(new_n109_), .c(new_n113_), .O(new_n114_));
  nand4  g69(.a(new_n105_), .b(new_n109_), .c(new_n113_), .d(new_n58_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n62_), .c(new_n87_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n86_), .O(new_n117_));
  nand2  g72(.a(new_n87_), .b(x07), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n117_), .O(z16));
  nand2  g74(.a(new_n115_), .b(x24), .O(new_n120_));
  nand4  g75(.a(new_n49_), .b(new_n113_), .c(new_n58_), .d(new_n57_), .O(new_n121_));
  or2    g76(.a(new_n121_), .b(new_n102_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n64_), .d(new_n87_), .O(z17));
  ...
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n95_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n62_), .d(new_n87_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n86_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n118_), .O(z18));
endmodule
