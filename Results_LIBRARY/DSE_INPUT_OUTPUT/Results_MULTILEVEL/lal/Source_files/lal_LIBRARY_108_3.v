...
module FAU ( 
  ...
  nand2  g41(.a(new_n48_), .b(new_n47_), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n86_), .c(new_n50_), .O(z09));
  nand4  g43(.a(new_n86_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n86_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n86_), .c(new_n48_), .d(new_n47_), .O(new_n97_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n63_), .d(new_n48_), .O(z13));
  nand2  g58(.a(new_n102_), .b(x21), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n94_), .c(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n63_), .d(new_n48_), .O(z14));
  nand2  g62(.a(new_n106_), .b(x22), .O(new_n108_));
  inv1   g63(.a(new_n99_), .O(new_n109_));
  nor3   g64(.a(x22), .b(x21), .c(x20), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n109_), .c(x15), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n63_), .O(z15));
  inv1   g67(.a(x23), .O(new_n113_));
  aoi21  g68(.a(new_n110_), .b(new_n109_), .c(new_n113_), .O(new_n114_));
  nand4  g69(.a(new_n105_), .b(new_n109_), .c(new_n113_), .d(new_n81_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n86_), .c(new_n48_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n48_), .b(x07), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n117_), .O(z16));
  inv1   g74(.a(x21), .O(new_n120_));
  nand4  g75(.a(new_n113_), .b(new_n81_), .c(new_n120_), .d(new_n54_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n99_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n101_), .d(new_n94_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n122_), .c(new_n86_), .d(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n118_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n123_), .c(new_n101_), .d(new_n94_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n63_), .d(new_n48_), .O(z18));
endmodule
