...
module FAU ( 
  ...
  nand4  g49(.a(new_n94_), .b(new_n85_), .c(new_n88_), .d(new_n47_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nor2   g53(.a(x20), .b(new_n54_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n92_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n98_), .c(new_n60_), .d(new_n88_), .O(z13));
  ...
  oai21  g60(.a(new_n105_), .b(x07), .c(new_n88_), .O(z14));
  ...
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n60_), .O(z15));
  aoi21  g66(.a(new_n109_), .b(new_n108_), .c(new_n78_), .O(new_n112_));
  ...
  nand2  g71(.a(new_n116_), .b(new_n88_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  nor2   g73(.a(x22), .b(x21), .O(new_n119_));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n119_), .c(new_n99_), .d(new_n92_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n118_), .c(new_n85_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n88_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n119_), .c(new_n99_), .d(new_n92_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n60_), .d(new_n88_), .O(z18));
endmodule
