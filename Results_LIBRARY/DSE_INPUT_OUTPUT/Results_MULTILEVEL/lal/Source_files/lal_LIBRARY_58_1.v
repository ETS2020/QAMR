...
module FAU ( 
  ...
  nand3  g35(.a(new_n80_), .b(new_n79_), .c(new_n47_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n56_), .c(new_n59_), .O(new_n82_));
  ...
  nand4  g44(.a(new_n89_), .b(new_n47_), .c(new_n51_), .d(new_n86_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  nand3  g46(.a(new_n89_), .b(x18), .c(new_n86_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n47_), .c(x15), .O(z11));
  nand4  g48(.a(new_n89_), .b(x19), .c(new_n47_), .d(new_n51_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z12));
  nand3  g50(.a(new_n89_), .b(new_n56_), .c(new_n86_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n51_), .O(z13));
  nand3  g53(.a(new_n89_), .b(new_n58_), .c(new_n86_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n51_), .O(z14));
  nand2  g56(.a(new_n63_), .b(new_n51_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n59_), .c(new_n47_), .O(z15));
  inv1   g59(.a(x23), .O(new_n105_));
  nand3  g60(.a(new_n89_), .b(new_n105_), .c(new_n86_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n51_), .O(z16));
  nand3  g63(.a(new_n103_), .b(new_n54_), .c(new_n47_), .O(z17));
  nand3  g64(.a(new_n103_), .b(new_n55_), .c(new_n47_), .O(z18));
endmodule
