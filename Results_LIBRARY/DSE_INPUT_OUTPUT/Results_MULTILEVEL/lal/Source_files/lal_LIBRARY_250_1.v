...
module FAU ( 
  ...
  nand2  g020(.a(new_n61_), .b(new_n52_), .O(z03));
  inv1   g021(.a(x01), .O(new_n67_));
  oai21  g022(.a(x08), .b(new_n67_), .c(new_n47_), .O(new_n68_));
  nand2  g023(.a(new_n68_), .b(new_n50_), .O(new_n69_));
  inv1   g024(.a(x09), .O(new_n70_));
  aoi22  g025(.a(x10), .b(new_n67_), .c(new_n70_), .d(x00), .O(new_n71_));
  ...
  oai21  g033(.a(x13), .b(x08), .c(new_n78_), .O(z05));
  nand2  g034(.a(x14), .b(new_n46_), .O(new_n80_));
  nand2  g035(.a(new_n80_), .b(new_n78_), .O(z06));
  aoi21  g036(.a(new_n46_), .b(x06), .c(new_n48_), .O(z07));
  inv1   g037(.a(x18), .O(new_n83_));
  inv1   g038(.a(x19), .O(new_n84_));
  nand3  g039(.a(new_n84_), .b(new_n83_), .c(new_n47_), .O(new_n85_));
  aoi21  g040(.a(new_n85_), .b(new_n55_), .c(new_n58_), .O(new_n86_));
  aoi21  g041(.a(new_n86_), .b(x21), .c(x23), .O(new_n87_));
  nor2   g042(.a(new_n48_), .b(x25), .O(new_n88_));
  oai21  g043(.a(new_n87_), .b(new_n53_), .c(new_n88_), .O(z08));
  inv1   g044(.a(x04), .O(new_n90_));
  inv1   g045(.a(x07), .O(new_n91_));
  inv1   g046(.a(x15), .O(new_n92_));
  nand4  g047(.a(new_n78_), .b(new_n92_), .c(new_n91_), .d(x05), .O(new_n93_));
  nor2   g048(.a(new_n93_), .b(new_n90_), .O(z09));
  nand2  g049(.a(x05), .b(x04), .O(new_n95_));
  nand4  g050(.a(new_n95_), .b(new_n47_), .c(new_n92_), .d(new_n91_), .O(new_n96_));
  nand2  g051(.a(new_n96_), .b(new_n78_), .O(z10));
  nand3  g052(.a(new_n83_), .b(x17), .c(x10), .O(new_n98_));
  ...
  nand2  g059(.a(new_n104_), .b(x10), .O(new_n105_));
  nand2  g060(.a(x19), .b(new_n47_), .O(new_n106_));
  ...
  nand4  g093(.a(new_n138_), .b(new_n123_), .c(new_n137_), .d(new_n58_), .O(new_n139_));
  ...
  nand3  g098(.a(new_n55_), .b(x19), .c(x18), .O(new_n144_));
  nand3  g099(.a(new_n137_), .b(new_n58_), .c(new_n57_), .O(new_n145_));
  ...
  nand2  g104(.a(new_n149_), .b(x10), .O(new_n150_));
  nand2  g105(.a(x24), .b(new_n47_), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n150_), .c(new_n111_), .O(z17));
  oai21  g107(.a(x25), .b(x17), .c(new_n50_), .O(new_n153_));
  ...
  nand4  g112(.a(new_n157_), .b(new_n154_), .c(new_n153_), .d(new_n62_), .O(z18));
endmodule
