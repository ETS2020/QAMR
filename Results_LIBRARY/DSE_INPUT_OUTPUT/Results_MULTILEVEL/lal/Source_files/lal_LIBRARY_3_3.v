...
module FAU ( 
  ...
  oai21  g43(.a(new_n88_), .b(new_n87_), .c(new_n50_), .O(z09));
  nand4  g44(.a(new_n87_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n50_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n87_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n87_), .c(new_n48_), .d(new_n47_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n62_), .d(new_n48_), .O(z13));
  nand2  g59(.a(new_n103_), .b(x21), .O(new_n105_));
  inv1   g60(.a(x21), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n53_), .c(x19), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n96_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n105_), .c(new_n62_), .d(new_n48_), .O(z14));
  oai21  g65(.a(new_n107_), .b(new_n95_), .c(x22), .O(new_n111_));
  inv1   g66(.a(new_n101_), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n53_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n87_), .d(new_n48_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n48_), .b(x07), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n116_), .O(z15));
  nand2  g73(.a(new_n114_), .b(x23), .O(new_n119_));
  inv1   g74(.a(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n82_), .c(new_n106_), .d(new_n53_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n112_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n62_), .d(new_n48_), .O(z16));
  oai21  g79(.a(new_n121_), .b(new_n101_), .c(x24), .O(new_n125_));
  nor2   g80(.a(x20), .b(new_n56_), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n113_), .c(new_n126_), .d(new_n96_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n87_), .d(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n117_), .O(z17));
  nand4  g86(.a(new_n81_), .b(new_n120_), .c(new_n82_), .d(new_n106_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n103_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n113_), .c(new_n126_), .d(new_n96_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n87_), .d(new_n48_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n117_), .O(z18));
endmodule
