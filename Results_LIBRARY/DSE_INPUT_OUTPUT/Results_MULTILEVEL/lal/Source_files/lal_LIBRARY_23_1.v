...
module FAU ( 
  ...
  nor2   g36(.a(new_n81_), .b(x02), .O(new_n82_));
  nor2   g37(.a(x15), .b(x11), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(x02), .c(new_n82_), .O(new_n84_));
  ...
  nand2  g51(.a(new_n47_), .b(new_n96_), .O(new_n97_));
  oai21  g52(.a(new_n97_), .b(new_n95_), .c(new_n49_), .O(z09));
  nand4  g53(.a(new_n95_), .b(new_n54_), .c(new_n47_), .d(new_n96_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z10));
  xor2a  g55(.a(x18), .b(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n95_), .c(new_n47_), .d(new_n96_), .O(new_n102_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n95_), .c(new_n47_), .d(new_n96_), .O(new_n107_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n64_), .d(new_n47_), .O(z13));
  aoi21  g68(.a(new_n111_), .b(new_n104_), .c(new_n59_), .O(new_n114_));
  nor2   g69(.a(x21), .b(x20), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n104_), .c(x19), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n95_), .c(new_n96_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n114_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(x15), .b(x11), .O(new_n119_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n95_), .c(new_n96_), .O(new_n124_));
  aoi21  g79(.a(new_n116_), .b(x22), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x15), .c(new_n119_), .O(z15));
  aoi21  g81(.a(new_n122_), .b(new_n121_), .c(new_n90_), .O(new_n127_));
  nand4  g82(.a(new_n115_), .b(new_n121_), .c(new_n90_), .d(new_n60_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n95_), .c(new_n96_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n127_), .c(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n119_), .O(z16));
  nand2  g86(.a(new_n128_), .b(x24), .O(new_n132_));
  nor2   g87(.a(x22), .b(x21), .O(new_n133_));
  nor2   g88(.a(x24), .b(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n133_), .c(new_n111_), .d(new_n104_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n132_), .c(new_n95_), .d(new_n96_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n119_), .O(z17));
  nand2  g93(.a(new_n135_), .b(x25), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n133_), .c(new_n111_), .d(new_n104_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n64_), .d(new_n47_), .O(z18));
endmodule
