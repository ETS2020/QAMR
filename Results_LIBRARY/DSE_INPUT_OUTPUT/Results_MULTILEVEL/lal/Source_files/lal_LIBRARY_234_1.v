...
module FAU ( 
  ...
  aoi21  g44(.a(new_n89_), .b(new_n58_), .c(new_n53_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x25), .c(x15), .O(new_n91_));
  nand2  g46(.a(new_n72_), .b(new_n54_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n47_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n91_), .O(z08));
  nor4   g49(.a(new_n52_), .b(x21), .c(x15), .d(x07), .O(z09));
  ...
  nand3  g58(.a(new_n103_), .b(new_n52_), .c(new_n51_), .O(new_n104_));
  ...
  nand3  g62(.a(new_n101_), .b(new_n60_), .c(x19), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n52_), .d(new_n51_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n47_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n59_), .O(z13));
  nor2   g66(.a(x21), .b(x15), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n108_), .c(new_n52_), .d(new_n51_), .O(z14));
  ...
  nand3  g72(.a(new_n117_), .b(new_n47_), .c(new_n59_), .O(new_n118_));
  ...
  nand4  g77(.a(new_n122_), .b(new_n58_), .c(new_n61_), .d(new_n60_), .O(new_n123_));
  and2   g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n115_), .d(new_n59_), .O(z16));
  nand2  g80(.a(new_n123_), .b(x24), .O(new_n126_));
  nand4  g81(.a(new_n116_), .b(new_n122_), .c(new_n53_), .d(new_n58_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n47_), .c(new_n59_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n126_), .c(new_n115_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nand4  g86(.a(new_n54_), .b(new_n53_), .c(new_n58_), .d(new_n61_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(new_n108_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(x21), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n131_), .c(new_n115_), .d(new_n59_), .O(z18));
endmodule
