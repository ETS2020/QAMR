...
module FAU ( 
  ...
  nand2  g21(.a(new_n60_), .b(new_n49_), .O(z03));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n79_), .c(new_n80_), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(x25), .O(new_n83_));
  nor3   g38(.a(x18), .b(x17), .c(x15), .O(new_n84_));
  inv1   g39(.a(x21), .O(new_n85_));
  nor2   g40(.a(new_n85_), .b(x19), .O(new_n86_));
  nand4  g41(.a(new_n86_), .b(new_n84_), .c(x24), .d(x22), .O(new_n87_));
  oai21  g42(.a(new_n83_), .b(new_n48_), .c(new_n87_), .O(z08));
  inv1   g43(.a(x07), .O(new_n89_));
  nand3  g44(.a(new_n62_), .b(new_n47_), .c(new_n89_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand4  g46(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n89_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n49_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n61_), .c(new_n47_), .d(new_n89_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z11));
  nand2  g51(.a(x18), .b(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(x19), .c(new_n47_), .O(new_n98_));
  nand3  g53(.a(new_n55_), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n61_), .c(new_n89_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n49_), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nand2  g59(.a(new_n61_), .b(new_n89_), .O(new_n105_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n106_), .c(new_n104_), .d(new_n47_), .O(z13));
  nand2  g65(.a(new_n109_), .b(x21), .O(new_n111_));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n107_), .c(x19), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n106_), .d(new_n47_), .O(z14));
  ...
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n106_), .d(new_n47_), .O(z15));
  nand3  g74(.a(new_n52_), .b(x18), .c(x17), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n85_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x19), .O(new_n124_));
  aoi21  g79(.a(new_n118_), .b(x23), .c(new_n105_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x15), .c(new_n124_), .O(z16));
  nand2  g81(.a(new_n121_), .b(new_n112_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n103_), .c(x24), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n117_), .c(new_n108_), .d(new_n107_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n106_), .d(new_n47_), .O(z17));
  nand2  g86(.a(new_n112_), .b(new_n107_), .O(new_n132_));
  nand3  g87(.a(new_n121_), .b(new_n51_), .c(new_n80_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n132_), .c(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x19), .O(new_n135_));
  aoi21  g90(.a(new_n130_), .b(x25), .c(new_n105_), .O(new_n136_));
  oai21  g91(.a(new_n136_), .b(x15), .c(new_n135_), .O(z18));
endmodule
