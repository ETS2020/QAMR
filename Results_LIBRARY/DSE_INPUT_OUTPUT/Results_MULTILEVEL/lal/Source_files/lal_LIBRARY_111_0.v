...
module FAU ( 
  ...
  oai21  g35(.a(new_n80_), .b(new_n78_), .c(new_n53_), .O(new_n81_));
  ...
  nand4  g43(.a(new_n60_), .b(x18), .c(new_n52_), .d(new_n78_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x19), .b(x17), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n60_), .c(new_n86_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x18), .c(x15), .O(z12));
  oai21  g48(.a(new_n54_), .b(new_n52_), .c(x20), .O(new_n94_));
  nor2   g49(.a(new_n61_), .b(x07), .O(new_n95_));
  nand3  g50(.a(new_n51_), .b(x19), .c(x17), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n53_), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n95_), .c(new_n94_), .d(new_n78_), .O(z13));
  nand2  g54(.a(new_n96_), .b(x21), .O(new_n100_));
  nor2   g55(.a(new_n54_), .b(new_n52_), .O(new_n101_));
  nor2   g56(.a(x21), .b(x20), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n101_), .c(new_n53_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n100_), .c(new_n95_), .d(new_n78_), .O(z14));
  inv1   g59(.a(x22), .O(new_n105_));
  aoi21  g60(.a(new_n102_), .b(new_n101_), .c(new_n105_), .O(new_n106_));
  nor3   g61(.a(x22), .b(x21), .c(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n101_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n60_), .c(new_n86_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(x18), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n78_), .O(z15));
  nand2  g66(.a(new_n108_), .b(x23), .O(new_n112_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(new_n97_), .c(new_n53_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n95_), .d(new_n78_), .O(z16));
  nand2  g70(.a(new_n113_), .b(new_n97_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(x24), .O(new_n117_));
  inv1   g72(.a(x21), .O(new_n118_));
  inv1   g73(.a(x24), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n82_), .c(new_n105_), .d(new_n118_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n97_), .c(new_n53_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n95_), .d(new_n78_), .O(z17));
  oai21  g78(.a(new_n120_), .b(new_n96_), .c(x25), .O(new_n124_));
  nor2   g79(.a(x23), .b(x22), .O(new_n125_));
  nor2   g80(.a(x25), .b(x24), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n102_), .d(new_n101_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n60_), .d(new_n86_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(x18), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n78_), .O(z18));
  nor2   g85(.a(new_n89_), .b(x07), .O(z11));
endmodule
