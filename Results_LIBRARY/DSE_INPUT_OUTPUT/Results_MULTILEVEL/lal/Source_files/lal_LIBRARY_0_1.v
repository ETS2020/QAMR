...
module FAU ( 
  ...
  nand3  g42(.a(new_n65_), .b(new_n47_), .c(new_n87_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n49_), .O(z09));
  nand4  g44(.a(new_n64_), .b(new_n54_), .c(new_n47_), .d(new_n87_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n64_), .c(new_n47_), .d(new_n87_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n49_), .O(z11));
  ...
  nand4  g52(.a(new_n97_), .b(new_n64_), .c(new_n47_), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n66_), .d(new_n47_), .O(z13));
  inv1   g58(.a(new_n102_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n59_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n95_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n64_), .c(new_n87_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n47_), .O(new_n109_));
  nand2  g64(.a(x15), .b(x14), .O(new_n110_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n112_), .c(new_n66_), .O(z15));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(new_n82_), .O(new_n117_));
  nand4  g72(.a(new_n106_), .b(new_n113_), .c(new_n82_), .d(new_n60_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n64_), .c(new_n87_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n117_), .c(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n110_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n51_), .c(new_n82_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n104_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n122_), .c(new_n66_), .d(new_n47_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n102_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n123_), .c(new_n104_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n64_), .d(new_n87_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n110_), .O(z18));
endmodule
