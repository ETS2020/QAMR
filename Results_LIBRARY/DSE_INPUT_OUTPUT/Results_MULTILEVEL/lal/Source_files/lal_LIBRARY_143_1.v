...
module FAU ( 
  ...
  aoi21  g44(.a(new_n89_), .b(new_n47_), .c(x07), .O(z11));
  ...
  nand4  g63(.a(new_n108_), .b(new_n105_), .c(new_n98_), .d(new_n47_), .O(z15));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n98_), .d(new_n47_), .O(z16));
  ...
  nand4  g74(.a(new_n119_), .b(new_n114_), .c(new_n98_), .d(new_n47_), .O(z17));
  ...
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n98_), .d(new_n47_), .O(z18));
endmodule
