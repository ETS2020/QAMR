...
module FAU ( 
  ...
  nand2  g39(.a(new_n47_), .b(new_n51_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n62_), .c(new_n49_), .O(z09));
  nor2   g41(.a(x17), .b(x07), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x15), .O(new_n88_));
  inv1   g43(.a(x04), .O(new_n89_));
  nand4  g44(.a(new_n54_), .b(new_n47_), .c(new_n51_), .d(new_n89_), .O(new_n90_));
  oai21  g45(.a(new_n88_), .b(x05), .c(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n93_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n95_), .c(new_n51_), .O(new_n99_));
  ...
  nand2  g60(.a(new_n105_), .b(new_n95_), .O(z13));
  ...
  oai21  g65(.a(new_n110_), .b(x15), .c(new_n95_), .O(z14));
  ...
  oai21  g71(.a(new_n116_), .b(x15), .c(new_n95_), .O(z15));
  nand2  g72(.a(new_n114_), .b(x23), .O(new_n118_));
  aoi21  g73(.a(x05), .b(x04), .c(x07), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n107_), .c(new_n112_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n47_), .O(z16));
  nand2  g77(.a(new_n121_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n103_), .O(new_n124_));
  inv1   g79(.a(x24), .O(new_n125_));
  nand3  g80(.a(new_n113_), .b(new_n125_), .c(new_n79_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n123_), .c(new_n119_), .d(new_n47_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n103_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n113_), .c(new_n124_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n51_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n95_), .O(z18));
endmodule
