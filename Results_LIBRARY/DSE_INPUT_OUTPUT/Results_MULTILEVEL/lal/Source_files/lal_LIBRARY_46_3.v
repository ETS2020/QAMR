...
module FAU ( 
  ...
  oai21  g61(.a(x21), .b(x15), .c(new_n96_), .O(new_n107_));
  nand3  g62(.a(new_n53_), .b(x18), .c(x17), .O(new_n108_));
  ...
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n107_), .O(z14));
  oai21  g68(.a(x22), .b(x15), .c(new_n96_), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(new_n97_), .c(new_n56_), .O(new_n115_));
  ...
  oai21  g74(.a(new_n119_), .b(new_n115_), .c(new_n87_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n114_), .O(z15));
  oai21  g76(.a(x23), .b(x15), .c(new_n96_), .O(new_n122_));
  aoi21  g77(.a(new_n117_), .b(new_n97_), .c(new_n79_), .O(new_n123_));
  nand4  g78(.a(new_n109_), .b(new_n116_), .c(new_n79_), .d(new_n56_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n60_), .c(new_n86_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n123_), .c(new_n87_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n122_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n51_), .b(new_n79_), .c(new_n56_), .d(new_n55_), .O(new_n129_));
  or2    g84(.a(new_n129_), .b(new_n105_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n62_), .d(new_n87_), .O(z17));
  oai21  g86(.a(x25), .b(x15), .c(new_n96_), .O(new_n132_));
  ...
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n104_), .d(new_n97_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n60_), .d(new_n86_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n87_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n132_), .O(z18));
endmodule
