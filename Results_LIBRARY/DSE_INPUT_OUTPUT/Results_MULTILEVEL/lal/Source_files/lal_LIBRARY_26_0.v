...
module FAU ( 
  ...
  nand2  g22(.a(new_n62_), .b(z15), .O(z03));
  ...
  nand3  g28(.a(new_n73_), .b(z15), .c(new_n46_), .O(new_n74_));
  inv1   g29(.a(new_n74_), .O(z04));
  nor3   g30(.a(z11), .b(x13), .c(x08), .O(z05));
  inv1   g31(.a(x14), .O(new_n77_));
  nor3   g32(.a(z11), .b(new_n77_), .c(x08), .O(z06));
  nand3  g33(.a(z15), .b(new_n46_), .c(x06), .O(z07));
