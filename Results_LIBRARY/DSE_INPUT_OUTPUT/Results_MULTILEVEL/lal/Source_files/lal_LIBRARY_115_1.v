...
module FAU ( 
  ...
  nand3  g17(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(new_n63_));
  ...
  nand2  g22(.a(new_n60_), .b(new_n48_), .O(z03));
  ...
  aoi21  g37(.a(x15), .b(new_n47_), .c(x25), .O(new_n83_));
  oai21  g38(.a(new_n82_), .b(new_n50_), .c(new_n83_), .O(z08));
  aoi21  g39(.a(new_n62_), .b(new_n61_), .c(x07), .O(z09));
  nand4  g40(.a(new_n62_), .b(new_n53_), .c(new_n61_), .d(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n62_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n61_), .c(x07), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n62_), .c(new_n61_), .d(new_n47_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n61_), .O(z13));
  ...
  oai21  g60(.a(new_n105_), .b(x15), .c(new_n47_), .O(z14));
  ...
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n62_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n61_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(new_n108_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n102_), .b(new_n114_), .c(new_n80_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n97_), .c(new_n62_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n61_), .O(new_n118_));
  ...
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n92_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n62_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n61_), .O(new_n126_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n122_), .c(new_n121_), .d(new_n92_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n62_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n61_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(z18));
endmodule
