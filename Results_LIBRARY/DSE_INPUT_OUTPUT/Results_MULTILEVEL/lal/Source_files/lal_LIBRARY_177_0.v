...
module FAU ( 
  ...
  oai21  g036(.a(new_n81_), .b(new_n74_), .c(new_n65_), .O(new_n82_));
  inv1   g037(.a(x09), .O(new_n83_));
  inv1   g038(.a(x15), .O(new_n84_));
  nor3   g039(.a(new_n84_), .b(new_n83_), .c(x00), .O(new_n85_));
  aoi21  g040(.a(new_n83_), .b(x00), .c(new_n85_), .O(new_n86_));
  aoi21  g041(.a(new_n86_), .b(new_n82_), .c(x08), .O(z04));
  nor3   g042(.a(new_n47_), .b(x13), .c(x08), .O(z05));
  nand2  g043(.a(x14), .b(new_n46_), .O(new_n89_));
  nand2  g044(.a(new_n89_), .b(new_n65_), .O(z06));
  nand3  g045(.a(new_n65_), .b(new_n46_), .c(x06), .O(z07));
  ...
  aoi21  g054(.a(new_n99_), .b(x00), .c(x15), .O(z09));
  nand3  g055(.a(new_n59_), .b(new_n51_), .c(new_n98_), .O(new_n101_));
  aoi21  g056(.a(new_n101_), .b(x00), .c(x15), .O(z10));
  inv1   g057(.a(x00), .O(new_n103_));
  xor2a  g058(.a(x18), .b(x17), .O(new_n104_));
  nand4  g059(.a(new_n104_), .b(new_n59_), .c(new_n84_), .d(new_n98_), .O(new_n105_));
  nor2   g060(.a(new_n105_), .b(new_n103_), .O(z11));
  ...
  nand3  g064(.a(new_n109_), .b(new_n59_), .c(new_n98_), .O(new_n110_));
  aoi21  g065(.a(new_n110_), .b(x00), .c(x15), .O(z12));
  nand3  g066(.a(x19), .b(x18), .c(x17), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(x20), .O(new_n113_));
  nor2   g068(.a(new_n60_), .b(new_n103_), .O(new_n114_));
  nor2   g069(.a(x20), .b(new_n53_), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n107_), .c(x15), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n98_), .O(z13));
  nand4  g072(.a(new_n50_), .b(x19), .c(x18), .d(x17), .O(new_n118_));
  ...
  nand3  g076(.a(new_n121_), .b(new_n84_), .c(new_n98_), .O(new_n122_));
  inv1   g077(.a(new_n122_), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n119_), .c(new_n114_), .O(z14));
  ...
  nand4  g083(.a(new_n128_), .b(new_n125_), .c(new_n114_), .d(new_n98_), .O(z15));
  inv1   g084(.a(x23), .O(new_n130_));
  aoi21  g085(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(new_n131_));
  nand4  g086(.a(new_n120_), .b(new_n126_), .c(new_n130_), .d(new_n93_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n59_), .c(new_n98_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n131_), .c(x00), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n84_), .O(z16));
  inv1   g090(.a(x21), .O(new_n136_));
  nand4  g091(.a(new_n130_), .b(new_n93_), .c(new_n136_), .d(new_n50_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n112_), .c(x24), .O(new_n138_));
  nor2   g093(.a(x22), .b(x21), .O(new_n139_));
  nor2   g094(.a(x24), .b(x23), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n139_), .c(new_n115_), .d(new_n107_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n138_), .c(new_n59_), .d(new_n98_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(x00), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n84_), .O(z17));
  nand4  g099(.a(new_n92_), .b(new_n130_), .c(new_n93_), .d(new_n136_), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n118_), .c(x25), .O(new_n146_));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n139_), .c(new_n115_), .d(new_n107_), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n146_), .c(new_n59_), .d(new_n98_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(x00), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n84_), .O(z18));
endmodule
