...
module FAU ( 
  ...
  nand2  g19(.a(z13), .b(new_n64_), .O(z02));
  nand2  g20(.a(new_n61_), .b(z13), .O(z03));
  ...
  nor3   g30(.a(z09), .b(new_n75_), .c(x08), .O(z06));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n52_), .c(z09), .O(z08));
  zero   g37(.O(z10));
  zero   g38(.O(z11));
  one    g39(.O(z14));
  one    g40(.O(z15));
