...
module FAU ( 
  ...
  aoi21  g02(.a(x16), .b(new_n47_), .c(new_n46_), .O(z00));
  ...
  nor2   g14(.a(new_n47_), .b(new_n46_), .O(new_n60_));
  nor2   g15(.a(new_n60_), .b(x07), .O(new_n61_));
  nand3  g16(.a(new_n61_), .b(new_n59_), .c(new_n58_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nor2   g18(.a(new_n60_), .b(new_n63_), .O(z02));
  inv1   g19(.a(new_n60_), .O(new_n65_));
  nand3  g20(.a(new_n65_), .b(new_n57_), .c(new_n49_), .O(new_n66_));
  ...
  nand2  g32(.a(new_n47_), .b(x08), .O(new_n78_));
  ...
  oai21  g42(.a(new_n87_), .b(new_n59_), .c(new_n65_), .O(z09));
  nand4  g43(.a(new_n59_), .b(new_n51_), .c(new_n47_), .d(new_n86_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n59_), .c(new_n47_), .d(new_n86_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n59_), .c(new_n47_), .d(new_n86_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n65_), .O(z12));
  ...
  nand2  g58(.a(x15), .b(new_n46_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n103_), .O(z13));
  inv1   g60(.a(x21), .O(new_n106_));
  nor2   g61(.a(x20), .b(new_n53_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n94_), .c(new_n106_), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n94_), .c(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n59_), .c(new_n86_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n59_), .d(new_n86_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n115_), .c(new_n119_), .d(new_n81_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n59_), .c(new_n86_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n104_), .O(z16));
  nand4  g79(.a(new_n119_), .b(new_n81_), .c(new_n106_), .d(new_n50_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n99_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x22), .b(x21), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n127_), .c(new_n107_), .d(new_n94_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n126_), .c(new_n59_), .d(new_n86_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n104_), .O(z17));
  nand4  g87(.a(new_n80_), .b(new_n119_), .c(new_n81_), .d(new_n106_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n101_), .c(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n127_), .c(new_n107_), .d(new_n94_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n59_), .d(new_n86_), .O(new_n137_));
