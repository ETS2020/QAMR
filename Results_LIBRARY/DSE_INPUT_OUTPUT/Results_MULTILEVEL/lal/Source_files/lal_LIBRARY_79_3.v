...
module FAU ( 
  ...
  nand3  g41(.a(new_n63_), .b(new_n86_), .c(new_n85_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n62_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n47_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(new_n86_), .d(new_n85_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n62_), .c(new_n86_), .d(new_n85_), .O(new_n97_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n64_), .d(new_n86_), .O(z14));
  inv1   g65(.a(new_n99_), .O(new_n111_));
  nor3   g66(.a(x22), .b(x21), .c(x20), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n62_), .c(new_n85_), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(x22), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x15), .c(new_n105_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  aoi21  g72(.a(new_n112_), .b(new_n111_), .c(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n108_), .b(new_n111_), .c(new_n117_), .d(new_n80_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n62_), .c(new_n85_), .O(new_n120_));
  ...
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n64_), .d(new_n86_), .O(z17));
  ...
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n64_), .d(new_n86_), .O(z18));
endmodule
