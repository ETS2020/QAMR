...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n62_), .c(new_n85_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n64_), .d(new_n85_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n64_), .d(new_n85_), .O(z14));
  inv1   g60(.a(new_n98_), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n53_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n62_), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(x22), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(x07), .c(new_n85_), .O(z15));
  ...
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n64_), .d(new_n85_), .O(z16));
  nand2  g70(.a(new_n114_), .b(x24), .O(new_n116_));
  inv1   g71(.a(new_n100_), .O(new_n117_));
  nand3  g72(.a(new_n107_), .b(new_n51_), .c(new_n80_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n64_), .d(new_n85_), .O(z17));
  nand2  g76(.a(new_n120_), .b(x25), .O(new_n122_));
  nor3   g77(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n107_), .c(new_n117_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n64_), .d(new_n85_), .O(z18));
endmodule
