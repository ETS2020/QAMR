...
module FAU ( 
  ...
  nand2  g35(.a(new_n60_), .b(new_n56_), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(x22), .c(x21), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(x24), .c(new_n47_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n55_), .O(z08));
  nand4  g40(.a(new_n47_), .b(new_n51_), .c(x05), .d(x04), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n52_), .b(new_n57_), .c(new_n47_), .d(new_n51_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n52_), .c(new_n47_), .d(new_n51_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n52_), .c(new_n47_), .d(new_n51_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n50_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nand3  g55(.a(new_n94_), .b(new_n56_), .c(x19), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n52_), .d(new_n51_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(x25), .b(x15), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n103_), .O(z13));
  inv1   g60(.a(new_n53_), .O(new_n106_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n47_), .O(z14));
  inv1   g65(.a(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n56_), .c(x19), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n93_), .c(x22), .O(new_n113_));
  inv1   g68(.a(new_n99_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n56_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n52_), .d(new_n51_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n104_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n108_), .c(new_n114_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n106_), .d(new_n47_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n101_), .O(new_n125_));
  inv1   g80(.a(x24), .O(new_n126_));
  nand3  g81(.a(new_n115_), .b(new_n126_), .c(new_n80_), .O(new_n127_));
  ...
  nand3  g87(.a(new_n132_), .b(new_n115_), .c(new_n125_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n106_), .d(new_n47_), .O(z18));
endmodule
