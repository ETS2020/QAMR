...
module FAU ( 
  ...
  nand3  g19(.a(new_n60_), .b(new_n49_), .c(new_n52_), .O(new_n65_));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n52_), .c(new_n78_), .O(z08));
  nand2  g39(.a(new_n51_), .b(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x05), .c(x15), .O(z09));
  inv1   g41(.a(x04), .O(new_n87_));
  nand3  g42(.a(new_n54_), .b(new_n51_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(x05), .c(x15), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n48_), .c(new_n51_), .d(x05), .O(new_n91_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n51_), .c(new_n87_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x05), .c(x15), .O(z12));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n51_), .d(new_n87_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x05), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n48_), .O(z13));
  and2   g58(.a(new_n100_), .b(x21), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n93_), .c(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n51_), .c(new_n87_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(x05), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n48_), .O(z14));
  inv1   g64(.a(new_n98_), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n53_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n51_), .c(new_n87_), .O(new_n113_));
  aoi21  g68(.a(new_n106_), .b(x22), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n47_), .c(new_n48_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  nor2   g71(.a(new_n47_), .b(x04), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n105_), .c(new_n110_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n48_), .c(new_n51_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n117_), .c(new_n116_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n100_), .O(new_n124_));
  inv1   g79(.a(x24), .O(new_n125_));
  nand3  g80(.a(new_n111_), .b(new_n125_), .c(new_n79_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n124_), .c(x15), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n123_), .c(new_n117_), .d(new_n51_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n100_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n111_), .c(new_n124_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n51_), .d(new_n87_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(x05), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(z18));
endmodule
