...
module FAU ( 
  ...
  nand4  g19(.a(new_n64_), .b(new_n63_), .c(new_n47_), .d(new_n50_), .O(z01));
  inv1   g20(.a(new_n47_), .O(new_n66_));
  nor2   g21(.a(new_n66_), .b(new_n46_), .O(z02));
  nand2  g22(.a(new_n63_), .b(new_n47_), .O(z03));
  ...
  nand3  g35(.a(new_n80_), .b(new_n69_), .c(x06), .O(z07));
  inv1   g36(.a(x23), .O(new_n82_));
  nand3  g37(.a(new_n58_), .b(x22), .c(x21), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(x24), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n52_), .c(new_n66_), .O(z08));
  nand2  g41(.a(new_n80_), .b(new_n50_), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n64_), .c(new_n47_), .O(z09));
  nand4  g43(.a(new_n64_), .b(new_n54_), .c(new_n80_), .d(new_n50_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n47_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n64_), .c(new_n80_), .d(new_n50_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n64_), .c(new_n80_), .d(new_n50_), .O(new_n97_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(new_n80_), .O(z13));
  aoi21  g59(.a(new_n102_), .b(new_n94_), .c(new_n59_), .O(new_n105_));
  ...
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n80_), .O(new_n109_));
  inv1   g64(.a(x06), .O(new_n110_));
  nand2  g65(.a(x15), .b(new_n110_), .O(new_n111_));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n101_), .d(new_n80_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  nand3  g73(.a(new_n106_), .b(new_n82_), .c(new_n60_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n114_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n101_), .d(new_n80_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n99_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n115_), .c(new_n102_), .d(new_n94_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n64_), .d(new_n50_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n80_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n111_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n115_), .c(new_n102_), .d(new_n94_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n101_), .d(new_n80_), .O(z18));
endmodule
