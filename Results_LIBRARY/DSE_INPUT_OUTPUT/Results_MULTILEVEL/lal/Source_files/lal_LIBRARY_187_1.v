...
module FAU ( 
  ...
  nor2   g59(.a(new_n85_), .b(x07), .O(new_n105_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n105_), .d(new_n47_), .O(z15));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n105_), .d(new_n47_), .O(z16));
  ...
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n105_), .d(new_n47_), .O(z17));
  ...
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n105_), .d(new_n47_), .O(z18));
endmodule
