...
module FAU ( 
  ...
  nand3  g31(.a(new_n56_), .b(x22), .c(x21), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(x24), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(new_n50_), .c(new_n75_), .O(z08));
  ...
  oai21  g39(.a(new_n84_), .b(new_n81_), .c(new_n47_), .O(z09));
  nand4  g40(.a(new_n81_), .b(new_n52_), .c(new_n83_), .d(new_n82_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n47_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n81_), .c(new_n83_), .d(new_n82_), .O(new_n89_));
  ...
  nand4  g48(.a(new_n93_), .b(new_n81_), .c(new_n83_), .d(new_n82_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n97_), .c(new_n81_), .d(new_n83_), .O(new_n99_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n60_), .d(new_n83_), .O(z14));
  inv1   g61(.a(new_n96_), .O(new_n107_));
  nor3   g62(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n81_), .c(new_n83_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(x07), .c(new_n101_), .O(z15));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n76_), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n104_), .c(new_n107_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n81_), .c(new_n83_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n113_), .c(new_n82_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n101_), .O(z16));
  nand2  g73(.a(new_n115_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n98_), .O(new_n120_));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n49_), .c(new_n76_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n119_), .c(new_n60_), .d(new_n83_), .O(z17));
  nand2  g80(.a(new_n124_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n121_), .c(new_n120_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n60_), .d(new_n83_), .O(z18));
endmodule
