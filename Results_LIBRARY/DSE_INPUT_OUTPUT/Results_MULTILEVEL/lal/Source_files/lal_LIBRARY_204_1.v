...
module FAU ( 
  ...
  oai21  g38(.a(new_n83_), .b(new_n54_), .c(new_n55_), .O(z08));
  nand3  g39(.a(new_n50_), .b(x05), .c(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n55_), .c(x15), .O(z09));
  nand4  g41(.a(new_n51_), .b(new_n55_), .c(new_n57_), .d(new_n47_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n51_), .c(new_n50_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n55_), .c(x15), .O(z11));
  nor2   g46(.a(new_n58_), .b(new_n57_), .O(new_n92_));
  nand3  g47(.a(new_n59_), .b(x18), .c(x17), .O(new_n93_));
  oai21  g48(.a(new_n92_), .b(new_n59_), .c(new_n93_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n51_), .c(new_n55_), .d(new_n47_), .O(new_n95_));
  ...
  nor2   g56(.a(new_n101_), .b(x25), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n97_), .d(new_n47_), .O(z13));
  nor2   g58(.a(new_n101_), .b(new_n62_), .O(new_n104_));
  ...
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n55_), .O(new_n108_));
  ...
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(x25), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n97_), .d(new_n47_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n112_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  nand4  g71(.a(new_n105_), .b(new_n111_), .c(new_n115_), .d(new_n63_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n51_), .c(new_n50_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(new_n55_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  nand4  g76(.a(new_n54_), .b(new_n115_), .c(new_n63_), .d(new_n62_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n101_), .c(x25), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n97_), .d(new_n47_), .O(z17));
  nand2  g80(.a(new_n123_), .b(new_n101_), .O(new_n126_));
  nor2   g81(.a(x25), .b(x15), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n51_), .d(new_n50_), .O(z18));
endmodule
