...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n109_, new_n111_, new_n112_, new_n115_, new_n116_;
  ...
  aoi21  g40(.a(new_n85_), .b(new_n69_), .c(new_n54_), .O(new_n86_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n47_), .c(x15), .O(z10));
  nand3  g52(.a(new_n95_), .b(x17), .c(new_n91_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g54(.a(new_n95_), .b(x19), .c(new_n91_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g56(.a(new_n95_), .b(new_n56_), .c(new_n91_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n51_), .O(z13));
  nand3  g59(.a(new_n95_), .b(new_n58_), .c(new_n91_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n51_), .O(z14));
  nand3  g62(.a(new_n95_), .b(new_n59_), .c(new_n91_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n51_), .O(z15));
  nand3  g65(.a(new_n95_), .b(new_n69_), .c(new_n91_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n51_), .O(z16));
  nand4  g68(.a(new_n63_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(z17));
  nand3  g69(.a(new_n95_), .b(new_n55_), .c(new_n91_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n51_), .O(z18));
endmodule
