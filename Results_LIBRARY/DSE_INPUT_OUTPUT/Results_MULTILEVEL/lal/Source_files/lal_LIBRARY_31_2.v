...
module FAU ( 
  ...
  oai21  g30(.a(x13), .b(x08), .c(new_n67_), .O(z05));
  aoi21  g31(.a(x15), .b(x08), .c(new_n47_), .O(z06));
  ...
  nor4   g39(.a(new_n84_), .b(x15), .c(x14), .d(x07), .O(z09));
  inv1   g40(.a(x15), .O(new_n86_));
  nand4  g41(.a(new_n84_), .b(new_n53_), .c(new_n86_), .d(new_n47_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  inv1   g43(.a(x07), .O(new_n89_));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n84_), .c(new_n89_), .O(new_n91_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n84_), .c(new_n89_), .O(new_n96_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n63_), .d(new_n47_), .O(z13));
  nor2   g58(.a(new_n101_), .b(new_n58_), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n93_), .c(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n84_), .c(new_n89_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n86_), .O(z14));
  ...
  and2   g68(.a(new_n113_), .b(new_n86_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n110_), .c(new_n63_), .d(new_n47_), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  nand4  g71(.a(new_n105_), .b(new_n111_), .c(new_n79_), .d(new_n59_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n86_), .c(new_n47_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n116_), .c(new_n63_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n112_), .b(new_n50_), .c(new_n79_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n101_), .c(x15), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n63_), .d(new_n47_), .O(z17));
  oai21  g80(.a(new_n122_), .b(new_n100_), .c(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n112_), .c(new_n101_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n84_), .d(new_n89_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n86_), .O(z18));
endmodule
