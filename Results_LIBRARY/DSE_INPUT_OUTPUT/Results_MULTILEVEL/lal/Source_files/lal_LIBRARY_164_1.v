...
module FAU ( 
  ...
  aoi21  g25(.a(new_n46_), .b(x02), .c(x15), .O(new_n71_));
  ...
  oai21  g37(.a(new_n71_), .b(x11), .c(new_n82_), .O(z04));
  ...
  nand3  g48(.a(new_n65_), .b(new_n47_), .c(new_n93_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z09));
  nand4  g50(.a(new_n64_), .b(new_n54_), .c(new_n47_), .d(new_n93_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n64_), .c(new_n47_), .d(new_n93_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n64_), .c(new_n47_), .d(new_n93_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n64_), .d(new_n93_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand2  g66(.a(x15), .b(x11), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(z13));
  aoi21  g68(.a(new_n108_), .b(new_n101_), .c(new_n59_), .O(new_n114_));
  nor2   g69(.a(x21), .b(x20), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n101_), .c(x19), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n64_), .c(new_n93_), .O(new_n117_));
  ...
  nand3  g77(.a(new_n122_), .b(new_n64_), .c(new_n93_), .O(new_n123_));
  aoi21  g78(.a(new_n116_), .b(x22), .c(new_n123_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x15), .c(new_n112_), .O(z15));
  aoi21  g80(.a(new_n121_), .b(new_n120_), .c(new_n88_), .O(new_n126_));
  nand4  g81(.a(new_n115_), .b(new_n120_), .c(new_n88_), .d(new_n60_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n64_), .c(new_n93_), .O(new_n128_));
  ...
  nand4  g88(.a(new_n133_), .b(new_n132_), .c(new_n108_), .d(new_n101_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n131_), .c(new_n64_), .d(new_n93_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n112_), .O(z17));
  nand2  g92(.a(new_n134_), .b(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n132_), .c(new_n108_), .d(new_n101_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n66_), .d(new_n47_), .O(z18));
endmodule
