...
module FAU ( 
  ...
  nor3   g36(.a(new_n81_), .b(new_n47_), .c(x02), .O(new_n82_));
  aoi21  g37(.a(new_n47_), .b(x02), .c(new_n82_), .O(new_n83_));
  ...
  aoi21  g61(.a(new_n106_), .b(new_n47_), .c(x15), .O(z12));
  ...
  nand4  g68(.a(new_n113_), .b(new_n109_), .c(new_n64_), .d(new_n47_), .O(z13));
  aoi21  g69(.a(new_n110_), .b(new_n103_), .c(new_n59_), .O(new_n115_));
  nor2   g70(.a(x21), .b(x20), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n103_), .c(x19), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n97_), .c(new_n94_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n115_), .c(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n81_), .O(z14));
  nand2  g75(.a(new_n117_), .b(x22), .O(new_n121_));
  inv1   g76(.a(new_n108_), .O(new_n122_));
  nand2  g77(.a(new_n60_), .b(new_n59_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(x20), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n121_), .c(new_n97_), .d(new_n94_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n81_), .O(z15));
  aoi21  g83(.a(new_n124_), .b(new_n122_), .c(new_n89_), .O(new_n129_));
  nand4  g84(.a(new_n116_), .b(new_n122_), .c(new_n89_), .d(new_n60_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n97_), .c(new_n94_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n129_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n81_), .O(z16));
  nand2  g88(.a(new_n130_), .b(x24), .O(new_n134_));
  inv1   g89(.a(new_n123_), .O(new_n135_));
  nor2   g90(.a(x24), .b(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n135_), .c(new_n110_), .d(new_n103_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n97_), .d(new_n94_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n47_), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n81_), .O(z17));
  nand2  g95(.a(new_n137_), .b(x25), .O(new_n141_));
  nand3  g96(.a(new_n52_), .b(new_n51_), .c(new_n89_), .O(new_n142_));
  nor2   g97(.a(new_n142_), .b(new_n123_), .O(new_n143_));
  aoi21  g98(.a(new_n143_), .b(new_n112_), .c(x15), .O(new_n144_));
  nand4  g99(.a(new_n144_), .b(new_n141_), .c(new_n64_), .d(new_n47_), .O(z18));
endmodule
