...
module FAU ( 
  ...
  oai21  g15(.a(new_n60_), .b(new_n52_), .c(new_n53_), .O(new_n61_));
  ...
  oai21  g33(.a(new_n52_), .b(new_n78_), .c(new_n53_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  nand4  g35(.a(new_n59_), .b(x24), .c(x22), .d(x21), .O(new_n81_));
  ...
  oai21  g41(.a(new_n86_), .b(new_n83_), .c(new_n48_), .O(z09));
  nand4  g42(.a(new_n83_), .b(new_n55_), .c(new_n85_), .d(new_n84_), .O(new_n88_));
  ...
  nand2  g46(.a(new_n91_), .b(new_n48_), .O(z11));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n62_), .d(new_n85_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n62_), .d(new_n85_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nand4  g69(.a(new_n106_), .b(new_n110_), .c(new_n78_), .d(new_n47_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n62_), .d(new_n85_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  inv1   g72(.a(new_n100_), .O(new_n118_));
  nand3  g73(.a(new_n111_), .b(new_n52_), .c(new_n78_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n62_), .d(new_n85_), .O(z17));
  oai21  g77(.a(new_n119_), .b(new_n100_), .c(x25), .O(new_n123_));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n111_), .c(new_n118_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n62_), .d(new_n85_), .O(z18));
endmodule
