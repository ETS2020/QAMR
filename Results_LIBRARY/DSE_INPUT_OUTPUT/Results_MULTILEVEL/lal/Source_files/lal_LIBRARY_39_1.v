...
module FAU ( 
  ...
  nor2   g03(.a(new_n48_), .b(x06), .O(new_n49_));
  ...
  nand3  g42(.a(new_n64_), .b(new_n48_), .c(new_n87_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n87_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n63_), .c(new_n48_), .d(new_n87_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n63_), .c(new_n48_), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n63_), .d(new_n87_), .O(new_n103_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n65_), .d(new_n48_), .O(z14));
  inv1   g65(.a(new_n100_), .O(new_n111_));
  nor3   g66(.a(x22), .b(x21), .c(x20), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n63_), .c(new_n87_), .O(new_n114_));
  ...
  nand4  g73(.a(new_n108_), .b(new_n111_), .c(new_n117_), .d(new_n82_), .O(new_n119_));
  ...
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n65_), .d(new_n48_), .O(z17));
  ...
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n65_), .d(new_n48_), .O(z18));
endmodule
