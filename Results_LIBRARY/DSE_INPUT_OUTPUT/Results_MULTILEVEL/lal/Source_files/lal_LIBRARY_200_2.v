...
module FAU ( 
  ...
  nand4  g20(.a(new_n65_), .b(new_n64_), .c(new_n51_), .d(new_n50_), .O(z01));
  inv1   g21(.a(x16), .O(new_n67_));
  nor2   g22(.a(new_n48_), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n64_), .b(new_n51_), .O(z03));
  ...
  nand4  g60(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n50_), .O(z13));
  aoi21  g61(.a(new_n102_), .b(new_n94_), .c(new_n60_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n94_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n65_), .c(new_n50_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n90_), .O(z14));
  ...
  and2   g71(.a(new_n116_), .b(new_n90_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n101_), .d(new_n50_), .O(z15));
  nand2  g73(.a(new_n116_), .b(x23), .O(new_n119_));
  nand3  g74(.a(new_n108_), .b(new_n81_), .c(new_n61_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n114_), .c(x15), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n119_), .c(new_n101_), .d(new_n50_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n65_), .d(new_n50_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n90_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  and2   g86(.a(new_n131_), .b(new_n115_), .O(new_n132_));
  aoi21  g87(.a(new_n132_), .b(new_n104_), .c(x15), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n101_), .d(new_n50_), .O(z18));
endmodule
