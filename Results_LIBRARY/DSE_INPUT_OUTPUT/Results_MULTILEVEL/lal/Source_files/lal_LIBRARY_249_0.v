...
module FAU ( 
  ...
  nand3  g45(.a(new_n54_), .b(x05), .c(x04), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(x19), .c(x15), .O(z09));
  inv1   g47(.a(x17), .O(new_n93_));
  nand4  g48(.a(new_n55_), .b(x19), .c(new_n93_), .d(new_n60_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n55_), .c(x19), .d(new_n60_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z11));
  nand2  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n55_), .c(x19), .d(new_n60_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(x07), .O(z12));
  inv1   g56(.a(new_n56_), .O(new_n102_));
  nand2  g57(.a(new_n99_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n58_), .b(x18), .c(x17), .O(new_n104_));
  and2   g59(.a(new_n104_), .b(x19), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n60_), .O(z13));
  ...
  oai21  g66(.a(new_n111_), .b(new_n61_), .c(new_n60_), .O(z14));
  nand2  g67(.a(new_n109_), .b(x22), .O(new_n113_));
  inv1   g68(.a(x21), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n58_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n99_), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(new_n61_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n113_), .c(new_n102_), .d(new_n60_), .O(z15));
  oai21  g74(.a(new_n116_), .b(new_n99_), .c(x23), .O(new_n120_));
  inv1   g75(.a(x18), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n121_), .O(new_n122_));
  nor2   g77(.a(x23), .b(x22), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n114_), .d(x17), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n55_), .d(new_n54_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x19), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n60_), .O(z16));
  nand3  g82(.a(new_n50_), .b(new_n115_), .c(new_n114_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n104_), .c(x24), .O(new_n129_));
  ...
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n55_), .d(new_n54_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(x19), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n60_), .O(z17));
  nand4  g90(.a(new_n68_), .b(new_n50_), .c(new_n115_), .d(new_n114_), .O(new_n136_));
  oai21  g91(.a(new_n136_), .b(new_n104_), .c(x25), .O(new_n137_));
  nor2   g92(.a(x25), .b(x24), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n123_), .c(new_n108_), .d(new_n107_), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n55_), .d(new_n54_), .O(new_n140_));
  nand2  g95(.a(new_n140_), .b(x19), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(new_n60_), .O(z18));
endmodule
