...
module FAU ( 
  ...
  nand2  g42(.a(new_n87_), .b(new_n66_), .O(z09));
  nand4  g43(.a(new_n60_), .b(new_n52_), .c(new_n47_), .d(new_n86_), .O(new_n89_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n92_), .c(new_n86_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n66_), .O(z12));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n86_), .O(new_n105_));
  ...
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n47_), .O(z14));
  ...
  nand3  g76(.a(new_n110_), .b(new_n120_), .c(new_n81_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n101_), .c(new_n86_), .O(new_n123_));
  ...
  nand4  g83(.a(new_n128_), .b(new_n127_), .c(new_n103_), .d(new_n96_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n126_), .c(new_n86_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n92_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n127_), .c(new_n103_), .d(new_n96_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n109_), .d(new_n47_), .O(z18));
endmodule
