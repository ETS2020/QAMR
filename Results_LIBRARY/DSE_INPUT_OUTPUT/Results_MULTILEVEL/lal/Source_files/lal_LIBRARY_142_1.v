...
module FAU ( 
  ...
  nand3  g09(.a(new_n54_), .b(new_n52_), .c(new_n51_), .O(new_n55_));
  ...
  oai21  g21(.a(new_n66_), .b(new_n59_), .c(x22), .O(new_n67_));
  ...
  nand2  g29(.a(new_n74_), .b(x15), .O(new_n75_));
  ...
  nand2  g43(.a(new_n65_), .b(new_n60_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(x22), .c(x21), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n57_), .c(new_n88_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(x25), .c(x15), .O(new_n92_));
  nand2  g47(.a(new_n72_), .b(new_n58_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n47_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n92_), .O(z08));
  nor4   g50(.a(new_n52_), .b(x22), .c(x15), .d(x07), .O(z09));
  nand3  g51(.a(new_n52_), .b(new_n62_), .c(new_n51_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n52_), .c(new_n51_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n47_), .c(x15), .O(z11));
  nor2   g56(.a(new_n63_), .b(new_n62_), .O(new_n102_));
  nand3  g57(.a(new_n64_), .b(x18), .c(x17), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n64_), .c(new_n103_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n52_), .c(new_n47_), .d(new_n59_), .O(new_n105_));
  nor2   g60(.a(new_n105_), .b(x07), .O(z12));
  nand3  g61(.a(x19), .b(x18), .c(x17), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(x20), .O(new_n108_));
  nor2   g63(.a(x20), .b(new_n64_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n102_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n52_), .d(new_n51_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n59_), .O(z13));
  nor2   g68(.a(x21), .b(x20), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n102_), .c(x19), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n52_), .c(new_n51_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n110_), .b(x21), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n117_), .c(new_n47_), .d(new_n59_), .O(z14));
  nand2  g74(.a(new_n117_), .b(new_n59_), .O(z15));
  inv1   g75(.a(new_n107_), .O(new_n121_));
  nor3   g76(.a(x23), .b(x21), .c(x20), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n52_), .c(new_n51_), .O(new_n124_));
  aoi21  g79(.a(new_n115_), .b(x23), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x22), .c(new_n59_), .O(z16));
  aoi21  g81(.a(new_n122_), .b(new_n121_), .c(new_n88_), .O(new_n127_));
  nand4  g82(.a(new_n114_), .b(new_n121_), .c(new_n88_), .d(new_n57_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n52_), .c(new_n51_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n127_), .c(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n59_), .O(z17));
  nor2   g86(.a(x23), .b(x21), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n109_), .c(new_n102_), .d(new_n53_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n52_), .c(new_n51_), .O(new_n134_));
  aoi21  g89(.a(new_n128_), .b(x25), .c(new_n134_), .O(new_n135_));
  oai21  g90(.a(new_n135_), .b(x22), .c(new_n59_), .O(z18));
endmodule
