...
module FAU ( 
  ...
  aoi21  g20(.a(new_n65_), .b(new_n62_), .c(new_n49_), .O(z01));
  ...
  oai21  g34(.a(new_n79_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g35(.a(x24), .O(new_n81_));
  inv1   g36(.a(x22), .O(new_n82_));
  aoi21  g37(.a(new_n58_), .b(new_n54_), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g43(.a(new_n63_), .b(new_n55_), .c(new_n79_), .d(new_n88_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x06), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n63_), .c(new_n79_), .d(new_n88_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n63_), .c(new_n79_), .d(new_n88_), .O(new_n97_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n79_), .c(new_n88_), .O(new_n109_));
  ...
  nand2  g69(.a(new_n82_), .b(new_n114_), .O(new_n115_));
  nor2   g70(.a(new_n115_), .b(x20), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n112_), .c(new_n63_), .d(new_n88_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n79_), .O(z15));
  inv1   g75(.a(x23), .O(new_n121_));
  aoi21  g76(.a(new_n116_), .b(new_n113_), .c(new_n121_), .O(new_n122_));
  nand4  g77(.a(new_n107_), .b(new_n113_), .c(new_n121_), .d(new_n82_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n63_), .c(new_n88_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n122_), .c(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n79_), .O(z16));
  nand2  g81(.a(new_n123_), .b(x24), .O(new_n127_));
  inv1   g82(.a(new_n101_), .O(new_n128_));
  nor2   g83(.a(x22), .b(x21), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n81_), .c(new_n121_), .O(new_n130_));
  inv1   g85(.a(new_n130_), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(new_n128_), .c(x15), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n127_), .c(new_n106_), .d(new_n88_), .O(z17));
  oai21  g88(.a(new_n130_), .b(new_n101_), .c(x25), .O(new_n134_));
  nand3  g89(.a(new_n53_), .b(new_n81_), .c(new_n121_), .O(new_n135_));
  nor2   g90(.a(new_n135_), .b(new_n115_), .O(new_n136_));
  aoi21  g91(.a(new_n136_), .b(new_n128_), .c(x15), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n106_), .d(new_n88_), .O(z18));
endmodule
