...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n89_, new_n91_, new_n93_, new_n96_, new_n97_, new_n99_, new_n100_,
  ...
  nand2  g17(.a(x18), .b(x15), .O(new_n63_));
  oai21  g18(.a(new_n62_), .b(x18), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g45(.a(new_n57_), .b(x05), .c(x04), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n47_), .c(x15), .O(z09));
  nand2  g47(.a(new_n58_), .b(new_n47_), .O(new_n93_));
  nor4   g48(.a(new_n93_), .b(x17), .c(x15), .d(x07), .O(z10));
  nor4   g49(.a(new_n93_), .b(new_n84_), .c(x15), .d(x07), .O(z11));
  inv1   g50(.a(x15), .O(new_n96_));
  nand4  g51(.a(new_n58_), .b(x19), .c(new_n47_), .d(new_n96_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z12));
  nand3  g53(.a(new_n58_), .b(new_n96_), .c(new_n57_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n61_), .c(new_n47_), .O(z13));
  nand3  g56(.a(new_n58_), .b(new_n52_), .c(new_n57_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n96_), .O(z14));
  nand3  g59(.a(new_n100_), .b(new_n53_), .c(new_n47_), .O(z15));
  nand3  g60(.a(new_n58_), .b(new_n54_), .c(new_n57_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n96_), .O(z16));
  nand3  g63(.a(new_n100_), .b(new_n83_), .c(new_n47_), .O(z17));
  nand3  g64(.a(new_n100_), .b(new_n51_), .c(new_n47_), .O(z18));
endmodule
