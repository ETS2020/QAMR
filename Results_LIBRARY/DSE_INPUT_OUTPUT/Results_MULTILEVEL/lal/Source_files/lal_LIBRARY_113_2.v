...
module FAU ( 
  ...
  aoi21  g018(.a(new_n63_), .b(new_n60_), .c(new_n50_), .O(z01));
  inv1   g019(.a(x16), .O(new_n65_));
  nand2  g020(.a(new_n48_), .b(new_n65_), .O(z02));
  nand3  g021(.a(new_n59_), .b(new_n48_), .c(new_n51_), .O(new_n67_));
  ...
  oai21  g034(.a(new_n79_), .b(new_n72_), .c(new_n48_), .O(new_n80_));
  inv1   g035(.a(x12), .O(new_n81_));
  nor2   g036(.a(new_n81_), .b(x03), .O(new_n82_));
  nor2   g037(.a(new_n47_), .b(x12), .O(new_n83_));
  aoi21  g038(.a(new_n83_), .b(x03), .c(new_n82_), .O(new_n84_));
  ...
  nand2  g045(.a(new_n56_), .b(new_n52_), .O(new_n91_));
  ...
  aoi21  g049(.a(new_n94_), .b(new_n51_), .c(new_n50_), .O(z08));
  inv1   g050(.a(x03), .O(new_n96_));
  inv1   g051(.a(x07), .O(new_n97_));
  nand3  g052(.a(new_n97_), .b(x05), .c(x04), .O(new_n98_));
  aoi21  g053(.a(new_n98_), .b(new_n96_), .c(x15), .O(z09));
  nand3  g054(.a(new_n61_), .b(new_n53_), .c(new_n97_), .O(new_n100_));
  aoi21  g055(.a(new_n100_), .b(new_n96_), .c(x15), .O(z10));
  xor2a  g056(.a(x18), .b(x17), .O(new_n102_));
  nand3  g057(.a(new_n102_), .b(new_n61_), .c(new_n97_), .O(new_n103_));
  aoi21  g058(.a(new_n103_), .b(new_n96_), .c(x15), .O(z11));
  ...
  nand3  g062(.a(new_n107_), .b(new_n61_), .c(new_n97_), .O(new_n108_));
  ...
  nand4  g066(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n111_), .c(new_n61_), .d(new_n97_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n96_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n47_), .O(z13));
  and2   g070(.a(new_n112_), .b(x21), .O(new_n116_));
  nor2   g071(.a(x21), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n105_), .c(x19), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n61_), .c(new_n97_), .O(new_n119_));
  oai21  g074(.a(new_n119_), .b(new_n116_), .c(new_n96_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n47_), .O(z14));
  ...
  nand3  g079(.a(new_n124_), .b(new_n61_), .c(new_n97_), .O(new_n125_));
  aoi21  g080(.a(new_n118_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(x03), .c(new_n47_), .O(z15));
  nand2  g082(.a(new_n124_), .b(x23), .O(new_n128_));
  nor2   g083(.a(new_n62_), .b(x03), .O(new_n129_));
  nor2   g084(.a(x23), .b(x22), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n117_), .c(new_n122_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n47_), .c(new_n97_), .O(new_n132_));
  inv1   g087(.a(new_n132_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n129_), .c(new_n128_), .O(z16));
  nand2  g089(.a(new_n131_), .b(x24), .O(new_n135_));
  inv1   g090(.a(new_n112_), .O(new_n136_));
  inv1   g091(.a(x24), .O(new_n137_));
  nand3  g092(.a(new_n123_), .b(new_n137_), .c(new_n90_), .O(new_n138_));
  inv1   g093(.a(new_n138_), .O(new_n139_));
  aoi21  g094(.a(new_n139_), .b(new_n136_), .c(x15), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n135_), .c(new_n129_), .d(new_n97_), .O(z17));
  oai21  g096(.a(new_n138_), .b(new_n112_), .c(x25), .O(new_n142_));
  nor3   g097(.a(x25), .b(x24), .c(x23), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n123_), .c(new_n136_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n142_), .c(new_n61_), .d(new_n97_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n47_), .O(z18));
endmodule
