...
module FAU ( 
  ...
  nand4  g44(.a(new_n89_), .b(new_n60_), .c(new_n47_), .d(new_n50_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n60_), .O(new_n100_));
  ...
  nor2   g63(.a(new_n61_), .b(x07), .O(new_n109_));
  ...
  nand4  g72(.a(new_n103_), .b(new_n117_), .c(new_n115_), .d(new_n81_), .O(new_n118_));
  ...
  nand2  g83(.a(new_n128_), .b(new_n50_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n109_), .d(new_n47_), .O(z18));
endmodule
