...
module FAU ( 
  ...
  nand2  g31(.a(new_n76_), .b(new_n64_), .O(z06));
  nand2  g32(.a(new_n46_), .b(x06), .O(z07));
  inv1   g33(.a(x24), .O(new_n79_));
  inv1   g34(.a(x22), .O(new_n80_));
  aoi21  g35(.a(new_n53_), .b(new_n49_), .c(new_n80_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(x21), .c(x23), .O(new_n82_));
  nor2   g37(.a(new_n60_), .b(x25), .O(new_n83_));
  oai21  g38(.a(new_n82_), .b(new_n79_), .c(new_n83_), .O(z08));
  inv1   g39(.a(x07), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(x05), .c(x04), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n46_), .c(x15), .O(z09));
  inv1   g42(.a(x15), .O(new_n88_));
  nand4  g43(.a(new_n58_), .b(new_n50_), .c(new_n88_), .d(new_n46_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n58_), .c(new_n88_), .d(new_n46_), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(x07), .O(z11));
  nor2   g48(.a(new_n51_), .b(new_n50_), .O(new_n94_));
  nand3  g49(.a(new_n52_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(new_n52_), .c(new_n95_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n58_), .c(new_n85_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n46_), .c(x15), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nor2   g55(.a(new_n59_), .b(x07), .O(new_n101_));
  nor2   g56(.a(x20), .b(new_n52_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(x15), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n46_), .O(z13));
  inv1   g61(.a(x21), .O(new_n107_));
  aoi21  g62(.a(new_n102_), .b(new_n94_), .c(new_n107_), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n94_), .c(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n58_), .c(new_n85_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n108_), .c(new_n46_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n88_), .O(z14));
  nand2  g68(.a(new_n110_), .b(x22), .O(new_n114_));
  inv1   g69(.a(new_n99_), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n49_), .O(new_n117_));
  and2   g72(.a(new_n117_), .b(new_n88_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n101_), .d(new_n46_), .O(z15));
  nand2  g74(.a(new_n117_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n80_), .c(new_n107_), .d(new_n49_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n115_), .c(x15), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n101_), .d(new_n46_), .O(z16));
  oai21  g80(.a(new_n122_), .b(new_n99_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n116_), .c(new_n102_), .d(new_n94_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n58_), .d(new_n85_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n46_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n88_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  and2   g88(.a(new_n133_), .b(new_n116_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n104_), .c(x15), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n132_), .c(new_n101_), .d(new_n46_), .O(z18));
endmodule
