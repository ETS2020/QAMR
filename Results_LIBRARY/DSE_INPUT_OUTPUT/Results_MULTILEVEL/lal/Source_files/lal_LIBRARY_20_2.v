...
module FAU ( 
  ...
  nand3  g26(.a(new_n71_), .b(new_n64_), .c(new_n46_), .O(new_n72_));
  inv1   g27(.a(new_n72_), .O(z04));
  nor3   g28(.a(new_n61_), .b(x13), .c(x08), .O(z05));
  inv1   g29(.a(x14), .O(new_n75_));
  nor3   g30(.a(new_n61_), .b(new_n75_), .c(x08), .O(z06));
  nand3  g31(.a(new_n64_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nor2   g36(.a(new_n61_), .b(x25), .O(new_n82_));
  oai21  g37(.a(new_n81_), .b(new_n78_), .c(new_n82_), .O(z08));
  inv1   g38(.a(x07), .O(new_n84_));
  nand3  g39(.a(new_n60_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z09));
  nand4  g41(.a(new_n59_), .b(new_n51_), .c(new_n47_), .d(new_n84_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n64_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n59_), .c(new_n47_), .d(new_n84_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n64_), .O(z11));
  ...
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n47_), .d(new_n84_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nor2   g54(.a(new_n60_), .b(x07), .O(new_n100_));
  ...
  nor2   g59(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n93_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n59_), .c(new_n84_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n47_), .O(new_n109_));
  nand2  g64(.a(x16), .b(x15), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n109_), .O(z14));
  nand3  g66(.a(new_n103_), .b(new_n50_), .c(x19), .O(new_n112_));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n59_), .d(new_n84_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n110_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n106_), .b(new_n114_), .c(new_n121_), .d(new_n79_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n100_), .d(new_n47_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  nand4  g79(.a(new_n78_), .b(new_n121_), .c(new_n79_), .d(new_n103_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n104_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n100_), .d(new_n47_), .O(z17));
  oai21  g83(.a(new_n125_), .b(new_n101_), .c(x25), .O(new_n129_));
  nor2   g84(.a(x20), .b(new_n53_), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n115_), .c(new_n130_), .d(new_n93_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n59_), .d(new_n84_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n110_), .O(z18));
  buf    g90(.a(x16), .O(z02));
endmodule
