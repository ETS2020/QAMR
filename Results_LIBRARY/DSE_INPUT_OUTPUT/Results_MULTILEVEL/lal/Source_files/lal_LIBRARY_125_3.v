...
module FAU ( 
  ...
  nor2   g57(.a(new_n88_), .b(x07), .O(new_n103_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n87_), .c(new_n86_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(new_n48_), .O(new_n111_));
  nand2  g66(.a(x15), .b(new_n47_), .O(new_n112_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n103_), .d(new_n48_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  inv1   g74(.a(x23), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n115_), .c(new_n120_), .d(new_n81_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n103_), .d(new_n48_), .O(z16));
  nand2  g77(.a(new_n121_), .b(x24), .O(new_n123_));
  nand3  g78(.a(new_n116_), .b(new_n80_), .c(new_n120_), .O(new_n124_));
  or2    g79(.a(new_n124_), .b(new_n105_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n103_), .d(new_n48_), .O(z17));
  oai21  g81(.a(new_n124_), .b(new_n105_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n116_), .c(new_n104_), .d(new_n96_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n87_), .d(new_n86_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n112_), .O(z18));
endmodule
