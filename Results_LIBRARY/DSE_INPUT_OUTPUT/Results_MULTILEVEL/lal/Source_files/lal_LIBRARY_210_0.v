...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x05), .O(new_n47_));
  ...
  aoi21  g12(.a(new_n57_), .b(new_n49_), .c(x07), .O(new_n58_));
  nand2  g13(.a(x05), .b(x04), .O(new_n59_));
  oai21  g14(.a(new_n58_), .b(new_n47_), .c(new_n59_), .O(z01));
  inv1   g15(.a(x16), .O(new_n61_));
  nor2   g16(.a(new_n47_), .b(new_n61_), .O(z02));
  inv1   g17(.a(new_n47_), .O(new_n63_));
  nand2  g18(.a(new_n57_), .b(new_n49_), .O(new_n64_));
  nand2  g19(.a(new_n64_), .b(new_n63_), .O(z03));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n49_), .c(new_n47_), .O(z08));
  ...
  nand3  g42(.a(new_n51_), .b(new_n83_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(x05), .c(x15), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n83_), .c(new_n87_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(x05), .c(x15), .O(z11));
  nor2   g47(.a(new_n52_), .b(new_n51_), .O(new_n93_));
  ...
  nand2  g57(.a(new_n102_), .b(new_n93_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(x15), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n101_), .c(new_n99_), .d(new_n83_), .O(z13));
  and2   g61(.a(new_n103_), .b(x21), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n93_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n83_), .c(new_n87_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(x05), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n84_), .O(z14));
  inv1   g67(.a(new_n98_), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n50_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n83_), .c(new_n87_), .O(new_n116_));
  aoi21  g71(.a(new_n109_), .b(x22), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n100_), .c(new_n84_), .O(z15));
  nand2  g73(.a(new_n115_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n108_), .c(new_n113_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n84_), .c(new_n83_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n101_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  inv1   g80(.a(x24), .O(new_n126_));
  nand3  g81(.a(new_n114_), .b(new_n126_), .c(new_n77_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n104_), .c(x15), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n101_), .d(new_n83_), .O(z17));
  oai21  g85(.a(new_n127_), .b(new_n103_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n114_), .c(new_n102_), .d(new_n93_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n83_), .d(new_n87_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x05), .O(new_n135_));
