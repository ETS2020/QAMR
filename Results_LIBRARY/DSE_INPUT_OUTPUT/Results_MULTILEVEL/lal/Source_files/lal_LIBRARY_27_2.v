...
module FAU ( 
  ...
  oai21  g31(.a(x13), .b(x08), .c(new_n64_), .O(z05));
  ...
  nand4  g44(.a(new_n87_), .b(new_n52_), .c(new_n89_), .d(new_n47_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x07), .O(z10));
  inv1   g46(.a(x07), .O(new_n92_));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n87_), .c(new_n92_), .O(new_n94_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n87_), .c(new_n92_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n87_), .d(new_n92_), .O(new_n104_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n87_), .c(new_n92_), .O(new_n110_));
  ...
  and2   g71(.a(new_n116_), .b(new_n89_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n60_), .d(new_n47_), .O(z15));
  ...
  nand3  g76(.a(new_n121_), .b(new_n89_), .c(new_n47_), .O(new_n122_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n125_), .c(new_n87_), .d(new_n92_), .O(new_n131_));
  ...
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n87_), .d(new_n92_), .O(new_n137_));
