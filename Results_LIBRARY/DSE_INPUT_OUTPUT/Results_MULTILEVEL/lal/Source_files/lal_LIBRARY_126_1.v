...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n100_, new_n102_, new_n103_, new_n106_, new_n107_, new_n110_,
    new_n111_;
  ...
  oai21  g24(.a(x18), .b(x17), .c(new_n47_), .O(new_n70_));
  ...
  nand3  g41(.a(new_n47_), .b(new_n86_), .c(new_n85_), .O(new_n87_));
  ...
  nor4   g47(.a(new_n92_), .b(x19), .c(x15), .d(x07), .O(z09));
  inv1   g48(.a(x07), .O(new_n94_));
  nand3  g49(.a(new_n92_), .b(new_n85_), .c(new_n94_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n92_), .c(new_n94_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n47_), .c(x15), .O(z11));
  nand4  g54(.a(new_n92_), .b(x18), .c(x17), .d(new_n94_), .O(new_n100_));
  ...
  nand3  g60(.a(new_n92_), .b(new_n59_), .c(new_n94_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n51_), .O(z15));
  nand3  g63(.a(new_n103_), .b(new_n69_), .c(new_n47_), .O(z16));
  nand3  g64(.a(new_n92_), .b(new_n54_), .c(new_n94_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n51_), .O(z17));
  nand3  g67(.a(new_n103_), .b(new_n55_), .c(new_n47_), .O(z18));
endmodule
