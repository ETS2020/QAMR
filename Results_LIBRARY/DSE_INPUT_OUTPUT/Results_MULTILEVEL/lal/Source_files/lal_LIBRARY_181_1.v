...
module FAU ( 
  ...
  nand4  g52(.a(new_n95_), .b(new_n47_), .c(x17), .d(new_n50_), .O(new_n98_));
  ...
  nand2  g56(.a(new_n62_), .b(new_n50_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n55_), .c(new_n47_), .O(z13));
  nand3  g59(.a(new_n95_), .b(new_n57_), .c(new_n91_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n50_), .O(z14));
  nand3  g62(.a(new_n95_), .b(new_n58_), .c(new_n91_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n50_), .O(z15));
  nand3  g65(.a(new_n103_), .b(new_n69_), .c(new_n47_), .O(z16));
  nand3  g66(.a(new_n95_), .b(new_n53_), .c(new_n91_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n50_), .O(z17));
  nand3  g69(.a(new_n95_), .b(new_n54_), .c(new_n91_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n50_), .O(z18));
endmodule
