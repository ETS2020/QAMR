...
module FAU ( 
  ...
  inv1   g40(.a(new_n63_), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n47_), .c(new_n62_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand2  g43(.a(new_n63_), .b(new_n54_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n47_), .c(x07), .O(z10));
  ...
  nand4  g51(.a(new_n96_), .b(new_n63_), .c(new_n47_), .d(new_n62_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nor2   g55(.a(new_n86_), .b(x07), .O(new_n101_));
  nand4  g56(.a(new_n53_), .b(x19), .c(x18), .d(x17), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n47_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n101_), .d(new_n47_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n101_), .O(z15));
  ...
  nand2  g72(.a(new_n117_), .b(new_n62_), .O(z16));
  nand2  g73(.a(new_n115_), .b(x24), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n51_), .c(new_n113_), .O(new_n121_));
  or2    g76(.a(new_n121_), .b(new_n102_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n119_), .c(new_n101_), .d(new_n47_), .O(z17));
  oai21  g78(.a(new_n121_), .b(new_n102_), .c(x25), .O(new_n124_));
  nor2   g79(.a(x20), .b(new_n56_), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n120_), .c(new_n125_), .d(new_n94_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n124_), .c(new_n63_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n62_), .O(z18));
endmodule
