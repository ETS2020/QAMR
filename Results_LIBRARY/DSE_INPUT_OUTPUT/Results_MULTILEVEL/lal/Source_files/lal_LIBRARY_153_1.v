...
module FAU ( 
  ...
  nand3  g59(.a(new_n92_), .b(new_n58_), .c(new_n94_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n50_), .O(z15));
  nand3  g62(.a(new_n92_), .b(new_n69_), .c(new_n94_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n50_), .O(z16));
  nand3  g65(.a(new_n92_), .b(new_n53_), .c(new_n94_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n50_), .O(z17));
  nand3  g68(.a(new_n92_), .b(new_n54_), .c(new_n94_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n50_), .O(z18));
endmodule
