...
module FAU ( 
  ...
  nand3  g47(.a(new_n58_), .b(new_n84_), .c(new_n57_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g49(.a(x15), .O(new_n95_));
  nand4  g50(.a(new_n58_), .b(new_n47_), .c(x17), .d(new_n95_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z11));
  nand3  g52(.a(new_n58_), .b(x19), .c(new_n57_), .O(new_n98_));
  ...
  nand3  g57(.a(new_n58_), .b(new_n95_), .c(new_n57_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n52_), .c(new_n47_), .O(z14));
  nand3  g60(.a(new_n104_), .b(new_n53_), .c(new_n47_), .O(z15));
  nand3  g61(.a(new_n104_), .b(new_n54_), .c(new_n47_), .O(z16));
  nand3  g62(.a(new_n58_), .b(new_n83_), .c(new_n57_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n95_), .O(z17));
  nand3  g65(.a(new_n58_), .b(new_n51_), .c(new_n57_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n95_), .O(z18));
endmodule
