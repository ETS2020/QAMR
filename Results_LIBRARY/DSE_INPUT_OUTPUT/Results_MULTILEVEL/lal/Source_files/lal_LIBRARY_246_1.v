...
module FAU ( 
  ...
  nand4  g19(.a(new_n64_), .b(new_n63_), .c(new_n50_), .d(new_n53_), .O(z01));
  ...
  aoi21  g29(.a(new_n48_), .b(x08), .c(x13), .O(z05));
  ...
  nand3  g40(.a(new_n85_), .b(new_n48_), .c(new_n53_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n64_), .b(new_n56_), .c(new_n48_), .d(new_n53_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n50_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n64_), .c(new_n48_), .d(new_n53_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n64_), .c(new_n48_), .d(new_n53_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nor2   g54(.a(new_n85_), .b(x07), .O(new_n100_));
  nand4  g55(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n48_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n100_), .d(new_n48_), .O(z14));
  inv1   g61(.a(new_n98_), .O(new_n107_));
  nor3   g62(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n64_), .c(new_n53_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  nand2  g66(.a(x15), .b(x13), .O(new_n112_));
  oai21  g67(.a(new_n111_), .b(x15), .c(new_n112_), .O(z15));
  ...
  nand3  g71(.a(new_n116_), .b(new_n64_), .c(new_n53_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n114_), .c(new_n48_), .O(new_n118_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n79_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n121_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n120_), .c(new_n100_), .d(new_n48_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n101_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n123_), .c(new_n121_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n64_), .d(new_n53_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n112_), .O(z18));
endmodule
