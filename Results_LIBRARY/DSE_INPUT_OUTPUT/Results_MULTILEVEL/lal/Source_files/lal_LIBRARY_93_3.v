...
module FAU ( 
  ...
  nand3  g42(.a(new_n66_), .b(new_n48_), .c(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n65_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n65_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n65_), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n65_), .d(new_n48_), .O(new_n104_));
  ...
  aoi21  g62(.a(new_n102_), .b(new_n95_), .c(new_n60_), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n95_), .c(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n65_), .c(new_n48_), .O(new_n111_));
  ...
  nand4  g74(.a(new_n109_), .b(new_n115_), .c(new_n83_), .d(new_n61_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n65_), .c(new_n48_), .O(new_n121_));
  ...
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n67_), .d(new_n48_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n67_), .d(new_n48_), .O(z18));
endmodule
