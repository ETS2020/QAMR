...
module FAU ( 
  ...
  nor2   g09(.a(x25), .b(x24), .O(new_n55_));
  nor3   g10(.a(new_n55_), .b(new_n54_), .c(x07), .O(new_n56_));
  ...
  oai21  g23(.a(new_n56_), .b(new_n49_), .c(new_n68_), .O(z01));
  inv1   g24(.a(x24), .O(new_n70_));
  nand2  g25(.a(new_n65_), .b(new_n60_), .O(new_n71_));
  nor2   g26(.a(new_n48_), .b(new_n61_), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(new_n71_), .c(x23), .O(new_n73_));
  oai21  g28(.a(new_n73_), .b(new_n70_), .c(new_n58_), .O(new_n74_));
  ...
  nor3   g39(.a(new_n49_), .b(new_n84_), .c(x08), .O(z06));
  aoi21  g40(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  nand3  g41(.a(new_n71_), .b(x22), .c(x21), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n57_), .c(new_n70_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(x25), .c(x15), .O(new_n89_));
  oai21  g44(.a(new_n70_), .b(new_n57_), .c(new_n58_), .O(new_n90_));
  ...
  aoi21  g49(.a(new_n94_), .b(new_n48_), .c(x15), .O(z09));
  nand4  g50(.a(new_n53_), .b(new_n48_), .c(new_n62_), .d(new_n59_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n53_), .c(new_n93_), .O(new_n99_));
  ...
  nand3  g58(.a(new_n103_), .b(new_n53_), .c(new_n93_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n48_), .c(x15), .O(z12));
  nand3  g60(.a(x19), .b(x18), .c(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nor2   g62(.a(new_n54_), .b(x07), .O(new_n108_));
  nor2   g63(.a(x20), .b(new_n64_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n101_), .c(x22), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n59_), .O(z13));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n101_), .c(x19), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n53_), .c(new_n93_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n48_), .O(new_n115_));
  nand2  g70(.a(new_n109_), .b(new_n101_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(x21), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n48_), .d(new_n59_), .O(z14));
  nand2  g73(.a(new_n115_), .b(new_n59_), .O(z15));
  inv1   g74(.a(new_n106_), .O(new_n120_));
  nor2   g75(.a(x23), .b(x21), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n60_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n53_), .c(new_n93_), .O(new_n123_));
  aoi21  g78(.a(new_n113_), .b(x23), .c(new_n123_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x22), .c(new_n59_), .O(z16));
  nand2  g80(.a(new_n122_), .b(x24), .O(new_n126_));
  nand4  g81(.a(new_n112_), .b(new_n120_), .c(new_n70_), .d(new_n57_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n48_), .c(new_n59_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n126_), .c(new_n108_), .O(z17));
  nand4  g85(.a(new_n121_), .b(new_n109_), .c(new_n101_), .d(new_n55_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n53_), .c(new_n93_), .O(new_n132_));
  aoi21  g87(.a(new_n127_), .b(x25), .c(new_n132_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(x22), .c(new_n59_), .O(z18));
endmodule
