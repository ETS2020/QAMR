...
module FAU ( 
  ...
  nor2   g16(.a(new_n48_), .b(x07), .O(new_n62_));
  nand3  g17(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nor2   g19(.a(new_n48_), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n59_), .b(new_n49_), .c(new_n51_), .O(new_n66_));
  ...
  nand3  g27(.a(new_n72_), .b(new_n47_), .c(new_n46_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(z04));
  nor3   g29(.a(x15), .b(x13), .c(x08), .O(z05));
  nand3  g30(.a(new_n47_), .b(x14), .c(new_n46_), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z06));
  oai21  g32(.a(x15), .b(x06), .c(new_n46_), .O(z07));
  ...
  oai21  g41(.a(new_n86_), .b(new_n61_), .c(new_n49_), .O(z09));
  ...
  nand2  g57(.a(x15), .b(x08), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(z13));
  inv1   g59(.a(x21), .O(new_n105_));
  nor2   g60(.a(x20), .b(new_n55_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n93_), .c(new_n105_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n93_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n61_), .c(new_n85_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n103_), .O(z14));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n61_), .d(new_n85_), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  aoi21  g73(.a(new_n115_), .b(new_n114_), .c(new_n118_), .O(new_n119_));
  nand4  g74(.a(new_n108_), .b(new_n114_), .c(new_n118_), .d(new_n80_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n61_), .c(new_n85_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n103_), .O(z16));
  nand4  g78(.a(new_n118_), .b(new_n80_), .c(new_n105_), .d(new_n52_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n98_), .c(x24), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n106_), .d(new_n93_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n61_), .d(new_n85_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n103_), .O(z17));
  nand4  g86(.a(new_n79_), .b(new_n118_), .c(new_n80_), .d(new_n105_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n100_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n126_), .c(new_n106_), .d(new_n93_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n61_), .d(new_n85_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n103_), .O(z18));
endmodule
