...
module FAU ( 
  ...
  nor3   g39(.a(new_n47_), .b(new_n84_), .c(x08), .O(z06));
  ...
  nor4   g45(.a(new_n56_), .b(new_n59_), .c(x15), .d(x07), .O(z09));
  nand3  g46(.a(new_n56_), .b(new_n61_), .c(new_n55_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x20), .c(x15), .O(z10));
  inv1   g48(.a(x15), .O(new_n94_));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n56_), .c(x20), .d(new_n94_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z11));
  oai21  g52(.a(new_n62_), .b(new_n61_), .c(x19), .O(new_n98_));
  nand3  g53(.a(new_n63_), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n56_), .c(x20), .d(new_n94_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x07), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n57_), .c(x20), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n94_), .O(z13));
  nand3  g60(.a(new_n56_), .b(new_n50_), .c(new_n55_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n94_), .O(z14));
  inv1   g63(.a(new_n57_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n51_), .c(x20), .d(new_n94_), .O(z15));
  nand3  g65(.a(new_n56_), .b(new_n52_), .c(new_n55_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x20), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n94_), .O(z16));
  nand3  g68(.a(new_n56_), .b(new_n70_), .c(new_n55_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x20), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n94_), .O(z17));
  nand4  g71(.a(new_n109_), .b(new_n60_), .c(x20), .d(new_n94_), .O(z18));
endmodule
