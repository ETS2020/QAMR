...
module FAU ( 
  ...
  nand2  g18(.a(new_n63_), .b(new_n47_), .O(z02));
  inv1   g19(.a(new_n49_), .O(new_n65_));
  nand2  g20(.a(new_n60_), .b(new_n65_), .O(z03));
  ...
  nand3  g26(.a(new_n71_), .b(new_n65_), .c(new_n46_), .O(new_n72_));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n51_), .c(new_n49_), .O(z08));
  nand2  g37(.a(x05), .b(x04), .O(new_n83_));
  inv1   g38(.a(x07), .O(new_n84_));
  nand2  g39(.a(new_n47_), .b(new_n84_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n83_), .c(new_n65_), .O(z09));
  nand4  g41(.a(new_n83_), .b(new_n53_), .c(new_n47_), .d(new_n84_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n83_), .c(new_n47_), .d(new_n84_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n83_), .c(new_n47_), .d(new_n84_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n98_), .c(new_n83_), .d(new_n84_), .O(new_n100_));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n61_), .d(new_n47_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n99_), .O(new_n119_));
  nand3  g74(.a(new_n109_), .b(new_n50_), .c(new_n78_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n61_), .d(new_n47_), .O(z17));
  oai21  g78(.a(new_n120_), .b(new_n99_), .c(x25), .O(new_n124_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n109_), .c(new_n119_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n83_), .d(new_n84_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n102_), .O(z18));
endmodule
