...
module FAU ( 
  ...
  nand3  g41(.a(new_n61_), .b(new_n86_), .c(new_n47_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n60_), .b(new_n52_), .c(new_n86_), .d(new_n47_), .O(new_n89_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n62_), .d(new_n86_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n62_), .d(new_n86_), .O(z14));
  ...
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n62_), .d(new_n86_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  nor2   g67(.a(x23), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n104_), .c(new_n108_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n62_), .d(new_n86_), .O(z16));
  ...
  nand4  g76(.a(new_n121_), .b(new_n116_), .c(new_n62_), .d(new_n86_), .O(z17));
  nand2  g77(.a(new_n121_), .b(x25), .O(new_n123_));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n109_), .c(new_n117_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n62_), .d(new_n86_), .O(z18));
endmodule
