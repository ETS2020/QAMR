...
module FAU ( 
  ...
  aoi21  g22(.a(new_n67_), .b(new_n64_), .c(new_n49_), .O(z01));
  ...
  nand4  g45(.a(new_n65_), .b(new_n55_), .c(new_n48_), .d(new_n88_), .O(new_n91_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n67_), .d(new_n48_), .O(z13));
  inv1   g59(.a(new_n103_), .O(new_n105_));
  nor2   g60(.a(new_n105_), .b(new_n60_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n96_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n65_), .c(new_n88_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n48_), .O(new_n110_));
  nand2  g65(.a(x15), .b(new_n47_), .O(new_n111_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n67_), .O(z15));
  aoi21  g72(.a(new_n115_), .b(new_n114_), .c(new_n83_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n114_), .c(new_n83_), .d(new_n61_), .O(new_n119_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n52_), .c(new_n83_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n105_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n67_), .d(new_n48_), .O(z17));
  oai21  g83(.a(new_n125_), .b(new_n103_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n124_), .c(new_n105_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n65_), .d(new_n88_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n48_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n111_), .O(z18));
endmodule
