...
module FAU ( 
  ...
  oai21  g07(.a(new_n52_), .b(new_n51_), .c(x19), .O(new_n53_));
  ...
  nand2  g23(.a(new_n62_), .b(new_n53_), .O(z03));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n81_), .c(new_n54_), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(x25), .O(new_n84_));
  nor3   g39(.a(x19), .b(x18), .c(x17), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(x24), .c(x22), .d(x21), .O(new_n86_));
  oai21  g41(.a(new_n84_), .b(new_n48_), .c(new_n86_), .O(z08));
  nor4   g42(.a(new_n63_), .b(x19), .c(x15), .d(x07), .O(z09));
  inv1   g43(.a(x17), .O(new_n89_));
  nor2   g44(.a(new_n64_), .b(x19), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n63_), .c(new_n47_), .d(new_n51_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z11));
  nand4  g50(.a(new_n90_), .b(x18), .c(x17), .d(new_n51_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z12));
  nand2  g52(.a(new_n65_), .b(new_n51_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n56_), .c(new_n47_), .O(z13));
  inv1   g55(.a(x07), .O(new_n101_));
  nand3  g56(.a(new_n63_), .b(new_n58_), .c(new_n101_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n51_), .O(z14));
  nand3  g59(.a(new_n63_), .b(new_n59_), .c(new_n101_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n51_), .O(z15));
  nand3  g62(.a(new_n63_), .b(new_n81_), .c(new_n101_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n51_), .O(z16));
  nand3  g65(.a(new_n99_), .b(new_n54_), .c(new_n47_), .O(z17));
  nand3  g66(.a(new_n63_), .b(new_n55_), .c(new_n101_), .O(new_n112_));
