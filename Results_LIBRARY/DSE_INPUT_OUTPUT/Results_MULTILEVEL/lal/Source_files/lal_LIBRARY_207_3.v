...
module FAU ( 
  ...
  nor2   g64(.a(new_n63_), .b(x07), .O(new_n110_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n62_), .c(new_n48_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n120_), .c(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n65_), .O(z16));
  ...
  nand4  g85(.a(new_n130_), .b(new_n127_), .c(new_n110_), .d(new_n48_), .O(z17));
  oai21  g86(.a(new_n129_), .b(new_n105_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n115_), .c(new_n104_), .d(new_n97_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n62_), .d(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n65_), .O(z18));
endmodule
