...
module FAU ( 
  ...
  nor3   g03(.a(z09), .b(x16), .c(new_n46_), .O(z00));
  inv1   g04(.a(x07), .O(new_n50_));
  inv1   g05(.a(x15), .O(new_n51_));
  oai21  g06(.a(new_n51_), .b(x04), .c(x05), .O(new_n52_));
  ...
  nand3  g17(.a(new_n62_), .b(new_n52_), .c(new_n50_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nor2   g19(.a(z09), .b(new_n64_), .O(z02));
  inv1   g20(.a(z09), .O(new_n66_));
  ...
  nor2   g40(.a(x07), .b(x05), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n55_), .c(new_n51_), .O(new_n87_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n50_), .O(new_n102_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n86_), .d(new_n51_), .O(z14));
  ...
  nand2  g69(.a(new_n114_), .b(new_n51_), .O(z15));
  inv1   g70(.a(x23), .O(new_n116_));
  aoi21  g71(.a(new_n111_), .b(new_n110_), .c(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n106_), .b(new_n116_), .c(new_n81_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n98_), .c(new_n50_), .O(new_n119_));
  ...
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n100_), .d(new_n93_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n50_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n51_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n123_), .c(new_n100_), .d(new_n93_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n86_), .d(new_n51_), .O(z18));
endmodule
