...
module FAU ( 
  ...
  aoi21  g36(.a(new_n81_), .b(new_n52_), .c(new_n48_), .O(z08));
  nor2   g37(.a(new_n62_), .b(x15), .O(z09));
  nand2  g38(.a(x05), .b(x04), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n54_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g41(.a(x15), .O(new_n87_));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n84_), .c(new_n87_), .d(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z11));
  nor2   g45(.a(new_n55_), .b(new_n54_), .O(new_n91_));
  nand3  g46(.a(new_n56_), .b(x18), .c(x17), .O(new_n92_));
  oai21  g47(.a(new_n91_), .b(new_n56_), .c(new_n92_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n84_), .c(new_n87_), .d(new_n47_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z12));
  nand3  g50(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n91_), .b(new_n53_), .c(x19), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n84_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n87_), .O(z13));
  nand2  g56(.a(new_n98_), .b(x21), .O(new_n102_));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n91_), .c(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n62_), .d(new_n87_), .O(z14));
  inv1   g60(.a(new_n96_), .O(new_n106_));
  nor3   g61(.a(x22), .b(x21), .c(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n84_), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(x22), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(x07), .c(new_n87_), .O(z15));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n78_), .O(new_n112_));
  nor2   g67(.a(x23), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n103_), .c(new_n106_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n84_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n112_), .c(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n87_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n98_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n51_), .c(new_n78_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n62_), .d(new_n87_), .O(z17));
  nand2  g79(.a(new_n123_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n119_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n62_), .d(new_n87_), .O(z18));
endmodule
