...
module FAU ( 
  ...
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n64_), .O(new_n102_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n66_), .d(new_n85_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n99_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n65_), .O(new_n112_));
  ...
  nand4  g72(.a(new_n106_), .b(new_n110_), .c(new_n116_), .d(new_n80_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n64_), .O(new_n119_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n53_), .c(new_n116_), .O(new_n124_));
  or2    g79(.a(new_n124_), .b(new_n101_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n122_), .c(new_n66_), .d(new_n85_), .O(z17));
  oai21  g81(.a(new_n124_), .b(new_n101_), .c(x25), .O(new_n127_));
  nor2   g82(.a(x20), .b(new_n58_), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n123_), .c(new_n128_), .d(new_n94_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n127_), .c(new_n64_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n85_), .O(z18));
endmodule
