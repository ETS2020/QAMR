// Benchmark "FAU" written by ABC on Fri Aug 14 00:09:37 2020
...
module FAU ( 
  ...
  aoi21  g18(.a(new_n63_), .b(new_n62_), .c(new_n48_), .O(z01));
  ...
  aoi22  g25(.a(x11), .b(new_n70_), .c(new_n69_), .d(x01), .O(new_n71_));
  oai21  g26(.a(new_n69_), .b(x01), .c(new_n71_), .O(new_n72_));
  ...
  oai21  g34(.a(new_n79_), .b(new_n72_), .c(new_n67_), .O(new_n80_));
  inv1   g35(.a(x15), .O(new_n81_));
  nor3   g36(.a(new_n81_), .b(new_n47_), .c(x00), .O(new_n82_));
  aoi21  g37(.a(new_n47_), .b(x00), .c(new_n82_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(new_n80_), .c(x08), .O(z04));
  nor3   g39(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  inv1   g40(.a(x14), .O(new_n86_));
  nor3   g41(.a(new_n48_), .b(new_n86_), .c(x08), .O(z06));
  aoi21  g42(.a(new_n46_), .b(x06), .c(new_n48_), .O(z07));
  aoi21  g43(.a(new_n56_), .b(new_n52_), .c(new_n59_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(x21), .c(x23), .O(new_n90_));
  nor2   g45(.a(new_n48_), .b(x25), .O(new_n91_));
  oai21  g46(.a(new_n90_), .b(new_n50_), .c(new_n91_), .O(z08));
  nand2  g47(.a(x05), .b(x04), .O(new_n93_));
  nor4   g48(.a(new_n93_), .b(x15), .c(x09), .d(x07), .O(z09));
  inv1   g49(.a(x07), .O(new_n95_));
  nand3  g50(.a(new_n93_), .b(new_n53_), .c(new_n95_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n93_), .c(new_n95_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n47_), .c(x15), .O(z11));
  nor2   g55(.a(new_n54_), .b(new_n53_), .O(new_n101_));
  nand3  g56(.a(new_n55_), .b(x18), .c(x17), .O(new_n102_));
  oai21  g57(.a(new_n101_), .b(new_n55_), .c(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n93_), .c(new_n95_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g60(.a(x19), .b(x18), .c(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nor2   g62(.a(x20), .b(new_n55_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n101_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(x15), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n107_), .c(new_n63_), .d(new_n47_), .O(z13));
  ...
  nand3  g70(.a(new_n115_), .b(new_n81_), .c(new_n47_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n113_), .c(new_n63_), .O(z14));
  nand2  g73(.a(new_n115_), .b(x22), .O(new_n119_));
  inv1   g74(.a(new_n106_), .O(new_n120_));
  nand2  g75(.a(new_n59_), .b(new_n58_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(x20), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n93_), .d(new_n95_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n81_), .O(z15));
  inv1   g81(.a(x23), .O(new_n127_));
  aoi21  g82(.a(new_n122_), .b(new_n120_), .c(new_n127_), .O(new_n128_));
  nand4  g83(.a(new_n114_), .b(new_n120_), .c(new_n127_), .d(new_n59_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n93_), .c(new_n95_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n128_), .c(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n81_), .O(z16));
  nand2  g87(.a(new_n129_), .b(x24), .O(new_n133_));
  inv1   g88(.a(new_n121_), .O(new_n134_));
  nor2   g89(.a(x24), .b(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n108_), .d(new_n101_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n93_), .d(new_n95_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n81_), .O(z17));
  nand2  g94(.a(new_n136_), .b(x25), .O(new_n140_));
  nand3  g95(.a(new_n51_), .b(new_n50_), .c(new_n127_), .O(new_n141_));
  nor2   g96(.a(new_n141_), .b(new_n121_), .O(new_n142_));
  aoi21  g97(.a(new_n142_), .b(new_n110_), .c(x15), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n140_), .c(new_n63_), .d(new_n47_), .O(z18));
endmodule
