...
module FAU ( 
  ...
  oai21  g23(.a(x08), .b(x02), .c(x15), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(x11), .O(new_n70_));
  ...
  nand2  g31(.a(new_n47_), .b(x02), .O(new_n77_));
  ...
  nand3  g41(.a(new_n58_), .b(x22), .c(x21), .O(new_n87_));
  ...
  nor4   g46(.a(new_n91_), .b(x15), .c(x11), .d(x07), .O(z09));
  inv1   g47(.a(x15), .O(new_n93_));
  nand4  g48(.a(new_n91_), .b(new_n54_), .c(new_n93_), .d(new_n47_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n91_), .c(new_n93_), .d(new_n47_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n91_), .c(new_n93_), .d(new_n47_), .O(new_n102_));
  nor2   g57(.a(new_n102_), .b(x07), .O(z12));
  inv1   g58(.a(x07), .O(new_n104_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n91_), .d(new_n104_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n47_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n93_), .O(z13));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n99_), .c(x19), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n91_), .c(new_n104_), .O(new_n114_));
  aoi21  g69(.a(new_n108_), .b(x21), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x11), .c(new_n93_), .O(z14));
  nand2  g71(.a(new_n113_), .b(x22), .O(new_n117_));
  inv1   g72(.a(new_n105_), .O(new_n118_));
  nand2  g73(.a(new_n60_), .b(new_n59_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(x20), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n91_), .d(new_n104_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n93_), .O(z15));
  aoi21  g79(.a(new_n120_), .b(new_n118_), .c(new_n86_), .O(new_n125_));
  nand4  g80(.a(new_n112_), .b(new_n118_), .c(new_n86_), .d(new_n60_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n91_), .c(new_n104_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n125_), .c(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n93_), .O(z16));
  nand2  g84(.a(new_n126_), .b(x24), .O(new_n130_));
  inv1   g85(.a(new_n119_), .O(new_n131_));
  nor2   g86(.a(x24), .b(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n131_), .c(new_n107_), .d(new_n99_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n91_), .d(new_n104_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n93_), .O(z17));
  nand2  g91(.a(new_n133_), .b(x25), .O(new_n137_));
  inv1   g92(.a(new_n108_), .O(new_n138_));
  nand3  g93(.a(new_n52_), .b(new_n51_), .c(new_n86_), .O(new_n139_));
  nor2   g94(.a(new_n139_), .b(new_n119_), .O(new_n140_));
  aoi21  g95(.a(new_n140_), .b(new_n138_), .c(x15), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n137_), .c(new_n64_), .d(new_n47_), .O(z18));
endmodule
