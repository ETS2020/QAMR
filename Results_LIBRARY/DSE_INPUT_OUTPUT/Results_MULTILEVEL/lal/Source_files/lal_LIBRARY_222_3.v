...
module FAU ( 
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n62_), .d(new_n48_), .O(new_n104_));
  ...
  nor2   g68(.a(new_n63_), .b(x07), .O(new_n114_));
  ...
  nand3  g73(.a(new_n118_), .b(new_n114_), .c(new_n113_), .O(z15));
  nor2   g74(.a(new_n117_), .b(new_n82_), .O(new_n120_));
  inv1   g75(.a(new_n100_), .O(new_n121_));
  nor2   g76(.a(x23), .b(x22), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n108_), .c(new_n121_), .O(new_n123_));
  ...
  nand3  g83(.a(new_n115_), .b(new_n128_), .c(new_n82_), .O(new_n129_));
  or2    g84(.a(new_n129_), .b(new_n103_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n127_), .c(new_n114_), .d(new_n48_), .O(z17));
  oai21  g86(.a(new_n129_), .b(new_n103_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n115_), .c(new_n102_), .d(new_n95_), .O(new_n134_));
