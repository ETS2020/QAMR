...
module FAU ( 
  ...
  nand4  g55(.a(new_n100_), .b(new_n98_), .c(new_n60_), .d(new_n85_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n60_), .d(new_n85_), .O(z14));
  ...
  nand3  g64(.a(new_n109_), .b(new_n106_), .c(new_n60_), .O(z15));
  inv1   g65(.a(x23), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(new_n107_), .c(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n103_), .b(new_n111_), .c(new_n79_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n97_), .c(new_n86_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n112_), .c(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n85_), .O(z16));
  oai21  g71(.a(new_n113_), .b(new_n97_), .c(x24), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n118_), .c(new_n99_), .d(new_n92_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n117_), .c(new_n86_), .O(new_n121_));
  ...
  nand4  g80(.a(new_n125_), .b(new_n118_), .c(new_n99_), .d(new_n92_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n60_), .d(new_n85_), .O(z18));
endmodule
