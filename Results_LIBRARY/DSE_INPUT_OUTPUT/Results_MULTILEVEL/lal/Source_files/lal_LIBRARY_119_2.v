...
module FAU ( 
  ...
  oai21  g65(.a(new_n110_), .b(x07), .c(new_n95_), .O(z15));
  ...
  nand3  g75(.a(new_n120_), .b(new_n53_), .c(new_n78_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n64_), .d(new_n95_), .O(z17));
  oai21  g79(.a(new_n121_), .b(new_n98_), .c(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n119_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n84_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n95_), .O(z18));
endmodule
