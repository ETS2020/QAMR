...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n85_), .d(new_n47_), .O(new_n96_));
  ...
  oai21  g72(.a(new_n117_), .b(new_n98_), .c(new_n61_), .O(new_n118_));
  ...
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n93_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n121_), .c(new_n61_), .O(new_n126_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n123_), .c(new_n122_), .d(new_n93_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n63_), .d(new_n85_), .O(z18));
endmodule
