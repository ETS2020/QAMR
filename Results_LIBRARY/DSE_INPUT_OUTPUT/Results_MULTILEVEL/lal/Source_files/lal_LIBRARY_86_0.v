...
module FAU ( 
  ...
  nand4  g16(.a(new_n61_), .b(new_n60_), .c(x15), .d(new_n50_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nand2  g18(.a(z13), .b(new_n63_), .O(z02));
  nand3  g19(.a(new_n59_), .b(z13), .c(new_n51_), .O(new_n65_));
  ...
  one    g41(.O(z17));
  one    g42(.O(z18));
  inv1   g43(.a(z10), .O(z14));
  inv1   g44(.a(z10), .O(z15));
  inv1   g45(.a(z10), .O(z16));
endmodule
