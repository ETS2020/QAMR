...
module FAU ( 
  ...
  oai21  g30(.a(x15), .b(new_n46_), .c(x06), .O(z07));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n50_), .c(new_n49_), .O(z08));
  ...
  nand4  g42(.a(new_n83_), .b(new_n52_), .c(new_n85_), .d(new_n84_), .O(new_n88_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n99_), .c(new_n60_), .d(new_n85_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n60_), .d(new_n85_), .O(z14));
  inv1   g61(.a(new_n98_), .O(new_n107_));
  nor2   g62(.a(x22), .b(x21), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n51_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n83_), .c(new_n84_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  inv1   g66(.a(x06), .O(new_n112_));
  nand2  g67(.a(x15), .b(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n111_), .b(x15), .c(new_n113_), .O(z15));
  nand2  g69(.a(new_n109_), .b(x23), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n104_), .c(new_n107_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n60_), .d(new_n85_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n108_), .c(new_n100_), .d(new_n93_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n83_), .d(new_n84_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n85_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n113_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n108_), .c(new_n100_), .d(new_n93_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n60_), .d(new_n85_), .O(z18));
endmodule
