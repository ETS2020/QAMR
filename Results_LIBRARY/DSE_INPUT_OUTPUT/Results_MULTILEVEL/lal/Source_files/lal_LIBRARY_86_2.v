...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n60_), .c(new_n47_), .d(new_n86_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n60_), .c(new_n47_), .d(new_n86_), .O(new_n97_));
  ...
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n61_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n86_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(z15));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n80_), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n105_), .c(new_n111_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n60_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n117_), .c(new_n86_), .O(new_n121_));
  ...
  nand4  g84(.a(new_n129_), .b(new_n123_), .c(new_n62_), .d(new_n47_), .O(z17));
  nand2  g85(.a(new_n129_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n125_), .c(new_n124_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n62_), .d(new_n47_), .O(z18));
endmodule
