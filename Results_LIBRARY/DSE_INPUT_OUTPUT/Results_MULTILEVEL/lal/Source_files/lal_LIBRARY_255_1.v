...
module FAU ( 
  ...
  nand4  g51(.a(new_n57_), .b(new_n47_), .c(new_n69_), .d(new_n56_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  nand3  g53(.a(new_n57_), .b(x18), .c(new_n56_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g55(.a(new_n57_), .b(x19), .c(new_n56_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g57(.a(new_n57_), .b(new_n60_), .c(new_n56_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n69_), .O(z13));
  nand3  g60(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n69_), .O(z14));
  nand3  g63(.a(new_n57_), .b(new_n69_), .c(new_n56_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n52_), .c(new_n47_), .O(z15));
  ...
  nand3  g69(.a(new_n110_), .b(new_n72_), .c(new_n47_), .O(z17));
  nand3  g70(.a(new_n57_), .b(new_n61_), .c(new_n56_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n69_), .O(z18));
endmodule
