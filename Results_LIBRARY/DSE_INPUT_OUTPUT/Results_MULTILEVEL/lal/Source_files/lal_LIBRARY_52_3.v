...
module FAU ( 
  ...
  nand3  g18(.a(new_n57_), .b(new_n47_), .c(new_n49_), .O(new_n64_));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n49_), .c(new_n79_), .O(z08));
  inv1   g40(.a(x07), .O(new_n86_));
  inv1   g41(.a(x15), .O(new_n87_));
  nand3  g42(.a(new_n60_), .b(new_n87_), .c(new_n86_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n59_), .b(new_n51_), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n59_), .c(new_n87_), .d(new_n86_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n47_), .O(z11));
  nor2   g49(.a(new_n52_), .b(new_n51_), .O(new_n95_));
  nand3  g50(.a(new_n53_), .b(x18), .c(x17), .O(new_n96_));
  oai21  g51(.a(new_n95_), .b(new_n53_), .c(new_n96_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n59_), .c(new_n87_), .d(new_n86_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n59_), .d(new_n87_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  nand2  g60(.a(new_n87_), .b(x07), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(z13));
  inv1   g62(.a(x21), .O(new_n108_));
  aoi21  g63(.a(new_n102_), .b(new_n95_), .c(new_n108_), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n95_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n59_), .c(new_n87_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n109_), .c(new_n86_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n106_), .O(z14));
  inv1   g69(.a(new_n100_), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n50_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n59_), .c(new_n87_), .O(new_n118_));
  aoi21  g73(.a(new_n111_), .b(x22), .c(new_n118_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(x07), .c(new_n106_), .O(z15));
  ...
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n61_), .d(new_n87_), .O(z16));
  nand2  g79(.a(new_n123_), .b(x24), .O(new_n125_));
  inv1   g80(.a(new_n103_), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n116_), .c(new_n126_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n61_), .d(new_n87_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n61_), .d(new_n87_), .O(z18));
endmodule
