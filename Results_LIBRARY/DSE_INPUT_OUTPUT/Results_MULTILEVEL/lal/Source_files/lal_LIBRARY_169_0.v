...
module FAU ( 
  ...
  aoi21  g33(.a(x15), .b(new_n78_), .c(x08), .O(z06));
  ...
  aoi21  g43(.a(new_n88_), .b(x08), .c(x15), .O(z09));
  inv1   g44(.a(x15), .O(new_n90_));
  nand4  g45(.a(new_n60_), .b(new_n52_), .c(new_n90_), .d(x08), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n60_), .c(new_n90_), .d(x08), .O(new_n94_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n60_), .c(new_n87_), .O(new_n99_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n103_), .c(new_n102_), .d(x08), .O(z13));
  inv1   g63(.a(x21), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(new_n96_), .c(new_n109_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n96_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n60_), .c(new_n87_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n110_), .c(x08), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n90_), .O(z14));
  nand2  g70(.a(new_n112_), .b(x22), .O(new_n116_));
  inv1   g71(.a(new_n101_), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n51_), .O(new_n119_));
  and2   g74(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n103_), .d(x08), .O(z15));
  nand2  g76(.a(new_n119_), .b(x23), .O(new_n122_));
  inv1   g77(.a(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n82_), .c(new_n109_), .d(new_n51_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n117_), .c(x15), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n122_), .c(new_n103_), .d(x08), .O(z16));
  oai21  g82(.a(new_n124_), .b(new_n101_), .c(x24), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n118_), .c(new_n104_), .d(new_n96_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n60_), .d(new_n87_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(x08), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n90_), .O(z17));
  nand2  g88(.a(new_n130_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  and2   g90(.a(new_n135_), .b(new_n118_), .O(new_n136_));
  aoi21  g91(.a(new_n136_), .b(new_n106_), .c(x15), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n103_), .d(x08), .O(z18));
endmodule
