...
module FAU ( 
  ...
  nand3  g14(.a(x15), .b(x05), .c(x04), .O(new_n60_));
  oai21  g15(.a(new_n59_), .b(z09), .c(new_n60_), .O(z01));
  inv1   g16(.a(x16), .O(new_n62_));
  nor2   g17(.a(z09), .b(new_n62_), .O(z02));
  inv1   g18(.a(z09), .O(new_n64_));
  ...
  nor2   g39(.a(x07), .b(x04), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n52_), .c(new_n84_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  inv1   g42(.a(x07), .O(new_n88_));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n84_), .c(new_n88_), .d(new_n47_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n88_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n85_), .d(new_n84_), .O(z14));
  inv1   g61(.a(new_n97_), .O(new_n107_));
  nor2   g62(.a(x22), .b(x21), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n51_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n88_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(x04), .c(new_n84_), .O(z15));
  nand2  g67(.a(new_n109_), .b(x23), .O(new_n113_));
  inv1   g68(.a(x23), .O(new_n114_));
  nand4  g69(.a(new_n104_), .b(new_n107_), .c(new_n114_), .d(new_n79_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n85_), .d(new_n84_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  inv1   g72(.a(new_n99_), .O(new_n118_));
  nand3  g73(.a(new_n108_), .b(new_n78_), .c(new_n114_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n117_), .c(new_n88_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n84_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n108_), .c(new_n118_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n85_), .d(new_n84_), .O(z18));
endmodule
