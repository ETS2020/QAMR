...
module FAU ( 
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n63_), .d(new_n86_), .O(z13));
  ...
  nand2  g73(.a(new_n118_), .b(new_n86_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n120_), .c(new_n63_), .d(new_n86_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n63_), .d(new_n86_), .O(z18));
endmodule
