...
module FAU ( 
  ...
  nand3  g31(.a(new_n47_), .b(x14), .c(new_n46_), .O(new_n77_));
  ...
  nand2  g36(.a(new_n54_), .b(new_n50_), .O(new_n82_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n49_), .c(new_n80_), .O(z08));
  inv1   g41(.a(x07), .O(new_n87_));
  inv1   g42(.a(x15), .O(new_n88_));
  nand3  g43(.a(new_n60_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n59_), .b(new_n51_), .c(new_n88_), .d(new_n87_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n59_), .c(new_n88_), .d(new_n87_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n47_), .O(z11));
  nor2   g50(.a(new_n52_), .b(new_n51_), .O(new_n96_));
  nand3  g51(.a(new_n53_), .b(x18), .c(x17), .O(new_n97_));
  oai21  g52(.a(new_n96_), .b(new_n53_), .c(new_n97_), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n59_), .c(new_n88_), .d(new_n87_), .O(new_n99_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n59_), .d(new_n88_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  nand2  g61(.a(new_n88_), .b(x07), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z13));
  inv1   g63(.a(x21), .O(new_n109_));
  aoi21  g64(.a(new_n103_), .b(new_n96_), .c(new_n109_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n96_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n59_), .c(new_n88_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n110_), .c(new_n87_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n107_), .O(z14));
  inv1   g70(.a(new_n101_), .O(new_n116_));
  nor2   g71(.a(x22), .b(x21), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n50_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n59_), .c(new_n88_), .O(new_n119_));
  aoi21  g74(.a(new_n112_), .b(x22), .c(new_n119_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(x07), .c(new_n107_), .O(z15));
  ...
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n61_), .d(new_n88_), .O(z16));
  nand2  g80(.a(new_n124_), .b(x24), .O(new_n126_));
  inv1   g81(.a(new_n104_), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n117_), .c(new_n127_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n126_), .c(new_n61_), .d(new_n88_), .O(z17));
  nand2  g85(.a(new_n129_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n117_), .c(new_n127_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n61_), .d(new_n88_), .O(z18));
endmodule
