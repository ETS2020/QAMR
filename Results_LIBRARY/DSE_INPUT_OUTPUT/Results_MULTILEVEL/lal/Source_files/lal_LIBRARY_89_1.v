...
module FAU ( 
  ...
  nand3  g49(.a(new_n94_), .b(new_n58_), .c(new_n57_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n47_), .c(x15), .O(z11));
  nand4  g51(.a(new_n58_), .b(x18), .c(x17), .d(new_n57_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x15), .O(z12));
  inv1   g53(.a(x15), .O(new_n99_));
  nand3  g54(.a(new_n58_), .b(new_n99_), .c(new_n57_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n61_), .c(new_n47_), .O(z13));
