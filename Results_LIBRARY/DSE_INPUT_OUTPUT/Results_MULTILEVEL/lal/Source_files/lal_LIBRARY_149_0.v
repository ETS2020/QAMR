...
module FAU ( 
  ...
  nand2  g14(.a(x24), .b(x15), .O(new_n60_));
  oai21  g15(.a(new_n60_), .b(new_n59_), .c(new_n50_), .O(new_n61_));
  ...
  aoi21  g20(.a(new_n55_), .b(new_n51_), .c(new_n57_), .O(new_n66_));
  oai21  g21(.a(new_n66_), .b(x23), .c(x24), .O(new_n67_));
  nand3  g22(.a(new_n67_), .b(new_n50_), .c(x15), .O(new_n68_));
  ...
  nand3  g38(.a(new_n83_), .b(x24), .c(x15), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n50_), .O(z08));
  inv1   g40(.a(x07), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(x05), .c(x04), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x25), .c(x15), .O(z09));
  nand2  g43(.a(x05), .b(x04), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n52_), .c(new_n86_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(x25), .c(x15), .O(z10));
  ...
  nand4  g53(.a(new_n98_), .b(new_n89_), .c(x25), .d(new_n95_), .O(new_n99_));
  ...
  nor2   g59(.a(new_n104_), .b(new_n50_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n102_), .c(new_n62_), .d(new_n95_), .O(z13));
  ...
  nand3  g65(.a(new_n110_), .b(new_n89_), .c(new_n86_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n108_), .c(x25), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n95_), .O(z14));
  nand2  g68(.a(new_n110_), .b(x22), .O(new_n114_));
  inv1   g69(.a(new_n101_), .O(new_n115_));
  nor3   g70(.a(x22), .b(x21), .c(x20), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(new_n50_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n62_), .d(new_n95_), .O(z15));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(new_n81_), .O(new_n119_));
  inv1   g74(.a(x22), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n115_), .c(new_n81_), .d(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n89_), .c(new_n86_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n119_), .c(x25), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n95_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n107_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n104_), .c(new_n50_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n62_), .d(new_n95_), .O(z17));
  nand2  g85(.a(new_n115_), .b(new_n62_), .O(new_n131_));
  nand3  g86(.a(new_n126_), .b(new_n109_), .c(new_n120_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n131_), .c(x25), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n95_), .O(z18));
endmodule
