...
module FAU ( 
  ...
  nor2   g03(.a(new_n48_), .b(x05), .O(new_n49_));
  ...
  inv1   g18(.a(x05), .O(new_n64_));
  nor2   g19(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  inv1   g20(.a(new_n65_), .O(new_n66_));
  oai21  g21(.a(new_n62_), .b(new_n49_), .c(new_n66_), .O(z01));
  ...
  nand3  g42(.a(new_n65_), .b(new_n48_), .c(new_n87_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nor2   g44(.a(x17), .b(x07), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x15), .c(new_n64_), .O(new_n91_));
  nand4  g46(.a(new_n55_), .b(new_n48_), .c(new_n87_), .d(new_n63_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n66_), .c(new_n48_), .d(new_n87_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n66_), .c(new_n48_), .d(new_n87_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nor2   g58(.a(new_n65_), .b(x07), .O(new_n104_));
  nand3  g59(.a(new_n97_), .b(new_n54_), .c(x19), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n48_), .O(z13));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n104_), .d(new_n48_), .O(z14));
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n102_), .O(new_n114_));
  nor2   g69(.a(new_n114_), .b(x15), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n111_), .c(new_n104_), .O(z15));
  oai21  g71(.a(x15), .b(x04), .c(x05), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nor2   g73(.a(new_n114_), .b(new_n118_), .O(new_n119_));
  inv1   g74(.a(new_n102_), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n120_), .c(new_n118_), .d(new_n82_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n87_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n119_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n117_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  inv1   g80(.a(new_n105_), .O(new_n126_));
  nand3  g81(.a(new_n112_), .b(new_n81_), .c(new_n118_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n87_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n117_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n112_), .c(new_n126_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n104_), .d(new_n48_), .O(z18));
endmodule
