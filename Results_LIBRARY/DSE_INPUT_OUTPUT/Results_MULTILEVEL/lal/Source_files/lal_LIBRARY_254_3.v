...
module FAU ( 
  ...
  nand3  g29(.a(new_n74_), .b(new_n50_), .c(new_n69_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z04));
  oai21  g31(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  nand2  g32(.a(x14), .b(new_n69_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n50_), .O(z06));
  aoi21  g34(.a(new_n69_), .b(x06), .c(new_n49_), .O(z07));
  ...
  nand3  g43(.a(new_n88_), .b(new_n48_), .c(new_n87_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n87_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n50_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n63_), .c(new_n48_), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n63_), .c(new_n48_), .d(new_n87_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n48_), .O(z13));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n104_), .d(new_n48_), .O(z14));
  ...
  nand2  g74(.a(x15), .b(new_n47_), .O(new_n120_));
  ...
  nand4  g78(.a(new_n109_), .b(new_n115_), .c(new_n122_), .d(new_n82_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n63_), .c(new_n87_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n123_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n120_), .O(z16));
  nand4  g82(.a(new_n122_), .b(new_n82_), .c(new_n112_), .d(new_n54_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n102_), .c(x24), .O(new_n129_));
  nor2   g84(.a(x22), .b(x21), .O(new_n130_));
  nor2   g85(.a(x24), .b(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n130_), .c(new_n105_), .d(new_n97_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n63_), .d(new_n87_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n120_), .O(z17));
  nand2  g90(.a(new_n132_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n130_), .c(new_n105_), .d(new_n97_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n104_), .d(new_n48_), .O(z18));
endmodule
