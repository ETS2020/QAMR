...
module FAU ( 
  ...
  aoi21  g37(.a(new_n82_), .b(new_n53_), .c(new_n49_), .O(z08));
  nor2   g38(.a(new_n63_), .b(x15), .O(z09));
  nand2  g39(.a(x05), .b(x04), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n55_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n48_), .c(x15), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n48_), .c(x15), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n85_), .c(new_n91_), .d(new_n48_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n92_), .b(new_n54_), .c(x19), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n85_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n91_), .O(z13));
  nand2  g57(.a(new_n99_), .b(x21), .O(new_n103_));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n92_), .c(x19), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n63_), .d(new_n91_), .O(z14));
  ...
  oai21  g66(.a(new_n111_), .b(x07), .c(new_n91_), .O(z15));
  ...
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n63_), .d(new_n91_), .O(z16));
  ...
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n63_), .d(new_n91_), .O(z17));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n63_), .d(new_n91_), .O(z18));
endmodule
