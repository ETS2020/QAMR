...
module FAU ( 
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n84_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n96_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n110_), .b(new_n109_), .c(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n103_), .b(new_n115_), .c(new_n78_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n97_), .c(new_n84_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n96_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n97_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n56_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n91_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n121_), .c(new_n84_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n96_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n123_), .c(new_n122_), .d(new_n91_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n62_), .d(new_n96_), .O(z18));
endmodule
