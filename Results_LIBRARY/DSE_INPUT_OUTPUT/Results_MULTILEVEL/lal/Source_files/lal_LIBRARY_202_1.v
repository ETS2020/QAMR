...
module FAU ( 
  ...
  nand4  g42(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n50_), .O(new_n88_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n100_), .d(new_n47_), .O(z15));
  ...
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n100_), .d(new_n47_), .O(z16));
  ...
  nand4  g76(.a(new_n121_), .b(new_n116_), .c(new_n100_), .d(new_n47_), .O(z17));
  ...
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n100_), .d(new_n47_), .O(z18));
endmodule
