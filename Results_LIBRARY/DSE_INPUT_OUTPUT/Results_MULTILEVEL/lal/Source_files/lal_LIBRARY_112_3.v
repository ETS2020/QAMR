...
module FAU ( 
  ...
  nor2   g19(.a(new_n46_), .b(new_n64_), .O(new_n65_));
  nor2   g20(.a(new_n65_), .b(x07), .O(new_n66_));
  nand3  g21(.a(new_n66_), .b(new_n63_), .c(new_n62_), .O(z01));
  inv1   g22(.a(new_n65_), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(new_n47_), .O(z02));
  nand2  g24(.a(new_n68_), .b(new_n62_), .O(z03));
  ...
  nand2  g30(.a(new_n75_), .b(new_n64_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n68_), .O(z04));
  nor2   g32(.a(x13), .b(x08), .O(z05));
  inv1   g33(.a(x14), .O(new_n79_));
  nor2   g34(.a(new_n79_), .b(x08), .O(z06));
  nand2  g35(.a(new_n46_), .b(x08), .O(new_n81_));
  oai21  g36(.a(x08), .b(x06), .c(new_n81_), .O(z07));
  aoi21  g37(.a(new_n56_), .b(new_n52_), .c(new_n59_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(x21), .c(x23), .O(new_n84_));
  nor2   g39(.a(new_n65_), .b(x25), .O(new_n85_));
  oai21  g40(.a(new_n84_), .b(new_n50_), .c(new_n85_), .O(z08));
  inv1   g41(.a(x07), .O(new_n87_));
  nand2  g42(.a(new_n46_), .b(new_n87_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(new_n63_), .c(new_n68_), .O(z09));
  nand4  g44(.a(new_n63_), .b(new_n53_), .c(new_n46_), .d(new_n87_), .O(new_n90_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n63_), .c(new_n46_), .d(new_n87_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z12));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nand4  g57(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n63_), .d(new_n87_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n46_), .O(new_n105_));
  nand2  g60(.a(x15), .b(new_n64_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(z13));
  ...
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n46_), .O(z14));
  nand3  g67(.a(new_n58_), .b(new_n52_), .c(x19), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n95_), .c(x22), .O(new_n114_));
  inv1   g69(.a(new_n101_), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n52_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n63_), .d(new_n87_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n46_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n106_), .O(z15));
  nand2  g75(.a(new_n117_), .b(x23), .O(new_n121_));
  inv1   g76(.a(x23), .O(new_n122_));
  nand4  g77(.a(new_n110_), .b(new_n115_), .c(new_n122_), .d(new_n59_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n109_), .d(new_n46_), .O(z16));
  nand2  g79(.a(new_n123_), .b(x24), .O(new_n125_));
  nand4  g80(.a(new_n50_), .b(new_n122_), .c(new_n59_), .d(new_n58_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n103_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n109_), .d(new_n46_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n103_), .c(x25), .O(new_n129_));
  nor2   g84(.a(x20), .b(new_n55_), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n116_), .c(new_n130_), .d(new_n96_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n63_), .d(new_n87_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n46_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n106_), .O(z18));
endmodule
