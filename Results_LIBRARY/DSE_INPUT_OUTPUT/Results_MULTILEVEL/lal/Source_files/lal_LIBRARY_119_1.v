...
module FAU ( 
  ...
  nand2  g42(.a(new_n87_), .b(new_n65_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n48_), .c(x07), .O(z11));
  ...
  nand2  g47(.a(new_n92_), .b(new_n65_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n48_), .c(x07), .O(z12));
  nand3  g49(.a(x19), .b(x18), .c(x17), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(x20), .O(new_n96_));
  nand4  g51(.a(new_n56_), .b(x19), .c(x18), .d(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n65_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n53_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n48_), .O(z14));
  inv1   g60(.a(new_n95_), .O(new_n106_));
  nor3   g61(.a(x22), .b(x21), .c(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n65_), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(x22), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(x15), .c(new_n53_), .O(z15));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n79_), .O(new_n112_));
  ...
  nand2  g71(.a(new_n116_), .b(new_n53_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n97_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n54_), .c(new_n79_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n102_), .d(new_n48_), .O(z17));
  oai21  g79(.a(new_n121_), .b(new_n97_), .c(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n119_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n65_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n53_), .O(z18));
endmodule
