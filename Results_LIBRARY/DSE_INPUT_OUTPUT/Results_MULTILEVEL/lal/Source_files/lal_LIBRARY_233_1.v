...
module FAU ( 
  ...
  nand3  g62(.a(new_n57_), .b(new_n52_), .c(new_n56_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n69_), .O(z15));
  nand3  g65(.a(new_n103_), .b(new_n53_), .c(new_n47_), .O(z16));
  nand3  g66(.a(new_n57_), .b(new_n72_), .c(new_n56_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n69_), .O(z17));
  nand3  g69(.a(new_n57_), .b(new_n61_), .c(new_n56_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n69_), .O(z18));
endmodule
