...
module FAU ( 
  ...
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n62_), .d(new_n87_), .O(z15));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n105_), .c(new_n109_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n62_), .d(new_n87_), .O(z16));
  ...
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n62_), .d(new_n87_), .O(z17));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n62_), .d(new_n87_), .O(z18));
endmodule
