...
module FAU ( 
  ...
  nand2  g43(.a(new_n60_), .b(new_n53_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n60_), .c(new_n86_), .d(new_n47_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n60_), .c(new_n86_), .d(new_n47_), .O(new_n97_));
  ...
  nor2   g61(.a(new_n61_), .b(x07), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n94_), .c(x19), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n86_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n107_), .d(new_n86_), .O(z15));
  ...
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n107_), .d(new_n86_), .O(z16));
  ...
  oai21  g78(.a(new_n123_), .b(x07), .c(new_n86_), .O(z17));
  ...
  oai21  g83(.a(new_n128_), .b(x07), .c(new_n86_), .O(z18));
endmodule
