...
module FAU ( 
  ...
  nor2   g21(.a(x08), .b(x00), .O(new_n67_));
  oai21  g22(.a(new_n67_), .b(x15), .c(x09), .O(new_n68_));
  ...
  nand2  g37(.a(new_n56_), .b(new_n52_), .O(new_n83_));
  ...
  aoi21  g41(.a(new_n86_), .b(new_n51_), .c(new_n63_), .O(z08));
  ...
  nand4  g46(.a(new_n61_), .b(new_n53_), .c(new_n88_), .d(new_n50_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n47_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n61_), .c(new_n88_), .d(new_n50_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n61_), .c(new_n88_), .d(new_n50_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n61_), .d(new_n50_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n88_), .O(new_n106_));
  nand2  g61(.a(x15), .b(new_n70_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z13));
  nand2  g63(.a(new_n104_), .b(x21), .O(new_n109_));
  nor2   g64(.a(new_n89_), .b(x07), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n97_), .c(x19), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n88_), .O(z14));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n110_), .d(new_n88_), .O(z15));
  ...
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n110_), .d(new_n88_), .O(z16));
  nand2  g77(.a(new_n121_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n104_), .O(new_n124_));
  inv1   g79(.a(x24), .O(new_n125_));
  nand3  g80(.a(new_n116_), .b(new_n125_), .c(new_n82_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n123_), .c(new_n110_), .d(new_n88_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n104_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n116_), .c(new_n124_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n61_), .d(new_n50_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n88_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n107_), .O(z18));
endmodule
