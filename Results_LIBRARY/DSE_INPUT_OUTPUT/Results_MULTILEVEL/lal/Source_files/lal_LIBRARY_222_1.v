...
module FAU ( 
  ...
  nand3  g40(.a(new_n61_), .b(new_n47_), .c(new_n50_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(new_n60_), .b(new_n53_), .O(new_n88_));
  ...
  oai21  g63(.a(new_n108_), .b(x15), .c(new_n50_), .O(z14));
  nand2  g64(.a(new_n106_), .b(x22), .O(new_n110_));
  nor2   g65(.a(new_n61_), .b(x07), .O(new_n111_));
  ...
  nor2   g71(.a(new_n114_), .b(new_n80_), .O(new_n117_));
  inv1   g72(.a(new_n98_), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n105_), .c(new_n118_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n60_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n117_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n50_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n112_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n101_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n111_), .d(new_n47_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n101_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n112_), .c(new_n100_), .d(new_n93_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n60_), .O(new_n132_));
