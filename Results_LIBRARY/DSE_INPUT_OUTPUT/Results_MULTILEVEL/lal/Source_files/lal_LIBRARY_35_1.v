...
module FAU ( 
  ...
  aoi21  g21(.a(new_n66_), .b(new_n63_), .c(new_n49_), .O(z01));
  ...
  oai21  g34(.a(new_n79_), .b(new_n72_), .c(new_n50_), .O(new_n80_));
  inv1   g35(.a(x00), .O(new_n81_));
  nor2   g36(.a(x09), .b(new_n81_), .O(new_n82_));
  inv1   g37(.a(x09), .O(new_n83_));
  nor2   g38(.a(x15), .b(new_n83_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n81_), .c(new_n82_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n80_), .c(x08), .O(z04));
  oai21  g41(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  inv1   g42(.a(x14), .O(new_n88_));
  nor3   g43(.a(new_n49_), .b(new_n88_), .c(x08), .O(z06));
  nand3  g44(.a(new_n50_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g45(.a(x23), .O(new_n91_));
  nand3  g46(.a(new_n60_), .b(x22), .c(x21), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(x24), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n54_), .c(new_n49_), .O(z08));
  inv1   g50(.a(x07), .O(new_n96_));
  nand3  g51(.a(new_n65_), .b(new_n48_), .c(new_n96_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z09));
  nand4  g53(.a(new_n64_), .b(new_n56_), .c(new_n48_), .d(new_n96_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z10));
  xor2a  g55(.a(x18), .b(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n64_), .c(new_n48_), .d(new_n96_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z11));
  nor2   g58(.a(new_n57_), .b(new_n56_), .O(new_n104_));
  nand3  g59(.a(new_n58_), .b(x18), .c(x17), .O(new_n105_));
  oai21  g60(.a(new_n104_), .b(new_n58_), .c(new_n105_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n64_), .c(new_n48_), .d(new_n96_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n50_), .O(z12));
  nand3  g63(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n104_), .b(new_n55_), .c(x19), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n66_), .d(new_n48_), .O(z13));
  ...
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n66_), .d(new_n48_), .O(z14));
  ...
  aoi21  g76(.a(new_n119_), .b(new_n118_), .c(new_n91_), .O(new_n122_));
  nor2   g77(.a(x23), .b(x22), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n114_), .c(new_n118_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n64_), .c(new_n96_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n122_), .c(new_n48_), .O(new_n126_));
  oai21  g81(.a(new_n48_), .b(new_n81_), .c(new_n126_), .O(z16));
  ...
  nand4  g87(.a(new_n132_), .b(new_n128_), .c(new_n66_), .d(new_n48_), .O(z17));
  ...
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n66_), .d(new_n48_), .O(z18));
endmodule
