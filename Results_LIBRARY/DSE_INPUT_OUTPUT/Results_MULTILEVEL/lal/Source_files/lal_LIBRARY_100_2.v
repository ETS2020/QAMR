...
module FAU ( 
  ...
  aoi21  g15(.a(new_n58_), .b(new_n50_), .c(new_n60_), .O(new_n61_));
  nand2  g16(.a(x15), .b(x07), .O(new_n62_));
  oai21  g17(.a(new_n61_), .b(x07), .c(new_n62_), .O(z01));
  ...
  nand3  g28(.a(new_n73_), .b(new_n66_), .c(new_n46_), .O(new_n74_));
  ...
  nand2  g35(.a(new_n55_), .b(new_n51_), .O(new_n81_));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n50_), .c(new_n48_), .O(z08));
  aoi21  g40(.a(new_n59_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n59_), .b(new_n52_), .c(new_n87_), .d(new_n47_), .O(new_n88_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n87_), .d(new_n47_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nor2   g54(.a(x20), .b(new_n54_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n59_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n87_), .O(z13));
  ...
  oai21  g63(.a(new_n108_), .b(x07), .c(new_n87_), .O(z14));
  ...
  nor2   g68(.a(new_n113_), .b(new_n60_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n87_), .O(z15));
  nor2   g72(.a(new_n113_), .b(new_n80_), .O(new_n118_));
  inv1   g73(.a(new_n98_), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n105_), .c(new_n119_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n59_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n118_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n87_), .O(z16));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n111_), .c(new_n100_), .d(new_n93_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n59_), .O(new_n127_));
  aoi21  g82(.a(new_n121_), .b(x24), .c(new_n127_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(x07), .c(new_n87_), .O(z17));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n111_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n101_), .c(new_n59_), .O(new_n132_));
  aoi21  g87(.a(new_n126_), .b(x25), .c(new_n132_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(x07), .c(new_n87_), .O(z18));
endmodule
