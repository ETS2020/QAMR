...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x12), .O(new_n48_));
  ...
  aoi21  g21(.a(new_n46_), .b(x03), .c(new_n66_), .O(new_n67_));
  ...
  nand4  g50(.a(new_n94_), .b(new_n54_), .c(new_n66_), .d(x12), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n94_), .c(new_n66_), .d(x12), .O(new_n99_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n94_), .c(new_n101_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(x12), .c(x15), .O(z12));
  ...
  nand4  g64(.a(new_n109_), .b(new_n108_), .c(new_n94_), .d(new_n101_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(x12), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n66_), .O(z13));
  ...
  nand3  g70(.a(new_n115_), .b(new_n94_), .c(new_n101_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n113_), .c(x12), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n66_), .O(z14));
  ...
  and2   g77(.a(new_n122_), .b(new_n66_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n62_), .d(x12), .O(z15));
  ...
  nand3  g82(.a(new_n127_), .b(new_n66_), .c(x12), .O(new_n128_));
  ...
  nand4  g90(.a(new_n135_), .b(new_n131_), .c(new_n62_), .d(x12), .O(z17));
  ...
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n94_), .d(new_n101_), .O(new_n140_));
  nand2  g95(.a(new_n140_), .b(x12), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(new_n66_), .O(z18));
endmodule
