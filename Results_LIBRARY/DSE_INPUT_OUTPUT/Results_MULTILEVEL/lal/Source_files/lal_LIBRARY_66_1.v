...
module FAU ( 
  ...
  nor2   g69(.a(new_n62_), .b(x07), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand4  g71(.a(new_n103_), .b(new_n108_), .c(new_n116_), .d(new_n81_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n47_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n99_), .O(new_n120_));
  nand3  g75(.a(new_n109_), .b(new_n80_), .c(new_n116_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n61_), .O(new_n124_));
  ...
  nand3  g83(.a(new_n128_), .b(new_n109_), .c(new_n120_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n115_), .d(new_n47_), .O(z18));
endmodule
