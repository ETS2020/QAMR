...
module FAU ( 
  ...
  nor2   g036(.a(x11), .b(new_n47_), .O(new_n82_));
  inv1   g037(.a(x11), .O(new_n83_));
  nor2   g038(.a(x15), .b(new_n83_), .O(new_n84_));
  aoi21  g039(.a(new_n84_), .b(new_n47_), .c(new_n82_), .O(new_n85_));
  ...
  nand3  g052(.a(new_n65_), .b(new_n97_), .c(new_n96_), .O(new_n98_));
  inv1   g053(.a(new_n98_), .O(z09));
  nand4  g054(.a(new_n64_), .b(new_n54_), .c(new_n97_), .d(new_n96_), .O(new_n100_));
  inv1   g055(.a(new_n100_), .O(z10));
  xor2a  g056(.a(x18), .b(x17), .O(new_n102_));
  nand4  g057(.a(new_n102_), .b(new_n64_), .c(new_n97_), .d(new_n96_), .O(new_n103_));
  ...
  nand4  g062(.a(new_n107_), .b(new_n64_), .c(new_n97_), .d(new_n96_), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n48_), .O(z12));
  nand3  g064(.a(x19), .b(x18), .c(x17), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(x20), .O(new_n111_));
  nand4  g066(.a(new_n53_), .b(x19), .c(x18), .d(x17), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n111_), .c(new_n66_), .d(new_n97_), .O(z13));
  inv1   g068(.a(new_n112_), .O(new_n114_));
  nor2   g069(.a(new_n114_), .b(new_n59_), .O(new_n115_));
  nor2   g070(.a(x21), .b(x20), .O(new_n116_));
  nand3  g071(.a(new_n116_), .b(new_n105_), .c(x19), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n64_), .c(new_n96_), .O(new_n118_));
  oai21  g073(.a(new_n118_), .b(new_n115_), .c(new_n97_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n124_), .b(new_n64_), .c(new_n96_), .O(new_n125_));
  aoi21  g080(.a(new_n117_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(x15), .c(new_n120_), .O(z15));
  aoi21  g082(.a(new_n123_), .b(new_n122_), .c(new_n91_), .O(new_n128_));
  nand4  g083(.a(new_n116_), .b(new_n122_), .c(new_n91_), .d(new_n60_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n64_), .c(new_n96_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(new_n128_), .c(new_n97_), .O(new_n131_));
  ...
  nand2  g092(.a(new_n137_), .b(new_n114_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n133_), .c(new_n64_), .d(new_n96_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n97_), .O(new_n140_));
  ...
  nand3  g098(.a(new_n143_), .b(new_n134_), .c(new_n114_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n142_), .c(new_n64_), .d(new_n96_), .O(new_n145_));
