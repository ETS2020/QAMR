...
module FAU ( 
  ...
  aoi21  g14(.a(new_n59_), .b(new_n58_), .c(new_n47_), .O(z01));
  inv1   g15(.a(x16), .O(new_n61_));
  nor2   g16(.a(new_n47_), .b(new_n61_), .O(z02));
  inv1   g17(.a(new_n47_), .O(new_n63_));
  nand3  g18(.a(new_n57_), .b(new_n63_), .c(new_n49_), .O(new_n64_));
  ...
  oai21  g30(.a(new_n67_), .b(x10), .c(new_n75_), .O(z04));
  oai21  g31(.a(x13), .b(x08), .c(new_n63_), .O(z05));
  ...
  nor4   g43(.a(new_n88_), .b(x15), .c(new_n87_), .d(x07), .O(z09));
  nand4  g44(.a(new_n88_), .b(new_n51_), .c(new_n66_), .d(x10), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x07), .O(z10));
  inv1   g46(.a(x07), .O(new_n92_));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n88_), .c(new_n92_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(x10), .c(x15), .O(z11));
  ...
  nand3  g53(.a(new_n98_), .b(new_n88_), .c(new_n92_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(x10), .c(x15), .O(z12));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n88_), .d(new_n92_), .O(new_n104_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n88_), .c(new_n92_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(x10), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n66_), .O(z14));
  ...
  and2   g71(.a(new_n116_), .b(new_n66_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n59_), .d(x10), .O(z15));
  ...
  nand3  g76(.a(new_n121_), .b(new_n66_), .c(x10), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n59_), .O(z16));
  ...
  nand2  g84(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n125_), .c(new_n88_), .d(new_n92_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(x10), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n66_), .O(z17));
  oai21  g88(.a(new_n128_), .b(new_n103_), .c(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n115_), .c(new_n126_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n88_), .d(new_n92_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(x10), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n66_), .O(z18));
endmodule
