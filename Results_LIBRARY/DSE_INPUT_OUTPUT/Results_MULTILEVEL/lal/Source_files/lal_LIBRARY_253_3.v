...
module FAU ( 
  ...
  nand4  g74(.a(new_n119_), .b(new_n77_), .c(new_n102_), .d(new_n50_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n112_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n59_), .d(new_n84_), .O(z16));
  oai21  g78(.a(new_n120_), .b(new_n98_), .c(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n113_), .c(new_n103_), .d(new_n93_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n82_), .d(new_n84_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n83_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n108_), .O(z17));
  nand4  g84(.a(new_n76_), .b(new_n119_), .c(new_n77_), .d(new_n102_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n100_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n113_), .c(new_n103_), .d(new_n93_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n82_), .d(new_n84_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n83_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n108_), .O(z18));
endmodule
