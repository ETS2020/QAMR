...
module FAU ( 
  ...
  nand4  g42(.a(new_n62_), .b(new_n53_), .c(new_n47_), .d(new_n61_), .O(new_n88_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n62_), .c(new_n47_), .d(new_n61_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n62_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n61_), .O(z14));
  ...
  nand3  g70(.a(new_n104_), .b(new_n115_), .c(new_n82_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n110_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n100_), .d(new_n47_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n98_), .c(x24), .O(new_n120_));
  nor2   g75(.a(x20), .b(new_n55_), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n111_), .c(new_n121_), .d(new_n93_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n62_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n61_), .O(z17));
  ...
  nand4  g84(.a(new_n129_), .b(new_n111_), .c(new_n121_), .d(new_n93_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n62_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n61_), .O(z18));
endmodule
