...
module FAU ( 
  ...
  aoi21  g18(.a(new_n63_), .b(new_n60_), .c(new_n48_), .O(z01));
  ...
  oai21  g23(.a(x11), .b(x08), .c(x15), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(x02), .O(new_n70_));
  ...
  nand2  g31(.a(x11), .b(new_n47_), .O(new_n77_));
  xnor2a g32(.a(x12), .b(x03), .O(new_n78_));
  nand3  g33(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(new_n79_));
  oai21  g34(.a(new_n79_), .b(new_n74_), .c(new_n46_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n70_), .O(z04));
  ...
  nand2  g41(.a(new_n56_), .b(new_n52_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(x22), .c(x21), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(x24), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g46(.a(x07), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(x05), .c(x04), .d(new_n47_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x15), .O(z09));
  nand3  g49(.a(new_n61_), .b(new_n53_), .c(new_n92_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g51(.a(x15), .O(new_n97_));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n61_), .c(new_n97_), .d(new_n92_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(x02), .O(z11));
  ...
  nand3  g70(.a(new_n115_), .b(new_n97_), .c(new_n92_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n113_), .c(new_n108_), .O(z14));
  inv1   g73(.a(new_n106_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n52_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n61_), .c(new_n92_), .O(new_n122_));
  aoi21  g77(.a(new_n115_), .b(x22), .c(new_n122_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(x02), .c(new_n97_), .O(z15));
  nand2  g79(.a(new_n121_), .b(x23), .O(new_n125_));
  nor2   g80(.a(x23), .b(x22), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n114_), .c(new_n119_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n97_), .c(new_n92_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n108_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  nor2   g86(.a(x24), .b(x23), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n120_), .O(new_n133_));
  inv1   g88(.a(new_n133_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n110_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n131_), .c(new_n61_), .d(new_n92_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n97_), .O(z17));
  oai21  g93(.a(new_n133_), .b(new_n109_), .c(x25), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n120_), .c(new_n110_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n61_), .d(new_n92_), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(new_n47_), .O(new_n143_));
  nand2  g98(.a(new_n143_), .b(new_n97_), .O(z18));
endmodule
