...
module FAU ( 
  ...
  nand2  g16(.a(x15), .b(x08), .O(new_n62_));
  nand4  g17(.a(new_n62_), .b(new_n61_), .c(new_n60_), .d(new_n50_), .O(z01));
  inv1   g18(.a(new_n62_), .O(new_n64_));
  nor2   g19(.a(new_n64_), .b(new_n47_), .O(z02));
  nand3  g20(.a(new_n62_), .b(new_n59_), .c(new_n51_), .O(new_n66_));
  ...
  oai21  g31(.a(new_n76_), .b(x08), .c(new_n62_), .O(z06));
  inv1   g32(.a(x08), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(x06), .O(z07));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n51_), .c(new_n64_), .O(z08));
  nand2  g40(.a(new_n46_), .b(new_n50_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n61_), .c(new_n62_), .O(z09));
  nand4  g42(.a(new_n61_), .b(new_n53_), .c(new_n46_), .d(new_n50_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n62_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n46_), .d(new_n50_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n62_), .O(z11));
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n46_), .d(new_n50_), .O(new_n96_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n46_), .O(z13));
  and2   g57(.a(new_n101_), .b(x21), .O(new_n103_));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n93_), .c(x19), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n61_), .c(new_n50_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n103_), .c(new_n46_), .O(new_n107_));
  nand2  g62(.a(x15), .b(new_n78_), .O(new_n108_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n100_), .d(new_n46_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x22), .O(new_n116_));
  nand3  g71(.a(new_n104_), .b(new_n80_), .c(new_n116_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n111_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n100_), .d(new_n46_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n121_), .c(new_n61_), .d(new_n50_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n46_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n108_), .O(z17));
  oai21  g84(.a(new_n124_), .b(new_n101_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n112_), .c(new_n122_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n61_), .d(new_n50_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n46_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n108_), .O(z18));
endmodule
