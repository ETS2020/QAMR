...
module FAU ( 
  ...
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n52_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  aoi21  g63(.a(new_n103_), .b(x22), .c(new_n108_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(x07), .c(new_n85_), .O(z15));
  ...
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n61_), .d(new_n85_), .O(z16));
  nand2  g69(.a(new_n113_), .b(x24), .O(new_n115_));
  inv1   g70(.a(new_n99_), .O(new_n116_));
  inv1   g71(.a(x24), .O(new_n117_));
  nand3  g72(.a(new_n106_), .b(new_n117_), .c(new_n78_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n115_), .c(new_n86_), .O(new_n121_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n86_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n85_), .O(z18));
endmodule
