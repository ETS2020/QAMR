...
module FAU ( 
  ...
  nand2  g27(.a(new_n72_), .b(new_n65_), .O(z04));
  ...
  nand3  g43(.a(new_n59_), .b(new_n86_), .c(new_n85_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n47_), .c(x17), .O(z10));
  nand4  g45(.a(new_n59_), .b(new_n47_), .c(x17), .d(new_n86_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(x07), .c(new_n65_), .O(z11));
  inv1   g47(.a(x19), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(x18), .c(x17), .O(new_n94_));
  oai21  g49(.a(new_n93_), .b(x18), .c(new_n94_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n86_), .d(new_n85_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  inv1   g52(.a(x17), .O(new_n98_));
  oai21  g53(.a(x20), .b(x18), .c(new_n98_), .O(new_n99_));
  nand2  g54(.a(x19), .b(x18), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nor2   g56(.a(new_n60_), .b(x07), .O(new_n102_));
  nand3  g57(.a(new_n52_), .b(x19), .c(x18), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(x15), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n102_), .c(new_n101_), .d(new_n99_), .O(z13));
  oai21  g61(.a(x21), .b(x18), .c(new_n98_), .O(new_n107_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n108_), .c(new_n107_), .d(new_n102_), .O(z14));
  oai21  g68(.a(new_n87_), .b(new_n60_), .c(new_n65_), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(x19), .c(new_n55_), .O(new_n115_));
  nand3  g70(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n100_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(x17), .O(new_n118_));
  nand2  g73(.a(x22), .b(new_n47_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n114_), .O(z15));
  oai21  g75(.a(x23), .b(x18), .c(new_n98_), .O(new_n121_));
  oai21  g76(.a(new_n116_), .b(new_n100_), .c(x23), .O(new_n122_));
  nor3   g77(.a(x23), .b(x22), .c(x21), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n104_), .c(x15), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n121_), .d(new_n102_), .O(z16));
  oai21  g80(.a(x24), .b(x18), .c(new_n98_), .O(new_n126_));
  nand2  g81(.a(new_n123_), .b(new_n104_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n50_), .b(new_n78_), .c(new_n55_), .d(new_n54_), .O(new_n129_));
  inv1   g84(.a(new_n129_), .O(new_n130_));
  aoi21  g85(.a(new_n130_), .b(new_n104_), .c(x15), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n126_), .d(new_n102_), .O(z17));
  oai21  g87(.a(x25), .b(x18), .c(new_n98_), .O(new_n133_));
  oai21  g88(.a(new_n129_), .b(new_n103_), .c(x25), .O(new_n134_));
  nand4  g89(.a(new_n51_), .b(new_n50_), .c(new_n78_), .d(new_n55_), .O(new_n135_));
  inv1   g90(.a(new_n135_), .O(new_n136_));
  aoi21  g91(.a(new_n136_), .b(new_n111_), .c(x15), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n133_), .d(new_n102_), .O(z18));
endmodule
