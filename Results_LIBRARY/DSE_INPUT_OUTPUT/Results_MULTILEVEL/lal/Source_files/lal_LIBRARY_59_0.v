...
module FAU ( 
  ...
  aoi21  g45(.a(new_n90_), .b(x19), .c(x15), .O(z09));
  inv1   g46(.a(x17), .O(new_n92_));
  nand3  g47(.a(new_n59_), .b(new_n92_), .c(new_n89_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(x19), .c(x15), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n59_), .c(new_n89_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x19), .c(x15), .O(z11));
  nand2  g52(.a(x18), .b(x17), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n59_), .c(new_n89_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(x19), .c(x15), .O(z12));
  nand2  g55(.a(new_n98_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n65_), .b(x18), .c(x17), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n59_), .d(new_n89_), .O(new_n103_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n59_), .c(new_n89_), .O(new_n109_));
  aoi21  g64(.a(new_n102_), .b(x21), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n67_), .c(new_n66_), .O(z14));
  nand2  g66(.a(new_n108_), .b(x22), .O(new_n112_));
  nor2   g67(.a(new_n60_), .b(x07), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n106_), .c(new_n65_), .O(new_n115_));
  and2   g70(.a(new_n115_), .b(x19), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n112_), .d(new_n66_), .O(z15));
  nand2  g72(.a(new_n115_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x21), .O(new_n119_));
  inv1   g74(.a(x22), .O(new_n120_));
  nand3  g75(.a(new_n52_), .b(new_n120_), .c(new_n119_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(new_n102_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(new_n67_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n113_), .d(new_n66_), .O(z16));
  oai21  g79(.a(new_n121_), .b(new_n102_), .c(x24), .O(new_n125_));
  inv1   g80(.a(x18), .O(new_n126_));
  nor2   g81(.a(x20), .b(new_n126_), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n114_), .c(new_n127_), .d(x17), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n59_), .d(new_n89_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x19), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n66_), .O(z17));
  nand4  g87(.a(new_n53_), .b(new_n52_), .c(new_n120_), .d(new_n119_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n102_), .c(x25), .O(new_n134_));
  nor2   g89(.a(x23), .b(x22), .O(new_n135_));
  nor2   g90(.a(x25), .b(x24), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n135_), .c(new_n107_), .d(new_n106_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n59_), .d(new_n89_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(x19), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n66_), .O(z18));
endmodule
