...
module FAU ( 
  ...
  aoi21  g17(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(z01));
  ...
  oai21  g31(.a(new_n76_), .b(x08), .c(new_n66_), .O(z06));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(new_n47_), .O(z08));
  nand2  g38(.a(x05), .b(x04), .O(new_n84_));
  nor4   g39(.a(new_n84_), .b(x15), .c(new_n76_), .d(x07), .O(z09));
  inv1   g40(.a(x15), .O(new_n86_));
  nand4  g41(.a(new_n84_), .b(new_n52_), .c(new_n86_), .d(x14), .O(new_n87_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n62_), .d(x14), .O(z13));
  nor2   g58(.a(new_n101_), .b(new_n57_), .O(new_n104_));
  ...
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(x14), .O(new_n108_));
  ...
  nand4  g69(.a(new_n114_), .b(new_n110_), .c(new_n62_), .d(x14), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  nand4  g71(.a(new_n105_), .b(new_n111_), .c(new_n79_), .d(new_n58_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n86_), .c(x14), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n116_), .c(new_n62_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n112_), .b(new_n49_), .c(new_n79_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n101_), .c(x15), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n62_), .d(x14), .O(z17));
  ...
  nand2  g84(.a(new_n129_), .b(x14), .O(new_n130_));
