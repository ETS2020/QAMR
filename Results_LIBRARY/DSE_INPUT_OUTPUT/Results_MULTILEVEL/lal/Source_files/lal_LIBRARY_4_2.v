...
module FAU ( 
  ...
  nand4  g51(.a(new_n96_), .b(new_n60_), .c(new_n90_), .d(new_n47_), .O(new_n97_));
  ...
  nand2  g78(.a(new_n123_), .b(new_n90_), .O(z16));
  ...
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n60_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n90_), .O(z17));
  ...
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n86_), .d(new_n90_), .O(z18));
endmodule
