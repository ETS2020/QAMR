...
module FAU ( 
  ...
  nand2  g39(.a(new_n69_), .b(x20), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n51_), .c(new_n68_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(x25), .c(new_n49_), .O(new_n87_));
  inv1   g42(.a(x19), .O(new_n88_));
  nor3   g43(.a(x18), .b(x17), .c(x15), .O(new_n89_));
  inv1   g44(.a(x22), .O(new_n90_));
  nor2   g45(.a(new_n68_), .b(new_n90_), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n89_), .c(x21), .d(new_n88_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n87_), .O(z08));
  nand4  g48(.a(new_n47_), .b(new_n55_), .c(x05), .d(x04), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z09));
  nand4  g50(.a(new_n56_), .b(new_n61_), .c(new_n47_), .d(new_n55_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  inv1   g52(.a(x18), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(x17), .c(new_n47_), .O(new_n99_));
  oai21  g54(.a(new_n98_), .b(x17), .c(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n56_), .c(new_n55_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n49_), .O(z11));
  nor2   g57(.a(new_n98_), .b(new_n61_), .O(new_n103_));
  nand3  g58(.a(new_n88_), .b(x18), .c(x17), .O(new_n104_));
  oai21  g59(.a(new_n103_), .b(new_n88_), .c(new_n104_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n56_), .c(new_n47_), .d(new_n55_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(z12));
  nand3  g62(.a(new_n59_), .b(x19), .c(x18), .O(new_n108_));
  ...
  aoi21  g66(.a(new_n111_), .b(x20), .c(new_n57_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n110_), .O(z13));
  nand2  g68(.a(x19), .b(x18), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nor2   g70(.a(x21), .b(x20), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(x15), .O(new_n117_));
  nand3  g72(.a(new_n103_), .b(new_n59_), .c(x19), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(x21), .c(new_n57_), .O(new_n119_));
  oai22  g74(.a(new_n119_), .b(x15), .c(new_n117_), .d(new_n61_), .O(z14));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n59_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n114_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x17), .O(new_n124_));
  nand3  g79(.a(new_n116_), .b(new_n103_), .c(x19), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(x22), .c(new_n57_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n124_), .O(z15));
  inv1   g82(.a(new_n57_), .O(new_n128_));
  oai21  g83(.a(new_n122_), .b(new_n111_), .c(x23), .O(new_n129_));
  inv1   g84(.a(new_n111_), .O(new_n130_));
  nand4  g85(.a(new_n116_), .b(new_n130_), .c(new_n51_), .d(new_n90_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n128_), .d(new_n47_), .O(z16));
  nand3  g87(.a(new_n121_), .b(new_n68_), .c(new_n51_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n108_), .c(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x17), .O(new_n135_));
  aoi21  g90(.a(new_n131_), .b(x24), .c(new_n57_), .O(new_n136_));
  oai21  g91(.a(new_n136_), .b(x15), .c(new_n135_), .O(z17));
  oai21  g92(.a(new_n133_), .b(new_n118_), .c(x25), .O(new_n138_));
  inv1   g93(.a(new_n118_), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n121_), .c(new_n139_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n138_), .c(new_n128_), .d(new_n47_), .O(z18));
endmodule
