...
module FAU ( 
  ...
  inv1   g34(.a(x03), .O(new_n80_));
  nand2  g35(.a(x12), .b(new_n80_), .O(new_n81_));
  nand4  g36(.a(new_n81_), .b(new_n79_), .c(new_n77_), .d(new_n75_), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(new_n73_), .c(new_n46_), .O(new_n83_));
  oai21  g38(.a(new_n69_), .b(x12), .c(new_n83_), .O(z04));
  ...
  aoi21  g44(.a(new_n57_), .b(new_n53_), .c(new_n89_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(x21), .c(x23), .O(new_n91_));
  nor2   g46(.a(new_n48_), .b(x25), .O(new_n92_));
  oai21  g47(.a(new_n91_), .b(new_n51_), .c(new_n92_), .O(z08));
  inv1   g48(.a(x07), .O(new_n94_));
  nand3  g49(.a(new_n63_), .b(new_n47_), .c(new_n94_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand4  g51(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n94_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n49_), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n62_), .c(new_n47_), .d(new_n94_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n62_), .c(new_n47_), .d(new_n94_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n62_), .d(new_n94_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n64_), .d(new_n47_), .O(z14));
  ...
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n64_), .O(z15));
  inv1   g78(.a(x23), .O(new_n124_));
  aoi21  g79(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(new_n125_));
  nand4  g80(.a(new_n116_), .b(new_n120_), .c(new_n124_), .d(new_n89_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n62_), .c(new_n94_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n125_), .c(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n113_), .O(z16));
  nand2  g84(.a(new_n126_), .b(x24), .O(new_n130_));
  nor2   g85(.a(x22), .b(x21), .O(new_n131_));
  nor2   g86(.a(x24), .b(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n131_), .c(new_n109_), .d(new_n102_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n62_), .d(new_n94_), .O(new_n134_));
  ...
  nand4  g93(.a(new_n138_), .b(new_n131_), .c(new_n109_), .d(new_n102_), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n64_), .d(new_n47_), .O(z18));
endmodule
