...
module FAU ( 
  ...
  nand4  g61(.a(new_n96_), .b(new_n60_), .c(new_n54_), .d(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n67_), .d(new_n48_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n67_), .d(new_n48_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n61_), .c(new_n60_), .d(new_n54_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n110_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n67_), .d(new_n48_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n101_), .c(x24), .O(new_n120_));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n111_), .c(new_n103_), .d(new_n96_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n65_), .d(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n48_), .b(x07), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n124_), .O(z17));
  nand2  g81(.a(new_n122_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n111_), .c(new_n103_), .d(new_n96_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n67_), .d(new_n48_), .O(z18));
endmodule
