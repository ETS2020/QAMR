...
module FAU ( 
  ...
  nand3  g34(.a(new_n47_), .b(new_n67_), .c(x06), .O(z07));
  ...
  nand3  g43(.a(new_n61_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n60_), .b(new_n52_), .c(new_n88_), .d(new_n87_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n60_), .c(new_n88_), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n60_), .c(new_n88_), .d(new_n87_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n62_), .d(new_n88_), .O(z13));
  nand2  g61(.a(new_n105_), .b(x21), .O(new_n107_));
  inv1   g62(.a(x21), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n51_), .c(x19), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n97_), .c(x15), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n107_), .c(new_n62_), .O(z14));
  oai21  g67(.a(new_n109_), .b(new_n96_), .c(x22), .O(new_n113_));
  inv1   g68(.a(new_n102_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n51_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n60_), .d(new_n88_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n87_), .O(new_n118_));
  nand2  g73(.a(new_n88_), .b(x07), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n118_), .O(z15));
  nand2  g75(.a(new_n116_), .b(x23), .O(new_n121_));
  inv1   g76(.a(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n82_), .c(new_n108_), .d(new_n51_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n114_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n121_), .c(new_n62_), .d(new_n88_), .O(z16));
  oai21  g81(.a(new_n123_), .b(new_n102_), .c(x24), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n115_), .c(new_n104_), .d(new_n97_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n60_), .d(new_n88_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n87_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n119_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n115_), .c(new_n104_), .d(new_n97_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n62_), .d(new_n88_), .O(z18));
endmodule
