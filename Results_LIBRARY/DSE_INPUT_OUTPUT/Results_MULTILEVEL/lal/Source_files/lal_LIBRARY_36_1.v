...
module FAU ( 
  ...
  nand3  g51(.a(new_n57_), .b(new_n96_), .c(new_n56_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x15), .O(z10));
  nand4  g53(.a(new_n57_), .b(new_n47_), .c(x17), .d(new_n69_), .O(new_n99_));
  ...
  nand3  g57(.a(new_n57_), .b(new_n69_), .c(new_n56_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n60_), .c(new_n47_), .O(z13));
  ...
  nand3  g63(.a(new_n104_), .b(new_n52_), .c(new_n47_), .O(z15));
  nand3  g64(.a(new_n104_), .b(new_n53_), .c(new_n47_), .O(z16));
  nand3  g65(.a(new_n57_), .b(new_n72_), .c(new_n56_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n69_), .O(z17));
  nand3  g68(.a(new_n57_), .b(new_n61_), .c(new_n56_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n69_), .O(z18));
endmodule
