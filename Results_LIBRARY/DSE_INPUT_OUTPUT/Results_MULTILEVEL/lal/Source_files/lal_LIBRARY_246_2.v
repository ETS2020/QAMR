...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n53_, new_n54_,
    ...
    new_n82_, new_n83_, new_n86_, new_n88_, new_n89_, new_n90_, new_n92_,
  ...
  nor4   g39(.a(new_n64_), .b(x15), .c(x13), .d(x07), .O(z09));
  nand3  g40(.a(new_n64_), .b(new_n56_), .c(new_n53_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n48_), .c(x15), .O(z10));
  inv1   g42(.a(x15), .O(new_n88_));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n64_), .c(new_n88_), .d(new_n48_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n64_), .c(new_n88_), .d(new_n48_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x15), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n98_), .d(new_n48_), .O(z13));
  ...
  nand3  g61(.a(new_n106_), .b(new_n88_), .c(new_n48_), .O(new_n107_));
  ...
  nand3  g67(.a(new_n112_), .b(new_n64_), .c(new_n53_), .O(new_n113_));
  aoi21  g68(.a(new_n106_), .b(x22), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x13), .c(new_n88_), .O(z15));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n105_), .c(new_n110_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n64_), .c(new_n53_), .O(new_n119_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n79_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  aoi21  g81(.a(new_n126_), .b(new_n101_), .c(x15), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n99_), .d(new_n48_), .O(z17));
  ...
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n64_), .d(new_n53_), .O(new_n132_));
