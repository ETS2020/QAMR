...
module FAU ( 
  ...
  nand3  g50(.a(new_n95_), .b(new_n83_), .c(new_n87_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x04), .c(x15), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  inv1   g54(.a(x04), .O(new_n100_));
  nor2   g55(.a(x05), .b(new_n100_), .O(new_n101_));
  ...
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(x04), .O(new_n111_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n101_), .d(new_n83_), .O(z15));
  nand2  g73(.a(new_n116_), .b(x23), .O(new_n119_));
  inv1   g74(.a(x23), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n114_), .c(new_n120_), .d(new_n78_), .O(new_n121_));
  ...
  nand3  g80(.a(new_n115_), .b(new_n77_), .c(new_n120_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n104_), .c(x15), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n101_), .d(new_n83_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n103_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n115_), .c(new_n102_), .d(new_n93_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n83_), .d(new_n87_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(x04), .O(new_n134_));
