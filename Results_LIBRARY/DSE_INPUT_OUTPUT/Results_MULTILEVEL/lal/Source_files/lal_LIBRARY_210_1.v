...
module FAU ( 
  ...
  nand2  g22(.a(new_n58_), .b(new_n50_), .O(new_n68_));
  ...
  oai21  g45(.a(new_n90_), .b(x15), .c(new_n61_), .O(new_n91_));
  nand4  g46(.a(new_n52_), .b(new_n47_), .c(new_n87_), .d(new_n60_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  oai21  g49(.a(x15), .b(x04), .c(x05), .O(new_n95_));
  ...
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n95_), .O(z15));
  ...
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n105_), .d(new_n47_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n115_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n107_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n105_), .d(new_n47_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n107_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n115_), .c(new_n106_), .d(new_n98_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n87_), .O(new_n132_));
