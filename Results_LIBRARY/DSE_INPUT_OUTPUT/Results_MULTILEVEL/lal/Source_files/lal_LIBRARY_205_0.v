...
module FAU ( 
  ...
  nand2  g20(.a(new_n61_), .b(z14), .O(z03));
  ...
  nand3  g26(.a(new_n71_), .b(z14), .c(new_n46_), .O(new_n72_));
  inv1   g27(.a(new_n72_), .O(z04));
  nor3   g28(.a(z12), .b(x13), .c(x08), .O(z05));
  inv1   g29(.a(x14), .O(new_n75_));
  nor3   g30(.a(z12), .b(new_n75_), .c(x08), .O(z06));
  ...
  one    g40(.O(z13));
  one    g41(.O(z15));
  inv1   g42(.a(z12), .O(z16));
  inv1   g43(.a(z12), .O(z17));
  inv1   g44(.a(z12), .O(z18));
endmodule
