...
module FAU ( 
  ...
  nor2   g71(.a(new_n116_), .b(x15), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n113_), .c(new_n62_), .O(new_n118_));
  ...
  nand4  g78(.a(new_n108_), .b(new_n123_), .c(new_n121_), .d(new_n85_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n62_), .c(new_n48_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n122_), .c(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n65_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  inv1   g83(.a(new_n105_), .O(new_n129_));
  nand4  g84(.a(new_n114_), .b(new_n129_), .c(new_n84_), .d(new_n121_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n104_), .d(new_n48_), .O(z17));
  nand2  g86(.a(new_n130_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n114_), .c(new_n129_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n104_), .d(new_n48_), .O(z18));
endmodule
