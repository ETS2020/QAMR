...
module FAU ( 
  ...
  oai21  g63(.a(new_n108_), .b(x07), .c(new_n88_), .O(z14));
  ...
  oai21  g69(.a(new_n114_), .b(x07), .c(new_n88_), .O(z15));
  ...
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n60_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n88_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n86_), .d(new_n88_), .O(z18));
endmodule
