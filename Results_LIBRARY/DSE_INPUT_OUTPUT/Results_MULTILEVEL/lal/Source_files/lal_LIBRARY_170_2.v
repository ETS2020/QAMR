...
module FAU ( 
  ...
  nor3   g041(.a(new_n86_), .b(new_n48_), .c(x01), .O(new_n87_));
  aoi21  g042(.a(new_n48_), .b(x01), .c(new_n87_), .O(new_n88_));
  ...
  aoi21  g048(.a(new_n59_), .b(new_n55_), .c(new_n62_), .O(new_n94_));
  aoi21  g049(.a(new_n94_), .b(x21), .c(x23), .O(new_n95_));
  nor2   g050(.a(new_n49_), .b(x25), .O(new_n96_));
  oai21  g051(.a(new_n95_), .b(new_n53_), .c(new_n96_), .O(z08));
  inv1   g052(.a(x07), .O(new_n98_));
  nand3  g053(.a(new_n98_), .b(x05), .c(x04), .O(new_n99_));
  aoi21  g054(.a(new_n99_), .b(new_n48_), .c(x15), .O(z09));
  nand3  g055(.a(new_n66_), .b(new_n56_), .c(new_n98_), .O(new_n101_));
  aoi21  g056(.a(new_n101_), .b(new_n48_), .c(x15), .O(z10));
  xor2a  g057(.a(x18), .b(x17), .O(new_n103_));
  nand4  g058(.a(new_n103_), .b(new_n66_), .c(new_n86_), .d(new_n48_), .O(new_n104_));
  ...
  nand4  g068(.a(new_n113_), .b(new_n112_), .c(new_n66_), .d(new_n98_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n48_), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(new_n86_), .O(z13));
  nand2  g071(.a(new_n113_), .b(x21), .O(new_n117_));
  nor2   g072(.a(new_n67_), .b(x07), .O(new_n118_));
  nand4  g073(.a(new_n106_), .b(new_n61_), .c(new_n55_), .d(x19), .O(new_n119_));
  nand3  g074(.a(new_n119_), .b(new_n86_), .c(new_n48_), .O(new_n120_));
  inv1   g075(.a(new_n120_), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(z14));
  ...
  and2   g081(.a(new_n126_), .b(new_n86_), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n123_), .c(new_n118_), .d(new_n48_), .O(z15));
  nand2  g083(.a(new_n126_), .b(x23), .O(new_n129_));
  ...
  aoi21  g087(.a(new_n132_), .b(new_n124_), .c(x15), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n129_), .c(new_n118_), .d(new_n48_), .O(z16));
  oai21  g089(.a(new_n131_), .b(new_n111_), .c(x24), .O(new_n135_));
  nor2   g090(.a(x20), .b(new_n58_), .O(new_n136_));
  nor2   g091(.a(x24), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n125_), .c(new_n136_), .d(new_n106_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n135_), .c(new_n66_), .d(new_n98_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n48_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n86_), .O(z17));
