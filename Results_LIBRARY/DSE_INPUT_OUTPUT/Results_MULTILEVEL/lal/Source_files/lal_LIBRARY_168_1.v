...
module FAU ( 
  ...
  oai21  g33(.a(new_n71_), .b(x09), .c(new_n78_), .O(z04));
  ...
  nand3  g39(.a(new_n58_), .b(x22), .c(x21), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x24), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n52_), .c(new_n48_), .O(z08));
  inv1   g43(.a(x07), .O(new_n89_));
  nand3  g44(.a(new_n65_), .b(new_n47_), .c(new_n89_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n49_), .O(z09));
  nand4  g46(.a(new_n64_), .b(new_n54_), .c(new_n47_), .d(new_n89_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n64_), .c(new_n47_), .d(new_n89_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n64_), .c(new_n47_), .d(new_n89_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n64_), .d(new_n89_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(x15), .b(x09), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(z13));
  aoi21  g64(.a(new_n104_), .b(new_n97_), .c(new_n59_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n97_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n64_), .c(new_n89_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n118_), .b(new_n64_), .c(new_n89_), .O(new_n119_));
  aoi21  g74(.a(new_n112_), .b(x22), .c(new_n119_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(x15), .c(new_n108_), .O(z15));
  nand2  g76(.a(new_n118_), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n111_), .b(new_n116_), .c(new_n84_), .d(new_n60_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n66_), .d(new_n47_), .O(z16));
  nand2  g79(.a(new_n123_), .b(x24), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n117_), .c(new_n104_), .d(new_n97_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n64_), .d(new_n89_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n108_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n117_), .c(new_n104_), .d(new_n97_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n66_), .d(new_n47_), .O(z18));
endmodule
