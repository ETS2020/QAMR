...
module FAU ( 
  ...
  nand3  g41(.a(new_n62_), .b(new_n86_), .c(new_n47_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n61_), .b(new_n53_), .c(new_n86_), .d(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n61_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n61_), .c(new_n86_), .d(new_n47_), .O(new_n97_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n61_), .O(new_n102_));
  ...
  nand2  g61(.a(new_n106_), .b(new_n61_), .O(new_n107_));
  aoi21  g62(.a(new_n101_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(x07), .c(new_n86_), .O(z14));
  ...
  oai21  g69(.a(new_n114_), .b(x07), .c(new_n86_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n105_), .c(new_n110_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n63_), .d(new_n86_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n101_), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n111_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n63_), .d(new_n86_), .O(z17));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n111_), .c(new_n121_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n63_), .d(new_n86_), .O(z18));
endmodule
