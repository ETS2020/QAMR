...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(x14), .c(x15), .O(z09));
  nand2  g40(.a(x05), .b(x04), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n54_), .c(new_n83_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x14), .c(x15), .O(z10));
  inv1   g43(.a(x15), .O(new_n89_));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n86_), .c(new_n89_), .d(x14), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n86_), .c(new_n89_), .d(x14), .O(new_n96_));
  ...
  nand3  g73(.a(new_n118_), .b(new_n89_), .c(x14), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n116_), .c(new_n62_), .O(z16));
  ...
  nand2  g89(.a(new_n134_), .b(x14), .O(new_n135_));
