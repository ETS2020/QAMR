...
module FAU ( 
  ...
  aoi21  g40(.a(new_n85_), .b(new_n69_), .c(new_n56_), .O(new_n86_));
  ...
  oai21  g44(.a(new_n87_), .b(new_n49_), .c(new_n89_), .O(z08));
  inv1   g45(.a(x07), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(x05), .c(x04), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n48_), .c(x15), .O(z09));
  ...
  nand3  g53(.a(new_n98_), .b(new_n95_), .c(new_n91_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n48_), .c(x15), .O(z11));
  nand3  g55(.a(new_n95_), .b(new_n48_), .c(x18), .O(new_n101_));
  nor4   g56(.a(new_n101_), .b(new_n94_), .c(x15), .d(x07), .O(z12));
  nand2  g57(.a(new_n65_), .b(new_n53_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n58_), .c(new_n48_), .O(z13));
  nand3  g60(.a(new_n95_), .b(new_n60_), .c(new_n91_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n53_), .O(z14));
  nand3  g63(.a(new_n95_), .b(new_n61_), .c(new_n91_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n48_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n53_), .O(z15));
  nand3  g66(.a(new_n95_), .b(new_n69_), .c(new_n91_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n48_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n53_), .O(z16));
  nand3  g69(.a(new_n104_), .b(new_n56_), .c(new_n48_), .O(z17));
  nand3  g70(.a(new_n95_), .b(new_n57_), .c(new_n91_), .O(new_n116_));
