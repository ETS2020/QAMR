...
module FAU ( 
  ...
  nand4  g17(.a(new_n62_), .b(new_n61_), .c(new_n51_), .d(new_n50_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nor2   g19(.a(new_n48_), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n60_), .b(new_n51_), .c(new_n52_), .O(new_n66_));
  inv1   g21(.a(new_n66_), .O(z03));
  aoi21  g22(.a(new_n46_), .b(x00), .c(x15), .O(new_n68_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n52_), .c(new_n48_), .O(z08));
  inv1   g41(.a(new_n62_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n47_), .c(new_n50_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n50_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n51_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n62_), .c(new_n47_), .d(new_n50_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n62_), .c(new_n47_), .d(new_n50_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n51_), .O(z12));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n62_), .d(new_n50_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(x15), .b(x09), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(z13));
  nand2  g61(.a(new_n102_), .b(x21), .O(new_n107_));
  nor2   g62(.a(new_n87_), .b(x07), .O(new_n108_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n108_), .d(new_n47_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n109_), .c(new_n113_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n108_), .d(new_n47_), .O(z16));
  nand2  g75(.a(new_n119_), .b(x24), .O(new_n121_));
  inv1   g76(.a(new_n102_), .O(new_n122_));
  inv1   g77(.a(x24), .O(new_n123_));
  nand3  g78(.a(new_n114_), .b(new_n123_), .c(new_n81_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n121_), .c(new_n108_), .d(new_n47_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n102_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n114_), .c(new_n122_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n62_), .d(new_n50_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n105_), .O(z18));
endmodule
