...
module FAU ( 
  ...
  nor2   g02(.a(new_n47_), .b(x03), .O(new_n48_));
  ...
  aoi21  g23(.a(x12), .b(new_n46_), .c(x15), .O(new_n69_));
  ...
  nand3  g44(.a(new_n58_), .b(x22), .c(x21), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(x24), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n52_), .c(new_n48_), .O(z08));
  ...
  nand3  g63(.a(new_n102_), .b(new_n53_), .c(x19), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n108_), .c(new_n64_), .d(new_n47_), .O(z13));
  ...
  inv1   g83(.a(new_n109_), .O(new_n129_));
  ...
  nand4  g87(.a(new_n132_), .b(new_n128_), .c(new_n64_), .d(new_n47_), .O(z17));
  ...
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n64_), .d(new_n47_), .O(z18));
endmodule
