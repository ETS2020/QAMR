...
module FAU ( 
  ...
  inv1   g42(.a(new_n62_), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n47_), .c(new_n87_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n87_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n50_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n62_), .c(new_n47_), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n62_), .c(new_n47_), .d(new_n87_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n47_), .O(z13));
  ...
  nand3  g66(.a(new_n111_), .b(new_n62_), .c(new_n87_), .O(new_n112_));
  ...
  nand3  g70(.a(new_n107_), .b(new_n53_), .c(x19), .O(new_n116_));
  ...
  nand4  g75(.a(new_n120_), .b(new_n117_), .c(new_n62_), .d(new_n87_), .O(new_n121_));
  ...
  nand4  g80(.a(new_n110_), .b(new_n118_), .c(new_n125_), .d(new_n82_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n104_), .d(new_n47_), .O(z16));
  nand2  g82(.a(new_n126_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n81_), .b(new_n125_), .c(new_n82_), .d(new_n107_), .O(new_n129_));
  inv1   g84(.a(new_n129_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n108_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n104_), .d(new_n47_), .O(z17));
  oai21  g87(.a(new_n129_), .b(new_n105_), .c(x25), .O(new_n133_));
  nor2   g88(.a(x20), .b(new_n56_), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n119_), .c(new_n134_), .d(new_n97_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n62_), .d(new_n87_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n114_), .O(z18));
endmodule
