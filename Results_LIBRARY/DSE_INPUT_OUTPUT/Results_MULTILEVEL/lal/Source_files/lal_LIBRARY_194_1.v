...
module FAU ( 
  ...
  oai21  g33(.a(new_n78_), .b(new_n71_), .c(new_n49_), .O(new_n79_));
  inv1   g34(.a(x11), .O(new_n80_));
  nor2   g35(.a(new_n80_), .b(x02), .O(new_n81_));
  nor2   g36(.a(x15), .b(x11), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(x02), .c(new_n81_), .O(new_n83_));
  ...
  nand2  g44(.a(new_n57_), .b(new_n53_), .O(new_n90_));
  ...
  aoi21  g48(.a(new_n93_), .b(new_n52_), .c(new_n48_), .O(z08));
  nand2  g49(.a(new_n47_), .b(new_n51_), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n62_), .c(new_n49_), .O(z09));
  nand4  g51(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n62_), .d(new_n51_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(x15), .b(x11), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(z13));
  inv1   g69(.a(x21), .O(new_n115_));
  aoi21  g70(.a(new_n109_), .b(new_n102_), .c(new_n115_), .O(new_n116_));
  nor2   g71(.a(x21), .b(x20), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n102_), .c(x19), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n62_), .c(new_n51_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n113_), .O(z14));
  nand2  g76(.a(new_n118_), .b(x22), .O(new_n122_));
  aoi21  g77(.a(x05), .b(x04), .c(x07), .O(new_n123_));
  inv1   g78(.a(new_n107_), .O(new_n124_));
  nor3   g79(.a(x22), .b(x21), .c(x20), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n124_), .c(x15), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n122_), .O(z15));
  aoi21  g82(.a(new_n125_), .b(new_n124_), .c(new_n89_), .O(new_n128_));
  nor2   g83(.a(x23), .b(x22), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n117_), .c(new_n124_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n62_), .c(new_n51_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n128_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n113_), .O(z16));
  nand2  g88(.a(new_n130_), .b(x24), .O(new_n134_));
  inv1   g89(.a(new_n110_), .O(new_n135_));
  nor2   g90(.a(x22), .b(x21), .O(new_n136_));
  nor2   g91(.a(x24), .b(x23), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n134_), .c(new_n123_), .d(new_n47_), .O(z17));
  nand2  g94(.a(new_n138_), .b(x25), .O(new_n140_));
  nor3   g95(.a(x25), .b(x24), .c(x23), .O(new_n141_));
  nand3  g96(.a(new_n141_), .b(new_n136_), .c(new_n135_), .O(new_n142_));
  nand4  g97(.a(new_n142_), .b(new_n140_), .c(new_n123_), .d(new_n47_), .O(z18));
endmodule
