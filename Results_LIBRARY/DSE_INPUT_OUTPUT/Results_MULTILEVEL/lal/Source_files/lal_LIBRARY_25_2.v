...
module FAU ( 
  ...
  nand2  g62(.a(new_n107_), .b(new_n88_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n60_), .d(new_n88_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand3  g70(.a(new_n104_), .b(new_n115_), .c(new_n79_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n110_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n60_), .d(new_n88_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n97_), .c(x24), .O(new_n120_));
  nor2   g75(.a(x20), .b(new_n54_), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n111_), .c(new_n121_), .d(new_n92_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n85_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n88_), .O(z17));
  nand2  g81(.a(new_n122_), .b(new_n111_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n99_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n111_), .c(new_n121_), .d(new_n92_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n85_), .O(new_n131_));
