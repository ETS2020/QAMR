...
module FAU ( 
  ...
  nand3  g35(.a(new_n47_), .b(x14), .c(new_n72_), .O(new_n81_));
  ...
  nand2  g43(.a(new_n69_), .b(new_n63_), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(new_n64_), .c(new_n47_), .O(z09));
  ...
  nand4  g54(.a(new_n99_), .b(new_n64_), .c(new_n69_), .d(new_n63_), .O(new_n100_));
  ...
  nand3  g60(.a(new_n97_), .b(new_n52_), .c(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n105_), .c(new_n103_), .d(new_n69_), .O(z13));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n105_), .d(new_n69_), .O(z14));
  nand3  g66(.a(new_n58_), .b(new_n52_), .c(x19), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n96_), .c(x22), .O(new_n113_));
  inv1   g68(.a(new_n102_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n52_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n64_), .d(new_n63_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n69_), .O(new_n118_));
  nand2  g73(.a(new_n50_), .b(x15), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n118_), .O(z15));
  nand2  g75(.a(new_n116_), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n109_), .b(new_n114_), .c(new_n85_), .d(new_n59_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n121_), .c(new_n105_), .d(new_n69_), .O(z16));
  nand2  g78(.a(new_n104_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n122_), .b(new_n69_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n50_), .O(new_n126_));
  nand3  g81(.a(new_n122_), .b(x24), .c(new_n69_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n124_), .O(z17));
  nand3  g83(.a(new_n115_), .b(new_n50_), .c(new_n85_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n106_), .c(x25), .O(new_n130_));
  inv1   g85(.a(new_n106_), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n115_), .c(new_n131_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n105_), .d(new_n69_), .O(z18));
endmodule
