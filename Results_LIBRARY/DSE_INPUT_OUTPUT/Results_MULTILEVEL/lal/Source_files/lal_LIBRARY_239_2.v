...
module FAU ( 
  ...
  nand4  g43(.a(new_n88_), .b(new_n84_), .c(new_n87_), .d(new_n48_), .O(new_n89_));
  ...
  nand4  g48(.a(new_n93_), .b(new_n84_), .c(new_n87_), .d(new_n48_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n97_), .c(new_n64_), .d(new_n87_), .O(z13));
  ...
  oai21  g58(.a(new_n103_), .b(x07), .c(new_n87_), .O(z14));
  ...
  oai21  g64(.a(new_n109_), .b(x07), .c(new_n87_), .O(z15));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n78_), .O(new_n111_));
  nor2   g66(.a(x23), .b(x22), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n100_), .c(new_n105_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n84_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n119_), .b(new_n53_), .c(new_n78_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n64_), .d(new_n87_), .O(z17));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n64_), .d(new_n87_), .O(z18));
endmodule
