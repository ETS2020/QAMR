...
module FAU ( 
  ...
  aoi21  g37(.a(new_n82_), .b(new_n51_), .c(new_n47_), .O(z08));
  inv1   g38(.a(x07), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(x05), .c(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x14), .c(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand2  g42(.a(x05), .b(x04), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n53_), .c(new_n87_), .d(x14), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n88_), .c(new_n84_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x14), .c(x15), .O(z11));
  ...
  nand4  g51(.a(new_n96_), .b(new_n88_), .c(new_n87_), .d(x14), .O(new_n97_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n100_), .c(new_n63_), .d(x14), .O(z13));
  nor2   g59(.a(new_n102_), .b(new_n58_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n94_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n88_), .c(new_n84_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(x14), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n87_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n63_), .d(x14), .O(z15));
  aoi21  g70(.a(new_n113_), .b(new_n112_), .c(new_n79_), .O(new_n116_));
  nand4  g71(.a(new_n106_), .b(new_n112_), .c(new_n79_), .d(new_n59_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n88_), .c(new_n84_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(x14), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n87_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  nor2   g76(.a(x22), .b(x21), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n50_), .c(new_n79_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  aoi21  g79(.a(new_n124_), .b(new_n102_), .c(x15), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n121_), .c(new_n63_), .d(x14), .O(z17));
  oai21  g81(.a(new_n123_), .b(new_n101_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n122_), .c(new_n102_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n88_), .d(new_n84_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x14), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n87_), .O(z18));
endmodule
