...
module FAU ( 
  ...
  aoi21  g23(.a(new_n46_), .b(x03), .c(new_n68_), .O(new_n69_));
  ...
  nor2   g45(.a(new_n47_), .b(x25), .O(new_n91_));
  oai21  g46(.a(new_n90_), .b(new_n50_), .c(new_n91_), .O(z08));
  inv1   g47(.a(x12), .O(new_n93_));
  nand2  g48(.a(x05), .b(x04), .O(new_n94_));
  nor4   g49(.a(new_n94_), .b(x15), .c(new_n93_), .d(x07), .O(z09));
  inv1   g50(.a(x07), .O(new_n96_));
  nand3  g51(.a(new_n94_), .b(new_n53_), .c(new_n96_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(x12), .c(x15), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n94_), .c(new_n68_), .d(x12), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n94_), .c(new_n68_), .d(x12), .O(new_n105_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n94_), .d(new_n96_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x12), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n68_), .O(z13));
  ...
  nand3  g71(.a(new_n116_), .b(new_n68_), .c(x12), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n114_), .c(new_n63_), .O(z14));
  nand2  g74(.a(new_n116_), .b(x22), .O(new_n120_));
  inv1   g75(.a(new_n107_), .O(new_n121_));
  nand2  g76(.a(new_n59_), .b(new_n58_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(x20), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n121_), .c(x15), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n63_), .d(x12), .O(z15));
  inv1   g80(.a(x23), .O(new_n126_));
  aoi21  g81(.a(new_n123_), .b(new_n121_), .c(new_n126_), .O(new_n127_));
  nand4  g82(.a(new_n115_), .b(new_n121_), .c(new_n126_), .d(new_n59_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n94_), .c(new_n96_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n127_), .c(x12), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n68_), .O(z16));
  ...
  nand4  g90(.a(new_n135_), .b(new_n132_), .c(new_n94_), .d(new_n96_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(x12), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n68_), .O(z17));
  nand2  g93(.a(new_n135_), .b(x25), .O(new_n139_));
  inv1   g94(.a(new_n110_), .O(new_n140_));
  nand3  g95(.a(new_n51_), .b(new_n50_), .c(new_n126_), .O(new_n141_));
  nor2   g96(.a(new_n141_), .b(new_n122_), .O(new_n142_));
  aoi21  g97(.a(new_n142_), .b(new_n140_), .c(x15), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n139_), .c(new_n63_), .d(x12), .O(z18));
endmodule
