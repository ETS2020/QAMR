...
module FAU ( 
  ...
  aoi21  g40(.a(new_n63_), .b(new_n48_), .c(x07), .O(z09));
  nand2  g41(.a(new_n63_), .b(new_n56_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n48_), .c(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n63_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n48_), .c(x07), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n63_), .c(new_n48_), .d(new_n53_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nor2   g53(.a(new_n64_), .b(x07), .O(new_n99_));
  nand3  g54(.a(new_n92_), .b(new_n55_), .c(x19), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n48_), .O(z13));
  ...
  aoi21  g59(.a(new_n100_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(x15), .c(new_n53_), .O(z14));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n107_));
  nor2   g62(.a(x22), .b(x21), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n55_), .O(new_n109_));
  nor2   g64(.a(new_n109_), .b(new_n97_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(new_n64_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n107_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n48_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n53_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  nor2   g70(.a(new_n110_), .b(new_n115_), .O(new_n116_));
  inv1   g71(.a(new_n97_), .O(new_n117_));
  nand4  g72(.a(new_n102_), .b(new_n117_), .c(new_n115_), .d(new_n81_), .O(new_n118_));
  ...
  nand4  g78(.a(new_n108_), .b(new_n123_), .c(new_n80_), .d(new_n115_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n99_), .d(new_n48_), .O(z17));
  nand2  g80(.a(new_n124_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n108_), .c(new_n123_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n99_), .d(new_n48_), .O(z18));
endmodule
