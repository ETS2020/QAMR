...
module FAU ( 
  ...
  aoi21  g29(.a(new_n47_), .b(x13), .c(x08), .O(z05));
  ...
  nand4  g44(.a(new_n89_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n49_), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n62_), .c(new_n47_), .d(new_n51_), .O(new_n95_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n62_), .c(new_n51_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  nand2  g66(.a(x15), .b(x08), .O(new_n112_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n62_), .c(new_n51_), .O(new_n117_));
  ...
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n62_), .d(new_n51_), .O(new_n125_));
