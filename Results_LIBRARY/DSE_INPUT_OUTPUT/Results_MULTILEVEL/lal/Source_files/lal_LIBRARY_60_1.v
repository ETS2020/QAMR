...
module FAU ( 
  ...
  nand3  g40(.a(new_n48_), .b(new_n85_), .c(new_n84_), .O(new_n86_));
  ...
  nand4  g48(.a(new_n60_), .b(new_n48_), .c(new_n84_), .d(new_n93_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n60_), .c(new_n59_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n48_), .c(x15), .O(z11));
  nand4  g53(.a(new_n60_), .b(x18), .c(x17), .d(new_n59_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n48_), .c(x15), .O(z12));
  nand3  g55(.a(new_n60_), .b(new_n63_), .c(new_n59_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n93_), .O(z13));
  nand3  g58(.a(new_n60_), .b(new_n93_), .c(new_n59_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n54_), .c(new_n48_), .O(z14));
  nand3  g61(.a(new_n60_), .b(new_n55_), .c(new_n59_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n93_), .O(z15));
  nand3  g64(.a(new_n60_), .b(new_n56_), .c(new_n59_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n48_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n93_), .O(z16));
  nand3  g67(.a(new_n105_), .b(new_n83_), .c(new_n48_), .O(z17));
  nand3  g68(.a(new_n105_), .b(new_n53_), .c(new_n48_), .O(z18));
endmodule
