...
module FAU ( 
  ...
  inv1   g38(.a(new_n63_), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(new_n47_), .c(new_n51_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z09));
  nand4  g41(.a(new_n63_), .b(new_n55_), .c(new_n47_), .d(new_n51_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n63_), .c(new_n47_), .d(new_n51_), .O(new_n90_));
  ...
  nor2   g53(.a(new_n84_), .b(x07), .O(new_n99_));
  nand4  g54(.a(new_n54_), .b(x19), .c(x18), .d(x17), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n47_), .O(z13));
  ...
  oai21  g60(.a(new_n105_), .b(x15), .c(new_n51_), .O(z14));
  ...
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n99_), .O(z15));
  aoi21  g66(.a(new_n109_), .b(new_n108_), .c(new_n79_), .O(new_n112_));
  nor2   g67(.a(x23), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n102_), .c(new_n108_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n63_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n112_), .c(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n51_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n100_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n52_), .c(new_n79_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n118_), .c(new_n63_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n51_), .O(z17));
  oai21  g81(.a(new_n121_), .b(new_n100_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n120_), .c(new_n119_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n63_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n51_), .O(z18));
endmodule
