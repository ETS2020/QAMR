...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n92_, new_n94_, new_n97_, new_n98_, new_n100_, new_n101_,
    new_n103_, new_n104_, new_n105_, new_n108_, new_n109_;
  ...
  nor2   g43(.a(new_n63_), .b(x17), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x15), .O(z10));
  nand2  g45(.a(x05), .b(x04), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(x18), .c(new_n86_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g48(.a(new_n91_), .b(x19), .c(new_n86_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n47_), .c(x15), .O(z12));
  nand4  g50(.a(new_n63_), .b(new_n56_), .c(new_n47_), .d(new_n51_), .O(z13));
  nand3  g51(.a(new_n91_), .b(new_n58_), .c(new_n86_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n51_), .O(z14));
  nand3  g54(.a(new_n91_), .b(new_n59_), .c(new_n86_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n51_), .O(z15));
  inv1   g57(.a(x23), .O(new_n103_));
  nand3  g58(.a(new_n91_), .b(new_n103_), .c(new_n86_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n51_), .O(z16));
  nand4  g61(.a(new_n63_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(z17));
  nand3  g62(.a(new_n91_), .b(new_n55_), .c(new_n86_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n51_), .O(z18));
endmodule
