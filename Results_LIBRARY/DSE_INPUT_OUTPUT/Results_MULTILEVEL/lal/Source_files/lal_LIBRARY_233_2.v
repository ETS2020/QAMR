...
module FAU ( 
  ...
  oai21  g46(.a(new_n91_), .b(new_n56_), .c(new_n49_), .O(z09));
  ...
  nand2  g53(.a(x19), .b(new_n93_), .O(new_n99_));
  inv1   g54(.a(x19), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(x18), .c(x17), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n99_), .c(x15), .O(new_n102_));
  nor2   g57(.a(new_n100_), .b(x18), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n102_), .c(new_n56_), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(x07), .c(new_n49_), .O(z12));
  inv1   g60(.a(new_n57_), .O(new_n106_));
  ...
  nand3  g66(.a(new_n111_), .b(x19), .c(x17), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x18), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(x21), .c(new_n57_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x15), .c(new_n114_), .O(z14));
  ...
  nand4  g77(.a(new_n111_), .b(x19), .c(x18), .d(x17), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(x22), .c(new_n57_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x15), .c(new_n122_), .O(z15));
  oai21  g80(.a(new_n120_), .b(new_n107_), .c(x23), .O(new_n126_));
  inv1   g81(.a(new_n107_), .O(new_n127_));
  nand4  g82(.a(new_n111_), .b(new_n127_), .c(new_n51_), .d(new_n119_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n106_), .d(new_n47_), .O(z16));
  nand3  g84(.a(new_n59_), .b(x19), .c(x17), .O(new_n130_));
  nand4  g85(.a(new_n68_), .b(new_n51_), .c(new_n119_), .d(new_n118_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n130_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(x18), .O(new_n133_));
  aoi21  g88(.a(new_n128_), .b(x24), .c(new_n57_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(x15), .c(new_n133_), .O(z17));
  nand4  g90(.a(new_n60_), .b(new_n68_), .c(new_n51_), .d(new_n119_), .O(new_n136_));
  oai21  g91(.a(new_n136_), .b(new_n112_), .c(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(x18), .O(new_n138_));
  oai21  g93(.a(new_n131_), .b(new_n109_), .c(x25), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n106_), .O(new_n140_));
