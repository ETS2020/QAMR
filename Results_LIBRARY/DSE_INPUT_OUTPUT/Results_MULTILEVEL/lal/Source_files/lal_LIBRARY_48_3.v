...
module FAU ( 
  ...
  nand2  g52(.a(new_n97_), .b(new_n50_), .O(z12));
  ...
  nor2   g67(.a(new_n62_), .b(x07), .O(new_n113_));
  inv1   g68(.a(new_n99_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n53_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n112_), .d(new_n48_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x23), .O(new_n119_));
  nand4  g74(.a(new_n107_), .b(new_n114_), .c(new_n119_), .d(new_n82_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n113_), .d(new_n48_), .O(z16));
  nand2  g76(.a(new_n120_), .b(x24), .O(new_n122_));
  nand3  g77(.a(new_n115_), .b(new_n81_), .c(new_n119_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n101_), .c(new_n94_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n122_), .c(new_n61_), .d(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n64_), .O(z17));
  oai21  g83(.a(new_n123_), .b(new_n102_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n115_), .c(new_n101_), .d(new_n94_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n61_), .d(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n64_), .O(z18));
endmodule
