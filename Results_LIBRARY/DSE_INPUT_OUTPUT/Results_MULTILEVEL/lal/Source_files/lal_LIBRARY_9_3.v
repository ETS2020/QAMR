...
module FAU ( 
  ...
  oai21  g44(.a(new_n89_), .b(new_n86_), .c(new_n47_), .O(z09));
  nand4  g45(.a(new_n86_), .b(new_n52_), .c(new_n88_), .d(new_n87_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n47_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n86_), .c(new_n88_), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n86_), .c(new_n88_), .d(new_n87_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z12));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n96_), .b(new_n51_), .c(x19), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n86_), .d(new_n88_), .O(new_n104_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n60_), .d(new_n88_), .O(z14));
  inv1   g66(.a(new_n101_), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n51_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n86_), .c(new_n88_), .O(new_n115_));
  aoi21  g70(.a(new_n110_), .b(x22), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x07), .c(new_n106_), .O(z15));
  nand2  g72(.a(new_n114_), .b(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n109_), .c(new_n112_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n60_), .d(new_n88_), .O(z16));
  nand2  g76(.a(new_n120_), .b(x24), .O(new_n122_));
  inv1   g77(.a(new_n103_), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n113_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n60_), .d(new_n88_), .O(z17));
  nand2  g83(.a(new_n127_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n113_), .c(new_n123_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n60_), .d(new_n88_), .O(z18));
endmodule
