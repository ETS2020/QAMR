...
module FAU ( 
  ...
  nand2  g15(.a(x15), .b(x08), .O(new_n61_));
  nand4  g16(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(new_n49_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nand2  g18(.a(new_n61_), .b(new_n63_), .O(z02));
  nand3  g19(.a(new_n61_), .b(new_n58_), .c(new_n50_), .O(new_n65_));
  ...
  inv1   g32(.a(new_n61_), .O(new_n78_));
  ...
  nand2  g39(.a(new_n47_), .b(new_n49_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n60_), .c(new_n61_), .O(z09));
  nand4  g41(.a(new_n60_), .b(new_n52_), .c(new_n47_), .d(new_n49_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n60_), .c(new_n47_), .d(new_n49_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n61_), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n60_), .c(new_n47_), .d(new_n49_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n61_), .O(z12));
  ...
  nand3  g64(.a(new_n109_), .b(new_n60_), .c(new_n49_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  nand2  g66(.a(x15), .b(new_n46_), .O(new_n112_));
  ...
  nand4  g70(.a(new_n104_), .b(new_n107_), .c(new_n79_), .d(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n60_), .c(new_n49_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n114_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n112_), .O(z16));
  nand3  g74(.a(new_n104_), .b(new_n79_), .c(new_n115_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n97_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x22), .b(x21), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n100_), .d(new_n92_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n60_), .d(new_n49_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n112_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n122_), .c(new_n100_), .d(new_n92_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n99_), .d(new_n47_), .O(z18));
endmodule
