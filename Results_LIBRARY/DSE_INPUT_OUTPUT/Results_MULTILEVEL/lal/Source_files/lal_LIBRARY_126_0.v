...
module FAU ( 
  ...
  aoi21  g47(.a(new_n92_), .b(x19), .c(x15), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n57_), .c(new_n90_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(x19), .c(x15), .O(z11));
  nand2  g51(.a(x18), .b(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n57_), .c(new_n90_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(x19), .c(x15), .O(z12));
  nand2  g54(.a(new_n97_), .b(x20), .O(new_n100_));
  nor2   g55(.a(new_n58_), .b(x07), .O(new_n101_));
  nand3  g56(.a(new_n65_), .b(x18), .c(x17), .O(new_n102_));
  and2   g57(.a(new_n102_), .b(x19), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(new_n66_), .O(z13));
  nand2  g59(.a(new_n102_), .b(x21), .O(new_n105_));
  inv1   g60(.a(x21), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n65_), .c(x18), .d(x17), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nor2   g63(.a(new_n108_), .b(new_n67_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n105_), .c(new_n101_), .d(new_n66_), .O(z14));
  inv1   g65(.a(x22), .O(new_n111_));
  nor2   g66(.a(new_n108_), .b(new_n111_), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n65_), .c(x18), .d(x17), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n57_), .c(new_n90_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n112_), .c(x19), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n66_), .O(z15));
  nand2  g72(.a(new_n114_), .b(x23), .O(new_n118_));
  nand3  g73(.a(new_n50_), .b(new_n111_), .c(new_n106_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(new_n102_), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(new_n67_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n101_), .d(new_n66_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n102_), .c(x24), .O(new_n123_));
  inv1   g78(.a(x18), .O(new_n124_));
  nor2   g79(.a(x20), .b(new_n124_), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n113_), .c(new_n125_), .d(x17), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n57_), .d(new_n90_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(x19), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n66_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  inv1   g86(.a(x25), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n51_), .c(new_n50_), .d(new_n111_), .O(new_n133_));
  inv1   g88(.a(new_n133_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n108_), .c(new_n67_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n131_), .c(new_n101_), .d(new_n66_), .O(z18));
endmodule
