...
module FAU ( 
  ...
  nand2  g02(.a(x04), .b(new_n47_), .O(new_n48_));
  ...
  nand3  g15(.a(x05), .b(x04), .c(x01), .O(new_n61_));
  oai21  g16(.a(new_n60_), .b(new_n50_), .c(new_n61_), .O(z01));
  and2   g17(.a(new_n48_), .b(x16), .O(z02));
  nand3  g18(.a(new_n59_), .b(new_n48_), .c(new_n51_), .O(new_n64_));
  inv1   g19(.a(new_n64_), .O(z03));
  aoi21  g20(.a(x10), .b(new_n46_), .c(x04), .O(new_n66_));
  inv1   g21(.a(x09), .O(new_n67_));
  inv1   g22(.a(x10), .O(new_n68_));
  aoi22  g23(.a(new_n68_), .b(x01), .c(new_n67_), .d(x00), .O(new_n69_));
  ...
  oai21  g28(.a(new_n73_), .b(new_n70_), .c(new_n46_), .O(new_n74_));
  oai21  g29(.a(new_n66_), .b(x01), .c(new_n74_), .O(z04));
  oai21  g30(.a(x13), .b(x08), .c(new_n48_), .O(z05));
  nand2  g31(.a(x14), .b(new_n46_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n48_), .O(z06));
  aoi21  g33(.a(new_n46_), .b(x06), .c(new_n50_), .O(z07));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n51_), .c(new_n50_), .O(z08));
  inv1   g40(.a(x04), .O(new_n86_));
  inv1   g41(.a(x07), .O(new_n87_));
  inv1   g42(.a(x15), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n87_), .c(x05), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(x01), .c(new_n86_), .O(z09));
  nand2  g45(.a(x05), .b(x04), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n53_), .c(new_n88_), .d(new_n87_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n48_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n91_), .c(new_n88_), .d(new_n87_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n48_), .O(z11));
  ...
  nand4  g54(.a(new_n99_), .b(new_n91_), .c(new_n88_), .d(new_n87_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n48_), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n97_), .b(new_n52_), .c(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n88_), .d(new_n87_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n61_), .O(z13));
  inv1   g62(.a(x21), .O(new_n108_));
  inv1   g63(.a(new_n104_), .O(new_n109_));
  nor2   g64(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n97_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n88_), .c(new_n87_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n110_), .c(new_n48_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n61_), .O(z14));
  oai21  g70(.a(x05), .b(new_n47_), .c(x04), .O(new_n116_));
  nand2  g71(.a(new_n112_), .b(x22), .O(new_n117_));
  inv1   g72(.a(x22), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n108_), .O(new_n119_));
  nor3   g74(.a(new_n119_), .b(new_n102_), .c(x20), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x15), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n116_), .d(new_n87_), .O(z15));
  nor2   g77(.a(new_n120_), .b(new_n80_), .O(new_n123_));
  inv1   g78(.a(new_n102_), .O(new_n124_));
  nand4  g79(.a(new_n111_), .b(new_n124_), .c(new_n80_), .d(new_n118_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n88_), .c(new_n87_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n123_), .c(new_n48_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n61_), .O(z16));
  nand2  g83(.a(new_n125_), .b(x24), .O(new_n129_));
  inv1   g84(.a(x24), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n80_), .c(new_n118_), .d(new_n108_), .O(new_n131_));
  inv1   g86(.a(new_n131_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n97_), .c(new_n52_), .d(x19), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n129_), .c(new_n88_), .d(new_n87_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n61_), .O(z17));
  nand2  g91(.a(new_n133_), .b(x25), .O(new_n137_));
  nand3  g92(.a(new_n51_), .b(new_n130_), .c(new_n80_), .O(new_n138_));
  nor2   g93(.a(new_n138_), .b(new_n119_), .O(new_n139_));
  aoi21  g94(.a(new_n139_), .b(new_n109_), .c(x15), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n137_), .c(new_n116_), .d(new_n87_), .O(z18));
endmodule
