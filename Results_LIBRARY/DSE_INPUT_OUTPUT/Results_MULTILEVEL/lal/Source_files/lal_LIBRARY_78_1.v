...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n53_, new_n54_,
    ...
    new_n89_, new_n93_, new_n95_, new_n97_, new_n98_, new_n99_, new_n101_,
  ...
  nor4   g45(.a(new_n60_), .b(x17), .c(x15), .d(x07), .O(z09));
  aoi21  g46(.a(new_n61_), .b(new_n48_), .c(x15), .O(z10));
  nand3  g47(.a(new_n60_), .b(x18), .c(new_n59_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n48_), .c(x15), .O(z11));
  nand3  g49(.a(new_n60_), .b(x19), .c(new_n59_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n48_), .c(x15), .O(z12));
  inv1   g51(.a(x15), .O(new_n97_));
  nand3  g52(.a(new_n60_), .b(new_n63_), .c(new_n59_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n97_), .O(z13));
  nand3  g55(.a(new_n60_), .b(new_n54_), .c(new_n59_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n97_), .O(z14));
  nand3  g58(.a(new_n60_), .b(new_n55_), .c(new_n59_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n97_), .O(z15));
  nand3  g61(.a(new_n60_), .b(new_n56_), .c(new_n59_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n97_), .O(z16));
  nand3  g64(.a(new_n60_), .b(new_n83_), .c(new_n59_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n48_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n97_), .O(z17));
  nand3  g67(.a(new_n60_), .b(new_n53_), .c(new_n59_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n48_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n97_), .O(z18));
endmodule
