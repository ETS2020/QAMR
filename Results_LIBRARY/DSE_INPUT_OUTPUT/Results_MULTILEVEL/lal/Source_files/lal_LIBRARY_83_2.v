...
module FAU ( 
  ...
  aoi21  g63(.a(new_n108_), .b(new_n107_), .c(x15), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n106_), .c(new_n64_), .O(z15));
  inv1   g65(.a(x23), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(new_n107_), .c(new_n111_), .O(new_n112_));
  nand4  g67(.a(new_n103_), .b(new_n107_), .c(new_n111_), .d(new_n80_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n62_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n112_), .c(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n85_), .O(z16));
  nand2  g71(.a(new_n113_), .b(x24), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n51_), .c(new_n111_), .O(new_n119_));
  or2    g74(.a(new_n119_), .b(new_n100_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n117_), .c(new_n64_), .d(new_n85_), .O(z17));
  oai21  g76(.a(new_n119_), .b(new_n100_), .c(x25), .O(new_n122_));
  nor2   g77(.a(x20), .b(new_n56_), .O(new_n123_));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n118_), .c(new_n123_), .d(new_n93_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n62_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n85_), .O(z18));
endmodule
