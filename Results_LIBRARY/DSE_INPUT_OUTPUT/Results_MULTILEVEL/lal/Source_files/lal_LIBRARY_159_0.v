...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x08), .O(new_n47_));
  ...
  nand3  g27(.a(new_n72_), .b(x15), .c(new_n46_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(z04));
  inv1   g29(.a(x13), .O(new_n75_));
  nand3  g30(.a(x15), .b(new_n75_), .c(new_n46_), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z05));
  nand3  g32(.a(x15), .b(x14), .c(new_n46_), .O(new_n78_));
  inv1   g33(.a(new_n78_), .O(z06));
  inv1   g34(.a(x15), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(x06), .c(new_n46_), .O(z07));
  inv1   g36(.a(x24), .O(new_n82_));
  inv1   g37(.a(x22), .O(new_n83_));
  aoi21  g38(.a(new_n55_), .b(new_n51_), .c(new_n83_), .O(new_n84_));
  ...
  aoi21  g44(.a(new_n89_), .b(x08), .c(x15), .O(z09));
  nand4  g45(.a(new_n60_), .b(new_n52_), .c(new_n80_), .d(x08), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n60_), .c(new_n80_), .d(x08), .O(new_n94_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n60_), .c(new_n88_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(x08), .c(x15), .O(z12));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n60_), .d(new_n88_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x08), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n80_), .O(z13));
  inv1   g61(.a(x21), .O(new_n107_));
  nor2   g62(.a(x20), .b(new_n54_), .O(new_n108_));
  aoi21  g63(.a(new_n108_), .b(new_n96_), .c(new_n107_), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n96_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n60_), .c(new_n88_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n109_), .c(x08), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n80_), .O(z14));
  nand2  g69(.a(new_n111_), .b(x22), .O(new_n115_));
  nor2   g70(.a(new_n61_), .b(x07), .O(new_n116_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n115_), .d(x08), .O(z15));
  inv1   g75(.a(x23), .O(new_n121_));
  aoi21  g76(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(new_n122_));
  nand4  g77(.a(new_n110_), .b(new_n117_), .c(new_n121_), .d(new_n83_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n60_), .c(new_n88_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n122_), .c(x08), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n80_), .O(z16));
  nand4  g81(.a(new_n121_), .b(new_n83_), .c(new_n107_), .d(new_n51_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n101_), .c(x24), .O(new_n128_));
  nor2   g83(.a(x22), .b(x21), .O(new_n129_));
  nor2   g84(.a(x24), .b(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n129_), .c(new_n108_), .d(new_n96_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n60_), .d(new_n88_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(x08), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n80_), .O(z17));
  nand4  g89(.a(new_n82_), .b(new_n121_), .c(new_n83_), .d(new_n107_), .O(new_n135_));
  oai21  g90(.a(new_n135_), .b(new_n103_), .c(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n129_), .c(new_n108_), .d(new_n96_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n60_), .d(new_n88_), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(x08), .O(new_n140_));
  nand2  g95(.a(new_n140_), .b(new_n80_), .O(z18));
endmodule
