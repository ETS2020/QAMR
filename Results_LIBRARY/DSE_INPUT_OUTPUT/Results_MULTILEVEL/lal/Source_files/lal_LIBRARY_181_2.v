...
module FAU ( 
  ...
  nand2  g51(.a(new_n96_), .b(new_n64_), .O(z10));
  ...
  aoi21  g71(.a(new_n111_), .b(x21), .c(new_n109_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(x15), .c(new_n116_), .O(z14));
  nand2  g73(.a(x19), .b(x17), .O(new_n119_));
  nand3  g74(.a(new_n54_), .b(new_n53_), .c(new_n67_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n119_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(x18), .O(new_n122_));
  nand4  g77(.a(new_n113_), .b(x19), .c(x18), .d(x17), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(x22), .c(new_n109_), .O(new_n124_));
  ...
  nand4  g82(.a(new_n113_), .b(new_n127_), .c(new_n50_), .d(new_n54_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n110_), .d(new_n47_), .O(z16));
  nand3  g84(.a(new_n67_), .b(x19), .c(x17), .O(new_n130_));
  nand4  g85(.a(new_n51_), .b(new_n50_), .c(new_n54_), .d(new_n53_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n130_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(x18), .O(new_n133_));
  aoi21  g88(.a(new_n128_), .b(x24), .c(new_n109_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(x15), .c(new_n133_), .O(z17));
  inv1   g90(.a(x25), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n51_), .c(new_n50_), .d(new_n54_), .O(new_n137_));
  oai21  g92(.a(new_n137_), .b(new_n114_), .c(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(x18), .O(new_n139_));
  oai21  g94(.a(new_n131_), .b(new_n111_), .c(x25), .O(new_n140_));
  nand2  g95(.a(new_n140_), .b(new_n110_), .O(new_n141_));
