...
module FAU ( 
  ...
  aoi21  g30(.a(new_n48_), .b(x08), .c(x13), .O(z05));
  ...
  nand3  g41(.a(new_n64_), .b(new_n48_), .c(new_n86_), .O(new_n87_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n102_), .d(new_n48_), .O(z14));
  inv1   g64(.a(x21), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n54_), .c(x19), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n94_), .c(x22), .O(new_n112_));
  inv1   g67(.a(new_n100_), .O(new_n113_));
  nor3   g68(.a(x22), .b(x21), .c(x20), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n63_), .d(new_n86_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n48_), .O(new_n117_));
  nand2  g72(.a(x15), .b(x13), .O(new_n118_));
  ...
  nand4  g76(.a(new_n107_), .b(new_n113_), .c(new_n120_), .d(new_n81_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n63_), .c(new_n86_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n121_), .c(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n118_), .O(z16));
  nand4  g80(.a(new_n120_), .b(new_n81_), .c(new_n110_), .d(new_n54_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n100_), .c(x24), .O(new_n127_));
  nor2   g82(.a(x22), .b(x21), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n128_), .c(new_n103_), .d(new_n95_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n127_), .c(new_n63_), .d(new_n86_), .O(new_n131_));
  ...
  nand4  g90(.a(new_n135_), .b(new_n128_), .c(new_n103_), .d(new_n95_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n102_), .d(new_n48_), .O(z18));
endmodule
