...
module FAU ( 
  ...
  aoi21  g17(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(z01));
  ...
  oai21  g32(.a(new_n77_), .b(new_n70_), .c(new_n49_), .O(new_n78_));
  inv1   g33(.a(x15), .O(new_n79_));
  nor3   g34(.a(new_n79_), .b(new_n47_), .c(x01), .O(new_n80_));
  aoi21  g35(.a(new_n47_), .b(x01), .c(new_n80_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n78_), .c(x08), .O(z04));
  ...
  nand3  g42(.a(new_n58_), .b(x22), .c(x21), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(x24), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n52_), .c(new_n48_), .O(z08));
  ...
  nand4  g50(.a(new_n95_), .b(new_n54_), .c(new_n79_), .d(new_n47_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n95_), .c(new_n79_), .d(new_n47_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(x07), .O(z11));
  nor2   g55(.a(new_n55_), .b(new_n54_), .O(new_n101_));
  nand3  g56(.a(new_n56_), .b(x18), .c(x17), .O(new_n102_));
  oai21  g57(.a(new_n101_), .b(new_n56_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n79_), .c(new_n47_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n113_), .c(new_n62_), .O(z14));
  inv1   g73(.a(new_n106_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n53_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n95_), .c(new_n92_), .O(new_n122_));
  aoi21  g77(.a(new_n115_), .b(x22), .c(new_n122_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(x10), .c(new_n79_), .O(z15));
  ...
  nand3  g82(.a(new_n127_), .b(new_n79_), .c(new_n47_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n62_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  nor2   g86(.a(x24), .b(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n120_), .c(new_n108_), .d(new_n101_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n95_), .d(new_n92_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n79_), .O(z17));
  ...
  aoi21  g94(.a(new_n139_), .b(new_n110_), .c(x15), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n137_), .c(new_n62_), .d(new_n47_), .O(z18));
endmodule
