...
module FAU ( 
  ...
  nand3  g33(.a(new_n50_), .b(new_n68_), .c(x06), .O(z07));
  inv1   g34(.a(x23), .O(new_n80_));
  nand2  g35(.a(new_n58_), .b(new_n54_), .O(new_n81_));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n53_), .c(new_n49_), .O(z08));
  inv1   g40(.a(x07), .O(new_n86_));
  nand2  g41(.a(x05), .b(x04), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n48_), .c(new_n86_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n87_), .b(new_n55_), .c(new_n48_), .d(new_n86_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n50_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n87_), .c(new_n48_), .d(new_n86_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n87_), .c(new_n48_), .d(new_n86_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z12));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nor2   g57(.a(x20), .b(new_n57_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n87_), .d(new_n86_), .O(new_n105_));
  ...
  nor2   g64(.a(new_n88_), .b(x07), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n96_), .c(x19), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n48_), .O(z14));
  ...
  nor2   g72(.a(new_n117_), .b(x15), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n114_), .c(new_n110_), .O(z15));
  nor2   g74(.a(new_n117_), .b(new_n80_), .O(new_n120_));
  inv1   g75(.a(new_n101_), .O(new_n121_));
  nor2   g76(.a(x23), .b(x22), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n111_), .c(new_n121_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n87_), .c(new_n86_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n120_), .c(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n107_), .O(z16));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n115_), .c(new_n103_), .d(new_n96_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n87_), .c(new_n86_), .O(new_n129_));
  aoi21  g84(.a(new_n123_), .b(x24), .c(new_n129_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(x15), .c(new_n107_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n115_), .c(new_n103_), .d(new_n96_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n110_), .d(new_n48_), .O(z18));
endmodule
