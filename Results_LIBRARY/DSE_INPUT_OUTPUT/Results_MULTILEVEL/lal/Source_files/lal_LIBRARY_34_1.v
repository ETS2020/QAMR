...
module FAU ( 
  ...
  nor2   g34(.a(new_n79_), .b(x01), .O(new_n80_));
  nor2   g35(.a(x15), .b(x10), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(x01), .c(new_n80_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n78_), .c(x08), .O(z04));
  ...
  nand3  g43(.a(new_n58_), .b(x22), .c(x21), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(x24), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n52_), .c(new_n48_), .O(z08));
  nand2  g47(.a(x05), .b(x04), .O(new_n93_));
  inv1   g48(.a(x07), .O(new_n94_));
  nand2  g49(.a(new_n47_), .b(new_n94_), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n93_), .c(new_n49_), .O(z09));
  nand4  g51(.a(new_n93_), .b(new_n54_), .c(new_n47_), .d(new_n94_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n93_), .c(new_n47_), .d(new_n94_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n93_), .c(new_n47_), .d(new_n94_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n62_), .d(new_n47_), .O(z13));
  ...
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n62_), .d(new_n47_), .O(z14));
  ...
  nand2  g75(.a(x15), .b(x10), .O(new_n121_));
  ...
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n62_), .d(new_n47_), .O(z16));
  nand2  g81(.a(new_n125_), .b(x24), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n117_), .c(new_n109_), .d(new_n102_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n93_), .d(new_n94_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n121_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n117_), .c(new_n109_), .d(new_n102_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n62_), .d(new_n47_), .O(z18));
endmodule
