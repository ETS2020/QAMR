...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n63_), .c(new_n47_), .d(new_n62_), .O(new_n92_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n101_), .d(new_n47_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n101_), .d(new_n47_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand3  g70(.a(new_n106_), .b(new_n115_), .c(new_n81_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n110_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n101_), .d(new_n47_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n99_), .c(x24), .O(new_n120_));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n111_), .c(new_n102_), .d(new_n94_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n63_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n62_), .O(z17));
  nand2  g80(.a(new_n122_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n111_), .c(new_n102_), .d(new_n94_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n101_), .d(new_n47_), .O(z18));
endmodule
