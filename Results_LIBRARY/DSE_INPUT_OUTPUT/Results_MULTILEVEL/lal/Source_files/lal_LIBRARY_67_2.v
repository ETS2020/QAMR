...
module FAU ( 
  ...
  oai21  g60(.a(new_n105_), .b(x07), .c(new_n87_), .O(z14));
  inv1   g61(.a(new_n96_), .O(new_n107_));
  nor3   g62(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  aoi21  g65(.a(new_n103_), .b(x22), .c(new_n110_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(x07), .c(new_n87_), .O(z15));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n78_), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n102_), .c(new_n107_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n84_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n113_), .c(new_n48_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n87_), .O(z16));
  nand2  g73(.a(new_n115_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n98_), .O(new_n120_));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n53_), .c(new_n78_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n119_), .c(new_n64_), .d(new_n87_), .O(z17));
  ...
  nand3  g83(.a(new_n128_), .b(new_n126_), .c(new_n84_), .O(new_n129_));
