...
module FAU ( 
  ...
  aoi21  g40(.a(new_n63_), .b(new_n47_), .c(x07), .O(z09));
  nand2  g41(.a(new_n63_), .b(new_n54_), .O(new_n87_));
  ...
  nand3  g54(.a(new_n93_), .b(new_n53_), .c(x19), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n63_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n62_), .O(z13));
  ...
  oai21  g62(.a(new_n107_), .b(x15), .c(new_n62_), .O(z14));
  nand2  g63(.a(new_n105_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n63_), .O(new_n110_));
  inv1   g65(.a(new_n98_), .O(new_n111_));
  nor3   g66(.a(x22), .b(x21), .c(x20), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n62_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  aoi21  g72(.a(new_n112_), .b(new_n111_), .c(new_n117_), .O(new_n118_));
  nand3  g73(.a(new_n104_), .b(new_n117_), .c(new_n81_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n98_), .c(new_n63_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n62_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n98_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n56_), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n93_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n123_), .c(new_n63_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n62_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nor2   g86(.a(new_n110_), .b(x07), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n125_), .c(new_n124_), .d(new_n93_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n131_), .d(new_n47_), .O(z18));
endmodule
