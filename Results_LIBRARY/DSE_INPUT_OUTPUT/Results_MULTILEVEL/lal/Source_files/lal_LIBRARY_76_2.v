...
module FAU ( 
  ...
  aoi21  g021(.a(new_n66_), .b(new_n63_), .c(new_n48_), .O(z01));
  inv1   g022(.a(x16), .O(new_n68_));
  nand2  g023(.a(new_n49_), .b(new_n68_), .O(z02));
  nand2  g024(.a(new_n63_), .b(new_n49_), .O(z03));
  oai21  g025(.a(x12), .b(x08), .c(x15), .O(new_n71_));
  nand2  g026(.a(new_n71_), .b(x03), .O(new_n72_));
  ...
  nand2  g037(.a(x12), .b(new_n47_), .O(new_n83_));
  nand4  g038(.a(new_n83_), .b(new_n82_), .c(new_n80_), .d(new_n78_), .O(new_n84_));
  oai21  g039(.a(new_n84_), .b(new_n76_), .c(new_n46_), .O(new_n85_));
  ...
  aoi21  g052(.a(new_n97_), .b(new_n47_), .c(x15), .O(z09));
  nand3  g053(.a(new_n64_), .b(new_n54_), .c(new_n96_), .O(new_n99_));
  aoi21  g054(.a(new_n99_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g055(.a(x18), .b(x17), .O(new_n101_));
  nand3  g056(.a(new_n101_), .b(new_n64_), .c(new_n96_), .O(new_n102_));
  ...
  nand4  g062(.a(new_n107_), .b(new_n64_), .c(new_n104_), .d(new_n96_), .O(new_n108_));
  nor2   g063(.a(new_n108_), .b(x03), .O(z12));
  nand3  g064(.a(x19), .b(x18), .c(x17), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(x20), .O(new_n111_));
  nor2   g066(.a(new_n65_), .b(x03), .O(new_n112_));
  nand3  g067(.a(new_n105_), .b(new_n53_), .c(x19), .O(new_n113_));
  ...
  nand3  g074(.a(new_n119_), .b(new_n104_), .c(new_n96_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n60_), .b(new_n59_), .O(new_n125_));
  nor2   g080(.a(new_n125_), .b(x20), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n123_), .c(new_n64_), .d(new_n96_), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n104_), .O(z15));
  aoi21  g085(.a(new_n126_), .b(new_n124_), .c(new_n91_), .O(new_n131_));
  nand4  g086(.a(new_n118_), .b(new_n124_), .c(new_n91_), .d(new_n60_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n64_), .c(new_n96_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n131_), .c(new_n47_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n104_), .O(z16));
  nand2  g090(.a(new_n132_), .b(x24), .O(new_n136_));
  nor2   g091(.a(x22), .b(x21), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n51_), .c(new_n91_), .O(new_n138_));
  ...
  nand3  g097(.a(new_n52_), .b(new_n51_), .c(new_n91_), .O(new_n143_));
