...
module FAU ( 
  ...
  nand3  g40(.a(new_n65_), .b(new_n85_), .c(new_n48_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n64_), .b(new_n56_), .c(new_n85_), .d(new_n48_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n64_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n48_), .c(x15), .O(z11));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n66_), .d(new_n85_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n66_), .d(new_n85_), .O(z14));
  nand2  g62(.a(new_n106_), .b(x22), .O(new_n108_));
  inv1   g63(.a(new_n99_), .O(new_n109_));
  nor3   g64(.a(x22), .b(x21), .c(x20), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n109_), .c(new_n65_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n48_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n85_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n110_), .b(new_n109_), .c(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n105_), .b(new_n115_), .c(new_n80_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n99_), .c(new_n64_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n85_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n99_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x22), .b(x21), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n101_), .d(new_n94_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n64_), .O(new_n125_));
  ...
  nand4  g84(.a(new_n129_), .b(new_n122_), .c(new_n101_), .d(new_n94_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n66_), .d(new_n85_), .O(z18));
endmodule
