...
module FAU ( 
  ...
  oai21  g21(.a(new_n66_), .b(new_n59_), .c(x21), .O(new_n67_));
  ...
  nand2  g26(.a(new_n65_), .b(new_n60_), .O(new_n72_));
  nor2   g27(.a(new_n61_), .b(new_n47_), .O(new_n73_));
  aoi21  g28(.a(new_n73_), .b(new_n72_), .c(x23), .O(new_n74_));
  oai21  g29(.a(new_n74_), .b(new_n53_), .c(new_n54_), .O(new_n75_));
  ...
  nand3  g42(.a(new_n72_), .b(x22), .c(x21), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n58_), .c(new_n53_), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(x25), .c(x15), .O(new_n90_));
  oai21  g45(.a(new_n53_), .b(new_n58_), .c(new_n54_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n47_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n90_), .O(z08));
  nand3  g48(.a(new_n51_), .b(x05), .c(x04), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n47_), .c(x15), .O(z09));
  nand4  g50(.a(new_n52_), .b(new_n47_), .c(new_n62_), .d(new_n59_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n52_), .c(new_n47_), .d(new_n59_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(x07), .O(z11));
  nor2   g55(.a(new_n63_), .b(new_n62_), .O(new_n101_));
  nand3  g56(.a(new_n64_), .b(x18), .c(x17), .O(new_n102_));
  oai21  g57(.a(new_n101_), .b(new_n64_), .c(new_n102_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n52_), .c(new_n47_), .d(new_n59_), .O(new_n104_));
  ...
  nand3  g63(.a(new_n101_), .b(new_n60_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n52_), .c(new_n51_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n108_), .c(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n59_), .O(z13));
  nand2  g67(.a(new_n110_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n59_), .O(z14));
  and2   g69(.a(new_n109_), .b(x22), .O(new_n115_));
  ...
  nand2  g74(.a(new_n119_), .b(new_n59_), .O(z15));
  nand2  g75(.a(new_n117_), .b(x23), .O(new_n121_));
  aoi21  g76(.a(x05), .b(x04), .c(x07), .O(new_n122_));
  nor3   g77(.a(x23), .b(x22), .c(x20), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n107_), .c(x21), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n121_), .d(new_n59_), .O(z16));
  aoi21  g80(.a(new_n123_), .b(new_n107_), .c(new_n53_), .O(new_n126_));
  nand4  g81(.a(new_n116_), .b(new_n107_), .c(new_n53_), .d(new_n58_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n52_), .c(new_n51_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n126_), .c(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n59_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nand4  g86(.a(new_n54_), .b(new_n53_), .c(new_n58_), .d(new_n61_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(new_n109_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(x21), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n131_), .c(new_n122_), .d(new_n59_), .O(z18));
endmodule
