...
module FAU ( 
  ...
  inv1   g24(.a(new_n62_), .O(new_n70_));
  nand2  g25(.a(new_n49_), .b(new_n51_), .O(new_n71_));
  ...
  oai21  g38(.a(new_n51_), .b(new_n47_), .c(new_n52_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(x15), .O(new_n85_));
  nand4  g40(.a(new_n58_), .b(x24), .c(x22), .d(x21), .O(new_n86_));
  ...
  nor4   g44(.a(new_n64_), .b(x23), .c(x15), .d(x07), .O(z09));
  inv1   g45(.a(x07), .O(new_n91_));
  nand3  g46(.a(new_n64_), .b(new_n54_), .c(new_n91_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g48(.a(x15), .O(new_n94_));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n64_), .c(new_n47_), .d(new_n94_), .O(new_n96_));
  ...
  nand3  g55(.a(new_n100_), .b(new_n64_), .c(new_n91_), .O(new_n101_));
  ...
  nor2   g59(.a(new_n65_), .b(x07), .O(new_n105_));
  nor2   g60(.a(x20), .b(new_n56_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n98_), .c(x23), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n94_), .O(z13));
  nand2  g63(.a(new_n106_), .b(new_n98_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x21), .O(new_n110_));
  nand4  g65(.a(new_n98_), .b(new_n59_), .c(new_n53_), .d(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n47_), .c(new_n94_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n105_), .O(z14));
  inv1   g69(.a(new_n103_), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n53_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n64_), .c(new_n91_), .O(new_n118_));
  aoi21  g73(.a(new_n111_), .b(x22), .c(new_n118_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(x23), .c(new_n94_), .O(z15));
  nand2  g75(.a(new_n118_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n94_), .O(z16));
  nand2  g77(.a(new_n117_), .b(x24), .O(new_n123_));
  nand4  g78(.a(new_n51_), .b(new_n60_), .c(new_n59_), .d(new_n53_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n115_), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n105_), .d(new_n94_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n103_), .c(x25), .O(new_n128_));
  nor2   g83(.a(x25), .b(x24), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n116_), .c(new_n106_), .d(new_n98_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n64_), .d(new_n91_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n94_), .O(z18));
endmodule
