...
module FAU ( 
  ...
  nand3  g41(.a(new_n62_), .b(new_n48_), .c(new_n47_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n50_), .O(z09));
  nand4  g43(.a(new_n61_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n50_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z11));
  nor2   g48(.a(new_n55_), .b(new_n54_), .O(new_n94_));
  nand3  g49(.a(new_n56_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(new_n56_), .c(new_n95_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nor2   g55(.a(x20), .b(new_n56_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n94_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n61_), .d(new_n48_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n64_), .O(z13));
  and2   g60(.a(new_n102_), .b(x21), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n94_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n61_), .c(new_n48_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n47_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n64_), .O(z14));
  nand2  g66(.a(new_n108_), .b(x22), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  nor2   g69(.a(new_n114_), .b(new_n99_), .O(new_n115_));
  nor2   g70(.a(new_n115_), .b(x15), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n112_), .c(new_n61_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n64_), .O(z15));
  inv1   g74(.a(x23), .O(new_n120_));
  nor2   g75(.a(new_n115_), .b(new_n120_), .O(new_n121_));
  inv1   g76(.a(new_n99_), .O(new_n122_));
  nand4  g77(.a(new_n107_), .b(new_n122_), .c(new_n120_), .d(new_n82_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n61_), .c(new_n48_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n121_), .c(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n64_), .O(z16));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n113_), .c(new_n101_), .d(new_n94_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n61_), .c(new_n48_), .O(new_n129_));
  aoi21  g84(.a(new_n123_), .b(x24), .c(new_n129_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(x07), .c(new_n64_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor2   g87(.a(new_n62_), .b(x07), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n113_), .c(new_n101_), .d(new_n94_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n132_), .d(new_n48_), .O(z18));
endmodule
