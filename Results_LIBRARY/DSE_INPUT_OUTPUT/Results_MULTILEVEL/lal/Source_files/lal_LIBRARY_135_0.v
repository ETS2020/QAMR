...
module FAU ( 
  ...
  nor2   g17(.a(z10), .b(new_n62_), .O(z02));
  inv1   g18(.a(z10), .O(z14));
  nand3  g19(.a(new_n58_), .b(z14), .c(new_n50_), .O(new_n65_));
  ...
  nand2  g30(.a(new_n75_), .b(z14), .O(z06));
  nand3  g31(.a(z14), .b(new_n46_), .c(x06), .O(z07));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(z10), .O(z08));
  zero   g38(.O(z09));
  zero   g39(.O(z11));
  zero   g40(.O(z12));
  one    g41(.O(z13));
