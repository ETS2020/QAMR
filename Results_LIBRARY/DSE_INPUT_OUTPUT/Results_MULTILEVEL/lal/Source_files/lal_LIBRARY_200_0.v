...
module FAU ( 
  ...
  nand4  g19(.a(new_n64_), .b(new_n63_), .c(new_n50_), .d(new_n49_), .O(z01));
  inv1   g20(.a(x16), .O(new_n66_));
  nor2   g21(.a(new_n47_), .b(new_n66_), .O(z02));
  nand2  g22(.a(new_n63_), .b(new_n50_), .O(z03));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n52_), .c(new_n47_), .O(z08));
  nand3  g39(.a(new_n49_), .b(x05), .c(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x06), .c(x15), .O(z09));
  nand3  g41(.a(new_n64_), .b(new_n54_), .c(new_n49_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x06), .c(x15), .O(z10));
  inv1   g43(.a(x06), .O(new_n89_));
  inv1   g44(.a(x15), .O(new_n90_));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n64_), .c(new_n90_), .d(new_n49_), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(new_n89_), .O(z11));
  ...
  nand4  g60(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n49_), .O(z13));
  aoi21  g61(.a(new_n102_), .b(new_n94_), .c(new_n59_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n94_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n64_), .c(new_n49_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(x06), .O(new_n111_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n101_), .d(new_n49_), .O(z15));
  nand2  g73(.a(new_n116_), .b(x23), .O(new_n119_));
  nand3  g74(.a(new_n108_), .b(new_n80_), .c(new_n60_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n114_), .c(x15), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n119_), .c(new_n101_), .d(new_n49_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n64_), .d(new_n49_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(x06), .O(new_n128_));
  ...
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n101_), .d(new_n49_), .O(z18));
endmodule
