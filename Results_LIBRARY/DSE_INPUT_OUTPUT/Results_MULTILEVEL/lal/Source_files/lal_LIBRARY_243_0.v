...
module FAU ( 
  ...
  nor3   g28(.a(z12), .b(x13), .c(x08), .O(z05));
  nand2  g29(.a(x14), .b(new_n46_), .O(new_n75_));
  nand2  g30(.a(new_n75_), .b(z15), .O(z06));
  aoi21  g31(.a(new_n46_), .b(x06), .c(z12), .O(z07));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n52_), .c(z12), .O(z08));
  zero   g37(.O(z09));
  zero   g38(.O(z10));
  zero   g39(.O(z11));
  one    g40(.O(z13));
  one    g41(.O(z14));
  one    g42(.O(z18));
  inv1   g43(.a(z12), .O(z16));
  inv1   g44(.a(z12), .O(z17));
endmodule
