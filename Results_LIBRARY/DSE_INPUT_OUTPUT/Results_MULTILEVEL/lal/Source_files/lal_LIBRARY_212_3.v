...
module FAU ( 
  ...
  nand3  g38(.a(new_n61_), .b(x22), .c(x21), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n55_), .c(x24), .O(new_n86_));
  inv1   g41(.a(x15), .O(new_n87_));
  nand2  g42(.a(x25), .b(new_n87_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n86_), .O(z08));
  nand4  g44(.a(new_n87_), .b(new_n50_), .c(x05), .d(x04), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand4  g46(.a(new_n51_), .b(new_n57_), .c(new_n87_), .d(new_n50_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n47_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n51_), .c(new_n87_), .d(new_n50_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n51_), .c(new_n87_), .d(new_n50_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z12));
  inv1   g57(.a(new_n52_), .O(new_n103_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n87_), .O(z13));
  aoi21  g63(.a(new_n106_), .b(new_n98_), .c(new_n62_), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n98_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n51_), .c(new_n50_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n109_), .c(new_n87_), .O(new_n113_));
  nand2  g68(.a(new_n55_), .b(x15), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n113_), .O(z14));
  nand3  g70(.a(new_n62_), .b(new_n56_), .c(x19), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n97_), .c(x22), .O(new_n117_));
  inv1   g72(.a(new_n104_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n63_), .c(new_n62_), .d(new_n56_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n51_), .d(new_n50_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n87_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n114_), .O(z15));
  nand2  g77(.a(new_n119_), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n110_), .b(new_n118_), .c(new_n83_), .d(new_n63_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n103_), .d(new_n87_), .O(z16));
  nand2  g80(.a(new_n124_), .b(x24), .O(new_n126_));
  nand4  g81(.a(new_n54_), .b(new_n83_), .c(new_n63_), .d(new_n62_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n106_), .c(new_n98_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n126_), .c(new_n103_), .d(new_n87_), .O(z17));
  oai21  g85(.a(new_n127_), .b(new_n107_), .c(new_n87_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n55_), .O(new_n132_));
  nand3  g87(.a(new_n129_), .b(x25), .c(new_n87_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n53_), .O(z18));
endmodule
