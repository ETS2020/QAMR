...
module FAU ( 
  ...
  nor3   g28(.a(z11), .b(x13), .c(x08), .O(z05));
  inv1   g29(.a(x14), .O(new_n75_));
  nor3   g30(.a(z11), .b(new_n75_), .c(x08), .O(z06));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n51_), .c(z11), .O(z08));
  zero   g38(.O(z09));
  zero   g39(.O(z10));
  zero   g40(.O(z12));
  one    g41(.O(z16));
  one    g42(.O(z17));
  one    g43(.O(z18));
  inv1   g44(.a(z11), .O(z14));
  inv1   g45(.a(z11), .O(z15));
endmodule
