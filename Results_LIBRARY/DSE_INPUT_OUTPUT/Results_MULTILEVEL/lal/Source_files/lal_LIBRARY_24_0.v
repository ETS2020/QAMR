...
module FAU ( 
  ...
  nor2   g21(.a(z09), .b(new_n66_), .O(z02));
  nand2  g22(.a(new_n60_), .b(z13), .O(z03));
  ...
  oai21  g30(.a(x13), .b(x08), .c(z13), .O(z05));
  ...
  one    g39(.O(z18));
  nor2   g40(.a(x15), .b(x07), .O(z10));
  nor2   g41(.a(x15), .b(x07), .O(z11));
  nor2   g42(.a(x15), .b(x07), .O(z12));
  inv1   g43(.a(z09), .O(z14));
