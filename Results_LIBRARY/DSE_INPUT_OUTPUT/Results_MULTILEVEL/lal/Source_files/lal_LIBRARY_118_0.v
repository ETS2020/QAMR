...
module FAU ( 
  ...
  nand4  g47(.a(new_n92_), .b(new_n56_), .c(x19), .d(new_n60_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x07), .O(z11));
  nand2  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n56_), .c(x19), .d(new_n60_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z12));
  nand2  g52(.a(new_n95_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n59_), .b(x18), .c(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n98_), .c(new_n56_), .d(new_n55_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x19), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n60_), .O(z13));
  inv1   g57(.a(new_n95_), .O(new_n103_));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n56_), .c(new_n55_), .O(new_n106_));
  aoi21  g61(.a(new_n99_), .b(x21), .c(new_n106_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n61_), .c(new_n60_), .O(z14));
  inv1   g63(.a(new_n57_), .O(new_n109_));
  nand2  g64(.a(new_n105_), .b(x22), .O(new_n110_));
  inv1   g65(.a(x21), .O(new_n111_));
  inv1   g66(.a(x22), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n59_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n95_), .O(new_n114_));
  nor2   g69(.a(new_n114_), .b(new_n61_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n110_), .c(new_n109_), .d(new_n60_), .O(z15));
  oai21  g71(.a(new_n113_), .b(new_n95_), .c(x23), .O(new_n117_));
  inv1   g72(.a(new_n99_), .O(new_n118_));
  nor3   g73(.a(x23), .b(x22), .c(x21), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n117_), .c(new_n56_), .d(new_n55_), .O(new_n121_));
  ...
  nand4  g80(.a(new_n125_), .b(new_n51_), .c(new_n112_), .d(new_n111_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n118_), .c(new_n61_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n109_), .d(new_n60_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n99_), .c(x25), .O(new_n130_));
  nor2   g85(.a(x23), .b(x22), .O(new_n131_));
  nor2   g86(.a(x25), .b(x24), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n131_), .c(new_n104_), .d(new_n103_), .O(new_n133_));
