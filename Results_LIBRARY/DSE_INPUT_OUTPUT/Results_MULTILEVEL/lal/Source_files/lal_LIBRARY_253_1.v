...
module FAU ( 
  ...
  aoi21  g40(.a(new_n61_), .b(new_n60_), .c(x07), .O(z09));
  nand2  g41(.a(new_n61_), .b(new_n52_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n60_), .c(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n61_), .c(new_n60_), .d(new_n47_), .O(new_n90_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n60_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n60_), .O(z13));
  ...
  oai21  g61(.a(new_n106_), .b(x15), .c(new_n47_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n61_), .O(new_n112_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n100_), .d(new_n60_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n98_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n54_), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n110_), .c(new_n122_), .d(new_n93_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n61_), .O(new_n125_));
