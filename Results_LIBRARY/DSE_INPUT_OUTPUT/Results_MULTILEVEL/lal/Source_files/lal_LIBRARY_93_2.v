...
module FAU ( 
  ...
  oai21  g62(.a(new_n107_), .b(x07), .c(new_n85_), .O(z14));
  ...
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n64_), .O(z15));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n80_), .O(new_n114_));
  ...
  nand3  g77(.a(new_n122_), .b(new_n51_), .c(new_n80_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n64_), .d(new_n85_), .O(z17));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n122_), .c(new_n121_), .O(new_n129_));
