...
module FAU ( 
  ...
  nor2   g19(.a(new_n49_), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n60_), .b(new_n50_), .c(new_n52_), .O(new_n66_));
  ...
  nand3  g30(.a(new_n50_), .b(x14), .c(new_n46_), .O(new_n76_));
  ...
  nand2  g40(.a(new_n48_), .b(new_n47_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n85_), .c(new_n50_), .O(z09));
  nand4  g42(.a(new_n85_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n85_), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n50_), .O(z11));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n62_), .d(new_n48_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n80_), .c(new_n102_), .d(new_n53_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n112_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n62_), .d(new_n48_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n98_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n113_), .c(new_n103_), .d(new_n93_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n85_), .d(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n109_), .O(z17));
  nand4  g82(.a(new_n79_), .b(new_n117_), .c(new_n80_), .d(new_n102_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n100_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n113_), .c(new_n103_), .d(new_n93_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n85_), .d(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n109_), .O(z18));
endmodule
