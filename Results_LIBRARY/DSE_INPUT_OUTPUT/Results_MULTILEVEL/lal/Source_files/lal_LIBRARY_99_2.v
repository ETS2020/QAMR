...
module FAU ( 
  ...
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n62_), .O(new_n112_));
  ...
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n80_), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n104_), .c(new_n110_), .O(new_n118_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n50_), .c(new_n80_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n63_), .d(new_n85_), .O(z17));
  ...
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n61_), .O(new_n132_));
