...
module FAU ( 
  ...
  nand4  g39(.a(new_n84_), .b(new_n47_), .c(x05), .d(x04), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z09));
  nand4  g41(.a(new_n61_), .b(new_n53_), .c(new_n84_), .d(new_n47_), .O(new_n87_));
  ...
  nand2  g56(.a(new_n101_), .b(new_n84_), .O(z13));
  ...
  oai21  g61(.a(new_n106_), .b(x07), .c(new_n84_), .O(z14));
  ...
  aoi21  g66(.a(new_n104_), .b(x22), .c(new_n111_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(x07), .c(new_n84_), .O(z15));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n78_), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n103_), .c(new_n108_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n61_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n114_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n84_), .O(z16));
  nand2  g74(.a(new_n116_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n99_), .O(new_n121_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n61_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n84_), .O(z17));
  oai21  g84(.a(new_n124_), .b(new_n99_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n123_), .c(new_n121_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n61_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n84_), .O(z18));
endmodule
