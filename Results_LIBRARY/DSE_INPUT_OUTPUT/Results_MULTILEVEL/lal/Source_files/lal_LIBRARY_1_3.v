...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n74_, new_n75_, new_n77_, new_n79_, new_n81_,
  ...
  nand2  g20(.a(new_n59_), .b(new_n47_), .O(z03));
  ...
  nand3  g36(.a(new_n56_), .b(x22), .c(x21), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(x24), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n50_), .c(new_n79_), .O(z08));
  ...
  nand4  g44(.a(new_n60_), .b(new_n52_), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n47_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n60_), .c(new_n87_), .d(new_n86_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n47_), .O(z11));
  nor2   g49(.a(new_n53_), .b(new_n52_), .O(new_n95_));
  nand3  g50(.a(new_n54_), .b(x18), .c(x17), .O(new_n96_));
  oai21  g51(.a(new_n95_), .b(new_n54_), .c(new_n96_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n60_), .c(new_n87_), .d(new_n86_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n95_), .b(new_n51_), .c(x19), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n62_), .d(new_n87_), .O(z13));
  nand2  g58(.a(new_n102_), .b(x21), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n95_), .c(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n62_), .d(new_n87_), .O(z14));
  inv1   g62(.a(new_n100_), .O(new_n108_));
  ...
  aoi21  g66(.a(new_n106_), .b(x22), .c(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n87_), .b(x07), .O(new_n113_));
  oai21  g68(.a(new_n112_), .b(x07), .c(new_n113_), .O(z15));
  nand2  g69(.a(new_n110_), .b(x23), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n105_), .c(new_n108_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n62_), .d(new_n87_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n102_), .O(new_n120_));
  nand3  g75(.a(new_n109_), .b(new_n49_), .c(new_n81_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n62_), .d(new_n87_), .O(z17));
  nand2  g79(.a(new_n123_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n109_), .c(new_n120_), .O(new_n127_));
