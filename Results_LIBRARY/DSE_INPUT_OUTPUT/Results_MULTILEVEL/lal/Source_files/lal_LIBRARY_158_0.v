// Benchmark "FAU" written by ABC on Fri Aug 14 00:09:25 2020
...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x13), .O(new_n47_));
  ...
  aoi21  g31(.a(x15), .b(x08), .c(x13), .O(z05));
  ...
  aoi21  g41(.a(new_n86_), .b(x13), .c(x15), .O(z09));
  inv1   g42(.a(x15), .O(new_n88_));
  nand4  g43(.a(new_n62_), .b(new_n52_), .c(new_n88_), .d(x13), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(new_n88_), .d(x13), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(x07), .O(z11));
  nor2   g48(.a(new_n53_), .b(new_n52_), .O(new_n94_));
  nand3  g49(.a(new_n54_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(new_n54_), .c(new_n95_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n62_), .c(new_n85_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(x13), .c(x15), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nand4  g55(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n62_), .d(new_n85_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x13), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n88_), .O(z13));
  inv1   g59(.a(new_n101_), .O(new_n105_));
  nor2   g60(.a(new_n105_), .b(new_n57_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n94_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n62_), .c(new_n85_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(x13), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n88_), .O(z14));
  nand2  g66(.a(new_n108_), .b(x22), .O(new_n112_));
  nor2   g67(.a(new_n63_), .b(x07), .O(new_n113_));
  inv1   g68(.a(new_n99_), .O(new_n114_));
  nor3   g69(.a(x22), .b(x21), .c(x20), .O(new_n115_));
  aoi21  g70(.a(new_n115_), .b(new_n114_), .c(x15), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n112_), .d(x13), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  aoi21  g73(.a(new_n115_), .b(new_n114_), .c(new_n118_), .O(new_n119_));
  nand4  g74(.a(new_n107_), .b(new_n114_), .c(new_n118_), .d(new_n58_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n62_), .c(new_n85_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(x13), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n88_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n49_), .c(new_n118_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n105_), .c(x15), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n113_), .d(x13), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n101_), .c(x25), .O(new_n130_));
  inv1   g85(.a(new_n125_), .O(new_n131_));
  nand3  g86(.a(new_n50_), .b(new_n49_), .c(new_n118_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  aoi21  g88(.a(new_n133_), .b(new_n105_), .c(x15), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n130_), .c(new_n113_), .d(x13), .O(z18));
endmodule
