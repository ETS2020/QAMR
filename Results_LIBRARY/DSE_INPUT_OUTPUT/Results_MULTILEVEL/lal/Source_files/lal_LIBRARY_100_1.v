...
module FAU ( 
  ...
  nand4  g41(.a(new_n60_), .b(new_n53_), .c(new_n47_), .d(new_n50_), .O(new_n87_));
  ...
  oai21  g62(.a(new_n107_), .b(x15), .c(new_n50_), .O(z14));
  ...
  nand2  g70(.a(new_n115_), .b(new_n50_), .O(z15));
  ...
  nand4  g79(.a(new_n124_), .b(new_n110_), .c(new_n99_), .d(new_n92_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n60_), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x24), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x15), .c(new_n50_), .O(z17));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n110_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n100_), .c(new_n60_), .O(new_n131_));
  aoi21  g86(.a(new_n125_), .b(x25), .c(new_n131_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(x15), .c(new_n50_), .O(z18));
endmodule
