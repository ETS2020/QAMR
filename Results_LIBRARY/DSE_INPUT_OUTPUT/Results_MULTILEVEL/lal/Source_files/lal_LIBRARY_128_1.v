...
module FAU ( 
  ...
  nor2   g53(.a(new_n61_), .b(x07), .O(new_n99_));
  ...
  nand3  g67(.a(new_n112_), .b(new_n108_), .c(new_n99_), .O(z15));
  nor2   g68(.a(new_n111_), .b(new_n80_), .O(new_n114_));
  inv1   g69(.a(new_n97_), .O(new_n115_));
  ...
  nand4  g76(.a(new_n121_), .b(new_n109_), .c(new_n100_), .d(new_n92_), .O(new_n122_));
  ...
  oai21  g82(.a(new_n127_), .b(new_n101_), .c(new_n60_), .O(new_n128_));
