...
module FAU ( 
  ...
  nand3  g41(.a(new_n60_), .b(new_n86_), .c(new_n47_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n59_), .b(new_n52_), .c(new_n86_), .d(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n59_), .c(new_n86_), .d(new_n47_), .O(new_n92_));
  ...
  nand2  g51(.a(new_n96_), .b(new_n59_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nor2   g55(.a(new_n60_), .b(x07), .O(new_n101_));
  nand3  g56(.a(new_n94_), .b(new_n51_), .c(x19), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n86_), .O(z13));
  ...
  oai21  g62(.a(new_n107_), .b(x07), .c(new_n86_), .O(z14));
  ...
  nand2  g70(.a(new_n115_), .b(new_n86_), .O(z15));
  nor2   g71(.a(new_n112_), .b(new_n80_), .O(new_n117_));
  inv1   g72(.a(new_n99_), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n104_), .c(new_n118_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n59_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n117_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n86_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n102_), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n110_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n124_), .c(new_n59_), .O(new_n130_));
  ...
  nand3  g89(.a(new_n134_), .b(new_n110_), .c(new_n125_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n101_), .d(new_n86_), .O(z18));
endmodule
