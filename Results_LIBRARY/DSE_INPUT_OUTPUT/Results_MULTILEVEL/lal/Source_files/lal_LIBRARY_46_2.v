...
module FAU ( 
  ...
  nand4  g54(.a(new_n99_), .b(new_n61_), .c(new_n47_), .d(new_n89_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand2  g58(.a(new_n61_), .b(new_n89_), .O(new_n104_));
  ...
  aoi21  g64(.a(new_n109_), .b(new_n97_), .c(x15), .O(new_n110_));
  aoi21  g65(.a(new_n107_), .b(x21), .c(new_n104_), .O(new_n111_));
  oai22  g66(.a(new_n111_), .b(x15), .c(new_n110_), .d(new_n55_), .O(z14));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n97_), .c(new_n52_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x19), .O(new_n116_));
  nand3  g71(.a(new_n109_), .b(new_n97_), .c(x19), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(x22), .c(new_n104_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n116_), .O(z15));
  ...
  inv1   g79(.a(new_n102_), .O(new_n125_));
  nand3  g80(.a(new_n113_), .b(new_n125_), .c(new_n52_), .O(new_n126_));
  aoi21  g81(.a(new_n126_), .b(x23), .c(new_n104_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x15), .c(new_n124_), .O(z16));
  nand2  g83(.a(new_n121_), .b(new_n109_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n102_), .c(x24), .O(new_n130_));
  nor2   g85(.a(x24), .b(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n113_), .c(new_n106_), .d(new_n97_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n105_), .d(new_n47_), .O(z17));
  nand3  g88(.a(new_n109_), .b(x18), .c(x17), .O(new_n134_));
  nand3  g89(.a(new_n121_), .b(new_n51_), .c(new_n80_), .O(new_n135_));
  oai21  g90(.a(new_n135_), .b(new_n134_), .c(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(x19), .O(new_n137_));
  aoi21  g92(.a(new_n132_), .b(x25), .c(new_n104_), .O(new_n138_));
