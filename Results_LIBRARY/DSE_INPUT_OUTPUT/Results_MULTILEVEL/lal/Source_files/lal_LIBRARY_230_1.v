...
module FAU ( 
  ...
  nand4  g41(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n87_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n62_), .O(new_n127_));
  ...
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n62_), .O(new_n133_));
