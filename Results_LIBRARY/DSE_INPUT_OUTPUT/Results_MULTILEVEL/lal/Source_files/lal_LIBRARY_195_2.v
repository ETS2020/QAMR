...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n59_), .c(new_n90_), .d(new_n47_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n59_), .c(new_n90_), .d(new_n47_), .O(new_n97_));
  ...
  oai21  g63(.a(new_n108_), .b(x07), .c(new_n90_), .O(z14));
  ...
  nand4  g73(.a(new_n105_), .b(new_n118_), .c(new_n116_), .d(new_n81_), .O(new_n119_));
  ...
  nand3  g79(.a(new_n111_), .b(new_n80_), .c(new_n116_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n123_), .c(new_n59_), .O(new_n128_));
  ...
  nand3  g87(.a(new_n132_), .b(new_n111_), .c(new_n124_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n86_), .d(new_n90_), .O(z18));
endmodule
