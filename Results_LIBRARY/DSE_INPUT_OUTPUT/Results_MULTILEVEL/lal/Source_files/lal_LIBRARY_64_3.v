...
module FAU ( 
  ...
  nand2  g58(.a(new_n86_), .b(x07), .O(new_n104_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n59_), .c(new_n86_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n85_), .O(new_n110_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n61_), .d(new_n86_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x22), .O(new_n118_));
  nand3  g73(.a(new_n107_), .b(new_n79_), .c(new_n118_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n113_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n61_), .d(new_n86_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n99_), .c(x24), .O(new_n123_));
  inv1   g78(.a(new_n101_), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n114_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n123_), .c(new_n59_), .d(new_n86_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n85_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n104_), .O(z17));
  oai21  g86(.a(new_n126_), .b(new_n101_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n114_), .c(new_n124_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n59_), .d(new_n86_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n85_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n104_), .O(z18));
endmodule
