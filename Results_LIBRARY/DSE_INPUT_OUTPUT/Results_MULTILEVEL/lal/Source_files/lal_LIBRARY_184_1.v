...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n47_), .d(new_n51_), .O(new_n96_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n61_), .O(new_n102_));
  ...
  nor2   g60(.a(new_n62_), .b(x07), .O(new_n106_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n106_), .d(new_n47_), .O(z15));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n106_), .d(new_n47_), .O(z16));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n112_), .c(new_n100_), .d(new_n93_), .O(new_n120_));
  ...
  oai21  g80(.a(new_n125_), .b(new_n101_), .c(new_n61_), .O(new_n126_));
