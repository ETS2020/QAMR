...
module FAU ( 
  ...
  aoi21  g020(.a(new_n65_), .b(new_n62_), .c(new_n49_), .O(z01));
  and2   g021(.a(new_n47_), .b(x16), .O(z02));
  nand2  g022(.a(new_n62_), .b(new_n47_), .O(z03));
  ...
  nor2   g037(.a(x15), .b(x11), .O(new_n83_));
  aoi21  g038(.a(new_n83_), .b(x02), .c(new_n82_), .O(new_n84_));
  aoi21  g039(.a(new_n84_), .b(new_n80_), .c(x08), .O(z04));
  oai21  g040(.a(x13), .b(x08), .c(new_n47_), .O(z05));
  inv1   g041(.a(x14), .O(new_n87_));
  oai21  g042(.a(new_n87_), .b(x08), .c(new_n47_), .O(z06));
  nand3  g043(.a(new_n47_), .b(new_n46_), .c(x06), .O(z07));
  ...
  aoi21  g048(.a(new_n93_), .b(new_n51_), .c(new_n49_), .O(z08));
  inv1   g049(.a(x07), .O(new_n95_));
  inv1   g050(.a(x15), .O(new_n96_));
  nand3  g051(.a(new_n64_), .b(new_n96_), .c(new_n95_), .O(new_n97_));
  inv1   g052(.a(new_n97_), .O(z09));
  nand4  g053(.a(new_n63_), .b(new_n53_), .c(new_n96_), .d(new_n95_), .O(new_n99_));
  inv1   g054(.a(new_n99_), .O(z10));
  xor2a  g055(.a(x18), .b(x17), .O(new_n101_));
  nand4  g056(.a(new_n101_), .b(new_n63_), .c(new_n96_), .d(new_n95_), .O(new_n102_));
  ...
  nand4  g061(.a(new_n106_), .b(new_n63_), .c(new_n96_), .d(new_n95_), .O(new_n107_));
  ...
  nand4  g066(.a(new_n111_), .b(new_n110_), .c(new_n65_), .d(new_n96_), .O(z13));
  inv1   g067(.a(new_n111_), .O(new_n113_));
  nor2   g068(.a(new_n113_), .b(new_n58_), .O(new_n114_));
  nor2   g069(.a(x21), .b(x20), .O(new_n115_));
  nand3  g070(.a(new_n115_), .b(new_n104_), .c(x19), .O(new_n116_));
  nand3  g071(.a(new_n116_), .b(new_n63_), .c(new_n95_), .O(new_n117_));
  oai21  g072(.a(new_n117_), .b(new_n114_), .c(new_n96_), .O(new_n118_));
  inv1   g073(.a(x02), .O(new_n119_));
  nand2  g074(.a(x15), .b(new_n119_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n118_), .O(z14));
  inv1   g076(.a(new_n109_), .O(new_n122_));
  nor3   g077(.a(x22), .b(x21), .c(x20), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n63_), .c(new_n95_), .O(new_n125_));
  aoi21  g080(.a(new_n116_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(x15), .c(new_n120_), .O(z15));
  aoi21  g082(.a(new_n123_), .b(new_n122_), .c(new_n90_), .O(new_n128_));
  nand4  g083(.a(new_n115_), .b(new_n122_), .c(new_n90_), .d(new_n59_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n63_), .c(new_n95_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(new_n128_), .c(new_n96_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n120_), .O(z16));
  ...
  nand4  g093(.a(new_n138_), .b(new_n133_), .c(new_n63_), .d(new_n95_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n96_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n120_), .O(z17));
  oai21  g096(.a(new_n136_), .b(new_n111_), .c(x25), .O(new_n142_));
  nor3   g097(.a(x25), .b(x24), .c(x23), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n134_), .c(new_n113_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n142_), .c(new_n63_), .d(new_n95_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n120_), .O(z18));
endmodule
