...
module FAU ( 
  ...
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n124_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n63_), .d(new_n85_), .O(z18));
endmodule
