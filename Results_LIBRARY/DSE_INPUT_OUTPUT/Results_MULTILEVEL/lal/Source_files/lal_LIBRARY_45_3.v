...
module FAU ( 
  ...
  nand4  g43(.a(new_n84_), .b(new_n52_), .c(new_n86_), .d(new_n85_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n84_), .c(new_n86_), .d(new_n85_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n84_), .d(new_n86_), .O(new_n102_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n60_), .d(new_n86_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x22), .O(new_n116_));
  nand3  g71(.a(new_n107_), .b(new_n79_), .c(new_n116_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n111_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n60_), .d(new_n86_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n121_), .c(new_n84_), .d(new_n86_), .O(new_n127_));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n84_), .d(new_n86_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n85_), .O(new_n134_));
