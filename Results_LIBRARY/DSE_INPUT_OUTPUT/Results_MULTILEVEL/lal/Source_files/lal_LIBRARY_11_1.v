...
module FAU ( 
  ...
  nand2  g23(.a(new_n63_), .b(new_n50_), .O(z03));
  ...
  nand3  g41(.a(new_n86_), .b(new_n48_), .c(new_n64_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n65_), .b(new_n56_), .c(new_n48_), .d(new_n64_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n97_), .b(new_n65_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n48_), .c(x07), .O(z12));
  ...
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n65_), .O(new_n103_));
  ...
  nand3  g80(.a(new_n125_), .b(new_n53_), .c(new_n118_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n107_), .d(new_n48_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n102_), .c(x25), .O(new_n129_));
  nor2   g84(.a(x20), .b(new_n58_), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n125_), .c(new_n130_), .d(new_n95_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n129_), .c(new_n65_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n64_), .O(z18));
endmodule
