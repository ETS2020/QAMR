...
module FAU ( 
  ...
  nand3  g44(.a(new_n63_), .b(new_n53_), .c(new_n87_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n63_), .c(new_n87_), .O(new_n93_));
  ...
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(x25), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n103_), .d(new_n95_), .O(z15));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(new_n81_), .O(new_n119_));
  nand4  g74(.a(new_n109_), .b(new_n115_), .c(new_n81_), .d(new_n59_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n63_), .c(new_n87_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n95_), .O(z16));
  nand4  g78(.a(new_n51_), .b(new_n81_), .c(new_n59_), .d(new_n58_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n104_), .c(new_n87_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n64_), .c(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n120_), .b(x24), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n47_), .d(new_n95_), .O(z17));
  nand2  g83(.a(new_n126_), .b(new_n95_), .O(z18));
endmodule
