...
module FAU ( 
  ...
  nor2   g63(.a(new_n84_), .b(x07), .O(new_n109_));
  inv1   g64(.a(new_n97_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(x15), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(z15));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n103_), .c(new_n110_), .O(new_n116_));
  ...
  nand3  g77(.a(new_n122_), .b(new_n52_), .c(new_n79_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n109_), .d(new_n47_), .O(z17));
  ...
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n109_), .d(new_n47_), .O(z18));
endmodule
