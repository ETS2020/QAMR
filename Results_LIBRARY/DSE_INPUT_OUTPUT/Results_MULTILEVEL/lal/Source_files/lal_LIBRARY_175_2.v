...
module FAU ( 
  ...
  oai21  g31(.a(x08), .b(x06), .c(new_n46_), .O(z07));
  ...
  nand3  g40(.a(new_n83_), .b(new_n53_), .c(new_n85_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n48_), .c(x15), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n83_), .c(new_n85_), .O(new_n89_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n83_), .c(new_n91_), .d(new_n48_), .O(new_n95_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n98_), .c(new_n61_), .d(new_n48_), .O(z13));
  ...
  nand3  g61(.a(new_n106_), .b(new_n91_), .c(new_n48_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n104_), .c(new_n61_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n110_), .c(new_n61_), .d(new_n48_), .O(z15));
  ...
  nand3  g73(.a(new_n118_), .b(new_n91_), .c(new_n48_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n116_), .c(new_n61_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n112_), .c(new_n99_), .d(new_n92_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n83_), .d(new_n85_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n91_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  and2   g84(.a(new_n129_), .b(new_n112_), .O(new_n130_));
  aoi21  g85(.a(new_n130_), .b(new_n101_), .c(x15), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n61_), .d(new_n48_), .O(z18));
endmodule
