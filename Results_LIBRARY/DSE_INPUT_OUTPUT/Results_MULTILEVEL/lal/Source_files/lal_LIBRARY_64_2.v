...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(new_n50_), .c(new_n78_), .O(z08));
  inv1   g40(.a(x07), .O(new_n86_));
  nand3  g41(.a(new_n61_), .b(new_n47_), .c(new_n86_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand2  g43(.a(new_n60_), .b(new_n52_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n86_), .c(x15), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n60_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n86_), .c(x15), .O(z11));
  ...
  aoi21  g52(.a(new_n97_), .b(new_n86_), .c(x15), .O(z12));
  ...
  oai21  g63(.a(new_n108_), .b(x07), .c(new_n47_), .O(z14));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n62_), .d(new_n47_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n105_), .c(new_n111_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n62_), .d(new_n47_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n101_), .O(new_n120_));
  inv1   g75(.a(x24), .O(new_n121_));
  nand3  g76(.a(new_n112_), .b(new_n121_), .c(new_n80_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n119_), .c(new_n60_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n86_), .O(new_n126_));
  ...
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n60_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n86_), .O(new_n132_));
