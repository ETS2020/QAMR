...
module FAU ( 
  ...
  nand3  g35(.a(x15), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g36(.a(new_n57_), .b(new_n53_), .c(new_n60_), .O(new_n82_));
  ...
  nor4   g40(.a(new_n64_), .b(x15), .c(x07), .d(x06), .O(z09));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n64_), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g44(.a(x15), .O(new_n90_));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n64_), .c(new_n90_), .d(new_n87_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n64_), .c(new_n90_), .d(new_n87_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n64_), .d(new_n87_), .O(new_n102_));
  ...
  nor2   g60(.a(new_n65_), .b(x06), .O(new_n106_));
  ...
  nand4  g73(.a(new_n107_), .b(new_n113_), .c(new_n117_), .d(new_n60_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n64_), .c(new_n87_), .O(new_n120_));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n64_), .d(new_n87_), .O(new_n133_));
