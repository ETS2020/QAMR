...
module FAU ( 
  ...
  nand4  g41(.a(new_n86_), .b(new_n53_), .c(new_n85_), .d(new_n47_), .O(new_n87_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n61_), .d(new_n85_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  inv1   g67(.a(x23), .O(new_n113_));
  nand3  g68(.a(new_n102_), .b(new_n113_), .c(new_n79_), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n108_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n61_), .d(new_n85_), .O(z16));
  oai21  g72(.a(new_n114_), .b(new_n97_), .c(x24), .O(new_n118_));
  nor2   g73(.a(x20), .b(new_n55_), .O(new_n119_));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n109_), .c(new_n119_), .d(new_n92_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n118_), .c(new_n86_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n85_), .O(z17));
  nand2  g79(.a(new_n120_), .b(new_n109_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n99_), .c(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n109_), .c(new_n119_), .d(new_n92_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n126_), .c(new_n86_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n85_), .O(z18));
endmodule
