...
module FAU ( 
  ...
  nand4  g48(.a(new_n55_), .b(x18), .c(new_n93_), .d(new_n60_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z10));
  xor2a  g50(.a(x19), .b(x17), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n55_), .c(new_n54_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(x18), .c(x15), .O(z12));
  inv1   g53(.a(new_n56_), .O(new_n99_));
  inv1   g54(.a(x19), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n93_), .c(x20), .O(new_n101_));
  nand3  g56(.a(new_n58_), .b(x19), .c(x17), .O(new_n102_));
  and2   g57(.a(new_n102_), .b(x18), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .d(new_n60_), .O(z13));
  inv1   g59(.a(x21), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n58_), .c(x19), .d(x17), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n55_), .c(new_n54_), .O(new_n107_));
  aoi21  g62(.a(new_n102_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n61_), .c(new_n60_), .O(z14));
  nand2  g64(.a(new_n106_), .b(x22), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n58_), .c(x19), .d(x17), .O(new_n112_));
  and2   g67(.a(new_n112_), .b(x18), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n99_), .d(new_n60_), .O(z15));
  ...
  nor2   g73(.a(new_n118_), .b(new_n61_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n99_), .d(new_n60_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n102_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n100_), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n111_), .c(new_n122_), .d(x17), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n55_), .d(new_n54_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x18), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n60_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  nand4  g83(.a(new_n59_), .b(new_n68_), .c(new_n50_), .d(new_n116_), .O(new_n129_));
  nor2   g84(.a(new_n129_), .b(new_n106_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(new_n61_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n99_), .d(new_n60_), .O(z18));
  nor2   g87(.a(new_n94_), .b(x07), .O(z11));
endmodule
