...
module FAU ( 
  ...
  nand3  g39(.a(new_n64_), .b(new_n48_), .c(new_n53_), .O(new_n85_));
  ...
  aoi21  g50(.a(new_n95_), .b(new_n48_), .c(x07), .O(z12));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n99_), .d(new_n48_), .O(z14));
  inv1   g60(.a(new_n97_), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n55_), .O(new_n108_));
  ...
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n99_), .d(new_n48_), .O(z16));
  ...
  nand3  g76(.a(new_n121_), .b(new_n116_), .c(new_n63_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n53_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n107_), .c(new_n117_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n99_), .d(new_n48_), .O(z18));
endmodule
