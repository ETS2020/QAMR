...
module FAU ( 
  ...
  aoi21  g35(.a(new_n80_), .b(x08), .c(new_n79_), .O(z06));
  nand3  g36(.a(new_n47_), .b(new_n70_), .c(x06), .O(z07));
  inv1   g37(.a(x23), .O(new_n83_));
  nand3  g38(.a(new_n58_), .b(x22), .c(x21), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(x24), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n52_), .c(new_n50_), .O(z08));
  inv1   g42(.a(x07), .O(new_n88_));
  nand3  g43(.a(new_n65_), .b(new_n80_), .c(new_n88_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n64_), .b(new_n54_), .c(new_n80_), .d(new_n88_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n64_), .c(new_n80_), .d(new_n88_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n64_), .c(new_n80_), .d(new_n88_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n66_), .d(new_n80_), .O(z13));
  inv1   g59(.a(new_n103_), .O(new_n105_));
  nor2   g60(.a(new_n105_), .b(new_n59_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n96_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n64_), .c(new_n88_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n80_), .O(new_n110_));
  nand2  g65(.a(x15), .b(new_n79_), .O(new_n111_));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n66_), .d(new_n80_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n114_), .c(new_n83_), .d(new_n60_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n118_), .c(new_n66_), .d(new_n80_), .O(z16));
  nand2  g75(.a(new_n119_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n115_), .b(new_n51_), .c(new_n83_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n105_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n66_), .d(new_n80_), .O(z17));
  oai21  g80(.a(new_n122_), .b(new_n103_), .c(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n115_), .c(new_n105_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n64_), .d(new_n88_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n111_), .O(z18));
endmodule
