...
module FAU ( 
  ...
  oai21  g18(.a(new_n63_), .b(new_n48_), .c(new_n53_), .O(new_n64_));
  ...
  nand2  g23(.a(new_n63_), .b(x15), .O(new_n69_));
  ...
  aoi21  g39(.a(new_n82_), .b(x21), .c(new_n84_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n48_), .c(new_n53_), .O(z08));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(x05), .c(x04), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n48_), .c(x15), .O(z09));
  inv1   g44(.a(x15), .O(new_n90_));
  nand4  g45(.a(new_n65_), .b(new_n48_), .c(new_n55_), .d(new_n90_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n65_), .c(new_n87_), .O(new_n94_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n65_), .c(new_n48_), .d(new_n90_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(x07), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nor2   g58(.a(new_n66_), .b(x07), .O(new_n104_));
  nand4  g59(.a(new_n54_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  and2   g60(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n90_), .O(z13));
  ...
  nand3  g65(.a(new_n110_), .b(new_n48_), .c(new_n90_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n108_), .c(new_n104_), .O(z14));
  nand3  g68(.a(new_n60_), .b(new_n54_), .c(x19), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n96_), .c(x22), .O(new_n115_));
  inv1   g70(.a(new_n102_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n61_), .c(new_n60_), .d(new_n54_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n65_), .d(new_n87_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n90_), .O(z15));
  nand2  g75(.a(new_n117_), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n109_), .b(new_n116_), .c(new_n83_), .d(new_n61_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n48_), .c(new_n90_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n104_), .O(z16));
  nand3  g80(.a(new_n122_), .b(new_n65_), .c(new_n87_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n48_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n90_), .O(z17));
  nand4  g83(.a(new_n53_), .b(new_n83_), .c(new_n61_), .d(new_n60_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n105_), .c(new_n87_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(new_n66_), .O(new_n131_));
  nand2  g86(.a(new_n122_), .b(x25), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n131_), .c(new_n48_), .d(new_n90_), .O(z18));
endmodule
