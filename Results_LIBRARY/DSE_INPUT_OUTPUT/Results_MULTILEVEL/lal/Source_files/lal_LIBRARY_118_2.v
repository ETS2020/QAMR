...
module FAU ( 
  ...
  aoi21  g59(.a(new_n104_), .b(x20), .c(new_n58_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(x15), .c(new_n103_), .O(z13));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n96_), .c(x15), .O(new_n108_));
  nor2   g63(.a(x20), .b(new_n61_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n96_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(x21), .c(new_n58_), .O(new_n111_));
  oai22  g66(.a(new_n111_), .b(x15), .c(new_n108_), .d(new_n61_), .O(z14));
  inv1   g67(.a(new_n58_), .O(new_n113_));
  nand3  g68(.a(new_n107_), .b(new_n96_), .c(x19), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x22), .O(new_n115_));
  inv1   g70(.a(new_n104_), .O(new_n116_));
  nor2   g71(.a(x22), .b(x21), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n60_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n113_), .d(new_n47_), .O(z15));
  inv1   g74(.a(x21), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n101_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x19), .O(new_n124_));
  aoi21  g79(.a(new_n118_), .b(x23), .c(new_n58_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x15), .c(new_n124_), .O(z16));
  nand2  g81(.a(new_n121_), .b(new_n107_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n104_), .c(x24), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n117_), .c(new_n109_), .d(new_n96_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n113_), .d(new_n47_), .O(z17));
  nand3  g86(.a(new_n107_), .b(x18), .c(x17), .O(new_n132_));
  nor2   g87(.a(x25), .b(x24), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n121_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(new_n132_), .c(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(x19), .O(new_n136_));
  aoi21  g91(.a(new_n130_), .b(x25), .c(new_n58_), .O(new_n137_));
  oai21  g92(.a(new_n137_), .b(x15), .c(new_n136_), .O(z18));
endmodule
