...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n60_), .c(new_n88_), .d(new_n47_), .O(new_n92_));
  ...
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n60_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n88_), .O(z13));
  ...
  oai21  g64(.a(new_n109_), .b(x07), .c(new_n88_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n86_), .d(new_n88_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n106_), .b(new_n112_), .c(new_n117_), .d(new_n81_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n86_), .d(new_n88_), .O(z16));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n113_), .c(new_n101_), .d(new_n94_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n60_), .O(new_n122_));
  aoi21  g77(.a(new_n118_), .b(x24), .c(new_n122_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(x07), .c(new_n88_), .O(z17));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n113_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n102_), .c(new_n60_), .O(new_n127_));
  aoi21  g82(.a(new_n121_), .b(x25), .c(new_n127_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(x07), .c(new_n88_), .O(z18));
endmodule
