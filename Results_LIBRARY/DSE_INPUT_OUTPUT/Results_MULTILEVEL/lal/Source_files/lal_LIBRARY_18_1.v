...
module FAU ( 
  ...
  aoi21  g42(.a(new_n87_), .b(new_n51_), .c(new_n48_), .O(z08));
  ...
  nand3  g72(.a(new_n117_), .b(new_n114_), .c(new_n63_), .O(z15));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(new_n83_), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n108_), .c(new_n115_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n61_), .c(new_n89_), .O(new_n122_));
  ...
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n104_), .d(new_n97_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n61_), .d(new_n89_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n112_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n126_), .c(new_n104_), .d(new_n97_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n63_), .d(new_n47_), .O(z18));
endmodule
