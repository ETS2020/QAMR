...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n48_), .c(new_n53_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n63_), .b(new_n56_), .c(new_n48_), .d(new_n53_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n63_), .c(new_n48_), .d(new_n53_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n100_), .d(new_n48_), .O(z14));
  ...
  nor2   g69(.a(new_n111_), .b(new_n114_), .O(new_n115_));
  inv1   g70(.a(new_n98_), .O(new_n116_));
  nand4  g71(.a(new_n105_), .b(new_n116_), .c(new_n114_), .d(new_n81_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n63_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n115_), .c(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n53_), .O(z16));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n109_), .c(new_n101_), .d(new_n93_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n63_), .O(new_n123_));
  aoi21  g78(.a(new_n117_), .b(x24), .c(new_n123_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x15), .c(new_n53_), .O(z17));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n109_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n102_), .c(new_n63_), .O(new_n128_));
  aoi21  g83(.a(new_n122_), .b(x25), .c(new_n128_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x15), .c(new_n53_), .O(z18));
endmodule
