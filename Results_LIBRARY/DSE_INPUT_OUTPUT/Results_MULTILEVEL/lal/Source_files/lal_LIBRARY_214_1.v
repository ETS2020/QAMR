...
module FAU ( 
  ...
  nand3  g41(.a(new_n51_), .b(x05), .c(x04), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g43(.a(x15), .O(new_n89_));
  nand4  g44(.a(new_n64_), .b(new_n47_), .c(new_n55_), .d(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x07), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n64_), .c(new_n51_), .O(new_n93_));
  ...
  nand3  g52(.a(new_n97_), .b(new_n64_), .c(new_n51_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n64_), .d(new_n51_), .O(new_n103_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n47_), .c(new_n89_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n107_), .c(new_n106_), .O(z14));
  nor2   g67(.a(x22), .b(x15), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n109_), .c(new_n64_), .d(new_n51_), .O(z15));
  nand2  g69(.a(new_n109_), .b(x23), .O(new_n115_));
  inv1   g70(.a(new_n100_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n80_), .c(new_n60_), .d(new_n54_), .O(new_n117_));
  and2   g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n107_), .d(new_n89_), .O(z16));
  nand2  g74(.a(new_n117_), .b(x24), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n116_), .c(new_n52_), .d(new_n80_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n47_), .c(new_n89_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n107_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nand4  g80(.a(new_n53_), .b(new_n52_), .c(new_n80_), .d(new_n60_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(x22), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n107_), .d(new_n89_), .O(z18));
endmodule
