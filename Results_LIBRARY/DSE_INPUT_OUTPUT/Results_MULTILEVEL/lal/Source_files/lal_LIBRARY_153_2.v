...
module FAU ( 
  ...
  nor3   g013(.a(new_n58_), .b(new_n48_), .c(x07), .O(new_n59_));
  ...
  oai21  g023(.a(new_n68_), .b(x15), .c(new_n67_), .O(new_n69_));
  ...
  nand3  g031(.a(new_n76_), .b(new_n63_), .c(new_n46_), .O(new_n77_));
  inv1   g032(.a(new_n77_), .O(z04));
  oai21  g033(.a(x13), .b(x08), .c(new_n63_), .O(z05));
  nand2  g034(.a(x14), .b(new_n46_), .O(new_n80_));
  nand2  g035(.a(new_n80_), .b(new_n63_), .O(z06));
  nand3  g036(.a(new_n63_), .b(new_n46_), .c(x06), .O(z07));
  nand3  g037(.a(x24), .b(x22), .c(x21), .O(new_n83_));
  inv1   g038(.a(new_n83_), .O(new_n84_));
  aoi21  g039(.a(new_n84_), .b(new_n68_), .c(x15), .O(new_n85_));
  oai21  g040(.a(new_n53_), .b(new_n66_), .c(new_n50_), .O(new_n86_));
  aoi21  g041(.a(new_n86_), .b(x24), .c(x25), .O(new_n87_));
  oai21  g042(.a(new_n85_), .b(x17), .c(new_n87_), .O(z08));
  inv1   g043(.a(x07), .O(new_n89_));
  nand3  g044(.a(new_n58_), .b(new_n47_), .c(new_n89_), .O(new_n90_));
  inv1   g045(.a(new_n90_), .O(z09));
  nand4  g046(.a(new_n57_), .b(new_n67_), .c(new_n47_), .d(new_n89_), .O(new_n92_));
  inv1   g047(.a(new_n92_), .O(z10));
  inv1   g048(.a(x18), .O(new_n94_));
  nand3  g049(.a(new_n94_), .b(x17), .c(new_n47_), .O(new_n95_));
  oai21  g050(.a(new_n94_), .b(x17), .c(new_n95_), .O(new_n96_));
  nand3  g051(.a(new_n96_), .b(new_n57_), .c(new_n89_), .O(new_n97_));
  nand2  g052(.a(new_n97_), .b(new_n63_), .O(z11));
  inv1   g053(.a(x19), .O(new_n99_));
  nor2   g054(.a(new_n94_), .b(new_n67_), .O(new_n100_));
  nand3  g055(.a(new_n99_), .b(x18), .c(x17), .O(new_n101_));
  oai21  g056(.a(new_n100_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  nand4  g057(.a(new_n102_), .b(new_n57_), .c(new_n47_), .d(new_n89_), .O(new_n103_));
  inv1   g058(.a(new_n103_), .O(z12));
  nand3  g059(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(x20), .O(new_n106_));
  nand2  g061(.a(new_n57_), .b(new_n89_), .O(new_n107_));
  inv1   g062(.a(new_n107_), .O(new_n108_));
  nand4  g063(.a(new_n66_), .b(x19), .c(x18), .d(x17), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n108_), .c(new_n106_), .d(new_n47_), .O(z13));
  nand2  g065(.a(new_n109_), .b(x21), .O(new_n111_));
  nor2   g066(.a(x21), .b(x20), .O(new_n112_));
  nand3  g067(.a(new_n112_), .b(new_n100_), .c(x19), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n111_), .c(new_n108_), .d(new_n47_), .O(z14));
  nor2   g069(.a(new_n99_), .b(new_n94_), .O(new_n115_));
  nor2   g070(.a(x22), .b(x21), .O(new_n116_));
  nand3  g071(.a(new_n116_), .b(new_n115_), .c(new_n66_), .O(new_n117_));
  nand2  g072(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g073(.a(new_n118_), .b(x17), .O(new_n119_));
  aoi21  g074(.a(new_n113_), .b(x22), .c(new_n107_), .O(new_n120_));
  oai21  g075(.a(new_n120_), .b(x15), .c(new_n119_), .O(z15));
  nand3  g076(.a(new_n66_), .b(x19), .c(x18), .O(new_n122_));
  ...
  inv1   g082(.a(new_n105_), .O(new_n128_));
  nand3  g083(.a(new_n116_), .b(new_n128_), .c(new_n66_), .O(new_n129_));
  aoi21  g084(.a(new_n129_), .b(x23), .c(new_n107_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x15), .c(new_n127_), .O(z16));
  nand3  g086(.a(new_n116_), .b(new_n51_), .c(new_n50_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(new_n122_), .c(new_n47_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(x17), .O(new_n134_));
  nand3  g089(.a(new_n124_), .b(new_n112_), .c(new_n128_), .O(new_n135_));
  aoi21  g090(.a(new_n135_), .b(x24), .c(new_n107_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(x15), .c(new_n134_), .O(z17));
  nand2  g092(.a(new_n112_), .b(new_n115_), .O(new_n138_));
  nor2   g093(.a(x25), .b(x24), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n124_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n138_), .c(new_n47_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(x17), .O(new_n142_));
  oai21  g097(.a(new_n132_), .b(new_n109_), .c(x25), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n108_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n47_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n142_), .O(z18));
endmodule
