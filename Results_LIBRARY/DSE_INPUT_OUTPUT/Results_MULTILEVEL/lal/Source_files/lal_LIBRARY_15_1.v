...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n100_, new_n102_, new_n103_, new_n105_, new_n106_, new_n110_,
    new_n111_;
  ...
  nand3  g44(.a(new_n89_), .b(new_n47_), .c(new_n88_), .O(new_n90_));
  ...
  nor4   g52(.a(new_n97_), .b(x17), .c(x15), .d(x07), .O(z10));
  nor4   g53(.a(new_n97_), .b(new_n88_), .c(x15), .d(x07), .O(z11));
  nand3  g54(.a(new_n57_), .b(x19), .c(new_n56_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g56(.a(new_n57_), .b(new_n69_), .c(new_n56_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n60_), .c(new_n47_), .O(z13));
  nand3  g59(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n69_), .O(z14));
  nand3  g62(.a(new_n103_), .b(new_n52_), .c(new_n47_), .O(z15));
  nand3  g63(.a(new_n103_), .b(new_n53_), .c(new_n47_), .O(z16));
  nand3  g64(.a(new_n57_), .b(new_n72_), .c(new_n56_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n69_), .O(z17));
  nand3  g67(.a(new_n103_), .b(new_n61_), .c(new_n47_), .O(z18));
endmodule
