...
module FAU ( 
  ...
  oai21  g41(.a(new_n86_), .b(x25), .c(new_n50_), .O(new_n87_));
  ...
  nand2  g48(.a(new_n47_), .b(new_n55_), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n56_), .c(new_n50_), .O(z09));
  ...
  nand2  g57(.a(x19), .b(new_n98_), .O(new_n103_));
  nand3  g58(.a(new_n88_), .b(x18), .c(x17), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(x15), .O(new_n105_));
  nor2   g60(.a(new_n88_), .b(x17), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n105_), .c(new_n56_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(x07), .c(new_n50_), .O(z12));
  inv1   g63(.a(new_n57_), .O(new_n109_));
  nand3  g64(.a(x19), .b(x18), .c(x17), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(x20), .O(new_n111_));
  nand4  g66(.a(new_n59_), .b(x19), .c(x18), .d(x17), .O(new_n112_));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n109_), .d(new_n47_), .O(z14));
  ...
  aoi21  g77(.a(new_n116_), .b(x22), .c(new_n57_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(x15), .c(new_n122_), .O(z15));
  oai21  g79(.a(new_n120_), .b(new_n110_), .c(x23), .O(new_n125_));
  inv1   g80(.a(new_n110_), .O(new_n126_));
  nand4  g81(.a(new_n115_), .b(new_n126_), .c(new_n51_), .d(new_n90_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n109_), .d(new_n47_), .O(z16));
  nand3  g83(.a(new_n59_), .b(x19), .c(x18), .O(new_n129_));
  nand3  g84(.a(new_n119_), .b(new_n68_), .c(new_n51_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n129_), .c(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(x17), .O(new_n132_));
  aoi21  g87(.a(new_n127_), .b(x24), .c(new_n57_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(x15), .c(new_n132_), .O(z17));
  oai21  g89(.a(new_n130_), .b(new_n112_), .c(x25), .O(new_n135_));
  inv1   g90(.a(new_n112_), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n119_), .c(new_n136_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n135_), .c(new_n109_), .d(new_n47_), .O(z18));
endmodule
