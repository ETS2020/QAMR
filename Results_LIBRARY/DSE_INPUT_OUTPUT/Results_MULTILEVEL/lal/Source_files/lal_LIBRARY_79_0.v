...
module FAU ( 
  ...
  nand2  g35(.a(x08), .b(x06), .O(new_n81_));
  oai21  g36(.a(new_n80_), .b(x06), .c(new_n81_), .O(z07));
  aoi21  g37(.a(new_n55_), .b(new_n51_), .c(new_n58_), .O(new_n83_));
  ...
  inv1   g41(.a(x06), .O(new_n87_));
  nor4   g42(.a(new_n62_), .b(x15), .c(x07), .d(new_n87_), .O(z09));
  inv1   g43(.a(x07), .O(new_n89_));
  nand3  g44(.a(new_n62_), .b(new_n52_), .c(new_n89_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(x06), .c(x15), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n62_), .c(new_n80_), .d(new_n89_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(new_n87_), .O(z11));
  ...
  nand4  g52(.a(new_n97_), .b(new_n62_), .c(new_n80_), .d(new_n89_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n62_), .d(new_n89_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x06), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n80_), .O(z13));
  nand2  g60(.a(new_n102_), .b(x21), .O(new_n106_));
  nor2   g61(.a(new_n63_), .b(new_n87_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n95_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n80_), .c(new_n89_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n107_), .c(new_n106_), .O(z14));
  nand2  g67(.a(new_n109_), .b(x22), .O(new_n113_));
  inv1   g68(.a(new_n100_), .O(new_n114_));
  nand2  g69(.a(new_n58_), .b(new_n57_), .O(new_n115_));
  nor2   g70(.a(new_n115_), .b(x20), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n62_), .d(new_n89_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(x06), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n80_), .O(z15));
  inv1   g75(.a(x23), .O(new_n121_));
  aoi21  g76(.a(new_n116_), .b(new_n114_), .c(new_n121_), .O(new_n122_));
  nand4  g77(.a(new_n108_), .b(new_n114_), .c(new_n121_), .d(new_n58_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n62_), .c(new_n89_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n122_), .c(x06), .O(new_n125_));
  ...
  nand3  g84(.a(new_n129_), .b(new_n49_), .c(new_n121_), .O(new_n130_));
  inv1   g85(.a(new_n130_), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(new_n128_), .c(x15), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n127_), .c(new_n107_), .d(new_n89_), .O(z17));
  oai21  g88(.a(new_n130_), .b(new_n102_), .c(x25), .O(new_n134_));
  nand3  g89(.a(new_n50_), .b(new_n49_), .c(new_n121_), .O(new_n135_));
  nor2   g90(.a(new_n135_), .b(new_n115_), .O(new_n136_));
  aoi21  g91(.a(new_n136_), .b(new_n128_), .c(x15), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n107_), .d(new_n89_), .O(z18));
endmodule
