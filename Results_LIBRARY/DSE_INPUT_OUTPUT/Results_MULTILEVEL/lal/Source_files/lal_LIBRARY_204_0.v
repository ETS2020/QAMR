...
module FAU ( 
  ...
  nand3  g17(.a(new_n62_), .b(new_n48_), .c(x15), .O(new_n63_));
  nand2  g18(.a(new_n63_), .b(new_n54_), .O(z01));
  ...
  nor2   g37(.a(x25), .b(new_n47_), .O(new_n83_));
  oai21  g38(.a(new_n82_), .b(new_n79_), .c(new_n83_), .O(z08));
  nand3  g39(.a(new_n51_), .b(x05), .c(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x25), .c(x15), .O(z09));
  nand4  g41(.a(new_n52_), .b(x25), .c(new_n56_), .d(new_n47_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n52_), .c(new_n51_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n52_), .c(x25), .d(new_n47_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z12));
  inv1   g51(.a(new_n53_), .O(new_n97_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n99_), .c(new_n97_), .d(new_n47_), .O(z13));
  inv1   g59(.a(x21), .O(new_n105_));
  aoi21  g60(.a(new_n100_), .b(new_n92_), .c(new_n105_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n92_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n52_), .c(new_n51_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(x25), .O(new_n110_));
  ...
  aoi21  g69(.a(new_n114_), .b(new_n113_), .c(new_n48_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n97_), .d(new_n47_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  aoi21  g72(.a(new_n114_), .b(new_n113_), .c(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n113_), .c(new_n117_), .d(new_n80_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n52_), .c(new_n51_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(x25), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n47_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nand4  g78(.a(new_n79_), .b(new_n117_), .c(new_n80_), .d(new_n105_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n102_), .c(new_n48_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n97_), .d(new_n47_), .O(z17));
  nand3  g82(.a(x25), .b(new_n79_), .c(new_n117_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand2  g84(.a(new_n92_), .b(x19), .O(new_n130_));
  nor3   g85(.a(new_n130_), .b(new_n53_), .c(x15), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n107_), .d(new_n80_), .O(z18));
endmodule
