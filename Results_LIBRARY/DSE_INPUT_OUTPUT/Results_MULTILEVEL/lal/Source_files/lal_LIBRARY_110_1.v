...
module FAU ( 
  ...
  oai21  g15(.a(new_n59_), .b(new_n48_), .c(new_n60_), .O(z01));
  inv1   g16(.a(x16), .O(new_n62_));
  nor2   g17(.a(new_n48_), .b(new_n62_), .O(z02));
  inv1   g18(.a(new_n48_), .O(new_n64_));
  nand2  g19(.a(new_n58_), .b(new_n50_), .O(new_n65_));
  nand2  g20(.a(new_n65_), .b(new_n64_), .O(z03));
  ...
  inv1   g39(.a(new_n60_), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n47_), .c(new_n84_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n64_), .O(z09));
  nand4  g42(.a(new_n60_), .b(new_n52_), .c(new_n47_), .d(new_n84_), .O(new_n88_));
  ...
  oai21  g47(.a(x15), .b(x05), .c(x04), .O(new_n93_));
  ...
  nand3  g51(.a(new_n96_), .b(new_n93_), .c(new_n84_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n64_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nand3  g55(.a(new_n94_), .b(new_n51_), .c(x19), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n84_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n93_), .O(z13));
  nand2  g59(.a(new_n101_), .b(x21), .O(new_n105_));
  nor2   g60(.a(new_n85_), .b(x07), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n94_), .c(x19), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n47_), .O(z14));
  inv1   g64(.a(new_n99_), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n51_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n84_), .O(new_n113_));
  aoi21  g68(.a(new_n108_), .b(x22), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n93_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n107_), .b(new_n110_), .c(new_n117_), .d(new_n79_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .d(new_n47_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n101_), .O(new_n121_));
  nand3  g76(.a(new_n111_), .b(new_n78_), .c(new_n117_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n84_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n93_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n106_), .d(new_n47_), .O(z18));
endmodule
