...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(x25), .c(new_n52_), .d(new_n89_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n90_), .c(new_n86_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(x25), .c(x15), .O(z11));
  ...
  nand4  g54(.a(new_n99_), .b(new_n90_), .c(x25), .d(new_n89_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n90_), .d(new_n86_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x25), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n89_), .O(z13));
  ...
  nand3  g67(.a(new_n112_), .b(new_n90_), .c(new_n86_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n110_), .c(x25), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n89_), .O(z14));
  nand3  g70(.a(new_n108_), .b(new_n51_), .c(x19), .O(new_n116_));
  ...
  nand4  g75(.a(new_n120_), .b(new_n117_), .c(new_n90_), .d(new_n86_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(x25), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n89_), .O(z15));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n81_), .O(new_n124_));
  inv1   g79(.a(x22), .O(new_n125_));
  nand4  g80(.a(new_n111_), .b(new_n118_), .c(new_n81_), .d(new_n125_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n90_), .c(new_n86_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n124_), .c(x25), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n89_), .O(z16));
  nand2  g84(.a(new_n126_), .b(x24), .O(new_n130_));
  nor2   g85(.a(x24), .b(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n125_), .c(new_n108_), .O(new_n132_));
  inv1   g87(.a(new_n132_), .O(new_n133_));
  aoi21  g88(.a(new_n133_), .b(new_n109_), .c(new_n50_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n130_), .c(new_n62_), .d(new_n89_), .O(z17));
  nand2  g90(.a(new_n118_), .b(new_n62_), .O(new_n136_));
  nand3  g91(.a(new_n131_), .b(new_n111_), .c(new_n125_), .O(new_n137_));
  oai21  g92(.a(new_n137_), .b(new_n136_), .c(x25), .O(new_n138_));
