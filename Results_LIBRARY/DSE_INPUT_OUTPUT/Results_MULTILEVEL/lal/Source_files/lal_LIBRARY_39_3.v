...
module FAU ( 
  ...
  oai21  g33(.a(x15), .b(new_n68_), .c(x06), .O(z07));
  ...
  nor2   g38(.a(new_n50_), .b(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n80_), .c(new_n84_), .O(z08));
  inv1   g40(.a(x07), .O(new_n86_));
  inv1   g41(.a(x15), .O(new_n87_));
  nand3  g42(.a(new_n62_), .b(new_n87_), .c(new_n86_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n61_), .b(new_n53_), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n61_), .c(new_n87_), .d(new_n86_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n61_), .c(new_n87_), .d(new_n86_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n95_), .b(new_n52_), .c(x19), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n61_), .d(new_n86_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  inv1   g59(.a(x06), .O(new_n105_));
  nand2  g60(.a(x15), .b(new_n105_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n104_), .O(z13));
  nand2  g62(.a(new_n102_), .b(x21), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n95_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n63_), .d(new_n87_), .O(z14));
  inv1   g66(.a(new_n100_), .O(new_n112_));
  nor3   g67(.a(x22), .b(x21), .c(x20), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n61_), .c(new_n86_), .O(new_n115_));
  aoi21  g70(.a(new_n110_), .b(x22), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x15), .c(new_n106_), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  aoi21  g73(.a(new_n113_), .b(new_n112_), .c(new_n118_), .O(new_n119_));
  nand4  g74(.a(new_n109_), .b(new_n112_), .c(new_n118_), .d(new_n81_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n61_), .c(new_n86_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(new_n87_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n106_), .O(z16));
  ...
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n63_), .d(new_n87_), .O(z17));
  nand2  g84(.a(new_n128_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n126_), .c(new_n125_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n63_), .d(new_n87_), .O(z18));
endmodule
