...
module FAU ( 
  ...
  nand4  g44(.a(new_n61_), .b(new_n53_), .c(new_n79_), .d(new_n87_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x06), .O(z10));
  ...
  nand4  g52(.a(new_n97_), .b(new_n61_), .c(new_n79_), .d(new_n87_), .O(new_n98_));
  nor2   g53(.a(new_n98_), .b(x06), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nor2   g56(.a(new_n62_), .b(x06), .O(new_n102_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n102_), .c(new_n101_), .d(new_n87_), .O(z13));
  ...
  nand3  g65(.a(new_n110_), .b(new_n79_), .c(new_n87_), .O(new_n111_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n61_), .c(new_n87_), .O(new_n117_));
  aoi21  g72(.a(new_n110_), .b(x22), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x06), .c(new_n79_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n109_), .c(new_n114_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n79_), .c(new_n87_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n102_), .O(z16));
  ...
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n61_), .d(new_n87_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n79_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  and2   g88(.a(new_n133_), .b(new_n115_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n105_), .c(x15), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n132_), .c(new_n102_), .d(new_n87_), .O(z18));
endmodule
