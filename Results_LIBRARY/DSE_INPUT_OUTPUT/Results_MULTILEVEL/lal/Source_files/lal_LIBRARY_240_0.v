...
module FAU ( 
  ...
  nand2  g04(.a(x25), .b(x15), .O(new_n50_));
  ...
  nand3  g15(.a(new_n60_), .b(new_n53_), .c(new_n52_), .O(new_n61_));
  ...
  nand2  g20(.a(new_n61_), .b(new_n51_), .O(z03));
  ...
  nand2  g35(.a(new_n53_), .b(new_n52_), .O(new_n81_));
  ...
  aoi21  g40(.a(new_n85_), .b(x24), .c(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand2  g42(.a(x05), .b(x04), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(x24), .c(new_n55_), .d(new_n87_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n88_), .c(x24), .d(new_n87_), .O(new_n92_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n88_), .c(x24), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n88_), .d(new_n84_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x24), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n87_), .O(z13));
  ...
  nand3  g63(.a(new_n108_), .b(x24), .c(new_n87_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n106_), .c(new_n62_), .O(z14));
  inv1   g66(.a(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n54_), .c(x19), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n94_), .c(x22), .O(new_n114_));
  inv1   g69(.a(new_n100_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n79_), .c(new_n112_), .d(new_n54_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n88_), .d(new_n84_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(x24), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n87_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  nand3  g75(.a(new_n107_), .b(new_n52_), .c(new_n79_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(new_n115_), .c(new_n49_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n120_), .c(new_n62_), .d(new_n87_), .O(z16));
  nor2   g79(.a(new_n49_), .b(x23), .O(new_n125_));
  nand2  g80(.a(new_n62_), .b(new_n87_), .O(new_n126_));
  nor3   g81(.a(new_n126_), .b(new_n94_), .c(new_n57_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n107_), .d(new_n79_), .O(z17));
  nand3  g83(.a(new_n88_), .b(new_n53_), .c(new_n84_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(x24), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n87_), .O(z18));
endmodule
