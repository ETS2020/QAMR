...
module FAU ( 
  ...
  nor2   g70(.a(new_n63_), .b(x07), .O(new_n116_));
  nor2   g71(.a(x22), .b(x21), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(new_n102_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(x15), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n116_), .c(new_n115_), .O(z15));
  inv1   g76(.a(x23), .O(new_n122_));
  nor2   g77(.a(new_n119_), .b(new_n122_), .O(new_n123_));
  inv1   g78(.a(new_n102_), .O(new_n124_));
  nand4  g79(.a(new_n110_), .b(new_n124_), .c(new_n122_), .d(new_n85_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n62_), .c(new_n48_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n123_), .c(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n65_), .O(z16));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n117_), .c(new_n104_), .d(new_n97_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n62_), .c(new_n48_), .O(new_n131_));
  aoi21  g86(.a(new_n125_), .b(x24), .c(new_n131_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(x07), .c(new_n65_), .O(z17));
  nand2  g88(.a(new_n130_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n117_), .c(new_n104_), .d(new_n97_), .O(new_n136_));
