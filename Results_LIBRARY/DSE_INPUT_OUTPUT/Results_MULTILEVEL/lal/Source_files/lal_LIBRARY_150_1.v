...
module FAU ( 
  ...
  inv1   g40(.a(new_n62_), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n47_), .c(new_n61_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand2  g43(.a(new_n62_), .b(new_n53_), .O(new_n89_));
  ...
  aoi21  g53(.a(new_n98_), .b(new_n47_), .c(x07), .O(z12));
  ...
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n62_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n61_), .O(z13));
  ...
  oai21  g64(.a(new_n109_), .b(x15), .c(new_n61_), .O(z14));
  ...
  nand4  g74(.a(new_n106_), .b(new_n112_), .c(new_n118_), .d(new_n81_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n62_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n61_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  nor2   g79(.a(new_n86_), .b(x07), .O(new_n125_));
  inv1   g80(.a(new_n102_), .O(new_n126_));
  nor2   g81(.a(x22), .b(x21), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n50_), .d(new_n118_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n124_), .d(new_n47_), .O(z17));
  nand2  g84(.a(new_n128_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n127_), .c(new_n126_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n125_), .d(new_n47_), .O(z18));
endmodule
