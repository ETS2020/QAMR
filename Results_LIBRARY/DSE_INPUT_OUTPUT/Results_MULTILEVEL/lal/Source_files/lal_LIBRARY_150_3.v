// Benchmark "FAU" written by ABC on Fri Aug 14 00:09:22 2020
...
module FAU ( 
  ...
  nand2  g23(.a(new_n68_), .b(new_n65_), .O(z01));
  nor2   g24(.a(new_n49_), .b(new_n46_), .O(z02));
  nand2  g25(.a(new_n65_), .b(new_n50_), .O(z03));
  ...
  nand3  g35(.a(new_n50_), .b(new_n80_), .c(new_n72_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z05));
  nand3  g37(.a(new_n50_), .b(x14), .c(new_n72_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z06));
  aoi21  g39(.a(new_n72_), .b(x06), .c(new_n49_), .O(z07));
  aoi21  g40(.a(new_n59_), .b(new_n55_), .c(new_n62_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(x21), .c(x23), .O(new_n87_));
  nor2   g42(.a(new_n49_), .b(x25), .O(new_n88_));
  oai21  g43(.a(new_n87_), .b(new_n53_), .c(new_n88_), .O(z08));
  nand3  g44(.a(new_n67_), .b(new_n48_), .c(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand4  g46(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n50_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n66_), .c(new_n48_), .d(new_n47_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n66_), .c(new_n48_), .d(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n50_), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nor2   g59(.a(x20), .b(new_n58_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n66_), .d(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n48_), .b(x07), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n108_), .O(z13));
  aoi21  g65(.a(new_n105_), .b(new_n98_), .c(new_n61_), .O(new_n111_));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n98_), .c(x19), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n66_), .c(new_n48_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n111_), .c(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n109_), .O(z14));
  nand3  g71(.a(new_n61_), .b(new_n55_), .c(x19), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n97_), .c(x22), .O(new_n118_));
  inv1   g73(.a(new_n103_), .O(new_n119_));
  nor3   g74(.a(x22), .b(x21), .c(x20), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n66_), .d(new_n48_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n109_), .O(z15));
  inv1   g79(.a(x23), .O(new_n125_));
  aoi21  g80(.a(new_n120_), .b(new_n119_), .c(new_n125_), .O(new_n126_));
  nand4  g81(.a(new_n112_), .b(new_n119_), .c(new_n125_), .d(new_n62_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n66_), .c(new_n48_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n126_), .c(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n109_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  inv1   g86(.a(new_n106_), .O(new_n132_));
  nor2   g87(.a(x22), .b(x21), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n53_), .c(new_n125_), .O(new_n134_));
  inv1   g89(.a(new_n134_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n131_), .c(new_n68_), .d(new_n48_), .O(z17));
  oai21  g92(.a(new_n134_), .b(new_n106_), .c(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand3  g94(.a(new_n139_), .b(new_n133_), .c(new_n132_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n68_), .d(new_n48_), .O(z18));
endmodule
