...
module FAU ( 
  ...
  nand3  g57(.a(new_n102_), .b(new_n93_), .c(x19), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n62_), .O(new_n104_));
  aoi21  g59(.a(new_n100_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(x07), .c(new_n85_), .O(z14));
