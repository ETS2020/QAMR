...
module FAU ( 
  ...
  nand4  g16(.a(new_n61_), .b(new_n60_), .c(new_n50_), .d(new_n47_), .O(z01));
  ...
  nand2  g34(.a(new_n56_), .b(new_n52_), .O(new_n80_));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n51_), .c(new_n77_), .O(z08));
  inv1   g39(.a(new_n61_), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n50_), .c(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(new_n61_), .b(new_n53_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n50_), .c(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n61_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n50_), .c(x07), .O(z11));
  ...
  nand2  g50(.a(new_n95_), .b(new_n61_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n50_), .c(x07), .O(z12));
  ...
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n61_), .O(new_n101_));
  ...
  oai21  g62(.a(new_n107_), .b(x15), .c(new_n47_), .O(z14));
  nand2  g63(.a(new_n105_), .b(x22), .O(new_n109_));
  nor2   g64(.a(new_n85_), .b(x07), .O(new_n110_));
  inv1   g65(.a(new_n98_), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n52_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n109_), .d(new_n50_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  nor2   g70(.a(x23), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n104_), .c(new_n111_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n110_), .d(new_n50_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n100_), .O(new_n120_));
  inv1   g75(.a(x24), .O(new_n121_));
  nand3  g76(.a(new_n112_), .b(new_n121_), .c(new_n79_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n119_), .c(new_n61_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n50_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(z17));
  oai21  g82(.a(new_n122_), .b(new_n100_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n112_), .c(new_n120_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n61_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n50_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(z18));
endmodule
