...
module FAU ( 
  ...
  aoi21  g23(.a(x11), .b(new_n46_), .c(x15), .O(new_n69_));
  ...
  nand3  g47(.a(new_n62_), .b(new_n47_), .c(new_n92_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  nand4  g49(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n92_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n49_), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n61_), .c(new_n47_), .d(new_n92_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n61_), .c(new_n47_), .d(new_n92_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z12));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nand4  g61(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n63_), .d(new_n47_), .O(z13));
  ...
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n63_), .d(new_n47_), .O(z14));
  inv1   g67(.a(new_n105_), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n52_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n61_), .c(new_n92_), .O(new_n116_));
  ...
  nand3  g76(.a(new_n121_), .b(new_n110_), .c(new_n113_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n63_), .d(new_n47_), .O(z16));
  ...
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n61_), .d(new_n92_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n118_), .O(z17));
  oai21  g87(.a(new_n127_), .b(new_n107_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n114_), .c(new_n125_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n61_), .d(new_n92_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n118_), .O(z18));
endmodule
