...
module FAU ( 
  ...
  nand2  g34(.a(new_n58_), .b(new_n54_), .O(new_n80_));
  ...
  nand3  g40(.a(new_n63_), .b(new_n85_), .c(new_n48_), .O(new_n86_));
  ...
  nand4  g45(.a(new_n90_), .b(new_n62_), .c(new_n85_), .d(new_n48_), .O(new_n91_));
  ...
  nor2   g54(.a(new_n63_), .b(x07), .O(new_n100_));
  nand3  g55(.a(new_n93_), .b(new_n54_), .c(x19), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n85_), .O(z13));
  ...
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n100_), .d(new_n85_), .O(z16));
  ...
  nand3  g77(.a(new_n122_), .b(new_n117_), .c(new_n62_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n85_), .O(z17));
  nand2  g80(.a(new_n122_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n108_), .c(new_n118_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n100_), .d(new_n85_), .O(z18));
endmodule
