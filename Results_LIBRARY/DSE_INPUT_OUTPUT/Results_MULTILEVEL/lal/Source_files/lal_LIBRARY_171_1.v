...
module FAU ( 
  ...
  aoi21  g40(.a(new_n65_), .b(new_n48_), .c(x07), .O(z09));
  nand2  g41(.a(new_n65_), .b(new_n56_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n48_), .c(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n65_), .O(new_n90_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n65_), .c(new_n48_), .d(new_n64_), .O(new_n96_));
  ...
  nand3  g55(.a(new_n93_), .b(new_n55_), .c(x19), .O(new_n101_));
  ...
  oai21  g61(.a(new_n106_), .b(x15), .c(new_n64_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n65_), .O(new_n112_));
  ...
  nand3  g71(.a(new_n103_), .b(new_n116_), .c(new_n81_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n109_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n100_), .d(new_n48_), .O(z16));
  ...
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n65_), .O(new_n125_));
  ...
  nand4  g84(.a(new_n129_), .b(new_n110_), .c(new_n122_), .d(new_n93_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n100_), .d(new_n48_), .O(z18));
endmodule
