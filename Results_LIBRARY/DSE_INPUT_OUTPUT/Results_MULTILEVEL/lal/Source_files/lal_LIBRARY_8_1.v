...
module FAU ( 
  ...
  nand4  g43(.a(new_n62_), .b(new_n53_), .c(new_n47_), .d(new_n61_), .O(new_n89_));
  ...
  nand2  g58(.a(new_n103_), .b(new_n61_), .O(z13));
  ...
  nand2  g64(.a(new_n109_), .b(new_n61_), .O(z14));
  ...
  nand3  g73(.a(new_n106_), .b(new_n117_), .c(new_n81_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n99_), .c(new_n62_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n61_), .O(z16));
  ...
  nand3  g82(.a(new_n127_), .b(new_n123_), .c(new_n62_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n61_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n125_), .c(new_n124_), .d(new_n94_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n112_), .d(new_n47_), .O(z18));
endmodule
