...
module FAU ( 
  ...
  nand4  g43(.a(new_n60_), .b(new_n53_), .c(new_n86_), .d(new_n47_), .O(new_n89_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n110_), .c(new_n123_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n122_), .c(new_n101_), .d(new_n86_), .O(z17));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n110_), .c(new_n123_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n101_), .d(new_n86_), .O(z18));
endmodule
