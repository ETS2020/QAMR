...
module FAU ( 
  ...
  nor2   g15(.a(x15), .b(new_n46_), .O(new_n61_));
  inv1   g16(.a(new_n61_), .O(new_n62_));
  nand4  g17(.a(new_n62_), .b(new_n60_), .c(new_n59_), .d(new_n49_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nor2   g19(.a(new_n61_), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n62_), .b(new_n58_), .c(new_n50_), .O(new_n66_));
  ...
  oai21  g29(.a(x13), .b(x08), .c(new_n62_), .O(z05));
  nand2  g30(.a(x14), .b(new_n46_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n62_), .O(z06));
  nand2  g32(.a(new_n46_), .b(x06), .O(z07));
  inv1   g33(.a(x23), .O(new_n79_));
  nand2  g34(.a(new_n55_), .b(new_n51_), .O(new_n80_));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n50_), .c(new_n61_), .O(z08));
  nand3  g39(.a(new_n49_), .b(x05), .c(x04), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n46_), .c(x15), .O(z09));
  nand3  g41(.a(new_n60_), .b(new_n52_), .c(new_n49_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n46_), .c(x15), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n60_), .c(new_n49_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n46_), .c(x15), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n60_), .c(new_n47_), .d(new_n46_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  aoi21  g53(.a(x05), .b(x04), .c(x07), .O(new_n99_));
  nand4  g54(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x15), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n98_), .d(new_n46_), .O(z13));
  and2   g58(.a(new_n100_), .b(x21), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n92_), .c(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n60_), .c(new_n49_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n46_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(z14));
  nand2  g64(.a(new_n106_), .b(x22), .O(new_n110_));
  inv1   g65(.a(new_n97_), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n51_), .O(new_n113_));
  and2   g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n110_), .c(new_n99_), .d(new_n46_), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x22), .O(new_n117_));
  nand3  g72(.a(new_n105_), .b(new_n79_), .c(new_n117_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n111_), .c(x15), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n99_), .d(new_n46_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n97_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n112_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n101_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n122_), .c(new_n60_), .d(new_n49_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n46_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(z17));
  oai21  g84(.a(new_n124_), .b(new_n100_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n112_), .c(new_n101_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n60_), .d(new_n49_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n46_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(z18));
endmodule
