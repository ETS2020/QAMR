...
module FAU ( 
  ...
  nand2  g41(.a(new_n61_), .b(new_n54_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n61_), .c(new_n47_), .d(new_n51_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n92_), .b(new_n53_), .c(x19), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n61_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n51_), .O(z13));
  ...
  oai21  g61(.a(new_n106_), .b(x15), .c(new_n51_), .O(z14));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n108_));
  nor2   g63(.a(x22), .b(x21), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n53_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(new_n97_), .O(new_n111_));
  nor2   g66(.a(new_n111_), .b(new_n62_), .O(new_n112_));
  ...
  nor2   g71(.a(new_n111_), .b(new_n116_), .O(new_n117_));
  inv1   g72(.a(new_n97_), .O(new_n118_));
  nand4  g73(.a(new_n103_), .b(new_n118_), .c(new_n116_), .d(new_n81_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n61_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n117_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n51_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n99_), .O(new_n124_));
  nand3  g79(.a(new_n109_), .b(new_n80_), .c(new_n116_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n123_), .c(new_n61_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n51_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nor2   g86(.a(new_n62_), .b(x07), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n109_), .c(new_n124_), .O(new_n134_));
