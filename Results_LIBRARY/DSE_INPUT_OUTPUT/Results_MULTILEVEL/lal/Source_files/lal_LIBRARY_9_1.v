...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n53_, new_n54_,
    ...
    new_n82_, new_n83_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
  ...
  nand2  g17(.a(new_n62_), .b(new_n54_), .O(new_n63_));
  nand2  g18(.a(x05), .b(x04), .O(new_n64_));
  nand4  g19(.a(new_n64_), .b(new_n63_), .c(new_n48_), .d(new_n53_), .O(z01));
  nand3  g20(.a(new_n62_), .b(new_n50_), .c(new_n54_), .O(new_n66_));
  ...
  nor3   g29(.a(new_n49_), .b(x13), .c(x08), .O(z05));
  ...
  nand2  g34(.a(new_n59_), .b(new_n55_), .O(new_n80_));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n54_), .c(new_n49_), .O(z08));
  aoi21  g39(.a(new_n64_), .b(new_n48_), .c(x07), .O(z09));
  nand2  g40(.a(new_n64_), .b(new_n56_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n48_), .c(x07), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n64_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n48_), .c(x07), .O(z11));
  nor2   g45(.a(new_n57_), .b(new_n56_), .O(new_n91_));
  nand3  g46(.a(new_n58_), .b(x18), .c(x17), .O(new_n92_));
  oai21  g47(.a(new_n91_), .b(new_n58_), .c(new_n92_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n64_), .c(new_n48_), .d(new_n53_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z12));
  nand3  g50(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n91_), .b(new_n55_), .c(x19), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n64_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n48_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n53_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n48_), .O(z14));
  inv1   g61(.a(new_n96_), .O(new_n107_));
  nor2   g62(.a(x22), .b(x21), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n55_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n64_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x22), .c(new_n110_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(x15), .c(new_n53_), .O(z15));
  nand2  g67(.a(new_n109_), .b(x23), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n104_), .c(new_n107_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n103_), .d(new_n48_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  inv1   g72(.a(new_n98_), .O(new_n118_));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n108_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n103_), .d(new_n48_), .O(z17));
  nand2  g78(.a(new_n122_), .b(x25), .O(new_n124_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n108_), .c(new_n118_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n103_), .d(new_n48_), .O(z18));
endmodule
