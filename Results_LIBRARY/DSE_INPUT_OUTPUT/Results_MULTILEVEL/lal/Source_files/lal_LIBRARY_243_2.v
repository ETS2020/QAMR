...
module FAU ( 
  ...
  aoi21  g64(.a(new_n109_), .b(new_n108_), .c(new_n63_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n85_), .O(z15));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n80_), .O(new_n114_));
  ...
  nand4  g77(.a(new_n122_), .b(new_n121_), .c(new_n100_), .d(new_n93_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n62_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n85_), .O(z17));
  nand2  g81(.a(new_n123_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n121_), .c(new_n100_), .d(new_n93_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n64_), .d(new_n85_), .O(z18));
endmodule
