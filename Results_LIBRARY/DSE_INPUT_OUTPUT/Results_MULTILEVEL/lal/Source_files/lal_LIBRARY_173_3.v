...
module FAU ( 
  ...
  nand4  g43(.a(new_n86_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n89_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n86_), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n86_), .d(new_n48_), .O(new_n103_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n66_), .d(new_n48_), .O(z14));
  nand3  g65(.a(new_n61_), .b(new_n55_), .c(x19), .O(new_n111_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n86_), .d(new_n48_), .O(new_n116_));
  ...
  nand4  g75(.a(new_n108_), .b(new_n113_), .c(new_n120_), .d(new_n62_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n66_), .d(new_n48_), .O(z16));
  nand2  g77(.a(new_n121_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n102_), .O(new_n124_));
  nand3  g79(.a(new_n114_), .b(new_n53_), .c(new_n120_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n66_), .d(new_n48_), .O(z17));
  oai21  g83(.a(new_n125_), .b(new_n102_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n114_), .c(new_n124_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n66_), .d(new_n48_), .O(z18));
endmodule
