...
module FAU ( 
  ...
  nand3  g66(.a(new_n111_), .b(new_n61_), .c(new_n48_), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(x22), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(x07), .c(new_n64_), .O(z15));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand4  g71(.a(new_n106_), .b(new_n109_), .c(new_n116_), .d(new_n82_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n101_), .d(new_n48_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  nand3  g74(.a(new_n110_), .b(new_n81_), .c(new_n116_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n102_), .c(new_n94_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n119_), .c(new_n61_), .d(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n64_), .O(z17));
  oai21  g80(.a(new_n120_), .b(new_n103_), .c(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n110_), .c(new_n102_), .d(new_n94_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n61_), .d(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n64_), .O(z18));
endmodule
