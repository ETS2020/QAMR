...
module FAU ( 
  ...
  nand3  g027(.a(new_n72_), .b(new_n66_), .c(new_n46_), .O(new_n73_));
  inv1   g028(.a(new_n73_), .O(z04));
  nor3   g029(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  aoi21  g030(.a(x17), .b(x08), .c(new_n47_), .O(z06));
  nand3  g031(.a(new_n66_), .b(new_n46_), .c(x06), .O(z07));
  nand3  g032(.a(x24), .b(x22), .c(x21), .O(new_n78_));
  nor3   g033(.a(new_n78_), .b(x19), .c(x18), .O(new_n79_));
  oai21  g034(.a(new_n79_), .b(x14), .c(new_n52_), .O(new_n80_));
  inv1   g035(.a(x23), .O(new_n81_));
  oai21  g036(.a(new_n56_), .b(new_n51_), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g041(.a(new_n61_), .b(new_n86_), .c(new_n85_), .O(new_n87_));
  nand2  g042(.a(new_n87_), .b(new_n66_), .O(z09));
  nand3  g043(.a(new_n60_), .b(new_n86_), .c(new_n85_), .O(new_n89_));
  aoi21  g044(.a(new_n89_), .b(new_n47_), .c(x17), .O(z10));
  nand3  g045(.a(x18), .b(new_n52_), .c(new_n47_), .O(new_n91_));
  oai21  g046(.a(x18), .b(new_n52_), .c(new_n91_), .O(new_n92_));
  nand4  g047(.a(new_n92_), .b(new_n60_), .c(new_n86_), .d(new_n85_), .O(new_n93_));
  inv1   g048(.a(new_n93_), .O(z11));
  oai21  g049(.a(new_n53_), .b(new_n52_), .c(x19), .O(new_n95_));
  nand3  g050(.a(new_n54_), .b(x18), .c(x17), .O(new_n96_));
  nand2  g051(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g052(.a(new_n97_), .b(new_n60_), .c(new_n86_), .d(new_n85_), .O(new_n98_));
  nand2  g053(.a(new_n98_), .b(new_n66_), .O(z12));
  oai21  g054(.a(x20), .b(x14), .c(new_n52_), .O(new_n100_));
  nand3  g055(.a(new_n60_), .b(new_n86_), .c(new_n85_), .O(new_n101_));
  nand2  g056(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nor2   g057(.a(new_n54_), .b(new_n53_), .O(new_n103_));
  nand3  g058(.a(new_n51_), .b(x19), .c(x18), .O(new_n104_));
  oai21  g059(.a(new_n103_), .b(new_n51_), .c(new_n104_), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(x17), .O(new_n106_));
  nand3  g061(.a(x20), .b(new_n52_), .c(new_n47_), .O(new_n107_));
  nand3  g062(.a(new_n107_), .b(new_n106_), .c(new_n102_), .O(z13));
  oai21  g063(.a(x21), .b(x14), .c(new_n52_), .O(new_n109_));
  ...
  nand3  g070(.a(x21), .b(new_n52_), .c(new_n47_), .O(new_n116_));
  nand3  g071(.a(new_n116_), .b(new_n115_), .c(new_n110_), .O(z14));
  oai21  g072(.a(x22), .b(x14), .c(new_n52_), .O(new_n118_));
  ...
  nand3  g079(.a(x22), .b(new_n52_), .c(new_n47_), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n124_), .c(new_n119_), .O(z15));
  oai21  g081(.a(x23), .b(x14), .c(new_n52_), .O(new_n127_));
  ...
  nand3  g088(.a(x23), .b(new_n52_), .c(new_n47_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n133_), .c(new_n128_), .O(z16));
  oai21  g090(.a(x24), .b(x14), .c(new_n52_), .O(new_n136_));
  oai21  g091(.a(new_n131_), .b(new_n104_), .c(x24), .O(new_n137_));
  nor2   g092(.a(new_n61_), .b(x07), .O(new_n138_));
  nand4  g093(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  ...
  oai21  g101(.a(x25), .b(x14), .c(new_n52_), .O(new_n147_));
  oai21  g102(.a(new_n143_), .b(new_n104_), .c(x25), .O(new_n148_));
  inv1   g103(.a(new_n142_), .O(new_n149_));
  nand3  g104(.a(new_n50_), .b(new_n141_), .c(new_n81_), .O(new_n150_));
