...
module FAU ( 
  ...
  nand2  g63(.a(new_n108_), .b(new_n53_), .O(new_n109_));
  nor2   g64(.a(new_n109_), .b(new_n97_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(new_n62_), .O(new_n111_));
  ...
  nor2   g69(.a(new_n110_), .b(new_n80_), .O(new_n115_));
  ...
  nand2  g78(.a(new_n123_), .b(new_n108_), .O(new_n124_));
  or2    g79(.a(new_n124_), .b(new_n101_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n122_), .c(new_n99_), .d(new_n47_), .O(z17));
  oai21  g81(.a(new_n124_), .b(new_n101_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n108_), .c(new_n100_), .d(new_n92_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n61_), .O(new_n130_));
