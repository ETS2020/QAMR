...
module FAU ( 
  ...
  oai21  g15(.a(new_n60_), .b(new_n47_), .c(new_n52_), .O(new_n61_));
  ...
  nand3  g26(.a(new_n71_), .b(new_n51_), .c(new_n46_), .O(new_n72_));
  ...
  nand3  g31(.a(new_n51_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g32(.a(x23), .O(new_n78_));
  nand3  g33(.a(new_n58_), .b(x22), .c(x21), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(new_n78_), .c(new_n47_), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(x25), .c(x15), .O(new_n81_));
  nand2  g36(.a(x25), .b(new_n47_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n81_), .O(z08));
  nand3  g38(.a(new_n50_), .b(x05), .c(x04), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g40(.a(x15), .O(new_n86_));
  nand4  g41(.a(new_n62_), .b(new_n47_), .c(new_n54_), .d(new_n86_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n62_), .c(new_n47_), .d(new_n86_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n62_), .c(new_n47_), .d(new_n86_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n98_), .c(new_n62_), .d(new_n50_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n86_), .O(z13));
  ...
  nand3  g62(.a(new_n107_), .b(new_n47_), .c(new_n86_), .O(new_n108_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n62_), .c(new_n50_), .O(new_n114_));
  aoi21  g69(.a(new_n107_), .b(x22), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x24), .c(new_n86_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n106_), .c(new_n111_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n47_), .c(new_n86_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n117_), .c(new_n105_), .O(z16));
  nor2   g77(.a(x24), .b(x15), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n62_), .d(new_n50_), .O(z17));
  nor2   g79(.a(x25), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n112_), .c(new_n99_), .d(new_n92_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n62_), .c(new_n50_), .O(new_n127_));
  aoi21  g82(.a(new_n119_), .b(x25), .c(new_n127_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(x24), .c(new_n86_), .O(z18));
endmodule
