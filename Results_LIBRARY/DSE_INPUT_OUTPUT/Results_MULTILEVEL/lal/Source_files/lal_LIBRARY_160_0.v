...
module FAU ( 
  ...
  nand4  g19(.a(new_n64_), .b(new_n50_), .c(new_n53_), .d(new_n60_), .O(new_n65_));
  oai21  g20(.a(new_n59_), .b(new_n47_), .c(new_n65_), .O(z01));
  inv1   g21(.a(x16), .O(new_n67_));
  nor2   g22(.a(new_n47_), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n55_), .b(new_n48_), .O(new_n69_));
  nand3  g24(.a(new_n64_), .b(new_n53_), .c(new_n60_), .O(new_n70_));
  ...
  nor2   g41(.a(new_n51_), .b(x19), .O(new_n87_));
  nor2   g42(.a(new_n83_), .b(new_n52_), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n87_), .c(new_n63_), .d(x15), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n86_), .O(z08));
  nor4   g45(.a(new_n57_), .b(new_n62_), .c(x15), .d(x07), .O(z09));
  inv1   g46(.a(x17), .O(new_n92_));
  nand3  g47(.a(new_n57_), .b(new_n92_), .c(new_n56_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(x19), .c(x15), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n57_), .c(x19), .d(new_n61_), .O(new_n96_));
  ...
  inv1   g55(.a(new_n58_), .O(new_n101_));
  nand2  g56(.a(new_n98_), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n60_), .b(x18), .c(x17), .O(new_n103_));
  and2   g58(.a(new_n103_), .b(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n61_), .O(z13));
  ...
  nand4  g64(.a(new_n109_), .b(new_n106_), .c(new_n101_), .d(new_n61_), .O(z14));
  nand2  g65(.a(new_n108_), .b(new_n107_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x22), .O(new_n112_));
  nand3  g67(.a(new_n52_), .b(new_n51_), .c(new_n60_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n98_), .O(new_n114_));
  nor2   g69(.a(new_n114_), .b(new_n62_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n101_), .d(new_n61_), .O(z15));
  oai21  g71(.a(new_n113_), .b(new_n98_), .c(x23), .O(new_n117_));
  inv1   g72(.a(x18), .O(new_n118_));
  nor2   g73(.a(x20), .b(new_n118_), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n119_), .c(new_n51_), .d(x17), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n57_), .d(new_n56_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(x19), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n61_), .O(z16));
  nand3  g79(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n103_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x22), .b(x21), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n127_), .c(new_n119_), .d(x17), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n126_), .c(new_n57_), .d(new_n56_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x19), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n61_), .O(z17));
  nand4  g87(.a(new_n83_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n103_), .c(x25), .O(new_n134_));
  nor2   g89(.a(x25), .b(x24), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n120_), .c(new_n108_), .d(new_n107_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n57_), .d(new_n56_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(x19), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n61_), .O(z18));
endmodule
