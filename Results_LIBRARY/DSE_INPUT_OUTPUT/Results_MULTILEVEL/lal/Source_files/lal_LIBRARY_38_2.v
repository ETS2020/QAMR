...
module FAU ( 
  ...
  nand4  g55(.a(new_n100_), .b(new_n57_), .c(new_n47_), .d(new_n56_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z12));
  inv1   g57(.a(new_n58_), .O(new_n103_));
  nand3  g58(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  nand4  g60(.a(new_n60_), .b(x19), .c(x18), .d(x17), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n105_), .c(new_n103_), .d(new_n47_), .O(z13));
  nor2   g62(.a(new_n98_), .b(new_n90_), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n108_), .c(x15), .O(new_n110_));
  aoi21  g65(.a(new_n106_), .b(x21), .c(new_n58_), .O(new_n111_));
  oai22  g66(.a(new_n111_), .b(x15), .c(new_n110_), .d(new_n61_), .O(z14));
  nand2  g67(.a(new_n109_), .b(x19), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n96_), .c(x22), .O(new_n114_));
  inv1   g69(.a(new_n104_), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n60_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n103_), .d(new_n47_), .O(z15));
  nand3  g73(.a(new_n60_), .b(x19), .c(x17), .O(new_n119_));
  inv1   g74(.a(x21), .O(new_n120_));
  inv1   g75(.a(x22), .O(new_n121_));
  nand3  g76(.a(new_n52_), .b(new_n121_), .c(new_n120_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n119_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x18), .O(new_n124_));
  aoi21  g79(.a(new_n117_), .b(x23), .c(new_n58_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x15), .c(new_n124_), .O(z16));
  nand3  g81(.a(new_n109_), .b(new_n52_), .c(new_n121_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n104_), .c(x24), .O(new_n128_));
  inv1   g83(.a(new_n106_), .O(new_n129_));
  inv1   g84(.a(x24), .O(new_n130_));
  nand3  g85(.a(new_n116_), .b(new_n130_), .c(new_n52_), .O(new_n131_));
  inv1   g86(.a(new_n131_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n128_), .c(new_n103_), .d(new_n47_), .O(z17));
  oai21  g89(.a(new_n131_), .b(new_n106_), .c(x25), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand3  g91(.a(new_n136_), .b(new_n116_), .c(new_n129_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n135_), .c(new_n103_), .d(new_n47_), .O(z18));
endmodule
