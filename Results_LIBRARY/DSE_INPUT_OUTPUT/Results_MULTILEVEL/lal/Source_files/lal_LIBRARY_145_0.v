...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x03), .O(new_n47_));
  ...
  oai21  g016(.a(x19), .b(x17), .c(x03), .O(new_n62_));
  ...
  aoi21  g025(.a(x12), .b(new_n46_), .c(new_n61_), .O(new_n71_));
  ...
  oai21  g043(.a(new_n71_), .b(x03), .c(new_n88_), .O(z04));
  ...
  nand3  g053(.a(new_n61_), .b(new_n98_), .c(x03), .O(new_n99_));
  ...
  nand3  g063(.a(new_n61_), .b(x17), .c(x03), .O(new_n109_));
  ...
  nand2  g076(.a(x19), .b(x17), .O(new_n122_));
  inv1   g077(.a(new_n122_), .O(new_n123_));
  nand3  g078(.a(new_n60_), .b(x19), .c(x17), .O(new_n124_));
  oai21  g079(.a(new_n123_), .b(new_n60_), .c(new_n124_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(x18), .O(new_n126_));
  nand3  g081(.a(x20), .b(new_n61_), .c(x03), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n126_), .c(new_n121_), .O(z13));
  oai21  g083(.a(x21), .b(new_n118_), .c(new_n61_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n120_), .O(new_n130_));
  nand2  g085(.a(new_n124_), .b(x21), .O(new_n131_));
  ...
  nand3  g090(.a(x21), .b(new_n61_), .c(x03), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n135_), .c(new_n130_), .O(z14));
  oai21  g092(.a(x22), .b(new_n118_), .c(new_n61_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n120_), .O(new_n139_));
  aoi21  g094(.a(new_n132_), .b(new_n123_), .c(new_n52_), .O(new_n140_));
  nand3  g095(.a(new_n52_), .b(new_n51_), .c(new_n60_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(new_n122_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n140_), .c(x18), .O(new_n143_));
  nand3  g098(.a(x22), .b(new_n61_), .c(x03), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n143_), .c(new_n139_), .O(z15));
  oai21  g100(.a(x23), .b(new_n118_), .c(new_n61_), .O(new_n146_));
  oai21  g101(.a(new_n141_), .b(new_n122_), .c(x23), .O(new_n147_));
  inv1   g102(.a(new_n58_), .O(new_n148_));
  nor2   g103(.a(new_n100_), .b(new_n61_), .O(new_n149_));
  nor2   g104(.a(x23), .b(x22), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n149_), .c(new_n132_), .d(x17), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n148_), .c(new_n104_), .O(new_n152_));
  inv1   g107(.a(new_n152_), .O(new_n153_));
  nand3  g108(.a(new_n153_), .b(new_n147_), .c(new_n146_), .O(z16));
  oai21  g109(.a(x24), .b(new_n118_), .c(new_n61_), .O(new_n155_));
  nand2  g110(.a(new_n150_), .b(new_n51_), .O(new_n156_));
  oai21  g111(.a(new_n156_), .b(new_n124_), .c(x24), .O(new_n157_));
  nand4  g112(.a(new_n60_), .b(x19), .c(x18), .d(x17), .O(new_n158_));
  nand4  g113(.a(new_n94_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n159_));
  nor2   g114(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nor2   g115(.a(new_n160_), .b(x15), .O(new_n161_));
  nand4  g116(.a(new_n161_), .b(new_n157_), .c(new_n155_), .d(new_n148_), .O(z17));
  oai21  g117(.a(x25), .b(new_n118_), .c(new_n61_), .O(new_n163_));
  nand2  g118(.a(new_n163_), .b(new_n120_), .O(new_n164_));
  oai21  g119(.a(new_n159_), .b(new_n124_), .c(x25), .O(new_n165_));
  nor2   g120(.a(x25), .b(x24), .O(new_n166_));
  nand4  g121(.a(new_n166_), .b(new_n150_), .c(new_n132_), .d(new_n123_), .O(new_n167_));
  nand2  g122(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand2  g123(.a(new_n168_), .b(x18), .O(new_n169_));
  nand3  g124(.a(x25), .b(new_n61_), .c(x03), .O(new_n170_));
