...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x03), .O(new_n48_));
  ...
  nand3  g19(.a(new_n61_), .b(new_n49_), .c(new_n53_), .O(new_n65_));
  inv1   g20(.a(new_n65_), .O(z03));
  inv1   g21(.a(x15), .O(new_n67_));
  aoi21  g22(.a(x12), .b(new_n46_), .c(new_n67_), .O(new_n68_));
  ...
  oai21  g36(.a(new_n81_), .b(new_n72_), .c(new_n46_), .O(new_n82_));
  oai21  g37(.a(new_n68_), .b(x03), .c(new_n82_), .O(z04));
  ...
  nand2  g43(.a(new_n58_), .b(new_n54_), .O(new_n89_));
  ...
  aoi21  g47(.a(new_n92_), .b(new_n53_), .c(new_n48_), .O(z08));
  nand3  g48(.a(x05), .b(x04), .c(x03), .O(new_n94_));
  nor3   g49(.a(new_n94_), .b(x15), .c(x07), .O(z09));
  inv1   g50(.a(x03), .O(new_n96_));
  nand4  g51(.a(new_n63_), .b(new_n55_), .c(new_n67_), .d(new_n52_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n96_), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n63_), .c(new_n67_), .d(new_n52_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(new_n96_), .O(z11));
  nor2   g56(.a(new_n56_), .b(new_n55_), .O(new_n102_));
  nand3  g57(.a(new_n57_), .b(x18), .c(x17), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n63_), .c(new_n52_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(x03), .c(x15), .O(z12));
  nand3  g61(.a(x19), .b(x18), .c(x17), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(x20), .O(new_n108_));
  aoi21  g63(.a(x05), .b(x04), .c(new_n96_), .O(new_n109_));
  nand3  g64(.a(new_n102_), .b(new_n54_), .c(x19), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nor2   g66(.a(new_n111_), .b(x15), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n108_), .d(new_n52_), .O(z13));
  nor2   g68(.a(x21), .b(x20), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n102_), .c(x19), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n63_), .c(new_n52_), .O(new_n116_));
  aoi21  g71(.a(new_n110_), .b(x21), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n96_), .c(new_n67_), .O(z14));
  nand2  g73(.a(new_n115_), .b(x22), .O(new_n119_));
  inv1   g74(.a(new_n107_), .O(new_n120_));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n54_), .O(new_n122_));
  and2   g77(.a(new_n122_), .b(new_n67_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n109_), .d(new_n52_), .O(z15));
  nand2  g79(.a(new_n122_), .b(x23), .O(new_n125_));
  nor2   g80(.a(x23), .b(x22), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n114_), .c(new_n120_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n67_), .c(new_n52_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n109_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  inv1   g86(.a(x24), .O(new_n132_));
  nand3  g87(.a(new_n121_), .b(new_n132_), .c(new_n88_), .O(new_n133_));
  inv1   g88(.a(new_n133_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n111_), .c(x15), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n131_), .c(new_n109_), .d(new_n52_), .O(z17));
  oai21  g91(.a(new_n133_), .b(new_n110_), .c(x25), .O(new_n137_));
  nor3   g92(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  and2   g93(.a(new_n138_), .b(new_n121_), .O(new_n139_));
  aoi21  g94(.a(new_n139_), .b(new_n111_), .c(x15), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n137_), .c(new_n109_), .d(new_n52_), .O(z18));
endmodule
