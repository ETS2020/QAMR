...
module FAU ( 
  ...
  nand2  g43(.a(new_n61_), .b(new_n86_), .O(new_n89_));
  ...
  aoi21  g65(.a(new_n106_), .b(x21), .c(new_n89_), .O(new_n111_));
  oai22  g66(.a(new_n111_), .b(x15), .c(new_n110_), .d(new_n53_), .O(z14));
  nand2  g67(.a(x19), .b(x18), .O(new_n113_));
  ...
  nand3  g72(.a(new_n108_), .b(new_n104_), .c(x19), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(x22), .c(new_n89_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(x15), .c(new_n117_), .O(z15));
  nand3  g75(.a(new_n52_), .b(x19), .c(x18), .O(new_n121_));
  ...
  nand3  g82(.a(new_n114_), .b(new_n127_), .c(new_n52_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(x23), .c(new_n89_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x15), .c(new_n126_), .O(z16));
  nand2  g85(.a(new_n123_), .b(new_n108_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n102_), .c(x24), .O(new_n132_));
  nor2   g87(.a(x24), .b(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n114_), .c(new_n105_), .d(new_n104_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n101_), .d(new_n47_), .O(z17));
  nor2   g90(.a(x25), .b(x24), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n123_), .O(new_n137_));
  oai21  g92(.a(new_n137_), .b(new_n109_), .c(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(x17), .O(new_n139_));
  aoi21  g94(.a(new_n134_), .b(x25), .c(new_n89_), .O(new_n140_));
