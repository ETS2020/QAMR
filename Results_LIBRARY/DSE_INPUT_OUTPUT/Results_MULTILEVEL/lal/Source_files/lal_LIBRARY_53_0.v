...
module FAU ( 
  ...
  nor2   g18(.a(z12), .b(new_n63_), .O(z02));
  inv1   g19(.a(z12), .O(z14));
  nand3  g20(.a(new_n59_), .b(z14), .c(new_n51_), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n51_), .c(z12), .O(z08));
  zero   g38(.O(z09));
  zero   g39(.O(z10));
  zero   g40(.O(z11));
  one    g41(.O(z13));
  one    g42(.O(z18));
  inv1   g43(.a(z12), .O(z15));
  inv1   g44(.a(z12), .O(z16));
