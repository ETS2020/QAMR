...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n78_, new_n81_, new_n84_, new_n85_, new_n86_, new_n88_, new_n90_,
  ...
  nand3  g32(.a(new_n77_), .b(new_n50_), .c(new_n72_), .O(new_n78_));
  ...
  nand3  g42(.a(new_n67_), .b(new_n48_), .c(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n66_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n50_), .O(z11));
  ...
  nand3  g72(.a(new_n117_), .b(new_n114_), .c(new_n68_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n115_), .c(new_n119_), .d(new_n62_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n66_), .c(new_n48_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n106_), .O(z16));
  nand4  g79(.a(new_n119_), .b(new_n62_), .c(new_n61_), .d(new_n55_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n100_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x22), .b(x21), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n127_), .c(new_n102_), .d(new_n95_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n126_), .c(new_n66_), .d(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n106_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n127_), .c(new_n102_), .d(new_n95_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n68_), .d(new_n48_), .O(z18));
endmodule
