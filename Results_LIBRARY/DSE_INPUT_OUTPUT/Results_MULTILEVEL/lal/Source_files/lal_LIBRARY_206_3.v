...
module FAU ( 
  ...
  nand2  g36(.a(new_n58_), .b(new_n54_), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(x22), .c(x21), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(x23), .c(x24), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n53_), .c(new_n49_), .O(z08));
  nand3  g41(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n62_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n50_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  ...
  oai21  g68(.a(new_n113_), .b(x07), .c(new_n65_), .O(z15));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n101_), .d(new_n48_), .O(z16));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n110_), .c(new_n102_), .d(new_n94_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n62_), .c(new_n48_), .O(new_n121_));
  aoi21  g76(.a(new_n117_), .b(x24), .c(new_n121_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(x07), .c(new_n65_), .O(z17));
  nand2  g78(.a(new_n120_), .b(x25), .O(new_n124_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n110_), .c(new_n102_), .d(new_n94_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n101_), .d(new_n48_), .O(z18));
endmodule
