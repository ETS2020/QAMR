...
module FAU ( 
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n48_), .O(z13));
  and2   g58(.a(new_n102_), .b(x21), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n94_), .c(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n61_), .c(new_n48_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n64_), .O(z14));
  ...
  nor2   g68(.a(new_n113_), .b(x15), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n110_), .c(new_n101_), .O(z15));
  nor2   g70(.a(new_n113_), .b(new_n81_), .O(new_n116_));
  inv1   g71(.a(new_n99_), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n105_), .c(new_n117_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n61_), .c(new_n48_), .O(new_n120_));
  ...
  nand3  g80(.a(new_n125_), .b(new_n111_), .c(new_n124_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n101_), .d(new_n48_), .O(z17));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n111_), .c(new_n124_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n101_), .d(new_n48_), .O(z18));
endmodule
