...
module FAU ( 
  ...
  nand2  g21(.a(new_n58_), .b(new_n50_), .O(new_n67_));
  ...
  nor2   g40(.a(new_n60_), .b(x07), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x15), .O(z09));
  inv1   g42(.a(x15), .O(new_n88_));
  nand4  g43(.a(new_n59_), .b(new_n52_), .c(new_n88_), .d(new_n47_), .O(new_n89_));
  ...
  oai21  g62(.a(new_n107_), .b(x07), .c(new_n88_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n109_), .c(new_n86_), .O(z15));
  nor2   g69(.a(new_n112_), .b(new_n80_), .O(new_n115_));
  inv1   g70(.a(new_n99_), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n104_), .c(new_n116_), .O(new_n118_));
  ...
  nand4  g77(.a(new_n122_), .b(new_n110_), .c(new_n101_), .d(new_n94_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n59_), .O(new_n124_));
  aoi21  g79(.a(new_n118_), .b(x24), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x07), .c(new_n88_), .O(z17));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n110_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n102_), .c(new_n59_), .O(new_n129_));
  aoi21  g84(.a(new_n123_), .b(x25), .c(new_n129_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(x07), .c(new_n88_), .O(z18));
endmodule
