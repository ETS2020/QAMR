...
module FAU ( 
  ...
  nand4  g52(.a(new_n97_), .b(new_n87_), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n62_), .d(new_n48_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n62_), .d(new_n48_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n62_), .O(z15));
  inv1   g67(.a(x23), .O(new_n113_));
  aoi21  g68(.a(new_n110_), .b(new_n109_), .c(new_n113_), .O(new_n114_));
  nand4  g69(.a(new_n105_), .b(new_n109_), .c(new_n113_), .d(new_n82_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n87_), .c(new_n48_), .O(new_n116_));
  ...
  nand4  g75(.a(new_n113_), .b(new_n82_), .c(new_n120_), .d(new_n53_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n100_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x20), .b(new_n56_), .O(new_n123_));
  nor2   g78(.a(x22), .b(x21), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n95_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n122_), .c(new_n87_), .d(new_n48_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n118_), .O(z17));
  nand4  g84(.a(new_n81_), .b(new_n113_), .c(new_n82_), .d(new_n120_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n102_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n124_), .c(new_n123_), .d(new_n95_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n87_), .d(new_n48_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n118_), .O(z18));
endmodule
