...
module FAU ( 
  ...
  nand2  g18(.a(new_n63_), .b(new_n62_), .O(z01));
  ...
  nand3  g33(.a(new_n50_), .b(x14), .c(new_n68_), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z06));
  nand3  g35(.a(new_n50_), .b(new_n68_), .c(x06), .O(z07));
  inv1   g36(.a(x24), .O(new_n82_));
  inv1   g37(.a(x22), .O(new_n83_));
  aoi21  g38(.a(new_n58_), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  ...
  nand4  g45(.a(new_n88_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n88_), .c(new_n48_), .d(new_n47_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n88_), .d(new_n48_), .O(new_n104_));
  ...
  aoi21  g64(.a(new_n109_), .b(new_n96_), .c(new_n108_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n96_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n88_), .c(new_n48_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n110_), .c(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n106_), .O(z14));
  nand2  g70(.a(new_n112_), .b(x22), .O(new_n116_));
  inv1   g71(.a(new_n101_), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n54_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n63_), .d(new_n48_), .O(z15));
  nand2  g75(.a(new_n119_), .b(x23), .O(new_n121_));
  inv1   g76(.a(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n83_), .c(new_n108_), .d(new_n54_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n117_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n121_), .c(new_n63_), .d(new_n48_), .O(z16));
  oai21  g81(.a(new_n123_), .b(new_n101_), .c(x24), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n118_), .c(new_n109_), .d(new_n96_), .O(new_n129_));
  ...
  nand4  g87(.a(new_n82_), .b(new_n122_), .c(new_n83_), .d(new_n108_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n103_), .c(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n118_), .c(new_n109_), .d(new_n96_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n88_), .d(new_n48_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n106_), .O(z18));
endmodule
