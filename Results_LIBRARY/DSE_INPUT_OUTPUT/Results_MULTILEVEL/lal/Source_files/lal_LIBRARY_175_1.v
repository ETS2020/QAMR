...
module FAU ( 
  ...
  nand3  g33(.a(new_n48_), .b(x14), .c(new_n46_), .O(new_n79_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n51_), .c(new_n49_), .O(z08));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n62_), .b(new_n48_), .c(new_n87_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n61_), .b(new_n53_), .c(new_n48_), .d(new_n87_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n66_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n61_), .c(new_n48_), .d(new_n87_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n66_), .O(z11));
  ...
  nand4  g52(.a(new_n97_), .b(new_n61_), .c(new_n48_), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n63_), .d(new_n48_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n63_), .d(new_n48_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n63_), .d(new_n48_), .O(z15));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n63_), .d(new_n48_), .O(z16));
  ...
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n61_), .d(new_n87_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n48_), .O(new_n122_));
  nand2  g77(.a(x15), .b(x08), .O(new_n123_));
  ...
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n63_), .d(new_n48_), .O(z18));
endmodule
