...
module FAU ( 
  ...
  nand3  g71(.a(new_n116_), .b(new_n112_), .c(new_n62_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n65_), .O(z15));
  nor2   g74(.a(new_n115_), .b(new_n82_), .O(new_n120_));
  inv1   g75(.a(new_n100_), .O(new_n121_));
  nor2   g76(.a(x23), .b(x22), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n107_), .c(new_n121_), .O(new_n123_));
  ...
  nand4  g82(.a(new_n127_), .b(new_n113_), .c(new_n103_), .d(new_n95_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n62_), .c(new_n48_), .O(new_n129_));
  aoi21  g84(.a(new_n123_), .b(x24), .c(new_n129_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(x07), .c(new_n65_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n113_), .c(new_n103_), .d(new_n95_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n102_), .d(new_n48_), .O(z18));
endmodule
