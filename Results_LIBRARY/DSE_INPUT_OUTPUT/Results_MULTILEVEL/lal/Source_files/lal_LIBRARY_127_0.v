...
module FAU ( 
  ...
  nor2   g02(.a(x22), .b(x15), .O(new_n48_));
  ...
  nand2  g22(.a(new_n60_), .b(x15), .O(new_n68_));
  oai21  g23(.a(new_n67_), .b(new_n60_), .c(new_n68_), .O(new_n69_));
  nand3  g24(.a(new_n69_), .b(new_n55_), .c(new_n59_), .O(new_n70_));
  nand2  g25(.a(new_n70_), .b(new_n58_), .O(z01));
  oai21  g26(.a(x25), .b(x23), .c(x15), .O(new_n72_));
  nand2  g27(.a(new_n72_), .b(new_n60_), .O(new_n73_));
  nand2  g28(.a(new_n66_), .b(new_n61_), .O(new_n74_));
  ...
  aoi21  g43(.a(x24), .b(x23), .c(x25), .O(new_n89_));
  nand4  g44(.a(new_n74_), .b(x24), .c(x22), .d(x21), .O(new_n90_));
  oai21  g45(.a(new_n89_), .b(new_n48_), .c(new_n90_), .O(z08));
  nand3  g46(.a(new_n52_), .b(x05), .c(x04), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x22), .c(x15), .O(z09));
  inv1   g48(.a(x15), .O(new_n94_));
  nand4  g49(.a(new_n53_), .b(x22), .c(new_n63_), .d(new_n94_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n53_), .c(new_n52_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(x22), .c(x15), .O(z11));
  nor2   g54(.a(new_n64_), .b(new_n63_), .O(new_n100_));
  nand3  g55(.a(new_n65_), .b(x18), .c(x17), .O(new_n101_));
  oai21  g56(.a(new_n100_), .b(new_n65_), .c(new_n101_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n53_), .c(new_n52_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(x22), .c(x15), .O(z12));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  aoi21  g61(.a(x05), .b(x04), .c(x07), .O(new_n107_));
  nand3  g62(.a(new_n100_), .b(new_n61_), .c(x19), .O(new_n108_));
  and2   g63(.a(new_n108_), .b(x22), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n94_), .O(z13));
  nand2  g65(.a(new_n108_), .b(x21), .O(new_n111_));
  nand4  g66(.a(new_n100_), .b(new_n62_), .c(new_n61_), .d(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(x22), .c(new_n94_), .O(new_n113_));
  inv1   g68(.a(new_n113_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n107_), .O(z14));
  nand3  g70(.a(new_n53_), .b(x17), .c(new_n52_), .O(new_n116_));
  nand4  g71(.a(new_n62_), .b(new_n61_), .c(x19), .d(x18), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n116_), .c(x22), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n94_), .O(z15));
  nand3  g74(.a(new_n53_), .b(new_n59_), .c(new_n52_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x22), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n94_), .O(z16));
  nand4  g77(.a(new_n107_), .b(new_n54_), .c(x22), .d(new_n94_), .O(z17));
  nand3  g78(.a(new_n53_), .b(new_n55_), .c(new_n52_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(x22), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n94_), .O(z18));
endmodule
