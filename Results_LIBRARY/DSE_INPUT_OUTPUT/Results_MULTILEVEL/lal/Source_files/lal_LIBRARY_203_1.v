// Benchmark "FAU" written by ABC on Fri Aug 14 00:09:45 2020
...
module FAU ( 
  ...
  nand3  g39(.a(new_n62_), .b(new_n47_), .c(new_n51_), .O(new_n85_));
  ...
  nor2   g58(.a(new_n62_), .b(x07), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n92_), .c(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n47_), .O(z14));
  ...
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n51_), .O(z15));
  nand2  g68(.a(new_n110_), .b(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n105_), .c(new_n108_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n104_), .d(new_n47_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n99_), .O(new_n119_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n118_), .c(new_n61_), .O(new_n124_));
  ...
  nand3  g83(.a(new_n128_), .b(new_n109_), .c(new_n119_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n104_), .d(new_n47_), .O(z18));
endmodule
