// Benchmark "FAU" written by ABC on Fri Aug 14 00:09:38 2020
...
module FAU ( 
  ...
  aoi21  g38(.a(new_n83_), .b(new_n49_), .c(new_n78_), .O(z08));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n59_), .d(new_n86_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n85_), .O(new_n103_));
  oai21  g58(.a(x15), .b(new_n85_), .c(new_n103_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n61_), .d(new_n86_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n99_), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n50_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n61_), .d(new_n86_), .O(z15));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n61_), .d(new_n86_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n101_), .O(new_n119_));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n61_), .d(new_n86_), .O(z17));
  nand2  g79(.a(new_n123_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n111_), .c(new_n119_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n61_), .d(new_n86_), .O(z18));
endmodule
