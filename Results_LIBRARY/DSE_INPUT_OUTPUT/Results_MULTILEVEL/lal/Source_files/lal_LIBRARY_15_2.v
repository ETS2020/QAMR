...
module FAU ( 
  ...
  nor2   g65(.a(new_n100_), .b(new_n93_), .O(new_n111_));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(x15), .O(new_n113_));
  aoi21  g68(.a(new_n109_), .b(x21), .c(new_n57_), .O(new_n114_));
  oai22  g69(.a(new_n114_), .b(x15), .c(new_n113_), .d(new_n61_), .O(z14));
  nand2  g70(.a(x18), .b(x17), .O(new_n116_));
  nand2  g71(.a(new_n112_), .b(x19), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n116_), .c(x22), .O(new_n118_));
  inv1   g73(.a(new_n107_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n59_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n106_), .d(new_n47_), .O(z15));
  ...
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n106_), .d(new_n47_), .O(z16));
  nand3  g81(.a(new_n59_), .b(x19), .c(x17), .O(new_n127_));
  nand3  g82(.a(new_n120_), .b(new_n68_), .c(new_n51_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n127_), .c(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(x18), .O(new_n130_));
  aoi21  g85(.a(new_n125_), .b(x24), .c(new_n57_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(x15), .c(new_n130_), .O(z17));
  oai21  g87(.a(new_n128_), .b(new_n109_), .c(x25), .O(new_n133_));
  inv1   g88(.a(new_n109_), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n120_), .c(new_n134_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n106_), .d(new_n47_), .O(z18));
endmodule
