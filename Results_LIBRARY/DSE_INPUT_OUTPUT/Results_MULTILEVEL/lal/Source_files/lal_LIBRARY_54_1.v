...
module FAU ( 
  ...
  nand3  g44(.a(new_n89_), .b(new_n86_), .c(new_n59_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n76_), .c(x17), .O(z10));
  nand4  g46(.a(new_n89_), .b(new_n76_), .c(x17), .d(new_n86_), .O(new_n92_));
  ...
  oai21  g51(.a(x20), .b(x18), .c(new_n47_), .O(new_n97_));
  oai21  g52(.a(new_n77_), .b(new_n76_), .c(x20), .O(new_n98_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n98_), .d(new_n97_), .O(z13));
  nand3  g58(.a(new_n89_), .b(new_n86_), .c(new_n59_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  inv1   g60(.a(x21), .O(new_n106_));
  nor2   g61(.a(x20), .b(new_n77_), .O(new_n107_));
  nand4  g62(.a(new_n106_), .b(new_n53_), .c(x19), .d(x18), .O(new_n108_));
  ...
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n105_), .O(z14));
  oai21  g67(.a(x22), .b(x18), .c(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n108_), .b(x22), .O(new_n114_));
  nor2   g69(.a(new_n77_), .b(new_n76_), .O(new_n115_));
  nor3   g70(.a(x22), .b(x21), .c(x20), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(x15), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n113_), .d(new_n99_), .O(z15));
  oai21  g73(.a(x23), .b(x18), .c(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n116_), .b(new_n115_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x23), .O(new_n121_));
  nor3   g76(.a(x23), .b(x22), .c(x21), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(new_n101_), .c(x15), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n119_), .d(new_n99_), .O(z16));
  aoi21  g79(.a(new_n122_), .b(new_n107_), .c(new_n51_), .O(new_n125_));
  inv1   g80(.a(x22), .O(new_n126_));
  nand4  g81(.a(new_n51_), .b(new_n81_), .c(new_n126_), .d(new_n106_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(new_n100_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n125_), .c(x17), .O(new_n129_));
  nand2  g84(.a(x24), .b(new_n76_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n129_), .c(new_n105_), .O(z17));
  oai21  g86(.a(x25), .b(x18), .c(new_n47_), .O(new_n132_));
  oai21  g87(.a(new_n127_), .b(new_n100_), .c(x25), .O(new_n133_));
  nand4  g88(.a(new_n52_), .b(new_n51_), .c(new_n81_), .d(new_n126_), .O(new_n134_));
  nor2   g89(.a(new_n134_), .b(new_n108_), .O(new_n135_));
  nor2   g90(.a(new_n135_), .b(x15), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n132_), .d(new_n99_), .O(z18));
endmodule
