...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n53_, new_n54_,
    ...
    new_n71_, new_n72_, new_n77_, new_n78_, new_n79_, new_n80_, new_n81_,
  ...
  aoi21  g29(.a(x15), .b(x08), .c(new_n48_), .O(z06));
  ...
  nand3  g38(.a(new_n83_), .b(x05), .c(x04), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n48_), .c(x15), .O(z09));
  nand2  g40(.a(x05), .b(x04), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n55_), .c(new_n83_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n48_), .c(x15), .O(z10));
  inv1   g43(.a(x15), .O(new_n89_));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n86_), .c(new_n89_), .d(new_n48_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n86_), .c(new_n89_), .d(new_n48_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n86_), .d(new_n83_), .O(new_n101_));
  ...
  nand3  g61(.a(new_n106_), .b(new_n86_), .c(new_n83_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n89_), .O(z14));
  nand2  g64(.a(new_n106_), .b(x22), .O(new_n110_));
  inv1   g65(.a(new_n98_), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n54_), .O(new_n113_));
  and2   g68(.a(new_n113_), .b(new_n89_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n110_), .c(new_n63_), .d(new_n48_), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n105_), .c(new_n111_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n89_), .c(new_n48_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n116_), .c(new_n63_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  inv1   g77(.a(new_n100_), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n86_), .d(new_n83_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n89_), .O(z17));
  oai21  g85(.a(new_n125_), .b(new_n100_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n112_), .c(new_n123_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n86_), .d(new_n83_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n89_), .O(z18));
endmodule
