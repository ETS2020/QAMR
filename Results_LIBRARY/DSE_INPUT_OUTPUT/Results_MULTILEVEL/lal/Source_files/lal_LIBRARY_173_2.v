...
module FAU ( 
  ...
  nor2   g37(.a(new_n61_), .b(x15), .O(z09));
  ...
  nand2  g49(.a(new_n94_), .b(new_n84_), .O(new_n95_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n84_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n87_), .O(z15));
  nand2  g68(.a(new_n110_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand4  g70(.a(new_n104_), .b(new_n108_), .c(new_n115_), .d(new_n78_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n61_), .d(new_n87_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n99_), .O(new_n119_));
  nand3  g74(.a(new_n109_), .b(new_n50_), .c(new_n115_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n61_), .d(new_n87_), .O(z17));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n61_), .d(new_n87_), .O(z18));
endmodule
