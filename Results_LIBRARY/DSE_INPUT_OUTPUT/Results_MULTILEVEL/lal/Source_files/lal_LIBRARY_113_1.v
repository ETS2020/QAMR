...
module FAU ( 
  ...
  nor2   g33(.a(x12), .b(new_n47_), .O(new_n79_));
  inv1   g34(.a(x12), .O(new_n80_));
  nor2   g35(.a(x15), .b(new_n80_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n47_), .c(new_n79_), .O(new_n82_));
  ...
  nand2  g43(.a(new_n56_), .b(new_n52_), .O(new_n89_));
  ...
  aoi21  g47(.a(new_n92_), .b(new_n51_), .c(new_n50_), .O(z08));
  ...
  nand4  g65(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n94_), .d(new_n95_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n96_), .O(new_n113_));
  nand2  g68(.a(x15), .b(x03), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n113_), .O(z13));
  and2   g70(.a(new_n111_), .b(x21), .O(new_n116_));
  nor2   g71(.a(x21), .b(x20), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n104_), .c(x19), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n94_), .c(new_n95_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n96_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n114_), .O(z14));
  inv1   g76(.a(new_n109_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n52_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n94_), .c(new_n95_), .O(new_n125_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n61_), .d(new_n96_), .O(z16));
  nand2  g86(.a(new_n130_), .b(x24), .O(new_n132_));
  inv1   g87(.a(new_n111_), .O(new_n133_));
  inv1   g88(.a(x24), .O(new_n134_));
  nand3  g89(.a(new_n123_), .b(new_n134_), .c(new_n88_), .O(new_n135_));
  inv1   g90(.a(new_n135_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n132_), .c(new_n61_), .d(new_n96_), .O(z17));
  oai21  g93(.a(new_n135_), .b(new_n111_), .c(x25), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n123_), .c(new_n133_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n94_), .d(new_n95_), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(new_n96_), .O(new_n143_));
