...
module FAU ( 
  ...
  oai21  g023(.a(new_n68_), .b(x12), .c(new_n67_), .O(new_n69_));
  ...
  oai21  g040(.a(new_n85_), .b(new_n78_), .c(new_n63_), .O(new_n86_));
  nor3   g041(.a(new_n67_), .b(new_n47_), .c(x03), .O(new_n87_));
  aoi21  g042(.a(new_n47_), .b(x03), .c(new_n87_), .O(new_n88_));
  aoi21  g043(.a(new_n88_), .b(new_n86_), .c(x08), .O(z04));
  nor3   g044(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  inv1   g045(.a(x14), .O(new_n91_));
  nor3   g046(.a(new_n48_), .b(new_n91_), .c(x08), .O(z06));
  nand3  g047(.a(new_n63_), .b(new_n46_), .c(x06), .O(z07));
  nand3  g048(.a(x24), .b(x22), .c(x21), .O(new_n94_));
  inv1   g049(.a(new_n94_), .O(new_n95_));
  aoi21  g050(.a(new_n95_), .b(new_n68_), .c(x12), .O(new_n96_));
  oai21  g051(.a(new_n53_), .b(new_n66_), .c(new_n50_), .O(new_n97_));
  aoi21  g052(.a(new_n97_), .b(x24), .c(x25), .O(new_n98_));
  oai21  g053(.a(new_n96_), .b(x18), .c(new_n98_), .O(z08));
  inv1   g054(.a(x04), .O(new_n100_));
  inv1   g055(.a(x07), .O(new_n101_));
  inv1   g056(.a(x15), .O(new_n102_));
  nand4  g057(.a(new_n63_), .b(new_n102_), .c(new_n101_), .d(x05), .O(new_n103_));
  nor2   g058(.a(new_n103_), .b(new_n100_), .O(z09));
  inv1   g059(.a(x17), .O(new_n105_));
  nand4  g060(.a(new_n57_), .b(new_n63_), .c(new_n105_), .d(new_n102_), .O(new_n106_));
  nor2   g061(.a(new_n106_), .b(x07), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n57_), .c(new_n102_), .d(new_n101_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n63_), .O(z11));
  xnor2a g065(.a(x19), .b(x17), .O(new_n111_));
  nand3  g066(.a(x19), .b(new_n67_), .c(new_n47_), .O(new_n112_));
  oai21  g067(.a(new_n111_), .b(new_n67_), .c(new_n112_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n57_), .c(new_n102_), .d(new_n101_), .O(new_n114_));
  inv1   g069(.a(new_n114_), .O(z12));
  oai21  g070(.a(x20), .b(x12), .c(new_n67_), .O(new_n116_));
  nand3  g071(.a(new_n57_), .b(new_n102_), .c(new_n101_), .O(new_n117_));
  nand2  g072(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  and2   g073(.a(x19), .b(x17), .O(new_n119_));
  nand3  g074(.a(new_n66_), .b(x19), .c(x17), .O(new_n120_));
  oai21  g075(.a(new_n119_), .b(new_n66_), .c(new_n120_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(x18), .O(new_n122_));
  nand3  g077(.a(x20), .b(new_n67_), .c(new_n47_), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n122_), .c(new_n118_), .O(z13));
  oai21  g079(.a(x21), .b(x12), .c(new_n67_), .O(new_n125_));
  ...
  nand3  g086(.a(x21), .b(new_n67_), .c(new_n47_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n131_), .c(new_n126_), .O(z14));
  oai21  g088(.a(x22), .b(x12), .c(new_n67_), .O(new_n134_));
  ...
  nand3  g095(.a(x22), .b(new_n67_), .c(new_n47_), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n140_), .c(new_n135_), .O(z15));
  oai21  g097(.a(x23), .b(x12), .c(new_n67_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n117_), .O(new_n144_));
  aoi21  g099(.a(new_n138_), .b(new_n119_), .c(new_n50_), .O(new_n145_));
  inv1   g100(.a(x21), .O(new_n146_));
  nand3  g101(.a(new_n50_), .b(new_n136_), .c(new_n146_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(new_n120_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n145_), .c(x18), .O(new_n149_));
  nand3  g104(.a(x23), .b(new_n67_), .c(new_n47_), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  oai21  g106(.a(x24), .b(x12), .c(new_n67_), .O(new_n152_));
  oai21  g107(.a(new_n147_), .b(new_n120_), .c(x24), .O(new_n153_));
  nor2   g108(.a(new_n58_), .b(x07), .O(new_n154_));
  nand4  g109(.a(new_n66_), .b(x19), .c(x18), .d(x17), .O(new_n155_));
  inv1   g110(.a(new_n155_), .O(new_n156_));
  nor2   g111(.a(x22), .b(x21), .O(new_n157_));
  nand3  g112(.a(new_n157_), .b(new_n51_), .c(new_n50_), .O(new_n158_));
