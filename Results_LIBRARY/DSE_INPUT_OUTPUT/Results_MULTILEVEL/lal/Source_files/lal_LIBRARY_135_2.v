...
module FAU ( 
  ...
  oai21  g61(.a(new_n106_), .b(x07), .c(new_n86_), .O(z14));
  ...
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n62_), .d(new_n86_), .O(z15));
  ...
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n62_), .d(new_n86_), .O(z16));
  ...
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n62_), .d(new_n86_), .O(z17));
  ...
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n62_), .d(new_n86_), .O(z18));
endmodule
