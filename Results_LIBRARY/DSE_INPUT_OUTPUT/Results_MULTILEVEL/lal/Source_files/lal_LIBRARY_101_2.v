...
module FAU ( 
  ...
  nand2  g42(.a(new_n62_), .b(new_n55_), .O(new_n88_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n62_), .c(new_n93_), .d(new_n48_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n86_), .d(new_n93_), .O(z13));
  ...
  oai21  g61(.a(new_n106_), .b(x07), .c(new_n93_), .O(z14));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n108_));
  nor2   g63(.a(x22), .b(x21), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n54_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(new_n99_), .O(new_n111_));
  ...
  nand2  g69(.a(new_n114_), .b(new_n93_), .O(z15));
  ...
  nand2  g74(.a(new_n119_), .b(new_n62_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n117_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n93_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n101_), .O(new_n124_));
  nand4  g79(.a(new_n109_), .b(new_n124_), .c(new_n80_), .d(new_n116_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n86_), .d(new_n93_), .O(z17));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n109_), .c(new_n124_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n86_), .d(new_n93_), .O(z18));
endmodule
