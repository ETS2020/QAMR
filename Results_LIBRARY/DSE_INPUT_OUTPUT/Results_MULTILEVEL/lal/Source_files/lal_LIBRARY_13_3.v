...
module FAU ( 
  ...
  nor2   g24(.a(x08), .b(x03), .O(new_n70_));
  oai21  g25(.a(new_n70_), .b(x15), .c(x12), .O(new_n71_));
  ...
  nand2  g36(.a(new_n47_), .b(x03), .O(new_n82_));
  ...
  oai21  g48(.a(new_n92_), .b(new_n52_), .c(new_n93_), .O(z08));
  ...
  nor2   g64(.a(x20), .b(new_n57_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n103_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n63_), .d(new_n95_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n65_), .d(new_n48_), .O(z14));
  nand2  g74(.a(new_n118_), .b(x22), .O(new_n120_));
  inv1   g75(.a(new_n108_), .O(new_n121_));
  nor3   g76(.a(x22), .b(x21), .c(x20), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(new_n121_), .c(x15), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n65_), .O(z15));
  inv1   g79(.a(x23), .O(new_n125_));
  aoi21  g80(.a(new_n122_), .b(new_n121_), .c(new_n125_), .O(new_n126_));
  nand4  g81(.a(new_n117_), .b(new_n121_), .c(new_n125_), .d(new_n90_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n63_), .c(new_n95_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n126_), .c(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n114_), .O(z16));
  nand2  g85(.a(new_n127_), .b(x24), .O(new_n131_));
  nor2   g86(.a(x22), .b(x21), .O(new_n132_));
  nor2   g87(.a(x24), .b(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n132_), .c(new_n110_), .d(new_n103_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n131_), .c(new_n63_), .d(new_n95_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n48_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n114_), .O(z17));
  nand2  g92(.a(new_n134_), .b(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n132_), .c(new_n110_), .d(new_n103_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n65_), .d(new_n48_), .O(z18));
endmodule
