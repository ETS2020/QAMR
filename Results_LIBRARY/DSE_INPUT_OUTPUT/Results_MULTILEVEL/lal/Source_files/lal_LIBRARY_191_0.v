...
module FAU ( 
  ...
  nand4  g16(.a(new_n61_), .b(new_n60_), .c(new_n50_), .d(new_n49_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nor2   g18(.a(new_n47_), .b(new_n63_), .O(z02));
  nand3  g19(.a(new_n59_), .b(new_n50_), .c(new_n51_), .O(new_n65_));
  inv1   g20(.a(new_n65_), .O(z03));
  inv1   g21(.a(x15), .O(new_n67_));
  aoi21  g22(.a(new_n46_), .b(x00), .c(new_n67_), .O(new_n68_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n51_), .c(new_n47_), .O(z08));
  inv1   g41(.a(x09), .O(new_n87_));
  nor4   g42(.a(new_n61_), .b(x15), .c(new_n87_), .d(x07), .O(z09));
  nand3  g43(.a(new_n61_), .b(new_n53_), .c(new_n49_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(x09), .c(x15), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n61_), .c(new_n67_), .d(x09), .O(new_n92_));
  ...
  nand3  g51(.a(new_n96_), .b(new_n61_), .c(new_n49_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n61_), .d(new_n49_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x09), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n67_), .O(z13));
  ...
  nand3  g63(.a(new_n108_), .b(new_n67_), .c(x09), .O(new_n109_));
  ...
  and2   g70(.a(new_n115_), .b(new_n67_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n106_), .d(x09), .O(z15));
  nand2  g72(.a(new_n115_), .b(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n107_), .c(new_n113_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n67_), .c(x09), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n118_), .c(new_n106_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n101_), .O(new_n125_));
  inv1   g80(.a(x24), .O(new_n126_));
  nand3  g81(.a(new_n114_), .b(new_n126_), .c(new_n81_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n125_), .c(x15), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n106_), .d(x09), .O(z17));
  oai21  g85(.a(new_n127_), .b(new_n101_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n114_), .c(new_n125_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n61_), .d(new_n49_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x09), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n67_), .O(z18));
endmodule
