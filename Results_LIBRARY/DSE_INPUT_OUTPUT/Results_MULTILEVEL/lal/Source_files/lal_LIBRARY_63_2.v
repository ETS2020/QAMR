...
module FAU ( 
  ...
  nor2   g03(.a(x09), .b(new_n48_), .O(new_n49_));
  ...
  aoi21  g24(.a(new_n69_), .b(new_n48_), .c(x00), .O(new_n70_));
  nand2  g25(.a(new_n69_), .b(x00), .O(new_n71_));
  ...
  oai21  g30(.a(new_n75_), .b(new_n70_), .c(new_n46_), .O(new_n76_));
  ...
  nand4  g45(.a(new_n50_), .b(new_n90_), .c(new_n89_), .d(x05), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(new_n88_), .O(z09));
  nand4  g47(.a(new_n63_), .b(new_n50_), .c(new_n55_), .d(new_n90_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x07), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n63_), .c(new_n90_), .d(new_n89_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n63_), .c(new_n50_), .d(new_n90_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x07), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nand2  g59(.a(new_n63_), .b(new_n89_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand4  g61(.a(new_n54_), .b(x19), .c(x18), .d(x17), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n104_), .d(new_n90_), .O(new_n108_));
  and2   g63(.a(new_n108_), .b(new_n50_), .O(z13));
  ...
  nand3  g67(.a(new_n112_), .b(new_n106_), .c(new_n90_), .O(new_n113_));
  inv1   g68(.a(new_n113_), .O(new_n114_));
  aoi21  g69(.a(new_n114_), .b(new_n110_), .c(new_n49_), .O(z14));
  nand2  g70(.a(new_n112_), .b(x22), .O(new_n116_));
  inv1   g71(.a(new_n103_), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n54_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(new_n105_), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n116_), .c(new_n49_), .O(z15));
  nand2  g77(.a(new_n119_), .b(x23), .O(new_n123_));
  inv1   g78(.a(x23), .O(new_n124_));
  nand4  g79(.a(new_n111_), .b(new_n117_), .c(new_n124_), .d(new_n83_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n106_), .c(new_n90_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n123_), .c(new_n49_), .O(z16));
  nand2  g83(.a(new_n125_), .b(x24), .O(new_n129_));
  inv1   g84(.a(new_n107_), .O(new_n130_));
  nand3  g85(.a(new_n118_), .b(new_n82_), .c(new_n124_), .O(new_n131_));
  inv1   g86(.a(new_n131_), .O(new_n132_));
  aoi21  g87(.a(new_n132_), .b(new_n130_), .c(x15), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n129_), .c(new_n106_), .d(new_n50_), .O(z17));
  oai21  g89(.a(new_n131_), .b(new_n107_), .c(x25), .O(new_n135_));
  inv1   g90(.a(new_n118_), .O(new_n136_));
  nand3  g91(.a(new_n53_), .b(new_n82_), .c(new_n124_), .O(new_n137_));
  nor2   g92(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  aoi21  g93(.a(new_n138_), .b(new_n130_), .c(x15), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n135_), .c(new_n106_), .d(new_n50_), .O(z18));
endmodule
