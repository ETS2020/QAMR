...
module FAU ( 
  ...
  nand2  g39(.a(new_n63_), .b(new_n55_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n47_), .c(x07), .O(z10));
  ...
  nand4  g47(.a(new_n92_), .b(new_n63_), .c(new_n47_), .d(new_n51_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z12));
  nand3  g49(.a(x19), .b(x18), .c(x17), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(x20), .O(new_n96_));
  nand3  g51(.a(new_n90_), .b(new_n54_), .c(x19), .O(new_n97_));
  ...
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n102_), .d(new_n47_), .O(z17));
  ...
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n102_), .d(new_n47_), .O(z18));
endmodule
