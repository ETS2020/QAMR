...
module FAU ( 
  ...
  oai21  g59(.a(new_n104_), .b(x15), .c(new_n53_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n101_), .c(new_n106_), .O(new_n114_));
  ...
  aoi21  g77(.a(new_n122_), .b(new_n119_), .c(x15), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n65_), .d(new_n53_), .O(z17));
