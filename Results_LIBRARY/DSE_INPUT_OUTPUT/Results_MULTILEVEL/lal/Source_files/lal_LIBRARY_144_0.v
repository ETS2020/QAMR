...
module FAU ( 
  ...
  nand3  g29(.a(x15), .b(x14), .c(new_n46_), .O(new_n75_));
  ...
  nand3  g38(.a(new_n50_), .b(x05), .c(x04), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x08), .c(x15), .O(z09));
  inv1   g40(.a(x15), .O(new_n86_));
  nand4  g41(.a(new_n61_), .b(new_n53_), .c(new_n86_), .d(x08), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n61_), .c(new_n50_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(x08), .c(x15), .O(z11));
  ...
  nand3  g50(.a(new_n95_), .b(new_n61_), .c(new_n50_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x08), .c(x15), .O(z12));
  ...
  nand4  g59(.a(new_n104_), .b(new_n100_), .c(new_n99_), .d(x08), .O(z13));
  ...
  nand3  g63(.a(new_n108_), .b(new_n86_), .c(x08), .O(new_n109_));
  ...
  nand4  g73(.a(new_n118_), .b(new_n112_), .c(new_n61_), .d(new_n50_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(x08), .O(new_n120_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n61_), .c(new_n50_), .O(new_n124_));
  ...
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n61_), .d(new_n50_), .O(new_n132_));
  ...
  nand3  g91(.a(new_n51_), .b(new_n136_), .c(new_n78_), .O(new_n137_));
  nor2   g92(.a(new_n137_), .b(new_n116_), .O(new_n138_));
  aoi21  g93(.a(new_n138_), .b(new_n103_), .c(x15), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n135_), .c(new_n100_), .d(x08), .O(z18));
endmodule
