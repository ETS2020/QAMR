...
module FAU ( 
  ...
  and2   g59(.a(new_n103_), .b(x21), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n94_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n61_), .c(new_n48_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n64_), .O(z14));
  nand2  g65(.a(new_n107_), .b(x22), .O(new_n111_));
  inv1   g66(.a(new_n99_), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n53_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n101_), .d(new_n48_), .O(z15));
  ...
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n101_), .d(new_n48_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(x24), .O(new_n121_));
  nand3  g76(.a(new_n113_), .b(new_n121_), .c(new_n81_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n102_), .c(new_n94_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n61_), .d(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n64_), .O(z17));
  oai21  g82(.a(new_n122_), .b(new_n103_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n113_), .c(new_n102_), .d(new_n94_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n61_), .d(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n64_), .O(z18));
endmodule
