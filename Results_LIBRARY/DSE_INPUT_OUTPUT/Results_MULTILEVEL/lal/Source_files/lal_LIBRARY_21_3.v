...
module FAU ( 
  ...
  nor2   g68(.a(new_n113_), .b(new_n101_), .O(new_n114_));
  nor2   g69(.a(new_n114_), .b(x15), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n111_), .c(new_n103_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  nor2   g72(.a(new_n114_), .b(new_n117_), .O(new_n118_));
  inv1   g73(.a(new_n101_), .O(new_n119_));
  nand4  g74(.a(new_n108_), .b(new_n119_), .c(new_n117_), .d(new_n81_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n87_), .c(new_n86_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n118_), .c(new_n48_), .O(new_n122_));
  nand2  g77(.a(x15), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n122_), .O(z16));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n112_), .c(new_n104_), .d(new_n96_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n87_), .c(new_n86_), .O(new_n127_));
  aoi21  g82(.a(new_n120_), .b(x24), .c(new_n127_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(x15), .c(new_n123_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n112_), .c(new_n104_), .d(new_n96_), .O(new_n132_));
