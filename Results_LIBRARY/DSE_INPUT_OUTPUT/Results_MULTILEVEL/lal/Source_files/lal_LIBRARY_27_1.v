...
module FAU ( 
  ...
  aoi21  g23(.a(new_n46_), .b(x01), .c(x15), .O(new_n69_));
  ...
  oai21  g32(.a(new_n69_), .b(x10), .c(new_n77_), .O(z04));
  oai21  g33(.a(x13), .b(x08), .c(new_n66_), .O(z05));
  ...
  aoi21  g39(.a(new_n55_), .b(new_n51_), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g50(.a(new_n95_), .b(new_n66_), .O(z11));
  ...
  nand4  g54(.a(new_n99_), .b(new_n60_), .c(new_n47_), .d(new_n89_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n66_), .O(z12));
  ...
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n60_), .d(new_n89_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(x15), .b(x10), .O(new_n107_));
  ...
  nand3  g66(.a(new_n111_), .b(new_n60_), .c(new_n89_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n62_), .d(new_n47_), .O(z15));
  nand2  g74(.a(new_n118_), .b(x23), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n110_), .c(new_n116_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n62_), .d(new_n47_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n104_), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n117_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n60_), .d(new_n89_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n107_), .O(z17));
  oai21  g87(.a(new_n127_), .b(new_n104_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n117_), .c(new_n125_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n60_), .d(new_n89_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n107_), .O(z18));
endmodule
