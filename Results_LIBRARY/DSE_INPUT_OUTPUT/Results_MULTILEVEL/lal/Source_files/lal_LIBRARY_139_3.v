...
module FAU ( 
  ...
  aoi21  g038(.a(new_n73_), .b(x06), .c(new_n63_), .O(z07));
  nand3  g039(.a(x22), .b(x21), .c(x20), .O(new_n85_));
  aoi21  g040(.a(new_n85_), .b(new_n67_), .c(new_n52_), .O(new_n86_));
  ...
  nand4  g054(.a(new_n99_), .b(new_n91_), .c(new_n93_), .d(new_n92_), .O(new_n100_));
  inv1   g055(.a(new_n100_), .O(z11));
  nand2  g056(.a(x18), .b(x17), .O(new_n102_));
  nand3  g057(.a(new_n102_), .b(x19), .c(new_n93_), .O(new_n103_));
  inv1   g058(.a(x19), .O(new_n104_));
  nand3  g059(.a(new_n104_), .b(x18), .c(x17), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand3  g061(.a(new_n106_), .b(new_n91_), .c(new_n92_), .O(new_n107_));
  nand2  g062(.a(new_n107_), .b(new_n47_), .O(z12));
  nand3  g063(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(x20), .O(new_n110_));
  inv1   g065(.a(new_n102_), .O(new_n111_));
  nor2   g066(.a(x20), .b(new_n104_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n110_), .c(new_n61_), .d(new_n93_), .O(z13));
  nand2  g069(.a(new_n113_), .b(x21), .O(new_n115_));
  nor2   g070(.a(x21), .b(x20), .O(new_n116_));
  nand3  g071(.a(new_n116_), .b(new_n111_), .c(x19), .O(new_n117_));
  nand4  g072(.a(new_n117_), .b(new_n115_), .c(new_n61_), .d(new_n93_), .O(z14));
  nand2  g073(.a(new_n117_), .b(x22), .O(new_n119_));
  inv1   g074(.a(new_n109_), .O(new_n120_));
  nor3   g075(.a(x22), .b(x21), .c(x20), .O(new_n121_));
  aoi21  g076(.a(new_n121_), .b(new_n120_), .c(x15), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n119_), .c(new_n61_), .O(z15));
  oai21  g078(.a(x23), .b(x15), .c(new_n68_), .O(new_n124_));
  nor2   g079(.a(new_n104_), .b(new_n96_), .O(new_n125_));
  aoi21  g080(.a(new_n125_), .b(new_n121_), .c(new_n67_), .O(new_n126_));
  nand4  g081(.a(new_n116_), .b(new_n120_), .c(new_n67_), .d(new_n57_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n91_), .c(new_n92_), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(new_n126_), .c(new_n93_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n124_), .O(z16));
  oai21  g085(.a(x24), .b(x15), .c(new_n68_), .O(new_n131_));
  nand3  g086(.a(new_n54_), .b(x19), .c(x17), .O(new_n132_));
  nand3  g087(.a(new_n67_), .b(new_n57_), .c(new_n56_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n132_), .c(x24), .O(new_n134_));
  nor2   g089(.a(x22), .b(x21), .O(new_n135_));
  nor2   g090(.a(x24), .b(x23), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n112_), .d(new_n111_), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n134_), .c(new_n91_), .d(new_n92_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n93_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n131_), .O(z17));
  oai21  g095(.a(x25), .b(x15), .c(new_n68_), .O(new_n141_));
  nand4  g096(.a(new_n52_), .b(new_n67_), .c(new_n57_), .d(new_n56_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n132_), .c(x25), .O(new_n143_));
  nor3   g098(.a(x25), .b(x24), .c(x23), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n135_), .c(new_n112_), .d(new_n111_), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n143_), .c(new_n91_), .d(new_n92_), .O(new_n146_));
