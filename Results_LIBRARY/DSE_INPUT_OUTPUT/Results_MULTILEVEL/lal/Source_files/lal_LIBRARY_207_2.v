...
module FAU ( 
  ...
  nand2  g42(.a(new_n59_), .b(new_n52_), .O(new_n88_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n59_), .c(new_n93_), .d(new_n47_), .O(new_n97_));
  ...
  nand2  g59(.a(new_n104_), .b(new_n93_), .O(z13));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n86_), .d(new_n93_), .O(z14));
  ...
  nand3  g69(.a(new_n114_), .b(new_n110_), .c(new_n86_), .O(z15));
  nor2   g70(.a(new_n113_), .b(new_n80_), .O(new_n116_));
  inv1   g71(.a(new_n99_), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n107_), .c(new_n117_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n59_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n116_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n93_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n111_), .O(new_n125_));
  or2    g80(.a(new_n125_), .b(new_n102_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n86_), .d(new_n93_), .O(z17));
  oai21  g82(.a(new_n125_), .b(new_n102_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n111_), .c(new_n101_), .d(new_n94_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n59_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n93_), .O(z18));
endmodule
