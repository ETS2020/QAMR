...
module FAU ( 
  ...
  aoi21  g36(.a(new_n56_), .b(new_n52_), .c(new_n59_), .O(new_n82_));
  ...
  nand4  g44(.a(new_n63_), .b(new_n53_), .c(new_n89_), .d(new_n47_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x07), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n63_), .c(new_n89_), .d(new_n47_), .O(new_n93_));
  ...
  nand3  g52(.a(new_n97_), .b(new_n63_), .c(new_n86_), .O(new_n98_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n63_), .c(new_n86_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n89_), .O(z14));
  nand2  g67(.a(new_n109_), .b(x22), .O(new_n113_));
  nor2   g68(.a(new_n64_), .b(x07), .O(new_n114_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n113_), .d(new_n47_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n115_), .c(new_n119_), .d(new_n59_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n63_), .c(new_n86_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n89_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n50_), .c(new_n119_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n106_), .c(x15), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n114_), .d(new_n47_), .O(z17));
  oai21  g85(.a(new_n127_), .b(new_n102_), .c(x25), .O(new_n131_));
  inv1   g86(.a(new_n126_), .O(new_n132_));
  nand3  g87(.a(new_n51_), .b(new_n50_), .c(new_n119_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n106_), .c(x15), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n131_), .c(new_n114_), .d(new_n47_), .O(z18));
endmodule
