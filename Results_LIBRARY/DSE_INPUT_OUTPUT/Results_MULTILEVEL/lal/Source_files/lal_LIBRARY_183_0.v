...
module FAU ( 
  ...
  nor2   g001(.a(x19), .b(x00), .O(new_n47_));
  ...
  inv1   g015(.a(x00), .O(new_n61_));
  inv1   g016(.a(x19), .O(new_n62_));
  nor2   g017(.a(x18), .b(x17), .O(new_n63_));
  oai21  g018(.a(new_n63_), .b(new_n61_), .c(new_n62_), .O(new_n64_));
  ...
  aoi21  g029(.a(x09), .b(new_n46_), .c(new_n62_), .O(new_n75_));
  ...
  aoi21  g043(.a(new_n88_), .b(new_n52_), .c(new_n69_), .O(new_n89_));
  oai21  g044(.a(new_n89_), .b(x25), .c(new_n49_), .O(new_n90_));
  nor2   g045(.a(new_n50_), .b(x19), .O(new_n91_));
  nor2   g046(.a(new_n69_), .b(new_n51_), .O(new_n92_));
  nand4  g047(.a(new_n92_), .b(new_n91_), .c(new_n63_), .d(x00), .O(new_n93_));
  ...
  nand2  g052(.a(new_n56_), .b(new_n49_), .O(new_n98_));
  nor4   g053(.a(new_n98_), .b(x17), .c(x15), .d(x07), .O(z10));
  xnor2a g054(.a(x18), .b(x17), .O(new_n100_));
  nor4   g055(.a(new_n100_), .b(new_n98_), .c(x15), .d(x07), .O(z11));
  nand2  g056(.a(x18), .b(x17), .O(new_n102_));
  inv1   g057(.a(new_n102_), .O(new_n103_));
  nand4  g058(.a(new_n62_), .b(x18), .c(x17), .d(x00), .O(new_n104_));
  oai21  g059(.a(new_n103_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  nand4  g060(.a(new_n105_), .b(new_n56_), .c(new_n95_), .d(new_n55_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z12));
  inv1   g062(.a(new_n57_), .O(new_n108_));
  oai21  g063(.a(x20), .b(new_n61_), .c(new_n62_), .O(new_n109_));
  nand2  g064(.a(new_n102_), .b(x20), .O(new_n110_));
  nand3  g065(.a(new_n103_), .b(new_n59_), .c(x19), .O(new_n111_));
  ...
  oai21  g069(.a(x21), .b(new_n61_), .c(new_n62_), .O(new_n115_));
  ...
  aoi21  g075(.a(new_n120_), .b(new_n103_), .c(x15), .O(new_n121_));
  nand4  g076(.a(new_n121_), .b(new_n117_), .c(new_n115_), .d(new_n108_), .O(z14));
  oai21  g077(.a(x22), .b(new_n61_), .c(new_n62_), .O(new_n123_));
  nand3  g078(.a(new_n56_), .b(new_n95_), .c(new_n55_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  aoi21  g080(.a(new_n118_), .b(new_n103_), .c(new_n51_), .O(new_n126_));
  nand2  g081(.a(new_n51_), .b(new_n50_), .O(new_n127_));
  nor3   g082(.a(new_n127_), .b(new_n102_), .c(x20), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(new_n126_), .c(x19), .O(new_n129_));
  nand3  g084(.a(x22), .b(new_n62_), .c(x00), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n129_), .c(new_n125_), .O(z15));
  oai21  g086(.a(x23), .b(new_n61_), .c(new_n62_), .O(new_n132_));
  inv1   g087(.a(new_n127_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n103_), .c(new_n59_), .O(new_n134_));
  nand3  g089(.a(x19), .b(x18), .c(x17), .O(new_n135_));
  inv1   g090(.a(new_n135_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n118_), .c(new_n52_), .d(new_n51_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n108_), .c(new_n95_), .O(new_n138_));
  aoi21  g093(.a(new_n134_), .b(x23), .c(new_n138_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n132_), .O(z16));
  oai21  g095(.a(x24), .b(new_n61_), .c(new_n62_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n124_), .O(new_n142_));
  nand3  g097(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(new_n116_), .c(x24), .O(new_n144_));
  inv1   g099(.a(new_n116_), .O(new_n145_));
  nor2   g100(.a(x24), .b(x23), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n133_), .c(new_n145_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(x19), .O(new_n149_));
  nand3  g104(.a(x24), .b(new_n62_), .c(x00), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n149_), .c(new_n142_), .O(z17));
  oai21  g106(.a(x25), .b(new_n61_), .c(new_n62_), .O(new_n152_));
  nand2  g107(.a(new_n147_), .b(x25), .O(new_n153_));
  nand3  g108(.a(new_n60_), .b(new_n69_), .c(new_n52_), .O(new_n154_));
  nor2   g109(.a(new_n154_), .b(new_n127_), .O(new_n155_));
  aoi21  g110(.a(new_n155_), .b(new_n112_), .c(x15), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n153_), .c(new_n152_), .d(new_n108_), .O(z18));
endmodule
