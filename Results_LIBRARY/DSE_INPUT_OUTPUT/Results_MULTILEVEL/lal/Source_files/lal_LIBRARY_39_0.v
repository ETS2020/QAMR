...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x06), .O(new_n48_));
  ...
  nand4  g44(.a(new_n62_), .b(new_n54_), .c(new_n78_), .d(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(new_n87_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n62_), .c(new_n78_), .d(new_n89_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n62_), .c(new_n78_), .d(new_n89_), .O(new_n98_));
  ...
  nand2  g59(.a(new_n104_), .b(new_n78_), .O(z13));
  ...
  nand3  g64(.a(new_n109_), .b(new_n78_), .c(new_n89_), .O(new_n110_));
  ...
  nand2  g70(.a(new_n82_), .b(new_n115_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(x20), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n113_), .c(new_n62_), .d(new_n89_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(x06), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n78_), .O(z15));
  inv1   g76(.a(x23), .O(new_n122_));
  aoi21  g77(.a(new_n117_), .b(new_n114_), .c(new_n122_), .O(new_n123_));
  nand4  g78(.a(new_n108_), .b(new_n114_), .c(new_n122_), .d(new_n82_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n62_), .c(new_n89_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n123_), .c(x06), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n78_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  inv1   g83(.a(new_n102_), .O(new_n129_));
  nor2   g84(.a(x22), .b(x21), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n81_), .c(new_n122_), .O(new_n131_));
  inv1   g86(.a(new_n131_), .O(new_n132_));
  aoi21  g87(.a(new_n132_), .b(new_n129_), .c(x15), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n128_), .c(new_n107_), .d(new_n89_), .O(z17));
  oai21  g89(.a(new_n131_), .b(new_n102_), .c(x25), .O(new_n135_));
  nand3  g90(.a(new_n52_), .b(new_n81_), .c(new_n122_), .O(new_n136_));
  nor2   g91(.a(new_n136_), .b(new_n116_), .O(new_n137_));
  aoi21  g92(.a(new_n137_), .b(new_n129_), .c(x15), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n135_), .c(new_n107_), .d(new_n89_), .O(z18));
endmodule
