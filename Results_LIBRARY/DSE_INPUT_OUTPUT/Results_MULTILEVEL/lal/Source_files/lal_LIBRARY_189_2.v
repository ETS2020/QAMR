...
module FAU ( 
  ...
  nor2   g04(.a(x25), .b(x23), .O(new_n50_));
  oai21  g05(.a(new_n50_), .b(x15), .c(new_n47_), .O(new_n51_));
  ...
  nand3  g19(.a(new_n64_), .b(new_n61_), .c(new_n51_), .O(z01));
  and2   g20(.a(new_n48_), .b(x16), .O(z02));
  inv1   g21(.a(x15), .O(new_n67_));
  oai21  g22(.a(x23), .b(x21), .c(x24), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g24(.a(new_n60_), .b(x21), .O(new_n70_));
  ...
  nand2  g39(.a(new_n58_), .b(new_n53_), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(x24), .c(x22), .d(x21), .O(new_n86_));
  oai21  g41(.a(new_n84_), .b(new_n83_), .c(new_n86_), .O(z08));
  inv1   g42(.a(x07), .O(new_n88_));
  nand3  g43(.a(new_n63_), .b(new_n67_), .c(new_n88_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n62_), .b(new_n55_), .c(new_n67_), .d(new_n88_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n48_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n62_), .c(new_n67_), .d(new_n88_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n62_), .c(new_n67_), .d(new_n88_), .O(new_n99_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n62_), .d(new_n88_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n67_), .O(new_n106_));
  oai21  g61(.a(new_n47_), .b(new_n67_), .c(new_n106_), .O(z13));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n64_), .d(new_n67_), .O(z14));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n64_), .d(new_n67_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n109_), .b(new_n113_), .c(new_n118_), .d(new_n54_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n64_), .d(new_n67_), .O(z16));
  oai21  g75(.a(x24), .b(x15), .c(x21), .O(new_n121_));
  nand3  g76(.a(new_n118_), .b(new_n54_), .c(new_n53_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n101_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n114_), .c(new_n103_), .d(new_n96_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n62_), .d(new_n88_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n67_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n121_), .O(z17));
  oai21  g83(.a(x25), .b(x15), .c(x21), .O(new_n129_));
  nand3  g84(.a(new_n124_), .b(new_n54_), .c(new_n53_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n101_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n114_), .c(new_n103_), .d(new_n96_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n62_), .d(new_n88_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n67_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n129_), .O(z18));
endmodule
