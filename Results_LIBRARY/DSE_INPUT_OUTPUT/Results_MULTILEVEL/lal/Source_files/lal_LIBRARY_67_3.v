...
module FAU ( 
  ...
  nand3  g32(.a(new_n47_), .b(new_n67_), .c(x06), .O(z07));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n51_), .c(new_n79_), .O(z08));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n85_), .d(new_n87_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n86_), .O(new_n104_));
  nand2  g59(.a(new_n87_), .b(x07), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(z13));
  inv1   g61(.a(new_n102_), .O(new_n107_));
  nor2   g62(.a(new_n107_), .b(new_n58_), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n95_), .c(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n85_), .c(new_n87_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n108_), .c(new_n86_), .O(new_n112_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n85_), .c(new_n87_), .O(new_n117_));
  aoi21  g72(.a(new_n110_), .b(x22), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x07), .c(new_n105_), .O(z15));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n80_), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n114_), .c(new_n80_), .d(new_n59_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n85_), .c(new_n87_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n86_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n105_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n50_), .c(new_n80_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n107_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n63_), .d(new_n87_), .O(z17));
  oai21  g85(.a(new_n127_), .b(new_n102_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n126_), .c(new_n107_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n85_), .d(new_n87_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n86_), .O(new_n135_));
