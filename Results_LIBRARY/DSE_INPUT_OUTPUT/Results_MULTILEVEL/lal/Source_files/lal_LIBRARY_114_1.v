...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n89_, new_n90_, new_n91_, new_n92_, new_n95_, new_n97_, new_n99_,
  ...
  aoi21  g43(.a(new_n88_), .b(new_n53_), .c(new_n72_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x25), .O(new_n90_));
  nor2   g45(.a(new_n72_), .b(new_n52_), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(x21), .d(new_n47_), .O(new_n92_));
  oai21  g47(.a(new_n90_), .b(new_n48_), .c(new_n92_), .O(z08));
  nor4   g48(.a(new_n57_), .b(x17), .c(x15), .d(x07), .O(z09));
  nand4  g49(.a(new_n57_), .b(new_n47_), .c(new_n69_), .d(new_n56_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  nand3  g51(.a(new_n57_), .b(x18), .c(new_n56_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x15), .O(z11));
  nand4  g53(.a(new_n57_), .b(x19), .c(new_n47_), .d(new_n69_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(x07), .O(z12));
  nand3  g55(.a(new_n57_), .b(new_n60_), .c(new_n56_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n69_), .O(z13));
  nand3  g58(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n69_), .O(z14));
  nand3  g61(.a(new_n57_), .b(new_n52_), .c(new_n56_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n69_), .O(z15));
  nand3  g64(.a(new_n57_), .b(new_n69_), .c(new_n56_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n53_), .c(new_n47_), .O(z16));
  nand3  g67(.a(new_n57_), .b(new_n72_), .c(new_n56_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n69_), .O(z17));
  nand3  g70(.a(new_n111_), .b(new_n61_), .c(new_n47_), .O(z18));
endmodule
