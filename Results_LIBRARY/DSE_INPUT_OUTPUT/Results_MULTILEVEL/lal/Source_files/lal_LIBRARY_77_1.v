...
module FAU ( 
  ...
  nor2   g003(.a(new_n48_), .b(x03), .O(new_n49_));
  ...
  nor2   g038(.a(x12), .b(new_n83_), .O(new_n84_));
  inv1   g039(.a(x12), .O(new_n85_));
  nor2   g040(.a(x15), .b(new_n85_), .O(new_n86_));
  aoi21  g041(.a(new_n86_), .b(new_n83_), .c(new_n84_), .O(new_n87_));
  ...
  nand3  g053(.a(new_n67_), .b(new_n48_), .c(new_n98_), .O(new_n99_));
  inv1   g054(.a(new_n99_), .O(z09));
  nand4  g055(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n98_), .O(new_n101_));
  inv1   g056(.a(new_n101_), .O(z10));
  xor2a  g057(.a(x18), .b(x17), .O(new_n103_));
  nand4  g058(.a(new_n103_), .b(new_n66_), .c(new_n48_), .d(new_n98_), .O(new_n104_));
  ...
  nand4  g063(.a(new_n108_), .b(new_n66_), .c(new_n48_), .d(new_n98_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n50_), .O(z12));
  nand3  g065(.a(x19), .b(x18), .c(x17), .O(new_n111_));
  nand2  g066(.a(new_n111_), .b(x20), .O(new_n112_));
  nand4  g067(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n112_), .c(new_n68_), .d(new_n48_), .O(z13));
  inv1   g069(.a(new_n113_), .O(new_n115_));
  nor2   g070(.a(new_n115_), .b(new_n61_), .O(new_n116_));
  nor2   g071(.a(x21), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n106_), .c(x19), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n66_), .c(new_n98_), .O(new_n119_));
  oai21  g074(.a(new_n119_), .b(new_n116_), .c(new_n48_), .O(new_n120_));
  nand2  g075(.a(x15), .b(x03), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n120_), .O(z14));
  inv1   g077(.a(new_n111_), .O(new_n123_));
  nor3   g078(.a(x22), .b(x21), .c(x20), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n66_), .c(new_n98_), .O(new_n126_));
  aoi21  g081(.a(new_n118_), .b(x22), .c(new_n126_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(x15), .c(new_n121_), .O(z15));
  aoi21  g083(.a(new_n124_), .b(new_n123_), .c(new_n93_), .O(new_n129_));
  nand4  g084(.a(new_n117_), .b(new_n123_), .c(new_n93_), .d(new_n62_), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n66_), .c(new_n98_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(new_n129_), .c(new_n48_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n121_), .O(z16));
  ...
  nand4  g094(.a(new_n139_), .b(new_n134_), .c(new_n66_), .d(new_n98_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n48_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n121_), .O(z17));
  oai21  g097(.a(new_n137_), .b(new_n113_), .c(x25), .O(new_n143_));
  nor3   g098(.a(x25), .b(x24), .c(x23), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n135_), .c(new_n115_), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n143_), .c(new_n66_), .d(new_n98_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n48_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n121_), .O(z18));
endmodule
