...
module FAU ( 
  ...
  aoi21  g48(.a(new_n93_), .b(new_n92_), .c(x15), .O(z09));
  nand2  g49(.a(new_n56_), .b(new_n92_), .O(new_n95_));
  nor4   g50(.a(new_n95_), .b(x17), .c(x15), .d(x07), .O(z10));
  inv1   g51(.a(x17), .O(new_n97_));
  nor4   g52(.a(new_n95_), .b(new_n97_), .c(x15), .d(x07), .O(z11));
  nand4  g53(.a(new_n56_), .b(x19), .c(new_n92_), .d(new_n47_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(x07), .O(z12));
  nand3  g55(.a(new_n56_), .b(new_n59_), .c(new_n55_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n92_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(z13));
  nand3  g58(.a(new_n56_), .b(new_n50_), .c(new_n55_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n92_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(z14));
  nand3  g61(.a(new_n56_), .b(new_n51_), .c(new_n55_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n92_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(z15));
  nor2   g64(.a(x23), .b(x18), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n56_), .c(new_n47_), .d(new_n55_), .O(z16));
  nand3  g66(.a(new_n56_), .b(new_n70_), .c(new_n55_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n92_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(z17));
  nand3  g69(.a(new_n56_), .b(new_n60_), .c(new_n55_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n92_), .O(new_n116_));
