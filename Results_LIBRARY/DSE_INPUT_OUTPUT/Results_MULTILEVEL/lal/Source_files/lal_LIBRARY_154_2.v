...
module FAU ( 
  ...
  aoi21  g07(.a(x24), .b(x23), .c(x21), .O(new_n53_));
  ...
  aoi21  g15(.a(new_n60_), .b(x22), .c(new_n54_), .O(new_n61_));
  ...
  oai22  g38(.a(new_n83_), .b(new_n54_), .c(new_n79_), .d(x21), .O(z08));
  ...
  oai21  g43(.a(new_n88_), .b(new_n85_), .c(new_n67_), .O(z09));
  nand4  g44(.a(new_n85_), .b(new_n56_), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  ...
  nand3  g56(.a(new_n95_), .b(new_n55_), .c(x19), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n50_), .d(new_n87_), .O(new_n103_));
  and2   g58(.a(new_n103_), .b(new_n67_), .O(z13));
  nand3  g59(.a(new_n85_), .b(new_n87_), .c(new_n86_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n67_), .O(new_n106_));
  nand3  g61(.a(new_n102_), .b(x24), .c(x21), .O(new_n107_));
  nand4  g62(.a(new_n95_), .b(new_n47_), .c(new_n55_), .d(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(z14));
  oai21  g64(.a(new_n54_), .b(x22), .c(x21), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n105_), .O(new_n111_));
  nand2  g66(.a(new_n102_), .b(x22), .O(new_n112_));
  nand4  g67(.a(new_n95_), .b(new_n80_), .c(new_n55_), .d(x19), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand3  g70(.a(x24), .b(x22), .c(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n111_), .O(z15));
  oai21  g72(.a(new_n54_), .b(x23), .c(x21), .O(new_n118_));
  ...
  nand3  g80(.a(x24), .b(x23), .c(x21), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n119_), .O(z16));
  nand2  g82(.a(new_n123_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n54_), .b(new_n52_), .c(new_n80_), .d(new_n55_), .O(new_n129_));
  inv1   g84(.a(new_n129_), .O(new_n130_));
  aoi21  g85(.a(new_n130_), .b(new_n121_), .c(x21), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n50_), .d(new_n87_), .O(z17));
  aoi21  g87(.a(new_n122_), .b(new_n121_), .c(new_n79_), .O(new_n133_));
  nand4  g88(.a(new_n79_), .b(new_n54_), .c(new_n52_), .d(new_n80_), .O(new_n134_));
  nor2   g89(.a(new_n134_), .b(new_n102_), .O(new_n135_));
  oai21  g90(.a(new_n135_), .b(new_n133_), .c(new_n47_), .O(new_n136_));
  nand2  g91(.a(x25), .b(x24), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n136_), .c(new_n106_), .O(z18));
endmodule
