...
module FAU ( 
  ...
  oai21  g22(.a(x11), .b(x08), .c(x15), .O(new_n68_));
  ...
  nand2  g30(.a(x11), .b(new_n47_), .O(new_n76_));
  xnor2a g31(.a(x12), .b(x03), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n73_), .c(new_n46_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n69_), .O(z04));
  ...
  nand4  g45(.a(new_n51_), .b(x05), .c(x04), .d(new_n47_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x15), .O(z09));
  inv1   g47(.a(x15), .O(new_n93_));
  nand4  g48(.a(new_n62_), .b(new_n54_), .c(new_n93_), .d(new_n51_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x02), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n62_), .c(new_n51_), .O(new_n97_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n62_), .c(new_n51_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g58(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  aoi21  g60(.a(x05), .b(x04), .c(x02), .O(new_n106_));
  nand4  g61(.a(new_n53_), .b(x19), .c(x18), .d(x17), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nor2   g63(.a(new_n108_), .b(x15), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n106_), .c(new_n105_), .d(new_n51_), .O(z13));
  ...
  nand3  g68(.a(new_n113_), .b(new_n93_), .c(new_n51_), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n111_), .c(new_n106_), .O(z14));
  inv1   g71(.a(new_n104_), .O(new_n117_));
  nor3   g72(.a(x22), .b(x21), .c(x20), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n62_), .c(new_n51_), .O(new_n120_));
  aoi21  g75(.a(new_n113_), .b(x22), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x02), .c(new_n93_), .O(z15));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n85_), .O(new_n123_));
  inv1   g78(.a(x22), .O(new_n124_));
  nand4  g79(.a(new_n112_), .b(new_n117_), .c(new_n85_), .d(new_n124_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n62_), .c(new_n51_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n123_), .c(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n93_), .O(z16));
  nand3  g83(.a(new_n112_), .b(new_n85_), .c(new_n124_), .O(new_n129_));
  ...
  nand2  g89(.a(new_n134_), .b(new_n108_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n130_), .c(new_n62_), .d(new_n51_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n93_), .O(z17));
  oai21  g93(.a(new_n133_), .b(new_n107_), .c(x25), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n131_), .c(new_n108_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n62_), .d(new_n51_), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(new_n47_), .O(new_n143_));
  nand2  g98(.a(new_n143_), .b(new_n93_), .O(z18));
endmodule
