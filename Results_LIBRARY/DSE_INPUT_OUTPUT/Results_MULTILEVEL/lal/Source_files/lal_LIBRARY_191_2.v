...
module FAU ( 
  ...
  oai21  g22(.a(x08), .b(x00), .c(x15), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(x09), .O(new_n69_));
  nand2  g24(.a(new_n47_), .b(x00), .O(new_n70_));
  ...
  nand2  g30(.a(new_n75_), .b(new_n69_), .O(z04));
  ...
  nor4   g41(.a(new_n62_), .b(x15), .c(x09), .d(x07), .O(z09));
  nand3  g42(.a(new_n62_), .b(new_n54_), .c(new_n50_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g44(.a(x15), .O(new_n90_));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(new_n90_), .d(new_n47_), .O(new_n92_));
  ...
  nand3  g51(.a(new_n96_), .b(new_n62_), .c(new_n50_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n62_), .d(new_n50_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n90_), .O(z13));
  ...
  nand3  g63(.a(new_n108_), .b(new_n90_), .c(new_n47_), .O(new_n109_));
  ...
  and2   g70(.a(new_n115_), .b(new_n90_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n106_), .d(new_n47_), .O(z15));
  ...
  nand3  g75(.a(new_n120_), .b(new_n90_), .c(new_n47_), .O(new_n121_));
  ...
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n106_), .d(new_n47_), .O(z17));
  ...
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n62_), .d(new_n50_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n90_), .O(z18));
endmodule
