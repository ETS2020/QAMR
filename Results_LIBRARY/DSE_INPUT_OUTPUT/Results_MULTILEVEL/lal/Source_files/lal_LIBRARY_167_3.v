...
module FAU ( 
  ...
  nor2   g24(.a(new_n49_), .b(new_n69_), .O(z02));
  nand2  g25(.a(new_n64_), .b(new_n50_), .O(z03));
  ...
  nand3  g43(.a(new_n66_), .b(new_n48_), .c(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n65_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n50_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n65_), .c(new_n48_), .d(new_n47_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n65_), .c(new_n48_), .d(new_n47_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n65_), .d(new_n48_), .O(new_n104_));
  ...
  aoi21  g63(.a(new_n108_), .b(new_n96_), .c(new_n60_), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n96_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n65_), .c(new_n48_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n67_), .d(new_n48_), .O(z15));
  nand2  g74(.a(new_n118_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n61_), .c(new_n60_), .d(new_n54_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n116_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n67_), .d(new_n48_), .O(z16));
  oai21  g80(.a(new_n122_), .b(new_n101_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n117_), .c(new_n108_), .d(new_n96_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n65_), .d(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n106_), .O(z17));
  nand4  g86(.a(new_n52_), .b(new_n121_), .c(new_n61_), .d(new_n60_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n103_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n117_), .c(new_n108_), .d(new_n96_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n65_), .d(new_n48_), .O(new_n136_));
