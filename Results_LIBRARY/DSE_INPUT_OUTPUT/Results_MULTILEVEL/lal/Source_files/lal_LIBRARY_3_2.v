...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n85_), .c(new_n91_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n61_), .d(new_n91_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n61_), .d(new_n91_), .O(z14));
