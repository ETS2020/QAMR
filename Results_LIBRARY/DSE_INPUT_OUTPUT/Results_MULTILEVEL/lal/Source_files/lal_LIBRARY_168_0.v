...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x09), .O(new_n47_));
  ...
  nand3  g51(.a(new_n96_), .b(new_n88_), .c(new_n85_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(x09), .c(x15), .O(z12));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n88_), .d(new_n85_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x09), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n66_), .O(z13));
  inv1   g60(.a(x09), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n94_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n88_), .c(new_n85_), .O(new_n109_));
  aoi21  g64(.a(new_n102_), .b(x21), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n106_), .c(new_n66_), .O(z14));
  inv1   g66(.a(new_n99_), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n52_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n88_), .c(new_n85_), .O(new_n115_));
  aoi21  g70(.a(new_n108_), .b(x22), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n106_), .c(new_n66_), .O(z15));
  nand2  g72(.a(new_n114_), .b(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n107_), .c(new_n112_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n66_), .c(x09), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n118_), .c(new_n61_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n113_), .c(new_n101_), .d(new_n94_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n88_), .d(new_n85_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(x09), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n66_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  inv1   g85(.a(new_n102_), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  and2   g87(.a(new_n132_), .b(new_n113_), .O(new_n133_));
  aoi21  g88(.a(new_n133_), .b(new_n131_), .c(x15), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n130_), .c(new_n61_), .d(x09), .O(z18));
endmodule
