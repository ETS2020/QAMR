...
module FAU ( 
  ...
  nand3  g33(.a(new_n78_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand3  g40(.a(new_n62_), .b(new_n78_), .c(new_n85_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n61_), .b(new_n53_), .c(new_n78_), .d(new_n85_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n47_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n78_), .d(new_n85_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n78_), .d(new_n85_), .O(new_n96_));
  ...
  nand2  g56(.a(new_n101_), .b(new_n78_), .O(new_n102_));
  inv1   g57(.a(x06), .O(new_n103_));
  nand2  g58(.a(x15), .b(new_n103_), .O(new_n104_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n63_), .d(new_n78_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n63_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n112_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  nand4  g71(.a(new_n107_), .b(new_n111_), .c(new_n115_), .d(new_n80_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n61_), .c(new_n85_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(new_n78_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n104_), .O(z16));
  nand2  g75(.a(new_n117_), .b(x24), .O(new_n121_));
  inv1   g76(.a(new_n100_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n50_), .c(new_n115_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n121_), .c(new_n63_), .d(new_n78_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n61_), .d(new_n85_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n78_), .O(new_n132_));
