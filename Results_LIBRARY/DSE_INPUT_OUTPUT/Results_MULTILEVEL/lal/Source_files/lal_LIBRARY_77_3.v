...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n85_, new_n88_, new_n89_, new_n92_, new_n93_, new_n94_, new_n95_,
  ...
  nand2  g001(.a(x15), .b(x03), .O(new_n47_));
  ...
  nand2  g023(.a(new_n63_), .b(new_n47_), .O(z03));
  ...
  oai21  g035(.a(new_n80_), .b(new_n73_), .c(new_n47_), .O(new_n81_));
  inv1   g036(.a(x12), .O(new_n82_));
  nor2   g037(.a(new_n82_), .b(x03), .O(new_n83_));
  nor2   g038(.a(x15), .b(x12), .O(new_n84_));
  ...
  nand3  g043(.a(new_n47_), .b(x14), .c(new_n88_), .O(new_n89_));
  inv1   g044(.a(new_n89_), .O(z06));
  aoi21  g045(.a(new_n88_), .b(x06), .c(new_n50_), .O(z07));
  inv1   g046(.a(x23), .O(new_n92_));
  nand3  g047(.a(new_n58_), .b(x22), .c(x21), .O(new_n93_));
  nand2  g048(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g049(.a(new_n94_), .b(x24), .O(new_n95_));
  aoi21  g050(.a(new_n95_), .b(new_n52_), .c(new_n50_), .O(z08));
  inv1   g051(.a(x07), .O(new_n97_));
  inv1   g052(.a(x15), .O(new_n98_));
  nand3  g053(.a(new_n65_), .b(new_n98_), .c(new_n97_), .O(new_n99_));
  inv1   g054(.a(new_n99_), .O(z09));
  nand4  g055(.a(new_n64_), .b(new_n54_), .c(new_n98_), .d(new_n97_), .O(new_n101_));
  inv1   g056(.a(new_n101_), .O(z10));
  xor2a  g057(.a(x18), .b(x17), .O(new_n103_));
  nand4  g058(.a(new_n103_), .b(new_n64_), .c(new_n98_), .d(new_n97_), .O(new_n104_));
  inv1   g059(.a(new_n104_), .O(z11));
  nor2   g060(.a(new_n55_), .b(new_n54_), .O(new_n106_));
  nand3  g061(.a(new_n56_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g062(.a(new_n106_), .b(new_n56_), .c(new_n107_), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n64_), .c(new_n98_), .d(new_n97_), .O(new_n109_));
  ...
  nand4  g068(.a(new_n113_), .b(new_n112_), .c(new_n66_), .d(new_n98_), .O(z13));
  inv1   g069(.a(new_n113_), .O(new_n115_));
  nor2   g070(.a(new_n115_), .b(new_n59_), .O(new_n116_));
  nor2   g071(.a(x21), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n106_), .c(x19), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n64_), .c(new_n97_), .O(new_n119_));
  oai21  g074(.a(new_n119_), .b(new_n116_), .c(new_n98_), .O(new_n120_));
  inv1   g075(.a(x03), .O(new_n121_));
  nand2  g076(.a(x15), .b(new_n121_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n120_), .O(z14));
  inv1   g078(.a(new_n111_), .O(new_n124_));
  nor3   g079(.a(x22), .b(x21), .c(x20), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n64_), .c(new_n97_), .O(new_n127_));
  aoi21  g082(.a(new_n118_), .b(x22), .c(new_n127_), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(x15), .c(new_n122_), .O(z15));
  aoi21  g084(.a(new_n125_), .b(new_n124_), .c(new_n92_), .O(new_n130_));
  nand4  g085(.a(new_n117_), .b(new_n124_), .c(new_n92_), .d(new_n60_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n64_), .c(new_n97_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(new_n130_), .c(new_n98_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n122_), .O(z16));
  ...
  nand4  g095(.a(new_n140_), .b(new_n135_), .c(new_n64_), .d(new_n97_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n98_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n122_), .O(z17));
  oai21  g098(.a(new_n138_), .b(new_n113_), .c(x25), .O(new_n144_));
  nor3   g099(.a(x25), .b(x24), .c(x23), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n136_), .c(new_n115_), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n144_), .c(new_n64_), .d(new_n97_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n98_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n122_), .O(z18));
endmodule
