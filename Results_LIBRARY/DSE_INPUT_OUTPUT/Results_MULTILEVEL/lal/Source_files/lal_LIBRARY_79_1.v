...
module FAU ( 
  ...
  oai21  g34(.a(x15), .b(x06), .c(new_n79_), .O(z07));
  ...
  nand2  g44(.a(new_n89_), .b(new_n67_), .O(z10));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n61_), .d(new_n86_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g58(.a(x15), .b(x06), .O(new_n104_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n63_), .d(new_n47_), .O(z14));
  inv1   g64(.a(new_n99_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n61_), .c(new_n86_), .O(new_n113_));
  aoi21  g68(.a(new_n108_), .b(x22), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n104_), .O(z15));
  inv1   g70(.a(x23), .O(new_n116_));
  aoi21  g71(.a(new_n111_), .b(new_n110_), .c(new_n116_), .O(new_n117_));
  nand4  g72(.a(new_n107_), .b(new_n110_), .c(new_n116_), .d(new_n81_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n61_), .c(new_n86_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n117_), .c(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n104_), .O(z16));
  ...
  nand4  g81(.a(new_n126_), .b(new_n122_), .c(new_n63_), .d(new_n47_), .O(z17));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n124_), .c(new_n123_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n63_), .d(new_n47_), .O(z18));
endmodule
