...
module FAU ( 
  ...
  oai21  g08(.a(new_n53_), .b(x18), .c(x17), .O(new_n54_));
  inv1   g09(.a(x24), .O(new_n55_));
  inv1   g10(.a(x25), .O(new_n56_));
  inv1   g11(.a(x20), .O(new_n57_));
  oai21  g12(.a(x19), .b(x18), .c(new_n57_), .O(new_n58_));
  ...
  nand3  g26(.a(new_n71_), .b(new_n50_), .c(new_n66_), .O(new_n72_));
  inv1   g27(.a(new_n72_), .O(z04));
  oai21  g28(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  nand2  g29(.a(x14), .b(new_n66_), .O(new_n75_));
  ...
  nand3  g34(.a(new_n79_), .b(new_n48_), .c(new_n47_), .O(new_n80_));
  ...
  nand4  g42(.a(new_n50_), .b(new_n87_), .c(new_n86_), .d(x05), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(new_n85_), .O(z09));
  nand2  g44(.a(x05), .b(x04), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n47_), .c(new_n87_), .d(new_n86_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n50_), .O(z10));
  nand2  g47(.a(new_n48_), .b(new_n47_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n86_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n50_), .O(z11));
  nand4  g50(.a(new_n90_), .b(x19), .c(new_n87_), .d(new_n86_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n50_), .O(z12));
  nand3  g52(.a(new_n90_), .b(new_n50_), .c(new_n86_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n57_), .c(new_n87_), .O(z13));
  nor2   g55(.a(x21), .b(x15), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n62_), .c(new_n49_), .O(z14));
  nand3  g57(.a(new_n99_), .b(new_n78_), .c(new_n87_), .O(z15));
  nor2   g58(.a(x23), .b(x15), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n99_), .O(z16));
  nor2   g60(.a(x24), .b(x15), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n62_), .c(new_n49_), .O(z17));
  nand3  g62(.a(new_n99_), .b(new_n56_), .c(new_n87_), .O(z18));
endmodule
