...
module FAU ( 
  ...
  inv1   g41(.a(new_n64_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n48_), .c(new_n63_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n64_), .b(new_n55_), .c(new_n48_), .d(new_n63_), .O(new_n90_));
  ...
  nand2  g53(.a(new_n98_), .b(new_n64_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n48_), .c(x07), .O(z12));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nor2   g57(.a(new_n87_), .b(x07), .O(new_n103_));
  nor2   g58(.a(x20), .b(new_n57_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n96_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n48_), .O(z13));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n103_), .d(new_n48_), .O(z14));
  ...
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n64_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n48_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n63_), .O(z15));
  nand2  g72(.a(new_n114_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x23), .O(new_n119_));
  nand3  g74(.a(new_n108_), .b(new_n119_), .c(new_n82_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n112_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n103_), .d(new_n48_), .O(z16));
  oai21  g78(.a(new_n120_), .b(new_n101_), .c(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n113_), .c(new_n104_), .d(new_n96_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n64_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n63_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n113_), .c(new_n104_), .d(new_n96_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n103_), .d(new_n48_), .O(z18));
endmodule
