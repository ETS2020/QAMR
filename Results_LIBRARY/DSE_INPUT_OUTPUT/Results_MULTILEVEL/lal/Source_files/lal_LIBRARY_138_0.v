...
module FAU ( 
  ...
  nor2   g021(.a(new_n66_), .b(x07), .O(new_n67_));
  aoi21  g022(.a(new_n67_), .b(new_n64_), .c(new_n51_), .O(z01));
  and2   g023(.a(new_n49_), .b(x16), .O(z02));
  nand2  g024(.a(new_n64_), .b(new_n49_), .O(z03));
  ...
  nor3   g038(.a(new_n48_), .b(new_n83_), .c(x02), .O(new_n84_));
  aoi21  g039(.a(new_n83_), .b(x02), .c(new_n84_), .O(new_n85_));
  ...
  nand3  g046(.a(new_n59_), .b(x22), .c(x21), .O(new_n92_));
  nand2  g047(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g048(.a(new_n93_), .b(x24), .O(new_n94_));
  aoi21  g049(.a(new_n94_), .b(new_n53_), .c(new_n51_), .O(z08));
  nand3  g050(.a(x05), .b(x04), .c(x02), .O(new_n96_));
  nor3   g051(.a(new_n96_), .b(x15), .c(x07), .O(z09));
  inv1   g052(.a(x07), .O(new_n98_));
  nand4  g053(.a(new_n65_), .b(new_n55_), .c(new_n48_), .d(new_n98_), .O(new_n99_));
  nor2   g054(.a(new_n99_), .b(new_n47_), .O(z10));
  xor2a  g055(.a(x18), .b(x17), .O(new_n101_));
  nand4  g056(.a(new_n101_), .b(new_n65_), .c(new_n48_), .d(new_n98_), .O(new_n102_));
  nor2   g057(.a(new_n102_), .b(new_n47_), .O(z11));
  nor2   g058(.a(new_n56_), .b(new_n55_), .O(new_n104_));
  nand3  g059(.a(new_n57_), .b(x18), .c(x17), .O(new_n105_));
  oai21  g060(.a(new_n104_), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  nand3  g061(.a(new_n106_), .b(new_n65_), .c(new_n98_), .O(new_n107_));
  aoi21  g062(.a(new_n107_), .b(x02), .c(x15), .O(z12));
  nand3  g063(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(x20), .O(new_n110_));
  nor2   g065(.a(new_n66_), .b(new_n47_), .O(new_n111_));
  nand4  g066(.a(new_n54_), .b(x19), .c(x18), .d(x17), .O(new_n112_));
  inv1   g067(.a(new_n112_), .O(new_n113_));
  nor2   g068(.a(new_n113_), .b(x15), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n111_), .c(new_n110_), .d(new_n98_), .O(z13));
  nor2   g070(.a(new_n113_), .b(new_n60_), .O(new_n116_));
  nor2   g071(.a(x21), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n104_), .c(x19), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n65_), .c(new_n98_), .O(new_n119_));
  oai21  g074(.a(new_n119_), .b(new_n116_), .c(x02), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n48_), .O(z14));
  inv1   g076(.a(new_n109_), .O(new_n122_));
  nor3   g077(.a(x22), .b(x21), .c(x20), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n65_), .c(new_n98_), .O(new_n125_));
  aoi21  g080(.a(new_n118_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(new_n47_), .c(new_n48_), .O(z15));
  aoi21  g082(.a(new_n123_), .b(new_n122_), .c(new_n91_), .O(new_n128_));
  nand4  g083(.a(new_n117_), .b(new_n122_), .c(new_n91_), .d(new_n61_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n65_), .c(new_n98_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(new_n128_), .c(x02), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n48_), .O(z16));
  nand2  g087(.a(new_n129_), .b(x24), .O(new_n133_));
  nor2   g088(.a(x22), .b(x21), .O(new_n134_));
  nor2   g089(.a(x24), .b(x23), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  inv1   g091(.a(new_n136_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n113_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n133_), .c(new_n65_), .d(new_n98_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(x02), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n48_), .O(z17));
  oai21  g096(.a(new_n136_), .b(new_n112_), .c(x25), .O(new_n142_));
  nor3   g097(.a(x25), .b(x24), .c(x23), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n134_), .c(new_n113_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n142_), .c(new_n65_), .d(new_n98_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(x02), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n48_), .O(z18));
endmodule
