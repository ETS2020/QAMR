...
module FAU ( 
  ...
  aoi21  g39(.a(new_n61_), .b(new_n47_), .c(x07), .O(z09));
  nand4  g40(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n50_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n61_), .c(new_n47_), .d(new_n50_), .O(new_n89_));
  ...
  nand4  g48(.a(new_n93_), .b(new_n61_), .c(new_n47_), .d(new_n50_), .O(new_n94_));
  ...
  nand2  g55(.a(new_n100_), .b(new_n50_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n47_), .O(z14));
  ...
  oai21  g66(.a(new_n111_), .b(x15), .c(new_n50_), .O(z15));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n79_), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n104_), .c(new_n107_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n61_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n113_), .c(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n50_), .O(z16));
  ...
  nand4  g80(.a(new_n125_), .b(new_n119_), .c(new_n103_), .d(new_n47_), .O(z17));
  ...
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n103_), .d(new_n47_), .O(z18));
endmodule
