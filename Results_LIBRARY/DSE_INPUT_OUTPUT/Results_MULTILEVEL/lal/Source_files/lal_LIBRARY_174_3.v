...
module FAU ( 
  ...
  nand3  g71(.a(new_n116_), .b(new_n112_), .c(new_n104_), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  nor2   g73(.a(new_n115_), .b(new_n118_), .O(new_n119_));
  inv1   g74(.a(new_n102_), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n120_), .c(new_n118_), .d(new_n85_), .O(new_n121_));
  ...
  nand3  g80(.a(new_n113_), .b(new_n84_), .c(new_n118_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n105_), .c(new_n97_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n62_), .d(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n65_), .O(z17));
  oai21  g86(.a(new_n126_), .b(new_n106_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n113_), .c(new_n105_), .d(new_n97_), .O(new_n134_));
