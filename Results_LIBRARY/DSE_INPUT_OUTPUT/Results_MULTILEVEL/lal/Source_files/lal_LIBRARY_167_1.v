...
module FAU ( 
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n63_), .O(new_n108_));
  ...
  nor2   g66(.a(new_n86_), .b(x07), .O(new_n112_));
  inv1   g67(.a(new_n99_), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n53_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n111_), .d(new_n47_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand3  g73(.a(new_n106_), .b(new_n118_), .c(new_n81_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n113_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n112_), .d(new_n47_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n99_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n56_), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n114_), .c(new_n124_), .d(new_n94_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n63_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n62_), .O(z17));
  nand2  g84(.a(new_n125_), .b(new_n114_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n101_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n114_), .c(new_n124_), .d(new_n94_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n131_), .c(new_n63_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n62_), .O(z18));
endmodule
