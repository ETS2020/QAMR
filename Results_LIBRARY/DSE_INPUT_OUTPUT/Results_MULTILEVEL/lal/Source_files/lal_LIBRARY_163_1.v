...
module FAU ( 
  ...
  oai21  g42(.a(new_n87_), .b(new_n85_), .c(new_n49_), .O(z09));
  nand4  g43(.a(new_n85_), .b(new_n53_), .c(new_n47_), .d(new_n86_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n85_), .c(new_n47_), .d(new_n86_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n85_), .c(new_n47_), .d(new_n86_), .O(new_n97_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n61_), .d(new_n47_), .O(z13));
  ...
  nand3  g65(.a(new_n110_), .b(new_n85_), .c(new_n86_), .O(new_n111_));
  aoi21  g66(.a(new_n106_), .b(x22), .c(new_n111_), .O(new_n112_));
  nand2  g67(.a(x15), .b(x06), .O(new_n113_));
  oai21  g68(.a(new_n112_), .b(x15), .c(new_n113_), .O(z15));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n61_), .d(new_n47_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n109_), .c(new_n101_), .d(new_n94_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n85_), .d(new_n86_), .O(new_n122_));
  ...
  nand4  g81(.a(new_n126_), .b(new_n109_), .c(new_n101_), .d(new_n94_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n61_), .d(new_n47_), .O(z18));
endmodule
