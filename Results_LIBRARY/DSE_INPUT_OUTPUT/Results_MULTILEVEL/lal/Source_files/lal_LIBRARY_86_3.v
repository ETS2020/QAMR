...
module FAU ( 
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n59_), .d(new_n86_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n85_), .O(new_n104_));
  nand2  g59(.a(new_n86_), .b(x07), .O(new_n105_));
  ...
  oai21  g66(.a(new_n111_), .b(new_n108_), .c(new_n85_), .O(new_n112_));
  ...
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n109_), .c(new_n114_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n59_), .c(new_n86_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n120_), .c(new_n85_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n105_), .O(z16));
  nand2  g80(.a(new_n122_), .b(x24), .O(new_n126_));
  inv1   g81(.a(new_n102_), .O(new_n127_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n126_), .c(new_n61_), .d(new_n86_), .O(z17));
  nand2  g86(.a(new_n130_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n128_), .c(new_n127_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n61_), .d(new_n86_), .O(z18));
endmodule
