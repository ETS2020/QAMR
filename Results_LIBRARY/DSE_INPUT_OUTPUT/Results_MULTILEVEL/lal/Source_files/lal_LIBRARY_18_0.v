...
module FAU ( 
  ...
  aoi21  g15(.a(new_n60_), .b(new_n59_), .c(new_n47_), .O(z01));
  ...
  nand4  g44(.a(new_n88_), .b(new_n52_), .c(new_n66_), .d(x10), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x07), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n88_), .c(new_n66_), .d(x10), .O(new_n93_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n88_), .c(new_n95_), .O(new_n99_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n102_), .c(new_n60_), .d(x10), .O(z13));
  ...
  nand3  g66(.a(new_n111_), .b(new_n88_), .c(new_n95_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n109_), .c(x10), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n66_), .O(z14));
  ...
  nand4  g75(.a(new_n120_), .b(new_n115_), .c(new_n60_), .d(x10), .O(z15));
  ...
  nand3  g78(.a(new_n123_), .b(new_n88_), .c(new_n95_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n122_), .c(x10), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n66_), .O(z16));
  ...
  nand4  g85(.a(new_n130_), .b(new_n127_), .c(new_n88_), .d(new_n95_), .O(new_n131_));
  ...
  nand3  g90(.a(new_n50_), .b(new_n135_), .c(new_n81_), .O(new_n136_));
  nor2   g91(.a(new_n136_), .b(new_n118_), .O(new_n137_));
  aoi21  g92(.a(new_n137_), .b(new_n105_), .c(x15), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n134_), .c(new_n60_), .d(x10), .O(z18));
endmodule
