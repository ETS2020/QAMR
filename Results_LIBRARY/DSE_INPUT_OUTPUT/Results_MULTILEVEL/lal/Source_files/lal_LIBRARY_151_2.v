...
module FAU ( 
  ...
  nand3  g41(.a(new_n64_), .b(new_n86_), .c(new_n48_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n63_), .b(new_n55_), .c(new_n86_), .d(new_n48_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n63_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n48_), .c(x15), .O(z11));
  ...
  nand2  g52(.a(new_n97_), .b(new_n63_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n65_), .d(new_n86_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n65_), .d(new_n86_), .O(z14));
  ...
  nand2  g69(.a(new_n114_), .b(new_n86_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand3  g72(.a(new_n106_), .b(new_n117_), .c(new_n81_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n110_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n65_), .d(new_n86_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n100_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n111_), .c(new_n102_), .d(new_n95_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n63_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n86_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n111_), .c(new_n102_), .d(new_n95_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n65_), .d(new_n86_), .O(z18));
endmodule
