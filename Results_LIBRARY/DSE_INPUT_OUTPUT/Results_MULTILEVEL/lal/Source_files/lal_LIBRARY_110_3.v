...
module FAU ( 
  ...
  nand2  g41(.a(new_n86_), .b(x05), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n48_), .c(new_n47_), .O(z09));
  nand2  g43(.a(x05), .b(x04), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n55_), .c(new_n48_), .d(new_n86_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n89_), .c(new_n48_), .d(new_n86_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n89_), .c(new_n48_), .d(new_n86_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n89_), .d(new_n86_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  nand2  g60(.a(x15), .b(new_n47_), .O(new_n106_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n89_), .c(new_n86_), .O(new_n116_));
  aoi21  g71(.a(new_n111_), .b(x22), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(x15), .c(new_n106_), .O(z15));
  nand2  g73(.a(new_n115_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n110_), .c(new_n113_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n109_), .d(new_n48_), .O(z16));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n114_), .c(new_n102_), .d(new_n95_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n89_), .c(new_n86_), .O(new_n125_));
  aoi21  g80(.a(new_n121_), .b(x24), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n106_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n114_), .c(new_n102_), .d(new_n95_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n109_), .d(new_n48_), .O(z18));
endmodule
