...
module FAU ( 
  ...
  nand2  g36(.a(new_n57_), .b(new_n53_), .O(new_n82_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n52_), .c(new_n49_), .O(z08));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(new_n48_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n101_), .d(new_n48_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n109_), .c(new_n61_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n64_), .O(z15));
  nor2   g71(.a(new_n112_), .b(new_n81_), .O(new_n117_));
  inv1   g72(.a(new_n99_), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n106_), .c(new_n118_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n61_), .c(new_n48_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n117_), .c(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n64_), .O(z16));
  ...
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n101_), .d(new_n48_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n103_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n110_), .c(new_n102_), .d(new_n94_), .O(new_n131_));
