...
module FAU ( 
  ...
  nand4  g16(.a(new_n61_), .b(new_n60_), .c(new_n47_), .d(new_n50_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nor2   g18(.a(new_n48_), .b(new_n63_), .O(z02));
  inv1   g19(.a(new_n48_), .O(new_n65_));
  nand3  g20(.a(new_n59_), .b(new_n65_), .c(new_n51_), .O(new_n66_));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g39(.a(new_n61_), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n47_), .c(new_n50_), .O(new_n86_));
  ...
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n47_), .d(new_n50_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n47_), .d(new_n50_), .O(new_n96_));
  ...
  nand3  g55(.a(new_n93_), .b(new_n52_), .c(x19), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n47_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n93_), .c(x19), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n61_), .O(new_n105_));
  aoi21  g60(.a(new_n101_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(x15), .c(new_n50_), .O(z14));
  ...
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n100_), .d(new_n47_), .O(z15));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n103_), .c(new_n109_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n100_), .d(new_n47_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  inv1   g72(.a(new_n101_), .O(new_n118_));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n110_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n117_), .c(new_n100_), .d(new_n47_), .O(z17));
  nand2  g78(.a(new_n122_), .b(x25), .O(new_n124_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n110_), .c(new_n118_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n100_), .d(new_n47_), .O(z18));
endmodule
