...
module FAU ( 
  ...
  nand4  g45(.a(new_n47_), .b(new_n55_), .c(x05), .d(x04), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand4  g47(.a(new_n56_), .b(new_n61_), .c(new_n47_), .d(new_n55_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n56_), .c(new_n47_), .d(new_n55_), .O(new_n96_));
  ...
  nand3  g58(.a(new_n59_), .b(x19), .c(x18), .O(new_n104_));
  ...
  aoi21  g62(.a(new_n107_), .b(x20), .c(new_n57_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(x15), .c(new_n106_), .O(z13));
  inv1   g64(.a(new_n57_), .O(new_n110_));
  nor2   g65(.a(x20), .b(new_n98_), .O(new_n111_));
  ...
  nand4  g75(.a(new_n120_), .b(new_n117_), .c(new_n110_), .d(new_n47_), .O(z15));
  inv1   g76(.a(x21), .O(new_n122_));
  nor2   g77(.a(x23), .b(x22), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n104_), .c(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x17), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x23), .c(new_n57_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x15), .c(new_n126_), .O(z16));
  nand2  g83(.a(new_n123_), .b(new_n114_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n107_), .c(x24), .O(new_n130_));
  nor2   g85(.a(x24), .b(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n119_), .c(new_n111_), .d(new_n99_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n110_), .d(new_n47_), .O(z17));
  nand3  g88(.a(new_n114_), .b(x19), .c(x18), .O(new_n134_));
  nand3  g89(.a(new_n123_), .b(new_n60_), .c(new_n68_), .O(new_n135_));
  oai21  g90(.a(new_n135_), .b(new_n134_), .c(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(x17), .O(new_n137_));
  aoi21  g92(.a(new_n132_), .b(x25), .c(new_n57_), .O(new_n138_));
