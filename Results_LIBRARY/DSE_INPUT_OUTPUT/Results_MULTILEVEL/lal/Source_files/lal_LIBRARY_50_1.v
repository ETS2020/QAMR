...
module FAU ( 
  ...
  nand4  g41(.a(new_n63_), .b(new_n56_), .c(new_n48_), .d(new_n53_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n63_), .c(new_n48_), .d(new_n53_), .O(new_n90_));
  ...
  nand2  g56(.a(new_n101_), .b(new_n53_), .O(z13));
  nand2  g57(.a(new_n99_), .b(x21), .O(new_n103_));
  nor2   g58(.a(new_n64_), .b(x07), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n92_), .c(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n48_), .O(z14));
  ...
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n104_), .d(new_n48_), .O(z15));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n113_));
  inv1   g68(.a(x23), .O(new_n114_));
  nand4  g69(.a(new_n105_), .b(new_n109_), .c(new_n114_), .d(new_n81_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n104_), .d(new_n48_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  inv1   g72(.a(new_n99_), .O(new_n118_));
  nand4  g73(.a(new_n110_), .b(new_n118_), .c(new_n80_), .d(new_n114_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n104_), .d(new_n48_), .O(z17));
  nand2  g75(.a(new_n119_), .b(x25), .O(new_n121_));
  nor3   g76(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n110_), .c(new_n118_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n104_), .d(new_n48_), .O(z18));
endmodule
