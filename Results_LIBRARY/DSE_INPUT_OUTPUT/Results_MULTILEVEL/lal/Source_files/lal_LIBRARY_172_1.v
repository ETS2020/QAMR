...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(new_n48_), .c(new_n63_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nor2   g20(.a(new_n48_), .b(new_n65_), .O(z02));
  inv1   g21(.a(new_n48_), .O(new_n67_));
  nand3  g22(.a(new_n58_), .b(new_n67_), .c(new_n50_), .O(new_n68_));
  ...
  nand3  g42(.a(new_n62_), .b(new_n47_), .c(new_n87_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nor2   g44(.a(x17), .b(x07), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x15), .c(new_n60_), .O(new_n91_));
  nand4  g46(.a(new_n52_), .b(new_n47_), .c(new_n87_), .d(new_n61_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  oai21  g49(.a(x15), .b(x05), .c(x04), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n87_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n67_), .O(z11));
  nor2   g52(.a(new_n53_), .b(new_n52_), .O(new_n98_));
  nand3  g53(.a(new_n54_), .b(x18), .c(x17), .O(new_n99_));
  oai21  g54(.a(new_n98_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n63_), .c(new_n47_), .d(new_n87_), .O(new_n101_));
  ...
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n87_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n95_), .O(z13));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n47_), .O(z14));
  nand2  g68(.a(new_n112_), .b(x22), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n51_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n103_), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(x15), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n114_), .c(new_n110_), .O(z15));
  nor2   g74(.a(new_n117_), .b(new_n81_), .O(new_n120_));
