...
module FAU ( 
  ...
  aoi21  g32(.a(new_n47_), .b(x08), .c(x13), .O(z05));
  ...
  nand2  g42(.a(new_n87_), .b(new_n69_), .O(z09));
  nand4  g43(.a(new_n63_), .b(new_n53_), .c(new_n47_), .d(new_n86_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n63_), .c(new_n47_), .d(new_n86_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n63_), .c(new_n47_), .d(new_n86_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n69_), .O(z12));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n63_), .d(new_n86_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(x15), .b(x13), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(z13));
  aoi21  g61(.a(new_n101_), .b(new_n94_), .c(new_n58_), .O(new_n107_));
  ...
  nand3  g82(.a(new_n127_), .b(new_n50_), .c(new_n119_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n125_), .c(new_n114_), .d(new_n47_), .O(z17));
  oai21  g86(.a(new_n128_), .b(new_n102_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n127_), .c(new_n126_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n114_), .d(new_n47_), .O(z18));
endmodule
