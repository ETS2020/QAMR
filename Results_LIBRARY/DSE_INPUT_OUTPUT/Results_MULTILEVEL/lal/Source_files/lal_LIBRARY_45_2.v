...
module FAU ( 
  ...
  nand4  g40(.a(new_n85_), .b(new_n54_), .c(new_n84_), .d(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n85_), .c(new_n84_), .d(new_n47_), .O(new_n89_));
  ...
  nand4  g52(.a(new_n53_), .b(x19), .c(x18), .d(x17), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n85_), .O(new_n99_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n62_), .d(new_n84_), .O(z14));
  ...
  nand4  g64(.a(new_n109_), .b(new_n106_), .c(new_n62_), .d(new_n84_), .O(z15));
  ...
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n62_), .d(new_n84_), .O(z16));
  nand2  g69(.a(new_n113_), .b(x24), .O(new_n115_));
  inv1   g70(.a(new_n98_), .O(new_n116_));
  nand3  g71(.a(new_n108_), .b(new_n51_), .c(new_n78_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n115_), .c(new_n85_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n84_), .O(z17));
  oai21  g77(.a(new_n117_), .b(new_n98_), .c(x25), .O(new_n123_));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n108_), .c(new_n116_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n123_), .c(new_n85_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n84_), .O(z18));
endmodule
