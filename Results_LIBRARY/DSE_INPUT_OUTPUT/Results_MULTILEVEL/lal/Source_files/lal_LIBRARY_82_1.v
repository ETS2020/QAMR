...
module FAU ( 
  ...
  nand3  g48(.a(new_n56_), .b(x05), .c(x04), .O(new_n94_));
  ...
  nand3  g59(.a(new_n103_), .b(new_n51_), .c(new_n47_), .O(z14));
  nand3  g60(.a(new_n57_), .b(new_n52_), .c(new_n56_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n69_), .O(z15));
