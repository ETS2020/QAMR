...
module FAU ( 
  ...
  nand3  g17(.a(new_n62_), .b(new_n47_), .c(new_n54_), .O(new_n63_));
  nand2  g18(.a(new_n63_), .b(new_n53_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nand2  g20(.a(new_n48_), .b(new_n65_), .O(z02));
  inv1   g21(.a(new_n63_), .O(z03));
  ...
  nor2   g37(.a(x25), .b(x15), .O(new_n83_));
  oai21  g38(.a(new_n82_), .b(new_n79_), .c(new_n83_), .O(z08));
  nand2  g39(.a(new_n54_), .b(new_n50_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n51_), .c(new_n48_), .O(z09));
  nand4  g41(.a(new_n51_), .b(new_n56_), .c(new_n54_), .d(new_n50_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n51_), .c(new_n54_), .d(new_n50_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n51_), .c(new_n54_), .d(new_n50_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  inv1   g51(.a(new_n52_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n99_), .c(new_n97_), .d(new_n54_), .O(z13));
  inv1   g57(.a(x21), .O(new_n103_));
  aoi21  g58(.a(new_n100_), .b(new_n92_), .c(new_n103_), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n92_), .c(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n51_), .c(new_n50_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n54_), .O(new_n108_));
  nand2  g63(.a(x25), .b(x15), .O(new_n109_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n97_), .O(z15));
  inv1   g70(.a(x23), .O(new_n116_));
  aoi21  g71(.a(new_n113_), .b(new_n112_), .c(new_n116_), .O(new_n117_));
  nand4  g72(.a(new_n105_), .b(new_n112_), .c(new_n116_), .d(new_n80_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n51_), .c(new_n50_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n117_), .c(new_n54_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n109_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  inv1   g77(.a(new_n101_), .O(new_n123_));
  nor2   g78(.a(x22), .b(x21), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n79_), .c(new_n116_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n97_), .d(new_n54_), .O(z17));
  ...
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n97_), .d(new_n54_), .O(z18));
endmodule
