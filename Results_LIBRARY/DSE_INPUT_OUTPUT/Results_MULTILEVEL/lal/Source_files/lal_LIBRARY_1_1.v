...
module FAU ( 
  ...
  nand4  g49(.a(new_n94_), .b(new_n63_), .c(new_n47_), .d(new_n51_), .O(new_n95_));
  ...
  nand3  g54(.a(new_n92_), .b(new_n54_), .c(x19), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n99_), .d(new_n47_), .O(z14));
  inv1   g60(.a(new_n97_), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n54_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n63_), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(x22), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(x15), .c(new_n51_), .O(z15));
  ...
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n99_), .d(new_n47_), .O(z16));
  nand2  g70(.a(new_n114_), .b(x24), .O(new_n116_));
  inv1   g71(.a(new_n100_), .O(new_n117_));
  nand3  g72(.a(new_n107_), .b(new_n52_), .c(new_n79_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n99_), .d(new_n47_), .O(z17));
  ...
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n99_), .d(new_n47_), .O(z18));
endmodule
