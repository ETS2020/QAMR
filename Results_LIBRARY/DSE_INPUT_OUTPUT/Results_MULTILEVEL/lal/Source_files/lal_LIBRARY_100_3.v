...
module FAU ( 
  ...
  nand2  g39(.a(new_n58_), .b(new_n54_), .O(new_n85_));
  ...
  aoi21  g43(.a(new_n88_), .b(new_n53_), .c(new_n49_), .O(z08));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n62_), .d(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n65_), .O(z13));
  and2   g63(.a(new_n105_), .b(x21), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n97_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n62_), .c(new_n48_), .O(new_n112_));
  ...
  nor2   g72(.a(new_n117_), .b(new_n102_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(x15), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n115_), .c(new_n62_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n65_), .O(z15));
  nor2   g77(.a(new_n118_), .b(new_n84_), .O(new_n123_));
  inv1   g78(.a(new_n102_), .O(new_n124_));
  nor2   g79(.a(x23), .b(x22), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n110_), .c(new_n124_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n62_), .c(new_n48_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n123_), .c(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n65_), .O(z16));
  nand2  g84(.a(new_n126_), .b(x24), .O(new_n130_));
  inv1   g85(.a(x24), .O(new_n131_));
  nand3  g86(.a(new_n116_), .b(new_n131_), .c(new_n84_), .O(new_n132_));
  inv1   g87(.a(new_n132_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n104_), .c(new_n97_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n130_), .c(new_n62_), .d(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n65_), .O(z17));
  oai21  g92(.a(new_n132_), .b(new_n105_), .c(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n116_), .c(new_n104_), .d(new_n97_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n62_), .d(new_n48_), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(new_n47_), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(new_n65_), .O(z18));
endmodule
