...
module FAU ( 
  ...
  nand2  g18(.a(z15), .b(new_n63_), .O(z02));
  nand3  g19(.a(new_n59_), .b(z15), .c(new_n51_), .O(new_n65_));
  ...
  oai21  g28(.a(x13), .b(x08), .c(z15), .O(z05));
