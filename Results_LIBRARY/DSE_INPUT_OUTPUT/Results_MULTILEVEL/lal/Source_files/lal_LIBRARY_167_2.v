...
module FAU ( 
  ...
  nand2  g57(.a(new_n102_), .b(new_n85_), .O(z13));
  ...
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n62_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n85_), .O(z14));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n64_), .d(new_n85_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand3  g71(.a(new_n105_), .b(new_n116_), .c(new_n80_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n111_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n64_), .d(new_n85_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n98_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n56_), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n112_), .c(new_n122_), .d(new_n93_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n62_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n85_), .O(z17));
  nand2  g82(.a(new_n123_), .b(new_n112_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n100_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n112_), .c(new_n122_), .d(new_n93_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n62_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n85_), .O(z18));
endmodule
