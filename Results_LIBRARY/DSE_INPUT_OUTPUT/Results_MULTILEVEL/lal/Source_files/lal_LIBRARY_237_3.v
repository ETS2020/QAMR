...
module FAU ( 
  ...
  nand3  g33(.a(new_n47_), .b(new_n66_), .c(x06), .O(z07));
  ...
  aoi21  g39(.a(new_n84_), .b(new_n50_), .c(new_n62_), .O(z08));
  ...
  nand3  g75(.a(new_n120_), .b(new_n86_), .c(new_n88_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n118_), .c(new_n87_), .O(new_n122_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n124_), .c(new_n60_), .d(new_n88_), .O(z17));
  nand2  g86(.a(new_n130_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n126_), .c(new_n125_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n60_), .d(new_n88_), .O(z18));
endmodule
