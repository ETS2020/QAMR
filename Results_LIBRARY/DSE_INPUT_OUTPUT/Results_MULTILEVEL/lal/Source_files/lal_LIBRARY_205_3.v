...
module FAU ( 
  ...
  nand3  g32(.a(new_n47_), .b(x14), .c(new_n46_), .O(new_n78_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n50_), .c(new_n81_), .O(z08));
  inv1   g41(.a(x07), .O(new_n87_));
  inv1   g42(.a(x15), .O(new_n88_));
  nand3  g43(.a(new_n63_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n62_), .b(new_n52_), .c(new_n88_), .d(new_n87_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n62_), .c(new_n88_), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n62_), .c(new_n88_), .d(new_n87_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n64_), .d(new_n88_), .O(z13));
  inv1   g59(.a(new_n103_), .O(new_n105_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n62_), .c(new_n88_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n87_), .O(new_n110_));
  nand2  g65(.a(new_n88_), .b(x07), .O(new_n111_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n64_), .O(z15));
  aoi21  g72(.a(new_n115_), .b(new_n114_), .c(new_n82_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n114_), .c(new_n82_), .d(new_n58_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n62_), .c(new_n88_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n87_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n111_), .O(z16));
  nand3  g77(.a(new_n107_), .b(new_n82_), .c(new_n58_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n101_), .c(x24), .O(new_n124_));
  ...
  nand2  g83(.a(new_n128_), .b(new_n105_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n62_), .d(new_n88_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n87_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n111_), .O(z17));
  oai21  g87(.a(new_n127_), .b(new_n103_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n125_), .c(new_n105_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n62_), .d(new_n88_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n87_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n111_), .O(z18));
endmodule
