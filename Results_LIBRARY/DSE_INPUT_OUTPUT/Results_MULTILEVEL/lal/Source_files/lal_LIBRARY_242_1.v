...
module FAU ( 
  ...
  nand3  g27(.a(new_n72_), .b(new_n65_), .c(new_n46_), .O(new_n73_));
  ...
  nand2  g40(.a(new_n61_), .b(new_n53_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n47_), .c(x07), .O(z10));
  ...
  nand4  g55(.a(new_n100_), .b(new_n98_), .c(new_n97_), .d(new_n47_), .O(z13));
  ...
  oai21  g60(.a(new_n105_), .b(x15), .c(new_n50_), .O(z14));
  ...
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n98_), .O(z15));
  ...
  nand2  g71(.a(new_n116_), .b(new_n50_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  nor2   g73(.a(x22), .b(x21), .O(new_n119_));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n119_), .c(new_n99_), .d(new_n91_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n118_), .c(new_n61_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n50_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n119_), .c(new_n99_), .d(new_n91_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n98_), .d(new_n47_), .O(z18));
endmodule
