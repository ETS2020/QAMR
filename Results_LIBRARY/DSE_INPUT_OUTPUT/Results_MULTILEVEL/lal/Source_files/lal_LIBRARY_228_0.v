...
module FAU ( 
  ...
  nor2   g02(.a(x16), .b(x15), .O(new_n48_));
  ...
  nand3  g32(.a(new_n66_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g33(.a(new_n55_), .b(new_n51_), .c(new_n58_), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(x21), .c(x23), .O(new_n80_));
  nor2   g35(.a(new_n48_), .b(x25), .O(new_n81_));
  oai21  g36(.a(new_n80_), .b(new_n49_), .c(new_n81_), .O(z08));
  inv1   g37(.a(x07), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(x05), .c(x04), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x16), .c(x15), .O(z09));
  nand2  g40(.a(x05), .b(x04), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n52_), .c(new_n83_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x16), .c(x15), .O(z10));
  inv1   g43(.a(x15), .O(new_n89_));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n86_), .c(x16), .d(new_n89_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n86_), .c(x16), .d(new_n89_), .O(new_n96_));
  ...
  nand2  g56(.a(new_n101_), .b(x16), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n89_), .O(z13));
  inv1   g58(.a(new_n100_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n57_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n93_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n86_), .c(new_n83_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(x16), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n89_), .O(z14));
  inv1   g65(.a(new_n98_), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n51_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n86_), .c(new_n83_), .O(new_n114_));
  aoi21  g69(.a(new_n107_), .b(x22), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n64_), .c(new_n89_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n106_), .b(new_n111_), .c(new_n118_), .d(new_n58_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(x16), .c(new_n89_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n117_), .c(new_n62_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nand3  g78(.a(new_n112_), .b(new_n49_), .c(new_n118_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n104_), .c(new_n64_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n62_), .d(new_n89_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n100_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n112_), .c(new_n104_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n86_), .d(new_n83_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n89_), .O(z18));
endmodule
