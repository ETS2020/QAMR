...
module FAU ( 
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n61_), .d(new_n48_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n64_), .O(z13));
  nand2  g62(.a(new_n104_), .b(x21), .O(new_n108_));
  nor2   g63(.a(new_n62_), .b(x07), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n96_), .c(x19), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n48_), .O(z14));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n109_), .d(new_n48_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x23), .O(new_n119_));
  nand4  g74(.a(new_n110_), .b(new_n114_), .c(new_n119_), .d(new_n84_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n109_), .d(new_n48_), .O(z16));
  nand2  g76(.a(new_n120_), .b(x24), .O(new_n122_));
  nand3  g77(.a(new_n115_), .b(new_n83_), .c(new_n119_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n103_), .c(new_n96_), .O(new_n125_));
  ...
  oai21  g83(.a(new_n123_), .b(new_n104_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n115_), .c(new_n103_), .d(new_n96_), .O(new_n131_));
