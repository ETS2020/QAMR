...
module FAU ( 
  ...
  nand3  g19(.a(new_n64_), .b(new_n54_), .c(new_n47_), .O(new_n65_));
  nand2  g20(.a(new_n65_), .b(new_n57_), .O(z01));
  inv1   g21(.a(x16), .O(new_n67_));
  nor2   g22(.a(new_n48_), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n50_), .b(new_n53_), .O(new_n69_));
  nand2  g24(.a(new_n64_), .b(new_n47_), .O(new_n70_));
  ...
  oai21  g37(.a(new_n53_), .b(new_n47_), .c(new_n54_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(x15), .O(new_n84_));
  nand4  g39(.a(new_n63_), .b(x24), .c(x22), .d(x21), .O(new_n85_));
  ...
  nor4   g43(.a(new_n52_), .b(x23), .c(x15), .d(x07), .O(z09));
  inv1   g44(.a(x15), .O(new_n90_));
  nand4  g45(.a(new_n52_), .b(new_n47_), .c(new_n59_), .d(new_n90_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n52_), .c(new_n51_), .O(new_n94_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n52_), .c(new_n47_), .d(new_n90_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n52_), .d(new_n51_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n90_), .O(z13));
  inv1   g63(.a(x21), .O(new_n109_));
  aoi21  g64(.a(new_n104_), .b(new_n97_), .c(new_n109_), .O(new_n110_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n52_), .d(new_n51_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n90_), .O(z15));
  nor2   g77(.a(x23), .b(x15), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n52_), .d(new_n51_), .O(z16));
  aoi21  g79(.a(new_n118_), .b(new_n117_), .c(new_n53_), .O(new_n125_));
  inv1   g80(.a(x22), .O(new_n126_));
  nand4  g81(.a(new_n111_), .b(new_n117_), .c(new_n53_), .d(new_n126_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n52_), .c(new_n51_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n125_), .c(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n90_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  aoi21  g86(.a(x05), .b(x04), .c(x07), .O(new_n132_));
  inv1   g87(.a(new_n105_), .O(new_n133_));
  nand4  g88(.a(new_n54_), .b(new_n53_), .c(new_n126_), .d(new_n109_), .O(new_n134_));
  inv1   g89(.a(new_n134_), .O(new_n135_));
  aoi21  g90(.a(new_n135_), .b(new_n133_), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n132_), .c(new_n131_), .d(new_n90_), .O(z18));
endmodule
