...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_,
    ...
    new_n89_, new_n92_, new_n94_, new_n95_, new_n97_, new_n98_, new_n100_,
  ...
  nor4   g45(.a(new_n57_), .b(new_n63_), .c(x15), .d(x07), .O(z09));
  nand2  g46(.a(new_n57_), .b(x19), .O(new_n92_));
  nor4   g47(.a(new_n92_), .b(x17), .c(x15), .d(x07), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n57_), .c(x19), .d(new_n62_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z11));
  nand2  g51(.a(x18), .b(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n57_), .c(new_n56_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(x19), .c(x15), .O(z12));
  inv1   g54(.a(new_n58_), .O(new_n100_));
  nand2  g55(.a(new_n97_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n60_), .b(x18), .c(x17), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nor2   g58(.a(new_n103_), .b(new_n63_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n101_), .c(new_n100_), .d(new_n62_), .O(z13));
  nand2  g60(.a(new_n102_), .b(x21), .O(new_n106_));
  inv1   g61(.a(new_n97_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  aoi21  g63(.a(new_n108_), .b(new_n107_), .c(new_n63_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n106_), .c(new_n100_), .d(new_n62_), .O(z14));
  ...
  nand4  g69(.a(new_n107_), .b(new_n114_), .c(new_n113_), .d(new_n60_), .O(new_n115_));
  and2   g70(.a(new_n115_), .b(x19), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n100_), .d(new_n62_), .O(z15));
  nand2  g72(.a(new_n115_), .b(x23), .O(new_n118_));
  nor3   g73(.a(x23), .b(x22), .c(x21), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n103_), .c(new_n63_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n100_), .d(new_n62_), .O(z16));
  nand2  g76(.a(new_n119_), .b(new_n103_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(x24), .O(new_n123_));
  nand4  g78(.a(new_n68_), .b(new_n52_), .c(new_n114_), .d(new_n113_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n103_), .c(new_n63_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n100_), .d(new_n62_), .O(z17));
  oai21  g82(.a(new_n124_), .b(new_n102_), .c(x25), .O(new_n128_));
  nor2   g83(.a(x23), .b(x22), .O(new_n129_));
  nor2   g84(.a(x25), .b(x24), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n129_), .c(new_n108_), .d(new_n107_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n57_), .d(new_n56_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(x19), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n62_), .O(z18));
endmodule
