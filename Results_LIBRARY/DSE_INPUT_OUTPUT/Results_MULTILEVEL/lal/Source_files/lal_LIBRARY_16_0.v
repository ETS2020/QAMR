...
module FAU ( 
  ...
  aoi21  g22(.a(x11), .b(new_n46_), .c(new_n67_), .O(new_n68_));
  ...
  nand3  g45(.a(x05), .b(x04), .c(x02), .O(new_n91_));
  nor3   g46(.a(new_n91_), .b(x15), .c(x07), .O(z09));
  inv1   g47(.a(x02), .O(new_n93_));
  nand4  g48(.a(new_n61_), .b(new_n53_), .c(new_n67_), .d(new_n50_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(new_n93_), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n61_), .c(new_n50_), .O(new_n97_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n67_), .c(new_n50_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n119_), .b(new_n61_), .c(new_n50_), .O(new_n120_));
  aoi21  g75(.a(new_n113_), .b(x22), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n93_), .c(new_n67_), .O(z15));
  ...
  nand3  g80(.a(new_n125_), .b(new_n61_), .c(new_n50_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n123_), .c(x02), .O(new_n127_));
  ...
  nand4  g90(.a(new_n135_), .b(new_n130_), .c(new_n61_), .d(new_n50_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(x02), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n67_), .O(z17));
  ...
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n61_), .d(new_n50_), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(x02), .O(new_n143_));
  nand2  g98(.a(new_n143_), .b(new_n67_), .O(z18));
endmodule
