...
module FAU ( 
  ...
  nor2   g15(.a(new_n60_), .b(x15), .O(new_n61_));
  ...
  aoi21  g34(.a(new_n53_), .b(new_n49_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n60_), .c(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n58_), .b(new_n50_), .c(new_n60_), .d(new_n87_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n58_), .c(new_n60_), .d(new_n87_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n58_), .c(new_n60_), .d(new_n87_), .O(new_n97_));
  ...
  nor2   g59(.a(new_n104_), .b(x16), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n87_), .O(z13));
  ...
  nand3  g65(.a(new_n110_), .b(new_n58_), .c(new_n84_), .O(new_n111_));
  ...
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n58_), .d(new_n84_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n60_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n87_), .O(z15));
  inv1   g76(.a(x23), .O(new_n122_));
  aoi21  g77(.a(new_n117_), .b(new_n116_), .c(new_n122_), .O(new_n123_));
  nand4  g78(.a(new_n109_), .b(new_n116_), .c(new_n122_), .d(new_n79_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n58_), .c(new_n84_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n123_), .c(new_n60_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n87_), .O(z16));
  nand4  g82(.a(new_n122_), .b(new_n79_), .c(new_n107_), .d(new_n49_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n99_), .c(x24), .O(new_n129_));
  nor2   g84(.a(x22), .b(x21), .O(new_n130_));
  nor2   g85(.a(x24), .b(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n130_), .c(new_n102_), .d(new_n94_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n58_), .d(new_n84_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n60_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n87_), .O(z17));
  nand2  g90(.a(new_n132_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  and2   g92(.a(new_n137_), .b(new_n130_), .O(new_n138_));
  aoi21  g93(.a(new_n138_), .b(new_n104_), .c(x16), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n136_), .c(new_n101_), .d(new_n87_), .O(z18));
  buf    g95(.a(x16), .O(z02));
endmodule
