...
module FAU ( 
  ...
  nand3  g19(.a(new_n58_), .b(new_n64_), .c(new_n50_), .O(new_n65_));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(new_n48_), .O(z08));
  nor2   g38(.a(new_n60_), .b(x15), .O(z09));
  inv1   g39(.a(x15), .O(new_n85_));
  nand2  g40(.a(x05), .b(x04), .O(new_n86_));
  nand4  g41(.a(new_n86_), .b(new_n52_), .c(new_n85_), .d(new_n47_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n86_), .c(new_n85_), .d(new_n47_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n86_), .c(new_n85_), .d(new_n47_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n92_), .b(new_n51_), .c(x19), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n86_), .O(new_n100_));
  ...
  oai21  g66(.a(new_n111_), .b(x07), .c(new_n85_), .O(z15));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n78_), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n104_), .c(new_n107_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n86_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n113_), .c(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n85_), .O(z16));
  ...
  nand2  g79(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n119_), .c(new_n60_), .d(new_n85_), .O(z17));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n121_), .c(new_n120_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n60_), .d(new_n85_), .O(z18));
endmodule
