...
module FAU ( 
  ...
  aoi21  g33(.a(new_n55_), .b(new_n51_), .c(new_n78_), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(x21), .c(x23), .O(new_n80_));
  aoi21  g35(.a(new_n47_), .b(x07), .c(x25), .O(new_n81_));
  oai21  g36(.a(new_n80_), .b(new_n77_), .c(new_n81_), .O(z08));
  nor2   g37(.a(new_n60_), .b(x15), .O(z09));
  inv1   g38(.a(x07), .O(new_n84_));
  nand2  g39(.a(x05), .b(x04), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n84_), .c(x15), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n85_), .c(new_n47_), .d(new_n84_), .O(new_n89_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n85_), .c(new_n47_), .d(new_n84_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n98_), .c(new_n60_), .d(new_n47_), .O(z13));
  ...
  oai21  g59(.a(new_n104_), .b(x07), .c(new_n47_), .O(z14));
  ...
  nand3  g64(.a(new_n109_), .b(new_n106_), .c(new_n85_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n84_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n60_), .d(new_n47_), .O(z16));
  oai21  g73(.a(new_n115_), .b(new_n97_), .c(x24), .O(new_n119_));
  nor2   g74(.a(x20), .b(new_n54_), .O(new_n120_));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n108_), .c(new_n120_), .d(new_n92_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n85_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(z17));
  nand2  g80(.a(new_n121_), .b(new_n108_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n99_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n108_), .c(new_n120_), .d(new_n92_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n85_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n84_), .O(new_n131_));
