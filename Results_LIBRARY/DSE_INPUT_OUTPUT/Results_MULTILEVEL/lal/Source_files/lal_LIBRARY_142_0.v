...
module FAU ( 
  ...
  nand3  g47(.a(new_n51_), .b(new_n61_), .c(new_n50_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(x22), .c(x15), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n51_), .c(new_n50_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x22), .c(x15), .O(z11));
  ...
  nand4  g56(.a(new_n101_), .b(new_n51_), .c(x22), .d(new_n98_), .O(new_n102_));
  nor2   g57(.a(new_n102_), .b(x07), .O(z12));
  nand3  g58(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n99_), .b(new_n59_), .c(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n105_), .c(new_n51_), .d(new_n50_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(x22), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n98_), .O(z13));
  nand2  g64(.a(new_n106_), .b(x21), .O(new_n110_));
  nand4  g65(.a(new_n99_), .b(new_n60_), .c(new_n59_), .d(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(x22), .c(new_n98_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n51_), .d(new_n50_), .O(z14));
  nand3  g69(.a(new_n51_), .b(x17), .c(new_n50_), .O(new_n115_));
  nand4  g70(.a(new_n60_), .b(new_n59_), .c(x19), .d(x18), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n115_), .c(x22), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n98_), .O(z15));
  nand3  g73(.a(new_n51_), .b(new_n57_), .c(new_n50_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(x22), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n98_), .O(z16));
  nand3  g76(.a(new_n51_), .b(new_n52_), .c(new_n50_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(x22), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n98_), .O(z17));
  nand3  g79(.a(new_n51_), .b(new_n53_), .c(new_n50_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x22), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n98_), .O(z18));
endmodule
