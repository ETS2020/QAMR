...
module FAU ( 
  ...
  nand3  g43(.a(new_n64_), .b(new_n47_), .c(new_n88_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n63_), .b(new_n53_), .c(new_n47_), .d(new_n88_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n63_), .c(new_n47_), .d(new_n88_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n63_), .c(new_n47_), .d(new_n88_), .O(new_n99_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n65_), .d(new_n47_), .O(z13));
  aoi21  g60(.a(new_n103_), .b(new_n96_), .c(new_n58_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n96_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n63_), .c(new_n88_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n47_), .O(new_n110_));
  nand2  g65(.a(x15), .b(x00), .O(new_n111_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n63_), .c(new_n88_), .O(new_n116_));
  aoi21  g71(.a(new_n108_), .b(x22), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(x15), .c(new_n111_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n114_), .b(new_n113_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n107_), .b(new_n113_), .c(new_n119_), .d(new_n59_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n63_), .c(new_n88_), .O(new_n122_));
  ...
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n103_), .d(new_n96_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n63_), .d(new_n88_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n111_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n126_), .c(new_n103_), .d(new_n96_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n65_), .d(new_n47_), .O(z18));
endmodule
