...
module FAU ( 
  ...
  aoi21  g50(.a(new_n95_), .b(new_n47_), .c(x07), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nor2   g53(.a(x20), .b(new_n56_), .O(new_n99_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n109_), .d(new_n47_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand4  g71(.a(new_n104_), .b(new_n111_), .c(new_n116_), .d(new_n81_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n110_), .d(new_n47_), .O(z16));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n112_), .c(new_n99_), .d(new_n92_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n61_), .O(new_n121_));
  aoi21  g76(.a(new_n117_), .b(x24), .c(new_n121_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(x15), .c(new_n51_), .O(z17));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n100_), .c(new_n61_), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x25), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x15), .c(new_n51_), .O(z18));
endmodule
