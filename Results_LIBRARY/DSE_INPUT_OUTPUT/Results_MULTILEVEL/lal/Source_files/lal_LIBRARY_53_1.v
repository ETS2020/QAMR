...
module FAU ( 
  ...
  nand4  g42(.a(new_n60_), .b(new_n53_), .c(new_n47_), .d(new_n50_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n60_), .c(new_n47_), .d(new_n50_), .O(new_n91_));
  ...
  nor2   g54(.a(new_n61_), .b(x07), .O(new_n100_));
  ...
  nand2  g80(.a(new_n125_), .b(new_n109_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n123_), .c(new_n60_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n50_), .O(z17));
  ...
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n100_), .d(new_n47_), .O(z18));
endmodule
