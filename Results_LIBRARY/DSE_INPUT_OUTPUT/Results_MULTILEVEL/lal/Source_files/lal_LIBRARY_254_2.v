...
module FAU ( 
  ...
  nor4   g40(.a(new_n63_), .b(x15), .c(x13), .d(x07), .O(z09));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n63_), .b(new_n55_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n48_), .c(x15), .O(z10));
  inv1   g44(.a(x15), .O(new_n90_));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n63_), .c(new_n90_), .d(new_n48_), .O(new_n92_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n63_), .c(new_n90_), .d(new_n48_), .O(new_n98_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n102_), .c(new_n101_), .d(new_n48_), .O(z13));
  ...
  nand3  g65(.a(new_n110_), .b(new_n90_), .c(new_n48_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n108_), .c(new_n102_), .O(z14));
  inv1   g68(.a(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n54_), .c(x19), .O(new_n115_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n63_), .d(new_n87_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n90_), .O(z15));
  inv1   g77(.a(x23), .O(new_n123_));
  aoi21  g78(.a(new_n118_), .b(new_n117_), .c(new_n123_), .O(new_n124_));
  nand4  g79(.a(new_n109_), .b(new_n117_), .c(new_n123_), .d(new_n81_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n63_), .c(new_n87_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n124_), .c(new_n48_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n90_), .O(z16));
  nand4  g83(.a(new_n123_), .b(new_n81_), .c(new_n114_), .d(new_n54_), .O(new_n129_));
  ...
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n63_), .d(new_n87_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n90_), .O(z17));
  ...
  aoi21  g94(.a(new_n139_), .b(new_n105_), .c(x15), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n137_), .c(new_n102_), .d(new_n48_), .O(z18));
endmodule
