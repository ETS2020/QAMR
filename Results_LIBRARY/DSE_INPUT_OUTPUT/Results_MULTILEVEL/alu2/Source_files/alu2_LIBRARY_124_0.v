...
module FAU ( 
  ...
  nor2   g188(.a(new_n79_), .b(new_n78_), .O(new_n205_));
  nor2   g189(.a(x3), .b(x1), .O(new_n206_));
  nor2   g190(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nor2   g191(.a(new_n207_), .b(new_n200_), .O(z2));
  oai21  g192(.a(new_n79_), .b(new_n78_), .c(new_n201_), .O(z3));
  xor2a  g193(.a(x2), .b(x0), .O(new_n210_));
  nor2   g194(.a(new_n210_), .b(new_n207_), .O(new_n211_));
  nand3  g195(.a(new_n211_), .b(x6), .c(new_n30_), .O(new_n212_));
  inv1   g196(.a(new_n212_), .O(new_n213_));
  oai21  g197(.a(x3), .b(new_n78_), .c(x2), .O(new_n214_));
  aoi21  g198(.a(x3), .b(new_n29_), .c(new_n19_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(new_n214_), .c(new_n30_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n213_), .c(new_n23_), .O(new_n217_));
  nand2  g201(.a(new_n17_), .b(new_n78_), .O(new_n218_));
  nand2  g202(.a(new_n39_), .b(new_n30_), .O(new_n219_));
  oai22  g203(.a(new_n219_), .b(new_n218_), .c(x6), .d(new_n30_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n29_), .O(new_n221_));
  nor2   g205(.a(x8), .b(x1), .O(new_n222_));
  oai21  g206(.a(new_n222_), .b(new_n51_), .c(x2), .O(new_n223_));
  aoi21  g207(.a(new_n189_), .b(new_n17_), .c(new_n123_), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n223_), .c(new_n29_), .O(new_n225_));
  nand2  g209(.a(new_n189_), .b(x1), .O(new_n226_));
  inv1   g210(.a(new_n226_), .O(new_n227_));
  oai21  g211(.a(new_n227_), .b(new_n225_), .c(new_n30_), .O(new_n228_));
  nand2  g212(.a(x8), .b(new_n30_), .O(new_n229_));
  nand3  g213(.a(new_n229_), .b(new_n19_), .c(new_n17_), .O(new_n230_));
  nand3  g214(.a(new_n230_), .b(new_n228_), .c(new_n221_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n79_), .O(new_n232_));
  nand2  g216(.a(new_n41_), .b(x0), .O(new_n233_));
  nand3  g217(.a(new_n233_), .b(x4), .c(new_n78_), .O(new_n234_));
  oai22  g218(.a(new_n20_), .b(x2), .c(new_n23_), .d(new_n29_), .O(new_n235_));
  nand4  g219(.a(new_n235_), .b(new_n39_), .c(new_n30_), .d(x1), .O(new_n236_));
  nand4  g220(.a(new_n236_), .b(new_n234_), .c(new_n232_), .d(new_n217_), .O(new_n237_));
  nand2  g221(.a(new_n237_), .b(x5), .O(new_n238_));
  aoi21  g222(.a(x4), .b(x3), .c(x1), .O(new_n239_));
  nand2  g223(.a(new_n41_), .b(x7), .O(new_n240_));
  aoi21  g224(.a(new_n240_), .b(new_n124_), .c(new_n239_), .O(new_n241_));
  nand2  g225(.a(new_n23_), .b(new_n17_), .O(new_n242_));
  aoi21  g226(.a(new_n219_), .b(new_n242_), .c(new_n19_), .O(new_n243_));
  oai21  g227(.a(new_n243_), .b(new_n241_), .c(new_n18_), .O(new_n244_));
  nor2   g228(.a(new_n224_), .b(x4), .O(new_n245_));
  ...
  aoi21  g232(.a(new_n123_), .b(x2), .c(new_n189_), .O(new_n249_));
  nor2   g233(.a(new_n249_), .b(new_n30_), .O(new_n250_));
  oai21  g234(.a(new_n119_), .b(new_n79_), .c(new_n134_), .O(new_n251_));
  ...
  nand3  g239(.a(new_n20_), .b(x3), .c(new_n78_), .O(new_n256_));
  inv1   g240(.a(new_n256_), .O(new_n257_));
  oai21  g241(.a(new_n257_), .b(new_n255_), .c(x4), .O(new_n258_));
  nand3  g242(.a(new_n258_), .b(new_n252_), .c(new_n113_), .O(new_n259_));
  nand2  g243(.a(new_n259_), .b(new_n18_), .O(new_n260_));
  nand3  g244(.a(new_n205_), .b(new_n51_), .c(new_n30_), .O(new_n261_));
  nand3  g245(.a(new_n261_), .b(new_n260_), .c(new_n248_), .O(new_n262_));
  inv1   g246(.a(new_n262_), .O(new_n263_));
  aoi21  g247(.a(new_n263_), .b(new_n238_), .c(new_n64_), .O(z4));
  oai21  g248(.a(new_n210_), .b(new_n207_), .c(new_n201_), .O(z5));
endmodule
