...
module FAU ( 
  ...
  oai21  g155(.a(new_n80_), .b(new_n122_), .c(new_n169_), .O(z3));
  nor2   g156(.a(x2), .b(new_n17_), .O(new_n173_));
  nor2   g157(.a(new_n81_), .b(x0), .O(new_n174_));
  oai22  g158(.a(new_n174_), .b(new_n173_), .c(new_n31_), .d(x1), .O(new_n175_));
  nor2   g159(.a(x3), .b(new_n122_), .O(new_n176_));
  nor3   g160(.a(new_n18_), .b(new_n80_), .c(x1), .O(new_n177_));
  oai22  g161(.a(new_n177_), .b(new_n176_), .c(new_n31_), .d(x0), .O(new_n178_));
  nor2   g162(.a(new_n31_), .b(new_n122_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n38_), .c(x0), .O(new_n180_));
  aoi21  g164(.a(new_n31_), .b(x3), .c(new_n18_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(x1), .c(new_n56_), .O(new_n182_));
  nand4  g166(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n175_), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(x6), .O(new_n184_));
  nand3  g168(.a(new_n44_), .b(x4), .c(x3), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n122_), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(new_n143_), .c(x0), .O(new_n187_));
  inv1   g171(.a(new_n90_), .O(new_n188_));
  aoi22  g172(.a(new_n188_), .b(x2), .c(x7), .d(x3), .O(new_n189_));
  nand3  g173(.a(new_n188_), .b(x3), .c(x2), .O(new_n190_));
  oai21  g174(.a(new_n189_), .b(new_n122_), .c(new_n190_), .O(new_n191_));
  nor4   g175(.a(new_n90_), .b(new_n80_), .c(new_n52_), .d(x1), .O(new_n192_));
  aoi21  g176(.a(new_n191_), .b(new_n44_), .c(new_n192_), .O(new_n193_));
  nand3  g177(.a(new_n193_), .b(new_n187_), .c(new_n184_), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(x9), .c(new_n19_), .O(new_n195_));
  inv1   g179(.a(new_n195_), .O(z4));
  xor2a  g180(.a(x2), .b(x0), .O(new_n197_));
  oai21  g181(.a(new_n197_), .b(new_n170_), .c(new_n169_), .O(z5));
endmodule
