...
module FAU ( 
  ...
  and2   g113(.a(new_n129_), .b(new_n126_), .O(z2));
  nand2  g114(.a(new_n127_), .b(new_n126_), .O(z3));
  xor2a  g115(.a(x2), .b(x0), .O(new_n132_));
  aoi21  g116(.a(new_n128_), .b(new_n127_), .c(new_n132_), .O(new_n133_));
  nand3  g117(.a(new_n133_), .b(x6), .c(new_n20_), .O(new_n134_));
  inv1   g118(.a(new_n134_), .O(new_n135_));
  oai21  g119(.a(x3), .b(new_n63_), .c(x2), .O(new_n136_));
  aoi21  g120(.a(x3), .b(new_n36_), .c(new_n31_), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n136_), .c(new_n20_), .O(new_n138_));
  oai21  g122(.a(new_n138_), .b(new_n135_), .c(new_n19_), .O(new_n139_));
  nand3  g123(.a(new_n129_), .b(x6), .c(new_n36_), .O(new_n140_));
  oai21  g124(.a(x6), .b(new_n63_), .c(new_n140_), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n24_), .O(new_n142_));
  oai21  g126(.a(x7), .b(new_n31_), .c(x1), .O(new_n143_));
  aoi21  g127(.a(x2), .b(new_n63_), .c(new_n31_), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(x3), .c(new_n143_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(x0), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(new_n142_), .c(x8), .O(new_n147_));
  nand2  g131(.a(x3), .b(new_n63_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(x6), .c(new_n24_), .O(new_n149_));
  nand2  g133(.a(new_n31_), .b(new_n64_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n24_), .c(new_n149_), .O(new_n151_));
  nand2  g135(.a(new_n151_), .b(x0), .O(new_n152_));
  nor2   g136(.a(new_n31_), .b(x3), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n65_), .c(x1), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(new_n152_), .c(new_n19_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n147_), .c(new_n20_), .O(new_n156_));
  aoi21  g140(.a(new_n31_), .b(new_n64_), .c(new_n63_), .O(new_n157_));
  nand3  g141(.a(new_n127_), .b(new_n31_), .c(new_n24_), .O(new_n158_));
  oai21  g142(.a(new_n157_), .b(x0), .c(new_n158_), .O(new_n159_));
  nand4  g143(.a(new_n44_), .b(new_n31_), .c(new_n64_), .d(new_n24_), .O(new_n160_));
  inv1   g144(.a(new_n160_), .O(new_n161_));
  aoi21  g145(.a(new_n159_), .b(x4), .c(new_n161_), .O(new_n162_));
  nand3  g146(.a(new_n162_), .b(new_n156_), .c(new_n139_), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(x9), .c(x5), .O(new_n164_));
  inv1   g148(.a(new_n164_), .O(z4));
  nand2  g149(.a(new_n133_), .b(new_n126_), .O(new_n166_));
