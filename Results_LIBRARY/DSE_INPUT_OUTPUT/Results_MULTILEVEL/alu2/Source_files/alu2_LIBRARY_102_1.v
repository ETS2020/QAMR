...
module FAU ( 
  ...
  inv1   g109(.a(new_n62_), .O(new_n126_));
  nor2   g110(.a(x3), .b(x1), .O(new_n127_));
  nor2   g111(.a(new_n67_), .b(new_n94_), .O(new_n128_));
  nor2   g112(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(new_n126_), .O(z2));
  nor3   g114(.a(new_n62_), .b(new_n67_), .c(new_n94_), .O(z3));
  nand2  g115(.a(new_n19_), .b(x8), .O(new_n132_));
  nand3  g116(.a(new_n132_), .b(x3), .c(x1), .O(new_n133_));
  nand3  g117(.a(new_n127_), .b(new_n18_), .c(x6), .O(new_n134_));
  xor2a  g118(.a(x2), .b(x0), .O(new_n135_));
  aoi21  g119(.a(new_n134_), .b(new_n133_), .c(new_n135_), .O(new_n136_));
  nand3  g120(.a(x2), .b(new_n94_), .c(x0), .O(new_n137_));
  nor4   g121(.a(new_n137_), .b(x8), .c(new_n23_), .d(x3), .O(new_n138_));
  oai21  g122(.a(new_n138_), .b(new_n136_), .c(x5), .O(new_n139_));
  oai21  g123(.a(x2), .b(new_n42_), .c(x6), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(x3), .O(new_n141_));
  nand2  g125(.a(x6), .b(new_n67_), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n141_), .c(new_n94_), .O(new_n143_));
  xor2a  g127(.a(x6), .b(x2), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(x0), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n69_), .c(x3), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n143_), .c(x7), .O(new_n147_));
  oai22  g131(.a(x3), .b(new_n42_), .c(x2), .d(new_n94_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n34_), .c(new_n23_), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(new_n147_), .c(new_n139_), .O(new_n150_));
  nand2  g134(.a(new_n150_), .b(new_n33_), .O(new_n151_));
  aoi21  g135(.a(new_n67_), .b(x1), .c(new_n17_), .O(new_n152_));
  oai21  g136(.a(new_n67_), .b(x0), .c(x6), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n152_), .c(new_n18_), .O(new_n154_));
  oai21  g138(.a(x6), .b(x3), .c(x1), .O(new_n155_));
  nor2   g139(.a(new_n128_), .b(x6), .O(new_n156_));
  aoi22  g140(.a(new_n156_), .b(new_n17_), .c(new_n155_), .d(new_n42_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand4  g142(.a(new_n34_), .b(new_n23_), .c(new_n67_), .d(new_n17_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(x5), .O(new_n160_));
  aoi21  g144(.a(new_n158_), .b(x4), .c(new_n160_), .O(new_n161_));
  aoi21  g145(.a(new_n161_), .b(new_n151_), .c(new_n27_), .O(z4));
  nor2   g146(.a(new_n135_), .b(new_n129_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n126_), .O(new_n164_));
