...
module FAU ( 
  ...
  oai22  g063(.a(new_n79_), .b(new_n18_), .c(x8), .d(x2), .O(new_n80_));
  nand2  g064(.a(new_n80_), .b(x3), .O(new_n81_));
  inv1   g065(.a(x3), .O(new_n82_));
  oai21  g066(.a(new_n17_), .b(new_n21_), .c(x0), .O(new_n83_));
  ...
  nand2  g071(.a(new_n30_), .b(new_n18_), .O(new_n88_));
  ...
  nor2   g093(.a(new_n30_), .b(new_n21_), .O(new_n110_));
  nand2  g094(.a(new_n110_), .b(new_n82_), .O(new_n111_));
  nand3  g095(.a(new_n101_), .b(x3), .c(new_n52_), .O(new_n112_));
  aoi21  g096(.a(new_n112_), .b(new_n111_), .c(new_n18_), .O(new_n113_));
  nand3  g097(.a(new_n31_), .b(new_n82_), .c(x2), .O(new_n114_));
  nand2  g098(.a(new_n96_), .b(x3), .O(new_n115_));
  aoi21  g099(.a(new_n115_), .b(new_n114_), .c(x8), .O(new_n116_));
  oai21  g100(.a(new_n116_), .b(new_n113_), .c(new_n28_), .O(new_n117_));
  nand3  g101(.a(new_n21_), .b(x3), .c(new_n52_), .O(new_n118_));
  ...
  nand3  g106(.a(new_n86_), .b(x6), .c(new_n28_), .O(new_n123_));
  ...
  nand4  g113(.a(new_n129_), .b(new_n21_), .c(new_n28_), .d(x0), .O(new_n130_));
  aoi21  g114(.a(new_n130_), .b(new_n128_), .c(x3), .O(new_n131_));
  aoi21  g115(.a(new_n122_), .b(x4), .c(new_n131_), .O(new_n132_));
  aoi21  g116(.a(new_n132_), .b(new_n109_), .c(new_n37_), .O(new_n133_));
  oai21  g117(.a(new_n133_), .b(new_n100_), .c(new_n78_), .O(new_n134_));
  nand3  g118(.a(new_n53_), .b(new_n21_), .c(x0), .O(new_n135_));
  ...
  oai21  g126(.a(new_n142_), .b(new_n52_), .c(new_n136_), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(x6), .O(new_n144_));
  aoi21  g128(.a(new_n92_), .b(new_n52_), .c(new_n37_), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n144_), .c(new_n28_), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n141_), .c(x7), .O(new_n147_));
  nand2  g131(.a(new_n21_), .b(new_n28_), .O(new_n148_));
  ...
  nand2  g137(.a(new_n28_), .b(new_n18_), .O(new_n154_));
  ...
  nand4  g155(.a(new_n30_), .b(x4), .c(new_n82_), .d(x2), .O(new_n172_));
  ...
  nand3  g161(.a(new_n177_), .b(new_n176_), .c(new_n18_), .O(new_n178_));
  ...
  nand2  g165(.a(new_n181_), .b(new_n82_), .O(new_n182_));
  ...
  nand3  g182(.a(new_n76_), .b(new_n82_), .c(new_n78_), .O(new_n199_));
  ...
  oai21  g192(.a(new_n208_), .b(new_n78_), .c(new_n199_), .O(z2));
  nand2  g193(.a(x3), .b(x1), .O(new_n210_));
  nand2  g194(.a(new_n210_), .b(new_n76_), .O(z3));
  nand2  g195(.a(new_n82_), .b(new_n78_), .O(new_n212_));
  xor2a  g196(.a(x2), .b(x0), .O(new_n213_));
  aoi21  g197(.a(new_n212_), .b(new_n210_), .c(new_n213_), .O(new_n214_));
  nand3  g198(.a(new_n214_), .b(x6), .c(new_n25_), .O(new_n215_));
  inv1   g199(.a(new_n215_), .O(new_n216_));
  oai21  g200(.a(x3), .b(new_n78_), .c(x2), .O(new_n217_));
  aoi21  g201(.a(x3), .b(new_n18_), .c(new_n21_), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(new_n217_), .c(new_n25_), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n216_), .c(new_n30_), .O(new_n220_));
  nand2  g204(.a(new_n52_), .b(new_n78_), .O(new_n221_));
  nand2  g205(.a(new_n17_), .b(new_n25_), .O(new_n222_));
  oai21  g206(.a(new_n222_), .b(new_n221_), .c(new_n22_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(new_n18_), .O(new_n224_));
  nor2   g208(.a(new_n30_), .b(x6), .O(new_n225_));
  nor2   g209(.a(x8), .b(x1), .O(new_n226_));
  oai21  g210(.a(new_n226_), .b(new_n225_), .c(x2), .O(new_n227_));
  aoi21  g211(.a(new_n110_), .b(new_n52_), .c(new_n92_), .O(new_n228_));
  aoi21  g212(.a(new_n228_), .b(new_n227_), .c(new_n18_), .O(new_n229_));
  nand2  g213(.a(new_n110_), .b(x1), .O(new_n230_));
  inv1   g214(.a(new_n230_), .O(new_n231_));
  oai21  g215(.a(new_n231_), .b(new_n229_), .c(new_n25_), .O(new_n232_));
  nand3  g216(.a(new_n142_), .b(new_n21_), .c(new_n52_), .O(new_n233_));
  nand3  g217(.a(new_n233_), .b(new_n232_), .c(new_n224_), .O(new_n234_));
  nand2  g218(.a(new_n234_), .b(new_n82_), .O(new_n235_));
  nand2  g219(.a(new_n125_), .b(x0), .O(new_n236_));
  nand3  g220(.a(new_n236_), .b(x4), .c(new_n78_), .O(new_n237_));
  oai22  g221(.a(new_n96_), .b(x2), .c(new_n30_), .d(new_n18_), .O(new_n238_));
  nand4  g222(.a(new_n238_), .b(new_n17_), .c(new_n25_), .d(x1), .O(new_n239_));
  nand4  g223(.a(new_n239_), .b(new_n237_), .c(new_n235_), .d(new_n220_), .O(new_n240_));
  aoi21  g224(.a(x4), .b(x3), .c(x1), .O(new_n241_));
  aoi21  g225(.a(new_n125_), .b(x7), .c(new_n92_), .O(new_n242_));
  nor2   g226(.a(new_n242_), .b(new_n241_), .O(new_n243_));
  aoi21  g227(.a(new_n222_), .b(new_n86_), .c(new_n21_), .O(new_n244_));
  oai21  g228(.a(new_n244_), .b(new_n243_), .c(new_n28_), .O(new_n245_));
  nor2   g229(.a(new_n228_), .b(x4), .O(new_n246_));
  ...
  aoi21  g233(.a(new_n92_), .b(x2), .c(new_n110_), .O(new_n250_));
  nor2   g234(.a(new_n250_), .b(new_n25_), .O(new_n251_));
  nand2  g235(.a(new_n225_), .b(x3), .O(new_n252_));
  nand2  g236(.a(new_n252_), .b(new_n97_), .O(new_n253_));
  oai21  g237(.a(new_n253_), .b(new_n251_), .c(x1), .O(new_n254_));
  nand2  g238(.a(new_n96_), .b(new_n18_), .O(new_n255_));
  nand2  g239(.a(new_n17_), .b(x3), .O(new_n256_));
  aoi21  g240(.a(new_n256_), .b(new_n255_), .c(new_n52_), .O(new_n257_));
  nand3  g241(.a(new_n96_), .b(x3), .c(new_n78_), .O(new_n258_));
  inv1   g242(.a(new_n258_), .O(new_n259_));
  oai21  g243(.a(new_n259_), .b(new_n257_), .c(x4), .O(new_n260_));
  nand3  g244(.a(new_n17_), .b(new_n30_), .c(x6), .O(new_n261_));
  nand3  g245(.a(new_n261_), .b(new_n260_), .c(new_n254_), .O(new_n262_));
  nand2  g246(.a(new_n262_), .b(new_n28_), .O(new_n263_));
  inv1   g247(.a(new_n210_), .O(new_n264_));
  nand3  g248(.a(new_n225_), .b(new_n264_), .c(new_n25_), .O(new_n265_));
  nand3  g249(.a(new_n265_), .b(new_n263_), .c(new_n249_), .O(new_n266_));
  aoi21  g250(.a(new_n240_), .b(x5), .c(new_n266_), .O(new_n267_));
  nor2   g251(.a(new_n267_), .b(new_n37_), .O(z4));
  inv1   g252(.a(new_n214_), .O(new_n269_));
  nand2  g253(.a(new_n269_), .b(new_n76_), .O(z5));
endmodule
