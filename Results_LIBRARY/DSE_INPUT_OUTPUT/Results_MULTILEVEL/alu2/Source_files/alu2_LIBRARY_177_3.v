// Benchmark "FAU" written by ABC on Thu Aug 13 18:22:04 2020
...
module FAU ( 
  ...
  nand2  g055(.a(x9), .b(x7), .O(new_n72_));
  nand2  g056(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  aoi21  g057(.a(new_n70_), .b(x0), .c(new_n73_), .O(new_n74_));
  nand3  g058(.a(new_n74_), .b(new_n61_), .c(new_n50_), .O(z0));
  inv1   g059(.a(x1), .O(new_n76_));
  nor2   g060(.a(x3), .b(new_n76_), .O(new_n77_));
  nand3  g061(.a(new_n30_), .b(x3), .c(new_n76_), .O(new_n78_));
  inv1   g062(.a(new_n78_), .O(new_n79_));
  oai21  g063(.a(new_n79_), .b(new_n77_), .c(x7), .O(new_n80_));
  inv1   g064(.a(x3), .O(new_n81_));
  oai21  g065(.a(x7), .b(x3), .c(x4), .O(new_n82_));
  aoi22  g066(.a(new_n82_), .b(new_n76_), .c(x6), .d(new_n81_), .O(new_n83_));
  aoi21  g067(.a(new_n83_), .b(new_n80_), .c(x9), .O(new_n84_));
  nand2  g068(.a(new_n81_), .b(new_n18_), .O(new_n85_));
  aoi21  g069(.a(new_n85_), .b(x4), .c(x0), .O(new_n86_));
  nand2  g070(.a(new_n81_), .b(x0), .O(new_n87_));
  nand2  g071(.a(new_n29_), .b(x3), .O(new_n88_));
  aoi21  g072(.a(new_n88_), .b(new_n87_), .c(new_n18_), .O(new_n89_));
  oai21  g073(.a(new_n89_), .b(new_n86_), .c(x8), .O(new_n90_));
  nand3  g074(.a(new_n21_), .b(x4), .c(x3), .O(new_n91_));
  aoi21  g075(.a(new_n91_), .b(new_n90_), .c(new_n30_), .O(new_n92_));
  nand2  g076(.a(x3), .b(new_n18_), .O(new_n93_));
  nand2  g077(.a(new_n26_), .b(x4), .O(new_n94_));
  oai22  g078(.a(new_n94_), .b(new_n93_), .c(new_n31_), .d(x3), .O(new_n95_));
  nand2  g079(.a(new_n95_), .b(x0), .O(new_n96_));
  nand2  g080(.a(new_n30_), .b(new_n81_), .O(new_n97_));
  nor2   g081(.a(x2), .b(x0), .O(new_n98_));
  nand3  g082(.a(new_n98_), .b(x9), .c(x3), .O(new_n99_));
  oai21  g083(.a(new_n97_), .b(new_n18_), .c(new_n99_), .O(new_n100_));
  nand3  g084(.a(new_n100_), .b(new_n25_), .c(x4), .O(new_n101_));
  nand2  g085(.a(new_n101_), .b(new_n96_), .O(new_n102_));
  oai21  g086(.a(new_n102_), .b(new_n92_), .c(new_n76_), .O(new_n103_));
  nand3  g087(.a(x6), .b(x4), .c(x2), .O(new_n104_));
  nand2  g088(.a(new_n62_), .b(new_n18_), .O(new_n105_));
  aoi21  g089(.a(new_n105_), .b(new_n104_), .c(x0), .O(new_n106_));
  nor2   g090(.a(x8), .b(new_n30_), .O(new_n107_));
  oai21  g091(.a(new_n107_), .b(new_n106_), .c(new_n81_), .O(new_n108_));
  nand4  g092(.a(new_n62_), .b(new_n29_), .c(x3), .d(new_n17_), .O(new_n109_));
  nand2  g093(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g094(.a(new_n110_), .b(x1), .O(new_n111_));
  aoi21  g095(.a(new_n111_), .b(new_n103_), .c(x7), .O(new_n112_));
  oai21  g096(.a(new_n112_), .b(new_n84_), .c(new_n19_), .O(new_n113_));
  oai21  g097(.a(new_n30_), .b(x4), .c(new_n55_), .O(new_n114_));
  nand3  g098(.a(new_n114_), .b(x5), .c(x3), .O(new_n115_));
  oai21  g099(.a(new_n29_), .b(x3), .c(new_n55_), .O(new_n116_));
  nand2  g100(.a(new_n116_), .b(x6), .O(new_n117_));
  aoi21  g101(.a(new_n117_), .b(new_n115_), .c(x9), .O(new_n118_));
  nand2  g102(.a(new_n107_), .b(new_n81_), .O(new_n119_));
  nand3  g103(.a(new_n98_), .b(new_n62_), .c(x3), .O(new_n120_));
  nand2  g104(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g105(.a(new_n121_), .b(x4), .O(new_n122_));
  nand2  g106(.a(x5), .b(x2), .O(new_n123_));
  aoi21  g107(.a(new_n123_), .b(new_n25_), .c(x4), .O(new_n124_));
  aoi21  g108(.a(new_n19_), .b(x2), .c(new_n25_), .O(new_n125_));
  oai21  g109(.a(new_n125_), .b(new_n124_), .c(new_n17_), .O(new_n126_));
  nand2  g110(.a(x4), .b(new_n17_), .O(new_n127_));
  nand3  g111(.a(new_n127_), .b(x8), .c(x2), .O(new_n128_));
  aoi21  g112(.a(new_n128_), .b(new_n126_), .c(new_n81_), .O(new_n129_));
  oai21  g113(.a(new_n25_), .b(new_n18_), .c(x0), .O(new_n130_));
  nor2   g114(.a(x8), .b(x2), .O(new_n131_));
  inv1   g115(.a(new_n131_), .O(new_n132_));
  aoi21  g116(.a(new_n132_), .b(new_n130_), .c(new_n30_), .O(new_n133_));
  nor2   g117(.a(new_n18_), .b(x0), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(new_n30_), .c(new_n29_), .O(new_n135_));
  inv1   g119(.a(new_n135_), .O(new_n136_));
  oai21  g120(.a(new_n136_), .b(new_n133_), .c(new_n81_), .O(new_n137_));
  oai21  g121(.a(new_n25_), .b(x6), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g125(.a(new_n30_), .b(x2), .c(x8), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(x0), .c(new_n131_), .O(new_n143_));
  nand3  g127(.a(new_n81_), .b(x2), .c(new_n17_), .O(new_n144_));
  oai21  g128(.a(new_n143_), .b(new_n81_), .c(new_n144_), .O(new_n145_));
  oai21  g129(.a(x2), .b(new_n17_), .c(new_n88_), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(new_n97_), .c(new_n25_), .O(new_n147_));
  aoi21  g131(.a(new_n145_), .b(new_n29_), .c(new_n147_), .O(new_n148_));
  nand4  g132(.a(new_n134_), .b(x8), .c(x4), .d(x3), .O(new_n149_));
  oai21  g133(.a(new_n148_), .b(new_n19_), .c(new_n149_), .O(new_n150_));
  nand4  g134(.a(new_n25_), .b(new_n30_), .c(x3), .d(x0), .O(new_n151_));
  nand2  g135(.a(new_n56_), .b(new_n81_), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n151_), .c(x4), .O(new_n153_));
  aoi21  g137(.a(new_n150_), .b(x9), .c(new_n153_), .O(new_n154_));
  oai21  g138(.a(new_n25_), .b(new_n81_), .c(new_n19_), .O(new_n155_));
  nand4  g139(.a(new_n155_), .b(x9), .c(new_n30_), .d(x4), .O(new_n156_));
  oai21  g140(.a(new_n154_), .b(x1), .c(new_n156_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n55_), .O(new_n158_));
  oai21  g142(.a(x6), .b(x1), .c(new_n55_), .O(new_n159_));
  nand4  g143(.a(new_n159_), .b(new_n20_), .c(new_n29_), .d(x3), .O(new_n160_));
  nand4  g144(.a(new_n160_), .b(new_n158_), .c(new_n141_), .d(new_n113_), .O(z1));
  xor2a  g145(.a(x3), .b(x1), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n72_), .O(z2));
  nand3  g147(.a(new_n72_), .b(x3), .c(x1), .O(new_n164_));
  inv1   g148(.a(new_n164_), .O(z3));
  nor2   g149(.a(new_n18_), .b(new_n17_), .O(new_n166_));
  nor2   g150(.a(new_n166_), .b(new_n98_), .O(new_n167_));
  nor2   g151(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(x6), .O(new_n169_));
  aoi21  g153(.a(new_n18_), .b(x0), .c(new_n77_), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n30_), .c(x4), .O(new_n171_));
  oai21  g155(.a(new_n81_), .b(x1), .c(new_n18_), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(new_n87_), .O(new_n173_));
  ...
  oai22  g160(.a(x8), .b(new_n76_), .c(new_n30_), .d(x0), .O(new_n177_));
  ...
  oai21  g166(.a(new_n77_), .b(new_n25_), .c(x6), .O(new_n183_));
  ...
  oai21  g176(.a(new_n167_), .b(new_n162_), .c(new_n72_), .O(z5));
endmodule
