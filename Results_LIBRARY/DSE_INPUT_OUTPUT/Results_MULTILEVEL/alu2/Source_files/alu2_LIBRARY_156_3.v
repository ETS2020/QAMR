...
module FAU ( 
  ...
  nand2  g136(.a(new_n150_), .b(new_n148_), .O(z3));
  xnor2a g137(.a(x2), .b(x0), .O(new_n154_));
  nand2  g138(.a(new_n42_), .b(x8), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n68_), .c(new_n72_), .O(new_n156_));
  oai21  g140(.a(new_n150_), .b(new_n42_), .c(new_n156_), .O(new_n157_));
  nand3  g141(.a(new_n157_), .b(new_n154_), .c(new_n17_), .O(new_n158_));
  nand3  g142(.a(x7), .b(x6), .c(x0), .O(new_n159_));
  oai21  g143(.a(x8), .b(x6), .c(new_n159_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(new_n23_), .O(new_n161_));
  nand3  g145(.a(new_n99_), .b(new_n18_), .c(x0), .O(new_n162_));
  nand3  g146(.a(x7), .b(x6), .c(x1), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(new_n162_), .c(new_n161_), .O(new_n164_));
  nand2  g148(.a(new_n164_), .b(new_n68_), .O(new_n165_));
  nand4  g149(.a(new_n42_), .b(new_n24_), .c(new_n23_), .d(x1), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(new_n165_), .c(new_n158_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(x5), .O(new_n168_));
  nand2  g152(.a(x5), .b(x2), .O(new_n169_));
  nand3  g153(.a(new_n169_), .b(x7), .c(x1), .O(new_n170_));
  oai21  g154(.a(new_n54_), .b(new_n24_), .c(new_n19_), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(x6), .O(new_n173_));
  oai21  g157(.a(new_n41_), .b(x8), .c(new_n100_), .O(new_n174_));
  nand2  g158(.a(new_n174_), .b(x1), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n173_), .c(new_n35_), .O(new_n176_));
  nand3  g160(.a(new_n41_), .b(new_n19_), .c(new_n68_), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(new_n137_), .c(new_n72_), .O(new_n178_));
  nand4  g162(.a(new_n24_), .b(new_n31_), .c(x6), .d(new_n19_), .O(new_n179_));
  nand2  g163(.a(new_n179_), .b(new_n17_), .O(new_n180_));
  nor3   g164(.a(new_n180_), .b(new_n178_), .c(new_n176_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n168_), .c(new_n28_), .O(z4));
  inv1   g166(.a(new_n151_), .O(new_n183_));
  nand3  g167(.a(new_n154_), .b(new_n183_), .c(new_n148_), .O(new_n184_));
