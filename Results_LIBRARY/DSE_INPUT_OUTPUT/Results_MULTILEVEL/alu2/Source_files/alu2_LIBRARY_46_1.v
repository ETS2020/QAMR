...
module FAU ( 
  ...
  nor2   g111(.a(new_n19_), .b(new_n18_), .O(new_n128_));
  inv1   g112(.a(new_n128_), .O(new_n129_));
  nand3  g113(.a(new_n129_), .b(new_n127_), .c(new_n125_), .O(new_n130_));
  nand2  g114(.a(new_n128_), .b(x4), .O(new_n131_));
  inv1   g115(.a(new_n131_), .O(new_n132_));
  aoi21  g116(.a(new_n130_), .b(new_n30_), .c(new_n132_), .O(new_n133_));
  nand3  g117(.a(x7), .b(new_n35_), .c(x3), .O(new_n134_));
  oai21  g118(.a(new_n52_), .b(x3), .c(new_n134_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(new_n30_), .O(new_n136_));
  oai21  g120(.a(new_n133_), .b(new_n63_), .c(new_n136_), .O(new_n137_));
  nor2   g121(.a(new_n137_), .b(new_n124_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n105_), .O(z1));
  nor2   g123(.a(new_n30_), .b(x0), .O(new_n140_));
  inv1   g124(.a(new_n140_), .O(new_n141_));
  xnor2a g125(.a(x3), .b(x1), .O(new_n142_));
  inv1   g126(.a(new_n142_), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n141_), .O(z2));
  nor3   g128(.a(new_n140_), .b(new_n62_), .c(new_n63_), .O(z3));
  nand3  g129(.a(new_n142_), .b(x6), .c(x0), .O(new_n146_));
  oai21  g130(.a(x3), .b(new_n63_), .c(x4), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n19_), .O(new_n149_));
  nand4  g133(.a(x7), .b(new_n18_), .c(new_n35_), .d(new_n62_), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n149_), .c(new_n17_), .O(new_n151_));
  nand2  g135(.a(new_n18_), .b(x4), .O(new_n152_));
  nand2  g136(.a(new_n128_), .b(new_n35_), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(new_n152_), .c(x3), .O(new_n154_));
  nand3  g138(.a(new_n128_), .b(new_n35_), .c(x1), .O(new_n155_));
  oai21  g139(.a(new_n152_), .b(x1), .c(new_n155_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n154_), .c(new_n17_), .O(new_n157_));
  nand2  g141(.a(new_n19_), .b(x6), .O(new_n158_));
  nand4  g142(.a(new_n158_), .b(new_n27_), .c(new_n35_), .d(new_n62_), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n157_), .c(new_n78_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n151_), .c(x5), .O(new_n161_));
  nand2  g145(.a(new_n86_), .b(x8), .O(new_n162_));
  oai21  g146(.a(new_n35_), .b(new_n62_), .c(new_n63_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nor2   g148(.a(new_n19_), .b(new_n62_), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n112_), .c(x1), .O(new_n166_));
  oai21  g150(.a(x7), .b(new_n63_), .c(x4), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(x8), .c(new_n62_), .O(new_n168_));
  oai21  g152(.a(new_n27_), .b(new_n17_), .c(new_n19_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n118_), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n168_), .c(x6), .O(new_n171_));
  nand3  g155(.a(new_n171_), .b(new_n166_), .c(new_n164_), .O(new_n172_));
  oai21  g156(.a(new_n165_), .b(new_n27_), .c(new_n18_), .O(new_n173_));
  oai21  g157(.a(new_n112_), .b(new_n27_), .c(x7), .O(new_n174_));
  nand2  g158(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(new_n35_), .c(x1), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(x0), .O(new_n177_));
  aoi21  g161(.a(new_n172_), .b(new_n23_), .c(new_n177_), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n161_), .c(new_n30_), .O(z4));
  nand2  g163(.a(x2), .b(x0), .O(new_n180_));
  nand3  g164(.a(new_n30_), .b(new_n17_), .c(new_n49_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n180_), .c(new_n143_), .O(z5));
endmodule
