...
module FAU ( 
  ...
  oai21  g131(.a(new_n84_), .b(new_n104_), .c(new_n67_), .O(z3));
  nor2   g132(.a(x3), .b(new_n104_), .O(new_n149_));
  nor2   g133(.a(new_n111_), .b(x1), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n149_), .c(new_n79_), .O(new_n151_));
  nor2   g135(.a(x2), .b(new_n42_), .O(new_n152_));
  nor2   g136(.a(new_n44_), .b(x0), .O(new_n153_));
  oai22  g137(.a(new_n153_), .b(new_n152_), .c(new_n32_), .d(x1), .O(new_n154_));
  aoi21  g138(.a(x4), .b(new_n84_), .c(new_n42_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n32_), .c(new_n23_), .O(new_n156_));
  nand2  g140(.a(new_n79_), .b(x3), .O(new_n157_));
  nand3  g141(.a(new_n157_), .b(x4), .c(x1), .O(new_n158_));
  nand4  g142(.a(new_n158_), .b(new_n156_), .c(new_n154_), .d(new_n151_), .O(new_n159_));
  ...
  oai21  g155(.a(new_n171_), .b(new_n146_), .c(new_n67_), .O(z5));
endmodule
