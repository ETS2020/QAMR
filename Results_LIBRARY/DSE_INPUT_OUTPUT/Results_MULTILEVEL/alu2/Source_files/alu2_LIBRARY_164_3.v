...
module FAU ( 
  ...
  nand3  g146(.a(new_n67_), .b(x3), .c(x1), .O(new_n163_));
  inv1   g147(.a(new_n163_), .O(z3));
  nor2   g148(.a(x3), .b(new_n110_), .O(new_n165_));
  nor3   g149(.a(new_n18_), .b(new_n69_), .c(x1), .O(new_n166_));
  oai22  g150(.a(new_n166_), .b(new_n165_), .c(new_n32_), .d(x0), .O(new_n167_));
  nor2   g151(.a(x2), .b(new_n43_), .O(new_n168_));
  nor2   g152(.a(new_n45_), .b(x0), .O(new_n169_));
  oai22  g153(.a(new_n169_), .b(new_n168_), .c(new_n32_), .d(x1), .O(new_n170_));
  aoi21  g154(.a(x4), .b(new_n69_), .c(new_n43_), .O(new_n171_));
  oai21  g155(.a(new_n171_), .b(new_n32_), .c(new_n23_), .O(new_n172_));
  oai21  g156(.a(new_n32_), .b(x0), .c(x3), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(x4), .c(x1), .O(new_n174_));
  nand4  g158(.a(new_n174_), .b(new_n172_), .c(new_n170_), .d(new_n167_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x6), .O(new_n176_));
  oai21  g160(.a(new_n116_), .b(x1), .c(new_n132_), .O(new_n177_));
  nand3  g161(.a(x7), .b(x3), .c(x1), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n177_), .c(new_n43_), .O(new_n179_));
  aoi21  g163(.a(new_n111_), .b(new_n51_), .c(new_n110_), .O(new_n180_));
  nand3  g164(.a(new_n50_), .b(x3), .c(x2), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n19_), .O(new_n182_));
  nor3   g166(.a(new_n182_), .b(new_n180_), .c(new_n179_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n176_), .c(new_n35_), .O(z4));
  xor2a  g168(.a(x2), .b(x0), .O(new_n185_));
  oai21  g169(.a(new_n185_), .b(new_n161_), .c(new_n67_), .O(z5));
endmodule
