...
module FAU ( 
  ...
  oai21  g060(.a(new_n25_), .b(x4), .c(new_n44_), .O(new_n77_));
  ...
  nand4  g088(.a(new_n17_), .b(x7), .c(new_n25_), .d(x3), .O(new_n105_));
  inv1   g089(.a(new_n105_), .O(new_n106_));
  oai21  g090(.a(new_n106_), .b(new_n104_), .c(new_n43_), .O(new_n107_));
  nand2  g091(.a(new_n107_), .b(new_n101_), .O(new_n108_));
  oai21  g092(.a(new_n108_), .b(new_n87_), .c(new_n66_), .O(new_n109_));
  nand2  g093(.a(new_n27_), .b(x3), .O(new_n110_));
  nand3  g094(.a(x9), .b(new_n25_), .c(new_n67_), .O(new_n111_));
  aoi21  g095(.a(new_n111_), .b(new_n110_), .c(new_n24_), .O(new_n112_));
  nand2  g096(.a(new_n44_), .b(x5), .O(new_n113_));
  nand3  g097(.a(new_n113_), .b(x7), .c(x3), .O(new_n114_));
  nand2  g098(.a(x9), .b(new_n43_), .O(new_n115_));
  aoi21  g099(.a(new_n115_), .b(new_n114_), .c(new_n25_), .O(new_n116_));
  oai21  g100(.a(new_n116_), .b(new_n112_), .c(new_n20_), .O(new_n117_));
  nand4  g101(.a(new_n82_), .b(x9), .c(new_n25_), .d(new_n67_), .O(new_n118_));
  nand2  g102(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g103(.a(new_n119_), .b(new_n18_), .O(new_n120_));
  nand3  g104(.a(new_n20_), .b(x3), .c(x2), .O(new_n121_));
  nand2  g105(.a(new_n27_), .b(x5), .O(new_n122_));
  nand4  g106(.a(x9), .b(new_n25_), .c(new_n67_), .d(new_n24_), .O(new_n123_));
  oai21  g107(.a(new_n122_), .b(new_n121_), .c(new_n123_), .O(new_n124_));
  nand2  g108(.a(new_n124_), .b(x8), .O(new_n125_));
  aoi21  g109(.a(x5), .b(new_n24_), .c(new_n44_), .O(new_n126_));
  nand3  g110(.a(new_n44_), .b(x5), .c(new_n24_), .O(new_n127_));
  oai21  g111(.a(new_n126_), .b(new_n18_), .c(new_n127_), .O(new_n128_));
  nand2  g112(.a(new_n128_), .b(x9), .O(new_n129_));
  aoi22  g113(.a(new_n46_), .b(x2), .c(new_n17_), .d(x4), .O(new_n130_));
  aoi21  g114(.a(new_n130_), .b(new_n129_), .c(x3), .O(new_n131_));
  nand2  g115(.a(new_n17_), .b(x7), .O(new_n132_));
  oai21  g116(.a(new_n19_), .b(new_n67_), .c(new_n17_), .O(new_n133_));
  nand2  g117(.a(new_n113_), .b(new_n18_), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(new_n133_), .c(x4), .O(new_n135_));
  nand3  g119(.a(new_n44_), .b(x7), .c(new_n43_), .O(new_n136_));
  nand2  g120(.a(new_n17_), .b(x5), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g122(.a(new_n138_), .b(new_n20_), .c(x3), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(new_n135_), .c(new_n132_), .O(new_n140_));
  oai21  g124(.a(new_n140_), .b(new_n131_), .c(x6), .O(new_n141_));
  nand2  g125(.a(x8), .b(new_n24_), .O(new_n142_));
  nand3  g126(.a(new_n142_), .b(x9), .c(x0), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(new_n127_), .c(x6), .O(new_n144_));
  nand4  g128(.a(x9), .b(new_n44_), .c(x4), .d(x2), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n137_), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n144_), .c(x3), .O(new_n147_));
  nand3  g131(.a(new_n17_), .b(new_n43_), .c(new_n67_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(x7), .O(new_n150_));
  nand4  g134(.a(new_n150_), .b(new_n141_), .c(new_n125_), .d(new_n120_), .O(new_n151_));
  nand2  g135(.a(new_n151_), .b(x1), .O(new_n152_));
  nand3  g136(.a(x7), .b(new_n20_), .c(x3), .O(new_n153_));
  oai21  g137(.a(new_n33_), .b(x3), .c(new_n153_), .O(new_n154_));
  nor2   g138(.a(new_n17_), .b(x7), .O(new_n155_));
  aoi21  g139(.a(new_n154_), .b(new_n17_), .c(new_n155_), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n152_), .c(new_n109_), .O(z1));
  nor2   g141(.a(new_n67_), .b(new_n66_), .O(new_n158_));
  ...
  nor2   g145(.a(new_n161_), .b(new_n155_), .O(z2));
  nor3   g146(.a(new_n155_), .b(new_n67_), .c(new_n66_), .O(z3));
  ...
  nand4  g159(.a(new_n25_), .b(x5), .c(new_n20_), .d(new_n67_), .O(new_n176_));
  inv1   g160(.a(new_n176_), .O(new_n177_));
  oai21  g161(.a(new_n177_), .b(new_n175_), .c(x2), .O(new_n178_));
  oai21  g162(.a(new_n44_), .b(new_n24_), .c(x1), .O(new_n179_));
  oai21  g163(.a(new_n43_), .b(x2), .c(x8), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n67_), .c(new_n46_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n179_), .c(x4), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n175_), .c(x6), .O(new_n183_));
  nand2  g167(.a(new_n46_), .b(x1), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n183_), .c(new_n178_), .O(new_n185_));
  nand2  g169(.a(new_n89_), .b(x3), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(x6), .c(x1), .O(new_n187_));
  nand3  g171(.a(new_n44_), .b(new_n67_), .c(new_n24_), .O(new_n188_));
  aoi21  g172(.a(new_n188_), .b(new_n187_), .c(new_n43_), .O(new_n189_));
  nand3  g173(.a(new_n25_), .b(x3), .c(x1), .O(new_n190_));
  inv1   g174(.a(new_n190_), .O(new_n191_));
  oai21  g175(.a(new_n191_), .b(new_n189_), .c(new_n20_), .O(new_n192_));
  nor2   g176(.a(x6), .b(x5), .O(new_n193_));
  aoi21  g177(.a(new_n193_), .b(new_n158_), .c(new_n19_), .O(new_n194_));
  nand2  g178(.a(new_n194_), .b(new_n192_), .O(new_n195_));
  aoi21  g179(.a(new_n185_), .b(x0), .c(new_n195_), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n174_), .c(new_n17_), .O(z4));
  inv1   g181(.a(new_n155_), .O(new_n198_));
