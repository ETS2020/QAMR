...
module FAU ( 
  ...
  oai21  g174(.a(new_n188_), .b(new_n142_), .c(new_n190_), .O(new_n191_));
  aoi21  g175(.a(new_n187_), .b(x1), .c(new_n191_), .O(new_n192_));
  nand3  g176(.a(new_n192_), .b(new_n164_), .c(new_n134_), .O(z1));
  nor2   g177(.a(x3), .b(x1), .O(new_n194_));
  nor2   g178(.a(new_n79_), .b(new_n77_), .O(new_n195_));
  nor2   g179(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand2  g180(.a(new_n196_), .b(new_n190_), .O(z2));
  nor3   g181(.a(new_n189_), .b(new_n79_), .c(new_n77_), .O(z3));
  ...
  nor2   g204(.a(new_n195_), .b(x6), .O(new_n221_));
  ...
  inv1   g213(.a(new_n195_), .O(new_n230_));
  nor3   g214(.a(new_n230_), .b(new_n48_), .c(x4), .O(new_n231_));
  oai21  g215(.a(new_n231_), .b(new_n229_), .c(x9), .O(new_n232_));
  oai21  g216(.a(x6), .b(x2), .c(x7), .O(new_n233_));
  aoi22  g217(.a(new_n233_), .b(new_n211_), .c(new_n99_), .d(new_n77_), .O(new_n234_));
  nand2  g218(.a(new_n37_), .b(new_n46_), .O(new_n235_));
  aoi21  g219(.a(new_n235_), .b(new_n84_), .c(new_n19_), .O(new_n236_));
  oai21  g220(.a(new_n236_), .b(new_n234_), .c(x0), .O(new_n237_));
  nand3  g221(.a(new_n37_), .b(new_n19_), .c(x2), .O(new_n238_));
  aoi21  g222(.a(new_n238_), .b(new_n125_), .c(new_n46_), .O(new_n239_));
  nand2  g223(.a(new_n20_), .b(new_n79_), .O(new_n240_));
  oai21  g224(.a(new_n48_), .b(new_n79_), .c(new_n240_), .O(new_n241_));
  oai21  g225(.a(new_n241_), .b(new_n239_), .c(x1), .O(new_n242_));
  nand2  g226(.a(new_n20_), .b(new_n29_), .O(new_n243_));
  nand2  g227(.a(new_n37_), .b(x3), .O(new_n244_));
  aoi21  g228(.a(new_n244_), .b(new_n243_), .c(new_n17_), .O(new_n245_));
  nand3  g229(.a(new_n20_), .b(x3), .c(new_n77_), .O(new_n246_));
  inv1   g230(.a(new_n246_), .O(new_n247_));
  oai21  g231(.a(new_n247_), .b(new_n245_), .c(x4), .O(new_n248_));
  nor2   g232(.a(x8), .b(x7), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(x6), .c(new_n63_), .O(new_n250_));
  ...
  oai21  g237(.a(new_n199_), .b(new_n196_), .c(new_n190_), .O(z5));
endmodule
