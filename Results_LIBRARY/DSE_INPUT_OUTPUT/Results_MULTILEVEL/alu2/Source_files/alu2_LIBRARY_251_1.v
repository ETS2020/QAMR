...
module FAU ( 
  ...
  nand2  g114(.a(x9), .b(new_n42_), .O(new_n131_));
  xor2a  g115(.a(x3), .b(x1), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(new_n131_), .O(z2));
  nand2  g117(.a(x3), .b(x1), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n131_), .O(z3));
  nand3  g119(.a(x6), .b(x3), .c(x2), .O(new_n136_));
  nand2  g120(.a(new_n18_), .b(x4), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n136_), .c(new_n62_), .O(new_n138_));
  oai21  g122(.a(new_n18_), .b(x3), .c(new_n22_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n62_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n108_), .c(new_n17_), .O(new_n141_));
  oai21  g125(.a(new_n141_), .b(new_n138_), .c(new_n23_), .O(new_n142_));
  nand3  g126(.a(new_n134_), .b(x4), .c(new_n17_), .O(new_n143_));
  ...
  aoi21  g132(.a(new_n148_), .b(new_n142_), .c(new_n29_), .O(new_n149_));
  oai21  g133(.a(new_n137_), .b(new_n71_), .c(new_n62_), .O(new_n150_));
  ...
  oai21  g153(.a(new_n169_), .b(new_n132_), .c(new_n131_), .O(z5));
endmodule
