...
module FAU ( 
  ...
  oai21  g101(.a(x8), .b(x6), .c(new_n117_), .O(new_n118_));
  ...
  oai21  g146(.a(new_n103_), .b(new_n79_), .c(new_n158_), .O(z3));
  aoi21  g147(.a(new_n103_), .b(x1), .c(new_n30_), .O(new_n164_));
  oai21  g148(.a(new_n103_), .b(x0), .c(x6), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n164_), .c(new_n31_), .O(new_n166_));
  oai21  g150(.a(x6), .b(x3), .c(x1), .O(new_n167_));
  nor2   g151(.a(new_n160_), .b(x6), .O(new_n168_));
  aoi22  g152(.a(new_n168_), .b(new_n30_), .c(new_n167_), .d(new_n18_), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n166_), .c(new_n34_), .O(new_n170_));
  nand2  g154(.a(x2), .b(new_n18_), .O(new_n171_));
  aoi21  g155(.a(new_n30_), .b(x0), .c(new_n23_), .O(new_n172_));
  aoi22  g156(.a(new_n172_), .b(new_n171_), .c(x7), .d(new_n79_), .O(new_n173_));
  oai21  g157(.a(x7), .b(new_n103_), .c(x1), .O(new_n174_));
  nand2  g158(.a(x7), .b(new_n18_), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(x3), .c(new_n79_), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  oai21  g161(.a(new_n177_), .b(new_n173_), .c(x6), .O(new_n178_));
  nand2  g162(.a(new_n117_), .b(x8), .O(new_n179_));
  oai21  g163(.a(x6), .b(new_n103_), .c(new_n79_), .O(new_n180_));
  nand3  g164(.a(new_n180_), .b(new_n179_), .c(x0), .O(new_n181_));
  nor2   g165(.a(new_n31_), .b(new_n103_), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n140_), .c(x1), .O(new_n183_));
  ...
  aoi21  g170(.a(new_n186_), .b(new_n178_), .c(x5), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n170_), .c(x9), .O(new_n188_));
  nor2   g172(.a(new_n188_), .b(new_n25_), .O(z4));
  nor2   g173(.a(new_n30_), .b(new_n18_), .O(new_n190_));
  nor2   g174(.a(new_n190_), .b(new_n81_), .O(new_n191_));
  oai21  g175(.a(new_n191_), .b(new_n161_), .c(new_n158_), .O(z5));
endmodule
