...
module FAU ( 
  ...
  nand3  g119(.a(x7), .b(x3), .c(new_n24_), .O(new_n136_));
  nand2  g120(.a(new_n44_), .b(new_n31_), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n136_), .c(new_n63_), .O(new_n138_));
  oai21  g122(.a(new_n19_), .b(new_n24_), .c(x8), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n31_), .O(new_n140_));
  nand3  g124(.a(x7), .b(x6), .c(new_n24_), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n140_), .c(x3), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n138_), .c(x0), .O(new_n143_));
  xor2a  g127(.a(x6), .b(x3), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(x7), .c(x1), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n135_), .c(new_n20_), .O(new_n147_));
  aoi21  g131(.a(new_n64_), .b(x1), .c(new_n24_), .O(new_n148_));
  oai21  g132(.a(new_n64_), .b(x0), .c(x6), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n148_), .c(new_n19_), .O(new_n150_));
  oai21  g134(.a(x6), .b(x3), .c(x1), .O(new_n151_));
  aoi21  g135(.a(x3), .b(x1), .c(x6), .O(new_n152_));
  aoi22  g136(.a(new_n152_), .b(new_n24_), .c(new_n151_), .d(new_n36_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g138(.a(new_n64_), .b(new_n24_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n137_), .c(x5), .O(new_n156_));
  aoi21  g140(.a(new_n154_), .b(x4), .c(new_n156_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n147_), .c(new_n18_), .O(z4));
  oai22  g142(.a(new_n134_), .b(new_n127_), .c(new_n18_), .d(x5), .O(z5));
endmodule
