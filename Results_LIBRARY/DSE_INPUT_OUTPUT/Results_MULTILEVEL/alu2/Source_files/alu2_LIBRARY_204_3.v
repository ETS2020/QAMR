...
module FAU ( 
  ...
  nand2  g144(.a(new_n69_), .b(new_n110_), .O(new_n161_));
  nand2  g145(.a(x3), .b(x1), .O(new_n162_));
  and2   g146(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n67_), .O(z2));
  nand2  g148(.a(new_n162_), .b(new_n67_), .O(z3));
  nor2   g149(.a(x3), .b(new_n110_), .O(new_n166_));
  nor3   g150(.a(new_n18_), .b(new_n69_), .c(x1), .O(new_n167_));
  oai22  g151(.a(new_n167_), .b(new_n166_), .c(new_n32_), .d(x0), .O(new_n168_));
  nor2   g152(.a(x2), .b(new_n43_), .O(new_n169_));
  nor2   g153(.a(new_n45_), .b(x0), .O(new_n170_));
  oai22  g154(.a(new_n170_), .b(new_n169_), .c(new_n32_), .d(x1), .O(new_n171_));
  oai21  g155(.a(x4), .b(new_n43_), .c(x7), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(new_n23_), .O(new_n173_));
  nand4  g157(.a(x7), .b(x4), .c(x1), .d(new_n43_), .O(new_n174_));
  nand4  g158(.a(new_n174_), .b(new_n173_), .c(new_n171_), .d(new_n168_), .O(new_n175_));
  ...
  inv1   g168(.a(new_n163_), .O(new_n185_));
