...
module FAU ( 
  ...
  nand2  g195(.a(new_n42_), .b(new_n17_), .O(new_n212_));
  nor2   g196(.a(x3), .b(x1), .O(new_n213_));
  nor2   g197(.a(new_n107_), .b(new_n140_), .O(new_n214_));
  ...
  oai21  g206(.a(x3), .b(new_n140_), .c(x2), .O(new_n223_));
  aoi21  g207(.a(x3), .b(new_n17_), .c(new_n31_), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n223_), .c(new_n18_), .O(new_n225_));
  oai21  g209(.a(new_n225_), .b(new_n222_), .c(new_n20_), .O(new_n226_));
  aoi21  g210(.a(new_n31_), .b(new_n107_), .c(new_n140_), .O(new_n227_));
  nand3  g211(.a(new_n217_), .b(new_n31_), .c(new_n29_), .O(new_n228_));
  ...
  nand4  g253(.a(new_n214_), .b(x7), .c(new_n31_), .d(new_n18_), .O(new_n270_));
  ...
  oai21  g257(.a(new_n219_), .b(new_n215_), .c(new_n212_), .O(z5));
endmodule
