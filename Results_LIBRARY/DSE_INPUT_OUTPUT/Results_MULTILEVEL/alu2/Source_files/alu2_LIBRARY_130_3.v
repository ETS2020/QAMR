...
module FAU ( 
  ...
  nor2   g104(.a(new_n120_), .b(new_n119_), .O(z2));
  inv1   g105(.a(new_n119_), .O(new_n122_));
  nand2  g106(.a(x3), .b(x1), .O(new_n123_));
  nand2  g107(.a(new_n123_), .b(new_n122_), .O(z3));
  ...
  oai21  g112(.a(new_n19_), .b(new_n17_), .c(new_n123_), .O(new_n129_));
  aoi21  g113(.a(new_n129_), .b(x7), .c(new_n29_), .O(new_n130_));
  oai21  g114(.a(new_n130_), .b(new_n128_), .c(x4), .O(new_n131_));
  nand3  g115(.a(x5), .b(new_n27_), .c(new_n68_), .O(new_n132_));
  oai21  g116(.a(x5), .b(new_n74_), .c(new_n132_), .O(new_n133_));
  nand3  g117(.a(new_n133_), .b(x7), .c(x2), .O(new_n134_));
  inv1   g118(.a(new_n132_), .O(new_n135_));
  nand2  g119(.a(new_n27_), .b(x3), .O(new_n136_));
  nand2  g120(.a(new_n29_), .b(new_n68_), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n136_), .c(new_n74_), .O(new_n138_));
  oai21  g122(.a(new_n138_), .b(new_n135_), .c(new_n22_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  oai21  g124(.a(x4), .b(new_n74_), .c(x3), .O(new_n141_));
  nand4  g125(.a(new_n141_), .b(new_n22_), .c(x5), .d(new_n19_), .O(new_n142_));
  nand4  g126(.a(new_n34_), .b(x7), .c(x3), .d(x1), .O(new_n143_));
  nand3  g127(.a(new_n143_), .b(new_n142_), .c(new_n46_), .O(new_n144_));
  aoi21  g128(.a(new_n140_), .b(x0), .c(new_n144_), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n131_), .c(new_n18_), .O(z4));
  xor2a  g130(.a(x2), .b(x0), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n120_), .c(new_n122_), .O(z5));
endmodule
