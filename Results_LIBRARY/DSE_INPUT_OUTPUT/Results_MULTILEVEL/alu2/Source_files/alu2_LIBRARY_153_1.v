...
module FAU ( 
  ...
  nor2   g113(.a(new_n64_), .b(new_n95_), .O(new_n130_));
  nor2   g114(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g115(.a(new_n131_), .b(new_n128_), .O(z2));
  oai21  g116(.a(new_n64_), .b(new_n95_), .c(new_n128_), .O(z3));
  oai21  g117(.a(x7), .b(new_n25_), .c(x8), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(x3), .c(x1), .O(new_n135_));
  nand3  g119(.a(new_n129_), .b(new_n19_), .c(x6), .O(new_n136_));
  xor2a  g120(.a(x2), .b(x0), .O(new_n137_));
  aoi21  g121(.a(new_n136_), .b(new_n135_), .c(new_n137_), .O(new_n138_));
  nand3  g122(.a(x2), .b(new_n95_), .c(x0), .O(new_n139_));
  nor4   g123(.a(new_n139_), .b(x8), .c(new_n25_), .d(x3), .O(new_n140_));
  oai21  g124(.a(new_n140_), .b(new_n138_), .c(x5), .O(new_n141_));
  oai21  g125(.a(x2), .b(new_n32_), .c(x6), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(x3), .O(new_n143_));
  nand2  g127(.a(x6), .b(new_n64_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n143_), .c(new_n95_), .O(new_n145_));
  xor2a  g129(.a(x6), .b(x2), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(x0), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n67_), .c(x3), .O(new_n148_));
  oai21  g132(.a(new_n148_), .b(new_n145_), .c(x7), .O(new_n149_));
  oai22  g133(.a(x3), .b(new_n32_), .c(x2), .d(new_n95_), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(new_n45_), .c(new_n25_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(new_n149_), .c(new_n141_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n20_), .O(new_n153_));
  aoi21  g137(.a(new_n64_), .b(x1), .c(new_n24_), .O(new_n154_));
  oai21  g138(.a(new_n64_), .b(x0), .c(x6), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n154_), .c(new_n19_), .O(new_n156_));
  oai21  g140(.a(x6), .b(x3), .c(x1), .O(new_n157_));
  nor2   g141(.a(new_n130_), .b(x6), .O(new_n158_));
  aoi22  g142(.a(new_n158_), .b(new_n24_), .c(new_n157_), .d(new_n32_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand4  g144(.a(new_n45_), .b(new_n25_), .c(new_n64_), .d(new_n24_), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(x5), .O(new_n162_));
  aoi21  g146(.a(new_n160_), .b(x4), .c(new_n162_), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n153_), .c(new_n18_), .O(z4));
  nor2   g148(.a(new_n137_), .b(new_n131_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n128_), .O(new_n166_));
  inv1   g150(.a(new_n166_), .O(z5));
endmodule
