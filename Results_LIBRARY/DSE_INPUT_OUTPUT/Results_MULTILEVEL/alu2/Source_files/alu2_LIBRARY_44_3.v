...
module FAU ( 
  ...
  aoi21  g082(.a(new_n69_), .b(x8), .c(new_n17_), .O(new_n99_));
  inv1   g083(.a(new_n99_), .O(new_n100_));
  aoi21  g084(.a(new_n100_), .b(new_n81_), .c(x5), .O(new_n101_));
  nand2  g085(.a(new_n69_), .b(x8), .O(new_n102_));
  nand2  g086(.a(x8), .b(x4), .O(new_n103_));
  oai21  g087(.a(x4), .b(new_n18_), .c(new_n103_), .O(new_n104_));
  nand2  g088(.a(new_n104_), .b(new_n17_), .O(new_n105_));
  aoi21  g089(.a(new_n105_), .b(new_n102_), .c(new_n24_), .O(new_n106_));
  oai21  g090(.a(new_n106_), .b(new_n101_), .c(new_n68_), .O(new_n107_));
  nand2  g091(.a(new_n24_), .b(new_n17_), .O(new_n108_));
  aoi21  g092(.a(new_n108_), .b(new_n20_), .c(x2), .O(new_n109_));
  nand2  g093(.a(new_n19_), .b(x2), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n20_), .c(x0), .O(new_n111_));
  oai21  g095(.a(new_n111_), .b(new_n109_), .c(x1), .O(new_n112_));
  aoi21  g096(.a(new_n112_), .b(new_n107_), .c(new_n30_), .O(new_n113_));
  oai21  g097(.a(new_n25_), .b(new_n19_), .c(new_n55_), .O(new_n114_));
  nand2  g098(.a(new_n114_), .b(x1), .O(new_n115_));
  nand2  g099(.a(new_n91_), .b(new_n36_), .O(new_n116_));
  nand3  g100(.a(new_n116_), .b(new_n26_), .c(new_n68_), .O(new_n117_));
  nand3  g101(.a(new_n117_), .b(new_n115_), .c(new_n59_), .O(new_n118_));
  oai21  g102(.a(new_n118_), .b(new_n113_), .c(new_n98_), .O(new_n119_));
  nand3  g103(.a(new_n26_), .b(x5), .c(x4), .O(new_n120_));
  aoi21  g104(.a(new_n120_), .b(new_n25_), .c(new_n30_), .O(new_n121_));
  nand3  g105(.a(new_n35_), .b(new_n19_), .c(new_n68_), .O(new_n122_));
  inv1   g106(.a(new_n122_), .O(new_n123_));
  or2    g107(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  aoi21  g108(.a(new_n62_), .b(x1), .c(new_n124_), .O(new_n125_));
  nand3  g109(.a(new_n125_), .b(new_n119_), .c(new_n97_), .O(z1));
  nand2  g110(.a(new_n98_), .b(new_n68_), .O(new_n127_));
  nand2  g111(.a(x3), .b(x1), .O(new_n128_));
  and2   g112(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(new_n64_), .O(z2));
  nand3  g114(.a(new_n64_), .b(x3), .c(x1), .O(new_n131_));
  inv1   g115(.a(new_n131_), .O(z3));
  nor2   g116(.a(x8), .b(new_n18_), .O(new_n133_));
  oai21  g117(.a(new_n133_), .b(new_n99_), .c(x3), .O(new_n134_));
  nand2  g118(.a(new_n133_), .b(x1), .O(new_n135_));
  aoi21  g119(.a(new_n135_), .b(new_n134_), .c(x5), .O(new_n136_));
  oai21  g120(.a(new_n18_), .b(new_n17_), .c(new_n128_), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(x7), .c(new_n24_), .O(new_n138_));
  oai21  g122(.a(new_n138_), .b(new_n136_), .c(x4), .O(new_n139_));
  nand3  g123(.a(x5), .b(new_n19_), .c(new_n98_), .O(new_n140_));
  oai21  g124(.a(x5), .b(new_n68_), .c(new_n140_), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n102_), .O(new_n142_));
  nand3  g126(.a(new_n20_), .b(new_n19_), .c(x1), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(x0), .O(new_n145_));
  oai21  g129(.a(x4), .b(new_n68_), .c(x3), .O(new_n146_));
  nand4  g130(.a(new_n146_), .b(new_n20_), .c(x5), .d(new_n18_), .O(new_n147_));
  nand2  g131(.a(x5), .b(x4), .O(new_n148_));
  nand4  g132(.a(new_n148_), .b(x7), .c(x3), .d(x1), .O(new_n149_));
  nand4  g133(.a(new_n149_), .b(new_n147_), .c(new_n145_), .d(new_n139_), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(x9), .c(new_n25_), .O(new_n151_));
  inv1   g135(.a(new_n151_), .O(z4));
  inv1   g136(.a(new_n129_), .O(new_n153_));
  xnor2a g137(.a(x2), .b(x0), .O(new_n154_));
  nand3  g138(.a(new_n154_), .b(new_n153_), .c(new_n64_), .O(new_n155_));
