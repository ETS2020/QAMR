...
module FAU ( 
  ...
  inv1   g146(.a(new_n156_), .O(new_n163_));
  nand2  g147(.a(new_n159_), .b(new_n163_), .O(z3));
  oai21  g148(.a(x6), .b(x3), .c(x1), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n18_), .O(new_n166_));
  nand3  g150(.a(new_n159_), .b(new_n25_), .c(new_n24_), .O(new_n167_));
  ...
  nor2   g159(.a(x5), .b(new_n66_), .O(new_n176_));
  inv1   g160(.a(new_n176_), .O(new_n177_));
  nand4  g161(.a(new_n25_), .b(x5), .c(new_n20_), .d(new_n67_), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n177_), .c(new_n24_), .O(new_n179_));
  inv1   g163(.a(new_n46_), .O(new_n180_));
  oai21  g164(.a(new_n44_), .b(new_n24_), .c(x1), .O(new_n181_));
  nand2  g165(.a(new_n127_), .b(new_n67_), .O(new_n182_));
  nand3  g166(.a(new_n182_), .b(new_n181_), .c(new_n180_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n20_), .c(new_n176_), .O(new_n184_));
  nand2  g168(.a(new_n46_), .b(x1), .O(new_n185_));
  oai21  g169(.a(new_n184_), .b(new_n25_), .c(new_n185_), .O(new_n186_));
  oai21  g170(.a(new_n186_), .b(new_n179_), .c(x0), .O(new_n187_));
  nand2  g171(.a(new_n89_), .b(x3), .O(new_n188_));
  nand3  g172(.a(new_n188_), .b(x6), .c(x1), .O(new_n189_));
  nand3  g173(.a(new_n44_), .b(new_n67_), .c(new_n24_), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand2  g175(.a(new_n191_), .b(x5), .O(new_n192_));
  oai21  g176(.a(new_n105_), .b(new_n66_), .c(new_n192_), .O(new_n193_));
  nand4  g177(.a(new_n25_), .b(new_n43_), .c(x3), .d(x1), .O(new_n194_));
  inv1   g178(.a(new_n194_), .O(new_n195_));
  aoi21  g179(.a(new_n193_), .b(new_n20_), .c(new_n195_), .O(new_n196_));
  nand3  g180(.a(new_n196_), .b(new_n187_), .c(new_n175_), .O(new_n197_));
  nand3  g181(.a(new_n197_), .b(x9), .c(x7), .O(new_n198_));
  inv1   g182(.a(new_n198_), .O(z4));
  inv1   g183(.a(new_n161_), .O(new_n200_));
  xnor2a g184(.a(x2), .b(x0), .O(new_n201_));
  nand3  g185(.a(new_n201_), .b(new_n200_), .c(new_n163_), .O(new_n202_));
