...
module FAU ( 
  ...
  oai21  g161(.a(new_n50_), .b(x3), .c(new_n177_), .O(z3));
  ...
  nand2  g166(.a(new_n21_), .b(x2), .O(new_n183_));
  ...
  nand2  g170(.a(new_n21_), .b(new_n129_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n186_), .c(x5), .O(new_n188_));
  nand3  g172(.a(new_n21_), .b(x2), .c(new_n18_), .O(new_n189_));
  inv1   g173(.a(new_n189_), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(new_n188_), .c(x6), .O(new_n191_));
  nand2  g175(.a(x7), .b(x2), .O(new_n192_));
  aoi21  g176(.a(new_n192_), .b(x8), .c(new_n18_), .O(new_n193_));
  oai21  g177(.a(x8), .b(new_n61_), .c(new_n179_), .O(new_n194_));
  ...
  nand3  g183(.a(new_n199_), .b(new_n28_), .c(x5), .O(new_n200_));
  oai21  g184(.a(new_n21_), .b(x2), .c(new_n118_), .O(new_n201_));
  aoi21  g185(.a(new_n201_), .b(x0), .c(new_n42_), .O(new_n202_));
  aoi21  g186(.a(new_n202_), .b(new_n200_), .c(x4), .O(new_n203_));
  inv1   g187(.a(new_n42_), .O(new_n204_));
  oai21  g188(.a(new_n24_), .b(x7), .c(x0), .O(new_n205_));
  aoi21  g189(.a(new_n205_), .b(new_n204_), .c(x5), .O(new_n206_));
  oai21  g190(.a(new_n206_), .b(new_n203_), .c(x1), .O(new_n207_));
  inv1   g191(.a(new_n29_), .O(new_n208_));
  aoi21  g192(.a(new_n21_), .b(new_n61_), .c(new_n24_), .O(new_n209_));
  oai21  g193(.a(new_n209_), .b(new_n18_), .c(new_n208_), .O(new_n210_));
  nand3  g194(.a(new_n210_), .b(x6), .c(new_n19_), .O(new_n211_));
  nand3  g195(.a(new_n211_), .b(new_n207_), .c(new_n197_), .O(new_n212_));
  nand3  g196(.a(new_n212_), .b(x9), .c(x3), .O(new_n213_));
  inv1   g197(.a(new_n213_), .O(z4));
  nand3  g198(.a(new_n50_), .b(new_n17_), .c(new_n129_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(new_n177_), .c(new_n198_), .O(z5));
endmodule
