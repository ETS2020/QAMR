...
module FAU ( 
  ...
  nor2   g125(.a(new_n44_), .b(new_n32_), .O(new_n142_));
  nand2  g126(.a(x3), .b(x1), .O(new_n143_));
  nand2  g127(.a(new_n69_), .b(new_n90_), .O(new_n144_));
  and2   g128(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nor2   g129(.a(new_n145_), .b(new_n142_), .O(z2));
  inv1   g130(.a(new_n142_), .O(new_n147_));
  nand2  g131(.a(new_n143_), .b(new_n147_), .O(z3));
  nand2  g132(.a(x3), .b(x2), .O(new_n149_));
  aoi21  g133(.a(new_n149_), .b(new_n17_), .c(new_n90_), .O(new_n150_));
  nand2  g134(.a(x2), .b(new_n90_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n27_), .c(x3), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(new_n150_), .c(x0), .O(new_n153_));
  aoi21  g137(.a(x6), .b(new_n69_), .c(new_n18_), .O(new_n154_));
  nand2  g138(.a(new_n69_), .b(new_n18_), .O(new_n155_));
  oai21  g139(.a(new_n154_), .b(new_n90_), .c(new_n155_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(x7), .O(new_n157_));
  oai21  g141(.a(new_n69_), .b(x0), .c(x6), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(new_n18_), .c(x1), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n157_), .c(new_n153_), .O(new_n160_));
  aoi21  g144(.a(new_n155_), .b(new_n34_), .c(x0), .O(new_n161_));
  nand2  g145(.a(new_n19_), .b(new_n18_), .O(new_n162_));
  nand2  g146(.a(new_n17_), .b(x2), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n162_), .c(new_n34_), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n161_), .c(new_n90_), .O(new_n165_));
  nand2  g149(.a(new_n19_), .b(new_n69_), .O(new_n166_));
  nand2  g150(.a(new_n17_), .b(x3), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(new_n166_), .c(x0), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n100_), .c(x4), .O(new_n169_));
  nand3  g153(.a(new_n19_), .b(new_n69_), .c(new_n18_), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n169_), .c(new_n165_), .O(new_n171_));
  aoi21  g155(.a(new_n160_), .b(new_n34_), .c(new_n171_), .O(new_n172_));
  nand2  g156(.a(new_n111_), .b(new_n52_), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(new_n114_), .c(new_n19_), .O(new_n174_));
  nand3  g158(.a(new_n162_), .b(new_n21_), .c(x4), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(x1), .O(new_n177_));
  oai21  g161(.a(x6), .b(x4), .c(x0), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n71_), .c(x5), .O(new_n179_));
  ...
  oai21  g166(.a(x4), .b(new_n52_), .c(x7), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(x6), .c(new_n21_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n182_), .c(new_n177_), .O(new_n185_));
  inv1   g169(.a(new_n185_), .O(new_n186_));
  oai21  g170(.a(new_n172_), .b(new_n21_), .c(new_n186_), .O(new_n187_));
  nand3  g171(.a(new_n187_), .b(x9), .c(new_n32_), .O(new_n188_));
  inv1   g172(.a(new_n188_), .O(z4));
  inv1   g173(.a(new_n145_), .O(new_n190_));
  xnor2a g174(.a(x2), .b(x0), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n190_), .c(new_n147_), .O(new_n192_));
