...
module FAU ( 
  ...
  nand3  g156(.a(new_n170_), .b(x3), .c(x1), .O(new_n173_));
  inv1   g157(.a(new_n173_), .O(z3));
  nor2   g158(.a(x3), .b(new_n122_), .O(new_n175_));
  nor3   g159(.a(new_n18_), .b(new_n78_), .c(x1), .O(new_n176_));
  oai22  g160(.a(new_n176_), .b(new_n175_), .c(new_n31_), .d(x0), .O(new_n177_));
  nor2   g161(.a(x2), .b(new_n17_), .O(new_n178_));
  nor2   g162(.a(new_n79_), .b(x0), .O(new_n179_));
  oai22  g163(.a(new_n179_), .b(new_n178_), .c(new_n31_), .d(x1), .O(new_n180_));
  aoi21  g164(.a(x4), .b(new_n78_), .c(new_n17_), .O(new_n181_));
  oai21  g165(.a(new_n181_), .b(new_n31_), .c(new_n20_), .O(new_n182_));
  oai21  g166(.a(new_n31_), .b(x0), .c(x3), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(x4), .c(x1), .O(new_n184_));
  nand4  g168(.a(new_n184_), .b(new_n182_), .c(new_n180_), .d(new_n177_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(x6), .O(new_n186_));
  oai21  g170(.a(new_n128_), .b(x1), .c(new_n144_), .O(new_n187_));
  nand3  g171(.a(x7), .b(x3), .c(x1), .O(new_n188_));
  aoi21  g172(.a(new_n188_), .b(new_n187_), .c(new_n17_), .O(new_n189_));
  aoi21  g173(.a(new_n123_), .b(new_n89_), .c(new_n122_), .O(new_n190_));
  nand3  g174(.a(new_n88_), .b(x3), .c(x2), .O(new_n191_));
  nand2  g175(.a(new_n191_), .b(new_n19_), .O(new_n192_));
  nor3   g176(.a(new_n192_), .b(new_n190_), .c(new_n189_), .O(new_n193_));
  aoi21  g177(.a(new_n193_), .b(new_n186_), .c(new_n21_), .O(z4));
  xor2a  g178(.a(x2), .b(x0), .O(new_n195_));
  oai21  g179(.a(new_n195_), .b(new_n171_), .c(new_n170_), .O(z5));
endmodule
