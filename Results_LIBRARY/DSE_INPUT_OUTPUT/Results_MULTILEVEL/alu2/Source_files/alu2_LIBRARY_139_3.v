...
module FAU ( 
  ...
  nor2   g152(.a(new_n21_), .b(new_n19_), .O(new_n169_));
  nand2  g153(.a(x3), .b(x1), .O(new_n170_));
  nand2  g154(.a(new_n80_), .b(new_n121_), .O(new_n171_));
  and2   g155(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nor2   g156(.a(new_n172_), .b(new_n169_), .O(z2));
  inv1   g157(.a(new_n169_), .O(new_n174_));
  nand2  g158(.a(new_n170_), .b(new_n174_), .O(z3));
  inv1   g159(.a(new_n149_), .O(new_n176_));
  aoi21  g160(.a(x4), .b(x3), .c(x1), .O(new_n177_));
  oai21  g161(.a(x6), .b(x2), .c(x7), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n176_), .c(new_n177_), .O(new_n179_));
  inv1   g163(.a(new_n100_), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n39_), .c(new_n45_), .O(new_n181_));
  oai21  g165(.a(new_n181_), .b(new_n179_), .c(x0), .O(new_n182_));
  nand2  g166(.a(x7), .b(x6), .O(new_n183_));
  nand2  g167(.a(new_n149_), .b(x2), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n183_), .c(new_n18_), .O(new_n185_));
  nand2  g169(.a(new_n158_), .b(new_n122_), .O(new_n186_));
  oai21  g170(.a(new_n186_), .b(new_n185_), .c(x1), .O(new_n187_));
  nand2  g171(.a(new_n129_), .b(new_n17_), .O(new_n188_));
  nand2  g172(.a(new_n20_), .b(x3), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n188_), .c(new_n53_), .O(new_n190_));
  nand3  g174(.a(new_n129_), .b(x3), .c(new_n121_), .O(new_n191_));
  inv1   g175(.a(new_n191_), .O(new_n192_));
  oai21  g176(.a(new_n192_), .b(new_n190_), .c(x4), .O(new_n193_));
  nand2  g177(.a(new_n57_), .b(x6), .O(new_n194_));
  nand4  g178(.a(new_n194_), .b(new_n193_), .c(new_n187_), .d(new_n182_), .O(new_n195_));
  nand3  g179(.a(new_n195_), .b(x9), .c(new_n19_), .O(new_n196_));
  inv1   g180(.a(new_n196_), .O(z4));
  inv1   g181(.a(new_n172_), .O(new_n198_));
  xnor2a g182(.a(x2), .b(x0), .O(new_n199_));
  nand3  g183(.a(new_n199_), .b(new_n198_), .c(new_n174_), .O(new_n200_));
