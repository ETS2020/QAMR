...
module FAU ( 
  ...
  nand2  g109(.a(new_n18_), .b(x4), .O(new_n126_));
  oai21  g110(.a(new_n126_), .b(x3), .c(new_n125_), .O(new_n127_));
  nand3  g111(.a(new_n127_), .b(x6), .c(x0), .O(new_n128_));
  nand3  g112(.a(new_n28_), .b(new_n18_), .c(new_n69_), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(x4), .O(new_n130_));
  nand3  g114(.a(new_n130_), .b(new_n32_), .c(x3), .O(new_n131_));
  nand3  g115(.a(new_n131_), .b(new_n128_), .c(new_n122_), .O(new_n132_));
  nand4  g116(.a(x6), .b(x4), .c(new_n70_), .d(x1), .O(new_n133_));
  nand4  g117(.a(new_n88_), .b(new_n59_), .c(x3), .d(new_n69_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(x0), .O(new_n136_));
  nand2  g120(.a(x4), .b(new_n70_), .O(new_n137_));
  nand3  g121(.a(x5), .b(new_n59_), .c(x3), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n69_), .O(new_n139_));
  nand3  g123(.a(new_n54_), .b(new_n59_), .c(new_n69_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(x5), .c(x3), .O(new_n141_));
  oai21  g125(.a(new_n141_), .b(new_n139_), .c(x6), .O(new_n142_));
  aoi21  g126(.a(new_n28_), .b(x3), .c(new_n18_), .O(new_n143_));
  oai22  g127(.a(new_n143_), .b(x4), .c(new_n72_), .d(x3), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n69_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n32_), .O(new_n147_));
  inv1   g131(.a(new_n77_), .O(new_n148_));
  inv1   g132(.a(new_n123_), .O(new_n149_));
  nor2   g133(.a(x1), .b(x0), .O(new_n150_));
  nand4  g134(.a(new_n150_), .b(new_n149_), .c(new_n112_), .d(new_n148_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(new_n147_), .c(new_n136_), .O(new_n152_));
  aoi21  g136(.a(new_n132_), .b(x7), .c(new_n152_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(new_n111_), .O(z1));
  xor2a  g138(.a(x3), .b(x1), .O(new_n155_));
  aoi21  g139(.a(x9), .b(x2), .c(new_n155_), .O(z2));
  oai22  g140(.a(new_n32_), .b(new_n17_), .c(new_n70_), .d(new_n69_), .O(z3));
  nand3  g141(.a(new_n84_), .b(new_n70_), .c(new_n17_), .O(new_n158_));
  nand2  g142(.a(new_n158_), .b(new_n59_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n69_), .O(new_n160_));
  nand3  g144(.a(x6), .b(new_n17_), .c(x1), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n59_), .O(new_n162_));
  nand3  g146(.a(new_n162_), .b(new_n54_), .c(x3), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n160_), .c(x0), .O(new_n164_));
  oai21  g148(.a(new_n150_), .b(new_n28_), .c(x8), .O(new_n165_));
  nand3  g149(.a(new_n165_), .b(x7), .c(new_n59_), .O(new_n166_));
  oai21  g150(.a(new_n24_), .b(x4), .c(new_n28_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n70_), .O(new_n169_));
  nor2   g153(.a(new_n84_), .b(x8), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n59_), .c(x1), .O(new_n171_));
  ...
  oai21  g158(.a(new_n174_), .b(new_n164_), .c(x5), .O(new_n175_));
  nand3  g159(.a(new_n36_), .b(new_n28_), .c(x3), .O(new_n176_));
  inv1   g160(.a(new_n176_), .O(new_n177_));
  nand2  g161(.a(new_n59_), .b(x0), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n126_), .c(new_n28_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n177_), .c(x7), .O(new_n180_));
  aoi21  g164(.a(x8), .b(new_n28_), .c(new_n20_), .O(new_n181_));
  nand2  g165(.a(new_n84_), .b(new_n70_), .O(new_n182_));
  inv1   g166(.a(new_n182_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n181_), .c(new_n18_), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n180_), .c(new_n69_), .O(new_n185_));
  nand3  g169(.a(new_n43_), .b(x4), .c(x3), .O(new_n186_));
  oai21  g170(.a(x8), .b(x4), .c(x7), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(x6), .O(new_n188_));
  aoi21  g172(.a(new_n188_), .b(new_n186_), .c(new_n20_), .O(new_n189_));
  nand2  g173(.a(x4), .b(x3), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(x1), .c(x8), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n54_), .c(x6), .O(new_n192_));
  inv1   g176(.a(new_n192_), .O(new_n193_));
  oai21  g177(.a(new_n193_), .b(new_n189_), .c(new_n18_), .O(new_n194_));
  nand2  g178(.a(new_n194_), .b(new_n17_), .O(new_n195_));
  nor2   g179(.a(new_n195_), .b(new_n185_), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n175_), .c(new_n32_), .O(z4));
  nand2  g181(.a(new_n17_), .b(new_n20_), .O(new_n198_));
  nand3  g182(.a(new_n32_), .b(x2), .c(x0), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(new_n198_), .c(new_n155_), .O(z5));
endmodule
