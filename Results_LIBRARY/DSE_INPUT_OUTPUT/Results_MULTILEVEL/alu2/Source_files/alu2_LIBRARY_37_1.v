// Benchmark "FAU" written by ABC on Thu Aug 13 18:20:59 2020
...
module FAU ( 
  ...
  oai21  g116(.a(x7), .b(new_n18_), .c(x8), .O(new_n133_));
  nand3  g117(.a(new_n133_), .b(x3), .c(x1), .O(new_n134_));
  nand2  g118(.a(x8), .b(x7), .O(new_n135_));
  nand4  g119(.a(new_n135_), .b(x6), .c(new_n67_), .d(new_n65_), .O(new_n136_));
  xor2a  g120(.a(x2), .b(x0), .O(new_n137_));
  aoi21  g121(.a(new_n136_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  nand3  g122(.a(x7), .b(x3), .c(new_n17_), .O(new_n139_));
  nand2  g123(.a(new_n22_), .b(new_n18_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n139_), .c(new_n65_), .O(new_n141_));
  oai21  g125(.a(new_n28_), .b(new_n17_), .c(x8), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n18_), .O(new_n143_));
  nand3  g127(.a(x7), .b(x6), .c(new_n17_), .O(new_n144_));
  ...
  oai21  g133(.a(new_n149_), .b(new_n138_), .c(new_n23_), .O(new_n150_));
  aoi21  g134(.a(new_n67_), .b(x1), .c(new_n17_), .O(new_n151_));
  oai21  g135(.a(new_n67_), .b(x0), .c(x6), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(new_n151_), .c(new_n28_), .O(new_n153_));
  oai21  g137(.a(x6), .b(x3), .c(x1), .O(new_n154_));
  aoi21  g138(.a(x3), .b(x1), .c(x6), .O(new_n155_));
  aoi22  g139(.a(new_n155_), .b(new_n17_), .c(new_n154_), .d(new_n41_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g141(.a(new_n67_), .b(new_n17_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n140_), .c(x5), .O(new_n159_));
  aoi21  g143(.a(new_n157_), .b(x4), .c(new_n159_), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n150_), .c(new_n27_), .O(z4));
  oai21  g145(.a(new_n137_), .b(new_n130_), .c(new_n129_), .O(z5));
endmodule
