...
module FAU ( 
  ...
  nand2  g110(.a(new_n64_), .b(new_n63_), .O(new_n127_));
  ...
  xor2a  g116(.a(x2), .b(x0), .O(new_n133_));
  nor2   g117(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(x6), .c(new_n20_), .O(new_n135_));
  inv1   g119(.a(new_n135_), .O(new_n136_));
  oai21  g120(.a(x3), .b(new_n63_), .c(x2), .O(new_n137_));
  aoi21  g121(.a(x3), .b(new_n36_), .c(new_n31_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n20_), .O(new_n139_));
  oai21  g123(.a(new_n139_), .b(new_n136_), .c(new_n19_), .O(new_n140_));
  nand3  g124(.a(new_n129_), .b(x6), .c(new_n36_), .O(new_n141_));
  oai21  g125(.a(x6), .b(new_n63_), .c(new_n141_), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n24_), .O(new_n143_));
  oai21  g127(.a(x7), .b(new_n31_), .c(x1), .O(new_n144_));
  aoi21  g128(.a(x2), .b(new_n63_), .c(new_n31_), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(x3), .c(new_n144_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(x0), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n143_), .c(x8), .O(new_n148_));
  nand2  g132(.a(x3), .b(new_n63_), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(x6), .c(new_n24_), .O(new_n150_));
  nand2  g134(.a(new_n31_), .b(new_n64_), .O(new_n151_));
  oai21  g135(.a(new_n151_), .b(new_n24_), .c(new_n150_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(x0), .O(new_n153_));
  nor2   g137(.a(new_n31_), .b(x3), .O(new_n154_));
  oai21  g138(.a(new_n154_), .b(new_n65_), .c(x1), .O(new_n155_));
  aoi21  g139(.a(new_n155_), .b(new_n153_), .c(new_n19_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n148_), .c(new_n20_), .O(new_n157_));
  aoi21  g141(.a(new_n31_), .b(new_n64_), .c(new_n63_), .O(new_n158_));
  nand3  g142(.a(new_n128_), .b(new_n31_), .c(new_n24_), .O(new_n159_));
  oai21  g143(.a(new_n158_), .b(x0), .c(new_n159_), .O(new_n160_));
  nand4  g144(.a(new_n44_), .b(new_n31_), .c(new_n64_), .d(new_n24_), .O(new_n161_));
  inv1   g145(.a(new_n161_), .O(new_n162_));
  aoi21  g146(.a(new_n160_), .b(x4), .c(new_n162_), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(new_n157_), .c(new_n140_), .O(new_n164_));
  nand3  g148(.a(new_n164_), .b(x9), .c(x5), .O(new_n165_));
  inv1   g149(.a(new_n165_), .O(z4));
  nand2  g150(.a(new_n134_), .b(new_n126_), .O(new_n167_));
