...
module FAU ( 
  ...
  nand2  g173(.a(new_n65_), .b(new_n18_), .O(new_n190_));
  oai21  g174(.a(new_n189_), .b(new_n143_), .c(new_n190_), .O(new_n191_));
  aoi21  g175(.a(new_n188_), .b(x1), .c(new_n191_), .O(new_n192_));
  nand3  g176(.a(new_n192_), .b(new_n165_), .c(new_n136_), .O(z1));
  nor2   g177(.a(x3), .b(x1), .O(new_n194_));
  nor2   g178(.a(new_n81_), .b(new_n79_), .O(new_n195_));
  nor2   g179(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand2  g180(.a(new_n196_), .b(new_n190_), .O(z2));
  oai21  g181(.a(new_n81_), .b(new_n79_), .c(new_n190_), .O(z3));
  nand2  g182(.a(x2), .b(x0), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(new_n125_), .c(new_n196_), .O(new_n200_));
  nand3  g184(.a(new_n200_), .b(x6), .c(new_n29_), .O(new_n201_));
  inv1   g185(.a(new_n201_), .O(new_n202_));
  oai21  g186(.a(x3), .b(new_n79_), .c(x2), .O(new_n203_));
  aoi21  g187(.a(x3), .b(new_n28_), .c(new_n19_), .O(new_n204_));
  aoi21  g188(.a(new_n204_), .b(new_n203_), .c(new_n29_), .O(new_n205_));
  oai21  g189(.a(new_n205_), .b(new_n202_), .c(new_n39_), .O(new_n206_));
  nand4  g190(.a(new_n38_), .b(new_n29_), .c(new_n17_), .d(new_n79_), .O(new_n207_));
  inv1   g191(.a(new_n207_), .O(new_n208_));
  oai21  g192(.a(new_n208_), .b(new_n105_), .c(new_n28_), .O(new_n209_));
  nor2   g193(.a(x8), .b(x1), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n51_), .c(x2), .O(new_n211_));
  nor2   g195(.a(x8), .b(x6), .O(new_n212_));
  aoi21  g196(.a(new_n128_), .b(new_n17_), .c(new_n212_), .O(new_n213_));
  aoi21  g197(.a(new_n213_), .b(new_n211_), .c(new_n28_), .O(new_n214_));
  nand2  g198(.a(new_n128_), .b(x1), .O(new_n215_));
  inv1   g199(.a(new_n215_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n214_), .c(new_n29_), .O(new_n217_));
  nand2  g201(.a(x8), .b(new_n29_), .O(new_n218_));
  nand3  g202(.a(new_n218_), .b(new_n19_), .c(new_n17_), .O(new_n219_));
  nand3  g203(.a(new_n219_), .b(new_n217_), .c(new_n209_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n81_), .O(new_n221_));
  aoi21  g205(.a(new_n41_), .b(x0), .c(new_n29_), .O(new_n222_));
  oai22  g206(.a(new_n20_), .b(x2), .c(new_n39_), .d(new_n28_), .O(new_n223_));
  nand4  g207(.a(new_n223_), .b(new_n38_), .c(new_n29_), .d(x1), .O(new_n224_));
  inv1   g208(.a(new_n224_), .O(new_n225_));
  aoi21  g209(.a(new_n222_), .b(new_n79_), .c(new_n225_), .O(new_n226_));
  nand3  g210(.a(new_n226_), .b(new_n221_), .c(new_n206_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(x5), .O(new_n228_));
  aoi21  g212(.a(new_n41_), .b(x7), .c(new_n212_), .O(new_n229_));
  aoi21  g213(.a(new_n101_), .b(new_n79_), .c(new_n229_), .O(new_n230_));
  nand2  g214(.a(new_n38_), .b(new_n29_), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n86_), .c(new_n19_), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n230_), .c(new_n18_), .O(new_n233_));
  nor2   g217(.a(new_n213_), .b(x4), .O(new_n234_));
  ...
  aoi21  g221(.a(new_n212_), .b(x2), .c(new_n128_), .O(new_n238_));
  nor2   g222(.a(new_n238_), .b(new_n29_), .O(new_n239_));
  nand2  g223(.a(new_n51_), .b(x3), .O(new_n240_));
  oai21  g224(.a(new_n23_), .b(x3), .c(new_n240_), .O(new_n241_));
  oai21  g225(.a(new_n241_), .b(new_n239_), .c(x1), .O(new_n242_));
  nand2  g226(.a(new_n20_), .b(new_n28_), .O(new_n243_));
  nand2  g227(.a(new_n38_), .b(x3), .O(new_n244_));
  aoi21  g228(.a(new_n244_), .b(new_n243_), .c(new_n17_), .O(new_n245_));
  nand3  g229(.a(new_n20_), .b(x3), .c(new_n79_), .O(new_n246_));
  inv1   g230(.a(new_n246_), .O(new_n247_));
  oai21  g231(.a(new_n247_), .b(new_n245_), .c(x4), .O(new_n248_));
  nand3  g232(.a(new_n38_), .b(new_n39_), .c(x6), .O(new_n249_));
  nand3  g233(.a(new_n249_), .b(new_n248_), .c(new_n242_), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(new_n18_), .O(new_n251_));
  nand3  g235(.a(new_n195_), .b(new_n51_), .c(new_n29_), .O(new_n252_));
  nand3  g236(.a(new_n252_), .b(new_n251_), .c(new_n237_), .O(new_n253_));
  inv1   g237(.a(new_n253_), .O(new_n254_));
  aoi21  g238(.a(new_n254_), .b(new_n228_), .c(new_n65_), .O(z4));
  inv1   g239(.a(new_n200_), .O(new_n256_));
  nand2  g240(.a(new_n256_), .b(new_n190_), .O(z5));
endmodule
