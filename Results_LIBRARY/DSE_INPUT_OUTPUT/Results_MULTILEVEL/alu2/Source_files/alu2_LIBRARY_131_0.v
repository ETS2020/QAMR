...
module FAU ( 
  ...
  nand3  g200(.a(x9), .b(new_n98_), .c(new_n154_), .O(new_n217_));
  oai21  g201(.a(new_n98_), .b(new_n154_), .c(new_n217_), .O(z2));
  nor2   g202(.a(new_n98_), .b(new_n154_), .O(z3));
  oai21  g203(.a(x8), .b(x4), .c(new_n77_), .O(new_n220_));
  nand3  g204(.a(new_n220_), .b(x3), .c(x1), .O(new_n221_));
  nor2   g205(.a(x7), .b(new_n17_), .O(new_n222_));
  nor2   g206(.a(x3), .b(x1), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n221_), .c(x2), .O(new_n225_));
  ...
  nand3  g213(.a(x7), .b(new_n17_), .c(new_n29_), .O(new_n230_));
  oai21  g214(.a(new_n77_), .b(x1), .c(new_n230_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n98_), .O(new_n232_));
  aoi21  g216(.a(new_n232_), .b(new_n221_), .c(new_n58_), .O(new_n233_));
  oai21  g217(.a(x3), .b(new_n154_), .c(new_n19_), .O(new_n234_));
  nor2   g218(.a(new_n234_), .b(new_n29_), .O(new_n235_));
  oai21  g219(.a(new_n235_), .b(new_n233_), .c(x2), .O(new_n236_));
  nor2   g220(.a(new_n90_), .b(x3), .O(new_n237_));
  nor2   g221(.a(x8), .b(x6), .O(new_n238_));
  inv1   g222(.a(new_n238_), .O(new_n239_));
  nor2   g223(.a(new_n239_), .b(x2), .O(new_n240_));
  oai21  g224(.a(new_n240_), .b(new_n237_), .c(x1), .O(new_n241_));
  nand2  g225(.a(new_n238_), .b(x0), .O(new_n242_));
  inv1   g226(.a(new_n242_), .O(new_n243_));
  aoi21  g227(.a(new_n189_), .b(x7), .c(new_n243_), .O(new_n244_));
  oai21  g228(.a(new_n244_), .b(x3), .c(new_n241_), .O(new_n245_));
  ...
  nand4  g235(.a(new_n251_), .b(new_n246_), .c(new_n236_), .d(new_n229_), .O(new_n252_));
  ...
  oai21  g239(.a(new_n255_), .b(new_n238_), .c(new_n254_), .O(new_n256_));
  oai21  g240(.a(new_n170_), .b(new_n25_), .c(x6), .O(new_n257_));
  aoi21  g241(.a(new_n257_), .b(new_n256_), .c(x5), .O(new_n258_));
  oai21  g242(.a(new_n90_), .b(x2), .c(new_n239_), .O(new_n259_));
  nand3  g243(.a(new_n259_), .b(new_n29_), .c(x1), .O(new_n260_));
  inv1   g244(.a(new_n260_), .O(new_n261_));
  oai21  g245(.a(new_n261_), .b(new_n258_), .c(x0), .O(new_n262_));
  nand2  g246(.a(new_n238_), .b(x2), .O(new_n263_));
  aoi21  g247(.a(new_n263_), .b(new_n90_), .c(new_n29_), .O(new_n264_));
  nand2  g248(.a(new_n222_), .b(new_n98_), .O(new_n265_));
  oai21  g249(.a(new_n167_), .b(new_n98_), .c(new_n265_), .O(new_n266_));
  oai21  g250(.a(new_n266_), .b(new_n264_), .c(x1), .O(new_n267_));
  nand2  g251(.a(new_n222_), .b(new_n58_), .O(new_n268_));
  nand2  g252(.a(new_n23_), .b(x3), .O(new_n269_));
  aoi21  g253(.a(new_n269_), .b(new_n268_), .c(new_n54_), .O(new_n270_));
  nand3  g254(.a(new_n222_), .b(x3), .c(new_n154_), .O(new_n271_));
  inv1   g255(.a(new_n271_), .O(new_n272_));
  oai21  g256(.a(new_n272_), .b(new_n270_), .c(x4), .O(new_n273_));
  nand2  g257(.a(new_n31_), .b(x6), .O(new_n274_));
  nand3  g258(.a(new_n274_), .b(new_n273_), .c(new_n267_), .O(new_n275_));
  nand2  g259(.a(new_n275_), .b(new_n22_), .O(new_n276_));
  inv1   g260(.a(new_n230_), .O(new_n277_));
  nand2  g261(.a(new_n277_), .b(z3), .O(new_n278_));
  nand3  g262(.a(new_n278_), .b(new_n276_), .c(new_n262_), .O(new_n279_));
  inv1   g263(.a(new_n279_), .O(new_n280_));
  aoi21  g264(.a(new_n280_), .b(new_n253_), .c(new_n18_), .O(z4));
  nor2   g265(.a(new_n223_), .b(z3), .O(new_n282_));
