...
module FAU ( 
  ...
  inv1   g193(.a(new_n205_), .O(new_n210_));
  inv1   g194(.a(new_n208_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(new_n210_), .O(z3));
  xor2a  g196(.a(x2), .b(x0), .O(new_n213_));
  nor2   g197(.a(new_n213_), .b(new_n207_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(x6), .O(new_n215_));
  inv1   g199(.a(new_n215_), .O(new_n216_));
  oai21  g200(.a(x3), .b(new_n129_), .c(x2), .O(new_n217_));
  aoi21  g201(.a(x3), .b(new_n18_), .c(new_n57_), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(new_n217_), .c(new_n34_), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n216_), .c(new_n20_), .O(new_n220_));
  aoi21  g204(.a(new_n57_), .b(new_n76_), .c(new_n129_), .O(new_n221_));
  nand3  g205(.a(new_n210_), .b(new_n57_), .c(new_n50_), .O(new_n222_));
  oai21  g206(.a(new_n221_), .b(x0), .c(new_n222_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(x4), .O(new_n224_));
  oai21  g208(.a(new_n57_), .b(new_n18_), .c(x8), .O(new_n225_));
  nand2  g209(.a(new_n225_), .b(new_n50_), .O(new_n226_));
  oai21  g210(.a(x6), .b(new_n50_), .c(x8), .O(new_n227_));
  ...
  nor3   g214(.a(new_n172_), .b(x8), .c(new_n129_), .O(new_n231_));
  aoi21  g215(.a(new_n230_), .b(new_n76_), .c(new_n231_), .O(new_n232_));
  oai22  g216(.a(x3), .b(new_n18_), .c(x2), .d(new_n129_), .O(new_n233_));
  nand3  g217(.a(new_n233_), .b(new_n21_), .c(new_n57_), .O(new_n234_));
  oai21  g218(.a(new_n232_), .b(new_n20_), .c(new_n234_), .O(new_n235_));
  nand2  g219(.a(new_n235_), .b(new_n34_), .O(new_n236_));
  nand3  g220(.a(new_n93_), .b(new_n76_), .c(new_n50_), .O(new_n237_));
  nand4  g221(.a(new_n237_), .b(new_n236_), .c(new_n224_), .d(new_n220_), .O(new_n238_));
  inv1   g222(.a(new_n93_), .O(new_n239_));
  aoi21  g223(.a(x4), .b(x3), .c(x1), .O(new_n240_));
  nand2  g224(.a(new_n159_), .b(x7), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(new_n239_), .c(new_n240_), .O(new_n242_));
  nand2  g226(.a(new_n21_), .b(new_n34_), .O(new_n243_));
  aoi21  g227(.a(new_n243_), .b(new_n153_), .c(new_n57_), .O(new_n244_));
  oai21  g228(.a(new_n244_), .b(new_n242_), .c(new_n17_), .O(new_n245_));
  nand2  g229(.a(x7), .b(x6), .O(new_n246_));
  oai21  g230(.a(new_n246_), .b(x2), .c(new_n239_), .O(new_n247_));
  nand3  g231(.a(new_n247_), .b(new_n34_), .c(x1), .O(new_n248_));
  nand2  g232(.a(new_n248_), .b(new_n245_), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(x0), .O(new_n250_));
  nand2  g234(.a(new_n93_), .b(x2), .O(new_n251_));
  aoi21  g235(.a(new_n251_), .b(new_n246_), .c(new_n34_), .O(new_n252_));
  nand2  g236(.a(new_n32_), .b(x3), .O(new_n253_));
  oai21  g237(.a(new_n41_), .b(x3), .c(new_n253_), .O(new_n254_));
  oai21  g238(.a(new_n254_), .b(new_n252_), .c(x1), .O(new_n255_));
  nand2  g239(.a(new_n68_), .b(new_n18_), .O(new_n256_));
  nand2  g240(.a(new_n21_), .b(x3), .O(new_n257_));
  aoi21  g241(.a(new_n257_), .b(new_n256_), .c(new_n50_), .O(new_n258_));
  nand3  g242(.a(new_n68_), .b(x3), .c(new_n129_), .O(new_n259_));
  inv1   g243(.a(new_n259_), .O(new_n260_));
  oai21  g244(.a(new_n260_), .b(new_n258_), .c(x4), .O(new_n261_));
  nand3  g245(.a(new_n21_), .b(new_n20_), .c(x6), .O(new_n262_));
  nand3  g246(.a(new_n262_), .b(new_n261_), .c(new_n255_), .O(new_n263_));
  nand2  g247(.a(new_n263_), .b(new_n17_), .O(new_n264_));
  nand3  g248(.a(new_n205_), .b(new_n32_), .c(new_n34_), .O(new_n265_));
  nand3  g249(.a(new_n265_), .b(new_n264_), .c(new_n250_), .O(new_n266_));
  aoi21  g250(.a(new_n238_), .b(x5), .c(new_n266_), .O(new_n267_));
  nor2   g251(.a(new_n267_), .b(new_n23_), .O(z4));
  oai21  g252(.a(new_n213_), .b(new_n207_), .c(new_n211_), .O(z5));
endmodule
