...
module FAU ( 
  ...
  nand4  g146(.a(new_n162_), .b(new_n155_), .c(new_n141_), .d(x5), .O(new_n163_));
  and2   g147(.a(new_n163_), .b(x9), .O(z4));
  inv1   g148(.a(new_n158_), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n130_), .c(new_n129_), .O(z5));
endmodule
