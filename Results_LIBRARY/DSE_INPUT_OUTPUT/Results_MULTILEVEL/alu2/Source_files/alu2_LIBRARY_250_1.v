...
module FAU ( 
  ...
  nor2   g113(.a(new_n129_), .b(new_n59_), .O(z2));
  nor3   g114(.a(new_n59_), .b(new_n67_), .c(new_n65_), .O(z3));
  oai21  g115(.a(x7), .b(new_n18_), .c(x8), .O(new_n132_));
  nand3  g116(.a(new_n132_), .b(x3), .c(x1), .O(new_n133_));
  nand2  g117(.a(x8), .b(x7), .O(new_n134_));
  nand4  g118(.a(new_n134_), .b(x6), .c(new_n67_), .d(new_n65_), .O(new_n135_));
  ...
  nand3  g123(.a(x7), .b(x3), .c(new_n17_), .O(new_n140_));
  nand2  g124(.a(new_n22_), .b(new_n18_), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n140_), .c(new_n65_), .O(new_n142_));
  oai21  g126(.a(new_n28_), .b(new_n17_), .c(x8), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n18_), .O(new_n144_));
  nand3  g128(.a(x7), .b(x6), .c(new_n17_), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n144_), .c(x3), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n142_), .c(x0), .O(new_n147_));
  xor2a  g131(.a(x6), .b(x3), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(x7), .c(x1), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(new_n147_), .c(new_n139_), .O(new_n150_));
  oai21  g134(.a(x3), .b(new_n65_), .c(x2), .O(new_n151_));
  aoi21  g135(.a(x3), .b(new_n41_), .c(new_n18_), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n151_), .c(x7), .O(new_n153_));
  aoi21  g137(.a(new_n18_), .b(new_n67_), .c(new_n65_), .O(new_n154_));
  nand2  g138(.a(x3), .b(x1), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n18_), .c(new_n17_), .O(new_n156_));
  oai21  g140(.a(new_n154_), .b(x0), .c(new_n156_), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n153_), .c(x4), .O(new_n158_));
  nand2  g142(.a(new_n67_), .b(new_n17_), .O(new_n159_));
  oai21  g143(.a(new_n159_), .b(new_n141_), .c(new_n158_), .O(new_n160_));
  aoi21  g144(.a(new_n150_), .b(new_n23_), .c(new_n160_), .O(new_n161_));
  nor3   g145(.a(new_n161_), .b(new_n27_), .c(new_n32_), .O(z4));
  oai22  g146(.a(new_n137_), .b(new_n129_), .c(new_n27_), .d(x5), .O(z5));
endmodule
