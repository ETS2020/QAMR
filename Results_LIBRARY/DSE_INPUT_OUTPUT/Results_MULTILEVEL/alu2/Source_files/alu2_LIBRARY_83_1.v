...
module FAU ( 
  ...
  nor3   g113(.a(new_n62_), .b(new_n67_), .c(new_n94_), .O(z3));
  nand2  g114(.a(new_n19_), .b(x8), .O(new_n131_));
  nand3  g115(.a(new_n131_), .b(x3), .c(x1), .O(new_n132_));
  nand3  g116(.a(new_n127_), .b(new_n18_), .c(x6), .O(new_n133_));
  xor2a  g117(.a(x2), .b(x0), .O(new_n134_));
  aoi21  g118(.a(new_n133_), .b(new_n132_), .c(new_n134_), .O(new_n135_));
  nand3  g119(.a(x2), .b(new_n94_), .c(x0), .O(new_n136_));
  nor4   g120(.a(new_n136_), .b(x8), .c(new_n23_), .d(x3), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n135_), .c(x5), .O(new_n138_));
  oai21  g122(.a(x2), .b(new_n42_), .c(x6), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(x3), .O(new_n140_));
  nand2  g124(.a(x6), .b(new_n67_), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n140_), .c(new_n94_), .O(new_n142_));
  xor2a  g126(.a(x6), .b(x2), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(x0), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n69_), .c(x3), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n142_), .c(x7), .O(new_n146_));
  oai22  g130(.a(x3), .b(new_n42_), .c(x2), .d(new_n94_), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(new_n34_), .c(new_n23_), .O(new_n148_));
  ...
  oai21  g136(.a(new_n152_), .b(new_n151_), .c(new_n18_), .O(new_n153_));
  oai21  g137(.a(x6), .b(x3), .c(x1), .O(new_n154_));
  nor2   g138(.a(new_n126_), .b(x6), .O(new_n155_));
  aoi22  g139(.a(new_n155_), .b(new_n17_), .c(new_n154_), .d(new_n42_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand4  g141(.a(new_n34_), .b(new_n23_), .c(new_n67_), .d(new_n17_), .O(new_n158_));
  ...
  inv1   g145(.a(new_n62_), .O(new_n162_));
  nor2   g146(.a(new_n134_), .b(new_n128_), .O(new_n163_));
