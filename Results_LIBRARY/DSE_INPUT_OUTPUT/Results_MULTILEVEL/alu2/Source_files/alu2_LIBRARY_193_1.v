...
module FAU ( 
  ...
  nand3  g141(.a(new_n157_), .b(new_n150_), .c(new_n136_), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(x9), .c(x5), .O(new_n159_));
  inv1   g143(.a(new_n159_), .O(z4));
  inv1   g144(.a(new_n61_), .O(new_n161_));
  inv1   g145(.a(new_n153_), .O(new_n162_));
  oai21  g146(.a(new_n162_), .b(new_n125_), .c(new_n161_), .O(z5));
endmodule
