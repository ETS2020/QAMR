...
module FAU ( 
  ...
  nor2   g025(.a(new_n19_), .b(x2), .O(new_n42_));
  ...
  nand2  g032(.a(new_n24_), .b(new_n18_), .O(new_n49_));
  ...
  nand3  g037(.a(x7), .b(new_n18_), .c(x2), .O(new_n54_));
  nand2  g038(.a(new_n31_), .b(new_n23_), .O(new_n55_));
  ...
  nand2  g049(.a(new_n65_), .b(new_n53_), .O(z0));
  ...
  nand2  g060(.a(new_n24_), .b(x3), .O(new_n77_));
  aoi21  g061(.a(new_n77_), .b(x0), .c(new_n31_), .O(new_n78_));
  ...
  oai21  g066(.a(x8), .b(x2), .c(new_n35_), .O(new_n83_));
  ...
  oai21  g070(.a(new_n23_), .b(x0), .c(new_n24_), .O(new_n87_));
  nand3  g071(.a(new_n25_), .b(new_n23_), .c(x0), .O(new_n88_));
  ...
  nand3  g075(.a(x3), .b(new_n23_), .c(x0), .O(new_n92_));
  ...
  nand3  g085(.a(new_n101_), .b(new_n19_), .c(x0), .O(new_n102_));
  nand3  g086(.a(new_n42_), .b(x9), .c(x8), .O(new_n103_));
  nand2  g087(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g088(.a(new_n104_), .b(new_n18_), .O(new_n105_));
  nand2  g089(.a(x8), .b(new_n31_), .O(new_n106_));
  oai21  g090(.a(new_n106_), .b(new_n23_), .c(new_n83_), .O(new_n107_));
  ...
  aoi21  g094(.a(new_n110_), .b(x6), .c(new_n35_), .O(new_n111_));
  nor2   g095(.a(new_n110_), .b(x2), .O(new_n112_));
  oai21  g096(.a(new_n112_), .b(new_n111_), .c(new_n24_), .O(new_n113_));
  oai21  g097(.a(x9), .b(x6), .c(new_n113_), .O(new_n114_));
  nand2  g098(.a(new_n114_), .b(x3), .O(new_n115_));
  nand2  g099(.a(new_n28_), .b(new_n19_), .O(new_n116_));
  nand2  g100(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  oai21  g101(.a(new_n117_), .b(new_n109_), .c(new_n72_), .O(new_n118_));
  oai21  g102(.a(x8), .b(new_n72_), .c(new_n23_), .O(new_n119_));
  nand2  g103(.a(new_n119_), .b(x0), .O(new_n120_));
  nand4  g104(.a(new_n24_), .b(x5), .c(new_n23_), .d(x1), .O(new_n121_));
  aoi21  g105(.a(new_n121_), .b(new_n120_), .c(new_n31_), .O(new_n122_));
  nand3  g106(.a(x9), .b(new_n31_), .c(new_n19_), .O(new_n123_));
  ...
  oai22  g110(.a(new_n126_), .b(x0), .c(new_n24_), .d(new_n23_), .O(new_n127_));
  nand4  g111(.a(new_n127_), .b(x9), .c(new_n31_), .d(x1), .O(new_n128_));
  nand2  g112(.a(new_n28_), .b(x7), .O(new_n129_));
  nand3  g113(.a(new_n129_), .b(new_n128_), .c(new_n125_), .O(new_n130_));
  nor2   g114(.a(new_n24_), .b(x2), .O(new_n131_));
  aoi21  g115(.a(x5), .b(new_n23_), .c(x0), .O(new_n132_));
  oai21  g116(.a(new_n132_), .b(new_n131_), .c(new_n68_), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n106_), .O(new_n134_));
  nand4  g118(.a(new_n134_), .b(x9), .c(new_n18_), .d(x1), .O(new_n135_));
  inv1   g119(.a(new_n135_), .O(new_n136_));
  aoi21  g120(.a(new_n130_), .b(x3), .c(new_n136_), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(new_n118_), .c(new_n99_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n17_), .O(new_n139_));
  nand3  g123(.a(x7), .b(new_n18_), .c(x3), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n69_), .c(x1), .O(new_n141_));
  nand2  g125(.a(x7), .b(x1), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n18_), .c(x3), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n141_), .c(new_n19_), .O(new_n144_));
  aoi21  g128(.a(x4), .b(new_n68_), .c(x7), .O(new_n145_));
  oai22  g129(.a(new_n145_), .b(new_n18_), .c(new_n61_), .d(new_n68_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(x1), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n28_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n139_), .O(z1));
  ...
  nand2  g139(.a(new_n155_), .b(new_n151_), .O(z2));
  nand2  g140(.a(new_n153_), .b(new_n151_), .O(z3));
  nand3  g141(.a(new_n154_), .b(new_n23_), .c(new_n35_), .O(new_n158_));
  nand4  g142(.a(new_n68_), .b(x2), .c(new_n72_), .d(x0), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  oai21  g144(.a(new_n41_), .b(new_n24_), .c(new_n160_), .O(new_n161_));
  ...
  aoi21  g149(.a(new_n100_), .b(x8), .c(x6), .O(new_n166_));
  nand2  g150(.a(x7), .b(x6), .O(new_n167_));
  nor2   g151(.a(new_n167_), .b(x2), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n166_), .c(new_n68_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x0), .O(new_n171_));
  oai22  g155(.a(new_n167_), .b(x3), .c(new_n49_), .d(x2), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(x1), .O(new_n173_));
  nand4  g157(.a(new_n24_), .b(new_n18_), .c(new_n68_), .d(new_n23_), .O(new_n174_));
  nand4  g158(.a(new_n174_), .b(new_n173_), .c(new_n171_), .d(new_n161_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x5), .O(new_n176_));
  aoi21  g160(.a(new_n77_), .b(new_n25_), .c(new_n23_), .O(new_n177_));
  oai21  g161(.a(new_n18_), .b(new_n19_), .c(new_n24_), .O(new_n178_));
  nand3  g162(.a(new_n31_), .b(x3), .c(x2), .O(new_n179_));
  nand3  g163(.a(new_n179_), .b(x6), .c(new_n19_), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(new_n178_), .O(new_n181_));
  oai21  g165(.a(new_n181_), .b(new_n177_), .c(x1), .O(new_n182_));
  nand2  g166(.a(new_n55_), .b(x8), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(x6), .c(new_n19_), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n182_), .c(new_n35_), .O(new_n185_));
  nand3  g169(.a(new_n41_), .b(new_n19_), .c(new_n68_), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n140_), .c(new_n72_), .O(new_n187_));
