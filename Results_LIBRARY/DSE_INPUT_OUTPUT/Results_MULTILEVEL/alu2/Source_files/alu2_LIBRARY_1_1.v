...
module FAU ( 
  ...
  nand3  g120(.a(x6), .b(x3), .c(x2), .O(new_n137_));
  nand2  g121(.a(new_n29_), .b(x4), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n83_), .O(new_n139_));
  oai21  g123(.a(new_n29_), .b(x3), .c(new_n18_), .O(new_n140_));
  ...
  oai21  g127(.a(new_n143_), .b(new_n139_), .c(new_n26_), .O(new_n144_));
  nand2  g128(.a(x3), .b(x1), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(x4), .c(new_n17_), .O(new_n146_));
  nand3  g130(.a(new_n85_), .b(new_n18_), .c(new_n82_), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n146_), .c(x6), .O(new_n148_));
  oai21  g132(.a(new_n29_), .b(x2), .c(x8), .O(new_n149_));
  ...
  aoi21  g136(.a(new_n152_), .b(new_n144_), .c(new_n21_), .O(new_n153_));
  oai21  g137(.a(new_n138_), .b(new_n82_), .c(new_n83_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n85_), .O(new_n155_));
  oai21  g139(.a(new_n26_), .b(x1), .c(new_n17_), .O(new_n156_));
  oai21  g140(.a(x7), .b(new_n82_), .c(x1), .O(new_n157_));
  nand2  g141(.a(new_n91_), .b(new_n25_), .O(new_n158_));
  nand3  g142(.a(x4), .b(x3), .c(new_n83_), .O(new_n159_));
  nand4  g143(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n156_), .O(new_n160_));
  ...
  aoi21  g148(.a(x3), .b(x2), .c(new_n29_), .O(new_n165_));
  oai21  g149(.a(x6), .b(new_n82_), .c(x8), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n165_), .c(x7), .O(new_n167_));
  oai21  g151(.a(x8), .b(x6), .c(new_n167_), .O(new_n168_));
  nand3  g152(.a(new_n168_), .b(new_n18_), .c(x1), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n164_), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n153_), .c(x9), .O(new_n171_));
  nor2   g155(.a(new_n171_), .b(new_n41_), .O(z4));
  xor2a  g156(.a(x2), .b(x0), .O(new_n173_));
  oai22  g157(.a(new_n173_), .b(new_n133_), .c(new_n42_), .d(x0), .O(z5));
endmodule
