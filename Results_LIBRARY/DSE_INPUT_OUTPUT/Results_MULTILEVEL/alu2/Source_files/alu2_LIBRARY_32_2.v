...
module FAU ( 
  ...
  nor2   g195(.a(new_n110_), .b(new_n142_), .O(new_n212_));
  nor2   g196(.a(x3), .b(x1), .O(new_n213_));
  nor2   g197(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nor2   g198(.a(new_n214_), .b(new_n211_), .O(z2));
  inv1   g199(.a(new_n211_), .O(new_n216_));
  inv1   g200(.a(new_n212_), .O(new_n217_));
  nand2  g201(.a(new_n217_), .b(new_n216_), .O(z3));
  xor2a  g202(.a(x2), .b(x0), .O(new_n219_));
  nor2   g203(.a(new_n219_), .b(new_n214_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(x6), .O(new_n221_));
  inv1   g205(.a(new_n221_), .O(new_n222_));
  oai21  g206(.a(x3), .b(new_n142_), .c(x2), .O(new_n223_));
  aoi21  g207(.a(x3), .b(new_n18_), .c(new_n22_), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n223_), .c(new_n33_), .O(new_n225_));
  oai21  g209(.a(new_n225_), .b(new_n222_), .c(new_n20_), .O(new_n226_));
  aoi21  g210(.a(new_n22_), .b(new_n110_), .c(new_n142_), .O(new_n227_));
  nand3  g211(.a(new_n217_), .b(new_n22_), .c(new_n21_), .O(new_n228_));
  ...
  nand4  g228(.a(new_n244_), .b(new_n242_), .c(new_n230_), .d(new_n226_), .O(new_n245_));
  ...
  nand3  g255(.a(new_n212_), .b(new_n45_), .c(new_n33_), .O(new_n272_));
  ...
  oai21  g259(.a(new_n219_), .b(new_n214_), .c(new_n216_), .O(z5));
endmodule
