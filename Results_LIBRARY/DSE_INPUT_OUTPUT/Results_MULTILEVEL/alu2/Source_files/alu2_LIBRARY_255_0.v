...
module FAU ( 
  ...
  aoi21  g212(.a(new_n228_), .b(new_n220_), .c(new_n34_), .O(new_n229_));
  nand2  g213(.a(x3), .b(x1), .O(new_n230_));
  nand2  g214(.a(new_n82_), .b(new_n80_), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n230_), .c(new_n23_), .O(new_n232_));
  or2    g216(.a(new_n232_), .b(new_n229_), .O(z2));
  oai21  g217(.a(x9), .b(x6), .c(new_n230_), .O(z3));
  xor2a  g218(.a(x2), .b(x0), .O(new_n235_));
  aoi21  g219(.a(new_n231_), .b(new_n230_), .c(new_n235_), .O(new_n236_));
  ...
  nand3  g227(.a(new_n230_), .b(new_n34_), .c(new_n33_), .O(new_n244_));
  nand2  g228(.a(new_n244_), .b(new_n243_), .O(new_n245_));
  nand2  g229(.a(new_n245_), .b(x4), .O(new_n246_));
  oai21  g230(.a(new_n34_), .b(new_n17_), .c(x8), .O(new_n247_));
  nand2  g231(.a(new_n247_), .b(new_n33_), .O(new_n248_));
  oai21  g232(.a(x6), .b(new_n33_), .c(x8), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(x0), .O(new_n250_));
  nand2  g234(.a(x6), .b(x1), .O(new_n251_));
  nand3  g235(.a(new_n251_), .b(new_n250_), .c(new_n248_), .O(new_n252_));
  oai21  g236(.a(new_n33_), .b(x0), .c(new_n18_), .O(new_n253_));
  nor2   g237(.a(new_n253_), .b(new_n80_), .O(new_n254_));
  aoi21  g238(.a(new_n252_), .b(new_n82_), .c(new_n254_), .O(new_n255_));
  oai22  g239(.a(x3), .b(new_n17_), .c(x2), .d(new_n80_), .O(new_n256_));
  nand3  g240(.a(new_n256_), .b(new_n18_), .c(new_n34_), .O(new_n257_));
  oai21  g241(.a(new_n255_), .b(new_n22_), .c(new_n257_), .O(new_n258_));
  nand2  g242(.a(new_n258_), .b(new_n54_), .O(new_n259_));
  nand2  g243(.a(new_n115_), .b(new_n38_), .O(new_n260_));
  nand4  g244(.a(new_n260_), .b(new_n259_), .c(new_n246_), .d(new_n242_), .O(new_n261_));
  nand2  g245(.a(new_n261_), .b(x5), .O(new_n262_));
  oai21  g246(.a(x6), .b(x2), .c(x7), .O(new_n263_));
  aoi22  g247(.a(new_n263_), .b(new_n39_), .c(new_n95_), .d(new_n80_), .O(new_n264_));
  nand2  g248(.a(new_n18_), .b(new_n54_), .O(new_n265_));
  aoi21  g249(.a(new_n265_), .b(new_n96_), .c(new_n34_), .O(new_n266_));
  oai21  g250(.a(new_n266_), .b(new_n264_), .c(new_n27_), .O(new_n267_));
  nand2  g251(.a(x7), .b(x6), .O(new_n268_));
  oai21  g252(.a(new_n268_), .b(x2), .c(new_n39_), .O(new_n269_));
  nand3  g253(.a(new_n269_), .b(new_n54_), .c(x1), .O(new_n270_));
  nand2  g254(.a(new_n270_), .b(new_n267_), .O(new_n271_));
  nand2  g255(.a(new_n271_), .b(x0), .O(new_n272_));
  nand2  g256(.a(new_n38_), .b(x2), .O(new_n273_));
  aoi21  g257(.a(new_n273_), .b(new_n268_), .c(new_n54_), .O(new_n274_));
  nand2  g258(.a(new_n70_), .b(x3), .O(new_n275_));
  oai21  g259(.a(new_n28_), .b(x3), .c(new_n275_), .O(new_n276_));
  oai21  g260(.a(new_n276_), .b(new_n274_), .c(x1), .O(new_n277_));
  nand2  g261(.a(new_n29_), .b(new_n17_), .O(new_n278_));
  nand2  g262(.a(new_n18_), .b(x3), .O(new_n279_));
  aoi21  g263(.a(new_n279_), .b(new_n278_), .c(new_n33_), .O(new_n280_));
  nand3  g264(.a(new_n29_), .b(x3), .c(new_n80_), .O(new_n281_));
  inv1   g265(.a(new_n281_), .O(new_n282_));
  oai21  g266(.a(new_n282_), .b(new_n280_), .c(x4), .O(new_n283_));
  nand3  g267(.a(new_n18_), .b(new_n22_), .c(x6), .O(new_n284_));
  nand3  g268(.a(new_n284_), .b(new_n283_), .c(new_n277_), .O(new_n285_));
  nand2  g269(.a(new_n285_), .b(new_n27_), .O(new_n286_));
  or2    g270(.a(new_n230_), .b(new_n162_), .O(new_n287_));
  nand3  g271(.a(new_n287_), .b(new_n286_), .c(new_n272_), .O(new_n288_));
  inv1   g272(.a(new_n288_), .O(new_n289_));
  aoi21  g273(.a(new_n289_), .b(new_n262_), .c(new_n23_), .O(z4));
  oai21  g274(.a(x9), .b(x6), .c(new_n236_), .O(new_n291_));
