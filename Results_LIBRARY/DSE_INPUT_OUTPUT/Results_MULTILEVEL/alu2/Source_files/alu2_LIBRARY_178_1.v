...
module FAU ( 
  ...
  oai21  g148(.a(x8), .b(x6), .c(new_n29_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(x1), .O(new_n166_));
  nand2  g150(.a(x7), .b(x0), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(x8), .c(new_n71_), .O(new_n168_));
  aoi21  g152(.a(new_n57_), .b(new_n32_), .c(new_n168_), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n166_), .c(x5), .O(new_n170_));
  oai21  g154(.a(x6), .b(x3), .c(x1), .O(new_n171_));
  nand3  g155(.a(x6), .b(new_n71_), .c(x1), .O(new_n172_));
  aoi22  g156(.a(new_n172_), .b(new_n19_), .c(new_n171_), .d(new_n32_), .O(new_n173_));
  nand3  g157(.a(new_n57_), .b(x3), .c(new_n70_), .O(new_n174_));
  oai21  g158(.a(new_n173_), .b(new_n18_), .c(new_n174_), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n170_), .c(x4), .O(new_n176_));
  nand3  g160(.a(x7), .b(x5), .c(new_n20_), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(new_n78_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n71_), .O(new_n179_));
  nand4  g163(.a(new_n19_), .b(x5), .c(x3), .d(x0), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n179_), .c(new_n25_), .O(new_n181_));
  nand2  g165(.a(x5), .b(x4), .O(new_n182_));
  oai22  g166(.a(x8), .b(new_n32_), .c(new_n19_), .d(new_n71_), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(new_n182_), .c(new_n25_), .O(new_n184_));
  oai21  g168(.a(x8), .b(x4), .c(x5), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(x7), .c(x0), .O(new_n186_));
  nand2  g170(.a(new_n186_), .b(new_n184_), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n181_), .c(x1), .O(new_n188_));
  nand3  g172(.a(new_n54_), .b(x5), .c(new_n71_), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n35_), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n20_), .c(x0), .O(new_n191_));
  oai21  g175(.a(new_n54_), .b(x5), .c(new_n191_), .O(new_n192_));
  nand2  g176(.a(new_n192_), .b(new_n46_), .O(new_n193_));
  oai22  g177(.a(new_n134_), .b(x4), .c(new_n54_), .d(x1), .O(new_n194_));
  nand4  g178(.a(new_n194_), .b(x5), .c(new_n71_), .d(x0), .O(new_n195_));
  nand4  g179(.a(new_n195_), .b(new_n193_), .c(new_n188_), .d(new_n176_), .O(new_n196_));
  nand3  g180(.a(new_n196_), .b(x9), .c(x2), .O(new_n197_));
  inv1   g181(.a(new_n197_), .O(z4));
  nand2  g182(.a(x2), .b(x0), .O(new_n199_));
  nand3  g183(.a(new_n17_), .b(new_n24_), .c(new_n32_), .O(new_n200_));
  aoi21  g184(.a(new_n200_), .b(new_n199_), .c(new_n162_), .O(z5));
endmodule
