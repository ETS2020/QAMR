...
module FAU ( 
  ...
  inv1   g124(.a(new_n138_), .O(new_n141_));
  oai21  g125(.a(new_n65_), .b(new_n67_), .c(new_n141_), .O(z3));
  nand3  g126(.a(new_n20_), .b(x4), .c(x3), .O(new_n143_));
  nand4  g127(.a(new_n35_), .b(x5), .c(new_n65_), .d(x2), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n143_), .c(x1), .O(new_n145_));
  nand2  g129(.a(x7), .b(x5), .O(new_n146_));
  oai22  g130(.a(new_n146_), .b(new_n54_), .c(x5), .d(new_n67_), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n65_), .O(new_n148_));
  nand2  g132(.a(new_n35_), .b(x5), .O(new_n149_));
  oai22  g133(.a(new_n149_), .b(new_n102_), .c(x5), .d(x2), .O(new_n150_));
  nand2  g134(.a(new_n150_), .b(x1), .O(new_n151_));
  nand3  g135(.a(new_n35_), .b(new_n20_), .c(new_n34_), .O(new_n152_));
  nand3  g136(.a(new_n152_), .b(new_n151_), .c(new_n148_), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n145_), .c(x6), .O(new_n154_));
  oai21  g138(.a(x4), .b(x3), .c(x5), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x1), .O(new_n156_));
  nand4  g140(.a(new_n21_), .b(x5), .c(new_n19_), .d(new_n65_), .O(new_n157_));
  nand3  g141(.a(new_n157_), .b(new_n156_), .c(new_n143_), .O(new_n158_));
  nand2  g142(.a(new_n158_), .b(x2), .O(new_n159_));
  nand2  g143(.a(new_n54_), .b(x5), .O(new_n160_));
  ...
  nand2  g148(.a(x3), .b(new_n34_), .O(new_n165_));
  oai21  g149(.a(new_n149_), .b(new_n165_), .c(new_n76_), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(new_n17_), .O(new_n167_));
  aoi21  g151(.a(x7), .b(new_n19_), .c(x5), .O(new_n168_));
  nor2   g152(.a(new_n146_), .b(x4), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n168_), .c(new_n65_), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n167_), .c(new_n21_), .O(new_n171_));
  aoi21  g155(.a(x6), .b(new_n19_), .c(x5), .O(new_n172_));
  nor2   g156(.a(x6), .b(x4), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n172_), .c(x7), .O(new_n174_));
  nor2   g158(.a(new_n174_), .b(new_n65_), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n171_), .c(x1), .O(new_n176_));
  aoi21  g160(.a(new_n65_), .b(x1), .c(new_n34_), .O(new_n177_));
  oai21  g161(.a(new_n65_), .b(x0), .c(x6), .O(new_n178_));
  oai21  g162(.a(new_n178_), .b(new_n177_), .c(new_n35_), .O(new_n179_));
  oai21  g163(.a(x6), .b(x3), .c(x1), .O(new_n180_));
  aoi21  g164(.a(x3), .b(x1), .c(x6), .O(new_n181_));
  aoi22  g165(.a(new_n181_), .b(new_n34_), .c(new_n180_), .d(new_n17_), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n179_), .c(new_n20_), .O(new_n183_));
  oai22  g167(.a(new_n65_), .b(x1), .c(new_n34_), .d(x0), .O(new_n184_));
  nand4  g168(.a(new_n184_), .b(new_n35_), .c(x6), .d(new_n20_), .O(new_n185_));
  inv1   g169(.a(new_n185_), .O(new_n186_));
  oai21  g170(.a(new_n186_), .b(new_n183_), .c(x4), .O(new_n187_));
  nand3  g171(.a(new_n22_), .b(x5), .c(new_n65_), .O(new_n188_));
  nor3   g172(.a(new_n188_), .b(new_n114_), .c(x0), .O(new_n189_));
  nor2   g173(.a(new_n189_), .b(new_n18_), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n187_), .c(new_n176_), .O(new_n191_));
  aoi21  g175(.a(new_n164_), .b(x0), .c(new_n191_), .O(new_n192_));
  nor2   g176(.a(new_n192_), .b(new_n30_), .O(z4));
  xor2a  g177(.a(x2), .b(x0), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n139_), .c(new_n141_), .O(z5));
endmodule
