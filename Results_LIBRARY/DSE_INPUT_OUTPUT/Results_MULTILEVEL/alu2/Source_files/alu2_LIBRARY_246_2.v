...
module FAU ( 
  ...
  nand2  g194(.a(new_n19_), .b(x8), .O(new_n211_));
  nor2   g195(.a(x3), .b(x1), .O(new_n212_));
  nor2   g196(.a(new_n110_), .b(new_n142_), .O(new_n213_));
  nor2   g197(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n211_), .O(z2));
  inv1   g199(.a(new_n213_), .O(new_n216_));
  nand2  g200(.a(new_n216_), .b(new_n211_), .O(z3));
  ...
  nand3  g210(.a(new_n216_), .b(new_n22_), .c(new_n21_), .O(new_n227_));
  oai21  g211(.a(new_n226_), .b(x0), .c(new_n227_), .O(new_n228_));
  nand2  g212(.a(new_n228_), .b(x4), .O(new_n229_));
  oai21  g213(.a(new_n22_), .b(new_n18_), .c(x8), .O(new_n230_));
  nand2  g214(.a(new_n230_), .b(new_n21_), .O(new_n231_));
  oai21  g215(.a(x6), .b(new_n21_), .c(x8), .O(new_n232_));
  ...
  nor3   g219(.a(new_n183_), .b(x8), .c(new_n142_), .O(new_n236_));
  aoi21  g220(.a(new_n235_), .b(new_n110_), .c(new_n236_), .O(new_n237_));
  oai22  g221(.a(x3), .b(new_n18_), .c(x2), .d(new_n142_), .O(new_n238_));
  nand3  g222(.a(new_n238_), .b(new_n17_), .c(new_n22_), .O(new_n239_));
  ...
  nand3  g226(.a(new_n242_), .b(new_n110_), .c(new_n21_), .O(new_n243_));
  nand4  g227(.a(new_n243_), .b(new_n241_), .c(new_n229_), .d(new_n225_), .O(new_n244_));
  inv1   g228(.a(new_n242_), .O(new_n245_));
  aoi21  g229(.a(x4), .b(x3), .c(x1), .O(new_n246_));
  nand2  g230(.a(new_n88_), .b(x7), .O(new_n247_));
  aoi21  g231(.a(new_n247_), .b(new_n245_), .c(new_n246_), .O(new_n248_));
  nand2  g232(.a(new_n17_), .b(new_n33_), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(new_n165_), .c(new_n22_), .O(new_n250_));
  oai21  g234(.a(new_n250_), .b(new_n248_), .c(new_n40_), .O(new_n251_));
  nand2  g235(.a(x7), .b(x6), .O(new_n252_));
  oai21  g236(.a(new_n252_), .b(x2), .c(new_n245_), .O(new_n253_));
  nand3  g237(.a(new_n253_), .b(new_n33_), .c(x1), .O(new_n254_));
  nand2  g238(.a(new_n254_), .b(new_n251_), .O(new_n255_));
  nand2  g239(.a(new_n255_), .b(x0), .O(new_n256_));
  nand2  g240(.a(new_n242_), .b(x2), .O(new_n257_));
  aoi21  g241(.a(new_n257_), .b(new_n252_), .c(new_n33_), .O(new_n258_));
  nand2  g242(.a(new_n45_), .b(x3), .O(new_n259_));
  oai21  g243(.a(new_n30_), .b(x3), .c(new_n259_), .O(new_n260_));
  oai21  g244(.a(new_n260_), .b(new_n258_), .c(x1), .O(new_n261_));
  nand2  g245(.a(new_n31_), .b(new_n18_), .O(new_n262_));
  nand2  g246(.a(new_n17_), .b(x3), .O(new_n263_));
  aoi21  g247(.a(new_n263_), .b(new_n262_), .c(new_n21_), .O(new_n264_));
  nand3  g248(.a(new_n31_), .b(x3), .c(new_n142_), .O(new_n265_));
  inv1   g249(.a(new_n265_), .O(new_n266_));
  oai21  g250(.a(new_n266_), .b(new_n264_), .c(x4), .O(new_n267_));
  nand3  g251(.a(new_n17_), .b(new_n20_), .c(x6), .O(new_n268_));
  nand3  g252(.a(new_n268_), .b(new_n267_), .c(new_n261_), .O(new_n269_));
  nand2  g253(.a(new_n269_), .b(new_n40_), .O(new_n270_));
  nand3  g254(.a(new_n213_), .b(new_n45_), .c(new_n33_), .O(new_n271_));
  nand3  g255(.a(new_n271_), .b(new_n270_), .c(new_n256_), .O(new_n272_));
  aoi21  g256(.a(new_n244_), .b(x5), .c(new_n272_), .O(new_n273_));
  nor2   g257(.a(new_n273_), .b(new_n19_), .O(z4));
  nand2  g258(.a(new_n219_), .b(new_n211_), .O(new_n275_));
