...
module FAU ( 
  ...
  oai21  g148(.a(new_n70_), .b(new_n112_), .c(new_n164_), .O(z3));
  nor2   g149(.a(x2), .b(new_n71_), .O(new_n166_));
  nor2   g150(.a(new_n44_), .b(x0), .O(new_n167_));
  oai22  g151(.a(new_n167_), .b(new_n166_), .c(new_n26_), .d(x1), .O(new_n168_));
  nor2   g152(.a(x3), .b(new_n112_), .O(new_n169_));
  nor3   g153(.a(new_n18_), .b(new_n70_), .c(x1), .O(new_n170_));
  oai22  g154(.a(new_n170_), .b(new_n169_), .c(new_n26_), .d(x0), .O(new_n171_));
  nor2   g155(.a(new_n26_), .b(new_n112_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n143_), .c(x0), .O(new_n173_));
  inv1   g157(.a(new_n95_), .O(new_n174_));
  aoi21  g158(.a(new_n26_), .b(x3), .c(new_n18_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(x1), .c(new_n174_), .O(new_n176_));
  nand4  g160(.a(new_n176_), .b(new_n173_), .c(new_n171_), .d(new_n168_), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(x6), .O(new_n178_));
  nand3  g162(.a(new_n33_), .b(x4), .c(x3), .O(new_n179_));
  nand2  g163(.a(new_n179_), .b(new_n112_), .O(new_n180_));
  nand3  g164(.a(new_n180_), .b(new_n133_), .c(x0), .O(new_n181_));
  aoi22  g165(.a(new_n50_), .b(x2), .c(x7), .d(x3), .O(new_n182_));
  nand3  g166(.a(new_n50_), .b(x3), .c(x2), .O(new_n183_));
  oai21  g167(.a(new_n182_), .b(new_n112_), .c(new_n183_), .O(new_n184_));
  nor4   g168(.a(new_n49_), .b(new_n70_), .c(new_n17_), .d(x1), .O(new_n185_));
  aoi21  g169(.a(new_n184_), .b(new_n33_), .c(new_n185_), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(new_n181_), .c(new_n178_), .O(new_n187_));
  nand3  g171(.a(new_n187_), .b(x9), .c(new_n19_), .O(new_n188_));
  inv1   g172(.a(new_n188_), .O(z4));
  xor2a  g173(.a(x2), .b(x0), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(new_n162_), .c(new_n164_), .O(z5));
endmodule
