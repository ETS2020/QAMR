...
module FAU ( 
  ...
  nand3  g121(.a(x7), .b(x3), .c(new_n17_), .O(new_n138_));
  nand2  g122(.a(new_n22_), .b(new_n18_), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(new_n138_), .c(new_n65_), .O(new_n140_));
  oai21  g124(.a(new_n28_), .b(new_n17_), .c(x8), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n18_), .O(new_n142_));
  nand3  g126(.a(x7), .b(x6), .c(new_n17_), .O(new_n143_));
  ...
  oai21  g132(.a(new_n148_), .b(new_n137_), .c(new_n23_), .O(new_n149_));
  aoi21  g133(.a(new_n67_), .b(x1), .c(new_n17_), .O(new_n150_));
  oai21  g134(.a(new_n67_), .b(x0), .c(x6), .O(new_n151_));
  oai21  g135(.a(new_n151_), .b(new_n150_), .c(new_n28_), .O(new_n152_));
  oai21  g136(.a(x6), .b(x3), .c(x1), .O(new_n153_));
  aoi21  g137(.a(x3), .b(x1), .c(x6), .O(new_n154_));
  aoi22  g138(.a(new_n154_), .b(new_n17_), .c(new_n153_), .d(new_n41_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g140(.a(new_n67_), .b(new_n17_), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n139_), .c(x5), .O(new_n158_));
  aoi21  g142(.a(new_n156_), .b(x4), .c(new_n158_), .O(new_n159_));
  aoi21  g143(.a(new_n159_), .b(new_n149_), .c(new_n27_), .O(z4));
  oai22  g144(.a(new_n136_), .b(new_n129_), .c(new_n27_), .d(x5), .O(z5));
endmodule
