...
module FAU ( 
  ...
  oai21  g148(.a(new_n69_), .b(new_n111_), .c(new_n164_), .O(z3));
  nor2   g149(.a(x3), .b(new_n111_), .O(new_n166_));
  nor3   g150(.a(new_n18_), .b(new_n69_), .c(x1), .O(new_n167_));
  oai22  g151(.a(new_n167_), .b(new_n166_), .c(new_n26_), .d(x0), .O(new_n168_));
  nor2   g152(.a(x2), .b(new_n70_), .O(new_n169_));
  nor2   g153(.a(new_n44_), .b(x0), .O(new_n170_));
  oai22  g154(.a(new_n170_), .b(new_n169_), .c(new_n26_), .d(x1), .O(new_n171_));
  aoi21  g155(.a(x4), .b(new_n69_), .c(new_n70_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n26_), .c(new_n20_), .O(new_n173_));
  oai21  g157(.a(new_n26_), .b(x0), .c(x3), .O(new_n174_));
  ...
  oai21  g170(.a(new_n186_), .b(new_n162_), .c(new_n164_), .O(z5));
endmodule
