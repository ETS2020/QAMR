...
module FAU ( 
  ...
  nand2  g144(.a(new_n68_), .b(new_n110_), .O(new_n161_));
  and2   g145(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nor2   g146(.a(new_n162_), .b(new_n65_), .O(z2));
  inv1   g147(.a(new_n65_), .O(new_n164_));
  nand2  g148(.a(new_n160_), .b(new_n164_), .O(z3));
  inv1   g149(.a(new_n138_), .O(new_n166_));
  aoi21  g150(.a(x4), .b(x3), .c(x1), .O(new_n167_));
  oai21  g151(.a(x6), .b(x2), .c(x7), .O(new_n168_));
  aoi21  g152(.a(new_n168_), .b(new_n166_), .c(new_n167_), .O(new_n169_));
  nor2   g153(.a(new_n141_), .b(new_n88_), .O(new_n170_));
  nor2   g154(.a(new_n170_), .b(new_n33_), .O(new_n171_));
  oai21  g155(.a(new_n171_), .b(new_n169_), .c(x0), .O(new_n172_));
  nand2  g156(.a(x7), .b(x6), .O(new_n173_));
  nand2  g157(.a(new_n138_), .b(x2), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n173_), .c(new_n18_), .O(new_n175_));
  nand2  g159(.a(new_n148_), .b(new_n111_), .O(new_n176_));
  oai21  g160(.a(new_n176_), .b(new_n175_), .c(x1), .O(new_n177_));
  nand2  g161(.a(new_n118_), .b(new_n69_), .O(new_n178_));
  nand2  g162(.a(new_n20_), .b(x3), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n178_), .c(new_n17_), .O(new_n180_));
  nand3  g164(.a(new_n118_), .b(x3), .c(new_n110_), .O(new_n181_));
  inv1   g165(.a(new_n181_), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n180_), .c(x4), .O(new_n183_));
  nand3  g167(.a(new_n20_), .b(new_n26_), .c(x6), .O(new_n184_));
  nand4  g168(.a(new_n184_), .b(new_n183_), .c(new_n177_), .d(new_n172_), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(x9), .c(new_n19_), .O(new_n186_));
  inv1   g170(.a(new_n186_), .O(z4));
  inv1   g171(.a(new_n162_), .O(new_n188_));
  xnor2a g172(.a(x2), .b(x0), .O(new_n189_));
  nand3  g173(.a(new_n189_), .b(new_n188_), .c(new_n164_), .O(new_n190_));
