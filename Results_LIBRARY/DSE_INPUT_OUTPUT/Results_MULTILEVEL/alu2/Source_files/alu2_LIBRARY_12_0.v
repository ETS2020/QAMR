...
module FAU ( 
  ...
  nor2   g035(.a(new_n23_), .b(x6), .O(new_n52_));
  ...
  nand2  g150(.a(new_n19_), .b(new_n30_), .O(new_n167_));
  nand4  g151(.a(new_n23_), .b(x6), .c(new_n18_), .d(x4), .O(new_n168_));
  aoi21  g152(.a(new_n168_), .b(new_n167_), .c(new_n17_), .O(new_n169_));
  aoi21  g153(.a(new_n45_), .b(new_n39_), .c(x6), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n169_), .c(new_n83_), .O(new_n171_));
  nand2  g155(.a(new_n107_), .b(new_n26_), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(new_n29_), .O(new_n174_));
  nand2  g158(.a(x7), .b(x0), .O(new_n175_));
  nand3  g159(.a(new_n39_), .b(new_n23_), .c(new_n83_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n175_), .c(new_n30_), .O(new_n177_));
  nand2  g161(.a(x8), .b(new_n29_), .O(new_n178_));
  nand3  g162(.a(new_n178_), .b(new_n34_), .c(new_n17_), .O(new_n179_));
  aoi21  g163(.a(x7), .b(new_n17_), .c(x5), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(x0), .c(new_n39_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n179_), .c(x3), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n177_), .c(x6), .O(new_n183_));
  oai21  g167(.a(x3), .b(x2), .c(x7), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(x8), .c(new_n19_), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(new_n183_), .c(new_n174_), .O(new_n186_));
  nand2  g170(.a(new_n186_), .b(x9), .O(new_n187_));
  nand3  g171(.a(new_n162_), .b(x4), .c(new_n83_), .O(new_n188_));
  ...
  nand2  g179(.a(new_n65_), .b(new_n18_), .O(new_n196_));
  nor2   g180(.a(x3), .b(x1), .O(new_n197_));
  nor2   g181(.a(new_n83_), .b(new_n79_), .O(new_n198_));
  nor2   g182(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  nand2  g183(.a(new_n199_), .b(new_n196_), .O(z2));
  oai21  g184(.a(new_n83_), .b(new_n79_), .c(new_n196_), .O(z3));
  xor2a  g185(.a(x2), .b(x0), .O(new_n202_));
  nor2   g186(.a(new_n202_), .b(new_n199_), .O(new_n203_));
  nand3  g187(.a(new_n203_), .b(x6), .c(new_n30_), .O(new_n204_));
  inv1   g188(.a(new_n204_), .O(new_n205_));
  oai21  g189(.a(x3), .b(new_n79_), .c(x2), .O(new_n206_));
  aoi21  g190(.a(x3), .b(new_n29_), .c(new_n19_), .O(new_n207_));
  aoi21  g191(.a(new_n207_), .b(new_n206_), .c(new_n30_), .O(new_n208_));
  oai21  g192(.a(new_n208_), .b(new_n205_), .c(new_n23_), .O(new_n209_));
  nand2  g193(.a(new_n17_), .b(new_n79_), .O(new_n210_));
  nand2  g194(.a(new_n39_), .b(new_n30_), .O(new_n211_));
  oai21  g195(.a(new_n211_), .b(new_n210_), .c(new_n161_), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(new_n29_), .O(new_n213_));
  nor2   g197(.a(x8), .b(x1), .O(new_n214_));
  oai21  g198(.a(new_n214_), .b(new_n52_), .c(x2), .O(new_n215_));
  aoi21  g199(.a(new_n107_), .b(new_n17_), .c(new_n92_), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n215_), .c(new_n29_), .O(new_n217_));
  nand2  g201(.a(new_n107_), .b(x1), .O(new_n218_));
  inv1   g202(.a(new_n218_), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n217_), .c(new_n30_), .O(new_n220_));
  nand3  g204(.a(new_n139_), .b(new_n19_), .c(new_n17_), .O(new_n221_));
  nand3  g205(.a(new_n221_), .b(new_n220_), .c(new_n213_), .O(new_n222_));
  nand2  g206(.a(new_n222_), .b(new_n83_), .O(new_n223_));
  nand2  g207(.a(new_n41_), .b(x0), .O(new_n224_));
  nand3  g208(.a(new_n224_), .b(x4), .c(new_n79_), .O(new_n225_));
  oai21  g209(.a(new_n20_), .b(x2), .c(new_n175_), .O(new_n226_));
  nand4  g210(.a(new_n226_), .b(new_n39_), .c(new_n30_), .d(x1), .O(new_n227_));
  nand4  g211(.a(new_n227_), .b(new_n225_), .c(new_n223_), .d(new_n209_), .O(new_n228_));
  nand2  g212(.a(new_n228_), .b(x5), .O(new_n229_));
  aoi21  g213(.a(x4), .b(x3), .c(x1), .O(new_n230_));
  aoi21  g214(.a(new_n41_), .b(x7), .c(new_n92_), .O(new_n231_));
  nor2   g215(.a(new_n231_), .b(new_n230_), .O(new_n232_));
  aoi21  g216(.a(new_n211_), .b(new_n119_), .c(new_n19_), .O(new_n233_));
  oai21  g217(.a(new_n233_), .b(new_n232_), .c(new_n18_), .O(new_n234_));
  nor2   g218(.a(new_n216_), .b(x4), .O(new_n235_));
  ...
  aoi21  g222(.a(new_n92_), .b(x2), .c(new_n107_), .O(new_n239_));
  nor2   g223(.a(new_n239_), .b(new_n30_), .O(new_n240_));
  nand2  g224(.a(new_n52_), .b(x3), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(new_n96_), .O(new_n242_));
  oai21  g226(.a(new_n242_), .b(new_n240_), .c(x1), .O(new_n243_));
  nand2  g227(.a(new_n20_), .b(new_n29_), .O(new_n244_));
  nand2  g228(.a(new_n39_), .b(x3), .O(new_n245_));
  aoi21  g229(.a(new_n245_), .b(new_n244_), .c(new_n17_), .O(new_n246_));
  nand3  g230(.a(new_n20_), .b(x3), .c(new_n79_), .O(new_n247_));
  inv1   g231(.a(new_n247_), .O(new_n248_));
  oai21  g232(.a(new_n248_), .b(new_n246_), .c(x4), .O(new_n249_));
  nand3  g233(.a(new_n39_), .b(new_n23_), .c(x6), .O(new_n250_));
  nand3  g234(.a(new_n250_), .b(new_n249_), .c(new_n243_), .O(new_n251_));
  nand2  g235(.a(new_n251_), .b(new_n18_), .O(new_n252_));
  nand3  g236(.a(new_n198_), .b(new_n52_), .c(new_n30_), .O(new_n253_));
  nand3  g237(.a(new_n253_), .b(new_n252_), .c(new_n238_), .O(new_n254_));
  inv1   g238(.a(new_n254_), .O(new_n255_));
  aoi21  g239(.a(new_n255_), .b(new_n229_), .c(new_n65_), .O(z4));
  oai21  g240(.a(new_n202_), .b(new_n199_), .c(new_n196_), .O(z5));
endmodule
