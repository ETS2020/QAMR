...
module FAU ( 
  ...
  nand2  g007(.a(new_n20_), .b(new_n18_), .O(new_n24_));
  nor2   g008(.a(x5), .b(x4), .O(new_n25_));
  aoi22  g009(.a(new_n25_), .b(new_n21_), .c(new_n24_), .d(new_n17_), .O(new_n26_));
  aoi21  g010(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n27_));
  ...
  nand3  g022(.a(x6), .b(new_n18_), .c(x2), .O(new_n39_));
  ...
  nand2  g032(.a(new_n40_), .b(x5), .O(new_n49_));
  aoi21  g033(.a(new_n49_), .b(new_n19_), .c(new_n29_), .O(new_n50_));
  nand2  g034(.a(x7), .b(new_n40_), .O(new_n51_));
  inv1   g035(.a(new_n51_), .O(new_n52_));
  oai21  g036(.a(new_n52_), .b(new_n50_), .c(x2), .O(new_n53_));
  aoi21  g037(.a(new_n19_), .b(x5), .c(x6), .O(new_n54_));
  nand2  g038(.a(new_n33_), .b(x6), .O(new_n55_));
  oai21  g039(.a(new_n54_), .b(new_n29_), .c(new_n55_), .O(new_n56_));
  nand2  g040(.a(new_n56_), .b(new_n17_), .O(new_n57_));
  aoi21  g041(.a(new_n57_), .b(new_n53_), .c(new_n28_), .O(new_n58_));
  oai21  g042(.a(new_n58_), .b(new_n48_), .c(new_n38_), .O(new_n59_));
  nor2   g043(.a(new_n29_), .b(new_n17_), .O(new_n60_));
  nor2   g044(.a(x7), .b(x6), .O(new_n61_));
  nand4  g045(.a(new_n61_), .b(new_n60_), .c(x5), .d(new_n28_), .O(new_n62_));
  nand3  g046(.a(new_n62_), .b(new_n59_), .c(new_n37_), .O(new_n63_));
  nand2  g047(.a(new_n63_), .b(x9), .O(new_n64_));
  inv1   g048(.a(x9), .O(new_n65_));
  nand2  g049(.a(new_n40_), .b(x2), .O(new_n66_));
  nand2  g050(.a(new_n21_), .b(new_n17_), .O(new_n67_));
  aoi21  g051(.a(new_n67_), .b(new_n66_), .c(x0), .O(new_n68_));
  nand2  g052(.a(x6), .b(x0), .O(new_n69_));
  aoi21  g053(.a(new_n69_), .b(new_n19_), .c(new_n17_), .O(new_n70_));
  ...
  oai21  g064(.a(new_n40_), .b(x2), .c(x8), .O(new_n81_));
  aoi22  g065(.a(new_n81_), .b(x0), .c(new_n38_), .d(new_n17_), .O(new_n82_));
  nand2  g066(.a(x8), .b(x6), .O(new_n83_));
  nand2  g067(.a(new_n83_), .b(x0), .O(new_n84_));
  nand3  g068(.a(new_n84_), .b(new_n80_), .c(x2), .O(new_n85_));
  oai21  g069(.a(new_n82_), .b(new_n80_), .c(new_n85_), .O(new_n86_));
  nand4  g070(.a(new_n65_), .b(new_n19_), .c(x6), .d(new_n80_), .O(new_n87_));
  inv1   g071(.a(new_n87_), .O(new_n88_));
  aoi21  g072(.a(new_n86_), .b(x9), .c(new_n88_), .O(new_n89_));
  nor2   g073(.a(x7), .b(x2), .O(new_n90_));
  nor2   g074(.a(new_n90_), .b(new_n28_), .O(new_n91_));
  nor2   g075(.a(x7), .b(x0), .O(new_n92_));
  oai21  g076(.a(new_n92_), .b(new_n91_), .c(new_n18_), .O(new_n93_));
  nor2   g077(.a(new_n65_), .b(x7), .O(new_n94_));
  nand3  g078(.a(new_n94_), .b(new_n80_), .c(new_n28_), .O(new_n95_));
  aoi21  g079(.a(new_n95_), .b(new_n93_), .c(new_n38_), .O(new_n96_));
  ...
  oai21  g085(.a(new_n89_), .b(new_n18_), .c(new_n101_), .O(new_n102_));
  nand2  g086(.a(new_n102_), .b(new_n29_), .O(new_n103_));
  nand4  g087(.a(x8), .b(new_n19_), .c(x3), .d(new_n17_), .O(new_n104_));
  ...
  nor2   g091(.a(new_n38_), .b(x6), .O(new_n108_));
  ...
  nor2   g095(.a(new_n90_), .b(x0), .O(new_n112_));
  oai21  g096(.a(new_n112_), .b(new_n111_), .c(x8), .O(new_n113_));
  nand3  g097(.a(new_n38_), .b(new_n19_), .c(x6), .O(new_n114_));
  nand3  g098(.a(new_n114_), .b(new_n113_), .c(new_n110_), .O(new_n115_));
  nand4  g099(.a(new_n20_), .b(x9), .c(new_n38_), .d(new_n80_), .O(new_n116_));
  nor2   g100(.a(new_n116_), .b(new_n17_), .O(new_n117_));
  aoi21  g101(.a(new_n115_), .b(x3), .c(new_n117_), .O(new_n118_));
  aoi21  g102(.a(new_n118_), .b(new_n107_), .c(new_n29_), .O(new_n119_));
  nand2  g103(.a(new_n83_), .b(new_n51_), .O(new_n120_));
  ...
  nand2  g112(.a(new_n29_), .b(x3), .O(new_n129_));
  ...
  nand2  g116(.a(new_n17_), .b(new_n28_), .O(new_n133_));
  nand2  g117(.a(new_n21_), .b(new_n80_), .O(new_n134_));
  ...
  nand2  g122(.a(new_n19_), .b(new_n28_), .O(new_n139_));
  nand2  g123(.a(new_n38_), .b(x7), .O(new_n140_));
  ...
  nand4  g148(.a(new_n164_), .b(x9), .c(x8), .d(new_n19_), .O(new_n165_));
  nand4  g149(.a(new_n165_), .b(new_n162_), .c(new_n153_), .d(new_n143_), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(x1), .O(new_n167_));
  oai21  g151(.a(new_n66_), .b(new_n28_), .c(x9), .O(new_n168_));
  nand3  g152(.a(new_n168_), .b(x7), .c(new_n29_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x3), .O(new_n171_));
  aoi21  g155(.a(new_n44_), .b(new_n38_), .c(x0), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n144_), .c(new_n40_), .O(new_n173_));
  nand2  g157(.a(new_n33_), .b(x0), .O(new_n174_));
  oai21  g158(.a(new_n19_), .b(new_n29_), .c(new_n38_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n174_), .c(x2), .O(new_n176_));
  nor2   g160(.a(x8), .b(new_n28_), .O(new_n177_));
  ...
  nor2   g172(.a(new_n19_), .b(new_n40_), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n29_), .O(new_n190_));
  ...
  oai21  g177(.a(new_n29_), .b(new_n28_), .c(x9), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(x7), .c(x6), .O(new_n195_));
  oai21  g179(.a(new_n141_), .b(new_n193_), .c(new_n195_), .O(new_n196_));
  aoi21  g180(.a(new_n192_), .b(new_n28_), .c(new_n196_), .O(new_n197_));
  nand2  g181(.a(new_n197_), .b(new_n188_), .O(new_n198_));
  nand2  g182(.a(new_n94_), .b(new_n40_), .O(new_n199_));
  ...
  nor2   g192(.a(new_n208_), .b(new_n200_), .O(z2));
  nor3   g193(.a(new_n200_), .b(new_n80_), .c(new_n79_), .O(z3));
  nand2  g194(.a(new_n20_), .b(x8), .O(new_n211_));
  nand3  g195(.a(new_n211_), .b(x3), .c(x1), .O(new_n212_));
  nand2  g196(.a(new_n207_), .b(new_n21_), .O(new_n213_));
  ...
  nand3  g201(.a(new_n38_), .b(x6), .c(new_n79_), .O(new_n218_));
  nand2  g202(.a(new_n218_), .b(new_n51_), .O(new_n219_));
  nand2  g203(.a(new_n219_), .b(x2), .O(new_n220_));
  aoi21  g204(.a(new_n189_), .b(new_n17_), .c(new_n123_), .O(new_n221_));
  aoi21  g205(.a(new_n221_), .b(new_n220_), .c(new_n28_), .O(new_n222_));
  nand2  g206(.a(new_n38_), .b(new_n17_), .O(new_n223_));
  nand2  g207(.a(x6), .b(x1), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n223_), .c(new_n19_), .O(new_n225_));
  oai21  g209(.a(new_n225_), .b(new_n222_), .c(new_n80_), .O(new_n226_));
  aoi21  g210(.a(x3), .b(x0), .c(new_n38_), .O(new_n227_));
  oai21  g211(.a(new_n227_), .b(new_n19_), .c(new_n124_), .O(new_n228_));
  nand3  g212(.a(new_n228_), .b(new_n17_), .c(x1), .O(new_n229_));
  nand3  g213(.a(new_n229_), .b(new_n226_), .c(new_n217_), .O(new_n230_));
  oai21  g214(.a(x3), .b(new_n79_), .c(x2), .O(new_n231_));
  aoi21  g215(.a(x3), .b(new_n28_), .c(new_n40_), .O(new_n232_));
  aoi21  g216(.a(new_n232_), .b(new_n231_), .c(x7), .O(new_n233_));
  aoi21  g217(.a(new_n40_), .b(new_n80_), .c(new_n79_), .O(new_n234_));
  nand3  g218(.a(new_n205_), .b(new_n40_), .c(new_n17_), .O(new_n235_));
  ...
  aoi21  g223(.a(new_n230_), .b(new_n29_), .c(new_n239_), .O(new_n240_));
  nand3  g224(.a(new_n206_), .b(new_n52_), .c(new_n29_), .O(new_n241_));
  oai21  g225(.a(new_n240_), .b(new_n18_), .c(new_n241_), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(x9), .O(new_n243_));
  aoi21  g227(.a(x4), .b(x3), .c(x1), .O(new_n244_));
  nand2  g228(.a(new_n41_), .b(x7), .O(new_n245_));
  aoi21  g229(.a(new_n245_), .b(new_n124_), .c(new_n244_), .O(new_n246_));
  aoi21  g230(.a(new_n38_), .b(new_n29_), .c(new_n90_), .O(new_n247_));
  nor2   g231(.a(new_n247_), .b(new_n40_), .O(new_n248_));
  oai21  g232(.a(new_n248_), .b(new_n246_), .c(x0), .O(new_n249_));
  aoi21  g233(.a(new_n123_), .b(x2), .c(new_n189_), .O(new_n250_));
  nor2   g234(.a(new_n250_), .b(new_n29_), .O(new_n251_));
  oai21  g235(.a(new_n51_), .b(new_n80_), .c(new_n134_), .O(new_n252_));
  oai21  g236(.a(new_n252_), .b(new_n251_), .c(x1), .O(new_n253_));
  nand2  g237(.a(new_n21_), .b(new_n28_), .O(new_n254_));
  nand2  g238(.a(new_n38_), .b(x3), .O(new_n255_));
  aoi21  g239(.a(new_n255_), .b(new_n254_), .c(new_n17_), .O(new_n256_));
  nand3  g240(.a(new_n21_), .b(x3), .c(new_n79_), .O(new_n257_));
  inv1   g241(.a(new_n257_), .O(new_n258_));
  oai21  g242(.a(new_n258_), .b(new_n256_), .c(x4), .O(new_n259_));
  nor2   g243(.a(new_n180_), .b(new_n65_), .O(new_n260_));
  nand4  g244(.a(new_n260_), .b(new_n259_), .c(new_n253_), .d(new_n249_), .O(new_n261_));
  nand2  g245(.a(new_n261_), .b(new_n18_), .O(new_n262_));
  nand2  g246(.a(new_n262_), .b(new_n243_), .O(z4));
  inv1   g247(.a(new_n208_), .O(new_n264_));
  nand3  g248(.a(new_n216_), .b(new_n264_), .c(new_n201_), .O(new_n265_));
