...
module FAU ( 
  ...
  nor2   g212(.a(new_n228_), .b(new_n101_), .O(new_n229_));
  inv1   g213(.a(new_n229_), .O(new_n230_));
  nand2  g214(.a(x9), .b(new_n228_), .O(new_n231_));
  oai21  g215(.a(new_n231_), .b(x1), .c(new_n230_), .O(z2));
  nand2  g216(.a(new_n18_), .b(new_n228_), .O(new_n233_));
  nand2  g217(.a(new_n233_), .b(new_n230_), .O(z3));
  oai21  g218(.a(new_n103_), .b(new_n60_), .c(new_n159_), .O(new_n235_));
  nand3  g219(.a(new_n235_), .b(new_n32_), .c(new_n101_), .O(new_n236_));
  nand2  g220(.a(new_n57_), .b(x0), .O(new_n237_));
  nand2  g221(.a(new_n237_), .b(new_n101_), .O(new_n238_));
  nand3  g222(.a(new_n238_), .b(x7), .c(new_n29_), .O(new_n239_));
  nand2  g223(.a(new_n239_), .b(new_n236_), .O(new_n240_));
  nand2  g224(.a(new_n240_), .b(x6), .O(new_n241_));
  nand3  g225(.a(new_n182_), .b(new_n29_), .c(x0), .O(new_n242_));
  oai21  g226(.a(new_n23_), .b(x4), .c(new_n57_), .O(new_n243_));
  nand3  g227(.a(new_n243_), .b(new_n242_), .c(new_n152_), .O(new_n244_));
  nand4  g228(.a(x4), .b(new_n57_), .c(new_n101_), .d(new_n60_), .O(new_n245_));
  inv1   g229(.a(new_n245_), .O(new_n246_));
  aoi21  g230(.a(new_n244_), .b(new_n17_), .c(new_n246_), .O(new_n247_));
  aoi21  g231(.a(new_n247_), .b(new_n241_), .c(x3), .O(new_n248_));
  nand2  g232(.a(x2), .b(x0), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(new_n159_), .O(new_n250_));
  nand4  g234(.a(new_n250_), .b(new_n32_), .c(x6), .d(new_n29_), .O(new_n251_));
  nand3  g235(.a(new_n237_), .b(new_n30_), .c(x4), .O(new_n252_));
  oai21  g236(.a(new_n251_), .b(new_n101_), .c(new_n252_), .O(new_n253_));
  nand2  g237(.a(new_n253_), .b(x3), .O(new_n254_));
  inv1   g238(.a(new_n25_), .O(new_n255_));
  oai21  g239(.a(new_n255_), .b(new_n101_), .c(new_n215_), .O(new_n256_));
  nand2  g240(.a(new_n256_), .b(new_n57_), .O(new_n257_));
  oai21  g241(.a(x7), .b(new_n29_), .c(new_n257_), .O(new_n258_));
  aoi21  g242(.a(new_n178_), .b(x0), .c(new_n29_), .O(new_n259_));
  aoi22  g243(.a(new_n259_), .b(new_n101_), .c(new_n258_), .d(new_n17_), .O(new_n260_));
  aoi21  g244(.a(new_n260_), .b(new_n254_), .c(new_n18_), .O(new_n261_));
  oai21  g245(.a(new_n261_), .b(new_n248_), .c(x5), .O(new_n262_));
  aoi21  g246(.a(x4), .b(x3), .c(x1), .O(new_n263_));
  nand2  g247(.a(new_n177_), .b(x7), .O(new_n264_));
  aoi21  g248(.a(new_n264_), .b(new_n128_), .c(new_n263_), .O(new_n265_));
  aoi21  g249(.a(new_n170_), .b(new_n255_), .c(new_n17_), .O(new_n266_));
  oai21  g250(.a(new_n266_), .b(new_n265_), .c(new_n19_), .O(new_n267_));
  oai21  g251(.a(new_n93_), .b(x2), .c(new_n128_), .O(new_n268_));
  nand3  g252(.a(new_n268_), .b(new_n29_), .c(x1), .O(new_n269_));
  aoi21  g253(.a(new_n269_), .b(new_n267_), .c(new_n60_), .O(new_n270_));
  nand2  g254(.a(new_n127_), .b(x2), .O(new_n271_));
  aoi21  g255(.a(new_n271_), .b(new_n93_), .c(new_n29_), .O(new_n272_));
  nand2  g256(.a(new_n135_), .b(x3), .O(new_n273_));
  inv1   g257(.a(new_n273_), .O(new_n274_));
  oai21  g258(.a(new_n274_), .b(new_n272_), .c(x1), .O(new_n275_));
  nand2  g259(.a(new_n96_), .b(new_n60_), .O(new_n276_));
  nand2  g260(.a(new_n23_), .b(x3), .O(new_n277_));
  aoi21  g261(.a(new_n277_), .b(new_n276_), .c(new_n57_), .O(new_n278_));
  nand3  g262(.a(new_n96_), .b(x3), .c(new_n101_), .O(new_n279_));
  inv1   g263(.a(new_n279_), .O(new_n280_));
  oai21  g264(.a(new_n280_), .b(new_n278_), .c(x4), .O(new_n281_));
  nand2  g265(.a(new_n34_), .b(x6), .O(new_n282_));
  nand3  g266(.a(new_n282_), .b(new_n281_), .c(new_n275_), .O(new_n283_));
  nand2  g267(.a(new_n283_), .b(new_n19_), .O(new_n284_));
  nand3  g268(.a(new_n229_), .b(new_n135_), .c(new_n29_), .O(new_n285_));
  nand2  g269(.a(new_n285_), .b(new_n284_), .O(new_n286_));
  oai21  g270(.a(new_n286_), .b(new_n270_), .c(x9), .O(new_n287_));
  nand2  g271(.a(new_n19_), .b(x1), .O(new_n288_));
  oai21  g272(.a(new_n288_), .b(new_n80_), .c(x9), .O(new_n289_));
  nand2  g273(.a(new_n289_), .b(new_n228_), .O(new_n290_));
  nand3  g274(.a(new_n290_), .b(new_n287_), .c(new_n262_), .O(z4));
  inv1   g275(.a(new_n250_), .O(new_n292_));
  nor2   g276(.a(x3), .b(x1), .O(new_n293_));
  aoi21  g277(.a(new_n231_), .b(x1), .c(new_n293_), .O(new_n294_));
  oai21  g278(.a(new_n294_), .b(new_n292_), .c(new_n233_), .O(z5));
endmodule
