...
module FAU ( 
  ...
  nand3  g136(.a(new_n146_), .b(x3), .c(x1), .O(new_n153_));
  inv1   g137(.a(new_n153_), .O(z3));
  nor2   g138(.a(x3), .b(new_n108_), .O(new_n155_));
  nor3   g139(.a(new_n18_), .b(new_n85_), .c(x1), .O(new_n156_));
  oai22  g140(.a(new_n156_), .b(new_n155_), .c(new_n23_), .d(x0), .O(new_n157_));
  nor2   g141(.a(x2), .b(new_n42_), .O(new_n158_));
  nor2   g142(.a(new_n44_), .b(x0), .O(new_n159_));
  oai22  g143(.a(new_n159_), .b(new_n158_), .c(new_n23_), .d(x1), .O(new_n160_));
  oai21  g144(.a(x4), .b(new_n42_), .c(x7), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n25_), .O(new_n162_));
  nand4  g146(.a(x7), .b(x4), .c(x1), .d(new_n42_), .O(new_n163_));
  nand4  g147(.a(new_n163_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n164_));
  ...
  inv1   g158(.a(new_n151_), .O(new_n175_));
  xnor2a g159(.a(x2), .b(x0), .O(new_n176_));
  nand3  g160(.a(new_n176_), .b(new_n175_), .c(new_n146_), .O(new_n177_));
