...
module FAU ( 
  ...
  inv1   g155(.a(new_n169_), .O(new_n172_));
  nand3  g156(.a(new_n172_), .b(x3), .c(x1), .O(new_n173_));
  inv1   g157(.a(new_n173_), .O(z3));
  nor2   g158(.a(x2), .b(new_n17_), .O(new_n175_));
  nor2   g159(.a(new_n81_), .b(x0), .O(new_n176_));
  oai22  g160(.a(new_n176_), .b(new_n175_), .c(new_n31_), .d(x1), .O(new_n177_));
  nor2   g161(.a(x3), .b(new_n122_), .O(new_n178_));
  nor3   g162(.a(new_n18_), .b(new_n80_), .c(x1), .O(new_n179_));
  oai22  g163(.a(new_n179_), .b(new_n178_), .c(new_n31_), .d(x0), .O(new_n180_));
  nor2   g164(.a(new_n31_), .b(new_n122_), .O(new_n181_));
  oai21  g165(.a(new_n181_), .b(new_n38_), .c(x0), .O(new_n182_));
  aoi21  g166(.a(new_n31_), .b(x3), .c(new_n18_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(x1), .c(new_n56_), .O(new_n184_));
  nand4  g168(.a(new_n184_), .b(new_n182_), .c(new_n180_), .d(new_n177_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(x6), .O(new_n186_));
  nand3  g170(.a(new_n44_), .b(x4), .c(x3), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n122_), .O(new_n188_));
  nand3  g172(.a(new_n188_), .b(new_n143_), .c(x0), .O(new_n189_));
  inv1   g173(.a(new_n90_), .O(new_n190_));
  aoi22  g174(.a(new_n190_), .b(x2), .c(x7), .d(x3), .O(new_n191_));
  nand3  g175(.a(new_n190_), .b(x3), .c(x2), .O(new_n192_));
  oai21  g176(.a(new_n191_), .b(new_n122_), .c(new_n192_), .O(new_n193_));
  nor4   g177(.a(new_n90_), .b(new_n80_), .c(new_n52_), .d(x1), .O(new_n194_));
  aoi21  g178(.a(new_n193_), .b(new_n44_), .c(new_n194_), .O(new_n195_));
  nand3  g179(.a(new_n195_), .b(new_n189_), .c(new_n186_), .O(new_n196_));
  nand3  g180(.a(new_n196_), .b(x9), .c(new_n19_), .O(new_n197_));
  inv1   g181(.a(new_n197_), .O(z4));
  xor2a  g182(.a(x2), .b(x0), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n170_), .c(new_n172_), .O(z5));
endmodule
