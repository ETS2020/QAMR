// Benchmark "FAU" written by ABC on Thu Aug 13 18:22:06 2020
...
module FAU ( 
  ...
  nand2  g113(.a(new_n67_), .b(new_n65_), .O(new_n130_));
  nand2  g114(.a(x3), .b(x1), .O(new_n131_));
  nand2  g115(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  inv1   g116(.a(new_n132_), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n129_), .O(z2));
  nand2  g118(.a(new_n131_), .b(new_n129_), .O(z3));
  xor2a  g119(.a(x2), .b(x0), .O(new_n136_));
  nor2   g120(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(x6), .c(new_n23_), .O(new_n138_));
  inv1   g122(.a(new_n138_), .O(new_n139_));
  oai21  g123(.a(x3), .b(new_n65_), .c(x2), .O(new_n140_));
  aoi21  g124(.a(x3), .b(new_n41_), .c(new_n18_), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n140_), .c(new_n23_), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n139_), .c(new_n28_), .O(new_n143_));
  nand3  g127(.a(new_n132_), .b(x6), .c(new_n41_), .O(new_n144_));
  oai21  g128(.a(x6), .b(new_n65_), .c(new_n144_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n17_), .O(new_n146_));
  oai21  g130(.a(x7), .b(new_n18_), .c(x1), .O(new_n147_));
  aoi21  g131(.a(x2), .b(new_n65_), .c(new_n18_), .O(new_n148_));
  oai21  g132(.a(new_n148_), .b(x3), .c(new_n147_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(x0), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n146_), .c(x8), .O(new_n151_));
  nand2  g135(.a(x3), .b(new_n65_), .O(new_n152_));
  nand3  g136(.a(new_n152_), .b(x6), .c(new_n17_), .O(new_n153_));
  nand2  g137(.a(new_n18_), .b(new_n67_), .O(new_n154_));
  oai21  g138(.a(new_n154_), .b(new_n17_), .c(new_n153_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x0), .O(new_n156_));
  nor2   g140(.a(new_n18_), .b(x3), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n68_), .c(x1), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n156_), .c(new_n28_), .O(new_n159_));
  oai21  g143(.a(new_n159_), .b(new_n151_), .c(new_n23_), .O(new_n160_));
  aoi21  g144(.a(new_n18_), .b(new_n67_), .c(new_n65_), .O(new_n161_));
  nand3  g145(.a(new_n131_), .b(new_n18_), .c(new_n17_), .O(new_n162_));
  oai21  g146(.a(new_n161_), .b(x0), .c(new_n162_), .O(new_n163_));
  nand4  g147(.a(new_n22_), .b(new_n18_), .c(new_n67_), .d(new_n17_), .O(new_n164_));
  inv1   g148(.a(new_n164_), .O(new_n165_));
  aoi21  g149(.a(new_n163_), .b(x4), .c(new_n165_), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(new_n160_), .c(new_n143_), .O(new_n167_));
  nand3  g151(.a(new_n167_), .b(x9), .c(x5), .O(new_n168_));
  inv1   g152(.a(new_n168_), .O(z4));
  nand2  g153(.a(new_n137_), .b(new_n129_), .O(new_n170_));
