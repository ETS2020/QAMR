...
module FAU ( 
  ...
  nand2  g164(.a(new_n180_), .b(new_n84_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n179_), .c(new_n25_), .O(new_n182_));
  nand2  g166(.a(x8), .b(new_n24_), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(new_n66_), .c(new_n53_), .O(new_n184_));
  aoi21  g168(.a(x7), .b(new_n53_), .c(x5), .O(new_n185_));
  oai21  g169(.a(new_n185_), .b(x0), .c(new_n17_), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n184_), .c(x3), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n182_), .c(x6), .O(new_n188_));
  oai21  g172(.a(x3), .b(x2), .c(x7), .O(new_n189_));
  nand3  g173(.a(new_n189_), .b(x8), .c(new_n20_), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n188_), .c(new_n178_), .O(new_n191_));
  ...
  nand2  g185(.a(new_n201_), .b(new_n78_), .O(z2));
  nor3   g186(.a(new_n77_), .b(new_n84_), .c(new_n80_), .O(z3));
  nand3  g187(.a(new_n200_), .b(x2), .c(x0), .O(new_n204_));
  nand4  g188(.a(x3), .b(new_n53_), .c(x1), .d(new_n24_), .O(new_n205_));
  aoi22  g189(.a(new_n205_), .b(new_n204_), .c(x8), .d(x7), .O(new_n206_));
  oai21  g190(.a(x2), .b(new_n24_), .c(new_n80_), .O(new_n207_));
  nand3  g191(.a(new_n207_), .b(x7), .c(new_n84_), .O(new_n208_));
  inv1   g192(.a(new_n208_), .O(new_n209_));
  oai21  g193(.a(new_n209_), .b(new_n206_), .c(x6), .O(new_n210_));
  nand3  g194(.a(new_n130_), .b(new_n84_), .c(x0), .O(new_n211_));
  nand3  g195(.a(new_n17_), .b(new_n53_), .c(x1), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(new_n20_), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n210_), .c(new_n29_), .O(new_n215_));
  inv1   g199(.a(new_n93_), .O(new_n216_));
  inv1   g200(.a(new_n110_), .O(new_n217_));
  oai21  g201(.a(new_n217_), .b(x2), .c(new_n216_), .O(new_n218_));
  nand2  g202(.a(new_n218_), .b(x0), .O(new_n219_));
  nand3  g203(.a(x7), .b(new_n20_), .c(x3), .O(new_n220_));
  aoi21  g204(.a(new_n220_), .b(new_n219_), .c(new_n80_), .O(new_n221_));
  oai21  g205(.a(new_n221_), .b(new_n215_), .c(new_n25_), .O(new_n222_));
  aoi21  g206(.a(new_n84_), .b(x1), .c(new_n53_), .O(new_n223_));
  oai21  g207(.a(new_n84_), .b(x0), .c(x6), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n223_), .c(new_n31_), .O(new_n225_));
  oai21  g209(.a(x6), .b(x3), .c(x1), .O(new_n226_));
  aoi21  g210(.a(x3), .b(x1), .c(x6), .O(new_n227_));
  aoi22  g211(.a(new_n227_), .b(new_n53_), .c(new_n226_), .d(new_n24_), .O(new_n228_));
  aoi21  g212(.a(new_n228_), .b(new_n225_), .c(new_n25_), .O(new_n229_));
  nand2  g213(.a(x8), .b(x7), .O(new_n230_));
  nand4  g214(.a(new_n230_), .b(x6), .c(new_n80_), .d(new_n24_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n216_), .O(new_n232_));
  nand3  g216(.a(new_n232_), .b(new_n84_), .c(new_n53_), .O(new_n233_));
  inv1   g217(.a(new_n233_), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n229_), .c(x5), .O(new_n235_));
  nand2  g219(.a(new_n235_), .b(new_n222_), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(x9), .O(new_n237_));
  aoi21  g221(.a(x4), .b(x3), .c(x1), .O(new_n238_));
  nand2  g222(.a(new_n126_), .b(x7), .O(new_n239_));
  aoi21  g223(.a(new_n239_), .b(new_n216_), .c(new_n238_), .O(new_n240_));
  nand2  g224(.a(new_n17_), .b(new_n25_), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(new_n123_), .c(new_n20_), .O(new_n242_));
  oai21  g226(.a(new_n242_), .b(new_n240_), .c(x0), .O(new_n243_));
  nand2  g227(.a(new_n93_), .b(x2), .O(new_n244_));
  aoi21  g228(.a(new_n244_), .b(new_n217_), .c(new_n25_), .O(new_n245_));
  nand2  g229(.a(new_n220_), .b(new_n98_), .O(new_n246_));
  oai21  g230(.a(new_n246_), .b(new_n245_), .c(x1), .O(new_n247_));
  nand2  g231(.a(new_n97_), .b(new_n24_), .O(new_n248_));
  nand2  g232(.a(new_n17_), .b(x3), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(new_n248_), .c(new_n53_), .O(new_n250_));
  nand3  g234(.a(new_n97_), .b(x3), .c(new_n80_), .O(new_n251_));
  inv1   g235(.a(new_n251_), .O(new_n252_));
  oai21  g236(.a(new_n252_), .b(new_n250_), .c(x4), .O(new_n253_));
  aoi21  g237(.a(new_n180_), .b(x6), .c(new_n38_), .O(new_n254_));
  nand4  g238(.a(new_n254_), .b(new_n253_), .c(new_n247_), .d(new_n243_), .O(new_n255_));
  nand2  g239(.a(new_n255_), .b(new_n29_), .O(new_n256_));
  nand2  g240(.a(new_n256_), .b(new_n237_), .O(z4));
  xor2a  g241(.a(x2), .b(x0), .O(new_n258_));
  oai21  g242(.a(new_n258_), .b(new_n201_), .c(new_n78_), .O(z5));
endmodule
