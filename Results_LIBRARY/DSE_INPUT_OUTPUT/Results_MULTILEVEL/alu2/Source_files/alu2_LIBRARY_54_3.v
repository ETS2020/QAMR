...
module FAU ( 
  ...
  and2   g142(.a(new_n158_), .b(new_n157_), .O(z2));
  nand3  g143(.a(new_n157_), .b(x3), .c(x1), .O(new_n160_));
  inv1   g144(.a(new_n160_), .O(z3));
  nand3  g145(.a(new_n158_), .b(x5), .c(new_n22_), .O(new_n162_));
  oai21  g146(.a(x3), .b(new_n72_), .c(new_n22_), .O(new_n163_));
  oai21  g147(.a(new_n135_), .b(x1), .c(x8), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n163_), .c(new_n18_), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(new_n162_), .c(x7), .O(new_n166_));
  nor2   g150(.a(x5), .b(new_n57_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(x0), .O(new_n168_));
  nand2  g152(.a(x1), .b(new_n22_), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n82_), .c(new_n168_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x3), .O(new_n171_));
  oai21  g155(.a(new_n63_), .b(new_n18_), .c(x0), .O(new_n172_));
  nand2  g156(.a(x7), .b(x5), .O(new_n173_));
  nor2   g157(.a(new_n173_), .b(x4), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(new_n167_), .c(new_n93_), .O(new_n175_));
  nand2  g159(.a(new_n142_), .b(x4), .O(new_n176_));
  nand3  g160(.a(new_n176_), .b(new_n175_), .c(new_n172_), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(x1), .O(new_n178_));
  oai21  g162(.a(new_n173_), .b(x3), .c(new_n77_), .O(new_n179_));
  nand3  g163(.a(new_n179_), .b(new_n57_), .c(x0), .O(new_n180_));
  nand3  g164(.a(new_n180_), .b(new_n178_), .c(new_n171_), .O(new_n181_));
  oai21  g165(.a(new_n181_), .b(new_n166_), .c(x6), .O(new_n182_));
  nand4  g166(.a(new_n38_), .b(new_n30_), .c(x3), .d(x1), .O(new_n183_));
  inv1   g167(.a(new_n82_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n93_), .c(new_n72_), .O(new_n185_));
  aoi21  g169(.a(new_n185_), .b(new_n183_), .c(new_n56_), .O(new_n186_));
  nand3  g170(.a(new_n26_), .b(x1), .c(x0), .O(new_n187_));
  aoi22  g171(.a(new_n187_), .b(new_n38_), .c(x7), .d(x3), .O(new_n188_));
  aoi21  g172(.a(new_n56_), .b(x1), .c(new_n93_), .O(new_n189_));
  oai22  g173(.a(new_n189_), .b(x8), .c(new_n57_), .d(x1), .O(new_n190_));
  aoi21  g174(.a(new_n190_), .b(x5), .c(new_n188_), .O(new_n191_));
  nand2  g175(.a(x5), .b(new_n22_), .O(new_n192_));
  nand3  g176(.a(new_n103_), .b(x3), .c(x0), .O(new_n193_));
  aoi21  g177(.a(new_n193_), .b(new_n192_), .c(new_n57_), .O(new_n194_));
  aoi21  g178(.a(new_n194_), .b(new_n72_), .c(x2), .O(new_n195_));
  oai21  g179(.a(new_n191_), .b(x6), .c(new_n195_), .O(new_n196_));
  nor2   g180(.a(new_n196_), .b(new_n186_), .O(new_n197_));
  aoi21  g181(.a(new_n197_), .b(new_n182_), .c(new_n34_), .O(z4));
  nand4  g182(.a(x9), .b(new_n56_), .c(x6), .d(x5), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(x2), .c(x0), .O(new_n200_));
  nor2   g184(.a(new_n17_), .b(new_n22_), .O(new_n201_));
  oai21  g185(.a(new_n201_), .b(new_n200_), .c(new_n158_), .O(new_n202_));
  nand3  g186(.a(x3), .b(x1), .c(new_n22_), .O(new_n203_));
  nand4  g187(.a(new_n26_), .b(x6), .c(x5), .d(new_n57_), .O(new_n204_));
  oai21  g188(.a(new_n204_), .b(new_n203_), .c(new_n17_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(x9), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n202_), .O(z5));
endmodule
