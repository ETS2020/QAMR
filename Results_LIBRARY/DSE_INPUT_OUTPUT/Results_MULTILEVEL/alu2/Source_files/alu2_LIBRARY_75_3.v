...
module FAU ( 
  ...
  nor2   g114(.a(new_n29_), .b(x4), .O(new_n131_));
  aoi22  g115(.a(new_n131_), .b(new_n68_), .c(new_n29_), .d(x1), .O(new_n132_));
  nand3  g116(.a(new_n22_), .b(new_n27_), .c(x1), .O(new_n133_));
  oai21  g117(.a(new_n132_), .b(new_n99_), .c(new_n133_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(x0), .O(new_n135_));
  oai21  g119(.a(x4), .b(new_n74_), .c(x3), .O(new_n136_));
  nand4  g120(.a(new_n136_), .b(new_n22_), .c(x5), .d(new_n19_), .O(new_n137_));
  nand4  g121(.a(new_n34_), .b(x7), .c(x3), .d(x1), .O(new_n138_));
  nand4  g122(.a(new_n138_), .b(new_n137_), .c(new_n135_), .d(new_n130_), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(x9), .c(new_n46_), .O(new_n140_));
  inv1   g124(.a(new_n140_), .O(z4));
  xor2a  g125(.a(x2), .b(x0), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n120_), .c(new_n119_), .O(z5));
endmodule
