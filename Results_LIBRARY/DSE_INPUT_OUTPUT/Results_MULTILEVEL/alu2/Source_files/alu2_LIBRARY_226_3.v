...
module FAU ( 
  ...
  nor2   g122(.a(new_n44_), .b(new_n32_), .O(new_n139_));
  ...
  inv1   g127(.a(new_n143_), .O(z3));
  xor2a  g128(.a(x2), .b(x0), .O(new_n145_));
  nor2   g129(.a(new_n145_), .b(new_n140_), .O(new_n146_));
  nand3  g130(.a(x7), .b(new_n69_), .c(x1), .O(new_n147_));
  ...
  oai21  g134(.a(new_n17_), .b(new_n52_), .c(new_n150_), .O(new_n151_));
  nor2   g135(.a(new_n27_), .b(x3), .O(new_n152_));
  aoi22  g136(.a(new_n152_), .b(x0), .c(new_n151_), .d(x1), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(new_n149_), .c(x4), .O(new_n154_));
  nand2  g138(.a(x4), .b(new_n89_), .O(new_n155_));
  aoi21  g139(.a(new_n155_), .b(x3), .c(x2), .O(new_n156_));
  nand2  g140(.a(new_n69_), .b(new_n52_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(x7), .c(new_n34_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n156_), .c(new_n19_), .O(new_n159_));
  aoi21  g143(.a(new_n17_), .b(x3), .c(new_n89_), .O(new_n160_));
  nand3  g144(.a(new_n17_), .b(x2), .c(new_n89_), .O(new_n161_));
  ...
  oai21  g148(.a(new_n164_), .b(new_n154_), .c(x5), .O(new_n165_));
  aoi21  g149(.a(new_n109_), .b(new_n52_), .c(new_n112_), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(new_n19_), .O(new_n167_));
  nand3  g151(.a(new_n150_), .b(new_n21_), .c(x4), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(x1), .O(new_n170_));
  inv1   g154(.a(new_n71_), .O(new_n171_));
  ...
  nand4  g162(.a(new_n178_), .b(new_n176_), .c(new_n170_), .d(new_n165_), .O(new_n179_));
  nand3  g163(.a(new_n179_), .b(x9), .c(new_n32_), .O(new_n180_));
  inv1   g164(.a(new_n180_), .O(z4));
  nand2  g165(.a(new_n146_), .b(new_n142_), .O(new_n182_));
