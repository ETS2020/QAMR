...
module FAU ( 
  ...
  aoi21  g139(.a(x4), .b(new_n84_), .c(new_n42_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n32_), .c(new_n23_), .O(new_n157_));
  nand2  g141(.a(new_n79_), .b(x3), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(x4), .c(x1), .O(new_n159_));
  nand4  g143(.a(new_n159_), .b(new_n157_), .c(new_n155_), .d(new_n152_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(x6), .O(new_n161_));
  nand2  g145(.a(new_n111_), .b(new_n104_), .O(new_n162_));
  ...
  aoi21  g150(.a(new_n166_), .b(new_n50_), .c(new_n104_), .O(new_n167_));
  nand3  g151(.a(new_n49_), .b(x3), .c(x2), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n19_), .O(new_n169_));
  nor3   g153(.a(new_n169_), .b(new_n167_), .c(new_n165_), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n161_), .c(new_n35_), .O(z4));
  xor2a  g155(.a(x2), .b(x0), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n146_), .c(new_n67_), .O(z5));
endmodule
