...
module FAU ( 
  ...
  oai21  g019(.a(new_n35_), .b(x6), .c(x5), .O(new_n36_));
  ...
  nor2   g118(.a(new_n17_), .b(x4), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(x3), .O(new_n136_));
  nand4  g120(.a(new_n136_), .b(new_n134_), .c(new_n130_), .d(new_n127_), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n44_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n121_), .O(z1));
  nor2   g123(.a(new_n44_), .b(new_n32_), .O(new_n140_));
  xor2a  g124(.a(x3), .b(x1), .O(new_n141_));
  nor2   g125(.a(new_n141_), .b(new_n140_), .O(z2));
  inv1   g126(.a(new_n140_), .O(new_n143_));
  oai21  g127(.a(new_n69_), .b(new_n89_), .c(new_n143_), .O(z3));
  nand3  g128(.a(new_n34_), .b(x3), .c(new_n52_), .O(new_n145_));
  nand2  g129(.a(new_n19_), .b(new_n69_), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(new_n145_), .c(x2), .O(new_n147_));
  nand2  g131(.a(new_n135_), .b(new_n69_), .O(new_n148_));
  nor2   g132(.a(new_n18_), .b(new_n52_), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(new_n17_), .c(x3), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n148_), .c(new_n19_), .O(new_n151_));
  oai21  g135(.a(new_n151_), .b(new_n147_), .c(x1), .O(new_n152_));
  inv1   g136(.a(new_n35_), .O(new_n153_));
  nand3  g137(.a(new_n34_), .b(new_n69_), .c(x0), .O(new_n154_));
  aoi22  g138(.a(new_n154_), .b(new_n153_), .c(x6), .d(new_n18_), .O(new_n155_));
  nor2   g139(.a(x3), .b(x2), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(x4), .c(new_n52_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n24_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n155_), .c(new_n89_), .O(new_n159_));
  nand2  g143(.a(new_n17_), .b(x3), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n146_), .c(new_n34_), .O(new_n161_));
  nor2   g145(.a(x3), .b(new_n52_), .O(new_n162_));
  aoi22  g146(.a(new_n162_), .b(new_n135_), .c(new_n161_), .d(new_n52_), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(new_n159_), .c(new_n152_), .O(new_n164_));
  nand2  g148(.a(new_n164_), .b(x5), .O(new_n165_));
  oai21  g149(.a(x6), .b(x2), .c(x1), .O(new_n166_));
  nor2   g150(.a(x2), .b(x0), .O(new_n167_));
  oai21  g151(.a(new_n167_), .b(new_n69_), .c(new_n166_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(x4), .O(new_n169_));
  oai21  g153(.a(new_n39_), .b(new_n69_), .c(new_n52_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x1), .O(new_n171_));
  aoi21  g155(.a(x4), .b(new_n69_), .c(new_n52_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n17_), .c(x6), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(new_n171_), .c(new_n169_), .O(new_n174_));
  nand2  g158(.a(new_n34_), .b(x3), .O(new_n175_));
  aoi21  g159(.a(new_n17_), .b(new_n19_), .c(new_n135_), .O(new_n176_));
  oai22  g160(.a(new_n176_), .b(new_n52_), .c(new_n175_), .d(new_n39_), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(x1), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n32_), .O(new_n179_));
  aoi21  g163(.a(new_n174_), .b(new_n21_), .c(new_n179_), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n165_), .c(new_n44_), .O(z4));
  nor2   g165(.a(new_n167_), .b(new_n149_), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n141_), .c(new_n143_), .O(z5));
endmodule
