...
module FAU ( 
  ...
  nor3   g183(.a(new_n196_), .b(new_n83_), .c(new_n79_), .O(z3));
  xor2a  g184(.a(x2), .b(x0), .O(new_n201_));
  nor2   g185(.a(new_n201_), .b(new_n198_), .O(new_n202_));
  nand3  g186(.a(new_n202_), .b(x6), .c(new_n30_), .O(new_n203_));
  inv1   g187(.a(new_n203_), .O(new_n204_));
  oai21  g188(.a(x3), .b(new_n79_), .c(x2), .O(new_n205_));
  aoi21  g189(.a(x3), .b(new_n29_), .c(new_n19_), .O(new_n206_));
  aoi21  g190(.a(new_n206_), .b(new_n205_), .c(new_n30_), .O(new_n207_));
  oai21  g191(.a(new_n207_), .b(new_n204_), .c(new_n23_), .O(new_n208_));
  nand2  g192(.a(new_n17_), .b(new_n79_), .O(new_n209_));
  nand2  g193(.a(new_n39_), .b(new_n30_), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n209_), .c(new_n161_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(new_n29_), .O(new_n212_));
  nor2   g196(.a(x8), .b(x1), .O(new_n213_));
  oai21  g197(.a(new_n213_), .b(new_n52_), .c(x2), .O(new_n214_));
  aoi21  g198(.a(new_n107_), .b(new_n17_), .c(new_n92_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(new_n214_), .c(new_n29_), .O(new_n216_));
  nand2  g200(.a(new_n107_), .b(x1), .O(new_n217_));
  inv1   g201(.a(new_n217_), .O(new_n218_));
  oai21  g202(.a(new_n218_), .b(new_n216_), .c(new_n30_), .O(new_n219_));
  nand3  g203(.a(new_n139_), .b(new_n19_), .c(new_n17_), .O(new_n220_));
  nand3  g204(.a(new_n220_), .b(new_n219_), .c(new_n212_), .O(new_n221_));
  nand2  g205(.a(new_n221_), .b(new_n83_), .O(new_n222_));
  nand2  g206(.a(new_n41_), .b(x0), .O(new_n223_));
  nand3  g207(.a(new_n223_), .b(x4), .c(new_n79_), .O(new_n224_));
  oai21  g208(.a(new_n20_), .b(x2), .c(new_n175_), .O(new_n225_));
  nand4  g209(.a(new_n225_), .b(new_n39_), .c(new_n30_), .d(x1), .O(new_n226_));
  nand4  g210(.a(new_n226_), .b(new_n224_), .c(new_n222_), .d(new_n208_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(x5), .O(new_n228_));
  aoi21  g212(.a(x4), .b(x3), .c(x1), .O(new_n229_));
  aoi21  g213(.a(new_n41_), .b(x7), .c(new_n92_), .O(new_n230_));
  nor2   g214(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  aoi21  g215(.a(new_n210_), .b(new_n119_), .c(new_n19_), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n231_), .c(new_n18_), .O(new_n233_));
  nor2   g217(.a(new_n215_), .b(x4), .O(new_n234_));
  ...
  aoi21  g221(.a(new_n92_), .b(x2), .c(new_n107_), .O(new_n238_));
  nor2   g222(.a(new_n238_), .b(new_n30_), .O(new_n239_));
  nand2  g223(.a(new_n52_), .b(x3), .O(new_n240_));
  nand2  g224(.a(new_n240_), .b(new_n96_), .O(new_n241_));
  ...
  nand3  g232(.a(new_n39_), .b(new_n23_), .c(x6), .O(new_n249_));
  nand3  g233(.a(new_n249_), .b(new_n248_), .c(new_n242_), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(new_n18_), .O(new_n251_));
  nand4  g235(.a(new_n52_), .b(new_n30_), .c(x3), .d(x1), .O(new_n252_));
