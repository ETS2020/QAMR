...
module FAU ( 
  ...
  nor3   g199(.a(new_n211_), .b(new_n110_), .c(new_n142_), .O(z3));
  ...
  oai21  g204(.a(x3), .b(new_n142_), .c(x2), .O(new_n221_));
  aoi21  g205(.a(x3), .b(new_n18_), .c(new_n22_), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n221_), .c(new_n33_), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n220_), .c(new_n20_), .O(new_n224_));
  aoi21  g208(.a(new_n22_), .b(new_n110_), .c(new_n142_), .O(new_n225_));
  inv1   g209(.a(new_n212_), .O(new_n226_));
  nand3  g210(.a(new_n226_), .b(new_n22_), .c(new_n21_), .O(new_n227_));
  ...
  nand4  g227(.a(new_n243_), .b(new_n241_), .c(new_n229_), .d(new_n224_), .O(new_n244_));
  ...
  nand3  g254(.a(new_n212_), .b(new_n45_), .c(new_n33_), .O(new_n271_));
  ...
  or2    g258(.a(new_n218_), .b(new_n211_), .O(z5));
endmodule
