...
module FAU ( 
  ...
  nor2   g112(.a(new_n67_), .b(new_n65_), .O(new_n129_));
  nor2   g113(.a(x3), .b(x1), .O(new_n130_));
  nor2   g114(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nor2   g115(.a(new_n131_), .b(new_n59_), .O(z2));
  inv1   g116(.a(new_n59_), .O(new_n133_));
  inv1   g117(.a(new_n129_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n133_), .O(z3));
  ...
  nor2   g141(.a(new_n129_), .b(x6), .O(new_n158_));
  ...
  oai21  g148(.a(new_n140_), .b(new_n131_), .c(new_n133_), .O(z5));
endmodule
