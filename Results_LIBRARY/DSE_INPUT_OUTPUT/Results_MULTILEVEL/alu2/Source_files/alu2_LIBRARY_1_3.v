...
module FAU ( 
  ...
  nand3  g139(.a(new_n149_), .b(x3), .c(x1), .O(new_n156_));
  inv1   g140(.a(new_n156_), .O(z3));
  nand2  g141(.a(new_n60_), .b(x3), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n18_), .c(x1), .O(new_n159_));
  nand2  g143(.a(new_n23_), .b(new_n18_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n47_), .c(new_n73_), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(x3), .O(new_n162_));
  nand2  g146(.a(x6), .b(new_n18_), .O(new_n163_));
  nand2  g147(.a(new_n19_), .b(x5), .O(new_n164_));
  oai21  g148(.a(new_n163_), .b(new_n118_), .c(new_n164_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n72_), .O(new_n166_));
  oai21  g150(.a(new_n163_), .b(new_n47_), .c(new_n164_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(new_n20_), .O(new_n168_));
  oai21  g152(.a(new_n23_), .b(x6), .c(x2), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n68_), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n18_), .c(x1), .O(new_n171_));
  nand4  g155(.a(new_n171_), .b(new_n168_), .c(new_n166_), .d(new_n162_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n159_), .c(x4), .O(new_n173_));
  nand2  g157(.a(new_n20_), .b(new_n18_), .O(new_n174_));
  nand3  g158(.a(x7), .b(x5), .c(new_n17_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n174_), .c(x3), .O(new_n176_));
  nand4  g160(.a(new_n20_), .b(x5), .c(x3), .d(new_n47_), .O(new_n177_));
  inv1   g161(.a(new_n177_), .O(new_n178_));
  oai21  g162(.a(new_n178_), .b(new_n176_), .c(x6), .O(new_n179_));
  nand4  g163(.a(new_n43_), .b(new_n23_), .c(x5), .d(new_n47_), .O(new_n180_));
  ...
  nand4  g167(.a(x7), .b(new_n19_), .c(new_n18_), .d(x3), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n183_), .c(new_n179_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(x1), .O(new_n186_));
  nand4  g170(.a(x5), .b(new_n72_), .c(new_n47_), .d(new_n118_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n160_), .c(x7), .O(new_n188_));
  oai21  g172(.a(new_n20_), .b(x4), .c(x6), .O(new_n189_));
  nand4  g173(.a(new_n189_), .b(new_n23_), .c(x5), .d(new_n72_), .O(new_n190_));
  inv1   g174(.a(new_n190_), .O(new_n191_));
  aoi22  g175(.a(new_n191_), .b(new_n47_), .c(new_n188_), .d(x6), .O(new_n192_));
  nand3  g176(.a(new_n192_), .b(new_n186_), .c(new_n173_), .O(new_n193_));
  nand3  g177(.a(new_n193_), .b(x9), .c(new_n25_), .O(new_n194_));
  inv1   g178(.a(new_n194_), .O(z4));
  xor2a  g179(.a(x2), .b(x0), .O(new_n196_));
  oai21  g180(.a(new_n196_), .b(new_n154_), .c(new_n149_), .O(z5));
endmodule
