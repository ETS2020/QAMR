...
module FAU ( 
  ...
  nand3  g035(.a(x7), .b(new_n18_), .c(x2), .O(new_n52_));
  nand2  g036(.a(new_n31_), .b(new_n23_), .O(new_n53_));
  aoi21  g037(.a(new_n53_), .b(new_n52_), .c(x0), .O(new_n54_));
  nand2  g038(.a(x7), .b(x0), .O(new_n55_));
  aoi21  g039(.a(new_n55_), .b(new_n18_), .c(x2), .O(new_n56_));
  oai21  g040(.a(new_n56_), .b(new_n54_), .c(new_n19_), .O(new_n57_));
  aoi21  g041(.a(x4), .b(new_n23_), .c(x7), .O(new_n58_));
  nand3  g042(.a(x7), .b(x5), .c(x2), .O(new_n59_));
  ...
  nand2  g047(.a(new_n63_), .b(new_n51_), .O(z0));
  inv1   g048(.a(x3), .O(new_n65_));
  nand3  g049(.a(x6), .b(new_n65_), .c(x1), .O(new_n66_));
  nand2  g050(.a(new_n66_), .b(new_n28_), .O(new_n67_));
  nand2  g051(.a(new_n67_), .b(x4), .O(new_n68_));
  inv1   g052(.a(x1), .O(new_n69_));
  nand3  g053(.a(x5), .b(new_n17_), .c(x3), .O(new_n70_));
  aoi21  g054(.a(new_n70_), .b(new_n31_), .c(new_n69_), .O(new_n71_));
  nand3  g055(.a(new_n31_), .b(new_n17_), .c(new_n69_), .O(new_n72_));
  aoi21  g056(.a(new_n72_), .b(x5), .c(x3), .O(new_n73_));
  oai21  g057(.a(new_n73_), .b(new_n71_), .c(new_n28_), .O(new_n74_));
  nand2  g058(.a(x5), .b(x2), .O(new_n75_));
  aoi21  g059(.a(new_n75_), .b(new_n24_), .c(x0), .O(new_n76_));
  ...
  aoi21  g067(.a(new_n83_), .b(new_n79_), .c(new_n69_), .O(new_n84_));
  ...
  nand3  g072(.a(x5), .b(new_n65_), .c(x2), .O(new_n89_));
  ...
  nand4  g079(.a(x8), .b(x7), .c(new_n69_), .d(x0), .O(new_n96_));
  nand2  g080(.a(new_n24_), .b(x1), .O(new_n97_));
  aoi21  g081(.a(new_n97_), .b(new_n96_), .c(x3), .O(new_n98_));
  oai21  g082(.a(x8), .b(new_n65_), .c(x0), .O(new_n99_));
  nand3  g083(.a(new_n99_), .b(x7), .c(x1), .O(new_n100_));
  inv1   g084(.a(new_n100_), .O(new_n101_));
  oai21  g085(.a(new_n101_), .b(new_n98_), .c(new_n19_), .O(new_n102_));
  nand3  g086(.a(new_n102_), .b(new_n95_), .c(new_n74_), .O(new_n103_));
  nand2  g087(.a(new_n103_), .b(x6), .O(new_n104_));
  oai21  g088(.a(new_n31_), .b(new_n23_), .c(x8), .O(new_n105_));
  nand3  g089(.a(new_n105_), .b(new_n19_), .c(x0), .O(new_n106_));
  nand3  g090(.a(x8), .b(x5), .c(new_n23_), .O(new_n107_));
  aoi21  g091(.a(new_n107_), .b(new_n106_), .c(x6), .O(new_n108_));
  oai21  g092(.a(x8), .b(x2), .c(new_n35_), .O(new_n109_));
  nand3  g093(.a(x8), .b(new_n31_), .c(x2), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n109_), .c(new_n19_), .O(new_n111_));
  oai21  g095(.a(new_n111_), .b(new_n108_), .c(new_n65_), .O(new_n112_));
  nor2   g096(.a(new_n18_), .b(x5), .O(new_n113_));
  oai21  g097(.a(new_n113_), .b(new_n35_), .c(new_n42_), .O(new_n114_));
  nand3  g098(.a(new_n114_), .b(new_n24_), .c(x3), .O(new_n115_));
  aoi21  g099(.a(new_n115_), .b(new_n112_), .c(new_n28_), .O(new_n116_));
  ...
  oai21  g105(.a(new_n121_), .b(new_n116_), .c(new_n69_), .O(new_n122_));
  nand2  g106(.a(new_n97_), .b(new_n23_), .O(new_n123_));
  nand3  g107(.a(new_n123_), .b(x7), .c(x0), .O(new_n124_));
  nand4  g108(.a(new_n42_), .b(new_n31_), .c(x1), .d(new_n35_), .O(new_n125_));
  aoi21  g109(.a(new_n125_), .b(new_n124_), .c(new_n65_), .O(new_n126_));
  ...
  aoi21  g114(.a(new_n130_), .b(new_n127_), .c(new_n69_), .O(new_n131_));
  oai21  g115(.a(new_n131_), .b(new_n126_), .c(x9), .O(new_n132_));
  nor2   g116(.a(new_n65_), .b(x2), .O(new_n133_));
  ...
  nand4  g120(.a(x9), .b(x8), .c(new_n31_), .d(x2), .O(new_n137_));
  nor2   g121(.a(x9), .b(new_n31_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(x5), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(new_n137_), .c(new_n65_), .O(new_n140_));
  nand3  g124(.a(new_n138_), .b(new_n19_), .c(new_n65_), .O(new_n141_));
  inv1   g125(.a(new_n141_), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n140_), .c(x1), .O(new_n143_));
  nand3  g127(.a(new_n138_), .b(new_n17_), .c(x3), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  aoi21  g129(.a(new_n136_), .b(new_n18_), .c(new_n145_), .O(new_n146_));
  nand4  g130(.a(new_n146_), .b(new_n122_), .c(new_n104_), .d(new_n68_), .O(z1));
  nand2  g131(.a(x9), .b(x4), .O(new_n148_));
  nand2  g132(.a(new_n65_), .b(new_n69_), .O(new_n149_));
  ...
  nand2  g138(.a(new_n154_), .b(new_n86_), .O(new_n155_));
  nand2  g139(.a(new_n41_), .b(x8), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n65_), .c(new_n69_), .O(new_n157_));
  oai21  g141(.a(new_n150_), .b(new_n41_), .c(new_n157_), .O(new_n158_));
  ...
  nand3  g146(.a(new_n105_), .b(new_n18_), .c(x0), .O(new_n163_));
  nand3  g147(.a(x7), .b(x6), .c(x1), .O(new_n164_));
  nand3  g148(.a(new_n164_), .b(new_n163_), .c(new_n162_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n65_), .O(new_n166_));
  aoi21  g150(.a(new_n31_), .b(x6), .c(x8), .O(new_n167_));
  nand3  g151(.a(new_n167_), .b(new_n23_), .c(x1), .O(new_n168_));
  nand3  g152(.a(new_n168_), .b(new_n166_), .c(new_n159_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(x5), .O(new_n170_));
  nand3  g154(.a(new_n75_), .b(x7), .c(x1), .O(new_n171_));
  inv1   g155(.a(new_n171_), .O(new_n172_));
  aoi21  g156(.a(new_n53_), .b(x8), .c(x5), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n172_), .c(x6), .O(new_n174_));
  and2   g158(.a(new_n105_), .b(new_n19_), .O(new_n175_));
  oai21  g159(.a(new_n167_), .b(new_n175_), .c(x1), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand2  g161(.a(new_n19_), .b(new_n65_), .O(new_n178_));
  nand3  g162(.a(x7), .b(new_n18_), .c(x3), .O(new_n179_));
  oai21  g163(.a(new_n178_), .b(new_n41_), .c(new_n179_), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(x1), .O(new_n181_));
  nor2   g165(.a(x8), .b(x7), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n113_), .c(x4), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  aoi21  g168(.a(new_n177_), .b(x0), .c(new_n184_), .O(new_n185_));
  aoi21  g169(.a(new_n185_), .b(new_n170_), .c(new_n28_), .O(z4));
  inv1   g170(.a(new_n151_), .O(new_n187_));
  nand3  g171(.a(new_n155_), .b(new_n187_), .c(new_n148_), .O(new_n188_));
