...
module FAU ( 
  ...
  inv1   g135(.a(new_n46_), .O(new_n152_));
  nand2  g136(.a(new_n18_), .b(x4), .O(new_n153_));
  nand3  g137(.a(x9), .b(new_n38_), .c(new_n39_), .O(new_n154_));
  oai22  g138(.a(new_n154_), .b(new_n153_), .c(new_n119_), .d(new_n152_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x6), .O(new_n156_));
  oai21  g140(.a(new_n19_), .b(x5), .c(x0), .O(new_n157_));
  nand2  g141(.a(x5), .b(new_n17_), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n157_), .c(x4), .O(new_n159_));
  nand3  g143(.a(x9), .b(new_n18_), .c(x4), .O(new_n160_));
  nor3   g144(.a(new_n160_), .b(x2), .c(x0), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n159_), .c(new_n38_), .O(new_n162_));
  aoi21  g146(.a(new_n116_), .b(x0), .c(new_n19_), .O(new_n163_));
  oai22  g147(.a(new_n163_), .b(x2), .c(new_n20_), .d(x0), .O(new_n164_));
  nand4  g148(.a(new_n164_), .b(x9), .c(x8), .d(x4), .O(new_n165_));
  nand3  g149(.a(new_n165_), .b(new_n162_), .c(new_n156_), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n151_), .c(x3), .O(new_n167_));
  xor2a  g151(.a(new_n64_), .b(x0), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n18_), .O(new_n169_));
  nand3  g153(.a(new_n39_), .b(new_n29_), .c(new_n28_), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n169_), .c(new_n19_), .O(new_n171_));
  nand2  g155(.a(new_n41_), .b(x0), .O(new_n172_));
  oai21  g156(.a(x9), .b(new_n29_), .c(new_n172_), .O(new_n173_));
  nand3  g157(.a(x9), .b(new_n39_), .c(x2), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n173_), .c(new_n18_), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n171_), .c(x8), .O(new_n176_));
  nand2  g160(.a(x7), .b(x2), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(x8), .c(new_n28_), .O(new_n178_));
  nand3  g162(.a(new_n38_), .b(x4), .c(x2), .O(new_n179_));
  inv1   g163(.a(new_n179_), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(new_n178_), .c(new_n19_), .O(new_n181_));
  nand3  g165(.a(new_n58_), .b(new_n38_), .c(x7), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n181_), .c(new_n99_), .O(new_n183_));
  nand2  g167(.a(x7), .b(x6), .O(new_n184_));
  or2    g168(.a(new_n184_), .b(new_n138_), .O(new_n185_));
  inv1   g169(.a(new_n185_), .O(new_n186_));
  oai21  g170(.a(new_n186_), .b(new_n183_), .c(new_n18_), .O(new_n187_));
  nor2   g171(.a(new_n17_), .b(x0), .O(new_n188_));
  nand2  g172(.a(new_n188_), .b(new_n46_), .O(new_n189_));
  nand3  g173(.a(new_n189_), .b(new_n187_), .c(new_n176_), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n81_), .O(new_n191_));
  nand2  g175(.a(new_n39_), .b(new_n28_), .O(new_n192_));
  oai21  g176(.a(new_n64_), .b(new_n28_), .c(new_n192_), .O(new_n193_));
  nand4  g177(.a(new_n193_), .b(x6), .c(new_n18_), .d(new_n29_), .O(new_n194_));
  oai21  g178(.a(x7), .b(new_n17_), .c(x0), .O(new_n195_));
  ...
  nand3  g182(.a(new_n198_), .b(new_n191_), .c(new_n167_), .O(new_n199_));
  oai21  g183(.a(new_n38_), .b(new_n81_), .c(new_n18_), .O(new_n200_));
  nand4  g184(.a(new_n200_), .b(x9), .c(new_n39_), .d(new_n19_), .O(new_n201_));
  nor2   g185(.a(new_n201_), .b(new_n29_), .O(new_n202_));
  aoi21  g186(.a(new_n199_), .b(new_n80_), .c(new_n202_), .O(new_n203_));
  nand4  g187(.a(new_n203_), .b(new_n148_), .c(new_n144_), .d(new_n88_), .O(z1));
  nand2  g188(.a(new_n99_), .b(new_n29_), .O(new_n205_));
  nor2   g189(.a(x3), .b(x1), .O(new_n206_));
  nor2   g190(.a(new_n81_), .b(new_n80_), .O(new_n207_));
  nor2   g191(.a(new_n207_), .b(new_n206_), .O(new_n208_));
  nand2  g192(.a(new_n208_), .b(new_n205_), .O(z2));
  inv1   g193(.a(new_n207_), .O(new_n210_));
  nand2  g194(.a(new_n210_), .b(new_n205_), .O(z3));
  xor2a  g195(.a(x2), .b(x0), .O(new_n212_));
  nor2   g196(.a(new_n212_), .b(new_n208_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(x6), .O(new_n214_));
  inv1   g198(.a(new_n214_), .O(new_n215_));
  oai21  g199(.a(x3), .b(new_n80_), .c(x2), .O(new_n216_));
  aoi21  g200(.a(x3), .b(new_n28_), .c(new_n19_), .O(new_n217_));
  aoi21  g201(.a(new_n217_), .b(new_n216_), .c(new_n29_), .O(new_n218_));
  oai21  g202(.a(new_n218_), .b(new_n215_), .c(new_n39_), .O(new_n219_));
  aoi21  g203(.a(new_n19_), .b(new_n81_), .c(new_n80_), .O(new_n220_));
  nand3  g204(.a(new_n210_), .b(new_n19_), .c(new_n17_), .O(new_n221_));
  oai21  g205(.a(new_n220_), .b(x0), .c(new_n221_), .O(new_n222_));
  nand2  g206(.a(new_n222_), .b(x4), .O(new_n223_));
  oai21  g207(.a(new_n19_), .b(new_n28_), .c(x8), .O(new_n224_));
  nand2  g208(.a(new_n224_), .b(new_n17_), .O(new_n225_));
  oai21  g209(.a(x6), .b(new_n17_), .c(x8), .O(new_n226_));
  ...
  nor3   g213(.a(new_n188_), .b(x8), .c(new_n80_), .O(new_n230_));
  aoi21  g214(.a(new_n229_), .b(new_n81_), .c(new_n230_), .O(new_n231_));
  oai22  g215(.a(x3), .b(new_n28_), .c(x2), .d(new_n80_), .O(new_n232_));
  nand3  g216(.a(new_n232_), .b(new_n38_), .c(new_n19_), .O(new_n233_));
  oai21  g217(.a(new_n231_), .b(new_n39_), .c(new_n233_), .O(new_n234_));
  nand2  g218(.a(new_n234_), .b(new_n29_), .O(new_n235_));
  nor2   g219(.a(x8), .b(x6), .O(new_n236_));
  nand3  g220(.a(new_n236_), .b(new_n81_), .c(new_n17_), .O(new_n237_));
  nand4  g221(.a(new_n237_), .b(new_n235_), .c(new_n223_), .d(new_n219_), .O(new_n238_));
  inv1   g222(.a(new_n236_), .O(new_n239_));
  aoi21  g223(.a(x4), .b(x3), .c(x1), .O(new_n240_));
  nand2  g224(.a(new_n41_), .b(x7), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(new_n239_), .c(new_n240_), .O(new_n242_));
  nand2  g226(.a(new_n38_), .b(new_n29_), .O(new_n243_));
  aoi21  g227(.a(new_n243_), .b(new_n65_), .c(new_n19_), .O(new_n244_));
  oai21  g228(.a(new_n244_), .b(new_n242_), .c(new_n18_), .O(new_n245_));
  oai21  g229(.a(new_n184_), .b(x2), .c(new_n239_), .O(new_n246_));
  nand3  g230(.a(new_n246_), .b(new_n29_), .c(x1), .O(new_n247_));
  nand2  g231(.a(new_n247_), .b(new_n245_), .O(new_n248_));
  nand2  g232(.a(new_n248_), .b(x0), .O(new_n249_));
  nand2  g233(.a(new_n236_), .b(x2), .O(new_n250_));
  aoi21  g234(.a(new_n250_), .b(new_n184_), .c(new_n29_), .O(new_n251_));
  nand2  g235(.a(new_n20_), .b(new_n81_), .O(new_n252_));
  oai21  g236(.a(new_n79_), .b(new_n81_), .c(new_n252_), .O(new_n253_));
  oai21  g237(.a(new_n253_), .b(new_n251_), .c(x1), .O(new_n254_));
  nand2  g238(.a(new_n20_), .b(new_n28_), .O(new_n255_));
  nand2  g239(.a(new_n38_), .b(x3), .O(new_n256_));
  aoi21  g240(.a(new_n256_), .b(new_n255_), .c(new_n17_), .O(new_n257_));
  nand3  g241(.a(new_n20_), .b(x3), .c(new_n80_), .O(new_n258_));
  inv1   g242(.a(new_n258_), .O(new_n259_));
  oai21  g243(.a(new_n259_), .b(new_n257_), .c(x4), .O(new_n260_));
  nand3  g244(.a(new_n38_), .b(new_n39_), .c(x6), .O(new_n261_));
  nand3  g245(.a(new_n261_), .b(new_n260_), .c(new_n254_), .O(new_n262_));
  nand2  g246(.a(new_n262_), .b(new_n18_), .O(new_n263_));
  nand3  g247(.a(new_n207_), .b(new_n54_), .c(new_n29_), .O(new_n264_));
  nand3  g248(.a(new_n264_), .b(new_n263_), .c(new_n249_), .O(new_n265_));
  aoi21  g249(.a(new_n238_), .b(x5), .c(new_n265_), .O(new_n266_));
  nor2   g250(.a(new_n266_), .b(new_n99_), .O(z4));
  nand2  g251(.a(new_n213_), .b(new_n205_), .O(new_n268_));
