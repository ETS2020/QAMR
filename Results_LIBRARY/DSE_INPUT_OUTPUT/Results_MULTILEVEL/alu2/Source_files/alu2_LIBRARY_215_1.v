...
module FAU ( 
  ...
  nor3   g110(.a(new_n61_), .b(new_n66_), .c(new_n93_), .O(z3));
  oai21  g111(.a(new_n109_), .b(new_n41_), .c(new_n93_), .O(new_n128_));
  nor2   g112(.a(x6), .b(x3), .O(new_n129_));
  nor2   g113(.a(x7), .b(new_n66_), .O(new_n130_));
  oai21  g114(.a(new_n130_), .b(new_n129_), .c(new_n41_), .O(new_n131_));
  oai21  g115(.a(x3), .b(x2), .c(x7), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(new_n18_), .O(new_n133_));
  nand2  g117(.a(new_n130_), .b(x2), .O(new_n134_));
  nand4  g118(.a(new_n134_), .b(new_n133_), .c(new_n131_), .d(new_n128_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(x4), .O(new_n136_));
  nand3  g120(.a(x7), .b(new_n32_), .c(new_n17_), .O(new_n137_));
  nand3  g121(.a(new_n26_), .b(x2), .c(new_n93_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n41_), .O(new_n139_));
  nand2  g123(.a(x8), .b(x7), .O(new_n140_));
  nand4  g124(.a(new_n140_), .b(new_n17_), .c(new_n93_), .d(new_n41_), .O(new_n141_));
  nand3  g125(.a(x7), .b(new_n32_), .c(x1), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n139_), .c(x6), .O(new_n144_));
  aoi21  g128(.a(x7), .b(x2), .c(new_n33_), .O(new_n145_));
  oai22  g129(.a(new_n145_), .b(x6), .c(x8), .d(new_n26_), .O(new_n146_));
  nand3  g130(.a(new_n146_), .b(new_n32_), .c(x0), .O(new_n147_));
  nand3  g131(.a(new_n33_), .b(new_n18_), .c(new_n17_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n147_), .c(new_n144_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n66_), .O(new_n150_));
  oai21  g134(.a(x7), .b(new_n18_), .c(x8), .O(new_n151_));
  nand2  g135(.a(new_n17_), .b(new_n41_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n67_), .O(new_n153_));
  oai21  g137(.a(x2), .b(new_n41_), .c(x6), .O(new_n154_));
  aoi22  g138(.a(new_n154_), .b(x7), .c(new_n153_), .d(new_n151_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n66_), .c(new_n148_), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n32_), .c(x1), .O(new_n157_));
  nand4  g141(.a(new_n157_), .b(new_n150_), .c(new_n136_), .d(x5), .O(new_n158_));
  and2   g142(.a(new_n158_), .b(x9), .O(z4));
  inv1   g143(.a(new_n61_), .O(new_n160_));
  inv1   g144(.a(new_n153_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n125_), .c(new_n160_), .O(z5));
endmodule
