...
module FAU ( 
  ...
  nor2   g109(.a(new_n125_), .b(new_n61_), .O(z2));
  inv1   g110(.a(new_n61_), .O(new_n127_));
  oai21  g111(.a(new_n66_), .b(new_n93_), .c(new_n127_), .O(z3));
  ...
  oai21  g145(.a(new_n161_), .b(new_n125_), .c(new_n127_), .O(z5));
endmodule
