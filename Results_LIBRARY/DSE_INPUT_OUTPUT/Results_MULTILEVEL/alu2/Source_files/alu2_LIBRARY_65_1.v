...
module FAU ( 
  ...
  oai21  g149(.a(new_n79_), .b(new_n78_), .c(new_n162_), .O(z3));
  nand3  g150(.a(new_n163_), .b(new_n22_), .c(new_n17_), .O(new_n167_));
  oai21  g151(.a(new_n23_), .b(x0), .c(new_n79_), .O(new_n168_));
  oai21  g152(.a(x8), .b(new_n78_), .c(new_n168_), .O(new_n169_));
  nand3  g153(.a(new_n169_), .b(x7), .c(new_n19_), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n167_), .c(x2), .O(new_n171_));
  nand2  g155(.a(new_n163_), .b(x0), .O(new_n172_));
  oai21  g156(.a(x3), .b(new_n78_), .c(x4), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n172_), .c(new_n40_), .O(new_n174_));
  nor3   g158(.a(new_n19_), .b(new_n79_), .c(x0), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n174_), .c(new_n22_), .O(new_n176_));
  nand3  g160(.a(x4), .b(new_n78_), .c(new_n17_), .O(new_n177_));
  nand3  g161(.a(new_n73_), .b(new_n79_), .c(x1), .O(new_n178_));
  nand3  g162(.a(new_n178_), .b(new_n177_), .c(new_n176_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n171_), .c(x5), .O(new_n180_));
  oai21  g164(.a(x8), .b(new_n79_), .c(new_n110_), .O(new_n181_));
  nand2  g165(.a(x7), .b(x0), .O(new_n182_));
  oai21  g166(.a(x7), .b(x1), .c(new_n182_), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(x3), .O(new_n184_));
  oai21  g168(.a(new_n22_), .b(new_n78_), .c(new_n184_), .O(new_n185_));
  aoi21  g169(.a(new_n181_), .b(x2), .c(new_n185_), .O(new_n186_));
  inv1   g170(.a(new_n134_), .O(new_n187_));
  aoi21  g171(.a(new_n182_), .b(new_n187_), .c(new_n78_), .O(new_n188_));
  nor2   g172(.a(x8), .b(x4), .O(new_n189_));
  oai21  g173(.a(new_n189_), .b(new_n84_), .c(x0), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n80_), .O(new_n191_));
  nor2   g175(.a(new_n191_), .b(new_n188_), .O(new_n192_));
  oai21  g176(.a(new_n186_), .b(new_n19_), .c(new_n192_), .O(new_n193_));
  nand2  g177(.a(new_n193_), .b(new_n21_), .O(new_n194_));
  oai22  g178(.a(new_n87_), .b(new_n78_), .c(x8), .d(x3), .O(new_n195_));
  nand4  g179(.a(new_n195_), .b(x7), .c(new_n19_), .d(x0), .O(new_n196_));
  nand3  g180(.a(new_n196_), .b(new_n194_), .c(new_n180_), .O(new_n197_));
  nand3  g181(.a(new_n197_), .b(x9), .c(x6), .O(new_n198_));
  inv1   g182(.a(new_n198_), .O(z4));
  nand2  g183(.a(x2), .b(x0), .O(new_n200_));
  nand2  g184(.a(new_n200_), .b(new_n99_), .O(new_n201_));
  nand3  g185(.a(new_n201_), .b(new_n163_), .c(new_n162_), .O(new_n202_));
