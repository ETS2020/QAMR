...
module FAU ( 
  ...
  nand2  g175(.a(new_n18_), .b(x5), .O(new_n192_));
  nand2  g176(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  aoi21  g177(.a(new_n188_), .b(x1), .c(new_n193_), .O(new_n194_));
  nand2  g178(.a(new_n194_), .b(new_n135_), .O(z1));
  nand2  g179(.a(x3), .b(x1), .O(new_n196_));
  nand2  g180(.a(new_n102_), .b(new_n75_), .O(new_n197_));
  and2   g181(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  aoi21  g182(.a(new_n18_), .b(x5), .c(new_n198_), .O(z2));
  nand2  g183(.a(new_n196_), .b(new_n192_), .O(z3));
  nand2  g184(.a(new_n20_), .b(x8), .O(new_n201_));
  xnor2a g185(.a(x2), .b(x0), .O(new_n202_));
  nand3  g186(.a(new_n202_), .b(new_n201_), .c(x9), .O(new_n203_));
  oai21  g187(.a(new_n81_), .b(new_n30_), .c(x7), .O(new_n204_));
  aoi21  g188(.a(new_n204_), .b(new_n203_), .c(new_n102_), .O(new_n205_));
  nand3  g189(.a(new_n20_), .b(new_n40_), .c(new_n17_), .O(new_n206_));
  nor2   g190(.a(new_n19_), .b(new_n30_), .O(new_n207_));
  inv1   g191(.a(new_n207_), .O(new_n208_));
  oai21  g192(.a(new_n208_), .b(x3), .c(new_n206_), .O(new_n209_));
  oai21  g193(.a(new_n209_), .b(new_n205_), .c(x1), .O(new_n210_));
  nand2  g194(.a(x8), .b(x7), .O(new_n211_));
  nand4  g195(.a(new_n211_), .b(x9), .c(x6), .d(new_n75_), .O(new_n212_));
  inv1   g196(.a(new_n212_), .O(new_n213_));
  oai21  g197(.a(new_n213_), .b(new_n76_), .c(x2), .O(new_n214_));
  nor2   g198(.a(x8), .b(x6), .O(new_n215_));
  aoi21  g199(.a(new_n207_), .b(new_n17_), .c(new_n215_), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n214_), .c(new_n29_), .O(new_n217_));
  nand3  g201(.a(new_n40_), .b(x7), .c(new_n17_), .O(new_n218_));
  inv1   g202(.a(new_n218_), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n217_), .c(new_n102_), .O(new_n220_));
  aoi21  g204(.a(new_n220_), .b(new_n210_), .c(x4), .O(new_n221_));
  oai21  g205(.a(x3), .b(new_n75_), .c(x2), .O(new_n222_));
  aoi21  g206(.a(x3), .b(new_n29_), .c(new_n30_), .O(new_n223_));
  aoi21  g207(.a(new_n223_), .b(new_n222_), .c(x7), .O(new_n224_));
  aoi21  g208(.a(new_n30_), .b(new_n102_), .c(new_n75_), .O(new_n225_));
  nand3  g209(.a(new_n196_), .b(new_n30_), .c(new_n17_), .O(new_n226_));
  oai21  g210(.a(new_n225_), .b(x0), .c(new_n226_), .O(new_n227_));
  oai21  g211(.a(new_n227_), .b(new_n224_), .c(x4), .O(new_n228_));
  inv1   g212(.a(new_n215_), .O(new_n229_));
  nand2  g213(.a(new_n75_), .b(new_n29_), .O(new_n230_));
  nand3  g214(.a(x9), .b(new_n19_), .c(x6), .O(new_n231_));
  oai21  g215(.a(new_n231_), .b(new_n230_), .c(new_n229_), .O(new_n232_));
  nand3  g216(.a(new_n232_), .b(new_n102_), .c(new_n17_), .O(new_n233_));
  nand3  g217(.a(new_n233_), .b(new_n228_), .c(x9), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n221_), .c(x5), .O(new_n235_));
  aoi21  g219(.a(x4), .b(x3), .c(x1), .O(new_n236_));
  nand2  g220(.a(new_n41_), .b(x7), .O(new_n237_));
  aoi21  g221(.a(new_n237_), .b(new_n229_), .c(new_n236_), .O(new_n238_));
  aoi21  g222(.a(new_n118_), .b(new_n65_), .c(new_n30_), .O(new_n239_));
  oai21  g223(.a(new_n239_), .b(new_n238_), .c(x0), .O(new_n240_));
  nand2  g224(.a(new_n215_), .b(x2), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(new_n208_), .c(new_n35_), .O(new_n242_));
  nand2  g226(.a(new_n76_), .b(x3), .O(new_n243_));
  oai21  g227(.a(new_n20_), .b(x3), .c(new_n243_), .O(new_n244_));
  oai21  g228(.a(new_n244_), .b(new_n242_), .c(x1), .O(new_n245_));
  nand2  g229(.a(new_n21_), .b(new_n29_), .O(new_n246_));
  nand2  g230(.a(new_n40_), .b(x3), .O(new_n247_));
  aoi21  g231(.a(new_n247_), .b(new_n246_), .c(new_n17_), .O(new_n248_));
  nand3  g232(.a(new_n21_), .b(x3), .c(new_n75_), .O(new_n249_));
  inv1   g233(.a(new_n249_), .O(new_n250_));
  oai21  g234(.a(new_n250_), .b(new_n248_), .c(x4), .O(new_n251_));
  nand3  g235(.a(new_n40_), .b(new_n19_), .c(x6), .O(new_n252_));
  nand4  g236(.a(new_n252_), .b(new_n251_), .c(new_n245_), .d(new_n240_), .O(new_n253_));
  nand3  g237(.a(new_n253_), .b(x9), .c(new_n24_), .O(new_n254_));
  nand2  g238(.a(new_n254_), .b(new_n235_), .O(z4));
  inv1   g239(.a(new_n198_), .O(new_n256_));
  nand3  g240(.a(new_n202_), .b(new_n256_), .c(new_n192_), .O(new_n257_));
