...
module FAU ( 
  ...
  nor2   g111(.a(new_n127_), .b(new_n126_), .O(z2));
  nor3   g112(.a(new_n126_), .b(new_n64_), .c(new_n63_), .O(z3));
  oai21  g113(.a(x7), .b(new_n31_), .c(x8), .O(new_n130_));
  nand3  g114(.a(new_n130_), .b(x3), .c(x1), .O(new_n131_));
  nand2  g115(.a(x8), .b(x7), .O(new_n132_));
  nand4  g116(.a(new_n132_), .b(x6), .c(new_n64_), .d(new_n63_), .O(new_n133_));
  ...
  nand3  g121(.a(x7), .b(x3), .c(new_n24_), .O(new_n138_));
  nand2  g122(.a(new_n44_), .b(new_n31_), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(new_n138_), .c(new_n63_), .O(new_n140_));
  oai21  g124(.a(new_n19_), .b(new_n24_), .c(x8), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n31_), .O(new_n142_));
  nand3  g126(.a(x7), .b(x6), .c(new_n24_), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(new_n142_), .c(x3), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(new_n140_), .c(x0), .O(new_n145_));
  xor2a  g129(.a(x6), .b(x3), .O(new_n146_));
  nand3  g130(.a(new_n146_), .b(x7), .c(x1), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(new_n145_), .c(new_n137_), .O(new_n148_));
  oai21  g132(.a(x3), .b(new_n63_), .c(x2), .O(new_n149_));
  aoi21  g133(.a(x3), .b(new_n36_), .c(new_n31_), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n149_), .c(x7), .O(new_n151_));
  aoi21  g135(.a(new_n31_), .b(new_n64_), .c(new_n63_), .O(new_n152_));
  nand2  g136(.a(x3), .b(x1), .O(new_n153_));
  nand3  g137(.a(new_n153_), .b(new_n31_), .c(new_n24_), .O(new_n154_));
  oai21  g138(.a(new_n152_), .b(x0), .c(new_n154_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n151_), .c(x4), .O(new_n156_));
  nand2  g140(.a(new_n64_), .b(new_n24_), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n139_), .c(new_n156_), .O(new_n158_));
  aoi21  g142(.a(new_n148_), .b(new_n20_), .c(new_n158_), .O(new_n159_));
  nor3   g143(.a(new_n159_), .b(new_n18_), .c(new_n17_), .O(z4));
  oai22  g144(.a(new_n135_), .b(new_n127_), .c(new_n18_), .d(x5), .O(z5));
endmodule
