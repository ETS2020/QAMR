...
module FAU ( 
  ...
  nor2   g141(.a(new_n26_), .b(x4), .O(new_n158_));
  inv1   g142(.a(new_n158_), .O(new_n159_));
  nor2   g143(.a(x3), .b(x1), .O(new_n160_));
  nor2   g144(.a(new_n103_), .b(new_n79_), .O(new_n161_));
  nor2   g145(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n159_), .O(z2));
  nor3   g147(.a(new_n158_), .b(new_n103_), .c(new_n79_), .O(z3));
  ...
  inv1   g153(.a(new_n161_), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n22_), .c(new_n30_), .O(new_n171_));
  oai21  g155(.a(new_n169_), .b(x0), .c(new_n171_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n168_), .c(x5), .O(new_n173_));
  nand2  g157(.a(x2), .b(new_n18_), .O(new_n174_));
  aoi21  g158(.a(new_n30_), .b(x0), .c(new_n23_), .O(new_n175_));
  aoi22  g159(.a(new_n175_), .b(new_n174_), .c(x7), .d(new_n79_), .O(new_n176_));
  nand2  g160(.a(x7), .b(new_n18_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(x3), .c(new_n79_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n165_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n176_), .c(x6), .O(new_n180_));
  inv1   g164(.a(new_n160_), .O(new_n181_));
  nor2   g165(.a(new_n117_), .b(new_n23_), .O(new_n182_));
  nor2   g166(.a(new_n182_), .b(new_n18_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n140_), .c(new_n181_), .O(new_n184_));
  nand3  g168(.a(x7), .b(x3), .c(x1), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(new_n184_), .c(new_n180_), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n34_), .c(new_n25_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n173_), .c(new_n26_), .O(z4));
  inv1   g172(.a(new_n162_), .O(new_n189_));
  xnor2a g173(.a(x2), .b(x0), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n189_), .c(new_n159_), .O(new_n191_));
