...
module FAU ( 
  ...
  inv1   g157(.a(new_n149_), .O(new_n174_));
  aoi21  g158(.a(x4), .b(x3), .c(x1), .O(new_n175_));
  oai21  g159(.a(x6), .b(x2), .c(x7), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n174_), .c(new_n175_), .O(new_n177_));
  inv1   g161(.a(new_n100_), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n39_), .c(new_n45_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n177_), .c(x0), .O(new_n180_));
  nand2  g164(.a(x7), .b(x6), .O(new_n181_));
  nand2  g165(.a(new_n149_), .b(x2), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n181_), .c(new_n18_), .O(new_n183_));
  nand2  g167(.a(new_n158_), .b(new_n122_), .O(new_n184_));
  oai21  g168(.a(new_n184_), .b(new_n183_), .c(x1), .O(new_n185_));
  nand2  g169(.a(new_n129_), .b(new_n17_), .O(new_n186_));
  nand2  g170(.a(new_n20_), .b(x3), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n186_), .c(new_n53_), .O(new_n188_));
  nand3  g172(.a(new_n129_), .b(x3), .c(new_n121_), .O(new_n189_));
  inv1   g173(.a(new_n189_), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(new_n188_), .c(x4), .O(new_n191_));
  nand2  g175(.a(new_n57_), .b(x6), .O(new_n192_));
  nand4  g176(.a(new_n192_), .b(new_n191_), .c(new_n185_), .d(new_n180_), .O(new_n193_));
  nand3  g177(.a(new_n193_), .b(x9), .c(new_n19_), .O(new_n194_));
  inv1   g178(.a(new_n194_), .O(z4));
  inv1   g179(.a(new_n170_), .O(new_n196_));
  xnor2a g180(.a(x2), .b(x0), .O(new_n197_));
  nand3  g181(.a(new_n197_), .b(new_n196_), .c(new_n169_), .O(new_n198_));
