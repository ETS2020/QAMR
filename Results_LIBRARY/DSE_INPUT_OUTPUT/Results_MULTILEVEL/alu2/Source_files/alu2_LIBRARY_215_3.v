...
module FAU ( 
  ...
  aoi21  g144(.a(x4), .b(new_n85_), .c(new_n42_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n23_), .c(new_n25_), .O(new_n162_));
  oai21  g146(.a(new_n23_), .b(x0), .c(x3), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(x4), .c(x1), .O(new_n164_));
  nand4  g148(.a(new_n164_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n165_));
  ...
  oai21  g160(.a(new_n176_), .b(new_n151_), .c(new_n146_), .O(z5));
endmodule
