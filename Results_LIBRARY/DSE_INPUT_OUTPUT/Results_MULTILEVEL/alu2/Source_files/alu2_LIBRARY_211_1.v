...
module FAU ( 
  ...
  nor2   g116(.a(new_n132_), .b(new_n59_), .O(z2));
  inv1   g117(.a(new_n59_), .O(new_n134_));
  nand2  g118(.a(new_n129_), .b(new_n134_), .O(z3));
  ...
  nand3  g127(.a(new_n131_), .b(x6), .c(new_n41_), .O(new_n144_));
  ...
  nand3  g145(.a(new_n129_), .b(new_n18_), .c(new_n17_), .O(new_n162_));
  ...
  nand2  g153(.a(new_n137_), .b(new_n134_), .O(new_n170_));
