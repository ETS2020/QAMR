...
module FAU ( 
  ...
  nor2   g194(.a(new_n110_), .b(new_n142_), .O(new_n211_));
  nor2   g195(.a(x3), .b(x1), .O(new_n212_));
  nor2   g196(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  aoi21  g197(.a(new_n19_), .b(x8), .c(new_n213_), .O(z2));
  nand2  g198(.a(new_n19_), .b(x8), .O(new_n215_));
  ...
  nand3  g254(.a(new_n211_), .b(new_n45_), .c(new_n33_), .O(new_n271_));
  ...
  nand2  g258(.a(new_n219_), .b(new_n215_), .O(new_n275_));
