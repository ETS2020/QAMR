...
module FAU ( 
  ...
  nand2  g112(.a(x9), .b(new_n17_), .O(new_n129_));
  xor2a  g113(.a(x3), .b(x1), .O(new_n130_));
  nand2  g114(.a(new_n130_), .b(new_n129_), .O(z2));
  oai21  g115(.a(new_n65_), .b(new_n96_), .c(new_n129_), .O(z3));
  oai21  g116(.a(new_n113_), .b(new_n32_), .c(new_n96_), .O(new_n133_));
  nor2   g117(.a(x6), .b(x3), .O(new_n134_));
  nor2   g118(.a(x7), .b(new_n65_), .O(new_n135_));
  oai21  g119(.a(new_n135_), .b(new_n134_), .c(new_n32_), .O(new_n136_));
  oai21  g120(.a(x3), .b(x2), .c(x7), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n25_), .O(new_n138_));
  nand2  g122(.a(new_n135_), .b(x2), .O(new_n139_));
  nand4  g123(.a(new_n139_), .b(new_n138_), .c(new_n136_), .d(new_n133_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(x4), .O(new_n141_));
  nand2  g125(.a(new_n42_), .b(new_n24_), .O(new_n142_));
  nand3  g126(.a(new_n19_), .b(x2), .c(new_n96_), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(new_n142_), .c(new_n32_), .O(new_n144_));
  nand2  g128(.a(x8), .b(x7), .O(new_n145_));
  nand4  g129(.a(new_n145_), .b(new_n24_), .c(new_n96_), .d(new_n32_), .O(new_n146_));
  nand2  g130(.a(new_n42_), .b(x1), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g132(.a(new_n148_), .b(new_n144_), .c(x6), .O(new_n149_));
  aoi21  g133(.a(x7), .b(x2), .c(new_n46_), .O(new_n150_));
  oai22  g134(.a(new_n150_), .b(x6), .c(x8), .d(new_n19_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(new_n20_), .c(x0), .O(new_n152_));
  nand3  g136(.a(new_n46_), .b(new_n25_), .c(new_n24_), .O(new_n153_));
  nand3  g137(.a(new_n153_), .b(new_n152_), .c(new_n149_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n65_), .O(new_n155_));
  oai21  g139(.a(x7), .b(new_n25_), .c(x8), .O(new_n156_));
  nand2  g140(.a(new_n24_), .b(new_n32_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n67_), .O(new_n158_));
  oai21  g142(.a(x2), .b(new_n32_), .c(x6), .O(new_n159_));
  aoi22  g143(.a(new_n159_), .b(x7), .c(new_n158_), .d(new_n156_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n65_), .c(new_n153_), .O(new_n161_));
  nand3  g145(.a(new_n161_), .b(new_n20_), .c(x1), .O(new_n162_));
  nand3  g146(.a(new_n162_), .b(new_n155_), .c(new_n141_), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(x9), .c(x5), .O(new_n164_));
  inv1   g148(.a(new_n164_), .O(z4));
  inv1   g149(.a(new_n158_), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n130_), .c(new_n129_), .O(z5));
endmodule
