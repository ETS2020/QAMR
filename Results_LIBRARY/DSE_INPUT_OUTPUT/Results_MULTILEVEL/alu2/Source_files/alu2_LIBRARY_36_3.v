...
module FAU ( 
  ...
  nand2  g135(.a(new_n85_), .b(new_n108_), .O(new_n152_));
  and2   g136(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nor2   g137(.a(new_n153_), .b(new_n66_), .O(z2));
  nand2  g138(.a(new_n151_), .b(new_n146_), .O(z3));
  nor2   g139(.a(x3), .b(new_n108_), .O(new_n156_));
  nor3   g140(.a(new_n18_), .b(new_n85_), .c(x1), .O(new_n157_));
  oai22  g141(.a(new_n157_), .b(new_n156_), .c(new_n23_), .d(x0), .O(new_n158_));
  nor2   g142(.a(x2), .b(new_n42_), .O(new_n159_));
  nor2   g143(.a(new_n44_), .b(x0), .O(new_n160_));
  oai22  g144(.a(new_n160_), .b(new_n159_), .c(new_n23_), .d(x1), .O(new_n161_));
  oai21  g145(.a(x4), .b(new_n42_), .c(x7), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n25_), .O(new_n163_));
  nand4  g147(.a(x7), .b(x4), .c(x1), .d(new_n42_), .O(new_n164_));
  nand4  g148(.a(new_n164_), .b(new_n163_), .c(new_n161_), .d(new_n158_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(x6), .O(new_n166_));
  oai21  g150(.a(new_n111_), .b(x1), .c(new_n130_), .O(new_n167_));
  nand3  g151(.a(x7), .b(x3), .c(x1), .O(new_n168_));
  aoi21  g152(.a(new_n168_), .b(new_n167_), .c(new_n42_), .O(new_n169_));
  nand3  g153(.a(x7), .b(new_n31_), .c(x3), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n50_), .c(new_n108_), .O(new_n171_));
  nand3  g155(.a(new_n49_), .b(x3), .c(x2), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(new_n19_), .O(new_n173_));
  nor3   g157(.a(new_n173_), .b(new_n171_), .c(new_n169_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n166_), .c(new_n34_), .O(z4));
  inv1   g159(.a(new_n153_), .O(new_n176_));
  xnor2a g160(.a(x2), .b(x0), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n176_), .c(new_n146_), .O(new_n178_));
