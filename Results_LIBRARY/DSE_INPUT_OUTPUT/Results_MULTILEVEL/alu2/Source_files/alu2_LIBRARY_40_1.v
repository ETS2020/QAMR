...
module FAU ( 
  ...
  nand4  g147(.a(new_n163_), .b(new_n156_), .c(new_n142_), .d(x5), .O(new_n164_));
  and2   g148(.a(new_n164_), .b(x9), .O(z4));
  inv1   g149(.a(new_n159_), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n131_), .c(new_n130_), .O(z5));
endmodule
