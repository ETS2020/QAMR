...
module FAU ( 
  ...
  nand3  g197(.a(new_n213_), .b(new_n89_), .c(new_n211_), .O(z2));
  nor3   g198(.a(new_n212_), .b(new_n83_), .c(new_n82_), .O(z3));
  nand2  g199(.a(x8), .b(x7), .O(new_n216_));
  nand2  g200(.a(new_n89_), .b(new_n211_), .O(new_n217_));
  nand3  g201(.a(new_n217_), .b(x2), .c(x0), .O(new_n218_));
  nand4  g202(.a(x3), .b(new_n17_), .c(x1), .d(new_n28_), .O(new_n219_));
  nand2  g203(.a(new_n219_), .b(new_n218_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n42_), .O(new_n221_));
  nor2   g205(.a(x3), .b(x2), .O(new_n222_));
  nand3  g206(.a(new_n222_), .b(new_n82_), .c(new_n28_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(new_n221_), .O(new_n224_));
  nand3  g208(.a(new_n224_), .b(new_n216_), .c(x6), .O(new_n225_));
  aoi21  g209(.a(new_n83_), .b(x1), .c(new_n17_), .O(new_n226_));
  oai21  g210(.a(new_n83_), .b(x0), .c(x6), .O(new_n227_));
  oai21  g211(.a(new_n227_), .b(new_n226_), .c(new_n37_), .O(new_n228_));
  oai21  g212(.a(x6), .b(x3), .c(x1), .O(new_n229_));
  nor2   g213(.a(new_n84_), .b(x6), .O(new_n230_));
  aoi22  g214(.a(new_n230_), .b(new_n17_), .c(new_n229_), .d(new_n28_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n228_), .O(new_n232_));
  nor2   g216(.a(x8), .b(x6), .O(new_n233_));
  aoi22  g217(.a(new_n233_), .b(new_n222_), .c(new_n232_), .d(x4), .O(new_n234_));
  aoi21  g218(.a(new_n234_), .b(new_n225_), .c(new_n18_), .O(new_n235_));
  inv1   g219(.a(new_n233_), .O(new_n236_));
  aoi21  g220(.a(x4), .b(x3), .c(x1), .O(new_n237_));
  nand2  g221(.a(new_n39_), .b(x7), .O(new_n238_));
  aoi21  g222(.a(new_n238_), .b(new_n236_), .c(new_n237_), .O(new_n239_));
  nand2  g223(.a(new_n20_), .b(new_n17_), .O(new_n240_));
  inv1   g224(.a(new_n240_), .O(new_n241_));
  oai21  g225(.a(new_n241_), .b(new_n239_), .c(x0), .O(new_n242_));
  nand2  g226(.a(new_n233_), .b(x2), .O(new_n243_));
  aoi21  g227(.a(new_n243_), .b(new_n103_), .c(new_n42_), .O(new_n244_));
  nand2  g228(.a(new_n54_), .b(x3), .O(new_n245_));
  oai21  g229(.a(new_n23_), .b(x3), .c(new_n245_), .O(new_n246_));
  oai21  g230(.a(new_n246_), .b(new_n244_), .c(x1), .O(new_n247_));
  nand2  g231(.a(new_n20_), .b(new_n28_), .O(new_n248_));
  nand2  g232(.a(new_n36_), .b(x3), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(new_n248_), .c(new_n17_), .O(new_n250_));
  nand3  g234(.a(new_n20_), .b(x3), .c(new_n82_), .O(new_n251_));
  inv1   g235(.a(new_n251_), .O(new_n252_));
  oai21  g236(.a(new_n252_), .b(new_n250_), .c(x4), .O(new_n253_));
  nand3  g237(.a(new_n36_), .b(new_n37_), .c(x6), .O(new_n254_));
  nand4  g238(.a(new_n254_), .b(new_n253_), .c(new_n247_), .d(new_n242_), .O(new_n255_));
  and2   g239(.a(new_n255_), .b(new_n18_), .O(new_n256_));
  oai21  g240(.a(new_n256_), .b(new_n235_), .c(x9), .O(new_n257_));
  inv1   g241(.a(new_n103_), .O(new_n258_));
  nand2  g242(.a(new_n258_), .b(new_n17_), .O(new_n259_));
  aoi21  g243(.a(x5), .b(new_n83_), .c(x1), .O(new_n260_));
  aoi21  g244(.a(new_n259_), .b(new_n236_), .c(new_n260_), .O(new_n261_));
  nand2  g245(.a(new_n83_), .b(x2), .O(new_n262_));
  nand2  g246(.a(new_n54_), .b(x5), .O(new_n263_));
  nand2  g247(.a(new_n76_), .b(new_n18_), .O(new_n264_));
  oai21  g248(.a(new_n263_), .b(new_n262_), .c(new_n264_), .O(new_n265_));
  oai21  g249(.a(new_n265_), .b(new_n261_), .c(x0), .O(new_n266_));
  inv1   g250(.a(new_n245_), .O(new_n267_));
  nand2  g251(.a(new_n258_), .b(new_n83_), .O(new_n268_));
  nand2  g252(.a(new_n233_), .b(new_n17_), .O(new_n269_));
  aoi21  g253(.a(new_n269_), .b(new_n268_), .c(new_n18_), .O(new_n270_));
  oai21  g254(.a(new_n270_), .b(new_n267_), .c(x1), .O(new_n271_));
  nand3  g255(.a(new_n271_), .b(new_n266_), .c(x9), .O(new_n272_));
  nand2  g256(.a(new_n272_), .b(new_n42_), .O(new_n273_));
  nand2  g257(.a(new_n273_), .b(new_n257_), .O(z4));
  xnor2a g258(.a(x2), .b(x0), .O(new_n275_));
  nand3  g259(.a(new_n275_), .b(new_n217_), .c(new_n213_), .O(new_n276_));
