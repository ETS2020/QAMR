// Benchmark "FAU" written by ABC on Thu Aug 13 18:21:52 2020
...
module FAU ( 
  ...
  nand2  g171(.a(new_n64_), .b(new_n18_), .O(new_n188_));
  oai21  g172(.a(new_n187_), .b(new_n141_), .c(new_n188_), .O(new_n189_));
  aoi21  g173(.a(new_n186_), .b(x1), .c(new_n189_), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n163_), .c(new_n134_), .O(z1));
  nor2   g175(.a(x3), .b(x1), .O(new_n192_));
  nand2  g176(.a(x3), .b(x1), .O(new_n193_));
  inv1   g177(.a(new_n193_), .O(new_n194_));
  nor2   g178(.a(new_n194_), .b(new_n192_), .O(new_n195_));
  nand2  g179(.a(new_n195_), .b(new_n188_), .O(z2));
  nand2  g180(.a(new_n193_), .b(new_n188_), .O(z3));
  nand2  g181(.a(new_n24_), .b(x8), .O(new_n198_));
  nand3  g182(.a(new_n198_), .b(x3), .c(x1), .O(new_n199_));
  nand2  g183(.a(new_n192_), .b(new_n20_), .O(new_n200_));
  nand2  g184(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand2  g185(.a(x2), .b(x0), .O(new_n202_));
  nand2  g186(.a(new_n202_), .b(new_n123_), .O(new_n203_));
  nand2  g187(.a(new_n203_), .b(new_n201_), .O(new_n204_));
  nand3  g188(.a(new_n39_), .b(x6), .c(new_n78_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(new_n49_), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(x2), .O(new_n207_));
  nor2   g191(.a(x8), .b(x6), .O(new_n208_));
  aoi21  g192(.a(new_n126_), .b(new_n17_), .c(new_n208_), .O(new_n209_));
  aoi21  g193(.a(new_n209_), .b(new_n207_), .c(new_n29_), .O(new_n210_));
  nand2  g194(.a(x6), .b(x1), .O(new_n211_));
  nand2  g195(.a(new_n39_), .b(new_n17_), .O(new_n212_));
  aoi21  g196(.a(new_n212_), .b(new_n211_), .c(new_n23_), .O(new_n213_));
  oai21  g197(.a(new_n213_), .b(new_n210_), .c(new_n80_), .O(new_n214_));
  inv1   g198(.a(new_n208_), .O(new_n215_));
  aoi21  g199(.a(x3), .b(x0), .c(new_n39_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n23_), .c(new_n215_), .O(new_n217_));
  nand3  g201(.a(new_n217_), .b(new_n17_), .c(x1), .O(new_n218_));
  nand3  g202(.a(new_n218_), .b(new_n214_), .c(new_n204_), .O(new_n219_));
  oai21  g203(.a(x3), .b(new_n78_), .c(x2), .O(new_n220_));
  aoi21  g204(.a(x3), .b(new_n29_), .c(new_n19_), .O(new_n221_));
  aoi21  g205(.a(new_n221_), .b(new_n220_), .c(x7), .O(new_n222_));
  oai21  g206(.a(new_n115_), .b(new_n78_), .c(new_n29_), .O(new_n223_));
  nand3  g207(.a(new_n193_), .b(new_n19_), .c(new_n17_), .O(new_n224_));
  nand2  g208(.a(new_n224_), .b(new_n223_), .O(new_n225_));
  oai21  g209(.a(new_n225_), .b(new_n222_), .c(x4), .O(new_n226_));
  oai21  g210(.a(new_n215_), .b(new_n105_), .c(new_n226_), .O(new_n227_));
  aoi21  g211(.a(new_n219_), .b(new_n30_), .c(new_n227_), .O(new_n228_));
  nand4  g212(.a(new_n194_), .b(x7), .c(new_n19_), .d(new_n30_), .O(new_n229_));
  oai21  g213(.a(new_n228_), .b(new_n18_), .c(new_n229_), .O(new_n230_));
  ...
  inv1   g236(.a(new_n195_), .O(new_n253_));
  nand3  g237(.a(new_n203_), .b(new_n253_), .c(new_n188_), .O(new_n254_));
