...
module FAU ( 
  ...
  nand3  g158(.a(new_n50_), .b(new_n17_), .c(new_n127_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n174_), .O(z2));
  oai21  g160(.a(new_n50_), .b(x3), .c(new_n174_), .O(z3));
  oai21  g161(.a(new_n21_), .b(new_n127_), .c(new_n18_), .O(new_n178_));
  ...
  nand2  g167(.a(x7), .b(new_n18_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(x6), .c(new_n127_), .O(new_n185_));
  aoi22  g169(.a(new_n24_), .b(x2), .c(x7), .d(x1), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(new_n185_), .c(new_n141_), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n19_), .O(new_n188_));
  nand3  g172(.a(new_n33_), .b(x2), .c(new_n18_), .O(new_n189_));
  nand3  g173(.a(new_n189_), .b(new_n188_), .c(new_n183_), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(x4), .O(new_n191_));
  nand3  g175(.a(new_n28_), .b(x2), .c(x0), .O(new_n192_));
  nand2  g176(.a(x8), .b(x7), .O(new_n193_));
  nand3  g177(.a(new_n193_), .b(x6), .c(new_n18_), .O(new_n194_));
  inv1   g178(.a(new_n194_), .O(new_n195_));
  oai21  g179(.a(new_n195_), .b(new_n121_), .c(new_n61_), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n192_), .c(new_n19_), .O(new_n197_));
  nand2  g181(.a(new_n61_), .b(x0), .O(new_n198_));
  aoi21  g182(.a(new_n198_), .b(x6), .c(new_n21_), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n197_), .c(new_n23_), .O(new_n200_));
  nor2   g184(.a(new_n154_), .b(new_n18_), .O(new_n201_));
  aoi21  g185(.a(x6), .b(new_n18_), .c(new_n21_), .O(new_n202_));
  ...
  oai21  g189(.a(new_n147_), .b(new_n24_), .c(x0), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand3  g191(.a(new_n207_), .b(x6), .c(new_n19_), .O(new_n208_));
  nand2  g192(.a(new_n208_), .b(x3), .O(new_n209_));
  aoi21  g193(.a(new_n204_), .b(x1), .c(new_n209_), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n191_), .c(new_n50_), .O(z4));
  inv1   g195(.a(new_n143_), .O(new_n212_));
  inv1   g196(.a(new_n42_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(new_n27_), .O(new_n214_));
  nand4  g198(.a(new_n214_), .b(x9), .c(x5), .d(new_n23_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(new_n17_), .c(new_n127_), .O(new_n216_));
  nor2   g200(.a(x3), .b(x1), .O(new_n217_));
  oai22  g201(.a(new_n217_), .b(new_n216_), .c(new_n158_), .d(new_n212_), .O(new_n218_));
  nand3  g202(.a(x6), .b(new_n61_), .c(new_n18_), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n143_), .c(x8), .O(new_n220_));
  nand4  g204(.a(new_n220_), .b(x5), .c(new_n23_), .d(x1), .O(new_n221_));
  nand2  g205(.a(new_n221_), .b(x3), .O(new_n222_));
  nand2  g206(.a(new_n222_), .b(x9), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(new_n218_), .O(z5));
endmodule
