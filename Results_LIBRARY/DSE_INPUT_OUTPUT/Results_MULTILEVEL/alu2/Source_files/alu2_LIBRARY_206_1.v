...
module FAU ( 
  ...
  nor3   g115(.a(new_n126_), .b(new_n64_), .c(new_n63_), .O(z3));
  ...
  nand3  g142(.a(new_n127_), .b(new_n31_), .c(new_n24_), .O(new_n159_));
  ...
  nand2  g151(.a(new_n134_), .b(new_n167_), .O(new_n168_));
