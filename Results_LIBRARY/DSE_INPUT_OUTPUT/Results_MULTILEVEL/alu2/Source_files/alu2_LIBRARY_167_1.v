...
module FAU ( 
  ...
  xnor2a g111(.a(x3), .b(x1), .O(new_n128_));
  inv1   g112(.a(new_n128_), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(new_n127_), .O(z2));
  nor3   g114(.a(new_n126_), .b(new_n64_), .c(new_n63_), .O(z3));
  xnor2a g115(.a(x2), .b(x0), .O(new_n132_));
  nand4  g116(.a(new_n132_), .b(new_n128_), .c(x6), .d(x5), .O(new_n133_));
  nor2   g117(.a(new_n133_), .b(x4), .O(new_n134_));
  oai21  g118(.a(x3), .b(new_n63_), .c(x2), .O(new_n135_));
  aoi21  g119(.a(x3), .b(new_n36_), .c(new_n31_), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n135_), .c(new_n20_), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n134_), .c(new_n19_), .O(new_n138_));
  nand4  g122(.a(new_n128_), .b(x6), .c(x5), .d(new_n36_), .O(new_n139_));
  oai21  g123(.a(x6), .b(new_n63_), .c(new_n139_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(new_n24_), .O(new_n141_));
  aoi21  g125(.a(new_n19_), .b(x6), .c(new_n63_), .O(new_n142_));
  nand4  g126(.a(x6), .b(x5), .c(x2), .d(new_n63_), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(x6), .c(x3), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(new_n142_), .c(x0), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n141_), .c(x8), .O(new_n146_));
  nand2  g130(.a(x3), .b(new_n63_), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(x6), .c(new_n24_), .O(new_n148_));
  ...
  oai21  g139(.a(new_n155_), .b(new_n146_), .c(new_n20_), .O(new_n156_));
  oai21  g140(.a(new_n149_), .b(new_n63_), .c(new_n36_), .O(new_n157_));
  nand2  g141(.a(x3), .b(x1), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(new_n31_), .c(new_n24_), .O(new_n159_));
  ...
  nand3  g147(.a(new_n163_), .b(new_n156_), .c(new_n138_), .O(new_n164_));
  and2   g148(.a(new_n164_), .b(x9), .O(z4));
  nand3  g149(.a(new_n132_), .b(new_n128_), .c(new_n127_), .O(new_n166_));
