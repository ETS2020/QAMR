...
module FAU ( 
  ...
  nor3   g194(.a(new_n209_), .b(new_n96_), .c(new_n132_), .O(z3));
  nand2  g195(.a(x2), .b(x0), .O(new_n212_));
  aoi21  g196(.a(new_n212_), .b(new_n190_), .c(new_n208_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(x6), .O(new_n214_));
  inv1   g198(.a(new_n214_), .O(new_n215_));
  oai21  g199(.a(x3), .b(new_n132_), .c(x2), .O(new_n216_));
  aoi21  g200(.a(x3), .b(new_n17_), .c(new_n20_), .O(new_n217_));
  aoi21  g201(.a(new_n217_), .b(new_n216_), .c(new_n18_), .O(new_n218_));
  oai21  g202(.a(new_n218_), .b(new_n215_), .c(new_n31_), .O(new_n219_));
  aoi21  g203(.a(new_n20_), .b(new_n96_), .c(new_n132_), .O(new_n220_));
  inv1   g204(.a(new_n206_), .O(new_n221_));
  nand3  g205(.a(new_n221_), .b(new_n20_), .c(new_n30_), .O(new_n222_));
  oai21  g206(.a(new_n220_), .b(x0), .c(new_n222_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(x4), .O(new_n224_));
  oai21  g208(.a(new_n20_), .b(new_n17_), .c(x8), .O(new_n225_));
  nand2  g209(.a(new_n225_), .b(new_n30_), .O(new_n226_));
  oai21  g210(.a(x6), .b(new_n30_), .c(x8), .O(new_n227_));
  ...
  aoi22  g215(.a(new_n231_), .b(x1), .c(new_n230_), .d(new_n96_), .O(new_n232_));
  oai22  g216(.a(x3), .b(new_n17_), .c(x2), .d(new_n132_), .O(new_n233_));
  nand3  g217(.a(new_n233_), .b(new_n42_), .c(new_n20_), .O(new_n234_));
  oai21  g218(.a(new_n232_), .b(new_n31_), .c(new_n234_), .O(new_n235_));
  nand2  g219(.a(new_n235_), .b(new_n18_), .O(new_n236_));
  nand3  g220(.a(new_n165_), .b(new_n96_), .c(new_n30_), .O(new_n237_));
  nand4  g221(.a(new_n237_), .b(new_n236_), .c(new_n224_), .d(new_n219_), .O(new_n238_));
  aoi21  g222(.a(x4), .b(x3), .c(x1), .O(new_n239_));
  nand2  g223(.a(new_n33_), .b(x7), .O(new_n240_));
  aoi21  g224(.a(new_n240_), .b(new_n166_), .c(new_n239_), .O(new_n241_));
  nand2  g225(.a(new_n42_), .b(new_n18_), .O(new_n242_));
  aoi21  g226(.a(new_n242_), .b(new_n133_), .c(new_n20_), .O(new_n243_));
  oai21  g227(.a(new_n243_), .b(new_n241_), .c(new_n19_), .O(new_n244_));
  oai21  g228(.a(new_n74_), .b(x2), .c(new_n166_), .O(new_n245_));
  nand3  g229(.a(new_n245_), .b(new_n18_), .c(x1), .O(new_n246_));
  nand2  g230(.a(new_n246_), .b(new_n244_), .O(new_n247_));
  nand2  g231(.a(new_n247_), .b(x0), .O(new_n248_));
  nand2  g232(.a(new_n165_), .b(x2), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(new_n74_), .c(new_n18_), .O(new_n250_));
  oai21  g234(.a(new_n22_), .b(x3), .c(new_n159_), .O(new_n251_));
  oai21  g235(.a(new_n251_), .b(new_n250_), .c(x1), .O(new_n252_));
  nand2  g236(.a(new_n21_), .b(new_n17_), .O(new_n253_));
  nand2  g237(.a(new_n42_), .b(x3), .O(new_n254_));
  aoi21  g238(.a(new_n254_), .b(new_n253_), .c(new_n30_), .O(new_n255_));
  nand3  g239(.a(new_n21_), .b(x3), .c(new_n132_), .O(new_n256_));
  inv1   g240(.a(new_n256_), .O(new_n257_));
  oai21  g241(.a(new_n257_), .b(new_n255_), .c(x4), .O(new_n258_));
  nand3  g242(.a(new_n42_), .b(new_n31_), .c(x6), .O(new_n259_));
  nand3  g243(.a(new_n259_), .b(new_n258_), .c(new_n252_), .O(new_n260_));
  nand2  g244(.a(new_n260_), .b(new_n19_), .O(new_n261_));
  nand3  g245(.a(new_n206_), .b(new_n158_), .c(new_n18_), .O(new_n262_));
  nand3  g246(.a(new_n262_), .b(new_n261_), .c(new_n248_), .O(new_n263_));
  aoi21  g247(.a(new_n238_), .b(x5), .c(new_n263_), .O(new_n264_));
  nor2   g248(.a(new_n264_), .b(new_n44_), .O(z4));
  or2    g249(.a(new_n213_), .b(new_n209_), .O(z5));
endmodule
