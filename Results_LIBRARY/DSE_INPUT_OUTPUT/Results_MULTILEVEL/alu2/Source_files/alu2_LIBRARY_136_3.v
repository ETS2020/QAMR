...
module FAU ( 
  ...
  aoi21  g156(.a(x4), .b(new_n69_), .c(new_n70_), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n26_), .c(new_n20_), .O(new_n174_));
  oai21  g158(.a(new_n26_), .b(x0), .c(x3), .O(new_n175_));
  ...
  oai21  g162(.a(new_n117_), .b(x1), .c(new_n133_), .O(new_n179_));
  nand3  g163(.a(x7), .b(x3), .c(x1), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n179_), .c(new_n70_), .O(new_n181_));
  aoi21  g165(.a(new_n112_), .b(new_n50_), .c(new_n111_), .O(new_n182_));
  nand3  g166(.a(new_n49_), .b(x3), .c(x2), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(new_n19_), .O(new_n184_));
  nor3   g168(.a(new_n184_), .b(new_n182_), .c(new_n181_), .O(new_n185_));
  aoi21  g169(.a(new_n185_), .b(new_n178_), .c(new_n21_), .O(z4));
  xor2a  g170(.a(x2), .b(x0), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n162_), .c(new_n164_), .O(z5));
endmodule
