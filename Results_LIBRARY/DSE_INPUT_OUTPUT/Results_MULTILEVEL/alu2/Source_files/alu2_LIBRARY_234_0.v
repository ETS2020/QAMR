...
module FAU ( 
  ...
  nand3  g121(.a(new_n137_), .b(new_n117_), .c(new_n17_), .O(new_n138_));
  ...
  xor2a  g300(.a(x3), .b(x1), .O(new_n317_));
  nor2   g301(.a(new_n296_), .b(new_n137_), .O(new_n318_));
  oai22  g302(.a(new_n318_), .b(new_n317_), .c(x9), .d(x1), .O(z5));
endmodule
