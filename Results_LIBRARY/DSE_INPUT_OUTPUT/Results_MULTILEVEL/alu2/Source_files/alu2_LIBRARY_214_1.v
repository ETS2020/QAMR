...
module FAU ( 
  ...
  aoi21  g074(.a(new_n90_), .b(new_n37_), .c(new_n77_), .O(new_n91_));
  nor2   g075(.a(x9), .b(x7), .O(new_n92_));
  nand2  g076(.a(x8), .b(x0), .O(new_n93_));
  nand3  g077(.a(new_n23_), .b(x7), .c(x4), .O(new_n94_));
  aoi21  g078(.a(new_n94_), .b(new_n93_), .c(new_n40_), .O(new_n95_));
  oai21  g079(.a(x8), .b(x4), .c(x7), .O(new_n96_));
  nand2  g080(.a(new_n40_), .b(new_n17_), .O(new_n97_));
  ...
  nand2  g088(.a(new_n92_), .b(new_n19_), .O(new_n105_));
  nand3  g089(.a(new_n105_), .b(new_n104_), .c(new_n99_), .O(new_n106_));
  aoi22  g090(.a(new_n106_), .b(x6), .c(new_n92_), .d(new_n21_), .O(new_n107_));
  nand2  g091(.a(new_n22_), .b(new_n17_), .O(new_n108_));
  oai21  g092(.a(new_n82_), .b(new_n17_), .c(new_n108_), .O(new_n109_));
  nand3  g093(.a(new_n109_), .b(new_n21_), .c(new_n19_), .O(new_n110_));
  nand2  g094(.a(new_n22_), .b(x2), .O(new_n111_));
  nand2  g095(.a(new_n111_), .b(x0), .O(new_n112_));
  nand4  g096(.a(new_n112_), .b(x9), .c(x5), .d(x4), .O(new_n113_));
  aoi21  g097(.a(new_n113_), .b(new_n110_), .c(new_n23_), .O(new_n114_));
  nor3   g098(.a(x9), .b(x5), .c(x4), .O(new_n115_));
  aoi21  g099(.a(new_n114_), .b(x6), .c(new_n115_), .O(new_n116_));
  oai21  g100(.a(new_n107_), .b(x3), .c(new_n116_), .O(new_n117_));
  oai21  g101(.a(new_n117_), .b(new_n91_), .c(new_n76_), .O(new_n118_));
  nand2  g102(.a(x4), .b(new_n77_), .O(new_n119_));
  nand3  g103(.a(x5), .b(new_n19_), .c(x3), .O(new_n120_));
  nand3  g104(.a(new_n120_), .b(new_n119_), .c(new_n22_), .O(new_n121_));
  nand2  g105(.a(new_n121_), .b(new_n34_), .O(new_n122_));
  nor2   g106(.a(x7), .b(x5), .O(new_n123_));
  oai22  g107(.a(new_n123_), .b(new_n40_), .c(new_n92_), .d(new_n23_), .O(new_n124_));
  nand2  g108(.a(new_n124_), .b(new_n19_), .O(new_n125_));
  nand2  g109(.a(new_n21_), .b(x2), .O(new_n126_));
  nand4  g110(.a(new_n126_), .b(x9), .c(x8), .d(new_n22_), .O(new_n127_));
  aoi21  g111(.a(new_n127_), .b(new_n125_), .c(new_n77_), .O(new_n128_));
  nand2  g112(.a(x7), .b(new_n19_), .O(new_n129_));
  nand4  g113(.a(new_n22_), .b(x4), .c(new_n77_), .d(x2), .O(new_n130_));
  ...
  nand2  g119(.a(new_n101_), .b(new_n40_), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n17_), .c(new_n34_), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n123_), .c(new_n77_), .O(new_n138_));
  ...
  nand3  g125(.a(new_n35_), .b(new_n77_), .c(new_n40_), .O(new_n142_));
  ...
  nand2  g129(.a(new_n145_), .b(new_n101_), .O(new_n146_));
  ...
  nand4  g135(.a(new_n151_), .b(new_n141_), .c(new_n132_), .d(new_n122_), .O(new_n152_));
  ...
  nand3  g141(.a(x6), .b(new_n21_), .c(new_n77_), .O(new_n158_));
  oai21  g142(.a(new_n129_), .b(new_n77_), .c(new_n158_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n34_), .O(new_n160_));
  nand3  g144(.a(new_n160_), .b(new_n157_), .c(new_n118_), .O(z1));
  xor2a  g145(.a(x3), .b(x1), .O(new_n162_));
  aoi21  g146(.a(x9), .b(new_n18_), .c(new_n162_), .O(z2));
  nand2  g147(.a(x9), .b(new_n18_), .O(new_n164_));
  oai21  g148(.a(new_n77_), .b(new_n76_), .c(new_n164_), .O(z3));
  nand2  g149(.a(x2), .b(x0), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(new_n97_), .O(new_n167_));
  nand4  g151(.a(new_n167_), .b(new_n20_), .c(x6), .d(new_n76_), .O(new_n168_));
  aoi21  g152(.a(new_n40_), .b(x0), .c(x1), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n22_), .c(new_n168_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(new_n77_), .O(new_n171_));
  nand3  g155(.a(new_n20_), .b(new_n40_), .c(new_n17_), .O(new_n172_));
  oai21  g156(.a(new_n111_), .b(new_n17_), .c(new_n172_), .O(new_n173_));
  nand4  g157(.a(new_n173_), .b(x6), .c(x3), .d(x1), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n171_), .c(x4), .O(new_n175_));
  oai21  g159(.a(x7), .b(new_n77_), .c(x1), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(new_n17_), .O(new_n177_));
  nand2  g161(.a(new_n77_), .b(x1), .O(new_n178_));
  nand3  g162(.a(new_n178_), .b(new_n22_), .c(x2), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n177_), .c(new_n19_), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(new_n175_), .c(x5), .O(new_n181_));
  oai21  g165(.a(x8), .b(new_n77_), .c(new_n108_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(x2), .O(new_n183_));
  nor2   g167(.a(new_n22_), .b(new_n17_), .O(new_n184_));
  nor2   g168(.a(x7), .b(x1), .O(new_n185_));
  oai21  g169(.a(new_n185_), .b(new_n184_), .c(x3), .O(new_n186_));
  ...
  oai21  g173(.a(new_n184_), .b(new_n134_), .c(x1), .O(new_n190_));
  nor2   g174(.a(x8), .b(x4), .O(new_n191_));
  oai21  g175(.a(new_n191_), .b(new_n82_), .c(x0), .O(new_n192_));
  nand4  g176(.a(new_n192_), .b(new_n190_), .c(new_n189_), .d(new_n78_), .O(new_n193_));
  nand4  g177(.a(new_n85_), .b(x7), .c(new_n19_), .d(x1), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n17_), .c(x6), .O(new_n195_));
  aoi21  g179(.a(new_n193_), .b(new_n21_), .c(new_n195_), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n181_), .c(new_n34_), .O(z4));
  inv1   g181(.a(new_n162_), .O(new_n198_));
  nand3  g182(.a(new_n167_), .b(new_n198_), .c(new_n164_), .O(new_n199_));
