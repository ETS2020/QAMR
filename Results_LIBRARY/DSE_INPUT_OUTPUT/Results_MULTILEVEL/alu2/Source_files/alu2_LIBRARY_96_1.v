...
module FAU ( 
  ...
  xnor2a g112(.a(x3), .b(x1), .O(new_n129_));
  inv1   g113(.a(new_n129_), .O(new_n130_));
  nor2   g114(.a(new_n130_), .b(new_n59_), .O(z2));
  nor3   g115(.a(new_n59_), .b(new_n67_), .c(new_n65_), .O(z3));
  xnor2a g116(.a(x2), .b(x0), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nor4   g118(.a(new_n134_), .b(new_n18_), .c(new_n32_), .d(x4), .O(new_n135_));
  oai21  g119(.a(x3), .b(new_n65_), .c(x2), .O(new_n136_));
  aoi21  g120(.a(x3), .b(new_n41_), .c(new_n18_), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n136_), .c(new_n23_), .O(new_n138_));
  oai21  g122(.a(new_n138_), .b(new_n135_), .c(new_n28_), .O(new_n139_));
  nand4  g123(.a(new_n129_), .b(x6), .c(x5), .d(new_n41_), .O(new_n140_));
  oai21  g124(.a(x6), .b(new_n65_), .c(new_n140_), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n17_), .O(new_n142_));
  aoi21  g126(.a(new_n28_), .b(x6), .c(new_n65_), .O(new_n143_));
  nand4  g127(.a(x6), .b(x5), .c(x2), .d(new_n65_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(x6), .c(x3), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n143_), .c(x0), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(new_n142_), .c(x8), .O(new_n147_));
  nand2  g131(.a(x3), .b(new_n65_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(x6), .c(new_n17_), .O(new_n149_));
  ...
  nor2   g137(.a(new_n18_), .b(x3), .O(new_n154_));
  oai21  g138(.a(new_n154_), .b(new_n68_), .c(x1), .O(new_n155_));
  aoi21  g139(.a(new_n155_), .b(new_n153_), .c(new_n28_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n147_), .c(new_n23_), .O(new_n157_));
  oai21  g141(.a(new_n150_), .b(new_n65_), .c(new_n41_), .O(new_n158_));
  nand2  g142(.a(x3), .b(x1), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n18_), .c(new_n17_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand4  g145(.a(new_n22_), .b(new_n18_), .c(new_n67_), .d(new_n17_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(x5), .O(new_n163_));
  aoi21  g147(.a(new_n161_), .b(x4), .c(new_n163_), .O(new_n164_));
  nand3  g148(.a(new_n164_), .b(new_n157_), .c(new_n139_), .O(new_n165_));
  and2   g149(.a(new_n165_), .b(x9), .O(z4));
  or2    g150(.a(new_n134_), .b(new_n59_), .O(new_n167_));
