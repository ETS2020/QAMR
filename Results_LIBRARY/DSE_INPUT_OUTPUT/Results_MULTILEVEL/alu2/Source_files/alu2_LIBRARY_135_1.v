...
module FAU ( 
  ...
  nor2   g112(.a(x3), .b(x1), .O(new_n129_));
  nor2   g113(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nor2   g114(.a(new_n130_), .b(new_n126_), .O(z2));
  nor3   g115(.a(new_n126_), .b(new_n63_), .c(new_n94_), .O(z3));
  oai21  g116(.a(x7), .b(new_n26_), .c(x8), .O(new_n133_));
  nand3  g117(.a(new_n133_), .b(x3), .c(x1), .O(new_n134_));
  nand3  g118(.a(new_n129_), .b(new_n20_), .c(x6), .O(new_n135_));
  ...
  nand3  g143(.a(new_n127_), .b(new_n26_), .c(new_n25_), .O(new_n160_));
  ...
  inv1   g150(.a(new_n126_), .O(new_n167_));
  inv1   g151(.a(new_n130_), .O(new_n168_));
  nand3  g152(.a(new_n138_), .b(new_n168_), .c(new_n167_), .O(new_n169_));
