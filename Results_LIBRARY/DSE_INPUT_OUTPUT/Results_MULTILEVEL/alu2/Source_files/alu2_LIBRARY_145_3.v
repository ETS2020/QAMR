...
module FAU ( 
  ...
  oai22  g112(.a(new_n68_), .b(new_n74_), .c(new_n19_), .d(new_n17_), .O(new_n129_));
  ...
  xor2a  g126(.a(x2), .b(x0), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n120_), .c(new_n122_), .O(z5));
endmodule
