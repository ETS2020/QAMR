...
module FAU ( 
  ...
  nor2   g180(.a(new_n102_), .b(new_n75_), .O(new_n197_));
  nor2   g181(.a(x3), .b(x1), .O(new_n198_));
  nor2   g182(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  nor2   g183(.a(new_n199_), .b(new_n192_), .O(z2));
  inv1   g184(.a(new_n197_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(new_n193_), .O(z3));
  xor2a  g186(.a(x2), .b(x0), .O(new_n203_));
  aoi21  g187(.a(new_n24_), .b(x8), .c(new_n203_), .O(new_n204_));
  aoi21  g188(.a(new_n80_), .b(x6), .c(new_n35_), .O(new_n205_));
  ...
  aoi21  g193(.a(new_n207_), .b(new_n17_), .c(new_n209_), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n206_), .c(new_n75_), .O(new_n211_));
  nand2  g195(.a(x7), .b(new_n19_), .O(new_n212_));
  nand2  g196(.a(x8), .b(x7), .O(new_n213_));
  nand3  g197(.a(new_n213_), .b(x6), .c(new_n75_), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n212_), .c(new_n17_), .O(new_n215_));
  oai22  g199(.a(new_n208_), .b(x2), .c(x8), .d(x6), .O(new_n216_));
  ...
  oai21  g203(.a(new_n219_), .b(new_n211_), .c(new_n34_), .O(new_n220_));
  aoi21  g204(.a(new_n102_), .b(x1), .c(new_n17_), .O(new_n221_));
  oai21  g205(.a(new_n102_), .b(x0), .c(x6), .O(new_n222_));
  oai21  g206(.a(new_n222_), .b(new_n221_), .c(new_n35_), .O(new_n223_));
  oai21  g207(.a(x6), .b(x3), .c(x1), .O(new_n224_));
  nor2   g208(.a(new_n197_), .b(x6), .O(new_n225_));
  aoi22  g209(.a(new_n225_), .b(new_n17_), .c(new_n224_), .d(new_n29_), .O(new_n226_));
  nand2  g210(.a(new_n226_), .b(new_n223_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(x4), .O(new_n228_));
  nand3  g212(.a(new_n20_), .b(new_n75_), .c(new_n29_), .O(new_n229_));
  oai21  g213(.a(x8), .b(x6), .c(new_n229_), .O(new_n230_));
  nand3  g214(.a(new_n230_), .b(new_n102_), .c(new_n17_), .O(new_n231_));
  nand4  g215(.a(new_n231_), .b(new_n228_), .c(new_n220_), .d(x9), .O(new_n232_));
  nand2  g216(.a(new_n232_), .b(x5), .O(new_n233_));
  oai22  g217(.a(new_n81_), .b(new_n70_), .c(new_n35_), .d(x1), .O(new_n234_));
  nand3  g218(.a(x4), .b(x3), .c(new_n75_), .O(new_n235_));
  oai21  g219(.a(x3), .b(new_n75_), .c(new_n235_), .O(new_n236_));
  oai21  g220(.a(new_n35_), .b(x0), .c(new_n236_), .O(new_n237_));
  nor2   g221(.a(x8), .b(x4), .O(new_n238_));
  nor2   g222(.a(new_n35_), .b(new_n75_), .O(new_n239_));
  oai21  g223(.a(new_n239_), .b(new_n238_), .c(x0), .O(new_n240_));
  aoi21  g224(.a(new_n35_), .b(x3), .c(new_n34_), .O(new_n241_));
  aoi22  g225(.a(new_n241_), .b(x1), .c(new_n40_), .d(new_n35_), .O(new_n242_));
  nand4  g226(.a(new_n242_), .b(new_n240_), .c(new_n237_), .d(new_n234_), .O(new_n243_));
  nand2  g227(.a(new_n243_), .b(x6), .O(new_n244_));
  nand3  g228(.a(new_n19_), .b(x4), .c(x3), .O(new_n245_));
  nand2  g229(.a(new_n245_), .b(new_n75_), .O(new_n246_));
  nand3  g230(.a(new_n246_), .b(new_n103_), .c(x0), .O(new_n247_));
  nand2  g231(.a(new_n40_), .b(x4), .O(new_n248_));
  oai21  g232(.a(new_n35_), .b(new_n102_), .c(new_n105_), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(x1), .O(new_n250_));
  oai21  g234(.a(new_n163_), .b(new_n248_), .c(new_n250_), .O(new_n251_));
  nor4   g235(.a(new_n248_), .b(new_n102_), .c(new_n17_), .d(x1), .O(new_n252_));
  aoi21  g236(.a(new_n251_), .b(new_n19_), .c(new_n252_), .O(new_n253_));
  nand3  g237(.a(new_n253_), .b(new_n247_), .c(new_n244_), .O(new_n254_));
  nand3  g238(.a(new_n254_), .b(x9), .c(new_n23_), .O(new_n255_));
  nand2  g239(.a(new_n255_), .b(new_n233_), .O(z4));
  oai21  g240(.a(new_n203_), .b(new_n199_), .c(new_n193_), .O(z5));
endmodule
