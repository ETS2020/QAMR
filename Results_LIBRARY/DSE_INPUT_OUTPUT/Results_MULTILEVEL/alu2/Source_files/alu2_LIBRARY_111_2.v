...
module FAU ( 
  ...
  aoi21  g054(.a(x8), .b(new_n32_), .c(new_n33_), .O(new_n71_));
  ...
  nand4  g122(.a(x7), .b(new_n18_), .c(new_n32_), .d(x0), .O(new_n139_));
  nand4  g123(.a(x9), .b(x8), .c(x4), .d(new_n17_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(x2), .O(new_n142_));
  nand2  g126(.a(new_n52_), .b(x0), .O(new_n143_));
  nand2  g127(.a(x5), .b(new_n32_), .O(new_n144_));
  oai22  g128(.a(new_n144_), .b(new_n143_), .c(new_n54_), .d(new_n27_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(x6), .O(new_n146_));
  nand2  g130(.a(x4), .b(new_n52_), .O(new_n147_));
  nand2  g131(.a(new_n41_), .b(new_n26_), .O(new_n148_));
  nand3  g132(.a(new_n38_), .b(x5), .c(new_n32_), .O(new_n149_));
  oai21  g133(.a(new_n148_), .b(new_n147_), .c(new_n149_), .O(new_n150_));
  nand2  g134(.a(new_n150_), .b(x0), .O(new_n151_));
  nand2  g135(.a(x8), .b(new_n18_), .O(new_n152_));
  nand3  g136(.a(new_n38_), .b(new_n26_), .c(new_n17_), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(new_n152_), .c(x2), .O(new_n154_));
  nand2  g138(.a(new_n23_), .b(x8), .O(new_n155_));
  nor2   g139(.a(new_n155_), .b(x0), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n154_), .c(x4), .O(new_n157_));
  nand4  g141(.a(new_n38_), .b(x5), .c(new_n32_), .d(new_n52_), .O(new_n158_));
  nand4  g142(.a(new_n158_), .b(new_n157_), .c(new_n151_), .d(new_n146_), .O(new_n159_));
  ...
  nand2  g146(.a(new_n44_), .b(new_n26_), .O(new_n163_));
  inv1   g147(.a(new_n163_), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n162_), .c(new_n18_), .O(new_n165_));
  nand3  g149(.a(new_n165_), .b(new_n160_), .c(new_n142_), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(x3), .O(new_n167_));
  nand2  g151(.a(new_n19_), .b(new_n52_), .O(new_n168_));
  nand3  g152(.a(new_n168_), .b(new_n26_), .c(x0), .O(new_n169_));
  nand2  g153(.a(x4), .b(x2), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n19_), .c(new_n17_), .O(new_n171_));
  nand3  g155(.a(x5), .b(new_n32_), .c(x2), .O(new_n172_));
  ...
  nand3  g159(.a(new_n175_), .b(new_n53_), .c(x0), .O(new_n176_));
  ...
  nand4  g168(.a(new_n23_), .b(new_n38_), .c(x4), .d(x2), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand4  g170(.a(x5), .b(new_n32_), .c(x2), .d(new_n17_), .O(new_n187_));
  inv1   g171(.a(new_n187_), .O(new_n188_));
  aoi21  g172(.a(new_n186_), .b(new_n26_), .c(new_n188_), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n179_), .c(x3), .O(new_n190_));
  inv1   g174(.a(new_n168_), .O(new_n191_));
  nand2  g175(.a(new_n19_), .b(new_n17_), .O(new_n192_));
  oai21  g176(.a(new_n191_), .b(new_n17_), .c(new_n192_), .O(new_n193_));
  nand4  g177(.a(new_n193_), .b(x6), .c(new_n26_), .d(new_n32_), .O(new_n194_));
  nand2  g178(.a(new_n175_), .b(x0), .O(new_n195_));
  nand3  g179(.a(new_n195_), .b(x5), .c(x4), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n194_), .c(new_n38_), .O(new_n197_));
  oai21  g181(.a(new_n197_), .b(new_n190_), .c(x9), .O(new_n198_));
  aoi21  g182(.a(x7), .b(x4), .c(x9), .O(new_n199_));
  nand4  g183(.a(new_n199_), .b(new_n18_), .c(new_n26_), .d(new_n134_), .O(new_n200_));
  nand3  g184(.a(new_n200_), .b(new_n198_), .c(new_n167_), .O(new_n201_));
  oai21  g185(.a(new_n38_), .b(new_n134_), .c(new_n26_), .O(new_n202_));
  nand4  g186(.a(new_n202_), .b(x9), .c(new_n19_), .d(new_n18_), .O(new_n203_));
  nor2   g187(.a(new_n203_), .b(new_n32_), .O(new_n204_));
  aoi21  g188(.a(new_n201_), .b(new_n138_), .c(new_n204_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(new_n137_), .O(z1));
  xor2a  g190(.a(x3), .b(x1), .O(new_n207_));
  nor2   g191(.a(new_n207_), .b(new_n77_), .O(z2));
  nor3   g192(.a(new_n77_), .b(new_n134_), .c(new_n138_), .O(z3));
  xor2a  g193(.a(x2), .b(x0), .O(new_n210_));
  nor2   g194(.a(new_n210_), .b(new_n207_), .O(new_n211_));
  nand3  g195(.a(new_n211_), .b(x6), .c(new_n32_), .O(new_n212_));
  oai21  g196(.a(x3), .b(new_n138_), .c(x2), .O(new_n213_));
  aoi21  g197(.a(x3), .b(new_n17_), .c(new_n18_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n213_), .O(new_n215_));
  nand3  g199(.a(new_n215_), .b(x9), .c(x4), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n212_), .c(x7), .O(new_n217_));
  nand2  g201(.a(new_n52_), .b(new_n138_), .O(new_n218_));
  nand3  g202(.a(new_n38_), .b(x6), .c(new_n32_), .O(new_n219_));
  nand2  g203(.a(x9), .b(new_n18_), .O(new_n220_));
  oai22  g204(.a(new_n220_), .b(new_n32_), .c(new_n219_), .d(new_n218_), .O(new_n221_));
  nand2  g205(.a(new_n221_), .b(new_n17_), .O(new_n222_));
  nand2  g206(.a(x6), .b(new_n52_), .O(new_n223_));
  oai21  g207(.a(new_n220_), .b(new_n52_), .c(new_n223_), .O(new_n224_));
  nand2  g208(.a(new_n224_), .b(x0), .O(new_n225_));
  nand2  g209(.a(x6), .b(x1), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n225_), .c(new_n19_), .O(new_n227_));
  nand4  g211(.a(x9), .b(new_n38_), .c(new_n18_), .d(x0), .O(new_n228_));
  inv1   g212(.a(new_n228_), .O(new_n229_));
  oai21  g213(.a(new_n229_), .b(new_n227_), .c(new_n32_), .O(new_n230_));
  nand3  g214(.a(new_n71_), .b(new_n18_), .c(new_n52_), .O(new_n231_));
  nand3  g215(.a(new_n231_), .b(new_n230_), .c(new_n222_), .O(new_n232_));
  nand2  g216(.a(new_n232_), .b(new_n134_), .O(new_n233_));
  nand2  g217(.a(new_n220_), .b(new_n80_), .O(new_n234_));
  nand4  g218(.a(new_n234_), .b(new_n38_), .c(new_n32_), .d(x1), .O(new_n235_));
  nand2  g219(.a(x4), .b(new_n138_), .O(new_n236_));
  oai21  g220(.a(new_n236_), .b(new_n220_), .c(new_n235_), .O(new_n237_));
  nand2  g221(.a(new_n237_), .b(new_n52_), .O(new_n238_));
  nand4  g222(.a(x9), .b(x4), .c(new_n138_), .d(new_n17_), .O(new_n239_));
  nand3  g223(.a(new_n239_), .b(new_n238_), .c(new_n233_), .O(new_n240_));
  oai21  g224(.a(new_n240_), .b(new_n217_), .c(x5), .O(new_n241_));
  oai21  g225(.a(x8), .b(new_n134_), .c(new_n192_), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(x2), .O(new_n243_));
  nor2   g227(.a(new_n19_), .b(new_n17_), .O(new_n244_));
  nor2   g228(.a(x7), .b(x1), .O(new_n245_));
  oai21  g229(.a(new_n245_), .b(new_n244_), .c(x3), .O(new_n246_));
  nand2  g230(.a(x7), .b(x1), .O(new_n247_));
  ...
  oai21  g235(.a(new_n251_), .b(new_n191_), .c(x0), .O(new_n252_));
  nand3  g236(.a(new_n252_), .b(new_n250_), .c(new_n54_), .O(new_n253_));
  aoi21  g237(.a(new_n248_), .b(x4), .c(new_n253_), .O(new_n254_));
  oai21  g238(.a(new_n38_), .b(new_n52_), .c(x1), .O(new_n255_));
  oai21  g239(.a(x8), .b(x3), .c(new_n255_), .O(new_n256_));
  nand4  g240(.a(new_n256_), .b(x7), .c(new_n32_), .d(x0), .O(new_n257_));
  and2   g241(.a(new_n257_), .b(x9), .O(new_n258_));
  oai21  g242(.a(new_n254_), .b(x5), .c(new_n258_), .O(new_n259_));
  nand2  g243(.a(new_n38_), .b(new_n18_), .O(new_n260_));
  aoi21  g244(.a(new_n260_), .b(new_n180_), .c(new_n17_), .O(new_n261_));
  nand2  g245(.a(x7), .b(x3), .O(new_n262_));
  nand3  g246(.a(new_n38_), .b(x4), .c(x2), .O(new_n263_));
  aoi21  g247(.a(new_n263_), .b(new_n262_), .c(x6), .O(new_n264_));
  oai21  g248(.a(new_n264_), .b(new_n261_), .c(new_n26_), .O(new_n265_));
  nand2  g249(.a(new_n262_), .b(new_n161_), .O(new_n266_));
  nand3  g250(.a(new_n266_), .b(new_n18_), .c(new_n32_), .O(new_n267_));
  nand2  g251(.a(new_n267_), .b(new_n265_), .O(new_n268_));
  nand2  g252(.a(new_n268_), .b(x1), .O(new_n269_));
  nor2   g253(.a(x8), .b(new_n52_), .O(new_n270_));
  or2    g254(.a(new_n270_), .b(new_n261_), .O(new_n271_));
  nand4  g255(.a(new_n271_), .b(new_n26_), .c(x4), .d(x3), .O(new_n272_));
  aoi21  g256(.a(new_n272_), .b(new_n269_), .c(new_n33_), .O(new_n273_));
  aoi21  g257(.a(new_n259_), .b(x6), .c(new_n273_), .O(new_n274_));
  nand2  g258(.a(new_n274_), .b(new_n241_), .O(z4));
  nand2  g259(.a(new_n211_), .b(new_n78_), .O(new_n276_));
