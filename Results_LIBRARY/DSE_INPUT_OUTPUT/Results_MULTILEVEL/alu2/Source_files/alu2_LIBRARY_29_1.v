...
module FAU ( 
  ...
  inv1   g146(.a(new_n116_), .O(new_n163_));
  oai21  g147(.a(x6), .b(new_n18_), .c(new_n163_), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n162_), .c(new_n36_), .O(new_n165_));
  oai21  g149(.a(x6), .b(x3), .c(x1), .O(new_n166_));
  nor2   g150(.a(new_n158_), .b(x6), .O(new_n167_));
  aoi22  g151(.a(new_n167_), .b(new_n40_), .c(new_n166_), .d(new_n18_), .O(new_n168_));
  ...
  aoi21  g155(.a(new_n40_), .b(x0), .c(new_n23_), .O(new_n172_));
  aoi22  g156(.a(new_n172_), .b(new_n171_), .c(x7), .d(new_n88_), .O(new_n173_));
  nand2  g157(.a(x7), .b(new_n18_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(x3), .c(new_n88_), .O(new_n175_));
  oai21  g159(.a(x3), .b(new_n88_), .c(new_n175_), .O(new_n176_));
  oai21  g160(.a(new_n176_), .b(new_n173_), .c(x6), .O(new_n177_));
  nand2  g161(.a(new_n105_), .b(x8), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(x0), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n140_), .c(new_n157_), .O(new_n180_));
  aoi21  g164(.a(new_n121_), .b(x1), .c(new_n180_), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n30_), .c(new_n25_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n170_), .c(new_n26_), .O(z4));
  inv1   g168(.a(new_n159_), .O(new_n185_));
  xnor2a g169(.a(x2), .b(x0), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(new_n185_), .c(new_n156_), .O(new_n187_));
