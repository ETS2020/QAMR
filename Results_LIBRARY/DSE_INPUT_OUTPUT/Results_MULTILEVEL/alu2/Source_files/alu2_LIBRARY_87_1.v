...
module FAU ( 
  ...
  nor3   g117(.a(new_n59_), .b(new_n67_), .c(new_n65_), .O(z3));
  xor2a  g118(.a(x2), .b(x0), .O(new_n135_));
  nor2   g119(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g120(.a(new_n136_), .b(x6), .c(new_n23_), .O(new_n137_));
  inv1   g121(.a(new_n137_), .O(new_n138_));
  oai21  g122(.a(x3), .b(new_n65_), .c(x2), .O(new_n139_));
  aoi21  g123(.a(x3), .b(new_n41_), .c(new_n18_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n139_), .c(new_n23_), .O(new_n141_));
  oai21  g125(.a(new_n141_), .b(new_n138_), .c(new_n28_), .O(new_n142_));
  nand3  g126(.a(new_n131_), .b(x6), .c(new_n41_), .O(new_n143_));
  oai21  g127(.a(x6), .b(new_n65_), .c(new_n143_), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n17_), .O(new_n145_));
  oai21  g129(.a(x7), .b(new_n18_), .c(x1), .O(new_n146_));
  aoi21  g130(.a(x2), .b(new_n65_), .c(new_n18_), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(x3), .c(new_n146_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(x0), .O(new_n149_));
  aoi21  g133(.a(new_n149_), .b(new_n145_), .c(x8), .O(new_n150_));
  nand2  g134(.a(x3), .b(new_n65_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(x6), .c(new_n17_), .O(new_n152_));
  nand2  g136(.a(new_n18_), .b(new_n67_), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n17_), .c(new_n152_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(x0), .O(new_n155_));
  nor2   g139(.a(new_n18_), .b(x3), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n68_), .c(x1), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n155_), .c(new_n28_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n150_), .c(new_n23_), .O(new_n159_));
  aoi21  g143(.a(new_n18_), .b(new_n67_), .c(new_n65_), .O(new_n160_));
  nand3  g144(.a(new_n129_), .b(new_n18_), .c(new_n17_), .O(new_n161_));
  oai21  g145(.a(new_n160_), .b(x0), .c(new_n161_), .O(new_n162_));
  nand4  g146(.a(new_n22_), .b(new_n18_), .c(new_n67_), .d(new_n17_), .O(new_n163_));
  inv1   g147(.a(new_n163_), .O(new_n164_));
  aoi21  g148(.a(new_n162_), .b(x4), .c(new_n164_), .O(new_n165_));
  nand3  g149(.a(new_n165_), .b(new_n159_), .c(new_n142_), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(x9), .c(x5), .O(new_n167_));
  inv1   g151(.a(new_n167_), .O(z4));
  inv1   g152(.a(new_n59_), .O(new_n169_));
  nand2  g153(.a(new_n136_), .b(new_n169_), .O(new_n170_));
