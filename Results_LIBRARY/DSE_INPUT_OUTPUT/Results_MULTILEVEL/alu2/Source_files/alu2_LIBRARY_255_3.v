...
module FAU ( 
  ...
  nor2   g102(.a(new_n18_), .b(new_n46_), .O(new_n119_));
  nand2  g103(.a(x3), .b(x1), .O(new_n120_));
  nand2  g104(.a(new_n68_), .b(new_n74_), .O(new_n121_));
  and2   g105(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nor2   g106(.a(new_n122_), .b(new_n119_), .O(z2));
  inv1   g107(.a(new_n119_), .O(new_n124_));
  nand2  g108(.a(new_n120_), .b(new_n124_), .O(z3));
  nor2   g109(.a(x8), .b(new_n19_), .O(new_n126_));
  oai21  g110(.a(new_n126_), .b(new_n97_), .c(x3), .O(new_n127_));
  nand2  g111(.a(new_n126_), .b(x1), .O(new_n128_));
  aoi21  g112(.a(new_n128_), .b(new_n127_), .c(x5), .O(new_n129_));
  oai21  g113(.a(new_n19_), .b(new_n17_), .c(new_n120_), .O(new_n130_));
  aoi21  g114(.a(new_n130_), .b(x7), .c(new_n29_), .O(new_n131_));
  oai21  g115(.a(new_n131_), .b(new_n129_), .c(x4), .O(new_n132_));
  nor2   g116(.a(new_n29_), .b(x4), .O(new_n133_));
  aoi22  g117(.a(new_n133_), .b(new_n68_), .c(new_n29_), .d(x1), .O(new_n134_));
  nand3  g118(.a(new_n22_), .b(new_n27_), .c(x1), .O(new_n135_));
  oai21  g119(.a(new_n134_), .b(new_n99_), .c(new_n135_), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(x0), .O(new_n137_));
  oai21  g121(.a(x4), .b(new_n74_), .c(x3), .O(new_n138_));
  nand4  g122(.a(new_n138_), .b(new_n22_), .c(x5), .d(new_n19_), .O(new_n139_));
  nand4  g123(.a(new_n34_), .b(x7), .c(x3), .d(x1), .O(new_n140_));
  nand4  g124(.a(new_n140_), .b(new_n139_), .c(new_n137_), .d(new_n132_), .O(new_n141_));
  nand3  g125(.a(new_n141_), .b(x9), .c(new_n46_), .O(new_n142_));
  inv1   g126(.a(new_n142_), .O(z4));
  inv1   g127(.a(new_n122_), .O(new_n144_));
  xnor2a g128(.a(x2), .b(x0), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(new_n144_), .c(new_n124_), .O(new_n146_));
