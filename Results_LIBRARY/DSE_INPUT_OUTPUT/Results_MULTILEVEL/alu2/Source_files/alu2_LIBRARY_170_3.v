...
module FAU ( 
  ...
  nand3  g154(.a(new_n165_), .b(x3), .c(x1), .O(new_n171_));
  inv1   g155(.a(new_n171_), .O(z3));
  nor2   g156(.a(x2), .b(new_n17_), .O(new_n173_));
  nor3   g157(.a(new_n18_), .b(new_n52_), .c(x0), .O(new_n174_));
  oai22  g158(.a(new_n174_), .b(new_n173_), .c(new_n31_), .d(x1), .O(new_n175_));
  nor2   g159(.a(x3), .b(new_n124_), .O(new_n176_));
  nor3   g160(.a(new_n18_), .b(new_n96_), .c(x1), .O(new_n177_));
  oai22  g161(.a(new_n177_), .b(new_n176_), .c(new_n31_), .d(x0), .O(new_n178_));
  nor2   g162(.a(new_n31_), .b(new_n124_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n38_), .c(x0), .O(new_n180_));
  aoi21  g164(.a(new_n31_), .b(x3), .c(new_n18_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(x1), .c(new_n55_), .O(new_n182_));
  nand4  g166(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n175_), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(x6), .O(new_n184_));
  oai21  g168(.a(new_n161_), .b(new_n96_), .c(new_n124_), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(new_n144_), .c(x0), .O(new_n186_));
  aoi22  g170(.a(new_n88_), .b(x2), .c(x7), .d(x3), .O(new_n187_));
  nand3  g171(.a(new_n88_), .b(x3), .c(x2), .O(new_n188_));
  oai21  g172(.a(new_n187_), .b(new_n124_), .c(new_n188_), .O(new_n189_));
  nor4   g173(.a(new_n102_), .b(new_n96_), .c(new_n52_), .d(x1), .O(new_n190_));
  aoi21  g174(.a(new_n189_), .b(new_n44_), .c(new_n190_), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n186_), .c(new_n184_), .O(new_n192_));
  nand3  g176(.a(new_n192_), .b(x9), .c(new_n19_), .O(new_n193_));
  inv1   g177(.a(new_n193_), .O(z4));
  xor2a  g178(.a(x2), .b(x0), .O(new_n195_));
  oai21  g179(.a(new_n195_), .b(new_n169_), .c(new_n165_), .O(z5));
endmodule
