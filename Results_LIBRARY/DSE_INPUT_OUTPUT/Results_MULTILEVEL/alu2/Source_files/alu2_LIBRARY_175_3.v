...
module FAU ( 
  ...
  aoi21  g132(.a(new_n148_), .b(new_n98_), .c(new_n25_), .O(new_n149_));
  aoi21  g133(.a(new_n146_), .b(new_n29_), .c(new_n149_), .O(new_n150_));
  nand4  g134(.a(new_n135_), .b(x8), .c(x4), .d(x3), .O(new_n151_));
  oai21  g135(.a(new_n150_), .b(new_n19_), .c(new_n151_), .O(new_n152_));
  nand4  g136(.a(new_n25_), .b(new_n30_), .c(x3), .d(x0), .O(new_n153_));
  nand2  g137(.a(new_n56_), .b(new_n82_), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(new_n153_), .c(x4), .O(new_n155_));
  aoi21  g139(.a(new_n152_), .b(x9), .c(new_n155_), .O(new_n156_));
  oai21  g140(.a(new_n25_), .b(new_n82_), .c(new_n19_), .O(new_n157_));
  nand4  g141(.a(new_n157_), .b(x9), .c(new_n30_), .d(x4), .O(new_n158_));
  oai21  g142(.a(new_n156_), .b(x1), .c(new_n158_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n55_), .O(new_n160_));
  oai21  g144(.a(x6), .b(x1), .c(new_n55_), .O(new_n161_));
  nand4  g145(.a(new_n161_), .b(new_n20_), .c(new_n29_), .d(x3), .O(new_n162_));
  nand4  g146(.a(new_n162_), .b(new_n160_), .c(new_n142_), .d(new_n114_), .O(z1));
  xor2a  g147(.a(x3), .b(x1), .O(new_n164_));
  nor2   g148(.a(new_n164_), .b(new_n72_), .O(z2));
  nand3  g149(.a(new_n73_), .b(x3), .c(x1), .O(new_n166_));
  inv1   g150(.a(new_n166_), .O(z3));
  inv1   g151(.a(new_n99_), .O(new_n168_));
  nand2  g152(.a(x2), .b(x0), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n168_), .c(new_n164_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x6), .O(new_n171_));
  nor2   g155(.a(new_n78_), .b(x0), .O(new_n172_));
  oai21  g156(.a(new_n18_), .b(x1), .c(x6), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n172_), .c(x4), .O(new_n174_));
  nor2   g158(.a(new_n82_), .b(x1), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(x2), .c(new_n88_), .O(new_n176_));
  nand3  g160(.a(new_n176_), .b(new_n25_), .c(new_n30_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n174_), .c(new_n171_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(x5), .O(new_n179_));
  nand2  g163(.a(x4), .b(x3), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n77_), .c(new_n17_), .O(new_n181_));
  oai21  g165(.a(x3), .b(x1), .c(x4), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n18_), .c(new_n30_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n181_), .c(new_n25_), .O(new_n184_));
  nor2   g168(.a(new_n175_), .b(new_n135_), .O(new_n185_));
  nor2   g169(.a(new_n185_), .b(new_n29_), .O(new_n186_));
  oai21  g170(.a(x3), .b(new_n77_), .c(new_n147_), .O(new_n187_));
  ...
  oai21  g174(.a(new_n190_), .b(new_n31_), .c(new_n55_), .O(new_n191_));
  aoi21  g175(.a(new_n189_), .b(new_n19_), .c(new_n191_), .O(new_n192_));
  aoi21  g176(.a(new_n192_), .b(new_n179_), .c(new_n20_), .O(z4));
  nand2  g177(.a(new_n170_), .b(new_n73_), .O(new_n194_));
