...
module FAU ( 
  ...
  nand2  g123(.a(new_n139_), .b(new_n138_), .O(z3));
  ...
  oai21  g139(.a(x4), .b(new_n68_), .c(x3), .O(new_n156_));
  nand4  g140(.a(new_n156_), .b(new_n24_), .c(x5), .d(new_n22_), .O(new_n157_));
  nand4  g141(.a(new_n34_), .b(x7), .c(x3), .d(x1), .O(new_n158_));
  nand4  g142(.a(new_n158_), .b(new_n157_), .c(new_n155_), .d(new_n148_), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(x9), .c(new_n47_), .O(new_n160_));
  inv1   g144(.a(new_n160_), .O(z4));
  nand2  g145(.a(new_n22_), .b(new_n17_), .O(new_n162_));
  aoi21  g146(.a(new_n145_), .b(new_n162_), .c(new_n136_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n138_), .O(new_n164_));
  inv1   g148(.a(new_n164_), .O(z5));
endmodule
