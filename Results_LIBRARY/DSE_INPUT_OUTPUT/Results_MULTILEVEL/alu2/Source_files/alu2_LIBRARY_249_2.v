...
module FAU ( 
  ...
  aoi21  g194(.a(new_n65_), .b(x2), .c(new_n210_), .O(z2));
  nand2  g195(.a(new_n65_), .b(x2), .O(new_n212_));
  oai21  g196(.a(new_n143_), .b(new_n170_), .c(new_n212_), .O(z3));
  ...
  aoi21  g259(.a(x9), .b(x2), .c(x0), .O(new_n276_));
  aoi21  g260(.a(x2), .b(x0), .c(new_n276_), .O(new_n277_));
  oai21  g261(.a(new_n277_), .b(new_n210_), .c(new_n212_), .O(z5));
endmodule
