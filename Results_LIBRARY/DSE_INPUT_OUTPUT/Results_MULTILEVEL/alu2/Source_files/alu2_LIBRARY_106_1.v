...
module FAU ( 
  ...
  nor2   g085(.a(new_n65_), .b(new_n34_), .O(new_n102_));
  nor2   g086(.a(new_n35_), .b(x6), .O(new_n103_));
  nand3  g087(.a(new_n103_), .b(new_n102_), .c(new_n19_), .O(new_n104_));
  nand2  g088(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  nand2  g089(.a(new_n105_), .b(new_n67_), .O(new_n106_));
  nand3  g090(.a(new_n106_), .b(new_n98_), .c(new_n90_), .O(new_n107_));
  nand2  g091(.a(new_n107_), .b(x0), .O(new_n108_));
  oai22  g092(.a(new_n47_), .b(x4), .c(new_n30_), .d(x7), .O(new_n109_));
  nand3  g093(.a(new_n109_), .b(x3), .c(x1), .O(new_n110_));
  nand2  g094(.a(new_n35_), .b(x4), .O(new_n111_));
  oai21  g095(.a(new_n51_), .b(x3), .c(new_n111_), .O(new_n112_));
  nand3  g096(.a(new_n112_), .b(x9), .c(new_n67_), .O(new_n113_));
  aoi21  g097(.a(new_n113_), .b(new_n110_), .c(new_n34_), .O(new_n114_));
  nand2  g098(.a(new_n34_), .b(new_n67_), .O(new_n115_));
  nor4   g099(.a(new_n115_), .b(new_n30_), .c(x6), .d(x3), .O(new_n116_));
  oai21  g100(.a(new_n116_), .b(new_n114_), .c(x5), .O(new_n117_));
  aoi21  g101(.a(new_n65_), .b(new_n34_), .c(new_n35_), .O(new_n118_));
  nand2  g102(.a(new_n115_), .b(x7), .O(new_n119_));
  nand3  g103(.a(new_n119_), .b(x4), .c(x3), .O(new_n120_));
  oai21  g104(.a(new_n118_), .b(new_n67_), .c(new_n120_), .O(new_n121_));
  nand3  g105(.a(new_n121_), .b(x9), .c(new_n21_), .O(new_n122_));
  nand4  g106(.a(new_n122_), .b(new_n117_), .c(new_n108_), .d(new_n86_), .O(new_n123_));
  nand2  g107(.a(new_n123_), .b(x8), .O(new_n124_));
  nand2  g108(.a(new_n43_), .b(x3), .O(new_n125_));
  nand2  g109(.a(new_n45_), .b(new_n65_), .O(new_n126_));
  nand3  g110(.a(new_n126_), .b(new_n125_), .c(new_n47_), .O(new_n127_));
  nand2  g111(.a(new_n127_), .b(x1), .O(new_n128_));
  nand3  g112(.a(new_n37_), .b(new_n35_), .c(new_n67_), .O(new_n129_));
  oai21  g113(.a(new_n21_), .b(x5), .c(new_n129_), .O(new_n130_));
  nand2  g114(.a(new_n130_), .b(new_n65_), .O(new_n131_));
  nand3  g115(.a(new_n32_), .b(new_n21_), .c(x3), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(new_n39_), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n67_), .O(new_n134_));
  nand2  g118(.a(new_n59_), .b(x3), .O(new_n135_));
  nand4  g119(.a(new_n135_), .b(new_n134_), .c(new_n131_), .d(new_n128_), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(new_n30_), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n124_), .O(z1));
  nor2   g122(.a(new_n30_), .b(x8), .O(new_n139_));
  xor2a  g123(.a(x3), .b(x1), .O(new_n140_));
  nor2   g124(.a(new_n140_), .b(new_n139_), .O(z2));
  nor3   g125(.a(new_n139_), .b(new_n65_), .c(new_n67_), .O(z3));
  nand2  g126(.a(new_n65_), .b(x2), .O(new_n143_));
  nand3  g127(.a(new_n20_), .b(x4), .c(x3), .O(new_n144_));
  nand3  g128(.a(x8), .b(new_n35_), .c(x5), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n143_), .c(new_n144_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n67_), .O(new_n147_));
  aoi21  g131(.a(new_n58_), .b(x5), .c(new_n67_), .O(new_n148_));
  nand4  g132(.a(x7), .b(x5), .c(new_n19_), .d(new_n65_), .O(new_n149_));
  oai21  g133(.a(x7), .b(x5), .c(new_n149_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n148_), .c(new_n34_), .O(new_n151_));
  inv1   g135(.a(new_n102_), .O(new_n152_));
  oai21  g136(.a(new_n145_), .b(new_n152_), .c(new_n31_), .O(new_n153_));
  ...
  nand3  g141(.a(x8), .b(x5), .c(x3), .O(new_n158_));
  oai22  g142(.a(new_n158_), .b(new_n157_), .c(x5), .d(x3), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(x1), .O(new_n160_));
  nand3  g144(.a(x8), .b(x5), .c(new_n65_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n115_), .c(new_n76_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n17_), .O(new_n163_));
  nand4  g147(.a(new_n20_), .b(x4), .c(x3), .d(new_n67_), .O(new_n164_));
  nand3  g148(.a(new_n164_), .b(new_n163_), .c(new_n160_), .O(new_n165_));
  oai21  g149(.a(new_n34_), .b(x0), .c(new_n35_), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(new_n20_), .c(x4), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(new_n149_), .c(new_n67_), .O(new_n168_));
  aoi21  g152(.a(new_n165_), .b(new_n35_), .c(new_n168_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n156_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x6), .O(new_n171_));
  nand2  g155(.a(new_n66_), .b(x2), .O(new_n172_));
  aoi21  g156(.a(x3), .b(new_n17_), .c(new_n21_), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n172_), .c(x7), .O(new_n174_));
  aoi21  g158(.a(new_n21_), .b(new_n65_), .c(new_n67_), .O(new_n175_));
  nand2  g159(.a(x3), .b(x1), .O(new_n176_));
  nand3  g160(.a(new_n176_), .b(new_n21_), .c(new_n34_), .O(new_n177_));
  oai21  g161(.a(new_n175_), .b(x0), .c(new_n177_), .O(new_n178_));
  oai21  g162(.a(new_n178_), .b(new_n174_), .c(x5), .O(new_n179_));
  nand4  g163(.a(new_n103_), .b(new_n102_), .c(new_n20_), .d(x0), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g165(.a(new_n20_), .b(x1), .O(new_n182_));
  nand4  g166(.a(new_n21_), .b(x5), .c(new_n19_), .d(new_n65_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n182_), .c(new_n34_), .O(new_n184_));
  nand2  g168(.a(x5), .b(x4), .O(new_n185_));
  nand4  g169(.a(new_n185_), .b(new_n21_), .c(x3), .d(x1), .O(new_n186_));
  inv1   g170(.a(new_n186_), .O(new_n187_));
  aoi21  g171(.a(new_n184_), .b(x0), .c(new_n187_), .O(new_n188_));
  oai21  g172(.a(new_n188_), .b(new_n35_), .c(x8), .O(new_n189_));
  aoi21  g173(.a(new_n181_), .b(x4), .c(new_n189_), .O(new_n190_));
  aoi21  g174(.a(new_n190_), .b(new_n171_), .c(new_n30_), .O(z4));
  inv1   g175(.a(new_n139_), .O(new_n192_));
  nand2  g176(.a(x2), .b(x0), .O(new_n193_));
  aoi21  g177(.a(new_n193_), .b(new_n157_), .c(new_n140_), .O(new_n194_));
  nand2  g178(.a(new_n194_), .b(new_n192_), .O(new_n195_));
  inv1   g179(.a(new_n195_), .O(z5));
endmodule
