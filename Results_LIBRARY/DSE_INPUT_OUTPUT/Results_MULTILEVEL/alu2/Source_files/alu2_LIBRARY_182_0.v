...
module FAU ( 
  ...
  nand2  g164(.a(x8), .b(new_n24_), .O(new_n181_));
  ...
  nand2  g170(.a(new_n83_), .b(new_n53_), .O(new_n187_));
  ...
  nand2  g185(.a(new_n201_), .b(new_n77_), .O(z2));
  nand2  g186(.a(new_n200_), .b(new_n77_), .O(z3));
  nand2  g187(.a(x8), .b(x7), .O(new_n204_));
  nand2  g188(.a(x2), .b(x0), .O(new_n205_));
  nand2  g189(.a(new_n53_), .b(new_n24_), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand3  g191(.a(new_n207_), .b(new_n204_), .c(new_n79_), .O(new_n208_));
  oai21  g192(.a(x2), .b(new_n24_), .c(new_n79_), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(x7), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n208_), .c(x3), .O(new_n211_));
  nand3  g195(.a(new_n204_), .b(new_n53_), .c(new_n24_), .O(new_n212_));
  oai21  g196(.a(new_n126_), .b(new_n24_), .c(new_n212_), .O(new_n213_));
  ...
  nor2   g200(.a(x6), .b(x3), .O(new_n217_));
  aoi21  g201(.a(x7), .b(x1), .c(new_n217_), .O(new_n218_));
  oai22  g202(.a(new_n218_), .b(new_n24_), .c(new_n125_), .d(new_n79_), .O(new_n219_));
  nand2  g203(.a(x7), .b(new_n20_), .O(new_n220_));
  nor3   g204(.a(new_n220_), .b(new_n205_), .c(x3), .O(new_n221_));
  aoi21  g205(.a(new_n219_), .b(new_n17_), .c(new_n221_), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n216_), .c(x4), .O(new_n223_));
  inv1   g207(.a(new_n92_), .O(new_n224_));
  oai21  g208(.a(x3), .b(new_n79_), .c(x2), .O(new_n225_));
  aoi21  g209(.a(x3), .b(new_n24_), .c(new_n20_), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n225_), .c(x7), .O(new_n227_));
  oai21  g211(.a(new_n217_), .b(new_n79_), .c(new_n24_), .O(new_n228_));
  nand3  g212(.a(new_n200_), .b(new_n20_), .c(new_n53_), .O(new_n229_));
  nand2  g213(.a(new_n229_), .b(new_n228_), .O(new_n230_));
  oai21  g214(.a(new_n230_), .b(new_n227_), .c(x4), .O(new_n231_));
  oai21  g215(.a(new_n187_), .b(new_n224_), .c(new_n231_), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n223_), .c(x5), .O(new_n233_));
  aoi21  g217(.a(x4), .b(x3), .c(x1), .O(new_n234_));
  nand2  g218(.a(new_n125_), .b(x7), .O(new_n235_));
  aoi21  g219(.a(new_n235_), .b(new_n224_), .c(new_n234_), .O(new_n236_));
  nand2  g220(.a(new_n17_), .b(new_n25_), .O(new_n237_));
  aoi21  g221(.a(new_n237_), .b(new_n122_), .c(new_n20_), .O(new_n238_));
  oai21  g222(.a(new_n238_), .b(new_n236_), .c(new_n29_), .O(new_n239_));
  inv1   g223(.a(new_n109_), .O(new_n240_));
  oai21  g224(.a(new_n240_), .b(x2), .c(new_n224_), .O(new_n241_));
  ...
  nand2  g228(.a(new_n92_), .b(x2), .O(new_n245_));
  aoi21  g229(.a(new_n245_), .b(new_n240_), .c(new_n25_), .O(new_n246_));
  oai21  g230(.a(new_n220_), .b(new_n83_), .c(new_n97_), .O(new_n247_));
  oai21  g231(.a(new_n247_), .b(new_n246_), .c(x1), .O(new_n248_));
  nand2  g232(.a(new_n96_), .b(new_n24_), .O(new_n249_));
  nand2  g233(.a(new_n17_), .b(x3), .O(new_n250_));
  aoi21  g234(.a(new_n250_), .b(new_n249_), .c(new_n53_), .O(new_n251_));
  nand3  g235(.a(new_n96_), .b(x3), .c(new_n79_), .O(new_n252_));
  inv1   g236(.a(new_n252_), .O(new_n253_));
  oai21  g237(.a(new_n253_), .b(new_n251_), .c(x4), .O(new_n254_));
  nand3  g238(.a(new_n17_), .b(new_n31_), .c(x6), .O(new_n255_));
  nand3  g239(.a(new_n255_), .b(new_n254_), .c(new_n248_), .O(new_n256_));
  nand2  g240(.a(new_n256_), .b(new_n29_), .O(new_n257_));
  inv1   g241(.a(new_n200_), .O(new_n258_));
  nand4  g242(.a(new_n258_), .b(x7), .c(new_n20_), .d(new_n25_), .O(new_n259_));
  nand3  g243(.a(new_n259_), .b(new_n257_), .c(new_n244_), .O(new_n260_));
  inv1   g244(.a(new_n260_), .O(new_n261_));
  aoi21  g245(.a(new_n261_), .b(new_n233_), .c(new_n38_), .O(z4));
  inv1   g246(.a(new_n201_), .O(new_n263_));
  nand3  g247(.a(new_n207_), .b(new_n263_), .c(new_n77_), .O(new_n264_));
