// Benchmark "FAU" written by ABC on Thu Aug 13 18:22:02 2020
...
module FAU ( 
  ...
  xor2a  g103(.a(x3), .b(x1), .O(new_n120_));
  nand2  g104(.a(new_n120_), .b(new_n119_), .O(z2));
  nand3  g105(.a(new_n119_), .b(x3), .c(x1), .O(new_n122_));
  inv1   g106(.a(new_n122_), .O(z3));
  nor2   g107(.a(x8), .b(new_n19_), .O(new_n124_));
  oai21  g108(.a(new_n124_), .b(new_n97_), .c(x3), .O(new_n125_));
  nand2  g109(.a(new_n124_), .b(x1), .O(new_n126_));
  aoi21  g110(.a(new_n126_), .b(new_n125_), .c(x5), .O(new_n127_));
  oai22  g111(.a(new_n68_), .b(new_n74_), .c(new_n19_), .d(new_n17_), .O(new_n128_));
  aoi21  g112(.a(new_n128_), .b(x7), .c(new_n29_), .O(new_n129_));
  oai21  g113(.a(new_n129_), .b(new_n127_), .c(x4), .O(new_n130_));
  nand3  g114(.a(x5), .b(new_n27_), .c(new_n68_), .O(new_n131_));
  oai21  g115(.a(x5), .b(new_n74_), .c(new_n131_), .O(new_n132_));
  nand3  g116(.a(new_n132_), .b(x7), .c(x2), .O(new_n133_));
  inv1   g117(.a(new_n131_), .O(new_n134_));
  nand2  g118(.a(new_n27_), .b(x3), .O(new_n135_));
  nand2  g119(.a(new_n29_), .b(new_n68_), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n135_), .c(new_n74_), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n134_), .c(new_n22_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  oai21  g123(.a(x4), .b(new_n74_), .c(x3), .O(new_n140_));
  nand4  g124(.a(new_n140_), .b(new_n22_), .c(x5), .d(new_n19_), .O(new_n141_));
  nand4  g125(.a(new_n34_), .b(x7), .c(x3), .d(x1), .O(new_n142_));
  nand3  g126(.a(new_n142_), .b(new_n141_), .c(new_n46_), .O(new_n143_));
  aoi21  g127(.a(new_n139_), .b(x0), .c(new_n143_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n130_), .c(new_n18_), .O(z4));
  xor2a  g129(.a(x2), .b(x0), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n120_), .c(new_n119_), .O(z5));
endmodule
