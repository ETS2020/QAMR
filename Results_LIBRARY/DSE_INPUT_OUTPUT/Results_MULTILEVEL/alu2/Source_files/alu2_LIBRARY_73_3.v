...
module FAU ( 
  ...
  oai21  g146(.a(new_n70_), .b(new_n111_), .c(new_n68_), .O(z3));
  nor2   g147(.a(x2), .b(new_n43_), .O(new_n164_));
  nor2   g148(.a(new_n45_), .b(x0), .O(new_n165_));
  oai22  g149(.a(new_n165_), .b(new_n164_), .c(new_n32_), .d(x1), .O(new_n166_));
  nor2   g150(.a(x3), .b(new_n111_), .O(new_n167_));
  nor3   g151(.a(new_n18_), .b(new_n70_), .c(x1), .O(new_n168_));
  oai22  g152(.a(new_n168_), .b(new_n167_), .c(new_n32_), .d(x0), .O(new_n169_));
  nor2   g153(.a(new_n32_), .b(new_n111_), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n142_), .c(x0), .O(new_n171_));
  inv1   g155(.a(new_n94_), .O(new_n172_));
  aoi21  g156(.a(new_n32_), .b(x3), .c(new_n18_), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(x1), .c(new_n172_), .O(new_n174_));
  nand4  g158(.a(new_n174_), .b(new_n171_), .c(new_n169_), .d(new_n166_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x6), .O(new_n176_));
  nand3  g160(.a(new_n30_), .b(x4), .c(x3), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(new_n111_), .O(new_n178_));
  nand3  g162(.a(new_n178_), .b(new_n132_), .c(x0), .O(new_n179_));
  aoi22  g163(.a(new_n51_), .b(x2), .c(x7), .d(x3), .O(new_n180_));
  nand3  g164(.a(new_n51_), .b(x3), .c(x2), .O(new_n181_));
  oai21  g165(.a(new_n180_), .b(new_n111_), .c(new_n181_), .O(new_n182_));
  nor4   g166(.a(new_n50_), .b(new_n70_), .c(new_n17_), .d(x1), .O(new_n183_));
  aoi21  g167(.a(new_n182_), .b(new_n30_), .c(new_n183_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n179_), .c(new_n176_), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(x9), .c(new_n19_), .O(new_n186_));
  inv1   g170(.a(new_n186_), .O(z4));
  xor2a  g171(.a(x2), .b(x0), .O(new_n188_));
  oai21  g172(.a(new_n188_), .b(new_n161_), .c(new_n68_), .O(z5));
endmodule
