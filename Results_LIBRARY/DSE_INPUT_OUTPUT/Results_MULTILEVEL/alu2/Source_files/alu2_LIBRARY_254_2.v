...
module FAU ( 
  ...
  nor2   g183(.a(new_n81_), .b(new_n98_), .O(new_n200_));
  nor2   g184(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(new_n198_), .O(z2));
  nor3   g186(.a(new_n197_), .b(new_n81_), .c(new_n98_), .O(z3));
  ...
  inv1   g196(.a(new_n200_), .O(new_n213_));
  ...
  oai21  g200(.a(new_n19_), .b(new_n17_), .c(x8), .O(new_n217_));
  ...
  nor3   g206(.a(new_n151_), .b(x8), .c(new_n98_), .O(new_n223_));
  aoi21  g207(.a(new_n222_), .b(new_n81_), .c(new_n223_), .O(new_n224_));
  oai22  g208(.a(x3), .b(new_n17_), .c(x2), .d(new_n98_), .O(new_n225_));
  nand3  g209(.a(new_n225_), .b(new_n22_), .c(new_n19_), .O(new_n226_));
  oai21  g210(.a(new_n224_), .b(new_n31_), .c(new_n226_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(new_n33_), .O(new_n228_));
  nand3  g212(.a(new_n25_), .b(new_n81_), .c(new_n18_), .O(new_n229_));
  nand4  g213(.a(new_n229_), .b(new_n228_), .c(new_n216_), .d(new_n211_), .O(new_n230_));
  nor2   g214(.a(new_n56_), .b(new_n31_), .O(new_n231_));
  oai22  g215(.a(new_n231_), .b(new_n25_), .c(new_n101_), .d(x1), .O(new_n232_));
  oai21  g216(.a(new_n116_), .b(new_n35_), .c(x6), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n232_), .c(x5), .O(new_n234_));
  oai21  g218(.a(new_n185_), .b(x2), .c(new_n26_), .O(new_n235_));
  nand3  g219(.a(new_n235_), .b(new_n33_), .c(x1), .O(new_n236_));
  inv1   g220(.a(new_n236_), .O(new_n237_));
  oai21  g221(.a(new_n237_), .b(new_n234_), .c(x0), .O(new_n238_));
  nand2  g222(.a(new_n25_), .b(x2), .O(new_n239_));
  aoi21  g223(.a(new_n239_), .b(new_n185_), .c(new_n33_), .O(new_n240_));
  oai21  g224(.a(new_n32_), .b(x3), .c(new_n121_), .O(new_n241_));
  oai21  g225(.a(new_n241_), .b(new_n240_), .c(x1), .O(new_n242_));
  nand2  g226(.a(new_n106_), .b(new_n17_), .O(new_n243_));
  nand2  g227(.a(new_n22_), .b(x3), .O(new_n244_));
  aoi21  g228(.a(new_n244_), .b(new_n243_), .c(new_n18_), .O(new_n245_));
  nand3  g229(.a(new_n106_), .b(x3), .c(new_n98_), .O(new_n246_));
  inv1   g230(.a(new_n246_), .O(new_n247_));
  oai21  g231(.a(new_n247_), .b(new_n245_), .c(x4), .O(new_n248_));
  nand3  g232(.a(new_n22_), .b(new_n31_), .c(x6), .O(new_n249_));
  nand3  g233(.a(new_n249_), .b(new_n248_), .c(new_n242_), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(new_n21_), .O(new_n251_));
  nand3  g235(.a(new_n200_), .b(new_n46_), .c(new_n33_), .O(new_n252_));
  nand3  g236(.a(new_n252_), .b(new_n251_), .c(new_n238_), .O(new_n253_));
  aoi21  g237(.a(new_n230_), .b(x5), .c(new_n253_), .O(new_n254_));
  nor2   g238(.a(new_n254_), .b(new_n65_), .O(z4));
  oai21  g239(.a(new_n204_), .b(new_n201_), .c(new_n198_), .O(z5));
endmodule
