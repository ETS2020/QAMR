...
module FAU ( 
  ...
  nand3  g122(.a(x7), .b(x3), .c(new_n24_), .O(new_n139_));
  nand2  g123(.a(new_n44_), .b(new_n31_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n139_), .c(new_n63_), .O(new_n141_));
  oai21  g125(.a(new_n19_), .b(new_n24_), .c(x8), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n31_), .O(new_n143_));
  nand3  g127(.a(x7), .b(x6), .c(new_n24_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n143_), .c(x3), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n141_), .c(x0), .O(new_n146_));
  xor2a  g130(.a(x6), .b(x3), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(x7), .c(x1), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n146_), .c(new_n138_), .O(new_n149_));
  oai21  g133(.a(x3), .b(new_n63_), .c(x2), .O(new_n150_));
  aoi21  g134(.a(x3), .b(new_n36_), .c(new_n31_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n150_), .c(x7), .O(new_n152_));
  aoi21  g136(.a(new_n31_), .b(new_n64_), .c(new_n63_), .O(new_n153_));
  nand2  g137(.a(x3), .b(x1), .O(new_n154_));
  nand3  g138(.a(new_n154_), .b(new_n31_), .c(new_n24_), .O(new_n155_));
  oai21  g139(.a(new_n153_), .b(x0), .c(new_n155_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n152_), .c(x4), .O(new_n157_));
  nand2  g141(.a(new_n64_), .b(new_n24_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n140_), .c(new_n157_), .O(new_n159_));
  aoi21  g143(.a(new_n149_), .b(new_n20_), .c(new_n159_), .O(new_n160_));
  nor3   g144(.a(new_n160_), .b(new_n18_), .c(new_n17_), .O(z4));
  oai21  g145(.a(new_n136_), .b(new_n128_), .c(new_n127_), .O(z5));
endmodule
