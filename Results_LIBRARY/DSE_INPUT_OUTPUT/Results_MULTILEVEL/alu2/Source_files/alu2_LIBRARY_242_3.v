...
module FAU ( 
  ...
  nand2  g127(.a(new_n24_), .b(x0), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n87_), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n96_), .c(new_n44_), .O(new_n146_));
  aoi21  g130(.a(new_n143_), .b(new_n20_), .c(new_n146_), .O(new_n147_));
  nand4  g131(.a(new_n133_), .b(x8), .c(x4), .d(x3), .O(new_n148_));
  oai21  g132(.a(new_n147_), .b(new_n18_), .c(new_n148_), .O(new_n149_));
  nand3  g133(.a(new_n60_), .b(x3), .c(x0), .O(new_n150_));
  nand3  g134(.a(new_n17_), .b(x6), .c(new_n80_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n150_), .c(x4), .O(new_n152_));
  aoi21  g136(.a(new_n149_), .b(x9), .c(new_n152_), .O(new_n153_));
  oai21  g137(.a(new_n44_), .b(new_n80_), .c(new_n18_), .O(new_n154_));
  nand4  g138(.a(new_n154_), .b(x9), .c(new_n25_), .d(x4), .O(new_n155_));
  oai21  g139(.a(new_n153_), .b(x1), .c(new_n155_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(new_n19_), .O(new_n157_));
  oai21  g141(.a(x6), .b(x1), .c(new_n19_), .O(new_n158_));
  nand4  g142(.a(new_n158_), .b(new_n17_), .c(new_n20_), .d(x3), .O(new_n159_));
  nand4  g143(.a(new_n159_), .b(new_n157_), .c(new_n140_), .d(new_n113_), .O(z1));
  nand2  g144(.a(x9), .b(x7), .O(new_n161_));
  xor2a  g145(.a(x3), .b(x1), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n161_), .O(z2));
  oai21  g147(.a(new_n80_), .b(new_n75_), .c(new_n161_), .O(z3));
  inv1   g148(.a(new_n97_), .O(new_n165_));
  nand2  g149(.a(x2), .b(x0), .O(new_n166_));
  aoi21  g150(.a(new_n166_), .b(new_n165_), .c(new_n162_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(x6), .O(new_n168_));
  nor2   g152(.a(new_n76_), .b(x0), .O(new_n169_));
  oai21  g153(.a(new_n24_), .b(x1), .c(x6), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n169_), .c(x4), .O(new_n171_));
  nor2   g155(.a(new_n80_), .b(x1), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(x2), .c(new_n86_), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(new_n44_), .c(new_n25_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(new_n171_), .c(new_n168_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x5), .O(new_n176_));
  nand2  g160(.a(x4), .b(x3), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(new_n75_), .c(new_n32_), .O(new_n178_));
  oai21  g162(.a(x3), .b(x1), .c(x4), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n24_), .c(new_n25_), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(new_n178_), .c(new_n44_), .O(new_n181_));
  nor2   g165(.a(new_n172_), .b(new_n133_), .O(new_n182_));
  nor2   g166(.a(new_n182_), .b(new_n20_), .O(new_n183_));
  oai21  g167(.a(x3), .b(new_n75_), .c(new_n144_), .O(new_n184_));
  ...
  oai21  g171(.a(new_n187_), .b(new_n57_), .c(new_n19_), .O(new_n188_));
  aoi21  g172(.a(new_n186_), .b(new_n18_), .c(new_n188_), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n176_), .c(new_n17_), .O(z4));
  nand2  g174(.a(new_n167_), .b(new_n161_), .O(new_n191_));
