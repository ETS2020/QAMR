...
module FAU ( 
  ...
  nand2  g111(.a(new_n127_), .b(new_n126_), .O(z2));
  nand2  g112(.a(x3), .b(x1), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(new_n126_), .O(z3));
  ...
  nand3  g137(.a(new_n129_), .b(new_n31_), .c(new_n24_), .O(new_n154_));
  oai21  g138(.a(new_n153_), .b(x0), .c(new_n154_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n152_), .c(x4), .O(new_n156_));
  nand2  g140(.a(new_n64_), .b(new_n24_), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n140_), .c(new_n156_), .O(new_n158_));
  aoi21  g142(.a(new_n149_), .b(new_n20_), .c(new_n158_), .O(new_n159_));
  nor3   g143(.a(new_n159_), .b(new_n18_), .c(new_n17_), .O(z4));
  oai21  g144(.a(new_n136_), .b(new_n127_), .c(new_n126_), .O(z5));
endmodule
