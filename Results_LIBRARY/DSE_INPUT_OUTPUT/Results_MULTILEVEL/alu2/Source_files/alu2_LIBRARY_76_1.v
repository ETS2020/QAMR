// Benchmark "FAU" written by ABC on Thu Aug 13 18:21:17 2020
...
module FAU ( 
  ...
  xor2a  g111(.a(x3), .b(x1), .O(new_n128_));
  nand2  g112(.a(new_n128_), .b(new_n127_), .O(z2));
  nor3   g113(.a(new_n126_), .b(new_n64_), .c(new_n63_), .O(z3));
  oai21  g114(.a(x7), .b(new_n31_), .c(x8), .O(new_n131_));
  nand3  g115(.a(new_n131_), .b(x3), .c(x1), .O(new_n132_));
  nand2  g116(.a(x8), .b(x7), .O(new_n133_));
  nand4  g117(.a(new_n133_), .b(x6), .c(new_n64_), .d(new_n63_), .O(new_n134_));
  xor2a  g118(.a(x2), .b(x0), .O(new_n135_));
  aoi21  g119(.a(new_n134_), .b(new_n132_), .c(new_n135_), .O(new_n136_));
  nand3  g120(.a(x7), .b(x3), .c(new_n24_), .O(new_n137_));
  nand2  g121(.a(new_n44_), .b(new_n31_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n63_), .O(new_n139_));
  oai21  g123(.a(new_n19_), .b(new_n24_), .c(x8), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(new_n31_), .O(new_n141_));
  nand3  g125(.a(x7), .b(x6), .c(new_n24_), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n141_), .c(x3), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n139_), .c(x0), .O(new_n144_));
  xor2a  g128(.a(x6), .b(x3), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(x7), .c(x1), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n136_), .c(new_n20_), .O(new_n148_));
  aoi21  g132(.a(new_n64_), .b(x1), .c(new_n24_), .O(new_n149_));
  oai21  g133(.a(new_n64_), .b(x0), .c(x6), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n149_), .c(new_n19_), .O(new_n151_));
  oai21  g135(.a(x6), .b(x3), .c(x1), .O(new_n152_));
  aoi21  g136(.a(x3), .b(x1), .c(x6), .O(new_n153_));
  aoi22  g137(.a(new_n153_), .b(new_n24_), .c(new_n152_), .d(new_n36_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g139(.a(new_n64_), .b(new_n24_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n138_), .c(x5), .O(new_n157_));
  aoi21  g141(.a(new_n155_), .b(x4), .c(new_n157_), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n148_), .c(new_n18_), .O(z4));
  oai21  g143(.a(new_n135_), .b(new_n128_), .c(new_n127_), .O(z5));
endmodule
