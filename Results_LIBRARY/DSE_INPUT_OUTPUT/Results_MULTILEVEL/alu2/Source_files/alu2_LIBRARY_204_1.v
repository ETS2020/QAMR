...
module FAU ( 
  ...
  xnor2a g113(.a(x3), .b(x1), .O(new_n130_));
  inv1   g114(.a(new_n130_), .O(new_n131_));
  nand2  g115(.a(new_n131_), .b(new_n129_), .O(z2));
  nand2  g116(.a(x3), .b(x1), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n129_), .O(z3));
  xnor2a g118(.a(x2), .b(x0), .O(new_n135_));
  nand4  g119(.a(new_n135_), .b(new_n130_), .c(x6), .d(x5), .O(new_n136_));
  nor2   g120(.a(new_n136_), .b(x4), .O(new_n137_));
  oai21  g121(.a(x3), .b(new_n65_), .c(x2), .O(new_n138_));
  aoi21  g122(.a(x3), .b(new_n41_), .c(new_n18_), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(new_n138_), .c(new_n23_), .O(new_n140_));
  oai21  g124(.a(new_n140_), .b(new_n137_), .c(new_n28_), .O(new_n141_));
  nand4  g125(.a(new_n130_), .b(x6), .c(x5), .d(new_n41_), .O(new_n142_));
  oai21  g126(.a(x6), .b(new_n65_), .c(new_n142_), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n17_), .O(new_n144_));
  aoi21  g128(.a(new_n28_), .b(x6), .c(new_n65_), .O(new_n145_));
  nand4  g129(.a(x6), .b(x5), .c(x2), .d(new_n65_), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(x6), .c(x3), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n145_), .c(x0), .O(new_n148_));
  aoi21  g132(.a(new_n148_), .b(new_n144_), .c(x8), .O(new_n149_));
  nand2  g133(.a(x3), .b(new_n65_), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(x6), .c(new_n17_), .O(new_n151_));
  nor2   g135(.a(x6), .b(x3), .O(new_n152_));
  ...
  oai21  g142(.a(new_n158_), .b(new_n149_), .c(new_n23_), .O(new_n159_));
  oai21  g143(.a(new_n152_), .b(new_n65_), .c(new_n41_), .O(new_n160_));
  nand3  g144(.a(new_n133_), .b(new_n18_), .c(new_n17_), .O(new_n161_));
  ...
  nand3  g149(.a(new_n165_), .b(new_n159_), .c(new_n141_), .O(new_n166_));
  and2   g150(.a(new_n166_), .b(x9), .O(z4));
  nand3  g151(.a(new_n135_), .b(new_n130_), .c(new_n129_), .O(new_n168_));
