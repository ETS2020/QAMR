...
module FAU ( 
  ...
  inv1   g119(.a(new_n124_), .O(new_n136_));
  aoi21  g120(.a(new_n103_), .b(new_n40_), .c(x0), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n34_), .c(new_n136_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n79_), .O(new_n139_));
  nand3  g123(.a(new_n45_), .b(new_n19_), .c(x3), .O(new_n140_));
  nand3  g124(.a(new_n140_), .b(new_n139_), .c(new_n135_), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n23_), .O(new_n142_));
  nand3  g126(.a(new_n35_), .b(new_n79_), .c(new_n40_), .O(new_n143_));
  nand4  g127(.a(x8), .b(new_n22_), .c(x3), .d(x2), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(x9), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n103_), .O(new_n147_));
  nand2  g131(.a(x9), .b(new_n22_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n72_), .O(new_n149_));
  nand4  g133(.a(new_n149_), .b(x8), .c(x5), .d(x3), .O(new_n150_));
  nor2   g134(.a(new_n150_), .b(new_n40_), .O(new_n151_));
  aoi21  g135(.a(new_n147_), .b(x0), .c(new_n151_), .O(new_n152_));
  nand4  g136(.a(new_n152_), .b(new_n142_), .c(new_n132_), .d(new_n123_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(x6), .O(new_n154_));
  nand2  g138(.a(x5), .b(x3), .O(new_n155_));
  nand2  g139(.a(new_n21_), .b(new_n79_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand3  g141(.a(new_n157_), .b(new_n34_), .c(x7), .O(new_n158_));
  nand2  g142(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(x1), .O(new_n160_));
  nand3  g144(.a(x6), .b(new_n21_), .c(new_n79_), .O(new_n161_));
  oai21  g145(.a(new_n72_), .b(new_n79_), .c(new_n161_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n34_), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(new_n160_), .c(new_n119_), .O(z1));
  nor2   g148(.a(new_n34_), .b(x6), .O(new_n165_));
  inv1   g149(.a(new_n165_), .O(new_n166_));
  xor2a  g150(.a(x3), .b(x1), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(new_n166_), .O(z2));
  nor3   g152(.a(new_n165_), .b(new_n79_), .c(new_n78_), .O(z3));
  nand3  g153(.a(new_n21_), .b(x4), .c(new_n78_), .O(new_n170_));
  nand4  g154(.a(new_n22_), .b(x5), .c(x2), .d(x1), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(new_n170_), .c(new_n79_), .O(new_n172_));
  nand2  g156(.a(new_n87_), .b(x1), .O(new_n173_));
  nand3  g157(.a(x5), .b(new_n79_), .c(new_n40_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n173_), .c(new_n22_), .O(new_n175_));
  nand4  g159(.a(new_n20_), .b(x5), .c(new_n79_), .d(x2), .O(new_n176_));
  nor2   g160(.a(x8), .b(x5), .O(new_n177_));
  inv1   g161(.a(new_n177_), .O(new_n178_));
  oai21  g162(.a(new_n176_), .b(x1), .c(new_n178_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n175_), .c(new_n19_), .O(new_n180_));
  oai21  g164(.a(new_n22_), .b(x1), .c(new_n40_), .O(new_n181_));
  oai21  g165(.a(new_n29_), .b(new_n79_), .c(x1), .O(new_n182_));
  ...
  oai21  g169(.a(new_n185_), .b(new_n172_), .c(x0), .O(new_n186_));
  nand4  g170(.a(new_n98_), .b(x5), .c(x3), .d(new_n40_), .O(new_n187_));
  nand3  g171(.a(new_n21_), .b(x4), .c(x2), .O(new_n188_));
  nand2  g172(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n17_), .O(new_n190_));
  oai21  g174(.a(new_n73_), .b(x3), .c(new_n103_), .O(new_n191_));
  nand4  g175(.a(x7), .b(x5), .c(new_n19_), .d(new_n79_), .O(new_n192_));
  inv1   g176(.a(new_n192_), .O(new_n193_));
  aoi21  g177(.a(new_n191_), .b(new_n21_), .c(new_n193_), .O(new_n194_));
  aoi21  g178(.a(new_n194_), .b(new_n190_), .c(new_n78_), .O(new_n195_));
  nand2  g179(.a(new_n22_), .b(x5), .O(new_n196_));
  nand2  g180(.a(new_n177_), .b(x3), .O(new_n197_));
  aoi21  g181(.a(new_n197_), .b(new_n196_), .c(new_n40_), .O(new_n198_));
  oai22  g182(.a(new_n136_), .b(new_n79_), .c(new_n21_), .d(x0), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n198_), .c(x4), .O(new_n200_));
  nand4  g184(.a(new_n20_), .b(x5), .c(new_n19_), .d(new_n79_), .O(new_n201_));
  inv1   g185(.a(new_n201_), .O(new_n202_));
  nand3  g186(.a(new_n202_), .b(new_n40_), .c(new_n17_), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(new_n200_), .c(x1), .O(new_n204_));
  aoi21  g188(.a(new_n155_), .b(new_n127_), .c(new_n19_), .O(new_n205_));
  aoi21  g189(.a(new_n205_), .b(new_n17_), .c(new_n177_), .O(new_n206_));
  oai21  g190(.a(new_n206_), .b(x7), .c(x6), .O(new_n207_));
  nor3   g191(.a(new_n207_), .b(new_n204_), .c(new_n195_), .O(new_n208_));
  aoi21  g192(.a(new_n208_), .b(new_n186_), .c(new_n34_), .O(z4));
  xor2a  g193(.a(x2), .b(x0), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n167_), .c(new_n166_), .O(z5));
endmodule
