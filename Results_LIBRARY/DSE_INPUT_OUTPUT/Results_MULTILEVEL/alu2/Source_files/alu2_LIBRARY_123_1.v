...
module FAU ( 
  ...
  nand3  g124(.a(x7), .b(x3), .c(new_n17_), .O(new_n141_));
  nand2  g125(.a(new_n22_), .b(new_n18_), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n141_), .c(new_n65_), .O(new_n143_));
  oai21  g127(.a(new_n28_), .b(new_n17_), .c(x8), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n18_), .O(new_n145_));
  nand3  g129(.a(x7), .b(x6), .c(new_n17_), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(new_n145_), .c(x3), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n143_), .c(x0), .O(new_n148_));
  xor2a  g132(.a(x6), .b(x3), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(x7), .c(x1), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(new_n148_), .c(new_n140_), .O(new_n151_));
  oai21  g135(.a(x3), .b(new_n65_), .c(x2), .O(new_n152_));
  aoi21  g136(.a(x3), .b(new_n41_), .c(new_n18_), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(new_n152_), .c(x7), .O(new_n154_));
  aoi21  g138(.a(new_n18_), .b(new_n67_), .c(new_n65_), .O(new_n155_));
  nand2  g139(.a(x3), .b(x1), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n18_), .c(new_n17_), .O(new_n157_));
  oai21  g141(.a(new_n155_), .b(x0), .c(new_n157_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n154_), .c(x4), .O(new_n159_));
  nand2  g143(.a(new_n67_), .b(new_n17_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n142_), .c(new_n159_), .O(new_n161_));
  aoi21  g145(.a(new_n151_), .b(new_n23_), .c(new_n161_), .O(new_n162_));
  nor3   g146(.a(new_n162_), .b(new_n27_), .c(new_n32_), .O(z4));
  oai21  g147(.a(new_n138_), .b(new_n130_), .c(new_n129_), .O(z5));
endmodule
