...
module FAU ( 
  ...
  nand2  g123(.a(new_n87_), .b(new_n80_), .O(new_n140_));
  nand2  g124(.a(new_n20_), .b(new_n18_), .O(new_n141_));
  nor3   g125(.a(new_n141_), .b(new_n140_), .c(x0), .O(new_n142_));
  ...
  nand2  g131(.a(new_n20_), .b(new_n80_), .O(new_n148_));
  ...
  nor2   g155(.a(x5), .b(x3), .O(new_n172_));
  nor2   g156(.a(new_n172_), .b(x1), .O(new_n173_));
  nor2   g157(.a(new_n173_), .b(new_n17_), .O(new_n174_));
  nand2  g158(.a(new_n18_), .b(new_n33_), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(x3), .c(x1), .O(new_n176_));
  nand3  g160(.a(new_n172_), .b(x2), .c(new_n80_), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(new_n176_), .c(x8), .O(new_n178_));
  oai21  g162(.a(new_n178_), .b(new_n174_), .c(x7), .O(new_n179_));
  nor3   g163(.a(x7), .b(x5), .c(x0), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(new_n19_), .c(x2), .O(new_n181_));
  aoi21  g165(.a(new_n56_), .b(new_n19_), .c(new_n44_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(new_n87_), .c(x1), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n179_), .c(new_n37_), .O(new_n185_));
  nand2  g169(.a(new_n27_), .b(new_n33_), .O(new_n186_));
  nand4  g170(.a(new_n186_), .b(x8), .c(new_n80_), .d(x0), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(x9), .O(new_n188_));
  nand3  g172(.a(new_n188_), .b(new_n18_), .c(new_n87_), .O(new_n189_));
  oai21  g173(.a(new_n76_), .b(new_n80_), .c(new_n189_), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(new_n185_), .c(x6), .O(new_n191_));
  nand3  g175(.a(x5), .b(x3), .c(x2), .O(new_n192_));
  inv1   g176(.a(new_n192_), .O(new_n193_));
  oai21  g177(.a(new_n193_), .b(new_n172_), .c(x1), .O(new_n194_));
  nand4  g178(.a(new_n54_), .b(new_n18_), .c(x3), .d(new_n80_), .O(new_n195_));
  aoi21  g179(.a(new_n195_), .b(new_n194_), .c(new_n27_), .O(new_n196_));
  inv1   g180(.a(new_n140_), .O(new_n197_));
  nand3  g181(.a(new_n197_), .b(new_n27_), .c(new_n18_), .O(new_n198_));
  inv1   g182(.a(new_n198_), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n196_), .c(new_n44_), .O(new_n200_));
  nand2  g184(.a(new_n200_), .b(new_n191_), .O(new_n201_));
  aoi21  g185(.a(new_n171_), .b(new_n37_), .c(new_n201_), .O(new_n202_));
  nand3  g186(.a(new_n202_), .b(new_n143_), .c(new_n139_), .O(z1));
  nor2   g187(.a(x6), .b(x2), .O(new_n204_));
  nor2   g188(.a(new_n152_), .b(new_n197_), .O(new_n205_));
  nor2   g189(.a(new_n205_), .b(new_n204_), .O(z2));
  inv1   g190(.a(new_n204_), .O(new_n207_));
  nand2  g191(.a(new_n207_), .b(new_n151_), .O(z3));
  nand3  g192(.a(x6), .b(x2), .c(x0), .O(new_n209_));
  oai21  g193(.a(x2), .b(x0), .c(new_n209_), .O(new_n210_));
  nand3  g194(.a(new_n210_), .b(new_n50_), .c(new_n80_), .O(new_n211_));
  oai21  g195(.a(new_n20_), .b(x6), .c(new_n97_), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(x0), .O(new_n213_));
  nor2   g197(.a(new_n27_), .b(new_n54_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(x1), .O(new_n215_));
  nand3  g199(.a(new_n215_), .b(new_n213_), .c(new_n211_), .O(new_n216_));
  nand2  g200(.a(new_n216_), .b(new_n87_), .O(new_n217_));
  nand4  g201(.a(new_n50_), .b(x6), .c(x2), .d(x0), .O(new_n218_));
  nand3  g202(.a(new_n27_), .b(new_n33_), .c(new_n17_), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n218_), .c(new_n87_), .O(new_n220_));
  ...
  oai21  g217(.a(new_n233_), .b(new_n214_), .c(x1), .O(new_n234_));
  nand2  g218(.a(new_n27_), .b(x6), .O(new_n235_));
  oai22  g219(.a(new_n235_), .b(x0), .c(x8), .d(new_n87_), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(x2), .O(new_n237_));
  inv1   g221(.a(new_n233_), .O(new_n238_));
  nor2   g222(.a(x7), .b(new_n54_), .O(new_n239_));
  nand2  g223(.a(new_n239_), .b(new_n80_), .O(new_n240_));
  nand3  g224(.a(new_n240_), .b(new_n238_), .c(new_n81_), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(x3), .O(new_n242_));
  nand3  g226(.a(new_n242_), .b(new_n237_), .c(new_n234_), .O(new_n243_));
  nand2  g227(.a(new_n243_), .b(x4), .O(new_n244_));
  oai21  g228(.a(new_n233_), .b(x7), .c(x0), .O(new_n245_));
  nand3  g229(.a(x7), .b(new_n54_), .c(x3), .O(new_n246_));
  nand2  g230(.a(new_n239_), .b(new_n87_), .O(new_n247_));
  nand3  g231(.a(new_n247_), .b(new_n246_), .c(new_n245_), .O(new_n248_));
  nand2  g232(.a(new_n248_), .b(x1), .O(new_n249_));
  oai21  g233(.a(new_n101_), .b(x4), .c(new_n186_), .O(new_n250_));
  nor2   g234(.a(x8), .b(x7), .O(new_n251_));
  aoi22  g235(.a(new_n251_), .b(x6), .c(new_n250_), .d(x0), .O(new_n252_));
  nand3  g236(.a(new_n252_), .b(new_n249_), .c(new_n244_), .O(new_n253_));
  inv1   g237(.a(new_n246_), .O(new_n254_));
  aoi21  g238(.a(new_n238_), .b(new_n97_), .c(new_n17_), .O(new_n255_));
  oai21  g239(.a(new_n255_), .b(new_n254_), .c(new_n37_), .O(new_n256_));
  nor2   g240(.a(new_n256_), .b(new_n80_), .O(new_n257_));
  aoi21  g241(.a(new_n253_), .b(new_n18_), .c(new_n257_), .O(new_n258_));
  nand2  g242(.a(new_n258_), .b(new_n232_), .O(new_n259_));
  nand2  g243(.a(new_n259_), .b(x9), .O(new_n260_));
  nand2  g244(.a(new_n260_), .b(new_n207_), .O(z4));
  aoi21  g245(.a(x6), .b(new_n33_), .c(new_n17_), .O(new_n262_));
  aoi21  g246(.a(new_n33_), .b(new_n17_), .c(new_n262_), .O(new_n263_));
  oai21  g247(.a(new_n263_), .b(new_n205_), .c(new_n207_), .O(z5));
endmodule
