...
module FAU ( 
  ...
  nand3  g167(.a(x7), .b(x5), .c(new_n21_), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n183_), .c(x3), .O(new_n185_));
  nand2  g169(.a(new_n135_), .b(new_n54_), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n17_), .c(new_n185_), .O(new_n187_));
  nand3  g171(.a(new_n187_), .b(new_n182_), .c(new_n174_), .O(new_n188_));
  nand2  g172(.a(new_n188_), .b(x6), .O(new_n189_));
  nand2  g173(.a(new_n18_), .b(new_n123_), .O(new_n190_));
  aoi21  g174(.a(new_n190_), .b(new_n177_), .c(x0), .O(new_n191_));
  nand2  g175(.a(new_n123_), .b(new_n55_), .O(new_n192_));
  aoi21  g176(.a(new_n192_), .b(x7), .c(x6), .O(new_n193_));
  oai21  g177(.a(new_n193_), .b(new_n191_), .c(x4), .O(new_n194_));
  nand4  g178(.a(new_n25_), .b(new_n22_), .c(new_n21_), .d(new_n55_), .O(new_n195_));
  aoi21  g179(.a(new_n195_), .b(new_n194_), .c(new_n17_), .O(new_n196_));
  aoi21  g180(.a(x7), .b(x2), .c(new_n22_), .O(new_n197_));
  or2    g181(.a(new_n197_), .b(new_n53_), .O(new_n198_));
  nand2  g182(.a(x7), .b(x3), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(new_n198_), .c(x4), .O(new_n200_));
  aoi21  g184(.a(new_n199_), .b(new_n102_), .c(x5), .O(new_n201_));
  oai21  g185(.a(new_n201_), .b(new_n200_), .c(new_n18_), .O(new_n202_));
  oai22  g186(.a(new_n197_), .b(x5), .c(new_n38_), .d(x4), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(x0), .c(new_n124_), .O(new_n204_));
  nand2  g188(.a(new_n204_), .b(new_n202_), .O(new_n205_));
  nor2   g189(.a(new_n205_), .b(new_n196_), .O(new_n206_));
  aoi21  g190(.a(new_n206_), .b(new_n189_), .c(new_n36_), .O(z4));
  nand3  g191(.a(new_n36_), .b(new_n123_), .c(new_n124_), .O(new_n208_));
  xor2a  g192(.a(x2), .b(x0), .O(new_n209_));
  aoi21  g193(.a(new_n208_), .b(new_n168_), .c(new_n209_), .O(z5));
endmodule
