...
module FAU ( 
  ...
  oai21  g164(.a(x4), .b(new_n17_), .c(x7), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n20_), .O(new_n182_));
  nand4  g166(.a(x7), .b(x4), .c(x1), .d(new_n17_), .O(new_n183_));
  nand4  g167(.a(new_n183_), .b(new_n182_), .c(new_n180_), .d(new_n177_), .O(new_n184_));
  nand2  g168(.a(new_n184_), .b(x6), .O(new_n185_));
  oai21  g169(.a(new_n128_), .b(x1), .c(new_n144_), .O(new_n186_));
  nand3  g170(.a(x7), .b(x3), .c(x1), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n186_), .c(new_n17_), .O(new_n188_));
  aoi21  g172(.a(new_n123_), .b(new_n89_), .c(new_n122_), .O(new_n189_));
  nand3  g173(.a(new_n88_), .b(x3), .c(x2), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n19_), .O(new_n191_));
  nor3   g175(.a(new_n191_), .b(new_n189_), .c(new_n188_), .O(new_n192_));
  aoi21  g176(.a(new_n192_), .b(new_n185_), .c(new_n21_), .O(z4));
  inv1   g177(.a(new_n171_), .O(new_n194_));
  xnor2a g178(.a(x2), .b(x0), .O(new_n195_));
  nand3  g179(.a(new_n195_), .b(new_n194_), .c(new_n170_), .O(new_n196_));
