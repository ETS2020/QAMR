// Benchmark "FAU" written by ABC on Thu Aug 13 18:21:09 2020
...
module FAU ( 
  ...
  oai21  g038(.a(x7), .b(x6), .c(x4), .O(new_n55_));
  nand3  g039(.a(new_n55_), .b(x9), .c(x5), .O(new_n56_));
  inv1   g040(.a(x4), .O(new_n57_));
  nand2  g041(.a(new_n34_), .b(new_n57_), .O(new_n58_));
  nand2  g042(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g043(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  nand3  g044(.a(new_n21_), .b(new_n25_), .c(new_n57_), .O(new_n61_));
  nand3  g045(.a(new_n61_), .b(new_n60_), .c(new_n54_), .O(new_n62_));
  ...
  aoi21  g052(.a(new_n68_), .b(new_n33_), .c(new_n57_), .O(new_n69_));
  ...
  aoi22  g057(.a(new_n73_), .b(new_n57_), .c(new_n64_), .d(new_n33_), .O(new_n74_));
  ...
  nor2   g063(.a(x8), .b(x2), .O(new_n80_));
  aoi21  g064(.a(new_n79_), .b(x0), .c(new_n80_), .O(new_n81_));
  nand2  g065(.a(x1), .b(new_n20_), .O(new_n82_));
  nand2  g066(.a(new_n33_), .b(x2), .O(new_n83_));
  oai22  g067(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(x1), .O(new_n84_));
  nand2  g068(.a(new_n84_), .b(x5), .O(new_n85_));
  aoi21  g069(.a(new_n25_), .b(new_n18_), .c(x8), .O(new_n86_));
  oai22  g070(.a(new_n86_), .b(x0), .c(new_n24_), .d(new_n17_), .O(new_n87_));
  nand3  g071(.a(new_n87_), .b(new_n33_), .c(x1), .O(new_n88_));
  aoi21  g072(.a(new_n88_), .b(new_n85_), .c(new_n21_), .O(new_n89_));
  ...
  nor2   g079(.a(new_n80_), .b(x0), .O(new_n96_));
  ...
  oai21  g086(.a(new_n102_), .b(new_n89_), .c(new_n57_), .O(new_n103_));
  nand3  g087(.a(new_n24_), .b(x7), .c(x2), .O(new_n104_));
  nand4  g088(.a(new_n26_), .b(new_n25_), .c(new_n17_), .d(new_n20_), .O(new_n105_));
  aoi21  g089(.a(new_n105_), .b(new_n104_), .c(new_n57_), .O(new_n106_));
  ...
  nand2  g108(.a(x8), .b(x7), .O(new_n125_));
  nor2   g109(.a(new_n125_), .b(x0), .O(new_n126_));
  oai21  g110(.a(new_n126_), .b(new_n124_), .c(new_n91_), .O(new_n127_));
  nand3  g111(.a(new_n64_), .b(new_n33_), .c(new_n25_), .O(new_n128_));
  nand2  g112(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(x4), .O(new_n130_));
  nand3  g114(.a(new_n130_), .b(new_n116_), .c(new_n103_), .O(new_n131_));
  nand2  g115(.a(new_n131_), .b(x3), .O(new_n132_));
  inv1   g116(.a(x3), .O(new_n133_));
  nand2  g117(.a(new_n33_), .b(new_n17_), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(new_n18_), .c(x0), .O(new_n135_));
  nor2   g119(.a(new_n18_), .b(x4), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(x2), .O(new_n137_));
  nand3  g121(.a(new_n33_), .b(new_n17_), .c(new_n20_), .O(new_n138_));
  ...
  nand3  g125(.a(new_n141_), .b(new_n83_), .c(x0), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(x5), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(new_n140_), .c(new_n24_), .O(new_n144_));
  ...
  nand3  g135(.a(new_n136_), .b(x2), .c(new_n20_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n144_), .c(new_n91_), .O(new_n154_));
  nand3  g138(.a(new_n25_), .b(x2), .c(new_n20_), .O(new_n155_));
  nand3  g139(.a(new_n24_), .b(x6), .c(new_n17_), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n155_), .c(x4), .O(new_n157_));
  aoi21  g141(.a(new_n18_), .b(new_n17_), .c(x8), .O(new_n158_));
  oai22  g142(.a(new_n158_), .b(x0), .c(new_n24_), .d(x2), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n25_), .O(new_n160_));
  nand2  g144(.a(new_n30_), .b(x0), .O(new_n161_));
  nand2  g145(.a(new_n24_), .b(new_n33_), .O(new_n162_));
  ...
  oai21  g150(.a(new_n166_), .b(new_n157_), .c(x1), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(new_n154_), .c(new_n21_), .O(new_n168_));
  nor2   g152(.a(x5), .b(new_n57_), .O(new_n169_));
  nand3  g153(.a(new_n169_), .b(x2), .c(x1), .O(new_n170_));
  nand3  g154(.a(x8), .b(new_n57_), .c(new_n91_), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(new_n20_), .O(new_n173_));
  nor2   g157(.a(new_n136_), .b(x8), .O(new_n174_));
  ...
  oai21  g161(.a(new_n158_), .b(new_n21_), .c(x4), .O(new_n178_));
  ...
  oai21  g167(.a(new_n183_), .b(new_n168_), .c(new_n133_), .O(new_n184_));
  nand2  g168(.a(new_n134_), .b(x0), .O(new_n185_));
  oai21  g169(.a(x7), .b(x0), .c(new_n185_), .O(new_n186_));
  nand4  g170(.a(new_n186_), .b(x6), .c(new_n18_), .d(new_n57_), .O(new_n187_));
  nand2  g171(.a(new_n83_), .b(x0), .O(new_n188_));
  ...
  nor2   g181(.a(x4), .b(x0), .O(new_n198_));
  nand4  g182(.a(new_n198_), .b(x7), .c(x6), .d(new_n18_), .O(new_n199_));
  nand2  g183(.a(new_n199_), .b(new_n128_), .O(new_n200_));
  aoi21  g184(.a(new_n200_), .b(x1), .c(new_n76_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(new_n197_), .O(new_n202_));
  aoi21  g186(.a(new_n192_), .b(new_n91_), .c(new_n202_), .O(new_n203_));
  nand3  g187(.a(new_n203_), .b(new_n184_), .c(new_n132_), .O(z1));
  xnor2a g188(.a(x3), .b(x1), .O(new_n205_));
  inv1   g189(.a(new_n205_), .O(new_n206_));
  nor2   g190(.a(new_n206_), .b(new_n76_), .O(z2));
  nor3   g191(.a(new_n76_), .b(new_n133_), .c(new_n91_), .O(z3));
  nand3  g192(.a(new_n205_), .b(x2), .c(x0), .O(new_n209_));
  nand2  g193(.a(x3), .b(new_n17_), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n82_), .c(new_n209_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(new_n57_), .O(new_n212_));
  nand4  g196(.a(new_n133_), .b(new_n17_), .c(new_n91_), .d(new_n20_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nand3  g198(.a(new_n214_), .b(new_n125_), .c(x6), .O(new_n215_));
  aoi21  g199(.a(new_n133_), .b(x1), .c(new_n17_), .O(new_n216_));
  oai21  g200(.a(new_n133_), .b(x0), .c(x6), .O(new_n217_));
  oai21  g201(.a(new_n217_), .b(new_n216_), .c(new_n33_), .O(new_n218_));
  oai21  g202(.a(x6), .b(x3), .c(x1), .O(new_n219_));
  aoi21  g203(.a(x3), .b(x1), .c(x6), .O(new_n220_));
  aoi22  g204(.a(new_n220_), .b(new_n17_), .c(new_n219_), .d(new_n20_), .O(new_n221_));
  nand2  g205(.a(new_n221_), .b(new_n218_), .O(new_n222_));
  oai21  g206(.a(x4), .b(new_n91_), .c(x3), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(new_n17_), .O(new_n224_));
  nand3  g208(.a(new_n57_), .b(new_n133_), .c(x0), .O(new_n225_));
  aoi21  g209(.a(new_n225_), .b(new_n224_), .c(x8), .O(new_n226_));
  aoi22  g210(.a(new_n226_), .b(new_n25_), .c(new_n222_), .d(x4), .O(new_n227_));
  aoi21  g211(.a(new_n227_), .b(new_n215_), .c(new_n18_), .O(new_n228_));
  nor2   g212(.a(new_n57_), .b(new_n133_), .O(new_n229_));
  nor2   g213(.a(new_n229_), .b(x1), .O(new_n230_));
  nand3  g214(.a(x4), .b(x2), .c(x1), .O(new_n231_));
  oai21  g215(.a(new_n230_), .b(new_n20_), .c(new_n231_), .O(new_n232_));
  nand2  g216(.a(new_n232_), .b(new_n25_), .O(new_n233_));
  oai21  g217(.a(x4), .b(new_n20_), .c(x7), .O(new_n234_));
  aoi22  g218(.a(new_n234_), .b(x6), .c(new_n229_), .d(x2), .O(new_n235_));
  aoi21  g219(.a(new_n235_), .b(new_n233_), .c(x5), .O(new_n236_));
  nand4  g220(.a(new_n25_), .b(new_n57_), .c(x1), .d(x0), .O(new_n237_));
  inv1   g221(.a(new_n237_), .O(new_n238_));
  oai21  g222(.a(new_n238_), .b(new_n236_), .c(new_n24_), .O(new_n239_));
  aoi22  g223(.a(x3), .b(new_n91_), .c(x2), .d(new_n20_), .O(new_n240_));
  aoi22  g224(.a(new_n133_), .b(x1), .c(new_n17_), .d(x0), .O(new_n241_));
  oai21  g225(.a(new_n240_), .b(new_n57_), .c(new_n241_), .O(new_n242_));
  nand4  g226(.a(new_n242_), .b(new_n33_), .c(x6), .d(new_n18_), .O(new_n243_));
  ...
  nand2  g231(.a(new_n169_), .b(x3), .O(new_n248_));
  nand3  g232(.a(new_n136_), .b(new_n133_), .c(new_n17_), .O(new_n249_));
  nand3  g233(.a(new_n249_), .b(new_n248_), .c(new_n247_), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(x6), .O(new_n251_));
  nand4  g235(.a(new_n25_), .b(x5), .c(new_n57_), .d(new_n133_), .O(new_n252_));
  oai21  g236(.a(new_n230_), .b(x5), .c(new_n252_), .O(new_n253_));
  nand2  g237(.a(new_n253_), .b(x2), .O(new_n254_));
  aoi21  g238(.a(new_n254_), .b(new_n251_), .c(new_n20_), .O(new_n255_));
  nand2  g239(.a(x5), .b(x4), .O(new_n256_));
  nand3  g240(.a(new_n256_), .b(new_n25_), .c(x3), .O(new_n257_));
  aoi21  g241(.a(new_n136_), .b(new_n133_), .c(new_n169_), .O(new_n258_));
  oai21  g242(.a(new_n258_), .b(new_n25_), .c(new_n257_), .O(new_n259_));
  nand2  g243(.a(new_n259_), .b(x1), .O(new_n260_));
  nand2  g244(.a(new_n260_), .b(x9), .O(new_n261_));
  oai21  g245(.a(new_n261_), .b(new_n255_), .c(x7), .O(new_n262_));
  nand2  g246(.a(new_n262_), .b(new_n245_), .O(z4));
  inv1   g247(.a(new_n76_), .O(new_n264_));
  and2   g248(.a(new_n108_), .b(new_n121_), .O(new_n265_));
  oai21  g249(.a(new_n265_), .b(new_n206_), .c(new_n264_), .O(z5));
endmodule
