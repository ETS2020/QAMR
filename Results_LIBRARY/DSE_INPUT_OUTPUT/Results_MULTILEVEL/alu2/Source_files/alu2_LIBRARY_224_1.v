...
module FAU ( 
  ...
  nor2   g114(.a(new_n67_), .b(new_n65_), .O(new_n131_));
  nor2   g115(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(new_n129_), .O(z2));
  inv1   g117(.a(new_n131_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n129_), .O(z3));
  oai21  g119(.a(x7), .b(new_n18_), .c(x8), .O(new_n136_));
  nand3  g120(.a(new_n136_), .b(x3), .c(x1), .O(new_n137_));
  nand2  g121(.a(x8), .b(x7), .O(new_n138_));
  nand4  g122(.a(new_n138_), .b(x6), .c(new_n67_), .d(new_n65_), .O(new_n139_));
  xor2a  g123(.a(x2), .b(x0), .O(new_n140_));
  aoi21  g124(.a(new_n139_), .b(new_n137_), .c(new_n140_), .O(new_n141_));
  ...
  oai21  g136(.a(new_n152_), .b(new_n141_), .c(new_n23_), .O(new_n153_));
  aoi21  g137(.a(new_n67_), .b(x1), .c(new_n17_), .O(new_n154_));
  oai21  g138(.a(new_n67_), .b(x0), .c(x6), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n154_), .c(new_n28_), .O(new_n156_));
  oai21  g140(.a(x6), .b(x3), .c(x1), .O(new_n157_));
  nor2   g141(.a(new_n131_), .b(x6), .O(new_n158_));
  aoi22  g142(.a(new_n158_), .b(new_n17_), .c(new_n157_), .d(new_n41_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g144(.a(new_n67_), .b(new_n17_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n143_), .c(x5), .O(new_n162_));
  aoi21  g146(.a(new_n160_), .b(x4), .c(new_n162_), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n153_), .c(new_n27_), .O(z4));
  oai21  g148(.a(new_n140_), .b(new_n132_), .c(new_n129_), .O(z5));
endmodule
