...
module FAU ( 
  ...
  inv1   g143(.a(new_n159_), .O(z3));
  nand2  g144(.a(new_n84_), .b(new_n70_), .O(new_n161_));
  aoi21  g145(.a(new_n161_), .b(new_n59_), .c(x1), .O(new_n162_));
  aoi21  g146(.a(x6), .b(x1), .c(x4), .O(new_n163_));
  nor3   g147(.a(new_n163_), .b(x7), .c(new_n70_), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n162_), .c(new_n20_), .O(new_n165_));
  oai21  g149(.a(new_n151_), .b(new_n28_), .c(x8), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(x7), .c(new_n59_), .O(new_n167_));
  oai21  g151(.a(new_n24_), .b(x4), .c(new_n28_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n70_), .O(new_n170_));
  nor3   g154(.a(new_n84_), .b(x8), .c(x4), .O(new_n171_));
  nand2  g155(.a(x7), .b(x1), .O(new_n172_));
  nand3  g156(.a(new_n172_), .b(new_n28_), .c(x4), .O(new_n173_));
  inv1   g157(.a(new_n173_), .O(new_n174_));
  aoi21  g158(.a(new_n171_), .b(x1), .c(new_n174_), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(new_n170_), .c(new_n165_), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(x5), .O(new_n177_));
  nand3  g161(.a(new_n36_), .b(new_n28_), .c(x3), .O(new_n178_));
  nor2   g162(.a(x4), .b(new_n20_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n126_), .c(x6), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n178_), .c(new_n54_), .O(new_n181_));
  nand2  g165(.a(new_n43_), .b(x0), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n161_), .c(x5), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n181_), .c(x1), .O(new_n184_));
  nand3  g168(.a(new_n43_), .b(x4), .c(x3), .O(new_n185_));
  oai21  g169(.a(x8), .b(x4), .c(x7), .O(new_n186_));
  nand2  g170(.a(new_n186_), .b(x6), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n185_), .c(new_n20_), .O(new_n188_));
  nand2  g172(.a(x4), .b(x3), .O(new_n189_));
  oai21  g173(.a(new_n189_), .b(x1), .c(x8), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n54_), .c(x6), .O(new_n191_));
  inv1   g175(.a(new_n191_), .O(new_n192_));
  oai21  g176(.a(new_n192_), .b(new_n188_), .c(new_n18_), .O(new_n193_));
  nand3  g177(.a(new_n193_), .b(new_n184_), .c(new_n177_), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(x9), .c(new_n17_), .O(new_n195_));
  inv1   g179(.a(new_n195_), .O(z4));
  nand2  g180(.a(new_n17_), .b(new_n20_), .O(new_n197_));
  nand3  g181(.a(new_n32_), .b(x2), .c(x0), .O(new_n198_));
  aoi21  g182(.a(new_n198_), .b(new_n197_), .c(new_n156_), .O(z5));
endmodule
