...
module FAU ( 
  ...
  nand4  g49(.a(new_n59_), .b(new_n89_), .c(new_n50_), .d(new_n80_), .O(new_n96_));
  ...
  oai21  g64(.a(new_n109_), .b(new_n84_), .c(new_n110_), .O(z13));
  aoi21  g65(.a(new_n108_), .b(new_n91_), .c(new_n70_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n104_), .c(new_n94_), .d(new_n80_), .O(new_n114_));
  ...
  nand2  g78(.a(new_n99_), .b(x06), .O(new_n125_));
