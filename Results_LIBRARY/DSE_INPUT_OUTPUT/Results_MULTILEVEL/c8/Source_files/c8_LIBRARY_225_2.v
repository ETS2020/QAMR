...
module FAU ( 
  ...
  oai21  g029(.a(new_n53_), .b(x18), .c(new_n47_), .O(new_n76_));
  oai21  g030(.a(new_n53_), .b(x13), .c(new_n76_), .O(z05));
  ...
  nand2  g059(.a(x24), .b(x18), .O(new_n106_));
  ...
  oai22  g068(.a(new_n106_), .b(new_n114_), .c(x18), .d(new_n68_), .O(new_n115_));
  ...
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n48_), .c(x16), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n116_), .O(z12));
  inv1   g077(.a(x04), .O(new_n124_));
  oai22  g078(.a(new_n106_), .b(new_n124_), .c(x18), .d(new_n71_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n93_), .O(new_n126_));
  oai21  g080(.a(new_n120_), .b(new_n117_), .c(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n102_), .c(new_n61_), .O(new_n129_));
  ...
  oai22  g088(.a(new_n106_), .b(new_n133_), .c(x18), .d(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n93_), .O(new_n136_));
  and2   g090(.a(new_n129_), .b(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x18), .b(x17), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g094(.a(new_n119_), .b(new_n47_), .c(new_n73_), .O(new_n141_));
  ...
  oai21  g101(.a(new_n78_), .b(new_n93_), .c(x24), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x18), .O(new_n149_));
  inv1   g103(.a(new_n141_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n102_), .c(new_n78_), .O(new_n151_));
  nand3  g105(.a(new_n128_), .b(new_n78_), .c(new_n47_), .O(new_n152_));
  nor2   g106(.a(new_n152_), .b(new_n110_), .O(new_n153_));
  ...
  oai22  g110(.a(new_n106_), .b(new_n156_), .c(x18), .d(new_n83_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n93_), .O(new_n158_));
  nor2   g112(.a(x25), .b(x23), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n119_), .c(new_n138_), .d(new_n89_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x26), .O(new_n161_));
  nor3   g115(.a(x26), .b(x25), .c(x24), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n128_), .c(new_n109_), .d(new_n91_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n161_), .c(x18), .O(new_n164_));
  nor2   g118(.a(new_n85_), .b(new_n47_), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n164_), .c(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n158_), .O(z16));
  nand2  g121(.a(new_n162_), .b(new_n128_), .O(new_n168_));
  nand3  g122(.a(new_n109_), .b(x19), .c(new_n89_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n168_), .c(new_n53_), .d(new_n89_), .O(new_n170_));
