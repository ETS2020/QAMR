...
module FAU ( 
  ...
  nand3  g068(.a(new_n114_), .b(new_n93_), .c(x16), .O(new_n115_));
  ...
  nand2  g076(.a(new_n86_), .b(x12), .O(new_n123_));
  ...
  nand4  g082(.a(new_n128_), .b(new_n112_), .c(new_n95_), .d(new_n82_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n86_), .b(x13), .O(new_n132_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n102_), .d(new_n84_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n93_), .c(x16), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n102_), .d(new_n84_), .O(new_n149_));
  ...
  nand3  g110(.a(new_n77_), .b(new_n156_), .c(new_n126_), .O(new_n157_));
  ...
  nor2   g114(.a(new_n52_), .b(new_n82_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n93_), .c(new_n89_), .O(z17));
endmodule
