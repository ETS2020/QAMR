...
module FAU ( 
  ...
  oai21  g026(.a(x27), .b(new_n72_), .c(new_n47_), .O(new_n73_));
  nand3  g027(.a(new_n52_), .b(new_n72_), .c(x18), .O(new_n74_));
  ...
  nor2   g036(.a(x18), .b(x14), .O(new_n83_));
  ...
  oai21  g057(.a(new_n97_), .b(x16), .c(new_n103_), .O(z11));
  inv1   g058(.a(x16), .O(new_n105_));
  nand2  g059(.a(x18), .b(x03), .O(new_n106_));
  nand2  g060(.a(new_n83_), .b(x11), .O(new_n107_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n81_), .O(z13));
  ...
  nand3  g087(.a(new_n133_), .b(new_n127_), .c(new_n81_), .O(z14));
  nand2  g088(.a(new_n131_), .b(x25), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n100_), .d(new_n90_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n81_), .c(x16), .O(new_n140_));
  nand3  g094(.a(x18), .b(new_n105_), .c(x06), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n140_), .O(z15));
  nand2  g096(.a(x18), .b(x07), .O(new_n143_));
  inv1   g097(.a(x18), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(x15), .c(new_n47_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n105_), .O(new_n147_));
  nand2  g101(.a(new_n138_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n136_), .c(new_n100_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n81_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z16));
  nand4  g107(.a(new_n136_), .b(new_n78_), .c(new_n72_), .d(new_n128_), .O(new_n154_));
  nand3  g108(.a(new_n100_), .b(x19), .c(new_n91_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n91_), .O(new_n156_));
