// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:09 2020
...
module FAU ( 
  ...
  oai21  g020(.a(x27), .b(new_n66_), .c(new_n47_), .O(new_n67_));
  nand3  g021(.a(new_n52_), .b(new_n66_), .c(x18), .O(new_n68_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n84_), .O(z09));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n84_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n84_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  inv1   g065(.a(x18), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n47_), .c(x11), .O(new_n113_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n87_), .c(new_n97_), .O(new_n118_));
  ...
  nand2  g075(.a(new_n118_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n99_), .c(new_n105_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n84_), .c(x16), .O(new_n126_));
  nand3  g080(.a(x18), .b(new_n89_), .c(x04), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n126_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  nand3  g083(.a(new_n112_), .b(x13), .c(new_n47_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n89_), .O(new_n132_));
  nand3  g086(.a(new_n97_), .b(new_n51_), .c(new_n85_), .O(new_n133_));
  nand3  g087(.a(new_n66_), .b(new_n63_), .c(new_n105_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n133_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n117_), .c(new_n136_), .d(new_n85_), .O(new_n138_));
  ...
  nand3  g096(.a(new_n112_), .b(x14), .c(new_n47_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n89_), .O(new_n145_));
  nand2  g099(.a(new_n138_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n123_), .c(new_n106_), .d(new_n87_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n84_), .c(x16), .O(new_n150_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n123_), .c(new_n106_), .d(new_n87_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n154_), .c(new_n84_), .O(z16));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n123_), .c(new_n72_), .O(new_n162_));
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n85_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n52_), .d(new_n85_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n84_), .O(z17));
endmodule
