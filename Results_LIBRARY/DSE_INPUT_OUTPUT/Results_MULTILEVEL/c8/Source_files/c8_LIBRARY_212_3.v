...
module FAU ( 
  ...
  nand2  g029(.a(new_n70_), .b(new_n75_), .O(new_n76_));
  aoi21  g030(.a(new_n76_), .b(new_n74_), .c(new_n49_), .O(z07));
  nor2   g031(.a(new_n49_), .b(new_n70_), .O(z08));
  ...
  oai22  g051(.a(new_n82_), .b(new_n97_), .c(x18), .d(new_n55_), .O(new_n98_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n91_), .c(new_n102_), .d(new_n101_), .O(new_n103_));
  ...
  aoi21  g063(.a(x18), .b(x05), .c(x22), .O(new_n110_));
  nand4  g064(.a(new_n110_), .b(new_n100_), .c(new_n91_), .d(new_n102_), .O(new_n111_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n92_), .c(new_n91_), .O(new_n120_));
  ...
  aoi21  g081(.a(new_n122_), .b(new_n94_), .c(new_n127_), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n119_), .c(new_n129_), .d(new_n101_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n128_), .c(x16), .O(new_n133_));
  inv1   g087(.a(x18), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n79_), .c(x13), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n133_), .c(new_n48_), .O(z14));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n141_), .d(new_n92_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n142_), .b(new_n75_), .c(new_n69_), .d(new_n127_), .O(new_n157_));
  nand3  g111(.a(new_n141_), .b(x19), .c(new_n101_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n70_), .d(new_n101_), .O(new_n159_));
