...
module FAU ( 
  ...
  nand3  g059(.a(new_n105_), .b(new_n100_), .c(new_n48_), .O(z11));
  inv1   g060(.a(x03), .O(new_n107_));
  oai22  g061(.a(new_n84_), .b(new_n107_), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  oai22  g079(.a(new_n84_), .b(new_n125_), .c(x18), .d(new_n69_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n66_), .b(new_n131_), .c(new_n101_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n111_), .c(new_n134_), .d(new_n128_), .O(new_n136_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n120_), .c(new_n102_), .d(new_n93_), .O(new_n145_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n102_), .d(new_n93_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n48_), .c(x16), .O(new_n153_));
  inv1   g107(.a(x18), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n81_), .c(x15), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(z16));
  inv1   g110(.a(x24), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n120_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n102_), .b(x19), .c(new_n128_), .O(new_n160_));
