...
module FAU ( 
  ...
  nor2   g040(.a(x18), .b(x12), .O(new_n87_));
  ...
  nand3  g054(.a(new_n100_), .b(new_n95_), .c(new_n85_), .O(z10));
  ...
  nand2  g065(.a(new_n87_), .b(x11), .O(new_n112_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n97_), .c(new_n96_), .O(new_n117_));
  ...
  aoi21  g083(.a(new_n121_), .b(new_n99_), .c(new_n72_), .O(new_n130_));
  inv1   g084(.a(x17), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n116_), .c(new_n132_), .d(new_n131_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n130_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n129_), .c(new_n85_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  nand3  g092(.a(new_n123_), .b(x14), .c(new_n47_), .O(new_n139_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n97_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n85_), .c(x16), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n106_), .d(new_n97_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n85_), .O(z16));
  nand4  g111(.a(new_n143_), .b(new_n82_), .c(new_n77_), .d(new_n72_), .O(new_n158_));
  nand3  g112(.a(new_n106_), .b(x19), .c(new_n131_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n131_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n85_), .O(z17));
endmodule
