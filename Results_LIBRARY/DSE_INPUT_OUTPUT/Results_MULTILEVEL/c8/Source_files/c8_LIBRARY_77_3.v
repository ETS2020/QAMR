...
module FAU ( 
  ...
  aoi21  g019(.a(x27), .b(new_n64_), .c(new_n65_), .O(new_n66_));
  ...
  nand3  g042(.a(new_n88_), .b(new_n84_), .c(new_n48_), .O(z09));
  inv1   g043(.a(x01), .O(new_n90_));
  nand2  g044(.a(new_n65_), .b(x18), .O(new_n91_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n48_), .O(z11));
  ...
  inv1   g065(.a(new_n104_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n83_), .c(new_n94_), .O(new_n114_));
  ...
  oai22  g082(.a(new_n91_), .b(new_n128_), .c(x18), .d(new_n68_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n85_), .O(new_n130_));
  nand2  g084(.a(new_n114_), .b(x24), .O(new_n131_));
  nor3   g085(.a(x24), .b(x22), .c(x21), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n96_), .O(new_n133_));
  aoi21  g087(.a(new_n133_), .b(new_n131_), .c(x23), .O(new_n134_));
  nor3   g088(.a(new_n70_), .b(new_n65_), .c(x18), .O(new_n135_));
  ...
  oai21  g094(.a(new_n75_), .b(new_n85_), .c(new_n64_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x23), .O(new_n142_));
  aoi21  g096(.a(new_n132_), .b(new_n96_), .c(new_n75_), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n123_), .O(new_n145_));
  nor2   g099(.a(new_n145_), .b(new_n104_), .O(new_n146_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n64_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x23), .O(new_n154_));
  nand3  g108(.a(new_n144_), .b(new_n113_), .c(new_n96_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n123_), .c(new_n112_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n154_), .c(new_n151_), .O(z16));
  inv1   g115(.a(x17), .O(new_n162_));
  nand2  g116(.a(new_n157_), .b(new_n123_), .O(new_n163_));
  nand3  g117(.a(new_n103_), .b(x19), .c(new_n162_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n58_), .d(new_n162_), .O(new_n165_));
