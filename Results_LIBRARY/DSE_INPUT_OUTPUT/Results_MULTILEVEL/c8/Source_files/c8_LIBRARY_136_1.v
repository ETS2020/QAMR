...
module FAU ( 
  ...
  nand2  g002(.a(x18), .b(new_n48_), .O(new_n49_));
  nand3  g003(.a(new_n49_), .b(x27), .c(new_n47_), .O(new_n50_));
  inv1   g004(.a(x27), .O(new_n51_));
  nand2  g005(.a(x18), .b(new_n48_), .O(new_n52_));
  nand2  g006(.a(new_n52_), .b(new_n51_), .O(z08));
  oai21  g007(.a(z08), .b(x19), .c(new_n50_), .O(z00));
  nor2   g008(.a(x27), .b(x20), .O(new_n55_));
  aoi21  g009(.a(x27), .b(new_n48_), .c(new_n55_), .O(new_n56_));
  nand2  g010(.a(new_n55_), .b(x09), .O(new_n57_));
  oai21  g011(.a(new_n56_), .b(x18), .c(new_n57_), .O(z01));
  inv1   g012(.a(new_n52_), .O(new_n59_));
  ...
  nand3  g022(.a(new_n68_), .b(new_n66_), .c(new_n52_), .O(z03));
  ...
  nand3  g032(.a(new_n78_), .b(new_n76_), .c(new_n52_), .O(z05));
  ...
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n59_), .O(z06));
  ...
  nand3  g042(.a(new_n88_), .b(new_n86_), .c(new_n52_), .O(z07));
  ...
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n52_), .O(z09));
  nand2  g053(.a(x18), .b(x01), .O(new_n100_));
  oai21  g054(.a(x18), .b(new_n48_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n52_), .O(z10));
  inv1   g061(.a(x02), .O(new_n108_));
  nand2  g062(.a(x18), .b(x09), .O(new_n109_));
  oai22  g063(.a(new_n109_), .b(new_n108_), .c(x18), .d(new_n60_), .O(new_n110_));
  ...
  oai22  g080(.a(new_n109_), .b(new_n126_), .c(x18), .d(new_n70_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n95_), .O(new_n128_));
  nand2  g082(.a(new_n122_), .b(x23), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n105_), .c(new_n62_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n52_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n128_), .O(z13));
  inv1   g088(.a(x05), .O(new_n135_));
  oai22  g089(.a(new_n109_), .b(new_n135_), .c(x18), .d(new_n77_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n95_), .O(new_n137_));
  nand3  g091(.a(new_n103_), .b(new_n91_), .c(new_n90_), .O(new_n138_));
  nand3  g092(.a(new_n72_), .b(new_n65_), .c(new_n62_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n138_), .c(x24), .O(new_n140_));
  nor2   g094(.a(x20), .b(x19), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n141_), .d(new_n90_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n109_), .b(new_n147_), .c(x18), .d(new_n80_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n95_), .O(new_n149_));
  nand2  g103(.a(new_n143_), .b(x25), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n130_), .c(new_n112_), .d(new_n93_), .O(new_n152_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n130_), .c(new_n112_), .d(new_n93_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n52_), .O(z16));
  nand4  g118(.a(new_n130_), .b(new_n85_), .c(new_n82_), .d(new_n75_), .O(new_n165_));
  nand3  g119(.a(new_n112_), .b(x19), .c(new_n90_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n51_), .d(new_n90_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x16), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n52_), .O(z17));
endmodule
