// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:11 2020
...
module FAU ( 
  ...
  oai21  g023(.a(x27), .b(new_n69_), .c(new_n48_), .O(new_n70_));
  nand3  g024(.a(new_n58_), .b(new_n69_), .c(x18), .O(new_n71_));
  nand2  g025(.a(new_n71_), .b(new_n70_), .O(z05));
  ...
  nand2  g034(.a(new_n58_), .b(new_n80_), .O(new_n81_));
  aoi21  g035(.a(new_n81_), .b(new_n79_), .c(new_n49_), .O(z07));
  inv1   g036(.a(new_n49_), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n58_), .O(z08));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n83_), .O(z09));
  ...
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n83_), .O(z10));
  nand2  g056(.a(x18), .b(x02), .O(new_n103_));
  inv1   g057(.a(x18), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  oai21  g059(.a(new_n105_), .b(new_n55_), .c(new_n103_), .O(new_n106_));
  ...
  oai21  g063(.a(new_n100_), .b(new_n57_), .c(new_n109_), .O(new_n110_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n88_), .c(new_n98_), .O(new_n118_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n100_), .c(new_n57_), .O(new_n127_));
  ...
  nand3  g084(.a(new_n98_), .b(new_n86_), .c(new_n85_), .O(new_n131_));
  inv1   g085(.a(x22), .O(new_n132_));
  nand3  g086(.a(new_n66_), .b(new_n132_), .c(new_n57_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n131_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n117_), .c(new_n135_), .d(new_n85_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n83_), .c(x16), .O(new_n139_));
  nand3  g093(.a(x18), .b(new_n90_), .c(x05), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n139_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n104_), .b(x14), .c(new_n48_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n90_), .O(new_n145_));
  nand2  g099(.a(new_n137_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n126_), .c(new_n108_), .d(new_n88_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n126_), .c(new_n108_), .d(new_n88_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n126_), .b(new_n80_), .c(new_n75_), .d(new_n69_), .O(new_n161_));
  nand3  g115(.a(new_n108_), .b(x19), .c(new_n85_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n58_), .d(new_n85_), .O(new_n163_));
