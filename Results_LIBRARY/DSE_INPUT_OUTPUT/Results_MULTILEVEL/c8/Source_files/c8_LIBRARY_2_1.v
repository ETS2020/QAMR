...
module FAU ( 
  ...
  nand3  g064(.a(new_n110_), .b(new_n104_), .c(new_n84_), .O(z11));
  nand3  g065(.a(x18), .b(x03), .c(x02), .O(new_n112_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n84_), .O(z13));
  nand3  g083(.a(x18), .b(x05), .c(x02), .O(new_n130_));
  ...
  nand3  g087(.a(new_n66_), .b(new_n133_), .c(new_n105_), .O(new_n134_));
  ...
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n84_), .O(z15));
  nand3  g104(.a(x18), .b(x07), .c(x02), .O(new_n151_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n125_), .c(new_n107_), .d(new_n97_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n125_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n160_));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n98_), .O(new_n161_));
