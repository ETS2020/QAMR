...
module FAU ( 
  ...
  oai21  g32(.a(x18), .b(x16), .c(new_n57_), .O(z08));
  ...
  oai21  g41(.a(new_n87_), .b(new_n80_), .c(new_n85_), .O(z09));
  ...
  oai21  g47(.a(new_n87_), .b(new_n89_), .c(new_n93_), .O(z10));
  inv1   g48(.a(x18), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(x02), .c(new_n86_), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n81_), .O(new_n98_));
  nand4  g52(.a(new_n56_), .b(new_n90_), .c(new_n82_), .d(new_n81_), .O(new_n99_));
  ...
  oai21  g56(.a(new_n95_), .b(x03), .c(new_n86_), .O(new_n103_));
  ...
  oai21  g61(.a(new_n107_), .b(new_n86_), .c(new_n103_), .O(z12));
  oai21  g62(.a(new_n95_), .b(x04), .c(new_n86_), .O(new_n109_));
  ...
  oai21  g66(.a(new_n95_), .b(x05), .c(new_n86_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n92_), .c(new_n70_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n105_), .c(new_n97_), .d(new_n81_), .O(new_n116_));
  ...
  oai21  g73(.a(new_n95_), .b(x06), .c(new_n86_), .O(new_n120_));
  inv1   g74(.a(x22), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n70_), .c(new_n65_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n100_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n86_), .c(new_n120_), .O(z15));
  oai21  g80(.a(new_n95_), .b(x07), .c(new_n86_), .O(new_n127_));
