...
module FAU ( 
  ...
  oai21  g043(.a(x16), .b(x08), .c(new_n89_), .O(new_n90_));
  inv1   g044(.a(x17), .O(new_n91_));
  nor2   g045(.a(new_n51_), .b(new_n91_), .O(new_n92_));
  nor2   g046(.a(x19), .b(x17), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  nand3  g048(.a(x18), .b(new_n47_), .c(x00), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(z09));
  nand2  g050(.a(x18), .b(x01), .O(new_n97_));
  oai21  g051(.a(x18), .b(new_n55_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n47_), .O(new_n99_));
  nand3  g053(.a(new_n57_), .b(new_n51_), .c(new_n91_), .O(new_n100_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n93_), .c(new_n57_), .O(new_n118_));
  ...
  nand3  g086(.a(new_n72_), .b(new_n67_), .c(new_n62_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n100_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n117_), .c(new_n135_), .d(new_n91_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n108_), .d(new_n93_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n108_), .d(new_n93_), .O(new_n155_));
  ...
  nand4  g113(.a(new_n124_), .b(new_n85_), .c(new_n80_), .d(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n91_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n91_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(x18), .c(x16), .O(new_n163_));
