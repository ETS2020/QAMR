...
module FAU ( 
  ...
  nand2  g033(.a(new_n79_), .b(new_n77_), .O(z07));
  nand2  g034(.a(new_n76_), .b(new_n52_), .O(z08));
  inv1   g035(.a(x16), .O(new_n82_));
  inv1   g036(.a(x00), .O(new_n83_));
  nand2  g037(.a(x26), .b(x18), .O(new_n84_));
  oai22  g038(.a(new_n84_), .b(new_n83_), .c(x18), .d(new_n49_), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  xnor2a g040(.a(x19), .b(x17), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n76_), .c(x16), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n86_), .O(z09));
  inv1   g043(.a(x01), .O(new_n90_));
  oai22  g044(.a(new_n84_), .b(new_n90_), .c(x18), .d(new_n55_), .O(new_n91_));
  ...
  nand3  g049(.a(new_n93_), .b(new_n51_), .c(new_n95_), .O(new_n96_));
  oai21  g050(.a(new_n94_), .b(new_n93_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n76_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n92_), .O(z10));
  ...
  nand2  g059(.a(new_n105_), .b(new_n94_), .O(new_n106_));
  oai21  g060(.a(new_n104_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n76_), .O(z11));
  inv1   g063(.a(x03), .O(new_n110_));
  oai22  g064(.a(new_n84_), .b(new_n110_), .c(x18), .d(new_n61_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n82_), .O(new_n112_));
  ...
  oai22  g073(.a(new_n84_), .b(new_n119_), .c(x18), .d(new_n66_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n82_), .O(new_n121_));
  nand2  g075(.a(new_n115_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n104_), .c(new_n103_), .O(new_n124_));
  ...
  oai22  g082(.a(new_n84_), .b(new_n128_), .c(x18), .d(new_n69_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n82_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n63_), .c(new_n103_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n96_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n134_), .d(new_n95_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n76_), .c(x16), .O(new_n138_));
  ...
  nand2  g095(.a(new_n141_), .b(new_n82_), .O(new_n142_));
  nand2  g096(.a(new_n136_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n123_), .c(new_n105_), .d(new_n94_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n76_), .O(z15));
  ...
  nand3  g105(.a(new_n134_), .b(new_n95_), .c(x16), .O(new_n152_));
  nand3  g106(.a(new_n144_), .b(new_n114_), .c(new_n131_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n152_), .c(new_n47_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n78_), .O(new_n155_));
  nand3  g109(.a(new_n145_), .b(x26), .c(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n151_), .O(z16));
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n95_), .O(new_n158_));
  inv1   g112(.a(x24), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n123_), .c(new_n159_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n158_), .c(new_n52_), .d(new_n95_), .O(new_n162_));
