...
module FAU ( 
  ...
  oai21  g024(.a(new_n70_), .b(new_n51_), .c(new_n47_), .O(new_n71_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n98_), .d(new_n81_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n79_), .c(x16), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n138_), .O(z15));
  inv1   g099(.a(x15), .O(new_n146_));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  oai21  g101(.a(new_n76_), .b(new_n146_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n73_), .O(new_n149_));
  nand2  g103(.a(new_n142_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n98_), .d(new_n81_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n79_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nand4  g109(.a(new_n140_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n156_));
  nand3  g110(.a(new_n98_), .b(x19), .c(new_n128_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n47_), .d(new_n128_), .O(new_n158_));
