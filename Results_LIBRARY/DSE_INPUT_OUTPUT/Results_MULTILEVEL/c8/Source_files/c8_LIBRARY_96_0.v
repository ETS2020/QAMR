...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x09), .O(new_n48_));
  ...
  oai21  g006(.a(x27), .b(new_n52_), .c(new_n51_), .O(new_n53_));
  ...
  aoi21  g016(.a(new_n62_), .b(new_n59_), .c(new_n48_), .O(z03));
  ...
  nand2  g036(.a(new_n82_), .b(new_n61_), .O(z08));
  inv1   g037(.a(x16), .O(new_n84_));
  nand2  g038(.a(x18), .b(x00), .O(new_n85_));
  nand2  g039(.a(new_n52_), .b(x09), .O(new_n86_));
  ...
  oai21  g068(.a(x18), .b(new_n58_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n84_), .O(new_n116_));
  aoi21  g070(.a(new_n52_), .b(new_n51_), .c(x22), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n107_), .c(new_n95_), .d(new_n98_), .O(new_n118_));
  ...
  nand2  g089(.a(new_n135_), .b(new_n84_), .O(new_n136_));
  aoi21  g090(.a(new_n129_), .b(new_n108_), .c(new_n71_), .O(new_n137_));
  nand4  g091(.a(new_n71_), .b(new_n66_), .c(new_n60_), .d(new_n107_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n99_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n137_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n136_), .c(new_n82_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n52_), .b(x14), .c(x09), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n84_), .O(new_n145_));
  nor2   g099(.a(x23), .b(x22), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n109_), .d(new_n96_), .O(new_n148_));
  oai21  g102(.a(new_n139_), .b(new_n76_), .c(new_n148_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n82_), .c(x16), .O(new_n150_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n146_), .c(new_n71_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n110_), .c(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n154_), .c(new_n82_), .O(z16));
  nand3  g114(.a(new_n109_), .b(x19), .c(new_n97_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n61_), .d(new_n97_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n82_), .c(x16), .O(new_n163_));
