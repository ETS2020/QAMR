...
module FAU ( 
  ...
  aoi22  g017(.a(new_n63_), .b(new_n61_), .c(new_n52_), .d(x18), .O(z02));
  ...
  nand3  g040(.a(new_n48_), .b(new_n52_), .c(new_n86_), .O(new_n87_));
  oai21  g041(.a(new_n85_), .b(x15), .c(new_n87_), .O(z07));
  inv1   g042(.a(new_n85_), .O(z08));
  ...
  nor2   g055(.a(new_n92_), .b(new_n55_), .O(new_n102_));
  ...
  oai22  g061(.a(new_n107_), .b(new_n106_), .c(x18), .d(new_n60_), .O(new_n108_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n126_), .c(new_n53_), .O(z13));
  ...
  oai22  g097(.a(new_n107_), .b(new_n143_), .c(x18), .d(new_n82_), .O(new_n144_));
  ...
  nand3  g110(.a(new_n137_), .b(new_n90_), .c(x16), .O(new_n157_));
  nand3  g111(.a(new_n148_), .b(new_n119_), .c(new_n70_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n157_), .c(new_n86_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n52_), .O(new_n160_));
  nand3  g114(.a(new_n149_), .b(x26), .c(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n160_), .c(new_n156_), .O(z16));
  nand2  g116(.a(z08), .b(x17), .O(new_n163_));
  nor2   g117(.a(x18), .b(x17), .O(new_n164_));
  nand2  g118(.a(new_n110_), .b(x19), .O(new_n165_));
  inv1   g119(.a(new_n165_), .O(new_n166_));
  nor3   g120(.a(x26), .b(x25), .c(x24), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n166_), .c(new_n164_), .d(new_n147_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n163_), .c(new_n94_), .O(z17));
endmodule
