...
module FAU ( 
  ...
  aoi21  g021(.a(x27), .b(new_n67_), .c(new_n53_), .O(new_n68_));
  ...
  aoi21  g027(.a(new_n73_), .b(new_n71_), .c(new_n53_), .O(z06));
  ...
  nand2  g034(.a(new_n80_), .b(new_n47_), .O(z08));
  inv1   g035(.a(x17), .O(new_n82_));
  nand3  g036(.a(new_n49_), .b(x18), .c(new_n82_), .O(new_n83_));
  oai21  g037(.a(new_n49_), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g042(.a(x19), .b(new_n48_), .O(new_n89_));
  ...
  oai21  g061(.a(new_n107_), .b(new_n86_), .c(x19), .O(new_n108_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n106_), .O(z11));
  nand2  g069(.a(x18), .b(x03), .O(new_n116_));
  oai21  g070(.a(x18), .b(new_n59_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n86_), .O(new_n118_));
  oai21  g072(.a(new_n61_), .b(new_n86_), .c(x19), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n48_), .O(new_n120_));
  inv1   g074(.a(new_n112_), .O(new_n121_));
  nor2   g075(.a(new_n121_), .b(new_n61_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  nor3   g078(.a(new_n124_), .b(new_n101_), .c(x20), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n120_), .c(new_n118_), .O(z12));
  nand2  g081(.a(x18), .b(x04), .O(new_n128_));
  oai21  g082(.a(new_n89_), .b(new_n64_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n86_), .O(new_n130_));
  nand2  g084(.a(new_n123_), .b(new_n96_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n110_), .c(new_n107_), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n132_), .c(new_n48_), .O(new_n135_));
  inv1   g089(.a(x23), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n49_), .O(new_n137_));
  ...
  oai21  g094(.a(new_n89_), .b(new_n67_), .c(new_n140_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n86_), .O(new_n142_));
  nand3  g096(.a(new_n133_), .b(new_n96_), .c(new_n107_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x24), .O(new_n144_));
  inv1   g098(.a(x24), .O(new_n145_));
  nand4  g099(.a(new_n123_), .b(new_n110_), .c(new_n145_), .d(new_n136_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n144_), .c(new_n48_), .O(new_n147_));
  nor2   g101(.a(new_n145_), .b(new_n49_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n147_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n142_), .O(z14));
  nand2  g104(.a(x18), .b(x06), .O(new_n151_));
  oai21  g105(.a(x18), .b(new_n70_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n86_), .O(new_n153_));
  oai21  g107(.a(new_n72_), .b(new_n86_), .c(x19), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n48_), .O(new_n155_));
  nand2  g109(.a(new_n146_), .b(x25), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n133_), .c(new_n121_), .O(new_n158_));
  ...
  oai21  g116(.a(new_n89_), .b(new_n75_), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n86_), .O(new_n164_));
  nand4  g118(.a(new_n157_), .b(new_n133_), .c(new_n111_), .d(new_n82_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x26), .O(new_n166_));
  nor3   g120(.a(x26), .b(x25), .c(x24), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n133_), .c(new_n111_), .d(new_n100_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n166_), .c(new_n48_), .O(new_n169_));
  nor2   g123(.a(new_n77_), .b(new_n49_), .O(new_n170_));
  oai21  g124(.a(new_n170_), .b(new_n169_), .c(x16), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n164_), .O(z16));
  nand3  g126(.a(new_n80_), .b(x27), .c(x17), .O(new_n173_));
  nor2   g127(.a(new_n49_), .b(x17), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n167_), .c(new_n133_), .d(new_n111_), .O(new_n175_));
  aoi21  g129(.a(new_n175_), .b(new_n173_), .c(new_n86_), .O(z17));
endmodule
