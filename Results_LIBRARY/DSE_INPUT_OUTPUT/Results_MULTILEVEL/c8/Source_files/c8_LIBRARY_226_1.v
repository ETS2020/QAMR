...
module FAU ( 
  ...
  aoi21  g038(.a(new_n84_), .b(new_n82_), .c(new_n70_), .O(z06));
  ...
  nor2   g051(.a(new_n94_), .b(new_n55_), .O(new_n98_));
  ...
  oai21  g057(.a(x18), .b(x10), .c(new_n52_), .O(new_n104_));
  nor2   g058(.a(x20), .b(x19), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  nand4  g060(.a(new_n60_), .b(new_n55_), .c(new_n47_), .d(new_n92_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  aoi21  g062(.a(new_n106_), .b(x21), .c(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n52_), .c(new_n104_), .O(z11));
  oai21  g064(.a(x18), .b(x11), .c(new_n52_), .O(new_n111_));
  nand2  g065(.a(new_n107_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n94_), .c(new_n55_), .O(new_n114_));
  and2   g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n52_), .c(new_n111_), .O(z12));
  oai21  g070(.a(x18), .b(x12), .c(new_n52_), .O(new_n117_));
  nor3   g071(.a(x23), .b(x22), .c(x21), .O(new_n118_));
  aoi22  g072(.a(new_n118_), .b(new_n99_), .c(new_n114_), .d(x23), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n52_), .c(new_n117_), .O(z13));
  aoi21  g074(.a(new_n118_), .b(new_n99_), .c(new_n76_), .O(new_n121_));
  ...
  nand4  g081(.a(new_n83_), .b(new_n76_), .c(new_n73_), .d(new_n65_), .O(new_n128_));
  ...
  oai21  g085(.a(new_n130_), .b(new_n52_), .c(new_n131_), .O(z15));
  ...
  nand2  g095(.a(new_n101_), .b(x15), .O(new_n142_));
