...
module FAU ( 
  ...
  nand2  g037(.a(new_n75_), .b(x18), .O(new_n84_));
  ...
  oai22  g055(.a(new_n84_), .b(new_n101_), .c(x18), .d(new_n58_), .O(new_n102_));
  ...
  oai22  g074(.a(new_n84_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n105_), .c(new_n71_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n115_), .c(new_n96_), .d(new_n95_), .O(new_n134_));
  ...
  nand2  g092(.a(new_n74_), .b(x14), .O(new_n139_));
  oai21  g093(.a(new_n84_), .b(new_n138_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n82_), .O(new_n141_));
  nand3  g095(.a(new_n134_), .b(x25), .c(new_n74_), .O(new_n142_));
  ...
  oai21  g106(.a(new_n152_), .b(new_n82_), .c(new_n74_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x25), .O(new_n154_));
  nand2  g108(.a(new_n134_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n143_), .c(new_n106_), .d(new_n94_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n143_), .b(new_n152_), .c(new_n75_), .d(new_n71_), .O(new_n161_));
  nand3  g115(.a(new_n106_), .b(x19), .c(new_n95_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n95_), .O(new_n163_));
