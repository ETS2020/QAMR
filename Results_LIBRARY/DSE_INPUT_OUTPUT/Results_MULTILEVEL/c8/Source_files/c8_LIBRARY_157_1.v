...
module FAU ( 
  ...
  nor2   g039(.a(x27), .b(x26), .O(new_n86_));
  aoi21  g040(.a(x27), .b(new_n47_), .c(new_n86_), .O(new_n87_));
  nand2  g041(.a(new_n86_), .b(x15), .O(new_n88_));
  oai21  g042(.a(new_n87_), .b(x18), .c(new_n88_), .O(z07));
  ...
  nor2   g056(.a(new_n93_), .b(new_n58_), .O(new_n103_));
  ...
  nand2  g069(.a(x18), .b(x15), .O(new_n116_));
  oai22  g070(.a(new_n116_), .b(new_n115_), .c(x18), .d(new_n66_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n95_), .O(new_n118_));
  nand2  g072(.a(new_n111_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n93_), .c(new_n58_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n116_), .b(new_n125_), .c(x18), .d(new_n73_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n95_), .O(new_n127_));
  nand2  g081(.a(new_n121_), .b(x23), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n104_), .c(new_n61_), .O(new_n130_));
  ...
  oai22  g088(.a(new_n116_), .b(new_n134_), .c(x18), .d(new_n76_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n95_), .O(new_n136_));
  nand2  g090(.a(new_n130_), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n120_), .b(new_n104_), .c(new_n78_), .d(new_n71_), .O(new_n138_));
  ...
  oai22  g096(.a(new_n116_), .b(new_n142_), .c(x18), .d(new_n83_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n95_), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n129_), .c(new_n110_), .d(new_n93_), .O(new_n147_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n129_), .c(new_n110_), .d(new_n93_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(x16), .c(new_n152_), .O(new_n157_));
  inv1   g111(.a(x18), .O(new_n158_));
  nand3  g112(.a(new_n156_), .b(new_n158_), .c(x16), .O(new_n159_));
  oai21  g113(.a(new_n157_), .b(new_n47_), .c(new_n159_), .O(z16));
  nand2  g114(.a(new_n154_), .b(new_n129_), .O(new_n161_));
  nand3  g115(.a(new_n110_), .b(x19), .c(new_n91_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n53_), .d(new_n91_), .O(new_n163_));
