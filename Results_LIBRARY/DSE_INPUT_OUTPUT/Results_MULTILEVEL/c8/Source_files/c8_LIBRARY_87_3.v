...
module FAU ( 
  ...
  nand3  g066(.a(new_n112_), .b(new_n106_), .c(new_n48_), .O(z11));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n88_), .c(new_n63_), .O(new_n117_));
  ...
  inv1   g081(.a(x18), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n90_), .c(x12), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(z13));
  ...
  aoi21  g087(.a(new_n124_), .b(new_n108_), .c(new_n73_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n118_), .c(new_n99_), .d(new_n85_), .O(new_n136_));
  ...
  oai22  g104(.a(new_n150_), .b(x04), .c(x18), .d(new_n81_), .O(new_n151_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n144_), .c(new_n73_), .O(new_n160_));
