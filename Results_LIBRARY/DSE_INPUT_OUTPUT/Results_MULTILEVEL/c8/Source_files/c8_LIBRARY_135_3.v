...
module FAU ( 
  ...
  nand2  g077(.a(new_n123_), .b(x12), .O(new_n124_));
  ...
  nand2  g086(.a(new_n123_), .b(x13), .O(new_n133_));
  ...
  nand2  g095(.a(new_n123_), .b(x14), .O(new_n142_));
  ...
  nand2  g103(.a(new_n123_), .b(x15), .O(new_n150_));
