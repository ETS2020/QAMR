...
module FAU ( 
  ...
  oai21  g54(.a(new_n90_), .b(x02), .c(new_n100_), .O(new_n101_));
  nor2   g55(.a(x20), .b(x19), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nand4  g57(.a(new_n59_), .b(new_n94_), .c(new_n50_), .d(new_n86_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n100_), .c(new_n101_), .O(z11));
  oai21  g61(.a(new_n90_), .b(x03), .c(new_n100_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n112_), .b(new_n100_), .c(new_n108_), .O(z12));
  ...
  aoi21  g72(.a(new_n114_), .b(new_n96_), .c(new_n74_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n110_), .c(new_n102_), .d(new_n86_), .O(new_n121_));
