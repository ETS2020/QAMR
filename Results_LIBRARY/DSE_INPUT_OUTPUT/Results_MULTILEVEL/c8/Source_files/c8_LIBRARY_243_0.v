// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:50 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x01), .O(new_n48_));
  ...
  inv1   g041(.a(x01), .O(new_n88_));
  aoi21  g042(.a(new_n80_), .b(new_n51_), .c(x16), .O(new_n89_));
  inv1   g043(.a(x20), .O(new_n90_));
  nor2   g044(.a(x19), .b(x17), .O(new_n91_));
  inv1   g045(.a(x17), .O(new_n92_));
  inv1   g046(.a(x19), .O(new_n93_));
  nand3  g047(.a(new_n90_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  oai21  g048(.a(new_n91_), .b(new_n90_), .c(new_n94_), .O(new_n95_));
  aoi21  g049(.a(new_n95_), .b(x16), .c(new_n89_), .O(new_n96_));
  nand3  g050(.a(new_n95_), .b(x18), .c(x16), .O(new_n97_));
  oai21  g051(.a(new_n96_), .b(new_n88_), .c(new_n97_), .O(z10));
  nand2  g052(.a(x18), .b(x02), .O(new_n99_));
  nand3  g053(.a(new_n80_), .b(x10), .c(x01), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n78_), .O(new_n102_));
  inv1   g056(.a(x21), .O(new_n103_));
  inv1   g057(.a(new_n94_), .O(new_n104_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n84_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n102_), .O(z11));
  nand2  g063(.a(x18), .b(x03), .O(new_n110_));
  oai21  g064(.a(x18), .b(new_n57_), .c(new_n110_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n78_), .O(new_n112_));
  aoi21  g066(.a(new_n80_), .b(new_n88_), .c(x22), .O(new_n113_));
  nand4  g067(.a(new_n113_), .b(new_n103_), .c(new_n90_), .d(new_n93_), .O(new_n114_));
  nand2  g068(.a(new_n106_), .b(x22), .O(new_n115_));
  oai21  g069(.a(new_n114_), .b(x17), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n84_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  nand3  g073(.a(new_n80_), .b(x12), .c(x01), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n78_), .O(new_n122_));
  inv1   g076(.a(x22), .O(new_n123_));
  nand4  g077(.a(new_n91_), .b(new_n123_), .c(new_n103_), .d(new_n90_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x23), .O(new_n125_));
  nor3   g079(.a(x23), .b(x22), .c(x21), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n104_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n84_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n122_), .O(z13));
  nand2  g084(.a(x18), .b(x05), .O(new_n131_));
  oai21  g085(.a(x18), .b(new_n63_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n78_), .O(new_n133_));
  aoi21  g087(.a(new_n126_), .b(new_n104_), .c(new_n65_), .O(new_n134_));
  inv1   g088(.a(x23), .O(new_n135_));
  nand4  g089(.a(new_n65_), .b(new_n135_), .c(new_n123_), .d(new_n103_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n94_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n134_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n133_), .c(new_n84_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  oai21  g094(.a(x18), .b(new_n69_), .c(new_n140_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n78_), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n105_), .d(new_n91_), .O(new_n145_));
  oai21  g099(.a(new_n137_), .b(new_n71_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n84_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n80_), .b(x15), .c(x01), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n78_), .O(new_n152_));
  nand2  g106(.a(new_n145_), .b(x26), .O(new_n153_));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n143_), .c(new_n65_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n106_), .c(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n84_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n92_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n66_), .d(new_n92_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n84_), .O(z17));
endmodule
