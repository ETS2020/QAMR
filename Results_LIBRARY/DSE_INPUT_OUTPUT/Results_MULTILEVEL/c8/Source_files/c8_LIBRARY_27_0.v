...
module FAU ( 
  ...
  nand3  g046(.a(new_n92_), .b(x09), .c(x06), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n86_), .O(new_n95_));
  nand3  g049(.a(new_n53_), .b(new_n82_), .c(new_n81_), .O(new_n96_));
  oai21  g050(.a(new_n84_), .b(new_n53_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n80_), .O(z11));
  ...
  nand3  g069(.a(new_n115_), .b(new_n84_), .c(new_n53_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n92_), .b(x12), .c(x06), .O(new_n121_));
  ...
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n80_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n92_), .b(x15), .c(x06), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n86_), .O(new_n154_));
  nand2  g108(.a(new_n147_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n125_), .c(new_n105_), .d(new_n84_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n125_), .c(new_n68_), .O(new_n162_));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n81_), .O(new_n163_));
