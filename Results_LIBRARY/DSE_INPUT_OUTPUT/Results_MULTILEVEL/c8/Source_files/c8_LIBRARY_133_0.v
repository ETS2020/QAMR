...
module FAU ( 
  ...
  nand2  g008(.a(new_n54_), .b(x21), .O(new_n55_));
  nand2  g009(.a(new_n55_), .b(x18), .O(new_n56_));
  inv1   g010(.a(x21), .O(new_n57_));
  nand3  g011(.a(new_n54_), .b(new_n57_), .c(x10), .O(new_n58_));
  oai21  g012(.a(new_n56_), .b(x10), .c(new_n58_), .O(z02));
  ...
  nand2  g039(.a(new_n85_), .b(x10), .O(new_n86_));
  oai21  g040(.a(new_n86_), .b(new_n47_), .c(new_n84_), .O(new_n87_));
  ...
  oai21  g056(.a(new_n85_), .b(x02), .c(new_n83_), .O(new_n103_));
  ...
  nand3  g064(.a(new_n85_), .b(x11), .c(x10), .O(new_n111_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n96_), .c(new_n95_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n81_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n113_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  nand3  g074(.a(new_n85_), .b(x12), .c(x10), .O(new_n121_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n115_), .c(new_n98_), .d(new_n97_), .O(new_n136_));
  ...
  nand3  g094(.a(new_n85_), .b(x14), .c(x10), .O(new_n141_));
  ...
  nand3  g105(.a(new_n85_), .b(x15), .c(x10), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n145_), .c(new_n105_), .d(new_n96_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n145_), .b(new_n78_), .c(new_n73_), .d(new_n133_), .O(new_n161_));
  nand3  g115(.a(new_n105_), .b(x19), .c(new_n97_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n54_), .d(new_n97_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n81_), .O(z17));
endmodule
