...
module FAU ( 
  ...
  nand2  g072(.a(new_n93_), .b(x12), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n118_), .c(new_n113_), .O(z13));
  oai21  g074(.a(x16), .b(x05), .c(x18), .O(new_n121_));
  aoi21  g075(.a(new_n115_), .b(new_n91_), .c(new_n71_), .O(new_n122_));
  ...
  nand2  g082(.a(new_n93_), .b(x13), .O(new_n129_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n97_), .d(new_n89_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n106_), .c(x16), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n135_), .c(new_n97_), .d(new_n89_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n93_), .b(x15), .O(new_n147_));
  ...
  aoi21  g112(.a(new_n158_), .b(new_n106_), .c(new_n84_), .O(z17));
endmodule
