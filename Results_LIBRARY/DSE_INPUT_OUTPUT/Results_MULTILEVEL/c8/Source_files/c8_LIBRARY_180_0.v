...
module FAU ( 
  ...
  aoi21  g20(.a(x27), .b(new_n66_), .c(new_n47_), .O(new_n67_));
  ...
  inv1   g28(.a(new_n47_), .O(new_n75_));
  nand2  g29(.a(new_n75_), .b(new_n51_), .O(z08));
  inv1   g30(.a(x17), .O(new_n77_));
  nor2   g31(.a(new_n50_), .b(new_n77_), .O(new_n78_));
  ...
  oai21  g39(.a(new_n81_), .b(x01), .c(new_n85_), .O(new_n86_));
  inv1   g40(.a(x20), .O(new_n87_));
  nor2   g41(.a(new_n79_), .b(new_n87_), .O(new_n88_));
  ...
  nand2  g46(.a(new_n92_), .b(new_n77_), .O(new_n93_));
  inv1   g47(.a(x21), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n87_), .c(new_n50_), .d(new_n77_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n82_), .b(x02), .O(new_n98_));
  oai21  g52(.a(new_n97_), .b(new_n85_), .c(new_n98_), .O(z11));
  oai21  g53(.a(new_n81_), .b(x03), .c(new_n85_), .O(new_n100_));
  nand2  g54(.a(new_n95_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n79_), .c(new_n87_), .O(new_n103_));
  and2   g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n85_), .c(new_n100_), .O(z12));
  oai21  g59(.a(new_n81_), .b(x04), .c(new_n85_), .O(new_n106_));
  nor3   g60(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n89_), .c(new_n103_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n85_), .c(new_n106_), .O(z13));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n89_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n102_), .c(new_n92_), .d(new_n77_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g69(.a(new_n82_), .b(x05), .O(new_n116_));
  ...
  aoi22  g76(.a(new_n122_), .b(new_n96_), .c(new_n113_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n82_), .b(x06), .O(new_n124_));
  ...
  nand2  g88(.a(new_n82_), .b(x07), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n110_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n77_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n51_), .d(new_n77_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n75_), .O(z17));
endmodule
