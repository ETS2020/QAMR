...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x10), .O(new_n48_));
  ...
  oai21  g013(.a(x27), .b(new_n59_), .c(new_n58_), .O(new_n60_));
  nand2  g014(.a(new_n55_), .b(new_n59_), .O(new_n61_));
  oai21  g015(.a(new_n61_), .b(x18), .c(new_n60_), .O(z02));
  ...
  nand2  g038(.a(x18), .b(new_n58_), .O(new_n85_));
  ...
  nor2   g048(.a(new_n94_), .b(new_n54_), .O(new_n95_));
  nor3   g049(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n48_), .O(z10));
  oai21  g052(.a(x18), .b(new_n83_), .c(x10), .O(new_n99_));
  nor2   g053(.a(x21), .b(x20), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  oai21  g055(.a(new_n96_), .b(new_n59_), .c(new_n101_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(x16), .O(new_n103_));
  nand3  g057(.a(x18), .b(new_n83_), .c(x02), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(z11));
  inv1   g059(.a(x03), .O(new_n106_));
  oai22  g060(.a(new_n85_), .b(new_n106_), .c(x18), .d(new_n63_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n83_), .O(new_n108_));
  nand2  g062(.a(new_n101_), .b(x22), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n94_), .c(new_n54_), .O(new_n111_));
  ...
  oai22  g069(.a(new_n85_), .b(new_n115_), .c(x18), .d(new_n66_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n83_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x23), .O(new_n118_));
  nor2   g072(.a(x23), .b(x22), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n96_), .c(new_n59_), .O(new_n120_));
  ...
  oai22  g102(.a(new_n85_), .b(new_n148_), .c(x18), .d(new_n77_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n119_), .c(new_n100_), .d(new_n94_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n48_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z16));
  inv1   g110(.a(x24), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n119_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n100_), .b(x19), .c(new_n127_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n127_), .O(new_n161_));
