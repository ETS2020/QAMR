...
module FAU ( 
  ...
  aoi21  g009(.a(x27), .b(new_n55_), .c(new_n52_), .O(new_n56_));
  ...
  aoi21  g019(.a(new_n65_), .b(new_n62_), .c(new_n52_), .O(z04));
  ...
  nand3  g041(.a(new_n48_), .b(x09), .c(x08), .O(new_n88_));
  ...
  nand3  g053(.a(new_n48_), .b(x10), .c(x08), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n79_), .O(new_n102_));
  ...
  nand3  g064(.a(new_n48_), .b(x11), .c(x08), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n79_), .O(new_n113_));
  ...
  oai21  g074(.a(x18), .b(new_n61_), .c(new_n120_), .O(new_n121_));
  ...
  nand2  g084(.a(new_n130_), .b(new_n79_), .O(new_n131_));
  inv1   g085(.a(x24), .O(new_n132_));
  aoi21  g086(.a(new_n124_), .b(new_n104_), .c(new_n132_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n115_), .c(new_n94_), .d(new_n93_), .O(new_n135_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n143_), .c(new_n105_), .d(new_n92_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n83_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n143_), .c(new_n132_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n93_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n64_), .d(new_n93_), .O(new_n162_));
