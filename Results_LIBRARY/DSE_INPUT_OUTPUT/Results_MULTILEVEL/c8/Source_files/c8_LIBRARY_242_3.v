...
module FAU ( 
  ...
  nand2  g028(.a(new_n52_), .b(new_n73_), .O(new_n75_));
  ...
  nand2  g036(.a(x18), .b(new_n72_), .O(new_n83_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n100_), .c(new_n47_), .O(z11));
  inv1   g060(.a(x03), .O(new_n107_));
  oai22  g061(.a(new_n83_), .b(new_n107_), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n47_), .c(x16), .O(new_n114_));
  ...
  nand2  g071(.a(new_n117_), .b(new_n81_), .O(new_n118_));
  ...
  oai22  g079(.a(new_n83_), .b(new_n125_), .c(x18), .d(new_n69_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n81_), .O(new_n127_));
  inv1   g081(.a(x17), .O(new_n128_));
  nand3  g082(.a(new_n92_), .b(new_n51_), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n120_), .c(new_n102_), .d(new_n93_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n47_), .c(x16), .O(new_n154_));
  ...
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n128_), .O(new_n160_));
