...
module FAU ( 
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n60_), .O(z05));
  ...
  nor2   g042(.a(new_n60_), .b(new_n48_), .O(z08));
  ...
  nand2  g053(.a(new_n71_), .b(new_n52_), .O(new_n100_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n66_), .c(new_n121_), .O(new_n122_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n104_), .c(new_n63_), .O(new_n131_));
  ...
  oai21  g089(.a(new_n100_), .b(new_n74_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n94_), .O(new_n137_));
  nand2  g091(.a(new_n121_), .b(x24), .O(new_n138_));
  nor3   g092(.a(x24), .b(x22), .c(x21), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n104_), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(new_n138_), .c(x23), .O(new_n141_));
  nand3  g095(.a(x24), .b(x23), .c(x18), .O(new_n142_));
  ...
  oai21  g102(.a(new_n81_), .b(new_n94_), .c(x18), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x23), .O(new_n150_));
  aoi21  g104(.a(new_n139_), .b(new_n104_), .c(new_n81_), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n130_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n112_), .O(new_n154_));
  ...
  oai21  g113(.a(new_n84_), .b(new_n94_), .c(x18), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x23), .O(new_n161_));
  nand3  g115(.a(new_n152_), .b(new_n120_), .c(new_n104_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x26), .O(new_n163_));
  nor3   g117(.a(x26), .b(x25), .c(x24), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n130_), .c(new_n119_), .O(new_n165_));
  ...
  nand2  g122(.a(new_n164_), .b(new_n130_), .O(new_n169_));
  nand3  g123(.a(new_n111_), .b(x19), .c(new_n90_), .O(new_n170_));
  oai22  g124(.a(new_n170_), .b(new_n169_), .c(new_n48_), .d(new_n90_), .O(new_n171_));
