...
module FAU ( 
  ...
  oai21  g48(.a(x18), .b(x09), .c(new_n94_), .O(new_n95_));
  nor2   g49(.a(new_n89_), .b(new_n57_), .O(new_n96_));
  ...
  oai21  g53(.a(x18), .b(x10), .c(new_n94_), .O(new_n100_));
  nor2   g54(.a(x20), .b(x19), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n87_), .O(new_n102_));
  inv1   g56(.a(x21), .O(new_n103_));
  nand4  g57(.a(new_n103_), .b(new_n57_), .c(new_n51_), .d(new_n87_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n102_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n94_), .c(new_n100_), .O(z11));
  oai21  g61(.a(x18), .b(x11), .c(new_n94_), .O(new_n108_));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n89_), .c(new_n57_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n94_), .c(new_n108_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n97_), .c(new_n111_), .d(x23), .O(new_n115_));
  oai22  g69(.a(new_n115_), .b(new_n94_), .c(new_n92_), .d(new_n68_), .O(z13));
  oai21  g70(.a(x18), .b(x13), .c(new_n94_), .O(new_n117_));
  aoi21  g71(.a(new_n114_), .b(new_n97_), .c(new_n75_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n110_), .c(new_n101_), .d(new_n87_), .O(new_n120_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n105_), .c(new_n120_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n91_), .b(x14), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n94_), .c(new_n128_), .O(z15));
  ...
  nand2  g92(.a(new_n91_), .b(x15), .O(new_n139_));
