...
module FAU ( 
  ...
  nor2   g42(.a(new_n84_), .b(new_n54_), .O(new_n89_));
  ...
  oai21  g47(.a(new_n93_), .b(new_n52_), .c(new_n91_), .O(z10));
  ...
  oai22  g53(.a(new_n99_), .b(new_n86_), .c(new_n93_), .d(new_n58_), .O(z11));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n84_), .c(new_n97_), .d(x22), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n86_), .c(new_n93_), .d(new_n63_), .O(z12));
  ...
  oai22  g61(.a(new_n107_), .b(new_n86_), .c(new_n93_), .d(new_n66_), .O(z13));
  inv1   g62(.a(x24), .O(new_n109_));
  aoi21  g63(.a(new_n106_), .b(new_n90_), .c(new_n109_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n104_), .c(new_n95_), .d(new_n81_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g68(.a(new_n92_), .b(x13), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n114_), .O(z14));
  oai21  g70(.a(x18), .b(x14), .c(new_n86_), .O(new_n117_));
  inv1   g71(.a(x22), .O(new_n118_));
  inv1   g72(.a(x25), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n68_), .d(new_n118_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n98_), .c(new_n112_), .d(x25), .O(new_n122_));
  ...
  nand2  g86(.a(new_n92_), .b(x15), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n132_), .O(z16));
  inv1   g88(.a(new_n49_), .O(new_n135_));
  nor2   g89(.a(x26), .b(x25), .O(new_n136_));
  nand3  g90(.a(new_n136_), .b(new_n125_), .c(new_n109_), .O(new_n137_));
  nand3  g91(.a(new_n124_), .b(x19), .c(new_n81_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n55_), .d(new_n81_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n135_), .O(z17));
endmodule
