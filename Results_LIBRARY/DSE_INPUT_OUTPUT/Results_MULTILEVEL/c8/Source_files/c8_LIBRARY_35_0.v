...
module FAU ( 
  ...
  nor2   g035(.a(new_n60_), .b(new_n56_), .O(z08));
  ...
  inv1   g040(.a(new_n60_), .O(new_n87_));
  ...
  nand3  g048(.a(new_n47_), .b(x09), .c(x08), .O(new_n95_));
  ...
  nand3  g053(.a(new_n55_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  oai21  g054(.a(new_n89_), .b(new_n55_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n87_), .c(x16), .O(new_n102_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n106_), .c(new_n87_), .O(z11));
  ...
  aoi21  g071(.a(new_n109_), .b(new_n89_), .c(new_n117_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n89_), .c(new_n55_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n116_), .c(new_n87_), .O(z12));
  ...
  nand3  g087(.a(new_n47_), .b(x13), .c(x08), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n83_), .O(new_n136_));
  inv1   g090(.a(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n117_), .c(new_n107_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n100_), .c(x24), .O(new_n139_));
  nor2   g093(.a(x20), .b(x19), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n119_), .c(new_n140_), .d(new_n98_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n87_), .c(x16), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n128_), .c(new_n109_), .d(new_n89_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n87_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n47_), .b(x15), .c(x08), .O(new_n156_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n128_), .c(new_n109_), .d(new_n89_), .O(new_n161_));
  ...
  nand4  g119(.a(new_n128_), .b(new_n79_), .c(new_n74_), .d(new_n165_), .O(new_n166_));
  nand3  g120(.a(new_n109_), .b(x19), .c(new_n98_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n56_), .d(new_n98_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n87_), .O(z17));
endmodule
