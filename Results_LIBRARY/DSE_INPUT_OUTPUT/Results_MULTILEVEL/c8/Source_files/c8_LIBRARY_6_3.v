...
module FAU ( 
  ...
  nand2  g036(.a(x18), .b(new_n52_), .O(new_n83_));
  ...
  nand3  g045(.a(x18), .b(new_n52_), .c(x01), .O(new_n92_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n104_), .c(new_n48_), .O(z11));
  nand2  g065(.a(x18), .b(x03), .O(new_n112_));
  oai21  g066(.a(x18), .b(new_n58_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n81_), .O(new_n114_));
  aoi21  g068(.a(new_n107_), .b(new_n87_), .c(new_n60_), .O(new_n115_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n48_), .O(z13));
  ...
  nand3  g092(.a(new_n138_), .b(new_n132_), .c(new_n48_), .O(z14));
  inv1   g093(.a(x06), .O(new_n140_));
  oai22  g094(.a(new_n83_), .b(new_n140_), .c(x18), .d(new_n72_), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n87_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n107_), .d(new_n87_), .O(new_n155_));
  ...
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n61_), .d(new_n96_), .O(new_n162_));
