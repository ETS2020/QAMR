...
module FAU ( 
  ...
  aoi21  g079(.a(new_n118_), .b(new_n93_), .c(new_n125_), .O(new_n126_));
  nor2   g080(.a(x20), .b(x19), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n110_), .c(new_n127_), .d(new_n83_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n126_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n95_), .b(x13), .O(new_n132_));
  ...
  nand3  g095(.a(new_n141_), .b(new_n101_), .c(x16), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n138_), .c(new_n103_), .d(new_n91_), .O(new_n147_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n74_), .c(new_n125_), .O(new_n155_));
  ...
  nor2   g112(.a(new_n55_), .b(new_n83_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n101_), .c(new_n81_), .O(z17));
endmodule
