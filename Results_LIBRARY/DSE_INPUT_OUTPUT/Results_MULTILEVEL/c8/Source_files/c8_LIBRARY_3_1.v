...
module FAU ( 
  ...
  nand2  g015(.a(new_n61_), .b(x23), .O(new_n62_));
  nand2  g016(.a(new_n62_), .b(new_n48_), .O(new_n63_));
  inv1   g017(.a(x23), .O(new_n64_));
  nand3  g018(.a(new_n61_), .b(new_n64_), .c(x12), .O(new_n65_));
  oai21  g019(.a(new_n63_), .b(x12), .c(new_n65_), .O(z04));
  ...
  nand2  g036(.a(x18), .b(x12), .O(new_n83_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n103_), .c(new_n86_), .O(z11));
  ...
  nand3  g072(.a(new_n118_), .b(new_n112_), .c(new_n86_), .O(z12));
  inv1   g073(.a(x04), .O(new_n120_));
  nand2  g074(.a(x18), .b(new_n120_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n81_), .c(x12), .O(new_n122_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n86_), .O(z13));
  inv1   g082(.a(x05), .O(new_n129_));
  oai22  g083(.a(new_n83_), .b(new_n129_), .c(x18), .d(new_n67_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n81_), .O(new_n131_));
  inv1   g085(.a(x17), .O(new_n132_));
  inv1   g086(.a(x19), .O(new_n133_));
  nand3  g087(.a(new_n96_), .b(new_n133_), .c(new_n132_), .O(new_n134_));
  nand3  g088(.a(new_n64_), .b(new_n113_), .c(new_n104_), .O(new_n135_));
  ...
  oai22  g106(.a(new_n83_), .b(new_n152_), .c(x18), .d(new_n75_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n124_), .c(new_n105_), .d(new_n88_), .O(new_n157_));
  ...
  nand4  g115(.a(new_n124_), .b(new_n77_), .c(new_n72_), .d(new_n161_), .O(new_n162_));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n132_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n61_), .d(new_n132_), .O(new_n164_));
