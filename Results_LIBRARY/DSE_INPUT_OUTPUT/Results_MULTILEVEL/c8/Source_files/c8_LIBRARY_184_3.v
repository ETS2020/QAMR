...
module FAU ( 
  ...
  nand2  g017(.a(new_n55_), .b(new_n62_), .O(new_n64_));
  oai21  g018(.a(new_n64_), .b(x18), .c(new_n63_), .O(z03));
  ...
  nand2  g056(.a(x18), .b(new_n61_), .O(new_n103_));
  ...
  nand4  g060(.a(new_n106_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n107_));
  oai21  g061(.a(new_n99_), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n48_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n105_), .O(z11));
  oai21  g064(.a(x18), .b(new_n90_), .c(x11), .O(new_n111_));
  aoi21  g065(.a(x18), .b(x11), .c(x22), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n106_), .c(new_n54_), .d(new_n86_), .O(new_n113_));
  ...
  nand3  g070(.a(x18), .b(new_n90_), .c(x03), .O(new_n117_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n88_), .c(new_n54_), .O(new_n123_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n121_), .c(new_n48_), .O(z13));
  ...
  nand4  g090(.a(new_n136_), .b(new_n122_), .c(new_n135_), .d(new_n85_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n134_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n132_), .c(new_n48_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n103_), .b(new_n141_), .c(x18), .d(new_n74_), .O(new_n142_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n88_), .O(new_n148_));
  ...
  oai22  g106(.a(new_n103_), .b(new_n152_), .c(x18), .d(new_n79_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n145_), .d(new_n88_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n146_), .b(new_n81_), .c(new_n76_), .d(new_n133_), .O(new_n161_));
  nand3  g115(.a(new_n145_), .b(x19), .c(new_n85_), .O(new_n162_));
