...
module FAU ( 
  ...
  nor2   g030(.a(new_n52_), .b(new_n76_), .O(new_n77_));
  oai21  g031(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  nand3  g032(.a(new_n52_), .b(new_n76_), .c(new_n47_), .O(new_n79_));
  ...
  oai22  g048(.a(new_n87_), .b(new_n94_), .c(x18), .d(new_n55_), .O(new_n95_));
  ...
  oai22  g069(.a(new_n87_), .b(new_n115_), .c(x18), .d(new_n61_), .O(new_n116_));
  ...
  oai22  g078(.a(new_n87_), .b(new_n124_), .c(x18), .d(new_n66_), .O(new_n125_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n109_), .c(new_n71_), .O(new_n136_));
  ...
  oai22  g096(.a(new_n87_), .b(new_n142_), .c(x18), .d(new_n74_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n85_), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x18), .b(x17), .O(new_n146_));
  ...
  nand4  g120(.a(new_n158_), .b(new_n155_), .c(new_n76_), .d(new_n71_), .O(new_n167_));
  nand3  g121(.a(new_n110_), .b(x19), .c(new_n99_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n52_), .d(new_n99_), .O(new_n169_));
