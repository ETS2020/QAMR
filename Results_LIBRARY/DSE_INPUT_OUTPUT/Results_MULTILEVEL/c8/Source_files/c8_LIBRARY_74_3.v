...
module FAU ( 
  ...
  oai21  g047(.a(x16), .b(x01), .c(x18), .O(new_n94_));
  inv1   g048(.a(x20), .O(new_n95_));
  nor2   g049(.a(new_n89_), .b(new_n95_), .O(new_n96_));
  nor3   g050(.a(x20), .b(x19), .c(x17), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n91_), .b(x09), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n98_), .c(new_n94_), .O(z10));
  ...
  nand3  g083(.a(new_n95_), .b(new_n87_), .c(new_n86_), .O(new_n130_));
  nand3  g084(.a(new_n66_), .b(new_n109_), .c(new_n57_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n111_), .c(new_n133_), .d(new_n86_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n129_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n128_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  oai21  g093(.a(x18), .b(new_n74_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n125_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n102_), .d(new_n89_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n129_), .c(x16), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n102_), .d(new_n89_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n91_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand2  g109(.a(new_n66_), .b(new_n109_), .O(new_n156_));
  nand3  g110(.a(new_n81_), .b(new_n76_), .c(new_n71_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n102_), .b(x19), .c(new_n86_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n58_), .b(new_n86_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n129_), .c(new_n125_), .O(z17));
endmodule
