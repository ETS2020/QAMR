...
module FAU ( 
  ...
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n52_), .O(z11));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n87_), .c(new_n65_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n52_), .O(z12));
  ...
  oai22  g085(.a(new_n96_), .b(new_n131_), .c(x18), .d(new_n71_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n89_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n65_), .c(new_n60_), .O(new_n135_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n52_), .c(x16), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n133_), .O(z14));
  inv1   g096(.a(new_n109_), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n126_), .O(new_n145_));
  inv1   g099(.a(new_n145_), .O(new_n146_));
  aoi22  g100(.a(new_n146_), .b(new_n143_), .c(new_n139_), .d(x25), .O(new_n147_));
  nor2   g101(.a(x18), .b(x16), .O(new_n148_));
  aoi21  g102(.a(new_n148_), .b(x14), .c(new_n53_), .O(new_n149_));
  oai21  g103(.a(new_n147_), .b(new_n89_), .c(new_n149_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  oai22  g105(.a(new_n151_), .b(x06), .c(x18), .d(new_n79_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n89_), .O(new_n153_));
  nand4  g107(.a(new_n144_), .b(new_n126_), .c(new_n108_), .d(new_n87_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n126_), .c(new_n108_), .d(new_n87_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n52_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n153_), .O(z16));
  inv1   g114(.a(x24), .O(new_n161_));
  nand4  g115(.a(new_n126_), .b(new_n81_), .c(new_n76_), .d(new_n161_), .O(new_n162_));
