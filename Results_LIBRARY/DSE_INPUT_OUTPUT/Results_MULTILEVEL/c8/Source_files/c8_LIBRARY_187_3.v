...
module FAU ( 
  ...
  oai21  g051(.a(new_n91_), .b(new_n62_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x16), .O(new_n99_));
  nand2  g053(.a(new_n86_), .b(x10), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(z11));
  oai21  g055(.a(x16), .b(x03), .c(x18), .O(new_n102_));
  inv1   g056(.a(x22), .O(new_n103_));
  aoi21  g057(.a(new_n96_), .b(new_n84_), .c(new_n103_), .O(new_n104_));
  nor2   g058(.a(x22), .b(x21), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n84_), .c(new_n57_), .O(new_n106_));
  inv1   g060(.a(new_n106_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n104_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n86_), .b(x11), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n108_), .c(new_n102_), .O(z12));
  ...
  nand2  g069(.a(new_n106_), .b(x23), .O(new_n116_));
  nor2   g070(.a(x23), .b(x22), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n62_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n115_), .c(x16), .O(new_n120_));
  ...
  nand2  g077(.a(new_n123_), .b(new_n111_), .O(new_n124_));
  nand3  g078(.a(new_n57_), .b(new_n51_), .c(new_n82_), .O(new_n125_));
  inv1   g079(.a(x23), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n103_), .c(new_n62_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n125_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n105_), .c(new_n129_), .d(new_n82_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n115_), .c(x16), .O(new_n133_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n117_), .c(new_n96_), .d(new_n84_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n115_), .c(x16), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n117_), .c(new_n96_), .d(new_n84_), .O(new_n147_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n117_), .c(new_n152_), .O(new_n154_));
  nand3  g108(.a(new_n96_), .b(x19), .c(new_n82_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n82_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n115_), .c(x16), .O(new_n157_));
