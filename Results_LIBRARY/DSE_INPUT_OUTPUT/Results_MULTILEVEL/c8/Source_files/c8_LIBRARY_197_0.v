...
module FAU ( 
  ...
  nor2   g005(.a(x18), .b(x06), .O(new_n52_));
  ...
  aoi21  g019(.a(new_n65_), .b(new_n63_), .c(new_n52_), .O(z03));
  inv1   g020(.a(x12), .O(new_n67_));
  aoi21  g021(.a(x27), .b(new_n67_), .c(new_n52_), .O(new_n68_));
  ...
  nand3  g049(.a(new_n95_), .b(x09), .c(x06), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  inv1   g052(.a(x20), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n49_), .c(new_n85_), .O(new_n100_));
  oai21  g054(.a(new_n87_), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n108_), .d(new_n87_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n83_), .c(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n155_), .O(z16));
  inv1   g115(.a(x24), .O(new_n162_));
  nand4  g116(.a(new_n126_), .b(new_n80_), .c(new_n75_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n85_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n50_), .d(new_n85_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n83_), .O(z17));
endmodule
