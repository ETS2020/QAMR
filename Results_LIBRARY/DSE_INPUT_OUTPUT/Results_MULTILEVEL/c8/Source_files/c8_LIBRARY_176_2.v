...
module FAU ( 
  ...
  oai21  g029(.a(x27), .b(new_n75_), .c(new_n47_), .O(new_n76_));
  ...
  nand3  g041(.a(new_n87_), .b(new_n74_), .c(x16), .O(new_n88_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n74_), .O(z10));
  aoi22  g052(.a(new_n85_), .b(x10), .c(x18), .d(x02), .O(new_n99_));
  nor2   g053(.a(x21), .b(x20), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  oai21  g055(.a(new_n96_), .b(new_n62_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n74_), .c(x16), .O(new_n103_));
  oai21  g057(.a(new_n99_), .b(x16), .c(new_n103_), .O(z11));
  nand2  g058(.a(x18), .b(x03), .O(new_n105_));
  oai21  g059(.a(x18), .b(new_n65_), .c(new_n105_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  inv1   g061(.a(x18), .O(new_n108_));
  aoi21  g062(.a(new_n108_), .b(x14), .c(x22), .O(new_n109_));
  nand4  g063(.a(new_n109_), .b(new_n62_), .c(new_n57_), .d(new_n51_), .O(new_n110_));
  nand2  g064(.a(new_n101_), .b(x22), .O(new_n111_));
  oai21  g065(.a(new_n110_), .b(x17), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n107_), .c(new_n74_), .O(z12));
  ...
  nand3  g078(.a(new_n124_), .b(new_n117_), .c(new_n74_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  nand2  g080(.a(new_n85_), .b(x13), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n90_), .O(new_n129_));
  nand2  g083(.a(new_n122_), .b(x24), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n118_), .c(new_n96_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n74_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n129_), .O(z14));
  nor2   g089(.a(x25), .b(x24), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n121_), .c(new_n100_), .d(new_n94_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  aoi21  g092(.a(new_n132_), .b(x25), .c(new_n138_), .O(new_n139_));
  nor2   g093(.a(new_n108_), .b(x16), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(x06), .c(new_n48_), .O(new_n141_));
  oai21  g095(.a(new_n139_), .b(new_n90_), .c(new_n141_), .O(z15));
  nand2  g096(.a(x18), .b(x07), .O(new_n143_));
  nand3  g097(.a(new_n108_), .b(x15), .c(new_n47_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n90_), .O(new_n146_));
  nand2  g100(.a(new_n137_), .b(x26), .O(new_n147_));
  inv1   g101(.a(x24), .O(new_n148_));
  nand4  g102(.a(new_n121_), .b(new_n81_), .c(new_n75_), .d(new_n148_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n101_), .c(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n74_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  inv1   g106(.a(x17), .O(new_n153_));
  nand3  g107(.a(new_n100_), .b(x19), .c(new_n153_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n149_), .c(new_n52_), .d(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n74_), .c(x16), .O(new_n156_));
