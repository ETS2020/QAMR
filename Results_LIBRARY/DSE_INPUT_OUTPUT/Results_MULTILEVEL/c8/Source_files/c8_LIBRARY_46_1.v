...
module FAU ( 
  ...
  inv1   g052(.a(x26), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n52_), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n57_), .c(new_n98_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  nand3  g056(.a(new_n55_), .b(new_n47_), .c(new_n89_), .O(new_n103_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n53_), .O(z11));
  nand2  g069(.a(x18), .b(x03), .O(new_n116_));
  oai21  g070(.a(new_n100_), .b(new_n66_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n93_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n91_), .c(new_n55_), .O(new_n121_));
  ...
  oai21  g088(.a(new_n100_), .b(new_n76_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n93_), .O(new_n136_));
  nand3  g090(.a(new_n73_), .b(new_n68_), .c(new_n63_), .O(new_n137_));
  ...
  nand4  g113(.a(new_n159_), .b(new_n129_), .c(new_n111_), .d(new_n91_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n157_), .c(new_n53_), .O(z16));
  nand2  g117(.a(z08), .b(x17), .O(new_n164_));
  nor2   g118(.a(new_n47_), .b(x17), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n159_), .c(new_n129_), .d(new_n111_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n164_), .c(new_n93_), .O(z17));
endmodule
