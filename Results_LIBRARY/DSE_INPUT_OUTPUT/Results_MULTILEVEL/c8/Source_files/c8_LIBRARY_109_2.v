...
module FAU ( 
  ...
  aoi21  g063(.a(new_n104_), .b(new_n88_), .c(new_n60_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n88_), .c(new_n94_), .O(new_n112_));
  ...
  nand3  g081(.a(new_n94_), .b(new_n86_), .c(new_n85_), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n60_), .c(new_n103_), .O(new_n130_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n119_), .c(new_n104_), .d(new_n88_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n119_), .c(new_n104_), .d(new_n88_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n90_), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n147_), .O(z16));
  nand4  g108(.a(new_n119_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n155_));
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n85_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n61_), .d(new_n85_), .O(new_n157_));
