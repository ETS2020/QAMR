...
module FAU ( 
  ...
  nand2  g058(.a(new_n96_), .b(x02), .O(new_n105_));
  ...
  nand3  g083(.a(new_n66_), .b(new_n129_), .c(new_n100_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n128_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n111_), .c(new_n132_), .d(new_n127_), .O(new_n134_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n101_), .d(new_n92_), .O(new_n141_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n118_), .c(new_n101_), .d(new_n92_), .O(new_n151_));
  ...
  nand2  g108(.a(new_n66_), .b(new_n129_), .O(new_n155_));
  inv1   g109(.a(x25), .O(new_n156_));
  nand3  g110(.a(new_n79_), .b(new_n156_), .c(new_n71_), .O(new_n157_));
  ...
  nor2   g114(.a(new_n52_), .b(new_n127_), .O(new_n161_));
