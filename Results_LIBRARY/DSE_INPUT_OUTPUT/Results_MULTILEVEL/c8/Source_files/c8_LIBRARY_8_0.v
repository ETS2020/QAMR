...
module FAU ( 
  ...
  nand2  g033(.a(new_n54_), .b(x26), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(x18), .O(new_n81_));
  inv1   g035(.a(x26), .O(new_n82_));
  nand3  g036(.a(new_n54_), .b(new_n82_), .c(x15), .O(new_n83_));
  oai21  g037(.a(new_n81_), .b(x15), .c(new_n83_), .O(z07));
  ...
  nor2   g051(.a(new_n88_), .b(new_n53_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n97_), .c(new_n85_), .O(z10));
  nand2  g055(.a(x18), .b(x02), .O(new_n102_));
  inv1   g056(.a(x18), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x15), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n57_), .c(new_n102_), .O(new_n105_));
  ...
  oai21  g062(.a(new_n99_), .b(new_n59_), .c(new_n108_), .O(new_n109_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n132_), .c(new_n85_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  oai21  g096(.a(new_n104_), .b(new_n75_), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n107_), .d(new_n88_), .O(new_n148_));
  ...
  oai21  g105(.a(new_n103_), .b(x07), .c(new_n90_), .O(new_n152_));
  nand2  g106(.a(new_n148_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n146_), .c(new_n107_), .d(new_n88_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n85_), .O(z16));
  nand4  g112(.a(new_n146_), .b(new_n82_), .c(new_n77_), .d(new_n133_), .O(new_n159_));
  nand3  g113(.a(new_n107_), .b(x19), .c(new_n135_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n54_), .d(new_n135_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n85_), .c(x16), .O(new_n162_));
