...
module FAU ( 
  ...
  nand2  g034(.a(x18), .b(x15), .O(new_n81_));
  ...
  oai22  g059(.a(new_n81_), .b(new_n105_), .c(x18), .d(new_n61_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n79_), .O(new_n107_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n77_), .c(x16), .O(new_n112_));
  ...
  nand2  g069(.a(new_n115_), .b(new_n79_), .O(new_n116_));
  nand2  g070(.a(new_n110_), .b(x23), .O(new_n117_));
  nor2   g071(.a(x23), .b(x22), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n93_), .c(new_n99_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n77_), .O(z13));
  inv1   g076(.a(x05), .O(new_n123_));
  oai22  g077(.a(new_n81_), .b(new_n123_), .c(x18), .d(new_n67_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n79_), .O(new_n125_));
  inv1   g079(.a(x17), .O(new_n126_));
  nand3  g080(.a(new_n90_), .b(new_n51_), .c(new_n126_), .O(new_n127_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n77_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n125_), .O(z14));
  inv1   g091(.a(x06), .O(new_n138_));
  oai22  g092(.a(new_n81_), .b(new_n138_), .c(x18), .d(new_n70_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n79_), .O(new_n140_));
  nand2  g094(.a(new_n134_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n118_), .c(new_n100_), .d(new_n91_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n77_), .c(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n140_), .O(z15));
  inv1   g100(.a(x07), .O(new_n147_));
  nand2  g101(.a(x18), .b(new_n147_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n79_), .c(x15), .O(new_n149_));
  nand2  g103(.a(new_n143_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n118_), .c(new_n100_), .d(new_n91_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n149_), .c(new_n77_), .O(z16));
  inv1   g109(.a(x24), .O(new_n156_));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n118_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n100_), .b(x19), .c(new_n126_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n126_), .O(new_n160_));
