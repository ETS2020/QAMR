...
module FAU ( 
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n52_), .O(z10));
  inv1   g051(.a(x05), .O(new_n98_));
  nand3  g052(.a(x18), .b(new_n98_), .c(x02), .O(new_n99_));
  ...
  nand4  g056(.a(new_n102_), .b(new_n93_), .c(new_n49_), .d(new_n81_), .O(new_n103_));
  oai21  g057(.a(new_n95_), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  ...
  nand4  g064(.a(new_n110_), .b(new_n102_), .c(new_n93_), .d(new_n49_), .O(new_n111_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n52_), .O(z12));
  ...
  nand3  g073(.a(new_n119_), .b(new_n83_), .c(new_n93_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n118_), .c(new_n52_), .O(z13));
  aoi21  g080(.a(new_n122_), .b(new_n95_), .c(new_n69_), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n119_), .c(new_n128_), .d(new_n81_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  inv1   g086(.a(x18), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n85_), .c(x13), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n132_), .c(new_n52_), .O(z14));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n83_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n138_), .c(new_n52_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  oai22  g101(.a(new_n147_), .b(x05), .c(x18), .d(new_n75_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n140_), .d(new_n83_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n140_), .b(x19), .c(new_n81_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n50_), .d(new_n81_), .O(new_n159_));
