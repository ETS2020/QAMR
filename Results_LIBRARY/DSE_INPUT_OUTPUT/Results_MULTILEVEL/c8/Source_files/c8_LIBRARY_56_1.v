...
module FAU ( 
  ...
  nand2  g035(.a(new_n53_), .b(x25), .O(new_n82_));
  nand3  g036(.a(new_n82_), .b(new_n81_), .c(new_n47_), .O(new_n83_));
  inv1   g037(.a(x25), .O(new_n84_));
  nand3  g038(.a(new_n53_), .b(new_n84_), .c(x14), .O(new_n85_));
  ...
  nand2  g043(.a(new_n53_), .b(new_n89_), .O(new_n90_));
  aoi21  g044(.a(new_n90_), .b(new_n88_), .c(new_n49_), .O(z07));
  nor2   g045(.a(new_n49_), .b(new_n53_), .O(z08));
  inv1   g046(.a(x17), .O(new_n93_));
  nor2   g047(.a(new_n52_), .b(new_n93_), .O(new_n94_));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n48_), .O(z09));
  inv1   g055(.a(x01), .O(new_n102_));
  nand2  g056(.a(x18), .b(x14), .O(new_n103_));
  oai22  g057(.a(new_n103_), .b(new_n102_), .c(x18), .d(new_n56_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n97_), .O(new_n105_));
  nor2   g059(.a(x20), .b(x19), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n93_), .O(new_n107_));
  oai21  g061(.a(new_n95_), .b(new_n58_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n48_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n105_), .O(z10));
  inv1   g064(.a(x02), .O(new_n111_));
  oai22  g065(.a(new_n103_), .b(new_n111_), .c(x18), .d(new_n61_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n97_), .O(new_n113_));
  inv1   g067(.a(new_n107_), .O(new_n114_));
  ...
  nand2  g072(.a(new_n118_), .b(new_n113_), .O(z11));
  inv1   g073(.a(x03), .O(new_n120_));
  oai22  g074(.a(new_n103_), .b(new_n120_), .c(x18), .d(new_n68_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n97_), .O(new_n122_));
  nand2  g076(.a(new_n116_), .b(x22), .O(new_n123_));
  nor2   g077(.a(x22), .b(x21), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n95_), .c(new_n58_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n48_), .c(x16), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n122_), .O(z12));
  inv1   g082(.a(x04), .O(new_n129_));
  oai22  g083(.a(new_n103_), .b(new_n129_), .c(x18), .d(new_n71_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n97_), .O(new_n131_));
  nand2  g085(.a(new_n125_), .b(x23), .O(new_n132_));
  nor3   g086(.a(x23), .b(x22), .c(x21), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n114_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n48_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n131_), .O(z13));
  nand2  g091(.a(x18), .b(x05), .O(new_n138_));
  oai21  g092(.a(x18), .b(new_n78_), .c(new_n138_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n97_), .O(new_n140_));
  aoi21  g094(.a(new_n133_), .b(new_n114_), .c(new_n76_), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n124_), .c(new_n106_), .d(new_n93_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n141_), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n140_), .c(new_n48_), .O(z14));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n95_), .O(new_n152_));
  ...
  oai21  g109(.a(new_n154_), .b(new_n47_), .c(new_n155_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  oai21  g111(.a(x18), .b(new_n87_), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n97_), .O(new_n159_));
  nand2  g113(.a(new_n152_), .b(x26), .O(new_n160_));
  nand4  g114(.a(new_n150_), .b(new_n89_), .c(new_n84_), .d(new_n76_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n116_), .c(new_n160_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n159_), .c(new_n48_), .O(z16));
  nand3  g118(.a(new_n115_), .b(x19), .c(new_n93_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n53_), .d(new_n93_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n48_), .O(z17));
endmodule
