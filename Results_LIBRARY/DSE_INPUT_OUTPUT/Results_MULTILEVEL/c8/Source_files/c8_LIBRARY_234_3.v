...
module FAU ( 
  ...
  nand2  g021(.a(new_n59_), .b(new_n67_), .O(new_n68_));
  ...
  nand2  g029(.a(new_n59_), .b(new_n75_), .O(new_n76_));
  ...
  nand2  g034(.a(new_n59_), .b(new_n80_), .O(new_n81_));
  aoi21  g035(.a(new_n81_), .b(new_n79_), .c(new_n50_), .O(z07));
  inv1   g036(.a(new_n50_), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n59_), .O(z08));
  inv1   g038(.a(x19), .O(new_n85_));
  nor2   g039(.a(new_n85_), .b(new_n48_), .O(new_n86_));
  ...
  oai21  g051(.a(new_n97_), .b(new_n89_), .c(new_n49_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x17), .O(new_n99_));
  nor2   g053(.a(x20), .b(x19), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  oai21  g055(.a(new_n97_), .b(new_n85_), .c(new_n101_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(x16), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n99_), .c(new_n96_), .O(z10));
  ...
  oai21  g061(.a(new_n58_), .b(new_n89_), .c(new_n49_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x17), .O(new_n109_));
  nor2   g063(.a(x21), .b(x20), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n87_), .O(new_n111_));
  oai21  g065(.a(new_n100_), .b(new_n58_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n109_), .c(new_n107_), .O(z11));
  ...
  oai21  g072(.a(new_n118_), .b(new_n89_), .c(new_n49_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x17), .O(new_n120_));
  nor3   g074(.a(x21), .b(x20), .c(x19), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n87_), .c(new_n97_), .O(new_n123_));
  oai21  g077(.a(new_n121_), .b(new_n118_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n117_), .O(z12));
  ...
  oai21  g083(.a(new_n67_), .b(new_n89_), .c(new_n49_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x17), .O(new_n131_));
  aoi21  g085(.a(new_n122_), .b(new_n100_), .c(new_n67_), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n58_), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(new_n101_), .O(new_n135_));
  ...
  nand2  g092(.a(x18), .b(new_n48_), .O(new_n139_));
  oai22  g093(.a(new_n139_), .b(new_n138_), .c(x18), .d(new_n70_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n89_), .O(new_n141_));
  nand3  g095(.a(new_n133_), .b(new_n100_), .c(new_n58_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x24), .O(new_n143_));
  nor2   g097(.a(x24), .b(x23), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n110_), .c(new_n118_), .d(new_n85_), .O(new_n145_));
  aoi21  g099(.a(new_n145_), .b(new_n143_), .c(x17), .O(new_n146_));
  nand3  g100(.a(x24), .b(new_n49_), .c(x17), .O(new_n147_));
  inv1   g101(.a(new_n147_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n146_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n141_), .O(z14));
  nand2  g104(.a(x18), .b(x06), .O(new_n151_));
  oai21  g105(.a(x18), .b(new_n73_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n89_), .O(new_n153_));
  oai21  g107(.a(new_n75_), .b(new_n89_), .c(new_n49_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x17), .O(new_n155_));
  and2   g109(.a(new_n145_), .b(x25), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n133_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n111_), .O(new_n159_));
  ...
  oai22  g116(.a(new_n139_), .b(new_n162_), .c(x18), .d(new_n78_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n89_), .O(new_n164_));
  nand4  g118(.a(new_n157_), .b(new_n133_), .c(new_n110_), .d(new_n85_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x26), .O(new_n166_));
  nor2   g120(.a(x26), .b(x25), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n144_), .c(new_n122_), .d(new_n100_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n166_), .c(x17), .O(new_n169_));
  nand3  g123(.a(x26), .b(new_n49_), .c(x17), .O(new_n170_));
  ...
  nor2   g127(.a(new_n85_), .b(x17), .O(new_n174_));
  nor3   g128(.a(x26), .b(x25), .c(x24), .O(new_n175_));
  nand4  g129(.a(new_n175_), .b(new_n174_), .c(new_n133_), .d(new_n110_), .O(new_n176_));
  nand3  g130(.a(x27), .b(new_n49_), .c(x17), .O(new_n177_));
  aoi21  g131(.a(new_n177_), .b(new_n176_), .c(new_n89_), .O(z17));
endmodule
