...
module FAU ( 
  ...
  nand3  g006(.a(new_n49_), .b(new_n52_), .c(x08), .O(new_n53_));
  nand2  g007(.a(new_n53_), .b(new_n51_), .O(z00));
  inv1   g008(.a(x09), .O(new_n55_));
  nor2   g009(.a(new_n48_), .b(x08), .O(new_n56_));
  ...
  nand2  g015(.a(new_n49_), .b(new_n61_), .O(new_n62_));
  ...
  nand2  g032(.a(new_n49_), .b(new_n78_), .O(new_n79_));
  aoi21  g033(.a(new_n79_), .b(new_n77_), .c(new_n56_), .O(z07));
  nor2   g034(.a(new_n56_), .b(new_n49_), .O(z08));
  xnor2a g035(.a(x19), .b(x17), .O(new_n82_));
  inv1   g036(.a(x00), .O(new_n83_));
  aoi21  g037(.a(x18), .b(new_n83_), .c(x16), .O(new_n84_));
  aoi21  g038(.a(new_n82_), .b(x16), .c(new_n84_), .O(new_n85_));
  nand3  g039(.a(new_n82_), .b(new_n48_), .c(x16), .O(new_n86_));
  oai21  g040(.a(new_n85_), .b(new_n47_), .c(new_n86_), .O(z09));
  inv1   g041(.a(x16), .O(new_n88_));
  inv1   g042(.a(x01), .O(new_n89_));
  nand2  g043(.a(x18), .b(x08), .O(new_n90_));
  oai22  g044(.a(new_n90_), .b(new_n89_), .c(x18), .d(new_n55_), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  inv1   g046(.a(new_n56_), .O(new_n93_));
  ...
  nand3  g053(.a(new_n99_), .b(new_n93_), .c(x16), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n92_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n93_), .O(z11));
  inv1   g064(.a(x03), .O(new_n111_));
  oai22  g065(.a(new_n90_), .b(new_n111_), .c(x18), .d(new_n64_), .O(new_n112_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n93_), .O(z13));
  ...
  nand3  g091(.a(new_n137_), .b(new_n131_), .c(new_n93_), .O(z14));
  ...
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n93_), .O(z15));
  ...
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n93_), .O(z16));
  ...
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n49_), .d(new_n96_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n93_), .c(x16), .O(new_n162_));
