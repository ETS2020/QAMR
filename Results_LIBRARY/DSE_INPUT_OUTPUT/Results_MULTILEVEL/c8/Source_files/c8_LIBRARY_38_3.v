...
module FAU ( 
  ...
  inv1   g062(.a(x26), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x18), .O(new_n110_));
  oai22  g064(.a(new_n110_), .b(new_n108_), .c(x18), .d(new_n63_), .O(new_n111_));
  ...
  nand3  g086(.a(new_n68_), .b(new_n132_), .c(new_n102_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n131_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n83_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n123_), .c(new_n103_), .d(new_n85_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n47_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n123_), .c(new_n103_), .d(new_n85_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n47_), .O(z16));
  inv1   g112(.a(x24), .O(new_n159_));
  nand4  g113(.a(new_n123_), .b(new_n109_), .c(new_n76_), .d(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n103_), .b(x19), .c(new_n83_), .O(new_n161_));
