...
module FAU ( 
  ...
  nand3  g078(.a(new_n124_), .b(new_n104_), .c(new_n56_), .O(new_n125_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n131_), .c(new_n48_), .O(z13));
  ...
  nand4  g096(.a(new_n142_), .b(new_n124_), .c(new_n106_), .d(new_n105_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n104_), .O(new_n152_));
  ...
  oai22  g111(.a(new_n95_), .b(new_n157_), .c(x18), .d(new_n87_), .O(new_n158_));
  ...
  nand3  g118(.a(new_n115_), .b(x19), .c(new_n105_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n53_), .d(new_n105_), .O(new_n166_));
