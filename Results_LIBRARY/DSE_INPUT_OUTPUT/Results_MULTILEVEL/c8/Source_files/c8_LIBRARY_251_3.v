...
module FAU ( 
  ...
  aoi21  g014(.a(new_n60_), .b(new_n57_), .c(new_n50_), .O(z02));
  ...
  nand2  g023(.a(new_n59_), .b(new_n69_), .O(new_n70_));
  aoi21  g024(.a(new_n70_), .b(new_n68_), .c(new_n50_), .O(z04));
  inv1   g025(.a(x13), .O(new_n72_));
  aoi21  g026(.a(x27), .b(new_n72_), .c(new_n50_), .O(new_n73_));
  oai21  g027(.a(x27), .b(x24), .c(new_n73_), .O(z05));
  inv1   g028(.a(new_n50_), .O(new_n75_));
  inv1   g029(.a(x14), .O(new_n76_));
  oai21  g030(.a(x27), .b(new_n48_), .c(new_n76_), .O(new_n77_));
  nand2  g031(.a(new_n59_), .b(new_n48_), .O(new_n78_));
  nand3  g032(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(z06));
  inv1   g033(.a(x15), .O(new_n80_));
  aoi21  g034(.a(x27), .b(new_n80_), .c(new_n50_), .O(new_n81_));
  oai21  g035(.a(x27), .b(x26), .c(new_n81_), .O(z07));
  nand2  g036(.a(new_n75_), .b(new_n59_), .O(z08));
  ...
  aoi21  g046(.a(new_n92_), .b(new_n88_), .c(new_n50_), .O(z09));
  nand2  g047(.a(x18), .b(x01), .O(new_n94_));
  oai21  g048(.a(x18), .b(new_n53_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n75_), .O(z10));
  nor2   g055(.a(x18), .b(new_n56_), .O(new_n102_));
  ...
  oai21  g059(.a(new_n99_), .b(new_n58_), .c(new_n105_), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(x16), .c(new_n50_), .O(new_n107_));
  oai21  g061(.a(new_n103_), .b(x16), .c(new_n107_), .O(z11));
  ...
  aoi21  g065(.a(new_n104_), .b(new_n87_), .c(new_n64_), .O(new_n112_));
  inv1   g066(.a(new_n87_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n97_), .O(new_n115_));
  nor2   g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n112_), .c(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n111_), .c(new_n75_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  oai21  g073(.a(x18), .b(new_n67_), .c(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n89_), .O(new_n121_));
  oai21  g075(.a(new_n115_), .b(new_n113_), .c(x23), .O(new_n122_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n75_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(x18), .b(new_n72_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n89_), .O(new_n130_));
  inv1   g084(.a(x24), .O(new_n131_));
  aoi21  g085(.a(new_n123_), .b(new_n99_), .c(new_n131_), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n114_), .c(new_n133_), .d(new_n84_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n132_), .c(x16), .O(new_n137_));
  aoi21  g091(.a(new_n137_), .b(new_n130_), .c(new_n50_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n104_), .d(new_n87_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n75_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  oai21  g103(.a(x18), .b(new_n80_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n89_), .O(new_n151_));
  nand2  g105(.a(new_n135_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n104_), .d(new_n87_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n75_), .O(z16));
  nand4  g111(.a(new_n143_), .b(new_n49_), .c(new_n48_), .d(new_n131_), .O(new_n158_));
  nand3  g112(.a(new_n104_), .b(x19), .c(new_n84_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n59_), .d(new_n84_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n75_), .O(z17));
endmodule
