...
module FAU ( 
  ...
  aoi22  g63(.a(new_n109_), .b(new_n94_), .c(new_n106_), .d(x23), .O(new_n110_));
  oai22  g64(.a(new_n110_), .b(new_n89_), .c(new_n90_), .d(new_n66_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n89_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n94_), .c(new_n71_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n105_), .c(new_n97_), .d(new_n85_), .O(new_n115_));
  ...
  nand3  g77(.a(new_n47_), .b(new_n89_), .c(x14), .O(new_n124_));
