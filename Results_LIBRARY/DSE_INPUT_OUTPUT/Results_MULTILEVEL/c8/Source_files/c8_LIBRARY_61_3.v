...
module FAU ( 
  ...
  aoi21  g041(.a(new_n87_), .b(new_n84_), .c(new_n83_), .O(new_n88_));
  aoi21  g042(.a(new_n83_), .b(x08), .c(new_n88_), .O(new_n89_));
  nand3  g043(.a(x18), .b(new_n83_), .c(x00), .O(new_n90_));
  oai21  g044(.a(new_n89_), .b(x18), .c(new_n90_), .O(z09));
  oai21  g045(.a(x16), .b(x01), .c(x18), .O(new_n92_));
  nor2   g046(.a(x19), .b(x17), .O(new_n93_));
  nor2   g047(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n96_), .c(new_n92_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n93_), .c(new_n54_), .O(new_n110_));
  ...
  nand2  g071(.a(new_n117_), .b(new_n95_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g074(.a(new_n97_), .b(x12), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(z13));
  oai21  g076(.a(x16), .b(x05), .c(x18), .O(new_n123_));
  inv1   g077(.a(x24), .O(new_n124_));
  aoi21  g078(.a(new_n117_), .b(new_n95_), .c(new_n124_), .O(new_n125_));
  nor2   g079(.a(x20), .b(x19), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n109_), .c(new_n126_), .d(new_n85_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n125_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n97_), .b(x13), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n123_), .O(z14));
  nand2  g086(.a(x18), .b(x06), .O(new_n133_));
  oai21  g087(.a(x18), .b(new_n74_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n83_), .O(new_n135_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n101_), .d(new_n93_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(x16), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n138_), .c(new_n101_), .d(new_n93_), .O(new_n147_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n138_), .c(new_n124_), .O(new_n153_));
  nand3  g107(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n55_), .d(new_n85_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n136_), .c(x16), .O(new_n156_));
