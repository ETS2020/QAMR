...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n96_), .c(new_n54_), .O(new_n115_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n95_), .c(x16), .O(new_n128_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n97_), .d(new_n85_), .O(new_n134_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n96_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n95_), .c(x16), .O(new_n147_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n143_), .c(new_n106_), .d(new_n96_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n118_), .b(x15), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  inv1   g110(.a(x23), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n112_), .O(new_n158_));
  nand3  g112(.a(new_n79_), .b(new_n74_), .c(new_n131_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n85_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n55_), .b(new_n85_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n95_), .c(new_n83_), .O(z17));
endmodule
