...
module FAU ( 
  ...
  nand3  g050(.a(new_n86_), .b(x09), .c(new_n48_), .O(new_n97_));
  ...
  nand3  g056(.a(new_n100_), .b(new_n102_), .c(new_n101_), .O(new_n103_));
  oai21  g057(.a(new_n91_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n82_), .O(z11));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n91_), .c(new_n63_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n91_), .c(new_n100_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n82_), .O(z12));
  ...
  nand3  g102(.a(new_n86_), .b(x14), .c(new_n48_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n130_), .c(new_n111_), .d(new_n91_), .O(new_n154_));
  ...
  oai21  g111(.a(new_n86_), .b(new_n84_), .c(x07), .O(new_n158_));
  nand2  g112(.a(new_n154_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n130_), .c(new_n111_), .d(new_n91_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n86_), .b(new_n84_), .c(x15), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n163_), .c(new_n158_), .O(z16));
  inv1   g119(.a(x24), .O(new_n166_));
  nand4  g120(.a(new_n130_), .b(new_n79_), .c(new_n74_), .d(new_n166_), .O(new_n167_));
  nand3  g121(.a(new_n111_), .b(x19), .c(new_n101_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n58_), .d(new_n101_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n82_), .O(z17));
endmodule
