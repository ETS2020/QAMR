...
module FAU ( 
  ...
  oai21  g041(.a(x18), .b(new_n49_), .c(new_n87_), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n85_), .c(new_n47_), .O(z09));
  ...
  aoi21  g064(.a(new_n103_), .b(new_n84_), .c(new_n63_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n84_), .c(new_n94_), .O(new_n113_));
  ...
  nand2  g071(.a(x18), .b(new_n76_), .O(new_n118_));
  ...
  oai22  g081(.a(new_n118_), .b(new_n127_), .c(x18), .d(new_n69_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n86_), .O(new_n129_));
  nand3  g083(.a(new_n94_), .b(new_n51_), .c(new_n82_), .O(new_n130_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n112_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n122_), .c(new_n103_), .d(new_n84_), .O(new_n145_));
  ...
  oai21  g102(.a(x18), .b(new_n86_), .c(x15), .O(new_n149_));
  nand2  g103(.a(new_n145_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n122_), .c(new_n103_), .d(new_n84_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(x18), .b(new_n86_), .c(x07), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  inv1   g110(.a(x24), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n122_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n82_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n82_), .O(new_n161_));
