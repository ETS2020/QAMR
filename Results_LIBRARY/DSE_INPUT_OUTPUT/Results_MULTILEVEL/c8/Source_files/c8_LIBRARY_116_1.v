...
module FAU ( 
  ...
  nand2  g025(.a(x18), .b(new_n47_), .O(new_n72_));
  nand3  g026(.a(new_n72_), .b(x27), .c(new_n71_), .O(new_n73_));
  nand2  g027(.a(new_n48_), .b(new_n53_), .O(z08));
  ...
  nand2  g068(.a(x18), .b(x13), .O(new_n115_));
  oai22  g069(.a(new_n115_), .b(new_n114_), .c(x18), .d(new_n68_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n94_), .O(new_n117_));
  nand2  g071(.a(new_n110_), .b(x22), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n92_), .c(new_n56_), .O(new_n120_));
  ...
  oai22  g078(.a(new_n115_), .b(new_n124_), .c(x18), .d(new_n71_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n94_), .O(new_n126_));
  nand3  g080(.a(new_n56_), .b(new_n52_), .c(new_n90_), .O(new_n127_));
  nand2  g081(.a(new_n120_), .b(x23), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n66_), .c(new_n61_), .O(new_n130_));
  ...
  oai22  g108(.a(new_n115_), .b(new_n154_), .c(x18), .d(new_n85_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n94_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  inv1   g111(.a(x24), .O(new_n158_));
  nand4  g112(.a(new_n148_), .b(new_n87_), .c(new_n80_), .d(new_n158_), .O(new_n159_));
  ...
  nand3  g116(.a(new_n109_), .b(x19), .c(new_n90_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n53_), .d(new_n90_), .O(new_n164_));
