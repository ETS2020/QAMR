...
module FAU ( 
  ...
  nor2   g033(.a(new_n48_), .b(new_n52_), .O(z08));
  ...
  nor2   g040(.a(new_n81_), .b(x16), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(x00), .O(new_n88_));
  nand3  g042(.a(new_n88_), .b(new_n86_), .c(new_n82_), .O(z09));
  ...
  nand3  g047(.a(new_n93_), .b(new_n51_), .c(new_n83_), .O(new_n94_));
  oai21  g048(.a(new_n85_), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g058(.a(new_n87_), .b(x02), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n104_), .c(new_n98_), .O(z11));
  oai21  g060(.a(x16), .b(x11), .c(new_n81_), .O(new_n107_));
  aoi21  g061(.a(new_n101_), .b(new_n85_), .c(new_n63_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n85_), .c(new_n93_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n87_), .b(x03), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n112_), .c(new_n107_), .O(z12));
  oai21  g068(.a(x16), .b(x12), .c(new_n81_), .O(new_n115_));
  nand2  g069(.a(new_n110_), .b(x23), .O(new_n116_));
  nor2   g070(.a(x23), .b(x22), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n100_), .c(new_n99_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g074(.a(new_n87_), .b(x04), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(z13));
  nand2  g076(.a(x18), .b(x05), .O(new_n123_));
  oai21  g077(.a(x18), .b(new_n69_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  inv1   g079(.a(x23), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n63_), .c(new_n99_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n94_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n109_), .c(new_n129_), .d(new_n83_), .O(new_n131_));
  ...
  oai21  g089(.a(x18), .b(new_n74_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g091(.a(new_n131_), .b(x25), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n117_), .c(new_n101_), .d(new_n85_), .O(new_n140_));
  ...
  oai21  g097(.a(x16), .b(x15), .c(new_n81_), .O(new_n144_));
  nand2  g098(.a(new_n140_), .b(x26), .O(new_n145_));
  nor3   g099(.a(x26), .b(x25), .c(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n117_), .c(new_n101_), .d(new_n85_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n87_), .b(x07), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  nand2  g105(.a(new_n126_), .b(new_n63_), .O(new_n152_));
  inv1   g106(.a(x25), .O(new_n153_));
  inv1   g107(.a(x26), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n71_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g110(.a(new_n101_), .b(x19), .c(new_n83_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n52_), .b(new_n83_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(x18), .c(new_n47_), .O(z17));
endmodule
