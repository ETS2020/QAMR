...
module FAU ( 
  ...
  oai21  g41(.a(x18), .b(x09), .c(new_n85_), .O(new_n88_));
  ...
  nand4  g49(.a(new_n60_), .b(new_n89_), .c(new_n51_), .d(new_n81_), .O(new_n96_));
  ...
  oai22  g54(.a(new_n100_), .b(new_n58_), .c(new_n98_), .d(new_n85_), .O(z11));
  oai21  g55(.a(x18), .b(x11), .c(new_n85_), .O(new_n102_));
  nand2  g56(.a(new_n96_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n83_), .c(new_n89_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n85_), .c(new_n102_), .O(z12));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n91_), .c(new_n105_), .d(x23), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n85_), .c(new_n100_), .d(new_n66_), .O(z13));
  aoi21  g64(.a(new_n108_), .b(new_n91_), .c(new_n71_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n104_), .c(new_n94_), .d(new_n81_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g69(.a(new_n99_), .b(x13), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n115_), .O(z14));
  inv1   g71(.a(x22), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n71_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n97_), .c(new_n113_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n99_), .b(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n85_), .c(new_n124_), .O(z15));
