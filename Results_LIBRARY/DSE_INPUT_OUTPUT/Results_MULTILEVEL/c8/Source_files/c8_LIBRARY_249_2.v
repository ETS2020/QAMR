...
module FAU ( 
  ...
  nor2   g056(.a(new_n102_), .b(new_n54_), .O(new_n103_));
  nor3   g057(.a(x20), .b(x19), .c(x17), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n103_), .c(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n101_), .c(new_n95_), .O(z10));
  nand2  g060(.a(x18), .b(x02), .O(new_n107_));
  nand3  g061(.a(new_n91_), .b(x10), .c(new_n48_), .O(new_n108_));
  ...
  oai21  g066(.a(new_n104_), .b(new_n60_), .c(new_n112_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n95_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n110_), .O(z11));
  nand2  g069(.a(x18), .b(x03), .O(new_n116_));
  nand3  g070(.a(new_n91_), .b(x11), .c(new_n48_), .O(new_n117_));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n104_), .c(new_n75_), .O(new_n139_));
  inv1   g093(.a(x17), .O(new_n140_));
  nor2   g094(.a(x20), .b(x19), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n141_), .d(new_n140_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n139_), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n138_), .c(new_n95_), .O(z14));
  nand3  g100(.a(new_n91_), .b(x14), .c(new_n48_), .O(new_n147_));
  oai21  g101(.a(new_n91_), .b(new_n48_), .c(new_n147_), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n151_), .c(new_n111_), .d(new_n102_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n95_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n149_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  nand3  g111(.a(new_n91_), .b(x15), .c(new_n48_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n162_), .b(new_n151_), .c(new_n111_), .d(new_n102_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n95_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n160_), .O(z16));
  nand4  g120(.a(new_n151_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n167_));
  nand3  g121(.a(new_n111_), .b(x19), .c(new_n140_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n55_), .d(new_n140_), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n95_), .c(x16), .O(new_n170_));
