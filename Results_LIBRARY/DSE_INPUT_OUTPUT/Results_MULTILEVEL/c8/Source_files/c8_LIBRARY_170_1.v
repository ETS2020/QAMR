...
module FAU ( 
  ...
  nand2  g26(.a(new_n58_), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g32(.a(new_n78_), .b(new_n58_), .O(z08));
  ...
  nand4  g49(.a(new_n57_), .b(new_n89_), .c(new_n81_), .d(new_n80_), .O(new_n96_));
  ...
  oai22  g54(.a(new_n100_), .b(new_n55_), .c(new_n98_), .d(new_n85_), .O(z11));
  nor3   g55(.a(x22), .b(x21), .c(x20), .O(new_n102_));
  aoi22  g56(.a(new_n102_), .b(new_n83_), .c(new_n96_), .d(x22), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n85_), .c(new_n100_), .d(new_n61_), .O(z12));
  ...
  nand4  g67(.a(new_n113_), .b(new_n106_), .c(new_n94_), .d(new_n80_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n99_), .b(x13), .O(new_n117_));
  ...
  nand4  g75(.a(new_n72_), .b(new_n111_), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n97_), .c(new_n114_), .d(x25), .O(new_n124_));
  ...
  nand2  g88(.a(new_n99_), .b(x15), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n111_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n80_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n58_), .d(new_n80_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n78_), .O(z17));
endmodule
