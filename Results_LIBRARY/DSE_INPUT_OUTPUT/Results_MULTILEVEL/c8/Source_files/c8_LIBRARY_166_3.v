...
module FAU ( 
  ...
  nand2  g034(.a(new_n52_), .b(new_n79_), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n80_), .c(new_n47_), .O(z06));
  ...
  nand2  g052(.a(new_n79_), .b(x18), .O(new_n99_));
  oai22  g053(.a(new_n99_), .b(new_n98_), .c(x18), .d(new_n55_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  inv1   g055(.a(x20), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n51_), .c(new_n89_), .O(new_n103_));
  oai21  g057(.a(new_n91_), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  ...
  oai22  g070(.a(new_n99_), .b(new_n116_), .c(x18), .d(new_n63_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n93_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n91_), .c(new_n102_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n47_), .c(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n118_), .O(z12));
  inv1   g078(.a(x04), .O(new_n125_));
  oai22  g079(.a(new_n99_), .b(new_n125_), .c(x18), .d(new_n68_), .O(new_n126_));
  ...
  oai22  g088(.a(new_n99_), .b(new_n134_), .c(x18), .d(new_n73_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n93_), .O(new_n136_));
  nand3  g090(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n47_), .O(z15));
  ...
  nor2   g110(.a(new_n85_), .b(new_n93_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(x18), .c(x25), .O(new_n158_));
  nand2  g112(.a(new_n141_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n129_), .c(new_n111_), .d(new_n91_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n156_), .O(z16));
  nand4  g118(.a(new_n129_), .b(new_n85_), .c(new_n79_), .d(new_n75_), .O(new_n165_));
  nand3  g119(.a(new_n111_), .b(x19), .c(new_n89_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n52_), .d(new_n89_), .O(new_n167_));
