...
module FAU ( 
  ...
  nand2  g041(.a(new_n48_), .b(new_n55_), .O(z08));
  ...
  inv1   g053(.a(x06), .O(new_n100_));
  nand2  g054(.a(x18), .b(new_n100_), .O(new_n101_));
  oai22  g055(.a(new_n101_), .b(new_n99_), .c(x18), .d(new_n52_), .O(new_n102_));
  ...
  oai21  g059(.a(new_n92_), .b(new_n54_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n48_), .O(z11));
  ...
  aoi21  g074(.a(new_n113_), .b(new_n92_), .c(new_n65_), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n92_), .c(new_n54_), .O(new_n123_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n122_), .c(new_n104_), .d(new_n89_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n138_), .c(new_n48_), .O(z14));
  inv1   g098(.a(new_n114_), .O(new_n145_));
  ...
  aoi22  g103(.a(new_n149_), .b(new_n145_), .c(new_n141_), .d(x25), .O(new_n150_));
  nor2   g104(.a(x18), .b(x16), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(x14), .c(new_n49_), .O(new_n152_));
  oai21  g106(.a(new_n150_), .b(new_n94_), .c(new_n152_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(x06), .c(x18), .d(new_n83_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n94_), .O(new_n156_));
  nand4  g110(.a(new_n147_), .b(new_n146_), .c(new_n113_), .d(new_n92_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x26), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n146_), .c(new_n113_), .d(new_n92_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n48_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n156_), .O(z16));
  nand4  g117(.a(new_n146_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n164_));
  nand3  g118(.a(new_n113_), .b(x19), .c(new_n89_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n55_), .d(new_n89_), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n48_), .c(x16), .O(new_n167_));
