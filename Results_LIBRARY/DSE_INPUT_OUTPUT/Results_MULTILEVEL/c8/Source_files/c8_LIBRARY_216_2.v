...
module FAU ( 
  ...
  aoi21  g061(.a(new_n102_), .b(new_n87_), .c(new_n65_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n87_), .c(new_n93_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n89_), .b(x03), .O(new_n113_));
  ...
  nand3  g080(.a(new_n93_), .b(new_n51_), .c(new_n85_), .O(new_n127_));
  nand3  g081(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n127_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n109_), .c(new_n130_), .d(new_n85_), .O(new_n132_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n119_), .c(new_n102_), .d(new_n87_), .O(new_n139_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n119_), .c(new_n102_), .d(new_n87_), .O(new_n147_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n119_), .c(new_n152_), .O(new_n154_));
