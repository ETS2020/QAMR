...
module FAU ( 
  ...
  inv1   g041(.a(new_n86_), .O(z08));
  nor2   g042(.a(x26), .b(x18), .O(new_n89_));
  aoi22  g043(.a(new_n89_), .b(x08), .c(x18), .d(x00), .O(new_n90_));
  xnor2a g044(.a(x19), .b(x17), .O(new_n91_));
  nand3  g045(.a(new_n91_), .b(new_n48_), .c(x16), .O(new_n92_));
  oai21  g046(.a(new_n90_), .b(x16), .c(new_n92_), .O(z09));
  aoi22  g047(.a(new_n89_), .b(x09), .c(x18), .d(x01), .O(new_n94_));
  nor2   g048(.a(x19), .b(x17), .O(new_n95_));
  inv1   g049(.a(x17), .O(new_n96_));
  nand3  g050(.a(new_n58_), .b(new_n52_), .c(new_n96_), .O(new_n97_));
  oai21  g051(.a(new_n95_), .b(new_n58_), .c(new_n97_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n48_), .c(x16), .O(new_n99_));
  oai21  g053(.a(new_n94_), .b(x16), .c(new_n99_), .O(z10));
  aoi22  g054(.a(new_n89_), .b(x10), .c(x18), .d(x02), .O(new_n101_));
  nor3   g055(.a(x20), .b(x19), .c(x17), .O(new_n102_));
  nor2   g056(.a(x21), .b(x20), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n95_), .O(new_n104_));
  oai21  g058(.a(new_n102_), .b(new_n63_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g063(.a(x18), .b(new_n66_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  aoi21  g065(.a(x26), .b(new_n47_), .c(x22), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n63_), .c(new_n58_), .d(new_n52_), .O(new_n113_));
  ...
  aoi22  g071(.a(new_n89_), .b(x12), .c(x18), .d(x04), .O(new_n118_));
  nand4  g072(.a(new_n95_), .b(new_n68_), .c(new_n63_), .d(new_n58_), .O(new_n119_));
  ...
  oai21  g078(.a(new_n118_), .b(x16), .c(new_n124_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n78_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n108_), .O(new_n128_));
  aoi21  g082(.a(new_n121_), .b(new_n102_), .c(new_n76_), .O(new_n129_));
  nand4  g083(.a(new_n76_), .b(new_n73_), .c(new_n68_), .d(new_n63_), .O(new_n130_));
  nor2   g084(.a(new_n130_), .b(new_n97_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n129_), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n128_), .c(new_n48_), .O(z14));
  nand2  g087(.a(x18), .b(x06), .O(new_n134_));
  nand2  g088(.a(new_n89_), .b(x14), .O(new_n135_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n103_), .d(new_n95_), .O(new_n140_));
  oai21  g094(.a(new_n131_), .b(new_n81_), .c(new_n140_), .O(new_n141_));
  ...
  nand2  g098(.a(new_n89_), .b(x15), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n108_), .O(new_n147_));
  nand3  g101(.a(new_n140_), .b(x26), .c(x18), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n138_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n104_), .c(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z16));
  nand2  g107(.a(z08), .b(x17), .O(new_n154_));
  nor2   g108(.a(new_n52_), .b(x17), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n149_), .c(new_n138_), .d(new_n103_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n154_), .c(new_n108_), .O(z17));
endmodule
