...
module FAU ( 
  ...
  nand3  g034(.a(x18), .b(x01), .c(x00), .O(new_n81_));
  ...
  nand3  g038(.a(new_n84_), .b(new_n78_), .c(x16), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(new_n83_), .O(z09));
  oai21  g040(.a(x18), .b(x09), .c(new_n80_), .O(new_n87_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n87_), .c(new_n78_), .O(z10));
  nand3  g047(.a(x18), .b(x02), .c(x01), .O(new_n94_));
  ...
  nand3  g054(.a(new_n100_), .b(new_n78_), .c(x16), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n96_), .O(z11));
  nand3  g056(.a(x18), .b(x03), .c(x01), .O(new_n103_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n78_), .c(x16), .O(new_n110_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n78_), .O(z13));
  ...
  aoi21  g078(.a(new_n116_), .b(new_n91_), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n123_), .c(new_n78_), .O(z14));
  nand3  g086(.a(x18), .b(x06), .c(x01), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n98_), .d(new_n89_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n137_), .c(new_n98_), .d(new_n89_), .O(new_n148_));
  ...
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n61_), .d(new_n126_), .O(new_n155_));
