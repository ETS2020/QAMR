...
module FAU ( 
  ...
  nand3  g034(.a(new_n57_), .b(new_n80_), .c(x18), .O(new_n81_));
  oai21  g035(.a(new_n79_), .b(x15), .c(new_n81_), .O(z07));
  inv1   g036(.a(new_n79_), .O(z08));
  ...
  oai21  g063(.a(new_n107_), .b(new_n56_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n78_), .O(z11));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  oai21  g067(.a(new_n96_), .b(new_n60_), .c(new_n113_), .O(new_n114_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n126_), .c(new_n108_), .d(new_n87_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n78_), .O(z15));
  ...
  nand3  g108(.a(new_n136_), .b(new_n84_), .c(x16), .O(new_n155_));
  nand3  g109(.a(new_n146_), .b(new_n117_), .c(new_n67_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n155_), .c(x18), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n80_), .O(new_n158_));
  nand3  g112(.a(new_n147_), .b(x26), .c(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n158_), .c(new_n154_), .O(z16));
  nand2  g114(.a(z08), .b(x17), .O(new_n161_));
  nor2   g115(.a(new_n95_), .b(x17), .O(new_n162_));
  nand2  g116(.a(new_n108_), .b(x19), .O(new_n163_));
  inv1   g117(.a(new_n163_), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(new_n126_), .O(new_n166_));
