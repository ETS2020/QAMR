...
module FAU ( 
  ...
  nand2  g037(.a(new_n68_), .b(new_n55_), .O(z08));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n68_), .O(z09));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  inv1   g049(.a(x18), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n48_), .c(x09), .O(new_n97_));
  ...
  oai21  g055(.a(new_n88_), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n68_), .c(x16), .O(new_n103_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n68_), .O(z11));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n88_), .c(new_n65_), .O(new_n117_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n68_), .O(z12));
  nand2  g076(.a(new_n119_), .b(x23), .O(new_n123_));
  nor3   g077(.a(x23), .b(x22), .c(x21), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n108_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n68_), .c(x16), .O(new_n127_));
  ...
  aoi21  g086(.a(new_n124_), .b(new_n108_), .c(new_n75_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n118_), .c(new_n100_), .d(new_n85_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n132_), .c(new_n68_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  nand3  g093(.a(new_n96_), .b(x14), .c(new_n48_), .O(new_n140_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n88_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n68_), .c(x16), .O(new_n148_));
