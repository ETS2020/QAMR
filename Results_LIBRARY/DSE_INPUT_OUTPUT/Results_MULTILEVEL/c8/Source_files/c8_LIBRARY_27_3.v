...
module FAU ( 
  ...
  nand3  g049(.a(new_n54_), .b(new_n82_), .c(new_n81_), .O(new_n96_));
  oai21  g050(.a(new_n84_), .b(new_n54_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n48_), .O(z11));
  ...
  nand3  g072(.a(new_n118_), .b(new_n112_), .c(new_n48_), .O(z12));
  inv1   g073(.a(x04), .O(new_n120_));
  oai22  g074(.a(new_n93_), .b(new_n120_), .c(x18), .d(new_n64_), .O(new_n121_));
  ...
  oai22  g083(.a(new_n93_), .b(new_n129_), .c(x18), .d(new_n67_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n86_), .O(new_n131_));
  inv1   g085(.a(x23), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n113_), .c(new_n103_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n96_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n81_), .O(new_n137_));
  ...
  inv1   g094(.a(new_n106_), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n124_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  aoi22  g098(.a(new_n144_), .b(new_n141_), .c(new_n137_), .d(x25), .O(new_n145_));
  nor2   g099(.a(x18), .b(x16), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(x14), .c(new_n49_), .O(new_n147_));
  oai21  g101(.a(new_n145_), .b(new_n86_), .c(new_n147_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  oai22  g103(.a(new_n149_), .b(x06), .c(x18), .d(new_n77_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n86_), .O(new_n151_));
  nand4  g105(.a(new_n142_), .b(new_n124_), .c(new_n105_), .d(new_n84_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n105_), .d(new_n84_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n124_), .c(new_n69_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n81_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n81_), .O(new_n162_));
