...
module FAU ( 
  ...
  nand2  g018(.a(new_n51_), .b(x23), .O(new_n65_));
  nand2  g019(.a(new_n65_), .b(x18), .O(new_n66_));
  inv1   g020(.a(x23), .O(new_n67_));
  nand3  g021(.a(new_n51_), .b(new_n67_), .c(x12), .O(new_n68_));
  ...
  nand2  g039(.a(new_n85_), .b(x12), .O(new_n86_));
  ...
  oai21  g055(.a(new_n86_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g064(.a(new_n86_), .b(new_n60_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n81_), .c(x16), .O(new_n117_));
  ...
  aoi21  g085(.a(new_n123_), .b(new_n98_), .c(new_n131_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n130_), .c(new_n81_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n105_), .d(new_n96_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n105_), .d(new_n96_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n144_), .c(new_n131_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n133_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n51_), .d(new_n133_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n81_), .c(x16), .O(new_n163_));
