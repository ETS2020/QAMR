...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x11), .O(new_n47_));
  ...
  aoi21  g025(.a(x27), .b(new_n71_), .c(new_n47_), .O(new_n72_));
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(z07));
  inv1   g032(.a(new_n47_), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n51_), .O(z08));
  inv1   g034(.a(x16), .O(new_n81_));
  nand2  g035(.a(x18), .b(x00), .O(new_n82_));
  nand2  g036(.a(new_n62_), .b(x11), .O(new_n83_));
  ...
  nand3  g040(.a(new_n86_), .b(new_n79_), .c(x16), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(new_n85_), .O(z09));
  nand2  g042(.a(x18), .b(x01), .O(new_n89_));
  oai21  g043(.a(x18), .b(new_n54_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n91_), .c(new_n79_), .O(z10));
  ...
  oai21  g056(.a(new_n95_), .b(new_n59_), .c(new_n102_), .O(new_n103_));
  ...
  nand2  g061(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  nand2  g062(.a(new_n102_), .b(x22), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n93_), .c(new_n92_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n79_), .c(x16), .O(new_n113_));
  ...
  nand2  g070(.a(new_n116_), .b(new_n81_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x23), .O(new_n118_));
  nor2   g072(.a(x23), .b(x22), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n95_), .c(new_n59_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n79_), .O(z13));
  nand2  g077(.a(x18), .b(x05), .O(new_n124_));
  nand3  g078(.a(new_n62_), .b(x13), .c(x11), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n81_), .O(new_n127_));
  inv1   g081(.a(x17), .O(new_n128_));
  nand3  g082(.a(new_n92_), .b(new_n50_), .c(new_n128_), .O(new_n129_));
  inv1   g083(.a(x22), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n59_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n110_), .c(new_n134_), .d(new_n128_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n79_), .c(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n127_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n119_), .c(new_n101_), .d(new_n93_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n79_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  oai21  g103(.a(x18), .b(new_n74_), .c(new_n149_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n119_), .c(new_n101_), .d(new_n93_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n79_), .O(z16));
  inv1   g111(.a(x24), .O(new_n158_));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n119_), .c(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n101_), .b(x19), .c(new_n128_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n51_), .d(new_n128_), .O(new_n162_));
