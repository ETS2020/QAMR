...
module FAU ( 
  ...
  nand3  g078(.a(new_n124_), .b(new_n120_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n119_), .O(z13));
  oai21  g080(.a(x16), .b(x05), .c(x18), .O(new_n127_));
  inv1   g081(.a(x24), .O(new_n128_));
  aoi21  g082(.a(new_n122_), .b(new_n97_), .c(new_n128_), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n110_), .c(new_n130_), .d(new_n88_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n129_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n92_), .b(x13), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n102_), .d(new_n90_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n92_), .b(x14), .O(new_n144_));
  ...
  nand2  g101(.a(new_n147_), .b(new_n116_), .O(new_n148_));
  nand2  g102(.a(new_n141_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n139_), .c(new_n102_), .d(new_n90_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n120_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n139_), .c(new_n128_), .O(new_n156_));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n88_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n88_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n120_), .c(x16), .O(new_n159_));
