...
module FAU ( 
  ...
  nand2  g49(.a(new_n48_), .b(new_n90_), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(new_n52_), .c(new_n95_), .O(z10));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n85_), .O(new_n99_));
  nand4  g53(.a(new_n60_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n90_), .c(new_n96_), .d(new_n58_), .O(z11));
  oai21  g57(.a(x18), .b(x11), .c(new_n90_), .O(new_n104_));
  nand2  g58(.a(new_n100_), .b(x22), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n88_), .c(new_n54_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n90_), .c(new_n104_), .O(z12));
  oai21  g63(.a(x18), .b(x12), .c(new_n90_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n94_), .c(new_n107_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n90_), .c(new_n110_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n90_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n94_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n98_), .d(new_n85_), .O(new_n118_));
  ...
  nand4  g76(.a(new_n78_), .b(new_n115_), .c(new_n70_), .d(new_n65_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n90_), .c(new_n122_), .O(z15));
  nor2   g80(.a(x21), .b(x20), .O(new_n127_));
  nor2   g81(.a(x23), .b(x22), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n88_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x26), .O(new_n131_));
  nor3   g85(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n128_), .c(new_n127_), .d(new_n88_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g89(.a(new_n48_), .b(new_n90_), .c(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  nor2   g91(.a(new_n86_), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n132_), .c(new_n128_), .d(new_n127_), .O(new_n139_));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  aoi21  g94(.a(new_n140_), .b(new_n139_), .c(new_n90_), .O(z17));
endmodule
