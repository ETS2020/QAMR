...
module FAU ( 
  ...
  aoi21  g064(.a(new_n105_), .b(new_n93_), .c(new_n63_), .O(new_n111_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n95_), .c(new_n104_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n92_), .b(new_n51_), .c(new_n85_), .O(new_n130_));
  nand3  g084(.a(new_n68_), .b(new_n63_), .c(new_n104_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n112_), .c(new_n133_), .d(new_n85_), .O(new_n135_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n122_), .c(new_n105_), .d(new_n93_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n122_), .c(new_n105_), .d(new_n93_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n97_), .b(x15), .O(new_n154_));
  ...
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n85_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n103_), .c(x16), .O(new_n161_));
