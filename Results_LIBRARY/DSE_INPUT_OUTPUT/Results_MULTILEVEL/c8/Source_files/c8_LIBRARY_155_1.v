...
module FAU ( 
  ...
  oai21  g49(.a(new_n90_), .b(new_n52_), .c(new_n95_), .O(z10));
  inv1   g50(.a(x16), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  nand4  g53(.a(new_n57_), .b(new_n92_), .c(new_n85_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n97_), .c(new_n90_), .d(new_n55_), .O(z11));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n87_), .c(new_n100_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n97_), .c(new_n90_), .d(new_n61_), .O(z12));
  oai21  g60(.a(x18), .b(x12), .c(new_n97_), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n87_), .c(new_n92_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n94_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n97_), .c(new_n107_), .O(z13));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n94_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n108_), .c(new_n98_), .d(new_n84_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n89_), .b(x13), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  oai21  g74(.a(x18), .b(x14), .c(new_n97_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  nand4  g76(.a(new_n74_), .b(new_n113_), .c(new_n122_), .d(new_n63_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n101_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n97_), .c(new_n121_), .O(z15));
  ...
  nand4  g91(.a(new_n128_), .b(new_n79_), .c(new_n74_), .d(new_n113_), .O(new_n138_));
  nand3  g92(.a(new_n127_), .b(x19), .c(new_n84_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n58_), .d(new_n84_), .O(new_n140_));
