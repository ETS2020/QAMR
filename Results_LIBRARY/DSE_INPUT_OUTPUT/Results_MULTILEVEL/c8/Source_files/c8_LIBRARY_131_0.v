...
module FAU ( 
  ...
  nand3  g048(.a(new_n93_), .b(new_n49_), .c(new_n81_), .O(new_n95_));
  ...
  nand3  g054(.a(new_n100_), .b(x10), .c(x05), .O(new_n101_));
  ...
  aoi21  g067(.a(new_n100_), .b(new_n113_), .c(x22), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n104_), .c(new_n93_), .d(new_n49_), .O(new_n115_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n112_), .c(new_n80_), .O(z12));
  ...
  nand4  g077(.a(new_n83_), .b(new_n123_), .c(new_n104_), .d(new_n93_), .O(new_n124_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n122_), .c(new_n80_), .O(z13));
  nand2  g084(.a(new_n100_), .b(new_n66_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n85_), .c(x05), .O(new_n132_));
  aoi21  g086(.a(new_n126_), .b(new_n96_), .c(new_n68_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nand4  g088(.a(new_n68_), .b(new_n134_), .c(new_n123_), .d(new_n104_), .O(new_n135_));
  nor2   g089(.a(new_n135_), .b(new_n95_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n132_), .c(new_n80_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n105_), .d(new_n83_), .O(new_n145_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n80_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n100_), .b(x15), .c(x05), .O(new_n150_));
  ...
  nand4  g107(.a(new_n143_), .b(new_n76_), .c(new_n142_), .d(new_n68_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n106_), .c(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n80_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n152_), .O(z16));
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n81_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n154_), .c(new_n50_), .d(new_n81_), .O(new_n159_));
