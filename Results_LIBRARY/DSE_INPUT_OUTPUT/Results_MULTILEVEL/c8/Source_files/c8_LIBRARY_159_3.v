...
module FAU ( 
  ...
  oai22  g070(.a(new_n80_), .b(new_n116_), .c(x18), .d(new_n64_), .O(new_n117_));
  ...
  oai22  g079(.a(new_n80_), .b(new_n125_), .c(x18), .d(new_n67_), .O(new_n126_));
  ...
  oai22  g091(.a(new_n80_), .b(new_n137_), .c(x18), .d(new_n70_), .O(new_n138_));
  ...
  nand2  g099(.a(new_n142_), .b(x26), .O(new_n146_));
  nor3   g100(.a(x26), .b(x25), .c(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n120_), .c(new_n102_), .d(new_n90_), .O(new_n148_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n77_), .c(x15), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(z16));
