...
module FAU ( 
  ...
  nand2  g27(.a(new_n54_), .b(new_n73_), .O(new_n74_));
  ...
  nand2  g35(.a(new_n81_), .b(new_n54_), .O(z08));
  ...
  nand4  g53(.a(new_n59_), .b(new_n53_), .c(new_n84_), .d(new_n83_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n89_), .b(x02), .O(new_n103_));
  oai21  g57(.a(new_n102_), .b(new_n97_), .c(new_n103_), .O(z11));
  oai21  g58(.a(new_n88_), .b(x03), .c(new_n97_), .O(new_n105_));
  nand2  g59(.a(new_n100_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n86_), .c(new_n53_), .O(new_n108_));
  ...
  aoi22  g65(.a(new_n111_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n112_));
  nand2  g66(.a(new_n89_), .b(x04), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n97_), .c(new_n113_), .O(z13));
  oai21  g68(.a(new_n88_), .b(x05), .c(new_n97_), .O(new_n115_));
  inv1   g69(.a(x24), .O(new_n116_));
  aoi21  g70(.a(new_n111_), .b(new_n93_), .c(new_n116_), .O(new_n117_));
  ...
  nand4  g78(.a(new_n73_), .b(new_n116_), .c(new_n124_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n101_), .c(new_n119_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n89_), .b(x06), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n97_), .c(new_n128_), .O(z15));
  oai21  g83(.a(new_n88_), .b(x07), .c(new_n97_), .O(new_n130_));
  ...
  nand4  g94(.a(new_n132_), .b(new_n78_), .c(new_n73_), .d(new_n116_), .O(new_n141_));
  nand3  g95(.a(new_n131_), .b(x19), .c(new_n83_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n54_), .d(new_n83_), .O(new_n143_));
