...
module FAU ( 
  ...
  nand2  g053(.a(x20), .b(x18), .O(new_n100_));
  oai22  g054(.a(new_n100_), .b(new_n98_), .c(x18), .d(new_n99_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  nor2   g056(.a(x18), .b(x17), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n47_), .c(new_n52_), .O(new_n104_));
  oai21  g058(.a(new_n91_), .b(new_n47_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n102_), .O(z10));
  inv1   g061(.a(x02), .O(new_n108_));
  oai22  g062(.a(new_n100_), .b(new_n108_), .c(x18), .d(new_n60_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n93_), .O(new_n110_));
  nand2  g064(.a(new_n52_), .b(new_n89_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(x21), .O(new_n112_));
  nor2   g066(.a(x21), .b(x20), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n91_), .O(new_n114_));
  aoi21  g068(.a(new_n114_), .b(new_n112_), .c(x18), .O(new_n115_));
  nor2   g069(.a(new_n58_), .b(new_n47_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n115_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n110_), .O(z11));
  ...
  oai21  g075(.a(new_n65_), .b(new_n93_), .c(x20), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x18), .O(new_n123_));
  aoi21  g077(.a(new_n113_), .b(new_n91_), .c(new_n65_), .O(new_n124_));
  nand2  g078(.a(new_n65_), .b(new_n58_), .O(new_n125_));
  nor3   g079(.a(new_n125_), .b(new_n111_), .c(x20), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n124_), .c(x16), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n123_), .c(new_n121_), .O(z12));
  inv1   g082(.a(x04), .O(new_n129_));
  oai22  g083(.a(new_n100_), .b(new_n129_), .c(x18), .d(new_n70_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n93_), .O(new_n131_));
  oai21  g085(.a(new_n125_), .b(new_n111_), .c(x23), .O(new_n132_));
  nor3   g086(.a(x20), .b(x19), .c(x17), .O(new_n133_));
  nor3   g087(.a(x23), .b(x22), .c(x21), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n132_), .c(x18), .O(new_n136_));
  nor2   g090(.a(new_n68_), .b(new_n47_), .O(new_n137_));
  ...
  oai21  g096(.a(new_n75_), .b(new_n93_), .c(x20), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x18), .O(new_n144_));
  aoi21  g098(.a(new_n134_), .b(new_n133_), .c(new_n75_), .O(new_n145_));
  nand3  g099(.a(new_n47_), .b(new_n52_), .c(new_n89_), .O(new_n146_));
  nand4  g100(.a(new_n75_), .b(new_n68_), .c(new_n65_), .d(new_n58_), .O(new_n147_));
  nor2   g101(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n145_), .c(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n142_), .O(z14));
  ...
  oai21  g107(.a(new_n78_), .b(new_n93_), .c(x20), .O(new_n154_));
  ...
  oai22  g112(.a(new_n158_), .b(new_n114_), .c(new_n148_), .d(new_n78_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n153_), .O(z15));
  inv1   g115(.a(x07), .O(new_n162_));
  oai22  g116(.a(new_n100_), .b(new_n162_), .c(x18), .d(new_n83_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n93_), .O(new_n164_));
  nor2   g118(.a(x21), .b(x19), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n157_), .c(new_n156_), .d(new_n89_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x26), .O(new_n167_));
  nor3   g121(.a(x26), .b(x25), .c(x24), .O(new_n168_));
  nand4  g122(.a(new_n168_), .b(new_n156_), .c(new_n113_), .d(new_n91_), .O(new_n169_));
  aoi21  g123(.a(new_n169_), .b(new_n167_), .c(x18), .O(new_n170_));
  nor2   g124(.a(new_n85_), .b(new_n47_), .O(new_n171_));
  oai21  g125(.a(new_n171_), .b(new_n170_), .c(x16), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(new_n164_), .O(z16));
  nand3  g127(.a(new_n48_), .b(x27), .c(x17), .O(new_n174_));
  nand2  g128(.a(new_n113_), .b(x19), .O(new_n175_));
  inv1   g129(.a(new_n175_), .O(new_n176_));
  nand4  g130(.a(new_n176_), .b(new_n168_), .c(new_n156_), .d(new_n103_), .O(new_n177_));
