...
module FAU ( 
  ...
  nand2  g043(.a(new_n65_), .b(x12), .O(new_n90_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n98_), .c(new_n86_), .O(z10));
  ...
  oai21  g076(.a(new_n65_), .b(x04), .c(new_n88_), .O(new_n123_));
  ...
  aoi21  g086(.a(new_n125_), .b(new_n102_), .c(new_n73_), .O(new_n133_));
  inv1   g087(.a(x17), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n118_), .c(new_n135_), .d(new_n134_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n133_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n132_), .c(new_n86_), .O(z14));
  nand2  g094(.a(x18), .b(x06), .O(new_n141_));
  nand3  g095(.a(new_n65_), .b(x14), .c(x12), .O(new_n142_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n109_), .d(new_n100_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n109_), .d(new_n100_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n146_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n134_), .O(new_n162_));
