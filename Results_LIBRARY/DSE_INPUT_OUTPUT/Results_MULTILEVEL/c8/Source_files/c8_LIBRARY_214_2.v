...
module FAU ( 
  ...
  nand2  g040(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  aoi21  g041(.a(new_n87_), .b(new_n84_), .c(new_n48_), .O(new_n88_));
  aoi21  g042(.a(new_n48_), .b(x00), .c(new_n88_), .O(new_n89_));
  nand3  g043(.a(new_n83_), .b(new_n48_), .c(x08), .O(new_n90_));
  oai21  g044(.a(new_n89_), .b(new_n83_), .c(new_n90_), .O(z09));
  oai21  g045(.a(x16), .b(x09), .c(new_n83_), .O(new_n92_));
  ...
  nor2   g051(.a(new_n83_), .b(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x01), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n97_), .c(new_n92_), .O(z10));
  oai21  g054(.a(x16), .b(x10), .c(new_n83_), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  oai21  g057(.a(new_n96_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nand2  g059(.a(new_n98_), .b(x02), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n105_), .c(new_n101_), .O(z11));
  oai21  g061(.a(x16), .b(x11), .c(new_n83_), .O(new_n108_));
  aoi21  g062(.a(new_n102_), .b(new_n94_), .c(new_n63_), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n94_), .c(new_n93_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n98_), .b(x03), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n96_), .c(new_n57_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n98_), .b(x04), .O(new_n122_));
  ...
  nand3  g080(.a(new_n93_), .b(new_n86_), .c(new_n85_), .O(new_n127_));
  inv1   g081(.a(x23), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n63_), .c(new_n57_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n127_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n110_), .c(new_n131_), .d(new_n85_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(x18), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n126_), .O(z14));
  oai21  g090(.a(x16), .b(x14), .c(new_n83_), .O(new_n137_));
  nand2  g091(.a(new_n133_), .b(x25), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n118_), .c(new_n102_), .d(new_n94_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n98_), .b(x06), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n118_), .c(new_n102_), .d(new_n94_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(x18), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z16));
  nand2  g107(.a(new_n128_), .b(new_n63_), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n76_), .c(new_n71_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n85_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n58_), .b(new_n85_), .O(new_n160_));
