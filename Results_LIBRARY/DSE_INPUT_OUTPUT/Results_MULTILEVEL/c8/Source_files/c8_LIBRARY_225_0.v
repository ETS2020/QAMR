...
module FAU ( 
  ...
  nand2  g053(.a(x24), .b(new_n68_), .O(new_n100_));
  ...
  oai21  g073(.a(new_n100_), .b(new_n63_), .c(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n86_), .O(new_n121_));
  oai21  g075(.a(new_n115_), .b(new_n112_), .c(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n96_), .c(new_n103_), .O(new_n124_));
  ...
  oai21  g083(.a(new_n100_), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n86_), .O(new_n131_));
  and2   g085(.a(new_n124_), .b(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(x18), .c(new_n82_), .O(new_n134_));
  nand3  g088(.a(new_n114_), .b(new_n69_), .c(new_n65_), .O(new_n135_));
  ...
  oai21  g096(.a(new_n142_), .b(new_n86_), .c(x24), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n68_), .O(new_n144_));
  inv1   g098(.a(new_n135_), .O(new_n145_));
  aoi21  g099(.a(new_n145_), .b(new_n96_), .c(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n123_), .b(new_n142_), .c(new_n69_), .O(new_n147_));
  ...
  oai21  g105(.a(new_n100_), .b(new_n75_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n86_), .O(new_n153_));
  nor2   g107(.a(x25), .b(x23), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n114_), .c(new_n133_), .d(new_n82_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n123_), .c(new_n104_), .d(new_n84_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n156_), .c(new_n68_), .O(new_n159_));
  nor2   g113(.a(new_n77_), .b(new_n69_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n159_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n153_), .O(z16));
  nand2  g116(.a(new_n157_), .b(new_n123_), .O(new_n163_));
  nand3  g117(.a(new_n104_), .b(x19), .c(new_n82_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n51_), .d(new_n82_), .O(new_n165_));
