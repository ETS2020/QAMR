...
module FAU ( 
  ...
  nor2   g034(.a(new_n47_), .b(new_n51_), .O(z08));
  ...
  nand3  g046(.a(new_n62_), .b(x11), .c(x09), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n87_), .O(new_n95_));
  nand3  g049(.a(new_n56_), .b(new_n50_), .c(new_n83_), .O(new_n96_));
  oai21  g050(.a(new_n85_), .b(new_n56_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n82_), .c(x16), .O(new_n98_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n82_), .O(z11));
  oai21  g063(.a(new_n62_), .b(x03), .c(new_n87_), .O(new_n110_));
  inv1   g064(.a(x22), .O(new_n111_));
  aoi21  g065(.a(new_n105_), .b(new_n85_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n85_), .c(new_n56_), .O(new_n114_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n104_), .c(new_n103_), .O(new_n123_));
  ...
  nand3  g081(.a(new_n62_), .b(x13), .c(x11), .O(new_n128_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n122_), .c(new_n105_), .d(new_n85_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n122_), .c(new_n105_), .d(new_n85_), .O(new_n154_));
  ...
  nand4  g112(.a(new_n122_), .b(new_n78_), .c(new_n73_), .d(new_n158_), .O(new_n159_));
