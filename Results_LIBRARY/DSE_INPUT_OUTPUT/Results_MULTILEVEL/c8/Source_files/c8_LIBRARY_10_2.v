...
module FAU ( 
  ...
  nand2  g037(.a(new_n63_), .b(new_n55_), .O(z08));
  nor2   g038(.a(x18), .b(x11), .O(new_n85_));
  aoi22  g039(.a(new_n85_), .b(x08), .c(x18), .d(x00), .O(new_n86_));
  xnor2a g040(.a(x19), .b(x17), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n63_), .c(x16), .O(new_n88_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n63_), .O(z10));
  ...
  nand3  g059(.a(new_n105_), .b(new_n63_), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n102_), .O(z11));
  nand2  g061(.a(new_n104_), .b(x22), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n94_), .c(new_n54_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n63_), .c(x16), .O(new_n112_));
  nand3  g066(.a(x18), .b(new_n90_), .c(x03), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n112_), .O(z12));
  nand2  g068(.a(x18), .b(x04), .O(new_n115_));
  inv1   g069(.a(x18), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(x12), .c(new_n48_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n90_), .O(new_n119_));
  nand2  g073(.a(new_n110_), .b(x23), .O(new_n120_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n63_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  nand3  g080(.a(new_n116_), .b(x13), .c(new_n48_), .O(new_n127_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n109_), .c(new_n136_), .d(new_n130_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n63_), .c(x16), .O(new_n140_));
  ...
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n63_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n116_), .b(x15), .c(new_n48_), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n63_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n154_), .O(z16));
  inv1   g114(.a(x24), .O(new_n161_));
  nand4  g115(.a(new_n121_), .b(new_n81_), .c(new_n76_), .d(new_n161_), .O(new_n162_));
  nand3  g116(.a(new_n103_), .b(x19), .c(new_n130_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n55_), .d(new_n130_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n63_), .c(x16), .O(new_n165_));
