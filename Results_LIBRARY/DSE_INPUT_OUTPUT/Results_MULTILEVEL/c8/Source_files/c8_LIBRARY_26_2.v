...
module FAU ( 
  ...
  oai21  g041(.a(x16), .b(x08), .c(new_n87_), .O(new_n88_));
  ...
  nor2   g046(.a(new_n87_), .b(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(x00), .O(new_n94_));
  nand3  g048(.a(new_n94_), .b(new_n92_), .c(new_n88_), .O(z09));
  ...
  nand3  g052(.a(new_n57_), .b(new_n51_), .c(new_n89_), .O(new_n99_));
  oai21  g053(.a(new_n91_), .b(new_n57_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(x18), .c(x16), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n98_), .O(z10));
  oai21  g056(.a(x16), .b(x10), .c(new_n87_), .O(new_n103_));
  nor3   g057(.a(x20), .b(x19), .c(x17), .O(new_n104_));
  nor2   g058(.a(x21), .b(x20), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n91_), .O(new_n106_));
  oai21  g060(.a(new_n104_), .b(new_n62_), .c(new_n106_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g062(.a(new_n93_), .b(x02), .O(new_n109_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n91_), .c(new_n57_), .O(new_n116_));
  ...
  oai21  g073(.a(x16), .b(x12), .c(new_n87_), .O(new_n120_));
  nand2  g074(.a(new_n116_), .b(x23), .O(new_n121_));
  nor2   g075(.a(x23), .b(x22), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n104_), .c(new_n62_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g079(.a(new_n93_), .b(x04), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n120_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(x18), .b(new_n75_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n115_), .c(new_n133_), .d(new_n89_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(x18), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n130_), .O(z14));
  oai21  g092(.a(x16), .b(x14), .c(new_n87_), .O(new_n139_));
  nand2  g093(.a(new_n135_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n105_), .d(new_n91_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n93_), .b(x06), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n144_), .c(new_n139_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  oai21  g101(.a(x18), .b(new_n83_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n47_), .O(new_n149_));
  nand2  g103(.a(new_n142_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n122_), .c(new_n105_), .d(new_n91_), .O(new_n152_));
  ...
  nand2  g109(.a(new_n72_), .b(new_n67_), .O(new_n156_));
  inv1   g110(.a(x24), .O(new_n157_));
  inv1   g111(.a(x26), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n80_), .c(new_n157_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n89_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n52_), .b(new_n89_), .O(new_n163_));
