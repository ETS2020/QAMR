...
module FAU ( 
  ...
  nor2   g013(.a(new_n59_), .b(x08), .O(new_n60_));
  aoi21  g014(.a(x27), .b(new_n58_), .c(new_n60_), .O(new_n61_));
  oai21  g015(.a(x27), .b(x21), .c(new_n61_), .O(z02));
  inv1   g016(.a(x11), .O(new_n63_));
  aoi21  g017(.a(x27), .b(new_n63_), .c(new_n60_), .O(new_n64_));
  oai21  g018(.a(x27), .b(x22), .c(new_n64_), .O(z03));
  inv1   g019(.a(x12), .O(new_n66_));
  aoi21  g020(.a(x27), .b(new_n66_), .c(new_n60_), .O(new_n67_));
  oai21  g021(.a(x27), .b(x23), .c(new_n67_), .O(z04));
  inv1   g022(.a(x13), .O(new_n69_));
  aoi21  g023(.a(x27), .b(new_n69_), .c(new_n60_), .O(new_n70_));
  ...
  aoi21  g029(.a(new_n75_), .b(new_n73_), .c(new_n60_), .O(z06));
  ...
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n60_), .O(z07));
  nor2   g035(.a(new_n60_), .b(new_n55_), .O(z08));
  ...
  aoi21  g041(.a(x18), .b(new_n87_), .c(x16), .O(new_n88_));
  aoi21  g042(.a(new_n86_), .b(x16), .c(new_n88_), .O(new_n89_));
  nand3  g043(.a(new_n86_), .b(new_n59_), .c(x16), .O(new_n90_));
  oai21  g044(.a(new_n89_), .b(new_n47_), .c(new_n90_), .O(z09));
  inv1   g045(.a(x16), .O(new_n92_));
  inv1   g046(.a(x01), .O(new_n93_));
  nand2  g047(.a(x18), .b(x08), .O(new_n94_));
  oai22  g048(.a(new_n94_), .b(new_n93_), .c(x18), .d(new_n52_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  inv1   g050(.a(new_n60_), .O(new_n97_));
  inv1   g051(.a(x17), .O(new_n98_));
  inv1   g052(.a(x19), .O(new_n99_));
  nand3  g053(.a(new_n54_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  oai21  g054(.a(new_n84_), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n106_), .c(new_n97_), .O(z11));
  ...
  aoi21  g071(.a(new_n109_), .b(new_n84_), .c(new_n117_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n84_), .c(new_n54_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n116_), .c(new_n97_), .O(z12));
  ...
  nand3  g085(.a(new_n131_), .b(new_n126_), .c(new_n97_), .O(z13));
  inv1   g086(.a(x05), .O(new_n133_));
  oai22  g087(.a(new_n94_), .b(new_n133_), .c(x18), .d(new_n69_), .O(new_n134_));
  ...
  oai21  g091(.a(new_n137_), .b(new_n100_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n139_), .d(new_n98_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n97_), .c(x16), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n128_), .c(new_n109_), .d(new_n84_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n97_), .O(z15));
  inv1   g107(.a(x07), .O(new_n154_));
  oai22  g108(.a(new_n94_), .b(new_n154_), .c(x18), .d(new_n77_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n128_), .c(new_n109_), .d(new_n84_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n97_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n156_), .O(z16));
  inv1   g116(.a(x24), .O(new_n163_));
  nand4  g117(.a(new_n128_), .b(new_n79_), .c(new_n74_), .d(new_n163_), .O(new_n164_));
  nand3  g118(.a(new_n109_), .b(x19), .c(new_n98_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n55_), .d(new_n98_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n97_), .O(z17));
endmodule
