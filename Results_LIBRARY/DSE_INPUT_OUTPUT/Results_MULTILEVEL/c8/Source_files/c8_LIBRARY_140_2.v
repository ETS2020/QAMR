...
module FAU ( 
  ...
  nor2   g045(.a(x18), .b(x13), .O(new_n92_));
  ...
  nor2   g055(.a(new_n101_), .b(new_n58_), .O(new_n102_));
  ...
  nand2  g060(.a(new_n92_), .b(x10), .O(new_n107_));
  ...
  nand2  g064(.a(new_n110_), .b(new_n101_), .O(new_n111_));
  ...
  aoi21  g071(.a(new_n47_), .b(x13), .c(x22), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n63_), .c(new_n58_), .d(new_n52_), .O(new_n119_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n130_), .c(new_n110_), .d(new_n101_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n47_), .b(x15), .c(new_n78_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n97_), .O(new_n155_));
  nand2  g109(.a(new_n148_), .b(x26), .O(new_n156_));
  nand4  g110(.a(new_n130_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n110_), .b(x19), .c(new_n161_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n157_), .c(new_n53_), .d(new_n161_), .O(new_n163_));
