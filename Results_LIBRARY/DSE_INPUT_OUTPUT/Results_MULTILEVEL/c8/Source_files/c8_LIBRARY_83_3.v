...
module FAU ( 
  ...
  nand3  g067(.a(new_n113_), .b(new_n87_), .c(new_n93_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n103_), .c(x16), .O(new_n116_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n103_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n120_), .O(z13));
  oai21  g080(.a(x16), .b(x05), .c(x18), .O(new_n127_));
  aoi21  g081(.a(new_n122_), .b(new_n95_), .c(new_n71_), .O(new_n128_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n104_), .d(new_n87_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n129_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n58_), .d(new_n129_), .O(new_n158_));
