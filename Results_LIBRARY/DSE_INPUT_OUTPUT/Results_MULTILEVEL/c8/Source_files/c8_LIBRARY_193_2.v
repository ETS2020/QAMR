...
module FAU ( 
  ...
  oai21  g049(.a(new_n85_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n85_), .c(new_n93_), .O(new_n112_));
  ...
  nand2  g075(.a(new_n87_), .b(x04), .O(new_n122_));
  ...
  aoi21  g079(.a(new_n118_), .b(new_n100_), .c(new_n125_), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n111_), .c(new_n94_), .d(new_n83_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n126_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n87_), .b(x05), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n124_), .O(z14));
  nand2  g086(.a(x18), .b(x06), .O(new_n133_));
  oai21  g087(.a(x18), .b(new_n72_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g089(.a(new_n128_), .b(x25), .O(new_n136_));
  nor2   g090(.a(x23), .b(x22), .O(new_n137_));
  nor2   g091(.a(x25), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n101_), .d(new_n85_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n137_), .c(new_n101_), .d(new_n85_), .O(new_n148_));
  ...
  inv1   g105(.a(x22), .O(new_n152_));
  inv1   g106(.a(x23), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  inv1   g108(.a(x25), .O(new_n155_));
  nand3  g109(.a(new_n77_), .b(new_n155_), .c(new_n125_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n83_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n52_), .b(new_n83_), .O(new_n160_));
