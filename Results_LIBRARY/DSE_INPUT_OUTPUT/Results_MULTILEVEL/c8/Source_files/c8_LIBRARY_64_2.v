...
module FAU ( 
  ...
  aoi21  g029(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z06));
  inv1   g030(.a(x26), .O(new_n77_));
  oai21  g031(.a(x27), .b(new_n77_), .c(new_n47_), .O(new_n78_));
  nand3  g032(.a(new_n52_), .b(new_n77_), .c(x18), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n78_), .O(z07));
  ...
  nand3  g049(.a(new_n95_), .b(new_n91_), .c(new_n81_), .O(z10));
  aoi22  g050(.a(new_n83_), .b(x10), .c(x18), .d(x02), .O(new_n97_));
  inv1   g051(.a(x21), .O(new_n98_));
  nor2   g052(.a(x21), .b(x20), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n92_), .O(new_n100_));
  oai21  g054(.a(new_n94_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n81_), .c(x16), .O(new_n102_));
  oai21  g056(.a(new_n97_), .b(x16), .c(new_n102_), .O(z11));
  inv1   g057(.a(new_n83_), .O(new_n104_));
  ...
  nand2  g061(.a(new_n100_), .b(x22), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n92_), .c(new_n57_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n81_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n107_), .O(z12));
  nand2  g067(.a(x18), .b(x04), .O(new_n114_));
  oai21  g068(.a(new_n104_), .b(new_n66_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n88_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n81_), .c(x16), .O(new_n121_));
  ...
  aoi21  g080(.a(new_n118_), .b(new_n94_), .c(new_n126_), .O(new_n127_));
  inv1   g081(.a(x17), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n109_), .c(new_n129_), .d(new_n128_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n127_), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n125_), .c(new_n81_), .O(z14));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n99_), .d(new_n92_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(new_n81_), .O(z15));
  nand2  g098(.a(new_n141_), .b(x26), .O(new_n145_));
  nor3   g099(.a(x26), .b(x25), .c(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n139_), .c(new_n99_), .d(new_n92_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  inv1   g103(.a(x18), .O(new_n150_));
  nor2   g104(.a(new_n150_), .b(x16), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(x07), .c(new_n48_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(z16));
  nand4  g107(.a(new_n139_), .b(new_n77_), .c(new_n74_), .d(new_n126_), .O(new_n154_));
  nand3  g108(.a(new_n99_), .b(x19), .c(new_n128_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n128_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n81_), .c(x16), .O(new_n157_));
