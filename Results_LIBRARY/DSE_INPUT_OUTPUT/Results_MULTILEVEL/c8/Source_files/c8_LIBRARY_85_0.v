...
module FAU ( 
  ...
  inv1   g24(.a(x26), .O(new_n71_));
  inv1   g25(.a(x27), .O(new_n72_));
  nand2  g26(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  aoi21  g27(.a(new_n73_), .b(new_n70_), .c(new_n48_), .O(z07));
  oai21  g28(.a(x18), .b(x16), .c(new_n72_), .O(z08));
  ...
  oai21  g38(.a(new_n82_), .b(x01), .c(new_n81_), .O(new_n85_));
  inv1   g39(.a(x20), .O(new_n86_));
  nor2   g40(.a(new_n79_), .b(new_n86_), .O(new_n87_));
  ...
  oai21  g44(.a(new_n82_), .b(x02), .c(new_n81_), .O(new_n91_));
  nor2   g45(.a(x20), .b(x19), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n76_), .O(new_n93_));
  inv1   g47(.a(x21), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n86_), .c(new_n77_), .d(new_n76_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n81_), .c(new_n91_), .O(z11));
  nand2  g52(.a(new_n95_), .b(x22), .O(new_n99_));
  nor2   g53(.a(x22), .b(x21), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n79_), .c(new_n86_), .O(new_n101_));
  and2   g55(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nor2   g56(.a(new_n82_), .b(x16), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x03), .O(new_n104_));
  oai21  g58(.a(new_n102_), .b(new_n81_), .c(new_n104_), .O(z12));
  oai21  g59(.a(new_n82_), .b(x04), .c(new_n81_), .O(new_n106_));
  nor3   g60(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n88_), .c(new_n101_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n81_), .c(new_n106_), .O(z13));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n88_), .c(new_n110_), .O(new_n111_));
  ...
  nand2  g69(.a(new_n103_), .b(x05), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n115_), .O(z14));
  oai21  g71(.a(new_n82_), .b(x06), .c(new_n81_), .O(new_n118_));
  inv1   g72(.a(x22), .O(new_n119_));
  inv1   g73(.a(x23), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n110_), .c(new_n120_), .d(new_n119_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n96_), .c(new_n113_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n81_), .c(new_n118_), .O(z15));
