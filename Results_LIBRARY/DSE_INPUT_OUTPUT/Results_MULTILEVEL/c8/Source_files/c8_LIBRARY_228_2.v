...
module FAU ( 
  ...
  oai21  g039(.a(new_n50_), .b(x04), .c(new_n52_), .O(new_n86_));
  oai21  g040(.a(new_n50_), .b(x15), .c(new_n86_), .O(z07));
  nor2   g041(.a(new_n54_), .b(new_n50_), .O(z08));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n91_), .c(new_n66_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n115_), .c(new_n53_), .O(z12));
  inv1   g076(.a(x18), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(x16), .c(x26), .O(new_n124_));
  ...
  nand3  g084(.a(new_n123_), .b(new_n93_), .c(x12), .O(new_n131_));
  ...
  aoi21  g089(.a(new_n127_), .b(new_n102_), .c(new_n78_), .O(new_n136_));
  nand3  g090(.a(new_n56_), .b(new_n49_), .c(new_n89_), .O(new_n137_));
  nand3  g091(.a(new_n118_), .b(new_n78_), .c(new_n73_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(new_n135_), .c(new_n54_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  oai21  g096(.a(x18), .b(new_n81_), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n108_), .d(new_n91_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n144_), .c(new_n53_), .O(z15));
  inv1   g105(.a(x15), .O(new_n152_));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  oai21  g107(.a(x18), .b(new_n152_), .c(new_n153_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n53_), .c(new_n93_), .O(new_n155_));
  nand2  g109(.a(new_n148_), .b(x26), .O(new_n156_));
  nor2   g110(.a(x17), .b(x04), .O(new_n157_));
  nor3   g111(.a(x21), .b(x20), .c(x19), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n146_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n155_), .O(z16));
  nand4  g117(.a(new_n146_), .b(new_n52_), .c(new_n83_), .d(new_n78_), .O(new_n164_));
  nand3  g118(.a(new_n108_), .b(x19), .c(new_n89_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n50_), .d(new_n89_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n53_), .O(z17));
endmodule
