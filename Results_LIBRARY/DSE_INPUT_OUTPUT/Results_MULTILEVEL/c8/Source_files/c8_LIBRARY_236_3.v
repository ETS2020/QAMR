...
module FAU ( 
  ...
  aoi21  g063(.a(new_n103_), .b(new_n86_), .c(new_n67_), .O(new_n110_));
  ...
  nand2  g068(.a(new_n88_), .b(x11), .O(new_n115_));
  ...
  aoi21  g080(.a(new_n119_), .b(new_n102_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n111_), .c(new_n96_), .d(new_n84_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n103_), .d(new_n86_), .O(new_n138_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n103_), .d(new_n86_), .O(new_n148_));
  ...
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n84_), .O(new_n158_));
  ...
  aoi21  g115(.a(new_n161_), .b(new_n95_), .c(new_n91_), .O(z17));
endmodule
