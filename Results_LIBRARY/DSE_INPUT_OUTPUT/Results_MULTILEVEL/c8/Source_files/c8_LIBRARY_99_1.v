...
module FAU ( 
  ...
  nand2  g37(.a(new_n47_), .b(new_n83_), .O(new_n84_));
  oai21  g38(.a(new_n84_), .b(new_n49_), .c(new_n82_), .O(z09));
  ...
  oai21  g45(.a(x18), .b(x10), .c(new_n83_), .O(new_n92_));
  nor2   g46(.a(x20), .b(x19), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n79_), .O(new_n94_));
  inv1   g48(.a(x21), .O(new_n95_));
  nand4  g49(.a(new_n95_), .b(new_n87_), .c(new_n51_), .d(new_n79_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n94_), .b(x21), .c(new_n97_), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(new_n83_), .c(new_n92_), .O(z11));
  nor3   g53(.a(x22), .b(x21), .c(x20), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n81_), .c(new_n96_), .d(x22), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n83_), .c(new_n84_), .d(new_n61_), .O(z12));
  oai21  g56(.a(x18), .b(x12), .c(new_n83_), .O(new_n103_));
  ...
  oai21  g61(.a(new_n107_), .b(new_n83_), .c(new_n103_), .O(z13));
  oai21  g62(.a(x18), .b(x13), .c(new_n83_), .O(new_n109_));
  aoi21  g63(.a(new_n106_), .b(new_n89_), .c(new_n69_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n104_), .c(new_n93_), .d(new_n79_), .O(new_n112_));
  ...
  oai21  g69(.a(x18), .b(x14), .c(new_n83_), .O(new_n116_));
  inv1   g70(.a(x22), .O(new_n117_));
  inv1   g71(.a(x23), .O(new_n118_));
  inv1   g72(.a(x25), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n69_), .c(new_n118_), .d(new_n117_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n97_), .c(new_n112_), .d(x25), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n83_), .c(new_n116_), .O(z15));
  nor2   g77(.a(x21), .b(x20), .O(new_n124_));
  nor2   g78(.a(x23), .b(x22), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n81_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n125_), .c(new_n124_), .d(new_n81_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g86(.a(new_n47_), .b(new_n83_), .c(x15), .O(new_n133_));
