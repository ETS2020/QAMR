...
module FAU ( 
  ...
  nand3  g042(.a(new_n88_), .b(new_n87_), .c(x08), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n86_), .c(new_n81_), .O(z09));
  ...
  nand3  g047(.a(new_n54_), .b(new_n83_), .c(new_n82_), .O(new_n94_));
  oai21  g048(.a(new_n85_), .b(new_n54_), .c(new_n94_), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n88_), .c(x16), .O(new_n96_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n88_), .c(x16), .O(new_n123_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n120_), .c(new_n102_), .d(new_n85_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n88_), .b(new_n87_), .c(x14), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n120_), .c(new_n102_), .d(new_n85_), .O(new_n150_));
  ...
  nand2  g107(.a(new_n68_), .b(new_n128_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n102_), .b(x19), .c(new_n82_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n55_), .b(new_n82_), .O(new_n162_));
  aoi21  g116(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n88_), .c(new_n87_), .O(z17));
endmodule
