...
module FAU ( 
  ...
  nor2   g28(.a(new_n48_), .b(new_n57_), .O(z08));
  ...
  nor2   g35(.a(new_n81_), .b(x16), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(x00), .O(new_n83_));
  ...
  nand2  g42(.a(new_n82_), .b(x01), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n88_), .O(z10));
  inv1   g44(.a(x16), .O(new_n91_));
  nor2   g45(.a(x20), .b(x19), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n76_), .O(new_n93_));
  nand4  g47(.a(new_n56_), .b(new_n85_), .c(new_n77_), .d(new_n76_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  aoi21  g49(.a(new_n93_), .b(x21), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n82_), .b(x02), .O(new_n97_));
  oai21  g51(.a(new_n96_), .b(new_n91_), .c(new_n97_), .O(z11));
  nand2  g52(.a(new_n94_), .b(x22), .O(new_n99_));
  nor2   g53(.a(x22), .b(x21), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n79_), .c(new_n85_), .O(new_n101_));
  and2   g55(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g56(.a(new_n82_), .b(x03), .O(new_n103_));
  oai21  g57(.a(new_n102_), .b(new_n91_), .c(new_n103_), .O(z12));
  oai21  g58(.a(new_n81_), .b(x04), .c(new_n91_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n87_), .c(new_n101_), .d(x23), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n91_), .c(new_n105_), .O(z13));
  oai21  g62(.a(new_n81_), .b(x05), .c(new_n91_), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n106_), .b(new_n87_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n100_), .c(new_n92_), .d(new_n76_), .O(new_n113_));
  ...
  inv1   g70(.a(x22), .O(new_n117_));
  inv1   g71(.a(x23), .O(new_n118_));
  inv1   g72(.a(x25), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n110_), .c(new_n118_), .d(new_n117_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n95_), .c(new_n113_), .d(x25), .O(new_n122_));
  nand2  g76(.a(new_n82_), .b(x06), .O(new_n123_));
  oai21  g77(.a(new_n122_), .b(new_n91_), .c(new_n123_), .O(z15));
  oai21  g78(.a(new_n81_), .b(x07), .c(new_n91_), .O(new_n125_));
  nor2   g79(.a(x21), .b(x20), .O(new_n126_));
  nor2   g80(.a(x23), .b(x22), .O(new_n127_));
  nor2   g81(.a(x25), .b(x24), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n79_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n127_), .c(new_n126_), .d(new_n79_), .O(new_n132_));
