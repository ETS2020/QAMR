...
module FAU ( 
  ...
  oai21  g59(.a(new_n88_), .b(x03), .c(new_n87_), .O(new_n106_));
  nand2  g60(.a(new_n100_), .b(x22), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n85_), .c(new_n92_), .O(new_n109_));
  and2   g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n87_), .c(new_n106_), .O(z12));
