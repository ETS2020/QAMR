...
module FAU ( 
  ...
  aoi21  g027(.a(x27), .b(x18), .c(new_n48_), .O(new_n74_));
  ...
  nand2  g035(.a(new_n81_), .b(new_n55_), .O(z08));
  ...
  nand3  g051(.a(new_n54_), .b(new_n84_), .c(new_n83_), .O(new_n98_));
  oai21  g052(.a(new_n86_), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g074(.a(new_n95_), .b(new_n66_), .c(new_n120_), .O(new_n121_));
  ...
  oai21  g083(.a(new_n95_), .b(new_n71_), .c(new_n129_), .O(new_n130_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n83_), .O(new_n137_));
  ...
  nand3  g098(.a(new_n137_), .b(x25), .c(x18), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n124_), .c(new_n106_), .d(new_n86_), .O(new_n147_));
  ...
  oai21  g107(.a(new_n78_), .b(new_n88_), .c(x18), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x25), .O(new_n155_));
  nand2  g109(.a(new_n137_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n124_), .c(new_n106_), .d(new_n86_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n124_), .b(new_n78_), .c(new_n48_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n83_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n83_), .O(new_n165_));
