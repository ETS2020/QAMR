...
module FAU ( 
  ...
  nand2  g058(.a(new_n88_), .b(x02), .O(new_n105_));
  ...
  nand3  g080(.a(new_n68_), .b(new_n63_), .c(new_n57_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n95_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n111_), .c(new_n129_), .d(new_n83_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n118_), .c(new_n101_), .d(new_n86_), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n118_), .c(new_n101_), .d(new_n86_), .O(new_n147_));
