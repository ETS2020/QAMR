...
module FAU ( 
  ...
  nand2  g037(.a(new_n83_), .b(new_n57_), .O(z08));
  ...
  nand3  g056(.a(new_n102_), .b(x10), .c(x01), .O(new_n103_));
  ...
  oai21  g061(.a(new_n98_), .b(new_n56_), .c(new_n107_), .O(new_n108_));
  ...
  nand3  g065(.a(new_n102_), .b(x11), .c(x01), .O(new_n112_));
  ...
  nand3  g075(.a(new_n102_), .b(x12), .c(x01), .O(new_n122_));
  ...
  aoi21  g087(.a(new_n126_), .b(new_n98_), .c(new_n72_), .O(new_n134_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n133_), .c(new_n83_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n102_), .b(x14), .c(x01), .O(new_n143_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n106_), .d(new_n86_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n83_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n145_), .O(z15));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n102_), .b(x15), .c(x01), .O(new_n154_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n147_), .c(new_n106_), .d(new_n86_), .O(new_n159_));
  ...
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n57_), .d(new_n135_), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n83_), .c(x16), .O(new_n167_));
