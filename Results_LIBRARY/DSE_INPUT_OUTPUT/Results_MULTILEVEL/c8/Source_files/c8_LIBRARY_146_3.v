...
module FAU ( 
  ...
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n47_), .O(z10));
  ...
  nand3  g064(.a(new_n110_), .b(new_n105_), .c(new_n47_), .O(z11));
  inv1   g065(.a(x03), .O(new_n112_));
  nand2  g066(.a(x18), .b(new_n66_), .O(new_n113_));
  oai22  g067(.a(new_n113_), .b(new_n112_), .c(x18), .d(new_n61_), .O(new_n114_));
  ...
  nand2  g076(.a(new_n69_), .b(x12), .O(new_n123_));
  oai21  g077(.a(new_n113_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n90_), .O(new_n125_));
  nand2  g079(.a(new_n118_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n100_), .c(new_n106_), .O(new_n128_));
  ...
  oai22  g086(.a(new_n113_), .b(new_n132_), .c(x18), .d(new_n72_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n90_), .O(new_n134_));
  nand3  g088(.a(new_n98_), .b(new_n51_), .c(new_n86_), .O(new_n135_));
  nand3  g089(.a(new_n67_), .b(new_n63_), .c(new_n106_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n117_), .c(new_n138_), .d(new_n86_), .O(new_n140_));
  ...
  oai22  g098(.a(new_n113_), .b(new_n144_), .c(x18), .d(new_n77_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n90_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n127_), .c(new_n107_), .d(new_n88_), .O(new_n149_));
  ...
  oai21  g107(.a(x18), .b(new_n82_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n127_), .c(new_n107_), .d(new_n88_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n127_), .c(new_n74_), .O(new_n163_));
  nand3  g117(.a(new_n107_), .b(x19), .c(new_n86_), .O(new_n164_));
