...
module FAU ( 
  ...
  aoi21  g012(.a(x27), .b(new_n58_), .c(new_n51_), .O(new_n59_));
  oai21  g013(.a(x27), .b(x21), .c(new_n59_), .O(z02));
  inv1   g014(.a(x11), .O(new_n61_));
  aoi21  g015(.a(x27), .b(new_n61_), .c(new_n51_), .O(new_n62_));
  oai21  g016(.a(x27), .b(x22), .c(new_n62_), .O(z03));
  inv1   g017(.a(x12), .O(new_n64_));
  aoi21  g018(.a(x27), .b(new_n64_), .c(new_n51_), .O(new_n65_));
  ...
  aoi21  g024(.a(new_n70_), .b(new_n68_), .c(new_n51_), .O(z05));
  inv1   g025(.a(x14), .O(new_n72_));
  aoi21  g026(.a(x27), .b(new_n72_), .c(new_n51_), .O(new_n73_));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n51_), .O(z07));
  nor2   g033(.a(new_n51_), .b(new_n55_), .O(z08));
  nand3  g034(.a(x19), .b(new_n47_), .c(x17), .O(new_n81_));
  oai21  g035(.a(x19), .b(x17), .c(new_n81_), .O(new_n82_));
  nand2  g036(.a(new_n82_), .b(x16), .O(new_n83_));
  inv1   g037(.a(x16), .O(new_n84_));
  inv1   g038(.a(x00), .O(new_n85_));
  nand2  g039(.a(new_n47_), .b(x08), .O(new_n86_));
  nand2  g040(.a(new_n48_), .b(x18), .O(new_n87_));
  oai21  g041(.a(new_n87_), .b(new_n85_), .c(new_n86_), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand2  g043(.a(new_n89_), .b(new_n83_), .O(z09));
  inv1   g044(.a(x01), .O(new_n91_));
  oai22  g045(.a(new_n87_), .b(new_n91_), .c(x18), .d(new_n52_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n84_), .O(new_n93_));
  inv1   g047(.a(x17), .O(new_n94_));
  nor2   g048(.a(new_n54_), .b(new_n94_), .O(new_n95_));
  nor2   g049(.a(x20), .b(x17), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(new_n48_), .O(new_n97_));
  nand3  g051(.a(x20), .b(x19), .c(new_n47_), .O(new_n98_));
  ...
  oai21  g072(.a(new_n106_), .b(new_n116_), .c(new_n118_), .O(new_n119_));
  nor3   g073(.a(new_n116_), .b(new_n48_), .c(x18), .O(new_n120_));
  aoi21  g074(.a(new_n119_), .b(new_n48_), .c(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n84_), .c(new_n115_), .O(z12));
  ...
  oai21  g080(.a(new_n126_), .b(new_n84_), .c(new_n47_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x19), .O(new_n128_));
  aoi21  g082(.a(new_n117_), .b(new_n96_), .c(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n54_), .b(new_n48_), .c(new_n94_), .O(new_n130_));
  ...
  oai22  g090(.a(new_n87_), .b(new_n136_), .c(x18), .d(new_n67_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n84_), .O(new_n138_));
  nand3  g092(.a(new_n131_), .b(new_n96_), .c(new_n109_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x24), .O(new_n140_));
  nor3   g094(.a(x24), .b(x23), .c(x22), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n106_), .O(new_n142_));
  aoi21  g096(.a(new_n142_), .b(new_n140_), .c(x19), .O(new_n143_));
  nor3   g097(.a(new_n69_), .b(new_n48_), .c(x18), .O(new_n144_));
  ...
  oai21  g104(.a(new_n150_), .b(new_n84_), .c(new_n47_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x19), .O(new_n152_));
  aoi21  g106(.a(new_n141_), .b(new_n106_), .c(new_n150_), .O(new_n153_));
  nor2   g107(.a(x21), .b(x20), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n48_), .c(new_n94_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n152_), .c(new_n149_), .O(z15));
  inv1   g114(.a(x07), .O(new_n161_));
  oai22  g115(.a(new_n87_), .b(new_n161_), .c(x18), .d(new_n75_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n84_), .O(new_n163_));
  nand4  g117(.a(new_n156_), .b(new_n131_), .c(new_n154_), .d(new_n94_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor2   g119(.a(x24), .b(x23), .O(new_n166_));
  nor2   g120(.a(x26), .b(x25), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n166_), .c(new_n117_), .d(new_n96_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n165_), .c(x19), .O(new_n169_));
  nor3   g123(.a(new_n77_), .b(new_n48_), .c(x18), .O(new_n170_));
  oai21  g124(.a(new_n170_), .b(new_n169_), .c(x16), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n163_), .O(z16));
  inv1   g126(.a(new_n51_), .O(new_n173_));
  nand3  g127(.a(new_n154_), .b(x19), .c(new_n94_), .O(new_n174_));
  nand3  g128(.a(new_n167_), .b(new_n131_), .c(new_n69_), .O(new_n175_));
  oai22  g129(.a(new_n175_), .b(new_n174_), .c(new_n55_), .d(new_n94_), .O(new_n176_));
