...
module FAU ( 
  ...
  nor2   g015(.a(new_n48_), .b(new_n52_), .O(new_n62_));
  oai21  g016(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  inv1   g017(.a(x18), .O(new_n64_));
  nand3  g018(.a(new_n48_), .b(new_n52_), .c(new_n64_), .O(new_n65_));
  ...
  nand2  g049(.a(x21), .b(x18), .O(new_n96_));
  oai22  g050(.a(new_n96_), .b(new_n95_), .c(x18), .d(new_n50_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  xnor2a g052(.a(x19), .b(x17), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n53_), .c(x16), .O(new_n100_));
  ...
  nor2   g059(.a(new_n105_), .b(new_n55_), .O(new_n106_));
  nor3   g060(.a(x20), .b(x19), .c(x17), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n106_), .c(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n104_), .c(new_n53_), .O(z10));
  inv1   g063(.a(x02), .O(new_n110_));
  oai22  g064(.a(new_n96_), .b(new_n110_), .c(x18), .d(new_n60_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n94_), .O(new_n112_));
  nor2   g066(.a(new_n107_), .b(new_n52_), .O(new_n113_));
  ...
  nand3  g076(.a(new_n67_), .b(new_n55_), .c(new_n47_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n122_), .c(new_n64_), .O(new_n124_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n105_), .c(new_n55_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x23), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n107_), .c(new_n52_), .O(new_n139_));
  ...
  oai22  g097(.a(new_n96_), .b(new_n143_), .c(x18), .d(new_n78_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n94_), .O(new_n145_));
  nand3  g099(.a(new_n138_), .b(new_n105_), .c(new_n55_), .O(new_n146_));
  ...
  aoi21  g103(.a(new_n149_), .b(new_n147_), .c(x18), .O(new_n150_));
  nor2   g104(.a(new_n80_), .b(new_n52_), .O(new_n151_));
  ...
  nand2  g122(.a(new_n168_), .b(x18), .O(new_n169_));
