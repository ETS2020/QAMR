...
module FAU ( 
  ...
  nand2  g030(.a(x27), .b(x25), .O(new_n77_));
  oai21  g031(.a(x25), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  nand2  g032(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  inv1   g033(.a(x25), .O(new_n80_));
  nand3  g034(.a(new_n51_), .b(new_n80_), .c(x18), .O(new_n81_));
  nand2  g035(.a(new_n81_), .b(new_n79_), .O(z06));
  ...
  nor2   g053(.a(new_n90_), .b(new_n56_), .O(new_n100_));
  ...
  nand3  g058(.a(new_n104_), .b(new_n99_), .c(new_n86_), .O(z10));
  nand2  g059(.a(x18), .b(x02), .O(new_n106_));
  nand2  g060(.a(x25), .b(new_n76_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n59_), .c(new_n106_), .O(new_n108_));
  ...
  oai21  g066(.a(new_n103_), .b(new_n110_), .c(new_n112_), .O(new_n113_));
  ...
  nor2   g072(.a(new_n47_), .b(x22), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n110_), .c(new_n56_), .d(new_n50_), .O(new_n120_));
  ...
  aoi21  g093(.a(new_n131_), .b(new_n103_), .c(new_n139_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n128_), .c(new_n101_), .d(new_n88_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n86_), .O(z14));
  nand2  g099(.a(x18), .b(x06), .O(new_n146_));
  oai21  g100(.a(new_n107_), .b(new_n75_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n92_), .O(new_n148_));
  nor2   g102(.a(new_n76_), .b(x17), .O(new_n149_));
  nor3   g103(.a(x25), .b(x24), .c(x23), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n128_), .d(new_n101_), .O(new_n151_));
  oai21  g105(.a(new_n143_), .b(new_n80_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  oai21  g109(.a(new_n107_), .b(new_n83_), .c(new_n155_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n92_), .O(new_n157_));
  nand2  g111(.a(new_n142_), .b(x26), .O(new_n158_));
  nor2   g112(.a(x23), .b(x22), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n159_), .c(new_n111_), .d(new_n90_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n158_), .c(new_n76_), .O(new_n162_));
  and2   g116(.a(x26), .b(x25), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(new_n162_), .c(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n157_), .O(z16));
  nand2  g119(.a(new_n160_), .b(new_n159_), .O(new_n166_));
  nand3  g120(.a(new_n111_), .b(x19), .c(new_n88_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n51_), .d(new_n88_), .O(new_n168_));
