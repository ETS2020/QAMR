...
module FAU ( 
  ...
  nand2  g035(.a(new_n48_), .b(new_n58_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  inv1   g037(.a(x00), .O(new_n84_));
  inv1   g038(.a(x05), .O(new_n85_));
  nand2  g039(.a(x18), .b(new_n85_), .O(new_n86_));
  oai22  g040(.a(new_n86_), .b(new_n84_), .c(x18), .d(new_n47_), .O(new_n87_));
  ...
  oai22  g057(.a(new_n86_), .b(new_n103_), .c(x18), .d(new_n55_), .O(new_n104_));
  ...
  oai22  g066(.a(new_n86_), .b(new_n112_), .c(x18), .d(new_n61_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n83_), .O(new_n114_));
  nand2  g068(.a(new_n108_), .b(x22), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n96_), .c(new_n95_), .O(new_n117_));
  ...
  oai22  g075(.a(new_n86_), .b(new_n121_), .c(x18), .d(new_n64_), .O(new_n122_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n48_), .c(x16), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n123_), .O(z13));
  aoi21  g083(.a(new_n125_), .b(new_n106_), .c(new_n69_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n116_), .c(new_n98_), .d(new_n97_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  inv1   g088(.a(x18), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n83_), .c(x13), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n134_), .c(new_n48_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  oai22  g092(.a(new_n138_), .b(x05), .c(x18), .d(new_n72_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n83_), .O(new_n140_));
  nand2  g094(.a(new_n132_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n107_), .d(new_n96_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n48_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n140_), .O(z15));
  nand2  g101(.a(x18), .b(x07), .O(new_n148_));
  oai22  g102(.a(new_n148_), .b(x05), .c(x18), .d(new_n77_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n107_), .d(new_n96_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n142_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x19), .c(new_n97_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n58_), .d(new_n97_), .O(new_n159_));
