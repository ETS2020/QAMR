...
module FAU ( 
  ...
  nor2   g028(.a(x27), .b(new_n74_), .O(new_n75_));
  oai22  g029(.a(new_n75_), .b(x15), .c(x27), .d(x26), .O(z07));
  inv1   g030(.a(new_n47_), .O(new_n77_));
  nand2  g031(.a(new_n77_), .b(new_n51_), .O(z08));
  inv1   g032(.a(x17), .O(new_n79_));
  nor2   g033(.a(new_n50_), .b(new_n79_), .O(new_n80_));
  ...
  oai21  g038(.a(x18), .b(new_n48_), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g042(.a(x18), .b(new_n54_), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n90_), .c(new_n77_), .O(z10));
  ...
  nand3  g057(.a(new_n103_), .b(new_n98_), .c(new_n77_), .O(z11));
  ...
  aoi21  g061(.a(new_n100_), .b(new_n81_), .c(new_n62_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n81_), .c(new_n91_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n77_), .O(z12));
  nand2  g067(.a(x18), .b(x04), .O(new_n114_));
  nand2  g068(.a(new_n74_), .b(x15), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n65_), .c(new_n114_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n83_), .O(new_n117_));
  nand2  g071(.a(new_n110_), .b(x23), .O(new_n118_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n77_), .c(x16), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n117_), .O(z13));
  nand2  g077(.a(x18), .b(x05), .O(new_n124_));
  oai21  g078(.a(new_n115_), .b(new_n68_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n83_), .O(new_n126_));
  nand3  g080(.a(new_n91_), .b(new_n50_), .c(new_n79_), .O(new_n127_));
  inv1   g081(.a(x23), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n62_), .c(new_n99_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n127_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n109_), .c(new_n131_), .d(new_n79_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n77_), .c(x16), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n119_), .c(new_n100_), .d(new_n81_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n77_), .O(z15));
  oai21  g099(.a(new_n74_), .b(x07), .c(new_n83_), .O(new_n146_));
  nand2  g100(.a(new_n142_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n119_), .c(new_n100_), .d(new_n81_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n119_), .c(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n100_), .b(x19), .c(new_n79_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n51_), .d(new_n79_), .O(new_n157_));
