...
module FAU ( 
  ...
  nand2  g022(.a(new_n53_), .b(new_n67_), .O(new_n69_));
  nand3  g023(.a(new_n69_), .b(new_n68_), .c(new_n48_), .O(z03));
  ...
  nand2  g062(.a(new_n67_), .b(new_n47_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n61_), .c(new_n108_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n96_), .O(new_n111_));
  nand3  g065(.a(new_n56_), .b(new_n52_), .c(new_n92_), .O(new_n112_));
  nand2  g066(.a(x22), .b(new_n47_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n112_), .c(x21), .O(new_n114_));
  nand4  g068(.a(new_n48_), .b(new_n63_), .c(new_n56_), .d(new_n52_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(x17), .c(new_n114_), .O(new_n116_));
  ...
  nor2   g078(.a(new_n124_), .b(new_n67_), .O(new_n125_));
  nor3   g079(.a(x22), .b(x21), .c(x20), .O(new_n126_));
  and2   g080(.a(new_n126_), .b(new_n94_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n125_), .c(x16), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n121_), .c(new_n48_), .O(z12));
  ...
  nand2  g086(.a(new_n123_), .b(x23), .O(new_n133_));
  nor2   g087(.a(x23), .b(x21), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n94_), .c(new_n56_), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n133_), .c(x22), .O(new_n136_));
  nand3  g090(.a(x23), .b(x22), .c(x18), .O(new_n137_));
  ...
  nand2  g099(.a(new_n135_), .b(x24), .O(new_n146_));
  nor2   g100(.a(x24), .b(x23), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n105_), .c(new_n67_), .d(new_n63_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n143_), .O(z14));
  nand2  g105(.a(x18), .b(x06), .O(new_n152_));
  oai21  g106(.a(new_n109_), .b(new_n81_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n96_), .O(new_n154_));
  nand3  g108(.a(new_n78_), .b(new_n71_), .c(new_n63_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n112_), .c(x25), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n134_), .c(new_n105_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n156_), .c(x22), .O(new_n159_));
  nand3  g113(.a(x25), .b(x22), .c(x18), .O(new_n160_));
  ...
  oai21  g118(.a(x18), .b(new_n86_), .c(new_n164_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n96_), .O(new_n166_));
  oai21  g120(.a(new_n88_), .b(new_n96_), .c(x18), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x22), .O(new_n168_));
  nand2  g122(.a(new_n158_), .b(x26), .O(new_n169_));
  nor2   g123(.a(x23), .b(x22), .O(new_n170_));
  nor3   g124(.a(x26), .b(x25), .c(x24), .O(new_n171_));
  nand3  g125(.a(new_n171_), .b(new_n170_), .c(new_n124_), .O(new_n172_));
  ...
  nand4  g131(.a(new_n177_), .b(new_n171_), .c(new_n170_), .d(new_n122_), .O(new_n178_));
  aoi21  g132(.a(new_n178_), .b(new_n176_), .c(new_n96_), .O(z17));
endmodule
