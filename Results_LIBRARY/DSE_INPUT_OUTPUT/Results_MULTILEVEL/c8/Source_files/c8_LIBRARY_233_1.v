...
module FAU ( 
  ...
  nand2  g050(.a(x18), .b(x07), .O(new_n97_));
  oai22  g051(.a(new_n97_), .b(new_n96_), .c(x18), .d(new_n52_), .O(new_n98_));
  ...
  oai22  g069(.a(new_n97_), .b(new_n115_), .c(x18), .d(new_n63_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n91_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x22), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n89_), .c(new_n54_), .O(new_n120_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n126_), .c(new_n87_), .O(z13));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n109_), .c(new_n75_), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n119_), .c(new_n101_), .d(new_n100_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n135_), .c(new_n87_), .O(z14));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n110_), .d(new_n89_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n144_), .c(new_n87_), .O(z15));
  oai21  g105(.a(x18), .b(x15), .c(new_n91_), .O(new_n152_));
  nand2  g106(.a(new_n148_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n146_), .c(new_n110_), .d(new_n89_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n87_), .O(z16));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n146_), .c(new_n75_), .O(new_n160_));
  nand3  g114(.a(new_n110_), .b(x19), .c(new_n100_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n100_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n87_), .O(z17));
endmodule
