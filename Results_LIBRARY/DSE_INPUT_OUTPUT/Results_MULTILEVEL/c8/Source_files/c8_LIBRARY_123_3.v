// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:00 2020
...
module FAU ( 
  ...
  nor2   g052(.a(new_n89_), .b(new_n57_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n98_), .c(new_n52_), .O(z10));
  inv1   g056(.a(x02), .O(new_n103_));
  inv1   g057(.a(x06), .O(new_n104_));
  nand2  g058(.a(x18), .b(new_n104_), .O(new_n105_));
  oai22  g059(.a(new_n105_), .b(new_n103_), .c(x18), .d(new_n60_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n91_), .O(new_n107_));
  nand4  g061(.a(new_n62_), .b(new_n57_), .c(new_n49_), .d(new_n87_), .O(new_n108_));
  oai21  g062(.a(new_n100_), .b(new_n62_), .c(new_n108_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n52_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n107_), .O(z11));
  ...
  aoi21  g068(.a(x18), .b(x06), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n62_), .c(new_n57_), .d(new_n49_), .O(new_n116_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n52_), .O(z12));
  inv1   g074(.a(x04), .O(new_n121_));
  oai22  g075(.a(new_n105_), .b(new_n121_), .c(x18), .d(new_n68_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n91_), .O(new_n123_));
  nor2   g077(.a(x22), .b(x21), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n89_), .c(new_n57_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n100_), .c(new_n62_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n52_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n123_), .O(z13));
  inv1   g085(.a(x05), .O(new_n132_));
  oai22  g086(.a(new_n105_), .b(new_n132_), .c(x18), .d(new_n73_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  nand3  g088(.a(new_n57_), .b(new_n49_), .c(new_n87_), .O(new_n135_));
  inv1   g089(.a(x22), .O(new_n136_));
  nand3  g090(.a(new_n70_), .b(new_n136_), .c(new_n62_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n135_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n124_), .c(new_n139_), .d(new_n87_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n52_), .c(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n134_), .O(z14));
  nand2  g098(.a(new_n141_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x21), .b(x20), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n127_), .c(new_n146_), .d(new_n89_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n52_), .c(x16), .O(new_n150_));
  inv1   g104(.a(x18), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n91_), .c(x14), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(z15));
  ...
  nand2  g110(.a(new_n148_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n127_), .c(new_n146_), .d(new_n89_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n52_), .O(z16));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n127_), .c(new_n75_), .O(new_n164_));
  nand3  g118(.a(new_n146_), .b(x19), .c(new_n87_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n50_), .d(new_n87_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n52_), .O(z17));
endmodule
