...
module FAU ( 
  ...
  nand2  g034(.a(x18), .b(new_n55_), .O(new_n81_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n90_), .c(new_n97_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n47_), .O(z13));
  inv1   g074(.a(x05), .O(new_n121_));
  oai22  g075(.a(new_n81_), .b(new_n121_), .c(x18), .d(new_n69_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n79_), .O(new_n123_));
  inv1   g077(.a(x17), .O(new_n124_));
  nand3  g078(.a(new_n56_), .b(new_n51_), .c(new_n124_), .O(new_n125_));
  inv1   g079(.a(x22), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n97_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n125_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n107_), .c(new_n130_), .d(new_n124_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n47_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n123_), .O(z14));
  inv1   g089(.a(x06), .O(new_n136_));
  oai22  g090(.a(new_n81_), .b(new_n136_), .c(x18), .d(new_n72_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n79_), .O(new_n138_));
  nand2  g092(.a(new_n132_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x25), .b(x24), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n116_), .c(new_n98_), .d(new_n88_), .O(new_n141_));
  ...
  oai21  g099(.a(x18), .b(new_n75_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n79_), .O(new_n147_));
  nand2  g101(.a(new_n141_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n116_), .c(new_n98_), .d(new_n88_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n47_), .O(z16));
  inv1   g107(.a(x24), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n116_), .c(new_n154_), .O(new_n156_));
  nand3  g110(.a(new_n98_), .b(x19), .c(new_n124_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n124_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n47_), .O(z17));
endmodule
