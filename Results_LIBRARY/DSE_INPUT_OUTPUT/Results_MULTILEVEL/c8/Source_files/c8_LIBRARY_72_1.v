...
module FAU ( 
  ...
  nand2  g052(.a(x18), .b(x12), .O(new_n99_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n108_), .c(new_n53_), .O(z11));
  ...
  aoi21  g078(.a(x18), .b(new_n124_), .c(x16), .O(new_n125_));
  ...
  aoi21  g083(.a(new_n129_), .b(x16), .c(new_n125_), .O(new_n130_));
  inv1   g084(.a(x18), .O(new_n131_));
  nand3  g085(.a(new_n129_), .b(new_n131_), .c(x16), .O(new_n132_));
  oai21  g086(.a(new_n130_), .b(new_n52_), .c(new_n132_), .O(z13));
  ...
  aoi21  g090(.a(new_n127_), .b(new_n109_), .c(new_n75_), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n119_), .O(new_n139_));
  ...
  oai22  g097(.a(new_n99_), .b(new_n143_), .c(x18), .d(new_n80_), .O(new_n144_));
  ...
  oai21  g102(.a(new_n140_), .b(new_n78_), .c(new_n148_), .O(new_n149_));
  ...
  nand4  g109(.a(new_n146_), .b(new_n83_), .c(new_n78_), .d(new_n75_), .O(new_n156_));
  ...
  nand3  g113(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n48_), .d(new_n89_), .O(new_n161_));
