...
module FAU ( 
  ...
  nand3  g41(.a(x18), .b(new_n87_), .c(x00), .O(new_n88_));
  ...
  oai21  g49(.a(new_n90_), .b(x02), .c(new_n87_), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  nand4  g52(.a(new_n59_), .b(new_n53_), .c(new_n83_), .d(new_n82_), .O(new_n99_));
  ...
  oai21  g66(.a(new_n90_), .b(x05), .c(new_n87_), .O(new_n113_));
  ...
  nand4  g75(.a(new_n75_), .b(new_n114_), .c(new_n121_), .d(new_n64_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n124_));
  nand3  g78(.a(x18), .b(new_n87_), .c(x06), .O(new_n125_));
  oai21  g79(.a(new_n124_), .b(new_n87_), .c(new_n125_), .O(z15));
  oai21  g80(.a(new_n90_), .b(x07), .c(new_n87_), .O(new_n127_));
  ...
  nor2   g91(.a(new_n83_), .b(x17), .O(new_n138_));
