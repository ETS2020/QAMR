...
module FAU ( 
  ...
  nor2   g45(.a(new_n85_), .b(new_n53_), .O(new_n92_));
  ...
  oai21  g57(.a(new_n88_), .b(x03), .c(new_n87_), .O(new_n104_));
  nand2  g58(.a(new_n100_), .b(x22), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n85_), .c(new_n53_), .O(new_n107_));
  ...
  nand3  g65(.a(x18), .b(new_n87_), .c(x04), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n87_), .c(new_n112_), .O(z13));
  oai21  g67(.a(new_n88_), .b(x05), .c(new_n87_), .O(new_n114_));
  ...
  nand4  g77(.a(new_n73_), .b(new_n115_), .c(new_n123_), .d(new_n62_), .O(new_n124_));
  ...
  oai21  g81(.a(new_n88_), .b(x07), .c(new_n87_), .O(new_n128_));
  ...
  nand4  g93(.a(new_n130_), .b(new_n78_), .c(new_n73_), .d(new_n115_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n82_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n54_), .d(new_n82_), .O(new_n142_));
