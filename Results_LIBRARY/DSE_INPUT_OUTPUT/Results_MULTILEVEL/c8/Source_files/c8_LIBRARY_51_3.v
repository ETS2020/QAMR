...
module FAU ( 
  ...
  nand2  g034(.a(x18), .b(new_n69_), .O(new_n81_));
  ...
  nand3  g038(.a(new_n84_), .b(new_n47_), .c(x16), .O(new_n85_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n89_), .c(new_n47_), .O(z10));
  ...
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(new_n47_), .O(z11));
  ...
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n47_), .O(z13));
  oai21  g075(.a(x18), .b(new_n79_), .c(x13), .O(new_n122_));
  inv1   g076(.a(x24), .O(new_n123_));
  aoi21  g077(.a(new_n117_), .b(new_n93_), .c(new_n123_), .O(new_n124_));
  inv1   g078(.a(x17), .O(new_n125_));
  nor2   g079(.a(x20), .b(x19), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n108_), .c(new_n126_), .d(new_n125_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n124_), .c(x16), .O(new_n130_));
  nand3  g084(.a(x18), .b(new_n79_), .c(x05), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n122_), .O(z14));
  inv1   g086(.a(x06), .O(new_n133_));
  oai22  g087(.a(new_n81_), .b(new_n133_), .c(x18), .d(new_n72_), .O(new_n134_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n99_), .d(new_n91_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n137_), .c(new_n99_), .d(new_n91_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n47_), .O(z16));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n137_), .c(new_n123_), .O(new_n153_));
  nand3  g107(.a(new_n99_), .b(x19), .c(new_n125_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n52_), .d(new_n125_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n47_), .O(z17));
endmodule
