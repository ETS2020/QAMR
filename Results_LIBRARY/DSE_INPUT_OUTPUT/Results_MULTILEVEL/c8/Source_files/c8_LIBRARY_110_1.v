...
module FAU ( 
  ...
  nor2   g024(.a(x27), .b(x18), .O(new_n71_));
  oai22  g025(.a(new_n71_), .b(x12), .c(x27), .d(x23), .O(z04));
  ...
  nor2   g041(.a(new_n55_), .b(new_n48_), .O(z08));
  ...
  nand3  g057(.a(new_n103_), .b(new_n100_), .c(new_n53_), .O(z10));
  ...
  oai21  g063(.a(new_n102_), .b(new_n61_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(new_n53_), .O(z11));
  inv1   g066(.a(x03), .O(new_n113_));
  nand2  g067(.a(x18), .b(x12), .O(new_n114_));
  oai22  g068(.a(new_n114_), .b(new_n113_), .c(x18), .d(new_n68_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n93_), .O(new_n116_));
  nand2  g070(.a(new_n109_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n91_), .c(new_n58_), .O(new_n119_));
  ...
  aoi21  g077(.a(x18), .b(new_n123_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n119_), .b(x23), .O(new_n125_));
  nor2   g079(.a(x23), .b(x22), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n102_), .c(new_n61_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(x16), .c(new_n124_), .O(new_n129_));
  inv1   g083(.a(x18), .O(new_n130_));
  nand3  g084(.a(new_n128_), .b(new_n130_), .c(x16), .O(new_n131_));
  oai21  g085(.a(new_n129_), .b(new_n52_), .c(new_n131_), .O(z13));
  inv1   g086(.a(x05), .O(new_n133_));
  oai22  g087(.a(new_n114_), .b(new_n133_), .c(x18), .d(new_n75_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  nand2  g089(.a(new_n127_), .b(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n118_), .c(new_n102_), .O(new_n138_));
  ...
  oai22  g096(.a(new_n114_), .b(new_n142_), .c(x18), .d(new_n80_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n93_), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n126_), .c(new_n108_), .d(new_n91_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n114_), .b(new_n151_), .c(x18), .d(new_n83_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n93_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nand4  g108(.a(new_n126_), .b(new_n85_), .c(new_n78_), .d(new_n73_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n109_), .c(new_n154_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n53_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n153_), .O(z16));
  nand3  g112(.a(new_n108_), .b(x19), .c(new_n89_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n48_), .d(new_n89_), .O(new_n160_));
