...
module FAU ( 
  ...
  nand2  g022(.a(new_n48_), .b(new_n67_), .O(new_n69_));
  nand3  g023(.a(new_n69_), .b(new_n68_), .c(new_n53_), .O(z03));
  ...
  nor2   g045(.a(x22), .b(x18), .O(new_n92_));
  ...
  nor2   g057(.a(new_n95_), .b(new_n58_), .O(new_n104_));
  inv1   g058(.a(x17), .O(new_n105_));
  nand3  g059(.a(new_n58_), .b(new_n47_), .c(new_n105_), .O(new_n106_));
  inv1   g060(.a(new_n106_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n104_), .c(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n103_), .c(new_n53_), .O(z10));
  nand2  g063(.a(x18), .b(x02), .O(new_n110_));
  oai21  g064(.a(x18), .b(new_n61_), .c(new_n110_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n100_), .O(new_n112_));
  nor2   g066(.a(x21), .b(x20), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n95_), .O(new_n114_));
  oai21  g068(.a(new_n107_), .b(new_n63_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n112_), .c(new_n53_), .O(z11));
  nand2  g071(.a(x18), .b(x03), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n66_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n100_), .O(new_n120_));
  aoi21  g074(.a(new_n113_), .b(new_n95_), .c(new_n67_), .O(new_n121_));
  nand3  g075(.a(new_n67_), .b(new_n63_), .c(new_n58_), .O(new_n122_));
  nor2   g076(.a(new_n122_), .b(new_n96_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n121_), .c(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n120_), .c(new_n53_), .O(z12));
  inv1   g079(.a(new_n92_), .O(new_n126_));
  nand2  g080(.a(x18), .b(x04), .O(new_n127_));
  oai21  g081(.a(new_n126_), .b(new_n71_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n100_), .O(new_n129_));
  nand2  g083(.a(new_n114_), .b(x23), .O(new_n130_));
  nor2   g084(.a(x23), .b(x21), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n95_), .c(new_n58_), .O(new_n132_));
  aoi21  g086(.a(new_n132_), .b(new_n130_), .c(x22), .O(new_n133_));
  nand3  g087(.a(x23), .b(x22), .c(x18), .O(new_n134_));
  ...
  nand2  g093(.a(new_n139_), .b(new_n100_), .O(new_n140_));
  oai21  g094(.a(new_n78_), .b(new_n100_), .c(x18), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x22), .O(new_n142_));
  nand2  g096(.a(new_n132_), .b(x24), .O(new_n143_));
  nor2   g097(.a(x24), .b(x23), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n67_), .c(new_n63_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n106_), .c(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n140_), .O(z14));
  nand2  g102(.a(x18), .b(x06), .O(new_n149_));
  oai21  g103(.a(new_n126_), .b(new_n81_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n100_), .O(new_n151_));
  nand3  g105(.a(new_n78_), .b(new_n73_), .c(new_n63_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n106_), .c(x25), .O(new_n153_));
  nor2   g107(.a(x20), .b(x19), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n131_), .c(new_n154_), .d(new_n105_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n153_), .c(x22), .O(new_n157_));
  nand3  g111(.a(x25), .b(x22), .c(x18), .O(new_n158_));
  ...
  nand3  g126(.a(new_n53_), .b(x27), .c(x17), .O(new_n173_));
  nor2   g127(.a(new_n47_), .b(x17), .O(new_n174_));
  nor2   g128(.a(x23), .b(x22), .O(new_n175_));
  nor3   g129(.a(x26), .b(x25), .c(x24), .O(new_n176_));
  nand4  g130(.a(new_n176_), .b(new_n175_), .c(new_n174_), .d(new_n113_), .O(new_n177_));
  aoi21  g131(.a(new_n177_), .b(new_n173_), .c(new_n100_), .O(z17));
endmodule
