...
module FAU ( 
  ...
  oai21  g024(.a(new_n48_), .b(x25), .c(new_n52_), .O(new_n71_));
  ...
  nand2  g034(.a(new_n48_), .b(new_n79_), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n80_), .c(new_n53_), .O(z06));
  ...
  oai21  g056(.a(new_n91_), .b(new_n55_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  aoi21  g058(.a(new_n104_), .b(new_n100_), .c(new_n60_), .O(z10));
  ...
  aoi21  g062(.a(new_n101_), .b(new_n89_), .c(new_n63_), .O(new_n109_));
  ...
  aoi21  g067(.a(new_n113_), .b(new_n108_), .c(new_n60_), .O(z11));
  ...
  aoi21  g071(.a(x25), .b(new_n52_), .c(x22), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n63_), .c(new_n55_), .d(new_n47_), .O(new_n119_));
  ...
  oai21  g084(.a(new_n130_), .b(new_n128_), .c(new_n79_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n52_), .O(new_n132_));
  nand3  g086(.a(new_n129_), .b(new_n91_), .c(new_n55_), .O(new_n133_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n53_), .c(new_n93_), .O(new_n138_));
  nand2  g092(.a(new_n133_), .b(new_n79_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n52_), .c(new_n73_), .O(new_n140_));
  nor2   g094(.a(x23), .b(x22), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n79_), .c(new_n73_), .O(new_n142_));
  nor2   g096(.a(new_n142_), .b(new_n111_), .O(new_n143_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n53_), .c(new_n93_), .O(new_n148_));
  nor2   g102(.a(new_n79_), .b(new_n52_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n143_), .c(x16), .O(new_n150_));
  ...
  nand3  g108(.a(new_n101_), .b(new_n89_), .c(x16), .O(new_n155_));
  nand3  g109(.a(new_n129_), .b(new_n83_), .c(new_n73_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n155_), .c(new_n79_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n52_), .O(new_n158_));
  nor2   g112(.a(new_n143_), .b(new_n83_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n158_), .c(new_n154_), .O(z16));
  nand3  g115(.a(new_n53_), .b(x27), .c(x17), .O(new_n162_));
  nor2   g116(.a(new_n47_), .b(x17), .O(new_n163_));
  nor3   g117(.a(x26), .b(x25), .c(x24), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n163_), .c(new_n141_), .d(new_n110_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n162_), .c(new_n93_), .O(z17));
endmodule
