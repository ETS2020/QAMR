...
module FAU ( 
  ...
  nand2  g063(.a(new_n90_), .b(x10), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n109_), .c(new_n103_), .O(z11));
  ...
  nand3  g072(.a(new_n118_), .b(new_n97_), .c(x16), .O(new_n119_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n97_), .c(x16), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n123_), .O(z13));
  oai21  g083(.a(x16), .b(x05), .c(x18), .O(new_n130_));
  inv1   g084(.a(x24), .O(new_n131_));
  aoi21  g085(.a(new_n125_), .b(new_n105_), .c(new_n131_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n116_), .c(new_n98_), .d(new_n86_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n90_), .b(x13), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n136_), .c(new_n130_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n88_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n97_), .c(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n141_), .O(z15));
  oai21  g102(.a(x16), .b(x07), .c(x18), .O(new_n149_));
  nand2  g103(.a(new_n145_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n143_), .c(new_n106_), .d(new_n88_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n90_), .b(x15), .O(new_n155_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n78_), .c(new_n131_), .O(new_n159_));
  ...
  nor2   g116(.a(new_n52_), .b(new_n86_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n97_), .c(new_n93_), .O(z17));
endmodule
