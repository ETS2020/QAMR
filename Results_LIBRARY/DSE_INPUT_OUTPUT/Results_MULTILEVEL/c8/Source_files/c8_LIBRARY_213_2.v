...
module FAU ( 
  ...
  oai21  g028(.a(x27), .b(new_n74_), .c(new_n47_), .O(new_n75_));
  nand3  g029(.a(new_n52_), .b(new_n74_), .c(x18), .O(new_n76_));
  nand2  g030(.a(new_n76_), .b(new_n75_), .O(z06));
  ...
  oai21  g067(.a(new_n113_), .b(new_n61_), .c(new_n111_), .O(new_n114_));
  ...
  oai21  g085(.a(new_n113_), .b(new_n71_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n89_), .O(new_n133_));
  nand3  g087(.a(new_n97_), .b(new_n51_), .c(new_n85_), .O(new_n134_));
  nand3  g088(.a(new_n68_), .b(new_n63_), .c(new_n105_), .O(new_n135_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n126_), .c(new_n106_), .d(new_n87_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n83_), .c(x16), .O(new_n147_));
  nand3  g101(.a(x18), .b(new_n89_), .c(x06), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n147_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  nand3  g104(.a(new_n112_), .b(x15), .c(new_n47_), .O(new_n151_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n126_), .c(new_n106_), .d(new_n87_), .O(new_n156_));
  ...
  nand4  g114(.a(new_n126_), .b(new_n80_), .c(new_n74_), .d(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n106_), .b(x19), .c(new_n85_), .O(new_n162_));
