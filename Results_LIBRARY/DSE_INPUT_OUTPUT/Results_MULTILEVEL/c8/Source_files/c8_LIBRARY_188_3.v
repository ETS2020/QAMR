...
module FAU ( 
  ...
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n48_), .O(z12));
  ...
  nand4  g108(.a(new_n154_), .b(new_n127_), .c(new_n109_), .d(new_n90_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g111(.a(x18), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n83_), .c(x15), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n157_), .c(new_n48_), .O(z16));
  inv1   g114(.a(x24), .O(new_n161_));
  nand4  g115(.a(new_n127_), .b(new_n79_), .c(new_n74_), .d(new_n161_), .O(new_n162_));
  nand3  g116(.a(new_n109_), .b(x19), .c(new_n99_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n58_), .d(new_n99_), .O(new_n164_));
