...
module FAU ( 
  ...
  nand3  g041(.a(new_n83_), .b(new_n47_), .c(x08), .O(new_n88_));
  oai21  g042(.a(new_n87_), .b(new_n83_), .c(new_n88_), .O(z09));
  oai21  g043(.a(x16), .b(x09), .c(new_n83_), .O(new_n90_));
  ...
  nor2   g049(.a(new_n83_), .b(x16), .O(new_n96_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n92_), .c(new_n91_), .O(new_n113_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n94_), .c(new_n102_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g076(.a(new_n96_), .b(x04), .O(new_n123_));
  ...
  nand3  g082(.a(new_n91_), .b(new_n51_), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n112_), .c(new_n132_), .d(new_n128_), .O(new_n134_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n119_), .c(new_n103_), .d(new_n92_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n96_), .b(x07), .O(new_n152_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n76_), .c(new_n155_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n128_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n52_), .b(new_n128_), .O(new_n161_));
