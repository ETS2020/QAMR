...
module FAU ( 
  ...
  aoi21  g079(.a(new_n120_), .b(new_n95_), .c(new_n73_), .O(new_n126_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n101_), .d(new_n87_), .O(new_n138_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n101_), .d(new_n87_), .O(new_n148_));
  ...
  nand3  g110(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n157_));
