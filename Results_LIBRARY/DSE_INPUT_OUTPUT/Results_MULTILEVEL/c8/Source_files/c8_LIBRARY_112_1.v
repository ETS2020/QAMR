...
module FAU ( 
  ...
  nand2  g49(.a(new_n95_), .b(new_n52_), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(new_n50_), .c(new_n94_), .O(z09));
  oai21  g51(.a(x18), .b(x09), .c(new_n52_), .O(new_n98_));
  ...
  oai22  g65(.a(new_n111_), .b(new_n52_), .c(new_n96_), .d(new_n67_), .O(z12));
  oai21  g66(.a(x18), .b(x12), .c(new_n52_), .O(new_n113_));
  nor2   g67(.a(x22), .b(x21), .O(new_n114_));
  nand3  g68(.a(new_n114_), .b(new_n93_), .c(new_n55_), .O(new_n115_));
  nor3   g69(.a(x23), .b(x22), .c(x21), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n100_), .c(new_n115_), .d(x23), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n52_), .c(new_n113_), .O(z13));
  aoi21  g72(.a(new_n116_), .b(new_n100_), .c(new_n75_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n114_), .c(new_n104_), .d(new_n91_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g77(.a(new_n95_), .b(new_n52_), .c(x13), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n123_), .O(z14));
  oai21  g79(.a(x18), .b(x14), .c(new_n52_), .O(new_n126_));
  nand4  g80(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n107_), .c(new_n121_), .d(x25), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n52_), .c(new_n126_), .O(z15));
  oai21  g84(.a(x18), .b(x15), .c(new_n52_), .O(new_n131_));
  ...
  nand4  g95(.a(new_n133_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n142_));
  nand3  g96(.a(new_n132_), .b(x19), .c(new_n91_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n48_), .d(new_n91_), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g99(.a(new_n145_), .b(new_n53_), .O(z17));
endmodule
