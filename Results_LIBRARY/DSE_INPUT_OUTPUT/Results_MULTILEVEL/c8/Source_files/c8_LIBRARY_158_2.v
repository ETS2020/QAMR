...
module FAU ( 
  ...
  inv1   g042(.a(x00), .O(new_n89_));
  nor2   g043(.a(x16), .b(new_n89_), .O(new_n90_));
  aoi21  g044(.a(new_n88_), .b(x16), .c(new_n90_), .O(new_n91_));
  nand3  g045(.a(new_n87_), .b(new_n48_), .c(x08), .O(new_n92_));
  oai21  g046(.a(new_n91_), .b(new_n87_), .c(new_n92_), .O(z09));
  ...
  nand2  g057(.a(new_n103_), .b(new_n96_), .O(z10));
  ...
  nand3  g065(.a(new_n111_), .b(x18), .c(x16), .O(new_n112_));
  ...
  nand3  g074(.a(new_n120_), .b(x18), .c(x16), .O(new_n121_));
  ...
  nand3  g083(.a(new_n129_), .b(x18), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  oai21  g085(.a(x16), .b(x13), .c(new_n87_), .O(new_n132_));
  ...
  nor2   g091(.a(new_n87_), .b(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x05), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n137_), .c(new_n132_), .O(z14));
  oai21  g094(.a(x16), .b(x14), .c(new_n87_), .O(new_n141_));
  ...
  nand2  g101(.a(new_n138_), .b(x06), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n147_), .c(new_n141_), .O(z15));
  oai21  g103(.a(x16), .b(x15), .c(new_n87_), .O(new_n150_));
  ...
  nand2  g109(.a(new_n138_), .b(x07), .O(new_n156_));
