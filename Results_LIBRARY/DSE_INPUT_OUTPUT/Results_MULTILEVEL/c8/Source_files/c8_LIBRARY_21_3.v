...
module FAU ( 
  ...
  nand2  g060(.a(x18), .b(new_n63_), .O(new_n107_));
  oai22  g061(.a(new_n107_), .b(new_n106_), .c(x18), .d(new_n58_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n94_), .O(new_n109_));
  nand4  g063(.a(new_n60_), .b(new_n54_), .c(new_n90_), .d(new_n89_), .O(new_n110_));
  oai21  g064(.a(new_n103_), .b(new_n60_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n48_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n109_), .O(z11));
  oai21  g067(.a(x18), .b(new_n94_), .c(x11), .O(new_n114_));
  aoi21  g068(.a(x18), .b(x11), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n60_), .c(new_n54_), .d(new_n90_), .O(new_n116_));
  ...
  nand3  g073(.a(x18), .b(new_n94_), .c(x03), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n92_), .c(new_n54_), .O(new_n126_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n125_), .c(new_n137_), .d(new_n89_), .O(new_n139_));
  ...
  oai22  g097(.a(new_n107_), .b(new_n143_), .c(x18), .d(new_n78_), .O(new_n144_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n92_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n147_), .d(new_n92_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n163_));
  nand3  g117(.a(new_n147_), .b(x19), .c(new_n89_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n89_), .O(new_n165_));
