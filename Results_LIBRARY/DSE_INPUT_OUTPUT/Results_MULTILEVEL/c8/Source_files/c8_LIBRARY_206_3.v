...
module FAU ( 
  ...
  nand2  g066(.a(new_n96_), .b(x11), .O(new_n113_));
  ...
  nand3  g082(.a(new_n66_), .b(new_n107_), .c(new_n57_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n128_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n109_), .c(new_n131_), .d(new_n83_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n118_), .c(x16), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n120_), .c(new_n100_), .d(new_n92_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n118_), .c(x16), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n120_), .c(new_n100_), .d(new_n92_), .O(new_n149_));
  ...
  nand2  g107(.a(new_n66_), .b(new_n107_), .O(new_n154_));
  inv1   g108(.a(x24), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n74_), .c(new_n155_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand3  g112(.a(new_n100_), .b(x19), .c(new_n83_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n58_), .b(new_n83_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n118_), .c(new_n81_), .O(z17));
endmodule
