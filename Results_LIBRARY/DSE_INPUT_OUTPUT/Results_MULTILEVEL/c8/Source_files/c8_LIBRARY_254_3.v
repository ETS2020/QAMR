...
module FAU ( 
  ...
  nand2  g005(.a(x16), .b(x04), .O(new_n52_));
  ...
  oai21  g043(.a(new_n89_), .b(x04), .c(x16), .O(new_n90_));
  oai21  g044(.a(new_n88_), .b(x16), .c(new_n90_), .O(z09));
  nor2   g045(.a(x18), .b(new_n55_), .O(new_n92_));
  aoi21  g046(.a(x18), .b(x01), .c(new_n92_), .O(new_n93_));
  inv1   g047(.a(x04), .O(new_n94_));
  ...
  nand3  g054(.a(new_n100_), .b(x16), .c(new_n94_), .O(new_n101_));
  oai21  g055(.a(new_n93_), .b(x16), .c(new_n101_), .O(z10));
  ...
  nand3  g062(.a(new_n108_), .b(x16), .c(new_n94_), .O(new_n109_));
  ...
  nand3  g080(.a(new_n126_), .b(x16), .c(new_n94_), .O(new_n127_));
  ...
  nand2  g084(.a(new_n130_), .b(new_n119_), .O(new_n131_));
  aoi21  g085(.a(new_n124_), .b(new_n105_), .c(new_n75_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n98_), .d(new_n97_), .O(new_n134_));
  ...
  nand2  g093(.a(new_n139_), .b(new_n119_), .O(new_n140_));
  ...
  nand3  g099(.a(new_n145_), .b(x16), .c(new_n94_), .O(new_n146_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n119_), .O(new_n150_));
  nand2  g104(.a(new_n144_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n106_), .d(new_n96_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(x16), .c(new_n94_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n97_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n50_), .b(new_n97_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n94_), .c(new_n119_), .O(z17));
endmodule
