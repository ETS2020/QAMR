...
module FAU ( 
  ...
  nand3  g066(.a(new_n112_), .b(new_n89_), .c(new_n57_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n96_), .c(new_n101_), .O(new_n122_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n65_), .c(new_n101_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n121_), .c(new_n102_), .d(new_n89_), .O(new_n142_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n121_), .c(new_n102_), .d(new_n89_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n121_), .c(new_n73_), .O(new_n157_));
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n87_), .O(new_n158_));
