...
module FAU ( 
  ...
  nand2  g001(.a(new_n47_), .b(x14), .O(new_n48_));
  ...
  nand3  g037(.a(new_n53_), .b(new_n82_), .c(x18), .O(new_n84_));
  ...
  nor2   g045(.a(x18), .b(x14), .O(new_n92_));
  ...
  aoi21  g068(.a(new_n47_), .b(x14), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n63_), .c(new_n58_), .d(new_n52_), .O(new_n116_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n101_), .c(new_n58_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n103_), .c(new_n63_), .O(new_n126_));
  ...
  nand2  g084(.a(new_n92_), .b(x13), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n97_), .O(new_n133_));
  nand2  g087(.a(new_n126_), .b(x24), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n122_), .c(new_n103_), .O(new_n136_));
  ...
  nand4  g105(.a(new_n125_), .b(new_n88_), .c(new_n82_), .d(new_n76_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n108_), .c(new_n151_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n48_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n150_), .O(z16));
  inv1   g109(.a(x17), .O(new_n156_));
  nand3  g110(.a(new_n107_), .b(x19), .c(new_n156_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n152_), .c(new_n53_), .d(new_n156_), .O(new_n158_));
