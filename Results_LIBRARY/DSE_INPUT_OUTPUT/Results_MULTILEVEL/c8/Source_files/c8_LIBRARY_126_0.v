...
module FAU ( 
  ...
  nor2   g005(.a(x18), .b(x00), .O(new_n52_));
  ...
  oai21  g045(.a(x18), .b(new_n54_), .c(new_n91_), .O(new_n92_));
  ...
  nand3  g051(.a(new_n94_), .b(new_n49_), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g061(.a(new_n99_), .b(new_n59_), .c(new_n107_), .O(new_n108_));
  ...
  aoi21  g067(.a(new_n85_), .b(new_n83_), .c(x22), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n59_), .c(new_n94_), .d(new_n49_), .O(new_n115_));
  ...
  nand4  g076(.a(new_n95_), .b(new_n64_), .c(new_n59_), .d(new_n94_), .O(new_n123_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n106_), .d(new_n95_), .O(new_n146_));
  oai21  g100(.a(new_n137_), .b(new_n143_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n81_), .O(z15));
  ...
  nand4  g107(.a(new_n144_), .b(new_n78_), .c(new_n143_), .d(new_n133_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n107_), .c(new_n153_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n152_), .c(new_n81_), .O(z16));
  nand3  g111(.a(new_n106_), .b(x19), .c(new_n97_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n154_), .c(new_n50_), .d(new_n97_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n81_), .O(z17));
endmodule
