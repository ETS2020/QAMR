...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x10), .O(new_n47_));
  ...
  aoi21  g015(.a(x27), .b(new_n60_), .c(new_n61_), .O(new_n62_));
  nand2  g016(.a(new_n61_), .b(x10), .O(new_n63_));
  oai21  g017(.a(new_n62_), .b(new_n59_), .c(new_n63_), .O(z02));
  ...
  aoi22  g022(.a(new_n68_), .b(new_n66_), .c(new_n59_), .d(new_n60_), .O(z03));
  ...
  aoi21  g027(.a(new_n73_), .b(new_n71_), .c(new_n47_), .O(z04));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n47_), .O(z05));
  ...
  aoi21  g037(.a(x27), .b(new_n83_), .c(new_n47_), .O(new_n84_));
  oai21  g038(.a(x27), .b(x26), .c(new_n84_), .O(z07));
  nor2   g039(.a(new_n47_), .b(new_n51_), .O(z08));
  inv1   g040(.a(new_n47_), .O(new_n87_));
  inv1   g041(.a(x17), .O(new_n88_));
  nor2   g042(.a(new_n50_), .b(new_n88_), .O(new_n89_));
  ...
  oai21  g047(.a(x18), .b(new_n48_), .c(new_n93_), .O(new_n94_));
  ...
  nand2  g051(.a(new_n59_), .b(x10), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n54_), .c(new_n97_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n92_), .O(new_n100_));
  nor2   g054(.a(new_n90_), .b(new_n56_), .O(new_n101_));
  nor3   g055(.a(x20), .b(x19), .c(x17), .O(new_n102_));
  or2    g056(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n87_), .c(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n100_), .O(z10));
  nand2  g059(.a(x18), .b(x02), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n98_), .O(new_n107_));
  ...
  oai21  g065(.a(new_n102_), .b(new_n109_), .c(new_n111_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n87_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n108_), .O(z11));
  ...
  aoi21  g071(.a(new_n59_), .b(new_n60_), .c(x22), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n109_), .c(new_n56_), .d(new_n50_), .O(new_n119_));
  nand2  g073(.a(new_n111_), .b(x22), .O(new_n120_));
  oai21  g074(.a(new_n119_), .b(x17), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n87_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  oai21  g078(.a(x18), .b(new_n70_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n92_), .O(new_n126_));
  nor2   g080(.a(x22), .b(x21), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n90_), .c(new_n56_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x23), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n102_), .c(new_n109_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n126_), .c(new_n87_), .O(z13));
  nand2  g088(.a(x18), .b(x05), .O(new_n135_));
  nand3  g089(.a(new_n59_), .b(x13), .c(x10), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n92_), .O(new_n138_));
  nand2  g092(.a(new_n131_), .b(x24), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n127_), .c(new_n102_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n87_), .c(x16), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n130_), .c(new_n110_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n87_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai21  g108(.a(x18), .b(new_n83_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n92_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n130_), .c(new_n77_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n111_), .c(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n87_), .O(z16));
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n88_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n51_), .d(new_n88_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n87_), .O(z17));
endmodule
