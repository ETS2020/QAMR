...
module FAU ( 
  ...
  nor2   g044(.a(new_n90_), .b(new_n53_), .O(new_n91_));
  ...
  nand3  g049(.a(new_n80_), .b(x10), .c(x00), .O(new_n96_));
  ...
  oai21  g054(.a(new_n92_), .b(new_n59_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n85_), .c(x16), .O(new_n102_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n90_), .c(new_n53_), .O(new_n110_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n85_), .O(z13));
  ...
  nand3  g087(.a(new_n133_), .b(new_n125_), .c(new_n85_), .O(z14));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n99_), .d(new_n90_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(new_n85_), .O(z15));
  nand2  g098(.a(x18), .b(x07), .O(new_n145_));
  nand3  g099(.a(new_n80_), .b(x15), .c(x00), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n139_), .c(new_n99_), .d(new_n90_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n155_), .b(new_n139_), .c(new_n126_), .O(new_n156_));
  nand3  g110(.a(new_n99_), .b(x19), .c(new_n128_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n54_), .d(new_n128_), .O(new_n158_));
