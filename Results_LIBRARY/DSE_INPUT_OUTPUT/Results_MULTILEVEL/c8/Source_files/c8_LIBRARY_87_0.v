...
module FAU ( 
  ...
  nor2   g036(.a(new_n48_), .b(new_n54_), .O(z08));
  ...
  nand3  g050(.a(new_n96_), .b(x09), .c(x04), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  nand3  g053(.a(new_n53_), .b(new_n86_), .c(new_n85_), .O(new_n100_));
  oai21  g054(.a(new_n88_), .b(new_n53_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n106_), .c(new_n84_), .O(z11));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n88_), .c(new_n62_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n88_), .c(new_n53_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n84_), .O(z12));
  inv1   g076(.a(x04), .O(new_n123_));
  aoi21  g077(.a(new_n96_), .b(new_n65_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n119_), .b(x23), .O(new_n125_));
  nor3   g079(.a(x23), .b(x22), .c(x21), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n108_), .O(new_n127_));
  ...
  nand2  g087(.a(new_n133_), .b(new_n90_), .O(new_n134_));
  aoi21  g088(.a(new_n126_), .b(new_n108_), .c(new_n72_), .O(new_n135_));
  nand3  g089(.a(new_n118_), .b(new_n72_), .c(new_n67_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n100_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n135_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n134_), .c(new_n84_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n109_), .d(new_n88_), .O(new_n145_));
  oai21  g099(.a(new_n137_), .b(new_n77_), .c(new_n145_), .O(new_n146_));
  ...
  nand3  g103(.a(new_n96_), .b(x15), .c(x04), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n143_), .c(new_n72_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n110_), .c(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n84_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  nand3  g112(.a(new_n109_), .b(x19), .c(new_n85_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n54_), .d(new_n85_), .O(new_n160_));
