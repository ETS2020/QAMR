...
module FAU ( 
  ...
  nand3  g44(.a(new_n48_), .b(new_n84_), .c(x09), .O(new_n91_));
  ...
  nand4  g49(.a(new_n57_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n96_));
  ...
  nand3  g56(.a(new_n102_), .b(new_n82_), .c(new_n87_), .O(new_n103_));
  ...
  aoi22  g61(.a(new_n107_), .b(new_n89_), .c(new_n103_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n84_), .c(new_n106_), .O(z13));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n89_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n102_), .c(new_n94_), .d(new_n79_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g69(.a(new_n48_), .b(new_n84_), .c(x13), .O(new_n116_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n110_), .c(new_n119_), .d(new_n63_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n97_), .c(new_n113_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n84_), .c(new_n118_), .O(z15));
  oai21  g78(.a(x18), .b(x15), .c(new_n84_), .O(new_n125_));
