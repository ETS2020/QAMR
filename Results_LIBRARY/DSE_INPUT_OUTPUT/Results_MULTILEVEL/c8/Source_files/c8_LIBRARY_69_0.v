...
module FAU ( 
  ...
  nand3  g007(.a(new_n53_), .b(x18), .c(new_n51_), .O(new_n54_));
  inv1   g008(.a(x20), .O(new_n55_));
  nand3  g009(.a(new_n52_), .b(new_n55_), .c(x09), .O(new_n56_));
  nand2  g010(.a(new_n56_), .b(new_n54_), .O(z01));
  ...
  aoi21  g068(.a(new_n102_), .b(new_n51_), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n60_), .c(new_n55_), .d(new_n85_), .O(new_n116_));
  ...
  aoi21  g090(.a(new_n128_), .b(new_n106_), .c(new_n136_), .O(new_n137_));
  nand4  g091(.a(new_n136_), .b(new_n68_), .c(new_n125_), .d(new_n60_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n97_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n137_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n135_), .c(new_n83_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n102_), .b(x14), .c(x09), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n107_), .d(new_n87_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n102_), .b(x15), .c(x09), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n146_), .c(new_n136_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n108_), .c(new_n156_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n83_), .c(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n155_), .O(z16));
  nand3  g115(.a(new_n107_), .b(x19), .c(new_n84_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n158_), .c(new_n52_), .d(new_n84_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n83_), .c(x16), .O(new_n164_));
