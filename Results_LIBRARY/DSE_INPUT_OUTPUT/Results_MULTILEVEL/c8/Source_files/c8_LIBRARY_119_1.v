...
module FAU ( 
  ...
  nor2   g002(.a(new_n48_), .b(x02), .O(new_n49_));
  ...
  nand3  g053(.a(new_n54_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  ...
  oai21  g057(.a(x18), .b(x10), .c(new_n86_), .O(new_n104_));
  ...
  nand3  g064(.a(x18), .b(x03), .c(x02), .O(new_n111_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n84_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n113_), .O(z12));
  nand3  g073(.a(x18), .b(x04), .c(x02), .O(new_n120_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n105_), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g082(.a(x18), .b(x05), .c(x02), .O(new_n129_));
  ...
  oai21  g087(.a(new_n133_), .b(new_n100_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n98_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n84_), .c(x16), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n106_), .d(new_n97_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n84_), .O(z15));
  nand3  g103(.a(x18), .b(x07), .c(x02), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n106_), .d(new_n97_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n124_), .c(new_n73_), .O(new_n160_));
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n98_), .O(new_n161_));
