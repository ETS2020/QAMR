...
module FAU ( 
  ...
  inv1   g016(.a(new_n49_), .O(new_n63_));
  inv1   g017(.a(x22), .O(new_n64_));
  oai21  g018(.a(x27), .b(new_n64_), .c(new_n48_), .O(new_n65_));
  nand2  g019(.a(new_n55_), .b(new_n64_), .O(new_n66_));
  nand3  g020(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(z03));
  ...
  nand2  g039(.a(new_n55_), .b(new_n85_), .O(new_n86_));
  aoi21  g040(.a(new_n86_), .b(new_n84_), .c(new_n49_), .O(z07));
  nand2  g041(.a(new_n63_), .b(new_n55_), .O(z08));
  ...
  oai21  g049(.a(x18), .b(new_n47_), .c(new_n95_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n63_), .O(z09));
  nand2  g052(.a(x18), .b(x01), .O(new_n99_));
  oai21  g053(.a(x18), .b(new_n52_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  nor2   g055(.a(new_n92_), .b(new_n54_), .O(new_n102_));
  nand3  g056(.a(new_n54_), .b(new_n90_), .c(new_n89_), .O(new_n103_));
  inv1   g057(.a(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n102_), .c(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n101_), .c(new_n63_), .O(z10));
  nand2  g060(.a(x18), .b(x02), .O(new_n107_));
  inv1   g061(.a(x18), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n48_), .c(x10), .O(new_n109_));
  ...
  oai21  g067(.a(new_n104_), .b(new_n60_), .c(new_n113_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n63_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n111_), .O(z11));
  aoi21  g070(.a(new_n108_), .b(x11), .c(x22), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n60_), .c(new_n54_), .d(new_n90_), .O(new_n118_));
  nand2  g072(.a(new_n113_), .b(x22), .O(new_n119_));
  oai21  g073(.a(new_n118_), .b(x17), .c(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nor2   g075(.a(new_n108_), .b(x16), .O(new_n122_));
  aoi21  g076(.a(new_n122_), .b(x03), .c(new_n49_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(z12));
  ...
  nand4  g081(.a(new_n92_), .b(new_n64_), .c(new_n60_), .d(new_n54_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x23), .O(new_n129_));
  nor3   g083(.a(x23), .b(x22), .c(x21), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n104_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n127_), .c(new_n63_), .O(z13));
  nand2  g088(.a(x18), .b(x05), .O(new_n135_));
  oai21  g089(.a(x18), .b(new_n73_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n94_), .O(new_n137_));
  aoi21  g091(.a(new_n130_), .b(new_n104_), .c(new_n75_), .O(new_n138_));
  nand4  g092(.a(new_n75_), .b(new_n70_), .c(new_n64_), .d(new_n60_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n103_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n138_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n137_), .c(new_n63_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  nand3  g097(.a(new_n108_), .b(x14), .c(new_n48_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n94_), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n112_), .d(new_n92_), .O(new_n149_));
  oai21  g103(.a(new_n140_), .b(new_n80_), .c(new_n149_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n63_), .c(x16), .O(new_n151_));
  ...
  nand4  g110(.a(new_n147_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n113_), .c(new_n156_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n155_), .c(new_n63_), .O(z16));
  nand3  g114(.a(new_n112_), .b(x19), .c(new_n89_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n55_), .d(new_n89_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n63_), .c(x16), .O(new_n163_));
