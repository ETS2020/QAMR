...
module FAU ( 
  ...
  oai21  g063(.a(x16), .b(x11), .c(new_n87_), .O(new_n110_));
  aoi21  g064(.a(new_n104_), .b(new_n92_), .c(new_n65_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n94_), .b(x03), .O(new_n116_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n99_), .c(new_n60_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n54_), .b(new_n90_), .c(new_n89_), .O(new_n130_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n112_), .c(new_n133_), .d(new_n89_), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n104_), .d(new_n92_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n94_), .b(x06), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n122_), .c(new_n104_), .d(new_n92_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n89_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n89_), .O(new_n159_));
