...
module FAU ( 
  ...
  nand2  g039(.a(x18), .b(x05), .O(new_n86_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n82_), .c(x16), .O(new_n119_));
  ...
  oai21  g083(.a(x18), .b(x13), .c(new_n84_), .O(new_n130_));
  aoi21  g084(.a(new_n125_), .b(new_n106_), .c(new_n69_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n116_), .c(new_n98_), .d(new_n97_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n130_), .c(new_n82_), .O(z14));
  nand3  g090(.a(x18), .b(x06), .c(x05), .O(new_n137_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n107_), .d(new_n96_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n82_), .c(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n139_), .O(z15));
  nand3  g100(.a(x18), .b(x07), .c(x05), .O(new_n147_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n107_), .d(new_n96_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n82_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nand4  g109(.a(new_n141_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n156_));
  nand3  g110(.a(new_n107_), .b(x19), .c(new_n97_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n58_), .d(new_n97_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n82_), .c(x16), .O(new_n159_));
