...
module FAU ( 
  ...
  oai21  g056(.a(x18), .b(x10), .c(new_n47_), .O(new_n103_));
  nor2   g057(.a(x20), .b(x19), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n92_), .O(new_n105_));
  nand4  g059(.a(new_n63_), .b(new_n58_), .c(new_n52_), .d(new_n92_), .O(new_n106_));
  inv1   g060(.a(new_n106_), .O(new_n107_));
  aoi21  g061(.a(new_n105_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n47_), .c(new_n103_), .O(z11));
  oai21  g063(.a(x18), .b(x11), .c(new_n47_), .O(new_n110_));
  ...
  oai21  g068(.a(new_n114_), .b(new_n47_), .c(new_n110_), .O(z12));
  ...
  oai21  g073(.a(new_n117_), .b(new_n47_), .c(new_n119_), .O(z13));
  aoi21  g074(.a(new_n116_), .b(new_n100_), .c(new_n76_), .O(new_n121_));
  ...
  nand4  g081(.a(new_n81_), .b(new_n76_), .c(new_n71_), .d(new_n66_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n107_), .c(new_n123_), .d(x25), .O(new_n130_));
  nand2  g084(.a(new_n118_), .b(x14), .O(new_n131_));
