...
module FAU ( 
  ...
  nand3  g43(.a(x18), .b(new_n83_), .c(x01), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n89_), .O(z10));
  oai21  g45(.a(new_n84_), .b(x02), .c(new_n83_), .O(new_n92_));
  ...
  oai21  g63(.a(new_n84_), .b(x05), .c(new_n83_), .O(new_n110_));
  ...
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n54_), .d(new_n78_), .O(new_n140_));
