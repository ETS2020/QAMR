...
module FAU ( 
  ...
  nand2  g022(.a(new_n60_), .b(new_n68_), .O(new_n69_));
  ...
  nand3  g042(.a(new_n88_), .b(new_n77_), .c(x16), .O(new_n89_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n77_), .O(z10));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n77_), .O(z11));
  ...
  aoi21  g064(.a(new_n103_), .b(new_n86_), .c(new_n59_), .O(new_n111_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n77_), .O(z12));
  nand2  g070(.a(new_n81_), .b(new_n63_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n79_), .c(x04), .O(new_n118_));
  ...
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n77_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  nand3  g100(.a(new_n81_), .b(x15), .c(x04), .O(new_n147_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n103_), .d(new_n86_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n77_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n140_), .c(new_n68_), .O(new_n157_));
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n129_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n60_), .d(new_n129_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n77_), .c(x16), .O(new_n160_));
