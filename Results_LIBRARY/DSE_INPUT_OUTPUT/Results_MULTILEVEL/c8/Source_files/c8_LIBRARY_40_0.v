...
module FAU ( 
  ...
  oai21  g50(.a(new_n86_), .b(x02), .c(new_n90_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  inv1   g53(.a(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n92_), .c(new_n50_), .d(new_n82_), .O(new_n101_));
  ...
  nand3  g60(.a(new_n106_), .b(new_n84_), .c(new_n92_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand2  g62(.a(new_n87_), .b(x03), .O(new_n109_));
  oai21  g63(.a(new_n108_), .b(new_n90_), .c(new_n109_), .O(z12));
  oai21  g64(.a(new_n86_), .b(x04), .c(new_n90_), .O(new_n111_));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n94_), .c(new_n107_), .d(x23), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n90_), .c(new_n111_), .O(z13));
  aoi21  g68(.a(new_n112_), .b(new_n94_), .c(new_n70_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n106_), .c(new_n98_), .d(new_n82_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n87_), .b(x05), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n119_), .O(z14));
  oai21  g75(.a(new_n86_), .b(x06), .c(new_n90_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n70_), .c(new_n65_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n90_), .c(new_n122_), .O(z15));
  ...
  nand2  g91(.a(new_n87_), .b(x07), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  inv1   g93(.a(new_n47_), .O(new_n140_));
  nand4  g94(.a(new_n130_), .b(new_n78_), .c(new_n124_), .d(new_n70_), .O(new_n141_));
