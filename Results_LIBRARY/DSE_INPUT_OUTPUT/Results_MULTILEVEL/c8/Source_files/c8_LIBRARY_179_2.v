...
module FAU ( 
  ...
  oai21  g055(.a(x16), .b(x10), .c(new_n83_), .O(new_n102_));
  ...
  nand2  g061(.a(new_n90_), .b(x02), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n107_), .c(new_n102_), .O(z11));
  oai21  g063(.a(x16), .b(x11), .c(new_n83_), .O(new_n110_));
  aoi21  g064(.a(new_n104_), .b(new_n88_), .c(new_n63_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n88_), .c(new_n96_), .O(new_n113_));
  ...
  aoi21  g080(.a(new_n120_), .b(new_n103_), .c(new_n73_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n112_), .c(new_n97_), .d(new_n85_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n90_), .b(x05), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n126_), .O(z14));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n104_), .d(new_n88_), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n138_), .c(new_n104_), .d(new_n88_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n90_), .b(x07), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n73_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n85_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n58_), .b(new_n85_), .O(new_n159_));
