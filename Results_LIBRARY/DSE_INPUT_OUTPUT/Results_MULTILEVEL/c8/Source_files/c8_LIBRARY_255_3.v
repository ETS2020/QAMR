...
module FAU ( 
  ...
  nand2  g001(.a(x23), .b(x22), .O(new_n48_));
  ...
  nor3   g057(.a(new_n103_), .b(x17), .c(new_n86_), .O(new_n104_));
  ...
  nand2  g061(.a(x23), .b(x22), .O(new_n108_));
  nand4  g062(.a(new_n108_), .b(new_n107_), .c(x21), .d(x16), .O(new_n109_));
  ...
  nor2   g079(.a(new_n116_), .b(new_n125_), .O(new_n126_));
  inv1   g080(.a(x21), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nor2   g083(.a(new_n129_), .b(new_n107_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n136_), .b(new_n125_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x22), .O(new_n138_));
  nor2   g092(.a(x23), .b(x21), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n84_), .c(new_n54_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x24), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n95_), .c(new_n114_), .d(new_n127_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n138_), .c(new_n135_), .O(z14));
  nand2  g100(.a(x18), .b(x06), .O(new_n147_));
  oai21  g101(.a(x18), .b(new_n70_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n86_), .O(new_n149_));
  oai21  g103(.a(new_n72_), .b(new_n86_), .c(new_n125_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x22), .O(new_n151_));
  nor3   g105(.a(x24), .b(x23), .c(x21), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n95_), .c(new_n72_), .O(new_n153_));
  nor2   g107(.a(x25), .b(x24), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n128_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n115_), .O(new_n156_));
  ...
  oai21  g113(.a(x18), .b(new_n75_), .c(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n48_), .c(new_n86_), .O(new_n161_));
  nand2  g115(.a(x26), .b(x22), .O(new_n162_));
  nor2   g116(.a(x24), .b(x22), .O(new_n163_));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n163_), .c(new_n102_), .d(new_n84_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n162_), .c(x23), .O(new_n166_));
  nand4  g120(.a(new_n154_), .b(new_n139_), .c(new_n106_), .d(new_n81_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(x26), .c(new_n114_), .O(new_n168_));
  inv1   g122(.a(new_n168_), .O(new_n169_));
  oai21  g123(.a(new_n169_), .b(new_n166_), .c(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n161_), .O(z16));
  nand2  g125(.a(z08), .b(x17), .O(new_n172_));
  nor2   g126(.a(new_n82_), .b(x17), .O(new_n173_));
  nor3   g127(.a(x26), .b(x25), .c(x24), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n173_), .c(new_n128_), .d(new_n102_), .O(new_n175_));
