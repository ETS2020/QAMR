...
module FAU ( 
  ...
  nand3  g062(.a(new_n88_), .b(new_n59_), .c(new_n99_), .O(new_n109_));
  oai21  g063(.a(new_n108_), .b(new_n59_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(new_n47_), .O(z11));
  ...
  oai21  g069(.a(new_n64_), .b(new_n90_), .c(new_n58_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(x21), .O(new_n117_));
  nand4  g071(.a(new_n88_), .b(new_n64_), .c(new_n59_), .d(new_n99_), .O(new_n118_));
  oai21  g072(.a(new_n108_), .b(new_n64_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(z12));
  inv1   g075(.a(x04), .O(new_n122_));
  oai22  g076(.a(new_n96_), .b(new_n122_), .c(x18), .d(new_n67_), .O(new_n123_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n88_), .c(new_n99_), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(new_n127_), .c(x21), .O(new_n130_));
  nor3   g084(.a(new_n69_), .b(new_n59_), .c(x18), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n130_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n124_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  oai22  g088(.a(new_n96_), .b(new_n134_), .c(x18), .d(new_n72_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n90_), .O(new_n136_));
  nand2  g090(.a(new_n129_), .b(x24), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n108_), .c(new_n64_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x21), .O(new_n140_));
  inv1   g094(.a(x24), .O(new_n141_));
  nor3   g095(.a(new_n141_), .b(new_n59_), .c(x18), .O(new_n142_));
