...
module FAU ( 
  ...
  oai21  g48(.a(new_n92_), .b(x01), .c(new_n91_), .O(new_n95_));
  nor2   g49(.a(new_n89_), .b(new_n53_), .O(new_n96_));
  ...
  oai21  g53(.a(new_n92_), .b(x02), .c(new_n91_), .O(new_n100_));
  ...
  oai21  g60(.a(new_n92_), .b(x03), .c(new_n91_), .O(new_n107_));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n89_), .c(new_n53_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n91_), .c(new_n107_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n97_), .c(new_n110_), .d(x23), .O(new_n114_));
  nor2   g68(.a(new_n92_), .b(x16), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n114_), .b(new_n91_), .c(new_n116_), .O(z13));
  aoi21  g71(.a(new_n113_), .b(new_n97_), .c(new_n74_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n101_), .d(new_n86_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n115_), .b(x05), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  oai21  g78(.a(new_n92_), .b(x06), .c(new_n91_), .O(new_n125_));
  ...
  oai21  g82(.a(new_n128_), .b(new_n91_), .c(new_n125_), .O(z15));
  ...
  nand2  g92(.a(new_n115_), .b(x07), .O(new_n139_));
