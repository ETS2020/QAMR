...
module FAU ( 
  ...
  oai22  g64(.a(new_n110_), .b(new_n87_), .c(new_n88_), .d(new_n68_), .O(z13));
  ...
  nand4  g69(.a(new_n115_), .b(new_n105_), .c(new_n97_), .d(new_n83_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n113_), .c(new_n121_), .d(new_n65_), .O(new_n123_));
