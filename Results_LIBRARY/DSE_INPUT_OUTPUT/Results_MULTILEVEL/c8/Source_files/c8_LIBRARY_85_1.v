...
module FAU ( 
  ...
  nand2  g29(.a(new_n48_), .b(new_n75_), .O(new_n76_));
  inv1   g30(.a(x13), .O(new_n77_));
  nand2  g31(.a(x27), .b(new_n77_), .O(new_n78_));
  nand3  g32(.a(new_n78_), .b(new_n76_), .c(new_n53_), .O(z05));
  ...
  nand2  g39(.a(x27), .b(new_n85_), .O(new_n86_));
  inv1   g40(.a(x26), .O(new_n87_));
  nand2  g41(.a(new_n48_), .b(new_n87_), .O(new_n88_));
  aoi22  g42(.a(new_n88_), .b(new_n86_), .c(x18), .d(new_n52_), .O(z07));
  ...
  oai21  g50(.a(x18), .b(x09), .c(new_n52_), .O(new_n97_));
  nor2   g51(.a(new_n93_), .b(new_n55_), .O(new_n98_));
  nor3   g52(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n97_), .O(z10));
  oai21  g55(.a(x18), .b(x10), .c(new_n52_), .O(new_n102_));
  nor2   g56(.a(x20), .b(x19), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n91_), .O(new_n104_));
  nand4  g58(.a(new_n60_), .b(new_n55_), .c(new_n47_), .d(new_n91_), .O(new_n105_));
  inv1   g59(.a(new_n105_), .O(new_n106_));
  aoi21  g60(.a(new_n104_), .b(x21), .c(new_n106_), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n52_), .c(new_n102_), .O(z11));
  nand2  g62(.a(new_n105_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n93_), .c(new_n55_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nor2   g66(.a(x18), .b(x16), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x11), .O(new_n114_));
  oai21  g68(.a(new_n112_), .b(new_n52_), .c(new_n114_), .O(z12));
  oai21  g69(.a(x18), .b(x12), .c(new_n52_), .O(new_n116_));
  nor3   g70(.a(x23), .b(x22), .c(x21), .O(new_n117_));
  aoi22  g71(.a(new_n117_), .b(new_n99_), .c(new_n111_), .d(x23), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n52_), .c(new_n116_), .O(z13));
  aoi21  g73(.a(new_n117_), .b(new_n99_), .c(new_n75_), .O(new_n120_));
  nor2   g74(.a(x24), .b(x23), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n110_), .c(new_n103_), .d(new_n91_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nand2  g78(.a(new_n113_), .b(x13), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n124_), .O(z14));
  oai21  g80(.a(x18), .b(x14), .c(new_n52_), .O(new_n127_));
  nand4  g81(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  aoi22  g83(.a(new_n129_), .b(new_n106_), .c(new_n122_), .d(x25), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n52_), .c(new_n127_), .O(z15));
  nor2   g85(.a(x21), .b(x20), .O(new_n132_));
  nor2   g86(.a(x23), .b(x22), .O(new_n133_));
  nor2   g87(.a(x25), .b(x24), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n93_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x26), .O(new_n136_));
  nor3   g90(.a(x26), .b(x25), .c(x24), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n133_), .c(new_n132_), .d(new_n93_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n113_), .b(x15), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n140_), .O(z16));
  nor2   g96(.a(new_n47_), .b(x17), .O(new_n143_));
  nand4  g97(.a(new_n143_), .b(new_n137_), .c(new_n133_), .d(new_n132_), .O(new_n144_));
  nand2  g98(.a(x27), .b(x17), .O(new_n145_));
  aoi21  g99(.a(new_n145_), .b(new_n144_), .c(new_n52_), .O(z17));
endmodule
