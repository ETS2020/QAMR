...
module FAU ( 
  ...
  nand3  g069(.a(new_n115_), .b(new_n90_), .c(new_n54_), .O(new_n116_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n105_), .d(new_n90_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n124_), .c(new_n105_), .d(new_n90_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand2  g109(.a(new_n92_), .b(x07), .O(new_n156_));
