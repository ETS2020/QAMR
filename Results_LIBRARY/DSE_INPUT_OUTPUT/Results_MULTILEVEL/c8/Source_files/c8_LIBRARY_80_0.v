...
module FAU ( 
  ...
  nor2   g47(.a(new_n86_), .b(new_n56_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n89_), .b(x02), .O(new_n103_));
  oai21  g57(.a(new_n102_), .b(new_n92_), .c(new_n103_), .O(z11));
  oai21  g58(.a(new_n88_), .b(x03), .c(new_n92_), .O(new_n105_));
  ...
  oai21  g63(.a(new_n109_), .b(new_n92_), .c(new_n105_), .O(z12));
  oai21  g64(.a(new_n88_), .b(x04), .c(new_n92_), .O(new_n111_));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n95_), .c(new_n108_), .d(x23), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n92_), .c(new_n111_), .O(z13));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n95_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n98_), .d(new_n84_), .O(new_n118_));
  ...
  oai21  g76(.a(new_n88_), .b(x06), .c(new_n92_), .O(new_n123_));
  inv1   g77(.a(x22), .O(new_n124_));
  inv1   g78(.a(x25), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n115_), .c(new_n69_), .d(new_n124_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n92_), .c(new_n123_), .O(z15));
  ...
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n92_), .O(z17));
endmodule
