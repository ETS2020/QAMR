...
module FAU ( 
  ...
  oai21  g026(.a(new_n55_), .b(x18), .c(new_n72_), .O(new_n73_));
  oai21  g027(.a(new_n55_), .b(x14), .c(new_n73_), .O(z06));
  ...
  nand2  g032(.a(new_n78_), .b(new_n55_), .O(z08));
  ...
  oai22  g045(.a(new_n91_), .b(new_n90_), .c(x18), .d(new_n52_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  nand3  g047(.a(new_n54_), .b(new_n81_), .c(new_n80_), .O(new_n94_));
  oai21  g048(.a(new_n83_), .b(new_n54_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n83_), .c(new_n54_), .O(new_n113_));
  ...
  oai22  g071(.a(new_n91_), .b(new_n117_), .c(x18), .d(new_n66_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n85_), .O(new_n119_));
  nand2  g073(.a(new_n113_), .b(x23), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n101_), .c(new_n60_), .O(new_n122_));
  ...
  oai22  g080(.a(new_n91_), .b(new_n126_), .c(x18), .d(new_n69_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n85_), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n110_), .c(new_n60_), .O(new_n130_));
  ...
  nand4  g095(.a(new_n54_), .b(new_n81_), .c(new_n80_), .d(x16), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n141_), .c(new_n48_), .O(new_n143_));
  ...
  nor2   g115(.a(x18), .b(x17), .O(new_n162_));
