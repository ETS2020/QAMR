...
module FAU ( 
  ...
  nor2   g041(.a(new_n48_), .b(new_n52_), .O(z08));
  oai21  g042(.a(x16), .b(x00), .c(x18), .O(new_n89_));
  inv1   g043(.a(x17), .O(new_n90_));
  nor2   g044(.a(new_n51_), .b(new_n90_), .O(new_n91_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n94_), .c(x08), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n93_), .c(new_n89_), .O(z09));
  nand2  g051(.a(x18), .b(x01), .O(new_n98_));
  oai21  g052(.a(x18), .b(new_n55_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n94_), .O(new_n100_));
  nand3  g054(.a(new_n57_), .b(new_n51_), .c(new_n90_), .O(new_n101_));
  oai21  g055(.a(new_n92_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n95_), .c(x16), .O(new_n103_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n62_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n95_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n107_), .O(z11));
  ...
  nand3  g072(.a(new_n118_), .b(new_n92_), .c(new_n57_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n116_), .O(z12));
  oai21  g076(.a(x16), .b(x04), .c(x18), .O(new_n123_));
  nand2  g077(.a(new_n119_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n108_), .c(new_n62_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand3  g082(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n128_), .c(new_n123_), .O(z13));
  nand2  g084(.a(x18), .b(x05), .O(new_n131_));
  oai21  g085(.a(x18), .b(new_n75_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n94_), .O(new_n133_));
  nand3  g087(.a(new_n72_), .b(new_n67_), .c(new_n62_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n101_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n118_), .c(new_n136_), .d(new_n90_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n95_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n109_), .d(new_n92_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n95_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  oai21  g105(.a(x18), .b(new_n83_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n94_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n125_), .c(new_n109_), .d(new_n92_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n95_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z16));
  inv1   g113(.a(x24), .O(new_n160_));
  nand4  g114(.a(new_n125_), .b(new_n85_), .c(new_n80_), .d(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n90_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n90_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n95_), .c(x16), .O(new_n164_));
