...
module FAU ( 
  ...
  oai21  g51(.a(x18), .b(x10), .c(new_n91_), .O(new_n98_));
  ...
  oai21  g61(.a(x18), .b(x12), .c(new_n91_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n112_), .b(new_n91_), .c(new_n108_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n91_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n95_), .c(new_n77_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n109_), .c(new_n99_), .d(new_n87_), .O(new_n117_));
  ...
  oai21  g74(.a(x18), .b(x14), .c(new_n91_), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n77_), .c(new_n72_), .d(new_n67_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n91_), .c(new_n121_), .O(z15));
  ...
  nand3  g89(.a(new_n47_), .b(new_n91_), .c(x15), .O(new_n136_));
