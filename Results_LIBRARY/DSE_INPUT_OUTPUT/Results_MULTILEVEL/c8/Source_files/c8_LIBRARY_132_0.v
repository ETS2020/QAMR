...
module FAU ( 
  ...
  aoi21  g023(.a(x27), .b(new_n68_), .c(new_n69_), .O(new_n70_));
  nand2  g024(.a(new_n69_), .b(x12), .O(new_n71_));
  oai21  g025(.a(new_n70_), .b(new_n67_), .c(new_n71_), .O(z04));
  ...
  aoi22  g030(.a(new_n76_), .b(new_n74_), .c(new_n67_), .d(new_n68_), .O(z05));
  ...
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(new_n86_), .O(z11));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n90_), .c(new_n64_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n90_), .c(new_n100_), .O(new_n118_));
  ...
  oai21  g075(.a(new_n67_), .b(x04), .c(new_n92_), .O(new_n122_));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n102_), .c(new_n75_), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n117_), .c(new_n133_), .d(new_n88_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n132_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n131_), .c(new_n86_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  nand3  g093(.a(new_n67_), .b(x14), .c(x12), .O(new_n140_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n90_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n108_), .d(new_n90_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n88_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n51_), .d(new_n88_), .O(new_n162_));
