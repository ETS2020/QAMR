...
module FAU ( 
  ...
  nand3  g045(.a(new_n91_), .b(new_n79_), .c(new_n78_), .O(new_n92_));
  oai21  g046(.a(new_n81_), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n90_), .c(x16), .O(new_n94_));
  ...
  nand2  g056(.a(new_n83_), .b(x10), .O(new_n103_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n90_), .c(x16), .O(new_n121_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n109_), .c(new_n130_), .d(new_n78_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n90_), .c(x16), .O(new_n134_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n99_), .d(new_n81_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n83_), .b(x14), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n118_), .c(new_n99_), .d(new_n81_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n83_), .b(x15), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  nand2  g105(.a(new_n127_), .b(new_n126_), .O(new_n152_));
  inv1   g106(.a(x25), .O(new_n153_));
  inv1   g107(.a(x26), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n66_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g110(.a(new_n99_), .b(x19), .c(new_n78_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n67_), .b(new_n78_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n90_), .c(new_n86_), .O(z17));
endmodule
