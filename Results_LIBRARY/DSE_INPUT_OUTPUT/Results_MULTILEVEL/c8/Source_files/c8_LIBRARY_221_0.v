...
module FAU ( 
  ...
  aoi21  g70(.a(new_n112_), .b(new_n96_), .c(new_n74_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n108_), .c(new_n100_), .d(new_n86_), .O(new_n119_));
  ...
  oai21  g76(.a(new_n91_), .b(x06), .c(new_n90_), .O(new_n123_));
  inv1   g77(.a(x22), .O(new_n124_));
  nand4  g78(.a(new_n79_), .b(new_n74_), .c(new_n69_), .d(new_n124_), .O(new_n125_));
  ...
  oai21  g82(.a(new_n91_), .b(x07), .c(new_n90_), .O(new_n129_));
  ...
  nand3  g95(.a(new_n141_), .b(new_n131_), .c(new_n74_), .O(new_n142_));
  nand3  g96(.a(new_n130_), .b(x19), .c(new_n86_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n51_), .d(new_n86_), .O(new_n144_));
