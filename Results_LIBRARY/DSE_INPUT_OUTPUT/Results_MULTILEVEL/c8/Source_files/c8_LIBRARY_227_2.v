...
module FAU ( 
  ...
  aoi21  g016(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n63_));
  ...
  nor2   g068(.a(new_n93_), .b(x16), .O(new_n115_));
  aoi21  g069(.a(new_n115_), .b(x03), .c(new_n48_), .O(new_n116_));
  oai21  g070(.a(new_n114_), .b(new_n87_), .c(new_n116_), .O(z12));
  ...
  nand3  g081(.a(new_n93_), .b(x13), .c(new_n47_), .O(new_n128_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n104_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n97_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n112_), .c(new_n135_), .d(new_n83_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n122_), .c(new_n106_), .d(new_n85_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n122_), .c(new_n106_), .d(new_n85_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n82_), .O(z16));
  inv1   g112(.a(x24), .O(new_n159_));
  nand4  g113(.a(new_n122_), .b(new_n78_), .c(new_n73_), .d(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n83_), .O(new_n161_));
