...
module FAU ( 
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n47_), .O(z09));
  oai21  g051(.a(x18), .b(new_n93_), .c(x09), .O(new_n98_));
  nor2   g052(.a(new_n91_), .b(new_n56_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  nand3  g055(.a(x18), .b(new_n93_), .c(x01), .O(new_n102_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n106_), .c(new_n47_), .O(z11));
  ...
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n56_), .O(new_n118_));
  ...
  nand2  g076(.a(x18), .b(new_n55_), .O(new_n123_));
  oai22  g077(.a(new_n123_), .b(new_n122_), .c(x18), .d(new_n68_), .O(new_n124_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n47_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  inv1   g085(.a(x05), .O(new_n132_));
  oai22  g086(.a(new_n123_), .b(new_n132_), .c(x18), .d(new_n73_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  nand3  g088(.a(new_n56_), .b(new_n51_), .c(new_n89_), .O(new_n135_));
  nand3  g089(.a(new_n70_), .b(new_n115_), .c(new_n62_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n117_), .c(new_n138_), .d(new_n89_), .O(new_n140_));
  ...
  nand2  g099(.a(new_n145_), .b(new_n93_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n127_), .c(new_n107_), .d(new_n91_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n127_), .c(new_n107_), .d(new_n91_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n127_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n162_));
  nand3  g116(.a(new_n107_), .b(x19), .c(new_n89_), .O(new_n163_));
