...
module FAU ( 
  ...
  nand3  g065(.a(new_n111_), .b(new_n86_), .c(new_n57_), .O(new_n112_));
  ...
  nand4  g083(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n99_), .d(new_n86_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n109_), .c(x16), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n139_), .c(new_n99_), .d(new_n86_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n88_), .b(x15), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nand2  g106(.a(new_n70_), .b(new_n65_), .O(new_n153_));
  inv1   g107(.a(x25), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n126_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g111(.a(new_n99_), .b(x19), .c(new_n84_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n52_), .b(new_n84_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n109_), .c(new_n105_), .O(z17));
endmodule
