...
module FAU ( 
  ...
  nand2  g055(.a(x18), .b(x05), .O(new_n102_));
  ...
  oai22  g064(.a(new_n102_), .b(new_n110_), .c(x18), .d(new_n61_), .O(new_n111_));
  ...
  oai21  g068(.a(new_n106_), .b(new_n63_), .c(new_n114_), .O(new_n115_));
  ...
  nand4  g075(.a(new_n121_), .b(new_n63_), .c(new_n58_), .d(new_n49_), .O(new_n122_));
  ...
  oai22  g081(.a(new_n102_), .b(new_n127_), .c(x18), .d(new_n71_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n106_), .c(new_n63_), .O(new_n134_));
  ...
  oai21  g091(.a(x18), .b(new_n78_), .c(new_n102_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n96_), .O(new_n139_));
  nand2  g093(.a(new_n134_), .b(x24), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n130_), .c(new_n106_), .O(new_n142_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n133_), .c(new_n113_), .d(new_n94_), .O(new_n151_));
  ...
  nand4  g112(.a(new_n133_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n159_));
