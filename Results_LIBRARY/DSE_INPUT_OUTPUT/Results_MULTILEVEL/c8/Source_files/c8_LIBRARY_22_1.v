...
module FAU ( 
  ...
  oai22  g59(.a(new_n105_), .b(new_n96_), .c(new_n90_), .d(new_n65_), .O(z12));
  ...
  oai22  g64(.a(new_n110_), .b(new_n96_), .c(new_n90_), .d(new_n68_), .O(z13));
  aoi21  g65(.a(new_n109_), .b(new_n93_), .c(new_n75_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n107_), .c(new_n98_), .d(new_n85_), .O(new_n114_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n75_), .c(new_n70_), .d(new_n120_), .O(new_n122_));
