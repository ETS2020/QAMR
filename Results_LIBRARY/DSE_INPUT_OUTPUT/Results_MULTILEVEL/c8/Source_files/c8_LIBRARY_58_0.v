...
module FAU ( 
  ...
  nand4  g53(.a(new_n56_), .b(new_n90_), .c(new_n82_), .d(new_n81_), .O(new_n100_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n98_), .d(new_n81_), .O(new_n117_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n114_), .c(new_n67_), .d(new_n62_), .O(new_n123_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n130_), .c(new_n114_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n81_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n57_), .d(new_n81_), .O(new_n142_));
