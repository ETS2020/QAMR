// Benchmark "FAU" written by ABC on Thu Aug 13 18:00:51 2020
...
module FAU ( 
  ...
  nor2   g060(.a(x18), .b(new_n61_), .O(new_n107_));
  ...
  oai21  g064(.a(new_n102_), .b(new_n63_), .c(new_n110_), .O(new_n111_));
  aoi21  g065(.a(new_n111_), .b(x16), .c(new_n55_), .O(new_n112_));
  oai21  g066(.a(new_n108_), .b(x16), .c(new_n112_), .O(z11));
  inv1   g067(.a(x03), .O(new_n114_));
  oai22  g068(.a(new_n99_), .b(new_n114_), .c(x18), .d(new_n66_), .O(new_n115_));
  ...
  nand2  g099(.a(new_n137_), .b(new_n118_), .O(new_n146_));
  nand3  g100(.a(new_n136_), .b(new_n89_), .c(x16), .O(new_n147_));
  nor2   g101(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(x18), .c(new_n52_), .O(new_n149_));
  ...
  oai22  g106(.a(new_n99_), .b(new_n152_), .c(x18), .d(new_n85_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n127_), .c(new_n109_), .d(new_n91_), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(new_n155_), .c(x18), .O(new_n158_));
  nor2   g112(.a(new_n83_), .b(new_n52_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n158_), .c(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n154_), .O(z16));
  nand2  g115(.a(new_n156_), .b(new_n127_), .O(new_n162_));
  nand3  g116(.a(new_n109_), .b(x19), .c(new_n89_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n48_), .d(new_n89_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n53_), .O(z17));
endmodule
