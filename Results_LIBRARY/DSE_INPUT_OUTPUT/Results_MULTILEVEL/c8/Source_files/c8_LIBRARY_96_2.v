...
module FAU ( 
  ...
  nor2   g045(.a(x18), .b(x09), .O(new_n92_));
  ...
  nand3  g052(.a(new_n55_), .b(new_n47_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g056(.a(x18), .b(new_n102_), .c(x01), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n101_), .O(z10));
  nand2  g058(.a(x18), .b(x02), .O(new_n105_));
  nand3  g059(.a(new_n52_), .b(x10), .c(new_n57_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n102_), .O(new_n108_));
  inv1   g062(.a(new_n99_), .O(new_n109_));
  ...
  nand2  g070(.a(new_n116_), .b(new_n102_), .O(new_n117_));
  aoi21  g071(.a(new_n52_), .b(x09), .c(x22), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n60_), .c(new_n55_), .d(new_n47_), .O(new_n119_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n53_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  nand3  g078(.a(new_n52_), .b(x12), .c(new_n57_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  nand4  g081(.a(new_n97_), .b(new_n68_), .c(new_n60_), .d(new_n55_), .O(new_n128_));
  ...
  nand2  g090(.a(new_n136_), .b(new_n102_), .O(new_n137_));
  aoi21  g091(.a(new_n130_), .b(new_n109_), .c(new_n78_), .O(new_n138_));
  nand4  g092(.a(new_n78_), .b(new_n73_), .c(new_n68_), .d(new_n60_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n99_), .O(new_n140_));
  ...
  nand3  g097(.a(new_n52_), .b(x14), .c(new_n57_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n102_), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n110_), .d(new_n97_), .O(new_n149_));
  oai21  g103(.a(new_n140_), .b(new_n83_), .c(new_n149_), .O(new_n150_));
  ...
  nand2  g108(.a(new_n154_), .b(new_n102_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n110_), .b(x19), .c(new_n98_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n48_), .d(new_n98_), .O(new_n162_));
