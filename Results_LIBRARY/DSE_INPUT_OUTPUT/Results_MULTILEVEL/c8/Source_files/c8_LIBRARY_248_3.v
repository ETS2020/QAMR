...
module FAU ( 
  ...
  aoi21  g064(.a(new_n105_), .b(new_n95_), .c(new_n67_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n95_), .c(new_n57_), .O(new_n113_));
  ...
  nand2  g078(.a(new_n116_), .b(x12), .O(new_n125_));
  ...
  nand4  g084(.a(new_n130_), .b(new_n112_), .c(new_n96_), .d(new_n85_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n116_), .b(x13), .O(new_n134_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n105_), .d(new_n95_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n116_), .b(x14), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n138_), .c(new_n105_), .d(new_n95_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n116_), .b(x15), .O(new_n151_));
  ...
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n85_), .O(new_n159_));
  ...
  aoi21  g116(.a(new_n162_), .b(new_n94_), .c(new_n83_), .O(z17));
endmodule
