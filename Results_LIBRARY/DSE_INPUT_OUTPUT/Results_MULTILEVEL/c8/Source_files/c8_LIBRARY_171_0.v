...
module FAU ( 
  ...
  nor2   g45(.a(new_n85_), .b(new_n56_), .O(new_n92_));
  ...
  nand4  g53(.a(new_n99_), .b(new_n56_), .c(new_n50_), .d(new_n83_), .O(new_n100_));
  ...
  nor2   g61(.a(new_n88_), .b(x16), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(x03), .O(new_n109_));
  oai21  g63(.a(new_n107_), .b(new_n87_), .c(new_n109_), .O(z12));
  ...
  nand4  g72(.a(new_n118_), .b(new_n105_), .c(new_n97_), .d(new_n83_), .O(new_n119_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n116_), .c(new_n69_), .d(new_n64_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n101_), .c(new_n119_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n108_), .b(x06), .O(new_n127_));
