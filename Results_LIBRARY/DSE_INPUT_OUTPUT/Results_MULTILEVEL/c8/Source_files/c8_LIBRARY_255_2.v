...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x22), .O(new_n53_));
  ...
  oai21  g024(.a(new_n48_), .b(x22), .c(new_n52_), .O(new_n71_));
  ...
  nor3   g065(.a(new_n111_), .b(x17), .c(new_n93_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(new_n53_), .O(new_n113_));
  nand2  g067(.a(new_n52_), .b(x22), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n102_), .c(x21), .d(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(z11));
  ...
  nand2  g073(.a(new_n110_), .b(new_n91_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  nor2   g075(.a(new_n121_), .b(new_n66_), .O(new_n122_));
  inv1   g076(.a(new_n91_), .O(new_n123_));
  nand3  g077(.a(new_n66_), .b(new_n61_), .c(new_n58_), .O(new_n124_));
  nor2   g078(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n119_), .c(new_n53_), .O(z12));
  inv1   g081(.a(x12), .O(new_n128_));
  ...
  oai21  g085(.a(new_n52_), .b(x16), .c(x22), .O(new_n132_));
  nand4  g086(.a(new_n91_), .b(new_n52_), .c(new_n61_), .d(new_n58_), .O(new_n133_));
  oai21  g087(.a(new_n121_), .b(new_n52_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n132_), .c(new_n131_), .O(z13));
  ...
  oai21  g093(.a(new_n73_), .b(new_n93_), .c(x23), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x22), .O(new_n141_));
  nand2  g095(.a(new_n133_), .b(x24), .O(new_n142_));
  nor3   g096(.a(x24), .b(x23), .c(x21), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n103_), .O(new_n144_));
  ...
  oai21  g104(.a(new_n80_), .b(new_n93_), .c(x23), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x22), .O(new_n152_));
  aoi21  g106(.a(new_n143_), .b(new_n103_), .c(new_n80_), .O(new_n153_));
  nand2  g107(.a(new_n52_), .b(new_n61_), .O(new_n154_));
  nand2  g108(.a(new_n80_), .b(new_n73_), .O(new_n155_));
  nor3   g109(.a(new_n155_), .b(new_n154_), .c(new_n102_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n53_), .c(new_n93_), .O(new_n161_));
  nand3  g115(.a(new_n80_), .b(new_n73_), .c(new_n61_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(new_n102_), .c(x26), .O(new_n163_));
  nor2   g117(.a(x24), .b(x23), .O(new_n164_));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n164_), .c(new_n110_), .d(new_n91_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n163_), .c(x22), .O(new_n167_));
  nor2   g121(.a(new_n85_), .b(new_n52_), .O(new_n168_));
  ...
  nor2   g125(.a(new_n47_), .b(x17), .O(new_n172_));
  nor2   g126(.a(x23), .b(x22), .O(new_n173_));
  nor3   g127(.a(x26), .b(x25), .c(x24), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n173_), .c(new_n172_), .d(new_n110_), .O(new_n175_));
  aoi21  g129(.a(new_n175_), .b(new_n171_), .c(new_n93_), .O(z17));
endmodule
