...
module FAU ( 
  ...
  oai21  g48(.a(x18), .b(x09), .c(new_n92_), .O(new_n95_));
  nor2   g49(.a(new_n90_), .b(new_n54_), .O(new_n96_));
  ...
  oai21  g53(.a(x18), .b(x10), .c(new_n92_), .O(new_n100_));
  ...
  oai21  g59(.a(new_n105_), .b(new_n92_), .c(new_n100_), .O(z11));
  nor3   g60(.a(x22), .b(x21), .c(x20), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n90_), .c(new_n103_), .d(x22), .O(new_n108_));
  nand2  g62(.a(new_n48_), .b(new_n92_), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n63_), .c(new_n108_), .d(new_n92_), .O(z12));
  ...
  oai22  g68(.a(new_n114_), .b(new_n92_), .c(new_n109_), .d(new_n66_), .O(z13));
  ...
  nand3  g74(.a(new_n48_), .b(new_n92_), .c(x13), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  oai21  g76(.a(x18), .b(x14), .c(new_n92_), .O(new_n123_));
  ...
  oai21  g81(.a(new_n127_), .b(new_n92_), .c(new_n123_), .O(z15));
  oai21  g82(.a(x18), .b(x15), .c(new_n92_), .O(new_n129_));
  nor2   g83(.a(x21), .b(x20), .O(new_n130_));
  nor2   g84(.a(x23), .b(x22), .O(new_n131_));
  nor2   g85(.a(x25), .b(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n90_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x26), .O(new_n134_));
  nor3   g88(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n131_), .c(new_n130_), .d(new_n90_), .O(new_n136_));
  ...
  nand4  g94(.a(new_n131_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n141_));
  nand3  g95(.a(new_n130_), .b(x19), .c(new_n87_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n55_), .d(new_n87_), .O(new_n143_));
