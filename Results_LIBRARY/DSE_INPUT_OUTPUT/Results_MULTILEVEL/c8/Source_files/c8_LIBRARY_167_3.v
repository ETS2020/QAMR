...
module FAU ( 
  ...
  oai21  g020(.a(x27), .b(new_n66_), .c(new_n65_), .O(new_n67_));
  nand2  g021(.a(new_n52_), .b(new_n66_), .O(new_n68_));
  oai21  g022(.a(new_n68_), .b(x18), .c(new_n67_), .O(z03));
  ...
  nand2  g042(.a(x18), .b(new_n65_), .O(new_n89_));
  ...
  oai22  g052(.a(new_n89_), .b(new_n98_), .c(x18), .d(new_n55_), .O(new_n99_));
  ...
  oai21  g057(.a(new_n93_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n47_), .c(x16), .O(new_n105_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n47_), .O(z11));
  oai21  g069(.a(x18), .b(new_n87_), .c(x11), .O(new_n116_));
  aoi21  g070(.a(new_n111_), .b(new_n93_), .c(new_n66_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n93_), .c(new_n57_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(x18), .b(new_n87_), .c(x03), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n121_), .c(new_n116_), .O(z12));
  inv1   g077(.a(x04), .O(new_n124_));
  oai22  g078(.a(new_n89_), .b(new_n124_), .c(x18), .d(new_n70_), .O(new_n125_));
  ...
  nand2  g082(.a(new_n128_), .b(new_n110_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n47_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n126_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai21  g087(.a(x18), .b(new_n73_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n87_), .O(new_n135_));
  inv1   g089(.a(x24), .O(new_n136_));
  aoi21  g090(.a(new_n128_), .b(new_n110_), .c(new_n136_), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n102_), .d(new_n101_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n47_), .O(z14));
  inv1   g096(.a(x06), .O(new_n143_));
  oai22  g097(.a(new_n89_), .b(new_n143_), .c(x18), .d(new_n76_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n111_), .d(new_n93_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n111_), .d(new_n93_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n83_), .c(new_n78_), .d(new_n136_), .O(new_n162_));
  nand3  g116(.a(new_n111_), .b(x19), .c(new_n101_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n52_), .d(new_n101_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n47_), .O(z17));
endmodule
