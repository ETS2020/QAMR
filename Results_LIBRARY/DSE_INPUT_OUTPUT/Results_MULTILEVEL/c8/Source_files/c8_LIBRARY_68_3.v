...
module FAU ( 
  ...
  nand2  g049(.a(new_n67_), .b(x18), .O(new_n96_));
  ...
  oai22  g058(.a(new_n96_), .b(new_n104_), .c(x18), .d(new_n58_), .O(new_n105_));
  ...
  oai22  g068(.a(new_n96_), .b(new_n114_), .c(x18), .d(new_n61_), .O(new_n115_));
  ...
  oai21  g089(.a(new_n72_), .b(new_n90_), .c(new_n66_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x23), .O(new_n137_));
  nand2  g091(.a(new_n119_), .b(x24), .O(new_n138_));
  nand3  g092(.a(new_n118_), .b(new_n72_), .c(new_n67_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n100_), .c(new_n138_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n137_), .c(new_n135_), .O(z14));
  inv1   g096(.a(x06), .O(new_n143_));
  oai22  g097(.a(new_n96_), .b(new_n143_), .c(x18), .d(new_n75_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n90_), .O(new_n145_));
  nand3  g099(.a(new_n72_), .b(new_n63_), .c(new_n107_), .O(new_n146_));
  oai21  g100(.a(new_n146_), .b(new_n100_), .c(x25), .O(new_n147_));
  nor2   g101(.a(x20), .b(x19), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n118_), .c(new_n148_), .d(new_n86_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n147_), .c(x23), .O(new_n151_));
  nor3   g105(.a(new_n77_), .b(new_n67_), .c(x18), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n151_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n145_), .O(z15));
  inv1   g108(.a(x07), .O(new_n155_));
  oai22  g109(.a(new_n96_), .b(new_n155_), .c(x18), .d(new_n80_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n90_), .O(new_n157_));
  nand2  g111(.a(new_n150_), .b(x26), .O(new_n158_));
  nor2   g112(.a(x24), .b(x22), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n159_), .c(new_n109_), .d(new_n88_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n158_), .c(x23), .O(new_n162_));
  nor3   g116(.a(new_n82_), .b(new_n67_), .c(x18), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(new_n162_), .c(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n157_), .O(z16));
  nand3  g119(.a(new_n109_), .b(x19), .c(new_n86_), .O(new_n166_));
  nand3  g120(.a(new_n160_), .b(new_n128_), .c(new_n72_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n52_), .d(new_n86_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n47_), .O(z17));
endmodule
