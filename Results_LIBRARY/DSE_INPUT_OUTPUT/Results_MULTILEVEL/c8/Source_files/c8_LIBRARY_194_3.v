...
module FAU ( 
  ...
  oai21  g056(.a(new_n92_), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n100_), .c(x16), .O(new_n104_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n92_), .c(new_n60_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n100_), .c(x16), .O(new_n122_));
  ...
  nand3  g080(.a(new_n90_), .b(new_n51_), .c(new_n82_), .O(new_n127_));
  inv1   g081(.a(x23), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n107_), .c(new_n60_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n127_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n109_), .c(new_n131_), .d(new_n82_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n100_), .c(x16), .O(new_n135_));
  ...
  nand3  g097(.a(new_n143_), .b(new_n100_), .c(x16), .O(new_n144_));
  ...
  nand2  g105(.a(new_n86_), .b(x15), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n119_), .c(new_n71_), .O(new_n155_));
  nand3  g109(.a(new_n101_), .b(x19), .c(new_n82_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n82_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n100_), .c(x16), .O(new_n158_));
