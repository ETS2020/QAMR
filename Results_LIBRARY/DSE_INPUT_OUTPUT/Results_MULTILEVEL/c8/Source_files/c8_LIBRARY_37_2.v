...
module FAU ( 
  ...
  nor2   g055(.a(new_n91_), .b(new_n47_), .O(new_n102_));
  nand3  g056(.a(new_n47_), .b(new_n52_), .c(new_n89_), .O(new_n103_));
  inv1   g057(.a(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n102_), .c(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n101_), .c(new_n48_), .O(z10));
  ...
  oai21  g063(.a(new_n58_), .b(new_n93_), .c(x20), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x18), .O(new_n111_));
  nor2   g065(.a(x21), .b(x20), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n91_), .O(new_n113_));
  oai21  g067(.a(new_n104_), .b(new_n58_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n111_), .c(new_n109_), .O(z11));
  ...
  oai21  g073(.a(new_n63_), .b(new_n93_), .c(x20), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x18), .O(new_n121_));
  aoi21  g075(.a(new_n112_), .b(new_n91_), .c(new_n63_), .O(new_n122_));
  nand4  g076(.a(new_n91_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n122_), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n121_), .c(new_n119_), .O(z12));
  nand2  g080(.a(x18), .b(x04), .O(new_n127_));
  oai21  g081(.a(x18), .b(new_n70_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n93_), .O(new_n129_));
  oai21  g083(.a(new_n68_), .b(new_n93_), .c(x20), .O(new_n130_));
  ...
  oai21  g087(.a(new_n124_), .b(new_n68_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n131_), .c(new_n129_), .O(z13));
  ...
  oai21  g093(.a(new_n75_), .b(new_n93_), .c(x20), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x18), .O(new_n141_));
  aoi21  g095(.a(new_n132_), .b(new_n104_), .c(new_n75_), .O(new_n142_));
  nand2  g096(.a(new_n63_), .b(new_n58_), .O(new_n143_));
  nand2  g097(.a(new_n75_), .b(new_n68_), .O(new_n144_));
  nor3   g098(.a(new_n144_), .b(new_n143_), .c(new_n103_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n142_), .c(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n141_), .c(new_n139_), .O(z14));
  nand3  g101(.a(x20), .b(x18), .c(x06), .O(new_n148_));
  oai21  g102(.a(x18), .b(new_n78_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n93_), .O(new_n150_));
  nand3  g104(.a(new_n58_), .b(new_n52_), .c(new_n89_), .O(new_n151_));
  nand3  g105(.a(new_n75_), .b(new_n68_), .c(new_n63_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n151_), .c(x25), .O(new_n153_));
  nor2   g107(.a(x23), .b(x22), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n154_), .c(new_n112_), .d(new_n91_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n153_), .c(x18), .O(new_n157_));
  nor2   g111(.a(new_n80_), .b(new_n47_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n157_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n150_), .O(z15));
  nand2  g114(.a(x18), .b(x07), .O(new_n161_));
  oai21  g115(.a(x18), .b(new_n85_), .c(new_n161_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n93_), .O(new_n163_));
  oai21  g117(.a(new_n83_), .b(new_n93_), .c(x20), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x18), .O(new_n165_));
  nand2  g119(.a(new_n156_), .b(x26), .O(new_n166_));
  nor3   g120(.a(x26), .b(x25), .c(x24), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n154_), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n113_), .c(new_n166_), .O(new_n169_));
  ...
  nand3  g127(.a(new_n173_), .b(new_n112_), .c(x19), .O(new_n174_));
