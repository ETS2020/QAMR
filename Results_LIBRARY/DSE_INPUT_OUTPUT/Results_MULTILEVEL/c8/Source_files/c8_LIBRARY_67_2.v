...
module FAU ( 
  ...
  oai21  g034(.a(new_n53_), .b(x18), .c(new_n47_), .O(new_n81_));
  oai21  g035(.a(new_n53_), .b(x14), .c(new_n81_), .O(z06));
  ...
  oai22  g059(.a(new_n91_), .b(new_n105_), .c(x18), .d(new_n63_), .O(new_n106_));
  ...
  aoi21  g069(.a(new_n47_), .b(x18), .c(x22), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n61_), .c(new_n56_), .d(new_n52_), .O(new_n117_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n100_), .c(new_n56_), .O(new_n126_));
  ...
  oai22  g087(.a(new_n91_), .b(new_n133_), .c(x18), .d(new_n76_), .O(new_n134_));
  ...
  oai22  g097(.a(new_n91_), .b(new_n142_), .c(x18), .d(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n89_), .O(new_n145_));
  nand2  g099(.a(new_n138_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x20), .b(x19), .O(new_n147_));
  nor2   g101(.a(x18), .b(x17), .O(new_n148_));
  nor3   g102(.a(x25), .b(x24), .c(x23), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n125_), .d(new_n147_), .O(new_n150_));
  ...
  oai21  g110(.a(new_n83_), .b(new_n89_), .c(x25), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x18), .O(new_n158_));
  nand3  g112(.a(new_n128_), .b(new_n47_), .c(new_n78_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n109_), .c(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n128_), .c(new_n108_), .d(new_n100_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n158_), .c(new_n156_), .O(z16));
  nand3  g119(.a(new_n48_), .b(x27), .c(x17), .O(new_n166_));
  nand2  g120(.a(new_n108_), .b(x19), .O(new_n167_));
  inv1   g121(.a(new_n167_), .O(new_n168_));
  nand4  g122(.a(new_n168_), .b(new_n161_), .c(new_n148_), .d(new_n128_), .O(new_n169_));
  aoi21  g123(.a(new_n169_), .b(new_n166_), .c(new_n89_), .O(z17));
endmodule
