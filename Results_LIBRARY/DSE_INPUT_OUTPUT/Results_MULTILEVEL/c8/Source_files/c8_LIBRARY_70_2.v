...
module FAU ( 
  ...
  nor2   g011(.a(new_n48_), .b(new_n52_), .O(z08));
  inv1   g012(.a(z08), .O(new_n59_));
  inv1   g013(.a(x21), .O(new_n60_));
  inv1   g014(.a(x22), .O(new_n61_));
  nand2  g015(.a(new_n61_), .b(x18), .O(new_n62_));
  nand3  g016(.a(new_n62_), .b(new_n52_), .c(new_n60_), .O(new_n63_));
  oai21  g017(.a(new_n59_), .b(x10), .c(new_n63_), .O(z02));
  nand3  g018(.a(new_n52_), .b(new_n61_), .c(new_n47_), .O(new_n65_));
  ...
  nand3  g040(.a(new_n86_), .b(new_n82_), .c(new_n79_), .O(z09));
  ...
  nand3  g048(.a(new_n94_), .b(new_n90_), .c(new_n79_), .O(z10));
  ...
  nand3  g057(.a(new_n103_), .b(new_n99_), .c(new_n79_), .O(z11));
  ...
  oai21  g062(.a(new_n60_), .b(new_n83_), .c(x22), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x18), .O(new_n110_));
  aoi21  g064(.a(new_n100_), .b(new_n81_), .c(new_n61_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n81_), .c(new_n91_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n108_), .O(z12));
  ...
  nand2  g076(.a(new_n113_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n93_), .c(new_n60_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x16), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n119_), .O(z13));
  nand3  g082(.a(x22), .b(x18), .c(x05), .O(new_n129_));
  oai21  g083(.a(x18), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n83_), .O(new_n131_));
  nor2   g085(.a(x23), .b(x21), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n81_), .c(new_n91_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x24), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n112_), .c(new_n93_), .O(new_n136_));
  aoi21  g090(.a(new_n136_), .b(new_n134_), .c(x18), .O(new_n137_));
  and2   g091(.a(x24), .b(x22), .O(new_n138_));
  ...
  nand2  g097(.a(x25), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x22), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x18), .O(new_n146_));
  nand2  g100(.a(new_n136_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n124_), .c(new_n100_), .d(new_n81_), .O(new_n149_));
  ...
  nand2  g112(.a(new_n149_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n124_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n101_), .c(new_n159_), .O(new_n162_));
  ...
  nand3  g120(.a(new_n166_), .b(new_n100_), .c(x19), .O(new_n167_));
  or2    g121(.a(new_n167_), .b(new_n161_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n165_), .c(new_n83_), .O(z17));
endmodule
