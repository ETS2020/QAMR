...
module FAU ( 
  ...
  nand4  g56(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n86_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n102_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n99_), .c(new_n100_), .O(z11));
  ...
  oai21  g65(.a(new_n110_), .b(new_n99_), .c(new_n111_), .O(z12));
  oai21  g66(.a(new_n90_), .b(x04), .c(new_n99_), .O(new_n113_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n95_), .c(new_n109_), .d(x23), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n99_), .c(new_n113_), .O(z13));
  oai21  g70(.a(new_n90_), .b(x05), .c(new_n99_), .O(new_n117_));
  aoi21  g71(.a(new_n114_), .b(new_n95_), .c(new_n76_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n108_), .c(new_n101_), .d(new_n86_), .O(new_n120_));
  ...
  oai21  g77(.a(new_n90_), .b(x06), .c(new_n99_), .O(new_n124_));
  ...
  oai21  g82(.a(new_n128_), .b(new_n99_), .c(new_n124_), .O(z15));
  ...
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n99_), .O(z17));
endmodule
