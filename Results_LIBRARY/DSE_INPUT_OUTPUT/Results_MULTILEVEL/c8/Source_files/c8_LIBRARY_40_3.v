...
module FAU ( 
  ...
  nand3  g083(.a(new_n66_), .b(new_n129_), .c(new_n99_), .O(new_n130_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n109_), .c(x16), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n100_), .d(new_n91_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n95_), .b(x14), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n118_), .c(new_n100_), .d(new_n91_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n109_), .c(x16), .O(new_n153_));
  ...
  aoi21  g116(.a(new_n162_), .b(new_n109_), .c(new_n86_), .O(z17));
endmodule
