...
module FAU ( 
  ...
  nand3  g056(.a(new_n91_), .b(x09), .c(new_n52_), .O(new_n103_));
  ...
  oai21  g062(.a(new_n97_), .b(new_n57_), .c(new_n108_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n95_), .c(x16), .O(new_n110_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n95_), .O(z11));
  ...
  aoi21  g077(.a(new_n116_), .b(new_n97_), .c(new_n67_), .O(new_n124_));
  nor2   g078(.a(x22), .b(x21), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n97_), .c(new_n57_), .O(new_n126_));
  inv1   g080(.a(new_n126_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n124_), .c(x16), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n95_), .O(z12));
  oai21  g083(.a(new_n91_), .b(new_n89_), .c(x04), .O(new_n130_));
  nand2  g084(.a(new_n126_), .b(x23), .O(new_n131_));
  nor3   g085(.a(x23), .b(x22), .c(x21), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n115_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g089(.a(new_n91_), .b(new_n89_), .c(x12), .O(new_n136_));
  ...
  aoi21  g094(.a(new_n132_), .b(new_n115_), .c(new_n77_), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n125_), .c(new_n107_), .d(new_n106_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n141_), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n140_), .c(new_n95_), .O(z14));
  ...
  nand4  g106(.a(new_n152_), .b(new_n151_), .c(new_n116_), .d(new_n97_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n149_), .c(new_n95_), .O(z15));
  ...
  nand4  g115(.a(new_n161_), .b(new_n151_), .c(new_n116_), .d(new_n97_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n159_), .c(new_n95_), .O(z16));
  nor2   g119(.a(x26), .b(x25), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n151_), .c(new_n77_), .O(new_n167_));
  nand3  g121(.a(new_n116_), .b(x19), .c(new_n106_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n50_), .d(new_n106_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n95_), .O(z17));
endmodule
