...
module FAU ( 
  ...
  nand2  g037(.a(new_n55_), .b(new_n82_), .O(new_n84_));
  oai21  g038(.a(new_n84_), .b(x18), .c(new_n83_), .O(z07));
  ...
  nand2  g056(.a(x18), .b(new_n81_), .O(new_n103_));
  oai22  g057(.a(new_n103_), .b(new_n102_), .c(x18), .d(new_n58_), .O(new_n104_));
  ...
  oai22  g065(.a(new_n103_), .b(new_n111_), .c(x18), .d(new_n63_), .O(new_n112_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n48_), .O(z13));
  ...
  aoi21  g086(.a(new_n124_), .b(new_n99_), .c(new_n132_), .O(new_n133_));
  inv1   g087(.a(x17), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n134_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n133_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n131_), .c(new_n48_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n103_), .b(new_n141_), .c(x18), .d(new_n76_), .O(new_n142_));
  ...
  oai21  g104(.a(x18), .b(new_n90_), .c(x15), .O(new_n151_));
  nand2  g105(.a(new_n147_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n145_), .c(new_n106_), .d(new_n88_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(x18), .b(new_n90_), .c(x07), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n151_), .O(z16));
  nand4  g112(.a(new_n145_), .b(new_n82_), .c(new_n78_), .d(new_n132_), .O(new_n159_));
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n134_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n134_), .O(new_n161_));
