...
module FAU ( 
  ...
  nand2  g033(.a(new_n52_), .b(new_n50_), .O(z08));
  inv1   g034(.a(x16), .O(new_n81_));
  inv1   g035(.a(x00), .O(new_n82_));
  inv1   g036(.a(x06), .O(new_n83_));
  ...
  nand2  g093(.a(new_n136_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n123_), .c(new_n105_), .d(new_n94_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n52_), .c(x16), .O(new_n144_));
  inv1   g098(.a(x18), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n81_), .c(x14), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(z15));
  ...
  nand2  g104(.a(new_n142_), .b(x26), .O(new_n151_));
  ...
  nand2  g116(.a(new_n162_), .b(new_n52_), .O(z17));
endmodule
