...
module FAU ( 
  ...
  nand2  g018(.a(new_n52_), .b(new_n64_), .O(new_n65_));
  ...
  nand2  g038(.a(new_n47_), .b(new_n52_), .O(z08));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n47_), .O(z09));
  inv1   g048(.a(x01), .O(new_n95_));
  nand2  g049(.a(new_n59_), .b(x18), .O(new_n96_));
  ...
  nand3  g053(.a(new_n99_), .b(new_n51_), .c(new_n86_), .O(new_n100_));
  oai21  g054(.a(new_n88_), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n47_), .c(x16), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n98_), .O(z10));
  inv1   g057(.a(x02), .O(new_n104_));
  nand2  g058(.a(new_n58_), .b(x10), .O(new_n105_));
  oai21  g059(.a(new_n96_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  nand3  g061(.a(new_n100_), .b(x21), .c(new_n58_), .O(new_n108_));
  ...
  oai22  g068(.a(new_n96_), .b(new_n114_), .c(x18), .d(new_n62_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n90_), .O(new_n116_));
  inv1   g070(.a(new_n100_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x20), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n88_), .O(new_n119_));
  oai21  g073(.a(new_n117_), .b(new_n64_), .c(new_n119_), .O(new_n120_));
  nor3   g074(.a(new_n64_), .b(new_n59_), .c(x18), .O(new_n121_));
  aoi21  g075(.a(new_n120_), .b(new_n59_), .c(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n90_), .c(new_n116_), .O(z12));
  ...
  oai21  g080(.a(new_n69_), .b(new_n90_), .c(new_n58_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x21), .O(new_n128_));
  aoi21  g082(.a(new_n118_), .b(new_n88_), .c(new_n69_), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n59_), .O(new_n131_));
  nor2   g085(.a(new_n131_), .b(new_n100_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n128_), .c(new_n126_), .O(z13));
  ...
  oai21  g092(.a(new_n138_), .b(new_n90_), .c(new_n58_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x21), .O(new_n140_));
  nand3  g094(.a(new_n130_), .b(new_n88_), .c(new_n99_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x24), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n64_), .c(new_n59_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n100_), .c(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n140_), .c(new_n137_), .O(z14));
  inv1   g101(.a(x06), .O(new_n148_));
  oai22  g102(.a(new_n96_), .b(new_n148_), .c(x18), .d(new_n75_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n90_), .O(new_n150_));
  nand3  g104(.a(new_n138_), .b(new_n69_), .c(new_n64_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n100_), .c(x25), .O(new_n152_));
  nor2   g106(.a(x20), .b(x19), .O(new_n153_));
  nor2   g107(.a(x25), .b(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n130_), .c(new_n153_), .d(new_n86_), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(new_n152_), .c(x21), .O(new_n156_));
  nor3   g110(.a(new_n77_), .b(new_n59_), .c(x18), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n156_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n150_), .O(z15));
  inv1   g113(.a(x07), .O(new_n160_));
  oai22  g114(.a(new_n96_), .b(new_n160_), .c(x18), .d(new_n80_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n90_), .O(new_n162_));
  nand2  g116(.a(new_n155_), .b(x26), .O(new_n163_));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n143_), .c(new_n118_), .d(new_n88_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n163_), .c(x21), .O(new_n166_));
  nor3   g120(.a(new_n82_), .b(new_n59_), .c(x18), .O(new_n167_));
  oai21  g121(.a(new_n167_), .b(new_n166_), .c(x16), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n162_), .O(z16));
  nand3  g123(.a(new_n47_), .b(x27), .c(x17), .O(new_n170_));
