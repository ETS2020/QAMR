...
module FAU ( 
  ...
  nand3  g078(.a(x18), .b(new_n48_), .c(x04), .O(new_n125_));
  ...
  aoi21  g082(.a(new_n121_), .b(new_n104_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g087(.a(x18), .b(new_n48_), .c(x05), .O(new_n134_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n105_), .d(new_n94_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n140_), .b(new_n79_), .c(new_n74_), .d(new_n128_), .O(new_n155_));
  nand3  g109(.a(new_n105_), .b(x19), .c(new_n95_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n58_), .d(new_n95_), .O(new_n157_));
