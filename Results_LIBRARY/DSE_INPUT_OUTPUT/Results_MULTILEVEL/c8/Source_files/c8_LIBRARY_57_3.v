...
module FAU ( 
  ...
  nand2  g052(.a(new_n91_), .b(x10), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n98_), .c(new_n94_), .O(z11));
  nand2  g054(.a(x18), .b(x03), .O(new_n101_));
  oai21  g055(.a(x18), .b(new_n61_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g070(.a(new_n91_), .b(x12), .O(new_n117_));
  ...
  nand3  g077(.a(new_n86_), .b(new_n123_), .c(new_n122_), .O(new_n124_));
  inv1   g078(.a(x22), .O(new_n125_));
  nand3  g079(.a(new_n66_), .b(new_n125_), .c(new_n57_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n124_), .c(x24), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n106_), .c(new_n128_), .d(new_n122_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n104_), .c(x16), .O(new_n132_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n113_), .c(new_n95_), .d(new_n87_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n104_), .c(x16), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n113_), .c(new_n95_), .d(new_n87_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n91_), .b(x15), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  inv1   g104(.a(x24), .O(new_n151_));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n113_), .c(new_n151_), .O(new_n153_));
  nand3  g107(.a(new_n95_), .b(x19), .c(new_n122_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n58_), .d(new_n122_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n104_), .c(x16), .O(new_n156_));
