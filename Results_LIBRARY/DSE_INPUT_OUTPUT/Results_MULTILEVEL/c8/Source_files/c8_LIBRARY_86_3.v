...
module FAU ( 
  ...
  aoi21  g061(.a(new_n102_), .b(new_n84_), .c(new_n63_), .O(new_n108_));
  ...
  nand2  g066(.a(new_n86_), .b(x11), .O(new_n113_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n102_), .d(new_n84_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g093(.a(new_n86_), .b(x14), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n135_), .c(new_n102_), .d(new_n84_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n100_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z16));
  nor2   g104(.a(x26), .b(x25), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n135_), .c(new_n124_), .O(new_n152_));
  nand3  g106(.a(new_n102_), .b(x19), .c(new_n82_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n52_), .d(new_n82_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n100_), .c(x16), .O(new_n155_));
