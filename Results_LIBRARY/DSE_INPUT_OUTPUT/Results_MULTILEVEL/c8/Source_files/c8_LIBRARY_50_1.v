...
module FAU ( 
  ...
  nand2  g008(.a(x18), .b(new_n54_), .O(new_n55_));
  ...
  nor2   g041(.a(new_n56_), .b(new_n52_), .O(z08));
  xnor2a g042(.a(x19), .b(x17), .O(new_n89_));
  inv1   g043(.a(x00), .O(new_n90_));
  aoi21  g044(.a(x18), .b(new_n90_), .c(x16), .O(new_n91_));
  aoi21  g045(.a(new_n89_), .b(x16), .c(new_n91_), .O(new_n92_));
  inv1   g046(.a(x18), .O(new_n93_));
  nand3  g047(.a(new_n89_), .b(new_n93_), .c(x16), .O(new_n94_));
  oai21  g048(.a(new_n92_), .b(new_n54_), .c(new_n94_), .O(z09));
  inv1   g049(.a(x16), .O(new_n96_));
  nand2  g050(.a(x18), .b(x01), .O(new_n97_));
  oai21  g051(.a(x18), .b(new_n49_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nor2   g053(.a(x19), .b(x17), .O(new_n100_));
  nor2   g054(.a(new_n100_), .b(new_n51_), .O(new_n101_));
  inv1   g055(.a(x17), .O(new_n102_));
  inv1   g056(.a(x19), .O(new_n103_));
  nand3  g057(.a(new_n51_), .b(new_n103_), .c(new_n102_), .O(new_n104_));
  inv1   g058(.a(new_n104_), .O(new_n105_));
  oai21  g059(.a(new_n105_), .b(new_n101_), .c(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n99_), .c(new_n55_), .O(z10));
  inv1   g061(.a(x02), .O(new_n108_));
  nand2  g062(.a(x18), .b(x08), .O(new_n109_));
  oai22  g063(.a(new_n109_), .b(new_n108_), .c(x18), .d(new_n58_), .O(new_n110_));
  ...
  oai21  g067(.a(new_n105_), .b(new_n60_), .c(new_n113_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n55_), .c(x16), .O(new_n115_));
  ...
  aoi21  g073(.a(x18), .b(new_n54_), .c(x22), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n60_), .c(new_n51_), .d(new_n103_), .O(new_n121_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n55_), .O(z12));
  ...
  nand4  g082(.a(new_n100_), .b(new_n65_), .c(new_n60_), .d(new_n51_), .O(new_n129_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n128_), .c(new_n55_), .O(z13));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n105_), .c(new_n73_), .O(new_n139_));
  nand4  g093(.a(new_n73_), .b(new_n68_), .c(new_n65_), .d(new_n60_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n104_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n138_), .c(new_n55_), .O(z14));
  ...
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n55_), .O(z15));
  inv1   g106(.a(x07), .O(new_n153_));
  oai22  g107(.a(new_n109_), .b(new_n153_), .c(x18), .d(new_n85_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n96_), .O(new_n155_));
  nand2  g109(.a(new_n149_), .b(x26), .O(new_n156_));
  nand4  g110(.a(new_n147_), .b(new_n83_), .c(new_n80_), .d(new_n73_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n113_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n55_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n155_), .O(z16));
  nand3  g114(.a(new_n112_), .b(x19), .c(new_n102_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n52_), .d(new_n102_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n55_), .O(z17));
endmodule
