...
module FAU ( 
  ...
  oai21  g060(.a(new_n95_), .b(new_n104_), .c(new_n106_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n103_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n102_), .O(z11));
  oai21  g063(.a(x16), .b(x03), .c(x18), .O(new_n110_));
  aoi21  g064(.a(new_n105_), .b(new_n87_), .c(new_n60_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n87_), .c(new_n93_), .O(new_n113_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n104_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n93_), .b(new_n85_), .c(new_n84_), .O(new_n129_));
  inv1   g083(.a(x23), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n60_), .c(new_n104_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n129_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n112_), .c(new_n133_), .d(new_n84_), .O(new_n135_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n105_), .d(new_n87_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n105_), .d(new_n87_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n89_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand4  g109(.a(new_n120_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n156_));
  nand3  g110(.a(new_n105_), .b(x19), .c(new_n84_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n61_), .d(new_n84_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n103_), .c(x16), .O(new_n159_));
