...
module FAU ( 
  ...
  oai21  g047(.a(x18), .b(new_n89_), .c(x09), .O(new_n94_));
  nor2   g048(.a(new_n87_), .b(new_n56_), .O(new_n95_));
  nor3   g049(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  nand3  g051(.a(x18), .b(new_n89_), .c(x01), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n97_), .c(new_n94_), .O(z10));
  inv1   g053(.a(x02), .O(new_n100_));
  nand2  g054(.a(x18), .b(new_n55_), .O(new_n101_));
  ...
  oai22  g063(.a(new_n101_), .b(new_n109_), .c(x18), .d(new_n65_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n89_), .O(new_n111_));
  nand2  g065(.a(new_n105_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n87_), .c(new_n56_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n47_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n111_), .O(z12));
  inv1   g071(.a(x04), .O(new_n118_));
  oai22  g072(.a(new_n101_), .b(new_n118_), .c(x18), .d(new_n68_), .O(new_n119_));
  ...
  oai22  g081(.a(new_n101_), .b(new_n127_), .c(x18), .d(new_n73_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n89_), .O(new_n129_));
  nand3  g083(.a(new_n56_), .b(new_n51_), .c(new_n85_), .O(new_n130_));
  inv1   g084(.a(x22), .O(new_n131_));
  nand3  g085(.a(new_n70_), .b(new_n131_), .c(new_n62_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n113_), .c(new_n134_), .d(new_n85_), .O(new_n136_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n122_), .c(new_n104_), .d(new_n87_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n47_), .O(z16));
  inv1   g111(.a(x24), .O(new_n158_));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n122_), .c(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n85_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n85_), .O(new_n162_));
