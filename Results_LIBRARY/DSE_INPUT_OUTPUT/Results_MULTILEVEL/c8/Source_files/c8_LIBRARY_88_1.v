...
module FAU ( 
  ...
  nand4  g55(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n87_), .O(new_n102_));
  ...
  nand3  g67(.a(new_n47_), .b(new_n91_), .c(x12), .O(new_n114_));
  oai21  g68(.a(new_n113_), .b(new_n91_), .c(new_n114_), .O(z13));
  oai21  g69(.a(x18), .b(x13), .c(new_n91_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  aoi21  g71(.a(new_n112_), .b(new_n96_), .c(new_n117_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n108_), .c(new_n100_), .d(new_n87_), .O(new_n120_));
  ...
  nand3  g91(.a(new_n47_), .b(new_n91_), .c(x15), .O(new_n138_));
