...
module FAU ( 
  ...
  nand3  g079(.a(new_n125_), .b(new_n92_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n121_), .O(z13));
  oai21  g081(.a(x16), .b(x05), .c(x18), .O(new_n128_));
  aoi21  g082(.a(new_n123_), .b(new_n102_), .c(new_n73_), .O(new_n129_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n103_), .d(new_n94_), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n103_), .d(new_n94_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n107_), .b(x15), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n140_), .c(new_n73_), .O(new_n155_));
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n95_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n95_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n92_), .c(x16), .O(new_n158_));
