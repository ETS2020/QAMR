...
module FAU ( 
  ...
  nand3  g020(.a(new_n66_), .b(new_n65_), .c(new_n48_), .O(z03));
  ...
  nand2  g042(.a(new_n64_), .b(x18), .O(new_n89_));
  ...
  oai21  g052(.a(x18), .b(new_n52_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  nor2   g054(.a(new_n93_), .b(new_n54_), .O(new_n101_));
  inv1   g055(.a(x17), .O(new_n102_));
  inv1   g056(.a(x19), .O(new_n103_));
  nand3  g057(.a(new_n54_), .b(new_n103_), .c(new_n102_), .O(new_n104_));
  inv1   g058(.a(new_n104_), .O(new_n105_));
  oai21  g059(.a(new_n105_), .b(new_n101_), .c(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n100_), .c(new_n48_), .O(z10));
  nor2   g061(.a(x18), .b(new_n58_), .O(new_n108_));
  ...
  oai21  g065(.a(new_n105_), .b(new_n60_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n93_), .c(new_n64_), .O(new_n118_));
  nand3  g072(.a(new_n64_), .b(new_n60_), .c(new_n54_), .O(new_n119_));
  nor2   g073(.a(new_n119_), .b(new_n94_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n118_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n117_), .c(new_n48_), .O(z12));
  inv1   g076(.a(x04), .O(new_n123_));
  oai22  g077(.a(new_n89_), .b(new_n123_), .c(x18), .d(new_n68_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n87_), .O(new_n125_));
  nand2  g079(.a(new_n111_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x21), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n93_), .c(new_n54_), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(new_n126_), .c(x22), .O(new_n129_));
  nor3   g083(.a(new_n70_), .b(new_n64_), .c(x18), .O(new_n130_));
  ...
  nor2   g089(.a(new_n75_), .b(new_n87_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(x18), .c(x22), .O(new_n137_));
  nand2  g091(.a(new_n128_), .b(x24), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n64_), .c(new_n60_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n104_), .c(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n135_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n89_), .b(new_n144_), .c(x18), .d(new_n78_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n87_), .O(new_n146_));
  nand3  g100(.a(new_n75_), .b(new_n70_), .c(new_n60_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n104_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x20), .b(x19), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n127_), .c(new_n149_), .d(new_n102_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n148_), .c(x22), .O(new_n152_));
  nor3   g106(.a(new_n80_), .b(new_n64_), .c(x18), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n152_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n146_), .O(z15));
  inv1   g109(.a(x07), .O(new_n156_));
  oai22  g110(.a(new_n89_), .b(new_n156_), .c(x18), .d(new_n83_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n87_), .O(new_n158_));
  nand2  g112(.a(new_n151_), .b(x26), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n139_), .c(new_n110_), .d(new_n93_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n159_), .c(x22), .O(new_n162_));
  nand2  g116(.a(x26), .b(x22), .O(new_n163_));
  nor2   g117(.a(new_n163_), .b(x18), .O(new_n164_));
  ...
  nor2   g121(.a(new_n103_), .b(x17), .O(new_n168_));
  nor2   g122(.a(x23), .b(x22), .O(new_n169_));
  nor3   g123(.a(x26), .b(x25), .c(x24), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n110_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n167_), .c(new_n87_), .O(z17));
endmodule
