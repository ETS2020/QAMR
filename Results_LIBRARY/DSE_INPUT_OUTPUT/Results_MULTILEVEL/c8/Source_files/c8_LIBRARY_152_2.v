...
module FAU ( 
  ...
  oai21  g042(.a(new_n82_), .b(new_n80_), .c(x01), .O(new_n89_));
  ...
  nand3  g048(.a(new_n82_), .b(new_n80_), .c(x09), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z10));
  nand2  g050(.a(x18), .b(x02), .O(new_n97_));
  nand3  g051(.a(new_n82_), .b(x10), .c(new_n48_), .O(new_n98_));
  ...
  nand3  g092(.a(new_n82_), .b(x14), .c(new_n48_), .O(new_n139_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n102_), .d(new_n91_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n102_), .d(new_n91_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n78_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n129_), .O(new_n159_));
