...
module FAU ( 
  ...
  nand3  g09(.a(new_n47_), .b(new_n55_), .c(new_n48_), .O(new_n56_));
  ...
  oai21  g15(.a(new_n61_), .b(x18), .c(new_n47_), .O(new_n62_));
  ...
  aoi22  g33(.a(new_n74_), .b(x01), .c(new_n48_), .d(x09), .O(new_n80_));
  nor2   g34(.a(x19), .b(x17), .O(new_n81_));
  inv1   g35(.a(x17), .O(new_n82_));
  nand3  g36(.a(new_n52_), .b(new_n49_), .c(new_n82_), .O(new_n83_));
  oai21  g37(.a(new_n81_), .b(new_n52_), .c(new_n83_), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(new_n76_), .c(x16), .O(new_n85_));
  oai21  g39(.a(new_n80_), .b(x16), .c(new_n85_), .O(z10));
  aoi22  g40(.a(new_n74_), .b(x02), .c(new_n48_), .d(x10), .O(new_n87_));
  nor3   g41(.a(x20), .b(x19), .c(x17), .O(new_n88_));
  nor2   g42(.a(x21), .b(x20), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n81_), .O(new_n90_));
  oai21  g44(.a(new_n88_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n76_), .c(x16), .O(new_n92_));
  oai21  g46(.a(new_n87_), .b(x16), .c(new_n92_), .O(z11));
  ...
  aoi21  g52(.a(new_n47_), .b(x18), .c(x22), .O(new_n99_));
  nand4  g53(.a(new_n99_), .b(new_n55_), .c(new_n52_), .d(new_n49_), .O(new_n100_));
  nand2  g54(.a(new_n90_), .b(x22), .O(new_n101_));
  oai21  g55(.a(new_n100_), .b(x17), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x16), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n98_), .c(new_n76_), .O(z12));
  aoi22  g58(.a(new_n74_), .b(x04), .c(new_n48_), .d(x12), .O(new_n105_));
  nand4  g59(.a(new_n81_), .b(new_n58_), .c(new_n55_), .d(new_n52_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x23), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n88_), .O(new_n109_));
  ...
  nand2  g69(.a(new_n115_), .b(new_n94_), .O(new_n116_));
  aoi21  g70(.a(new_n108_), .b(new_n88_), .c(new_n64_), .O(new_n117_));
  nand4  g71(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n83_), .O(new_n119_));
  ...
  nand2  g78(.a(new_n124_), .b(new_n94_), .O(new_n125_));
  nor2   g79(.a(x23), .b(x22), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n126_), .c(new_n89_), .d(new_n81_), .O(new_n128_));
  oai21  g82(.a(new_n119_), .b(new_n67_), .c(new_n128_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n125_), .c(new_n76_), .O(z15));
  nand2  g85(.a(new_n48_), .b(x15), .O(new_n132_));
  nand2  g86(.a(new_n74_), .b(x07), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n94_), .O(new_n135_));
  nand2  g89(.a(new_n128_), .b(x26), .O(new_n136_));
  nand4  g90(.a(new_n126_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n137_));
  oai21  g91(.a(new_n137_), .b(new_n90_), .c(new_n136_), .O(new_n138_));
  nand3  g92(.a(new_n138_), .b(new_n76_), .c(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n135_), .O(z16));
  nand3  g94(.a(new_n89_), .b(x19), .c(new_n82_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n137_), .c(new_n47_), .d(new_n82_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(new_n76_), .O(z17));
endmodule
