...
module FAU ( 
  ...
  nand2  g028(.a(new_n64_), .b(new_n73_), .O(new_n75_));
  ...
  nand2  g033(.a(new_n64_), .b(new_n79_), .O(new_n80_));
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n49_), .O(z07));
  nor2   g035(.a(new_n49_), .b(new_n64_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  inv1   g037(.a(x00), .O(new_n84_));
  nand2  g038(.a(new_n73_), .b(x18), .O(new_n85_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n93_), .c(new_n48_), .O(z10));
  inv1   g056(.a(x02), .O(new_n103_));
  oai22  g057(.a(new_n85_), .b(new_n103_), .c(x18), .d(new_n55_), .O(new_n104_));
  ...
  aoi21  g069(.a(x25), .b(x18), .c(x22), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n106_), .c(new_n94_), .d(new_n115_), .O(new_n117_));
  nand2  g071(.a(new_n108_), .b(x22), .O(new_n118_));
  ...
  oai22  g076(.a(new_n85_), .b(new_n122_), .c(x18), .d(new_n61_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n83_), .O(new_n124_));
  nor2   g078(.a(x22), .b(x21), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n95_), .c(new_n94_), .O(new_n126_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n100_), .c(new_n69_), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n125_), .c(new_n98_), .d(new_n97_), .O(new_n138_));
  ...
  nand3  g099(.a(new_n145_), .b(new_n73_), .c(new_n69_), .O(new_n146_));
  oai22  g100(.a(new_n146_), .b(new_n108_), .c(new_n139_), .d(new_n73_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n144_), .c(new_n48_), .O(z15));
  ...
  nand2  g106(.a(new_n138_), .b(x26), .O(new_n153_));
  nor2   g107(.a(x26), .b(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n145_), .c(new_n107_), .d(new_n95_), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(new_n153_), .c(x25), .O(new_n156_));
  nor3   g110(.a(new_n79_), .b(new_n73_), .c(x18), .O(new_n157_));
  ...
  nand4  g114(.a(new_n145_), .b(new_n79_), .c(new_n73_), .d(new_n69_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n64_), .d(new_n97_), .O(new_n162_));
