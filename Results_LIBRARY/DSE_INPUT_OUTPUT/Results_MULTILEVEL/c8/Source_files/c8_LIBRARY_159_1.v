...
module FAU ( 
  ...
  nand2  g032(.a(x18), .b(x07), .O(new_n79_));
  oai22  g033(.a(new_n79_), .b(new_n78_), .c(x18), .d(new_n47_), .O(new_n80_));
  ...
  oai22  g040(.a(new_n79_), .b(new_n86_), .c(x18), .d(new_n52_), .O(new_n87_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n99_), .c(new_n82_), .O(z11));
  inv1   g060(.a(x03), .O(new_n107_));
  oai22  g061(.a(new_n79_), .b(new_n107_), .c(x18), .d(new_n58_), .O(new_n108_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n82_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n109_), .O(z12));
  inv1   g069(.a(x04), .O(new_n116_));
  oai22  g070(.a(new_n79_), .b(new_n116_), .c(x18), .d(new_n64_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n77_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x23), .O(new_n119_));
  nor2   g073(.a(x23), .b(x22), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n101_), .c(new_n100_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n82_), .c(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n118_), .O(z13));
  inv1   g078(.a(x05), .O(new_n125_));
  oai22  g079(.a(new_n79_), .b(new_n125_), .c(x18), .d(new_n67_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n77_), .O(new_n127_));
  inv1   g081(.a(x23), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n60_), .c(new_n100_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n93_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n91_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n82_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n127_), .O(z14));
  inv1   g090(.a(x06), .O(new_n137_));
  oai22  g091(.a(new_n79_), .b(new_n137_), .c(x18), .d(new_n70_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n77_), .O(new_n139_));
  nand2  g093(.a(new_n133_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n120_), .c(new_n102_), .d(new_n90_), .O(new_n142_));
  ...
  oai21  g099(.a(x18), .b(new_n73_), .c(new_n79_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n77_), .O(new_n147_));
  nand2  g101(.a(new_n142_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n120_), .c(new_n102_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n82_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z16));
  inv1   g107(.a(x24), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n120_), .c(new_n154_), .O(new_n156_));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n91_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n61_), .d(new_n91_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n82_), .O(z17));
endmodule
