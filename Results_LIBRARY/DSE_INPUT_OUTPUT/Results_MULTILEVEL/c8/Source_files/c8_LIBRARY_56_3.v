...
module FAU ( 
  ...
  nand2  g051(.a(x18), .b(new_n76_), .O(new_n98_));
  ...
  oai21  g056(.a(new_n90_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  ...
  oai22  g069(.a(new_n98_), .b(new_n115_), .c(x18), .d(new_n65_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n92_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x22), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n90_), .c(new_n57_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n47_), .c(x16), .O(new_n122_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n119_), .c(new_n101_), .d(new_n88_), .O(new_n139_));
  ...
  nand2  g097(.a(new_n79_), .b(x14), .O(new_n144_));
  oai21  g098(.a(new_n98_), .b(new_n143_), .c(new_n144_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n110_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n47_), .c(x16), .O(new_n152_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n110_), .d(new_n90_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n47_), .O(z16));
  nand4  g116(.a(new_n148_), .b(new_n84_), .c(new_n77_), .d(new_n136_), .O(new_n163_));
  nand3  g117(.a(new_n110_), .b(x19), .c(new_n88_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n88_), .O(new_n165_));
