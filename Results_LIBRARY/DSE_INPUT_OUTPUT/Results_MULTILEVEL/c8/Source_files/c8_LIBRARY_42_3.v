...
module FAU ( 
  ...
  nor2   g044(.a(x18), .b(x16), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(x08), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n90_), .c(new_n85_), .O(z09));
  ...
  oai21  g054(.a(new_n89_), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n98_), .c(x16), .O(new_n102_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n98_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n106_), .O(z11));
  oai21  g066(.a(x16), .b(x03), .c(x18), .O(new_n113_));
  aoi21  g067(.a(new_n108_), .b(new_n89_), .c(new_n65_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n89_), .c(new_n54_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n91_), .b(x11), .O(new_n119_));
  ...
  nand2  g077(.a(new_n123_), .b(new_n107_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x16), .O(new_n126_));
  nand2  g080(.a(new_n91_), .b(x12), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n121_), .O(z13));
  oai21  g082(.a(x16), .b(x05), .c(x18), .O(new_n129_));
  inv1   g083(.a(x24), .O(new_n130_));
  aoi21  g084(.a(new_n123_), .b(new_n107_), .c(new_n130_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n115_), .c(new_n99_), .d(new_n86_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n91_), .b(x13), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n135_), .c(new_n129_), .O(z14));
  oai21  g091(.a(x16), .b(x06), .c(x18), .O(new_n138_));
  nand2  g092(.a(new_n133_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n108_), .d(new_n89_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n91_), .b(x14), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n144_), .c(new_n138_), .O(z15));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n108_), .d(new_n89_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n98_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n140_), .c(new_n130_), .O(new_n157_));
  nand3  g111(.a(new_n108_), .b(x19), .c(new_n86_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n86_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n98_), .c(x16), .O(new_n160_));
