...
module FAU ( 
  ...
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n102_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g076(.a(new_n95_), .b(x12), .O(new_n123_));
  ...
  nand3  g082(.a(new_n90_), .b(new_n51_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n101_), .c(x16), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n103_), .d(new_n91_), .O(new_n141_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n119_), .c(new_n103_), .d(new_n91_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n95_), .b(x15), .O(new_n152_));
  ...
  aoi21  g116(.a(new_n162_), .b(new_n101_), .c(new_n86_), .O(z17));
endmodule
