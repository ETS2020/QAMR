...
module FAU ( 
  ...
  oai22  g063(.a(new_n109_), .b(new_n108_), .c(x18), .d(new_n63_), .O(new_n110_));
  ...
  oai21  g079(.a(x18), .b(new_n73_), .c(new_n109_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n105_), .c(new_n61_), .O(new_n132_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n128_), .c(new_n105_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n53_), .c(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n138_), .O(z14));
  nand3  g098(.a(x18), .b(x06), .c(x04), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n131_), .c(new_n112_), .d(new_n94_), .O(new_n150_));
  ...
  nand4  g111(.a(new_n131_), .b(new_n88_), .c(new_n83_), .d(new_n78_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n113_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n53_), .c(x16), .O(new_n160_));
