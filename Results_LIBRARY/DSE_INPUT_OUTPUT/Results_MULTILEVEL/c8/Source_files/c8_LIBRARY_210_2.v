...
module FAU ( 
  ...
  nand4  g108(.a(new_n154_), .b(new_n136_), .c(new_n115_), .d(new_n94_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n53_), .O(z15));
  nand2  g112(.a(x18), .b(x07), .O(new_n159_));
  oai21  g113(.a(x18), .b(new_n88_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n96_), .O(new_n161_));
  nand2  g115(.a(new_n155_), .b(x26), .O(new_n162_));
  nand4  g116(.a(new_n136_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(new_n116_), .c(new_n162_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n161_), .c(new_n53_), .O(z16));
  nand3  g120(.a(new_n115_), .b(x19), .c(new_n92_), .O(new_n167_));
