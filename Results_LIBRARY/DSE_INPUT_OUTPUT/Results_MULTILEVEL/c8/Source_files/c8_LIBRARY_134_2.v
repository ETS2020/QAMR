...
module FAU ( 
  ...
  nor2   g053(.a(new_n85_), .b(x16), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(x01), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n99_), .c(new_n94_), .O(z10));
  oai21  g056(.a(x16), .b(x10), .c(new_n85_), .O(new_n103_));
  nor2   g057(.a(x21), .b(x20), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n96_), .O(new_n105_));
  oai21  g059(.a(new_n98_), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(x16), .O(new_n107_));
  nand2  g061(.a(new_n100_), .b(x02), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n107_), .c(new_n103_), .O(z11));
  oai21  g063(.a(x16), .b(x11), .c(new_n85_), .O(new_n110_));
  aoi21  g064(.a(new_n104_), .b(new_n96_), .c(new_n63_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n96_), .c(new_n95_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n100_), .b(x03), .O(new_n116_));
  ...
  nand2  g077(.a(new_n100_), .b(x04), .O(new_n124_));
  ...
  nand3  g082(.a(new_n95_), .b(new_n88_), .c(new_n87_), .O(new_n129_));
  nand3  g083(.a(new_n68_), .b(new_n63_), .c(new_n57_), .O(new_n130_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n120_), .c(new_n104_), .d(new_n96_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n120_), .c(new_n104_), .d(new_n96_), .O(new_n152_));
  ...
  nand2  g109(.a(new_n68_), .b(new_n63_), .O(new_n156_));
  inv1   g110(.a(x26), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n78_), .c(new_n73_), .O(new_n158_));
  ...
  nor2   g115(.a(new_n58_), .b(new_n87_), .O(new_n162_));
