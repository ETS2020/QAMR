...
module FAU ( 
  ...
  nor2   g052(.a(x21), .b(x18), .O(new_n99_));
  ...
  nand3  g059(.a(new_n101_), .b(x21), .c(x18), .O(new_n106_));
  ...
  inv1   g065(.a(new_n99_), .O(new_n112_));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  oai21  g067(.a(new_n112_), .b(new_n64_), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g072(.a(new_n116_), .b(new_n66_), .c(new_n118_), .O(new_n119_));
  nor2   g073(.a(new_n66_), .b(new_n61_), .O(new_n120_));
  aoi22  g074(.a(new_n120_), .b(x18), .c(new_n119_), .d(new_n61_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n94_), .c(new_n115_), .O(z12));
  ...
  oai21  g079(.a(new_n71_), .b(new_n94_), .c(x18), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x21), .O(new_n127_));
  aoi21  g081(.a(new_n117_), .b(new_n92_), .c(new_n71_), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n61_), .O(new_n130_));
  nor2   g084(.a(new_n130_), .b(new_n101_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n127_), .c(new_n125_), .O(z13));
  ...
  oai21  g090(.a(new_n74_), .b(new_n94_), .c(x18), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x21), .O(new_n138_));
  nand3  g092(.a(new_n129_), .b(new_n92_), .c(new_n56_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x24), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n116_), .c(new_n66_), .d(new_n61_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n136_), .O(z14));
  nand2  g099(.a(x18), .b(x06), .O(new_n146_));
  oai21  g100(.a(new_n112_), .b(new_n79_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n94_), .O(new_n148_));
  nand3  g102(.a(new_n74_), .b(new_n71_), .c(new_n66_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n101_), .c(x25), .O(new_n150_));
  nor2   g104(.a(x20), .b(x19), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n129_), .c(new_n151_), .d(new_n90_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n150_), .c(x21), .O(new_n154_));
  nand3  g108(.a(x25), .b(x21), .c(x18), .O(new_n155_));
  ...
  oai21  g113(.a(new_n112_), .b(new_n84_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n94_), .O(new_n161_));
  nand2  g115(.a(new_n153_), .b(x26), .O(new_n162_));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n141_), .c(new_n117_), .d(new_n92_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(x21), .O(new_n165_));
  nand3  g119(.a(x26), .b(x21), .c(x18), .O(new_n166_));
  ...
  nor2   g124(.a(new_n52_), .b(x17), .O(new_n171_));
  nor3   g125(.a(x26), .b(x25), .c(x24), .O(new_n172_));
  nand4  g126(.a(new_n172_), .b(new_n171_), .c(new_n129_), .d(new_n107_), .O(new_n173_));
  aoi21  g127(.a(new_n173_), .b(new_n170_), .c(new_n94_), .O(z17));
endmodule
