...
module FAU ( 
  ...
  nand4  g48(.a(new_n57_), .b(new_n88_), .c(new_n80_), .d(new_n79_), .O(new_n95_));
  ...
  oai22  g53(.a(new_n99_), .b(new_n55_), .c(new_n97_), .d(new_n84_), .O(z11));
  ...
  oai22  g62(.a(new_n108_), .b(new_n84_), .c(new_n99_), .d(new_n64_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n84_), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n90_), .c(new_n69_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n103_), .c(new_n93_), .d(new_n79_), .O(new_n113_));
  ...
  aoi22  g75(.a(new_n121_), .b(new_n96_), .c(new_n113_), .d(x25), .O(new_n122_));
  nand2  g76(.a(new_n98_), .b(x14), .O(new_n123_));
