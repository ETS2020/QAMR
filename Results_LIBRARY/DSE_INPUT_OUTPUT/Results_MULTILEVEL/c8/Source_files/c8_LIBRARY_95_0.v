...
module FAU ( 
  ...
  nand2  g034(.a(new_n74_), .b(x15), .O(new_n81_));
  oai21  g035(.a(new_n81_), .b(new_n48_), .c(new_n80_), .O(new_n82_));
  ...
  oai21  g041(.a(new_n81_), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  ...
  nand2  g075(.a(new_n121_), .b(new_n102_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n77_), .c(x16), .O(new_n124_));
  ...
  aoi21  g083(.a(new_n121_), .b(new_n102_), .c(new_n129_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n112_), .c(new_n93_), .d(new_n92_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n128_), .c(new_n77_), .O(z14));
  nand2  g089(.a(x18), .b(x06), .O(new_n136_));
  oai21  g090(.a(new_n81_), .b(new_n71_), .c(new_n136_), .O(new_n137_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n103_), .d(new_n91_), .O(new_n142_));
  ...
  oai21  g099(.a(new_n74_), .b(x07), .c(new_n79_), .O(new_n146_));
  nand2  g100(.a(new_n142_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n103_), .d(new_n91_), .O(new_n149_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n140_), .c(new_n129_), .O(new_n154_));
  nand3  g108(.a(new_n103_), .b(x19), .c(new_n92_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n51_), .d(new_n92_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n77_), .c(x16), .O(new_n157_));
