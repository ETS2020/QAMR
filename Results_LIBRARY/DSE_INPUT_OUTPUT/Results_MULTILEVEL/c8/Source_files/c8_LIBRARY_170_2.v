...
module FAU ( 
  ...
  nand3  g062(.a(new_n108_), .b(new_n84_), .c(new_n90_), .O(new_n109_));
  ...
  nand3  g077(.a(new_n90_), .b(new_n82_), .c(new_n81_), .O(new_n124_));
  inv1   g078(.a(x22), .O(new_n125_));
  inv1   g079(.a(x23), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n57_), .O(new_n127_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n72_), .c(new_n153_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g110(.a(new_n99_), .b(x19), .c(new_n81_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n58_), .b(new_n81_), .O(new_n159_));
