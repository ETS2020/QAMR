...
module FAU ( 
  ...
  nand2  g031(.a(new_n60_), .b(new_n77_), .O(new_n78_));
  ...
  nand2  g046(.a(x23), .b(new_n63_), .O(new_n93_));
  ...
  nor2   g050(.a(new_n85_), .b(new_n96_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  or2    g052(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  ...
  oai21  g056(.a(x18), .b(new_n54_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n80_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  oai21  g065(.a(x18), .b(new_n57_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  aoi21  g067(.a(new_n106_), .b(new_n85_), .c(new_n59_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n85_), .c(new_n96_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n80_), .O(z12));
  inv1   g073(.a(x12), .O(new_n120_));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  oai21  g075(.a(new_n93_), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n87_), .O(new_n123_));
  nor2   g077(.a(new_n117_), .b(new_n64_), .O(new_n124_));
  nand3  g078(.a(new_n83_), .b(x18), .c(new_n82_), .O(new_n125_));
  nor2   g079(.a(x23), .b(x22), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n106_), .O(new_n127_));
  nor2   g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  ...
  oai21  g085(.a(new_n93_), .b(new_n67_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n87_), .O(new_n133_));
  nand2  g087(.a(new_n116_), .b(x24), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n115_), .c(new_n98_), .O(new_n136_));
  aoi21  g090(.a(new_n136_), .b(new_n134_), .c(new_n63_), .O(new_n137_));
  nor2   g091(.a(new_n69_), .b(new_n64_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n137_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n133_), .O(z14));
  ...
  oai21  g098(.a(new_n144_), .b(new_n87_), .c(x23), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n63_), .O(new_n146_));
  nand2  g100(.a(new_n136_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n106_), .d(new_n85_), .O(new_n149_));
  ...
  oai21  g109(.a(new_n77_), .b(new_n87_), .c(x23), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n63_), .O(new_n157_));
  nand2  g111(.a(new_n149_), .b(x26), .O(new_n158_));
  nand4  g112(.a(new_n126_), .b(new_n77_), .c(new_n144_), .d(new_n69_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n107_), .c(new_n158_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n157_), .c(new_n155_), .O(z16));
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n82_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n60_), .d(new_n82_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n80_), .O(z17));
endmodule
