...
module FAU ( 
  ...
  nand4  g50(.a(new_n96_), .b(new_n54_), .c(new_n82_), .d(new_n81_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x21), .c(new_n98_), .O(new_n99_));
  oai22  g53(.a(new_n99_), .b(new_n86_), .c(new_n87_), .d(new_n58_), .O(z11));
  ...
  oai21  g64(.a(x18), .b(x13), .c(new_n86_), .O(new_n111_));
  inv1   g65(.a(x24), .O(new_n112_));
  aoi21  g66(.a(new_n108_), .b(new_n91_), .c(new_n112_), .O(new_n113_));
  ...
  nand4  g73(.a(new_n74_), .b(new_n112_), .c(new_n119_), .d(new_n63_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n98_), .c(new_n115_), .d(x25), .O(new_n122_));
  nand3  g76(.a(new_n48_), .b(new_n86_), .c(x14), .O(new_n123_));
  oai21  g77(.a(new_n122_), .b(new_n86_), .c(new_n123_), .O(z15));
  oai21  g78(.a(x18), .b(x15), .c(new_n86_), .O(new_n125_));
  ...
  inv1   g89(.a(new_n49_), .O(new_n136_));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n112_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n81_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n55_), .d(new_n81_), .O(new_n140_));
