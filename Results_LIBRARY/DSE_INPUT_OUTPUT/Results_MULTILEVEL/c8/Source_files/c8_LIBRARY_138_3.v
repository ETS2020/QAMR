...
module FAU ( 
  ...
  nor3   g052(.a(new_n98_), .b(new_n83_), .c(x18), .O(new_n99_));
  ...
  oai22  g057(.a(new_n84_), .b(new_n103_), .c(x18), .d(new_n55_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n81_), .O(new_n105_));
  oai21  g059(.a(x19), .b(x17), .c(x21), .O(new_n106_));
  nand3  g060(.a(new_n57_), .b(new_n90_), .c(new_n89_), .O(new_n107_));
  aoi21  g061(.a(new_n107_), .b(new_n106_), .c(x20), .O(new_n108_));
  nor3   g062(.a(new_n57_), .b(new_n83_), .c(x18), .O(new_n109_));
  ...
  nand3  g070(.a(new_n98_), .b(new_n115_), .c(new_n57_), .O(new_n117_));
  oai21  g071(.a(new_n116_), .b(new_n115_), .c(new_n117_), .O(new_n118_));
  nor3   g072(.a(new_n115_), .b(new_n83_), .c(x18), .O(new_n119_));
  aoi21  g073(.a(new_n118_), .b(new_n83_), .c(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n81_), .c(new_n114_), .O(z12));
  inv1   g075(.a(x04), .O(new_n122_));
  oai22  g076(.a(new_n84_), .b(new_n122_), .c(x18), .d(new_n64_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n81_), .O(new_n124_));
  nand2  g078(.a(new_n117_), .b(x23), .O(new_n125_));
  nor2   g079(.a(x23), .b(x22), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n98_), .c(new_n57_), .O(new_n127_));
  aoi21  g081(.a(new_n127_), .b(new_n125_), .c(x20), .O(new_n128_));
  nor3   g082(.a(new_n66_), .b(new_n83_), .c(x18), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n128_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n124_), .O(z13));
  ...
  inv1   g088(.a(x18), .O(new_n135_));
  oai21  g089(.a(new_n71_), .b(new_n81_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x20), .O(new_n137_));
  nand2  g091(.a(new_n127_), .b(x24), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n100_), .c(new_n115_), .d(new_n57_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n134_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n84_), .b(new_n144_), .c(x18), .d(new_n74_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n81_), .O(new_n146_));
  nand3  g100(.a(new_n71_), .b(new_n66_), .c(new_n115_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n107_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n126_), .c(new_n116_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n148_), .c(x20), .O(new_n151_));
  nand2  g105(.a(x25), .b(x20), .O(new_n152_));
  nor2   g106(.a(new_n152_), .b(x18), .O(new_n153_));
  ...
  nand2  g111(.a(new_n157_), .b(new_n81_), .O(new_n158_));
  nand2  g112(.a(x26), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n135_), .O(new_n160_));
  ...
  nand4  g118(.a(new_n164_), .b(new_n163_), .c(new_n126_), .d(new_n98_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n161_), .c(new_n158_), .O(z16));
  nand2  g122(.a(new_n164_), .b(new_n126_), .O(new_n169_));
  nand3  g123(.a(new_n163_), .b(x19), .c(new_n89_), .O(new_n170_));
  oai22  g124(.a(new_n170_), .b(new_n169_), .c(new_n58_), .d(new_n89_), .O(new_n171_));
