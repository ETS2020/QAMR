...
module FAU ( 
  ...
  nand2  g061(.a(new_n100_), .b(x10), .O(new_n108_));
  ...
  nand2  g069(.a(new_n100_), .b(x11), .O(new_n116_));
  ...
  nand2  g077(.a(new_n100_), .b(x12), .O(new_n124_));
  ...
  nand3  g083(.a(new_n95_), .b(new_n88_), .c(new_n87_), .O(new_n130_));
  nand3  g084(.a(new_n68_), .b(new_n63_), .c(new_n57_), .O(new_n131_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n104_), .d(new_n96_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n120_), .c(new_n104_), .d(new_n96_), .O(new_n153_));
  ...
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n87_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n58_), .b(new_n87_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n129_), .c(new_n85_), .O(z17));
endmodule
