...
module FAU ( 
  ...
  nand4  g54(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n86_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n93_), .c(new_n91_), .d(new_n60_), .O(z11));
  oai21  g58(.a(x18), .b(x11), .c(new_n93_), .O(new_n105_));
  nand2  g59(.a(new_n101_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n88_), .c(new_n57_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n93_), .c(new_n105_), .O(z12));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n96_), .c(new_n108_), .d(x23), .O(new_n112_));
  oai22  g66(.a(new_n112_), .b(new_n93_), .c(new_n91_), .d(new_n68_), .O(z13));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n96_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n107_), .c(new_n99_), .d(new_n86_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n90_), .b(x13), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n119_), .O(z14));
  inv1   g75(.a(x22), .O(new_n122_));
  nand4  g76(.a(new_n78_), .b(new_n114_), .c(new_n70_), .d(new_n122_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n90_), .b(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n93_), .c(new_n126_), .O(z15));
