...
module FAU ( 
  ...
  nand3  g42(.a(new_n48_), .b(new_n88_), .c(x08), .O(new_n89_));
  ...
  nand4  g52(.a(new_n60_), .b(new_n54_), .c(new_n84_), .d(new_n83_), .O(new_n99_));
  ...
  nand3  g59(.a(new_n105_), .b(new_n86_), .c(new_n54_), .O(new_n106_));
  ...
  nand4  g75(.a(new_n76_), .b(new_n114_), .c(new_n121_), .d(new_n65_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n124_));
  ...
  nor2   g91(.a(new_n84_), .b(x17), .O(new_n138_));
