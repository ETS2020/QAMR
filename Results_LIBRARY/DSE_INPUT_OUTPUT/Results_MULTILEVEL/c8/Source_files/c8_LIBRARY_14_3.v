...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(new_n52_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n94_), .O(z09));
  inv1   g054(.a(x01), .O(new_n101_));
  oai22  g055(.a(new_n92_), .b(new_n101_), .c(x18), .d(new_n55_), .O(new_n102_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n52_), .O(z11));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n52_), .O(z12));
  nor3   g081(.a(x23), .b(x22), .c(x21), .O(new_n128_));
  aoi22  g082(.a(new_n128_), .b(new_n113_), .c(new_n124_), .d(x23), .O(new_n129_));
  nor2   g083(.a(x18), .b(x16), .O(new_n130_));
  aoi21  g084(.a(new_n130_), .b(x12), .c(new_n53_), .O(new_n131_));
  oai21  g085(.a(new_n129_), .b(new_n89_), .c(new_n131_), .O(z13));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n113_), .c(new_n77_), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n123_), .c(new_n105_), .d(new_n104_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n135_), .c(new_n52_), .O(z14));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n114_), .d(new_n96_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n114_), .d(new_n96_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n154_), .c(new_n52_), .O(z16));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n146_), .c(new_n77_), .O(new_n162_));
  nand3  g116(.a(new_n114_), .b(x19), .c(new_n104_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n104_), .O(new_n164_));
