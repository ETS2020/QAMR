...
module FAU ( 
  ...
  oai21  g050(.a(x16), .b(x09), .c(new_n87_), .O(new_n97_));
  nor2   g051(.a(new_n92_), .b(new_n54_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand2  g054(.a(new_n94_), .b(x01), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n100_), .c(new_n97_), .O(z10));
  ...
  oai21  g059(.a(new_n99_), .b(new_n60_), .c(new_n105_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(x16), .O(new_n107_));
  nand2  g061(.a(new_n94_), .b(x02), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n107_), .c(new_n103_), .O(z11));
  ...
  nand3  g068(.a(new_n114_), .b(new_n92_), .c(new_n54_), .O(new_n115_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n89_), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n123_), .c(new_n104_), .d(new_n92_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n94_), .b(x06), .O(new_n147_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n123_), .c(new_n104_), .d(new_n92_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n94_), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  nand2  g110(.a(new_n68_), .b(new_n132_), .O(new_n157_));
  nand3  g111(.a(new_n83_), .b(new_n78_), .c(new_n73_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n104_), .b(x19), .c(new_n89_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n55_), .b(new_n89_), .O(new_n162_));
