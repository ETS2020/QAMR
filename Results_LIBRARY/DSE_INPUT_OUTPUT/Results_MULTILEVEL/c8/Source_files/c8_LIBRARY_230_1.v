...
module FAU ( 
  ...
  nand3  g065(.a(new_n97_), .b(new_n48_), .c(new_n83_), .O(new_n112_));
  ...
  oai22  g069(.a(new_n90_), .b(new_n115_), .c(x18), .d(new_n61_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n88_), .O(new_n117_));
  nand2  g071(.a(new_n108_), .b(new_n84_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n101_), .c(new_n54_), .O(new_n121_));
  aoi21  g075(.a(new_n121_), .b(new_n119_), .c(x18), .O(new_n122_));
  ...
  oai22  g080(.a(new_n90_), .b(new_n126_), .c(x18), .d(new_n64_), .O(new_n127_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n97_), .c(new_n131_), .d(new_n83_), .O(new_n133_));
  aoi21  g087(.a(new_n133_), .b(new_n130_), .c(x18), .O(new_n134_));
  nor2   g088(.a(new_n66_), .b(new_n83_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n134_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n128_), .O(z13));
  inv1   g091(.a(x05), .O(new_n138_));
  oai22  g092(.a(new_n90_), .b(new_n138_), .c(x18), .d(new_n69_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n97_), .d(new_n83_), .O(new_n144_));
  aoi21  g098(.a(new_n144_), .b(new_n142_), .c(x18), .O(new_n145_));
  nor2   g099(.a(new_n71_), .b(new_n83_), .O(new_n146_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n109_), .c(new_n48_), .O(new_n154_));
  ...
  oai22  g114(.a(new_n90_), .b(new_n160_), .c(x18), .d(new_n79_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n88_), .O(new_n162_));
  nand4  g116(.a(new_n152_), .b(new_n132_), .c(new_n108_), .d(new_n84_), .O(new_n163_));
  ...
  oai22  g127(.a(new_n173_), .b(new_n172_), .c(new_n55_), .d(new_n83_), .O(new_n174_));
