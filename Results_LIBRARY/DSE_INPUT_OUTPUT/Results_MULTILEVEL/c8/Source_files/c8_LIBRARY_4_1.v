...
module FAU ( 
  ...
  aoi22  g64(.a(new_n110_), .b(new_n94_), .c(new_n107_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n90_), .c(new_n88_), .d(new_n66_), .O(z13));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n94_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n106_), .c(new_n97_), .d(new_n83_), .O(new_n116_));
  ...
  nand2  g78(.a(new_n87_), .b(x14), .O(new_n125_));
  oai21  g79(.a(new_n124_), .b(new_n90_), .c(new_n125_), .O(z15));
