...
module FAU ( 
  ...
  aoi21  g069(.a(x18), .b(new_n52_), .c(x22), .O(new_n116_));
  ...
  oai22  g076(.a(new_n91_), .b(new_n122_), .c(x18), .d(new_n71_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n89_), .O(new_n124_));
  inv1   g078(.a(x17), .O(new_n125_));
  nand3  g079(.a(new_n58_), .b(new_n47_), .c(new_n125_), .O(new_n126_));
  ...
  nand3  g083(.a(new_n73_), .b(new_n66_), .c(new_n63_), .O(new_n130_));
  ...
  nand4  g112(.a(new_n148_), .b(new_n85_), .c(new_n78_), .d(new_n158_), .O(new_n159_));
  ...
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n48_), .d(new_n125_), .O(new_n164_));
