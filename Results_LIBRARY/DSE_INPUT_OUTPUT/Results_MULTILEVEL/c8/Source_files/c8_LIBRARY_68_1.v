...
module FAU ( 
  ...
  nand2  g001(.a(x23), .b(new_n47_), .O(new_n48_));
  ...
  aoi21  g025(.a(x27), .b(x18), .c(new_n71_), .O(new_n72_));
  oai22  g026(.a(new_n72_), .b(x12), .c(x27), .d(x23), .O(z04));
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n49_), .O(z05));
  ...
  nor2   g052(.a(x23), .b(x18), .O(new_n99_));
  aoi22  g053(.a(new_n99_), .b(x09), .c(x18), .d(x01), .O(new_n100_));
  nand3  g054(.a(new_n56_), .b(new_n52_), .c(new_n90_), .O(new_n101_));
  oai21  g055(.a(new_n92_), .b(new_n56_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n48_), .c(x16), .O(new_n103_));
  oai21  g057(.a(new_n100_), .b(x16), .c(new_n103_), .O(z10));
  aoi22  g058(.a(new_n99_), .b(x10), .c(x18), .d(x02), .O(new_n105_));
  inv1   g059(.a(new_n101_), .O(new_n106_));
  nor2   g060(.a(x21), .b(x20), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n92_), .O(new_n108_));
  oai21  g062(.a(new_n106_), .b(new_n61_), .c(new_n108_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n48_), .c(x16), .O(new_n110_));
  oai21  g064(.a(new_n105_), .b(x16), .c(new_n110_), .O(z11));
  aoi22  g065(.a(new_n99_), .b(x11), .c(x18), .d(x03), .O(new_n112_));
  nand2  g066(.a(new_n108_), .b(x22), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n92_), .c(new_n56_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n48_), .c(x16), .O(new_n117_));
  oai21  g071(.a(new_n112_), .b(x16), .c(new_n117_), .O(z12));
  aoi22  g072(.a(new_n99_), .b(x12), .c(x18), .d(x04), .O(new_n119_));
  nand3  g073(.a(new_n115_), .b(x23), .c(x18), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n106_), .c(new_n61_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  oai21  g078(.a(new_n119_), .b(x16), .c(new_n124_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n74_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n94_), .O(new_n128_));
  oai21  g082(.a(new_n76_), .b(new_n94_), .c(x18), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x23), .O(new_n130_));
  nand2  g084(.a(new_n115_), .b(x24), .O(new_n131_));
  nand3  g085(.a(new_n114_), .b(new_n76_), .c(new_n71_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n101_), .c(new_n131_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n130_), .c(new_n128_), .O(z14));
  inv1   g089(.a(new_n99_), .O(new_n136_));
  nand2  g090(.a(x18), .b(x06), .O(new_n137_));
  oai21  g091(.a(new_n136_), .b(new_n79_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n94_), .O(new_n139_));
  nand3  g093(.a(new_n76_), .b(new_n68_), .c(new_n61_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n101_), .c(x25), .O(new_n141_));
  nor2   g095(.a(x20), .b(x19), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n114_), .c(new_n142_), .d(new_n90_), .O(new_n144_));
  aoi21  g098(.a(new_n144_), .b(new_n141_), .c(x23), .O(new_n145_));
  nand3  g099(.a(x25), .b(x23), .c(x18), .O(new_n146_));
  inv1   g100(.a(new_n146_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n145_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n139_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  oai21  g104(.a(new_n136_), .b(new_n84_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n94_), .O(new_n152_));
  nand2  g106(.a(new_n144_), .b(x26), .O(new_n153_));
  nor2   g107(.a(x24), .b(x22), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n154_), .c(new_n107_), .d(new_n92_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n153_), .c(x23), .O(new_n157_));
  ...
  nand3  g115(.a(new_n107_), .b(x19), .c(new_n90_), .O(new_n162_));
  nand3  g116(.a(new_n155_), .b(new_n121_), .c(new_n76_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n53_), .d(new_n90_), .O(new_n164_));
