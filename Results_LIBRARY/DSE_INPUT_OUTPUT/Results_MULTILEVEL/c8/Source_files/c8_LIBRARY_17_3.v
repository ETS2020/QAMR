...
module FAU ( 
  ...
  nor2   g032(.a(new_n50_), .b(new_n62_), .O(z08));
  nand3  g033(.a(x19), .b(new_n48_), .c(x17), .O(new_n80_));
  ...
  nand2  g039(.a(new_n49_), .b(x18), .O(new_n86_));
  ...
  nand2  g059(.a(new_n105_), .b(x21), .O(new_n106_));
  inv1   g060(.a(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n93_), .c(new_n96_), .O(new_n108_));
  aoi21  g062(.a(new_n108_), .b(new_n106_), .c(x19), .O(new_n109_));
  nor3   g063(.a(new_n107_), .b(new_n49_), .c(x18), .O(new_n110_));
  ...
  oai21  g081(.a(new_n127_), .b(new_n84_), .c(new_n48_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x19), .O(new_n129_));
  aoi21  g083(.a(new_n119_), .b(new_n104_), .c(new_n127_), .O(new_n130_));
  inv1   g084(.a(new_n98_), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n107_), .O(new_n133_));
  ...
  oai21  g091(.a(x18), .b(new_n68_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n84_), .O(new_n139_));
  oai21  g093(.a(new_n70_), .b(new_n84_), .c(new_n48_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x19), .O(new_n141_));
  oai21  g095(.a(new_n133_), .b(new_n105_), .c(x24), .O(new_n142_));
  nand4  g096(.a(new_n119_), .b(new_n98_), .c(new_n70_), .d(new_n127_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n86_), .b(new_n147_), .c(x18), .d(new_n73_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n84_), .O(new_n149_));
  nand3  g103(.a(new_n70_), .b(new_n127_), .c(new_n61_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n108_), .c(x25), .O(new_n151_));
  nor2   g105(.a(x21), .b(x20), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n132_), .c(new_n152_), .d(new_n96_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n151_), .c(x19), .O(new_n155_));
  inv1   g109(.a(x25), .O(new_n156_));
  nor3   g110(.a(new_n156_), .b(new_n49_), .c(x18), .O(new_n157_));
  ...
  oai21  g114(.a(x18), .b(new_n76_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n84_), .O(new_n162_));
  inv1   g116(.a(x26), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(new_n84_), .c(new_n48_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x19), .O(new_n165_));
  nand2  g119(.a(new_n154_), .b(x26), .O(new_n166_));
  nand2  g120(.a(new_n152_), .b(new_n82_), .O(new_n167_));
  nand4  g121(.a(new_n132_), .b(new_n163_), .c(new_n156_), .d(new_n70_), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n167_), .c(new_n166_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand3  g124(.a(new_n170_), .b(new_n165_), .c(new_n162_), .O(z16));
  inv1   g125(.a(new_n50_), .O(new_n172_));
  nand3  g126(.a(new_n152_), .b(x19), .c(new_n96_), .O(new_n173_));
  oai22  g127(.a(new_n173_), .b(new_n168_), .c(new_n62_), .d(new_n96_), .O(new_n174_));
  nand2  g128(.a(new_n174_), .b(x16), .O(new_n175_));
  nand2  g129(.a(new_n175_), .b(new_n172_), .O(z17));
endmodule
