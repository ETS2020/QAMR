...
module FAU ( 
  ...
  oai22  g53(.a(new_n99_), .b(new_n58_), .c(new_n97_), .d(new_n84_), .O(z11));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n82_), .c(new_n95_), .d(x22), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n84_), .c(new_n99_), .d(new_n61_), .O(z12));
  oai21  g57(.a(x18), .b(x12), .c(new_n84_), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n82_), .c(new_n54_), .O(new_n106_));
  nor3   g60(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n89_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n84_), .c(new_n104_), .O(z13));
  aoi21  g63(.a(new_n107_), .b(new_n89_), .c(new_n69_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n105_), .c(new_n92_), .d(new_n79_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g68(.a(new_n98_), .b(x13), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n114_), .O(z14));
  oai21  g70(.a(x18), .b(x14), .c(new_n84_), .O(new_n117_));
  inv1   g71(.a(x22), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n69_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n96_), .c(new_n112_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n84_), .c(new_n117_), .O(z15));
  nor2   g78(.a(x21), .b(x20), .O(new_n125_));
  nor2   g79(.a(x23), .b(x22), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n82_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(x26), .O(new_n129_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n126_), .c(new_n125_), .d(new_n82_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g87(.a(new_n98_), .b(x15), .O(new_n134_));
