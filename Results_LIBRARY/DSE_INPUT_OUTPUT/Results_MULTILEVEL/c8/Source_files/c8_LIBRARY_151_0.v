...
module FAU ( 
  ...
  nand3  g020(.a(new_n66_), .b(x27), .c(new_n63_), .O(new_n67_));
  inv1   g021(.a(new_n48_), .O(new_n68_));
  nand2  g022(.a(new_n68_), .b(new_n57_), .O(z08));
  oai21  g023(.a(z08), .b(x23), .c(new_n67_), .O(z04));
  nor2   g024(.a(x27), .b(x24), .O(new_n71_));
  aoi21  g025(.a(x27), .b(new_n64_), .c(new_n71_), .O(new_n72_));
  nand2  g026(.a(new_n71_), .b(x13), .O(new_n73_));
  oai21  g027(.a(new_n72_), .b(new_n65_), .c(new_n73_), .O(z05));
  ...
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n68_), .O(z10));
  nand2  g056(.a(x18), .b(x02), .O(new_n103_));
  nand2  g057(.a(new_n65_), .b(x13), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n54_), .c(new_n103_), .O(new_n105_));
  ...
  oai21  g062(.a(new_n100_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n68_), .c(x16), .O(new_n110_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n88_), .c(new_n98_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n68_), .c(x16), .O(new_n119_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n68_), .O(z13));
  ...
  nand3  g086(.a(new_n98_), .b(new_n86_), .c(new_n85_), .O(new_n133_));
  inv1   g087(.a(x22), .O(new_n134_));
  inv1   g088(.a(x23), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n134_), .c(new_n56_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n116_), .c(new_n138_), .d(new_n85_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n68_), .c(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n132_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  nand3  g098(.a(new_n65_), .b(x14), .c(x13), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n125_), .c(new_n107_), .d(new_n88_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n68_), .c(x16), .O(new_n152_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n125_), .c(new_n107_), .d(new_n88_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n68_), .O(z16));
  inv1   g116(.a(x24), .O(new_n163_));
  nand4  g117(.a(new_n125_), .b(new_n82_), .c(new_n77_), .d(new_n163_), .O(new_n164_));
  nand3  g118(.a(new_n107_), .b(x19), .c(new_n85_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n57_), .d(new_n85_), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n68_), .c(x16), .O(new_n167_));
