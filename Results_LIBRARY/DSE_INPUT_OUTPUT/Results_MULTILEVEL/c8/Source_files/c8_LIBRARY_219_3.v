...
module FAU ( 
  ...
  nand3  g029(.a(new_n52_), .b(new_n73_), .c(new_n75_), .O(new_n76_));
  nand2  g030(.a(new_n76_), .b(new_n74_), .O(z06));
  ...
  nand2  g039(.a(x18), .b(new_n72_), .O(new_n86_));
  ...
  oai22  g046(.a(new_n86_), .b(new_n92_), .c(x18), .d(new_n55_), .O(new_n93_));
  ...
  oai22  g057(.a(new_n86_), .b(new_n103_), .c(x18), .d(new_n58_), .O(new_n104_));
  ...
  oai22  g067(.a(new_n86_), .b(new_n113_), .c(x18), .d(new_n61_), .O(new_n114_));
  ...
  nand2  g077(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  ...
  nand2  g095(.a(new_n75_), .b(x14), .O(new_n142_));
  oai21  g096(.a(new_n86_), .b(new_n141_), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n108_), .d(new_n96_), .O(new_n148_));
  ...
  oai22  g106(.a(new_n86_), .b(new_n152_), .c(x18), .d(new_n78_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n108_), .d(new_n96_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n146_), .b(new_n80_), .c(new_n73_), .d(new_n134_), .O(new_n161_));
  nand3  g115(.a(new_n108_), .b(x19), .c(new_n97_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n97_), .O(new_n163_));
