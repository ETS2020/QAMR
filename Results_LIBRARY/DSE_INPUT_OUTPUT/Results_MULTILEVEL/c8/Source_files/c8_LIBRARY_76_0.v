...
module FAU ( 
  ...
  nand4  g52(.a(new_n98_), .b(new_n56_), .c(new_n50_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n87_), .c(new_n88_), .d(new_n95_), .O(z11));
  inv1   g56(.a(x18), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(x03), .c(new_n87_), .O(new_n104_));
  nand2  g58(.a(new_n99_), .b(x22), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n85_), .c(new_n56_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n87_), .c(new_n104_), .O(z12));
  inv1   g63(.a(x04), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n92_), .c(new_n107_), .d(x23), .O(new_n112_));
  oai22  g66(.a(new_n112_), .b(new_n87_), .c(new_n88_), .d(new_n110_), .O(z13));
  oai21  g67(.a(new_n103_), .b(x05), .c(new_n87_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n92_), .c(new_n115_), .O(new_n116_));
  ...
  oai21  g75(.a(new_n103_), .b(x06), .c(new_n87_), .O(new_n122_));
  ...
  oai21  g81(.a(new_n103_), .b(x07), .c(new_n87_), .O(new_n128_));
