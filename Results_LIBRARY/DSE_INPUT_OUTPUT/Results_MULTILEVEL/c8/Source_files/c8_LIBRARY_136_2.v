...
module FAU ( 
  ...
  oai21  g060(.a(new_n95_), .b(new_n61_), .c(new_n106_), .O(new_n107_));
  ...
  nand3  g064(.a(new_n97_), .b(x11), .c(new_n47_), .O(new_n111_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n87_), .c(new_n55_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n97_), .b(x12), .c(new_n47_), .O(new_n121_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n95_), .c(new_n61_), .O(new_n126_));
  ...
  nand3  g084(.a(new_n97_), .b(x13), .c(new_n47_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n89_), .O(new_n133_));
  nand3  g087(.a(new_n55_), .b(new_n51_), .c(new_n85_), .O(new_n134_));
  inv1   g088(.a(x22), .O(new_n135_));
  nand3  g089(.a(new_n69_), .b(new_n135_), .c(new_n61_), .O(new_n136_));
  ...
  nand3  g098(.a(new_n97_), .b(x14), .c(new_n47_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n125_), .c(new_n105_), .d(new_n87_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n125_), .c(new_n105_), .d(new_n87_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n83_), .O(z16));
