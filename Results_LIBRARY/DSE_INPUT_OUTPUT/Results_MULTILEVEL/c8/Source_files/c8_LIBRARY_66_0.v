...
module FAU ( 
  ...
  oai21  g025(.a(new_n51_), .b(x12), .c(new_n71_), .O(z04));
  ...
  nand2  g043(.a(x23), .b(new_n69_), .O(new_n90_));
  ...
  nand3  g056(.a(new_n56_), .b(new_n50_), .c(new_n102_), .O(new_n103_));
  oai21  g057(.a(new_n94_), .b(new_n56_), .c(new_n103_), .O(new_n104_));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n94_), .c(new_n66_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n94_), .c(new_n56_), .O(new_n121_));
  ...
  oai21  g080(.a(new_n90_), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n88_), .O(new_n128_));
  nor2   g082(.a(new_n122_), .b(new_n70_), .O(new_n129_));
  nand3  g083(.a(new_n50_), .b(x18), .c(new_n102_), .O(new_n130_));
  ...
  oai21  g090(.a(new_n90_), .b(new_n73_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n88_), .O(new_n138_));
  nand2  g092(.a(new_n121_), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n120_), .b(new_n110_), .c(new_n75_), .d(new_n70_), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(new_n139_), .c(new_n69_), .O(new_n141_));
  nor2   g095(.a(new_n75_), .b(new_n70_), .O(new_n142_));
  ...
  oai21  g099(.a(new_n90_), .b(new_n78_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n88_), .O(new_n147_));
  nand3  g101(.a(new_n75_), .b(new_n66_), .c(new_n61_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n103_), .c(x25), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n131_), .c(new_n111_), .d(new_n94_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n149_), .c(new_n69_), .O(new_n152_));
  and2   g106(.a(x25), .b(x23), .O(new_n153_));
  ...
  oai21  g110(.a(new_n90_), .b(new_n81_), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n88_), .O(new_n158_));
  nor2   g112(.a(x20), .b(x19), .O(new_n159_));
  nand4  g113(.a(new_n150_), .b(new_n120_), .c(new_n159_), .d(new_n102_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x26), .O(new_n161_));
  nor3   g115(.a(x26), .b(x25), .c(x24), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n131_), .c(new_n111_), .d(new_n94_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n161_), .c(new_n69_), .O(new_n164_));
  nor2   g118(.a(new_n83_), .b(new_n70_), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n164_), .c(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n158_), .O(z16));
  nand3  g121(.a(new_n86_), .b(x27), .c(x17), .O(new_n168_));
  nand2  g122(.a(new_n111_), .b(x19), .O(new_n169_));
  nor3   g123(.a(new_n169_), .b(new_n69_), .c(x17), .O(new_n170_));
  nand3  g124(.a(new_n170_), .b(new_n162_), .c(new_n131_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n168_), .c(new_n88_), .O(z17));
endmodule
