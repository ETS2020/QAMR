...
module FAU ( 
  ...
  nor2   g007(.a(x18), .b(new_n47_), .O(new_n54_));
  aoi21  g008(.a(x27), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  ...
  aoi21  g014(.a(new_n60_), .b(new_n58_), .c(new_n54_), .O(z02));
  inv1   g015(.a(x11), .O(new_n62_));
  aoi21  g016(.a(x27), .b(new_n62_), .c(new_n54_), .O(new_n63_));
  oai21  g017(.a(x27), .b(x22), .c(new_n63_), .O(z03));
  inv1   g018(.a(x12), .O(new_n65_));
  aoi21  g019(.a(x27), .b(new_n65_), .c(new_n54_), .O(new_n66_));
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n54_), .O(z07));
  nor2   g032(.a(new_n54_), .b(new_n50_), .O(z08));
  inv1   g033(.a(new_n54_), .O(new_n80_));
  xnor2a g034(.a(x19), .b(x17), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n80_), .c(x16), .O(new_n82_));
  inv1   g036(.a(x16), .O(new_n83_));
  nand3  g037(.a(x18), .b(new_n83_), .c(x00), .O(new_n84_));
  nand2  g038(.a(new_n84_), .b(new_n82_), .O(z09));
  nand2  g039(.a(x18), .b(x01), .O(new_n86_));
  inv1   g040(.a(x18), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(x09), .c(new_n47_), .O(new_n88_));
  ...
  nand3  g062(.a(new_n87_), .b(x11), .c(new_n47_), .O(new_n109_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n80_), .O(z13));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n103_), .d(new_n92_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n103_), .d(new_n92_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n93_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n50_), .d(new_n93_), .O(new_n159_));
