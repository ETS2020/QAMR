...
module FAU ( 
  ...
  oai21  g023(.a(x27), .b(new_n69_), .c(new_n68_), .O(new_n70_));
  nand2  g024(.a(new_n55_), .b(new_n69_), .O(new_n71_));
  nand3  g025(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(z04));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n48_), .O(z09));
  inv1   g048(.a(x01), .O(new_n95_));
  nand2  g049(.a(x18), .b(new_n68_), .O(new_n96_));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n88_), .c(new_n65_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n88_), .c(new_n54_), .O(new_n118_));
  ...
  nand3  g075(.a(x18), .b(new_n68_), .c(x04), .O(new_n122_));
  oai21  g076(.a(x18), .b(new_n68_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n90_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n48_), .c(x16), .O(new_n129_));
  ...
  aoi21  g087(.a(new_n126_), .b(new_n107_), .c(new_n75_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n117_), .c(new_n99_), .d(new_n85_), .O(new_n136_));
  inv1   g090(.a(new_n136_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n134_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n133_), .c(new_n48_), .O(z14));
  inv1   g093(.a(x06), .O(new_n140_));
  oai22  g094(.a(new_n96_), .b(new_n140_), .c(x18), .d(new_n78_), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n88_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n108_), .d(new_n88_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n48_), .O(z16));
  ...
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n85_), .O(new_n162_));
