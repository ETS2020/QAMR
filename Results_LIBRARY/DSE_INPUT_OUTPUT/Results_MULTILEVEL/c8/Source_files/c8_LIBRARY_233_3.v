...
module FAU ( 
  ...
  inv1   g049(.a(x07), .O(new_n96_));
  nand2  g050(.a(x18), .b(new_n96_), .O(new_n97_));
  oai22  g051(.a(new_n97_), .b(new_n95_), .c(x18), .d(new_n52_), .O(new_n98_));
  ...
  oai21  g056(.a(new_n88_), .b(new_n54_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n88_), .c(new_n54_), .O(new_n120_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n110_), .d(new_n88_), .O(new_n148_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n146_), .c(new_n110_), .d(new_n88_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g110(.a(x18), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n90_), .c(x15), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n156_), .c(new_n48_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n146_), .c(new_n75_), .O(new_n161_));
  nand3  g115(.a(new_n110_), .b(x19), .c(new_n100_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n100_), .O(new_n163_));
