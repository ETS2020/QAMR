...
module FAU ( 
  ...
  oai21  g30(.a(x18), .b(x16), .c(new_n51_), .O(z08));
  ...
  nand4  g49(.a(new_n95_), .b(new_n86_), .c(new_n50_), .d(new_n78_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n94_), .b(x21), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n90_), .b(x02), .O(new_n99_));
  oai21  g53(.a(new_n98_), .b(new_n82_), .c(new_n99_), .O(z11));
  oai21  g54(.a(new_n83_), .b(x03), .c(new_n82_), .O(new_n101_));
  nand2  g55(.a(new_n96_), .b(x22), .O(new_n102_));
  nor2   g56(.a(x22), .b(x21), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n80_), .c(new_n86_), .O(new_n104_));
  and2   g58(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n82_), .c(new_n101_), .O(z12));
  ...
  oai21  g63(.a(new_n108_), .b(new_n82_), .c(new_n109_), .O(z13));
  ...
  nand4  g74(.a(new_n120_), .b(new_n68_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n97_), .c(new_n113_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n90_), .b(x06), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n82_), .c(new_n124_), .O(z15));
  oai21  g79(.a(new_n83_), .b(x07), .c(new_n82_), .O(new_n126_));
  nor2   g80(.a(x21), .b(x20), .O(new_n127_));
  nor2   g81(.a(x23), .b(x22), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n80_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x26), .O(new_n131_));
  nor3   g85(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n128_), .c(new_n127_), .d(new_n80_), .O(new_n133_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n82_), .O(z17));
endmodule
