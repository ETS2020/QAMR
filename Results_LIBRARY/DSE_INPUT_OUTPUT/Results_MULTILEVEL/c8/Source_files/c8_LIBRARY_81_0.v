...
module FAU ( 
  ...
  nand2  g002(.a(new_n48_), .b(x19), .O(new_n49_));
  nand3  g003(.a(new_n49_), .b(x18), .c(new_n47_), .O(new_n50_));
  inv1   g004(.a(x19), .O(new_n51_));
  nand3  g005(.a(new_n48_), .b(new_n51_), .c(x08), .O(new_n52_));
  nand2  g006(.a(new_n52_), .b(new_n50_), .O(z00));
  inv1   g007(.a(x09), .O(new_n54_));
  nor2   g008(.a(x18), .b(x08), .O(new_n55_));
  aoi21  g009(.a(x27), .b(new_n54_), .c(new_n55_), .O(new_n56_));
  ...
  aoi21  g015(.a(new_n61_), .b(new_n59_), .c(new_n55_), .O(z02));
  inv1   g016(.a(x11), .O(new_n63_));
  aoi21  g017(.a(x27), .b(new_n63_), .c(new_n55_), .O(new_n64_));
  oai21  g018(.a(x27), .b(x22), .c(new_n64_), .O(z03));
  inv1   g019(.a(x12), .O(new_n66_));
  aoi21  g020(.a(x27), .b(new_n66_), .c(new_n55_), .O(new_n67_));
  oai21  g021(.a(x27), .b(x23), .c(new_n67_), .O(z04));
  inv1   g022(.a(x13), .O(new_n69_));
  aoi21  g023(.a(x27), .b(new_n69_), .c(new_n55_), .O(new_n70_));
  oai21  g024(.a(x27), .b(x24), .c(new_n70_), .O(z05));
  inv1   g025(.a(x14), .O(new_n72_));
  aoi21  g026(.a(x27), .b(new_n72_), .c(new_n55_), .O(new_n73_));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n55_), .O(z07));
  nor2   g033(.a(new_n55_), .b(new_n48_), .O(z08));
  ...
  inv1   g038(.a(new_n55_), .O(new_n85_));
  ...
  nand3  g044(.a(new_n90_), .b(x09), .c(x08), .O(new_n91_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n85_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  nand3  g065(.a(new_n90_), .b(x11), .c(x08), .O(new_n112_));
  ...
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n85_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n106_), .d(new_n95_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n96_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n48_), .d(new_n96_), .O(new_n162_));
