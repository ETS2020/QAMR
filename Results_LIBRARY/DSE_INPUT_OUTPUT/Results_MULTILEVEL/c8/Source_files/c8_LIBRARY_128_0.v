...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n68_), .O(new_n69_));
  ...
  nor2   g30(.a(new_n48_), .b(new_n63_), .O(z08));
  ...
  nand4  g50(.a(new_n96_), .b(new_n87_), .c(new_n79_), .d(new_n78_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x21), .c(new_n98_), .O(new_n99_));
  nand2  g53(.a(new_n84_), .b(x02), .O(new_n100_));
  oai21  g54(.a(new_n99_), .b(new_n93_), .c(new_n100_), .O(z11));
  ...
  nand2  g59(.a(new_n84_), .b(x03), .O(new_n106_));
  oai21  g60(.a(new_n105_), .b(new_n93_), .c(new_n106_), .O(z12));
  oai21  g61(.a(new_n83_), .b(x04), .c(new_n93_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n89_), .c(new_n104_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n93_), .c(new_n108_), .O(z13));
  oai21  g65(.a(new_n83_), .b(x05), .c(new_n93_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n89_), .c(new_n68_), .O(new_n113_));
  ...
  oai21  g72(.a(new_n83_), .b(x06), .c(new_n93_), .O(new_n119_));
  inv1   g73(.a(x22), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n68_), .c(new_n62_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n98_), .c(new_n115_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n93_), .c(new_n119_), .O(z15));
  ...
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n63_), .d(new_n78_), .O(new_n141_));
