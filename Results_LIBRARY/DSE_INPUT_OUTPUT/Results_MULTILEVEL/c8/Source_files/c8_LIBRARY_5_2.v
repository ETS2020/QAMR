// Benchmark "FAU" written by ABC on Thu Aug 13 18:00:25 2020
...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x04), .O(new_n53_));
  ...
  nand3  g056(.a(new_n52_), .b(x09), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n96_), .O(new_n105_));
  nor2   g059(.a(new_n94_), .b(new_n56_), .O(new_n106_));
  nor3   g060(.a(x20), .b(x19), .c(x17), .O(new_n107_));
  or2    g061(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n53_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n105_), .O(z10));
  nand2  g064(.a(x18), .b(x02), .O(new_n111_));
  nand3  g065(.a(new_n52_), .b(x10), .c(new_n102_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n96_), .O(new_n114_));
  nor2   g068(.a(x21), .b(x20), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n94_), .O(new_n116_));
  oai21  g070(.a(new_n107_), .b(new_n61_), .c(new_n116_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n53_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n114_), .O(z11));
  ...
  aoi21  g076(.a(new_n52_), .b(x04), .c(x22), .O(new_n123_));
  nand4  g077(.a(new_n123_), .b(new_n61_), .c(new_n56_), .d(new_n49_), .O(new_n124_));
  nand2  g078(.a(new_n116_), .b(x22), .O(new_n125_));
  oai21  g079(.a(new_n124_), .b(x17), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x16), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n53_), .O(z12));
  nand3  g082(.a(new_n52_), .b(x12), .c(new_n102_), .O(new_n129_));
  oai21  g083(.a(new_n52_), .b(new_n102_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n96_), .O(new_n131_));
  nor2   g085(.a(x22), .b(x21), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n94_), .c(new_n56_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x23), .O(new_n134_));
  nor2   g088(.a(x23), .b(x22), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n107_), .c(new_n61_), .O(new_n136_));
  ...
  nand3  g094(.a(new_n52_), .b(x13), .c(new_n102_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n96_), .O(new_n143_));
  nand2  g097(.a(new_n136_), .b(x24), .O(new_n144_));
  nor2   g098(.a(x24), .b(x23), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n132_), .c(new_n107_), .O(new_n146_));
  ...
  nand3  g104(.a(new_n52_), .b(x14), .c(new_n102_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n96_), .O(new_n153_));
  nand2  g107(.a(new_n146_), .b(x25), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n135_), .c(new_n115_), .d(new_n94_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n53_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z15));
  nand2  g113(.a(x18), .b(x07), .O(new_n160_));
  oai21  g114(.a(x18), .b(new_n86_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n96_), .O(new_n162_));
  nand2  g116(.a(new_n156_), .b(x26), .O(new_n163_));
  nand4  g117(.a(new_n135_), .b(new_n88_), .c(new_n81_), .d(new_n78_), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n116_), .c(new_n163_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n162_), .c(new_n53_), .O(z16));
  nand3  g121(.a(new_n115_), .b(x19), .c(new_n92_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n164_), .c(new_n50_), .d(new_n92_), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n53_), .c(x16), .O(new_n170_));
  inv1   g124(.a(new_n170_), .O(z17));
endmodule
