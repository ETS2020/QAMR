...
module FAU ( 
  ...
  nand2  g060(.a(x24), .b(x18), .O(new_n107_));
  ...
  nand4  g072(.a(new_n118_), .b(new_n63_), .c(new_n56_), .d(new_n52_), .O(new_n119_));
  ...
  nand4  g080(.a(new_n91_), .b(new_n66_), .c(new_n63_), .d(new_n56_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x23), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n103_), .c(new_n63_), .O(new_n130_));
  ...
  oai22  g089(.a(new_n107_), .b(new_n134_), .c(x18), .d(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n93_), .O(new_n137_));
  inv1   g091(.a(x18), .O(new_n138_));
  nand4  g092(.a(new_n56_), .b(new_n52_), .c(new_n138_), .d(new_n89_), .O(new_n139_));
  nand4  g093(.a(new_n47_), .b(new_n71_), .c(new_n66_), .d(new_n63_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  aoi21  g095(.a(new_n130_), .b(x24), .c(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n93_), .c(new_n137_), .O(z14));
  ...
  nand3  g100(.a(new_n71_), .b(new_n66_), .c(new_n63_), .O(new_n147_));
  ...
  oai21  g109(.a(x18), .b(new_n85_), .c(new_n155_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n93_), .O(new_n157_));
  oai21  g111(.a(new_n83_), .b(new_n93_), .c(x24), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x18), .O(new_n159_));
  nand2  g113(.a(new_n150_), .b(x26), .O(new_n160_));
  nand4  g114(.a(new_n129_), .b(new_n83_), .c(new_n78_), .d(new_n47_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n111_), .c(new_n160_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n159_), .c(new_n157_), .O(z16));
  nand3  g118(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n53_), .d(new_n89_), .O(new_n166_));
