...
module FAU ( 
  ...
  nand2  g009(.a(new_n55_), .b(x21), .O(new_n56_));
  nand2  g010(.a(new_n56_), .b(new_n48_), .O(new_n57_));
  inv1   g011(.a(x21), .O(new_n58_));
  nand3  g012(.a(new_n55_), .b(new_n58_), .c(x10), .O(new_n59_));
  oai21  g013(.a(new_n57_), .b(x10), .c(new_n59_), .O(z02));
  ...
  nand2  g039(.a(x18), .b(x10), .O(new_n86_));
  ...
  nand3  g058(.a(new_n104_), .b(new_n84_), .c(x10), .O(new_n105_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n105_), .c(new_n82_), .O(z11));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n96_), .O(new_n146_));
  ...
  oai22  g104(.a(new_n86_), .b(new_n150_), .c(x18), .d(new_n77_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n107_), .d(new_n96_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n144_), .b(new_n79_), .c(new_n74_), .d(new_n133_), .O(new_n159_));
