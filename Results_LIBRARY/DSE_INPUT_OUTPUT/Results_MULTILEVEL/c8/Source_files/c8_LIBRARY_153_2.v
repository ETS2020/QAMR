...
module FAU ( 
  ...
  nor2   g039(.a(new_n57_), .b(new_n50_), .O(z08));
  ...
  nand2  g055(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  ...
  nand2  g061(.a(x19), .b(x18), .O(new_n108_));
  oai22  g062(.a(new_n108_), .b(new_n107_), .c(x18), .d(new_n60_), .O(new_n109_));
  ...
  nor2   g068(.a(new_n62_), .b(new_n49_), .O(new_n115_));
  ...
  oai22  g096(.a(new_n108_), .b(new_n142_), .c(x18), .d(new_n75_), .O(new_n143_));
  ...
  aoi21  g101(.a(new_n147_), .b(new_n146_), .c(x18), .O(new_n148_));
  nor2   g102(.a(new_n77_), .b(new_n49_), .O(new_n149_));
  ...
  oai22  g118(.a(new_n108_), .b(new_n164_), .c(x18), .d(new_n83_), .O(new_n165_));
  ...
  oai22  g130(.a(new_n176_), .b(new_n175_), .c(new_n50_), .d(new_n88_), .O(new_n177_));
