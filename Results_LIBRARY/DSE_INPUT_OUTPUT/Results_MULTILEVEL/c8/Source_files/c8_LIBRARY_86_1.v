...
module FAU ( 
  ...
  nand4  g50(.a(new_n96_), .b(new_n89_), .c(new_n51_), .d(new_n81_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x21), .c(new_n98_), .O(new_n99_));
  nand3  g53(.a(new_n47_), .b(new_n85_), .c(x10), .O(new_n100_));
  ...
  oai21  g61(.a(x18), .b(x12), .c(new_n85_), .O(new_n108_));
  ...
  oai21  g73(.a(x18), .b(x14), .c(new_n85_), .O(new_n120_));
  inv1   g74(.a(x23), .O(new_n121_));
  nand4  g75(.a(new_n74_), .b(new_n113_), .c(new_n121_), .d(new_n63_), .O(new_n122_));
  ...
  nand3  g88(.a(new_n47_), .b(new_n85_), .c(x15), .O(new_n135_));
