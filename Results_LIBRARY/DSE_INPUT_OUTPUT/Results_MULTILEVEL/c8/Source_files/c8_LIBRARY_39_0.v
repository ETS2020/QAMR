...
module FAU ( 
  ...
  oai21  g000(.a(x18), .b(x09), .c(x27), .O(new_n47_));
  inv1   g001(.a(x19), .O(new_n48_));
  inv1   g002(.a(x27), .O(new_n49_));
  nor2   g003(.a(x18), .b(x09), .O(new_n50_));
  ...
  aoi21  g020(.a(x27), .b(new_n66_), .c(new_n50_), .O(new_n67_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n87_), .c(new_n51_), .O(z10));
  ...
  nand3  g055(.a(new_n101_), .b(new_n96_), .c(new_n51_), .O(z11));
  nand2  g056(.a(x18), .b(x03), .O(new_n103_));
  nand3  g057(.a(new_n54_), .b(x11), .c(x09), .O(new_n104_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n89_), .c(new_n88_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n51_), .c(x16), .O(new_n111_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n97_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n51_), .O(z13));
  nand2  g075(.a(x18), .b(x05), .O(new_n122_));
  nand3  g076(.a(new_n54_), .b(x13), .c(x09), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n79_), .O(new_n125_));
  inv1   g079(.a(x17), .O(new_n126_));
  nand3  g080(.a(new_n88_), .b(new_n48_), .c(new_n126_), .O(new_n127_));
  inv1   g081(.a(x22), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n128_), .c(new_n97_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n108_), .c(new_n132_), .d(new_n126_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n51_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n125_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  nand3  g092(.a(new_n54_), .b(x14), .c(x09), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n117_), .c(new_n98_), .d(new_n89_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n51_), .c(x16), .O(new_n146_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n79_), .O(new_n150_));
  nand2  g104(.a(new_n144_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n117_), .c(new_n98_), .d(new_n89_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n51_), .O(z16));
  inv1   g110(.a(x24), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n117_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n98_), .b(x19), .c(new_n126_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n49_), .d(new_n126_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n51_), .O(z17));
endmodule
