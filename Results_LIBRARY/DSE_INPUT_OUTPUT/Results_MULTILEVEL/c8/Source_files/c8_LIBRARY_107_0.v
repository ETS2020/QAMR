...
module FAU ( 
  ...
  inv1   g028(.a(new_n47_), .O(new_n75_));
  nand3  g029(.a(new_n75_), .b(x27), .c(new_n74_), .O(new_n76_));
  inv1   g030(.a(x26), .O(new_n77_));
  nand3  g031(.a(new_n51_), .b(new_n77_), .c(x18), .O(new_n78_));
  nand2  g032(.a(new_n78_), .b(new_n76_), .O(z07));
  nand2  g033(.a(new_n75_), .b(new_n51_), .O(z08));
  inv1   g034(.a(x16), .O(new_n81_));
  nand2  g035(.a(x18), .b(x00), .O(new_n82_));
  inv1   g036(.a(x18), .O(new_n83_));
  nand2  g037(.a(x26), .b(new_n83_), .O(new_n84_));
  oai21  g038(.a(new_n84_), .b(new_n48_), .c(new_n82_), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(new_n81_), .O(new_n86_));
  xnor2a g040(.a(x19), .b(x17), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n75_), .c(x16), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n86_), .O(z09));
  nand2  g043(.a(x18), .b(x01), .O(new_n90_));
  oai21  g044(.a(new_n84_), .b(new_n54_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n75_), .c(x16), .O(new_n98_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n75_), .O(z11));
  nand2  g063(.a(x18), .b(x03), .O(new_n110_));
  oai21  g064(.a(new_n84_), .b(new_n60_), .c(new_n110_), .O(new_n111_));
  ...
  oai21  g073(.a(new_n84_), .b(new_n65_), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n75_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n121_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(new_n84_), .b(new_n68_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n81_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n62_), .c(new_n103_), .O(new_n132_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n75_), .c(x16), .O(new_n138_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n75_), .O(z15));
  ...
  oai21  g107(.a(new_n153_), .b(new_n152_), .c(x18), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n77_), .O(new_n155_));
  ...
  oai22  g115(.a(new_n161_), .b(new_n158_), .c(new_n51_), .d(new_n95_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n75_), .O(z17));
endmodule
