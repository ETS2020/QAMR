...
module FAU ( 
  ...
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n62_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n99_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n123_), .c(new_n135_), .d(new_n85_), .O(new_n137_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n89_), .c(x13), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  oai22  g097(.a(new_n143_), .b(x05), .c(x18), .d(new_n76_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n147_), .d(new_n87_), .O(new_n149_));
  ...
  oai22  g107(.a(new_n153_), .b(x05), .c(x18), .d(new_n79_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n147_), .d(new_n87_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n126_), .c(new_n73_), .O(new_n163_));
  nand3  g117(.a(new_n147_), .b(x19), .c(new_n85_), .O(new_n164_));
