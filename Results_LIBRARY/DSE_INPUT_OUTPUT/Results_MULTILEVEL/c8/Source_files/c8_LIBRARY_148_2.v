...
module FAU ( 
  ...
  aoi21  g035(.a(new_n81_), .b(new_n79_), .c(new_n65_), .O(z06));
  ...
  oai22  g054(.a(new_n91_), .b(new_n100_), .c(x18), .d(new_n57_), .O(new_n101_));
  ...
  nor2   g061(.a(x18), .b(new_n62_), .O(new_n108_));
  ...
  aoi21  g067(.a(new_n113_), .b(x16), .c(new_n65_), .O(new_n114_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n55_), .O(new_n121_));
  ...
  nor3   g083(.a(new_n129_), .b(new_n96_), .c(new_n89_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(x18), .c(new_n52_), .O(new_n131_));
  nand3  g085(.a(new_n121_), .b(x23), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n128_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  oai22  g088(.a(new_n91_), .b(new_n134_), .c(x18), .d(new_n73_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n89_), .O(new_n136_));
  nand2  g090(.a(new_n121_), .b(x24), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n120_), .c(new_n110_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x18), .O(new_n140_));
  nor2   g094(.a(new_n75_), .b(new_n52_), .O(new_n141_));
  ...
  nand3  g100(.a(new_n75_), .b(new_n68_), .c(new_n60_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n104_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x23), .b(x22), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n111_), .d(new_n95_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n148_), .c(x18), .O(new_n152_));
  nor2   g106(.a(new_n80_), .b(new_n52_), .O(new_n153_));
  ...
  oai21  g112(.a(new_n83_), .b(new_n89_), .c(x23), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x18), .O(new_n160_));
  nand2  g114(.a(new_n151_), .b(x26), .O(new_n161_));
  nand4  g115(.a(new_n149_), .b(new_n83_), .c(new_n80_), .d(new_n75_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(new_n112_), .c(new_n161_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n160_), .c(new_n158_), .O(z16));
  nand3  g119(.a(new_n111_), .b(x19), .c(new_n103_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n162_), .c(new_n48_), .d(new_n103_), .O(new_n167_));
