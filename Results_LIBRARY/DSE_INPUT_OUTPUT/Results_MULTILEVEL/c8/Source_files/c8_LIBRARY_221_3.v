...
module FAU ( 
  ...
  aoi21  g082(.a(new_n123_), .b(new_n97_), .c(new_n75_), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n111_), .c(new_n130_), .d(new_n88_), .O(new_n132_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n139_), .c(new_n102_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n92_), .b(x15), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  nand2  g107(.a(new_n70_), .b(new_n109_), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n80_), .c(new_n75_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n88_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n52_), .b(new_n88_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n121_), .c(new_n117_), .O(z17));
endmodule
