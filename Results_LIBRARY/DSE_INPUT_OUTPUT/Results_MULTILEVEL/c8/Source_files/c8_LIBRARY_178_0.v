...
module FAU ( 
  ...
  nand2  g51(.a(new_n91_), .b(x01), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n97_), .O(z10));
  inv1   g53(.a(x16), .O(new_n100_));
  nor2   g54(.a(x20), .b(x19), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n86_), .O(new_n102_));
  nand4  g56(.a(new_n59_), .b(new_n94_), .c(new_n50_), .d(new_n86_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n102_), .b(x21), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n91_), .b(x02), .O(new_n106_));
  oai21  g60(.a(new_n105_), .b(new_n100_), .c(new_n106_), .O(z11));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n94_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n91_), .b(x03), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n100_), .c(new_n112_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n96_), .c(new_n110_), .d(x23), .O(new_n115_));
  nand2  g69(.a(new_n91_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n100_), .c(new_n116_), .O(z13));
  oai21  g71(.a(new_n90_), .b(x05), .c(new_n100_), .O(new_n118_));
  aoi21  g72(.a(new_n114_), .b(new_n96_), .c(new_n72_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n101_), .d(new_n86_), .O(new_n121_));
  ...
  nand4  g79(.a(new_n77_), .b(new_n72_), .c(new_n67_), .d(new_n125_), .O(new_n126_));
  ...
  oai21  g83(.a(new_n128_), .b(new_n100_), .c(new_n129_), .O(z15));
  oai21  g84(.a(new_n90_), .b(x07), .c(new_n100_), .O(new_n131_));
  ...
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n100_), .O(z17));
endmodule
