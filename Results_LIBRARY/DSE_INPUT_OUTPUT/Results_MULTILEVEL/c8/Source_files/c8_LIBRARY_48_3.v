...
module FAU ( 
  ...
  nand2  g054(.a(new_n100_), .b(x09), .O(new_n101_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n96_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n122_), .c(x16), .O(new_n146_));
