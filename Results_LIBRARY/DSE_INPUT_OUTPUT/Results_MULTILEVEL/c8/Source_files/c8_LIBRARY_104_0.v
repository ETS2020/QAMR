...
module FAU ( 
  ...
  nand3  g013(.a(new_n51_), .b(new_n59_), .c(x18), .O(new_n60_));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n57_), .O(z09));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  nand2  g049(.a(x21), .b(new_n63_), .O(new_n96_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n57_), .c(x16), .O(new_n102_));
  ...
  nor2   g061(.a(new_n63_), .b(x17), .O(new_n108_));
  nor3   g062(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  aoi22  g063(.a(new_n109_), .b(new_n108_), .c(new_n100_), .d(x21), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n90_), .c(new_n107_), .O(z11));
  inv1   g065(.a(x11), .O(new_n112_));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  oai21  g067(.a(new_n96_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n90_), .O(new_n115_));
  nand2  g069(.a(new_n100_), .b(x22), .O(new_n116_));
  nand4  g070(.a(new_n88_), .b(new_n62_), .c(new_n59_), .d(new_n99_), .O(new_n117_));
  aoi21  g071(.a(new_n117_), .b(new_n116_), .c(new_n63_), .O(new_n118_));
  nor2   g072(.a(new_n62_), .b(new_n59_), .O(new_n119_));
  ...
  oai21  g078(.a(new_n69_), .b(new_n90_), .c(x21), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n63_), .O(new_n126_));
  nand2  g080(.a(new_n117_), .b(x23), .O(new_n127_));
  inv1   g081(.a(new_n100_), .O(new_n128_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n126_), .c(new_n124_), .O(z13));
  ...
  oai21  g091(.a(new_n137_), .b(new_n90_), .c(x21), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n63_), .O(new_n139_));
  aoi21  g093(.a(new_n129_), .b(new_n128_), .c(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n62_), .b(new_n59_), .O(new_n141_));
  nand2  g095(.a(new_n137_), .b(new_n69_), .O(new_n142_));
  nor3   g096(.a(new_n142_), .b(new_n141_), .c(new_n100_), .O(new_n143_));
  ...
  nand3  g102(.a(new_n137_), .b(new_n69_), .c(new_n62_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n88_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n150_), .c(new_n63_), .O(new_n155_));
  nor2   g109(.a(new_n77_), .b(new_n59_), .O(new_n156_));
  ...
  oai21  g113(.a(new_n96_), .b(new_n80_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n90_), .O(new_n161_));
  nor2   g115(.a(x20), .b(x19), .O(new_n162_));
  nand4  g116(.a(new_n153_), .b(new_n152_), .c(new_n162_), .d(new_n86_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x26), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n152_), .c(new_n151_), .d(new_n88_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n164_), .c(new_n63_), .O(new_n167_));
  nor2   g121(.a(new_n82_), .b(new_n59_), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n167_), .c(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n161_), .O(z16));
  nand3  g124(.a(new_n57_), .b(x27), .c(x17), .O(new_n171_));
  nand2  g125(.a(new_n151_), .b(x19), .O(new_n172_));
  inv1   g126(.a(new_n172_), .O(new_n173_));
  nand4  g127(.a(new_n173_), .b(new_n165_), .c(new_n152_), .d(new_n108_), .O(new_n174_));
  aoi21  g128(.a(new_n174_), .b(new_n171_), .c(new_n90_), .O(z17));
endmodule
