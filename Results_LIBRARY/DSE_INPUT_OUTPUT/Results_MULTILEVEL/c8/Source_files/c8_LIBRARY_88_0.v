...
module FAU ( 
  ...
  oai21  g45(.a(new_n91_), .b(x00), .c(new_n90_), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n89_), .O(z09));
  oai21  g47(.a(new_n91_), .b(x01), .c(new_n90_), .O(new_n94_));
  nor2   g48(.a(new_n88_), .b(new_n56_), .O(new_n95_));
  ...
  oai21  g52(.a(new_n91_), .b(x02), .c(new_n90_), .O(new_n99_));
  ...
  oai21  g58(.a(new_n104_), .b(new_n90_), .c(new_n99_), .O(z11));
  oai21  g59(.a(new_n91_), .b(x03), .c(new_n90_), .O(new_n106_));
  ...
  nand3  g67(.a(x18), .b(new_n90_), .c(x04), .O(new_n114_));
  oai21  g68(.a(new_n113_), .b(new_n90_), .c(new_n114_), .O(z13));
  oai21  g69(.a(new_n91_), .b(x05), .c(new_n90_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  aoi21  g71(.a(new_n112_), .b(new_n96_), .c(new_n117_), .O(new_n118_));
  ...
  oai21  g77(.a(new_n91_), .b(x06), .c(new_n90_), .O(new_n124_));
  nand4  g78(.a(new_n79_), .b(new_n117_), .c(new_n71_), .d(new_n66_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n103_), .c(new_n120_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n90_), .c(new_n124_), .O(z15));
  ...
  nand3  g91(.a(x18), .b(new_n90_), .c(x07), .O(new_n138_));
