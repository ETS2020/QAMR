...
module FAU ( 
  ...
  aoi21  g065(.a(new_n103_), .b(new_n95_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n95_), .c(new_n94_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n107_), .b(x11), .O(new_n117_));
  ...
  aoi21  g081(.a(new_n121_), .b(new_n102_), .c(new_n71_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n113_), .c(new_n96_), .d(new_n83_), .O(new_n130_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n137_), .c(new_n71_), .O(new_n153_));
