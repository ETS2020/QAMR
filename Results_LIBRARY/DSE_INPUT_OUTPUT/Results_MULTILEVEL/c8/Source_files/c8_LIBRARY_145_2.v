...
module FAU ( 
  ...
  nand3  g074(.a(new_n120_), .b(new_n96_), .c(new_n101_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n66_), .b(new_n60_), .c(new_n101_), .O(new_n129_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n120_), .c(new_n102_), .d(new_n88_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n90_), .b(x06), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n120_), .c(new_n102_), .d(new_n88_), .O(new_n150_));
  ...
  nand2  g107(.a(new_n66_), .b(new_n60_), .O(new_n154_));
  ...
  nor2   g113(.a(new_n61_), .b(new_n85_), .O(new_n160_));
