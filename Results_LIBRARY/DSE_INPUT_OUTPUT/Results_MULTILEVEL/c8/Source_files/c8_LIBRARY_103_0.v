...
module FAU ( 
  ...
  oai21  g032(.a(new_n54_), .b(new_n77_), .c(new_n78_), .O(new_n79_));
  oai21  g033(.a(new_n54_), .b(x14), .c(new_n79_), .O(z06));
  ...
  nand2  g048(.a(x25), .b(new_n77_), .O(new_n95_));
  ...
  oai21  g053(.a(new_n87_), .b(new_n53_), .c(new_n99_), .O(new_n100_));
  ...
  oai21  g061(.a(new_n98_), .b(new_n59_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n105_), .c(new_n84_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  oai21  g065(.a(new_n95_), .b(new_n62_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n89_), .O(new_n113_));
  nand2  g067(.a(new_n107_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n87_), .c(new_n53_), .O(new_n116_));
  ...
  oai21  g083(.a(new_n95_), .b(new_n72_), .c(new_n129_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n84_), .c(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n131_), .O(z14));
  inv1   g093(.a(x14), .O(new_n140_));
  nand2  g094(.a(x18), .b(x06), .O(new_n141_));
  oai21  g095(.a(x18), .b(new_n140_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n89_), .O(new_n143_));
  nand2  g097(.a(new_n135_), .b(new_n115_), .O(new_n144_));
  nand3  g098(.a(new_n134_), .b(new_n133_), .c(x16), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n144_), .c(x18), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n78_), .O(new_n147_));
  nand3  g101(.a(new_n136_), .b(x25), .c(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n147_), .c(new_n143_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  oai21  g104(.a(new_n95_), .b(new_n81_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n89_), .O(new_n152_));
  nand2  g106(.a(new_n136_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n106_), .d(new_n87_), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(new_n153_), .c(new_n77_), .O(new_n156_));
  and2   g110(.a(x26), .b(x25), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n156_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n152_), .O(z16));
  nand2  g113(.a(new_n154_), .b(new_n124_), .O(new_n160_));
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n133_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n54_), .d(new_n133_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n84_), .O(z17));
endmodule
