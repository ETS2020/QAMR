...
module FAU ( 
  ...
  aoi21  g067(.a(new_n108_), .b(new_n92_), .c(new_n65_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n92_), .c(new_n54_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n94_), .b(x03), .O(new_n119_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n107_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n100_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n89_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n125_), .c(new_n108_), .d(new_n92_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n125_), .c(new_n108_), .d(new_n92_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand2  g109(.a(new_n94_), .b(x07), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n125_), .c(new_n75_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n89_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n89_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(x18), .c(x16), .O(new_n162_));
