...
module FAU ( 
  ...
  oai21  g033(.a(new_n52_), .b(x18), .c(new_n79_), .O(new_n80_));
  oai21  g034(.a(new_n52_), .b(x15), .c(new_n80_), .O(z07));
  ...
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n82_), .O(z11));
  inv1   g062(.a(x03), .O(new_n109_));
  nand2  g063(.a(x26), .b(x18), .O(new_n110_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n86_), .c(new_n57_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n82_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n112_), .O(z12));
  inv1   g072(.a(x04), .O(new_n119_));
  oai22  g073(.a(new_n110_), .b(new_n119_), .c(x18), .d(new_n66_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n88_), .O(new_n121_));
  nand2  g075(.a(new_n115_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n97_), .c(new_n103_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n82_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n121_), .O(z13));
  inv1   g081(.a(x05), .O(new_n128_));
  oai22  g082(.a(new_n110_), .b(new_n128_), .c(x18), .d(new_n71_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n88_), .O(new_n130_));
  nand3  g084(.a(new_n57_), .b(new_n51_), .c(new_n84_), .O(new_n131_));
  inv1   g085(.a(x22), .O(new_n132_));
  nand3  g086(.a(new_n68_), .b(new_n132_), .c(new_n103_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n131_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n84_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n82_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n130_), .O(z14));
  nand2  g094(.a(x18), .b(x06), .O(new_n141_));
  oai21  g095(.a(x18), .b(new_n74_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n88_), .O(new_n143_));
  nand2  g097(.a(new_n137_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n123_), .c(new_n104_), .d(new_n86_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n82_), .O(z15));
  inv1   g103(.a(x15), .O(new_n150_));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  oai21  g105(.a(x18), .b(new_n150_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n88_), .O(new_n153_));
  nand3  g107(.a(new_n135_), .b(new_n84_), .c(x16), .O(new_n154_));
  nand3  g108(.a(new_n145_), .b(new_n114_), .c(new_n68_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n154_), .c(new_n47_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n79_), .O(new_n157_));
  nand3  g111(.a(new_n146_), .b(x26), .c(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n157_), .c(new_n153_), .O(z16));
  nand3  g113(.a(new_n104_), .b(x19), .c(new_n84_), .O(new_n160_));
  inv1   g114(.a(x24), .O(new_n161_));
  nand4  g115(.a(new_n123_), .b(new_n79_), .c(new_n76_), .d(new_n161_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n160_), .c(new_n52_), .d(new_n84_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n82_), .O(z17));
endmodule
