...
module FAU ( 
  ...
  oai21  g31(.a(new_n47_), .b(x16), .c(new_n52_), .O(z08));
  ...
  nor2   g40(.a(new_n81_), .b(new_n86_), .O(new_n87_));
  ...
  oai21  g45(.a(new_n91_), .b(new_n55_), .c(new_n89_), .O(z10));
  nor2   g46(.a(x20), .b(x19), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n79_), .O(new_n94_));
  inv1   g48(.a(x21), .O(new_n95_));
  nand4  g49(.a(new_n95_), .b(new_n86_), .c(new_n51_), .d(new_n79_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n94_), .b(x21), .c(new_n97_), .O(new_n98_));
  oai22  g52(.a(new_n98_), .b(new_n83_), .c(new_n91_), .d(new_n58_), .O(z11));
  oai21  g53(.a(x18), .b(x11), .c(new_n83_), .O(new_n100_));
  nand2  g54(.a(new_n96_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n81_), .c(new_n86_), .O(new_n103_));
  ...
  aoi22  g60(.a(new_n106_), .b(new_n88_), .c(new_n103_), .d(x23), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n83_), .c(new_n91_), .d(new_n64_), .O(z13));
  aoi21  g62(.a(new_n106_), .b(new_n88_), .c(new_n69_), .O(new_n109_));
  nor2   g63(.a(x24), .b(x23), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n102_), .c(new_n93_), .d(new_n79_), .O(new_n111_));
  inv1   g65(.a(new_n111_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g67(.a(new_n90_), .b(x13), .O(new_n114_));
  ...
  nand2  g75(.a(new_n90_), .b(x14), .O(new_n122_));
