...
module FAU ( 
  ...
  nand3  g058(.a(new_n104_), .b(x10), .c(x06), .O(new_n105_));
  ...
  nor2   g069(.a(new_n52_), .b(x22), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n61_), .c(new_n56_), .d(new_n49_), .O(new_n117_));
  ...
  nand3  g076(.a(new_n104_), .b(x12), .c(x06), .O(new_n123_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n89_), .c(new_n56_), .O(new_n127_));
  ...
  nand3  g088(.a(new_n104_), .b(x13), .c(x06), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n126_), .c(new_n139_), .d(new_n87_), .O(new_n141_));
  ...
  aoi21  g099(.a(new_n104_), .b(new_n77_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n141_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n129_), .c(new_n108_), .d(new_n89_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(x16), .c(new_n146_), .O(new_n151_));
  nand3  g105(.a(new_n150_), .b(x18), .c(x16), .O(new_n152_));
  oai21  g106(.a(new_n151_), .b(new_n145_), .c(new_n152_), .O(z15));
  ...
  nand3  g112(.a(new_n158_), .b(new_n129_), .c(new_n74_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n109_), .c(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n86_), .O(z16));
  nand3  g116(.a(new_n108_), .b(x19), .c(new_n87_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n50_), .d(new_n87_), .O(new_n164_));
