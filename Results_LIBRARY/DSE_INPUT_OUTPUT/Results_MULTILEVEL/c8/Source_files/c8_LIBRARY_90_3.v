...
module FAU ( 
  ...
  nand2  g072(.a(new_n109_), .b(x23), .O(new_n119_));
  ...
  aoi21  g080(.a(new_n120_), .b(new_n94_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n108_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n100_), .d(new_n87_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n89_), .b(x14), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n100_), .d(new_n87_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n89_), .b(x15), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  inv1   g105(.a(x23), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n63_), .O(new_n153_));
  nand3  g107(.a(new_n79_), .b(new_n74_), .c(new_n126_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n100_), .b(x19), .c(new_n84_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n55_), .b(new_n84_), .O(new_n158_));
  aoi21  g112(.a(new_n157_), .b(new_n155_), .c(new_n158_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n118_), .c(new_n114_), .O(z17));
endmodule
