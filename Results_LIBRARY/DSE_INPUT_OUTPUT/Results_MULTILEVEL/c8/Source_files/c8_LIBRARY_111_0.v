...
module FAU ( 
  ...
  aoi21  g026(.a(new_n72_), .b(new_n70_), .c(new_n47_), .O(z06));
  ...
  oai21  g059(.a(new_n81_), .b(new_n60_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g077(.a(new_n81_), .b(new_n66_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n79_), .O(new_n125_));
  inv1   g079(.a(x17), .O(new_n126_));
  nand3  g080(.a(new_n90_), .b(new_n50_), .c(new_n126_), .O(new_n127_));
  ...
  oai21  g092(.a(new_n81_), .b(new_n69_), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g100(.a(new_n74_), .b(x07), .c(new_n79_), .O(new_n147_));
  nand2  g101(.a(new_n143_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n118_), .c(new_n100_), .d(new_n91_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n77_), .O(z16));
  inv1   g107(.a(x24), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n118_), .c(new_n154_), .O(new_n156_));
  nand3  g110(.a(new_n100_), .b(x19), .c(new_n126_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n51_), .d(new_n126_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n77_), .O(z17));
endmodule
