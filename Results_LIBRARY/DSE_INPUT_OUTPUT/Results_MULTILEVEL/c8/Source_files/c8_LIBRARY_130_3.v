...
module FAU ( 
  ...
  nand2  g027(.a(new_n55_), .b(new_n72_), .O(new_n74_));
  nand3  g028(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z05));
  ...
  nor2   g050(.a(new_n96_), .b(new_n54_), .O(new_n97_));
  ...
  oai22  g055(.a(new_n87_), .b(new_n101_), .c(x18), .d(new_n58_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n85_), .O(new_n103_));
  inv1   g057(.a(x17), .O(new_n104_));
  inv1   g058(.a(x19), .O(new_n105_));
  nand4  g059(.a(new_n60_), .b(new_n54_), .c(new_n105_), .d(new_n104_), .O(new_n106_));
  oai21  g060(.a(new_n98_), .b(new_n60_), .c(new_n106_), .O(new_n107_));
  ...
  aoi21  g066(.a(x18), .b(x13), .c(x22), .O(new_n113_));
  nand4  g067(.a(new_n113_), .b(new_n60_), .c(new_n54_), .d(new_n105_), .O(new_n114_));
  ...
  oai22  g073(.a(new_n87_), .b(new_n119_), .c(x18), .d(new_n66_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n85_), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n96_), .c(new_n54_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n98_), .c(new_n60_), .O(new_n126_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n125_), .c(new_n147_), .d(new_n96_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n125_), .c(new_n147_), .d(new_n96_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n125_), .c(new_n72_), .O(new_n163_));
  nand3  g117(.a(new_n147_), .b(x19), .c(new_n104_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n104_), .O(new_n165_));
