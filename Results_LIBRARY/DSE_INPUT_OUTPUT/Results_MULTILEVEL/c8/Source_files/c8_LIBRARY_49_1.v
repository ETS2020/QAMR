...
module FAU ( 
  ...
  nor2   g013(.a(x27), .b(x18), .O(new_n60_));
  ...
  aoi21  g035(.a(new_n81_), .b(new_n79_), .c(new_n77_), .O(z06));
  ...
  nor2   g041(.a(new_n77_), .b(new_n48_), .O(z08));
  inv1   g042(.a(x16), .O(new_n89_));
  inv1   g043(.a(x00), .O(new_n90_));
  nand2  g044(.a(x18), .b(x10), .O(new_n91_));
  ...
  oai22  g051(.a(new_n91_), .b(new_n97_), .c(x18), .d(new_n57_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n89_), .O(new_n99_));
  nor2   g053(.a(x19), .b(x17), .O(new_n100_));
  inv1   g054(.a(x17), .O(new_n101_));
  nand3  g055(.a(new_n55_), .b(new_n47_), .c(new_n101_), .O(new_n102_));
  oai21  g056(.a(new_n100_), .b(new_n55_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n53_), .c(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n99_), .O(z10));
  inv1   g059(.a(x02), .O(new_n106_));
  aoi21  g060(.a(x18), .b(new_n106_), .c(x16), .O(new_n107_));
  ...
  aoi21  g066(.a(new_n112_), .b(x16), .c(new_n107_), .O(new_n113_));
  inv1   g067(.a(x18), .O(new_n114_));
  nand3  g068(.a(new_n112_), .b(new_n114_), .c(x16), .O(new_n115_));
  oai21  g069(.a(new_n113_), .b(new_n52_), .c(new_n115_), .O(z11));
  ...
  nand4  g074(.a(new_n120_), .b(new_n108_), .c(new_n55_), .d(new_n47_), .O(new_n121_));
  nand2  g075(.a(new_n111_), .b(x22), .O(new_n122_));
  ...
  nand4  g082(.a(new_n100_), .b(new_n62_), .c(new_n108_), .d(new_n55_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x23), .O(new_n130_));
  nor3   g084(.a(x23), .b(x22), .c(x21), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n109_), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n109_), .c(new_n72_), .O(new_n139_));
  nand4  g093(.a(new_n72_), .b(new_n67_), .c(new_n62_), .d(new_n108_), .O(new_n140_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n110_), .d(new_n100_), .O(new_n149_));
  ...
  nand4  g110(.a(new_n147_), .b(new_n83_), .c(new_n80_), .d(new_n72_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n110_), .b(x19), .c(new_n101_), .O(new_n161_));
