...
module FAU ( 
  ...
  nand3  g050(.a(new_n96_), .b(x09), .c(new_n52_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  inv1   g053(.a(x20), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n49_), .c(new_n86_), .O(new_n101_));
  oai21  g055(.a(new_n88_), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n88_), .c(new_n100_), .O(new_n119_));
  ...
  oai21  g098(.a(new_n96_), .b(new_n90_), .c(x06), .O(new_n145_));
  nand2  g099(.a(new_n141_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n127_), .c(new_n109_), .d(new_n88_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n96_), .b(new_n90_), .c(x14), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z15));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n96_), .b(x15), .c(new_n52_), .O(new_n154_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n127_), .c(new_n109_), .d(new_n88_), .O(new_n159_));
  ...
  nand4  g117(.a(new_n127_), .b(new_n81_), .c(new_n76_), .d(new_n163_), .O(new_n164_));
  nand3  g118(.a(new_n109_), .b(x19), .c(new_n86_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n50_), .d(new_n86_), .O(new_n166_));
