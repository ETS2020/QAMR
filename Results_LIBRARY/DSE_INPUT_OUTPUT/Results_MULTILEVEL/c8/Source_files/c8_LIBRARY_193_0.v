...
module FAU ( 
  ...
  nand4  g51(.a(new_n59_), .b(new_n88_), .c(new_n50_), .d(new_n80_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n84_), .c(new_n95_), .O(z11));
  nand2  g55(.a(new_n98_), .b(x22), .O(new_n102_));
  nor2   g56(.a(x22), .b(x21), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n82_), .c(new_n88_), .O(new_n104_));
  ...
  aoi22  g63(.a(new_n109_), .b(new_n90_), .c(new_n104_), .d(x23), .O(new_n110_));
  ...
  aoi21  g67(.a(new_n109_), .b(new_n90_), .c(new_n113_), .O(new_n114_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n113_), .c(new_n121_), .d(new_n120_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n99_), .c(new_n116_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n92_), .b(x06), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n84_), .c(new_n126_), .O(z15));
  ...
  nand2  g90(.a(new_n92_), .b(x07), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  inv1   g92(.a(new_n47_), .O(new_n139_));
  nand4  g93(.a(new_n129_), .b(new_n76_), .c(new_n122_), .d(new_n113_), .O(new_n140_));
