...
module FAU ( 
  ...
  nor2   g006(.a(x16), .b(new_n52_), .O(new_n53_));
  ...
  nand2  g048(.a(new_n94_), .b(x08), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n93_), .c(new_n52_), .O(new_n96_));
  ...
  nand3  g054(.a(new_n100_), .b(new_n92_), .c(new_n52_), .O(new_n101_));
  inv1   g055(.a(x20), .O(new_n102_));
  nor2   g056(.a(new_n90_), .b(new_n102_), .O(new_n103_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n92_), .c(new_n52_), .O(new_n109_));
  nor2   g063(.a(x20), .b(x19), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n88_), .O(new_n111_));
  nand4  g065(.a(new_n60_), .b(new_n102_), .c(new_n49_), .d(new_n88_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  aoi21  g067(.a(new_n111_), .b(x21), .c(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n92_), .c(new_n109_), .O(z11));
  nand2  g069(.a(x18), .b(x03), .O(new_n116_));
  nand2  g070(.a(new_n94_), .b(x11), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n116_), .c(new_n52_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n92_), .O(new_n119_));
  nand2  g073(.a(new_n112_), .b(x22), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n90_), .c(new_n102_), .O(new_n122_));
  and2   g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n92_), .c(new_n119_), .O(z12));
  nor3   g078(.a(x23), .b(x22), .c(x21), .O(new_n125_));
  aoi22  g079(.a(new_n125_), .b(new_n104_), .c(new_n122_), .d(x23), .O(new_n126_));
  nand4  g080(.a(new_n94_), .b(new_n92_), .c(x12), .d(new_n52_), .O(new_n127_));
  oai21  g081(.a(new_n126_), .b(new_n92_), .c(new_n127_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  nand2  g083(.a(new_n94_), .b(x13), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(new_n52_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n92_), .O(new_n132_));
  aoi21  g086(.a(new_n125_), .b(new_n104_), .c(new_n75_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n121_), .c(new_n110_), .d(new_n88_), .O(new_n135_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n92_), .c(new_n52_), .O(new_n141_));
  nand4  g095(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  aoi22  g097(.a(new_n143_), .b(new_n113_), .c(new_n135_), .d(x25), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n92_), .c(new_n141_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  oai21  g100(.a(x18), .b(new_n83_), .c(new_n146_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n92_), .c(new_n52_), .O(new_n148_));
  nor2   g102(.a(x21), .b(x20), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n90_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n150_), .c(new_n149_), .d(new_n90_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n150_), .c(new_n75_), .O(new_n160_));
  nand3  g114(.a(new_n149_), .b(x19), .c(new_n88_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n50_), .d(new_n88_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n86_), .O(z17));
endmodule
