...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  ...
  nor2   g060(.a(new_n83_), .b(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(x02), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n106_), .c(new_n100_), .O(z11));
  oai21  g063(.a(x16), .b(x11), .c(new_n83_), .O(new_n110_));
  aoi21  g064(.a(new_n103_), .b(new_n94_), .c(new_n65_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n107_), .b(x03), .O(new_n116_));
  ...
  nand2  g077(.a(new_n107_), .b(x04), .O(new_n124_));
  ...
  nand4  g082(.a(new_n128_), .b(new_n112_), .c(new_n95_), .d(new_n85_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n107_), .b(x05), .O(new_n132_));
  ...
  nand2  g107(.a(new_n153_), .b(new_n65_), .O(new_n154_));
  ...
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n85_), .O(new_n159_));
