...
module FAU ( 
  ...
  nand2  g026(.a(new_n51_), .b(x25), .O(new_n73_));
  nand2  g027(.a(new_n73_), .b(x18), .O(new_n74_));
  inv1   g028(.a(x25), .O(new_n75_));
  nand3  g029(.a(new_n51_), .b(new_n75_), .c(x14), .O(new_n76_));
  oai21  g030(.a(new_n74_), .b(x14), .c(new_n76_), .O(z06));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n83_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n83_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  inv1   g065(.a(x18), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x14), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n60_), .c(new_n111_), .O(new_n114_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n99_), .c(new_n105_), .O(new_n127_));
  ...
  oai21  g085(.a(new_n113_), .b(new_n70_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n89_), .O(new_n133_));
  nand3  g087(.a(new_n97_), .b(new_n50_), .c(new_n85_), .O(new_n134_));
  nand3  g088(.a(new_n67_), .b(new_n62_), .c(new_n105_), .O(new_n135_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n126_), .c(new_n106_), .d(new_n87_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n112_), .b(x15), .c(x14), .O(new_n153_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n106_), .d(new_n87_), .O(new_n158_));
  ...
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n85_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n51_), .d(new_n85_), .O(new_n165_));
