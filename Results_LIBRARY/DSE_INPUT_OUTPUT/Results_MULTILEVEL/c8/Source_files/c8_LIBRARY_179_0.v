...
module FAU ( 
  ...
  nand3  g48(.a(x18), .b(new_n87_), .c(x01), .O(new_n95_));
  ...
  oai21  g63(.a(new_n88_), .b(x04), .c(new_n87_), .O(new_n110_));
  ...
  aoi21  g68(.a(new_n111_), .b(new_n93_), .c(new_n72_), .O(new_n115_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n122_));
  ...
  oai21  g80(.a(new_n88_), .b(x07), .c(new_n87_), .O(new_n127_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n129_), .c(new_n72_), .O(new_n140_));
  nand3  g94(.a(new_n128_), .b(x19), .c(new_n82_), .O(new_n141_));
