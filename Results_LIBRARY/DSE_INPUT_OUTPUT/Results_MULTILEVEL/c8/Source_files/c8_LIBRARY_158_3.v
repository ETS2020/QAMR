// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:15 2020
...
module FAU ( 
  ...
  nand2  g037(.a(new_n58_), .b(new_n83_), .O(new_n84_));
  aoi21  g038(.a(new_n84_), .b(new_n82_), .c(new_n49_), .O(z07));
  nor2   g039(.a(new_n49_), .b(new_n58_), .O(z08));
  xnor2a g040(.a(x19), .b(x17), .O(new_n87_));
  nor2   g041(.a(x16), .b(new_n47_), .O(new_n88_));
  aoi21  g042(.a(new_n87_), .b(x16), .c(new_n88_), .O(new_n89_));
  inv1   g043(.a(x16), .O(new_n90_));
  nand3  g044(.a(x18), .b(new_n90_), .c(x00), .O(new_n91_));
  oai21  g045(.a(new_n89_), .b(x18), .c(new_n91_), .O(z09));
  nand2  g046(.a(x18), .b(x01), .O(new_n93_));
  oai21  g047(.a(x18), .b(new_n52_), .c(new_n93_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  ...
  oai21  g055(.a(new_n98_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n96_), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n95_), .O(z10));
  ...
  oai21  g064(.a(new_n108_), .b(new_n57_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n96_), .c(x16), .O(new_n112_));
  ...
  nand2  g069(.a(new_n115_), .b(new_n90_), .O(new_n116_));
  nand2  g070(.a(new_n110_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n98_), .c(new_n97_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n96_), .c(x16), .O(new_n121_));
  ...
  nand2  g078(.a(new_n124_), .b(new_n90_), .O(new_n125_));
  nand2  g079(.a(new_n119_), .b(x23), .O(new_n126_));
  nor3   g080(.a(x23), .b(x22), .c(x21), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n108_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n96_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  oai21  g085(.a(x16), .b(x05), .c(x18), .O(new_n132_));
  aoi21  g086(.a(new_n127_), .b(new_n108_), .c(new_n73_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n118_), .c(new_n100_), .d(new_n99_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nor2   g091(.a(x18), .b(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x13), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n137_), .c(new_n132_), .O(z14));
  oai21  g094(.a(x16), .b(x06), .c(x18), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n109_), .d(new_n98_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand2  g101(.a(new_n138_), .b(x14), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n147_), .c(new_n141_), .O(z15));
  oai21  g103(.a(x16), .b(x07), .c(x18), .O(new_n150_));
  nand2  g104(.a(new_n145_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n143_), .c(new_n109_), .d(new_n98_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand2  g109(.a(new_n138_), .b(x15), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(z16));
  nand4  g111(.a(new_n143_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n158_));
  nand3  g112(.a(new_n109_), .b(x19), .c(new_n99_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n58_), .d(new_n99_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n96_), .c(x16), .O(new_n161_));
