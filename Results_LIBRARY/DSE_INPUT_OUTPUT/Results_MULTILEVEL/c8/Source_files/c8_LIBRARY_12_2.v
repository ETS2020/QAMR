...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x00), .O(new_n53_));
  ...
  nand3  g047(.a(new_n52_), .b(x08), .c(new_n93_), .O(new_n94_));
  ...
  nor2   g057(.a(new_n103_), .b(new_n58_), .O(new_n104_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n53_), .O(z10));
  nand2  g063(.a(x18), .b(x02), .O(new_n110_));
  nand3  g064(.a(new_n52_), .b(x10), .c(new_n93_), .O(new_n111_));
  ...
  oai21  g069(.a(new_n107_), .b(new_n61_), .c(new_n115_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n53_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n113_), .O(z11));
  ...
  aoi21  g075(.a(new_n52_), .b(x00), .c(x22), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n61_), .c(new_n58_), .d(new_n47_), .O(new_n123_));
  ...
  aoi21  g094(.a(new_n133_), .b(new_n107_), .c(new_n76_), .O(new_n141_));
  nand4  g095(.a(new_n76_), .b(new_n73_), .c(new_n68_), .d(new_n61_), .O(new_n142_));
  ...
  nand2  g101(.a(new_n147_), .b(new_n92_), .O(new_n148_));
  nor2   g102(.a(x23), .b(x22), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n114_), .d(new_n103_), .O(new_n151_));
  oai21  g105(.a(new_n143_), .b(new_n83_), .c(new_n151_), .O(new_n152_));
  ...
  nand3  g109(.a(new_n52_), .b(x15), .c(new_n93_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n149_), .b(new_n86_), .c(new_n83_), .d(new_n76_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n115_), .c(new_n159_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n53_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n158_), .O(z16));
  nand3  g117(.a(new_n114_), .b(x19), .c(new_n105_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n160_), .c(new_n48_), .d(new_n105_), .O(new_n165_));
