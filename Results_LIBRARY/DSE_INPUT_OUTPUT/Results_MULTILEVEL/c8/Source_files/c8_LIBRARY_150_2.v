...
module FAU ( 
  ...
  nor2   g059(.a(new_n81_), .b(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(x02), .O(new_n107_));
  ...
  aoi21  g064(.a(new_n102_), .b(new_n94_), .c(new_n110_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n106_), .b(x03), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n115_), .c(new_n109_), .O(z12));
  oai21  g071(.a(x16), .b(x12), .c(new_n81_), .O(new_n118_));
  ...
  nand2  g077(.a(new_n106_), .b(x04), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n123_), .c(new_n118_), .O(z13));
  oai21  g079(.a(x16), .b(x13), .c(new_n81_), .O(new_n126_));
  aoi21  g080(.a(new_n120_), .b(new_n101_), .c(new_n71_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n112_), .c(new_n95_), .d(new_n83_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n106_), .b(x05), .O(new_n132_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n102_), .d(new_n94_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n106_), .b(x06), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n136_), .c(new_n102_), .d(new_n94_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n106_), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  nor2   g104(.a(x26), .b(x25), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n136_), .c(new_n71_), .O(new_n152_));
  nand3  g106(.a(new_n102_), .b(x19), .c(new_n83_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n58_), .d(new_n83_), .O(new_n154_));
