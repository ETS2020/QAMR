...
module FAU ( 
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n52_), .O(z05));
  ...
  oai21  g061(.a(new_n96_), .b(new_n56_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n94_), .c(x16), .O(new_n109_));
  ...
  nor3   g067(.a(x20), .b(x19), .c(x17), .O(new_n114_));
  nor2   g068(.a(x21), .b(x20), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n96_), .O(new_n116_));
  oai21  g070(.a(new_n114_), .b(new_n61_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n94_), .O(z11));
  ...
  aoi21  g076(.a(new_n115_), .b(new_n96_), .c(new_n66_), .O(new_n123_));
  nor2   g077(.a(x22), .b(x21), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n96_), .c(new_n56_), .O(new_n125_));
  inv1   g079(.a(new_n125_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n123_), .c(x16), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n94_), .O(z12));
  nand2  g082(.a(new_n90_), .b(new_n69_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n88_), .c(x04), .O(new_n130_));
  nand2  g084(.a(new_n125_), .b(x23), .O(new_n131_));
  nor3   g085(.a(x23), .b(x22), .c(x21), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n114_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n130_), .c(new_n94_), .O(z13));
  ...
  aoi21  g093(.a(new_n132_), .b(new_n114_), .c(new_n76_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n124_), .c(new_n106_), .d(new_n105_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n94_), .O(z14));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n96_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n148_), .c(new_n94_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  oai21  g110(.a(x18), .b(new_n84_), .c(new_n156_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n115_), .d(new_n96_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n94_), .O(z16));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n150_), .c(new_n76_), .O(new_n166_));
  nand3  g120(.a(new_n115_), .b(x19), .c(new_n105_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n50_), .d(new_n105_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n94_), .O(z17));
endmodule
