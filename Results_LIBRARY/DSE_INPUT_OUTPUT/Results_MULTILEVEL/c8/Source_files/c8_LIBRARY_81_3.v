...
module FAU ( 
  ...
  nand3  g005(.a(new_n51_), .b(new_n48_), .c(new_n50_), .O(new_n52_));
  nand2  g006(.a(new_n52_), .b(new_n49_), .O(z00));
  inv1   g007(.a(x09), .O(new_n54_));
  nand2  g008(.a(x18), .b(x08), .O(new_n55_));
  inv1   g009(.a(new_n55_), .O(new_n56_));
  aoi21  g010(.a(x27), .b(new_n54_), .c(new_n56_), .O(new_n57_));
  ...
  aoi21  g016(.a(new_n62_), .b(new_n60_), .c(new_n56_), .O(z02));
  inv1   g017(.a(x11), .O(new_n64_));
  aoi21  g018(.a(x27), .b(new_n64_), .c(new_n56_), .O(new_n65_));
  oai21  g019(.a(x27), .b(x22), .c(new_n65_), .O(z03));
  inv1   g020(.a(x12), .O(new_n67_));
  aoi21  g021(.a(x27), .b(new_n67_), .c(new_n56_), .O(new_n68_));
  oai21  g022(.a(x27), .b(x23), .c(new_n68_), .O(z04));
  inv1   g023(.a(x13), .O(new_n70_));
  aoi21  g024(.a(x27), .b(new_n70_), .c(new_n56_), .O(new_n71_));
  oai21  g025(.a(x27), .b(x24), .c(new_n71_), .O(z05));
  inv1   g026(.a(x14), .O(new_n73_));
  aoi21  g027(.a(x27), .b(new_n73_), .c(new_n56_), .O(new_n74_));
  ...
  aoi21  g033(.a(new_n79_), .b(new_n77_), .c(new_n56_), .O(z07));
  nor2   g034(.a(new_n56_), .b(new_n51_), .O(z08));
  inv1   g035(.a(x16), .O(new_n82_));
  inv1   g036(.a(x00), .O(new_n83_));
  nand2  g037(.a(x18), .b(new_n47_), .O(new_n84_));
  nand2  g038(.a(new_n50_), .b(x08), .O(new_n85_));
  ...
  nand3  g042(.a(new_n88_), .b(new_n55_), .c(x16), .O(new_n89_));
  nand2  g043(.a(new_n89_), .b(new_n87_), .O(z09));
  inv1   g044(.a(x01), .O(new_n91_));
  oai22  g045(.a(new_n84_), .b(new_n91_), .c(x18), .d(new_n54_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n82_), .O(new_n93_));
  ...
  nand2  g075(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n106_), .d(new_n95_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n55_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n132_), .O(new_n159_));
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n96_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n51_), .d(new_n96_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n55_), .c(x16), .O(new_n162_));
