...
module FAU ( 
  ...
  nor2   g053(.a(new_n99_), .b(new_n57_), .O(new_n100_));
  nor3   g054(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  oai21  g055(.a(new_n101_), .b(new_n100_), .c(x16), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(new_n52_), .O(z10));
  ...
  oai21  g062(.a(new_n101_), .b(new_n62_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x16), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n106_), .c(new_n52_), .O(z11));
  inv1   g065(.a(x03), .O(new_n112_));
  oai22  g066(.a(new_n90_), .b(new_n112_), .c(x18), .d(new_n65_), .O(new_n113_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n52_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z12));
  nor3   g074(.a(x23), .b(x22), .c(x21), .O(new_n121_));
  aoi22  g075(.a(new_n121_), .b(new_n101_), .c(new_n117_), .d(x23), .O(new_n122_));
  nor2   g076(.a(x18), .b(x16), .O(new_n123_));
  aoi21  g077(.a(new_n123_), .b(x12), .c(new_n53_), .O(new_n124_));
  oai21  g078(.a(new_n122_), .b(new_n87_), .c(new_n124_), .O(z13));
  ...
  aoi21  g082(.a(new_n121_), .b(new_n101_), .c(new_n75_), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n116_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  ...
  oai22  g091(.a(new_n137_), .b(x04), .c(x18), .d(new_n78_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n107_), .d(new_n99_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n147_), .b(x04), .c(x18), .d(new_n81_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n87_), .O(new_n149_));
  nand2  g103(.a(new_n143_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n107_), .d(new_n99_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n52_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n75_), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x19), .c(new_n130_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n50_), .d(new_n130_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n52_), .O(z17));
endmodule
