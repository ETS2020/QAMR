...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x17), .O(new_n48_));
  ...
  nand3  g037(.a(new_n83_), .b(x18), .c(new_n82_), .O(new_n84_));
  oai21  g038(.a(new_n83_), .b(new_n82_), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g043(.a(new_n89_), .b(x17), .O(new_n90_));
  oai21  g044(.a(new_n90_), .b(new_n47_), .c(new_n88_), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n86_), .O(z09));
  nand2  g047(.a(x18), .b(x01), .O(new_n94_));
  oai21  g048(.a(x18), .b(new_n51_), .c(new_n94_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  nor2   g050(.a(x20), .b(x19), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x18), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n82_), .O(new_n100_));
  ...
  oai21  g059(.a(x18), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  ...
  nand2  g063(.a(new_n109_), .b(x18), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n82_), .O(new_n111_));
  nand3  g065(.a(new_n97_), .b(x18), .c(new_n82_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(x21), .c(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n111_), .c(new_n107_), .O(z11));
  nand2  g068(.a(x18), .b(x03), .O(new_n115_));
  oai21  g069(.a(new_n90_), .b(new_n60_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n87_), .O(new_n117_));
  nand2  g071(.a(new_n108_), .b(new_n83_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n101_), .c(new_n53_), .O(new_n121_));
  aoi21  g075(.a(new_n121_), .b(new_n119_), .c(new_n89_), .O(new_n122_));
  ...
  oai21  g080(.a(new_n90_), .b(new_n63_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n87_), .O(new_n128_));
  nand2  g082(.a(new_n120_), .b(new_n97_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x23), .O(new_n130_));
  inv1   g084(.a(x21), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n97_), .c(new_n131_), .d(new_n82_), .O(new_n133_));
  aoi21  g087(.a(new_n133_), .b(new_n130_), .c(new_n89_), .O(new_n134_));
  nor2   g088(.a(new_n65_), .b(new_n82_), .O(new_n135_));
  ...
  oai21  g092(.a(new_n90_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n87_), .O(new_n140_));
  nand3  g094(.a(new_n132_), .b(new_n97_), .c(new_n131_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x24), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n97_), .d(new_n82_), .O(new_n144_));
  aoi21  g098(.a(new_n144_), .b(new_n142_), .c(new_n89_), .O(new_n145_));
  nor2   g099(.a(new_n70_), .b(new_n82_), .O(new_n146_));
  ...
  oai21  g103(.a(x18), .b(new_n73_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n87_), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n132_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n109_), .c(x18), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n82_), .O(new_n155_));
  inv1   g109(.a(new_n112_), .O(new_n156_));
  nand3  g110(.a(new_n143_), .b(new_n120_), .c(new_n156_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(x25), .c(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n155_), .c(new_n151_), .O(z15));
  nand2  g113(.a(x18), .b(x07), .O(new_n160_));
  oai21  g114(.a(new_n90_), .b(new_n78_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n87_), .O(new_n162_));
  nand4  g116(.a(new_n152_), .b(new_n132_), .c(new_n108_), .d(new_n83_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x26), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n132_), .c(new_n108_), .d(new_n101_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n164_), .c(new_n89_), .O(new_n167_));
  and2   g121(.a(x26), .b(x17), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n167_), .c(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n162_), .O(z16));
  inv1   g124(.a(new_n48_), .O(new_n171_));
  nand2  g125(.a(new_n165_), .b(new_n132_), .O(new_n172_));
  nand3  g126(.a(new_n108_), .b(x19), .c(new_n82_), .O(new_n173_));
  oai22  g127(.a(new_n173_), .b(new_n172_), .c(new_n54_), .d(new_n82_), .O(new_n174_));
