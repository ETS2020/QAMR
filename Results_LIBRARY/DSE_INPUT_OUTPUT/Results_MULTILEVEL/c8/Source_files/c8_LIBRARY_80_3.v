...
module FAU ( 
  ...
  oai21  g060(.a(new_n96_), .b(new_n62_), .c(new_n106_), .O(new_n107_));
  ...
  aoi21  g065(.a(new_n105_), .b(new_n94_), .c(new_n111_), .O(new_n112_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n116_), .c(new_n110_), .O(z12));
  ...
  nand2  g078(.a(new_n98_), .b(x12), .O(new_n125_));
  ...
  nand3  g084(.a(new_n70_), .b(new_n111_), .c(new_n62_), .O(new_n131_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n104_), .c(x16), .O(new_n137_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n121_), .c(new_n105_), .d(new_n94_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n98_), .b(x14), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n121_), .c(new_n105_), .d(new_n94_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n104_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  inv1   g109(.a(x24), .O(new_n156_));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n121_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n87_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n87_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n104_), .c(x16), .O(new_n161_));
