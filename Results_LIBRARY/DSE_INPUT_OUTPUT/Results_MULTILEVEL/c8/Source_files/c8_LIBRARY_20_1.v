...
module FAU ( 
  ...
  inv1   g027(.a(new_n48_), .O(new_n74_));
  inv1   g028(.a(x14), .O(new_n75_));
  oai21  g029(.a(x27), .b(new_n47_), .c(new_n75_), .O(new_n76_));
  nand2  g030(.a(new_n52_), .b(new_n47_), .O(new_n77_));
  nand3  g031(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(z06));
  ...
  nor2   g036(.a(x25), .b(x18), .O(new_n83_));
  ...
  nand3  g042(.a(new_n88_), .b(new_n74_), .c(x16), .O(new_n89_));
  oai21  g043(.a(new_n84_), .b(x16), .c(new_n89_), .O(z09));
  aoi22  g044(.a(new_n83_), .b(x09), .c(x18), .d(x01), .O(new_n91_));
  inv1   g045(.a(x20), .O(new_n92_));
  inv1   g046(.a(x17), .O(new_n93_));
  nand3  g047(.a(new_n92_), .b(new_n51_), .c(new_n93_), .O(new_n94_));
  oai21  g048(.a(new_n86_), .b(new_n92_), .c(new_n94_), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n74_), .c(x16), .O(new_n96_));
  ...
  oai21  g058(.a(new_n102_), .b(new_n60_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n74_), .O(z11));
  nand2  g061(.a(x18), .b(x03), .O(new_n108_));
  oai21  g062(.a(x18), .b(new_n63_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n98_), .O(new_n110_));
  aoi21  g064(.a(new_n103_), .b(new_n86_), .c(new_n65_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n86_), .c(new_n92_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n74_), .O(z12));
  inv1   g070(.a(new_n83_), .O(new_n117_));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  oai21  g072(.a(new_n117_), .b(new_n68_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n98_), .O(new_n120_));
  nand2  g074(.a(new_n113_), .b(x23), .O(new_n121_));
  nor2   g075(.a(x23), .b(x22), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n102_), .c(new_n60_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n74_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n120_), .O(z13));
  nand2  g080(.a(x18), .b(x05), .O(new_n127_));
  oai21  g081(.a(new_n117_), .b(new_n71_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n98_), .O(new_n129_));
  inv1   g083(.a(x23), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n65_), .c(new_n60_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n94_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n112_), .c(new_n133_), .d(new_n93_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n74_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n129_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  oai21  g093(.a(new_n117_), .b(new_n75_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n98_), .O(new_n141_));
  nand3  g095(.a(new_n135_), .b(x25), .c(x18), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n122_), .c(new_n103_), .d(new_n86_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n98_), .O(new_n150_));
  inv1   g104(.a(x26), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n98_), .c(x18), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x25), .O(new_n153_));
  nand2  g107(.a(new_n135_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n122_), .c(new_n103_), .d(new_n86_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n150_), .O(z16));
  inv1   g113(.a(x24), .O(new_n160_));
  nand4  g114(.a(new_n122_), .b(new_n151_), .c(new_n47_), .d(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n103_), .b(x19), .c(new_n93_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n93_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n74_), .O(z17));
endmodule
