// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:47 2020
...
module FAU ( 
  ...
  nand2  g036(.a(new_n82_), .b(new_n58_), .O(z08));
  ...
  inv1   g054(.a(new_n87_), .O(new_n101_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n85_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n48_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  nor2   g064(.a(x18), .b(x17), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n97_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(x21), .c(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n110_), .c(new_n106_), .O(z11));
  ...
  nor3   g071(.a(x22), .b(x21), .c(x20), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n85_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n48_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n84_), .O(new_n121_));
  nand3  g075(.a(new_n111_), .b(new_n107_), .c(new_n85_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(x22), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n121_), .c(new_n117_), .O(z12));
  ...
  nand2  g082(.a(new_n128_), .b(new_n57_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n98_), .c(new_n48_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n84_), .O(new_n131_));
  nand4  g085(.a(new_n118_), .b(new_n85_), .c(new_n48_), .d(new_n84_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(x23), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n131_), .c(new_n127_), .O(z13));
  inv1   g088(.a(x05), .O(new_n135_));
  nand2  g089(.a(x18), .b(x17), .O(new_n136_));
  oai22  g090(.a(new_n136_), .b(new_n135_), .c(x18), .d(new_n69_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n89_), .O(new_n138_));
  nand3  g092(.a(new_n128_), .b(new_n97_), .c(new_n57_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x24), .O(new_n140_));
  nor2   g094(.a(x22), .b(x21), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n97_), .d(new_n84_), .O(new_n143_));
  ...
  oai21  g102(.a(x18), .b(new_n72_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n89_), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n128_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n108_), .c(new_n48_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n84_), .O(new_n154_));
  nand4  g108(.a(new_n142_), .b(new_n141_), .c(new_n111_), .d(new_n97_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(x25), .c(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n154_), .c(new_n150_), .O(z15));
  inv1   g111(.a(x07), .O(new_n158_));
  oai22  g112(.a(new_n136_), .b(new_n158_), .c(x18), .d(new_n77_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n89_), .O(new_n160_));
  nand4  g114(.a(new_n151_), .b(new_n128_), .c(new_n107_), .d(new_n85_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x26), .O(new_n162_));
  nor3   g116(.a(x26), .b(x25), .c(x24), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n128_), .c(new_n107_), .d(new_n87_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(x18), .O(new_n165_));
  nor2   g119(.a(new_n79_), .b(new_n84_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n165_), .c(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n160_), .O(z16));
  nand2  g122(.a(new_n107_), .b(x19), .O(new_n169_));
  inv1   g123(.a(new_n169_), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n163_), .c(new_n128_), .d(new_n111_), .O(new_n171_));
  nand2  g125(.a(x27), .b(x17), .O(new_n172_));
  aoi21  g126(.a(new_n172_), .b(new_n171_), .c(new_n89_), .O(z17));
endmodule
