...
module FAU ( 
  ...
  oai21  g023(.a(x27), .b(new_n69_), .c(new_n47_), .O(new_n70_));
  nand3  g024(.a(new_n52_), .b(new_n69_), .c(x18), .O(new_n71_));
  ...
  oai21  g074(.a(new_n111_), .b(new_n64_), .c(new_n120_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n95_), .b(new_n51_), .c(new_n83_), .O(new_n129_));
  inv1   g083(.a(x22), .O(new_n130_));
  nand3  g084(.a(new_n66_), .b(new_n130_), .c(new_n103_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n129_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n115_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n81_), .c(x16), .O(new_n137_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n124_), .c(new_n104_), .d(new_n85_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n110_), .b(x15), .c(new_n47_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n104_), .d(new_n85_), .O(new_n155_));
