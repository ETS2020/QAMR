...
module FAU ( 
  ...
  oai22  g066(.a(new_n89_), .b(new_n112_), .c(x18), .d(new_n65_), .O(new_n113_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n92_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z12));
  oai21  g074(.a(x18), .b(x12), .c(new_n87_), .O(new_n121_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n92_), .O(z13));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n101_), .c(new_n75_), .O(new_n131_));
  inv1   g085(.a(x17), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n131_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n130_), .c(new_n92_), .O(z14));
  nand3  g092(.a(x18), .b(x06), .c(x04), .O(new_n139_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n92_), .c(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n141_), .O(z15));
  nand3  g102(.a(x18), .b(x07), .c(x04), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n107_), .d(new_n99_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n92_), .c(x16), .O(new_n156_));
