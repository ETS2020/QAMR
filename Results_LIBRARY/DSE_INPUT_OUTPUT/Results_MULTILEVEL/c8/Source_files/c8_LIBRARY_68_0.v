...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_,
    ...
    new_n172_;
  nor2   g000(.a(x23), .b(x18), .O(new_n47_));
  ...
  inv1   g018(.a(new_n47_), .O(new_n65_));
  nand2  g019(.a(new_n65_), .b(x27), .O(new_n66_));
  inv1   g020(.a(x23), .O(new_n67_));
  nand3  g021(.a(new_n51_), .b(new_n67_), .c(x18), .O(new_n68_));
  oai21  g022(.a(new_n66_), .b(x12), .c(new_n68_), .O(z04));
  inv1   g023(.a(x24), .O(new_n70_));
  inv1   g024(.a(x18), .O(new_n71_));
  nand2  g025(.a(new_n67_), .b(new_n71_), .O(new_n72_));
  nand3  g026(.a(new_n72_), .b(new_n51_), .c(new_n70_), .O(new_n73_));
  oai21  g027(.a(new_n66_), .b(x13), .c(new_n73_), .O(z05));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n65_), .O(z09));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  nand2  g049(.a(x23), .b(new_n71_), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n54_), .c(new_n95_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n90_), .O(new_n98_));
  inv1   g052(.a(x20), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n50_), .c(new_n86_), .O(new_n100_));
  oai21  g054(.a(new_n88_), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n65_), .c(x16), .O(new_n102_));
  ...
  inv1   g061(.a(new_n100_), .O(new_n108_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n65_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n106_), .O(z11));
  nand2  g067(.a(x18), .b(x03), .O(new_n114_));
  oai21  g068(.a(new_n96_), .b(new_n60_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n90_), .O(new_n116_));
  nand2  g070(.a(new_n110_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n88_), .c(new_n99_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n65_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n116_), .O(z12));
  inv1   g076(.a(x12), .O(new_n123_));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  oai21  g078(.a(new_n96_), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n90_), .O(new_n126_));
  and2   g080(.a(new_n119_), .b(x23), .O(new_n127_));
  nand3  g081(.a(new_n50_), .b(x18), .c(new_n86_), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n109_), .O(new_n130_));
  ...
  oai21  g091(.a(new_n70_), .b(new_n90_), .c(x23), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n71_), .O(new_n139_));
  nor3   g093(.a(x23), .b(x22), .c(x21), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(new_n108_), .c(new_n70_), .O(new_n141_));
  nand3  g095(.a(new_n118_), .b(new_n70_), .c(new_n67_), .O(new_n142_));
  nor2   g096(.a(new_n142_), .b(new_n100_), .O(new_n143_));
  ...
  oai21  g100(.a(new_n96_), .b(new_n75_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n90_), .O(new_n148_));
  nand3  g102(.a(new_n70_), .b(new_n62_), .c(new_n107_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n100_), .c(x25), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n129_), .c(new_n109_), .d(new_n88_), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n150_), .c(new_n71_), .O(new_n153_));
  nor2   g107(.a(new_n77_), .b(new_n67_), .O(new_n154_));
  ...
  oai21  g111(.a(new_n96_), .b(new_n80_), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n90_), .O(new_n159_));
  nor2   g113(.a(x20), .b(x19), .O(new_n160_));
  nand4  g114(.a(new_n151_), .b(new_n118_), .c(new_n160_), .d(new_n86_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x26), .O(new_n162_));
  nor3   g116(.a(x26), .b(x25), .c(x24), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n129_), .c(new_n109_), .d(new_n88_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(new_n71_), .O(new_n165_));
  nor2   g119(.a(new_n82_), .b(new_n67_), .O(new_n166_));
  ...
  nand3  g123(.a(new_n109_), .b(x19), .c(new_n86_), .O(new_n170_));
  oai22  g124(.a(new_n170_), .b(new_n169_), .c(new_n51_), .d(new_n86_), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(x16), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(new_n65_), .O(z17));
endmodule
