...
module FAU ( 
  ...
  nor2   g46(.a(new_n87_), .b(new_n57_), .O(new_n93_));
  ...
  oai21  g50(.a(x18), .b(x10), .c(new_n89_), .O(new_n97_));
  ...
  oai21  g57(.a(new_n103_), .b(new_n89_), .c(new_n97_), .O(z11));
  ...
  nand2  g90(.a(new_n107_), .b(x15), .O(new_n137_));
