...
module FAU ( 
  ...
  nand3  g074(.a(new_n120_), .b(new_n96_), .c(new_n62_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(new_n98_), .b(x04), .O(new_n124_));
  ...
  nand3  g083(.a(new_n70_), .b(new_n110_), .c(new_n62_), .O(new_n130_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n104_), .d(new_n94_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n98_), .b(x06), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n104_), .d(new_n94_), .O(new_n151_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n120_), .c(new_n155_), .O(new_n157_));
