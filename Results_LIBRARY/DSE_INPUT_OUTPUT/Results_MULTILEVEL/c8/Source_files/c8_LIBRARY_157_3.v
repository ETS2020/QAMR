...
module FAU ( 
  ...
  nand3  g036(.a(new_n52_), .b(new_n80_), .c(new_n82_), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n81_), .O(z07));
  ...
  nor2   g051(.a(new_n88_), .b(new_n57_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n97_), .c(new_n47_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n47_), .O(z11));
  inv1   g064(.a(x03), .O(new_n111_));
  nand2  g065(.a(x18), .b(new_n79_), .O(new_n112_));
  ...
  oai22  g075(.a(new_n112_), .b(new_n121_), .c(x18), .d(new_n68_), .O(new_n122_));
  ...
  oai22  g084(.a(new_n112_), .b(new_n130_), .c(x18), .d(new_n71_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n90_), .O(new_n132_));
  nand3  g086(.a(new_n57_), .b(new_n51_), .c(new_n86_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n65_), .c(new_n105_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n133_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n137_), .d(new_n86_), .O(new_n139_));
  ...
  oai22  g097(.a(new_n112_), .b(new_n143_), .c(x18), .d(new_n76_), .O(new_n144_));
  ...
  nand2  g106(.a(new_n82_), .b(x15), .O(new_n153_));
  oai21  g107(.a(new_n112_), .b(new_n152_), .c(new_n153_), .O(new_n154_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n125_), .c(new_n73_), .O(new_n163_));
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n86_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n86_), .O(new_n165_));
