...
module FAU ( 
  ...
  aoi21  g024(.a(x27), .b(x18), .c(new_n70_), .O(new_n71_));
  ...
  aoi22  g060(.a(new_n106_), .b(x10), .c(x18), .d(x02), .O(new_n107_));
  nor2   g061(.a(x21), .b(x20), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n92_), .O(new_n109_));
  oai21  g063(.a(new_n103_), .b(new_n60_), .c(new_n109_), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n53_), .c(x16), .O(new_n111_));
  oai21  g065(.a(new_n107_), .b(x16), .c(new_n111_), .O(z11));
  aoi22  g066(.a(new_n106_), .b(x11), .c(x18), .d(x03), .O(new_n113_));
  nand2  g067(.a(new_n109_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n92_), .c(new_n55_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n53_), .c(x16), .O(new_n118_));
  oai21  g072(.a(new_n113_), .b(x16), .c(new_n118_), .O(z12));
  aoi22  g073(.a(new_n106_), .b(x12), .c(x18), .d(x04), .O(new_n120_));
  nand3  g074(.a(new_n116_), .b(x23), .c(x18), .O(new_n121_));
  ...
  oai21  g081(.a(x18), .b(new_n74_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n94_), .O(new_n129_));
  oai21  g083(.a(new_n76_), .b(new_n94_), .c(x18), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x23), .O(new_n131_));
  nand2  g085(.a(new_n116_), .b(x24), .O(new_n132_));
  nand4  g086(.a(new_n115_), .b(new_n103_), .c(new_n76_), .d(new_n70_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n131_), .c(new_n129_), .O(z14));
  ...
  oai21  g093(.a(new_n81_), .b(new_n94_), .c(x18), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x23), .O(new_n141_));
  nor3   g095(.a(x24), .b(x22), .c(x21), .O(new_n142_));
  aoi21  g096(.a(new_n142_), .b(new_n103_), .c(new_n81_), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n122_), .O(new_n145_));
  nor2   g099(.a(new_n145_), .b(new_n109_), .O(new_n146_));
  ...
  nand2  g103(.a(new_n106_), .b(x15), .O(new_n150_));
  ...
  nand4  g107(.a(new_n144_), .b(new_n115_), .c(new_n153_), .d(new_n90_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x26), .O(new_n155_));
  nor2   g109(.a(x24), .b(x22), .O(new_n156_));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n156_), .c(new_n108_), .d(new_n92_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n155_), .c(x23), .O(new_n159_));
  nand3  g113(.a(x26), .b(x23), .c(x18), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n159_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n152_), .O(z16));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n90_), .O(new_n164_));
  nand3  g118(.a(new_n157_), .b(new_n122_), .c(new_n76_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n48_), .d(new_n90_), .O(new_n166_));
