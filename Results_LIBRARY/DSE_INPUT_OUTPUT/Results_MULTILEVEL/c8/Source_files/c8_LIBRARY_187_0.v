...
module FAU ( 
  ...
  nand4  g49(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n80_), .O(new_n96_));
  ...
  oai21  g53(.a(new_n85_), .b(x03), .c(new_n84_), .O(new_n100_));
  nand2  g54(.a(new_n96_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n82_), .c(new_n56_), .O(new_n103_));
  ...
  aoi22  g60(.a(new_n106_), .b(new_n90_), .c(new_n103_), .d(x23), .O(new_n107_));
  nor2   g61(.a(new_n85_), .b(x16), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(x04), .O(new_n109_));
  oai21  g63(.a(new_n107_), .b(new_n84_), .c(new_n109_), .O(z13));
  inv1   g64(.a(x24), .O(new_n111_));
  aoi21  g65(.a(new_n106_), .b(new_n90_), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n94_), .d(new_n80_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n108_), .b(x05), .O(new_n117_));
  ...
  nand2  g78(.a(new_n108_), .b(x06), .O(new_n125_));
