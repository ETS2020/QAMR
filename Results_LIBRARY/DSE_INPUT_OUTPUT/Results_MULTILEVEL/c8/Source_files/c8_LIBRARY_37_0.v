...
module FAU ( 
  ...
  oai21  g009(.a(new_n51_), .b(new_n54_), .c(new_n55_), .O(new_n56_));
  oai21  g010(.a(new_n51_), .b(x09), .c(new_n56_), .O(z01));
  inv1   g011(.a(x10), .O(new_n58_));
  aoi21  g012(.a(x27), .b(new_n58_), .c(new_n47_), .O(new_n59_));
  oai21  g013(.a(x27), .b(x21), .c(new_n59_), .O(z02));
  inv1   g014(.a(x11), .O(new_n61_));
  aoi21  g015(.a(x27), .b(new_n61_), .c(new_n47_), .O(new_n62_));
  ...
  aoi21  g024(.a(new_n70_), .b(new_n68_), .c(new_n47_), .O(z05));
  ...
  oai21  g046(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n86_), .O(new_n94_));
  nor2   g048(.a(new_n84_), .b(new_n55_), .O(new_n95_));
  nand3  g049(.a(new_n55_), .b(new_n50_), .c(new_n82_), .O(new_n96_));
  ...
  oai21  g057(.a(new_n103_), .b(new_n86_), .c(x20), .O(new_n104_));
  ...
  oai21  g061(.a(new_n97_), .b(new_n103_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n105_), .c(new_n102_), .O(z11));
  ...
  oai21  g068(.a(new_n114_), .b(new_n86_), .c(x20), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n54_), .O(new_n116_));
  aoi21  g070(.a(new_n106_), .b(new_n84_), .c(new_n114_), .O(new_n117_));
  nand4  g071(.a(new_n84_), .b(new_n114_), .c(new_n103_), .d(new_n55_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n117_), .c(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n116_), .c(new_n113_), .O(z12));
  ...
  oai21  g079(.a(new_n125_), .b(new_n86_), .c(x20), .O(new_n126_));
  ...
  oai21  g083(.a(new_n119_), .b(new_n125_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n127_), .c(new_n124_), .O(z13));
  ...
  oai21  g089(.a(new_n69_), .b(new_n86_), .c(x20), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  aoi21  g091(.a(new_n128_), .b(new_n97_), .c(new_n69_), .O(new_n138_));
  nand2  g092(.a(new_n114_), .b(new_n103_), .O(new_n139_));
  nand2  g093(.a(new_n69_), .b(new_n125_), .O(new_n140_));
  nor3   g094(.a(new_n140_), .b(new_n139_), .c(new_n96_), .O(new_n141_));
  ...
  nand3  g098(.a(x20), .b(new_n54_), .c(x14), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n86_), .O(new_n147_));
  nand3  g101(.a(new_n103_), .b(new_n50_), .c(new_n82_), .O(new_n148_));
  nand3  g102(.a(new_n69_), .b(new_n125_), .c(new_n114_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n148_), .c(x25), .O(new_n150_));
  nor2   g104(.a(x23), .b(x22), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n151_), .c(new_n106_), .d(new_n84_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n150_), .c(new_n54_), .O(new_n154_));
  nor2   g108(.a(new_n74_), .b(new_n55_), .O(new_n155_));
  ...
  nand2  g114(.a(x26), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x20), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n54_), .O(new_n163_));
  nand2  g117(.a(new_n153_), .b(x26), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n151_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n107_), .c(new_n164_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x16), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n163_), .c(new_n160_), .O(z16));
  nand2  g123(.a(z08), .b(x17), .O(new_n170_));
  nand4  g124(.a(new_n106_), .b(x19), .c(x18), .d(new_n82_), .O(new_n171_));
  or2    g125(.a(new_n171_), .b(new_n166_), .O(new_n172_));
  aoi21  g126(.a(new_n172_), .b(new_n170_), .c(new_n86_), .O(z17));
endmodule
