...
module FAU ( 
  ...
  oai21  g56(.a(new_n85_), .b(x03), .c(new_n89_), .O(new_n103_));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n83_), .c(new_n91_), .O(new_n106_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n129_), .c(new_n113_), .O(new_n140_));
