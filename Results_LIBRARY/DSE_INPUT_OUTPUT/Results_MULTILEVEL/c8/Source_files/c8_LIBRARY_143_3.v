...
module FAU ( 
  ...
  nor2   g036(.a(new_n51_), .b(new_n82_), .O(new_n83_));
  nor2   g037(.a(x19), .b(x17), .O(new_n84_));
  oai21  g038(.a(new_n84_), .b(new_n83_), .c(x16), .O(new_n85_));
  nor2   g039(.a(x18), .b(x16), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(x08), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(z09));
  ...
  nand3  g048(.a(new_n94_), .b(new_n51_), .c(new_n82_), .O(new_n95_));
  oai21  g049(.a(new_n84_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n93_), .c(x16), .O(new_n97_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n101_), .c(new_n100_), .O(new_n119_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n63_), .c(new_n100_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n95_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n110_), .c(new_n130_), .d(new_n82_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n93_), .c(x16), .O(new_n134_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n102_), .d(new_n84_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n93_), .c(x16), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n118_), .c(new_n102_), .d(new_n84_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n86_), .b(x15), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nand2  g106(.a(new_n127_), .b(new_n63_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n82_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n52_), .b(new_n82_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n93_), .c(new_n89_), .O(z17));
endmodule
