...
module FAU ( 
  ...
  nand3  g054(.a(x18), .b(new_n100_), .c(x02), .O(new_n101_));
  ...
  nand4  g058(.a(new_n104_), .b(new_n95_), .c(new_n49_), .d(new_n83_), .O(new_n105_));
  oai21  g059(.a(new_n97_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g065(.a(x18), .b(x04), .c(x22), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n104_), .c(new_n95_), .d(new_n49_), .O(new_n113_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n85_), .c(new_n95_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x23), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n97_), .c(new_n104_), .O(new_n122_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n87_), .c(x12), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai22  g082(.a(new_n128_), .b(x04), .c(x18), .d(new_n67_), .O(new_n129_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n132_), .c(new_n104_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n118_), .c(new_n136_), .d(new_n83_), .O(new_n138_));
  ...
  oai22  g096(.a(new_n142_), .b(x04), .c(x18), .d(new_n72_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n121_), .c(new_n146_), .d(new_n85_), .O(new_n148_));
  ...
  oai22  g106(.a(new_n152_), .b(x04), .c(x18), .d(new_n77_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n121_), .c(new_n146_), .d(new_n85_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n121_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n161_));
  nand3  g115(.a(new_n146_), .b(x19), .c(new_n83_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n50_), .d(new_n83_), .O(new_n163_));
