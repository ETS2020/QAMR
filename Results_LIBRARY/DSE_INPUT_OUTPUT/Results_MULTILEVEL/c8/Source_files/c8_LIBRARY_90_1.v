...
module FAU ( 
  ...
  nor2   g35(.a(new_n49_), .b(new_n55_), .O(z08));
  ...
  nor2   g45(.a(new_n86_), .b(new_n54_), .O(new_n92_));
  ...
  nand3  g65(.a(new_n48_), .b(new_n88_), .c(x12), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n88_), .c(new_n112_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n88_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n110_), .b(new_n93_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n97_), .d(new_n83_), .O(new_n118_));
  ...
  oai21  g75(.a(x18), .b(x14), .c(new_n88_), .O(new_n122_));
  inv1   g76(.a(x23), .O(new_n123_));
  nand4  g77(.a(new_n74_), .b(new_n115_), .c(new_n123_), .d(new_n63_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n88_), .c(new_n122_), .O(z15));
  oai21  g81(.a(x18), .b(x15), .c(new_n88_), .O(new_n128_));
  ...
  nand4  g93(.a(new_n130_), .b(new_n79_), .c(new_n74_), .d(new_n115_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n83_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n55_), .d(new_n83_), .O(new_n142_));
