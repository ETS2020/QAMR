...
module FAU ( 
  ...
  nand3  g038(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z09));
  ...
  nand2  g067(.a(new_n113_), .b(new_n101_), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n105_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z13));
  oai21  g074(.a(x16), .b(x05), .c(x18), .O(new_n121_));
  aoi21  g075(.a(new_n116_), .b(new_n89_), .c(new_n69_), .O(new_n122_));
