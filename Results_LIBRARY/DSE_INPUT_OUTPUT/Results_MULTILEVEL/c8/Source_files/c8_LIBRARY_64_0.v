...
module FAU ( 
  ...
  nand2  g029(.a(new_n51_), .b(x26), .O(new_n76_));
  nand2  g030(.a(new_n76_), .b(x18), .O(new_n77_));
  inv1   g031(.a(x26), .O(new_n78_));
  nand3  g032(.a(new_n51_), .b(new_n78_), .c(x15), .O(new_n79_));
  oai21  g033(.a(new_n77_), .b(x15), .c(new_n79_), .O(z07));
  ...
  nand2  g039(.a(new_n85_), .b(x15), .O(new_n86_));
  ...
  oai21  g054(.a(new_n86_), .b(new_n59_), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g072(.a(new_n86_), .b(new_n65_), .c(new_n118_), .O(new_n119_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n129_), .c(new_n81_), .O(z14));
  ...
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n81_), .O(z15));
  oai21  g102(.a(new_n85_), .b(x07), .c(new_n83_), .O(new_n149_));
  nand2  g103(.a(new_n145_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n143_), .c(new_n104_), .d(new_n95_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n149_), .c(new_n81_), .O(z16));
  nand4  g109(.a(new_n143_), .b(new_n78_), .c(new_n73_), .d(new_n130_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n132_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n51_), .d(new_n132_), .O(new_n158_));
