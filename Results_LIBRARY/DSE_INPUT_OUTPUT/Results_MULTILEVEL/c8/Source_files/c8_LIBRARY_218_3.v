...
module FAU ( 
  ...
  nand3  g055(.a(new_n101_), .b(new_n96_), .c(x16), .O(new_n102_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n97_), .c(new_n57_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n96_), .c(x16), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n115_), .O(z12));
  oai21  g075(.a(x16), .b(x04), .c(x18), .O(new_n122_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n106_), .d(new_n97_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n110_), .b(x14), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n106_), .d(new_n97_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n96_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n140_), .c(new_n77_), .O(new_n157_));
  nand3  g111(.a(new_n106_), .b(x19), .c(new_n98_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n98_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n96_), .c(x16), .O(new_n160_));
