...
module FAU ( 
  ...
  aoi21  g64(.a(new_n107_), .b(new_n92_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g69(.a(new_n47_), .b(new_n87_), .c(x13), .O(new_n116_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n110_), .c(new_n68_), .d(new_n119_), .O(new_n121_));
