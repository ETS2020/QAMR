...
module FAU ( 
  ...
  nand3  g059(.a(new_n56_), .b(new_n49_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g069(.a(new_n107_), .b(new_n63_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g076(.a(new_n122_), .b(new_n63_), .c(new_n56_), .d(new_n49_), .O(new_n123_));
  ...
  nand4  g084(.a(new_n103_), .b(new_n68_), .c(new_n63_), .d(new_n56_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n63_), .O(new_n142_));
  ...
  nand4  g112(.a(new_n149_), .b(new_n88_), .c(new_n81_), .d(new_n76_), .O(new_n159_));
  ...
  nand3  g116(.a(new_n114_), .b(x19), .c(new_n105_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n50_), .d(new_n105_), .O(new_n164_));
