...
module FAU ( 
  ...
  nor2   g031(.a(new_n52_), .b(new_n58_), .O(z08));
  nand3  g032(.a(x19), .b(new_n47_), .c(x17), .O(new_n79_));
  oai21  g033(.a(x19), .b(x17), .c(new_n79_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(x16), .O(new_n81_));
  inv1   g035(.a(x16), .O(new_n82_));
  inv1   g036(.a(x00), .O(new_n83_));
  nand2  g037(.a(new_n47_), .b(x08), .O(new_n84_));
  ...
  oai22  g043(.a(new_n85_), .b(new_n89_), .c(x18), .d(new_n51_), .O(new_n90_));
  ...
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(new_n48_), .O(new_n96_));
  nand3  g050(.a(x20), .b(x19), .c(new_n47_), .O(new_n97_));
  ...
  oai22  g055(.a(new_n85_), .b(new_n101_), .c(x18), .d(new_n55_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n82_), .O(new_n103_));
  inv1   g057(.a(new_n95_), .O(new_n104_));
  nor3   g058(.a(x21), .b(x20), .c(x17), .O(new_n105_));
  aoi21  g059(.a(new_n104_), .b(x21), .c(new_n105_), .O(new_n106_));
  nor2   g060(.a(new_n106_), .b(x19), .O(new_n107_));
  nor3   g061(.a(new_n57_), .b(new_n48_), .c(x18), .O(new_n108_));
  ...
  oai21  g070(.a(new_n105_), .b(new_n114_), .c(new_n116_), .O(new_n117_));
  nor3   g071(.a(new_n114_), .b(new_n48_), .c(x18), .O(new_n118_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n95_), .c(new_n57_), .O(new_n126_));
  aoi21  g080(.a(new_n126_), .b(new_n124_), .c(x19), .O(new_n127_));
  nor3   g081(.a(new_n66_), .b(new_n48_), .c(x18), .O(new_n128_));
  ...
  oai21  g088(.a(new_n134_), .b(new_n82_), .c(new_n47_), .O(new_n135_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n115_), .d(new_n92_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n136_), .c(new_n133_), .O(z14));
  ...
  oai21  g101(.a(new_n147_), .b(new_n82_), .c(new_n47_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x19), .O(new_n149_));
  nor3   g103(.a(x24), .b(x23), .c(x22), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n105_), .c(new_n147_), .O(new_n151_));
  nor2   g105(.a(x21), .b(x20), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n48_), .c(new_n92_), .O(new_n153_));
  nor2   g107(.a(x25), .b(x24), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n125_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n151_), .c(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n149_), .c(new_n146_), .O(z15));
  inv1   g112(.a(x07), .O(new_n159_));
  oai22  g113(.a(new_n85_), .b(new_n159_), .c(x18), .d(new_n75_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n82_), .O(new_n161_));
  nand4  g115(.a(new_n154_), .b(new_n125_), .c(new_n152_), .d(new_n92_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x26), .O(new_n163_));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n139_), .c(new_n115_), .d(new_n95_), .O(new_n165_));
  ...
  nand3  g125(.a(new_n152_), .b(x19), .c(new_n92_), .O(new_n172_));
  nand3  g126(.a(new_n164_), .b(new_n125_), .c(new_n134_), .O(new_n173_));
  oai22  g127(.a(new_n173_), .b(new_n172_), .c(new_n58_), .d(new_n92_), .O(new_n174_));
