...
module FAU ( 
  ...
  nand4  g75(.a(new_n76_), .b(new_n114_), .c(new_n68_), .d(new_n121_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n124_));
  nand3  g78(.a(new_n47_), .b(new_n88_), .c(x14), .O(new_n125_));
  ...
  nand3  g92(.a(new_n138_), .b(new_n129_), .c(new_n114_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n84_), .O(new_n140_));
