...
module FAU ( 
  ...
  nand3  g091(.a(new_n96_), .b(new_n90_), .c(x13), .O(new_n138_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n96_), .c(x16), .O(new_n148_));
  ...
  nand3  g109(.a(new_n96_), .b(new_n90_), .c(x15), .O(new_n156_));
