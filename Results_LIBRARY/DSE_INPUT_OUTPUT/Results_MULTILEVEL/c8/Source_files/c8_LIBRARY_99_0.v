...
module FAU ( 
  ...
  aoi21  g17(.a(x27), .b(new_n63_), .c(new_n47_), .O(new_n64_));
  ...
  nand2  g22(.a(new_n51_), .b(new_n68_), .O(new_n69_));
  aoi21  g23(.a(new_n69_), .b(new_n67_), .c(new_n47_), .O(z05));
  ...
  aoi21  g28(.a(x27), .b(new_n74_), .c(new_n47_), .O(new_n75_));
  oai21  g29(.a(x27), .b(x26), .c(new_n75_), .O(z07));
  nor2   g30(.a(new_n47_), .b(new_n51_), .O(z08));
  inv1   g31(.a(x17), .O(new_n78_));
  nor2   g32(.a(new_n50_), .b(new_n78_), .O(new_n79_));
  ...
  nand2  g37(.a(new_n83_), .b(x00), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n81_), .O(z09));
  inv1   g39(.a(x16), .O(new_n86_));
  oai21  g40(.a(new_n82_), .b(x01), .c(new_n86_), .O(new_n87_));
  inv1   g41(.a(x20), .O(new_n88_));
  nor2   g42(.a(new_n80_), .b(new_n88_), .O(new_n89_));
  nor3   g43(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  oai21  g44(.a(new_n90_), .b(new_n89_), .c(x16), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n87_), .O(z10));
  oai21  g46(.a(new_n82_), .b(x02), .c(new_n86_), .O(new_n93_));
  nor2   g47(.a(x20), .b(x19), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n78_), .O(new_n95_));
  inv1   g49(.a(x21), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n88_), .c(new_n50_), .d(new_n78_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x21), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n86_), .c(new_n93_), .O(z11));
  nand2  g54(.a(new_n97_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n80_), .c(new_n88_), .O(new_n103_));
  and2   g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g58(.a(new_n83_), .b(x03), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n86_), .c(new_n105_), .O(z12));
  oai21  g60(.a(new_n82_), .b(x04), .c(new_n86_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n90_), .c(new_n103_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n86_), .c(new_n107_), .O(z13));
  oai21  g64(.a(new_n82_), .b(x05), .c(new_n86_), .O(new_n111_));
  aoi21  g65(.a(new_n108_), .b(new_n90_), .c(new_n68_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n94_), .d(new_n78_), .O(new_n114_));
  ...
  oai21  g71(.a(new_n82_), .b(x06), .c(new_n86_), .O(new_n118_));
