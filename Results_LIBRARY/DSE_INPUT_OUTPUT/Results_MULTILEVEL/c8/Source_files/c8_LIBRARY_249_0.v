...
module FAU ( 
  ...
  nor2   g055(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  ...
  oai21  g060(.a(new_n106_), .b(new_n102_), .c(x16), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n100_), .c(new_n94_), .O(z10));
  nand2  g062(.a(x18), .b(x02), .O(new_n109_));
  nand3  g063(.a(new_n90_), .b(x10), .c(x06), .O(new_n110_));
  ...
  oai21  g068(.a(new_n106_), .b(new_n59_), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g072(.a(new_n90_), .b(x11), .c(x06), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n101_), .c(new_n53_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n90_), .b(x12), .c(x06), .O(new_n129_));
  ...
  aoi21  g094(.a(new_n133_), .b(new_n106_), .c(new_n74_), .O(new_n141_));
  ...
  nand3  g099(.a(new_n145_), .b(new_n140_), .c(new_n94_), .O(z14));
  inv1   g100(.a(x06), .O(new_n147_));
  aoi21  g101(.a(new_n90_), .b(new_n77_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n143_), .b(x25), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n113_), .d(new_n101_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(x16), .c(new_n148_), .O(new_n154_));
  nand3  g108(.a(new_n153_), .b(x18), .c(x16), .O(new_n155_));
  oai21  g109(.a(new_n154_), .b(new_n147_), .c(new_n155_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  nand3  g111(.a(new_n90_), .b(x15), .c(x06), .O(new_n158_));
  ...
  nand4  g115(.a(new_n150_), .b(new_n84_), .c(new_n79_), .d(new_n74_), .O(new_n162_));
  ...
  oai22  g120(.a(new_n166_), .b(new_n162_), .c(new_n54_), .d(new_n103_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n94_), .c(x16), .O(new_n168_));
