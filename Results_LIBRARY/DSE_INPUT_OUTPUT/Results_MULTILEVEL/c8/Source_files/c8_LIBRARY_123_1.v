...
module FAU ( 
  ...
  nand2  g062(.a(x18), .b(x06), .O(new_n109_));
  oai22  g063(.a(new_n109_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n110_));
  ...
  nand4  g074(.a(new_n120_), .b(new_n63_), .c(new_n58_), .d(new_n49_), .O(new_n121_));
  ...
  oai22  g080(.a(new_n109_), .b(new_n126_), .c(x18), .d(new_n71_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n96_), .O(new_n128_));
  nor2   g082(.a(x22), .b(x21), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n94_), .c(new_n58_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x23), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n105_), .c(new_n63_), .O(new_n133_));
  ...
  oai22  g091(.a(new_n109_), .b(new_n137_), .c(x18), .d(new_n76_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n96_), .O(new_n139_));
  nand2  g093(.a(new_n133_), .b(x24), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n129_), .c(new_n105_), .O(new_n142_));
  ...
  oai21  g099(.a(x18), .b(new_n81_), .c(new_n109_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n96_), .O(new_n147_));
  nand2  g101(.a(new_n142_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n132_), .c(new_n112_), .d(new_n94_), .O(new_n150_));
  ...
  nand4  g111(.a(new_n132_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n158_));
  ...
  nand3  g115(.a(new_n112_), .b(x19), .c(new_n92_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n158_), .c(new_n50_), .d(new_n92_), .O(new_n163_));
