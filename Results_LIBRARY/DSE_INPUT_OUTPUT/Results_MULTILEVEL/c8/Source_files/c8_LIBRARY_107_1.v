...
module FAU ( 
  ...
  aoi21  g028(.a(x27), .b(x18), .c(new_n47_), .O(new_n75_));
  oai22  g029(.a(new_n75_), .b(x15), .c(x27), .d(x26), .O(z07));
  inv1   g030(.a(new_n48_), .O(new_n77_));
  nand2  g031(.a(new_n77_), .b(new_n52_), .O(z08));
  nor2   g032(.a(x26), .b(x18), .O(new_n79_));
  aoi22  g033(.a(new_n79_), .b(x08), .c(x18), .d(x00), .O(new_n80_));
  xnor2a g034(.a(x19), .b(x17), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n77_), .c(x16), .O(new_n82_));
  oai21  g036(.a(new_n80_), .b(x16), .c(new_n82_), .O(z09));
  aoi22  g037(.a(new_n79_), .b(x09), .c(x18), .d(x01), .O(new_n84_));
  inv1   g038(.a(x20), .O(new_n85_));
  nor2   g039(.a(x19), .b(x17), .O(new_n86_));
  inv1   g040(.a(x17), .O(new_n87_));
  nand3  g041(.a(new_n85_), .b(new_n51_), .c(new_n87_), .O(new_n88_));
  oai21  g042(.a(new_n86_), .b(new_n85_), .c(new_n88_), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n77_), .c(x16), .O(new_n90_));
  oai21  g044(.a(new_n84_), .b(x16), .c(new_n90_), .O(z10));
  inv1   g045(.a(x16), .O(new_n92_));
  nand2  g046(.a(x18), .b(x02), .O(new_n93_));
  oai21  g047(.a(x18), .b(new_n58_), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n95_), .c(new_n77_), .O(z11));
  inv1   g056(.a(new_n79_), .O(new_n103_));
  nand2  g057(.a(x18), .b(x03), .O(new_n104_));
  oai21  g058(.a(new_n103_), .b(new_n61_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  nand2  g060(.a(new_n99_), .b(x22), .O(new_n107_));
  nor2   g061(.a(x22), .b(x21), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n86_), .c(new_n85_), .O(new_n109_));
  ...
  oai21  g067(.a(new_n103_), .b(new_n66_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n92_), .O(new_n115_));
  nand2  g069(.a(new_n109_), .b(x23), .O(new_n116_));
  nor2   g070(.a(x23), .b(x22), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n97_), .c(new_n96_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n77_), .c(x16), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n115_), .O(z13));
  nand2  g075(.a(x18), .b(x05), .O(new_n122_));
  oai21  g076(.a(new_n103_), .b(new_n69_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n92_), .O(new_n124_));
  inv1   g078(.a(x23), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n63_), .c(new_n96_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n88_), .c(x24), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n108_), .c(new_n128_), .d(new_n87_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n77_), .c(x16), .O(new_n132_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n117_), .c(new_n98_), .d(new_n86_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(new_n77_), .O(z15));
  ...
  nand4  g102(.a(new_n148_), .b(new_n117_), .c(new_n98_), .d(new_n86_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n117_), .c(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n98_), .b(x19), .c(new_n87_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n87_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n77_), .O(z17));
endmodule
