...
module FAU ( 
  ...
  nand3  g067(.a(new_n113_), .b(new_n111_), .c(new_n105_), .O(z11));
  oai21  g068(.a(x16), .b(x03), .c(x18), .O(new_n115_));
  aoi21  g069(.a(new_n108_), .b(new_n99_), .c(new_n65_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n99_), .c(new_n57_), .O(new_n118_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n108_), .d(new_n99_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n98_), .c(x16), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n108_), .d(new_n99_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n98_), .c(x16), .O(new_n156_));
  ...
  nor2   g117(.a(new_n52_), .b(new_n89_), .O(new_n164_));
  aoi21  g118(.a(new_n163_), .b(new_n161_), .c(new_n164_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n98_), .c(new_n87_), .O(z17));
endmodule
