...
module FAU ( 
  ...
  oai21  g053(.a(x18), .b(new_n57_), .c(new_n94_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n92_), .O(new_n101_));
  nor2   g055(.a(x19), .b(x17), .O(new_n102_));
  inv1   g056(.a(x17), .O(new_n103_));
  nand3  g057(.a(new_n55_), .b(new_n47_), .c(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n102_), .b(new_n55_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n53_), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n101_), .O(z10));
  nand3  g061(.a(x18), .b(x02), .c(x01), .O(new_n108_));
  ...
  nand4  g074(.a(new_n120_), .b(new_n60_), .c(new_n55_), .d(new_n47_), .O(new_n121_));
  ...
  nand3  g079(.a(x18), .b(x04), .c(x01), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n72_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n92_), .O(new_n128_));
  nand4  g082(.a(new_n102_), .b(new_n65_), .c(new_n60_), .d(new_n55_), .O(new_n129_));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n111_), .c(new_n78_), .O(new_n139_));
  nand4  g093(.a(new_n78_), .b(new_n70_), .c(new_n65_), .d(new_n60_), .O(new_n140_));
  ...
  oai21  g103(.a(new_n141_), .b(new_n83_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n53_), .O(z15));
  nand3  g106(.a(x18), .b(x07), .c(x01), .O(new_n153_));
  oai21  g107(.a(x18), .b(new_n88_), .c(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n92_), .O(new_n155_));
  nand2  g109(.a(new_n149_), .b(x26), .O(new_n156_));
  nand4  g110(.a(new_n147_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n112_), .b(x19), .c(new_n103_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n48_), .d(new_n103_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n53_), .O(z17));
endmodule
