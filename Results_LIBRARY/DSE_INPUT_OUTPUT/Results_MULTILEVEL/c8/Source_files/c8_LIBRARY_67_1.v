...
module FAU ( 
  ...
  nand2  g037(.a(new_n53_), .b(new_n82_), .O(new_n84_));
  nand3  g038(.a(new_n84_), .b(new_n83_), .c(new_n48_), .O(z06));
  ...
  oai21  g062(.a(new_n103_), .b(new_n61_), .c(new_n108_), .O(new_n109_));
  ...
  aoi21  g068(.a(x25), .b(new_n47_), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n61_), .c(new_n56_), .d(new_n52_), .O(new_n116_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n101_), .c(new_n56_), .O(new_n125_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n123_), .c(new_n48_), .O(z13));
  inv1   g085(.a(new_n92_), .O(new_n132_));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai21  g087(.a(new_n132_), .b(new_n76_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n97_), .O(new_n135_));
  nand2  g089(.a(new_n128_), .b(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n124_), .c(new_n103_), .O(new_n138_));
  ...
  oai21  g096(.a(new_n132_), .b(new_n81_), .c(new_n142_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n97_), .O(new_n144_));
  nand3  g098(.a(new_n138_), .b(x25), .c(x18), .O(new_n145_));
  inv1   g099(.a(new_n108_), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n127_), .c(new_n146_), .O(new_n148_));
  ...
  oai21  g106(.a(x18), .b(new_n88_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n97_), .O(new_n154_));
  oai21  g108(.a(new_n86_), .b(new_n97_), .c(x18), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x25), .O(new_n156_));
  nand2  g110(.a(new_n138_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n127_), .c(new_n146_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n154_), .O(z16));
  nand3  g116(.a(new_n48_), .b(x27), .c(x17), .O(new_n163_));
  nor2   g117(.a(new_n52_), .b(x17), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n158_), .c(new_n127_), .d(new_n107_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n163_), .c(new_n97_), .O(z17));
endmodule
