...
module FAU ( 
  ...
  oai21  g035(.a(x27), .b(new_n81_), .c(new_n48_), .O(new_n82_));
  nand3  g036(.a(new_n55_), .b(new_n81_), .c(x18), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n82_), .O(z07));
  ...
  oai21  g058(.a(new_n104_), .b(new_n58_), .c(new_n102_), .O(new_n105_));
  ...
  oai21  g096(.a(new_n104_), .b(new_n76_), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n146_), .c(new_n107_), .d(new_n88_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nor2   g110(.a(new_n103_), .b(x16), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(x07), .c(new_n49_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(z16));
  nand4  g113(.a(new_n146_), .b(new_n81_), .c(new_n78_), .d(new_n133_), .O(new_n160_));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n135_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n135_), .O(new_n162_));
