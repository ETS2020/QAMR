...
module FAU ( 
  ...
  aoi21  g065(.a(new_n104_), .b(new_n95_), .c(new_n65_), .O(new_n112_));
  ...
  nand2  g070(.a(new_n108_), .b(x11), .O(new_n117_));
  ...
  nand2  g078(.a(new_n108_), .b(x12), .O(new_n125_));
  ...
  nand4  g083(.a(new_n129_), .b(new_n113_), .c(new_n96_), .d(new_n85_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n108_), .b(x13), .O(new_n133_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n104_), .d(new_n95_), .O(new_n141_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n139_), .c(new_n104_), .d(new_n95_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n94_), .c(x16), .O(new_n152_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n73_), .O(new_n158_));
  ...
  aoi21  g117(.a(new_n163_), .b(new_n94_), .c(new_n83_), .O(z17));
endmodule
