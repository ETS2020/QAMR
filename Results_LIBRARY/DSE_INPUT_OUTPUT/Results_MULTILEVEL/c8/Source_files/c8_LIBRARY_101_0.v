...
module FAU ( 
  ...
  nand3  g40(.a(x18), .b(new_n86_), .c(x00), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n85_), .O(z09));
  inv1   g42(.a(x18), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(x01), .c(new_n86_), .O(new_n90_));
  ...
  oai21  g49(.a(new_n89_), .b(x02), .c(new_n86_), .O(new_n96_));
  ...
  oai21  g57(.a(new_n89_), .b(x03), .c(new_n86_), .O(new_n104_));
  ...
  oai21  g63(.a(new_n89_), .b(x04), .c(new_n86_), .O(new_n110_));
  ...
  oai21  g67(.a(new_n89_), .b(x05), .c(new_n86_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n93_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n97_), .d(new_n82_), .O(new_n118_));
  ...
  oai21  g75(.a(new_n89_), .b(x06), .c(new_n86_), .O(new_n122_));
  ...
  nand3  g90(.a(x18), .b(new_n86_), .c(x07), .O(new_n137_));
