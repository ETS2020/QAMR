...
module FAU ( 
  ...
  nand2  g018(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  oai21  g019(.a(new_n65_), .b(x18), .c(new_n63_), .O(z04));
  ...
  nand2  g026(.a(new_n64_), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g031(.a(new_n64_), .b(new_n77_), .O(new_n78_));
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n49_), .O(z07));
  nor2   g033(.a(new_n49_), .b(new_n64_), .O(z08));
  inv1   g034(.a(x16), .O(new_n81_));
  inv1   g035(.a(x00), .O(new_n82_));
  nand2  g036(.a(x18), .b(new_n61_), .O(new_n83_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n48_), .O(z10));
  ...
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n48_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  oai21  g063(.a(x18), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n81_), .O(new_n111_));
  inv1   g065(.a(x22), .O(new_n112_));
  aoi21  g066(.a(new_n104_), .b(new_n87_), .c(new_n112_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n87_), .c(new_n95_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n111_), .c(new_n48_), .O(z12));
  oai21  g072(.a(x18), .b(new_n81_), .c(x12), .O(new_n119_));
  nand2  g073(.a(new_n115_), .b(x23), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n97_), .c(new_n103_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(x18), .b(new_n81_), .c(x04), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n124_), .c(new_n119_), .O(z13));
  inv1   g080(.a(x05), .O(new_n127_));
  oai22  g081(.a(new_n83_), .b(new_n127_), .c(x18), .d(new_n67_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n81_), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  inv1   g084(.a(x19), .O(new_n131_));
  nand3  g085(.a(new_n95_), .b(new_n131_), .c(new_n130_), .O(new_n132_));
  nand3  g086(.a(new_n62_), .b(new_n112_), .c(new_n103_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n132_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n130_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n48_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n129_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n83_), .b(new_n141_), .c(x18), .d(new_n70_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n81_), .O(new_n143_));
  nand2  g097(.a(new_n137_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n121_), .c(new_n104_), .d(new_n87_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n48_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n143_), .O(z15));
  inv1   g103(.a(x07), .O(new_n150_));
  oai22  g104(.a(new_n83_), .b(new_n150_), .c(x18), .d(new_n75_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n81_), .O(new_n152_));
  nand2  g106(.a(new_n146_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n121_), .c(new_n104_), .d(new_n87_), .O(new_n155_));
  ...
  inv1   g112(.a(x24), .O(new_n159_));
  nand4  g113(.a(new_n121_), .b(new_n77_), .c(new_n72_), .d(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n130_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n64_), .d(new_n130_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n48_), .c(x16), .O(new_n163_));
