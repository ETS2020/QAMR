...
module FAU ( 
  ...
  nand3  g47(.a(x18), .b(new_n87_), .c(x01), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n93_), .O(z10));
  oai21  g49(.a(new_n88_), .b(x02), .c(new_n87_), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n83_), .O(new_n98_));
  nand4  g52(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n83_), .O(new_n99_));
  ...
  oai21  g56(.a(new_n88_), .b(x03), .c(new_n87_), .O(new_n103_));
  ...
  oai21  g62(.a(new_n88_), .b(x04), .c(new_n87_), .O(new_n109_));
  ...
  oai21  g66(.a(new_n88_), .b(x05), .c(new_n87_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n97_), .d(new_n83_), .O(new_n117_));
  ...
  oai21  g74(.a(new_n88_), .b(x06), .c(new_n87_), .O(new_n121_));
  ...
  nand3  g90(.a(x18), .b(new_n87_), .c(x07), .O(new_n137_));
  ...
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n51_), .d(new_n83_), .O(new_n142_));
