...
module FAU ( 
  ...
  nor2   g059(.a(new_n94_), .b(new_n58_), .O(new_n106_));
  ...
  oai21  g070(.a(new_n107_), .b(new_n63_), .c(new_n116_), .O(new_n117_));
  ...
  nand4  g077(.a(new_n123_), .b(new_n63_), .c(new_n58_), .d(new_n49_), .O(new_n124_));
  ...
  nand3  g083(.a(new_n52_), .b(x12), .c(new_n102_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n96_), .O(new_n132_));
  nor2   g086(.a(x22), .b(x21), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n94_), .c(new_n58_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x23), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n107_), .c(new_n63_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n53_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n132_), .O(z13));
  nand3  g094(.a(new_n52_), .b(x13), .c(new_n102_), .O(new_n141_));
  oai21  g095(.a(new_n52_), .b(new_n102_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n96_), .O(new_n143_));
  nand2  g097(.a(new_n137_), .b(x24), .O(new_n144_));
  nor2   g098(.a(x24), .b(x23), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n133_), .c(new_n107_), .O(new_n146_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n136_), .c(new_n115_), .d(new_n94_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n52_), .b(x15), .c(new_n102_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n96_), .O(new_n163_));
  nand2  g117(.a(new_n156_), .b(x26), .O(new_n164_));
  nand4  g118(.a(new_n136_), .b(new_n88_), .c(new_n81_), .d(new_n78_), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n116_), .c(new_n164_), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n53_), .c(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n163_), .O(z16));
  nand3  g122(.a(new_n115_), .b(x19), .c(new_n92_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n165_), .c(new_n50_), .d(new_n92_), .O(new_n170_));
