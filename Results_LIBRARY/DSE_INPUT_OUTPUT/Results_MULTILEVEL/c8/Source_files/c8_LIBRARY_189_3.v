...
module FAU ( 
  ...
  aoi21  g040(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  aoi21  g041(.a(new_n83_), .b(x08), .c(new_n87_), .O(new_n88_));
  nand3  g042(.a(x18), .b(new_n83_), .c(x00), .O(new_n89_));
  oai21  g043(.a(new_n88_), .b(x18), .c(new_n89_), .O(z09));
  ...
  nand2  g072(.a(new_n110_), .b(x23), .O(new_n119_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n118_), .c(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n117_), .O(z13));
  oai21  g078(.a(x16), .b(x05), .c(x18), .O(new_n125_));
  inv1   g079(.a(x24), .O(new_n126_));
  aoi21  g080(.a(new_n120_), .b(new_n95_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n109_), .c(new_n128_), .d(new_n85_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n97_), .b(x13), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n101_), .d(new_n93_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n97_), .b(x14), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n101_), .d(new_n93_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n97_), .b(x15), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n137_), .c(new_n126_), .O(new_n153_));
  nand3  g107(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n52_), .d(new_n85_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n118_), .c(x16), .O(new_n156_));
