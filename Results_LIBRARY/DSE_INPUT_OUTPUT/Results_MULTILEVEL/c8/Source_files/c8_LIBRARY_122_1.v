...
module FAU ( 
  ...
  nand4  g54(.a(new_n100_), .b(new_n91_), .c(new_n51_), .d(new_n84_), .O(new_n101_));
  ...
  aoi22  g59(.a(new_n105_), .b(new_n86_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n88_), .c(new_n95_), .d(new_n61_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n88_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n86_), .c(new_n91_), .O(new_n110_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n109_), .c(new_n98_), .d(new_n84_), .O(new_n117_));
  ...
  nand3  g89(.a(new_n47_), .b(new_n88_), .c(x15), .O(new_n136_));
  ...
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n84_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n52_), .d(new_n84_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(new_n82_), .O(z17));
endmodule
