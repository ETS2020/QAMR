...
module FAU ( 
  ...
  nand2  g47(.a(new_n47_), .b(new_n87_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n55_), .c(new_n93_), .O(z10));
  ...
  oai22  g58(.a(new_n104_), .b(new_n87_), .c(new_n94_), .d(new_n63_), .O(z12));
  ...
  aoi21  g66(.a(new_n109_), .b(new_n92_), .c(new_n73_), .O(new_n113_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n73_), .c(new_n119_), .d(new_n65_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n100_), .c(new_n115_), .d(x25), .O(new_n123_));
  nand3  g77(.a(new_n47_), .b(new_n87_), .c(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n87_), .c(new_n124_), .O(z15));
  ...
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n83_), .O(new_n140_));
