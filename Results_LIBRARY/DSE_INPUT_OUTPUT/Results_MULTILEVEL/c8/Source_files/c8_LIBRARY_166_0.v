...
module FAU ( 
  ...
  oai21  g033(.a(new_n51_), .b(x14), .c(new_n79_), .O(z06));
  ...
  nand2  g051(.a(x25), .b(new_n77_), .O(new_n98_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n50_), .c(new_n88_), .O(new_n102_));
  oai21  g056(.a(new_n90_), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n59_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n108_), .c(new_n87_), .O(z11));
  nand2  g068(.a(x18), .b(x03), .O(new_n115_));
  oai21  g069(.a(new_n98_), .b(new_n62_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n92_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x22), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n90_), .c(new_n101_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n87_), .c(x16), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n117_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  oai21  g078(.a(new_n98_), .b(new_n67_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n92_), .O(new_n126_));
  nand2  g080(.a(new_n120_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n109_), .c(new_n59_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n87_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n126_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai21  g087(.a(new_n98_), .b(new_n72_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n92_), .O(new_n135_));
  nand3  g089(.a(new_n69_), .b(new_n64_), .c(new_n59_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n102_), .c(x24), .O(new_n137_));
  nand4  g091(.a(new_n119_), .b(new_n109_), .c(new_n74_), .d(new_n69_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n87_), .c(x16), .O(new_n140_));
  ...
  nand2  g098(.a(new_n144_), .b(new_n92_), .O(new_n145_));
  nand3  g099(.a(new_n119_), .b(new_n74_), .c(new_n69_), .O(new_n146_));
  nand4  g100(.a(new_n101_), .b(new_n50_), .c(new_n88_), .d(x16), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n146_), .c(x18), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n78_), .O(new_n149_));
  nand3  g103(.a(new_n138_), .b(x25), .c(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n145_), .O(z15));
  ...
  nand2  g109(.a(new_n155_), .b(new_n77_), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n128_), .c(new_n110_), .d(new_n90_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n128_), .c(new_n110_), .d(new_n90_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n156_), .c(new_n154_), .O(z16));
  nand4  g118(.a(new_n128_), .b(new_n83_), .c(new_n78_), .d(new_n74_), .O(new_n165_));
  nand3  g119(.a(new_n110_), .b(x19), .c(new_n88_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n51_), .d(new_n88_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x16), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n87_), .O(z17));
endmodule
