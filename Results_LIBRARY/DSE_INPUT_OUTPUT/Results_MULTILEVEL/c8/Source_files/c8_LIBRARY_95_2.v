...
module FAU ( 
  ...
  aoi22  g041(.a(new_n83_), .b(x09), .c(x18), .d(x01), .O(new_n88_));
  ...
  oai21  g049(.a(new_n88_), .b(x16), .c(new_n95_), .O(z10));
  ...
  nand3  g060(.a(new_n106_), .b(new_n100_), .c(new_n81_), .O(z11));
  inv1   g061(.a(new_n83_), .O(new_n108_));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  oai21  g063(.a(new_n108_), .b(new_n61_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n97_), .O(new_n111_));
  nand2  g065(.a(new_n104_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n90_), .c(new_n89_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n81_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n111_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  oai21  g072(.a(new_n108_), .b(new_n64_), .c(new_n118_), .O(new_n119_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n81_), .c(x16), .O(new_n125_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n141_), .c(new_n103_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nor2   g105(.a(new_n75_), .b(x16), .O(new_n152_));
  ...
  nand3  g109(.a(new_n155_), .b(new_n141_), .c(new_n130_), .O(new_n156_));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n91_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n91_), .O(new_n158_));
