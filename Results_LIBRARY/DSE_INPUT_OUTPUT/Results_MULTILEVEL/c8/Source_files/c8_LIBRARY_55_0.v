...
module FAU ( 
  ...
  nand3  g032(.a(new_n54_), .b(new_n78_), .c(x18), .O(new_n79_));
  ...
  nand2  g052(.a(x25), .b(new_n74_), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n51_), .c(new_n98_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  nand3  g055(.a(new_n53_), .b(new_n89_), .c(new_n88_), .O(new_n102_));
  oai21  g056(.a(new_n91_), .b(new_n53_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g078(.a(new_n99_), .b(new_n65_), .c(new_n124_), .O(new_n125_));
  ...
  oai21  g087(.a(new_n99_), .b(new_n70_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  inv1   g089(.a(x22), .O(new_n136_));
  nand3  g090(.a(new_n67_), .b(new_n136_), .c(new_n59_), .O(new_n137_));
  ...
  oai21  g099(.a(new_n99_), .b(new_n73_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n93_), .O(new_n147_));
  nand2  g101(.a(new_n141_), .b(x25), .O(new_n148_));
  nor2   g102(.a(new_n74_), .b(x17), .O(new_n149_));
  ...
  nand2  g112(.a(new_n158_), .b(new_n74_), .O(new_n159_));
  ...
  nand4  g122(.a(new_n128_), .b(new_n83_), .c(new_n78_), .d(new_n168_), .O(new_n169_));
  nand3  g123(.a(new_n110_), .b(x19), .c(new_n88_), .O(new_n170_));
  oai22  g124(.a(new_n170_), .b(new_n169_), .c(new_n54_), .d(new_n88_), .O(new_n171_));
