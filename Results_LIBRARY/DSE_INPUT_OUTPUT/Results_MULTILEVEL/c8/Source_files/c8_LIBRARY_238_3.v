...
module FAU ( 
  ...
  nor2   g031(.a(x16), .b(new_n47_), .O(new_n78_));
  aoi21  g032(.a(new_n77_), .b(x16), .c(new_n78_), .O(new_n79_));
  inv1   g033(.a(x16), .O(new_n80_));
  nand3  g034(.a(x18), .b(new_n80_), .c(x00), .O(new_n81_));
  oai21  g035(.a(new_n79_), .b(x18), .c(new_n81_), .O(z09));
  nand2  g036(.a(x18), .b(x01), .O(new_n83_));
  oai21  g037(.a(x18), .b(new_n52_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n86_), .c(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n85_), .O(z10));
  nand2  g048(.a(x18), .b(x02), .O(new_n95_));
  oai21  g049(.a(x18), .b(new_n55_), .c(new_n95_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n80_), .O(new_n97_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n86_), .c(x16), .O(new_n102_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n86_), .c(x16), .O(new_n111_));
  ...
  nand2  g073(.a(new_n119_), .b(x12), .O(new_n120_));
  ...
  nand2  g082(.a(new_n119_), .b(x13), .O(new_n129_));
  ...
  nand2  g100(.a(new_n119_), .b(x15), .O(new_n147_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n86_), .c(x16), .O(new_n153_));
