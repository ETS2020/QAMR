...
module FAU ( 
  ...
  nand3  g067(.a(new_n113_), .b(new_n87_), .c(new_n95_), .O(new_n114_));
  ...
  aoi21  g080(.a(new_n120_), .b(new_n102_), .c(new_n73_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n113_), .c(new_n96_), .d(new_n85_), .O(new_n129_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n103_), .d(new_n87_), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n138_), .c(new_n103_), .d(new_n87_), .O(new_n147_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n65_), .O(new_n153_));
