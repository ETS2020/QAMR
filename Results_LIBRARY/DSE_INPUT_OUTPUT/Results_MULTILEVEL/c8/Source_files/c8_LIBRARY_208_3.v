...
module FAU ( 
  ...
  nand2  g044(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n92_), .c(new_n80_), .O(z11));
  inv1   g052(.a(x03), .O(new_n99_));
  nand2  g053(.a(new_n66_), .b(x18), .O(new_n100_));
  oai22  g054(.a(new_n100_), .b(new_n99_), .c(x18), .d(new_n57_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n76_), .O(new_n102_));
  nand2  g056(.a(new_n95_), .b(x22), .O(new_n103_));
  nor2   g057(.a(x22), .b(x21), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n74_), .c(new_n85_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n80_), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n102_), .O(z12));
  nand2  g062(.a(x18), .b(x04), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n60_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  and2   g065(.a(new_n105_), .b(x23), .O(new_n112_));
  nor3   g066(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  and2   g067(.a(new_n113_), .b(new_n87_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n112_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n111_), .c(new_n80_), .O(z13));
  inv1   g070(.a(x05), .O(new_n117_));
  oai22  g071(.a(new_n100_), .b(new_n117_), .c(x18), .d(new_n63_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n76_), .O(new_n119_));
  inv1   g073(.a(x24), .O(new_n120_));
  inv1   g074(.a(x23), .O(new_n121_));
  nand4  g075(.a(new_n104_), .b(new_n87_), .c(new_n120_), .d(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n114_), .b(new_n120_), .c(new_n122_), .O(new_n123_));
  ...
  oai21  g081(.a(new_n100_), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n131_), .c(new_n94_), .d(new_n74_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n80_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n129_), .O(z15));
  inv1   g090(.a(x07), .O(new_n137_));
  nand2  g091(.a(new_n47_), .b(x15), .O(new_n138_));
  oai21  g092(.a(new_n100_), .b(new_n137_), .c(new_n138_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n76_), .O(new_n140_));
  ...
  oai21  g097(.a(new_n143_), .b(new_n95_), .c(new_n141_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n80_), .c(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n140_), .O(z16));
  inv1   g100(.a(x25), .O(new_n147_));
  aoi21  g101(.a(x27), .b(x18), .c(x26), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n120_), .d(new_n121_), .O(new_n149_));
  nor3   g103(.a(new_n149_), .b(x22), .c(x21), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n85_), .c(x19), .d(new_n71_), .O(new_n151_));
  nand2  g105(.a(new_n67_), .b(x17), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n151_), .c(new_n76_), .O(z17));
