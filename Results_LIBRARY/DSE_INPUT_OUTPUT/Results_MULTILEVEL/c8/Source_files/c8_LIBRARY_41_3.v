...
module FAU ( 
  ...
  nand3  g035(.a(x19), .b(new_n81_), .c(x17), .O(new_n82_));
  ...
  nand2  g042(.a(new_n88_), .b(x18), .O(new_n89_));
  oai22  g043(.a(new_n89_), .b(new_n87_), .c(x18), .d(new_n47_), .O(new_n90_));
  ...
  oai21  g050(.a(new_n96_), .b(new_n86_), .c(new_n81_), .O(new_n97_));
  ...
  oai21  g061(.a(new_n107_), .b(new_n86_), .c(new_n81_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x19), .O(new_n109_));
  nor2   g063(.a(x20), .b(x17), .O(new_n110_));
  ...
  oai21  g104(.a(x18), .b(new_n70_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n86_), .O(new_n152_));
  oai21  g106(.a(new_n72_), .b(new_n86_), .c(new_n81_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x19), .O(new_n154_));
  and2   g108(.a(new_n144_), .b(x25), .O(new_n155_));
  nor2   g109(.a(x25), .b(x24), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n132_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n112_), .O(new_n158_));
  ...
  oai22  g115(.a(new_n89_), .b(new_n161_), .c(x18), .d(new_n75_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n86_), .O(new_n163_));
  nand4  g117(.a(new_n156_), .b(new_n132_), .c(new_n111_), .d(new_n99_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor2   g119(.a(x26), .b(x25), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n143_), .c(new_n122_), .d(new_n110_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(x19), .O(new_n168_));
  nor3   g122(.a(new_n77_), .b(new_n88_), .c(x18), .O(new_n169_));
  ...
  nand4  g128(.a(new_n174_), .b(new_n166_), .c(new_n132_), .d(new_n146_), .O(new_n175_));
