...
module FAU ( 
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n52_), .O(z11));
  ...
  nand3  g078(.a(new_n124_), .b(new_n118_), .c(new_n52_), .O(z12));
  inv1   g079(.a(x23), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n119_), .c(new_n62_), .O(new_n127_));
  nor2   g081(.a(new_n127_), .b(new_n103_), .O(new_n128_));
  aoi21  g082(.a(new_n122_), .b(x23), .c(new_n128_), .O(new_n129_));
  nor2   g083(.a(x18), .b(x16), .O(new_n130_));
  aoi21  g084(.a(new_n130_), .b(x12), .c(new_n53_), .O(new_n131_));
  oai21  g085(.a(new_n129_), .b(new_n87_), .c(new_n131_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai22  g087(.a(new_n133_), .b(x04), .c(x18), .d(new_n71_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n87_), .O(new_n135_));
  oai21  g089(.a(new_n127_), .b(new_n103_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n121_), .c(new_n137_), .d(new_n102_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n111_), .d(new_n94_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n111_), .d(new_n94_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n162_));
  nand3  g116(.a(new_n111_), .b(x19), .c(new_n102_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n102_), .O(new_n164_));
