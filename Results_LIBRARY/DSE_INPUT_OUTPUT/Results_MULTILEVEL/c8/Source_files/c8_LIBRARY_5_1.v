...
module FAU ( 
  ...
  nor2   g058(.a(new_n94_), .b(new_n56_), .O(new_n105_));
  ...
  oai22  g064(.a(new_n102_), .b(new_n110_), .c(x18), .d(new_n63_), .O(new_n111_));
  ...
  aoi21  g074(.a(x18), .b(new_n52_), .c(x22), .O(new_n121_));
  ...
  nand3  g099(.a(x18), .b(x06), .c(x04), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n132_), .c(new_n113_), .d(new_n94_), .O(new_n151_));
  ...
  nand4  g112(.a(new_n132_), .b(new_n88_), .c(new_n81_), .d(new_n78_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n114_), .c(new_n158_), .O(new_n160_));
  ...
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n50_), .d(new_n92_), .O(new_n164_));
