...
module FAU ( 
  ...
  aoi21  g018(.a(x27), .b(new_n64_), .c(new_n52_), .O(new_n65_));
  ...
  aoi21  g027(.a(new_n73_), .b(new_n71_), .c(new_n52_), .O(z05));
  ...
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n61_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n99_), .c(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n83_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n126_), .O(z13));
  aoi21  g089(.a(new_n95_), .b(new_n70_), .c(x16), .O(new_n136_));
  oai21  g090(.a(new_n132_), .b(new_n99_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n127_), .c(new_n107_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(x16), .c(new_n136_), .O(new_n141_));
  nand3  g095(.a(new_n140_), .b(x18), .c(x16), .O(new_n142_));
  oai21  g096(.a(new_n141_), .b(new_n116_), .c(new_n142_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  nand3  g098(.a(new_n95_), .b(x14), .c(x05), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n89_), .O(new_n147_));
  nand2  g101(.a(new_n139_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x23), .b(x22), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n108_), .d(new_n87_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n83_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n147_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n95_), .b(x15), .c(x05), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n89_), .O(new_n158_));
  nand2  g112(.a(new_n151_), .b(x26), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n149_), .c(new_n72_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n109_), .c(new_n159_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n83_), .c(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n158_), .O(z16));
  nand3  g118(.a(new_n108_), .b(x19), .c(new_n85_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n50_), .d(new_n85_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n83_), .O(z17));
endmodule
