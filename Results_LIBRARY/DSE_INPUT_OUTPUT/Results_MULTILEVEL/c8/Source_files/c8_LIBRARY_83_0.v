...
module FAU ( 
  ...
  nand2  g34(.a(new_n57_), .b(new_n80_), .O(new_n81_));
  aoi21  g35(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(z07));
  nor2   g36(.a(new_n48_), .b(new_n57_), .O(z08));
  ...
  oai21  g46(.a(new_n90_), .b(x01), .c(new_n89_), .O(new_n93_));
  inv1   g47(.a(x20), .O(new_n94_));
  nor2   g48(.a(new_n87_), .b(new_n94_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n56_), .b(new_n94_), .c(new_n85_), .d(new_n84_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  nor2   g57(.a(new_n90_), .b(x16), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x02), .O(new_n105_));
  oai21  g59(.a(new_n103_), .b(new_n89_), .c(new_n105_), .O(z11));
  nand2  g60(.a(new_n101_), .b(x22), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n87_), .c(new_n94_), .O(new_n109_));
  and2   g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g64(.a(new_n104_), .b(x03), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n89_), .c(new_n111_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n96_), .c(new_n109_), .d(x23), .O(new_n114_));
  nand2  g68(.a(new_n104_), .b(x04), .O(new_n115_));
  oai21  g69(.a(new_n114_), .b(new_n89_), .c(new_n115_), .O(z13));
  oai21  g70(.a(new_n90_), .b(x05), .c(new_n89_), .O(new_n117_));
  aoi21  g71(.a(new_n113_), .b(new_n96_), .c(new_n70_), .O(new_n118_));
  ...
  nand2  g81(.a(new_n104_), .b(x06), .O(new_n128_));
