...
module FAU ( 
  ...
  nand4  g073(.a(new_n119_), .b(new_n61_), .c(new_n58_), .d(new_n47_), .O(new_n120_));
  ...
  nand4  g081(.a(new_n101_), .b(new_n68_), .c(new_n61_), .d(new_n58_), .O(new_n128_));
  ...
  nand4  g092(.a(new_n76_), .b(new_n73_), .c(new_n68_), .d(new_n61_), .O(new_n139_));
  ...
  nand3  g105(.a(x18), .b(x07), .c(x00), .O(new_n152_));
  ...
  nand4  g109(.a(new_n146_), .b(new_n86_), .c(new_n83_), .d(new_n76_), .O(new_n156_));
  ...
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n48_), .d(new_n103_), .O(new_n161_));
