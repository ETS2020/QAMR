...
module FAU ( 
  ...
  oai21  g051(.a(new_n87_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  ...
  nand2  g061(.a(new_n89_), .b(x02), .O(new_n108_));
  ...
  nand3  g070(.a(new_n116_), .b(x18), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n112_), .O(z12));
  oai21  g072(.a(x16), .b(x12), .c(new_n83_), .O(new_n119_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n104_), .d(new_n87_), .O(new_n149_));
  ...
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n85_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n52_), .b(new_n85_), .O(new_n160_));
