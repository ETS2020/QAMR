...
module FAU ( 
  ...
  nand3  g061(.a(new_n107_), .b(new_n95_), .c(x16), .O(new_n108_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n104_), .c(new_n60_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n95_), .c(x16), .O(new_n126_));
  ...
  nand3  g085(.a(new_n68_), .b(new_n131_), .c(new_n60_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n97_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n134_), .d(new_n84_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n95_), .c(x16), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n105_), .d(new_n86_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n88_), .b(x14), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n123_), .c(new_n105_), .d(new_n86_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n88_), .b(x15), .O(new_n154_));
  ...
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n84_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n84_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n95_), .c(x16), .O(new_n161_));
