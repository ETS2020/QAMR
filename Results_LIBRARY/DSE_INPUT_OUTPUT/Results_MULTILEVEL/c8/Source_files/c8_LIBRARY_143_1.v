...
module FAU ( 
  ...
  nor2   g051(.a(new_n94_), .b(new_n56_), .O(new_n98_));
  ...
  nand2  g056(.a(new_n102_), .b(new_n100_), .O(z10));
  oai21  g057(.a(x18), .b(x10), .c(new_n47_), .O(new_n104_));
  nor2   g058(.a(x20), .b(x19), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  nand4  g060(.a(new_n61_), .b(new_n56_), .c(new_n52_), .d(new_n92_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  aoi21  g062(.a(new_n106_), .b(x21), .c(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n47_), .c(new_n104_), .O(z11));
  oai21  g064(.a(x18), .b(x11), .c(new_n47_), .O(new_n111_));
  nand2  g065(.a(new_n107_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n94_), .c(new_n56_), .O(new_n114_));
  ...
  aoi22  g072(.a(new_n118_), .b(new_n99_), .c(new_n114_), .d(x23), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n47_), .c(new_n117_), .O(z13));
  aoi21  g074(.a(new_n118_), .b(new_n99_), .c(new_n78_), .O(new_n121_));
  nor2   g075(.a(x24), .b(x23), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n113_), .c(new_n105_), .d(new_n92_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n101_), .b(x13), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n125_), .O(z14));
  nand4  g081(.a(new_n81_), .b(new_n78_), .c(new_n71_), .d(new_n68_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n108_), .c(new_n123_), .d(x25), .O(new_n130_));
  nand2  g084(.a(new_n101_), .b(x14), .O(new_n131_));
  ...
  nand4  g097(.a(new_n135_), .b(new_n86_), .c(new_n81_), .d(new_n78_), .O(new_n144_));
