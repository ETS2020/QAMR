...
module FAU ( 
  ...
  oai21  g46(.a(x18), .b(x08), .c(new_n92_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n91_), .O(z09));
  nor2   g48(.a(new_n90_), .b(new_n54_), .O(new_n95_));
  ...
  oai21  g53(.a(new_n99_), .b(new_n52_), .c(new_n97_), .O(z10));
  nor2   g54(.a(x20), .b(x19), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n87_), .O(new_n102_));
  nand4  g56(.a(new_n60_), .b(new_n54_), .c(new_n88_), .d(new_n87_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n102_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n92_), .c(new_n99_), .d(new_n58_), .O(z11));
  oai21  g60(.a(x18), .b(x11), .c(new_n92_), .O(new_n107_));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n90_), .c(new_n54_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n92_), .c(new_n107_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n96_), .c(new_n110_), .d(x23), .O(new_n114_));
  oai22  g68(.a(new_n114_), .b(new_n92_), .c(new_n99_), .d(new_n68_), .O(z13));
  aoi21  g69(.a(new_n113_), .b(new_n96_), .c(new_n75_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n109_), .c(new_n101_), .d(new_n87_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n98_), .b(x13), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  nand4  g76(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n104_), .c(new_n118_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n98_), .b(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n92_), .c(new_n126_), .O(z15));
  oai21  g81(.a(x18), .b(x15), .c(new_n92_), .O(new_n128_));
