...
module FAU ( 
  ...
  aoi21  g23(.a(x27), .b(new_n69_), .c(new_n47_), .O(new_n70_));
  oai21  g24(.a(x27), .b(x23), .c(new_n70_), .O(z04));
  ...
  aoi21  g29(.a(x27), .b(new_n75_), .c(new_n47_), .O(new_n76_));
  ...
  oai21  g42(.a(new_n88_), .b(new_n82_), .c(new_n86_), .O(z09));
  inv1   g43(.a(x01), .O(new_n90_));
  nor2   g44(.a(new_n85_), .b(new_n56_), .O(new_n91_));
  nor3   g45(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n88_), .b(new_n90_), .c(new_n93_), .O(z10));
  inv1   g48(.a(x02), .O(new_n95_));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n83_), .O(new_n97_));
  nand4  g51(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n83_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai22  g54(.a(new_n100_), .b(new_n87_), .c(new_n88_), .d(new_n95_), .O(z11));
  inv1   g55(.a(x18), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(x03), .c(new_n87_), .O(new_n103_));
  nand2  g57(.a(new_n98_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n85_), .c(new_n56_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n87_), .c(new_n103_), .O(z12));
  oai21  g62(.a(new_n102_), .b(x04), .c(new_n87_), .O(new_n109_));
  ...
  oai21  g66(.a(new_n102_), .b(x05), .c(new_n87_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n96_), .d(new_n83_), .O(new_n117_));
  ...
  oai21  g74(.a(new_n102_), .b(x06), .c(new_n87_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n114_), .c(new_n122_), .d(new_n66_), .O(new_n124_));
  ...
  oai21  g81(.a(new_n102_), .b(x07), .c(new_n87_), .O(new_n128_));
  ...
  nand3  g94(.a(new_n140_), .b(new_n130_), .c(new_n114_), .O(new_n141_));
  nand3  g95(.a(new_n129_), .b(x19), .c(new_n83_), .O(new_n142_));
