...
module FAU ( 
  ...
  aoi21  g030(.a(new_n76_), .b(new_n74_), .c(new_n48_), .O(z05));
  ...
  oai21  g039(.a(x18), .b(new_n47_), .c(new_n52_), .O(z08));
  inv1   g040(.a(x18), .O(new_n87_));
  nand2  g041(.a(x19), .b(x17), .O(new_n88_));
  inv1   g042(.a(x17), .O(new_n89_));
  nand2  g043(.a(new_n51_), .b(new_n89_), .O(new_n90_));
  aoi21  g044(.a(new_n90_), .b(new_n88_), .c(new_n47_), .O(new_n91_));
  aoi21  g045(.a(new_n47_), .b(x00), .c(new_n91_), .O(new_n92_));
  nand3  g046(.a(new_n87_), .b(new_n47_), .c(x08), .O(new_n93_));
  oai21  g047(.a(new_n92_), .b(new_n87_), .c(new_n93_), .O(z09));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  oai21  g049(.a(x18), .b(new_n55_), .c(new_n95_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n98_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(x18), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n97_), .O(z10));
  oai21  g058(.a(x16), .b(x10), .c(new_n87_), .O(new_n105_));
  nor3   g059(.a(x20), .b(x19), .c(x17), .O(new_n106_));
  nor2   g060(.a(x21), .b(x20), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n99_), .O(new_n108_));
  oai21  g062(.a(new_n106_), .b(new_n60_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x16), .O(new_n110_));
  nor2   g064(.a(new_n87_), .b(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(x02), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n110_), .c(new_n105_), .O(z11));
  oai21  g067(.a(x16), .b(x11), .c(new_n87_), .O(new_n114_));
  aoi21  g068(.a(new_n107_), .b(new_n99_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n99_), .c(new_n98_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n111_), .b(x03), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n119_), .c(new_n114_), .O(z12));
  ...
  nand3  g082(.a(new_n128_), .b(x18), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n124_), .O(z13));
  oai21  g084(.a(x16), .b(x13), .c(new_n87_), .O(new_n131_));
  aoi21  g085(.a(new_n126_), .b(new_n106_), .c(new_n75_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n116_), .c(new_n100_), .d(new_n89_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n111_), .b(x05), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n136_), .c(new_n131_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  oai21  g093(.a(x18), .b(new_n78_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n47_), .O(new_n141_));
  nand2  g095(.a(new_n134_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n99_), .O(new_n145_));
  ...
  oai21  g102(.a(x16), .b(x15), .c(new_n87_), .O(new_n149_));
  nand2  g103(.a(new_n145_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n143_), .c(new_n107_), .d(new_n99_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n111_), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n143_), .c(new_n75_), .O(new_n158_));
  nand3  g112(.a(new_n107_), .b(x19), .c(new_n89_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n89_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(x18), .c(x16), .O(new_n161_));
