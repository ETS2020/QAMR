...
module FAU ( 
  ...
  nand2  g044(.a(x21), .b(x18), .O(new_n91_));
  ...
  oai22  g051(.a(new_n91_), .b(new_n97_), .c(x18), .d(new_n58_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n89_), .O(new_n99_));
  nor2   g053(.a(x19), .b(x17), .O(new_n100_));
  inv1   g054(.a(x17), .O(new_n101_));
  nand3  g055(.a(new_n56_), .b(new_n52_), .c(new_n101_), .O(new_n102_));
  oai21  g056(.a(new_n100_), .b(new_n56_), .c(new_n102_), .O(new_n103_));
  ...
  nand4  g063(.a(new_n56_), .b(new_n52_), .c(new_n101_), .d(x16), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(x18), .c(new_n47_), .O(new_n112_));
  nand3  g066(.a(new_n102_), .b(x21), .c(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n112_), .c(new_n109_), .O(z11));
  inv1   g068(.a(x03), .O(new_n115_));
  oai22  g069(.a(new_n91_), .b(new_n115_), .c(x18), .d(new_n63_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n89_), .O(new_n117_));
  nand2  g071(.a(new_n102_), .b(x22), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n100_), .c(new_n56_), .O(new_n120_));
  aoi21  g074(.a(new_n120_), .b(new_n118_), .c(x18), .O(new_n121_));
  nor2   g075(.a(new_n65_), .b(new_n47_), .O(new_n122_));
  ...
  nand3  g081(.a(new_n100_), .b(new_n65_), .c(new_n56_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x23), .O(new_n129_));
  nor3   g083(.a(x20), .b(x19), .c(x17), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n47_), .O(new_n132_));
  aoi21  g086(.a(new_n132_), .b(new_n129_), .c(x18), .O(new_n133_));
  nor2   g087(.a(new_n68_), .b(new_n47_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n133_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n127_), .O(z13));
  inv1   g090(.a(x05), .O(new_n137_));
  oai22  g091(.a(new_n91_), .b(new_n137_), .c(x18), .d(new_n73_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n89_), .O(new_n139_));
  nand3  g093(.a(new_n131_), .b(new_n100_), .c(new_n56_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x24), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n119_), .c(new_n130_), .O(new_n143_));
  aoi21  g097(.a(new_n143_), .b(new_n141_), .c(x18), .O(new_n144_));
  nor2   g098(.a(new_n75_), .b(new_n47_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n144_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n139_), .O(z14));
  inv1   g101(.a(x06), .O(new_n148_));
  oai22  g102(.a(new_n91_), .b(new_n148_), .c(x18), .d(new_n80_), .O(new_n149_));
  ...
  nor2   g106(.a(x21), .b(x20), .O(new_n153_));
  nor2   g107(.a(x25), .b(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n153_), .c(new_n131_), .d(new_n100_), .O(new_n155_));
  ...
  oai21  g114(.a(x18), .b(new_n85_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n89_), .O(new_n162_));
  oai21  g116(.a(new_n83_), .b(new_n89_), .c(x21), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x18), .O(new_n164_));
  nand2  g118(.a(new_n153_), .b(new_n100_), .O(new_n165_));
  nand2  g119(.a(new_n155_), .b(x26), .O(new_n166_));
  nor3   g120(.a(x26), .b(x25), .c(x24), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n131_), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n165_), .c(new_n166_), .O(new_n169_));
  ...
  nor2   g126(.a(x18), .b(x17), .O(new_n173_));
  nand3  g127(.a(new_n173_), .b(new_n153_), .c(x19), .O(new_n174_));
  or2    g128(.a(new_n174_), .b(new_n168_), .O(new_n175_));
  aoi21  g129(.a(new_n175_), .b(new_n172_), .c(new_n89_), .O(z17));
endmodule
