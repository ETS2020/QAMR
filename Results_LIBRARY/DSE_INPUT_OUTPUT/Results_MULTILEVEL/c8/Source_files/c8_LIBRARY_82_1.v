...
module FAU ( 
  ...
  oai21  g031(.a(x27), .b(new_n48_), .c(new_n77_), .O(new_n78_));
  nand2  g032(.a(new_n55_), .b(new_n48_), .O(new_n79_));
  ...
  nand2  g037(.a(new_n76_), .b(new_n55_), .O(z08));
  nor2   g038(.a(x25), .b(x18), .O(new_n85_));
  ...
  nand3  g047(.a(new_n54_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  ...
  nand3  g056(.a(new_n102_), .b(new_n76_), .c(x16), .O(new_n103_));
  oai21  g057(.a(new_n98_), .b(x16), .c(new_n103_), .O(z11));
  inv1   g058(.a(x16), .O(new_n105_));
  inv1   g059(.a(new_n85_), .O(new_n106_));
  nand2  g060(.a(x18), .b(x03), .O(new_n107_));
  oai21  g061(.a(new_n106_), .b(new_n63_), .c(new_n107_), .O(new_n108_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n76_), .c(x16), .O(new_n114_));
  ...
  nand2  g105(.a(new_n133_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n120_), .c(new_n100_), .d(new_n91_), .O(new_n154_));
  ...
  nand3  g111(.a(new_n76_), .b(x27), .c(x17), .O(new_n158_));
  nor2   g112(.a(new_n93_), .b(x17), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n153_), .c(new_n120_), .d(new_n100_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n158_), .c(new_n105_), .O(z17));
endmodule
