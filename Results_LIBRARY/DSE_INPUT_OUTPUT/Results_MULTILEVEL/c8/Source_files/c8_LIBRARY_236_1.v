...
module FAU ( 
  ...
  inv1   g35(.a(new_n48_), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n52_), .O(z08));
  inv1   g37(.a(x17), .O(new_n84_));
  nor2   g38(.a(new_n51_), .b(new_n84_), .O(new_n85_));
  ...
  nor2   g44(.a(new_n86_), .b(new_n57_), .O(new_n91_));
  nor3   g45(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand3  g47(.a(new_n47_), .b(new_n88_), .c(x09), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n93_), .O(z10));
  oai21  g49(.a(x18), .b(x10), .c(new_n88_), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n84_), .O(new_n98_));
  nand4  g52(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n84_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n88_), .c(new_n96_), .O(z11));
  oai21  g56(.a(x18), .b(x11), .c(new_n88_), .O(new_n103_));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n86_), .c(new_n57_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n88_), .c(new_n103_), .O(z12));
  oai21  g62(.a(x18), .b(x12), .c(new_n88_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n92_), .c(new_n106_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n88_), .c(new_n109_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n88_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n97_), .d(new_n84_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n113_), .O(z14));
  oai21  g74(.a(x18), .b(x14), .c(new_n88_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n114_), .c(new_n122_), .d(new_n67_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n88_), .c(new_n121_), .O(z15));
  ...
  nand3  g90(.a(new_n47_), .b(new_n88_), .c(x15), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand3  g93(.a(new_n139_), .b(new_n129_), .c(new_n114_), .O(new_n140_));
  nand3  g94(.a(new_n128_), .b(x19), .c(new_n84_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n52_), .d(new_n84_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(new_n82_), .O(z17));
endmodule
