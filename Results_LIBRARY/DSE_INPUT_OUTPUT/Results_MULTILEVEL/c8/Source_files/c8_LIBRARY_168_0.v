...
module FAU ( 
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n90_), .O(z11));
  ...
  nand3  g074(.a(new_n120_), .b(new_n92_), .c(new_n56_), .O(new_n121_));
  ...
  aoi21  g092(.a(new_n130_), .b(new_n110_), .c(new_n138_), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n102_), .d(new_n101_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(new_n90_), .O(z14));
  nand2  g098(.a(x18), .b(x06), .O(new_n145_));
  nand3  g099(.a(new_n86_), .b(x14), .c(x02), .O(new_n146_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n111_), .d(new_n92_), .O(new_n152_));
  ...
  nand2  g111(.a(new_n157_), .b(new_n84_), .O(new_n158_));
  nand2  g112(.a(new_n152_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n111_), .d(new_n92_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n90_), .O(z16));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n150_), .c(new_n138_), .O(new_n166_));
  nand3  g120(.a(new_n111_), .b(x19), .c(new_n101_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n50_), .d(new_n101_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n90_), .c(x16), .O(new_n169_));
