...
module FAU ( 
  ...
  oai21  g027(.a(x27), .b(new_n48_), .c(new_n73_), .O(new_n74_));
  nand2  g028(.a(new_n55_), .b(new_n48_), .O(new_n75_));
  ...
  nand2  g033(.a(new_n72_), .b(new_n55_), .O(z08));
  ...
  nand2  g046(.a(new_n48_), .b(new_n92_), .O(new_n93_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n72_), .c(x16), .O(new_n98_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n72_), .O(z11));
  ...
  nand3  g068(.a(new_n114_), .b(new_n84_), .c(new_n54_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n111_), .c(new_n72_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  oai21  g073(.a(new_n93_), .b(new_n66_), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n72_), .O(z15));
  ...
  nand2  g108(.a(new_n136_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n123_), .c(new_n104_), .d(new_n84_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n72_), .b(x27), .c(x17), .O(new_n161_));
  nor2   g115(.a(new_n82_), .b(x17), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n156_), .c(new_n123_), .d(new_n104_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n161_), .c(new_n86_), .O(z17));
endmodule
