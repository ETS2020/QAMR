...
module FAU ( 
  ...
  nand2  g027(.a(new_n53_), .b(new_n72_), .O(new_n74_));
  nand3  g028(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z04));
  ...
  aoi22  g053(.a(new_n92_), .b(x09), .c(x18), .d(x01), .O(new_n100_));
  inv1   g054(.a(x17), .O(new_n101_));
  nand3  g055(.a(new_n58_), .b(new_n52_), .c(new_n101_), .O(new_n102_));
  oai21  g056(.a(new_n95_), .b(new_n58_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n48_), .c(x16), .O(new_n104_));
  oai21  g058(.a(new_n100_), .b(x16), .c(new_n104_), .O(z10));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n48_), .O(z11));
  ...
  aoi22  g078(.a(new_n92_), .b(x12), .c(x18), .d(x04), .O(new_n125_));
  nand3  g079(.a(new_n121_), .b(x23), .c(x18), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n110_), .c(new_n63_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x16), .O(new_n130_));
  oai21  g084(.a(new_n125_), .b(x16), .c(new_n130_), .O(z13));
  ...
  nand2  g089(.a(new_n121_), .b(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x22), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n110_), .c(new_n63_), .O(new_n138_));
  aoi21  g092(.a(new_n138_), .b(new_n136_), .c(x23), .O(new_n139_));
  nand3  g093(.a(x24), .b(x23), .c(x18), .O(new_n140_));
  ...
  oai21  g098(.a(new_n132_), .b(new_n83_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n106_), .O(new_n146_));
  nand3  g100(.a(new_n78_), .b(new_n68_), .c(new_n63_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n102_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x20), .b(x19), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n149_), .d(new_n101_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n148_), .c(x23), .O(new_n152_));
  nand3  g106(.a(x25), .b(x23), .c(x18), .O(new_n153_));
  ...
  oai21  g111(.a(new_n132_), .b(new_n86_), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n106_), .O(new_n159_));
  nand2  g113(.a(new_n151_), .b(x26), .O(new_n160_));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n137_), .c(new_n111_), .d(new_n95_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n160_), .c(x23), .O(new_n163_));
  nand3  g117(.a(x26), .b(x23), .c(x18), .O(new_n164_));
  ...
  nand4  g124(.a(new_n170_), .b(new_n169_), .c(new_n127_), .d(new_n111_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n168_), .c(new_n106_), .O(z17));
endmodule
