...
module FAU ( 
  ...
  oai21  g47(.a(new_n85_), .b(x02), .c(new_n84_), .O(new_n94_));
  ...
  inv1   g55(.a(x03), .O(new_n102_));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n82_), .c(new_n98_), .d(x22), .O(new_n104_));
  nand2  g58(.a(x18), .b(new_n84_), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n102_), .c(new_n104_), .d(new_n84_), .O(z12));
  inv1   g60(.a(x04), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n82_), .c(new_n89_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n91_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n84_), .c(new_n105_), .d(new_n107_), .O(z13));
  oai21  g66(.a(new_n85_), .b(x05), .c(new_n84_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n91_), .c(new_n68_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n108_), .c(new_n95_), .d(new_n79_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n68_), .c(new_n121_), .d(new_n59_), .O(new_n123_));
  ...
  nand3  g92(.a(new_n138_), .b(new_n129_), .c(new_n68_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n79_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n60_), .d(new_n79_), .O(new_n141_));
