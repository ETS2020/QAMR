...
module FAU ( 
  ...
  nand2  g47(.a(new_n87_), .b(x01), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n93_), .O(z10));
  inv1   g49(.a(x16), .O(new_n96_));
  oai21  g50(.a(new_n86_), .b(x02), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nand4  g53(.a(new_n59_), .b(new_n90_), .c(new_n50_), .d(new_n82_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n96_), .c(new_n97_), .O(z11));
  nand2  g57(.a(new_n100_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n84_), .c(new_n90_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g61(.a(new_n87_), .b(x03), .O(new_n108_));
  oai21  g62(.a(new_n107_), .b(new_n96_), .c(new_n108_), .O(z12));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n92_), .c(new_n106_), .d(x23), .O(new_n111_));
  nand2  g65(.a(new_n87_), .b(x04), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n96_), .c(new_n112_), .O(z13));
  oai21  g67(.a(new_n86_), .b(x05), .c(new_n96_), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n92_), .c(new_n72_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n98_), .d(new_n82_), .O(new_n117_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n72_), .c(new_n121_), .d(new_n64_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n101_), .c(new_n117_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n87_), .b(x06), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n96_), .c(new_n126_), .O(z15));
  oai21  g81(.a(new_n86_), .b(x07), .c(new_n96_), .O(new_n128_));
