...
module FAU ( 
  ...
  nand2  g067(.a(new_n97_), .b(x03), .O(new_n114_));
  ...
  nand2  g075(.a(new_n97_), .b(x04), .O(new_n122_));
  ...
  nand2  g085(.a(new_n97_), .b(x05), .O(new_n132_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n102_), .d(new_n93_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n97_), .b(x06), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n102_), .d(new_n93_), .O(new_n148_));
  ...
  nand3  g107(.a(new_n102_), .b(x19), .c(new_n85_), .O(new_n154_));
