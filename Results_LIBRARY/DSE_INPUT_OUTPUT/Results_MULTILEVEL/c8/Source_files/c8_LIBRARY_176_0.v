...
module FAU ( 
  ...
  aoi21  g064(.a(new_n74_), .b(new_n73_), .c(x22), .O(new_n111_));
  ...
  oai21  g082(.a(new_n85_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g090(.a(new_n74_), .b(x06), .c(new_n83_), .O(new_n137_));
  nand2  g091(.a(new_n133_), .b(x25), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n123_), .c(new_n103_), .d(new_n95_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n88_), .O(z15));
  nand2  g097(.a(x18), .b(x07), .O(new_n144_));
  nand3  g098(.a(new_n74_), .b(x15), .c(x14), .O(new_n145_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n123_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n103_), .b(x19), .c(new_n154_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n150_), .c(new_n51_), .d(new_n154_), .O(new_n156_));
