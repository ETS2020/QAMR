...
module FAU ( 
  ...
  oai21  g031(.a(x27), .b(new_n77_), .c(new_n47_), .O(new_n78_));
  nand2  g032(.a(new_n52_), .b(new_n77_), .O(new_n79_));
  nand3  g033(.a(new_n79_), .b(new_n78_), .c(new_n76_), .O(z06));
  ...
  nand2  g039(.a(new_n76_), .b(new_n52_), .O(z08));
  nor2   g040(.a(x18), .b(x14), .O(new_n87_));
  aoi22  g041(.a(new_n87_), .b(x08), .c(x18), .d(x00), .O(new_n88_));
  xnor2a g042(.a(x19), .b(x17), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n76_), .c(x16), .O(new_n90_));
  oai21  g044(.a(new_n88_), .b(x16), .c(new_n90_), .O(z09));
  ...
  nand3  g054(.a(new_n100_), .b(new_n95_), .c(new_n76_), .O(z10));
  aoi22  g055(.a(new_n87_), .b(x10), .c(x18), .d(x02), .O(new_n102_));
  inv1   g056(.a(x21), .O(new_n103_));
  nor2   g057(.a(x21), .b(x20), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n97_), .O(new_n105_));
  oai21  g059(.a(new_n99_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n76_), .c(x16), .O(new_n107_));
  oai21  g061(.a(new_n102_), .b(x16), .c(new_n107_), .O(z11));
  inv1   g062(.a(new_n87_), .O(new_n109_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n97_), .c(new_n96_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n76_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n112_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  oai21  g073(.a(new_n109_), .b(new_n66_), .c(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n92_), .O(new_n121_));
  nand2  g075(.a(new_n115_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n99_), .c(new_n103_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n76_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n121_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(new_n109_), .b(new_n71_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n92_), .O(new_n130_));
  inv1   g084(.a(x17), .O(new_n131_));
  nand3  g085(.a(new_n96_), .b(new_n51_), .c(new_n131_), .O(new_n132_));
  nand3  g086(.a(new_n68_), .b(new_n63_), .c(new_n103_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n132_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n131_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n76_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n130_), .O(z14));
  inv1   g094(.a(new_n105_), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n123_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  aoi22  g098(.a(new_n144_), .b(new_n141_), .c(new_n137_), .d(x25), .O(new_n145_));
  inv1   g099(.a(x18), .O(new_n146_));
  nor2   g100(.a(new_n146_), .b(x16), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(x06), .c(new_n48_), .O(new_n148_));
  oai21  g102(.a(new_n145_), .b(new_n92_), .c(new_n148_), .O(z15));
  ...
  nand4  g106(.a(new_n142_), .b(new_n123_), .c(new_n104_), .d(new_n97_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n123_), .c(new_n104_), .d(new_n97_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n152_), .c(new_n76_), .O(z16));
  nand4  g113(.a(new_n123_), .b(new_n83_), .c(new_n77_), .d(new_n73_), .O(new_n160_));
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n131_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n131_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n76_), .c(x16), .O(new_n163_));
