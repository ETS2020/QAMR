// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:51 2020
...
module FAU ( 
  ...
  oai21  g053(.a(x16), .b(x10), .c(new_n83_), .O(new_n100_));
  ...
  nand2  g060(.a(new_n89_), .b(x02), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n106_), .c(new_n100_), .O(z11));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n103_), .d(new_n87_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n103_), .d(new_n87_), .O(new_n149_));
  ...
  inv1   g106(.a(x22), .O(new_n153_));
  nand2  g107(.a(new_n68_), .b(new_n153_), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n76_), .c(new_n127_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n85_), .O(new_n158_));
