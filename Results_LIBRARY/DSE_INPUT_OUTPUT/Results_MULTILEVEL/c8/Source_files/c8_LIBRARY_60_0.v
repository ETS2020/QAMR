...
module FAU ( 
  ...
  nand2  g30(.a(new_n60_), .b(new_n76_), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(new_n75_), .c(new_n48_), .O(z07));
  oai21  g32(.a(x18), .b(x16), .c(new_n60_), .O(z08));
