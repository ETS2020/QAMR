...
module FAU ( 
  ...
  aoi21  g037(.a(new_n78_), .b(new_n79_), .c(new_n51_), .O(z08));
  ...
  nor2   g051(.a(new_n88_), .b(new_n56_), .O(new_n98_));
  ...
  nand2  g065(.a(new_n78_), .b(x15), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n62_), .c(new_n111_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n90_), .O(new_n114_));
  nand2  g068(.a(new_n107_), .b(x22), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n88_), .c(new_n56_), .O(new_n117_));
  ...
  oai21  g075(.a(new_n112_), .b(new_n67_), .c(new_n121_), .O(new_n122_));
  ...
  oai21  g084(.a(new_n112_), .b(new_n70_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n90_), .O(new_n132_));
  nand3  g086(.a(new_n56_), .b(new_n50_), .c(new_n86_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n64_), .c(new_n105_), .O(new_n135_));
  ...
  oai21  g097(.a(new_n112_), .b(new_n75_), .c(new_n143_), .O(new_n144_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n125_), .c(new_n106_), .d(new_n88_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n125_), .c(new_n72_), .O(new_n162_));
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n86_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n51_), .d(new_n86_), .O(new_n164_));
