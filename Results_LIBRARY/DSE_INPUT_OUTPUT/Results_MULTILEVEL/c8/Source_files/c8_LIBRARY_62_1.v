...
module FAU ( 
  ...
  nand2  g001(.a(x24), .b(new_n47_), .O(new_n48_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n103_), .c(new_n48_), .O(z10));
  nand2  g061(.a(x18), .b(x02), .O(new_n108_));
  nand2  g062(.a(new_n76_), .b(new_n47_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n61_), .c(new_n108_), .O(new_n110_));
  ...
  nand2  g068(.a(new_n114_), .b(new_n111_), .O(z11));
  ...
  aoi21  g072(.a(x24), .b(new_n47_), .c(x22), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n63_), .c(new_n56_), .d(new_n52_), .O(new_n120_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n94_), .c(new_n56_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x23), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n105_), .c(new_n63_), .O(new_n132_));
  ...
  oai21  g090(.a(new_n109_), .b(new_n78_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n96_), .O(new_n138_));
  nand3  g092(.a(new_n132_), .b(x24), .c(x18), .O(new_n139_));
  nand4  g093(.a(new_n128_), .b(new_n105_), .c(new_n76_), .d(new_n71_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n138_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(new_n109_), .b(new_n83_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  nand3  g100(.a(new_n56_), .b(new_n52_), .c(new_n92_), .O(new_n147_));
  nand3  g101(.a(new_n71_), .b(new_n66_), .c(new_n63_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n147_), .c(x25), .O(new_n149_));
  nor2   g103(.a(x25), .b(x23), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n128_), .c(new_n105_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n149_), .c(x24), .O(new_n152_));
  nand3  g106(.a(x25), .b(x24), .c(x18), .O(new_n153_));
  ...
  oai21  g113(.a(new_n86_), .b(new_n96_), .c(x18), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x24), .O(new_n161_));
  nand2  g115(.a(new_n151_), .b(x26), .O(new_n162_));
  inv1   g116(.a(new_n112_), .O(new_n163_));
  nor3   g117(.a(x26), .b(x25), .c(x24), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n131_), .c(new_n163_), .O(new_n165_));
  ...
  nand2  g122(.a(new_n164_), .b(new_n131_), .O(new_n169_));
  nand4  g123(.a(new_n63_), .b(new_n56_), .c(x19), .d(new_n92_), .O(new_n170_));
  oai22  g124(.a(new_n170_), .b(new_n169_), .c(new_n53_), .d(new_n92_), .O(new_n171_));
