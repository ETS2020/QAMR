...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n91_), .c(new_n50_), .d(new_n82_), .O(new_n100_));
  ...
  nor2   g61(.a(new_n87_), .b(x16), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(x03), .O(new_n109_));
  oai21  g63(.a(new_n107_), .b(new_n86_), .c(new_n109_), .O(z12));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n93_), .c(new_n106_), .d(x23), .O(new_n112_));
  nand2  g66(.a(new_n108_), .b(x04), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n86_), .c(new_n113_), .O(z13));
  oai21  g68(.a(new_n87_), .b(x05), .c(new_n86_), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n93_), .c(new_n72_), .O(new_n116_));
  ...
  nand2  g90(.a(new_n108_), .b(x07), .O(new_n137_));
