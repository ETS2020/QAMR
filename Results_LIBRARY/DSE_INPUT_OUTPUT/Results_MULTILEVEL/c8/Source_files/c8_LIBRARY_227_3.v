...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(new_n63_), .O(new_n93_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n47_), .O(z11));
  oai21  g063(.a(x18), .b(new_n87_), .c(x11), .O(new_n110_));
  inv1   g064(.a(x22), .O(new_n111_));
  aoi21  g065(.a(new_n105_), .b(new_n85_), .c(new_n111_), .O(new_n112_));
  ...
  nand3  g070(.a(x18), .b(new_n87_), .c(x03), .O(new_n117_));
  ...
  oai22  g082(.a(new_n93_), .b(new_n128_), .c(x18), .d(new_n69_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n87_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n111_), .c(new_n103_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n96_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n113_), .c(new_n134_), .d(new_n83_), .O(new_n136_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n123_), .c(new_n105_), .d(new_n85_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n123_), .c(new_n105_), .d(new_n85_), .O(new_n154_));
