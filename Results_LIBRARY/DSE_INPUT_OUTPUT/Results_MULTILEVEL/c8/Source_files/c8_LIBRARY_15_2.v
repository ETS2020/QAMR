...
module FAU ( 
  ...
  oai21  g033(.a(x18), .b(new_n48_), .c(new_n58_), .O(z08));
  ...
  nor2   g058(.a(new_n81_), .b(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x02), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n104_), .c(new_n99_), .O(z11));
  ...
  nand2  g076(.a(new_n105_), .b(x04), .O(new_n123_));
  ...
  aoi21  g080(.a(new_n119_), .b(new_n100_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n112_), .c(new_n94_), .d(new_n93_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n105_), .b(x05), .O(new_n132_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n101_), .d(new_n92_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n105_), .b(x06), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n136_), .c(new_n101_), .d(new_n92_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n105_), .b(x07), .O(new_n149_));
  ...
  nand3  g107(.a(new_n77_), .b(new_n72_), .c(new_n126_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n101_), .b(x19), .c(new_n93_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n58_), .b(new_n93_), .O(new_n158_));
