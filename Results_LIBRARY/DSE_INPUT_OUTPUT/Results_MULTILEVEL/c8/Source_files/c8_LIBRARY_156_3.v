...
module FAU ( 
  ...
  aoi21  g044(.a(new_n90_), .b(new_n88_), .c(new_n87_), .O(new_n91_));
  aoi21  g045(.a(new_n87_), .b(x08), .c(new_n91_), .O(new_n92_));
  nand3  g046(.a(x18), .b(new_n87_), .c(x00), .O(new_n93_));
  oai21  g047(.a(new_n92_), .b(x18), .c(new_n93_), .O(z09));
  ...
  nand3  g057(.a(new_n103_), .b(new_n98_), .c(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n97_), .O(z10));
  oai21  g059(.a(x16), .b(x02), .c(x18), .O(new_n106_));
  ...
  nor2   g065(.a(x18), .b(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x10), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n111_), .c(new_n106_), .O(z11));
  oai21  g068(.a(x16), .b(x03), .c(x18), .O(new_n115_));
  aoi21  g069(.a(new_n108_), .b(new_n100_), .c(new_n65_), .O(new_n116_));
  ...
  nand2  g074(.a(new_n112_), .b(x11), .O(new_n121_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n98_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  oai21  g085(.a(x16), .b(x05), .c(x18), .O(new_n132_));
  aoi21  g086(.a(new_n127_), .b(new_n107_), .c(new_n75_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n117_), .c(new_n101_), .d(new_n89_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n112_), .b(x13), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n137_), .c(new_n132_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n100_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n98_), .c(x16), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n144_), .c(new_n108_), .d(new_n100_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand2  g109(.a(new_n112_), .b(x15), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n144_), .c(new_n75_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n89_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n89_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n98_), .c(x16), .O(new_n162_));
