...
module FAU ( 
  ...
  oai21  g015(.a(new_n61_), .b(new_n51_), .c(new_n47_), .O(new_n62_));
  ...
  nand2  g033(.a(new_n47_), .b(new_n51_), .O(new_n80_));
  ...
  oai21  g039(.a(new_n77_), .b(new_n84_), .c(new_n85_), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n74_), .O(new_n87_));
  nor2   g041(.a(x19), .b(x17), .O(new_n88_));
  inv1   g042(.a(x17), .O(new_n89_));
  nand3  g043(.a(new_n52_), .b(new_n48_), .c(new_n89_), .O(new_n90_));
  oai21  g044(.a(new_n88_), .b(new_n52_), .c(new_n90_), .O(new_n91_));
  nand3  g045(.a(new_n91_), .b(new_n80_), .c(x16), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n87_), .O(z10));
  inv1   g047(.a(x10), .O(new_n94_));
  nand2  g048(.a(x18), .b(x02), .O(new_n95_));
  oai21  g049(.a(new_n77_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  ...
  aoi21  g061(.a(new_n47_), .b(new_n51_), .c(x22), .O(new_n108_));
  ...
  oai21  g069(.a(new_n77_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n80_), .c(x16), .O(new_n123_));
  ...
  aoi21  g082(.a(new_n120_), .b(new_n98_), .c(new_n64_), .O(new_n129_));
  nand4  g083(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n130_));
  nor2   g084(.a(new_n130_), .b(new_n90_), .O(new_n131_));
  ...
  nand3  g106(.a(new_n99_), .b(x19), .c(new_n89_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n149_), .c(new_n47_), .d(new_n89_), .O(new_n154_));
