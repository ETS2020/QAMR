...
module FAU ( 
  ...
  aoi21  g061(.a(new_n102_), .b(new_n91_), .c(new_n63_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n91_), .c(new_n54_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n95_), .b(x03), .O(new_n113_));
  ...
  nand2  g074(.a(new_n95_), .b(x04), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(z13));
  oai21  g076(.a(x16), .b(x13), .c(new_n81_), .O(new_n123_));
  inv1   g077(.a(x24), .O(new_n124_));
  aoi21  g078(.a(new_n117_), .b(new_n93_), .c(new_n124_), .O(new_n125_));
  nor2   g079(.a(x20), .b(x19), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n109_), .c(new_n126_), .d(new_n83_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n125_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n95_), .b(x05), .O(new_n131_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n102_), .d(new_n91_), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n137_), .c(new_n102_), .d(new_n91_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n95_), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  inv1   g104(.a(x23), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n63_), .O(new_n152_));
  inv1   g106(.a(x26), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n74_), .c(new_n124_), .O(new_n154_));
  ...
  nor2   g111(.a(new_n55_), .b(new_n83_), .O(new_n158_));
