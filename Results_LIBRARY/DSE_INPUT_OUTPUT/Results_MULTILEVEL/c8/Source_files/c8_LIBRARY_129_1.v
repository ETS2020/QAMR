...
module FAU ( 
  ...
  oai22  g58(.a(new_n104_), .b(new_n87_), .c(new_n88_), .d(new_n63_), .O(z12));
  ...
  oai22  g63(.a(new_n109_), .b(new_n87_), .c(new_n88_), .d(new_n66_), .O(z13));
  ...
  nand4  g68(.a(new_n114_), .b(new_n106_), .c(new_n97_), .d(new_n83_), .O(new_n115_));
  ...
  nand4  g74(.a(new_n76_), .b(new_n112_), .c(new_n68_), .d(new_n120_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n100_), .c(new_n115_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n87_), .c(new_n119_), .O(z15));
