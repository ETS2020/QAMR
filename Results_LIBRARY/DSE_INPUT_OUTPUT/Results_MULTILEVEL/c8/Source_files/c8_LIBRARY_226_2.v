...
module FAU ( 
  ...
  aoi21  g063(.a(new_n102_), .b(new_n86_), .c(new_n109_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n86_), .c(new_n94_), .O(new_n112_));
  ...
  nand3  g081(.a(new_n63_), .b(new_n109_), .c(new_n100_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n95_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n111_), .c(new_n130_), .d(new_n83_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n102_), .d(new_n86_), .O(new_n141_));
  ...
  nand4  g108(.a(new_n119_), .b(new_n77_), .c(new_n72_), .d(new_n154_), .O(new_n155_));
  nand3  g109(.a(new_n102_), .b(x19), .c(new_n83_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n64_), .d(new_n83_), .O(new_n157_));
