...
module FAU ( 
  ...
  nand2  g036(.a(x18), .b(x07), .O(new_n83_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n86_), .O(z10));
  ...
  nand3  g059(.a(new_n105_), .b(new_n100_), .c(new_n86_), .O(z11));
  ...
  oai21  g102(.a(x18), .b(new_n77_), .c(new_n83_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n120_), .c(new_n102_), .d(new_n93_), .O(new_n153_));
