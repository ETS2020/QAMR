...
module FAU ( 
  ...
  nand2  g025(.a(new_n52_), .b(x25), .O(new_n72_));
  nand2  g026(.a(new_n72_), .b(new_n47_), .O(new_n73_));
  inv1   g027(.a(x25), .O(new_n74_));
  nand3  g028(.a(new_n52_), .b(new_n74_), .c(x14), .O(new_n75_));
  oai21  g029(.a(new_n73_), .b(x14), .c(new_n75_), .O(z06));
  ...
  nand2  g036(.a(x18), .b(x14), .O(new_n83_));
  ...
  oai22  g062(.a(new_n83_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n86_), .c(x16), .O(new_n115_));
  ...
  oai22  g080(.a(new_n83_), .b(new_n126_), .c(x18), .d(new_n69_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n81_), .O(new_n128_));
  inv1   g082(.a(x17), .O(new_n129_));
  nand3  g083(.a(new_n93_), .b(new_n51_), .c(new_n129_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n63_), .c(new_n102_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n112_), .c(new_n134_), .d(new_n129_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n86_), .c(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n128_), .O(z14));
  inv1   g093(.a(x06), .O(new_n140_));
  nand2  g094(.a(x18), .b(new_n140_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n81_), .c(x14), .O(new_n142_));
  nand2  g096(.a(new_n136_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n86_), .O(z15));
  inv1   g102(.a(x07), .O(new_n149_));
  oai22  g103(.a(new_n83_), .b(new_n149_), .c(x18), .d(new_n77_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n154_));
  ...
  nand3  g114(.a(new_n103_), .b(x19), .c(new_n129_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n129_), .O(new_n162_));
