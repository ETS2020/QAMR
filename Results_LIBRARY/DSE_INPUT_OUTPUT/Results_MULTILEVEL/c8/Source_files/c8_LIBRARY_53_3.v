...
module FAU ( 
  ...
  nor2   g043(.a(x16), .b(new_n47_), .O(new_n90_));
  aoi21  g044(.a(new_n89_), .b(x16), .c(new_n90_), .O(new_n91_));
  inv1   g045(.a(x16), .O(new_n92_));
  nand3  g046(.a(x18), .b(new_n92_), .c(x00), .O(new_n93_));
  oai21  g047(.a(new_n91_), .b(x18), .c(new_n93_), .O(z09));
  ...
  nand3  g054(.a(new_n100_), .b(new_n92_), .c(x09), .O(new_n101_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n100_), .c(x16), .O(new_n109_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n96_), .c(new_n54_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n100_), .c(x16), .O(new_n118_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n100_), .c(x16), .O(new_n127_));
  ...
  nand3  g087(.a(new_n54_), .b(new_n133_), .c(new_n132_), .O(new_n134_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n100_), .c(x16), .O(new_n159_));
  ...
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n132_), .O(new_n164_));
  inv1   g118(.a(new_n164_), .O(new_n165_));
  nor2   g119(.a(new_n55_), .b(new_n132_), .O(new_n166_));
  aoi21  g120(.a(new_n165_), .b(new_n163_), .c(new_n166_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n100_), .c(new_n92_), .O(z17));
endmodule
