...
module FAU ( 
  ...
  nand2  g040(.a(new_n56_), .b(x18), .O(new_n87_));
  oai22  g041(.a(new_n87_), .b(new_n86_), .c(x18), .d(new_n49_), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nand2  g043(.a(x20), .b(x18), .O(new_n90_));
  nand3  g044(.a(new_n90_), .b(x19), .c(x17), .O(new_n91_));
  inv1   g045(.a(x17), .O(new_n92_));
  nand3  g046(.a(new_n47_), .b(new_n51_), .c(new_n92_), .O(new_n93_));
  ...
  nor3   g054(.a(new_n100_), .b(new_n56_), .c(x18), .O(new_n101_));
  ...
  oai22  g059(.a(new_n87_), .b(new_n105_), .c(x18), .d(new_n60_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n85_), .O(new_n107_));
  oai21  g061(.a(x19), .b(x17), .c(x21), .O(new_n108_));
  inv1   g062(.a(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n51_), .c(new_n92_), .O(new_n110_));
  aoi21  g064(.a(new_n110_), .b(new_n108_), .c(x20), .O(new_n111_));
  nor3   g065(.a(new_n109_), .b(new_n56_), .c(x18), .O(new_n112_));
  ...
  oai21  g072(.a(new_n65_), .b(new_n85_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x20), .O(new_n120_));
  nand2  g074(.a(new_n110_), .b(x22), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n100_), .c(new_n56_), .O(new_n123_));
  ...
  oai22  g081(.a(new_n87_), .b(new_n127_), .c(x18), .d(new_n68_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n85_), .O(new_n129_));
  nand2  g083(.a(new_n122_), .b(new_n100_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x23), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n100_), .c(new_n109_), .O(new_n133_));
  aoi21  g087(.a(new_n133_), .b(new_n131_), .c(x20), .O(new_n134_));
  inv1   g088(.a(x23), .O(new_n135_));
  nor3   g089(.a(new_n135_), .b(new_n56_), .c(x18), .O(new_n136_));
  ...
  oai21  g095(.a(new_n73_), .b(new_n85_), .c(new_n118_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x20), .O(new_n143_));
  nand2  g097(.a(new_n133_), .b(x24), .O(new_n144_));
  nor2   g098(.a(x24), .b(x23), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n122_), .c(new_n102_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n141_), .O(z14));
  inv1   g103(.a(x06), .O(new_n150_));
  oai22  g104(.a(new_n87_), .b(new_n150_), .c(x18), .d(new_n76_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n85_), .O(new_n152_));
  nand3  g106(.a(new_n73_), .b(new_n135_), .c(new_n65_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n110_), .c(x25), .O(new_n154_));
  nor2   g108(.a(x21), .b(x19), .O(new_n155_));
  nor2   g109(.a(x25), .b(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n132_), .c(new_n155_), .d(new_n92_), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(new_n154_), .c(x20), .O(new_n158_));
  nand2  g112(.a(x25), .b(x20), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n158_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n152_), .O(z15));
  inv1   g116(.a(x07), .O(new_n163_));
  oai22  g117(.a(new_n87_), .b(new_n163_), .c(x18), .d(new_n79_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n85_), .O(new_n165_));
  nand2  g119(.a(new_n157_), .b(x26), .O(new_n166_));
  nor2   g120(.a(x26), .b(x25), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n145_), .c(new_n122_), .d(new_n100_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n166_), .c(x20), .O(new_n169_));
  nor3   g123(.a(new_n81_), .b(new_n56_), .c(x18), .O(new_n170_));
  oai21  g124(.a(new_n170_), .b(new_n169_), .c(x16), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n165_), .O(z16));
  nand4  g126(.a(new_n109_), .b(new_n56_), .c(x19), .d(new_n92_), .O(new_n173_));
  nand3  g127(.a(new_n167_), .b(new_n132_), .c(new_n73_), .O(new_n174_));
  oai22  g128(.a(new_n174_), .b(new_n173_), .c(new_n52_), .d(new_n92_), .O(new_n175_));
  nand2  g129(.a(new_n175_), .b(x16), .O(new_n176_));
  nand2  g130(.a(new_n176_), .b(new_n47_), .O(z17));
endmodule
