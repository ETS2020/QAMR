...
module FAU ( 
  ...
  oai21  g033(.a(x27), .b(new_n47_), .c(new_n79_), .O(new_n80_));
  nand2  g034(.a(new_n52_), .b(new_n47_), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n80_), .c(new_n78_), .O(z06));
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n78_), .O(z09));
  ...
  nand3  g057(.a(new_n103_), .b(new_n51_), .c(new_n89_), .O(new_n104_));
  oai21  g058(.a(new_n91_), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n78_), .c(x16), .O(new_n106_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n78_), .O(z11));
  nand2  g070(.a(x18), .b(x03), .O(new_n117_));
  oai21  g071(.a(new_n100_), .b(new_n63_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n93_), .O(new_n119_));
  nand2  g073(.a(new_n113_), .b(x22), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n91_), .c(new_n103_), .O(new_n122_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n130_), .c(new_n112_), .d(new_n91_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n78_), .O(z15));
  ...
  oai21  g111(.a(new_n85_), .b(new_n93_), .c(x18), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x25), .O(new_n159_));
  nand2  g113(.a(new_n142_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n130_), .c(new_n112_), .d(new_n91_), .O(new_n162_));
  ...
  nand4  g119(.a(new_n130_), .b(new_n85_), .c(new_n47_), .d(new_n75_), .O(new_n166_));
  nand3  g120(.a(new_n112_), .b(x19), .c(new_n89_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n52_), .d(new_n89_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n78_), .O(z17));
endmodule
