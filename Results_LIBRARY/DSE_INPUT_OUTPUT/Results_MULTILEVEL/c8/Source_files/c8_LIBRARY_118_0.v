...
module FAU ( 
  ...
  nor2   g005(.a(x02), .b(x00), .O(new_n52_));
  ...
  aoi21  g033(.a(new_n79_), .b(new_n77_), .c(new_n52_), .O(z07));
  nor2   g034(.a(new_n52_), .b(new_n50_), .O(z08));
  inv1   g035(.a(new_n52_), .O(new_n82_));
  ...
  oai21  g053(.a(x18), .b(x10), .c(x02), .O(new_n100_));
  inv1   g054(.a(x18), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(x10), .c(x00), .O(new_n102_));
  ...
  oai21  g061(.a(new_n97_), .b(new_n105_), .c(new_n107_), .O(new_n108_));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n85_), .c(new_n62_), .O(new_n114_));
  nand2  g068(.a(new_n49_), .b(new_n83_), .O(new_n115_));
  nand3  g069(.a(new_n62_), .b(new_n105_), .c(new_n95_), .O(new_n116_));
  nor2   g070(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  aoi21  g072(.a(new_n118_), .b(new_n113_), .c(new_n52_), .O(z12));
  ...
  oai21  g079(.a(new_n117_), .b(new_n123_), .c(new_n125_), .O(new_n126_));
