...
module FAU ( 
  ...
  oai21  g030(.a(new_n52_), .b(x26), .c(x18), .O(new_n77_));
  ...
  nand3  g035(.a(new_n81_), .b(new_n79_), .c(new_n77_), .O(z07));
  ...
  nand2  g047(.a(new_n78_), .b(x18), .O(new_n94_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n51_), .c(new_n84_), .O(new_n98_));
  oai21  g052(.a(new_n86_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g068(.a(new_n106_), .b(new_n86_), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n113_), .c(new_n47_), .O(z12));
  ...
  nand3  g079(.a(new_n125_), .b(new_n105_), .c(new_n60_), .O(new_n126_));
  ...
  oai22  g096(.a(new_n94_), .b(new_n142_), .c(x18), .d(new_n72_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n88_), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n106_), .d(new_n86_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n94_), .b(new_n151_), .c(x18), .d(new_n80_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n88_), .O(new_n153_));
  inv1   g107(.a(x18), .O(new_n154_));
  nand3  g108(.a(new_n147_), .b(x26), .c(new_n154_), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n125_), .c(new_n106_), .d(new_n86_), .O(new_n157_));
  ...
  nand4  g115(.a(new_n125_), .b(new_n78_), .c(new_n74_), .d(new_n161_), .O(new_n162_));
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n84_), .O(new_n163_));
