...
module FAU ( 
  ...
  nand3  g037(.a(new_n83_), .b(new_n48_), .c(x16), .O(new_n84_));
  ...
  oai22  g051(.a(new_n97_), .b(x00), .c(x18), .d(new_n58_), .O(new_n98_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n54_), .c(new_n102_), .d(new_n101_), .O(new_n103_));
  oai21  g057(.a(new_n94_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  ...
  aoi21  g063(.a(x18), .b(x00), .c(x22), .O(new_n110_));
  nand4  g064(.a(new_n110_), .b(new_n100_), .c(new_n54_), .d(new_n102_), .O(new_n111_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n48_), .O(z12));
  ...
  nand3  g079(.a(new_n125_), .b(new_n118_), .c(new_n48_), .O(z13));
  ...
  aoi21  g084(.a(new_n122_), .b(new_n94_), .c(new_n130_), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n119_), .c(new_n132_), .d(new_n101_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n131_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n129_), .c(new_n48_), .O(z14));
  ...
  nor2   g095(.a(x21), .b(x20), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n92_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n140_), .c(new_n48_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  oai22  g103(.a(new_n149_), .b(x00), .c(x18), .d(new_n79_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n142_), .d(new_n92_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n48_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n151_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n130_), .O(new_n159_));
  nand3  g113(.a(new_n142_), .b(x19), .c(new_n101_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n101_), .O(new_n161_));
