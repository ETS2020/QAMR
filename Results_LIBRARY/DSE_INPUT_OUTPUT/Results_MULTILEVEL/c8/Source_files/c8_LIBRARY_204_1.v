...
module FAU ( 
  ...
  aoi21  g015(.a(x27), .b(new_n47_), .c(new_n61_), .O(new_n62_));
  ...
  aoi22  g022(.a(new_n68_), .b(new_n66_), .c(x18), .d(new_n47_), .O(z03));
  ...
  oai21  g067(.a(new_n105_), .b(new_n111_), .c(new_n113_), .O(new_n114_));
  aoi21  g068(.a(new_n114_), .b(x16), .c(new_n110_), .O(new_n115_));
  inv1   g069(.a(x18), .O(new_n116_));
  nand3  g070(.a(new_n114_), .b(new_n116_), .c(x16), .O(new_n117_));
  oai21  g071(.a(new_n115_), .b(new_n47_), .c(new_n117_), .O(z11));
  ...
  aoi21  g075(.a(x18), .b(new_n47_), .c(x22), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n111_), .c(new_n58_), .d(new_n52_), .O(new_n123_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n93_), .c(new_n58_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x23), .O(new_n133_));
  nor2   g087(.a(x23), .b(x22), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n105_), .c(new_n111_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n130_), .c(new_n48_), .O(z13));
  inv1   g092(.a(x05), .O(new_n139_));
  oai22  g093(.a(new_n101_), .b(new_n139_), .c(x18), .d(new_n75_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n95_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x24), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n131_), .c(new_n105_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n134_), .c(new_n112_), .d(new_n93_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n48_), .O(z15));
  ...
  nand4  g114(.a(new_n134_), .b(new_n85_), .c(new_n80_), .d(new_n77_), .O(new_n161_));
  ...
  nand3  g118(.a(new_n112_), .b(x19), .c(new_n91_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n53_), .d(new_n91_), .O(new_n166_));
