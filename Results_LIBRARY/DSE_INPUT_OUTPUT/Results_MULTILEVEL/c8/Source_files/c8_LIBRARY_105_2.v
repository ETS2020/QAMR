...
module FAU ( 
  ...
  oai21  g006(.a(x27), .b(x19), .c(new_n52_), .O(z00));
  inv1   g007(.a(x20), .O(new_n54_));
  nand2  g008(.a(new_n50_), .b(new_n54_), .O(new_n55_));
  inv1   g009(.a(x09), .O(new_n56_));
  nand2  g010(.a(x27), .b(new_n56_), .O(new_n57_));
  nand2  g011(.a(new_n49_), .b(x19), .O(new_n58_));
  nand3  g012(.a(new_n58_), .b(new_n57_), .c(new_n55_), .O(z01));
  inv1   g013(.a(new_n58_), .O(new_n60_));
  ...
  nand3  g028(.a(new_n74_), .b(new_n72_), .c(new_n58_), .O(z04));
  inv1   g029(.a(x13), .O(new_n76_));
  nor2   g030(.a(x24), .b(x19), .O(new_n77_));
  oai21  g031(.a(new_n77_), .b(new_n51_), .c(new_n76_), .O(new_n78_));
  nand3  g032(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n78_), .O(z05));
  ...
  nand3  g043(.a(new_n89_), .b(new_n87_), .c(new_n58_), .O(z07));
  nor2   g044(.a(new_n60_), .b(new_n50_), .O(z08));
  inv1   g045(.a(x16), .O(new_n92_));
  nand2  g046(.a(x18), .b(x00), .O(new_n93_));
  oai21  g047(.a(x18), .b(new_n47_), .c(new_n93_), .O(new_n94_));
  nand3  g048(.a(new_n94_), .b(new_n58_), .c(new_n92_), .O(new_n95_));
  nand3  g049(.a(x24), .b(x19), .c(x17), .O(new_n96_));
  oai21  g050(.a(x19), .b(x17), .c(new_n96_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n95_), .O(z09));
  ...
  oai21  g056(.a(new_n54_), .b(new_n92_), .c(x24), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x19), .O(new_n104_));
  inv1   g058(.a(x17), .O(new_n105_));
  nor2   g059(.a(new_n54_), .b(new_n105_), .O(new_n106_));
  nor3   g060(.a(x20), .b(x19), .c(x17), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n106_), .c(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n104_), .c(new_n102_), .O(z10));
  nand2  g063(.a(x18), .b(x02), .O(new_n110_));
  oai21  g064(.a(x18), .b(new_n61_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n58_), .c(new_n92_), .O(new_n112_));
  oai21  g066(.a(x20), .b(x17), .c(x21), .O(new_n113_));
  ...
  nand3  g070(.a(x24), .b(x21), .c(x19), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n116_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n112_), .O(z11));
  nand2  g074(.a(x18), .b(x03), .O(new_n121_));
  oai21  g075(.a(x18), .b(new_n66_), .c(new_n121_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n58_), .c(new_n92_), .O(new_n123_));
  nor2   g077(.a(x20), .b(x17), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n68_), .c(new_n63_), .O(new_n125_));
  oai21  g079(.a(new_n114_), .b(new_n68_), .c(new_n125_), .O(new_n126_));
  nand3  g080(.a(x24), .b(x22), .c(x19), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  aoi21  g082(.a(new_n126_), .b(new_n48_), .c(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n92_), .c(new_n123_), .O(z12));
  nand2  g084(.a(x18), .b(x04), .O(new_n131_));
  oai21  g085(.a(x18), .b(new_n73_), .c(new_n131_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n58_), .c(new_n92_), .O(new_n133_));
  nand2  g087(.a(new_n125_), .b(x23), .O(new_n134_));
  nor2   g088(.a(x23), .b(x22), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n124_), .c(new_n63_), .O(new_n136_));
  aoi21  g090(.a(new_n136_), .b(new_n134_), .c(x19), .O(new_n137_));
  nand3  g091(.a(x24), .b(x23), .c(x19), .O(new_n138_));
  ...
  oai21  g098(.a(new_n49_), .b(x16), .c(x19), .O(new_n145_));
  nand2  g099(.a(new_n136_), .b(x24), .O(new_n146_));
  nor2   g100(.a(x24), .b(x23), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n114_), .c(new_n68_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n144_), .O(z14));
  nand2  g105(.a(x18), .b(x06), .O(new_n152_));
  oai21  g106(.a(x18), .b(new_n81_), .c(new_n152_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n58_), .c(new_n92_), .O(new_n154_));
  nand2  g108(.a(new_n136_), .b(x25), .O(new_n155_));
  nor2   g109(.a(x25), .b(x24), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n135_), .c(new_n114_), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(new_n155_), .c(x19), .O(new_n158_));
  nor2   g112(.a(new_n83_), .b(new_n49_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n158_), .c(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n154_), .O(z15));
  nand2  g115(.a(x18), .b(x07), .O(new_n162_));
  oai21  g116(.a(x18), .b(new_n88_), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n92_), .O(new_n164_));
  oai21  g118(.a(new_n86_), .b(new_n92_), .c(x24), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x19), .O(new_n166_));
  nand2  g120(.a(new_n157_), .b(x26), .O(new_n167_));
  inv1   g121(.a(new_n125_), .O(new_n168_));
  nor2   g122(.a(x26), .b(x25), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n147_), .c(new_n168_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(x16), .O(new_n172_));
  nand3  g126(.a(new_n172_), .b(new_n166_), .c(new_n164_), .O(z16));
  nand3  g127(.a(x27), .b(x17), .c(x16), .O(new_n174_));
  nand2  g128(.a(new_n174_), .b(new_n58_), .O(z17));
endmodule
