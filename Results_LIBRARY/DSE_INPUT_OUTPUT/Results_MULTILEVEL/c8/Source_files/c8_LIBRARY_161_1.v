...
module FAU ( 
  ...
  aoi21  g37(.a(x27), .b(new_n83_), .c(new_n49_), .O(new_n84_));
  oai21  g38(.a(x27), .b(x26), .c(new_n84_), .O(z07));
  nor2   g39(.a(new_n49_), .b(new_n55_), .O(z08));
  ...
  oai21  g49(.a(x18), .b(x09), .c(new_n95_), .O(new_n96_));
  nor2   g50(.a(new_n90_), .b(new_n54_), .O(new_n97_));
  ...
  oai21  g54(.a(x18), .b(x10), .c(new_n95_), .O(new_n101_));
  nor2   g55(.a(x20), .b(x19), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n87_), .O(new_n103_));
  nand4  g57(.a(new_n60_), .b(new_n54_), .c(new_n88_), .d(new_n87_), .O(new_n104_));
  ...
  oai21  g61(.a(x18), .b(x11), .c(new_n95_), .O(new_n108_));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n90_), .c(new_n54_), .O(new_n111_));
  ...
  oai22  g69(.a(new_n115_), .b(new_n95_), .c(new_n93_), .d(new_n68_), .O(z13));
  aoi21  g70(.a(new_n114_), .b(new_n98_), .c(new_n75_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n110_), .c(new_n102_), .d(new_n87_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand2  g75(.a(new_n92_), .b(x13), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n121_), .O(z14));
  oai21  g77(.a(x18), .b(x14), .c(new_n95_), .O(new_n124_));
