...
module FAU ( 
  ...
  nor2   g010(.a(new_n47_), .b(new_n51_), .O(z08));
  inv1   g011(.a(z08), .O(new_n58_));
  ...
  nand3  g016(.a(new_n62_), .b(new_n51_), .c(new_n59_), .O(new_n63_));
  oai21  g017(.a(new_n58_), .b(x10), .c(new_n63_), .O(z02));
  nand3  g018(.a(new_n51_), .b(new_n61_), .c(x18), .O(new_n65_));
  ...
  oai21  g055(.a(new_n93_), .b(new_n59_), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g062(.a(new_n59_), .b(new_n83_), .c(x22), .O(new_n109_));
  ...
  nand2  g075(.a(new_n121_), .b(new_n60_), .O(new_n122_));
  nand2  g076(.a(new_n113_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n93_), .c(new_n59_), .O(new_n125_));
  ...
  nand3  g083(.a(x22), .b(new_n60_), .c(x13), .O(new_n130_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n81_), .c(new_n91_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x24), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n112_), .c(new_n93_), .O(new_n137_));
  aoi21  g091(.a(new_n137_), .b(new_n135_), .c(new_n60_), .O(new_n138_));
  and2   g092(.a(x24), .b(x22), .O(new_n139_));
  ...
  nand2  g098(.a(x25), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x22), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n60_), .O(new_n147_));
  nand2  g101(.a(new_n137_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n124_), .c(new_n100_), .d(new_n81_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n144_), .O(z15));
  ...
  nand2  g112(.a(new_n158_), .b(new_n60_), .O(new_n159_));
  nand2  g113(.a(new_n150_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n124_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(new_n101_), .c(new_n160_), .O(new_n163_));
  ...
  nand4  g121(.a(new_n100_), .b(x19), .c(x18), .d(new_n167_), .O(new_n168_));
  or2    g122(.a(new_n168_), .b(new_n162_), .O(new_n169_));
  aoi21  g123(.a(new_n169_), .b(new_n166_), .c(new_n83_), .O(z17));
endmodule
