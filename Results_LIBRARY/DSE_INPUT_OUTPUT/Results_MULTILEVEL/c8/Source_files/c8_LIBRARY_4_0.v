...
module FAU ( 
  ...
  nand2  g32(.a(new_n51_), .b(new_n78_), .O(new_n79_));
  aoi21  g33(.a(new_n79_), .b(new_n77_), .c(new_n47_), .O(z07));
  oai21  g34(.a(x18), .b(x16), .c(new_n51_), .O(z08));
  ...
  nor2   g40(.a(new_n86_), .b(x16), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(x00), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n85_), .O(z09));
  inv1   g43(.a(x16), .O(new_n90_));
  oai21  g44(.a(new_n86_), .b(x01), .c(new_n90_), .O(new_n91_));
  inv1   g45(.a(x20), .O(new_n92_));
  nor2   g46(.a(new_n84_), .b(new_n92_), .O(new_n93_));
  nor3   g47(.a(x20), .b(x19), .c(x17), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n91_), .O(z10));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  inv1   g52(.a(x21), .O(new_n99_));
  nand4  g53(.a(new_n99_), .b(new_n92_), .c(new_n50_), .d(new_n82_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n87_), .b(x02), .O(new_n103_));
  oai21  g57(.a(new_n102_), .b(new_n90_), .c(new_n103_), .O(z11));
  oai21  g58(.a(new_n86_), .b(x03), .c(new_n90_), .O(new_n105_));
  nand2  g59(.a(new_n100_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n84_), .c(new_n92_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n90_), .c(new_n105_), .O(z12));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n94_), .c(new_n108_), .d(x23), .O(new_n112_));
  nand2  g66(.a(new_n87_), .b(x04), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n90_), .c(new_n113_), .O(z13));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n94_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n97_), .d(new_n82_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n87_), .b(x05), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n115_), .c(new_n67_), .d(new_n62_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n87_), .b(x06), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n90_), .c(new_n127_), .O(z15));
  oai21  g82(.a(new_n86_), .b(x07), .c(new_n90_), .O(new_n129_));
  nor2   g83(.a(x21), .b(x20), .O(new_n130_));
  nor2   g84(.a(x23), .b(x22), .O(new_n131_));
  nor2   g85(.a(x25), .b(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n84_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x26), .O(new_n134_));
  nor3   g88(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n131_), .c(new_n130_), .d(new_n84_), .O(new_n136_));
