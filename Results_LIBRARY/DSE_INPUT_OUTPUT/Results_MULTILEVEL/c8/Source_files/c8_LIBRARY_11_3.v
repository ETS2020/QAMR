...
module FAU ( 
  ...
  aoi21  g043(.a(new_n89_), .b(new_n86_), .c(new_n85_), .O(new_n90_));
  aoi21  g044(.a(new_n85_), .b(x08), .c(new_n90_), .O(new_n91_));
  nand3  g045(.a(x18), .b(new_n85_), .c(x00), .O(new_n92_));
  oai21  g046(.a(new_n91_), .b(x18), .c(new_n92_), .O(z09));
  ...
  nand2  g070(.a(new_n99_), .b(x11), .O(new_n117_));
  ...
  nand3  g085(.a(new_n54_), .b(new_n88_), .c(new_n87_), .O(new_n132_));
  nand3  g086(.a(new_n66_), .b(new_n111_), .c(new_n103_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n132_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n113_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n122_), .c(x16), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n124_), .c(new_n104_), .d(new_n95_), .O(new_n144_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n124_), .c(new_n104_), .d(new_n95_), .O(new_n152_));
  ...
  nand4  g110(.a(new_n124_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n157_));
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n87_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n87_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n122_), .c(x16), .O(new_n160_));
