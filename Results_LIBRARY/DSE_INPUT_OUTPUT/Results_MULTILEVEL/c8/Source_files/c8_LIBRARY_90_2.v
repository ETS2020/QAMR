...
module FAU ( 
  ...
  oai21  g046(.a(x16), .b(x09), .c(new_n83_), .O(new_n93_));
  nor2   g047(.a(new_n88_), .b(new_n54_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  nand2  g050(.a(new_n90_), .b(x01), .O(new_n97_));
  ...
  oai21  g056(.a(new_n95_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  nand2  g058(.a(new_n90_), .b(x02), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n104_), .c(new_n99_), .O(z11));
  oai21  g060(.a(x16), .b(x11), .c(new_n83_), .O(new_n107_));
  aoi21  g061(.a(new_n101_), .b(new_n88_), .c(new_n63_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n88_), .c(new_n54_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n90_), .b(x03), .O(new_n113_));
  ...
  aoi21  g079(.a(new_n119_), .b(new_n95_), .c(new_n125_), .O(new_n126_));
  nor2   g080(.a(x20), .b(x19), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n109_), .c(new_n127_), .d(new_n85_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n101_), .d(new_n88_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n90_), .b(x06), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n136_), .c(new_n101_), .d(new_n88_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n90_), .b(x07), .O(new_n149_));
  ...
  nand3  g106(.a(new_n79_), .b(new_n74_), .c(new_n125_), .O(new_n153_));
  ...
  nor2   g110(.a(new_n55_), .b(new_n85_), .O(new_n157_));
