...
module FAU ( 
  ...
  nand2  g039(.a(new_n48_), .b(x27), .O(new_n86_));
  nand2  g040(.a(new_n53_), .b(new_n47_), .O(new_n87_));
  oai22  g041(.a(new_n87_), .b(x18), .c(new_n86_), .d(x15), .O(z07));
  inv1   g042(.a(new_n86_), .O(z08));
  inv1   g043(.a(x16), .O(new_n90_));
  inv1   g044(.a(x00), .O(new_n91_));
  nand2  g045(.a(x26), .b(x18), .O(new_n92_));
  oai22  g046(.a(new_n92_), .b(new_n91_), .c(x18), .d(new_n50_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  xnor2a g048(.a(x19), .b(x17), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n48_), .c(x16), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n94_), .O(z09));
  inv1   g051(.a(x01), .O(new_n98_));
  oai22  g052(.a(new_n92_), .b(new_n98_), .c(x18), .d(new_n56_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n90_), .O(new_n100_));
  nor2   g054(.a(x19), .b(x17), .O(new_n101_));
  inv1   g055(.a(x17), .O(new_n102_));
  nand3  g056(.a(new_n58_), .b(new_n52_), .c(new_n102_), .O(new_n103_));
  oai21  g057(.a(new_n101_), .b(new_n58_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n48_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n100_), .O(z10));
  inv1   g060(.a(x02), .O(new_n107_));
  oai22  g061(.a(new_n92_), .b(new_n107_), .c(x18), .d(new_n61_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n90_), .O(new_n109_));
  inv1   g063(.a(new_n103_), .O(new_n110_));
  ...
  aoi21  g072(.a(new_n47_), .b(x18), .c(x22), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n63_), .c(new_n58_), .d(new_n52_), .O(new_n120_));
  ...
  oai22  g079(.a(new_n92_), .b(new_n125_), .c(x18), .d(new_n71_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n90_), .O(new_n127_));
  nand4  g081(.a(new_n101_), .b(new_n68_), .c(new_n63_), .d(new_n58_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x23), .O(new_n129_));
  nor3   g083(.a(x23), .b(x22), .c(x21), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n110_), .O(new_n131_));
  ...
  aoi21  g091(.a(new_n130_), .b(new_n110_), .c(new_n76_), .O(new_n138_));
  ...
  nand3  g095(.a(new_n141_), .b(new_n137_), .c(new_n48_), .O(z14));
  inv1   g096(.a(x06), .O(new_n143_));
  oai22  g097(.a(new_n92_), .b(new_n143_), .c(x18), .d(new_n83_), .O(new_n144_));
  ...
  nand3  g103(.a(new_n149_), .b(new_n48_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n145_), .O(z15));
  inv1   g105(.a(x07), .O(new_n152_));
  inv1   g106(.a(x15), .O(new_n153_));
  oai22  g107(.a(new_n92_), .b(new_n152_), .c(x18), .d(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n90_), .O(new_n155_));
  nand2  g109(.a(new_n148_), .b(x26), .O(new_n156_));
  nor2   g110(.a(x18), .b(x17), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n111_), .c(new_n52_), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n146_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n158_), .c(new_n156_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n155_), .O(z16));
  nand2  g117(.a(z08), .b(x17), .O(new_n164_));
  nand2  g118(.a(new_n111_), .b(x19), .O(new_n165_));
  inv1   g119(.a(new_n165_), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n159_), .c(new_n157_), .d(new_n146_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n164_), .c(new_n90_), .O(z17));
endmodule
