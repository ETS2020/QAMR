...
module FAU ( 
  ...
  nand3  g067(.a(new_n113_), .b(new_n88_), .c(new_n57_), .O(new_n114_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n95_), .c(new_n100_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n57_), .b(new_n51_), .c(new_n86_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n65_), .c(new_n100_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n113_), .c(new_n134_), .d(new_n86_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n111_), .c(x16), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n122_), .c(new_n101_), .d(new_n88_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n90_), .b(x14), .O(new_n146_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n107_), .O(new_n150_));
  nand2  g104(.a(new_n143_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n122_), .c(new_n101_), .d(new_n88_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n111_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z16));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n122_), .c(new_n73_), .O(new_n158_));
  nand3  g112(.a(new_n101_), .b(x19), .c(new_n86_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n86_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n111_), .c(x16), .O(new_n161_));
