...
module FAU ( 
  ...
  nand3  g043(.a(new_n89_), .b(new_n78_), .c(x16), .O(new_n90_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n78_), .O(z10));
  ...
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n78_), .O(z11));
  ...
  aoi21  g065(.a(new_n104_), .b(new_n87_), .c(new_n60_), .O(new_n112_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n78_), .O(z12));
  oai21  g071(.a(new_n82_), .b(new_n80_), .c(x04), .O(new_n118_));
  ...
  nand3  g077(.a(new_n82_), .b(new_n80_), .c(x12), .O(new_n124_));
  ...
  aoi21  g082(.a(new_n120_), .b(new_n97_), .c(new_n69_), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n113_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n129_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n128_), .c(new_n78_), .O(z14));
  nand2  g090(.a(x18), .b(x06), .O(new_n137_));
  oai21  g091(.a(x18), .b(new_n72_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n80_), .O(new_n139_));
  nand2  g093(.a(new_n133_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x23), .b(x22), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n87_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n139_), .c(new_n78_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  nand3  g101(.a(new_n82_), .b(x15), .c(new_n48_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n80_), .O(new_n150_));
  nand2  g104(.a(new_n143_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n141_), .c(new_n104_), .d(new_n87_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n78_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z16));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n141_), .c(new_n69_), .O(new_n158_));
  nand3  g112(.a(new_n104_), .b(x19), .c(new_n130_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n61_), .d(new_n130_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n78_), .c(x16), .O(new_n161_));
