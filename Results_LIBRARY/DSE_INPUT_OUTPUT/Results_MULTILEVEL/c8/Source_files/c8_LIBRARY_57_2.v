...
module FAU ( 
  ...
  oai21  g051(.a(new_n90_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x16), .O(new_n99_));
  nand2  g053(.a(new_n92_), .b(x02), .O(new_n100_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n88_), .c(new_n87_), .O(new_n107_));
  ...
  nand3  g077(.a(new_n87_), .b(new_n123_), .c(new_n122_), .O(new_n124_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n113_), .c(new_n96_), .d(new_n88_), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n113_), .c(new_n96_), .d(new_n88_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n92_), .b(x07), .O(new_n149_));
  ...
  nand3  g107(.a(new_n96_), .b(x19), .c(new_n122_), .O(new_n154_));
