...
module FAU ( 
  ...
  oai21  g006(.a(new_n52_), .b(new_n51_), .c(new_n47_), .O(new_n53_));
  oai21  g007(.a(new_n47_), .b(x09), .c(new_n53_), .O(z01));
  inv1   g008(.a(x21), .O(new_n55_));
  oai21  g009(.a(new_n55_), .b(new_n51_), .c(new_n47_), .O(new_n56_));
  oai21  g010(.a(new_n47_), .b(x10), .c(new_n56_), .O(z02));
  inv1   g011(.a(x22), .O(new_n58_));
  oai21  g012(.a(new_n58_), .b(new_n51_), .c(new_n47_), .O(new_n59_));
  ...
  oai21  g018(.a(new_n64_), .b(new_n51_), .c(new_n47_), .O(new_n65_));
  ...
  nand3  g052(.a(new_n89_), .b(new_n55_), .c(new_n52_), .O(new_n99_));
  oai21  g053(.a(new_n90_), .b(new_n55_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n81_), .c(x16), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n98_), .O(z11));
  inv1   g056(.a(x11), .O(new_n103_));
  nand2  g057(.a(x18), .b(x03), .O(new_n104_));
  oai21  g058(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n74_), .O(new_n106_));
  inv1   g060(.a(new_n99_), .O(new_n107_));
  nor2   g061(.a(new_n80_), .b(x22), .O(new_n108_));
  nand4  g062(.a(new_n108_), .b(new_n55_), .c(new_n52_), .d(new_n48_), .O(new_n109_));
  oai22  g063(.a(new_n109_), .b(x17), .c(new_n107_), .d(new_n58_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n81_), .O(z12));
  inv1   g066(.a(x12), .O(new_n113_));
  nand2  g067(.a(x18), .b(x04), .O(new_n114_));
  oai21  g068(.a(x18), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n74_), .O(new_n116_));
  nor3   g070(.a(x22), .b(x21), .c(x20), .O(new_n117_));
  aoi21  g071(.a(new_n117_), .b(new_n89_), .c(new_n61_), .O(new_n118_));
  nor2   g072(.a(x23), .b(x22), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n55_), .O(new_n120_));
  nor2   g074(.a(new_n120_), .b(new_n91_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n116_), .c(new_n81_), .O(z13));
  inv1   g077(.a(x13), .O(new_n124_));
  nand2  g078(.a(x18), .b(x05), .O(new_n125_));
  oai21  g079(.a(x18), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n74_), .O(new_n127_));
  nor2   g081(.a(x22), .b(x21), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n90_), .c(new_n64_), .d(new_n61_), .O(new_n129_));
  oai21  g083(.a(new_n121_), .b(new_n64_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n127_), .c(new_n81_), .O(z14));
  inv1   g086(.a(x14), .O(new_n133_));
  nand2  g087(.a(x18), .b(x06), .O(new_n134_));
  oai21  g088(.a(new_n77_), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n74_), .O(new_n136_));
  nand2  g090(.a(new_n129_), .b(x25), .O(new_n137_));
  nand4  g091(.a(new_n119_), .b(new_n107_), .c(new_n67_), .d(new_n64_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n81_), .c(x16), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n136_), .O(z15));
  inv1   g095(.a(x15), .O(new_n142_));
  nand2  g096(.a(x18), .b(x07), .O(new_n143_));
  oai21  g097(.a(new_n77_), .b(new_n142_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n74_), .O(new_n145_));
  nand2  g099(.a(new_n138_), .b(x26), .O(new_n146_));
  nor3   g100(.a(x26), .b(x25), .c(x24), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n119_), .c(new_n107_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n81_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n145_), .O(z16));
  oai21  g105(.a(new_n51_), .b(x17), .c(new_n47_), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n153_));
  nor3   g107(.a(new_n153_), .b(x23), .c(x22), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n55_), .c(new_n52_), .d(x19), .O(new_n155_));
  nand2  g109(.a(x27), .b(x17), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n155_), .c(new_n74_), .O(z17));
endmodule
