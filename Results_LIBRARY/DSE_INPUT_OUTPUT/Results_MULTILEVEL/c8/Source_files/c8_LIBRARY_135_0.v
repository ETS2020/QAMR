...
module FAU ( 
  ...
  inv1   g32(.a(new_n48_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n57_), .O(z08));
  inv1   g34(.a(x00), .O(new_n81_));
  ...
  oai21  g42(.a(new_n88_), .b(new_n81_), .c(new_n86_), .O(z09));
  inv1   g43(.a(x01), .O(new_n90_));
  ...
  oai21  g48(.a(new_n88_), .b(new_n90_), .c(new_n94_), .O(z10));
  inv1   g49(.a(x02), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  nand4  g52(.a(new_n56_), .b(new_n91_), .c(new_n83_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n87_), .c(new_n88_), .d(new_n96_), .O(z11));
  inv1   g56(.a(x03), .O(new_n103_));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n85_), .c(new_n99_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n87_), .c(new_n88_), .d(new_n103_), .O(z12));
  inv1   g60(.a(x18), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(x04), .c(new_n87_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n85_), .c(new_n91_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n93_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n87_), .c(new_n108_), .O(z13));
  oai21  g67(.a(new_n107_), .b(x05), .c(new_n87_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n93_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n109_), .c(new_n97_), .d(new_n82_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n114_), .O(z14));
  oai21  g75(.a(new_n107_), .b(x06), .c(new_n87_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  nand4  g77(.a(new_n73_), .b(new_n115_), .c(new_n65_), .d(new_n123_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n100_), .c(new_n118_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n87_), .c(new_n122_), .O(z15));
  oai21  g81(.a(new_n107_), .b(x07), .c(new_n87_), .O(new_n128_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n130_), .c(new_n115_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n82_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n57_), .d(new_n82_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(new_n79_), .O(z17));
endmodule
