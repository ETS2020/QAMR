...
module FAU ( 
  ...
  nand3  g072(.a(new_n118_), .b(new_n98_), .c(x16), .O(new_n119_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n98_), .c(x16), .O(new_n128_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n63_), .c(new_n104_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n99_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n116_), .c(new_n136_), .d(new_n86_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n98_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n106_), .d(new_n89_), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n125_), .c(new_n106_), .d(new_n89_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n91_), .b(x15), .O(new_n157_));
  ...
  nor2   g117(.a(new_n55_), .b(new_n86_), .O(new_n164_));
  aoi21  g118(.a(new_n163_), .b(new_n161_), .c(new_n164_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n98_), .c(new_n94_), .O(z17));
endmodule
