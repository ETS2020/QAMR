...
module FAU ( 
  ...
  nand2  g47(.a(new_n88_), .b(x01), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n93_), .O(z10));
  inv1   g49(.a(x16), .O(new_n96_));
  oai21  g50(.a(new_n87_), .b(x02), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n83_), .O(new_n99_));
  inv1   g53(.a(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n56_), .c(new_n50_), .d(new_n83_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n99_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n96_), .c(new_n97_), .O(z11));
  oai21  g58(.a(new_n87_), .b(x03), .c(new_n96_), .O(new_n105_));
  nand2  g59(.a(new_n101_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n85_), .c(new_n56_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n96_), .c(new_n105_), .O(z12));
  oai21  g64(.a(new_n87_), .b(x04), .c(new_n96_), .O(new_n111_));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n92_), .c(new_n108_), .d(x23), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n96_), .c(new_n111_), .O(z13));
  oai21  g68(.a(new_n87_), .b(x05), .c(new_n96_), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n92_), .c(new_n72_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n98_), .d(new_n83_), .O(new_n118_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n72_), .c(new_n122_), .d(new_n64_), .O(new_n124_));
  ...
  oai21  g81(.a(new_n126_), .b(new_n96_), .c(new_n127_), .O(z15));
  ...
  nand3  g94(.a(new_n140_), .b(new_n130_), .c(new_n72_), .O(new_n141_));
