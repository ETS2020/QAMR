...
module FAU ( 
  ...
  nand2  g19(.a(new_n54_), .b(new_n65_), .O(new_n66_));
  ...
  nand2  g29(.a(new_n54_), .b(new_n75_), .O(new_n76_));
  ...
  nand2  g34(.a(new_n54_), .b(new_n80_), .O(new_n81_));
  ...
  nor2   g48(.a(new_n87_), .b(new_n53_), .O(new_n95_));
  ...
  oai21  g52(.a(new_n89_), .b(x02), .c(new_n93_), .O(new_n99_));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  inv1   g55(.a(x21), .O(new_n102_));
  nand4  g56(.a(new_n102_), .b(new_n53_), .c(new_n85_), .d(new_n84_), .O(new_n103_));
  ...
  oai21  g60(.a(new_n89_), .b(x03), .c(new_n93_), .O(new_n107_));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n87_), .c(new_n53_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n93_), .c(new_n107_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n96_), .c(new_n110_), .d(x23), .O(new_n114_));
  nand2  g68(.a(new_n90_), .b(x04), .O(new_n115_));
  oai21  g69(.a(new_n114_), .b(new_n93_), .c(new_n115_), .O(z13));
  aoi21  g70(.a(new_n113_), .b(new_n96_), .c(new_n70_), .O(new_n117_));
  ...
  oai21  g77(.a(new_n89_), .b(x06), .c(new_n93_), .O(new_n124_));
  inv1   g78(.a(x22), .O(new_n125_));
  nand4  g79(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n125_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n104_), .c(new_n119_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n93_), .c(new_n124_), .O(z15));
  oai21  g83(.a(new_n89_), .b(x07), .c(new_n93_), .O(new_n130_));
