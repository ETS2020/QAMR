...
module FAU ( 
  ...
  aoi21  g084(.a(new_n124_), .b(new_n104_), .c(new_n130_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n115_), .c(new_n97_), .d(new_n87_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n91_), .b(x05), .O(new_n136_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n89_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n105_), .d(new_n89_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n91_), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand2  g109(.a(new_n70_), .b(new_n65_), .O(new_n156_));
  inv1   g110(.a(x26), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n78_), .c(new_n130_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand3  g113(.a(new_n105_), .b(x19), .c(new_n87_), .O(new_n160_));
