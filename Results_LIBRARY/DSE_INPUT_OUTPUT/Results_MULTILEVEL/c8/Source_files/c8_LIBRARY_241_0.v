...
module FAU ( 
  ...
  nand3  g049(.a(new_n95_), .b(new_n90_), .c(new_n77_), .O(z10));
  ...
  nand3  g058(.a(new_n104_), .b(new_n99_), .c(new_n77_), .O(z11));
  nand2  g059(.a(x18), .b(x03), .O(new_n106_));
  nand3  g060(.a(new_n81_), .b(x11), .c(x05), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n79_), .O(new_n109_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n77_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n109_), .O(z12));
  nand2  g069(.a(x18), .b(x04), .O(new_n116_));
  oai21  g070(.a(x18), .b(new_n60_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n79_), .O(new_n118_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n77_), .O(z13));
  nand2  g078(.a(new_n81_), .b(new_n63_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n79_), .c(x05), .O(new_n126_));
  aoi21  g080(.a(new_n120_), .b(new_n94_), .c(new_n65_), .O(new_n127_));
  inv1   g081(.a(x17), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n111_), .c(new_n129_), .d(new_n128_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n127_), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n126_), .c(new_n77_), .O(z14));
  nand2  g088(.a(x18), .b(x06), .O(new_n135_));
  nand3  g089(.a(new_n81_), .b(x14), .c(x05), .O(new_n136_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n101_), .d(new_n92_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n77_), .c(x16), .O(new_n144_));
  ...
  nand2  g101(.a(new_n147_), .b(new_n79_), .O(new_n148_));
  nand2  g102(.a(new_n142_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n101_), .d(new_n92_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n77_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n140_), .c(new_n65_), .O(new_n156_));
  nand3  g110(.a(new_n101_), .b(x19), .c(new_n128_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n66_), .d(new_n128_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n77_), .c(x16), .O(new_n159_));
