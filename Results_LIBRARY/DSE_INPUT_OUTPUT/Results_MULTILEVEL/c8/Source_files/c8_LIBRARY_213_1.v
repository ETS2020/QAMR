...
module FAU ( 
  ...
  nand2  g066(.a(new_n112_), .b(new_n95_), .O(new_n113_));
  ...
  nand2  g071(.a(x18), .b(x14), .O(new_n118_));
  oai22  g072(.a(new_n118_), .b(new_n117_), .c(x18), .d(new_n66_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n97_), .O(new_n120_));
  nand2  g074(.a(new_n113_), .b(x22), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n95_), .c(new_n56_), .O(new_n123_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n106_), .c(new_n61_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n129_), .c(new_n48_), .O(z13));
  inv1   g089(.a(x05), .O(new_n136_));
  oai22  g090(.a(new_n118_), .b(new_n136_), .c(x18), .d(new_n78_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n97_), .O(new_n138_));
  nand2  g092(.a(new_n132_), .b(x24), .O(new_n139_));
  nor2   g093(.a(x20), .b(x19), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n140_), .d(new_n93_), .O(new_n142_));
  ...
  aoi21  g100(.a(x18), .b(new_n146_), .c(x16), .O(new_n147_));
  nand2  g101(.a(new_n142_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n131_), .c(new_n112_), .d(new_n95_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(x16), .c(new_n147_), .O(new_n152_));
  nand3  g106(.a(new_n151_), .b(new_n81_), .c(x16), .O(new_n153_));
  oai21  g107(.a(new_n152_), .b(new_n47_), .c(new_n153_), .O(z15));
  inv1   g108(.a(x07), .O(new_n155_));
  oai22  g109(.a(new_n118_), .b(new_n155_), .c(x18), .d(new_n87_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n97_), .O(new_n157_));
  nand2  g111(.a(new_n150_), .b(x26), .O(new_n158_));
  nand4  g112(.a(new_n131_), .b(new_n89_), .c(new_n84_), .d(new_n76_), .O(new_n159_));
  ...
  nand3  g116(.a(new_n112_), .b(x19), .c(new_n93_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n53_), .d(new_n93_), .O(new_n164_));
