...
module FAU ( 
  ...
  nor2   g45(.a(new_n86_), .b(new_n57_), .O(new_n92_));
  ...
  nand2  g59(.a(new_n47_), .b(new_n88_), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n63_), .c(new_n105_), .d(new_n88_), .O(z12));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n86_), .c(new_n57_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n93_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n88_), .c(new_n106_), .d(new_n68_), .O(z13));
  ...
  nand4  g70(.a(new_n116_), .b(new_n108_), .c(new_n97_), .d(new_n84_), .O(new_n117_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n114_), .c(new_n70_), .d(new_n65_), .O(new_n122_));
