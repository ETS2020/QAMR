...
module FAU ( 
  ...
  nand4  g52(.a(new_n59_), .b(new_n92_), .c(new_n50_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  nand2  g55(.a(new_n87_), .b(x02), .O(new_n102_));
  oai21  g56(.a(new_n101_), .b(new_n90_), .c(new_n102_), .O(z11));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n84_), .c(new_n92_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g61(.a(new_n87_), .b(x03), .O(new_n108_));
  oai21  g62(.a(new_n107_), .b(new_n90_), .c(new_n108_), .O(z12));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n94_), .c(new_n106_), .d(x23), .O(new_n111_));
  nand2  g65(.a(new_n87_), .b(x04), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n90_), .c(new_n112_), .O(z13));
  aoi21  g67(.a(new_n110_), .b(new_n94_), .c(new_n70_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n105_), .c(new_n97_), .d(new_n82_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n87_), .b(x05), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  inv1   g74(.a(x22), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n70_), .c(new_n122_), .d(new_n121_), .O(new_n124_));
