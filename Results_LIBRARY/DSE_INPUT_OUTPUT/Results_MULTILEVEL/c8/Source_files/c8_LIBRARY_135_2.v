...
module FAU ( 
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n103_), .d(new_n92_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n123_), .b(x07), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n74_), .c(new_n127_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n93_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n58_), .b(new_n93_), .O(new_n159_));
