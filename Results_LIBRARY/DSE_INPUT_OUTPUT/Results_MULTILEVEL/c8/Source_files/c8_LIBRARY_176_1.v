...
module FAU ( 
  ...
  nand2  g044(.a(x18), .b(x14), .O(new_n91_));
  ...
  oai22  g059(.a(new_n91_), .b(new_n105_), .c(x18), .d(new_n61_), .O(new_n106_));
  ...
  oai21  g067(.a(x18), .b(new_n68_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  aoi21  g069(.a(x18), .b(new_n47_), .c(x22), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n63_), .c(new_n58_), .d(new_n52_), .O(new_n117_));
  nand2  g071(.a(new_n109_), .b(x22), .O(new_n118_));
  ...
  oai21  g076(.a(x18), .b(new_n73_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n89_), .O(new_n124_));
  nor2   g078(.a(x22), .b(x21), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n100_), .c(new_n58_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n102_), .c(new_n63_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n124_), .c(new_n48_), .O(z13));
  inv1   g086(.a(x05), .O(new_n133_));
  oai22  g087(.a(new_n91_), .b(new_n133_), .c(x18), .d(new_n78_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n89_), .O(new_n135_));
  nand2  g089(.a(new_n129_), .b(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n125_), .c(new_n102_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n48_), .c(x16), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n135_), .O(z14));
  inv1   g095(.a(x06), .O(new_n142_));
  nand2  g096(.a(x18), .b(new_n142_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n89_), .c(x14), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n128_), .c(new_n108_), .d(new_n100_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n48_), .O(z15));
  inv1   g104(.a(x07), .O(new_n151_));
  oai22  g105(.a(new_n91_), .b(new_n151_), .c(x18), .d(new_n83_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n89_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n128_), .c(new_n76_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n109_), .c(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n48_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z16));
  inv1   g113(.a(x17), .O(new_n160_));
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n160_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n156_), .c(new_n53_), .d(new_n160_), .O(new_n162_));
