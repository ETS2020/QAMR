...
module FAU ( 
  ...
  nand3  g052(.a(new_n57_), .b(new_n51_), .c(new_n98_), .O(new_n99_));
  oai21  g053(.a(new_n97_), .b(new_n57_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n96_), .c(x16), .O(new_n110_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n97_), .c(new_n57_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n96_), .c(x16), .O(new_n119_));
  ...
  nand2  g104(.a(new_n150_), .b(new_n90_), .O(new_n151_));
  nand2  g105(.a(new_n145_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n123_), .c(new_n107_), .d(new_n97_), .O(new_n154_));
  ...
  nand2  g111(.a(new_n72_), .b(new_n67_), .O(new_n158_));
  inv1   g112(.a(x25), .O(new_n159_));
  inv1   g113(.a(x26), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n159_), .c(new_n77_), .O(new_n161_));
  nor2   g115(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand3  g116(.a(new_n107_), .b(x19), .c(new_n98_), .O(new_n163_));
  inv1   g117(.a(new_n163_), .O(new_n164_));
  nor2   g118(.a(new_n52_), .b(new_n98_), .O(new_n165_));
  aoi21  g119(.a(new_n164_), .b(new_n162_), .c(new_n165_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n96_), .c(new_n90_), .O(z17));
endmodule
