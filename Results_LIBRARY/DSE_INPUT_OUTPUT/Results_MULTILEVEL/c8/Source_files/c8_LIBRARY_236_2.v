...
module FAU ( 
  ...
  aoi21  g062(.a(new_n102_), .b(new_n87_), .c(new_n67_), .O(new_n109_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n135_), .c(new_n102_), .d(new_n87_), .O(new_n147_));
  ...
  nand2  g105(.a(new_n151_), .b(new_n67_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n85_), .O(new_n157_));
