...
module FAU ( 
  ...
  aoi21  g029(.a(x27), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  ...
  nand2  g036(.a(new_n48_), .b(new_n55_), .O(z08));
  ...
  nand2  g048(.a(new_n75_), .b(x18), .O(new_n95_));
  oai22  g049(.a(new_n95_), .b(new_n94_), .c(x18), .d(new_n52_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n89_), .O(new_n97_));
  nand3  g051(.a(new_n54_), .b(new_n85_), .c(new_n84_), .O(new_n98_));
  oai21  g052(.a(new_n87_), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n48_), .O(z11));
  inv1   g064(.a(x03), .O(new_n111_));
  oai22  g065(.a(new_n95_), .b(new_n111_), .c(x18), .d(new_n63_), .O(new_n112_));
  ...
  oai22  g074(.a(new_n95_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  ...
  oai22  g083(.a(new_n95_), .b(new_n129_), .c(x18), .d(new_n71_), .O(new_n130_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n84_), .O(new_n137_));
  ...
  nand2  g095(.a(new_n74_), .b(x14), .O(new_n142_));
  oai21  g096(.a(new_n95_), .b(new_n141_), .c(new_n142_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n89_), .O(new_n144_));
  nand3  g098(.a(new_n137_), .b(x25), .c(new_n74_), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n124_), .c(new_n106_), .d(new_n87_), .O(new_n147_));
  ...
  oai21  g107(.a(new_n80_), .b(new_n89_), .c(new_n74_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x25), .O(new_n155_));
  nand2  g109(.a(new_n137_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n124_), .c(new_n106_), .d(new_n87_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n153_), .O(z16));
  inv1   g115(.a(x24), .O(new_n162_));
  nand4  g116(.a(new_n124_), .b(new_n80_), .c(new_n75_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n84_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n84_), .O(new_n165_));
