...
module FAU ( 
  ...
  oai21  g035(.a(x18), .b(new_n48_), .c(new_n55_), .O(z08));
  ...
  oai21  g051(.a(new_n95_), .b(new_n54_), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g065(.a(new_n105_), .b(new_n95_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n95_), .c(new_n54_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nor2   g070(.a(new_n83_), .b(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x03), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n116_), .c(new_n110_), .O(z12));
  ...
  nand4  g086(.a(new_n132_), .b(new_n113_), .c(new_n96_), .d(new_n85_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n117_), .b(x05), .O(new_n136_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n95_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n105_), .d(new_n95_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n117_), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  inv1   g109(.a(x23), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n111_), .O(new_n157_));
  nand3  g111(.a(new_n79_), .b(new_n74_), .c(new_n130_), .O(new_n158_));
