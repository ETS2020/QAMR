...
module FAU ( 
  ...
  nand2  g062(.a(new_n101_), .b(x02), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n108_), .c(new_n104_), .O(z11));
  oai21  g064(.a(x16), .b(x11), .c(new_n87_), .O(new_n111_));
  aoi21  g065(.a(new_n105_), .b(new_n97_), .c(new_n65_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n97_), .c(new_n54_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n101_), .b(x03), .O(new_n117_));
  ...
  nand2  g074(.a(new_n120_), .b(new_n48_), .O(new_n121_));
  nand2  g075(.a(new_n114_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n99_), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n54_), .b(new_n90_), .c(new_n89_), .O(new_n131_));
  nand3  g085(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n113_), .c(new_n134_), .d(new_n89_), .O(new_n136_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n48_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(x18), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z16));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n123_), .c(new_n75_), .O(new_n158_));
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n89_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n89_), .O(new_n160_));
