...
module FAU ( 
  ...
  nand2  g005(.a(x18), .b(x05), .O(new_n52_));
  ...
  aoi21  g022(.a(new_n68_), .b(new_n66_), .c(new_n53_), .O(z03));
  ...
  aoi21  g027(.a(new_n73_), .b(new_n71_), .c(new_n53_), .O(z04));
  ...
  aoi21  g032(.a(x27), .b(new_n78_), .c(new_n53_), .O(new_n79_));
  oai21  g033(.a(x27), .b(x25), .c(new_n79_), .O(z06));
  inv1   g034(.a(x15), .O(new_n81_));
  aoi21  g035(.a(x27), .b(new_n81_), .c(new_n53_), .O(new_n82_));
  oai21  g036(.a(x27), .b(x26), .c(new_n82_), .O(z07));
  nand2  g037(.a(new_n52_), .b(new_n50_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n52_), .O(z09));
  inv1   g047(.a(x01), .O(new_n94_));
  inv1   g048(.a(x05), .O(new_n95_));
  nand2  g049(.a(x18), .b(new_n95_), .O(new_n96_));
  oai22  g050(.a(new_n96_), .b(new_n94_), .c(x18), .d(new_n55_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  nand3  g052(.a(new_n57_), .b(new_n49_), .c(new_n85_), .O(new_n99_));
  oai21  g053(.a(new_n87_), .b(new_n57_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n52_), .c(x16), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n98_), .O(z10));
  inv1   g056(.a(x02), .O(new_n103_));
  oai22  g057(.a(new_n96_), .b(new_n103_), .c(x18), .d(new_n60_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  nor3   g059(.a(x20), .b(x19), .c(x17), .O(new_n106_));
  nand4  g060(.a(new_n62_), .b(new_n57_), .c(new_n49_), .d(new_n85_), .O(new_n107_));
  oai21  g061(.a(new_n106_), .b(new_n62_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n52_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n105_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  oai21  g065(.a(x18), .b(new_n65_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n89_), .O(new_n113_));
  aoi21  g067(.a(x18), .b(x05), .c(x22), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n62_), .c(new_n57_), .d(new_n49_), .O(new_n115_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n52_), .O(z12));
  inv1   g073(.a(x04), .O(new_n120_));
  oai22  g074(.a(new_n96_), .b(new_n120_), .c(x18), .d(new_n70_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n89_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n87_), .c(new_n57_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x23), .O(new_n125_));
  nor2   g079(.a(x23), .b(x22), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n106_), .c(new_n62_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n52_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n122_), .O(z13));
  nand3  g084(.a(new_n72_), .b(new_n67_), .c(new_n62_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n99_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n123_), .c(new_n133_), .d(new_n85_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n52_), .c(x16), .O(new_n137_));
  inv1   g091(.a(x18), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n89_), .c(x13), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(z14));
  nand2  g094(.a(x18), .b(x06), .O(new_n141_));
  oai21  g095(.a(x18), .b(new_n78_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n89_), .O(new_n143_));
  nand2  g097(.a(new_n135_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x21), .b(x20), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n126_), .c(new_n145_), .d(new_n87_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n52_), .O(z15));
  ...
  nand4  g109(.a(new_n155_), .b(new_n126_), .c(new_n145_), .d(new_n87_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n52_), .O(z16));
  inv1   g113(.a(x24), .O(new_n160_));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n126_), .c(new_n160_), .O(new_n162_));
  nand3  g116(.a(new_n145_), .b(x19), .c(new_n85_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n85_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n52_), .c(x16), .O(new_n165_));
