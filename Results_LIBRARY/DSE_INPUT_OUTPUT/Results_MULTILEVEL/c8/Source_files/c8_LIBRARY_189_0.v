...
module FAU ( 
  ...
  oai21  g44(.a(new_n90_), .b(x01), .c(new_n87_), .O(new_n91_));
  ...
  oai21  g50(.a(new_n90_), .b(x02), .c(new_n87_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n83_), .O(new_n99_));
  nand4  g53(.a(new_n59_), .b(new_n92_), .c(new_n50_), .d(new_n83_), .O(new_n100_));
  ...
  oai21  g57(.a(new_n90_), .b(x03), .c(new_n87_), .O(new_n104_));
  ...
  oai21  g67(.a(new_n90_), .b(x05), .c(new_n87_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n94_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n98_), .d(new_n83_), .O(new_n118_));
  ...
  oai21  g75(.a(new_n90_), .b(x06), .c(new_n87_), .O(new_n122_));
  inv1   g76(.a(x23), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n115_), .c(new_n123_), .d(new_n64_), .O(new_n125_));
  ...
  oai21  g82(.a(new_n90_), .b(x07), .c(new_n87_), .O(new_n129_));
