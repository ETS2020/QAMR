...
module FAU ( 
  ...
  oai21  g43(.a(new_n89_), .b(new_n47_), .c(new_n87_), .O(z09));
  ...
  oai21  g48(.a(new_n89_), .b(new_n52_), .c(new_n94_), .O(z10));
  inv1   g49(.a(x16), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n83_), .O(new_n98_));
  nand4  g52(.a(new_n57_), .b(new_n91_), .c(new_n84_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n96_), .c(new_n89_), .d(new_n55_), .O(z11));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n86_), .c(new_n99_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n96_), .c(new_n89_), .d(new_n61_), .O(z12));
  oai21  g59(.a(x18), .b(x12), .c(new_n96_), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n86_), .c(new_n91_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n96_), .c(new_n106_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n96_), .O(new_n112_));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n109_), .b(new_n93_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n107_), .c(new_n97_), .d(new_n83_), .O(new_n116_));
  ...
  nand4  g74(.a(new_n74_), .b(new_n113_), .c(new_n66_), .d(new_n120_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n100_), .c(new_n116_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n88_), .b(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n96_), .c(new_n124_), .O(z15));
  nor2   g79(.a(x21), .b(x20), .O(new_n126_));
  nor2   g80(.a(x23), .b(x22), .O(new_n127_));
  nor2   g81(.a(x25), .b(x24), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n86_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n127_), .c(new_n126_), .d(new_n86_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g88(.a(new_n88_), .b(x15), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  nor2   g90(.a(new_n84_), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n131_), .c(new_n127_), .d(new_n126_), .O(new_n138_));
  nand2  g92(.a(x27), .b(x17), .O(new_n139_));
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n96_), .O(z17));
endmodule
