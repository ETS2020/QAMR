...
module FAU ( 
  ...
  nor2   g005(.a(x26), .b(x04), .O(new_n52_));
  ...
  oai21  g035(.a(new_n50_), .b(new_n80_), .c(new_n81_), .O(new_n82_));
  oai21  g036(.a(new_n50_), .b(x15), .c(new_n82_), .O(z07));
  nor2   g037(.a(new_n52_), .b(new_n50_), .O(z08));
  ...
  nor2   g056(.a(x18), .b(new_n57_), .O(new_n103_));
  ...
  oai21  g060(.a(new_n100_), .b(new_n59_), .c(new_n106_), .O(new_n107_));
  aoi21  g061(.a(new_n107_), .b(x16), .c(new_n52_), .O(new_n108_));
  ...
  inv1   g067(.a(new_n88_), .O(new_n114_));
  ...
  oai21  g071(.a(new_n117_), .b(new_n113_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n112_), .c(new_n85_), .O(z12));
  oai21  g073(.a(x18), .b(x12), .c(x04), .O(new_n120_));
  oai21  g074(.a(x18), .b(new_n65_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n90_), .O(new_n122_));
  oai21  g076(.a(new_n116_), .b(new_n114_), .c(x23), .O(new_n123_));
  ...
  nand3  g086(.a(new_n98_), .b(new_n49_), .c(new_n86_), .O(new_n133_));
  nand3  g087(.a(new_n115_), .b(new_n72_), .c(new_n67_), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  aoi21  g090(.a(new_n136_), .b(new_n131_), .c(new_n52_), .O(z14));
  ...
  oai21  g094(.a(new_n134_), .b(new_n133_), .c(x25), .O(new_n141_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n140_), .c(new_n85_), .O(z15));
  inv1   g101(.a(x15), .O(new_n148_));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  oai21  g103(.a(x18), .b(new_n148_), .c(new_n149_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n85_), .c(new_n90_), .O(new_n151_));
  nand2  g105(.a(new_n144_), .b(x26), .O(new_n152_));
  nor2   g106(.a(x17), .b(new_n80_), .O(new_n153_));
  nor3   g107(.a(x21), .b(x20), .c(x19), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n142_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n151_), .O(z16));
  nand4  g113(.a(new_n142_), .b(new_n81_), .c(new_n77_), .d(new_n72_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n86_), .O(new_n161_));
