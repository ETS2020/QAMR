...
module FAU ( 
  ...
  nand3  g023(.a(new_n69_), .b(new_n67_), .c(new_n54_), .O(z03));
  ...
  nand3  g028(.a(new_n74_), .b(new_n72_), .c(new_n54_), .O(z04));
  ...
  nand3  g033(.a(new_n79_), .b(new_n77_), .c(new_n54_), .O(z05));
  ...
  nand3  g038(.a(new_n84_), .b(new_n82_), .c(new_n54_), .O(z06));
  ...
  nand3  g043(.a(new_n89_), .b(new_n87_), .c(new_n54_), .O(z07));
  ...
  nor2   g049(.a(new_n53_), .b(x16), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(x00), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n95_), .O(z09));
  oai21  g052(.a(new_n53_), .b(x01), .c(new_n52_), .O(new_n99_));
  nor2   g053(.a(new_n94_), .b(new_n56_), .O(new_n100_));
  ...
  oai21  g057(.a(new_n53_), .b(x02), .c(new_n52_), .O(new_n104_));
  nor2   g058(.a(x20), .b(x19), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  nand4  g060(.a(new_n61_), .b(new_n56_), .c(new_n47_), .d(new_n92_), .O(new_n107_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n94_), .c(new_n56_), .O(new_n113_));
  and2   g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g068(.a(new_n96_), .b(x03), .O(new_n115_));
  oai21  g069(.a(new_n114_), .b(new_n52_), .c(new_n115_), .O(z12));
  oai21  g070(.a(new_n53_), .b(x04), .c(new_n52_), .O(new_n117_));
  nor3   g071(.a(x23), .b(x22), .c(x21), .O(new_n118_));
  aoi22  g072(.a(new_n118_), .b(new_n101_), .c(new_n113_), .d(x23), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n52_), .c(new_n117_), .O(z13));
  aoi21  g074(.a(new_n118_), .b(new_n101_), .c(new_n76_), .O(new_n121_));
  nor2   g075(.a(x24), .b(x23), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n112_), .c(new_n105_), .d(new_n92_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n96_), .b(x05), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n125_), .O(z14));
  oai21  g081(.a(new_n53_), .b(x06), .c(new_n52_), .O(new_n128_));
  nand4  g082(.a(new_n81_), .b(new_n76_), .c(new_n71_), .d(new_n66_), .O(new_n129_));
  ...
  oai21  g086(.a(new_n53_), .b(x07), .c(new_n52_), .O(new_n133_));
  ...
  nand4  g097(.a(new_n135_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n144_));
  ...
  nand2  g101(.a(new_n147_), .b(new_n54_), .O(z17));
endmodule
