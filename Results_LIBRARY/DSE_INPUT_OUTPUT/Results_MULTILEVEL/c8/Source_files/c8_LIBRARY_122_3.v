...
module FAU ( 
  ...
  nand2  g062(.a(new_n88_), .b(x10), .O(new_n109_));
  ...
  nand2  g079(.a(new_n88_), .b(x12), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n120_), .O(z13));
  oai21  g081(.a(x16), .b(x05), .c(x18), .O(new_n128_));
  aoi21  g082(.a(new_n122_), .b(new_n104_), .c(new_n73_), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n115_), .c(new_n97_), .d(new_n84_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n105_), .d(new_n86_), .O(new_n140_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n138_), .c(new_n105_), .d(new_n86_), .O(new_n150_));
