...
module FAU ( 
  ...
  aoi22  g61(.a(new_n107_), .b(new_n88_), .c(new_n103_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n84_), .c(new_n106_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n84_), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  aoi21  g65(.a(new_n107_), .b(new_n88_), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n93_), .d(new_n79_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n111_), .c(new_n119_), .d(new_n63_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n97_), .c(new_n114_), .d(x25), .O(new_n123_));
  ...
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n55_), .d(new_n79_), .O(new_n140_));
