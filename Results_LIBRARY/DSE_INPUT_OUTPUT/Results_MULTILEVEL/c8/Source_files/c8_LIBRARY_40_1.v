...
module FAU ( 
  ...
  nand2  g33(.a(new_n52_), .b(new_n79_), .O(new_n80_));
  aoi21  g34(.a(new_n80_), .b(new_n78_), .c(new_n48_), .O(z07));
  ...
  oai21  g42(.a(new_n88_), .b(new_n49_), .c(new_n86_), .O(z09));
  inv1   g43(.a(x16), .O(new_n90_));
  oai21  g44(.a(x18), .b(x09), .c(new_n90_), .O(new_n91_));
  inv1   g45(.a(x20), .O(new_n92_));
  nor2   g46(.a(new_n85_), .b(new_n92_), .O(new_n93_));
  ...
  oai21  g50(.a(x18), .b(x10), .c(new_n90_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n83_), .O(new_n99_));
  inv1   g53(.a(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n92_), .c(new_n51_), .d(new_n83_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n99_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n90_), .c(new_n97_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n85_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n90_), .c(new_n88_), .d(new_n61_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n90_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n85_), .c(new_n92_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n94_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n90_), .c(new_n108_), .O(z13));
  aoi21  g67(.a(new_n111_), .b(new_n94_), .c(new_n71_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n109_), .c(new_n98_), .d(new_n83_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n87_), .b(x13), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  oai21  g74(.a(x18), .b(x14), .c(new_n90_), .O(new_n121_));
  inv1   g75(.a(x22), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n71_), .c(new_n66_), .d(new_n122_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n90_), .c(new_n121_), .O(z15));
  ...
  nand2  g90(.a(new_n87_), .b(x15), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  inv1   g92(.a(new_n48_), .O(new_n139_));
  nand4  g93(.a(new_n129_), .b(new_n79_), .c(new_n123_), .d(new_n71_), .O(new_n140_));
