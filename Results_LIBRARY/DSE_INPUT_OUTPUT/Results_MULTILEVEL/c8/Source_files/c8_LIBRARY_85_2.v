...
module FAU ( 
  ...
  aoi22  g042(.a(new_n88_), .b(new_n86_), .c(new_n52_), .d(x16), .O(z07));
  ...
  oai21  g052(.a(x16), .b(x09), .c(new_n52_), .O(new_n99_));
  ...
  nand2  g056(.a(new_n96_), .b(x01), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n102_), .c(new_n99_), .O(z10));
  oai21  g058(.a(x16), .b(x10), .c(new_n52_), .O(new_n105_));
  nor2   g059(.a(x21), .b(x20), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n94_), .O(new_n107_));
  oai21  g061(.a(new_n101_), .b(new_n60_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g063(.a(new_n96_), .b(x02), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n109_), .c(new_n105_), .O(z11));
  inv1   g065(.a(x16), .O(new_n112_));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  oai21  g067(.a(x18), .b(new_n67_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g069(.a(new_n107_), .b(x22), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n94_), .c(new_n55_), .O(new_n118_));
  ...
  oai21  g095(.a(x16), .b(x14), .c(new_n52_), .O(new_n142_));
  ...
  nand2  g101(.a(new_n96_), .b(x06), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n147_), .c(new_n142_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  oai21  g104(.a(x18), .b(new_n85_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n112_), .O(new_n152_));
  nand2  g106(.a(new_n145_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n106_), .d(new_n94_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n124_), .b(new_n87_), .c(new_n80_), .d(new_n75_), .O(new_n159_));
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n92_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n48_), .d(new_n92_), .O(new_n161_));
