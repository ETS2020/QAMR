...
module FAU ( 
  ...
  oai21  g013(.a(new_n59_), .b(x18), .c(new_n57_), .O(z02));
  ...
  nand2  g038(.a(x18), .b(new_n55_), .O(new_n85_));
  ...
  oai21  g055(.a(x18), .b(new_n83_), .c(x10), .O(new_n102_));
  ...
  nand3  g061(.a(x18), .b(new_n83_), .c(x02), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n107_), .c(new_n102_), .O(z11));
  inv1   g063(.a(x03), .O(new_n110_));
  oai22  g064(.a(new_n85_), .b(new_n110_), .c(x18), .d(new_n61_), .O(new_n111_));
  ...
  oai22  g073(.a(new_n85_), .b(new_n119_), .c(x18), .d(new_n64_), .O(new_n120_));
  ...
  nand2  g077(.a(new_n123_), .b(new_n103_), .O(new_n124_));
  ...
  aoi21  g085(.a(new_n123_), .b(new_n103_), .c(new_n131_), .O(new_n132_));
  ...
  oai22  g092(.a(new_n85_), .b(new_n138_), .c(x18), .d(new_n72_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n104_), .d(new_n95_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n104_), .d(new_n95_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n142_), .b(new_n79_), .c(new_n74_), .d(new_n131_), .O(new_n157_));
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n96_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n58_), .d(new_n96_), .O(new_n159_));
