...
module FAU ( 
  ...
  nand2  g014(.a(new_n55_), .b(x22), .O(new_n61_));
  nand2  g015(.a(new_n61_), .b(new_n48_), .O(new_n62_));
  inv1   g016(.a(x22), .O(new_n63_));
  nand3  g017(.a(new_n55_), .b(new_n63_), .c(x11), .O(new_n64_));
  oai21  g018(.a(new_n62_), .b(x11), .c(new_n64_), .O(z03));
  ...
  nand3  g055(.a(new_n101_), .b(new_n98_), .c(new_n84_), .O(z10));
  inv1   g056(.a(x02), .O(new_n103_));
  nand2  g057(.a(x18), .b(x11), .O(new_n104_));
  ...
  oai21  g066(.a(new_n48_), .b(x03), .c(new_n91_), .O(new_n113_));
  ...
  aoi21  g072(.a(new_n108_), .b(new_n89_), .c(new_n63_), .O(new_n119_));
  nand3  g073(.a(new_n87_), .b(new_n48_), .c(new_n86_), .O(new_n120_));
  nor2   g074(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n119_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n118_), .c(new_n84_), .O(z12));
  ...
  nand3  g080(.a(new_n115_), .b(new_n89_), .c(new_n54_), .O(new_n127_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n126_), .c(new_n84_), .O(z13));
  ...
  aoi21  g091(.a(new_n129_), .b(new_n100_), .c(new_n137_), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n115_), .c(new_n139_), .d(new_n86_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n138_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n136_), .c(new_n84_), .O(z14));
  inv1   g098(.a(x06), .O(new_n145_));
  oai22  g099(.a(new_n104_), .b(new_n145_), .c(x18), .d(new_n74_), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n108_), .d(new_n89_), .O(new_n151_));
  ...
  oai22  g109(.a(new_n104_), .b(new_n155_), .c(x18), .d(new_n79_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n159_), .b(new_n149_), .c(new_n108_), .d(new_n89_), .O(new_n160_));
  ...
  nand4  g117(.a(new_n149_), .b(new_n81_), .c(new_n76_), .d(new_n137_), .O(new_n164_));
  nand3  g118(.a(new_n108_), .b(x19), .c(new_n86_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n55_), .d(new_n86_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n84_), .O(z17));
endmodule
