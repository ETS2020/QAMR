...
module FAU ( 
  ...
  nand2  g029(.a(new_n51_), .b(x25), .O(new_n76_));
  nand3  g030(.a(new_n76_), .b(x18), .c(new_n75_), .O(new_n77_));
  inv1   g031(.a(x25), .O(new_n78_));
  nand3  g032(.a(new_n51_), .b(new_n78_), .c(x14), .O(new_n79_));
  ...
  nand2  g044(.a(new_n90_), .b(x14), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n48_), .c(new_n89_), .O(new_n92_));
  ...
  oai21  g059(.a(new_n91_), .b(new_n59_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g069(.a(new_n90_), .b(new_n75_), .c(x22), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n61_), .c(new_n56_), .d(new_n50_), .O(new_n117_));
  ...
  oai21  g076(.a(new_n91_), .b(new_n69_), .c(new_n122_), .O(new_n123_));
  ...
  oai21  g087(.a(new_n91_), .b(new_n72_), .c(new_n133_), .O(new_n134_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n86_), .c(x16), .O(new_n140_));
  ...
  nand3  g105(.a(new_n90_), .b(x15), .c(x14), .O(new_n152_));
  ...
  nand4  g110(.a(new_n128_), .b(new_n83_), .c(new_n78_), .d(new_n156_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n108_), .b(x19), .c(new_n161_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n157_), .c(new_n51_), .d(new_n161_), .O(new_n163_));
