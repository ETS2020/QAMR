...
module FAU ( 
  ...
  nand2  g049(.a(x20), .b(new_n47_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(x19), .c(x17), .O(new_n97_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n95_), .c(new_n48_), .O(z09));
  nand2  g056(.a(x18), .b(x01), .O(new_n103_));
  nand2  g057(.a(new_n57_), .b(new_n47_), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n56_), .c(new_n103_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  nor3   g060(.a(new_n98_), .b(new_n57_), .c(new_n47_), .O(new_n107_));
  nor3   g061(.a(x20), .b(x19), .c(x17), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n107_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n106_), .O(z10));
  ...
  nor3   g067(.a(x21), .b(x19), .c(x17), .O(new_n114_));
  aoi21  g068(.a(new_n99_), .b(x21), .c(new_n114_), .O(new_n115_));
  nand3  g069(.a(x21), .b(x20), .c(x18), .O(new_n116_));
  oai21  g070(.a(new_n115_), .b(x20), .c(new_n116_), .O(new_n117_));
  ...
  oai21  g076(.a(new_n68_), .b(new_n92_), .c(x18), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x20), .O(new_n124_));
  nor2   g078(.a(x22), .b(x21), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n98_), .c(new_n57_), .O(new_n126_));
  oai21  g080(.a(new_n114_), .b(new_n68_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n124_), .c(new_n122_), .O(z12));
  nand2  g083(.a(x18), .b(x04), .O(new_n130_));
  oai21  g084(.a(new_n104_), .b(new_n73_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n92_), .O(new_n132_));
  nand2  g086(.a(new_n125_), .b(new_n98_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x23), .O(new_n134_));
  nor2   g088(.a(x23), .b(x22), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n98_), .c(new_n61_), .O(new_n136_));
  ...
  nand3  g102(.a(new_n148_), .b(new_n125_), .c(new_n108_), .O(new_n149_));
  ...
  oai21  g109(.a(new_n81_), .b(new_n92_), .c(x18), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x20), .O(new_n157_));
  nor3   g111(.a(x24), .b(x23), .c(x22), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n114_), .c(new_n81_), .O(new_n159_));
  nor2   g113(.a(x21), .b(x20), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n98_), .O(new_n161_));
  nor2   g115(.a(x25), .b(x24), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n135_), .O(new_n163_));
  nor2   g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n159_), .c(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n157_), .c(new_n155_), .O(z15));
  nand2  g120(.a(x18), .b(x07), .O(new_n167_));
  oai21  g121(.a(new_n104_), .b(new_n86_), .c(new_n167_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n92_), .O(new_n169_));
  inv1   g123(.a(x17), .O(new_n170_));
  nor2   g124(.a(x21), .b(x19), .O(new_n171_));
  nand4  g125(.a(new_n162_), .b(new_n135_), .c(new_n171_), .d(new_n170_), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(x26), .O(new_n173_));
  nor2   g127(.a(x26), .b(x25), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n148_), .c(new_n125_), .d(new_n98_), .O(new_n175_));
  aoi21  g129(.a(new_n175_), .b(new_n173_), .c(x20), .O(new_n176_));
  nand3  g130(.a(x26), .b(x20), .c(x18), .O(new_n177_));
  inv1   g131(.a(new_n177_), .O(new_n178_));
  oai21  g132(.a(new_n178_), .b(new_n176_), .c(x16), .O(new_n179_));
  nand2  g133(.a(new_n179_), .b(new_n169_), .O(z16));
  nand3  g134(.a(new_n48_), .b(x27), .c(x17), .O(new_n181_));
  nor2   g135(.a(new_n52_), .b(x17), .O(new_n182_));
  nor3   g136(.a(x26), .b(x25), .c(x24), .O(new_n183_));
  nand4  g137(.a(new_n183_), .b(new_n182_), .c(new_n160_), .d(new_n135_), .O(new_n184_));
  aoi21  g138(.a(new_n184_), .b(new_n181_), .c(new_n92_), .O(z17));
endmodule
