...
module FAU ( 
  ...
  nand4  g68(.a(new_n114_), .b(new_n103_), .c(new_n94_), .d(new_n79_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g71(.a(new_n99_), .b(x05), .O(new_n118_));
  ...
  nand4  g76(.a(new_n71_), .b(new_n112_), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n97_), .c(new_n115_), .d(x25), .O(new_n125_));
  ...
  nand2  g89(.a(new_n99_), .b(x07), .O(new_n136_));
  ...
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n57_), .d(new_n79_), .O(new_n141_));
