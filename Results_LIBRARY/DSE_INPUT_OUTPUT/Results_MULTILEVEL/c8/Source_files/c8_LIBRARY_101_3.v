...
module FAU ( 
  ...
  nand2  g067(.a(new_n97_), .b(x11), .O(new_n114_));
  ...
  nand2  g075(.a(new_n97_), .b(x12), .O(new_n122_));
  ...
  nand2  g085(.a(new_n97_), .b(x13), .O(new_n132_));
  ...
  nand2  g094(.a(new_n97_), .b(x14), .O(new_n141_));
  ...
  nand2  g100(.a(new_n138_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n136_), .c(new_n102_), .d(new_n93_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n146_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n145_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n136_), .c(new_n125_), .O(new_n154_));
  nand3  g108(.a(new_n102_), .b(x19), .c(new_n85_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n85_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n146_), .c(x16), .O(new_n157_));
