...
module FAU ( 
  ...
  nand4  g53(.a(new_n59_), .b(new_n92_), .c(new_n50_), .d(new_n82_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n90_), .c(new_n97_), .O(z11));
  ...
  oai21  g67(.a(new_n86_), .b(x05), .c(new_n90_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n110_), .b(new_n94_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n105_), .c(new_n98_), .d(new_n82_), .O(new_n118_));
  ...
  nand2  g90(.a(new_n87_), .b(x07), .O(new_n137_));
