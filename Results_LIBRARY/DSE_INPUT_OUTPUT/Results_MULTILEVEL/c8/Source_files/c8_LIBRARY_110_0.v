...
module FAU ( 
  ...
  oai22  g018(.a(new_n64_), .b(x12), .c(x27), .d(x23), .O(z04));
  ...
  nor2   g045(.a(new_n82_), .b(new_n53_), .O(new_n92_));
  ...
  nand2  g059(.a(new_n63_), .b(x12), .O(new_n106_));
  oai21  g060(.a(new_n106_), .b(new_n60_), .c(new_n105_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n84_), .O(new_n108_));
  nand2  g062(.a(new_n101_), .b(x22), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n82_), .c(new_n53_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n115_), .b(new_n106_), .O(new_n116_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n119_), .c(new_n100_), .d(new_n82_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n78_), .c(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n142_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n63_), .b(x15), .c(x12), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n119_), .c(new_n100_), .d(new_n82_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n78_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  inv1   g112(.a(x24), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n119_), .c(new_n159_), .O(new_n161_));
  nand3  g115(.a(new_n100_), .b(x19), .c(new_n79_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n54_), .d(new_n79_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n78_), .c(x16), .O(new_n164_));
