...
module FAU ( 
  ...
  aoi21  g063(.a(new_n103_), .b(new_n91_), .c(new_n65_), .O(new_n110_));
  ...
  nand2  g068(.a(new_n93_), .b(x11), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n114_), .c(new_n109_), .O(z12));
  inv1   g070(.a(x16), .O(new_n117_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n121_), .c(x16), .O(new_n126_));
  ...
  nand3  g084(.a(new_n54_), .b(new_n89_), .c(new_n88_), .O(new_n131_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n111_), .c(new_n134_), .d(new_n88_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n121_), .c(x16), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n103_), .d(new_n91_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n93_), .b(x14), .O(new_n146_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n117_), .O(new_n150_));
  nand2  g104(.a(new_n143_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n123_), .c(new_n103_), .d(new_n91_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n121_), .c(x16), .O(new_n155_));
  ...
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n88_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n88_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n121_), .c(x16), .O(new_n161_));
