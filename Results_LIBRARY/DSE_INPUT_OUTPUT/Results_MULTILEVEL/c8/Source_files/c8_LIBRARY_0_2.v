...
module FAU ( 
  ...
  nand2  g053(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  ...
  nand3  g063(.a(new_n98_), .b(new_n49_), .c(new_n86_), .O(new_n110_));
  ...
  oai22  g072(.a(new_n118_), .b(new_n117_), .c(x18), .d(new_n65_), .O(new_n119_));
  ...
  aoi21  g077(.a(new_n123_), .b(new_n122_), .c(x18), .O(new_n124_));
  nor2   g078(.a(new_n67_), .b(new_n49_), .O(new_n125_));
  ...
  nand2  g086(.a(new_n132_), .b(x18), .O(new_n133_));
  ...
  oai22  g116(.a(new_n118_), .b(new_n162_), .c(x18), .d(new_n81_), .O(new_n163_));
  ...
  oai22  g128(.a(new_n174_), .b(new_n173_), .c(new_n50_), .d(new_n86_), .O(new_n175_));
