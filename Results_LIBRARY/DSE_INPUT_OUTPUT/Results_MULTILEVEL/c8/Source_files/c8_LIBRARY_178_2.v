...
module FAU ( 
  ...
  nand3  g045(.a(new_n87_), .b(new_n47_), .c(x08), .O(new_n92_));
  ...
  nand2  g060(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  ...
  nand3  g091(.a(x18), .b(new_n47_), .c(x05), .O(new_n138_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n98_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n144_), .c(new_n109_), .d(new_n98_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(x18), .b(new_n47_), .c(x07), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(z16));
  nand4  g111(.a(new_n144_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n158_));
  nand3  g112(.a(new_n109_), .b(x19), .c(new_n99_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n99_), .O(new_n160_));
