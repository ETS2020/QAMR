...
module FAU ( 
  ...
  aoi21  g037(.a(x27), .b(new_n83_), .c(new_n49_), .O(new_n84_));
  oai21  g038(.a(x27), .b(x26), .c(new_n84_), .O(z07));
  nor2   g039(.a(new_n49_), .b(new_n55_), .O(z08));
  inv1   g040(.a(new_n49_), .O(new_n87_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n90_), .c(new_n87_), .O(z09));
  nand2  g049(.a(x18), .b(x01), .O(new_n96_));
  inv1   g050(.a(x18), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(x09), .c(new_n48_), .O(new_n98_));
  ...
  oai21  g057(.a(new_n89_), .b(new_n54_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n87_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n100_), .O(z10));
  nand2  g060(.a(x18), .b(x02), .O(new_n107_));
  nand3  g061(.a(new_n97_), .b(x10), .c(new_n48_), .O(new_n108_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n60_), .c(new_n113_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n87_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n110_), .O(z11));
  nand2  g070(.a(x18), .b(x03), .O(new_n117_));
  nand3  g071(.a(new_n97_), .b(x11), .c(new_n48_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n91_), .O(new_n120_));
  nand2  g074(.a(new_n113_), .b(x22), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n89_), .c(new_n54_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n87_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n120_), .O(z12));
  ...
  oai21  g108(.a(new_n97_), .b(new_n91_), .c(x07), .O(new_n155_));
  nand2  g109(.a(new_n151_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n149_), .c(new_n112_), .d(new_n89_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n97_), .b(new_n91_), .c(x15), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n160_), .c(new_n155_), .O(z16));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n149_), .c(new_n75_), .O(new_n164_));
  nand3  g118(.a(new_n112_), .b(x19), .c(new_n101_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n55_), .d(new_n101_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n87_), .O(z17));
endmodule
