...
module FAU ( 
  ...
  nand2  g038(.a(x18), .b(new_n73_), .O(new_n85_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n47_), .O(z10));
  inv1   g052(.a(x02), .O(new_n99_));
  oai22  g053(.a(new_n85_), .b(new_n99_), .c(x18), .d(new_n60_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n83_), .O(new_n101_));
  inv1   g055(.a(x17), .O(new_n102_));
  nand4  g056(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n102_), .O(new_n103_));
  oai21  g057(.a(new_n96_), .b(new_n62_), .c(new_n103_), .O(new_n104_));
  ...
  aoi21  g063(.a(x18), .b(x13), .c(x22), .O(new_n110_));
  nand4  g064(.a(new_n110_), .b(new_n62_), .c(new_n57_), .d(new_n51_), .O(new_n111_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n47_), .O(z12));
  nand2  g069(.a(x18), .b(x04), .O(new_n116_));
  oai21  g070(.a(x18), .b(new_n70_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n94_), .c(new_n57_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n118_), .c(new_n47_), .O(z13));
  nand3  g080(.a(x18), .b(new_n73_), .c(x05), .O(new_n127_));
  oai21  g081(.a(x18), .b(new_n73_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n83_), .O(new_n129_));
  nand3  g083(.a(new_n57_), .b(new_n51_), .c(new_n102_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n67_), .c(new_n62_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n119_), .c(new_n134_), .d(new_n102_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n47_), .c(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n129_), .O(z14));
  inv1   g093(.a(x06), .O(new_n140_));
  oai22  g094(.a(new_n85_), .b(new_n140_), .c(x18), .d(new_n76_), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n122_), .c(new_n144_), .d(new_n94_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n47_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n142_), .O(z15));
  inv1   g103(.a(x07), .O(new_n150_));
  oai22  g104(.a(new_n85_), .b(new_n150_), .c(x18), .d(new_n79_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n122_), .c(new_n144_), .d(new_n94_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n47_), .c(x16), .O(new_n157_));
  ...
  nand3  g115(.a(new_n144_), .b(x19), .c(new_n102_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n102_), .O(new_n163_));
