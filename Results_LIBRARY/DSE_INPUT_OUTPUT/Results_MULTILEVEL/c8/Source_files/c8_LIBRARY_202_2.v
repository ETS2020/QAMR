...
module FAU ( 
  ...
  nor2   g036(.a(x18), .b(x12), .O(new_n83_));
  ...
  oai21  g055(.a(new_n95_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g059(.a(new_n83_), .b(x11), .O(new_n106_));
  ...
  nand2  g068(.a(new_n111_), .b(x23), .O(new_n115_));
  ...
  nand3  g073(.a(x18), .b(new_n88_), .c(x04), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n119_), .O(z13));
  ...
  aoi21  g079(.a(new_n116_), .b(new_n95_), .c(new_n125_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n124_), .c(new_n81_), .O(z14));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n100_), .d(new_n93_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n136_), .c(new_n81_), .O(z15));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n100_), .d(new_n93_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n81_), .O(z16));
