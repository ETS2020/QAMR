...
module FAU ( 
  ...
  aoi21  g084(.a(new_n124_), .b(new_n106_), .c(new_n73_), .O(new_n131_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n107_), .d(new_n98_), .O(new_n153_));
  ...
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n89_), .O(new_n161_));
