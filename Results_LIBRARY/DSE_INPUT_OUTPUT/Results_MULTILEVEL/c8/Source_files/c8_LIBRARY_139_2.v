...
module FAU ( 
  ...
  nand3  g050(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n97_));
  oai21  g051(.a(new_n96_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g066(.a(new_n106_), .b(new_n96_), .c(new_n112_), .O(new_n113_));
  ...
  nand3  g071(.a(x18), .b(new_n47_), .c(x03), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n117_), .c(new_n111_), .O(z12));
  ...
  nand3  g086(.a(new_n132_), .b(new_n112_), .c(new_n104_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n97_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  ...
  oai21  g094(.a(x16), .b(x14), .c(new_n85_), .O(new_n141_));
  nand2  g095(.a(new_n137_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n124_), .c(new_n106_), .d(new_n96_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(x18), .b(new_n47_), .c(x06), .O(new_n147_));
  ...
  nand2  g104(.a(new_n150_), .b(new_n47_), .O(new_n151_));
  nand2  g105(.a(new_n144_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n124_), .c(new_n106_), .d(new_n96_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n124_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n158_));
  nand3  g112(.a(new_n106_), .b(x19), .c(new_n87_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n87_), .O(new_n160_));
