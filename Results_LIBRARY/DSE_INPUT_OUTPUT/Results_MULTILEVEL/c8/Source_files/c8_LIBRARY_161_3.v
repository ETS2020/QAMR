...
module FAU ( 
  ...
  nand2  g070(.a(new_n101_), .b(x11), .O(new_n117_));
  ...
  nand3  g085(.a(new_n54_), .b(new_n90_), .c(new_n89_), .O(new_n132_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n113_), .c(new_n135_), .d(new_n89_), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n124_), .c(new_n105_), .d(new_n97_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n101_), .b(x14), .O(new_n147_));
