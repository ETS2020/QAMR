...
module FAU ( 
  ...
  nor2   g032(.a(new_n47_), .b(new_n51_), .O(z08));
  inv1   g033(.a(x16), .O(new_n80_));
  nand2  g034(.a(x18), .b(x00), .O(new_n81_));
  inv1   g035(.a(x18), .O(new_n82_));
  nand2  g036(.a(new_n82_), .b(x14), .O(new_n83_));
  oai21  g037(.a(new_n83_), .b(new_n48_), .c(new_n81_), .O(new_n84_));
  ...
  oai21  g062(.a(new_n83_), .b(new_n60_), .c(new_n108_), .O(new_n109_));
  ...
  oai21  g080(.a(new_n83_), .b(new_n68_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n80_), .O(new_n128_));
  inv1   g082(.a(x17), .O(new_n129_));
  nand3  g083(.a(new_n93_), .b(new_n50_), .c(new_n129_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n62_), .c(new_n102_), .O(new_n132_));
  ...
  oai21  g093(.a(new_n82_), .b(x06), .c(new_n80_), .O(new_n140_));
  ...
  nand3  g099(.a(new_n145_), .b(new_n140_), .c(new_n86_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  nand3  g101(.a(new_n82_), .b(x15), .c(x14), .O(new_n148_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n121_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n129_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n51_), .d(new_n129_), .O(new_n161_));
