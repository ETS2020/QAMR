...
module FAU ( 
  ...
  nand4  g51(.a(new_n57_), .b(new_n90_), .c(new_n83_), .d(new_n82_), .O(new_n98_));
  ...
  oai22  g57(.a(new_n103_), .b(new_n87_), .c(new_n88_), .d(new_n61_), .O(z12));
  ...
  nand4  g68(.a(new_n114_), .b(new_n106_), .c(new_n96_), .d(new_n82_), .O(new_n115_));
  ...
  nand4  g75(.a(new_n72_), .b(new_n112_), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  ...
  nand4  g90(.a(new_n128_), .b(new_n77_), .c(new_n72_), .d(new_n112_), .O(new_n137_));
  nand3  g91(.a(new_n127_), .b(x19), .c(new_n82_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n58_), .d(new_n82_), .O(new_n139_));
