...
module FAU ( 
  ...
  nand2  g039(.a(new_n53_), .b(x27), .O(new_n86_));
  inv1   g040(.a(x18), .O(new_n87_));
  nand3  g041(.a(new_n48_), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  oai21  g042(.a(new_n86_), .b(x15), .c(new_n88_), .O(z07));
  inv1   g043(.a(new_n86_), .O(z08));
  inv1   g044(.a(x17), .O(new_n91_));
  nor2   g045(.a(new_n47_), .b(new_n91_), .O(new_n92_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n53_), .O(z09));
  inv1   g053(.a(x01), .O(new_n100_));
  nand2  g054(.a(x26), .b(x18), .O(new_n101_));
  oai22  g055(.a(new_n101_), .b(new_n100_), .c(x18), .d(new_n57_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n95_), .O(new_n103_));
  nand3  g057(.a(new_n55_), .b(new_n47_), .c(new_n91_), .O(new_n104_));
  oai21  g058(.a(new_n93_), .b(new_n55_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n53_), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n103_), .O(z10));
  nand2  g061(.a(x18), .b(x02), .O(new_n108_));
  oai21  g062(.a(x18), .b(new_n61_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n95_), .O(new_n110_));
  nor3   g064(.a(x20), .b(x19), .c(x17), .O(new_n111_));
  nor2   g065(.a(x21), .b(x20), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n93_), .O(new_n113_));
  oai21  g067(.a(new_n111_), .b(new_n63_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n53_), .O(z11));
  inv1   g070(.a(x03), .O(new_n117_));
  oai22  g071(.a(new_n101_), .b(new_n117_), .c(x18), .d(new_n66_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n95_), .O(new_n119_));
  nand2  g073(.a(new_n113_), .b(x22), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n93_), .c(new_n55_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n53_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z12));
  inv1   g079(.a(x04), .O(new_n126_));
  oai22  g080(.a(new_n101_), .b(new_n126_), .c(x18), .d(new_n71_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n95_), .O(new_n128_));
  nand2  g082(.a(new_n122_), .b(x23), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n111_), .c(new_n63_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n53_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n128_), .O(z13));
  inv1   g088(.a(x05), .O(new_n135_));
  oai22  g089(.a(new_n101_), .b(new_n135_), .c(x18), .d(new_n76_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n95_), .O(new_n137_));
  nand3  g091(.a(new_n73_), .b(new_n68_), .c(new_n63_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n104_), .c(x24), .O(new_n139_));
  nor2   g093(.a(x20), .b(x19), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n121_), .c(new_n140_), .d(new_n91_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n53_), .c(x16), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n130_), .c(new_n112_), .d(new_n93_), .O(new_n151_));
  ...
  oai21  g110(.a(x18), .b(new_n155_), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n95_), .O(new_n158_));
  nand3  g112(.a(new_n140_), .b(new_n91_), .c(x16), .O(new_n159_));
  nand3  g113(.a(new_n150_), .b(new_n121_), .c(new_n73_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n159_), .c(new_n87_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n52_), .O(new_n162_));
  nand3  g116(.a(new_n151_), .b(x26), .c(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n162_), .c(new_n158_), .O(z16));
  nand2  g118(.a(z08), .b(x17), .O(new_n165_));
  nor2   g119(.a(x18), .b(x17), .O(new_n166_));
  nand2  g120(.a(new_n112_), .b(x19), .O(new_n167_));
  inv1   g121(.a(new_n167_), .O(new_n168_));
  nor3   g122(.a(x26), .b(x25), .c(x24), .O(new_n169_));
  nand4  g123(.a(new_n169_), .b(new_n168_), .c(new_n166_), .d(new_n130_), .O(new_n170_));
  aoi21  g124(.a(new_n170_), .b(new_n165_), .c(new_n95_), .O(z17));
endmodule
