// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:04 2020
...
module FAU ( 
  ...
  aoi21  g025(.a(x27), .b(new_n47_), .c(new_n71_), .O(new_n72_));
  nand2  g026(.a(new_n71_), .b(x12), .O(new_n73_));
  oai21  g027(.a(new_n72_), .b(x18), .c(new_n73_), .O(z04));
  ...
  aoi22  g032(.a(new_n78_), .b(new_n76_), .c(x18), .d(new_n47_), .O(z05));
  ...
  nand3  g042(.a(new_n88_), .b(new_n86_), .c(new_n48_), .O(z07));
  nand2  g043(.a(new_n48_), .b(new_n53_), .O(z08));
  ...
  nor2   g056(.a(new_n93_), .b(new_n56_), .O(new_n103_));
  nor3   g057(.a(x20), .b(x19), .c(x17), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n103_), .c(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n102_), .c(new_n48_), .O(z10));
  ...
  oai21  g065(.a(new_n104_), .b(new_n63_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n109_), .c(new_n48_), .O(z11));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n93_), .c(new_n68_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n56_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n95_), .c(x12), .O(new_n126_));
  ...
  nand2  g088(.a(new_n134_), .b(new_n95_), .O(new_n135_));
  aoi21  g089(.a(new_n128_), .b(new_n104_), .c(new_n77_), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n119_), .c(new_n137_), .d(new_n91_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n136_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n48_), .O(z14));
  nand3  g096(.a(x18), .b(x12), .c(x06), .O(new_n143_));
  oai21  g097(.a(x18), .b(new_n80_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n95_), .O(new_n145_));
  nand2  g099(.a(new_n139_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n110_), .d(new_n93_), .O(new_n149_));
  ...
  oai21  g107(.a(x18), .b(new_n87_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n110_), .d(new_n93_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n85_), .c(new_n82_), .d(new_n77_), .O(new_n162_));
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n91_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n53_), .d(new_n91_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n48_), .c(x16), .O(new_n165_));
