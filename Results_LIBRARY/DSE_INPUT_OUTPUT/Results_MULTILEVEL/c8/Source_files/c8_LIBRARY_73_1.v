...
module FAU ( 
  ...
  oai22  g61(.a(new_n107_), .b(new_n90_), .c(new_n96_), .d(new_n63_), .O(z12));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n57_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n94_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai22  g66(.a(new_n112_), .b(new_n90_), .c(new_n96_), .d(new_n68_), .O(z13));
  ...
  nand4  g71(.a(new_n117_), .b(new_n109_), .c(new_n99_), .d(new_n86_), .O(new_n118_));
  ...
  nand4  g75(.a(new_n78_), .b(new_n115_), .c(new_n70_), .d(new_n65_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n103_), .c(new_n118_), .d(x25), .O(new_n124_));
  nand3  g78(.a(new_n47_), .b(new_n90_), .c(x14), .O(new_n125_));
  ...
  nand3  g92(.a(new_n138_), .b(new_n129_), .c(new_n115_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n86_), .O(new_n140_));
