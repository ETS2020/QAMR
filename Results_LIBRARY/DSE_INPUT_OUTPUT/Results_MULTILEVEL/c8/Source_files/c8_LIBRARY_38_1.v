...
module FAU ( 
  ...
  oai21  g083(.a(new_n111_), .b(new_n71_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n88_), .O(new_n131_));
  nand3  g085(.a(new_n57_), .b(new_n51_), .c(new_n84_), .O(new_n132_));
  inv1   g086(.a(x22), .O(new_n133_));
  nand3  g087(.a(new_n68_), .b(new_n133_), .c(new_n103_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n132_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n115_), .c(new_n136_), .d(new_n84_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n124_), .c(new_n104_), .d(new_n86_), .O(new_n147_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n124_), .c(new_n104_), .d(new_n86_), .O(new_n156_));
  ...
  nand4  g114(.a(new_n124_), .b(new_n47_), .c(new_n76_), .d(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n104_), .b(x19), .c(new_n84_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n84_), .O(new_n163_));
