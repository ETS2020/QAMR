...
module FAU ( 
  ...
  nand2  g058(.a(new_n97_), .b(x02), .O(new_n105_));
  ...
  nand2  g066(.a(new_n97_), .b(x03), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n112_), .c(new_n107_), .O(z12));
  oai21  g068(.a(x16), .b(x12), .c(new_n83_), .O(new_n115_));
  ...
  nand2  g074(.a(new_n97_), .b(x04), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(z13));
  oai21  g076(.a(x16), .b(x13), .c(new_n83_), .O(new_n123_));
  ...
  nand2  g084(.a(new_n97_), .b(x05), .O(new_n131_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n137_), .c(new_n101_), .d(new_n93_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n97_), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  nor2   g104(.a(x26), .b(x25), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n137_), .c(new_n124_), .O(new_n152_));
  nand3  g106(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n55_), .d(new_n85_), .O(new_n154_));
