...
module FAU ( 
  ...
  oai22  g62(.a(new_n108_), .b(new_n87_), .c(new_n88_), .d(new_n68_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n87_), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n92_), .c(new_n73_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n105_), .c(new_n96_), .d(new_n83_), .O(new_n113_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n73_), .c(new_n117_), .d(new_n65_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n99_), .c(new_n113_), .d(x25), .O(new_n121_));
  nand3  g75(.a(new_n47_), .b(new_n87_), .c(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n87_), .c(new_n122_), .O(z15));
