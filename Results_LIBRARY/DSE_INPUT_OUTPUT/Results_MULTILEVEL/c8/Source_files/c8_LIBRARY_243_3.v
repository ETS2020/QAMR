...
module FAU ( 
  ...
  nor2   g031(.a(new_n49_), .b(new_n67_), .O(z08));
  inv1   g032(.a(x16), .O(new_n79_));
  inv1   g033(.a(x01), .O(new_n80_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n79_), .c(x09), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n93_), .O(z10));
  nand2  g050(.a(x18), .b(x02), .O(new_n97_));
  oai22  g051(.a(new_n97_), .b(x01), .c(x18), .d(new_n55_), .O(new_n98_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n87_), .c(new_n102_), .d(new_n89_), .O(new_n103_));
  ...
  aoi21  g063(.a(x18), .b(x01), .c(x22), .O(new_n110_));
  nand4  g064(.a(new_n110_), .b(new_n100_), .c(new_n87_), .d(new_n102_), .O(new_n111_));
  ...
  oai22  g070(.a(new_n116_), .b(x01), .c(x18), .d(new_n61_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n79_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n88_), .c(new_n87_), .O(new_n120_));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n101_), .c(new_n66_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n119_), .c(new_n90_), .d(new_n89_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n129_), .c(new_n48_), .O(z14));
  nand2  g089(.a(x18), .b(x06), .O(new_n136_));
  oai21  g090(.a(x18), .b(new_n70_), .c(new_n136_), .O(new_n137_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n88_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n147_), .b(x01), .c(x18), .d(new_n75_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n140_), .d(new_n88_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n66_), .O(new_n157_));
  nand3  g111(.a(new_n140_), .b(x19), .c(new_n89_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n67_), .d(new_n89_), .O(new_n159_));
