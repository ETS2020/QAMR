...
module FAU ( 
  ...
  oai22  g063(.a(new_n95_), .b(new_n109_), .c(x18), .d(new_n61_), .O(new_n110_));
  ...
  aoi21  g073(.a(x18), .b(new_n47_), .c(x22), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n63_), .c(new_n58_), .d(new_n52_), .O(new_n121_));
  ...
  oai22  g080(.a(new_n95_), .b(new_n126_), .c(x18), .d(new_n73_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n93_), .O(new_n128_));
  nor2   g082(.a(x22), .b(x21), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n104_), .c(new_n58_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x23), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n106_), .c(new_n63_), .O(new_n133_));
  ...
  oai22  g091(.a(new_n95_), .b(new_n137_), .c(x18), .d(new_n78_), .O(new_n138_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n129_), .c(new_n142_), .d(new_n141_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n144_), .b(x25), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n132_), .c(new_n112_), .d(new_n104_), .O(new_n152_));
  ...
  nand4  g114(.a(new_n132_), .b(new_n89_), .c(new_n84_), .d(new_n76_), .O(new_n161_));
  ...
  nand3  g118(.a(new_n112_), .b(x19), .c(new_n141_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n53_), .d(new_n141_), .O(new_n166_));
