...
module FAU ( 
  ...
  aoi21  g060(.a(new_n101_), .b(new_n85_), .c(new_n63_), .O(new_n107_));
  ...
  nand2  g073(.a(new_n87_), .b(x04), .O(new_n120_));
  ...
  aoi21  g077(.a(new_n116_), .b(new_n93_), .c(new_n123_), .O(new_n124_));
  nor2   g078(.a(x20), .b(x19), .O(new_n125_));
  nor2   g079(.a(x24), .b(x23), .O(new_n126_));
  nand4  g080(.a(new_n126_), .b(new_n108_), .c(new_n125_), .d(new_n83_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n124_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n87_), .b(x05), .O(new_n130_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n101_), .d(new_n85_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g092(.a(new_n87_), .b(x06), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n134_), .c(new_n101_), .d(new_n85_), .O(new_n146_));
  ...
  nand3  g104(.a(new_n150_), .b(new_n134_), .c(new_n123_), .O(new_n151_));
  nand3  g105(.a(new_n101_), .b(x19), .c(new_n83_), .O(new_n152_));
