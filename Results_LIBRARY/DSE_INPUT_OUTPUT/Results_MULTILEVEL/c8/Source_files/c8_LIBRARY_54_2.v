...
module FAU ( 
  ...
  nor2   g054(.a(new_n100_), .b(new_n57_), .O(new_n101_));
  nor3   g055(.a(x20), .b(x19), .c(x17), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n101_), .c(x16), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n99_), .c(new_n93_), .O(z10));
  ...
  oai21  g063(.a(new_n102_), .b(new_n62_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(new_n93_), .O(z11));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  nand3  g067(.a(new_n89_), .b(x11), .c(new_n52_), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n100_), .c(new_n57_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n93_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n116_), .O(z12));
  oai21  g076(.a(new_n89_), .b(new_n87_), .c(x04), .O(new_n123_));
  nand2  g077(.a(new_n119_), .b(x23), .O(new_n124_));
  nor3   g078(.a(x23), .b(x22), .c(x21), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n102_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand3  g082(.a(new_n89_), .b(new_n87_), .c(x12), .O(new_n129_));
  ...
  aoi21  g087(.a(new_n125_), .b(new_n102_), .c(new_n75_), .O(new_n134_));
  inv1   g088(.a(x17), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n118_), .c(new_n136_), .d(new_n135_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n134_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n133_), .c(new_n93_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n89_), .b(x14), .c(new_n52_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n108_), .d(new_n100_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n93_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n145_), .O(z15));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n89_), .b(x15), .c(new_n52_), .O(new_n154_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n147_), .c(new_n108_), .d(new_n100_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n93_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n156_), .O(z16));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n147_), .c(new_n75_), .O(new_n164_));
  nand3  g118(.a(new_n108_), .b(x19), .c(new_n135_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n50_), .d(new_n135_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n93_), .O(z17));
endmodule
