...
module FAU ( 
  ...
  aoi21  g030(.a(x27), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  oai22  g031(.a(new_n77_), .b(x15), .c(x27), .d(x26), .O(z07));
  nand2  g032(.a(new_n47_), .b(new_n52_), .O(z08));
  inv1   g033(.a(x16), .O(new_n80_));
  inv1   g034(.a(x00), .O(new_n81_));
  nand2  g035(.a(new_n76_), .b(x18), .O(new_n82_));
  oai22  g036(.a(new_n82_), .b(new_n81_), .c(x18), .d(new_n49_), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  xnor2a g038(.a(x19), .b(x17), .O(new_n85_));
  nand3  g039(.a(new_n85_), .b(new_n47_), .c(x16), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n84_), .O(z09));
  inv1   g041(.a(x01), .O(new_n88_));
  oai22  g042(.a(new_n82_), .b(new_n88_), .c(x18), .d(new_n55_), .O(new_n89_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n51_), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n100_), .c(new_n47_), .O(z11));
  inv1   g061(.a(x03), .O(new_n108_));
  oai22  g062(.a(new_n82_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  ...
  oai22  g071(.a(new_n82_), .b(new_n117_), .c(x18), .d(new_n66_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n80_), .O(new_n119_));
  nand2  g073(.a(new_n113_), .b(x23), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n102_), .c(new_n101_), .O(new_n122_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n103_), .d(new_n92_), .O(new_n143_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n121_), .c(new_n103_), .d(new_n92_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n93_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n93_), .O(new_n161_));
