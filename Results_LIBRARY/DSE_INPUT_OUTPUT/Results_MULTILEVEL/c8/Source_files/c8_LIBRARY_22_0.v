...
module FAU ( 
  ...
  oai21  g51(.a(new_n88_), .b(x02), .c(new_n97_), .O(new_n98_));
  nor2   g52(.a(x20), .b(x19), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n84_), .O(new_n100_));
  nand4  g54(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n84_), .O(new_n101_));
  ...
  nand2  g62(.a(new_n89_), .b(x03), .O(new_n109_));
  ...
  aoi21  g68(.a(new_n111_), .b(new_n93_), .c(new_n74_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n106_), .c(new_n99_), .d(new_n84_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n89_), .b(x05), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n119_), .O(z14));
  oai21  g75(.a(new_n88_), .b(x06), .c(new_n97_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n74_), .c(new_n69_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n97_), .c(new_n122_), .O(z15));
  ...
  nand2  g91(.a(new_n89_), .b(x07), .O(new_n138_));
