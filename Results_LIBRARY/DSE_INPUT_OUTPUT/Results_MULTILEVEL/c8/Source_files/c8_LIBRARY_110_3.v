// Benchmark "FAU" written by ABC on Thu Aug 13 18:00:54 2020
...
module FAU ( 
  ...
  nor2   g045(.a(new_n82_), .b(new_n54_), .O(new_n92_));
  nor3   g046(.a(x20), .b(x19), .c(x17), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  nand3  g048(.a(new_n94_), .b(new_n91_), .c(new_n48_), .O(z10));
  ...
  nand2  g059(.a(x18), .b(new_n64_), .O(new_n106_));
  oai22  g060(.a(new_n106_), .b(new_n105_), .c(x18), .d(new_n61_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n84_), .O(new_n108_));
  nand2  g062(.a(new_n101_), .b(x22), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n82_), .c(new_n54_), .O(new_n111_));
  ...
  nand3  g068(.a(x18), .b(new_n64_), .c(x04), .O(new_n115_));
  oai21  g069(.a(x18), .b(new_n64_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n84_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x23), .O(new_n118_));
  nor2   g072(.a(x23), .b(x22), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n99_), .O(new_n120_));
  ...
  oai22  g078(.a(new_n106_), .b(new_n124_), .c(x18), .d(new_n67_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  nand3  g080(.a(new_n54_), .b(new_n80_), .c(new_n79_), .O(new_n127_));
  inv1   g081(.a(x22), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n128_), .c(new_n99_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n110_), .c(new_n132_), .d(new_n79_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n48_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n126_), .O(z14));
  inv1   g091(.a(x06), .O(new_n138_));
  oai22  g092(.a(new_n106_), .b(new_n138_), .c(x18), .d(new_n70_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n84_), .O(new_n140_));
  nand2  g094(.a(new_n134_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n119_), .c(new_n100_), .d(new_n82_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n106_), .b(new_n147_), .c(x18), .d(new_n73_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n119_), .c(new_n100_), .d(new_n82_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n48_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  inv1   g109(.a(x24), .O(new_n156_));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n119_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n100_), .b(x19), .c(new_n79_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n79_), .O(new_n160_));
