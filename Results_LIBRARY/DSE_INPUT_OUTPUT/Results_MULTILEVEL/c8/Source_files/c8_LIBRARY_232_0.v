...
module FAU ( 
  ...
  oai21  g46(.a(new_n92_), .b(x00), .c(new_n91_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n90_), .O(z09));
  nor2   g48(.a(new_n89_), .b(new_n53_), .O(new_n95_));
  nor3   g49(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  nor2   g51(.a(new_n92_), .b(x16), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x01), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n97_), .O(z10));
  nor2   g54(.a(x20), .b(x19), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n86_), .O(new_n102_));
  nand4  g56(.a(new_n59_), .b(new_n53_), .c(new_n87_), .d(new_n86_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n102_), .b(x21), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n98_), .b(x02), .O(new_n106_));
  oai21  g60(.a(new_n105_), .b(new_n91_), .c(new_n106_), .O(z11));
  oai21  g61(.a(new_n92_), .b(x03), .c(new_n91_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n112_), .b(new_n91_), .c(new_n108_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n96_), .c(new_n111_), .d(x23), .O(new_n115_));
  nand2  g69(.a(new_n98_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n91_), .c(new_n116_), .O(z13));
  aoi21  g71(.a(new_n114_), .b(new_n96_), .c(new_n74_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n110_), .c(new_n101_), .d(new_n86_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n98_), .b(x05), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  nand4  g78(.a(new_n79_), .b(new_n74_), .c(new_n69_), .d(new_n64_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n104_), .c(new_n120_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n98_), .b(x06), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n91_), .c(new_n128_), .O(z15));
  oai21  g83(.a(new_n92_), .b(x07), .c(new_n91_), .O(new_n130_));
  nor2   g84(.a(x21), .b(x20), .O(new_n131_));
  nor2   g85(.a(x23), .b(x22), .O(new_n132_));
  nor2   g86(.a(x25), .b(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n89_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x26), .O(new_n135_));
  nor3   g89(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n132_), .c(new_n131_), .d(new_n89_), .O(new_n137_));
  ...
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n91_), .O(z17));
endmodule
