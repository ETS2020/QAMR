...
module FAU ( 
  ...
  nand2  g028(.a(new_n51_), .b(x25), .O(new_n75_));
  nand2  g029(.a(new_n75_), .b(x18), .O(new_n76_));
  inv1   g030(.a(x25), .O(new_n77_));
  nand3  g031(.a(new_n51_), .b(new_n77_), .c(x14), .O(new_n78_));
  oai21  g032(.a(new_n76_), .b(x14), .c(new_n78_), .O(z06));
  ...
  nand2  g051(.a(new_n97_), .b(x14), .O(new_n98_));
  ...
  oai21  g056(.a(new_n89_), .b(new_n56_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g060(.a(new_n98_), .b(new_n59_), .c(new_n106_), .O(new_n107_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n110_), .d(new_n89_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n82_), .c(new_n77_), .d(new_n136_), .O(new_n162_));
