...
module FAU ( 
  ...
  nand3  g051(.a(x18), .b(new_n47_), .c(x01), .O(new_n98_));
  ...
  oai21  g058(.a(new_n96_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(x18), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n102_), .O(z11));
  oai21  g061(.a(x16), .b(x11), .c(new_n85_), .O(new_n108_));
  inv1   g062(.a(x22), .O(new_n109_));
  aoi21  g063(.a(new_n103_), .b(new_n94_), .c(new_n109_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n94_), .c(new_n57_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand3  g068(.a(x18), .b(new_n47_), .c(x03), .O(new_n115_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n96_), .c(new_n62_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n129_));
  nand3  g083(.a(new_n70_), .b(new_n109_), .c(new_n62_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n129_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n111_), .c(new_n132_), .d(new_n87_), .O(new_n134_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n152_));
  ...
  nand2  g109(.a(new_n70_), .b(new_n109_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n103_), .b(x19), .c(new_n87_), .O(new_n161_));
