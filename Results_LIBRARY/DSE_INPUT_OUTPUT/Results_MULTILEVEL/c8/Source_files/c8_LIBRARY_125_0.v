...
module FAU ( 
  ...
  nand3  g036(.a(new_n82_), .b(x08), .c(x07), .O(new_n83_));
  ...
  nand3  g061(.a(new_n82_), .b(x11), .c(x07), .O(new_n108_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n93_), .c(new_n53_), .O(new_n113_));
  ...
  nand3  g080(.a(new_n82_), .b(x13), .c(x07), .O(new_n127_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n112_), .c(new_n95_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n121_), .c(new_n102_), .d(new_n93_), .O(new_n141_));
  ...
  aoi21  g099(.a(new_n82_), .b(new_n76_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n141_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n121_), .c(new_n102_), .d(new_n93_), .O(new_n149_));
  ...
  oai21  g106(.a(new_n151_), .b(new_n145_), .c(new_n152_), .O(z16));
  inv1   g107(.a(x17), .O(new_n154_));
  nand2  g108(.a(new_n148_), .b(new_n121_), .O(new_n155_));
  nand3  g109(.a(new_n102_), .b(x19), .c(new_n154_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n54_), .d(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n86_), .c(x16), .O(new_n158_));
