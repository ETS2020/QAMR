...
module FAU ( 
  ...
  nand2  g076(.a(new_n105_), .b(x12), .O(new_n123_));
  ...
  nand2  g085(.a(new_n105_), .b(x13), .O(new_n132_));
  ...
  nand2  g094(.a(new_n105_), .b(x14), .O(new_n141_));
  ...
  nand2  g102(.a(new_n105_), .b(x15), .O(new_n149_));
  ...
  aoi21  g113(.a(new_n159_), .b(new_n90_), .c(new_n84_), .O(z17));
endmodule
