...
module FAU ( 
  ...
  oai21  g057(.a(new_n55_), .b(new_n96_), .c(x18), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x19), .O(new_n105_));
  nand3  g059(.a(new_n55_), .b(new_n47_), .c(new_n92_), .O(new_n106_));
  oai21  g060(.a(new_n55_), .b(new_n92_), .c(new_n106_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n105_), .c(new_n103_), .O(z10));
  ...
  oai21  g066(.a(new_n63_), .b(new_n96_), .c(x18), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x19), .O(new_n114_));
  nor2   g068(.a(x20), .b(x17), .O(new_n115_));
  nor2   g069(.a(new_n115_), .b(new_n63_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n114_), .c(new_n112_), .O(z11));
  ...
  oai21  g078(.a(new_n66_), .b(new_n96_), .c(x18), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x19), .O(new_n126_));
  nand2  g080(.a(new_n117_), .b(new_n92_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x22), .O(new_n128_));
  nor2   g082(.a(x22), .b(x21), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n94_), .c(new_n55_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n126_), .c(new_n124_), .O(z12));
  ...
  oai21  g090(.a(new_n71_), .b(new_n96_), .c(x18), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x19), .O(new_n138_));
  aoi21  g092(.a(new_n129_), .b(new_n115_), .c(new_n71_), .O(new_n139_));
  ...
  nand3  g099(.a(new_n47_), .b(new_n52_), .c(x13), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  nand3  g102(.a(new_n140_), .b(new_n115_), .c(new_n63_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x24), .O(new_n150_));
  nor2   g104(.a(x24), .b(x23), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n117_), .c(new_n66_), .d(new_n92_), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n150_), .c(x19), .O(new_n153_));
  nand3  g107(.a(x24), .b(x19), .c(x18), .O(new_n154_));
  inv1   g108(.a(new_n154_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n153_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n148_), .O(z14));
  nand2  g111(.a(x18), .b(x06), .O(new_n158_));
  oai21  g112(.a(x18), .b(new_n83_), .c(new_n158_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n96_), .O(new_n160_));
  oai21  g114(.a(new_n81_), .b(new_n96_), .c(x18), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x19), .O(new_n162_));
  and2   g116(.a(new_n152_), .b(x25), .O(new_n163_));
  nand3  g117(.a(new_n140_), .b(new_n81_), .c(new_n78_), .O(new_n164_));
  nor2   g118(.a(new_n164_), .b(new_n118_), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n163_), .c(x16), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n162_), .c(new_n160_), .O(z15));
  nand2  g121(.a(x18), .b(x07), .O(new_n168_));
  oai21  g122(.a(x18), .b(new_n86_), .c(new_n168_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n96_), .O(new_n170_));
  oai21  g124(.a(new_n88_), .b(new_n96_), .c(x18), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(x19), .O(new_n172_));
  oai21  g126(.a(new_n164_), .b(new_n127_), .c(x26), .O(new_n173_));
  nor3   g127(.a(x26), .b(x25), .c(x24), .O(new_n174_));
  nand3  g128(.a(new_n174_), .b(new_n140_), .c(new_n119_), .O(new_n175_));
  ...
  nand2  g133(.a(new_n117_), .b(x19), .O(new_n180_));
  nor3   g134(.a(new_n180_), .b(new_n52_), .c(x17), .O(new_n181_));
  nand3  g135(.a(new_n181_), .b(new_n174_), .c(new_n140_), .O(new_n182_));
  aoi21  g136(.a(new_n182_), .b(new_n179_), .c(new_n96_), .O(z17));
endmodule
