...
module FAU ( 
  ...
  nand4  g52(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n86_), .c(new_n96_), .O(z11));
  nand2  g56(.a(new_n99_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n84_), .c(new_n56_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand2  g60(.a(new_n93_), .b(x03), .O(new_n107_));
  oai21  g61(.a(new_n106_), .b(new_n86_), .c(new_n107_), .O(z12));
  oai21  g62(.a(new_n87_), .b(x04), .c(new_n86_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n91_), .c(new_n105_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n86_), .c(new_n109_), .O(z13));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n91_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n104_), .c(new_n97_), .d(new_n82_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n93_), .b(x05), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  oai21  g74(.a(new_n87_), .b(x06), .c(new_n86_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n113_), .c(new_n122_), .d(new_n66_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n100_), .c(new_n116_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n86_), .c(new_n121_), .O(z15));
