// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:43 2020
...
module FAU ( 
  ...
  oai21  g026(.a(new_n54_), .b(new_n71_), .c(new_n72_), .O(new_n73_));
  oai21  g027(.a(new_n54_), .b(x14), .c(new_n73_), .O(z06));
  ...
  nand2  g032(.a(new_n78_), .b(new_n54_), .O(z08));
  ...
  nand3  g042(.a(new_n88_), .b(new_n84_), .c(new_n78_), .O(z09));
  nand2  g043(.a(x18), .b(x01), .O(new_n90_));
  nand2  g044(.a(x25), .b(new_n71_), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n51_), .c(new_n90_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  nand3  g047(.a(new_n53_), .b(new_n81_), .c(new_n80_), .O(new_n94_));
  oai21  g048(.a(new_n83_), .b(new_n53_), .c(new_n94_), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n78_), .c(x16), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n93_), .O(z10));
  nand2  g051(.a(x18), .b(x02), .O(new_n98_));
  oai21  g052(.a(x18), .b(new_n57_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n85_), .O(new_n100_));
  nor3   g054(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n83_), .O(new_n103_));
  oai21  g057(.a(new_n101_), .b(new_n59_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n100_), .c(new_n78_), .O(z11));
  nand2  g060(.a(x18), .b(x03), .O(new_n107_));
  oai21  g061(.a(x18), .b(new_n62_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n85_), .O(new_n109_));
  inv1   g063(.a(x22), .O(new_n110_));
  aoi21  g064(.a(new_n102_), .b(new_n83_), .c(new_n110_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n83_), .c(new_n53_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n109_), .c(new_n78_), .O(z12));
  nand2  g070(.a(x18), .b(x04), .O(new_n117_));
  oai21  g071(.a(new_n91_), .b(new_n65_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n85_), .O(new_n119_));
  nand2  g073(.a(new_n113_), .b(x23), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n101_), .c(new_n59_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n78_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  oai21  g080(.a(new_n91_), .b(new_n68_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n85_), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n110_), .c(new_n59_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n94_), .c(x24), .O(new_n131_));
  inv1   g085(.a(x24), .O(new_n132_));
  nand4  g086(.a(new_n112_), .b(new_n101_), .c(new_n132_), .d(new_n129_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n78_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n128_), .O(z14));
  ...
  nand3  g094(.a(new_n112_), .b(new_n132_), .c(new_n129_), .O(new_n141_));
  nand4  g095(.a(new_n53_), .b(new_n81_), .c(new_n80_), .d(x16), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n141_), .c(x18), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n72_), .O(new_n144_));
  nand3  g098(.a(new_n133_), .b(x25), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n144_), .c(new_n140_), .O(z15));
  ...
  nand2  g104(.a(new_n150_), .b(x25), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n71_), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n121_), .c(new_n102_), .d(new_n83_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n121_), .c(new_n102_), .d(new_n83_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n152_), .c(new_n149_), .O(z16));
  nand3  g114(.a(new_n78_), .b(x27), .c(x17), .O(new_n161_));
  nor2   g115(.a(new_n71_), .b(x17), .O(new_n162_));
  nand2  g116(.a(new_n102_), .b(x19), .O(new_n163_));
  inv1   g117(.a(new_n163_), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n162_), .c(new_n156_), .d(new_n121_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n161_), .c(new_n85_), .O(z17));
endmodule
