...
module FAU ( 
  ...
  aoi21  g082(.a(new_n121_), .b(new_n103_), .c(new_n128_), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n114_), .c(new_n96_), .d(new_n84_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n88_), .b(x13), .O(new_n134_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n104_), .d(new_n86_), .O(new_n140_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n138_), .c(new_n104_), .d(new_n86_), .O(new_n150_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n76_), .c(new_n128_), .O(new_n157_));
  ...
  nor2   g114(.a(new_n52_), .b(new_n84_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n95_), .c(new_n91_), .O(z17));
endmodule
