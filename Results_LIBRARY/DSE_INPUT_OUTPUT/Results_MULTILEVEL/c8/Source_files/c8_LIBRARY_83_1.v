...
module FAU ( 
  ...
  nand2  g30(.a(new_n58_), .b(new_n76_), .O(new_n77_));
  ...
  nand2  g35(.a(new_n58_), .b(new_n81_), .O(new_n82_));
  aoi21  g36(.a(new_n82_), .b(new_n80_), .c(new_n49_), .O(z07));
  nor2   g37(.a(new_n49_), .b(new_n58_), .O(z08));
  ...
  nand4  g54(.a(new_n57_), .b(new_n94_), .c(new_n86_), .d(new_n85_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  nor2   g57(.a(x18), .b(x16), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n55_), .c(new_n103_), .d(new_n90_), .O(z11));
  nor3   g60(.a(x22), .b(x21), .c(x20), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n88_), .c(new_n101_), .d(x22), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n90_), .c(new_n105_), .d(new_n61_), .O(z12));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n88_), .c(new_n94_), .O(new_n111_));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n96_), .c(new_n111_), .d(x23), .O(new_n113_));
  oai22  g67(.a(new_n113_), .b(new_n90_), .c(new_n105_), .d(new_n64_), .O(z13));
  oai21  g68(.a(x18), .b(x13), .c(new_n90_), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n96_), .c(new_n71_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n110_), .c(new_n99_), .d(new_n85_), .O(new_n118_));
  ...
  nand2  g79(.a(new_n104_), .b(x14), .O(new_n126_));
  ...
  nand2  g90(.a(new_n104_), .b(x15), .O(new_n137_));
