...
module FAU ( 
  ...
  nand3  g033(.a(new_n52_), .b(new_n77_), .c(new_n79_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n78_), .O(z06));
  ...
  nand2  g043(.a(x18), .b(new_n76_), .O(new_n90_));
  ...
  oai22  g058(.a(new_n90_), .b(new_n104_), .c(x18), .d(new_n60_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n88_), .O(new_n106_));
  inv1   g060(.a(x17), .O(new_n107_));
  nand4  g061(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n107_), .O(new_n108_));
  ...
  aoi21  g068(.a(x18), .b(x14), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n62_), .c(new_n57_), .d(new_n51_), .O(new_n116_));
  ...
  oai22  g075(.a(new_n90_), .b(new_n121_), .c(x18), .d(new_n70_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n88_), .O(new_n123_));
  nor2   g077(.a(x22), .b(x21), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n99_), .c(new_n57_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n101_), .c(new_n62_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n57_), .b(new_n51_), .c(new_n107_), .O(new_n135_));
  inv1   g089(.a(x23), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n67_), .c(new_n62_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n135_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n124_), .c(new_n139_), .d(new_n107_), .O(new_n141_));
  ...
  nand2  g099(.a(new_n79_), .b(x14), .O(new_n146_));
  oai21  g100(.a(new_n90_), .b(new_n145_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n88_), .O(new_n148_));
  nand2  g102(.a(new_n141_), .b(x25), .O(new_n149_));
  nor2   g103(.a(x21), .b(x20), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n127_), .c(new_n150_), .d(new_n99_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n47_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n148_), .O(z15));
  inv1   g109(.a(x07), .O(new_n156_));
  oai22  g110(.a(new_n90_), .b(new_n156_), .c(x18), .d(new_n82_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n127_), .c(new_n150_), .d(new_n99_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n47_), .c(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n158_), .O(z16));
  inv1   g118(.a(x24), .O(new_n165_));
  nand4  g119(.a(new_n127_), .b(new_n84_), .c(new_n77_), .d(new_n165_), .O(new_n166_));
  nand3  g120(.a(new_n150_), .b(x19), .c(new_n107_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n52_), .d(new_n107_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n47_), .c(x16), .O(new_n169_));
