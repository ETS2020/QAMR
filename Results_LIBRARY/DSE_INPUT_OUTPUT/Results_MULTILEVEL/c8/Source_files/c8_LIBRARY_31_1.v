...
module FAU ( 
  ...
  nand2  g017(.a(new_n53_), .b(new_n62_), .O(new_n64_));
  nand3  g018(.a(new_n64_), .b(new_n63_), .c(new_n48_), .O(z02));
  ...
  nor2   g045(.a(x21), .b(x18), .O(new_n92_));
  ...
  nand3  g053(.a(new_n56_), .b(new_n52_), .c(new_n99_), .O(new_n100_));
  oai21  g054(.a(new_n98_), .b(new_n56_), .c(new_n100_), .O(new_n101_));
  ...
  inv1   g067(.a(new_n92_), .O(new_n114_));
  nand2  g068(.a(x18), .b(x03), .O(new_n115_));
  oai21  g069(.a(new_n114_), .b(new_n66_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n104_), .O(new_n117_));
  nand3  g071(.a(new_n98_), .b(new_n68_), .c(new_n56_), .O(new_n118_));
  oai21  g072(.a(new_n108_), .b(new_n68_), .c(new_n118_), .O(new_n119_));
  nor2   g073(.a(new_n68_), .b(new_n62_), .O(new_n120_));
  aoi22  g074(.a(new_n120_), .b(x18), .c(new_n119_), .d(new_n62_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n104_), .c(new_n117_), .O(z12));
  nand2  g076(.a(x18), .b(x04), .O(new_n123_));
  oai21  g077(.a(new_n114_), .b(new_n73_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n104_), .O(new_n125_));
  nand2  g079(.a(new_n118_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n98_), .c(new_n56_), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(new_n126_), .c(x21), .O(new_n129_));
  nand3  g083(.a(x23), .b(x21), .c(x18), .O(new_n130_));
  ...
  oai21  g088(.a(new_n114_), .b(new_n76_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n104_), .O(new_n136_));
  nand2  g090(.a(new_n128_), .b(x24), .O(new_n137_));
  nor3   g091(.a(x24), .b(x23), .c(x22), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n108_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x21), .O(new_n140_));
  nand3  g094(.a(x24), .b(x21), .c(x18), .O(new_n141_));
  ...
  oai21  g099(.a(new_n114_), .b(new_n83_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n104_), .O(new_n147_));
  nand3  g101(.a(new_n78_), .b(new_n71_), .c(new_n68_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n100_), .c(x25), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n127_), .c(new_n108_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n149_), .c(x21), .O(new_n152_));
  nand3  g106(.a(x25), .b(x21), .c(x18), .O(new_n153_));
  ...
  nand2  g112(.a(new_n158_), .b(new_n104_), .O(new_n159_));
  oai21  g113(.a(new_n86_), .b(new_n104_), .c(x18), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x21), .O(new_n161_));
  nand2  g115(.a(new_n151_), .b(x26), .O(new_n162_));
  nor3   g116(.a(x26), .b(x25), .c(x24), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n127_), .c(new_n109_), .d(new_n98_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n161_), .c(new_n159_), .O(z16));
  nand2  g121(.a(z08), .b(x17), .O(new_n168_));
  nor2   g122(.a(new_n52_), .b(x17), .O(new_n169_));
  nand4  g123(.a(new_n169_), .b(new_n163_), .c(new_n127_), .d(new_n109_), .O(new_n170_));
  aoi21  g124(.a(new_n170_), .b(new_n168_), .c(new_n104_), .O(z17));
endmodule
