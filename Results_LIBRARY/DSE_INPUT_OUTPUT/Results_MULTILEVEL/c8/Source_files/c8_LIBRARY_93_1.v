...
module FAU ( 
  ...
  nand4  g67(.a(new_n113_), .b(new_n106_), .c(new_n96_), .d(new_n83_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g70(.a(new_n47_), .b(new_n87_), .c(x13), .O(new_n117_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n111_), .c(new_n120_), .d(new_n67_), .O(new_n122_));
