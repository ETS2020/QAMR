...
module FAU ( 
  ...
  oai21  g46(.a(x18), .b(x09), .c(new_n92_), .O(new_n93_));
  nor2   g47(.a(new_n87_), .b(new_n57_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n85_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n92_), .c(new_n90_), .d(new_n60_), .O(z11));
  oai21  g57(.a(x18), .b(x11), .c(new_n92_), .O(new_n104_));
  ...
  oai21  g62(.a(new_n108_), .b(new_n92_), .c(new_n104_), .O(z12));
  oai21  g63(.a(x18), .b(x12), .c(new_n92_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n95_), .c(new_n107_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n92_), .c(new_n110_), .O(z13));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n95_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n106_), .c(new_n98_), .d(new_n85_), .O(new_n117_));
  ...
  oai21  g75(.a(x18), .b(x14), .c(new_n92_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n114_), .c(new_n70_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n101_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n92_), .c(new_n122_), .O(z15));
  ...
  nand2  g91(.a(new_n89_), .b(x15), .O(new_n138_));
  ...
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n92_), .O(z17));
endmodule
