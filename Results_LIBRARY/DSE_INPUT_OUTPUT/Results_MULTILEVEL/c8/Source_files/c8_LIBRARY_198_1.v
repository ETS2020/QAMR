// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:31 2020
...
module FAU ( 
  ...
  aoi21  g015(.a(x27), .b(x18), .c(new_n61_), .O(new_n62_));
  ...
  aoi21  g021(.a(new_n67_), .b(new_n65_), .c(new_n49_), .O(z03));
  ...
  aoi21  g026(.a(new_n72_), .b(new_n70_), .c(new_n49_), .O(z04));
  ...
  nand3  g031(.a(new_n77_), .b(new_n75_), .c(new_n48_), .O(z05));
  ...
  aoi21  g036(.a(new_n82_), .b(new_n80_), .c(new_n49_), .O(z06));
  ...
  aoi21  g041(.a(new_n87_), .b(new_n85_), .c(new_n49_), .O(z07));
  nor2   g042(.a(new_n49_), .b(new_n53_), .O(z08));
  inv1   g043(.a(x17), .O(new_n90_));
  nor2   g044(.a(new_n52_), .b(new_n90_), .O(new_n91_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n48_), .O(z09));
  nand2  g052(.a(x18), .b(x01), .O(new_n99_));
  nand2  g053(.a(new_n61_), .b(new_n47_), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n58_), .c(new_n99_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n94_), .O(new_n102_));
  nand3  g056(.a(new_n56_), .b(new_n52_), .c(new_n90_), .O(new_n103_));
  oai21  g057(.a(new_n92_), .b(new_n56_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n92_), .b(new_n61_), .c(new_n56_), .O(new_n112_));
  oai21  g066(.a(new_n111_), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n110_), .c(new_n48_), .O(z11));
  ...
  oai21  g072(.a(new_n66_), .b(new_n94_), .c(x18), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x21), .O(new_n120_));
  nand4  g074(.a(new_n92_), .b(new_n66_), .c(new_n61_), .d(new_n56_), .O(new_n121_));
  oai21  g075(.a(new_n111_), .b(new_n66_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n120_), .c(new_n118_), .O(z12));
  nand2  g078(.a(x18), .b(x04), .O(new_n125_));
  oai21  g079(.a(new_n100_), .b(new_n69_), .c(new_n125_), .O(new_n126_));
  ...
  oai21  g103(.a(new_n100_), .b(new_n79_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n94_), .O(new_n151_));
  nand3  g105(.a(new_n74_), .b(new_n71_), .c(new_n66_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n103_), .c(x25), .O(new_n153_));
  nor2   g107(.a(x20), .b(x19), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n131_), .c(new_n154_), .d(new_n90_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n153_), .c(x21), .O(new_n157_));
  nand3  g111(.a(x25), .b(x21), .c(x18), .O(new_n158_));
  ...
  oai21  g116(.a(new_n100_), .b(new_n84_), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n94_), .O(new_n164_));
  nand2  g118(.a(new_n156_), .b(x26), .O(new_n165_));
  nor2   g119(.a(x26), .b(x25), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n142_), .c(new_n128_), .d(new_n92_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(x21), .O(new_n168_));
  nand3  g122(.a(x26), .b(x21), .c(x18), .O(new_n169_));
  ...
  nand4  g126(.a(new_n61_), .b(new_n56_), .c(x19), .d(new_n90_), .O(new_n173_));
  nand3  g127(.a(new_n166_), .b(new_n131_), .c(new_n74_), .O(new_n174_));
  oai22  g128(.a(new_n174_), .b(new_n173_), .c(new_n53_), .d(new_n90_), .O(new_n175_));
