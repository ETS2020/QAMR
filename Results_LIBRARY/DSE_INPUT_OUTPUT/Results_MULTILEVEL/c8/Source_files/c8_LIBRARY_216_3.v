...
module FAU ( 
  ...
  aoi21  g062(.a(new_n103_), .b(new_n86_), .c(new_n65_), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n86_), .c(new_n92_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n88_), .b(x11), .O(new_n114_));
  ...
  nand2  g071(.a(new_n117_), .b(new_n98_), .O(new_n118_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n102_), .c(x16), .O(new_n123_));
  ...
  nand3  g081(.a(new_n92_), .b(new_n51_), .c(new_n84_), .O(new_n128_));
  nand3  g082(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n128_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n110_), .c(new_n131_), .d(new_n84_), .O(new_n133_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n120_), .c(new_n103_), .d(new_n86_), .O(new_n140_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n120_), .c(new_n103_), .d(new_n86_), .O(new_n148_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n120_), .c(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n84_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n84_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n102_), .c(x16), .O(new_n158_));
