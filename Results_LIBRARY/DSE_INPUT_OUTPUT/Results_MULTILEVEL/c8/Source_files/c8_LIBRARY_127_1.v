...
module FAU ( 
  ...
  nand3  g060(.a(new_n106_), .b(new_n99_), .c(new_n48_), .O(z10));
  ...
  nand4  g064(.a(new_n63_), .b(new_n56_), .c(new_n52_), .d(new_n102_), .O(new_n111_));
  oai21  g065(.a(new_n105_), .b(new_n63_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n110_), .c(new_n48_), .O(z11));
  ...
  nand3  g072(.a(new_n118_), .b(new_n100_), .c(new_n56_), .O(new_n119_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n47_), .c(new_n123_), .O(z12));
  ...
  nand4  g110(.a(new_n129_), .b(new_n85_), .c(new_n78_), .d(new_n73_), .O(new_n157_));
  ...
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n53_), .d(new_n102_), .O(new_n162_));
