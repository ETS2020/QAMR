...
module FAU ( 
  ...
  nand3  g049(.a(new_n95_), .b(new_n51_), .c(new_n85_), .O(new_n96_));
  oai21  g050(.a(new_n87_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n103_), .c(new_n60_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n68_), .b(new_n130_), .c(new_n60_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n96_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n85_), .O(new_n135_));
  ...
  oai21  g092(.a(x16), .b(x14), .c(new_n83_), .O(new_n139_));
  nand2  g093(.a(new_n135_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n104_), .d(new_n87_), .O(new_n142_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n122_), .c(new_n104_), .d(new_n87_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n89_), .b(x07), .O(new_n153_));
