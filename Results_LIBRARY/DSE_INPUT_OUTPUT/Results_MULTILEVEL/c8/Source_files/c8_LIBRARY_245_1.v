...
module FAU ( 
  ...
  nand3  g034(.a(x18), .b(x04), .c(x00), .O(new_n81_));
  ...
  nand3  g041(.a(new_n87_), .b(new_n78_), .c(x16), .O(new_n88_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n78_), .O(z10));
  ...
  oai21  g069(.a(x18), .b(x12), .c(new_n80_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n78_), .O(z13));
  ...
  aoi21  g079(.a(new_n118_), .b(new_n95_), .c(new_n69_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n125_), .c(new_n78_), .O(z14));
  ...
  nand3  g096(.a(new_n142_), .b(new_n136_), .c(new_n78_), .O(z15));
  nand3  g097(.a(x18), .b(x07), .c(x04), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n102_), .d(new_n85_), .O(new_n149_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n138_), .c(new_n69_), .O(new_n154_));
  nand3  g108(.a(new_n102_), .b(x19), .c(new_n127_), .O(new_n155_));
