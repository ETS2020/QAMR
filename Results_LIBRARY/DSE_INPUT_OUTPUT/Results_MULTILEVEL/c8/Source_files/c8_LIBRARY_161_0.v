...
module FAU ( 
  ...
  nand2  g28(.a(new_n54_), .b(new_n74_), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z05));
  inv1   g30(.a(x14), .O(new_n77_));
  nand2  g31(.a(x27), .b(new_n77_), .O(new_n78_));
  inv1   g32(.a(x25), .O(new_n79_));
  nand2  g33(.a(new_n54_), .b(new_n79_), .O(new_n80_));
  aoi21  g34(.a(new_n80_), .b(new_n78_), .c(new_n48_), .O(z06));
  inv1   g35(.a(x15), .O(new_n82_));
  aoi21  g36(.a(x27), .b(new_n82_), .c(new_n48_), .O(new_n83_));
  oai21  g37(.a(x27), .b(x26), .c(new_n83_), .O(z07));
  nor2   g38(.a(new_n48_), .b(new_n54_), .O(z08));
  inv1   g39(.a(x17), .O(new_n86_));
  inv1   g40(.a(x19), .O(new_n87_));
  ...
  nor2   g45(.a(new_n91_), .b(x16), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(x00), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n90_), .O(z09));
  inv1   g48(.a(x16), .O(new_n95_));
  oai21  g49(.a(new_n91_), .b(x01), .c(new_n95_), .O(new_n96_));
  nor2   g50(.a(new_n89_), .b(new_n53_), .O(new_n97_));
  nor3   g51(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n96_), .O(z10));
  oai21  g54(.a(new_n91_), .b(x02), .c(new_n95_), .O(new_n101_));
  nor2   g55(.a(x20), .b(x19), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nand4  g57(.a(new_n59_), .b(new_n53_), .c(new_n87_), .d(new_n86_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n95_), .c(new_n101_), .O(z11));
  oai21  g61(.a(new_n91_), .b(x03), .c(new_n95_), .O(new_n108_));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n89_), .c(new_n53_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n95_), .c(new_n108_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n98_), .c(new_n111_), .d(x23), .O(new_n115_));
  nand2  g69(.a(new_n92_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n95_), .c(new_n116_), .O(z13));
  aoi21  g71(.a(new_n114_), .b(new_n98_), .c(new_n74_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n110_), .c(new_n102_), .d(new_n86_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n92_), .b(x05), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  oai21  g78(.a(new_n91_), .b(x06), .c(new_n95_), .O(new_n125_));
  nand4  g79(.a(new_n79_), .b(new_n74_), .c(new_n69_), .d(new_n64_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n105_), .c(new_n120_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n95_), .c(new_n125_), .O(z15));
  nor2   g83(.a(x21), .b(x20), .O(new_n130_));
  nor2   g84(.a(x23), .b(x22), .O(new_n131_));
  nor2   g85(.a(x25), .b(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n89_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x26), .O(new_n134_));
  nor3   g88(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n131_), .c(new_n130_), .d(new_n89_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n92_), .b(x07), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n138_), .O(z16));
  nor2   g94(.a(new_n87_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n135_), .c(new_n131_), .d(new_n130_), .O(new_n142_));
  nand2  g96(.a(x27), .b(x17), .O(new_n143_));
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n95_), .O(z17));
endmodule
