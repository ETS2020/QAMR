...
module FAU ( 
  ...
  nor2   g47(.a(x18), .b(x16), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n52_), .c(new_n93_), .O(z10));
  oai21  g50(.a(x18), .b(x10), .c(new_n87_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nand4  g53(.a(new_n57_), .b(new_n90_), .c(new_n83_), .d(new_n82_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n87_), .c(new_n97_), .O(z11));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n85_), .c(new_n100_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n87_), .c(new_n95_), .d(new_n61_), .O(z12));
  oai21  g60(.a(x18), .b(x12), .c(new_n87_), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n85_), .c(new_n90_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n92_), .c(new_n109_), .d(x23), .O(new_n111_));
  ...
  nand3  g92(.a(new_n138_), .b(new_n129_), .c(new_n113_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n82_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n58_), .d(new_n82_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(new_n80_), .O(z17));
endmodule
