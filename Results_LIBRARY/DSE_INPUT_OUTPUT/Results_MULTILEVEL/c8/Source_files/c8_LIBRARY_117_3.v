...
module FAU ( 
  ...
  nand4  g083(.a(new_n129_), .b(new_n114_), .c(new_n97_), .d(new_n84_), .O(new_n130_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n104_), .d(new_n86_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n95_), .c(x16), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n139_), .c(new_n104_), .d(new_n86_), .O(new_n148_));
