...
module FAU ( 
  ...
  nor2   g002(.a(new_n48_), .b(x10), .O(new_n49_));
  ...
  nand2  g011(.a(new_n55_), .b(x21), .O(new_n58_));
  nand2  g012(.a(new_n58_), .b(new_n48_), .O(new_n59_));
  inv1   g013(.a(x21), .O(new_n60_));
  nand3  g014(.a(new_n55_), .b(new_n60_), .c(x10), .O(new_n61_));
  ...
  nand2  g038(.a(x18), .b(x10), .O(new_n85_));
  ...
  nor2   g049(.a(new_n95_), .b(new_n54_), .O(new_n96_));
  ...
  oai22  g080(.a(new_n85_), .b(new_n126_), .c(x18), .d(new_n71_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n83_), .O(new_n128_));
  inv1   g082(.a(x17), .O(new_n129_));
  inv1   g083(.a(x19), .O(new_n130_));
  nand3  g084(.a(new_n54_), .b(new_n130_), .c(new_n129_), .O(new_n131_));
  inv1   g085(.a(x22), .O(new_n132_));
  nand3  g086(.a(new_n68_), .b(new_n132_), .c(new_n60_), .O(new_n133_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n121_), .c(new_n103_), .d(new_n95_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n88_), .O(z15));
  inv1   g103(.a(x07), .O(new_n150_));
  oai22  g104(.a(new_n85_), .b(new_n150_), .c(x18), .d(new_n77_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n121_), .c(new_n103_), .d(new_n95_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n88_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  inv1   g112(.a(x24), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n121_), .c(new_n159_), .O(new_n161_));
  nand3  g115(.a(new_n103_), .b(x19), .c(new_n129_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n129_), .O(new_n163_));
