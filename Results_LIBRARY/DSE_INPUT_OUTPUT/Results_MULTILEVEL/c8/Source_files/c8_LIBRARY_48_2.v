...
module FAU ( 
  ...
  oai21  g048(.a(x16), .b(x09), .c(new_n87_), .O(new_n95_));
  ...
  nor2   g053(.a(new_n87_), .b(x16), .O(new_n100_));
  ...
  nand2  g062(.a(new_n100_), .b(x02), .O(new_n109_));
  ...
  nand2  g070(.a(new_n100_), .b(x03), .O(new_n117_));
  ...
  oai21  g081(.a(x16), .b(x13), .c(new_n87_), .O(new_n128_));
  aoi21  g082(.a(new_n123_), .b(new_n98_), .c(new_n75_), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n113_), .c(new_n130_), .d(new_n89_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n129_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n100_), .b(x05), .O(new_n135_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n105_), .d(new_n96_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n105_), .d(new_n96_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n89_), .O(new_n158_));
