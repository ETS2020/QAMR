...
module FAU ( 
  ...
  oai21  g032(.a(x27), .b(new_n78_), .c(new_n77_), .O(new_n79_));
  nand2  g033(.a(new_n52_), .b(new_n78_), .O(new_n80_));
  oai21  g034(.a(new_n80_), .b(x18), .c(new_n79_), .O(z07));
  nand2  g035(.a(new_n47_), .b(new_n52_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  inv1   g037(.a(x00), .O(new_n84_));
  nand2  g038(.a(x18), .b(new_n77_), .O(new_n85_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n47_), .c(x16), .O(new_n115_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n47_), .c(x16), .O(new_n124_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n128_), .c(new_n47_), .O(z14));
  ...
  oai21  g101(.a(x18), .b(new_n83_), .c(x15), .O(new_n148_));
  nand2  g102(.a(new_n144_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n103_), .d(new_n94_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(x18), .b(new_n83_), .c(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand4  g109(.a(new_n142_), .b(new_n78_), .c(new_n74_), .d(new_n129_), .O(new_n156_));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n131_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n131_), .O(new_n158_));
