...
module FAU ( 
  ...
  nor2   g041(.a(x18), .b(x16), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(x08), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n87_), .c(new_n83_), .O(z09));
  ...
  nand3  g049(.a(new_n57_), .b(new_n51_), .c(new_n84_), .O(new_n96_));
  oai21  g050(.a(new_n86_), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n95_), .c(x16), .O(new_n98_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n101_), .c(new_n62_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g076(.a(new_n88_), .b(x12), .O(new_n123_));
  ...
  nand2  g080(.a(new_n126_), .b(new_n91_), .O(new_n127_));
  inv1   g081(.a(x23), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n67_), .c(new_n62_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n96_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n112_), .c(new_n131_), .d(new_n84_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n95_), .c(x16), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n119_), .c(new_n102_), .d(new_n86_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n95_), .c(x16), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n102_), .d(new_n86_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n95_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nand2  g108(.a(new_n128_), .b(new_n67_), .O(new_n155_));
  inv1   g109(.a(x24), .O(new_n156_));
  inv1   g110(.a(x25), .O(new_n157_));
  inv1   g111(.a(x26), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n157_), .c(new_n156_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand3  g114(.a(new_n102_), .b(x19), .c(new_n84_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n52_), .b(new_n84_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n95_), .c(new_n91_), .O(z17));
endmodule
