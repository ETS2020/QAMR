...
module FAU ( 
  ...
  oai21  g45(.a(new_n91_), .b(new_n52_), .c(new_n89_), .O(z10));
  ...
  oai22  g52(.a(new_n98_), .b(new_n84_), .c(new_n91_), .d(new_n58_), .O(z11));
  ...
  oai22  g61(.a(new_n107_), .b(new_n84_), .c(new_n91_), .d(new_n64_), .O(z13));
  ...
  aoi22  g75(.a(new_n121_), .b(new_n97_), .c(new_n111_), .d(x25), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n84_), .c(new_n116_), .O(z15));
  ...
  nand2  g86(.a(new_n90_), .b(x15), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n132_), .O(z16));
  inv1   g88(.a(new_n49_), .O(new_n135_));
  nor2   g89(.a(x26), .b(x25), .O(new_n136_));
  nand3  g90(.a(new_n136_), .b(new_n125_), .c(new_n69_), .O(new_n137_));
  nand3  g91(.a(new_n124_), .b(x19), .c(new_n79_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n55_), .d(new_n79_), .O(new_n139_));
