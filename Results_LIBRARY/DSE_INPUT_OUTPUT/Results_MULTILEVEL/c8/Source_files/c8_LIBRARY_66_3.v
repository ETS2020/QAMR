...
module FAU ( 
  ...
  nand2  g000(.a(x23), .b(x18), .O(new_n47_));
  ...
  nand2  g026(.a(new_n52_), .b(new_n71_), .O(new_n73_));
  nand3  g027(.a(new_n73_), .b(new_n72_), .c(new_n47_), .O(z04));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(z05));
  ...
  nand2  g039(.a(new_n52_), .b(new_n85_), .O(new_n86_));
  aoi21  g040(.a(new_n86_), .b(new_n84_), .c(new_n48_), .O(z07));
  nand2  g041(.a(new_n47_), .b(new_n52_), .O(z08));
  inv1   g042(.a(x16), .O(new_n89_));
  inv1   g043(.a(x00), .O(new_n90_));
  nand2  g044(.a(new_n71_), .b(x18), .O(new_n91_));
  oai22  g045(.a(new_n91_), .b(new_n90_), .c(x18), .d(new_n49_), .O(new_n92_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n47_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n93_), .O(z09));
  inv1   g053(.a(x01), .O(new_n100_));
  oai22  g054(.a(new_n91_), .b(new_n100_), .c(x18), .d(new_n55_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n89_), .O(new_n102_));
  inv1   g056(.a(x17), .O(new_n103_));
  nand3  g057(.a(new_n57_), .b(new_n51_), .c(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n95_), .b(new_n57_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n47_), .c(x16), .O(new_n106_));
  ...
  nand2  g065(.a(new_n111_), .b(new_n95_), .O(new_n112_));
  oai21  g066(.a(new_n110_), .b(new_n62_), .c(new_n112_), .O(new_n113_));
  aoi21  g067(.a(new_n113_), .b(x16), .c(new_n48_), .O(new_n114_));
  oai21  g068(.a(new_n109_), .b(x16), .c(new_n114_), .O(z11));
  nand2  g069(.a(x18), .b(x03), .O(new_n116_));
  oai21  g070(.a(x18), .b(new_n65_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n89_), .O(new_n118_));
  aoi21  g072(.a(new_n111_), .b(new_n95_), .c(new_n67_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n57_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n47_), .O(z12));
  inv1   g078(.a(x04), .O(new_n125_));
  oai22  g079(.a(new_n91_), .b(new_n125_), .c(x18), .d(new_n70_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n89_), .O(new_n127_));
  nand2  g081(.a(new_n121_), .b(x23), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n110_), .c(new_n62_), .O(new_n130_));
  oai21  g084(.a(new_n128_), .b(x18), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n127_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  oai22  g088(.a(new_n91_), .b(new_n134_), .c(x18), .d(new_n75_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n89_), .O(new_n136_));
  nand2  g090(.a(new_n121_), .b(x24), .O(new_n137_));
  nor2   g091(.a(x24), .b(x22), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n110_), .c(new_n62_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x23), .O(new_n140_));
  nor3   g094(.a(new_n77_), .b(new_n71_), .c(x18), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n140_), .c(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n136_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n91_), .b(new_n144_), .c(x18), .d(new_n80_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n89_), .O(new_n146_));
  nand3  g100(.a(new_n77_), .b(new_n67_), .c(new_n62_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n104_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x20), .b(x19), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n149_), .d(new_n103_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n148_), .c(x23), .O(new_n152_));
  nand2  g106(.a(x25), .b(x23), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(x18), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n152_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n146_), .O(z15));
  inv1   g110(.a(x07), .O(new_n157_));
  oai22  g111(.a(new_n91_), .b(new_n157_), .c(x18), .d(new_n83_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n89_), .O(new_n159_));
  nand2  g113(.a(new_n151_), .b(x26), .O(new_n160_));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n138_), .c(new_n111_), .d(new_n95_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n160_), .c(x23), .O(new_n163_));
  nor3   g117(.a(new_n85_), .b(new_n71_), .c(x18), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n163_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n159_), .O(z16));
  nand3  g120(.a(new_n47_), .b(x27), .c(x17), .O(new_n167_));
  nor2   g121(.a(new_n51_), .b(x17), .O(new_n168_));
  nor3   g122(.a(x26), .b(x25), .c(x24), .O(new_n169_));
  nand4  g123(.a(new_n169_), .b(new_n168_), .c(new_n129_), .d(new_n111_), .O(new_n170_));
