...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n87_), .O(z10));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n87_), .O(z11));
  nand2  g061(.a(x18), .b(x03), .O(new_n108_));
  nand3  g062(.a(new_n83_), .b(x11), .c(new_n48_), .O(new_n109_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n94_), .c(new_n54_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n87_), .c(x16), .O(new_n116_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n87_), .O(z13));
  nand2  g080(.a(x18), .b(x05), .O(new_n127_));
  nand3  g081(.a(new_n83_), .b(x13), .c(new_n48_), .O(new_n128_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n122_), .c(new_n103_), .d(new_n94_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n87_), .O(z15));
  nand3  g105(.a(new_n83_), .b(x15), .c(new_n48_), .O(new_n152_));
  oai21  g106(.a(new_n83_), .b(new_n48_), .c(new_n152_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n122_), .c(new_n103_), .d(new_n94_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n87_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n154_), .O(z16));
  inv1   g114(.a(x24), .O(new_n161_));
  nor2   g115(.a(x26), .b(x25), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n122_), .c(new_n161_), .O(new_n163_));
  nand3  g117(.a(new_n103_), .b(x19), .c(new_n131_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n131_), .O(new_n165_));
