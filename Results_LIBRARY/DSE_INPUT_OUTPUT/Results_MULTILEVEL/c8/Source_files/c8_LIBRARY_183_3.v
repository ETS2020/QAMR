...
module FAU ( 
  ...
  nand3  g049(.a(new_n95_), .b(new_n86_), .c(x09), .O(new_n96_));
  ...
  oai21  g056(.a(new_n93_), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n95_), .c(x16), .O(new_n104_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n95_), .c(x16), .O(new_n113_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n60_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n95_), .c(x16), .O(new_n122_));
  ...
  nand3  g099(.a(new_n145_), .b(new_n95_), .c(x16), .O(new_n146_));
  ...
  nand3  g107(.a(new_n95_), .b(new_n86_), .c(x15), .O(new_n154_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n95_), .c(x16), .O(new_n160_));
