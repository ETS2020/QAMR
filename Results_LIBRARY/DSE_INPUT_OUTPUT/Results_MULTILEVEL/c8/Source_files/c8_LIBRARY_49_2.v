...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x10), .O(new_n53_));
  ...
  nor2   g045(.a(x18), .b(x10), .O(new_n92_));
  ...
  inv1   g061(.a(new_n104_), .O(new_n108_));
  nor2   g062(.a(x21), .b(x20), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n102_), .O(new_n110_));
  oai21  g064(.a(new_n108_), .b(new_n60_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n53_), .c(x16), .O(new_n112_));
  nand3  g066(.a(x18), .b(new_n97_), .c(x02), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n112_), .O(z11));
  ...
  aoi21  g071(.a(new_n52_), .b(x10), .c(x22), .O(new_n118_));
  ...
  nand4  g080(.a(new_n102_), .b(new_n65_), .c(new_n60_), .d(new_n55_), .O(new_n127_));
  ...
  nand2  g089(.a(new_n135_), .b(new_n97_), .O(new_n136_));
  aoi21  g090(.a(new_n129_), .b(new_n108_), .c(new_n75_), .O(new_n137_));
  nand4  g091(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n60_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n104_), .O(new_n139_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n109_), .d(new_n102_), .O(new_n147_));
  oai21  g101(.a(new_n139_), .b(new_n83_), .c(new_n147_), .O(new_n148_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n97_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nand4  g108(.a(new_n145_), .b(new_n86_), .c(new_n83_), .d(new_n75_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n110_), .c(new_n154_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n153_), .c(new_n53_), .O(z16));
  nand3  g112(.a(new_n109_), .b(x19), .c(new_n103_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n48_), .d(new_n103_), .O(new_n160_));
