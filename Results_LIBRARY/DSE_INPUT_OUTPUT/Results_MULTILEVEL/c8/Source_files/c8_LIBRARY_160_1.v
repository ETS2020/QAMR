...
module FAU ( 
  ...
  nor2   g006(.a(new_n52_), .b(x06), .O(new_n53_));
  ...
  aoi21  g015(.a(x27), .b(new_n61_), .c(new_n53_), .O(new_n62_));
  ...
  nand2  g034(.a(new_n80_), .b(new_n50_), .O(z08));
  inv1   g035(.a(x16), .O(new_n82_));
  inv1   g036(.a(x00), .O(new_n83_));
  nand2  g037(.a(x18), .b(x06), .O(new_n84_));
  ...
  nand3  g049(.a(new_n93_), .b(new_n49_), .c(new_n95_), .O(new_n96_));
  oai21  g050(.a(new_n94_), .b(new_n93_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n80_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n92_), .O(z10));
  inv1   g053(.a(x02), .O(new_n100_));
  oai22  g054(.a(new_n84_), .b(new_n100_), .c(x18), .d(new_n58_), .O(new_n101_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n80_), .c(x16), .O(new_n108_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n80_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n112_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  oai21  g073(.a(x18), .b(new_n64_), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n80_), .O(z13));
  ...
  nand3  g085(.a(new_n66_), .b(new_n131_), .c(new_n103_), .O(new_n132_));
  ...
  oai21  g093(.a(x18), .b(new_n72_), .c(new_n84_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n82_), .O(new_n141_));
  nand2  g095(.a(new_n136_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n123_), .c(new_n105_), .d(new_n94_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n82_), .O(new_n150_));
  nand2  g104(.a(new_n144_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n123_), .c(new_n105_), .d(new_n94_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n80_), .O(z16));
  inv1   g110(.a(x24), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n123_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n105_), .b(x19), .c(new_n95_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n50_), .d(new_n95_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n80_), .O(z17));
endmodule
