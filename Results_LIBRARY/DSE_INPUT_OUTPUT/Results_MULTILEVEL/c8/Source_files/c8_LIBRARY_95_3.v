...
module FAU ( 
  ...
  oai21  g028(.a(x27), .b(x15), .c(x18), .O(new_n75_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n103_), .c(new_n47_), .O(z11));
  inv1   g064(.a(x03), .O(new_n111_));
  oai22  g065(.a(new_n84_), .b(new_n111_), .c(x18), .d(new_n61_), .O(new_n112_));
  ...
  oai22  g074(.a(new_n84_), .b(new_n120_), .c(x18), .d(new_n64_), .O(new_n121_));
  ...
  oai22  g093(.a(new_n84_), .b(new_n139_), .c(x18), .d(new_n72_), .O(new_n140_));
