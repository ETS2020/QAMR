...
module FAU ( 
  ...
  nand3  g075(.a(new_n121_), .b(new_n104_), .c(new_n57_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(new_n92_), .b(new_n86_), .c(x12), .O(new_n125_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n63_), .c(new_n57_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n97_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n114_), .c(new_n133_), .d(new_n95_), .O(new_n135_));
  ...
  nand3  g098(.a(new_n92_), .b(new_n86_), .c(x14), .O(new_n145_));
  ...
  nor2   g115(.a(new_n58_), .b(new_n95_), .O(new_n162_));
  aoi21  g116(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n92_), .c(new_n86_), .O(z17));
endmodule
