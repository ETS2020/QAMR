...
module FAU ( 
  ...
  nor2   g006(.a(new_n52_), .b(x04), .O(new_n53_));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n53_), .O(z05));
  inv1   g033(.a(x14), .O(new_n80_));
  nand2  g034(.a(x27), .b(new_n80_), .O(new_n81_));
  inv1   g035(.a(x25), .O(new_n82_));
  nand2  g036(.a(new_n50_), .b(new_n82_), .O(new_n83_));
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n53_), .O(z06));
  inv1   g038(.a(x15), .O(new_n85_));
  aoi21  g039(.a(x27), .b(new_n85_), .c(new_n53_), .O(new_n86_));
  oai21  g040(.a(x27), .b(x26), .c(new_n86_), .O(z07));
  nor2   g041(.a(new_n53_), .b(new_n50_), .O(z08));
  inv1   g042(.a(x16), .O(new_n89_));
  inv1   g043(.a(x00), .O(new_n90_));
  nand2  g044(.a(x18), .b(x04), .O(new_n91_));
  oai22  g045(.a(new_n91_), .b(new_n90_), .c(x18), .d(new_n47_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  inv1   g047(.a(new_n53_), .O(new_n94_));
  ...
  oai22  g055(.a(new_n91_), .b(new_n101_), .c(x18), .d(new_n55_), .O(new_n102_));
  ...
  oai21  g060(.a(new_n96_), .b(new_n57_), .c(new_n106_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n94_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n103_), .O(z10));
  ...
  oai21  g069(.a(new_n113_), .b(new_n62_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n94_), .O(z11));
  ...
  aoi21  g075(.a(new_n114_), .b(new_n96_), .c(new_n67_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n96_), .c(new_n57_), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n94_), .O(z12));
  oai21  g081(.a(x18), .b(x12), .c(new_n89_), .O(new_n128_));
  nand2  g082(.a(new_n124_), .b(x23), .O(new_n129_));
  nor3   g083(.a(x23), .b(x22), .c(x21), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n113_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n128_), .c(new_n94_), .O(z13));
  nand2  g088(.a(x18), .b(x05), .O(new_n135_));
  oai21  g089(.a(x18), .b(new_n75_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n89_), .O(new_n137_));
  aoi21  g091(.a(new_n130_), .b(new_n113_), .c(new_n77_), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n123_), .c(new_n105_), .d(new_n104_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n138_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n94_), .O(z14));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n114_), .d(new_n96_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n146_), .c(new_n94_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai21  g108(.a(x18), .b(new_n85_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n89_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n114_), .d(new_n96_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n94_), .O(z16));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n148_), .c(new_n77_), .O(new_n164_));
  nand3  g118(.a(new_n114_), .b(x19), .c(new_n104_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n50_), .d(new_n104_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n94_), .O(z17));
endmodule
