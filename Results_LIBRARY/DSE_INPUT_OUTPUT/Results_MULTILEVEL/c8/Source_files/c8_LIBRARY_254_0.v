...
module FAU ( 
  ...
  nor2   g005(.a(x16), .b(x04), .O(new_n52_));
  ...
  aoi21  g024(.a(new_n70_), .b(new_n68_), .c(new_n52_), .O(z04));
  ...
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n52_), .O(z06));
  inv1   g035(.a(x15), .O(new_n82_));
  aoi21  g036(.a(x27), .b(new_n82_), .c(new_n52_), .O(new_n83_));
  oai21  g037(.a(x27), .b(x26), .c(new_n83_), .O(z07));
  inv1   g038(.a(new_n52_), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(new_n50_), .O(z08));
  ...
  nand3  g048(.a(new_n94_), .b(new_n92_), .c(x04), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n90_), .O(z09));
  nand2  g051(.a(x18), .b(x01), .O(new_n98_));
  oai21  g052(.a(x18), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n91_), .c(x04), .O(new_n100_));
  inv1   g054(.a(x20), .O(new_n101_));
  nor2   g055(.a(new_n89_), .b(new_n101_), .O(new_n102_));
  ...
  oai21  g060(.a(x18), .b(new_n57_), .c(new_n106_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n91_), .c(x04), .O(new_n108_));
  nor2   g062(.a(x20), .b(x19), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n87_), .O(new_n110_));
  nand4  g064(.a(new_n59_), .b(new_n101_), .c(new_n49_), .d(new_n87_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  aoi21  g066(.a(new_n110_), .b(x21), .c(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n91_), .c(new_n108_), .O(z11));
  nand2  g068(.a(x18), .b(x03), .O(new_n115_));
  nand2  g069(.a(new_n93_), .b(x11), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n115_), .c(x04), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n91_), .O(new_n118_));
  nand2  g072(.a(new_n111_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n89_), .c(new_n101_), .O(new_n121_));
  and2   g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n91_), .c(new_n118_), .O(z12));
  nand2  g077(.a(new_n93_), .b(new_n67_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n91_), .c(x04), .O(new_n125_));
  nor3   g079(.a(x23), .b(x22), .c(x21), .O(new_n126_));
  aoi22  g080(.a(new_n126_), .b(new_n103_), .c(new_n121_), .d(x23), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n91_), .c(new_n125_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  nand2  g083(.a(new_n93_), .b(x13), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(x04), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n91_), .O(new_n132_));
  aoi21  g086(.a(new_n126_), .b(new_n103_), .c(new_n74_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n120_), .c(new_n109_), .d(new_n87_), .O(new_n135_));
  ...
  oai21  g093(.a(x18), .b(new_n77_), .c(new_n139_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n91_), .c(x04), .O(new_n141_));
  nand4  g095(.a(new_n79_), .b(new_n74_), .c(new_n69_), .d(new_n64_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  aoi22  g097(.a(new_n143_), .b(new_n112_), .c(new_n135_), .d(x25), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n91_), .c(new_n141_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  oai21  g100(.a(x18), .b(new_n82_), .c(new_n146_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n91_), .c(x04), .O(new_n148_));
  nor2   g102(.a(x21), .b(x20), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n89_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n150_), .c(new_n149_), .d(new_n89_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n148_), .O(z16));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n150_), .c(new_n74_), .O(new_n160_));
  nand3  g114(.a(new_n149_), .b(x19), .c(new_n87_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n50_), .d(new_n87_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n85_), .O(z17));
endmodule
