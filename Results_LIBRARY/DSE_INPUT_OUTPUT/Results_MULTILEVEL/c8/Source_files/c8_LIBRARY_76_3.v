...
module FAU ( 
  ...
  aoi21  g066(.a(new_n106_), .b(new_n95_), .c(new_n112_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n95_), .c(new_n57_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nor2   g071(.a(x18), .b(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x11), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n117_), .c(new_n111_), .O(z12));
  ...
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n96_), .d(new_n85_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n118_), .b(x13), .O(new_n137_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n106_), .d(new_n95_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n118_), .b(x14), .O(new_n146_));
