...
module FAU ( 
  ...
  nand2  g039(.a(x18), .b(x07), .O(new_n86_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n82_), .c(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n88_), .O(z09));
  inv1   g048(.a(x01), .O(new_n95_));
  oai22  g049(.a(new_n86_), .b(new_n95_), .c(x18), .d(new_n52_), .O(new_n96_));
  ...
  nand3  g054(.a(new_n98_), .b(new_n100_), .c(new_n99_), .O(new_n101_));
  oai21  g055(.a(new_n90_), .b(new_n98_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n82_), .O(z11));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n90_), .c(new_n63_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n90_), .c(new_n98_), .O(new_n119_));
  ...
  oai22  g077(.a(new_n86_), .b(new_n123_), .c(x18), .d(new_n66_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n84_), .O(new_n125_));
  nand2  g079(.a(new_n119_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n108_), .c(new_n57_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n82_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  inv1   g085(.a(x05), .O(new_n132_));
  oai22  g086(.a(new_n86_), .b(new_n132_), .c(x18), .d(new_n69_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n84_), .O(new_n134_));
  inv1   g088(.a(x23), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n63_), .c(new_n57_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n101_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n118_), .c(new_n138_), .d(new_n99_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n82_), .c(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n134_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n86_), .b(new_n144_), .c(x18), .d(new_n72_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n84_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n127_), .c(new_n109_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n82_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z15));
  oai21  g106(.a(x18), .b(x15), .c(new_n84_), .O(new_n153_));
  nand2  g107(.a(new_n149_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n127_), .c(new_n109_), .d(new_n90_), .O(new_n156_));
  ...
  nand4  g114(.a(new_n127_), .b(new_n79_), .c(new_n74_), .d(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n99_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n58_), .d(new_n99_), .O(new_n163_));
