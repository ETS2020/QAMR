...
module FAU ( 
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n101_), .d(new_n93_), .O(new_n138_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n136_), .c(new_n101_), .d(new_n93_), .O(new_n146_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n136_), .c(new_n125_), .O(new_n152_));
  nand3  g106(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n52_), .d(new_n85_), .O(new_n154_));
