...
module FAU ( 
  ...
  oai21  g47(.a(new_n89_), .b(new_n55_), .c(new_n93_), .O(z10));
  ...
  nand4  g53(.a(new_n99_), .b(new_n57_), .c(new_n51_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n95_), .c(new_n96_), .O(z11));
  oai21  g57(.a(x18), .b(x11), .c(new_n95_), .O(new_n104_));
  nand2  g58(.a(new_n100_), .b(x22), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n86_), .c(new_n57_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n95_), .c(new_n104_), .O(z12));
  oai21  g63(.a(x18), .b(x12), .c(new_n95_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n92_), .c(new_n107_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n95_), .c(new_n110_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n95_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n92_), .c(new_n73_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n106_), .c(new_n97_), .d(new_n84_), .O(new_n117_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n73_), .c(new_n121_), .d(new_n65_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n101_), .c(new_n117_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n88_), .b(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n95_), .c(new_n126_), .O(z15));
  ...
  nand2  g90(.a(new_n88_), .b(x15), .O(new_n137_));
