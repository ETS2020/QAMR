...
module FAU ( 
  ...
  oai21  g054(.a(new_n92_), .b(new_n57_), .c(new_n100_), .O(new_n101_));
  ...
  aoi21  g059(.a(new_n99_), .b(new_n84_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g076(.a(new_n117_), .b(new_n92_), .c(new_n69_), .O(new_n123_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n99_), .d(new_n84_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n135_), .c(new_n99_), .d(new_n84_), .O(new_n146_));
  ...
  nand3  g104(.a(new_n150_), .b(new_n135_), .c(new_n69_), .O(new_n151_));
