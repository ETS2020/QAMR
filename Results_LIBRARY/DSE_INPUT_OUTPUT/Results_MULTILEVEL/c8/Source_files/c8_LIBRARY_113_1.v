...
module FAU ( 
  ...
  aoi21  g027(.a(x27), .b(x18), .c(new_n47_), .O(new_n74_));
  ...
  nor2   g033(.a(x25), .b(x18), .O(new_n80_));
  ...
  aoi22  g039(.a(new_n80_), .b(x09), .c(x18), .d(x01), .O(new_n86_));
  ...
  aoi22  g048(.a(new_n80_), .b(x10), .c(x18), .d(x02), .O(new_n95_));
  ...
  oai21  g055(.a(new_n95_), .b(x16), .c(new_n101_), .O(z11));
  ...
  nand3  g063(.a(new_n109_), .b(new_n88_), .c(new_n87_), .O(new_n110_));
  ...
  aoi21  g079(.a(new_n118_), .b(new_n97_), .c(new_n71_), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n109_), .c(new_n90_), .d(new_n89_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n126_), .c(x16), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n125_), .c(new_n82_), .O(z14));
  nand2  g085(.a(x18), .b(x06), .O(new_n132_));
  nand2  g086(.a(new_n80_), .b(x14), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n103_), .O(new_n135_));
  nand3  g089(.a(new_n128_), .b(x25), .c(x18), .O(new_n136_));
  nor2   g090(.a(x23), .b(x22), .O(new_n137_));
  nor2   g091(.a(x25), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n98_), .d(new_n88_), .O(new_n139_));
  ...
  nand2  g098(.a(new_n144_), .b(new_n103_), .O(new_n145_));
  inv1   g099(.a(x26), .O(new_n146_));
  oai21  g100(.a(new_n146_), .b(new_n103_), .c(x18), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x25), .O(new_n148_));
  nand2  g102(.a(new_n128_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n137_), .c(new_n98_), .d(new_n88_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n145_), .O(z16));
  nand4  g108(.a(new_n137_), .b(new_n146_), .c(new_n47_), .d(new_n71_), .O(new_n155_));
  nand3  g109(.a(new_n98_), .b(x19), .c(new_n89_), .O(new_n156_));
