...
module FAU ( 
  ...
  nand4  g74(.a(new_n120_), .b(new_n108_), .c(new_n100_), .d(new_n85_), .O(new_n121_));
  ...
  nand4  g78(.a(new_n77_), .b(new_n118_), .c(new_n69_), .d(new_n64_), .O(new_n125_));
  ...
  nand3  g95(.a(new_n141_), .b(new_n132_), .c(new_n118_), .O(new_n142_));
