...
module FAU ( 
  ...
  oai21  g51(.a(new_n97_), .b(new_n52_), .c(new_n95_), .O(z10));
  ...
  oai22  g62(.a(new_n108_), .b(new_n90_), .c(new_n97_), .d(new_n61_), .O(z12));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n88_), .c(new_n54_), .O(new_n111_));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n94_), .c(new_n111_), .d(x23), .O(new_n113_));
  oai22  g67(.a(new_n113_), .b(new_n90_), .c(new_n97_), .d(new_n66_), .O(z13));
  aoi21  g68(.a(new_n112_), .b(new_n94_), .c(new_n71_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n110_), .c(new_n100_), .d(new_n85_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n96_), .b(x13), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n119_), .O(z14));
  inv1   g75(.a(x23), .O(new_n122_));
  nand4  g76(.a(new_n76_), .b(new_n71_), .c(new_n122_), .d(new_n63_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n104_), .c(new_n117_), .d(x25), .O(new_n125_));
