...
module FAU ( 
  ...
  nand2  g045(.a(new_n73_), .b(x18), .O(new_n92_));
  oai22  g046(.a(new_n92_), .b(new_n91_), .c(x18), .d(new_n52_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n86_), .O(new_n94_));
  nand3  g048(.a(new_n54_), .b(new_n82_), .c(new_n81_), .O(new_n95_));
  oai21  g049(.a(new_n84_), .b(new_n54_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n48_), .O(z11));
  ...
  aoi21  g065(.a(new_n103_), .b(new_n84_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n84_), .c(new_n54_), .O(new_n114_));
  ...
  oai22  g072(.a(new_n92_), .b(new_n118_), .c(x18), .d(new_n66_), .O(new_n119_));
  ...
  oai22  g081(.a(new_n92_), .b(new_n127_), .c(x18), .d(new_n69_), .O(new_n128_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n81_), .O(new_n135_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n122_), .c(new_n103_), .d(new_n84_), .O(new_n144_));
  ...
  oai21  g105(.a(new_n151_), .b(x18), .c(x25), .O(new_n152_));
  nand2  g106(.a(new_n135_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n122_), .c(new_n103_), .d(new_n84_), .O(new_n155_));
  ...
  nand3  g112(.a(new_n48_), .b(x27), .c(x17), .O(new_n159_));
  nor2   g113(.a(new_n82_), .b(x17), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n154_), .c(new_n122_), .d(new_n103_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n159_), .c(new_n86_), .O(z17));
endmodule
