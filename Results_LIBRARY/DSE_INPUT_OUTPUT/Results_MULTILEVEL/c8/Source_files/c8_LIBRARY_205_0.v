...
module FAU ( 
  ...
  nor2   g41(.a(new_n81_), .b(new_n53_), .O(new_n88_));
  ...
  nand2  g46(.a(new_n92_), .b(new_n78_), .O(new_n93_));
  inv1   g47(.a(x21), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n53_), .c(new_n79_), .d(new_n78_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(new_n84_), .b(x16), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x02), .O(new_n99_));
  oai21  g53(.a(new_n97_), .b(new_n83_), .c(new_n99_), .O(z11));
  nand2  g54(.a(new_n95_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n81_), .c(new_n53_), .O(new_n103_));
  and2   g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g58(.a(new_n98_), .b(x03), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n83_), .c(new_n105_), .O(z12));
  oai21  g60(.a(new_n84_), .b(x04), .c(new_n83_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n89_), .c(new_n103_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n83_), .c(new_n107_), .O(z13));
  aoi21  g64(.a(new_n108_), .b(new_n89_), .c(new_n68_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n102_), .c(new_n92_), .d(new_n78_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g69(.a(new_n98_), .b(x05), .O(new_n116_));
  ...
  nand2  g88(.a(new_n98_), .b(x07), .O(new_n135_));
