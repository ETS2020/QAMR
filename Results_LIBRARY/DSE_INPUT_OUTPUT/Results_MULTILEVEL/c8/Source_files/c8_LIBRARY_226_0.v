...
module FAU ( 
  ...
  nand2  g25(.a(new_n63_), .b(new_n71_), .O(new_n72_));
  ...
  nor2   g32(.a(new_n48_), .b(new_n63_), .O(z08));
  ...
  oai21  g57(.a(new_n86_), .b(x03), .c(new_n85_), .O(new_n104_));
