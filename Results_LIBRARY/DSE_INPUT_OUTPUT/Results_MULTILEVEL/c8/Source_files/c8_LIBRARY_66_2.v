...
module FAU ( 
  ...
  oai21  g024(.a(new_n53_), .b(x18), .c(new_n47_), .O(new_n71_));
  oai21  g025(.a(new_n53_), .b(x12), .c(new_n71_), .O(z04));
  ...
  nand2  g044(.a(x23), .b(x18), .O(new_n91_));
  ...
  oai22  g054(.a(new_n91_), .b(new_n100_), .c(x18), .d(new_n56_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n89_), .O(new_n102_));
  inv1   g056(.a(x17), .O(new_n103_));
  nand3  g057(.a(new_n58_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
  ...
  nor2   g061(.a(x18), .b(new_n61_), .O(new_n108_));
  ...
  aoi21  g067(.a(new_n113_), .b(x16), .c(new_n49_), .O(new_n114_));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n95_), .c(new_n68_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n58_), .O(new_n121_));
  ...
  oai22  g080(.a(new_n91_), .b(new_n125_), .c(x18), .d(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n89_), .O(new_n128_));
  nor2   g082(.a(x19), .b(x18), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n129_), .c(new_n111_), .d(new_n103_), .O(new_n131_));
  oai21  g085(.a(new_n122_), .b(new_n47_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n128_), .O(z13));
  inv1   g088(.a(x05), .O(new_n135_));
  oai22  g089(.a(new_n91_), .b(new_n135_), .c(x18), .d(new_n73_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n89_), .O(new_n137_));
  nand2  g091(.a(new_n121_), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n120_), .b(new_n110_), .c(new_n75_), .d(new_n47_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n138_), .c(x18), .O(new_n140_));
  nor2   g094(.a(new_n75_), .b(new_n47_), .O(new_n141_));
  ...
  nand3  g100(.a(new_n75_), .b(new_n68_), .c(new_n63_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n104_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n130_), .c(new_n111_), .d(new_n95_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n148_), .c(x18), .O(new_n151_));
  nor2   g105(.a(new_n78_), .b(new_n47_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n151_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n146_), .O(z15));
  inv1   g108(.a(x07), .O(new_n155_));
  oai22  g109(.a(new_n91_), .b(new_n155_), .c(x18), .d(new_n83_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n89_), .O(new_n157_));
  nor2   g111(.a(x20), .b(x19), .O(new_n158_));
  nand4  g112(.a(new_n149_), .b(new_n120_), .c(new_n158_), .d(new_n103_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n130_), .c(new_n111_), .d(new_n95_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n160_), .c(x18), .O(new_n163_));
  nor2   g117(.a(new_n85_), .b(new_n47_), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n163_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n157_), .O(z16));
  nand3  g120(.a(new_n48_), .b(x27), .c(x17), .O(new_n167_));
  nand2  g121(.a(new_n111_), .b(x19), .O(new_n168_));
  nor3   g122(.a(new_n168_), .b(x18), .c(x17), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n161_), .c(new_n130_), .O(new_n170_));
