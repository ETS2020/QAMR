...
module FAU ( 
  ...
  oai21  g39(.a(new_n47_), .b(x16), .c(new_n52_), .O(z08));
  ...
  nor2   g48(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nor3   g49(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  oai21  g51(.a(new_n92_), .b(new_n55_), .c(new_n97_), .O(z10));
  nor2   g52(.a(x20), .b(x19), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  nand4  g54(.a(new_n60_), .b(new_n94_), .c(new_n51_), .d(new_n87_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n91_), .c(new_n92_), .d(new_n58_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n89_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n91_), .c(new_n92_), .d(new_n63_), .O(z12));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n89_), .c(new_n94_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n96_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n91_), .c(new_n92_), .d(new_n66_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n91_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n96_), .c(new_n73_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n108_), .c(new_n99_), .d(new_n87_), .O(new_n116_));
  ...
  nand4  g74(.a(new_n78_), .b(new_n73_), .c(new_n68_), .d(new_n120_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n123_));
  nand3  g77(.a(new_n47_), .b(new_n91_), .c(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n91_), .c(new_n124_), .O(z15));
  oai21  g79(.a(x18), .b(x15), .c(new_n91_), .O(new_n126_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n91_), .O(z17));
endmodule
