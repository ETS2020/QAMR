...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(x12), .O(new_n93_));
  ...
  nor2   g056(.a(new_n102_), .b(new_n56_), .O(new_n103_));
  ...
  nand2  g064(.a(new_n110_), .b(new_n102_), .O(new_n111_));
  ...
  oai22  g069(.a(new_n93_), .b(new_n115_), .c(x18), .d(new_n66_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n91_), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x22), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n102_), .c(new_n56_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n91_), .c(x12), .O(new_n126_));
  ...
  nand3  g096(.a(new_n142_), .b(new_n135_), .c(new_n48_), .O(z14));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n110_), .d(new_n102_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n110_), .d(new_n102_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n87_), .c(new_n82_), .d(new_n77_), .O(new_n163_));
  nand3  g117(.a(new_n110_), .b(x19), .c(new_n137_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n53_), .d(new_n137_), .O(new_n165_));
