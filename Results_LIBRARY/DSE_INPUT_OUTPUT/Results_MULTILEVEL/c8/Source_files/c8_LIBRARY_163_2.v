...
module FAU ( 
  ...
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n101_), .d(new_n87_), .O(new_n141_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n118_), .c(new_n101_), .d(new_n87_), .O(new_n150_));
  ...
  nand2  g107(.a(new_n127_), .b(new_n67_), .O(new_n154_));
  inv1   g108(.a(x24), .O(new_n155_));
  inv1   g109(.a(x25), .O(new_n156_));
  inv1   g110(.a(x26), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n155_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand3  g113(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n52_), .b(new_n85_), .O(new_n162_));
