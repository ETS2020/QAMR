...
module FAU ( 
  ...
  aoi21  g040(.a(new_n86_), .b(new_n84_), .c(new_n70_), .O(z07));
  nor2   g041(.a(new_n70_), .b(new_n48_), .O(z08));
  ...
  oai22  g062(.a(new_n91_), .b(new_n108_), .c(x18), .d(new_n62_), .O(new_n109_));
  ...
  aoi21  g072(.a(new_n52_), .b(x18), .c(x22), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n60_), .c(new_n55_), .d(new_n47_), .O(new_n120_));
  ...
  oai22  g079(.a(new_n91_), .b(new_n125_), .c(x18), .d(new_n71_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n89_), .O(new_n127_));
  nor2   g081(.a(x22), .b(x21), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n100_), .c(new_n55_), .O(new_n129_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n128_), .c(new_n103_), .d(new_n102_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n138_), .c(new_n53_), .O(z14));
  ...
  nand2  g102(.a(new_n140_), .b(new_n128_), .O(new_n149_));
  nand3  g103(.a(new_n103_), .b(new_n102_), .c(x16), .O(new_n150_));
  nor2   g104(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(x18), .c(new_n52_), .O(new_n152_));
  nand3  g106(.a(new_n141_), .b(x25), .c(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n148_), .O(z15));
  ...
  nand2  g111(.a(new_n141_), .b(x26), .O(new_n158_));
  nor2   g112(.a(x23), .b(x22), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n159_), .c(new_n111_), .d(new_n100_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n158_), .c(x18), .O(new_n162_));
  nor2   g116(.a(new_n85_), .b(new_n52_), .O(new_n163_));
  ...
  nand3  g120(.a(new_n111_), .b(x19), .c(new_n102_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n48_), .d(new_n102_), .O(new_n168_));
