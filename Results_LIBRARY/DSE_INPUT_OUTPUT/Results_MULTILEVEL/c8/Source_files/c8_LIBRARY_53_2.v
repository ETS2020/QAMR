...
module FAU ( 
  ...
  oai21  g041(.a(x18), .b(new_n48_), .c(new_n55_), .O(z08));
  inv1   g042(.a(x18), .O(new_n89_));
  xnor2a g043(.a(x19), .b(x17), .O(new_n90_));
  inv1   g044(.a(x00), .O(new_n91_));
  nor2   g045(.a(x16), .b(new_n91_), .O(new_n92_));
  aoi21  g046(.a(new_n90_), .b(x16), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(new_n89_), .b(new_n48_), .c(x08), .O(new_n94_));
  oai21  g048(.a(new_n93_), .b(new_n89_), .c(new_n94_), .O(z09));
  oai21  g049(.a(x16), .b(x09), .c(new_n89_), .O(new_n96_));
  ...
  nand3  g054(.a(x18), .b(new_n48_), .c(x01), .O(new_n101_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n124_), .c(new_n106_), .d(new_n97_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n124_), .c(new_n106_), .d(new_n97_), .O(new_n157_));
  ...
  aoi21  g121(.a(new_n167_), .b(x18), .c(new_n48_), .O(z17));
endmodule
