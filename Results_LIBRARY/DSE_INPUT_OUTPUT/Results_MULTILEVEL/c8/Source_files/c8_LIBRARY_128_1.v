...
module FAU ( 
  ...
  inv1   g16(.a(x23), .O(new_n63_));
  inv1   g17(.a(x27), .O(new_n64_));
  nand2  g18(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  aoi21  g19(.a(new_n65_), .b(new_n62_), .c(new_n49_), .O(z04));
  inv1   g20(.a(x13), .O(new_n67_));
  nand2  g21(.a(x27), .b(new_n67_), .O(new_n68_));
  inv1   g22(.a(x24), .O(new_n69_));
  nand2  g23(.a(new_n64_), .b(new_n69_), .O(new_n70_));
  ...
  nor2   g31(.a(new_n49_), .b(new_n64_), .O(z08));
  ...
  oai21  g68(.a(x18), .b(x14), .c(new_n84_), .O(new_n115_));
  inv1   g69(.a(x22), .O(new_n116_));
  inv1   g70(.a(x25), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n69_), .c(new_n63_), .d(new_n116_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi22  g73(.a(new_n119_), .b(new_n96_), .c(new_n111_), .d(x25), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n84_), .c(new_n115_), .O(z15));
  nor2   g75(.a(x21), .b(x20), .O(new_n122_));
  nor2   g76(.a(x23), .b(x22), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n82_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(x26), .O(new_n126_));
  nor3   g80(.a(x26), .b(x25), .c(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n123_), .c(new_n122_), .d(new_n82_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g84(.a(new_n48_), .b(new_n84_), .c(x15), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n130_), .O(z16));
  inv1   g86(.a(new_n49_), .O(new_n133_));
  nor2   g87(.a(x26), .b(x25), .O(new_n134_));
  nand3  g88(.a(new_n134_), .b(new_n123_), .c(new_n69_), .O(new_n135_));
  nand3  g89(.a(new_n122_), .b(x19), .c(new_n79_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n135_), .c(new_n64_), .d(new_n79_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n133_), .O(z17));
endmodule
