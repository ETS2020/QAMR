...
module FAU ( 
  ...
  nand3  g070(.a(new_n116_), .b(new_n90_), .c(new_n99_), .O(new_n117_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n116_), .c(new_n100_), .d(new_n83_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n98_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n116_), .c(new_n69_), .O(new_n154_));
  nand3  g108(.a(new_n100_), .b(x19), .c(new_n80_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n55_), .d(new_n80_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n98_), .c(x16), .O(new_n157_));
