...
module FAU ( 
  ...
  aoi21  g024(.a(new_n70_), .b(new_n68_), .c(new_n50_), .O(z03));
  ...
  nand2  g040(.a(new_n49_), .b(x27), .O(new_n87_));
  nand3  g041(.a(new_n54_), .b(new_n48_), .c(x18), .O(new_n88_));
  oai21  g042(.a(new_n87_), .b(x15), .c(new_n88_), .O(z07));
  inv1   g043(.a(new_n87_), .O(z08));
  inv1   g044(.a(x16), .O(new_n91_));
  nand2  g045(.a(x18), .b(x00), .O(new_n92_));
  nand2  g046(.a(x26), .b(new_n47_), .O(new_n93_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n49_), .c(x16), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n95_), .O(z09));
  nand2  g052(.a(x18), .b(x01), .O(new_n99_));
  oai21  g053(.a(new_n93_), .b(new_n57_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n91_), .O(new_n101_));
  nor2   g055(.a(x19), .b(x17), .O(new_n102_));
  inv1   g056(.a(x17), .O(new_n103_));
  nand3  g057(.a(new_n59_), .b(new_n53_), .c(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n102_), .b(new_n59_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g062(.a(new_n93_), .b(new_n62_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n91_), .O(new_n110_));
  inv1   g064(.a(new_n104_), .O(new_n111_));
  nor2   g065(.a(x21), .b(x20), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n102_), .O(new_n113_));
  oai21  g067(.a(new_n111_), .b(new_n64_), .c(new_n113_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n49_), .c(x16), .O(new_n115_));
  ...
  aoi21  g073(.a(new_n48_), .b(new_n47_), .c(x22), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n64_), .c(new_n59_), .d(new_n53_), .O(new_n121_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n49_), .O(z12));
  nand2  g079(.a(x18), .b(x04), .O(new_n126_));
  oai21  g080(.a(new_n93_), .b(new_n72_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n91_), .O(new_n128_));
  nand4  g082(.a(new_n102_), .b(new_n69_), .c(new_n64_), .d(new_n59_), .O(new_n129_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n49_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n128_), .O(z13));
  nand2  g089(.a(x18), .b(x05), .O(new_n136_));
  oai21  g090(.a(x18), .b(new_n79_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n91_), .O(new_n138_));
  aoi21  g092(.a(new_n131_), .b(new_n111_), .c(new_n77_), .O(new_n139_));
  nand4  g093(.a(new_n77_), .b(new_n74_), .c(new_n69_), .d(new_n64_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n104_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n138_), .c(new_n49_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(new_n93_), .b(new_n84_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n91_), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n112_), .d(new_n102_), .O(new_n149_));
  oai21  g103(.a(new_n141_), .b(new_n82_), .c(new_n149_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n49_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z15));
  inv1   g106(.a(x15), .O(new_n153_));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai21  g108(.a(new_n93_), .b(new_n153_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n91_), .O(new_n156_));
  nand2  g110(.a(new_n149_), .b(x26), .O(new_n157_));
  nor2   g111(.a(new_n47_), .b(x17), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n112_), .c(new_n53_), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n147_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n159_), .c(new_n157_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n156_), .O(z16));
  nand2  g118(.a(z08), .b(x17), .O(new_n165_));
  nand2  g119(.a(new_n112_), .b(x19), .O(new_n166_));
  inv1   g120(.a(new_n166_), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n160_), .c(new_n158_), .d(new_n147_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n165_), .c(new_n91_), .O(z17));
endmodule
