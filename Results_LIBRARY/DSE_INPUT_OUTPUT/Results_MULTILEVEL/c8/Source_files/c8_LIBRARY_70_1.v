...
module FAU ( 
  ...
  inv1   g071(.a(new_n110_), .O(new_n118_));
  nor2   g072(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  nor3   g073(.a(x22), .b(x21), .c(x20), .O(new_n120_));
  and2   g074(.a(new_n120_), .b(new_n92_), .O(new_n121_));
  ...
  oai21  g080(.a(new_n69_), .b(new_n94_), .c(x18), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x22), .O(new_n128_));
  nor2   g082(.a(new_n118_), .b(new_n69_), .O(new_n129_));
  nand3  g083(.a(new_n56_), .b(new_n52_), .c(new_n90_), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n63_), .O(new_n132_));
  ...
  nand3  g090(.a(new_n66_), .b(new_n47_), .c(x13), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n94_), .O(new_n139_));
  nor2   g093(.a(x23), .b(x21), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n92_), .c(new_n56_), .O(new_n141_));
  ...
  aoi21  g098(.a(new_n144_), .b(new_n142_), .c(x22), .O(new_n145_));
  nand3  g099(.a(x24), .b(x22), .c(x18), .O(new_n146_));
  ...
  nand2  g107(.a(new_n153_), .b(x22), .O(new_n154_));
  aoi21  g108(.a(new_n143_), .b(new_n103_), .c(new_n79_), .O(new_n155_));
  ...
  oai21  g117(.a(new_n84_), .b(new_n94_), .c(x18), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x22), .O(new_n165_));
  nand2  g119(.a(new_n156_), .b(new_n140_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n130_), .c(x26), .O(new_n167_));
  nor3   g121(.a(x26), .b(x25), .c(x24), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n131_), .c(new_n118_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(x16), .O(new_n171_));
  nand3  g125(.a(new_n171_), .b(new_n165_), .c(new_n163_), .O(z16));
  nand2  g126(.a(z08), .b(x17), .O(new_n173_));
  nor2   g127(.a(new_n52_), .b(x17), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n168_), .c(new_n131_), .d(new_n109_), .O(new_n175_));
