...
module FAU ( 
  ...
  nand2  g032(.a(new_n55_), .b(new_n77_), .O(new_n79_));
  nand3  g033(.a(new_n79_), .b(new_n78_), .c(new_n48_), .O(z06));
  ...
  nand2  g040(.a(new_n77_), .b(x18), .O(new_n87_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n106_), .c(new_n60_), .O(new_n126_));
  ...
  oai22  g084(.a(new_n87_), .b(new_n130_), .c(x18), .d(new_n71_), .O(new_n131_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n116_), .c(new_n136_), .d(new_n97_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n107_), .d(new_n96_), .O(new_n147_));
  ...
  oai21  g108(.a(new_n154_), .b(x18), .c(x25), .O(new_n155_));
  nand2  g109(.a(new_n138_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n125_), .c(new_n107_), .d(new_n96_), .O(new_n158_));
  ...
  nand3  g115(.a(new_n48_), .b(x27), .c(x17), .O(new_n162_));
  nor2   g116(.a(new_n98_), .b(x17), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n157_), .c(new_n125_), .d(new_n107_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(new_n85_), .O(z17));
endmodule
