// Benchmark "FAU" written by ABC on Thu Aug 13 18:00:50 2020
...
module FAU ( 
  ...
  oai21  g059(.a(new_n97_), .b(new_n60_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n89_), .c(new_n95_), .O(new_n114_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n97_), .c(new_n60_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(new_n91_), .b(x04), .O(new_n124_));
  ...
  nand3  g082(.a(new_n95_), .b(new_n51_), .c(new_n87_), .O(new_n129_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n120_), .c(new_n104_), .d(new_n89_), .O(new_n152_));
  ...
  nand4  g110(.a(new_n120_), .b(new_n81_), .c(new_n76_), .d(new_n156_), .O(new_n157_));
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n87_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n87_), .O(new_n159_));
