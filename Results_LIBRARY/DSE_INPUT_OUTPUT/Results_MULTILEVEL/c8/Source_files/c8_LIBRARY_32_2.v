...
module FAU ( 
  ...
  oai21  g039(.a(new_n85_), .b(new_n84_), .c(x00), .O(new_n86_));
  ...
  nand3  g045(.a(new_n85_), .b(new_n84_), .c(x08), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n91_), .c(new_n86_), .O(z09));
  nand2  g047(.a(x18), .b(x01), .O(new_n94_));
  nand3  g048(.a(new_n85_), .b(x09), .c(new_n48_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n84_), .O(new_n97_));
  nand3  g051(.a(new_n54_), .b(new_n88_), .c(new_n87_), .O(new_n98_));
  oai21  g052(.a(new_n90_), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n82_), .c(x16), .O(new_n100_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n104_), .c(new_n82_), .O(z11));
  nand2  g065(.a(x18), .b(x03), .O(new_n112_));
  oai21  g066(.a(x18), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n84_), .O(new_n114_));
  aoi21  g068(.a(new_n107_), .b(new_n90_), .c(new_n63_), .O(new_n115_));
  ...
  nand3  g084(.a(new_n85_), .b(x13), .c(new_n48_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n84_), .O(new_n133_));
  nand3  g087(.a(new_n68_), .b(new_n63_), .c(new_n105_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n98_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n116_), .c(new_n136_), .d(new_n87_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n82_), .c(x16), .O(new_n140_));
  ...
  nand2  g097(.a(new_n143_), .b(new_n84_), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n107_), .d(new_n90_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n82_), .O(z15));
  ...
  nand4  g109(.a(new_n155_), .b(new_n125_), .c(new_n107_), .d(new_n90_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n82_), .O(z16));
  inv1   g113(.a(x24), .O(new_n160_));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n125_), .c(new_n160_), .O(new_n162_));
  nand3  g116(.a(new_n107_), .b(x19), .c(new_n87_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n55_), .d(new_n87_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n82_), .c(x16), .O(new_n165_));
