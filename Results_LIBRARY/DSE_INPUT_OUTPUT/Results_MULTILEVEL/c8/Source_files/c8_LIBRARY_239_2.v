...
module FAU ( 
  ...
  nor2   g002(.a(x21), .b(new_n48_), .O(new_n49_));
  ...
  oai21  g013(.a(new_n56_), .b(x10), .c(new_n59_), .O(z02));
  inv1   g014(.a(x22), .O(new_n61_));
  nand2  g015(.a(new_n57_), .b(x18), .O(new_n62_));
  nand3  g016(.a(new_n62_), .b(new_n58_), .c(new_n61_), .O(new_n63_));
  oai21  g017(.a(new_n56_), .b(x11), .c(new_n63_), .O(z03));
  inv1   g018(.a(x12), .O(new_n65_));
  nand2  g019(.a(x27), .b(new_n65_), .O(new_n66_));
  inv1   g020(.a(x23), .O(new_n67_));
  nand2  g021(.a(new_n58_), .b(new_n67_), .O(new_n68_));
  ...
  nand2  g036(.a(new_n55_), .b(new_n58_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n55_), .O(z09));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n55_), .O(z10));
  inv1   g055(.a(x02), .O(new_n102_));
  inv1   g056(.a(x10), .O(new_n103_));
  nand2  g057(.a(x21), .b(x18), .O(new_n104_));
  ...
  nor2   g061(.a(x18), .b(x17), .O(new_n108_));
  ...
  nand3  g070(.a(new_n61_), .b(new_n97_), .c(new_n85_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n116_), .c(new_n48_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n57_), .O(new_n119_));
  ...
  nand2  g081(.a(new_n127_), .b(x18), .O(new_n128_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n99_), .c(new_n57_), .O(new_n133_));
  ...
  oai22  g091(.a(new_n104_), .b(new_n137_), .c(x18), .d(new_n70_), .O(new_n138_));
  ...
  nand2  g116(.a(new_n162_), .b(x18), .O(new_n163_));
  ...
  nand3  g123(.a(new_n55_), .b(x27), .c(x17), .O(new_n170_));
