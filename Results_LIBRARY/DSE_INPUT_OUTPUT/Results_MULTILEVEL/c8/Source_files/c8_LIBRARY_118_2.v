...
module FAU ( 
  ...
  oai21  g046(.a(new_n92_), .b(x16), .c(x02), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(x00), .O(new_n94_));
  inv1   g048(.a(x17), .O(new_n95_));
  nor2   g049(.a(new_n49_), .b(new_n95_), .O(new_n96_));
  nor2   g050(.a(x19), .b(x17), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  inv1   g052(.a(x16), .O(new_n99_));
  nand3  g053(.a(new_n92_), .b(new_n99_), .c(x08), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(z09));
  ...
  nor2   g058(.a(new_n97_), .b(new_n56_), .O(new_n105_));
  ...
  oai21  g062(.a(x18), .b(x10), .c(x02), .O(new_n109_));
  nand2  g063(.a(new_n92_), .b(x10), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(x00), .c(new_n109_), .O(new_n111_));
  ...
  nand2  g073(.a(new_n119_), .b(new_n99_), .O(new_n120_));
  aoi21  g074(.a(new_n113_), .b(new_n97_), .c(new_n68_), .O(new_n121_));
  nand2  g075(.a(new_n49_), .b(new_n95_), .O(new_n122_));
  nand3  g076(.a(new_n68_), .b(new_n61_), .c(new_n56_), .O(new_n123_));
  nor2   g077(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  aoi21  g079(.a(new_n125_), .b(new_n120_), .c(new_n54_), .O(z12));
  ...
  oai21  g085(.a(new_n124_), .b(new_n71_), .c(new_n131_), .O(new_n132_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n113_), .d(new_n97_), .O(new_n161_));
  ...
  nand3  g119(.a(new_n113_), .b(x19), .c(new_n95_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n50_), .d(new_n95_), .O(new_n167_));
