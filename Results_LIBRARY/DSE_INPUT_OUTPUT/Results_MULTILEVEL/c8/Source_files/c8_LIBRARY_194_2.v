...
module FAU ( 
  ...
  oai21  g033(.a(x18), .b(new_n47_), .c(new_n52_), .O(z08));
  ...
  nand2  g048(.a(new_n87_), .b(x01), .O(new_n95_));
  ...
  aoi21  g060(.a(new_n100_), .b(new_n85_), .c(new_n106_), .O(new_n107_));
  nor2   g061(.a(x22), .b(x21), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n85_), .c(new_n91_), .O(new_n109_));
  inv1   g063(.a(new_n109_), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n107_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n87_), .b(x03), .O(new_n112_));
  ...
  nand2  g069(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  ...
  nand3  g079(.a(new_n91_), .b(new_n51_), .c(new_n83_), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n106_), .c(new_n60_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n126_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n108_), .c(new_n130_), .d(new_n83_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n100_), .d(new_n85_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n118_), .c(new_n100_), .d(new_n85_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n87_), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n118_), .c(new_n71_), .O(new_n154_));
  nand3  g108(.a(new_n100_), .b(x19), .c(new_n83_), .O(new_n155_));
