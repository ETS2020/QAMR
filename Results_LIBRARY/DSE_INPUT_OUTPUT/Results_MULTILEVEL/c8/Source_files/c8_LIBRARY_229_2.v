...
module FAU ( 
  ...
  nand2  g044(.a(x22), .b(x18), .O(new_n91_));
  ...
  oai21  g064(.a(new_n104_), .b(new_n63_), .c(new_n110_), .O(new_n111_));
  ...
  oai21  g071(.a(new_n63_), .b(new_n89_), .c(x22), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x18), .O(new_n119_));
  aoi21  g073(.a(new_n109_), .b(new_n95_), .c(new_n52_), .O(new_n120_));
  nand2  g074(.a(new_n52_), .b(new_n63_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n91_), .b(new_n125_), .c(x18), .d(new_n68_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n89_), .O(new_n127_));
  nand2  g081(.a(new_n110_), .b(x23), .O(new_n128_));
  nor3   g082(.a(x23), .b(x22), .c(x21), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n104_), .O(new_n130_));
  aoi21  g084(.a(new_n130_), .b(new_n128_), .c(x18), .O(new_n131_));
  ...
  oai21  g091(.a(new_n75_), .b(new_n89_), .c(x22), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x18), .O(new_n139_));
  aoi21  g093(.a(new_n129_), .b(new_n104_), .c(new_n75_), .O(new_n140_));
  inv1   g094(.a(x17), .O(new_n141_));
  nand3  g095(.a(new_n58_), .b(new_n47_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n75_), .b(new_n70_), .O(new_n143_));
  nor3   g097(.a(new_n143_), .b(new_n121_), .c(new_n142_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n140_), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n139_), .c(new_n137_), .O(z14));
  inv1   g100(.a(x06), .O(new_n147_));
  oai22  g101(.a(new_n91_), .b(new_n147_), .c(x18), .d(new_n78_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n89_), .O(new_n149_));
  nand3  g103(.a(new_n75_), .b(new_n70_), .c(new_n63_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n142_), .c(x25), .O(new_n151_));
  nor2   g105(.a(x23), .b(x22), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n152_), .c(new_n109_), .d(new_n95_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n151_), .c(x18), .O(new_n155_));
  nor2   g109(.a(new_n80_), .b(new_n52_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n155_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n149_), .O(z15));
  inv1   g112(.a(x07), .O(new_n159_));
  oai22  g113(.a(new_n91_), .b(new_n159_), .c(x18), .d(new_n85_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n89_), .O(new_n161_));
  nor2   g115(.a(x20), .b(x19), .O(new_n162_));
  nor2   g116(.a(x23), .b(x21), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n153_), .c(new_n162_), .d(new_n141_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor3   g119(.a(x26), .b(x25), .c(x24), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n152_), .c(new_n109_), .d(new_n95_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(x18), .O(new_n168_));
  nor2   g122(.a(new_n83_), .b(new_n52_), .O(new_n169_));
  ...
  nand3  g128(.a(new_n174_), .b(new_n166_), .c(new_n152_), .O(new_n175_));
