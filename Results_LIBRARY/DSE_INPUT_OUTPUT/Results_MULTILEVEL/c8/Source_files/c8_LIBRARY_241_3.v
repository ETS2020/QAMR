...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x05), .O(new_n48_));
  ...
  nand2  g031(.a(new_n48_), .b(new_n67_), .O(z08));
  inv1   g032(.a(x16), .O(new_n79_));
  inv1   g033(.a(x00), .O(new_n80_));
  inv1   g034(.a(x05), .O(new_n81_));
  nand2  g035(.a(x18), .b(new_n81_), .O(new_n82_));
  oai22  g036(.a(new_n82_), .b(new_n80_), .c(x18), .d(new_n47_), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n79_), .O(new_n84_));
  ...
  nand2  g043(.a(new_n89_), .b(new_n79_), .O(new_n90_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n90_), .c(new_n48_), .O(z10));
  nand2  g050(.a(x18), .b(x02), .O(new_n97_));
  oai21  g051(.a(x18), .b(new_n55_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n79_), .O(new_n99_));
  ...
  nand2  g061(.a(new_n107_), .b(new_n79_), .O(new_n108_));
  ...
  nand2  g070(.a(new_n116_), .b(new_n79_), .O(new_n117_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n48_), .O(z13));
  aoi21  g077(.a(new_n119_), .b(new_n94_), .c(new_n66_), .O(new_n124_));
  inv1   g078(.a(x17), .O(new_n125_));
  nor2   g079(.a(x20), .b(x19), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n110_), .c(new_n126_), .d(new_n125_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n124_), .c(x16), .O(new_n130_));
  inv1   g084(.a(x18), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n79_), .c(x13), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n130_), .c(new_n48_), .O(z14));
  nand2  g087(.a(x18), .b(x06), .O(new_n134_));
  oai22  g088(.a(new_n134_), .b(x05), .c(x18), .d(new_n70_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n79_), .O(new_n136_));
  nand2  g090(.a(new_n128_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n101_), .d(new_n92_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n48_), .c(x16), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n101_), .d(new_n92_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n48_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n138_), .c(new_n66_), .O(new_n154_));
  nand3  g108(.a(new_n101_), .b(x19), .c(new_n125_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n67_), .d(new_n125_), .O(new_n156_));
