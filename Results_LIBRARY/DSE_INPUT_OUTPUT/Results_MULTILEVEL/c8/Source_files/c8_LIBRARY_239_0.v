...
module FAU ( 
  ...
  nor2   g001(.a(x21), .b(x18), .O(new_n48_));
  ...
  inv1   g007(.a(new_n48_), .O(new_n54_));
  nand2  g008(.a(new_n54_), .b(x27), .O(new_n55_));
  inv1   g009(.a(x21), .O(new_n56_));
  inv1   g010(.a(x27), .O(new_n57_));
  nand3  g011(.a(new_n57_), .b(new_n56_), .c(x18), .O(new_n58_));
  oai21  g012(.a(new_n55_), .b(x10), .c(new_n58_), .O(z02));
  inv1   g013(.a(x22), .O(new_n60_));
  inv1   g014(.a(x18), .O(new_n61_));
  nand2  g015(.a(new_n56_), .b(new_n61_), .O(new_n62_));
  nand3  g016(.a(new_n62_), .b(new_n57_), .c(new_n60_), .O(new_n63_));
  oai21  g017(.a(new_n55_), .b(x11), .c(new_n63_), .O(z03));
  ...
  nand2  g034(.a(new_n57_), .b(new_n80_), .O(new_n81_));
  aoi21  g035(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(z07));
  nand2  g036(.a(new_n54_), .b(new_n57_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n54_), .O(z09));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n54_), .O(z10));
  inv1   g055(.a(x10), .O(new_n102_));
  nand2  g056(.a(x18), .b(x02), .O(new_n103_));
  nand2  g057(.a(x21), .b(new_n61_), .O(new_n104_));
  ...
  nor2   g061(.a(new_n61_), .b(x17), .O(new_n108_));
  nor3   g062(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  aoi22  g063(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(x21), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n89_), .c(new_n106_), .O(z11));
  ...
  nand2  g069(.a(new_n84_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n60_), .b(new_n97_), .c(new_n85_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n116_), .c(x18), .O(new_n118_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n119_), .c(new_n115_), .O(z12));
  ...
  oai21  g080(.a(new_n67_), .b(new_n89_), .c(x21), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n61_), .O(new_n128_));
  nor2   g082(.a(x22), .b(x21), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n87_), .c(new_n97_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x23), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n99_), .c(new_n56_), .O(new_n133_));
  ...
  oai21  g091(.a(new_n104_), .b(new_n70_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n89_), .O(new_n139_));
  nand3  g093(.a(new_n132_), .b(new_n87_), .c(new_n97_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x24), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n129_), .c(new_n99_), .O(new_n143_));
  aoi21  g097(.a(new_n143_), .b(new_n141_), .c(new_n61_), .O(new_n144_));
  nor2   g098(.a(new_n72_), .b(new_n56_), .O(new_n145_));
  ...
  oai21  g102(.a(new_n104_), .b(new_n75_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n89_), .O(new_n150_));
  nand3  g104(.a(new_n72_), .b(new_n67_), .c(new_n60_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n107_), .c(x25), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n132_), .c(new_n120_), .d(new_n87_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n152_), .c(new_n61_), .O(new_n155_));
  and2   g109(.a(x25), .b(x21), .O(new_n156_));
  ...
  oai21  g113(.a(x18), .b(new_n78_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n89_), .O(new_n161_));
  oai21  g115(.a(new_n80_), .b(new_n89_), .c(x21), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n61_), .O(new_n163_));
  nand2  g117(.a(new_n154_), .b(x26), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n132_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n121_), .c(new_n164_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x16), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n163_), .c(new_n161_), .O(z16));
  nand3  g123(.a(new_n54_), .b(x27), .c(x17), .O(new_n170_));
  nand2  g124(.a(new_n120_), .b(x19), .O(new_n171_));
  inv1   g125(.a(new_n171_), .O(new_n172_));
  nand4  g126(.a(new_n172_), .b(new_n165_), .c(new_n132_), .d(new_n108_), .O(new_n173_));
  aoi21  g127(.a(new_n173_), .b(new_n170_), .c(new_n89_), .O(z17));
endmodule
