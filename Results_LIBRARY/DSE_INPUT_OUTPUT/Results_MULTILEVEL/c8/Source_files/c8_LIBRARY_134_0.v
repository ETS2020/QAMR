...
module FAU ( 
  ...
  nand2  g31(.a(new_n57_), .b(new_n77_), .O(new_n78_));
  ...
  nor2   g49(.a(new_n87_), .b(new_n95_), .O(new_n96_));
  ...
  aoi22  g68(.a(new_n114_), .b(new_n97_), .c(new_n110_), .d(x23), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n93_), .c(new_n113_), .O(z13));
  aoi21  g70(.a(new_n114_), .b(new_n97_), .c(new_n72_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n109_), .c(new_n101_), .d(new_n84_), .O(new_n119_));
  ...
  nand4  g77(.a(new_n77_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n104_), .c(new_n119_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n90_), .b(x06), .O(new_n127_));
  ...
  nand2  g91(.a(new_n90_), .b(x07), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  inv1   g93(.a(new_n48_), .O(new_n140_));
  nor2   g94(.a(x26), .b(x25), .O(new_n141_));
  nand3  g95(.a(new_n141_), .b(new_n130_), .c(new_n72_), .O(new_n142_));
  nand3  g96(.a(new_n129_), .b(x19), .c(new_n84_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n57_), .d(new_n84_), .O(new_n144_));
