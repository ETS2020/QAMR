...
module FAU ( 
  ...
  nand3  g079(.a(new_n58_), .b(new_n52_), .c(new_n125_), .O(new_n126_));
  nor2   g080(.a(x22), .b(x21), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n100_), .c(new_n58_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x23), .O(new_n129_));
  nand3  g083(.a(new_n71_), .b(new_n68_), .c(new_n63_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n126_), .c(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n124_), .c(new_n48_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  aoi21  g088(.a(x18), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g089(.a(new_n130_), .b(new_n126_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n127_), .c(new_n102_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(x16), .c(new_n135_), .O(new_n140_));
  inv1   g094(.a(x18), .O(new_n141_));
  nand3  g095(.a(new_n139_), .b(new_n141_), .c(x16), .O(new_n142_));
  oai21  g096(.a(new_n140_), .b(new_n47_), .c(new_n142_), .O(z14));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n108_), .d(new_n100_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n48_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n146_), .O(z15));
  inv1   g107(.a(x07), .O(new_n154_));
  oai22  g108(.a(new_n91_), .b(new_n154_), .c(x18), .d(new_n85_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n89_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  inv1   g111(.a(x24), .O(new_n158_));
  nand4  g112(.a(new_n148_), .b(new_n83_), .c(new_n78_), .d(new_n158_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n109_), .c(new_n157_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n48_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n156_), .O(z16));
  nand3  g116(.a(new_n108_), .b(x19), .c(new_n125_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n53_), .d(new_n125_), .O(new_n164_));
