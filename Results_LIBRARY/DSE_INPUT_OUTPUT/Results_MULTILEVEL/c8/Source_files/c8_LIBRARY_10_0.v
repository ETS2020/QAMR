...
module FAU ( 
  ...
  nor2   g016(.a(x27), .b(new_n62_), .O(new_n63_));
  ...
  nand2  g038(.a(new_n62_), .b(x11), .O(new_n85_));
  ...
  nand3  g042(.a(new_n88_), .b(new_n81_), .c(x16), .O(new_n89_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n81_), .O(z10));
  nand2  g052(.a(x18), .b(x02), .O(new_n99_));
  oai21  g053(.a(new_n85_), .b(new_n57_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n96_), .c(new_n59_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n81_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  nand3  g080(.a(new_n62_), .b(x13), .c(x11), .O(new_n127_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n121_), .c(new_n102_), .d(new_n94_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n121_), .b(new_n78_), .c(new_n73_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n102_), .b(x19), .c(new_n130_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n54_), .d(new_n130_), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n81_), .c(x16), .O(new_n166_));
