...
module FAU ( 
  ...
  oai21  g044(.a(x16), .b(x09), .c(new_n83_), .O(new_n91_));
  ...
  nor2   g050(.a(new_n83_), .b(x16), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(x01), .O(new_n98_));
  ...
  aoi21  g063(.a(new_n104_), .b(new_n93_), .c(new_n63_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n93_), .c(new_n92_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n97_), .b(x03), .O(new_n115_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n95_), .c(new_n103_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n92_), .b(new_n51_), .c(new_n85_), .O(new_n129_));
  nand3  g083(.a(new_n68_), .b(new_n63_), .c(new_n103_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n129_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n111_), .c(new_n132_), .d(new_n85_), .O(new_n134_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n104_), .d(new_n93_), .O(new_n143_));
