// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:45 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x22), .b(x18), .O(new_n48_));
  ...
  oai21  g017(.a(new_n54_), .b(new_n62_), .c(new_n63_), .O(new_n64_));
  oai21  g018(.a(new_n54_), .b(x11), .c(new_n64_), .O(z03));
  ...
  nand2  g027(.a(new_n54_), .b(new_n73_), .O(new_n74_));
  ...
  nand2  g038(.a(new_n84_), .b(new_n54_), .O(z08));
  inv1   g039(.a(x16), .O(new_n86_));
  nand2  g040(.a(x18), .b(x00), .O(new_n87_));
  nand2  g041(.a(x22), .b(new_n62_), .O(new_n88_));
  oai21  g042(.a(new_n88_), .b(new_n47_), .c(new_n87_), .O(new_n89_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n84_), .c(x16), .O(new_n95_));
  ...
  nand3  g056(.a(new_n102_), .b(new_n99_), .c(new_n84_), .O(z10));
  nand2  g057(.a(x18), .b(x02), .O(new_n104_));
  oai21  g058(.a(x18), .b(new_n57_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g062(.a(new_n101_), .b(new_n59_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x16), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n106_), .c(new_n84_), .O(z11));
  ...
  oai21  g069(.a(new_n59_), .b(new_n86_), .c(x22), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n62_), .O(new_n117_));
  aoi21  g071(.a(new_n107_), .b(new_n92_), .c(new_n63_), .O(new_n118_));
  nand2  g072(.a(new_n63_), .b(new_n59_), .O(new_n119_));
  nor3   g073(.a(new_n119_), .b(new_n93_), .c(x20), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n118_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n117_), .c(new_n115_), .O(z12));
  nand2  g076(.a(x18), .b(x04), .O(new_n123_));
  oai21  g077(.a(new_n88_), .b(new_n66_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n86_), .O(new_n125_));
  nand2  g079(.a(new_n108_), .b(x23), .O(new_n126_));
  nor3   g080(.a(x23), .b(x22), .c(x21), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n101_), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(new_n126_), .c(new_n62_), .O(new_n129_));
  nor2   g083(.a(new_n68_), .b(new_n63_), .O(new_n130_));
  ...
  oai21  g087(.a(x18), .b(new_n71_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n86_), .O(new_n135_));
  oai21  g089(.a(new_n73_), .b(new_n86_), .c(x22), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n62_), .O(new_n137_));
  aoi21  g091(.a(new_n127_), .b(new_n101_), .c(new_n73_), .O(new_n138_));
  inv1   g092(.a(x17), .O(new_n139_));
  inv1   g093(.a(x19), .O(new_n140_));
  nand3  g094(.a(new_n53_), .b(new_n140_), .c(new_n139_), .O(new_n141_));
  nand2  g095(.a(new_n73_), .b(new_n68_), .O(new_n142_));
  nor3   g096(.a(new_n142_), .b(new_n119_), .c(new_n141_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n138_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n137_), .c(new_n135_), .O(z14));
  nand2  g099(.a(x18), .b(x06), .O(new_n146_));
  oai21  g100(.a(new_n88_), .b(new_n76_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n86_), .O(new_n148_));
  nand3  g102(.a(new_n73_), .b(new_n68_), .c(new_n59_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n141_), .c(x25), .O(new_n150_));
  nor2   g104(.a(x23), .b(x22), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n151_), .c(new_n107_), .d(new_n92_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n150_), .c(new_n62_), .O(new_n154_));
  nor2   g108(.a(new_n78_), .b(new_n63_), .O(new_n155_));
  ...
  oai21  g112(.a(new_n88_), .b(new_n81_), .c(new_n158_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n86_), .O(new_n160_));
  nor2   g114(.a(x20), .b(x19), .O(new_n161_));
  nor2   g115(.a(x23), .b(x21), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n152_), .c(new_n161_), .d(new_n139_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x26), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n151_), .c(new_n107_), .d(new_n92_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n164_), .c(new_n62_), .O(new_n167_));
  and2   g121(.a(x26), .b(x22), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n167_), .c(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n160_), .O(z16));
  nand3  g124(.a(new_n84_), .b(x27), .c(x17), .O(new_n171_));
  nand2  g125(.a(new_n107_), .b(x19), .O(new_n172_));
  nor3   g126(.a(new_n172_), .b(new_n62_), .c(x17), .O(new_n173_));
  nand3  g127(.a(new_n173_), .b(new_n165_), .c(new_n151_), .O(new_n174_));
  aoi21  g128(.a(new_n174_), .b(new_n171_), .c(new_n86_), .O(z17));
endmodule
