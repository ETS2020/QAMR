...
module FAU ( 
  ...
  oai21  g33(.a(x27), .b(x25), .c(new_n79_), .O(z06));
  ...
  oai21  g52(.a(x18), .b(x10), .c(new_n91_), .O(new_n99_));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  nand4  g55(.a(new_n60_), .b(new_n94_), .c(new_n51_), .d(new_n87_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n91_), .c(new_n99_), .O(z11));
  oai21  g59(.a(x18), .b(x11), .c(new_n91_), .O(new_n106_));
  ...
  oai21  g64(.a(new_n110_), .b(new_n91_), .c(new_n106_), .O(z12));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n96_), .c(new_n109_), .d(x23), .O(new_n113_));
  oai22  g67(.a(new_n113_), .b(new_n91_), .c(new_n92_), .d(new_n68_), .O(z13));
  oai21  g68(.a(x18), .b(x13), .c(new_n91_), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n96_), .c(new_n75_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n100_), .d(new_n87_), .O(new_n118_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n103_), .c(new_n118_), .d(x25), .O(new_n125_));
  nand3  g79(.a(new_n47_), .b(new_n91_), .c(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n91_), .c(new_n126_), .O(z15));
  oai21  g81(.a(x18), .b(x15), .c(new_n91_), .O(new_n128_));
