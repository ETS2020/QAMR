...
module FAU ( 
  ...
  nand4  g49(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n83_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n95_), .b(x21), .c(new_n97_), .O(new_n98_));
  oai22  g52(.a(new_n98_), .b(new_n87_), .c(new_n88_), .d(new_n60_), .O(z11));
  oai21  g53(.a(x18), .b(x11), .c(new_n87_), .O(new_n100_));
  nand2  g54(.a(new_n96_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n85_), .c(new_n57_), .O(new_n103_));
  ...
  aoi22  g61(.a(new_n107_), .b(new_n91_), .c(new_n103_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n87_), .c(new_n106_), .O(z13));
  ...
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n94_), .d(new_n83_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n111_), .c(new_n119_), .d(new_n67_), .O(new_n121_));
