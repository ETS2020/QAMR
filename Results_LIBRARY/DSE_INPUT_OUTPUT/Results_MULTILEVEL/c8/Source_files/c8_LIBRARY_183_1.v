...
module FAU ( 
  ...
  nand4  g52(.a(new_n60_), .b(new_n92_), .c(new_n51_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n90_), .c(new_n88_), .d(new_n58_), .O(z11));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n94_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n90_), .c(new_n88_), .d(new_n66_), .O(z13));
  aoi21  g64(.a(new_n108_), .b(new_n94_), .c(new_n71_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n106_), .c(new_n97_), .d(new_n83_), .O(new_n113_));
  ...
  aoi22  g76(.a(new_n122_), .b(new_n100_), .c(new_n113_), .d(x25), .O(new_n123_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n90_), .O(z17));
endmodule
