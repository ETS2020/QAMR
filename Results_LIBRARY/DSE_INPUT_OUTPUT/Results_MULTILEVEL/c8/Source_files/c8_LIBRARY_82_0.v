...
module FAU ( 
  ...
  oai21  g030(.a(new_n54_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  oai21  g031(.a(new_n54_), .b(x14), .c(new_n77_), .O(z06));
  ...
  nand2  g036(.a(new_n82_), .b(new_n54_), .O(z08));
  inv1   g037(.a(x16), .O(new_n84_));
  nand2  g038(.a(x18), .b(x00), .O(new_n85_));
  nand2  g039(.a(x25), .b(new_n75_), .O(new_n86_));
  oai21  g040(.a(new_n86_), .b(new_n47_), .c(new_n85_), .O(new_n87_));
  ...
  oai21  g046(.a(new_n86_), .b(new_n51_), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g056(.a(new_n86_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n82_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  oai21  g083(.a(new_n86_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n84_), .O(new_n131_));
  inv1   g085(.a(x22), .O(new_n132_));
  nand3  g086(.a(new_n67_), .b(new_n132_), .c(new_n59_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n98_), .c(x24), .O(new_n134_));
  nand4  g088(.a(new_n115_), .b(new_n105_), .c(new_n72_), .d(new_n67_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n82_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n131_), .O(z14));
  ...
  nand3  g096(.a(new_n115_), .b(new_n72_), .c(new_n67_), .O(new_n143_));
  nand4  g097(.a(new_n53_), .b(new_n97_), .c(new_n96_), .d(x16), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n143_), .c(x18), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n76_), .O(new_n146_));
  nand3  g100(.a(new_n135_), .b(x25), .c(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n146_), .c(new_n142_), .O(z15));
  ...
  nand2  g107(.a(new_n153_), .b(new_n75_), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n124_), .c(new_n106_), .d(new_n95_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n124_), .c(new_n106_), .d(new_n95_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n154_), .c(new_n151_), .O(z16));
  nand3  g116(.a(new_n82_), .b(x27), .c(x17), .O(new_n163_));
  nor2   g117(.a(new_n75_), .b(x17), .O(new_n164_));
  nand2  g118(.a(new_n106_), .b(x19), .O(new_n165_));
  inv1   g119(.a(new_n165_), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n164_), .c(new_n158_), .d(new_n124_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n163_), .c(new_n84_), .O(z17));
endmodule
