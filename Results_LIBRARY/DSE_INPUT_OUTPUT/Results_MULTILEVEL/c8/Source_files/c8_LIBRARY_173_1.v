...
module FAU ( 
  ...
  aoi21  g061(.a(new_n100_), .b(new_n81_), .c(new_n63_), .O(new_n108_));
  ...
  oai22  g078(.a(new_n115_), .b(new_n124_), .c(x18), .d(new_n69_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n83_), .O(new_n126_));
  nand3  g080(.a(new_n91_), .b(new_n51_), .c(new_n79_), .O(new_n127_));
  inv1   g081(.a(x23), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n63_), .c(new_n99_), .O(new_n129_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n83_), .c(x15), .O(new_n148_));
  nand2  g102(.a(new_n142_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n100_), .d(new_n81_), .O(new_n151_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n119_), .c(new_n155_), .O(new_n157_));
  nand3  g111(.a(new_n100_), .b(x19), .c(new_n79_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n79_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n77_), .O(z17));
endmodule
