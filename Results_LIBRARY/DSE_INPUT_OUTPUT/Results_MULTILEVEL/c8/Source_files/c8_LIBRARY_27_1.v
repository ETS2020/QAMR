...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(x06), .O(new_n93_));
  oai22  g047(.a(new_n93_), .b(new_n92_), .c(x18), .d(new_n52_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n87_), .O(new_n95_));
  nand3  g049(.a(new_n54_), .b(new_n83_), .c(new_n82_), .O(new_n96_));
  oai21  g050(.a(new_n85_), .b(new_n54_), .c(new_n96_), .O(new_n97_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n82_), .O(new_n137_));
  ...
  oai21  g094(.a(x18), .b(x14), .c(new_n87_), .O(new_n141_));
  nand2  g095(.a(new_n137_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n124_), .c(new_n105_), .d(new_n85_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n141_), .c(new_n81_), .O(z15));
  nand3  g101(.a(x18), .b(x07), .c(x06), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n124_), .c(new_n105_), .d(new_n85_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n124_), .c(new_n69_), .O(new_n158_));
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n82_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n82_), .O(new_n160_));
