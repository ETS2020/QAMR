...
module FAU ( 
  ...
  nand2  g049(.a(x18), .b(x06), .O(new_n96_));
  ...
  nand3  g053(.a(new_n99_), .b(new_n49_), .c(new_n86_), .O(new_n100_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n84_), .O(z11));
  ...
  nand3  g071(.a(new_n117_), .b(new_n88_), .c(new_n99_), .O(new_n118_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n117_), .c(new_n137_), .d(new_n86_), .O(new_n139_));
  ...
  oai21  g096(.a(x18), .b(x14), .c(new_n90_), .O(new_n143_));
  nand2  g097(.a(new_n139_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n126_), .c(new_n108_), .d(new_n88_), .O(new_n146_));
  ...
  nand3  g103(.a(x18), .b(x07), .c(x06), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n126_), .c(new_n108_), .d(new_n88_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n86_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n50_), .d(new_n86_), .O(new_n162_));
