...
module FAU ( 
  ...
  nand3  g050(.a(new_n54_), .b(new_n83_), .c(new_n82_), .O(new_n97_));
  oai21  g051(.a(new_n85_), .b(new_n54_), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g068(.a(new_n106_), .b(new_n85_), .c(new_n114_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n85_), .c(new_n54_), .O(new_n117_));
  ...
  nand3  g075(.a(new_n93_), .b(x12), .c(new_n48_), .O(new_n122_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n106_), .d(new_n85_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n126_), .c(new_n69_), .O(new_n163_));
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n82_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n82_), .O(new_n165_));
