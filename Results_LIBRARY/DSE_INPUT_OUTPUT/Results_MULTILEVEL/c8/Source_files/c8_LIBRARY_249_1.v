...
module FAU ( 
  ...
  nor2   g055(.a(new_n101_), .b(new_n54_), .O(new_n102_));
  nor3   g056(.a(x20), .b(x19), .c(x17), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n102_), .c(x16), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n100_), .c(new_n94_), .O(z10));
  inv1   g059(.a(x02), .O(new_n106_));
  oai22  g060(.a(new_n91_), .b(new_n106_), .c(x18), .d(new_n58_), .O(new_n107_));
  ...
  nand2  g081(.a(new_n127_), .b(new_n103_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n94_), .c(x16), .O(new_n130_));
  ...
  aoi21  g088(.a(new_n127_), .b(new_n103_), .c(new_n75_), .O(new_n135_));
  inv1   g089(.a(x17), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n137_), .d(new_n136_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n135_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n134_), .c(new_n94_), .O(z14));
  oai21  g096(.a(x18), .b(new_n78_), .c(new_n91_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n109_), .d(new_n101_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n94_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n144_), .O(z15));
  nand3  g105(.a(x18), .b(x07), .c(x06), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n109_), .d(new_n101_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n146_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n136_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n136_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n94_), .c(x16), .O(new_n164_));
