...
module FAU ( 
  ...
  nand2  g005(.a(new_n47_), .b(x25), .O(new_n52_));
  ...
  oai21  g010(.a(new_n49_), .b(new_n56_), .c(new_n47_), .O(new_n57_));
  oai21  g011(.a(new_n47_), .b(x12), .c(new_n57_), .O(z04));
  inv1   g012(.a(x24), .O(new_n59_));
  oai21  g013(.a(new_n49_), .b(new_n59_), .c(new_n47_), .O(new_n60_));
  oai21  g014(.a(new_n47_), .b(x13), .c(new_n60_), .O(z05));
  nor2   g015(.a(new_n47_), .b(x14), .O(z06));
  inv1   g016(.a(x26), .O(new_n63_));
  oai21  g017(.a(new_n63_), .b(new_n49_), .c(new_n47_), .O(new_n64_));
  ...
  nand2  g028(.a(new_n47_), .b(new_n49_), .O(new_n75_));
  ...
  nand2  g076(.a(new_n122_), .b(new_n66_), .O(new_n123_));
  nor2   g077(.a(x24), .b(x23), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n102_), .O(new_n125_));
  nor2   g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n121_), .c(x16), .O(new_n127_));
  aoi21  g081(.a(new_n127_), .b(new_n120_), .c(new_n77_), .O(z14));
  inv1   g082(.a(x14), .O(new_n129_));
  nand2  g083(.a(x18), .b(x06), .O(new_n130_));
  oai21  g084(.a(x18), .b(new_n129_), .c(new_n130_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n75_), .c(new_n70_), .O(new_n132_));
  inv1   g086(.a(new_n92_), .O(new_n133_));
  nand3  g087(.a(new_n124_), .b(new_n102_), .c(new_n84_), .O(new_n134_));
  nand2  g088(.a(new_n56_), .b(new_n100_), .O(new_n135_));
  nand3  g089(.a(x27), .b(new_n49_), .c(new_n59_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  aoi22  g091(.a(new_n137_), .b(new_n133_), .c(new_n134_), .d(x25), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n70_), .c(new_n132_), .O(z15));
  inv1   g093(.a(x15), .O(new_n140_));
  nand2  g094(.a(x18), .b(x07), .O(new_n141_));
  oai21  g095(.a(x18), .b(new_n140_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n70_), .O(new_n143_));
  nand3  g097(.a(new_n122_), .b(new_n66_), .c(x16), .O(new_n144_));
  nand4  g098(.a(new_n102_), .b(new_n63_), .c(new_n59_), .d(new_n56_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n144_), .c(x27), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n49_), .O(new_n147_));
  nand2  g101(.a(new_n137_), .b(new_n133_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(x26), .c(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n147_), .c(new_n143_), .O(z16));
  nand3  g104(.a(new_n102_), .b(new_n82_), .c(x19), .O(new_n151_));
  nand3  g105(.a(new_n124_), .b(new_n63_), .c(new_n49_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n151_), .c(new_n66_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(x27), .c(x16), .O(new_n154_));
