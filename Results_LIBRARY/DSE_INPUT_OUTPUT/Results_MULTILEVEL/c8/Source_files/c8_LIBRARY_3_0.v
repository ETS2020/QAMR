...
module FAU ( 
  ...
  nand2  g014(.a(new_n60_), .b(x23), .O(new_n61_));
  nand2  g015(.a(new_n61_), .b(x18), .O(new_n62_));
  inv1   g016(.a(x23), .O(new_n63_));
  nand3  g017(.a(new_n60_), .b(new_n63_), .c(x12), .O(new_n64_));
  oai21  g018(.a(new_n62_), .b(x12), .c(new_n64_), .O(z04));
  ...
  nand3  g036(.a(new_n82_), .b(x12), .c(x08), .O(new_n83_));
  ...
  oai21  g073(.a(new_n82_), .b(x04), .c(new_n80_), .O(new_n120_));
  nand2  g074(.a(new_n116_), .b(x23), .O(new_n121_));
  nor2   g075(.a(x23), .b(x22), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n98_), .c(new_n104_), .O(new_n123_));
  ...
  nand3  g081(.a(new_n82_), .b(x13), .c(x12), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  inv1   g084(.a(x17), .O(new_n131_));
  inv1   g085(.a(x19), .O(new_n132_));
  nand3  g086(.a(new_n96_), .b(new_n132_), .c(new_n131_), .O(new_n133_));
  nand3  g087(.a(new_n63_), .b(new_n113_), .c(new_n104_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n133_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n115_), .c(new_n136_), .d(new_n131_), .O(new_n138_));
  ...
  nand3  g096(.a(new_n82_), .b(x14), .c(x12), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n122_), .c(new_n105_), .d(new_n88_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n82_), .b(x15), .c(x12), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n80_), .O(new_n155_));
  nand2  g109(.a(new_n148_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n122_), .c(new_n105_), .d(new_n88_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n86_), .c(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n155_), .O(z16));
  inv1   g115(.a(x24), .O(new_n162_));
  nand4  g116(.a(new_n122_), .b(new_n76_), .c(new_n71_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n105_), .b(x19), .c(new_n131_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n60_), .d(new_n131_), .O(new_n165_));
