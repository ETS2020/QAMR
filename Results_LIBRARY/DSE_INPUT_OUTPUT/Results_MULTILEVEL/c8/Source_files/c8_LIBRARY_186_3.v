...
module FAU ( 
  ...
  nand2  g022(.a(new_n52_), .b(new_n67_), .O(new_n69_));
  ...
  nand2  g042(.a(x18), .b(new_n66_), .O(new_n89_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n47_), .O(z11));
  ...
  aoi21  g086(.a(new_n124_), .b(new_n101_), .c(new_n73_), .O(new_n133_));
  inv1   g087(.a(x17), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n117_), .c(new_n135_), .d(new_n134_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n133_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n132_), .c(new_n47_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n89_), .b(new_n141_), .c(x18), .d(new_n76_), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n108_), .d(new_n99_), .O(new_n147_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n108_), .d(new_n99_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n145_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n160_));
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n134_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n134_), .O(new_n162_));
