...
module FAU ( 
  ...
  nand2  g057(.a(x20), .b(x18), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n52_), .c(new_n92_), .O(new_n105_));
  ...
  oai21  g065(.a(new_n61_), .b(new_n96_), .c(x18), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x20), .O(new_n113_));
  nor2   g067(.a(new_n94_), .b(new_n61_), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n111_), .O(z11));
  ...
  oai21  g087(.a(new_n71_), .b(new_n96_), .c(x18), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x20), .O(new_n135_));
  aoi21  g089(.a(new_n126_), .b(new_n94_), .c(new_n71_), .O(new_n136_));
  nand3  g090(.a(new_n57_), .b(new_n52_), .c(new_n92_), .O(new_n137_));
  ...
  oai21  g099(.a(new_n78_), .b(new_n96_), .c(x18), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x20), .O(new_n147_));
  nand3  g101(.a(new_n138_), .b(new_n94_), .c(new_n61_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x24), .O(new_n149_));
  nand3  g103(.a(new_n126_), .b(new_n78_), .c(new_n71_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n137_), .c(new_n149_), .O(new_n151_));
  ...
  nand3  g108(.a(new_n57_), .b(new_n47_), .c(x14), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n96_), .O(new_n157_));
  nand3  g111(.a(new_n61_), .b(new_n52_), .c(new_n92_), .O(new_n158_));
  nand3  g112(.a(new_n78_), .b(new_n71_), .c(new_n66_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n158_), .c(x25), .O(new_n160_));
  nor2   g114(.a(x25), .b(x24), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n138_), .c(new_n125_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n160_), .c(x20), .O(new_n163_));
  nand3  g117(.a(x25), .b(x20), .c(x18), .O(new_n164_));
  inv1   g118(.a(new_n164_), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n163_), .c(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n157_), .O(z15));
  nand2  g121(.a(x18), .b(x07), .O(new_n168_));
  oai21  g122(.a(x18), .b(new_n88_), .c(new_n168_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n96_), .O(new_n170_));
  oai21  g124(.a(new_n86_), .b(new_n96_), .c(x18), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(x20), .O(new_n172_));
  nand2  g126(.a(new_n162_), .b(x26), .O(new_n173_));
  nor3   g127(.a(x26), .b(x25), .c(x24), .O(new_n174_));
  nand3  g128(.a(new_n174_), .b(new_n138_), .c(new_n117_), .O(new_n175_));
  nand2  g129(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g130(.a(new_n176_), .b(x16), .O(new_n177_));
  nand3  g131(.a(new_n177_), .b(new_n172_), .c(new_n170_), .O(z16));
  nand2  g132(.a(z08), .b(x17), .O(new_n179_));
  nor2   g133(.a(new_n52_), .b(x17), .O(new_n180_));
  nand4  g134(.a(new_n180_), .b(new_n174_), .c(new_n138_), .d(new_n115_), .O(new_n181_));
