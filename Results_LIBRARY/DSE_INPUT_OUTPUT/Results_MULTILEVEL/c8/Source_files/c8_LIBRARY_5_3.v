...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n49_), .c(new_n83_), .O(new_n98_));
  oai21  g052(.a(new_n85_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n52_), .c(x16), .O(new_n100_));
  ...
  nand4  g060(.a(new_n105_), .b(new_n97_), .c(new_n49_), .d(new_n83_), .O(new_n107_));
  oai21  g061(.a(new_n106_), .b(new_n105_), .c(new_n107_), .O(new_n108_));
  ...
  aoi21  g067(.a(x18), .b(x04), .c(x22), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n105_), .c(new_n97_), .d(new_n49_), .O(new_n115_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n85_), .c(new_n97_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n106_), .c(new_n105_), .O(new_n124_));
  ...
  oai22  g096(.a(new_n142_), .b(x04), .c(x18), .d(new_n74_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n123_), .c(new_n146_), .d(new_n85_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n123_), .c(new_n146_), .d(new_n85_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n123_), .c(new_n71_), .O(new_n162_));
  nand3  g116(.a(new_n146_), .b(x19), .c(new_n83_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n83_), .O(new_n164_));
