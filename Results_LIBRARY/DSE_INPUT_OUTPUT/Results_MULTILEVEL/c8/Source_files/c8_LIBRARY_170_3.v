...
module FAU ( 
  ...
  nand2  g031(.a(new_n48_), .b(new_n58_), .O(z08));
  ...
  nand3  g063(.a(new_n109_), .b(new_n83_), .c(new_n89_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n99_), .c(x16), .O(new_n112_));
  ...
  nand3  g078(.a(new_n89_), .b(new_n81_), .c(new_n80_), .O(new_n125_));
  inv1   g079(.a(x22), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n57_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n99_), .c(x16), .O(new_n134_));
  ...
  nand3  g104(.a(new_n150_), .b(new_n99_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nand2  g106(.a(new_n127_), .b(new_n126_), .O(new_n153_));
  inv1   g107(.a(x24), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n72_), .c(new_n154_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g111(.a(new_n100_), .b(x19), .c(new_n80_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n58_), .b(new_n80_), .O(new_n160_));
