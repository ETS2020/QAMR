...
module FAU ( 
  ...
  nand2  g29(.a(new_n55_), .b(new_n75_), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n49_), .O(z05));
  inv1   g31(.a(x14), .O(new_n78_));
  nand2  g32(.a(x27), .b(new_n78_), .O(new_n79_));
  inv1   g33(.a(x25), .O(new_n80_));
  nand2  g34(.a(new_n55_), .b(new_n80_), .O(new_n81_));
  aoi21  g35(.a(new_n81_), .b(new_n79_), .c(new_n49_), .O(z06));
  inv1   g36(.a(x15), .O(new_n83_));
  nand2  g37(.a(x27), .b(new_n83_), .O(new_n84_));
  inv1   g38(.a(x26), .O(new_n85_));
  nand2  g39(.a(new_n55_), .b(new_n85_), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n49_), .O(z07));
  inv1   g41(.a(new_n49_), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n55_), .O(z08));
  ...
  nor2   g48(.a(x18), .b(x16), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(new_n47_), .c(new_n94_), .O(z09));
  inv1   g51(.a(x16), .O(new_n98_));
  oai21  g52(.a(x18), .b(x09), .c(new_n98_), .O(new_n99_));
  nor2   g53(.a(new_n93_), .b(new_n54_), .O(new_n100_));
  nor3   g54(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n100_), .c(x16), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n99_), .O(z10));
  nor2   g57(.a(x20), .b(x19), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n90_), .O(new_n105_));
  nand4  g59(.a(new_n60_), .b(new_n54_), .c(new_n91_), .d(new_n90_), .O(new_n106_));
  inv1   g60(.a(new_n106_), .O(new_n107_));
  aoi21  g61(.a(new_n105_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n98_), .c(new_n96_), .d(new_n58_), .O(z11));
  nor3   g63(.a(x22), .b(x21), .c(x20), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n93_), .c(new_n106_), .d(x22), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n98_), .c(new_n96_), .d(new_n63_), .O(z12));
  nor2   g66(.a(x22), .b(x21), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(new_n93_), .c(new_n54_), .O(new_n114_));
  nor3   g68(.a(x23), .b(x22), .c(x21), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n101_), .c(new_n114_), .d(x23), .O(new_n116_));
  oai22  g70(.a(new_n116_), .b(new_n98_), .c(new_n96_), .d(new_n68_), .O(z13));
  aoi21  g71(.a(new_n115_), .b(new_n101_), .c(new_n75_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n113_), .c(new_n104_), .d(new_n90_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n95_), .b(x13), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  nand4  g78(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n107_), .c(new_n120_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n95_), .b(x14), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n98_), .c(new_n128_), .O(z15));
  nor2   g83(.a(x21), .b(x20), .O(new_n130_));
  nor2   g84(.a(x23), .b(x22), .O(new_n131_));
  nor2   g85(.a(x25), .b(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n93_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x26), .O(new_n134_));
  nor3   g88(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n131_), .c(new_n130_), .d(new_n93_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n95_), .b(x15), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n138_), .O(z16));
  nand4  g94(.a(new_n131_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n141_));
  nand3  g95(.a(new_n130_), .b(x19), .c(new_n90_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n55_), .d(new_n90_), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(new_n88_), .O(z17));
endmodule
