...
module FAU ( 
  ...
  nand2  g064(.a(new_n97_), .b(x03), .O(new_n111_));
  oai21  g065(.a(new_n110_), .b(new_n90_), .c(new_n111_), .O(z12));
  oai21  g066(.a(new_n91_), .b(x04), .c(new_n90_), .O(new_n113_));
  nor3   g067(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g068(.a(new_n114_), .b(new_n95_), .c(new_n109_), .d(x23), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n90_), .c(new_n113_), .O(z13));
  inv1   g070(.a(x24), .O(new_n117_));
  aoi21  g071(.a(new_n114_), .b(new_n95_), .c(new_n117_), .O(new_n118_));
  ...
  nand2  g076(.a(new_n97_), .b(x05), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n122_), .O(z14));
  oai21  g078(.a(new_n91_), .b(x06), .c(new_n90_), .O(new_n125_));
  nand4  g079(.a(new_n79_), .b(new_n117_), .c(new_n71_), .d(new_n66_), .O(new_n126_));
  inv1   g080(.a(new_n126_), .O(new_n127_));
  aoi22  g081(.a(new_n127_), .b(new_n104_), .c(new_n120_), .d(x25), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n90_), .c(new_n125_), .O(z15));
