...
module FAU ( 
  ...
  nand3  g046(.a(new_n54_), .b(new_n81_), .c(new_n80_), .O(new_n93_));
  ...
  aoi21  g062(.a(new_n102_), .b(new_n83_), .c(new_n108_), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n83_), .c(new_n54_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n85_), .b(x11), .O(new_n114_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n92_), .c(x16), .O(new_n123_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n92_), .c(x16), .O(new_n135_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n120_), .c(new_n102_), .d(new_n83_), .O(new_n140_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n120_), .c(new_n102_), .d(new_n83_), .O(new_n150_));
  ...
  nand2  g107(.a(new_n128_), .b(new_n108_), .O(new_n154_));
  inv1   g108(.a(x25), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n69_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand3  g112(.a(new_n102_), .b(x19), .c(new_n80_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n55_), .b(new_n80_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n92_), .c(new_n88_), .O(z17));
endmodule
