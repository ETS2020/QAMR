...
module FAU ( 
  ...
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n104_), .d(new_n93_), .O(new_n149_));
  ...
  nand2  g107(.a(new_n68_), .b(new_n110_), .O(new_n154_));
  ...
  aoi21  g115(.a(new_n161_), .b(new_n103_), .c(new_n83_), .O(z17));
endmodule
