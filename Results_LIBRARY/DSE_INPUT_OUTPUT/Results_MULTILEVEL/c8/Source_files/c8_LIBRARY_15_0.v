...
module FAU ( 
  ...
  oai21  g50(.a(new_n96_), .b(x02), .c(new_n87_), .O(new_n97_));
  ...
  aoi22  g59(.a(new_n105_), .b(new_n85_), .c(new_n100_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n87_), .c(new_n88_), .d(new_n104_), .O(z12));
  oai21  g61(.a(new_n96_), .b(x04), .c(new_n87_), .O(new_n108_));
  ...
  oai21  g67(.a(new_n96_), .b(x05), .c(new_n87_), .O(new_n114_));
  ...
  oai21  g75(.a(new_n96_), .b(x06), .c(new_n87_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x23), .O(new_n124_));
  nand4  g78(.a(new_n71_), .b(new_n115_), .c(new_n124_), .d(new_n123_), .O(new_n125_));
  ...
  oai21  g82(.a(new_n96_), .b(x07), .c(new_n87_), .O(new_n129_));
  ...
  nand4  g93(.a(new_n131_), .b(new_n76_), .c(new_n71_), .d(new_n115_), .O(new_n140_));
