...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x02), .O(new_n48_));
  ...
  aoi22  g058(.a(new_n104_), .b(new_n97_), .c(new_n100_), .d(x21), .O(new_n105_));
  nor2   g059(.a(x18), .b(x16), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(x10), .c(new_n49_), .O(new_n107_));
  oai21  g061(.a(new_n105_), .b(new_n85_), .c(new_n107_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  oai22  g063(.a(new_n109_), .b(x02), .c(x18), .d(new_n61_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  nand2  g065(.a(new_n104_), .b(new_n97_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x22), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n97_), .c(new_n54_), .O(new_n115_));
  ...
  inv1   g076(.a(x21), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand4  g078(.a(new_n124_), .b(new_n99_), .c(new_n123_), .d(new_n98_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x16), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n121_), .c(new_n48_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  oai22  g083(.a(new_n129_), .b(x02), .c(x18), .d(new_n69_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n85_), .O(new_n131_));
  nand2  g085(.a(new_n125_), .b(x24), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n99_), .d(new_n98_), .O(new_n134_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n124_), .c(new_n104_), .d(new_n97_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n147_), .b(x02), .c(x18), .d(new_n79_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n124_), .c(new_n104_), .d(new_n97_), .O(new_n152_));
  ...
  nand4  g109(.a(new_n124_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n98_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n55_), .d(new_n98_), .O(new_n158_));
