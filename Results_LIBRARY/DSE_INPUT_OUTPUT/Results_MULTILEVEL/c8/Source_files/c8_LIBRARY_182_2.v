...
module FAU ( 
  ...
  oai21  g031(.a(x18), .b(new_n48_), .c(new_n61_), .O(z08));
  ...
  nor2   g037(.a(new_n79_), .b(x16), .O(new_n84_));
  nand2  g038(.a(new_n84_), .b(x00), .O(new_n85_));
  nand3  g039(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z09));
  oai21  g040(.a(x16), .b(x09), .c(new_n79_), .O(new_n87_));
  ...
  nand2  g045(.a(new_n84_), .b(x01), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(z10));
  oai21  g047(.a(x16), .b(x10), .c(new_n79_), .O(new_n94_));
  inv1   g048(.a(x21), .O(new_n95_));
  nor2   g049(.a(x21), .b(x20), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  oai21  g051(.a(new_n90_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x16), .O(new_n99_));
  nand2  g053(.a(new_n84_), .b(x02), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z11));
  ...
  nand2  g058(.a(new_n97_), .b(x22), .O(new_n105_));
  nor2   g059(.a(x22), .b(x21), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n82_), .c(new_n88_), .O(new_n107_));
  ...
  oai21  g073(.a(x16), .b(x13), .c(new_n79_), .O(new_n120_));
  aoi21  g074(.a(new_n115_), .b(new_n90_), .c(new_n69_), .O(new_n121_));
  inv1   g075(.a(x17), .O(new_n122_));
  nor2   g076(.a(x20), .b(x19), .O(new_n123_));
  nor2   g077(.a(x24), .b(x23), .O(new_n124_));
  nand4  g078(.a(new_n124_), .b(new_n106_), .c(new_n123_), .d(new_n122_), .O(new_n125_));
  inv1   g079(.a(new_n125_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n121_), .c(x16), .O(new_n127_));
  nand2  g081(.a(new_n84_), .b(x05), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n127_), .c(new_n120_), .O(z14));
  oai21  g083(.a(x16), .b(x14), .c(new_n79_), .O(new_n130_));
  nand2  g084(.a(new_n125_), .b(x25), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nor2   g086(.a(x25), .b(x24), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n132_), .c(new_n96_), .d(new_n82_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g090(.a(new_n84_), .b(x06), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n136_), .c(new_n130_), .O(z15));
  oai21  g092(.a(x16), .b(x15), .c(new_n79_), .O(new_n139_));
  nand2  g093(.a(new_n134_), .b(x26), .O(new_n140_));
  nor3   g094(.a(x26), .b(x25), .c(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n132_), .c(new_n96_), .d(new_n82_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n84_), .b(x07), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n144_), .c(new_n139_), .O(z16));
  inv1   g100(.a(x23), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n60_), .O(new_n148_));
  inv1   g102(.a(x25), .O(new_n149_));
  inv1   g103(.a(x26), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n69_), .O(new_n151_));
  nor2   g105(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand3  g106(.a(new_n96_), .b(x19), .c(new_n122_), .O(new_n153_));
  inv1   g107(.a(new_n153_), .O(new_n154_));
  nor2   g108(.a(new_n61_), .b(new_n122_), .O(new_n155_));
