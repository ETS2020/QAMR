...
module FAU ( 
  ...
  oai22  g048(.a(new_n85_), .b(new_n94_), .c(x18), .d(new_n55_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  inv1   g050(.a(x20), .O(new_n97_));
  inv1   g051(.a(x17), .O(new_n98_));
  nand3  g052(.a(new_n97_), .b(new_n51_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n89_), .c(new_n97_), .O(new_n117_));
  ...
  oai22  g075(.a(new_n85_), .b(new_n121_), .c(x18), .d(new_n68_), .O(new_n122_));
  ...
  oai22  g084(.a(new_n85_), .b(new_n130_), .c(x18), .d(new_n71_), .O(new_n131_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n107_), .d(new_n89_), .O(new_n148_));
  ...
  oai21  g109(.a(new_n155_), .b(new_n83_), .c(new_n145_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x25), .O(new_n157_));
  nand2  g111(.a(new_n138_), .b(x26), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n125_), .c(new_n107_), .d(new_n89_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n157_), .c(new_n154_), .O(z16));
  inv1   g117(.a(x24), .O(new_n164_));
  nand4  g118(.a(new_n125_), .b(new_n155_), .c(new_n75_), .d(new_n164_), .O(new_n165_));
  nand3  g119(.a(new_n107_), .b(x19), .c(new_n98_), .O(new_n166_));
