...
module FAU ( 
  ...
  nand3  g026(.a(new_n58_), .b(new_n70_), .c(new_n72_), .O(new_n73_));
  ...
  nand2  g036(.a(new_n58_), .b(new_n82_), .O(new_n83_));
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n49_), .O(z07));
  nand2  g038(.a(new_n48_), .b(new_n58_), .O(z08));
  ...
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(new_n48_), .O(z10));
  inv1   g057(.a(x02), .O(new_n104_));
  nand2  g058(.a(x18), .b(new_n69_), .O(new_n105_));
  oai22  g059(.a(new_n105_), .b(new_n104_), .c(x18), .d(new_n55_), .O(new_n106_));
  ...
  oai22  g067(.a(new_n105_), .b(new_n113_), .c(x18), .d(new_n61_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n91_), .O(new_n115_));
  nand2  g069(.a(new_n109_), .b(x22), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n89_), .c(new_n99_), .O(new_n118_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n101_), .c(new_n57_), .O(new_n127_));
  ...
  nand2  g085(.a(new_n72_), .b(x13), .O(new_n132_));
  oai21  g086(.a(new_n105_), .b(new_n131_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  nand3  g088(.a(new_n99_), .b(new_n87_), .c(new_n86_), .O(new_n135_));
  inv1   g089(.a(x22), .O(new_n136_));
  nand3  g090(.a(new_n66_), .b(new_n136_), .c(new_n57_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n135_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n117_), .c(new_n139_), .d(new_n86_), .O(new_n141_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n126_), .c(new_n108_), .d(new_n89_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n126_), .c(new_n108_), .d(new_n89_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n126_), .b(new_n82_), .c(new_n77_), .d(new_n70_), .O(new_n163_));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n86_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n58_), .d(new_n86_), .O(new_n165_));
