...
module FAU ( 
  ...
  nor2   g043(.a(new_n89_), .b(new_n52_), .O(new_n90_));
  nand2  g044(.a(new_n52_), .b(new_n49_), .O(new_n91_));
  nor2   g045(.a(new_n91_), .b(x17), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n88_), .c(new_n81_), .O(z10));
  ...
  oai21  g053(.a(new_n92_), .b(new_n55_), .c(new_n99_), .O(new_n100_));
  ...
  nor3   g074(.a(new_n120_), .b(new_n91_), .c(x17), .O(new_n121_));
  ...
  oai21  g079(.a(new_n77_), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n74_), .O(new_n127_));
  nor2   g081(.a(x22), .b(x21), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n92_), .c(new_n64_), .d(new_n61_), .O(new_n129_));
  oai21  g083(.a(new_n121_), .b(new_n64_), .c(new_n129_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n81_), .c(x16), .O(new_n131_));
  ...
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n81_), .O(z16));
  oai21  g105(.a(new_n48_), .b(x17), .c(new_n47_), .O(new_n152_));
