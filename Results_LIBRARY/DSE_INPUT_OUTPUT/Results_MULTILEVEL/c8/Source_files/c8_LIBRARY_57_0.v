...
module FAU ( 
  ...
  nor2   g43(.a(new_n81_), .b(new_n89_), .O(new_n90_));
  ...
  oai21  g47(.a(new_n83_), .b(x02), .c(new_n87_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand4  g50(.a(new_n56_), .b(new_n89_), .c(new_n79_), .d(new_n78_), .O(new_n97_));
  ...
  nand3  g56(.a(new_n102_), .b(new_n81_), .c(new_n89_), .O(new_n103_));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n91_), .c(new_n103_), .d(x23), .O(new_n109_));
