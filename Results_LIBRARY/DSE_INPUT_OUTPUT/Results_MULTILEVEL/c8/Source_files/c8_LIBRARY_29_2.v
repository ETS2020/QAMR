...
module FAU ( 
  ...
  oai21  g068(.a(new_n112_), .b(new_n62_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n93_), .O(z11));
  ...
  aoi21  g075(.a(new_n113_), .b(new_n95_), .c(new_n121_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n95_), .c(new_n57_), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n120_), .c(new_n93_), .O(z12));
  oai21  g081(.a(new_n89_), .b(new_n87_), .c(x04), .O(new_n128_));
  nand2  g082(.a(new_n124_), .b(x23), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n112_), .c(new_n62_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand3  g087(.a(new_n89_), .b(new_n87_), .c(x12), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n133_), .c(new_n128_), .O(z13));
  nand2  g089(.a(x18), .b(x05), .O(new_n136_));
  nand3  g090(.a(new_n89_), .b(x13), .c(new_n52_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n87_), .O(new_n139_));
  inv1   g093(.a(x23), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n121_), .c(new_n62_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n105_), .c(x24), .O(new_n142_));
  nor2   g096(.a(x20), .b(x19), .O(new_n143_));
  nor2   g097(.a(x24), .b(x23), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n123_), .c(new_n143_), .d(new_n104_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n93_), .c(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n139_), .O(z14));
  ...
  nand4  g107(.a(new_n153_), .b(new_n130_), .c(new_n113_), .d(new_n95_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n93_), .O(z15));
  ...
  nand4  g116(.a(new_n162_), .b(new_n130_), .c(new_n113_), .d(new_n95_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n160_), .c(new_n93_), .O(z16));
  nand4  g120(.a(new_n130_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n167_));
  nand3  g121(.a(new_n113_), .b(x19), .c(new_n104_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n50_), .d(new_n104_), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n93_), .c(x16), .O(new_n170_));
