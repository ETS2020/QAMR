...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n55_,
    ...
    new_n65_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_, new_n76_,
  ...
  nand2  g026(.a(new_n48_), .b(x27), .O(new_n73_));
  oai22  g027(.a(new_n73_), .b(x15), .c(x27), .d(x26), .O(z07));
  ...
  nand3  g038(.a(new_n84_), .b(new_n80_), .c(new_n48_), .O(z09));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n48_), .O(z10));
  inv1   g047(.a(x02), .O(new_n94_));
  inv1   g048(.a(x26), .O(new_n95_));
  ...
  oai22  g058(.a(new_n96_), .b(new_n104_), .c(x18), .d(new_n61_), .O(new_n105_));
  ...
  nand4  g082(.a(new_n128_), .b(new_n108_), .c(new_n127_), .d(new_n76_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n126_), .c(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n124_), .c(new_n48_), .O(z14));
  inv1   g086(.a(x06), .O(new_n133_));
  oai22  g087(.a(new_n96_), .b(new_n133_), .c(x18), .d(new_n70_), .O(new_n134_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n99_), .d(new_n79_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n99_), .d(new_n79_), .O(new_n149_));
  ...
  nor2   g107(.a(new_n77_), .b(x17), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n148_), .c(new_n137_), .d(new_n99_), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(new_n153_), .c(new_n81_), .O(z17));
endmodule
