...
module FAU ( 
  ...
  aoi21  g068(.a(new_n109_), .b(new_n91_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n91_), .c(new_n54_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n93_), .b(x11), .O(new_n120_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n100_), .c(x16), .O(new_n129_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n100_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n126_), .c(new_n109_), .d(new_n91_), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n126_), .c(new_n109_), .d(new_n91_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n93_), .b(x15), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n151_), .O(z16));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n126_), .c(new_n75_), .O(new_n160_));
  nand3  g114(.a(new_n109_), .b(x19), .c(new_n88_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n88_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n100_), .c(x16), .O(new_n163_));
