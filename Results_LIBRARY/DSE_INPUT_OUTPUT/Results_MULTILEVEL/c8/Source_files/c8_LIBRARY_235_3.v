...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(new_n95_), .c(new_n47_), .O(z10));
  inv1   g053(.a(x02), .O(new_n100_));
  nand2  g054(.a(new_n78_), .b(x18), .O(new_n101_));
  ...
  nand4  g058(.a(new_n104_), .b(new_n57_), .c(new_n51_), .d(new_n84_), .O(new_n105_));
  ...
  aoi21  g065(.a(x26), .b(x18), .c(x22), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n104_), .c(new_n57_), .d(new_n51_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n86_), .c(new_n57_), .O(new_n122_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n121_), .c(new_n134_), .d(new_n84_), .O(new_n136_));
  ...
  oai22  g094(.a(new_n101_), .b(new_n140_), .c(x18), .d(new_n74_), .O(new_n141_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n86_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n101_), .b(new_n151_), .c(x18), .d(new_n80_), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n145_), .c(new_n144_), .d(new_n86_), .O(new_n157_));
  ...
  nand4  g116(.a(new_n162_), .b(new_n156_), .c(new_n145_), .d(new_n144_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n161_), .c(new_n88_), .O(z17));
endmodule
