...
module FAU ( 
  ...
  inv1   g31(.a(new_n49_), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n61_), .O(z08));
  ...
  oai21  g47(.a(x18), .b(x10), .c(new_n85_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n80_), .O(new_n96_));
  inv1   g50(.a(x21), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n89_), .c(new_n81_), .d(new_n80_), .O(new_n98_));
  ...
  nand2  g57(.a(new_n48_), .b(new_n85_), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n58_), .c(new_n103_), .d(new_n85_), .O(z12));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n83_), .c(new_n89_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n91_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n85_), .c(new_n104_), .d(new_n64_), .O(z13));
  oai21  g64(.a(x18), .b(x13), .c(new_n85_), .O(new_n111_));
  aoi21  g65(.a(new_n108_), .b(new_n91_), .c(new_n69_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n106_), .c(new_n95_), .d(new_n80_), .O(new_n114_));
  ...
  oai21  g71(.a(x18), .b(x14), .c(new_n85_), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n69_), .c(new_n119_), .d(new_n60_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n99_), .c(new_n114_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n85_), .c(new_n118_), .O(z15));
  oai21  g78(.a(x18), .b(x15), .c(new_n85_), .O(new_n125_));
  ...
  nand3  g90(.a(new_n136_), .b(new_n127_), .c(new_n69_), .O(new_n137_));
  nand3  g91(.a(new_n126_), .b(x19), .c(new_n80_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n61_), .d(new_n80_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n78_), .O(z17));
endmodule
