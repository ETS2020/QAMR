...
module FAU ( 
  ...
  nand3  g055(.a(new_n101_), .b(x09), .c(new_n48_), .O(new_n102_));
  ...
  oai21  g060(.a(new_n93_), .b(new_n54_), .c(new_n106_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n88_), .c(x16), .O(new_n108_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n88_), .O(z11));
  ...
  aoi21  g075(.a(new_n114_), .b(new_n93_), .c(new_n65_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n93_), .c(new_n54_), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n88_), .O(z12));
  nand2  g081(.a(x18), .b(x04), .O(new_n128_));
  nand3  g082(.a(new_n101_), .b(x12), .c(new_n48_), .O(new_n129_));
  ...
  aoi21  g094(.a(new_n133_), .b(new_n113_), .c(new_n75_), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n105_), .d(new_n90_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n141_), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n140_), .c(new_n88_), .O(z14));
  oai21  g100(.a(new_n101_), .b(new_n95_), .c(x06), .O(new_n147_));
  nand2  g101(.a(new_n143_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x23), .b(x22), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n114_), .d(new_n93_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n101_), .b(new_n95_), .c(x14), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n147_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  nand3  g110(.a(new_n101_), .b(x15), .c(new_n48_), .O(new_n157_));
  ...
  nand4  g115(.a(new_n161_), .b(new_n149_), .c(new_n114_), .d(new_n93_), .O(new_n162_));
  ...
  nand4  g119(.a(new_n149_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n166_));
  nand3  g120(.a(new_n114_), .b(x19), .c(new_n90_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n55_), .d(new_n90_), .O(new_n168_));
