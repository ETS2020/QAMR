...
module FAU ( 
  ...
  nor2   g063(.a(new_n87_), .b(x16), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x02), .O(new_n111_));
  ...
  nand2  g081(.a(new_n110_), .b(x04), .O(new_n128_));
  ...
  nand2  g089(.a(new_n110_), .b(x05), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n135_), .c(new_n130_), .O(z14));
  oai21  g091(.a(x16), .b(x14), .c(new_n87_), .O(new_n138_));
  ...
  nand2  g098(.a(new_n110_), .b(x06), .O(new_n145_));
