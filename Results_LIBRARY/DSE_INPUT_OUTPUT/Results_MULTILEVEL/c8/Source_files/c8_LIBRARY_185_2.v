...
module FAU ( 
  ...
  oai21  g012(.a(x27), .b(new_n58_), .c(new_n48_), .O(new_n59_));
  nand3  g013(.a(new_n55_), .b(new_n58_), .c(x18), .O(new_n60_));
  nand2  g014(.a(new_n60_), .b(new_n59_), .O(z02));
  ...
  nor2   g035(.a(x18), .b(x10), .O(new_n82_));
  ...
  nor2   g046(.a(new_n92_), .b(new_n54_), .O(new_n93_));
  nor3   g047(.a(x20), .b(x19), .c(x17), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n91_), .c(new_n84_), .O(z10));
  inv1   g050(.a(x17), .O(new_n97_));
  inv1   g051(.a(x19), .O(new_n98_));
  nand3  g052(.a(new_n54_), .b(new_n98_), .c(new_n97_), .O(new_n99_));
  nor2   g053(.a(x21), .b(x20), .O(new_n100_));
  aoi22  g054(.a(new_n100_), .b(new_n92_), .c(new_n99_), .d(x21), .O(new_n101_));
  inv1   g055(.a(x18), .O(new_n102_));
  nor2   g056(.a(new_n102_), .b(x16), .O(new_n103_));
  aoi21  g057(.a(new_n103_), .b(x02), .c(new_n49_), .O(new_n104_));
  oai21  g058(.a(new_n101_), .b(new_n88_), .c(new_n104_), .O(z11));
  nand2  g059(.a(x18), .b(x03), .O(new_n106_));
  nand3  g060(.a(new_n102_), .b(x11), .c(new_n48_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n88_), .O(new_n109_));
  nand2  g063(.a(new_n100_), .b(new_n92_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x22), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n92_), .c(new_n54_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n84_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n109_), .O(z12));
  nand2  g070(.a(x18), .b(x04), .O(new_n117_));
  nand3  g071(.a(new_n102_), .b(x12), .c(new_n48_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n88_), .O(new_n120_));
  nand2  g074(.a(new_n113_), .b(x23), .O(new_n121_));
  nor2   g075(.a(x23), .b(x22), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n94_), .c(new_n58_), .O(new_n123_));
  ...
  nand3  g081(.a(new_n102_), .b(x13), .c(new_n48_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n88_), .O(new_n130_));
  inv1   g084(.a(x22), .O(new_n131_));
  nand3  g085(.a(new_n67_), .b(new_n131_), .c(new_n58_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n99_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n112_), .c(new_n134_), .d(new_n97_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n84_), .c(x16), .O(new_n138_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n122_), .c(new_n100_), .d(new_n92_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n102_), .b(x15), .c(new_n48_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n122_), .c(new_n100_), .d(new_n92_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n122_), .c(new_n159_), .O(new_n161_));
  nand3  g115(.a(new_n100_), .b(x19), .c(new_n97_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n97_), .O(new_n163_));
