...
module FAU ( 
  ...
  nor2   g025(.a(x27), .b(new_n71_), .O(new_n72_));
  ...
  nand2  g043(.a(new_n71_), .b(x14), .O(new_n90_));
  oai21  g044(.a(new_n90_), .b(new_n51_), .c(new_n89_), .O(new_n91_));
  ...
  oai21  g049(.a(new_n82_), .b(new_n53_), .c(new_n95_), .O(new_n96_));
  ...
  oai21  g072(.a(new_n90_), .b(new_n65_), .c(new_n118_), .O(new_n119_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n139_), .c(new_n104_), .d(new_n82_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n80_), .O(z16));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n139_), .c(new_n130_), .O(new_n155_));
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n93_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n54_), .d(new_n93_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n80_), .c(x16), .O(new_n158_));
