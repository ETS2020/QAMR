...
module FAU ( 
  ...
  oai21  g041(.a(x16), .b(x09), .c(new_n81_), .O(new_n88_));
  ...
  nor2   g047(.a(new_n81_), .b(x16), .O(new_n94_));
  ...
  oai21  g066(.a(x16), .b(x12), .c(new_n81_), .O(new_n113_));
  ...
  oai21  g074(.a(x16), .b(x13), .c(new_n81_), .O(new_n121_));
  aoi21  g075(.a(new_n115_), .b(new_n92_), .c(new_n71_), .O(new_n122_));
  inv1   g076(.a(x17), .O(new_n123_));
  nor2   g077(.a(x20), .b(x19), .O(new_n124_));
  nor2   g078(.a(x24), .b(x23), .O(new_n125_));
  nand4  g079(.a(new_n125_), .b(new_n108_), .c(new_n124_), .d(new_n123_), .O(new_n126_));
  ...
  oai21  g085(.a(x18), .b(new_n74_), .c(new_n131_), .O(new_n132_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n98_), .d(new_n90_), .O(new_n137_));
  ...
  inv1   g105(.a(x26), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n71_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand3  g108(.a(new_n98_), .b(x19), .c(new_n123_), .O(new_n155_));
  inv1   g109(.a(new_n155_), .O(new_n156_));
  nor2   g110(.a(new_n58_), .b(new_n123_), .O(new_n157_));
  aoi21  g111(.a(new_n156_), .b(new_n154_), .c(new_n157_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(x18), .c(new_n48_), .O(z17));
endmodule
