...
module FAU ( 
  ...
  inv1   g044(.a(x06), .O(new_n91_));
  nand2  g045(.a(x18), .b(new_n91_), .O(new_n92_));
  oai22  g046(.a(new_n92_), .b(new_n90_), .c(x18), .d(new_n47_), .O(new_n93_));
  ...
  oai22  g060(.a(new_n92_), .b(new_n106_), .c(x18), .d(new_n58_), .O(new_n107_));
  ...
  oai22  g068(.a(new_n92_), .b(new_n114_), .c(x18), .d(new_n63_), .O(new_n115_));
  ...
  oai22  g077(.a(new_n92_), .b(new_n123_), .c(x18), .d(new_n68_), .O(new_n124_));
  ...
  nand3  g095(.a(new_n141_), .b(new_n134_), .c(new_n48_), .O(z14));
  nand2  g096(.a(new_n139_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x23), .b(x22), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n101_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n48_), .c(x16), .O(new_n148_));
  inv1   g102(.a(x18), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n89_), .c(x14), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(z15));
  nand2  g105(.a(x18), .b(x07), .O(new_n152_));
  oai22  g106(.a(new_n152_), .b(x06), .c(x18), .d(new_n83_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n89_), .O(new_n154_));
  nand2  g108(.a(new_n146_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n144_), .c(new_n109_), .d(new_n101_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n144_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n161_));
