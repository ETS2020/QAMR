...
module FAU ( 
  ...
  nand2  g058(.a(new_n89_), .b(x10), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n104_), .c(new_n99_), .O(z11));
  oai21  g060(.a(x16), .b(x03), .c(x18), .O(new_n107_));
  aoi21  g061(.a(new_n101_), .b(new_n87_), .c(new_n60_), .O(new_n108_));
  ...
  nand2  g066(.a(new_n89_), .b(x11), .O(new_n113_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n95_), .c(new_n100_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n119_), .c(x16), .O(new_n124_));
  ...
  nand2  g081(.a(new_n127_), .b(new_n115_), .O(new_n128_));
  nand3  g082(.a(new_n93_), .b(new_n85_), .c(new_n84_), .O(new_n129_));
  nand3  g083(.a(new_n66_), .b(new_n60_), .c(new_n100_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n129_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n109_), .c(new_n132_), .d(new_n84_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n119_), .c(x16), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n121_), .c(new_n101_), .d(new_n87_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n89_), .b(x14), .O(new_n144_));
  ...
  nand2  g101(.a(new_n147_), .b(new_n115_), .O(new_n148_));
  nand2  g102(.a(new_n141_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n121_), .c(new_n101_), .d(new_n87_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n119_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nand2  g108(.a(new_n66_), .b(new_n60_), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n76_), .c(new_n71_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n101_), .b(x19), .c(new_n84_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n61_), .b(new_n84_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n119_), .c(new_n115_), .O(z17));
endmodule
