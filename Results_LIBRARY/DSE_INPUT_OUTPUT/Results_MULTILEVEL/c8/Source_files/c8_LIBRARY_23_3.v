...
module FAU ( 
  ...
  nand3  g035(.a(new_n81_), .b(new_n48_), .c(x16), .O(new_n82_));
  inv1   g036(.a(x16), .O(new_n83_));
  inv1   g037(.a(x18), .O(new_n84_));
  nand3  g038(.a(new_n84_), .b(new_n83_), .c(x08), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(new_n82_), .O(z09));
  nand2  g040(.a(x18), .b(x01), .O(new_n87_));
  oai22  g041(.a(new_n87_), .b(x00), .c(x18), .d(new_n52_), .O(new_n88_));
  ...
  nand3  g046(.a(new_n54_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  oai21  g047(.a(new_n90_), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  ...
  oai22  g061(.a(new_n107_), .b(x00), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  nand3  g082(.a(new_n66_), .b(new_n128_), .c(new_n100_), .O(new_n129_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n102_), .d(new_n90_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n155_), .b(new_n120_), .c(new_n71_), .O(new_n156_));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n91_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n55_), .d(new_n91_), .O(new_n158_));
