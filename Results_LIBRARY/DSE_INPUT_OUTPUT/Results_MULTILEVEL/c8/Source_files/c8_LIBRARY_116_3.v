// Benchmark "FAU" written by ABC on Thu Aug 13 18:00:57 2020
...
module FAU ( 
  ...
  oai21  g024(.a(x27), .b(new_n70_), .c(new_n69_), .O(new_n71_));
  inv1   g025(.a(x18), .O(new_n72_));
  nand3  g026(.a(new_n52_), .b(new_n70_), .c(new_n72_), .O(new_n73_));
  nand2  g027(.a(new_n73_), .b(new_n71_), .O(z05));
  ...
  nand3  g062(.a(new_n108_), .b(new_n103_), .c(new_n47_), .O(z11));
  inv1   g063(.a(x03), .O(new_n110_));
  nand2  g064(.a(x18), .b(new_n69_), .O(new_n111_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n47_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n113_), .O(z12));
  inv1   g073(.a(x04), .O(new_n120_));
  oai22  g074(.a(new_n111_), .b(new_n120_), .c(x18), .d(new_n64_), .O(new_n121_));
  ...
  nand2  g083(.a(new_n72_), .b(x13), .O(new_n130_));
  oai21  g084(.a(new_n111_), .b(new_n129_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n88_), .O(new_n132_));
  nand3  g086(.a(new_n96_), .b(new_n51_), .c(new_n84_), .O(new_n133_));
  inv1   g087(.a(x22), .O(new_n134_));
  nand3  g088(.a(new_n66_), .b(new_n134_), .c(new_n104_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n133_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n115_), .c(new_n137_), .d(new_n84_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n124_), .c(new_n105_), .d(new_n86_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n47_), .O(z15));
  inv1   g105(.a(x07), .O(new_n152_));
  oai22  g106(.a(new_n111_), .b(new_n152_), .c(x18), .d(new_n78_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n124_), .c(new_n105_), .d(new_n86_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n124_), .c(new_n70_), .O(new_n162_));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n84_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n52_), .d(new_n84_), .O(new_n164_));
