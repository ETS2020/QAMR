...
module FAU ( 
  ...
  nand3  g064(.a(new_n52_), .b(x10), .c(new_n110_), .O(new_n111_));
  ...
  oai21  g069(.a(new_n106_), .b(new_n61_), .c(new_n115_), .O(new_n116_));
  ...
  aoi21  g075(.a(new_n52_), .b(x05), .c(x22), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n61_), .c(new_n56_), .d(new_n49_), .O(new_n123_));
  ...
  nand4  g084(.a(new_n94_), .b(new_n66_), .c(new_n61_), .d(new_n56_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor3   g086(.a(x23), .b(x22), .c(x21), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n106_), .O(new_n134_));
  ...
  oai21  g091(.a(new_n52_), .b(new_n96_), .c(x05), .O(new_n138_));
  aoi21  g092(.a(new_n133_), .b(new_n106_), .c(new_n78_), .O(new_n139_));
  nand4  g093(.a(new_n78_), .b(new_n71_), .c(new_n66_), .d(new_n61_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n105_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n52_), .b(new_n96_), .c(x13), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n142_), .c(new_n138_), .O(z14));
  nand2  g098(.a(x18), .b(x06), .O(new_n145_));
  oai21  g099(.a(x18), .b(new_n83_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n96_), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n114_), .d(new_n94_), .O(new_n150_));
  oai21  g104(.a(new_n141_), .b(new_n81_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n53_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n52_), .b(x15), .c(new_n110_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n148_), .b(new_n88_), .c(new_n81_), .d(new_n78_), .O(new_n159_));
  ...
  nand3  g116(.a(new_n114_), .b(x19), .c(new_n92_), .O(new_n163_));
