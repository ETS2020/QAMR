...
module FAU ( 
  ...
  oai21  g069(.a(x16), .b(x12), .c(new_n79_), .O(new_n116_));
  ...
  nor2   g075(.a(new_n79_), .b(x16), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x04), .O(new_n123_));
  ...
  nand2  g084(.a(new_n122_), .b(x05), .O(new_n131_));
  ...
  nand2  g093(.a(new_n122_), .b(x06), .O(new_n140_));
