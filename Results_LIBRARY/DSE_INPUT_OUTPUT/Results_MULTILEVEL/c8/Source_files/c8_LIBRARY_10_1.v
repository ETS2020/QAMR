...
module FAU ( 
  ...
  nor2   g054(.a(new_n100_), .b(new_n58_), .O(new_n101_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n99_), .c(new_n53_), .O(z10));
  inv1   g061(.a(x02), .O(new_n108_));
  oai22  g062(.a(new_n91_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n89_), .O(new_n110_));
  nand4  g064(.a(new_n63_), .b(new_n58_), .c(new_n47_), .d(new_n102_), .O(new_n111_));
  oai21  g065(.a(new_n105_), .b(new_n63_), .c(new_n111_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n53_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n110_), .O(z11));
  inv1   g068(.a(x03), .O(new_n115_));
  aoi21  g069(.a(x18), .b(new_n115_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n111_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n100_), .c(new_n58_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  aoi21  g074(.a(new_n120_), .b(x16), .c(new_n116_), .O(new_n121_));
  inv1   g075(.a(x18), .O(new_n122_));
  nand3  g076(.a(new_n120_), .b(new_n122_), .c(x16), .O(new_n123_));
  oai21  g077(.a(new_n121_), .b(new_n52_), .c(new_n123_), .O(z12));
  ...
  nand2  g081(.a(new_n119_), .b(x23), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n63_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n104_), .c(new_n128_), .O(new_n131_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n103_), .d(new_n102_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n53_), .c(x16), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n136_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  oai21  g097(.a(x18), .b(new_n78_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n89_), .O(new_n145_));
  nand2  g099(.a(new_n139_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x21), .b(x20), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n129_), .c(new_n147_), .d(new_n100_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n145_), .c(new_n53_), .O(z15));
  inv1   g106(.a(x07), .O(new_n153_));
  oai22  g107(.a(new_n91_), .b(new_n153_), .c(x18), .d(new_n83_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n89_), .O(new_n155_));
  nand2  g109(.a(new_n149_), .b(x26), .O(new_n156_));
  nand4  g110(.a(new_n129_), .b(new_n85_), .c(new_n80_), .d(new_n73_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n111_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n53_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n155_), .O(z16));
  nand3  g114(.a(new_n147_), .b(x19), .c(new_n102_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n48_), .d(new_n102_), .O(new_n162_));
