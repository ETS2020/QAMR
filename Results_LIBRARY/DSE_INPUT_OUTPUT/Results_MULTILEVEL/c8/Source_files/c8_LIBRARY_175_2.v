...
module FAU ( 
  ...
  oai21  g031(.a(x18), .b(new_n47_), .c(new_n52_), .O(z08));
  ...
  nor2   g038(.a(new_n79_), .b(x16), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(x00), .O(new_n86_));
  nand3  g040(.a(new_n86_), .b(new_n84_), .c(new_n80_), .O(z09));
  ...
  nand3  g045(.a(new_n91_), .b(new_n51_), .c(new_n81_), .O(new_n92_));
  oai21  g046(.a(new_n83_), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  ...
  aoi21  g061(.a(new_n101_), .b(new_n83_), .c(new_n107_), .O(new_n108_));
  ...
  nand2  g066(.a(new_n85_), .b(x03), .O(new_n113_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n101_), .d(new_n83_), .O(new_n141_));
  ...
  oai21  g098(.a(x16), .b(x15), .c(new_n79_), .O(new_n145_));
  ...
  nand2  g104(.a(new_n85_), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n119_), .c(new_n69_), .O(new_n154_));
  nand3  g108(.a(new_n101_), .b(x19), .c(new_n81_), .O(new_n155_));
