...
module FAU ( 
  ...
  nor2   g033(.a(x16), .b(new_n49_), .O(new_n80_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n105_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n104_), .O(z12));
  oai21  g065(.a(x16), .b(x04), .c(x18), .O(new_n112_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n132_), .c(new_n96_), .d(new_n87_), .O(new_n144_));
  ...
  nand3  g102(.a(new_n148_), .b(new_n132_), .c(new_n69_), .O(new_n149_));
  nand3  g103(.a(new_n96_), .b(x19), .c(new_n122_), .O(new_n150_));
  oai22  g104(.a(new_n150_), .b(new_n149_), .c(new_n52_), .d(new_n122_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n105_), .c(x16), .O(new_n152_));
  inv1   g106(.a(new_n152_), .O(z17));
endmodule
