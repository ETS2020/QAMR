...
module FAU ( 
  ...
  oai22  g081(.a(new_n102_), .b(new_n127_), .c(x18), .d(new_n73_), .O(new_n128_));
  ...
  oai21  g091(.a(x18), .b(new_n76_), .c(new_n102_), .O(new_n138_));
  ...
  nand3  g099(.a(x18), .b(x06), .c(x05), .O(new_n146_));
  ...
  nand3  g108(.a(x18), .b(x07), .c(x05), .O(new_n155_));
  ...
  nand4  g112(.a(new_n133_), .b(new_n88_), .c(new_n81_), .d(new_n78_), .O(new_n159_));
