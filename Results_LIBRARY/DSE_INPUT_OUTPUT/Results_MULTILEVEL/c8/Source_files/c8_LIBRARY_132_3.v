...
module FAU ( 
  ...
  nand2  g024(.a(new_n52_), .b(new_n69_), .O(new_n71_));
  oai21  g025(.a(new_n71_), .b(x18), .c(new_n70_), .O(z04));
  ...
  oai21  g062(.a(new_n101_), .b(new_n60_), .c(new_n108_), .O(new_n109_));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n89_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n89_), .c(new_n99_), .O(new_n117_));
  ...
  oai21  g074(.a(x18), .b(new_n91_), .c(x12), .O(new_n121_));
  ...
  nand3  g080(.a(x18), .b(new_n91_), .c(x04), .O(new_n127_));
  ...
  nand2  g084(.a(new_n130_), .b(new_n91_), .O(new_n131_));
  aoi21  g085(.a(new_n123_), .b(new_n101_), .c(new_n75_), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n87_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n132_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n131_), .c(new_n47_), .O(z14));
  nand3  g092(.a(x18), .b(new_n68_), .c(x06), .O(new_n139_));
  oai21  g093(.a(x18), .b(new_n78_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n91_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n89_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n107_), .d(new_n89_), .O(new_n154_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n75_), .O(new_n159_));
  nand3  g113(.a(new_n107_), .b(x19), .c(new_n87_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n87_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n47_), .c(x16), .O(new_n162_));
