...
module FAU ( 
  ...
  nand2  g035(.a(new_n47_), .b(new_n52_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  inv1   g037(.a(x00), .O(new_n84_));
  nand2  g038(.a(new_n75_), .b(x18), .O(new_n85_));
  oai22  g039(.a(new_n85_), .b(new_n84_), .c(x18), .d(new_n49_), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  xnor2a g041(.a(x19), .b(x17), .O(new_n88_));
  nand3  g042(.a(new_n88_), .b(new_n47_), .c(x16), .O(new_n89_));
  ...
  nor2   g049(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nor3   g050(.a(x20), .b(x19), .c(x17), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n93_), .c(new_n47_), .O(z10));
  inv1   g053(.a(x02), .O(new_n100_));
  oai22  g054(.a(new_n85_), .b(new_n100_), .c(x18), .d(new_n58_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n83_), .O(new_n102_));
  inv1   g056(.a(x21), .O(new_n103_));
  inv1   g057(.a(x17), .O(new_n104_));
  nand4  g058(.a(new_n103_), .b(new_n94_), .c(new_n51_), .d(new_n104_), .O(new_n105_));
  ...
  aoi21  g065(.a(x25), .b(x18), .c(x22), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n103_), .c(new_n94_), .d(new_n51_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n95_), .c(new_n94_), .O(new_n122_));
  ...
  oai22  g083(.a(new_n85_), .b(new_n129_), .c(x18), .d(new_n69_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n83_), .O(new_n131_));
  nand3  g085(.a(new_n94_), .b(new_n51_), .c(new_n104_), .O(new_n132_));
  inv1   g086(.a(x22), .O(new_n133_));
  nand3  g087(.a(new_n66_), .b(new_n133_), .c(new_n103_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n132_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n121_), .c(new_n136_), .d(new_n104_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n47_), .c(x16), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n131_), .O(z14));
  inv1   g095(.a(x06), .O(new_n142_));
  oai22  g096(.a(new_n85_), .b(new_n142_), .c(x18), .d(new_n74_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n83_), .O(new_n144_));
  inv1   g098(.a(x18), .O(new_n145_));
  nand3  g099(.a(new_n138_), .b(x25), .c(new_n145_), .O(new_n146_));
  nor2   g100(.a(x21), .b(x20), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n124_), .c(new_n147_), .d(new_n95_), .O(new_n149_));
  ...
  nand2  g110(.a(new_n156_), .b(new_n145_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x25), .O(new_n158_));
  nand2  g112(.a(new_n138_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n124_), .c(new_n147_), .d(new_n95_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n155_), .O(z16));
  nand3  g118(.a(new_n47_), .b(x27), .c(x17), .O(new_n165_));
  nor2   g119(.a(new_n51_), .b(x17), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n160_), .c(new_n124_), .d(new_n147_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(new_n83_), .O(z17));
endmodule
