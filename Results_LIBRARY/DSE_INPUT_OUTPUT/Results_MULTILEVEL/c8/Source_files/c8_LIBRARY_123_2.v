...
module FAU ( 
  ...
  oai21  g068(.a(new_n105_), .b(new_n63_), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g074(.a(new_n52_), .b(x06), .c(x22), .O(new_n121_));
  ...
  nand3  g081(.a(new_n52_), .b(x12), .c(new_n109_), .O(new_n128_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n94_), .c(new_n58_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x23), .O(new_n133_));
  nor2   g087(.a(x23), .b(x22), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n105_), .c(new_n63_), .O(new_n135_));
  ...
  oai21  g112(.a(x18), .b(new_n88_), .c(new_n158_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n96_), .O(new_n160_));
  nand2  g114(.a(new_n154_), .b(x26), .O(new_n161_));
  nand4  g115(.a(new_n134_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(new_n114_), .c(new_n161_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n160_), .c(new_n53_), .O(z16));
  nand3  g119(.a(new_n113_), .b(x19), .c(new_n92_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n162_), .c(new_n50_), .d(new_n92_), .O(new_n167_));
