...
module FAU ( 
  ...
  oai21  g33(.a(new_n48_), .b(x16), .c(new_n58_), .O(z08));
  ...
  nand4  g50(.a(new_n57_), .b(new_n89_), .c(new_n82_), .d(new_n81_), .O(new_n97_));
  ...
  nand3  g57(.a(new_n103_), .b(new_n84_), .c(new_n89_), .O(new_n104_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n71_), .c(new_n66_), .d(new_n119_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n98_), .c(new_n114_), .d(x25), .O(new_n123_));
  ...
  nor2   g89(.a(new_n82_), .b(x17), .O(new_n136_));
