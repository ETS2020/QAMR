...
module FAU ( 
  ...
  aoi21  g084(.a(new_n125_), .b(new_n105_), .c(new_n73_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n116_), .c(new_n98_), .d(new_n86_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n139_), .b(new_n93_), .O(new_n140_));
  nand2  g094(.a(new_n133_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n106_), .d(new_n88_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n97_), .c(x16), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n106_), .d(new_n88_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n97_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z16));
  inv1   g110(.a(x23), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n65_), .O(new_n158_));
  inv1   g112(.a(x26), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n78_), .c(new_n73_), .O(new_n160_));
  nor2   g114(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g115(.a(new_n106_), .b(x19), .c(new_n86_), .O(new_n162_));
