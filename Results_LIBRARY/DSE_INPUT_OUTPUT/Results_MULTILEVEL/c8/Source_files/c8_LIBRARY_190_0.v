...
module FAU ( 
  ...
  aoi21  g012(.a(x27), .b(new_n58_), .c(new_n56_), .O(new_n59_));
  ...
  nand2  g017(.a(new_n54_), .b(new_n63_), .O(new_n64_));
  aoi21  g018(.a(new_n64_), .b(new_n62_), .c(new_n56_), .O(z03));
  inv1   g019(.a(x12), .O(new_n66_));
  aoi21  g020(.a(x27), .b(new_n66_), .c(new_n56_), .O(new_n67_));
  oai21  g021(.a(x27), .b(x23), .c(new_n67_), .O(z04));
  inv1   g022(.a(x13), .O(new_n69_));
  aoi21  g023(.a(x27), .b(new_n69_), .c(new_n56_), .O(new_n70_));
  ...
  aoi21  g029(.a(new_n75_), .b(new_n73_), .c(new_n56_), .O(z06));
  ...
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n56_), .O(z07));
  nor2   g035(.a(new_n56_), .b(new_n54_), .O(z08));
  inv1   g036(.a(new_n56_), .O(new_n83_));
  ...
  oai21  g041(.a(new_n48_), .b(x00), .c(new_n87_), .O(new_n88_));
  nand3  g042(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(z09));
  nand2  g043(.a(x18), .b(x01), .O(new_n90_));
  nand3  g044(.a(new_n48_), .b(x09), .c(x08), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n87_), .O(new_n93_));
  inv1   g047(.a(x17), .O(new_n94_));
  nor2   g048(.a(x20), .b(x19), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  oai21  g050(.a(new_n85_), .b(new_n53_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n83_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n93_), .O(z10));
  nand2  g053(.a(x18), .b(x02), .O(new_n100_));
  nand3  g054(.a(new_n48_), .b(x10), .c(x08), .O(new_n101_));
  ...
  nand3  g065(.a(new_n48_), .b(x11), .c(x08), .O(new_n112_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n85_), .c(new_n53_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n83_), .c(x16), .O(new_n119_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n83_), .O(z13));
  ...
  aoi21  g087(.a(new_n125_), .b(new_n105_), .c(new_n133_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n116_), .c(new_n95_), .d(new_n94_), .O(new_n136_));
  inv1   g090(.a(new_n136_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n134_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n132_), .c(new_n83_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  nand3  g094(.a(new_n48_), .b(x14), .c(x08), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n87_), .O(new_n143_));
  nand2  g097(.a(new_n136_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x23), .b(x22), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n106_), .d(new_n85_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n83_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n143_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  oai21  g105(.a(x18), .b(new_n77_), .c(new_n151_), .O(new_n152_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n106_), .d(new_n85_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n83_), .O(z16));
  nand4  g113(.a(new_n145_), .b(new_n79_), .c(new_n74_), .d(new_n133_), .O(new_n160_));
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n94_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n54_), .d(new_n94_), .O(new_n162_));
