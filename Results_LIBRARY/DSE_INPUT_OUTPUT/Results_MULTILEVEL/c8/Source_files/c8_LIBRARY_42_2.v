...
module FAU ( 
  ...
  oai21  g053(.a(new_n90_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  ...
  oai21  g065(.a(x16), .b(x11), .c(new_n85_), .O(new_n112_));
  aoi21  g066(.a(new_n107_), .b(new_n90_), .c(new_n65_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n90_), .c(new_n54_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n92_), .b(x03), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n117_), .c(new_n112_), .O(z12));
  oai21  g073(.a(x16), .b(x12), .c(new_n85_), .O(new_n120_));
  nand2  g074(.a(new_n115_), .b(x23), .O(new_n121_));
  nor3   g075(.a(x23), .b(x22), .c(x21), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n106_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g079(.a(new_n92_), .b(x04), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n120_), .O(z13));
  oai21  g081(.a(x16), .b(x13), .c(new_n85_), .O(new_n128_));
  inv1   g082(.a(x24), .O(new_n129_));
  aoi21  g083(.a(new_n122_), .b(new_n106_), .c(new_n129_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n114_), .c(new_n98_), .d(new_n87_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n92_), .b(x05), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n134_), .c(new_n128_), .O(z14));
  oai21  g090(.a(x16), .b(x14), .c(new_n85_), .O(new_n137_));
  nand2  g091(.a(new_n132_), .b(x25), .O(new_n138_));
  nor2   g092(.a(x23), .b(x22), .O(new_n139_));
  nor2   g093(.a(x25), .b(x24), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n107_), .d(new_n90_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n92_), .b(x06), .O(new_n144_));
  ...
  nand2  g102(.a(new_n141_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n139_), .c(new_n107_), .d(new_n90_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n155_), .b(new_n139_), .c(new_n129_), .O(new_n156_));
  nand3  g110(.a(new_n107_), .b(x19), .c(new_n87_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n55_), .d(new_n87_), .O(new_n158_));
