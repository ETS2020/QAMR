...
module FAU ( 
  ...
  nor2   g030(.a(new_n48_), .b(new_n63_), .O(z08));
  ...
  nand3  g035(.a(x18), .b(new_n81_), .c(x00), .O(new_n82_));
  nand2  g036(.a(new_n82_), .b(new_n80_), .O(z09));
  nand2  g037(.a(x18), .b(x01), .O(new_n84_));
  inv1   g038(.a(x18), .O(new_n85_));
  nand3  g039(.a(new_n85_), .b(x09), .c(new_n47_), .O(new_n86_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n78_), .c(x16), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n88_), .O(z10));
  nand2  g050(.a(x18), .b(x02), .O(new_n97_));
  nand3  g051(.a(new_n85_), .b(x10), .c(new_n47_), .O(new_n98_));
  ...
  nand3  g062(.a(new_n85_), .b(x11), .c(new_n47_), .O(new_n109_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n78_), .c(x16), .O(new_n116_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n78_), .O(z13));
  ...
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(new_n78_), .O(z14));
  ...
  nand3  g101(.a(new_n85_), .b(x15), .c(new_n47_), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n141_), .c(new_n103_), .d(new_n90_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n141_), .c(new_n130_), .O(new_n158_));
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n91_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n63_), .d(new_n91_), .O(new_n160_));
