...
module FAU ( 
  ...
  nand2  g040(.a(x18), .b(x14), .O(new_n87_));
  ...
  oai22  g065(.a(new_n87_), .b(new_n111_), .c(x18), .d(new_n61_), .O(new_n112_));
  ...
  oai22  g074(.a(new_n87_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  ...
  nand3  g086(.a(new_n96_), .b(new_n51_), .c(new_n132_), .O(new_n133_));
  ...
  nand3  g097(.a(new_n143_), .b(new_n85_), .c(x14), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n124_), .c(new_n106_), .d(new_n97_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n83_), .O(z15));
  ...
  nand4  g109(.a(new_n155_), .b(new_n124_), .c(new_n106_), .d(new_n97_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n124_), .c(new_n73_), .O(new_n161_));
  nand3  g115(.a(new_n106_), .b(x19), .c(new_n132_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n132_), .O(new_n163_));
