...
module FAU ( 
  ...
  nor2   g052(.a(new_n85_), .b(x16), .O(new_n99_));
  ...
  nand2  g061(.a(new_n99_), .b(x02), .O(new_n108_));
  ...
  nand2  g070(.a(new_n99_), .b(x03), .O(new_n117_));
  ...
  nand3  g084(.a(new_n54_), .b(new_n88_), .c(new_n87_), .O(new_n131_));
  nand3  g085(.a(new_n66_), .b(new_n111_), .c(new_n103_), .O(new_n132_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n104_), .d(new_n95_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n99_), .b(x06), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n123_), .c(new_n104_), .d(new_n95_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n99_), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand4  g109(.a(new_n123_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n87_), .O(new_n157_));
