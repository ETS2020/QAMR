...
module FAU ( 
  ...
  nor2   g48(.a(new_n88_), .b(x16), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(x01), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n94_), .O(z10));
  oai21  g51(.a(new_n88_), .b(x02), .c(new_n87_), .O(new_n98_));
  nor2   g52(.a(x20), .b(x19), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n83_), .O(new_n100_));
  inv1   g54(.a(x21), .O(new_n101_));
  nand4  g55(.a(new_n101_), .b(new_n91_), .c(new_n50_), .d(new_n83_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n87_), .c(new_n98_), .O(z11));
  ...
  nand2  g63(.a(new_n95_), .b(x03), .O(new_n110_));
  ...
  aoi21  g70(.a(new_n113_), .b(new_n93_), .c(new_n72_), .O(new_n117_));
  ...
  nand2  g91(.a(new_n95_), .b(x07), .O(new_n138_));
