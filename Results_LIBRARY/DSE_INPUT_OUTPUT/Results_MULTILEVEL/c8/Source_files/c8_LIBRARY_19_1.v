...
module FAU ( 
  ...
  nor2   g002(.a(new_n48_), .b(x06), .O(new_n49_));
  ...
  nand2  g042(.a(new_n88_), .b(new_n55_), .O(z08));
  ...
  oai21  g050(.a(x18), .b(new_n47_), .c(new_n96_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n88_), .O(z09));
  inv1   g053(.a(x01), .O(new_n100_));
  nand2  g054(.a(x18), .b(x06), .O(new_n101_));
  oai22  g055(.a(new_n101_), .b(new_n100_), .c(x18), .d(new_n52_), .O(new_n102_));
  ...
  oai21  g059(.a(new_n93_), .b(new_n54_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n88_), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n103_), .O(z10));
  ...
  nand2  g067(.a(new_n113_), .b(new_n93_), .O(new_n114_));
  oai21  g068(.a(new_n112_), .b(new_n60_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n88_), .O(z11));
  nand2  g071(.a(x18), .b(x03), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n63_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n95_), .O(new_n120_));
  aoi21  g074(.a(new_n113_), .b(new_n93_), .c(new_n65_), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n93_), .c(new_n54_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n88_), .O(z12));
  inv1   g080(.a(x04), .O(new_n127_));
  oai22  g081(.a(new_n101_), .b(new_n127_), .c(x18), .d(new_n68_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n95_), .O(new_n129_));
  nand2  g083(.a(new_n123_), .b(x23), .O(new_n130_));
  nor3   g084(.a(x23), .b(x22), .c(x21), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n112_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n88_), .c(x16), .O(new_n134_));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n112_), .c(new_n75_), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n122_), .c(new_n104_), .d(new_n90_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n138_), .c(new_n88_), .O(z14));
  oai21  g098(.a(x18), .b(x14), .c(new_n95_), .O(new_n145_));
  nand2  g099(.a(new_n141_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n113_), .d(new_n93_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n145_), .c(new_n88_), .O(z15));
  nand3  g106(.a(x18), .b(x07), .c(x06), .O(new_n153_));
  oai21  g107(.a(x18), .b(new_n83_), .c(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n95_), .O(new_n155_));
  nand2  g109(.a(new_n149_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n113_), .d(new_n93_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n162_));
  nand3  g116(.a(new_n113_), .b(x19), .c(new_n90_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n55_), .d(new_n90_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n88_), .c(x16), .O(new_n165_));
