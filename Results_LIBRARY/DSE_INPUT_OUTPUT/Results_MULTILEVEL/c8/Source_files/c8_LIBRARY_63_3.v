...
module FAU ( 
  ...
  nand2  g034(.a(new_n47_), .b(x27), .O(new_n81_));
  oai22  g035(.a(new_n81_), .b(x15), .c(x27), .d(x26), .O(z07));
  ...
  oai22  g041(.a(new_n87_), .b(new_n85_), .c(x18), .d(new_n49_), .O(new_n88_));
  ...
  oai22  g047(.a(new_n87_), .b(new_n93_), .c(x18), .d(new_n55_), .O(new_n94_));
  ...
  oai21  g053(.a(new_n96_), .b(new_n57_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n47_), .c(x16), .O(new_n101_));
  ...
  nand4  g060(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n97_), .O(new_n107_));
  oai21  g061(.a(new_n106_), .b(new_n62_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n47_), .c(x16), .O(new_n109_));
  ...
  aoi21  g067(.a(x26), .b(x18), .c(x22), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n62_), .c(new_n57_), .d(new_n51_), .O(new_n115_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n47_), .O(z12));
  inv1   g073(.a(x04), .O(new_n120_));
  oai22  g074(.a(new_n87_), .b(new_n120_), .c(x18), .d(new_n70_), .O(new_n121_));
  ...
  aoi21  g088(.a(new_n126_), .b(new_n106_), .c(new_n134_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n123_), .c(new_n98_), .d(new_n97_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n133_), .c(new_n47_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n87_), .b(new_n141_), .c(x18), .d(new_n78_), .O(new_n142_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n96_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n47_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n143_), .O(z15));
  inv1   g105(.a(x07), .O(new_n152_));
  inv1   g106(.a(x18), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x15), .O(new_n154_));
  oai21  g108(.a(new_n87_), .b(new_n152_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n84_), .O(new_n156_));
  nand3  g110(.a(new_n148_), .b(x26), .c(new_n153_), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n146_), .c(new_n145_), .d(new_n96_), .O(new_n159_));
  ...
  nor2   g117(.a(new_n51_), .b(x17), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n158_), .c(new_n146_), .d(new_n145_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n163_), .c(new_n84_), .O(z17));
endmodule
