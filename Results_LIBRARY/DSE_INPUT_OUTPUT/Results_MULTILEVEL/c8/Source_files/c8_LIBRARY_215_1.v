...
module FAU ( 
  ...
  nor2   g002(.a(new_n48_), .b(x14), .O(new_n49_));
  ...
  nor2   g025(.a(x27), .b(x18), .O(new_n72_));
  oai22  g026(.a(new_n72_), .b(x14), .c(x27), .d(x25), .O(z06));
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n49_), .O(z07));
  nor2   g032(.a(new_n49_), .b(new_n55_), .O(z08));
  ...
  nand2  g043(.a(x18), .b(x14), .O(new_n90_));
  oai22  g044(.a(new_n90_), .b(new_n89_), .c(x18), .d(new_n52_), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n84_), .O(new_n92_));
  inv1   g046(.a(x17), .O(new_n93_));
  nor2   g047(.a(x20), .b(x19), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  oai21  g049(.a(new_n82_), .b(new_n54_), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n80_), .c(x16), .O(new_n97_));
  ...
  nand2  g054(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n101_), .c(new_n80_), .O(z11));
  inv1   g062(.a(x03), .O(new_n109_));
  oai22  g063(.a(new_n90_), .b(new_n109_), .c(x18), .d(new_n61_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n84_), .O(new_n111_));
  nand2  g065(.a(new_n105_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n82_), .c(new_n54_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n80_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n111_), .O(z12));
  inv1   g071(.a(x04), .O(new_n118_));
  oai22  g072(.a(new_n90_), .b(new_n118_), .c(x18), .d(new_n66_), .O(new_n119_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n80_), .c(x16), .O(new_n125_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n104_), .d(new_n82_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n149_), .c(new_n80_), .O(z16));
  ...
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n93_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n80_), .c(x16), .O(new_n160_));
