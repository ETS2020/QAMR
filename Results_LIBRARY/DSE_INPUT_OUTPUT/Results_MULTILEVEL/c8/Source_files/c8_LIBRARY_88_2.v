...
module FAU ( 
  ...
  aoi21  g063(.a(new_n103_), .b(new_n91_), .c(new_n67_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n91_), .c(new_n57_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n93_), .b(x03), .O(new_n115_));
  ...
  oai21  g079(.a(x16), .b(x13), .c(new_n87_), .O(new_n126_));
  inv1   g080(.a(x24), .O(new_n127_));
  aoi21  g081(.a(new_n121_), .b(new_n98_), .c(new_n127_), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n111_), .c(new_n129_), .d(new_n89_), .O(new_n131_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n138_), .c(new_n103_), .d(new_n91_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n138_), .c(new_n127_), .O(new_n155_));
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n89_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n89_), .O(new_n157_));
