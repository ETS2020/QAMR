...
module FAU ( 
  ...
  nand2  g050(.a(x18), .b(x04), .O(new_n97_));
  ...
  nand3  g056(.a(new_n102_), .b(new_n85_), .c(x16), .O(new_n103_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n107_), .c(new_n85_), .O(z11));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n89_), .c(new_n63_), .O(new_n118_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n85_), .O(z12));
  oai21  g077(.a(x18), .b(new_n66_), .c(new_n97_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n91_), .O(new_n125_));
  nand2  g079(.a(new_n120_), .b(x23), .O(new_n126_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n85_), .c(x16), .O(new_n130_));
  ...
  aoi21  g088(.a(new_n127_), .b(new_n109_), .c(new_n73_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n119_), .c(new_n100_), .d(new_n86_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n134_), .c(new_n85_), .O(z14));
  ...
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n85_), .O(z15));
  nand3  g104(.a(x18), .b(x07), .c(x04), .O(new_n151_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n110_), .d(new_n89_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n85_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n145_), .c(new_n73_), .O(new_n161_));
  nand3  g115(.a(new_n110_), .b(x19), .c(new_n86_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n86_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n85_), .O(z17));
endmodule
