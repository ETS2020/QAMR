...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(new_n65_), .O(new_n66_));
  ...
  nand2  g24(.a(new_n60_), .b(new_n70_), .O(new_n71_));
  ...
  nand2  g29(.a(new_n60_), .b(new_n75_), .O(new_n76_));
  ...
  nor2   g34(.a(new_n48_), .b(new_n60_), .O(z08));
  ...
  oai21  g44(.a(new_n88_), .b(x01), .c(new_n87_), .O(new_n91_));
  ...
  nor2   g66(.a(new_n88_), .b(x16), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x04), .O(new_n114_));
  oai21  g68(.a(new_n112_), .b(new_n87_), .c(new_n114_), .O(z13));
  aoi21  g69(.a(new_n111_), .b(new_n94_), .c(new_n70_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n98_), .d(new_n82_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n113_), .b(x05), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  oai21  g76(.a(new_n88_), .b(x06), .c(new_n87_), .O(new_n123_));
  nand4  g77(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n59_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n102_), .c(new_n118_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n87_), .c(new_n123_), .O(z15));
  ...
  nand2  g90(.a(new_n113_), .b(x07), .O(new_n137_));
  ...
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n60_), .d(new_n82_), .O(new_n143_));
