...
module FAU ( 
  ...
  nand2  g042(.a(new_n88_), .b(new_n83_), .O(z09));
  ...
  aoi22  g070(.a(new_n116_), .b(new_n95_), .c(new_n112_), .d(x23), .O(new_n117_));
  nor2   g071(.a(x18), .b(x16), .O(new_n118_));
  aoi21  g072(.a(new_n118_), .b(x12), .c(new_n49_), .O(new_n119_));
  oai21  g073(.a(new_n117_), .b(new_n79_), .c(new_n119_), .O(z13));
  ...
  nand3  g094(.a(new_n140_), .b(new_n134_), .c(new_n48_), .O(z15));
  nand2  g095(.a(x18), .b(x07), .O(new_n142_));
  oai22  g096(.a(new_n142_), .b(x04), .c(x18), .d(new_n75_), .O(new_n143_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n136_), .c(new_n102_), .d(new_n85_), .O(new_n147_));
  ...
  nand3  g106(.a(new_n102_), .b(x19), .c(new_n125_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n61_), .d(new_n125_), .O(new_n154_));
