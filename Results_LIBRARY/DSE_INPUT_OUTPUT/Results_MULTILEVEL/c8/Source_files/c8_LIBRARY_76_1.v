...
module FAU ( 
  ...
  oai21  g46(.a(new_n88_), .b(new_n55_), .c(new_n92_), .O(z10));
  nor2   g47(.a(x20), .b(x19), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n83_), .O(new_n95_));
  inv1   g49(.a(x21), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n57_), .c(new_n51_), .d(new_n83_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x21), .c(new_n98_), .O(new_n99_));
  oai22  g53(.a(new_n99_), .b(new_n87_), .c(new_n88_), .d(new_n60_), .O(z11));
  oai21  g54(.a(x18), .b(x11), .c(new_n87_), .O(new_n101_));
  nand2  g55(.a(new_n97_), .b(x22), .O(new_n102_));
  nor2   g56(.a(x22), .b(x21), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n85_), .c(new_n57_), .O(new_n104_));
  ...
  aoi22  g61(.a(new_n107_), .b(new_n91_), .c(new_n104_), .d(x23), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n87_), .c(new_n88_), .d(new_n66_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n87_), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  aoi21  g65(.a(new_n107_), .b(new_n91_), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n103_), .c(new_n94_), .d(new_n83_), .O(new_n114_));
  ...
  nand4  g73(.a(new_n76_), .b(new_n111_), .c(new_n68_), .d(new_n119_), .O(new_n120_));
