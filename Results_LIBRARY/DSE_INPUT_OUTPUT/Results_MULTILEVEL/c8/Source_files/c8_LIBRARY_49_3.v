...
module FAU ( 
  ...
  nor2   g029(.a(new_n49_), .b(new_n70_), .O(z08));
  inv1   g030(.a(x16), .O(new_n77_));
  inv1   g031(.a(x00), .O(new_n78_));
  nand2  g032(.a(x18), .b(new_n55_), .O(new_n79_));
  ...
  nand3  g036(.a(new_n82_), .b(new_n48_), .c(x16), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n81_), .O(z09));
  inv1   g038(.a(x01), .O(new_n85_));
  oai22  g039(.a(new_n79_), .b(new_n85_), .c(x18), .d(new_n52_), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n77_), .O(new_n87_));
  ...
  oai21  g046(.a(new_n89_), .b(new_n88_), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n48_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n87_), .O(z10));
  nand3  g049(.a(x18), .b(new_n55_), .c(x02), .O(new_n96_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n88_), .c(new_n101_), .d(new_n90_), .O(new_n102_));
  ...
  aoi21  g062(.a(x18), .b(x10), .c(x22), .O(new_n109_));
  nand4  g063(.a(new_n109_), .b(new_n99_), .c(new_n88_), .d(new_n101_), .O(new_n110_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n89_), .c(new_n88_), .O(new_n119_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n117_), .c(new_n48_), .O(z13));
  ...
  aoi21  g083(.a(new_n121_), .b(new_n100_), .c(new_n129_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n118_), .c(new_n91_), .d(new_n90_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n128_), .c(new_n48_), .O(z14));
  nand2  g089(.a(x18), .b(x06), .O(new_n136_));
  oai21  g090(.a(x18), .b(new_n67_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n77_), .O(new_n138_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n129_), .O(new_n157_));
  nand3  g111(.a(new_n140_), .b(x19), .c(new_n90_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n70_), .d(new_n90_), .O(new_n159_));
