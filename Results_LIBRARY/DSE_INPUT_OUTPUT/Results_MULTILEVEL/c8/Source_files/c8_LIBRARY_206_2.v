...
module FAU ( 
  ...
  nand2  g057(.a(new_n96_), .b(x02), .O(new_n104_));
  ...
  aoi21  g061(.a(new_n100_), .b(new_n92_), .c(new_n107_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n92_), .c(new_n91_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n96_), .b(x03), .O(new_n113_));
  ...
  nand3  g081(.a(new_n66_), .b(new_n107_), .c(new_n57_), .O(new_n128_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n100_), .d(new_n92_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n119_), .c(new_n100_), .d(new_n92_), .O(new_n148_));
  ...
  nand2  g106(.a(new_n66_), .b(new_n107_), .O(new_n153_));
  inv1   g107(.a(x24), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n74_), .c(new_n154_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g111(.a(new_n100_), .b(x19), .c(new_n83_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n58_), .b(new_n83_), .O(new_n160_));
