...
module FAU ( 
  ...
  nand2  g001(.a(x25), .b(new_n47_), .O(new_n48_));
  ...
  nand3  g033(.a(new_n79_), .b(new_n77_), .c(new_n48_), .O(z05));
  inv1   g034(.a(x25), .O(new_n81_));
  aoi21  g035(.a(x27), .b(x18), .c(new_n81_), .O(new_n82_));
  oai22  g036(.a(new_n82_), .b(x14), .c(x27), .d(x25), .O(z06));
  inv1   g037(.a(x26), .O(new_n84_));
  nand2  g038(.a(new_n53_), .b(new_n84_), .O(new_n85_));
  inv1   g039(.a(x15), .O(new_n86_));
  nand2  g040(.a(x27), .b(new_n86_), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n85_), .c(new_n48_), .O(z07));
  nand2  g042(.a(new_n48_), .b(new_n53_), .O(z08));
  ...
  oai21  g053(.a(x18), .b(new_n56_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  nor2   g055(.a(new_n92_), .b(new_n58_), .O(new_n102_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n48_), .O(z10));
  nand2  g061(.a(x18), .b(x02), .O(new_n108_));
  nand2  g062(.a(new_n81_), .b(new_n47_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n63_), .c(new_n108_), .O(new_n110_));
  ...
  oai21  g067(.a(new_n105_), .b(new_n61_), .c(new_n113_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n48_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n111_), .O(z11));
  nand2  g070(.a(x18), .b(x03), .O(new_n117_));
  oai21  g071(.a(x18), .b(new_n66_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n94_), .O(new_n119_));
  aoi21  g073(.a(x25), .b(new_n47_), .c(x22), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n61_), .c(new_n58_), .d(new_n52_), .O(new_n121_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n48_), .O(z12));
  nand2  g079(.a(x18), .b(x04), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n71_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n94_), .O(new_n128_));
  nor2   g082(.a(x22), .b(x21), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n92_), .c(new_n58_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x23), .O(new_n131_));
  nor3   g085(.a(x23), .b(x22), .c(x21), .O(new_n132_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n128_), .c(new_n48_), .O(z13));
  nand2  g090(.a(x18), .b(x05), .O(new_n137_));
  oai21  g091(.a(x18), .b(new_n78_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n94_), .O(new_n139_));
  aoi21  g093(.a(new_n132_), .b(new_n105_), .c(new_n76_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n129_), .c(new_n103_), .d(new_n90_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n48_), .O(z14));
  inv1   g099(.a(x14), .O(new_n146_));
  nand2  g100(.a(x18), .b(x06), .O(new_n147_));
  oai21  g101(.a(new_n109_), .b(new_n146_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n94_), .O(new_n149_));
  nand3  g103(.a(new_n142_), .b(x25), .c(x18), .O(new_n150_));
  nor2   g104(.a(x23), .b(x22), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n81_), .c(new_n76_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n113_), .c(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  oai21  g110(.a(new_n109_), .b(new_n86_), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n94_), .O(new_n158_));
  nand2  g112(.a(new_n142_), .b(x26), .O(new_n159_));
  nor2   g113(.a(x26), .b(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n151_), .c(new_n112_), .d(new_n92_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n159_), .c(x25), .O(new_n162_));
  nand3  g116(.a(x26), .b(x25), .c(x18), .O(new_n163_));
  inv1   g117(.a(new_n163_), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n162_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n158_), .O(z16));
  nand3  g120(.a(new_n112_), .b(x19), .c(new_n90_), .O(new_n167_));
  nand4  g121(.a(new_n151_), .b(new_n84_), .c(new_n81_), .d(new_n76_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n53_), .d(new_n90_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n48_), .O(z17));
endmodule
