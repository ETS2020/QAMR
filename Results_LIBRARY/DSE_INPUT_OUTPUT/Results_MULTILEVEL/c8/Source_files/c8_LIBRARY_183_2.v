...
module FAU ( 
  ...
  nand3  g049(.a(x18), .b(new_n47_), .c(x01), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n95_), .c(new_n90_), .O(z10));
  ...
  oai21  g056(.a(new_n94_), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n94_), .c(new_n60_), .O(new_n120_));
  ...
  oai21  g101(.a(x16), .b(x15), .c(new_n83_), .O(new_n148_));
  ...
  nand3  g107(.a(x18), .b(new_n47_), .c(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n119_), .c(new_n71_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n127_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n127_), .O(new_n159_));
