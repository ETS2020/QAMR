...
module FAU ( 
  ...
  aoi21  g063(.a(new_n104_), .b(new_n94_), .c(new_n67_), .O(new_n110_));
  ...
  nor2   g068(.a(new_n83_), .b(x16), .O(new_n115_));
  ...
  nand2  g077(.a(new_n115_), .b(x04), .O(new_n124_));
  ...
  aoi21  g081(.a(new_n120_), .b(new_n103_), .c(new_n127_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n111_), .c(new_n95_), .d(new_n85_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n115_), .b(x05), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n104_), .d(new_n94_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n115_), .b(x06), .O(new_n142_));
