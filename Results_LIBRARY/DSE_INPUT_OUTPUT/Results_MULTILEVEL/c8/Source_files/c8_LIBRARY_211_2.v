...
module FAU ( 
  ...
  nor2   g072(.a(new_n85_), .b(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x03), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n118_), .c(new_n112_), .O(z12));
  ...
  aoi21  g085(.a(new_n126_), .b(new_n106_), .c(new_n71_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n115_), .c(new_n98_), .d(new_n87_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n119_), .b(x05), .O(new_n137_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n97_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n143_), .c(new_n107_), .d(new_n97_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n119_), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  nand4  g110(.a(new_n143_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x19), .c(new_n87_), .O(new_n158_));
