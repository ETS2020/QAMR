...
module FAU ( 
  ...
  aoi21  g32(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(z05));
  inv1   g33(.a(x14), .O(new_n80_));
  aoi21  g34(.a(x27), .b(new_n80_), .c(new_n48_), .O(new_n81_));
  oai21  g35(.a(x27), .b(x25), .c(new_n81_), .O(z06));
  ...
  nor2   g44(.a(x18), .b(x16), .O(new_n91_));
  ...
  nand4  g54(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n87_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n98_), .c(new_n92_), .d(new_n60_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n89_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n98_), .c(new_n92_), .d(new_n65_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n98_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n89_), .c(new_n57_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n95_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n98_), .c(new_n108_), .O(z13));
  aoi21  g67(.a(new_n111_), .b(new_n95_), .c(new_n77_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n109_), .c(new_n99_), .d(new_n87_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n91_), .b(x13), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n77_), .c(new_n72_), .d(new_n67_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n124_));
  nand2  g78(.a(new_n91_), .b(x14), .O(new_n125_));
  oai21  g79(.a(new_n124_), .b(new_n98_), .c(new_n125_), .O(z15));
  nor2   g80(.a(x21), .b(x20), .O(new_n127_));
  nor2   g81(.a(x23), .b(x22), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n89_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x26), .O(new_n131_));
  nor3   g85(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n128_), .c(new_n127_), .d(new_n89_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n91_), .b(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  inv1   g91(.a(new_n48_), .O(new_n138_));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand3  g93(.a(new_n139_), .b(new_n128_), .c(new_n77_), .O(new_n140_));
  nand3  g94(.a(new_n127_), .b(x19), .c(new_n87_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n52_), .d(new_n87_), .O(new_n142_));
