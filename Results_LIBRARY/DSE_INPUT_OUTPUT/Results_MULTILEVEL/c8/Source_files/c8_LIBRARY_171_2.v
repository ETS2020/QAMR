...
module FAU ( 
  ...
  nor2   g046(.a(new_n87_), .b(new_n57_), .O(new_n93_));
  nor3   g047(.a(x20), .b(x19), .c(x17), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nand2  g049(.a(new_n89_), .b(x01), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n95_), .c(new_n92_), .O(z10));
  oai21  g051(.a(x16), .b(x10), .c(new_n83_), .O(new_n98_));
  inv1   g052(.a(x21), .O(new_n99_));
  nor2   g053(.a(x21), .b(x20), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  oai21  g055(.a(new_n94_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(x16), .O(new_n103_));
  nand2  g057(.a(new_n89_), .b(x02), .O(new_n104_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n87_), .c(new_n57_), .O(new_n111_));
  ...
  nand2  g070(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  ...
  aoi21  g079(.a(new_n119_), .b(new_n94_), .c(new_n125_), .O(new_n126_));
  ...
  nand2  g089(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  nand2  g090(.a(new_n129_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n100_), .d(new_n87_), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n138_), .c(new_n100_), .d(new_n87_), .O(new_n147_));
  ...
  nand2  g105(.a(new_n70_), .b(new_n65_), .O(new_n152_));
  inv1   g106(.a(x25), .O(new_n153_));
  inv1   g107(.a(x26), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n125_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g110(.a(new_n100_), .b(x19), .c(new_n85_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n52_), .b(new_n85_), .O(new_n159_));
