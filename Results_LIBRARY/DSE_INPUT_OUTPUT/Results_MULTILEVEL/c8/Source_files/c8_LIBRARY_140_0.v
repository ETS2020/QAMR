...
module FAU ( 
  ...
  nor2   g049(.a(new_n95_), .b(new_n56_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n85_), .b(new_n59_), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g058(.a(new_n97_), .b(new_n61_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g062(.a(x18), .b(new_n64_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n83_), .O(new_n110_));
  aoi21  g064(.a(new_n73_), .b(new_n72_), .c(x22), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n61_), .c(new_n56_), .d(new_n50_), .O(new_n112_));
  nand2  g066(.a(new_n104_), .b(x22), .O(new_n113_));
  oai21  g067(.a(new_n112_), .b(x17), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n88_), .O(z12));
  nand2  g070(.a(x18), .b(x04), .O(new_n117_));
  oai21  g071(.a(x18), .b(new_n69_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n83_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n56_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n97_), .c(new_n61_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n119_), .c(new_n88_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n85_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n83_), .O(new_n130_));
  nand2  g084(.a(new_n124_), .b(x24), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n120_), .c(new_n97_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n88_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n130_), .O(z14));
  nand2  g090(.a(x18), .b(x06), .O(new_n137_));
  nand3  g091(.a(new_n73_), .b(x14), .c(x13), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n103_), .d(new_n95_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n88_), .c(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n140_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  nand3  g101(.a(new_n73_), .b(x15), .c(x13), .O(new_n148_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n123_), .O(new_n153_));
  ...
  oai22  g112(.a(new_n158_), .b(new_n153_), .c(new_n51_), .d(new_n157_), .O(new_n159_));
