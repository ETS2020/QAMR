...
module FAU ( 
  ...
  nor2   g055(.a(new_n92_), .b(new_n59_), .O(new_n102_));
  nand3  g056(.a(new_n59_), .b(new_n53_), .c(new_n90_), .O(new_n103_));
  inv1   g057(.a(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n102_), .c(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n101_), .c(new_n49_), .O(z10));
  nand2  g060(.a(x18), .b(x02), .O(new_n107_));
  nand2  g061(.a(x26), .b(new_n47_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n64_), .c(new_n107_), .O(new_n109_));
  ...
  aoi21  g072(.a(new_n48_), .b(new_n47_), .c(x22), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n62_), .c(new_n59_), .d(new_n53_), .O(new_n120_));
  ...
  oai21  g079(.a(x18), .b(new_n74_), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n94_), .O(new_n127_));
  nand4  g081(.a(new_n92_), .b(new_n69_), .c(new_n62_), .d(new_n59_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n127_), .c(new_n49_), .O(z13));
  ...
  aoi21  g091(.a(new_n130_), .b(new_n104_), .c(new_n77_), .O(new_n138_));
  nand4  g092(.a(new_n77_), .b(new_n72_), .c(new_n69_), .d(new_n62_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n103_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n138_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n137_), .c(new_n49_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  oai21  g097(.a(new_n108_), .b(new_n84_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n94_), .O(new_n145_));
  nor2   g099(.a(x23), .b(x22), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n111_), .d(new_n92_), .O(new_n148_));
  oai21  g102(.a(new_n140_), .b(new_n82_), .c(new_n148_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n49_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n145_), .O(z15));
  inv1   g105(.a(x15), .O(new_n152_));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  oai21  g107(.a(new_n108_), .b(new_n152_), .c(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n94_), .O(new_n155_));
  nand2  g109(.a(new_n148_), .b(x26), .O(new_n156_));
  nor2   g110(.a(new_n47_), .b(x17), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n111_), .c(new_n53_), .O(new_n158_));
  ...
  aoi21  g121(.a(new_n167_), .b(new_n164_), .c(new_n94_), .O(z17));
endmodule
