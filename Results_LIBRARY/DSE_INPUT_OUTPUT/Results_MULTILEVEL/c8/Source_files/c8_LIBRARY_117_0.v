...
module FAU ( 
  ...
  oai21  g56(.a(new_n102_), .b(new_n86_), .c(new_n97_), .O(z11));
  ...
  aoi22  g65(.a(new_n111_), .b(new_n92_), .c(new_n106_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n86_), .c(new_n110_), .O(z13));
  oai21  g67(.a(new_n87_), .b(x05), .c(new_n86_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n92_), .c(new_n72_), .O(new_n115_));
