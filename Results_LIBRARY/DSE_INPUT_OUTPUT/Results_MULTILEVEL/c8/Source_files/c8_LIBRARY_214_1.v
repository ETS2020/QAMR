...
module FAU ( 
  ...
  oai21  g052(.a(x18), .b(x09), .c(new_n52_), .O(new_n99_));
  nor2   g053(.a(new_n94_), .b(new_n55_), .O(new_n100_));
  ...
  nand4  g060(.a(new_n63_), .b(new_n55_), .c(new_n47_), .d(new_n92_), .O(new_n107_));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n101_), .c(new_n78_), .O(new_n121_));
  ...
  nand2  g079(.a(new_n96_), .b(x13), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n125_), .O(z14));
  oai21  g081(.a(x18), .b(x14), .c(new_n52_), .O(new_n128_));
  nand4  g082(.a(new_n83_), .b(new_n78_), .c(new_n71_), .d(new_n68_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  aoi22  g084(.a(new_n130_), .b(new_n108_), .c(new_n123_), .d(x25), .O(new_n131_));
  ...
  nand4  g097(.a(new_n134_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n144_));
  nand3  g098(.a(new_n133_), .b(x19), .c(new_n92_), .O(new_n145_));
  oai22  g099(.a(new_n145_), .b(new_n144_), .c(new_n48_), .d(new_n92_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n53_), .O(z17));
endmodule
