...
module FAU ( 
  ...
  nand3  g051(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n98_));
  oai21  g052(.a(new_n97_), .b(new_n57_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n96_), .c(x16), .O(new_n100_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n97_), .c(new_n57_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n96_), .b(new_n85_), .c(x11), .O(new_n119_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n113_), .c(new_n105_), .O(new_n134_));
  ...
  nand3  g101(.a(new_n96_), .b(new_n85_), .c(x14), .O(new_n148_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n125_), .c(new_n107_), .d(new_n97_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n96_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  nand4  g112(.a(new_n125_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n159_));
  nand3  g113(.a(new_n107_), .b(x19), .c(new_n87_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n87_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n96_), .c(x16), .O(new_n162_));
