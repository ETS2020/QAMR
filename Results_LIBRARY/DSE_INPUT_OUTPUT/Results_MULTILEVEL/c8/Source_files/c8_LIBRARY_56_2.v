...
module FAU ( 
  ...
  oai21  g030(.a(x27), .b(new_n76_), .c(new_n47_), .O(new_n77_));
  nand3  g031(.a(new_n52_), .b(new_n76_), .c(x18), .O(new_n78_));
  ...
  oai21  g069(.a(new_n98_), .b(new_n65_), .c(new_n115_), .O(new_n116_));
  ...
  oai21  g078(.a(new_n98_), .b(new_n68_), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n86_), .O(z14));
  nand2  g096(.a(new_n139_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x23), .b(x22), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n110_), .d(new_n89_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n86_), .c(x16), .O(new_n148_));
  nand3  g102(.a(x18), .b(new_n91_), .c(x06), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n148_), .O(z15));
  ...
  nand4  g109(.a(new_n155_), .b(new_n144_), .c(new_n110_), .d(new_n89_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n144_), .b(new_n82_), .c(new_n76_), .d(new_n136_), .O(new_n160_));
  nand3  g114(.a(new_n110_), .b(x19), .c(new_n87_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n87_), .O(new_n162_));
