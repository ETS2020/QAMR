...
module FAU ( 
  ...
  nand3  g046(.a(new_n92_), .b(new_n79_), .c(x09), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n91_), .c(new_n48_), .O(z10));
  nand2  g048(.a(x18), .b(x02), .O(new_n95_));
  oai22  g049(.a(new_n95_), .b(x01), .c(x18), .d(new_n55_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n90_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  ...
  oai22  g058(.a(new_n104_), .b(x01), .c(x18), .d(new_n58_), .O(new_n105_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n48_), .O(z13));
  nand2  g075(.a(x18), .b(x05), .O(new_n122_));
  oai21  g076(.a(x18), .b(new_n67_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n79_), .O(new_n124_));
  inv1   g078(.a(x24), .O(new_n125_));
  aoi21  g079(.a(new_n117_), .b(new_n90_), .c(new_n125_), .O(new_n126_));
  ...
  oai22  g088(.a(new_n134_), .b(x01), .c(x18), .d(new_n70_), .O(new_n135_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n99_), .d(new_n88_), .O(new_n149_));
