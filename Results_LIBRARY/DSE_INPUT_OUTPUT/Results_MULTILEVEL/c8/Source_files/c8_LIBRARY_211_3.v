...
module FAU ( 
  ...
  nand3  g064(.a(new_n110_), .b(new_n96_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n106_), .O(z11));
  oai21  g066(.a(x16), .b(x03), .c(x18), .O(new_n113_));
  inv1   g067(.a(x22), .O(new_n114_));
  aoi21  g068(.a(new_n108_), .b(new_n98_), .c(new_n114_), .O(new_n115_));
  ...
  nor2   g073(.a(x18), .b(x16), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x11), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n119_), .c(new_n113_), .O(z12));
  ...
  aoi21  g086(.a(new_n127_), .b(new_n107_), .c(new_n71_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n116_), .c(new_n99_), .d(new_n87_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n120_), .b(x13), .O(new_n138_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n98_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n144_), .c(new_n108_), .d(new_n98_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand2  g109(.a(new_n120_), .b(x15), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(z16));
  nand4  g111(.a(new_n144_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n158_));
  nand3  g112(.a(new_n108_), .b(x19), .c(new_n87_), .O(new_n159_));
