...
module FAU ( 
  ...
  nand2  g006(.a(x02), .b(new_n52_), .O(new_n53_));
  ...
  nor2   g057(.a(new_n94_), .b(new_n56_), .O(new_n104_));
  ...
  oai21  g063(.a(new_n105_), .b(new_n61_), .c(new_n109_), .O(new_n110_));
  ...
  nand4  g068(.a(x18), .b(new_n96_), .c(x02), .d(x00), .O(new_n115_));
  oai21  g069(.a(new_n114_), .b(new_n54_), .c(new_n115_), .O(z11));
  nand2  g070(.a(x18), .b(x03), .O(new_n117_));
  nand2  g071(.a(new_n111_), .b(x11), .O(new_n118_));
  aoi22  g072(.a(new_n118_), .b(new_n117_), .c(x02), .d(new_n52_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n96_), .O(new_n120_));
  nand2  g074(.a(new_n109_), .b(x22), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n94_), .c(new_n56_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n53_), .c(x16), .O(new_n125_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n129_), .c(new_n53_), .O(z13));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n105_), .c(new_n78_), .O(new_n139_));
  nor2   g093(.a(x20), .b(x19), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n140_), .d(new_n92_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n139_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n53_), .O(z14));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n108_), .d(new_n94_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n148_), .c(new_n54_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  oai21  g110(.a(x18), .b(new_n86_), .c(new_n156_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n108_), .d(new_n94_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n158_), .c(new_n54_), .O(z16));
  nand2  g118(.a(new_n160_), .b(new_n150_), .O(new_n165_));
  nand3  g119(.a(new_n108_), .b(x19), .c(new_n92_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n50_), .d(new_n92_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n53_), .c(x16), .O(new_n168_));
