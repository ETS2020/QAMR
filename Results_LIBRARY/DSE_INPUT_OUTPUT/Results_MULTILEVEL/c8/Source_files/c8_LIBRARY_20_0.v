...
module FAU ( 
  ...
  nor2   g000(.a(x25), .b(x18), .O(new_n47_));
  ...
  aoi21  g024(.a(x27), .b(new_n70_), .c(new_n47_), .O(new_n71_));
  ...
  oai21  g029(.a(new_n51_), .b(x14), .c(new_n75_), .O(z06));
  ...
  nand2  g036(.a(x25), .b(new_n73_), .O(new_n83_));
  oai21  g037(.a(new_n83_), .b(new_n48_), .c(new_n82_), .O(new_n84_));
  nand2  g038(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  inv1   g039(.a(new_n47_), .O(new_n86_));
  ...
  oai21  g047(.a(new_n83_), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n81_), .O(new_n95_));
  inv1   g049(.a(x20), .O(new_n96_));
  inv1   g050(.a(x17), .O(new_n97_));
  nand3  g051(.a(new_n96_), .b(new_n50_), .c(new_n97_), .O(new_n98_));
  oai21  g052(.a(new_n88_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n86_), .c(x16), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n95_), .O(z10));
  nand2  g055(.a(x18), .b(x02), .O(new_n102_));
  oai21  g056(.a(x18), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g061(.a(new_n105_), .b(new_n59_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n86_), .O(z11));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n88_), .c(new_n64_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n88_), .c(new_n96_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n86_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  oai21  g074(.a(new_n83_), .b(new_n67_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  nand2  g076(.a(new_n116_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n105_), .c(new_n59_), .O(new_n125_));
  ...
  oai21  g083(.a(new_n83_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n81_), .O(new_n131_));
  inv1   g085(.a(x23), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n64_), .c(new_n59_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n98_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n97_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n86_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n131_), .O(z14));
  inv1   g094(.a(x14), .O(new_n141_));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  oai21  g096(.a(new_n83_), .b(new_n141_), .c(new_n142_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n81_), .O(new_n144_));
  nand2  g098(.a(new_n137_), .b(x25), .O(new_n145_));
  nor2   g099(.a(new_n73_), .b(x17), .O(new_n146_));
  nor3   g100(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n115_), .d(new_n135_), .O(new_n148_));
  ...
  oai21  g106(.a(x18), .b(new_n77_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n81_), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n81_), .c(x25), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n73_), .O(new_n157_));
  nor2   g111(.a(x25), .b(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n124_), .c(new_n106_), .d(new_n88_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n124_), .c(new_n106_), .d(new_n88_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n157_), .c(new_n154_), .O(z16));
  inv1   g119(.a(x24), .O(new_n166_));
  nand4  g120(.a(new_n124_), .b(new_n155_), .c(new_n74_), .d(new_n166_), .O(new_n167_));
  nand3  g121(.a(new_n106_), .b(x19), .c(new_n97_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n51_), .d(new_n97_), .O(new_n169_));
