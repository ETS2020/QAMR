...
module FAU ( 
  ...
  oai21  g058(.a(new_n95_), .b(new_n60_), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g063(.a(new_n103_), .b(new_n93_), .c(new_n109_), .O(new_n110_));
  ...
  nand2  g076(.a(new_n97_), .b(x04), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n122_), .c(new_n117_), .O(z13));
  oai21  g078(.a(x16), .b(x13), .c(new_n83_), .O(new_n125_));
  ...
  nand4  g083(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n85_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n97_), .b(x05), .O(new_n133_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n103_), .d(new_n93_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n139_), .c(new_n103_), .d(new_n93_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n97_), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nand2  g106(.a(new_n68_), .b(new_n109_), .O(new_n153_));
  inv1   g107(.a(x26), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n76_), .c(new_n126_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n85_), .O(new_n157_));
