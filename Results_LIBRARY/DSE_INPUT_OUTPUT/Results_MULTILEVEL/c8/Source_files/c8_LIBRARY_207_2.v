...
module FAU ( 
  ...
  nand3  g055(.a(new_n52_), .b(x09), .c(new_n94_), .O(new_n102_));
  ...
  nand2  g069(.a(new_n115_), .b(new_n105_), .O(new_n116_));
  ...
  nand4  g077(.a(new_n123_), .b(new_n63_), .c(new_n56_), .d(new_n49_), .O(new_n124_));
  ...
  oai21  g082(.a(new_n52_), .b(new_n92_), .c(x04), .O(new_n129_));
  nor2   g083(.a(x22), .b(x21), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n105_), .c(new_n56_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n107_), .c(new_n63_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(x16), .O(new_n136_));
  nand3  g090(.a(new_n52_), .b(new_n92_), .c(x12), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n136_), .c(new_n129_), .O(z13));
  nand2  g092(.a(x18), .b(x05), .O(new_n139_));
  nand3  g093(.a(new_n52_), .b(x13), .c(new_n94_), .O(new_n140_));
  ...
  nand3  g098(.a(new_n144_), .b(new_n130_), .c(new_n107_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n133_), .c(new_n115_), .d(new_n105_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n53_), .O(z15));
  nand2  g111(.a(x18), .b(x07), .O(new_n158_));
  nand3  g112(.a(new_n52_), .b(x15), .c(new_n94_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n133_), .b(new_n88_), .c(new_n83_), .d(new_n76_), .O(new_n163_));
  ...
  nand3  g121(.a(new_n115_), .b(x19), .c(new_n167_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n163_), .c(new_n50_), .d(new_n167_), .O(new_n169_));
