...
module FAU ( 
  ...
  nor2   g021(.a(x27), .b(new_n67_), .O(new_n68_));
  ...
  nand2  g047(.a(new_n67_), .b(x12), .O(new_n94_));
  ...
  oai21  g052(.a(new_n86_), .b(new_n53_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n86_), .c(new_n64_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n86_), .c(new_n53_), .O(new_n116_));
  ...
  nand3  g092(.a(new_n67_), .b(x14), .c(x12), .O(new_n139_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n86_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n106_), .d(new_n86_), .O(new_n154_));
  ...
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n54_), .d(new_n83_), .O(new_n161_));
