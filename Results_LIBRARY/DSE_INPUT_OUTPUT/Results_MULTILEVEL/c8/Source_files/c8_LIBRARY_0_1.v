...
module FAU ( 
  ...
  nand2  g016(.a(new_n57_), .b(new_n62_), .O(new_n63_));
  aoi21  g017(.a(new_n63_), .b(new_n61_), .c(new_n51_), .O(z03));
  inv1   g018(.a(x12), .O(new_n65_));
  aoi21  g019(.a(x27), .b(new_n65_), .c(new_n51_), .O(new_n66_));
  ...
  nand2  g027(.a(new_n57_), .b(new_n73_), .O(new_n74_));
  aoi21  g028(.a(new_n74_), .b(new_n72_), .c(new_n51_), .O(z06));
  inv1   g029(.a(x15), .O(new_n76_));
  aoi21  g030(.a(x27), .b(new_n76_), .c(new_n51_), .O(new_n77_));
  oai21  g031(.a(x27), .b(x26), .c(new_n77_), .O(z07));
  nor2   g032(.a(new_n51_), .b(new_n57_), .O(z08));
  inv1   g033(.a(x16), .O(new_n80_));
  xor2a  g034(.a(x19), .b(x17), .O(new_n81_));
  inv1   g035(.a(x08), .O(new_n82_));
  nand2  g036(.a(x18), .b(x00), .O(new_n83_));
  oai21  g037(.a(x18), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  aoi21  g038(.a(new_n84_), .b(new_n80_), .c(new_n51_), .O(new_n85_));
  oai21  g039(.a(new_n81_), .b(new_n80_), .c(new_n85_), .O(z09));
  ...
  oai21  g054(.a(new_n56_), .b(new_n80_), .c(x18), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(x19), .O(new_n102_));
  nor2   g056(.a(x20), .b(x17), .O(new_n103_));
  nor2   g057(.a(x21), .b(x20), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n47_), .c(new_n93_), .O(new_n105_));
  oai21  g059(.a(new_n103_), .b(new_n56_), .c(new_n105_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(x16), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n100_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  inv1   g063(.a(x18), .O(new_n110_));
  nand2  g064(.a(new_n47_), .b(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n60_), .c(new_n109_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n80_), .O(new_n113_));
  nor3   g067(.a(x21), .b(x20), .c(x17), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n103_), .O(new_n116_));
  oai21  g070(.a(new_n114_), .b(new_n62_), .c(new_n116_), .O(new_n117_));
  nor2   g071(.a(new_n62_), .b(new_n47_), .O(new_n118_));
  aoi22  g072(.a(new_n118_), .b(x18), .c(new_n117_), .d(new_n47_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n80_), .c(new_n113_), .O(z12));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  oai21  g075(.a(x18), .b(new_n65_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n80_), .O(new_n123_));
  inv1   g077(.a(x23), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n80_), .c(x18), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x19), .O(new_n126_));
  aoi21  g080(.a(new_n115_), .b(new_n103_), .c(new_n124_), .O(new_n127_));
  inv1   g081(.a(new_n95_), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n56_), .O(new_n130_));
  ...
  oai21  g088(.a(x18), .b(new_n68_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n80_), .O(new_n136_));
  inv1   g090(.a(x24), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n80_), .c(x18), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x19), .O(new_n139_));
  nand3  g093(.a(new_n129_), .b(new_n103_), .c(new_n56_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x24), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n115_), .c(new_n95_), .O(new_n143_));
  ...
  oai21  g101(.a(x18), .b(new_n71_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n80_), .O(new_n149_));
  oai21  g103(.a(new_n73_), .b(new_n80_), .c(x18), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x19), .O(new_n151_));
  nor3   g105(.a(x24), .b(x23), .c(x22), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n114_), .c(new_n73_), .O(new_n153_));
  nor2   g107(.a(x25), .b(x24), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n129_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n105_), .O(new_n156_));
  ...
  oai21  g113(.a(new_n111_), .b(new_n76_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n80_), .O(new_n161_));
  nand4  g115(.a(new_n154_), .b(new_n129_), .c(new_n104_), .d(new_n93_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x26), .O(new_n163_));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n142_), .c(new_n115_), .d(new_n103_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n163_), .c(x19), .O(new_n166_));
  nand3  g120(.a(x26), .b(x19), .c(x18), .O(new_n167_));
  ...
  nand3  g125(.a(new_n104_), .b(x19), .c(new_n93_), .O(new_n172_));
  nand3  g126(.a(new_n164_), .b(new_n129_), .c(new_n137_), .O(new_n173_));
  oai22  g127(.a(new_n173_), .b(new_n172_), .c(new_n57_), .d(new_n93_), .O(new_n174_));
