...
module FAU ( 
  ...
  oai21  g043(.a(x18), .b(x08), .c(new_n89_), .O(new_n90_));
  nand3  g044(.a(new_n90_), .b(new_n88_), .c(new_n82_), .O(z09));
  nand3  g045(.a(x18), .b(x01), .c(x00), .O(new_n92_));
  oai21  g046(.a(x18), .b(new_n52_), .c(new_n92_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  nand3  g048(.a(new_n54_), .b(new_n85_), .c(new_n84_), .O(new_n95_));
  oai21  g049(.a(new_n87_), .b(new_n54_), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n82_), .c(x16), .O(new_n97_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n101_), .c(new_n82_), .O(z11));
  ...
  aoi21  g065(.a(new_n104_), .b(new_n87_), .c(new_n63_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n87_), .c(new_n54_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n82_), .O(z12));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n82_), .O(z13));
  nand3  g080(.a(x18), .b(x05), .c(x00), .O(new_n127_));
  oai21  g081(.a(x18), .b(new_n71_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n89_), .O(new_n129_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n113_), .c(new_n132_), .d(new_n84_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n82_), .c(x16), .O(new_n136_));
  ...
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n84_), .O(new_n160_));
