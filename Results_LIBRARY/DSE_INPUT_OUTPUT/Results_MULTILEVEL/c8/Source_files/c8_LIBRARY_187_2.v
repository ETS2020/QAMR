...
module FAU ( 
  ...
  oai21  g052(.a(new_n92_), .b(new_n62_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x16), .O(new_n100_));
  nand2  g054(.a(new_n87_), .b(x02), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z11));
  oai21  g056(.a(x16), .b(x11), .c(new_n81_), .O(new_n103_));
  inv1   g057(.a(x22), .O(new_n104_));
  aoi21  g058(.a(new_n97_), .b(new_n85_), .c(new_n104_), .O(new_n105_));
  nor2   g059(.a(x22), .b(x21), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n85_), .c(new_n57_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n105_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n87_), .b(x03), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n109_), .c(new_n103_), .O(z12));
  nand2  g065(.a(x18), .b(x04), .O(new_n112_));
  oai21  g066(.a(x18), .b(new_n68_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g068(.a(new_n107_), .b(x23), .O(new_n115_));
  nor2   g069(.a(x23), .b(x22), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n92_), .c(new_n62_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(x18), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z13));
  nand2  g074(.a(x18), .b(x05), .O(new_n121_));
  oai21  g075(.a(x18), .b(new_n71_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand3  g077(.a(new_n57_), .b(new_n51_), .c(new_n83_), .O(new_n124_));
  inv1   g078(.a(x23), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n104_), .c(new_n62_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n124_), .c(x24), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n106_), .c(new_n128_), .d(new_n83_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(x18), .c(x16), .O(new_n132_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n97_), .d(new_n85_), .O(new_n139_));
  ...
  nand2  g097(.a(new_n139_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n116_), .c(new_n97_), .d(new_n85_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n87_), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  inv1   g104(.a(x24), .O(new_n151_));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n116_), .c(new_n151_), .O(new_n153_));
  nand3  g107(.a(new_n97_), .b(x19), .c(new_n83_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n52_), .d(new_n83_), .O(new_n155_));
