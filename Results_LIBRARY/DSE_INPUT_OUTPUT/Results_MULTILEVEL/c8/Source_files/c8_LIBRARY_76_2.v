...
module FAU ( 
  ...
  nand4  g086(.a(new_n132_), .b(new_n113_), .c(new_n95_), .d(new_n85_), .O(new_n133_));
  ...
  nand2  g098(.a(new_n117_), .b(x06), .O(new_n145_));
