...
module FAU ( 
  ...
  nor2   g45(.a(new_n86_), .b(new_n56_), .O(new_n92_));
  ...
  oai21  g58(.a(new_n103_), .b(new_n97_), .c(new_n104_), .O(z11));
  oai21  g59(.a(new_n88_), .b(x03), .c(new_n97_), .O(new_n106_));
  nand2  g60(.a(new_n101_), .b(x22), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n86_), .c(new_n56_), .O(new_n109_));
  and2   g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n97_), .c(new_n106_), .O(z12));
  nor3   g65(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n93_), .c(new_n109_), .d(x23), .O(new_n113_));
  nand2  g67(.a(new_n89_), .b(x04), .O(new_n114_));
  oai21  g68(.a(new_n113_), .b(new_n97_), .c(new_n114_), .O(z13));
  aoi21  g69(.a(new_n112_), .b(new_n93_), .c(new_n70_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n98_), .d(new_n84_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n89_), .b(x05), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  oai21  g76(.a(new_n88_), .b(x06), .c(new_n97_), .O(new_n123_));
  inv1   g77(.a(x22), .O(new_n124_));
  inv1   g78(.a(x23), .O(new_n125_));
  nand4  g79(.a(new_n75_), .b(new_n70_), .c(new_n125_), .d(new_n124_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n102_), .c(new_n118_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n97_), .c(new_n123_), .O(z15));
  ...
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n97_), .O(z17));
endmodule
