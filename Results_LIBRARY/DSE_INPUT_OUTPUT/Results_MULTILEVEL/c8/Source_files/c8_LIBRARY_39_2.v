...
module FAU ( 
  ...
  nor2   g030(.a(new_n48_), .b(new_n52_), .O(z08));
  nor2   g031(.a(x18), .b(x09), .O(new_n78_));
  ...
  oai21  g036(.a(new_n79_), .b(x16), .c(new_n82_), .O(z09));
  nor2   g037(.a(x19), .b(x17), .O(new_n84_));
  nor2   g038(.a(new_n84_), .b(new_n55_), .O(new_n85_));
  nor3   g039(.a(x20), .b(x19), .c(x17), .O(new_n86_));
  oai21  g040(.a(new_n86_), .b(new_n85_), .c(x16), .O(new_n87_));
  inv1   g041(.a(x18), .O(new_n88_));
  nor2   g042(.a(new_n88_), .b(x16), .O(new_n89_));
  aoi21  g043(.a(new_n89_), .b(x01), .c(new_n48_), .O(new_n90_));
  nand2  g044(.a(new_n90_), .b(new_n87_), .O(z10));
  inv1   g045(.a(x16), .O(new_n92_));
  nand2  g046(.a(x18), .b(x02), .O(new_n93_));
  oai21  g047(.a(x18), .b(new_n59_), .c(new_n93_), .O(new_n94_));
  ...
  oai21  g052(.a(new_n86_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n95_), .c(new_n80_), .O(z11));
  nand2  g055(.a(x18), .b(x03), .O(new_n102_));
  nand3  g056(.a(new_n88_), .b(x11), .c(new_n47_), .O(new_n103_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n84_), .c(new_n55_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n80_), .c(x16), .O(new_n110_));
  ...
  nand3  g091(.a(new_n88_), .b(x14), .c(new_n47_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n116_), .c(new_n97_), .d(new_n84_), .O(new_n143_));
  ...
  nand2  g102(.a(new_n148_), .b(new_n92_), .O(new_n149_));
  nand2  g103(.a(new_n143_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n116_), .c(new_n97_), .d(new_n84_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n116_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n97_), .b(x19), .c(new_n125_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n125_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n80_), .O(z17));
endmodule
