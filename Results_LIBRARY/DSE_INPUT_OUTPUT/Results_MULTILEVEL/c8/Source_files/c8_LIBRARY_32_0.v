...
module FAU ( 
  ...
  nand3  g039(.a(new_n85_), .b(new_n83_), .c(x00), .O(new_n86_));
  ...
  nand3  g045(.a(new_n91_), .b(new_n86_), .c(new_n81_), .O(z09));
  nand2  g046(.a(x18), .b(x01), .O(new_n93_));
  nand3  g047(.a(new_n84_), .b(x09), .c(x00), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  nand3  g050(.a(new_n53_), .b(new_n88_), .c(new_n87_), .O(new_n97_));
  oai21  g051(.a(new_n90_), .b(new_n53_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n103_), .c(new_n81_), .O(z11));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n90_), .c(new_n62_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n90_), .c(new_n53_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n81_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  oai21  g074(.a(x18), .b(new_n65_), .c(new_n120_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n81_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  nand3  g083(.a(new_n84_), .b(x13), .c(x00), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n83_), .O(new_n132_));
  nand3  g086(.a(new_n67_), .b(new_n62_), .c(new_n104_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n97_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n106_), .d(new_n90_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n81_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n106_), .d(new_n90_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n81_), .O(z16));
  inv1   g112(.a(x24), .O(new_n159_));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n124_), .c(new_n159_), .O(new_n161_));
  nand3  g115(.a(new_n106_), .b(x19), .c(new_n87_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n54_), .d(new_n87_), .O(new_n163_));
