...
module FAU ( 
  ...
  nand2  g038(.a(x18), .b(new_n63_), .O(new_n85_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n47_), .O(z11));
  nand3  g061(.a(x18), .b(new_n63_), .c(x03), .O(new_n108_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n47_), .O(z13));
  ...
  nand3  g083(.a(new_n94_), .b(new_n51_), .c(new_n129_), .O(new_n130_));
  inv1   g084(.a(x23), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n64_), .c(new_n60_), .O(new_n132_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n121_), .c(new_n103_), .d(new_n95_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n47_), .O(z15));
  ...
  nand4  g107(.a(new_n153_), .b(new_n121_), .c(new_n103_), .d(new_n95_), .O(new_n154_));
