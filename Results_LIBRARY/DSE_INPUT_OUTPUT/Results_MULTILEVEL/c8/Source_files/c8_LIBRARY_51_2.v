...
module FAU ( 
  ...
  nor2   g032(.a(x18), .b(x13), .O(new_n79_));
  ...
  oai21  g039(.a(x18), .b(new_n55_), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n87_), .c(new_n77_), .O(z10));
  ...
  nand2  g056(.a(new_n79_), .b(x11), .O(new_n103_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n89_), .c(new_n88_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n77_), .c(x16), .O(new_n110_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n77_), .O(z13));
  inv1   g074(.a(x24), .O(new_n121_));
  aoi21  g075(.a(new_n116_), .b(new_n91_), .c(new_n121_), .O(new_n122_));
  ...
  nor2   g083(.a(new_n129_), .b(x16), .O(new_n130_));
  aoi21  g084(.a(new_n130_), .b(x05), .c(new_n48_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n128_), .O(z14));
  nand2  g086(.a(x18), .b(x06), .O(new_n133_));
  nand3  g087(.a(new_n129_), .b(x14), .c(new_n47_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n84_), .O(new_n136_));
  nand2  g090(.a(new_n126_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n97_), .d(new_n89_), .O(new_n140_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n97_), .d(new_n89_), .O(new_n149_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n138_), .c(new_n121_), .O(new_n154_));
  nand3  g108(.a(new_n97_), .b(x19), .c(new_n123_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n123_), .O(new_n156_));
