...
module FAU ( 
  ...
  nand3  g016(.a(new_n62_), .b(x27), .c(new_n61_), .O(new_n63_));
  inv1   g017(.a(x21), .O(new_n64_));
  nand3  g018(.a(new_n48_), .b(new_n53_), .c(new_n64_), .O(new_n65_));
  nand2  g019(.a(new_n65_), .b(new_n63_), .O(z02));
  nor2   g020(.a(x27), .b(x22), .O(new_n67_));
  aoi21  g021(.a(x27), .b(new_n47_), .c(new_n67_), .O(new_n68_));
  nand2  g022(.a(new_n67_), .b(x11), .O(new_n69_));
  oai21  g023(.a(new_n68_), .b(x18), .c(new_n69_), .O(z03));
  ...
  nand2  g047(.a(x18), .b(x11), .O(new_n94_));
  ...
  oai22  g057(.a(new_n94_), .b(new_n103_), .c(x18), .d(new_n56_), .O(new_n104_));
  ...
  oai21  g062(.a(new_n98_), .b(new_n58_), .c(new_n108_), .O(new_n109_));
  ...
  oai21  g075(.a(x18), .b(new_n47_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n92_), .O(new_n123_));
  inv1   g077(.a(x22), .O(new_n124_));
  aoi21  g078(.a(new_n116_), .b(new_n98_), .c(new_n124_), .O(new_n125_));
  nor2   g079(.a(x22), .b(x21), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n98_), .c(new_n58_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n125_), .c(x16), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n123_), .c(new_n48_), .O(z12));
  inv1   g084(.a(x04), .O(new_n131_));
  oai22  g085(.a(new_n94_), .b(new_n131_), .c(x18), .d(new_n73_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n92_), .O(new_n133_));
  nand2  g087(.a(new_n127_), .b(x23), .O(new_n134_));
  nor3   g088(.a(x23), .b(x22), .c(x21), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n115_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n48_), .c(x16), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n133_), .O(z13));
  ...
  aoi21  g096(.a(new_n135_), .b(new_n115_), .c(new_n76_), .O(new_n143_));
  nor2   g097(.a(x24), .b(x23), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n126_), .c(new_n107_), .d(new_n106_), .O(new_n145_));
  inv1   g099(.a(new_n145_), .O(new_n146_));
  oai21  g100(.a(new_n146_), .b(new_n143_), .c(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n48_), .O(z14));
  inv1   g102(.a(x06), .O(new_n149_));
  oai22  g103(.a(new_n94_), .b(new_n149_), .c(x18), .d(new_n81_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n153_), .c(new_n116_), .d(new_n98_), .O(new_n155_));
  ...
  nand4  g117(.a(new_n163_), .b(new_n153_), .c(new_n116_), .d(new_n98_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n161_), .c(new_n48_), .O(z16));
  nand4  g121(.a(new_n153_), .b(new_n88_), .c(new_n83_), .d(new_n76_), .O(new_n168_));
  nand3  g122(.a(new_n116_), .b(x19), .c(new_n106_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n168_), .c(new_n53_), .d(new_n106_), .O(new_n170_));
