...
module FAU ( 
  ...
  nand4  g53(.a(new_n59_), .b(new_n93_), .c(new_n50_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  nor2   g56(.a(new_n89_), .b(x16), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x02), .O(new_n104_));
  oai21  g58(.a(new_n102_), .b(new_n88_), .c(new_n104_), .O(z11));
  ...
  oai21  g64(.a(new_n109_), .b(new_n88_), .c(new_n110_), .O(z12));
  ...
  nand2  g75(.a(new_n103_), .b(x05), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n121_), .O(z14));
  oai21  g77(.a(new_n89_), .b(x06), .c(new_n88_), .O(new_n124_));
  inv1   g78(.a(x23), .O(new_n125_));
  nand4  g79(.a(new_n75_), .b(new_n116_), .c(new_n125_), .d(new_n64_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n101_), .c(new_n119_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n88_), .c(new_n124_), .O(z15));
  ...
  nand2  g92(.a(new_n103_), .b(x07), .O(new_n139_));
