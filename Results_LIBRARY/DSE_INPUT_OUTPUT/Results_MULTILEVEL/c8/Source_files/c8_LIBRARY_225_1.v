...
module FAU ( 
  ...
  nand2  g032(.a(new_n53_), .b(new_n77_), .O(new_n79_));
  nand3  g033(.a(new_n79_), .b(new_n78_), .c(new_n48_), .O(z05));
  ...
  nand2  g062(.a(new_n77_), .b(new_n47_), .O(new_n109_));
  ...
  oai21  g071(.a(new_n109_), .b(new_n68_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n96_), .O(new_n119_));
  inv1   g073(.a(new_n94_), .O(new_n120_));
  nand2  g074(.a(new_n113_), .b(x22), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n56_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(new_n121_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n48_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n119_), .O(z12));
  nand2  g080(.a(x18), .b(x04), .O(new_n127_));
  oai21  g081(.a(new_n109_), .b(new_n71_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n96_), .O(new_n129_));
  oai21  g083(.a(new_n123_), .b(new_n120_), .c(x23), .O(new_n130_));
  ...
  oai21  g090(.a(new_n109_), .b(new_n76_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n96_), .O(new_n138_));
  nand3  g092(.a(new_n132_), .b(x24), .c(x18), .O(new_n139_));
  nand4  g093(.a(new_n122_), .b(new_n105_), .c(new_n77_), .d(new_n73_), .O(new_n140_));
  ...
  oai21  g100(.a(new_n81_), .b(new_n96_), .c(x18), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x24), .O(new_n148_));
  aoi21  g102(.a(new_n131_), .b(new_n105_), .c(new_n81_), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n81_), .c(new_n77_), .O(new_n151_));
  nor2   g105(.a(new_n151_), .b(new_n113_), .O(new_n152_));
  ...
  oai21  g109(.a(new_n109_), .b(new_n86_), .c(new_n155_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n96_), .O(new_n157_));
  nor2   g111(.a(x20), .b(x19), .O(new_n158_));
  nor2   g112(.a(x25), .b(x23), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n122_), .c(new_n158_), .d(new_n92_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x26), .O(new_n161_));
  nor2   g115(.a(x26), .b(x25), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n150_), .c(new_n112_), .d(new_n94_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n161_), .c(x24), .O(new_n164_));
  nand3  g118(.a(x26), .b(x24), .c(x18), .O(new_n165_));
  inv1   g119(.a(new_n165_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n164_), .c(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n157_), .O(z16));
  nand3  g122(.a(new_n112_), .b(x19), .c(new_n92_), .O(new_n169_));
  nand3  g123(.a(new_n162_), .b(new_n150_), .c(new_n77_), .O(new_n170_));
