...
module FAU ( 
  ...
  oai21  g55(.a(new_n101_), .b(new_n87_), .c(new_n95_), .O(z11));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n85_), .c(new_n99_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n87_), .c(new_n93_), .d(new_n63_), .O(z12));
  ...
  nand4  g75(.a(new_n76_), .b(new_n113_), .c(new_n68_), .d(new_n121_), .O(new_n122_));
