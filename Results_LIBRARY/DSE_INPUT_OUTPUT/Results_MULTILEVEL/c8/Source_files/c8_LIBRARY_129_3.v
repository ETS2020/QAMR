...
module FAU ( 
  ...
  nor2   g048(.a(x18), .b(x16), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(x09), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n94_), .c(new_n89_), .O(z10));
  ...
  nand2  g056(.a(new_n95_), .b(x10), .O(new_n103_));
  ...
  nand2  g062(.a(new_n100_), .b(x22), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n91_), .c(new_n90_), .O(new_n111_));
  ...
  nand2  g095(.a(new_n95_), .b(x14), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n99_), .d(new_n91_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n108_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n137_), .c(new_n125_), .O(new_n154_));
