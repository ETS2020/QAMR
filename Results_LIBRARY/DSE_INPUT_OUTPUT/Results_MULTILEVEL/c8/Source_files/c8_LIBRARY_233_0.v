...
module FAU ( 
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n86_), .O(z09));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  inv1   g049(.a(x18), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(x09), .c(x07), .O(new_n97_));
  ...
  oai21  g056(.a(new_n88_), .b(new_n53_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g060(.a(new_n96_), .b(x10), .c(x07), .O(new_n107_));
  ...
  nand3  g070(.a(new_n96_), .b(x11), .c(x07), .O(new_n117_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n88_), .c(new_n53_), .O(new_n122_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n121_), .c(new_n101_), .d(new_n100_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n138_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n86_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(x18), .b(new_n77_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n90_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n111_), .d(new_n88_), .O(new_n150_));
  ...
  nand2  g107(.a(new_n96_), .b(new_n82_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n90_), .c(x07), .O(new_n155_));
  nand2  g109(.a(new_n150_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n148_), .c(new_n111_), .d(new_n88_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n148_), .c(new_n74_), .O(new_n163_));
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n100_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n54_), .d(new_n100_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n86_), .O(z17));
endmodule
