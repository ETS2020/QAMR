...
module FAU ( 
  ...
  oai21  g058(.a(new_n93_), .b(new_n57_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n91_), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n101_), .O(z10));
  oai21  g061(.a(new_n87_), .b(new_n85_), .c(x02), .O(new_n108_));
  ...
  nand3  g067(.a(new_n87_), .b(new_n85_), .c(x10), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n113_), .c(new_n108_), .O(z11));
  ...
  aoi21  g072(.a(new_n110_), .b(new_n93_), .c(new_n67_), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n91_), .O(z12));
  nand2  g078(.a(x18), .b(x04), .O(new_n125_));
  nand3  g079(.a(new_n87_), .b(x12), .c(new_n52_), .O(new_n126_));
  ...
  aoi21  g092(.a(new_n130_), .b(new_n109_), .c(new_n138_), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n103_), .d(new_n102_), .O(new_n141_));
  ...
  nand3  g099(.a(new_n87_), .b(x14), .c(new_n52_), .O(new_n146_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n110_), .d(new_n93_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n91_), .c(x16), .O(new_n154_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n110_), .d(new_n93_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n91_), .O(z16));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n150_), .c(new_n138_), .O(new_n166_));
  nand3  g120(.a(new_n110_), .b(x19), .c(new_n102_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n50_), .d(new_n102_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n91_), .c(x16), .O(new_n169_));
