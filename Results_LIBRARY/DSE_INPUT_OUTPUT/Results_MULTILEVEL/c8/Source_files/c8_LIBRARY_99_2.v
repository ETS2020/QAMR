...
module FAU ( 
  ...
  nand3  g037(.a(new_n79_), .b(new_n47_), .c(x08), .O(new_n84_));
  oai21  g038(.a(new_n83_), .b(new_n79_), .c(new_n84_), .O(z09));
  oai21  g039(.a(x16), .b(x09), .c(new_n79_), .O(new_n86_));
  ...
  nor2   g045(.a(new_n79_), .b(x16), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(x01), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n91_), .c(new_n86_), .O(z10));
  oai21  g048(.a(x16), .b(x10), .c(new_n79_), .O(new_n95_));
  ...
  nand2  g054(.a(new_n92_), .b(x02), .O(new_n101_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n88_), .c(new_n87_), .O(new_n108_));
  ...
  oai21  g065(.a(x16), .b(x12), .c(new_n79_), .O(new_n112_));
  ...
  nand2  g081(.a(new_n92_), .b(x05), .O(new_n128_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n132_), .c(new_n97_), .d(new_n88_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g090(.a(new_n92_), .b(x06), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n132_), .c(new_n97_), .d(new_n88_), .O(new_n144_));
  ...
  nand3  g103(.a(new_n97_), .b(x19), .c(new_n122_), .O(new_n150_));
