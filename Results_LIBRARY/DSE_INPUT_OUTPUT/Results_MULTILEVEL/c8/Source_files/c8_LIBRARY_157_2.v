...
module FAU ( 
  ...
  oai21  g033(.a(x27), .b(new_n79_), .c(new_n47_), .O(new_n80_));
  nand3  g034(.a(new_n52_), .b(new_n79_), .c(x18), .O(new_n81_));
  nand2  g035(.a(new_n81_), .b(new_n80_), .O(z07));
  ...
  nand3  g053(.a(new_n99_), .b(new_n96_), .c(new_n84_), .O(z10));
  ...
  oai21  g097(.a(new_n112_), .b(new_n76_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n89_), .O(new_n145_));
  nand2  g099(.a(new_n139_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n105_), .d(new_n87_), .O(new_n148_));
  ...
  nand2  g105(.a(new_n148_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n125_), .c(new_n105_), .d(new_n87_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n84_), .c(x16), .O(new_n156_));
  nand3  g110(.a(x18), .b(new_n89_), .c(x07), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n156_), .O(z16));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n125_), .c(new_n73_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n85_), .O(new_n161_));
