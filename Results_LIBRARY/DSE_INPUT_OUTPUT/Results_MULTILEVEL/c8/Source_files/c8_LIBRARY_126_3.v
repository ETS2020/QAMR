...
module FAU ( 
  ...
  nand2  g005(.a(x18), .b(x00), .O(new_n52_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n91_), .c(new_n52_), .O(z10));
  nand2  g051(.a(x18), .b(x02), .O(new_n98_));
  oai22  g052(.a(new_n98_), .b(x00), .c(x18), .d(new_n58_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n85_), .O(new_n100_));
  inv1   g054(.a(x17), .O(new_n101_));
  nand4  g055(.a(new_n60_), .b(new_n92_), .c(new_n49_), .d(new_n101_), .O(new_n102_));
  ...
  aoi21  g062(.a(x18), .b(x00), .c(x22), .O(new_n109_));
  nand4  g063(.a(new_n109_), .b(new_n60_), .c(new_n92_), .d(new_n49_), .O(new_n110_));
  nand2  g064(.a(new_n102_), .b(x22), .O(new_n111_));
  oai21  g065(.a(new_n110_), .b(x17), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n108_), .c(new_n52_), .O(z12));
  ...
  aoi21  g083(.a(new_n121_), .b(new_n95_), .c(new_n129_), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n118_), .c(new_n131_), .d(new_n101_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n130_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n128_), .c(new_n52_), .O(z14));
  ...
  nor2   g094(.a(x21), .b(x20), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n93_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n139_), .c(new_n52_), .O(z15));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n141_), .d(new_n93_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n52_), .O(z16));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n142_), .c(new_n129_), .O(new_n158_));
  nand3  g112(.a(new_n141_), .b(x19), .c(new_n101_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n50_), .d(new_n101_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n52_), .O(z17));
endmodule
