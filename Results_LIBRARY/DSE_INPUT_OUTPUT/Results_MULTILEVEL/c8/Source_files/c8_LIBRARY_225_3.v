...
module FAU ( 
  ...
  nand2  g025(.a(new_n52_), .b(new_n70_), .O(new_n72_));
  nand3  g026(.a(new_n72_), .b(new_n71_), .c(new_n47_), .O(z05));
  ...
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n47_), .O(z10));
  inv1   g053(.a(x02), .O(new_n100_));
  nand2  g054(.a(new_n70_), .b(x18), .O(new_n101_));
  ...
  oai22  g083(.a(new_n101_), .b(new_n129_), .c(x18), .d(new_n69_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n87_), .O(new_n131_));
  inv1   g085(.a(x18), .O(new_n132_));
  nand3  g086(.a(new_n125_), .b(x24), .c(new_n132_), .O(new_n133_));
  nand4  g087(.a(new_n115_), .b(new_n97_), .c(new_n70_), .d(new_n66_), .O(new_n134_));
  ...
  oai21  g095(.a(new_n141_), .b(new_n87_), .c(new_n132_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x24), .O(new_n143_));
  aoi21  g097(.a(new_n124_), .b(new_n97_), .c(new_n141_), .O(new_n144_));
  nor2   g098(.a(x23), .b(x22), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n141_), .c(new_n70_), .O(new_n146_));
  nor2   g100(.a(new_n146_), .b(new_n106_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n144_), .c(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n140_), .O(z15));
  inv1   g103(.a(x07), .O(new_n150_));
  oai22  g104(.a(new_n101_), .b(new_n150_), .c(x18), .d(new_n77_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n87_), .O(new_n152_));
  nor2   g106(.a(x20), .b(x19), .O(new_n153_));
  nor2   g107(.a(x25), .b(x23), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n115_), .c(new_n153_), .d(new_n83_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x26), .O(new_n156_));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n145_), .c(new_n105_), .d(new_n85_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n156_), .c(x24), .O(new_n159_));
  nor3   g113(.a(new_n79_), .b(new_n70_), .c(x18), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n159_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n152_), .O(z16));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n83_), .O(new_n163_));
  nand3  g117(.a(new_n157_), .b(new_n145_), .c(new_n70_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n83_), .O(new_n165_));
