...
module FAU ( 
  ...
  nand2  g058(.a(new_n85_), .b(x10), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n104_), .c(new_n98_), .O(z11));
  oai21  g060(.a(x16), .b(x03), .c(x18), .O(new_n107_));
  aoi21  g061(.a(new_n101_), .b(new_n83_), .c(new_n63_), .O(new_n108_));
  ...
  nand2  g066(.a(new_n85_), .b(x11), .O(new_n113_));
  ...
  nand2  g074(.a(new_n85_), .b(x12), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(z13));
  oai21  g076(.a(x16), .b(x05), .c(x18), .O(new_n123_));
  inv1   g077(.a(x24), .O(new_n124_));
  aoi21  g078(.a(new_n117_), .b(new_n100_), .c(new_n124_), .O(new_n125_));
  nor2   g079(.a(x24), .b(x23), .O(new_n126_));
  nand4  g080(.a(new_n126_), .b(new_n109_), .c(new_n93_), .d(new_n80_), .O(new_n127_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n101_), .d(new_n83_), .O(new_n136_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n134_), .c(new_n101_), .d(new_n83_), .O(new_n144_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n124_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand3  g108(.a(new_n101_), .b(x19), .c(new_n80_), .O(new_n155_));
  inv1   g109(.a(new_n155_), .O(new_n156_));
  nor2   g110(.a(new_n55_), .b(new_n80_), .O(new_n157_));
  aoi21  g111(.a(new_n156_), .b(new_n154_), .c(new_n157_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n92_), .c(new_n88_), .O(z17));
endmodule
