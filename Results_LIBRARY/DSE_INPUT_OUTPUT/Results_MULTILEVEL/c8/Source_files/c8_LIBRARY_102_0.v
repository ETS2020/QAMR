...
module FAU ( 
  ...
  nand4  g52(.a(new_n59_), .b(new_n90_), .c(new_n50_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  nand2  g55(.a(new_n94_), .b(x02), .O(new_n102_));
  ...
  nand2  g61(.a(new_n94_), .b(x03), .O(new_n108_));
  ...
  nand2  g65(.a(new_n94_), .b(x04), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n86_), .c(new_n112_), .O(z13));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n97_), .d(new_n82_), .O(new_n117_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n114_), .c(new_n67_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n86_), .c(new_n122_), .O(z15));
  oai21  g82(.a(new_n87_), .b(x07), .c(new_n86_), .O(new_n129_));
