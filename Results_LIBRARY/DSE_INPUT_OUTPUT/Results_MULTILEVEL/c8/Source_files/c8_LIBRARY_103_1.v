...
module FAU ( 
  ...
  nand2  g055(.a(new_n82_), .b(new_n52_), .O(new_n102_));
  ...
  oai21  g072(.a(new_n102_), .b(new_n66_), .c(new_n118_), .O(new_n119_));
  ...
  nand3  g103(.a(new_n131_), .b(new_n82_), .c(new_n78_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n114_), .c(new_n149_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n148_), .c(new_n53_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai21  g108(.a(new_n102_), .b(new_n88_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n96_), .O(new_n156_));
  nand2  g110(.a(new_n142_), .b(x26), .O(new_n157_));
  nor2   g111(.a(x26), .b(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n131_), .c(new_n113_), .d(new_n94_), .O(new_n159_));
  ...
  nand3  g118(.a(new_n113_), .b(x19), .c(new_n92_), .O(new_n165_));
  nand4  g119(.a(new_n131_), .b(new_n86_), .c(new_n82_), .d(new_n78_), .O(new_n166_));
