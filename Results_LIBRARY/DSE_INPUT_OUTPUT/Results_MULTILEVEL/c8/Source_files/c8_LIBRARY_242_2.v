...
module FAU ( 
  ...
  nand3  g057(.a(new_n103_), .b(new_n98_), .c(new_n82_), .O(z11));
  inv1   g058(.a(new_n80_), .O(new_n105_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n82_), .O(z13));
  nand2  g077(.a(x18), .b(x05), .O(new_n124_));
  oai21  g078(.a(new_n105_), .b(new_n69_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n86_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  nand3  g081(.a(new_n90_), .b(new_n51_), .c(new_n127_), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n63_), .c(new_n99_), .O(new_n130_));
  ...
  inv1   g091(.a(new_n101_), .O(new_n138_));
  ...
  nand3  g114(.a(new_n100_), .b(x19), .c(new_n127_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n127_), .O(new_n162_));
