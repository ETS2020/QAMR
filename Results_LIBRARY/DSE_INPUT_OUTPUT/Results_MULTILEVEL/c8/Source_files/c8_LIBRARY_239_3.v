...
module FAU ( 
  ...
  nand2  g036(.a(new_n48_), .b(new_n62_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n48_), .O(z09));
  ...
  nor2   g051(.a(new_n87_), .b(new_n97_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n48_), .O(z10));
  inv1   g055(.a(x02), .O(new_n102_));
  nand2  g056(.a(new_n55_), .b(x10), .O(new_n103_));
  nand2  g057(.a(new_n56_), .b(x18), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n102_), .c(new_n103_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n89_), .O(new_n106_));
  nand3  g060(.a(new_n97_), .b(new_n85_), .c(new_n84_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(x21), .c(new_n55_), .O(new_n108_));
  ...
  oai21  g068(.a(x18), .b(new_n59_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n89_), .O(new_n116_));
  oai21  g070(.a(new_n61_), .b(new_n89_), .c(new_n55_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x21), .O(new_n118_));
  nand4  g072(.a(new_n87_), .b(new_n61_), .c(new_n56_), .d(new_n97_), .O(new_n119_));
  oai21  g073(.a(new_n99_), .b(new_n61_), .c(new_n119_), .O(new_n120_));
  ...
  nand2  g078(.a(new_n124_), .b(new_n89_), .O(new_n125_));
  oai21  g079(.a(new_n67_), .b(new_n89_), .c(new_n55_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x21), .O(new_n127_));
  nor2   g081(.a(x22), .b(x20), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(new_n87_), .c(new_n67_), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n56_), .O(new_n131_));
  nor2   g085(.a(new_n131_), .b(new_n107_), .O(new_n132_));
  ...
  oai22  g089(.a(new_n104_), .b(new_n135_), .c(x18), .d(new_n70_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n89_), .O(new_n137_));
  nand3  g091(.a(new_n130_), .b(new_n87_), .c(new_n97_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x24), .O(new_n139_));
  nor3   g093(.a(x24), .b(x23), .c(x22), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n99_), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n139_), .c(x21), .O(new_n142_));
  nor3   g096(.a(new_n72_), .b(new_n56_), .c(x18), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n142_), .c(x16), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n137_), .O(z14));
  inv1   g099(.a(x06), .O(new_n146_));
  oai22  g100(.a(new_n104_), .b(new_n146_), .c(x18), .d(new_n75_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n89_), .O(new_n148_));
  nand3  g102(.a(new_n72_), .b(new_n67_), .c(new_n61_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n107_), .c(x25), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n130_), .c(new_n99_), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n150_), .c(x21), .O(new_n153_));
  nand2  g107(.a(x25), .b(x21), .O(new_n154_));
  ...
  oai21  g112(.a(x18), .b(new_n78_), .c(new_n158_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n89_), .O(new_n160_));
  oai21  g114(.a(new_n80_), .b(new_n89_), .c(new_n55_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x21), .O(new_n162_));
  nand2  g116(.a(new_n152_), .b(x26), .O(new_n163_));
  nor3   g117(.a(x26), .b(x25), .c(x24), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n130_), .c(new_n109_), .d(new_n87_), .O(new_n165_));
  ...
  nand3  g122(.a(new_n48_), .b(x27), .c(x17), .O(new_n169_));
  nor2   g123(.a(new_n85_), .b(x17), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n164_), .c(new_n130_), .d(new_n109_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n169_), .c(new_n89_), .O(z17));
endmodule
