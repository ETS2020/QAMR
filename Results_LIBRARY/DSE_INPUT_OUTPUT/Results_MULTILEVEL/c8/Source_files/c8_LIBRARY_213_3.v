...
module FAU ( 
  ...
  nand3  g031(.a(new_n52_), .b(new_n75_), .c(new_n77_), .O(new_n78_));
  nand2  g032(.a(new_n78_), .b(new_n76_), .O(z06));
  ...
  nand2  g066(.a(x18), .b(new_n74_), .O(new_n113_));
  ...
  oai22  g085(.a(new_n113_), .b(new_n131_), .c(x18), .d(new_n71_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n90_), .O(new_n133_));
  nand3  g087(.a(new_n98_), .b(new_n51_), .c(new_n86_), .O(new_n134_));
  nand3  g088(.a(new_n68_), .b(new_n63_), .c(new_n106_), .O(new_n135_));
  ...
  nand2  g097(.a(new_n77_), .b(x14), .O(new_n144_));
  oai21  g098(.a(new_n113_), .b(new_n143_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n90_), .O(new_n146_));
  nand2  g100(.a(new_n139_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n107_), .d(new_n88_), .O(new_n149_));
  ...
  oai22  g107(.a(new_n113_), .b(new_n153_), .c(x18), .d(new_n80_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n107_), .d(new_n88_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n126_), .b(new_n82_), .c(new_n75_), .d(new_n162_), .O(new_n163_));
