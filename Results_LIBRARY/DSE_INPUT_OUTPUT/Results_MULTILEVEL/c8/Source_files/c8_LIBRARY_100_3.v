...
module FAU ( 
  ...
  oai21  g060(.a(new_n96_), .b(new_n60_), .c(new_n106_), .O(new_n107_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n88_), .c(new_n94_), .O(new_n115_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n96_), .c(new_n60_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g078(.a(new_n90_), .b(x12), .O(new_n125_));
  ...
  nand3  g083(.a(new_n94_), .b(new_n51_), .c(new_n86_), .O(new_n130_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n134_), .d(new_n86_), .O(new_n136_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n105_), .d(new_n88_), .O(new_n143_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n100_), .O(new_n150_));
  nand2  g104(.a(new_n143_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n121_), .c(new_n105_), .d(new_n88_), .O(new_n153_));
  ...
  nand4  g111(.a(new_n121_), .b(new_n81_), .c(new_n76_), .d(new_n157_), .O(new_n158_));
