...
module FAU ( 
  ...
  nor2   g032(.a(new_n48_), .b(new_n60_), .O(z08));
  inv1   g033(.a(x16), .O(new_n80_));
  nand2  g034(.a(x18), .b(x00), .O(new_n81_));
  nand2  g035(.a(new_n51_), .b(x09), .O(new_n82_));
  oai21  g036(.a(new_n82_), .b(new_n47_), .c(new_n81_), .O(new_n83_));
  ...
  nand3  g053(.a(new_n99_), .b(new_n85_), .c(x16), .O(new_n100_));
  ...
  nand2  g057(.a(new_n103_), .b(new_n80_), .O(new_n104_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n104_), .c(new_n85_), .O(z11));
  nand2  g065(.a(x18), .b(x03), .O(new_n112_));
  oai21  g066(.a(x18), .b(new_n57_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n80_), .O(new_n114_));
  aoi21  g068(.a(new_n107_), .b(new_n87_), .c(new_n59_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n87_), .c(new_n95_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n85_), .O(z12));
  ...
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n85_), .O(z13));
  ...
  nand3  g092(.a(new_n138_), .b(new_n132_), .c(new_n85_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  nand3  g094(.a(new_n51_), .b(x14), .c(x09), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n80_), .O(new_n143_));
  nand2  g097(.a(new_n136_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x23), .b(x22), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n107_), .d(new_n87_), .O(new_n147_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n80_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n107_), .d(new_n87_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n85_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n145_), .c(new_n133_), .O(new_n161_));
  nand3  g115(.a(new_n107_), .b(x19), .c(new_n96_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n60_), .d(new_n96_), .O(new_n163_));
