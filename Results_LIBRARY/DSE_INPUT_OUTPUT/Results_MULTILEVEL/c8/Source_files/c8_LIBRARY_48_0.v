...
module FAU ( 
  ...
  oai21  g53(.a(new_n90_), .b(x02), .c(new_n94_), .O(new_n100_));
  ...
  oai21  g61(.a(new_n90_), .b(x03), .c(new_n94_), .O(new_n108_));
  ...
  oai21  g70(.a(new_n115_), .b(new_n94_), .c(new_n116_), .O(z13));
  oai21  g71(.a(new_n90_), .b(x05), .c(new_n94_), .O(new_n118_));
  aoi21  g72(.a(new_n114_), .b(new_n97_), .c(new_n74_), .O(new_n119_));
  ...
  oai21  g83(.a(new_n128_), .b(new_n94_), .c(new_n129_), .O(z15));
  ...
  nand2  g93(.a(new_n91_), .b(x07), .O(new_n140_));
