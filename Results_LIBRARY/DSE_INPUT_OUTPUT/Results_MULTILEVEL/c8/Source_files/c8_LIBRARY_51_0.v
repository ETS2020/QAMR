...
module FAU ( 
  ...
  nand2  g034(.a(new_n68_), .b(x13), .O(new_n81_));
  ...
  oai21  g041(.a(x18), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  ...
  oai21  g054(.a(new_n93_), .b(new_n59_), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g058(.a(new_n81_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g075(.a(new_n68_), .b(x05), .c(new_n79_), .O(new_n122_));
  ...
  nand3  g086(.a(new_n68_), .b(x14), .c(x13), .O(new_n133_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n77_), .c(x16), .O(new_n141_));
  ...
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n77_), .O(z16));
  ...
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n51_), .d(new_n125_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n77_), .O(z17));
endmodule
