...
module FAU ( 
  ...
  nand3  g045(.a(new_n54_), .b(new_n82_), .c(new_n81_), .O(new_n92_));
  oai21  g046(.a(new_n84_), .b(new_n54_), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(x18), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n91_), .O(z10));
  ...
  nand3  g057(.a(new_n103_), .b(x18), .c(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n98_), .O(z11));
  oai21  g059(.a(x16), .b(x11), .c(new_n79_), .O(new_n106_));
  inv1   g060(.a(x22), .O(new_n107_));
  aoi21  g061(.a(new_n101_), .b(new_n84_), .c(new_n107_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n84_), .c(new_n54_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n86_), .b(x03), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n112_), .c(new_n106_), .O(z12));
  ...
  nand3  g073(.a(new_n119_), .b(new_n100_), .c(new_n99_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n107_), .c(new_n99_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n92_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n109_), .c(new_n130_), .d(new_n81_), .O(new_n132_));
  ...
  nand2  g099(.a(new_n145_), .b(new_n48_), .O(new_n146_));
  nand2  g100(.a(new_n139_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n119_), .c(new_n101_), .d(new_n84_), .O(new_n149_));
  ...
  nand2  g106(.a(new_n127_), .b(new_n107_), .O(new_n153_));
  inv1   g107(.a(x25), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n69_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n81_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n55_), .b(new_n81_), .O(new_n160_));
