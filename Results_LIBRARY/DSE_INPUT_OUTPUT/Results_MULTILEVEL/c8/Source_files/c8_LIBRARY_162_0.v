...
module FAU ( 
  ...
  nand3  g44(.a(x18), .b(new_n83_), .c(x01), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n90_), .O(z10));
  oai21  g46(.a(new_n84_), .b(x02), .c(new_n83_), .O(new_n93_));
  ...
  nand4  g66(.a(new_n112_), .b(new_n102_), .c(new_n94_), .d(new_n78_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g69(.a(x18), .b(new_n83_), .c(x05), .O(new_n116_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n110_), .c(new_n119_), .d(new_n62_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n97_), .c(new_n113_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n83_), .c(new_n118_), .O(z15));
  oai21  g78(.a(new_n84_), .b(x07), .c(new_n83_), .O(new_n125_));
