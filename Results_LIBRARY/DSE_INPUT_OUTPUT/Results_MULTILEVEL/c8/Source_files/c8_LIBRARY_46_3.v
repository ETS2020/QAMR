...
module FAU ( 
  ...
  nand2  g032(.a(new_n48_), .b(x27), .O(new_n79_));
  oai22  g033(.a(new_n79_), .b(x15), .c(x27), .d(x26), .O(z07));
  inv1   g034(.a(new_n79_), .O(z08));
  ...
  oai22  g048(.a(new_n94_), .b(new_n92_), .c(x18), .d(new_n52_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  inv1   g050(.a(x20), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n83_), .c(new_n82_), .O(new_n98_));
  ...
  oai22  g065(.a(new_n94_), .b(new_n111_), .c(x18), .d(new_n61_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  nand2  g067(.a(new_n107_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n85_), .c(new_n97_), .O(new_n116_));
  ...
  oai22  g074(.a(new_n94_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n87_), .O(new_n122_));
  nand2  g076(.a(new_n116_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n105_), .c(new_n57_), .O(new_n125_));
  ...
  oai22  g083(.a(new_n94_), .b(new_n129_), .c(x18), .d(new_n71_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n87_), .O(new_n131_));
  nand3  g085(.a(new_n68_), .b(new_n63_), .c(new_n57_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n98_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n115_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n124_), .c(new_n106_), .d(new_n85_), .O(new_n145_));
  ...
  nand2  g112(.a(z08), .b(x17), .O(new_n159_));
  nor2   g113(.a(new_n83_), .b(x17), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n154_), .c(new_n124_), .d(new_n106_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n159_), .c(new_n87_), .O(z17));
endmodule
