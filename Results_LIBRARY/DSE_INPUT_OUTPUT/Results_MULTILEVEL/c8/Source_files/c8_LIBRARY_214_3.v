...
module FAU ( 
  ...
  nand2  g059(.a(new_n98_), .b(x10), .O(new_n106_));
  ...
  nand2  g067(.a(new_n98_), .b(x11), .O(new_n114_));
  ...
  nand2  g075(.a(new_n98_), .b(x12), .O(new_n122_));
  ...
  nand3  g081(.a(new_n93_), .b(new_n86_), .c(new_n85_), .O(new_n128_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n110_), .c(new_n132_), .d(new_n85_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n127_), .c(x16), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n102_), .d(new_n94_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n98_), .b(x14), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n118_), .c(new_n102_), .d(new_n94_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n127_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nand2  g108(.a(new_n129_), .b(new_n63_), .O(new_n155_));
  ...
  nand3  g112(.a(new_n102_), .b(x19), .c(new_n85_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n58_), .b(new_n85_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n127_), .c(new_n83_), .O(z17));
endmodule
