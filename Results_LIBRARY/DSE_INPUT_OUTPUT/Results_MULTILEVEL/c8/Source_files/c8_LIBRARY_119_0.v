// Benchmark "FAU" written by ABC on Thu Aug 13 18:00:58 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x02), .O(new_n48_));
  ...
  nand3  g048(.a(new_n87_), .b(x09), .c(x02), .O(new_n95_));
  ...
  inv1   g053(.a(x19), .O(new_n100_));
  nand3  g054(.a(new_n53_), .b(new_n100_), .c(new_n99_), .O(new_n101_));
  oai21  g055(.a(new_n98_), .b(new_n53_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n83_), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n97_), .O(z10));
  nand2  g058(.a(new_n87_), .b(new_n57_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n85_), .c(x02), .O(new_n106_));
  nor3   g060(.a(x20), .b(x19), .c(x17), .O(new_n107_));
  nor2   g061(.a(x21), .b(x20), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n98_), .O(new_n109_));
  oai21  g063(.a(new_n107_), .b(new_n59_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n83_), .O(z11));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  nand3  g067(.a(new_n87_), .b(x11), .c(x02), .O(new_n114_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n128_), .c(new_n108_), .d(new_n98_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n83_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n87_), .b(x15), .c(x02), .O(new_n156_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n128_), .c(new_n108_), .d(new_n98_), .O(new_n161_));
  ...
  nand3  g119(.a(new_n165_), .b(new_n128_), .c(new_n72_), .O(new_n166_));
  nand3  g120(.a(new_n108_), .b(x19), .c(new_n99_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n54_), .d(new_n99_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n83_), .c(x16), .O(new_n169_));
