// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:27 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x07), .O(new_n48_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n81_), .c(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n88_), .O(z09));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  nand3  g049(.a(new_n85_), .b(x09), .c(x07), .O(new_n96_));
  ...
  inv1   g054(.a(x19), .O(new_n101_));
  nand3  g055(.a(new_n99_), .b(new_n101_), .c(new_n100_), .O(new_n102_));
  oai21  g056(.a(new_n90_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n81_), .c(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n98_), .O(z10));
  nand2  g059(.a(x18), .b(x02), .O(new_n106_));
  oai21  g060(.a(x18), .b(new_n54_), .c(new_n106_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n83_), .O(new_n108_));
  nor3   g062(.a(x20), .b(x19), .c(x17), .O(new_n109_));
  nor2   g063(.a(x21), .b(x20), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n90_), .O(new_n111_));
  oai21  g065(.a(new_n109_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n108_), .c(new_n81_), .O(z11));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n90_), .c(new_n62_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n90_), .c(new_n99_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n81_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  nand3  g078(.a(new_n85_), .b(x12), .c(x07), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n83_), .O(new_n127_));
  nand2  g081(.a(new_n120_), .b(x23), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n109_), .c(new_n56_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n81_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n127_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  nand3  g088(.a(new_n85_), .b(x13), .c(x07), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n83_), .O(new_n137_));
  inv1   g091(.a(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n62_), .c(new_n56_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n102_), .c(x24), .O(new_n140_));
  nor2   g094(.a(x20), .b(x19), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n119_), .c(new_n141_), .d(new_n100_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n81_), .c(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n137_), .O(z14));
  nand2  g100(.a(x18), .b(x06), .O(new_n147_));
  nand3  g101(.a(new_n85_), .b(x14), .c(x07), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n83_), .O(new_n150_));
  nand2  g104(.a(new_n143_), .b(x25), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n129_), .c(new_n110_), .d(new_n90_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n81_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z15));
  nand2  g110(.a(new_n85_), .b(new_n76_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n83_), .c(x07), .O(new_n158_));
  nand2  g112(.a(new_n153_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n129_), .c(new_n110_), .d(new_n90_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n81_), .O(z16));
  inv1   g118(.a(x24), .O(new_n165_));
  nand4  g119(.a(new_n129_), .b(new_n78_), .c(new_n73_), .d(new_n165_), .O(new_n166_));
  nand3  g120(.a(new_n110_), .b(x19), .c(new_n100_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n57_), .d(new_n100_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n81_), .O(z17));
endmodule
