...
module FAU ( 
  ...
  nand2  g034(.a(new_n55_), .b(new_n79_), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n80_), .c(new_n48_), .O(z06));
  ...
  nand2  g049(.a(new_n79_), .b(x18), .O(new_n96_));
  ...
  nor2   g057(.a(x18), .b(new_n58_), .O(new_n104_));
  aoi21  g058(.a(x18), .b(x02), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g062(.a(new_n108_), .b(x16), .c(new_n49_), .O(new_n109_));
  oai21  g063(.a(new_n105_), .b(x16), .c(new_n109_), .O(z11));
  inv1   g064(.a(x03), .O(new_n111_));
  oai22  g065(.a(new_n96_), .b(new_n111_), .c(x18), .d(new_n63_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n90_), .O(new_n113_));
  nand2  g067(.a(new_n107_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n88_), .c(new_n54_), .O(new_n116_));
  ...
  oai22  g074(.a(new_n96_), .b(new_n120_), .c(x18), .d(new_n68_), .O(new_n121_));
  ...
  oai22  g083(.a(new_n96_), .b(new_n129_), .c(x18), .d(new_n73_), .O(new_n130_));
  ...
  nand3  g097(.a(new_n124_), .b(new_n79_), .c(new_n75_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n107_), .c(new_n143_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n142_), .c(new_n48_), .O(z15));
  inv1   g101(.a(x07), .O(new_n148_));
  oai22  g102(.a(new_n96_), .b(new_n148_), .c(x18), .d(new_n83_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n136_), .b(x26), .O(new_n151_));
  nor2   g105(.a(x26), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n124_), .c(new_n106_), .d(new_n88_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n151_), .c(x25), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nor3   g109(.a(new_n155_), .b(new_n79_), .c(x18), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n154_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n150_), .O(z16));
  nand3  g112(.a(new_n106_), .b(x19), .c(new_n133_), .O(new_n159_));
  nand4  g113(.a(new_n124_), .b(new_n155_), .c(new_n79_), .d(new_n75_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n133_), .O(new_n161_));
