...
module FAU ( 
  ...
  nand4  g48(.a(new_n56_), .b(new_n88_), .c(new_n79_), .d(new_n78_), .O(new_n95_));
  ...
  nand2  g55(.a(new_n95_), .b(x22), .O(new_n102_));
  ...
  aoi21  g65(.a(new_n107_), .b(new_n90_), .c(new_n68_), .O(new_n112_));
