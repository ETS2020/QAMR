...
module FAU ( 
  ...
  nand3  g057(.a(new_n93_), .b(x10), .c(x04), .O(new_n104_));
  ...
  oai21  g063(.a(new_n99_), .b(new_n107_), .c(new_n109_), .O(new_n110_));
  ...
  aoi21  g070(.a(new_n93_), .b(new_n116_), .c(x22), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n107_), .c(new_n97_), .d(new_n49_), .O(new_n118_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n115_), .c(new_n82_), .O(z12));
  aoi21  g076(.a(new_n93_), .b(new_n65_), .c(x16), .O(new_n123_));
  nor2   g077(.a(x22), .b(x21), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n85_), .c(new_n97_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n99_), .c(new_n107_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(x16), .c(new_n123_), .O(new_n130_));
  nand3  g084(.a(new_n129_), .b(x18), .c(x16), .O(new_n131_));
  oai21  g085(.a(new_n130_), .b(new_n116_), .c(new_n131_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  nand3  g087(.a(new_n93_), .b(x13), .c(x04), .O(new_n134_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n124_), .c(new_n99_), .O(new_n139_));
  ...
  nand3  g097(.a(new_n93_), .b(x14), .c(x04), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n127_), .c(new_n108_), .d(new_n85_), .O(new_n149_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n127_), .c(new_n70_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n109_), .c(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n82_), .O(z16));
  nand3  g115(.a(new_n108_), .b(x19), .c(new_n83_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n158_), .c(new_n50_), .d(new_n83_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n82_), .c(x16), .O(new_n164_));
