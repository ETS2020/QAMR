...
module FAU ( 
  ...
  oai22  g041(.a(new_n81_), .b(new_n87_), .c(x18), .d(new_n55_), .O(new_n88_));
  ...
  oai22  g062(.a(new_n81_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  ...
  oai22  g071(.a(new_n81_), .b(new_n117_), .c(x18), .d(new_n64_), .O(new_n118_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n79_), .c(x15), .O(new_n148_));
  ...
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n92_), .O(new_n158_));
