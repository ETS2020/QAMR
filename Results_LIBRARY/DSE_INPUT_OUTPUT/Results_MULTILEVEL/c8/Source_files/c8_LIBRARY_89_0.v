...
module FAU ( 
  ...
  nand4  g54(.a(new_n100_), .b(new_n93_), .c(new_n50_), .d(new_n83_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n99_), .b(x21), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n88_), .b(x02), .O(new_n104_));
  oai21  g58(.a(new_n103_), .b(new_n91_), .c(new_n104_), .O(z11));
  ...
  nand2  g63(.a(new_n88_), .b(x03), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n91_), .c(new_n110_), .O(z12));
  oai21  g65(.a(new_n87_), .b(x04), .c(new_n91_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n95_), .c(new_n108_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n91_), .c(new_n112_), .O(z13));
  ...
  nand2  g75(.a(new_n88_), .b(x05), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n121_), .O(z14));
  oai21  g77(.a(new_n87_), .b(x06), .c(new_n91_), .O(new_n124_));
