...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x13), .O(new_n53_));
  ...
  nand2  g032(.a(new_n48_), .b(new_n77_), .O(new_n79_));
  nand3  g033(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z05));
  ...
  oai21  g062(.a(new_n103_), .b(new_n63_), .c(new_n108_), .O(new_n109_));
  ...
  aoi21  g068(.a(new_n52_), .b(x13), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n116_));
  ...
  nand2  g075(.a(new_n92_), .b(x12), .O(new_n122_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n101_), .c(new_n58_), .O(new_n126_));
  ...
  nand2  g086(.a(new_n129_), .b(x24), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n125_), .c(new_n103_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n53_), .c(x16), .O(new_n137_));
  nand3  g091(.a(x18), .b(new_n97_), .c(x05), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n137_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  oai21  g094(.a(x18), .b(new_n83_), .c(new_n140_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n97_), .O(new_n142_));
  nand2  g096(.a(new_n135_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n128_), .c(new_n107_), .d(new_n101_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n53_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n52_), .b(x15), .c(new_n76_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n128_), .b(new_n88_), .c(new_n81_), .d(new_n77_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n108_), .c(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n53_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n152_), .O(z16));
  inv1   g111(.a(x17), .O(new_n158_));
  nand3  g112(.a(new_n107_), .b(x19), .c(new_n158_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n154_), .c(new_n48_), .d(new_n158_), .O(new_n160_));
