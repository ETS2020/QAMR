...
module FAU ( 
  ...
  aoi21  g70(.a(new_n112_), .b(new_n96_), .c(new_n75_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n108_), .c(new_n100_), .d(new_n87_), .O(new_n119_));
  ...
  nand4  g78(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n124_), .O(new_n125_));
  ...
  nand3  g95(.a(new_n141_), .b(new_n131_), .c(new_n75_), .O(new_n142_));
  nand3  g96(.a(new_n130_), .b(x19), .c(new_n87_), .O(new_n143_));
