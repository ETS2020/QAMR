...
module FAU ( 
  ...
  oai22  g064(.a(new_n94_), .b(new_n110_), .c(x18), .d(new_n62_), .O(new_n111_));
  ...
  oai21  g068(.a(new_n107_), .b(new_n60_), .c(new_n114_), .O(new_n115_));
  ...
  nand4  g075(.a(new_n121_), .b(new_n60_), .c(new_n55_), .d(new_n47_), .O(new_n122_));
  ...
  nand4  g083(.a(new_n103_), .b(new_n65_), .c(new_n60_), .d(new_n55_), .O(new_n130_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(new_n53_), .O(z13));
  oai21  g090(.a(x18), .b(x13), .c(new_n92_), .O(new_n137_));
  aoi21  g091(.a(new_n132_), .b(new_n107_), .c(new_n75_), .O(new_n138_));
  nand4  g092(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n60_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n106_), .O(new_n140_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n113_), .d(new_n103_), .O(new_n148_));
  ...
  nand4  g109(.a(new_n146_), .b(new_n88_), .c(new_n83_), .d(new_n75_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n114_), .c(new_n155_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n154_), .c(new_n53_), .O(z16));
  nand3  g113(.a(new_n113_), .b(x19), .c(new_n105_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n48_), .d(new_n105_), .O(new_n161_));
