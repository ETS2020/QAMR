...
module FAU ( 
  ...
  nand2  g072(.a(new_n118_), .b(new_n106_), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n110_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z13));
  oai21  g079(.a(x16), .b(x05), .c(x18), .O(new_n126_));
  aoi21  g080(.a(new_n121_), .b(new_n94_), .c(new_n73_), .O(new_n127_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n100_), .d(new_n86_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n100_), .d(new_n86_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n110_), .c(x16), .O(new_n151_));
  ...
  nand3  g111(.a(new_n100_), .b(x19), .c(new_n84_), .O(new_n158_));
  ...
  aoi21  g115(.a(new_n161_), .b(new_n110_), .c(new_n106_), .O(z17));
endmodule
