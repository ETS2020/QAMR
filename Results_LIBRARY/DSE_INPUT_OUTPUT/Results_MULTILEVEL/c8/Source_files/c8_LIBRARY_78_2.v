...
module FAU ( 
  ...
  nand3  g063(.a(new_n52_), .b(x10), .c(new_n109_), .O(new_n110_));
  ...
  oai21  g068(.a(new_n105_), .b(new_n61_), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g074(.a(new_n52_), .b(x04), .c(x22), .O(new_n121_));
  nand4  g075(.a(new_n121_), .b(new_n61_), .c(new_n56_), .d(new_n49_), .O(new_n122_));
  ...
  nand3  g080(.a(new_n52_), .b(x12), .c(new_n109_), .O(new_n127_));
  oai21  g081(.a(new_n52_), .b(new_n109_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n96_), .O(new_n129_));
  nor2   g083(.a(x22), .b(x21), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n94_), .c(new_n56_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n105_), .c(new_n61_), .O(new_n134_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n133_), .c(new_n113_), .d(new_n94_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n53_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n151_), .O(z15));
  nand2  g111(.a(x18), .b(x07), .O(new_n158_));
  nand3  g112(.a(new_n52_), .b(x15), .c(new_n109_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n96_), .O(new_n161_));
  nand2  g115(.a(new_n154_), .b(x26), .O(new_n162_));
  nand4  g116(.a(new_n133_), .b(new_n88_), .c(new_n83_), .d(new_n78_), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(new_n114_), .c(new_n162_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n53_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n161_), .O(z16));
  nand3  g120(.a(new_n113_), .b(x19), .c(new_n92_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n163_), .c(new_n50_), .d(new_n92_), .O(new_n168_));
