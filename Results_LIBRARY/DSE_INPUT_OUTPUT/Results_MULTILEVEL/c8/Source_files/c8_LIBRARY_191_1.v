...
module FAU ( 
  ...
  aoi22  g56(.a(new_n102_), .b(new_n84_), .c(new_n98_), .d(x22), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n86_), .c(new_n87_), .d(new_n61_), .O(z12));
  oai21  g58(.a(x18), .b(x12), .c(new_n86_), .O(new_n105_));
  ...
  oai21  g63(.a(new_n109_), .b(new_n86_), .c(new_n105_), .O(z13));
  oai21  g64(.a(x18), .b(x13), .c(new_n86_), .O(new_n111_));
  aoi21  g65(.a(new_n108_), .b(new_n92_), .c(new_n71_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n106_), .c(new_n96_), .d(new_n81_), .O(new_n114_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n71_), .c(new_n118_), .d(new_n63_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n99_), .c(new_n114_), .d(x25), .O(new_n122_));
  ...
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n71_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n81_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n58_), .d(new_n81_), .O(new_n140_));
