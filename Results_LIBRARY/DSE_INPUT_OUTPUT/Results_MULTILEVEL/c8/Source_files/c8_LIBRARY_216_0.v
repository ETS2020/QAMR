...
module FAU ( 
  ...
  nand4  g51(.a(new_n59_), .b(new_n91_), .c(new_n50_), .d(new_n82_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x21), .c(new_n99_), .O(new_n100_));
  nor2   g54(.a(new_n87_), .b(x16), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(x02), .O(new_n102_));
  oai21  g56(.a(new_n100_), .b(new_n86_), .c(new_n102_), .O(z11));
  oai21  g57(.a(new_n87_), .b(x03), .c(new_n86_), .O(new_n104_));
  nand2  g58(.a(new_n98_), .b(x22), .O(new_n105_));
  ...
  nand2  g65(.a(new_n101_), .b(x04), .O(new_n112_));
