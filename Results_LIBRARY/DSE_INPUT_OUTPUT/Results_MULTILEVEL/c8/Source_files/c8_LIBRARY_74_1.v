...
module FAU ( 
  ...
  nand4  g55(.a(new_n57_), .b(new_n94_), .c(new_n86_), .d(new_n85_), .O(new_n102_));
  ...
  nand3  g62(.a(new_n108_), .b(new_n88_), .c(new_n94_), .O(new_n109_));
  ...
  aoi21  g69(.a(new_n113_), .b(new_n96_), .c(new_n71_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n100_), .d(new_n85_), .O(new_n118_));
  ...
  nand3  g80(.a(new_n48_), .b(new_n90_), .c(x14), .O(new_n127_));
  ...
  inv1   g93(.a(new_n49_), .O(new_n140_));
  nand4  g94(.a(new_n131_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n141_));
  nand3  g95(.a(new_n130_), .b(x19), .c(new_n85_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n58_), .d(new_n85_), .O(new_n143_));
