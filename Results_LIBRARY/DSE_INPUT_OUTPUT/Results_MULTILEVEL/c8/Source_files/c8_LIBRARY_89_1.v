...
module FAU ( 
  ...
  nand2  g42(.a(new_n47_), .b(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n49_), .c(new_n87_), .O(z09));
  oai21  g44(.a(x18), .b(x09), .c(new_n88_), .O(new_n91_));
  ...
  nand4  g53(.a(new_n99_), .b(new_n92_), .c(new_n51_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n88_), .c(new_n89_), .d(new_n58_), .O(z11));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n86_), .c(new_n100_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n88_), .c(new_n89_), .d(new_n61_), .O(z12));
  oai21  g60(.a(x18), .b(x12), .c(new_n88_), .O(new_n107_));
  ...
  nand3  g91(.a(new_n137_), .b(new_n128_), .c(new_n113_), .O(new_n138_));
  nand3  g92(.a(new_n127_), .b(x19), .c(new_n84_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n52_), .d(new_n84_), .O(new_n140_));
