...
module FAU ( 
  ...
  oai22  g080(.a(new_n84_), .b(new_n126_), .c(x18), .d(new_n67_), .O(new_n127_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n102_), .O(new_n133_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n47_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n128_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n84_), .b(new_n141_), .c(x18), .d(new_n70_), .O(new_n142_));
  ...
  oai21  g103(.a(x18), .b(new_n82_), .c(x15), .O(new_n150_));
  ...
  nand3  g109(.a(x18), .b(new_n82_), .c(x07), .O(new_n156_));
