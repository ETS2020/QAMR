// Benchmark "FAU" written by ABC on Thu Aug 13 18:01:40 2020
...
module FAU ( 
  ...
  inv1   g25(.a(x23), .O(new_n72_));
  nand2  g26(.a(new_n52_), .b(new_n72_), .O(new_n73_));
  aoi21  g27(.a(new_n73_), .b(new_n71_), .c(new_n48_), .O(z04));
  inv1   g28(.a(x13), .O(new_n75_));
  aoi21  g29(.a(x27), .b(new_n75_), .c(new_n48_), .O(new_n76_));
  oai21  g30(.a(x27), .b(x24), .c(new_n76_), .O(z05));
  inv1   g31(.a(x14), .O(new_n78_));
  nand2  g32(.a(x27), .b(new_n78_), .O(new_n79_));
  inv1   g33(.a(x25), .O(new_n80_));
  nand2  g34(.a(new_n52_), .b(new_n80_), .O(new_n81_));
  aoi21  g35(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(z06));
  inv1   g36(.a(x15), .O(new_n83_));
  nand2  g37(.a(x27), .b(new_n83_), .O(new_n84_));
  inv1   g38(.a(x26), .O(new_n85_));
  nand2  g39(.a(new_n52_), .b(new_n85_), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n48_), .O(z07));
  nor2   g41(.a(new_n48_), .b(new_n52_), .O(z08));
  inv1   g42(.a(x17), .O(new_n89_));
  nor2   g43(.a(new_n51_), .b(new_n89_), .O(new_n90_));
  nor2   g44(.a(x19), .b(x17), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n90_), .c(x16), .O(new_n92_));
  inv1   g46(.a(x16), .O(new_n93_));
  oai21  g47(.a(x18), .b(x08), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n92_), .O(z09));
  nor2   g49(.a(new_n91_), .b(new_n57_), .O(new_n96_));
  nor3   g50(.a(x20), .b(x19), .c(x17), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  nor2   g52(.a(x18), .b(x16), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n55_), .c(new_n98_), .O(z10));
  nor2   g55(.a(x20), .b(x19), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n89_), .O(new_n103_));
  nand4  g57(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n89_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n93_), .c(new_n100_), .d(new_n60_), .O(z11));
  nor3   g61(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n91_), .c(new_n104_), .d(x22), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n93_), .c(new_n100_), .d(new_n65_), .O(z12));
  oai21  g64(.a(x18), .b(x12), .c(new_n93_), .O(new_n111_));
  nor2   g65(.a(x22), .b(x21), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n91_), .c(new_n57_), .O(new_n113_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n97_), .c(new_n113_), .d(x23), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n93_), .c(new_n111_), .O(z13));
  inv1   g70(.a(x24), .O(new_n117_));
  aoi21  g71(.a(new_n114_), .b(new_n97_), .c(new_n117_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n112_), .c(new_n102_), .d(new_n89_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n99_), .b(x13), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  nand4  g78(.a(new_n80_), .b(new_n117_), .c(new_n72_), .d(new_n67_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n105_), .c(new_n120_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n99_), .b(x14), .O(new_n128_));
  ...
  nand4  g86(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n91_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x26), .O(new_n134_));
  nor3   g88(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n131_), .c(new_n130_), .d(new_n91_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n99_), .b(x15), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n138_), .O(z16));
  nor2   g94(.a(new_n51_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n135_), .c(new_n131_), .d(new_n130_), .O(new_n142_));
  nand2  g96(.a(x27), .b(x17), .O(new_n143_));
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n93_), .O(z17));
endmodule
