...
module FAU ( 
  ...
  oai21  g37(.a(new_n47_), .b(x16), .c(new_n52_), .O(z08));
  ...
  nand4  g53(.a(new_n60_), .b(new_n93_), .c(new_n51_), .d(new_n85_), .O(new_n100_));
  ...
  oai22  g58(.a(new_n104_), .b(new_n58_), .c(new_n102_), .d(new_n89_), .O(z11));
  nor3   g59(.a(x22), .b(x21), .c(x20), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n87_), .c(new_n100_), .d(x22), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n89_), .c(new_n104_), .d(new_n63_), .O(z12));
  ...
  aoi22  g66(.a(new_n112_), .b(new_n95_), .c(new_n111_), .d(x23), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n89_), .c(new_n109_), .O(z13));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n95_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n110_), .c(new_n98_), .d(new_n85_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n103_), .b(x13), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  oai21  g76(.a(x18), .b(x14), .c(new_n89_), .O(new_n123_));
  inv1   g77(.a(x23), .O(new_n124_));
  nand4  g78(.a(new_n76_), .b(new_n115_), .c(new_n124_), .d(new_n65_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n89_), .c(new_n123_), .O(z15));
  ...
  nand2  g91(.a(new_n103_), .b(x15), .O(new_n138_));
