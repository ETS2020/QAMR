...
module FAU ( 
  ...
  nand2  g063(.a(x26), .b(new_n78_), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n62_), .c(new_n109_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n88_), .O(new_n112_));
  nand2  g066(.a(new_n105_), .b(x22), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n86_), .c(new_n56_), .O(new_n115_));
  ...
  oai21  g073(.a(new_n110_), .b(new_n65_), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g082(.a(new_n110_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g086(.a(new_n67_), .b(new_n132_), .c(new_n103_), .O(new_n133_));
  ...
  nand3  g108(.a(new_n145_), .b(new_n114_), .c(new_n67_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n154_), .c(x18), .O(new_n156_));
  ...
  nand4  g115(.a(new_n123_), .b(new_n79_), .c(new_n75_), .d(new_n161_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n160_), .c(new_n51_), .d(new_n84_), .O(new_n163_));
