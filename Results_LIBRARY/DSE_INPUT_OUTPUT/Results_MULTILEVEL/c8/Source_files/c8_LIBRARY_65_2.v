...
module FAU ( 
  ...
  oai21  g047(.a(new_n84_), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  ...
  nand2  g057(.a(new_n86_), .b(x02), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n103_), .c(new_n97_), .O(z11));
  oai21  g059(.a(x16), .b(x11), .c(new_n79_), .O(new_n106_));
  aoi21  g060(.a(new_n100_), .b(new_n84_), .c(new_n63_), .O(new_n107_));
  ...
  nand2  g065(.a(new_n86_), .b(x03), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n111_), .c(new_n106_), .O(z12));
  oai21  g067(.a(x16), .b(x12), .c(new_n79_), .O(new_n114_));
  ...
  nand2  g073(.a(new_n86_), .b(x04), .O(new_n120_));
  ...
  aoi21  g077(.a(new_n116_), .b(new_n99_), .c(new_n123_), .O(new_n124_));
  nor2   g078(.a(x24), .b(x23), .O(new_n125_));
  nand4  g079(.a(new_n125_), .b(new_n108_), .c(new_n92_), .d(new_n81_), .O(new_n126_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n133_), .c(new_n100_), .d(new_n84_), .O(new_n135_));
  ...
  oai21  g093(.a(x16), .b(x15), .c(new_n79_), .O(new_n140_));
  nand2  g094(.a(new_n135_), .b(x26), .O(new_n141_));
  nor3   g095(.a(x26), .b(x25), .c(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n133_), .c(new_n100_), .d(new_n84_), .O(new_n143_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n123_), .O(new_n152_));
  nor2   g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g107(.a(new_n100_), .b(x19), .c(new_n81_), .O(new_n154_));
  inv1   g108(.a(new_n154_), .O(new_n155_));
  nor2   g109(.a(new_n55_), .b(new_n81_), .O(new_n156_));
