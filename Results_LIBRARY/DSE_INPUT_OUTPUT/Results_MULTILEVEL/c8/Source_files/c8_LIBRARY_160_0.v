...
module FAU ( 
  ...
  nand3  g055(.a(new_n83_), .b(x10), .c(x06), .O(new_n102_));
  ...
  nand3  g065(.a(new_n83_), .b(x11), .c(x06), .O(new_n112_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n95_), .c(new_n94_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n79_), .c(x16), .O(new_n119_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n96_), .c(new_n105_), .O(new_n126_));
  ...
  nand3  g084(.a(new_n83_), .b(x13), .c(x06), .O(new_n131_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n79_), .c(x16), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n133_), .O(z14));
  inv1   g095(.a(x06), .O(new_n142_));
  aoi21  g096(.a(new_n83_), .b(new_n71_), .c(x16), .O(new_n143_));
  nand2  g097(.a(new_n138_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n125_), .c(new_n106_), .d(new_n95_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(x16), .c(new_n143_), .O(new_n148_));
  nand3  g102(.a(new_n147_), .b(x18), .c(x16), .O(new_n149_));
  oai21  g103(.a(new_n148_), .b(new_n142_), .c(new_n149_), .O(z15));
  ...
  nand2  g109(.a(new_n155_), .b(new_n125_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n107_), .c(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n79_), .O(z16));
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n135_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n50_), .d(new_n135_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n79_), .O(z17));
endmodule
