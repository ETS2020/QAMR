...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x06), .O(new_n48_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n87_), .O(z09));
  nand2  g052(.a(x18), .b(x01), .O(new_n99_));
  inv1   g053(.a(x18), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(x09), .c(x06), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  nor2   g057(.a(x20), .b(x19), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  oai21  g059(.a(new_n92_), .b(new_n53_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n87_), .c(x16), .O(new_n107_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n59_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n87_), .O(z11));
  nand2  g071(.a(x18), .b(x03), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n62_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n94_), .O(new_n120_));
  aoi21  g074(.a(new_n113_), .b(new_n92_), .c(new_n64_), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n92_), .c(new_n53_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n87_), .O(z12));
  nand2  g080(.a(x18), .b(x04), .O(new_n127_));
  nand3  g081(.a(new_n100_), .b(x12), .c(x06), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n94_), .O(new_n130_));
  nand2  g084(.a(new_n123_), .b(x23), .O(new_n131_));
  nor3   g085(.a(x23), .b(x22), .c(x21), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n112_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n87_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n130_), .O(z13));
  ...
  aoi21  g093(.a(new_n132_), .b(new_n112_), .c(new_n74_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n104_), .d(new_n89_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n87_), .O(z14));
  nand2  g099(.a(new_n100_), .b(new_n77_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n94_), .c(x06), .O(new_n147_));
  nand2  g101(.a(new_n142_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x23), .b(x22), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n113_), .d(new_n92_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n147_), .c(new_n87_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n100_), .b(x15), .c(x06), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n94_), .O(new_n158_));
  nand2  g112(.a(new_n151_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n149_), .c(new_n113_), .d(new_n92_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n87_), .c(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n158_), .O(z16));
  nand4  g118(.a(new_n149_), .b(new_n84_), .c(new_n79_), .d(new_n74_), .O(new_n165_));
  nand3  g119(.a(new_n113_), .b(x19), .c(new_n89_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n54_), .d(new_n89_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n87_), .c(x16), .O(new_n168_));
