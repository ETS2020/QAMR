...
module FAU ( 
  ...
  nand2  g038(.a(x18), .b(new_n52_), .O(new_n85_));
  ...
  nand3  g044(.a(x18), .b(new_n52_), .c(x01), .O(new_n91_));
  ...
  oai22  g056(.a(new_n85_), .b(new_n102_), .c(x18), .d(new_n55_), .O(new_n103_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n94_), .c(new_n107_), .d(new_n96_), .O(new_n108_));
  ...
  nand4  g069(.a(new_n115_), .b(new_n105_), .c(new_n94_), .d(new_n107_), .O(new_n116_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n95_), .c(new_n94_), .O(new_n125_));
  ...
  aoi21  g088(.a(new_n127_), .b(new_n106_), .c(new_n71_), .O(new_n135_));
  ...
  oai22  g095(.a(new_n85_), .b(new_n141_), .c(x18), .d(new_n74_), .O(new_n142_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n95_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n145_), .d(new_n95_), .O(new_n157_));
  ...
  nand3  g116(.a(new_n145_), .b(x19), .c(new_n96_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n61_), .d(new_n96_), .O(new_n164_));
