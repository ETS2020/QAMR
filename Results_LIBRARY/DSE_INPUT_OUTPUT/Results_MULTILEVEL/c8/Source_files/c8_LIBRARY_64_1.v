...
module FAU ( 
  ...
  nor2   g001(.a(new_n47_), .b(x15), .O(new_n48_));
  ...
  nand2  g030(.a(new_n52_), .b(x26), .O(new_n77_));
  nand2  g031(.a(new_n77_), .b(new_n47_), .O(new_n78_));
  inv1   g032(.a(x26), .O(new_n79_));
  nand3  g033(.a(new_n52_), .b(new_n79_), .c(x15), .O(new_n80_));
  oai21  g034(.a(new_n78_), .b(x15), .c(new_n80_), .O(z07));
  ...
  nand2  g039(.a(x18), .b(x15), .O(new_n86_));
  ...
  nand3  g043(.a(new_n89_), .b(new_n82_), .c(x16), .O(new_n90_));
  ...
  aoi21  g084(.a(new_n122_), .b(new_n97_), .c(new_n130_), .O(new_n131_));
  inv1   g085(.a(x17), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n131_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n129_), .c(new_n82_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n104_), .d(new_n95_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n82_), .O(z15));
  inv1   g102(.a(x07), .O(new_n149_));
  nand2  g103(.a(x18), .b(new_n149_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n84_), .c(x15), .O(new_n151_));
  nand2  g105(.a(new_n145_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n104_), .d(new_n95_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n82_), .O(z16));
  nand4  g111(.a(new_n143_), .b(new_n79_), .c(new_n74_), .d(new_n130_), .O(new_n158_));
  nand3  g112(.a(new_n104_), .b(x19), .c(new_n132_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n132_), .O(new_n160_));
