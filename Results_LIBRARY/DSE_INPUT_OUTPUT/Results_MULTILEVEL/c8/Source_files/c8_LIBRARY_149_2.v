...
module FAU ( 
  ...
  nand3  g050(.a(new_n80_), .b(x10), .c(new_n48_), .O(new_n97_));
  ...
  nand3  g059(.a(new_n80_), .b(x11), .c(new_n48_), .O(new_n106_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n84_), .O(z13));
  nand2  g077(.a(x18), .b(x05), .O(new_n124_));
  oai21  g078(.a(x18), .b(new_n69_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n79_), .O(new_n126_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n126_), .c(new_n84_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n100_), .d(new_n91_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n84_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  nand3  g100(.a(new_n80_), .b(x15), .c(new_n48_), .O(new_n147_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n100_), .d(new_n91_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n140_), .c(new_n127_), .O(new_n157_));
  nand3  g111(.a(new_n100_), .b(x19), .c(new_n129_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n129_), .O(new_n159_));
