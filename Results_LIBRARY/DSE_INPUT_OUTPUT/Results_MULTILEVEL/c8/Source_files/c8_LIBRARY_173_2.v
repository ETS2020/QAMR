...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(new_n94_), .c(new_n81_), .O(z10));
  ...
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n81_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  nand2  g072(.a(new_n75_), .b(new_n47_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n66_), .c(new_n118_), .O(new_n120_));
  ...
  oai21  g082(.a(new_n119_), .b(new_n69_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n87_), .O(new_n130_));
  nand3  g084(.a(new_n95_), .b(new_n51_), .c(new_n83_), .O(new_n131_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n123_), .c(new_n104_), .d(new_n85_), .O(new_n146_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n123_), .c(new_n104_), .d(new_n85_), .O(new_n152_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n123_), .c(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n83_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n83_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n81_), .O(z17));
endmodule
