...
module FAU ( 
  ...
  nand3  g041(.a(x18), .b(new_n48_), .c(x00), .O(new_n88_));
  nand3  g042(.a(new_n88_), .b(new_n87_), .c(new_n82_), .O(z09));
  ...
  nand3  g064(.a(new_n110_), .b(new_n86_), .c(new_n54_), .O(new_n111_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n100_), .c(new_n60_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n68_), .b(new_n127_), .c(new_n60_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n93_), .c(x24), .O(new_n129_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n119_), .c(new_n101_), .d(new_n86_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand3  g095(.a(x18), .b(new_n48_), .c(x06), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n119_), .c(new_n101_), .d(new_n86_), .O(new_n149_));
  ...
  nand2  g106(.a(new_n68_), .b(new_n127_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n101_), .b(x19), .c(new_n83_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n55_), .b(new_n83_), .O(new_n161_));
