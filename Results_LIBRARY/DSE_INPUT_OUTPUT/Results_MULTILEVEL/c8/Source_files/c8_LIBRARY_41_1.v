...
module FAU ( 
  ...
  nand2  g006(.a(x19), .b(new_n52_), .O(new_n53_));
  ...
  nand3  g045(.a(x19), .b(x18), .c(x17), .O(new_n92_));
  inv1   g046(.a(new_n92_), .O(new_n93_));
  nor2   g047(.a(x19), .b(x17), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nor2   g049(.a(x19), .b(x18), .O(new_n96_));
  aoi22  g050(.a(new_n96_), .b(x08), .c(x18), .d(x00), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(x16), .c(new_n95_), .O(z09));
  ...
  oai21  g056(.a(new_n55_), .b(new_n99_), .c(x18), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x19), .O(new_n104_));
  inv1   g058(.a(x17), .O(new_n105_));
  nor2   g059(.a(new_n55_), .b(new_n105_), .O(new_n106_));
  ...
  oai21  g066(.a(new_n60_), .b(new_n99_), .c(x18), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x19), .O(new_n114_));
  nor2   g068(.a(x20), .b(x17), .O(new_n115_));
  ...
  oai21  g077(.a(new_n68_), .b(new_n99_), .c(x18), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x19), .O(new_n125_));
  nor3   g079(.a(x21), .b(x20), .c(x17), .O(new_n126_));
  nor2   g080(.a(x22), .b(x21), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n94_), .c(new_n55_), .O(new_n128_));
  oai21  g082(.a(new_n126_), .b(new_n68_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n125_), .c(new_n123_), .O(z12));
  inv1   g085(.a(new_n96_), .O(new_n132_));
  nand2  g086(.a(x18), .b(x04), .O(new_n133_));
  oai21  g087(.a(new_n132_), .b(new_n73_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n99_), .O(new_n135_));
  nand2  g089(.a(new_n127_), .b(new_n115_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x23), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n115_), .c(new_n60_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x19), .O(new_n140_));
  nand3  g094(.a(x23), .b(x19), .c(x18), .O(new_n141_));
  ...
  oai21  g099(.a(new_n132_), .b(new_n78_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n99_), .O(new_n147_));
  nand2  g101(.a(new_n139_), .b(x24), .O(new_n148_));
  nor2   g102(.a(x24), .b(x23), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n116_), .c(new_n68_), .d(new_n105_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n148_), .c(x19), .O(new_n151_));
  nand3  g105(.a(x24), .b(x19), .c(x18), .O(new_n152_));
  ...
  oai21  g110(.a(x18), .b(new_n81_), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n99_), .O(new_n158_));
  oai21  g112(.a(new_n83_), .b(new_n99_), .c(x18), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x19), .O(new_n160_));
  and2   g114(.a(new_n150_), .b(x25), .O(new_n161_));
  nor2   g115(.a(x25), .b(x24), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n138_), .O(new_n163_));
  nor2   g117(.a(new_n163_), .b(new_n117_), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n161_), .c(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n160_), .c(new_n158_), .O(z15));
  nand2  g120(.a(x18), .b(x07), .O(new_n167_));
  oai21  g121(.a(new_n132_), .b(new_n86_), .c(new_n167_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n99_), .O(new_n169_));
  nand4  g123(.a(new_n162_), .b(new_n138_), .c(new_n116_), .d(new_n105_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(x26), .O(new_n171_));
  nor2   g125(.a(x26), .b(x25), .O(new_n172_));
  nand4  g126(.a(new_n172_), .b(new_n149_), .c(new_n127_), .d(new_n115_), .O(new_n173_));
  aoi21  g127(.a(new_n173_), .b(new_n171_), .c(x19), .O(new_n174_));
  nand3  g128(.a(x26), .b(x19), .c(x18), .O(new_n175_));
  inv1   g129(.a(new_n175_), .O(new_n176_));
  oai21  g130(.a(new_n176_), .b(new_n174_), .c(x16), .O(new_n177_));
  nand2  g131(.a(new_n177_), .b(new_n169_), .O(z16));
  nand3  g132(.a(new_n53_), .b(x27), .c(x17), .O(new_n179_));
  nand2  g133(.a(new_n116_), .b(x19), .O(new_n180_));
  nor3   g134(.a(new_n180_), .b(new_n52_), .c(x17), .O(new_n181_));
  nand4  g135(.a(new_n181_), .b(new_n172_), .c(new_n138_), .d(new_n76_), .O(new_n182_));
  aoi21  g136(.a(new_n182_), .b(new_n179_), .c(new_n99_), .O(z17));
endmodule
