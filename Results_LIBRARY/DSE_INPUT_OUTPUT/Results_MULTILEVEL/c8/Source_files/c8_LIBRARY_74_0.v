...
module FAU ( 
  ...
  nand4  g55(.a(new_n56_), .b(new_n94_), .c(new_n85_), .d(new_n84_), .O(new_n102_));
  ...
  aoi21  g69(.a(new_n113_), .b(new_n96_), .c(new_n70_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n100_), .d(new_n84_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand3  g74(.a(x18), .b(new_n89_), .c(x05), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  inv1   g76(.a(x22), .O(new_n123_));
  nand4  g77(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n123_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n103_), .c(new_n118_), .d(x25), .O(new_n126_));
  nand3  g80(.a(x18), .b(new_n89_), .c(x06), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n89_), .c(new_n127_), .O(z15));
  oai21  g82(.a(new_n90_), .b(x07), .c(new_n89_), .O(new_n129_));
  ...
  nand4  g94(.a(new_n131_), .b(new_n80_), .c(new_n75_), .d(new_n70_), .O(new_n141_));
  nand3  g95(.a(new_n130_), .b(x19), .c(new_n84_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n57_), .d(new_n84_), .O(new_n143_));
