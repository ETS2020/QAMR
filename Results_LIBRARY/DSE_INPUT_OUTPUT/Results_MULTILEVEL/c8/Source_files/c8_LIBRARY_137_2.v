...
module FAU ( 
  ...
  nand2  g052(.a(x26), .b(x18), .O(new_n99_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n63_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n91_), .c(new_n66_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n91_), .c(new_n56_), .O(new_n120_));
  ...
  oai22  g098(.a(new_n99_), .b(new_n144_), .c(x18), .d(new_n81_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n93_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n128_), .c(new_n110_), .d(new_n91_), .O(new_n149_));
  ...
  oai22  g108(.a(new_n99_), .b(new_n153_), .c(x18), .d(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n93_), .O(new_n156_));
  nand2  g110(.a(new_n149_), .b(x26), .O(new_n157_));
  nor2   g111(.a(x18), .b(x17), .O(new_n158_));
  nor3   g112(.a(x21), .b(x20), .c(x19), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n128_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n156_), .O(z16));
  nand4  g118(.a(new_n128_), .b(new_n47_), .c(new_n83_), .d(new_n76_), .O(new_n165_));
  ...
  nand2  g122(.a(new_n168_), .b(new_n48_), .O(z17));
endmodule
