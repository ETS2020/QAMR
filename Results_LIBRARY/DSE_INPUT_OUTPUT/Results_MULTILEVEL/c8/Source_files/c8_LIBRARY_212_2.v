...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x05), .O(new_n53_));
  ...
  aoi21  g038(.a(new_n84_), .b(new_n82_), .c(new_n80_), .O(z06));
  ...
  aoi21  g043(.a(new_n89_), .b(new_n87_), .c(new_n80_), .O(z07));
  nor2   g044(.a(new_n80_), .b(new_n48_), .O(z08));
  inv1   g045(.a(x16), .O(new_n92_));
  nand2  g046(.a(x18), .b(x00), .O(new_n93_));
  inv1   g047(.a(x05), .O(new_n94_));
  nand3  g048(.a(new_n52_), .b(x08), .c(new_n94_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  xnor2a g051(.a(x19), .b(x17), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n53_), .c(x16), .O(new_n99_));
  ...
  nand2  g056(.a(new_n102_), .b(new_n92_), .O(new_n103_));
  nor2   g057(.a(x19), .b(x17), .O(new_n104_));
  nor2   g058(.a(new_n104_), .b(new_n55_), .O(new_n105_));
  inv1   g059(.a(x17), .O(new_n106_));
  nand3  g060(.a(new_n55_), .b(new_n47_), .c(new_n106_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n105_), .c(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n103_), .c(new_n53_), .O(z10));
  nand2  g064(.a(x18), .b(x02), .O(new_n111_));
  nand3  g065(.a(new_n52_), .b(x10), .c(new_n94_), .O(new_n112_));
  ...
  aoi21  g076(.a(new_n52_), .b(x05), .c(x22), .O(new_n123_));
  nand4  g077(.a(new_n123_), .b(new_n60_), .c(new_n55_), .d(new_n47_), .O(new_n124_));
  ...
  nand4  g085(.a(new_n104_), .b(new_n65_), .c(new_n60_), .d(new_n55_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x23), .O(new_n133_));
  nor3   g087(.a(x23), .b(x22), .c(x21), .O(new_n134_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n131_), .c(new_n53_), .O(z13));
  oai21  g092(.a(new_n52_), .b(new_n92_), .c(x05), .O(new_n139_));
  aoi21  g093(.a(new_n134_), .b(new_n108_), .c(new_n75_), .O(new_n140_));
  nand4  g094(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n60_), .O(new_n141_));
  nor2   g095(.a(new_n141_), .b(new_n107_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n140_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n52_), .b(new_n92_), .c(x13), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n115_), .d(new_n104_), .O(new_n151_));
  oai21  g105(.a(new_n142_), .b(new_n83_), .c(new_n151_), .O(new_n152_));
  ...
  oai21  g109(.a(x18), .b(new_n86_), .c(new_n155_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n92_), .O(new_n157_));
  nand2  g111(.a(new_n151_), .b(x26), .O(new_n158_));
  nand4  g112(.a(new_n149_), .b(new_n88_), .c(new_n83_), .d(new_n75_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n116_), .c(new_n158_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n157_), .c(new_n53_), .O(z16));
  nand3  g116(.a(new_n115_), .b(x19), .c(new_n106_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n48_), .d(new_n106_), .O(new_n164_));
