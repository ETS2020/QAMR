...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n73_, new_n76_, new_n77_, new_n78_, new_n80_, new_n81_,
  ...
  nand2  g025(.a(x18), .b(new_n52_), .O(new_n72_));
  nand3  g026(.a(new_n72_), .b(x27), .c(new_n71_), .O(new_n73_));
  nand2  g027(.a(new_n53_), .b(new_n48_), .O(z08));
  oai21  g028(.a(z08), .b(x23), .c(new_n73_), .O(z04));
  ...
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n60_), .O(z06));
  ...
  aoi21  g042(.a(new_n88_), .b(new_n86_), .c(new_n60_), .O(z07));
  ...
  nand2  g060(.a(x18), .b(x13), .O(new_n107_));
  oai22  g061(.a(new_n107_), .b(new_n106_), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  oai21  g065(.a(new_n103_), .b(new_n63_), .c(new_n111_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n53_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n109_), .O(z11));
  inv1   g068(.a(x03), .O(new_n115_));
  oai22  g069(.a(new_n107_), .b(new_n115_), .c(x18), .d(new_n68_), .O(new_n116_));
  ...
  nand3  g080(.a(new_n55_), .b(new_n47_), .c(new_n90_), .O(new_n127_));
  nand2  g081(.a(new_n120_), .b(x23), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n66_), .c(new_n63_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(new_n128_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n126_), .c(new_n53_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  aoi21  g088(.a(x18), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g089(.a(new_n130_), .b(new_n127_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n119_), .c(new_n103_), .O(new_n138_));
  ...
  oai22  g098(.a(new_n107_), .b(new_n144_), .c(x18), .d(new_n80_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n110_), .d(new_n92_), .O(new_n150_));
  ...
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n90_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n48_), .d(new_n90_), .O(new_n164_));
