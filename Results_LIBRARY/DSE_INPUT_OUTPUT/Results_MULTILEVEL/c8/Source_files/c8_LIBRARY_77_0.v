...
module FAU ( 
  ...
  inv1   g016(.a(new_n48_), .O(new_n63_));
  nand2  g017(.a(new_n63_), .b(x27), .O(new_n64_));
  inv1   g018(.a(x23), .O(new_n65_));
  nand3  g019(.a(new_n57_), .b(new_n65_), .c(x18), .O(new_n66_));
  oai21  g020(.a(new_n64_), .b(x12), .c(new_n66_), .O(z04));
  inv1   g021(.a(x24), .O(new_n68_));
  inv1   g022(.a(x18), .O(new_n69_));
  nand2  g023(.a(new_n65_), .b(new_n69_), .O(new_n70_));
  nand3  g024(.a(new_n70_), .b(new_n57_), .c(new_n68_), .O(new_n71_));
  oai21  g025(.a(new_n64_), .b(x13), .c(new_n71_), .O(z05));
  inv1   g026(.a(x14), .O(new_n73_));
  nand2  g027(.a(x27), .b(new_n73_), .O(new_n74_));
  inv1   g028(.a(x25), .O(new_n75_));
  nand2  g029(.a(new_n57_), .b(new_n75_), .O(new_n76_));
  ...
  nand3  g042(.a(new_n88_), .b(new_n84_), .c(new_n63_), .O(z09));
  nand2  g043(.a(x18), .b(x01), .O(new_n90_));
  nand2  g044(.a(x23), .b(new_n69_), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n51_), .c(new_n90_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  inv1   g047(.a(x20), .O(new_n94_));
  nor2   g048(.a(new_n83_), .b(new_n94_), .O(new_n95_));
  nor3   g049(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  or2    g050(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n63_), .c(x16), .O(new_n98_));
  ...
  oai21  g058(.a(new_n96_), .b(new_n56_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n63_), .O(z11));
  nand2  g061(.a(x18), .b(x03), .O(new_n108_));
  oai21  g062(.a(x18), .b(new_n60_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n85_), .O(new_n110_));
  and2   g064(.a(new_n104_), .b(x22), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n83_), .c(new_n94_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n63_), .O(z12));
  ...
  nand2  g074(.a(new_n112_), .b(new_n94_), .O(new_n121_));
  nand2  g075(.a(new_n83_), .b(x16), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n121_), .c(x18), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n65_), .O(new_n124_));
  nand3  g078(.a(new_n113_), .b(x23), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n124_), .c(new_n120_), .O(z13));
  inv1   g080(.a(x13), .O(new_n127_));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(new_n91_), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n85_), .O(new_n130_));
  nand2  g084(.a(new_n113_), .b(x24), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n112_), .c(new_n96_), .O(new_n133_));
  aoi21  g087(.a(new_n133_), .b(new_n131_), .c(new_n69_), .O(new_n134_));
  nor2   g088(.a(new_n68_), .b(new_n65_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n134_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n130_), .O(z14));
  ...
  oai21  g094(.a(new_n75_), .b(new_n85_), .c(x23), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n69_), .O(new_n142_));
  nand2  g096(.a(new_n133_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x23), .b(x22), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n103_), .d(new_n83_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n140_), .O(z15));
  ...
  inv1   g106(.a(x26), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n85_), .c(x23), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n69_), .O(new_n155_));
  nand2  g109(.a(new_n146_), .b(x26), .O(new_n156_));
  nand4  g110(.a(new_n144_), .b(new_n153_), .c(new_n75_), .d(new_n68_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n104_), .c(new_n156_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n155_), .c(new_n152_), .O(z16));
  inv1   g114(.a(x17), .O(new_n161_));
  nand3  g115(.a(new_n103_), .b(x19), .c(new_n161_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n157_), .c(new_n57_), .d(new_n161_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n63_), .O(z17));
endmodule
