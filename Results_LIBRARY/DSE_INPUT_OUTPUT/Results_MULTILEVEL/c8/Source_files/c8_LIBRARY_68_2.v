...
module FAU ( 
  ...
  nand2  g024(.a(new_n48_), .b(x27), .O(new_n71_));
  nand2  g025(.a(new_n53_), .b(new_n47_), .O(new_n72_));
  oai22  g026(.a(new_n72_), .b(x18), .c(new_n71_), .d(x12), .O(z04));
  inv1   g027(.a(x24), .O(new_n74_));
  nand2  g028(.a(new_n47_), .b(x18), .O(new_n75_));
  nand3  g029(.a(new_n75_), .b(new_n53_), .c(new_n74_), .O(new_n76_));
  oai21  g030(.a(new_n71_), .b(x13), .c(new_n76_), .O(z05));
  ...
  nand3  g055(.a(new_n56_), .b(new_n52_), .c(new_n89_), .O(new_n102_));
  oai21  g056(.a(new_n91_), .b(new_n56_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n48_), .c(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n101_), .O(z10));
  inv1   g059(.a(x02), .O(new_n106_));
  oai22  g060(.a(new_n99_), .b(new_n106_), .c(x18), .d(new_n63_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n93_), .O(new_n108_));
  inv1   g062(.a(new_n102_), .O(new_n109_));
  ...
  oai22  g069(.a(new_n99_), .b(new_n115_), .c(x18), .d(new_n66_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n93_), .O(new_n117_));
  inv1   g071(.a(new_n91_), .O(new_n118_));
  nand2  g072(.a(new_n111_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n56_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(new_n119_), .O(new_n122_));
  ...
  oai22  g080(.a(new_n99_), .b(new_n125_), .c(x18), .d(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n93_), .O(new_n128_));
  oai21  g082(.a(new_n121_), .b(new_n118_), .c(x23), .O(new_n129_));
  nor2   g083(.a(x19), .b(x18), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n130_), .c(new_n110_), .d(new_n89_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n138_), .b(new_n93_), .O(new_n139_));
  oai21  g093(.a(new_n74_), .b(new_n93_), .c(x23), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x18), .O(new_n141_));
  nor3   g095(.a(x23), .b(x22), .c(x21), .O(new_n142_));
  aoi21  g096(.a(new_n142_), .b(new_n109_), .c(new_n74_), .O(new_n143_));
  nand3  g097(.a(new_n120_), .b(new_n74_), .c(new_n47_), .O(new_n144_));
  nor2   g098(.a(new_n144_), .b(new_n102_), .O(new_n145_));
  ...
  oai22  g102(.a(new_n99_), .b(new_n148_), .c(x18), .d(new_n78_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n93_), .O(new_n150_));
  nand3  g104(.a(new_n74_), .b(new_n68_), .c(new_n61_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n102_), .c(x25), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n131_), .c(new_n110_), .d(new_n91_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n152_), .c(x18), .O(new_n155_));
  nor2   g109(.a(new_n80_), .b(new_n47_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n155_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n150_), .O(z15));
  inv1   g112(.a(x07), .O(new_n159_));
  oai22  g113(.a(new_n99_), .b(new_n159_), .c(x18), .d(new_n83_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n93_), .O(new_n161_));
  nor2   g115(.a(x20), .b(x19), .O(new_n162_));
  nand4  g116(.a(new_n153_), .b(new_n120_), .c(new_n162_), .d(new_n89_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x26), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n131_), .c(new_n110_), .d(new_n91_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n164_), .c(x18), .O(new_n167_));
  nor2   g121(.a(new_n85_), .b(new_n47_), .O(new_n168_));
  oai21  g122(.a(new_n168_), .b(new_n167_), .c(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n161_), .O(z16));
  nand2  g124(.a(new_n165_), .b(new_n131_), .O(new_n171_));
  nand3  g125(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n172_));
  oai22  g126(.a(new_n172_), .b(new_n171_), .c(new_n53_), .d(new_n89_), .O(new_n173_));
