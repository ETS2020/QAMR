...
module FAU ( 
  ...
  nand3  g054(.a(new_n100_), .b(new_n93_), .c(new_n81_), .O(z10));
  nand2  g055(.a(x18), .b(x02), .O(new_n102_));
  nand3  g056(.a(new_n85_), .b(x10), .c(x00), .O(new_n103_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n81_), .c(x16), .O(new_n110_));
  ...
  aoi21  g068(.a(new_n85_), .b(new_n83_), .c(x22), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n106_), .c(new_n53_), .d(new_n97_), .O(new_n116_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n81_), .O(z12));
  ...
  aoi21  g088(.a(new_n126_), .b(new_n99_), .c(new_n134_), .O(new_n135_));
  nand4  g089(.a(new_n134_), .b(new_n67_), .c(new_n62_), .d(new_n106_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n98_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n135_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n133_), .c(new_n81_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n94_), .O(new_n145_));
  oai21  g099(.a(new_n137_), .b(new_n75_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n81_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n85_), .b(x15), .c(x00), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n90_), .O(new_n152_));
  nand2  g106(.a(new_n145_), .b(x26), .O(new_n153_));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n143_), .c(new_n134_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n108_), .c(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n81_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z16));
  nand3  g112(.a(new_n107_), .b(x19), .c(new_n96_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n54_), .d(new_n96_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n81_), .c(x16), .O(new_n161_));
