...
module FAU ( 
  ...
  nand2  g23(.a(new_n29_), .b(x5), .O(new_n41_));
  ...
  oai21  g29(.a(new_n46_), .b(new_n33_), .c(x5), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n43_), .O(z5));
  oai21  g31(.a(x9), .b(x5), .c(new_n33_), .O(new_n49_));
  ...
  nand3  g41(.a(new_n58_), .b(new_n54_), .c(new_n49_), .O(z6));
endmodule
