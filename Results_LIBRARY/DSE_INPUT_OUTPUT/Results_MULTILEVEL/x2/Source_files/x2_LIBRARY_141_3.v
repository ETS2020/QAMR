...
module FAU ( 
  ...
  oai21  g11(.a(x9), .b(new_n21_), .c(new_n28_), .O(z3));
  oai21  g12(.a(x9), .b(x6), .c(x7), .O(z4));
  inv1   g13(.a(x6), .O(new_n31_));
  oai21  g14(.a(new_n26_), .b(new_n21_), .c(new_n31_), .O(new_n32_));
  inv1   g15(.a(x8), .O(new_n33_));
  nand4  g16(.a(new_n33_), .b(x2), .c(new_n23_), .d(new_n22_), .O(new_n34_));
