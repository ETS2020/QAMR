...
module FAU ( 
  ...
  nand2  g24(.a(new_n41_), .b(new_n27_), .O(new_n42_));
  ...
  oai21  g31(.a(new_n18_), .b(new_n27_), .c(new_n48_), .O(new_n49_));
  nand3  g32(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n50_));
  ...
  nand3  g38(.a(new_n18_), .b(new_n20_), .c(new_n19_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(z6));
endmodule
