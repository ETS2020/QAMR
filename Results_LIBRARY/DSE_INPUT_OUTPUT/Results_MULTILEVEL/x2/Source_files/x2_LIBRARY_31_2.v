...
module FAU ( 
  ...
  oai21  g19(.a(new_n36_), .b(new_n20_), .c(new_n25_), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n34_), .c(z0), .d(x6), .O(z5));
  inv1   g21(.a(x6), .O(new_n39_));
  nand2  g22(.a(z0), .b(new_n39_), .O(new_n40_));
  nand3  g23(.a(new_n24_), .b(new_n32_), .c(new_n31_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(x8), .c(new_n25_), .O(new_n42_));
  nand3  g25(.a(x8), .b(new_n25_), .c(x5), .O(new_n43_));
  inv1   g26(.a(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(x9), .O(new_n45_));
  nand2  g28(.a(new_n20_), .b(new_n25_), .O(new_n46_));
