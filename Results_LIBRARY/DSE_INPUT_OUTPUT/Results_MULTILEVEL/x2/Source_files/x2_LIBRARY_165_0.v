...
module FAU ( 
  ...
  oai21  g23(.a(new_n41_), .b(new_n29_), .c(x1), .O(new_n42_));
  nand2  g24(.a(new_n42_), .b(new_n38_), .O(z5));
  inv1   g25(.a(x2), .O(new_n44_));
  nand3  g26(.a(x7), .b(new_n44_), .c(new_n33_), .O(new_n45_));
  ...
  aoi21  g34(.a(new_n52_), .b(new_n22_), .c(new_n29_), .O(new_n53_));
