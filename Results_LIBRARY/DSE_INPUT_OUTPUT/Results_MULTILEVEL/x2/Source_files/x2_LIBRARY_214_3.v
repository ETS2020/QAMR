...
module FAU ( 
  ...
  oai21  g07(.a(new_n18_), .b(x4), .c(x9), .O(new_n25_));
  nor2   g08(.a(x9), .b(new_n18_), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(new_n27_));
  nand3  g10(.a(new_n27_), .b(new_n25_), .c(new_n19_), .O(z1));
  nand2  g11(.a(x9), .b(x4), .O(new_n29_));
  ...
  nand3  g19(.a(x8), .b(new_n18_), .c(new_n36_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n35_), .c(new_n20_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n23_), .O(z3));
  oai21  g22(.a(x8), .b(x4), .c(x9), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(x7), .c(x6), .O(z4));
  ...
  nor2   g27(.a(new_n20_), .b(new_n19_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n18_), .c(x5), .O(new_n46_));
  inv1   g29(.a(x6), .O(new_n47_));
  aoi21  g30(.a(new_n26_), .b(x3), .c(new_n47_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  oai21  g33(.a(new_n19_), .b(new_n47_), .c(new_n20_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n50_), .O(z5));
  nand2  g35(.a(new_n29_), .b(new_n47_), .O(new_n53_));
  nand3  g36(.a(new_n45_), .b(x5), .c(new_n22_), .O(new_n54_));
  inv1   g37(.a(new_n54_), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n30_), .c(new_n18_), .O(new_n56_));
  nand3  g39(.a(new_n36_), .b(new_n34_), .c(new_n33_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x8), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x9), .c(new_n22_), .O(new_n59_));
  nand4  g42(.a(new_n20_), .b(x8), .c(x4), .d(x3), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x7), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n56_), .c(new_n53_), .O(z6));
endmodule
