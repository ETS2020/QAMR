...
module FAU ( 
  ...
  oai21  g03(.a(x9), .b(x2), .c(new_n20_), .O(new_n21_));
  ...
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n20_), .d(new_n24_), .O(z3));
  nand2  g13(.a(new_n20_), .b(new_n24_), .O(new_n31_));
  inv1   g14(.a(x6), .O(new_n32_));
  nor2   g15(.a(new_n18_), .b(new_n25_), .O(new_n33_));
  ...
  nand4  g20(.a(x9), .b(x8), .c(new_n37_), .d(new_n36_), .O(new_n38_));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n33_), .c(new_n32_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n44_), .c(new_n40_), .O(z5));
  nand3  g31(.a(x9), .b(new_n20_), .c(x5), .O(new_n49_));
  nand4  g32(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x8), .O(new_n52_));
  nand3  g35(.a(new_n24_), .b(new_n37_), .c(new_n36_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x8), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(x9), .c(x7), .O(new_n55_));
  oai21  g38(.a(x9), .b(x8), .c(new_n24_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n20_), .c(new_n32_), .O(new_n57_));
