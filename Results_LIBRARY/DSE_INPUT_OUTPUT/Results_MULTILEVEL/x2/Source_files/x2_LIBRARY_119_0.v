...
module FAU ( 
  ...
  inv1   g19(.a(x7), .O(new_n39_));
  nand3  g20(.a(x9), .b(new_n39_), .c(x5), .O(new_n40_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n27_), .c(new_n26_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x8), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x9), .c(x7), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n43_), .c(new_n32_), .O(z6));
  zero   g29(.O(z2));
  one    g30(.O(z3));
endmodule
