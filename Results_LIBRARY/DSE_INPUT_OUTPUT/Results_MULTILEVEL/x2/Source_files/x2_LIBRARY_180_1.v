...
module FAU ( 
  ...
  nand3  g13(.a(new_n30_), .b(x9), .c(x4), .O(new_n31_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n27_), .c(x6), .O(new_n48_));
  aoi21  g31(.a(new_n46_), .b(new_n20_), .c(new_n48_), .O(new_n49_));
  ...
  aoi21  g41(.a(x9), .b(new_n20_), .c(new_n38_), .O(new_n59_));
