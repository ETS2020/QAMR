...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n24_, new_n25_,
    new_n26_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_, new_n36_,
  ...
  oai21  g06(.a(x9), .b(x2), .c(new_n18_), .O(new_n24_));
  ...
  nor2   g15(.a(new_n25_), .b(new_n19_), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(x7), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n22_), .O(z4));
  ...
  nand3  g31(.a(x9), .b(new_n18_), .c(x5), .O(new_n49_));
  nand4  g32(.a(new_n25_), .b(x7), .c(x4), .d(x3), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x8), .O(new_n52_));
  nand3  g35(.a(new_n21_), .b(new_n37_), .c(new_n36_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x8), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(x9), .c(x7), .O(new_n55_));
  oai21  g38(.a(x9), .b(x8), .c(new_n21_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n18_), .c(new_n32_), .O(new_n57_));
