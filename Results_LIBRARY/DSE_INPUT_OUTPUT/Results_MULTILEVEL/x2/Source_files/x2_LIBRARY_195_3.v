...
module FAU ( 
  ...
  oai21  g07(.a(new_n23_), .b(x3), .c(new_n24_), .O(z1));
  ...
  oai21  g15(.a(new_n19_), .b(new_n32_), .c(new_n26_), .O(new_n33_));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n35_), .c(new_n32_), .O(new_n45_));
  ...
  nand2  g39(.a(new_n24_), .b(x3), .O(new_n57_));
  inv1   g40(.a(x2), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n39_), .c(new_n38_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x8), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x9), .c(x7), .O(new_n61_));
  nor2   g44(.a(new_n27_), .b(new_n32_), .O(new_n62_));
  nand4  g45(.a(new_n62_), .b(new_n61_), .c(new_n57_), .d(new_n56_), .O(z6));
endmodule
