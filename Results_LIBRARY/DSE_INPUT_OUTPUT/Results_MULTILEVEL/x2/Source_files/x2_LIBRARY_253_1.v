...
module FAU ( 
  ...
  oai22  g09(.a(new_n26_), .b(x7), .c(new_n18_), .d(x2), .O(z2));
  inv1   g10(.a(x0), .O(new_n28_));
  inv1   g11(.a(x1), .O(new_n29_));
  nand4  g12(.a(x8), .b(new_n21_), .c(new_n29_), .d(new_n28_), .O(new_n30_));
  ...
  nand2  g21(.a(new_n21_), .b(x5), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(new_n38_), .c(x6), .O(new_n40_));
  aoi21  g23(.a(new_n37_), .b(new_n28_), .c(new_n40_), .O(new_n41_));
  ...
  oai21  g28(.a(new_n41_), .b(new_n20_), .c(new_n45_), .O(z5));
  nand4  g29(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n47_));
  oai21  g30(.a(new_n18_), .b(x8), .c(new_n47_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x7), .O(new_n49_));
  inv1   g32(.a(x5), .O(new_n50_));
  oai21  g33(.a(new_n38_), .b(new_n50_), .c(new_n26_), .O(new_n51_));
  oai21  g34(.a(new_n18_), .b(x2), .c(x6), .O(new_n52_));
  aoi21  g35(.a(new_n51_), .b(new_n21_), .c(new_n52_), .O(new_n53_));
