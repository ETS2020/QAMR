...
module FAU ( 
  ...
  inv1   g09(.a(z2), .O(new_n27_));
  oai21  g10(.a(new_n23_), .b(new_n26_), .c(new_n27_), .O(new_n28_));
  oai21  g11(.a(new_n18_), .b(new_n20_), .c(new_n28_), .O(z4));
  inv1   g12(.a(x0), .O(new_n30_));
  inv1   g13(.a(x1), .O(new_n31_));
  xnor2a g14(.a(x8), .b(x7), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(x2), .c(new_n31_), .d(new_n30_), .O(new_n33_));
  nand3  g16(.a(x8), .b(new_n23_), .c(x5), .O(new_n34_));
  ...
  nand2  g24(.a(new_n27_), .b(new_n26_), .O(new_n42_));
  nand3  g25(.a(x9), .b(new_n23_), .c(x5), .O(new_n43_));
  nand4  g26(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n44_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n46_), .c(new_n42_), .O(z6));
endmodule
