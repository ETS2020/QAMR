...
module FAU ( 
  ...
  oai21  g05(.a(new_n21_), .b(x5), .c(new_n22_), .O(z1));
  ...
  aoi21  g31(.a(x9), .b(x5), .c(new_n38_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n48_), .c(new_n44_), .O(z5));
  nand2  g33(.a(x9), .b(x7), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n40_), .O(new_n52_));
  ...
  nand3  g40(.a(new_n57_), .b(new_n53_), .c(new_n49_), .O(z6));
endmodule
