...
module FAU ( 
  ...
  oai21  g11(.a(new_n19_), .b(x6), .c(new_n28_), .O(z2));
  oai21  g12(.a(x8), .b(new_n20_), .c(x9), .O(new_n30_));
  nor2   g13(.a(x1), .b(x0), .O(new_n31_));
  nor2   g14(.a(new_n21_), .b(x2), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(new_n20_), .O(z3));
  nor2   g16(.a(new_n19_), .b(new_n21_), .O(new_n34_));
  ...
  nand3  g24(.a(new_n34_), .b(new_n20_), .c(x5), .O(new_n42_));
  ...
  nand3  g43(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(z6));
endmodule
