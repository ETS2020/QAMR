...
module FAU ( 
  ...
  nand4  g12(.a(new_n29_), .b(new_n27_), .c(new_n26_), .d(new_n22_), .O(z3));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n31_), .c(new_n20_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n42_), .c(new_n38_), .O(z5));
  nand3  g29(.a(x9), .b(new_n22_), .c(x5), .O(new_n47_));
  nand2  g30(.a(x4), .b(x3), .O(new_n48_));
  nand3  g31(.a(new_n18_), .b(x7), .c(x6), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x8), .O(new_n51_));
  inv1   g34(.a(x2), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n35_), .c(new_n34_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x8), .O(new_n54_));
  nand4  g37(.a(new_n54_), .b(x9), .c(x7), .d(x6), .O(new_n55_));
  oai21  g38(.a(x9), .b(x8), .c(x6), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n22_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(new_n51_), .O(z6));
endmodule
