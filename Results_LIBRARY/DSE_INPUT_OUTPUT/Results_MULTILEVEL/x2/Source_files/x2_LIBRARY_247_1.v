...
module FAU ( 
  ...
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(x1), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x7), .O(z4));
  inv1   g18(.a(x0), .O(new_n36_));
  nand3  g19(.a(new_n19_), .b(x2), .c(new_n36_), .O(new_n37_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n33_), .c(new_n32_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z5));
  oai21  g30(.a(new_n24_), .b(x1), .c(new_n32_), .O(new_n48_));
  nand2  g31(.a(x9), .b(new_n19_), .O(new_n49_));
  nand4  g32(.a(new_n22_), .b(x8), .c(x4), .d(x3), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(x7), .c(x1), .O(new_n52_));
  nand3  g35(.a(x9), .b(x8), .c(x5), .O(new_n53_));
  oai21  g36(.a(x9), .b(x8), .c(new_n53_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n24_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n52_), .c(new_n48_), .O(z6));
endmodule
