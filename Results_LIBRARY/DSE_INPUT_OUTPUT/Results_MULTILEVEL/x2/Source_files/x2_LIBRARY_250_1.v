...
module FAU ( 
  ...
  nand3  g13(.a(new_n30_), .b(x9), .c(x5), .O(new_n31_));
  ...
  nand3  g19(.a(new_n36_), .b(new_n31_), .c(new_n29_), .O(z3));
  inv1   g20(.a(x6), .O(new_n38_));
  nand3  g21(.a(new_n25_), .b(x7), .c(new_n38_), .O(new_n39_));
  nand2  g22(.a(new_n18_), .b(new_n21_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n39_), .c(new_n31_), .O(z4));
  nand4  g24(.a(new_n30_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n42_));
  aoi21  g25(.a(x8), .b(new_n21_), .c(new_n20_), .O(new_n43_));
  ...
  aoi21  g31(.a(new_n48_), .b(new_n18_), .c(new_n38_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n45_), .O(z5));
  xnor2a g33(.a(x9), .b(x8), .O(new_n51_));
  ...
  aoi21  g40(.a(x9), .b(new_n20_), .c(new_n38_), .O(new_n58_));
