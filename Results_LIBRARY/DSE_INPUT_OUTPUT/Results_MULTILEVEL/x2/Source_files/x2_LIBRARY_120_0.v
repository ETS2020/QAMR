...
module FAU ( 
  ...
  nor2   g30(.a(x7), .b(new_n23_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n45_), .c(new_n41_), .O(z5));
  nand2  g33(.a(new_n18_), .b(new_n20_), .O(new_n51_));
  oai21  g34(.a(new_n38_), .b(new_n23_), .c(new_n51_), .O(new_n52_));
  ...
  aoi21  g41(.a(new_n18_), .b(new_n23_), .c(new_n46_), .O(new_n59_));
