...
module FAU ( 
  ...
  oai21  g05(.a(new_n22_), .b(x1), .c(x7), .O(new_n23_));
  ...
  nand3  g13(.a(new_n22_), .b(x8), .c(new_n24_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(new_n30_), .c(new_n18_), .O(new_n32_));
  oai21  g15(.a(x7), .b(new_n18_), .c(new_n32_), .O(z3));
  nand2  g16(.a(x9), .b(x8), .O(new_n34_));
  nand4  g17(.a(new_n34_), .b(x7), .c(x6), .d(new_n18_), .O(z4));
  nand3  g18(.a(new_n19_), .b(new_n24_), .c(new_n18_), .O(new_n36_));
  oai21  g19(.a(new_n34_), .b(new_n24_), .c(new_n36_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(x2), .c(new_n28_), .O(new_n38_));
  inv1   g21(.a(x4), .O(new_n39_));
  nand3  g22(.a(new_n22_), .b(new_n39_), .c(x3), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n18_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(x7), .O(new_n42_));
  nand2  g25(.a(new_n22_), .b(new_n19_), .O(new_n43_));
  nand4  g26(.a(x9), .b(x8), .c(new_n24_), .d(x5), .O(new_n44_));
  ...
  oai21  g31(.a(new_n24_), .b(new_n18_), .c(new_n48_), .O(new_n49_));
  inv1   g32(.a(x5), .O(new_n50_));
  oai21  g33(.a(new_n34_), .b(new_n50_), .c(new_n43_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n24_), .O(new_n52_));
  oai21  g35(.a(x2), .b(x0), .c(x8), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x9), .O(new_n54_));
  nand4  g37(.a(new_n22_), .b(x8), .c(x4), .d(x3), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(x7), .c(new_n18_), .O(new_n57_));
