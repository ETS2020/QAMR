...
module FAU ( 
  ...
  oai21  g10(.a(new_n19_), .b(x1), .c(new_n27_), .O(z2));
  ...
  aoi22  g21(.a(new_n38_), .b(x1), .c(new_n19_), .d(new_n20_), .O(new_n39_));
