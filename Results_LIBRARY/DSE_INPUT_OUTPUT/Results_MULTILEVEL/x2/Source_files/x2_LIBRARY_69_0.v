...
module FAU ( 
  ...
  nor2   g15(.a(x9), .b(x3), .O(new_n33_));
  oai22  g16(.a(new_n33_), .b(new_n32_), .c(new_n18_), .d(new_n25_), .O(z4));
  ...
  nand4  g39(.a(new_n56_), .b(new_n50_), .c(new_n47_), .d(x6), .O(z6));
endmodule
