...
module FAU ( 
  ...
  oai21  g24(.a(new_n32_), .b(new_n41_), .c(new_n27_), .O(new_n42_));
  ...
  nand3  g33(.a(new_n28_), .b(new_n37_), .c(new_n36_), .O(new_n51_));
  ...
  aoi21  g39(.a(new_n24_), .b(new_n20_), .c(new_n56_), .O(new_n57_));
