...
module FAU ( 
  ...
  nand4  g09(.a(new_n26_), .b(new_n25_), .c(new_n24_), .d(new_n23_), .O(new_n27_));
  nand2  g10(.a(new_n27_), .b(x8), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n19_), .O(z3));
  inv1   g12(.a(x6), .O(new_n30_));
  oai21  g13(.a(new_n18_), .b(new_n26_), .c(new_n19_), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n30_), .O(new_n32_));
  oai21  g15(.a(x9), .b(x8), .c(new_n26_), .O(new_n33_));
  ...
  nand3  g20(.a(x8), .b(new_n26_), .c(x5), .O(new_n38_));
  ...
  oai21  g28(.a(x9), .b(x8), .c(new_n30_), .O(new_n46_));
  nand4  g29(.a(x9), .b(new_n25_), .c(new_n24_), .d(new_n23_), .O(new_n47_));
  nand3  g30(.a(new_n19_), .b(x4), .c(x3), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x7), .O(new_n50_));
  nand4  g33(.a(x9), .b(x8), .c(new_n26_), .d(x5), .O(new_n51_));
  nand4  g34(.a(new_n51_), .b(new_n50_), .c(new_n46_), .d(z1), .O(z6));
endmodule
