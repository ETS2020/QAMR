...
module FAU ( 
  ...
  nand3  g09(.a(new_n26_), .b(x7), .c(x4), .O(new_n27_));
  nand2  g10(.a(new_n27_), .b(x9), .O(new_n28_));
  nor2   g11(.a(x1), .b(x0), .O(new_n29_));
  nor2   g12(.a(new_n26_), .b(x2), .O(new_n30_));
