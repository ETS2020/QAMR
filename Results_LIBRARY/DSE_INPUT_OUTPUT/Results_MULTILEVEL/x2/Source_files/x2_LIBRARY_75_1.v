...
module FAU ( 
  ...
  nand3  g14(.a(new_n31_), .b(x9), .c(x3), .O(new_n32_));
  ...
  nand4  g35(.a(new_n52_), .b(new_n48_), .c(new_n45_), .d(x6), .O(z5));
  ...
  aoi21  g44(.a(x9), .b(new_n28_), .c(new_n39_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n61_), .c(new_n56_), .O(z6));
endmodule
