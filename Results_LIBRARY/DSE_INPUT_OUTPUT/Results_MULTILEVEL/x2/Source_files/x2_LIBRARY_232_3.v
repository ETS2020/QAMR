...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n21_, new_n22_, new_n23_, new_n26_, new_n28_,
  ...
  oai21  g03(.a(new_n19_), .b(x2), .c(x7), .O(new_n21_));
  ...
  and2   g11(.a(x9), .b(x8), .O(new_n29_));
  oai21  g12(.a(new_n29_), .b(new_n28_), .c(new_n18_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(x7), .O(z4));
  nor3   g14(.a(x8), .b(x1), .c(x0), .O(new_n32_));
  oai21  g15(.a(new_n32_), .b(x7), .c(x2), .O(new_n33_));
  ...
  aoi21  g22(.a(new_n39_), .b(new_n29_), .c(new_n28_), .O(new_n40_));
  ...
  nand3  g32(.a(new_n49_), .b(new_n44_), .c(x6), .O(z6));
endmodule
