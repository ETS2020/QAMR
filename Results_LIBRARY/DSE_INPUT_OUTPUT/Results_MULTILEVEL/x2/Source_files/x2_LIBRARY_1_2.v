...
module FAU ( 
  ...
  nand2  g17(.a(z0), .b(new_n27_), .O(new_n35_));
  nand3  g18(.a(x9), .b(x8), .c(x5), .O(new_n36_));
  inv1   g19(.a(new_n36_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n20_), .c(new_n24_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n35_), .c(new_n34_), .O(z5));
  nor3   g22(.a(x2), .b(x1), .c(x0), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(new_n21_), .c(x7), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n38_), .c(new_n35_), .O(z6));
endmodule
