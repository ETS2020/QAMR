...
module FAU ( 
  ...
  oai21  g10(.a(new_n19_), .b(new_n21_), .c(x1), .O(new_n28_));
  oai21  g11(.a(x8), .b(new_n21_), .c(x9), .O(new_n29_));
  inv1   g12(.a(x0), .O(new_n30_));
  inv1   g13(.a(x2), .O(new_n31_));
  nand4  g14(.a(x8), .b(new_n21_), .c(new_n31_), .d(new_n30_), .O(new_n32_));
  inv1   g15(.a(new_n32_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n29_), .c(new_n28_), .O(z3));
  nand2  g17(.a(new_n19_), .b(x1), .O(new_n35_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n40_), .c(x6), .O(new_n45_));
  ...
  nand3  g36(.a(new_n31_), .b(new_n18_), .c(new_n30_), .O(new_n54_));
  ...
  nand4  g41(.a(new_n58_), .b(new_n53_), .c(new_n35_), .d(x6), .O(z6));
endmodule
