...
module FAU ( 
  ...
  nand3  g28(.a(new_n45_), .b(new_n41_), .c(new_n25_), .O(z5));
  nand2  g29(.a(x9), .b(x7), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(x0), .c(new_n18_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n30_), .O(new_n49_));
  nand2  g32(.a(x9), .b(new_n20_), .O(new_n50_));
  nand4  g33(.a(new_n27_), .b(x8), .c(x4), .d(x3), .O(new_n51_));
  ...
  aoi21  g38(.a(new_n55_), .b(new_n26_), .c(new_n42_), .O(new_n56_));
