...
module FAU ( 
  ...
  aoi21  g19(.a(new_n36_), .b(new_n25_), .c(x1), .O(new_n37_));
  ...
  oai21  g27(.a(new_n40_), .b(new_n18_), .c(new_n44_), .O(z5));
  nand4  g28(.a(new_n19_), .b(x8), .c(x4), .d(x3), .O(new_n46_));
  oai21  g29(.a(new_n19_), .b(x8), .c(new_n46_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x7), .O(new_n48_));
  nand3  g31(.a(x9), .b(x8), .c(x5), .O(new_n49_));
  oai21  g32(.a(x9), .b(x8), .c(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n19_), .b(x2), .c(x6), .O(new_n51_));
  aoi21  g34(.a(new_n50_), .b(new_n20_), .c(new_n51_), .O(new_n52_));
