...
module FAU ( 
  ...
  nand4  g08(.a(new_n26_), .b(new_n25_), .c(new_n24_), .d(new_n23_), .O(new_n27_));
  nand2  g09(.a(new_n27_), .b(x8), .O(new_n28_));
  nand2  g10(.a(new_n28_), .b(new_n19_), .O(z3));
  inv1   g11(.a(x6), .O(new_n30_));
  oai21  g12(.a(new_n18_), .b(new_n26_), .c(new_n19_), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(new_n30_), .O(new_n32_));
  nand2  g14(.a(new_n19_), .b(new_n18_), .O(new_n33_));
  nor2   g15(.a(new_n19_), .b(new_n18_), .O(new_n34_));
  inv1   g16(.a(new_n34_), .O(new_n35_));
  nand4  g17(.a(new_n35_), .b(new_n33_), .c(new_n32_), .d(x7), .O(z4));
  nand3  g18(.a(x9), .b(x8), .c(x7), .O(new_n37_));
  oai21  g19(.a(x8), .b(x7), .c(new_n37_), .O(new_n38_));
  nand4  g20(.a(new_n38_), .b(x2), .c(new_n24_), .d(new_n23_), .O(new_n39_));
