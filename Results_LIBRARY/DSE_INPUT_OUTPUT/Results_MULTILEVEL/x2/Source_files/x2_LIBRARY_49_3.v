...
module FAU ( 
  ...
  oai21  g08(.a(new_n23_), .b(x0), .c(new_n25_), .O(z1));
  nand2  g09(.a(x9), .b(x0), .O(new_n27_));
  ...
  nand3  g21(.a(new_n18_), .b(new_n19_), .c(x0), .O(new_n39_));
  ...
  oai21  g37(.a(new_n50_), .b(x0), .c(new_n54_), .O(z5));
