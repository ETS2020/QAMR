...
module FAU ( 
  ...
  nor2   g12(.a(new_n18_), .b(new_n29_), .O(new_n30_));
  inv1   g13(.a(x6), .O(new_n31_));
  nor2   g14(.a(new_n20_), .b(new_n31_), .O(new_n32_));
  nand3  g15(.a(x9), .b(x8), .c(new_n29_), .O(new_n33_));
  oai21  g16(.a(new_n32_), .b(new_n30_), .c(new_n33_), .O(z4));
  inv1   g17(.a(x0), .O(new_n35_));
  inv1   g18(.a(x2), .O(new_n36_));
  nand3  g19(.a(x9), .b(x8), .c(x7), .O(new_n37_));
  aoi21  g20(.a(new_n37_), .b(new_n23_), .c(new_n36_), .O(new_n38_));
  nand4  g21(.a(x9), .b(x8), .c(new_n20_), .d(x5), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(x6), .O(new_n40_));
  aoi21  g23(.a(new_n38_), .b(new_n35_), .c(new_n40_), .O(new_n41_));
  ...
  nand2  g29(.a(new_n40_), .b(new_n29_), .O(new_n47_));
  xnor2a g30(.a(x9), .b(x7), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n22_), .O(new_n49_));
  nand3  g32(.a(x9), .b(new_n36_), .c(new_n35_), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n18_), .b(new_n31_), .c(new_n30_), .O(new_n54_));
  nand4  g37(.a(new_n54_), .b(new_n53_), .c(new_n49_), .d(new_n47_), .O(z6));
endmodule
