...
module FAU ( 
  ...
  oai21  g12(.a(new_n30_), .b(x7), .c(new_n21_), .O(z3));
  ...
  oai21  g18(.a(new_n20_), .b(x7), .c(new_n21_), .O(new_n37_));
  inv1   g19(.a(x5), .O(new_n38_));
  nor2   g20(.a(x7), .b(new_n38_), .O(new_n39_));
  aoi21  g21(.a(new_n39_), .b(new_n22_), .c(new_n32_), .O(new_n40_));
  nand3  g22(.a(new_n40_), .b(new_n37_), .c(new_n36_), .O(z5));
  oai21  g23(.a(new_n21_), .b(x7), .c(new_n20_), .O(new_n42_));
  nor3   g24(.a(x2), .b(x1), .c(x0), .O(new_n43_));
  oai21  g25(.a(new_n43_), .b(new_n21_), .c(x7), .O(new_n44_));
  nand3  g26(.a(new_n44_), .b(new_n42_), .c(new_n40_), .O(z6));
  one    g27(.O(z0));
endmodule
