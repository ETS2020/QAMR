...
module FAU ( 
  ...
  nand4  g14(.a(new_n31_), .b(x8), .c(new_n22_), .d(new_n30_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(x6), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n29_), .O(z3));
  oai21  g17(.a(x9), .b(x6), .c(new_n22_), .O(new_n35_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n18_), .c(x6), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n44_), .O(z5));
  nand3  g32(.a(x9), .b(x8), .c(x5), .O(new_n50_));
  nand3  g33(.a(new_n18_), .b(new_n25_), .c(x6), .O(new_n51_));
  ...
  nand3  g41(.a(new_n58_), .b(new_n53_), .c(x6), .O(z6));
endmodule
