...
module FAU ( 
  ...
  oai21  g10(.a(new_n19_), .b(new_n21_), .c(x5), .O(new_n28_));
  ...
  oai21  g24(.a(new_n25_), .b(x7), .c(x9), .O(new_n42_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n19_), .c(new_n18_), .O(new_n53_));
  nand3  g36(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(x8), .c(new_n21_), .O(new_n55_));
  nand3  g38(.a(x8), .b(new_n21_), .c(x5), .O(new_n56_));
  inv1   g39(.a(new_n56_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n55_), .c(x9), .O(new_n58_));
