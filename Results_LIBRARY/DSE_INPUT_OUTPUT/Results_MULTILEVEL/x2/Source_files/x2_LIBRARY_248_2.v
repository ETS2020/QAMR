...
module FAU ( 
  ...
  nand4  g15(.a(new_n33_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n34_));
  ...
  nand2  g21(.a(new_n21_), .b(new_n39_), .O(new_n40_));
  nand3  g22(.a(new_n28_), .b(new_n27_), .c(new_n26_), .O(new_n41_));
  ...
  nand3  g28(.a(new_n46_), .b(new_n45_), .c(new_n40_), .O(z6));
  one    g29(.O(z0));
endmodule
