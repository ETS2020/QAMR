...
module FAU ( 
  ...
  nor2   g04(.a(new_n18_), .b(x7), .O(new_n23_));
  nor3   g05(.a(x2), .b(x1), .c(x0), .O(new_n24_));
  nand3  g06(.a(new_n24_), .b(new_n23_), .c(new_n19_), .O(z3));
  nor2   g07(.a(x9), .b(x8), .O(new_n26_));
  inv1   g08(.a(x6), .O(new_n27_));
  inv1   g09(.a(x7), .O(new_n28_));
  nor2   g10(.a(new_n28_), .b(new_n27_), .O(new_n29_));
  nand2  g11(.a(x9), .b(x8), .O(new_n30_));
  oai21  g12(.a(new_n29_), .b(new_n26_), .c(new_n30_), .O(z4));
