...
module FAU ( 
  ...
  oai21  g06(.a(x9), .b(x1), .c(new_n18_), .O(new_n24_));
  ...
  nand3  g14(.a(new_n20_), .b(new_n31_), .c(new_n30_), .O(new_n32_));
  inv1   g15(.a(new_n32_), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(x1), .c(new_n18_), .O(z3));
  inv1   g17(.a(x6), .O(new_n35_));
  aoi21  g18(.a(x9), .b(x8), .c(new_n35_), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(new_n18_), .c(new_n22_), .O(z4));
  nand2  g20(.a(new_n19_), .b(new_n18_), .O(new_n38_));
  nand4  g21(.a(x9), .b(x8), .c(x7), .d(new_n21_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(x2), .c(new_n30_), .O(new_n41_));
  oai21  g24(.a(x7), .b(new_n21_), .c(new_n35_), .O(new_n42_));
  nand3  g25(.a(x9), .b(x8), .c(x5), .O(new_n43_));
  nand2  g26(.a(new_n25_), .b(new_n19_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n21_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n18_), .O(new_n46_));
  inv1   g29(.a(x3), .O(new_n47_));
  oai21  g30(.a(x4), .b(new_n47_), .c(x8), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n25_), .c(x7), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(new_n46_), .c(new_n42_), .d(new_n41_), .O(z5));
  aoi21  g33(.a(new_n44_), .b(new_n43_), .c(x7), .O(new_n51_));
  ...
  oai21  g38(.a(new_n25_), .b(x8), .c(new_n55_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x7), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n54_), .c(new_n42_), .O(z6));
endmodule
