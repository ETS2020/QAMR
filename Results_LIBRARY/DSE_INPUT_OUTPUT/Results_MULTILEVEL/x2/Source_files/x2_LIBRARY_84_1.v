...
module FAU ( 
  ...
  oai21  g21(.a(new_n37_), .b(new_n18_), .c(new_n26_), .O(new_n39_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n45_), .c(new_n24_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n40_), .O(z5));
  nand2  g32(.a(new_n20_), .b(new_n19_), .O(new_n50_));
  oai21  g33(.a(new_n37_), .b(new_n46_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n18_), .O(new_n52_));
  nand3  g35(.a(new_n33_), .b(new_n31_), .c(new_n30_), .O(new_n53_));
  ...
  nand3  g40(.a(new_n57_), .b(new_n52_), .c(x6), .O(z6));
endmodule
