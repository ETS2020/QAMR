...
module FAU ( 
  ...
  nand3  g27(.a(new_n44_), .b(new_n19_), .c(x6), .O(new_n45_));
  inv1   g28(.a(new_n45_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z5));
  nand2  g30(.a(x9), .b(x7), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(x0), .c(new_n30_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n18_), .O(new_n50_));
  nand2  g33(.a(x9), .b(new_n21_), .O(new_n51_));
  ...
  oai21  g39(.a(x9), .b(x8), .c(new_n56_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(new_n26_), .c(new_n55_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n54_), .c(new_n50_), .O(z6));
endmodule
