...
module FAU ( 
  ...
  oai21  g14(.a(new_n31_), .b(new_n29_), .c(new_n20_), .O(new_n32_));
  oai21  g15(.a(x9), .b(new_n20_), .c(new_n32_), .O(z3));
  nand3  g16(.a(new_n18_), .b(x7), .c(x6), .O(z4));
  inv1   g17(.a(x6), .O(new_n35_));
  nand2  g18(.a(new_n23_), .b(new_n35_), .O(new_n36_));
  inv1   g19(.a(x3), .O(new_n37_));
  oai21  g20(.a(x4), .b(new_n37_), .c(new_n18_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x7), .O(new_n39_));
  nand3  g22(.a(x2), .b(new_n28_), .c(new_n27_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(x9), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n21_), .O(new_n42_));
  nand4  g25(.a(x9), .b(x8), .c(new_n20_), .d(x5), .O(new_n43_));
  nand4  g26(.a(new_n43_), .b(new_n42_), .c(new_n39_), .d(new_n36_), .O(z5));
  nand3  g27(.a(x9), .b(x8), .c(x5), .O(new_n45_));
  inv1   g28(.a(new_n45_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n24_), .c(new_n20_), .O(new_n47_));
  nor2   g30(.a(x9), .b(new_n21_), .O(new_n48_));
