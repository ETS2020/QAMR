...
module FAU ( 
  ...
  nand2  g25(.a(x8), .b(new_n21_), .O(new_n43_));
  aoi21  g26(.a(new_n43_), .b(new_n42_), .c(new_n18_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n38_), .c(x5), .O(new_n45_));
  ...
  oai21  g34(.a(new_n51_), .b(x7), .c(x6), .O(new_n52_));
  ...
  nand4  g39(.a(x9), .b(new_n34_), .c(new_n33_), .d(new_n32_), .O(new_n57_));
  ...
  aoi21  g44(.a(x9), .b(new_n20_), .c(new_n61_), .O(new_n62_));
