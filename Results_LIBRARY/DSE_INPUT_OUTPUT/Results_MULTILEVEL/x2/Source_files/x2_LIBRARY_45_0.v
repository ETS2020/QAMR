...
module FAU ( 
  ...
  nand2  g10(.a(new_n18_), .b(new_n20_), .O(new_n29_));
  ...
  nand4  g15(.a(new_n33_), .b(x2), .c(new_n32_), .d(new_n20_), .O(new_n34_));
  nand3  g16(.a(x8), .b(new_n22_), .c(x5), .O(new_n35_));
  ...
  oai21  g23(.a(new_n41_), .b(new_n38_), .c(x0), .O(new_n42_));
  nand2  g24(.a(new_n42_), .b(new_n37_), .O(z5));
  ...
  oai21  g30(.a(new_n18_), .b(x8), .c(new_n48_), .O(new_n49_));
  nand2  g31(.a(new_n49_), .b(x7), .O(new_n50_));
  nand3  g32(.a(x9), .b(x8), .c(x5), .O(new_n51_));
  oai21  g33(.a(x9), .b(x8), .c(new_n51_), .O(new_n52_));
  aoi21  g34(.a(new_n52_), .b(new_n22_), .c(new_n38_), .O(new_n53_));
