...
module FAU ( 
  ...
  nand3  g07(.a(new_n18_), .b(new_n24_), .c(new_n20_), .O(new_n25_));
  oai21  g08(.a(new_n18_), .b(new_n20_), .c(new_n25_), .O(z2));
  ...
  nand4  g29(.a(new_n46_), .b(new_n41_), .c(new_n25_), .d(x6), .O(z6));
endmodule
