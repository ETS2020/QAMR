...
module FAU ( 
  ...
  aoi21  g09(.a(new_n26_), .b(x6), .c(x9), .O(z2));
  nand3  g10(.a(new_n25_), .b(x7), .c(x6), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(x9), .O(new_n29_));
  inv1   g12(.a(x2), .O(new_n30_));
  nor2   g13(.a(x1), .b(x0), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(x8), .c(new_n21_), .d(new_n30_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(x6), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n29_), .O(z3));
  oai21  g17(.a(x9), .b(x6), .c(new_n21_), .O(new_n35_));
  oai21  g18(.a(x8), .b(new_n20_), .c(x9), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n35_), .O(z4));
  inv1   g20(.a(x0), .O(new_n38_));
  inv1   g21(.a(x1), .O(new_n39_));
  nand3  g22(.a(x9), .b(x8), .c(x7), .O(new_n40_));
  oai21  g23(.a(new_n26_), .b(new_n20_), .c(new_n40_), .O(new_n41_));
  ...
  nand3  g28(.a(new_n45_), .b(new_n18_), .c(x6), .O(new_n46_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n18_), .c(x6), .O(new_n53_));
  nand3  g36(.a(new_n30_), .b(new_n39_), .c(new_n38_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(x8), .c(new_n21_), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n48_), .c(x9), .O(new_n56_));
