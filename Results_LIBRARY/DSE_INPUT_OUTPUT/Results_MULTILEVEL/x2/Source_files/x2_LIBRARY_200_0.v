...
module FAU ( 
  ...
  nor2   g07(.a(new_n18_), .b(x9), .O(new_n25_));
  ...
  nor2   g19(.a(new_n36_), .b(new_n19_), .O(new_n37_));
  ...
  aoi21  g31(.a(new_n48_), .b(new_n37_), .c(new_n35_), .O(new_n49_));
  ...
  nand3  g36(.a(new_n28_), .b(new_n30_), .c(new_n29_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(x8), .c(new_n36_), .O(new_n55_));
  nand4  g38(.a(new_n36_), .b(x8), .c(x4), .d(x3), .O(new_n56_));
