...
module FAU ( 
  ...
  nand4  g22(.a(new_n30_), .b(x9), .c(x8), .d(x2), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(new_n27_), .d(x6), .O(z5));
  ...
  nand4  g27(.a(new_n44_), .b(new_n43_), .c(new_n27_), .d(x6), .O(z6));
endmodule
