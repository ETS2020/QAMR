...
module FAU ( 
  ...
  nand3  g34(.a(x9), .b(new_n20_), .c(x5), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x8), .O(new_n54_));
  nand2  g37(.a(new_n22_), .b(x3), .O(new_n55_));
  inv1   g38(.a(x2), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n37_), .c(new_n36_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x8), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x9), .c(x7), .O(new_n59_));
  nor2   g42(.a(new_n25_), .b(new_n30_), .O(new_n60_));
  nand4  g43(.a(new_n60_), .b(new_n59_), .c(new_n55_), .d(new_n54_), .O(z6));
endmodule
