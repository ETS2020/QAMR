...
module FAU ( 
  ...
  oai21  g12(.a(x9), .b(x7), .c(new_n31_), .O(new_n32_));
  nand3  g13(.a(x9), .b(x8), .c(x5), .O(new_n33_));
  aoi21  g14(.a(new_n33_), .b(x9), .c(x7), .O(new_n34_));
  inv1   g15(.a(x3), .O(new_n35_));
  oai21  g16(.a(x4), .b(new_n35_), .c(x8), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n18_), .c(new_n34_), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n32_), .c(new_n30_), .O(z5));
  nand3  g19(.a(x9), .b(new_n20_), .c(x5), .O(new_n39_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n27_), .c(new_n26_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(x8), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x9), .c(x7), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n42_), .c(new_n32_), .O(z6));
  zero   g28(.O(z2));
  one    g29(.O(z3));
endmodule
