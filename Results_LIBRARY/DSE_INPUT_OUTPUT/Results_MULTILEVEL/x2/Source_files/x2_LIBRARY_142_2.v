...
module FAU ( 
  ...
  nor3   g27(.a(x9), .b(x8), .c(x7), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n32_), .c(new_n18_), .O(new_n46_));
  inv1   g29(.a(x5), .O(new_n47_));
  nand2  g30(.a(x8), .b(new_n22_), .O(new_n48_));
  ...
  nand2  g36(.a(new_n53_), .b(new_n46_), .O(z6));
endmodule
