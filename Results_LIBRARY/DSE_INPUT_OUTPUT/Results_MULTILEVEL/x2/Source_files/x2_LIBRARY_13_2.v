...
module FAU ( 
  ...
  oai21  g03(.a(x9), .b(x4), .c(new_n20_), .O(new_n21_));
  ...
  oai21  g13(.a(new_n30_), .b(x4), .c(new_n20_), .O(z3));
  nand2  g14(.a(x9), .b(x8), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(x7), .c(x6), .O(z4));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  nand2  g18(.a(new_n25_), .b(new_n20_), .O(new_n36_));
  oai21  g19(.a(new_n32_), .b(new_n20_), .c(new_n36_), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n38_));
  inv1   g21(.a(x6), .O(new_n39_));
  oai21  g22(.a(x7), .b(new_n24_), .c(new_n39_), .O(new_n40_));
  nand2  g23(.a(x7), .b(x3), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n36_), .c(x4), .O(new_n42_));
  nor2   g25(.a(x8), .b(new_n20_), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n42_), .c(new_n18_), .O(new_n44_));
  inv1   g27(.a(x5), .O(new_n45_));
  oai21  g28(.a(new_n32_), .b(new_n45_), .c(new_n24_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(new_n44_), .c(new_n40_), .d(new_n38_), .O(z5));
  nand2  g31(.a(new_n18_), .b(new_n25_), .O(new_n49_));
  oai21  g32(.a(new_n32_), .b(new_n45_), .c(new_n49_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n20_), .c(new_n24_), .O(new_n51_));
  nand3  g34(.a(new_n28_), .b(new_n35_), .c(new_n34_), .O(new_n52_));
  ...
  nand3  g39(.a(new_n56_), .b(new_n51_), .c(new_n40_), .O(z6));
endmodule
