...
module FAU ( 
  ...
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n28_), .d(new_n22_), .O(z3));
  nand3  g14(.a(new_n25_), .b(x7), .c(x6), .O(z4));
  nand2  g15(.a(new_n20_), .b(new_n19_), .O(new_n33_));
  inv1   g16(.a(x4), .O(new_n34_));
  nand3  g17(.a(new_n20_), .b(new_n34_), .c(x3), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(x6), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  inv1   g20(.a(x6), .O(new_n38_));
  oai21  g21(.a(x8), .b(x7), .c(x9), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  inv1   g23(.a(x0), .O(new_n41_));
  inv1   g24(.a(x1), .O(new_n42_));
  nand4  g25(.a(new_n22_), .b(x2), .c(new_n42_), .d(new_n41_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n19_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x9), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n40_), .c(new_n37_), .d(new_n33_), .O(z5));
  nand2  g29(.a(x9), .b(new_n19_), .O(new_n47_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n40_), .c(new_n26_), .O(z6));
endmodule
