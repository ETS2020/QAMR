...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(x5), .c(new_n31_), .O(z4));
  ...
  nand4  g24(.a(new_n41_), .b(new_n37_), .c(new_n30_), .d(x6), .O(z5));
  nand2  g25(.a(new_n30_), .b(new_n29_), .O(new_n43_));
  ...
  nand3  g30(.a(new_n47_), .b(x9), .c(new_n44_), .O(new_n48_));
