...
module FAU ( 
  ...
  oai21  g16(.a(new_n18_), .b(x3), .c(new_n33_), .O(z3));
  ...
  nand2  g35(.a(new_n24_), .b(new_n41_), .O(new_n53_));
  nand3  g36(.a(new_n42_), .b(x5), .c(new_n37_), .O(new_n54_));
  inv1   g37(.a(new_n54_), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n25_), .c(new_n20_), .O(new_n56_));
  nand3  g39(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x8), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x9), .c(new_n37_), .O(new_n59_));
