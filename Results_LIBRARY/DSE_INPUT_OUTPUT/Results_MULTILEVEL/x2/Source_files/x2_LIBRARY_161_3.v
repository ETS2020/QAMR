...
module FAU ( 
  ...
  nor2   g03(.a(new_n18_), .b(x3), .O(new_n21_));
  ...
  oai21  g33(.a(new_n18_), .b(new_n35_), .c(new_n39_), .O(new_n51_));
  nand3  g34(.a(new_n40_), .b(x5), .c(new_n35_), .O(new_n52_));
  oai21  g35(.a(x9), .b(x8), .c(new_n52_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n20_), .O(new_n54_));
  nand3  g37(.a(new_n29_), .b(new_n27_), .c(new_n26_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x8), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(x9), .c(new_n35_), .O(new_n57_));
