...
module FAU ( 
  ...
  oai22  g16(.a(x9), .b(new_n18_), .c(new_n21_), .d(new_n33_), .O(new_n34_));
  oai21  g17(.a(new_n19_), .b(new_n25_), .c(new_n34_), .O(z4));
  ...
  nor2   g24(.a(new_n19_), .b(new_n25_), .O(new_n42_));
  ...
  nand3  g32(.a(new_n49_), .b(new_n37_), .c(new_n36_), .O(new_n50_));
