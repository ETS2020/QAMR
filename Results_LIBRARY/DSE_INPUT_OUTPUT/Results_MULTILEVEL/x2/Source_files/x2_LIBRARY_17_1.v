...
module FAU ( 
  ...
  oai22  g13(.a(new_n20_), .b(x5), .c(new_n18_), .d(new_n30_), .O(new_n31_));
  ...
  nand2  g19(.a(new_n19_), .b(x7), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(x2), .c(new_n36_), .d(new_n35_), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(new_n34_), .c(new_n20_), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(new_n30_), .c(x5), .O(new_n40_));
  ...
  oai21  g28(.a(new_n20_), .b(x5), .c(new_n30_), .O(new_n46_));
  oai21  g29(.a(x9), .b(x8), .c(new_n32_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n18_), .O(new_n48_));
  inv1   g31(.a(x2), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n36_), .c(new_n35_), .O(new_n50_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n48_), .c(new_n46_), .O(z6));
endmodule
