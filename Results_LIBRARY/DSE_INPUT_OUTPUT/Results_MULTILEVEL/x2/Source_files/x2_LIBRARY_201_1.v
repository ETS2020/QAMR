...
module FAU ( 
  ...
  nand3  g10(.a(new_n25_), .b(x7), .c(x4), .O(new_n28_));
  ...
  nand3  g17(.a(new_n34_), .b(new_n29_), .c(new_n22_), .O(z3));
  ...
  nand4  g25(.a(x9), .b(x8), .c(new_n22_), .d(x5), .O(new_n43_));
  nand2  g26(.a(new_n18_), .b(new_n25_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(x6), .O(new_n45_));
  aoi21  g28(.a(new_n42_), .b(new_n20_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g33(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n51_));
  ...
  aoi21  g39(.a(x9), .b(new_n20_), .c(new_n56_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(new_n50_), .O(z6));
endmodule
