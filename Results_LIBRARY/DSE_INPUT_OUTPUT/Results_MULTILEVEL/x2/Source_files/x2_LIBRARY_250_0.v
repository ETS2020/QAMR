...
module FAU ( 
  ...
  nand2  g33(.a(new_n18_), .b(new_n25_), .O(new_n51_));
  oai21  g34(.a(new_n40_), .b(new_n20_), .c(new_n51_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nand3  g36(.a(new_n28_), .b(new_n39_), .c(new_n38_), .O(new_n54_));
  ...
  aoi21  g41(.a(new_n18_), .b(new_n20_), .c(new_n33_), .O(new_n59_));
