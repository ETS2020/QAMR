...
module FAU ( 
  ...
  nand2  g09(.a(x9), .b(x3), .O(new_n27_));
  ...
  nand4  g14(.a(new_n31_), .b(new_n18_), .c(x8), .d(new_n19_), .O(z3));
  inv1   g15(.a(x6), .O(new_n33_));
  oai21  g16(.a(new_n19_), .b(new_n33_), .c(new_n27_), .O(new_n34_));
  nand2  g17(.a(x9), .b(x8), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(x3), .c(new_n34_), .O(z4));
  inv1   g19(.a(x0), .O(new_n37_));
  inv1   g20(.a(x1), .O(new_n38_));
  oai21  g21(.a(new_n35_), .b(new_n19_), .c(new_n24_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(x2), .c(new_n38_), .d(new_n37_), .O(new_n40_));
  oai21  g23(.a(new_n19_), .b(x4), .c(new_n18_), .O(new_n41_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n33_), .c(new_n28_), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(new_n46_), .c(new_n42_), .d(new_n40_), .O(z5));
  nand2  g32(.a(new_n27_), .b(new_n33_), .O(new_n50_));
  nand4  g33(.a(x9), .b(x8), .c(x5), .d(new_n43_), .O(new_n51_));
  inv1   g34(.a(new_n51_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n28_), .c(new_n19_), .O(new_n53_));
  inv1   g36(.a(x2), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n38_), .c(new_n37_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x8), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(x9), .c(new_n43_), .O(new_n57_));
  ...
  nand3  g43(.a(new_n60_), .b(new_n53_), .c(new_n50_), .O(z6));
endmodule
