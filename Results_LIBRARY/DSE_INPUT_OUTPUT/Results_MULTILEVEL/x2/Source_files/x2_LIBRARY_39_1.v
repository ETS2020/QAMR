...
module FAU ( 
  ...
  oai21  g10(.a(new_n18_), .b(x1), .c(new_n27_), .O(z2));
  ...
  oai21  g17(.a(new_n23_), .b(x1), .c(new_n34_), .O(new_n35_));
  nand2  g18(.a(x9), .b(x8), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  aoi22  g20(.a(new_n37_), .b(x1), .c(new_n18_), .d(new_n21_), .O(new_n38_));
  ...
  oai21  g36(.a(new_n18_), .b(x1), .c(x6), .O(new_n54_));
