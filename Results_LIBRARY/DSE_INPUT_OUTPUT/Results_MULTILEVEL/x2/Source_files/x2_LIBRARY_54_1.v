...
module FAU ( 
  ...
  oai22  g13(.a(new_n20_), .b(x3), .c(new_n18_), .d(new_n30_), .O(new_n31_));
  nand3  g14(.a(x9), .b(x8), .c(x3), .O(new_n32_));
  ...
  nand3  g21(.a(x8), .b(new_n18_), .c(x5), .O(new_n39_));
  ...
  nand4  g28(.a(new_n45_), .b(new_n41_), .c(new_n38_), .d(x6), .O(z5));
  ...
  aoi21  g39(.a(x9), .b(new_n56_), .c(new_n30_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(new_n49_), .O(z6));
endmodule
