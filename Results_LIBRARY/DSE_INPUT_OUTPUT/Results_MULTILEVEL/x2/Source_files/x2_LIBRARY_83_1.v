...
module FAU ( 
  ...
  oai21  g09(.a(new_n18_), .b(x6), .c(new_n26_), .O(z2));
  nor2   g10(.a(x7), .b(new_n20_), .O(new_n28_));
  ...
  oai21  g17(.a(new_n18_), .b(x6), .c(x7), .O(new_n35_));
  inv1   g18(.a(x8), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(x9), .c(x6), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n35_), .c(new_n34_), .O(z3));
  inv1   g22(.a(new_n29_), .O(new_n40_));
  nor2   g23(.a(new_n18_), .b(new_n36_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n21_), .c(x6), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n40_), .O(z4));
  ...
  nand3  g29(.a(new_n41_), .b(new_n21_), .c(x5), .O(new_n47_));
  ...
  nand3  g37(.a(new_n41_), .b(x6), .c(x5), .O(new_n55_));
  inv1   g38(.a(new_n55_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n25_), .c(new_n21_), .O(new_n57_));
  nand3  g40(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x8), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(x9), .c(x6), .O(new_n60_));
  ...
  nand3  g46(.a(new_n63_), .b(new_n57_), .c(new_n40_), .O(z6));
endmodule
