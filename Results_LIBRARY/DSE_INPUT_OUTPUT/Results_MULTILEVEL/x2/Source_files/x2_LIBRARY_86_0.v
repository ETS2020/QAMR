...
module FAU ( 
  ...
  nand4  g16(.a(new_n33_), .b(new_n28_), .c(new_n21_), .d(x6), .O(z3));
  nand2  g17(.a(x9), .b(x8), .O(new_n35_));
  nand3  g18(.a(new_n35_), .b(x7), .c(x6), .O(z4));
  oai21  g19(.a(new_n35_), .b(new_n21_), .c(new_n26_), .O(new_n37_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n20_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n38_), .O(z5));
  nand2  g30(.a(new_n18_), .b(new_n25_), .O(new_n48_));
  oai21  g31(.a(new_n35_), .b(new_n44_), .c(new_n48_), .O(new_n49_));
