...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(x7), .c(x6), .O(new_n31_));
  ...
  oai21  g21(.a(new_n29_), .b(new_n18_), .c(x7), .O(z4));
  oai21  g22(.a(new_n29_), .b(new_n24_), .c(new_n27_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n41_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n30_), .c(new_n18_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n45_), .c(new_n41_), .O(z5));
  nand2  g32(.a(new_n22_), .b(new_n19_), .O(new_n50_));
  oai21  g33(.a(new_n29_), .b(new_n46_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n24_), .O(new_n52_));
  nand3  g35(.a(new_n35_), .b(new_n33_), .c(new_n32_), .O(new_n53_));
