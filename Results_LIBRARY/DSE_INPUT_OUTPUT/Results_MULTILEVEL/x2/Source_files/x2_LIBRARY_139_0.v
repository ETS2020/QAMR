...
module FAU ( 
  ...
  oai21  g11(.a(new_n18_), .b(new_n21_), .c(new_n20_), .O(new_n29_));
  ...
  nand4  g18(.a(new_n35_), .b(new_n30_), .c(new_n29_), .d(new_n21_), .O(z3));
  nand2  g19(.a(new_n18_), .b(new_n20_), .O(new_n37_));
  nand2  g20(.a(x9), .b(x8), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n37_), .c(x7), .d(x6), .O(z4));
  nand2  g22(.a(new_n25_), .b(new_n21_), .O(new_n40_));
  oai21  g23(.a(new_n38_), .b(new_n21_), .c(new_n40_), .O(new_n41_));
  ...
  inv1   g30(.a(new_n38_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n26_), .c(new_n47_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n46_), .c(new_n42_), .O(z5));
  nand2  g33(.a(new_n37_), .b(new_n47_), .O(new_n51_));
