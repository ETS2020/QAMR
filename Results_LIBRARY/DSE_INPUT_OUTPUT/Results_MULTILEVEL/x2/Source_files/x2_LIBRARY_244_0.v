...
module FAU ( 
  ...
  oai21  g16(.a(new_n22_), .b(new_n33_), .c(x4), .O(new_n34_));
  ...
  nand3  g24(.a(x8), .b(new_n22_), .c(x5), .O(new_n42_));
  ...
  oai21  g30(.a(x9), .b(x4), .c(new_n33_), .O(new_n48_));
  nand3  g31(.a(x8), .b(x7), .c(x3), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n26_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n18_), .c(x4), .O(new_n51_));
  inv1   g34(.a(new_n42_), .O(new_n52_));
  nand3  g35(.a(new_n28_), .b(new_n39_), .c(new_n38_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(x8), .c(new_n22_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n52_), .c(x9), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n51_), .c(new_n48_), .O(z6));
endmodule
