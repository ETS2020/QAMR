...
module FAU ( 
  ...
  nand2  g17(.a(new_n25_), .b(new_n34_), .O(new_n35_));
  ...
  nand2  g28(.a(x9), .b(x7), .O(new_n46_));
  ...
  nand4  g33(.a(new_n21_), .b(x8), .c(x4), .d(x3), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x7), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n48_), .c(new_n35_), .O(z6));
endmodule
