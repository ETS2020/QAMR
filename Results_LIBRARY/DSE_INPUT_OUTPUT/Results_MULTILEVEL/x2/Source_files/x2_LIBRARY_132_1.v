...
module FAU ( 
  ...
  oai21  g11(.a(new_n18_), .b(x8), .c(new_n28_), .O(new_n29_));
  ...
  nor2   g20(.a(new_n18_), .b(new_n24_), .O(new_n38_));
  ...
  nand3  g25(.a(new_n42_), .b(new_n37_), .c(new_n29_), .O(z5));
  inv1   g26(.a(x2), .O(new_n44_));
  nand3  g27(.a(new_n23_), .b(x9), .c(new_n44_), .O(new_n45_));
  ...
  aoi21  g34(.a(new_n50_), .b(new_n22_), .c(new_n51_), .O(new_n52_));
