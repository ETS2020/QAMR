...
module FAU ( 
  ...
  oai21  g02(.a(x9), .b(new_n19_), .c(x8), .O(new_n20_));
  oai21  g03(.a(x8), .b(new_n18_), .c(new_n20_), .O(z0));
  inv1   g04(.a(x8), .O(new_n22_));
  xnor2a g05(.a(x9), .b(x7), .O(new_n23_));
  nand3  g06(.a(new_n23_), .b(new_n22_), .c(x6), .O(z1));
  inv1   g07(.a(x9), .O(new_n25_));
  nand2  g08(.a(new_n25_), .b(new_n19_), .O(new_n26_));
  aoi21  g09(.a(new_n26_), .b(x6), .c(x8), .O(z2));
  nor3   g10(.a(x2), .b(x1), .c(x0), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n25_), .c(x8), .d(new_n19_), .O(z3));
  oai21  g12(.a(x9), .b(new_n18_), .c(x8), .O(new_n30_));
  oai21  g13(.a(x7), .b(new_n18_), .c(new_n30_), .O(z4));
  ...
  nor2   g23(.a(new_n25_), .b(new_n22_), .O(new_n41_));
  inv1   g24(.a(x5), .O(new_n42_));
  nor2   g25(.a(x7), .b(new_n42_), .O(new_n43_));
  aoi21  g26(.a(new_n43_), .b(new_n41_), .c(new_n18_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n40_), .c(new_n36_), .O(z5));
  nand2  g28(.a(new_n41_), .b(x5), .O(new_n46_));
  nand3  g29(.a(new_n25_), .b(new_n22_), .c(x6), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n19_), .O(new_n49_));
  inv1   g32(.a(x2), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n33_), .c(new_n32_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x8), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(x9), .c(x6), .O(new_n53_));
  ...
  nand2  g39(.a(x8), .b(new_n18_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n56_), .c(new_n49_), .O(z6));
endmodule
