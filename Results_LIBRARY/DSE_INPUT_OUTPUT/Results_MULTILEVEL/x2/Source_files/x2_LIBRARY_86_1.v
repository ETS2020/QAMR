...
module FAU ( 
  ...
  nand4  g14(.a(new_n31_), .b(new_n29_), .c(new_n28_), .d(new_n21_), .O(z3));
  nand2  g15(.a(x9), .b(x8), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(x7), .c(x6), .O(z4));
  inv1   g17(.a(x0), .O(new_n35_));
  inv1   g18(.a(x1), .O(new_n36_));
  nand2  g19(.a(new_n30_), .b(new_n21_), .O(new_n37_));
  oai21  g20(.a(new_n33_), .b(new_n21_), .c(new_n37_), .O(new_n38_));
  ...
  inv1   g26(.a(new_n33_), .O(new_n44_));
  ...
  oai21  g33(.a(new_n50_), .b(new_n25_), .c(new_n21_), .O(new_n51_));
