...
module FAU ( 
  ...
  nand4  g08(.a(new_n18_), .b(new_n25_), .c(new_n21_), .d(x2), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(z2));
  nand2  g10(.a(new_n18_), .b(new_n20_), .O(z3));
  nand2  g11(.a(x9), .b(x8), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(z3), .c(x7), .d(x6), .O(z4));
  inv1   g13(.a(x0), .O(new_n31_));
  inv1   g14(.a(x1), .O(new_n32_));
  nand2  g15(.a(new_n25_), .b(new_n21_), .O(new_n33_));
  ...
  nand2  g30(.a(z3), .b(new_n43_), .O(new_n48_));
  nand4  g31(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n18_), .c(x2), .O(new_n51_));
  nand3  g34(.a(new_n20_), .b(new_n32_), .c(new_n31_), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(x8), .c(new_n21_), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n45_), .c(x9), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n51_), .c(new_n48_), .O(z6));
endmodule
