...
module FAU ( 
  ...
  nor2   g24(.a(new_n18_), .b(new_n20_), .O(new_n42_));
  ...
  oai21  g35(.a(new_n18_), .b(new_n27_), .c(new_n41_), .O(new_n53_));
  nand3  g36(.a(new_n42_), .b(x5), .c(new_n27_), .O(new_n54_));
  ...
  nand3  g41(.a(new_n58_), .b(x9), .c(new_n27_), .O(new_n59_));
