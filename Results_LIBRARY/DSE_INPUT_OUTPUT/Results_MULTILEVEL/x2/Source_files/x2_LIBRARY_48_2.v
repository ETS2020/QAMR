...
module FAU ( 
  ...
  nor2   g10(.a(x9), .b(new_n27_), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n26_), .c(new_n25_), .d(new_n24_), .O(z3));
  nand4  g12(.a(x9), .b(new_n27_), .c(x7), .d(x6), .O(z4));
  ...
  oai21  g22(.a(new_n39_), .b(new_n20_), .c(new_n25_), .O(new_n40_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n40_), .c(new_n37_), .O(z6));
endmodule
