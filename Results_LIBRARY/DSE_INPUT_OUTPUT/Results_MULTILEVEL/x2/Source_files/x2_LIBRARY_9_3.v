...
module FAU ( 
  ...
  oai21  g03(.a(new_n20_), .b(x5), .c(x9), .O(new_n21_));
  ...
  nand3  g14(.a(x8), .b(new_n20_), .c(new_n31_), .O(new_n32_));
  oai21  g15(.a(new_n32_), .b(new_n30_), .c(new_n18_), .O(new_n33_));
  oai21  g16(.a(new_n18_), .b(x5), .c(new_n33_), .O(z3));
  ...
  nand2  g31(.a(new_n24_), .b(new_n48_), .O(new_n49_));
  nand3  g32(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x8), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(x9), .c(new_n37_), .O(new_n52_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n49_), .c(new_n26_), .O(z6));
endmodule
