...
module FAU ( 
  ...
  nand2  g17(.a(new_n20_), .b(new_n19_), .O(new_n35_));
  inv1   g18(.a(x4), .O(new_n36_));
  nand3  g19(.a(new_n20_), .b(new_n36_), .c(x3), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(x6), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x7), .O(new_n39_));
  inv1   g22(.a(x6), .O(new_n40_));
  oai21  g23(.a(x8), .b(x7), .c(x9), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand4  g25(.a(new_n22_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n19_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x9), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n42_), .c(new_n39_), .d(new_n35_), .O(z5));
  ...
  nand3  g33(.a(new_n50_), .b(new_n42_), .c(new_n26_), .O(z6));
endmodule
