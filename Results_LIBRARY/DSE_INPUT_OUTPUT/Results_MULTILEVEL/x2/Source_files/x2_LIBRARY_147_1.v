...
module FAU ( 
  ...
  nor2   g36(.a(new_n26_), .b(new_n46_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n21_), .c(new_n19_), .O(new_n55_));
  aoi21  g38(.a(x9), .b(new_n18_), .c(new_n35_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n55_), .c(new_n53_), .O(z6));
endmodule
