...
module FAU ( 
  ...
  oai21  g06(.a(new_n21_), .b(x0), .c(new_n23_), .O(z1));
  inv1   g07(.a(x8), .O(new_n25_));
  nand2  g08(.a(new_n25_), .b(new_n22_), .O(new_n26_));
  aoi21  g09(.a(new_n26_), .b(new_n18_), .c(x9), .O(z2));
  oai21  g10(.a(new_n19_), .b(new_n22_), .c(x0), .O(new_n28_));
  ...
  nand2  g16(.a(new_n19_), .b(x0), .O(new_n34_));
  ...
  nand3  g35(.a(new_n30_), .b(new_n29_), .c(new_n18_), .O(new_n53_));
  ...
  nand4  g40(.a(new_n57_), .b(new_n52_), .c(new_n34_), .d(x6), .O(z6));
endmodule
