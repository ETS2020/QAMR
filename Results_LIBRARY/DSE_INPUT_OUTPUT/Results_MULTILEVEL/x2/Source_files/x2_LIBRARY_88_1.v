...
module FAU ( 
  ...
  nand2  g10(.a(x7), .b(x6), .O(new_n28_));
  oai21  g11(.a(new_n18_), .b(x1), .c(new_n28_), .O(new_n29_));
  nand3  g12(.a(x9), .b(x8), .c(x1), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n29_), .O(z4));
  nand3  g14(.a(x8), .b(new_n21_), .c(x5), .O(new_n32_));
  ...
  oai21  g29(.a(new_n18_), .b(x1), .c(x6), .O(new_n47_));
  aoi21  g30(.a(new_n46_), .b(new_n21_), .c(new_n47_), .O(new_n48_));
