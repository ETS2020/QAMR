...
module FAU ( 
  ...
  nand2  g11(.a(new_n18_), .b(new_n22_), .O(new_n29_));
  inv1   g12(.a(x6), .O(new_n30_));
  aoi21  g13(.a(x9), .b(x8), .c(new_n30_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(new_n22_), .c(new_n29_), .O(z4));
  ...
  nor2   g26(.a(x9), .b(x7), .O(new_n44_));
  nor2   g27(.a(new_n18_), .b(new_n22_), .O(new_n45_));
