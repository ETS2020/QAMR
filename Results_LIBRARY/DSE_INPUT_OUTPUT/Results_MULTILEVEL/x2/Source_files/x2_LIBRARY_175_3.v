...
module FAU ( 
  ...
  aoi21  g26(.a(new_n41_), .b(new_n37_), .c(new_n43_), .O(new_n44_));
  ...
  oai21  g31(.a(new_n44_), .b(x0), .c(new_n48_), .O(z5));
  nand2  g32(.a(new_n26_), .b(new_n31_), .O(new_n50_));
  nand3  g33(.a(new_n34_), .b(x5), .c(new_n33_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n27_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n19_), .O(new_n53_));
  oai21  g36(.a(x2), .b(x1), .c(x8), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(x9), .c(new_n33_), .O(new_n55_));
