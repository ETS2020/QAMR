...
module FAU ( 
  ...
  aoi21  g30(.a(new_n47_), .b(x3), .c(new_n38_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n29_), .O(new_n50_));
  oai21  g33(.a(new_n20_), .b(new_n38_), .c(new_n18_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n50_), .O(z5));
  nand2  g35(.a(new_n27_), .b(new_n38_), .O(new_n53_));
  nand3  g36(.a(new_n45_), .b(x5), .c(new_n29_), .O(new_n54_));
  ...
  nand3  g41(.a(new_n58_), .b(x9), .c(new_n29_), .O(new_n59_));
