...
module FAU ( 
  ...
  nand3  g14(.a(new_n31_), .b(x9), .c(x5), .O(new_n32_));
  ...
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n33_), .O(new_n43_));
  aoi21  g26(.a(x8), .b(new_n21_), .c(new_n20_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x9), .O(new_n46_));
  inv1   g29(.a(x4), .O(new_n47_));
  nand3  g30(.a(new_n18_), .b(new_n47_), .c(x3), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x6), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x7), .O(new_n50_));
  nand2  g33(.a(new_n25_), .b(new_n39_), .O(new_n51_));
  nand4  g34(.a(new_n51_), .b(new_n50_), .c(new_n46_), .d(new_n27_), .O(z5));
  nand3  g35(.a(x9), .b(x8), .c(x5), .O(new_n53_));
  inv1   g36(.a(new_n53_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n26_), .c(new_n21_), .O(new_n55_));
  nand3  g38(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x8), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(x9), .c(x5), .O(new_n58_));
  ...
  nand3  g44(.a(new_n61_), .b(new_n55_), .c(new_n51_), .O(z6));
endmodule
