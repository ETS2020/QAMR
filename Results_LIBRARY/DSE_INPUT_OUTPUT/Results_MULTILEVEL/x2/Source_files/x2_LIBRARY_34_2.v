...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n22_, new_n24_, new_n26_, new_n29_,
  ...
  aoi21  g06(.a(new_n24_), .b(x7), .c(x9), .O(z2));
  inv1   g07(.a(x9), .O(new_n26_));
  nand2  g08(.a(new_n26_), .b(x8), .O(z3));
  ...
  nand2  g16(.a(z3), .b(new_n34_), .O(new_n35_));
  nor2   g17(.a(new_n26_), .b(new_n24_), .O(new_n36_));
  inv1   g18(.a(x5), .O(new_n37_));
  nor2   g19(.a(x7), .b(new_n37_), .O(new_n38_));
  aoi21  g20(.a(new_n38_), .b(new_n36_), .c(new_n21_), .O(new_n39_));
  nand3  g21(.a(new_n39_), .b(new_n35_), .c(new_n33_), .O(z5));
