...
module FAU ( 
  ...
  nand3  g29(.a(x9), .b(new_n30_), .c(new_n29_), .O(new_n47_));
  ...
  nor2   g33(.a(x9), .b(x6), .O(new_n51_));
  aoi21  g34(.a(x9), .b(x2), .c(new_n51_), .O(new_n52_));
  nand4  g35(.a(new_n52_), .b(new_n50_), .c(new_n46_), .d(new_n39_), .O(z6));
endmodule
