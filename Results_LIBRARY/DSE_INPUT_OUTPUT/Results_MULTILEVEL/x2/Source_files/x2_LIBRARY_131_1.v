...
module FAU ( 
  ...
  aoi21  g27(.a(new_n44_), .b(new_n43_), .c(new_n20_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n39_), .c(x5), .O(new_n46_));
  ...
  nand2  g34(.a(new_n29_), .b(new_n39_), .O(new_n52_));
  ...
  nand4  g41(.a(new_n20_), .b(x8), .c(x4), .d(x3), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x7), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n55_), .c(new_n52_), .O(z6));
endmodule
