...
module FAU ( 
  ...
  aoi21  g40(.a(new_n19_), .b(x1), .c(new_n30_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n57_), .c(new_n51_), .O(z6));
endmodule
