...
module FAU ( 
  ...
  oai21  g15(.a(x9), .b(new_n29_), .c(new_n32_), .O(z3));
  ...
  nand4  g27(.a(new_n44_), .b(new_n40_), .c(new_n38_), .d(new_n26_), .O(z5));
  nand2  g28(.a(new_n26_), .b(new_n39_), .O(new_n46_));
  nand4  g29(.a(x9), .b(x8), .c(x5), .d(new_n29_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n27_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n19_), .O(new_n49_));
  oai21  g32(.a(x1), .b(x0), .c(x8), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x9), .c(new_n29_), .O(new_n51_));
