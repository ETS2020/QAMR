...
module FAU ( 
  ...
  nand2  g16(.a(new_n34_), .b(new_n23_), .O(new_n35_));
  ...
  inv1   g27(.a(x8), .O(new_n46_));
  nor2   g28(.a(x9), .b(new_n46_), .O(new_n47_));
  aoi21  g29(.a(new_n47_), .b(new_n45_), .c(new_n36_), .O(new_n48_));
  nand3  g30(.a(new_n48_), .b(new_n44_), .c(new_n35_), .O(z6));
  zero   g31(.O(z2));
endmodule
