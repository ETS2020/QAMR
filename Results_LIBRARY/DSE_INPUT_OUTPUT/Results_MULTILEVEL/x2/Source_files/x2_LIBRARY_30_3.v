...
module FAU ( 
  ...
  oai21  g03(.a(new_n18_), .b(x6), .c(new_n20_), .O(z0));
  ...
  nand4  g13(.a(new_n30_), .b(x8), .c(new_n22_), .d(new_n29_), .O(new_n31_));
  ...
  oai21  g24(.a(new_n41_), .b(new_n24_), .c(new_n18_), .O(new_n42_));
