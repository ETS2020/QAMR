...
module FAU ( 
  ...
  nor2   g16(.a(new_n18_), .b(new_n21_), .O(new_n34_));
  inv1   g17(.a(new_n34_), .O(new_n35_));
  nand3  g18(.a(new_n35_), .b(new_n33_), .c(new_n31_), .O(z4));
  oai21  g19(.a(new_n18_), .b(x8), .c(new_n32_), .O(new_n37_));
  nand2  g20(.a(new_n26_), .b(new_n25_), .O(new_n38_));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n34_), .c(new_n44_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n43_), .c(new_n37_), .O(z5));
  nand4  g31(.a(x9), .b(new_n27_), .c(new_n26_), .d(new_n25_), .O(new_n49_));
  ...
  oai21  g37(.a(new_n18_), .b(x8), .c(x6), .O(new_n55_));
