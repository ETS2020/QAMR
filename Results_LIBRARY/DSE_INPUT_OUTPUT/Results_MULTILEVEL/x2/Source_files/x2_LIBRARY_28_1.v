...
module FAU ( 
  ...
  oai22  g13(.a(new_n18_), .b(x4), .c(new_n22_), .d(new_n30_), .O(new_n31_));
  nand2  g14(.a(x9), .b(x8), .O(new_n32_));
  oai21  g15(.a(new_n32_), .b(new_n20_), .c(new_n31_), .O(z4));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  oai21  g18(.a(new_n32_), .b(new_n22_), .c(new_n26_), .O(new_n36_));
  ...
  nand2  g23(.a(new_n18_), .b(new_n25_), .O(new_n41_));
