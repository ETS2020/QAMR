...
module FAU ( 
  ...
  oai21  g04(.a(x9), .b(x3), .c(new_n21_), .O(new_n22_));
  ...
  nand2  g17(.a(new_n19_), .b(x3), .O(new_n35_));
  ...
  oai21  g30(.a(new_n47_), .b(new_n46_), .c(new_n18_), .O(new_n48_));
  nand2  g31(.a(new_n40_), .b(x6), .O(new_n49_));
  nand3  g32(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(x8), .c(new_n21_), .O(new_n51_));
