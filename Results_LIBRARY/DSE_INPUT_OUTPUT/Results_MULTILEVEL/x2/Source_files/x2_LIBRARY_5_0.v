...
module FAU ( 
  ...
  nand4  g15(.a(new_n32_), .b(new_n23_), .c(new_n22_), .d(x6), .O(z3));
  nand2  g16(.a(x9), .b(x8), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(x7), .c(x6), .O(z4));
  oai21  g18(.a(new_n34_), .b(new_n22_), .c(new_n26_), .O(new_n36_));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n42_), .c(new_n20_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n18_), .c(x6), .O(new_n49_));
