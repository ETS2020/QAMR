...
module FAU ( 
  ...
  oai21  g24(.a(x9), .b(new_n41_), .c(x7), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n20_), .O(new_n43_));
  inv1   g26(.a(x8), .O(new_n44_));
  nand2  g27(.a(new_n18_), .b(new_n44_), .O(new_n45_));
  nand4  g28(.a(x9), .b(x8), .c(new_n21_), .d(x5), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(x6), .O(new_n47_));
  inv1   g30(.a(new_n47_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n43_), .c(new_n40_), .O(z5));
  nand3  g32(.a(x9), .b(new_n21_), .c(x5), .O(new_n50_));
  nand4  g33(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x8), .O(new_n53_));
  nand3  g36(.a(new_n28_), .b(new_n37_), .c(new_n36_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x8), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(x9), .c(x7), .O(new_n56_));
  aoi21  g39(.a(new_n25_), .b(new_n21_), .c(new_n33_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n56_), .c(new_n53_), .O(z6));
endmodule
