...
module FAU ( 
  ...
  nand3  g16(.a(x8), .b(new_n23_), .c(new_n33_), .O(new_n34_));
  oai21  g17(.a(new_n34_), .b(new_n32_), .c(x4), .O(new_n35_));
  ...
  nand3  g36(.a(new_n33_), .b(new_n31_), .c(new_n30_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(x8), .c(new_n23_), .O(new_n55_));
