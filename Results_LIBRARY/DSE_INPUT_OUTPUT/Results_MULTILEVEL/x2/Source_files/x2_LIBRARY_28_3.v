...
module FAU ( 
  ...
  oai22  g11(.a(new_n18_), .b(new_n27_), .c(new_n21_), .d(new_n28_), .O(new_n29_));
  and2   g12(.a(x9), .b(x8), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n27_), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n29_), .O(z4));
  ...
  oai21  g21(.a(new_n38_), .b(x9), .c(x4), .O(new_n39_));
  nand3  g22(.a(x7), .b(new_n27_), .c(x3), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n30_), .c(new_n28_), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n42_), .c(new_n39_), .d(new_n37_), .O(z5));
  nand3  g29(.a(x7), .b(x4), .c(x3), .O(new_n47_));
  nand3  g30(.a(x9), .b(new_n21_), .c(x5), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x8), .O(new_n50_));
  inv1   g33(.a(x2), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n34_), .c(new_n33_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x8), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(x9), .c(x7), .O(new_n54_));
  nor2   g37(.a(x9), .b(x8), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n21_), .c(new_n28_), .O(new_n56_));
  nand4  g39(.a(new_n56_), .b(new_n54_), .c(new_n50_), .d(new_n39_), .O(z6));
endmodule
