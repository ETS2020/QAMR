...
module FAU ( 
  ...
  oai21  g09(.a(x8), .b(new_n22_), .c(x9), .O(new_n27_));
  nor2   g10(.a(x1), .b(x0), .O(new_n28_));
  nor2   g11(.a(new_n20_), .b(x2), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n27_), .d(new_n22_), .O(z3));
  ...
  nand4  g19(.a(new_n28_), .b(x9), .c(x8), .d(x2), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(new_n25_), .d(x6), .O(z5));
  ...
  nand4  g25(.a(new_n42_), .b(new_n40_), .c(new_n25_), .d(x6), .O(z6));
endmodule
