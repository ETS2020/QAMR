...
module FAU ( 
  ...
  oai21  g09(.a(new_n18_), .b(x3), .c(new_n26_), .O(z2));
  ...
  nor2   g23(.a(new_n18_), .b(new_n40_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n21_), .c(x5), .O(new_n42_));
  ...
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n39_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x3), .O(new_n48_));
  oai21  g31(.a(new_n40_), .b(new_n44_), .c(new_n18_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n48_), .O(z5));
  oai21  g33(.a(new_n18_), .b(x3), .c(new_n44_), .O(new_n51_));
  nand3  g34(.a(new_n41_), .b(x5), .c(x3), .O(new_n52_));
  inv1   g35(.a(new_n52_), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n25_), .c(new_n21_), .O(new_n54_));
  nor2   g37(.a(x2), .b(x1), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n28_), .c(new_n40_), .O(new_n56_));
