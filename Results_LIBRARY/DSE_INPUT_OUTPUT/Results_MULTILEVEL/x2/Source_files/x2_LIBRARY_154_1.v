...
module FAU ( 
  ...
  aoi21  g05(.a(new_n18_), .b(x7), .c(x8), .O(z2));
  ...
  oai21  g12(.a(new_n20_), .b(new_n29_), .c(new_n18_), .O(new_n30_));
  oai21  g13(.a(new_n18_), .b(new_n21_), .c(new_n30_), .O(z4));
  oai21  g14(.a(new_n18_), .b(x8), .c(new_n29_), .O(new_n32_));
  nand3  g15(.a(x9), .b(x8), .c(x2), .O(new_n33_));
  inv1   g16(.a(x4), .O(new_n34_));
  nand3  g17(.a(new_n18_), .b(new_n34_), .c(x3), .O(new_n35_));
  oai21  g18(.a(new_n33_), .b(new_n26_), .c(new_n35_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  nor2   g20(.a(new_n18_), .b(new_n21_), .O(new_n38_));
  inv1   g21(.a(x5), .O(new_n39_));
  nor2   g22(.a(x7), .b(new_n39_), .O(new_n40_));
  nor2   g23(.a(x9), .b(x8), .O(new_n41_));
  aoi21  g24(.a(new_n40_), .b(new_n38_), .c(new_n41_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n37_), .c(new_n32_), .O(z5));
  inv1   g26(.a(x2), .O(new_n44_));
  nand4  g27(.a(x9), .b(new_n44_), .c(new_n25_), .d(new_n24_), .O(new_n45_));
  nand3  g28(.a(new_n18_), .b(x4), .c(x3), .O(new_n46_));
  aoi21  g29(.a(new_n46_), .b(new_n45_), .c(new_n20_), .O(new_n47_));
  nand3  g30(.a(x9), .b(new_n20_), .c(x5), .O(new_n48_));
  inv1   g31(.a(new_n48_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n47_), .c(x8), .O(new_n50_));
  nand2  g33(.a(new_n41_), .b(new_n20_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n50_), .c(new_n32_), .O(z6));
endmodule
