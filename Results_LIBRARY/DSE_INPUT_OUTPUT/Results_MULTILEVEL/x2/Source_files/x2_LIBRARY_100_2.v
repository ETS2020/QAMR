...
module FAU ( 
  ...
  oai21  g06(.a(new_n21_), .b(x2), .c(new_n23_), .O(z1));
  inv1   g07(.a(x8), .O(new_n25_));
  nand4  g08(.a(new_n19_), .b(new_n25_), .c(new_n22_), .d(new_n18_), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(z2));
  oai21  g10(.a(new_n19_), .b(new_n22_), .c(x2), .O(new_n28_));
  inv1   g11(.a(x0), .O(new_n29_));
  inv1   g12(.a(x1), .O(new_n30_));
  nand4  g13(.a(x8), .b(new_n22_), .c(new_n30_), .d(new_n29_), .O(new_n31_));
  inv1   g14(.a(new_n31_), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(new_n28_), .c(new_n23_), .O(z3));
  ...
  aoi21  g25(.a(new_n42_), .b(x8), .c(x9), .O(new_n43_));
  nand2  g26(.a(new_n22_), .b(x5), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n35_), .c(x6), .O(new_n45_));
  nor2   g28(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n40_), .O(z5));
  inv1   g30(.a(x6), .O(new_n48_));
  nand2  g31(.a(new_n34_), .b(new_n48_), .O(new_n49_));
