...
module FAU ( 
  ...
  nand3  g17(.a(new_n34_), .b(new_n32_), .c(new_n31_), .O(new_n35_));
  ...
  nand3  g22(.a(new_n39_), .b(new_n35_), .c(x6), .O(new_n40_));
  ...
  nand3  g28(.a(x7), .b(new_n32_), .c(new_n31_), .O(new_n46_));
  ...
  oai21  g32(.a(new_n18_), .b(x8), .c(new_n49_), .O(new_n50_));
