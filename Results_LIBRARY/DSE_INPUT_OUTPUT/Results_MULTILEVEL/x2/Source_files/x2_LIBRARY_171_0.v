...
module FAU ( 
  ...
  oai21  g10(.a(new_n28_), .b(x7), .c(x8), .O(new_n29_));
  ...
  oai21  g29(.a(x9), .b(x8), .c(new_n31_), .O(new_n48_));
  nand3  g30(.a(x9), .b(new_n19_), .c(x5), .O(new_n49_));
  nand4  g31(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n50_));
  nand2  g32(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g33(.a(new_n51_), .b(x8), .O(new_n52_));
  nand2  g34(.a(new_n28_), .b(x8), .O(new_n53_));
  nand3  g35(.a(new_n53_), .b(x9), .c(x7), .O(new_n54_));
  nand3  g36(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(z6));
  zero   g37(.O(z2));
endmodule
