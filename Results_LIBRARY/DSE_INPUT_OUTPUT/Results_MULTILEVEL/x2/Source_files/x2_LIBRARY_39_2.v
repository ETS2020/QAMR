...
module FAU ( 
  ...
  oai21  g04(.a(x9), .b(x1), .c(new_n21_), .O(new_n22_));
  ...
  oai21  g21(.a(new_n38_), .b(new_n21_), .c(new_n26_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(x2), .c(new_n18_), .d(new_n28_), .O(new_n40_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n40_), .O(z5));
  nand2  g32(.a(new_n19_), .b(new_n25_), .O(new_n50_));
  oai21  g33(.a(new_n38_), .b(new_n46_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n21_), .O(new_n52_));
  nand3  g35(.a(new_n29_), .b(new_n18_), .c(new_n28_), .O(new_n53_));
  ...
  aoi21  g40(.a(new_n19_), .b(x1), .c(new_n33_), .O(new_n58_));
