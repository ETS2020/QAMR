...
module FAU ( 
  ...
  nand4  g11(.a(new_n28_), .b(new_n20_), .c(x8), .d(new_n18_), .O(z3));
  inv1   g12(.a(x6), .O(new_n30_));
  oai22  g13(.a(new_n20_), .b(x4), .c(new_n18_), .d(new_n30_), .O(new_n31_));
  nor2   g14(.a(new_n20_), .b(new_n19_), .O(new_n32_));
  ...
  aoi21  g24(.a(new_n41_), .b(new_n32_), .c(new_n30_), .O(new_n42_));
  ...
  oai21  g32(.a(new_n20_), .b(x4), .c(new_n30_), .O(new_n50_));
  nand3  g33(.a(new_n32_), .b(x5), .c(x4), .O(new_n51_));
  oai21  g34(.a(x9), .b(x8), .c(new_n51_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  nor2   g36(.a(x2), .b(x1), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n35_), .c(new_n19_), .O(new_n55_));
  nand3  g38(.a(new_n20_), .b(x8), .c(x3), .O(new_n56_));
  oai21  g39(.a(new_n55_), .b(new_n20_), .c(new_n56_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(x7), .c(x4), .O(new_n58_));
