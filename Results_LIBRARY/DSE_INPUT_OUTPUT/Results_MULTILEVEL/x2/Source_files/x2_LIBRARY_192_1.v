...
module FAU ( 
  ...
  nand3  g08(.a(new_n18_), .b(new_n25_), .c(new_n21_), .O(new_n26_));
  ...
  oai21  g16(.a(new_n18_), .b(new_n20_), .c(new_n33_), .O(z3));
  ...
  nand2  g21(.a(new_n25_), .b(x7), .O(new_n39_));
  ...
  oai21  g31(.a(new_n48_), .b(x7), .c(x6), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x5), .O(new_n50_));
  xnor2a g33(.a(x9), .b(x7), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n25_), .O(new_n52_));
  nand2  g35(.a(x9), .b(new_n31_), .O(new_n53_));
  nand4  g36(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n54_));
  oai21  g37(.a(new_n53_), .b(new_n30_), .c(new_n54_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x7), .O(new_n56_));
  nor2   g39(.a(x9), .b(x6), .O(new_n57_));
  aoi21  g40(.a(x9), .b(new_n20_), .c(new_n57_), .O(new_n58_));
