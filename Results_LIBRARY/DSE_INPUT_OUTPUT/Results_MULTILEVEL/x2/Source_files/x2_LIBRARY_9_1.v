...
module FAU ( 
  ...
  nand4  g23(.a(new_n40_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n38_), .c(new_n18_), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n37_), .c(x5), .O(new_n43_));
  ...
  oai21  g31(.a(new_n18_), .b(x5), .c(new_n37_), .O(new_n49_));
  nand3  g32(.a(x9), .b(x8), .c(x5), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n25_), .c(new_n21_), .O(new_n52_));
  nand3  g35(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x8), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(x9), .c(x5), .O(new_n55_));
