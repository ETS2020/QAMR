...
module FAU ( 
  ...
  or2    g20(.a(new_n28_), .b(x6), .O(new_n38_));
  nand2  g21(.a(new_n18_), .b(new_n20_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(new_n31_), .O(z4));
  ...
  nand4  g36(.a(x9), .b(new_n34_), .c(new_n33_), .d(new_n32_), .O(new_n54_));
  ...
  nand4  g40(.a(new_n57_), .b(new_n53_), .c(new_n24_), .d(x6), .O(z6));
endmodule
