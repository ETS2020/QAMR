...
module FAU ( 
  ...
  nand3  g33(.a(new_n50_), .b(new_n45_), .c(new_n41_), .O(z5));
  nand2  g34(.a(new_n18_), .b(new_n20_), .O(new_n52_));
  oai21  g35(.a(new_n38_), .b(new_n48_), .c(new_n52_), .O(new_n53_));
  ...
  nand3  g39(.a(new_n18_), .b(x8), .c(x4), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n56_), .c(x7), .O(new_n59_));
  aoi21  g42(.a(new_n18_), .b(new_n23_), .c(new_n46_), .O(new_n60_));
