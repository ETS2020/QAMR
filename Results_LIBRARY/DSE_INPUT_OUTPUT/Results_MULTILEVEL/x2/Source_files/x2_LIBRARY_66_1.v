...
module FAU ( 
  ...
  nor2   g24(.a(new_n32_), .b(x7), .O(new_n42_));
  aoi21  g25(.a(new_n42_), .b(x5), .c(new_n20_), .O(new_n43_));
  ...
  nand3  g33(.a(new_n50_), .b(x9), .c(x6), .O(new_n51_));
  ...
  nand2  g37(.a(new_n18_), .b(new_n20_), .O(new_n55_));
