...
module FAU ( 
  ...
  oai21  g13(.a(new_n20_), .b(new_n29_), .c(new_n30_), .O(new_n31_));
  nand2  g14(.a(x9), .b(x8), .O(new_n32_));
  oai21  g15(.a(new_n32_), .b(x4), .c(new_n31_), .O(z4));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  oai21  g18(.a(new_n32_), .b(new_n20_), .c(new_n23_), .O(new_n36_));
  ...
  oai21  g25(.a(new_n42_), .b(new_n32_), .c(x6), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n38_), .O(new_n44_));
  aoi21  g27(.a(x8), .b(x6), .c(x9), .O(new_n45_));
  aoi21  g28(.a(x9), .b(x4), .c(new_n45_), .O(new_n46_));
  nand4  g29(.a(new_n46_), .b(new_n44_), .c(new_n41_), .d(new_n37_), .O(z5));
  nand2  g30(.a(new_n30_), .b(new_n29_), .O(new_n48_));
  nand2  g31(.a(x5), .b(new_n38_), .O(new_n49_));
  nand2  g32(.a(new_n18_), .b(new_n22_), .O(new_n50_));
  oai21  g33(.a(new_n49_), .b(new_n32_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  inv1   g35(.a(x2), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n35_), .c(new_n34_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x8), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(x9), .c(new_n38_), .O(new_n56_));
  ...
  nand3  g42(.a(new_n59_), .b(new_n52_), .c(new_n48_), .O(z6));
endmodule
