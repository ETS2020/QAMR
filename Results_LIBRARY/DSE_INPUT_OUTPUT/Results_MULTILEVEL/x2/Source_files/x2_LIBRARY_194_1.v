...
module FAU ( 
  ...
  oai21  g20(.a(new_n36_), .b(new_n18_), .c(new_n27_), .O(new_n38_));
  ...
  nor2   g27(.a(new_n36_), .b(x7), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(x5), .c(new_n44_), .O(new_n46_));
  ...
  nand3  g33(.a(new_n32_), .b(new_n30_), .c(new_n29_), .O(new_n51_));
  ...
  nand2  g39(.a(new_n20_), .b(new_n44_), .O(new_n57_));
