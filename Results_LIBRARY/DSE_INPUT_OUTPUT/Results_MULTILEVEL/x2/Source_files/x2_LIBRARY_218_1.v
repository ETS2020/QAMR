...
module FAU ( 
  ...
  oai21  g14(.a(x9), .b(x6), .c(new_n31_), .O(z4));
  ...
  nand3  g20(.a(new_n30_), .b(new_n21_), .c(x5), .O(new_n38_));
  ...
  nand3  g28(.a(new_n30_), .b(x6), .c(x5), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n25_), .c(new_n21_), .O(new_n48_));
