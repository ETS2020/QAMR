...
module FAU ( 
  ...
  oai21  g16(.a(new_n30_), .b(new_n19_), .c(new_n27_), .O(new_n34_));
  ...
  nand2  g28(.a(z3), .b(new_n40_), .O(new_n46_));
  nand4  g29(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n27_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n18_), .c(x2), .O(new_n49_));
  nand3  g32(.a(new_n23_), .b(new_n33_), .c(new_n32_), .O(new_n50_));
