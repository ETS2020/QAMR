...
module FAU ( 
  ...
  oai21  g11(.a(new_n18_), .b(new_n20_), .c(x1), .O(new_n29_));
  ...
  nand3  g23(.a(new_n40_), .b(x2), .c(new_n31_), .O(new_n41_));
  ...
  nand3  g37(.a(new_n32_), .b(new_n19_), .c(new_n31_), .O(new_n55_));
  ...
  nand4  g42(.a(new_n59_), .b(new_n54_), .c(new_n36_), .d(x6), .O(z6));
endmodule
