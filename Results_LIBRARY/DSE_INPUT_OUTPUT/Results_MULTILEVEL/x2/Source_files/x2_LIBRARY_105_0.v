...
module FAU ( 
  ...
  or2    g12(.a(z2), .b(x6), .O(new_n31_));
  nand3  g13(.a(x9), .b(x8), .c(x5), .O(new_n32_));
  aoi21  g14(.a(new_n32_), .b(x9), .c(x7), .O(new_n33_));
  inv1   g15(.a(x3), .O(new_n34_));
  oai21  g16(.a(x4), .b(new_n34_), .c(x8), .O(new_n35_));
  aoi21  g17(.a(new_n35_), .b(new_n18_), .c(new_n33_), .O(new_n36_));
  nand3  g18(.a(new_n36_), .b(new_n31_), .c(new_n30_), .O(z5));
  inv1   g19(.a(x7), .O(new_n38_));
  nand3  g20(.a(x9), .b(new_n38_), .c(x5), .O(new_n39_));
  nand4  g21(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n40_));
  nand2  g22(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g23(.a(new_n41_), .b(x8), .O(new_n42_));
  inv1   g24(.a(x2), .O(new_n43_));
  nand3  g25(.a(new_n43_), .b(new_n27_), .c(new_n26_), .O(new_n44_));
  nand2  g26(.a(new_n44_), .b(x8), .O(new_n45_));
  nand3  g27(.a(new_n45_), .b(x9), .c(x7), .O(new_n46_));
  nand3  g28(.a(new_n46_), .b(new_n42_), .c(new_n31_), .O(z6));
  one    g29(.O(z3));
endmodule
