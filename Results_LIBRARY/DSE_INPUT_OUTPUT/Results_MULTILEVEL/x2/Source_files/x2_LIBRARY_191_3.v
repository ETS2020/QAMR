...
module FAU ( 
  ...
  nand3  g16(.a(x8), .b(new_n33_), .c(new_n32_), .O(new_n34_));
  ...
  nand3  g20(.a(new_n18_), .b(new_n19_), .c(x0), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n37_), .c(new_n29_), .O(z3));
  inv1   g22(.a(x6), .O(new_n40_));
  nand3  g23(.a(new_n26_), .b(x7), .c(new_n40_), .O(new_n41_));
  nor2   g24(.a(new_n18_), .b(new_n20_), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n19_), .c(new_n30_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n41_), .c(new_n38_), .O(z4));
  nand2  g27(.a(new_n20_), .b(new_n19_), .O(new_n45_));
  nand3  g28(.a(x9), .b(x8), .c(x7), .O(new_n46_));
  aoi21  g29(.a(new_n46_), .b(new_n45_), .c(new_n33_), .O(new_n47_));
  nand4  g30(.a(x9), .b(x8), .c(new_n19_), .d(x5), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x6), .O(new_n49_));
  aoi21  g32(.a(new_n47_), .b(new_n32_), .c(new_n49_), .O(new_n50_));
  ...
  nand2  g38(.a(new_n26_), .b(new_n40_), .O(new_n56_));
  nand3  g39(.a(new_n42_), .b(x5), .c(new_n30_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n27_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n19_), .O(new_n59_));
  oai21  g42(.a(x2), .b(x1), .c(x8), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x9), .c(new_n30_), .O(new_n61_));
