...
module FAU ( 
  ...
  oai21  g09(.a(x9), .b(new_n19_), .c(x2), .O(new_n27_));
  oai21  g10(.a(x8), .b(new_n19_), .c(x9), .O(new_n28_));
  inv1   g11(.a(x0), .O(new_n29_));
  inv1   g12(.a(x1), .O(new_n30_));
  nand4  g13(.a(x8), .b(new_n19_), .c(new_n30_), .d(new_n29_), .O(new_n31_));
  ...
  nand4  g19(.a(x9), .b(x8), .c(new_n19_), .d(x5), .O(new_n37_));
  ...
  oai21  g28(.a(new_n18_), .b(new_n36_), .c(new_n45_), .O(new_n46_));
  nand4  g29(.a(x9), .b(x8), .c(x5), .d(new_n36_), .O(new_n47_));
  nand2  g30(.a(new_n18_), .b(new_n20_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n19_), .O(new_n50_));
  oai21  g33(.a(x1), .b(x0), .c(x8), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(x9), .c(new_n36_), .O(new_n52_));
