...
module FAU ( 
  ...
  oai21  g04(.a(x9), .b(x5), .c(new_n21_), .O(new_n22_));
  ...
  oai21  g16(.a(new_n21_), .b(new_n33_), .c(new_n18_), .O(new_n34_));
  ...
  nand4  g40(.a(new_n57_), .b(new_n53_), .c(new_n51_), .d(x6), .O(z6));
endmodule
