...
module FAU ( 
  ...
  oai21  g10(.a(new_n27_), .b(new_n20_), .c(x9), .O(new_n28_));
  inv1   g11(.a(x0), .O(new_n29_));
  inv1   g12(.a(x1), .O(new_n30_));
  inv1   g13(.a(x2), .O(new_n31_));
  nand4  g14(.a(x8), .b(new_n31_), .c(new_n30_), .d(new_n29_), .O(new_n32_));
  inv1   g15(.a(new_n32_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n28_), .c(new_n22_), .O(z3));
  oai21  g17(.a(x8), .b(new_n20_), .c(x9), .O(new_n35_));
  nand3  g18(.a(new_n35_), .b(x7), .c(x6), .O(z4));
  nand4  g19(.a(new_n27_), .b(x2), .c(new_n30_), .d(new_n29_), .O(new_n37_));
  aoi21  g20(.a(x8), .b(new_n22_), .c(new_n20_), .O(new_n38_));
  ...
  aoi21  g25(.a(new_n42_), .b(x6), .c(new_n22_), .O(new_n43_));
