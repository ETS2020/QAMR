...
module FAU ( 
  ...
  nand2  g16(.a(new_n18_), .b(new_n24_), .O(new_n34_));
  oai21  g17(.a(new_n33_), .b(new_n24_), .c(new_n34_), .O(z4));
  oai21  g18(.a(new_n18_), .b(x7), .c(new_n32_), .O(new_n36_));
  ...
  oai21  g26(.a(x9), .b(new_n20_), .c(new_n24_), .O(new_n44_));
  ...
  nand4  g31(.a(new_n48_), .b(new_n46_), .c(new_n44_), .d(x6), .O(z6));
endmodule
