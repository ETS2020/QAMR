...
module FAU ( 
  ...
  oai21  g17(.a(new_n33_), .b(new_n22_), .c(new_n34_), .O(z4));
  nand2  g18(.a(new_n23_), .b(new_n32_), .O(new_n36_));
  nand4  g19(.a(x8), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n37_));
  ...
  nand4  g30(.a(x9), .b(new_n28_), .c(new_n27_), .d(new_n26_), .O(new_n48_));
