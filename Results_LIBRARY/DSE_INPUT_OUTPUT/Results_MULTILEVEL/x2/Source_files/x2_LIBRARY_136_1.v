...
module FAU ( 
  ...
  nor2   g12(.a(new_n18_), .b(x2), .O(new_n30_));
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n23_), .d(new_n25_), .O(z3));
  inv1   g14(.a(x6), .O(new_n32_));
  aoi21  g15(.a(x9), .b(x8), .c(new_n32_), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n25_), .c(new_n21_), .O(z4));
  nand2  g17(.a(new_n26_), .b(new_n32_), .O(new_n35_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n35_), .O(z5));
  nor2   g28(.a(new_n23_), .b(new_n25_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n20_), .c(new_n18_), .O(new_n47_));
  inv1   g30(.a(x2), .O(new_n48_));
  nand3  g31(.a(new_n29_), .b(x9), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n47_), .c(new_n35_), .O(z6));
endmodule
