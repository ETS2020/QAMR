...
module FAU ( 
  ...
  nand4  g10(.a(new_n27_), .b(new_n25_), .c(new_n20_), .d(new_n24_), .O(z3));
  nand3  g11(.a(new_n20_), .b(x7), .c(x6), .O(z4));
  inv1   g12(.a(x6), .O(new_n30_));
  oai21  g13(.a(new_n20_), .b(new_n24_), .c(new_n30_), .O(new_n31_));
  inv1   g14(.a(x0), .O(new_n32_));
  inv1   g15(.a(x1), .O(new_n33_));
  nand4  g16(.a(new_n26_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n34_));
  ...
  oai21  g26(.a(new_n43_), .b(new_n19_), .c(new_n24_), .O(new_n44_));
  nor2   g27(.a(x9), .b(new_n26_), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(x7), .c(x4), .d(x3), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n44_), .c(new_n31_), .O(z6));
endmodule
