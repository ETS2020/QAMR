...
module FAU ( 
  ...
  oai21  g04(.a(x9), .b(x2), .c(new_n21_), .O(new_n22_));
  ...
  nand3  g21(.a(new_n38_), .b(new_n29_), .c(new_n28_), .O(new_n39_));
  ...
  nand4  g27(.a(x9), .b(x8), .c(new_n21_), .d(x5), .O(new_n45_));
  ...
  nand3  g34(.a(new_n18_), .b(new_n29_), .c(new_n28_), .O(new_n52_));
  ...
  aoi21  g39(.a(new_n19_), .b(x2), .c(new_n33_), .O(new_n57_));
