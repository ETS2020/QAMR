...
module FAU ( 
  ...
  oai21  g08(.a(new_n24_), .b(x3), .c(new_n25_), .O(z1));
  ...
  nand4  g17(.a(new_n34_), .b(new_n29_), .c(new_n25_), .d(new_n20_), .O(z3));
  nand2  g18(.a(new_n18_), .b(x3), .O(new_n36_));
  ...
  nand3  g30(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(x8), .c(new_n20_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n47_), .c(x9), .O(new_n50_));
  nor2   g33(.a(x8), .b(x7), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(x3), .c(new_n18_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n50_), .c(x6), .O(z6));
endmodule
