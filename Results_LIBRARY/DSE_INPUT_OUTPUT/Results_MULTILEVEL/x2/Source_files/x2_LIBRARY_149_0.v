...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(x2), .c(new_n33_), .d(new_n20_), .O(new_n35_));
  ...
  oai21  g24(.a(new_n41_), .b(new_n30_), .c(x0), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n38_), .O(z5));
  inv1   g26(.a(x2), .O(new_n44_));
  nand3  g27(.a(x7), .b(new_n44_), .c(new_n33_), .O(new_n45_));
  ...
  aoi21  g35(.a(new_n52_), .b(new_n21_), .c(new_n30_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n50_), .c(new_n47_), .O(z6));
endmodule
