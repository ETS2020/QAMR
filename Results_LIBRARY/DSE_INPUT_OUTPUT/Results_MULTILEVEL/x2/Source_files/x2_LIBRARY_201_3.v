...
module FAU ( 
  ...
  aoi21  g41(.a(new_n58_), .b(new_n21_), .c(new_n45_), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n57_), .c(new_n54_), .d(new_n41_), .O(z6));
endmodule
