...
module FAU ( 
  ...
  oai22  g07(.a(new_n24_), .b(x7), .c(new_n23_), .d(x2), .O(z1));
  nand2  g08(.a(x7), .b(x2), .O(new_n26_));
  ...
  nand4  g13(.a(new_n30_), .b(new_n22_), .c(x8), .d(new_n27_), .O(z3));
  inv1   g14(.a(x6), .O(new_n32_));
  nor2   g15(.a(new_n22_), .b(new_n19_), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(new_n18_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x7), .O(z4));
  nor3   g18(.a(x8), .b(x1), .c(x0), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(x7), .c(x2), .O(new_n37_));
  ...
  aoi21  g26(.a(new_n43_), .b(new_n33_), .c(new_n32_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n41_), .c(new_n37_), .O(z5));
  nand2  g28(.a(new_n26_), .b(new_n32_), .O(new_n46_));
  nand3  g29(.a(x9), .b(x8), .c(x5), .O(new_n47_));
  inv1   g30(.a(new_n47_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n24_), .c(new_n27_), .O(new_n49_));
  oai21  g32(.a(x1), .b(x0), .c(x8), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x9), .O(new_n51_));
  nand4  g34(.a(new_n22_), .b(x8), .c(x4), .d(x3), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(x7), .c(new_n18_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n49_), .c(new_n46_), .O(z6));
endmodule
