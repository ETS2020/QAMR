...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n36_));
  oai21  g18(.a(x9), .b(new_n24_), .c(new_n31_), .O(new_n37_));
  nand3  g19(.a(x9), .b(x8), .c(x5), .O(new_n38_));
  inv1   g20(.a(new_n38_), .O(new_n39_));
  oai21  g21(.a(new_n39_), .b(new_n19_), .c(new_n24_), .O(new_n40_));
