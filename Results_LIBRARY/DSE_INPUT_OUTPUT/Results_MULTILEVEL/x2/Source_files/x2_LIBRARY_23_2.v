...
module FAU ( 
  ...
  nand4  g11(.a(x8), .b(new_n29_), .c(new_n28_), .d(new_n27_), .O(new_n30_));
  nand2  g12(.a(new_n30_), .b(new_n22_), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(new_n20_), .O(z3));
  ...
  nand2  g20(.a(new_n21_), .b(new_n33_), .O(new_n39_));
  nand3  g21(.a(x9), .b(x8), .c(x5), .O(new_n40_));
  oai21  g22(.a(x9), .b(x8), .c(new_n40_), .O(new_n41_));
  nand2  g23(.a(new_n41_), .b(new_n22_), .O(new_n42_));
  nand3  g24(.a(new_n42_), .b(new_n39_), .c(new_n38_), .O(z5));
  nand3  g25(.a(new_n29_), .b(new_n28_), .c(new_n27_), .O(new_n44_));
  aoi21  g26(.a(new_n44_), .b(x8), .c(new_n22_), .O(new_n45_));
  nand3  g27(.a(x8), .b(new_n22_), .c(x5), .O(new_n46_));
  inv1   g28(.a(new_n46_), .O(new_n47_));
  oai21  g29(.a(new_n47_), .b(new_n45_), .c(x9), .O(new_n48_));
  nand3  g30(.a(new_n20_), .b(new_n19_), .c(new_n22_), .O(new_n49_));
  nand3  g31(.a(new_n49_), .b(new_n48_), .c(new_n39_), .O(z6));
  one    g32(.O(z0));
endmodule
