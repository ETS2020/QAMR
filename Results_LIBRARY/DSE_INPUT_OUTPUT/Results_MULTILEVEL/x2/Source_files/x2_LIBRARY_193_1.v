...
module FAU ( 
  ...
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n27_), .d(new_n18_), .O(z3));
  nand2  g13(.a(x9), .b(x8), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(x7), .c(x6), .O(z4));
  inv1   g15(.a(x6), .O(new_n33_));
  oai21  g16(.a(new_n21_), .b(x7), .c(new_n33_), .O(new_n34_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n47_), .c(new_n34_), .O(z6));
endmodule
