...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(new_n29_), .c(x9), .O(new_n31_));
  nor2   g14(.a(x1), .b(x0), .O(new_n32_));
  nor2   g15(.a(new_n19_), .b(x2), .O(new_n33_));
  nand4  g16(.a(new_n33_), .b(new_n32_), .c(new_n31_), .d(new_n18_), .O(z3));
  oai21  g17(.a(x8), .b(new_n29_), .c(x9), .O(new_n35_));
  nand3  g18(.a(new_n35_), .b(x7), .c(x6), .O(z4));
  inv1   g19(.a(x0), .O(new_n37_));
  nand3  g20(.a(x9), .b(x8), .c(x7), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(new_n27_), .c(x1), .O(new_n39_));
  ...
  oai21  g29(.a(new_n42_), .b(new_n29_), .c(new_n46_), .O(z5));
  inv1   g30(.a(x6), .O(new_n48_));
  oai21  g31(.a(new_n20_), .b(x2), .c(new_n48_), .O(new_n49_));
  nand3  g32(.a(x8), .b(new_n18_), .c(x5), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n30_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(x9), .c(x2), .O(new_n52_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n52_), .c(new_n49_), .O(z6));
endmodule
