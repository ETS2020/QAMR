...
module FAU ( 
  ...
  oai21  g16(.a(new_n32_), .b(new_n29_), .c(new_n33_), .O(z4));
  inv1   g17(.a(x0), .O(new_n35_));
  inv1   g18(.a(x1), .O(new_n36_));
  oai21  g19(.a(new_n33_), .b(new_n19_), .c(new_n27_), .O(new_n37_));
  ...
  nand3  g23(.a(new_n40_), .b(x8), .c(x2), .O(new_n41_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n31_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n38_), .O(z5));
  nand2  g30(.a(z3), .b(new_n31_), .O(new_n48_));
  ...
  nand3  g34(.a(new_n23_), .b(new_n36_), .c(new_n35_), .O(new_n52_));
