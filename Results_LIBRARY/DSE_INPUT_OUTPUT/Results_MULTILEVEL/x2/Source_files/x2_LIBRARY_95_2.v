...
module FAU ( 
  ...
  oai21  g30(.a(new_n47_), .b(new_n34_), .c(new_n19_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n45_), .O(z5));
  nor3   g32(.a(x9), .b(x8), .c(x7), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n34_), .c(new_n19_), .O(new_n51_));
  nand2  g34(.a(new_n43_), .b(x6), .O(new_n52_));
  nand3  g35(.a(new_n29_), .b(new_n40_), .c(new_n39_), .O(new_n53_));
