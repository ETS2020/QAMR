...
module FAU ( 
  ...
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(x9), .d(x6), .O(z5));
  inv1   g16(.a(x2), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n29_), .c(new_n28_), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(x8), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(x9), .c(x7), .O(new_n37_));
  nand2  g20(.a(x8), .b(x5), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(x9), .c(x7), .O(new_n39_));
  oai21  g22(.a(x9), .b(new_n22_), .c(x6), .O(new_n40_));
  nor2   g23(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n37_), .O(z6));
endmodule
