...
module FAU ( 
  ...
  oai22  g05(.a(new_n22_), .b(x7), .c(new_n20_), .d(x9), .O(z1));
  nand2  g06(.a(x9), .b(x8), .O(new_n24_));
  inv1   g07(.a(x7), .O(new_n25_));
  nand3  g08(.a(new_n18_), .b(new_n21_), .c(new_n25_), .O(new_n26_));
  nand2  g09(.a(new_n26_), .b(new_n24_), .O(z2));
  inv1   g10(.a(x0), .O(new_n28_));
  inv1   g11(.a(x1), .O(new_n29_));
  inv1   g12(.a(x2), .O(new_n30_));
  nand4  g13(.a(new_n25_), .b(new_n30_), .c(new_n29_), .d(new_n28_), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n18_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(x8), .O(z3));
  nand3  g16(.a(new_n24_), .b(x7), .c(x6), .O(z4));
  inv1   g17(.a(x6), .O(new_n35_));
  nand2  g18(.a(new_n24_), .b(new_n35_), .O(new_n36_));
  nand4  g19(.a(new_n25_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n37_));
