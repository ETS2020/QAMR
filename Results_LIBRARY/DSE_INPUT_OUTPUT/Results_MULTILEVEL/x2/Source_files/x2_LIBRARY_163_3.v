...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n23_, new_n25_, new_n28_, new_n29_,
  ...
  nand4  g08(.a(new_n25_), .b(new_n21_), .c(x8), .d(new_n19_), .O(z3));
  oai21  g09(.a(x9), .b(x6), .c(x7), .O(z4));
  inv1   g10(.a(x3), .O(new_n28_));
  oai21  g11(.a(x4), .b(new_n28_), .c(new_n21_), .O(new_n29_));
