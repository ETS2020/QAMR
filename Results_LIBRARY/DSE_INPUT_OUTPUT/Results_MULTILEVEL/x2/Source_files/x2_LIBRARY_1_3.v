...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n24_, new_n25_, new_n28_, new_n29_,
  ...
  oai21  g11(.a(new_n20_), .b(new_n24_), .c(new_n28_), .O(new_n29_));
  ...
  oai21  g28(.a(new_n45_), .b(new_n19_), .c(new_n24_), .O(new_n46_));
