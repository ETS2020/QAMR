...
module FAU ( 
  ...
  nor2   g13(.a(new_n25_), .b(new_n20_), .O(new_n31_));
  nor2   g14(.a(new_n31_), .b(new_n19_), .O(new_n32_));
  ...
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n38_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n34_), .O(new_n48_));
  inv1   g31(.a(x3), .O(new_n49_));
  nand2  g32(.a(new_n45_), .b(new_n31_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n26_), .c(x6), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n48_), .O(z5));
  nand3  g36(.a(new_n21_), .b(x7), .c(x4), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n34_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x3), .O(new_n56_));
  oai21  g39(.a(new_n26_), .b(x7), .c(x6), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n18_), .O(new_n58_));
  oai21  g41(.a(x9), .b(x7), .c(new_n43_), .O(new_n59_));
  inv1   g42(.a(x2), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n35_), .c(new_n34_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(x8), .c(new_n28_), .O(new_n62_));
  nand3  g45(.a(x8), .b(new_n28_), .c(x5), .O(new_n63_));
  inv1   g46(.a(new_n63_), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n62_), .c(x9), .O(new_n65_));
  nand4  g48(.a(new_n65_), .b(new_n59_), .c(new_n58_), .d(new_n56_), .O(z6));
endmodule
