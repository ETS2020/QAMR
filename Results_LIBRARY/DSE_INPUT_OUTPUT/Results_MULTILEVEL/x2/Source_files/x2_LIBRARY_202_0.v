...
module FAU ( 
  ...
  nand2  g03(.a(new_n18_), .b(x6), .O(new_n21_));
  oai21  g04(.a(new_n20_), .b(new_n18_), .c(new_n21_), .O(z0));
  inv1   g05(.a(x6), .O(new_n23_));
  oai21  g06(.a(x9), .b(new_n23_), .c(new_n18_), .O(new_n24_));
  inv1   g07(.a(x9), .O(new_n25_));
  aoi21  g08(.a(new_n25_), .b(x7), .c(x8), .O(new_n26_));
  nand2  g09(.a(new_n26_), .b(new_n24_), .O(z1));
  nand4  g10(.a(new_n25_), .b(new_n19_), .c(new_n18_), .d(x6), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  inv1   g12(.a(x0), .O(new_n30_));
  inv1   g13(.a(x1), .O(new_n31_));
  inv1   g14(.a(x2), .O(new_n32_));
  nand4  g15(.a(new_n20_), .b(new_n32_), .c(new_n31_), .d(new_n30_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n18_), .c(x6), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n18_), .O(z3));
  nor2   g18(.a(new_n25_), .b(new_n19_), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(new_n23_), .c(x7), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n21_), .O(z4));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n36_), .c(new_n23_), .O(new_n48_));
  ...
  nand3  g35(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(x8), .c(new_n25_), .O(new_n54_));
