...
module FAU ( 
  ...
  nand2  g07(.a(new_n20_), .b(new_n19_), .O(new_n26_));
  nor2   g08(.a(new_n26_), .b(x9), .O(z2));
  nand2  g09(.a(new_n23_), .b(x8), .O(z3));
  inv1   g10(.a(x6), .O(new_n29_));
  oai21  g11(.a(new_n19_), .b(new_n29_), .c(new_n20_), .O(new_n30_));
  nand2  g12(.a(x9), .b(x8), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(new_n30_), .O(z4));
  inv1   g14(.a(x0), .O(new_n33_));
  inv1   g15(.a(x1), .O(new_n34_));
  oai21  g16(.a(new_n31_), .b(new_n19_), .c(new_n26_), .O(new_n35_));
  nand4  g17(.a(new_n35_), .b(x2), .c(new_n34_), .d(new_n33_), .O(new_n36_));
  nand3  g18(.a(x8), .b(new_n19_), .c(x5), .O(new_n37_));
  ...
  aoi21  g24(.a(new_n42_), .b(x8), .c(new_n19_), .O(new_n43_));
  oai21  g25(.a(new_n43_), .b(new_n38_), .c(x9), .O(new_n44_));
  aoi21  g26(.a(new_n21_), .b(new_n23_), .c(new_n29_), .O(new_n45_));
