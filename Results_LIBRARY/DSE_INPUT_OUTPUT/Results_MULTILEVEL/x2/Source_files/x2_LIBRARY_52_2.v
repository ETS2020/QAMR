...
module FAU ( 
  ...
  nand3  g26(.a(new_n43_), .b(x8), .c(new_n18_), .O(new_n44_));
  ...
  aoi21  g31(.a(new_n48_), .b(new_n46_), .c(new_n33_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n45_), .c(new_n42_), .O(z5));
  nor3   g33(.a(x9), .b(x8), .c(x7), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n33_), .c(new_n18_), .O(new_n52_));
