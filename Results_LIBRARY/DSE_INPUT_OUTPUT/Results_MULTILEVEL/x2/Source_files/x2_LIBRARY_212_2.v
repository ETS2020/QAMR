...
module FAU ( 
  ...
  nand3  g05(.a(new_n18_), .b(new_n22_), .c(x7), .O(new_n23_));
  nand2  g06(.a(new_n23_), .b(new_n21_), .O(z1));
  aoi21  g07(.a(new_n22_), .b(x7), .c(x9), .O(z2));
  nand2  g08(.a(new_n18_), .b(x8), .O(z3));
  ...
  nand4  g16(.a(x9), .b(x8), .c(new_n20_), .d(x5), .O(new_n34_));
  nand4  g17(.a(new_n34_), .b(new_n33_), .c(new_n31_), .d(x9), .O(z5));
  inv1   g18(.a(x2), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n29_), .c(new_n28_), .O(new_n37_));
  ...
  nand3  g24(.a(new_n18_), .b(new_n22_), .c(new_n20_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n41_), .c(new_n33_), .O(z6));
endmodule
