...
module FAU ( 
  ...
  oai21  g16(.a(new_n20_), .b(x7), .c(new_n21_), .O(new_n35_));
  inv1   g17(.a(x6), .O(new_n36_));
  inv1   g18(.a(x5), .O(new_n37_));
  nor2   g19(.a(x7), .b(new_n37_), .O(new_n38_));
  aoi21  g20(.a(new_n38_), .b(new_n22_), .c(new_n36_), .O(new_n39_));
  nand3  g21(.a(new_n39_), .b(new_n35_), .c(new_n34_), .O(z5));
  oai21  g22(.a(new_n21_), .b(x7), .c(new_n20_), .O(new_n41_));
  nor3   g23(.a(x2), .b(x1), .c(x0), .O(new_n42_));
  oai21  g24(.a(new_n42_), .b(new_n21_), .c(x7), .O(new_n43_));
