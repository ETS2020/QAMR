...
module FAU ( 
  ...
  oai22  g07(.a(new_n24_), .b(x7), .c(new_n23_), .d(new_n18_), .O(z1));
  ...
  oai21  g12(.a(new_n29_), .b(x7), .c(x4), .O(new_n30_));
  ...
  oai21  g22(.a(new_n39_), .b(new_n29_), .c(x4), .O(new_n40_));
  ...
  aoi22  g29(.a(new_n46_), .b(new_n29_), .c(x7), .d(new_n18_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(new_n44_), .c(new_n26_), .d(x6), .O(z5));
  nand3  g31(.a(x9), .b(x8), .c(x5), .O(new_n49_));
  inv1   g32(.a(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n24_), .c(new_n31_), .O(new_n51_));
  nand3  g34(.a(new_n35_), .b(new_n33_), .c(new_n32_), .O(new_n52_));
