...
module FAU ( 
  ...
  oai21  g08(.a(x8), .b(new_n21_), .c(x9), .O(new_n26_));
  nor2   g09(.a(x1), .b(x0), .O(new_n27_));
  inv1   g10(.a(x8), .O(new_n28_));
  nor2   g11(.a(new_n28_), .b(x2), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(new_n27_), .c(new_n26_), .d(new_n21_), .O(z3));
  nor2   g13(.a(new_n18_), .b(new_n28_), .O(new_n31_));
  ...
  nand3  g21(.a(new_n31_), .b(new_n21_), .c(x5), .O(new_n39_));
  ...
  nand3  g29(.a(new_n31_), .b(x6), .c(x5), .O(new_n47_));
