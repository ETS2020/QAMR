...
module FAU ( 
  ...
  nand2  g06(.a(x9), .b(x1), .O(new_n24_));
  ...
  nand3  g15(.a(x8), .b(new_n32_), .c(new_n31_), .O(new_n33_));
  ...
  nand3  g19(.a(new_n18_), .b(new_n20_), .c(x1), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n36_), .c(new_n28_), .O(z3));
  or2    g21(.a(new_n28_), .b(x6), .O(new_n39_));
  inv1   g22(.a(x8), .O(new_n40_));
  oai21  g23(.a(new_n18_), .b(new_n40_), .c(x7), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n29_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n39_), .c(new_n37_), .O(z4));
  nand3  g26(.a(x9), .b(x8), .c(x7), .O(new_n44_));
  oai21  g27(.a(x8), .b(x7), .c(new_n44_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(x2), .c(new_n31_), .O(new_n46_));
  ...
  nand4  g45(.a(new_n62_), .b(new_n57_), .c(new_n24_), .d(x6), .O(z6));
endmodule
