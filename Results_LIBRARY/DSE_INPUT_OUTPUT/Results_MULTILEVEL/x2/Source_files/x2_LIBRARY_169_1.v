...
module FAU ( 
  ...
  oai21  g09(.a(new_n18_), .b(x1), .c(new_n26_), .O(z2));
  nand3  g10(.a(new_n25_), .b(x7), .c(x1), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(x9), .O(new_n29_));
  nor2   g12(.a(x1), .b(x0), .O(new_n30_));
  nor2   g13(.a(new_n25_), .b(x2), .O(new_n31_));
  ...
  nand4  g17(.a(x9), .b(x8), .c(new_n21_), .d(x5), .O(new_n35_));
  ...
  nand2  g25(.a(x9), .b(new_n25_), .O(new_n43_));
  ...
  nor2   g29(.a(new_n18_), .b(x1), .O(new_n47_));
  oai21  g30(.a(x8), .b(x7), .c(x6), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n18_), .c(new_n47_), .O(new_n49_));
