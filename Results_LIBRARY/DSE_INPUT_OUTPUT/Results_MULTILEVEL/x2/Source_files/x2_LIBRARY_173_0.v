...
module FAU ( 
  ...
  nand2  g14(.a(new_n33_), .b(new_n18_), .O(new_n34_));
  ...
  nand3  g21(.a(new_n40_), .b(new_n28_), .c(new_n27_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(x8), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(x9), .c(x7), .O(new_n43_));
  and2   g24(.a(x4), .b(x3), .O(new_n44_));
  inv1   g25(.a(x8), .O(new_n45_));
  nor2   g26(.a(x9), .b(new_n45_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n44_), .c(new_n35_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n43_), .c(new_n34_), .O(z6));
  zero   g29(.O(z2));
  one    g30(.O(z3));
endmodule
