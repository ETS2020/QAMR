...
module FAU ( 
  ...
  oai21  g21(.a(new_n34_), .b(new_n22_), .c(new_n38_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(x2), .c(new_n37_), .d(new_n36_), .O(new_n40_));
  nand2  g23(.a(x7), .b(x3), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(x8), .c(new_n18_), .O(new_n42_));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n44_), .c(new_n32_), .O(new_n47_));
  ...
  nand2  g37(.a(new_n38_), .b(new_n18_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n19_), .c(new_n32_), .O(new_n56_));
