...
module FAU ( 
  ...
  nand2  g11(.a(x8), .b(new_n19_), .O(new_n29_));
  ...
  oai21  g16(.a(x8), .b(new_n23_), .c(x9), .O(new_n34_));
  oai21  g17(.a(x7), .b(new_n23_), .c(new_n34_), .O(z4));
  ...
  oai21  g28(.a(new_n29_), .b(new_n45_), .c(x6), .O(new_n46_));
  ...
  oai21  g37(.a(new_n54_), .b(new_n46_), .c(x9), .O(new_n55_));
