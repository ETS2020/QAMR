...
module FAU ( 
  ...
  oai21  g07(.a(new_n18_), .b(new_n24_), .c(x9), .O(new_n25_));
  ...
  oai21  g12(.a(new_n20_), .b(x4), .c(new_n29_), .O(z2));
  ...
  oai21  g20(.a(x8), .b(new_n24_), .c(x9), .O(new_n38_));
  ...
  nand3  g32(.a(x7), .b(new_n24_), .c(x3), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x8), .c(x6), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n49_), .O(z5));
  oai21  g36(.a(new_n20_), .b(x4), .c(new_n43_), .O(new_n54_));
  nand3  g37(.a(new_n44_), .b(x5), .c(x4), .O(new_n55_));
  inv1   g38(.a(new_n55_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n28_), .c(new_n18_), .O(new_n57_));
  nor2   g40(.a(x2), .b(x1), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n31_), .c(new_n19_), .O(new_n59_));
  nand3  g42(.a(new_n20_), .b(x8), .c(x3), .O(new_n60_));
  oai21  g43(.a(new_n59_), .b(new_n20_), .c(new_n60_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(x7), .c(x4), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n57_), .c(new_n54_), .O(z6));
endmodule
