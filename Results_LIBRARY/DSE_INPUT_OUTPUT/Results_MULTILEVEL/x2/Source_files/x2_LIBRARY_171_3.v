...
module FAU ( 
  ...
  nand4  g11(.a(new_n22_), .b(new_n28_), .c(new_n27_), .d(new_n26_), .O(new_n29_));
  ...
  oai21  g20(.a(x8), .b(x7), .c(x9), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand4  g22(.a(new_n22_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n40_));
  ...
  nand3  g31(.a(new_n18_), .b(new_n20_), .c(new_n22_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n48_), .c(new_n39_), .O(z6));
endmodule
