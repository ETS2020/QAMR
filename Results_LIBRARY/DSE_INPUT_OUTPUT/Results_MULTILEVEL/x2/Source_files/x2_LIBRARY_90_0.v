...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(new_n30_), .c(x3), .O(new_n33_));
  ...
  nand2  g31(.a(new_n35_), .b(new_n48_), .O(new_n49_));
  nand3  g32(.a(x8), .b(x7), .c(x4), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n26_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n18_), .c(x3), .O(new_n52_));
  inv1   g35(.a(new_n40_), .O(new_n53_));
  nand3  g36(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(new_n54_));
