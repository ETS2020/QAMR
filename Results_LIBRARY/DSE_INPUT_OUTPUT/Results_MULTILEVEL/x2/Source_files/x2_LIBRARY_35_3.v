...
module FAU ( 
  ...
  nor2   g09(.a(new_n18_), .b(x2), .O(new_n27_));
  nand4  g10(.a(new_n27_), .b(new_n26_), .c(new_n19_), .d(new_n22_), .O(z3));
  nand3  g11(.a(new_n19_), .b(x7), .c(x6), .O(z4));
  inv1   g12(.a(x6), .O(new_n30_));
  nand2  g13(.a(new_n24_), .b(new_n30_), .O(new_n31_));
  inv1   g14(.a(x3), .O(new_n32_));
  oai21  g15(.a(x4), .b(new_n32_), .c(new_n19_), .O(new_n33_));
