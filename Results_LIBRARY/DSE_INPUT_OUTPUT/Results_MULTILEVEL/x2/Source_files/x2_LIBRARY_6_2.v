...
module FAU ( 
  ...
  oai21  g22(.a(new_n36_), .b(new_n20_), .c(new_n27_), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n34_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n41_), .O(z5));
  nor3   g30(.a(x9), .b(x8), .c(x7), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n34_), .c(new_n19_), .O(new_n49_));
  inv1   g32(.a(x2), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n39_), .c(new_n38_), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(x8), .c(new_n20_), .O(new_n52_));
  oai21  g35(.a(new_n29_), .b(new_n44_), .c(x6), .O(new_n53_));
