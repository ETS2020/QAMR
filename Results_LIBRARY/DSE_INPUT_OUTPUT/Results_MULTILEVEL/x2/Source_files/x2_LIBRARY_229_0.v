...
module FAU ( 
  ...
  oai21  g22(.a(new_n35_), .b(new_n22_), .c(new_n39_), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n32_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n41_), .O(z5));
  oai21  g30(.a(x9), .b(x4), .c(new_n32_), .O(new_n48_));
