...
module FAU ( 
  ...
  nand3  g10(.a(new_n19_), .b(x7), .c(x1), .O(new_n28_));
  ...
  nand4  g18(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n36_));
  ...
  nor2   g31(.a(new_n20_), .b(x1), .O(new_n49_));
  aoi21  g32(.a(new_n48_), .b(new_n20_), .c(new_n49_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n47_), .c(new_n38_), .O(z6));
endmodule
