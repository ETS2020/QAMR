...
module FAU ( 
  ...
  nand3  g16(.a(new_n20_), .b(new_n23_), .c(x2), .O(new_n34_));
  nand3  g17(.a(x9), .b(x8), .c(x7), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n33_), .c(new_n32_), .O(new_n37_));
  ...
  nand2  g32(.a(x9), .b(new_n20_), .O(new_n50_));
  nand4  g33(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n50_), .c(x2), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x7), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n49_), .c(x6), .O(z6));
endmodule
