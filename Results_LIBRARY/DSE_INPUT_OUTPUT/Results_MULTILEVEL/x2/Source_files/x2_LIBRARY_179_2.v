...
module FAU ( 
  ...
  nand3  g24(.a(new_n42_), .b(new_n33_), .c(new_n32_), .O(new_n43_));
  ...
  nand3  g29(.a(new_n20_), .b(new_n19_), .c(new_n22_), .O(new_n48_));
  nand3  g30(.a(new_n48_), .b(new_n47_), .c(new_n37_), .O(z6));
  one    g31(.O(z0));
endmodule
