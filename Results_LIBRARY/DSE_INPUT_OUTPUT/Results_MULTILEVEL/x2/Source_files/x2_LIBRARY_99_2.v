...
module FAU ( 
  ...
  nand2  g18(.a(new_n18_), .b(x5), .O(new_n36_));
  ...
  oai21  g24(.a(new_n21_), .b(x7), .c(x9), .O(new_n42_));
  ...
  nand4  g30(.a(new_n47_), .b(new_n43_), .c(new_n41_), .d(x6), .O(z5));
  xnor2a g31(.a(x9), .b(x7), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n21_), .O(new_n50_));
  nand4  g33(.a(x9), .b(new_n32_), .c(new_n30_), .d(new_n29_), .O(new_n51_));
  ...
  nand4  g37(.a(new_n54_), .b(new_n50_), .c(new_n43_), .d(x6), .O(z6));
endmodule
