...
module FAU ( 
  ...
  nand4  g15(.a(new_n33_), .b(x2), .c(new_n20_), .d(new_n32_), .O(new_n34_));
  ...
  oai21  g23(.a(new_n41_), .b(new_n38_), .c(x1), .O(new_n42_));
  ...
  aoi21  g34(.a(new_n52_), .b(new_n21_), .c(new_n38_), .O(new_n53_));
