...
module FAU ( 
  ...
  nand2  g19(.a(new_n25_), .b(new_n21_), .O(new_n37_));
  oai21  g20(.a(new_n35_), .b(new_n21_), .c(new_n37_), .O(new_n38_));
  ...
  nor2   g26(.a(new_n35_), .b(x7), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(x5), .c(new_n20_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n21_), .c(x6), .O(new_n49_));
  nand3  g32(.a(new_n31_), .b(new_n30_), .c(new_n29_), .O(new_n50_));
