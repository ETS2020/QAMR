...
module FAU ( 
  ...
  oai21  g12(.a(new_n29_), .b(new_n27_), .c(new_n24_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n21_), .O(z3));
  nand3  g14(.a(new_n18_), .b(x7), .c(x6), .O(z4));
  inv1   g15(.a(x6), .O(new_n33_));
  oai21  g16(.a(new_n18_), .b(new_n24_), .c(new_n33_), .O(new_n34_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n39_), .c(new_n34_), .O(z5));
  ...
  oai21  g31(.a(new_n48_), .b(new_n20_), .c(new_n24_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n47_), .c(new_n34_), .O(z6));
endmodule
