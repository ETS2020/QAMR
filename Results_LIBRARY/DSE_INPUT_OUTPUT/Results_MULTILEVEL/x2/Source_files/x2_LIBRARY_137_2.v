...
module FAU ( 
  ...
  oai21  g08(.a(new_n24_), .b(x2), .c(new_n25_), .O(z1));
  ...
  nand3  g22(.a(new_n39_), .b(new_n30_), .c(new_n29_), .O(new_n40_));
  ...
  oai21  g31(.a(x9), .b(new_n19_), .c(new_n34_), .O(new_n49_));
  nand3  g32(.a(x9), .b(x8), .c(x5), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  nor3   g34(.a(x9), .b(x8), .c(x2), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n51_), .c(new_n20_), .O(new_n53_));
  nand3  g36(.a(x9), .b(new_n30_), .c(new_n29_), .O(new_n54_));
  nand4  g37(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n54_), .c(x2), .O(new_n56_));
  nor2   g39(.a(new_n18_), .b(x8), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n56_), .c(x7), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n53_), .c(new_n49_), .O(z6));
endmodule
