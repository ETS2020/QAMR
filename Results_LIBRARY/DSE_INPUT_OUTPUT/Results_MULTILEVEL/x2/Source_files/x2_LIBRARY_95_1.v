...
module FAU ( 
  ...
  nand2  g11(.a(x9), .b(new_n28_), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(x7), .O(new_n30_));
  nand2  g13(.a(new_n19_), .b(x7), .O(new_n31_));
  ...
  nand3  g19(.a(new_n36_), .b(new_n20_), .c(new_n18_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n32_), .c(new_n30_), .O(z3));
  inv1   g21(.a(x6), .O(new_n39_));
  nand3  g22(.a(new_n29_), .b(x7), .c(new_n39_), .O(new_n40_));
  ...
  nor2   g28(.a(new_n20_), .b(new_n19_), .O(new_n46_));
  ...
  nand3  g44(.a(new_n20_), .b(x8), .c(x3), .O(new_n62_));
  oai21  g45(.a(new_n61_), .b(new_n20_), .c(new_n62_), .O(new_n63_));
