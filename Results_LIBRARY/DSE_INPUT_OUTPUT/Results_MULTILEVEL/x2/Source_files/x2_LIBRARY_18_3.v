...
module FAU ( 
  ...
  nand4  g31(.a(new_n48_), .b(new_n44_), .c(new_n24_), .d(x6), .O(z5));
  nand2  g32(.a(new_n24_), .b(new_n38_), .O(new_n50_));
  nand3  g33(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x8), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(x9), .c(new_n29_), .O(new_n53_));
  ...
  nand3  g39(.a(new_n56_), .b(new_n50_), .c(new_n26_), .O(z6));
endmodule
