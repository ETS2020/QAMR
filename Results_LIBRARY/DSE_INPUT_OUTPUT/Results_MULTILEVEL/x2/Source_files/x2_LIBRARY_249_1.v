...
module FAU ( 
  ...
  nand3  g21(.a(new_n33_), .b(new_n21_), .c(x5), .O(new_n39_));
  ...
  nand3  g29(.a(new_n33_), .b(x6), .c(x5), .O(new_n47_));
  oai21  g30(.a(x9), .b(x8), .c(new_n47_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n21_), .O(new_n49_));
  nand3  g32(.a(new_n29_), .b(new_n27_), .c(new_n26_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x8), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(x9), .c(x6), .O(new_n52_));
