...
module FAU ( 
  ...
  oai21  g29(.a(x8), .b(new_n30_), .c(new_n46_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n19_), .O(new_n48_));
  oai21  g31(.a(new_n19_), .b(x4), .c(new_n18_), .O(new_n49_));
  oai21  g32(.a(x9), .b(x8), .c(x6), .O(new_n50_));
  aoi21  g33(.a(new_n49_), .b(x3), .c(new_n50_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n48_), .c(new_n45_), .O(z5));
  nand3  g35(.a(x7), .b(x4), .c(x3), .O(new_n53_));
  nand3  g36(.a(x9), .b(new_n19_), .c(x5), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x8), .O(new_n56_));
  nand2  g39(.a(new_n26_), .b(new_n18_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x3), .O(new_n58_));
  nand3  g41(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x8), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x9), .c(x7), .O(new_n61_));
  nor2   g44(.a(x9), .b(x8), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n19_), .c(new_n39_), .O(new_n63_));
  nand4  g46(.a(new_n63_), .b(new_n61_), .c(new_n58_), .d(new_n56_), .O(z6));
endmodule
