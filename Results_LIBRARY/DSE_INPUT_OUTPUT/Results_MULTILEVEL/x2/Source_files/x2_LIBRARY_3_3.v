...
module FAU ( 
  ...
  nand3  g13(.a(new_n21_), .b(x8), .c(new_n30_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(new_n29_), .c(new_n26_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n22_), .O(z3));
  nand3  g16(.a(new_n21_), .b(x7), .c(x6), .O(z4));
  inv1   g17(.a(x6), .O(new_n35_));
  nand2  g18(.a(new_n24_), .b(new_n35_), .O(new_n36_));
  inv1   g19(.a(x3), .O(new_n37_));
  oai21  g20(.a(x4), .b(new_n37_), .c(new_n21_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x7), .O(new_n39_));
  inv1   g22(.a(x8), .O(new_n40_));
  nand3  g23(.a(x2), .b(new_n28_), .c(new_n27_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(x9), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n40_), .O(new_n43_));
  nand4  g26(.a(x9), .b(x8), .c(new_n26_), .d(x5), .O(new_n44_));
  nand4  g27(.a(new_n44_), .b(new_n43_), .c(new_n39_), .d(new_n36_), .O(z5));
  nand3  g28(.a(x9), .b(x8), .c(x5), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n18_), .c(new_n26_), .O(new_n48_));
  nor2   g31(.a(x9), .b(new_n40_), .O(new_n49_));
