...
module FAU ( 
  ...
  nand2  g21(.a(new_n21_), .b(new_n20_), .O(new_n39_));
  oai21  g22(.a(new_n35_), .b(new_n20_), .c(new_n39_), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n33_), .O(new_n46_));
  ...
  nand2  g36(.a(new_n39_), .b(new_n19_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n18_), .c(new_n33_), .O(new_n55_));
