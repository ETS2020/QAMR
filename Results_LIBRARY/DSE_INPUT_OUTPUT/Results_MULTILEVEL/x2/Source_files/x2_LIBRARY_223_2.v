...
module FAU ( 
  ...
  nor2   g20(.a(new_n20_), .b(new_n19_), .O(new_n39_));
  aoi21  g21(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(new_n40_));
  nand3  g22(.a(new_n40_), .b(new_n35_), .c(new_n33_), .O(z5));
  nand2  g23(.a(new_n23_), .b(new_n19_), .O(new_n42_));
  nor3   g24(.a(x2), .b(x1), .c(x0), .O(new_n43_));
  oai21  g25(.a(new_n43_), .b(new_n20_), .c(x7), .O(new_n44_));
