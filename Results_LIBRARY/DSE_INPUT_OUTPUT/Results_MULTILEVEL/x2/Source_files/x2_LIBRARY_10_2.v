...
module FAU ( 
  ...
  nand2  g08(.a(x7), .b(x6), .O(new_n27_));
  nand2  g09(.a(new_n27_), .b(new_n21_), .O(new_n28_));
  oai21  g10(.a(new_n22_), .b(new_n21_), .c(new_n28_), .O(z4));
  ...
  nand3  g15(.a(x8), .b(new_n19_), .c(x5), .O(new_n34_));
  nand4  g16(.a(new_n34_), .b(new_n33_), .c(x9), .d(x6), .O(z5));
  inv1   g17(.a(x2), .O(new_n36_));
  nand3  g18(.a(new_n36_), .b(new_n31_), .c(new_n30_), .O(new_n37_));
  nand2  g19(.a(new_n37_), .b(x8), .O(new_n38_));
  nand3  g20(.a(new_n38_), .b(x9), .c(x7), .O(new_n39_));
  nand2  g21(.a(x8), .b(x5), .O(new_n40_));
  aoi21  g22(.a(new_n40_), .b(x9), .c(x7), .O(new_n41_));
  oai21  g23(.a(x9), .b(new_n21_), .c(x6), .O(new_n42_));
  nor2   g24(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g25(.a(new_n43_), .b(new_n39_), .O(z6));
  one    g26(.O(z0));
endmodule
