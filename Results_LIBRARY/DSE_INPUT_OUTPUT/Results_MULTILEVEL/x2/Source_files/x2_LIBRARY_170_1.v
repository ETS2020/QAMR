...
module FAU ( 
  ...
  nand2  g17(.a(new_n18_), .b(new_n25_), .O(new_n35_));
  oai21  g18(.a(new_n34_), .b(new_n25_), .c(new_n35_), .O(z4));
  oai21  g19(.a(new_n18_), .b(x7), .c(new_n33_), .O(new_n37_));
  nand3  g20(.a(x9), .b(x8), .c(x2), .O(new_n38_));
  inv1   g21(.a(x4), .O(new_n39_));
  nand3  g22(.a(new_n18_), .b(new_n39_), .c(x3), .O(new_n40_));
  oai21  g23(.a(new_n38_), .b(new_n28_), .c(new_n40_), .O(new_n41_));
