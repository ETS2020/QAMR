...
module FAU ( 
  ...
  oai21  g25(.a(new_n42_), .b(new_n31_), .c(x0), .O(new_n43_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n19_), .c(x0), .O(new_n48_));
  inv1   g31(.a(new_n37_), .O(new_n49_));
  inv1   g32(.a(x2), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n34_), .c(new_n18_), .O(new_n51_));
