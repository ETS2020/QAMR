...
module FAU ( 
  ...
  nand3  g12(.a(new_n19_), .b(x8), .c(new_n29_), .O(new_n30_));
  oai21  g13(.a(new_n30_), .b(new_n28_), .c(new_n22_), .O(new_n31_));
  oai21  g14(.a(x9), .b(new_n22_), .c(new_n31_), .O(z3));
  nand3  g15(.a(new_n19_), .b(x7), .c(x6), .O(z4));
  ...
  nand2  g30(.a(new_n37_), .b(new_n20_), .O(new_n48_));
