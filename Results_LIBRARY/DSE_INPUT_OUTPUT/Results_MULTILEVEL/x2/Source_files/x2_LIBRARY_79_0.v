...
module FAU ( 
  ...
  or2    g22(.a(z2), .b(x6), .O(new_n40_));
  nand3  g23(.a(x9), .b(new_n18_), .c(x5), .O(new_n41_));
  nand4  g24(.a(new_n19_), .b(x7), .c(x4), .d(x3), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x8), .O(new_n44_));
  inv1   g27(.a(x2), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n28_), .c(new_n27_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x8), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(x9), .c(x7), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n40_), .O(z6));
endmodule
