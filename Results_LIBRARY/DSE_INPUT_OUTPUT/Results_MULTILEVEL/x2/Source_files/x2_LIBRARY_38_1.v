...
module FAU ( 
  ...
  oai22  g10(.a(x9), .b(new_n27_), .c(x8), .d(new_n23_), .O(new_n28_));
  ...
  oai21  g17(.a(x9), .b(new_n27_), .c(x8), .O(new_n35_));
  ...
  oai21  g31(.a(new_n48_), .b(new_n44_), .c(new_n23_), .O(new_n49_));
  nand3  g32(.a(new_n18_), .b(x7), .c(x3), .O(new_n50_));
