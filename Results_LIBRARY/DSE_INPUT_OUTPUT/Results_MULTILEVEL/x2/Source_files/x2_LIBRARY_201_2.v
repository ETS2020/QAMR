...
module FAU ( 
  ...
  oai21  g04(.a(x9), .b(x4), .c(new_n21_), .O(new_n22_));
  ...
  oai21  g10(.a(new_n19_), .b(new_n21_), .c(x4), .O(new_n28_));
  ...
  nand2  g38(.a(new_n39_), .b(new_n18_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n19_), .c(new_n45_), .O(new_n57_));
