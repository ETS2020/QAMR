...
module FAU ( 
  ...
  oai21  g11(.a(x9), .b(x7), .c(new_n28_), .O(new_n29_));
  inv1   g12(.a(x2), .O(new_n30_));
  nor2   g13(.a(x1), .b(x0), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(x8), .c(new_n19_), .d(new_n30_), .O(new_n32_));
  ...
  nand4  g22(.a(new_n39_), .b(new_n24_), .c(new_n18_), .d(x6), .O(z6));
endmodule
