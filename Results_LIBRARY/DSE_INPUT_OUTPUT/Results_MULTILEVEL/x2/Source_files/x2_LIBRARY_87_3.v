...
module FAU ( 
  ...
  oai21  g08(.a(x9), .b(x7), .c(new_n25_), .O(new_n26_));
  inv1   g09(.a(x2), .O(new_n27_));
  nor2   g10(.a(x1), .b(x0), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(x8), .c(new_n20_), .d(new_n27_), .O(new_n29_));
  ...
  nand3  g21(.a(new_n18_), .b(new_n38_), .c(new_n20_), .O(new_n39_));
  nand4  g22(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(new_n18_), .d(x6), .O(z6));
endmodule
