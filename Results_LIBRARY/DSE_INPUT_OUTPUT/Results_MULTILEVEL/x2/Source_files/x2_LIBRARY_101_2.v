...
module FAU ( 
  ...
  aoi21  g08(.a(new_n25_), .b(x7), .c(x9), .O(z2));
  nand2  g09(.a(new_n21_), .b(x8), .O(z3));
  nand2  g10(.a(z0), .b(new_n20_), .O(new_n28_));
  inv1   g11(.a(x6), .O(new_n29_));
  nand2  g12(.a(new_n25_), .b(new_n29_), .O(new_n30_));
  nand2  g13(.a(x9), .b(x8), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(new_n30_), .c(new_n28_), .O(z4));
  inv1   g15(.a(x0), .O(new_n33_));
  inv1   g16(.a(x1), .O(new_n34_));
  nand2  g17(.a(new_n25_), .b(new_n20_), .O(new_n35_));
  oai21  g18(.a(new_n31_), .b(new_n20_), .c(new_n35_), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(x2), .c(new_n34_), .d(new_n33_), .O(new_n37_));
  nand2  g20(.a(z0), .b(new_n29_), .O(new_n38_));
  inv1   g21(.a(new_n31_), .O(new_n39_));
  inv1   g22(.a(x5), .O(new_n40_));
  nor2   g23(.a(x7), .b(new_n40_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n39_), .c(new_n22_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n38_), .c(new_n37_), .O(z5));
  inv1   g26(.a(x2), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n34_), .c(new_n33_), .O(new_n45_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n49_), .c(new_n38_), .O(z6));
endmodule
