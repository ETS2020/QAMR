...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n23_, new_n25_, new_n28_,
  ...
  aoi21  g10(.a(x9), .b(x8), .c(new_n28_), .O(new_n29_));
  oai21  g11(.a(new_n29_), .b(new_n22_), .c(new_n25_), .O(z4));
  ...
  oai21  g17(.a(new_n20_), .b(x7), .c(new_n28_), .O(new_n36_));
  ...
  nand3  g22(.a(new_n40_), .b(new_n36_), .c(new_n35_), .O(z5));
  inv1   g23(.a(x2), .O(new_n42_));
  nand3  g24(.a(new_n42_), .b(new_n32_), .c(new_n31_), .O(new_n43_));
  nand2  g25(.a(new_n43_), .b(x8), .O(new_n44_));
  nand3  g26(.a(new_n44_), .b(x9), .c(x7), .O(new_n45_));
  aoi21  g27(.a(x9), .b(new_n20_), .c(x7), .O(new_n46_));
  and2   g28(.a(x4), .b(x3), .O(new_n47_));
  nor2   g29(.a(x9), .b(new_n20_), .O(new_n48_));
  aoi21  g30(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n49_));
  nand3  g31(.a(new_n49_), .b(new_n45_), .c(new_n36_), .O(z6));
  one    g32(.O(z3));
endmodule
