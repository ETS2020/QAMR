...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_,
  ...
  inv1   g04(.a(x7), .O(new_n24_));
  oai21  g05(.a(x8), .b(new_n24_), .c(x9), .O(new_n25_));
  oai21  g06(.a(new_n24_), .b(x6), .c(new_n25_), .O(z4));
  ...
  nand3  g11(.a(x8), .b(new_n24_), .c(x5), .O(new_n31_));
  ...
  aoi21  g23(.a(new_n42_), .b(x8), .c(new_n24_), .O(new_n43_));
