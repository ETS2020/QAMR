...
module FAU ( 
  ...
  nand2  g12(.a(x9), .b(x5), .O(new_n30_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n36_), .c(new_n35_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x8), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x9), .c(new_n32_), .O(new_n51_));
  ...
  nand3  g37(.a(new_n18_), .b(new_n20_), .c(new_n19_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n54_), .c(new_n47_), .O(z6));
endmodule
