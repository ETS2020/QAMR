...
module FAU ( 
  ...
  nand3  g21(.a(new_n38_), .b(new_n31_), .c(new_n30_), .O(new_n39_));
  ...
  oai21  g26(.a(new_n18_), .b(x7), .c(new_n43_), .O(new_n44_));
  inv1   g27(.a(x4), .O(new_n45_));
  nand3  g28(.a(x7), .b(new_n45_), .c(x3), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x8), .O(new_n47_));
  nor2   g30(.a(new_n18_), .b(x2), .O(new_n48_));
  aoi21  g31(.a(new_n47_), .b(new_n18_), .c(new_n48_), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(new_n44_), .c(new_n42_), .d(new_n39_), .O(z5));
  oai21  g33(.a(new_n18_), .b(x2), .c(new_n43_), .O(new_n51_));
  nand3  g34(.a(x8), .b(new_n21_), .c(x5), .O(new_n52_));
  ...
  oai21  g39(.a(new_n56_), .b(new_n23_), .c(new_n18_), .O(new_n57_));
