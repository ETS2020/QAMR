...
module FAU ( 
  ...
  nand3  g09(.a(new_n26_), .b(x8), .c(new_n21_), .O(new_n27_));
  ...
  oai21  g23(.a(new_n18_), .b(x0), .c(new_n40_), .O(new_n41_));
  ...
  nand3  g28(.a(new_n45_), .b(x9), .c(x0), .O(new_n46_));
  nand4  g29(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n47_));
  inv1   g30(.a(new_n47_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n23_), .c(new_n18_), .O(new_n49_));
