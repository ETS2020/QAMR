...
module FAU ( 
  ...
  oai21  g26(.a(new_n30_), .b(new_n22_), .c(new_n31_), .O(new_n48_));
  nand2  g27(.a(new_n43_), .b(x13), .O(new_n49_));
  nor2   g28(.a(x13), .b(x12), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n34_), .O(new_n51_));
  ...
  aoi21  g35(.a(x07), .b(new_n30_), .c(new_n56_), .O(new_n57_));
