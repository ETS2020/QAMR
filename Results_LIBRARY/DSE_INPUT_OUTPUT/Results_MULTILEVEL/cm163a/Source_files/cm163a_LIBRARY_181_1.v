...
module FAU ( 
  ...
  nand2  g08(.a(x15), .b(new_n29_), .O(new_n30_));
  ...
  aoi21  g16(.a(new_n25_), .b(x11), .c(new_n37_), .O(new_n38_));
  nor2   g17(.a(x04), .b(x01), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n31_), .O(new_n40_));
  oai21  g19(.a(new_n38_), .b(new_n34_), .c(new_n40_), .O(z1));
  inv1   g20(.a(x15), .O(new_n42_));
  nand3  g21(.a(new_n35_), .b(new_n24_), .c(x04), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n22_), .c(new_n42_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n29_), .O(new_n45_));
  nand3  g24(.a(new_n36_), .b(x12), .c(x04), .O(new_n46_));
  ...
  nand2  g31(.a(new_n36_), .b(new_n42_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n29_), .c(new_n52_), .O(new_n54_));
  nand4  g33(.a(new_n42_), .b(new_n52_), .c(new_n29_), .d(new_n35_), .O(new_n55_));
  ...
  nand4  g38(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n60_));
  nor3   g39(.a(new_n60_), .b(new_n42_), .c(new_n59_), .O(z4));
endmodule
