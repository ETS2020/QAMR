...
module FAU ( 
  ...
  nand4  g13(.a(new_n34_), .b(new_n22_), .c(x04), .d(x03), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x05), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x02), .O(new_n37_));
  nand3  g16(.a(new_n26_), .b(x11), .c(x04), .O(new_n38_));
  inv1   g17(.a(x01), .O(new_n39_));
  nand2  g18(.a(new_n30_), .b(new_n39_), .O(new_n40_));
  ...
  aoi22  g24(.a(new_n45_), .b(new_n25_), .c(new_n44_), .d(x12), .O(new_n46_));
  inv1   g25(.a(x06), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n30_), .c(new_n31_), .O(new_n48_));
  oai21  g27(.a(new_n46_), .b(new_n30_), .c(new_n48_), .O(z2));
  ...
  oai21  g35(.a(new_n54_), .b(new_n30_), .c(new_n56_), .O(z3));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n31_), .b(new_n23_), .c(new_n58_), .O(new_n59_));
