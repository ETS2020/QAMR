...
module FAU ( 
  ...
  nand3  g17(.a(new_n33_), .b(new_n26_), .c(x04), .O(new_n39_));
  oai22  g18(.a(new_n39_), .b(new_n24_), .c(x06), .d(x04), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n22_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x05), .O(z2));
  nand2  g21(.a(new_n34_), .b(x13), .O(new_n43_));
  nor2   g22(.a(x13), .b(x11), .O(new_n44_));
  ...
  nand2  g28(.a(x12), .b(x05), .O(new_n50_));
