...
module FAU ( 
  ...
  oai21  g18(.a(new_n39_), .b(new_n25_), .c(new_n26_), .O(new_n40_));
  ...
  nand4  g24(.a(new_n45_), .b(new_n29_), .c(x03), .d(x02), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(new_n22_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n25_), .c(new_n26_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n43_), .O(z2));
  and2   g28(.a(new_n46_), .b(x13), .O(new_n50_));
  nor2   g29(.a(x13), .b(x12), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n37_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n30_), .c(new_n26_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n50_), .c(x04), .O(new_n54_));
  inv1   g33(.a(x07), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n22_), .c(new_n25_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n54_), .O(z3));
  nand4  g36(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n22_), .c(new_n26_), .O(z4));
endmodule
