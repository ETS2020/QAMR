...
module FAU ( 
  ...
  aoi22  g22(.a(new_n43_), .b(new_n34_), .c(new_n35_), .d(x12), .O(new_n44_));
  ...
  oai21  g29(.a(new_n42_), .b(new_n23_), .c(x13), .O(new_n51_));
  ...
  aoi21  g37(.a(new_n33_), .b(new_n28_), .c(new_n58_), .O(new_n59_));
