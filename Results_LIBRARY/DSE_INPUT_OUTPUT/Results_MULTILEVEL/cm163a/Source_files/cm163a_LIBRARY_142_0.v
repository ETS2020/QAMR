...
module FAU ( 
  ...
  nor2   g08(.a(x13), .b(x06), .O(new_n30_));
  ...
  nand3  g30(.a(x04), .b(x03), .c(x02), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n48_), .c(x06), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n43_), .O(new_n54_));
  inv1   g33(.a(new_n49_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(x13), .c(x04), .O(new_n56_));
  inv1   g35(.a(x07), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n39_), .c(new_n28_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(z3));
  inv1   g38(.a(x03), .O(new_n60_));
  inv1   g39(.a(x15), .O(new_n61_));
  nor2   g40(.a(new_n30_), .b(new_n61_), .O(new_n62_));
