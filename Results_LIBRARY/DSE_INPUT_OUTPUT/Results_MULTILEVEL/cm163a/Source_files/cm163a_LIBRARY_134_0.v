...
module FAU ( 
  ...
  nand4  g10(.a(new_n31_), .b(new_n24_), .c(x03), .d(x02), .O(new_n32_));
  inv1   g11(.a(new_n32_), .O(new_n33_));
  aoi21  g12(.a(new_n25_), .b(x11), .c(new_n33_), .O(new_n34_));
  inv1   g13(.a(x01), .O(new_n35_));
  inv1   g14(.a(x05), .O(new_n36_));
  aoi21  g15(.a(new_n28_), .b(new_n35_), .c(new_n36_), .O(new_n37_));
  oai21  g16(.a(new_n34_), .b(new_n28_), .c(new_n37_), .O(z1));
  inv1   g17(.a(new_n22_), .O(new_n39_));
  ...
  aoi21  g21(.a(new_n42_), .b(new_n28_), .c(new_n36_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n28_), .c(new_n43_), .O(z2));
  inv1   g23(.a(x13), .O(new_n45_));
  aoi21  g24(.a(new_n40_), .b(new_n39_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand3  g26(.a(new_n45_), .b(new_n47_), .c(new_n31_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n25_), .c(x05), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n46_), .c(x04), .O(new_n50_));
  inv1   g29(.a(x07), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(x05), .c(new_n28_), .O(new_n52_));
