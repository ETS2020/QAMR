...
module FAU ( 
  ...
  oai21  g08(.a(new_n29_), .b(new_n28_), .c(x14), .O(new_n30_));
  ...
  nand2  g16(.a(x14), .b(x05), .O(new_n38_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(x14), .O(new_n46_));
  ...
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(x14), .d(new_n57_), .O(z4));
endmodule
