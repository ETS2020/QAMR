...
module FAU ( 
  ...
  aoi21  g14(.a(new_n25_), .b(x11), .c(new_n35_), .O(new_n36_));
  inv1   g15(.a(x01), .O(new_n37_));
  aoi21  g16(.a(new_n29_), .b(new_n37_), .c(new_n30_), .O(new_n38_));
  oai21  g17(.a(new_n36_), .b(new_n29_), .c(new_n38_), .O(z1));
  nand2  g18(.a(x06), .b(x05), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n29_), .O(new_n41_));
  nand2  g20(.a(new_n34_), .b(x12), .O(new_n42_));
  nor2   g21(.a(x12), .b(x11), .O(new_n43_));
  nand4  g22(.a(new_n43_), .b(new_n22_), .c(x03), .d(x02), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n42_), .c(new_n29_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n30_), .c(new_n24_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n41_), .O(z2));
  and2   g26(.a(new_n44_), .b(x13), .O(new_n48_));
  nor2   g27(.a(x13), .b(x12), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n25_), .c(new_n24_), .O(new_n51_));
  ...
  nand4  g35(.a(x10), .b(x08), .c(new_n29_), .d(x03), .O(new_n57_));
  nor3   g36(.a(new_n57_), .b(new_n56_), .c(new_n24_), .O(z4));
endmodule
