...
module FAU ( 
  ...
  aoi21  g09(.a(x12), .b(new_n22_), .c(x09), .O(new_n31_));
  ...
  nand4  g18(.a(new_n39_), .b(new_n36_), .c(x03), .d(x02), .O(new_n40_));
  ...
  nand2  g23(.a(new_n44_), .b(new_n40_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x04), .O(new_n46_));
  inv1   g25(.a(x05), .O(new_n47_));
  inv1   g26(.a(x06), .O(new_n48_));
  oai21  g27(.a(x12), .b(x04), .c(new_n44_), .O(new_n49_));
  aoi22  g28(.a(new_n49_), .b(new_n48_), .c(new_n23_), .d(new_n47_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n46_), .O(z2));
  inv1   g30(.a(x12), .O(new_n52_));
  inv1   g31(.a(x13), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n36_), .c(x04), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n24_), .c(new_n52_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n22_), .O(new_n56_));
  nand3  g35(.a(new_n40_), .b(x13), .c(x04), .O(new_n57_));
  inv1   g36(.a(x07), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n27_), .c(new_n47_), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(z3));
