...
module FAU ( 
  ...
  aoi21  g18(.a(new_n33_), .b(x04), .c(new_n39_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n38_), .c(x05), .O(z2));
  nor2   g20(.a(x07), .b(x04), .O(new_n42_));
  and2   g21(.a(x13), .b(x04), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x12), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z3));
  inv1   g24(.a(x03), .O(new_n46_));
  inv1   g25(.a(x15), .O(new_n47_));
  aoi21  g26(.a(new_n38_), .b(x05), .c(new_n47_), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(x14), .c(x10), .d(x08), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n46_), .O(z4));
endmodule
