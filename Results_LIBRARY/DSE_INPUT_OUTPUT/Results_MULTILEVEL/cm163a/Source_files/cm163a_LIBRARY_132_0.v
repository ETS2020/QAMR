...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(new_n23_), .c(new_n44_), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nand3  g25(.a(new_n44_), .b(new_n46_), .c(new_n32_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n25_), .c(x05), .O(new_n48_));
  ...
  aoi21  g33(.a(new_n40_), .b(new_n28_), .c(new_n54_), .O(new_n55_));
