...
module FAU ( 
  ...
  nand2  g06(.a(new_n27_), .b(x11), .O(new_n28_));
  nand3  g07(.a(new_n26_), .b(x03), .c(x02), .O(new_n29_));
  ...
  nand2  g15(.a(new_n23_), .b(new_n36_), .O(new_n37_));
  oai21  g16(.a(new_n22_), .b(x04), .c(x09), .O(new_n38_));
  nand2  g17(.a(new_n22_), .b(new_n26_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n27_), .c(new_n28_), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x04), .O(new_n41_));
  nand4  g20(.a(new_n41_), .b(new_n38_), .c(new_n37_), .d(new_n35_), .O(z1));
  inv1   g21(.a(x12), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n33_), .c(x11), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x09), .O(new_n45_));
  nand3  g24(.a(new_n22_), .b(x03), .c(x02), .O(new_n46_));
  ...
  aoi21  g32(.a(new_n53_), .b(new_n33_), .c(new_n36_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n52_), .c(new_n45_), .O(z2));
  inv1   g34(.a(x13), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n33_), .c(x11), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x09), .O(new_n58_));
  aoi21  g37(.a(new_n49_), .b(new_n48_), .c(new_n56_), .O(new_n59_));
  nand3  g38(.a(new_n56_), .b(new_n43_), .c(new_n22_), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n27_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  inv1   g41(.a(x07), .O(new_n63_));
  aoi21  g42(.a(new_n63_), .b(new_n33_), .c(new_n36_), .O(new_n64_));
  nand3  g43(.a(new_n64_), .b(new_n62_), .c(new_n58_), .O(z3));
  inv1   g44(.a(x03), .O(new_n66_));
  inv1   g45(.a(x15), .O(new_n67_));
  aoi21  g46(.a(new_n22_), .b(x09), .c(new_n67_), .O(new_n68_));
