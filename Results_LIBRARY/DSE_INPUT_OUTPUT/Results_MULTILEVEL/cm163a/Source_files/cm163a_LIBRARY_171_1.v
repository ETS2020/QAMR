...
module FAU ( 
  ...
  nand3  g24(.a(new_n45_), .b(new_n43_), .c(x03), .O(z2));
  nand2  g25(.a(new_n41_), .b(x13), .O(new_n47_));
  nor2   g26(.a(x13), .b(x12), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n32_), .c(new_n22_), .d(x02), .O(new_n49_));
  ...
  oai22  g34(.a(new_n55_), .b(new_n54_), .c(new_n29_), .d(x03), .O(z4));
endmodule
