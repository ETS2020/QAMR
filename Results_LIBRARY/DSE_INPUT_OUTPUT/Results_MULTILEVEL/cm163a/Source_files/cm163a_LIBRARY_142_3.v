...
module FAU ( 
  ...
  nand2  g09(.a(x13), .b(x06), .O(new_n31_));
  inv1   g10(.a(new_n31_), .O(new_n32_));
  nor2   g11(.a(new_n32_), .b(new_n30_), .O(new_n33_));
  nand3  g12(.a(new_n33_), .b(new_n29_), .c(new_n26_), .O(z0));
  ...
  aoi21  g19(.a(new_n28_), .b(new_n40_), .c(new_n30_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n39_), .c(new_n32_), .O(z1));
  inv1   g21(.a(x06), .O(new_n43_));
  oai21  g22(.a(x13), .b(new_n43_), .c(new_n28_), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  aoi21  g24(.a(new_n36_), .b(new_n23_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n44_), .c(new_n33_), .O(z2));
  inv1   g31(.a(new_n24_), .O(new_n53_));
  nand3  g32(.a(new_n48_), .b(new_n23_), .c(new_n22_), .O(new_n54_));
  nor3   g33(.a(x13), .b(x12), .c(x11), .O(new_n55_));
  aoi22  g34(.a(new_n55_), .b(new_n53_), .c(new_n54_), .d(x13), .O(new_n56_));
  inv1   g35(.a(x07), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n28_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n31_), .c(x05), .O(new_n59_));
  inv1   g38(.a(new_n59_), .O(new_n60_));
  oai21  g39(.a(new_n56_), .b(new_n28_), .c(new_n60_), .O(z3));
  inv1   g40(.a(x03), .O(new_n62_));
  inv1   g41(.a(x08), .O(new_n63_));
  nand4  g42(.a(new_n31_), .b(x15), .c(x14), .d(x10), .O(new_n64_));
