...
module FAU ( 
  ...
  oai21  g10(.a(x12), .b(x04), .c(new_n31_), .O(new_n32_));
  ...
  nand4  g24(.a(new_n26_), .b(new_n45_), .c(new_n44_), .d(new_n25_), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n43_), .c(new_n42_), .d(x05), .O(z2));
  ...
  aoi21  g30(.a(new_n34_), .b(new_n26_), .c(new_n49_), .O(new_n52_));
  ...
  nand3  g34(.a(new_n55_), .b(new_n51_), .c(new_n32_), .O(z3));
