...
module FAU ( 
  ...
  nor3   g22(.a(new_n43_), .b(x07), .c(new_n42_), .O(new_n44_));
  oai21  g23(.a(new_n41_), .b(new_n32_), .c(new_n44_), .O(z2));
  inv1   g24(.a(x13), .O(new_n46_));
  aoi21  g25(.a(new_n40_), .b(new_n23_), .c(new_n46_), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand3  g27(.a(new_n46_), .b(new_n48_), .c(new_n33_), .O(new_n49_));
  ...
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(new_n28_), .d(new_n42_), .O(z4));
endmodule
