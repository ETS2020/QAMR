...
module FAU ( 
  ...
  nor2   g01(.a(new_n22_), .b(x11), .O(new_n23_));
  ...
  nand3  g13(.a(new_n25_), .b(new_n24_), .c(x04), .O(new_n35_));
  ...
  nand3  g19(.a(new_n40_), .b(new_n38_), .c(new_n37_), .O(z1));
  ...
  nand2  g24(.a(new_n26_), .b(new_n22_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n34_), .c(new_n45_), .O(new_n47_));
  nand3  g26(.a(new_n22_), .b(new_n45_), .c(new_n34_), .O(new_n48_));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n25_), .c(x13), .O(new_n53_));
  oai21  g32(.a(x07), .b(x04), .c(x05), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(new_n55_));
  oai21  g34(.a(new_n53_), .b(new_n30_), .c(new_n55_), .O(z3));
