...
module FAU ( 
  ...
  nand3  g19(.a(new_n38_), .b(new_n40_), .c(new_n22_), .O(new_n41_));
  ...
  nand3  g23(.a(new_n44_), .b(x05), .c(new_n29_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n43_), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nor3   g26(.a(x12), .b(x11), .c(x09), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n24_), .c(new_n47_), .O(new_n49_));
  ...
  nand3  g32(.a(new_n53_), .b(x05), .c(new_n29_), .O(new_n54_));
