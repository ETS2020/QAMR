...
module FAU ( 
  ...
  nand4  g26(.a(new_n40_), .b(x04), .c(x03), .d(x02), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n47_), .c(new_n22_), .d(x05), .O(z3));
  nand2  g28(.a(x08), .b(x03), .O(new_n50_));
  nand3  g29(.a(x15), .b(x14), .c(x10), .O(new_n51_));
  oai22  g30(.a(new_n51_), .b(new_n50_), .c(new_n22_), .d(new_n42_), .O(z4));
endmodule
