...
module FAU ( 
  ...
  nor2   g08(.a(x09), .b(x07), .O(new_n30_));
  ...
  nand2  g15(.a(new_n22_), .b(x11), .O(new_n37_));
  inv1   g16(.a(x11), .O(new_n38_));
  nand4  g17(.a(new_n38_), .b(new_n24_), .c(x03), .d(x02), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n36_), .O(new_n40_));
  nor2   g19(.a(new_n38_), .b(new_n24_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(x04), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n35_), .O(z1));
  oai21  g22(.a(x06), .b(x04), .c(x05), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n33_), .O(new_n45_));
  nand3  g24(.a(new_n38_), .b(x03), .c(x02), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x12), .O(new_n47_));
  nor2   g26(.a(x12), .b(x11), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n24_), .c(x03), .d(x02), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n47_), .c(new_n36_), .O(new_n50_));
  and2   g29(.a(x12), .b(x09), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n50_), .c(x04), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n45_), .O(z2));
  nand2  g32(.a(x09), .b(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n36_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n28_), .O(new_n56_));
  nor2   g35(.a(x07), .b(x04), .O(new_n57_));
  and2   g36(.a(x13), .b(x04), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(x09), .O(new_n59_));
  nand3  g38(.a(new_n48_), .b(x03), .c(x02), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(x13), .O(new_n61_));
  inv1   g40(.a(new_n25_), .O(new_n62_));
  nor3   g41(.a(x13), .b(x12), .c(x11), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g43(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  nand3  g44(.a(new_n65_), .b(x07), .c(x04), .O(new_n66_));
  nand3  g45(.a(new_n66_), .b(new_n59_), .c(new_n56_), .O(z3));
  inv1   g46(.a(x03), .O(new_n68_));
  inv1   g47(.a(x15), .O(new_n69_));
  nor2   g48(.a(new_n30_), .b(new_n69_), .O(new_n70_));
