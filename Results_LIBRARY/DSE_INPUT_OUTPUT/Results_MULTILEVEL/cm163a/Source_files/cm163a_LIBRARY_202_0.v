...
module FAU ( 
  ...
  nand3  g11(.a(new_n31_), .b(new_n32_), .c(x04), .O(new_n33_));
  oai22  g12(.a(new_n33_), .b(new_n23_), .c(x04), .d(x01), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x05), .O(new_n35_));
  nand2  g14(.a(new_n25_), .b(x02), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(x04), .c(new_n28_), .O(new_n37_));
  oai21  g16(.a(new_n37_), .b(new_n31_), .c(new_n35_), .O(z1));
  inv1   g17(.a(new_n23_), .O(new_n39_));
  nand3  g18(.a(new_n39_), .b(new_n31_), .c(new_n32_), .O(new_n40_));
  nor3   g19(.a(x12), .b(x11), .c(x09), .O(new_n41_));
  aoi22  g20(.a(new_n41_), .b(new_n39_), .c(new_n40_), .d(x12), .O(new_n42_));
  ...
  aoi21  g37(.a(new_n31_), .b(new_n28_), .c(new_n58_), .O(new_n59_));
  nand4  g38(.a(new_n59_), .b(x14), .c(x10), .d(x08), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n24_), .O(z4));
endmodule
