...
module FAU ( 
  ...
  nand2  g22(.a(x14), .b(x06), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n32_), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  aoi21  g25(.a(new_n37_), .b(new_n27_), .c(new_n46_), .O(new_n47_));
  inv1   g26(.a(x11), .O(new_n48_));
  nand3  g27(.a(new_n46_), .b(new_n48_), .c(new_n25_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n26_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n47_), .c(x04), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n45_), .c(new_n23_), .d(x05), .O(z2));
