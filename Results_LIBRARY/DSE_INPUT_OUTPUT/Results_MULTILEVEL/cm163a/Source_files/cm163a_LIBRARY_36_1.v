...
module FAU ( 
  ...
  nand4  g16(.a(new_n37_), .b(new_n28_), .c(new_n27_), .d(x03), .O(new_n38_));
  oai21  g17(.a(new_n31_), .b(new_n37_), .c(new_n38_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(x04), .O(new_n40_));
  inv1   g19(.a(x06), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n34_), .O(new_n42_));
  nand4  g21(.a(new_n42_), .b(new_n40_), .c(x05), .d(x02), .O(z2));
  ...
  aoi21  g31(.a(x05), .b(new_n22_), .c(new_n52_), .O(new_n53_));
