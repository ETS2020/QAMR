...
module FAU ( 
  ...
  nand2  g13(.a(new_n34_), .b(new_n28_), .O(z0));
  ...
  aoi21  g19(.a(new_n26_), .b(x11), .c(new_n40_), .O(new_n41_));
  nor2   g20(.a(x04), .b(x01), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n33_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n36_), .c(new_n43_), .O(z1));
  oai21  g23(.a(new_n31_), .b(new_n36_), .c(new_n30_), .O(new_n45_));
  nor2   g24(.a(new_n40_), .b(new_n31_), .O(new_n46_));
  nor4   g25(.a(new_n22_), .b(x12), .c(x11), .d(x09), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n46_), .c(x04), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n45_), .c(x05), .O(z2));
  oai21  g28(.a(x07), .b(x04), .c(x05), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n32_), .O(new_n51_));
  nand2  g30(.a(new_n39_), .b(x13), .O(new_n52_));
  ...
  and2   g34(.a(x13), .b(x12), .O(new_n56_));
  ...
  oai21  g39(.a(new_n60_), .b(new_n59_), .c(new_n32_), .O(z4));
endmodule
