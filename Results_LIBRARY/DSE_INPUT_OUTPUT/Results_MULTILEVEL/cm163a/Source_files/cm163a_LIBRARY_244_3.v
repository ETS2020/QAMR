...
module FAU ( 
  ...
  and2   g18(.a(x05), .b(x04), .O(new_n40_));
  inv1   g19(.a(x12), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n33_), .c(new_n26_), .O(new_n42_));
  or2    g21(.a(new_n42_), .b(new_n24_), .O(new_n43_));
  nand4  g22(.a(new_n43_), .b(new_n40_), .c(new_n39_), .d(new_n22_), .O(z2));
  oai21  g23(.a(new_n42_), .b(new_n24_), .c(x13), .O(new_n45_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n45_), .c(new_n23_), .O(new_n50_));
  ...
  nor3   g35(.a(new_n56_), .b(new_n54_), .c(new_n46_), .O(z4));
endmodule
