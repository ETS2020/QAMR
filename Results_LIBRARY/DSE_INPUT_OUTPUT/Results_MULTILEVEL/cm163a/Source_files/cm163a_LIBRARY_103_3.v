...
module FAU ( 
  ...
  aoi21  g17(.a(new_n33_), .b(new_n23_), .c(new_n38_), .O(new_n39_));
  ...
  oai21  g21(.a(new_n42_), .b(new_n39_), .c(new_n28_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n47_), .b(new_n32_), .c(new_n50_), .O(z3));
  nand2  g30(.a(x08), .b(x03), .O(new_n52_));
  nand3  g31(.a(x15), .b(x14), .c(x10), .O(new_n53_));
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(new_n28_), .d(new_n48_), .O(z4));
endmodule
