...
module FAU ( 
  ...
  nand2  g10(.a(x12), .b(new_n31_), .O(new_n32_));
  ...
  inv1   g20(.a(new_n23_), .O(new_n42_));
  ...
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n31_), .O(new_n46_));
  ...
  nand2  g29(.a(new_n36_), .b(x13), .O(new_n51_));
  ...
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(x12), .d(x05), .O(z4));
endmodule
