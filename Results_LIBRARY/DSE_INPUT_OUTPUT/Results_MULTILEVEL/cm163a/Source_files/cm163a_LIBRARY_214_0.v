...
module FAU ( 
  ...
  nand2  g17(.a(x04), .b(x02), .O(new_n39_));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n22_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n39_), .c(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x03), .O(new_n43_));
  nand3  g22(.a(new_n33_), .b(x12), .c(x04), .O(new_n44_));
  ...
  nand4  g29(.a(new_n40_), .b(new_n22_), .c(x03), .d(x02), .O(new_n51_));
  nor3   g30(.a(x13), .b(x12), .c(x11), .O(new_n52_));
  aoi22  g31(.a(new_n52_), .b(new_n50_), .c(new_n51_), .d(x13), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n28_), .c(new_n29_), .O(new_n55_));
  oai21  g34(.a(new_n53_), .b(new_n28_), .c(new_n55_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x05), .d(x03), .O(z4));
endmodule
