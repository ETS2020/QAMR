...
module FAU ( 
  ...
  nand4  g12(.a(new_n26_), .b(x04), .c(x03), .d(x02), .O(new_n34_));
  nand4  g13(.a(new_n34_), .b(new_n33_), .c(new_n22_), .d(x05), .O(z1));
  inv1   g14(.a(x12), .O(new_n36_));
  nand4  g15(.a(new_n36_), .b(new_n26_), .c(x03), .d(x02), .O(new_n37_));
  inv1   g16(.a(new_n37_), .O(new_n38_));
  aoi21  g17(.a(new_n27_), .b(x12), .c(new_n38_), .O(new_n39_));
  inv1   g18(.a(x05), .O(new_n40_));
  nor2   g19(.a(x06), .b(x04), .O(new_n41_));
  nor3   g20(.a(new_n41_), .b(x11), .c(new_n40_), .O(new_n42_));
  oai21  g21(.a(new_n39_), .b(new_n23_), .c(new_n42_), .O(z2));
