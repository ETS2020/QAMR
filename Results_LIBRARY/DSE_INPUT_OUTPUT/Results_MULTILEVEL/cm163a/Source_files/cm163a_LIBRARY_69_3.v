...
module FAU ( 
  ...
  nand2  g06(.a(x14), .b(x07), .O(new_n28_));
  ...
  nand3  g22(.a(new_n43_), .b(new_n28_), .c(x05), .O(new_n44_));
  inv1   g23(.a(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n41_), .b(new_n32_), .c(new_n45_), .O(z2));
  inv1   g25(.a(x07), .O(new_n47_));
  inv1   g26(.a(x14), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x04), .c(new_n47_), .O(new_n49_));
  ...
  aoi22  g34(.a(new_n28_), .b(new_n55_), .c(new_n47_), .d(new_n32_), .O(new_n56_));
  oai21  g35(.a(new_n54_), .b(new_n49_), .c(new_n56_), .O(z3));
  inv1   g36(.a(x15), .O(new_n58_));
  nand4  g37(.a(x10), .b(x08), .c(new_n47_), .d(x03), .O(new_n59_));
  nor3   g38(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(z4));
endmodule
