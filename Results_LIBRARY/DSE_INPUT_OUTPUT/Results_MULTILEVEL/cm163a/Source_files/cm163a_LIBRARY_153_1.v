...
module FAU ( 
  ...
  aoi22  g21(.a(new_n42_), .b(new_n35_), .c(new_n37_), .d(x12), .O(new_n43_));
  ...
  nand2  g26(.a(new_n42_), .b(new_n35_), .O(new_n48_));
  nor3   g27(.a(x13), .b(x12), .c(x11), .O(new_n49_));
  aoi22  g28(.a(new_n49_), .b(new_n47_), .c(new_n48_), .d(x13), .O(new_n50_));
  ...
  aoi21  g33(.a(new_n54_), .b(x05), .c(new_n31_), .O(z4));
endmodule
