...
module FAU ( 
  ...
  nand3  g18(.a(new_n23_), .b(new_n31_), .c(new_n39_), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n38_), .c(new_n24_), .O(z1));
  inv1   g20(.a(x06), .O(new_n42_));
  oai21  g21(.a(x12), .b(new_n42_), .c(new_n31_), .O(new_n43_));
  nand2  g22(.a(new_n36_), .b(x12), .O(new_n44_));
  nor3   g23(.a(x12), .b(x11), .c(x09), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(x04), .c(x03), .d(x02), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n44_), .c(new_n43_), .d(x05), .O(z2));
  inv1   g26(.a(x07), .O(new_n48_));
  oai21  g27(.a(x12), .b(new_n48_), .c(new_n31_), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  aoi21  g29(.a(new_n35_), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  inv1   g30(.a(x11), .O(new_n52_));
  nand3  g31(.a(new_n50_), .b(new_n23_), .c(new_n52_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n51_), .c(x04), .O(new_n55_));
  aoi21  g34(.a(x13), .b(x12), .c(new_n22_), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(new_n23_), .d(x04), .O(z4));
endmodule
