...
module FAU ( 
  ...
  nand3  g04(.a(new_n25_), .b(new_n23_), .c(x12), .O(new_n26_));
  ...
  oai21  g17(.a(new_n38_), .b(new_n30_), .c(x12), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n34_), .O(z1));
  nand3  g19(.a(x12), .b(new_n36_), .c(new_n24_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n22_), .c(x04), .O(new_n42_));
  ...
  aoi21  g27(.a(x13), .b(x04), .c(new_n30_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n46_), .c(new_n48_), .O(z3));
  inv1   g29(.a(x03), .O(new_n51_));
  inv1   g30(.a(x15), .O(new_n52_));
  aoi21  g31(.a(new_n46_), .b(x04), .c(new_n52_), .O(new_n53_));
