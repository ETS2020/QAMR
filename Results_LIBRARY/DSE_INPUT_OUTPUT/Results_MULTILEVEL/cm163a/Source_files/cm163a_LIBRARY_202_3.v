...
module FAU ( 
  ...
  nand3  g03(.a(new_n24_), .b(new_n22_), .c(new_n23_), .O(new_n25_));
  ...
  nand3  g10(.a(new_n24_), .b(new_n23_), .c(x04), .O(new_n32_));
  oai21  g11(.a(x04), .b(x01), .c(new_n32_), .O(new_n33_));
  ...
  aoi21  g18(.a(new_n36_), .b(x12), .c(new_n39_), .O(new_n40_));
  inv1   g19(.a(x05), .O(new_n41_));
  nor2   g20(.a(x06), .b(x04), .O(new_n42_));
  nor3   g21(.a(new_n42_), .b(x11), .c(new_n41_), .O(new_n43_));
  oai21  g22(.a(new_n40_), .b(new_n29_), .c(new_n43_), .O(z2));
  nand2  g23(.a(new_n38_), .b(x13), .O(new_n45_));
  nor2   g24(.a(x13), .b(x12), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n24_), .c(new_n23_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n45_), .c(new_n29_), .O(new_n48_));
