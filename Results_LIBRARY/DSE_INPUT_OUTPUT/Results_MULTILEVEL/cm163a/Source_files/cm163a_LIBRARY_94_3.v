...
module FAU ( 
  ...
  nand3  g16(.a(new_n37_), .b(new_n34_), .c(new_n22_), .O(new_n38_));
  ...
  aoi21  g22(.a(new_n36_), .b(new_n35_), .c(new_n43_), .O(new_n44_));
  inv1   g23(.a(x11), .O(new_n45_));
  nand3  g24(.a(new_n43_), .b(new_n45_), .c(new_n25_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n23_), .c(new_n22_), .O(new_n47_));
  ...
  nand2  g29(.a(new_n50_), .b(new_n48_), .O(z2));
  inv1   g30(.a(x13), .O(new_n52_));
  nor3   g31(.a(x12), .b(x11), .c(x09), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n35_), .c(new_n52_), .O(new_n54_));
  nand3  g33(.a(new_n52_), .b(new_n43_), .c(new_n45_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n26_), .c(new_n22_), .O(new_n56_));
  ...
  inv1   g39(.a(x14), .O(new_n61_));
  nand4  g40(.a(x10), .b(x08), .c(new_n30_), .d(x03), .O(new_n62_));
  nor3   g41(.a(new_n62_), .b(new_n22_), .c(new_n61_), .O(z4));
endmodule
