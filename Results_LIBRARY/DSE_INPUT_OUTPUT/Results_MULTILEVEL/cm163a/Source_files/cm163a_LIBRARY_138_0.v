...
module FAU ( 
  ...
  nand4  g28(.a(new_n47_), .b(new_n49_), .c(new_n33_), .d(new_n25_), .O(new_n50_));
  oai22  g29(.a(new_n50_), .b(new_n48_), .c(x07), .d(x04), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x05), .O(new_n52_));
  aoi21  g31(.a(new_n42_), .b(x04), .c(new_n30_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n47_), .c(new_n52_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  oai22  g35(.a(new_n56_), .b(new_n55_), .c(x13), .d(x05), .O(z4));
endmodule
