...
module FAU ( 
  ...
  aoi22  g20(.a(new_n41_), .b(new_n35_), .c(new_n36_), .d(x12), .O(new_n42_));
  ...
  nand4  g27(.a(new_n46_), .b(new_n48_), .c(new_n34_), .d(new_n25_), .O(new_n49_));
  oai22  g28(.a(new_n49_), .b(new_n47_), .c(x07), .d(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x05), .O(new_n51_));
  nand2  g30(.a(new_n41_), .b(new_n35_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x04), .c(new_n30_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n46_), .c(new_n51_), .O(z3));
