...
module FAU ( 
  ...
  nand2  g23(.a(new_n29_), .b(x01), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n44_), .O(z2));
  inv1   g25(.a(new_n24_), .O(new_n47_));
  nor3   g26(.a(x13), .b(x12), .c(x11), .O(new_n48_));
  aoi22  g27(.a(new_n48_), .b(new_n47_), .c(new_n41_), .d(x13), .O(new_n49_));
  ...
  aoi21  g33(.a(new_n29_), .b(new_n36_), .c(new_n54_), .O(new_n55_));
