...
module FAU ( 
  ...
  nor2   g12(.a(new_n33_), .b(x06), .O(new_n34_));
  ...
  oai21  g22(.a(x13), .b(new_n28_), .c(new_n30_), .O(new_n44_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n44_), .c(x05), .O(z2));
  ...
  nor2   g42(.a(new_n34_), .b(new_n63_), .O(new_n64_));
