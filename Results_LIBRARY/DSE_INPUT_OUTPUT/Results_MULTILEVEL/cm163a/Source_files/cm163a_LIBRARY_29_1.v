...
module FAU ( 
  ...
  aoi21  g24(.a(x06), .b(x05), .c(new_n22_), .O(new_n46_));
  nor2   g25(.a(x11), .b(x06), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n46_), .c(new_n31_), .O(new_n48_));
  nand3  g27(.a(x12), .b(x11), .c(x04), .O(new_n49_));
  oai21  g28(.a(x12), .b(x05), .c(new_n49_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x00), .O(new_n51_));
  nand2  g30(.a(new_n40_), .b(x12), .O(new_n52_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n38_), .c(new_n32_), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n51_), .c(new_n48_), .O(z2));
  inv1   g36(.a(x13), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n31_), .c(x00), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(x11), .O(new_n60_));
  and2   g39(.a(new_n54_), .b(x13), .O(new_n61_));
  nand3  g40(.a(new_n58_), .b(new_n53_), .c(new_n32_), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(new_n40_), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n61_), .c(x04), .O(new_n64_));
  inv1   g43(.a(x07), .O(new_n65_));
  aoi21  g44(.a(new_n65_), .b(new_n31_), .c(new_n38_), .O(new_n66_));
