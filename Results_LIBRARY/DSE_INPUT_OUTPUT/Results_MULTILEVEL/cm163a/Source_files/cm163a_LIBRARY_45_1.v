...
module FAU ( 
  ...
  oai21  g20(.a(new_n41_), .b(new_n31_), .c(x10), .O(new_n42_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n31_), .c(x10), .O(new_n53_));
  ...
  inv1   g35(.a(x11), .O(new_n57_));
  nand3  g36(.a(new_n52_), .b(new_n41_), .c(new_n57_), .O(new_n58_));
  ...
  nand3  g41(.a(new_n62_), .b(new_n60_), .c(new_n54_), .O(z3));
