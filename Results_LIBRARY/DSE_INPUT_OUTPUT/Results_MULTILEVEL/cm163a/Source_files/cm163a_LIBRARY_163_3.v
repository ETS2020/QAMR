...
module FAU ( 
  ...
  oai21  g22(.a(x14), .b(new_n43_), .c(new_n31_), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  aoi21  g24(.a(new_n36_), .b(new_n26_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x11), .O(new_n47_));
  nand3  g26(.a(new_n45_), .b(new_n47_), .c(new_n24_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n25_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n46_), .c(x04), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n44_), .c(new_n22_), .d(x05), .O(z2));
  inv1   g30(.a(x13), .O(new_n52_));
  nor3   g31(.a(x12), .b(x11), .c(x09), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n26_), .c(new_n52_), .O(new_n54_));
  nand3  g33(.a(new_n52_), .b(new_n45_), .c(new_n47_), .O(new_n55_));
  ...
  nand4  g41(.a(x10), .b(x08), .c(new_n43_), .d(x03), .O(new_n63_));
  nor3   g42(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z4));
endmodule
