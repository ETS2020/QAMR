...
module FAU ( 
  ...
  nand3  g19(.a(new_n40_), .b(new_n25_), .c(x04), .O(new_n41_));
  oai22  g20(.a(new_n41_), .b(new_n34_), .c(x06), .d(x04), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n23_), .O(new_n43_));
  nand3  g22(.a(new_n26_), .b(new_n23_), .c(new_n25_), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(x12), .c(x04), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n43_), .c(new_n24_), .O(z2));
  inv1   g25(.a(x07), .O(new_n47_));
  oai21  g26(.a(x11), .b(new_n47_), .c(new_n31_), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nor2   g28(.a(x12), .b(x09), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n26_), .c(new_n49_), .O(new_n51_));
  nand3  g30(.a(new_n49_), .b(new_n40_), .c(new_n23_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n27_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n51_), .c(x04), .O(new_n54_));
  aoi21  g33(.a(x13), .b(x11), .c(new_n22_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n54_), .c(new_n48_), .O(z3));
  inv1   g35(.a(x03), .O(new_n57_));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(x11), .b(new_n31_), .c(new_n58_), .O(new_n59_));
