...
module FAU ( 
  ...
  oai21  g01(.a(x10), .b(x04), .c(new_n22_), .O(new_n23_));
  ...
  nand3  g10(.a(x10), .b(new_n31_), .c(new_n30_), .O(new_n32_));
  nand3  g11(.a(new_n32_), .b(new_n29_), .c(new_n23_), .O(z0));
  ...
  nand3  g18(.a(x10), .b(new_n31_), .c(new_n39_), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n38_), .c(new_n23_), .O(z1));
  inv1   g20(.a(x12), .O(new_n42_));
  aoi21  g21(.a(new_n35_), .b(new_n26_), .c(new_n42_), .O(new_n43_));
  ...
  nand3  g27(.a(x10), .b(new_n48_), .c(new_n31_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n47_), .c(new_n23_), .O(z2));
  nand2  g29(.a(x10), .b(x07), .O(new_n51_));
  ...
  oai22  g40(.a(new_n61_), .b(new_n60_), .c(x10), .d(x04), .O(z4));
endmodule
