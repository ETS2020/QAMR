...
module FAU ( 
  ...
  oai21  g08(.a(new_n29_), .b(new_n28_), .c(x06), .O(new_n30_));
  ...
  aoi21  g18(.a(new_n22_), .b(new_n38_), .c(new_n39_), .O(new_n40_));
  oai21  g19(.a(new_n37_), .b(new_n22_), .c(new_n40_), .O(z1));
  inv1   g20(.a(new_n39_), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n33_), .c(new_n32_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(new_n45_));
  aoi21  g24(.a(new_n35_), .b(x12), .c(new_n45_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n22_), .c(new_n42_), .O(z2));
  ...
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x06), .O(new_n53_));
