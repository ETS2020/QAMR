...
module FAU ( 
  ...
  oai21  g21(.a(x15), .b(new_n28_), .c(new_n30_), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  aoi21  g23(.a(new_n35_), .b(new_n23_), .c(new_n44_), .O(new_n45_));
  ...
  inv1   g30(.a(new_n24_), .O(new_n52_));
  nand3  g31(.a(new_n47_), .b(new_n23_), .c(new_n22_), .O(new_n53_));
  ...
  nand3  g36(.a(new_n57_), .b(new_n31_), .c(x05), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n62_), .b(x06), .c(new_n61_), .O(z4));
endmodule
