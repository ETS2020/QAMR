...
module FAU ( 
  ...
  nand2  g03(.a(new_n24_), .b(x14), .O(new_n25_));
  ...
  nand2  g12(.a(new_n33_), .b(x14), .O(new_n34_));
  ...
  oai21  g23(.a(new_n44_), .b(new_n29_), .c(x14), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n40_), .O(z2));
  and2   g25(.a(new_n43_), .b(x13), .O(new_n47_));
  nor2   g26(.a(x13), .b(x12), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n32_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n24_), .c(x14), .O(new_n50_));
