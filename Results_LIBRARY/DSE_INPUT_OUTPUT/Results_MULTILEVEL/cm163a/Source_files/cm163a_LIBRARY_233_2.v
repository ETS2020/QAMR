...
module FAU ( 
  ...
  nor2   g11(.a(x07), .b(new_n32_), .O(new_n33_));
  ...
  oai21  g31(.a(x06), .b(new_n29_), .c(new_n44_), .O(new_n53_));
  inv1   g32(.a(x13), .O(new_n54_));
  nor3   g33(.a(x12), .b(x11), .c(x09), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n24_), .c(new_n54_), .O(new_n56_));
  nand3  g35(.a(new_n54_), .b(new_n46_), .c(new_n48_), .O(new_n57_));
  ...
  oai22  g41(.a(new_n62_), .b(new_n61_), .c(x07), .d(new_n32_), .O(z4));
endmodule
