...
module FAU ( 
  ...
  aoi21  g30(.a(new_n51_), .b(new_n49_), .c(new_n24_), .O(z2));
  inv1   g31(.a(new_n27_), .O(new_n53_));
  nor2   g32(.a(x12), .b(x11), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n26_), .c(new_n25_), .O(new_n55_));
  nor3   g34(.a(x13), .b(x12), .c(x11), .O(new_n56_));
  aoi22  g35(.a(new_n56_), .b(new_n53_), .c(new_n55_), .d(x13), .O(new_n57_));
  inv1   g36(.a(x07), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n31_), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n23_), .c(x05), .O(new_n60_));
  inv1   g39(.a(new_n60_), .O(new_n61_));
  oai21  g40(.a(new_n57_), .b(new_n31_), .c(new_n61_), .O(z3));
