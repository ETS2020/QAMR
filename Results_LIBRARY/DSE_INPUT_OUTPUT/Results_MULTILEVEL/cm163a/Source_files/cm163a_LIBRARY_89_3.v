...
module FAU ( 
  ...
  nand3  g07(.a(new_n28_), .b(new_n27_), .c(new_n22_), .O(new_n29_));
  ...
  nand4  g13(.a(new_n34_), .b(new_n31_), .c(new_n22_), .d(x05), .O(z1));
  nand3  g14(.a(new_n27_), .b(x03), .c(x02), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x12), .O(new_n37_));
  inv1   g16(.a(x12), .O(new_n38_));
  nand4  g17(.a(new_n38_), .b(new_n27_), .c(x03), .d(x02), .O(new_n39_));
  ...
  nand3  g24(.a(new_n45_), .b(new_n28_), .c(new_n27_), .O(new_n46_));
