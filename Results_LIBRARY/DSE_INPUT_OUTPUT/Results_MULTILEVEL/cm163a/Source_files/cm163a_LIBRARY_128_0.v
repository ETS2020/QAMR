...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(x11), .c(x09), .O(new_n35_));
  nand2  g14(.a(new_n23_), .b(x11), .O(new_n36_));
  nand3  g15(.a(new_n24_), .b(new_n29_), .c(new_n22_), .O(new_n37_));
  ...
  nand3  g22(.a(new_n43_), .b(new_n22_), .c(x04), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n23_), .c(x15), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n29_), .O(new_n46_));
  nand4  g25(.a(new_n24_), .b(x15), .c(new_n29_), .d(new_n22_), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(x12), .c(x04), .O(new_n48_));
  or2    g27(.a(x06), .b(x04), .O(new_n49_));
  nand4  g28(.a(new_n49_), .b(new_n48_), .c(new_n46_), .d(x05), .O(z2));
  oai21  g29(.a(x07), .b(x04), .c(x05), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n31_), .O(new_n52_));
  inv1   g31(.a(x13), .O(new_n53_));
  nand4  g32(.a(new_n43_), .b(new_n22_), .c(x03), .d(x02), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x15), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n29_), .c(new_n53_), .O(new_n56_));
  nand4  g35(.a(x15), .b(new_n53_), .c(new_n43_), .d(new_n29_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n25_), .O(new_n58_));
  ...
  oai21  g41(.a(new_n62_), .b(new_n61_), .c(new_n31_), .O(z4));
endmodule
