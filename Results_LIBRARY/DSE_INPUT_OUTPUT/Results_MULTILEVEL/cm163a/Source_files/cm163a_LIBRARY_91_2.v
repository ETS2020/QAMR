...
module FAU ( 
  ...
  nand2  g11(.a(x11), .b(new_n24_), .O(new_n33_));
  ...
  nand2  g18(.a(new_n39_), .b(new_n29_), .O(new_n40_));
  aoi21  g19(.a(x12), .b(x04), .c(new_n30_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n38_), .c(new_n40_), .O(z2));
  nand2  g21(.a(x07), .b(x05), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n29_), .O(new_n44_));
  aoi21  g23(.a(x13), .b(x04), .c(new_n30_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n38_), .c(new_n44_), .O(z3));
  inv1   g25(.a(x03), .O(new_n47_));
  inv1   g26(.a(x15), .O(new_n48_));
  aoi21  g27(.a(new_n38_), .b(x04), .c(new_n48_), .O(new_n49_));
