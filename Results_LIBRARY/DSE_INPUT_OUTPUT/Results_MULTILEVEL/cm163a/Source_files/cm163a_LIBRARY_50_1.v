...
module FAU ( 
  ...
  nor2   g01(.a(new_n22_), .b(x13), .O(new_n23_));
  ...
  oai21  g32(.a(new_n53_), .b(new_n46_), .c(new_n22_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  inv1   g34(.a(new_n47_), .O(new_n56_));
  ...
  nand4  g39(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(x13), .c(new_n22_), .O(z4));
endmodule
