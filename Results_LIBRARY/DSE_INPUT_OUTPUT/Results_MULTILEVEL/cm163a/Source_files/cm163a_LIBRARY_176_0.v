...
module FAU ( 
  ...
  nor3   g10(.a(new_n23_), .b(new_n29_), .c(x03), .O(new_n32_));
  oai21  g11(.a(new_n32_), .b(new_n31_), .c(x04), .O(new_n33_));
  ...
  nand3  g17(.a(new_n38_), .b(new_n29_), .c(x02), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n22_), .O(new_n40_));
  nor3   g19(.a(new_n23_), .b(new_n38_), .c(x03), .O(new_n41_));
  ...
  nor2   g25(.a(new_n22_), .b(new_n27_), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n38_), .c(new_n29_), .O(new_n48_));
  nor3   g27(.a(x12), .b(x11), .c(x09), .O(new_n49_));
  aoi22  g28(.a(new_n49_), .b(new_n47_), .c(new_n48_), .d(x12), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n44_), .c(new_n46_), .O(z2));
  oai21  g30(.a(x07), .b(x04), .c(x05), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n24_), .O(new_n53_));
  nand2  g32(.a(new_n39_), .b(x13), .O(new_n54_));
  nor2   g33(.a(x13), .b(x12), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(new_n38_), .c(new_n29_), .d(x02), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n54_), .c(new_n22_), .O(new_n57_));
  and2   g36(.a(x13), .b(x12), .O(new_n58_));
