...
module FAU ( 
  ...
  inv1   g08(.a(x12), .O(new_n30_));
  nand2  g09(.a(new_n30_), .b(x06), .O(new_n31_));
  nand2  g10(.a(new_n31_), .b(x05), .O(new_n32_));
  nor2   g11(.a(new_n32_), .b(new_n29_), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(new_n28_), .O(z0));
  inv1   g13(.a(x04), .O(new_n35_));
  inv1   g14(.a(x11), .O(new_n36_));
  nand4  g15(.a(new_n36_), .b(new_n22_), .c(x03), .d(x02), .O(new_n37_));
  inv1   g16(.a(new_n37_), .O(new_n38_));
  aoi21  g17(.a(new_n26_), .b(x11), .c(new_n38_), .O(new_n39_));
  nor2   g18(.a(x04), .b(x01), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n32_), .O(new_n41_));
  oai21  g20(.a(new_n39_), .b(new_n35_), .c(new_n41_), .O(z1));
  nand2  g21(.a(x12), .b(x06), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n35_), .O(new_n44_));
  oai21  g23(.a(new_n38_), .b(x06), .c(new_n30_), .O(new_n45_));
  nand3  g24(.a(new_n37_), .b(x12), .c(x04), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(x05), .O(z2));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n50_), .c(x06), .O(new_n53_));
  and2   g32(.a(x13), .b(x12), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(x04), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n49_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n31_), .O(z4));
endmodule
