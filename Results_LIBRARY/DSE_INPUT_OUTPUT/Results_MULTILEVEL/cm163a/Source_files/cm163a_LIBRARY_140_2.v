...
module FAU ( 
  ...
  nand2  g07(.a(new_n28_), .b(x06), .O(new_n29_));
  ...
  aoi21  g18(.a(x10), .b(x04), .c(new_n39_), .O(new_n40_));
  nand2  g19(.a(new_n34_), .b(new_n23_), .O(new_n41_));
  nor3   g20(.a(x12), .b(x11), .c(x09), .O(new_n42_));
  aoi22  g21(.a(new_n42_), .b(new_n23_), .c(new_n41_), .d(x12), .O(new_n43_));
  inv1   g22(.a(x05), .O(new_n44_));
  aoi22  g23(.a(new_n29_), .b(new_n44_), .c(new_n39_), .d(new_n33_), .O(new_n45_));
  oai21  g24(.a(new_n43_), .b(new_n40_), .c(new_n45_), .O(z2));
  inv1   g25(.a(new_n29_), .O(new_n47_));
  ...
  nand3  g30(.a(new_n48_), .b(new_n51_), .c(new_n50_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n24_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n49_), .c(x04), .O(new_n54_));
  inv1   g33(.a(x07), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n33_), .c(new_n44_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n54_), .c(new_n47_), .O(z3));
