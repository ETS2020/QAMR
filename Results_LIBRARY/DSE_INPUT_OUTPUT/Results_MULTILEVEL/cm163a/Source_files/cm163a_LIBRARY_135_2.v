...
module FAU ( 
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x09), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x07), .O(new_n45_));
  inv1   g24(.a(new_n26_), .O(new_n46_));
  nor2   g25(.a(x11), .b(x09), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n46_), .c(new_n43_), .O(new_n48_));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n42_), .c(new_n53_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n52_), .c(new_n45_), .O(z2));
  nand2  g35(.a(new_n23_), .b(new_n53_), .O(new_n57_));
  inv1   g36(.a(x13), .O(new_n58_));
  aoi21  g37(.a(new_n49_), .b(new_n46_), .c(new_n58_), .O(new_n59_));
  nand3  g38(.a(new_n22_), .b(x03), .c(x02), .O(new_n60_));
  nand3  g39(.a(new_n58_), .b(new_n43_), .c(new_n36_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(x04), .O(new_n62_));
  oai21  g41(.a(new_n62_), .b(new_n59_), .c(new_n28_), .O(new_n63_));
  nand3  g42(.a(x13), .b(x09), .c(x04), .O(new_n64_));
  nand3  g43(.a(new_n64_), .b(new_n63_), .c(new_n57_), .O(z3));
  inv1   g44(.a(x03), .O(new_n66_));
  inv1   g45(.a(x15), .O(new_n67_));
  aoi21  g46(.a(new_n22_), .b(x07), .c(new_n67_), .O(new_n68_));
