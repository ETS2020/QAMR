...
module FAU ( 
  ...
  nand3  g21(.a(new_n42_), .b(new_n34_), .c(new_n22_), .O(new_n43_));
  ...
  oai21  g26(.a(new_n45_), .b(new_n29_), .c(new_n47_), .O(z2));
  ...
  nand2  g35(.a(new_n56_), .b(new_n40_), .O(z3));
  nand4  g36(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(x05), .c(new_n39_), .O(z4));
endmodule
