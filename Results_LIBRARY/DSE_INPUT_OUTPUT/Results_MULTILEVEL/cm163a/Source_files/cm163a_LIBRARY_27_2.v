...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_;
  ...
  nand4  g08(.a(new_n29_), .b(new_n26_), .c(x13), .d(x05), .O(z0));
  ...
  oai21  g19(.a(x06), .b(x04), .c(x13), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  oai21  g21(.a(new_n39_), .b(new_n28_), .c(new_n42_), .O(z2));
  and2   g22(.a(new_n38_), .b(new_n23_), .O(new_n44_));
  oai21  g23(.a(x07), .b(x04), .c(x13), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n40_), .O(new_n46_));
  ...
  aoi21  g29(.a(new_n49_), .b(x05), .c(new_n50_), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(x14), .c(x10), .d(x08), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n48_), .O(z4));
endmodule
