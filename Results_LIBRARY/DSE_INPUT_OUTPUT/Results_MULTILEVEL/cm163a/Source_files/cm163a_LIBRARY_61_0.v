...
module FAU ( 
  ...
  aoi21  g24(.a(new_n34_), .b(x04), .c(new_n29_), .O(new_n46_));
  oai22  g25(.a(new_n46_), .b(new_n40_), .c(new_n45_), .d(new_n29_), .O(z2));
  ...
  aoi21  g39(.a(new_n40_), .b(new_n29_), .c(new_n60_), .O(new_n61_));
