...
module FAU ( 
  ...
  inv1   g08(.a(x10), .O(new_n30_));
  nand2  g09(.a(x11), .b(new_n30_), .O(new_n31_));
  ...
  nand3  g13(.a(new_n24_), .b(x11), .c(x10), .O(new_n35_));
  ...
  oai21  g20(.a(new_n41_), .b(new_n28_), .c(x10), .O(new_n42_));
  ...
  aoi21  g30(.a(x11), .b(new_n30_), .c(x07), .O(new_n52_));
  nor2   g31(.a(new_n30_), .b(x05), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(new_n28_), .O(new_n54_));
  oai21  g33(.a(x13), .b(new_n30_), .c(x11), .O(new_n55_));
  ...
  nand3  g40(.a(x13), .b(x11), .c(x10), .O(new_n62_));
  ...
  oai21  g46(.a(new_n67_), .b(new_n66_), .c(new_n31_), .O(z4));
endmodule
