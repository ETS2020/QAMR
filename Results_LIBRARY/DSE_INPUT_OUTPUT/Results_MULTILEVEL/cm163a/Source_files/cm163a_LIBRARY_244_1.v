...
module FAU ( 
  ...
  aoi21  g23(.a(new_n31_), .b(new_n22_), .c(new_n30_), .O(new_n45_));
  oai21  g24(.a(new_n44_), .b(new_n22_), .c(new_n45_), .O(z2));
  oai21  g25(.a(new_n42_), .b(new_n23_), .c(x13), .O(new_n47_));
  ...
  nand2  g33(.a(new_n54_), .b(new_n32_), .O(z3));
  inv1   g34(.a(x15), .O(new_n56_));
  aoi21  g35(.a(x06), .b(new_n30_), .c(new_n56_), .O(new_n57_));
  nand4  g36(.a(new_n57_), .b(x14), .c(x10), .d(x08), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n48_), .O(z4));
endmodule
