...
module FAU ( 
  ...
  nand2  g16(.a(x13), .b(new_n29_), .O(new_n38_));
  ...
  aoi21  g21(.a(new_n42_), .b(new_n40_), .c(new_n28_), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(x05), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n38_), .O(z2));
  ...
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(x13), .d(x05), .O(z4));
endmodule
