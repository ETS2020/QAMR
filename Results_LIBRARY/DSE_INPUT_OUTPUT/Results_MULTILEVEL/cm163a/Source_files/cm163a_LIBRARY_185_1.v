...
module FAU ( 
  ...
  nand3  g05(.a(new_n26_), .b(x09), .c(x05), .O(new_n27_));
  ...
  aoi22  g11(.a(new_n32_), .b(new_n30_), .c(new_n31_), .d(new_n23_), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(new_n29_), .O(z0));
  nand2  g13(.a(new_n22_), .b(x04), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n26_), .c(x05), .O(new_n36_));
  ...
  oai21  g18(.a(x04), .b(x01), .c(new_n39_), .O(new_n40_));
  ...
  oai21  g23(.a(new_n44_), .b(new_n26_), .c(x05), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n31_), .O(new_n46_));
  nand4  g25(.a(new_n31_), .b(new_n22_), .c(x03), .d(x02), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(x12), .c(x04), .O(new_n48_));
  inv1   g27(.a(new_n48_), .O(new_n49_));
  nor2   g28(.a(x06), .b(x04), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n49_), .c(x05), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n46_), .O(z2));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  inv1   g32(.a(x13), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n43_), .c(new_n22_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n53_), .c(x05), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n31_), .O(new_n57_));
  nor2   g36(.a(x12), .b(x11), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(new_n22_), .c(x03), .d(x02), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(x13), .c(x04), .O(new_n60_));
  or2    g39(.a(x07), .b(x04), .O(new_n61_));
