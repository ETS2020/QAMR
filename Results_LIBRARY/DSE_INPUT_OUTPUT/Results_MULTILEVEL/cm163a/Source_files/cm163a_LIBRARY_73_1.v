...
module FAU ( 
  ...
  oai22  g32(.a(new_n53_), .b(new_n44_), .c(x07), .d(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand4  g34(.a(new_n23_), .b(new_n40_), .c(new_n43_), .d(new_n22_), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(x13), .c(x07), .d(x04), .O(new_n57_));
