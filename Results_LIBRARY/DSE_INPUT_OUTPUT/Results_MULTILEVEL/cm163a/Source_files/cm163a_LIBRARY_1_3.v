...
module FAU ( 
  ...
  nor3   g15(.a(new_n36_), .b(x10), .c(new_n35_), .O(new_n37_));
  oai21  g16(.a(new_n34_), .b(new_n23_), .c(new_n37_), .O(z1));
  nand3  g17(.a(new_n33_), .b(x03), .c(x02), .O(new_n39_));
  nor3   g18(.a(x12), .b(x11), .c(x09), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n32_), .c(new_n39_), .d(x12), .O(new_n41_));
  nor2   g20(.a(x06), .b(x04), .O(new_n42_));
  nor3   g21(.a(new_n42_), .b(x10), .c(new_n35_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n23_), .c(new_n43_), .O(z2));
  nand3  g23(.a(new_n26_), .b(x04), .c(x02), .O(new_n45_));
  ...
  oai21  g28(.a(new_n48_), .b(new_n45_), .c(new_n49_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x03), .O(new_n51_));
  nand2  g30(.a(new_n40_), .b(new_n32_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(x13), .c(x04), .O(new_n53_));
  nor2   g32(.a(x07), .b(x04), .O(new_n54_));
  nor3   g33(.a(new_n54_), .b(x10), .c(new_n35_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n53_), .c(new_n51_), .O(z3));
  nand4  g35(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n35_), .c(new_n22_), .O(z4));
endmodule
