...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x07), .O(new_n28_));
  ...
  inv1   g16(.a(new_n28_), .O(new_n38_));
  inv1   g17(.a(x12), .O(new_n39_));
  aoi21  g18(.a(new_n33_), .b(new_n23_), .c(new_n39_), .O(new_n40_));
  ...
  aoi21  g26(.a(new_n47_), .b(new_n32_), .c(new_n46_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n45_), .c(new_n38_), .O(z2));
  nand2  g28(.a(new_n28_), .b(new_n46_), .O(new_n50_));
  ...
  oai21  g33(.a(new_n54_), .b(new_n32_), .c(new_n51_), .O(new_n55_));
  nand3  g34(.a(x04), .b(x03), .c(x02), .O(new_n56_));
  inv1   g35(.a(new_n56_), .O(new_n57_));
  nand4  g36(.a(new_n57_), .b(new_n33_), .c(new_n52_), .d(new_n39_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n55_), .c(new_n50_), .O(z3));
  nand2  g38(.a(x08), .b(x03), .O(new_n60_));
  nand3  g39(.a(x15), .b(x14), .c(x10), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n28_), .O(z4));
endmodule
