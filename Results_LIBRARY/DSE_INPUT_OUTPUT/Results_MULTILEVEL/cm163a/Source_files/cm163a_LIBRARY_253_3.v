...
module FAU ( 
  ...
  inv1   g13(.a(new_n27_), .O(new_n35_));
  nor2   g14(.a(x11), .b(x09), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n34_), .c(new_n26_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x04), .O(new_n39_));
  inv1   g18(.a(x01), .O(new_n40_));
  aoi21  g19(.a(new_n22_), .b(new_n40_), .c(new_n25_), .O(new_n41_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n45_), .c(new_n29_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n27_), .c(new_n26_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n44_), .c(x04), .O(new_n48_));
  inv1   g27(.a(x06), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n22_), .c(new_n25_), .O(new_n50_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n30_), .c(new_n26_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n54_), .c(x04), .O(new_n57_));
  aoi21  g36(.a(new_n26_), .b(new_n22_), .c(new_n25_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n57_), .O(z3));
  inv1   g38(.a(x03), .O(new_n60_));
  inv1   g39(.a(x08), .O(new_n61_));
  nand2  g40(.a(x07), .b(x04), .O(new_n62_));
