...
module FAU ( 
  ...
  inv1   g24(.a(new_n29_), .O(new_n46_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n28_), .c(new_n46_), .O(z3));
  inv1   g29(.a(x03), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  inv1   g31(.a(x15), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x05), .c(new_n53_), .O(new_n54_));
  nand4  g33(.a(new_n54_), .b(x14), .c(x10), .d(x08), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n51_), .O(z4));
endmodule
