...
module FAU ( 
  ...
  aoi22  g11(.a(new_n32_), .b(new_n28_), .c(new_n22_), .d(x10), .O(z0));
  inv1   g12(.a(x10), .O(new_n34_));
  nand2  g13(.a(new_n23_), .b(x04), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n24_), .c(new_n34_), .O(new_n36_));
  ...
  oai21  g21(.a(new_n42_), .b(new_n30_), .c(x11), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x10), .O(new_n44_));
  nor2   g23(.a(x11), .b(x09), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n25_), .c(new_n42_), .O(new_n46_));
  nand3  g25(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n24_), .O(new_n48_));
  ...
  oai21  g32(.a(new_n53_), .b(new_n30_), .c(x11), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x10), .O(new_n55_));
  nor3   g34(.a(x12), .b(x11), .c(x09), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n25_), .c(new_n53_), .O(new_n57_));
  nand3  g36(.a(new_n53_), .b(new_n42_), .c(new_n22_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n26_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n57_), .c(x04), .O(new_n60_));
  inv1   g39(.a(x07), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n30_), .c(new_n31_), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n60_), .c(new_n55_), .O(z3));
  nand4  g42(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n64_));
  aoi21  g43(.a(new_n64_), .b(x11), .c(new_n34_), .O(z4));
endmodule
