...
module FAU ( 
  ...
  nand4  g20(.a(new_n25_), .b(new_n41_), .c(new_n35_), .d(new_n23_), .O(new_n42_));
  ...
  nand3  g25(.a(new_n41_), .b(new_n35_), .c(new_n23_), .O(new_n47_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n48_), .c(new_n32_), .O(new_n51_));
