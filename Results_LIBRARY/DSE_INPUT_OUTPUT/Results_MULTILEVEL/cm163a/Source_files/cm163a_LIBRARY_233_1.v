...
module FAU ( 
  ...
  inv1   g10(.a(x07), .O(new_n32_));
  nor2   g11(.a(new_n32_), .b(x06), .O(new_n33_));
  ...
  oai21  g23(.a(x07), .b(new_n29_), .c(new_n44_), .O(new_n45_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n45_), .c(x05), .O(z2));
  oai21  g31(.a(new_n32_), .b(new_n44_), .c(new_n29_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n59_), .b(new_n53_), .c(new_n34_), .O(z3));
  nand2  g39(.a(x08), .b(x03), .O(new_n61_));
  nand3  g40(.a(x15), .b(x14), .c(x10), .O(new_n62_));
  oai22  g41(.a(new_n62_), .b(new_n61_), .c(new_n32_), .d(x06), .O(z4));
endmodule
