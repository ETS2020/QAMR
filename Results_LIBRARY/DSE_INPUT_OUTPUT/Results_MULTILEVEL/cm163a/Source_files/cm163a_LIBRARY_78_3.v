...
module FAU ( 
  ...
  aoi22  g19(.a(new_n40_), .b(new_n23_), .c(new_n39_), .d(x12), .O(new_n41_));
  inv1   g20(.a(x05), .O(new_n42_));
  nor2   g21(.a(x06), .b(x04), .O(new_n43_));
  nor3   g22(.a(new_n43_), .b(x08), .c(new_n42_), .O(new_n44_));
  oai21  g23(.a(new_n41_), .b(new_n32_), .c(new_n44_), .O(z2));
  nand3  g24(.a(new_n22_), .b(x04), .c(x02), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n47_), .c(new_n38_), .O(new_n49_));
  nand4  g28(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n50_));
  oai21  g29(.a(new_n49_), .b(new_n46_), .c(new_n50_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x03), .O(new_n52_));
  nand2  g31(.a(new_n40_), .b(new_n23_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(x13), .c(x04), .O(new_n54_));
  nor2   g33(.a(x07), .b(x04), .O(new_n55_));
  nor3   g34(.a(new_n55_), .b(x08), .c(new_n42_), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z3));
  nand4  g36(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n42_), .c(new_n28_), .O(z4));
endmodule
