...
module FAU ( 
  ...
  oai21  g08(.a(new_n24_), .b(x00), .c(new_n29_), .O(z0));
  ...
  aoi21  g14(.a(new_n22_), .b(new_n35_), .c(new_n23_), .O(new_n36_));
  oai21  g15(.a(new_n34_), .b(new_n22_), .c(new_n36_), .O(z1));
  nor3   g16(.a(x12), .b(x11), .c(x09), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n26_), .c(new_n32_), .d(x12), .O(new_n39_));
  inv1   g18(.a(x06), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n22_), .c(new_n23_), .O(new_n41_));
  oai21  g20(.a(new_n39_), .b(new_n22_), .c(new_n41_), .O(z2));
  inv1   g21(.a(new_n27_), .O(new_n43_));
  ...
  aoi21  g27(.a(new_n48_), .b(new_n22_), .c(new_n23_), .O(new_n49_));
  oai21  g28(.a(new_n47_), .b(new_n22_), .c(new_n49_), .O(z3));
  inv1   g29(.a(x03), .O(new_n51_));
  inv1   g30(.a(x15), .O(new_n52_));
  aoi21  g31(.a(new_n23_), .b(x00), .c(new_n52_), .O(new_n53_));
