...
module FAU ( 
  ...
  oai21  g17(.a(x12), .b(x06), .c(x11), .O(new_n39_));
  ...
  nand2  g24(.a(new_n26_), .b(x12), .O(new_n46_));
  nand4  g25(.a(new_n43_), .b(new_n24_), .c(x03), .d(x02), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n42_), .c(x04), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n45_), .c(new_n40_), .O(z2));
  aoi21  g29(.a(x07), .b(x05), .c(x06), .O(new_n51_));
  nor2   g30(.a(x11), .b(x07), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(new_n30_), .O(new_n53_));
  oai21  g32(.a(x13), .b(x06), .c(x11), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand2  g34(.a(new_n47_), .b(x13), .O(new_n56_));
  inv1   g35(.a(x13), .O(new_n57_));
  nand4  g36(.a(new_n25_), .b(new_n57_), .c(new_n43_), .d(new_n24_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n56_), .c(x11), .O(new_n59_));
  nor3   g38(.a(new_n57_), .b(new_n42_), .c(x06), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n59_), .c(x04), .O(new_n61_));
  nand3  g40(.a(new_n61_), .b(new_n55_), .c(new_n53_), .O(z3));
