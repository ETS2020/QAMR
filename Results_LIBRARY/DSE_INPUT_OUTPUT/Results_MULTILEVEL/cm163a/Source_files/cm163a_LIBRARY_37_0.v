...
module FAU ( 
  ...
  nand2  g22(.a(new_n26_), .b(x12), .O(new_n44_));
  nor2   g23(.a(x12), .b(x11), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n25_), .c(new_n24_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x04), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n43_), .c(new_n23_), .O(z2));
  ...
  aoi21  g37(.a(new_n34_), .b(new_n30_), .c(new_n58_), .O(new_n59_));
