...
module FAU ( 
  ...
  nand4  g11(.a(new_n32_), .b(new_n27_), .c(x03), .d(x02), .O(new_n33_));
  ...
  nand3  g19(.a(new_n40_), .b(new_n32_), .c(new_n27_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n25_), .O(new_n42_));
  aoi21  g21(.a(new_n33_), .b(x12), .c(new_n42_), .O(new_n43_));
  inv1   g22(.a(x06), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n22_), .c(new_n37_), .O(new_n45_));
  ...
  oai21  g27(.a(new_n41_), .b(new_n25_), .c(x13), .O(new_n49_));
  ...
  nand3  g33(.a(new_n54_), .b(x05), .c(x04), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n48_), .O(z3));
  inv1   g35(.a(x15), .O(new_n57_));
  aoi21  g36(.a(new_n37_), .b(x04), .c(new_n57_), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(x14), .c(x10), .d(x08), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n50_), .O(z4));
endmodule
