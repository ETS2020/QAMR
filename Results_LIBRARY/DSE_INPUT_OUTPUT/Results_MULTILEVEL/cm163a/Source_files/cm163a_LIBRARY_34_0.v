...
module FAU ( 
  ...
  oai21  g01(.a(x11), .b(x04), .c(new_n22_), .O(new_n23_));
  ...
  nand3  g09(.a(x11), .b(new_n30_), .c(new_n29_), .O(new_n31_));
  ...
  nand3  g18(.a(new_n39_), .b(new_n34_), .c(x05), .O(z1));
  nand2  g19(.a(x11), .b(x06), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n30_), .O(new_n42_));
  nand3  g21(.a(new_n37_), .b(x12), .c(x04), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand4  g23(.a(new_n25_), .b(new_n44_), .c(new_n36_), .d(new_n24_), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n43_), .c(new_n42_), .d(x05), .O(z2));
  nor2   g25(.a(x07), .b(x04), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n30_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n47_), .c(x11), .O(new_n50_));
  nor2   g29(.a(x12), .b(x09), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n25_), .c(new_n48_), .O(new_n52_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n36_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n26_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n52_), .c(x04), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n50_), .c(new_n23_), .O(z3));
  inv1   g35(.a(x03), .O(new_n57_));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n36_), .b(new_n30_), .c(new_n58_), .O(new_n59_));
