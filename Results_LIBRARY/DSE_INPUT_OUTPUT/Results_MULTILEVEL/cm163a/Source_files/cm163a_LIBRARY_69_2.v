...
module FAU ( 
  ...
  aoi21  g27(.a(x14), .b(x04), .c(new_n48_), .O(new_n49_));
  ...
  aoi22  g34(.a(new_n29_), .b(new_n55_), .c(new_n48_), .d(new_n33_), .O(new_n56_));
  oai21  g35(.a(new_n54_), .b(new_n49_), .c(new_n56_), .O(z3));
