...
module FAU ( 
  ...
  nand3  g20(.a(new_n41_), .b(new_n35_), .c(new_n25_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n23_), .O(new_n43_));
  aoi21  g22(.a(new_n36_), .b(x12), .c(new_n43_), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n30_), .O(new_n46_));
  ...
  aoi21  g36(.a(new_n57_), .b(x05), .c(new_n31_), .O(z4));
endmodule
