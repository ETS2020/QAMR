...
module FAU ( 
  ...
  nand2  g19(.a(new_n24_), .b(x12), .O(new_n41_));
  inv1   g20(.a(x12), .O(new_n42_));
  nand4  g21(.a(new_n23_), .b(new_n42_), .c(new_n29_), .d(new_n22_), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(new_n41_), .c(new_n28_), .O(new_n44_));
  nor2   g23(.a(new_n42_), .b(new_n29_), .O(new_n45_));
  ...
  nand2  g27(.a(new_n48_), .b(new_n30_), .O(new_n49_));
  nand4  g28(.a(new_n42_), .b(new_n22_), .c(x03), .d(x02), .O(new_n50_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n51_), .c(new_n28_), .O(new_n56_));
  and2   g35(.a(x13), .b(x11), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n56_), .c(x04), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n49_), .O(z3));
  nand2  g38(.a(x08), .b(x03), .O(new_n60_));
  nand3  g39(.a(x15), .b(x14), .c(x10), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n30_), .O(z4));
endmodule
