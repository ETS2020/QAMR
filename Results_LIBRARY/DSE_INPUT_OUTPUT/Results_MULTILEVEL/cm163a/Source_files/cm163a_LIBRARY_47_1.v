...
module FAU ( 
  ...
  nand2  g07(.a(x08), .b(new_n28_), .O(new_n29_));
  ...
  oai21  g26(.a(x08), .b(new_n33_), .c(new_n28_), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  aoi21  g28(.a(new_n41_), .b(new_n23_), .c(new_n49_), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n57_), .b(x07), .c(new_n56_), .O(z4));
endmodule
