...
module FAU ( 
  ...
  nor2   g27(.a(new_n23_), .b(new_n48_), .O(new_n49_));
  nand4  g28(.a(new_n49_), .b(new_n40_), .c(new_n26_), .d(x02), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n47_), .c(new_n22_), .d(x05), .O(z3));
  inv1   g30(.a(x08), .O(new_n52_));
  nand2  g31(.a(x13), .b(x05), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(x15), .c(x14), .d(x10), .O(new_n54_));
  nor3   g33(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(z4));
endmodule
