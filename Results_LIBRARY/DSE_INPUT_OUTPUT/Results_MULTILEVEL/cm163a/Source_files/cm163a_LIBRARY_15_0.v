...
module FAU ( 
  ...
  aoi22  g18(.a(new_n39_), .b(new_n23_), .c(new_n33_), .d(x12), .O(new_n40_));
  ...
  aoi21  g23(.a(new_n39_), .b(new_n23_), .c(new_n44_), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nand3  g25(.a(new_n44_), .b(new_n46_), .c(new_n32_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n24_), .c(x05), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n45_), .c(x04), .O(new_n49_));
  inv1   g28(.a(x07), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x05), .c(new_n28_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n49_), .O(z3));
  inv1   g31(.a(x03), .O(new_n53_));
  inv1   g32(.a(x15), .O(new_n54_));
  aoi21  g33(.a(new_n29_), .b(new_n28_), .c(new_n54_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(x14), .c(x10), .d(x08), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n53_), .O(z4));
endmodule
