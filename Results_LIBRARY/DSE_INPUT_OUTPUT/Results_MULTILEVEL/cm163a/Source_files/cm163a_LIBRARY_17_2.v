...
module FAU ( 
  ...
  aoi21  g09(.a(new_n22_), .b(x01), .c(x09), .O(new_n31_));
  ...
  aoi21  g16(.a(new_n37_), .b(new_n36_), .c(new_n27_), .O(new_n38_));
  or2    g17(.a(new_n38_), .b(x01), .O(new_n39_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n27_), .c(x11), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x01), .O(new_n47_));
  aoi21  g26(.a(new_n37_), .b(new_n36_), .c(new_n45_), .O(new_n48_));
  nor4   g27(.a(new_n24_), .b(x12), .c(x11), .d(x09), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(x04), .O(new_n50_));
  inv1   g29(.a(x06), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n27_), .c(new_n34_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n50_), .c(new_n47_), .O(z2));
  oai21  g32(.a(x07), .b(x04), .c(x05), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n23_), .O(new_n55_));
  inv1   g34(.a(x09), .O(new_n56_));
  nand2  g35(.a(new_n45_), .b(new_n56_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n24_), .c(x13), .O(new_n58_));
  nor3   g37(.a(x13), .b(x12), .c(x11), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n41_), .c(x02), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(x01), .O(new_n61_));
  ...
  nor2   g45(.a(new_n66_), .b(new_n40_), .O(z4));
endmodule
