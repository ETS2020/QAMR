...
module FAU ( 
  ...
  oai21  g21(.a(new_n42_), .b(new_n41_), .c(x14), .O(new_n43_));
  ...
  oai21  g27(.a(x07), .b(x04), .c(x14), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  oai21  g29(.a(new_n47_), .b(new_n22_), .c(new_n50_), .O(z3));
  nand2  g30(.a(x08), .b(x03), .O(new_n52_));
  nand3  g31(.a(x15), .b(x14), .c(x10), .O(new_n53_));
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(x14), .d(new_n48_), .O(z4));
endmodule
