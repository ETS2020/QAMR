...
module FAU ( 
  ...
  oai21  g12(.a(x15), .b(x11), .c(x09), .O(new_n34_));
  nand2  g13(.a(new_n23_), .b(x11), .O(new_n35_));
  nand3  g14(.a(new_n24_), .b(new_n29_), .c(new_n22_), .O(new_n36_));
  ...
  nand4  g25(.a(new_n24_), .b(new_n42_), .c(new_n29_), .d(new_n22_), .O(new_n47_));
  ...
  nand4  g35(.a(new_n42_), .b(new_n53_), .c(new_n43_), .d(new_n29_), .O(new_n57_));
  ...
  aoi21  g40(.a(new_n61_), .b(x11), .c(new_n42_), .O(z4));
endmodule
