...
module FAU ( 
  ...
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(x09), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n22_), .O(new_n46_));
  aoi21  g25(.a(new_n36_), .b(new_n28_), .c(new_n44_), .O(new_n47_));
  nand3  g26(.a(new_n44_), .b(new_n39_), .c(new_n23_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n27_), .O(new_n49_));
  ...
  oai21  g33(.a(new_n23_), .b(new_n43_), .c(new_n22_), .O(new_n55_));
  ...
  nand2  g38(.a(new_n44_), .b(new_n39_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n27_), .c(x13), .O(new_n61_));
  inv1   g40(.a(x03), .O(new_n62_));
  nor2   g41(.a(x09), .b(new_n62_), .O(new_n63_));
  nor3   g42(.a(x13), .b(x12), .c(x11), .O(new_n64_));
  nand3  g43(.a(new_n64_), .b(new_n63_), .c(x02), .O(new_n65_));
  nand2  g44(.a(new_n65_), .b(new_n61_), .O(new_n66_));
  nand3  g45(.a(new_n66_), .b(x07), .c(x04), .O(new_n67_));
  nand3  g46(.a(new_n67_), .b(new_n59_), .c(new_n56_), .O(z3));
  and2   g47(.a(new_n24_), .b(x15), .O(new_n69_));
  nand4  g48(.a(new_n69_), .b(x14), .c(x10), .d(x08), .O(new_n70_));
  nor2   g49(.a(new_n70_), .b(new_n62_), .O(z4));
endmodule
