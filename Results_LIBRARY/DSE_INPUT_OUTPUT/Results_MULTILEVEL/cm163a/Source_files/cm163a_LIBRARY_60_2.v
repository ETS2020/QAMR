...
module FAU ( 
  ...
  oai21  g13(.a(new_n34_), .b(new_n22_), .c(new_n30_), .O(new_n35_));
  ...
  nand4  g17(.a(new_n38_), .b(new_n37_), .c(new_n35_), .d(x05), .O(z1));
  ...
  nand4  g23(.a(new_n25_), .b(new_n44_), .c(new_n34_), .d(new_n24_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(x01), .O(new_n46_));
  nor2   g25(.a(new_n44_), .b(new_n34_), .O(new_n47_));
  ...
  nand4  g30(.a(new_n44_), .b(new_n24_), .c(x03), .d(x02), .O(new_n52_));
  ...
  aoi21  g36(.a(new_n57_), .b(new_n53_), .c(x01), .O(new_n58_));
  ...
  nor2   g41(.a(new_n23_), .b(new_n62_), .O(new_n63_));
  nand4  g42(.a(new_n63_), .b(x14), .c(x10), .d(x08), .O(new_n64_));
  nor2   g43(.a(new_n64_), .b(new_n54_), .O(z4));
endmodule
