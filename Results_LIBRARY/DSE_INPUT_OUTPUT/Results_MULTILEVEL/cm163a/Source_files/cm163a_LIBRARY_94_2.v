...
module FAU ( 
  ...
  nand3  g04(.a(new_n25_), .b(new_n23_), .c(x15), .O(new_n26_));
  ...
  nand3  g15(.a(new_n36_), .b(new_n33_), .c(x15), .O(new_n37_));
  ...
  aoi21  g21(.a(new_n35_), .b(new_n34_), .c(new_n42_), .O(new_n43_));
  inv1   g22(.a(x11), .O(new_n44_));
  nand3  g23(.a(new_n42_), .b(new_n44_), .c(new_n24_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n22_), .c(x15), .O(new_n46_));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n34_), .c(new_n51_), .O(new_n53_));
  nand3  g32(.a(new_n51_), .b(new_n42_), .c(new_n44_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n25_), .c(x15), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n53_), .c(x04), .O(new_n56_));
  inv1   g35(.a(x07), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n29_), .c(new_n30_), .O(new_n58_));
