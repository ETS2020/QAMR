...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x06), .O(new_n28_));
  ...
  aoi21  g18(.a(new_n39_), .b(x04), .c(new_n38_), .O(new_n40_));
  nand2  g19(.a(new_n33_), .b(new_n23_), .O(new_n41_));
  ...
  aoi22  g23(.a(new_n28_), .b(new_n44_), .c(new_n38_), .d(new_n32_), .O(new_n45_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n32_), .c(new_n44_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n54_), .c(new_n47_), .O(z3));
  nand4  g36(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n38_), .c(new_n39_), .O(z4));
endmodule
