...
module FAU ( 
  ...
  nor3   g30(.a(new_n51_), .b(x15), .c(new_n50_), .O(new_n52_));
  oai21  g31(.a(new_n49_), .b(new_n32_), .c(new_n52_), .O(z3));
  inv1   g32(.a(x14), .O(new_n54_));
  nand4  g33(.a(x10), .b(x08), .c(new_n50_), .d(x03), .O(new_n55_));
  nor3   g34(.a(new_n55_), .b(new_n28_), .c(new_n54_), .O(z4));
endmodule
