...
module FAU ( 
  ...
  oai21  g21(.a(new_n42_), .b(new_n41_), .c(x07), .O(new_n43_));
  ...
  and2   g26(.a(x07), .b(x05), .O(new_n48_));
  oai21  g27(.a(new_n47_), .b(new_n22_), .c(new_n48_), .O(z3));
  inv1   g28(.a(x03), .O(new_n50_));
  inv1   g29(.a(x07), .O(new_n51_));
  inv1   g30(.a(x15), .O(new_n52_));
  aoi21  g31(.a(new_n51_), .b(x05), .c(new_n52_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(x14), .c(x10), .d(x08), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n50_), .O(z4));
endmodule
