...
module FAU ( 
  ...
  oai21  g11(.a(new_n22_), .b(new_n28_), .c(x11), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x06), .O(new_n34_));
  nand2  g13(.a(new_n24_), .b(x11), .O(new_n35_));
  nand3  g14(.a(new_n23_), .b(new_n30_), .c(new_n22_), .O(new_n36_));
  ...
  nand2  g21(.a(new_n31_), .b(new_n40_), .O(new_n43_));
  ...
  nand2  g27(.a(new_n48_), .b(new_n44_), .O(new_n49_));
  nand3  g28(.a(x12), .b(x11), .c(x04), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n49_), .c(new_n43_), .O(z2));
  inv1   g30(.a(x13), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n28_), .c(x11), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(x06), .O(new_n54_));
  aoi21  g33(.a(new_n46_), .b(new_n23_), .c(new_n52_), .O(new_n55_));
  inv1   g34(.a(x12), .O(new_n56_));
  nand3  g35(.a(new_n52_), .b(new_n56_), .c(new_n30_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n55_), .c(x04), .O(new_n59_));
  inv1   g38(.a(x07), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n28_), .c(new_n40_), .O(new_n61_));
  nand3  g40(.a(new_n61_), .b(new_n59_), .c(new_n54_), .O(z3));
  inv1   g41(.a(x03), .O(new_n63_));
  and2   g42(.a(new_n31_), .b(x15), .O(new_n64_));
  nand4  g43(.a(new_n64_), .b(x14), .c(x10), .d(x08), .O(new_n65_));
  nor2   g44(.a(new_n65_), .b(new_n63_), .O(z4));
endmodule
