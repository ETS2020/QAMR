...
module FAU ( 
  ...
  oai21  g28(.a(x08), .b(new_n30_), .c(new_n49_), .O(new_n50_));
  inv1   g29(.a(x13), .O(new_n51_));
  nor3   g30(.a(x12), .b(x11), .c(x09), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n25_), .c(new_n51_), .O(new_n53_));
  nand3  g32(.a(new_n51_), .b(new_n39_), .c(new_n42_), .O(new_n54_));
  ...
  nand4  g38(.a(x10), .b(x08), .c(x07), .d(x03), .O(new_n60_));
