...
module FAU ( 
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(new_n25_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x09), .O(new_n45_));
  nand2  g24(.a(new_n37_), .b(x12), .O(new_n46_));
  nor2   g25(.a(x12), .b(x11), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(new_n28_), .c(x03), .d(x02), .O(new_n48_));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n42_), .c(new_n51_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n50_), .c(new_n45_), .O(z2));
  oai21  g33(.a(x13), .b(x07), .c(x09), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n51_), .O(new_n56_));
  nand2  g35(.a(x13), .b(x09), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x04), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n25_), .O(new_n59_));
  nand4  g38(.a(new_n43_), .b(new_n36_), .c(x03), .d(x02), .O(new_n60_));
  ...
  nand3  g43(.a(new_n64_), .b(new_n28_), .c(x04), .O(new_n65_));
