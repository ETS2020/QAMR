...
module FAU ( 
  ...
  oai21  g07(.a(new_n28_), .b(new_n27_), .c(x01), .O(new_n29_));
  ...
  nand3  g14(.a(new_n35_), .b(x04), .c(x01), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x05), .O(z1));
  nor3   g16(.a(x12), .b(x11), .c(x09), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n32_), .c(new_n34_), .d(x12), .O(new_n39_));
  ...
  inv1   g22(.a(new_n26_), .O(new_n44_));
  ...
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(x01), .O(z4));
endmodule
