...
module FAU ( 
  ...
  nand2  g11(.a(x11), .b(new_n28_), .O(new_n33_));
  oai21  g12(.a(new_n33_), .b(new_n26_), .c(x04), .O(new_n34_));
  inv1   g13(.a(x01), .O(new_n35_));
  aoi21  g14(.a(new_n22_), .b(new_n35_), .c(new_n25_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n34_), .O(z1));
  inv1   g16(.a(x11), .O(new_n38_));
  oai21  g17(.a(x12), .b(new_n38_), .c(x04), .O(new_n39_));
  ...
  aoi21  g23(.a(x13), .b(x04), .c(new_n25_), .O(new_n45_));
