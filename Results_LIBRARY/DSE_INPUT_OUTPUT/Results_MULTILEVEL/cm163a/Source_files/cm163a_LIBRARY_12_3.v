...
module FAU ( 
  ...
  nand3  g18(.a(new_n39_), .b(new_n33_), .c(new_n26_), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n24_), .O(new_n41_));
  aoi21  g20(.a(new_n34_), .b(x12), .c(new_n41_), .O(new_n42_));
  inv1   g21(.a(x05), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  nor3   g23(.a(new_n44_), .b(x10), .c(new_n43_), .O(new_n45_));
  oai21  g24(.a(new_n42_), .b(new_n23_), .c(new_n45_), .O(z2));
  oai21  g25(.a(new_n40_), .b(new_n24_), .c(x13), .O(new_n47_));
