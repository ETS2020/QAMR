...
module FAU ( 
  ...
  nand4  g14(.a(new_n35_), .b(new_n32_), .c(new_n29_), .d(x05), .O(z0));
  oai21  g15(.a(x04), .b(x01), .c(x05), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  nand2  g17(.a(new_n27_), .b(x11), .O(new_n39_));
  nand4  g18(.a(new_n24_), .b(new_n34_), .c(x10), .d(new_n22_), .O(new_n40_));
  ...
  oai21  g23(.a(new_n44_), .b(new_n31_), .c(x11), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n33_), .O(new_n46_));
  nor2   g25(.a(x11), .b(x09), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n24_), .c(new_n44_), .O(new_n48_));
  nor4   g27(.a(new_n23_), .b(x12), .c(x11), .d(x09), .O(new_n49_));
  ...
  nand2  g35(.a(new_n44_), .b(new_n22_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n23_), .c(x13), .O(new_n58_));
  nor3   g37(.a(x13), .b(x12), .c(x11), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n26_), .c(x02), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(new_n33_), .O(new_n61_));
  ...
  oai21  g45(.a(new_n66_), .b(new_n65_), .c(new_n35_), .O(z4));
endmodule
