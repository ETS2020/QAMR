...
module FAU ( 
  ...
  nand4  g22(.a(new_n27_), .b(new_n43_), .c(new_n32_), .d(new_n25_), .O(new_n44_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n32_), .c(new_n25_), .O(new_n50_));
  ...
  aoi21  g38(.a(new_n37_), .b(x04), .c(new_n59_), .O(new_n60_));
