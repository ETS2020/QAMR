...
module FAU ( 
  ...
  nand4  g17(.a(new_n24_), .b(new_n38_), .c(new_n31_), .d(new_n22_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n29_), .O(new_n40_));
  nor2   g19(.a(x06), .b(x04), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(x00), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x05), .O(z2));
  nand3  g22(.a(new_n38_), .b(new_n31_), .c(new_n22_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n23_), .c(x13), .O(new_n45_));
  ...
  aoi21  g34(.a(x05), .b(new_n54_), .c(new_n55_), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(x14), .c(x10), .d(x08), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n46_), .O(z4));
endmodule
