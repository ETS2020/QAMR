...
module FAU ( 
  ...
  nand3  g14(.a(new_n26_), .b(new_n32_), .c(new_n23_), .O(new_n36_));
  ...
  nor2   g21(.a(new_n42_), .b(x09), .O(new_n43_));
  aoi22  g22(.a(new_n43_), .b(new_n26_), .c(new_n36_), .d(x12), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n27_), .c(new_n22_), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n27_), .c(new_n46_), .O(z2));
  nand2  g26(.a(x13), .b(x04), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x09), .O(new_n50_));
  oai21  g29(.a(new_n42_), .b(new_n25_), .c(x13), .O(new_n51_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n51_), .c(new_n27_), .O(new_n56_));
  ...
  aoi21  g39(.a(new_n23_), .b(new_n22_), .c(new_n60_), .O(new_n61_));
