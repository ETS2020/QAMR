...
module FAU ( 
  ...
  and2   g22(.a(new_n43_), .b(new_n41_), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n31_), .c(new_n38_), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n31_), .c(new_n46_), .O(z2));
  nor2   g26(.a(x13), .b(x12), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n33_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n23_), .c(x05), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x02), .O(new_n51_));
  nand3  g30(.a(new_n43_), .b(x13), .c(x04), .O(new_n52_));
  inv1   g31(.a(x07), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n31_), .O(new_n54_));
  ...
  inv1   g37(.a(x02), .O(new_n59_));
  inv1   g38(.a(x15), .O(new_n60_));
  aoi21  g39(.a(new_n38_), .b(new_n59_), .c(new_n60_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(x14), .c(x10), .d(x08), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(new_n58_), .O(z4));
endmodule
