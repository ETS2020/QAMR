...
module FAU ( 
  ...
  nor3   g21(.a(new_n42_), .b(new_n22_), .c(new_n30_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n29_), .c(new_n43_), .O(z2));
  inv1   g23(.a(x07), .O(new_n45_));
  inv1   g24(.a(x13), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n29_), .c(new_n45_), .O(new_n47_));
  aoi21  g26(.a(new_n40_), .b(new_n24_), .c(new_n46_), .O(new_n48_));
  inv1   g27(.a(x12), .O(new_n49_));
  nand3  g28(.a(new_n46_), .b(new_n49_), .c(new_n33_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n25_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n48_), .c(x04), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n47_), .c(x05), .O(z3));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  nand3  g33(.a(x15), .b(x14), .c(x10), .O(new_n55_));
  oai22  g34(.a(new_n55_), .b(new_n54_), .c(x13), .d(x07), .O(z4));
endmodule
