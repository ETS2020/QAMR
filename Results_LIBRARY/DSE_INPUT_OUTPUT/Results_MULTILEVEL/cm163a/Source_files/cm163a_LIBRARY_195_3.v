...
module FAU ( 
  ...
  and2   g00(.a(x08), .b(x07), .O(new_n22_));
  ...
  nor2   g26(.a(new_n22_), .b(new_n30_), .O(new_n48_));
  inv1   g27(.a(x07), .O(new_n49_));
  oai21  g28(.a(x08), .b(new_n49_), .c(new_n29_), .O(new_n50_));
  ...
  nand3  g36(.a(x08), .b(new_n49_), .c(x03), .O(new_n58_));
