...
module FAU ( 
  ...
  nand2  g17(.a(new_n34_), .b(new_n25_), .O(new_n39_));
  ...
  nand2  g21(.a(new_n42_), .b(new_n30_), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n22_), .c(x05), .O(new_n44_));
  inv1   g23(.a(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n41_), .b(new_n30_), .c(new_n45_), .O(z2));
  inv1   g25(.a(x07), .O(new_n47_));
  oai21  g26(.a(x12), .b(new_n47_), .c(new_n30_), .O(new_n48_));
  oai21  g27(.a(x13), .b(x07), .c(x12), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  aoi21  g29(.a(new_n34_), .b(new_n25_), .c(new_n50_), .O(new_n51_));
  inv1   g30(.a(x11), .O(new_n52_));
  inv1   g31(.a(x12), .O(new_n53_));
  nand3  g32(.a(new_n50_), .b(new_n53_), .c(new_n52_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n26_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n51_), .c(x04), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(new_n49_), .c(new_n48_), .d(x05), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n58_), .c(new_n22_), .O(z4));
endmodule
