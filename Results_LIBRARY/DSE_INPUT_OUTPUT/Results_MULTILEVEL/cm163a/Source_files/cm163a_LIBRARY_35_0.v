...
module FAU ( 
  ...
  nand3  g22(.a(new_n43_), .b(new_n35_), .c(new_n34_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(new_n45_));
  aoi21  g24(.a(new_n37_), .b(x12), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x06), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n22_), .c(new_n31_), .O(new_n48_));
  oai21  g27(.a(new_n46_), .b(new_n22_), .c(new_n48_), .O(z2));
  ...
  aoi21  g36(.a(new_n47_), .b(new_n31_), .c(new_n57_), .O(new_n58_));
