...
module FAU ( 
  ...
  aoi21  g19(.a(x14), .b(x04), .c(new_n22_), .O(new_n41_));
  nor3   g20(.a(x12), .b(x11), .c(x09), .O(new_n42_));
  aoi22  g21(.a(new_n42_), .b(new_n25_), .c(new_n35_), .d(x12), .O(new_n43_));
  inv1   g22(.a(x14), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x06), .O(new_n45_));
  aoi22  g24(.a(new_n45_), .b(new_n31_), .c(new_n22_), .d(new_n30_), .O(new_n46_));
  oai21  g25(.a(new_n43_), .b(new_n41_), .c(new_n46_), .O(z2));
  ...
  nand3  g33(.a(new_n54_), .b(new_n45_), .c(x05), .O(new_n55_));
