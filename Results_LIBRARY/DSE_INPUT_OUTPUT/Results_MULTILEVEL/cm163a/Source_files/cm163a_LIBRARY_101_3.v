...
module FAU ( 
  ...
  nor3   g16(.a(new_n37_), .b(x08), .c(new_n36_), .O(new_n38_));
  ...
  nand3  g25(.a(new_n26_), .b(x04), .c(x02), .O(new_n47_));
  ...
  nor3   g33(.a(new_n54_), .b(x08), .c(new_n36_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(z3));
  nand4  g35(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n36_), .c(new_n22_), .O(z4));
endmodule
