...
module FAU ( 
  ...
  aoi22  g19(.a(new_n40_), .b(new_n23_), .c(new_n35_), .d(x12), .O(new_n41_));
  nor2   g20(.a(x06), .b(x04), .O(new_n42_));
  nor3   g21(.a(new_n42_), .b(x13), .c(new_n27_), .O(new_n43_));
  ...
  nand4  g26(.a(new_n47_), .b(new_n46_), .c(new_n31_), .d(x05), .O(z3));
