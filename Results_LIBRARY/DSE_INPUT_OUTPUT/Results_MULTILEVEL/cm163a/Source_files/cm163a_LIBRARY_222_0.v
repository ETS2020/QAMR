...
module FAU ( 
  ...
  oai21  g16(.a(new_n31_), .b(new_n25_), .c(new_n37_), .O(z1));
  ...
  aoi22  g30(.a(new_n51_), .b(new_n50_), .c(new_n45_), .d(x13), .O(new_n52_));
  ...
  aoi21  g36(.a(new_n25_), .b(new_n30_), .c(new_n57_), .O(new_n58_));
