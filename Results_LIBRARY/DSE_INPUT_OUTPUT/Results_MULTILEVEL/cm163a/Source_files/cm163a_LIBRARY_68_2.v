...
module FAU ( 
  ...
  nand2  g20(.a(x07), .b(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n29_), .O(new_n43_));
  aoi21  g22(.a(x13), .b(x04), .c(new_n30_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n33_), .c(new_n43_), .O(z3));
  nand2  g24(.a(x08), .b(x03), .O(new_n46_));
  nand3  g25(.a(x15), .b(x14), .c(x10), .O(new_n47_));
  oai22  g26(.a(new_n47_), .b(new_n46_), .c(x11), .d(new_n29_), .O(z4));
endmodule
