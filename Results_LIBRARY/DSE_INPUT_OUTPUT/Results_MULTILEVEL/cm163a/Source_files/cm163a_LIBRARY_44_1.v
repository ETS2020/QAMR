...
module FAU ( 
  ...
  nand4  g24(.a(new_n45_), .b(new_n31_), .c(new_n30_), .d(x02), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(new_n27_), .O(new_n47_));
  nor2   g26(.a(x07), .b(x04), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n47_), .c(x03), .O(new_n49_));
  ...
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(x03), .O(z4));
endmodule
