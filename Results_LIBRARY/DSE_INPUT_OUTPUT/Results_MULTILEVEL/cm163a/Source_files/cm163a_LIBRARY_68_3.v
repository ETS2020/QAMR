...
module FAU ( 
  ...
  nand3  g30(.a(new_n51_), .b(new_n27_), .c(new_n25_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n50_), .c(new_n22_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n32_), .c(new_n29_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n49_), .O(z3));
  nand2  g34(.a(x08), .b(x03), .O(new_n56_));
  nand3  g35(.a(x15), .b(x14), .c(x10), .O(new_n57_));
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(new_n29_), .d(new_n22_), .O(z4));
endmodule
