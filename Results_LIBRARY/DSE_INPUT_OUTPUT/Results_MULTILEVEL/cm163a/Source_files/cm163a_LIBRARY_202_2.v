...
module FAU ( 
  ...
  nand2  g08(.a(x11), .b(x05), .O(new_n30_));
  ...
  aoi21  g13(.a(new_n25_), .b(x04), .c(new_n34_), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n33_), .c(x05), .O(z1));
  nand2  g15(.a(x12), .b(x04), .O(new_n37_));
  inv1   g16(.a(x06), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n29_), .O(new_n39_));
  nand4  g18(.a(new_n39_), .b(new_n37_), .c(x11), .d(x05), .O(z2));
  nor2   g19(.a(x07), .b(x04), .O(new_n41_));
  and2   g20(.a(x13), .b(x04), .O(new_n42_));
  ...
  aoi21  g25(.a(new_n33_), .b(x05), .c(new_n46_), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(x14), .c(x10), .d(x08), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n45_), .O(z4));
endmodule
