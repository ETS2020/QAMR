...
module FAU ( 
  ...
  nand2  g18(.a(new_n31_), .b(new_n22_), .O(new_n40_));
  ...
  aoi21  g22(.a(x06), .b(x05), .c(x00), .O(new_n44_));
  nor2   g23(.a(x11), .b(x06), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n23_), .O(new_n46_));
  nand3  g25(.a(x12), .b(x11), .c(x04), .O(new_n47_));
  oai21  g26(.a(x12), .b(x05), .c(new_n47_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n29_), .O(new_n49_));
  nand2  g28(.a(new_n38_), .b(x12), .O(new_n50_));
  inv1   g29(.a(x12), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n22_), .c(x03), .d(x02), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n50_), .c(new_n23_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n30_), .c(new_n31_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n49_), .c(new_n46_), .O(z2));
  inv1   g34(.a(x13), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n23_), .c(new_n29_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x11), .O(new_n58_));
  and2   g37(.a(new_n52_), .b(x13), .O(new_n59_));
  nand3  g38(.a(new_n56_), .b(new_n51_), .c(new_n31_), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n38_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  inv1   g41(.a(x07), .O(new_n63_));
  aoi21  g42(.a(new_n63_), .b(new_n23_), .c(new_n30_), .O(new_n64_));
  nand3  g43(.a(new_n64_), .b(new_n62_), .c(new_n58_), .O(z3));
  inv1   g44(.a(x03), .O(new_n66_));
  inv1   g45(.a(x08), .O(new_n67_));
  nand4  g46(.a(new_n35_), .b(x15), .c(x14), .d(x10), .O(new_n68_));
