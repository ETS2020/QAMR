...
module FAU ( 
  ...
  nor3   g15(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(new_n37_));
  oai21  g16(.a(new_n33_), .b(new_n22_), .c(new_n37_), .O(z1));
  nand3  g17(.a(new_n32_), .b(x03), .c(x02), .O(new_n39_));
  nor3   g18(.a(x12), .b(x11), .c(x09), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n31_), .c(new_n39_), .d(x12), .O(new_n41_));
  oai21  g20(.a(x06), .b(x04), .c(x13), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n34_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n22_), .c(new_n43_), .O(z2));
  nand2  g23(.a(new_n40_), .b(new_n31_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x04), .O(new_n46_));
  inv1   g25(.a(x07), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n22_), .c(new_n35_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n46_), .c(x05), .O(z3));
  inv1   g28(.a(x03), .O(new_n50_));
  inv1   g29(.a(x15), .O(new_n51_));
  aoi21  g30(.a(new_n35_), .b(x05), .c(new_n51_), .O(new_n52_));
