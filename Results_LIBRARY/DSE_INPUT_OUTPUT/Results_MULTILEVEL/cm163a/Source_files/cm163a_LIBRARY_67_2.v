...
module FAU ( 
  ...
  aoi22  g18(.a(new_n39_), .b(new_n26_), .c(new_n32_), .d(x12), .O(new_n40_));
  inv1   g19(.a(x06), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n22_), .c(new_n36_), .O(new_n42_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n22_), .c(new_n36_), .O(new_n50_));
