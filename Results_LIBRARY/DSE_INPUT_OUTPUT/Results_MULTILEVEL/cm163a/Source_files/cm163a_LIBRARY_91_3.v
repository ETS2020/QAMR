...
module FAU ( 
  ...
  oai21  g21(.a(new_n42_), .b(new_n30_), .c(new_n24_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n38_), .O(z2));
  ...
  nand2  g33(.a(x11), .b(x04), .O(new_n55_));
