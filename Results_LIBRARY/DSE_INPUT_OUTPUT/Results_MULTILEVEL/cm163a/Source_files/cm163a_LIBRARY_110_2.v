...
module FAU ( 
  ...
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(x15), .O(new_n42_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n40_), .c(new_n49_), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n48_), .c(new_n43_), .O(z2));
  inv1   g31(.a(x13), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n40_), .c(x15), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x11), .O(new_n55_));
  nor2   g34(.a(x12), .b(x09), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n23_), .c(new_n53_), .O(new_n57_));
  nand3  g36(.a(new_n53_), .b(new_n41_), .c(new_n28_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n24_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n57_), .c(x04), .O(new_n60_));
  inv1   g39(.a(x07), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n40_), .c(new_n49_), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n60_), .c(new_n55_), .O(z3));
  nand2  g42(.a(x08), .b(x03), .O(new_n64_));
  nand3  g43(.a(x15), .b(x14), .c(x10), .O(new_n65_));
  oai22  g44(.a(new_n65_), .b(new_n64_), .c(x15), .d(new_n28_), .O(z4));
endmodule
