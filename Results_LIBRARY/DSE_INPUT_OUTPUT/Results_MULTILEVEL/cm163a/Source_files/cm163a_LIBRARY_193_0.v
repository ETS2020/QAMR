...
module FAU ( 
  ...
  nand3  g12(.a(new_n24_), .b(new_n23_), .c(x04), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x13), .O(new_n35_));
  ...
  nand3  g18(.a(new_n39_), .b(new_n37_), .c(new_n36_), .O(z1));
  ...
  nand2  g23(.a(new_n25_), .b(x13), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n33_), .c(new_n44_), .O(new_n46_));
  nand3  g25(.a(x13), .b(new_n44_), .c(new_n33_), .O(new_n47_));
