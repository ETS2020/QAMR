...
module FAU ( 
  ...
  inv1   g20(.a(new_n38_), .O(new_n42_));
  ...
  nand3  g27(.a(new_n47_), .b(new_n37_), .c(new_n29_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n27_), .c(new_n26_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n22_), .c(new_n25_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n51_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  oai22  g35(.a(new_n56_), .b(new_n55_), .c(new_n26_), .d(new_n22_), .O(z4));
endmodule
