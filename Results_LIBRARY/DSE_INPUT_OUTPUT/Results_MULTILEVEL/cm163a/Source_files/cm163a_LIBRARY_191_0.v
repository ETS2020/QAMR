...
module FAU ( 
  ...
  nand3  g19(.a(new_n40_), .b(new_n34_), .c(new_n25_), .O(new_n41_));
  ...
  oai21  g25(.a(new_n41_), .b(new_n23_), .c(x13), .O(new_n47_));
  ...
  nand2  g33(.a(new_n54_), .b(new_n31_), .O(z3));
  nand2  g34(.a(x08), .b(x03), .O(new_n56_));
  nand3  g35(.a(x15), .b(x14), .c(x10), .O(new_n57_));
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x15), .d(x05), .O(z4));
endmodule
