...
module FAU ( 
  ...
  aoi22  g18(.a(new_n39_), .b(new_n32_), .c(new_n34_), .d(x12), .O(new_n40_));
  ...
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(x08), .d(new_n41_), .O(z4));
endmodule
