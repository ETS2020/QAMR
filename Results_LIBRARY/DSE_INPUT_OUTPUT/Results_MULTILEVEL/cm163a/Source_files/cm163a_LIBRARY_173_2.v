...
module FAU ( 
  ...
  nand4  g09(.a(new_n30_), .b(new_n27_), .c(x08), .d(x05), .O(z0));
  ...
  oai21  g22(.a(x06), .b(x04), .c(x08), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  oai21  g24(.a(new_n42_), .b(new_n29_), .c(new_n45_), .O(z2));
  oai21  g25(.a(new_n40_), .b(new_n23_), .c(x13), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n47_), .c(new_n29_), .O(new_n52_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x08), .d(new_n43_), .O(z4));
endmodule
