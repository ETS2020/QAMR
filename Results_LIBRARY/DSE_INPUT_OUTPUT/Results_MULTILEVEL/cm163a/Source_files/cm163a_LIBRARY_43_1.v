...
module FAU ( 
  ...
  and2   g16(.a(new_n32_), .b(x12), .O(new_n38_));
  ...
  nand4  g26(.a(new_n47_), .b(new_n31_), .c(new_n22_), .d(x03), .O(new_n48_));
  ...
  aoi21  g33(.a(x05), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(x14), .c(x10), .d(x08), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n24_), .O(z4));
endmodule
