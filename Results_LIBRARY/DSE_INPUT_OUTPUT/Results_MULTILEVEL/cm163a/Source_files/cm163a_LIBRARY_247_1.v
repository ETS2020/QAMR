...
module FAU ( 
  ...
  nor2   g20(.a(x09), .b(new_n41_), .O(new_n42_));
  nor3   g21(.a(x13), .b(x12), .c(x11), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n42_), .c(x02), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n40_), .c(x05), .d(x04), .O(z3));
  inv1   g24(.a(x05), .O(new_n46_));
  nand2  g25(.a(x08), .b(x03), .O(new_n47_));
  nand3  g26(.a(x15), .b(x14), .c(x10), .O(new_n48_));
  oai22  g27(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(x04), .O(z4));
endmodule
