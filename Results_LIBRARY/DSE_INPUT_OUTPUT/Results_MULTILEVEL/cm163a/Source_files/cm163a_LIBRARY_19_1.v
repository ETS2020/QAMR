...
module FAU ( 
  ...
  nand4  g20(.a(new_n24_), .b(new_n41_), .c(new_n35_), .d(new_n22_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n40_), .c(new_n31_), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(x01), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x05), .O(z2));
  nand3  g25(.a(new_n41_), .b(new_n35_), .c(new_n22_), .O(new_n47_));
