...
module FAU ( 
  ...
  oai21  g09(.a(new_n30_), .b(new_n25_), .c(x07), .O(new_n31_));
  ...
  nand3  g15(.a(new_n36_), .b(new_n33_), .c(x07), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(x04), .O(new_n38_));
  inv1   g17(.a(x01), .O(new_n39_));
  aoi21  g18(.a(new_n22_), .b(new_n39_), .c(new_n25_), .O(new_n40_));
  ...
  nand2  g24(.a(new_n45_), .b(x07), .O(new_n46_));
  ...
  inv1   g29(.a(new_n29_), .O(new_n51_));
  nor3   g30(.a(x13), .b(x12), .c(x11), .O(new_n52_));
  aoi22  g31(.a(new_n52_), .b(new_n51_), .c(new_n45_), .d(x13), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n25_), .O(new_n55_));
  oai21  g34(.a(new_n53_), .b(new_n22_), .c(new_n55_), .O(z3));
  inv1   g35(.a(x03), .O(new_n57_));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n54_), .b(x04), .c(new_n58_), .O(new_n59_));
