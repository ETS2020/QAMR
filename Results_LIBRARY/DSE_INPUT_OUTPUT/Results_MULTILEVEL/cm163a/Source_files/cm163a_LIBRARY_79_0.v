...
module FAU ( 
  ...
  nor2   g08(.a(x15), .b(x06), .O(new_n30_));
  nor3   g09(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(new_n31_));
  oai21  g10(.a(new_n27_), .b(new_n22_), .c(new_n31_), .O(z0));
  ...
  aoi21  g18(.a(new_n22_), .b(new_n39_), .c(new_n28_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n38_), .c(new_n30_), .O(z1));
  inv1   g20(.a(x06), .O(new_n42_));
  nand2  g21(.a(x15), .b(x04), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  aoi21  g24(.a(new_n35_), .b(new_n34_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n34_), .c(new_n24_), .O(new_n52_));
  nor3   g31(.a(x13), .b(x12), .c(x11), .O(new_n53_));
  aoi22  g32(.a(new_n53_), .b(new_n26_), .c(new_n52_), .d(x13), .O(new_n54_));
  nor2   g33(.a(x07), .b(x04), .O(new_n55_));
  nor3   g34(.a(new_n55_), .b(new_n30_), .c(new_n28_), .O(new_n56_));
  oai21  g35(.a(new_n54_), .b(new_n22_), .c(new_n56_), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(x15), .d(x06), .O(z4));
endmodule
