...
module FAU ( 
  ...
  nand3  g07(.a(new_n28_), .b(x04), .c(x00), .O(new_n29_));
  nand2  g08(.a(new_n29_), .b(x05), .O(z0));
  inv1   g09(.a(x04), .O(new_n31_));
  inv1   g10(.a(x11), .O(new_n32_));
  nand3  g11(.a(new_n24_), .b(new_n32_), .c(new_n22_), .O(new_n33_));
  ...
  nand3  g19(.a(new_n40_), .b(new_n32_), .c(new_n22_), .O(new_n41_));
  ...
  nor2   g23(.a(new_n44_), .b(new_n36_), .O(new_n45_));
  oai21  g24(.a(new_n43_), .b(new_n31_), .c(new_n45_), .O(z2));
  oai21  g25(.a(new_n41_), .b(new_n23_), .c(x13), .O(new_n47_));
  nor3   g26(.a(x13), .b(x12), .c(x11), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n26_), .c(x02), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n47_), .c(new_n31_), .O(new_n50_));
  ...
  aoi21  g33(.a(x05), .b(new_n36_), .c(new_n54_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(x14), .c(x10), .d(x08), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n25_), .O(z4));
endmodule
