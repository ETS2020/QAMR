...
module FAU ( 
  ...
  oai21  g06(.a(new_n27_), .b(x00), .c(x05), .O(z0));
  ...
  aoi21  g11(.a(new_n25_), .b(x11), .c(new_n32_), .O(new_n33_));
  ...
  inv1   g15(.a(new_n22_), .O(new_n37_));
  ...
  nor2   g19(.a(new_n40_), .b(x00), .O(new_n41_));
  ...
  nor2   g27(.a(new_n48_), .b(x00), .O(new_n49_));
