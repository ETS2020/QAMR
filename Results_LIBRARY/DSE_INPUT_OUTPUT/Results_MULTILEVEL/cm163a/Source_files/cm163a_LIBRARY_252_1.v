...
module FAU ( 
  ...
  aoi21  g18(.a(new_n27_), .b(x11), .c(new_n39_), .O(new_n40_));
  inv1   g19(.a(x01), .O(new_n41_));
  aoi21  g20(.a(new_n22_), .b(new_n41_), .c(new_n31_), .O(new_n42_));
  oai21  g21(.a(new_n40_), .b(new_n22_), .c(new_n42_), .O(z1));
  inv1   g22(.a(x12), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(new_n36_), .c(new_n35_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(new_n46_));
  aoi21  g25(.a(new_n38_), .b(x12), .c(new_n46_), .O(new_n47_));
  aoi21  g26(.a(new_n32_), .b(new_n22_), .c(new_n31_), .O(new_n48_));
  oai21  g27(.a(new_n47_), .b(new_n22_), .c(new_n48_), .O(z2));
  oai21  g28(.a(new_n45_), .b(new_n23_), .c(x13), .O(new_n50_));
  ...
  nand2  g34(.a(new_n55_), .b(new_n33_), .O(z3));
  inv1   g35(.a(x15), .O(new_n57_));
  aoi21  g36(.a(x06), .b(new_n31_), .c(new_n57_), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(x14), .c(x10), .d(x08), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n25_), .O(z4));
endmodule
