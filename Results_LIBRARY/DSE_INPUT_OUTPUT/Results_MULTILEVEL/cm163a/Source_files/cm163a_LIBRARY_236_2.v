...
module FAU ( 
  ...
  aoi22  g21(.a(new_n42_), .b(new_n36_), .c(new_n38_), .d(x12), .O(new_n43_));
  inv1   g22(.a(x06), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n22_), .c(new_n31_), .O(new_n45_));
