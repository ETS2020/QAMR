...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x06), .O(new_n28_));
  ...
  nand2  g11(.a(x11), .b(new_n32_), .O(new_n33_));
  ...
  oai21  g20(.a(x12), .b(x06), .c(x11), .O(new_n42_));
  ...
  nor2   g27(.a(x12), .b(x09), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n44_), .c(x04), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n47_), .c(new_n43_), .O(z2));
  inv1   g32(.a(x04), .O(new_n54_));
  inv1   g33(.a(x13), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n32_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x11), .O(new_n57_));
  aoi21  g36(.a(new_n49_), .b(new_n23_), .c(new_n55_), .O(new_n58_));
  nand3  g37(.a(new_n55_), .b(new_n45_), .c(new_n44_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n58_), .c(x04), .O(new_n61_));
  inv1   g40(.a(x07), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n54_), .c(new_n41_), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n61_), .c(new_n57_), .O(z3));
  inv1   g43(.a(x03), .O(new_n65_));
  inv1   g44(.a(x08), .O(new_n66_));
  nand4  g45(.a(new_n28_), .b(x15), .c(x14), .d(x10), .O(new_n67_));
