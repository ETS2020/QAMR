...
module FAU ( 
  ...
  nand3  g26(.a(new_n47_), .b(new_n33_), .c(new_n22_), .O(new_n48_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n23_), .c(new_n22_), .O(new_n52_));
  ...
  aoi21  g39(.a(x12), .b(new_n29_), .c(new_n60_), .O(new_n61_));
