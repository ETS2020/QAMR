...
module FAU ( 
  ...
  aoi21  g14(.a(new_n27_), .b(x04), .c(new_n35_), .O(new_n36_));
  oai21  g15(.a(new_n36_), .b(new_n22_), .c(new_n34_), .O(z1));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n23_), .c(new_n35_), .O(new_n52_));
  oai21  g31(.a(new_n50_), .b(new_n23_), .c(new_n52_), .O(z3));
  inv1   g32(.a(x03), .O(new_n54_));
  inv1   g33(.a(x15), .O(new_n55_));
  aoi21  g34(.a(new_n22_), .b(new_n35_), .c(new_n55_), .O(new_n56_));
