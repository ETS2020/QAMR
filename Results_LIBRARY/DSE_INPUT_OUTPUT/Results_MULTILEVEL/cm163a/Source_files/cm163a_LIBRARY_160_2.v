...
module FAU ( 
  ...
  nand2  g07(.a(x14), .b(x05), .O(new_n29_));
  ...
  oai21  g28(.a(x07), .b(x04), .c(x14), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  oai21  g30(.a(new_n48_), .b(new_n28_), .c(new_n51_), .O(z3));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  nand3  g32(.a(x15), .b(x14), .c(x10), .O(new_n54_));
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(x14), .d(new_n49_), .O(z4));
endmodule
