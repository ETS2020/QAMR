...
module FAU ( 
  ...
  oai21  g20(.a(new_n28_), .b(new_n22_), .c(new_n41_), .O(new_n42_));
  nand2  g21(.a(new_n35_), .b(x12), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(new_n31_), .c(new_n33_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n23_), .c(new_n43_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(x05), .c(x04), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n42_), .O(z2));
  oai21  g27(.a(new_n45_), .b(new_n23_), .c(x13), .O(new_n49_));
  ...
  nand2  g33(.a(new_n41_), .b(new_n28_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n54_), .O(z3));
  inv1   g35(.a(x15), .O(new_n57_));
  aoi21  g36(.a(x06), .b(new_n28_), .c(new_n57_), .O(new_n58_));
