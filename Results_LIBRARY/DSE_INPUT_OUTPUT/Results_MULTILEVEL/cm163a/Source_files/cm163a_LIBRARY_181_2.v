...
module FAU ( 
  ...
  nand2  g07(.a(new_n28_), .b(x12), .O(new_n29_));
  ...
  aoi21  g15(.a(new_n24_), .b(x11), .c(new_n36_), .O(new_n37_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n29_), .c(x05), .O(new_n45_));
  inv1   g24(.a(new_n45_), .O(new_n46_));
  oai21  g25(.a(new_n42_), .b(new_n33_), .c(new_n46_), .O(z2));
  aoi21  g26(.a(new_n28_), .b(x12), .c(x07), .O(new_n48_));
  nor2   g27(.a(new_n28_), .b(x05), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(new_n50_));
  inv1   g29(.a(x05), .O(new_n51_));
  oai21  g30(.a(new_n28_), .b(x13), .c(x12), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g32(.a(new_n35_), .b(x13), .O(new_n54_));
  nor2   g33(.a(x13), .b(x11), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n23_), .c(new_n22_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n54_), .c(x12), .O(new_n57_));
  nand3  g36(.a(x15), .b(x13), .c(x12), .O(new_n58_));
  inv1   g37(.a(new_n58_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n57_), .c(x04), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n53_), .c(new_n50_), .O(z3));
  nand4  g40(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(new_n28_), .O(z4));
endmodule
