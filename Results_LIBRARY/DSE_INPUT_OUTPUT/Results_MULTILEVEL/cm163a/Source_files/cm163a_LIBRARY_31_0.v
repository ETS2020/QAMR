...
module FAU ( 
  ...
  oai21  g01(.a(x09), .b(x06), .c(new_n22_), .O(new_n23_));
  inv1   g02(.a(x09), .O(new_n24_));
  and2   g03(.a(x03), .b(x02), .O(new_n25_));
  nand3  g04(.a(new_n25_), .b(new_n24_), .c(x06), .O(new_n26_));
  ...
  nand3  g09(.a(new_n25_), .b(new_n30_), .c(x04), .O(new_n31_));
  ...
  nand3  g18(.a(new_n39_), .b(new_n35_), .c(new_n33_), .O(z1));
  inv1   g19(.a(x06), .O(new_n41_));
  oai21  g20(.a(new_n24_), .b(new_n37_), .c(new_n41_), .O(new_n42_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n44_), .c(x09), .O(new_n47_));
  nand3  g26(.a(new_n30_), .b(x03), .c(x02), .O(new_n48_));
  ...
  nand3  g32(.a(new_n53_), .b(new_n47_), .c(new_n43_), .O(z2));
  inv1   g33(.a(x13), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n37_), .c(x09), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n41_), .O(new_n57_));
  aoi21  g36(.a(new_n50_), .b(new_n25_), .c(new_n55_), .O(new_n58_));
  nand3  g37(.a(new_n55_), .b(new_n45_), .c(new_n30_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n34_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n58_), .c(x04), .O(new_n61_));
  inv1   g40(.a(x07), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n37_), .c(new_n38_), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n61_), .c(new_n57_), .O(z3));
  nand2  g43(.a(x08), .b(x03), .O(new_n65_));
  nand3  g44(.a(x15), .b(x14), .c(x10), .O(new_n66_));
  oai22  g45(.a(new_n66_), .b(new_n65_), .c(x09), .d(x06), .O(z4));
endmodule
