...
module FAU ( 
  ...
  nand3  g14(.a(new_n25_), .b(x11), .c(x04), .O(new_n36_));
  ...
  nand4  g24(.a(new_n32_), .b(new_n24_), .c(x03), .d(x02), .O(new_n46_));
  ...
  nand4  g31(.a(new_n42_), .b(new_n24_), .c(x03), .d(x02), .O(new_n53_));
  nor3   g32(.a(x13), .b(x12), .c(x11), .O(new_n54_));
  aoi22  g33(.a(new_n54_), .b(new_n26_), .c(new_n53_), .d(x13), .O(new_n55_));
  ...
  aoi21  g39(.a(x09), .b(new_n29_), .c(new_n60_), .O(new_n61_));
