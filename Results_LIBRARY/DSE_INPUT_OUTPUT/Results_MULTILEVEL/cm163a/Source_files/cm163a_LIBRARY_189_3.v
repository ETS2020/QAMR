...
module FAU ( 
  ...
  nor3   g07(.a(new_n28_), .b(x12), .c(new_n27_), .O(new_n29_));
  ...
  nand4  g20(.a(new_n23_), .b(new_n34_), .c(new_n22_), .d(x04), .O(new_n42_));
  nand4  g21(.a(new_n42_), .b(new_n41_), .c(new_n31_), .d(x05), .O(z2));
  nor3   g22(.a(x13), .b(x11), .c(x09), .O(new_n44_));
  aoi22  g23(.a(new_n44_), .b(new_n23_), .c(new_n35_), .d(x13), .O(new_n45_));
  nor2   g24(.a(x07), .b(x04), .O(new_n46_));
  nor3   g25(.a(new_n46_), .b(x12), .c(new_n27_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n32_), .c(new_n47_), .O(z3));
