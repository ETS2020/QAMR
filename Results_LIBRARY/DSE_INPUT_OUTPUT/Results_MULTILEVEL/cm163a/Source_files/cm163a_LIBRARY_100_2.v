...
module FAU ( 
  ...
  nand2  g08(.a(x07), .b(x05), .O(new_n30_));
  ...
  nand3  g19(.a(new_n40_), .b(new_n33_), .c(new_n24_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n22_), .O(new_n42_));
  aoi21  g21(.a(new_n34_), .b(x12), .c(new_n42_), .O(new_n43_));
  inv1   g22(.a(x05), .O(new_n44_));
  oai21  g23(.a(x06), .b(x04), .c(x07), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  oai21  g25(.a(new_n43_), .b(new_n29_), .c(new_n46_), .O(z2));
  oai21  g26(.a(new_n41_), .b(new_n22_), .c(x13), .O(new_n48_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x07), .d(new_n44_), .O(z4));
endmodule
