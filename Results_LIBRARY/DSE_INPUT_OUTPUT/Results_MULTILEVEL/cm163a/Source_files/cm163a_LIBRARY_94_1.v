...
module FAU ( 
  ...
  oai21  g02(.a(x15), .b(new_n22_), .c(new_n23_), .O(new_n24_));
  ...
  oai21  g11(.a(x15), .b(new_n32_), .c(new_n23_), .O(new_n33_));
  ...
  oai21  g19(.a(x15), .b(new_n40_), .c(new_n23_), .O(new_n41_));
  ...
  nand3  g26(.a(new_n47_), .b(new_n41_), .c(x05), .O(z2));
  inv1   g27(.a(x07), .O(new_n49_));
  oai21  g28(.a(x15), .b(new_n49_), .c(new_n23_), .O(new_n50_));
  ...
  nand4  g38(.a(x10), .b(x08), .c(x04), .d(x03), .O(new_n60_));
