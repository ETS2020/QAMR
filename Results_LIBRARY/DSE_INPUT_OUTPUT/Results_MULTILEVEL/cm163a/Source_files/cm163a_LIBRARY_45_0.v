...
module FAU ( 
  ...
  nand2  g13(.a(new_n24_), .b(x04), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n25_), .c(x10), .O(new_n36_));
  ...
  oai21  g21(.a(new_n42_), .b(new_n31_), .c(x11), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n22_), .O(new_n44_));
  nor2   g23(.a(x11), .b(x09), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n26_), .c(new_n42_), .O(new_n46_));
  nand3  g25(.a(new_n42_), .b(new_n23_), .c(new_n24_), .O(new_n47_));
