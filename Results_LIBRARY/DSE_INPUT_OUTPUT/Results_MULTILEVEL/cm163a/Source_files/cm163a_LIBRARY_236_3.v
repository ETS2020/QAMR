...
module FAU ( 
  ...
  nand4  g13(.a(new_n34_), .b(new_n33_), .c(new_n26_), .d(x04), .O(new_n35_));
  ...
  nand4  g17(.a(new_n33_), .b(new_n26_), .c(x03), .d(x02), .O(new_n39_));
  nor3   g18(.a(x12), .b(x11), .c(x09), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n34_), .c(new_n39_), .d(x12), .O(new_n41_));
  oai21  g20(.a(x06), .b(x04), .c(x05), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(x01), .O(new_n43_));
  ...
  nor2   g29(.a(new_n50_), .b(x01), .O(new_n51_));
