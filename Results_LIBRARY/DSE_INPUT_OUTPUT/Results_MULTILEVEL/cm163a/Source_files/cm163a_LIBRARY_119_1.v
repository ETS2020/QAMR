...
module FAU ( 
  ...
  and2   g15(.a(x05), .b(x01), .O(new_n37_));
  oai21  g16(.a(new_n36_), .b(new_n22_), .c(new_n37_), .O(z1));
  nand2  g17(.a(new_n34_), .b(x12), .O(new_n39_));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  nand4  g19(.a(new_n40_), .b(new_n32_), .c(x03), .d(x02), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n39_), .c(new_n22_), .O(new_n42_));
  nor2   g21(.a(x06), .b(x04), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x01), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z2));
  inv1   g24(.a(x12), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n33_), .c(new_n32_), .O(new_n47_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x01), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(x05), .O(z3));
  inv1   g33(.a(x01), .O(new_n55_));
  ...
  nor2   g37(.a(new_n58_), .b(new_n25_), .O(z4));
endmodule
