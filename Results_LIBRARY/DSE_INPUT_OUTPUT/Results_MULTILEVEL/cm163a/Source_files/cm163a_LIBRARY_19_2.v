...
module FAU ( 
  ...
  nand2  g23(.a(new_n29_), .b(new_n32_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n44_), .O(z2));
  inv1   g25(.a(x12), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n34_), .c(new_n24_), .O(new_n48_));
  ...
  nand2  g35(.a(new_n56_), .b(new_n45_), .O(z3));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n29_), .b(x01), .c(new_n58_), .O(new_n59_));
