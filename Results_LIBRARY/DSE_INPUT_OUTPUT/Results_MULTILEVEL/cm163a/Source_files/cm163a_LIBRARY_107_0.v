...
module FAU ( 
  ...
  nor2   g00(.a(x14), .b(x06), .O(new_n22_));
  ...
  nand3  g20(.a(new_n41_), .b(new_n24_), .c(new_n23_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n40_), .c(new_n22_), .O(new_n43_));
  inv1   g22(.a(x14), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(x05), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n43_), .c(x04), .O(new_n46_));
  nor2   g25(.a(new_n44_), .b(x06), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n29_), .c(x06), .d(new_n30_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n46_), .O(z2));
  inv1   g28(.a(new_n25_), .O(new_n50_));
  nor3   g29(.a(x13), .b(x12), .c(x11), .O(new_n51_));
  aoi22  g30(.a(new_n51_), .b(new_n50_), .c(new_n42_), .d(x13), .O(new_n52_));
  nor2   g31(.a(x07), .b(x04), .O(new_n53_));
  nor3   g32(.a(new_n53_), .b(new_n22_), .c(new_n30_), .O(new_n54_));
  oai21  g33(.a(new_n52_), .b(new_n29_), .c(new_n54_), .O(z3));
