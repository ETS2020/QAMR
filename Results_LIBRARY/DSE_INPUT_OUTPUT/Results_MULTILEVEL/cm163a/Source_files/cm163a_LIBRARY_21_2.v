...
module FAU ( 
  ...
  nand2  g14(.a(x08), .b(x05), .O(new_n36_));
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x08), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z2));
  inv1   g24(.a(new_n26_), .O(new_n46_));
  nor3   g25(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n46_), .c(new_n41_), .d(x13), .O(new_n48_));
  inv1   g27(.a(x05), .O(new_n49_));
  oai21  g28(.a(x07), .b(x04), .c(x08), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  oai21  g30(.a(new_n48_), .b(new_n22_), .c(new_n51_), .O(z3));
