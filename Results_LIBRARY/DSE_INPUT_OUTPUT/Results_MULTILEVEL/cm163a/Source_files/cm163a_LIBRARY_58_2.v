...
module FAU ( 
  ...
  nand2  g18(.a(new_n23_), .b(x05), .O(new_n40_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n27_), .c(x04), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n25_), .c(new_n43_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n22_), .O(new_n47_));
  nand2  g26(.a(new_n37_), .b(new_n36_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(x12), .c(x04), .O(new_n49_));
  inv1   g28(.a(x06), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n32_), .c(new_n33_), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(z2));
  oai21  g31(.a(new_n22_), .b(new_n43_), .c(new_n32_), .O(new_n53_));
  nand2  g32(.a(x13), .b(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x12), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x07), .O(new_n56_));
  nand4  g35(.a(new_n36_), .b(new_n22_), .c(new_n44_), .d(new_n27_), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(x13), .c(x04), .O(new_n58_));
  inv1   g37(.a(new_n28_), .O(new_n59_));
  nor3   g38(.a(x13), .b(x12), .c(x11), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n59_), .c(new_n33_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(new_n58_), .c(new_n56_), .d(new_n53_), .O(z3));
