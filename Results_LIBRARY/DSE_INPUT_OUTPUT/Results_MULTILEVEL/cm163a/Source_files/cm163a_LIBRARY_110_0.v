...
module FAU ( 
  ...
  oai21  g07(.a(x15), .b(x11), .c(x05), .O(new_n29_));
  nor2   g08(.a(new_n29_), .b(new_n28_), .O(new_n30_));
  nand2  g09(.a(new_n30_), .b(new_n27_), .O(z0));
  inv1   g10(.a(x15), .O(new_n32_));
  oai21  g11(.a(new_n32_), .b(x11), .c(x09), .O(new_n33_));
  ...
  oai21  g22(.a(new_n43_), .b(new_n23_), .c(x15), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n35_), .O(new_n45_));
  nand4  g24(.a(new_n24_), .b(x15), .c(new_n35_), .d(new_n22_), .O(new_n46_));
  ...
  nor2   g38(.a(new_n32_), .b(x12), .O(new_n60_));
  nand4  g39(.a(new_n60_), .b(new_n59_), .c(new_n35_), .d(x02), .O(new_n61_));
  ...
  oai22  g46(.a(new_n67_), .b(new_n66_), .c(x15), .d(x11), .O(z4));
endmodule
