...
module FAU ( 
  ...
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(x13), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x05), .O(z2));
  nor2   g25(.a(x07), .b(x04), .O(new_n47_));
  aoi21  g26(.a(new_n42_), .b(x04), .c(new_n47_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n36_), .c(x05), .O(z3));
  nand2  g28(.a(x08), .b(x03), .O(new_n50_));
  nand3  g29(.a(x15), .b(x14), .c(x10), .O(new_n51_));
  oai22  g30(.a(new_n51_), .b(new_n50_), .c(x13), .d(new_n35_), .O(z4));
endmodule
