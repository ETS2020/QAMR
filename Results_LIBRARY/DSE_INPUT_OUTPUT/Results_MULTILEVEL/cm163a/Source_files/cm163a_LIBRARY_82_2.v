...
module FAU ( 
  ...
  nand4  g08(.a(new_n29_), .b(new_n26_), .c(x10), .d(x05), .O(z0));
  ...
  oai21  g19(.a(x06), .b(x04), .c(x10), .O(new_n41_));
  ...
  oai21  g26(.a(x07), .b(x04), .c(x10), .O(new_n48_));
  ...
  oai22  g31(.a(new_n52_), .b(new_n51_), .c(x10), .d(new_n40_), .O(z4));
endmodule
