...
module FAU ( 
  ...
  nand4  g27(.a(new_n47_), .b(new_n41_), .c(new_n33_), .d(new_n22_), .O(new_n49_));
  oai22  g28(.a(new_n49_), .b(new_n48_), .c(x07), .d(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x05), .O(new_n51_));
  aoi21  g30(.a(new_n42_), .b(x04), .c(new_n29_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n47_), .c(new_n51_), .O(z3));
  inv1   g32(.a(x03), .O(new_n54_));
  inv1   g33(.a(x15), .O(new_n55_));
  aoi21  g34(.a(new_n47_), .b(new_n29_), .c(new_n55_), .O(new_n56_));
