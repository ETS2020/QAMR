...
module FAU ( 
  ...
  aoi21  g17(.a(new_n33_), .b(new_n38_), .c(new_n29_), .O(new_n39_));
  ...
  nand3  g23(.a(new_n35_), .b(x12), .c(x04), .O(new_n45_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n50_), .c(x05), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n24_), .O(new_n54_));
  nand4  g33(.a(new_n41_), .b(new_n24_), .c(x03), .d(x02), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(x13), .c(x04), .O(new_n56_));
  inv1   g35(.a(x07), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n33_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n56_), .O(new_n59_));
