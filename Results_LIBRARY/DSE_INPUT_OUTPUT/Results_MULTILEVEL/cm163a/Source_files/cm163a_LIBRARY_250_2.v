// Benchmark "FAU" written by ABC on Thu Aug 13 15:20:22 2020
...
module FAU ( 
  ...
  nand2  g13(.a(new_n34_), .b(new_n26_), .O(new_n35_));
  ...
  aoi22  g18(.a(new_n39_), .b(new_n26_), .c(new_n35_), .d(x12), .O(new_n40_));
  ...
  nand4  g25(.a(new_n46_), .b(new_n25_), .c(x03), .d(x02), .O(new_n47_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n22_), .c(new_n41_), .O(new_n51_));
  oai21  g30(.a(new_n49_), .b(new_n22_), .c(new_n51_), .O(z3));
  inv1   g31(.a(x03), .O(new_n53_));
  inv1   g32(.a(x15), .O(new_n54_));
  aoi21  g33(.a(new_n41_), .b(x04), .c(new_n54_), .O(new_n55_));
