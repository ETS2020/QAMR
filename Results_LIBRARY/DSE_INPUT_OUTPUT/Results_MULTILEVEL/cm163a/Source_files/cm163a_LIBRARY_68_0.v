...
module FAU ( 
  ...
  nor2   g21(.a(new_n42_), .b(new_n22_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n41_), .c(x11), .O(new_n44_));
  nand2  g23(.a(new_n27_), .b(x12), .O(new_n45_));
  nor2   g24(.a(x12), .b(x11), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n26_), .c(new_n25_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x04), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n44_), .c(new_n32_), .O(z2));
  nor2   g29(.a(x07), .b(x04), .O(new_n51_));
  inv1   g30(.a(x13), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n22_), .O(new_n53_));
