...
module FAU ( 
  ...
  nand3  g19(.a(new_n40_), .b(new_n35_), .c(new_n25_), .O(new_n41_));
  ...
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n44_), .O(new_n46_));
  oai21  g25(.a(new_n43_), .b(new_n22_), .c(new_n46_), .O(z2));
  nand2  g26(.a(x07), .b(x05), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n22_), .O(new_n49_));
  oai21  g28(.a(new_n41_), .b(new_n26_), .c(x13), .O(new_n50_));
  ...
  aoi21  g37(.a(new_n44_), .b(x04), .c(new_n58_), .O(new_n59_));
