...
module FAU ( 
  ...
  inv1   g26(.a(new_n30_), .O(new_n48_));
  nand2  g27(.a(x08), .b(x07), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  inv1   g29(.a(x13), .O(new_n51_));
  aoi21  g30(.a(new_n41_), .b(new_n23_), .c(new_n51_), .O(new_n52_));
  inv1   g31(.a(x12), .O(new_n53_));
  nand3  g32(.a(new_n51_), .b(new_n53_), .c(new_n34_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n24_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n52_), .c(x04), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n50_), .c(new_n48_), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n58_), .c(new_n29_), .O(z4));
endmodule
