...
module FAU ( 
  ...
  nand3  g11(.a(new_n23_), .b(new_n22_), .c(x04), .O(new_n33_));
  ...
  nand3  g18(.a(new_n23_), .b(new_n32_), .c(new_n22_), .O(new_n40_));
  ...
  nand2  g34(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x05), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n50_), .O(z3));
  inv1   g37(.a(x03), .O(new_n59_));
  inv1   g38(.a(x15), .O(new_n60_));
  aoi21  g39(.a(x11), .b(new_n29_), .c(new_n60_), .O(new_n61_));
