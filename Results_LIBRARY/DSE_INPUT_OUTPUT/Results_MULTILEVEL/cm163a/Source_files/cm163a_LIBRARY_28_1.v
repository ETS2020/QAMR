...
module FAU ( 
  ...
  nand3  g21(.a(new_n42_), .b(new_n33_), .c(new_n24_), .O(new_n43_));
  nor3   g22(.a(x12), .b(x11), .c(x09), .O(new_n44_));
  aoi22  g23(.a(new_n44_), .b(new_n42_), .c(new_n43_), .d(x12), .O(new_n45_));
  inv1   g24(.a(x06), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n41_), .c(new_n29_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n41_), .c(new_n47_), .O(z2));
  nand3  g27(.a(x04), .b(x03), .c(x02), .O(new_n49_));
  nor2   g28(.a(x13), .b(x12), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n33_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n49_), .c(x05), .O(new_n52_));
  ...
  nand2  g36(.a(new_n57_), .b(new_n41_), .O(new_n58_));
  ...
  aoi21  g42(.a(x09), .b(new_n29_), .c(new_n63_), .O(new_n64_));
