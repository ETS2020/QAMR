...
module FAU ( 
  ...
  inv1   g30(.a(new_n26_), .O(new_n52_));
  nor2   g31(.a(x12), .b(x11), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n25_), .c(new_n24_), .O(new_n54_));
  ...
  nand3  g37(.a(new_n58_), .b(new_n22_), .c(x05), .O(new_n59_));
  inv1   g38(.a(new_n59_), .O(new_n60_));
  oai21  g39(.a(new_n56_), .b(new_n30_), .c(new_n60_), .O(z3));
  inv1   g40(.a(x13), .O(new_n62_));
  inv1   g41(.a(x14), .O(new_n63_));
  nand4  g42(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n64_));
  aoi21  g43(.a(new_n64_), .b(new_n62_), .c(new_n63_), .O(z4));
endmodule
