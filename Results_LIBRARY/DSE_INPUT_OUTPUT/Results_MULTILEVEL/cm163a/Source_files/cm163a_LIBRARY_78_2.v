...
module FAU ( 
  ...
  nand2  g07(.a(x08), .b(x05), .O(new_n29_));
  ...
  oai21  g20(.a(x06), .b(x04), .c(x08), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  oai21  g22(.a(new_n40_), .b(new_n28_), .c(new_n43_), .O(z2));
