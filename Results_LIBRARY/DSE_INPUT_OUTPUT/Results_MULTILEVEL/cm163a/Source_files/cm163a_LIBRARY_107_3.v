...
module FAU ( 
  ...
  nand2  g00(.a(x14), .b(x06), .O(new_n22_));
  ...
  aoi21  g21(.a(new_n42_), .b(x04), .c(new_n41_), .O(new_n43_));
  nor3   g22(.a(x12), .b(x11), .c(x09), .O(new_n44_));
  aoi22  g23(.a(new_n44_), .b(new_n25_), .c(new_n35_), .d(x12), .O(new_n45_));
  aoi22  g24(.a(new_n22_), .b(new_n31_), .c(new_n41_), .d(new_n30_), .O(new_n46_));
  oai21  g25(.a(new_n45_), .b(new_n43_), .c(new_n46_), .O(z2));
  inv1   g26(.a(new_n26_), .O(new_n48_));
  nor2   g27(.a(x12), .b(x11), .O(new_n49_));
  nand4  g28(.a(new_n49_), .b(new_n24_), .c(x03), .d(x02), .O(new_n50_));
  ...
  nand3  g33(.a(new_n54_), .b(new_n22_), .c(x05), .O(new_n55_));
  inv1   g34(.a(new_n55_), .O(new_n56_));
  oai21  g35(.a(new_n52_), .b(new_n30_), .c(new_n56_), .O(z3));
  inv1   g36(.a(x15), .O(new_n58_));
  nand4  g37(.a(x10), .b(x08), .c(new_n41_), .d(x03), .O(new_n59_));
  nor3   g38(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(z4));
endmodule
