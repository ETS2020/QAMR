...
module FAU ( 
  ...
  aoi21  g12(.a(new_n30_), .b(new_n26_), .c(new_n22_), .O(new_n34_));
  oai21  g13(.a(x04), .b(x01), .c(x05), .O(new_n35_));
  or2    g14(.a(new_n35_), .b(new_n34_), .O(z1));
  ...
  nand4  g26(.a(new_n47_), .b(new_n29_), .c(x03), .d(x02), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n46_), .c(new_n22_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n25_), .c(new_n26_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n45_), .O(z3));
  inv1   g30(.a(x03), .O(new_n52_));
  inv1   g31(.a(x08), .O(new_n53_));
  nand2  g32(.a(x11), .b(x04), .O(new_n54_));
