...
module FAU ( 
  ...
  nor3   g29(.a(new_n50_), .b(x08), .c(new_n36_), .O(new_n51_));
  oai21  g30(.a(new_n49_), .b(new_n23_), .c(new_n51_), .O(z3));
  inv1   g31(.a(x14), .O(new_n53_));
  inv1   g32(.a(x15), .O(new_n54_));
  nand4  g33(.a(x10), .b(x08), .c(new_n36_), .d(x03), .O(new_n55_));
