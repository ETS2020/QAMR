...
module FAU ( 
  ...
  nand3  g16(.a(x05), .b(new_n29_), .c(new_n37_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(z1));
  inv1   g18(.a(x12), .O(new_n40_));
  aoi21  g19(.a(new_n33_), .b(new_n24_), .c(new_n40_), .O(new_n41_));
  inv1   g20(.a(x11), .O(new_n42_));
  nand3  g21(.a(new_n40_), .b(new_n42_), .c(new_n22_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n23_), .c(x05), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n41_), .c(x04), .O(new_n45_));
  inv1   g24(.a(x06), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(x05), .c(new_n29_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n45_), .O(z2));
  inv1   g27(.a(x13), .O(new_n49_));
  nor3   g28(.a(x12), .b(x11), .c(x09), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n24_), .c(new_n49_), .O(new_n51_));
  ...
  nand3  g34(.a(new_n55_), .b(x05), .c(new_n29_), .O(new_n56_));
