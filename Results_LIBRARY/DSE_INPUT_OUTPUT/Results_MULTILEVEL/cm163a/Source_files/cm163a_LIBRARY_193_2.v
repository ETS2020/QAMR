...
module FAU ( 
  ...
  oai21  g20(.a(new_n41_), .b(new_n39_), .c(new_n30_), .O(new_n42_));
  oai21  g21(.a(new_n40_), .b(x12), .c(x11), .O(new_n43_));
  ...
  oai21  g31(.a(new_n40_), .b(x04), .c(x11), .O(new_n53_));
  and2   g32(.a(new_n47_), .b(x13), .O(new_n54_));
  nor3   g33(.a(x13), .b(x12), .c(x09), .O(new_n55_));
  and2   g34(.a(new_n55_), .b(new_n25_), .O(new_n56_));
  ...
  oai22  g41(.a(new_n62_), .b(new_n61_), .c(x13), .d(new_n22_), .O(z4));
endmodule
