...
module FAU ( 
  ...
  nand3  g11(.a(new_n32_), .b(new_n22_), .c(new_n26_), .O(new_n33_));
  ...
  aoi22  g19(.a(new_n40_), .b(new_n32_), .c(new_n33_), .d(x12), .O(new_n41_));
  inv1   g20(.a(x06), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n23_), .c(new_n37_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n23_), .c(new_n43_), .O(z2));
  ...
  nand2  g36(.a(new_n57_), .b(new_n47_), .O(z3));
