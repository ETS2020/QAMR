...
module FAU ( 
  ...
  nand2  g052(.a(x24), .b(new_n112_), .O(new_n136_));
  ...
  nand2  g059(.a(new_n142_), .b(new_n94_), .O(z14));
  ...
  nand2  g069(.a(new_n152_), .b(new_n94_), .O(z16));
  ...
  oai21  g081(.a(x31), .b(x10), .c(new_n93_), .O(new_n165_));
  nand3  g082(.a(x32), .b(new_n88_), .c(x09), .O(new_n166_));
  ...
  oai21  g099(.a(x37), .b(x10), .c(new_n93_), .O(new_n183_));
  nand3  g100(.a(x38), .b(new_n88_), .c(x09), .O(new_n184_));
  ...
  nand3  g113(.a(x41), .b(new_n99_), .c(x09), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z29));
  nand2  g115(.a(new_n192_), .b(x41), .O(new_n199_));
