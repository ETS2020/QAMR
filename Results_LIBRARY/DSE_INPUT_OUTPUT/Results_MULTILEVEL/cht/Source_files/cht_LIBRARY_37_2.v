...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x16), .O(new_n88_));
  ...
  nor2   g157(.a(new_n87_), .b(x14), .O(new_n241_));
  aoi22  g158(.a(new_n241_), .b(x09), .c(new_n213_), .d(x45), .O(new_n242_));
  oai21  g159(.a(new_n242_), .b(x10), .c(new_n88_), .O(z34));
  nand3  g160(.a(new_n108_), .b(new_n100_), .c(x09), .O(new_n244_));
