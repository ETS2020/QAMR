// Benchmark "FAU" written by ABC on Thu Aug 13 18:11:58 2020
...
module FAU ( 
  ...
  nand3  g043(.a(x21), .b(new_n91_), .c(new_n113_), .O(new_n127_));
  nand2  g044(.a(new_n127_), .b(new_n126_), .O(z10));
  oai21  g045(.a(x23), .b(x10), .c(x08), .O(new_n129_));
  nand3  g046(.a(x22), .b(new_n91_), .c(new_n113_), .O(new_n130_));
  ...
  nand3  g064(.a(x28), .b(new_n91_), .c(new_n113_), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(new_n147_), .O(z17));
  oai21  g066(.a(x30), .b(x10), .c(x08), .O(new_n150_));
  nand3  g067(.a(x29), .b(new_n91_), .c(new_n113_), .O(new_n151_));
  ...
  nand2  g083(.a(new_n166_), .b(new_n96_), .O(z22));
  ...
  nand2  g091(.a(new_n174_), .b(new_n96_), .O(z24));
  ...
  aoi21  g105(.a(new_n98_), .b(x09), .c(new_n182_), .O(new_n189_));
  nand3  g106(.a(x40), .b(new_n98_), .c(x09), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(new_n191_));
  oai21  g108(.a(new_n191_), .b(new_n189_), .c(new_n91_), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n96_), .O(z28));
  inv1   g110(.a(x40), .O(new_n194_));
  aoi21  g111(.a(new_n98_), .b(x09), .c(new_n194_), .O(new_n195_));
  nand3  g112(.a(x41), .b(new_n98_), .c(x09), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(new_n197_));
  oai21  g114(.a(new_n197_), .b(new_n195_), .c(new_n91_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n96_), .O(z29));
  inv1   g116(.a(x41), .O(new_n200_));
  aoi21  g117(.a(new_n98_), .b(x09), .c(new_n200_), .O(new_n201_));
  nand3  g118(.a(x42), .b(new_n98_), .c(x09), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(new_n203_));
  oai21  g120(.a(new_n203_), .b(new_n201_), .c(new_n91_), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(new_n96_), .O(z30));
  nand2  g122(.a(new_n98_), .b(x09), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(x42), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n98_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z31));
  inv1   g126(.a(x43), .O(new_n210_));
  aoi21  g127(.a(new_n98_), .b(x09), .c(new_n210_), .O(new_n211_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n96_), .O(z32));
  nand2  g132(.a(new_n206_), .b(x44), .O(new_n216_));
  nand3  g133(.a(x45), .b(new_n98_), .c(x09), .O(new_n217_));
