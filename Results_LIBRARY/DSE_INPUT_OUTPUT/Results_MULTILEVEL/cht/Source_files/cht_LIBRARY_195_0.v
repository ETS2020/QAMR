...
module FAU ( 
  ...
  nand3  g049(.a(new_n132_), .b(x23), .c(new_n84_), .O(new_n133_));
  inv1   g050(.a(new_n133_), .O(z10));
  nand3  g051(.a(x23), .b(new_n130_), .c(new_n111_), .O(new_n135_));
  and2   g052(.a(new_n135_), .b(new_n84_), .O(z11));
  aoi21  g053(.a(x24), .b(x08), .c(new_n97_), .O(new_n137_));
  aoi21  g054(.a(new_n137_), .b(x08), .c(x10), .O(z12));
  nand2  g055(.a(x24), .b(new_n111_), .O(new_n139_));
  nand2  g056(.a(x25), .b(x08), .O(new_n140_));
  nand3  g057(.a(new_n140_), .b(new_n139_), .c(x23), .O(new_n141_));
  ...
  nand3  g084(.a(new_n167_), .b(x23), .c(new_n84_), .O(new_n168_));
  ...
  nand3  g089(.a(new_n172_), .b(x23), .c(new_n84_), .O(new_n173_));
  ...
  nand3  g115(.a(new_n198_), .b(x23), .c(new_n84_), .O(new_n199_));
  ...
  aoi21  g121(.a(x38), .b(new_n175_), .c(new_n97_), .O(new_n205_));
  ...
  nand3  g126(.a(new_n209_), .b(x23), .c(new_n84_), .O(new_n210_));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(new_n97_), .O(new_n221_));
  ...
  nand3  g142(.a(new_n225_), .b(x23), .c(new_n84_), .O(new_n226_));
  ...
  nand3  g152(.a(new_n235_), .b(x23), .c(new_n84_), .O(new_n236_));
  ...
  nand3  g162(.a(new_n245_), .b(x23), .c(new_n84_), .O(new_n246_));
