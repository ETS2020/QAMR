...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n91_,
    ...
    new_n180_, new_n181_, new_n183_, new_n185_, new_n187_, new_n189_,
  ...
  nand3  g110(.a(new_n193_), .b(new_n84_), .c(x09), .O(new_n194_));
  ...
  nand2  g124(.a(x42), .b(new_n207_), .O(new_n208_));
  ...
  nand2  g128(.a(x43), .b(new_n207_), .O(new_n212_));
  ...
  nand2  g142(.a(x46), .b(new_n207_), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n225_), .c(x09), .O(new_n227_));
  and2   g144(.a(new_n227_), .b(new_n84_), .O(z34));
  nand2  g145(.a(new_n207_), .b(x00), .O(new_n229_));
