...
module FAU ( 
  ...
  nand2  g052(.a(new_n135_), .b(new_n89_), .O(z13));
  ...
  nand2  g057(.a(new_n140_), .b(new_n89_), .O(z14));
  ...
  nor2   g140(.a(x14), .b(new_n163_), .O(new_n224_));
  oai21  g141(.a(new_n224_), .b(x44), .c(x45), .O(new_n225_));
  nand2  g142(.a(new_n208_), .b(x44), .O(new_n226_));
  aoi21  g143(.a(new_n226_), .b(new_n225_), .c(x10), .O(z33));
  oai21  g144(.a(new_n224_), .b(x45), .c(x46), .O(new_n228_));
  nand2  g145(.a(new_n208_), .b(x45), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z34));
  inv1   g147(.a(x46), .O(new_n231_));
  aoi21  g148(.a(new_n196_), .b(x09), .c(new_n231_), .O(new_n232_));
