...
module FAU ( 
  ...
  nand3  g019(.a(new_n102_), .b(x17), .c(new_n84_), .O(new_n103_));
  inv1   g020(.a(new_n103_), .O(z03));
  inv1   g021(.a(x15), .O(new_n105_));
  nand2  g022(.a(x07), .b(x02), .O(new_n106_));
  oai21  g023(.a(new_n105_), .b(x07), .c(new_n106_), .O(new_n107_));
  nand3  g024(.a(new_n107_), .b(x17), .c(new_n84_), .O(new_n108_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n172_), .c(x17), .O(new_n174_));
  ...
  nand3  g117(.a(new_n200_), .b(x17), .c(new_n84_), .O(new_n201_));
  ...
  aoi21  g123(.a(x38), .b(new_n171_), .c(new_n97_), .O(new_n207_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(new_n97_), .O(new_n218_));
  ...
  aoi21  g139(.a(new_n222_), .b(x09), .c(new_n97_), .O(new_n223_));
  ...
  nand3  g144(.a(new_n227_), .b(x17), .c(new_n84_), .O(new_n228_));
  ...
  aoi21  g149(.a(new_n232_), .b(x09), .c(new_n97_), .O(new_n233_));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(new_n97_), .O(new_n238_));
  ...
  nand3  g159(.a(new_n242_), .b(x17), .c(new_n84_), .O(new_n243_));
  ...
  nand3  g164(.a(new_n247_), .b(x17), .c(new_n84_), .O(new_n248_));
