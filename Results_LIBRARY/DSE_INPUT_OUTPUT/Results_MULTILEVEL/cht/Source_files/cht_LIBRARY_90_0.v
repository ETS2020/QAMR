...
module FAU ( 
  ...
  nand3  g072(.a(new_n155_), .b(new_n95_), .c(x08), .O(new_n156_));
  ...
  nand3  g081(.a(new_n164_), .b(new_n95_), .c(x08), .O(new_n165_));
  ...
  nand3  g086(.a(new_n169_), .b(new_n95_), .c(x08), .O(new_n170_));
  ...
  nand3  g103(.a(new_n186_), .b(new_n95_), .c(x08), .O(new_n187_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n95_), .c(x08), .O(new_n192_));
  ...
  aoi21  g130(.a(new_n184_), .b(x00), .c(new_n86_), .O(new_n214_));
