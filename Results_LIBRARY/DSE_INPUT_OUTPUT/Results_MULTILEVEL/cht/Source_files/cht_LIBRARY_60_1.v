...
module FAU ( 
  ...
  oai21  g062(.a(x29), .b(x10), .c(new_n99_), .O(new_n146_));
  nand3  g063(.a(x30), .b(new_n94_), .c(x08), .O(new_n147_));
  ...
  nand2  g082(.a(new_n165_), .b(new_n100_), .O(z23));
  ...
  nand2  g086(.a(new_n169_), .b(new_n100_), .O(z24));
  ...
  nand2  g091(.a(new_n174_), .b(new_n100_), .O(z25));
  ...
  nand2  g106(.a(new_n189_), .b(new_n100_), .O(z28));
  ...
  nand2  g112(.a(new_n195_), .b(new_n100_), .O(z29));
  ...
  nand2  g122(.a(new_n205_), .b(new_n100_), .O(z31));
  ...
  nand2  g137(.a(new_n220_), .b(new_n100_), .O(z35));
endmodule
