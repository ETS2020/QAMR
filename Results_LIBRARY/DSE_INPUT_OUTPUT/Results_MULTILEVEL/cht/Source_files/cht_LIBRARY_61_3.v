...
module FAU ( 
  ...
  oai21  g026(.a(x18), .b(new_n109_), .c(x17), .O(new_n110_));
  nand2  g027(.a(x18), .b(x08), .O(new_n111_));
  aoi21  g028(.a(new_n111_), .b(new_n110_), .c(x10), .O(z06));
  oai21  g029(.a(x10), .b(new_n109_), .c(x18), .O(new_n113_));
  nand3  g030(.a(x19), .b(new_n84_), .c(x08), .O(new_n114_));
  ...
  nand2  g039(.a(new_n122_), .b(new_n89_), .O(z09));
  ...
  nand2  g066(.a(new_n149_), .b(new_n89_), .O(z16));
  ...
  nand2  g070(.a(new_n153_), .b(new_n89_), .O(z17));
  nand2  g071(.a(x29), .b(new_n109_), .O(new_n155_));
  nand2  g072(.a(x30), .b(x08), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z18));
  nand2  g074(.a(x08), .b(x00), .O(new_n158_));
  nand2  g075(.a(x30), .b(new_n109_), .O(new_n159_));
  ...
  aoi21  g111(.a(new_n98_), .b(x09), .c(new_n188_), .O(new_n195_));
  nand3  g112(.a(x40), .b(new_n98_), .c(x09), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(new_n197_));
  oai21  g114(.a(new_n197_), .b(new_n195_), .c(new_n84_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n89_), .O(z28));
  ...
  nand2  g140(.a(new_n223_), .b(new_n89_), .O(z34));
  nand2  g141(.a(new_n200_), .b(x46), .O(new_n225_));
