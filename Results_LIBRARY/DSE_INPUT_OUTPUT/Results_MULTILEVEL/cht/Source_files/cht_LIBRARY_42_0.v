...
module FAU ( 
  ...
  nand3  g020(.a(new_n103_), .b(x33), .c(new_n84_), .O(new_n104_));
  inv1   g021(.a(new_n104_), .O(z04));
  inv1   g022(.a(x16), .O(new_n106_));
  nand2  g023(.a(x07), .b(x03), .O(new_n107_));
  oai21  g024(.a(new_n106_), .b(x07), .c(new_n107_), .O(new_n108_));
  nand3  g025(.a(new_n108_), .b(x33), .c(new_n84_), .O(new_n109_));
  ...
  nand3  g034(.a(new_n117_), .b(x33), .c(new_n84_), .O(new_n118_));
  ...
  nand3  g084(.a(new_n167_), .b(x33), .c(new_n84_), .O(new_n168_));
  inv1   g085(.a(new_n168_), .O(z20));
  oai21  g086(.a(x32), .b(x09), .c(x33), .O(new_n170_));
  nor2   g087(.a(new_n170_), .b(x10), .O(z21));
  nor2   g088(.a(x34), .b(new_n92_), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(x09), .c(x10), .O(z22));
  inv1   g090(.a(x09), .O(new_n174_));
  nand2  g091(.a(x34), .b(new_n174_), .O(new_n175_));
  ...
  nand3  g107(.a(new_n190_), .b(x33), .c(new_n84_), .O(new_n191_));
  ...
  aoi21  g113(.a(x38), .b(new_n174_), .c(new_n92_), .O(new_n197_));
  ...
  nand3  g135(.a(new_n218_), .b(x33), .c(new_n84_), .O(new_n219_));
  ...
  nand3  g150(.a(new_n233_), .b(x33), .c(new_n84_), .O(new_n234_));
  ...
  nand3  g155(.a(new_n238_), .b(x33), .c(new_n84_), .O(new_n239_));
