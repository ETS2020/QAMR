...
module FAU ( 
  ...
  oai21  g041(.a(new_n85_), .b(new_n114_), .c(new_n124_), .O(new_n125_));
  ...
  nand2  g070(.a(new_n153_), .b(new_n86_), .O(z14));
  ...
  nand2  g084(.a(x30), .b(new_n85_), .O(new_n168_));
  nand3  g085(.a(new_n168_), .b(x29), .c(new_n114_), .O(new_n169_));
  nor2   g086(.a(new_n129_), .b(new_n85_), .O(new_n170_));
