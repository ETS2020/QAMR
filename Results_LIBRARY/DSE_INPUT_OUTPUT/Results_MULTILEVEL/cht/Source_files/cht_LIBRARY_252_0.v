...
module FAU ( 
  ...
  nand2  g104(.a(x39), .b(new_n98_), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n187_), .c(x09), .O(new_n189_));
  and2   g106(.a(new_n189_), .b(new_n89_), .O(z27));
  ...
  and2   g110(.a(new_n193_), .b(new_n89_), .O(z28));
  ...
  and2   g114(.a(new_n197_), .b(new_n89_), .O(z29));
