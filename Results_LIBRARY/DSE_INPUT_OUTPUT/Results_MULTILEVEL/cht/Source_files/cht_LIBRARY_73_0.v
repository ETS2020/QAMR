...
module FAU ( 
  ...
  oai21  g109(.a(new_n86_), .b(x09), .c(new_n85_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(x34), .O(new_n194_));
  ...
  aoi21  g133(.a(new_n103_), .b(x09), .c(new_n210_), .O(new_n217_));
  ...
  aoi21  g139(.a(new_n103_), .b(x09), .c(new_n222_), .O(new_n223_));
  ...
  nand3  g166(.a(x35), .b(new_n103_), .c(x09), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(new_n86_), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(x46), .O(new_n252_));
  oai21  g169(.a(x14), .b(new_n178_), .c(x45), .O(new_n253_));
