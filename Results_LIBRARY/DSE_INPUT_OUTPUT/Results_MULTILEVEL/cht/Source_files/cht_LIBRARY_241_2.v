...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x45), .O(new_n86_));
  ...
  oai21  g168(.a(new_n251_), .b(x45), .c(new_n84_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(new_n86_), .O(z34));
  oai21  g170(.a(x14), .b(new_n177_), .c(new_n85_), .O(new_n254_));
  aoi21  g171(.a(new_n101_), .b(x09), .c(new_n85_), .O(new_n255_));
  aoi21  g172(.a(new_n254_), .b(x00), .c(new_n255_), .O(new_n256_));
  oai21  g173(.a(new_n256_), .b(x10), .c(new_n86_), .O(z35));
endmodule
