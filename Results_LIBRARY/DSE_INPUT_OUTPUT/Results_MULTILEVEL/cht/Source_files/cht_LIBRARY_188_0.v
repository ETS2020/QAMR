...
module FAU ( 
  ...
  nand2  g049(.a(new_n132_), .b(new_n87_), .O(z09));
  ...
  oai21  g060(.a(new_n85_), .b(new_n115_), .c(new_n143_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n84_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n87_), .O(z12));
  aoi21  g063(.a(x25), .b(new_n85_), .c(x08), .O(new_n147_));
  nor2   g064(.a(new_n86_), .b(new_n115_), .O(new_n148_));
  oai21  g065(.a(new_n148_), .b(new_n147_), .c(new_n84_), .O(new_n149_));
  nand2  g066(.a(new_n149_), .b(new_n87_), .O(z13));
  nand2  g067(.a(x26), .b(x08), .O(new_n151_));
  oai21  g068(.a(new_n86_), .b(x08), .c(new_n151_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n84_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n87_), .O(z14));
  ...
  nand2  g079(.a(new_n162_), .b(new_n87_), .O(z16));
  ...
  nand2  g088(.a(new_n171_), .b(new_n87_), .O(z18));
