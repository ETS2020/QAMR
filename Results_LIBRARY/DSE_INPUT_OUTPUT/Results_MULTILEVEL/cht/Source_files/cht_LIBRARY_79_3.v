...
module FAU ( 
  ...
  nand2  g015(.a(x43), .b(x10), .O(new_n99_));
  ...
  nand2  g023(.a(new_n106_), .b(new_n94_), .O(new_n107_));
  nand2  g024(.a(new_n107_), .b(new_n99_), .O(z05));
  ...
  nand2  g029(.a(new_n112_), .b(new_n99_), .O(z06));
  ...
  nand2  g042(.a(new_n125_), .b(new_n99_), .O(z09));
  ...
  nand2  g055(.a(new_n138_), .b(new_n99_), .O(z12));
  ...
  nand2  g063(.a(new_n146_), .b(new_n99_), .O(z14));
  ...
  nand2  g067(.a(new_n150_), .b(new_n99_), .O(z15));
  ...
  nand2  g088(.a(x33), .b(new_n164_), .O(new_n172_));
  oai21  g089(.a(new_n171_), .b(new_n164_), .c(new_n172_), .O(new_n173_));
  ...
  nand2  g095(.a(new_n178_), .b(new_n99_), .O(z23));
  ...
  nand2  g103(.a(new_n186_), .b(new_n99_), .O(z25));
  ...
  oai21  g113(.a(new_n196_), .b(x10), .c(new_n99_), .O(z27));
  ...
  nand3  g124(.a(new_n198_), .b(x42), .c(new_n94_), .O(new_n208_));
  nor2   g125(.a(x14), .b(new_n164_), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(x10), .c(x43), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n208_), .O(z31));
  oai21  g128(.a(new_n209_), .b(x43), .c(x44), .O(new_n212_));
  nand2  g129(.a(new_n198_), .b(x43), .O(new_n213_));
  ...
  nand2  g143(.a(new_n198_), .b(x46), .O(new_n227_));
  nand2  g144(.a(new_n209_), .b(x00), .O(new_n228_));
