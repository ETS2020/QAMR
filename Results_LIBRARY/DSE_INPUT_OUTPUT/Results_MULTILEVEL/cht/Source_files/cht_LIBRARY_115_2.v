...
module FAU ( 
  ...
  aoi21  g128(.a(new_n203_), .b(x09), .c(new_n211_), .O(new_n212_));
  nand3  g129(.a(x42), .b(new_n203_), .c(x09), .O(new_n213_));
  ...
  nand3  g134(.a(x43), .b(new_n203_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z31));
  inv1   g136(.a(x43), .O(new_n220_));
  aoi21  g137(.a(new_n203_), .b(x09), .c(new_n220_), .O(new_n221_));
  nand3  g138(.a(x44), .b(new_n203_), .c(x09), .O(new_n222_));
  ...
  nand3  g143(.a(x45), .b(new_n203_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z33));
  inv1   g145(.a(x45), .O(new_n229_));
  aoi21  g146(.a(new_n203_), .b(x09), .c(new_n229_), .O(new_n230_));
  nand3  g147(.a(x46), .b(new_n203_), .c(x09), .O(new_n231_));
  ...
  aoi21  g152(.a(new_n203_), .b(x09), .c(new_n235_), .O(new_n236_));
  nand3  g153(.a(new_n203_), .b(x09), .c(x00), .O(new_n237_));
