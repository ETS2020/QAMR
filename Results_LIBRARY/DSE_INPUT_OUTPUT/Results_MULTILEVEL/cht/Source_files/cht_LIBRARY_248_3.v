...
module FAU ( 
  ...
  nand3  g091(.a(x32), .b(new_n84_), .c(new_n171_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(z21));
  oai21  g093(.a(x34), .b(x10), .c(x09), .O(new_n177_));
  nand3  g094(.a(x33), .b(new_n84_), .c(new_n171_), .O(new_n178_));
  ...
  nand3  g113(.a(x38), .b(new_n84_), .c(new_n171_), .O(new_n197_));
  ...
  oai22  g119(.a(new_n202_), .b(new_n171_), .c(new_n201_), .d(new_n199_), .O(z28));
  nand2  g120(.a(new_n193_), .b(x09), .O(new_n204_));
  ...
  nand3  g125(.a(x42), .b(new_n193_), .c(x09), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z30));
  inv1   g127(.a(x42), .O(new_n211_));
  aoi21  g128(.a(x43), .b(new_n193_), .c(x10), .O(new_n212_));
  oai22  g129(.a(new_n212_), .b(new_n171_), .c(new_n201_), .d(new_n211_), .O(z31));
  nand2  g130(.a(new_n204_), .b(x43), .O(new_n214_));
  ...
  oai22  g141(.a(new_n224_), .b(new_n171_), .c(new_n201_), .d(new_n223_), .O(z35));
endmodule
