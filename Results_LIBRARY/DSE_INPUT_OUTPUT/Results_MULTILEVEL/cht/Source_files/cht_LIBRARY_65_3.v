...
module FAU ( 
  ...
  aoi21  g131(.a(new_n204_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  nand3  g138(.a(x43), .b(new_n204_), .c(x09), .O(new_n222_));
  ...
  aoi21  g146(.a(new_n204_), .b(x09), .c(new_n229_), .O(new_n230_));
  ...
  nand3  g152(.a(x46), .b(new_n204_), .c(x09), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(new_n235_), .c(x10), .O(z34));
  nand2  g154(.a(new_n210_), .b(x46), .O(new_n238_));
  nand3  g155(.a(new_n204_), .b(x09), .c(x00), .O(new_n239_));
