...
module FAU ( 
  ...
  nand3  g032(.a(x18), .b(new_n84_), .c(new_n111_), .O(new_n116_));
  ...
  nand3  g041(.a(x21), .b(new_n84_), .c(new_n111_), .O(new_n125_));
  ...
  oai21  g084(.a(new_n166_), .b(new_n154_), .c(new_n167_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n84_), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n89_), .O(z23));
  ...
  nand2  g090(.a(new_n173_), .b(new_n89_), .O(z24));
  ...
  nand2  g103(.a(x38), .b(new_n154_), .O(new_n187_));
  ...
  aoi21  g111(.a(new_n189_), .b(x09), .c(new_n194_), .O(new_n195_));
  nand3  g112(.a(x41), .b(new_n189_), .c(x09), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(new_n197_));
  oai21  g114(.a(new_n197_), .b(new_n195_), .c(new_n84_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n89_), .O(z29));
  nand2  g116(.a(new_n190_), .b(x41), .O(new_n200_));
  nand3  g117(.a(x42), .b(new_n189_), .c(x09), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z30));
  nand2  g119(.a(new_n190_), .b(x42), .O(new_n203_));
  nand3  g120(.a(x43), .b(new_n189_), .c(x09), .O(new_n204_));
