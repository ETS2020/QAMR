...
module FAU ( 
  ...
  oai21  g104(.a(x10), .b(x09), .c(x36), .O(new_n188_));
  nand3  g105(.a(x35), .b(new_n84_), .c(new_n170_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n188_), .O(z24));
  oai21  g107(.a(x10), .b(new_n170_), .c(x36), .O(new_n191_));
  nand3  g108(.a(x37), .b(new_n84_), .c(x09), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n191_), .O(z25));
  ...
  aoi21  g126(.a(new_n204_), .b(x09), .c(new_n209_), .O(new_n210_));
  nand3  g127(.a(x41), .b(new_n204_), .c(x09), .O(new_n211_));
  ...
  nand3  g135(.a(x43), .b(new_n204_), .c(x09), .O(new_n219_));
  ...
  aoi21  g147(.a(new_n204_), .b(x09), .c(new_n230_), .O(new_n231_));
  nand3  g148(.a(x46), .b(new_n204_), .c(x09), .O(new_n232_));
  ...
  aoi21  g153(.a(new_n204_), .b(x09), .c(new_n236_), .O(new_n237_));
  nand3  g154(.a(new_n204_), .b(x09), .c(x00), .O(new_n238_));
