...
module FAU ( 
  ...
  nand2  g088(.a(new_n171_), .b(new_n94_), .O(z24));
  ...
  aoi21  g103(.a(new_n99_), .b(x09), .c(new_n180_), .O(new_n187_));
  nand3  g104(.a(x40), .b(new_n99_), .c(x09), .O(new_n188_));
  ...
  nand2  g120(.a(new_n203_), .b(new_n94_), .O(z31));
  ...
  nand2  g132(.a(new_n215_), .b(new_n94_), .O(z34));
  ...
  nand2  g138(.a(new_n221_), .b(new_n94_), .O(z35));
endmodule
