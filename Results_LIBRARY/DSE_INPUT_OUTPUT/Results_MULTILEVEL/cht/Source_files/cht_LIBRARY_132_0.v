...
module FAU ( 
  ...
  nand2  g104(.a(new_n187_), .b(new_n91_), .O(z20));
  ...
  nand2  g108(.a(new_n191_), .b(new_n91_), .O(z21));
  ...
  nand2  g113(.a(new_n196_), .b(new_n91_), .O(z22));
  nand2  g114(.a(x35), .b(x09), .O(new_n198_));
  oai21  g115(.a(new_n193_), .b(x09), .c(new_n198_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n91_), .c(new_n84_), .O(new_n200_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n91_), .O(z24));
  nand2  g123(.a(x37), .b(x09), .O(new_n207_));
  oai21  g124(.a(new_n202_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n91_), .c(new_n84_), .O(new_n209_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n91_), .O(z26));
  ...
  oai21  g136(.a(new_n219_), .b(new_n218_), .c(new_n91_), .O(new_n220_));
  ...
  oai21  g142(.a(new_n225_), .b(x10), .c(new_n91_), .O(z28));
  nor2   g143(.a(x14), .b(new_n183_), .O(new_n227_));
  oai21  g144(.a(new_n227_), .b(new_n89_), .c(new_n90_), .O(new_n228_));
  ...
  nand2  g148(.a(new_n222_), .b(new_n90_), .O(new_n232_));
  aoi21  g149(.a(new_n103_), .b(x09), .c(new_n90_), .O(new_n233_));
  aoi21  g150(.a(new_n232_), .b(x42), .c(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(x10), .c(new_n91_), .O(z30));
  ...
  oai21  g155(.a(new_n238_), .b(x10), .c(new_n91_), .O(z31));
  ...
  oai21  g159(.a(new_n242_), .b(x10), .c(new_n91_), .O(z32));
  ...
  oai21  g163(.a(new_n246_), .b(x10), .c(new_n91_), .O(z33));
