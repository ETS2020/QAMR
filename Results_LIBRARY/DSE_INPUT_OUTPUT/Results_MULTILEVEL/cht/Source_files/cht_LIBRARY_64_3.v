...
module FAU ( 
  ...
  nand2  g003(.a(x46), .b(x19), .O(new_n87_));
  ...
  nand3  g033(.a(new_n116_), .b(new_n87_), .c(new_n93_), .O(new_n117_));
  ...
  oai21  g038(.a(new_n121_), .b(x10), .c(new_n87_), .O(z07));
  inv1   g039(.a(x46), .O(new_n123_));
  inv1   g040(.a(x20), .O(new_n124_));
  nand2  g041(.a(new_n124_), .b(x08), .O(new_n125_));
  nand3  g042(.a(new_n125_), .b(new_n123_), .c(x19), .O(new_n126_));
  ...
  nand3  g048(.a(new_n131_), .b(new_n87_), .c(new_n93_), .O(new_n132_));
  ...
  nand3  g061(.a(new_n144_), .b(new_n87_), .c(new_n93_), .O(new_n145_));
  ...
  nand3  g089(.a(new_n172_), .b(new_n87_), .c(new_n93_), .O(new_n173_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n93_), .O(new_n201_));
  ...
  oai21  g162(.a(new_n245_), .b(x10), .c(new_n87_), .O(z33));
  nor2   g163(.a(new_n123_), .b(x14), .O(new_n247_));
  aoi22  g164(.a(new_n247_), .b(x09), .c(new_n218_), .d(x45), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(x10), .c(new_n87_), .O(z34));
  nand3  g166(.a(new_n123_), .b(new_n99_), .c(x09), .O(new_n250_));
  oai21  g167(.a(new_n123_), .b(x19), .c(new_n250_), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(x00), .O(new_n252_));
  nand3  g169(.a(new_n218_), .b(x46), .c(new_n127_), .O(new_n253_));
