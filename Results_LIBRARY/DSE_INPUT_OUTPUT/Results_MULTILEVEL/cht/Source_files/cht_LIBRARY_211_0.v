...
module FAU ( 
  ...
  nand3  g019(.a(new_n102_), .b(new_n89_), .c(x08), .O(new_n103_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n89_), .c(x08), .O(new_n143_));
  ...
  aoi21  g130(.a(new_n189_), .b(x00), .c(new_n86_), .O(new_n214_));
