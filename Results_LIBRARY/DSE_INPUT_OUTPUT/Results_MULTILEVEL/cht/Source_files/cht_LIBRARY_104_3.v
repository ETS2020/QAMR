...
module FAU ( 
  ...
  nand3  g031(.a(x17), .b(new_n91_), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g046(.a(x22), .b(new_n91_), .c(new_n114_), .O(new_n130_));
  ...
  nand3  g058(.a(x26), .b(new_n91_), .c(new_n114_), .O(new_n142_));
  ...
  nand3  g064(.a(x28), .b(new_n91_), .c(new_n114_), .O(new_n148_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n96_), .O(z26));
  ...
  aoi21  g104(.a(new_n98_), .b(x09), .c(new_n182_), .O(new_n188_));
  ...
  nand2  g108(.a(new_n191_), .b(new_n96_), .O(z28));
  ...
  nand2  g114(.a(new_n197_), .b(new_n96_), .O(z29));
  ...
  nand2  g133(.a(new_n216_), .b(new_n96_), .O(z33));
  ...
  nand2  g139(.a(new_n222_), .b(new_n96_), .O(z34));
