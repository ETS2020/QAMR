...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n97_), .c(x09), .O(new_n106_));
  ...
  and2   g084(.a(new_n167_), .b(new_n85_), .O(z17));
  ...
  aoi21  g091(.a(x30), .b(new_n113_), .c(x09), .O(new_n175_));
  ...
  aoi21  g101(.a(new_n184_), .b(new_n84_), .c(x10), .O(z23));
  ...
  nand2  g106(.a(new_n179_), .b(x37), .O(new_n190_));
