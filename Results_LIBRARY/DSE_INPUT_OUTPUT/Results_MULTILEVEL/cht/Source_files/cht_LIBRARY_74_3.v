...
module FAU ( 
  ...
  nand3  g028(.a(x18), .b(new_n91_), .c(new_n107_), .O(new_n112_));
  ...
  nand3  g040(.a(x22), .b(new_n91_), .c(new_n107_), .O(new_n124_));
  nand2  g041(.a(new_n124_), .b(new_n123_), .O(z11));
  oai21  g042(.a(x24), .b(x10), .c(x08), .O(new_n126_));
  nand3  g043(.a(x23), .b(new_n91_), .c(new_n107_), .O(new_n127_));
  nand2  g044(.a(new_n127_), .b(new_n126_), .O(z12));
  oai21  g045(.a(x25), .b(x10), .c(x08), .O(new_n129_));
  nand3  g046(.a(x24), .b(new_n91_), .c(new_n107_), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(new_n129_), .O(z13));
  oai21  g048(.a(x26), .b(x10), .c(x08), .O(new_n132_));
  nand3  g049(.a(x25), .b(new_n91_), .c(new_n107_), .O(new_n133_));
  ...
  nand2  g071(.a(new_n154_), .b(new_n96_), .O(z20));
  ...
  nand2  g075(.a(new_n158_), .b(new_n96_), .O(z21));
  ...
  nand2  g083(.a(new_n166_), .b(new_n96_), .O(z23));
  ...
  nand2  g087(.a(new_n170_), .b(new_n96_), .O(z24));
  ...
  nand2  g092(.a(new_n175_), .b(new_n96_), .O(z25));
  ...
  nand2  g096(.a(new_n179_), .b(new_n96_), .O(z26));
  ...
  nand2  g128(.a(new_n211_), .b(new_n96_), .O(z32));
  ...
  nand2  g143(.a(new_n226_), .b(new_n96_), .O(z35));
endmodule
