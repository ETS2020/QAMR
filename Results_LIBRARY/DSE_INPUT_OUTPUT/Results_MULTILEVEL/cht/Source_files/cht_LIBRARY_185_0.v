...
module FAU ( 
  ...
  nand2  g030(.a(new_n113_), .b(x21), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z09));
  nand2  g032(.a(new_n113_), .b(x22), .O(new_n116_));
  ...
  nand3  g094(.a(new_n177_), .b(new_n89_), .c(x08), .O(new_n178_));
  ...
  oai21  g126(.a(new_n174_), .b(new_n134_), .c(new_n209_), .O(new_n210_));
