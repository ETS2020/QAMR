...
module FAU ( 
  ...
  nand2  g039(.a(new_n122_), .b(new_n103_), .O(z08));
  ...
  nand2  g043(.a(new_n126_), .b(new_n103_), .O(z09));
  nand2  g044(.a(x21), .b(new_n115_), .O(new_n128_));
  ...
  nand2  g051(.a(new_n134_), .b(new_n103_), .O(z11));
  ...
  oai21  g057(.a(new_n139_), .b(new_n115_), .c(new_n140_), .O(new_n141_));
  nand2  g058(.a(new_n141_), .b(new_n97_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(new_n103_), .O(z13));
  ...
  nand2  g070(.a(new_n153_), .b(new_n97_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n103_), .O(z16));
  ...
  nand2  g086(.a(new_n169_), .b(new_n97_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n103_), .O(z20));
  ...
  nand2  g105(.a(new_n188_), .b(new_n103_), .O(z25));
  ...
  nand2  g113(.a(x38), .b(new_n172_), .O(new_n197_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n103_), .O(z31));
  ...
  nand2  g137(.a(new_n220_), .b(new_n103_), .O(z32));
  nand2  g138(.a(new_n200_), .b(x44), .O(new_n222_));
  nand3  g139(.a(x45), .b(new_n199_), .c(x09), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(new_n222_), .c(x10), .O(z33));
  inv1   g141(.a(x45), .O(new_n225_));
  aoi21  g142(.a(new_n199_), .b(x09), .c(new_n225_), .O(new_n226_));
  nand3  g143(.a(x46), .b(new_n199_), .c(x09), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(new_n228_));
  oai21  g145(.a(new_n228_), .b(new_n226_), .c(new_n97_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n103_), .O(z34));
