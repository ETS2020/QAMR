...
module FAU ( 
  ...
  nand2  g042(.a(new_n125_), .b(new_n94_), .O(z08));
  ...
  oai21  g071(.a(x28), .b(new_n112_), .c(x27), .O(new_n155_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n94_), .O(z30));
  ...
  nand2  g152(.a(new_n235_), .b(new_n94_), .O(z35));
endmodule
