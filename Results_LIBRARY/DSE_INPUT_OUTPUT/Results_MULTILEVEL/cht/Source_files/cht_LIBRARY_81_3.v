...
module FAU ( 
  ...
  nand2  g012(.a(x35), .b(x10), .O(new_n96_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n96_), .O(z21));
  ...
  oai21  g096(.a(new_n178_), .b(new_n160_), .c(new_n179_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n91_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n96_), .O(z25));
  ...
  nand2  g102(.a(new_n185_), .b(new_n96_), .O(z26));
  ...
  oai21  g109(.a(new_n192_), .b(x10), .c(new_n96_), .O(z27));
  ...
  nand2  g119(.a(new_n202_), .b(new_n96_), .O(z29));
  nand2  g120(.a(new_n194_), .b(x41), .O(new_n204_));
