...
module FAU ( 
  ...
  nand2  g005(.a(x10), .b(x00), .O(new_n89_));
  ...
  nand2  g032(.a(new_n115_), .b(new_n89_), .O(z06));
  ...
  nand2  g036(.a(new_n119_), .b(new_n89_), .O(z07));
  inv1   g037(.a(x20), .O(new_n121_));
  nand2  g038(.a(x19), .b(new_n111_), .O(new_n122_));
  ...
  nand2  g047(.a(x21), .b(new_n111_), .O(new_n131_));
  ...
  nand2  g065(.a(new_n148_), .b(new_n89_), .O(z14));
  ...
  nand2  g078(.a(new_n161_), .b(new_n89_), .O(z17));
  ...
  nand2  g083(.a(new_n166_), .b(new_n89_), .O(z18));
  oai21  g084(.a(x10), .b(x08), .c(x00), .O(new_n168_));
  nand3  g085(.a(x30), .b(new_n84_), .c(new_n111_), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n168_), .O(z19));
  ...
  nand2  g097(.a(x33), .b(new_n176_), .O(new_n181_));
  ...
  nand2  g106(.a(x35), .b(new_n176_), .O(new_n190_));
  ...
  nand2  g113(.a(new_n196_), .b(new_n89_), .O(z25));
  inv1   g114(.a(x38), .O(new_n198_));
  nand2  g115(.a(x37), .b(new_n176_), .O(new_n199_));
  ...
  oai21  g119(.a(new_n98_), .b(new_n176_), .c(new_n84_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(x00), .O(new_n204_));
  nor2   g121(.a(new_n198_), .b(x09), .O(new_n205_));
  nand3  g122(.a(x39), .b(new_n98_), .c(x09), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(new_n207_));
  oai21  g124(.a(new_n207_), .b(new_n205_), .c(new_n84_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n204_), .O(z27));
  inv1   g126(.a(x39), .O(new_n210_));
  aoi21  g127(.a(new_n98_), .b(x09), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(x40), .b(new_n98_), .c(x09), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(new_n213_));
  oai21  g130(.a(new_n213_), .b(new_n211_), .c(new_n84_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n89_), .O(z28));
  ...
  nand2  g137(.a(new_n220_), .b(new_n89_), .O(z29));
  nand2  g138(.a(new_n98_), .b(x09), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(x41), .O(new_n223_));
  nand3  g140(.a(x42), .b(new_n98_), .c(x09), .O(new_n224_));
  ...
  nand2  g147(.a(new_n230_), .b(new_n89_), .O(z31));
  nand2  g148(.a(new_n222_), .b(x43), .O(new_n232_));
  nand3  g149(.a(x44), .b(new_n98_), .c(x09), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n232_), .c(x10), .O(z32));
  nand2  g151(.a(new_n222_), .b(x44), .O(new_n235_));
  ...
  nand3  g156(.a(x46), .b(new_n98_), .c(x09), .O(new_n240_));
  ...
  inv1   g160(.a(x00), .O(new_n244_));
  aoi21  g161(.a(new_n98_), .b(x09), .c(x10), .O(new_n245_));
  nand3  g162(.a(new_n222_), .b(x46), .c(new_n84_), .O(new_n246_));
  oai21  g163(.a(new_n245_), .b(new_n244_), .c(new_n246_), .O(z35));
endmodule
