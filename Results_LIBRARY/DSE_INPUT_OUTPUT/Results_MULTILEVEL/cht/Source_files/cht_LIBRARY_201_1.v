...
module FAU ( 
  ...
  nand2  g037(.a(new_n120_), .b(new_n90_), .O(z07));
  ...
  oai21  g100(.a(new_n182_), .b(new_n178_), .c(new_n183_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n84_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n90_), .O(z22));
  ...
  aoi21  g125(.a(new_n207_), .b(x09), .c(new_n208_), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(x10), .c(new_n90_), .O(z27));
  aoi21  g127(.a(new_n99_), .b(x09), .c(new_n205_), .O(new_n211_));
  ...
  nand2  g147(.a(new_n230_), .b(new_n90_), .O(z31));
  ...
  nand3  g152(.a(x45), .b(new_n99_), .c(x09), .O(new_n236_));
