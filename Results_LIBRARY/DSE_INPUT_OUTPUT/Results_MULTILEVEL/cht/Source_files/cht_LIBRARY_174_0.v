...
module FAU ( 
  ...
  nand3  g033(.a(new_n116_), .b(x20), .c(new_n84_), .O(new_n117_));
  inv1   g034(.a(new_n117_), .O(z06));
  nand2  g035(.a(x19), .b(x08), .O(new_n119_));
  oai21  g036(.a(new_n114_), .b(x08), .c(new_n119_), .O(new_n120_));
  nand3  g037(.a(new_n120_), .b(x20), .c(new_n84_), .O(new_n121_));
  inv1   g038(.a(new_n121_), .O(z07));
  nor2   g039(.a(new_n92_), .b(x19), .O(new_n123_));
  aoi21  g040(.a(new_n123_), .b(new_n113_), .c(x10), .O(z08));
  nor2   g041(.a(x21), .b(new_n92_), .O(new_n125_));
  aoi21  g042(.a(new_n125_), .b(x08), .c(x10), .O(z09));
  nand2  g043(.a(x21), .b(new_n113_), .O(new_n127_));
  nand2  g044(.a(x22), .b(x08), .O(new_n128_));
  nand3  g045(.a(new_n128_), .b(new_n127_), .c(x20), .O(new_n129_));
  ...
  nand3  g132(.a(new_n215_), .b(x20), .c(new_n84_), .O(new_n216_));
  ...
  nand3  g152(.a(new_n235_), .b(x20), .c(new_n84_), .O(new_n236_));
  ...
  aoi21  g157(.a(new_n240_), .b(x09), .c(new_n92_), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n238_), .c(x10), .O(z34));
  nand2  g159(.a(new_n207_), .b(x46), .O(new_n243_));
  aoi21  g160(.a(new_n228_), .b(x00), .c(new_n92_), .O(new_n244_));
