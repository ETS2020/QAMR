...
module FAU ( 
  ...
  oai21  g039(.a(new_n121_), .b(new_n117_), .c(new_n122_), .O(new_n123_));
  ...
  oai21  g064(.a(x27), .b(new_n117_), .c(x26), .O(new_n148_));
  ...
  nand2  g071(.a(x28), .b(new_n117_), .O(new_n155_));
