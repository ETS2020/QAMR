...
module FAU ( 
  ...
  aoi21  g018(.a(new_n101_), .b(new_n85_), .c(x10), .O(z03));
  nand2  g019(.a(x07), .b(x02), .O(new_n103_));
  inv1   g020(.a(x07), .O(new_n104_));
  aoi21  g021(.a(x15), .b(new_n104_), .c(x14), .O(new_n105_));
  aoi21  g022(.a(new_n105_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g023(.a(x07), .b(x03), .O(new_n107_));
  aoi21  g024(.a(x16), .b(new_n104_), .c(x14), .O(new_n108_));
  ...
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n85_), .O(new_n165_));
  ...
  nand2  g122(.a(x38), .b(new_n177_), .O(new_n206_));
  nand2  g123(.a(x39), .b(x09), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n85_), .O(new_n208_));
  and2   g125(.a(new_n208_), .b(new_n84_), .O(z27));
  inv1   g126(.a(x39), .O(new_n210_));
  nand2  g127(.a(x40), .b(x09), .O(new_n211_));
  ...
  nand2  g132(.a(x41), .b(x09), .O(new_n216_));
  oai21  g133(.a(new_n215_), .b(x09), .c(new_n216_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n85_), .c(new_n84_), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(z29));
  nand2  g136(.a(x41), .b(new_n177_), .O(new_n220_));
  nand2  g137(.a(x42), .b(x09), .O(new_n221_));
  nand3  g138(.a(new_n221_), .b(new_n220_), .c(new_n85_), .O(new_n222_));
  and2   g139(.a(new_n222_), .b(new_n84_), .O(z30));
  inv1   g140(.a(x42), .O(new_n224_));
  nand2  g141(.a(x43), .b(x09), .O(new_n225_));
