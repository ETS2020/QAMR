...
module FAU ( 
  ...
  aoi21  g019(.a(x14), .b(new_n102_), .c(x41), .O(new_n103_));
  ...
  aoi21  g057(.a(x24), .b(x08), .c(x41), .O(new_n141_));
  ...
  aoi21  g065(.a(x26), .b(x08), .c(x41), .O(new_n149_));
  ...
  aoi21  g085(.a(x30), .b(new_n115_), .c(x41), .O(new_n169_));
  ...
  aoi21  g126(.a(new_n209_), .b(x09), .c(x41), .O(new_n210_));
  ...
  aoi21  g131(.a(new_n214_), .b(new_n85_), .c(x10), .O(z30));
  ...
  aoi21  g140(.a(new_n223_), .b(x09), .c(x41), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n221_), .c(x10), .O(z32));
  nand2  g142(.a(new_n206_), .b(x44), .O(new_n226_));
  inv1   g143(.a(x45), .O(new_n227_));
  nor2   g144(.a(new_n227_), .b(x14), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(x09), .c(x41), .O(new_n229_));
