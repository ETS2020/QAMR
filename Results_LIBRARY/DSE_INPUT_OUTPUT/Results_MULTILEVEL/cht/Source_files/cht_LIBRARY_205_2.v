...
module FAU ( 
  ...
  nand2  g046(.a(new_n129_), .b(new_n94_), .O(z10));
  ...
  nand2  g056(.a(x25), .b(new_n112_), .O(new_n140_));
  nand2  g057(.a(x26), .b(x08), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(new_n140_), .c(x10), .O(z14));
  nand2  g059(.a(x26), .b(new_n112_), .O(new_n143_));
  ...
  oai21  g070(.a(new_n152_), .b(new_n112_), .c(new_n153_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n88_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n94_), .O(z18));
  ...
  nand2  g076(.a(new_n159_), .b(new_n94_), .O(z19));
  ...
  nand2  g085(.a(x33), .b(new_n161_), .O(new_n169_));
  oai21  g086(.a(new_n168_), .b(new_n161_), .c(new_n169_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n88_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n94_), .O(z22));
  ...
  nand2  g092(.a(new_n175_), .b(new_n94_), .O(z23));
  inv1   g093(.a(x36), .O(new_n177_));
  nand2  g094(.a(x35), .b(new_n161_), .O(new_n178_));
  oai21  g095(.a(new_n177_), .b(new_n161_), .c(new_n178_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n88_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n94_), .O(z24));
  ...
  nand2  g101(.a(new_n184_), .b(new_n94_), .O(z25));
  inv1   g102(.a(x38), .O(new_n186_));
  nand2  g103(.a(x37), .b(new_n161_), .O(new_n187_));
  oai21  g104(.a(new_n186_), .b(new_n161_), .c(new_n187_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n88_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n94_), .O(z26));
  ...
  oai21  g112(.a(new_n195_), .b(x10), .c(new_n94_), .O(z27));
  nand2  g113(.a(new_n99_), .b(x09), .O(new_n197_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n94_), .O(z29));
  ...
  nand3  g127(.a(x43), .b(new_n99_), .c(x09), .O(new_n211_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n94_), .O(z33));
  nand2  g141(.a(new_n197_), .b(x45), .O(new_n225_));
  nand3  g142(.a(x46), .b(new_n99_), .c(x09), .O(new_n226_));
