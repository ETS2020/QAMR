...
module FAU ( 
  ...
  nor2   g025(.a(new_n87_), .b(x07), .O(new_n109_));
  ...
  oai21  g035(.a(new_n118_), .b(x10), .c(new_n89_), .O(z07));
  ...
  aoi21  g137(.a(new_n213_), .b(x40), .c(new_n220_), .O(new_n221_));
  ...
  nand3  g151(.a(new_n234_), .b(new_n89_), .c(new_n91_), .O(new_n235_));
  inv1   g152(.a(new_n235_), .O(z32));
  inv1   g153(.a(x45), .O(new_n237_));
  nor2   g154(.a(new_n237_), .b(x14), .O(new_n238_));
  aoi22  g155(.a(new_n238_), .b(x09), .c(new_n213_), .d(x44), .O(new_n239_));
  oai21  g156(.a(new_n239_), .b(x10), .c(new_n89_), .O(z33));
  nand2  g157(.a(new_n213_), .b(new_n237_), .O(new_n241_));
  aoi21  g158(.a(new_n101_), .b(x09), .c(new_n237_), .O(new_n242_));
  aoi21  g159(.a(new_n241_), .b(x46), .c(new_n242_), .O(new_n243_));
  oai21  g160(.a(new_n243_), .b(x10), .c(new_n89_), .O(z34));
  nand3  g161(.a(x16), .b(new_n101_), .c(x09), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n88_), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(x00), .O(new_n247_));
