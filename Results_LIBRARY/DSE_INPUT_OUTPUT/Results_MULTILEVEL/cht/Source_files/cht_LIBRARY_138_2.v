...
module FAU ( 
  ...
  nand3  g012(.a(new_n95_), .b(new_n84_), .c(new_n85_), .O(new_n96_));
  ...
  nand2  g086(.a(x30), .b(new_n116_), .O(new_n170_));
  nand3  g087(.a(new_n170_), .b(new_n169_), .c(new_n85_), .O(new_n171_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n84_), .c(new_n85_), .O(new_n198_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x05), .O(new_n220_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x05), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n222_), .c(x10), .O(z30));
  oai21  g143(.a(x14), .b(new_n173_), .c(x42), .O(new_n227_));
  nand3  g144(.a(x43), .b(new_n210_), .c(x09), .O(new_n228_));
  ...
  aoi21  g156(.a(new_n239_), .b(x09), .c(x05), .O(new_n240_));
  ...
  nand3  g166(.a(new_n249_), .b(new_n84_), .c(new_n85_), .O(new_n250_));
