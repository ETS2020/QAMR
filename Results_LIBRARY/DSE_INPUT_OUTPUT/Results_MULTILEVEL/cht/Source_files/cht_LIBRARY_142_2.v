...
module FAU ( 
  ...
  nor2   g106(.a(x35), .b(x09), .O(new_n190_));
  inv1   g107(.a(x35), .O(new_n191_));
  nor2   g108(.a(new_n87_), .b(new_n191_), .O(new_n192_));
  oai21  g109(.a(new_n192_), .b(new_n190_), .c(x34), .O(new_n193_));
  nand2  g110(.a(new_n192_), .b(x09), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z23));
  inv1   g112(.a(x36), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(x09), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(x42), .c(x35), .O(new_n198_));
  nand3  g115(.a(x36), .b(new_n191_), .c(x09), .O(new_n199_));
  ...
  nand2  g122(.a(x37), .b(new_n175_), .O(new_n206_));
  oai21  g123(.a(new_n205_), .b(new_n175_), .c(new_n206_), .O(new_n207_));
  ...
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(new_n175_), .O(new_n212_));
  ...
  nand2  g137(.a(new_n216_), .b(x40), .O(new_n221_));
  ...
  nor2   g142(.a(x14), .b(new_n175_), .O(new_n226_));
  oai21  g143(.a(new_n226_), .b(x35), .c(new_n87_), .O(new_n227_));
  ...
  nand2  g147(.a(new_n216_), .b(new_n87_), .O(new_n231_));
  aoi21  g148(.a(new_n100_), .b(x09), .c(new_n87_), .O(new_n232_));
  aoi21  g149(.a(new_n231_), .b(x43), .c(new_n232_), .O(new_n233_));
