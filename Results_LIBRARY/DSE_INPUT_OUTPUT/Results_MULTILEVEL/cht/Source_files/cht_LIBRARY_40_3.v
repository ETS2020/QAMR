...
module FAU ( 
  ...
  oai21  g053(.a(x10), .b(x08), .c(x25), .O(new_n137_));
  nand3  g054(.a(x24), .b(new_n84_), .c(new_n113_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n137_), .O(z13));
  oai21  g056(.a(x10), .b(new_n113_), .c(x25), .O(new_n140_));
  ...
  nand2  g089(.a(x33), .b(new_n168_), .O(new_n173_));
