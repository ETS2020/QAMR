...
module FAU ( 
  ...
  oai21  g108(.a(new_n190_), .b(new_n169_), .c(new_n191_), .O(new_n192_));
  ...
  nand2  g139(.a(new_n205_), .b(x09), .O(new_n223_));
  ...
  nand3  g145(.a(x44), .b(new_n205_), .c(x09), .O(new_n229_));
  ...
  nand2  g161(.a(new_n223_), .b(new_n89_), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(x00), .O(new_n246_));
  nand2  g163(.a(new_n223_), .b(x46), .O(new_n247_));
