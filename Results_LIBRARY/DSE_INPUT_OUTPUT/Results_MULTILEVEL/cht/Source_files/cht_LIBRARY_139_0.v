...
module FAU ( 
  ...
  nand2  g030(.a(new_n113_), .b(x19), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z07));
  nand2  g032(.a(new_n113_), .b(x20), .O(new_n116_));
  inv1   g033(.a(new_n116_), .O(z08));
  nand2  g034(.a(new_n113_), .b(x21), .O(new_n118_));
  inv1   g035(.a(new_n118_), .O(z09));
  nand2  g036(.a(new_n113_), .b(x22), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z10));
  inv1   g038(.a(x23), .O(new_n122_));
  aoi21  g039(.a(new_n122_), .b(x08), .c(x10), .O(z11));
  nand2  g040(.a(new_n113_), .b(x24), .O(new_n124_));
  inv1   g041(.a(new_n124_), .O(z12));
  nand2  g042(.a(new_n113_), .b(x25), .O(new_n126_));
  ...
  nand2  g048(.a(new_n113_), .b(x28), .O(new_n132_));
  ...
  nand3  g069(.a(new_n152_), .b(new_n89_), .c(x08), .O(new_n153_));
  ...
  aoi21  g092(.a(x38), .b(new_n140_), .c(new_n86_), .O(new_n176_));
  ...
  oai21  g120(.a(x14), .b(new_n140_), .c(x44), .O(new_n204_));
  ...
  oai21  g125(.a(x14), .b(new_n140_), .c(x45), .O(new_n209_));
  ...
  nor2   g131(.a(x14), .b(new_n140_), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(x00), .c(new_n86_), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n214_), .c(x10), .O(z35));
endmodule
