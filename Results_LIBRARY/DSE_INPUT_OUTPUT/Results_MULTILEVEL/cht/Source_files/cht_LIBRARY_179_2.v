...
module FAU ( 
  ...
  oai21  g020(.a(x15), .b(x07), .c(x02), .O(new_n104_));
  ...
  nand2  g048(.a(x22), .b(new_n117_), .O(new_n132_));
  ...
  oai21  g071(.a(new_n153_), .b(new_n117_), .c(new_n154_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n91_), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(new_n97_), .O(z17));
  ...
  nand2  g086(.a(new_n169_), .b(new_n97_), .O(z20));
  ...
  nand2  g090(.a(new_n173_), .b(new_n97_), .O(z21));
  ...
  nand2  g095(.a(new_n178_), .b(new_n97_), .O(z22));
  ...
  nand2  g099(.a(new_n182_), .b(new_n97_), .O(z23));
  ...
  nand2  g104(.a(new_n187_), .b(new_n97_), .O(z24));
  ...
  oai21  g110(.a(new_n192_), .b(new_n165_), .c(new_n193_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n91_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n97_), .O(z26));
  ...
  oai21  g118(.a(new_n201_), .b(x10), .c(new_n97_), .O(z27));
  aoi21  g119(.a(new_n99_), .b(x09), .c(new_n197_), .O(new_n203_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n97_), .O(z28));
  ...
  nand2  g136(.a(new_n219_), .b(new_n97_), .O(z31));
  ...
  nand3  g141(.a(x45), .b(new_n99_), .c(x09), .O(new_n225_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n97_), .O(z34));
