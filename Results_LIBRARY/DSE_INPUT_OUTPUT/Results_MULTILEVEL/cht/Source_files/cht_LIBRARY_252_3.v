...
module FAU ( 
  ...
  nand2  g064(.a(x25), .b(new_n128_), .O(new_n148_));
  ...
  nand2  g086(.a(x30), .b(new_n128_), .O(new_n170_));
  ...
  nand2  g098(.a(x34), .b(new_n172_), .O(new_n182_));
  ...
  nand3  g108(.a(x37), .b(new_n84_), .c(new_n172_), .O(new_n192_));
  ...
  nand3  g115(.a(x38), .b(new_n84_), .c(new_n172_), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n198_), .O(z27));
  nor2   g117(.a(x10), .b(x09), .O(new_n201_));
  nor2   g118(.a(new_n195_), .b(new_n172_), .O(new_n202_));
  oai21  g119(.a(new_n202_), .b(new_n201_), .c(x39), .O(new_n203_));
  inv1   g120(.a(x40), .O(new_n204_));
  oai21  g121(.a(new_n204_), .b(x14), .c(new_n84_), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(x09), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n203_), .O(z28));
  oai21  g124(.a(new_n202_), .b(new_n201_), .c(x40), .O(new_n208_));
  inv1   g125(.a(x41), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(x14), .c(new_n84_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(x09), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n208_), .O(z29));
  oai21  g129(.a(new_n202_), .b(new_n201_), .c(x41), .O(new_n213_));
  inv1   g130(.a(x42), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(x14), .c(new_n84_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(x09), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n213_), .O(z30));
  nand2  g134(.a(new_n195_), .b(x09), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(x42), .O(new_n219_));
  nand3  g136(.a(x43), .b(new_n195_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z31));
  oai21  g138(.a(new_n202_), .b(new_n201_), .c(x43), .O(new_n222_));
  inv1   g139(.a(x44), .O(new_n223_));
  oai21  g140(.a(new_n223_), .b(x14), .c(new_n84_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(x09), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n222_), .O(z32));
  oai21  g143(.a(new_n202_), .b(new_n201_), .c(x44), .O(new_n227_));
  inv1   g144(.a(x45), .O(new_n228_));
  oai21  g145(.a(new_n228_), .b(x14), .c(new_n84_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(x09), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n227_), .O(z33));
  oai21  g148(.a(new_n202_), .b(new_n201_), .c(x45), .O(new_n232_));
  inv1   g149(.a(x46), .O(new_n233_));
  oai21  g150(.a(new_n233_), .b(x14), .c(new_n84_), .O(new_n234_));
  nand2  g151(.a(new_n234_), .b(x09), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n232_), .O(z34));
  nand2  g153(.a(new_n218_), .b(x46), .O(new_n237_));
  nand3  g154(.a(new_n195_), .b(x09), .c(x00), .O(new_n238_));
