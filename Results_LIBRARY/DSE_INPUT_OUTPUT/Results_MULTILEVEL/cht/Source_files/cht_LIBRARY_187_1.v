...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n85_), .c(x44), .O(new_n96_));
  aoi21  g013(.a(new_n96_), .b(new_n95_), .c(x10), .O(z02));
  nand2  g014(.a(x07), .b(x01), .O(new_n98_));
  aoi21  g015(.a(x14), .b(new_n85_), .c(x44), .O(new_n99_));
  ...
  aoi21  g075(.a(x30), .b(x08), .c(x44), .O(new_n159_));
  ...
  aoi21  g093(.a(x34), .b(x09), .c(x44), .O(new_n177_));
  ...
  aoi21  g110(.a(x38), .b(x09), .c(x44), .O(new_n194_));
  ...
  aoi21  g116(.a(x38), .b(new_n166_), .c(x44), .O(new_n200_));
  ...
  nand2  g139(.a(new_n203_), .b(x09), .O(new_n223_));
  nand4  g140(.a(new_n223_), .b(new_n89_), .c(x43), .d(new_n88_), .O(new_n224_));
  inv1   g141(.a(new_n224_), .O(z32));
  inv1   g142(.a(x45), .O(new_n226_));
  nand4  g143(.a(new_n89_), .b(new_n203_), .c(new_n88_), .d(x09), .O(new_n227_));
  nor2   g144(.a(new_n227_), .b(new_n226_), .O(z33));
  ...
  nand3  g148(.a(new_n231_), .b(new_n89_), .c(new_n88_), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(z34));
  nand2  g150(.a(new_n223_), .b(x46), .O(new_n234_));
  nor2   g151(.a(x14), .b(new_n166_), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(x00), .c(x44), .O(new_n236_));
