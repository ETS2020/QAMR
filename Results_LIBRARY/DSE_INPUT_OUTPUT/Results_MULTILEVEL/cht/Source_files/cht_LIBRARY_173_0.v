...
module FAU ( 
  ...
  nand3  g030(.a(new_n113_), .b(x30), .c(new_n84_), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z06));
  inv1   g032(.a(x08), .O(new_n116_));
  nand2  g033(.a(x18), .b(new_n116_), .O(new_n117_));
  aoi21  g034(.a(x19), .b(x08), .c(new_n102_), .O(new_n118_));
  ...
  nand3  g054(.a(new_n137_), .b(x30), .c(new_n84_), .O(new_n138_));
  inv1   g055(.a(new_n138_), .O(z12));
  nand2  g056(.a(x24), .b(new_n116_), .O(new_n140_));
  aoi21  g057(.a(x25), .b(x08), .c(new_n102_), .O(new_n141_));
  ...
  aoi21  g069(.a(x28), .b(x08), .c(new_n102_), .O(new_n153_));
  ...
  nand3  g074(.a(new_n157_), .b(x30), .c(new_n84_), .O(new_n158_));
  inv1   g075(.a(new_n158_), .O(z17));
  nand3  g076(.a(x30), .b(new_n155_), .c(new_n116_), .O(new_n160_));
  and2   g077(.a(new_n160_), .b(new_n84_), .O(z18));
  nor3   g078(.a(new_n102_), .b(new_n116_), .c(x00), .O(new_n162_));
  nor2   g079(.a(new_n162_), .b(x10), .O(z19));
  ...
  nand3  g084(.a(new_n167_), .b(x30), .c(new_n84_), .O(new_n168_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n174_), .c(x30), .O(new_n176_));
  ...
  nand3  g101(.a(new_n184_), .b(x30), .c(new_n84_), .O(new_n185_));
  ...
  aoi21  g116(.a(x38), .b(new_n164_), .c(new_n102_), .O(new_n200_));
  ...
  nand3  g122(.a(new_n205_), .b(x30), .c(new_n84_), .O(new_n206_));
  ...
  nand3  g127(.a(new_n210_), .b(x30), .c(new_n84_), .O(new_n211_));
  ...
  nand3  g132(.a(new_n215_), .b(x30), .c(new_n84_), .O(new_n216_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(new_n102_), .O(new_n222_));
  ...
  nand3  g143(.a(new_n226_), .b(x30), .c(new_n84_), .O(new_n227_));
  ...
  nand3  g148(.a(new_n231_), .b(x30), .c(new_n84_), .O(new_n232_));
  ...
  aoi21  g157(.a(new_n240_), .b(x00), .c(new_n102_), .O(new_n241_));
