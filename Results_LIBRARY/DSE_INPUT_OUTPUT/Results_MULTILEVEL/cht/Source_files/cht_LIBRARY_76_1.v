...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n85_), .c(x33), .O(new_n106_));
  ...
  aoi21  g065(.a(x27), .b(x08), .c(x33), .O(new_n149_));
  ...
  aoi21  g077(.a(x30), .b(x08), .c(x33), .O(new_n161_));
  ...
  aoi21  g086(.a(x32), .b(x09), .c(x33), .O(new_n170_));
  ...
  nand4  g090(.a(x34), .b(new_n89_), .c(new_n88_), .d(x09), .O(new_n174_));
  inv1   g091(.a(new_n174_), .O(z22));
  nand2  g092(.a(x34), .b(new_n168_), .O(new_n176_));
  ...
  aoi21  g112(.a(x38), .b(new_n168_), .c(x33), .O(new_n196_));
  ...
  aoi21  g118(.a(new_n201_), .b(x09), .c(x33), .O(new_n202_));
  ...
  aoi21  g123(.a(new_n206_), .b(x09), .c(x33), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n204_), .c(x10), .O(z29));
  oai21  g125(.a(x14), .b(new_n168_), .c(x41), .O(new_n209_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x33), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x33), .O(new_n227_));
  ...
  nand2  g150(.a(new_n198_), .b(x46), .O(new_n234_));
  nor2   g151(.a(x14), .b(new_n168_), .O(new_n235_));
