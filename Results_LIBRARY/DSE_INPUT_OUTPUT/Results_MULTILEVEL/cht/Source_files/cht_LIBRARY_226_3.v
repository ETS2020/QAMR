...
module FAU ( 
  ...
  nand2  g009(.a(x16), .b(x10), .O(new_n93_));
  ...
  oai21  g022(.a(x16), .b(x07), .c(x03), .O(new_n106_));
  ...
  nand2  g081(.a(new_n164_), .b(new_n93_), .O(z20));
  ...
  nand2  g094(.a(x35), .b(new_n166_), .O(new_n178_));
  nand2  g095(.a(x36), .b(x09), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z24));
  nand2  g097(.a(x36), .b(new_n166_), .O(new_n181_));
  ...
  nand2  g104(.a(new_n187_), .b(new_n93_), .O(z26));
  ...
  aoi21  g137(.a(new_n195_), .b(x09), .c(new_n220_), .O(new_n221_));
