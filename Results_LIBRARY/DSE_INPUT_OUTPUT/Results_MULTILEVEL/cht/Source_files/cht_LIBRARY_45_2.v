...
module FAU ( 
  ...
  oai21  g058(.a(new_n89_), .b(x08), .c(new_n141_), .O(new_n142_));
  ...
  nand2  g070(.a(x27), .b(new_n114_), .O(new_n154_));
  ...
  aoi21  g119(.a(new_n102_), .b(x09), .c(new_n197_), .O(new_n203_));
  ...
  nand2  g124(.a(new_n102_), .b(x09), .O(new_n208_));
  ...
  nand3  g129(.a(x42), .b(new_n102_), .c(x09), .O(new_n213_));
  ...
  nand3  g139(.a(x44), .b(new_n102_), .c(x09), .O(new_n223_));
  ...
  nand3  g153(.a(new_n102_), .b(x09), .c(x00), .O(new_n237_));
