...
module FAU ( 
  ...
  nand2  g112(.a(new_n195_), .b(new_n89_), .O(z29));
  nand2  g113(.a(new_n187_), .b(x41), .O(new_n197_));
  nand3  g114(.a(x42), .b(new_n98_), .c(x09), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z30));
  nand2  g116(.a(new_n187_), .b(x42), .O(new_n200_));
