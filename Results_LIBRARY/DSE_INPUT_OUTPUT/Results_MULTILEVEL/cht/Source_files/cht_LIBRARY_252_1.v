...
module FAU ( 
  ...
  nand2  g065(.a(x25), .b(new_n129_), .O(new_n149_));
  ...
  nand2  g087(.a(x30), .b(new_n129_), .O(new_n171_));
  ...
  nand2  g104(.a(x36), .b(new_n89_), .O(new_n188_));
  nand2  g105(.a(x37), .b(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z25));
  oai21  g107(.a(x37), .b(x10), .c(new_n89_), .O(new_n191_));
  nand3  g108(.a(x38), .b(new_n84_), .c(x09), .O(new_n192_));
  ...
  nand2  g135(.a(new_n202_), .b(x09), .O(new_n219_));
  ...
  oai21  g139(.a(x43), .b(x10), .c(new_n89_), .O(new_n223_));
  nand2  g140(.a(x43), .b(x14), .O(new_n224_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n223_), .O(z32));
  oai21  g145(.a(x44), .b(x10), .c(new_n89_), .O(new_n229_));
  nand2  g146(.a(x44), .b(x14), .O(new_n230_));
  nand3  g147(.a(x45), .b(new_n202_), .c(x09), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n230_), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n84_), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(new_n229_), .O(z33));
  oai21  g151(.a(x45), .b(x10), .c(new_n89_), .O(new_n235_));
  ...
  nand2  g157(.a(new_n219_), .b(x46), .O(new_n241_));
