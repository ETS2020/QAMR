...
module FAU ( 
  ...
  nand2  g092(.a(x37), .b(new_n154_), .O(new_n176_));
  ...
  nand2  g099(.a(x38), .b(new_n154_), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z27));
  inv1   g101(.a(x14), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(x09), .c(new_n179_), .O(new_n186_));
  ...
  nand2  g106(.a(new_n189_), .b(new_n90_), .O(z28));
  ...
  aoi21  g115(.a(new_n185_), .b(x09), .c(new_n198_), .O(new_n199_));
  nand3  g116(.a(x43), .b(new_n185_), .c(x09), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(new_n201_));
  oai21  g118(.a(new_n201_), .b(new_n199_), .c(new_n84_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n90_), .O(z31));
  inv1   g120(.a(x43), .O(new_n204_));
  aoi21  g121(.a(new_n185_), .b(x09), .c(new_n204_), .O(new_n205_));
  nand3  g122(.a(x44), .b(new_n185_), .c(x09), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(new_n207_));
  oai21  g124(.a(new_n207_), .b(new_n205_), .c(new_n84_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n90_), .O(z32));
  nand2  g126(.a(new_n191_), .b(x44), .O(new_n210_));
  nand3  g127(.a(x45), .b(new_n185_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z33));
  nand2  g129(.a(new_n191_), .b(x45), .O(new_n213_));
  nand3  g130(.a(x46), .b(new_n185_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z34));
  inv1   g132(.a(x46), .O(new_n216_));
  aoi21  g133(.a(new_n185_), .b(x09), .c(new_n216_), .O(new_n217_));
  nand3  g134(.a(new_n185_), .b(x09), .c(x00), .O(new_n218_));
