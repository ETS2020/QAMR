...
module FAU ( 
  ...
  and2   g042(.a(new_n125_), .b(new_n85_), .O(z08));
  ...
  aoi21  g097(.a(new_n180_), .b(new_n84_), .c(x10), .O(z21));
  ...
  aoi21  g103(.a(new_n186_), .b(new_n84_), .c(x10), .O(z24));
  ...
  nand2  g108(.a(new_n177_), .b(x38), .O(new_n192_));
  ...
  aoi21  g123(.a(new_n206_), .b(new_n84_), .c(x10), .O(z34));
