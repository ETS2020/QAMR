...
module FAU ( 
  ...
  nand4  g030(.a(new_n89_), .b(x17), .c(new_n88_), .d(new_n113_), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z06));
  nand2  g032(.a(x19), .b(x08), .O(new_n116_));
  aoi21  g033(.a(new_n116_), .b(new_n89_), .c(x10), .O(z07));
  ...
  and2   g042(.a(new_n125_), .b(new_n88_), .O(z09));
  ...
  and2   g113(.a(new_n196_), .b(new_n88_), .O(z25));
  ...
  and2   g117(.a(new_n200_), .b(new_n88_), .O(z26));
  ...
  aoi21  g122(.a(x38), .b(new_n171_), .c(x18), .O(new_n206_));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(x18), .O(new_n238_));
  ...
  aoi21  g159(.a(new_n242_), .b(x09), .c(x18), .O(new_n243_));
  ...
  nand3  g164(.a(new_n247_), .b(new_n89_), .c(new_n88_), .O(new_n248_));
