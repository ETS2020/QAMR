...
module FAU ( 
  ...
  aoi21  g023(.a(x16), .b(new_n85_), .c(x28), .O(new_n107_));
  ...
  aoi21  g058(.a(x26), .b(x08), .c(x28), .O(new_n142_));
  ...
  nand4  g065(.a(new_n89_), .b(x27), .c(new_n88_), .d(new_n109_), .O(new_n149_));
  inv1   g066(.a(new_n149_), .O(z16));
  nand2  g067(.a(x29), .b(x08), .O(new_n151_));
  aoi21  g068(.a(new_n151_), .b(new_n89_), .c(x10), .O(z17));
  ...
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n89_), .O(new_n165_));
  and2   g082(.a(new_n165_), .b(new_n88_), .O(z20));
  ...
  and2   g100(.a(new_n183_), .b(new_n88_), .O(z24));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(x28), .O(new_n221_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x28), .O(new_n226_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x28), .O(new_n231_));
  ...
  aoi21  g155(.a(new_n233_), .b(x00), .c(x28), .O(new_n239_));
