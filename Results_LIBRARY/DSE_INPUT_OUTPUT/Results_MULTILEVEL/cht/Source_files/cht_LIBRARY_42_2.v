...
module FAU ( 
  ...
  nand2  g050(.a(new_n133_), .b(new_n94_), .O(z10));
  ...
  nand2  g075(.a(new_n158_), .b(new_n94_), .O(z17));
  ...
  oai21  g090(.a(new_n93_), .b(x09), .c(new_n173_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n88_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n94_), .O(z22));
  ...
  nand2  g097(.a(new_n180_), .b(new_n94_), .O(z23));
  ...
  aoi21  g114(.a(new_n101_), .b(x09), .c(new_n191_), .O(new_n198_));
  nand3  g115(.a(x40), .b(new_n101_), .c(x09), .O(new_n199_));
  ...
  nand3  g121(.a(x41), .b(new_n101_), .c(x09), .O(new_n205_));
