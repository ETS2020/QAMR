...
module FAU ( 
  ...
  nand3  g060(.a(new_n143_), .b(new_n89_), .c(x09), .O(new_n144_));
  ...
  nand3  g082(.a(new_n165_), .b(new_n89_), .c(x09), .O(new_n166_));
  ...
  nand3  g087(.a(new_n170_), .b(new_n89_), .c(x09), .O(new_n171_));
  inv1   g088(.a(new_n171_), .O(z18));
  nand2  g089(.a(x08), .b(x00), .O(new_n173_));
  aoi21  g090(.a(x30), .b(new_n123_), .c(new_n86_), .O(new_n174_));
  ...
  and2   g126(.a(new_n209_), .b(new_n89_), .O(z30));
  ...
  nand3  g135(.a(new_n218_), .b(new_n89_), .c(x09), .O(new_n219_));
  inv1   g136(.a(new_n219_), .O(z32));
  nand2  g137(.a(x44), .b(x14), .O(new_n221_));
  nand2  g138(.a(x45), .b(new_n207_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(x09), .O(new_n223_));
  and2   g140(.a(new_n223_), .b(new_n89_), .O(z33));
  inv1   g141(.a(x46), .O(new_n225_));
  nand2  g142(.a(x45), .b(x14), .O(new_n226_));
  oai21  g143(.a(new_n225_), .b(x14), .c(new_n226_), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n89_), .c(x09), .O(new_n228_));
  inv1   g145(.a(new_n228_), .O(z34));
  inv1   g146(.a(x00), .O(new_n230_));
  nand2  g147(.a(x46), .b(x14), .O(new_n231_));
  oai21  g148(.a(x14), .b(new_n230_), .c(new_n231_), .O(new_n232_));
  nand3  g149(.a(new_n232_), .b(new_n89_), .c(x09), .O(new_n233_));
