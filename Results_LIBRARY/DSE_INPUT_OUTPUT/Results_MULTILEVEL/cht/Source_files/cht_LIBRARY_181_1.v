...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n90_, new_n91_,
    ...
    new_n204_, new_n206_, new_n208_, new_n210_, new_n211_, new_n212_,
  ...
  aoi21  g012(.a(x13), .b(new_n85_), .c(x41), .O(new_n96_));
  ...
  aoi21  g020(.a(x15), .b(new_n85_), .c(x41), .O(new_n104_));
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  aoi21  g023(.a(x16), .b(new_n85_), .c(x41), .O(new_n107_));
  ...
  aoi21  g032(.a(x19), .b(x08), .c(x41), .O(new_n116_));
  ...
  aoi21  g044(.a(x22), .b(x08), .c(x41), .O(new_n128_));
  ...
  aoi21  g067(.a(x28), .b(x08), .c(x41), .O(new_n151_));
  ...
  aoi21  g107(.a(x38), .b(x09), .c(x41), .O(new_n191_));
  ...
  oai21  g114(.a(new_n197_), .b(new_n195_), .c(new_n89_), .O(new_n198_));
  ...
  nand4  g122(.a(new_n200_), .b(new_n89_), .c(x40), .d(new_n88_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z29));
  nand3  g124(.a(x42), .b(new_n98_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n89_), .c(x10), .O(z30));
  ...
  nand3  g142(.a(x46), .b(new_n98_), .c(x09), .O(new_n226_));
  ...
  inv1   g147(.a(new_n200_), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(x00), .c(x41), .O(new_n232_));
