...
module FAU ( 
  ...
  nand2  g005(.a(x28), .b(x10), .O(new_n89_));
  ...
  oai21  g068(.a(x28), .b(new_n113_), .c(x27), .O(new_n152_));
  nand2  g069(.a(x28), .b(x08), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(new_n152_), .c(x10), .O(z16));
  oai21  g071(.a(x10), .b(new_n113_), .c(x28), .O(new_n155_));
  nand3  g072(.a(x29), .b(new_n84_), .c(x08), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(new_n155_), .O(z17));
