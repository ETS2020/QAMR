...
module FAU ( 
  ...
  nand2  g012(.a(x17), .b(x10), .O(new_n96_));
  ...
  nand2  g047(.a(new_n130_), .b(new_n96_), .O(z11));
  ...
  nand2  g061(.a(x27), .b(new_n109_), .O(new_n145_));
  ...
  oai21  g066(.a(new_n148_), .b(new_n109_), .c(new_n149_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n91_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n96_), .O(z17));
  ...
  oai21  g110(.a(new_n193_), .b(x10), .c(new_n96_), .O(z27));
  ...
  nand2  g116(.a(new_n199_), .b(new_n96_), .O(z28));
  ...
  aoi21  g124(.a(new_n195_), .b(x09), .c(new_n207_), .O(new_n208_));
  ...
  nand2  g129(.a(new_n195_), .b(x09), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(x42), .O(new_n214_));
  nand3  g131(.a(x43), .b(new_n195_), .c(x09), .O(new_n215_));
  ...
  nand2  g138(.a(new_n221_), .b(new_n96_), .O(z32));
  ...
  nand2  g144(.a(new_n227_), .b(new_n96_), .O(z33));
