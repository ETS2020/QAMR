...
module FAU ( 
  ...
  inv1   g015(.a(x07), .O(new_n99_));
  aoi21  g016(.a(x14), .b(new_n99_), .c(x12), .O(new_n100_));
  aoi21  g017(.a(new_n100_), .b(new_n98_), .c(x10), .O(z03));
  ...
  aoi21  g024(.a(x16), .b(new_n99_), .c(x12), .O(new_n108_));
  ...
  aoi21  g124(.a(x38), .b(new_n173_), .c(x12), .O(new_n208_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x12), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n217_), .c(x10), .O(z29));
  nand2  g138(.a(new_n216_), .b(x41), .O(new_n222_));
  ...
  aoi21  g146(.a(new_n229_), .b(x09), .c(x12), .O(new_n230_));
  aoi21  g147(.a(new_n230_), .b(new_n227_), .c(x10), .O(z31));
  oai21  g148(.a(x14), .b(new_n173_), .c(x43), .O(new_n232_));
  nand3  g149(.a(x44), .b(new_n211_), .c(x09), .O(new_n233_));
  ...
  nand2  g158(.a(new_n216_), .b(x45), .O(new_n242_));
  inv1   g159(.a(x46), .O(new_n243_));
  nor2   g160(.a(new_n243_), .b(x14), .O(new_n244_));
  aoi21  g161(.a(new_n244_), .b(x09), .c(x12), .O(new_n245_));
  ...
  aoi21  g165(.a(new_n248_), .b(x00), .c(x12), .O(new_n249_));
