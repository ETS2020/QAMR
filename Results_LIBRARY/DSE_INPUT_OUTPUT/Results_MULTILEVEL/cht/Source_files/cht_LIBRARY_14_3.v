...
module FAU ( 
  ...
  oai21  g061(.a(x10), .b(x08), .c(x26), .O(new_n145_));
  nand3  g062(.a(x25), .b(new_n88_), .c(new_n111_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n145_), .O(z14));
  oai21  g064(.a(x27), .b(new_n111_), .c(x26), .O(new_n148_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n93_), .O(z21));
  ...
  nand2  g110(.a(new_n193_), .b(new_n93_), .O(z25));
  ...
  nand2  g114(.a(new_n197_), .b(new_n93_), .O(z26));
  ...
  aoi21  g121(.a(new_n98_), .b(x09), .c(new_n199_), .O(new_n205_));
  ...
  nand2  g125(.a(new_n208_), .b(new_n93_), .O(z28));
  ...
  nand2  g131(.a(new_n214_), .b(new_n93_), .O(z29));
  ...
  nand2  g151(.a(new_n216_), .b(x46), .O(new_n235_));
