...
module FAU ( 
  ...
  nand2  g109(.a(new_n101_), .b(x09), .O(new_n193_));
  ...
  aoi21  g114(.a(new_n101_), .b(x09), .c(new_n197_), .O(new_n198_));
  ...
  nand2  g118(.a(new_n201_), .b(new_n90_), .O(z29));
  ...
  nand2  g139(.a(new_n222_), .b(new_n90_), .O(z33));
