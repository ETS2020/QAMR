...
module FAU ( 
  ...
  nand2  g100(.a(x32), .b(new_n180_), .O(new_n184_));
  nand2  g101(.a(x33), .b(x09), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z21));
  oai21  g103(.a(x34), .b(x10), .c(x09), .O(new_n187_));
  nand3  g104(.a(x33), .b(new_n84_), .c(new_n180_), .O(new_n188_));
  ...
  aoi21  g127(.a(x40), .b(new_n100_), .c(x10), .O(new_n211_));
  oai22  g128(.a(new_n211_), .b(new_n180_), .c(new_n210_), .d(new_n208_), .O(z28));
  ...
  aoi21  g146(.a(x46), .b(new_n100_), .c(x10), .O(new_n230_));
  oai22  g147(.a(new_n230_), .b(new_n180_), .c(new_n210_), .d(new_n229_), .O(z34));
  inv1   g148(.a(x46), .O(new_n232_));
  aoi21  g149(.a(new_n100_), .b(x00), .c(x10), .O(new_n233_));
  oai22  g150(.a(new_n233_), .b(new_n180_), .c(new_n210_), .d(new_n232_), .O(z35));
endmodule
