...
module FAU ( 
  ...
  nand2  g117(.a(x42), .b(new_n191_), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n200_), .c(x09), .O(new_n202_));
  and2   g119(.a(new_n202_), .b(new_n84_), .O(z30));
