...
module FAU ( 
  ...
  oai21  g059(.a(x10), .b(x08), .c(x26), .O(new_n143_));
  nand3  g060(.a(x25), .b(new_n84_), .c(new_n113_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n143_), .O(z14));
  oai21  g062(.a(x10), .b(new_n113_), .c(x26), .O(new_n146_));
  nand3  g063(.a(x27), .b(new_n84_), .c(x08), .O(new_n147_));
  ...
  nand3  g137(.a(x45), .b(new_n199_), .c(x09), .O(new_n221_));
