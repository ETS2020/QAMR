...
module FAU ( 
  ...
  oai21  g043(.a(new_n125_), .b(new_n122_), .c(new_n126_), .O(new_n127_));
  nand3  g044(.a(new_n127_), .b(x19), .c(new_n84_), .O(new_n128_));
  ...
  nand3  g066(.a(new_n149_), .b(x19), .c(new_n84_), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z14));
  nand2  g068(.a(x26), .b(new_n122_), .O(new_n152_));
  nand2  g069(.a(x27), .b(x08), .O(new_n153_));
  nand3  g070(.a(new_n153_), .b(new_n152_), .c(x19), .O(new_n154_));
  and2   g071(.a(new_n154_), .b(new_n84_), .O(z15));
  nand2  g072(.a(x27), .b(new_n122_), .O(new_n156_));
  nand2  g073(.a(x28), .b(x08), .O(new_n157_));
  nand3  g074(.a(new_n157_), .b(new_n156_), .c(x19), .O(new_n158_));
  and2   g075(.a(new_n158_), .b(new_n84_), .O(z16));
  nand2  g076(.a(x28), .b(new_n122_), .O(new_n160_));
  nand2  g077(.a(x29), .b(x08), .O(new_n161_));
  nand3  g078(.a(new_n161_), .b(new_n160_), .c(x19), .O(new_n162_));
  and2   g079(.a(new_n162_), .b(new_n84_), .O(z17));
  nand2  g080(.a(x29), .b(new_n122_), .O(new_n164_));
  nand2  g081(.a(x30), .b(x08), .O(new_n165_));
  nand3  g082(.a(new_n165_), .b(new_n164_), .c(x19), .O(new_n166_));
  and2   g083(.a(new_n166_), .b(new_n84_), .O(z18));
  nand2  g084(.a(x08), .b(x00), .O(new_n168_));
  aoi21  g085(.a(x30), .b(new_n122_), .c(new_n102_), .O(new_n169_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n172_), .c(x19), .O(new_n174_));
  ...
  nand3  g099(.a(new_n182_), .b(x19), .c(new_n84_), .O(new_n183_));
  ...
  nand3  g152(.a(x45), .b(new_n208_), .c(x09), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(x19), .c(new_n84_), .O(new_n238_));
