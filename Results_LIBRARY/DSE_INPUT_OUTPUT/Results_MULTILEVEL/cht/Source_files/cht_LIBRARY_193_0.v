...
module FAU ( 
  ...
  nand3  g041(.a(new_n124_), .b(x12), .c(new_n84_), .O(new_n125_));
  ...
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(x12), .O(new_n133_));
  ...
  nand3  g058(.a(new_n141_), .b(x12), .c(new_n84_), .O(new_n142_));
  ...
  aoi21  g082(.a(x30), .b(new_n108_), .c(new_n91_), .O(new_n166_));
  ...
  nand3  g092(.a(new_n175_), .b(x12), .c(new_n84_), .O(new_n176_));
  ...
  nand3  g110(.a(new_n193_), .b(x12), .c(new_n84_), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z25));
  nand2  g112(.a(x37), .b(new_n168_), .O(new_n196_));
  nand2  g113(.a(x38), .b(x09), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(x12), .O(new_n198_));
  ...
  aoi21  g120(.a(x38), .b(new_n168_), .c(new_n91_), .O(new_n204_));
  ...
  nand3  g126(.a(new_n209_), .b(x12), .c(new_n84_), .O(new_n210_));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(new_n91_), .O(new_n216_));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(new_n91_), .O(new_n221_));
  ...
  nand3  g142(.a(new_n225_), .b(x12), .c(new_n84_), .O(new_n226_));
  ...
  aoi21  g157(.a(new_n240_), .b(x09), .c(new_n91_), .O(new_n241_));
  ...
  aoi21  g161(.a(new_n244_), .b(x00), .c(new_n91_), .O(new_n245_));
