...
module FAU ( 
  ...
  oai21  g087(.a(new_n170_), .b(x10), .c(new_n89_), .O(z18));
  ...
  oai21  g122(.a(new_n204_), .b(x09), .c(new_n205_), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n91_), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n89_), .O(z26));
  inv1   g125(.a(x00), .O(new_n209_));
  nand2  g126(.a(x46), .b(x14), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n87_), .c(new_n209_), .O(new_n211_));
  nor2   g128(.a(new_n87_), .b(x14), .O(new_n212_));
  oai21  g129(.a(new_n212_), .b(new_n211_), .c(x09), .O(new_n213_));
  nand3  g130(.a(new_n89_), .b(x38), .c(new_n176_), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z27));
  oai21  g132(.a(x14), .b(new_n176_), .c(new_n87_), .O(new_n216_));
  aoi21  g133(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n217_));
  aoi21  g134(.a(new_n216_), .b(x40), .c(new_n217_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(x10), .c(new_n89_), .O(z28));
  ...
  oai21  g147(.a(x14), .b(new_n176_), .c(x42), .O(new_n231_));
  nand3  g148(.a(x43), .b(new_n101_), .c(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n89_), .c(new_n91_), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(z31));
  oai21  g152(.a(x14), .b(new_n176_), .c(x43), .O(new_n236_));
  ...
  aoi21  g158(.a(new_n101_), .b(x09), .c(new_n241_), .O(new_n242_));
  nand3  g159(.a(x45), .b(new_n101_), .c(x09), .O(new_n243_));
  inv1   g160(.a(new_n243_), .O(new_n244_));
  oai21  g161(.a(new_n244_), .b(new_n242_), .c(new_n91_), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n89_), .O(z33));
  oai21  g163(.a(new_n217_), .b(x46), .c(x45), .O(new_n247_));
  nand3  g164(.a(x46), .b(new_n101_), .c(x09), .O(new_n248_));
  aoi21  g165(.a(new_n248_), .b(new_n247_), .c(x10), .O(z34));
  oai21  g166(.a(x14), .b(new_n176_), .c(new_n88_), .O(new_n250_));
  aoi21  g167(.a(new_n101_), .b(x09), .c(new_n88_), .O(new_n251_));
  aoi21  g168(.a(new_n250_), .b(x00), .c(new_n251_), .O(new_n252_));
  oai21  g169(.a(new_n252_), .b(x10), .c(new_n89_), .O(z35));
endmodule
