...
module FAU ( 
  ...
  nand2  g002(.a(x27), .b(new_n85_), .O(new_n86_));
  ...
  oai21  g019(.a(x27), .b(new_n102_), .c(new_n85_), .O(new_n103_));
  ...
  oai21  g036(.a(new_n119_), .b(x10), .c(new_n86_), .O(z06));
  ...
  oai21  g044(.a(new_n127_), .b(x10), .c(new_n86_), .O(z08));
  ...
  nand2  g140(.a(new_n223_), .b(new_n161_), .O(new_n224_));
  ...
  nand2  g147(.a(new_n230_), .b(new_n161_), .O(new_n231_));
  ...
  nand2  g151(.a(new_n234_), .b(new_n161_), .O(new_n235_));
  ...
  nand2  g156(.a(new_n239_), .b(new_n161_), .O(new_n240_));
  ...
  nand2  g163(.a(new_n246_), .b(new_n161_), .O(new_n247_));
  ...
  nand2  g167(.a(new_n250_), .b(new_n161_), .O(new_n251_));
  ...
  nand2  g172(.a(new_n255_), .b(new_n161_), .O(new_n256_));
