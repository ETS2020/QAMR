...
module FAU ( 
  ...
  nand2  g001(.a(x46), .b(x45), .O(new_n85_));
  ...
  nor2   g166(.a(x14), .b(x10), .O(new_n250_));
  aoi21  g167(.a(new_n250_), .b(x09), .c(x45), .O(new_n251_));
  nand2  g168(.a(new_n100_), .b(x09), .O(new_n252_));
  nand3  g169(.a(new_n252_), .b(x45), .c(new_n84_), .O(new_n253_));
  oai21  g170(.a(new_n251_), .b(new_n249_), .c(new_n253_), .O(z34));
  aoi21  g171(.a(new_n100_), .b(x09), .c(new_n249_), .O(new_n255_));
