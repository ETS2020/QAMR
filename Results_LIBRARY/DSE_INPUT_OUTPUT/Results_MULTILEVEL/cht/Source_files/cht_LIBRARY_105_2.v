...
module FAU ( 
  ...
  nand2  g042(.a(x19), .b(new_n121_), .O(new_n126_));
  oai21  g043(.a(new_n125_), .b(new_n121_), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g055(.a(x22), .b(new_n121_), .O(new_n139_));
  nand2  g056(.a(x23), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z11));
  inv1   g058(.a(x24), .O(new_n142_));
  nand2  g059(.a(x23), .b(new_n121_), .O(new_n143_));
  oai21  g060(.a(new_n142_), .b(new_n121_), .c(new_n143_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n84_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n90_), .O(z12));
  ...
  nand2  g068(.a(x25), .b(new_n121_), .O(new_n152_));
  oai21  g069(.a(new_n151_), .b(new_n121_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g075(.a(new_n158_), .b(new_n90_), .O(z15));
  nand2  g076(.a(x27), .b(new_n121_), .O(new_n160_));
  ...
  oai21  g081(.a(new_n163_), .b(new_n121_), .c(new_n164_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n84_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n90_), .O(z17));
  ...
  nand2  g125(.a(x38), .b(new_n177_), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z27));
  aoi21  g127(.a(new_n101_), .b(x09), .c(new_n205_), .O(new_n211_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n90_), .O(z30));
  ...
  nand2  g162(.a(new_n245_), .b(new_n90_), .O(z35));
endmodule
