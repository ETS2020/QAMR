...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n85_), .c(x28), .O(new_n104_));
  ...
  aoi21  g043(.a(x21), .b(x08), .c(x28), .O(new_n127_));
  ...
  aoi21  g051(.a(x23), .b(x08), .c(x28), .O(new_n135_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n92_), .c(new_n91_), .O(new_n149_));
  ...
  nand4  g071(.a(new_n92_), .b(x27), .c(new_n91_), .d(new_n111_), .O(new_n155_));
  inv1   g072(.a(new_n155_), .O(z16));
  nand4  g073(.a(x29), .b(new_n92_), .c(new_n91_), .d(x08), .O(new_n157_));
  ...
  nand3  g095(.a(new_n178_), .b(new_n177_), .c(new_n92_), .O(new_n179_));
  and2   g096(.a(new_n179_), .b(new_n91_), .O(z22));
  ...
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n92_), .O(new_n188_));
  and2   g105(.a(new_n188_), .b(new_n91_), .O(z24));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x28), .O(new_n215_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x28), .O(new_n220_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x28), .O(new_n225_));
  ...
  nand3  g146(.a(new_n229_), .b(new_n92_), .c(new_n91_), .O(new_n230_));
