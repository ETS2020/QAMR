...
module FAU ( 
  ...
  aoi21  g035(.a(x20), .b(x08), .c(x25), .O(new_n119_));
  ...
  and2   g058(.a(new_n141_), .b(new_n88_), .O(z15));
  ...
  and2   g071(.a(new_n154_), .b(new_n88_), .O(z18));
  ...
  and2   g086(.a(new_n169_), .b(new_n88_), .O(z21));
  ...
  and2   g094(.a(new_n177_), .b(new_n88_), .O(z23));
  nand2  g095(.a(x35), .b(new_n166_), .O(new_n179_));
  nand2  g096(.a(x36), .b(x09), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n89_), .O(new_n181_));
  and2   g098(.a(new_n181_), .b(new_n88_), .O(z24));
  ...
  and2   g102(.a(new_n185_), .b(new_n88_), .O(z25));
  ...
  aoi21  g119(.a(new_n202_), .b(x09), .c(x25), .O(new_n203_));
  ...
  aoi21  g124(.a(new_n207_), .b(x09), .c(x25), .O(new_n208_));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x25), .O(new_n213_));
  ...
  aoi21  g144(.a(new_n227_), .b(x09), .c(x25), .O(new_n228_));
  ...
  aoi21  g149(.a(new_n232_), .b(x09), .c(x25), .O(new_n233_));
  ...
  nand3  g153(.a(new_n236_), .b(new_n89_), .c(new_n88_), .O(new_n237_));
