...
module FAU ( 
  ...
  nand3  g038(.a(new_n121_), .b(new_n88_), .c(new_n90_), .O(new_n122_));
  ...
  nand3  g043(.a(new_n126_), .b(new_n88_), .c(new_n90_), .O(new_n127_));
  ...
  nand2  g056(.a(new_n139_), .b(new_n90_), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n88_), .O(z11));
  ...
  nand2  g065(.a(new_n148_), .b(new_n90_), .O(new_n149_));
  nand2  g066(.a(new_n149_), .b(new_n88_), .O(z13));
  oai21  g067(.a(x26), .b(new_n114_), .c(x25), .O(new_n151_));
  inv1   g068(.a(x31), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(x26), .c(x08), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(new_n151_), .c(x10), .O(z14));
  inv1   g071(.a(x27), .O(new_n155_));
  nand2  g072(.a(x26), .b(new_n114_), .O(new_n156_));
  oai21  g073(.a(new_n155_), .b(new_n114_), .c(new_n156_), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(new_n90_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n88_), .O(z15));
  ...
  nand2  g081(.a(x28), .b(new_n114_), .O(new_n165_));
  oai21  g082(.a(new_n164_), .b(new_n114_), .c(new_n165_), .O(new_n166_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n88_), .c(new_n90_), .O(new_n176_));
  inv1   g093(.a(new_n176_), .O(z19));
  nand2  g094(.a(x32), .b(x09), .O(new_n178_));
  oai21  g095(.a(new_n152_), .b(x09), .c(new_n178_), .O(new_n179_));
  ...
  nand2  g142(.a(new_n225_), .b(new_n90_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n88_), .O(z29));
  ...
  nand2  g152(.a(new_n235_), .b(new_n90_), .O(new_n236_));
  ...
  nand3  g167(.a(new_n250_), .b(new_n88_), .c(new_n90_), .O(new_n251_));
  ...
  nand2  g172(.a(new_n255_), .b(new_n90_), .O(new_n256_));
