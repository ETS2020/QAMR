...
module FAU ( 
  ...
  oai21  g095(.a(x32), .b(new_n178_), .c(x31), .O(new_n179_));
  nand3  g096(.a(x46), .b(x32), .c(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z20));
  inv1   g098(.a(x33), .O(new_n182_));
  nand2  g099(.a(x32), .b(new_n178_), .O(new_n183_));
  oai21  g100(.a(new_n182_), .b(new_n178_), .c(new_n183_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n95_), .O(new_n185_));
  ...
  nand2  g110(.a(new_n193_), .b(new_n95_), .O(new_n194_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n95_), .O(new_n207_));
  ...
  aoi21  g132(.a(new_n101_), .b(x09), .c(new_n209_), .O(new_n216_));
  nand3  g133(.a(x40), .b(new_n101_), .c(x09), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(new_n216_), .c(new_n95_), .O(new_n219_));
  ...
  nand3  g140(.a(new_n223_), .b(new_n89_), .c(new_n95_), .O(new_n224_));
  ...
  nand3  g168(.a(x31), .b(new_n101_), .c(x09), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(new_n88_), .O(new_n253_));
