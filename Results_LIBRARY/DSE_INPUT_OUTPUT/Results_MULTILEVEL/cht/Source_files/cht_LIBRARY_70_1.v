...
module FAU ( 
  ...
  oai21  g028(.a(x17), .b(x10), .c(new_n96_), .O(new_n112_));
  nand3  g029(.a(x18), .b(new_n91_), .c(x08), .O(new_n113_));
  ...
  oai21  g037(.a(x20), .b(x10), .c(new_n96_), .O(new_n121_));
  nand3  g038(.a(x21), .b(new_n91_), .c(x08), .O(new_n122_));
  ...
  nand2  g052(.a(x25), .b(new_n96_), .O(new_n136_));
  ...
  nand2  g068(.a(x30), .b(new_n96_), .O(new_n152_));
  ...
  nand2  g080(.a(x34), .b(new_n154_), .O(new_n164_));
  nand2  g081(.a(x35), .b(x09), .O(new_n165_));
  aoi21  g082(.a(new_n165_), .b(new_n164_), .c(x10), .O(z23));
  nand2  g083(.a(x35), .b(new_n154_), .O(new_n167_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n97_), .O(z25));
  ...
  aoi21  g112(.a(new_n184_), .b(x09), .c(new_n195_), .O(new_n196_));
  nand3  g113(.a(x43), .b(new_n184_), .c(x09), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(new_n198_));
  oai21  g115(.a(new_n198_), .b(new_n196_), .c(new_n91_), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n97_), .O(z31));
  inv1   g117(.a(x43), .O(new_n201_));
  aoi21  g118(.a(new_n184_), .b(x09), .c(new_n201_), .O(new_n202_));
  nand3  g119(.a(x44), .b(new_n184_), .c(x09), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(new_n204_));
  oai21  g121(.a(new_n204_), .b(new_n202_), .c(new_n91_), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(new_n97_), .O(z32));
  nand2  g123(.a(new_n185_), .b(x44), .O(new_n207_));
  nand3  g124(.a(x45), .b(new_n184_), .c(x09), .O(new_n208_));
  ...
  nand2  g129(.a(new_n185_), .b(x46), .O(new_n213_));
  nand3  g130(.a(new_n184_), .b(x09), .c(x00), .O(new_n214_));
