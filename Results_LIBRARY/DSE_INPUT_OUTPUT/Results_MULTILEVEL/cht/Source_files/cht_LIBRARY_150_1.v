...
module FAU ( 
  ...
  aoi21  g008(.a(x13), .b(new_n85_), .c(x46), .O(new_n92_));
  aoi21  g009(.a(new_n92_), .b(new_n91_), .c(x10), .O(z02));
  inv1   g010(.a(x10), .O(new_n94_));
  inv1   g011(.a(x46), .O(new_n95_));
  ...
  nand3  g030(.a(new_n113_), .b(new_n95_), .c(new_n94_), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z06));
  inv1   g032(.a(x08), .O(new_n116_));
  nand2  g033(.a(x18), .b(new_n116_), .O(new_n117_));
  aoi21  g034(.a(x19), .b(x08), .c(x46), .O(new_n118_));
  ...
  aoi21  g065(.a(x27), .b(x08), .c(x46), .O(new_n149_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n95_), .c(new_n94_), .O(new_n175_));
  inv1   g092(.a(new_n175_), .O(z22));
  nand2  g093(.a(x34), .b(new_n165_), .O(new_n177_));
  aoi21  g094(.a(x35), .b(x09), .c(x46), .O(new_n178_));
  ...
  nand3  g131(.a(x43), .b(new_n96_), .c(x09), .O(new_n215_));
  ...
  aoi21  g146(.a(new_n229_), .b(new_n95_), .c(x10), .O(z34));
  nand4  g147(.a(new_n96_), .b(new_n94_), .c(x09), .d(x00), .O(new_n231_));
  nor2   g148(.a(new_n231_), .b(x46), .O(z35));
endmodule
