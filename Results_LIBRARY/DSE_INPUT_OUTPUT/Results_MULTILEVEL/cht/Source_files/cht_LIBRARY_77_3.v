...
module FAU ( 
  ...
  oai21  g030(.a(x10), .b(new_n113_), .c(x17), .O(new_n114_));
  ...
  nand2  g090(.a(x33), .b(new_n163_), .O(new_n174_));
  oai21  g091(.a(new_n173_), .b(new_n163_), .c(new_n174_), .O(new_n175_));
  ...
  nand2  g114(.a(x38), .b(new_n163_), .O(new_n198_));
  ...
  nand3  g125(.a(x42), .b(new_n200_), .c(x09), .O(new_n209_));
  ...
  nand3  g129(.a(x43), .b(new_n200_), .c(x09), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n200_), .b(x09), .c(new_n217_), .O(new_n218_));
  ...
  aoi21  g146(.a(new_n200_), .b(x09), .c(new_n229_), .O(new_n230_));
