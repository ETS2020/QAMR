...
module FAU ( 
  ...
  aoi21  g025(.a(x16), .b(new_n102_), .c(x17), .O(new_n109_));
  aoi21  g026(.a(new_n109_), .b(new_n108_), .c(x10), .O(z05));
  nand2  g027(.a(x18), .b(x08), .O(new_n111_));
  aoi21  g028(.a(new_n111_), .b(new_n85_), .c(x10), .O(z06));
  ...
  nand3  g050(.a(new_n133_), .b(new_n132_), .c(new_n85_), .O(new_n134_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x17), .O(new_n212_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x17), .O(new_n217_));
  ...
  aoi21  g148(.a(new_n231_), .b(x09), .c(x17), .O(new_n232_));
  ...
  aoi21  g153(.a(new_n236_), .b(x09), .c(x17), .O(new_n237_));
  ...
  aoi21  g158(.a(new_n241_), .b(x09), .c(x17), .O(new_n242_));
  aoi21  g159(.a(new_n242_), .b(new_n239_), .c(x10), .O(z34));
  nand2  g160(.a(new_n208_), .b(x46), .O(new_n244_));
  aoi21  g161(.a(new_n219_), .b(x00), .c(x17), .O(new_n245_));
