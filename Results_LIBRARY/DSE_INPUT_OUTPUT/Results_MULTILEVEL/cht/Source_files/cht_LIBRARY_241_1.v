...
module FAU ( 
  ...
  oai21  g083(.a(new_n166_), .b(x10), .c(new_n86_), .O(z17));
  ...
  nand2  g166(.a(new_n101_), .b(x09), .O(new_n250_));
  aoi21  g167(.a(new_n250_), .b(x45), .c(x46), .O(new_n251_));
  oai21  g168(.a(new_n251_), .b(x10), .c(new_n86_), .O(z34));
