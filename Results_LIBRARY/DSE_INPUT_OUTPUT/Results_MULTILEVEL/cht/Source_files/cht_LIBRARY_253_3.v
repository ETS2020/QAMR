...
module FAU ( 
  ...
  nand3  g084(.a(x31), .b(new_n88_), .c(new_n167_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n166_), .O(z20));
  nand2  g086(.a(x32), .b(new_n167_), .O(new_n170_));
  ...
  nand3  g093(.a(x34), .b(new_n88_), .c(new_n167_), .O(new_n177_));
  ...
  nand3  g099(.a(x36), .b(new_n88_), .c(new_n167_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(z25));
  oai21  g101(.a(x38), .b(x10), .c(x09), .O(new_n185_));
  nand3  g102(.a(x37), .b(new_n88_), .c(new_n167_), .O(new_n186_));
  ...
  nand3  g109(.a(x38), .b(new_n88_), .c(new_n167_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n192_), .O(z27));
  inv1   g111(.a(x39), .O(new_n195_));
  nor2   g112(.a(x10), .b(x09), .O(new_n196_));
  aoi21  g113(.a(x14), .b(x09), .c(new_n196_), .O(new_n197_));
  aoi21  g114(.a(x40), .b(new_n189_), .c(x10), .O(new_n198_));
  oai22  g115(.a(new_n198_), .b(new_n167_), .c(new_n197_), .d(new_n195_), .O(z28));
  inv1   g116(.a(x40), .O(new_n200_));
  aoi21  g117(.a(x41), .b(new_n189_), .c(x10), .O(new_n201_));
  oai22  g118(.a(new_n201_), .b(new_n167_), .c(new_n197_), .d(new_n200_), .O(z29));
  inv1   g119(.a(x41), .O(new_n203_));
  aoi21  g120(.a(x42), .b(new_n189_), .c(x10), .O(new_n204_));
  oai22  g121(.a(new_n204_), .b(new_n167_), .c(new_n197_), .d(new_n203_), .O(z30));
  nand2  g122(.a(new_n189_), .b(x09), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(x42), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n189_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z31));
  nand2  g126(.a(new_n206_), .b(x43), .O(new_n210_));
  nand3  g127(.a(x44), .b(new_n189_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z32));
  inv1   g129(.a(x44), .O(new_n213_));
  aoi21  g130(.a(x45), .b(new_n189_), .c(x10), .O(new_n214_));
  oai22  g131(.a(new_n214_), .b(new_n167_), .c(new_n197_), .d(new_n213_), .O(z33));
  nand2  g132(.a(new_n206_), .b(x45), .O(new_n216_));
  nand3  g133(.a(x46), .b(new_n189_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  nand2  g135(.a(new_n206_), .b(x46), .O(new_n219_));
