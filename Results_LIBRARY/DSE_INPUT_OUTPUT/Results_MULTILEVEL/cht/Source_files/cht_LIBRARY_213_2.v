...
module FAU ( 
  ...
  oai21  g045(.a(x23), .b(new_n110_), .c(x22), .O(new_n129_));
  ...
  nand2  g094(.a(new_n177_), .b(new_n90_), .O(z23));
  ...
  nand3  g126(.a(x43), .b(new_n197_), .c(x09), .O(new_n210_));
  ...
  nand3  g144(.a(new_n197_), .b(x09), .c(x00), .O(new_n228_));
