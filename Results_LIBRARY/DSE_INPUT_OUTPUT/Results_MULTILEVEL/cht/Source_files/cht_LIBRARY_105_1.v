...
module FAU ( 
  ...
  aoi21  g015(.a(x14), .b(new_n85_), .c(x33), .O(new_n99_));
  ...
  aoi21  g025(.a(x18), .b(x08), .c(x33), .O(new_n109_));
  ...
  nand4  g078(.a(new_n92_), .b(x32), .c(new_n91_), .d(new_n161_), .O(new_n162_));
  inv1   g079(.a(new_n162_), .O(z21));
  nand2  g080(.a(x34), .b(x09), .O(new_n164_));
  aoi21  g081(.a(new_n164_), .b(new_n92_), .c(x10), .O(z22));
  nand2  g082(.a(x34), .b(new_n161_), .O(new_n166_));
  nand2  g083(.a(x35), .b(x09), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n92_), .O(new_n168_));
  and2   g085(.a(new_n168_), .b(new_n91_), .O(z23));
  ...
  nand2  g091(.a(x36), .b(new_n161_), .O(new_n175_));
  nand2  g092(.a(x37), .b(x09), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n175_), .c(new_n92_), .O(new_n177_));
  and2   g094(.a(new_n177_), .b(new_n91_), .O(z25));
  nand2  g095(.a(x37), .b(new_n161_), .O(new_n179_));
  nand2  g096(.a(x38), .b(x09), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n92_), .O(new_n181_));
  and2   g098(.a(new_n181_), .b(new_n91_), .O(z26));
  nand2  g099(.a(x14), .b(x00), .O(new_n183_));
  inv1   g100(.a(x14), .O(new_n184_));
  nand2  g101(.a(x39), .b(new_n184_), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n183_), .c(new_n161_), .O(new_n186_));
  inv1   g103(.a(x38), .O(new_n187_));
  nor2   g104(.a(new_n187_), .b(x09), .O(new_n188_));
  oai21  g105(.a(new_n188_), .b(new_n186_), .c(new_n92_), .O(new_n189_));
  ...
  aoi21  g111(.a(new_n194_), .b(x09), .c(x33), .O(new_n195_));
  ...
  aoi21  g116(.a(new_n199_), .b(x09), .c(x33), .O(new_n200_));
  ...
  nand3  g126(.a(new_n209_), .b(new_n92_), .c(new_n91_), .O(new_n210_));
  ...
  nand3  g131(.a(new_n214_), .b(new_n92_), .c(new_n91_), .O(new_n215_));
  ...
  aoi21  g144(.a(new_n207_), .b(x00), .c(x33), .O(new_n228_));
