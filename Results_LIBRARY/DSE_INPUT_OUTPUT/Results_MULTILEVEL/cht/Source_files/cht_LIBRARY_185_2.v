...
module FAU ( 
  ...
  aoi21  g026(.a(new_n109_), .b(new_n88_), .c(x10), .O(z07));
  inv1   g027(.a(x19), .O(new_n111_));
  aoi21  g028(.a(new_n111_), .b(new_n88_), .c(x10), .O(z08));
  ...
  aoi21  g037(.a(new_n120_), .b(new_n88_), .c(x10), .O(z12));
  ...
  aoi21  g047(.a(new_n130_), .b(new_n88_), .c(x10), .O(z17));
  ...
  and2   g056(.a(new_n139_), .b(new_n89_), .O(z20));
  ...
  and2   g069(.a(new_n152_), .b(new_n89_), .O(z23));
  nand2  g070(.a(x35), .b(new_n136_), .O(new_n154_));
  nand2  g071(.a(x36), .b(x09), .O(new_n155_));
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(new_n88_), .O(new_n156_));
  and2   g073(.a(new_n156_), .b(new_n89_), .O(z24));
  ...
  and2   g077(.a(new_n160_), .b(new_n89_), .O(z25));
  ...
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n89_), .O(new_n172_));
  ...
  nor2   g101(.a(x14), .b(new_n136_), .O(new_n185_));
  nand3  g102(.a(x42), .b(new_n168_), .c(x09), .O(new_n186_));
  oai21  g103(.a(new_n185_), .b(new_n181_), .c(new_n186_), .O(new_n187_));
  ...
  aoi21  g110(.a(new_n193_), .b(new_n190_), .c(x10), .O(z31));
  ...
  nand3  g121(.a(x46), .b(new_n168_), .c(x09), .O(new_n205_));
  oai21  g122(.a(new_n185_), .b(new_n201_), .c(new_n205_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n89_), .c(new_n88_), .O(new_n207_));
  inv1   g124(.a(new_n207_), .O(z34));
  nand2  g125(.a(new_n174_), .b(x46), .O(new_n209_));
  nand2  g126(.a(new_n185_), .b(x00), .O(new_n210_));
