...
module FAU ( 
  ...
  nand2  g047(.a(new_n130_), .b(new_n90_), .O(new_n131_));
  nand2  g048(.a(new_n131_), .b(new_n88_), .O(z09));
  ...
  nand2  g071(.a(new_n154_), .b(new_n88_), .O(z14));
  ...
  nand2  g083(.a(new_n166_), .b(new_n90_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n88_), .O(z17));
  oai21  g085(.a(x30), .b(new_n114_), .c(x29), .O(new_n169_));
  nand3  g086(.a(x30), .b(new_n84_), .c(x08), .O(new_n170_));
