...
module FAU ( 
  ...
  nand3  g018(.a(new_n101_), .b(x35), .c(new_n98_), .O(new_n102_));
  ...
  nand3  g023(.a(new_n106_), .b(x35), .c(new_n98_), .O(new_n107_));
  ...
  nand3  g028(.a(new_n111_), .b(x35), .c(new_n98_), .O(new_n112_));
  ...
  nand3  g079(.a(new_n162_), .b(x35), .c(new_n98_), .O(new_n163_));
  ...
  nand3  g094(.a(new_n177_), .b(x35), .c(new_n98_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z22));
  nor2   g096(.a(new_n86_), .b(x34), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n165_), .c(x10), .O(z23));
  oai21  g098(.a(x36), .b(new_n165_), .c(x35), .O(new_n182_));
  ...
  nand3  g118(.a(new_n201_), .b(x35), .c(new_n98_), .O(new_n202_));
  ...
  nand3  g123(.a(new_n206_), .b(x35), .c(new_n98_), .O(new_n207_));
  ...
  nand3  g154(.a(new_n237_), .b(x35), .c(new_n98_), .O(new_n238_));
