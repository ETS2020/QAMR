...
module FAU ( 
  ...
  nand3  g057(.a(new_n140_), .b(x29), .c(new_n84_), .O(new_n141_));
  ...
  oai21  g065(.a(x28), .b(x08), .c(x29), .O(new_n149_));
  nor2   g066(.a(new_n149_), .b(x10), .O(z17));
  oai21  g067(.a(x30), .b(new_n107_), .c(x29), .O(new_n151_));
  nor2   g068(.a(new_n151_), .b(x10), .O(z18));
  nand2  g069(.a(x08), .b(x00), .O(new_n153_));
  aoi21  g070(.a(x30), .b(new_n107_), .c(new_n92_), .O(new_n154_));
  ...
  nand3  g085(.a(new_n168_), .b(x29), .c(new_n84_), .O(new_n169_));
  inv1   g086(.a(new_n169_), .O(z22));
  nand2  g087(.a(x34), .b(new_n156_), .O(new_n171_));
  nand2  g088(.a(x35), .b(x09), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(x29), .O(new_n173_));
  ...
  nand3  g094(.a(new_n177_), .b(x29), .c(new_n84_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z24));
  nand2  g096(.a(x36), .b(new_n156_), .O(new_n180_));
  nand2  g097(.a(x37), .b(x09), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(new_n180_), .c(x29), .O(new_n182_));
  ...
  nand3  g103(.a(new_n186_), .b(x29), .c(new_n84_), .O(new_n187_));
  ...
  oai21  g110(.a(new_n193_), .b(new_n192_), .c(x29), .O(new_n194_));
  ...
  nand3  g116(.a(new_n199_), .b(x29), .c(new_n84_), .O(new_n200_));
  ...
  nand3  g121(.a(new_n204_), .b(x29), .c(new_n84_), .O(new_n205_));
  ...
  nand3  g136(.a(new_n219_), .b(x29), .c(new_n84_), .O(new_n220_));
  ...
  nand3  g141(.a(new_n224_), .b(x29), .c(new_n84_), .O(new_n225_));
  ...
  nand3  g146(.a(new_n229_), .b(x29), .c(new_n84_), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(z34));
  nand2  g148(.a(new_n196_), .b(x46), .O(new_n232_));
  aoi21  g149(.a(new_n217_), .b(x00), .c(new_n92_), .O(new_n233_));
