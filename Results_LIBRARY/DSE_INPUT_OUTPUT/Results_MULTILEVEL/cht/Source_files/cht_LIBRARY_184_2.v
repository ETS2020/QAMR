...
module FAU ( 
  ...
  nand2  g052(.a(x22), .b(new_n119_), .O(new_n136_));
  ...
  nand2  g071(.a(x27), .b(new_n119_), .O(new_n155_));
  ...
  nand2  g109(.a(x37), .b(new_n169_), .O(new_n193_));
  ...
  nand3  g130(.a(x42), .b(new_n101_), .c(x09), .O(new_n214_));
  ...
  nand2  g149(.a(new_n232_), .b(new_n90_), .O(z34));
