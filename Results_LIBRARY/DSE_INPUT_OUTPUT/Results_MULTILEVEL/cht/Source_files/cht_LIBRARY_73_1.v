...
module FAU ( 
  ...
  nor2   g108(.a(x45), .b(x09), .O(new_n192_));
  oai21  g109(.a(new_n192_), .b(x35), .c(x34), .O(new_n193_));
  nand2  g110(.a(x35), .b(x09), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z23));
  nand2  g112(.a(x36), .b(x09), .O(new_n196_));
  oai21  g113(.a(new_n85_), .b(x09), .c(new_n196_), .O(new_n197_));
  ...
  nand2  g165(.a(x45), .b(x35), .O(new_n249_));
  inv1   g166(.a(x45), .O(new_n250_));
  nand3  g167(.a(new_n250_), .b(new_n102_), .c(x09), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(new_n249_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(x46), .O(new_n253_));
  nand2  g170(.a(new_n102_), .b(x09), .O(new_n254_));
  nand3  g171(.a(new_n254_), .b(x45), .c(x35), .O(new_n255_));
  aoi21  g172(.a(new_n255_), .b(new_n253_), .c(x10), .O(z34));
  oai21  g173(.a(x14), .b(new_n177_), .c(x46), .O(new_n257_));
