...
module FAU ( 
  ...
  nand2  g089(.a(new_n172_), .b(new_n90_), .O(z23));
  inv1   g090(.a(x36), .O(new_n174_));
  nand2  g091(.a(x35), .b(new_n161_), .O(new_n175_));
  oai21  g092(.a(new_n174_), .b(new_n161_), .c(new_n175_), .O(new_n176_));
  ...
  oai21  g108(.a(new_n191_), .b(x10), .c(new_n90_), .O(z27));
  ...
  nand2  g137(.a(new_n193_), .b(x45), .O(new_n221_));
  ...
  nand2  g145(.a(new_n228_), .b(new_n90_), .O(z35));
endmodule
