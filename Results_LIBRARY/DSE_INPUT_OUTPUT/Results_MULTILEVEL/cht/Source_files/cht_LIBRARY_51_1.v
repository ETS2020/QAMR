...
module FAU ( 
  ...
  oai21  g116(.a(x41), .b(x10), .c(new_n89_), .O(new_n200_));
  nand2  g117(.a(x41), .b(x14), .O(new_n201_));
  nand3  g118(.a(x42), .b(new_n192_), .c(x09), .O(new_n202_));
  ...
  oai21  g122(.a(x42), .b(x10), .c(new_n89_), .O(new_n206_));
  nand2  g123(.a(x42), .b(x14), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n192_), .c(x09), .O(new_n208_));
  ...
  nand2  g140(.a(new_n193_), .b(x46), .O(new_n224_));
  nand3  g141(.a(new_n192_), .b(x09), .c(x00), .O(new_n225_));
