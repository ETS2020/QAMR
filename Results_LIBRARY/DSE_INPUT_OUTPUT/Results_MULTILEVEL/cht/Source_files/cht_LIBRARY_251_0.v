...
module FAU ( 
  ...
  nand3  g050(.a(new_n133_), .b(x27), .c(new_n89_), .O(new_n134_));
  ...
  nand3  g061(.a(new_n144_), .b(x27), .c(new_n89_), .O(new_n145_));
  inv1   g062(.a(new_n145_), .O(z14));
  nor2   g063(.a(new_n86_), .b(x26), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n115_), .c(x10), .O(z15));
  ...
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(x27), .O(new_n153_));
  and2   g070(.a(new_n153_), .b(new_n89_), .O(z17));
  ...
  nand3  g083(.a(new_n166_), .b(x27), .c(new_n89_), .O(new_n167_));
  ...
  nand3  g109(.a(new_n192_), .b(x27), .c(new_n89_), .O(new_n193_));
  ...
  nand3  g120(.a(new_n203_), .b(x27), .c(new_n89_), .O(new_n204_));
  ...
  nand3  g125(.a(new_n208_), .b(x27), .c(new_n89_), .O(new_n209_));
  ...
  nand3  g130(.a(new_n213_), .b(x27), .c(new_n89_), .O(new_n214_));
