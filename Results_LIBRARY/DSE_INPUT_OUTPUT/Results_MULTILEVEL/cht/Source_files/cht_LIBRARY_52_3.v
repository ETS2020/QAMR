...
module FAU ( 
  ...
  oai22  g121(.a(new_n204_), .b(new_n167_), .c(new_n203_), .d(new_n201_), .O(z30));
  nand2  g122(.a(new_n194_), .b(x42), .O(new_n206_));
  ...
  oai22  g130(.a(new_n213_), .b(new_n167_), .c(new_n203_), .d(new_n212_), .O(z33));
  inv1   g131(.a(x45), .O(new_n215_));
  aoi21  g132(.a(x46), .b(new_n98_), .c(x10), .O(new_n216_));
  oai22  g133(.a(new_n216_), .b(new_n167_), .c(new_n203_), .d(new_n215_), .O(z34));
