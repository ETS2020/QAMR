...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n92_), .c(x36), .O(new_n104_));
  ...
  aoi21  g029(.a(x18), .b(x08), .c(x36), .O(new_n113_));
  ...
  aoi21  g075(.a(x30), .b(x08), .c(x36), .O(new_n159_));
  aoi21  g076(.a(new_n159_), .b(new_n158_), .c(x10), .O(z18));
  nand2  g077(.a(x08), .b(x00), .O(new_n161_));
  aoi21  g078(.a(x30), .b(new_n111_), .c(x36), .O(new_n162_));
  ...
  aoi21  g098(.a(new_n181_), .b(new_n85_), .c(x10), .O(z24));
  nand2  g099(.a(x37), .b(x09), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n85_), .c(x10), .O(z25));
  ...
  aoi21  g110(.a(x38), .b(new_n169_), .c(x36), .O(new_n194_));
  ...
  aoi21  g126(.a(new_n209_), .b(x09), .c(x36), .O(new_n210_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x36), .O(new_n225_));
