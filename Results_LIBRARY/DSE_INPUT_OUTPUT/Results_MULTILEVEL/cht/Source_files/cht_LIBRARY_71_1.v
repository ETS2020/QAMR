...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n85_), .c(x38), .O(new_n101_));
  ...
  aoi21  g066(.a(x28), .b(x08), .c(x38), .O(new_n150_));
  ...
  aoi21  g077(.a(x30), .b(new_n111_), .c(x38), .O(new_n161_));
  ...
  nand4  g103(.a(new_n89_), .b(x37), .c(new_n88_), .d(new_n163_), .O(new_n187_));
  ...
  aoi21  g135(.a(new_n218_), .b(x09), .c(x38), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n216_), .c(x10), .O(z32));
  oai21  g137(.a(x14), .b(new_n163_), .c(x44), .O(new_n221_));
  nand3  g138(.a(x45), .b(new_n195_), .c(x09), .O(new_n222_));
  ...
  oai21  g142(.a(x14), .b(new_n163_), .c(x45), .O(new_n226_));
  nand3  g143(.a(x46), .b(new_n195_), .c(x09), .O(new_n227_));
  ...
  nor2   g148(.a(x14), .b(new_n163_), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(x00), .c(x38), .O(new_n233_));
