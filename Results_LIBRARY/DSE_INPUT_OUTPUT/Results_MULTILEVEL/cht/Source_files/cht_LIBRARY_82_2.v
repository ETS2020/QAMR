...
module FAU ( 
  ...
  nand2  g052(.a(new_n135_), .b(new_n100_), .O(z13));
  nand2  g053(.a(x25), .b(new_n108_), .O(new_n137_));
  nand2  g054(.a(x26), .b(x08), .O(new_n138_));
  aoi21  g055(.a(new_n138_), .b(new_n137_), .c(x10), .O(z14));
  nand2  g056(.a(x26), .b(new_n108_), .O(new_n140_));
  ...
  nand2  g062(.a(x28), .b(new_n108_), .O(new_n146_));
  nand2  g063(.a(x29), .b(x08), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n146_), .c(x10), .O(z17));
  nand2  g065(.a(x29), .b(new_n108_), .O(new_n149_));
  oai21  g066(.a(new_n99_), .b(new_n108_), .c(new_n149_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n94_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n100_), .O(z18));
  nand2  g069(.a(x08), .b(x00), .O(new_n153_));
  oai21  g070(.a(new_n99_), .b(x08), .c(new_n153_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n94_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n100_), .O(z19));
  ...
  nand2  g077(.a(new_n160_), .b(new_n100_), .O(z20));
  ...
  nand2  g086(.a(new_n169_), .b(new_n100_), .O(z22));
  ...
  nand2  g090(.a(new_n173_), .b(new_n100_), .O(z23));
  ...
  nand2  g095(.a(new_n178_), .b(new_n100_), .O(z24));
  nand2  g096(.a(x36), .b(new_n162_), .O(new_n180_));
  ...
  oai21  g101(.a(new_n183_), .b(new_n162_), .c(new_n184_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n94_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n100_), .O(z26));
  ...
  oai21  g109(.a(new_n192_), .b(x10), .c(new_n100_), .O(z27));
  ...
  nand2  g114(.a(new_n197_), .b(new_n100_), .O(z28));
  ...
  nand2  g122(.a(new_n199_), .b(x42), .O(new_n206_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n100_), .O(z32));
  ...
  nand2  g136(.a(new_n219_), .b(new_n100_), .O(z33));
  ...
  nand2  g145(.a(new_n228_), .b(new_n100_), .O(z35));
endmodule
