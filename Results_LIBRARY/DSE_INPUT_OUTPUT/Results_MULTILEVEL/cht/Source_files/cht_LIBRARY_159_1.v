...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n85_), .c(x37), .O(new_n96_));
  ...
  aoi21  g069(.a(x29), .b(x08), .c(x37), .O(new_n153_));
  ...
  aoi21  g084(.a(x33), .b(x09), .c(x37), .O(new_n168_));
  ...
  aoi21  g092(.a(x35), .b(x09), .c(x37), .O(new_n176_));
  ...
  nand4  g099(.a(new_n89_), .b(x36), .c(new_n88_), .d(new_n163_), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z25));
  nand2  g101(.a(x38), .b(x09), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n89_), .c(x10), .O(z26));
  ...
  oai21  g109(.a(new_n192_), .b(new_n190_), .c(new_n89_), .O(new_n193_));
  ...
  aoi21  g135(.a(new_n218_), .b(x09), .c(x37), .O(new_n219_));
  ...
  aoi21  g147(.a(new_n211_), .b(x00), .c(x37), .O(new_n231_));
