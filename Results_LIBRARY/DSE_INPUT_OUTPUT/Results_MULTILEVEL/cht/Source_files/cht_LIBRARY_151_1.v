...
module FAU ( 
  ...
  nand2  g068(.a(new_n151_), .b(new_n93_), .O(z15));
  ...
  nand2  g073(.a(new_n156_), .b(new_n93_), .O(z16));
  ...
  oai21  g079(.a(new_n161_), .b(new_n113_), .c(new_n162_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n88_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n93_), .O(z18));
  ...
  nand2  g102(.a(new_n185_), .b(new_n93_), .O(z23));
  ...
  oai21  g119(.a(new_n202_), .b(x10), .c(new_n93_), .O(z27));
  ...
  nand2  g124(.a(new_n207_), .b(new_n93_), .O(z28));
  ...
  nand2  g129(.a(new_n209_), .b(x41), .O(new_n213_));
  ...
  aoi21  g139(.a(new_n100_), .b(x09), .c(new_n222_), .O(new_n223_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n93_), .O(z32));
