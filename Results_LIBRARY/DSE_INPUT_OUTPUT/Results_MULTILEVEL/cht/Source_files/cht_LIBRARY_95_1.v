...
module FAU ( 
  ...
  aoi21  g005(.a(x12), .b(new_n85_), .c(x27), .O(new_n89_));
  ...
  aoi21  g020(.a(x15), .b(new_n85_), .c(x27), .O(new_n104_));
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  aoi21  g023(.a(x16), .b(new_n85_), .c(x27), .O(new_n107_));
  ...
  nand3  g029(.a(new_n112_), .b(new_n92_), .c(new_n91_), .O(new_n113_));
  ...
  and2   g071(.a(new_n154_), .b(new_n91_), .O(z18));
  ...
  nand3  g107(.a(new_n190_), .b(new_n189_), .c(new_n92_), .O(new_n191_));
  and2   g108(.a(new_n191_), .b(new_n91_), .O(z26));
  ...
  aoi21  g120(.a(new_n203_), .b(x09), .c(x27), .O(new_n204_));
  ...
  nand3  g130(.a(new_n213_), .b(new_n92_), .c(new_n91_), .O(new_n214_));
  ...
  aoi21  g140(.a(new_n223_), .b(x09), .c(x27), .O(new_n224_));
