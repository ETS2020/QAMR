...
module FAU ( 
  ...
  nand2  g001(.a(x43), .b(x27), .O(new_n85_));
  ...
  oai21  g067(.a(new_n150_), .b(x10), .c(new_n85_), .O(z14));
  nor2   g068(.a(x27), .b(x08), .O(new_n152_));
  inv1   g069(.a(x27), .O(new_n153_));
  nor2   g070(.a(x43), .b(new_n153_), .O(new_n154_));
  oai21  g071(.a(new_n154_), .b(new_n152_), .c(x26), .O(new_n155_));
  nand2  g072(.a(new_n154_), .b(x08), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z15));
  nor2   g074(.a(new_n153_), .b(x08), .O(new_n158_));
  ...
  oai21  g085(.a(new_n168_), .b(x10), .c(new_n85_), .O(z18));
  ...
  nand2  g156(.a(new_n239_), .b(new_n237_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(x44), .O(new_n241_));
  nand2  g158(.a(new_n99_), .b(x09), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(x43), .c(new_n153_), .O(new_n243_));
  aoi21  g160(.a(new_n243_), .b(new_n241_), .c(x10), .O(z32));
