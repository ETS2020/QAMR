...
module FAU ( 
  ...
  nand3  g049(.a(x23), .b(new_n84_), .c(new_n114_), .O(new_n133_));
  ...
  nand3  g064(.a(x28), .b(new_n84_), .c(new_n114_), .O(new_n148_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n89_), .O(z22));
  ...
  nand2  g098(.a(new_n181_), .b(new_n89_), .O(z26));
  ...
  nand2  g103(.a(x38), .b(new_n156_), .O(new_n187_));
  ...
  aoi21  g111(.a(new_n101_), .b(x09), .c(new_n194_), .O(new_n195_));
  ...
  nand2  g125(.a(new_n208_), .b(new_n89_), .O(z31));
  ...
  nand2  g132(.a(new_n200_), .b(x44), .O(new_n216_));
  nand3  g133(.a(x45), .b(new_n101_), .c(x09), .O(new_n217_));
  ...
  nand3  g137(.a(x46), .b(new_n101_), .c(x09), .O(new_n221_));
  ...
  nand3  g142(.a(new_n101_), .b(x09), .c(x00), .O(new_n226_));
