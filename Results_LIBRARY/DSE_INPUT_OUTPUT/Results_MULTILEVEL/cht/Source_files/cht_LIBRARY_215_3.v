...
module FAU ( 
  ...
  nand3  g101(.a(x36), .b(new_n88_), .c(new_n169_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(z25));
  oai21  g103(.a(x38), .b(x10), .c(x09), .O(new_n187_));
  nand3  g104(.a(x37), .b(new_n88_), .c(new_n169_), .O(new_n188_));
  ...
  aoi21  g114(.a(x40), .b(new_n98_), .c(x10), .O(new_n198_));
  oai22  g115(.a(new_n198_), .b(new_n169_), .c(new_n197_), .d(new_n190_), .O(z28));
  inv1   g116(.a(x40), .O(new_n200_));
  aoi21  g117(.a(x41), .b(new_n98_), .c(x10), .O(new_n201_));
  oai22  g118(.a(new_n201_), .b(new_n169_), .c(new_n197_), .d(new_n200_), .O(z29));
  ...
  oai22  g131(.a(new_n214_), .b(new_n169_), .c(new_n197_), .d(new_n213_), .O(z33));
  nand2  g132(.a(new_n203_), .b(x45), .O(new_n216_));
  nand3  g133(.a(x46), .b(new_n98_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  nand2  g135(.a(new_n203_), .b(x46), .O(new_n219_));
