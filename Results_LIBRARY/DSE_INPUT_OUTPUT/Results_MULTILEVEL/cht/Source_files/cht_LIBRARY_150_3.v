...
module FAU ( 
  ...
  nand3  g144(.a(x44), .b(new_n204_), .c(x09), .O(new_n228_));
  inv1   g145(.a(new_n228_), .O(new_n229_));
  oai21  g146(.a(new_n229_), .b(new_n227_), .c(new_n84_), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n89_), .O(z32));
  inv1   g148(.a(x44), .O(new_n232_));
  aoi21  g149(.a(new_n204_), .b(x09), .c(new_n232_), .O(new_n233_));
  nand3  g150(.a(x45), .b(new_n204_), .c(x09), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(new_n235_));
  oai21  g152(.a(new_n235_), .b(new_n233_), .c(new_n84_), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n89_), .O(z33));
  nand3  g154(.a(new_n222_), .b(x45), .c(new_n84_), .O(new_n238_));
  nor2   g155(.a(x14), .b(new_n168_), .O(new_n239_));
  oai21  g156(.a(new_n239_), .b(x10), .c(x46), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(new_n238_), .O(z34));
  oai21  g158(.a(new_n239_), .b(x46), .c(x00), .O(new_n242_));
