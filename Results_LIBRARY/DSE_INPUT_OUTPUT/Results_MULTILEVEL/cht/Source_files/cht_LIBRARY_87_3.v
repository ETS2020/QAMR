...
module FAU ( 
  ...
  nand2  g003(.a(x23), .b(x13), .O(new_n87_));
  ...
  nand3  g032(.a(new_n115_), .b(new_n87_), .c(new_n89_), .O(new_n116_));
  ...
  nand3  g076(.a(new_n159_), .b(new_n87_), .c(new_n89_), .O(new_n160_));
  ...
  nand2  g118(.a(new_n201_), .b(new_n87_), .O(z25));
  ...
  nand3  g133(.a(new_n216_), .b(new_n87_), .c(new_n89_), .O(new_n217_));
  ...
  oai21  g150(.a(new_n233_), .b(new_n231_), .c(new_n89_), .O(new_n234_));
  ...
  nand3  g155(.a(new_n238_), .b(new_n87_), .c(new_n89_), .O(new_n239_));
  ...
  nand3  g170(.a(new_n253_), .b(new_n87_), .c(new_n89_), .O(new_n254_));
