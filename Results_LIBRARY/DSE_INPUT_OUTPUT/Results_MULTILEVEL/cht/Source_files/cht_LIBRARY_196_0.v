...
module FAU ( 
  ...
  oai21  g042(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(x19), .O(new_n127_));
  nand2  g044(.a(x20), .b(x08), .O(new_n128_));
  aoi21  g045(.a(new_n128_), .b(new_n127_), .c(x10), .O(z08));
  oai21  g046(.a(x21), .b(new_n116_), .c(x20), .O(new_n130_));
  nand3  g047(.a(x40), .b(x21), .c(x08), .O(new_n131_));
  aoi21  g048(.a(new_n131_), .b(new_n130_), .c(x10), .O(z09));
  inv1   g049(.a(x22), .O(new_n133_));
  nand2  g050(.a(x21), .b(new_n116_), .O(new_n134_));
  oai21  g051(.a(new_n133_), .b(new_n116_), .c(new_n134_), .O(new_n135_));
  ...
  aoi21  g133(.a(new_n101_), .b(x09), .c(new_n85_), .O(new_n217_));
  oai21  g134(.a(new_n217_), .b(x40), .c(x39), .O(new_n218_));
  nand3  g135(.a(x40), .b(new_n101_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z28));
  nand3  g137(.a(x20), .b(new_n101_), .c(x09), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n86_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(x41), .O(new_n223_));
  oai21  g140(.a(x14), .b(new_n178_), .c(x40), .O(new_n224_));
  ...
  oai21  g147(.a(x14), .b(new_n178_), .c(x42), .O(new_n231_));
  ...
  oai21  g152(.a(x14), .b(new_n178_), .c(x43), .O(new_n236_));
  ...
  oai21  g157(.a(x14), .b(new_n178_), .c(x44), .O(new_n241_));
