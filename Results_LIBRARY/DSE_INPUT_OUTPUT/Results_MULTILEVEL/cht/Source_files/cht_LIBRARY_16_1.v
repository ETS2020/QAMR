...
module FAU ( 
  ...
  nand3  g031(.a(new_n114_), .b(new_n86_), .c(new_n84_), .O(new_n115_));
  ...
  oai21  g041(.a(new_n124_), .b(x10), .c(new_n86_), .O(z07));
  ...
  oai21  g069(.a(new_n152_), .b(x10), .c(new_n86_), .O(z13));
  nor2   g070(.a(x32), .b(x08), .O(new_n154_));
  oai21  g071(.a(new_n154_), .b(x26), .c(x25), .O(new_n155_));
  nand2  g072(.a(x26), .b(x08), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z14));
  nor2   g074(.a(new_n85_), .b(x08), .O(new_n158_));
  ...
  nand3  g097(.a(new_n180_), .b(x32), .c(x26), .O(new_n181_));
  inv1   g098(.a(x32), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(x31), .c(new_n178_), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n181_), .c(x10), .O(z20));
  nand2  g101(.a(x33), .b(x09), .O(new_n185_));
  oai21  g102(.a(new_n182_), .b(x09), .c(new_n185_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n84_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n86_), .O(z21));
  inv1   g105(.a(x34), .O(new_n189_));
  nand2  g106(.a(x33), .b(new_n178_), .O(new_n190_));
  oai21  g107(.a(new_n189_), .b(new_n178_), .c(new_n190_), .O(new_n191_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n86_), .O(z26));
  ...
  oai21  g134(.a(x14), .b(new_n178_), .c(x39), .O(new_n218_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n86_), .O(z29));
  oai21  g145(.a(x14), .b(new_n178_), .c(x41), .O(new_n229_));
