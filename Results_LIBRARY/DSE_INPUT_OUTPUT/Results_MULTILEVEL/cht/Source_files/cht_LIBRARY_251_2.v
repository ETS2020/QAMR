...
module FAU ( 
  ...
  nand2  g060(.a(x25), .b(new_n108_), .O(new_n144_));
  nand2  g061(.a(x26), .b(x08), .O(new_n145_));
  aoi21  g062(.a(new_n145_), .b(new_n144_), .c(x10), .O(z14));
  nand2  g063(.a(x26), .b(new_n108_), .O(new_n147_));
  oai21  g064(.a(new_n89_), .b(new_n108_), .c(new_n147_), .O(new_n148_));
  ...
  oai21  g073(.a(new_n155_), .b(new_n108_), .c(new_n156_), .O(new_n157_));
  ...
  nand2  g081(.a(x30), .b(new_n108_), .O(new_n165_));
  ...
  nand3  g129(.a(x42), .b(new_n204_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z30));
  inv1   g131(.a(x42), .O(new_n215_));
  aoi21  g132(.a(new_n204_), .b(x09), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(x43), .b(new_n204_), .c(x09), .O(new_n217_));
  ...
  aoi21  g138(.a(new_n204_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(x44), .b(new_n204_), .c(x09), .O(new_n223_));
  ...
  aoi21  g144(.a(new_n204_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(x45), .b(new_n204_), .c(x09), .O(new_n229_));
  ...
  nand3  g151(.a(x46), .b(new_n204_), .c(x09), .O(new_n235_));
  ...
  aoi21  g156(.a(new_n204_), .b(x09), .c(new_n239_), .O(new_n240_));
  nand3  g157(.a(new_n204_), .b(x09), .c(x00), .O(new_n241_));
