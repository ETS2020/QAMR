...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n97_), .c(x23), .O(new_n106_));
  ...
  aoi21  g054(.a(new_n137_), .b(new_n85_), .c(x10), .O(z12));
  ...
  nand2  g096(.a(x33), .b(new_n175_), .O(new_n180_));
  ...
  nand2  g104(.a(x35), .b(new_n175_), .O(new_n188_));
  ...
  aoi21  g121(.a(x38), .b(new_n175_), .c(x23), .O(new_n205_));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(x23), .O(new_n216_));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(x23), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n218_), .c(x10), .O(z30));
  oai21  g139(.a(x14), .b(new_n175_), .c(x42), .O(new_n223_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x23), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n228_), .c(x10), .O(z32));
  oai21  g149(.a(x14), .b(new_n175_), .c(x44), .O(new_n233_));
  ...
  aoi21  g157(.a(new_n240_), .b(x09), .c(x23), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n238_), .c(x10), .O(z34));
  oai21  g159(.a(x14), .b(new_n175_), .c(x46), .O(new_n243_));
