...
module FAU ( 
  ...
  nand2  g009(.a(x37), .b(x10), .O(new_n93_));
  ...
  nand2  g063(.a(new_n146_), .b(new_n93_), .O(z14));
  ...
  nand2  g094(.a(x34), .b(new_n167_), .O(new_n178_));
  ...
  nand2  g101(.a(new_n184_), .b(new_n93_), .O(z24));
  oai21  g102(.a(x10), .b(x09), .c(x37), .O(new_n186_));
  nand3  g103(.a(x36), .b(new_n88_), .c(new_n167_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(z25));
  oai21  g105(.a(x38), .b(new_n167_), .c(x37), .O(new_n189_));
  ...
  aoi21  g126(.a(new_n199_), .b(x09), .c(new_n209_), .O(new_n210_));
  ...
  nand3  g141(.a(x45), .b(new_n199_), .c(x09), .O(new_n225_));
