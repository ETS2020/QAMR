...
module FAU ( 
  ...
  aoi21  g091(.a(x30), .b(new_n111_), .c(new_n86_), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z19));
  nand3  g093(.a(x32), .b(new_n92_), .c(x09), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z20));
  inv1   g095(.a(x33), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(x09), .c(x10), .O(z21));
  nand3  g097(.a(x34), .b(new_n92_), .c(x09), .O(new_n181_));
  ...
  and2   g111(.a(new_n194_), .b(new_n92_), .O(z27));
  ...
  nand2  g130(.a(x44), .b(new_n192_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(x09), .O(new_n215_));
  and2   g132(.a(new_n215_), .b(new_n92_), .O(z32));
  ...
  nand2  g143(.a(new_n192_), .b(x00), .O(new_n227_));
