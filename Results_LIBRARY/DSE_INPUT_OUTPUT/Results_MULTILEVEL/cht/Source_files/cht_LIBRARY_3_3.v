...
module FAU ( 
  ...
  nand2  g018(.a(x11), .b(x10), .O(new_n102_));
  ...
  nand2  g037(.a(new_n120_), .b(new_n97_), .O(new_n121_));
  nand2  g038(.a(new_n121_), .b(new_n102_), .O(z08));
  ...
  nand2  g042(.a(new_n125_), .b(new_n102_), .O(z09));
  ...
  nand2  g050(.a(new_n133_), .b(new_n102_), .O(z11));
  ...
  nand2  g058(.a(new_n141_), .b(new_n102_), .O(z13));
  ...
  nand2  g070(.a(new_n153_), .b(new_n102_), .O(z16));
  ...
  nand2  g085(.a(new_n168_), .b(new_n97_), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n102_), .O(z20));
  ...
  nand2  g103(.a(new_n186_), .b(new_n97_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n102_), .O(z25));
  ...
  oai21  g129(.a(new_n212_), .b(new_n210_), .c(new_n97_), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(new_n102_), .O(z31));
  ...
  nand2  g136(.a(new_n219_), .b(new_n102_), .O(z32));
  nand2  g137(.a(new_n199_), .b(x44), .O(new_n221_));
  nand3  g138(.a(x45), .b(new_n198_), .c(x09), .O(new_n222_));
  ...
  nand2  g145(.a(new_n228_), .b(new_n102_), .O(z34));
  nand2  g146(.a(new_n199_), .b(x46), .O(new_n230_));
  nand3  g147(.a(new_n198_), .b(x09), .c(x00), .O(new_n231_));
