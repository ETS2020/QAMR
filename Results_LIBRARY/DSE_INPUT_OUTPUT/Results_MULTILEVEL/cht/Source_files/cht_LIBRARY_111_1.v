...
module FAU ( 
  ...
  aoi21  g105(.a(new_n102_), .b(x09), .c(new_n183_), .O(new_n189_));
  nand3  g106(.a(x40), .b(new_n102_), .c(x09), .O(new_n190_));
  ...
  aoi21  g111(.a(new_n102_), .b(x09), .c(new_n194_), .O(new_n195_));
  nand3  g112(.a(x41), .b(new_n102_), .c(x09), .O(new_n196_));
  ...
  nand3  g118(.a(x42), .b(new_n102_), .c(x09), .O(new_n202_));
  ...
  nand3  g122(.a(x43), .b(new_n102_), .c(x09), .O(new_n206_));
  ...
  nand3  g133(.a(x45), .b(new_n102_), .c(x09), .O(new_n217_));
  ...
  nand3  g137(.a(x46), .b(new_n102_), .c(x09), .O(new_n221_));
  ...
  nand3  g142(.a(new_n102_), .b(x09), .c(x00), .O(new_n226_));
