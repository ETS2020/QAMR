...
module FAU ( 
  ...
  oai21  g063(.a(x27), .b(new_n109_), .c(x26), .O(new_n147_));
  nand2  g064(.a(x27), .b(x08), .O(new_n148_));
  aoi21  g065(.a(new_n148_), .b(new_n147_), .c(x10), .O(z15));
  oai21  g066(.a(x10), .b(new_n109_), .c(x27), .O(new_n150_));
  ...
  oai21  g074(.a(new_n156_), .b(new_n109_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g136(.a(new_n202_), .b(x09), .O(new_n220_));
  ...
  nand3  g144(.a(x45), .b(new_n202_), .c(x09), .O(new_n228_));
