...
module FAU ( 
  ...
  nand2  g040(.a(new_n123_), .b(new_n90_), .O(z09));
  ...
  nand2  g048(.a(new_n131_), .b(new_n90_), .O(z11));
  ...
  oai21  g085(.a(new_n89_), .b(new_n164_), .c(new_n168_), .O(new_n169_));
  ...
  nand2  g091(.a(x34), .b(new_n164_), .O(new_n175_));
  ...
  nand2  g098(.a(new_n181_), .b(new_n90_), .O(z24));
  ...
  nand2  g109(.a(x38), .b(new_n164_), .O(new_n193_));
  ...
  nand2  g136(.a(new_n201_), .b(x44), .O(new_n220_));
  ...
  aoi21  g143(.a(new_n195_), .b(x09), .c(new_n226_), .O(new_n227_));
  nand3  g144(.a(new_n195_), .b(x09), .c(x00), .O(new_n228_));
