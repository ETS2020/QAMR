...
module FAU ( 
  ...
  oai21  g085(.a(x31), .b(x10), .c(new_n93_), .O(new_n169_));
  nand3  g086(.a(x32), .b(new_n88_), .c(x09), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n169_), .O(z20));
  oai21  g088(.a(x32), .b(x10), .c(new_n93_), .O(new_n172_));
  nand3  g089(.a(x33), .b(new_n88_), .c(x09), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(z21));
  oai21  g091(.a(x33), .b(x10), .c(new_n93_), .O(new_n175_));
  nand3  g092(.a(x34), .b(new_n88_), .c(x09), .O(new_n176_));
  ...
  nand2  g097(.a(x35), .b(new_n93_), .O(new_n181_));
  nand2  g098(.a(x36), .b(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z24));
  oai21  g100(.a(x36), .b(x10), .c(new_n93_), .O(new_n184_));
  nand3  g101(.a(x37), .b(new_n88_), .c(x09), .O(new_n185_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n88_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n196_), .O(z28));
  oai21  g118(.a(x40), .b(x10), .c(new_n93_), .O(new_n202_));
  ...
  oai21  g134(.a(x44), .b(x10), .c(new_n93_), .O(new_n218_));
