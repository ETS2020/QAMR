...
module FAU ( 
  ...
  oai21  g100(.a(new_n182_), .b(new_n166_), .c(new_n183_), .O(new_n184_));
  ...
  nand2  g150(.a(new_n233_), .b(new_n89_), .O(z34));
  nand2  g151(.a(new_n198_), .b(x46), .O(new_n235_));
