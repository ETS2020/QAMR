...
module FAU ( 
  ...
  or2    g001(.a(x30), .b(x20), .O(new_n85_));
  ...
  oai21  g044(.a(x21), .b(new_n113_), .c(x20), .O(new_n128_));
  nand3  g045(.a(x30), .b(x21), .c(x08), .O(new_n129_));
  ...
  nand3  g083(.a(new_n85_), .b(x29), .c(new_n113_), .O(new_n167_));
  nand2  g084(.a(x30), .b(x08), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n167_), .c(x10), .O(z18));
  nand3  g086(.a(new_n85_), .b(x08), .c(x00), .O(new_n170_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n85_), .O(z25));
  ...
  nand2  g121(.a(new_n204_), .b(new_n85_), .O(z26));
  ...
  oai21  g126(.a(new_n209_), .b(new_n208_), .c(new_n85_), .O(new_n210_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n85_), .O(z30));
  ...
  nand2  g158(.a(new_n241_), .b(new_n85_), .O(z33));
