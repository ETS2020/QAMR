// Benchmark "FAU" written by ABC on Thu Aug 13 18:12:54 2020
...
module FAU ( 
  ...
  nand3  g030(.a(x18), .b(new_n88_), .c(new_n109_), .O(new_n114_));
  ...
  nand3  g060(.a(x28), .b(new_n88_), .c(new_n109_), .O(new_n144_));
  ...
  nand2  g075(.a(x33), .b(new_n152_), .O(new_n159_));
  nand2  g076(.a(x34), .b(x09), .O(new_n160_));
  aoi21  g077(.a(new_n160_), .b(new_n159_), .c(x10), .O(z22));
  inv1   g078(.a(x35), .O(new_n162_));
  nand2  g079(.a(x34), .b(new_n152_), .O(new_n163_));
  oai21  g080(.a(new_n162_), .b(new_n152_), .c(new_n163_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n88_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n93_), .O(z23));
  ...
  oai21  g101(.a(new_n184_), .b(x10), .c(new_n93_), .O(z27));
  inv1   g102(.a(x14), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(x09), .c(new_n179_), .O(new_n187_));
  nand3  g104(.a(x40), .b(new_n186_), .c(x09), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(new_n189_));
  oai21  g106(.a(new_n189_), .b(new_n187_), .c(new_n88_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n93_), .O(z28));
  inv1   g108(.a(x40), .O(new_n192_));
  aoi21  g109(.a(new_n186_), .b(x09), .c(new_n192_), .O(new_n193_));
  nand3  g110(.a(x41), .b(new_n186_), .c(x09), .O(new_n194_));
  ...
  aoi21  g115(.a(new_n186_), .b(x09), .c(new_n198_), .O(new_n199_));
  nand3  g116(.a(x42), .b(new_n186_), .c(x09), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(new_n201_));
  oai21  g118(.a(new_n201_), .b(new_n199_), .c(new_n88_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n93_), .O(z30));
  nand2  g120(.a(new_n186_), .b(x09), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(x42), .O(new_n205_));
  nand3  g122(.a(x43), .b(new_n186_), .c(x09), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z31));
  inv1   g124(.a(x43), .O(new_n208_));
  aoi21  g125(.a(new_n186_), .b(x09), .c(new_n208_), .O(new_n209_));
  nand3  g126(.a(x44), .b(new_n186_), .c(x09), .O(new_n210_));
  ...
  nand2  g130(.a(new_n204_), .b(x44), .O(new_n214_));
  nand3  g131(.a(x45), .b(new_n186_), .c(x09), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n214_), .c(x10), .O(z33));
  nand2  g133(.a(new_n204_), .b(x45), .O(new_n217_));
  nand3  g134(.a(x46), .b(new_n186_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z34));
  inv1   g136(.a(x46), .O(new_n220_));
  aoi21  g137(.a(new_n186_), .b(x09), .c(new_n220_), .O(new_n221_));
  nand3  g138(.a(new_n186_), .b(x09), .c(x00), .O(new_n222_));
  inv1   g139(.a(new_n222_), .O(new_n223_));
  oai21  g140(.a(new_n223_), .b(new_n221_), .c(new_n88_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n93_), .O(z35));
endmodule
