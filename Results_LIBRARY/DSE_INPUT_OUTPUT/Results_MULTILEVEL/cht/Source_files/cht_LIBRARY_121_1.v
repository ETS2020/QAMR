...
module FAU ( 
  ...
  oai21  g066(.a(x26), .b(new_n113_), .c(x25), .O(new_n150_));
  inv1   g067(.a(x45), .O(new_n151_));
  nand3  g068(.a(new_n151_), .b(x26), .c(x08), .O(new_n152_));
  aoi21  g069(.a(new_n152_), .b(new_n150_), .c(x10), .O(z14));
  ...
  nand3  g077(.a(new_n160_), .b(new_n88_), .c(new_n98_), .O(new_n161_));
  ...
  nand2  g082(.a(new_n165_), .b(new_n98_), .O(new_n166_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n88_), .c(new_n98_), .O(new_n175_));
  ...
  nand3  g136(.a(new_n219_), .b(new_n88_), .c(new_n98_), .O(new_n220_));
  ...
  nand3  g141(.a(new_n224_), .b(new_n88_), .c(new_n98_), .O(new_n225_));
  ...
  and2   g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  ...
  nand2  g157(.a(new_n216_), .b(new_n240_), .O(new_n241_));
  nand3  g158(.a(new_n241_), .b(x45), .c(x25), .O(new_n242_));
  nand3  g159(.a(new_n216_), .b(new_n151_), .c(x44), .O(new_n243_));
  aoi21  g160(.a(new_n243_), .b(new_n242_), .c(x10), .O(z33));
  nand3  g161(.a(new_n151_), .b(new_n99_), .c(x09), .O(new_n245_));
  oai21  g162(.a(new_n151_), .b(new_n87_), .c(new_n245_), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(x46), .O(new_n247_));
  nand3  g164(.a(new_n216_), .b(x45), .c(x25), .O(new_n248_));
  ...
  nand3  g168(.a(new_n251_), .b(new_n88_), .c(new_n98_), .O(new_n252_));
