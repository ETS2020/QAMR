...
module FAU ( 
  ...
  nand2  g004(.a(x37), .b(new_n87_), .O(new_n88_));
  ...
  nor2   g078(.a(x37), .b(x08), .O(new_n162_));
  oai21  g079(.a(new_n162_), .b(x28), .c(x27), .O(new_n163_));
  nand2  g080(.a(x28), .b(x08), .O(new_n164_));
  aoi21  g081(.a(new_n164_), .b(new_n163_), .c(x10), .O(z16));
  nor2   g082(.a(new_n87_), .b(x08), .O(new_n166_));
  ...
  nand3  g093(.a(new_n176_), .b(new_n88_), .c(new_n90_), .O(new_n177_));
  ...
  nand3  g103(.a(new_n186_), .b(new_n88_), .c(new_n90_), .O(new_n187_));
  ...
  nand2  g119(.a(x37), .b(new_n87_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(x36), .c(new_n179_), .O(new_n204_));
  and2   g121(.a(x37), .b(x28), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(x09), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n204_), .c(x10), .O(z25));
  nand3  g124(.a(new_n203_), .b(x38), .c(x09), .O(new_n208_));
  nand2  g125(.a(new_n205_), .b(new_n179_), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z26));
  nand2  g127(.a(x14), .b(x00), .O(new_n211_));
  nand2  g128(.a(x39), .b(new_n101_), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(new_n179_), .O(new_n213_));
