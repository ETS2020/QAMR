...
module FAU ( 
  ...
  oai21  g085(.a(x10), .b(x09), .c(x33), .O(new_n169_));
  inv1   g086(.a(x09), .O(new_n170_));
  nand3  g087(.a(x32), .b(new_n84_), .c(new_n170_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n169_), .O(z21));
  oai21  g089(.a(x34), .b(new_n170_), .c(x33), .O(new_n173_));
  ...
  oai21  g094(.a(new_n176_), .b(new_n170_), .c(new_n177_), .O(new_n178_));
  ...
  nand2  g100(.a(new_n183_), .b(new_n89_), .O(z24));
  inv1   g101(.a(x37), .O(new_n185_));
  nand2  g102(.a(x36), .b(new_n170_), .O(new_n186_));
  oai21  g103(.a(new_n185_), .b(new_n170_), .c(new_n186_), .O(new_n187_));
  ...
  aoi21  g139(.a(new_n201_), .b(x09), .c(new_n222_), .O(new_n223_));
  ...
  nand2  g149(.a(new_n232_), .b(new_n89_), .O(z33));
  inv1   g150(.a(x45), .O(new_n234_));
  aoi21  g151(.a(new_n201_), .b(x09), .c(new_n234_), .O(new_n235_));
  ...
  nand2  g155(.a(new_n238_), .b(new_n89_), .O(z34));
  inv1   g156(.a(x46), .O(new_n240_));
  aoi21  g157(.a(new_n201_), .b(x09), .c(new_n240_), .O(new_n241_));
  nand3  g158(.a(new_n201_), .b(x09), .c(x00), .O(new_n242_));
  inv1   g159(.a(new_n242_), .O(new_n243_));
  oai21  g160(.a(new_n243_), .b(new_n241_), .c(new_n84_), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(new_n89_), .O(z35));
endmodule
