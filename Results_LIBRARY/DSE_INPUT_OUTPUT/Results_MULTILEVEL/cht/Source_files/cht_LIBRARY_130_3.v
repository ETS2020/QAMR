...
module FAU ( 
  ...
  nand3  g101(.a(x36), .b(new_n84_), .c(new_n168_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(z25));
  oai21  g103(.a(x38), .b(x10), .c(x09), .O(new_n187_));
  nand3  g104(.a(x37), .b(new_n84_), .c(new_n168_), .O(new_n188_));
  ...
  nor2   g112(.a(x10), .b(x09), .O(new_n196_));
  aoi21  g113(.a(x14), .b(x09), .c(new_n196_), .O(new_n197_));
  aoi21  g114(.a(x40), .b(new_n101_), .c(x10), .O(new_n198_));
  oai22  g115(.a(new_n198_), .b(new_n168_), .c(new_n197_), .d(new_n190_), .O(z28));
  nand2  g116(.a(new_n101_), .b(x09), .O(new_n200_));
  ...
  aoi21  g121(.a(x42), .b(new_n101_), .c(x10), .O(new_n205_));
  oai22  g122(.a(new_n205_), .b(new_n168_), .c(new_n197_), .d(new_n204_), .O(z30));
  nand2  g123(.a(new_n200_), .b(x42), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n101_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z31));
  inv1   g126(.a(x43), .O(new_n210_));
  aoi21  g127(.a(x44), .b(new_n101_), .c(x10), .O(new_n211_));
  oai22  g128(.a(new_n211_), .b(new_n168_), .c(new_n197_), .d(new_n210_), .O(z32));
  inv1   g129(.a(x44), .O(new_n213_));
  aoi21  g130(.a(x45), .b(new_n101_), .c(x10), .O(new_n214_));
  oai22  g131(.a(new_n214_), .b(new_n168_), .c(new_n197_), .d(new_n213_), .O(z33));
  nand2  g132(.a(new_n200_), .b(x45), .O(new_n216_));
  nand3  g133(.a(x46), .b(new_n101_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  inv1   g135(.a(x46), .O(new_n219_));
  aoi21  g136(.a(new_n101_), .b(x00), .c(x10), .O(new_n220_));
  oai22  g137(.a(new_n220_), .b(new_n168_), .c(new_n197_), .d(new_n219_), .O(z35));
endmodule
