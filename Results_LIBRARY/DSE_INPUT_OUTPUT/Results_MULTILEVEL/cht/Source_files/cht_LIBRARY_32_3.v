...
module FAU ( 
  ...
  oai21  g102(.a(x10), .b(x09), .c(x36), .O(new_n186_));
  nand3  g103(.a(x35), .b(new_n84_), .c(new_n168_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(z24));
  oai21  g105(.a(x10), .b(new_n168_), .c(x36), .O(new_n189_));
  nand3  g106(.a(x37), .b(new_n84_), .c(x09), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n189_), .O(z25));
  ...
  aoi21  g133(.a(new_n202_), .b(x09), .c(new_n216_), .O(new_n217_));
  ...
  aoi21  g139(.a(new_n202_), .b(x09), .c(new_n222_), .O(new_n223_));
  ...
  nand3  g149(.a(x46), .b(new_n202_), .c(x09), .O(new_n233_));
