...
module FAU ( 
  ...
  nand2  g094(.a(new_n177_), .b(new_n94_), .O(z25));
  ...
  nand2  g106(.a(new_n99_), .b(x09), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(x39), .O(new_n191_));
  nand3  g108(.a(x40), .b(new_n99_), .c(x09), .O(new_n192_));
  ...
  nand2  g122(.a(new_n190_), .b(x43), .O(new_n206_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n94_), .O(z33));
  ...
  nand3  g138(.a(new_n99_), .b(x09), .c(x00), .O(new_n222_));
