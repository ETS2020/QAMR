...
module FAU ( 
  ...
  nand3  g031(.a(x44), .b(x18), .c(x08), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n114_), .c(x10), .O(z06));
  nand2  g033(.a(x18), .b(new_n113_), .O(new_n117_));
  nand3  g034(.a(x44), .b(x19), .c(x08), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n117_), .c(x10), .O(z07));
  nand2  g036(.a(x19), .b(new_n113_), .O(new_n120_));
  nand3  g037(.a(x44), .b(x20), .c(x08), .O(new_n121_));
  aoi21  g038(.a(new_n121_), .b(new_n120_), .c(x10), .O(z08));
  nand2  g039(.a(x20), .b(new_n113_), .O(new_n123_));
  nand3  g040(.a(x44), .b(x21), .c(x08), .O(new_n124_));
  aoi21  g041(.a(new_n124_), .b(new_n123_), .c(x10), .O(z09));
  aoi21  g042(.a(x22), .b(new_n90_), .c(new_n87_), .O(new_n126_));
  nand3  g043(.a(x21), .b(new_n90_), .c(new_n113_), .O(new_n127_));
  oai21  g044(.a(new_n126_), .b(new_n113_), .c(new_n127_), .O(z10));
  nand2  g045(.a(x22), .b(new_n113_), .O(new_n129_));
  nand3  g046(.a(x44), .b(x23), .c(x08), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n129_), .c(x10), .O(z11));
  nand2  g048(.a(x23), .b(new_n113_), .O(new_n132_));
  nand3  g049(.a(x44), .b(x24), .c(x08), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(new_n132_), .c(x10), .O(z12));
  aoi21  g051(.a(x25), .b(new_n90_), .c(new_n87_), .O(new_n135_));
  nand3  g052(.a(x24), .b(new_n90_), .c(new_n113_), .O(new_n136_));
  oai21  g053(.a(new_n135_), .b(new_n113_), .c(new_n136_), .O(z13));
  nand2  g054(.a(x25), .b(new_n113_), .O(new_n138_));
  nand3  g055(.a(x44), .b(x26), .c(x08), .O(new_n139_));
  aoi21  g056(.a(new_n139_), .b(new_n138_), .c(x10), .O(z14));
  nand2  g057(.a(x26), .b(new_n113_), .O(new_n141_));
  nand3  g058(.a(x44), .b(x27), .c(x08), .O(new_n142_));
  aoi21  g059(.a(new_n142_), .b(new_n141_), .c(x10), .O(z15));
  aoi21  g060(.a(x28), .b(new_n90_), .c(new_n87_), .O(new_n144_));
  nand3  g061(.a(x27), .b(new_n90_), .c(new_n113_), .O(new_n145_));
  oai21  g062(.a(new_n144_), .b(new_n113_), .c(new_n145_), .O(z16));
  aoi21  g063(.a(x29), .b(new_n90_), .c(new_n87_), .O(new_n147_));
  nand3  g064(.a(x28), .b(new_n90_), .c(new_n113_), .O(new_n148_));
  oai21  g065(.a(new_n147_), .b(new_n113_), .c(new_n148_), .O(z17));
  nand2  g066(.a(x29), .b(new_n113_), .O(new_n150_));
  nand3  g067(.a(x44), .b(x30), .c(x08), .O(new_n151_));
  aoi21  g068(.a(new_n151_), .b(new_n150_), .c(x10), .O(z18));
  aoi21  g069(.a(new_n90_), .b(x00), .c(new_n87_), .O(new_n153_));
  nand3  g070(.a(x30), .b(new_n90_), .c(new_n113_), .O(new_n154_));
  oai21  g071(.a(new_n153_), .b(new_n113_), .c(new_n154_), .O(z19));
  ...
  nand3  g139(.a(new_n100_), .b(x09), .c(new_n113_), .O(new_n223_));
  nand2  g140(.a(x44), .b(x08), .O(new_n224_));
  ...
  oai21  g154(.a(new_n237_), .b(new_n235_), .c(new_n90_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n88_), .O(z35));
endmodule
