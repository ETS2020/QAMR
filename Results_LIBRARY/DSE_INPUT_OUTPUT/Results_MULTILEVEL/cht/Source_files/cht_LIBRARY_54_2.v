...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x15), .O(new_n86_));
  ...
  oai21  g088(.a(new_n171_), .b(x10), .c(new_n86_), .O(z19));
  ...
  nand2  g116(.a(new_n199_), .b(new_n86_), .O(z25));
  ...
  nand2  g143(.a(new_n226_), .b(new_n86_), .O(z30));
  inv1   g144(.a(x42), .O(new_n228_));
  nand3  g145(.a(x43), .b(new_n101_), .c(x09), .O(new_n229_));
  ...
  nand2  g167(.a(new_n250_), .b(new_n84_), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(new_n86_), .O(z35));
endmodule
