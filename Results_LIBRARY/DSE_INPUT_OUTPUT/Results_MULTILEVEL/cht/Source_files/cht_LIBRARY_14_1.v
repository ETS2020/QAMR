...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x26), .O(new_n93_));
  ...
  aoi21  g017(.a(x14), .b(new_n92_), .c(x26), .O(new_n101_));
  ...
  aoi21  g025(.a(x16), .b(new_n92_), .c(x26), .O(new_n109_));
  ...
  and2   g068(.a(new_n151_), .b(new_n84_), .O(z17));
  nand2  g069(.a(x29), .b(new_n116_), .O(new_n153_));
  nand2  g070(.a(x30), .b(x08), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n153_), .c(new_n85_), .O(new_n155_));
  and2   g072(.a(new_n155_), .b(new_n84_), .O(z18));
  nand2  g073(.a(x08), .b(x00), .O(new_n157_));
  aoi21  g074(.a(x30), .b(new_n116_), .c(x26), .O(new_n158_));
  ...
  and2   g085(.a(new_n168_), .b(new_n84_), .O(z21));
  ...
  and2   g089(.a(new_n172_), .b(new_n84_), .O(z22));
  ...
  and2   g097(.a(new_n180_), .b(new_n84_), .O(z24));
  ...
  and2   g101(.a(new_n184_), .b(new_n84_), .O(z25));
  ...
  nand3  g131(.a(x43), .b(new_n191_), .c(x09), .O(new_n215_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x26), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n219_), .c(x10), .O(z32));
  nand3  g140(.a(x45), .b(new_n191_), .c(x09), .O(new_n224_));
  ...
  nand2  g144(.a(new_n198_), .b(x45), .O(new_n228_));
  nand3  g145(.a(x46), .b(new_n191_), .c(x09), .O(new_n229_));
  ...
  nand2  g149(.a(new_n198_), .b(x46), .O(new_n233_));
  nand2  g150(.a(new_n209_), .b(x00), .O(new_n234_));
