...
module FAU ( 
  ...
  nand2  g075(.a(x29), .b(new_n118_), .O(new_n159_));
  ...
  nand2  g107(.a(x37), .b(new_n167_), .O(new_n191_));
  ...
  aoi21  g116(.a(new_n100_), .b(x09), .c(new_n194_), .O(new_n200_));
  ...
  nand3  g144(.a(new_n205_), .b(x45), .c(new_n84_), .O(new_n228_));
  aoi21  g145(.a(new_n100_), .b(x09), .c(x10), .O(new_n229_));
  oai21  g146(.a(new_n229_), .b(new_n227_), .c(new_n228_), .O(z34));
  nand3  g147(.a(new_n100_), .b(new_n84_), .c(x09), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(x46), .O(new_n232_));
  nand4  g149(.a(new_n100_), .b(new_n84_), .c(x09), .d(x00), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(new_n232_), .O(z35));
endmodule
