...
module FAU ( 
  ...
  nand2  g001(.a(x45), .b(x35), .O(new_n85_));
  ...
  nand2  g102(.a(x45), .b(x35), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(x34), .c(x09), .O(new_n187_));
  nand3  g104(.a(new_n85_), .b(x33), .c(new_n176_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z22));
  nand3  g106(.a(new_n85_), .b(x34), .c(new_n176_), .O(new_n190_));
  inv1   g107(.a(x45), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(x35), .c(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n190_), .c(x10), .O(z23));
  ...
  aoi21  g131(.a(new_n101_), .b(x09), .c(new_n208_), .O(new_n215_));
  ...
  nand2  g163(.a(new_n246_), .b(new_n85_), .O(z33));
  nand2  g164(.a(x45), .b(new_n194_), .O(new_n248_));
  nand3  g165(.a(new_n191_), .b(new_n101_), .c(x09), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n248_), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(x46), .O(new_n251_));
  nand2  g168(.a(new_n101_), .b(x09), .O(new_n252_));
  nand3  g169(.a(new_n252_), .b(x45), .c(new_n194_), .O(new_n253_));
