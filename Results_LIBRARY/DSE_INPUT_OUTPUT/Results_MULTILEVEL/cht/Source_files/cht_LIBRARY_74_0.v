...
module FAU ( 
  ...
  aoi21  g045(.a(new_n128_), .b(x08), .c(x10), .O(z12));
  ...
  nor2   g059(.a(new_n142_), .b(x10), .O(z19));
  ...
  and2   g085(.a(new_n168_), .b(new_n84_), .O(z25));
  ...
  nor2   g096(.a(new_n179_), .b(new_n97_), .O(z27));
  ...
  aoi21  g121(.a(new_n204_), .b(x09), .c(new_n97_), .O(new_n205_));
  ...
  aoi21  g134(.a(new_n207_), .b(x00), .c(new_n97_), .O(new_n218_));
