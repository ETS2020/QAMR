...
module FAU ( 
  ...
  nand2  g094(.a(new_n177_), .b(new_n90_), .O(z20));
  ...
  nand2  g120(.a(x38), .b(new_n179_), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z27));
  aoi21  g122(.a(new_n102_), .b(x09), .c(new_n200_), .O(new_n206_));
  ...
  aoi21  g128(.a(new_n102_), .b(x09), .c(new_n211_), .O(new_n212_));
  nand3  g129(.a(x41), .b(new_n102_), .c(x09), .O(new_n213_));
  ...
  nand2  g149(.a(new_n229_), .b(x44), .O(new_n233_));
  nand3  g150(.a(x45), .b(new_n102_), .c(x09), .O(new_n234_));
  aoi21  g151(.a(new_n234_), .b(new_n233_), .c(x10), .O(z33));
  nand2  g152(.a(new_n229_), .b(x45), .O(new_n236_));
  ...
  nand3  g157(.a(new_n102_), .b(x09), .c(x00), .O(new_n241_));
