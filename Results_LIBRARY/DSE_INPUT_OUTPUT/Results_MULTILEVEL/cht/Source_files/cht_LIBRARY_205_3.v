...
module FAU ( 
  ...
  nand2  g009(.a(x25), .b(x10), .O(new_n93_));
  ...
  nand2  g045(.a(new_n128_), .b(new_n93_), .O(z10));
  ...
  nand2  g061(.a(x27), .b(new_n111_), .O(new_n145_));
  nand2  g062(.a(x28), .b(x08), .O(new_n146_));
  aoi21  g063(.a(new_n146_), .b(new_n145_), .c(x10), .O(z16));
  nand2  g064(.a(x28), .b(new_n111_), .O(new_n148_));
  ...
  nand2  g084(.a(x33), .b(new_n160_), .O(new_n168_));
  oai21  g085(.a(new_n167_), .b(new_n160_), .c(new_n168_), .O(new_n169_));
  ...
  nand2  g102(.a(x37), .b(new_n160_), .O(new_n186_));
  oai21  g103(.a(new_n185_), .b(new_n160_), .c(new_n186_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n88_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n93_), .O(z26));
  ...
  oai21  g111(.a(new_n194_), .b(x10), .c(new_n93_), .O(z27));
  ...
  nand2  g122(.a(new_n196_), .b(x41), .O(new_n206_));
  ...
  nand2  g133(.a(new_n216_), .b(new_n93_), .O(z32));
  inv1   g134(.a(x44), .O(new_n218_));
  aoi21  g135(.a(new_n98_), .b(x09), .c(new_n218_), .O(new_n219_));
  nand3  g136(.a(x45), .b(new_n98_), .c(x09), .O(new_n220_));
  inv1   g137(.a(new_n220_), .O(new_n221_));
  oai21  g138(.a(new_n221_), .b(new_n219_), .c(new_n88_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n93_), .O(z33));
  nand2  g140(.a(new_n196_), .b(x45), .O(new_n224_));
  nand3  g141(.a(x46), .b(new_n98_), .c(x09), .O(new_n225_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n93_), .O(z35));
endmodule
