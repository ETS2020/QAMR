...
module FAU ( 
  ...
  nand2  g003(.a(x46), .b(x31), .O(new_n87_));
  ...
  nand3  g035(.a(new_n118_), .b(new_n87_), .c(new_n93_), .O(new_n119_));
  ...
  nand3  g040(.a(new_n123_), .b(new_n87_), .c(new_n93_), .O(new_n124_));
  ...
  inv1   g092(.a(x46), .O(new_n176_));
  inv1   g093(.a(x32), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(x09), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n176_), .c(x31), .O(new_n179_));
  ...
  nand2  g107(.a(new_n190_), .b(new_n93_), .O(new_n191_));
  ...
  nand2  g125(.a(new_n208_), .b(new_n93_), .O(new_n209_));
  ...
  aoi21  g133(.a(new_n99_), .b(x09), .c(new_n211_), .O(new_n217_));
  ...
  nand3  g163(.a(new_n246_), .b(new_n87_), .c(new_n93_), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(z33));
  inv1   g165(.a(x45), .O(new_n249_));
  nand2  g166(.a(new_n99_), .b(x09), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  nand3  g168(.a(new_n251_), .b(x46), .c(new_n180_), .O(new_n252_));
  nand3  g169(.a(new_n250_), .b(new_n176_), .c(x45), .O(new_n253_));
  aoi21  g170(.a(new_n253_), .b(new_n252_), .c(x10), .O(z34));
  nand2  g171(.a(x46), .b(new_n180_), .O(new_n255_));
  nand3  g172(.a(new_n176_), .b(new_n99_), .c(x09), .O(new_n256_));
  nand2  g173(.a(new_n256_), .b(new_n255_), .O(new_n257_));
  nand2  g174(.a(new_n257_), .b(x00), .O(new_n258_));
  nand3  g175(.a(new_n250_), .b(x46), .c(new_n180_), .O(new_n259_));
