...
module FAU ( 
  ...
  oai21  g042(.a(new_n125_), .b(x10), .c(new_n87_), .O(z07));
  ...
  oai21  g061(.a(new_n144_), .b(x10), .c(new_n87_), .O(z11));
  ...
  aoi21  g069(.a(x25), .b(x08), .c(new_n152_), .O(new_n153_));
  oai21  g070(.a(new_n153_), .b(x10), .c(new_n87_), .O(z13));
  oai21  g071(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(x25), .O(new_n156_));
  nand2  g073(.a(x26), .b(x08), .O(new_n157_));
  aoi21  g074(.a(new_n157_), .b(new_n156_), .c(x10), .O(z14));
  nor2   g075(.a(new_n85_), .b(x08), .O(new_n159_));
  ...
  oai21  g095(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n179_));
  ...
  oai21  g100(.a(new_n86_), .b(x09), .c(new_n183_), .O(new_n184_));
  ...
  oai21  g133(.a(x14), .b(new_n187_), .c(x39), .O(new_n217_));
  ...
  oai21  g144(.a(x14), .b(new_n187_), .c(x41), .O(new_n228_));
  ...
  oai21  g149(.a(x14), .b(new_n187_), .c(x42), .O(new_n233_));
  ...
  oai21  g154(.a(x14), .b(new_n187_), .c(x43), .O(new_n238_));
  ...
  oai21  g159(.a(x14), .b(new_n187_), .c(x44), .O(new_n243_));
