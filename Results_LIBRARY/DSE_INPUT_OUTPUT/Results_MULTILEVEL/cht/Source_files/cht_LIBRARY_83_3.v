...
module FAU ( 
  ...
  nand2  g003(.a(x46), .b(x41), .O(new_n87_));
  ...
  nand3  g049(.a(new_n132_), .b(new_n87_), .c(new_n93_), .O(new_n133_));
  ...
  nand3  g082(.a(new_n165_), .b(new_n87_), .c(new_n93_), .O(new_n166_));
  ...
  nand3  g087(.a(new_n170_), .b(new_n87_), .c(new_n93_), .O(new_n171_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n93_), .O(new_n181_));
  ...
  nand2  g101(.a(new_n184_), .b(new_n93_), .O(new_n185_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n87_), .c(new_n93_), .O(new_n203_));
  ...
  nand3  g135(.a(new_n218_), .b(new_n87_), .c(new_n93_), .O(new_n219_));
  inv1   g136(.a(new_n219_), .O(z28));
  inv1   g137(.a(x46), .O(new_n221_));
  inv1   g138(.a(x40), .O(new_n222_));
  nand2  g139(.a(new_n99_), .b(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n221_), .c(x41), .O(new_n225_));
  ...
  aoi21  g145(.a(new_n99_), .b(x09), .c(new_n226_), .O(new_n229_));
  ...
  oai21  g150(.a(x14), .b(new_n177_), .c(x42), .O(new_n234_));
  ...
  nand3  g168(.a(x46), .b(new_n99_), .c(x09), .O(new_n252_));
  ...
  nand2  g172(.a(x46), .b(new_n226_), .O(new_n256_));
  nand3  g173(.a(new_n221_), .b(new_n99_), .c(x09), .O(new_n257_));
  nand2  g174(.a(new_n257_), .b(new_n256_), .O(new_n258_));
  nand2  g175(.a(new_n258_), .b(x00), .O(new_n259_));
  nand3  g176(.a(new_n223_), .b(x46), .c(new_n226_), .O(new_n260_));
  aoi21  g177(.a(new_n260_), .b(new_n259_), .c(x10), .O(z35));
endmodule
