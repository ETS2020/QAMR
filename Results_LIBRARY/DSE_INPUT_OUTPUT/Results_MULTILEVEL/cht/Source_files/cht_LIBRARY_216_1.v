...
module FAU ( 
  ...
  nand2  g053(.a(x26), .b(new_n93_), .O(new_n137_));
  ...
  oai21  g059(.a(x28), .b(x10), .c(new_n93_), .O(new_n143_));
  nand3  g060(.a(x29), .b(new_n88_), .c(x08), .O(new_n144_));
  ...
  nand2  g086(.a(new_n169_), .b(new_n94_), .O(z24));
  ...
  nand2  g091(.a(new_n174_), .b(new_n94_), .O(z25));
  ...
  nand2  g107(.a(new_n190_), .b(new_n94_), .O(z28));
  ...
  nand2  g113(.a(new_n196_), .b(new_n94_), .O(z29));
  ...
  nand2  g119(.a(new_n202_), .b(new_n94_), .O(z30));
  ...
  nand2  g141(.a(new_n224_), .b(new_n94_), .O(z35));
endmodule
