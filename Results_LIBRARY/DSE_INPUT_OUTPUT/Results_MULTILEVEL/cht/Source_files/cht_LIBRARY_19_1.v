...
module FAU ( 
  ...
  oai21  g035(.a(x20), .b(x10), .c(new_n96_), .O(new_n119_));
  nand3  g036(.a(x21), .b(new_n91_), .c(x08), .O(new_n120_));
  ...
  nand2  g044(.a(x23), .b(new_n96_), .O(new_n128_));
  ...
  oai21  g056(.a(x27), .b(x10), .c(new_n96_), .O(new_n140_));
  nand3  g057(.a(x28), .b(new_n91_), .c(x08), .O(new_n141_));
  ...
  oai21  g065(.a(x30), .b(x10), .c(new_n96_), .O(new_n149_));
  nand3  g066(.a(new_n91_), .b(x08), .c(x00), .O(new_n150_));
  ...
  oai21  g104(.a(new_n187_), .b(x10), .c(new_n97_), .O(z27));
  ...
  nand2  g115(.a(new_n198_), .b(new_n97_), .O(z29));
  ...
  nand2  g121(.a(new_n204_), .b(new_n97_), .O(z30));
  ...
  nand2  g127(.a(new_n210_), .b(new_n97_), .O(z31));
  nand2  g128(.a(new_n190_), .b(x43), .O(new_n212_));
  nand3  g129(.a(x44), .b(new_n189_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z32));
  nand2  g131(.a(new_n190_), .b(x44), .O(new_n215_));
  ...
  aoi21  g138(.a(new_n189_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(new_n189_), .b(x09), .c(x00), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(new_n224_));
  oai21  g141(.a(new_n224_), .b(new_n222_), .c(new_n91_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n97_), .O(z35));
endmodule
