...
module FAU ( 
  ...
  nand2  g141(.a(new_n206_), .b(x43), .O(new_n225_));
  nand3  g142(.a(x44), .b(new_n205_), .c(x09), .O(new_n226_));
  ...
  nand3  g148(.a(x46), .b(new_n205_), .c(x09), .O(new_n232_));
  ...
  nand3  g152(.a(new_n205_), .b(x09), .c(x00), .O(new_n236_));
