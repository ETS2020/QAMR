...
module FAU ( 
  ...
  nand2  g003(.a(x40), .b(x37), .O(new_n87_));
  ...
  nand3  g031(.a(new_n114_), .b(new_n87_), .c(new_n89_), .O(new_n115_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n87_), .c(new_n89_), .O(new_n143_));
  ...
  nand3  g079(.a(new_n162_), .b(new_n87_), .c(new_n89_), .O(new_n163_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n87_), .c(new_n89_), .O(new_n176_));
  ...
  nand3  g102(.a(new_n185_), .b(new_n87_), .c(new_n89_), .O(new_n186_));
  ...
  oai21  g124(.a(new_n206_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n89_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n87_), .O(z26));
  nand2  g127(.a(x14), .b(x00), .O(new_n211_));
  nand2  g128(.a(x39), .b(new_n99_), .O(new_n212_));
  ...
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(new_n87_), .O(new_n216_));
  nor2   g133(.a(new_n216_), .b(x10), .O(z27));
  inv1   g134(.a(x39), .O(new_n218_));
  nand2  g135(.a(new_n99_), .b(x09), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n218_), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(x40), .c(new_n206_), .O(new_n221_));
  inv1   g138(.a(x40), .O(new_n222_));
  nand3  g139(.a(new_n219_), .b(new_n222_), .c(x39), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(new_n221_), .c(x10), .O(z28));
  nand3  g141(.a(new_n222_), .b(new_n99_), .c(x09), .O(new_n225_));
  oai21  g142(.a(new_n222_), .b(x37), .c(new_n225_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(x41), .O(new_n227_));
  nand3  g144(.a(new_n219_), .b(x40), .c(new_n206_), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z29));
  nand2  g146(.a(new_n219_), .b(x41), .O(new_n230_));
  nand3  g147(.a(x42), .b(new_n99_), .c(x09), .O(new_n231_));
  ...
  aoi21  g153(.a(new_n219_), .b(x42), .c(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(x10), .c(new_n87_), .O(z31));
  nand2  g155(.a(new_n219_), .b(x43), .O(new_n239_));
  ...
  nand2  g160(.a(new_n219_), .b(x44), .O(new_n244_));
  ...
  aoi21  g167(.a(new_n219_), .b(x45), .c(new_n250_), .O(new_n251_));
  oai21  g168(.a(new_n251_), .b(x10), .c(new_n87_), .O(z34));
  inv1   g169(.a(x00), .O(new_n253_));
  nand2  g170(.a(new_n219_), .b(x46), .O(new_n254_));
  oai21  g171(.a(new_n219_), .b(new_n253_), .c(new_n254_), .O(new_n255_));
  nand3  g172(.a(new_n255_), .b(new_n87_), .c(new_n89_), .O(new_n256_));
