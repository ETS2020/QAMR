...
module FAU ( 
  ...
  aoi21  g084(.a(x30), .b(new_n109_), .c(new_n92_), .O(new_n168_));
  ...
  nand2  g097(.a(new_n174_), .b(x37), .O(new_n181_));
  ...
  and2   g104(.a(new_n187_), .b(new_n84_), .O(z27));
  ...
  nand2  g137(.a(new_n98_), .b(x00), .O(new_n221_));
