...
module FAU ( 
  ...
  nand2  g041(.a(x21), .b(new_n113_), .O(new_n125_));
  ...
  nand2  g051(.a(new_n134_), .b(new_n103_), .O(z12));
  ...
  oai21  g059(.a(new_n102_), .b(x08), .c(new_n142_), .O(new_n143_));
  ...
  nand2  g073(.a(new_n156_), .b(new_n103_), .O(z18));
  ...
  nand2  g092(.a(new_n175_), .b(new_n97_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n103_), .O(z23));
  ...
  nand2  g101(.a(new_n184_), .b(new_n103_), .O(z25));
  ...
  oai21  g111(.a(new_n194_), .b(x10), .c(new_n103_), .O(z27));
  ...
  oai21  g116(.a(new_n199_), .b(new_n197_), .c(new_n97_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n103_), .O(z28));
  ...
  nand3  g139(.a(new_n196_), .b(x09), .c(x00), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(new_n224_));
  oai21  g141(.a(new_n224_), .b(new_n222_), .c(new_n97_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n103_), .O(z35));
endmodule
