...
module FAU ( 
  ...
  nand2  g071(.a(new_n154_), .b(new_n90_), .O(z17));
  ...
  aoi21  g147(.a(new_n200_), .b(x09), .c(new_n230_), .O(new_n231_));
  nand3  g148(.a(x45), .b(new_n200_), .c(x09), .O(new_n232_));
  ...
  aoi21  g153(.a(new_n200_), .b(x09), .c(new_n236_), .O(new_n237_));
  nand3  g154(.a(x46), .b(new_n200_), .c(x09), .O(new_n238_));
  ...
  aoi21  g158(.a(new_n200_), .b(x09), .c(new_n89_), .O(new_n242_));
  nand3  g159(.a(new_n200_), .b(x09), .c(x00), .O(new_n243_));
