...
module FAU ( 
  ...
  nand2  g093(.a(new_n176_), .b(new_n90_), .O(z24));
  ...
  nand2  g102(.a(new_n185_), .b(new_n90_), .O(z26));
  ...
  aoi21  g110(.a(new_n101_), .b(x09), .c(new_n187_), .O(new_n194_));
  ...
  nand3  g139(.a(new_n101_), .b(x09), .c(x00), .O(new_n223_));
