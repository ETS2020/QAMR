...
module FAU ( 
  ...
  oai21  g026(.a(x17), .b(x10), .c(new_n96_), .O(new_n110_));
  nand3  g027(.a(x18), .b(new_n91_), .c(x08), .O(new_n111_));
  nand2  g028(.a(new_n111_), .b(new_n110_), .O(z06));
  oai21  g029(.a(x18), .b(x10), .c(new_n96_), .O(new_n113_));
  nand3  g030(.a(x19), .b(new_n91_), .c(x08), .O(new_n114_));
  nand2  g031(.a(new_n114_), .b(new_n113_), .O(z07));
  nand2  g032(.a(x19), .b(new_n96_), .O(new_n116_));
  ...
  nand2  g047(.a(x24), .b(new_n96_), .O(new_n131_));
  nand2  g048(.a(x25), .b(x08), .O(new_n132_));
  aoi21  g049(.a(new_n132_), .b(new_n131_), .c(x10), .O(z13));
  oai21  g050(.a(x25), .b(x10), .c(new_n96_), .O(new_n134_));
  nand3  g051(.a(x26), .b(new_n91_), .c(x08), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(new_n134_), .O(z14));
  nand2  g053(.a(x26), .b(new_n96_), .O(new_n137_));
  ...
  nand2  g073(.a(new_n156_), .b(new_n97_), .O(z20));
  ...
  nand2  g077(.a(new_n160_), .b(new_n97_), .O(z21));
  ...
  nand2  g082(.a(new_n165_), .b(new_n97_), .O(z22));
  ...
  nand2  g086(.a(new_n169_), .b(new_n97_), .O(z23));
  ...
  nand2  g094(.a(new_n177_), .b(new_n97_), .O(z25));
  ...
  nand2  g098(.a(new_n181_), .b(new_n97_), .O(z26));
  ...
  oai21  g105(.a(new_n188_), .b(x10), .c(new_n97_), .O(z27));
  ...
  nand2  g110(.a(new_n193_), .b(new_n97_), .O(z28));
  ...
  nand2  g120(.a(new_n203_), .b(new_n97_), .O(z30));
  ...
  nand2  g126(.a(new_n209_), .b(new_n97_), .O(z31));
  ...
  nand2  g147(.a(new_n230_), .b(new_n97_), .O(z35));
endmodule
