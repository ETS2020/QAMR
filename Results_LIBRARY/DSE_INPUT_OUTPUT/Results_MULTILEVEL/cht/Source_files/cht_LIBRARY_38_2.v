...
module FAU ( 
  ...
  oai21  g013(.a(x13), .b(x07), .c(x06), .O(new_n97_));
  ...
  nand2  g066(.a(x26), .b(new_n116_), .O(new_n150_));
  nand2  g067(.a(x27), .b(x08), .O(new_n151_));
  aoi21  g068(.a(new_n151_), .b(new_n150_), .c(x10), .O(z15));
  nand2  g069(.a(x27), .b(new_n116_), .O(new_n153_));
  ...
  nand2  g080(.a(new_n163_), .b(new_n90_), .O(z18));
  ...
  nand2  g106(.a(x36), .b(new_n168_), .O(new_n190_));
  oai21  g107(.a(new_n189_), .b(new_n168_), .c(new_n190_), .O(new_n191_));
  ...
  nand2  g118(.a(x38), .b(new_n168_), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z27));
  aoi21  g120(.a(new_n101_), .b(x09), .c(new_n198_), .O(new_n204_));
  nand3  g121(.a(x40), .b(new_n101_), .c(x09), .O(new_n205_));
  ...
  nand3  g133(.a(x42), .b(new_n101_), .c(x09), .O(new_n217_));
  ...
  nand2  g142(.a(new_n225_), .b(new_n90_), .O(z31));
  inv1   g143(.a(x43), .O(new_n227_));
  aoi21  g144(.a(new_n101_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(x44), .b(new_n101_), .c(x09), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(new_n230_));
  oai21  g147(.a(new_n230_), .b(new_n228_), .c(new_n84_), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n90_), .O(z32));
  nand2  g149(.a(new_n101_), .b(x09), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(x44), .O(new_n234_));
  nand3  g151(.a(x45), .b(new_n101_), .c(x09), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n234_), .c(x10), .O(z33));
  nand2  g153(.a(new_n233_), .b(x45), .O(new_n237_));
  nand3  g154(.a(x46), .b(new_n101_), .c(x09), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(new_n237_), .c(x10), .O(z34));
  nand2  g156(.a(new_n233_), .b(x46), .O(new_n240_));
  nand3  g157(.a(new_n101_), .b(x09), .c(x00), .O(new_n241_));
