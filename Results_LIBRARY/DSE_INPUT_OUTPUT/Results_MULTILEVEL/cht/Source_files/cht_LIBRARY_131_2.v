...
module FAU ( 
  ...
  oai21  g127(.a(x39), .b(x14), .c(x00), .O(new_n211_));
  ...
  oai21  g131(.a(new_n214_), .b(new_n213_), .c(new_n84_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n86_), .O(z27));
  oai21  g133(.a(x14), .b(new_n178_), .c(new_n85_), .O(new_n217_));
  aoi21  g134(.a(new_n100_), .b(x09), .c(new_n85_), .O(new_n218_));
  ...
  nor2   g138(.a(x14), .b(new_n178_), .O(new_n222_));
  nand3  g139(.a(x41), .b(new_n100_), .c(x09), .O(new_n223_));
  oai21  g140(.a(new_n222_), .b(new_n221_), .c(new_n223_), .O(new_n224_));
  ...
  oai21  g145(.a(new_n222_), .b(new_n227_), .c(new_n228_), .O(new_n229_));
  ...
  oai21  g150(.a(new_n222_), .b(new_n232_), .c(new_n233_), .O(new_n234_));
  ...
  oai21  g155(.a(new_n222_), .b(new_n237_), .c(new_n238_), .O(new_n239_));
  ...
  oai21  g160(.a(new_n222_), .b(new_n242_), .c(new_n243_), .O(new_n244_));
  ...
  oai21  g165(.a(new_n222_), .b(new_n247_), .c(new_n248_), .O(new_n249_));
  ...
  oai21  g170(.a(new_n222_), .b(new_n252_), .c(new_n253_), .O(new_n254_));
