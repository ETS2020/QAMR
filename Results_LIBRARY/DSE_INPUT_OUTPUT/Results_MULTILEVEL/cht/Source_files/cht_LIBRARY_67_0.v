...
module FAU ( 
  ...
  nand3  g075(.a(new_n158_), .b(new_n87_), .c(new_n84_), .O(new_n159_));
  ...
  oai21  g124(.a(new_n85_), .b(x09), .c(new_n207_), .O(new_n208_));
  ...
  aoi21  g134(.a(new_n101_), .b(x09), .c(new_n211_), .O(new_n218_));
  ...
  nand2  g150(.a(new_n233_), .b(new_n87_), .O(z30));
  ...
  nand3  g157(.a(x37), .b(new_n101_), .c(x09), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n86_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(x44), .O(new_n243_));
  oai21  g160(.a(x14), .b(new_n179_), .c(x43), .O(new_n244_));
  ...
  aoi21  g168(.a(new_n101_), .b(x09), .c(new_n251_), .O(new_n252_));
  ...
  aoi21  g174(.a(new_n101_), .b(x09), .c(new_n257_), .O(new_n258_));
  ...
  nand2  g178(.a(new_n261_), .b(new_n87_), .O(z35));
endmodule
