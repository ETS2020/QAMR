...
module FAU ( 
  ...
  oai21  g045(.a(new_n127_), .b(new_n108_), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g060(.a(new_n142_), .b(new_n108_), .c(new_n143_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n91_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n97_), .O(z15));
  ...
  nand2  g071(.a(new_n154_), .b(new_n97_), .O(z17));
  nand2  g072(.a(x29), .b(new_n108_), .O(new_n156_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n97_), .O(z19));
  ...
  nand2  g097(.a(new_n180_), .b(new_n97_), .O(z24));
  ...
  nand2  g101(.a(new_n184_), .b(new_n97_), .O(z25));
  ...
  nand2  g106(.a(new_n189_), .b(new_n97_), .O(z26));
  ...
  nand3  g122(.a(x42), .b(new_n197_), .c(x09), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z30));
  nand2  g124(.a(new_n198_), .b(x42), .O(new_n208_));
  nand3  g125(.a(x43), .b(new_n197_), .c(x09), .O(new_n209_));
  ...
  nand3  g129(.a(x44), .b(new_n197_), .c(x09), .O(new_n213_));
  ...
  nand3  g134(.a(x45), .b(new_n197_), .c(x09), .O(new_n218_));
  ...
  nand3  g138(.a(x46), .b(new_n197_), .c(x09), .O(new_n222_));
