...
module FAU ( 
  ...
  nand2  g054(.a(x24), .b(new_n120_), .O(new_n138_));
  ...
  nand2  g062(.a(x26), .b(new_n120_), .O(new_n146_));
  nand2  g063(.a(x27), .b(x08), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n146_), .c(x10), .O(z15));
  nand2  g065(.a(x27), .b(new_n120_), .O(new_n149_));
