...
module FAU ( 
  ...
  oai21  g041(.a(x20), .b(x10), .c(new_n93_), .O(new_n125_));
  nand3  g042(.a(x21), .b(new_n88_), .c(x08), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(new_n125_), .O(z09));
  oai21  g044(.a(x21), .b(x10), .c(new_n93_), .O(new_n128_));
  nand3  g045(.a(x22), .b(new_n88_), .c(x08), .O(new_n129_));
  nand2  g046(.a(new_n129_), .b(new_n128_), .O(z10));
  nand2  g047(.a(x22), .b(new_n93_), .O(new_n131_));
  ...
  oai21  g053(.a(x24), .b(x10), .c(new_n93_), .O(new_n137_));
  nand3  g054(.a(x25), .b(new_n88_), .c(x08), .O(new_n138_));
  ...
  nand2  g068(.a(x29), .b(new_n93_), .O(new_n152_));
  ...
  nand2  g087(.a(new_n170_), .b(new_n94_), .O(z22));
  ...
  nand2  g091(.a(new_n174_), .b(new_n94_), .O(z23));
  ...
  oai21  g107(.a(new_n190_), .b(x10), .c(new_n94_), .O(z27));
  ...
  aoi21  g120(.a(new_n101_), .b(x09), .c(new_n203_), .O(new_n204_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n94_), .O(z30));
  ...
  nand3  g146(.a(new_n101_), .b(x09), .c(x00), .O(new_n230_));
