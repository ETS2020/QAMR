...
module FAU ( 
  ...
  nand3  g107(.a(x38), .b(new_n84_), .c(new_n164_), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n190_), .O(z27));
  nand2  g109(.a(new_n187_), .b(x09), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(x39), .O(new_n194_));
  nand3  g111(.a(x40), .b(new_n187_), .c(x09), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z28));
  nand2  g113(.a(new_n193_), .b(x40), .O(new_n197_));
  nand3  g114(.a(x41), .b(new_n187_), .c(x09), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z29));
  inv1   g116(.a(x41), .O(new_n200_));
  nor2   g117(.a(x10), .b(x09), .O(new_n201_));
  aoi21  g118(.a(x14), .b(x09), .c(new_n201_), .O(new_n202_));
  aoi21  g119(.a(x42), .b(new_n187_), .c(x10), .O(new_n203_));
  oai22  g120(.a(new_n203_), .b(new_n164_), .c(new_n202_), .d(new_n200_), .O(z30));
  inv1   g121(.a(x42), .O(new_n205_));
  aoi21  g122(.a(x43), .b(new_n187_), .c(x10), .O(new_n206_));
  oai22  g123(.a(new_n206_), .b(new_n164_), .c(new_n202_), .d(new_n205_), .O(z31));
  nand2  g124(.a(new_n193_), .b(x43), .O(new_n208_));
  ...
  oai22  g129(.a(new_n212_), .b(new_n164_), .c(new_n202_), .d(new_n211_), .O(z33));
  nand2  g130(.a(new_n193_), .b(x45), .O(new_n214_));
  nand3  g131(.a(x46), .b(new_n187_), .c(x09), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n214_), .c(x10), .O(z34));
  nand2  g133(.a(new_n193_), .b(x46), .O(new_n217_));
