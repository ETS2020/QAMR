...
module FAU ( 
  ...
  nor2   g070(.a(new_n85_), .b(x08), .O(new_n154_));
  ...
  oai21  g090(.a(new_n173_), .b(x10), .c(new_n86_), .O(z19));
  ...
  nand3  g149(.a(new_n232_), .b(x43), .c(x26), .O(new_n233_));
  ...
  nand2  g153(.a(x43), .b(x26), .O(new_n237_));
  nand3  g154(.a(new_n234_), .b(new_n101_), .c(x09), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(x44), .O(new_n240_));
  nand3  g157(.a(new_n231_), .b(x43), .c(x26), .O(new_n241_));
