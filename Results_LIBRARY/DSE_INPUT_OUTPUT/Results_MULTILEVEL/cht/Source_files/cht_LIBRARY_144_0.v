...
module FAU ( 
  ...
  nand3  g023(.a(new_n106_), .b(x38), .c(new_n89_), .O(new_n107_));
  ...
  nand3  g044(.a(new_n127_), .b(x38), .c(new_n89_), .O(new_n128_));
  ...
  aoi21  g077(.a(x30), .b(new_n109_), .c(new_n86_), .O(new_n161_));
  ...
  nand3  g110(.a(new_n193_), .b(x38), .c(new_n89_), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z27));
  oai21  g112(.a(x14), .b(new_n163_), .c(x39), .O(new_n196_));
  nand3  g113(.a(x40), .b(new_n191_), .c(x09), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(x38), .c(new_n89_), .O(new_n199_));
