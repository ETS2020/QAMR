...
module FAU ( 
  ...
  nand2  g001(.a(x46), .b(x24), .O(new_n85_));
  ...
  nor2   g056(.a(x24), .b(x08), .O(new_n140_));
  inv1   g057(.a(x24), .O(new_n141_));
  nor2   g058(.a(x46), .b(new_n141_), .O(new_n142_));
  oai21  g059(.a(new_n142_), .b(new_n140_), .c(x23), .O(new_n143_));
  nand2  g060(.a(new_n142_), .b(x08), .O(new_n144_));
  aoi21  g061(.a(new_n144_), .b(new_n143_), .c(x10), .O(z12));
  nor2   g062(.a(new_n141_), .b(x08), .O(new_n146_));
  ...
  oai21  g134(.a(new_n217_), .b(x10), .c(new_n85_), .O(z28));
  ...
  oai21  g138(.a(new_n221_), .b(x10), .c(new_n85_), .O(z29));
  ...
  oai21  g142(.a(new_n225_), .b(x10), .c(new_n85_), .O(z30));
  ...
  nand2  g159(.a(new_n214_), .b(new_n242_), .O(new_n243_));
  nand3  g160(.a(new_n243_), .b(x46), .c(new_n141_), .O(new_n244_));
  inv1   g161(.a(x46), .O(new_n245_));
  nand3  g162(.a(new_n214_), .b(new_n245_), .c(x45), .O(new_n246_));
  aoi21  g163(.a(new_n246_), .b(new_n244_), .c(x10), .O(z34));
  ...
  nand2  g168(.a(new_n251_), .b(new_n85_), .O(z35));
endmodule
