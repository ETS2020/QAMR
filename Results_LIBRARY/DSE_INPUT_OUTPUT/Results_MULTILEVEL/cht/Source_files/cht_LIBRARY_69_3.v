...
module FAU ( 
  ...
  nand2  g009(.a(x27), .b(x10), .O(new_n93_));
  ...
  nand2  g032(.a(new_n115_), .b(new_n93_), .O(z06));
  ...
  nand2  g036(.a(new_n119_), .b(new_n93_), .O(z07));
  ...
  nand2  g041(.a(new_n124_), .b(new_n93_), .O(z08));
  ...
  nand2  g045(.a(new_n128_), .b(new_n93_), .O(z09));
  ...
  nand2  g050(.a(new_n133_), .b(new_n93_), .O(z10));
  ...
  oai21  g066(.a(x10), .b(x08), .c(x27), .O(new_n150_));
  nand3  g067(.a(x26), .b(new_n88_), .c(new_n111_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n150_), .O(z15));
  oai21  g069(.a(x28), .b(new_n111_), .c(x27), .O(new_n153_));
  ...
  nand2  g076(.a(new_n159_), .b(new_n93_), .O(z17));
  ...
  nand2  g097(.a(new_n180_), .b(new_n93_), .O(z23));
  ...
  nand2  g105(.a(new_n188_), .b(new_n93_), .O(z25));
  ...
  aoi21  g115(.a(new_n100_), .b(x09), .c(new_n193_), .O(new_n199_));
  ...
  nand2  g119(.a(new_n202_), .b(new_n93_), .O(z28));
  ...
  nand2  g129(.a(new_n212_), .b(new_n93_), .O(z30));
