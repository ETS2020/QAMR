...
module FAU ( 
  ...
  oai21  g065(.a(x27), .b(new_n113_), .c(x26), .O(new_n149_));
  nand2  g066(.a(x27), .b(x08), .O(new_n150_));
  aoi21  g067(.a(new_n150_), .b(new_n149_), .c(x10), .O(z15));
  oai21  g068(.a(x10), .b(new_n113_), .c(x27), .O(new_n152_));
  nand3  g069(.a(x28), .b(new_n84_), .c(x08), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n152_), .O(z16));
  ...
  nand2  g093(.a(new_n176_), .b(new_n89_), .O(z22));
  ...
  nand2  g102(.a(x36), .b(new_n166_), .O(new_n186_));
  ...
  nand2  g109(.a(new_n192_), .b(new_n89_), .O(z26));
  ...
  aoi21  g117(.a(new_n200_), .b(x09), .c(new_n194_), .O(new_n201_));
  ...
  nand3  g134(.a(x44), .b(new_n200_), .c(x09), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(new_n217_), .c(new_n84_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n89_), .O(z32));
  nand2  g138(.a(new_n206_), .b(x44), .O(new_n222_));
  nand3  g139(.a(x45), .b(new_n200_), .c(x09), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(new_n222_), .c(x10), .O(z33));
  inv1   g141(.a(x45), .O(new_n225_));
  aoi21  g142(.a(new_n200_), .b(x09), .c(new_n225_), .O(new_n226_));
  nand3  g143(.a(x46), .b(new_n200_), .c(x09), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(new_n228_));
  oai21  g145(.a(new_n228_), .b(new_n226_), .c(new_n84_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n89_), .O(z34));
  nand2  g147(.a(new_n206_), .b(x46), .O(new_n231_));
  nand3  g148(.a(new_n200_), .b(x09), .c(x00), .O(new_n232_));
