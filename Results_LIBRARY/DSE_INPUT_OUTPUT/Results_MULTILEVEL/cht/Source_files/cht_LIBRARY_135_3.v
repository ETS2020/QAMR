...
module FAU ( 
  ...
  nand2  g082(.a(x30), .b(new_n115_), .O(new_n166_));
  ...
  oai21  g097(.a(x36), .b(x10), .c(x09), .O(new_n181_));
  nand3  g098(.a(x35), .b(new_n84_), .c(new_n168_), .O(new_n182_));
  ...
  aoi21  g115(.a(x40), .b(new_n101_), .c(x10), .O(new_n199_));
  ...
  nand3  g119(.a(x41), .b(new_n101_), .c(x09), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z29));
  inv1   g121(.a(x41), .O(new_n205_));
  aoi21  g122(.a(x42), .b(new_n101_), .c(x10), .O(new_n206_));
  oai22  g123(.a(new_n206_), .b(new_n168_), .c(new_n198_), .d(new_n205_), .O(z30));
  inv1   g124(.a(x42), .O(new_n208_));
  aoi21  g125(.a(x43), .b(new_n101_), .c(x10), .O(new_n209_));
  oai22  g126(.a(new_n209_), .b(new_n168_), .c(new_n198_), .d(new_n208_), .O(z31));
  ...
  aoi21  g131(.a(x45), .b(new_n101_), .c(x10), .O(new_n215_));
  oai22  g132(.a(new_n215_), .b(new_n168_), .c(new_n198_), .d(new_n214_), .O(z33));
  inv1   g133(.a(x45), .O(new_n217_));
  aoi21  g134(.a(x46), .b(new_n101_), .c(x10), .O(new_n218_));
  oai22  g135(.a(new_n218_), .b(new_n168_), .c(new_n198_), .d(new_n217_), .O(z34));
  nand2  g136(.a(new_n201_), .b(x46), .O(new_n220_));
