...
module FAU ( 
  ...
  nand3  g032(.a(x18), .b(new_n84_), .c(new_n112_), .O(new_n116_));
  ...
  nand3  g038(.a(x20), .b(new_n84_), .c(new_n112_), .O(new_n122_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n89_), .O(z21));
  ...
  oai21  g100(.a(new_n183_), .b(x10), .c(new_n89_), .O(z27));
  inv1   g101(.a(x14), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(x09), .c(new_n178_), .O(new_n186_));
  nand3  g103(.a(x40), .b(new_n185_), .c(x09), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(new_n188_));
  oai21  g105(.a(new_n188_), .b(new_n186_), .c(new_n84_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n89_), .O(z28));
  nand2  g107(.a(new_n185_), .b(x09), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(x40), .O(new_n192_));
  nand3  g109(.a(x41), .b(new_n185_), .c(x09), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(new_n192_), .c(x10), .O(z29));
  nand2  g111(.a(new_n191_), .b(x41), .O(new_n195_));
  nand3  g112(.a(x42), .b(new_n185_), .c(x09), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z30));
  nand2  g114(.a(new_n191_), .b(x42), .O(new_n198_));
  nand3  g115(.a(x43), .b(new_n185_), .c(x09), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z31));
  nand2  g117(.a(new_n191_), .b(x43), .O(new_n201_));
  nand3  g118(.a(x44), .b(new_n185_), .c(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z32));
  nand2  g120(.a(new_n191_), .b(x44), .O(new_n204_));
  nand3  g121(.a(x45), .b(new_n185_), .c(x09), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z33));
  inv1   g123(.a(x45), .O(new_n207_));
  aoi21  g124(.a(new_n185_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand3  g125(.a(x46), .b(new_n185_), .c(x09), .O(new_n209_));
  ...
  nand2  g129(.a(new_n191_), .b(x46), .O(new_n213_));
