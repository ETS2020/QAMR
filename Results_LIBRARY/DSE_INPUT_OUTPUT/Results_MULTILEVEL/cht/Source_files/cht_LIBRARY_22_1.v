...
module FAU ( 
  ...
  nand2  g066(.a(new_n149_), .b(new_n100_), .O(z15));
  ...
  nand2  g090(.a(new_n173_), .b(new_n100_), .O(z21));
  ...
  nand2  g098(.a(new_n181_), .b(new_n100_), .O(z23));
  ...
  nand2  g106(.a(new_n189_), .b(new_n100_), .O(z25));
  ...
  aoi21  g116(.a(new_n95_), .b(x09), .c(new_n194_), .O(new_n200_));
  nand3  g117(.a(x40), .b(new_n95_), .c(x09), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(new_n202_));
  oai21  g119(.a(new_n202_), .b(new_n200_), .c(new_n94_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n100_), .O(z28));
  nand2  g121(.a(new_n95_), .b(x09), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(x40), .O(new_n206_));
  nand3  g123(.a(x41), .b(new_n95_), .c(x09), .O(new_n207_));
  ...
  nand3  g147(.a(x46), .b(new_n95_), .c(x09), .O(new_n231_));
  ...
  nand2  g154(.a(new_n237_), .b(new_n100_), .O(z35));
endmodule
