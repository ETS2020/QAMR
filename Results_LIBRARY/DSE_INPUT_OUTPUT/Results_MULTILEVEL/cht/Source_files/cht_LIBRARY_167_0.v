...
module FAU ( 
  ...
  nand3  g079(.a(new_n162_), .b(new_n89_), .c(x09), .O(new_n163_));
  ...
  nand3  g084(.a(new_n167_), .b(new_n89_), .c(x09), .O(new_n168_));
  inv1   g085(.a(new_n168_), .O(z18));
  nand2  g086(.a(x08), .b(x00), .O(new_n170_));
  aoi21  g087(.a(x30), .b(new_n121_), .c(new_n86_), .O(new_n171_));
  ...
  nand2  g098(.a(new_n173_), .b(x36), .O(new_n182_));
  ...
  nand2  g111(.a(x40), .b(new_n194_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n193_), .c(x09), .O(new_n196_));
  and2   g113(.a(new_n196_), .b(new_n89_), .O(z28));
  nand2  g114(.a(x40), .b(x14), .O(new_n198_));
  nand2  g115(.a(x41), .b(new_n194_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n198_), .c(x09), .O(new_n200_));
  and2   g117(.a(new_n200_), .b(new_n89_), .O(z29));
  nand2  g118(.a(x41), .b(x14), .O(new_n202_));
  nand2  g119(.a(x42), .b(new_n194_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n202_), .c(x09), .O(new_n204_));
  and2   g121(.a(new_n204_), .b(new_n89_), .O(z30));
  nand2  g122(.a(x42), .b(x14), .O(new_n206_));
  nand2  g123(.a(x43), .b(new_n194_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(x09), .O(new_n208_));
  and2   g125(.a(new_n208_), .b(new_n89_), .O(z31));
  ...
  nand2  g132(.a(x45), .b(new_n194_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n215_), .c(x09), .O(new_n217_));
  and2   g134(.a(new_n217_), .b(new_n89_), .O(z33));
  ...
  nand2  g140(.a(new_n194_), .b(x00), .O(new_n224_));
