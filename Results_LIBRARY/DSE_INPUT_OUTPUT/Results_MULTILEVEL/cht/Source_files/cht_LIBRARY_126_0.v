...
module FAU ( 
  ...
  nand3  g019(.a(new_n102_), .b(x41), .c(new_n84_), .O(new_n103_));
  ...
  nand3  g034(.a(new_n117_), .b(x41), .c(new_n84_), .O(new_n118_));
  inv1   g035(.a(new_n118_), .O(z06));
  inv1   g036(.a(x08), .O(new_n120_));
  nand2  g037(.a(x18), .b(new_n120_), .O(new_n121_));
  aoi21  g038(.a(x19), .b(x08), .c(new_n112_), .O(new_n122_));
  ...
  nand3  g114(.a(new_n197_), .b(x41), .c(new_n84_), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z26));
  nand2  g116(.a(x14), .b(x00), .O(new_n200_));
  nand2  g117(.a(x39), .b(new_n100_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(new_n176_), .O(new_n202_));
  ...
  aoi21  g144(.a(new_n227_), .b(x09), .c(new_n112_), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n225_), .c(x10), .O(z32));
  nand3  g146(.a(x45), .b(new_n100_), .c(x09), .O(new_n230_));
  oai21  g147(.a(new_n220_), .b(new_n226_), .c(new_n230_), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(x41), .c(new_n84_), .O(new_n232_));
  ...
  nand3  g153(.a(new_n236_), .b(x41), .c(new_n84_), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(z34));
  nand2  g155(.a(new_n206_), .b(x46), .O(new_n239_));
  aoi21  g156(.a(new_n220_), .b(x00), .c(new_n112_), .O(new_n240_));
