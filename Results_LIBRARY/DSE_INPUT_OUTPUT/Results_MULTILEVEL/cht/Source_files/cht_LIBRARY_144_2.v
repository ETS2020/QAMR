...
module FAU ( 
  ...
  oai21  g108(.a(x38), .b(new_n174_), .c(x37), .O(new_n192_));
  ...
  nand2  g115(.a(x38), .b(new_n174_), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z27));
  nand2  g117(.a(new_n101_), .b(x09), .O(new_n201_));
  ...
  nand2  g121(.a(new_n201_), .b(x40), .O(new_n205_));
  nand3  g122(.a(x41), .b(new_n101_), .c(x09), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z29));
  nand2  g124(.a(new_n201_), .b(x41), .O(new_n208_));
  nand3  g125(.a(x42), .b(new_n101_), .c(x09), .O(new_n209_));
  ...
  nand2  g139(.a(new_n201_), .b(x45), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n101_), .c(x09), .O(new_n224_));
