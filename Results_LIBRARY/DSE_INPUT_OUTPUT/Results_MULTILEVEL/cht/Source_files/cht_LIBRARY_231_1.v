...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x17), .O(new_n98_));
  ...
  aoi21  g027(.a(x16), .b(new_n97_), .c(x17), .O(new_n111_));
  ...
  aoi21  g085(.a(x30), .b(new_n115_), .c(x17), .O(new_n169_));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x17), .O(new_n213_));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(x17), .O(new_n238_));
