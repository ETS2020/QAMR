...
module FAU ( 
  ...
  nand2  g100(.a(x35), .b(new_n171_), .O(new_n184_));
  ...
  nand2  g115(.a(x38), .b(new_n171_), .O(new_n199_));
  ...
  nand3  g148(.a(new_n201_), .b(x09), .c(x00), .O(new_n232_));
