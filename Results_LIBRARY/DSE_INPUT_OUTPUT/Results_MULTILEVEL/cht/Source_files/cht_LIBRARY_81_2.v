...
module FAU ( 
  ...
  oai21  g053(.a(new_n135_), .b(new_n110_), .c(new_n136_), .O(new_n137_));
  ...
  nand2  g063(.a(x27), .b(new_n110_), .O(new_n147_));
  ...
  nand2  g069(.a(x29), .b(new_n110_), .O(new_n153_));
  ...
  nand2  g076(.a(new_n159_), .b(new_n97_), .O(z19));
  ...
  nand2  g085(.a(new_n168_), .b(new_n97_), .O(z21));
  ...
  oai21  g092(.a(x36), .b(new_n161_), .c(x35), .O(new_n176_));
  nand2  g093(.a(x36), .b(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z24));
  inv1   g095(.a(x37), .O(new_n179_));
  nand2  g096(.a(x36), .b(new_n161_), .O(new_n180_));
  oai21  g097(.a(new_n179_), .b(new_n161_), .c(new_n180_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n91_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n97_), .O(z25));
  ...
  nand2  g103(.a(new_n186_), .b(new_n97_), .O(z26));
  ...
  oai21  g110(.a(new_n193_), .b(x10), .c(new_n97_), .O(z27));
  nand2  g111(.a(new_n99_), .b(x09), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(x39), .O(new_n196_));
  nand3  g113(.a(x40), .b(new_n99_), .c(x09), .O(new_n197_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n97_), .O(z32));
  ...
  nand2  g141(.a(new_n224_), .b(new_n97_), .O(z34));
  nand2  g142(.a(new_n195_), .b(x46), .O(new_n226_));
  nand3  g143(.a(new_n99_), .b(x09), .c(x00), .O(new_n227_));
