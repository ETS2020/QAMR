...
module FAU ( 
  ...
  nand2  g003(.a(x29), .b(x11), .O(new_n87_));
  ...
  nand3  g053(.a(new_n136_), .b(new_n87_), .c(new_n89_), .O(new_n137_));
  ...
  nand3  g085(.a(x30), .b(new_n168_), .c(x08), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n167_), .c(x10), .O(z18));
  nor2   g087(.a(new_n165_), .b(x08), .O(new_n171_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n89_), .O(new_n205_));
  ...
  oai21  g138(.a(new_n221_), .b(new_n219_), .c(new_n89_), .O(new_n222_));
  ...
  oai21  g157(.a(x14), .b(new_n174_), .c(x44), .O(new_n241_));
  ...
  oai21  g162(.a(x14), .b(new_n174_), .c(x45), .O(new_n246_));
  ...
  oai21  g171(.a(new_n254_), .b(new_n252_), .c(new_n89_), .O(new_n255_));
