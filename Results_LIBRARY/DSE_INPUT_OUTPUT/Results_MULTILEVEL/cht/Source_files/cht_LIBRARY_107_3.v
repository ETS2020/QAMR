...
module FAU ( 
  ...
  nand3  g097(.a(x32), .b(new_n84_), .c(new_n177_), .O(new_n181_));
  ...
  nor2   g133(.a(x10), .b(x09), .O(new_n217_));
  nor2   g134(.a(new_n100_), .b(new_n177_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(new_n217_), .c(x43), .O(new_n219_));
  inv1   g136(.a(x44), .O(new_n220_));
  oai21  g137(.a(new_n220_), .b(x14), .c(new_n84_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x09), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n219_), .O(z32));
  nand2  g140(.a(new_n204_), .b(x44), .O(new_n224_));
