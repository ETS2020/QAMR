...
module FAU ( 
  ...
  aoi21  g019(.a(x14), .b(new_n102_), .c(x19), .O(new_n103_));
  ...
  nand2  g042(.a(x20), .b(new_n120_), .O(new_n126_));
  oai21  g043(.a(new_n125_), .b(new_n120_), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g068(.a(x26), .b(new_n120_), .O(new_n152_));
  ...
  nand2  g076(.a(x28), .b(new_n120_), .O(new_n160_));
  ...
  aoi21  g085(.a(x30), .b(new_n120_), .c(x19), .O(new_n169_));
  ...
  aoi21  g122(.a(x38), .b(new_n171_), .c(x19), .O(new_n206_));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x19), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x19), .O(new_n218_));
  ...
  aoi21  g139(.a(new_n222_), .b(x09), .c(x19), .O(new_n223_));
  ...
  aoi21  g144(.a(new_n227_), .b(x09), .c(x19), .O(new_n228_));
