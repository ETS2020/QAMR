...
module FAU ( 
  ...
  nand2  g009(.a(new_n89_), .b(x10), .O(new_n93_));
  ...
  nand2  g061(.a(x26), .b(new_n113_), .O(new_n145_));
  ...
  nand2  g068(.a(new_n151_), .b(new_n93_), .O(z16));
  ...
  nand2  g100(.a(new_n183_), .b(new_n93_), .O(z24));
  ...
  aoi21  g120(.a(new_n100_), .b(x09), .c(new_n203_), .O(new_n204_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n93_), .O(z29));
