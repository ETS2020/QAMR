...
module FAU ( 
  ...
  nand2  g052(.a(x22), .b(new_n112_), .O(new_n136_));
  ...
  nand2  g069(.a(new_n152_), .b(new_n90_), .O(z15));
  ...
  nand2  g077(.a(new_n160_), .b(new_n90_), .O(z17));
  nand2  g078(.a(x29), .b(new_n112_), .O(new_n162_));
  ...
  nand2  g091(.a(new_n174_), .b(new_n90_), .O(z20));
  ...
  nand2  g095(.a(new_n178_), .b(new_n90_), .O(z21));
