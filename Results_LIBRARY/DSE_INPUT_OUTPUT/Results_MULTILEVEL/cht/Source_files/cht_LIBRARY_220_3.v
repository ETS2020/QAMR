...
module FAU ( 
  ...
  nand3  g093(.a(x34), .b(new_n84_), .c(new_n167_), .O(new_n177_));
  ...
  nand3  g099(.a(x36), .b(new_n84_), .c(new_n167_), .O(new_n183_));
  ...
  nor2   g116(.a(x10), .b(x09), .O(new_n200_));
  aoi21  g117(.a(x14), .b(x09), .c(new_n200_), .O(new_n201_));
  aoi21  g118(.a(x41), .b(new_n194_), .c(x10), .O(new_n202_));
  oai22  g119(.a(new_n202_), .b(new_n167_), .c(new_n201_), .d(new_n199_), .O(z29));
  nand2  g120(.a(new_n195_), .b(x41), .O(new_n204_));
  nand3  g121(.a(x42), .b(new_n194_), .c(x09), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z30));
  nand2  g123(.a(new_n195_), .b(x42), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n194_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z31));
  nand2  g126(.a(new_n195_), .b(x43), .O(new_n210_));
  nand3  g127(.a(x44), .b(new_n194_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z32));
  nand2  g129(.a(new_n195_), .b(x44), .O(new_n213_));
  nand3  g130(.a(x45), .b(new_n194_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z33));
  inv1   g132(.a(x45), .O(new_n216_));
  aoi21  g133(.a(x46), .b(new_n194_), .c(x10), .O(new_n217_));
  oai22  g134(.a(new_n217_), .b(new_n167_), .c(new_n201_), .d(new_n216_), .O(z34));
  inv1   g135(.a(x46), .O(new_n219_));
  aoi21  g136(.a(new_n194_), .b(x00), .c(x10), .O(new_n220_));
  oai22  g137(.a(new_n220_), .b(new_n167_), .c(new_n201_), .d(new_n219_), .O(z35));
endmodule
