...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n85_), .c(x30), .O(new_n101_));
  ...
  nand4  g078(.a(new_n89_), .b(x29), .c(new_n88_), .d(new_n111_), .O(new_n162_));
  inv1   g079(.a(new_n162_), .O(z18));
  nand2  g080(.a(x08), .b(x00), .O(new_n164_));
  aoi21  g081(.a(new_n164_), .b(new_n89_), .c(x10), .O(z19));
  ...
  aoi21  g118(.a(x38), .b(new_n171_), .c(x30), .O(new_n202_));
  ...
  nand3  g150(.a(new_n233_), .b(new_n89_), .c(new_n88_), .O(new_n234_));
  ...
  aoi21  g155(.a(new_n238_), .b(x09), .c(x30), .O(new_n239_));
  ...
  nand3  g160(.a(new_n243_), .b(new_n89_), .c(new_n88_), .O(new_n244_));
