...
module FAU ( 
  ...
  aoi21  g025(.a(x16), .b(new_n102_), .c(x09), .O(new_n109_));
  ...
  and2   g044(.a(new_n127_), .b(new_n85_), .O(z09));
  ...
  nand2  g119(.a(new_n180_), .b(x44), .O(new_n203_));
