...
module FAU ( 
  ...
  nor2   g057(.a(x46), .b(x08), .O(new_n141_));
  oai21  g058(.a(new_n141_), .b(x24), .c(x23), .O(new_n142_));
  nand2  g059(.a(x24), .b(x08), .O(new_n143_));
  aoi21  g060(.a(new_n143_), .b(new_n142_), .c(x10), .O(z12));
  nor2   g061(.a(new_n85_), .b(x08), .O(new_n145_));
  ...
  oai21  g072(.a(new_n155_), .b(x10), .c(new_n86_), .O(z15));
  ...
  oai21  g089(.a(new_n172_), .b(x10), .c(new_n86_), .O(z19));
  ...
  nand2  g122(.a(new_n205_), .b(new_n86_), .O(z26));
  ...
  oai21  g127(.a(new_n210_), .b(new_n209_), .c(new_n86_), .O(new_n211_));
  ...
  oai21  g133(.a(new_n216_), .b(x10), .c(new_n86_), .O(z28));
  nand3  g134(.a(x41), .b(new_n100_), .c(x09), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(new_n219_));
  aoi21  g136(.a(new_n213_), .b(x40), .c(new_n219_), .O(new_n220_));
  oai21  g137(.a(new_n220_), .b(x10), .c(new_n86_), .O(z29));
  nand3  g138(.a(x42), .b(new_n100_), .c(x09), .O(new_n222_));
  inv1   g139(.a(new_n222_), .O(new_n223_));
  aoi21  g140(.a(new_n213_), .b(x41), .c(new_n223_), .O(new_n224_));
  oai21  g141(.a(new_n224_), .b(x10), .c(new_n86_), .O(z30));
  nand2  g142(.a(new_n213_), .b(x42), .O(new_n226_));
  ...
  nand2  g147(.a(new_n213_), .b(x43), .O(new_n231_));
  ...
  nand2  g158(.a(new_n213_), .b(new_n241_), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(x46), .c(x24), .O(new_n243_));
  inv1   g160(.a(x46), .O(new_n244_));
  nand3  g161(.a(new_n213_), .b(new_n244_), .c(x45), .O(new_n245_));
  aoi21  g162(.a(new_n245_), .b(new_n243_), .c(x10), .O(z34));
