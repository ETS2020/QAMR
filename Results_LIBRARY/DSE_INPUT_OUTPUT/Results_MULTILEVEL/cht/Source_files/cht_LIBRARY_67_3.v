...
module FAU ( 
  ...
  oai21  g036(.a(new_n119_), .b(x10), .c(new_n85_), .O(z07));
  ...
  nand2  g111(.a(new_n194_), .b(new_n85_), .O(z23));
  ...
  aoi21  g133(.a(new_n99_), .b(x09), .c(new_n210_), .O(new_n217_));
  ...
  nand2  g156(.a(x43), .b(new_n205_), .O(new_n240_));
  inv1   g157(.a(x43), .O(new_n241_));
  nand3  g158(.a(new_n241_), .b(new_n99_), .c(x09), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n240_), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(x44), .O(new_n244_));
  nand2  g161(.a(new_n99_), .b(x09), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(x43), .c(new_n205_), .O(new_n246_));
  aoi21  g163(.a(new_n246_), .b(new_n244_), .c(x10), .O(z32));
  oai21  g164(.a(x14), .b(new_n177_), .c(x44), .O(new_n248_));
  nand3  g165(.a(x45), .b(new_n99_), .c(x09), .O(new_n249_));
  ...
  nand2  g174(.a(new_n257_), .b(new_n85_), .O(z34));
  inv1   g175(.a(x46), .O(new_n259_));
  aoi21  g176(.a(new_n99_), .b(x09), .c(new_n259_), .O(new_n260_));
  nand3  g177(.a(new_n99_), .b(x09), .c(x00), .O(new_n261_));
  inv1   g178(.a(new_n261_), .O(new_n262_));
  oai21  g179(.a(new_n262_), .b(new_n260_), .c(new_n84_), .O(new_n263_));
  nand2  g180(.a(new_n263_), .b(new_n85_), .O(z35));
endmodule
