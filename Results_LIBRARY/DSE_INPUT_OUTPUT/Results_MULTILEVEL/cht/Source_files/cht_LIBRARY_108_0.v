...
module FAU ( 
  ...
  nand2  g071(.a(x26), .b(new_n121_), .O(new_n155_));
  ...
  nand2  g075(.a(x27), .b(new_n121_), .O(new_n159_));
  ...
  nand3  g087(.a(new_n170_), .b(new_n84_), .c(x09), .O(new_n171_));
  inv1   g088(.a(new_n171_), .O(z18));
  nand2  g089(.a(x08), .b(x00), .O(new_n173_));
  aoi21  g090(.a(x30), .b(new_n121_), .c(new_n92_), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z19));
  nor2   g092(.a(x10), .b(new_n92_), .O(new_n176_));
  ...
  nand2  g112(.a(x40), .b(new_n98_), .O(new_n196_));
  ...
  nand2  g130(.a(x44), .b(new_n98_), .O(new_n214_));
