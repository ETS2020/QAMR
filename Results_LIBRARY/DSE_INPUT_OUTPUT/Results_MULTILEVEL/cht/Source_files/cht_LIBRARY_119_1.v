...
module FAU ( 
  ...
  aoi21  g012(.a(x14), .b(new_n85_), .c(x12), .O(new_n96_));
  ...
  aoi21  g081(.a(x30), .b(new_n106_), .c(x12), .O(new_n165_));
  ...
  oai21  g120(.a(new_n203_), .b(new_n202_), .c(new_n89_), .O(new_n204_));
  ...
  nand3  g131(.a(new_n214_), .b(new_n89_), .c(new_n88_), .O(new_n215_));
  ...
  nand3  g136(.a(new_n219_), .b(new_n89_), .c(new_n88_), .O(new_n220_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x12), .O(new_n225_));
  ...
  aoi21  g151(.a(new_n234_), .b(x09), .c(x12), .O(new_n235_));
  ...
  aoi21  g156(.a(new_n239_), .b(x09), .c(x12), .O(new_n240_));
  aoi21  g157(.a(new_n240_), .b(new_n237_), .c(x10), .O(z34));
  nand2  g158(.a(new_n206_), .b(x46), .O(new_n242_));
  aoi21  g159(.a(new_n227_), .b(x00), .c(x12), .O(new_n243_));
