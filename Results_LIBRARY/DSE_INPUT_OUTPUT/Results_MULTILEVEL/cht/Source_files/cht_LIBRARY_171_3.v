...
module FAU ( 
  ...
  nand2  g003(.a(x29), .b(x10), .O(new_n87_));
  ...
  nand2  g050(.a(x24), .b(new_n109_), .O(new_n134_));
  ...
  nand2  g059(.a(new_n142_), .b(new_n116_), .O(new_n143_));
  nand2  g060(.a(new_n143_), .b(new_n87_), .O(z15));
  nand2  g061(.a(x28), .b(x08), .O(new_n145_));
  oai21  g062(.a(new_n140_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n116_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n87_), .O(z16));
  oai21  g065(.a(x10), .b(x08), .c(x29), .O(new_n149_));
  nand3  g066(.a(x28), .b(new_n116_), .c(new_n109_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n149_), .O(z17));
  oai21  g068(.a(x30), .b(new_n109_), .c(x29), .O(new_n152_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n116_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n87_), .O(z19));
  ...
  nand2  g091(.a(x35), .b(new_n160_), .O(new_n175_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n116_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n87_), .O(z25));
  ...
  oai21  g108(.a(new_n191_), .b(x10), .c(new_n87_), .O(z27));
  aoi21  g109(.a(new_n97_), .b(x09), .c(new_n186_), .O(new_n193_));
  nand3  g110(.a(x40), .b(new_n97_), .c(x09), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(new_n195_));
  oai21  g112(.a(new_n195_), .b(new_n193_), .c(new_n116_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n87_), .O(z28));
  inv1   g114(.a(x40), .O(new_n198_));
  aoi21  g115(.a(new_n97_), .b(x09), .c(new_n198_), .O(new_n199_));
  nand3  g116(.a(x41), .b(new_n97_), .c(x09), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(new_n201_));
  oai21  g118(.a(new_n201_), .b(new_n199_), .c(new_n116_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n87_), .O(z29));
  inv1   g120(.a(x41), .O(new_n204_));
  aoi21  g121(.a(new_n97_), .b(x09), .c(new_n204_), .O(new_n205_));
  nand3  g122(.a(x42), .b(new_n97_), .c(x09), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(new_n207_));
  oai21  g124(.a(new_n207_), .b(new_n205_), .c(new_n116_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n87_), .O(z30));
  nand2  g126(.a(new_n97_), .b(x09), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(x42), .O(new_n211_));
  nand3  g128(.a(x43), .b(new_n97_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z31));
  inv1   g130(.a(x43), .O(new_n214_));
  aoi21  g131(.a(new_n97_), .b(x09), .c(new_n214_), .O(new_n215_));
  nand3  g132(.a(x44), .b(new_n97_), .c(x09), .O(new_n216_));
  inv1   g133(.a(new_n216_), .O(new_n217_));
  oai21  g134(.a(new_n217_), .b(new_n215_), .c(new_n116_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n87_), .O(z32));
  inv1   g136(.a(x44), .O(new_n220_));
  aoi21  g137(.a(new_n97_), .b(x09), .c(new_n220_), .O(new_n221_));
  nand3  g138(.a(x45), .b(new_n97_), .c(x09), .O(new_n222_));
  inv1   g139(.a(new_n222_), .O(new_n223_));
  oai21  g140(.a(new_n223_), .b(new_n221_), .c(new_n116_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n87_), .O(z33));
  inv1   g142(.a(x45), .O(new_n226_));
  aoi21  g143(.a(new_n97_), .b(x09), .c(new_n226_), .O(new_n227_));
  nand3  g144(.a(x46), .b(new_n97_), .c(x09), .O(new_n228_));
  inv1   g145(.a(new_n228_), .O(new_n229_));
  oai21  g146(.a(new_n229_), .b(new_n227_), .c(new_n116_), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n87_), .O(z34));
  nand2  g148(.a(new_n210_), .b(x46), .O(new_n232_));
  nand3  g149(.a(new_n97_), .b(x09), .c(x00), .O(new_n233_));
