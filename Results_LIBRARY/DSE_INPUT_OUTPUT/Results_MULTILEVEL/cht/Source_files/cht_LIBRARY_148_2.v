...
module FAU ( 
  ...
  oai21  g057(.a(new_n139_), .b(new_n112_), .c(new_n140_), .O(new_n141_));
  ...
  nand2  g128(.a(new_n202_), .b(new_n89_), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(x42), .O(new_n213_));
  nand2  g130(.a(new_n202_), .b(x41), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z30));
  nand2  g132(.a(new_n202_), .b(x42), .O(new_n216_));
