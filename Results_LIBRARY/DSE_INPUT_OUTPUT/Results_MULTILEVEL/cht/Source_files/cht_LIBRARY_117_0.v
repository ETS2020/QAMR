...
module FAU ( 
  ...
  nand3  g070(.a(new_n153_), .b(new_n95_), .c(x08), .O(new_n154_));
  ...
  nand3  g083(.a(new_n166_), .b(new_n95_), .c(x08), .O(new_n167_));
  ...
  nand3  g124(.a(new_n207_), .b(new_n95_), .c(x08), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z34));
  nand2  g126(.a(new_n176_), .b(x46), .O(new_n210_));
  aoi21  g127(.a(new_n175_), .b(x00), .c(new_n86_), .O(new_n211_));
