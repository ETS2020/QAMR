...
module FAU ( 
  ...
  nor2   g017(.a(new_n85_), .b(x07), .O(new_n101_));
  ...
  oai21  g081(.a(new_n85_), .b(x08), .c(new_n86_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(x28), .O(new_n166_));
  nand2  g083(.a(x29), .b(x08), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z17));
  nor2   g085(.a(new_n86_), .b(x08), .O(new_n169_));
  ...
  nand2  g131(.a(x39), .b(new_n176_), .O(new_n215_));
  nand3  g132(.a(x40), .b(new_n85_), .c(x09), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n215_), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(x29), .O(new_n218_));
  nand2  g135(.a(x39), .b(x14), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z28));
  nand3  g137(.a(x41), .b(new_n84_), .c(x09), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x29), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n85_), .O(new_n223_));
  nand2  g140(.a(new_n85_), .b(x09), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(x40), .c(new_n84_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n223_), .O(z29));
  nand2  g143(.a(x41), .b(new_n176_), .O(new_n227_));
  nand3  g144(.a(x42), .b(new_n85_), .c(x09), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n227_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(x29), .O(new_n230_));
  nand2  g147(.a(x41), .b(x14), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n230_), .c(x10), .O(z30));
  nand2  g149(.a(x42), .b(new_n176_), .O(new_n233_));
  nand3  g150(.a(x43), .b(new_n85_), .c(x09), .O(new_n234_));
  nand2  g151(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(x29), .O(new_n236_));
  nand2  g153(.a(x42), .b(x14), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z31));
  nand2  g155(.a(x43), .b(new_n176_), .O(new_n239_));
  nand3  g156(.a(x44), .b(new_n85_), .c(x09), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(x29), .O(new_n242_));
  nand2  g159(.a(x43), .b(x14), .O(new_n243_));
  aoi21  g160(.a(new_n243_), .b(new_n242_), .c(x10), .O(z32));
  nand3  g161(.a(x45), .b(new_n84_), .c(x09), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(x29), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(new_n85_), .O(new_n247_));
  nand3  g164(.a(new_n224_), .b(x44), .c(new_n84_), .O(new_n248_));
  nand2  g165(.a(new_n248_), .b(new_n247_), .O(z33));
  nand3  g166(.a(x46), .b(new_n84_), .c(x09), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(x29), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(new_n85_), .O(new_n252_));
  nand3  g169(.a(new_n224_), .b(x45), .c(new_n84_), .O(new_n253_));
  nand2  g170(.a(new_n253_), .b(new_n252_), .O(z34));
  nand3  g171(.a(new_n84_), .b(x09), .c(x00), .O(new_n255_));
  nand2  g172(.a(new_n255_), .b(x29), .O(new_n256_));
  nand2  g173(.a(new_n256_), .b(new_n85_), .O(new_n257_));
  nand3  g174(.a(new_n224_), .b(x46), .c(new_n84_), .O(new_n258_));
