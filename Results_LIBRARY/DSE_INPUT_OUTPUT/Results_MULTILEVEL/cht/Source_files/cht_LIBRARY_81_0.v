...
module FAU ( 
  ...
  nand3  g004(.a(new_n87_), .b(x35), .c(new_n84_), .O(new_n88_));
  inv1   g005(.a(new_n88_), .O(z00));
  inv1   g006(.a(x12), .O(new_n90_));
  nand2  g007(.a(x07), .b(x05), .O(new_n91_));
  oai21  g008(.a(new_n90_), .b(x07), .c(new_n91_), .O(new_n92_));
  nand3  g009(.a(new_n92_), .b(x35), .c(new_n84_), .O(new_n93_));
  inv1   g010(.a(new_n93_), .O(z01));
  nand2  g011(.a(x07), .b(x06), .O(new_n95_));
  inv1   g012(.a(x07), .O(new_n96_));
  inv1   g013(.a(x35), .O(new_n97_));
  ...
  nand3  g022(.a(new_n105_), .b(x35), .c(new_n84_), .O(new_n106_));
  inv1   g023(.a(new_n106_), .O(z04));
  inv1   g024(.a(x16), .O(new_n108_));
  nand2  g025(.a(x07), .b(x03), .O(new_n109_));
  oai21  g026(.a(new_n108_), .b(x07), .c(new_n109_), .O(new_n110_));
  nand3  g027(.a(new_n110_), .b(x35), .c(new_n84_), .O(new_n111_));
  ...
  nand3  g089(.a(new_n172_), .b(x35), .c(new_n84_), .O(new_n173_));
  inv1   g090(.a(new_n173_), .O(z20));
  inv1   g091(.a(x09), .O(new_n175_));
  nand2  g092(.a(x32), .b(new_n175_), .O(new_n176_));
  aoi21  g093(.a(x33), .b(x09), .c(new_n97_), .O(new_n177_));
  ...
  nand3  g098(.a(new_n181_), .b(x35), .c(new_n84_), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z22));
  oai21  g100(.a(x34), .b(x09), .c(x35), .O(new_n184_));
  nor2   g101(.a(new_n184_), .b(x10), .O(z23));
  oai21  g102(.a(x36), .b(new_n175_), .c(x35), .O(new_n186_));
  nor2   g103(.a(new_n186_), .b(x10), .O(z24));
  nand2  g104(.a(x36), .b(new_n175_), .O(new_n188_));
  nand2  g105(.a(x37), .b(x09), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n188_), .c(x35), .O(new_n190_));
  and2   g107(.a(new_n190_), .b(new_n84_), .O(z25));
  nand2  g108(.a(x37), .b(new_n175_), .O(new_n192_));
  nand2  g109(.a(x38), .b(x09), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(x35), .O(new_n194_));
  ...
  oai21  g130(.a(x14), .b(new_n175_), .c(x41), .O(new_n214_));
  nand3  g131(.a(x42), .b(new_n203_), .c(x09), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n214_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(x35), .c(new_n84_), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(z30));
  oai21  g135(.a(x14), .b(new_n175_), .c(x42), .O(new_n219_));
  nand3  g136(.a(x43), .b(new_n203_), .c(x09), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n219_), .O(new_n221_));
  nand3  g138(.a(new_n221_), .b(x35), .c(new_n84_), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(new_n97_), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n224_), .c(x10), .O(z32));
  oai21  g145(.a(x14), .b(new_n175_), .c(x44), .O(new_n229_));
  nand3  g146(.a(x45), .b(new_n203_), .c(x09), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(x35), .c(new_n84_), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(z33));
  nand2  g150(.a(new_n208_), .b(x45), .O(new_n234_));
  inv1   g151(.a(x46), .O(new_n235_));
  nor2   g152(.a(new_n235_), .b(x14), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(x09), .c(new_n97_), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n234_), .c(x10), .O(z34));
  oai21  g155(.a(x14), .b(new_n175_), .c(x46), .O(new_n239_));
  nand3  g156(.a(new_n203_), .b(x09), .c(x00), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand3  g158(.a(new_n241_), .b(x35), .c(new_n84_), .O(new_n242_));
