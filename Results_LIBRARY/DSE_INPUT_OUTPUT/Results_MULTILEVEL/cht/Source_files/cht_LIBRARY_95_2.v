...
module FAU ( 
  ...
  nand2  g038(.a(x19), .b(new_n114_), .O(new_n122_));
  ...
  nand2  g046(.a(x21), .b(new_n114_), .O(new_n130_));
  ...
  nand2  g082(.a(x30), .b(new_n114_), .O(new_n166_));
  ...
  nand2  g096(.a(x34), .b(new_n168_), .O(new_n180_));
  ...
  nand2  g104(.a(x36), .b(new_n168_), .O(new_n188_));
  ...
  nand2  g116(.a(x38), .b(new_n168_), .O(new_n200_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n90_), .O(z32));
  nand2  g140(.a(new_n208_), .b(x44), .O(new_n224_));
  nand3  g141(.a(x45), .b(new_n202_), .c(x09), .O(new_n225_));
  ...
  nand3  g150(.a(new_n202_), .b(x09), .c(x00), .O(new_n234_));
