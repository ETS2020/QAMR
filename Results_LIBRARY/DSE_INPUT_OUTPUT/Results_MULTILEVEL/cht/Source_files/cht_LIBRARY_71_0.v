...
module FAU ( 
  ...
  nand3  g034(.a(new_n117_), .b(x38), .c(new_n89_), .O(new_n118_));
  ...
  nand3  g071(.a(new_n154_), .b(x38), .c(new_n89_), .O(new_n155_));
  ...
  nand3  g109(.a(new_n192_), .b(x38), .c(new_n89_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z27));
  oai21  g111(.a(x14), .b(new_n163_), .c(x39), .O(new_n195_));
  nand3  g112(.a(x40), .b(new_n190_), .c(x09), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(x38), .c(new_n89_), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z28));
  nand2  g116(.a(new_n190_), .b(x09), .O(new_n200_));
  ...
  nand3  g123(.a(x42), .b(new_n190_), .c(x09), .O(new_n207_));
  ...
  nand3  g128(.a(x43), .b(new_n190_), .c(x09), .O(new_n212_));
  ...
  nand3  g138(.a(x45), .b(new_n190_), .c(x09), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n221_), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(x38), .c(new_n89_), .O(new_n224_));
  inv1   g141(.a(new_n224_), .O(z33));
  oai21  g142(.a(x14), .b(new_n163_), .c(x45), .O(new_n226_));
  nand3  g143(.a(x46), .b(new_n190_), .c(x09), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(new_n226_), .O(new_n228_));
  nand3  g145(.a(new_n228_), .b(x38), .c(new_n89_), .O(new_n229_));
