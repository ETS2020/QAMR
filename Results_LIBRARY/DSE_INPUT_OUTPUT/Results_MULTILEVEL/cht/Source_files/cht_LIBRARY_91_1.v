...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x30), .O(new_n98_));
  ...
  aoi21  g073(.a(x28), .b(x08), .c(x30), .O(new_n157_));
  ...
  nand2  g080(.a(x29), .b(new_n120_), .O(new_n164_));
  aoi21  g081(.a(new_n164_), .b(new_n85_), .c(x10), .O(z18));
  nand4  g082(.a(new_n85_), .b(new_n84_), .c(x08), .d(x00), .O(new_n166_));
  ...
  aoi21  g121(.a(x38), .b(new_n168_), .c(x30), .O(new_n205_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x30), .O(new_n226_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x30), .O(new_n231_));
  ...
  aoi21  g161(.a(new_n244_), .b(x00), .c(x30), .O(new_n245_));
