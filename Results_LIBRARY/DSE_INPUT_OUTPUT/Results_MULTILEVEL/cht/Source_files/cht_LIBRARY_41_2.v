...
module FAU ( 
  ...
  aoi21  g029(.a(new_n112_), .b(new_n84_), .c(x10), .O(z07));
  ...
  and2   g062(.a(new_n145_), .b(new_n85_), .O(z21));
  ...
  and2   g066(.a(new_n149_), .b(new_n85_), .O(z22));
  ...
  aoi21  g130(.a(new_n193_), .b(x00), .c(x08), .O(new_n214_));
