...
module FAU ( 
  ...
  nand2  g009(.a(x10), .b(x00), .O(new_n93_));
  ...
  nand2  g044(.a(new_n127_), .b(new_n93_), .O(z09));
  ...
  nand2  g079(.a(new_n162_), .b(new_n93_), .O(z18));
  oai21  g080(.a(x10), .b(x08), .c(x00), .O(new_n164_));
  nand3  g081(.a(x30), .b(new_n88_), .c(new_n111_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n164_), .O(z19));
  ...
  nand3  g115(.a(x40), .b(new_n98_), .c(x09), .O(new_n199_));
  ...
  nand2  g126(.a(new_n197_), .b(x43), .O(new_n210_));
  ...
  nand2  g134(.a(new_n217_), .b(new_n93_), .O(z33));
  ...
  nand2  g139(.a(new_n197_), .b(new_n222_), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(x00), .O(new_n224_));
