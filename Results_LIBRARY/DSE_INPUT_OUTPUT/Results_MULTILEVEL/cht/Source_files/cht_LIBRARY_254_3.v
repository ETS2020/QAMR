...
module FAU ( 
  ...
  nand2  g040(.a(x21), .b(new_n114_), .O(new_n124_));
  ...
  nand2  g072(.a(x29), .b(new_n114_), .O(new_n156_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n96_), .O(z19));
  oai21  g080(.a(x32), .b(x10), .c(x09), .O(new_n164_));
  inv1   g081(.a(x09), .O(new_n165_));
  nand3  g082(.a(x31), .b(new_n91_), .c(new_n165_), .O(new_n166_));
  ...
  nand3  g091(.a(x34), .b(new_n91_), .c(new_n165_), .O(new_n175_));
  ...
  nand3  g107(.a(x38), .b(new_n91_), .c(new_n165_), .O(new_n191_));
  ...
  nor2   g123(.a(x10), .b(x09), .O(new_n207_));
  aoi21  g124(.a(x14), .b(x09), .c(new_n207_), .O(new_n208_));
  aoi21  g125(.a(x44), .b(new_n187_), .c(x10), .O(new_n209_));
  oai22  g126(.a(new_n209_), .b(new_n165_), .c(new_n208_), .d(new_n206_), .O(z32));
  inv1   g127(.a(x44), .O(new_n211_));
  aoi21  g128(.a(x45), .b(new_n187_), .c(x10), .O(new_n212_));
  oai22  g129(.a(new_n212_), .b(new_n165_), .c(new_n208_), .d(new_n211_), .O(z33));
  ...
  oai22  g135(.a(new_n218_), .b(new_n165_), .c(new_n208_), .d(new_n217_), .O(z35));
endmodule
