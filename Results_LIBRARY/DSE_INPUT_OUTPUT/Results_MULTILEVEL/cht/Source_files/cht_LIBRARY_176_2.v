...
module FAU ( 
  ...
  oai21  g109(.a(x38), .b(new_n168_), .c(x37), .O(new_n193_));
  ...
  nor2   g115(.a(new_n89_), .b(x09), .O(new_n199_));
  ...
  nand2  g142(.a(new_n202_), .b(x09), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(x43), .O(new_n227_));
  nand3  g144(.a(x44), .b(new_n202_), .c(x09), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z32));
  nand2  g146(.a(new_n226_), .b(x44), .O(new_n230_));
  ...
  nand2  g155(.a(new_n226_), .b(x46), .O(new_n239_));
