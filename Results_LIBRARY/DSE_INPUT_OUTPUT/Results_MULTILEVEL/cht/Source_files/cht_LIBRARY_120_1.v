...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n221_, new_n222_, new_n224_, new_n226_;
  ...
  aoi21  g043(.a(x22), .b(x08), .c(x46), .O(new_n127_));
  ...
  aoi21  g051(.a(x24), .b(x08), .c(x46), .O(new_n135_));
  ...
  aoi21  g107(.a(x38), .b(new_n162_), .c(x46), .O(new_n191_));
  ...
  nand4  g140(.a(new_n213_), .b(new_n95_), .c(x45), .d(new_n94_), .O(new_n224_));
  inv1   g141(.a(new_n224_), .O(z34));
  nand4  g142(.a(new_n96_), .b(new_n94_), .c(x09), .d(x00), .O(new_n226_));
  nor2   g143(.a(new_n226_), .b(x46), .O(z35));
endmodule
