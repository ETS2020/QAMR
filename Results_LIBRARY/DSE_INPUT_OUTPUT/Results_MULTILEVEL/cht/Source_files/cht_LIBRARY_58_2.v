...
module FAU ( 
  ...
  nand2  g040(.a(new_n123_), .b(new_n86_), .O(z07));
  ...
  nand2  g049(.a(new_n132_), .b(new_n86_), .O(z09));
  ...
  nor2   g075(.a(new_n85_), .b(new_n158_), .O(new_n159_));
  oai21  g076(.a(new_n159_), .b(new_n157_), .c(x26), .O(new_n160_));
  nand2  g077(.a(new_n159_), .b(x08), .O(new_n161_));
  ...
  nand3  g088(.a(new_n86_), .b(x29), .c(new_n115_), .O(new_n172_));
  nand2  g089(.a(x30), .b(x08), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n172_), .c(x10), .O(z18));
  nand3  g091(.a(new_n86_), .b(x08), .c(x00), .O(new_n175_));
  nand2  g092(.a(x30), .b(new_n115_), .O(new_n176_));
  ...
  aoi21  g167(.a(new_n102_), .b(x09), .c(new_n250_), .O(new_n251_));
  ...
  nand3  g175(.a(new_n258_), .b(new_n86_), .c(new_n84_), .O(new_n259_));
