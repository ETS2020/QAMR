...
module FAU ( 
  ...
  nand2  g028(.a(new_n111_), .b(x03), .O(new_n112_));
  oai21  g029(.a(new_n111_), .b(new_n110_), .c(new_n112_), .O(z05));
  ...
  nand2  g057(.a(x24), .b(new_n114_), .O(new_n141_));
  ...
  nand2  g136(.a(new_n210_), .b(x43), .O(new_n220_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n89_), .O(z33));
