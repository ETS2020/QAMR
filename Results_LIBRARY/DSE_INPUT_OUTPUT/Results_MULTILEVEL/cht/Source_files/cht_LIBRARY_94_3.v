...
module FAU ( 
  ...
  nand2  g009(.a(x10), .b(x04), .O(new_n93_));
  ...
  nand2  g049(.a(x22), .b(new_n116_), .O(new_n133_));
  oai21  g050(.a(new_n132_), .b(new_n116_), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g074(.a(x29), .b(new_n116_), .O(new_n158_));
  ...
  nand2  g104(.a(new_n187_), .b(new_n93_), .O(z25));
  nand2  g105(.a(x37), .b(new_n166_), .O(new_n189_));
  ...
  nand2  g112(.a(x38), .b(new_n166_), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z27));
  nand2  g114(.a(new_n100_), .b(x09), .O(new_n198_));
  ...
  nand2  g121(.a(new_n198_), .b(x41), .O(new_n205_));
  nand3  g122(.a(x42), .b(new_n100_), .c(x09), .O(new_n206_));
  ...
  nand2  g129(.a(new_n212_), .b(new_n93_), .O(z31));
  ...
  nand2  g145(.a(new_n198_), .b(x46), .O(new_n229_));
  nand3  g146(.a(new_n100_), .b(x09), .c(x00), .O(new_n230_));
