...
module FAU ( 
  ...
  nand2  g067(.a(new_n150_), .b(new_n89_), .O(z14));
  ...
  nand2  g077(.a(x28), .b(new_n113_), .O(new_n161_));
  nand2  g078(.a(x29), .b(x08), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(new_n161_), .c(x10), .O(z17));
  oai21  g080(.a(x10), .b(x08), .c(x30), .O(new_n164_));
  nand3  g081(.a(x29), .b(new_n84_), .c(new_n113_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n164_), .O(z18));
  oai21  g083(.a(x30), .b(x08), .c(x00), .O(new_n167_));
  nand2  g084(.a(x30), .b(new_n113_), .O(new_n168_));
  ...
  nand2  g094(.a(new_n177_), .b(new_n89_), .O(z21));
  ...
  oai21  g100(.a(new_n182_), .b(new_n170_), .c(new_n183_), .O(new_n184_));
  ...
  nand2  g111(.a(x37), .b(new_n170_), .O(new_n195_));
  oai21  g112(.a(new_n194_), .b(new_n170_), .c(new_n195_), .O(new_n196_));
  ...
  aoi21  g119(.a(new_n201_), .b(x09), .c(new_n202_), .O(new_n203_));
  oai21  g120(.a(new_n203_), .b(x10), .c(new_n89_), .O(z27));
