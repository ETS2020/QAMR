...
module FAU ( 
  ...
  nand2  g004(.a(x17), .b(new_n87_), .O(new_n88_));
  ...
  nand3  g115(.a(new_n198_), .b(new_n88_), .c(new_n94_), .O(new_n199_));
  ...
  aoi21  g128(.a(new_n100_), .b(x09), .c(new_n206_), .O(new_n212_));
  ...
  oai21  g165(.a(new_n248_), .b(new_n246_), .c(new_n94_), .O(new_n249_));
  ...
  nand3  g170(.a(new_n253_), .b(new_n88_), .c(new_n94_), .O(new_n254_));
