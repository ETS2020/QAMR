...
module FAU ( 
  ...
  nand2  g041(.a(x20), .b(new_n118_), .O(new_n125_));
  ...
  nand2  g088(.a(x34), .b(new_n162_), .O(new_n172_));
  ...
  aoi21  g129(.a(new_n195_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x44), .b(new_n195_), .c(x09), .O(new_n214_));
  ...
  nand3  g135(.a(x45), .b(new_n195_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z33));
  inv1   g137(.a(x45), .O(new_n221_));
  aoi21  g138(.a(new_n195_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(x46), .b(new_n195_), .c(x09), .O(new_n223_));
  ...
  aoi21  g144(.a(new_n195_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(new_n195_), .b(x09), .c(x00), .O(new_n229_));
