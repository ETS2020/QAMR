...
module FAU ( 
  ...
  aoi21  g058(.a(new_n141_), .b(new_n92_), .c(x10), .O(z13));
  nand2  g059(.a(x26), .b(x08), .O(new_n143_));
  aoi21  g060(.a(new_n143_), .b(new_n92_), .c(x10), .O(z14));
  ...
  aoi21  g080(.a(x30), .b(new_n109_), .c(x25), .O(new_n164_));
  ...
  and2   g086(.a(new_n169_), .b(new_n91_), .O(z20));
  ...
  and2   g095(.a(new_n178_), .b(new_n91_), .O(z22));
  ...
  and2   g099(.a(new_n182_), .b(new_n91_), .O(z23));
  ...
  and2   g108(.a(new_n191_), .b(new_n91_), .O(z25));
  ...
  oai21  g118(.a(new_n201_), .b(new_n200_), .c(new_n92_), .O(new_n202_));
  ...
  aoi21  g156(.a(new_n215_), .b(x00), .c(x25), .O(new_n240_));
