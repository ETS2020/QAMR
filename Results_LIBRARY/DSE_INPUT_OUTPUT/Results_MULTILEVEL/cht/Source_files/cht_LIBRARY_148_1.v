...
module FAU ( 
  ...
  aoi21  g015(.a(x14), .b(new_n85_), .c(x41), .O(new_n99_));
  ...
  aoi21  g034(.a(x19), .b(x08), .c(x41), .O(new_n118_));
  ...
  aoi21  g072(.a(x29), .b(x08), .c(x41), .O(new_n156_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n92_), .c(new_n91_), .O(new_n176_));
  ...
  oai21  g115(.a(new_n198_), .b(new_n196_), .c(new_n92_), .O(new_n199_));
  ...
  aoi21  g124(.a(new_n207_), .b(new_n92_), .c(x10), .O(z29));
  inv1   g125(.a(x42), .O(new_n209_));
  nand4  g126(.a(new_n92_), .b(new_n194_), .c(new_n91_), .d(x09), .O(new_n210_));
  nor2   g127(.a(new_n210_), .b(new_n209_), .O(z30));
  inv1   g128(.a(new_n201_), .O(new_n212_));
  nand3  g129(.a(x43), .b(new_n194_), .c(x09), .O(new_n213_));
  oai21  g130(.a(new_n212_), .b(new_n209_), .c(new_n213_), .O(new_n214_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x41), .O(new_n220_));
