...
module FAU ( 
  ...
  oai21  g171(.a(x14), .b(new_n178_), .c(new_n87_), .O(new_n255_));
  aoi21  g172(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n256_));
  aoi21  g173(.a(new_n255_), .b(x00), .c(new_n256_), .O(new_n257_));
  oai21  g174(.a(new_n257_), .b(x10), .c(new_n88_), .O(z35));
endmodule
