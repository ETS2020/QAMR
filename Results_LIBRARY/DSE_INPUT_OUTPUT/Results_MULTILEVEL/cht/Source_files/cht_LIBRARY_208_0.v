...
module FAU ( 
  ...
  nand2  g034(.a(new_n109_), .b(x23), .O(new_n118_));
  ...
  nand3  g081(.a(new_n164_), .b(new_n101_), .c(x08), .O(new_n165_));
  ...
  nand3  g094(.a(new_n177_), .b(new_n101_), .c(x08), .O(new_n178_));
  ...
  nand3  g099(.a(new_n182_), .b(new_n101_), .c(x08), .O(new_n183_));
  ...
  nand3  g124(.a(new_n207_), .b(new_n101_), .c(x08), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z34));
  nand2  g126(.a(new_n174_), .b(x46), .O(new_n210_));
  aoi21  g127(.a(new_n200_), .b(x00), .c(new_n86_), .O(new_n211_));
