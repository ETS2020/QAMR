...
module FAU ( 
  ...
  nand2  g087(.a(x30), .b(new_n113_), .O(new_n171_));
  ...
  nand2  g093(.a(new_n176_), .b(new_n89_), .O(z20));
  ...
  nand2  g119(.a(x38), .b(new_n178_), .O(new_n203_));
  ...
  nand3  g152(.a(x46), .b(new_n101_), .c(x09), .O(new_n236_));
