...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n97_), .c(x08), .O(new_n101_));
  ...
  aoi21  g030(.a(new_n113_), .b(new_n84_), .c(x10), .O(z06));
  inv1   g031(.a(x18), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n84_), .c(x10), .O(z07));
  nor2   g033(.a(x10), .b(x08), .O(new_n117_));
  nand2  g034(.a(new_n117_), .b(x19), .O(new_n118_));
  inv1   g035(.a(new_n118_), .O(z08));
  inv1   g036(.a(x20), .O(new_n120_));
  aoi21  g037(.a(new_n120_), .b(new_n84_), .c(x10), .O(z09));
  nand2  g038(.a(new_n117_), .b(x21), .O(new_n122_));
  inv1   g039(.a(new_n122_), .O(z10));
  nand2  g040(.a(new_n117_), .b(x22), .O(new_n124_));
  inv1   g041(.a(new_n124_), .O(z11));
  nand2  g042(.a(new_n117_), .b(x23), .O(new_n126_));
  inv1   g043(.a(new_n126_), .O(z12));
  nand2  g044(.a(new_n117_), .b(x24), .O(new_n128_));
  inv1   g045(.a(new_n128_), .O(z13));
  inv1   g046(.a(x25), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n84_), .c(x10), .O(z14));
  nand2  g048(.a(new_n117_), .b(x26), .O(new_n132_));
  ...
  aoi21  g053(.a(new_n136_), .b(new_n84_), .c(x10), .O(z17));
  nand2  g054(.a(new_n117_), .b(x29), .O(new_n138_));
  inv1   g055(.a(new_n138_), .O(z18));
  nand2  g056(.a(new_n117_), .b(x30), .O(new_n140_));
  ...
  and2   g062(.a(new_n145_), .b(new_n85_), .O(z20));
  ...
  and2   g066(.a(new_n149_), .b(new_n85_), .O(z21));
  ...
  and2   g070(.a(new_n153_), .b(new_n85_), .O(z22));
