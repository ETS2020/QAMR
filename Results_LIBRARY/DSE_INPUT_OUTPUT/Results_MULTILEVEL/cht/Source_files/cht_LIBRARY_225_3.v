...
module FAU ( 
  ...
  aoi21  g128(.a(new_n211_), .b(new_n209_), .c(new_n207_), .O(new_n212_));
  nand3  g129(.a(new_n210_), .b(x39), .c(new_n99_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(new_n212_), .c(x09), .O(new_n215_));
  nand3  g132(.a(new_n87_), .b(x38), .c(new_n174_), .O(new_n216_));
  ...
  nand2  g143(.a(new_n218_), .b(x41), .O(new_n227_));
  ...
  nand3  g151(.a(new_n234_), .b(new_n87_), .c(new_n89_), .O(new_n235_));
  ...
  aoi21  g160(.a(new_n218_), .b(x44), .c(new_n243_), .O(new_n244_));
  oai21  g161(.a(new_n244_), .b(x10), .c(new_n87_), .O(z33));
  inv1   g162(.a(x45), .O(new_n246_));
  nand2  g163(.a(new_n218_), .b(new_n246_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(x46), .c(new_n208_), .O(new_n248_));
  nand3  g165(.a(new_n218_), .b(new_n210_), .c(x45), .O(new_n249_));
  aoi21  g166(.a(new_n249_), .b(new_n248_), .c(x10), .O(z34));
  nand2  g167(.a(new_n218_), .b(x46), .O(new_n251_));
  oai21  g168(.a(new_n218_), .b(new_n207_), .c(new_n251_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(new_n89_), .O(new_n253_));
