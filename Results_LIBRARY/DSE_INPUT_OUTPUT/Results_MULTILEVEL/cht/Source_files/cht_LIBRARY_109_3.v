...
module FAU ( 
  ...
  nand3  g054(.a(x24), .b(new_n84_), .c(new_n116_), .O(new_n138_));
  ...
  oai21  g062(.a(x28), .b(x10), .c(x08), .O(new_n146_));
  nand3  g063(.a(x27), .b(new_n84_), .c(new_n116_), .O(new_n147_));
  ...
  nand3  g069(.a(x29), .b(new_n84_), .c(new_n116_), .O(new_n153_));
  ...
  nand2  g083(.a(x33), .b(new_n158_), .O(new_n167_));
  nand2  g084(.a(x34), .b(x09), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n167_), .c(x10), .O(z22));
  nand2  g086(.a(x34), .b(new_n158_), .O(new_n170_));
  ...
  nand2  g093(.a(x36), .b(new_n158_), .O(new_n177_));
  oai21  g094(.a(new_n176_), .b(new_n158_), .c(new_n177_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n84_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n89_), .O(z25));
  ...
  nand2  g100(.a(new_n183_), .b(new_n89_), .O(z26));
  ...
  aoi21  g107(.a(new_n100_), .b(x09), .c(new_n185_), .O(new_n191_));
  nand3  g108(.a(x40), .b(new_n100_), .c(x09), .O(new_n192_));
  ...
  aoi21  g119(.a(new_n100_), .b(x09), .c(new_n202_), .O(new_n203_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n89_), .O(z30));
  inv1   g124(.a(x42), .O(new_n208_));
  aoi21  g125(.a(new_n100_), .b(x09), .c(new_n208_), .O(new_n209_));
  nand3  g126(.a(x43), .b(new_n100_), .c(x09), .O(new_n210_));
  ...
  nand2  g131(.a(new_n214_), .b(x43), .O(new_n215_));
  nand3  g132(.a(x44), .b(new_n100_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z32));
  nand2  g134(.a(new_n214_), .b(x44), .O(new_n218_));
  nand3  g135(.a(x45), .b(new_n100_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z33));
  nand2  g137(.a(new_n214_), .b(x45), .O(new_n221_));
  nand3  g138(.a(x46), .b(new_n100_), .c(x09), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n221_), .c(x10), .O(z34));
  nand2  g140(.a(new_n214_), .b(x46), .O(new_n224_));
