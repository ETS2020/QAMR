...
module FAU ( 
  ...
  oai21  g029(.a(x18), .b(new_n112_), .c(x17), .O(new_n113_));
  nand2  g030(.a(x18), .b(x08), .O(new_n114_));
  aoi21  g031(.a(new_n114_), .b(new_n113_), .c(x10), .O(z06));
  oai21  g032(.a(x19), .b(new_n112_), .c(x18), .O(new_n116_));
  ...
  nand2  g080(.a(x30), .b(new_n112_), .O(new_n164_));
  ...
  nand2  g108(.a(x37), .b(new_n166_), .O(new_n192_));
  oai21  g109(.a(new_n191_), .b(new_n166_), .c(new_n192_), .O(new_n193_));
  ...
  nand2  g134(.a(new_n217_), .b(new_n90_), .O(z30));
  ...
  nand2  g140(.a(new_n223_), .b(new_n90_), .O(z31));
  ...
  oai21  g159(.a(x14), .b(new_n166_), .c(x46), .O(new_n243_));
