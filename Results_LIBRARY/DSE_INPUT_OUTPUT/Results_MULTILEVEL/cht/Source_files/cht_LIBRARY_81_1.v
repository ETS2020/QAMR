...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x35), .O(new_n98_));
  aoi21  g015(.a(new_n98_), .b(new_n96_), .c(x10), .O(z02));
  nand2  g016(.a(x07), .b(x01), .O(new_n100_));
  aoi21  g017(.a(x14), .b(new_n97_), .c(x35), .O(new_n101_));
  ...
  aoi21  g084(.a(x30), .b(new_n113_), .c(x35), .O(new_n168_));
  ...
  aoi21  g093(.a(x33), .b(x09), .c(x35), .O(new_n177_));
  ...
  nand4  g100(.a(new_n85_), .b(x34), .c(new_n84_), .d(new_n175_), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z23));
  nand4  g102(.a(x36), .b(new_n85_), .c(new_n84_), .d(x09), .O(new_n186_));
  ...
  aoi21  g116(.a(x38), .b(new_n175_), .c(x35), .O(new_n200_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x35), .O(new_n212_));
  ...
  aoi21  g153(.a(new_n236_), .b(x09), .c(x35), .O(new_n237_));
