...
module FAU ( 
  ...
  aoi21  g027(.a(x18), .b(x08), .c(new_n97_), .O(new_n111_));
  ...
  nand3  g057(.a(new_n140_), .b(x41), .c(new_n84_), .O(new_n141_));
  inv1   g058(.a(new_n141_), .O(z14));
  nand2  g059(.a(x26), .b(new_n109_), .O(new_n143_));
  aoi21  g060(.a(x27), .b(x08), .c(new_n97_), .O(new_n144_));
  ...
  nand3  g104(.a(new_n187_), .b(x41), .c(new_n84_), .O(new_n188_));
  ...
  aoi21  g110(.a(x38), .b(new_n161_), .c(new_n97_), .O(new_n194_));
  ...
  nand2  g119(.a(new_n197_), .b(new_n199_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(x41), .c(new_n84_), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z29));
  nor2   g122(.a(x14), .b(new_n161_), .O(new_n206_));
  nor2   g123(.a(x42), .b(new_n97_), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z30));
  oai21  g125(.a(x14), .b(new_n161_), .c(x42), .O(new_n209_));
  nand3  g126(.a(x43), .b(new_n196_), .c(x09), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n209_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(x41), .c(new_n84_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z31));
  nand2  g130(.a(new_n197_), .b(x43), .O(new_n214_));
  inv1   g131(.a(x44), .O(new_n215_));
  nor2   g132(.a(new_n215_), .b(x14), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(x09), .c(new_n97_), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n214_), .c(x10), .O(z32));
  nand2  g135(.a(new_n197_), .b(x44), .O(new_n219_));
  inv1   g136(.a(x45), .O(new_n220_));
  nor2   g137(.a(new_n220_), .b(x14), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(x09), .c(new_n97_), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n219_), .c(x10), .O(z33));
  oai21  g140(.a(x14), .b(new_n161_), .c(x45), .O(new_n224_));
  nand3  g141(.a(x46), .b(new_n196_), .c(x09), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n224_), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(x41), .c(new_n84_), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(z34));
  nand2  g145(.a(new_n197_), .b(x46), .O(new_n229_));
  aoi21  g146(.a(new_n206_), .b(x00), .c(new_n97_), .O(new_n230_));
