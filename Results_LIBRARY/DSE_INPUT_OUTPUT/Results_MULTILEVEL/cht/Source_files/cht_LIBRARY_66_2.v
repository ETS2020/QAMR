...
module FAU ( 
  ...
  aoi21  g033(.a(new_n116_), .b(new_n94_), .c(x10), .O(z08));
  ...
  aoi21  g039(.a(new_n122_), .b(new_n94_), .c(x10), .O(z11));
  ...
  aoi21  g055(.a(new_n138_), .b(new_n94_), .c(x10), .O(z19));
  ...
  nand3  g060(.a(new_n143_), .b(new_n95_), .c(new_n94_), .O(new_n144_));
  ...
  and2   g069(.a(new_n152_), .b(new_n95_), .O(z22));
  nand2  g070(.a(x34), .b(new_n140_), .O(new_n154_));
  nand2  g071(.a(x35), .b(x09), .O(new_n155_));
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(new_n94_), .O(new_n156_));
  and2   g073(.a(new_n156_), .b(new_n95_), .O(z23));
  ...
  nand2  g088(.a(x39), .b(new_n96_), .O(new_n172_));
  ...
  oai21  g092(.a(new_n175_), .b(new_n173_), .c(new_n95_), .O(new_n176_));
  ...
  nand3  g111(.a(x43), .b(new_n96_), .c(x09), .O(new_n195_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x08), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n209_), .c(x10), .O(z34));
  inv1   g130(.a(x00), .O(new_n214_));
  nand2  g131(.a(new_n178_), .b(x46), .O(new_n215_));
  oai21  g132(.a(new_n178_), .b(new_n214_), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n95_), .c(new_n94_), .O(new_n217_));
