...
module FAU ( 
  ...
  nand2  g052(.a(new_n135_), .b(new_n97_), .O(z12));
  ...
  oai21  g067(.a(new_n149_), .b(new_n110_), .c(new_n150_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n91_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n97_), .O(z17));
  ...
  nand2  g073(.a(new_n156_), .b(new_n97_), .O(z18));
  ...
  nand2  g083(.a(new_n166_), .b(new_n97_), .O(z20));
  ...
  nand2  g102(.a(x37), .b(new_n168_), .O(new_n186_));
  ...
  oai21  g111(.a(new_n194_), .b(x10), .c(new_n97_), .O(z27));
  ...
  oai21  g116(.a(new_n199_), .b(new_n197_), .c(new_n91_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n97_), .O(z28));
  ...
  nand2  g130(.a(new_n196_), .b(x09), .O(new_n214_));
