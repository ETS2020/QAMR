...
module FAU ( 
  ...
  nand2  g001(.a(x30), .b(x19), .O(new_n85_));
  ...
  nand2  g047(.a(x20), .b(new_n115_), .O(new_n131_));
  ...
  nand2  g054(.a(new_n137_), .b(new_n85_), .O(z10));
  inv1   g055(.a(x23), .O(new_n139_));
  nand2  g056(.a(x22), .b(new_n115_), .O(new_n140_));
  ...
  nand2  g065(.a(x24), .b(new_n115_), .O(new_n149_));
  oai21  g066(.a(new_n148_), .b(new_n115_), .c(new_n149_), .O(new_n150_));
  ...
  nand2  g072(.a(new_n155_), .b(new_n85_), .O(z14));
  inv1   g073(.a(x27), .O(new_n157_));
  nand2  g074(.a(x26), .b(new_n115_), .O(new_n158_));
  oai21  g075(.a(new_n157_), .b(new_n115_), .c(new_n158_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n84_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n85_), .O(z15));
  ...
  nand2  g086(.a(new_n169_), .b(new_n85_), .O(z17));
  ...
  nor2   g092(.a(new_n175_), .b(x19), .O(new_n176_));
  nor2   g093(.a(x30), .b(new_n115_), .O(new_n177_));
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(x00), .O(new_n178_));
  nand2  g095(.a(new_n176_), .b(new_n115_), .O(new_n179_));
  ...
  oai21  g135(.a(new_n218_), .b(x10), .c(new_n85_), .O(z27));
  ...
  oai21  g157(.a(x14), .b(new_n181_), .c(x43), .O(new_n241_));
  ...
  oai21  g162(.a(x14), .b(new_n181_), .c(x44), .O(new_n246_));
  ...
  oai21  g167(.a(x14), .b(new_n181_), .c(x45), .O(new_n251_));
  ...
  oai21  g172(.a(x14), .b(new_n181_), .c(x46), .O(new_n256_));
