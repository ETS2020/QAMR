...
module FAU ( 
  ...
  aoi21  g037(.a(new_n120_), .b(x08), .c(x10), .O(z08));
  ...
  nand2  g044(.a(new_n115_), .b(x24), .O(new_n128_));
  ...
  aoi21  g053(.a(new_n136_), .b(x08), .c(x10), .O(z16));
  ...
  and2   g064(.a(new_n147_), .b(new_n84_), .O(z20));
  ...
  and2   g068(.a(new_n151_), .b(new_n84_), .O(z21));
  ...
  and2   g081(.a(new_n164_), .b(new_n84_), .O(z24));
  ...
  aoi21  g095(.a(x38), .b(new_n144_), .c(new_n102_), .O(new_n179_));
  ...
  aoi21  g112(.a(new_n195_), .b(x09), .c(new_n102_), .O(new_n196_));
  ...
  aoi21  g122(.a(new_n205_), .b(x09), .c(new_n102_), .O(new_n206_));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(new_n102_), .O(new_n216_));
