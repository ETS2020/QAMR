...
module FAU ( 
  ...
  aoi21  g050(.a(x23), .b(x08), .c(x42), .O(new_n134_));
  ...
  aoi21  g096(.a(x35), .b(x09), .c(x42), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z23));
  inv1   g098(.a(x36), .O(new_n182_));
  nand2  g099(.a(x35), .b(new_n167_), .O(new_n183_));
  oai21  g100(.a(new_n182_), .b(new_n167_), .c(new_n183_), .O(new_n184_));
  ...
  aoi21  g116(.a(x38), .b(new_n167_), .c(x42), .O(new_n200_));
  ...
  aoi21  g122(.a(new_n205_), .b(x09), .c(x42), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n203_), .c(x10), .O(z28));
  oai21  g124(.a(x14), .b(new_n167_), .c(x40), .O(new_n208_));
  ...
  aoi21  g130(.a(new_n213_), .b(new_n89_), .c(x10), .O(z30));
  nand3  g131(.a(x43), .b(new_n100_), .c(x09), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n89_), .c(x10), .O(z31));
  oai21  g133(.a(x14), .b(new_n167_), .c(x43), .O(new_n217_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x42), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n222_), .c(x10), .O(z33));
  oai21  g143(.a(x14), .b(new_n167_), .c(x45), .O(new_n227_));
  ...
  oai21  g148(.a(x14), .b(new_n167_), .c(x46), .O(new_n232_));
