...
module FAU ( 
  ...
  nand2  g055(.a(new_n138_), .b(new_n86_), .O(z10));
  ...
  nand2  g073(.a(new_n156_), .b(new_n86_), .O(z14));
  ...
  nand2  g079(.a(x27), .b(new_n116_), .O(new_n163_));
  oai21  g080(.a(new_n162_), .b(new_n116_), .c(new_n163_), .O(new_n164_));
  ...
  nand2  g087(.a(x29), .b(new_n116_), .O(new_n171_));
  oai21  g088(.a(new_n85_), .b(new_n116_), .c(new_n171_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n84_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n86_), .O(z18));
  oai21  g091(.a(x19), .b(new_n116_), .c(new_n85_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(x00), .O(new_n176_));
  nand2  g093(.a(x30), .b(new_n116_), .O(new_n177_));
  ...
  oai21  g165(.a(x14), .b(new_n179_), .c(x45), .O(new_n249_));
  ...
  oai21  g170(.a(x14), .b(new_n179_), .c(x46), .O(new_n254_));
