...
module FAU ( 
  ...
  nand2  g012(.a(x15), .b(x10), .O(new_n96_));
  ...
  oai21  g019(.a(x15), .b(x07), .c(x02), .O(new_n103_));
  ...
  nand2  g067(.a(new_n150_), .b(new_n96_), .O(z16));
  ...
  nand2  g072(.a(new_n155_), .b(new_n96_), .O(z17));
  ...
  nand2  g085(.a(new_n168_), .b(new_n96_), .O(z20));
  ...
  nand2  g089(.a(new_n172_), .b(new_n96_), .O(z21));
  ...
  nand2  g094(.a(new_n177_), .b(new_n96_), .O(z22));
  ...
  nand2  g098(.a(new_n181_), .b(new_n96_), .O(z23));
  ...
  nand2  g103(.a(new_n186_), .b(new_n96_), .O(z24));
  ...
  nand2  g147(.a(new_n230_), .b(new_n96_), .O(z34));
