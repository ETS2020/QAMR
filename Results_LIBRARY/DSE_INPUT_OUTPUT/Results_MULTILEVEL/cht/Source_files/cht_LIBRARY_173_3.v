...
module FAU ( 
  ...
  nand2  g015(.a(x30), .b(x10), .O(new_n99_));
  ...
  nand2  g035(.a(new_n118_), .b(new_n99_), .O(z07));
  ...
  oai21  g041(.a(new_n123_), .b(new_n111_), .c(new_n124_), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(new_n94_), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(new_n99_), .O(z09));
  ...
  nand2  g047(.a(new_n130_), .b(new_n99_), .O(z10));
  ...
  nand2  g058(.a(new_n141_), .b(new_n99_), .O(z13));
  ...
  oai21  g073(.a(x10), .b(x08), .c(x30), .O(new_n157_));
  nand3  g074(.a(x29), .b(new_n94_), .c(new_n111_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n157_), .O(z18));
  inv1   g076(.a(x30), .O(new_n160_));
  nor2   g077(.a(x10), .b(new_n111_), .O(new_n161_));
  nand2  g078(.a(new_n161_), .b(x00), .O(new_n162_));
  oai21  g079(.a(new_n161_), .b(new_n160_), .c(new_n162_), .O(z19));
  ...
  nand2  g091(.a(new_n174_), .b(new_n99_), .O(z22));
  ...
  nand2  g098(.a(x36), .b(new_n164_), .O(new_n182_));
  ...
  oai21  g110(.a(new_n193_), .b(x10), .c(new_n99_), .O(z27));
  nand2  g111(.a(new_n95_), .b(x09), .O(new_n195_));
  ...
  aoi21  g122(.a(new_n95_), .b(x09), .c(new_n205_), .O(new_n206_));
  ...
  nand2  g126(.a(new_n209_), .b(new_n99_), .O(z31));
  ...
  nand2  g138(.a(new_n221_), .b(new_n99_), .O(z34));
  inv1   g139(.a(x46), .O(new_n223_));
  aoi21  g140(.a(new_n95_), .b(x09), .c(new_n223_), .O(new_n224_));
  nand3  g141(.a(new_n95_), .b(x09), .c(x00), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(new_n226_));
  oai21  g143(.a(new_n226_), .b(new_n224_), .c(new_n94_), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(new_n99_), .O(z35));
endmodule
