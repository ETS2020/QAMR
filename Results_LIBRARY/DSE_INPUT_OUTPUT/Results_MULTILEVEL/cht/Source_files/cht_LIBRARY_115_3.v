...
module FAU ( 
  ...
  oai21  g040(.a(new_n122_), .b(new_n109_), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g127(.a(new_n202_), .b(x09), .c(new_n210_), .O(new_n211_));
  ...
  aoi21  g145(.a(new_n202_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(x46), .b(new_n202_), .c(x09), .O(new_n230_));
