...
module FAU ( 
  ...
  nor2   g073(.a(x30), .b(x08), .O(new_n157_));
  oai21  g074(.a(new_n157_), .b(x27), .c(x26), .O(new_n158_));
  nand2  g075(.a(x27), .b(x08), .O(new_n159_));
  aoi21  g076(.a(new_n159_), .b(new_n158_), .c(x10), .O(z15));
  nand2  g077(.a(x28), .b(x08), .O(new_n161_));
  oai21  g078(.a(new_n85_), .b(x08), .c(new_n161_), .O(new_n162_));
  ...
  nand2  g086(.a(x30), .b(new_n85_), .O(new_n170_));
  nand3  g087(.a(new_n170_), .b(x29), .c(new_n115_), .O(new_n171_));
  and2   g088(.a(x30), .b(x27), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(x08), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n171_), .c(x10), .O(z18));
  nand3  g091(.a(new_n170_), .b(x08), .c(x00), .O(new_n175_));
  nand2  g092(.a(new_n172_), .b(new_n115_), .O(new_n176_));
