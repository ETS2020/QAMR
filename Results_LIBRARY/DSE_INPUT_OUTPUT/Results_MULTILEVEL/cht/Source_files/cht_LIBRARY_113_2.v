...
module FAU ( 
  ...
  nand2  g034(.a(new_n117_), .b(new_n90_), .O(z07));
  ...
  nand2  g095(.a(new_n178_), .b(new_n90_), .O(z24));
  ...
  aoi21  g115(.a(new_n193_), .b(x09), .c(new_n198_), .O(new_n199_));
  nand3  g116(.a(x41), .b(new_n193_), .c(x09), .O(new_n200_));
  ...
  nand3  g122(.a(x42), .b(new_n193_), .c(x09), .O(new_n206_));
  ...
  nor2   g126(.a(x14), .b(new_n160_), .O(new_n210_));
  oai21  g127(.a(new_n210_), .b(x42), .c(x43), .O(new_n211_));
  nand2  g128(.a(new_n194_), .b(x42), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z31));
  inv1   g130(.a(x43), .O(new_n214_));
  aoi21  g131(.a(new_n193_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  aoi21  g137(.a(new_n193_), .b(x09), .c(new_n220_), .O(new_n221_));
  nand3  g138(.a(x45), .b(new_n193_), .c(x09), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n193_), .b(x09), .c(new_n226_), .O(new_n227_));
  ...
  nand2  g147(.a(new_n230_), .b(new_n90_), .O(z34));
  nand2  g148(.a(new_n194_), .b(x46), .O(new_n232_));
  nand2  g149(.a(new_n210_), .b(x00), .O(new_n233_));
