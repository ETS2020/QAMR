...
module FAU ( 
  ...
  nand3  g051(.a(x23), .b(new_n84_), .c(new_n116_), .O(new_n135_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n89_), .O(z20));
  ...
  nand2  g087(.a(x34), .b(new_n163_), .O(new_n171_));
  ...
  nand2  g109(.a(new_n100_), .b(x09), .O(new_n193_));
  ...
  aoi21  g114(.a(new_n100_), .b(x09), .c(new_n197_), .O(new_n198_));
  ...
  nand2  g119(.a(new_n193_), .b(x41), .O(new_n203_));
  ...
  nand2  g140(.a(new_n193_), .b(x45), .O(new_n224_));
  nand3  g141(.a(x46), .b(new_n100_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z34));
  nand2  g143(.a(new_n193_), .b(x46), .O(new_n227_));
  nand3  g144(.a(new_n100_), .b(x09), .c(x00), .O(new_n228_));
