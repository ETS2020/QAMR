...
module FAU ( 
  ...
  nand3  g106(.a(x35), .b(new_n88_), .c(new_n177_), .O(new_n190_));
  ...
  nand3  g118(.a(x38), .b(new_n88_), .c(new_n177_), .O(new_n202_));
  ...
  nor2   g125(.a(x10), .b(x09), .O(new_n209_));
  aoi21  g126(.a(x14), .b(x09), .c(new_n209_), .O(new_n210_));
  aoi21  g127(.a(x41), .b(new_n100_), .c(x10), .O(new_n211_));
  oai22  g128(.a(new_n211_), .b(new_n177_), .c(new_n210_), .d(new_n208_), .O(z29));
  inv1   g129(.a(x41), .O(new_n213_));
  aoi21  g130(.a(x42), .b(new_n100_), .c(x10), .O(new_n214_));
  oai22  g131(.a(new_n214_), .b(new_n177_), .c(new_n210_), .d(new_n213_), .O(z30));
  inv1   g132(.a(x42), .O(new_n216_));
  aoi21  g133(.a(x43), .b(new_n100_), .c(x10), .O(new_n217_));
  oai22  g134(.a(new_n217_), .b(new_n177_), .c(new_n210_), .d(new_n216_), .O(z31));
  nand2  g135(.a(new_n204_), .b(x43), .O(new_n219_));
  nand3  g136(.a(x44), .b(new_n100_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z32));
  inv1   g138(.a(x44), .O(new_n222_));
  aoi21  g139(.a(x45), .b(new_n100_), .c(x10), .O(new_n223_));
  oai22  g140(.a(new_n223_), .b(new_n177_), .c(new_n210_), .d(new_n222_), .O(z33));
  inv1   g141(.a(x45), .O(new_n225_));
  aoi21  g142(.a(x46), .b(new_n100_), .c(x10), .O(new_n226_));
  oai22  g143(.a(new_n226_), .b(new_n177_), .c(new_n210_), .d(new_n225_), .O(z34));
  nand2  g144(.a(new_n204_), .b(x46), .O(new_n228_));
  nand3  g145(.a(new_n100_), .b(x09), .c(x00), .O(new_n229_));
