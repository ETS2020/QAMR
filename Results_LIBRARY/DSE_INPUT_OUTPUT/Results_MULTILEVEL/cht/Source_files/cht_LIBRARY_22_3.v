...
module FAU ( 
  ...
  oai21  g010(.a(x10), .b(x07), .c(x01), .O(new_n94_));
  ...
  nand2  g017(.a(new_n100_), .b(new_n95_), .O(new_n101_));
  nand2  g018(.a(x10), .b(x01), .O(new_n102_));
  ...
  nand2  g023(.a(new_n106_), .b(new_n95_), .O(new_n107_));
  ...
  nand2  g035(.a(new_n118_), .b(new_n95_), .O(new_n119_));
  ...
  nand2  g047(.a(new_n130_), .b(new_n102_), .O(z11));
  ...
  nand2  g054(.a(new_n137_), .b(new_n95_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n102_), .O(z13));
  ...
  nand2  g062(.a(new_n145_), .b(new_n95_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n102_), .O(z15));
  ...
  nand2  g070(.a(new_n153_), .b(new_n95_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n102_), .O(z17));
  nand2  g072(.a(x30), .b(x08), .O(new_n156_));
  oai21  g073(.a(new_n151_), .b(x08), .c(new_n156_), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(new_n95_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n102_), .O(z18));
  ...
  nand2  g087(.a(new_n170_), .b(new_n102_), .O(z21));
  ...
  nand2  g095(.a(new_n178_), .b(new_n102_), .O(z23));
  ...
  nand2  g103(.a(new_n186_), .b(new_n102_), .O(z25));
  ...
  oai21  g117(.a(new_n200_), .b(new_n198_), .c(new_n95_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n102_), .O(z28));
  ...
  oai21  g127(.a(new_n210_), .b(new_n208_), .c(new_n95_), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n102_), .O(z30));
  ...
  nand2  g134(.a(new_n217_), .b(new_n102_), .O(z31));
  ...
  nand2  g140(.a(new_n223_), .b(new_n102_), .O(z32));
  ...
  nand3  g145(.a(x46), .b(new_n197_), .c(x09), .O(new_n229_));
  ...
  nand3  g149(.a(new_n197_), .b(x09), .c(x00), .O(new_n233_));
  inv1   g150(.a(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(new_n232_), .c(new_n95_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n102_), .O(z35));
endmodule
