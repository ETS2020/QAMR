...
module FAU ( 
  ...
  nor2   g025(.a(x10), .b(new_n97_), .O(new_n109_));
  ...
  aoi21  g090(.a(x38), .b(new_n138_), .c(new_n97_), .O(new_n174_));
  ...
  aoi21  g097(.a(new_n180_), .b(x09), .c(new_n97_), .O(new_n181_));
  ...
  aoi21  g102(.a(new_n185_), .b(x09), .c(new_n97_), .O(new_n186_));
  ...
  aoi21  g117(.a(new_n200_), .b(x09), .c(new_n97_), .O(new_n201_));
  ...
  aoi21  g131(.a(new_n214_), .b(x00), .c(new_n97_), .O(new_n215_));
