...
module FAU ( 
  ...
  nor2   g070(.a(x26), .b(x08), .O(new_n154_));
  inv1   g071(.a(x26), .O(new_n155_));
  nor2   g072(.a(new_n85_), .b(new_n155_), .O(new_n156_));
  oai21  g073(.a(new_n156_), .b(new_n154_), .c(x25), .O(new_n157_));
  nand2  g074(.a(new_n156_), .b(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z14));
  ...
  nor2   g096(.a(x26), .b(x09), .O(new_n180_));
  oai21  g097(.a(new_n180_), .b(x32), .c(x31), .O(new_n181_));
  nand2  g098(.a(x32), .b(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z20));
  nand2  g100(.a(x33), .b(x09), .O(new_n184_));
  oai21  g101(.a(new_n85_), .b(x09), .c(new_n184_), .O(new_n185_));
  ...
  oai21  g145(.a(x14), .b(new_n188_), .c(x41), .O(new_n229_));
  ...
  oai21  g150(.a(x14), .b(new_n188_), .c(x42), .O(new_n234_));
  ...
  oai21  g155(.a(x14), .b(new_n188_), .c(x43), .O(new_n239_));
  ...
  oai21  g160(.a(x14), .b(new_n188_), .c(x44), .O(new_n244_));
