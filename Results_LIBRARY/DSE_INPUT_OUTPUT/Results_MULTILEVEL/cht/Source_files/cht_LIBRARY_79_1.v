...
module FAU ( 
  ...
  aoi21  g019(.a(x14), .b(new_n102_), .c(x43), .O(new_n103_));
  ...
  aoi21  g053(.a(x24), .b(x08), .c(x43), .O(new_n137_));
  ...
  aoi21  g106(.a(x37), .b(x09), .c(x43), .O(new_n190_));
  ...
  aoi21  g117(.a(x38), .b(new_n168_), .c(x43), .O(new_n201_));
  ...
  nand4  g139(.a(new_n85_), .b(new_n204_), .c(new_n84_), .d(x09), .O(new_n223_));
  nor2   g140(.a(new_n223_), .b(new_n222_), .O(z32));
  nand2  g141(.a(new_n219_), .b(x44), .O(new_n225_));
  inv1   g142(.a(x45), .O(new_n226_));
  nor2   g143(.a(new_n226_), .b(x14), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(x09), .c(x43), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n225_), .c(x10), .O(z33));
  nand2  g146(.a(new_n219_), .b(x45), .O(new_n230_));
  inv1   g147(.a(x46), .O(new_n231_));
  nor2   g148(.a(new_n231_), .b(x14), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(x09), .c(x43), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n230_), .c(x10), .O(z34));
  oai21  g151(.a(x14), .b(new_n168_), .c(x46), .O(new_n235_));
  nand3  g152(.a(new_n204_), .b(x09), .c(x00), .O(new_n236_));
