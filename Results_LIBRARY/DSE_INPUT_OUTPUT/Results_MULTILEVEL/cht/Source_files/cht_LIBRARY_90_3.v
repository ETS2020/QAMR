...
module FAU ( 
  ...
  nand3  g047(.a(x23), .b(new_n84_), .c(new_n112_), .O(new_n131_));
  ...
  nand3  g065(.a(x29), .b(new_n84_), .c(new_n112_), .O(new_n149_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n89_), .O(z21));
  ...
  nand2  g119(.a(new_n202_), .b(new_n89_), .O(z31));
