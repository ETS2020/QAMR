...
module FAU ( 
  ...
  nand2  g049(.a(x22), .b(new_n113_), .O(new_n133_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n93_), .O(z17));
  ...
  nand2  g090(.a(new_n173_), .b(new_n93_), .O(z20));
  ...
  oai21  g103(.a(x10), .b(x09), .c(x36), .O(new_n187_));
  nand3  g104(.a(x35), .b(new_n88_), .c(new_n175_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n187_), .O(z24));
  oai21  g106(.a(x10), .b(new_n175_), .c(x36), .O(new_n190_));
  nand3  g107(.a(x37), .b(new_n88_), .c(x09), .O(new_n191_));
  ...
  nand3  g147(.a(x46), .b(new_n100_), .c(x09), .O(new_n231_));
