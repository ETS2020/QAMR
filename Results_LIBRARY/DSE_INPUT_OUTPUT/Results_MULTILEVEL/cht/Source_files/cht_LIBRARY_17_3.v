...
module FAU ( 
  ...
  nand2  g066(.a(x26), .b(new_n118_), .O(new_n150_));
  ...
  oai21  g091(.a(x33), .b(new_n174_), .c(x32), .O(new_n175_));
  nand2  g092(.a(x33), .b(x09), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n175_), .c(x10), .O(z21));
  oai21  g094(.a(x10), .b(new_n174_), .c(x33), .O(new_n178_));
  nand3  g095(.a(x34), .b(new_n84_), .c(x09), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(z22));
  ...
  nand2  g107(.a(x36), .b(new_n174_), .O(new_n191_));
  oai21  g108(.a(new_n190_), .b(new_n174_), .c(new_n191_), .O(new_n192_));
  ...
  oai21  g121(.a(new_n204_), .b(x10), .c(new_n89_), .O(z27));
  ...
  aoi21  g128(.a(new_n206_), .b(x09), .c(new_n211_), .O(new_n212_));
  nand3  g129(.a(x41), .b(new_n206_), .c(x09), .O(new_n213_));
  ...
  nand3  g140(.a(x43), .b(new_n206_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z31));
  inv1   g142(.a(x43), .O(new_n226_));
  aoi21  g143(.a(new_n206_), .b(x09), .c(new_n226_), .O(new_n227_));
  nand3  g144(.a(x44), .b(new_n206_), .c(x09), .O(new_n228_));
  ...
  nand2  g148(.a(new_n207_), .b(x44), .O(new_n232_));
  nand3  g149(.a(x45), .b(new_n206_), .c(x09), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n232_), .c(x10), .O(z33));
  nand2  g151(.a(new_n207_), .b(x45), .O(new_n235_));
  nand3  g152(.a(x46), .b(new_n206_), .c(x09), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(new_n235_), .c(x10), .O(z34));
  inv1   g154(.a(x46), .O(new_n238_));
  aoi21  g155(.a(new_n206_), .b(x09), .c(new_n238_), .O(new_n239_));
  nand3  g156(.a(new_n206_), .b(x09), .c(x00), .O(new_n240_));
