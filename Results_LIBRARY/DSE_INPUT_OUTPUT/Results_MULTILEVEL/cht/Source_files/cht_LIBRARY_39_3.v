...
module FAU ( 
  ...
  nand2  g034(.a(new_n117_), .b(new_n89_), .O(z08));
  ...
  nand2  g061(.a(x26), .b(new_n107_), .O(new_n145_));
  ...
  nand3  g102(.a(x37), .b(new_n84_), .c(new_n167_), .O(new_n186_));
  ...
  nand3  g119(.a(x42), .b(new_n194_), .c(x09), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z30));
  inv1   g121(.a(x42), .O(new_n205_));
  nor2   g122(.a(x10), .b(x09), .O(new_n206_));
  aoi21  g123(.a(x14), .b(x09), .c(new_n206_), .O(new_n207_));
  aoi21  g124(.a(x43), .b(new_n194_), .c(x10), .O(new_n208_));
  oai22  g125(.a(new_n208_), .b(new_n167_), .c(new_n207_), .d(new_n205_), .O(z31));
  inv1   g126(.a(x43), .O(new_n210_));
  aoi21  g127(.a(x44), .b(new_n194_), .c(x10), .O(new_n211_));
  oai22  g128(.a(new_n211_), .b(new_n167_), .c(new_n207_), .d(new_n210_), .O(z32));
  inv1   g129(.a(x44), .O(new_n213_));
  aoi21  g130(.a(x45), .b(new_n194_), .c(x10), .O(new_n214_));
  oai22  g131(.a(new_n214_), .b(new_n167_), .c(new_n207_), .d(new_n213_), .O(z33));
  nand2  g132(.a(new_n195_), .b(x45), .O(new_n216_));
  nand3  g133(.a(x46), .b(new_n194_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  inv1   g135(.a(x46), .O(new_n219_));
  aoi21  g136(.a(new_n194_), .b(x00), .c(x10), .O(new_n220_));
  oai22  g137(.a(new_n220_), .b(new_n167_), .c(new_n207_), .d(new_n219_), .O(z35));
endmodule
