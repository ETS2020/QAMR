...
module FAU ( 
  ...
  oai21  g055(.a(new_n137_), .b(new_n109_), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g075(.a(new_n157_), .b(new_n109_), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(z23));
  ...
  nand2  g110(.a(x37), .b(new_n171_), .O(new_n194_));
  oai21  g111(.a(new_n193_), .b(new_n171_), .c(new_n194_), .O(new_n195_));
  ...
  aoi21  g129(.a(new_n204_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x42), .b(new_n204_), .c(x09), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(new_n84_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n89_), .O(z30));
  inv1   g134(.a(x42), .O(new_n218_));
  aoi21  g135(.a(new_n204_), .b(x09), .c(new_n218_), .O(new_n219_));
  nand3  g136(.a(x43), .b(new_n204_), .c(x09), .O(new_n220_));
  inv1   g137(.a(new_n220_), .O(new_n221_));
  oai21  g138(.a(new_n221_), .b(new_n219_), .c(new_n84_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n89_), .O(z31));
  nand2  g140(.a(new_n205_), .b(x43), .O(new_n224_));
  nand3  g141(.a(x44), .b(new_n204_), .c(x09), .O(new_n225_));
