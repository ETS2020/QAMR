...
module FAU ( 
  ...
  nand2  g060(.a(new_n143_), .b(new_n90_), .O(z12));
  ...
  nand2  g072(.a(x27), .b(new_n119_), .O(new_n156_));
  ...
  nand2  g139(.a(new_n101_), .b(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(x42), .O(new_n224_));
  nand3  g141(.a(x43), .b(new_n101_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z31));
  nand2  g143(.a(new_n223_), .b(x43), .O(new_n227_));
  nand3  g144(.a(x44), .b(new_n101_), .c(x09), .O(new_n228_));
  ...
  nand2  g158(.a(new_n223_), .b(x46), .O(new_n242_));
  nand3  g159(.a(new_n101_), .b(x09), .c(x00), .O(new_n243_));
