...
module FAU ( 
  ...
  nand2  g099(.a(x34), .b(new_n171_), .O(new_n183_));
  ...
  nand2  g106(.a(new_n189_), .b(new_n94_), .O(z24));
  ...
  nor2   g121(.a(x14), .b(new_n171_), .O(new_n205_));
  oai21  g122(.a(new_n205_), .b(x39), .c(x40), .O(new_n206_));
  ...
  aoi21  g126(.a(new_n101_), .b(x09), .c(new_n93_), .O(new_n210_));
  ...
  nand2  g136(.a(new_n219_), .b(new_n94_), .O(z30));
  ...
  nand2  g142(.a(new_n225_), .b(new_n94_), .O(z31));
  ...
  nand2  g148(.a(new_n231_), .b(new_n94_), .O(z32));
  nand2  g149(.a(new_n207_), .b(x44), .O(new_n233_));
  nand3  g150(.a(x45), .b(new_n101_), .c(x09), .O(new_n234_));
  ...
  nand2  g156(.a(new_n205_), .b(x00), .O(new_n240_));
