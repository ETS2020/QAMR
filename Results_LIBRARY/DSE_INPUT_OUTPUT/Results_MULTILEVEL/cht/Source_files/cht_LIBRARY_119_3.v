...
module FAU ( 
  ...
  nand2  g005(.a(x12), .b(x10), .O(new_n89_));
  ...
  nand2  g062(.a(x25), .b(new_n118_), .O(new_n146_));
  ...
  nand2  g073(.a(x28), .b(new_n118_), .O(new_n157_));
  nand2  g074(.a(x29), .b(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z17));
  inv1   g076(.a(x30), .O(new_n160_));
  nand2  g077(.a(x29), .b(new_n118_), .O(new_n161_));
  oai21  g078(.a(new_n160_), .b(new_n118_), .c(new_n161_), .O(new_n162_));
  ...
  nand3  g125(.a(x42), .b(new_n100_), .c(x09), .O(new_n209_));
  ...
  nand2  g133(.a(new_n201_), .b(x43), .O(new_n217_));
  ...
  nand2  g147(.a(new_n230_), .b(new_n89_), .O(z34));
