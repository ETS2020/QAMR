...
module FAU ( 
  ...
  nand3  g052(.a(new_n135_), .b(new_n91_), .c(new_n84_), .O(new_n136_));
  ...
  oai21  g057(.a(new_n140_), .b(x10), .c(new_n91_), .O(z10));
  ...
  nor2   g066(.a(new_n90_), .b(x08), .O(new_n150_));
  ...
  nand3  g098(.a(new_n181_), .b(new_n91_), .c(new_n84_), .O(new_n182_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n91_), .O(z24));
  ...
  nand2  g126(.a(new_n209_), .b(new_n91_), .O(z26));
  nand2  g127(.a(x14), .b(x00), .O(new_n211_));
  nand2  g128(.a(x39), .b(new_n103_), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(new_n178_), .O(new_n213_));
  nor2   g130(.a(new_n206_), .b(x09), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(new_n213_), .c(new_n91_), .O(new_n215_));
  ...
  nand3  g147(.a(new_n230_), .b(new_n91_), .c(new_n84_), .O(new_n231_));
  ...
  nand2  g153(.a(new_n236_), .b(new_n91_), .O(z31));
  ...
  nand2  g173(.a(new_n256_), .b(new_n91_), .O(z35));
endmodule
