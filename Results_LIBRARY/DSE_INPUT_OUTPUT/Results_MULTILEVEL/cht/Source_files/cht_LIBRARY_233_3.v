...
module FAU ( 
  ...
  oai21  g099(.a(new_n182_), .b(x10), .c(new_n93_), .O(z27));
  ...
  nand2  g105(.a(new_n188_), .b(new_n93_), .O(z28));
  ...
  nand2  g115(.a(new_n198_), .b(new_n93_), .O(z30));
  ...
  nand2  g130(.a(new_n213_), .b(new_n93_), .O(z34));
