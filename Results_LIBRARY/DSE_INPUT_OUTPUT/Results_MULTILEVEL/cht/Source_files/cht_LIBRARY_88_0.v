...
module FAU ( 
  ...
  nand3  g078(.a(new_n161_), .b(x42), .c(new_n89_), .O(new_n162_));
  ...
  aoi21  g085(.a(x32), .b(x09), .c(new_n86_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z20));
  nand2  g087(.a(x32), .b(new_n167_), .O(new_n171_));
  aoi21  g088(.a(x33), .b(x09), .c(new_n86_), .O(new_n172_));
  ...
  nand3  g093(.a(new_n176_), .b(x42), .c(new_n89_), .O(new_n177_));
  ...
  nand3  g110(.a(new_n193_), .b(x42), .c(new_n89_), .O(new_n194_));
  ...
  aoi21  g116(.a(x38), .b(new_n167_), .c(new_n86_), .O(new_n200_));
  ...
  nor2   g129(.a(new_n86_), .b(x41), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n202_), .c(x10), .O(z30));
  inv1   g131(.a(new_n202_), .O(new_n215_));
  nor2   g132(.a(x43), .b(new_n86_), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z31));
  oai21  g134(.a(x14), .b(new_n167_), .c(x43), .O(new_n218_));
  nand3  g135(.a(x44), .b(new_n100_), .c(x09), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n218_), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(x42), .c(new_n89_), .O(new_n221_));
