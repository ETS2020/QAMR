...
module FAU ( 
  ...
  nand3  g017(.a(new_n100_), .b(x25), .c(new_n89_), .O(new_n101_));
  ...
  nand3  g036(.a(new_n119_), .b(x25), .c(new_n89_), .O(new_n120_));
  ...
  nand3  g041(.a(new_n124_), .b(x25), .c(new_n89_), .O(new_n125_));
  ...
  nand3  g049(.a(new_n132_), .b(x25), .c(new_n89_), .O(new_n133_));
  inv1   g050(.a(new_n133_), .O(z11));
  nand2  g051(.a(x24), .b(x08), .O(new_n135_));
  oai21  g052(.a(new_n130_), .b(x08), .c(new_n135_), .O(new_n136_));
  nand3  g053(.a(new_n136_), .b(x25), .c(new_n89_), .O(new_n137_));
  inv1   g054(.a(new_n137_), .O(z12));
  oai21  g055(.a(x24), .b(x08), .c(x25), .O(new_n139_));
  nor2   g056(.a(new_n139_), .b(x10), .O(z13));
  nor2   g057(.a(x26), .b(new_n86_), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(x08), .c(x10), .O(z14));
  ...
  nand3  g071(.a(new_n154_), .b(x25), .c(new_n89_), .O(new_n155_));
  ...
  oai21  g116(.a(new_n199_), .b(new_n197_), .c(x25), .O(new_n200_));
  ...
  nand3  g122(.a(new_n205_), .b(x25), .c(new_n89_), .O(new_n206_));
  ...
  nand3  g127(.a(new_n210_), .b(x25), .c(new_n89_), .O(new_n211_));
  ...
  nand3  g137(.a(new_n220_), .b(x25), .c(new_n89_), .O(new_n221_));
  ...
  nand3  g146(.a(new_n229_), .b(x25), .c(new_n89_), .O(new_n230_));
  ...
  aoi21  g154(.a(new_n218_), .b(x00), .c(new_n86_), .O(new_n238_));
