...
module FAU ( 
  ...
  nand2  g043(.a(new_n126_), .b(new_n100_), .O(z09));
  ...
  nand2  g056(.a(new_n139_), .b(new_n100_), .O(z12));
  ...
  oai21  g062(.a(new_n144_), .b(new_n115_), .c(new_n145_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n94_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n100_), .O(z14));
  ...
  nand2  g092(.a(new_n175_), .b(new_n100_), .O(z22));
  ...
  nand2  g096(.a(new_n179_), .b(new_n100_), .O(z23));
  ...
  oai21  g114(.a(new_n197_), .b(x10), .c(new_n100_), .O(z27));
  nand2  g115(.a(new_n95_), .b(x09), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(x39), .O(new_n200_));
  nand3  g117(.a(x40), .b(new_n95_), .c(x09), .O(new_n201_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n100_), .O(z31));
  nor2   g131(.a(x14), .b(new_n165_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(x43), .c(x44), .O(new_n216_));
  nand2  g133(.a(new_n199_), .b(x43), .O(new_n217_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n100_), .O(z33));
  ...
  nand2  g146(.a(new_n229_), .b(new_n100_), .O(z34));
  nand2  g147(.a(new_n199_), .b(x46), .O(new_n231_));
  nand2  g148(.a(new_n215_), .b(x00), .O(new_n232_));
