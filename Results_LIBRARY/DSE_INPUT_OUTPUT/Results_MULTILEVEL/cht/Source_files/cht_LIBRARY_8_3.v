...
module FAU ( 
  ...
  nand2  g009(.a(x43), .b(x10), .O(new_n93_));
  ...
  nand2  g081(.a(x30), .b(new_n116_), .O(new_n165_));
  ...
  nand3  g129(.a(new_n197_), .b(x42), .c(new_n88_), .O(new_n213_));
  nor2   g130(.a(x14), .b(new_n167_), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(x10), .c(x43), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n213_), .O(z31));
  oai21  g133(.a(new_n214_), .b(x43), .c(x44), .O(new_n217_));
  ...
  nand2  g142(.a(new_n197_), .b(x45), .O(new_n226_));
