...
module FAU ( 
  ...
  nor3   g005(.a(new_n86_), .b(new_n85_), .c(x05), .O(new_n89_));
  ...
  nand3  g011(.a(new_n94_), .b(x12), .c(new_n91_), .O(new_n95_));
  ...
  nand3  g019(.a(new_n102_), .b(x12), .c(new_n91_), .O(new_n103_));
  inv1   g020(.a(new_n103_), .O(z04));
  inv1   g021(.a(x16), .O(new_n105_));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  oai21  g023(.a(new_n105_), .b(x07), .c(new_n106_), .O(new_n107_));
  nand3  g024(.a(new_n107_), .b(x12), .c(new_n91_), .O(new_n108_));
  ...
  nand3  g029(.a(new_n112_), .b(x12), .c(new_n91_), .O(new_n113_));
  ...
  nand3  g038(.a(new_n121_), .b(new_n120_), .c(x12), .O(new_n122_));
  ...
  nand3  g043(.a(new_n126_), .b(x12), .c(new_n91_), .O(new_n127_));
  ...
  nand3  g051(.a(new_n134_), .b(new_n133_), .c(x12), .O(new_n135_));
  ...
  nand3  g116(.a(new_n199_), .b(x12), .c(new_n91_), .O(new_n200_));
  ...
  oai21  g123(.a(new_n206_), .b(new_n205_), .c(x12), .O(new_n207_));
  ...
  nand3  g129(.a(new_n212_), .b(x12), .c(new_n91_), .O(new_n213_));
  ...
  nand3  g134(.a(new_n217_), .b(x12), .c(new_n91_), .O(new_n218_));
  ...
  nand3  g154(.a(new_n237_), .b(x12), .c(new_n91_), .O(new_n238_));
  ...
  nand3  g164(.a(new_n247_), .b(x12), .c(new_n91_), .O(new_n248_));
