...
module FAU ( 
  ...
  nand2  g003(.a(x46), .b(x16), .O(new_n87_));
  ...
  nand3  g061(.a(new_n144_), .b(new_n87_), .c(new_n89_), .O(new_n145_));
  ...
  nand3  g066(.a(new_n149_), .b(new_n87_), .c(new_n89_), .O(new_n150_));
  ...
  nand3  g120(.a(new_n203_), .b(new_n87_), .c(new_n89_), .O(new_n204_));
  ...
  oai21  g137(.a(new_n220_), .b(x10), .c(new_n87_), .O(z29));
  ...
  nand3  g150(.a(new_n233_), .b(new_n87_), .c(new_n89_), .O(new_n234_));
  ...
  oai21  g155(.a(new_n238_), .b(x10), .c(new_n87_), .O(z33));
  ...
  oai21  g159(.a(new_n242_), .b(x10), .c(new_n87_), .O(z34));
  nand3  g160(.a(new_n240_), .b(new_n99_), .c(x09), .O(new_n244_));
  oai21  g161(.a(new_n240_), .b(x16), .c(new_n244_), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(x00), .O(new_n246_));
  nand3  g163(.a(new_n212_), .b(x46), .c(new_n107_), .O(new_n247_));
