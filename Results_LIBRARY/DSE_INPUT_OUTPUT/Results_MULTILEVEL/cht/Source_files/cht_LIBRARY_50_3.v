...
module FAU ( 
  ...
  nand2  g094(.a(new_n177_), .b(new_n93_), .O(z25));
  ...
  nand2  g106(.a(new_n98_), .b(x09), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(x39), .O(new_n191_));
  nand3  g108(.a(x40), .b(new_n98_), .c(x09), .O(new_n192_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n93_), .O(z33));
