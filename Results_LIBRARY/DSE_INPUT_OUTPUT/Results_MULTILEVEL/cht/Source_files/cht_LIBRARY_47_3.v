...
module FAU ( 
  ...
  oai21  g069(.a(x30), .b(new_n111_), .c(x29), .O(new_n153_));
  nand2  g070(.a(x30), .b(x08), .O(new_n154_));
  aoi21  g071(.a(new_n154_), .b(new_n153_), .c(x10), .O(z18));
  inv1   g072(.a(x30), .O(new_n156_));
  nor2   g073(.a(x10), .b(new_n111_), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(x00), .O(new_n158_));
  oai21  g075(.a(new_n157_), .b(new_n156_), .c(new_n158_), .O(z19));
