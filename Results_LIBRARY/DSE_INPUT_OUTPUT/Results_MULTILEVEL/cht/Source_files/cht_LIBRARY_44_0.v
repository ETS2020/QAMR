...
module FAU ( 
  ...
  oai21  g058(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(x23), .O(new_n143_));
  nand2  g060(.a(x24), .b(x08), .O(new_n144_));
  aoi21  g061(.a(new_n144_), .b(new_n143_), .c(x10), .O(z12));
  nor2   g062(.a(new_n85_), .b(x08), .O(new_n146_));
  ...
  nand3  g104(.a(new_n187_), .b(new_n87_), .c(new_n84_), .O(new_n188_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n87_), .O(z26));
  ...
  nand3  g156(.a(new_n239_), .b(new_n87_), .c(new_n84_), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(z33));
  nor2   g158(.a(x14), .b(new_n175_), .O(new_n242_));
  oai21  g159(.a(new_n242_), .b(new_n85_), .c(new_n86_), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(x45), .O(new_n244_));
  nand3  g161(.a(x46), .b(new_n101_), .c(x09), .O(new_n245_));
  aoi21  g162(.a(new_n245_), .b(new_n244_), .c(x10), .O(z34));
  nand2  g163(.a(new_n214_), .b(new_n86_), .O(new_n247_));
  aoi21  g164(.a(new_n101_), .b(x09), .c(new_n86_), .O(new_n248_));
  aoi21  g165(.a(new_n247_), .b(x00), .c(new_n248_), .O(new_n249_));
  oai21  g166(.a(new_n249_), .b(x10), .c(new_n87_), .O(z35));
endmodule
