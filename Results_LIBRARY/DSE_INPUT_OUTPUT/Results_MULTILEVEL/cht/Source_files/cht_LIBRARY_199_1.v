...
module FAU ( 
  ...
  aoi21  g039(.a(x21), .b(x08), .c(x46), .O(new_n123_));
  ...
  oai21  g052(.a(new_n134_), .b(new_n109_), .c(new_n135_), .O(new_n136_));
  ...
  nand2  g067(.a(x27), .b(new_n109_), .O(new_n151_));
  aoi21  g068(.a(x28), .b(x08), .c(x46), .O(new_n152_));
  aoi21  g069(.a(new_n152_), .b(new_n151_), .c(x10), .O(z16));
  nand2  g070(.a(x28), .b(new_n109_), .O(new_n154_));
  aoi21  g071(.a(x29), .b(x08), .c(x46), .O(new_n155_));
  ...
  aoi21  g079(.a(x30), .b(new_n109_), .c(x46), .O(new_n163_));
  ...
  aoi21  g112(.a(new_n195_), .b(new_n193_), .c(new_n165_), .O(new_n196_));
  ...
  aoi21  g121(.a(new_n204_), .b(x09), .c(x46), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n202_), .c(x10), .O(z28));
  inv1   g123(.a(new_n201_), .O(new_n207_));
  nand3  g124(.a(x41), .b(new_n194_), .c(x09), .O(new_n208_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x46), .O(new_n215_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x46), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n217_), .c(x10), .O(z31));
  nand3  g138(.a(x44), .b(new_n194_), .c(x09), .O(new_n222_));
  oai21  g139(.a(new_n207_), .b(new_n218_), .c(new_n222_), .O(new_n223_));
  ...
  nand3  g143(.a(x45), .b(new_n194_), .c(x09), .O(new_n227_));
  ...
  nand2  g147(.a(new_n201_), .b(x45), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n89_), .c(x10), .O(z34));
  nand2  g149(.a(new_n207_), .b(x00), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n89_), .c(x10), .O(z35));
endmodule
