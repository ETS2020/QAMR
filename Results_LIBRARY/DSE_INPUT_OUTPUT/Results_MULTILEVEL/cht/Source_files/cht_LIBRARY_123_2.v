...
module FAU ( 
  ...
  nand2  g061(.a(x24), .b(new_n114_), .O(new_n145_));
  ...
  nand2  g096(.a(new_n179_), .b(new_n90_), .O(z21));
  ...
  nand2  g104(.a(new_n187_), .b(new_n90_), .O(z23));
  ...
  nand2  g108(.a(new_n191_), .b(new_n90_), .O(z24));
  ...
  oai21  g122(.a(new_n205_), .b(x10), .c(new_n90_), .O(z27));
  nand2  g123(.a(new_n101_), .b(x09), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(x39), .O(new_n208_));
  nand3  g125(.a(x40), .b(new_n101_), .c(x09), .O(new_n209_));
  ...
  nand2  g133(.a(new_n207_), .b(x42), .O(new_n217_));
  nand3  g134(.a(x43), .b(new_n101_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z31));
  nand2  g136(.a(new_n207_), .b(x43), .O(new_n220_));
  nand3  g137(.a(x44), .b(new_n101_), .c(x09), .O(new_n221_));
  ...
  nand3  g141(.a(x45), .b(new_n101_), .c(x09), .O(new_n225_));
