...
module FAU ( 
  ...
  nand3  g020(.a(new_n103_), .b(x20), .c(new_n89_), .O(new_n104_));
  inv1   g021(.a(new_n104_), .O(z04));
  inv1   g022(.a(x16), .O(new_n106_));
  nand2  g023(.a(x07), .b(x03), .O(new_n107_));
  oai21  g024(.a(new_n106_), .b(x07), .c(new_n107_), .O(new_n108_));
  nand3  g025(.a(new_n108_), .b(x20), .c(new_n89_), .O(new_n109_));
  ...
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(x20), .O(new_n153_));
  ...
  nand3  g074(.a(new_n157_), .b(x20), .c(new_n89_), .O(new_n158_));
  ...
  oai21  g120(.a(new_n203_), .b(new_n201_), .c(x20), .O(new_n204_));
  ...
  nand3  g156(.a(new_n239_), .b(x20), .c(new_n89_), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(z34));
  nand2  g158(.a(new_n207_), .b(x46), .O(new_n242_));
  aoi21  g159(.a(new_n206_), .b(x00), .c(new_n86_), .O(new_n243_));
