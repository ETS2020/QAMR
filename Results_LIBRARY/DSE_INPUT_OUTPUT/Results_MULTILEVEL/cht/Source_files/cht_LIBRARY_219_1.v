...
module FAU ( 
  ...
  nand2  g032(.a(x17), .b(new_n89_), .O(new_n116_));
  ...
  oai21  g038(.a(x19), .b(x10), .c(new_n89_), .O(new_n122_));
  nand3  g039(.a(x20), .b(new_n84_), .c(x08), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n122_), .O(z08));
  nand2  g041(.a(x20), .b(new_n89_), .O(new_n125_));
  nand2  g042(.a(x21), .b(x08), .O(new_n126_));
  aoi21  g043(.a(new_n126_), .b(new_n125_), .c(x10), .O(z09));
  nand2  g044(.a(x21), .b(new_n89_), .O(new_n128_));
  ...
  oai21  g053(.a(x24), .b(x10), .c(new_n89_), .O(new_n137_));
  nand3  g054(.a(x25), .b(new_n84_), .c(x08), .O(new_n138_));
  ...
  oai21  g059(.a(x26), .b(x10), .c(new_n89_), .O(new_n143_));
  nand3  g060(.a(x27), .b(new_n84_), .c(x08), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n143_), .O(z15));
  nand2  g062(.a(x27), .b(new_n89_), .O(new_n146_));
  ...
  oai21  g068(.a(x29), .b(x10), .c(new_n89_), .O(new_n152_));
  nand3  g069(.a(x30), .b(new_n84_), .c(x08), .O(new_n153_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n90_), .O(z20));
  ...
  nand2  g087(.a(new_n170_), .b(new_n90_), .O(z22));
  ...
  nand2  g095(.a(x36), .b(new_n163_), .O(new_n179_));
  nand2  g096(.a(x37), .b(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z25));
  nand2  g098(.a(x37), .b(new_n163_), .O(new_n182_));
  ...
  nand2  g105(.a(x38), .b(new_n163_), .O(new_n189_));
  ...
  aoi21  g112(.a(new_n101_), .b(x09), .c(new_n195_), .O(new_n196_));
  nand3  g113(.a(x41), .b(new_n101_), .c(x09), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(new_n198_));
  oai21  g115(.a(new_n198_), .b(new_n196_), .c(new_n84_), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n90_), .O(z29));
  ...
  nand2  g135(.a(new_n191_), .b(x46), .O(new_n219_));
