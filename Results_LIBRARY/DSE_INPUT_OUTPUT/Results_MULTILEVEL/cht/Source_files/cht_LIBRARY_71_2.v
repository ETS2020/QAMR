...
module FAU ( 
  ...
  nand2  g049(.a(x22), .b(new_n117_), .O(new_n133_));
  ...
  oai21  g079(.a(new_n161_), .b(new_n117_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g111(.a(x38), .b(new_n175_), .c(x37), .O(new_n195_));
  ...
  nand2  g118(.a(x38), .b(new_n175_), .O(new_n202_));
  ...
  nand3  g131(.a(x42), .b(new_n99_), .c(x09), .O(new_n215_));
