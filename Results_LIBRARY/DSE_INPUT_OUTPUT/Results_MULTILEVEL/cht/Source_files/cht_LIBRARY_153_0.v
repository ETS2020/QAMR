...
module FAU ( 
  ...
  aoi21  g085(.a(x30), .b(new_n111_), .c(new_n92_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z19));
  nor2   g087(.a(x10), .b(new_n92_), .O(new_n171_));
  ...
  nand2  g094(.a(new_n171_), .b(x35), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z23));
  nand2  g096(.a(new_n171_), .b(x36), .O(new_n180_));
  ...
  nand2  g108(.a(x40), .b(new_n187_), .O(new_n192_));
  ...
  nand2  g112(.a(x41), .b(new_n187_), .O(new_n196_));
  ...
  nand2  g116(.a(x42), .b(new_n187_), .O(new_n200_));
  ...
  nand2  g135(.a(x46), .b(new_n187_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(x09), .O(new_n220_));
  and2   g137(.a(new_n220_), .b(new_n84_), .O(z34));
  nand2  g138(.a(new_n187_), .b(x00), .O(new_n222_));
  nand2  g139(.a(x46), .b(x14), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n222_), .c(x09), .O(new_n224_));
  and2   g141(.a(new_n224_), .b(new_n84_), .O(z35));
endmodule
