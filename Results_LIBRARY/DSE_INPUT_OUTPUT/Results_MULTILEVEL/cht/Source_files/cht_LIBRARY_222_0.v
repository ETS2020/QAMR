...
module FAU ( 
  ...
  nor2   g031(.a(x10), .b(new_n92_), .O(new_n115_));
  ...
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(new_n84_), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(new_n92_), .O(z27));
  ...
  aoi21  g133(.a(new_n206_), .b(x00), .c(new_n92_), .O(new_n217_));
