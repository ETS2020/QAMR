...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n93_), .O(z06));
  ...
  oai21  g074(.a(x29), .b(new_n115_), .c(x28), .O(new_n158_));
  nand2  g075(.a(x29), .b(x08), .O(new_n159_));
  aoi21  g076(.a(new_n159_), .b(new_n158_), .c(x10), .O(z17));
  oai21  g077(.a(x30), .b(new_n115_), .c(x29), .O(new_n161_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n93_), .O(z19));
  ...
  nand2  g142(.a(new_n201_), .b(x45), .O(new_n226_));
