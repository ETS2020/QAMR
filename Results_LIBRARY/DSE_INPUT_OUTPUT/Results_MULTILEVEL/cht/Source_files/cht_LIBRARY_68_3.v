...
module FAU ( 
  ...
  oai21  g044(.a(new_n126_), .b(new_n114_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g068(.a(new_n151_), .b(new_n96_), .O(z15));
  ...
  nand2  g073(.a(new_n156_), .b(new_n96_), .O(z16));
  ...
  nand2  g086(.a(new_n169_), .b(new_n89_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n96_), .O(z20));
  ...
  nand2  g099(.a(new_n182_), .b(new_n96_), .O(z23));
  ...
  oai21  g105(.a(new_n187_), .b(new_n172_), .c(new_n188_), .O(new_n189_));
  ...
  oai21  g118(.a(new_n201_), .b(x10), .c(new_n96_), .O(z27));
  ...
  nand2  g128(.a(new_n211_), .b(new_n96_), .O(z29));
