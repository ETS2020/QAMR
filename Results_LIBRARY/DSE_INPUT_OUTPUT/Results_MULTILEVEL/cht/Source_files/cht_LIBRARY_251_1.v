...
module FAU ( 
  ...
  aoi21  g033(.a(x18), .b(x08), .c(x27), .O(new_n117_));
  ...
  aoi21  g056(.a(x25), .b(x08), .c(x27), .O(new_n140_));
  ...
  and2   g074(.a(new_n157_), .b(new_n88_), .O(z18));
  ...
  aoi21  g115(.a(x38), .b(new_n169_), .c(x27), .O(new_n199_));
  ...
  oai21  g122(.a(x14), .b(new_n169_), .c(x40), .O(new_n206_));
  ...
  oai21  g127(.a(x14), .b(new_n169_), .c(x41), .O(new_n211_));
  ...
  aoi21  g151(.a(new_n234_), .b(x09), .c(x27), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n232_), .c(x10), .O(z34));
  nand2  g153(.a(new_n216_), .b(x46), .O(new_n237_));
  nor2   g154(.a(x14), .b(new_n169_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(x00), .c(x27), .O(new_n239_));
