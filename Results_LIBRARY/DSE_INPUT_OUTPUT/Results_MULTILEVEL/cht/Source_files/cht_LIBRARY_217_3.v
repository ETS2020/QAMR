...
module FAU ( 
  ...
  nand2  g076(.a(new_n159_), .b(new_n93_), .O(z21));
  ...
  nand2  g080(.a(new_n163_), .b(new_n93_), .O(z22));
  nand2  g081(.a(x34), .b(new_n152_), .O(new_n165_));
  nand2  g082(.a(x35), .b(x09), .O(new_n166_));
  aoi21  g083(.a(new_n166_), .b(new_n165_), .c(x10), .O(z23));
  inv1   g084(.a(x36), .O(new_n168_));
  nand2  g085(.a(x35), .b(new_n152_), .O(new_n169_));
  oai21  g086(.a(new_n168_), .b(new_n152_), .c(new_n169_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n88_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n93_), .O(z24));
  ...
  nand2  g093(.a(x37), .b(new_n152_), .O(new_n177_));
  ...
  aoi21  g103(.a(new_n98_), .b(x09), .c(new_n180_), .O(new_n187_));
  ...
  nand2  g112(.a(new_n192_), .b(x41), .O(new_n196_));
  ...
  nand2  g120(.a(new_n203_), .b(new_n93_), .O(z31));
  nand2  g121(.a(new_n192_), .b(x43), .O(new_n205_));
  nand3  g122(.a(x44), .b(new_n98_), .c(x09), .O(new_n206_));
  ...
  nand2  g138(.a(new_n221_), .b(new_n93_), .O(z35));
endmodule
