...
module FAU ( 
  ...
  and2   g047(.a(new_n130_), .b(new_n85_), .O(z10));
  ...
  and2   g069(.a(new_n152_), .b(new_n85_), .O(z15));
  ...
  and2   g081(.a(new_n164_), .b(new_n85_), .O(z18));
  nand2  g082(.a(x08), .b(x00), .O(new_n166_));
  aoi21  g083(.a(x30), .b(new_n119_), .c(x09), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z19));
  inv1   g085(.a(x31), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n84_), .c(x10), .O(z20));
  ...
  aoi21  g091(.a(new_n174_), .b(new_n84_), .c(x10), .O(z22));
  nand2  g092(.a(new_n171_), .b(x34), .O(new_n176_));
  inv1   g093(.a(new_n176_), .O(z23));
  inv1   g094(.a(x35), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n84_), .c(x10), .O(z24));
  inv1   g096(.a(x36), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n84_), .c(x10), .O(z25));
  inv1   g098(.a(x37), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n84_), .c(x10), .O(z26));
  inv1   g100(.a(x38), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n84_), .c(x10), .O(z27));
  nand2  g102(.a(new_n171_), .b(x39), .O(new_n186_));
  inv1   g103(.a(new_n186_), .O(z28));
  inv1   g104(.a(x40), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n84_), .c(x10), .O(z29));
  inv1   g106(.a(x41), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n84_), .c(x10), .O(z30));
  inv1   g108(.a(x42), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n84_), .c(x10), .O(z31));
  nand2  g110(.a(new_n171_), .b(x43), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z32));
  inv1   g112(.a(x44), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n84_), .c(x10), .O(z33));
  inv1   g114(.a(x45), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n84_), .c(x10), .O(z34));
