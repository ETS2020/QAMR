...
module FAU ( 
  ...
  aoi21  g041(.a(new_n124_), .b(new_n88_), .c(x10), .O(z12));
  ...
  aoi21  g049(.a(new_n132_), .b(new_n88_), .c(x10), .O(z16));
  ...
  and2   g073(.a(new_n156_), .b(new_n89_), .O(z23));
  ...
  and2   g077(.a(new_n160_), .b(new_n89_), .O(z24));
  ...
  oai21  g104(.a(x14), .b(new_n140_), .c(x41), .O(new_n188_));
  ...
  nor2   g130(.a(x14), .b(new_n140_), .O(new_n214_));
