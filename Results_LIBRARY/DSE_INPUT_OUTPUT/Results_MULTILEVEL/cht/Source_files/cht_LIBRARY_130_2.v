...
module FAU ( 
  ...
  nand3  g077(.a(new_n160_), .b(new_n98_), .c(new_n97_), .O(new_n161_));
  ...
  nand3  g082(.a(new_n165_), .b(new_n98_), .c(new_n97_), .O(new_n166_));
