...
module FAU ( 
  ...
  nand2  g025(.a(new_n108_), .b(new_n90_), .O(z04));
  ...
  nand2  g093(.a(x34), .b(new_n169_), .O(new_n177_));
  ...
  nand2  g101(.a(x36), .b(new_n169_), .O(new_n185_));
  nand2  g102(.a(x37), .b(x09), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z25));
  nand2  g104(.a(x37), .b(new_n169_), .O(new_n188_));
  ...
  nand3  g123(.a(x42), .b(new_n100_), .c(x09), .O(new_n207_));
  ...
  nand3  g140(.a(x46), .b(new_n100_), .c(x09), .O(new_n224_));
