...
module FAU ( 
  ...
  nand2  g055(.a(x24), .b(new_n116_), .O(new_n139_));
  ...
  nand3  g094(.a(x35), .b(new_n91_), .c(new_n164_), .O(new_n178_));
  ...
  nand3  g106(.a(x38), .b(new_n91_), .c(new_n164_), .O(new_n190_));
  ...
  aoi21  g111(.a(x40), .b(new_n98_), .c(x10), .O(new_n195_));
  ...
  aoi21  g121(.a(x43), .b(new_n98_), .c(x10), .O(new_n205_));
  oai22  g122(.a(new_n205_), .b(new_n164_), .c(new_n194_), .d(new_n204_), .O(z31));
  inv1   g123(.a(x43), .O(new_n207_));
  aoi21  g124(.a(x44), .b(new_n98_), .c(x10), .O(new_n208_));
  oai22  g125(.a(new_n208_), .b(new_n164_), .c(new_n194_), .d(new_n207_), .O(z32));
  ...
  aoi21  g130(.a(x46), .b(new_n98_), .c(x10), .O(new_n214_));
  oai22  g131(.a(new_n214_), .b(new_n164_), .c(new_n194_), .d(new_n213_), .O(z34));
