...
module FAU ( 
  ...
  nand2  g004(.a(x38), .b(new_n87_), .O(new_n88_));
  ...
  nor2   g090(.a(x38), .b(x09), .O(new_n174_));
  oai21  g091(.a(new_n174_), .b(x32), .c(x31), .O(new_n175_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n88_), .O(z21));
  inv1   g098(.a(x09), .O(new_n182_));
  inv1   g099(.a(x34), .O(new_n183_));
  nand2  g100(.a(x33), .b(new_n182_), .O(new_n184_));
  ...
  nand2  g109(.a(x35), .b(new_n182_), .O(new_n193_));
  ...
  nand3  g119(.a(new_n202_), .b(x38), .c(x32), .O(new_n203_));
  inv1   g120(.a(x38), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(x37), .c(new_n182_), .O(new_n205_));
  ...
  nand3  g126(.a(new_n209_), .b(new_n88_), .c(x09), .O(new_n210_));
  nand3  g127(.a(x38), .b(x32), .c(new_n182_), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z27));
  oai21  g129(.a(x14), .b(new_n182_), .c(x39), .O(new_n213_));
  ...
  oai21  g134(.a(x14), .b(new_n182_), .c(x40), .O(new_n218_));
  ...
  oai21  g145(.a(x14), .b(new_n182_), .c(x42), .O(new_n229_));
