...
module FAU ( 
  ...
  nand3  g088(.a(x33), .b(new_n91_), .c(new_n164_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n171_), .O(z22));
  oai21  g090(.a(x35), .b(x10), .c(x09), .O(new_n174_));
  nand3  g091(.a(x34), .b(new_n91_), .c(new_n164_), .O(new_n175_));
  ...
  nand3  g100(.a(x37), .b(new_n91_), .c(new_n164_), .O(new_n184_));
