...
module FAU ( 
  ...
  aoi21  g088(.a(x30), .b(new_n118_), .c(new_n102_), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n171_), .c(x10), .O(z19));
  nor2   g090(.a(x10), .b(new_n102_), .O(new_n174_));
  ...
  nand2  g117(.a(x41), .b(new_n200_), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n199_), .c(x09), .O(new_n202_));
  and2   g119(.a(new_n202_), .b(new_n84_), .O(z29));
  nand2  g120(.a(x41), .b(x14), .O(new_n204_));
  nand2  g121(.a(x42), .b(new_n200_), .O(new_n205_));
  ...
  nand2  g125(.a(x43), .b(new_n200_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(x09), .O(new_n210_));
  and2   g127(.a(new_n210_), .b(new_n84_), .O(z31));
  nand2  g128(.a(x43), .b(x14), .O(new_n212_));
  nand2  g129(.a(x44), .b(new_n200_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(x09), .O(new_n214_));
  and2   g131(.a(new_n214_), .b(new_n84_), .O(z32));
