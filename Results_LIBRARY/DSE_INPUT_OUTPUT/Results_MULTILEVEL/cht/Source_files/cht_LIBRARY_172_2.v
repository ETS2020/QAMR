...
module FAU ( 
  ...
  nor2   g071(.a(new_n85_), .b(new_n154_), .O(new_n155_));
  ...
  nand3  g154(.a(new_n154_), .b(new_n100_), .c(x09), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n85_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(x44), .O(new_n240_));
  oai21  g157(.a(x14), .b(new_n176_), .c(x43), .O(new_n241_));
