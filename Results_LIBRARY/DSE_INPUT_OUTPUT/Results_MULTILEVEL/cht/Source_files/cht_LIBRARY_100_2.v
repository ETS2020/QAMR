...
module FAU ( 
  ...
  oai21  g056(.a(new_n138_), .b(new_n112_), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g068(.a(x28), .b(new_n112_), .O(new_n152_));
  ...
  aoi21  g113(.a(new_n101_), .b(x09), .c(new_n191_), .O(new_n197_));
  ...
  aoi21  g125(.a(new_n101_), .b(x09), .c(new_n208_), .O(new_n209_));
  ...
  aoi21  g131(.a(new_n101_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  oai21  g148(.a(x14), .b(new_n164_), .c(x45), .O(new_n232_));
  nand3  g149(.a(x46), .b(new_n101_), .c(x09), .O(new_n233_));
