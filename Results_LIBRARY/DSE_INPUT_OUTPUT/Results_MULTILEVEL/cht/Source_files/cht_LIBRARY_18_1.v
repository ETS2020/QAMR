...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n85_), .c(x38), .O(new_n104_));
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  aoi21  g023(.a(x16), .b(new_n85_), .c(x38), .O(new_n107_));
  ...
  aoi21  g046(.a(x23), .b(x08), .c(x38), .O(new_n130_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n92_), .c(new_n91_), .O(new_n169_));
  ...
  nand3  g122(.a(x42), .b(new_n98_), .c(x09), .O(new_n206_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x38), .O(new_n218_));
  ...
  aoi21  g139(.a(new_n222_), .b(x09), .c(x38), .O(new_n223_));
  ...
  nand2  g146(.a(new_n194_), .b(x46), .O(new_n230_));
  nor2   g147(.a(x14), .b(new_n161_), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(x00), .c(x38), .O(new_n232_));
