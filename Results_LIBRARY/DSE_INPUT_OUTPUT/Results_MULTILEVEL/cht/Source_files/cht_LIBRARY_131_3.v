...
module FAU ( 
  ...
  nand2  g001(.a(x39), .b(x38), .O(new_n85_));
  ...
  nand2  g098(.a(new_n181_), .b(new_n85_), .O(z20));
  ...
  nand2  g154(.a(new_n237_), .b(new_n85_), .O(z31));
