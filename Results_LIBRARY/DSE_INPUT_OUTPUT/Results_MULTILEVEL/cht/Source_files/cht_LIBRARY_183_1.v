...
module FAU ( 
  ...
  aoi21  g024(.a(x15), .b(new_n107_), .c(x26), .O(new_n108_));
  ...
  aoi21  g033(.a(x18), .b(x08), .c(x26), .O(new_n117_));
  ...
  aoi21  g057(.a(x24), .b(x08), .c(x26), .O(new_n141_));
  ...
  nand4  g064(.a(new_n85_), .b(x25), .c(new_n84_), .d(new_n115_), .O(new_n148_));
  inv1   g065(.a(new_n148_), .O(z14));
  nand2  g066(.a(x27), .b(x08), .O(new_n150_));
  aoi21  g067(.a(new_n150_), .b(new_n85_), .c(x10), .O(z15));
  ...
  aoi21  g123(.a(x38), .b(new_n175_), .c(x26), .O(new_n207_));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x26), .O(new_n213_));
  ...
  nand3  g137(.a(x42), .b(new_n101_), .c(x09), .O(new_n221_));
  ...
  nand3  g142(.a(x43), .b(new_n101_), .c(x09), .O(new_n226_));
  ...
  nand3  g147(.a(x44), .b(new_n101_), .c(x09), .O(new_n231_));
  ...
  aoi21  g163(.a(new_n246_), .b(x00), .c(x26), .O(new_n247_));
