...
module FAU ( 
  ...
  nand2  g084(.a(new_n167_), .b(new_n90_), .O(z17));
  ...
  nand2  g089(.a(new_n172_), .b(new_n90_), .O(z18));
  ...
  nand2  g105(.a(x35), .b(new_n89_), .O(new_n189_));
  ...
  nand2  g118(.a(x38), .b(new_n89_), .O(new_n202_));
