...
module FAU ( 
  ...
  nand3  g058(.a(new_n141_), .b(new_n89_), .c(new_n91_), .O(new_n142_));
  ...
  nor2   g094(.a(new_n177_), .b(x08), .O(new_n178_));
  aoi21  g095(.a(x08), .b(x00), .c(new_n178_), .O(new_n179_));
  oai21  g096(.a(new_n179_), .b(x10), .c(new_n89_), .O(z19));
  ...
  nand2  g102(.a(new_n185_), .b(new_n89_), .O(z20));
  ...
  nand2  g106(.a(new_n189_), .b(new_n89_), .O(z21));
  ...
  nand2  g116(.a(x35), .b(new_n181_), .O(new_n200_));
  oai21  g117(.a(new_n87_), .b(new_n181_), .c(new_n200_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n91_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n89_), .O(z24));
  oai21  g120(.a(x37), .b(new_n181_), .c(x36), .O(new_n204_));
  nand3  g121(.a(x45), .b(x37), .c(x09), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z25));
  inv1   g123(.a(x38), .O(new_n207_));
  nand2  g124(.a(x37), .b(new_n181_), .O(new_n208_));
  oai21  g125(.a(new_n207_), .b(new_n181_), .c(new_n208_), .O(new_n209_));
  ...
  oai21  g134(.a(x14), .b(new_n181_), .c(x39), .O(new_n218_));
  ...
  oai21  g139(.a(x14), .b(new_n181_), .c(x40), .O(new_n223_));
  ...
  oai21  g144(.a(x14), .b(new_n181_), .c(x41), .O(new_n228_));
  ...
  oai21  g149(.a(x14), .b(new_n181_), .c(x42), .O(new_n233_));
  ...
  oai21  g154(.a(x14), .b(new_n181_), .c(x43), .O(new_n238_));
