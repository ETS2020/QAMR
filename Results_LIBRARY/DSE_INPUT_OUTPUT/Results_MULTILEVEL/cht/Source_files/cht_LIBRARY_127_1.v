...
module FAU ( 
  ...
  nand2  g025(.a(new_n108_), .b(new_n94_), .O(z05));
  ...
  nand2  g053(.a(new_n136_), .b(new_n94_), .O(z12));
  ...
  nand2  g064(.a(new_n147_), .b(new_n94_), .O(z15));
  ...
  nand2  g075(.a(new_n158_), .b(new_n94_), .O(z18));
  ...
  nand3  g105(.a(new_n188_), .b(new_n88_), .c(x09), .O(new_n189_));
  oai21  g106(.a(x38), .b(x10), .c(new_n93_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n189_), .O(z27));
  oai21  g108(.a(x39), .b(x10), .c(new_n93_), .O(new_n192_));
  ...
  oai21  g115(.a(x40), .b(x10), .c(new_n93_), .O(new_n199_));
  ...
  oai21  g125(.a(x42), .b(x10), .c(new_n93_), .O(new_n209_));
  ...
  oai21  g131(.a(x43), .b(x10), .c(new_n93_), .O(new_n215_));
  ...
  nand2  g136(.a(new_n219_), .b(new_n215_), .O(z32));
  oai21  g137(.a(x44), .b(x10), .c(new_n93_), .O(new_n221_));
  nand2  g138(.a(x44), .b(x14), .O(new_n222_));
  nand3  g139(.a(x45), .b(new_n194_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n88_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n221_), .O(z33));
  nand2  g143(.a(new_n205_), .b(x45), .O(new_n227_));
  nand3  g144(.a(x46), .b(new_n194_), .c(x09), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z34));
  nand2  g146(.a(new_n205_), .b(x46), .O(new_n230_));
  nand3  g147(.a(new_n194_), .b(x09), .c(x00), .O(new_n231_));
