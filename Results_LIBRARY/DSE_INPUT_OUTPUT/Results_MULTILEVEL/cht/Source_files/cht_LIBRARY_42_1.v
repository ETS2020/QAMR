...
module FAU ( 
  ...
  aoi21  g029(.a(x18), .b(x08), .c(x33), .O(new_n113_));
  ...
  oai21  g050(.a(new_n132_), .b(new_n111_), .c(new_n133_), .O(new_n134_));
  ...
  nand4  g087(.a(new_n85_), .b(x32), .c(new_n84_), .d(new_n170_), .O(new_n171_));
  inv1   g088(.a(new_n171_), .O(z21));
  nand2  g089(.a(x34), .b(x09), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n85_), .c(x10), .O(z22));
  nand2  g091(.a(x34), .b(new_n170_), .O(new_n175_));
  ...
  nand2  g096(.a(x35), .b(new_n170_), .O(new_n180_));
  oai21  g097(.a(new_n179_), .b(new_n170_), .c(new_n180_), .O(new_n181_));
  ...
  aoi21  g113(.a(x38), .b(new_n170_), .c(x33), .O(new_n197_));
  ...
  aoi21  g130(.a(new_n213_), .b(x09), .c(x33), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n211_), .c(x10), .O(z30));
  oai21  g132(.a(x14), .b(new_n170_), .c(x42), .O(new_n216_));
  ...
  aoi21  g140(.a(new_n223_), .b(x09), .c(x33), .O(new_n224_));
  ...
  aoi21  g145(.a(new_n228_), .b(x09), .c(x33), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n226_), .c(x10), .O(z33));
  oai21  g147(.a(x14), .b(new_n170_), .c(x45), .O(new_n231_));
  ...
  oai21  g152(.a(x14), .b(new_n170_), .c(x46), .O(new_n236_));
