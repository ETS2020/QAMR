...
module FAU ( 
  ...
  oai21  g123(.a(new_n85_), .b(x09), .c(new_n206_), .O(new_n207_));
  ...
  nand3  g152(.a(x43), .b(new_n100_), .c(x09), .O(new_n236_));
  ...
  nand2  g156(.a(x43), .b(x37), .O(new_n240_));
  ...
  nand2  g161(.a(new_n100_), .b(x09), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(x43), .c(x37), .O(new_n246_));
  aoi21  g163(.a(new_n246_), .b(new_n244_), .c(x10), .O(z32));
  oai21  g164(.a(x14), .b(new_n178_), .c(x44), .O(new_n248_));
  nand3  g165(.a(x45), .b(new_n100_), .c(x09), .O(new_n249_));
  ...
  nand3  g171(.a(x46), .b(new_n100_), .c(x09), .O(new_n255_));
  ...
  aoi21  g176(.a(new_n100_), .b(x09), .c(new_n259_), .O(new_n260_));
  nand3  g177(.a(new_n100_), .b(x09), .c(x00), .O(new_n261_));
