...
module FAU ( 
  ...
  nand2  g003(.a(x34), .b(x12), .O(new_n87_));
  ...
  nand3  g034(.a(new_n117_), .b(new_n87_), .c(new_n93_), .O(new_n118_));
  ...
  nand3  g039(.a(new_n122_), .b(new_n87_), .c(new_n93_), .O(new_n123_));
  ...
  nand3  g067(.a(new_n150_), .b(new_n87_), .c(new_n93_), .O(new_n151_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n87_), .c(new_n93_), .O(new_n169_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n87_), .c(new_n93_), .O(new_n174_));
  ...
  nand2  g096(.a(new_n179_), .b(new_n93_), .O(new_n180_));
  ...
  nand3  g109(.a(new_n192_), .b(x34), .c(new_n89_), .O(new_n193_));
  nand3  g110(.a(x35), .b(new_n186_), .c(x09), .O(new_n194_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n87_), .c(new_n93_), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z24));
  inv1   g116(.a(x37), .O(new_n200_));
  nand2  g117(.a(x36), .b(new_n176_), .O(new_n201_));
  oai21  g118(.a(new_n200_), .b(new_n176_), .c(new_n201_), .O(new_n202_));
  ...
  nand3  g123(.a(new_n206_), .b(new_n87_), .c(new_n93_), .O(new_n207_));
  ...
  oai21  g130(.a(new_n213_), .b(new_n211_), .c(new_n87_), .O(new_n214_));
  ...
  nand3  g140(.a(new_n223_), .b(new_n87_), .c(new_n93_), .O(new_n224_));
  ...
  nand3  g145(.a(new_n228_), .b(new_n87_), .c(new_n93_), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(z30));
  nand2  g147(.a(new_n216_), .b(x42), .O(new_n231_));
  nand3  g148(.a(x43), .b(new_n99_), .c(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n87_), .c(new_n93_), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(z31));
  nand2  g152(.a(new_n216_), .b(x43), .O(new_n236_));
  nand3  g153(.a(x44), .b(new_n99_), .c(x09), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(new_n87_), .c(new_n93_), .O(new_n239_));
  ...
  nand3  g160(.a(new_n243_), .b(new_n87_), .c(new_n93_), .O(new_n244_));
