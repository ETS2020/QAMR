...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n96_), .O(z07));
  ...
  nand2  g051(.a(new_n134_), .b(new_n96_), .O(z11));
  ...
  nand2  g059(.a(new_n142_), .b(new_n96_), .O(z13));
  nand2  g060(.a(x25), .b(new_n121_), .O(new_n144_));
  ...
  nand2  g066(.a(x27), .b(new_n121_), .O(new_n150_));
  ...
  nand2  g073(.a(new_n156_), .b(new_n96_), .O(z17));
  nand2  g074(.a(x29), .b(new_n121_), .O(new_n158_));
  ...
  nand2  g081(.a(new_n164_), .b(new_n96_), .O(z19));
  ...
  nand3  g102(.a(x37), .b(new_n91_), .c(new_n166_), .O(new_n186_));
  ...
  aoi21  g129(.a(x45), .b(new_n98_), .c(x10), .O(new_n213_));
  oai22  g130(.a(new_n213_), .b(new_n166_), .c(new_n212_), .d(new_n210_), .O(z33));
  inv1   g131(.a(x45), .O(new_n215_));
  aoi21  g132(.a(x46), .b(new_n98_), .c(x10), .O(new_n216_));
  oai22  g133(.a(new_n216_), .b(new_n166_), .c(new_n212_), .d(new_n215_), .O(z34));
