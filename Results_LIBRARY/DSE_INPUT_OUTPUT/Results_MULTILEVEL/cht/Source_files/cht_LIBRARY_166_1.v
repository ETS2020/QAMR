...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n85_), .c(x30), .O(new_n96_));
  ...
  aoi21  g064(.a(x28), .b(x08), .c(x30), .O(new_n148_));
  ...
  nand4  g071(.a(new_n89_), .b(x29), .c(new_n88_), .d(new_n107_), .O(new_n155_));
  ...
  and2   g084(.a(new_n167_), .b(new_n88_), .O(z21));
  ...
  and2   g088(.a(new_n171_), .b(new_n88_), .O(z22));
  ...
  aoi21  g111(.a(x38), .b(new_n164_), .c(x30), .O(new_n195_));
  ...
  aoi21  g123(.a(new_n206_), .b(x09), .c(x30), .O(new_n207_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x30), .O(new_n212_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x30), .O(new_n217_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x30), .O(new_n227_));
  ...
  aoi21  g152(.a(new_n235_), .b(x00), .c(x30), .O(new_n236_));
