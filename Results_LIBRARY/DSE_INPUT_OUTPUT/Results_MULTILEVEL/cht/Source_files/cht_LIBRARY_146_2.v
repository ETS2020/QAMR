...
module FAU ( 
  ...
  oai21  g028(.a(new_n89_), .b(x07), .c(new_n111_), .O(new_n112_));
  nand2  g029(.a(new_n112_), .b(new_n84_), .O(new_n113_));
  nand2  g030(.a(new_n113_), .b(new_n90_), .O(z05));
  ...
  nand2  g120(.a(x38), .b(new_n168_), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z27));
  aoi21  g122(.a(new_n101_), .b(x09), .c(new_n200_), .O(new_n206_));
  ...
  nand2  g127(.a(new_n101_), .b(x09), .O(new_n211_));
  ...
  nand2  g146(.a(new_n211_), .b(x45), .O(new_n230_));
