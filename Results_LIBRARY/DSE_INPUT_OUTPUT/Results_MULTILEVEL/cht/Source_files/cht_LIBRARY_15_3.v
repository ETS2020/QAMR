...
module FAU ( 
  ...
  nand3  g042(.a(x22), .b(new_n84_), .c(new_n110_), .O(new_n126_));
  ...
  nand3  g054(.a(x26), .b(new_n84_), .c(new_n110_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n137_), .O(z15));
  oai21  g056(.a(x28), .b(x10), .c(x08), .O(new_n140_));
  nand3  g057(.a(x27), .b(new_n84_), .c(new_n110_), .O(new_n141_));
  ...
  nand3  g066(.a(x30), .b(new_n84_), .c(new_n110_), .O(new_n150_));
  ...
  nand2  g082(.a(new_n165_), .b(new_n89_), .O(z22));
  ...
  nand2  g105(.a(x38), .b(new_n152_), .O(new_n189_));
  ...
  aoi21  g122(.a(new_n191_), .b(x09), .c(new_n205_), .O(new_n206_));
  nand3  g123(.a(x43), .b(new_n191_), .c(x09), .O(new_n207_));
  ...
  nand2  g142(.a(new_n192_), .b(x46), .O(new_n226_));
  nand3  g143(.a(new_n191_), .b(x09), .c(x00), .O(new_n227_));
