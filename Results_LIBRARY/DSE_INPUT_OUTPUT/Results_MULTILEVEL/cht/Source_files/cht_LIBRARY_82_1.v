...
module FAU ( 
  ...
  aoi21  g042(.a(x20), .b(x08), .c(x30), .O(new_n126_));
  ...
  aoi21  g063(.a(x25), .b(x08), .c(x30), .O(new_n147_));
  ...
  nand2  g083(.a(x29), .b(new_n115_), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n85_), .c(x10), .O(z18));
  nand2  g085(.a(x08), .b(x00), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n85_), .c(x10), .O(z19));
  ...
  aoi21  g122(.a(x38), .b(new_n171_), .c(x30), .O(new_n206_));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(x30), .O(new_n238_));
  ...
  aoi21  g163(.a(new_n246_), .b(x00), .c(x30), .O(new_n247_));
