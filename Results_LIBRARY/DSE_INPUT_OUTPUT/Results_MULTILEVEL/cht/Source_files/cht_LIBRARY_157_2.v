...
module FAU ( 
  ...
  nand2  g032(.a(x19), .b(new_n108_), .O(new_n116_));
  oai21  g033(.a(new_n115_), .b(new_n108_), .c(new_n116_), .O(new_n117_));
  nand2  g034(.a(new_n117_), .b(new_n94_), .O(new_n118_));
  nand2  g035(.a(new_n118_), .b(new_n100_), .O(z08));
  nand2  g036(.a(x21), .b(x08), .O(new_n120_));
  oai21  g037(.a(new_n115_), .b(x08), .c(new_n120_), .O(new_n121_));
  nand2  g038(.a(new_n121_), .b(new_n94_), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(new_n100_), .O(z09));
  nand2  g040(.a(x21), .b(new_n108_), .O(new_n124_));
  ...
  nand2  g050(.a(new_n133_), .b(new_n100_), .O(z12));
  ...
  nand2  g059(.a(x26), .b(new_n108_), .O(new_n143_));
  ...
  nand2  g067(.a(x28), .b(new_n108_), .O(new_n151_));
  nand2  g068(.a(x29), .b(x08), .O(new_n152_));
  aoi21  g069(.a(new_n152_), .b(new_n151_), .c(x10), .O(z17));
  nand2  g070(.a(x29), .b(new_n108_), .O(new_n154_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n100_), .O(z19));
  ...
  nand2  g086(.a(new_n169_), .b(new_n100_), .O(z21));
  nand2  g087(.a(x33), .b(new_n162_), .O(new_n171_));
  ...
  oai21  g092(.a(new_n174_), .b(new_n162_), .c(new_n175_), .O(new_n176_));
  ...
  nand2  g111(.a(x38), .b(new_n162_), .O(new_n195_));
  ...
  nor2   g118(.a(x14), .b(new_n162_), .O(new_n202_));
  oai21  g119(.a(new_n202_), .b(x40), .c(x41), .O(new_n203_));
  nand2  g120(.a(new_n95_), .b(x09), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(x40), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n203_), .c(x10), .O(z29));
  aoi21  g123(.a(new_n95_), .b(x09), .c(new_n99_), .O(new_n207_));
  ...
  nand2  g128(.a(new_n204_), .b(x42), .O(new_n212_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n100_), .O(z34));
