...
module FAU ( 
  ...
  nand2  g043(.a(new_n126_), .b(new_n99_), .O(z11));
  ...
  nand2  g061(.a(new_n144_), .b(new_n99_), .O(z16));
  ...
  nand2  g066(.a(new_n149_), .b(new_n99_), .O(z17));
  ...
  nand2  g070(.a(new_n153_), .b(new_n99_), .O(z18));
  ...
  nand2  g075(.a(new_n158_), .b(new_n99_), .O(z19));
  ...
  oai21  g111(.a(new_n194_), .b(x10), .c(new_n99_), .O(z27));
  aoi21  g112(.a(new_n95_), .b(x09), .c(new_n189_), .O(new_n196_));
  ...
  nand2  g135(.a(new_n95_), .b(x09), .O(new_n219_));
  ...
  nand2  g145(.a(new_n219_), .b(x46), .O(new_n229_));
