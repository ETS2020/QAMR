...
module FAU ( 
  ...
  nand3  g018(.a(new_n101_), .b(x34), .c(new_n98_), .O(new_n102_));
  ...
  nand3  g076(.a(new_n159_), .b(x34), .c(new_n98_), .O(new_n160_));
  ...
  nand3  g081(.a(new_n164_), .b(x34), .c(new_n98_), .O(new_n165_));
  ...
  oai21  g087(.a(x33), .b(x09), .c(x34), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(x10), .O(z22));
  oai21  g089(.a(x35), .b(new_n167_), .c(x34), .O(new_n173_));
  nor2   g090(.a(new_n173_), .b(x10), .O(z23));
  nand2  g091(.a(x35), .b(new_n167_), .O(new_n175_));
  nand2  g092(.a(x36), .b(x09), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n175_), .c(x34), .O(new_n177_));
  and2   g094(.a(new_n177_), .b(new_n98_), .O(z24));
  ...
  aoi21  g108(.a(x38), .b(new_n167_), .c(new_n86_), .O(new_n192_));
  ...
  nand3  g130(.a(new_n213_), .b(x34), .c(new_n98_), .O(new_n214_));
  ...
  nand3  g135(.a(new_n218_), .b(x34), .c(new_n98_), .O(new_n219_));
  ...
  nand3  g140(.a(new_n223_), .b(x34), .c(new_n98_), .O(new_n224_));
  ...
  nand3  g145(.a(new_n228_), .b(x34), .c(new_n98_), .O(new_n229_));
