...
module FAU ( 
  ...
  oai21  g128(.a(new_n87_), .b(x14), .c(new_n211_), .O(new_n212_));
  nor2   g129(.a(new_n206_), .b(x09), .O(new_n213_));
  aoi21  g130(.a(new_n212_), .b(x09), .c(new_n213_), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(x10), .c(new_n88_), .O(z27));
  oai21  g132(.a(x14), .b(new_n178_), .c(new_n87_), .O(new_n216_));
  aoi21  g133(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n217_));
  aoi21  g134(.a(new_n216_), .b(x40), .c(new_n217_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(x10), .c(new_n88_), .O(z28));
  oai21  g136(.a(x14), .b(new_n178_), .c(x40), .O(new_n220_));
  ...
  oai21  g141(.a(x14), .b(new_n178_), .c(x41), .O(new_n225_));
  ...
  oai21  g158(.a(x14), .b(new_n178_), .c(x44), .O(new_n242_));
  ...
  aoi21  g164(.a(new_n101_), .b(x09), .c(new_n247_), .O(new_n248_));
