...
module FAU ( 
  ...
  oai21  g043(.a(x22), .b(x10), .c(new_n89_), .O(new_n127_));
  nand3  g044(.a(x23), .b(new_n84_), .c(x08), .O(new_n128_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n90_), .O(z23));
  ...
  oai21  g101(.a(new_n184_), .b(x10), .c(new_n90_), .O(z27));
  ...
  oai21  g106(.a(new_n189_), .b(new_n187_), .c(new_n84_), .O(new_n190_));
  ...
  aoi21  g121(.a(new_n186_), .b(x09), .c(new_n204_), .O(new_n205_));
  ...
  nand2  g125(.a(new_n208_), .b(new_n90_), .O(z31));
  inv1   g126(.a(x43), .O(new_n210_));
  aoi21  g127(.a(new_n186_), .b(x09), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(x44), .b(new_n186_), .c(x09), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(new_n213_));
  oai21  g130(.a(new_n213_), .b(new_n211_), .c(new_n84_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n90_), .O(z32));
  nand2  g132(.a(new_n186_), .b(x09), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(x44), .O(new_n217_));
  nand3  g134(.a(x45), .b(new_n186_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z33));
  nand2  g136(.a(new_n216_), .b(x45), .O(new_n220_));
  nand3  g137(.a(x46), .b(new_n186_), .c(x09), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z34));
  inv1   g139(.a(x46), .O(new_n223_));
  aoi21  g140(.a(new_n186_), .b(x09), .c(new_n223_), .O(new_n224_));
