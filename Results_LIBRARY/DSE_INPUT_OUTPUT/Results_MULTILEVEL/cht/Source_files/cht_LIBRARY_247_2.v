...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n93_), .O(z08));
  ...
  nand2  g040(.a(new_n123_), .b(new_n93_), .O(z09));
  nand2  g041(.a(x21), .b(new_n112_), .O(new_n125_));
  ...
  nand2  g048(.a(x23), .b(new_n112_), .O(new_n132_));
  ...
  nand2  g061(.a(x26), .b(new_n112_), .O(new_n145_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n93_), .O(z28));
  ...
  nand2  g145(.a(new_n228_), .b(new_n93_), .O(z35));
endmodule
