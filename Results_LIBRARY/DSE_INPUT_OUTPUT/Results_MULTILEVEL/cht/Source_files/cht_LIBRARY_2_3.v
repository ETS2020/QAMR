...
module FAU ( 
  ...
  nand2  g003(.a(x45), .b(x36), .O(new_n87_));
  ...
  nand3  g018(.a(new_n101_), .b(new_n87_), .c(new_n89_), .O(new_n102_));
  ...
  nand3  g056(.a(new_n139_), .b(new_n87_), .c(new_n89_), .O(new_n140_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n87_), .c(new_n89_), .O(new_n149_));
  ...
  nand3  g089(.a(new_n172_), .b(new_n87_), .c(new_n89_), .O(new_n173_));
  ...
  nand3  g119(.a(new_n87_), .b(x37), .c(x09), .O(new_n203_));
  inv1   g120(.a(x45), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(x36), .c(new_n179_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n203_), .c(x10), .O(z25));
  nand3  g123(.a(new_n87_), .b(x38), .c(x09), .O(new_n207_));
  nand2  g124(.a(x45), .b(x36), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(x37), .c(new_n179_), .O(new_n209_));
  ...
  nand3  g147(.a(new_n230_), .b(new_n87_), .c(new_n89_), .O(new_n231_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n87_), .c(new_n89_), .O(new_n236_));
  ...
  nand2  g165(.a(x45), .b(new_n198_), .O(new_n249_));
  nand3  g166(.a(new_n204_), .b(new_n99_), .c(x09), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(x46), .O(new_n252_));
  nand2  g169(.a(new_n99_), .b(x09), .O(new_n253_));
  nand3  g170(.a(new_n253_), .b(x45), .c(new_n198_), .O(new_n254_));
  aoi21  g171(.a(new_n254_), .b(new_n252_), .c(x10), .O(z34));
  oai21  g172(.a(x14), .b(new_n179_), .c(x46), .O(new_n256_));
