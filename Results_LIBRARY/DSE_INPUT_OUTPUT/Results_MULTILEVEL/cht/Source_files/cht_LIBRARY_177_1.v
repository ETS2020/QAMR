...
module FAU ( 
  ...
  nand2  g096(.a(x32), .b(new_n93_), .O(new_n180_));
  ...
  nand2  g102(.a(x34), .b(new_n93_), .O(new_n186_));
  nand2  g103(.a(x35), .b(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z23));
  oai21  g105(.a(x35), .b(x10), .c(new_n93_), .O(new_n189_));
  nand3  g106(.a(x36), .b(new_n88_), .c(x09), .O(new_n190_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n88_), .c(x09), .O(new_n201_));
  oai21  g118(.a(x38), .b(x10), .c(new_n93_), .O(new_n202_));
  ...
  oai21  g136(.a(x42), .b(x10), .c(new_n93_), .O(new_n220_));
  nand2  g137(.a(x42), .b(x14), .O(new_n221_));
  ...
  nand2  g141(.a(new_n224_), .b(new_n220_), .O(z31));
  nand2  g142(.a(new_n204_), .b(x43), .O(new_n226_));
  nand3  g143(.a(x44), .b(new_n101_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z32));
  oai21  g145(.a(x44), .b(x10), .c(new_n93_), .O(new_n229_));
  ...
  nand2  g157(.a(new_n204_), .b(x46), .O(new_n241_));
  nand3  g158(.a(new_n101_), .b(x09), .c(x00), .O(new_n242_));
