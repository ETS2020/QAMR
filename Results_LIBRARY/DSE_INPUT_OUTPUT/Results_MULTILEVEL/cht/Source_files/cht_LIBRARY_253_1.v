...
module FAU ( 
  ...
  nand2  g074(.a(new_n157_), .b(new_n94_), .O(z17));
  ...
  oai21  g083(.a(x31), .b(x10), .c(new_n93_), .O(new_n167_));
  nand3  g084(.a(x32), .b(new_n88_), .c(x09), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n167_), .O(z20));
  nand2  g086(.a(x32), .b(new_n93_), .O(new_n170_));
  ...
  oai21  g092(.a(x34), .b(x10), .c(new_n93_), .O(new_n176_));
  nand3  g093(.a(x35), .b(new_n88_), .c(x09), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n176_), .O(z23));
  nand2  g095(.a(x35), .b(new_n93_), .O(new_n179_));
  nand2  g096(.a(x36), .b(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z24));
  oai21  g098(.a(x36), .b(x10), .c(new_n93_), .O(new_n182_));
  nand3  g099(.a(x37), .b(new_n88_), .c(x09), .O(new_n183_));
  ...
  oai21  g117(.a(x40), .b(x10), .c(new_n93_), .O(new_n201_));
  ...
  oai21  g123(.a(x41), .b(x10), .c(new_n93_), .O(new_n207_));
  ...
  nand2  g129(.a(new_n196_), .b(x09), .O(new_n213_));
  ...
  oai21  g136(.a(x44), .b(x10), .c(new_n93_), .O(new_n220_));
  nand2  g137(.a(x44), .b(x14), .O(new_n221_));
  nand3  g138(.a(x45), .b(new_n196_), .c(x09), .O(new_n222_));
  ...
  nand2  g142(.a(new_n213_), .b(x45), .O(new_n226_));
  nand3  g143(.a(x46), .b(new_n196_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z34));
  nand2  g145(.a(new_n213_), .b(x46), .O(new_n229_));
  nand3  g146(.a(new_n196_), .b(x09), .c(x00), .O(new_n230_));
