...
module FAU ( 
  ...
  aoi21  g027(.a(x18), .b(x08), .c(x30), .O(new_n111_));
  ...
  aoi21  g036(.a(x21), .b(x08), .c(x30), .O(new_n120_));
  ...
  aoi21  g044(.a(x23), .b(x08), .c(x30), .O(new_n128_));
  ...
  aoi21  g069(.a(new_n152_), .b(new_n92_), .c(x10), .O(z18));
  nand4  g070(.a(new_n92_), .b(new_n91_), .c(x08), .d(x00), .O(new_n154_));
  ...
  nand3  g080(.a(new_n163_), .b(new_n162_), .c(new_n92_), .O(new_n164_));
  and2   g081(.a(new_n164_), .b(new_n91_), .O(z21));
  ...
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n92_), .O(new_n173_));
  and2   g090(.a(new_n173_), .b(new_n91_), .O(z23));
  ...
  and2   g094(.a(new_n177_), .b(new_n91_), .O(z24));
  ...
  and2   g103(.a(new_n186_), .b(new_n91_), .O(z26));
  ...
  aoi21  g108(.a(x38), .b(new_n161_), .c(x30), .O(new_n192_));
  ...
  aoi21  g139(.a(new_n222_), .b(x09), .c(x30), .O(new_n223_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n92_), .c(new_n91_), .O(new_n228_));
