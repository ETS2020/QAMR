...
module FAU ( 
  ...
  nand2  g071(.a(x26), .b(new_n115_), .O(new_n155_));
  ...
  nand2  g084(.a(x29), .b(new_n115_), .O(new_n168_));
  ...
  aoi21  g090(.a(x30), .b(new_n115_), .c(new_n173_), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n172_), .c(x10), .O(z19));
  nor2   g092(.a(x10), .b(new_n173_), .O(new_n176_));
  ...
  nand2  g113(.a(x40), .b(new_n100_), .O(new_n197_));
  ...
  nand2  g127(.a(x43), .b(new_n100_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(x09), .O(new_n212_));
  and2   g129(.a(new_n212_), .b(new_n84_), .O(z31));
