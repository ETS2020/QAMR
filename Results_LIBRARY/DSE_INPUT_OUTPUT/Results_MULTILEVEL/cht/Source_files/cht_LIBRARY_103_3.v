...
module FAU ( 
  ...
  nand2  g003(.a(x37), .b(x28), .O(new_n87_));
  ...
  nand3  g034(.a(new_n117_), .b(new_n87_), .c(new_n89_), .O(new_n118_));
  ...
  nor2   g077(.a(x28), .b(x08), .O(new_n161_));
  inv1   g078(.a(x28), .O(new_n162_));
  nor2   g079(.a(x37), .b(new_n162_), .O(new_n163_));
  oai21  g080(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand2  g081(.a(new_n163_), .b(x08), .O(new_n165_));
  aoi21  g082(.a(new_n165_), .b(new_n164_), .c(x10), .O(z16));
  nor2   g083(.a(new_n162_), .b(x08), .O(new_n167_));
  ...
  nand2  g120(.a(x37), .b(x28), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(x36), .c(new_n180_), .O(new_n205_));
  inv1   g122(.a(x37), .O(new_n206_));
  nor2   g123(.a(new_n206_), .b(x28), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n205_), .c(x10), .O(z25));
  nand3  g126(.a(new_n204_), .b(x38), .c(x09), .O(new_n210_));
  nand2  g127(.a(new_n207_), .b(new_n180_), .O(new_n211_));
  ...
  nor2   g137(.a(x14), .b(new_n180_), .O(new_n221_));
  ...
  nand2  g150(.a(new_n233_), .b(new_n89_), .O(new_n234_));
