...
module FAU ( 
  ...
  nand2  g019(.a(x15), .b(new_n91_), .O(new_n103_));
  nand3  g020(.a(new_n103_), .b(new_n102_), .c(new_n84_), .O(new_n104_));
  and2   g021(.a(new_n104_), .b(new_n85_), .O(z04));
  ...
  and2   g040(.a(new_n123_), .b(new_n85_), .O(z08));
  ...
  and2   g049(.a(new_n132_), .b(new_n85_), .O(z10));
  ...
  and2   g075(.a(new_n158_), .b(new_n85_), .O(z16));
  ...
  and2   g084(.a(new_n167_), .b(new_n85_), .O(z18));
  ...
  and2   g088(.a(new_n171_), .b(new_n85_), .O(z19));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x05), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n212_), .c(x10), .O(z28));
  oai21  g133(.a(x14), .b(new_n173_), .c(x40), .O(new_n217_));
  ...
  oai21  g138(.a(x14), .b(new_n173_), .c(x41), .O(new_n222_));
  ...
  aoi21  g146(.a(new_n229_), .b(x09), .c(x05), .O(new_n230_));
  ...
  aoi21  g151(.a(new_n234_), .b(x09), .c(x05), .O(new_n235_));
  ...
  aoi21  g161(.a(new_n244_), .b(x09), .c(x05), .O(new_n245_));
  aoi21  g162(.a(new_n245_), .b(new_n242_), .c(x10), .O(z34));
  oai21  g163(.a(x14), .b(new_n173_), .c(x46), .O(new_n247_));
