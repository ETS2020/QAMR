...
module FAU ( 
  ...
  aoi21  g027(.a(x16), .b(new_n92_), .c(x09), .O(new_n111_));
  ...
  nand2  g054(.a(x22), .b(new_n118_), .O(new_n138_));
  ...
  nand2  g072(.a(x26), .b(new_n118_), .O(new_n156_));
  ...
  aoi21  g099(.a(new_n182_), .b(new_n84_), .c(x10), .O(z22));
  ...
  nand2  g106(.a(new_n177_), .b(x37), .O(new_n190_));
  ...
  nand2  g114(.a(new_n177_), .b(x41), .O(new_n198_));
