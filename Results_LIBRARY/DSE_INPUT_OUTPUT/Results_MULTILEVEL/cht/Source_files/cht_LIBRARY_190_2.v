...
module FAU ( 
  ...
  aoi21  g031(.a(new_n114_), .b(new_n84_), .c(x10), .O(z09));
  inv1   g032(.a(x21), .O(new_n116_));
  aoi21  g033(.a(new_n116_), .b(new_n84_), .c(x10), .O(z10));
  ...
  aoi21  g039(.a(new_n122_), .b(new_n84_), .c(x10), .O(z13));
  ...
  nand2  g044(.a(new_n111_), .b(x27), .O(new_n128_));
  ...
  and2   g056(.a(new_n139_), .b(new_n85_), .O(z20));
  ...
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(new_n84_), .O(new_n148_));
  and2   g065(.a(new_n148_), .b(new_n85_), .O(z22));
  nand2  g066(.a(x34), .b(new_n136_), .O(new_n150_));
  nand2  g067(.a(x35), .b(x09), .O(new_n151_));
  nand3  g068(.a(new_n151_), .b(new_n150_), .c(new_n84_), .O(new_n152_));
  and2   g069(.a(new_n152_), .b(new_n85_), .O(z23));
  ...
  aoi21  g088(.a(x38), .b(new_n136_), .c(x08), .O(new_n172_));
