...
module FAU ( 
  ...
  nand2  g037(.a(new_n120_), .b(new_n94_), .O(z06));
  ...
  nand2  g054(.a(x22), .b(new_n116_), .O(new_n138_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n94_), .O(z16));
  oai21  g075(.a(x29), .b(new_n116_), .c(x28), .O(new_n159_));
  nand2  g076(.a(x29), .b(x08), .O(new_n160_));
  aoi21  g077(.a(new_n160_), .b(new_n159_), .c(x10), .O(z17));
  oai21  g078(.a(x30), .b(new_n116_), .c(x29), .O(new_n162_));
  ...
  nand2  g108(.a(new_n191_), .b(new_n94_), .O(z25));
  ...
  nand2  g136(.a(new_n219_), .b(new_n94_), .O(z31));
