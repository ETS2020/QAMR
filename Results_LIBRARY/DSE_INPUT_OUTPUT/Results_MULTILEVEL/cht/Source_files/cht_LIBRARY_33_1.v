...
module FAU ( 
  ...
  nand3  g055(.a(new_n86_), .b(x22), .c(new_n115_), .O(new_n139_));
  nand2  g056(.a(x23), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z11));
  nand3  g058(.a(new_n86_), .b(x24), .c(x08), .O(new_n142_));
  ...
  nand3  g068(.a(new_n151_), .b(x25), .c(x23), .O(new_n152_));
  nand3  g069(.a(x26), .b(new_n145_), .c(x08), .O(new_n153_));
  ...
  oai21  g135(.a(new_n217_), .b(new_n216_), .c(new_n218_), .O(new_n219_));
  ...
  nand2  g167(.a(new_n250_), .b(new_n86_), .O(z34));
