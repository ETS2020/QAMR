...
module FAU ( 
  ...
  nand2  g001(.a(x43), .b(x26), .O(new_n85_));
  ...
  oai21  g032(.a(new_n115_), .b(x10), .c(new_n85_), .O(z06));
  ...
  nand3  g149(.a(new_n232_), .b(x43), .c(new_n153_), .O(new_n233_));
  inv1   g150(.a(x43), .O(new_n234_));
  nand3  g151(.a(new_n231_), .b(new_n234_), .c(x42), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n233_), .c(x10), .O(z31));
  nand2  g153(.a(x43), .b(new_n153_), .O(new_n237_));
  nand3  g154(.a(new_n234_), .b(new_n100_), .c(x09), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(x44), .O(new_n240_));
  nand3  g157(.a(new_n231_), .b(x43), .c(new_n153_), .O(new_n241_));
  ...
  nand2  g164(.a(new_n247_), .b(new_n85_), .O(z33));
  oai21  g165(.a(x14), .b(new_n175_), .c(x45), .O(new_n249_));
  ...
  oai21  g170(.a(x14), .b(new_n175_), .c(x46), .O(new_n254_));
