...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n97_), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(new_n102_), .O(z12));
  ...
  nand2  g057(.a(new_n140_), .b(new_n102_), .O(z13));
  ...
  nand2  g072(.a(new_n155_), .b(new_n102_), .O(z16));
  inv1   g073(.a(x28), .O(new_n157_));
  nand2  g074(.a(x29), .b(x08), .O(new_n158_));
  oai21  g075(.a(new_n157_), .b(x08), .c(new_n158_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n97_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n102_), .O(z17));
  ...
  nand3  g089(.a(x32), .b(new_n97_), .c(new_n168_), .O(new_n173_));
  ...
  nand3  g095(.a(x34), .b(new_n97_), .c(new_n168_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(z23));
  oai21  g097(.a(x36), .b(x10), .c(x09), .O(new_n181_));
  nand3  g098(.a(x35), .b(new_n97_), .c(new_n168_), .O(new_n182_));
  ...
  nand3  g111(.a(x38), .b(new_n97_), .c(new_n168_), .O(new_n195_));
  ...
  oai22  g124(.a(new_n207_), .b(new_n168_), .c(new_n206_), .d(new_n204_), .O(z30));
  ...
  aoi21  g129(.a(x44), .b(new_n191_), .c(x10), .O(new_n213_));
  oai22  g130(.a(new_n213_), .b(new_n168_), .c(new_n206_), .d(new_n212_), .O(z32));
  inv1   g131(.a(x44), .O(new_n215_));
  aoi21  g132(.a(x45), .b(new_n191_), .c(x10), .O(new_n216_));
  oai22  g133(.a(new_n216_), .b(new_n168_), .c(new_n206_), .d(new_n215_), .O(z33));
  nand2  g134(.a(new_n197_), .b(x45), .O(new_n218_));
  nand3  g135(.a(x46), .b(new_n191_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z34));
  inv1   g137(.a(x46), .O(new_n221_));
  aoi21  g138(.a(new_n191_), .b(x00), .c(x10), .O(new_n222_));
  oai22  g139(.a(new_n222_), .b(new_n168_), .c(new_n206_), .d(new_n221_), .O(z35));
endmodule
