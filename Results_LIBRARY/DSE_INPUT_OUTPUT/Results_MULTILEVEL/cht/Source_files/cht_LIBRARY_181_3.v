...
module FAU ( 
  ...
  nand2  g056(.a(new_n139_), .b(new_n89_), .O(z12));
  ...
  nand2  g115(.a(x38), .b(new_n165_), .O(new_n199_));
  ...
  nand2  g123(.a(new_n202_), .b(new_n206_), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(x41), .O(new_n208_));
  nand2  g125(.a(new_n202_), .b(x40), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z29));
  nand3  g127(.a(new_n201_), .b(new_n84_), .c(x09), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(x41), .O(new_n212_));
  nand4  g129(.a(x42), .b(new_n201_), .c(new_n84_), .d(x09), .O(new_n213_));
  ...
  nand3  g138(.a(x45), .b(new_n201_), .c(x09), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n221_), .c(x10), .O(z33));
  nand2  g140(.a(new_n202_), .b(x45), .O(new_n224_));
  nand3  g141(.a(x46), .b(new_n201_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z34));
  inv1   g143(.a(x46), .O(new_n227_));
  aoi21  g144(.a(new_n201_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(new_n201_), .b(x09), .c(x00), .O(new_n229_));
