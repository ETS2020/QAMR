...
module FAU ( 
  ...
  nor2   g016(.a(new_n87_), .b(x07), .O(new_n100_));
  ...
  nand3  g026(.a(new_n109_), .b(new_n88_), .c(new_n94_), .O(new_n110_));
  ...
  nand3  g103(.a(new_n186_), .b(new_n88_), .c(new_n94_), .O(new_n187_));
  ...
  nand3  g115(.a(new_n198_), .b(x37), .c(x14), .O(new_n199_));
