...
module FAU ( 
  ...
  nand3  g034(.a(x18), .b(new_n88_), .c(new_n113_), .O(new_n118_));
  nand2  g035(.a(new_n118_), .b(new_n117_), .O(z07));
  oai21  g036(.a(x20), .b(x10), .c(x08), .O(new_n120_));
  nand3  g037(.a(x19), .b(new_n88_), .c(new_n113_), .O(new_n121_));
  ...
  nand3  g043(.a(x21), .b(new_n88_), .c(new_n113_), .O(new_n127_));
  ...
  nand3  g061(.a(x27), .b(new_n88_), .c(new_n113_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n144_), .O(z16));
  oai21  g063(.a(x29), .b(x10), .c(x08), .O(new_n147_));
  nand3  g064(.a(x28), .b(new_n88_), .c(new_n113_), .O(new_n148_));
  ...
  nand3  g070(.a(x30), .b(new_n88_), .c(new_n113_), .O(new_n154_));
  ...
  nand2  g086(.a(new_n169_), .b(new_n93_), .O(z23));
  ...
  nand2  g090(.a(new_n173_), .b(new_n93_), .O(z24));
  ...
  nand2  g098(.a(new_n181_), .b(new_n93_), .O(z26));
  ...
  aoi21  g105(.a(new_n100_), .b(x09), .c(new_n183_), .O(new_n189_));
  nand3  g106(.a(x40), .b(new_n100_), .c(x09), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(new_n191_));
  oai21  g108(.a(new_n191_), .b(new_n189_), .c(new_n88_), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n93_), .O(z28));
  nand2  g110(.a(new_n100_), .b(x09), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(x40), .O(new_n195_));
  nand3  g112(.a(x41), .b(new_n100_), .c(x09), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z29));
  nand2  g114(.a(new_n194_), .b(x41), .O(new_n198_));
  nand3  g115(.a(x42), .b(new_n100_), .c(x09), .O(new_n199_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n93_), .O(z31));
