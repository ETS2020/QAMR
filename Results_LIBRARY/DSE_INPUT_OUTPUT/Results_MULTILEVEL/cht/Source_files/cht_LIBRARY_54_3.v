...
module FAU ( 
  ...
  nand2  g001(.a(x37), .b(x15), .O(new_n85_));
  ...
  oai21  g045(.a(new_n128_), .b(x10), .c(new_n85_), .O(z09));
  ...
  oai21  g087(.a(new_n170_), .b(x10), .c(new_n85_), .O(z19));
  ...
  nand2  g115(.a(new_n198_), .b(new_n85_), .O(z25));
  ...
  nand2  g120(.a(new_n203_), .b(new_n85_), .O(z26));
  ...
  nand2  g132(.a(new_n215_), .b(new_n85_), .O(z28));
  ...
  nand2  g142(.a(new_n225_), .b(new_n85_), .O(z30));
  ...
  nand2  g157(.a(new_n240_), .b(new_n85_), .O(z33));
  ...
  nand2  g167(.a(new_n250_), .b(new_n85_), .O(z35));
endmodule
