...
module FAU ( 
  ...
  nor2   g106(.a(x42), .b(x09), .O(new_n190_));
  oai21  g107(.a(new_n190_), .b(x35), .c(x34), .O(new_n191_));
  nand2  g108(.a(x35), .b(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z23));
  oai21  g110(.a(x36), .b(new_n175_), .c(x35), .O(new_n194_));
  inv1   g111(.a(x42), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(x36), .c(x09), .O(new_n196_));
  ...
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(new_n175_), .O(new_n209_));
  ...
  nand2  g141(.a(new_n214_), .b(new_n224_), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(x42), .c(x35), .O(new_n226_));
  nand3  g143(.a(new_n214_), .b(new_n195_), .c(x41), .O(new_n227_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n88_), .c(new_n90_), .O(new_n236_));
  ...
  oai21  g157(.a(new_n240_), .b(x10), .c(new_n88_), .O(z33));
  ...
  nand2  g165(.a(new_n248_), .b(new_n90_), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n88_), .O(z35));
endmodule
