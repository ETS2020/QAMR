...
module FAU ( 
  ...
  oai22  g113(.a(new_n196_), .b(new_n166_), .c(new_n195_), .d(new_n188_), .O(z28));
  nand2  g114(.a(new_n98_), .b(x09), .O(new_n198_));
  ...
  aoi21  g122(.a(x43), .b(new_n98_), .c(x10), .O(new_n206_));
  oai22  g123(.a(new_n206_), .b(new_n166_), .c(new_n195_), .d(new_n205_), .O(z31));
  inv1   g124(.a(x43), .O(new_n208_));
  aoi21  g125(.a(x44), .b(new_n98_), .c(x10), .O(new_n209_));
  oai22  g126(.a(new_n209_), .b(new_n166_), .c(new_n195_), .d(new_n208_), .O(z32));
  inv1   g127(.a(x44), .O(new_n211_));
  aoi21  g128(.a(x45), .b(new_n98_), .c(x10), .O(new_n212_));
  oai22  g129(.a(new_n212_), .b(new_n166_), .c(new_n195_), .d(new_n211_), .O(z33));
  inv1   g130(.a(x45), .O(new_n214_));
  aoi21  g131(.a(x46), .b(new_n98_), .c(x10), .O(new_n215_));
  oai22  g132(.a(new_n215_), .b(new_n166_), .c(new_n195_), .d(new_n214_), .O(z34));
  nand2  g133(.a(new_n198_), .b(x46), .O(new_n217_));
  nand3  g134(.a(new_n98_), .b(x09), .c(x00), .O(new_n218_));
