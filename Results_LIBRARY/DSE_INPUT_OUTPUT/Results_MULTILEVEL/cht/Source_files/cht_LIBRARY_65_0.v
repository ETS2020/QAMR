...
module FAU ( 
  ...
  nand3  g085(.a(new_n168_), .b(new_n84_), .c(x05), .O(new_n169_));
  ...
  nand3  g112(.a(new_n195_), .b(new_n84_), .c(x05), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z25));
  nand2  g114(.a(x37), .b(new_n171_), .O(new_n198_));
  nand2  g115(.a(x38), .b(x09), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n198_), .c(x05), .O(new_n200_));
  ...
  aoi21  g122(.a(x38), .b(new_n171_), .c(new_n90_), .O(new_n206_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(new_n90_), .O(new_n212_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n84_), .c(x05), .O(new_n217_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(new_n90_), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(new_n90_), .O(new_n227_));
  ...
  nand3  g148(.a(new_n231_), .b(new_n84_), .c(x05), .O(new_n232_));
  ...
  aoi21  g153(.a(new_n236_), .b(x09), .c(new_n90_), .O(new_n237_));
  ...
  nand3  g158(.a(new_n241_), .b(new_n84_), .c(x05), .O(new_n242_));
  ...
  nand3  g163(.a(new_n246_), .b(new_n84_), .c(x05), .O(new_n247_));
