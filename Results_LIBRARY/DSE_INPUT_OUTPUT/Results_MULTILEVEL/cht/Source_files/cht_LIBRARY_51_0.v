...
module FAU ( 
  ...
  nand3  g030(.a(new_n113_), .b(new_n89_), .c(x09), .O(new_n114_));
  ...
  nand3  g045(.a(new_n128_), .b(new_n89_), .c(x09), .O(new_n129_));
  ...
  nand3  g050(.a(new_n133_), .b(new_n89_), .c(x09), .O(new_n134_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n89_), .c(x09), .O(new_n143_));
  ...
  nand3  g076(.a(new_n159_), .b(new_n89_), .c(x09), .O(new_n160_));
  ...
  nand3  g086(.a(new_n169_), .b(new_n89_), .c(x09), .O(new_n170_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n89_), .c(x09), .O(new_n175_));
  ...
  nand2  g109(.a(x39), .b(new_n98_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(x09), .O(new_n194_));
  and2   g111(.a(new_n194_), .b(new_n89_), .O(z27));
  ...
  nand3  g120(.a(new_n203_), .b(new_n89_), .c(x09), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z29));
  nand2  g122(.a(x41), .b(x14), .O(new_n206_));
  nand2  g123(.a(x42), .b(new_n98_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(x09), .O(new_n208_));
  and2   g125(.a(new_n208_), .b(new_n89_), .O(z30));
  nand2  g126(.a(x42), .b(x14), .O(new_n210_));
  nand2  g127(.a(x43), .b(new_n98_), .O(new_n211_));
  ...
  nand3  g147(.a(new_n230_), .b(new_n89_), .c(x09), .O(new_n231_));
