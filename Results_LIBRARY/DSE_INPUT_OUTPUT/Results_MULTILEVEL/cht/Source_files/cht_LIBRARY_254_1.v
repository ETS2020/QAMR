...
module FAU ( 
  ...
  nand2  g073(.a(x29), .b(new_n115_), .O(new_n157_));
  ...
  oai21  g081(.a(x31), .b(x10), .c(new_n96_), .O(new_n165_));
  nand3  g082(.a(x32), .b(new_n91_), .c(x09), .O(new_n166_));
  ...
  oai21  g122(.a(x43), .b(x10), .c(new_n96_), .O(new_n206_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n206_), .O(z32));
  oai21  g128(.a(x44), .b(x10), .c(new_n96_), .O(new_n212_));
  nand2  g129(.a(x44), .b(x14), .O(new_n213_));
  nand3  g130(.a(x45), .b(new_n192_), .c(x09), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n213_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n91_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n212_), .O(z33));
  ...
  oai21  g137(.a(x46), .b(x10), .c(new_n96_), .O(new_n221_));
  nand3  g138(.a(new_n192_), .b(x09), .c(x00), .O(new_n222_));
  nand2  g139(.a(x46), .b(x14), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n91_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n221_), .O(z35));
endmodule
