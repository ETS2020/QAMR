...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x25), .O(new_n93_));
  ...
  aoi21  g017(.a(x14), .b(new_n92_), .c(x25), .O(new_n101_));
  ...
  aoi21  g025(.a(x16), .b(new_n92_), .c(x25), .O(new_n109_));
  ...
  nand4  g057(.a(new_n85_), .b(x24), .c(new_n84_), .d(new_n111_), .O(new_n141_));
  inv1   g058(.a(new_n141_), .O(z13));
  nand4  g059(.a(x26), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n143_));
  ...
  aoi21  g080(.a(x30), .b(new_n111_), .c(x25), .O(new_n164_));
  ...
  aoi21  g116(.a(x38), .b(new_n166_), .c(x25), .O(new_n200_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x25), .O(new_n212_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x25), .O(new_n227_));
  ...
  aoi21  g148(.a(new_n231_), .b(x09), .c(x25), .O(new_n232_));
  ...
  aoi21  g157(.a(new_n240_), .b(x00), .c(x25), .O(new_n241_));
