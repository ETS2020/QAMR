...
module FAU ( 
  ...
  oai21  g088(.a(x32), .b(x10), .c(new_n89_), .O(new_n172_));
  nand3  g089(.a(x33), .b(new_n84_), .c(x09), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(z21));
  nand2  g091(.a(x33), .b(new_n89_), .O(new_n175_));
  ...
  oai21  g097(.a(x35), .b(x10), .c(new_n89_), .O(new_n181_));
  nand3  g098(.a(x36), .b(new_n84_), .c(x09), .O(new_n182_));
  ...
  oai21  g110(.a(x38), .b(x10), .c(new_n89_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n193_), .O(z27));
  oai21  g112(.a(x39), .b(x10), .c(new_n89_), .O(new_n196_));
  nand2  g113(.a(x39), .b(x14), .O(new_n197_));
  nand3  g114(.a(x40), .b(new_n102_), .c(x09), .O(new_n198_));
  ...
  oai21  g122(.a(x41), .b(x10), .c(new_n89_), .O(new_n206_));
  ...
  nand3  g130(.a(x43), .b(new_n102_), .c(x09), .O(new_n214_));
  ...
  oai21  g137(.a(x44), .b(x10), .c(new_n89_), .O(new_n221_));
  nand2  g138(.a(x44), .b(x14), .O(new_n222_));
  nand3  g139(.a(x45), .b(new_n102_), .c(x09), .O(new_n223_));
  ...
  oai21  g143(.a(x45), .b(x10), .c(new_n89_), .O(new_n227_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n227_), .O(z34));
