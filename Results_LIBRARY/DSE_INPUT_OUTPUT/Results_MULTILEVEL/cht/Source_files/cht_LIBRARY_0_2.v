...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n97_), .c(x08), .O(new_n104_));
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  aoi21  g023(.a(x16), .b(new_n97_), .c(x08), .O(new_n107_));
  ...
  nand2  g044(.a(new_n109_), .b(x26), .O(new_n128_));
  ...
  aoi21  g049(.a(new_n132_), .b(new_n84_), .c(x10), .O(z17));
  ...
  and2   g067(.a(new_n150_), .b(new_n85_), .O(z22));
  ...
  oai21  g079(.a(new_n161_), .b(new_n138_), .c(new_n162_), .O(new_n163_));
  ...
  aoi21  g090(.a(x38), .b(new_n138_), .c(x08), .O(new_n174_));
  ...
  nand3  g110(.a(x43), .b(new_n176_), .c(x09), .O(new_n194_));
