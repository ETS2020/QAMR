...
module FAU ( 
  ...
  aoi21  g037(.a(new_n120_), .b(new_n88_), .c(x10), .O(z09));
  ...
  nand2  g046(.a(new_n115_), .b(x25), .O(new_n130_));
  inv1   g047(.a(new_n130_), .O(z14));
  inv1   g048(.a(x26), .O(new_n132_));
  aoi21  g049(.a(new_n132_), .b(new_n88_), .c(x10), .O(z15));
  inv1   g050(.a(x27), .O(new_n134_));
  aoi21  g051(.a(new_n134_), .b(new_n88_), .c(x10), .O(z16));
