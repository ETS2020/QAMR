...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x39), .O(new_n88_));
  ...
  nand2  g127(.a(x46), .b(x39), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(new_n208_), .O(new_n212_));
  nor2   g129(.a(new_n211_), .b(x14), .O(new_n213_));
  oai21  g130(.a(new_n213_), .b(new_n212_), .c(x09), .O(new_n214_));
  nand3  g131(.a(new_n88_), .b(x38), .c(new_n175_), .O(new_n215_));
  ...
  oai21  g135(.a(new_n217_), .b(new_n209_), .c(new_n218_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n90_), .O(new_n220_));
  ...
  aoi21  g141(.a(new_n222_), .b(x40), .c(new_n224_), .O(new_n225_));
  oai21  g142(.a(new_n225_), .b(x10), .c(new_n88_), .O(z29));
  nand2  g143(.a(new_n222_), .b(x41), .O(new_n227_));
  ...
  nand2  g148(.a(new_n222_), .b(x42), .O(new_n232_));
  ...
  nand2  g153(.a(new_n222_), .b(x43), .O(new_n237_));
  ...
  aoi21  g160(.a(new_n222_), .b(x44), .c(new_n243_), .O(new_n244_));
  oai21  g161(.a(new_n244_), .b(x10), .c(new_n88_), .O(z33));
  oai21  g162(.a(new_n217_), .b(x39), .c(new_n87_), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(x45), .O(new_n247_));
  nand3  g164(.a(x46), .b(new_n100_), .c(x09), .O(new_n248_));
  aoi21  g165(.a(new_n248_), .b(new_n247_), .c(x10), .O(z34));
  aoi21  g166(.a(new_n222_), .b(new_n87_), .c(new_n208_), .O(new_n250_));
  aoi21  g167(.a(new_n222_), .b(x46), .c(new_n250_), .O(new_n251_));
  oai21  g168(.a(new_n251_), .b(x10), .c(new_n88_), .O(z35));
endmodule
