...
module FAU ( 
  ...
  nand2  g065(.a(x28), .b(new_n111_), .O(new_n149_));
  ...
  nand2  g072(.a(x30), .b(new_n111_), .O(new_n156_));
  ...
  nand2  g109(.a(x38), .b(new_n158_), .O(new_n193_));
  ...
  nand3  g141(.a(x46), .b(new_n195_), .c(x09), .O(new_n225_));
