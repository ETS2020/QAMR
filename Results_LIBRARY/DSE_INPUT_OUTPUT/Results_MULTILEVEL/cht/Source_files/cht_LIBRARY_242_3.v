...
module FAU ( 
  ...
  nand2  g040(.a(new_n123_), .b(new_n99_), .O(z08));
  ...
  nand2  g045(.a(new_n128_), .b(new_n99_), .O(z09));
  ...
  nand3  g084(.a(x31), .b(new_n94_), .c(new_n167_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n166_), .O(z20));
  oai21  g086(.a(x33), .b(x10), .c(x09), .O(new_n170_));
  nand3  g087(.a(x32), .b(new_n94_), .c(new_n167_), .O(new_n171_));
  ...
  nand3  g093(.a(x34), .b(new_n94_), .c(new_n167_), .O(new_n177_));
  ...
  nand3  g099(.a(x36), .b(new_n94_), .c(new_n167_), .O(new_n183_));
  ...
  aoi21  g120(.a(x42), .b(new_n95_), .c(x10), .O(new_n204_));
  oai22  g121(.a(new_n204_), .b(new_n167_), .c(new_n203_), .d(new_n201_), .O(z30));
  inv1   g122(.a(x42), .O(new_n206_));
  aoi21  g123(.a(x43), .b(new_n95_), .c(x10), .O(new_n207_));
  oai22  g124(.a(new_n207_), .b(new_n167_), .c(new_n203_), .d(new_n206_), .O(z31));
  ...
  nand3  g129(.a(x45), .b(new_n95_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z33));
  inv1   g131(.a(x45), .O(new_n215_));
  aoi21  g132(.a(x46), .b(new_n95_), .c(x10), .O(new_n216_));
  oai22  g133(.a(new_n216_), .b(new_n167_), .c(new_n203_), .d(new_n215_), .O(z34));
  inv1   g134(.a(x46), .O(new_n218_));
  aoi21  g135(.a(new_n95_), .b(x00), .c(x10), .O(new_n219_));
  oai22  g136(.a(new_n219_), .b(new_n167_), .c(new_n203_), .d(new_n218_), .O(z35));
endmodule
