...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x43), .O(new_n93_));
  ...
  aoi21  g017(.a(x14), .b(new_n92_), .c(x43), .O(new_n101_));
  aoi21  g018(.a(new_n101_), .b(new_n100_), .c(x10), .O(z03));
  nand2  g019(.a(x07), .b(x02), .O(new_n103_));
  aoi21  g020(.a(x15), .b(new_n92_), .c(x43), .O(new_n104_));
  ...
  aoi21  g100(.a(x36), .b(x09), .c(x43), .O(new_n184_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x43), .O(new_n212_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x43), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n214_), .c(x10), .O(z30));
  nand2  g135(.a(new_n203_), .b(x42), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n85_), .c(x10), .O(z31));
  inv1   g137(.a(x44), .O(new_n221_));
  nand4  g138(.a(new_n85_), .b(new_n196_), .c(new_n84_), .d(x09), .O(new_n222_));
  nor2   g139(.a(new_n222_), .b(new_n221_), .O(z32));
  nand2  g140(.a(new_n203_), .b(x44), .O(new_n224_));
  inv1   g141(.a(x45), .O(new_n225_));
  nor2   g142(.a(new_n225_), .b(x14), .O(new_n226_));
  aoi21  g143(.a(new_n226_), .b(x09), .c(x43), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n224_), .c(x10), .O(z33));
  inv1   g145(.a(new_n203_), .O(new_n229_));
  ...
  aoi21  g151(.a(new_n229_), .b(x00), .c(x43), .O(new_n235_));
