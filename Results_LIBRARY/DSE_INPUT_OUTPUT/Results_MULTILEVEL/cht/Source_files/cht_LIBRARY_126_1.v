...
module FAU ( 
  ...
  aoi21  g029(.a(x16), .b(new_n112_), .c(x41), .O(new_n113_));
  ...
  aoi21  g038(.a(x19), .b(x08), .c(x41), .O(new_n122_));
  ...
  nand2  g117(.a(x39), .b(new_n101_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(new_n176_), .O(new_n202_));
  nor2   g119(.a(new_n195_), .b(x09), .O(new_n203_));
  oai21  g120(.a(new_n203_), .b(new_n202_), .c(new_n85_), .O(new_n204_));
  ...
  nand4  g128(.a(new_n206_), .b(new_n85_), .c(x40), .d(new_n84_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z29));
  inv1   g130(.a(x42), .O(new_n214_));
  nand4  g131(.a(new_n85_), .b(new_n101_), .c(new_n84_), .d(x09), .O(new_n215_));
  nor2   g132(.a(new_n215_), .b(new_n214_), .O(z30));
  inv1   g133(.a(new_n206_), .O(new_n217_));
  nand3  g134(.a(x43), .b(new_n101_), .c(x09), .O(new_n218_));
  oai21  g135(.a(new_n217_), .b(new_n214_), .c(new_n218_), .O(new_n219_));
  ...
  nand3  g148(.a(x46), .b(new_n101_), .c(x09), .O(new_n232_));
  ...
  nand2  g152(.a(new_n206_), .b(x46), .O(new_n236_));
  aoi21  g153(.a(new_n217_), .b(x00), .c(x41), .O(new_n237_));
