...
module FAU ( 
  ...
  oai21  g034(.a(new_n93_), .b(new_n110_), .c(new_n117_), .O(new_n118_));
  nand2  g035(.a(new_n118_), .b(new_n88_), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(new_n94_), .O(z08));
  nand2  g037(.a(x21), .b(x08), .O(new_n121_));
  oai21  g038(.a(new_n93_), .b(x08), .c(new_n121_), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(new_n88_), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n94_), .O(z09));
  ...
  nand2  g062(.a(x27), .b(new_n110_), .O(new_n146_));
  oai21  g063(.a(new_n145_), .b(new_n110_), .c(new_n146_), .O(new_n147_));
  ...
  nand2  g069(.a(new_n152_), .b(new_n94_), .O(z17));
  ...
  nand2  g090(.a(new_n173_), .b(new_n94_), .O(z22));
  ...
  oai21  g096(.a(new_n178_), .b(new_n163_), .c(new_n179_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n88_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n94_), .O(z24));
  ...
  nand3  g125(.a(x43), .b(new_n196_), .c(x09), .O(new_n209_));
