...
module FAU ( 
  ...
  nand2  g054(.a(x23), .b(new_n123_), .O(new_n138_));
  ...
  nand2  g062(.a(x25), .b(new_n123_), .O(new_n146_));
  nand2  g063(.a(x26), .b(x08), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n146_), .c(x10), .O(z14));
  nand2  g065(.a(x26), .b(new_n123_), .O(new_n149_));
  ...
  nand2  g084(.a(x30), .b(new_n123_), .O(new_n168_));
  ...
  aoi21  g115(.a(x14), .b(x09), .c(new_n198_), .O(new_n199_));
  aoi21  g116(.a(x40), .b(new_n98_), .c(x10), .O(new_n200_));
  oai22  g117(.a(new_n200_), .b(new_n170_), .c(new_n199_), .d(new_n192_), .O(z28));
  ...
  aoi21  g126(.a(x43), .b(new_n98_), .c(x10), .O(new_n210_));
  oai22  g127(.a(new_n210_), .b(new_n170_), .c(new_n199_), .d(new_n209_), .O(z31));
  inv1   g128(.a(x43), .O(new_n212_));
  aoi21  g129(.a(x44), .b(new_n98_), .c(x10), .O(new_n213_));
  oai22  g130(.a(new_n213_), .b(new_n170_), .c(new_n199_), .d(new_n212_), .O(z32));
  nand2  g131(.a(new_n202_), .b(x44), .O(new_n215_));
  ...
  nand3  g135(.a(x46), .b(new_n98_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z34));
  nand2  g137(.a(new_n202_), .b(x46), .O(new_n221_));
  nand3  g138(.a(new_n98_), .b(x09), .c(x00), .O(new_n222_));
