...
module FAU ( 
  ...
  nand2  g032(.a(new_n109_), .b(x22), .O(new_n116_));
  ...
  nand2  g046(.a(new_n109_), .b(x29), .O(new_n130_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n89_), .c(x08), .O(new_n149_));
  ...
  nand3  g121(.a(new_n204_), .b(new_n89_), .c(x08), .O(new_n205_));
  ...
  oai21  g129(.a(new_n176_), .b(new_n134_), .c(new_n212_), .O(new_n213_));
