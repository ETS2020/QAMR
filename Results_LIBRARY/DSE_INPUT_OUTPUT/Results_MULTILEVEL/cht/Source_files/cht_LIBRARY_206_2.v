...
module FAU ( 
  ...
  nand2  g084(.a(new_n167_), .b(new_n93_), .O(z20));
  ...
  nand2  g123(.a(new_n206_), .b(new_n93_), .O(z29));
  ...
  nand2  g136(.a(new_n198_), .b(x43), .O(new_n220_));
