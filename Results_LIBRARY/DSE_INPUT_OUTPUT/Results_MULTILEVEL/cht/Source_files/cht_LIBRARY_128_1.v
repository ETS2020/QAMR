...
module FAU ( 
  ...
  inv1   g003(.a(x17), .O(new_n87_));
  nand2  g004(.a(x34), .b(new_n87_), .O(new_n88_));
  ...
  nand2  g059(.a(new_n142_), .b(new_n90_), .O(new_n143_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n90_), .O(new_n161_));
  ...
  nand2  g089(.a(x30), .b(new_n113_), .O(new_n173_));
  oai21  g090(.a(new_n113_), .b(new_n172_), .c(new_n173_), .O(new_n174_));
  ...
  nand3  g105(.a(new_n188_), .b(x34), .c(x17), .O(new_n189_));
  nand3  g106(.a(new_n115_), .b(x33), .c(new_n177_), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z22));
  nand2  g108(.a(x35), .b(x09), .O(new_n192_));
  oai21  g109(.a(new_n115_), .b(x09), .c(new_n192_), .O(new_n193_));
  ...
  oai21  g154(.a(new_n237_), .b(x10), .c(new_n88_), .O(z32));
  ...
  oai21  g163(.a(new_n246_), .b(x10), .c(new_n88_), .O(z34));
  nand2  g164(.a(new_n216_), .b(x46), .O(new_n248_));
  oai21  g165(.a(new_n216_), .b(new_n172_), .c(new_n248_), .O(new_n249_));
