...
module FAU ( 
  ...
  nand3  g032(.a(x18), .b(new_n88_), .c(new_n111_), .O(new_n116_));
  ...
  nand3  g038(.a(x20), .b(new_n88_), .c(new_n111_), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(new_n121_), .O(z09));
  oai21  g040(.a(x22), .b(x10), .c(x08), .O(new_n124_));
  nand3  g041(.a(x21), .b(new_n88_), .c(new_n111_), .O(new_n125_));
  ...
  nand3  g053(.a(x25), .b(new_n88_), .c(new_n111_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n136_), .O(z14));
  oai21  g055(.a(x27), .b(x10), .c(x08), .O(new_n139_));
  nand3  g056(.a(x26), .b(new_n88_), .c(new_n111_), .O(new_n140_));
  ...
  nand3  g068(.a(x30), .b(new_n88_), .c(new_n111_), .O(new_n152_));
  ...
  nand2  g075(.a(new_n158_), .b(new_n93_), .O(z20));
  ...
  nand2  g079(.a(new_n162_), .b(new_n93_), .O(z21));
  ...
  nand2  g091(.a(x36), .b(new_n154_), .O(new_n175_));
  nand2  g092(.a(x37), .b(x09), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n175_), .c(x10), .O(z25));
  inv1   g094(.a(x38), .O(new_n178_));
  nand2  g095(.a(x37), .b(new_n154_), .O(new_n179_));
  oai21  g096(.a(new_n178_), .b(new_n154_), .c(new_n179_), .O(new_n180_));
  ...
  oai21  g117(.a(x14), .b(new_n154_), .c(x41), .O(new_n201_));
  nand3  g118(.a(x42), .b(new_n189_), .c(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z30));
  inv1   g120(.a(x42), .O(new_n204_));
  aoi21  g121(.a(new_n189_), .b(x09), .c(new_n204_), .O(new_n205_));
  nand3  g122(.a(x43), .b(new_n189_), .c(x09), .O(new_n206_));
  ...
  aoi21  g127(.a(new_n189_), .b(x09), .c(new_n210_), .O(new_n211_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n93_), .O(z32));
  inv1   g132(.a(x44), .O(new_n216_));
  aoi21  g133(.a(new_n189_), .b(x09), .c(new_n216_), .O(new_n217_));
  nand3  g134(.a(x45), .b(new_n189_), .c(x09), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(new_n217_), .c(new_n88_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n93_), .O(z33));
  inv1   g138(.a(x45), .O(new_n222_));
  aoi21  g139(.a(new_n189_), .b(x09), .c(new_n222_), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n189_), .c(x09), .O(new_n224_));
  ...
  aoi21  g145(.a(new_n189_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(new_n189_), .b(x09), .c(x00), .O(new_n230_));
