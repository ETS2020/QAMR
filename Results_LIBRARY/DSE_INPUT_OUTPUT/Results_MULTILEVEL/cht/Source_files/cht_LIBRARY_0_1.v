...
module FAU ( 
  ...
  nand2  g030(.a(x17), .b(new_n96_), .O(new_n114_));
  ...
  oai21  g042(.a(x21), .b(x10), .c(new_n96_), .O(new_n126_));
  ...
  nand2  g057(.a(x26), .b(new_n96_), .O(new_n141_));
  ...
  oai21  g066(.a(x29), .b(x10), .c(new_n96_), .O(new_n150_));
  nand3  g067(.a(x30), .b(new_n91_), .c(x08), .O(new_n151_));
  ...
  nand2  g091(.a(new_n174_), .b(new_n97_), .O(z24));
  ...
  nand2  g109(.a(new_n192_), .b(new_n97_), .O(z28));
  inv1   g110(.a(x40), .O(new_n194_));
  aoi21  g111(.a(new_n99_), .b(x09), .c(new_n194_), .O(new_n195_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n97_), .O(z32));
  ...
  nand2  g140(.a(new_n223_), .b(new_n97_), .O(z34));
  ...
  nand2  g146(.a(new_n229_), .b(new_n97_), .O(z35));
endmodule
