...
module FAU ( 
  ...
  aoi21  g039(.a(new_n122_), .b(new_n88_), .c(x10), .O(z11));
  ...
  aoi21  g045(.a(new_n128_), .b(new_n88_), .c(x10), .O(z14));
  inv1   g046(.a(x26), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n88_), .c(x10), .O(z15));
  nand2  g048(.a(new_n113_), .b(x27), .O(new_n132_));
  inv1   g049(.a(new_n132_), .O(z16));
  inv1   g050(.a(x28), .O(new_n134_));
  aoi21  g051(.a(new_n134_), .b(new_n88_), .c(x10), .O(z17));
  inv1   g052(.a(x29), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n88_), .c(x10), .O(z18));
  ...
  aoi21  g132(.a(new_n215_), .b(x00), .c(x08), .O(new_n216_));
