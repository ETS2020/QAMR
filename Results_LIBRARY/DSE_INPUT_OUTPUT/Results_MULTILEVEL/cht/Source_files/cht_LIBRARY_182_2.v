...
module FAU ( 
  ...
  aoi21  g024(.a(x15), .b(new_n107_), .c(x09), .O(new_n108_));
  aoi21  g025(.a(new_n108_), .b(new_n106_), .c(x10), .O(z04));
  nand2  g026(.a(x07), .b(x03), .O(new_n110_));
  aoi21  g027(.a(x16), .b(new_n107_), .c(x09), .O(new_n111_));
  ...
  nand3  g047(.a(new_n130_), .b(new_n129_), .c(new_n84_), .O(new_n131_));
  and2   g048(.a(new_n131_), .b(new_n85_), .O(z09));
  ...
  and2   g057(.a(new_n140_), .b(new_n85_), .O(z11));
  ...
  and2   g061(.a(new_n144_), .b(new_n85_), .O(z12));
  ...
  and2   g065(.a(new_n148_), .b(new_n85_), .O(z13));
  ...
  and2   g069(.a(new_n152_), .b(new_n85_), .O(z14));
  ...
  and2   g073(.a(new_n156_), .b(new_n85_), .O(z15));
  ...
  nand2  g097(.a(new_n176_), .b(x33), .O(new_n181_));
  ...
  nand2  g105(.a(new_n176_), .b(x37), .O(new_n189_));
  ...
  nand2  g115(.a(new_n176_), .b(x42), .O(new_n199_));
  ...
  aoi21  g120(.a(new_n203_), .b(new_n84_), .c(x10), .O(z33));
