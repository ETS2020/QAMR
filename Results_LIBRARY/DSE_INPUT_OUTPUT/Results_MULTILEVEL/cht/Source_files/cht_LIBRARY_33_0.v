...
module FAU ( 
  ...
  or2    g001(.a(x25), .b(x23), .O(new_n85_));
  ...
  nand3  g054(.a(new_n85_), .b(x22), .c(new_n114_), .O(new_n138_));
  nand2  g055(.a(x23), .b(x08), .O(new_n139_));
  aoi21  g056(.a(new_n139_), .b(new_n138_), .c(x10), .O(z11));
  nand3  g057(.a(new_n85_), .b(x24), .c(x08), .O(new_n141_));
  ...
  oai21  g065(.a(x26), .b(new_n114_), .c(x25), .O(new_n149_));
  nand3  g066(.a(x26), .b(x23), .c(x08), .O(new_n150_));
  aoi21  g067(.a(new_n150_), .b(new_n149_), .c(x10), .O(z14));
  inv1   g068(.a(x27), .O(new_n152_));
  nand2  g069(.a(x26), .b(new_n114_), .O(new_n153_));
  ...
  nand2  g076(.a(new_n159_), .b(new_n85_), .O(z16));
  ...
  nand2  g081(.a(new_n164_), .b(new_n85_), .O(z17));
  ...
  nand2  g085(.a(new_n168_), .b(new_n85_), .O(z18));
  ...
  oai21  g128(.a(new_n211_), .b(new_n210_), .c(new_n85_), .O(new_n212_));
  ...
  nand2  g165(.a(new_n248_), .b(new_n85_), .O(z34));
  ...
  nand2  g170(.a(new_n253_), .b(new_n85_), .O(z35));
endmodule
