...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n85_), .c(x36), .O(new_n106_));
  ...
  aoi21  g071(.a(x28), .b(x08), .c(x36), .O(new_n155_));
  ...
  nand4  g099(.a(new_n89_), .b(x35), .c(new_n88_), .d(new_n168_), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z24));
  nand2  g101(.a(x37), .b(x09), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n89_), .c(x10), .O(z25));
  ...
  aoi21  g112(.a(x38), .b(new_n168_), .c(x36), .O(new_n196_));
  ...
  aoi21  g148(.a(new_n231_), .b(x09), .c(x36), .O(new_n232_));
