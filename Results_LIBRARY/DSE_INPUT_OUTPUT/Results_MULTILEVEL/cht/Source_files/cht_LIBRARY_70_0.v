...
module FAU ( 
  ...
  nor3   g055(.a(x10), .b(new_n97_), .c(new_n138_), .O(z19));
  ...
  nor2   g094(.a(new_n177_), .b(new_n97_), .O(z27));
  ...
  oai21  g132(.a(new_n179_), .b(new_n138_), .c(new_n215_), .O(new_n216_));
