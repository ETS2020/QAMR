...
module FAU ( 
  ...
  nor2   g128(.a(x14), .b(new_n167_), .O(new_n212_));
  oai21  g129(.a(new_n212_), .b(x43), .c(x44), .O(new_n213_));
  nand2  g130(.a(new_n199_), .b(x43), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z32));
  oai21  g132(.a(new_n212_), .b(x44), .c(x45), .O(new_n216_));
  nand2  g133(.a(new_n199_), .b(x44), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z33));
  nand2  g135(.a(new_n199_), .b(x45), .O(new_n219_));
