...
module FAU ( 
  ...
  nand3  g085(.a(x32), .b(new_n88_), .c(new_n164_), .O(new_n169_));
  ...
  nand3  g091(.a(x34), .b(new_n88_), .c(new_n164_), .O(new_n175_));
  ...
  nand3  g097(.a(x36), .b(new_n88_), .c(new_n164_), .O(new_n181_));
  ...
  nand2  g114(.a(new_n187_), .b(x09), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(x40), .O(new_n199_));
  nand3  g116(.a(x41), .b(new_n187_), .c(x09), .O(new_n200_));
  ...
  nand2  g127(.a(new_n198_), .b(x44), .O(new_n211_));
  nand3  g128(.a(x45), .b(new_n187_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z33));
  inv1   g130(.a(x45), .O(new_n214_));
  aoi21  g131(.a(x46), .b(new_n187_), .c(x10), .O(new_n215_));
  oai22  g132(.a(new_n215_), .b(new_n164_), .c(new_n195_), .d(new_n214_), .O(z34));
  inv1   g133(.a(x46), .O(new_n217_));
  aoi21  g134(.a(new_n187_), .b(x00), .c(x10), .O(new_n218_));
  oai22  g135(.a(new_n218_), .b(new_n164_), .c(new_n195_), .d(new_n217_), .O(z35));
endmodule
