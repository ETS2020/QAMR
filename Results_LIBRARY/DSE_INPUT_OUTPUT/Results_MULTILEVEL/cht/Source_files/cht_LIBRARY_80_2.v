...
module FAU ( 
  ...
  aoi21  g028(.a(new_n111_), .b(new_n88_), .c(x10), .O(z07));
  ...
  aoi21  g037(.a(new_n120_), .b(new_n88_), .c(x10), .O(z11));
  ...
  nand2  g044(.a(new_n113_), .b(x26), .O(new_n128_));
  ...
  aoi21  g049(.a(new_n132_), .b(new_n88_), .c(x10), .O(z17));
  nand2  g050(.a(new_n113_), .b(x29), .O(new_n134_));
  ...
  oai21  g061(.a(new_n143_), .b(x09), .c(new_n144_), .O(new_n145_));
  ...
  aoi21  g089(.a(x38), .b(new_n138_), .c(x08), .O(new_n173_));
  ...
  oai21  g103(.a(x14), .b(new_n138_), .c(x41), .O(new_n187_));
  nand3  g104(.a(x42), .b(new_n176_), .c(x09), .O(new_n188_));
  ...
  oai21  g108(.a(x14), .b(new_n138_), .c(x42), .O(new_n192_));
  nand3  g109(.a(x43), .b(new_n176_), .c(x09), .O(new_n193_));
  ...
  oai21  g123(.a(x14), .b(new_n138_), .c(x45), .O(new_n207_));
  nand3  g124(.a(x46), .b(new_n176_), .c(x09), .O(new_n208_));
  ...
  nand2  g128(.a(new_n181_), .b(x46), .O(new_n212_));
  nor2   g129(.a(x14), .b(new_n138_), .O(new_n213_));
