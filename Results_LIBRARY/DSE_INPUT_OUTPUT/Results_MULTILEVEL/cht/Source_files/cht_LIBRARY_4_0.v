...
module FAU ( 
  ...
  and2   g033(.a(new_n116_), .b(new_n89_), .O(z06));
  ...
  nand3  g046(.a(new_n129_), .b(new_n89_), .c(x09), .O(new_n130_));
  ...
  and2   g061(.a(new_n144_), .b(new_n89_), .O(z12));
  ...
  and2   g084(.a(new_n167_), .b(new_n89_), .O(z17));
  nand2  g085(.a(x29), .b(new_n113_), .O(new_n169_));
  nand2  g086(.a(x30), .b(x08), .O(new_n170_));
  nand3  g087(.a(new_n170_), .b(new_n169_), .c(x09), .O(new_n171_));
  and2   g088(.a(new_n171_), .b(new_n89_), .O(z18));
  nand2  g089(.a(x08), .b(x00), .O(new_n173_));
  aoi21  g090(.a(x30), .b(new_n113_), .c(new_n86_), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z19));
  nor2   g092(.a(x10), .b(new_n86_), .O(new_n176_));
  ...
  and2   g124(.a(new_n207_), .b(new_n89_), .O(z30));
