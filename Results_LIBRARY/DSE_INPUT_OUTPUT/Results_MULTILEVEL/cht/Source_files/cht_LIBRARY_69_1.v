...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x27), .O(new_n93_));
  aoi21  g010(.a(new_n93_), .b(new_n91_), .c(x10), .O(z01));
  nand2  g011(.a(x07), .b(x06), .O(new_n95_));
  aoi21  g012(.a(x13), .b(new_n92_), .c(x27), .O(new_n96_));
  aoi21  g013(.a(new_n96_), .b(new_n95_), .c(x10), .O(z02));
  nand2  g014(.a(x07), .b(x01), .O(new_n98_));
  aoi21  g015(.a(x14), .b(new_n92_), .c(x27), .O(new_n99_));
  ...
  aoi21  g056(.a(x26), .b(x08), .c(x27), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z14));
  nand2  g058(.a(x26), .b(new_n111_), .O(new_n142_));
  aoi21  g059(.a(new_n142_), .b(new_n85_), .c(x10), .O(z15));
  nand4  g060(.a(x28), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n144_));
  ...
  oai21  g113(.a(new_n196_), .b(new_n195_), .c(new_n85_), .O(new_n197_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x27), .O(new_n218_));
  ...
  aoi21  g151(.a(new_n205_), .b(x00), .c(x27), .O(new_n235_));
