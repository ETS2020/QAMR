...
module FAU ( 
  ...
  nand2  g028(.a(x16), .b(new_n98_), .O(new_n112_));
  ...
  nand2  g042(.a(x21), .b(new_n89_), .O(new_n126_));
  ...
  nand2  g108(.a(new_n101_), .b(x09), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(x39), .O(new_n193_));
  nand3  g110(.a(x40), .b(new_n101_), .c(x09), .O(new_n194_));
  ...
  aoi21  g119(.a(new_n101_), .b(x09), .c(new_n202_), .O(new_n203_));
  ...
  nand3  g129(.a(x44), .b(new_n101_), .c(x09), .O(new_n213_));
