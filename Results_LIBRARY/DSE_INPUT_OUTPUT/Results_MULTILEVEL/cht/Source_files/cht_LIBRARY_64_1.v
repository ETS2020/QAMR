...
module FAU ( 
  ...
  oai21  g041(.a(x20), .b(new_n115_), .c(x19), .O(new_n125_));
  inv1   g042(.a(x46), .O(new_n126_));
  nand3  g043(.a(new_n126_), .b(x20), .c(x08), .O(new_n127_));
  ...
  nand2  g085(.a(new_n168_), .b(new_n88_), .O(z17));
  ...
  nand2  g094(.a(new_n177_), .b(new_n88_), .O(z19));
  ...
  nor2   g163(.a(new_n126_), .b(x14), .O(new_n247_));
  aoi22  g164(.a(new_n247_), .b(x09), .c(new_n218_), .d(x45), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(x10), .c(new_n88_), .O(z34));
  nand3  g166(.a(new_n126_), .b(new_n100_), .c(x09), .O(new_n250_));
  oai21  g167(.a(new_n126_), .b(new_n87_), .c(new_n250_), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(x00), .O(new_n252_));
  nand3  g169(.a(new_n218_), .b(x46), .c(x19), .O(new_n253_));
