...
module FAU ( 
  ...
  nand2  g005(.a(x46), .b(x10), .O(new_n89_));
  ...
  nand2  g074(.a(x28), .b(new_n111_), .O(new_n158_));
  ...
  nand2  g098(.a(new_n181_), .b(new_n89_), .O(z22));
  ...
  nand2  g104(.a(x35), .b(new_n171_), .O(new_n188_));
  oai21  g105(.a(new_n187_), .b(new_n171_), .c(new_n188_), .O(new_n189_));
  ...
  aoi21  g121(.a(new_n203_), .b(x09), .c(new_n204_), .O(new_n205_));
  oai21  g122(.a(new_n205_), .b(x10), .c(new_n89_), .O(z27));
  inv1   g123(.a(x14), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(x09), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(x39), .O(new_n209_));
  nand3  g126(.a(x40), .b(new_n207_), .c(x09), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z28));
  nand2  g128(.a(new_n208_), .b(x40), .O(new_n212_));
  nand3  g129(.a(x41), .b(new_n207_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z29));
  nand2  g131(.a(new_n208_), .b(x41), .O(new_n215_));
  nand3  g132(.a(x42), .b(new_n207_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z30));
  nand2  g134(.a(new_n208_), .b(x42), .O(new_n218_));
  nand3  g135(.a(x43), .b(new_n207_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z31));
  inv1   g137(.a(x43), .O(new_n221_));
  aoi21  g138(.a(new_n207_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(x44), .b(new_n207_), .c(x09), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(new_n224_));
  oai21  g141(.a(new_n224_), .b(new_n222_), .c(new_n84_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n89_), .O(z32));
  nand2  g143(.a(new_n208_), .b(x44), .O(new_n227_));
  nand3  g144(.a(x45), .b(new_n207_), .c(x09), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z33));
  nor2   g146(.a(x14), .b(new_n171_), .O(new_n230_));
  oai21  g147(.a(new_n230_), .b(x45), .c(x46), .O(new_n231_));
  nand2  g148(.a(new_n208_), .b(x45), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n231_), .c(x10), .O(z34));
  oai21  g150(.a(new_n230_), .b(x46), .c(x00), .O(new_n234_));
  nand2  g151(.a(new_n208_), .b(x46), .O(new_n235_));
