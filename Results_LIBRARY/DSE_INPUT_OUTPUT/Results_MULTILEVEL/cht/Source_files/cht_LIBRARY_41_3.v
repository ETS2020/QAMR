...
module FAU ( 
  ...
  nand3  g067(.a(x29), .b(new_n88_), .c(new_n113_), .O(new_n151_));
  ...
  nand2  g107(.a(x38), .b(new_n156_), .O(new_n191_));
  ...
  nand3  g111(.a(x40), .b(new_n98_), .c(x09), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z28));
  nand2  g113(.a(new_n193_), .b(x40), .O(new_n197_));
  nand3  g114(.a(x41), .b(new_n98_), .c(x09), .O(new_n198_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n93_), .O(z30));
  ...
  nand2  g136(.a(new_n219_), .b(new_n93_), .O(z34));
