...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x37), .O(new_n93_));
  ...
  aoi21  g022(.a(x15), .b(new_n92_), .c(x37), .O(new_n106_));
  aoi21  g023(.a(new_n106_), .b(new_n105_), .c(x10), .O(z04));
  nand2  g024(.a(x07), .b(x03), .O(new_n108_));
  aoi21  g025(.a(x16), .b(new_n92_), .c(x37), .O(new_n109_));
  ...
  aoi21  g052(.a(x24), .b(x08), .c(x37), .O(new_n136_));
  ...
  aoi21  g060(.a(x26), .b(x08), .c(x37), .O(new_n144_));
  ...
  aoi21  g068(.a(x28), .b(x08), .c(x37), .O(new_n152_));
  ...
  aoi21  g076(.a(x30), .b(x08), .c(x37), .O(new_n160_));
  ...
  aoi21  g099(.a(x35), .b(x09), .c(x37), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z23));
  nand2  g101(.a(x35), .b(new_n167_), .O(new_n185_));
  aoi21  g102(.a(x36), .b(x09), .c(x37), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z24));
  nand2  g104(.a(x36), .b(new_n167_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n85_), .c(x10), .O(z25));
  nand4  g106(.a(x38), .b(new_n85_), .c(new_n84_), .d(x09), .O(new_n190_));
  ...
  aoi21  g112(.a(x38), .b(new_n167_), .c(x37), .O(new_n196_));
  ...
  aoi21  g118(.a(new_n201_), .b(x09), .c(x37), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n199_), .c(x10), .O(z28));
  oai21  g120(.a(x14), .b(new_n167_), .c(x40), .O(new_n204_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x37), .O(new_n212_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x37), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n214_), .c(x10), .O(z31));
  oai21  g135(.a(x14), .b(new_n167_), .c(x43), .O(new_n219_));
  ...
  oai21  g140(.a(x14), .b(new_n167_), .c(x44), .O(new_n224_));
  ...
  oai21  g145(.a(x14), .b(new_n167_), .c(x45), .O(new_n229_));
  ...
  nor2   g151(.a(x14), .b(new_n167_), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(x00), .c(x37), .O(new_n236_));
