...
module FAU ( 
  ...
  nand2  g055(.a(x23), .b(new_n126_), .O(new_n139_));
  nand2  g056(.a(x24), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z12));
  nand2  g058(.a(x24), .b(new_n126_), .O(new_n142_));
  ...
  oai21  g100(.a(x36), .b(x10), .c(new_n89_), .O(new_n184_));
  ...
  oai21  g131(.a(x43), .b(x10), .c(new_n89_), .O(new_n215_));
  ...
  nand3  g144(.a(x46), .b(new_n102_), .c(x09), .O(new_n228_));
