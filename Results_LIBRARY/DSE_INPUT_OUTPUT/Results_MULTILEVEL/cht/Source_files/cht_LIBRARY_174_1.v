...
module FAU ( 
  ...
  aoi21  g040(.a(new_n123_), .b(new_n85_), .c(x10), .O(z08));
  nand2  g041(.a(x21), .b(x08), .O(new_n125_));
  aoi21  g042(.a(new_n125_), .b(new_n85_), .c(x10), .O(z09));
  ...
  aoi21  g083(.a(x30), .b(new_n113_), .c(x20), .O(new_n167_));
  ...
  aoi21  g157(.a(new_n240_), .b(x09), .c(x20), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n238_), .c(x10), .O(z34));
  nand2  g159(.a(new_n207_), .b(x46), .O(new_n243_));
  aoi21  g160(.a(new_n228_), .b(x00), .c(x20), .O(new_n244_));
