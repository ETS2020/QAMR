...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n90_, new_n91_,
    ...
    new_n189_, new_n191_, new_n193_, new_n195_, new_n197_;
  ...
  nand3  g031(.a(new_n114_), .b(new_n113_), .c(new_n88_), .O(new_n115_));
  ...
  aoi21  g080(.a(x30), .b(new_n112_), .c(x09), .O(new_n164_));
  aoi21  g081(.a(new_n164_), .b(new_n163_), .c(x10), .O(z19));
  nor2   g082(.a(x10), .b(x09), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(x31), .O(new_n167_));
  inv1   g084(.a(new_n167_), .O(z20));
  nand2  g085(.a(new_n166_), .b(x32), .O(new_n169_));
  inv1   g086(.a(new_n169_), .O(z21));
  inv1   g087(.a(x33), .O(new_n171_));
  aoi21  g088(.a(new_n171_), .b(new_n88_), .c(x10), .O(z22));
  nand2  g089(.a(new_n166_), .b(x34), .O(new_n173_));
  inv1   g090(.a(new_n173_), .O(z23));
  nand2  g091(.a(new_n166_), .b(x35), .O(new_n175_));
  inv1   g092(.a(new_n175_), .O(z24));
  nand2  g093(.a(new_n166_), .b(x36), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z25));
  nand2  g095(.a(new_n166_), .b(x37), .O(new_n179_));
  inv1   g096(.a(new_n179_), .O(z26));
  inv1   g097(.a(x38), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n88_), .c(x10), .O(z27));
  inv1   g099(.a(x39), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n88_), .c(x10), .O(z28));
  nand2  g101(.a(new_n166_), .b(x40), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z29));
  nand2  g103(.a(new_n166_), .b(x41), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(z30));
  nand2  g105(.a(new_n166_), .b(x42), .O(new_n189_));
  inv1   g106(.a(new_n189_), .O(z31));
  inv1   g107(.a(x43), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n88_), .c(x10), .O(z32));
  nand2  g109(.a(new_n166_), .b(x44), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z33));
  inv1   g111(.a(x45), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n88_), .c(x10), .O(z34));
  inv1   g113(.a(x46), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n88_), .c(x10), .O(z35));
endmodule
