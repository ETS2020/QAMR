...
module FAU ( 
  ...
  nand3  g082(.a(new_n165_), .b(new_n84_), .c(x09), .O(new_n166_));
  ...
  nand2  g115(.a(x40), .b(new_n198_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n197_), .c(x09), .O(new_n200_));
  and2   g117(.a(new_n200_), .b(new_n84_), .O(z28));
  ...
  nand2  g129(.a(x43), .b(new_n198_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(x09), .O(new_n214_));
  and2   g131(.a(new_n214_), .b(new_n84_), .O(z31));
  nand2  g132(.a(x43), .b(x14), .O(new_n216_));
  nand2  g133(.a(x44), .b(new_n198_), .O(new_n217_));
  ...
  nand2  g137(.a(x45), .b(new_n198_), .O(new_n221_));
  ...
  nand2  g141(.a(x46), .b(new_n198_), .O(new_n225_));
