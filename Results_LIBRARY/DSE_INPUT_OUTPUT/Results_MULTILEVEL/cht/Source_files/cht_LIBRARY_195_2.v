...
module FAU ( 
  ...
  oai21  g045(.a(new_n96_), .b(new_n112_), .c(new_n128_), .O(new_n129_));
  nand2  g046(.a(new_n129_), .b(new_n91_), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(new_n97_), .O(z11));
  nand2  g048(.a(x24), .b(x08), .O(new_n132_));
  oai21  g049(.a(new_n96_), .b(x08), .c(new_n132_), .O(new_n133_));
  nand2  g050(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  nand2  g051(.a(new_n134_), .b(new_n97_), .O(z12));
  ...
  nand2  g068(.a(new_n151_), .b(new_n97_), .O(z16));
  nand2  g069(.a(x28), .b(new_n112_), .O(new_n153_));
  ...
  nand2  g086(.a(new_n169_), .b(new_n97_), .O(z21));
  ...
  nand2  g090(.a(new_n173_), .b(new_n97_), .O(z22));
  ...
  nand2  g095(.a(new_n178_), .b(new_n97_), .O(z23));
  ...
  nand2  g099(.a(new_n182_), .b(new_n97_), .O(z24));
  ...
  oai21  g114(.a(new_n197_), .b(x10), .c(new_n97_), .O(z27));
  ...
  nand2  g125(.a(new_n208_), .b(new_n97_), .O(z29));
  ...
  nand2  g131(.a(new_n214_), .b(new_n97_), .O(z30));
  ...
  nand2  g140(.a(new_n223_), .b(new_n97_), .O(z32));
  ...
  nand2  g149(.a(new_n232_), .b(new_n97_), .O(z34));
