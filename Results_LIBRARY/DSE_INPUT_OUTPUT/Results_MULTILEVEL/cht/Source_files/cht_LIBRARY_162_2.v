...
module FAU ( 
  ...
  nand2  g110(.a(new_n193_), .b(new_n90_), .O(z24));
  nand2  g111(.a(x36), .b(new_n171_), .O(new_n195_));
  ...
  nor2   g120(.a(new_n89_), .b(x09), .O(new_n204_));
  ...
  aoi21  g135(.a(new_n207_), .b(x09), .c(new_n218_), .O(new_n219_));
  nand3  g136(.a(x43), .b(new_n207_), .c(x09), .O(new_n220_));
  ...
  aoi21  g141(.a(new_n207_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(x44), .b(new_n207_), .c(x09), .O(new_n226_));
  ...
  nand2  g146(.a(new_n208_), .b(x44), .O(new_n230_));
  nand3  g147(.a(x45), .b(new_n207_), .c(x09), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n230_), .c(x10), .O(z33));
  inv1   g149(.a(x45), .O(new_n233_));
  aoi21  g150(.a(new_n207_), .b(x09), .c(new_n233_), .O(new_n234_));
  nand3  g151(.a(x46), .b(new_n207_), .c(x09), .O(new_n235_));
  ...
  nand3  g156(.a(new_n207_), .b(x09), .c(x00), .O(new_n240_));
