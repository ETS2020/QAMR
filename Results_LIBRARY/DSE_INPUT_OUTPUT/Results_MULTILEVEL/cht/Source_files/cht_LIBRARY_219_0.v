...
module FAU ( 
  ...
  nor2   g023(.a(x10), .b(new_n86_), .O(new_n107_));
  nand2  g024(.a(new_n107_), .b(x18), .O(new_n108_));
  inv1   g025(.a(new_n108_), .O(z06));
  nand2  g026(.a(new_n107_), .b(x19), .O(new_n110_));
  inv1   g027(.a(new_n110_), .O(z07));
  inv1   g028(.a(x20), .O(new_n112_));
  aoi21  g029(.a(new_n112_), .b(x08), .c(x10), .O(z08));
  nand2  g030(.a(new_n107_), .b(x21), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z09));
  nand2  g032(.a(new_n107_), .b(x22), .O(new_n116_));
  inv1   g033(.a(new_n116_), .O(z10));
  nand2  g034(.a(new_n107_), .b(x23), .O(new_n118_));
  ...
  nand2  g044(.a(new_n107_), .b(x28), .O(new_n128_));
  ...
  and2   g056(.a(new_n139_), .b(new_n92_), .O(z20));
  ...
  and2   g065(.a(new_n148_), .b(new_n92_), .O(z22));
  ...
  and2   g069(.a(new_n152_), .b(new_n92_), .O(z23));
  ...
  nand3  g073(.a(new_n156_), .b(new_n92_), .c(x08), .O(new_n157_));
  inv1   g074(.a(new_n157_), .O(z24));
  nand2  g075(.a(x37), .b(x09), .O(new_n159_));
  oai21  g076(.a(new_n154_), .b(x09), .c(new_n159_), .O(new_n160_));
  nand3  g077(.a(new_n160_), .b(new_n92_), .c(x08), .O(new_n161_));
  inv1   g078(.a(new_n161_), .O(z25));
  inv1   g079(.a(x38), .O(new_n163_));
  nand2  g080(.a(x37), .b(new_n136_), .O(new_n164_));
  oai21  g081(.a(new_n163_), .b(new_n136_), .c(new_n164_), .O(new_n165_));
  ...
  nand2  g086(.a(x39), .b(new_n169_), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n168_), .c(new_n136_), .O(new_n171_));
  nor2   g088(.a(new_n163_), .b(x09), .O(new_n172_));
  oai21  g089(.a(new_n172_), .b(new_n171_), .c(new_n92_), .O(new_n173_));
  nor2   g090(.a(new_n173_), .b(new_n86_), .O(z27));
  nand2  g091(.a(new_n169_), .b(x09), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(x39), .O(new_n176_));
  nand3  g093(.a(x40), .b(new_n169_), .c(x09), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n92_), .c(x08), .O(new_n179_));
  ...
  aoi21  g100(.a(new_n183_), .b(x09), .c(new_n86_), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n181_), .c(x10), .O(z29));
  inv1   g102(.a(new_n175_), .O(new_n186_));
  nand3  g103(.a(x42), .b(new_n169_), .c(x09), .O(new_n187_));
  oai21  g104(.a(new_n186_), .b(new_n182_), .c(new_n187_), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n92_), .c(x08), .O(new_n189_));
  inv1   g106(.a(new_n189_), .O(z30));
  nand2  g107(.a(new_n175_), .b(x42), .O(new_n191_));
  nand3  g108(.a(x43), .b(new_n169_), .c(x09), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n92_), .c(x08), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z31));
  nand2  g112(.a(new_n175_), .b(x43), .O(new_n196_));
  nand3  g113(.a(x44), .b(new_n169_), .c(x09), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n92_), .c(x08), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  nand2  g117(.a(new_n175_), .b(x44), .O(new_n201_));
  ...
  nand3  g122(.a(x46), .b(new_n169_), .c(x09), .O(new_n206_));
  oai21  g123(.a(new_n186_), .b(new_n202_), .c(new_n206_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n92_), .c(x08), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z34));
  nand2  g126(.a(new_n175_), .b(x46), .O(new_n210_));
  oai21  g127(.a(new_n175_), .b(new_n134_), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n92_), .c(x08), .O(new_n212_));
