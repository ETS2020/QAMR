...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x19), .O(new_n86_));
  ...
  nand3  g081(.a(new_n164_), .b(new_n86_), .c(new_n84_), .O(new_n165_));
  ...
  oai21  g086(.a(new_n169_), .b(x10), .c(new_n86_), .O(z19));
  ...
  nand2  g092(.a(new_n175_), .b(new_n86_), .O(z20));
  ...
  nand2  g096(.a(new_n179_), .b(new_n86_), .O(z21));
  ...
  nand2  g101(.a(new_n184_), .b(new_n86_), .O(z22));
  ...
  nand3  g109(.a(new_n192_), .b(new_n86_), .c(new_n84_), .O(new_n193_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n86_), .O(z25));
  ...
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(new_n171_), .O(new_n206_));
  nor2   g123(.a(new_n199_), .b(x09), .O(new_n207_));
  oai21  g124(.a(new_n207_), .b(new_n206_), .c(new_n86_), .O(new_n208_));
  ...
  nand3  g130(.a(new_n213_), .b(new_n86_), .c(new_n84_), .O(new_n214_));
  ...
  aoi21  g139(.a(new_n210_), .b(x41), .c(new_n222_), .O(new_n223_));
  oai21  g140(.a(new_n223_), .b(x10), .c(new_n86_), .O(z30));
  nand2  g141(.a(new_n210_), .b(new_n85_), .O(new_n225_));
  aoi21  g142(.a(new_n100_), .b(x09), .c(new_n85_), .O(new_n226_));
  aoi21  g143(.a(new_n225_), .b(x43), .c(new_n226_), .O(new_n227_));
  oai21  g144(.a(new_n227_), .b(x10), .c(new_n86_), .O(z31));
  nand3  g145(.a(x44), .b(new_n100_), .c(x09), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(new_n230_));
  aoi21  g147(.a(new_n210_), .b(x43), .c(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(x10), .c(new_n86_), .O(z32));
  nand2  g149(.a(new_n210_), .b(x44), .O(new_n233_));
  ...
  aoi21  g156(.a(new_n210_), .b(x45), .c(new_n239_), .O(new_n240_));
  oai21  g157(.a(new_n240_), .b(x10), .c(new_n86_), .O(z34));
  inv1   g158(.a(x00), .O(new_n242_));
  nand2  g159(.a(new_n210_), .b(x46), .O(new_n243_));
  oai21  g160(.a(new_n210_), .b(new_n242_), .c(new_n243_), .O(new_n244_));
