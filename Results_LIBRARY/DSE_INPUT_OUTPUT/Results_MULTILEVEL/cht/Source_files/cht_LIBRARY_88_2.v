...
module FAU ( 
  ...
  nand2  g061(.a(x26), .b(new_n117_), .O(new_n145_));
  ...
  nand2  g074(.a(x29), .b(new_n117_), .O(new_n158_));
  ...
  nand2  g081(.a(new_n164_), .b(new_n90_), .O(z19));
  ...
  aoi21  g127(.a(new_n200_), .b(x09), .c(new_n210_), .O(new_n211_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n90_), .O(z30));
  aoi21  g132(.a(new_n200_), .b(x09), .c(new_n89_), .O(new_n216_));
  ...
  nand2  g146(.a(new_n206_), .b(x45), .O(new_n230_));
  nand3  g147(.a(x46), .b(new_n200_), .c(x09), .O(new_n231_));
