...
module FAU ( 
  ...
  nand2  g065(.a(x26), .b(new_n121_), .O(new_n149_));
  aoi21  g066(.a(x27), .b(x08), .c(x32), .O(new_n150_));
  aoi21  g067(.a(new_n150_), .b(new_n149_), .c(x10), .O(z15));
  inv1   g068(.a(x28), .O(new_n152_));
  nand2  g069(.a(x27), .b(new_n121_), .O(new_n153_));
  ...
  nand2  g077(.a(x29), .b(new_n121_), .O(new_n161_));
  aoi21  g078(.a(x30), .b(x08), .c(x32), .O(new_n162_));
  ...
  aoi21  g087(.a(new_n170_), .b(new_n85_), .c(x10), .O(z20));
  nand4  g088(.a(x33), .b(new_n85_), .c(new_n84_), .d(x09), .O(new_n172_));
  ...
  aoi21  g116(.a(x38), .b(new_n169_), .c(x32), .O(new_n200_));
  ...
  aoi21  g122(.a(new_n205_), .b(x09), .c(x32), .O(new_n206_));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(x32), .O(new_n216_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x32), .O(new_n226_));
  ...
  aoi21  g152(.a(new_n235_), .b(x09), .c(x32), .O(new_n236_));
  ...
  aoi21  g156(.a(new_n239_), .b(x00), .c(x32), .O(new_n240_));
