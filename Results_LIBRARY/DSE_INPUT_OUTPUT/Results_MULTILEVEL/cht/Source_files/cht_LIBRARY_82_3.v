...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n99_), .O(z13));
  ...
  nand2  g061(.a(x28), .b(new_n107_), .O(new_n145_));
  nand2  g062(.a(x29), .b(x08), .O(new_n146_));
  aoi21  g063(.a(new_n146_), .b(new_n145_), .c(x10), .O(z17));
  oai21  g064(.a(x10), .b(x08), .c(x30), .O(new_n148_));
  nand3  g065(.a(x29), .b(new_n94_), .c(new_n107_), .O(new_n149_));
  nand2  g066(.a(new_n149_), .b(new_n148_), .O(z18));
  inv1   g067(.a(x30), .O(new_n151_));
  nor2   g068(.a(x10), .b(new_n107_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(x00), .O(new_n153_));
  oai21  g070(.a(new_n152_), .b(new_n151_), .c(new_n153_), .O(z19));
  ...
  nand2  g075(.a(new_n158_), .b(new_n99_), .O(z20));
  inv1   g076(.a(x09), .O(new_n160_));
  nand2  g077(.a(x32), .b(new_n160_), .O(new_n161_));
  nand2  g078(.a(x33), .b(x09), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(new_n161_), .c(x10), .O(z21));
  inv1   g080(.a(x34), .O(new_n164_));
  nand2  g081(.a(x33), .b(new_n160_), .O(new_n165_));
  oai21  g082(.a(new_n164_), .b(new_n160_), .c(new_n165_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n94_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n99_), .O(z22));
  ...
  nand2  g088(.a(new_n171_), .b(new_n99_), .O(z23));
  ...
  nand2  g093(.a(new_n176_), .b(new_n99_), .O(z24));
  ...
  oai21  g099(.a(new_n181_), .b(new_n160_), .c(new_n182_), .O(new_n183_));
  ...
  oai21  g107(.a(new_n190_), .b(x10), .c(new_n99_), .O(z27));
  aoi21  g108(.a(new_n95_), .b(x09), .c(new_n186_), .O(new_n192_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n99_), .O(z28));
  ...
  nand2  g134(.a(new_n217_), .b(new_n99_), .O(z33));
