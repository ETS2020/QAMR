...
module FAU ( 
  ...
  aoi21  g029(.a(x18), .b(x08), .c(x27), .O(new_n113_));
  ...
  nand4  g062(.a(new_n92_), .b(x26), .c(new_n91_), .d(new_n111_), .O(new_n146_));
  inv1   g063(.a(new_n146_), .O(z15));
  nand2  g064(.a(x28), .b(x08), .O(new_n148_));
  aoi21  g065(.a(new_n148_), .b(new_n92_), .c(x10), .O(z16));
  ...
  nand3  g073(.a(new_n156_), .b(new_n155_), .c(new_n92_), .O(new_n157_));
  and2   g074(.a(new_n157_), .b(new_n91_), .O(z18));
  ...
  and2   g089(.a(new_n172_), .b(new_n91_), .O(z21));
  ...
  and2   g107(.a(new_n190_), .b(new_n91_), .O(z25));
  ...
  aoi21  g117(.a(x38), .b(new_n169_), .c(x27), .O(new_n201_));
  ...
  nand3  g122(.a(new_n205_), .b(new_n92_), .c(new_n91_), .O(new_n206_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x27), .O(new_n212_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x27), .O(new_n227_));
