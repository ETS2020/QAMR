...
module FAU ( 
  ...
  aoi21  g056(.a(x24), .b(x08), .c(x29), .O(new_n140_));
  ...
  aoi21  g068(.a(x27), .b(x08), .c(x29), .O(new_n152_));
  ...
  aoi21  g076(.a(new_n159_), .b(new_n85_), .c(x10), .O(z17));
  nand2  g077(.a(x30), .b(x08), .O(new_n161_));
  aoi21  g078(.a(new_n161_), .b(new_n85_), .c(x10), .O(z18));
  ...
  aoi21  g120(.a(x38), .b(new_n168_), .c(x29), .O(new_n204_));
  ...
  aoi21  g145(.a(new_n228_), .b(x09), .c(x29), .O(new_n229_));
