...
module FAU ( 
  ...
  nand3  g047(.a(x23), .b(new_n84_), .c(new_n111_), .O(new_n131_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n89_), .O(z20));
  ...
  nand2  g087(.a(new_n170_), .b(new_n89_), .O(z23));
  ...
  nand2  g093(.a(x36), .b(new_n159_), .O(new_n177_));
  nand2  g094(.a(x37), .b(x09), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z25));
  nand2  g096(.a(x37), .b(new_n159_), .O(new_n180_));
  ...
  nand2  g116(.a(new_n196_), .b(x41), .O(new_n200_));
  nand3  g117(.a(x42), .b(new_n190_), .c(x09), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z30));
  inv1   g119(.a(x42), .O(new_n203_));
  aoi21  g120(.a(new_n190_), .b(x09), .c(new_n203_), .O(new_n204_));
  nand3  g121(.a(x43), .b(new_n190_), .c(x09), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(new_n206_));
  oai21  g123(.a(new_n206_), .b(new_n204_), .c(new_n84_), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n89_), .O(z31));
