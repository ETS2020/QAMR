...
module FAU ( 
  ...
  nand2  g012(.a(x11), .b(x10), .O(new_n96_));
  ...
  nand2  g046(.a(new_n129_), .b(new_n96_), .O(z11));
  ...
  nand2  g050(.a(new_n133_), .b(new_n96_), .O(z12));
  ...
  oai21  g059(.a(new_n141_), .b(new_n107_), .c(new_n142_), .O(new_n143_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n96_), .O(z19));
  ...
  nand2  g100(.a(new_n183_), .b(new_n96_), .O(z25));
  inv1   g101(.a(x38), .O(new_n185_));
  nand2  g102(.a(x37), .b(new_n163_), .O(new_n186_));
  oai21  g103(.a(new_n185_), .b(new_n163_), .c(new_n186_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n91_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n96_), .O(z26));
  ...
  nand2  g120(.a(new_n197_), .b(x41), .O(new_n204_));
  nand3  g121(.a(x42), .b(new_n196_), .c(x09), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z30));
  nand2  g123(.a(new_n197_), .b(x42), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n196_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z31));
  inv1   g126(.a(x43), .O(new_n210_));
  aoi21  g127(.a(new_n196_), .b(x09), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(x44), .b(new_n196_), .c(x09), .O(new_n212_));
