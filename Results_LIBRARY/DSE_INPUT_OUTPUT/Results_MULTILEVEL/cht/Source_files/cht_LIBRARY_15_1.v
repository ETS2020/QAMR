...
module FAU ( 
  ...
  oai21  g032(.a(x19), .b(x10), .c(new_n89_), .O(new_n116_));
  nand3  g033(.a(x20), .b(new_n84_), .c(x08), .O(new_n117_));
  ...
  nand2  g050(.a(x25), .b(new_n89_), .O(new_n134_));
  nand2  g051(.a(x26), .b(x08), .O(new_n135_));
  aoi21  g052(.a(new_n135_), .b(new_n134_), .c(x10), .O(z14));
  oai21  g053(.a(x26), .b(x10), .c(new_n89_), .O(new_n137_));
  nand3  g054(.a(x27), .b(new_n84_), .c(x08), .O(new_n138_));
  ...
  nand2  g059(.a(x28), .b(new_n89_), .O(new_n143_));
  ...
  oai21  g065(.a(x30), .b(x10), .c(new_n89_), .O(new_n149_));
  nand3  g066(.a(new_n84_), .b(x08), .c(x00), .O(new_n150_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n90_), .O(z21));
  ...
  nand2  g082(.a(new_n165_), .b(new_n90_), .O(z22));
  ...
  nand2  g095(.a(new_n178_), .b(new_n90_), .O(z25));
  ...
  nand2  g126(.a(new_n209_), .b(new_n90_), .O(z31));
  ...
  nand2  g132(.a(new_n215_), .b(new_n90_), .O(z32));
