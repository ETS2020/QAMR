...
module FAU ( 
  ...
  inv1   g054(.a(x08), .O(new_n138_));
  nand2  g055(.a(x22), .b(new_n138_), .O(new_n139_));
  nand2  g056(.a(x23), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z11));
  nand2  g058(.a(x23), .b(new_n138_), .O(new_n142_));
  ...
  nand2  g066(.a(x25), .b(new_n138_), .O(new_n150_));
  nand2  g067(.a(x26), .b(x08), .O(new_n151_));
  aoi21  g068(.a(new_n151_), .b(new_n150_), .c(x10), .O(z14));
  nand2  g069(.a(x26), .b(new_n138_), .O(new_n153_));
  ...
  nand3  g118(.a(x38), .b(new_n84_), .c(new_n177_), .O(new_n202_));
