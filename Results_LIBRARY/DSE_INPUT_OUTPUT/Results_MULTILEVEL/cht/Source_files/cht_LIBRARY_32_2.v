...
module FAU ( 
  ...
  oai21  g070(.a(new_n152_), .b(new_n116_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g099(.a(new_n182_), .b(new_n90_), .O(z22));
  ...
  aoi21  g130(.a(new_n205_), .b(x09), .c(new_n213_), .O(new_n214_));
  nand3  g131(.a(x42), .b(new_n205_), .c(x09), .O(new_n215_));
  ...
  aoi21  g136(.a(new_n205_), .b(x09), .c(new_n219_), .O(new_n220_));
  nand3  g137(.a(x43), .b(new_n205_), .c(x09), .O(new_n221_));
  ...
  aoi21  g142(.a(new_n205_), .b(x09), .c(new_n225_), .O(new_n226_));
  ...
  aoi21  g151(.a(new_n205_), .b(x09), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(x46), .b(new_n205_), .c(x09), .O(new_n236_));
  inv1   g153(.a(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(new_n235_), .c(new_n84_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n90_), .O(z34));
  nand2  g156(.a(new_n206_), .b(x46), .O(new_n240_));
  nand3  g157(.a(new_n205_), .b(x09), .c(x00), .O(new_n241_));
