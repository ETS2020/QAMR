...
module FAU ( 
  ...
  nand2  g056(.a(x24), .b(new_n119_), .O(new_n140_));
  nand2  g057(.a(x25), .b(x08), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(new_n140_), .c(x10), .O(z13));
  nand2  g059(.a(x25), .b(new_n119_), .O(new_n143_));
  ...
  oai21  g064(.a(new_n146_), .b(new_n119_), .c(new_n147_), .O(new_n148_));
  ...
  nand2  g076(.a(x29), .b(new_n119_), .O(new_n160_));
  ...
  nand2  g115(.a(x38), .b(new_n168_), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z27));
  aoi21  g117(.a(new_n101_), .b(x09), .c(new_n195_), .O(new_n201_));
  ...
  nand2  g137(.a(new_n220_), .b(new_n90_), .O(z31));
  ...
  aoi21  g150(.a(new_n101_), .b(x09), .c(new_n89_), .O(new_n234_));
