...
module FAU ( 
  ...
  and2   g043(.a(new_n126_), .b(new_n89_), .O(z08));
  nand2  g044(.a(x20), .b(new_n123_), .O(new_n128_));
  nand2  g045(.a(x21), .b(x08), .O(new_n129_));
  nand3  g046(.a(new_n129_), .b(new_n128_), .c(new_n88_), .O(new_n130_));
  and2   g047(.a(new_n130_), .b(new_n89_), .O(z09));
  ...
  nand2  g062(.a(x24), .b(new_n123_), .O(new_n146_));
  ...
  nand2  g066(.a(x25), .b(new_n123_), .O(new_n150_));
  ...
  nand2  g070(.a(x26), .b(new_n123_), .O(new_n154_));
  ...
  aoi21  g090(.a(x30), .b(new_n123_), .c(x09), .O(new_n174_));
