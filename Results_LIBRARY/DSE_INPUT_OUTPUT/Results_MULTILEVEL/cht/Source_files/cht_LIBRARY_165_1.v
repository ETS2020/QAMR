...
module FAU ( 
  ...
  nand2  g030(.a(new_n113_), .b(new_n103_), .O(z06));
  ...
  nand2  g037(.a(x19), .b(new_n120_), .O(new_n121_));
  ...
  nand2  g056(.a(x24), .b(new_n120_), .O(new_n140_));
  ...
  nand2  g064(.a(x26), .b(new_n120_), .O(new_n148_));
  nand2  g065(.a(x27), .b(x08), .O(new_n149_));
  aoi21  g066(.a(new_n149_), .b(new_n148_), .c(x10), .O(z15));
  nand2  g067(.a(x27), .b(new_n120_), .O(new_n151_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n103_), .O(z17));
  inv1   g075(.a(x29), .O(new_n159_));
  nand2  g076(.a(x30), .b(x08), .O(new_n160_));
  oai21  g077(.a(new_n159_), .b(x08), .c(new_n160_), .O(new_n161_));
  nand2  g078(.a(new_n161_), .b(new_n97_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(new_n103_), .O(z18));
  inv1   g080(.a(x30), .O(new_n164_));
  nand2  g081(.a(x08), .b(x00), .O(new_n165_));
  oai21  g082(.a(new_n164_), .b(x08), .c(new_n165_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n97_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n103_), .O(z19));
  oai21  g085(.a(x31), .b(x10), .c(new_n102_), .O(new_n169_));
  nand3  g086(.a(x32), .b(new_n97_), .c(x09), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n169_), .O(z20));
  nand2  g088(.a(x32), .b(new_n102_), .O(new_n172_));
  nand2  g089(.a(x33), .b(x09), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n172_), .c(x10), .O(z21));
  oai21  g091(.a(x33), .b(x10), .c(new_n102_), .O(new_n175_));
  nand3  g092(.a(x34), .b(new_n97_), .c(x09), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n175_), .O(z22));
  nand2  g094(.a(x34), .b(new_n102_), .O(new_n178_));
  nand2  g095(.a(x35), .b(x09), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z23));
  nand2  g097(.a(x35), .b(new_n102_), .O(new_n181_));
  ...
  oai21  g132(.a(x44), .b(x10), .c(new_n102_), .O(new_n216_));
  nand2  g133(.a(x44), .b(x14), .O(new_n217_));
  nand3  g134(.a(x45), .b(new_n196_), .c(x09), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n217_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n97_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n216_), .O(z33));
  oai21  g138(.a(x45), .b(x10), .c(new_n102_), .O(new_n222_));
  nand2  g139(.a(x45), .b(x14), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n196_), .c(x09), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n223_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n97_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n222_), .O(z34));
  nand2  g144(.a(new_n197_), .b(x46), .O(new_n228_));
