...
module FAU ( 
  ...
  aoi21  g011(.a(x14), .b(new_n85_), .c(x35), .O(new_n95_));
  aoi21  g012(.a(new_n95_), .b(new_n94_), .c(x10), .O(z03));
  inv1   g013(.a(x10), .O(new_n97_));
  inv1   g014(.a(x35), .O(new_n98_));
  ...
  aoi21  g032(.a(x19), .b(x08), .c(x35), .O(new_n116_));
  ...
  aoi21  g074(.a(x30), .b(x08), .c(x35), .O(new_n158_));
  ...
  nand3  g079(.a(new_n162_), .b(new_n98_), .c(new_n97_), .O(new_n163_));
  ...
  nand3  g094(.a(new_n177_), .b(new_n98_), .c(new_n97_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z22));
  nand2  g096(.a(x34), .b(new_n165_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n98_), .c(x10), .O(z23));
  nand4  g098(.a(x36), .b(new_n98_), .c(new_n97_), .d(x09), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z24));
  nand2  g100(.a(x36), .b(new_n165_), .O(new_n184_));
  nand2  g101(.a(x37), .b(x09), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n184_), .c(new_n98_), .O(new_n186_));
  and2   g103(.a(new_n186_), .b(new_n97_), .O(z25));
  nand2  g104(.a(x37), .b(new_n165_), .O(new_n188_));
  nand2  g105(.a(x38), .b(x09), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n188_), .c(new_n98_), .O(new_n190_));
  and2   g107(.a(new_n190_), .b(new_n97_), .O(z26));
  ...
  aoi21  g149(.a(new_n232_), .b(x09), .c(x35), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n230_), .c(x10), .O(z34));
  oai21  g151(.a(x14), .b(new_n165_), .c(x46), .O(new_n235_));
  nand3  g152(.a(new_n199_), .b(x09), .c(x00), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n98_), .c(new_n97_), .O(new_n238_));
