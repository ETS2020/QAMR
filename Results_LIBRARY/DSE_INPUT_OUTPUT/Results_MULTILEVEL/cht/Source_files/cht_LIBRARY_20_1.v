...
module FAU ( 
  ...
  oai21  g029(.a(x20), .b(x10), .c(new_n103_), .O(new_n113_));
  inv1   g030(.a(x10), .O(new_n114_));
  nand3  g031(.a(x21), .b(new_n114_), .c(x08), .O(new_n115_));
  nand2  g032(.a(new_n115_), .b(new_n113_), .O(z09));
  oai21  g033(.a(x21), .b(x10), .c(new_n103_), .O(new_n117_));
  nand3  g034(.a(x22), .b(new_n114_), .c(x08), .O(new_n118_));
  ...
  oai21  g042(.a(x24), .b(x10), .c(new_n103_), .O(new_n126_));
  nand3  g043(.a(x25), .b(new_n114_), .c(x08), .O(new_n127_));
  nand2  g044(.a(new_n127_), .b(new_n126_), .O(z13));
  oai21  g045(.a(x25), .b(x10), .c(new_n103_), .O(new_n129_));
  nand3  g046(.a(x26), .b(new_n114_), .c(x08), .O(new_n130_));
  ...
  oai21  g054(.a(x28), .b(x10), .c(new_n103_), .O(new_n138_));
  nand3  g055(.a(x29), .b(new_n114_), .c(x08), .O(new_n139_));
  ...
  oai21  g060(.a(x30), .b(x10), .c(new_n103_), .O(new_n144_));
  nand3  g061(.a(new_n114_), .b(x08), .c(x00), .O(new_n145_));
  ...
  nand2  g067(.a(x10), .b(new_n103_), .O(new_n151_));
