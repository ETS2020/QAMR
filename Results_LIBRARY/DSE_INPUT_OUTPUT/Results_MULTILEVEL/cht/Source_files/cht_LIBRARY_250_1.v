...
module FAU ( 
  ...
  nand2  g072(.a(x30), .b(new_n89_), .O(new_n156_));
  ...
  nand2  g103(.a(new_n186_), .b(new_n90_), .O(z26));
  ...
  oai21  g110(.a(new_n193_), .b(x10), .c(new_n90_), .O(z27));
  nand2  g111(.a(new_n102_), .b(x09), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(x39), .O(new_n196_));
  nand3  g113(.a(x40), .b(new_n102_), .c(x09), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z28));
  inv1   g115(.a(x40), .O(new_n199_));
  aoi21  g116(.a(new_n102_), .b(x09), .c(new_n199_), .O(new_n200_));
  nand3  g117(.a(x41), .b(new_n102_), .c(x09), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(new_n202_));
  oai21  g119(.a(new_n202_), .b(new_n200_), .c(new_n84_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n90_), .O(z29));
  ...
  nand3  g135(.a(x46), .b(new_n102_), .c(x09), .O(new_n219_));
  ...
  nand3  g140(.a(new_n102_), .b(x09), .c(x00), .O(new_n224_));
