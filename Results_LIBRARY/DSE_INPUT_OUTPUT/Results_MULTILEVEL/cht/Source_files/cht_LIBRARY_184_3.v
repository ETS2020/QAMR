...
module FAU ( 
  ...
  oai21  g085(.a(x32), .b(new_n168_), .c(x31), .O(new_n169_));
  nand2  g086(.a(x32), .b(x09), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n169_), .c(x10), .O(z20));
  oai21  g088(.a(x10), .b(new_n168_), .c(x32), .O(new_n172_));
  ...
  nand2  g107(.a(x37), .b(new_n168_), .O(new_n191_));
