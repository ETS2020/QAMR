...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n89_), .O(z12));
  ...
  oai21  g072(.a(new_n154_), .b(new_n109_), .c(new_n155_), .O(new_n156_));
  ...
  oai21  g097(.a(x36), .b(new_n163_), .c(x35), .O(new_n181_));
  nand2  g098(.a(x36), .b(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z24));
  oai21  g100(.a(x10), .b(new_n163_), .c(x36), .O(new_n184_));
  ...
  nand2  g118(.a(new_n201_), .b(new_n89_), .O(z28));
  ...
  nand2  g124(.a(new_n207_), .b(new_n89_), .O(z29));
  inv1   g125(.a(x41), .O(new_n209_));
  aoi21  g126(.a(new_n197_), .b(x09), .c(new_n209_), .O(new_n210_));
  ...
  aoi21  g132(.a(new_n197_), .b(x09), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(x43), .b(new_n197_), .c(x09), .O(new_n217_));
  ...
  nand2  g137(.a(new_n197_), .b(x09), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x43), .O(new_n222_));
  nand3  g139(.a(x44), .b(new_n197_), .c(x09), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(new_n222_), .c(x10), .O(z32));
  nand2  g141(.a(new_n221_), .b(x44), .O(new_n225_));
  nand3  g142(.a(x45), .b(new_n197_), .c(x09), .O(new_n226_));
  ...
  nand2  g150(.a(new_n221_), .b(x46), .O(new_n234_));
