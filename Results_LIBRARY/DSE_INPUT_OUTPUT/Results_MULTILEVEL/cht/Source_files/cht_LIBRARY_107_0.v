...
module FAU ( 
  ...
  nand3  g070(.a(new_n153_), .b(new_n92_), .c(x09), .O(new_n154_));
  ...
  nand3  g083(.a(new_n166_), .b(new_n92_), .c(x09), .O(new_n167_));
  ...
  nand3  g102(.a(new_n185_), .b(new_n92_), .c(x09), .O(new_n186_));
  ...
  nand3  g107(.a(new_n190_), .b(new_n92_), .c(x09), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z28));
  inv1   g109(.a(x41), .O(new_n193_));
  nand2  g110(.a(x40), .b(x14), .O(new_n194_));
  ...
  nand2  g126(.a(x44), .b(new_n209_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n208_), .c(x09), .O(new_n211_));
  and2   g128(.a(new_n211_), .b(new_n92_), .O(z32));
