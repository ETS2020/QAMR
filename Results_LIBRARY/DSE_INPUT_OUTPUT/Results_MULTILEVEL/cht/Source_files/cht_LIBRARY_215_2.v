...
module FAU ( 
  ...
  nand2  g100(.a(new_n183_), .b(x35), .O(new_n184_));
  ...
  nand2  g106(.a(new_n183_), .b(x38), .O(new_n190_));
  ...
  nand2  g112(.a(new_n183_), .b(x41), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z30));
  nand2  g114(.a(new_n183_), .b(x42), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z31));
  nand2  g116(.a(new_n183_), .b(x43), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z32));
  inv1   g118(.a(x44), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n84_), .c(x10), .O(z33));
  nand2  g120(.a(new_n183_), .b(x45), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z34));
  nand2  g122(.a(new_n183_), .b(x46), .O(new_n206_));
