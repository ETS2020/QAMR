...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x15), .O(new_n98_));
  aoi21  g015(.a(new_n98_), .b(new_n96_), .c(x10), .O(z02));
  nand2  g016(.a(x07), .b(x01), .O(new_n100_));
  aoi21  g017(.a(x14), .b(new_n97_), .c(x15), .O(new_n101_));
  aoi21  g018(.a(new_n101_), .b(new_n100_), .c(x10), .O(z03));
  nand4  g019(.a(new_n85_), .b(new_n84_), .c(x07), .d(x02), .O(new_n103_));
  inv1   g020(.a(new_n103_), .O(z04));
  nand2  g021(.a(x07), .b(x03), .O(new_n105_));
  aoi21  g022(.a(x16), .b(new_n97_), .c(x15), .O(new_n106_));
  ...
  aoi21  g120(.a(x38), .b(new_n170_), .c(x15), .O(new_n204_));
  ...
  aoi21  g127(.a(new_n210_), .b(x09), .c(x15), .O(new_n211_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x15), .O(new_n226_));
