...
module FAU ( 
  ...
  oai21  g105(.a(new_n188_), .b(x10), .c(new_n90_), .O(z27));
  aoi21  g106(.a(new_n99_), .b(x09), .c(new_n183_), .O(new_n190_));
  ...
  aoi21  g112(.a(new_n99_), .b(x09), .c(new_n195_), .O(new_n196_));
  ...
  aoi21  g118(.a(new_n99_), .b(x09), .c(new_n201_), .O(new_n202_));
  ...
  nand3  g141(.a(new_n99_), .b(x09), .c(x00), .O(new_n225_));
