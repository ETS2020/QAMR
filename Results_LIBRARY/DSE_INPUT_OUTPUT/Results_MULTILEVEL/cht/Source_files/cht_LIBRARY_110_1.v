...
module FAU ( 
  ...
  nand2  g052(.a(x22), .b(new_n126_), .O(new_n136_));
  ...
  nand2  g070(.a(x26), .b(new_n126_), .O(new_n154_));
  ...
  nand2  g089(.a(x30), .b(new_n126_), .O(new_n173_));
  ...
  nand2  g094(.a(x32), .b(new_n93_), .O(new_n178_));
  ...
  nand2  g116(.a(x38), .b(new_n93_), .O(new_n200_));
  ...
  oai21  g128(.a(x41), .b(x10), .c(new_n93_), .O(new_n212_));
  nand2  g129(.a(x41), .b(x14), .O(new_n213_));
  ...
  nand2  g133(.a(new_n216_), .b(new_n212_), .O(z30));
  ...
  oai21  g143(.a(x45), .b(x10), .c(new_n93_), .O(new_n227_));
  ...
  oai21  g149(.a(x46), .b(x10), .c(new_n93_), .O(new_n233_));
