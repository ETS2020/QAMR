...
module FAU ( 
  ...
  aoi21  g024(.a(x15), .b(new_n107_), .c(x25), .O(new_n108_));
  ...
  aoi21  g038(.a(x19), .b(x08), .c(x25), .O(new_n122_));
  ...
  aoi21  g050(.a(x22), .b(x08), .c(x25), .O(new_n134_));
  ...
  aoi21  g062(.a(new_n145_), .b(new_n85_), .c(x10), .O(z13));
  nand4  g063(.a(x26), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n147_));
  ...
  aoi21  g123(.a(x38), .b(new_n171_), .c(x25), .O(new_n207_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x25), .O(new_n218_));
  ...
  aoi21  g159(.a(new_n242_), .b(x09), .c(x25), .O(new_n243_));
  aoi21  g160(.a(new_n243_), .b(new_n240_), .c(x10), .O(z34));
  oai21  g161(.a(x14), .b(new_n171_), .c(x46), .O(new_n245_));
  nand3  g162(.a(new_n101_), .b(x09), .c(x00), .O(new_n246_));
