...
module FAU ( 
  ...
  inv1   g107(.a(new_n180_), .O(new_n191_));
  ...
  nand3  g113(.a(x43), .b(new_n173_), .c(x09), .O(new_n197_));
  ...
  oai21  g123(.a(new_n191_), .b(new_n202_), .c(new_n206_), .O(new_n207_));
  ...
  nand3  g129(.a(new_n212_), .b(new_n89_), .c(x08), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand2  g131(.a(new_n180_), .b(x46), .O(new_n215_));
  aoi21  g132(.a(new_n191_), .b(x00), .c(new_n86_), .O(new_n216_));
