...
module FAU ( 
  ...
  nand3  g042(.a(x20), .b(new_n88_), .c(new_n116_), .O(new_n126_));
  ...
  aoi21  g108(.a(new_n100_), .b(x09), .c(new_n185_), .O(new_n192_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n93_), .O(z28));
