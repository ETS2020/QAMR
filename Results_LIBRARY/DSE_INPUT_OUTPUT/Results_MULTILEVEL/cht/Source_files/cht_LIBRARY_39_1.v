...
module FAU ( 
  ...
  nand2  g035(.a(new_n118_), .b(new_n90_), .O(z08));
  ...
  nand2  g062(.a(x26), .b(new_n108_), .O(new_n146_));
  ...
  oai21  g121(.a(x42), .b(x10), .c(new_n89_), .O(new_n205_));
  ...
  nand2  g126(.a(new_n209_), .b(new_n205_), .O(z31));
  oai21  g127(.a(x43), .b(x10), .c(new_n89_), .O(new_n211_));
  nand2  g128(.a(x43), .b(x14), .O(new_n212_));
  nand3  g129(.a(x44), .b(new_n194_), .c(x09), .O(new_n213_));
  ...
  nand2  g139(.a(new_n195_), .b(x45), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n194_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z34));
  oai21  g142(.a(x46), .b(x10), .c(new_n89_), .O(new_n226_));
  nand3  g143(.a(new_n194_), .b(x09), .c(x00), .O(new_n227_));
