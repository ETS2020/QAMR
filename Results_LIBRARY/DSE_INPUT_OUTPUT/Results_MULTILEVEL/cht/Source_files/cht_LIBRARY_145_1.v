...
module FAU ( 
  ...
  nand2  g083(.a(x30), .b(new_n112_), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z19));
  nand2  g085(.a(x31), .b(new_n89_), .O(new_n169_));
  ...
  nand2  g094(.a(x34), .b(new_n89_), .O(new_n178_));
  ...
  nand2  g112(.a(new_n101_), .b(x09), .O(new_n196_));
  ...
  oai21  g116(.a(x40), .b(x10), .c(new_n89_), .O(new_n200_));
  ...
  nand3  g132(.a(x45), .b(new_n101_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z33));
  oai21  g134(.a(x45), .b(x10), .c(new_n89_), .O(new_n218_));
  nand2  g135(.a(x45), .b(x14), .O(new_n219_));
  nand3  g136(.a(x46), .b(new_n101_), .c(x09), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n219_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n84_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n218_), .O(z34));
