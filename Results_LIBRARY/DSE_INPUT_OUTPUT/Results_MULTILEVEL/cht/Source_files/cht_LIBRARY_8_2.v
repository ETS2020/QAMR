...
module FAU ( 
  ...
  nand2  g101(.a(new_n184_), .b(new_n94_), .O(z24));
  nand2  g102(.a(x36), .b(new_n168_), .O(new_n186_));
  ...
  nand2  g136(.a(new_n198_), .b(new_n93_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(x44), .O(new_n221_));
  nand2  g138(.a(new_n198_), .b(x43), .O(new_n222_));
  ...
  nand2  g146(.a(new_n198_), .b(x45), .O(new_n230_));
