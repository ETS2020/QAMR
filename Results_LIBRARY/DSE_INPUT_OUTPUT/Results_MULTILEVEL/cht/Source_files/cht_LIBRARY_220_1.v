...
module FAU ( 
  ...
  nand2  g138(.a(new_n221_), .b(new_n217_), .O(z34));
  oai21  g139(.a(x46), .b(x10), .c(new_n89_), .O(new_n223_));
  nand3  g140(.a(new_n194_), .b(x09), .c(x00), .O(new_n224_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n223_), .O(z35));
endmodule
