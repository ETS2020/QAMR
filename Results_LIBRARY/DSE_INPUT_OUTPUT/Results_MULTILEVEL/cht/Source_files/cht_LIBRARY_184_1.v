...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n85_), .c(x32), .O(new_n96_));
  aoi21  g013(.a(new_n96_), .b(new_n95_), .c(x10), .O(z02));
  nand2  g014(.a(x07), .b(x01), .O(new_n98_));
  aoi21  g015(.a(x14), .b(new_n85_), .c(x32), .O(new_n99_));
  ...
  aoi21  g035(.a(x20), .b(x08), .c(x32), .O(new_n119_));
  ...
  aoi21  g055(.a(x25), .b(x08), .c(x32), .O(new_n139_));
  ...
  aoi21  g063(.a(x27), .b(x08), .c(x32), .O(new_n147_));
  ...
  aoi21  g075(.a(x30), .b(x08), .c(x32), .O(new_n159_));
  ...
  nand4  g083(.a(new_n89_), .b(x31), .c(new_n88_), .d(new_n166_), .O(new_n167_));
  inv1   g084(.a(new_n167_), .O(z20));
  nand2  g085(.a(x33), .b(x09), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n89_), .c(x10), .O(z21));
  ...
  oai21  g093(.a(new_n175_), .b(new_n166_), .c(new_n176_), .O(new_n177_));
  ...
  aoi21  g113(.a(x38), .b(new_n166_), .c(x32), .O(new_n197_));
  ...
  aoi21  g125(.a(new_n208_), .b(x09), .c(x32), .O(new_n209_));
  ...
  aoi21  g140(.a(new_n223_), .b(x09), .c(x32), .O(new_n224_));
  ...
  aoi21  g150(.a(new_n233_), .b(x09), .c(x32), .O(new_n234_));
