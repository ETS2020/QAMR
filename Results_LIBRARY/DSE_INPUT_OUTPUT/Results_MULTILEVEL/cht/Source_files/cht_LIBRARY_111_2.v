...
module FAU ( 
  ...
  aoi21  g049(.a(new_n132_), .b(new_n97_), .c(x10), .O(z17));
  ...
  nand3  g057(.a(new_n140_), .b(new_n98_), .c(new_n97_), .O(new_n141_));
  ...
  nand3  g080(.a(new_n163_), .b(new_n98_), .c(new_n97_), .O(new_n164_));
  inv1   g081(.a(new_n164_), .O(z25));
  nand2  g082(.a(x37), .b(new_n143_), .O(new_n166_));
  nand2  g083(.a(x38), .b(x09), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n97_), .O(new_n168_));
  ...
  nand2  g130(.a(new_n189_), .b(x00), .O(new_n214_));
