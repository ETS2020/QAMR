...
module FAU ( 
  ...
  nand2  g005(.a(x38), .b(x12), .O(new_n89_));
  ...
  nor2   g010(.a(x38), .b(new_n93_), .O(new_n94_));
  ...
  nand3  g027(.a(new_n110_), .b(new_n89_), .c(new_n84_), .O(new_n111_));
  ...
  nand3  g063(.a(new_n146_), .b(new_n89_), .c(new_n84_), .O(new_n147_));
  ...
  oai21  g072(.a(new_n155_), .b(x10), .c(new_n89_), .O(z14));
  ...
  nand3  g080(.a(new_n163_), .b(new_n89_), .c(new_n84_), .O(new_n164_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n89_), .c(new_n84_), .O(new_n169_));
  ...
  nand2  g105(.a(new_n188_), .b(new_n89_), .O(z21));
  ...
  nand2  g114(.a(new_n197_), .b(new_n89_), .O(z23));
  ...
  nand2  g119(.a(new_n202_), .b(new_n89_), .O(z24));
  nand2  g120(.a(x38), .b(x12), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(x37), .c(x09), .O(new_n205_));
  nand3  g122(.a(new_n89_), .b(x36), .c(new_n180_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z25));
  nand3  g124(.a(new_n89_), .b(x37), .c(new_n180_), .O(new_n208_));
  nand3  g125(.a(x38), .b(new_n93_), .c(x09), .O(new_n209_));
  ...
  aoi21  g134(.a(new_n103_), .b(x09), .c(new_n211_), .O(new_n218_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n89_), .O(z29));
  ...
  nand3  g148(.a(new_n231_), .b(new_n89_), .c(new_n84_), .O(new_n232_));
  ...
  nand2  g155(.a(new_n238_), .b(new_n89_), .O(z31));
  ...
  nand3  g159(.a(new_n242_), .b(new_n89_), .c(new_n84_), .O(new_n243_));
  ...
  nand2  g166(.a(new_n249_), .b(new_n89_), .O(z33));
  ...
  nand3  g170(.a(new_n253_), .b(new_n89_), .c(new_n84_), .O(new_n254_));
