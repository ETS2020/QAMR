...
module FAU ( 
  ...
  nand2  g003(.a(x42), .b(x35), .O(new_n87_));
  ...
  nor2   g107(.a(x42), .b(new_n190_), .O(new_n191_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n195_), .c(x35), .O(new_n198_));
  nand3  g115(.a(x36), .b(new_n190_), .c(x09), .O(new_n199_));
  ...
  nand2  g122(.a(x37), .b(new_n174_), .O(new_n206_));
  oai21  g123(.a(new_n205_), .b(new_n174_), .c(new_n206_), .O(new_n207_));
  ...
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(new_n174_), .O(new_n212_));
  ...
  nand3  g144(.a(new_n227_), .b(x42), .c(new_n190_), .O(new_n228_));
  nand3  g145(.a(new_n216_), .b(new_n195_), .c(x41), .O(new_n229_));
  ...
  nand3  g154(.a(new_n237_), .b(new_n87_), .c(new_n89_), .O(new_n238_));
  ...
  nand2  g167(.a(new_n250_), .b(new_n89_), .O(new_n251_));
