...
module FAU ( 
  ...
  nand2  g091(.a(x39), .b(new_n98_), .O(new_n175_));
  ...
  nand3  g098(.a(x40), .b(new_n98_), .c(x09), .O(new_n182_));
  ...
  nand3  g103(.a(x41), .b(new_n98_), .c(x09), .O(new_n187_));
  ...
  nand3  g108(.a(x42), .b(new_n98_), .c(x09), .O(new_n192_));
  ...
  inv1   g122(.a(new_n180_), .O(new_n206_));
  ...
  aoi21  g133(.a(new_n206_), .b(x00), .c(x08), .O(new_n217_));
