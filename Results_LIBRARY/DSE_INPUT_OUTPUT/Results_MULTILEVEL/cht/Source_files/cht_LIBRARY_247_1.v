...
module FAU ( 
  ...
  aoi21  g125(.a(x38), .b(new_n174_), .c(x12), .O(new_n209_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x12), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n212_), .c(x10), .O(z28));
  oai21  g133(.a(x14), .b(new_n174_), .c(x40), .O(new_n217_));
  ...
  oai21  g158(.a(x14), .b(new_n174_), .c(x45), .O(new_n242_));
  ...
  nor2   g164(.a(x14), .b(new_n174_), .O(new_n248_));
