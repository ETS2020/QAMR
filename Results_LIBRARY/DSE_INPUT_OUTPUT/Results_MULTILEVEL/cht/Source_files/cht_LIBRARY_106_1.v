...
module FAU ( 
  ...
  nand2  g002(.a(x30), .b(new_n85_), .O(new_n86_));
  ...
  nand2  g045(.a(new_n128_), .b(new_n86_), .O(z08));
  ...
  nand2  g072(.a(new_n155_), .b(new_n86_), .O(z14));
  inv1   g073(.a(x27), .O(new_n157_));
  nand2  g074(.a(x26), .b(new_n116_), .O(new_n158_));
  oai21  g075(.a(new_n157_), .b(new_n116_), .c(new_n158_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n84_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n86_), .O(z15));
  ...
  nand2  g091(.a(x30), .b(x19), .O(new_n175_));
  oai21  g092(.a(x30), .b(new_n116_), .c(new_n175_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(x00), .O(new_n177_));
  nand3  g094(.a(x30), .b(x19), .c(new_n116_), .O(new_n178_));
  ...
  aoi21  g151(.a(new_n102_), .b(x09), .c(new_n234_), .O(new_n235_));
  ...
  nand2  g155(.a(new_n238_), .b(new_n86_), .O(z31));
  ...
  oai21  g161(.a(x14), .b(new_n180_), .c(x44), .O(new_n245_));
