...
module FAU ( 
  ...
  nand2  g031(.a(new_n114_), .b(new_n97_), .O(z06));
  ...
  oai21  g054(.a(new_n136_), .b(new_n110_), .c(new_n137_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n91_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(new_n97_), .O(z12));
  ...
  nand2  g065(.a(new_n148_), .b(new_n97_), .O(z14));
  ...
  nand2  g073(.a(new_n156_), .b(new_n97_), .O(z16));
  ...
  nand2  g094(.a(new_n177_), .b(new_n97_), .O(z22));
  ...
  nand2  g103(.a(x36), .b(new_n167_), .O(new_n187_));
  ...
  nand2  g110(.a(new_n193_), .b(new_n97_), .O(z26));
  ...
  nand2  g115(.a(x38), .b(new_n167_), .O(new_n199_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n97_), .O(z29));
  ...
  nand3  g132(.a(x43), .b(new_n201_), .c(x09), .O(new_n216_));
  ...
  aoi21  g138(.a(new_n201_), .b(x09), .c(new_n221_), .O(new_n222_));
  ...
  nand2  g142(.a(new_n225_), .b(new_n97_), .O(z33));
  nand2  g143(.a(new_n202_), .b(x45), .O(new_n227_));
  nand3  g144(.a(x46), .b(new_n201_), .c(x09), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z34));
  nand2  g146(.a(new_n202_), .b(x46), .O(new_n230_));
  nand3  g147(.a(new_n201_), .b(x09), .c(x00), .O(new_n231_));
