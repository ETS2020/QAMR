...
module FAU ( 
  ...
  nand2  g065(.a(x27), .b(new_n117_), .O(new_n149_));
  ...
  oai21  g071(.a(x30), .b(new_n117_), .c(x29), .O(new_n155_));
  ...
  nand2  g101(.a(x36), .b(new_n168_), .O(new_n185_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n94_), .O(z31));
  ...
  nand2  g141(.a(new_n224_), .b(new_n94_), .O(z33));
  ...
  nand2  g147(.a(new_n230_), .b(new_n94_), .O(z34));
  ...
  nand2  g153(.a(new_n236_), .b(new_n94_), .O(z35));
endmodule
