...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x36), .O(new_n86_));
  ...
  nor2   g112(.a(x36), .b(x09), .O(new_n196_));
  inv1   g113(.a(x36), .O(new_n197_));
  nor2   g114(.a(new_n85_), .b(new_n197_), .O(new_n198_));
  oai21  g115(.a(new_n198_), .b(new_n196_), .c(x35), .O(new_n199_));
  ...
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(new_n177_), .O(new_n213_));
  ...
  oai21  g137(.a(new_n220_), .b(x10), .c(new_n86_), .O(z28));
  nand3  g138(.a(x41), .b(new_n102_), .c(x09), .O(new_n222_));
  inv1   g139(.a(new_n222_), .O(new_n223_));
  aoi21  g140(.a(new_n217_), .b(x40), .c(new_n223_), .O(new_n224_));
  oai21  g141(.a(new_n224_), .b(x10), .c(new_n86_), .O(z29));
  nand3  g142(.a(x42), .b(new_n102_), .c(x09), .O(new_n226_));
  inv1   g143(.a(new_n226_), .O(new_n227_));
  aoi21  g144(.a(new_n217_), .b(x41), .c(new_n227_), .O(new_n228_));
  oai21  g145(.a(new_n228_), .b(x10), .c(new_n86_), .O(z30));
  nand3  g146(.a(new_n197_), .b(new_n102_), .c(x09), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(new_n198_), .c(x43), .O(new_n232_));
  nand2  g149(.a(new_n217_), .b(x42), .O(new_n233_));
  ...
  aoi21  g153(.a(new_n217_), .b(x43), .c(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(x10), .c(new_n86_), .O(z32));
  nand3  g155(.a(x45), .b(new_n102_), .c(x09), .O(new_n239_));
  inv1   g156(.a(new_n239_), .O(new_n240_));
  aoi21  g157(.a(new_n217_), .b(x44), .c(new_n240_), .O(new_n241_));
  oai21  g158(.a(new_n241_), .b(x10), .c(new_n86_), .O(z33));
  nand3  g159(.a(x46), .b(new_n102_), .c(x09), .O(new_n243_));
  inv1   g160(.a(new_n243_), .O(new_n244_));
  aoi21  g161(.a(new_n217_), .b(x45), .c(new_n244_), .O(new_n245_));
  oai21  g162(.a(new_n245_), .b(x10), .c(new_n86_), .O(z34));
