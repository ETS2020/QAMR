...
module FAU ( 
  ...
  nand3  g051(.a(new_n134_), .b(new_n95_), .c(new_n94_), .O(new_n135_));
  inv1   g052(.a(new_n135_), .O(z13));
  nand2  g053(.a(x25), .b(new_n109_), .O(new_n137_));
  aoi21  g054(.a(x26), .b(x08), .c(x36), .O(new_n138_));
  ...
  aoi21  g104(.a(x38), .b(new_n160_), .c(x36), .O(new_n188_));
  ...
  aoi21  g115(.a(new_n198_), .b(x09), .c(x36), .O(new_n199_));
  ...
  aoi21  g135(.a(new_n218_), .b(x09), .c(x36), .O(new_n219_));
  ...
  aoi21  g144(.a(new_n227_), .b(x00), .c(x36), .O(new_n228_));
