...
module FAU ( 
  ...
  nand2  g050(.a(new_n133_), .b(new_n97_), .O(z11));
  ...
  nand2  g063(.a(new_n146_), .b(new_n97_), .O(z14));
  ...
  oai21  g098(.a(x36), .b(x10), .c(new_n96_), .O(new_n182_));
  nand3  g099(.a(x37), .b(new_n91_), .c(x09), .O(new_n183_));
