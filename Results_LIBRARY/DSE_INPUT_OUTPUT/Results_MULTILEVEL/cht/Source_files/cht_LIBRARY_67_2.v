...
module FAU ( 
  ...
  oai21  g037(.a(new_n120_), .b(x10), .c(new_n86_), .O(z07));
  ...
  aoi21  g134(.a(new_n100_), .b(x09), .c(new_n211_), .O(new_n218_));
  ...
  nand2  g138(.a(new_n221_), .b(new_n86_), .O(z28));
  ...
  nand3  g157(.a(new_n206_), .b(new_n100_), .c(x09), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n85_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(x44), .O(new_n243_));
  oai21  g160(.a(x14), .b(new_n178_), .c(x43), .O(new_n244_));
  ...
  nand2  g178(.a(new_n261_), .b(new_n86_), .O(z35));
endmodule
