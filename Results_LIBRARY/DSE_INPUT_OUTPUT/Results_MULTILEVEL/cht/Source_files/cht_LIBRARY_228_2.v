...
module FAU ( 
  ...
  nand2  g057(.a(new_n140_), .b(new_n90_), .O(z11));
  ...
  aoi21  g121(.a(new_n202_), .b(x09), .c(new_n204_), .O(new_n205_));
  ...
  aoi21  g129(.a(new_n207_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x41), .b(new_n207_), .c(x09), .O(new_n214_));
  ...
  aoi21  g156(.a(new_n207_), .b(x09), .c(new_n239_), .O(new_n240_));
  nand3  g157(.a(new_n207_), .b(x09), .c(x00), .O(new_n241_));
