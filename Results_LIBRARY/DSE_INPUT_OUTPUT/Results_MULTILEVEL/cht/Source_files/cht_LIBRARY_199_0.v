...
module FAU ( 
  ...
  nand3  g009(.a(new_n92_), .b(x46), .c(new_n89_), .O(new_n93_));
  ...
  nand3  g020(.a(new_n103_), .b(x46), .c(new_n89_), .O(new_n104_));
  ...
  nand3  g062(.a(new_n145_), .b(x46), .c(new_n89_), .O(new_n146_));
  ...
  nand3  g076(.a(new_n159_), .b(x46), .c(new_n89_), .O(new_n160_));
  inv1   g077(.a(new_n160_), .O(z18));
  nand2  g078(.a(x08), .b(x00), .O(new_n162_));
  aoi21  g079(.a(x30), .b(new_n109_), .c(new_n86_), .O(new_n163_));
  ...
  oai21  g115(.a(new_n198_), .b(new_n196_), .c(x46), .O(new_n199_));
  ...
  nand3  g126(.a(new_n209_), .b(x46), .c(new_n89_), .O(new_n210_));
  ...
  nand3  g140(.a(new_n223_), .b(x46), .c(new_n89_), .O(new_n224_));
  ...
  nand3  g145(.a(new_n228_), .b(x46), .c(new_n89_), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(z33));
  nor2   g147(.a(new_n86_), .b(x45), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n201_), .c(x10), .O(z34));
  nor2   g149(.a(new_n165_), .b(x00), .O(new_n233_));
  nor2   g150(.a(new_n86_), .b(x14), .O(new_n234_));
