...
module FAU ( 
  ...
  nand2  g095(.a(x34), .b(new_n168_), .O(new_n179_));
  ...
  nand2  g102(.a(new_n185_), .b(new_n94_), .O(z24));
  nand2  g103(.a(x36), .b(new_n168_), .O(new_n187_));
  oai21  g104(.a(new_n93_), .b(new_n168_), .c(new_n187_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n88_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n94_), .O(z25));
  oai21  g107(.a(x38), .b(new_n168_), .c(x37), .O(new_n191_));
  ...
  oai21  g116(.a(new_n199_), .b(x10), .c(new_n94_), .O(z27));
