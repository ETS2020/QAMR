...
module FAU ( 
  ...
  nor2   g023(.a(new_n85_), .b(x07), .O(new_n107_));
  ...
  oai21  g118(.a(new_n86_), .b(x09), .c(new_n201_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n84_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n87_), .O(z26));
  nand2  g121(.a(x14), .b(x00), .O(new_n205_));
  nand2  g122(.a(x39), .b(new_n102_), .O(new_n206_));
  ...
  nand2  g133(.a(new_n216_), .b(new_n87_), .O(z28));
  ...
  nand2  g143(.a(new_n226_), .b(new_n87_), .O(z30));
