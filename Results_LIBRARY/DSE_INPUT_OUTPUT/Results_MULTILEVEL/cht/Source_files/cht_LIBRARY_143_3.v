...
module FAU ( 
  ...
  oai21  g053(.a(x10), .b(x08), .c(x24), .O(new_n137_));
  nand3  g054(.a(x23), .b(new_n88_), .c(new_n111_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n137_), .O(z12));
  ...
  nand2  g066(.a(new_n149_), .b(new_n93_), .O(z15));
  ...
  nand2  g079(.a(x30), .b(new_n111_), .O(new_n163_));
  ...
  nand2  g085(.a(new_n168_), .b(new_n93_), .O(z20));
  ...
  nand2  g094(.a(new_n177_), .b(new_n93_), .O(z22));
  ...
  nand2  g102(.a(new_n185_), .b(new_n93_), .O(z24));
  ...
  oai21  g109(.a(new_n191_), .b(new_n170_), .c(new_n192_), .O(new_n193_));
