...
module FAU ( 
  ...
  nand2  g014(.a(x39), .b(x13), .O(new_n98_));
  oai21  g015(.a(x13), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g016(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g017(.a(x39), .b(x13), .c(new_n97_), .O(new_n101_));
  ...
  oai21  g037(.a(new_n120_), .b(x10), .c(new_n90_), .O(z06));
  ...
  oai21  g065(.a(new_n148_), .b(x10), .c(new_n90_), .O(z12));
  ...
  nand3  g074(.a(new_n157_), .b(new_n90_), .c(new_n84_), .O(new_n158_));
  ...
  oai21  g079(.a(new_n162_), .b(x10), .c(new_n90_), .O(z15));
  ...
  inv1   g132(.a(x13), .O(new_n216_));
  aoi21  g133(.a(x14), .b(new_n216_), .c(x39), .O(new_n217_));
  nand2  g134(.a(x39), .b(new_n103_), .O(new_n218_));
  oai21  g135(.a(new_n217_), .b(new_n215_), .c(new_n218_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(x09), .O(new_n220_));
  nand3  g137(.a(new_n90_), .b(x38), .c(new_n182_), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z27));
  nand3  g139(.a(new_n103_), .b(new_n216_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n89_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(x40), .O(new_n225_));
  oai21  g142(.a(x14), .b(new_n182_), .c(x39), .O(new_n226_));
  aoi21  g143(.a(new_n226_), .b(new_n225_), .c(x10), .O(z28));
  inv1   g144(.a(x40), .O(new_n228_));
  nor2   g145(.a(x14), .b(new_n182_), .O(new_n229_));
  nand3  g146(.a(x41), .b(new_n103_), .c(x09), .O(new_n230_));
  oai21  g147(.a(new_n229_), .b(new_n228_), .c(new_n230_), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n84_), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n90_), .O(z29));
  inv1   g150(.a(x41), .O(new_n234_));
  nand3  g151(.a(x42), .b(new_n103_), .c(x09), .O(new_n235_));
  oai21  g152(.a(new_n229_), .b(new_n234_), .c(new_n235_), .O(new_n236_));
  nand3  g153(.a(new_n236_), .b(new_n90_), .c(new_n84_), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(z30));
  inv1   g155(.a(x42), .O(new_n239_));
  nand3  g156(.a(x43), .b(new_n103_), .c(x09), .O(new_n240_));
  oai21  g157(.a(new_n229_), .b(new_n239_), .c(new_n240_), .O(new_n241_));
  nand3  g158(.a(new_n241_), .b(new_n90_), .c(new_n84_), .O(new_n242_));
  inv1   g159(.a(new_n242_), .O(z31));
  inv1   g160(.a(x43), .O(new_n244_));
  nand3  g161(.a(x44), .b(new_n103_), .c(x09), .O(new_n245_));
  oai21  g162(.a(new_n229_), .b(new_n244_), .c(new_n245_), .O(new_n246_));
  ...
  oai21  g167(.a(new_n229_), .b(new_n249_), .c(new_n250_), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(new_n84_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(new_n90_), .O(z33));
  inv1   g170(.a(x45), .O(new_n254_));
  nand3  g171(.a(x46), .b(new_n103_), .c(x09), .O(new_n255_));
  oai21  g172(.a(new_n229_), .b(new_n254_), .c(new_n255_), .O(new_n256_));
  nand2  g173(.a(new_n256_), .b(new_n84_), .O(new_n257_));
  nand2  g174(.a(new_n257_), .b(new_n90_), .O(z34));
  inv1   g175(.a(x46), .O(new_n259_));
  nand3  g176(.a(new_n103_), .b(x09), .c(x00), .O(new_n260_));
  oai21  g177(.a(new_n229_), .b(new_n259_), .c(new_n260_), .O(new_n261_));
