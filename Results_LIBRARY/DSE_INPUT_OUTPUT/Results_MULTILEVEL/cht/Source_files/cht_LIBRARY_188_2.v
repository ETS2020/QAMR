...
module FAU ( 
  ...
  oai21  g062(.a(new_n145_), .b(x10), .c(new_n86_), .O(z12));
  ...
  aoi21  g067(.a(new_n85_), .b(new_n147_), .c(x08), .O(new_n151_));
  ...
  nand2  g156(.a(new_n239_), .b(new_n86_), .O(z32));
  ...
  nand2  g171(.a(new_n254_), .b(new_n86_), .O(z35));
endmodule
