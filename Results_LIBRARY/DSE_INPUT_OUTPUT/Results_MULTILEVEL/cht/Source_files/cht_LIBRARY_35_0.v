...
module FAU ( 
  ...
  nand2  g072(.a(x34), .b(new_n147_), .O(new_n156_));
  ...
  oai21  g078(.a(new_n160_), .b(new_n147_), .c(new_n161_), .O(new_n162_));
  ...
  nand3  g083(.a(new_n166_), .b(new_n84_), .c(x08), .O(new_n167_));
  ...
  oai21  g096(.a(x14), .b(new_n147_), .c(x39), .O(new_n180_));
  ...
  oai21  g122(.a(x14), .b(new_n147_), .c(x44), .O(new_n206_));
  nand3  g123(.a(x45), .b(new_n98_), .c(x09), .O(new_n207_));
  ...
  oai21  g132(.a(x14), .b(new_n147_), .c(x46), .O(new_n216_));
