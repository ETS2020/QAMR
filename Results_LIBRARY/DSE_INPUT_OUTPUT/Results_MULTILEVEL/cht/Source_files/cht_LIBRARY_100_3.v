...
module FAU ( 
  ...
  nand2  g060(.a(new_n143_), .b(new_n89_), .O(z15));
  ...
  aoi21  g111(.a(new_n100_), .b(x09), .c(new_n189_), .O(new_n195_));
  ...
  oai21  g146(.a(x14), .b(new_n162_), .c(x45), .O(new_n230_));
