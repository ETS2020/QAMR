...
module FAU ( 
  ...
  nor2   g038(.a(new_n85_), .b(x08), .O(new_n122_));
  ...
  nand2  g096(.a(new_n179_), .b(new_n87_), .O(z21));
  ...
  nand2  g121(.a(x39), .b(new_n101_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(new_n171_), .O(new_n206_));
  nor2   g123(.a(new_n199_), .b(x09), .O(new_n207_));
  oai21  g124(.a(new_n207_), .b(new_n206_), .c(new_n87_), .O(new_n208_));
  ...
  nand3  g130(.a(new_n213_), .b(new_n87_), .c(new_n84_), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(z28));
  nand2  g132(.a(new_n210_), .b(x40), .O(new_n216_));
  nand3  g133(.a(x41), .b(new_n101_), .c(x09), .O(new_n217_));
  ...
  oai21  g140(.a(new_n223_), .b(x10), .c(new_n87_), .O(z30));
  nand2  g141(.a(new_n210_), .b(new_n86_), .O(new_n225_));
  aoi21  g142(.a(new_n101_), .b(x09), .c(new_n86_), .O(new_n226_));
  aoi21  g143(.a(new_n225_), .b(x43), .c(new_n226_), .O(new_n227_));
  oai21  g144(.a(new_n227_), .b(x10), .c(new_n87_), .O(z31));
  ...
  oai21  g148(.a(new_n231_), .b(x10), .c(new_n87_), .O(z32));
  ...
  oai21  g157(.a(new_n240_), .b(x10), .c(new_n87_), .O(z34));
