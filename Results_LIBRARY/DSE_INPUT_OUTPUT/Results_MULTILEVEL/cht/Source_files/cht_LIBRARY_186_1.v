...
module FAU ( 
  ...
  nand2  g032(.a(new_n115_), .b(new_n100_), .O(z07));
  ...
  nand2  g037(.a(new_n120_), .b(new_n100_), .O(z08));
  ...
  nand2  g077(.a(new_n160_), .b(new_n100_), .O(z16));
  ...
  nand3  g113(.a(new_n196_), .b(new_n94_), .c(x09), .O(new_n197_));
  oai21  g114(.a(x38), .b(x10), .c(new_n99_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n197_), .O(z27));
  nand2  g116(.a(new_n95_), .b(x09), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(x39), .O(new_n201_));
  nand3  g118(.a(x40), .b(new_n95_), .c(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z28));
  oai21  g120(.a(x40), .b(x10), .c(new_n99_), .O(new_n204_));
  nand2  g121(.a(x40), .b(x14), .O(new_n205_));
  nand3  g122(.a(x41), .b(new_n95_), .c(x09), .O(new_n206_));
  ...
  oai21  g126(.a(x41), .b(x10), .c(new_n99_), .O(new_n210_));
  nand2  g127(.a(x41), .b(x14), .O(new_n211_));
  nand3  g128(.a(x42), .b(new_n95_), .c(x09), .O(new_n212_));
  ...
  oai21  g132(.a(x42), .b(x10), .c(new_n99_), .O(new_n216_));
  ...
  nand2  g138(.a(new_n200_), .b(x43), .O(new_n222_));
  ...
  nand3  g142(.a(x45), .b(new_n95_), .c(x09), .O(new_n226_));
  ...
  nand3  g148(.a(new_n95_), .b(x09), .c(x00), .O(new_n232_));
