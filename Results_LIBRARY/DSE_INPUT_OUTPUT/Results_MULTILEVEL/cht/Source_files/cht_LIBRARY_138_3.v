...
module FAU ( 
  ...
  nand2  g005(.a(x10), .b(x05), .O(new_n89_));
  nand2  g006(.a(new_n89_), .b(new_n88_), .O(z00));
  oai21  g007(.a(x12), .b(x07), .c(x05), .O(new_n91_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n89_), .O(z13));
  ...
  nand2  g097(.a(x34), .b(new_n173_), .O(new_n181_));
  oai21  g098(.a(new_n180_), .b(new_n173_), .c(new_n181_), .O(new_n182_));
  ...
  nand2  g105(.a(x36), .b(new_n173_), .O(new_n189_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n89_), .O(z26));
  ...
  oai21  g118(.a(new_n201_), .b(x10), .c(new_n89_), .O(z27));
  aoi21  g119(.a(new_n98_), .b(x09), .c(new_n197_), .O(new_n203_));
  ...
  nand2  g136(.a(new_n98_), .b(x09), .O(new_n220_));
  ...
  nand2  g158(.a(new_n220_), .b(x46), .O(new_n242_));
