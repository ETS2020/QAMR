...
module FAU ( 
  ...
  nand2  g047(.a(new_n130_), .b(new_n89_), .O(z11));
  ...
  nand2  g073(.a(new_n156_), .b(new_n89_), .O(z18));
  ...
  nand2  g078(.a(new_n161_), .b(new_n89_), .O(z19));
  ...
  oai21  g083(.a(x10), .b(x09), .c(x33), .O(new_n167_));
  nand3  g084(.a(x32), .b(new_n84_), .c(new_n163_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n167_), .O(z21));
  ...
  nand2  g100(.a(x37), .b(new_n163_), .O(new_n184_));
  ...
  nand2  g107(.a(x38), .b(new_n163_), .O(new_n191_));
  ...
  aoi21  g120(.a(new_n193_), .b(x09), .c(new_n203_), .O(new_n204_));
  nand3  g121(.a(x42), .b(new_n193_), .c(x09), .O(new_n205_));
  ...
  aoi21  g129(.a(new_n193_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x44), .b(new_n193_), .c(x09), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(new_n84_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n89_), .O(z32));
  nand2  g134(.a(new_n199_), .b(x44), .O(new_n218_));
  ...
  aoi21  g141(.a(new_n193_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(new_n193_), .b(x09), .c(x00), .O(new_n226_));
  inv1   g143(.a(new_n226_), .O(new_n227_));
  oai21  g144(.a(new_n227_), .b(new_n225_), .c(new_n84_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n89_), .O(z35));
endmodule
