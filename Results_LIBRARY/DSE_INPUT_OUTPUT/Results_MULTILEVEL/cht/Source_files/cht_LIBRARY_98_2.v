...
module FAU ( 
  ...
  oai21  g089(.a(new_n89_), .b(x09), .c(new_n172_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n84_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n90_), .O(z22));
  nand2  g092(.a(x34), .b(new_n165_), .O(new_n176_));
  ...
  oai21  g113(.a(new_n196_), .b(x10), .c(new_n90_), .O(z27));
  aoi21  g114(.a(new_n99_), .b(x09), .c(new_n191_), .O(new_n198_));
  ...
  nand2  g125(.a(new_n99_), .b(x09), .O(new_n209_));
  ...
  nand3  g130(.a(x43), .b(new_n99_), .c(x09), .O(new_n214_));
  ...
  nand3  g145(.a(x46), .b(new_n99_), .c(x09), .O(new_n229_));
