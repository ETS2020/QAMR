...
module FAU ( 
  ...
  oai21  g012(.a(x13), .b(x07), .c(x06), .O(new_n96_));
  ...
  nand2  g117(.a(x38), .b(new_n167_), .O(new_n201_));
  ...
  nand2  g141(.a(new_n224_), .b(new_n89_), .O(z31));
  ...
  nand2  g148(.a(new_n100_), .b(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(x44), .O(new_n233_));
  nand3  g150(.a(x45), .b(new_n100_), .c(x09), .O(new_n234_));
  aoi21  g151(.a(new_n234_), .b(new_n233_), .c(x10), .O(z33));
  nand2  g152(.a(new_n232_), .b(x45), .O(new_n236_));
  nand3  g153(.a(x46), .b(new_n100_), .c(x09), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z34));
  nand2  g155(.a(new_n232_), .b(x46), .O(new_n239_));
  nand3  g156(.a(new_n100_), .b(x09), .c(x00), .O(new_n240_));
