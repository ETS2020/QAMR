...
module FAU ( 
  ...
  nand2  g001(.a(x25), .b(x23), .O(new_n85_));
  ...
  nand2  g054(.a(x25), .b(x23), .O(new_n138_));
  nand3  g055(.a(new_n138_), .b(x22), .c(new_n114_), .O(new_n139_));
  inv1   g056(.a(x23), .O(new_n140_));
  nor2   g057(.a(x25), .b(new_n140_), .O(new_n141_));
  nand2  g058(.a(new_n141_), .b(x08), .O(new_n142_));
  aoi21  g059(.a(new_n142_), .b(new_n139_), .c(x10), .O(z11));
  nand3  g060(.a(new_n138_), .b(x24), .c(x08), .O(new_n144_));
  nand2  g061(.a(new_n141_), .b(new_n114_), .O(new_n145_));
  aoi21  g062(.a(new_n145_), .b(new_n144_), .c(x10), .O(z12));
  inv1   g063(.a(x25), .O(new_n147_));
  nand2  g064(.a(x24), .b(new_n114_), .O(new_n148_));
  ...
  nand3  g070(.a(new_n153_), .b(x25), .c(new_n140_), .O(new_n154_));
  nand3  g071(.a(x26), .b(new_n147_), .c(x08), .O(new_n155_));
  ...
  nand2  g078(.a(x27), .b(new_n114_), .O(new_n162_));
  oai21  g079(.a(new_n161_), .b(new_n114_), .c(new_n162_), .O(new_n163_));
  ...
  nand2  g087(.a(x29), .b(new_n114_), .O(new_n171_));
  oai21  g088(.a(new_n170_), .b(new_n114_), .c(new_n171_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n84_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n85_), .O(z18));
  nand2  g091(.a(x08), .b(x00), .O(new_n175_));
  oai21  g092(.a(new_n170_), .b(x08), .c(new_n175_), .O(new_n176_));
  ...
  nor2   g135(.a(x14), .b(new_n179_), .O(new_n219_));
  ...
  nand2  g169(.a(new_n252_), .b(new_n85_), .O(z34));
  inv1   g170(.a(x46), .O(new_n254_));
  nand3  g171(.a(new_n100_), .b(x09), .c(x00), .O(new_n255_));
