...
module FAU ( 
  ...
  nand2  g046(.a(new_n129_), .b(new_n87_), .O(z08));
  ...
  nand2  g055(.a(new_n138_), .b(new_n87_), .O(z10));
  ...
  nand2  g075(.a(new_n158_), .b(new_n85_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(x26), .O(new_n160_));
  nand2  g077(.a(x27), .b(x08), .O(new_n161_));
  aoi21  g078(.a(new_n161_), .b(new_n160_), .c(x10), .O(z15));
  nand2  g079(.a(x28), .b(x08), .O(new_n163_));
  oai21  g080(.a(new_n85_), .b(x08), .c(new_n163_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n84_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n87_), .O(z16));
  ...
  nand3  g088(.a(new_n87_), .b(x29), .c(new_n116_), .O(new_n172_));
  nand2  g089(.a(x30), .b(x08), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n172_), .c(x10), .O(z18));
  nand3  g091(.a(new_n87_), .b(x08), .c(x00), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n158_), .c(x10), .O(z19));
  ...
  oai21  g148(.a(x14), .b(new_n177_), .c(x42), .O(new_n232_));
