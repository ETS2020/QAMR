...
module FAU ( 
  ...
  oai21  g056(.a(new_n138_), .b(new_n114_), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g091(.a(new_n174_), .b(new_n90_), .O(z21));
  ...
  oai21  g098(.a(x36), .b(new_n167_), .c(x35), .O(new_n182_));
  ...
  nand2  g151(.a(new_n213_), .b(x46), .O(new_n235_));
  nand3  g152(.a(new_n201_), .b(x09), .c(x00), .O(new_n236_));
