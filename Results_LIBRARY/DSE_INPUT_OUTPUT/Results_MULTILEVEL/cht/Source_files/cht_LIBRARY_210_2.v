...
module FAU ( 
  ...
  nand2  g055(.a(new_n138_), .b(new_n100_), .O(z13));
  ...
  nand2  g070(.a(new_n153_), .b(new_n100_), .O(z17));
  nand2  g071(.a(x29), .b(new_n113_), .O(new_n155_));
  nand2  g072(.a(x30), .b(x08), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z18));
  nand2  g074(.a(x08), .b(x00), .O(new_n158_));
  nand2  g075(.a(x30), .b(new_n113_), .O(new_n159_));
  ...
  nand2  g088(.a(new_n171_), .b(new_n100_), .O(z22));
  ...
  nand2  g095(.a(x36), .b(new_n161_), .O(new_n179_));
  ...
  oai21  g107(.a(new_n190_), .b(x10), .c(new_n100_), .O(z27));
  aoi21  g108(.a(new_n95_), .b(x09), .c(new_n185_), .O(new_n192_));
  nand3  g109(.a(x40), .b(new_n95_), .c(x09), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(new_n194_));
  oai21  g111(.a(new_n194_), .b(new_n192_), .c(new_n94_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n100_), .O(z28));
  inv1   g113(.a(x40), .O(new_n197_));
  aoi21  g114(.a(new_n95_), .b(x09), .c(new_n197_), .O(new_n198_));
  ...
  nand2  g118(.a(new_n201_), .b(new_n100_), .O(z29));
  ...
  nand2  g128(.a(new_n211_), .b(new_n100_), .O(z31));
  ...
  nand2  g149(.a(new_n232_), .b(new_n100_), .O(z35));
endmodule
