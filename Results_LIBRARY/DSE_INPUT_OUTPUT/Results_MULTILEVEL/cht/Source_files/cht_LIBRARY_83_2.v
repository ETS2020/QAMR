...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x41), .O(new_n88_));
  ...
  nand3  g141(.a(new_n224_), .b(x46), .c(x41), .O(new_n225_));
  ...
  aoi21  g145(.a(new_n100_), .b(x09), .c(new_n226_), .O(new_n229_));
  nand3  g146(.a(x42), .b(new_n100_), .c(x09), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(new_n229_), .c(new_n94_), .O(new_n232_));
  ...
  oai21  g164(.a(new_n247_), .b(new_n245_), .c(new_n94_), .O(new_n248_));
  ...
  nand2  g173(.a(new_n256_), .b(new_n87_), .O(new_n257_));
  nand2  g174(.a(new_n257_), .b(x00), .O(new_n258_));
  nand2  g175(.a(new_n223_), .b(x46), .O(new_n259_));
