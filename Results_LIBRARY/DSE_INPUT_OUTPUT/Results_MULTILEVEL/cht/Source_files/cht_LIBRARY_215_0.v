...
module FAU ( 
  ...
  nand2  g073(.a(x27), .b(new_n121_), .O(new_n157_));
  ...
  nand2  g082(.a(x29), .b(new_n121_), .O(new_n166_));
  ...
  nand3  g099(.a(x36), .b(new_n84_), .c(x09), .O(new_n183_));
  ...
  nand2  g135(.a(x45), .b(new_n195_), .O(new_n219_));
