...
module FAU ( 
  ...
  aoi21  g045(.a(x21), .b(x08), .c(x33), .O(new_n129_));
  ...
  aoi21  g053(.a(x23), .b(x08), .c(x33), .O(new_n137_));
  ...
  aoi21  g070(.a(x27), .b(x08), .c(x33), .O(new_n154_));
  ...
  aoi21  g093(.a(new_n176_), .b(new_n92_), .c(x10), .O(z21));
  nand4  g094(.a(x34), .b(new_n92_), .c(new_n91_), .d(x09), .O(new_n178_));
  ...
  nand3  g103(.a(new_n186_), .b(new_n185_), .c(new_n92_), .O(new_n187_));
  and2   g104(.a(new_n187_), .b(new_n91_), .O(z24));
  ...
  oai21  g119(.a(new_n202_), .b(new_n200_), .c(new_n92_), .O(new_n203_));
  ...
  aoi21  g144(.a(new_n227_), .b(x09), .c(x33), .O(new_n228_));
  ...
  aoi21  g156(.a(new_n211_), .b(x00), .c(x33), .O(new_n240_));
