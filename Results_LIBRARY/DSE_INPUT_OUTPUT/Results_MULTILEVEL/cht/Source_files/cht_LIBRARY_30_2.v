...
module FAU ( 
  ...
  oai21  g076(.a(new_n158_), .b(new_n110_), .c(new_n159_), .O(new_n160_));
  ...
  nand2  g110(.a(new_n193_), .b(new_n90_), .O(z25));
  ...
  aoi21  g127(.a(new_n204_), .b(x09), .c(new_n210_), .O(new_n211_));
  ...
  aoi21  g133(.a(new_n204_), .b(x09), .c(new_n216_), .O(new_n217_));
  nand3  g134(.a(x42), .b(new_n204_), .c(x09), .O(new_n218_));
