...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x16), .O(new_n93_));
  ...
  aoi21  g022(.a(x15), .b(new_n92_), .c(x16), .O(new_n106_));
  aoi21  g023(.a(new_n106_), .b(new_n105_), .c(x10), .O(z04));
  nand4  g024(.a(new_n85_), .b(new_n84_), .c(x07), .d(x03), .O(new_n108_));
  ...
  oai21  g125(.a(new_n208_), .b(new_n206_), .c(new_n85_), .O(new_n209_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x16), .O(new_n215_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x16), .O(new_n225_));
  ...
  aoi21  g155(.a(new_n238_), .b(x09), .c(x16), .O(new_n239_));
  ...
  aoi21  g160(.a(new_n243_), .b(x09), .c(x16), .O(new_n244_));
