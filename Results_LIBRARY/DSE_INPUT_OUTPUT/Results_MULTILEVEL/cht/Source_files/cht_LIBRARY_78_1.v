...
module FAU ( 
  ...
  nand2  g049(.a(new_n132_), .b(new_n90_), .O(z09));
  ...
  inv1   g055(.a(x08), .O(new_n139_));
  nand2  g056(.a(x22), .b(new_n139_), .O(new_n140_));
  nand2  g057(.a(x23), .b(x08), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(new_n140_), .c(x10), .O(z11));
  nand2  g059(.a(x23), .b(new_n139_), .O(new_n143_));
  ...
  nand2  g067(.a(x25), .b(new_n139_), .O(new_n151_));
  nand2  g068(.a(x26), .b(x08), .O(new_n152_));
  aoi21  g069(.a(new_n152_), .b(new_n151_), .c(x10), .O(z14));
  nand2  g070(.a(x26), .b(new_n139_), .O(new_n154_));
  ...
  nand2  g111(.a(x37), .b(new_n89_), .O(new_n195_));
  ...
  oai21  g145(.a(x45), .b(x10), .c(new_n89_), .O(new_n229_));
