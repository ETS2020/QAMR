...
module FAU ( 
  ...
  nand2  g001(.a(x42), .b(x19), .O(new_n85_));
  ...
  oai21  g085(.a(new_n168_), .b(x10), .c(new_n85_), .O(z19));
  ...
  nand2  g091(.a(new_n174_), .b(new_n85_), .O(z20));
  ...
  nand2  g095(.a(new_n178_), .b(new_n85_), .O(z21));
  ...
  nand2  g100(.a(new_n183_), .b(new_n85_), .O(z22));
  ...
  nand2  g113(.a(new_n196_), .b(new_n85_), .O(z25));
  ...
  oai21  g139(.a(new_n222_), .b(x10), .c(new_n85_), .O(z30));
  ...
  oai21  g143(.a(new_n226_), .b(x10), .c(new_n85_), .O(z31));
  nand3  g144(.a(x44), .b(new_n99_), .c(x09), .O(new_n228_));
  inv1   g145(.a(new_n228_), .O(new_n229_));
  aoi21  g146(.a(new_n209_), .b(x43), .c(new_n229_), .O(new_n230_));
  oai21  g147(.a(new_n230_), .b(x10), .c(new_n85_), .O(z32));
  ...
  nand3  g153(.a(x46), .b(new_n99_), .c(x09), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(new_n238_));
  aoi21  g155(.a(new_n209_), .b(x45), .c(new_n238_), .O(new_n239_));
  oai21  g156(.a(new_n239_), .b(x10), .c(new_n85_), .O(z34));
