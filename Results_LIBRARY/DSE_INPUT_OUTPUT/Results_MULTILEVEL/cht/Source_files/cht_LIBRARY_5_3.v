...
module FAU ( 
  ...
  oai21  g054(.a(x10), .b(x08), .c(x24), .O(new_n138_));
  nand3  g055(.a(x23), .b(new_n84_), .c(new_n115_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(new_n138_), .O(z12));
  oai21  g057(.a(x10), .b(new_n115_), .c(x24), .O(new_n141_));
  nand3  g058(.a(x25), .b(new_n84_), .c(x08), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(new_n141_), .O(z13));
  ...
  nand2  g076(.a(new_n159_), .b(new_n89_), .O(z17));
  ...
  nand2  g099(.a(x34), .b(new_n174_), .O(new_n183_));
  ...
  nand2  g105(.a(x36), .b(new_n174_), .O(new_n189_));
  nand2  g106(.a(x37), .b(x09), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z25));
  nand2  g108(.a(x37), .b(new_n174_), .O(new_n192_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n89_), .O(z30));
  nand2  g131(.a(new_n202_), .b(x42), .O(new_n215_));
  nand3  g132(.a(x43), .b(new_n101_), .c(x09), .O(new_n216_));
  ...
  nand2  g145(.a(new_n228_), .b(new_n89_), .O(z34));
  ...
  nand2  g151(.a(new_n234_), .b(new_n89_), .O(z35));
endmodule
