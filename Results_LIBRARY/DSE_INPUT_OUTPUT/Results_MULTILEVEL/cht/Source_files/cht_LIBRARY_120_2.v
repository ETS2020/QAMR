...
module FAU ( 
  ...
  nand2  g075(.a(x28), .b(new_n112_), .O(new_n159_));
  ...
  nand2  g096(.a(x33), .b(new_n172_), .O(new_n180_));
  oai21  g097(.a(new_n179_), .b(new_n172_), .c(new_n180_), .O(new_n181_));
  ...
  oai21  g106(.a(new_n188_), .b(new_n172_), .c(new_n189_), .O(new_n190_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n90_), .O(z26));
  ...
  aoi21  g122(.a(new_n204_), .b(x09), .c(new_n205_), .O(new_n206_));
  ...
  nand3  g130(.a(x41), .b(new_n208_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z29));
  nand2  g132(.a(new_n209_), .b(x41), .O(new_n216_));
  nand3  g133(.a(x42), .b(new_n208_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z30));
  nand2  g135(.a(new_n209_), .b(x42), .O(new_n219_));
  nand3  g136(.a(x43), .b(new_n208_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z31));
  inv1   g138(.a(x43), .O(new_n222_));
  aoi21  g139(.a(new_n208_), .b(x09), .c(new_n222_), .O(new_n223_));
  nand3  g140(.a(x44), .b(new_n208_), .c(x09), .O(new_n224_));
  ...
  nand3  g145(.a(x45), .b(new_n208_), .c(x09), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z33));
  nor2   g147(.a(x14), .b(new_n172_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(x45), .c(x46), .O(new_n232_));
  nand2  g149(.a(new_n209_), .b(x45), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n232_), .c(x10), .O(z34));
  oai21  g151(.a(new_n231_), .b(x46), .c(x00), .O(new_n235_));
  nand2  g152(.a(new_n209_), .b(x46), .O(new_n236_));
