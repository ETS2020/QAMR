...
module FAU ( 
  ...
  nand3  g053(.a(x23), .b(new_n84_), .c(new_n113_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n136_), .O(z12));
  oai21  g055(.a(x10), .b(new_n113_), .c(x24), .O(new_n139_));
  nand3  g056(.a(x25), .b(new_n84_), .c(x08), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n139_), .O(z13));
  ...
  oai21  g107(.a(new_n189_), .b(new_n165_), .c(new_n190_), .O(new_n191_));
  ...
  aoi21  g116(.a(new_n101_), .b(x09), .c(new_n194_), .O(new_n200_));
