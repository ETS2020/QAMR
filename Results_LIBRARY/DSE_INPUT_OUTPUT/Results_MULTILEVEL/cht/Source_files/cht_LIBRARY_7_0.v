...
module FAU ( 
  ...
  and2   g079(.a(new_n162_), .b(new_n89_), .O(z17));
  nand2  g080(.a(x29), .b(new_n109_), .O(new_n164_));
  nand2  g081(.a(x30), .b(x08), .O(new_n165_));
  nand3  g082(.a(new_n165_), .b(new_n164_), .c(x09), .O(new_n166_));
  and2   g083(.a(new_n166_), .b(new_n89_), .O(z18));
  ...
  nand2  g125(.a(x43), .b(new_n194_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(x09), .O(new_n210_));
  and2   g127(.a(new_n210_), .b(new_n89_), .O(z31));
  nand2  g128(.a(x43), .b(x14), .O(new_n212_));
  nand2  g129(.a(x44), .b(new_n194_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(x09), .O(new_n214_));
  and2   g131(.a(new_n214_), .b(new_n89_), .O(z32));
  ...
  nand3  g140(.a(new_n223_), .b(new_n89_), .c(x09), .O(new_n224_));
  ...
  nand3  g145(.a(new_n228_), .b(new_n89_), .c(x09), .O(new_n229_));
