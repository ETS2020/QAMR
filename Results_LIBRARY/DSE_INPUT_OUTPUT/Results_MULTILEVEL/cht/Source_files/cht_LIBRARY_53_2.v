...
module FAU ( 
  ...
  nand3  g082(.a(new_n165_), .b(new_n164_), .c(new_n91_), .O(new_n166_));
  ...
  aoi21  g090(.a(x30), .b(new_n131_), .c(x09), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z19));
  inv1   g092(.a(x31), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n91_), .c(x10), .O(z20));
  ...
  aoi21  g110(.a(new_n193_), .b(new_n91_), .c(x10), .O(z28));
  inv1   g111(.a(x40), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n91_), .c(x10), .O(z29));
  nand2  g113(.a(new_n178_), .b(x41), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z30));
  inv1   g115(.a(x42), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n91_), .c(x10), .O(z31));
