...
module FAU ( 
  ...
  nand3  g042(.a(new_n125_), .b(x36), .c(new_n84_), .O(new_n126_));
  ...
  aoi21  g060(.a(x25), .b(x08), .c(new_n102_), .O(new_n144_));
  ...
  nand3  g080(.a(new_n163_), .b(x36), .c(new_n84_), .O(new_n164_));
  ...
  nand3  g090(.a(new_n173_), .b(x36), .c(new_n84_), .O(new_n174_));
  ...
  aoi21  g097(.a(x34), .b(x09), .c(new_n102_), .O(new_n181_));
  ...
  oai21  g104(.a(x35), .b(x09), .c(x36), .O(new_n188_));
  nor2   g105(.a(new_n188_), .b(x10), .O(z24));
  oai21  g106(.a(x37), .b(new_n170_), .c(x36), .O(new_n190_));
  nor2   g107(.a(new_n190_), .b(x10), .O(z25));
  inv1   g108(.a(x37), .O(new_n192_));
  nand2  g109(.a(x38), .b(x09), .O(new_n193_));
  oai21  g110(.a(new_n192_), .b(x09), .c(new_n193_), .O(new_n194_));
  nand3  g111(.a(new_n194_), .b(x36), .c(new_n84_), .O(new_n195_));
  ...
  aoi21  g117(.a(x38), .b(new_n170_), .c(new_n102_), .O(new_n201_));
  ...
  nand3  g134(.a(new_n217_), .b(x36), .c(new_n84_), .O(new_n218_));
  ...
  aoi21  g158(.a(new_n241_), .b(x00), .c(new_n102_), .O(new_n242_));
