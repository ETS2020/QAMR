...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n94_), .O(z11));
  ...
  nand2  g056(.a(new_n139_), .b(new_n94_), .O(z12));
  ...
  oai21  g077(.a(new_n159_), .b(new_n117_), .c(new_n160_), .O(new_n161_));
  ...
  oai21  g101(.a(new_n93_), .b(new_n168_), .c(new_n184_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n88_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n94_), .O(z24));
  nand2  g104(.a(x37), .b(x09), .O(new_n188_));
  oai21  g105(.a(new_n93_), .b(x09), .c(new_n188_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n88_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n94_), .O(z25));
