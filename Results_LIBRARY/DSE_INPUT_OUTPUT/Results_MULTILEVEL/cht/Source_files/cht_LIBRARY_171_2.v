...
module FAU ( 
  ...
  nand2  g037(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand2  g038(.a(new_n121_), .b(new_n88_), .O(z08));
  ...
  nand2  g054(.a(x25), .b(new_n110_), .O(new_n138_));
  ...
  oai21  g059(.a(new_n141_), .b(new_n110_), .c(new_n142_), .O(new_n143_));
  nand2  g060(.a(new_n143_), .b(new_n117_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n88_), .O(z15));
  ...
  nand2  g065(.a(new_n148_), .b(new_n88_), .O(z16));
  nand2  g066(.a(x28), .b(new_n110_), .O(new_n150_));
  oai21  g067(.a(new_n87_), .b(new_n110_), .c(new_n150_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n117_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n88_), .O(z17));
  oai21  g070(.a(x30), .b(new_n110_), .c(x29), .O(new_n154_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n88_), .O(z19));
  ...
  nand2  g088(.a(new_n171_), .b(new_n117_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n88_), .O(z22));
  nand2  g090(.a(x34), .b(new_n162_), .O(new_n174_));
  nand2  g091(.a(x35), .b(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z23));
  nand2  g093(.a(x35), .b(new_n162_), .O(new_n177_));
  ...
  nand2  g099(.a(new_n182_), .b(new_n117_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n88_), .O(z25));
  ...
  oai21  g110(.a(new_n193_), .b(x10), .c(new_n88_), .O(z27));
  ...
  oai21  g114(.a(new_n197_), .b(new_n195_), .c(new_n117_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n88_), .O(z28));
  ...
  oai21  g120(.a(new_n203_), .b(new_n201_), .c(new_n117_), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(new_n88_), .O(z29));
  ...
  oai21  g126(.a(new_n209_), .b(new_n207_), .c(new_n117_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n88_), .O(z30));
  ...
  oai21  g136(.a(new_n219_), .b(new_n217_), .c(new_n117_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n88_), .O(z32));
  ...
  oai21  g142(.a(new_n225_), .b(new_n223_), .c(new_n117_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n88_), .O(z33));
  inv1   g144(.a(x45), .O(new_n228_));
  aoi21  g145(.a(new_n98_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(x46), .b(new_n98_), .c(x09), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(new_n229_), .c(new_n117_), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n88_), .O(z34));
