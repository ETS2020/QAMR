...
module FAU ( 
  ...
  nand2  g066(.a(new_n149_), .b(new_n87_), .O(z13));
  ...
  nand2  g071(.a(new_n154_), .b(new_n87_), .O(z14));
  oai21  g072(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(x26), .O(new_n157_));
  nand2  g074(.a(x27), .b(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z15));
  inv1   g076(.a(x28), .O(new_n160_));
  aoi21  g077(.a(new_n160_), .b(x08), .c(new_n85_), .O(new_n161_));
  nor2   g078(.a(new_n160_), .b(new_n114_), .O(new_n162_));
  oai21  g079(.a(new_n162_), .b(new_n161_), .c(new_n84_), .O(new_n163_));
  ...
  nand2  g086(.a(x29), .b(new_n114_), .O(new_n170_));
  oai21  g087(.a(new_n169_), .b(new_n114_), .c(new_n170_), .O(new_n171_));
  ...
  oai21  g151(.a(x14), .b(new_n178_), .c(new_n234_), .O(new_n235_));
  aoi21  g152(.a(new_n101_), .b(x09), .c(new_n234_), .O(new_n236_));
  aoi21  g153(.a(new_n235_), .b(x43), .c(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(x10), .c(new_n87_), .O(z31));
  nand3  g155(.a(x27), .b(new_n101_), .c(x09), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(new_n86_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(x44), .O(new_n241_));
  oai21  g158(.a(x14), .b(new_n178_), .c(x43), .O(new_n242_));
  aoi21  g159(.a(new_n242_), .b(new_n241_), .c(x10), .O(z32));
  ...
  nand2  g177(.a(new_n260_), .b(new_n87_), .O(z35));
endmodule
