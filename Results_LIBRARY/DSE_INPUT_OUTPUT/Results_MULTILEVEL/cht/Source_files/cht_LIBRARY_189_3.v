...
module FAU ( 
  ...
  nand2  g051(.a(x24), .b(new_n111_), .O(new_n135_));
  ...
  nand3  g088(.a(x33), .b(new_n88_), .c(new_n165_), .O(new_n172_));
  ...
  nand3  g100(.a(x37), .b(new_n88_), .c(new_n165_), .O(new_n184_));
  ...
  nand3  g106(.a(x38), .b(new_n88_), .c(new_n165_), .O(new_n190_));
