...
module FAU ( 
  ...
  aoi21  g027(.a(x16), .b(new_n97_), .c(x08), .O(new_n111_));
  ...
  aoi21  g035(.a(new_n118_), .b(new_n84_), .c(x10), .O(z08));
  inv1   g036(.a(x20), .O(new_n120_));
  aoi21  g037(.a(new_n120_), .b(new_n84_), .c(x10), .O(z09));
  inv1   g038(.a(x21), .O(new_n122_));
  aoi21  g039(.a(new_n122_), .b(new_n84_), .c(x10), .O(z10));
  inv1   g040(.a(x22), .O(new_n124_));
  aoi21  g041(.a(new_n124_), .b(new_n84_), .c(x10), .O(z11));
  ...
  nand2  g046(.a(new_n113_), .b(x25), .O(new_n130_));
  ...
  nand2  g054(.a(new_n113_), .b(x29), .O(new_n138_));
  ...
  and2   g075(.a(new_n158_), .b(new_n85_), .O(z23));
  ...
  and2   g084(.a(new_n167_), .b(new_n85_), .O(z25));
  ...
  and2   g088(.a(new_n171_), .b(new_n85_), .O(z26));
  ...
  aoi21  g093(.a(x38), .b(new_n142_), .c(x08), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z27));
  oai21  g095(.a(x14), .b(new_n142_), .c(x39), .O(new_n179_));
  ...
  nand3  g117(.a(x44), .b(new_n100_), .c(x09), .O(new_n201_));
  ...
  oai21  g121(.a(x14), .b(new_n142_), .c(x44), .O(new_n205_));
  ...
  oai21  g126(.a(x14), .b(new_n142_), .c(x45), .O(new_n210_));
  ...
  nand2  g131(.a(new_n184_), .b(x46), .O(new_n215_));
