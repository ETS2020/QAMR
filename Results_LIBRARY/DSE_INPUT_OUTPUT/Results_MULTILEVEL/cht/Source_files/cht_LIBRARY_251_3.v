...
module FAU ( 
  ...
  nand2  g028(.a(new_n111_), .b(new_n89_), .O(z06));
  ...
  oai21  g062(.a(x10), .b(x08), .c(x27), .O(new_n146_));
  nand3  g063(.a(x26), .b(new_n84_), .c(new_n107_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n146_), .O(z15));
  oai21  g065(.a(x10), .b(new_n107_), .c(x27), .O(new_n149_));
  nand3  g066(.a(x28), .b(new_n84_), .c(x08), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n149_), .O(z16));
  inv1   g068(.a(x29), .O(new_n152_));
  nand2  g069(.a(x28), .b(new_n107_), .O(new_n153_));
  oai21  g070(.a(new_n152_), .b(new_n107_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g078(.a(x30), .b(new_n107_), .O(new_n162_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n89_), .O(z22));
  ...
  nand2  g101(.a(new_n184_), .b(new_n89_), .O(z24));
  ...
  nand3  g126(.a(x42), .b(new_n201_), .c(x09), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z30));
  inv1   g128(.a(x42), .O(new_n212_));
  aoi21  g129(.a(new_n201_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x43), .b(new_n201_), .c(x09), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(new_n84_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n89_), .O(z31));
  inv1   g134(.a(x43), .O(new_n218_));
  aoi21  g135(.a(new_n201_), .b(x09), .c(new_n218_), .O(new_n219_));
  ...
  aoi21  g141(.a(new_n201_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(x45), .b(new_n201_), .c(x09), .O(new_n226_));
  ...
  aoi21  g147(.a(new_n201_), .b(x09), .c(new_n230_), .O(new_n231_));
  nand3  g148(.a(x46), .b(new_n201_), .c(x09), .O(new_n232_));
  ...
  aoi21  g153(.a(new_n201_), .b(x09), .c(new_n236_), .O(new_n237_));
  nand3  g154(.a(new_n201_), .b(x09), .c(x00), .O(new_n238_));
