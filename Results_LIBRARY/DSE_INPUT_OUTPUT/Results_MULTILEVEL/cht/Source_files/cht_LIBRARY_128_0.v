...
module FAU ( 
  ...
  oai21  g031(.a(x18), .b(new_n114_), .c(x17), .O(new_n115_));
  nand3  g032(.a(x34), .b(x18), .c(x08), .O(new_n116_));
  ...
  oai21  g103(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n187_));
  ...
  oai21  g108(.a(new_n88_), .b(x09), .c(new_n191_), .O(new_n192_));
  ...
  nand3  g135(.a(new_n218_), .b(new_n89_), .c(new_n91_), .O(new_n219_));
  ...
  oai21  g153(.a(new_n236_), .b(x10), .c(new_n89_), .O(z32));
  ...
  oai21  g162(.a(new_n245_), .b(x10), .c(new_n89_), .O(z34));
  nand2  g163(.a(new_n215_), .b(x46), .O(new_n247_));
  oai21  g164(.a(new_n215_), .b(new_n172_), .c(new_n247_), .O(new_n248_));
