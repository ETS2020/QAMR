...
module FAU ( 
  ...
  aoi21  g024(.a(x15), .b(new_n107_), .c(x08), .O(new_n108_));
  ...
  and2   g078(.a(new_n161_), .b(new_n85_), .O(z23));
  ...
  and2   g091(.a(new_n174_), .b(new_n85_), .O(z26));
  ...
  nand3  g110(.a(x42), .b(new_n101_), .c(x09), .O(new_n194_));
  ...
  nand3  g135(.a(new_n101_), .b(x09), .c(x00), .O(new_n219_));
