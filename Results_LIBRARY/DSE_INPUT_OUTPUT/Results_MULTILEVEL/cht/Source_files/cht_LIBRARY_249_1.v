...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n85_), .c(x35), .O(new_n101_));
  aoi21  g018(.a(new_n101_), .b(new_n100_), .c(x10), .O(z03));
  nand2  g019(.a(x07), .b(x02), .O(new_n103_));
  aoi21  g020(.a(x15), .b(new_n85_), .c(x35), .O(new_n104_));
  ...
  aoi21  g070(.a(x30), .b(x08), .c(x35), .O(new_n154_));
  ...
  nand4  g089(.a(new_n89_), .b(x34), .c(new_n88_), .d(new_n161_), .O(new_n173_));
  inv1   g090(.a(new_n173_), .O(z23));
  nand2  g091(.a(x36), .b(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n89_), .c(x10), .O(z24));
  ...
  and2   g101(.a(new_n184_), .b(new_n88_), .O(z26));
  ...
  oai21  g108(.a(new_n191_), .b(new_n189_), .c(new_n89_), .O(new_n192_));
  ...
  aoi21  g114(.a(new_n197_), .b(x09), .c(x35), .O(new_n198_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n89_), .c(new_n88_), .O(new_n203_));
  ...
  aoi21  g124(.a(new_n207_), .b(x09), .c(x35), .O(new_n208_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x35), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x35), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n224_), .c(x10), .O(z34));
  nand2  g145(.a(new_n194_), .b(x46), .O(new_n229_));
  aoi21  g146(.a(new_n200_), .b(x00), .c(x35), .O(new_n230_));
