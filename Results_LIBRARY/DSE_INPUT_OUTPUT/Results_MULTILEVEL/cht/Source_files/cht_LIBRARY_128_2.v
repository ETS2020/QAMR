...
module FAU ( 
  ...
  nand3  g031(.a(new_n114_), .b(x34), .c(x17), .O(new_n115_));
  ...
  nor2   g103(.a(x17), .b(x09), .O(new_n187_));
  oai21  g104(.a(new_n187_), .b(x34), .c(x33), .O(new_n188_));
  nand2  g105(.a(x34), .b(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z22));
  nand2  g107(.a(x35), .b(x09), .O(new_n191_));
  oai21  g108(.a(new_n87_), .b(x09), .c(new_n191_), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n90_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n88_), .O(z23));
  inv1   g111(.a(x36), .O(new_n195_));
  nand2  g112(.a(x35), .b(new_n177_), .O(new_n196_));
  oai21  g113(.a(new_n195_), .b(new_n177_), .c(new_n196_), .O(new_n197_));
  ...
  nand2  g126(.a(x39), .b(new_n101_), .O(new_n210_));
  ...
  aoi21  g144(.a(new_n215_), .b(x41), .c(new_n227_), .O(new_n228_));
  oai21  g145(.a(new_n228_), .b(x10), .c(new_n88_), .O(z30));
  ...
  oai21  g149(.a(new_n232_), .b(x10), .c(new_n88_), .O(z31));
  ...
  aoi21  g161(.a(new_n215_), .b(x45), .c(new_n244_), .O(new_n245_));
  oai21  g162(.a(new_n245_), .b(x10), .c(new_n88_), .O(z34));
  inv1   g163(.a(x00), .O(new_n247_));
  nand2  g164(.a(new_n215_), .b(x46), .O(new_n248_));
  oai21  g165(.a(new_n215_), .b(new_n247_), .c(new_n248_), .O(new_n249_));
