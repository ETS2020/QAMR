...
module FAU ( 
  ...
  nand2  g100(.a(new_n183_), .b(new_n90_), .O(z22));
  ...
  nand2  g127(.a(new_n205_), .b(x09), .O(new_n211_));
  ...
  aoi21  g132(.a(new_n205_), .b(x09), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(x42), .b(new_n205_), .c(x09), .O(new_n217_));
  ...
  aoi21  g138(.a(new_n205_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(x43), .b(new_n205_), .c(x09), .O(new_n223_));
  ...
  nand3  g144(.a(x44), .b(new_n205_), .c(x09), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z32));
  inv1   g146(.a(x44), .O(new_n230_));
  aoi21  g147(.a(new_n205_), .b(x09), .c(new_n230_), .O(new_n231_));
  ...
  nand3  g153(.a(x46), .b(new_n205_), .c(x09), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z34));
  nand2  g155(.a(new_n211_), .b(x46), .O(new_n239_));
  nand3  g156(.a(new_n205_), .b(x09), .c(x00), .O(new_n240_));
