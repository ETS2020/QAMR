...
module FAU ( 
  ...
  oai21  g029(.a(x18), .b(x10), .c(new_n99_), .O(new_n113_));
  nand3  g030(.a(x19), .b(new_n94_), .c(x08), .O(new_n114_));
  ...
  nand2  g035(.a(x20), .b(new_n99_), .O(new_n119_));
  nand2  g036(.a(x21), .b(x08), .O(new_n120_));
  aoi21  g037(.a(new_n120_), .b(new_n119_), .c(x10), .O(z09));
  nand2  g038(.a(x21), .b(new_n99_), .O(new_n122_));
  nand2  g039(.a(x22), .b(x08), .O(new_n123_));
  aoi21  g040(.a(new_n123_), .b(new_n122_), .c(x10), .O(z10));
  oai21  g041(.a(x22), .b(x10), .c(new_n99_), .O(new_n125_));
  nand3  g042(.a(x23), .b(new_n94_), .c(x08), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(new_n125_), .O(z11));
  oai21  g044(.a(x23), .b(x10), .c(new_n99_), .O(new_n128_));
  nand3  g045(.a(x24), .b(new_n94_), .c(x08), .O(new_n129_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n100_), .O(z22));
  ...
  nand2  g090(.a(new_n173_), .b(new_n100_), .O(z25));
  ...
  nand2  g109(.a(new_n192_), .b(new_n100_), .O(z29));
  ...
  nand2  g130(.a(new_n213_), .b(new_n100_), .O(z35));
endmodule
