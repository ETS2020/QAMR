...
module FAU ( 
  ...
  oai21  g122(.a(new_n85_), .b(new_n177_), .c(new_n205_), .O(new_n206_));
  ...
  oai21  g136(.a(x14), .b(new_n177_), .c(x40), .O(new_n220_));
  ...
  oai21  g158(.a(x14), .b(new_n177_), .c(x44), .O(new_n242_));
  ...
  nand2  g164(.a(new_n100_), .b(x09), .O(new_n248_));
  nand2  g165(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand3  g166(.a(new_n249_), .b(x46), .c(x38), .O(new_n250_));
  inv1   g167(.a(x46), .O(new_n251_));
  nand3  g168(.a(new_n248_), .b(new_n251_), .c(x45), .O(new_n252_));
  aoi21  g169(.a(new_n252_), .b(new_n250_), .c(x10), .O(z34));
  nand2  g170(.a(x46), .b(x38), .O(new_n254_));
  nand3  g171(.a(new_n251_), .b(new_n100_), .c(x09), .O(new_n255_));
  nand2  g172(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  nand2  g173(.a(new_n256_), .b(x00), .O(new_n257_));
  nand3  g174(.a(new_n248_), .b(x46), .c(x38), .O(new_n258_));
