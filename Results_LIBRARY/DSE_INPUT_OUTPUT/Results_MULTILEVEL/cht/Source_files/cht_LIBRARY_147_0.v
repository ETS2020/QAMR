...
module FAU ( 
  ...
  nand3  g022(.a(new_n105_), .b(new_n92_), .c(x08), .O(new_n106_));
  ...
  nand2  g052(.a(new_n119_), .b(x30), .O(new_n136_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n92_), .c(x08), .O(new_n143_));
  ...
  aoi21  g093(.a(x38), .b(new_n145_), .c(new_n86_), .O(new_n177_));
  ...
  nand3  g134(.a(new_n217_), .b(new_n92_), .c(x08), .O(new_n218_));
