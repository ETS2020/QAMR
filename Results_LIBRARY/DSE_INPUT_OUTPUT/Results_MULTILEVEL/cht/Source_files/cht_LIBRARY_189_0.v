...
module FAU ( 
  ...
  nand2  g067(.a(x25), .b(new_n131_), .O(new_n151_));
  ...
  nand2  g071(.a(x26), .b(new_n131_), .O(new_n155_));
  ...
  nand2  g075(.a(x27), .b(new_n131_), .O(new_n159_));
  ...
  nor2   g095(.a(x10), .b(new_n92_), .O(new_n179_));
