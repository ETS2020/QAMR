...
module FAU ( 
  ...
  nand2  g113(.a(x38), .b(new_n163_), .O(new_n197_));
  ...
  aoi21  g140(.a(new_n199_), .b(x09), .c(new_n223_), .O(new_n224_));
  ...
  nand3  g147(.a(x45), .b(new_n199_), .c(x09), .O(new_n231_));
  ...
  oai21  g152(.a(x14), .b(new_n163_), .c(x45), .O(new_n236_));
  aoi21  g153(.a(new_n199_), .b(x09), .c(x10), .O(new_n237_));
  oai22  g154(.a(new_n237_), .b(new_n235_), .c(new_n236_), .d(x10), .O(z34));
  nand3  g155(.a(new_n199_), .b(new_n84_), .c(x09), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(x46), .O(new_n240_));
  nand4  g157(.a(new_n199_), .b(new_n84_), .c(x09), .d(x00), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n240_), .O(z35));
endmodule
