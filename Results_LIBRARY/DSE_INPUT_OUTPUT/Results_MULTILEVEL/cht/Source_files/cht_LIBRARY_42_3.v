...
module FAU ( 
  ...
  nand2  g049(.a(new_n132_), .b(new_n93_), .O(z10));
  ...
  oai21  g068(.a(new_n150_), .b(new_n116_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n93_), .O(z17));
  ...
  oai21  g088(.a(x10), .b(new_n165_), .c(x33), .O(new_n172_));
  nand3  g089(.a(x34), .b(new_n88_), .c(x09), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(z22));
  ...
  aoi21  g112(.a(new_n100_), .b(x09), .c(new_n189_), .O(new_n196_));
