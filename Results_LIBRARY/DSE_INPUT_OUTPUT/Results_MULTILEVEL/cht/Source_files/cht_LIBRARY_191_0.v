...
module FAU ( 
  ...
  oai21  g113(.a(new_n86_), .b(x09), .c(new_n85_), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(x35), .O(new_n198_));
  nand2  g115(.a(x36), .b(x09), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z24));
  nand2  g117(.a(x37), .b(x09), .O(new_n201_));
  oai21  g118(.a(new_n85_), .b(x09), .c(new_n201_), .O(new_n202_));
  ...
  nand3  g124(.a(new_n207_), .b(new_n87_), .c(new_n84_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z26));
  nand2  g126(.a(x14), .b(x00), .O(new_n210_));
  nand2  g127(.a(x39), .b(new_n103_), .O(new_n211_));
  ...
  nand2  g132(.a(new_n103_), .b(x09), .O(new_n216_));
  nand3  g133(.a(x40), .b(new_n103_), .c(x09), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(new_n218_));
  aoi21  g135(.a(new_n216_), .b(x39), .c(new_n218_), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(x10), .c(new_n87_), .O(z28));
  nand3  g137(.a(x41), .b(new_n103_), .c(x09), .O(new_n221_));
  inv1   g138(.a(new_n221_), .O(new_n222_));
  aoi21  g139(.a(new_n216_), .b(x40), .c(new_n222_), .O(new_n223_));
  oai21  g140(.a(new_n223_), .b(x10), .c(new_n87_), .O(z29));
  nand3  g141(.a(x42), .b(new_n103_), .c(x09), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(new_n226_));
  aoi21  g143(.a(new_n216_), .b(x41), .c(new_n226_), .O(new_n227_));
  oai21  g144(.a(new_n227_), .b(x10), .c(new_n87_), .O(z30));
  nand3  g145(.a(x36), .b(new_n103_), .c(x09), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n86_), .O(new_n230_));
  ...
  nand3  g150(.a(x44), .b(new_n103_), .c(x09), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(new_n235_));
  aoi21  g152(.a(new_n216_), .b(x43), .c(new_n235_), .O(new_n236_));
  oai21  g153(.a(new_n236_), .b(x10), .c(new_n87_), .O(z32));
  nand3  g154(.a(x45), .b(new_n103_), .c(x09), .O(new_n238_));
  inv1   g155(.a(new_n238_), .O(new_n239_));
  aoi21  g156(.a(new_n216_), .b(x44), .c(new_n239_), .O(new_n240_));
  oai21  g157(.a(new_n240_), .b(x10), .c(new_n87_), .O(z33));
  nand3  g158(.a(x46), .b(new_n103_), .c(x09), .O(new_n242_));
  inv1   g159(.a(new_n242_), .O(new_n243_));
  aoi21  g160(.a(new_n216_), .b(x45), .c(new_n243_), .O(new_n244_));
