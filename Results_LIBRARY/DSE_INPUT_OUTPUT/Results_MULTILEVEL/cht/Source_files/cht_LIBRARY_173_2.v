...
module FAU ( 
  ...
  oai21  g042(.a(new_n124_), .b(new_n112_), .c(new_n125_), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(new_n94_), .O(new_n127_));
  nand2  g044(.a(new_n127_), .b(new_n100_), .O(z09));
  ...
  nand2  g048(.a(new_n131_), .b(new_n100_), .O(z10));
  ...
  nand2  g070(.a(new_n153_), .b(new_n100_), .O(z16));
  ...
  nand2  g093(.a(new_n176_), .b(new_n100_), .O(z22));
