...
module FAU ( 
  ...
  nand3  g060(.a(new_n143_), .b(new_n88_), .c(new_n90_), .O(new_n144_));
  ...
  oai21  g124(.a(new_n87_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n90_), .O(new_n209_));
  ...
  nand3  g137(.a(new_n220_), .b(x40), .c(x37), .O(new_n221_));
  ...
  nand3  g141(.a(new_n222_), .b(new_n100_), .c(x09), .O(new_n225_));
  oai21  g142(.a(new_n222_), .b(new_n87_), .c(new_n225_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(x41), .O(new_n227_));
  nand3  g144(.a(new_n219_), .b(x40), .c(x37), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z29));
  nand2  g146(.a(new_n219_), .b(x41), .O(new_n230_));
  nand3  g147(.a(x42), .b(new_n100_), .c(x09), .O(new_n231_));
  ...
  oai21  g154(.a(new_n237_), .b(x10), .c(new_n88_), .O(z31));
  ...
  oai21  g168(.a(new_n251_), .b(x10), .c(new_n88_), .O(z34));
  ...
  nand3  g172(.a(new_n255_), .b(new_n88_), .c(new_n90_), .O(new_n256_));
