...
module FAU ( 
  ...
  aoi21  g087(.a(x30), .b(new_n116_), .c(new_n86_), .O(new_n171_));
  ...
  nand3  g099(.a(x37), .b(new_n89_), .c(x09), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z25));
  nand3  g101(.a(x38), .b(new_n89_), .c(x09), .O(new_n185_));
  ...
  nand2  g122(.a(x43), .b(new_n98_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n205_), .c(x09), .O(new_n207_));
  and2   g124(.a(new_n207_), .b(new_n89_), .O(z31));
  ...
  nand2  g140(.a(new_n98_), .b(x00), .O(new_n224_));
