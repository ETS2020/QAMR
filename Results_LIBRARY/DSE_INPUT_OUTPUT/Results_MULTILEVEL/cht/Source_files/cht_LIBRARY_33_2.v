...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x23), .O(new_n86_));
  ...
  nand2  g055(.a(new_n85_), .b(x23), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(x22), .c(new_n115_), .O(new_n140_));
  inv1   g057(.a(x23), .O(new_n141_));
  nor2   g058(.a(new_n85_), .b(new_n141_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(x08), .O(new_n143_));
  aoi21  g060(.a(new_n143_), .b(new_n140_), .c(x10), .O(z11));
  nand3  g061(.a(new_n139_), .b(x24), .c(x08), .O(new_n145_));
  nand2  g062(.a(new_n142_), .b(new_n115_), .O(new_n146_));
  aoi21  g063(.a(new_n146_), .b(new_n145_), .c(x10), .O(z12));
  nand2  g064(.a(x24), .b(new_n115_), .O(new_n148_));
  oai21  g065(.a(new_n85_), .b(new_n115_), .c(new_n148_), .O(new_n149_));
  ...
  nand3  g069(.a(x26), .b(new_n141_), .c(x08), .O(new_n153_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n86_), .O(z16));
  ...
  nand2  g168(.a(new_n251_), .b(new_n86_), .O(z34));
