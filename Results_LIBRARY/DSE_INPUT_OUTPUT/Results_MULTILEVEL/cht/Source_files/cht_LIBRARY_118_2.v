...
module FAU ( 
  ...
  nand2  g054(.a(x24), .b(new_n112_), .O(new_n138_));
  nand2  g055(.a(x25), .b(x08), .O(new_n139_));
  aoi21  g056(.a(new_n139_), .b(new_n138_), .c(x10), .O(z13));
  nand2  g057(.a(x25), .b(new_n112_), .O(new_n141_));
  ...
  nand2  g089(.a(new_n172_), .b(new_n90_), .O(z22));
  ...
  nand2  g098(.a(x36), .b(new_n159_), .O(new_n182_));
  ...
  nand2  g110(.a(x38), .b(new_n159_), .O(new_n194_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n90_), .O(z29));
  ...
  aoi21  g130(.a(new_n196_), .b(x09), .c(new_n213_), .O(new_n214_));
  ...
  nand2  g135(.a(new_n197_), .b(x43), .O(new_n219_));
