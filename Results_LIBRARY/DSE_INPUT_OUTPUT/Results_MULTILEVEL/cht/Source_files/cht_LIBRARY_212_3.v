...
module FAU ( 
  ...
  nor2   g014(.a(x10), .b(new_n97_), .O(new_n98_));
  nand2  g015(.a(new_n98_), .b(x06), .O(new_n99_));
  oai21  g016(.a(new_n98_), .b(new_n96_), .c(new_n99_), .O(z02));
  ...
  nand2  g023(.a(x15), .b(new_n97_), .O(new_n107_));
  aoi21  g024(.a(new_n107_), .b(new_n106_), .c(x10), .O(z04));
  nand2  g025(.a(x07), .b(x03), .O(new_n109_));
  nand2  g026(.a(x16), .b(new_n97_), .O(new_n110_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n89_), .O(z20));
  ...
  nand2  g096(.a(new_n179_), .b(new_n89_), .O(z23));
  ...
  nand2  g127(.a(new_n210_), .b(new_n89_), .O(z30));
