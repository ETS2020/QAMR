...
module FAU ( 
  ...
  aoi21  g091(.a(x30), .b(new_n125_), .c(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z19));
  inv1   g093(.a(x31), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n88_), .c(x10), .O(z20));
  nor2   g095(.a(x10), .b(x09), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(x32), .O(new_n180_));
  inv1   g097(.a(new_n180_), .O(z21));
  nand2  g098(.a(new_n179_), .b(x33), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z22));
  nand2  g100(.a(new_n179_), .b(x34), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z23));
  inv1   g102(.a(x35), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n88_), .c(x10), .O(z24));
  ...
  nand2  g108(.a(new_n179_), .b(x38), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z27));
  nand2  g110(.a(new_n179_), .b(x39), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z28));
  nand2  g112(.a(new_n179_), .b(x40), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z29));
  nand2  g114(.a(new_n179_), .b(x41), .O(new_n198_));
  ...
  nand2  g122(.a(new_n179_), .b(x45), .O(new_n206_));
