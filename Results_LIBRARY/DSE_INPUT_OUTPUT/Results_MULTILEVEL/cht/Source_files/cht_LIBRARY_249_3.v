...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n89_), .O(z10));
  ...
  oai21  g058(.a(new_n140_), .b(new_n113_), .c(new_n141_), .O(new_n142_));
  ...
  nand2  g070(.a(x26), .b(new_n113_), .O(new_n154_));
  ...
  nand2  g076(.a(x28), .b(new_n113_), .O(new_n160_));
  ...
  nand2  g085(.a(x30), .b(new_n113_), .O(new_n169_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n89_), .O(z20));
  ...
  nand2  g096(.a(new_n179_), .b(new_n89_), .O(z21));
  ...
  oai21  g103(.a(x10), .b(new_n171_), .c(x35), .O(new_n187_));
  ...
  nand2  g118(.a(x38), .b(new_n171_), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z27));
  aoi21  g120(.a(new_n98_), .b(x09), .c(new_n198_), .O(new_n204_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n89_), .O(z28));
  nand2  g125(.a(new_n98_), .b(x09), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(x40), .O(new_n210_));
  nand3  g127(.a(x41), .b(new_n98_), .c(x09), .O(new_n211_));
  ...
  nand2  g152(.a(new_n235_), .b(new_n89_), .O(z34));
  inv1   g153(.a(x46), .O(new_n237_));
  aoi21  g154(.a(new_n98_), .b(x09), .c(new_n237_), .O(new_n238_));
  nand3  g155(.a(new_n98_), .b(x09), .c(x00), .O(new_n239_));
  inv1   g156(.a(new_n239_), .O(new_n240_));
  oai21  g157(.a(new_n240_), .b(new_n238_), .c(new_n84_), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n89_), .O(z35));
endmodule
