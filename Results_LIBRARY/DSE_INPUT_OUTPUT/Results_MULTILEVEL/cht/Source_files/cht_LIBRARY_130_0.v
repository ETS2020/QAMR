...
module FAU ( 
  ...
  nand3  g050(.a(new_n133_), .b(new_n98_), .c(x09), .O(new_n134_));
  ...
  nand3  g055(.a(new_n138_), .b(new_n98_), .c(x09), .O(new_n139_));
  ...
  nand3  g060(.a(new_n143_), .b(new_n98_), .c(x09), .O(new_n144_));
  inv1   g061(.a(new_n144_), .O(z13));
  nand2  g062(.a(x25), .b(new_n107_), .O(new_n146_));
  nand2  g063(.a(x26), .b(x08), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(x09), .O(new_n148_));
  and2   g065(.a(new_n148_), .b(new_n98_), .O(z14));
  ...
  nand3  g082(.a(new_n165_), .b(new_n98_), .c(x09), .O(new_n166_));
  ...
  nand3  g087(.a(new_n170_), .b(new_n98_), .c(x09), .O(new_n171_));
  inv1   g088(.a(new_n171_), .O(z19));
  nand3  g089(.a(x32), .b(new_n98_), .c(x09), .O(new_n173_));
  ...
  nand3  g097(.a(x36), .b(new_n98_), .c(x09), .O(new_n181_));
  ...
  nand2  g110(.a(x40), .b(new_n193_), .O(new_n194_));
