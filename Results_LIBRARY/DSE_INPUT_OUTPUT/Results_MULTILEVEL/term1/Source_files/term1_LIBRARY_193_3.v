...
module FAU ( 
  ...
  nor3   g066(.a(new_n110_), .b(new_n89_), .c(new_n88_), .O(new_n111_));
  inv1   g067(.a(x31), .O(new_n112_));
  nand4  g068(.a(new_n60_), .b(new_n112_), .c(new_n82_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n111_), .c(new_n46_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x01), .O(z7));
  ...
  oai21  g088(.a(new_n132_), .b(new_n120_), .c(new_n48_), .O(new_n133_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n120_), .c(new_n48_), .O(new_n166_));
  nand2  g122(.a(new_n137_), .b(new_n112_), .O(new_n167_));
  nor2   g123(.a(new_n112_), .b(new_n101_), .O(new_n168_));
