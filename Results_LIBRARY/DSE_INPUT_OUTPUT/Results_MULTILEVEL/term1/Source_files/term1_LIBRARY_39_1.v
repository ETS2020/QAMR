...
module FAU ( 
  ...
  oai21  g042(.a(new_n86_), .b(new_n61_), .c(new_n48_), .O(z3));
  xor2a  g043(.a(x28), .b(x27), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n85_), .c(new_n48_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n78_), .c(x25), .d(x01), .O(new_n91_));
  ...
  nand3  g054(.a(new_n98_), .b(new_n45_), .c(new_n96_), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n96_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n94_), .d(new_n78_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n93_), .c(new_n61_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n78_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n61_), .c(new_n48_), .O(z6));
  nor4   g066(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n111_));
  nand4  g067(.a(new_n94_), .b(new_n78_), .c(x25), .d(x01), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(new_n48_), .O(new_n113_));
  nand3  g069(.a(x30), .b(x28), .c(x27), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  nand3  g071(.a(new_n98_), .b(new_n45_), .c(x30), .O(new_n116_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n49_), .c(x31), .d(new_n103_), .O(new_n139_));
  nand2  g095(.a(x32), .b(x30), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n120_), .O(new_n141_));
  nand3  g097(.a(new_n79_), .b(new_n122_), .c(x13), .O(new_n142_));
  nand4  g098(.a(new_n49_), .b(x31), .c(x30), .d(new_n97_), .O(new_n143_));
  oai22  g099(.a(new_n143_), .b(new_n142_), .c(new_n49_), .d(new_n122_), .O(new_n144_));
  nand3  g100(.a(new_n79_), .b(new_n124_), .c(x14), .O(new_n145_));
  oai22  g101(.a(new_n145_), .b(new_n143_), .c(new_n49_), .d(x14), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(x18), .c(new_n144_), .d(x19), .O(new_n147_));
  nand3  g103(.a(new_n49_), .b(x31), .c(x30), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n128_), .c(new_n120_), .O(new_n150_));
  oai21  g106(.a(new_n147_), .b(new_n121_), .c(new_n150_), .O(new_n151_));
  inv1   g107(.a(new_n120_), .O(new_n152_));
  nor3   g108(.a(new_n148_), .b(new_n133_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n151_), .b(x16), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(x32), .b(new_n103_), .O(new_n155_));
  nand4  g111(.a(x17), .b(x16), .c(new_n136_), .d(x10), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n149_), .c(x19), .d(x18), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n155_), .c(x28), .O(new_n159_));
  nand2  g115(.a(x16), .b(x15), .O(new_n160_));
  nand2  g116(.a(x18), .b(x17), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n124_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x10), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n161_), .c(new_n136_), .O(new_n164_));
  inv1   g120(.a(x11), .O(new_n165_));
  oai21  g121(.a(new_n161_), .b(new_n165_), .c(new_n130_), .O(new_n166_));
  ...
  aoi22  g126(.a(new_n170_), .b(x32), .c(new_n159_), .d(new_n79_), .O(new_n171_));
  oai21  g127(.a(new_n154_), .b(new_n136_), .c(new_n171_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n141_), .c(x29), .O(new_n173_));
  nand2  g129(.a(x32), .b(new_n45_), .O(new_n174_));
  ...
  nand2  g133(.a(new_n124_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n136_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n170_), .c(new_n48_), .O(new_n181_));
  oai21  g137(.a(new_n120_), .b(new_n103_), .c(x31), .O(new_n182_));
  oai21  g138(.a(new_n120_), .b(x31), .c(new_n182_), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(x29), .c(new_n45_), .d(x30), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  nand4  g142(.a(new_n152_), .b(x31), .c(x30), .d(x29), .O(new_n187_));
  nand2  g143(.a(new_n152_), .b(x29), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n45_), .c(new_n103_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n138_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(x33), .c(new_n186_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n78_), .c(x00), .O(new_n193_));
