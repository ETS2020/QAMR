...
module FAU ( 
  ...
  nor2   g048(.a(new_n92_), .b(new_n55_), .O(new_n93_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n61_), .c(x25), .d(x01), .O(new_n123_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(new_n48_), .d(x31), .O(new_n145_));
  ...
  aoi21  g113(.a(new_n85_), .b(new_n157_), .c(new_n121_), .O(new_n158_));
  ...
  nand4  g121(.a(new_n144_), .b(new_n128_), .c(new_n52_), .d(x31), .O(new_n166_));
  nand2  g122(.a(new_n85_), .b(new_n157_), .O(new_n167_));
  nor2   g123(.a(new_n121_), .b(new_n105_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n167_), .c(new_n156_), .d(new_n128_), .O(new_n169_));
