...
module FAU ( 
  ...
  aoi21  g057(.a(new_n101_), .b(new_n80_), .c(x26), .O(z5));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n80_), .c(x26), .O(z6));
  inv1   g062(.a(new_n85_), .O(new_n107_));
  inv1   g063(.a(new_n86_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n84_), .O(new_n109_));
  nand3  g065(.a(new_n61_), .b(x25), .c(x01), .O(new_n110_));
  nor4   g066(.a(new_n110_), .b(x31), .c(x30), .d(x26), .O(new_n111_));
  oai21  g067(.a(new_n109_), .b(new_n87_), .c(new_n111_), .O(z7));
  inv1   g068(.a(x32), .O(new_n113_));
  nand2  g069(.a(new_n96_), .b(new_n81_), .O(new_n114_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n80_), .c(new_n45_), .d(x00), .O(new_n155_));
  ...
  aoi21  g122(.a(new_n166_), .b(new_n80_), .c(x26), .O(z9));
endmodule
