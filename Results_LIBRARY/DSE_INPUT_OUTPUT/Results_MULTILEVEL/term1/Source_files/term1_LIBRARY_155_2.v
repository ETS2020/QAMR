...
module FAU ( 
  ...
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n89_), .O(new_n135_));
  ...
  oai22  g100(.a(new_n144_), .b(new_n132_), .c(new_n112_), .d(new_n45_), .O(new_n145_));
  nor2   g101(.a(x28), .b(x27), .O(new_n146_));
  nor3   g102(.a(new_n146_), .b(new_n112_), .c(new_n101_), .O(new_n147_));
  inv1   g103(.a(new_n146_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x29), .O(new_n149_));
  aoi22  g105(.a(new_n149_), .b(new_n112_), .c(new_n147_), .d(new_n45_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n145_), .c(new_n128_), .O(new_n151_));
  nand3  g107(.a(new_n149_), .b(x30), .c(new_n45_), .O(new_n152_));
  nand3  g108(.a(new_n148_), .b(new_n112_), .c(x29), .O(new_n153_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n154_), .c(new_n128_), .d(x31), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n151_), .c(x00), .O(new_n170_));
  ...
  nand4  g132(.a(new_n167_), .b(new_n172_), .c(new_n123_), .d(new_n112_), .O(new_n177_));
  ...
  inv1   g137(.a(new_n142_), .O(new_n182_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n132_), .c(x33), .O(new_n187_));
