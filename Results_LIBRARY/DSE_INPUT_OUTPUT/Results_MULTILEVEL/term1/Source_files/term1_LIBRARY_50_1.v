...
module FAU ( 
  ...
  aoi21  g045(.a(new_n89_), .b(new_n85_), .c(new_n56_), .O(new_n90_));
  ...
  aoi21  g055(.a(new_n98_), .b(new_n48_), .c(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n56_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n93_), .c(new_n80_), .d(x25), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n61_), .O(z4));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n62_), .c(new_n80_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n61_), .O(z5));
  nor2   g066(.a(new_n104_), .b(new_n81_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x29), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x30), .c(x21), .O(new_n113_));
  ...
  nand2  g072(.a(new_n116_), .b(new_n98_), .O(new_n117_));
  nor2   g073(.a(new_n81_), .b(x21), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n114_), .c(x28), .d(new_n82_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n62_), .c(new_n80_), .d(x25), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n61_), .O(z6));
  oai21  g078(.a(x31), .b(x30), .c(new_n83_), .O(new_n123_));
  nor2   g079(.a(x31), .b(x21), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n82_), .c(new_n84_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n126_));
  nand3  g082(.a(new_n111_), .b(x30), .c(x29), .O(new_n127_));
  nor2   g083(.a(new_n56_), .b(new_n61_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand4  g085(.a(new_n111_), .b(new_n129_), .c(x30), .d(x29), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n80_), .d(x25), .O(new_n131_));
  aoi21  g087(.a(new_n127_), .b(x31), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n126_), .c(new_n123_), .O(z7));
  ...
  oai21  g100(.a(new_n140_), .b(new_n144_), .c(new_n82_), .O(new_n145_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n138_), .c(new_n48_), .O(new_n150_));
  nand2  g106(.a(new_n104_), .b(new_n81_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x30), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n106_), .O(new_n153_));
  nand2  g109(.a(new_n151_), .b(x29), .O(new_n154_));
  aoi22  g110(.a(new_n154_), .b(new_n45_), .c(new_n153_), .d(x21), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n150_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x32), .O(new_n157_));
  nand3  g113(.a(new_n154_), .b(x30), .c(x21), .O(new_n158_));
  nand3  g114(.a(new_n151_), .b(new_n45_), .c(x29), .O(new_n159_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n82_), .c(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x15), .O(new_n173_));
  nand4  g129(.a(new_n170_), .b(x16), .c(new_n134_), .d(x10), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n160_), .c(new_n49_), .d(x31), .O(new_n176_));
  ...
  nor2   g135(.a(new_n147_), .b(new_n146_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n138_), .c(new_n48_), .O(new_n182_));
  nand2  g138(.a(new_n154_), .b(new_n129_), .O(new_n183_));
  nor2   g139(.a(new_n129_), .b(new_n106_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n151_), .c(new_n45_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(x21), .c(new_n183_), .d(new_n45_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand4  g144(.a(new_n151_), .b(x31), .c(x30), .d(x29), .O(new_n189_));
  oai22  g145(.a(new_n189_), .b(new_n83_), .c(new_n183_), .d(x30), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n175_), .c(new_n53_), .O(new_n191_));
