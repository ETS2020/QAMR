...
module FAU ( 
  ...
  nor3   g057(.a(new_n101_), .b(new_n91_), .c(new_n61_), .O(z5));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n98_), .c(new_n91_), .O(new_n121_));
  ...
  aoi21  g130(.a(new_n149_), .b(new_n118_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n118_), .b(new_n96_), .O(new_n176_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n118_), .c(new_n46_), .d(new_n45_), .O(new_n181_));
