...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n62_), .c(new_n49_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n91_), .c(new_n63_), .d(new_n49_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n91_), .c(new_n63_), .d(new_n81_), .O(new_n106_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n63_), .c(new_n81_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n62_), .c(new_n49_), .O(z6));
  oai21  g072(.a(x31), .b(x30), .c(x00), .O(new_n117_));
  ...
  nor2   g076(.a(new_n57_), .b(new_n62_), .O(new_n121_));
  ...
  nand2  g082(.a(new_n102_), .b(new_n82_), .O(new_n127_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(new_n50_), .d(x31), .O(new_n146_));
  ...
  nand2  g114(.a(new_n129_), .b(new_n158_), .O(new_n159_));
  nor2   g115(.a(new_n122_), .b(new_n101_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n159_), .c(new_n157_), .d(new_n127_), .O(new_n161_));
  ...
  oai21  g121(.a(new_n146_), .b(new_n101_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n81_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n46_), .c(new_n45_), .O(z8));
  nand2  g124(.a(new_n127_), .b(x29), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n145_), .c(new_n54_), .d(new_n122_), .O(new_n170_));
  aoi21  g126(.a(new_n129_), .b(new_n158_), .c(x31), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n169_), .c(new_n151_), .d(new_n148_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n170_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n81_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n46_), .c(new_n45_), .O(z9));
endmodule
