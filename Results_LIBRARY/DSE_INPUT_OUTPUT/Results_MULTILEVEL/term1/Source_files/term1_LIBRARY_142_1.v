...
module FAU ( 
  ...
  nand4  g043(.a(new_n87_), .b(new_n81_), .c(x25), .d(x01), .O(new_n88_));
  aoi21  g044(.a(new_n88_), .b(new_n80_), .c(x27), .O(z3));
  inv1   g045(.a(x25), .O(new_n90_));
  nand3  g046(.a(new_n80_), .b(x28), .c(new_n45_), .O(new_n91_));
  oai21  g047(.a(x28), .b(new_n45_), .c(new_n91_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n87_), .c(new_n81_), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n90_), .c(new_n59_), .O(z4));
  ...
  nand3  g055(.a(new_n99_), .b(new_n61_), .c(new_n81_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x25), .c(x01), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n46_), .O(z5));
  nand3  g059(.a(new_n80_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n80_), .b(x28), .c(new_n104_), .O(new_n105_));
  nor2   g061(.a(new_n80_), .b(x29), .O(new_n106_));
  aoi21  g062(.a(new_n105_), .b(x29), .c(new_n106_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n61_), .c(new_n81_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n59_), .c(new_n46_), .O(z6));
  oai21  g066(.a(x31), .b(x30), .c(new_n45_), .O(new_n111_));
  nor2   g067(.a(new_n80_), .b(new_n97_), .O(new_n112_));
  ...
  nor3   g077(.a(new_n121_), .b(new_n60_), .c(new_n59_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n118_), .c(new_n114_), .d(new_n111_), .O(z7));
  ...
  oai21  g096(.a(new_n140_), .b(new_n128_), .c(new_n46_), .O(new_n141_));
  oai21  g097(.a(x28), .b(x27), .c(x29), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(new_n80_), .c(new_n112_), .d(x27), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  inv1   g101(.a(x32), .O(new_n146_));
  nor2   g102(.a(x30), .b(new_n97_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n106_), .c(x27), .O(new_n148_));
  nand2  g104(.a(new_n147_), .b(x28), .O(new_n149_));
  ...
  nand3  g109(.a(new_n125_), .b(x18), .c(x14), .O(new_n154_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n135_), .c(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x15), .O(new_n163_));
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n124_), .d(x10), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n150_), .c(new_n146_), .d(x31), .O(new_n166_));
  ...
  nor2   g125(.a(new_n138_), .b(new_n137_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n128_), .c(new_n46_), .O(new_n172_));
  nand2  g128(.a(new_n142_), .b(new_n119_), .O(new_n173_));
  aoi21  g129(.a(x31), .b(x29), .c(new_n80_), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(x27), .c(new_n173_), .d(new_n80_), .O(new_n175_));
