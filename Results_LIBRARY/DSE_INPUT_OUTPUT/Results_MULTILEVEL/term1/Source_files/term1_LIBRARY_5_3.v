...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n84_), .c(new_n58_), .O(new_n94_));
  ...
  nand2  g060(.a(x30), .b(x00), .O(new_n105_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n105_), .c(new_n93_), .d(new_n84_), .O(new_n111_));
  ...
  nand3  g071(.a(new_n107_), .b(x30), .c(new_n45_), .O(new_n116_));
  nand3  g072(.a(new_n46_), .b(x28), .c(x27), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x29), .O(new_n119_));
  nand2  g075(.a(x30), .b(new_n106_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n119_), .c(new_n115_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n84_), .c(new_n82_), .d(x25), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n63_), .c(new_n58_), .O(z6));
  oai21  g079(.a(x31), .b(x30), .c(x00), .O(new_n124_));
  nand2  g080(.a(x30), .b(x29), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n107_), .c(x31), .O(new_n126_));
  nand4  g082(.a(new_n92_), .b(new_n90_), .c(new_n88_), .d(new_n86_), .O(new_n127_));
  nor2   g083(.a(new_n60_), .b(new_n63_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand4  g085(.a(new_n108_), .b(new_n129_), .c(x30), .d(x29), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n82_), .d(x25), .O(new_n131_));
  ...
  nand2  g091(.a(new_n135_), .b(new_n83_), .O(new_n136_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n136_), .c(new_n134_), .d(x31), .O(new_n155_));
  aoi21  g111(.a(new_n140_), .b(x14), .c(new_n138_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x17), .c(x16), .d(x15), .O(new_n157_));
  nand2  g113(.a(x16), .b(x15), .O(new_n158_));
  nand2  g114(.a(x18), .b(x17), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n140_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x10), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(new_n152_), .O(new_n162_));
  inv1   g118(.a(x11), .O(new_n163_));
  oai21  g119(.a(new_n159_), .b(new_n163_), .c(new_n146_), .O(new_n164_));
  nand2  g120(.a(x18), .b(x12), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n137_), .O(new_n166_));
  inv1   g122(.a(x13), .O(new_n167_));
  nand2  g123(.a(new_n138_), .b(new_n167_), .O(new_n168_));
  nor2   g124(.a(new_n129_), .b(new_n106_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n166_), .d(new_n136_), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  and2   g127(.a(new_n171_), .b(new_n164_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x32), .O(new_n174_));
  oai21  g130(.a(new_n155_), .b(new_n106_), .c(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n46_), .c(new_n82_), .d(x00), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(z8));
  inv1   g133(.a(x33), .O(new_n178_));
  nand2  g134(.a(new_n136_), .b(x29), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n154_), .c(new_n178_), .d(new_n129_), .O(new_n180_));
  aoi21  g136(.a(new_n138_), .b(new_n167_), .c(x31), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n166_), .c(new_n164_), .d(new_n162_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n179_), .c(new_n160_), .d(new_n157_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n180_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n46_), .c(new_n82_), .d(x00), .O(new_n187_));
