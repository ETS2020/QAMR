...
module FAU ( 
  ...
  nor2   g017(.a(new_n50_), .b(new_n45_), .O(new_n62_));
  nand3  g018(.a(x30), .b(new_n50_), .c(new_n45_), .O(new_n63_));
  inv1   g019(.a(new_n63_), .O(new_n64_));
  oai21  g020(.a(new_n64_), .b(new_n62_), .c(x01), .O(new_n65_));
  ...
  nand3  g033(.a(x30), .b(x03), .c(new_n45_), .O(new_n78_));
  oai21  g034(.a(x03), .b(new_n45_), .c(new_n78_), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(x01), .O(new_n80_));
  aoi21  g036(.a(x30), .b(new_n69_), .c(x02), .O(new_n81_));
  nor2   g037(.a(x03), .b(x02), .O(new_n82_));
  nand4  g038(.a(new_n82_), .b(x30), .c(x06), .d(x05), .O(new_n83_));
  oai21  g039(.a(new_n81_), .b(new_n72_), .c(new_n83_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n66_), .O(new_n85_));
  aoi21  g041(.a(new_n85_), .b(new_n80_), .c(new_n77_), .O(new_n86_));
  aoi21  g042(.a(new_n76_), .b(new_n61_), .c(new_n86_), .O(new_n87_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n90_), .c(new_n89_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n66_), .c(new_n47_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n89_), .d(x25), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n66_), .c(new_n47_), .O(z4));
  inv1   g057(.a(new_n62_), .O(new_n102_));
  inv1   g058(.a(new_n95_), .O(new_n103_));
  inv1   g059(.a(x28), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n90_), .c(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x28), .c(x27), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n102_), .d(new_n89_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x25), .c(x01), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n47_), .O(z5));
  aoi21  g068(.a(x30), .b(new_n50_), .c(new_n45_), .O(new_n113_));
  nand2  g069(.a(new_n105_), .b(x29), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand2  g071(.a(x27), .b(new_n50_), .O(new_n116_));
  nand3  g072(.a(new_n46_), .b(x29), .c(x28), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n113_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n103_), .c(new_n89_), .d(x25), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n66_), .c(new_n47_), .O(z6));
  oai21  g076(.a(x31), .b(new_n45_), .c(new_n46_), .O(new_n121_));
  nor4   g077(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n122_));
  nand3  g078(.a(new_n89_), .b(x25), .c(x01), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nand2  g080(.a(x31), .b(new_n46_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n50_), .c(new_n45_), .O(new_n126_));
  ...
  aoi21  g087(.a(new_n131_), .b(x30), .c(new_n126_), .O(new_n132_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n53_), .c(x31), .d(new_n46_), .O(new_n153_));
