...
module FAU ( 
  ...
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(x31), .d(new_n46_), .O(new_n143_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n154_), .c(new_n47_), .O(new_n172_));
  aoi21  g128(.a(new_n147_), .b(new_n118_), .c(x30), .O(new_n173_));
  nor2   g129(.a(new_n118_), .b(new_n94_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n123_), .c(new_n46_), .O(new_n175_));
  aoi21  g131(.a(new_n173_), .b(x25), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x33), .O(new_n178_));
  nand4  g134(.a(new_n147_), .b(new_n118_), .c(new_n46_), .d(x25), .O(new_n179_));
