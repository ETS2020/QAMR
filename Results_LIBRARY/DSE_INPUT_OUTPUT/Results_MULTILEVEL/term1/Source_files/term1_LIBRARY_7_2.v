...
module FAU ( 
  ...
  nor3   g063(.a(new_n107_), .b(new_n100_), .c(new_n62_), .O(z5));
  ...
  nor2   g079(.a(new_n56_), .b(new_n100_), .O(new_n124_));
  ...
  nand2  g083(.a(x30), .b(x26), .O(new_n128_));
  ...
  nand2  g101(.a(new_n103_), .b(new_n81_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x30), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n102_), .O(new_n148_));
  nand2  g104(.a(new_n146_), .b(x29), .O(new_n149_));
  aoi22  g105(.a(new_n149_), .b(new_n111_), .c(new_n148_), .d(new_n45_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  nand3  g108(.a(new_n149_), .b(x30), .c(new_n45_), .O(new_n153_));
  nand3  g109(.a(new_n146_), .b(new_n111_), .c(x29), .O(new_n154_));
  ...
  nand2  g131(.a(new_n149_), .b(new_n116_), .O(new_n176_));
  nor2   g132(.a(new_n116_), .b(new_n102_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n146_), .c(new_n111_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n45_), .c(new_n176_), .d(new_n111_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  nand4  g137(.a(new_n146_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
