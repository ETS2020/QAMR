...
module FAU ( 
  ...
  nor4   g065(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n110_));
  nand4  g066(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(new_n46_), .O(new_n112_));
  nand3  g068(.a(new_n95_), .b(x30), .c(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand4  g071(.a(new_n95_), .b(new_n115_), .c(x30), .d(x29), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(z7));
  ...
  and2   g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n130_), .c(new_n127_), .d(new_n125_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n122_), .c(new_n46_), .O(new_n139_));
  nand2  g095(.a(new_n94_), .b(new_n80_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x29), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x31), .O(new_n142_));
  xor2a  g098(.a(new_n142_), .b(x30), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  inv1   g101(.a(x32), .O(new_n146_));
  nand3  g102(.a(new_n140_), .b(new_n102_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n141_), .b(x30), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand3  g105(.a(x19), .b(new_n135_), .c(x13), .O(new_n150_));
  nand3  g106(.a(new_n119_), .b(x18), .c(x14), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n150_), .c(new_n131_), .O(new_n152_));
  nand4  g108(.a(x19), .b(x18), .c(new_n131_), .d(x12), .O(new_n153_));
  ...
  nand3  g113(.a(new_n157_), .b(new_n129_), .c(x11), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x15), .O(new_n160_));
  nand4  g116(.a(new_n157_), .b(x16), .c(new_n118_), .d(x10), .O(new_n161_));
  ...
  inv1   g124(.a(new_n140_), .O(new_n169_));
  aoi21  g125(.a(new_n161_), .b(new_n160_), .c(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n168_), .c(x31), .d(x29), .O(new_n171_));
  nor2   g127(.a(new_n115_), .b(new_n93_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n140_), .c(new_n136_), .d(new_n133_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n130_), .c(new_n127_), .d(new_n125_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n122_), .c(x33), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n171_), .c(new_n102_), .O(new_n177_));
  nor3   g133(.a(new_n168_), .b(new_n115_), .c(x30), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n177_), .c(new_n79_), .O(new_n179_));
