...
module FAU ( 
  ...
  nor3   g045(.a(new_n89_), .b(new_n84_), .c(new_n60_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n88_), .c(x25), .d(x22), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n59_), .O(z4));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n96_), .c(new_n84_), .O(new_n99_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n61_), .c(new_n88_), .O(new_n107_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n88_), .c(x22), .d(x00), .O(new_n168_));
  ...
  nand4  g130(.a(new_n143_), .b(new_n170_), .c(new_n119_), .d(new_n104_), .O(new_n175_));
  ...
  aoi21  g143(.a(new_n187_), .b(x22), .c(x26), .O(z9));
endmodule
