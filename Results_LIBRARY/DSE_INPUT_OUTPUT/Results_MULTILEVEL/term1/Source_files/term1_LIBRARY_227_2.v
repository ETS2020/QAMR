...
module FAU ( 
  ...
  nor2   g057(.a(new_n88_), .b(new_n87_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n58_), .c(new_n89_), .O(new_n104_));
  aoi21  g060(.a(new_n101_), .b(new_n99_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n60_), .c(new_n58_), .O(z5));
  nor2   g063(.a(new_n98_), .b(new_n82_), .O(new_n108_));
  oai21  g064(.a(x29), .b(x24), .c(new_n103_), .O(new_n109_));
  inv1   g065(.a(x19), .O(new_n110_));
  nand3  g066(.a(x29), .b(new_n45_), .c(new_n110_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(new_n112_));
  nor2   g068(.a(new_n91_), .b(x29), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n112_), .c(x30), .O(new_n114_));
  inv1   g070(.a(x30), .O(new_n115_));
  nand2  g071(.a(new_n84_), .b(new_n83_), .O(new_n116_));
  nor2   g072(.a(new_n85_), .b(new_n110_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n102_), .c(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n115_), .c(x29), .d(x28), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x27), .c(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  ...
  oai21  g082(.a(new_n125_), .b(x30), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g088(.a(x30), .b(x24), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n85_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n129_), .c(new_n128_), .d(new_n116_), .O(new_n135_));
  nand3  g091(.a(x29), .b(x28), .c(x27), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x31), .O(new_n137_));
  nand3  g093(.a(new_n108_), .b(new_n130_), .c(x29), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nor2   g095(.a(new_n130_), .b(x30), .O(new_n140_));
  aoi22  g096(.a(new_n140_), .b(new_n45_), .c(new_n139_), .d(x30), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n135_), .c(new_n127_), .O(z7));
  nand2  g098(.a(new_n98_), .b(new_n82_), .O(new_n143_));
  ...
  nand3  g103(.a(new_n110_), .b(x18), .c(x14), .O(new_n148_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n83_), .c(x11), .O(new_n155_));
  ...
  nand4  g116(.a(new_n160_), .b(new_n144_), .c(x31), .d(new_n115_), .O(new_n161_));
  ...
  nand4  g121(.a(new_n160_), .b(new_n144_), .c(x31), .d(x30), .O(new_n166_));
  nand2  g122(.a(x32), .b(new_n115_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand2  g125(.a(new_n110_), .b(x14), .O(new_n170_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n58_), .O(z8));
  nor2   g143(.a(new_n181_), .b(new_n180_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n179_), .c(new_n177_), .d(new_n175_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n172_), .c(new_n58_), .O(new_n190_));
  aoi21  g146(.a(new_n165_), .b(new_n130_), .c(x30), .O(new_n191_));
  nor2   g147(.a(new_n130_), .b(new_n100_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n143_), .c(new_n115_), .O(new_n193_));
  aoi21  g149(.a(new_n191_), .b(new_n45_), .c(new_n193_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n190_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  nand4  g152(.a(new_n165_), .b(new_n130_), .c(new_n115_), .d(new_n45_), .O(new_n197_));
  nand4  g153(.a(new_n143_), .b(x31), .c(x30), .d(x29), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n160_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(x33), .c(new_n196_), .O(new_n201_));
