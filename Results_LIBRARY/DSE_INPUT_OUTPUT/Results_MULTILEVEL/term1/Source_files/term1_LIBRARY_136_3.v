...
module FAU ( 
  ...
  nand2  g000(.a(x26), .b(x22), .O(new_n45_));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n95_), .c(new_n78_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n114_), .c(new_n113_), .d(new_n109_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n79_), .O(new_n120_));
  oai21  g076(.a(new_n79_), .b(x22), .c(new_n120_), .O(z7));
  nand2  g077(.a(new_n94_), .b(new_n80_), .O(new_n122_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n123_), .c(x31), .d(new_n100_), .O(new_n142_));
  ...
  nand2  g103(.a(x32), .b(new_n100_), .O(new_n148_));
  ...
  nor3   g118(.a(new_n162_), .b(new_n161_), .c(new_n115_), .O(new_n163_));
  ...
  nand2  g126(.a(x33), .b(new_n100_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n122_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n141_), .b(new_n169_), .c(new_n115_), .d(new_n100_), .O(new_n174_));
