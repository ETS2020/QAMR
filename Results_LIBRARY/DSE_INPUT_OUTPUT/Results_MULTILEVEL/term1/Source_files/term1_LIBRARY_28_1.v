...
module FAU ( 
  ...
  oai21  g058(.a(new_n45_), .b(new_n81_), .c(x29), .O(new_n103_));
  ...
  nand2  g067(.a(x30), .b(new_n104_), .O(new_n112_));
  oai21  g068(.a(new_n111_), .b(new_n104_), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n102_), .c(new_n61_), .d(x28), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n80_), .c(x25), .d(x01), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(z6));
  oai21  g073(.a(x31), .b(x30), .c(new_n45_), .O(new_n118_));
  nand3  g074(.a(x30), .b(x29), .c(x27), .O(new_n119_));
  ...
  nand4  g079(.a(new_n123_), .b(x30), .c(x29), .d(x27), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n80_), .c(x25), .O(new_n125_));
  nor3   g081(.a(new_n125_), .b(new_n60_), .c(new_n59_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n122_), .c(new_n120_), .d(new_n118_), .O(z7));
  inv1   g083(.a(x30), .O(new_n128_));
  nand4  g084(.a(x32), .b(new_n81_), .c(new_n80_), .d(x00), .O(new_n129_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n128_), .c(x29), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n112_), .O(new_n136_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n131_), .O(z8));
  inv1   g131(.a(x33), .O(new_n176_));
  oai21  g132(.a(new_n167_), .b(new_n133_), .c(new_n123_), .O(new_n177_));
  nand3  g133(.a(x31), .b(x30), .c(x29), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n151_), .c(new_n176_), .O(new_n180_));
  oai21  g136(.a(new_n133_), .b(new_n104_), .c(new_n123_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n128_), .O(new_n182_));
  oai21  g138(.a(new_n123_), .b(new_n104_), .c(x30), .O(new_n183_));
  nand2  g139(.a(new_n86_), .b(new_n165_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n156_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n183_), .c(new_n182_), .d(new_n154_), .O(new_n187_));
