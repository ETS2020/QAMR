...
module FAU ( 
  ...
  oai21  g063(.a(new_n104_), .b(new_n99_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n63_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n98_), .c(new_n62_), .O(z5));
  nor2   g066(.a(new_n45_), .b(x29), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n106_), .O(new_n112_));
  nand2  g068(.a(x30), .b(new_n82_), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n82_), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n63_), .d(x28), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n81_), .c(x25), .d(x01), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(z6));
  oai21  g074(.a(x31), .b(x30), .c(new_n99_), .O(new_n119_));
  nor2   g075(.a(new_n45_), .b(new_n105_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x31), .O(new_n122_));
  nand4  g078(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x30), .c(x29), .d(x27), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n81_), .c(x25), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n56_), .c(new_n62_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n123_), .c(new_n122_), .d(new_n119_), .O(z7));
  inv1   g084(.a(x15), .O(new_n129_));
  nand2  g085(.a(new_n91_), .b(x14), .O(new_n130_));
  ...
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n91_), .O(new_n135_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n132_), .c(new_n48_), .O(new_n145_));
  oai21  g101(.a(x28), .b(x27), .c(x29), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n45_), .c(new_n120_), .d(x28), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  nand2  g105(.a(new_n106_), .b(x27), .O(new_n150_));
  oai21  g106(.a(new_n112_), .b(new_n99_), .c(new_n150_), .O(new_n151_));
  ...
  nand3  g115(.a(new_n159_), .b(new_n139_), .c(x11), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x15), .O(new_n162_));
  nand4  g118(.a(new_n159_), .b(x16), .c(new_n129_), .d(x10), .O(new_n163_));
  ...
  nor2   g124(.a(new_n142_), .b(new_n141_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n132_), .c(new_n48_), .O(new_n171_));
  nand2  g127(.a(new_n146_), .b(new_n124_), .O(new_n172_));
  ...
  nand4  g132(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n177_));
  oai21  g133(.a(new_n172_), .b(x30), .c(new_n177_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n164_), .c(new_n53_), .O(new_n179_));
