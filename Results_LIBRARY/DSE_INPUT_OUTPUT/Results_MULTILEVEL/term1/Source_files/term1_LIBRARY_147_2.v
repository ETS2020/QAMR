...
module FAU ( 
  ...
  oai21  g069(.a(new_n113_), .b(new_n62_), .c(new_n48_), .O(z6));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n103_), .b(new_n115_), .c(x29), .O(new_n116_));
  ...
  nor2   g078(.a(new_n56_), .b(new_n81_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n122_), .c(new_n120_), .d(x01), .O(new_n124_));
  ...
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n115_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n142_));
  oai22  g098(.a(new_n142_), .b(new_n130_), .c(new_n110_), .d(new_n45_), .O(new_n143_));
  nor2   g099(.a(x28), .b(x27), .O(new_n144_));
  nor3   g100(.a(new_n144_), .b(new_n110_), .c(new_n102_), .O(new_n145_));
  inv1   g101(.a(new_n144_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(new_n110_), .c(new_n145_), .d(new_n45_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n143_), .c(new_n49_), .O(new_n149_));
  nand3  g105(.a(new_n147_), .b(x30), .c(new_n45_), .O(new_n150_));
  nand3  g106(.a(new_n146_), .b(new_n110_), .c(x29), .O(new_n151_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n152_), .c(new_n49_), .d(x31), .O(new_n166_));
  ...
  nand4  g125(.a(new_n165_), .b(new_n53_), .c(x31), .d(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n110_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n146_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n165_), .b(new_n53_), .c(new_n115_), .d(new_n110_), .O(new_n174_));
  ...
  inv1   g133(.a(new_n139_), .O(new_n178_));
  ...
  nand4  g138(.a(new_n182_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n130_), .c(x33), .O(new_n184_));
