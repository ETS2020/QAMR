...
module FAU ( 
  ...
  nand2  g019(.a(new_n47_), .b(new_n50_), .O(new_n64_));
  aoi21  g020(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(new_n65_));
  nand2  g021(.a(x05), .b(new_n47_), .O(new_n66_));
  nand3  g022(.a(new_n66_), .b(x06), .c(new_n50_), .O(new_n67_));
  ...
  nand4  g031(.a(x06), .b(x05), .c(new_n47_), .d(new_n50_), .O(new_n76_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n83_), .c(new_n55_), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n82_), .c(new_n61_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n89_), .c(new_n55_), .O(new_n93_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n63_), .d(new_n55_), .O(new_n101_));
  ...
  nor2   g063(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n63_), .c(new_n55_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n61_), .c(new_n59_), .O(z6));
  ...
  nor2   g070(.a(new_n85_), .b(new_n84_), .O(new_n115_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n55_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(new_n116_), .d(new_n112_), .O(z7));
  nand2  g079(.a(new_n97_), .b(new_n83_), .O(new_n124_));
  ...
  nand4  g098(.a(new_n142_), .b(z0), .c(x31), .d(new_n103_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n142_), .b(z0), .c(x31), .d(x30), .O(new_n148_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n55_), .c(x00), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(z8));
  nand4  g125(.a(new_n142_), .b(new_n54_), .c(x31), .d(x30), .O(new_n170_));
  ...
  nand4  g129(.a(new_n142_), .b(new_n54_), .c(new_n119_), .d(new_n103_), .O(new_n174_));
  ...
  nand3  g141(.a(new_n185_), .b(new_n55_), .c(x00), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n59_), .O(z9));
endmodule
