...
module FAU ( 
  ...
  nor3   g047(.a(new_n91_), .b(new_n89_), .c(new_n58_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n109_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n79_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n89_), .O(new_n122_));
