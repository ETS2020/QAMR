...
module FAU ( 
  ...
  nand4  g067(.a(new_n111_), .b(new_n100_), .c(new_n60_), .d(x25), .O(new_n112_));
  ...
  nor2   g078(.a(new_n122_), .b(new_n96_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n118_), .c(new_n117_), .d(new_n115_), .O(z7));
  nand2  g080(.a(new_n102_), .b(new_n80_), .O(new_n125_));
  inv1   g081(.a(x32), .O(new_n126_));
  nand3  g082(.a(x19), .b(new_n85_), .c(x13), .O(new_n127_));
  nand3  g083(.a(new_n88_), .b(x18), .c(x14), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(new_n82_), .O(new_n129_));
  nand4  g085(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n130_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n126_), .c(x31), .d(new_n45_), .O(new_n142_));
  ...
  nand2  g106(.a(new_n88_), .b(x14), .O(new_n151_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(new_n88_), .O(new_n156_));
  ...
  nand2  g126(.a(x33), .b(new_n45_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n125_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n141_), .b(new_n169_), .c(new_n120_), .d(new_n45_), .O(new_n174_));
