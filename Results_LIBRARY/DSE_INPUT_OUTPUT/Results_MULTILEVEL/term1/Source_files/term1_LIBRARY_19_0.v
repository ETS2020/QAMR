...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n81_), .c(new_n46_), .O(new_n91_));
  ...
  nand3  g051(.a(new_n95_), .b(new_n90_), .c(new_n46_), .O(new_n96_));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n89_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(x25), .d(x01), .O(new_n106_));
  ...
  nor2   g066(.a(new_n101_), .b(new_n81_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(x29), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n109_), .c(new_n89_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n100_), .c(x25), .d(x01), .O(new_n114_));
  ...
  nand4  g076(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n84_), .O(new_n121_));
  ...
  nand2  g085(.a(new_n129_), .b(new_n46_), .O(z7));
  nand2  g086(.a(new_n101_), .b(new_n81_), .O(new_n131_));
  ...
  nand2  g112(.a(x32), .b(new_n110_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  aoi21  g114(.a(new_n136_), .b(x14), .c(new_n134_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(x17), .c(x16), .O(new_n160_));
  ...
  nand2  g126(.a(new_n134_), .b(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x31), .O(new_n172_));
  aoi21  g128(.a(new_n169_), .b(new_n133_), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n161_), .c(x32), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x00), .O(new_n176_));
  aoi21  g132(.a(new_n158_), .b(new_n155_), .c(new_n176_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n154_), .c(x26), .O(z8));
  inv1   g134(.a(x33), .O(new_n179_));
  nand4  g135(.a(new_n150_), .b(new_n179_), .c(x31), .d(x30), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n110_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n131_), .c(x29), .O(new_n183_));
  nand4  g139(.a(new_n150_), .b(new_n179_), .c(new_n124_), .d(new_n110_), .O(new_n184_));
  nand2  g140(.a(x33), .b(x30), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g142(.a(new_n169_), .b(new_n133_), .O(new_n187_));
  xnor2a g143(.a(x31), .b(x30), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n171_), .c(new_n187_), .d(new_n168_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n166_), .c(new_n164_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n161_), .c(x33), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x00), .O(new_n193_));
  aoi21  g149(.a(new_n186_), .b(new_n155_), .c(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n183_), .c(x26), .O(z9));
endmodule
