...
module FAU ( 
  ...
  nor2   g074(.a(new_n56_), .b(new_n80_), .O(new_n119_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n49_), .c(x31), .d(new_n101_), .O(new_n142_));
  ...
  nand4  g102(.a(new_n141_), .b(new_n49_), .c(x31), .d(x30), .O(new_n147_));
  ...
  nor3   g118(.a(new_n162_), .b(new_n161_), .c(new_n109_), .O(new_n163_));
  ...
  nand4  g124(.a(new_n141_), .b(new_n53_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n101_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n123_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n141_), .b(new_n53_), .c(new_n109_), .d(new_n101_), .O(new_n173_));
