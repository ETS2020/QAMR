...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n83_), .c(new_n45_), .d(x25), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(new_n62_), .c(new_n48_), .O(z3));
  ...
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n64_), .d(new_n45_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n92_), .c(new_n62_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n64_), .c(new_n45_), .d(x25), .O(new_n110_));
  ...
  nand3  g100(.a(new_n144_), .b(new_n58_), .c(x31), .O(new_n145_));
  ...
  oai21  g106(.a(new_n145_), .b(new_n104_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g116(.a(new_n156_), .b(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n136_), .O(new_n162_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n152_), .c(new_n148_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n45_), .c(x00), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n48_), .O(z8));
  aoi21  g126(.a(new_n143_), .b(new_n141_), .c(x33), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x31), .c(x30), .d(new_n45_), .O(new_n172_));
  ...
  nand4  g131(.a(new_n171_), .b(new_n119_), .c(new_n104_), .d(new_n45_), .O(new_n176_));
