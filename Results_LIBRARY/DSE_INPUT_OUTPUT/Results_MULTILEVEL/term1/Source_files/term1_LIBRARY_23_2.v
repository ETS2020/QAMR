...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n85_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n63_), .c(new_n82_), .d(new_n81_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(x25), .c(new_n45_), .d(x01), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n63_), .d(new_n81_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(x25), .c(new_n45_), .d(x01), .O(new_n102_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n94_), .c(new_n63_), .d(new_n81_), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x25), .c(new_n45_), .d(x01), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(z6));
  nand3  g077(.a(new_n106_), .b(x30), .c(x29), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x31), .O(new_n123_));
  nor2   g079(.a(new_n86_), .b(new_n84_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n93_), .c(new_n90_), .d(x17), .O(new_n125_));
  nand3  g081(.a(new_n63_), .b(new_n45_), .c(x01), .O(new_n126_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n129_), .c(new_n81_), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n127_), .c(new_n125_), .d(new_n123_), .O(z7));
  ...
  oai21  g112(.a(new_n151_), .b(new_n113_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g114(.a(new_n91_), .b(x14), .O(new_n159_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n91_), .O(new_n164_));
