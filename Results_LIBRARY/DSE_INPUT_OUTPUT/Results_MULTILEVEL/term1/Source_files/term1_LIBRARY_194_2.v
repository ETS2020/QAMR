...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n60_), .c(new_n47_), .O(z3));
  ...
  nor3   g056(.a(new_n100_), .b(new_n90_), .c(new_n60_), .O(z5));
  ...
  nor2   g075(.a(new_n61_), .b(new_n90_), .O(new_n120_));
  ...
  oai22  g128(.a(new_n172_), .b(new_n155_), .c(new_n102_), .d(new_n45_), .O(new_n173_));
  nand2  g129(.a(new_n148_), .b(new_n110_), .O(new_n174_));
  nor2   g130(.a(new_n110_), .b(new_n95_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n124_), .c(new_n102_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(new_n45_), .c(new_n174_), .d(new_n102_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x33), .O(new_n179_));
  nand4  g135(.a(new_n124_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
  oai22  g136(.a(new_n180_), .b(x26), .c(new_n174_), .d(x30), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n143_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(x33), .c(new_n179_), .O(new_n183_));
