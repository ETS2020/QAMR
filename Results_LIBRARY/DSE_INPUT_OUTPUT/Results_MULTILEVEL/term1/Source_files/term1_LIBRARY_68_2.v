...
module FAU ( 
  ...
  nand3  g029(.a(new_n73_), .b(new_n70_), .c(x01), .O(new_n74_));
  aoi21  g030(.a(new_n74_), .b(new_n69_), .c(new_n58_), .O(new_n75_));
  xnor2a g031(.a(x07), .b(x04), .O(new_n76_));
  aoi21  g032(.a(x30), .b(x02), .c(new_n45_), .O(new_n77_));
  nor2   g033(.a(new_n77_), .b(new_n62_), .O(new_n78_));
  nor4   g034(.a(new_n72_), .b(new_n60_), .c(new_n45_), .d(new_n61_), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(new_n78_), .c(new_n59_), .O(new_n80_));
  nand3  g036(.a(new_n70_), .b(new_n49_), .c(x02), .O(new_n81_));
  ...
  nor2   g042(.a(new_n86_), .b(new_n75_), .O(new_n87_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n71_), .c(new_n70_), .d(new_n90_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n89_), .c(x25), .d(x01), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z3));
  nand3  g056(.a(new_n70_), .b(x28), .c(new_n90_), .O(new_n101_));
  oai21  g057(.a(x28), .b(new_n90_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n96_), .c(new_n71_), .d(new_n89_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x25), .c(x01), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n70_), .O(z4));
  inv1   g062(.a(x29), .O(new_n107_));
  inv1   g063(.a(x28), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n90_), .O(new_n109_));
  nand3  g065(.a(new_n107_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n109_), .b(new_n107_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n96_), .c(new_n71_), .d(new_n89_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x25), .c(x01), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n70_), .O(z5));
  nand3  g071(.a(new_n60_), .b(x28), .c(x27), .O(new_n116_));
  oai21  g072(.a(new_n109_), .b(new_n60_), .c(new_n116_), .O(new_n117_));
  nor2   g073(.a(new_n60_), .b(x29), .O(new_n118_));
  aoi21  g074(.a(new_n117_), .b(x29), .c(new_n118_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n95_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n71_), .c(new_n89_), .d(x25), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n59_), .c(new_n70_), .O(z6));
  oai21  g078(.a(x31), .b(x06), .c(new_n60_), .O(new_n123_));
  nor4   g079(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n124_));
  nand4  g080(.a(new_n71_), .b(new_n89_), .c(x25), .d(x01), .O(new_n125_));
  ...
  nand3  g085(.a(new_n109_), .b(new_n129_), .c(x29), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nor2   g087(.a(new_n129_), .b(x30), .O(new_n132_));
  aoi22  g088(.a(new_n132_), .b(new_n45_), .c(new_n131_), .d(x30), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n126_), .O(z7));
  nand2  g090(.a(new_n108_), .b(new_n90_), .O(new_n135_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n136_), .c(x31), .d(new_n60_), .O(new_n155_));
  ...
  nand2  g116(.a(x32), .b(new_n60_), .O(new_n161_));
  ...
  nor3   g131(.a(new_n175_), .b(new_n174_), .c(new_n129_), .O(new_n176_));
  ...
  nand3  g135(.a(new_n179_), .b(new_n89_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n70_), .O(z8));
  nor2   g137(.a(new_n175_), .b(new_n174_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n173_), .c(new_n171_), .d(new_n169_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n166_), .c(new_n70_), .O(new_n184_));
  aoi21  g140(.a(new_n159_), .b(new_n129_), .c(x30), .O(new_n185_));
  nor2   g141(.a(new_n129_), .b(new_n107_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n135_), .c(new_n60_), .O(new_n187_));
  aoi21  g143(.a(new_n185_), .b(new_n45_), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n184_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand4  g146(.a(new_n159_), .b(new_n129_), .c(new_n60_), .d(new_n45_), .O(new_n191_));
  nand4  g147(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n154_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(x33), .c(new_n190_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n89_), .c(x00), .O(new_n196_));
