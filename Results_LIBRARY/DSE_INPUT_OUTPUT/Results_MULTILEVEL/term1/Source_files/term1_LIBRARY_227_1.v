...
module FAU ( 
  ...
  nand3  g063(.a(new_n107_), .b(x30), .c(x24), .O(new_n108_));
  ...
  inv1   g067(.a(new_n89_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n86_), .c(new_n84_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nor2   g070(.a(new_n82_), .b(x24), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n109_), .c(x28), .d(new_n87_), .O(new_n116_));
  ...
  nand2  g076(.a(new_n120_), .b(new_n58_), .O(new_n121_));
  nand2  g077(.a(new_n107_), .b(x31), .O(new_n122_));
  nand3  g078(.a(new_n112_), .b(new_n86_), .c(new_n84_), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  nand4  g080(.a(new_n100_), .b(new_n124_), .c(x30), .d(x29), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n123_), .c(new_n122_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x24), .O(new_n127_));
  oai21  g083(.a(new_n123_), .b(new_n87_), .c(new_n124_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n45_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n127_), .c(new_n121_), .O(z7));
  nand2  g086(.a(new_n99_), .b(new_n82_), .O(new_n131_));
  ...
  nand4  g110(.a(new_n149_), .b(new_n132_), .c(x31), .d(x30), .O(new_n155_));
  nand2  g111(.a(x32), .b(new_n45_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g114(.a(new_n87_), .b(x14), .O(new_n159_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n87_), .O(new_n164_));
  ...
  nand2  g131(.a(new_n175_), .b(new_n58_), .O(z8));
  nor2   g132(.a(new_n170_), .b(new_n169_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n161_), .c(new_n58_), .O(new_n179_));
  nand2  g135(.a(new_n154_), .b(new_n124_), .O(new_n180_));
  nor2   g136(.a(new_n124_), .b(new_n98_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n131_), .c(new_n45_), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(x24), .c(new_n180_), .d(new_n45_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n179_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  nand4  g141(.a(new_n131_), .b(x31), .c(x30), .d(x29), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n88_), .c(new_n180_), .d(x30), .O(new_n187_));
