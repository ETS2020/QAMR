...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n61_), .d(new_n82_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n80_), .O(z5));
  nand3  g064(.a(new_n79_), .b(x28), .c(x27), .O(new_n109_));
  oai21  g065(.a(new_n102_), .b(new_n79_), .c(new_n109_), .O(new_n110_));
  nor2   g066(.a(new_n79_), .b(x29), .O(new_n111_));
  aoi21  g067(.a(new_n110_), .b(x29), .c(new_n111_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n88_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n61_), .c(new_n82_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n59_), .c(new_n80_), .O(z6));
  oai21  g071(.a(x32), .b(x31), .c(new_n79_), .O(new_n116_));
  nor4   g072(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n84_), .O(new_n117_));
  nand4  g073(.a(new_n61_), .b(new_n82_), .c(x25), .d(x01), .O(new_n118_));
  ...
  nor2   g080(.a(x32), .b(new_n122_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n79_), .c(new_n124_), .O(new_n126_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n55_), .c(x31), .d(new_n79_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(z0), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n128_), .c(x29), .O(new_n149_));
  nand2  g105(.a(new_n128_), .b(x29), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n146_), .c(new_n55_), .d(x31), .O(new_n151_));
  nand2  g107(.a(new_n132_), .b(x14), .O(new_n152_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n132_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x10), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n144_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n156_), .b(new_n160_), .c(new_n138_), .O(new_n161_));
  ...
  nand4  g127(.a(new_n146_), .b(new_n46_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n79_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n128_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n146_), .b(new_n46_), .c(new_n122_), .d(new_n79_), .O(new_n176_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n154_), .c(x33), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n179_), .c(new_n175_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n82_), .c(x00), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n80_), .O(z9));
endmodule
