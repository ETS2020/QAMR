...
module FAU ( 
  ...
  inv1   g070(.a(new_n91_), .O(new_n115_));
  nand3  g071(.a(new_n88_), .b(new_n85_), .c(new_n82_), .O(new_n116_));
  nand3  g072(.a(new_n60_), .b(x25), .c(x01), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(x31), .c(x30), .d(x26), .O(new_n118_));
  oai21  g074(.a(new_n116_), .b(new_n115_), .c(new_n118_), .O(z7));
  ...
  nand4  g092(.a(new_n136_), .b(new_n121_), .c(new_n120_), .d(x31), .O(new_n137_));
  aoi21  g093(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(x17), .c(x16), .d(x15), .O(new_n139_));
  nand2  g095(.a(x16), .b(x15), .O(new_n140_));
  nand2  g096(.a(x18), .b(x17), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(new_n89_), .O(new_n142_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n150_), .c(new_n148_), .d(new_n121_), .O(new_n153_));
  ...
  nand2  g117(.a(new_n121_), .b(x29), .O(new_n162_));
