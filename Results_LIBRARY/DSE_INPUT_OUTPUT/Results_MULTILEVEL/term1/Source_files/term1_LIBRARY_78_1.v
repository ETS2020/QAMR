...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n90_), .c(new_n45_), .O(new_n95_));
  ...
  nand2  g071(.a(new_n115_), .b(new_n93_), .O(z7));
  inv1   g072(.a(x32), .O(new_n117_));
  nand2  g073(.a(new_n99_), .b(new_n81_), .O(new_n118_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n118_), .c(new_n117_), .d(x31), .O(new_n137_));
  aoi21  g093(.a(new_n122_), .b(x14), .c(new_n120_), .O(new_n138_));
  ...
  nand2  g105(.a(new_n120_), .b(new_n149_), .O(new_n150_));
  nor2   g106(.a(new_n113_), .b(new_n101_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n150_), .c(new_n148_), .d(new_n118_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  and2   g109(.a(new_n153_), .b(new_n146_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n144_), .c(new_n142_), .d(new_n139_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  oai21  g112(.a(new_n137_), .b(new_n101_), .c(new_n156_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n45_), .c(new_n93_), .d(x00), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  nand2  g116(.a(new_n118_), .b(x29), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n136_), .c(new_n160_), .d(new_n113_), .O(new_n162_));
  aoi21  g118(.a(new_n120_), .b(new_n149_), .c(x31), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n148_), .c(new_n146_), .d(new_n144_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n161_), .c(new_n142_), .d(new_n139_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x33), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n45_), .c(new_n93_), .d(x00), .O(new_n169_));
