...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n56_), .c(new_n47_), .O(new_n93_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n56_), .d(new_n47_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n82_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z5));
  inv1   g068(.a(x01), .O(new_n113_));
  inv1   g069(.a(new_n92_), .O(new_n114_));
  nand4  g070(.a(new_n62_), .b(x28), .c(x27), .d(x05), .O(new_n115_));
  oai21  g071(.a(new_n106_), .b(new_n62_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g075(.a(new_n119_), .b(new_n56_), .c(new_n82_), .d(x25), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n113_), .O(z6));
  inv1   g077(.a(x05), .O(new_n122_));
  oai21  g078(.a(x31), .b(new_n122_), .c(new_n62_), .O(new_n123_));
  nand3  g079(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x31), .O(new_n125_));
  nand4  g081(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n126_));
  nor2   g082(.a(new_n55_), .b(new_n113_), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  nand4  g084(.a(new_n106_), .b(new_n128_), .c(x30), .d(x29), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n127_), .c(new_n82_), .d(x25), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n126_), .c(new_n125_), .d(new_n123_), .O(z7));
  nand2  g088(.a(new_n105_), .b(new_n83_), .O(new_n133_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n48_), .c(x31), .d(new_n62_), .O(new_n152_));
  ...
  nand4  g112(.a(new_n151_), .b(new_n48_), .c(x31), .d(x30), .O(new_n157_));
  nand2  g113(.a(x32), .b(new_n62_), .O(new_n158_));
  ...
  aoi21  g137(.a(new_n156_), .b(new_n128_), .c(x30), .O(new_n182_));
  nor2   g138(.a(new_n128_), .b(new_n104_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n133_), .c(new_n62_), .O(new_n184_));
  aoi21  g140(.a(new_n182_), .b(x05), .c(new_n184_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n181_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x33), .O(new_n187_));
  nand4  g143(.a(new_n156_), .b(new_n128_), .c(new_n62_), .d(x05), .O(new_n188_));
  nand4  g144(.a(new_n133_), .b(x31), .c(x30), .d(x29), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n151_), .c(new_n52_), .O(new_n191_));
