...
module FAU ( 
  ...
  nand4  g046(.a(new_n90_), .b(new_n84_), .c(new_n58_), .d(x25), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n61_), .c(new_n46_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n58_), .d(x25), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n61_), .c(new_n46_), .O(z4));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n63_), .d(new_n58_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n96_), .c(new_n61_), .O(z5));
  ...
  nand4  g066(.a(new_n110_), .b(new_n63_), .c(new_n58_), .d(x25), .O(new_n111_));
  ...
  inv1   g071(.a(new_n88_), .O(new_n116_));
  nor2   g072(.a(new_n86_), .b(new_n85_), .O(new_n117_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n58_), .c(x00), .O(new_n171_));
  ...
  nand3  g145(.a(new_n189_), .b(new_n58_), .c(x00), .O(new_n190_));
