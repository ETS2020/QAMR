...
module FAU ( 
  ...
  nand3  g014(.a(new_n58_), .b(new_n52_), .c(new_n49_), .O(z1));
  xnor2a g015(.a(x07), .b(x04), .O(new_n60_));
  oai21  g016(.a(new_n57_), .b(new_n56_), .c(x01), .O(new_n61_));
  inv1   g017(.a(x01), .O(new_n62_));
  nand2  g018(.a(x05), .b(new_n55_), .O(new_n63_));
  nand3  g019(.a(new_n63_), .b(x06), .c(new_n54_), .O(new_n64_));
  nand2  g020(.a(x06), .b(new_n54_), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(x05), .c(new_n55_), .O(new_n66_));
  ...
  nand3  g025(.a(new_n69_), .b(new_n60_), .c(new_n49_), .O(new_n70_));
  xor2a  g026(.a(x07), .b(x04), .O(new_n71_));
  nand2  g027(.a(new_n51_), .b(x01), .O(new_n72_));
  and2   g028(.a(x06), .b(x05), .O(new_n73_));
  aoi22  g029(.a(new_n73_), .b(new_n57_), .c(new_n65_), .d(new_n63_), .O(new_n74_));
  oai21  g030(.a(new_n74_), .b(x01), .c(new_n72_), .O(new_n75_));
  nand3  g031(.a(new_n75_), .b(new_n71_), .c(new_n49_), .O(new_n76_));
  ...
  nand4  g042(.a(new_n86_), .b(new_n80_), .c(new_n46_), .d(x25), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(new_n62_), .c(new_n49_), .O(z3));
  inv1   g044(.a(x25), .O(new_n89_));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n86_), .c(new_n46_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n89_), .c(new_n62_), .O(z4));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n93_), .d(new_n46_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x25), .c(x01), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n49_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n93_), .c(new_n46_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n62_), .O(z6));
  ...
  nor2   g073(.a(new_n56_), .b(new_n62_), .O(new_n118_));
  ...
  nand2  g080(.a(new_n96_), .b(new_n80_), .O(new_n125_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n50_), .c(x31), .O(new_n144_));
  nand2  g100(.a(x32), .b(x30), .O(new_n145_));
  oai21  g101(.a(new_n144_), .b(x30), .c(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n125_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n125_), .b(x29), .O(new_n148_));
  nand2  g104(.a(x32), .b(new_n104_), .O(new_n149_));
  oai21  g105(.a(new_n144_), .b(new_n104_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n129_), .b(x14), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(x18), .c(x17), .d(x16), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n141_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x15), .O(new_n154_));
  nand2  g110(.a(x18), .b(x17), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(new_n129_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n155_), .c(new_n141_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n155_), .b(new_n159_), .c(new_n135_), .O(new_n160_));
  ...
  aoi21  g122(.a(new_n150_), .b(new_n148_), .c(new_n166_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n147_), .c(new_n45_), .O(z8));
  nand4  g124(.a(new_n143_), .b(new_n53_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n104_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n125_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n143_), .b(new_n53_), .c(new_n120_), .d(new_n104_), .O(new_n173_));
  nand2  g129(.a(x33), .b(x30), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n148_), .O(new_n176_));
  ...
  nand3  g140(.a(new_n184_), .b(new_n46_), .c(x00), .O(new_n185_));
