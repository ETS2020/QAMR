...
module FAU ( 
  ...
  and2   g048(.a(new_n92_), .b(new_n61_), .O(new_n93_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n61_), .d(new_n45_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n96_), .c(x25), .d(x01), .O(new_n109_));
  ...
  nor2   g071(.a(new_n115_), .b(new_n90_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand4  g073(.a(new_n61_), .b(new_n117_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n116_), .c(new_n45_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n96_), .O(z7));
  inv1   g076(.a(x32), .O(new_n121_));
  nand2  g077(.a(new_n102_), .b(new_n80_), .O(new_n122_));
  nand3  g078(.a(x19), .b(new_n87_), .c(x13), .O(new_n123_));
  inv1   g079(.a(x19), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n123_), .c(new_n84_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n127_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n122_), .c(new_n121_), .d(x31), .O(new_n139_));
  aoi21  g095(.a(new_n124_), .b(x14), .c(new_n87_), .O(new_n140_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n84_), .O(new_n150_));
  inv1   g106(.a(x13), .O(new_n151_));
  nand2  g107(.a(new_n87_), .b(new_n151_), .O(new_n152_));
  nor2   g108(.a(new_n117_), .b(new_n104_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n152_), .c(new_n150_), .d(new_n122_), .O(new_n154_));
  ...
  oai21  g114(.a(new_n139_), .b(new_n104_), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n45_), .c(new_n96_), .d(x00), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(z8));
  inv1   g117(.a(x33), .O(new_n162_));
  nand2  g118(.a(new_n122_), .b(x29), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n138_), .c(new_n162_), .d(new_n117_), .O(new_n164_));
  aoi21  g120(.a(new_n87_), .b(new_n151_), .c(x31), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n150_), .c(new_n148_), .d(new_n146_), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n163_), .c(new_n144_), .d(new_n141_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x33), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n164_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n45_), .c(new_n96_), .d(x00), .O(new_n171_));
