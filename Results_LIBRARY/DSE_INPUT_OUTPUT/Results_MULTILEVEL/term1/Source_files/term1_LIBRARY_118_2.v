...
module FAU ( 
  ...
  aoi21  g11(.a(new_n55_), .b(new_n51_), .c(new_n46_), .O(z1));
  ...
  nand3  g67(.a(new_n102_), .b(new_n111_), .c(x29), .O(new_n112_));
  aoi22  g68(.a(new_n112_), .b(new_n110_), .c(new_n89_), .d(new_n85_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n99_), .c(x25), .d(x01), .O(new_n114_));
  ...
  inv1   g75(.a(new_n88_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n85_), .O(new_n121_));
  nand3  g77(.a(new_n99_), .b(x01), .c(new_n45_), .O(new_n122_));
  inv1   g78(.a(new_n122_), .O(new_n123_));
  inv1   g79(.a(x25), .O(new_n124_));
  inv1   g80(.a(new_n102_), .O(new_n125_));
  inv1   g81(.a(x31), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(x30), .c(x29), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n125_), .c(new_n93_), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n123_), .c(new_n121_), .d(new_n117_), .O(z7));
  zero   g86(.O(z8));
  zero   g87(.O(z9));
endmodule
