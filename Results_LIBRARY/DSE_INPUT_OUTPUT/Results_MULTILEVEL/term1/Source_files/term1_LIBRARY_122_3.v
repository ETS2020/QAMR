...
module FAU ( 
  ...
  nor2   g075(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  ...
  oai22  g094(.a(new_n138_), .b(new_n126_), .c(x30), .d(new_n45_), .O(new_n139_));
  nor2   g095(.a(x28), .b(x27), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n95_), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n46_), .c(new_n45_), .O(new_n143_));
  ...
  nand4  g104(.a(new_n144_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n149_));
  oai21  g105(.a(new_n141_), .b(new_n46_), .c(new_n149_), .O(new_n150_));
  ...
  nand2  g127(.a(x33), .b(new_n46_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n144_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n165_), .b(new_n170_), .c(new_n117_), .d(new_n46_), .O(new_n175_));
