...
module FAU ( 
  ...
  aoi21  g035(.a(new_n79_), .b(x26), .c(new_n57_), .O(z2));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n57_), .c(x26), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n89_), .c(new_n62_), .d(new_n45_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(x25), .c(new_n57_), .d(x01), .O(new_n115_));
  ...
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n84_), .O(new_n122_));
  nand3  g078(.a(new_n62_), .b(new_n57_), .c(x01), .O(new_n123_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n101_), .c(new_n45_), .O(new_n128_));
  ...
  nand4  g131(.a(new_n175_), .b(new_n45_), .c(new_n57_), .d(x00), .O(new_n176_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n45_), .c(new_n57_), .d(x00), .O(new_n195_));
