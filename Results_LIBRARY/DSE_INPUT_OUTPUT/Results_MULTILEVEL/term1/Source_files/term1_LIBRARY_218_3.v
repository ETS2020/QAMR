...
module FAU ( 
  ...
  nand2  g077(.a(new_n96_), .b(new_n81_), .O(new_n122_));
  ...
  oai22  g126(.a(new_n170_), .b(new_n153_), .c(x30), .d(new_n45_), .O(new_n171_));
  ...
  aoi21  g130(.a(new_n172_), .b(new_n45_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  nand4  g133(.a(new_n146_), .b(new_n117_), .c(new_n46_), .d(new_n45_), .O(new_n178_));
