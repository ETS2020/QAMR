...
module FAU ( 
  ...
  nand3  g043(.a(new_n87_), .b(new_n81_), .c(new_n45_), .O(new_n88_));
  nor3   g044(.a(new_n88_), .b(new_n80_), .c(new_n61_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n87_), .c(new_n45_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n80_), .c(new_n61_), .O(z4));
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n62_), .d(new_n45_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n80_), .c(new_n61_), .O(z5));
  ...
  nor2   g070(.a(new_n56_), .b(new_n61_), .O(new_n115_));
  ...
  nor2   g075(.a(new_n119_), .b(new_n80_), .O(new_n120_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n49_), .c(x31), .d(new_n101_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n140_), .b(new_n49_), .c(x31), .d(x30), .O(new_n146_));
  nand2  g102(.a(x32), .b(new_n101_), .O(new_n147_));
  ...
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n117_), .O(new_n162_));
  ...
  nand4  g123(.a(x33), .b(new_n132_), .c(x15), .d(x00), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n45_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n158_), .O(new_n170_));
  nand4  g126(.a(new_n140_), .b(new_n53_), .c(x31), .d(x30), .O(new_n171_));
  ...
  nand4  g130(.a(new_n140_), .b(new_n53_), .c(new_n117_), .d(new_n101_), .O(new_n175_));
  ...
  nand4  g134(.a(x19), .b(x18), .c(x17), .d(x15), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n132_), .O(new_n180_));
  oai21  g136(.a(new_n154_), .b(new_n138_), .c(new_n126_), .O(new_n181_));
  inv1   g137(.a(x10), .O(new_n182_));
  oai21  g138(.a(new_n154_), .b(new_n182_), .c(new_n138_), .O(new_n183_));
  inv1   g139(.a(new_n160_), .O(new_n184_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n183_), .c(new_n181_), .d(new_n180_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n152_), .c(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n178_), .c(new_n174_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n45_), .c(x00), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n170_), .O(z9));
endmodule
