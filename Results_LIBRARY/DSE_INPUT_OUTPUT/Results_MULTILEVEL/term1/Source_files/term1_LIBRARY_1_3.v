...
module FAU ( 
  ...
  nand3  g066(.a(new_n92_), .b(new_n57_), .c(x29), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n104_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(x27), .c(new_n80_), .d(x25), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n102_), .O(z6));
  nand2  g070(.a(new_n87_), .b(new_n84_), .O(new_n115_));
  or2    g071(.a(new_n115_), .b(new_n88_), .O(new_n116_));
  nand3  g072(.a(new_n58_), .b(x25), .c(x01), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(x31), .c(x30), .d(x26), .O(new_n118_));
  oai21  g074(.a(new_n116_), .b(new_n89_), .c(new_n118_), .O(z7));
  ...
  nor3   g091(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  ...
  nand3  g107(.a(new_n121_), .b(x18), .c(x14), .O(new_n152_));
  ...
  nand4  g117(.a(new_n158_), .b(x16), .c(new_n120_), .d(x10), .O(new_n162_));
  ...
  nand4  g124(.a(new_n168_), .b(new_n132_), .c(new_n129_), .d(new_n127_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n124_), .c(new_n45_), .O(new_n170_));
  nand2  g126(.a(new_n142_), .b(new_n133_), .O(new_n171_));
  nor2   g127(.a(new_n133_), .b(new_n106_), .O(new_n172_));
