...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n61_), .c(x28), .d(new_n80_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n79_), .c(x25), .d(x01), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z3));
  nand3  g053(.a(new_n95_), .b(x25), .c(x01), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(x28), .c(x26), .O(z4));
  xor2a  g055(.a(x29), .b(x27), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n93_), .c(new_n61_), .d(x28), .O(new_n101_));
  ...
  nand4  g073(.a(new_n117_), .b(x30), .c(x29), .d(x27), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x28), .c(new_n79_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n115_), .c(new_n113_), .O(z7));
  xor2a  g077(.a(x30), .b(x29), .O(new_n122_));
  nand3  g078(.a(x19), .b(new_n85_), .c(x13), .O(new_n123_));
  nand3  g079(.a(new_n88_), .b(x18), .c(x14), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n123_), .c(new_n82_), .O(new_n125_));
  nand4  g081(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n126_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n122_), .c(new_n48_), .d(x31), .O(new_n138_));
  aoi21  g094(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x17), .c(x16), .d(x15), .O(new_n140_));
  nand4  g096(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n141_));
  and2   g097(.a(new_n141_), .b(new_n88_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand2  g099(.a(x18), .b(x17), .O(new_n144_));
  nand2  g100(.a(x16), .b(x10), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(new_n135_), .O(new_n146_));
  inv1   g102(.a(x11), .O(new_n147_));
  oai21  g103(.a(new_n144_), .b(new_n147_), .c(new_n129_), .O(new_n148_));
  nand2  g104(.a(x18), .b(x12), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n82_), .O(new_n150_));
  inv1   g106(.a(x13), .O(new_n151_));
  aoi22  g107(.a(x30), .b(x29), .c(new_n85_), .d(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n107_), .b(new_n105_), .c(new_n117_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n146_), .c(new_n143_), .d(new_n140_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x32), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n138_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(x28), .c(new_n79_), .d(x00), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(z8));
  nand2  g116(.a(x31), .b(x30), .O(new_n161_));
  nand3  g117(.a(new_n117_), .b(new_n107_), .c(new_n105_), .O(new_n162_));
  oai21  g118(.a(new_n161_), .b(new_n105_), .c(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n137_), .c(new_n52_), .O(new_n164_));
  nand2  g120(.a(new_n161_), .b(x29), .O(new_n165_));
  oai21  g121(.a(x31), .b(x30), .c(new_n105_), .O(new_n166_));
  nand2  g122(.a(new_n85_), .b(new_n151_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n150_), .c(new_n148_), .d(new_n146_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n142_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n166_), .c(new_n165_), .d(new_n140_), .O(new_n170_));
  ...
  aoi21  g129(.a(new_n173_), .b(x28), .c(x26), .O(z9));
endmodule
