...
module FAU ( 
  ...
  nand2  g077(.a(new_n46_), .b(x26), .O(new_n122_));
  ...
  nand2  g096(.a(new_n96_), .b(new_n81_), .O(new_n141_));
  ...
  nand4  g103(.a(new_n141_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n148_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n127_), .c(new_n122_), .O(new_n172_));
  aoi21  g128(.a(new_n142_), .b(new_n117_), .c(x30), .O(new_n173_));
  nor2   g129(.a(new_n117_), .b(new_n95_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n141_), .c(new_n46_), .O(new_n175_));
  aoi21  g131(.a(new_n173_), .b(new_n45_), .c(new_n175_), .O(new_n176_));
  ...
  nand4  g136(.a(new_n142_), .b(new_n117_), .c(new_n46_), .d(new_n45_), .O(new_n181_));
