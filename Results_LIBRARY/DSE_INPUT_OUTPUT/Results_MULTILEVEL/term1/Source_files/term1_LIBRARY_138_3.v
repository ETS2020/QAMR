...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n89_), .c(new_n46_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n63_), .c(new_n58_), .O(z4));
  ...
  nor3   g058(.a(new_n102_), .b(new_n82_), .c(new_n63_), .O(z5));
  ...
  nand2  g080(.a(new_n98_), .b(new_n83_), .O(new_n125_));
  ...
  aoi21  g127(.a(new_n171_), .b(new_n148_), .c(new_n45_), .O(z8));
  ...
  nand4  g133(.a(new_n144_), .b(new_n173_), .c(new_n120_), .d(new_n104_), .O(new_n178_));
