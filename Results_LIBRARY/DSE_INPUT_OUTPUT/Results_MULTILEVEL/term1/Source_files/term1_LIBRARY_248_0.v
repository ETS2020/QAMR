...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(x22), .c(x26), .O(z3));
  xnor2a g048(.a(x28), .b(x27), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n89_), .c(new_n61_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n46_), .c(x25), .d(x22), .O(new_n95_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n62_), .c(x25), .d(x01), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(x22), .c(x26), .O(z5));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n89_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n62_), .c(x25), .d(x01), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(x22), .c(x26), .O(z6));
  nand3  g069(.a(new_n98_), .b(x30), .c(x29), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  nand3  g071(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n116_));
  nand3  g072(.a(new_n62_), .b(x22), .c(x01), .O(new_n117_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n99_), .c(new_n46_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n118_), .c(new_n116_), .d(new_n115_), .O(z7));
  nand2  g080(.a(new_n97_), .b(new_n81_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(x31), .d(new_n106_), .O(new_n145_));
  nand2  g101(.a(x32), .b(x30), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n125_), .c(x29), .O(new_n148_));
  nand2  g104(.a(new_n125_), .b(x29), .O(new_n149_));
  nand4  g105(.a(new_n144_), .b(new_n126_), .c(x31), .d(x30), .O(new_n150_));
  nand2  g106(.a(x32), .b(new_n106_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g109(.a(new_n130_), .b(x14), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(x18), .c(x17), .d(x16), .O(new_n155_));
  nor2   g111(.a(new_n155_), .b(new_n142_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  nand2  g113(.a(x18), .b(x17), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n130_), .O(new_n159_));
  nand2  g115(.a(x16), .b(x10), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(new_n142_), .O(new_n161_));
  inv1   g117(.a(x11), .O(new_n162_));
  oai21  g118(.a(new_n158_), .b(new_n162_), .c(new_n136_), .O(new_n163_));
  aoi21  g119(.a(x18), .b(x12), .c(x17), .O(new_n164_));
  nor2   g120(.a(x18), .b(x13), .O(new_n165_));
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n120_), .O(new_n166_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n153_), .c(new_n148_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x00), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(x22), .c(x26), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n144_), .b(new_n172_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n106_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n125_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n120_), .d(new_n106_), .O(new_n177_));
  nand2  g133(.a(x33), .b(x30), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n149_), .O(new_n180_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n156_), .c(x33), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n180_), .c(new_n176_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n46_), .c(x22), .d(x00), .O(new_n189_));
