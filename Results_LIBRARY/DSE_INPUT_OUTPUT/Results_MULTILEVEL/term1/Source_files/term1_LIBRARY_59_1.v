...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n81_), .c(x25), .d(x01), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n45_), .c(x27), .O(z3));
  inv1   g052(.a(x25), .O(new_n97_));
  inv1   g053(.a(x27), .O(new_n98_));
  nand3  g054(.a(new_n45_), .b(x28), .c(new_n98_), .O(new_n99_));
  oai21  g055(.a(x28), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n94_), .c(new_n81_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n97_), .c(new_n60_), .O(z4));
  ...
  oai21  g062(.a(new_n103_), .b(new_n98_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n62_), .d(new_n81_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n97_), .c(new_n60_), .O(z5));
  inv1   g065(.a(x28), .O(new_n110_));
  nor2   g066(.a(new_n45_), .b(x29), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n105_), .O(new_n112_));
  nand2  g068(.a(x30), .b(new_n110_), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n110_), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n93_), .c(new_n62_), .d(x27), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n81_), .c(x25), .d(x01), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(z6));
  oai21  g074(.a(x31), .b(x30), .c(new_n98_), .O(new_n119_));
  nor2   g075(.a(new_n45_), .b(new_n104_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n81_), .c(x25), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n61_), .c(new_n60_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n123_), .c(new_n122_), .d(new_n119_), .O(z7));
  ...
  oai21  g101(.a(x28), .b(x27), .c(x29), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n45_), .c(new_n120_), .d(x27), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nand2  g106(.a(new_n105_), .b(x28), .O(new_n151_));
  oai21  g107(.a(new_n112_), .b(new_n98_), .c(new_n151_), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n87_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n90_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n84_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n156_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n139_), .c(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x15), .O(new_n163_));
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n129_), .d(x10), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n152_), .c(new_n150_), .d(x31), .O(new_n166_));
  ...
  nor2   g125(.a(new_n142_), .b(new_n141_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n132_), .c(new_n47_), .O(new_n172_));
  nand2  g128(.a(new_n146_), .b(new_n124_), .O(new_n173_));
  ...
  nand4  g134(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n179_));
  oai21  g135(.a(new_n173_), .b(x30), .c(new_n179_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n165_), .c(new_n178_), .O(new_n181_));
