...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n187_;
  nand2  g000(.a(x26), .b(x23), .O(new_n45_));
  ...
  nor3   g055(.a(new_n99_), .b(new_n89_), .c(new_n58_), .O(z5));
  ...
  nand2  g143(.a(new_n187_), .b(new_n45_), .O(z9));
endmodule
