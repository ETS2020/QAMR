...
module FAU ( 
  ...
  nand3  g022(.a(new_n66_), .b(new_n57_), .c(new_n56_), .O(new_n67_));
  ...
  nand3  g029(.a(new_n73_), .b(new_n68_), .c(new_n56_), .O(new_n74_));
  ...
  nand2  g041(.a(new_n85_), .b(new_n81_), .O(new_n86_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n86_), .c(new_n97_), .d(new_n91_), .O(new_n103_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n87_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n97_), .c(x25), .d(x01), .O(new_n112_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n81_), .O(new_n119_));
  nand3  g075(.a(new_n97_), .b(x01), .c(x00), .O(new_n120_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n91_), .O(new_n126_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n91_), .c(x00), .O(new_n174_));
  ...
  nand4  g136(.a(new_n148_), .b(new_n176_), .c(new_n124_), .d(new_n109_), .O(new_n181_));
  ...
  nand3  g148(.a(new_n192_), .b(new_n91_), .c(x00), .O(new_n193_));
