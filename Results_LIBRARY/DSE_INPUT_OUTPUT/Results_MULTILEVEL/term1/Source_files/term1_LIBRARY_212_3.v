...
module FAU ( 
  ...
  nand2  g000(.a(x33), .b(x06), .O(new_n45_));
  nand2  g001(.a(new_n45_), .b(x32), .O(z0));
  nor3   g002(.a(x32), .b(x06), .c(x03), .O(new_n47_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n61_), .c(new_n45_), .O(z6));
  ...
  nand4  g101(.a(new_n145_), .b(new_n53_), .c(x31), .d(new_n105_), .O(new_n146_));
  ...
  nand4  g126(.a(new_n170_), .b(new_n45_), .c(new_n82_), .d(x00), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(z8));
  nand4  g128(.a(new_n145_), .b(new_n57_), .c(x31), .d(x30), .O(new_n173_));
  nand3  g129(.a(x33), .b(new_n105_), .c(new_n52_), .O(new_n174_));
  ...
  nand3  g133(.a(x33), .b(x30), .c(new_n52_), .O(new_n178_));
  ...
  nand3  g143(.a(new_n187_), .b(x33), .c(new_n52_), .O(new_n188_));
