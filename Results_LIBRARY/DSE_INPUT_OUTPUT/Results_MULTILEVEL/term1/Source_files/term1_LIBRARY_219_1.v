...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n59_), .c(new_n47_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n80_), .d(x25), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n59_), .c(new_n47_), .O(z4));
  ...
  xnor2a g060(.a(x30), .b(x27), .O(new_n105_));
  nand2  g061(.a(x30), .b(new_n98_), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n98_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n89_), .c(new_n61_), .d(x28), .O(new_n108_));
  ...
  oai21  g069(.a(new_n113_), .b(new_n112_), .c(new_n47_), .O(new_n114_));
  ...
  aoi22  g074(.a(new_n118_), .b(x28), .c(x31), .d(new_n45_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n114_), .O(z7));
  nand4  g076(.a(x32), .b(new_n81_), .c(new_n80_), .d(x00), .O(new_n121_));
  ...
  nand3  g082(.a(new_n126_), .b(new_n45_), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n106_), .O(new_n128_));
  ...
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n132_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(new_n144_), .O(new_n155_));
  inv1   g111(.a(x11), .O(new_n156_));
  oai21  g112(.a(new_n152_), .b(new_n156_), .c(new_n138_), .O(new_n157_));
  nand2  g113(.a(x18), .b(x12), .O(new_n158_));
  nor2   g114(.a(x18), .b(x13), .O(new_n159_));
  aoi21  g115(.a(x30), .b(x29), .c(new_n159_), .O(new_n160_));
  aoi21  g116(.a(new_n45_), .b(new_n98_), .c(new_n115_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  aoi21  g118(.a(new_n158_), .b(new_n129_), .c(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n150_), .c(x32), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n147_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n80_), .c(x00), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n123_), .O(z8));
  aoi21  g124(.a(new_n158_), .b(new_n129_), .c(new_n159_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n150_), .c(new_n47_), .O(new_n171_));
  oai21  g127(.a(new_n125_), .b(new_n98_), .c(new_n115_), .O(new_n172_));
  aoi21  g128(.a(x31), .b(x29), .c(new_n45_), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(x28), .c(new_n172_), .d(new_n45_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  inv1   g132(.a(x33), .O(new_n177_));
  nand4  g133(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n178_));
  oai21  g134(.a(new_n172_), .b(x30), .c(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n146_), .c(new_n177_), .O(new_n180_));
