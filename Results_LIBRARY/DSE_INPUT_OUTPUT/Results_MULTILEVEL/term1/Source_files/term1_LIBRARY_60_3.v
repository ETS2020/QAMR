...
module FAU ( 
  ...
  nand4  g118(.a(new_n159_), .b(x16), .c(new_n124_), .d(x10), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n151_), .c(new_n149_), .d(x31), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n148_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x00), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n58_), .O(z8));
  ...
  nand3  g128(.a(new_n172_), .b(new_n145_), .c(x29), .O(new_n173_));
  ...
  nand2  g132(.a(new_n176_), .b(new_n143_), .O(new_n177_));
