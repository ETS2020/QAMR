...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n87_), .c(new_n60_), .d(new_n95_), .O(new_n101_));
  ...
  nand3  g073(.a(new_n60_), .b(x01), .c(x00), .O(new_n118_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n132_), .O(new_n163_));
  nand2  g119(.a(x16), .b(x10), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n162_), .c(new_n144_), .O(new_n165_));
  inv1   g121(.a(x11), .O(new_n166_));
  oai21  g122(.a(new_n162_), .b(new_n166_), .c(new_n138_), .O(new_n167_));
  aoi21  g123(.a(x18), .b(x12), .c(x17), .O(new_n168_));
  nor2   g124(.a(x18), .b(x13), .O(new_n169_));
  nor3   g125(.a(new_n169_), .b(new_n168_), .c(new_n122_), .O(new_n170_));
  ...
  nand3  g128(.a(new_n172_), .b(new_n155_), .c(new_n150_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n95_), .c(x00), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(z8));
  inv1   g131(.a(x33), .O(new_n176_));
  nand4  g132(.a(new_n146_), .b(new_n176_), .c(x31), .d(x30), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(x30), .c(new_n177_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n127_), .c(x29), .O(new_n179_));
  nand4  g135(.a(new_n146_), .b(new_n176_), .c(new_n122_), .d(new_n107_), .O(new_n180_));
  oai21  g136(.a(new_n176_), .b(new_n107_), .c(new_n180_), .O(new_n181_));
  inv1   g137(.a(new_n168_), .O(new_n182_));
  inv1   g138(.a(new_n169_), .O(new_n183_));
  xnor2a g139(.a(x31), .b(x30), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n167_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n165_), .c(new_n163_), .d(new_n159_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x00), .O(new_n189_));
  aoi21  g145(.a(new_n181_), .b(new_n151_), .c(new_n189_), .O(new_n190_));
