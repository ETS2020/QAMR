...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n100_), .c(new_n63_), .d(new_n45_), .O(new_n105_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n100_), .c(new_n63_), .d(x25), .O(new_n114_));
  ...
  nor2   g080(.a(new_n56_), .b(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n123_), .c(new_n121_), .d(x01), .O(new_n126_));
  ...
  oai22  g100(.a(new_n144_), .b(new_n132_), .c(new_n111_), .d(new_n45_), .O(new_n145_));
  nor2   g101(.a(x28), .b(x27), .O(new_n146_));
  nor3   g102(.a(new_n146_), .b(new_n111_), .c(new_n101_), .O(new_n147_));
  inv1   g103(.a(new_n146_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x29), .O(new_n149_));
  aoi22  g105(.a(new_n149_), .b(new_n111_), .c(new_n147_), .d(new_n45_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n145_), .c(new_n49_), .O(new_n151_));
  nand3  g107(.a(new_n149_), .b(x30), .c(new_n45_), .O(new_n152_));
  nand3  g108(.a(new_n148_), .b(new_n111_), .c(x29), .O(new_n153_));
  ...
  nand4  g127(.a(new_n167_), .b(new_n53_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n111_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n148_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n167_), .b(new_n53_), .c(new_n116_), .d(new_n111_), .O(new_n176_));
  ...
  inv1   g136(.a(new_n142_), .O(new_n181_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n185_));
