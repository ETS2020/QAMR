...
module FAU ( 
  ...
  nand4  g043(.a(new_n87_), .b(new_n62_), .c(new_n48_), .d(new_n81_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n80_), .c(x25), .d(x01), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z3));
  nand3  g047(.a(new_n48_), .b(x28), .c(new_n81_), .O(new_n92_));
  ...
  nand2  g052(.a(new_n96_), .b(new_n48_), .O(z4));
  ...
  nand4  g057(.a(new_n101_), .b(new_n87_), .c(new_n62_), .d(new_n48_), .O(new_n102_));
  ...
  nand4  g062(.a(new_n106_), .b(x28), .c(x27), .d(new_n45_), .O(new_n107_));
  ...
  oai21  g069(.a(x31), .b(x09), .c(new_n106_), .O(new_n114_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n130_), .c(new_n48_), .O(new_n143_));
  nor2   g099(.a(x28), .b(x27), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n98_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n106_), .c(new_n45_), .O(new_n147_));
  ...
  nand4  g107(.a(new_n148_), .b(new_n106_), .c(x29), .d(new_n45_), .O(new_n152_));
  ...
  nand4  g128(.a(new_n168_), .b(new_n53_), .c(x31), .d(x30), .O(new_n173_));
  ...
  nand4  g132(.a(new_n168_), .b(new_n53_), .c(new_n120_), .d(new_n106_), .O(new_n177_));
