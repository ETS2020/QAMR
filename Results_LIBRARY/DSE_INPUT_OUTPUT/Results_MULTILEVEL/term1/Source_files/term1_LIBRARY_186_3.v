...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n61_), .c(new_n59_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n88_), .c(new_n45_), .d(x25), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n61_), .c(new_n59_), .O(z4));
  ...
  nand2  g058(.a(new_n102_), .b(new_n59_), .O(z5));
  nand3  g059(.a(new_n46_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n97_), .b(new_n46_), .c(new_n104_), .O(new_n105_));
  nor2   g061(.a(new_n46_), .b(x29), .O(new_n106_));
  aoi21  g062(.a(new_n105_), .b(x29), .c(new_n106_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n87_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n63_), .c(new_n45_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n61_), .O(z6));
  nand3  g066(.a(new_n97_), .b(x30), .c(x29), .O(new_n111_));
  ...
  oai22  g097(.a(new_n141_), .b(new_n129_), .c(x30), .d(new_n45_), .O(new_n142_));
  nor2   g098(.a(x28), .b(x27), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n95_), .O(new_n144_));
  ...
  nand4  g107(.a(new_n147_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n152_));
  oai21  g108(.a(new_n144_), .b(new_n46_), .c(new_n152_), .O(new_n153_));
  inv1   g109(.a(x17), .O(new_n154_));
  inv1   g110(.a(x18), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n155_), .c(x13), .O(new_n156_));
  nand3  g112(.a(new_n126_), .b(x18), .c(x14), .O(new_n157_));
  ...
  nand2  g130(.a(x33), .b(new_n46_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n147_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n168_), .b(new_n173_), .c(new_n120_), .d(new_n46_), .O(new_n178_));
  nand2  g134(.a(x33), .b(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n145_), .O(new_n181_));
  inv1   g137(.a(new_n138_), .O(new_n182_));
  ...
  nand4  g142(.a(new_n186_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n129_), .c(x33), .O(new_n188_));
