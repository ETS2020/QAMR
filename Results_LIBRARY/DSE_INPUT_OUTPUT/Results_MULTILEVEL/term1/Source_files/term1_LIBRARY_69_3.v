...
module FAU ( 
  ...
  nor3   g056(.a(new_n100_), .b(new_n81_), .c(new_n62_), .O(z5));
  ...
  nand4  g062(.a(new_n106_), .b(new_n63_), .c(new_n45_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n62_), .O(z6));
  ...
  nand4  g098(.a(new_n142_), .b(new_n50_), .c(x31), .d(new_n46_), .O(new_n143_));
  ...
  nand2  g104(.a(x32), .b(new_n46_), .O(new_n149_));
  ...
  nand4  g129(.a(new_n142_), .b(new_n54_), .c(new_n117_), .d(new_n46_), .O(new_n174_));
