...
module FAU ( 
  ...
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n92_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n80_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x00), .c(x26), .O(z5));
  ...
  nand3  g080(.a(new_n80_), .b(x01), .c(x00), .O(new_n125_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n105_), .c(new_n78_), .O(new_n130_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(x31), .d(new_n114_), .O(new_n150_));
  ...
  nand4  g138(.a(new_n149_), .b(new_n179_), .c(new_n128_), .d(new_n114_), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(new_n114_), .c(new_n183_), .O(new_n184_));
