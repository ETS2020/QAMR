...
module FAU ( 
  ...
  nand3  g051(.a(new_n95_), .b(new_n47_), .c(new_n82_), .O(new_n96_));
  ...
  nor2   g060(.a(new_n45_), .b(new_n82_), .O(new_n105_));
  ...
  oai21  g070(.a(new_n104_), .b(new_n45_), .c(x30), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n103_), .c(new_n62_), .d(new_n81_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n112_), .c(new_n60_), .O(z6));
  ...
  nand2  g086(.a(new_n45_), .b(new_n82_), .O(new_n131_));
  nand2  g087(.a(x30), .b(new_n104_), .O(new_n132_));
  nand2  g088(.a(new_n46_), .b(x29), .O(new_n133_));
  ...
  aoi21  g106(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(x17), .c(x16), .d(x15), .O(new_n152_));
  nand3  g108(.a(new_n131_), .b(x30), .c(x29), .O(new_n153_));
  nand4  g109(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n154_));
  and2   g110(.a(new_n154_), .b(new_n90_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand4  g112(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n157_));
  nand3  g113(.a(x18), .b(x17), .c(x11), .O(new_n158_));
  ...
  aoi21  g119(.a(new_n46_), .b(new_n104_), .c(new_n125_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n165_));
  aoi21  g121(.a(new_n157_), .b(new_n147_), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n156_), .c(new_n153_), .d(new_n152_), .O(new_n167_));
  ...
  nand4  g127(.a(x33), .b(new_n82_), .c(new_n81_), .d(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x30), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n45_), .O(new_n174_));
  inv1   g130(.a(x33), .O(new_n175_));
  nand4  g131(.a(new_n131_), .b(x31), .c(x30), .d(x29), .O(new_n176_));
  nand3  g132(.a(new_n125_), .b(new_n46_), .c(new_n104_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n149_), .c(new_n175_), .O(new_n179_));
  oai21  g135(.a(new_n125_), .b(new_n104_), .c(x30), .O(new_n180_));
  oai21  g136(.a(x31), .b(x29), .c(new_n46_), .O(new_n181_));
  nand2  g137(.a(new_n157_), .b(new_n147_), .O(new_n182_));
  nand4  g138(.a(new_n163_), .b(new_n161_), .c(new_n159_), .d(new_n182_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n155_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n181_), .c(new_n180_), .d(new_n152_), .O(new_n185_));
  ...
  nand2  g144(.a(new_n188_), .b(new_n174_), .O(z9));
endmodule
