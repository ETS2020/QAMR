...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n59_), .c(new_n57_), .O(z3));
  ...
  nand2  g065(.a(new_n103_), .b(x29), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x30), .c(new_n45_), .O(new_n111_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n61_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n59_), .c(new_n57_), .O(z6));
  nand3  g072(.a(new_n103_), .b(x30), .c(x29), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x31), .O(new_n118_));
  inv1   g074(.a(new_n81_), .O(new_n119_));
  nand4  g075(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n119_), .O(new_n120_));
  nor2   g076(.a(new_n60_), .b(new_n59_), .O(new_n121_));
  inv1   g077(.a(new_n103_), .O(new_n122_));
  ...
  nor2   g081(.a(new_n125_), .b(new_n96_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(z7));
  nand2  g083(.a(new_n102_), .b(new_n80_), .O(new_n128_));
  inv1   g084(.a(x32), .O(new_n129_));
  nand3  g085(.a(x19), .b(new_n85_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n88_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n82_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n133_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n112_), .O(new_n145_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n88_), .O(new_n159_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n45_), .c(x00), .O(new_n189_));
