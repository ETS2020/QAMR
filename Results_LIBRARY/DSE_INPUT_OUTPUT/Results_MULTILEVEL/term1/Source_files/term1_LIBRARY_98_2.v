...
module FAU ( 
  ...
  aoi21  g048(.a(new_n91_), .b(new_n57_), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g062(.a(new_n106_), .b(new_n45_), .c(new_n105_), .O(new_n107_));
  ...
  nor2   g068(.a(new_n106_), .b(x20), .O(new_n113_));
  nand2  g069(.a(new_n106_), .b(new_n45_), .O(new_n114_));
  aoi22  g070(.a(new_n114_), .b(new_n91_), .c(new_n113_), .d(new_n105_), .O(new_n115_));
  nor3   g071(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n84_), .c(x15), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n106_), .c(x28), .d(x27), .O(new_n118_));
  oai21  g074(.a(new_n115_), .b(new_n101_), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x29), .O(new_n120_));
  aoi21  g076(.a(new_n83_), .b(new_n82_), .c(new_n92_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n116_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x30), .c(new_n100_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(new_n60_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n80_), .c(x25), .d(x01), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n57_), .O(z6));
  oai21  g082(.a(x31), .b(x20), .c(new_n106_), .O(new_n127_));
  nand3  g083(.a(x29), .b(x28), .c(x27), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x31), .O(new_n129_));
  nand4  g085(.a(new_n121_), .b(new_n90_), .c(new_n88_), .d(new_n86_), .O(new_n130_));
  nor2   g086(.a(new_n60_), .b(new_n59_), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand4  g088(.a(new_n101_), .b(new_n132_), .c(x30), .d(x29), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n131_), .c(new_n80_), .d(x25), .O(new_n134_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n142_), .c(new_n105_), .O(new_n145_));
  inv1   g101(.a(x11), .O(new_n146_));
  oai21  g102(.a(new_n142_), .b(new_n146_), .c(new_n82_), .O(new_n147_));
  aoi21  g103(.a(x18), .b(x12), .c(x17), .O(new_n148_));
  nor2   g104(.a(x18), .b(x13), .O(new_n149_));
  nor3   g105(.a(new_n149_), .b(new_n148_), .c(new_n132_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n140_), .c(new_n57_), .O(new_n152_));
  nor2   g108(.a(x28), .b(x27), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n100_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n106_), .c(new_n45_), .O(new_n156_));
  inv1   g112(.a(new_n153_), .O(new_n157_));
  ...
  nand4  g117(.a(new_n157_), .b(new_n106_), .c(x29), .d(new_n45_), .O(new_n162_));
  oai21  g118(.a(new_n154_), .b(new_n106_), .c(new_n162_), .O(new_n163_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n82_), .c(x11), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x15), .O(new_n176_));
  nand4  g132(.a(new_n173_), .b(x16), .c(new_n105_), .d(x10), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n163_), .c(new_n161_), .d(x31), .O(new_n179_));
  ...
  nand2  g140(.a(x33), .b(new_n106_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n157_), .c(x29), .O(new_n187_));
  nand4  g143(.a(new_n178_), .b(new_n183_), .c(new_n132_), .d(new_n106_), .O(new_n188_));
  nand2  g144(.a(x33), .b(x30), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n155_), .O(new_n191_));
  ...
  nand2  g156(.a(new_n200_), .b(new_n57_), .O(z9));
endmodule
