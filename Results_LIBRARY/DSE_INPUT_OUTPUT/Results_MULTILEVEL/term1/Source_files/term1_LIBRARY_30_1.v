...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n61_), .c(new_n46_), .O(z3));
  ...
  nand4  g066(.a(new_n110_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n111_));
  ...
  nor2   g079(.a(new_n123_), .b(new_n90_), .O(new_n124_));
