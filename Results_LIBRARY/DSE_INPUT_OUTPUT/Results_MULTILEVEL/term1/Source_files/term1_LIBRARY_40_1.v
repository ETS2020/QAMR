...
module FAU ( 
  ...
  nor2   g052(.a(new_n87_), .b(new_n85_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n58_), .O(new_n99_));
  nand3  g055(.a(new_n45_), .b(new_n84_), .c(new_n83_), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n99_), .c(new_n61_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n60_), .O(z4));
  inv1   g059(.a(x28), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  nor2   g061(.a(x30), .b(new_n83_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(x20), .c(new_n98_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n100_), .c(new_n105_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x29), .O(new_n109_));
  inv1   g065(.a(x29), .O(new_n110_));
  oai21  g066(.a(new_n106_), .b(x20), .c(new_n98_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n100_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n110_), .c(x28), .d(x27), .O(new_n113_));
  ...
  nand2  g072(.a(new_n105_), .b(x29), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x30), .c(x20), .O(new_n118_));
  nor2   g074(.a(x30), .b(new_n110_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n105_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n98_), .O(new_n122_));
  nor2   g078(.a(new_n82_), .b(x20), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n119_), .c(x28), .d(new_n83_), .O(new_n124_));
  ...
  nand2  g084(.a(new_n128_), .b(new_n58_), .O(new_n129_));
  nand3  g085(.a(x29), .b(x28), .c(x27), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x31), .O(new_n131_));
  nand3  g087(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n132_));
  inv1   g088(.a(x31), .O(new_n133_));
  nand4  g089(.a(new_n105_), .b(new_n133_), .c(x30), .d(x29), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(new_n131_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x20), .O(new_n136_));
  oai21  g092(.a(new_n132_), .b(new_n83_), .c(new_n133_), .O(new_n137_));
  ...
  nand2  g096(.a(new_n140_), .b(x14), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(x18), .c(x17), .d(x16), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n83_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x15), .O(new_n144_));
  nand2  g100(.a(x18), .b(x17), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(new_n140_), .O(new_n146_));
  nand2  g102(.a(x16), .b(x10), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(new_n83_), .O(new_n148_));
  ...
  nor3   g109(.a(new_n153_), .b(new_n152_), .c(new_n133_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n151_), .c(new_n148_), .d(new_n146_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n143_), .c(new_n58_), .O(new_n156_));
  nand2  g112(.a(new_n104_), .b(new_n82_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x30), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n110_), .O(new_n159_));
  nand2  g115(.a(new_n157_), .b(x29), .O(new_n160_));
  aoi22  g116(.a(new_n160_), .b(new_n45_), .c(new_n159_), .d(x20), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x32), .O(new_n163_));
  inv1   g119(.a(x32), .O(new_n164_));
  nand3  g120(.a(new_n160_), .b(x30), .c(x20), .O(new_n165_));
  nand3  g121(.a(new_n157_), .b(new_n45_), .c(x29), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  inv1   g123(.a(x17), .O(new_n168_));
  inv1   g124(.a(x18), .O(new_n169_));
  nand3  g125(.a(x19), .b(new_n169_), .c(x13), .O(new_n170_));
  nand3  g126(.a(new_n140_), .b(x18), .c(x14), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand4  g128(.a(x19), .b(x18), .c(new_n168_), .d(x12), .O(new_n173_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n150_), .c(x11), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x15), .O(new_n180_));
  nand4  g136(.a(new_n177_), .b(x16), .c(new_n83_), .d(x10), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n167_), .c(new_n164_), .d(x31), .O(new_n183_));
  ...
  nor2   g142(.a(new_n153_), .b(new_n152_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n151_), .c(new_n148_), .d(new_n146_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n143_), .c(new_n58_), .O(new_n189_));
  nand2  g145(.a(new_n160_), .b(new_n133_), .O(new_n190_));
  nor2   g146(.a(new_n133_), .b(new_n110_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n157_), .c(new_n45_), .O(new_n192_));
  aoi22  g148(.a(new_n192_), .b(x20), .c(new_n190_), .d(new_n45_), .O(new_n193_));
  ...
  oai22  g153(.a(new_n197_), .b(new_n84_), .c(new_n190_), .d(x30), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n182_), .c(new_n196_), .O(new_n199_));
