...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n59_), .c(new_n79_), .d(new_n78_), .O(new_n93_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n91_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n59_), .c(x25), .d(x01), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x00), .c(x26), .O(z5));
  nand3  g066(.a(x29), .b(x28), .c(x27), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x30), .O(new_n112_));
  inv1   g068(.a(x30), .O(new_n113_));
  nand3  g069(.a(new_n103_), .b(new_n113_), .c(x29), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n92_), .c(new_n59_), .d(new_n78_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(x25), .c(x01), .d(x00), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(z6));
  nand3  g075(.a(new_n103_), .b(x30), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  inv1   g077(.a(new_n80_), .O(new_n122_));
  nand4  g078(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n122_), .O(new_n123_));
  nand3  g079(.a(new_n59_), .b(x01), .c(x00), .O(new_n124_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n104_), .c(new_n78_), .O(new_n129_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(x31), .d(new_n113_), .O(new_n149_));
  nand2  g105(.a(x32), .b(x30), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n132_), .c(x29), .O(new_n152_));
  nand2  g108(.a(new_n132_), .b(x29), .O(new_n153_));
  nand4  g109(.a(new_n148_), .b(new_n133_), .c(x31), .d(x30), .O(new_n154_));
  nand2  g110(.a(x32), .b(new_n113_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g113(.a(new_n87_), .b(x14), .O(new_n158_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n87_), .O(new_n165_));
  nand2  g121(.a(x16), .b(x10), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n164_), .c(new_n146_), .O(new_n167_));
  inv1   g123(.a(x11), .O(new_n168_));
  oai21  g124(.a(new_n164_), .b(new_n168_), .c(new_n140_), .O(new_n169_));
  ...
  nand3  g130(.a(new_n174_), .b(new_n157_), .c(new_n152_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n78_), .c(x00), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(z8));
  inv1   g133(.a(x33), .O(new_n178_));
  nand4  g134(.a(new_n148_), .b(new_n178_), .c(x31), .d(x30), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(x30), .c(new_n179_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n132_), .c(x29), .O(new_n181_));
  nand4  g137(.a(new_n148_), .b(new_n178_), .c(new_n127_), .d(new_n113_), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n113_), .c(new_n182_), .O(new_n183_));
  inv1   g139(.a(new_n170_), .O(new_n184_));
  inv1   g140(.a(new_n171_), .O(new_n185_));
  xnor2a g141(.a(x31), .b(x30), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n169_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n167_), .c(new_n165_), .d(new_n161_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x00), .O(new_n191_));
  aoi21  g147(.a(new_n183_), .b(new_n153_), .c(new_n191_), .O(new_n192_));
