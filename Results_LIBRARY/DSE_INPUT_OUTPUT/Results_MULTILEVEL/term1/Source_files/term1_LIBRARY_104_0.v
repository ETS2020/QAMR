...
module FAU ( 
  ...
  aoi21  g049(.a(new_n93_), .b(x23), .c(x26), .O(z3));
  xnor2a g050(.a(x28), .b(x27), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n91_), .c(new_n61_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n46_), .c(x25), .d(x23), .O(new_n97_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n90_), .c(new_n62_), .d(new_n46_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(x25), .c(x23), .d(x01), .O(new_n106_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n62_), .c(new_n46_), .d(x25), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n45_), .c(new_n60_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nor2   g072(.a(new_n108_), .b(new_n99_), .O(new_n117_));
  ...
  nand4  g076(.a(new_n101_), .b(new_n116_), .c(x30), .d(x29), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(x25), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n118_), .c(x23), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n46_), .O(z7));
  ...
  nand3  g098(.a(new_n142_), .b(new_n126_), .c(x31), .O(new_n143_));
  ...
  oai21  g104(.a(new_n143_), .b(new_n108_), .c(new_n148_), .O(new_n149_));
  ...
  nor2   g108(.a(new_n152_), .b(new_n140_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n155_), .c(new_n140_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n155_), .b(new_n159_), .c(new_n134_), .O(new_n160_));
  aoi21  g116(.a(x18), .b(x12), .c(x17), .O(new_n161_));
  nor2   g117(.a(x18), .b(x13), .O(new_n162_));
  nor3   g118(.a(new_n162_), .b(new_n161_), .c(new_n116_), .O(new_n163_));
  ...
  nand3  g121(.a(new_n165_), .b(new_n150_), .c(new_n146_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n46_), .c(x23), .d(x00), .O(new_n167_));
  ...
  nand4  g129(.a(new_n142_), .b(new_n169_), .c(new_n116_), .d(new_n108_), .O(new_n174_));
  ...
  aoi21  g142(.a(new_n186_), .b(x23), .c(x26), .O(z9));
endmodule
