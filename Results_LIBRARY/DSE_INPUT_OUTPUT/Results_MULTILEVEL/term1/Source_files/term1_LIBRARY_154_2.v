...
module FAU ( 
  ...
  aoi21  g052(.a(new_n96_), .b(x30), .c(new_n45_), .O(z3));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n59_), .d(x30), .O(new_n109_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n103_), .c(new_n59_), .d(x30), .O(new_n114_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n59_), .c(new_n81_), .d(x25), .O(new_n124_));
  ...
  nand2  g083(.a(new_n127_), .b(x01), .O(z7));
  inv1   g084(.a(new_n46_), .O(new_n129_));
  nand2  g085(.a(new_n104_), .b(new_n82_), .O(new_n130_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n132_), .c(x31), .d(new_n131_), .O(new_n148_));
  ...
  nand4  g108(.a(new_n147_), .b(new_n132_), .c(x31), .d(x30), .O(new_n153_));
  nand2  g109(.a(x32), .b(new_n131_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n90_), .b(x14), .O(new_n157_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n90_), .O(new_n162_));
  ...
  nand2  g148(.a(new_n192_), .b(new_n129_), .O(z9));
endmodule
