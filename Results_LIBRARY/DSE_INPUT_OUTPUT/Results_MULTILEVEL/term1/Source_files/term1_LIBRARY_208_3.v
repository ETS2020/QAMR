...
module FAU ( 
  ...
  nand3  g099(.a(new_n143_), .b(new_n125_), .c(x31), .O(new_n144_));
  ...
  oai21  g105(.a(new_n144_), .b(new_n102_), .c(new_n149_), .O(new_n150_));
  ...
  aoi21  g123(.a(new_n167_), .b(new_n147_), .c(new_n123_), .O(z8));
  ...
  nand4  g129(.a(new_n143_), .b(new_n169_), .c(new_n118_), .d(new_n102_), .O(new_n174_));
