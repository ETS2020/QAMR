...
module FAU ( 
  ...
  nand3  g098(.a(new_n142_), .b(new_n50_), .c(x31), .O(new_n143_));
  ...
  oai21  g104(.a(new_n143_), .b(new_n102_), .c(new_n148_), .O(new_n149_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n153_), .c(new_n128_), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(new_n140_), .O(new_n157_));
  inv1   g113(.a(x11), .O(new_n158_));
  oai21  g114(.a(new_n154_), .b(new_n158_), .c(new_n134_), .O(new_n159_));
  ...
  aoi21  g121(.a(new_n149_), .b(new_n147_), .c(new_n165_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n146_), .c(new_n45_), .O(z8));
  nand4  g123(.a(new_n142_), .b(new_n53_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n102_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n124_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n142_), .b(new_n53_), .c(new_n117_), .d(new_n102_), .O(new_n172_));
  ...
  nand3  g139(.a(new_n183_), .b(new_n46_), .c(x00), .O(new_n184_));
