...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n83_), .c(x29), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x28), .c(x27), .O(new_n102_));
  aoi22  g058(.a(new_n102_), .b(new_n100_), .c(new_n90_), .d(new_n86_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n60_), .c(new_n82_), .d(x25), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n46_), .c(new_n45_), .O(z5));
  nor4   g061(.a(new_n92_), .b(x30), .c(new_n101_), .d(new_n99_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n82_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n45_), .O(z6));
  inv1   g064(.a(new_n87_), .O(new_n109_));
  inv1   g065(.a(new_n88_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n109_), .c(new_n86_), .O(new_n111_));
  nand3  g067(.a(new_n60_), .b(x25), .c(x01), .O(new_n112_));
  nor4   g068(.a(new_n112_), .b(x31), .c(x30), .d(x26), .O(new_n113_));
  oai21  g069(.a(new_n111_), .b(new_n89_), .c(new_n113_), .O(z7));
  ...
  oai21  g088(.a(new_n132_), .b(new_n119_), .c(new_n48_), .O(new_n133_));
  nand2  g089(.a(new_n99_), .b(new_n83_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x30), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n101_), .O(new_n136_));
  nand2  g092(.a(new_n134_), .b(x29), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n46_), .c(new_n136_), .d(new_n45_), .O(new_n138_));
  ...
  nand3  g098(.a(new_n134_), .b(new_n46_), .c(x29), .O(new_n143_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n119_), .c(new_n48_), .O(new_n166_));
  nand2  g122(.a(new_n137_), .b(new_n128_), .O(new_n167_));
  nor2   g123(.a(new_n128_), .b(new_n101_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n134_), .c(new_n46_), .O(new_n169_));
