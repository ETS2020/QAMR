...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n61_), .c(new_n46_), .O(z4));
  ...
  nand4  g065(.a(new_n109_), .b(new_n93_), .c(new_n80_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n61_), .c(new_n46_), .O(z6));
  ...
  inv1   g075(.a(new_n97_), .O(new_n120_));
  ...
  nand4  g080(.a(new_n124_), .b(new_n118_), .c(new_n117_), .d(new_n113_), .O(z7));
  ...
  nand4  g133(.a(new_n145_), .b(new_n173_), .c(new_n121_), .d(new_n104_), .O(new_n178_));
