...
module FAU ( 
  ...
  nand4  g052(.a(new_n96_), .b(new_n90_), .c(x25), .d(x01), .O(new_n97_));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n45_), .c(x26), .O(z5));
  nand3  g061(.a(new_n90_), .b(new_n45_), .c(x29), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(x27), .c(new_n80_), .d(x25), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n61_), .O(z6));
  ...
  nand4  g069(.a(new_n62_), .b(new_n113_), .c(x25), .d(x01), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n112_), .c(new_n45_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n80_), .O(z7));
  ...
  nand4  g091(.a(new_n135_), .b(new_n117_), .c(new_n49_), .d(x31), .O(new_n136_));
  aoi21  g092(.a(new_n121_), .b(x14), .c(new_n119_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(x17), .c(x16), .d(x15), .O(new_n138_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n140_), .c(new_n133_), .O(new_n143_));
  inv1   g099(.a(x11), .O(new_n144_));
  oai21  g100(.a(new_n140_), .b(new_n144_), .c(new_n127_), .O(new_n145_));
  nand2  g101(.a(x18), .b(x12), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n118_), .O(new_n147_));
  inv1   g103(.a(x13), .O(new_n148_));
  nand2  g104(.a(new_n119_), .b(new_n148_), .O(new_n149_));
  nor2   g105(.a(new_n113_), .b(new_n101_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n147_), .d(new_n117_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  and2   g108(.a(new_n152_), .b(new_n145_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n143_), .c(new_n141_), .d(new_n138_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  oai21  g111(.a(new_n136_), .b(new_n101_), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(z8));
  nand2  g114(.a(new_n117_), .b(x29), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n135_), .c(new_n53_), .d(new_n113_), .O(new_n160_));
  aoi21  g116(.a(new_n119_), .b(new_n148_), .c(x31), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n159_), .c(new_n141_), .d(new_n138_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x33), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n160_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n167_));
