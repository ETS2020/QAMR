...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n60_), .c(new_n57_), .O(new_n91_));
  ...
  nand2  g074(.a(new_n86_), .b(new_n83_), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n88_), .c(new_n87_), .O(new_n120_));
  nand4  g076(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n120_), .c(new_n57_), .O(new_n122_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n123_), .c(new_n125_), .O(new_n128_));
  aoi22  g084(.a(new_n128_), .b(x05), .c(x31), .d(new_n45_), .O(new_n129_));
  ...
  aoi22  g108(.a(new_n152_), .b(new_n45_), .c(new_n151_), .d(x05), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  inv1   g111(.a(x32), .O(new_n156_));
  nand3  g112(.a(new_n152_), .b(x30), .c(x05), .O(new_n157_));
  nand3  g113(.a(new_n149_), .b(new_n45_), .c(x29), .O(new_n158_));
  ...
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n84_), .O(new_n163_));
  nand4  g119(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n164_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n142_), .c(x11), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x15), .O(new_n171_));
  nand4  g127(.a(new_n168_), .b(x16), .c(new_n131_), .d(x10), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n159_), .c(new_n156_), .d(x31), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n155_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n79_), .c(x00), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(z8));
  nor2   g133(.a(new_n145_), .b(new_n144_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n143_), .c(new_n140_), .d(new_n138_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n135_), .c(new_n57_), .O(new_n180_));
  nand2  g136(.a(new_n152_), .b(new_n126_), .O(new_n181_));
  nor2   g137(.a(new_n126_), .b(new_n102_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n149_), .c(new_n45_), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(x05), .c(new_n181_), .d(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  inv1   g142(.a(x33), .O(new_n187_));
  inv1   g143(.a(x05), .O(new_n188_));
  nand4  g144(.a(new_n149_), .b(x31), .c(x30), .d(x29), .O(new_n189_));
  oai22  g145(.a(new_n189_), .b(new_n188_), .c(new_n181_), .d(x30), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n173_), .c(new_n187_), .O(new_n191_));
