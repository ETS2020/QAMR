...
module FAU ( 
  ...
  nand2  g000(.a(x30), .b(x09), .O(new_n45_));
  ...
  nand4  g041(.a(new_n85_), .b(new_n59_), .c(new_n45_), .d(new_n79_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n78_), .c(x25), .d(x01), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z3));
  nand3  g045(.a(new_n45_), .b(x28), .c(new_n79_), .O(new_n90_));
  oai21  g046(.a(x28), .b(new_n79_), .c(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n85_), .c(new_n59_), .d(new_n78_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(x25), .c(x01), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n45_), .O(z4));
  ...
  nand4  g056(.a(new_n100_), .b(new_n85_), .c(new_n59_), .d(new_n78_), .O(new_n101_));
  ...
  oai21  g068(.a(x31), .b(x30), .c(x09), .O(new_n113_));
  ...
  nor2   g073(.a(new_n81_), .b(new_n80_), .O(new_n118_));
  ...
  nand2  g081(.a(new_n97_), .b(new_n79_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(x31), .d(new_n105_), .O(new_n146_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n45_), .O(z8));
  ...
  nand4  g133(.a(new_n145_), .b(new_n173_), .c(new_n121_), .d(new_n105_), .O(new_n178_));
