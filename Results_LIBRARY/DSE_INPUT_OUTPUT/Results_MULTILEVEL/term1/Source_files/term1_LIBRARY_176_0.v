...
module FAU ( 
  ...
  nand4  g033(.a(new_n77_), .b(x30), .c(new_n45_), .d(x08), .O(new_n78_));
  ...
  nand4  g043(.a(new_n87_), .b(new_n61_), .c(new_n47_), .d(new_n81_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n80_), .c(x25), .d(x01), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z3));
  nand3  g047(.a(new_n47_), .b(x28), .c(new_n81_), .O(new_n92_));
  oai21  g048(.a(x28), .b(new_n81_), .c(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n87_), .c(new_n61_), .d(new_n80_), .O(new_n94_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n87_), .c(new_n61_), .d(new_n47_), .O(new_n103_));
  ...
  oai21  g063(.a(new_n100_), .b(new_n46_), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n46_), .b(x29), .O(new_n109_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n59_), .c(new_n47_), .O(z6));
  oai21  g069(.a(x31), .b(new_n45_), .c(new_n46_), .O(new_n114_));
  ...
  nand4  g078(.a(new_n100_), .b(new_n122_), .c(x30), .d(x29), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(new_n80_), .d(x25), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n120_), .c(new_n116_), .d(new_n114_), .O(z7));
  nand2  g082(.a(new_n99_), .b(new_n81_), .O(new_n127_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(x31), .d(new_n46_), .O(new_n147_));
  ...
  nand2  g108(.a(x32), .b(new_n46_), .O(new_n153_));
  ...
  nor3   g123(.a(new_n167_), .b(new_n166_), .c(new_n122_), .O(new_n168_));
  ...
  nor2   g129(.a(new_n167_), .b(new_n166_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n158_), .c(new_n47_), .O(new_n176_));
  aoi21  g132(.a(new_n151_), .b(new_n122_), .c(x30), .O(new_n177_));
  nor2   g133(.a(new_n122_), .b(new_n98_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n127_), .c(new_n46_), .O(new_n179_));
  aoi21  g135(.a(new_n177_), .b(x09), .c(new_n179_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nand4  g138(.a(new_n151_), .b(new_n122_), .c(new_n46_), .d(x09), .O(new_n183_));
  nand4  g139(.a(new_n127_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n146_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(x33), .c(new_n182_), .O(new_n187_));
