...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n61_), .d(new_n45_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(x25), .c(x01), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n57_), .O(z5));
  ...
  nand4  g063(.a(new_n107_), .b(new_n61_), .c(new_n45_), .d(x25), .O(new_n108_));
  ...
  nor2   g113(.a(new_n127_), .b(new_n126_), .O(new_n158_));
  ...
  nand2  g119(.a(new_n163_), .b(new_n135_), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  oai21  g121(.a(x18), .b(x13), .c(x31), .O(new_n166_));
  ...
  nand2  g129(.a(new_n157_), .b(x00), .O(new_n174_));
  nand3  g130(.a(x33), .b(x18), .c(x17), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n174_), .c(new_n45_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  inv1   g133(.a(x33), .O(new_n178_));
  nand4  g134(.a(new_n143_), .b(new_n178_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n102_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n124_), .c(x29), .O(new_n182_));
  nand4  g138(.a(new_n143_), .b(new_n178_), .c(new_n119_), .d(new_n102_), .O(new_n183_));
  nand2  g139(.a(x33), .b(x30), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n148_), .O(new_n186_));
  inv1   g142(.a(new_n165_), .O(new_n187_));
  oai22  g143(.a(new_n156_), .b(new_n136_), .c(x18), .d(x13), .O(new_n188_));
  xor2a  g144(.a(x31), .b(x30), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n187_), .c(new_n164_), .d(new_n162_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n159_), .c(x33), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n186_), .c(new_n182_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n45_), .c(x00), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n177_), .O(z9));
endmodule
