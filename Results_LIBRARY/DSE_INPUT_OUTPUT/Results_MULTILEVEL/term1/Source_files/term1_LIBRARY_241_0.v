...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n80_), .c(new_n79_), .d(new_n46_), .O(new_n94_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n80_), .d(new_n46_), .O(new_n99_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n80_), .d(new_n46_), .O(new_n108_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(x31), .d(new_n114_), .O(new_n149_));
  ...
  nand2  g133(.a(x33), .b(new_n114_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n132_), .c(x29), .O(new_n180_));
  nand4  g136(.a(new_n148_), .b(new_n176_), .c(new_n127_), .d(new_n114_), .O(new_n181_));
