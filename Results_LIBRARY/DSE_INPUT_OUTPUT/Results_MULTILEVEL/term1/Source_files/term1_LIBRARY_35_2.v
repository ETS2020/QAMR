...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n100_), .c(new_n60_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n58_), .c(new_n46_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n103_), .b(new_n116_), .c(x29), .O(new_n117_));
  ...
  nor2   g079(.a(new_n59_), .b(new_n79_), .O(new_n124_));
  ...
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n116_), .d(new_n45_), .O(new_n177_));
