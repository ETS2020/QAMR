...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n89_), .c(new_n55_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n61_), .c(new_n59_), .O(z4));
  ...
  nand2  g059(.a(new_n103_), .b(new_n59_), .O(z5));
  ...
  nand4  g066(.a(new_n110_), .b(new_n63_), .c(new_n55_), .d(x25), .O(new_n111_));
  ...
  nand4  g101(.a(new_n145_), .b(z0), .c(x31), .d(new_n105_), .O(new_n146_));
  ...
  oai21  g108(.a(new_n151_), .b(x26), .c(new_n152_), .O(new_n153_));
  ...
  nor2   g113(.a(new_n129_), .b(new_n128_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(x16), .c(x15), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n131_), .O(new_n160_));
  nand3  g116(.a(new_n158_), .b(x16), .c(x10), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n143_), .O(new_n162_));
  nand2  g118(.a(new_n158_), .b(x11), .O(new_n163_));
  ...
  nand4  g131(.a(new_n145_), .b(new_n54_), .c(new_n120_), .d(new_n105_), .O(new_n176_));
  oai21  g132(.a(new_n54_), .b(new_n105_), .c(new_n176_), .O(new_n177_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n157_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n178_), .c(new_n175_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n55_), .c(x00), .O(new_n187_));
