...
module FAU ( 
  ...
  aoi21  g049(.a(new_n93_), .b(new_n46_), .c(new_n45_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n92_), .c(new_n81_), .d(x25), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n46_), .c(new_n45_), .O(z4));
  ...
  aoi22  g057(.a(new_n101_), .b(new_n99_), .c(new_n89_), .d(new_n85_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n59_), .c(new_n81_), .d(x25), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n46_), .c(new_n45_), .O(z5));
  nor4   g060(.a(new_n91_), .b(x30), .c(new_n100_), .d(new_n98_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(x27), .c(new_n81_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n45_), .O(z6));
  inv1   g063(.a(new_n86_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n85_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n88_), .c(new_n87_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n59_), .b(new_n111_), .c(new_n81_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n110_), .c(new_n46_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x01), .O(z7));
  inv1   g070(.a(new_n47_), .O(new_n115_));
  ...
  nor3   g086(.a(new_n130_), .b(new_n129_), .c(new_n111_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n128_), .c(new_n125_), .d(new_n123_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n120_), .c(new_n115_), .O(new_n133_));
  nand2  g089(.a(new_n98_), .b(new_n82_), .O(new_n134_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n120_), .c(new_n115_), .O(new_n166_));
  nand2  g122(.a(new_n137_), .b(new_n111_), .O(new_n167_));
  nor2   g123(.a(new_n111_), .b(new_n100_), .O(new_n168_));
