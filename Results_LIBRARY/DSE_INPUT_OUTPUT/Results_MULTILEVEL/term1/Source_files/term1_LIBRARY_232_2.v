...
module FAU ( 
  ...
  nand2  g001(.a(new_n45_), .b(x25), .O(new_n46_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n82_), .c(new_n81_), .d(x01), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(x30), .c(new_n80_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n95_), .c(x30), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n81_), .c(x25), .d(x01), .O(new_n101_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n61_), .d(x30), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n81_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z5));
  nand2  g068(.a(new_n105_), .b(x29), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n103_), .c(new_n61_), .d(x30), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n81_), .c(x25), .d(x01), .O(new_n116_));
  ...
  nand3  g079(.a(new_n123_), .b(x30), .c(new_n81_), .O(new_n124_));
  nor4   g080(.a(new_n124_), .b(new_n60_), .c(new_n80_), .d(new_n59_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n121_), .c(new_n119_), .O(z7));
  nand2  g082(.a(new_n104_), .b(new_n82_), .O(new_n127_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(x31), .d(new_n45_), .O(new_n144_));
  nand2  g100(.a(x32), .b(x30), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n127_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n127_), .b(x29), .O(new_n148_));
  nand4  g104(.a(new_n143_), .b(new_n128_), .c(x31), .d(x30), .O(new_n149_));
  nand2  g105(.a(x32), .b(new_n45_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g108(.a(new_n90_), .b(x14), .O(new_n153_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n90_), .O(new_n158_));
  ...
  nor3   g120(.a(new_n164_), .b(new_n163_), .c(new_n122_), .O(new_n165_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n46_), .O(z8));
  nor2   g126(.a(new_n164_), .b(new_n163_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n155_), .c(new_n46_), .O(new_n173_));
  aoi21  g129(.a(new_n148_), .b(new_n122_), .c(x30), .O(new_n174_));
  nor2   g130(.a(new_n122_), .b(new_n106_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n127_), .c(new_n45_), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(new_n80_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x33), .O(new_n179_));
  nand4  g135(.a(new_n148_), .b(new_n122_), .c(new_n45_), .d(new_n80_), .O(new_n180_));
  nand4  g136(.a(new_n127_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n143_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(x33), .c(new_n179_), .O(new_n184_));
