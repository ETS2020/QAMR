...
module FAU ( 
  ...
  nand3  g051(.a(new_n95_), .b(new_n86_), .c(new_n84_), .O(new_n96_));
  ...
  aoi21  g056(.a(new_n96_), .b(new_n46_), .c(new_n100_), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n60_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n103_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n101_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n59_), .O(z5));
  nand3  g069(.a(new_n107_), .b(new_n90_), .c(x30), .O(new_n114_));
  inv1   g070(.a(x30), .O(new_n115_));
  nand4  g071(.a(new_n96_), .b(new_n115_), .c(x28), .d(x27), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x29), .O(new_n118_));
  aoi21  g074(.a(new_n96_), .b(x30), .c(new_n88_), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(x29), .c(new_n118_), .O(new_n120_));
  ...
  nor2   g081(.a(new_n100_), .b(new_n82_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n95_), .c(new_n86_), .d(new_n125_), .O(new_n127_));
  inv1   g083(.a(x25), .O(new_n128_));
  nand3  g084(.a(new_n61_), .b(new_n46_), .c(x01), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x30), .c(x29), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n107_), .c(new_n80_), .O(new_n132_));
  nor3   g088(.a(new_n132_), .b(new_n129_), .c(new_n128_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n127_), .c(new_n124_), .O(z7));
  nand2  g090(.a(new_n105_), .b(new_n81_), .O(new_n135_));
  ...
  nand3  g095(.a(new_n97_), .b(x18), .c(x14), .O(new_n140_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n136_), .c(x31), .d(new_n115_), .O(new_n154_));
  ...
  nand2  g115(.a(x32), .b(new_n115_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n97_), .b(x14), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x18), .c(x17), .d(x16), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n151_), .O(new_n165_));
  nand2  g121(.a(x16), .b(x15), .O(new_n166_));
  nand2  g122(.a(x18), .b(x17), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n166_), .c(new_n97_), .O(new_n168_));
  nand2  g124(.a(x16), .b(x10), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n167_), .c(new_n151_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n167_), .b(new_n171_), .c(new_n145_), .O(new_n172_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n165_), .c(x32), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n162_), .c(new_n157_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n80_), .c(x00), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n46_), .O(z8));
  nor2   g136(.a(new_n174_), .b(new_n173_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n165_), .c(new_n46_), .O(new_n183_));
  aoi21  g139(.a(new_n158_), .b(new_n130_), .c(x30), .O(new_n184_));
  nor2   g140(.a(new_n130_), .b(new_n109_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n135_), .c(new_n115_), .O(new_n186_));
  aoi21  g142(.a(new_n184_), .b(x24), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n183_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  nand4  g145(.a(new_n158_), .b(new_n130_), .c(new_n115_), .d(x24), .O(new_n190_));
  nand4  g146(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n153_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(x33), .c(new_n189_), .O(new_n194_));
