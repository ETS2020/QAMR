...
module FAU ( 
  ...
  nand3  g52(.a(x28), .b(new_n83_), .c(new_n45_), .O(new_n97_));
  inv1   g53(.a(x28), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x27), .O(new_n99_));
  aoi22  g55(.a(new_n99_), .b(new_n97_), .c(new_n91_), .d(new_n87_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n84_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g58(.a(x29), .O(new_n103_));
  nor2   g59(.a(new_n98_), .b(new_n83_), .O(new_n104_));
  nand3  g60(.a(new_n103_), .b(x28), .c(x27), .O(new_n105_));
  oai21  g61(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n92_), .c(new_n84_), .d(new_n82_), .O(new_n107_));
  ...
  aoi22  g70(.a(new_n114_), .b(new_n112_), .c(new_n91_), .d(new_n87_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n84_), .c(x25), .d(x01), .O(new_n116_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n87_), .O(new_n123_));
  nand3  g79(.a(new_n84_), .b(x01), .c(new_n45_), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(new_n125_));
  inv1   g81(.a(x25), .O(new_n126_));
  inv1   g82(.a(new_n104_), .O(new_n127_));
  inv1   g83(.a(x31), .O(new_n128_));
  nand3  g84(.a(new_n128_), .b(x30), .c(x29), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n127_), .c(new_n82_), .O(new_n130_));
  nor2   g86(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n125_), .c(new_n123_), .d(new_n119_), .O(z7));
  zero   g88(.O(z8));
  zero   g89(.O(z9));
endmodule
