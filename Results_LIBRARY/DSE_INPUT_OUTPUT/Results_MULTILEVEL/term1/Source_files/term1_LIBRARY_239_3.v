...
module FAU ( 
  ...
  nand3  g016(.a(new_n60_), .b(new_n57_), .c(x01), .O(new_n61_));
  ...
  oai21  g023(.a(new_n67_), .b(new_n62_), .c(new_n56_), .O(new_n68_));
  xor2a  g024(.a(x07), .b(x04), .O(new_n69_));
  xor2a  g025(.a(x03), .b(x02), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(new_n57_), .c(x01), .O(new_n71_));
  ...
  oai21  g031(.a(new_n75_), .b(new_n72_), .c(new_n69_), .O(new_n76_));
  aoi21  g032(.a(new_n76_), .b(new_n68_), .c(x09), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(x08), .O(new_n78_));
  inv1   g034(.a(new_n78_), .O(z2));
  inv1   g035(.a(x01), .O(new_n80_));
  ...
  aoi21  g048(.a(new_n92_), .b(new_n57_), .c(new_n80_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n91_), .c(new_n81_), .d(x25), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n57_), .c(new_n80_), .O(z4));
  ...
  nand4  g057(.a(new_n101_), .b(new_n90_), .c(new_n58_), .d(new_n57_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n81_), .c(x25), .d(x01), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z5));
  nand3  g061(.a(new_n91_), .b(x29), .c(x28), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(x27), .c(new_n81_), .d(x25), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n57_), .c(new_n80_), .O(z6));
  inv1   g065(.a(new_n87_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n86_), .c(new_n84_), .O(new_n111_));
  nand3  g067(.a(new_n58_), .b(x25), .c(x01), .O(new_n112_));
  nor4   g068(.a(new_n112_), .b(x31), .c(x30), .d(x26), .O(new_n113_));
  oai21  g069(.a(new_n111_), .b(new_n88_), .c(new_n113_), .O(z7));
  inv1   g070(.a(x15), .O(new_n115_));
  inv1   g071(.a(x19), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x14), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(x18), .c(x17), .d(x16), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand2  g075(.a(x16), .b(x15), .O(new_n120_));
  nand2  g076(.a(x18), .b(x17), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n120_), .c(new_n116_), .O(new_n122_));
  nand2  g078(.a(x16), .b(x10), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n115_), .O(new_n124_));
  inv1   g080(.a(x11), .O(new_n125_));
  inv1   g081(.a(x16), .O(new_n126_));
  oai21  g082(.a(new_n121_), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  aoi21  g084(.a(x18), .b(x12), .c(x17), .O(new_n129_));
  nor2   g085(.a(x18), .b(x13), .O(new_n130_));
  nor3   g086(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n119_), .c(new_n45_), .O(new_n133_));
  nand2  g089(.a(new_n97_), .b(new_n82_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x30), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n99_), .O(new_n136_));
  nand2  g092(.a(new_n134_), .b(x29), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n57_), .c(new_n136_), .d(new_n80_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand3  g097(.a(new_n137_), .b(x30), .c(new_n80_), .O(new_n142_));
  nand3  g098(.a(new_n134_), .b(new_n57_), .c(x29), .O(new_n143_));
  ...
  nand3  g103(.a(new_n116_), .b(x18), .c(x14), .O(new_n148_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n126_), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x15), .O(new_n157_));
  nand4  g113(.a(new_n154_), .b(x16), .c(new_n115_), .d(x10), .O(new_n158_));
  ...
  nor2   g119(.a(new_n130_), .b(new_n129_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n119_), .c(new_n45_), .O(new_n166_));
  nand2  g122(.a(new_n137_), .b(new_n128_), .O(new_n167_));
  nor2   g123(.a(new_n128_), .b(new_n99_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n134_), .c(new_n57_), .O(new_n169_));
  aoi22  g125(.a(new_n169_), .b(new_n80_), .c(new_n167_), .d(new_n57_), .O(new_n170_));
  ...
  oai22  g130(.a(new_n174_), .b(x01), .c(new_n167_), .d(x30), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n159_), .c(new_n173_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n81_), .c(x00), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(z9));
endmodule
