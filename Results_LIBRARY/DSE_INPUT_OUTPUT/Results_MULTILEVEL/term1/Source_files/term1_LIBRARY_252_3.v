...
module FAU ( 
  ...
  nand2  g033(.a(new_n77_), .b(new_n58_), .O(z2));
  ...
  nand3  g046(.a(new_n90_), .b(new_n46_), .c(new_n80_), .O(new_n91_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n46_), .c(new_n45_), .O(z5));
  nand3  g063(.a(new_n90_), .b(new_n46_), .c(x29), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n101_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x27), .c(new_n79_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n45_), .O(z6));
  nand2  g067(.a(new_n85_), .b(new_n83_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n87_), .c(new_n86_), .O(new_n113_));
  inv1   g069(.a(x31), .O(new_n114_));
  nand4  g070(.a(new_n60_), .b(new_n114_), .c(new_n79_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n113_), .c(new_n46_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x01), .O(z7));
  inv1   g073(.a(x15), .O(new_n118_));
  inv1   g074(.a(x19), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x14), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x18), .c(x17), .d(x16), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand2  g078(.a(x16), .b(x15), .O(new_n123_));
  nand2  g079(.a(x18), .b(x17), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n123_), .c(new_n119_), .O(new_n125_));
  nand2  g081(.a(x16), .b(x10), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(new_n118_), .O(new_n127_));
  inv1   g083(.a(x11), .O(new_n128_));
  inv1   g084(.a(x16), .O(new_n129_));
  oai21  g085(.a(new_n124_), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  aoi21  g086(.a(x18), .b(x12), .c(x17), .O(new_n131_));
  nor2   g087(.a(x18), .b(x13), .O(new_n132_));
  nor3   g088(.a(new_n132_), .b(new_n131_), .c(new_n114_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n130_), .c(new_n127_), .d(new_n125_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n122_), .c(new_n58_), .O(new_n135_));
  nor2   g091(.a(x28), .b(x27), .O(new_n136_));
  nor3   g092(.a(new_n136_), .b(new_n46_), .c(new_n103_), .O(new_n137_));
  inv1   g093(.a(new_n136_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x29), .O(new_n139_));
  aoi22  g095(.a(new_n139_), .b(new_n46_), .c(new_n137_), .d(new_n45_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n135_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  nand3  g099(.a(new_n139_), .b(x30), .c(new_n45_), .O(new_n144_));
  nand3  g100(.a(new_n138_), .b(new_n46_), .c(x29), .O(new_n145_));
  ...
  nand3  g105(.a(new_n119_), .b(x18), .c(x14), .O(new_n150_));
  ...
  nand3  g112(.a(new_n156_), .b(new_n129_), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x15), .O(new_n159_));
  nand4  g115(.a(new_n156_), .b(x16), .c(new_n118_), .d(x10), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n146_), .c(new_n143_), .d(x31), .O(new_n162_));
  ...
  nand4  g122(.a(new_n161_), .b(new_n166_), .c(x31), .d(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n46_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n138_), .c(x29), .O(new_n170_));
  nand4  g126(.a(new_n161_), .b(new_n166_), .c(new_n114_), .d(new_n46_), .O(new_n171_));
  nand2  g127(.a(x33), .b(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n139_), .O(new_n174_));
  inv1   g130(.a(new_n131_), .O(new_n175_));
  inv1   g131(.a(new_n132_), .O(new_n176_));
  ...
  nand4  g135(.a(new_n179_), .b(new_n130_), .c(new_n127_), .d(new_n125_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n122_), .c(x33), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n174_), .c(new_n170_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n79_), .c(x00), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n58_), .O(z9));
endmodule
