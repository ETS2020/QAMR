...
module FAU ( 
  ...
  nor2   g050(.a(new_n94_), .b(new_n56_), .O(new_n95_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n63_), .d(new_n45_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n81_), .c(new_n62_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n63_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n62_), .c(new_n48_), .O(z6));
  ...
  nor2   g079(.a(new_n56_), .b(new_n81_), .O(new_n124_));
  ...
  nand2  g083(.a(new_n103_), .b(new_n82_), .O(new_n128_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n49_), .c(x31), .d(new_n111_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n143_), .b(new_n49_), .c(x31), .d(x30), .O(new_n149_));
  nand2  g105(.a(x32), .b(new_n111_), .O(new_n150_));
  ...
  nor3   g120(.a(new_n164_), .b(new_n163_), .c(new_n116_), .O(new_n165_));
  ...
  nand4  g126(.a(new_n143_), .b(new_n53_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n111_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n128_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n143_), .b(new_n53_), .c(new_n116_), .d(new_n111_), .O(new_n175_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n155_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n178_), .c(new_n174_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n45_), .c(x00), .O(new_n187_));
