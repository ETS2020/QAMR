...
module FAU ( 
  ...
  nor2   g43(.a(x22), .b(x17), .O(new_n88_));
  nor2   g44(.a(x23), .b(x18), .O(new_n89_));
  nor2   g45(.a(x24), .b(x19), .O(new_n90_));
  nor3   g46(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(x25), .c(x01), .d(new_n45_), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(z3));
  xor2a  g52(.a(x28), .b(x27), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n92_), .c(new_n84_), .d(new_n82_), .O(new_n98_));
  ...
  and2   g58(.a(x28), .b(x27), .O(new_n103_));
  nand3  g59(.a(new_n102_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g60(.a(new_n103_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  and2   g61(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  ...
  nand3  g67(.a(new_n103_), .b(new_n111_), .c(x29), .O(new_n112_));
  aoi22  g68(.a(new_n112_), .b(new_n110_), .c(new_n91_), .d(new_n87_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n84_), .c(x25), .d(x01), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g71(.a(new_n103_), .b(x30), .c(x29), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(x31), .O(new_n117_));
  inv1   g73(.a(new_n89_), .O(new_n118_));
  inv1   g74(.a(new_n90_), .O(new_n119_));
  nor3   g75(.a(new_n88_), .b(new_n86_), .c(new_n85_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n119_), .c(new_n118_), .O(new_n121_));
  nor2   g77(.a(new_n60_), .b(new_n63_), .O(new_n122_));
  ...
  aoi21  g82(.a(new_n126_), .b(new_n103_), .c(new_n123_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n122_), .c(new_n121_), .d(new_n117_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n45_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n82_), .O(z7));
  nor2   g86(.a(x26), .b(new_n45_), .O(z9));
endmodule
