...
module FAU ( 
  ...
  inv1   g012(.a(x32), .O(new_n57_));
  oai21  g013(.a(new_n48_), .b(x26), .c(new_n57_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n56_), .c(new_n51_), .O(z1));
  inv1   g015(.a(x09), .O(new_n60_));
  nand2  g016(.a(new_n57_), .b(x26), .O(new_n61_));
  xnor2a g017(.a(x07), .b(x04), .O(new_n62_));
  inv1   g018(.a(x01), .O(new_n63_));
  nor2   g019(.a(new_n46_), .b(new_n52_), .O(new_n64_));
  inv1   g020(.a(new_n64_), .O(new_n65_));
  nand2  g021(.a(new_n46_), .b(new_n52_), .O(new_n66_));
  aoi21  g022(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(new_n67_));
  nand2  g023(.a(x05), .b(new_n46_), .O(new_n68_));
  nand3  g024(.a(new_n68_), .b(x06), .c(new_n52_), .O(new_n69_));
  nand2  g025(.a(x06), .b(new_n52_), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(x05), .c(new_n46_), .O(new_n71_));
  aoi21  g027(.a(new_n71_), .b(new_n69_), .c(x01), .O(new_n72_));
  oai21  g028(.a(new_n72_), .b(new_n67_), .c(new_n62_), .O(new_n73_));
  xor2a  g029(.a(x07), .b(x04), .O(new_n74_));
  xnor2a g030(.a(x03), .b(x02), .O(new_n75_));
  nor2   g031(.a(new_n75_), .b(new_n63_), .O(new_n76_));
  nand2  g032(.a(new_n70_), .b(new_n68_), .O(new_n77_));
  nand4  g033(.a(x06), .b(x05), .c(new_n46_), .d(new_n52_), .O(new_n78_));
  aoi21  g034(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(new_n76_), .c(new_n74_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n73_), .O(new_n81_));
  nand4  g037(.a(new_n81_), .b(new_n61_), .c(new_n60_), .d(x08), .O(new_n82_));
  ...
  nor2   g066(.a(new_n108_), .b(x29), .O(new_n111_));
  aoi21  g067(.a(new_n110_), .b(x29), .c(new_n111_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n90_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n65_), .c(new_n84_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n63_), .O(z6));
  ...
  nor2   g075(.a(new_n87_), .b(new_n86_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n119_), .c(new_n118_), .O(new_n121_));
  nor2   g077(.a(new_n64_), .b(new_n63_), .O(new_n122_));
  inv1   g078(.a(new_n101_), .O(new_n123_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n122_), .c(new_n121_), .d(new_n117_), .O(z7));
  nand2  g084(.a(new_n100_), .b(new_n85_), .O(new_n129_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n57_), .c(x31), .d(new_n108_), .O(new_n148_));
  nand2  g104(.a(x32), .b(x30), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n129_), .c(x29), .O(new_n151_));
  nand2  g107(.a(new_n129_), .b(x29), .O(new_n152_));
  nand4  g108(.a(new_n147_), .b(new_n57_), .c(x31), .d(x30), .O(new_n153_));
  ...
  nand2  g112(.a(new_n133_), .b(x14), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(x18), .c(x17), .d(x16), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n145_), .O(new_n159_));
  nand2  g115(.a(x16), .b(x15), .O(new_n160_));
  nand2  g116(.a(x18), .b(x17), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n133_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x10), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n161_), .c(new_n145_), .O(new_n164_));
  inv1   g120(.a(x11), .O(new_n165_));
  oai21  g121(.a(new_n161_), .b(new_n165_), .c(new_n139_), .O(new_n166_));
  aoi21  g122(.a(x18), .b(x12), .c(x17), .O(new_n167_));
  nor2   g123(.a(x18), .b(x13), .O(new_n168_));
  nor3   g124(.a(new_n168_), .b(new_n167_), .c(new_n124_), .O(new_n169_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n156_), .c(new_n151_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n84_), .c(x00), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(z8));
  nand4  g130(.a(new_n147_), .b(new_n48_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n108_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n129_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n147_), .b(new_n48_), .c(new_n124_), .d(new_n108_), .O(new_n179_));
  ...
  nand3  g146(.a(new_n190_), .b(new_n84_), .c(x00), .O(new_n191_));
