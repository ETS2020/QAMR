...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n199_, new_n200_;
  nand2  g000(.a(x30), .b(x21), .O(new_n45_));
  ...
  inv1   g054(.a(new_n84_), .O(new_n99_));
  inv1   g055(.a(new_n85_), .O(new_n100_));
  nor2   g056(.a(new_n83_), .b(new_n80_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n45_), .c(new_n81_), .O(new_n103_));
  aoi21  g059(.a(new_n98_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n57_), .O(z5));
  nand2  g062(.a(new_n102_), .b(x16), .O(new_n107_));
  inv1   g063(.a(x16), .O(new_n108_));
  inv1   g064(.a(x21), .O(new_n109_));
  nand3  g065(.a(x29), .b(new_n109_), .c(new_n108_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n107_), .c(new_n94_), .O(new_n111_));
  nor2   g067(.a(new_n80_), .b(new_n108_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n86_), .c(x29), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n111_), .c(x30), .O(new_n114_));
  inv1   g070(.a(x30), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(x21), .c(new_n102_), .O(new_n116_));
  nand3  g072(.a(new_n115_), .b(new_n109_), .c(new_n108_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x29), .c(x28), .d(x27), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n114_), .c(new_n58_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n78_), .c(x25), .d(x01), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n45_), .O(z6));
  nand3  g078(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n108_), .O(new_n124_));
  nand4  g080(.a(new_n59_), .b(new_n78_), .c(x25), .d(x01), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n124_), .c(new_n45_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n130_), .b(new_n95_), .c(new_n128_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n109_), .O(new_n132_));
  oai21  g088(.a(new_n123_), .b(new_n109_), .c(new_n129_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n115_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(new_n126_), .O(z7));
  inv1   g091(.a(x15), .O(new_n136_));
  inv1   g092(.a(x19), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x14), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(x18), .c(x17), .d(x16), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g096(.a(x16), .b(x15), .O(new_n141_));
  nand2  g097(.a(x18), .b(x17), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(new_n137_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n142_), .c(new_n136_), .O(new_n145_));
  inv1   g101(.a(x11), .O(new_n146_));
  oai21  g102(.a(new_n142_), .b(new_n146_), .c(new_n108_), .O(new_n147_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n140_), .c(new_n45_), .O(new_n152_));
  nor2   g108(.a(x28), .b(x27), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n115_), .c(new_n97_), .O(new_n154_));
  inv1   g110(.a(new_n153_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x29), .O(new_n156_));
  aoi22  g112(.a(new_n156_), .b(new_n115_), .c(new_n154_), .d(new_n109_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x32), .O(new_n159_));
  inv1   g115(.a(x32), .O(new_n160_));
  nand3  g116(.a(new_n156_), .b(x30), .c(new_n109_), .O(new_n161_));
  nand3  g117(.a(new_n155_), .b(new_n115_), .c(x29), .O(new_n162_));
  ...
  nand3  g122(.a(new_n137_), .b(x18), .c(x14), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand4  g124(.a(x19), .b(x18), .c(new_n164_), .d(x12), .O(new_n169_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n108_), .c(x11), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x15), .O(new_n176_));
  nand4  g132(.a(new_n173_), .b(x16), .c(new_n136_), .d(x10), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n163_), .c(new_n160_), .d(x31), .O(new_n179_));
  ...
  nand2  g140(.a(x33), .b(new_n115_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n155_), .c(x29), .O(new_n187_));
  nand4  g143(.a(new_n178_), .b(new_n183_), .c(new_n129_), .d(new_n115_), .O(new_n188_));
  ...
  inv1   g147(.a(new_n148_), .O(new_n192_));
  ...
  nand4  g152(.a(new_n196_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n140_), .c(x33), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n191_), .c(new_n187_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n78_), .c(x00), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n45_), .O(z9));
endmodule
