...
module FAU ( 
  ...
  nand3  g070(.a(new_n104_), .b(x30), .c(x29), .O(new_n115_));
  ...
  nand2  g083(.a(new_n90_), .b(x14), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n90_), .O(new_n133_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n130_), .c(new_n126_), .O(new_n143_));
  nand2  g099(.a(new_n103_), .b(new_n82_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x29), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n46_), .c(new_n45_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n144_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n151_));
  nand2  g107(.a(new_n145_), .b(x30), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n87_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n90_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n84_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n157_));
  ...
  oai21  g128(.a(new_n172_), .b(new_n130_), .c(new_n126_), .O(new_n173_));
  aoi21  g129(.a(new_n145_), .b(new_n121_), .c(x30), .O(new_n174_));
  nor2   g130(.a(new_n121_), .b(new_n102_), .O(new_n175_));
  ...
  nand4  g137(.a(new_n145_), .b(new_n121_), .c(new_n46_), .d(new_n45_), .O(new_n182_));
