...
module FAU ( 
  ...
  nand3  g044(.a(new_n88_), .b(x30), .c(new_n80_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n79_), .c(x25), .d(x01), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z3));
  nand3  g048(.a(x30), .b(x28), .c(new_n80_), .O(new_n93_));
  oai21  g049(.a(x28), .b(new_n80_), .c(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n88_), .c(x25), .d(x01), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(x30), .c(x26), .O(z4));
  nand2  g052(.a(new_n87_), .b(new_n83_), .O(new_n97_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n60_), .d(x30), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n79_), .c(x25), .d(x01), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z5));
  oai21  g062(.a(new_n99_), .b(new_n80_), .c(x30), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(x29), .c(new_n87_), .d(new_n83_), .O(new_n108_));
  ...
  nand3  g073(.a(new_n100_), .b(new_n117_), .c(x29), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n60_), .c(x25), .d(x01), .O(new_n119_));
  ...
  nand2  g078(.a(new_n122_), .b(new_n79_), .O(z7));
  inv1   g079(.a(x32), .O(new_n124_));
  nand2  g080(.a(new_n99_), .b(new_n80_), .O(new_n125_));
  ...
  nor2   g124(.a(new_n117_), .b(new_n98_), .O(new_n169_));
  ...
  oai21  g130(.a(new_n167_), .b(new_n98_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x00), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(x30), .c(x26), .O(z9));
endmodule
