...
module FAU ( 
  ...
  aoi21  g034(.a(new_n78_), .b(new_n57_), .c(x09), .O(z2));
  ...
  nand4  g058(.a(new_n102_), .b(new_n87_), .c(new_n61_), .d(new_n80_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x25), .c(x01), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n46_), .O(z5));
  nand3  g062(.a(new_n57_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n100_), .b(new_n57_), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n57_), .b(x29), .O(new_n109_));
  ...
  oai21  g069(.a(x31), .b(x30), .c(new_n45_), .O(new_n114_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(x31), .d(new_n57_), .O(new_n147_));
  ...
  nand2  g108(.a(x32), .b(new_n57_), .O(new_n153_));
  ...
  nand2  g131(.a(x33), .b(new_n57_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n127_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n146_), .b(new_n174_), .c(new_n122_), .d(new_n57_), .O(new_n179_));
  ...
  nand2  g147(.a(new_n191_), .b(new_n46_), .O(z9));
endmodule
