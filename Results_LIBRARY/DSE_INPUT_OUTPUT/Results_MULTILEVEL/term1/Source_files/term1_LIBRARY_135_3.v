...
module FAU ( 
  ...
  nand4  g067(.a(new_n111_), .b(new_n95_), .c(new_n46_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n63_), .O(z6));
  ...
  nand4  g135(.a(new_n146_), .b(new_n176_), .c(new_n122_), .d(new_n106_), .O(new_n180_));
  oai21  g136(.a(new_n176_), .b(new_n106_), .c(new_n180_), .O(new_n181_));
