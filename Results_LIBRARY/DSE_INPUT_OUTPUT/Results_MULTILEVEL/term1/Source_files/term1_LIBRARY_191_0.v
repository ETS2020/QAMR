...
module FAU ( 
  ...
  nand3  g007(.a(new_n51_), .b(new_n47_), .c(new_n49_), .O(new_n52_));
  ...
  nand3  g014(.a(new_n58_), .b(new_n46_), .c(x30), .O(new_n59_));
  nand2  g015(.a(new_n59_), .b(new_n52_), .O(z1));
  ...
  oai21  g043(.a(new_n87_), .b(new_n62_), .c(new_n47_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n86_), .c(new_n79_), .d(x25), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(new_n62_), .c(new_n47_), .O(z4));
  inv1   g047(.a(new_n55_), .O(new_n92_));
  inv1   g048(.a(new_n85_), .O(new_n93_));
  inv1   g049(.a(x29), .O(new_n94_));
  and2   g050(.a(x28), .b(x27), .O(new_n95_));
  nand3  g051(.a(new_n94_), .b(x28), .c(x27), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n94_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n93_), .c(new_n92_), .d(new_n79_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(x25), .c(x01), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n47_), .O(z5));
  nand3  g057(.a(new_n45_), .b(x28), .c(x27), .O(new_n102_));
  oai21  g058(.a(new_n95_), .b(new_n45_), .c(new_n102_), .O(new_n103_));
  nor2   g059(.a(new_n45_), .b(x29), .O(new_n104_));
  aoi21  g060(.a(new_n103_), .b(x29), .c(new_n104_), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n85_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n79_), .d(x25), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n62_), .c(new_n47_), .O(z6));
  oai21  g064(.a(new_n46_), .b(x31), .c(new_n45_), .O(new_n109_));
  ...
  nor2   g071(.a(new_n55_), .b(new_n62_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand4  g073(.a(new_n95_), .b(new_n117_), .c(x30), .d(x29), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n116_), .c(new_n79_), .d(x25), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n115_), .c(new_n111_), .d(new_n109_), .O(z7));
  ...
  nand3  g085(.a(new_n129_), .b(x16), .c(x15), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n123_), .O(new_n131_));
  nand3  g087(.a(new_n129_), .b(x16), .c(x10), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n122_), .O(new_n133_));
  inv1   g089(.a(x16), .O(new_n134_));
  nand2  g090(.a(new_n129_), .b(x11), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  aoi21  g092(.a(x18), .b(x12), .c(x17), .O(new_n137_));
  nor2   g093(.a(x18), .b(x13), .O(new_n138_));
  nor3   g094(.a(new_n138_), .b(new_n137_), .c(new_n117_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n126_), .c(new_n47_), .O(new_n141_));
  nor2   g097(.a(x28), .b(x27), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x30), .c(x29), .O(new_n144_));
  nor2   g100(.a(new_n142_), .b(new_n94_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x33), .c(new_n45_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n144_), .c(new_n141_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  nand4  g105(.a(new_n143_), .b(x33), .c(new_n45_), .d(x29), .O(new_n150_));
  oai21  g106(.a(new_n145_), .b(new_n45_), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(x19), .b(new_n128_), .c(x13), .O(new_n152_));
  nand3  g108(.a(new_n123_), .b(x18), .c(x14), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n152_), .c(new_n127_), .O(new_n154_));
  nand4  g110(.a(x19), .b(x18), .c(new_n127_), .d(x12), .O(new_n155_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n151_), .c(new_n49_), .d(x31), .O(new_n165_));
  ...
  nand4  g124(.a(new_n164_), .b(new_n46_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n45_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n143_), .c(x29), .O(new_n172_));
  nand2  g128(.a(x31), .b(x29), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n142_), .c(x30), .O(new_n174_));
  inv1   g130(.a(new_n137_), .O(new_n175_));
  aoi21  g131(.a(x31), .b(new_n45_), .c(new_n138_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n175_), .c(new_n136_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n174_), .c(new_n133_), .d(new_n131_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n126_), .c(x33), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n172_), .O(new_n181_));
