...
module FAU ( 
  ...
  nor3   g045(.a(new_n89_), .b(new_n81_), .c(new_n62_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n88_), .c(new_n45_), .d(x25), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n62_), .c(new_n47_), .O(z4));
  inv1   g049(.a(new_n59_), .O(new_n94_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n94_), .d(new_n45_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n81_), .c(new_n62_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n62_), .c(new_n47_), .O(z6));
  ...
  nor2   g072(.a(new_n59_), .b(new_n62_), .O(new_n117_));
  ...
  nor2   g077(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(new_n116_), .d(new_n112_), .O(z7));
  nand2  g079(.a(new_n97_), .b(new_n82_), .O(new_n124_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n125_), .c(x31), .d(new_n103_), .O(new_n144_));
  ...
  nand2  g105(.a(x32), .b(new_n103_), .O(new_n150_));
  ...
  nor3   g120(.a(new_n164_), .b(new_n163_), .c(new_n119_), .O(new_n165_));
  ...
  nand2  g128(.a(x33), .b(new_n103_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n124_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n143_), .b(new_n171_), .c(new_n119_), .d(new_n103_), .O(new_n176_));
