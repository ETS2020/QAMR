...
module FAU ( 
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n63_), .d(x25), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n62_), .c(new_n48_), .O(z6));
  ...
  nand2  g084(.a(new_n103_), .b(new_n81_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n49_), .c(x31), .d(new_n113_), .O(new_n145_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n124_), .O(new_n166_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n53_), .c(new_n124_), .d(new_n113_), .O(new_n176_));
