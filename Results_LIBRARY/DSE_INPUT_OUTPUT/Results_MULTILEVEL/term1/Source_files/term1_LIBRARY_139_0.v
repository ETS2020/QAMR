...
module FAU ( 
  ...
  oai21  g069(.a(new_n105_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x29), .O(new_n115_));
  oai21  g071(.a(new_n112_), .b(x29), .c(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n93_), .c(new_n80_), .d(new_n78_), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x25), .c(x01), .d(x00), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(z6));
  nand3  g076(.a(new_n105_), .b(x30), .c(x29), .O(new_n121_));
  ...
  nor2   g080(.a(new_n54_), .b(new_n60_), .O(new_n125_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n105_), .c(new_n126_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n124_), .d(new_n122_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x00), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n78_), .O(z7));
  nand2  g089(.a(new_n99_), .b(new_n79_), .O(new_n134_));
  nand3  g090(.a(x19), .b(new_n85_), .c(x13), .O(new_n135_));
  nand3  g091(.a(new_n88_), .b(x18), .c(x14), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n82_), .O(new_n137_));
  ...
  nand2  g110(.a(x32), .b(new_n112_), .O(new_n155_));
  oai21  g111(.a(new_n150_), .b(new_n112_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n88_), .b(x14), .O(new_n157_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n88_), .O(new_n162_));
  ...
  nor3   g124(.a(new_n168_), .b(new_n167_), .c(new_n127_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n149_), .b(new_n51_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n112_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n134_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n149_), .b(new_n51_), .c(new_n127_), .d(new_n112_), .O(new_n179_));
