...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(new_n91_), .c(new_n46_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n90_), .c(new_n60_), .O(z3));
  xor2a  g055(.a(x28), .b(x27), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n97_), .c(new_n46_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n90_), .c(new_n60_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n62_), .d(new_n46_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n90_), .c(new_n60_), .O(z5));
  inv1   g066(.a(x30), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x28), .c(x27), .O(new_n112_));
  oai21  g068(.a(new_n106_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n62_), .c(new_n46_), .d(x25), .O(new_n117_));
  ...
  inv1   g077(.a(new_n95_), .O(new_n122_));
  nor2   g078(.a(new_n93_), .b(new_n92_), .O(new_n123_));
  ...
  nor2   g085(.a(new_n129_), .b(new_n90_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n124_), .d(new_n120_), .O(z7));
  nand2  g087(.a(new_n105_), .b(new_n91_), .O(new_n132_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n133_), .c(x31), .d(new_n111_), .O(new_n152_));
  ...
  nand2  g133(.a(new_n177_), .b(new_n83_), .O(z8));
  ...
  nand4  g139(.a(new_n151_), .b(new_n179_), .c(new_n127_), .d(new_n111_), .O(new_n184_));
  ...
  nand2  g152(.a(new_n196_), .b(new_n83_), .O(z9));
endmodule
