...
module FAU ( 
  ...
  nor2   g050(.a(new_n94_), .b(new_n57_), .O(new_n95_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n62_), .c(new_n49_), .O(z4));
  ...
  nand4  g061(.a(new_n105_), .b(new_n101_), .c(new_n63_), .d(new_n45_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n81_), .c(new_n62_), .O(z5));
  nand2  g063(.a(new_n103_), .b(x29), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x30), .c(new_n45_), .O(new_n109_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n63_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n62_), .c(new_n49_), .O(z6));
  nand3  g070(.a(new_n103_), .b(x30), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x31), .O(new_n116_));
  inv1   g072(.a(new_n83_), .O(new_n117_));
  nand4  g073(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n117_), .O(new_n118_));
  nor2   g074(.a(new_n57_), .b(new_n62_), .O(new_n119_));
  inv1   g075(.a(new_n103_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x30), .c(x29), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n45_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n81_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(z7));
  nand2  g081(.a(new_n46_), .b(new_n82_), .O(new_n126_));
  nand3  g082(.a(x19), .b(new_n87_), .c(x13), .O(new_n127_));
  nand3  g083(.a(new_n90_), .b(x18), .c(x14), .O(new_n128_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n50_), .c(x31), .O(new_n142_));
  nand2  g098(.a(x32), .b(x30), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(x30), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n126_), .c(x29), .O(new_n145_));
  nand2  g101(.a(new_n126_), .b(x29), .O(new_n146_));
  nand2  g102(.a(x32), .b(new_n110_), .O(new_n147_));
  oai21  g103(.a(new_n142_), .b(new_n110_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g105(.a(new_n90_), .b(x14), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(x18), .c(x17), .d(x16), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n139_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x15), .O(new_n153_));
  nand2  g109(.a(x18), .b(x17), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n153_), .c(new_n90_), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(new_n139_), .O(new_n157_));
  inv1   g113(.a(x11), .O(new_n158_));
  oai21  g114(.a(new_n154_), .b(new_n158_), .c(new_n133_), .O(new_n159_));
  aoi21  g115(.a(x18), .b(x12), .c(x17), .O(new_n160_));
  nor2   g116(.a(x18), .b(x13), .O(new_n161_));
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n121_), .O(new_n162_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n149_), .c(new_n145_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n45_), .c(x00), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(z8));
  oai21  g123(.a(new_n82_), .b(x26), .c(new_n46_), .O(new_n168_));
  nand4  g124(.a(new_n141_), .b(new_n54_), .c(x31), .d(x30), .O(new_n169_));
  oai21  g125(.a(new_n54_), .b(x30), .c(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n168_), .c(x29), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  nand4  g128(.a(new_n141_), .b(new_n54_), .c(new_n121_), .d(new_n110_), .O(new_n173_));
  ...
  aoi21  g139(.a(new_n183_), .b(new_n176_), .c(x26), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n172_), .c(x00), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n49_), .O(z9));
endmodule
