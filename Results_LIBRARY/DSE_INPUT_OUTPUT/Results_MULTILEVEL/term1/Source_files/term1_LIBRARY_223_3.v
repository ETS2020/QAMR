...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n59_), .c(new_n45_), .O(new_n93_));
  ...
  nand2  g059(.a(x30), .b(x06), .O(new_n104_));
  inv1   g060(.a(x29), .O(new_n105_));
  inv1   g061(.a(x28), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n79_), .O(new_n107_));
  nand3  g063(.a(new_n105_), .b(x28), .c(x27), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(new_n105_), .c(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n104_), .c(new_n92_), .d(new_n59_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n78_), .c(x25), .d(x01), .O(new_n112_));
  ...
  oai21  g074(.a(new_n116_), .b(x06), .c(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n92_), .c(new_n59_), .d(new_n78_), .O(new_n120_));
  nor3   g076(.a(new_n120_), .b(new_n114_), .c(new_n57_), .O(z6));
  oai21  g077(.a(x31), .b(x30), .c(x06), .O(new_n122_));
  nand3  g078(.a(new_n107_), .b(x30), .c(x29), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x31), .O(new_n124_));
  nand4  g080(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n125_));
  nor2   g081(.a(new_n58_), .b(new_n57_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand4  g083(.a(new_n107_), .b(new_n127_), .c(x30), .d(x29), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n126_), .c(new_n78_), .d(x25), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n124_), .d(new_n122_), .O(z7));
  nand2  g087(.a(new_n106_), .b(new_n79_), .O(new_n132_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(x31), .d(new_n117_), .O(new_n149_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n89_), .O(new_n163_));
  ...
  nand4  g136(.a(new_n148_), .b(new_n176_), .c(new_n127_), .d(new_n117_), .O(new_n181_));
  ...
  nand2  g149(.a(new_n193_), .b(new_n45_), .O(z9));
endmodule
