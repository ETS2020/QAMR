...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n62_), .d(new_n46_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x25), .c(x01), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n48_), .O(z5));
  ...
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n130_), .O(new_n161_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n46_), .c(x00), .O(new_n172_));
  ...
  nand3  g132(.a(new_n176_), .b(new_n125_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n144_), .b(new_n174_), .c(new_n120_), .d(new_n103_), .O(new_n178_));
  oai21  g134(.a(new_n174_), .b(new_n103_), .c(new_n178_), .O(new_n179_));
  ...
  aoi21  g144(.a(new_n188_), .b(new_n177_), .c(new_n45_), .O(z9));
endmodule
