...
module FAU ( 
  ...
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n79_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n62_), .c(new_n46_), .O(z6));
  ...
  nand3  g072(.a(new_n92_), .b(x25), .c(x01), .O(new_n117_));
  ...
  nor2   g078(.a(new_n122_), .b(x26), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n118_), .c(new_n116_), .d(new_n112_), .O(z7));
  nand2  g080(.a(new_n95_), .b(new_n80_), .O(new_n125_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n48_), .c(x31), .O(new_n144_));
  ...
  nand2  g104(.a(x32), .b(new_n103_), .O(new_n149_));
  oai21  g105(.a(new_n144_), .b(new_n103_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g107(.a(new_n129_), .b(x14), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(x18), .c(x17), .d(x16), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n141_), .O(new_n154_));
  nor2   g110(.a(new_n127_), .b(new_n126_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(x16), .c(x15), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n129_), .O(new_n157_));
  nand3  g113(.a(new_n155_), .b(x16), .c(x10), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n141_), .O(new_n159_));
  nand2  g115(.a(new_n155_), .b(x11), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n135_), .O(new_n161_));
  aoi21  g117(.a(x18), .b(x12), .c(x17), .O(new_n162_));
  nor2   g118(.a(x18), .b(x13), .O(new_n163_));
  nor3   g119(.a(new_n163_), .b(new_n162_), .c(new_n120_), .O(new_n164_));
  ...
  nand3  g122(.a(new_n166_), .b(new_n151_), .c(new_n147_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n46_), .c(new_n79_), .d(x00), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(z8));
  aoi21  g125(.a(new_n142_), .b(new_n140_), .c(x33), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x31), .c(x30), .d(new_n52_), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n103_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n125_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n170_), .b(new_n120_), .c(new_n103_), .d(new_n52_), .O(new_n175_));
