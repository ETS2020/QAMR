...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n62_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(x30), .c(x26), .O(z5));
  aoi21  g058(.a(new_n97_), .b(x29), .c(new_n89_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n62_), .c(x25), .d(x01), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(x30), .c(x26), .O(z6));
  ...
  nand4  g066(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n84_), .O(new_n111_));
  nand3  g067(.a(new_n62_), .b(x25), .c(x01), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x29), .c(x28), .d(x27), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x30), .c(new_n45_), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n111_), .c(new_n107_), .O(z7));
  inv1   g073(.a(x32), .O(new_n118_));
  nand2  g074(.a(new_n96_), .b(new_n81_), .O(new_n119_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n120_), .c(new_n118_), .d(x31), .O(new_n139_));
  ...
  aoi21  g107(.a(new_n122_), .b(new_n151_), .c(new_n113_), .O(new_n152_));
  ...
  nand4  g113(.a(new_n157_), .b(x30), .c(new_n45_), .d(x00), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  nand4  g116(.a(new_n138_), .b(new_n119_), .c(new_n160_), .d(x31), .O(new_n161_));
  nand2  g117(.a(new_n122_), .b(new_n151_), .O(new_n162_));
  nor2   g118(.a(new_n113_), .b(new_n98_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n150_), .d(new_n119_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  and2   g121(.a(new_n165_), .b(new_n148_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n146_), .c(new_n144_), .d(new_n141_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x33), .O(new_n168_));
  oai21  g124(.a(new_n161_), .b(new_n98_), .c(new_n168_), .O(new_n169_));
