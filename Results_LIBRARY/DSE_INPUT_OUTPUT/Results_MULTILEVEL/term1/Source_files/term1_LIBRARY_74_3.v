...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n82_), .c(new_n46_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n81_), .c(new_n60_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n46_), .d(x25), .O(new_n97_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n91_), .c(new_n62_), .d(new_n46_), .O(new_n104_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n92_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n62_), .c(new_n46_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n60_), .c(new_n58_), .O(z6));
  nand3  g071(.a(new_n101_), .b(x30), .c(x29), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  nand4  g073(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n118_));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n101_), .c(new_n81_), .O(new_n123_));
  ...
  nand2  g082(.a(new_n100_), .b(new_n82_), .O(new_n127_));
  ...
  nand2  g108(.a(x32), .b(new_n108_), .O(new_n153_));
  ...
  aoi21  g129(.a(new_n173_), .b(new_n150_), .c(new_n45_), .O(z8));
  ...
  nand4  g135(.a(new_n146_), .b(new_n175_), .c(new_n120_), .d(new_n108_), .O(new_n180_));
