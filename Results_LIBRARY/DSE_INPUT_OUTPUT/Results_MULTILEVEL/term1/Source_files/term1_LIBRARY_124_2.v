...
module FAU ( 
  ...
  nor2   g109(.a(new_n153_), .b(new_n104_), .O(new_n154_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(x30), .O(new_n162_));
  nand3  g118(.a(x19), .b(x18), .c(x17), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n115_), .c(x11), .O(new_n165_));
  oai21  g121(.a(new_n162_), .b(new_n115_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x15), .O(new_n167_));
  nor2   g123(.a(new_n115_), .b(x15), .O(new_n168_));
  nor2   g124(.a(new_n156_), .b(new_n83_), .O(new_n169_));
  nor2   g125(.a(new_n45_), .b(new_n88_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(x10), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n167_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n155_), .c(x31), .O(new_n173_));
  nand2  g129(.a(x32), .b(new_n45_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n173_), .c(new_n154_), .O(new_n175_));
  inv1   g131(.a(new_n153_), .O(new_n176_));
  oai21  g132(.a(new_n161_), .b(new_n159_), .c(x15), .O(new_n177_));
  nand3  g133(.a(new_n164_), .b(new_n114_), .c(x10), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n155_), .c(x31), .d(new_n45_), .O(new_n180_));
  oai22  g136(.a(new_n180_), .b(new_n115_), .c(new_n155_), .d(new_n45_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n176_), .c(x29), .O(new_n182_));
  aoi22  g138(.a(x30), .b(new_n115_), .c(new_n88_), .d(x14), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(x18), .c(x17), .d(x15), .O(new_n184_));
  nand3  g140(.a(new_n169_), .b(x16), .c(x15), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n88_), .O(new_n186_));
  and2   g142(.a(x16), .b(x10), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n169_), .c(x15), .O(new_n188_));
  nand3  g144(.a(x18), .b(x16), .c(x12), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n83_), .O(new_n190_));
  inv1   g146(.a(x13), .O(new_n191_));
  oai21  g147(.a(new_n115_), .b(new_n191_), .c(new_n156_), .O(new_n192_));
  oai21  g148(.a(new_n45_), .b(new_n134_), .c(new_n115_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n192_), .c(new_n190_), .d(x31), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n188_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n186_), .c(new_n184_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(x32), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n182_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n175_), .c(new_n80_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n152_), .c(new_n46_), .O(z8));
  inv1   g156(.a(x33), .O(new_n201_));
  nand3  g157(.a(new_n172_), .b(new_n201_), .c(x31), .O(new_n202_));
  nand2  g158(.a(x33), .b(new_n45_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n176_), .c(x29), .O(new_n205_));
  inv1   g161(.a(new_n154_), .O(new_n206_));
  nand4  g162(.a(new_n179_), .b(new_n201_), .c(new_n147_), .d(new_n45_), .O(new_n207_));
  oai22  g163(.a(new_n207_), .b(new_n115_), .c(new_n201_), .d(new_n45_), .O(new_n208_));
  oai21  g164(.a(x31), .b(new_n115_), .c(new_n45_), .O(new_n209_));
  aoi21  g165(.a(new_n169_), .b(x11), .c(x16), .O(new_n210_));
  aoi21  g166(.a(x18), .b(x12), .c(x17), .O(new_n211_));
  nand2  g167(.a(new_n147_), .b(x30), .O(new_n212_));
  nand2  g168(.a(new_n156_), .b(new_n191_), .O(new_n213_));
  nand2  g169(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nor4   g170(.a(new_n214_), .b(new_n211_), .c(new_n210_), .d(new_n188_), .O(new_n215_));
  nand4  g171(.a(new_n215_), .b(new_n209_), .c(new_n186_), .d(new_n184_), .O(new_n216_));
  aoi22  g172(.a(new_n216_), .b(x33), .c(new_n208_), .d(new_n206_), .O(new_n217_));
  nand2  g173(.a(new_n217_), .b(new_n205_), .O(new_n218_));
  nand3  g174(.a(new_n218_), .b(new_n80_), .c(x00), .O(new_n219_));
  nand2  g175(.a(new_n219_), .b(new_n46_), .O(z9));
endmodule
