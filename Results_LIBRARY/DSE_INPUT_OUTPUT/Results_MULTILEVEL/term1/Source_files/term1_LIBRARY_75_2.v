...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n95_), .c(new_n59_), .d(x30), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n82_), .c(x25), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x30), .c(new_n81_), .O(z5));
  nand3  g066(.a(x29), .b(x28), .c(x27), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n95_), .c(new_n59_), .d(x30), .O(new_n112_));
  ...
  nand3  g073(.a(new_n59_), .b(x25), .c(x01), .O(new_n118_));
  ...
  nand2  g080(.a(new_n92_), .b(x14), .O(new_n125_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n128_), .c(new_n92_), .O(new_n130_));
  ...
  nand2  g096(.a(new_n102_), .b(new_n83_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x29), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n45_), .c(new_n81_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n141_), .b(new_n45_), .c(x29), .d(new_n81_), .O(new_n148_));
  ...
  aoi21  g129(.a(new_n171_), .b(new_n81_), .c(new_n173_), .O(new_n174_));
  ...
  nand4  g134(.a(new_n142_), .b(new_n119_), .c(new_n45_), .d(new_n81_), .O(new_n179_));
