...
module FAU ( 
  ...
  nand2  g014(.a(new_n49_), .b(new_n52_), .O(new_n59_));
  nand2  g015(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g016(.a(new_n60_), .b(x30), .c(x01), .O(new_n61_));
  ...
  nand3  g026(.a(new_n70_), .b(x30), .c(x01), .O(new_n71_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n92_), .c(new_n58_), .d(x30), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n81_), .c(x25), .d(x01), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z5));
  oai21  g063(.a(new_n101_), .b(new_n45_), .c(x29), .O(new_n108_));
  and2   g064(.a(new_n108_), .b(new_n92_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n58_), .c(new_n81_), .d(x25), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x30), .c(new_n80_), .O(z6));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x31), .O(new_n113_));
  nand4  g069(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n114_));
  nand3  g070(.a(new_n58_), .b(x25), .c(x01), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n101_), .b(new_n116_), .c(x29), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x30), .c(new_n81_), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n114_), .c(new_n113_), .O(z7));
  ...
  nor3   g091(.a(new_n135_), .b(new_n134_), .c(new_n116_), .O(new_n136_));
  ...
  nand3  g096(.a(new_n140_), .b(new_n45_), .c(new_n80_), .O(new_n141_));
  nand3  g097(.a(new_n139_), .b(x30), .c(x29), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n141_), .c(new_n138_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x32), .O(new_n144_));
  inv1   g100(.a(x32), .O(new_n145_));
  nand4  g101(.a(new_n139_), .b(new_n45_), .c(x29), .d(new_n80_), .O(new_n146_));
  nand2  g102(.a(new_n140_), .b(x30), .O(new_n147_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n148_), .c(new_n145_), .d(x31), .O(new_n164_));
  ...
  nor2   g123(.a(new_n135_), .b(new_n134_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n133_), .c(new_n130_), .d(new_n128_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n125_), .c(new_n46_), .O(new_n170_));
  aoi21  g126(.a(new_n140_), .b(new_n116_), .c(x30), .O(new_n171_));
  nor2   g127(.a(new_n116_), .b(new_n99_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n139_), .c(new_n45_), .O(new_n173_));
  aoi21  g129(.a(new_n171_), .b(new_n80_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  aoi21  g132(.a(new_n159_), .b(new_n156_), .c(new_n121_), .O(new_n177_));
  inv1   g133(.a(new_n162_), .O(new_n178_));
  nand4  g134(.a(new_n140_), .b(new_n116_), .c(new_n45_), .d(new_n80_), .O(new_n179_));
  nand4  g135(.a(new_n139_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
