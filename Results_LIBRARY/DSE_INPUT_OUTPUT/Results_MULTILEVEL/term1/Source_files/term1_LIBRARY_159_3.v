...
module FAU ( 
  ...
  nand2  g000(.a(x26), .b(x14), .O(new_n45_));
  ...
  nand4  g086(.a(new_n80_), .b(x19), .c(new_n130_), .d(x13), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n129_), .c(new_n127_), .O(new_n132_));
  nand2  g088(.a(new_n127_), .b(x12), .O(new_n133_));
  nand3  g089(.a(new_n80_), .b(x19), .c(x18), .O(new_n134_));
  ...
  nor2   g097(.a(x26), .b(new_n128_), .O(new_n142_));
  nor2   g098(.a(new_n137_), .b(x15), .O(new_n143_));
  nand2  g099(.a(x18), .b(x17), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n143_), .c(new_n142_), .d(x10), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n126_), .c(x31), .d(new_n103_), .O(new_n148_));
  nand3  g104(.a(x32), .b(x30), .c(new_n80_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n125_), .c(x29), .O(new_n151_));
  nand2  g107(.a(new_n125_), .b(x29), .O(new_n152_));
  nand4  g108(.a(new_n147_), .b(new_n126_), .c(x31), .d(x30), .O(new_n153_));
  nand3  g109(.a(x32), .b(new_n103_), .c(new_n80_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  aoi21  g112(.a(new_n128_), .b(x14), .c(new_n130_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(x17), .c(x16), .d(x15), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n144_), .c(new_n128_), .O(new_n160_));
  inv1   g116(.a(x15), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n144_), .c(new_n161_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n144_), .b(new_n164_), .c(new_n137_), .O(new_n165_));
  nand2  g121(.a(x18), .b(x12), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n127_), .O(new_n167_));
  inv1   g123(.a(x13), .O(new_n168_));
  nand2  g124(.a(new_n130_), .b(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n167_), .c(new_n165_), .d(x31), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n163_), .c(new_n160_), .d(new_n158_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(x32), .c(new_n80_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n156_), .c(new_n151_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n45_), .O(z8));
  inv1   g132(.a(x33), .O(new_n177_));
  nand4  g133(.a(new_n147_), .b(new_n177_), .c(x31), .d(x30), .O(new_n178_));
  nand3  g134(.a(x33), .b(new_n103_), .c(new_n80_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n125_), .c(x29), .O(new_n181_));
  nand4  g137(.a(new_n147_), .b(new_n177_), .c(new_n118_), .d(new_n103_), .O(new_n182_));
  nand3  g138(.a(x33), .b(x30), .c(new_n80_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n152_), .O(new_n185_));
  xnor2a g141(.a(x31), .b(x30), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n163_), .c(new_n160_), .d(new_n158_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(x33), .c(new_n80_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n185_), .c(new_n181_), .O(new_n191_));
