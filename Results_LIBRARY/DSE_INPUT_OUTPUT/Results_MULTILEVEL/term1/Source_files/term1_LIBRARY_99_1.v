...
module FAU ( 
  ...
  aoi21  g018(.a(new_n62_), .b(new_n54_), .c(new_n61_), .O(new_n63_));
  inv1   g019(.a(x02), .O(new_n64_));
  inv1   g020(.a(x03), .O(new_n65_));
  nand2  g021(.a(x05), .b(new_n65_), .O(new_n66_));
  nand3  g022(.a(new_n66_), .b(x06), .c(new_n64_), .O(new_n67_));
  nand2  g023(.a(x06), .b(new_n64_), .O(new_n68_));
  nand3  g024(.a(new_n68_), .b(x05), .c(new_n65_), .O(new_n69_));
  aoi21  g025(.a(new_n69_), .b(new_n67_), .c(x01), .O(new_n70_));
  oai21  g026(.a(new_n70_), .b(new_n63_), .c(new_n60_), .O(new_n71_));
  xor2a  g027(.a(x07), .b(x04), .O(new_n72_));
  nor2   g028(.a(new_n50_), .b(new_n61_), .O(new_n73_));
  nand2  g029(.a(new_n68_), .b(new_n66_), .O(new_n74_));
  nand3  g030(.a(new_n56_), .b(x06), .c(x05), .O(new_n75_));
  ...
  and2   g051(.a(new_n95_), .b(new_n54_), .O(new_n96_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n95_), .c(new_n54_), .d(new_n45_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n81_), .c(x25), .d(x01), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z5));
  nand3  g069(.a(new_n96_), .b(new_n45_), .c(x29), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n105_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x27), .c(new_n81_), .d(x25), .O(new_n116_));
  ...
  nand3  g075(.a(new_n54_), .b(x25), .c(x01), .O(new_n120_));
  nor4   g076(.a(new_n120_), .b(x31), .c(x30), .d(x26), .O(new_n121_));
  oai21  g077(.a(new_n119_), .b(new_n118_), .c(new_n121_), .O(z7));
  nand2  g078(.a(new_n105_), .b(new_n82_), .O(new_n123_));
  nand3  g079(.a(x19), .b(new_n89_), .c(x13), .O(new_n124_));
  nand3  g080(.a(new_n92_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n124_), .c(new_n86_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n127_));
  ...
  aoi21  g095(.a(new_n92_), .b(x14), .c(new_n89_), .O(new_n140_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n86_), .O(new_n150_));
  inv1   g106(.a(x13), .O(new_n151_));
  nand2  g107(.a(new_n89_), .b(new_n151_), .O(new_n152_));
  inv1   g108(.a(x31), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n107_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n152_), .c(new_n150_), .d(new_n123_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  and2   g112(.a(new_n156_), .b(new_n148_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n146_), .c(new_n144_), .d(new_n141_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x32), .O(new_n159_));
  oai21  g115(.a(new_n139_), .b(new_n107_), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n138_), .c(new_n53_), .d(new_n153_), .O(new_n164_));
  aoi21  g120(.a(new_n89_), .b(new_n151_), .c(x31), .O(new_n165_));
