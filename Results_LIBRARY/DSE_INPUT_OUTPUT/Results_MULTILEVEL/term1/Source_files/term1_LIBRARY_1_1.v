...
module FAU ( 
  ...
  nand3  g023(.a(new_n67_), .b(new_n62_), .c(new_n45_), .O(new_n68_));
  ...
  nand3  g032(.a(new_n76_), .b(new_n62_), .c(new_n45_), .O(new_n77_));
  ...
  nand3  g061(.a(new_n62_), .b(x28), .c(x27), .O(new_n106_));
  oai21  g062(.a(new_n99_), .b(new_n62_), .c(new_n106_), .O(new_n107_));
  nor2   g063(.a(new_n62_), .b(x29), .O(new_n108_));
  ...
  nor2   g074(.a(new_n59_), .b(new_n45_), .O(new_n119_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n130_), .c(new_n46_), .O(new_n143_));
  ...
  aoi22  g103(.a(new_n147_), .b(new_n62_), .c(new_n146_), .d(x01), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  nand3  g107(.a(new_n147_), .b(x30), .c(x01), .O(new_n152_));
  nand3  g108(.a(new_n144_), .b(new_n62_), .c(x29), .O(new_n153_));
  ...
  nor2   g129(.a(new_n140_), .b(new_n139_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n130_), .c(new_n46_), .O(new_n176_));
  nand2  g132(.a(new_n147_), .b(new_n121_), .O(new_n177_));
  nor2   g133(.a(new_n121_), .b(new_n97_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n144_), .c(new_n62_), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(x01), .c(new_n177_), .d(new_n62_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  inv1   g138(.a(x33), .O(new_n183_));
  nand4  g139(.a(new_n144_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
  oai22  g140(.a(new_n184_), .b(new_n45_), .c(new_n177_), .d(x30), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n169_), .c(new_n183_), .O(new_n186_));
