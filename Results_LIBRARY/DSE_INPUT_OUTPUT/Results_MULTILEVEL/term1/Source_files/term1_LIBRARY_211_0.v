...
module FAU ( 
  ...
  nor2   g000(.a(x26), .b(x22), .O(new_n45_));
  ...
  nor2   g040(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n80_), .c(x25), .d(x01), .O(new_n86_));
  aoi21  g042(.a(new_n86_), .b(x22), .c(x26), .O(z3));
  xor2a  g043(.a(x28), .b(x27), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n85_), .c(x25), .d(x01), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(x22), .c(x26), .O(z4));
  inv1   g046(.a(x28), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n80_), .c(x29), .O(new_n92_));
  inv1   g048(.a(x29), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(x28), .c(x27), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(new_n92_), .c(new_n84_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n61_), .c(x25), .d(x01), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(x22), .c(x26), .O(z5));
  inv1   g053(.a(x30), .O(new_n98_));
  nor2   g054(.a(new_n91_), .b(new_n80_), .O(new_n99_));
  ...
  nand2  g058(.a(x30), .b(new_n93_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(new_n84_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n61_), .c(x25), .d(x01), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(x22), .c(x26), .O(z6));
  inv1   g062(.a(x26), .O(new_n107_));
  inv1   g063(.a(x31), .O(new_n108_));
  nor2   g064(.a(new_n98_), .b(new_n93_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n99_), .c(new_n108_), .O(new_n110_));
  inv1   g066(.a(new_n83_), .O(new_n111_));
  nor2   g067(.a(new_n82_), .b(new_n81_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nor2   g069(.a(new_n60_), .b(new_n59_), .O(new_n114_));
  nand4  g070(.a(new_n99_), .b(new_n108_), .c(x30), .d(x29), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(x25), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n110_), .c(x22), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n107_), .O(z7));
  nand2  g074(.a(new_n91_), .b(new_n80_), .O(new_n119_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n120_), .c(x31), .d(new_n98_), .O(new_n139_));
  ...
  nand2  g100(.a(x32), .b(new_n98_), .O(new_n145_));
  ...
  aoi21  g113(.a(x18), .b(x12), .c(x17), .O(new_n158_));
  nor2   g114(.a(x18), .b(x13), .O(new_n159_));
  nor3   g115(.a(new_n159_), .b(new_n158_), .c(new_n108_), .O(new_n160_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n147_), .c(new_n142_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x00), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(x22), .c(x26), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n138_), .b(new_n166_), .c(x31), .d(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n98_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n119_), .c(x29), .O(new_n170_));
  nand4  g126(.a(new_n138_), .b(new_n166_), .c(new_n108_), .d(new_n98_), .O(new_n171_));
  nand2  g127(.a(x33), .b(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n143_), .O(new_n174_));
  inv1   g130(.a(new_n158_), .O(new_n175_));
  inv1   g131(.a(new_n159_), .O(new_n176_));
  xnor2a g132(.a(x31), .b(x30), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n176_), .c(new_n175_), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n150_), .c(x33), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n174_), .c(new_n170_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n107_), .c(x22), .d(x00), .O(new_n183_));
