...
module FAU ( 
  ...
  nor2   g040(.a(new_n84_), .b(new_n59_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n79_), .c(x25), .d(x01), .O(new_n86_));
  aoi21  g042(.a(new_n86_), .b(z0), .c(x26), .O(z3));
  inv1   g043(.a(x26), .O(new_n88_));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n85_), .c(z0), .O(new_n90_));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n97_), .c(new_n84_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n60_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(z0), .c(x26), .O(z5));
  inv1   g058(.a(x30), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n95_), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g065(.a(new_n109_), .b(z0), .c(x26), .O(z6));
  ...
  nor2   g070(.a(new_n81_), .b(new_n80_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(new_n116_));
  nand3  g072(.a(new_n60_), .b(x25), .c(x01), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x30), .c(x29), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n96_), .c(z0), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(x26), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n118_), .c(new_n116_), .d(new_n112_), .O(z7));
  ...
  aoi22  g084(.a(new_n128_), .b(x30), .c(new_n126_), .d(x29), .O(new_n129_));
  ...
  aoi21  g102(.a(new_n146_), .b(new_n144_), .c(new_n129_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(z0), .c(x31), .d(new_n88_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n124_), .O(z8));
  nand2  g105(.a(new_n146_), .b(new_n144_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n46_), .c(x31), .d(x30), .O(new_n151_));
  nand2  g107(.a(x33), .b(new_n103_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n127_), .c(x29), .O(new_n154_));
  nand4  g110(.a(new_n150_), .b(new_n46_), .c(new_n119_), .d(new_n103_), .O(new_n155_));
  ...
  aoi21  g114(.a(new_n133_), .b(x14), .c(new_n131_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(x17), .c(x16), .d(x15), .O(new_n160_));
  nand2  g116(.a(x16), .b(x15), .O(new_n161_));
  nand2  g117(.a(x18), .b(x17), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n133_), .O(new_n163_));
  nand2  g119(.a(x16), .b(x10), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n162_), .c(new_n145_), .O(new_n165_));
  inv1   g121(.a(x11), .O(new_n166_));
  oai21  g122(.a(new_n162_), .b(new_n166_), .c(new_n139_), .O(new_n167_));
  nand2  g123(.a(x18), .b(x12), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n130_), .O(new_n169_));
  inv1   g125(.a(x13), .O(new_n170_));
  nand2  g126(.a(new_n131_), .b(new_n170_), .O(new_n171_));
  xnor2a g127(.a(x31), .b(x30), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n171_), .c(new_n169_), .d(new_n167_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n165_), .c(new_n163_), .d(new_n160_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n158_), .c(new_n154_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(z0), .c(new_n88_), .d(x00), .O(new_n178_));
