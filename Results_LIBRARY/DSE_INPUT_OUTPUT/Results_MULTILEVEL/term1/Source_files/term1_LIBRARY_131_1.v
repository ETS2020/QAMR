...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n60_), .c(new_n47_), .d(new_n80_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n79_), .c(x25), .d(x01), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z3));
  nand3  g052(.a(new_n47_), .b(x28), .c(new_n80_), .O(new_n97_));
  oai21  g053(.a(x28), .b(new_n80_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x25), .c(x01), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n47_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n60_), .d(new_n47_), .O(new_n108_));
  ...
  nand3  g069(.a(new_n105_), .b(new_n45_), .c(x29), .O(new_n114_));
  oai21  g070(.a(new_n113_), .b(new_n45_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x25), .c(x01), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n47_), .O(z6));
  nand3  g075(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n90_), .O(new_n121_));
  nand4  g077(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(new_n47_), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  inv1   g080(.a(new_n105_), .O(new_n125_));
  nand3  g081(.a(new_n124_), .b(x30), .c(x29), .O(new_n126_));
  oai22  g082(.a(new_n126_), .b(new_n125_), .c(new_n113_), .d(new_n124_), .O(new_n127_));
  aoi22  g083(.a(new_n127_), .b(x06), .c(x31), .d(new_n45_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n123_), .O(z7));
  nand2  g085(.a(new_n104_), .b(new_n80_), .O(new_n130_));
  inv1   g086(.a(x32), .O(new_n131_));
  nand3  g087(.a(x19), .b(new_n87_), .c(x13), .O(new_n132_));
  inv1   g088(.a(x19), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x18), .c(x14), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n132_), .c(new_n84_), .O(new_n135_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n131_), .c(x31), .d(new_n45_), .O(new_n148_));
  nand2  g104(.a(x32), .b(x30), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n130_), .c(x29), .O(new_n151_));
  nand2  g107(.a(new_n130_), .b(x29), .O(new_n152_));
  nand4  g108(.a(new_n147_), .b(new_n131_), .c(x31), .d(x30), .O(new_n153_));
  ...
  nand3  g128(.a(new_n172_), .b(new_n79_), .c(x00), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n47_), .O(z8));
  nor2   g130(.a(new_n168_), .b(new_n167_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n166_), .c(new_n164_), .d(new_n162_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n159_), .c(new_n47_), .O(new_n177_));
  nand2  g133(.a(new_n152_), .b(new_n124_), .O(new_n178_));
  nor2   g134(.a(new_n124_), .b(new_n103_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n130_), .c(new_n45_), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(x06), .c(new_n178_), .d(new_n45_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  inv1   g139(.a(x06), .O(new_n184_));
  nand4  g140(.a(new_n130_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
  oai22  g141(.a(new_n185_), .b(new_n184_), .c(new_n178_), .d(x30), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n147_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(x33), .c(new_n183_), .O(new_n188_));
