...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x20), .O(new_n45_));
  ...
  nor2   g051(.a(new_n86_), .b(new_n84_), .O(new_n96_));
  and2   g052(.a(new_n96_), .b(new_n90_), .O(new_n97_));
  nand3  g053(.a(x30), .b(new_n83_), .c(new_n82_), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(new_n45_), .c(new_n98_), .O(new_n99_));
  and2   g055(.a(new_n99_), .b(new_n61_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n80_), .d(x25), .O(new_n101_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n99_), .c(x29), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  aoi21  g063(.a(x30), .b(x15), .c(x20), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n97_), .c(new_n98_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n107_), .c(x28), .d(x27), .O(new_n110_));
  ...
  nand3  g070(.a(new_n114_), .b(new_n91_), .c(x30), .O(new_n115_));
  nor2   g071(.a(new_n97_), .b(x30), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(x29), .c(x28), .d(x27), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n83_), .c(new_n115_), .O(new_n118_));
  ...
  oai21  g077(.a(x31), .b(new_n83_), .c(new_n121_), .O(new_n122_));
  ...
  inv1   g083(.a(new_n89_), .O(new_n128_));
  nand3  g084(.a(new_n96_), .b(new_n128_), .c(new_n127_), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x15), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand3  g088(.a(new_n104_), .b(new_n132_), .c(x29), .O(new_n133_));
  ...
  oai21  g092(.a(new_n136_), .b(new_n130_), .c(x20), .O(new_n137_));
  ...
  nor2   g097(.a(new_n141_), .b(new_n82_), .O(new_n142_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(new_n82_), .O(new_n147_));
  inv1   g103(.a(x11), .O(new_n148_));
  inv1   g104(.a(x16), .O(new_n149_));
  oai21  g105(.a(new_n144_), .b(new_n148_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(x18), .b(x12), .c(x17), .O(new_n151_));
  nor2   g107(.a(x18), .b(x13), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n151_), .c(new_n132_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n150_), .c(new_n147_), .d(new_n145_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n142_), .c(new_n57_), .O(new_n155_));
  nand2  g111(.a(new_n103_), .b(new_n81_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x29), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n121_), .c(x20), .O(new_n158_));
  nand3  g114(.a(new_n156_), .b(x30), .c(x29), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n158_), .c(new_n155_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x32), .O(new_n161_));
  inv1   g117(.a(x32), .O(new_n162_));
  nand4  g118(.a(new_n156_), .b(new_n121_), .c(x29), .d(x20), .O(new_n163_));
  nand2  g119(.a(new_n157_), .b(x30), .O(new_n164_));
  ...
  nand3  g131(.a(new_n175_), .b(new_n149_), .c(x11), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x15), .O(new_n178_));
  nand4  g134(.a(new_n175_), .b(x16), .c(new_n82_), .d(x10), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n165_), .c(new_n162_), .d(x31), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n161_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n80_), .c(x00), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(z8));
  nor2   g140(.a(new_n152_), .b(new_n151_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n150_), .c(new_n147_), .d(new_n145_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n142_), .c(new_n57_), .O(new_n187_));
  aoi21  g143(.a(new_n157_), .b(new_n132_), .c(x30), .O(new_n188_));
  nor2   g144(.a(new_n132_), .b(new_n107_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n156_), .c(new_n121_), .O(new_n190_));
  aoi21  g146(.a(new_n188_), .b(x20), .c(new_n190_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n187_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  aoi21  g149(.a(new_n176_), .b(new_n173_), .c(new_n82_), .O(new_n194_));
  inv1   g150(.a(new_n179_), .O(new_n195_));
  nand4  g151(.a(new_n157_), .b(new_n132_), .c(new_n121_), .d(x20), .O(new_n196_));
  nand4  g152(.a(new_n156_), .b(x31), .c(x30), .d(x29), .O(new_n197_));
