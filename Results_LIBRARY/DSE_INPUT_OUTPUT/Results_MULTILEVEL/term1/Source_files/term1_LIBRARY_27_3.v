...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n60_), .c(new_n58_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n60_), .c(new_n58_), .O(z4));
  ...
  nand2  g059(.a(new_n46_), .b(x26), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n103_), .c(new_n100_), .d(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nand4  g062(.a(new_n100_), .b(new_n106_), .c(x28), .d(x27), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(x26), .c(new_n105_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n62_), .c(x25), .d(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n58_), .O(z5));
  nand4  g066(.a(new_n46_), .b(x28), .c(x27), .d(new_n45_), .O(new_n111_));
  oai21  g067(.a(new_n102_), .b(new_n46_), .c(new_n111_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x29), .O(new_n113_));
  oai21  g069(.a(new_n46_), .b(x29), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n62_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n60_), .c(new_n58_), .O(z6));
  nand3  g072(.a(new_n102_), .b(x30), .c(x29), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x31), .O(new_n118_));
  inv1   g074(.a(new_n82_), .O(new_n119_));
  nand4  g075(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n119_), .O(new_n120_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n46_), .O(new_n145_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n156_), .c(new_n104_), .O(new_n174_));
  aoi21  g130(.a(new_n149_), .b(new_n123_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n123_), .b(new_n106_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n128_), .c(new_n46_), .O(new_n177_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n123_), .c(new_n46_), .d(new_n45_), .O(new_n181_));
  nand4  g137(.a(new_n128_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n58_), .O(z9));
endmodule
