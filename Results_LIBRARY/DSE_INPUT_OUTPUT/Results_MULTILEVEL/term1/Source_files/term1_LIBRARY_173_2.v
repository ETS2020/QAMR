...
module FAU ( 
  ...
  aoi21  g052(.a(new_n96_), .b(new_n58_), .c(new_n86_), .O(new_n97_));
  ...
  nor2   g057(.a(new_n101_), .b(new_n97_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x29), .O(new_n103_));
  inv1   g059(.a(x29), .O(new_n104_));
  oai21  g060(.a(x30), .b(new_n45_), .c(new_n96_), .O(new_n105_));
  ...
  nor2   g065(.a(new_n109_), .b(new_n60_), .O(z5));
  nand2  g066(.a(new_n101_), .b(x29), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n91_), .c(x30), .O(new_n112_));
  and2   g068(.a(new_n90_), .b(x22), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n85_), .c(x30), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(x29), .c(x28), .d(x27), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(x17), .c(new_n112_), .O(new_n116_));
  ...
  oai21  g075(.a(x31), .b(x17), .c(new_n119_), .O(new_n120_));
  ...
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(new_n87_), .d(new_n85_), .O(new_n125_));
  nor2   g081(.a(new_n61_), .b(new_n60_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand4  g083(.a(new_n101_), .b(new_n127_), .c(x30), .d(x29), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n126_), .c(new_n81_), .d(x25), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n122_), .d(new_n120_), .O(z7));
  nor2   g087(.a(x28), .b(x27), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n104_), .O(new_n133_));
  ...
  nand2  g109(.a(x32), .b(new_n119_), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n127_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n134_), .O(new_n156_));
  inv1   g112(.a(new_n132_), .O(new_n157_));
  oai21  g113(.a(x30), .b(x17), .c(x32), .O(new_n158_));
  nor2   g114(.a(new_n136_), .b(new_n142_), .O(new_n159_));
  nand2  g115(.a(x18), .b(x16), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand4  g118(.a(new_n135_), .b(x31), .c(new_n119_), .d(x19), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n158_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n157_), .c(x29), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  aoi21  g122(.a(new_n139_), .b(x14), .c(new_n137_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(x17), .c(x16), .d(x15), .O(new_n168_));
  nor2   g124(.a(new_n146_), .b(new_n136_), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  nand2  g126(.a(x18), .b(x17), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n170_), .c(new_n139_), .O(new_n172_));
  nand2  g128(.a(x16), .b(x10), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n171_), .c(new_n136_), .O(new_n174_));
  inv1   g130(.a(x11), .O(new_n175_));
  oai21  g131(.a(new_n171_), .b(new_n175_), .c(new_n146_), .O(new_n176_));
  oai21  g132(.a(new_n137_), .b(new_n142_), .c(new_n45_), .O(new_n177_));
  oai21  g133(.a(x18), .b(x13), .c(x31), .O(new_n178_));
  ...
  nand4  g137(.a(new_n181_), .b(new_n174_), .c(new_n172_), .d(new_n168_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(x32), .c(new_n166_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n156_), .O(new_n184_));
  ...
  oai22  g144(.a(new_n188_), .b(new_n162_), .c(new_n187_), .d(x30), .O(new_n189_));
  ...
  nand4  g153(.a(new_n197_), .b(x31), .c(x30), .d(x17), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n190_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n157_), .c(x29), .O(new_n200_));
  nand2  g156(.a(x33), .b(x30), .O(new_n201_));
  nor2   g157(.a(x17), .b(new_n146_), .O(new_n202_));
  nor3   g158(.a(x33), .b(x31), .c(x30), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n202_), .c(new_n159_), .d(new_n192_), .O(new_n204_));
  aoi21  g160(.a(new_n204_), .b(new_n201_), .c(new_n133_), .O(new_n205_));
  oai21  g161(.a(new_n160_), .b(new_n136_), .c(new_n139_), .O(new_n206_));
  oai21  g162(.a(new_n160_), .b(new_n151_), .c(new_n136_), .O(new_n207_));
  aoi21  g163(.a(x18), .b(x11), .c(x16), .O(new_n208_));
  nor2   g164(.a(new_n208_), .b(new_n178_), .O(new_n209_));
  nand4  g165(.a(new_n209_), .b(new_n207_), .c(new_n206_), .d(new_n168_), .O(new_n210_));
  nand2  g166(.a(new_n210_), .b(x30), .O(new_n211_));
  aoi21  g167(.a(x31), .b(new_n119_), .c(new_n139_), .O(new_n212_));
  nand4  g168(.a(new_n212_), .b(new_n169_), .c(x18), .d(x12), .O(new_n213_));
  nand2  g169(.a(new_n213_), .b(new_n45_), .O(new_n214_));
  nand2  g170(.a(new_n214_), .b(new_n211_), .O(new_n215_));
  aoi21  g171(.a(new_n215_), .b(x33), .c(new_n205_), .O(new_n216_));
