...
module FAU ( 
  ...
  nor3   g047(.a(new_n91_), .b(new_n86_), .c(new_n85_), .O(new_n92_));
  ...
  nor2   g066(.a(new_n91_), .b(new_n85_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n86_), .c(new_n109_), .d(new_n100_), .O(new_n113_));
  nor2   g069(.a(new_n111_), .b(x30), .O(new_n114_));
  ...
  oai21  g073(.a(new_n117_), .b(new_n58_), .c(new_n46_), .O(z6));
  nand3  g074(.a(new_n102_), .b(x30), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x31), .O(new_n120_));
  inv1   g076(.a(x17), .O(new_n121_));
  inv1   g077(.a(x22), .O(new_n122_));
  nand3  g078(.a(x30), .b(new_n122_), .c(new_n121_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n84_), .c(new_n82_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n90_), .c(new_n88_), .O(new_n126_));
  inv1   g082(.a(x25), .O(new_n127_));
  nand3  g083(.a(new_n60_), .b(new_n46_), .c(x01), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x30), .c(x29), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n109_), .c(new_n79_), .O(new_n131_));
  nor3   g087(.a(new_n131_), .b(new_n128_), .c(new_n127_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n126_), .c(new_n120_), .O(z7));
  nand2  g089(.a(new_n101_), .b(new_n80_), .O(new_n134_));
  ...
  aoi21  g095(.a(new_n139_), .b(new_n137_), .c(new_n121_), .O(new_n140_));
  nand4  g096(.a(x19), .b(x18), .c(new_n121_), .d(x12), .O(new_n141_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n135_), .c(x31), .d(new_n110_), .O(new_n153_));
  nand2  g109(.a(x32), .b(x30), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n134_), .c(x29), .O(new_n156_));
  nand2  g112(.a(new_n134_), .b(x29), .O(new_n157_));
  nand4  g113(.a(new_n152_), .b(new_n135_), .c(x31), .d(x30), .O(new_n158_));
  nand2  g114(.a(x32), .b(new_n110_), .O(new_n159_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n164_), .c(new_n46_), .O(new_n182_));
  aoi21  g138(.a(new_n157_), .b(new_n129_), .c(x30), .O(new_n183_));
  nor2   g139(.a(new_n129_), .b(new_n100_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n134_), .c(new_n110_), .O(new_n185_));
  aoi21  g141(.a(new_n183_), .b(x22), .c(new_n185_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand4  g144(.a(new_n157_), .b(new_n129_), .c(new_n110_), .d(x22), .O(new_n189_));
  nand4  g145(.a(new_n134_), .b(x31), .c(x30), .d(x29), .O(new_n190_));
