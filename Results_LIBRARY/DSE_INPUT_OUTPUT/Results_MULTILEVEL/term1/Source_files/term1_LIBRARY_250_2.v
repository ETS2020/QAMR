...
module FAU ( 
  ...
  oai22  g096(.a(new_n140_), .b(new_n128_), .c(new_n102_), .d(new_n45_), .O(new_n141_));
  nor2   g097(.a(x28), .b(x27), .O(new_n142_));
  nor3   g098(.a(new_n142_), .b(new_n102_), .c(new_n95_), .O(new_n143_));
  inv1   g099(.a(new_n142_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x29), .O(new_n145_));
  aoi22  g101(.a(new_n145_), .b(new_n102_), .c(new_n143_), .d(new_n45_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n141_), .c(new_n123_), .O(new_n147_));
  nand3  g103(.a(new_n145_), .b(x30), .c(new_n45_), .O(new_n148_));
  nand3  g104(.a(new_n144_), .b(new_n102_), .c(x29), .O(new_n149_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n150_), .c(new_n123_), .d(x31), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n147_), .c(x00), .O(new_n168_));
  ...
  nand4  g130(.a(new_n165_), .b(new_n170_), .c(new_n118_), .d(new_n102_), .O(new_n175_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n184_));
