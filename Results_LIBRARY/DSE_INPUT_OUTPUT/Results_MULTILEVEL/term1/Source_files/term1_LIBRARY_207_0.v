...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x10), .O(new_n45_));
  ...
  nand2  g032(.a(new_n76_), .b(new_n56_), .O(z2));
  ...
  nand3  g041(.a(new_n85_), .b(new_n59_), .c(new_n56_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n79_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n78_), .c(x25), .d(x01), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n87_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n78_), .c(x25), .d(x01), .O(new_n95_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n85_), .c(new_n59_), .d(new_n56_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n78_), .c(x25), .d(x01), .O(new_n104_));
  ...
  nor2   g066(.a(new_n110_), .b(new_n84_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n58_), .c(new_n56_), .O(z6));
  inv1   g069(.a(x10), .O(new_n114_));
  oai21  g070(.a(x31), .b(new_n114_), .c(new_n106_), .O(new_n115_));
  nor4   g071(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n116_));
  ...
  nand3  g077(.a(new_n99_), .b(new_n121_), .c(x29), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nor2   g079(.a(new_n121_), .b(x30), .O(new_n124_));
  aoi22  g080(.a(new_n124_), .b(x10), .c(new_n123_), .d(x30), .O(new_n125_));
  ...
  nor2   g088(.a(new_n128_), .b(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x17), .c(x16), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n127_), .O(new_n135_));
  inv1   g091(.a(x16), .O(new_n136_));
  nand2  g092(.a(x18), .b(x17), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(new_n128_), .O(new_n138_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n131_), .c(new_n56_), .O(new_n145_));
  nand2  g101(.a(new_n98_), .b(new_n79_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n106_), .c(x10), .O(new_n148_));
  nand2  g104(.a(new_n127_), .b(new_n114_), .O(new_n149_));
  ...
  nand3  g110(.a(x19), .b(new_n132_), .c(x13), .O(new_n155_));
  ...
  inv1   g114(.a(x17), .O(new_n159_));
  nand3  g115(.a(new_n133_), .b(new_n159_), .c(x12), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand2  g117(.a(new_n136_), .b(x11), .O(new_n162_));
  nand2  g118(.a(new_n133_), .b(x17), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  aoi21  g120(.a(new_n161_), .b(x16), .c(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n133_), .b(x17), .c(x16), .d(new_n127_), .O(new_n166_));
  oai21  g122(.a(new_n165_), .b(new_n127_), .c(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n146_), .c(new_n106_), .d(x29), .O(new_n168_));
  nand4  g124(.a(new_n147_), .b(x30), .c(x19), .d(x18), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x17), .c(x16), .d(new_n127_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n168_), .c(new_n114_), .O(new_n172_));
  inv1   g128(.a(new_n165_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n147_), .c(x30), .d(x15), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n172_), .c(new_n154_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n121_), .c(new_n153_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n78_), .c(x00), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(z8));
  inv1   g135(.a(new_n131_), .O(new_n180_));
  nor2   g136(.a(new_n142_), .b(new_n141_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n140_), .c(new_n138_), .O(new_n182_));
  aoi21  g138(.a(new_n134_), .b(new_n127_), .c(new_n182_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n180_), .c(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n147_), .b(new_n121_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n106_), .c(x10), .O(new_n186_));
  nand2  g142(.a(new_n149_), .b(new_n146_), .O(new_n187_));
  nand2  g143(.a(x31), .b(x29), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(x30), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n184_), .c(x33), .O(new_n191_));
  nand4  g147(.a(new_n167_), .b(new_n147_), .c(new_n121_), .d(new_n106_), .O(new_n192_));
  aoi21  g148(.a(new_n98_), .b(new_n79_), .c(new_n121_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(x30), .c(x29), .d(x19), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n132_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(x17), .c(x16), .d(new_n127_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n192_), .c(new_n114_), .O(new_n197_));
  aoi21  g153(.a(new_n98_), .b(new_n79_), .c(new_n165_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(x31), .c(x30), .d(x29), .O(new_n199_));
  nor2   g155(.a(new_n199_), .b(new_n127_), .O(new_n200_));
  nor2   g156(.a(new_n200_), .b(new_n197_), .O(new_n201_));
  oai21  g157(.a(new_n201_), .b(x33), .c(new_n191_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n78_), .c(x00), .O(new_n203_));
