...
module FAU ( 
  ...
  nand3  g014(.a(new_n49_), .b(new_n58_), .c(x05), .O(new_n59_));
  ...
  nor2   g037(.a(x32), .b(x05), .O(new_n82_));
  ...
  nand4  g128(.a(new_n145_), .b(new_n49_), .c(x31), .d(x30), .O(new_n173_));
  ...
  nand4  g132(.a(new_n145_), .b(new_n49_), .c(new_n122_), .d(new_n112_), .O(new_n177_));
