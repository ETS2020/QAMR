...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n63_), .c(new_n49_), .O(z4));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n64_), .d(new_n46_), .O(new_n100_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n64_), .c(new_n46_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n63_), .c(new_n49_), .O(z6));
  ...
  nor2   g073(.a(new_n57_), .b(new_n63_), .O(new_n118_));
  ...
  oai21  g081(.a(new_n46_), .b(x24), .c(new_n125_), .O(z7));
  ...
  nand4  g101(.a(new_n145_), .b(new_n50_), .c(x31), .d(new_n104_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n145_), .b(new_n50_), .c(x31), .d(x30), .O(new_n151_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n49_), .O(z8));
  ...
  nand4  g132(.a(new_n145_), .b(new_n54_), .c(new_n120_), .d(new_n104_), .O(new_n177_));
