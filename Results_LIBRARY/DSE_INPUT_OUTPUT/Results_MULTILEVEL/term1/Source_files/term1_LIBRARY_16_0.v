...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n199_;
  nor2   g000(.a(x26), .b(x06), .O(new_n45_));
  ...
  nand3  g020(.a(new_n62_), .b(x26), .c(new_n59_), .O(new_n65_));
  inv1   g021(.a(new_n65_), .O(new_n66_));
  oai21  g022(.a(new_n66_), .b(new_n64_), .c(new_n58_), .O(new_n67_));
  inv1   g023(.a(new_n45_), .O(new_n68_));
  nor2   g024(.a(new_n48_), .b(new_n51_), .O(new_n69_));
  inv1   g025(.a(new_n69_), .O(new_n70_));
  nand2  g026(.a(new_n48_), .b(new_n51_), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g028(.a(new_n72_), .b(new_n68_), .c(x01), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n67_), .O(new_n74_));
  xnor2a g030(.a(x07), .b(x04), .O(new_n75_));
  nand2  g031(.a(x26), .b(new_n59_), .O(new_n76_));
  nand2  g032(.a(x06), .b(x02), .O(new_n77_));
  aoi21  g033(.a(new_n77_), .b(new_n76_), .c(new_n62_), .O(new_n78_));
  nand4  g034(.a(x06), .b(x05), .c(new_n48_), .d(new_n51_), .O(new_n79_));
  inv1   g035(.a(new_n79_), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(new_n78_), .c(new_n58_), .O(new_n81_));
  xor2a  g037(.a(x03), .b(x02), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n68_), .c(x01), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(new_n81_), .c(new_n75_), .O(new_n84_));
  aoi21  g040(.a(new_n74_), .b(new_n57_), .c(new_n84_), .O(new_n85_));
  nor3   g041(.a(new_n85_), .b(x09), .c(new_n56_), .O(z2));
  ...
  nor2   g051(.a(new_n95_), .b(new_n69_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n87_), .c(x25), .d(x01), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(x06), .c(x26), .O(z3));
  inv1   g054(.a(x26), .O(new_n99_));
  xor2a  g055(.a(x28), .b(x27), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n96_), .c(new_n99_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(x25), .c(x06), .d(x01), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z4));
  inv1   g060(.a(x28), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n87_), .c(x29), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x28), .c(x27), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n95_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n70_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x06), .c(x26), .O(z5));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x30), .O(new_n113_));
  inv1   g069(.a(x30), .O(new_n114_));
  nor2   g070(.a(new_n105_), .b(new_n87_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n114_), .c(x29), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n113_), .c(new_n95_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n70_), .c(x25), .d(x01), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(x06), .c(x26), .O(z6));
  nand3  g075(.a(new_n115_), .b(x30), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  inv1   g077(.a(new_n91_), .O(new_n122_));
  inv1   g078(.a(new_n92_), .O(new_n123_));
  inv1   g079(.a(new_n93_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n90_), .O(new_n125_));
  nor2   g081(.a(new_n69_), .b(new_n58_), .O(new_n126_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n115_), .c(new_n127_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n126_), .c(new_n125_), .d(new_n121_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x06), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n99_), .O(z7));
  nand2  g090(.a(new_n105_), .b(new_n87_), .O(new_n135_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n136_), .c(x31), .d(new_n114_), .O(new_n155_));
  ...
  nand2  g116(.a(x32), .b(new_n114_), .O(new_n161_));
  ...
  aoi21  g155(.a(new_n199_), .b(x06), .c(x26), .O(z9));
endmodule
