...
module FAU ( 
  ...
  oai21  g007(.a(new_n51_), .b(new_n50_), .c(new_n45_), .O(new_n52_));
  inv1   g008(.a(x32), .O(new_n53_));
  nand3  g009(.a(new_n53_), .b(new_n46_), .c(new_n49_), .O(new_n54_));
  inv1   g010(.a(x33), .O(new_n55_));
  nand2  g011(.a(new_n55_), .b(x03), .O(new_n56_));
  nand3  g012(.a(new_n56_), .b(new_n54_), .c(new_n46_), .O(new_n57_));
  ...
  nand2  g021(.a(x02), .b(new_n65_), .O(new_n66_));
  ...
  nand4  g025(.a(new_n69_), .b(x06), .c(new_n45_), .d(new_n65_), .O(new_n70_));
  ...
  nand2  g031(.a(new_n69_), .b(x02), .O(new_n76_));
  ...
  nand3  g036(.a(new_n80_), .b(new_n77_), .c(new_n76_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n65_), .O(new_n82_));
  nand3  g038(.a(new_n79_), .b(x03), .c(new_n45_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n82_), .c(new_n75_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n73_), .O(new_n85_));
  aoi21  g041(.a(new_n85_), .b(new_n72_), .c(x09), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(x08), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n60_), .O(z2));
  ...
  nor3   g053(.a(new_n97_), .b(new_n89_), .c(new_n65_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n46_), .d(x25), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n65_), .c(new_n60_), .O(z4));
  ...
  nand4  g074(.a(new_n118_), .b(new_n102_), .c(new_n46_), .d(x25), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n65_), .O(z6));
  ...
  nor2   g082(.a(new_n62_), .b(new_n65_), .O(new_n127_));
  inv1   g083(.a(new_n106_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x30), .c(x29), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n128_), .c(new_n46_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n89_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n126_), .d(new_n122_), .O(z7));
  nand2  g089(.a(new_n105_), .b(new_n90_), .O(new_n134_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n53_), .c(x31), .d(new_n113_), .O(new_n153_));
  ...
  nand2  g136(.a(x33), .b(new_n113_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n134_), .c(x29), .O(new_n183_));
  nand4  g139(.a(new_n152_), .b(new_n55_), .c(new_n129_), .d(new_n113_), .O(new_n184_));
