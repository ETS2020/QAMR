...
module FAU ( 
  ...
  aoi21  g049(.a(new_n89_), .b(new_n57_), .c(new_n93_), .O(new_n94_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n103_), .c(new_n80_), .O(new_n130_));
  nor3   g086(.a(new_n130_), .b(new_n127_), .c(new_n126_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n125_), .c(new_n122_), .O(z7));
  ...
  nand3  g094(.a(x19), .b(new_n90_), .c(x13), .O(new_n139_));
  inv1   g095(.a(x19), .O(new_n140_));
  nand4  g096(.a(x30), .b(new_n140_), .c(x18), .d(x14), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n139_), .c(new_n138_), .O(new_n142_));
  inv1   g098(.a(x12), .O(new_n143_));
  nand3  g099(.a(x30), .b(x19), .c(x18), .O(new_n144_));
  nor3   g100(.a(new_n144_), .b(x17), .c(new_n143_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n142_), .c(x16), .O(new_n146_));
  inv1   g102(.a(x16), .O(new_n147_));
  inv1   g103(.a(new_n144_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x17), .c(new_n147_), .d(x11), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n146_), .c(new_n137_), .O(new_n150_));
  nand3  g106(.a(x16), .b(new_n137_), .c(x10), .O(new_n151_));
  nand2  g107(.a(x18), .b(x17), .O(new_n152_));
  nor4   g108(.a(new_n152_), .b(new_n151_), .c(new_n113_), .d(new_n140_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n150_), .c(new_n136_), .O(new_n154_));
  nand2  g110(.a(x32), .b(new_n113_), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n128_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n135_), .O(new_n157_));
  nand3  g113(.a(x19), .b(new_n138_), .c(x12), .O(new_n158_));
  nand3  g114(.a(new_n140_), .b(x17), .c(x14), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n147_), .O(new_n160_));
  nand4  g116(.a(x19), .b(x17), .c(new_n147_), .d(x11), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n160_), .c(x15), .O(new_n163_));
  nor2   g119(.a(new_n140_), .b(new_n138_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(x16), .c(new_n137_), .d(x10), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n136_), .c(x31), .d(new_n113_), .O(new_n167_));
  nand2  g123(.a(x32), .b(x30), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n133_), .O(new_n169_));
  aoi22  g125(.a(x30), .b(new_n90_), .c(new_n140_), .d(x14), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x17), .c(x16), .d(x15), .O(new_n171_));
  inv1   g127(.a(new_n152_), .O(new_n172_));
  nor2   g128(.a(new_n147_), .b(new_n137_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n172_), .c(x19), .O(new_n174_));
  and2   g130(.a(x16), .b(x10), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n172_), .c(x15), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n152_), .b(new_n177_), .c(new_n147_), .O(new_n178_));
  oai21  g134(.a(new_n90_), .b(new_n143_), .c(new_n138_), .O(new_n179_));
  inv1   g135(.a(x13), .O(new_n180_));
  nand2  g136(.a(new_n90_), .b(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n179_), .c(new_n178_), .d(x31), .O(new_n182_));
  nor3   g138(.a(new_n182_), .b(new_n176_), .c(new_n174_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n171_), .c(new_n136_), .O(new_n184_));
  aoi21  g140(.a(new_n169_), .b(x29), .c(new_n184_), .O(new_n185_));
  ...
  oai21  g145(.a(new_n153_), .b(new_n150_), .c(new_n189_), .O(new_n190_));
  nand2  g146(.a(x33), .b(new_n113_), .O(new_n191_));
  oai21  g147(.a(new_n190_), .b(new_n128_), .c(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n134_), .c(x29), .O(new_n193_));
  nand4  g149(.a(new_n166_), .b(new_n189_), .c(new_n128_), .d(new_n113_), .O(new_n194_));
  oai21  g150(.a(new_n189_), .b(new_n113_), .c(new_n194_), .O(new_n195_));
  xnor2a g151(.a(x31), .b(x30), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n181_), .c(new_n179_), .d(new_n178_), .O(new_n197_));
  nor3   g153(.a(new_n197_), .b(new_n176_), .c(new_n174_), .O(new_n198_));
  aoi21  g154(.a(new_n198_), .b(new_n171_), .c(new_n189_), .O(new_n199_));
  aoi21  g155(.a(new_n195_), .b(new_n135_), .c(new_n199_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n193_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n80_), .c(x00), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n57_), .O(z9));
endmodule
