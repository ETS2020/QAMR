...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n45_), .c(new_n92_), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(new_n91_), .c(new_n59_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n80_), .c(new_n79_), .d(x25), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n58_), .O(z3));
  nand3  g053(.a(new_n93_), .b(x28), .c(new_n80_), .O(new_n98_));
  oai21  g054(.a(x28), .b(new_n80_), .c(new_n98_), .O(new_n99_));
  nand2  g055(.a(new_n45_), .b(new_n92_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n60_), .O(new_n102_));
  nand4  g058(.a(new_n90_), .b(new_n60_), .c(x28), .d(new_n80_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n45_), .c(new_n102_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n79_), .c(x25), .d(x01), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n46_), .O(z4));
  ...
  oai21  g066(.a(x30), .b(new_n92_), .c(new_n45_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n90_), .O(new_n112_));
  aoi22  g068(.a(new_n112_), .b(new_n94_), .c(new_n110_), .d(new_n108_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n58_), .O(z5));
  nand3  g071(.a(x29), .b(x28), .c(x27), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x30), .O(new_n117_));
  nor2   g073(.a(new_n107_), .b(new_n80_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n93_), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n90_), .O(new_n121_));
  oai21  g077(.a(new_n116_), .b(new_n100_), .c(new_n121_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n58_), .c(new_n46_), .O(z6));
  nand4  g080(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n46_), .O(new_n126_));
  nand2  g082(.a(new_n116_), .b(x31), .O(new_n127_));
  nand3  g083(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand4  g085(.a(new_n118_), .b(new_n129_), .c(x30), .d(x29), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x23), .O(new_n132_));
  oai21  g088(.a(new_n128_), .b(new_n92_), .c(new_n129_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(new_n126_), .O(z7));
  nand2  g091(.a(new_n107_), .b(new_n80_), .O(new_n136_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n137_), .c(x31), .d(new_n93_), .O(new_n153_));
  ...
  nor2   g139(.a(new_n129_), .b(new_n109_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n136_), .c(new_n93_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(x23), .c(new_n183_), .d(new_n93_), .O(new_n186_));
  ...
  oai22  g145(.a(new_n189_), .b(new_n45_), .c(new_n183_), .d(x30), .O(new_n190_));
