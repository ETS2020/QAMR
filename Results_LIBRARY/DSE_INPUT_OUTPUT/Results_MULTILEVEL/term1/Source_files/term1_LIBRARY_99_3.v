...
module FAU ( 
  ...
  nor3   g044(.a(new_n88_), .b(new_n80_), .c(new_n63_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n87_), .c(new_n45_), .d(x25), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n63_), .c(new_n49_), .O(z4));
  ...
  nor3   g056(.a(new_n100_), .b(new_n80_), .c(new_n63_), .O(z5));
  ...
  nand4  g062(.a(new_n106_), .b(new_n93_), .c(new_n45_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n63_), .O(z6));
  ...
  nor2   g070(.a(new_n56_), .b(new_n63_), .O(new_n115_));
  ...
  aoi21  g126(.a(new_n145_), .b(new_n117_), .c(x30), .O(new_n171_));
  nor2   g127(.a(new_n117_), .b(new_n95_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n122_), .c(new_n46_), .O(new_n173_));
  ...
  nand4  g132(.a(new_n145_), .b(new_n117_), .c(new_n46_), .d(new_n45_), .O(new_n177_));
