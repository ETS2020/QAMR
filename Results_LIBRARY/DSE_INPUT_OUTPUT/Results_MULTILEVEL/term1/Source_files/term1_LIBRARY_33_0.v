...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n61_), .d(new_n46_), .O(new_n105_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(new_n61_), .d(new_n46_), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x25), .c(x01), .d(x00), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(z6));
  nand3  g073(.a(new_n102_), .b(x30), .c(x29), .O(new_n118_));
  ...
  nand3  g077(.a(new_n61_), .b(x01), .c(x00), .O(new_n122_));
  ...
  nand4  g085(.a(new_n129_), .b(new_n123_), .c(new_n121_), .d(new_n119_), .O(z7));
  ...
  nand3  g103(.a(new_n147_), .b(new_n132_), .c(x31), .O(new_n148_));
  nand2  g104(.a(x32), .b(x30), .O(new_n149_));
  oai21  g105(.a(new_n148_), .b(x30), .c(new_n149_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n131_), .c(x29), .O(new_n151_));
  nand2  g107(.a(new_n131_), .b(x29), .O(new_n152_));
  nand2  g108(.a(x32), .b(new_n109_), .O(new_n153_));
  oai21  g109(.a(new_n148_), .b(new_n109_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n88_), .b(x14), .O(new_n155_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n88_), .O(new_n160_));
  ...
  nor3   g122(.a(new_n166_), .b(new_n165_), .c(new_n126_), .O(new_n167_));
