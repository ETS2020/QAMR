...
module FAU ( 
  ...
  nand3  g26(.a(new_n70_), .b(new_n59_), .c(new_n46_), .O(new_n71_));
  ...
  nand3  g33(.a(new_n77_), .b(new_n72_), .c(new_n46_), .O(new_n78_));
  ...
  nand4  g47(.a(new_n91_), .b(new_n84_), .c(new_n83_), .d(new_n45_), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  nand4  g49(.a(new_n93_), .b(x25), .c(x01), .d(new_n82_), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(z3));
  nand3  g51(.a(x28), .b(new_n83_), .c(new_n82_), .O(new_n96_));
  ...
  aoi21  g55(.a(new_n99_), .b(new_n82_), .c(x26), .O(z4));
  ...
  nand4  g61(.a(new_n105_), .b(new_n91_), .c(new_n84_), .d(new_n45_), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(x25), .c(x01), .d(new_n82_), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(z5));
  nand2  g65(.a(new_n101_), .b(x30), .O(new_n110_));
  ...
  nand2  g70(.a(x30), .b(new_n103_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n91_), .c(new_n84_), .d(new_n45_), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(x25), .c(x01), .d(new_n82_), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(z6));
  nand2  g76(.a(x30), .b(x29), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n101_), .c(x31), .O(new_n122_));
  nand4  g78(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n87_), .O(new_n123_));
  nand3  g79(.a(new_n84_), .b(x25), .c(x01), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(new_n125_));
  inv1   g81(.a(x31), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(x30), .c(x29), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n101_), .c(new_n46_), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(x26), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n125_), .c(new_n123_), .d(new_n122_), .O(z7));
  inv1   g86(.a(new_n46_), .O(z9));
endmodule
