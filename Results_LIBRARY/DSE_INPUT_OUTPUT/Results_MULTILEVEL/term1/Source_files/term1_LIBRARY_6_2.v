...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n81_), .c(x29), .O(new_n95_));
  ...
  nand2  g061(.a(new_n105_), .b(x33), .O(new_n106_));
  nand4  g062(.a(new_n104_), .b(x29), .c(x28), .d(x27), .O(new_n107_));
  ...
  nor3   g065(.a(new_n109_), .b(new_n103_), .c(new_n59_), .O(z6));
  ...
  aoi21  g070(.a(new_n106_), .b(x30), .c(new_n114_), .O(new_n115_));
  nor4   g071(.a(new_n105_), .b(new_n45_), .c(x31), .d(new_n104_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n113_), .O(z7));
  ...
  nand2  g083(.a(new_n127_), .b(new_n119_), .O(new_n128_));
  ...
  and2   g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n131_), .c(new_n128_), .d(new_n126_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n123_), .c(new_n46_), .O(new_n139_));
  nor2   g095(.a(x28), .b(x27), .O(new_n140_));
  nor3   g096(.a(new_n140_), .b(new_n45_), .c(new_n104_), .O(new_n141_));
  nor2   g097(.a(new_n140_), .b(new_n96_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(new_n104_), .c(new_n141_), .d(x29), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x32), .O(new_n146_));
  inv1   g102(.a(x32), .O(new_n147_));
  inv1   g103(.a(new_n140_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n104_), .c(x29), .O(new_n149_));
  nand3  g105(.a(new_n143_), .b(x33), .c(x30), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  inv1   g107(.a(x18), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n152_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n120_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n132_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n132_), .d(x12), .O(new_n156_));
  ...
  aoi21  g117(.a(new_n161_), .b(new_n158_), .c(new_n119_), .O(new_n162_));
  nand3  g118(.a(x16), .b(new_n119_), .c(x10), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  or2    g120(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n151_), .c(new_n147_), .d(x31), .O(new_n166_));
  ...
  oai21  g125(.a(new_n164_), .b(new_n162_), .c(new_n45_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(x31), .c(new_n104_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n143_), .O(new_n172_));
  oai21  g128(.a(new_n142_), .b(x31), .c(new_n104_), .O(new_n173_));
  inv1   g129(.a(new_n135_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n134_), .c(new_n131_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n173_), .c(new_n128_), .d(new_n126_), .O(new_n177_));
  or2    g133(.a(new_n177_), .b(new_n123_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(x33), .c(new_n114_), .d(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n172_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n80_), .c(x00), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n46_), .O(z9));
endmodule
