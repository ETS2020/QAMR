...
module FAU ( 
  ...
  nand3  g017(.a(new_n61_), .b(x30), .c(x01), .O(new_n62_));
  ...
  nand3  g027(.a(new_n71_), .b(x30), .c(x01), .O(new_n72_));
  ...
  aoi21  g045(.a(new_n89_), .b(new_n85_), .c(new_n58_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n82_), .c(new_n81_), .d(x25), .O(new_n91_));
  aoi21  g047(.a(new_n91_), .b(x30), .c(new_n45_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n81_), .d(x25), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(x30), .c(new_n45_), .O(z4));
  nand2  g051(.a(new_n89_), .b(new_n85_), .O(new_n96_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n96_), .c(new_n59_), .d(x30), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n81_), .c(x25), .d(x01), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z5));
  inv1   g060(.a(x30), .O(new_n105_));
  oai21  g061(.a(new_n98_), .b(new_n105_), .c(x29), .O(new_n106_));
  and2   g062(.a(new_n106_), .b(new_n96_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n59_), .c(new_n81_), .d(x25), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(x30), .c(new_n45_), .O(z6));
  nand3  g065(.a(x29), .b(x28), .c(x27), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x31), .O(new_n111_));
  inv1   g067(.a(new_n86_), .O(new_n112_));
  inv1   g068(.a(new_n87_), .O(new_n113_));
  inv1   g069(.a(new_n88_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n85_), .O(new_n115_));
  nand3  g071(.a(new_n59_), .b(x25), .c(x01), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n98_), .b(new_n117_), .c(x29), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x30), .c(new_n81_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n115_), .c(new_n111_), .O(z7));
  inv1   g077(.a(new_n46_), .O(new_n122_));
  ...
  nor3   g093(.a(new_n137_), .b(new_n136_), .c(new_n117_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n135_), .c(new_n132_), .d(new_n130_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n127_), .c(new_n122_), .O(new_n140_));
  nor2   g096(.a(x28), .b(x27), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n97_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n105_), .c(new_n45_), .O(new_n144_));
  ...
  nand4  g105(.a(new_n145_), .b(new_n105_), .c(x29), .d(new_n45_), .O(new_n150_));
  oai21  g106(.a(new_n142_), .b(new_n105_), .c(new_n150_), .O(new_n151_));
  ...
  nand4  g131(.a(new_n166_), .b(new_n171_), .c(new_n117_), .d(new_n105_), .O(new_n176_));
  ...
  nand2  g144(.a(new_n188_), .b(new_n122_), .O(z9));
endmodule
