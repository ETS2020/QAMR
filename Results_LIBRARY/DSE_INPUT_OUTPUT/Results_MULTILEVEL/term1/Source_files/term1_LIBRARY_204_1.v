...
module FAU ( 
  ...
  nand3  g032(.a(new_n52_), .b(x03), .c(new_n45_), .O(new_n77_));
  oai21  g033(.a(x03), .b(new_n45_), .c(new_n77_), .O(new_n78_));
  nand2  g034(.a(new_n78_), .b(x01), .O(new_n79_));
  aoi21  g035(.a(new_n52_), .b(new_n68_), .c(x02), .O(new_n80_));
  nor2   g036(.a(x03), .b(x02), .O(new_n81_));
  nand4  g037(.a(new_n81_), .b(new_n52_), .c(x06), .d(x05), .O(new_n82_));
  oai21  g038(.a(new_n80_), .b(new_n71_), .c(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n65_), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n79_), .c(new_n76_), .O(new_n85_));
  aoi21  g041(.a(new_n75_), .b(new_n61_), .c(new_n85_), .O(new_n86_));
  nor3   g042(.a(new_n86_), .b(x09), .c(new_n60_), .O(z2));
  ...
  oai21  g052(.a(new_n96_), .b(new_n65_), .c(new_n46_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n88_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n65_), .c(new_n46_), .O(z4));
  inv1   g056(.a(new_n62_), .O(new_n101_));
  inv1   g057(.a(new_n94_), .O(new_n102_));
  inv1   g058(.a(x29), .O(new_n103_));
  inv1   g059(.a(x28), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  nand3  g061(.a(new_n103_), .b(x28), .c(x27), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n101_), .d(new_n88_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x25), .c(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n46_), .O(z5));
  oai21  g067(.a(x30), .b(x03), .c(x02), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x28), .c(x27), .O(new_n113_));
  inv1   g069(.a(new_n105_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x30), .c(new_n49_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x29), .O(new_n117_));
  nand3  g073(.a(x30), .b(new_n103_), .c(new_n49_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n117_), .c(new_n94_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n88_), .c(x25), .d(x01), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n46_), .O(z6));
  nor4   g077(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n122_));
  nand3  g078(.a(new_n88_), .b(x25), .c(x01), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n46_), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  nor2   g082(.a(x31), .b(new_n52_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n105_), .c(x29), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n126_), .c(new_n49_), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(x30), .O(new_n131_));
  aoi21  g087(.a(new_n129_), .b(x02), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n124_), .O(z7));
  nand2  g089(.a(new_n104_), .b(new_n89_), .O(new_n134_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n53_), .c(x31), .d(new_n52_), .O(new_n153_));
  ...
  nand4  g113(.a(new_n152_), .b(new_n53_), .c(x31), .d(x30), .O(new_n158_));
  nand2  g114(.a(x32), .b(new_n52_), .O(new_n159_));
  ...
  nor3   g129(.a(new_n173_), .b(new_n172_), .c(new_n130_), .O(new_n174_));
  ...
  nand4  g135(.a(new_n152_), .b(new_n55_), .c(x31), .d(x30), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n52_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n134_), .c(x29), .O(new_n183_));
  nand4  g139(.a(new_n152_), .b(new_n55_), .c(new_n130_), .d(new_n52_), .O(new_n184_));
  ...
  nor3   g144(.a(new_n173_), .b(new_n131_), .c(new_n127_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n188_), .c(new_n171_), .O(new_n190_));
  inv1   g146(.a(new_n190_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n169_), .c(new_n167_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n164_), .c(x33), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n187_), .c(new_n183_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n88_), .c(x00), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n46_), .O(z9));
endmodule
