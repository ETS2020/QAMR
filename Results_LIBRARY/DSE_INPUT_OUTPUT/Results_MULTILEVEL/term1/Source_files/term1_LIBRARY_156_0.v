...
module FAU ( 
  ...
  nand2  g047(.a(new_n45_), .b(new_n91_), .O(new_n92_));
  ...
  oai21  g061(.a(new_n46_), .b(new_n91_), .c(new_n45_), .O(new_n106_));
  nand3  g062(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g064(.a(x31), .b(new_n45_), .c(new_n91_), .O(new_n109_));
  aoi22  g065(.a(new_n109_), .b(new_n108_), .c(new_n105_), .d(new_n103_), .O(new_n110_));
  ...
  oai21  g069(.a(new_n104_), .b(new_n45_), .c(new_n91_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n107_), .O(new_n115_));
  nand2  g071(.a(x31), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n92_), .c(new_n115_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n102_), .c(new_n61_), .O(new_n118_));
  nand2  g074(.a(new_n94_), .b(new_n104_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(new_n113_), .O(new_n120_));
  nand3  g076(.a(new_n94_), .b(new_n113_), .c(x29), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n100_), .c(new_n81_), .O(new_n122_));
  ...
  nand4  g083(.a(new_n106_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n128_));
  nand3  g084(.a(new_n101_), .b(x30), .c(x29), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x31), .O(new_n130_));
  nor2   g086(.a(x31), .b(new_n113_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n101_), .c(x29), .d(x24), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n130_), .c(new_n128_), .d(new_n127_), .O(z7));
  inv1   g089(.a(x00), .O(new_n134_));
  nand2  g090(.a(new_n100_), .b(new_n81_), .O(new_n135_));
  ...
  aoi21  g103(.a(new_n147_), .b(new_n143_), .c(new_n137_), .O(new_n148_));
  nand3  g104(.a(x16), .b(new_n137_), .c(x10), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n148_), .c(new_n136_), .O(new_n151_));
  ...
  nor2   g116(.a(new_n160_), .b(new_n137_), .O(new_n161_));
  nor2   g117(.a(new_n88_), .b(new_n85_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(x16), .c(x15), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n91_), .O(new_n164_));
  ...
  nand2  g123(.a(new_n167_), .b(new_n144_), .O(new_n168_));
  ...
  nand3  g130(.a(x32), .b(new_n46_), .c(x24), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(x31), .c(new_n176_), .O(new_n177_));
  nor3   g133(.a(new_n177_), .b(x26), .c(new_n134_), .O(z8));
  inv1   g134(.a(x33), .O(new_n179_));
  inv1   g135(.a(new_n148_), .O(new_n180_));
  inv1   g136(.a(new_n150_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n179_), .c(x31), .d(x30), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(x31), .c(new_n183_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n135_), .c(x29), .O(new_n185_));
  nand4  g141(.a(new_n182_), .b(new_n179_), .c(new_n46_), .d(new_n113_), .O(new_n186_));
  oai21  g142(.a(new_n179_), .b(new_n46_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n155_), .O(new_n188_));
  inv1   g144(.a(new_n169_), .O(new_n189_));
  nor2   g145(.a(new_n46_), .b(x30), .O(new_n190_));
  nor3   g146(.a(new_n190_), .b(new_n170_), .c(new_n131_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n189_), .c(new_n168_), .O(new_n192_));
  inv1   g148(.a(new_n192_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n166_), .c(new_n164_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n161_), .c(x33), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n188_), .c(new_n185_), .O(new_n196_));
