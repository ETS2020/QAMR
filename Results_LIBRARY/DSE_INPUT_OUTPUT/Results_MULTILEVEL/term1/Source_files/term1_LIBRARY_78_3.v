...
module FAU ( 
  ...
  nand3  g055(.a(new_n99_), .b(new_n95_), .c(new_n45_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n98_), .c(new_n61_), .O(z4));
  ...
  nand2  g061(.a(new_n46_), .b(x26), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(new_n102_), .d(x29), .O(new_n107_));
  inv1   g063(.a(x29), .O(new_n108_));
  nand4  g064(.a(new_n102_), .b(new_n108_), .c(x28), .d(x27), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(x26), .c(new_n107_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n63_), .c(x25), .d(x01), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n48_), .O(z5));
  nand4  g068(.a(new_n46_), .b(x28), .c(x27), .d(new_n45_), .O(new_n113_));
  oai21  g069(.a(new_n104_), .b(new_n46_), .c(new_n113_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x29), .O(new_n115_));
  oai21  g071(.a(new_n46_), .b(x29), .c(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n63_), .d(x25), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n61_), .c(new_n48_), .O(z6));
  oai21  g074(.a(x31), .b(x26), .c(new_n46_), .O(new_n119_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n104_), .c(new_n98_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n119_), .O(z7));
  nand2  g087(.a(new_n103_), .b(new_n82_), .O(new_n132_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(x31), .d(new_n46_), .O(new_n149_));
  ...
  nand2  g133(.a(x33), .b(new_n46_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n132_), .c(x29), .O(new_n180_));
  nand4  g136(.a(new_n148_), .b(new_n176_), .c(new_n125_), .d(new_n46_), .O(new_n181_));
  nand2  g137(.a(x33), .b(x30), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n153_), .O(new_n184_));
  ...
  nand3  g148(.a(new_n192_), .b(new_n45_), .c(x00), .O(new_n193_));
