// Benchmark "FAU" written by ABC on Fri Aug 14 02:50:32 2020
...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n62_), .c(new_n48_), .O(z4));
  inv1   g056(.a(x30), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(x28), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n45_), .c(x29), .O(new_n103_));
  nand2  g059(.a(x28), .b(x27), .O(new_n104_));
  inv1   g060(.a(x29), .O(new_n105_));
  nand2  g061(.a(x30), .b(new_n105_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n94_), .c(new_n63_), .d(new_n82_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n81_), .c(new_n62_), .O(z5));
  nand3  g065(.a(x29), .b(x28), .c(x27), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n94_), .c(new_n63_), .d(x30), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n82_), .c(x25), .d(x01), .O(new_n113_));
  ...
  nand2  g074(.a(x30), .b(x29), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n104_), .c(x31), .O(new_n120_));
  nand4  g076(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n121_));
  nand4  g077(.a(new_n63_), .b(new_n82_), .c(x25), .d(x01), .O(new_n122_));
  ...
  nand2  g085(.a(new_n129_), .b(new_n91_), .O(new_n130_));
  nand2  g086(.a(x18), .b(x17), .O(new_n131_));
  nand2  g087(.a(x16), .b(x10), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n125_), .O(new_n133_));
  inv1   g089(.a(x11), .O(new_n134_));
  inv1   g090(.a(x16), .O(new_n135_));
  oai21  g091(.a(new_n131_), .b(new_n134_), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(x18), .b(x12), .O(new_n137_));
  inv1   g093(.a(x13), .O(new_n138_));
  nand2  g094(.a(new_n88_), .b(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x31), .O(new_n140_));
  aoi21  g096(.a(new_n137_), .b(new_n85_), .c(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n136_), .c(new_n133_), .d(new_n130_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n128_), .c(new_n48_), .O(new_n143_));
  nand2  g099(.a(x29), .b(x28), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n101_), .c(new_n45_), .O(new_n145_));
  nor2   g101(.a(x28), .b(x27), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n101_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n145_), .c(new_n143_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  nand3  g106(.a(new_n101_), .b(x29), .c(x28), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n102_), .c(new_n45_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n106_), .O(new_n154_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n135_), .c(x11), .O(new_n163_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n154_), .c(new_n49_), .d(x31), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n150_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n82_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  nand2  g127(.a(x30), .b(x28), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n45_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(x31), .c(x29), .O(new_n174_));
  nand2  g130(.a(new_n144_), .b(new_n115_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(x30), .c(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n167_), .c(new_n53_), .O(new_n177_));
  nand2  g133(.a(new_n175_), .b(new_n101_), .O(new_n178_));
  nand2  g134(.a(x31), .b(x29), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n146_), .c(x30), .O(new_n180_));
  nand2  g136(.a(new_n137_), .b(new_n85_), .O(new_n181_));
  nand4  g137(.a(new_n139_), .b(new_n181_), .c(new_n136_), .d(new_n133_), .O(new_n182_));
  aoi21  g138(.a(new_n129_), .b(new_n91_), .c(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n180_), .c(new_n178_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n128_), .c(x33), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n177_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n82_), .c(x00), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n48_), .O(z9));
endmodule
