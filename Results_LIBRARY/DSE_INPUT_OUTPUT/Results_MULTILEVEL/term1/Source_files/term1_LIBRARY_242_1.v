...
module FAU ( 
  ...
  nand3  g052(.a(new_n45_), .b(x28), .c(new_n82_), .O(new_n97_));
  oai21  g053(.a(x28), .b(new_n82_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n92_), .c(x25), .d(x01), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n45_), .c(x26), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n90_), .c(new_n63_), .d(new_n45_), .O(new_n105_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n45_), .c(x26), .O(z6));
  inv1   g071(.a(new_n86_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n85_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n88_), .c(new_n87_), .O(new_n118_));
  nand3  g074(.a(new_n102_), .b(x30), .c(x29), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n63_), .c(x25), .d(x01), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n81_), .O(z7));
  nand4  g078(.a(x32), .b(new_n45_), .c(new_n81_), .d(x00), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(z8));
  ...
  nand4  g099(.a(new_n143_), .b(new_n125_), .c(new_n53_), .d(new_n111_), .O(new_n144_));
  aoi21  g100(.a(new_n129_), .b(x14), .c(new_n127_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x17), .c(x16), .d(x15), .O(new_n146_));
  nand2  g102(.a(x16), .b(x15), .O(new_n147_));
  nand2  g103(.a(x18), .b(x17), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n129_), .O(new_n149_));
  ...
  aoi21  g112(.a(new_n127_), .b(new_n156_), .c(x30), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n155_), .c(new_n153_), .d(new_n151_), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n149_), .c(new_n146_), .d(new_n125_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x33), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n144_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n45_), .c(new_n81_), .d(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z9));
endmodule
