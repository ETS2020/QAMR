...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n92_), .c(new_n60_), .d(x30), .O(new_n114_));
  ...
  oai21  g079(.a(new_n104_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  aoi22  g080(.a(new_n124_), .b(x30), .c(x31), .d(new_n45_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n121_), .O(z7));
  inv1   g082(.a(x00), .O(new_n127_));
  inv1   g083(.a(x30), .O(new_n128_));
  inv1   g084(.a(x32), .O(new_n129_));
  nand2  g085(.a(new_n103_), .b(new_n80_), .O(new_n130_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n131_), .c(new_n129_), .d(x31), .O(new_n148_));
  ...
  nor3   g116(.a(new_n160_), .b(new_n159_), .c(new_n122_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n158_), .c(new_n156_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n154_), .c(new_n131_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n151_), .c(x32), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n148_), .c(new_n128_), .O(new_n166_));
  nand3  g122(.a(x32), .b(new_n128_), .c(new_n45_), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n166_), .c(new_n79_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n127_), .O(z8));
  nor2   g126(.a(new_n160_), .b(new_n159_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n151_), .c(new_n57_), .O(new_n173_));
  nand2  g129(.a(new_n122_), .b(new_n128_), .O(new_n174_));
  nand2  g130(.a(new_n130_), .b(x31), .O(new_n175_));
  aoi22  g131(.a(new_n175_), .b(x30), .c(new_n174_), .d(new_n45_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x33), .O(new_n178_));
  nor3   g134(.a(new_n175_), .b(new_n128_), .c(new_n45_), .O(new_n179_));
  nor2   g135(.a(new_n174_), .b(x29), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n147_), .O(new_n181_));
