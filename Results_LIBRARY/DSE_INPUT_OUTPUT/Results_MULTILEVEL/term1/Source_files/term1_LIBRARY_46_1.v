...
module FAU ( 
  ...
  inv1   g036(.a(new_n61_), .O(new_n81_));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n84_), .c(new_n81_), .O(new_n89_));
  ...
  nand3  g049(.a(new_n93_), .b(new_n89_), .c(new_n45_), .O(new_n94_));
  ...
  aoi22  g057(.a(new_n101_), .b(new_n99_), .c(new_n88_), .d(new_n84_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n61_), .c(x25), .d(x01), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n45_), .c(x26), .O(z5));
  nand3  g060(.a(new_n89_), .b(new_n45_), .c(x29), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n92_), .d(x25), .O(new_n107_));
  ...
  nand2  g071(.a(new_n98_), .b(new_n80_), .O(new_n116_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n45_), .c(new_n92_), .d(x00), .O(new_n157_));
  ...
  aoi21  g124(.a(new_n168_), .b(new_n45_), .c(x26), .O(z9));
endmodule
