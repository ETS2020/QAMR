...
module FAU ( 
  ...
  nor3   g048(.a(new_n92_), .b(new_n80_), .c(new_n61_), .O(z4));
  ...
  nand4  g066(.a(new_n110_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n111_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(x31), .d(new_n105_), .O(new_n147_));
  ...
  nand4  g134(.a(new_n146_), .b(new_n174_), .c(new_n120_), .d(new_n105_), .O(new_n179_));
