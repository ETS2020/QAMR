...
module FAU ( 
  ...
  nand3  g045(.a(new_n89_), .b(new_n83_), .c(new_n45_), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n82_), .c(new_n61_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n89_), .c(new_n45_), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n82_), .c(new_n61_), .O(z4));
  ...
  nor3   g057(.a(new_n101_), .b(new_n82_), .c(new_n61_), .O(z5));
  nand3  g058(.a(new_n46_), .b(x28), .c(x27), .O(new_n103_));
  oai21  g059(.a(new_n98_), .b(new_n46_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n98_), .b(x30), .c(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x31), .O(new_n111_));
  inv1   g067(.a(new_n86_), .O(new_n112_));
  inv1   g068(.a(new_n87_), .O(new_n113_));
  nor2   g069(.a(new_n85_), .b(new_n84_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n115_));
  nor2   g071(.a(new_n62_), .b(new_n61_), .O(new_n116_));
  inv1   g072(.a(new_n98_), .O(new_n117_));
  ...
  nor2   g076(.a(new_n120_), .b(new_n82_), .O(new_n121_));
  ...
  oai22  g095(.a(new_n139_), .b(new_n127_), .c(x30), .d(new_n45_), .O(new_n140_));
  nor2   g096(.a(x28), .b(x27), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n96_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n46_), .c(new_n45_), .O(new_n144_));
  ...
  nand4  g105(.a(new_n145_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n150_));
