...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n99_), .c(new_n60_), .d(x30), .O(new_n104_));
  ...
  oai21  g064(.a(new_n101_), .b(new_n108_), .c(x29), .O(new_n109_));
  and2   g065(.a(new_n109_), .b(new_n99_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n60_), .c(new_n82_), .d(x25), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(x30), .c(new_n45_), .O(z6));
  ...
  inv1   g072(.a(new_n89_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n86_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n101_), .b(new_n119_), .c(x29), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n60_), .c(new_n82_), .d(x25), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n118_), .c(new_n114_), .O(new_n123_));
  ...
  nor2   g100(.a(new_n144_), .b(new_n100_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n108_), .c(new_n45_), .O(new_n147_));
  ...
  nand4  g108(.a(new_n148_), .b(new_n108_), .c(x29), .d(new_n45_), .O(new_n153_));
  oai21  g109(.a(new_n145_), .b(new_n108_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g125(.a(new_n169_), .b(new_n154_), .c(new_n152_), .d(x31), .O(new_n170_));
  ...
  nand4  g134(.a(new_n169_), .b(new_n174_), .c(new_n119_), .d(new_n108_), .O(new_n179_));
  nand2  g135(.a(x33), .b(x30), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n146_), .O(new_n182_));
  ...
  nand4  g143(.a(new_n187_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n130_), .c(x33), .O(new_n189_));
