...
module FAU ( 
  ...
  nand3  g034(.a(new_n78_), .b(new_n45_), .c(x08), .O(new_n79_));
  ...
  nand4  g050(.a(new_n94_), .b(new_n63_), .c(new_n49_), .d(new_n82_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n81_), .c(x25), .d(x01), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z3));
  nand3  g054(.a(new_n49_), .b(x28), .c(new_n82_), .O(new_n99_));
  oai21  g055(.a(x28), .b(new_n82_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n94_), .c(new_n63_), .d(new_n81_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x25), .c(x01), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n49_), .O(z4));
  nand2  g060(.a(x30), .b(x09), .O(new_n105_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n105_), .c(new_n94_), .d(new_n63_), .O(new_n110_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n94_), .c(new_n63_), .d(new_n81_), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n114_), .c(new_n62_), .O(z6));
  nand3  g076(.a(new_n91_), .b(new_n88_), .c(new_n85_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n92_), .O(new_n122_));
  nand4  g078(.a(new_n63_), .b(new_n81_), .c(x25), .d(x01), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n49_), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  nor2   g082(.a(x31), .b(new_n46_), .O(new_n127_));
  ...
  aoi21  g087(.a(new_n129_), .b(new_n45_), .c(new_n131_), .O(new_n132_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n138_), .c(new_n49_), .O(new_n151_));
  nor2   g107(.a(x28), .b(x27), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n46_), .c(new_n106_), .O(new_n153_));
  inv1   g109(.a(new_n152_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x29), .O(new_n155_));
  aoi22  g111(.a(new_n155_), .b(new_n46_), .c(new_n153_), .d(new_n45_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  nand3  g114(.a(new_n155_), .b(x30), .c(new_n45_), .O(new_n159_));
  nand3  g115(.a(new_n154_), .b(new_n46_), .c(x29), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand3  g117(.a(x19), .b(new_n89_), .c(x13), .O(new_n162_));
  nand3  g118(.a(new_n135_), .b(x18), .c(x14), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n162_), .c(new_n86_), .O(new_n164_));
  nand4  g120(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n165_));
  ...
  nand4  g130(.a(new_n174_), .b(new_n161_), .c(new_n50_), .d(x31), .O(new_n175_));
  ...
  nand4  g134(.a(new_n174_), .b(new_n54_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n46_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n154_), .c(x29), .O(new_n182_));
  nand4  g138(.a(new_n174_), .b(new_n54_), .c(new_n130_), .d(new_n46_), .O(new_n183_));
