...
module FAU ( 
  ...
  nand3  g022(.a(new_n66_), .b(x30), .c(new_n61_), .O(new_n67_));
  ...
  nand3  g030(.a(new_n74_), .b(x30), .c(new_n61_), .O(new_n75_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n61_), .c(new_n79_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n61_), .c(new_n79_), .O(z4));
  inv1   g055(.a(x25), .O(new_n100_));
  inv1   g056(.a(new_n58_), .O(new_n101_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n101_), .d(new_n80_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n100_), .c(new_n61_), .O(z5));
  nand2  g065(.a(new_n105_), .b(x29), .O(new_n110_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n102_), .c(new_n101_), .d(new_n80_), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n100_), .c(new_n79_), .O(z6));
  ...
  nor2   g076(.a(new_n58_), .b(new_n61_), .O(new_n121_));
  ...
  nand4  g109(.a(new_n149_), .b(new_n112_), .c(x29), .d(x01), .O(new_n154_));
  oai21  g110(.a(new_n146_), .b(new_n112_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g130(.a(x33), .b(new_n112_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n149_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n168_), .b(new_n173_), .c(new_n123_), .d(new_n112_), .O(new_n178_));
  ...
  nand2  g146(.a(new_n190_), .b(new_n79_), .O(z9));
endmodule
