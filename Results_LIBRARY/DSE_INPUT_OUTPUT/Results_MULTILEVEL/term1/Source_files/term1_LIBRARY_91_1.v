...
module FAU ( 
  ...
  aoi21  g048(.a(new_n92_), .b(new_n83_), .c(new_n59_), .O(new_n93_));
  ...
  oai21  g059(.a(x30), .b(new_n103_), .c(new_n45_), .O(new_n104_));
  nor2   g060(.a(new_n84_), .b(new_n81_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n91_), .c(new_n104_), .O(new_n107_));
  inv1   g063(.a(x30), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n45_), .c(new_n103_), .O(new_n109_));
  aoi22  g065(.a(new_n109_), .b(new_n107_), .c(new_n102_), .d(new_n100_), .O(new_n110_));
  ...
  nor2   g069(.a(new_n106_), .b(new_n91_), .O(new_n114_));
  nor2   g070(.a(new_n99_), .b(new_n80_), .O(new_n115_));
  aoi21  g071(.a(x29), .b(x21), .c(x16), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(x29), .O(new_n117_));
  nor2   g073(.a(x30), .b(new_n101_), .O(new_n118_));
  aoi22  g074(.a(new_n118_), .b(new_n115_), .c(new_n117_), .d(x30), .O(new_n119_));
  nand3  g075(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  oai22  g076(.a(new_n120_), .b(new_n113_), .c(new_n119_), .d(new_n114_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n58_), .c(new_n46_), .O(z6));
  ...
  nand3  g082(.a(new_n105_), .b(new_n90_), .c(new_n87_), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  nand4  g084(.a(new_n115_), .b(new_n128_), .c(x30), .d(x29), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n127_), .c(new_n126_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x21), .O(new_n131_));
  oai21  g087(.a(new_n127_), .b(new_n103_), .c(new_n128_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n108_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n131_), .c(new_n125_), .O(z7));
  inv1   g090(.a(x15), .O(new_n135_));
  nand2  g091(.a(new_n88_), .b(x14), .O(new_n136_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(new_n88_), .O(new_n141_));
  nand2  g097(.a(x16), .b(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n140_), .c(new_n135_), .O(new_n143_));
  inv1   g099(.a(x11), .O(new_n144_));
  oai21  g100(.a(new_n140_), .b(new_n144_), .c(new_n103_), .O(new_n145_));
  aoi21  g101(.a(x18), .b(x12), .c(x17), .O(new_n146_));
  nor2   g102(.a(x18), .b(x13), .O(new_n147_));
  nor3   g103(.a(new_n147_), .b(new_n146_), .c(new_n128_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n138_), .c(new_n46_), .O(new_n150_));
  nor2   g106(.a(x28), .b(x27), .O(new_n151_));
  nor3   g107(.a(new_n151_), .b(new_n108_), .c(new_n101_), .O(new_n152_));
  inv1   g108(.a(new_n151_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x29), .O(new_n154_));
  aoi22  g110(.a(new_n154_), .b(new_n108_), .c(new_n152_), .d(x21), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n150_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x32), .O(new_n157_));
  inv1   g113(.a(x32), .O(new_n158_));
  nand3  g114(.a(new_n154_), .b(x30), .c(x21), .O(new_n159_));
  nand3  g115(.a(new_n153_), .b(new_n108_), .c(x29), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  inv1   g117(.a(x17), .O(new_n162_));
  nand3  g118(.a(x19), .b(new_n85_), .c(x13), .O(new_n163_));
  nand3  g119(.a(new_n88_), .b(x18), .c(x14), .O(new_n164_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n103_), .c(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x15), .O(new_n173_));
  nand4  g129(.a(new_n170_), .b(x16), .c(new_n135_), .d(x10), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n161_), .c(new_n158_), .d(x31), .O(new_n176_));
  ...
  nand2  g137(.a(x33), .b(new_n108_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n153_), .c(x29), .O(new_n184_));
  nand4  g140(.a(new_n175_), .b(new_n180_), .c(new_n128_), .d(new_n108_), .O(new_n185_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n138_), .c(x33), .O(new_n195_));
