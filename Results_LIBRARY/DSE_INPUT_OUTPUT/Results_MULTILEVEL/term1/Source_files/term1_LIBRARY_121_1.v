...
module FAU ( 
  ...
  aoi21  g013(.a(new_n45_), .b(new_n57_), .c(new_n46_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n56_), .c(new_n52_), .O(z1));
  ...
  aoi21  g049(.a(new_n93_), .b(new_n45_), .c(x26), .O(z3));
  inv1   g050(.a(x26), .O(new_n95_));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n92_), .c(new_n45_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n90_), .c(new_n63_), .d(new_n45_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n95_), .c(x25), .d(x01), .O(new_n108_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(new_n91_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n63_), .c(x25), .d(x01), .O(new_n115_));
  ...
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n85_), .O(new_n122_));
  nor2   g078(.a(new_n62_), .b(new_n61_), .O(new_n123_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n103_), .c(new_n124_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n123_), .c(new_n122_), .d(new_n118_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n95_), .O(z7));
  ...
  xnor2a g104(.a(x32), .b(x30), .O(new_n149_));
  nand2  g105(.a(new_n102_), .b(new_n82_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(x29), .O(new_n151_));
  nand2  g107(.a(new_n150_), .b(x29), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n57_), .c(x30), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  oai21  g110(.a(new_n148_), .b(new_n146_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n136_), .b(x14), .c(new_n134_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x17), .c(x16), .d(x15), .O(new_n157_));
  nand2  g113(.a(new_n152_), .b(new_n112_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  nand2  g115(.a(x18), .b(x17), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n136_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n160_), .c(new_n132_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n160_), .b(new_n164_), .c(new_n142_), .O(new_n165_));
  nand2  g121(.a(x18), .b(x12), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n133_), .O(new_n167_));
  inv1   g123(.a(x13), .O(new_n168_));
  aoi21  g124(.a(new_n134_), .b(new_n168_), .c(new_n125_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n167_), .c(new_n165_), .d(new_n163_), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n161_), .c(new_n158_), .d(new_n157_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x32), .O(new_n173_));
  oai21  g129(.a(new_n155_), .b(new_n125_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x00), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n45_), .c(x26), .O(z8));
  or2    g132(.a(new_n148_), .b(new_n146_), .O(new_n177_));
  nand4  g133(.a(new_n150_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  nand3  g134(.a(new_n152_), .b(new_n125_), .c(new_n112_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n177_), .c(x00), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n45_), .c(x26), .O(z9));
endmodule
