...
module FAU ( 
  ...
  aoi21  g063(.a(new_n107_), .b(new_n80_), .c(x26), .O(z6));
  inv1   g064(.a(new_n84_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n83_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n86_), .c(new_n85_), .O(new_n111_));
  inv1   g067(.a(x31), .O(new_n112_));
  nand4  g068(.a(new_n60_), .b(new_n112_), .c(x25), .d(x01), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n111_), .c(new_n80_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n45_), .O(z7));
  inv1   g071(.a(x32), .O(new_n116_));
  nand2  g072(.a(new_n98_), .b(new_n79_), .O(new_n117_));
  ...
  nor2   g105(.a(new_n112_), .b(new_n100_), .O(new_n150_));
  ...
  oai21  g111(.a(new_n136_), .b(new_n100_), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n80_), .c(new_n45_), .d(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(z8));
  inv1   g114(.a(x33), .O(new_n159_));
  nand2  g115(.a(new_n117_), .b(x29), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n135_), .c(new_n159_), .d(new_n112_), .O(new_n161_));
  aoi21  g117(.a(new_n119_), .b(new_n148_), .c(x31), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n160_), .c(new_n141_), .d(new_n138_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x33), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n161_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n80_), .c(new_n45_), .d(x00), .O(new_n168_));
