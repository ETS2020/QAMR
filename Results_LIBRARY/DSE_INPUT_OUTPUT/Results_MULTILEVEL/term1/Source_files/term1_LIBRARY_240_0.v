...
module FAU ( 
  ...
  nand4  g032(.a(new_n76_), .b(new_n55_), .c(new_n57_), .d(x08), .O(new_n77_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n60_), .c(x32), .d(new_n79_), .O(new_n93_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n60_), .d(x32), .O(new_n98_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n60_), .d(x32), .O(new_n107_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n92_), .c(new_n60_), .d(x32), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n54_), .c(x25), .d(x01), .O(new_n118_));
  ...
  nand3  g078(.a(new_n60_), .b(x25), .c(x01), .O(new_n123_));
  ...
  aoi21  g105(.a(new_n86_), .b(new_n149_), .c(new_n126_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .d(new_n143_), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n139_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n136_), .c(new_n134_), .d(new_n132_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x00), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(x32), .c(x26), .O(z8));
  ...
  nand3  g120(.a(new_n164_), .b(new_n145_), .c(x11), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x15), .O(new_n167_));
  nand4  g123(.a(new_n164_), .b(x16), .c(new_n140_), .d(x10), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n156_), .c(x31), .d(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n111_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n133_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n169_), .b(new_n156_), .c(new_n126_), .d(new_n111_), .O(new_n174_));
  nand2  g130(.a(x33), .b(x30), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n135_), .O(new_n177_));
  nand2  g133(.a(new_n86_), .b(new_n149_), .O(new_n178_));
  xnor2a g134(.a(x31), .b(x30), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n178_), .c(new_n148_), .d(new_n146_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n143_), .c(new_n138_), .d(new_n132_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n177_), .c(new_n173_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x00), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(x32), .c(x26), .O(z9));
endmodule
