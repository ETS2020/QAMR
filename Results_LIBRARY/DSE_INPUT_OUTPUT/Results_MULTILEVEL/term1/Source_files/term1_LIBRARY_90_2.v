...
module FAU ( 
  ...
  nor2   g037(.a(x32), .b(new_n57_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n81_), .O(z2));
  ...
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n64_), .d(new_n85_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n83_), .O(z6));
  nand3  g074(.a(new_n103_), .b(x30), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x31), .O(new_n120_));
  nor4   g076(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n87_), .O(new_n121_));
  inv1   g077(.a(x31), .O(new_n122_));
  nand4  g078(.a(new_n103_), .b(new_n122_), .c(x30), .d(x29), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n85_), .c(x25), .O(new_n124_));
  nor4   g080(.a(new_n124_), .b(new_n121_), .c(new_n63_), .d(new_n62_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n120_), .c(new_n82_), .O(z7));
  nand2  g082(.a(new_n102_), .b(new_n86_), .O(new_n127_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n58_), .c(x31), .d(new_n112_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n145_), .b(new_n58_), .c(x31), .d(x30), .O(new_n151_));
  nand2  g107(.a(x32), .b(new_n112_), .O(new_n152_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n83_), .O(z8));
  ...
  nand4  g132(.a(new_n145_), .b(new_n48_), .c(new_n122_), .d(new_n112_), .O(new_n177_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n85_), .c(x00), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n83_), .O(z9));
endmodule
