...
module FAU ( 
  ...
  nand4  g47(.a(new_n91_), .b(new_n61_), .c(new_n81_), .d(new_n80_), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  nand4  g49(.a(new_n93_), .b(x25), .c(x01), .d(new_n45_), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(z3));
  nor3   g51(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n96_));
  nand3  g52(.a(x28), .b(new_n81_), .c(new_n45_), .O(new_n97_));
  inv1   g53(.a(x28), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x27), .O(new_n99_));
  aoi22  g55(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n84_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n61_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n45_), .c(x26), .O(z4));
  oai21  g58(.a(new_n98_), .b(new_n81_), .c(x29), .O(new_n103_));
  inv1   g59(.a(x29), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x28), .c(x27), .O(new_n105_));
  aoi22  g61(.a(new_n105_), .b(new_n103_), .c(new_n96_), .d(new_n84_), .O(new_n106_));
  ...
  nor2   g66(.a(new_n98_), .b(new_n81_), .O(new_n111_));
  nor2   g67(.a(x30), .b(new_n104_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  aoi22  g69(.a(new_n113_), .b(new_n110_), .c(new_n96_), .d(new_n84_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n61_), .c(x25), .d(x01), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g72(.a(new_n111_), .b(x30), .c(x29), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(x31), .O(new_n118_));
  nand4  g74(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n119_));
  aoi21  g75(.a(x03), .b(x02), .c(new_n60_), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  inv1   g77(.a(x31), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(x30), .c(x29), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n111_), .c(new_n121_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n45_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n80_), .O(z7));
  nor2   g84(.a(x26), .b(new_n45_), .O(z9));
endmodule
