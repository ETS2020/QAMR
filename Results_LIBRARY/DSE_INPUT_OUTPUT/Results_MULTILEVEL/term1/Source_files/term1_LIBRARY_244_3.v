...
module FAU ( 
  ...
  oai21  g064(.a(new_n108_), .b(new_n60_), .c(new_n48_), .O(z6));
  ...
  oai21  g078(.a(new_n46_), .b(x24), .c(new_n122_), .O(z7));
  ...
  nand4  g131(.a(new_n143_), .b(new_n171_), .c(new_n117_), .d(new_n102_), .O(new_n176_));
