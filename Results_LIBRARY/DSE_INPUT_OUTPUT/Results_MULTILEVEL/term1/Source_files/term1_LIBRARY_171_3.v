...
module FAU ( 
  ...
  nor3   g063(.a(new_n107_), .b(new_n81_), .c(new_n60_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n62_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n60_), .c(new_n48_), .O(z6));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n104_), .c(new_n81_), .O(new_n124_));
  ...
  nand2  g101(.a(new_n103_), .b(new_n82_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n146_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n153_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n132_), .c(new_n128_), .O(new_n175_));
  aoi21  g131(.a(new_n147_), .b(new_n121_), .c(x30), .O(new_n176_));
  nor2   g132(.a(new_n121_), .b(new_n102_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n146_), .c(new_n46_), .O(new_n178_));
  aoi21  g134(.a(new_n176_), .b(new_n45_), .c(new_n178_), .O(new_n179_));
  ...
  nand4  g139(.a(new_n147_), .b(new_n121_), .c(new_n46_), .d(new_n45_), .O(new_n184_));
