...
module FAU ( 
  ...
  xnor2a g067(.a(x30), .b(x28), .O(new_n112_));
  aoi21  g068(.a(x30), .b(new_n103_), .c(new_n45_), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n103_), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n102_), .c(new_n62_), .d(new_n81_), .O(new_n115_));
  ...
  nor2   g079(.a(new_n61_), .b(new_n60_), .O(new_n124_));
  ...
  nand2  g086(.a(new_n89_), .b(x14), .O(new_n131_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n134_), .c(new_n89_), .O(new_n136_));
  nand2  g092(.a(x16), .b(x10), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(new_n130_), .O(new_n138_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n133_), .c(new_n47_), .O(new_n146_));
  xnor2a g102(.a(x30), .b(x29), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x27), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n146_), .c(new_n120_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  aoi21  g107(.a(new_n104_), .b(new_n45_), .c(new_n103_), .O(new_n152_));
  nand3  g108(.a(new_n46_), .b(x29), .c(x27), .O(new_n153_));
  oai21  g109(.a(new_n152_), .b(new_n46_), .c(new_n153_), .O(new_n154_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n140_), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x15), .O(new_n165_));
  nand4  g121(.a(new_n162_), .b(x16), .c(new_n130_), .d(x10), .O(new_n166_));
  ...
  nor2   g127(.a(new_n143_), .b(new_n142_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n141_), .c(new_n138_), .d(new_n136_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n133_), .c(new_n47_), .O(new_n174_));
  aoi21  g130(.a(new_n125_), .b(new_n103_), .c(x30), .O(new_n175_));
  nand2  g131(.a(new_n104_), .b(new_n45_), .O(new_n176_));
  ...
  aoi21  g136(.a(new_n163_), .b(new_n160_), .c(new_n130_), .O(new_n181_));
