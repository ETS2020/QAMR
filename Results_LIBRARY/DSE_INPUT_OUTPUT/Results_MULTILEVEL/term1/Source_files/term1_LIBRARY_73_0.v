...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n61_), .d(x30), .O(new_n101_));
  ...
  aoi21  g111(.a(new_n126_), .b(new_n155_), .c(new_n115_), .O(new_n156_));
  ...
  nand4  g117(.a(new_n161_), .b(x30), .c(new_n94_), .d(x00), .O(new_n162_));
  ...
  nor2   g122(.a(new_n115_), .b(new_n96_), .O(new_n167_));
  ...
  oai21  g128(.a(new_n165_), .b(new_n96_), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x30), .c(new_n94_), .d(x00), .O(new_n174_));
