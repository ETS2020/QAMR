...
module FAU ( 
  ...
  aoi21  g049(.a(new_n92_), .b(new_n58_), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n101_), .c(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  inv1   g062(.a(new_n93_), .O(new_n107_));
  oai21  g063(.a(x30), .b(new_n45_), .c(new_n92_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n106_), .c(x28), .d(x27), .O(new_n110_));
  ...
  nand2  g069(.a(new_n103_), .b(x29), .O(new_n114_));
  nand4  g070(.a(new_n107_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n114_), .c(x30), .O(new_n116_));
  inv1   g072(.a(x30), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x29), .O(new_n118_));
  oai22  g074(.a(new_n118_), .b(new_n104_), .c(x29), .d(new_n45_), .O(new_n119_));
  nor4   g075(.a(new_n118_), .b(new_n102_), .c(new_n82_), .d(x23), .O(new_n120_));
  aoi21  g076(.a(new_n119_), .b(new_n92_), .c(new_n120_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n116_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n60_), .c(new_n58_), .O(z6));
  oai21  g080(.a(x31), .b(x18), .c(new_n117_), .O(new_n125_));
  nand3  g081(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x31), .O(new_n127_));
  nand4  g083(.a(new_n107_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n128_));
  ...
  nand4  g096(.a(x30), .b(x19), .c(new_n45_), .d(x13), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(new_n86_), .O(new_n142_));
  nand4  g098(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n143_));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n145_), .c(new_n139_), .O(new_n150_));
  nand3  g106(.a(x16), .b(new_n139_), .c(x10), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n150_), .c(new_n138_), .O(new_n153_));
  nand2  g109(.a(x32), .b(new_n117_), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n130_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n137_), .O(new_n156_));
  inv1   g112(.a(new_n135_), .O(new_n157_));
  oai21  g113(.a(x30), .b(x18), .c(x32), .O(new_n158_));
  nand4  g114(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n159_));
  nor2   g115(.a(x30), .b(new_n89_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n138_), .c(x31), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(new_n158_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n157_), .c(x29), .O(new_n163_));
  aoi21  g119(.a(new_n89_), .b(x14), .c(new_n45_), .O(new_n164_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n167_), .c(new_n139_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n167_), .b(new_n171_), .c(new_n146_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x12), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n86_), .O(new_n174_));
  inv1   g130(.a(x13), .O(new_n175_));
  nand2  g131(.a(new_n45_), .b(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n174_), .c(new_n172_), .d(x31), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n170_), .c(new_n168_), .d(new_n165_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x32), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n163_), .c(new_n156_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n81_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n58_), .O(z8));
  inv1   g139(.a(x33), .O(new_n184_));
  oai21  g140(.a(new_n152_), .b(new_n150_), .c(new_n184_), .O(new_n185_));
  nand2  g141(.a(x33), .b(new_n117_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n130_), .c(new_n186_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n157_), .c(x29), .O(new_n188_));
  oai21  g144(.a(x30), .b(x18), .c(x33), .O(new_n189_));
  inv1   g145(.a(new_n159_), .O(new_n190_));
  nand4  g146(.a(new_n160_), .b(new_n190_), .c(new_n184_), .d(new_n130_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n189_), .c(new_n136_), .O(new_n192_));
  nand2  g148(.a(new_n89_), .b(x14), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(x17), .c(x16), .d(x15), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(x31), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x18), .O(new_n196_));
  xnor2a g152(.a(x31), .b(x30), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n176_), .c(new_n174_), .d(new_n172_), .O(new_n198_));
  inv1   g154(.a(new_n198_), .O(new_n199_));
  nand4  g155(.a(new_n199_), .b(new_n196_), .c(new_n170_), .d(new_n168_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(x33), .c(new_n192_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n188_), .O(new_n202_));
