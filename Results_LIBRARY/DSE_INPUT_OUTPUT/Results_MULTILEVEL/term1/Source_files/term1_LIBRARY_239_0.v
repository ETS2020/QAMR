...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n45_), .c(new_n47_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n81_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n45_), .c(new_n47_), .O(z4));
  ...
  nor2   g076(.a(new_n60_), .b(new_n45_), .O(new_n121_));
  ...
  nand3  g102(.a(new_n146_), .b(new_n46_), .c(x01), .O(new_n147_));
  ...
  nand4  g107(.a(new_n145_), .b(new_n46_), .c(x29), .d(x01), .O(new_n152_));
  ...
  aoi21  g130(.a(new_n146_), .b(new_n123_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n123_), .b(new_n104_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n145_), .c(new_n46_), .O(new_n177_));
  ...
  aoi21  g136(.a(new_n163_), .b(new_n160_), .c(new_n128_), .O(new_n181_));
  inv1   g137(.a(new_n166_), .O(new_n182_));
  nand4  g138(.a(new_n146_), .b(new_n123_), .c(new_n46_), .d(x01), .O(new_n183_));
  nand4  g139(.a(new_n145_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
