...
module FAU ( 
  ...
  nor2   g047(.a(new_n91_), .b(new_n54_), .O(new_n92_));
  ...
  oai21  g054(.a(new_n98_), .b(new_n61_), .c(new_n47_), .O(z4));
  inv1   g055(.a(new_n54_), .O(new_n100_));
  ...
  nand2  g068(.a(x30), .b(new_n102_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(x27), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n101_), .c(new_n100_), .d(new_n78_), .O(new_n115_));
  ...
  oai21  g075(.a(x31), .b(new_n119_), .c(new_n79_), .O(new_n120_));
  ...
  nand2  g086(.a(new_n103_), .b(new_n79_), .O(new_n131_));
  nand2  g087(.a(new_n119_), .b(x29), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n131_), .c(new_n113_), .O(new_n133_));
  ...
  nand2  g118(.a(new_n84_), .b(new_n162_), .O(new_n163_));
  aoi21  g119(.a(new_n119_), .b(new_n102_), .c(new_n126_), .O(new_n164_));
  ...
  aoi21  g131(.a(new_n126_), .b(new_n102_), .c(x30), .O(new_n176_));
