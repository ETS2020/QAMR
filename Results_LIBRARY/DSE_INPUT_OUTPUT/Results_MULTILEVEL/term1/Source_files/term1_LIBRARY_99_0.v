...
module FAU ( 
  ...
  nand3  g077(.a(new_n62_), .b(x25), .c(x01), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(x29), .c(x28), .d(x27), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x30), .c(new_n80_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n121_), .c(new_n119_), .O(z7));
  nand2  g083(.a(new_n104_), .b(new_n81_), .O(new_n128_));
  ...
  aoi21  g113(.a(new_n86_), .b(new_n157_), .c(new_n123_), .O(new_n158_));
  ...
  nand2  g122(.a(new_n86_), .b(new_n157_), .O(new_n167_));
  nor2   g123(.a(new_n123_), .b(new_n106_), .O(new_n168_));
  ...
  oai21  g129(.a(new_n166_), .b(new_n106_), .c(new_n173_), .O(new_n174_));
