...
module FAU ( 
  ...
  nand3  g042(.a(new_n86_), .b(new_n60_), .c(new_n46_), .O(new_n87_));
  ...
  nand4  g062(.a(new_n106_), .b(x28), .c(x27), .d(x13), .O(new_n107_));
  oai21  g063(.a(new_n99_), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x29), .O(new_n109_));
  nand2  g065(.a(x30), .b(new_n98_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n85_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n59_), .O(z6));
  inv1   g069(.a(x13), .O(new_n114_));
  oai21  g070(.a(x31), .b(new_n114_), .c(new_n106_), .O(new_n115_));
  nor4   g071(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n116_));
  ...
  aoi22  g080(.a(new_n124_), .b(x13), .c(new_n123_), .d(x30), .O(new_n125_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(x31), .d(x30), .O(new_n149_));
  oai21  g105(.a(new_n130_), .b(x30), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n129_), .O(new_n151_));
  nand2  g107(.a(x19), .b(new_n132_), .O(new_n152_));
  aoi21  g108(.a(new_n135_), .b(new_n152_), .c(new_n131_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n138_), .c(x16), .O(new_n154_));
  ...
  nand4  g113(.a(new_n157_), .b(new_n130_), .c(x31), .d(new_n106_), .O(new_n158_));
  oai21  g114(.a(new_n130_), .b(new_n106_), .c(new_n158_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n128_), .c(x29), .O(new_n160_));
  nand2  g116(.a(new_n134_), .b(x14), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(x18), .c(x17), .d(x16), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n146_), .O(new_n163_));
  nor2   g119(.a(new_n132_), .b(new_n131_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(x16), .c(x15), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n134_), .O(new_n166_));
  nand3  g122(.a(new_n164_), .b(x16), .c(x10), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n146_), .O(new_n168_));
  nand2  g124(.a(new_n164_), .b(x11), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n140_), .O(new_n170_));
  aoi21  g126(.a(x18), .b(x12), .c(x17), .O(new_n171_));
  oai21  g127(.a(x18), .b(x13), .c(x31), .O(new_n172_));
  ...
  nand3  g131(.a(new_n175_), .b(new_n160_), .c(new_n151_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n79_), .c(x00), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n46_), .O(z8));
  inv1   g134(.a(new_n163_), .O(new_n179_));
  nor2   g135(.a(new_n134_), .b(new_n131_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(x16), .c(x15), .O(new_n181_));
  nand2  g137(.a(x17), .b(x16), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n146_), .c(new_n134_), .O(new_n183_));
  inv1   g139(.a(x10), .O(new_n184_));
  oai21  g140(.a(new_n182_), .b(new_n184_), .c(new_n146_), .O(new_n185_));
  nand2  g141(.a(x17), .b(x11), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n140_), .O(new_n187_));
  inv1   g143(.a(x12), .O(new_n188_));
  nand2  g144(.a(new_n131_), .b(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n187_), .c(new_n185_), .d(new_n183_), .O(new_n190_));
  aoi21  g146(.a(new_n181_), .b(new_n132_), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n179_), .c(new_n45_), .O(new_n192_));
  nand2  g148(.a(new_n129_), .b(new_n121_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n106_), .c(x13), .O(new_n194_));
  oai21  g150(.a(x18), .b(x13), .c(new_n128_), .O(new_n195_));
  nand2  g151(.a(x31), .b(x29), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n195_), .c(x30), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n194_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n192_), .c(x33), .O(new_n199_));
  inv1   g155(.a(x33), .O(new_n200_));
  nand4  g156(.a(new_n157_), .b(new_n129_), .c(new_n121_), .d(new_n106_), .O(new_n201_));
  nor2   g157(.a(new_n127_), .b(new_n121_), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(x30), .c(x29), .d(x19), .O(new_n203_));
  nor2   g159(.a(new_n203_), .b(x18), .O(new_n204_));
  nand4  g160(.a(new_n204_), .b(x17), .c(x16), .d(x15), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n201_), .c(new_n114_), .O(new_n206_));
  nand3  g162(.a(x19), .b(new_n131_), .c(x12), .O(new_n207_));
  nand3  g163(.a(new_n134_), .b(x17), .c(x14), .O(new_n208_));
  aoi21  g164(.a(new_n208_), .b(new_n207_), .c(new_n140_), .O(new_n209_));
  nand3  g165(.a(new_n180_), .b(new_n140_), .c(x11), .O(new_n210_));
  inv1   g166(.a(new_n210_), .O(new_n211_));
  oai21  g167(.a(new_n211_), .b(new_n209_), .c(x15), .O(new_n212_));
  nand4  g168(.a(new_n180_), .b(x16), .c(new_n146_), .d(x10), .O(new_n213_));
  aoi21  g169(.a(new_n213_), .b(new_n212_), .c(new_n127_), .O(new_n214_));
  nand4  g170(.a(new_n214_), .b(x31), .c(x30), .d(x29), .O(new_n215_));
  nor2   g171(.a(new_n215_), .b(new_n132_), .O(new_n216_));
  oai21  g172(.a(new_n216_), .b(new_n206_), .c(new_n200_), .O(new_n217_));
  nand2  g173(.a(new_n217_), .b(new_n199_), .O(new_n218_));
