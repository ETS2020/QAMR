...
module FAU ( 
  ...
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n95_), .d(new_n46_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n91_), .c(new_n63_), .O(z5));
  inv1   g059(.a(x30), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x28), .c(x27), .O(new_n105_));
  oai21  g061(.a(new_n99_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n95_), .c(new_n46_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n63_), .c(new_n48_), .O(z6));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(x31), .d(new_n104_), .O(new_n146_));
