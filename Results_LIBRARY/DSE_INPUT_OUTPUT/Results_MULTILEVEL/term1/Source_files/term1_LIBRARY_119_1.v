...
module FAU ( 
  ...
  aoi21  g055(.a(new_n99_), .b(new_n97_), .c(new_n89_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n63_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n45_), .c(x26), .O(z5));
  nand3  g058(.a(new_n90_), .b(x29), .c(x28), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x27), .c(x25), .d(x01), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n45_), .c(x26), .O(z6));
  inv1   g062(.a(x26), .O(new_n107_));
  inv1   g063(.a(new_n85_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n84_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n87_), .c(new_n86_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n63_), .b(new_n111_), .c(x25), .d(x01), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n110_), .c(new_n45_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n107_), .O(z7));
  nand2  g070(.a(new_n96_), .b(new_n81_), .O(new_n115_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n115_), .c(new_n49_), .d(x31), .O(new_n134_));
  ...
  nor2   g103(.a(new_n111_), .b(new_n98_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n145_), .d(new_n115_), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  and2   g106(.a(new_n150_), .b(new_n143_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n141_), .c(new_n139_), .d(new_n136_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x32), .O(new_n153_));
  oai21  g109(.a(new_n134_), .b(new_n98_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x00), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n45_), .c(x26), .O(z8));
  nand2  g112(.a(new_n115_), .b(x29), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n133_), .c(new_n53_), .d(new_n111_), .O(new_n158_));
  aoi21  g114(.a(new_n117_), .b(new_n146_), .c(x31), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n157_), .c(new_n139_), .d(new_n136_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x33), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n158_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n45_), .c(new_n107_), .d(x00), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(z9));
endmodule
