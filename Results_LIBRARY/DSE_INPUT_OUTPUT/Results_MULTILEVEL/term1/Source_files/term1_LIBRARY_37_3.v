...
module FAU ( 
  ...
  nor3   g048(.a(new_n92_), .b(new_n88_), .c(new_n87_), .O(new_n93_));
  ...
  inv1   g053(.a(new_n88_), .O(new_n98_));
  oai21  g054(.a(new_n92_), .b(new_n87_), .c(new_n59_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n98_), .c(new_n62_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n97_), .c(new_n82_), .d(x25), .O(new_n101_));
  ...
  nand3  g072(.a(new_n116_), .b(new_n91_), .c(new_n114_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n113_), .c(x30), .O(new_n118_));
  nor2   g074(.a(new_n83_), .b(x17), .O(new_n119_));
  ...
  aoi21  g078(.a(new_n91_), .b(new_n86_), .c(x30), .O(new_n123_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n128_), .c(new_n86_), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n115_), .O(new_n131_));
  nand4  g087(.a(new_n63_), .b(new_n82_), .c(x25), .d(x01), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n59_), .O(new_n133_));
  inv1   g089(.a(new_n106_), .O(new_n134_));
  nand2  g090(.a(new_n113_), .b(x31), .O(new_n135_));
  inv1   g091(.a(x31), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x30), .c(x29), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n134_), .c(new_n135_), .O(new_n138_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n147_), .c(new_n59_), .O(new_n160_));
  nor2   g116(.a(x28), .b(x27), .O(new_n161_));
  nor3   g117(.a(new_n161_), .b(new_n46_), .c(new_n104_), .O(new_n162_));
  ...
  inv1   g127(.a(x18), .O(new_n172_));
  nand3  g128(.a(x19), .b(new_n172_), .c(x13), .O(new_n173_));
  nand3  g129(.a(new_n144_), .b(x18), .c(x14), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n173_), .c(new_n115_), .O(new_n175_));
  nand4  g131(.a(x19), .b(x18), .c(new_n115_), .d(x12), .O(new_n176_));
  ...
  nand4  g139(.a(new_n180_), .b(x16), .c(new_n143_), .d(x10), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n171_), .c(new_n168_), .d(x31), .O(new_n186_));
  ...
  nand2  g147(.a(x33), .b(new_n46_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n163_), .c(x29), .O(new_n194_));
  nand4  g150(.a(new_n185_), .b(new_n190_), .c(new_n136_), .d(new_n46_), .O(new_n195_));
  nand2  g151(.a(x33), .b(x30), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n164_), .O(new_n198_));
  inv1   g154(.a(new_n156_), .O(new_n199_));
  inv1   g155(.a(new_n157_), .O(new_n200_));
  ...
  nand4  g159(.a(new_n203_), .b(new_n155_), .c(new_n152_), .d(new_n150_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n147_), .c(x33), .O(new_n205_));
  nand3  g161(.a(new_n205_), .b(new_n198_), .c(new_n194_), .O(new_n206_));
  nand3  g162(.a(new_n206_), .b(new_n82_), .c(x00), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(new_n59_), .O(z9));
endmodule
