...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n61_), .c(new_n46_), .O(new_n95_));
  ...
  nand3  g073(.a(new_n117_), .b(x30), .c(x11), .O(new_n118_));
  inv1   g074(.a(x30), .O(new_n119_));
  nand3  g075(.a(new_n109_), .b(new_n119_), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n116_), .c(new_n59_), .O(z6));
  oai21  g079(.a(x31), .b(x30), .c(new_n45_), .O(new_n124_));
  nand3  g080(.a(new_n109_), .b(x30), .c(x29), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  nand4  g082(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n127_));
  nor2   g083(.a(new_n60_), .b(new_n59_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand4  g085(.a(new_n109_), .b(new_n129_), .c(x30), .d(x29), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n80_), .d(x25), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n126_), .d(new_n124_), .O(z7));
  nand2  g089(.a(new_n108_), .b(new_n81_), .O(new_n134_));
  ...
  nand4  g096(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(new_n136_), .O(new_n142_));
  ...
  nand4  g103(.a(new_n147_), .b(x16), .c(new_n146_), .d(x10), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n135_), .c(x31), .d(new_n119_), .O(new_n150_));
  nand2  g106(.a(x32), .b(x30), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n134_), .c(x29), .O(new_n153_));
  nand2  g109(.a(new_n134_), .b(x29), .O(new_n154_));
  nand4  g110(.a(x19), .b(x18), .c(x17), .d(new_n136_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n142_), .c(x15), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n148_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n135_), .c(x31), .d(x30), .O(new_n159_));
  nand2  g115(.a(x32), .b(new_n119_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n154_), .O(new_n162_));
  nand2  g118(.a(new_n91_), .b(x14), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x18), .c(x17), .d(x16), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n146_), .O(new_n165_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n167_), .c(new_n146_), .O(new_n170_));
  oai21  g126(.a(new_n167_), .b(new_n45_), .c(new_n136_), .O(new_n171_));
  ...
  nand4  g130(.a(new_n174_), .b(new_n171_), .c(new_n170_), .d(new_n168_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n165_), .c(x32), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n162_), .c(new_n153_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n80_), .c(x00), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n46_), .O(z8));
  inv1   g135(.a(x33), .O(new_n180_));
  nand4  g136(.a(new_n149_), .b(new_n180_), .c(new_n129_), .d(new_n119_), .O(new_n181_));
  nand2  g137(.a(x33), .b(x30), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n154_), .O(new_n184_));
  nand4  g140(.a(new_n158_), .b(new_n180_), .c(x31), .d(x30), .O(new_n185_));
  nand2  g141(.a(x33), .b(new_n119_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n134_), .c(x29), .O(new_n188_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n171_), .c(new_n170_), .d(new_n168_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n165_), .c(x33), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n188_), .c(new_n184_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n80_), .c(x00), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n46_), .O(z9));
endmodule
