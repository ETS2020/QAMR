...
module FAU ( 
  ...
  aoi21  g048(.a(new_n92_), .b(new_n46_), .c(new_n45_), .O(z3));
  ...
  nor4   g061(.a(new_n90_), .b(x30), .c(new_n99_), .d(new_n97_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n80_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n45_), .O(z6));
  ...
  oai21  g087(.a(new_n131_), .b(new_n118_), .c(new_n48_), .O(new_n132_));
  nor2   g088(.a(x28), .b(x27), .O(new_n133_));
  nor3   g089(.a(new_n133_), .b(new_n46_), .c(new_n99_), .O(new_n134_));
  inv1   g090(.a(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x29), .O(new_n136_));
  aoi22  g092(.a(new_n136_), .b(new_n46_), .c(new_n134_), .d(new_n45_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x32), .O(new_n139_));
  inv1   g095(.a(x32), .O(new_n140_));
  nand3  g096(.a(new_n136_), .b(x30), .c(new_n45_), .O(new_n141_));
  nand3  g097(.a(new_n135_), .b(new_n46_), .c(x29), .O(new_n142_));
  ...
  nand4  g119(.a(new_n158_), .b(new_n163_), .c(x31), .d(x30), .O(new_n164_));
  nand2  g120(.a(x33), .b(new_n46_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n135_), .c(x29), .O(new_n167_));
  nand4  g123(.a(new_n158_), .b(new_n163_), .c(new_n127_), .d(new_n46_), .O(new_n168_));
  ...
  inv1   g127(.a(new_n128_), .O(new_n172_));
  inv1   g128(.a(new_n129_), .O(new_n173_));
  xnor2a g129(.a(x31), .b(x30), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n172_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n126_), .c(new_n123_), .d(new_n121_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n118_), .c(x33), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n171_), .c(new_n167_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n80_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n48_), .O(z9));
endmodule
