...
module FAU ( 
  ...
  and2   g020(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  oai21  g021(.a(new_n65_), .b(x01), .c(new_n60_), .O(new_n66_));
  nand3  g022(.a(new_n66_), .b(new_n57_), .c(new_n46_), .O(new_n67_));
  ...
  aoi22  g027(.a(new_n71_), .b(new_n59_), .c(new_n63_), .d(new_n61_), .O(new_n72_));
  oai21  g028(.a(new_n72_), .b(x01), .c(new_n70_), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(new_n68_), .c(new_n46_), .O(new_n74_));
  ...
  nor2   g046(.a(new_n90_), .b(new_n58_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n78_), .c(x25), .d(x01), .O(new_n92_));
  aoi21  g048(.a(new_n92_), .b(x00), .c(x26), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n91_), .c(x25), .d(x01), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(x00), .c(x26), .O(z4));
  inv1   g052(.a(new_n58_), .O(new_n97_));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n101_), .c(new_n90_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n97_), .c(x25), .d(x01), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(x00), .c(x26), .O(z5));
  inv1   g062(.a(x30), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x28), .c(x27), .O(new_n108_));
  oai21  g064(.a(new_n99_), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x29), .O(new_n110_));
  nand2  g066(.a(x30), .b(new_n102_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n110_), .c(new_n90_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n97_), .c(x25), .d(x01), .O(new_n113_));
  ...
  inv1   g072(.a(new_n79_), .O(new_n117_));
  nand4  g073(.a(new_n88_), .b(new_n85_), .c(new_n82_), .d(new_n117_), .O(new_n118_));
  nand3  g074(.a(new_n97_), .b(x01), .c(x00), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  inv1   g076(.a(x25), .O(new_n121_));
  inv1   g077(.a(x26), .O(new_n122_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n120_), .c(new_n118_), .d(new_n116_), .O(z7));
  nand2  g083(.a(new_n98_), .b(new_n78_), .O(new_n128_));
  inv1   g084(.a(x32), .O(new_n129_));
  nand3  g085(.a(x19), .b(new_n83_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n86_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n80_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n80_), .d(x12), .O(new_n133_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n107_), .O(new_n145_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n86_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n160_), .c(new_n142_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n160_), .b(new_n164_), .c(new_n136_), .O(new_n165_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n153_), .c(new_n148_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n122_), .c(x00), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n144_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(x30), .c(new_n175_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n128_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n144_), .b(new_n174_), .c(new_n123_), .d(new_n107_), .O(new_n178_));
  oai21  g134(.a(new_n174_), .b(new_n107_), .c(new_n178_), .O(new_n179_));
  inv1   g135(.a(new_n166_), .O(new_n180_));
  inv1   g136(.a(new_n167_), .O(new_n181_));
  xnor2a g137(.a(x31), .b(x30), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n181_), .c(new_n180_), .d(new_n165_), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n163_), .c(new_n161_), .d(new_n157_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x00), .O(new_n187_));
  aoi21  g143(.a(new_n179_), .b(new_n149_), .c(new_n187_), .O(new_n188_));
