...
module FAU ( 
  ...
  oai21  g013(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n53_), .c(new_n49_), .O(z1));
  xnor2a g015(.a(x07), .b(x04), .O(new_n60_));
  inv1   g016(.a(new_n57_), .O(new_n61_));
  aoi21  g017(.a(new_n61_), .b(new_n55_), .c(new_n45_), .O(new_n62_));
  ...
  nor2   g027(.a(new_n51_), .b(new_n45_), .O(new_n72_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n55_), .c(new_n80_), .d(x25), .O(new_n104_));
  ...
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(new_n84_), .O(new_n112_));
  nand3  g068(.a(new_n55_), .b(x25), .c(x01), .O(new_n113_));
  nor4   g069(.a(new_n113_), .b(x31), .c(x30), .d(x26), .O(new_n114_));
  oai21  g070(.a(new_n112_), .b(new_n87_), .c(new_n114_), .O(z7));
  inv1   g071(.a(x15), .O(new_n116_));
  inv1   g072(.a(x19), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x14), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x18), .c(x17), .d(x16), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand2  g076(.a(x16), .b(x15), .O(new_n121_));
  nand2  g077(.a(x18), .b(x17), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(new_n117_), .O(new_n123_));
  nand2  g079(.a(x16), .b(x10), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(new_n116_), .O(new_n125_));
  inv1   g081(.a(x11), .O(new_n126_));
  inv1   g082(.a(x16), .O(new_n127_));
  oai21  g083(.a(new_n122_), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  aoi21  g085(.a(x18), .b(x12), .c(x17), .O(new_n130_));
  nor2   g086(.a(x18), .b(x13), .O(new_n131_));
  nor3   g087(.a(new_n131_), .b(new_n130_), .c(new_n129_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n128_), .c(new_n125_), .d(new_n123_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n120_), .c(new_n49_), .O(new_n134_));
  nand2  g090(.a(new_n99_), .b(new_n81_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x30), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n101_), .O(new_n137_));
  nand2  g093(.a(new_n135_), .b(x29), .O(new_n138_));
  aoi22  g094(.a(new_n138_), .b(new_n46_), .c(new_n137_), .d(new_n45_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x32), .O(new_n141_));
  nand3  g097(.a(new_n138_), .b(x30), .c(new_n45_), .O(new_n142_));
  nand3  g098(.a(new_n135_), .b(new_n46_), .c(x29), .O(new_n143_));
  ...
  nand3  g103(.a(new_n117_), .b(x18), .c(x14), .O(new_n148_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n127_), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x15), .O(new_n157_));
  nand4  g113(.a(new_n154_), .b(x16), .c(new_n116_), .d(x10), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n144_), .c(new_n50_), .d(x31), .O(new_n160_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n128_), .c(new_n125_), .d(new_n123_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n120_), .c(new_n49_), .O(new_n166_));
  nand2  g122(.a(new_n138_), .b(new_n129_), .O(new_n167_));
  nor2   g123(.a(new_n129_), .b(new_n101_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n135_), .c(new_n46_), .O(new_n169_));
  ...
  nand4  g128(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(x01), .c(new_n167_), .d(x30), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n159_), .c(new_n54_), .O(new_n175_));
