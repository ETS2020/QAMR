...
module FAU ( 
  ...
  nand2  g000(.a(x30), .b(x17), .O(new_n45_));
  ...
  nand2  g041(.a(new_n85_), .b(new_n45_), .O(new_n86_));
  inv1   g042(.a(x17), .O(new_n87_));
  inv1   g043(.a(x22), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(new_n86_), .c(new_n58_), .O(new_n90_));
  ...
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n78_), .d(x25), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n57_), .O(z4));
  ...
  nand3  g056(.a(new_n89_), .b(new_n84_), .c(new_n81_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(new_n59_), .d(new_n78_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x25), .c(x01), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n45_), .O(z5));
  nand3  g061(.a(x29), .b(x28), .c(x27), .O(new_n106_));
  nand3  g062(.a(new_n84_), .b(new_n81_), .c(x22), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n106_), .c(x30), .O(new_n108_));
  inv1   g064(.a(x30), .O(new_n109_));
  nor2   g065(.a(new_n79_), .b(x22), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n109_), .c(x29), .d(x28), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  aoi21  g069(.a(new_n84_), .b(new_n81_), .c(x30), .O(new_n114_));
  ...
  nor2   g073(.a(new_n117_), .b(new_n57_), .O(z6));
  inv1   g074(.a(new_n82_), .O(new_n119_));
  inv1   g075(.a(new_n83_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n119_), .c(new_n81_), .O(new_n121_));
  ...
  nand2  g081(.a(new_n106_), .b(x31), .O(new_n126_));
  ...
  oai21  g086(.a(new_n121_), .b(new_n87_), .c(new_n127_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n109_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n124_), .O(z7));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n139_), .c(new_n87_), .O(new_n142_));
  nand2  g098(.a(new_n87_), .b(x12), .O(new_n143_));
  nand3  g099(.a(new_n109_), .b(x19), .c(x18), .O(new_n144_));
  ...
  aoi21  g106(.a(new_n150_), .b(new_n146_), .c(new_n137_), .O(new_n151_));
  nand3  g107(.a(x16), .b(new_n137_), .c(x10), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(new_n136_), .O(new_n154_));
  ...
  nor2   g113(.a(new_n134_), .b(new_n96_), .O(new_n158_));
  oai21  g114(.a(new_n109_), .b(x17), .c(x32), .O(new_n159_));
  nand4  g115(.a(x18), .b(x16), .c(x15), .d(x12), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nor2   g117(.a(new_n109_), .b(new_n140_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n161_), .c(new_n136_), .d(x31), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n159_), .c(new_n158_), .O(new_n164_));
  aoi21  g120(.a(new_n140_), .b(x14), .c(new_n138_), .O(new_n165_));
  ...
  oai21  g126(.a(new_n170_), .b(new_n168_), .c(new_n137_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  oai21  g128(.a(new_n168_), .b(new_n172_), .c(new_n147_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x12), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n87_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  nand2  g132(.a(new_n138_), .b(new_n176_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n175_), .c(new_n173_), .d(x31), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n171_), .c(new_n169_), .d(new_n166_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(x32), .c(new_n164_), .O(new_n181_));
  ...
  oai21  g142(.a(new_n153_), .b(new_n151_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(x33), .b(x30), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(x31), .c(new_n188_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  oai21  g146(.a(new_n109_), .b(x17), .c(x33), .O(new_n191_));
  nand3  g147(.a(new_n162_), .b(new_n186_), .c(x31), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n160_), .c(new_n191_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n135_), .c(x29), .O(new_n194_));
  nand3  g150(.a(new_n165_), .b(x16), .c(x15), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n127_), .c(new_n87_), .O(new_n196_));
  xnor2a g152(.a(x31), .b(x30), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n177_), .c(new_n175_), .d(new_n173_), .O(new_n198_));
  inv1   g154(.a(new_n198_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n171_), .c(new_n169_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n196_), .c(x33), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n194_), .c(new_n190_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n78_), .c(x00), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n45_), .O(z9));
endmodule
