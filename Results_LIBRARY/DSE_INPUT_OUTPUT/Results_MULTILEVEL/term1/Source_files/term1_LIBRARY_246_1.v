...
module FAU ( 
  ...
  oai21  g043(.a(new_n87_), .b(new_n59_), .c(new_n57_), .O(z3));
  ...
  nor3   g055(.a(new_n99_), .b(new_n92_), .c(new_n59_), .O(z5));
  ...
  oai21  g063(.a(new_n107_), .b(new_n59_), .c(new_n57_), .O(z6));
  ...
  nand3  g122(.a(new_n166_), .b(new_n45_), .c(x00), .O(new_n167_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n57_), .O(z9));
endmodule
