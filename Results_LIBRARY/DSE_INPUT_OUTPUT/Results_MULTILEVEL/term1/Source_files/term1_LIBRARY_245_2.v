...
module FAU ( 
  ...
  nand3  g064(.a(new_n102_), .b(new_n45_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n94_), .c(new_n60_), .d(x25), .O(new_n111_));
  ...
  nand4  g070(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n115_));
  ...
  nand2  g078(.a(new_n101_), .b(new_n81_), .O(new_n123_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n124_), .c(x31), .d(new_n45_), .O(new_n140_));
  ...
  nand2  g104(.a(new_n91_), .b(x14), .O(new_n149_));
  ...
  nand4  g127(.a(new_n139_), .b(new_n167_), .c(new_n118_), .d(new_n45_), .O(new_n172_));
