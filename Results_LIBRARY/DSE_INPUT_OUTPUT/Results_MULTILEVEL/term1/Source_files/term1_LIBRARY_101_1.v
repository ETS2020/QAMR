...
module FAU ( 
  ...
  nand3  g054(.a(new_n98_), .b(new_n93_), .c(new_n80_), .O(new_n99_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n60_), .d(new_n80_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n45_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z5));
  nand3  g067(.a(new_n93_), .b(x29), .c(x28), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x27), .c(x25), .d(x01), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n80_), .c(x26), .O(z6));
  nand3  g071(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n116_));
  nand3  g072(.a(new_n60_), .b(x25), .c(x01), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(x31), .c(x30), .d(x26), .O(new_n118_));
  oai21  g074(.a(new_n116_), .b(new_n90_), .c(new_n118_), .O(z7));
  inv1   g075(.a(x32), .O(new_n120_));
  nand2  g076(.a(new_n103_), .b(new_n79_), .O(new_n121_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n121_), .c(new_n120_), .d(x31), .O(new_n138_));
  aoi21  g094(.a(new_n123_), .b(x14), .c(new_n87_), .O(new_n139_));
  ...
  nand2  g106(.a(new_n87_), .b(new_n150_), .O(new_n151_));
  inv1   g107(.a(x31), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n105_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n151_), .c(new_n149_), .d(new_n121_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  and2   g111(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n145_), .c(new_n143_), .d(new_n140_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  oai21  g114(.a(new_n138_), .b(new_n105_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x00), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n80_), .c(x26), .O(z8));
  inv1   g117(.a(x33), .O(new_n162_));
  nand2  g118(.a(new_n121_), .b(x29), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n137_), .c(new_n162_), .d(new_n152_), .O(new_n164_));
  aoi21  g120(.a(new_n87_), .b(new_n150_), .c(x31), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n163_), .c(new_n143_), .d(new_n140_), .O(new_n168_));
  ...
  aoi21  g127(.a(new_n171_), .b(new_n80_), .c(x26), .O(z9));
endmodule
