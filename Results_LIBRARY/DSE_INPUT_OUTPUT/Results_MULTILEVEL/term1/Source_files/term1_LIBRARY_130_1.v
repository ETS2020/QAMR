...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n63_), .c(new_n47_), .O(z3));
  ...
  nand4  g066(.a(new_n110_), .b(new_n95_), .c(new_n81_), .d(x25), .O(new_n111_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n81_), .O(new_n123_));
  ...
  nand4  g133(.a(new_n145_), .b(new_n173_), .c(new_n121_), .d(new_n45_), .O(new_n178_));
