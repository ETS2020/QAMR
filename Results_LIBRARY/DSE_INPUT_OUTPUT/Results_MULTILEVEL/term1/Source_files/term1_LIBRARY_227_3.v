...
module FAU ( 
  ...
  aoi21  g046(.a(new_n45_), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(new_n86_), .O(new_n92_));
  and2   g048(.a(new_n92_), .b(new_n63_), .O(new_n93_));
  ...
  nor2   g056(.a(new_n100_), .b(new_n83_), .O(new_n101_));
  nand3  g057(.a(new_n99_), .b(x28), .c(x27), .O(new_n102_));
  oai21  g058(.a(new_n101_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n92_), .c(new_n63_), .d(new_n82_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x25), .c(x01), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n59_), .O(z5));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  inv1   g064(.a(new_n85_), .O(new_n109_));
  nor2   g065(.a(new_n84_), .b(new_n89_), .O(new_n110_));
  nor2   g066(.a(new_n90_), .b(new_n87_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n108_), .c(x30), .O(new_n113_));
  nor2   g069(.a(new_n83_), .b(x19), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n46_), .c(x29), .d(x28), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n45_), .O(new_n117_));
  aoi21  g073(.a(new_n111_), .b(new_n86_), .c(x30), .O(new_n118_));
  ...
  nand3  g079(.a(new_n123_), .b(new_n88_), .c(new_n86_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n89_), .O(new_n125_));
  nand4  g081(.a(new_n63_), .b(new_n82_), .c(x25), .d(x01), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n125_), .c(new_n59_), .O(new_n127_));
  inv1   g083(.a(new_n101_), .O(new_n128_));
  nand2  g084(.a(new_n108_), .b(x31), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x30), .c(x29), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n128_), .c(new_n129_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n45_), .O(new_n133_));
  oai21  g089(.a(new_n124_), .b(new_n45_), .c(new_n130_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n46_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n127_), .O(z7));
  nand2  g092(.a(new_n100_), .b(new_n83_), .O(new_n137_));
  ...
  nand3  g097(.a(new_n89_), .b(x18), .c(x14), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n141_), .c(new_n139_), .O(new_n143_));
  nand4  g099(.a(x19), .b(x18), .c(new_n139_), .d(x12), .O(new_n144_));
  ...
  nand3  g105(.a(new_n149_), .b(new_n147_), .c(x11), .O(new_n150_));
  ...
  nand4  g111(.a(new_n155_), .b(new_n138_), .c(x31), .d(new_n46_), .O(new_n156_));
  nand2  g112(.a(x32), .b(x30), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n137_), .c(x29), .O(new_n159_));
  nand2  g115(.a(new_n137_), .b(x29), .O(new_n160_));
  nand4  g116(.a(new_n155_), .b(new_n138_), .c(x31), .d(x30), .O(new_n161_));
  ...
  nand2  g120(.a(new_n89_), .b(x14), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x18), .c(x17), .d(x16), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n153_), .O(new_n167_));
  nand2  g123(.a(x16), .b(x15), .O(new_n168_));
  nand2  g124(.a(x18), .b(x17), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n168_), .c(new_n89_), .O(new_n170_));
  nand2  g126(.a(x16), .b(x10), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(new_n153_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n169_), .b(new_n173_), .c(new_n147_), .O(new_n174_));
  aoi21  g130(.a(x18), .b(x12), .c(x17), .O(new_n175_));
  nor2   g131(.a(x18), .b(x13), .O(new_n176_));
  nor3   g132(.a(new_n176_), .b(new_n175_), .c(new_n130_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n174_), .c(new_n172_), .d(new_n170_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n167_), .c(x32), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n164_), .c(new_n159_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n82_), .c(x00), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n59_), .O(z8));
  nor2   g138(.a(new_n176_), .b(new_n175_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n174_), .c(new_n172_), .d(new_n170_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n167_), .c(new_n59_), .O(new_n185_));
  nand2  g141(.a(new_n160_), .b(new_n130_), .O(new_n186_));
  nor2   g142(.a(new_n130_), .b(new_n99_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n137_), .c(new_n46_), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(new_n45_), .c(new_n186_), .d(new_n46_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand4  g147(.a(new_n137_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
  oai22  g148(.a(new_n192_), .b(x24), .c(new_n186_), .d(x30), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n155_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(x33), .c(new_n191_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n82_), .c(x00), .O(new_n196_));
