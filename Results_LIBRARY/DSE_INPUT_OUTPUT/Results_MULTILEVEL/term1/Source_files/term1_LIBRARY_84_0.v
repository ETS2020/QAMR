...
module FAU ( 
  ...
  nand3  g045(.a(new_n89_), .b(new_n59_), .c(new_n56_), .O(new_n90_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n89_), .c(new_n59_), .d(new_n78_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n56_), .O(z5));
  ...
  nand4  g072(.a(new_n116_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n58_), .c(new_n56_), .O(z6));
  inv1   g074(.a(x31), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(x05), .c(x30), .O(new_n120_));
  nand2  g076(.a(new_n85_), .b(new_n82_), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n87_), .c(new_n86_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n103_), .b(new_n119_), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nor2   g084(.a(new_n119_), .b(x30), .O(new_n129_));
  aoi22  g085(.a(new_n129_), .b(x05), .c(new_n128_), .d(x30), .O(new_n130_));
  oai21  g086(.a(new_n124_), .b(new_n120_), .c(new_n130_), .O(z7));
  ...
  nor3   g102(.a(new_n146_), .b(new_n145_), .c(new_n119_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n144_), .c(new_n141_), .d(new_n139_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n136_), .c(new_n56_), .O(new_n149_));
  nand2  g105(.a(new_n102_), .b(new_n79_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x29), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n111_), .c(x05), .O(new_n152_));
  ...
  nand4  g112(.a(new_n150_), .b(new_n111_), .c(x29), .d(x05), .O(new_n157_));
  nand2  g113(.a(new_n151_), .b(x30), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  inv1   g115(.a(x18), .O(new_n160_));
  nand3  g116(.a(x19), .b(new_n160_), .c(x13), .O(new_n161_));
  nand3  g117(.a(new_n133_), .b(x18), .c(x14), .O(new_n162_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n143_), .c(x11), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x15), .O(new_n171_));
  nand4  g127(.a(new_n168_), .b(x16), .c(new_n132_), .d(x10), .O(new_n172_));
  ...
  nor2   g133(.a(new_n146_), .b(new_n145_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n144_), .c(new_n141_), .d(new_n139_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n136_), .c(new_n56_), .O(new_n180_));
  aoi21  g136(.a(new_n151_), .b(new_n119_), .c(x30), .O(new_n181_));
  nor2   g137(.a(new_n119_), .b(new_n101_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n150_), .c(new_n111_), .O(new_n183_));
  aoi21  g139(.a(new_n181_), .b(x05), .c(new_n183_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  aoi21  g142(.a(new_n169_), .b(new_n166_), .c(new_n132_), .O(new_n187_));
  inv1   g143(.a(new_n172_), .O(new_n188_));
  nand4  g144(.a(new_n151_), .b(new_n119_), .c(new_n111_), .d(x05), .O(new_n189_));
  nand4  g145(.a(new_n150_), .b(x31), .c(x30), .d(x29), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  oai21  g147(.a(new_n188_), .b(new_n187_), .c(new_n191_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(x33), .c(new_n186_), .O(new_n193_));
