...
module FAU ( 
  ...
  nor2   g057(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  oai21  g058(.a(x30), .b(x29), .c(new_n102_), .O(new_n103_));
  inv1   g059(.a(new_n93_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n45_), .c(x28), .d(x27), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n59_), .c(new_n46_), .O(z5));
  ...
  nand3  g077(.a(new_n101_), .b(new_n121_), .c(x30), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n80_), .c(x25), .O(new_n123_));
  nor3   g079(.a(new_n123_), .b(new_n60_), .c(new_n59_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n120_), .c(new_n118_), .d(new_n116_), .O(z7));
  inv1   g081(.a(x15), .O(new_n126_));
  aoi21  g082(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x17), .c(x16), .O(new_n128_));
  ...
  nand2  g095(.a(new_n86_), .b(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x31), .O(new_n141_));
  aoi21  g097(.a(new_n138_), .b(new_n83_), .c(new_n141_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n129_), .c(new_n46_), .O(new_n144_));
  nor2   g100(.a(x28), .b(x27), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x30), .c(x29), .O(new_n147_));
  oai21  g103(.a(new_n145_), .b(new_n45_), .c(new_n109_), .O(new_n148_));
  ...
  nand3  g107(.a(x30), .b(new_n100_), .c(new_n81_), .O(new_n152_));
  oai21  g108(.a(new_n145_), .b(x30), .c(new_n152_), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n86_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n89_), .b(x18), .c(x14), .O(new_n155_));
  ...
  nand3  g120(.a(x16), .b(new_n126_), .c(x10), .O(new_n165_));
  ...
  nand4  g124(.a(new_n168_), .b(new_n153_), .c(new_n151_), .d(x31), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n45_), .c(new_n150_), .O(new_n170_));
  ...
  nand3  g130(.a(x33), .b(new_n109_), .c(x29), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n146_), .O(new_n177_));
  aoi21  g133(.a(new_n162_), .b(new_n159_), .c(new_n126_), .O(new_n178_));
  nand3  g134(.a(new_n109_), .b(new_n100_), .c(new_n81_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x29), .O(new_n180_));
  oai21  g136(.a(new_n166_), .b(new_n178_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(x33), .b(x30), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(x33), .c(new_n182_), .O(new_n183_));
  inv1   g139(.a(new_n129_), .O(new_n184_));
  nand2  g140(.a(new_n138_), .b(new_n83_), .O(new_n185_));
  nand2  g141(.a(x31), .b(new_n109_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n152_), .c(new_n140_), .d(new_n185_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  and2   g144(.a(new_n188_), .b(new_n137_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n134_), .c(new_n132_), .d(new_n184_), .O(new_n190_));
  and2   g146(.a(new_n190_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n183_), .b(new_n121_), .c(new_n191_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n177_), .O(new_n193_));
