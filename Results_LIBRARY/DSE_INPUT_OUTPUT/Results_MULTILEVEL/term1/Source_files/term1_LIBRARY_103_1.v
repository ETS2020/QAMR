...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n62_), .c(new_n80_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n87_), .c(new_n45_), .d(x25), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n62_), .c(new_n80_), .O(z4));
  ...
  nand2  g126(.a(new_n170_), .b(new_n80_), .O(z8));
  ...
  nand2  g145(.a(new_n189_), .b(new_n80_), .O(z9));
endmodule
