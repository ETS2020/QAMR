...
module FAU ( 
  ...
  nor2   g066(.a(new_n110_), .b(new_n59_), .O(z6));
  ...
  nand4  g107(.a(new_n151_), .b(new_n133_), .c(x31), .d(new_n104_), .O(new_n152_));
  ...
  nand2  g113(.a(x32), .b(new_n104_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nor2   g116(.a(new_n135_), .b(new_n134_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n127_), .c(x19), .O(new_n162_));
  nand3  g118(.a(new_n161_), .b(x16), .c(x10), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n149_), .O(new_n164_));
  nand2  g120(.a(new_n161_), .b(x11), .O(new_n165_));
  ...
  nor2   g125(.a(new_n144_), .b(new_n126_), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n169_), .c(new_n119_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n162_), .c(x32), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n160_), .c(new_n155_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n81_), .c(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n131_), .O(z8));
  nand3  g132(.a(x33), .b(x18), .c(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n128_), .c(new_n81_), .O(new_n178_));
  ...
  nand2  g137(.a(x33), .b(new_n104_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n132_), .c(x29), .O(new_n184_));
  nand4  g140(.a(new_n151_), .b(new_n180_), .c(new_n119_), .d(new_n104_), .O(new_n185_));
  ...
  nor3   g145(.a(new_n189_), .b(new_n170_), .c(new_n169_), .O(new_n190_));
  ...
  nand3  g148(.a(new_n192_), .b(new_n188_), .c(new_n184_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n81_), .c(x00), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n179_), .O(z9));
endmodule
