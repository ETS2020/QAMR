...
module FAU ( 
  ...
  aoi21  g11(.a(new_n55_), .b(new_n51_), .c(new_n46_), .O(new_n56_));
  ...
  nand4  g46(.a(new_n90_), .b(new_n52_), .c(new_n82_), .d(new_n81_), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(x25), .c(x01), .d(new_n45_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(z3));
  nand3  g50(.a(x28), .b(new_n82_), .c(new_n45_), .O(new_n95_));
  inv1   g51(.a(x28), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(x27), .O(new_n97_));
  aoi22  g53(.a(new_n97_), .b(new_n95_), .c(new_n89_), .d(new_n85_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n52_), .c(x25), .d(x01), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g56(.a(x29), .O(new_n101_));
  nor2   g57(.a(new_n96_), .b(new_n82_), .O(new_n102_));
  nand3  g58(.a(new_n101_), .b(x28), .c(x27), .O(new_n103_));
  oai21  g59(.a(new_n102_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n90_), .c(new_n52_), .d(new_n81_), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(x25), .c(x01), .d(new_n45_), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(z5));
  nand3  g64(.a(x29), .b(x28), .c(x27), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x30), .O(new_n110_));
  nor2   g66(.a(x30), .b(new_n101_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n102_), .O(new_n112_));
  aoi22  g68(.a(new_n112_), .b(new_n110_), .c(new_n89_), .d(new_n85_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n52_), .c(x25), .d(x01), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g71(.a(new_n102_), .b(x30), .c(x29), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(x31), .O(new_n117_));
  inv1   g73(.a(new_n87_), .O(new_n118_));
  inv1   g74(.a(new_n88_), .O(new_n119_));
  nor3   g75(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n120_));
  ...
  aoi21  g82(.a(new_n126_), .b(new_n102_), .c(new_n123_), .O(new_n127_));
