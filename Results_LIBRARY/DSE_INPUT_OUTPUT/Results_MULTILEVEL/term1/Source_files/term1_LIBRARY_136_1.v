...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n85_), .c(new_n83_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n60_), .c(new_n81_), .d(new_n80_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n79_), .c(new_n58_), .O(z3));
  nand2  g051(.a(x28), .b(new_n81_), .O(new_n96_));
  inv1   g052(.a(x28), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x27), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g055(.a(new_n92_), .b(new_n83_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  oai21  g057(.a(new_n96_), .b(new_n85_), .c(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n60_), .c(new_n80_), .O(new_n103_));
  nor2   g059(.a(new_n59_), .b(x28), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x27), .c(new_n45_), .d(new_n84_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n46_), .O(z4));
  inv1   g064(.a(x29), .O(new_n109_));
  nor2   g065(.a(new_n97_), .b(new_n81_), .O(new_n110_));
  nand3  g066(.a(new_n109_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n93_), .c(new_n60_), .d(new_n80_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n79_), .c(new_n58_), .O(z5));
  inv1   g070(.a(new_n110_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n93_), .c(x30), .O(new_n116_));
  inv1   g072(.a(x30), .O(new_n117_));
  nand4  g073(.a(new_n100_), .b(new_n117_), .c(x28), .d(x27), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n109_), .O(new_n119_));
  nand2  g075(.a(new_n100_), .b(x30), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(x29), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n119_), .c(new_n80_), .O(new_n122_));
  nand3  g078(.a(new_n110_), .b(new_n117_), .c(x29), .O(new_n123_));
  oai21  g079(.a(new_n117_), .b(x29), .c(new_n123_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n45_), .c(new_n84_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n60_), .c(x25), .d(x01), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n46_), .O(z6));
  nand3  g084(.a(new_n110_), .b(x30), .c(x29), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x31), .O(new_n130_));
  nand3  g086(.a(new_n91_), .b(new_n88_), .c(new_n83_), .O(new_n131_));
  ...
  aoi21  g093(.a(new_n137_), .b(new_n110_), .c(new_n79_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n134_), .c(new_n133_), .d(new_n130_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n80_), .O(new_n140_));
  oai21  g096(.a(new_n132_), .b(x26), .c(x22), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(z7));
  nand2  g098(.a(new_n97_), .b(new_n81_), .O(new_n143_));
  inv1   g099(.a(x32), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n86_), .c(x13), .O(new_n145_));
  nand3  g101(.a(new_n89_), .b(x18), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n84_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n148_));
  ...
  nand4  g115(.a(new_n159_), .b(new_n144_), .c(x31), .d(new_n117_), .O(new_n160_));
  ...
  nand2  g121(.a(x32), .b(new_n117_), .O(new_n166_));
  ...
  nand4  g143(.a(new_n159_), .b(new_n187_), .c(x31), .d(x30), .O(new_n188_));
  nand2  g144(.a(x33), .b(new_n117_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n143_), .c(x29), .O(new_n191_));
  nand4  g147(.a(new_n159_), .b(new_n187_), .c(new_n135_), .d(new_n117_), .O(new_n192_));
  nand2  g148(.a(x33), .b(x30), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n164_), .O(new_n195_));
  inv1   g151(.a(new_n179_), .O(new_n196_));
  inv1   g152(.a(new_n180_), .O(new_n197_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n178_), .c(new_n176_), .d(new_n174_), .O(new_n201_));
  oai21  g157(.a(new_n201_), .b(new_n171_), .c(x33), .O(new_n202_));
