...
module FAU ( 
  ...
  nand4  g041(.a(new_n85_), .b(new_n79_), .c(new_n45_), .d(x25), .O(new_n86_));
  oai21  g042(.a(new_n86_), .b(new_n61_), .c(new_n48_), .O(z3));
  inv1   g043(.a(x25), .O(new_n88_));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n85_), .c(new_n45_), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n88_), .c(new_n61_), .O(z4));
  ...
  nor3   g055(.a(new_n99_), .b(new_n88_), .c(new_n61_), .O(z5));
  ...
  nor2   g075(.a(new_n119_), .b(new_n88_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n115_), .c(new_n114_), .d(new_n110_), .O(z7));
  nand2  g077(.a(new_n95_), .b(new_n79_), .O(new_n122_));
  ...
  nand4  g123(.a(new_n140_), .b(new_n52_), .c(x31), .d(x30), .O(new_n168_));
  ...
  nand4  g127(.a(new_n140_), .b(new_n52_), .c(new_n117_), .d(new_n101_), .O(new_n172_));
