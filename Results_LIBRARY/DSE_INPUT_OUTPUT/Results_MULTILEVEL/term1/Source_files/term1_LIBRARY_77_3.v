...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n62_), .c(new_n49_), .O(z4));
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n63_), .d(new_n46_), .O(new_n99_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n63_), .c(new_n46_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n62_), .c(new_n49_), .O(z6));
  ...
  nor2   g072(.a(new_n57_), .b(new_n62_), .O(new_n117_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n50_), .c(x31), .d(new_n103_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n143_), .b(new_n50_), .c(x31), .d(x30), .O(new_n149_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n129_), .O(new_n160_));
  ...
  nand4  g128(.a(new_n143_), .b(new_n54_), .c(x31), .d(x30), .O(new_n173_));
  oai21  g129(.a(new_n54_), .b(x30), .c(new_n173_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n125_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n143_), .b(new_n54_), .c(new_n120_), .d(new_n103_), .O(new_n176_));
  oai21  g132(.a(new_n54_), .b(new_n103_), .c(new_n176_), .O(new_n177_));
