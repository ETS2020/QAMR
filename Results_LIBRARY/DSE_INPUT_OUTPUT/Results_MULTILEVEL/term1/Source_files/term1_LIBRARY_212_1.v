...
module FAU ( 
  ...
  oai21  g046(.a(new_n90_), .b(new_n61_), .c(new_n46_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n89_), .c(new_n82_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n61_), .c(new_n46_), .O(z4));
  ...
  oai21  g067(.a(new_n111_), .b(new_n61_), .c(new_n46_), .O(z6));
  ...
  nand3  g074(.a(new_n63_), .b(x25), .c(x01), .O(new_n119_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n46_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(x26), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n120_), .c(new_n118_), .d(new_n114_), .O(z7));
  nand2  g082(.a(new_n97_), .b(new_n83_), .O(new_n127_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n49_), .c(x31), .d(new_n105_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n145_), .b(new_n49_), .c(x31), .d(x30), .O(new_n151_));
  ...
  nand4  g126(.a(new_n170_), .b(new_n46_), .c(new_n82_), .d(x00), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(z8));
  nand4  g128(.a(new_n145_), .b(new_n57_), .c(x31), .d(x30), .O(new_n173_));
  nand3  g129(.a(x33), .b(new_n105_), .c(x06), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n127_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n145_), .b(new_n57_), .c(new_n122_), .d(new_n105_), .O(new_n177_));
  nand3  g133(.a(x33), .b(x30), .c(x06), .O(new_n178_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n164_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n162_), .c(new_n160_), .d(new_n181_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(x33), .c(x06), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n180_), .c(new_n176_), .O(new_n189_));
