...
module FAU ( 
  ...
  oai22  g126(.a(new_n170_), .b(new_n153_), .c(new_n101_), .d(new_n45_), .O(new_n171_));
  nand2  g127(.a(new_n146_), .b(new_n117_), .O(new_n172_));
  nor2   g128(.a(new_n117_), .b(new_n94_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n122_), .c(new_n101_), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(new_n45_), .c(new_n172_), .d(new_n101_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  nand4  g133(.a(new_n122_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  oai22  g134(.a(new_n178_), .b(x26), .c(new_n172_), .d(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n141_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(x33), .c(new_n177_), .O(new_n181_));
