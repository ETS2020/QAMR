...
module FAU ( 
  ...
  and2   g43(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n80_), .c(x25), .d(x01), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n45_), .c(x26), .O(z3));
  xor2a  g46(.a(x28), .b(x27), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n88_), .c(x25), .d(x01), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g49(.a(x26), .O(new_n94_));
  inv1   g50(.a(x29), .O(new_n95_));
  nand2  g51(.a(x28), .b(x27), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  nand3  g53(.a(new_n95_), .b(x28), .c(x27), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(new_n95_), .c(new_n98_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n87_), .c(new_n61_), .d(new_n94_), .O(new_n100_));
  inv1   g56(.a(new_n100_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(x25), .c(x01), .d(new_n45_), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(z5));
  nand3  g59(.a(x29), .b(x28), .c(x27), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(x30), .O(new_n105_));
  inv1   g61(.a(x30), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(x29), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n96_), .c(new_n105_), .O(new_n108_));
  and2   g64(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n61_), .c(x25), .d(x01), .O(new_n110_));
  ...
  nand4  g69(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n114_));
  nand3  g70(.a(new_n61_), .b(x01), .c(new_n45_), .O(new_n115_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n96_), .c(new_n94_), .O(new_n120_));
  nor2   g76(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n116_), .c(new_n114_), .d(new_n113_), .O(z7));
  zero   g78(.O(z8));
endmodule
