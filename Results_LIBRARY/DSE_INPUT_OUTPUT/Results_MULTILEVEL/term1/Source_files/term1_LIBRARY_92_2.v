...
module FAU ( 
  ...
  nor4   g047(.a(new_n91_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n92_));
  ...
  aoi21  g058(.a(new_n102_), .b(new_n100_), .c(new_n92_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n63_), .c(x25), .d(x01), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n45_), .c(x26), .O(z5));
  nor2   g061(.a(new_n99_), .b(new_n81_), .O(new_n106_));
  nor2   g062(.a(new_n84_), .b(new_n83_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n91_), .c(x19), .O(new_n109_));
  nand2  g065(.a(x29), .b(new_n82_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n106_), .O(new_n111_));
  nor2   g067(.a(new_n92_), .b(x29), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(x30), .O(new_n113_));
  nor2   g069(.a(new_n92_), .b(x30), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(x29), .c(x28), .d(x27), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n63_), .c(x25), .d(x01), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n45_), .c(x26), .O(z6));
  inv1   g074(.a(x26), .O(new_n119_));
  nand3  g075(.a(new_n106_), .b(x30), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  nand4  g077(.a(new_n107_), .b(new_n90_), .c(new_n87_), .d(x19), .O(new_n122_));
  nor2   g078(.a(new_n56_), .b(new_n62_), .O(new_n123_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n106_), .c(new_n124_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n119_), .O(z7));
  nand2  g087(.a(new_n99_), .b(new_n81_), .O(new_n132_));
  inv1   g088(.a(x30), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n88_), .c(x13), .O(new_n134_));
  nand3  g090(.a(new_n82_), .b(x18), .c(x14), .O(new_n135_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n49_), .c(x31), .d(new_n133_), .O(new_n149_));
  ...
  nand4  g109(.a(new_n148_), .b(new_n49_), .c(x31), .d(x30), .O(new_n154_));
  nand2  g110(.a(x32), .b(new_n133_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g113(.a(new_n82_), .b(x14), .O(new_n158_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n82_), .O(new_n163_));
  ...
  aoi21  g130(.a(new_n174_), .b(new_n45_), .c(x26), .O(z8));
  nand4  g131(.a(new_n148_), .b(new_n53_), .c(x31), .d(x30), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n133_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n132_), .c(x29), .O(new_n179_));
  nand4  g135(.a(new_n148_), .b(new_n53_), .c(new_n125_), .d(new_n133_), .O(new_n180_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n119_), .c(new_n45_), .d(x00), .O(new_n192_));
