...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n62_), .c(new_n81_), .d(new_n46_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(x25), .c(x14), .d(x01), .O(new_n97_));
  ...
  nand4  g057(.a(new_n101_), .b(x25), .c(x14), .d(x01), .O(new_n102_));
  ...
  aoi21  g065(.a(new_n109_), .b(x14), .c(x26), .O(z5));
  ...
  nand4  g072(.a(new_n116_), .b(new_n94_), .c(new_n62_), .d(new_n46_), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x25), .c(x14), .d(x01), .O(new_n119_));
  ...
  nand2  g092(.a(new_n89_), .b(x18), .O(new_n137_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n135_), .c(x31), .d(new_n113_), .O(new_n151_));
  ...
  nor2   g117(.a(new_n86_), .b(new_n83_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(x19), .O(new_n163_));
  nand3  g119(.a(new_n162_), .b(x16), .c(x10), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n148_), .O(new_n165_));
  nand2  g121(.a(new_n162_), .b(x11), .O(new_n166_));
  ...
  nor2   g126(.a(new_n160_), .b(new_n143_), .O(new_n171_));
  ...
  aoi21  g132(.a(new_n176_), .b(x14), .c(x26), .O(z8));
  ...
  nand4  g138(.a(new_n150_), .b(new_n178_), .c(new_n127_), .d(new_n113_), .O(new_n183_));
  ...
  nor3   g143(.a(new_n187_), .b(new_n171_), .c(new_n170_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n163_), .c(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n186_), .c(new_n182_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x00), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(x14), .c(x26), .O(z9));
endmodule
