...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n82_), .c(new_n45_), .O(new_n90_));
  oai21  g046(.a(x22), .b(x17), .c(new_n90_), .O(new_n91_));
  and2   g047(.a(new_n91_), .b(new_n62_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n81_), .c(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n60_), .c(new_n47_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n92_), .c(x25), .O(new_n96_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n91_), .c(new_n62_), .d(x25), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n60_), .c(new_n47_), .O(z5));
  ...
  oai21  g064(.a(new_n105_), .b(x29), .c(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n91_), .c(new_n62_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n60_), .c(new_n47_), .O(z6));
  nand3  g067(.a(new_n100_), .b(x30), .c(x29), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x31), .O(new_n113_));
  inv1   g069(.a(new_n82_), .O(new_n114_));
  nand3  g070(.a(new_n88_), .b(new_n85_), .c(new_n114_), .O(new_n115_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n129_), .c(x31), .d(new_n105_), .O(new_n146_));
  nand2  g102(.a(x32), .b(x30), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n128_), .c(x29), .O(new_n149_));
  nand2  g105(.a(new_n128_), .b(x29), .O(new_n150_));
  nand4  g106(.a(new_n145_), .b(new_n129_), .c(x31), .d(x30), .O(new_n151_));
  ...
  nand2  g110(.a(new_n86_), .b(x14), .O(new_n155_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n86_), .O(new_n160_));
  ...
  nand4  g133(.a(new_n145_), .b(new_n173_), .c(new_n120_), .d(new_n105_), .O(new_n178_));
