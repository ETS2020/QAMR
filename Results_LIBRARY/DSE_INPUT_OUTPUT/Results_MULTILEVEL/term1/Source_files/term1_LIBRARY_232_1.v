...
module FAU ( 
  ...
  nor3   g047(.a(new_n91_), .b(new_n45_), .c(new_n59_), .O(z4));
  ...
  nor3   g055(.a(new_n99_), .b(new_n45_), .c(new_n59_), .O(z5));
  ...
  oai21  g126(.a(new_n170_), .b(new_n153_), .c(new_n46_), .O(new_n171_));
  ...
  aoi22  g130(.a(new_n174_), .b(x25), .c(new_n172_), .d(new_n101_), .O(new_n175_));
  ...
  oai22  g134(.a(new_n178_), .b(new_n45_), .c(new_n172_), .d(x30), .O(new_n179_));
