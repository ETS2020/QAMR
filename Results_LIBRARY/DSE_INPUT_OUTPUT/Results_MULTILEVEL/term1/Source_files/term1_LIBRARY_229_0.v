...
module FAU ( 
  ...
  nand4  g080(.a(new_n124_), .b(new_n122_), .c(new_n81_), .d(x25), .O(new_n125_));
  ...
  nand2  g097(.a(new_n87_), .b(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x31), .O(new_n143_));
  aoi21  g099(.a(new_n140_), .b(new_n84_), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n131_), .c(new_n47_), .O(new_n146_));
  nor2   g102(.a(x28), .b(x27), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n46_), .O(new_n148_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n46_), .c(x29), .O(new_n155_));
  oai21  g111(.a(new_n147_), .b(new_n45_), .c(x30), .O(new_n156_));
  ...
  nand3  g131(.a(x33), .b(new_n81_), .c(x00), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n45_), .O(new_n178_));
  aoi21  g134(.a(new_n169_), .b(new_n168_), .c(x33), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n46_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n180_), .c(new_n147_), .O(new_n182_));
  oai21  g138(.a(new_n147_), .b(new_n123_), .c(x30), .O(new_n183_));
  nand2  g139(.a(new_n140_), .b(new_n84_), .O(new_n184_));
  nand2  g140(.a(x31), .b(new_n46_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n142_), .c(new_n184_), .d(new_n139_), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n183_), .c(new_n136_), .d(new_n134_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n131_), .c(x33), .O(new_n189_));
  nand4  g145(.a(new_n179_), .b(new_n123_), .c(new_n46_), .d(new_n102_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(x27), .c(new_n189_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n182_), .c(new_n81_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n175_), .c(new_n178_), .O(z9));
endmodule
