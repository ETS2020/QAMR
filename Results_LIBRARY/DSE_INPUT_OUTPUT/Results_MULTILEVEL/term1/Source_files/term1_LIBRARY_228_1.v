...
module FAU ( 
  ...
  nand4  g046(.a(new_n90_), .b(new_n61_), .c(new_n46_), .d(new_n81_), .O(new_n91_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n90_), .d(new_n61_), .O(new_n107_));
  ...
  nand3  g067(.a(new_n103_), .b(x30), .c(x06), .O(new_n112_));
  ...
  nand2  g072(.a(x30), .b(new_n102_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(new_n111_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n59_), .c(new_n46_), .O(z6));
  oai21  g076(.a(x31), .b(x30), .c(new_n45_), .O(new_n121_));
  nand2  g077(.a(x30), .b(x29), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n103_), .c(x31), .O(new_n123_));
  nand4  g079(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n124_));
  nor2   g080(.a(new_n60_), .b(new_n59_), .O(new_n125_));
  inv1   g081(.a(x31), .O(new_n126_));
  nand4  g082(.a(new_n104_), .b(new_n126_), .c(x30), .d(x29), .O(new_n127_));
  ...
  nor3   g101(.a(new_n145_), .b(new_n144_), .c(new_n126_), .O(new_n146_));
  ...
  nor2   g107(.a(new_n151_), .b(new_n102_), .O(new_n152_));
  nand2  g108(.a(new_n150_), .b(x29), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(new_n113_), .c(new_n152_), .d(x06), .O(new_n154_));
  ...
  nand3  g114(.a(new_n150_), .b(new_n113_), .c(x29), .O(new_n159_));
  ...
  nand3  g119(.a(new_n132_), .b(x18), .c(x14), .O(new_n164_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n142_), .c(x11), .O(new_n171_));
  ...
  nor2   g135(.a(new_n145_), .b(new_n144_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n143_), .c(new_n140_), .d(new_n138_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n135_), .c(new_n46_), .O(new_n182_));
  nand2  g138(.a(new_n153_), .b(new_n126_), .O(new_n183_));
  nor2   g139(.a(new_n126_), .b(new_n102_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n150_), .c(new_n113_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(x06), .c(new_n183_), .d(new_n113_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  inv1   g144(.a(x33), .O(new_n189_));
  nand4  g145(.a(new_n150_), .b(x31), .c(x30), .d(x29), .O(new_n190_));
  oai22  g146(.a(new_n190_), .b(new_n45_), .c(new_n183_), .d(x30), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n175_), .c(new_n189_), .O(new_n192_));
