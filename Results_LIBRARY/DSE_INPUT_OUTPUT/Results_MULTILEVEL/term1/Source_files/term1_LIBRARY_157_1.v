...
module FAU ( 
  ...
  nor2   g049(.a(x20), .b(x15), .O(new_n94_));
  nor2   g050(.a(x21), .b(x16), .O(new_n95_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n102_), .c(new_n99_), .d(new_n96_), .O(new_n105_));
  and2   g061(.a(new_n105_), .b(new_n93_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n91_), .c(new_n90_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n89_), .c(new_n65_), .O(z3));
  xor2a  g064(.a(x28), .b(x27), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n106_), .c(new_n90_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n89_), .c(new_n65_), .O(z4));
  ...
  nand4  g072(.a(new_n116_), .b(new_n105_), .c(new_n93_), .d(new_n90_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n89_), .c(new_n65_), .O(z5));
  oai21  g074(.a(x30), .b(x03), .c(x02), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x29), .c(x28), .d(x27), .O(new_n120_));
  nand3  g076(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x30), .c(new_n49_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n105_), .c(new_n90_), .d(x25), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n65_), .c(new_n46_), .O(z6));
  nand3  g081(.a(new_n102_), .b(new_n99_), .c(new_n96_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n103_), .O(new_n127_));
  nand3  g083(.a(new_n90_), .b(x25), .c(x01), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(new_n46_), .O(new_n129_));
  nand2  g085(.a(new_n121_), .b(x31), .O(new_n130_));
  nor2   g086(.a(x31), .b(new_n52_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n114_), .c(x29), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n49_), .O(new_n133_));
  inv1   g089(.a(x31), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(x30), .O(new_n135_));
  aoi21  g091(.a(new_n133_), .b(x02), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n129_), .O(z7));
  nand2  g093(.a(new_n113_), .b(new_n91_), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n100_), .c(x13), .O(new_n139_));
  inv1   g095(.a(x19), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x18), .c(x14), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n139_), .c(new_n97_), .O(new_n142_));
  nand4  g098(.a(x19), .b(x18), .c(new_n97_), .d(x12), .O(new_n143_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n53_), .c(x31), .d(new_n52_), .O(new_n155_));
  nand2  g111(.a(x32), .b(x30), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n138_), .c(x29), .O(new_n158_));
  nand2  g114(.a(new_n138_), .b(x29), .O(new_n159_));
  nand4  g115(.a(new_n154_), .b(new_n53_), .c(x31), .d(x30), .O(new_n160_));
  nand2  g116(.a(x32), .b(new_n52_), .O(new_n161_));
  ...
  nor3   g131(.a(new_n175_), .b(new_n174_), .c(new_n134_), .O(new_n176_));
  ...
  nand3  g135(.a(new_n179_), .b(new_n90_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n46_), .O(z8));
  nand4  g137(.a(new_n154_), .b(new_n55_), .c(x31), .d(x30), .O(new_n182_));
  nand2  g138(.a(x33), .b(new_n52_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n138_), .c(x29), .O(new_n185_));
  nand4  g141(.a(new_n154_), .b(new_n55_), .c(new_n134_), .d(new_n52_), .O(new_n186_));
  ...
  nor3   g146(.a(new_n175_), .b(new_n135_), .c(new_n131_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n190_), .c(new_n173_), .O(new_n192_));
  inv1   g148(.a(new_n192_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n171_), .c(new_n169_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n166_), .c(x33), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n189_), .c(new_n185_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n90_), .c(x00), .O(new_n197_));
