...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n92_), .c(x30), .O(new_n97_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n60_), .d(x30), .O(new_n107_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n101_), .c(new_n60_), .d(x30), .O(new_n112_));
  ...
  nand3  g078(.a(new_n122_), .b(x30), .c(new_n95_), .O(new_n123_));
  ...
  nand2  g082(.a(new_n102_), .b(new_n79_), .O(new_n127_));
  ...
  aoi21  g112(.a(new_n84_), .b(new_n156_), .c(new_n121_), .O(new_n157_));
  ...
  nand2  g122(.a(new_n84_), .b(new_n156_), .O(new_n167_));
  nor2   g123(.a(new_n121_), .b(new_n104_), .O(new_n168_));
  ...
  oai21  g129(.a(new_n166_), .b(new_n104_), .c(new_n173_), .O(new_n174_));
