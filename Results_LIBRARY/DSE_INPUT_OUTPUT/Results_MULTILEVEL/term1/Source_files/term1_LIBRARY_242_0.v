...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(x31), .c(new_n81_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n80_), .c(x25), .d(x01), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z3));
  nand3  g051(.a(x31), .b(x28), .c(new_n81_), .O(new_n96_));
  oai21  g052(.a(x28), .b(new_n81_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n91_), .c(x25), .d(x01), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(x31), .c(x26), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n89_), .c(new_n62_), .d(x31), .O(new_n105_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n90_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n62_), .c(x25), .d(x01), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(x31), .c(x26), .O(z6));
  inv1   g071(.a(new_n85_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n84_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n87_), .c(new_n86_), .O(new_n118_));
  inv1   g074(.a(x25), .O(new_n119_));
  nor2   g075(.a(new_n55_), .b(new_n119_), .O(new_n120_));
  nor2   g076(.a(new_n111_), .b(new_n100_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n102_), .d(x01), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n118_), .c(x31), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n80_), .O(z7));
  nand2  g080(.a(new_n101_), .b(new_n81_), .O(new_n125_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n140_), .c(new_n48_), .O(new_n143_));
  ...
  nand2  g102(.a(new_n125_), .b(x29), .O(new_n147_));
  nand2  g103(.a(x32), .b(new_n111_), .O(new_n148_));
  oai21  g104(.a(new_n143_), .b(new_n111_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g106(.a(new_n130_), .b(x14), .O(new_n151_));
  ...
  nand3  g114(.a(new_n156_), .b(x16), .c(x10), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n126_), .O(new_n160_));
  aoi21  g116(.a(new_n156_), .b(x11), .c(x16), .O(new_n161_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n150_), .c(new_n146_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(x31), .c(new_n80_), .d(x00), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(z8));
  or2    g126(.a(new_n142_), .b(new_n140_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n125_), .c(new_n52_), .d(x30), .O(new_n172_));
  inv1   g128(.a(new_n164_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n125_), .c(new_n121_), .O(new_n174_));
  nor3   g130(.a(new_n174_), .b(new_n163_), .c(new_n161_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n160_), .c(new_n158_), .d(new_n154_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  oai21  g133(.a(new_n172_), .b(new_n100_), .c(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x31), .c(new_n80_), .d(x00), .O(new_n179_));
