...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n62_), .c(new_n47_), .O(z4));
  ...
  nor3   g057(.a(new_n101_), .b(new_n93_), .c(new_n62_), .O(z5));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n98_), .c(new_n93_), .O(new_n121_));
