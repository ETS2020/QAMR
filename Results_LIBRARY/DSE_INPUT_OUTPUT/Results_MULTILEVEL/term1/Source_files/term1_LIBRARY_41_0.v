...
module FAU ( 
  ...
  aoi21  g044(.a(new_n88_), .b(new_n84_), .c(new_n55_), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(x30), .c(new_n81_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n80_), .c(x25), .d(x01), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z3));
  nand3  g049(.a(x30), .b(x28), .c(new_n81_), .O(new_n94_));
  oai21  g050(.a(x28), .b(new_n81_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n89_), .c(x25), .d(x01), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(x30), .c(x26), .O(z4));
  nand2  g053(.a(new_n88_), .b(new_n84_), .O(new_n98_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n98_), .c(new_n62_), .d(x30), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n80_), .c(x25), .d(x01), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z5));
  oai21  g063(.a(new_n100_), .b(new_n81_), .c(x30), .O(new_n108_));
  aoi22  g064(.a(new_n108_), .b(x29), .c(new_n88_), .d(new_n84_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x30), .c(x26), .O(z6));
  ...
  nand3  g074(.a(new_n101_), .b(new_n118_), .c(x29), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n62_), .c(x25), .d(x01), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n117_), .c(new_n113_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x30), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n80_), .O(z7));
  nand2  g080(.a(new_n100_), .b(new_n81_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(new_n48_), .d(x31), .O(new_n145_));
  aoi21  g101(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(x17), .c(x16), .d(x15), .O(new_n147_));
  nand2  g103(.a(x16), .b(x15), .O(new_n148_));
  nand2  g104(.a(x18), .b(x17), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n130_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(new_n142_), .O(new_n152_));
  inv1   g108(.a(x11), .O(new_n153_));
  oai21  g109(.a(new_n149_), .b(new_n153_), .c(new_n136_), .O(new_n154_));
  nand2  g110(.a(x18), .b(x12), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n127_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  aoi21  g113(.a(new_n128_), .b(new_n157_), .c(new_n118_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n150_), .c(new_n147_), .d(new_n126_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n145_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x30), .c(new_n80_), .d(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  nand4  g121(.a(new_n144_), .b(new_n125_), .c(new_n52_), .d(x31), .O(new_n166_));
  nand2  g122(.a(new_n128_), .b(new_n157_), .O(new_n167_));
  nor2   g123(.a(new_n118_), .b(new_n99_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n167_), .c(new_n156_), .d(new_n125_), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  and2   g126(.a(new_n170_), .b(new_n154_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n152_), .c(new_n150_), .d(new_n147_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x33), .O(new_n173_));
  oai21  g129(.a(new_n166_), .b(new_n99_), .c(new_n173_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x30), .c(new_n80_), .d(x00), .O(new_n175_));
