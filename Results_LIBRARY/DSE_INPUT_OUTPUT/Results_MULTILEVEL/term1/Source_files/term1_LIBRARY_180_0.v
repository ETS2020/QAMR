...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n87_), .c(new_n61_), .d(new_n92_), .O(new_n103_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n88_), .O(new_n111_));
  ...
  nand3  g075(.a(new_n61_), .b(x01), .c(x00), .O(new_n120_));
  ...
  nand3  g103(.a(new_n147_), .b(new_n48_), .c(x31), .O(new_n148_));
  ...
  aoi21  g130(.a(new_n174_), .b(new_n151_), .c(x26), .O(z8));
  nand4  g131(.a(new_n147_), .b(new_n52_), .c(x31), .d(x30), .O(new_n176_));
  ...
  nand4  g135(.a(new_n147_), .b(new_n52_), .c(new_n124_), .d(new_n109_), .O(new_n180_));
  nand2  g136(.a(x33), .b(x30), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g138(.a(new_n166_), .b(new_n130_), .O(new_n183_));
  xnor2a g139(.a(x31), .b(x30), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n168_), .c(new_n183_), .d(new_n165_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n163_), .c(new_n161_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n158_), .c(x33), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x00), .O(new_n189_));
  aoi21  g145(.a(new_n182_), .b(new_n152_), .c(new_n189_), .O(new_n190_));
