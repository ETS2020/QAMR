...
module FAU ( 
  ...
  nand2  g060(.a(new_n46_), .b(x26), .O(new_n105_));
  ...
  oai21  g064(.a(new_n108_), .b(x26), .c(new_n106_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(x25), .d(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n58_), .O(z5));
  nand4  g067(.a(new_n46_), .b(x28), .c(x27), .d(new_n45_), .O(new_n112_));
  oai21  g068(.a(new_n103_), .b(new_n46_), .c(new_n112_), .O(new_n113_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n104_), .c(new_n45_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n81_), .O(new_n126_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n131_), .c(new_n105_), .O(new_n144_));
  nor2   g100(.a(x28), .b(x27), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n107_), .O(new_n146_));
  ...
  nand4  g109(.a(new_n149_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n154_));
  oai21  g110(.a(new_n146_), .b(new_n46_), .c(new_n154_), .O(new_n155_));
  ...
  nand4  g133(.a(new_n168_), .b(new_n173_), .c(new_n123_), .d(new_n46_), .O(new_n178_));
