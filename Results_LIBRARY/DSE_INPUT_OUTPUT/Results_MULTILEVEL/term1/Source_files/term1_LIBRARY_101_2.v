...
module FAU ( 
  ...
  nand2  g097(.a(new_n102_), .b(new_n82_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x30), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n101_), .O(new_n144_));
  ...
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n125_), .d(x10), .O(new_n164_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n128_), .c(new_n124_), .O(new_n172_));
  nand2  g128(.a(new_n145_), .b(new_n119_), .O(new_n173_));
  nor2   g129(.a(new_n119_), .b(new_n101_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n142_), .c(new_n45_), .O(new_n175_));
  aoi22  g131(.a(new_n175_), .b(new_n81_), .c(new_n173_), .d(new_n45_), .O(new_n176_));
  ...
  oai22  g136(.a(new_n180_), .b(x26), .c(new_n173_), .d(x30), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n165_), .c(new_n179_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x00), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n46_), .O(z9));
endmodule
