...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n57_), .c(new_n81_), .O(new_n93_));
  ...
  nand3  g053(.a(new_n97_), .b(new_n92_), .c(new_n57_), .O(new_n98_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n58_), .c(new_n80_), .d(x25), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n57_), .c(new_n102_), .O(z5));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n57_), .c(new_n102_), .O(z6));
  nand2  g070(.a(new_n87_), .b(new_n84_), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n89_), .c(new_n88_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand4  g073(.a(new_n58_), .b(new_n117_), .c(new_n80_), .d(x25), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n116_), .c(new_n57_), .O(new_n119_));
  ...
  nand2  g094(.a(new_n104_), .b(new_n81_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x30), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n106_), .O(new_n141_));
  nand2  g097(.a(new_n139_), .b(x29), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(new_n57_), .c(new_n141_), .d(new_n102_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  inv1   g101(.a(x32), .O(new_n146_));
  nand3  g102(.a(new_n142_), .b(x30), .c(new_n102_), .O(new_n147_));
  nand3  g103(.a(new_n139_), .b(new_n57_), .c(x29), .O(new_n148_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n125_), .c(new_n45_), .O(new_n170_));
  nand2  g126(.a(new_n142_), .b(new_n117_), .O(new_n171_));
  nor2   g127(.a(new_n117_), .b(new_n106_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n139_), .c(new_n57_), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(new_n102_), .c(new_n171_), .d(new_n57_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  inv1   g132(.a(x33), .O(new_n177_));
  nand4  g133(.a(new_n139_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  oai22  g134(.a(new_n178_), .b(x01), .c(new_n171_), .d(x30), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n163_), .c(new_n177_), .O(new_n180_));
