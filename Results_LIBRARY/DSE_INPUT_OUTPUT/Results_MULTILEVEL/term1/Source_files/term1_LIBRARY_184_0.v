...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x28), .O(new_n45_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n61_), .c(new_n47_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n62_), .d(new_n80_), .O(new_n108_));
  ...
  xor2a  g068(.a(x30), .b(x27), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x29), .c(x28), .O(new_n114_));
  oai21  g070(.a(new_n103_), .b(new_n104_), .c(x30), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n62_), .d(new_n80_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n112_), .c(new_n61_), .O(z6));
  inv1   g074(.a(x30), .O(new_n119_));
  oai21  g075(.a(x31), .b(new_n119_), .c(new_n104_), .O(new_n120_));
  ...
  nor2   g080(.a(new_n55_), .b(new_n61_), .O(new_n125_));
  inv1   g081(.a(x31), .O(new_n126_));
  nand4  g082(.a(new_n105_), .b(new_n126_), .c(x30), .d(x29), .O(new_n127_));
  ...
  nand2  g087(.a(new_n89_), .b(x14), .O(new_n132_));
  ...
  nand2  g091(.a(new_n135_), .b(new_n89_), .O(new_n136_));
  nand2  g092(.a(x18), .b(x17), .O(new_n137_));
  nand2  g093(.a(x16), .b(x10), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n131_), .O(new_n139_));
  inv1   g095(.a(x11), .O(new_n140_));
  inv1   g096(.a(x16), .O(new_n141_));
  oai21  g097(.a(new_n137_), .b(new_n140_), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(x18), .b(x12), .O(new_n143_));
  inv1   g099(.a(x13), .O(new_n144_));
  nand2  g100(.a(new_n86_), .b(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x31), .O(new_n146_));
  aoi21  g102(.a(new_n143_), .b(new_n83_), .c(new_n146_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n142_), .c(new_n139_), .d(new_n136_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n134_), .c(new_n47_), .O(new_n149_));
  xnor2a g105(.a(x30), .b(x29), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x28), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n121_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x32), .O(new_n153_));
  nor2   g109(.a(x28), .b(x27), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n103_), .c(x30), .O(new_n155_));
  nand3  g111(.a(new_n119_), .b(x29), .c(x28), .O(new_n156_));
  ...
  nand3  g121(.a(new_n165_), .b(new_n141_), .c(x11), .O(new_n166_));
  ...
  nand4  g126(.a(new_n170_), .b(new_n157_), .c(new_n48_), .d(x31), .O(new_n171_));
  ...
  nand4  g130(.a(x33), .b(new_n81_), .c(new_n80_), .d(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x30), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n104_), .O(new_n177_));
  inv1   g133(.a(new_n154_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand3  g135(.a(new_n126_), .b(new_n119_), .c(new_n103_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n170_), .c(new_n52_), .O(new_n182_));
  oai21  g138(.a(new_n126_), .b(new_n103_), .c(x30), .O(new_n183_));
  oai21  g139(.a(x31), .b(x29), .c(new_n119_), .O(new_n184_));
  nand2  g140(.a(new_n143_), .b(new_n83_), .O(new_n185_));
  nand4  g141(.a(new_n145_), .b(new_n185_), .c(new_n142_), .d(new_n139_), .O(new_n186_));
  aoi21  g142(.a(new_n135_), .b(new_n89_), .c(new_n186_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n184_), .c(new_n183_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n134_), .c(x33), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n182_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n80_), .c(x00), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n177_), .O(z9));
endmodule
