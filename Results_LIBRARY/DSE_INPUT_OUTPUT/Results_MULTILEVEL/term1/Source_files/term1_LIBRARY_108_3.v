...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(new_n46_), .c(new_n45_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n90_), .c(new_n46_), .O(new_n94_));
  ...
  oai21  g054(.a(new_n98_), .b(new_n81_), .c(x29), .O(new_n99_));
  inv1   g055(.a(x29), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x28), .c(x27), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n99_), .c(new_n89_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n46_), .c(new_n45_), .O(z5));
  nand3  g060(.a(new_n90_), .b(x29), .c(x28), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n80_), .d(x25), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n46_), .c(new_n45_), .O(z6));
  inv1   g064(.a(new_n85_), .O(new_n109_));
  inv1   g065(.a(new_n86_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n109_), .c(new_n84_), .O(new_n111_));
  nand3  g067(.a(new_n61_), .b(x25), .c(x01), .O(new_n112_));
  nor4   g068(.a(new_n112_), .b(x31), .c(x30), .d(x26), .O(new_n113_));
  oai21  g069(.a(new_n111_), .b(new_n87_), .c(new_n113_), .O(z7));
  nand2  g070(.a(new_n98_), .b(new_n81_), .O(new_n115_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n116_), .c(x31), .d(new_n46_), .O(new_n135_));
  nand2  g091(.a(x32), .b(x30), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n115_), .c(x29), .O(new_n138_));
  nand2  g094(.a(new_n115_), .b(x29), .O(new_n139_));
  nand4  g095(.a(new_n134_), .b(new_n116_), .c(x31), .d(x30), .O(new_n140_));
  ...
  nand2  g099(.a(new_n120_), .b(x14), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(x18), .c(x17), .d(x16), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n132_), .O(new_n146_));
  nand2  g102(.a(x16), .b(x15), .O(new_n147_));
  nand2  g103(.a(x18), .b(x17), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n120_), .O(new_n149_));
  nand2  g105(.a(x16), .b(x10), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n148_), .c(new_n132_), .O(new_n151_));
  inv1   g107(.a(x11), .O(new_n152_));
  oai21  g108(.a(new_n148_), .b(new_n152_), .c(new_n126_), .O(new_n153_));
  inv1   g109(.a(x31), .O(new_n154_));
  aoi21  g110(.a(x18), .b(x12), .c(x17), .O(new_n155_));
  nor2   g111(.a(x18), .b(x13), .O(new_n156_));
  nor3   g112(.a(new_n156_), .b(new_n155_), .c(new_n154_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n153_), .c(new_n151_), .d(new_n149_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n146_), .c(x32), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n143_), .c(new_n138_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n80_), .c(x00), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n48_), .O(z8));
  nor2   g118(.a(new_n156_), .b(new_n155_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n153_), .c(new_n151_), .d(new_n149_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n146_), .c(new_n48_), .O(new_n165_));
  nand2  g121(.a(new_n139_), .b(new_n154_), .O(new_n166_));
  nor2   g122(.a(new_n154_), .b(new_n100_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n115_), .c(new_n46_), .O(new_n168_));
  aoi22  g124(.a(new_n168_), .b(new_n45_), .c(new_n166_), .d(new_n46_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x33), .O(new_n171_));
  nand4  g127(.a(new_n115_), .b(x31), .c(x30), .d(x29), .O(new_n172_));
  oai22  g128(.a(new_n172_), .b(x01), .c(new_n166_), .d(x30), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n134_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(x33), .c(new_n171_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n80_), .c(x00), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(z9));
endmodule
