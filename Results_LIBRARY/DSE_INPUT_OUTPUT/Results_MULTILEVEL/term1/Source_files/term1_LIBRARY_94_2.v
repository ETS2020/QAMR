...
module FAU ( 
  ...
  oai21  g068(.a(x31), .b(x14), .c(new_n105_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n98_), .b(new_n119_), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nor2   g077(.a(new_n119_), .b(x30), .O(new_n122_));
  aoi22  g078(.a(new_n122_), .b(new_n45_), .c(new_n121_), .d(x30), .O(new_n123_));
  ...
  nand4  g088(.a(x30), .b(x19), .c(new_n132_), .d(x13), .O(new_n133_));
  ...
  nor2   g100(.a(new_n132_), .b(new_n129_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nor3   g102(.a(new_n146_), .b(new_n144_), .c(new_n143_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n142_), .c(new_n127_), .O(new_n148_));
  nand2  g104(.a(x32), .b(new_n105_), .O(new_n149_));
  oai21  g105(.a(new_n148_), .b(new_n119_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n126_), .O(new_n151_));
  nand3  g107(.a(x18), .b(new_n129_), .c(x12), .O(new_n152_));
  nand3  g108(.a(new_n132_), .b(x17), .c(x13), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n152_), .c(new_n139_), .O(new_n154_));
  nand4  g110(.a(x18), .b(x17), .c(new_n139_), .d(x11), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(x15), .O(new_n157_));
  nand4  g113(.a(new_n145_), .b(x16), .c(new_n128_), .d(x10), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n127_), .c(x31), .d(new_n105_), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n130_), .c(new_n127_), .d(new_n105_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n125_), .c(x29), .O(new_n162_));
  nand2  g118(.a(new_n132_), .b(x13), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x17), .c(x16), .d(x15), .O(new_n164_));
  aoi22  g120(.a(new_n164_), .b(x19), .c(x30), .d(x14), .O(new_n165_));
  nand2  g121(.a(x16), .b(x15), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n146_), .c(new_n130_), .O(new_n167_));
  nand3  g123(.a(new_n145_), .b(x16), .c(x10), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n128_), .O(new_n169_));
  aoi21  g125(.a(new_n145_), .b(x11), .c(x16), .O(new_n170_));
  aoi21  g126(.a(x18), .b(x12), .c(x17), .O(new_n171_));
  nand3  g127(.a(x19), .b(x18), .c(x17), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n166_), .O(new_n173_));
  inv1   g129(.a(x13), .O(new_n174_));
  nor2   g130(.a(new_n105_), .b(x18), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x31), .O(new_n177_));
  nor4   g133(.a(new_n177_), .b(new_n173_), .c(new_n171_), .d(new_n170_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n169_), .c(new_n167_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n165_), .c(x32), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n162_), .c(new_n151_), .O(new_n181_));
  ...
  nor2   g141(.a(new_n129_), .b(new_n139_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(x15), .c(x18), .O(new_n187_));
  nand2  g143(.a(new_n186_), .b(x10), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n128_), .O(new_n189_));
  nand2  g145(.a(x17), .b(x11), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n139_), .O(new_n191_));
  nand2  g147(.a(new_n129_), .b(new_n135_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n191_), .c(new_n189_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n187_), .c(new_n57_), .O(new_n194_));
  nand3  g150(.a(new_n186_), .b(x15), .c(new_n45_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n175_), .c(new_n174_), .O(new_n197_));
  aoi21  g153(.a(new_n143_), .b(x14), .c(new_n132_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(x17), .c(x16), .d(x15), .O(new_n199_));
  aoi21  g155(.a(new_n126_), .b(new_n119_), .c(x30), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n130_), .c(new_n45_), .O(new_n201_));
  nand4  g157(.a(new_n167_), .b(new_n125_), .c(x31), .d(x29), .O(new_n202_));
  ...
  aoi21  g161(.a(new_n205_), .b(new_n194_), .c(new_n185_), .O(new_n206_));
  inv1   g162(.a(new_n125_), .O(new_n207_));
  nand3  g163(.a(x19), .b(new_n132_), .c(x13), .O(new_n208_));
  aoi21  g164(.a(new_n208_), .b(new_n131_), .c(new_n129_), .O(new_n209_));
  nand4  g165(.a(x19), .b(x18), .c(new_n129_), .d(x12), .O(new_n210_));
  inv1   g166(.a(new_n210_), .O(new_n211_));
  oai21  g167(.a(new_n211_), .b(new_n209_), .c(x16), .O(new_n212_));
  inv1   g168(.a(new_n172_), .O(new_n213_));
  nand3  g169(.a(new_n213_), .b(new_n139_), .c(x11), .O(new_n214_));
  nand2  g170(.a(new_n214_), .b(new_n212_), .O(new_n215_));
  nand2  g171(.a(new_n215_), .b(x15), .O(new_n216_));
  inv1   g172(.a(new_n144_), .O(new_n217_));
  nand2  g173(.a(new_n213_), .b(new_n217_), .O(new_n218_));
  aoi21  g174(.a(new_n218_), .b(new_n216_), .c(new_n207_), .O(new_n219_));
  nand4  g175(.a(new_n219_), .b(x31), .c(x30), .d(x29), .O(new_n220_));
  nand4  g176(.a(new_n159_), .b(new_n126_), .c(new_n119_), .d(new_n105_), .O(new_n221_));
  inv1   g177(.a(new_n221_), .O(new_n222_));
  nand3  g178(.a(new_n222_), .b(x19), .c(new_n45_), .O(new_n223_));
  aoi21  g179(.a(new_n223_), .b(new_n220_), .c(x33), .O(new_n224_));
  oai21  g180(.a(new_n224_), .b(new_n206_), .c(new_n80_), .O(new_n225_));
  nor2   g181(.a(new_n225_), .b(new_n184_), .O(z9));
endmodule
