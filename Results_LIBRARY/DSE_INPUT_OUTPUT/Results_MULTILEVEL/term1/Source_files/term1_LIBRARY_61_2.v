...
module FAU ( 
  ...
  nor3   g063(.a(new_n107_), .b(new_n97_), .c(new_n60_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n62_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n60_), .c(new_n47_), .O(z6));
  ...
  nor2   g079(.a(new_n61_), .b(new_n97_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(new_n121_), .d(x01), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n119_), .O(z7));
  nand2  g083(.a(new_n103_), .b(new_n81_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n111_), .O(new_n145_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n89_), .O(new_n159_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n116_), .O(new_n166_));
  ...
  nand2  g129(.a(x33), .b(new_n111_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n128_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n116_), .d(new_n111_), .O(new_n177_));
