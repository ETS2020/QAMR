...
module FAU ( 
  ...
  nand4  g068(.a(new_n112_), .b(new_n100_), .c(new_n61_), .d(x25), .O(new_n113_));
  ...
  nand2  g081(.a(x30), .b(x26), .O(new_n126_));
  inv1   g082(.a(x15), .O(new_n127_));
  nand2  g083(.a(new_n89_), .b(x14), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n89_), .O(new_n133_));
  ...
  nand2  g099(.a(new_n102_), .b(new_n81_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x30), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n101_), .O(new_n146_));
  nand2  g102(.a(new_n144_), .b(x29), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(new_n110_), .c(new_n146_), .d(new_n45_), .O(new_n148_));
  ...
  nand3  g108(.a(new_n144_), .b(new_n110_), .c(x29), .O(new_n153_));
  ...
  nor2   g127(.a(new_n140_), .b(new_n139_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n130_), .c(new_n126_), .O(new_n174_));
  nand2  g130(.a(new_n147_), .b(new_n121_), .O(new_n175_));
  nor2   g131(.a(new_n121_), .b(new_n101_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n144_), .c(new_n110_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n45_), .c(new_n175_), .d(new_n110_), .O(new_n178_));
