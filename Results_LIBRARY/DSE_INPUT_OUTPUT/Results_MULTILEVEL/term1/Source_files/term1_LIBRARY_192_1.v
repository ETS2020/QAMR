...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n60_), .c(new_n57_), .O(new_n93_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n60_), .d(new_n57_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n79_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z5));
  nand3  g068(.a(x29), .b(x28), .c(x27), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n106_), .b(new_n45_), .c(x29), .O(new_n115_));
  oai21  g071(.a(new_n114_), .b(new_n45_), .c(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n117_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n57_), .O(new_n124_));
  inv1   g080(.a(x31), .O(new_n125_));
  nor2   g081(.a(x31), .b(new_n45_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n106_), .c(x29), .O(new_n127_));
  oai21  g083(.a(new_n114_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nor2   g084(.a(new_n125_), .b(x30), .O(new_n129_));
  aoi21  g085(.a(new_n128_), .b(x10), .c(new_n129_), .O(new_n130_));
  ...
  nand4  g092(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nor2   g094(.a(new_n87_), .b(new_n84_), .O(new_n139_));
  ...
  nor3   g102(.a(new_n146_), .b(new_n145_), .c(new_n125_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n144_), .c(new_n141_), .d(new_n138_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n136_), .c(new_n57_), .O(new_n149_));
  nand2  g105(.a(new_n105_), .b(new_n80_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  nor3   g107(.a(new_n151_), .b(new_n45_), .c(new_n104_), .O(new_n152_));
  nand2  g108(.a(new_n150_), .b(x29), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  oai21  g110(.a(x15), .b(x10), .c(new_n154_), .O(new_n155_));
  aoi22  g111(.a(new_n155_), .b(new_n45_), .c(new_n152_), .d(x10), .O(new_n156_));
  ...
  nand3  g116(.a(new_n133_), .b(x18), .c(x14), .O(new_n161_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n142_), .c(x11), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n165_), .c(new_n132_), .O(new_n169_));
  nand2  g125(.a(x16), .b(new_n132_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n166_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(new_n153_), .O(new_n172_));
  nand4  g128(.a(new_n150_), .b(new_n45_), .c(x29), .d(x19), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n87_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x17), .c(x16), .d(new_n132_), .O(new_n175_));
  oai21  g131(.a(new_n172_), .b(new_n45_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x10), .O(new_n177_));
  aoi21  g133(.a(new_n168_), .b(new_n165_), .c(new_n151_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n45_), .c(x29), .d(x15), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n177_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n159_), .c(x31), .O(new_n181_));
  ...
  nand4  g142(.a(new_n167_), .b(x16), .c(new_n132_), .d(x10), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n185_), .c(new_n125_), .d(new_n45_), .O(new_n189_));
  oai21  g145(.a(new_n185_), .b(new_n45_), .c(new_n189_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n153_), .O(new_n191_));
  or2    g147(.a(new_n171_), .b(new_n169_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n185_), .c(x31), .d(x30), .O(new_n193_));
  nand2  g149(.a(x33), .b(new_n45_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n150_), .c(x29), .O(new_n196_));
  nand3  g152(.a(new_n139_), .b(x16), .c(x15), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n133_), .O(new_n198_));
  nand3  g154(.a(new_n139_), .b(x16), .c(x10), .O(new_n199_));
  inv1   g155(.a(new_n145_), .O(new_n200_));
  nor3   g156(.a(new_n146_), .b(new_n129_), .c(new_n126_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n200_), .c(new_n144_), .O(new_n202_));
  aoi21  g158(.a(new_n199_), .b(new_n132_), .c(new_n202_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n198_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n136_), .c(x33), .O(new_n205_));
  nand3  g161(.a(new_n205_), .b(new_n196_), .c(new_n191_), .O(new_n206_));
