...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n60_), .c(new_n80_), .d(new_n79_), .O(new_n94_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n93_), .c(new_n60_), .d(new_n79_), .O(new_n117_));
  ...
  nor2   g079(.a(new_n59_), .b(new_n58_), .O(new_n124_));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n105_), .c(new_n125_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x00), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n79_), .O(z7));
  nand2  g088(.a(new_n104_), .b(new_n80_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(x31), .d(new_n112_), .O(new_n150_));
  ...
  nand3  g131(.a(new_n175_), .b(new_n158_), .c(new_n153_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n79_), .c(x00), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(z8));
  inv1   g134(.a(x33), .O(new_n179_));
  nand4  g135(.a(new_n149_), .b(new_n179_), .c(x31), .d(x30), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(x30), .c(new_n180_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n133_), .c(x29), .O(new_n182_));
  nand4  g138(.a(new_n149_), .b(new_n179_), .c(new_n126_), .d(new_n112_), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(new_n112_), .c(new_n183_), .O(new_n184_));
  inv1   g140(.a(new_n171_), .O(new_n185_));
  inv1   g141(.a(new_n172_), .O(new_n186_));
  xnor2a g142(.a(x31), .b(x30), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n170_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n168_), .c(new_n166_), .d(new_n162_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x00), .O(new_n192_));
  aoi21  g148(.a(new_n184_), .b(new_n154_), .c(new_n192_), .O(new_n193_));
