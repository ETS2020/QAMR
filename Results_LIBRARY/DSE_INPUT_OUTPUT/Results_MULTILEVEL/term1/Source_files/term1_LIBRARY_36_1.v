...
module FAU ( 
  ...
  oai21  g074(.a(new_n116_), .b(new_n91_), .c(new_n118_), .O(z7));
  nand2  g075(.a(new_n103_), .b(new_n81_), .O(new_n120_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n120_), .c(new_n49_), .d(x31), .O(new_n137_));
  aoi21  g093(.a(new_n122_), .b(x14), .c(new_n88_), .O(new_n138_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n85_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  nand2  g105(.a(new_n88_), .b(new_n149_), .O(new_n150_));
  inv1   g106(.a(x31), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n105_), .O(new_n152_));
  ...
  oai21  g113(.a(new_n137_), .b(new_n105_), .c(new_n157_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(z8));
  nand2  g116(.a(new_n120_), .b(x29), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n136_), .c(new_n53_), .d(new_n151_), .O(new_n162_));
  aoi21  g118(.a(new_n88_), .b(new_n149_), .c(x31), .O(new_n163_));
  ...
  aoi21  g125(.a(new_n169_), .b(new_n45_), .c(x26), .O(z9));
endmodule
