...
module FAU ( 
  ...
  nor2   g051(.a(new_n95_), .b(new_n57_), .O(new_n96_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n102_), .c(new_n64_), .d(new_n45_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n82_), .c(new_n63_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n102_), .c(new_n64_), .d(x25), .O(new_n113_));
  ...
  oai22  g099(.a(new_n143_), .b(new_n131_), .c(x30), .d(new_n45_), .O(new_n144_));
  ...
  nand4  g108(.a(new_n149_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n153_));
  oai21  g109(.a(new_n146_), .b(new_n46_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g127(.a(new_n167_), .b(new_n54_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n46_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n149_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n167_), .b(new_n54_), .c(new_n121_), .d(new_n46_), .O(new_n176_));
  nand2  g132(.a(x33), .b(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n147_), .O(new_n179_));
  inv1   g135(.a(new_n140_), .O(new_n180_));
  inv1   g136(.a(new_n141_), .O(new_n181_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n131_), .c(x33), .O(new_n186_));
