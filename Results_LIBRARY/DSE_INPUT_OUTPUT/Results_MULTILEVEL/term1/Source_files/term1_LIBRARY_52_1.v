...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n60_), .c(new_n57_), .d(new_n80_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n79_), .c(x25), .d(x01), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z3));
  nand3  g052(.a(new_n57_), .b(x28), .c(new_n80_), .O(new_n97_));
  ...
  nand2  g057(.a(new_n101_), .b(new_n57_), .O(z4));
  ...
  oai21  g068(.a(new_n105_), .b(new_n45_), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n92_), .c(new_n60_), .d(x29), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n79_), .c(x25), .d(x01), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(z6));
  nand3  g073(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n90_), .O(new_n119_));
  nand4  g075(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n57_), .O(new_n121_));
  inv1   g077(.a(x31), .O(new_n122_));
  nand3  g078(.a(new_n105_), .b(new_n122_), .c(x30), .O(new_n123_));
  oai21  g079(.a(new_n105_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  nor2   g080(.a(new_n122_), .b(x30), .O(new_n125_));
  aoi21  g081(.a(new_n124_), .b(x29), .c(new_n125_), .O(new_n126_));
  ...
  aoi22  g105(.a(new_n149_), .b(new_n45_), .c(new_n147_), .d(x29), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(x32), .O(new_n153_));
  nand2  g109(.a(new_n148_), .b(new_n45_), .O(new_n154_));
  nand3  g110(.a(x30), .b(new_n104_), .c(new_n80_), .O(new_n155_));
  ...
  nand4  g123(.a(new_n164_), .b(x16), .c(new_n128_), .d(x10), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n156_), .c(new_n153_), .d(x31), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n103_), .c(new_n152_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n79_), .c(x00), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(z8));
  nor2   g129(.a(new_n142_), .b(new_n141_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n132_), .c(new_n57_), .O(new_n176_));
  oai21  g132(.a(new_n146_), .b(new_n122_), .c(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n154_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(x29), .c(new_n125_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  nand4  g137(.a(new_n148_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  nand3  g138(.a(new_n149_), .b(new_n122_), .c(new_n45_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n169_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(x33), .c(new_n181_), .O(new_n186_));
