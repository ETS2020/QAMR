...
module FAU ( 
  ...
  nand3  g002(.a(z0), .b(x30), .c(new_n46_), .O(new_n47_));
  ...
  nand3  g008(.a(z0), .b(x30), .c(x03), .O(new_n53_));
  ...
  nand3  g012(.a(new_n48_), .b(z0), .c(x30), .O(new_n57_));
  nand3  g013(.a(new_n57_), .b(new_n56_), .c(new_n51_), .O(z1));
  xnor2a g014(.a(x07), .b(x04), .O(new_n59_));
  inv1   g015(.a(x01), .O(new_n60_));
  nor2   g016(.a(new_n46_), .b(new_n52_), .O(new_n61_));
  inv1   g017(.a(new_n61_), .O(new_n62_));
  nand2  g018(.a(new_n46_), .b(new_n52_), .O(new_n63_));
  aoi21  g019(.a(new_n63_), .b(new_n62_), .c(new_n60_), .O(new_n64_));
  nand2  g020(.a(x05), .b(new_n46_), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(x06), .c(new_n52_), .O(new_n66_));
  nand2  g022(.a(x06), .b(new_n52_), .O(new_n67_));
  nand3  g023(.a(new_n67_), .b(x05), .c(new_n46_), .O(new_n68_));
  ...
  nand4  g030(.a(x06), .b(x05), .c(new_n46_), .d(new_n52_), .O(new_n75_));
  ...
  nand2  g036(.a(z0), .b(new_n80_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n79_), .O(z2));
  ...
  nand4  g060(.a(new_n104_), .b(new_n100_), .c(new_n62_), .d(new_n83_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n81_), .O(z5));
  nand3  g064(.a(new_n80_), .b(x28), .c(x27), .O(new_n109_));
  oai21  g065(.a(new_n102_), .b(new_n80_), .c(new_n109_), .O(new_n110_));
  nor2   g066(.a(new_n80_), .b(x29), .O(new_n111_));
  aoi21  g067(.a(new_n110_), .b(x29), .c(new_n111_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n89_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n62_), .c(new_n83_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n60_), .c(new_n81_), .O(z6));
  oai21  g071(.a(z0), .b(x31), .c(new_n80_), .O(new_n116_));
  nor4   g072(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n117_));
  nand4  g073(.a(new_n62_), .b(new_n83_), .c(x25), .d(x01), .O(new_n118_));
  ...
  nor3   g080(.a(z0), .b(new_n122_), .c(x30), .O(new_n125_));
  aoi21  g081(.a(new_n124_), .b(x30), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g104(.a(new_n148_), .b(z0), .c(x31), .d(x30), .O(new_n149_));
  nand2  g105(.a(x32), .b(new_n80_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(new_n130_), .O(new_n151_));
  aoi21  g107(.a(new_n134_), .b(x14), .c(new_n132_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(x17), .c(x16), .d(x15), .O(new_n153_));
  nor3   g109(.a(new_n129_), .b(new_n80_), .c(new_n101_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x15), .O(new_n155_));
  nand2  g111(.a(x18), .b(x17), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n134_), .O(new_n157_));
  ...
  nor3   g119(.a(new_n163_), .b(new_n162_), .c(new_n122_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n154_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n153_), .c(z0), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n151_), .c(new_n83_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n128_), .O(z8));
  inv1   g125(.a(new_n129_), .O(new_n170_));
  nand4  g126(.a(new_n148_), .b(new_n48_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n80_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n170_), .c(x29), .O(new_n174_));
  inv1   g130(.a(new_n130_), .O(new_n175_));
  nand4  g131(.a(new_n148_), .b(new_n48_), .c(new_n122_), .d(new_n80_), .O(new_n176_));
  ...
  inv1   g135(.a(new_n162_), .O(new_n180_));
  inv1   g136(.a(new_n163_), .O(new_n181_));
  xnor2a g137(.a(x31), .b(x30), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n181_), .c(new_n180_), .d(new_n161_), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n159_), .c(new_n157_), .d(new_n153_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n179_), .c(new_n174_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n83_), .c(x00), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n81_), .O(z9));
endmodule
