...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n102_), .c(new_n99_), .d(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nand4  g062(.a(new_n99_), .b(new_n106_), .c(x28), .d(x27), .O(new_n107_));
  ...
  nand4  g066(.a(new_n103_), .b(x28), .c(x27), .d(new_n79_), .O(new_n111_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n99_), .c(new_n60_), .d(x25), .O(new_n115_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n103_), .O(new_n145_));
  ...
  aoi21  g132(.a(new_n176_), .b(new_n128_), .c(new_n103_), .O(new_n177_));
  aoi21  g133(.a(new_n175_), .b(new_n79_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  nand4  g136(.a(new_n149_), .b(new_n123_), .c(new_n103_), .d(new_n79_), .O(new_n181_));
