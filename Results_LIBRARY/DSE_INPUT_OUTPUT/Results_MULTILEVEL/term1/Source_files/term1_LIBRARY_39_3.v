...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n62_), .c(new_n49_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n95_), .c(new_n49_), .O(new_n99_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n46_), .c(x29), .O(new_n106_));
  nand3  g062(.a(new_n45_), .b(x28), .c(x27), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n104_), .c(new_n63_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n103_), .c(new_n62_), .O(z5));
  ...
  oai21  g070(.a(new_n114_), .b(new_n105_), .c(new_n112_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n104_), .c(new_n63_), .d(new_n81_), .O(new_n116_));
  ...
  nand3  g078(.a(new_n122_), .b(new_n81_), .c(x25), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n121_), .c(new_n63_), .d(x01), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n46_), .O(new_n126_));
  oai21  g082(.a(new_n46_), .b(x29), .c(new_n126_), .O(z7));
  inv1   g083(.a(x15), .O(new_n128_));
  nand2  g084(.a(x32), .b(x18), .O(new_n129_));
  nand2  g085(.a(new_n87_), .b(x13), .O(new_n130_));
  nand3  g086(.a(new_n50_), .b(x31), .c(x30), .O(new_n131_));
  ...
  nand2  g091(.a(new_n90_), .b(x14), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n131_), .c(new_n135_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x18), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n133_), .c(new_n84_), .O(new_n139_));
  inv1   g095(.a(x12), .O(new_n140_));
  nand4  g096(.a(new_n50_), .b(x31), .c(x30), .d(x19), .O(new_n141_));
  nor4   g097(.a(new_n141_), .b(new_n87_), .c(x17), .d(new_n140_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  inv1   g099(.a(x16), .O(new_n144_));
  inv1   g100(.a(new_n141_), .O(new_n145_));
  nor2   g101(.a(new_n87_), .b(new_n84_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(x11), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n143_), .c(new_n128_), .O(new_n148_));
  nand3  g104(.a(new_n146_), .b(x16), .c(x15), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n90_), .O(new_n150_));
  nand3  g106(.a(new_n146_), .b(x16), .c(x10), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n128_), .O(new_n152_));
  nand2  g108(.a(new_n146_), .b(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n144_), .O(new_n154_));
  aoi21  g110(.a(x18), .b(x12), .c(x17), .O(new_n155_));
  oai21  g111(.a(x18), .b(x13), .c(x30), .O(new_n156_));
  ...
  nor2   g115(.a(new_n84_), .b(new_n144_), .O(new_n160_));
  nor3   g116(.a(new_n131_), .b(new_n90_), .c(new_n87_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n160_), .c(new_n128_), .d(x10), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n148_), .c(new_n45_), .O(new_n164_));
  ...
  aoi21  g128(.a(new_n172_), .b(new_n171_), .c(new_n84_), .O(new_n173_));
  nand4  g129(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n174_));
  ...
  nand3  g134(.a(new_n178_), .b(new_n144_), .c(x11), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x15), .O(new_n181_));
  nand4  g137(.a(new_n178_), .b(x16), .c(new_n128_), .d(x10), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n170_), .c(new_n54_), .d(new_n113_), .O(new_n184_));
  aoi21  g140(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(x17), .c(x16), .d(x15), .O(new_n186_));
  inv1   g142(.a(new_n155_), .O(new_n187_));
  inv1   g143(.a(x13), .O(new_n188_));
  aoi21  g144(.a(new_n87_), .b(new_n188_), .c(x30), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n187_), .c(new_n154_), .d(new_n152_), .O(new_n190_));
  inv1   g146(.a(new_n190_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n186_), .c(new_n170_), .d(new_n150_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n184_), .c(x31), .O(new_n194_));
  nor3   g150(.a(new_n54_), .b(new_n46_), .c(x29), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n194_), .c(new_n81_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n169_), .O(z9));
endmodule
