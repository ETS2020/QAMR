...
module FAU ( 
  ...
  nand4  g088(.a(new_n132_), .b(new_n126_), .c(new_n124_), .d(new_n122_), .O(z7));
  ...
  aoi21  g114(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n159_));
  ...
  nand2  g126(.a(new_n85_), .b(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x31), .O(new_n172_));
  aoi21  g128(.a(new_n169_), .b(new_n82_), .c(new_n172_), .O(new_n173_));
  ...
  nand4  g139(.a(new_n150_), .b(new_n179_), .c(new_n129_), .d(new_n112_), .O(new_n184_));
  nand2  g140(.a(x33), .b(x30), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g142(.a(new_n169_), .b(new_n82_), .O(new_n187_));
