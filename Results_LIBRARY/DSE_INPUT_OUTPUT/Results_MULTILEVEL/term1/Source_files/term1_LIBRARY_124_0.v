...
module FAU ( 
  ...
  nand4  g065(.a(new_n109_), .b(new_n93_), .c(new_n62_), .d(new_n81_), .O(new_n110_));
  ...
  nand2  g075(.a(new_n91_), .b(new_n88_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n123_), .b(new_n120_), .c(new_n84_), .O(new_n124_));
  nor2   g080(.a(new_n87_), .b(x24), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n89_), .c(x16), .d(x15), .O(new_n126_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n121_), .c(new_n87_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n90_), .c(new_n89_), .d(x17), .O(new_n131_));
  nand2  g087(.a(new_n83_), .b(x29), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n131_), .c(new_n128_), .d(new_n119_), .O(new_n133_));
  aoi22  g089(.a(new_n133_), .b(new_n114_), .c(new_n93_), .d(new_n105_), .O(new_n134_));
  nand4  g090(.a(new_n93_), .b(new_n46_), .c(x29), .d(x28), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x27), .c(x11), .O(new_n137_));
  oai21  g093(.a(new_n134_), .b(new_n46_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n60_), .O(z6));
  ...
  nand4  g100(.a(new_n91_), .b(new_n88_), .c(new_n86_), .d(new_n144_), .O(new_n145_));
  nor2   g101(.a(new_n61_), .b(new_n60_), .O(new_n146_));
  inv1   g102(.a(x31), .O(new_n147_));
  nand4  g103(.a(new_n107_), .b(new_n147_), .c(x30), .d(x29), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n146_), .c(new_n81_), .d(x25), .O(new_n149_));
  ...
  aoi21  g116(.a(new_n160_), .b(new_n159_), .c(new_n116_), .O(new_n161_));
  nand3  g117(.a(x19), .b(x18), .c(x17), .O(new_n162_));
  nor3   g118(.a(new_n162_), .b(x16), .c(new_n45_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n161_), .c(x15), .O(new_n164_));
  inv1   g120(.a(new_n162_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x16), .c(new_n115_), .d(x10), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n154_), .c(x31), .d(x30), .O(new_n168_));
  ...
  nand4  g127(.a(x19), .b(x18), .c(x17), .d(new_n116_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n161_), .c(x15), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n166_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n154_), .c(x31), .d(new_n46_), .O(new_n176_));
  ...
  nand2  g135(.a(new_n89_), .b(x14), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x18), .c(x17), .d(x16), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n115_), .O(new_n182_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n184_), .c(new_n115_), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n45_), .c(new_n116_), .O(new_n188_));
  aoi21  g144(.a(x18), .b(x12), .c(x17), .O(new_n189_));
  nor2   g145(.a(x18), .b(x13), .O(new_n190_));
  nor3   g146(.a(new_n190_), .b(new_n189_), .c(new_n147_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n188_), .c(new_n187_), .d(new_n185_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n182_), .c(x32), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n179_), .c(new_n171_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n81_), .c(x00), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n47_), .O(z8));
  inv1   g152(.a(x33), .O(new_n197_));
  nand4  g153(.a(new_n167_), .b(new_n197_), .c(x31), .d(x30), .O(new_n198_));
  nand2  g154(.a(x33), .b(new_n46_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n152_), .c(x29), .O(new_n201_));
  nand4  g157(.a(new_n175_), .b(new_n197_), .c(new_n147_), .d(new_n46_), .O(new_n202_));
  nand2  g158(.a(x33), .b(x30), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n153_), .O(new_n205_));
  inv1   g161(.a(new_n189_), .O(new_n206_));
  inv1   g162(.a(new_n190_), .O(new_n207_));
  xnor2a g163(.a(x31), .b(x30), .O(new_n208_));
  nand3  g164(.a(new_n208_), .b(new_n207_), .c(new_n206_), .O(new_n209_));
  inv1   g165(.a(new_n209_), .O(new_n210_));
  nand4  g166(.a(new_n210_), .b(new_n188_), .c(new_n187_), .d(new_n185_), .O(new_n211_));
  oai21  g167(.a(new_n211_), .b(new_n182_), .c(x33), .O(new_n212_));
  nand3  g168(.a(new_n212_), .b(new_n205_), .c(new_n201_), .O(new_n213_));
  nand3  g169(.a(new_n213_), .b(new_n81_), .c(x00), .O(new_n214_));
