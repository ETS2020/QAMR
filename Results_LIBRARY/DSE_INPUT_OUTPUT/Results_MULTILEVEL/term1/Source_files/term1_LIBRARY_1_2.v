...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n58_), .c(x30), .d(new_n81_), .O(new_n95_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n94_), .c(new_n58_), .d(x30), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n80_), .c(x25), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(x30), .c(new_n104_), .O(z5));
  nand3  g069(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n58_), .d(x30), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n80_), .c(x25), .d(x01), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(z6));
  nand2  g074(.a(new_n114_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n120_));
  nand3  g076(.a(new_n58_), .b(x25), .c(x01), .O(new_n121_));
  inv1   g077(.a(x31), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(x29), .c(x28), .d(x27), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x30), .c(new_n80_), .O(new_n124_));
  ...
  nand2  g083(.a(new_n91_), .b(x14), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n91_), .O(new_n133_));
  ...
  nand2  g099(.a(new_n105_), .b(new_n81_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n144_), .b(new_n45_), .c(x29), .d(new_n104_), .O(new_n151_));
  ...
  oai21  g128(.a(new_n172_), .b(new_n130_), .c(new_n46_), .O(new_n173_));
  aoi21  g129(.a(new_n145_), .b(new_n122_), .c(x30), .O(new_n174_));
  nor2   g130(.a(new_n122_), .b(new_n107_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n144_), .c(new_n45_), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(new_n104_), .c(new_n176_), .O(new_n177_));
  ...
  nand4  g137(.a(new_n145_), .b(new_n122_), .c(new_n45_), .d(new_n104_), .O(new_n182_));
