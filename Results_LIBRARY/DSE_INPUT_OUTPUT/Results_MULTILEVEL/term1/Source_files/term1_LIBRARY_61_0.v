...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n61_), .d(x30), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n91_), .c(x25), .d(x01), .O(new_n105_));
  ...
  nand2  g078(.a(new_n122_), .b(new_n91_), .O(z7));
  ...
  nand4  g119(.a(new_n163_), .b(x30), .c(new_n91_), .d(x00), .O(new_n164_));
  ...
  nand4  g131(.a(new_n175_), .b(x30), .c(new_n91_), .d(x00), .O(new_n176_));
