...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n79_), .c(x31), .O(new_n97_));
  nand3  g053(.a(new_n45_), .b(x28), .c(x27), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(new_n45_), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n95_), .c(new_n94_), .d(new_n78_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n93_), .c(new_n61_), .O(z5));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n84_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n94_), .c(new_n78_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n61_), .c(new_n48_), .O(z6));
  nor4   g065(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n110_));
  nand4  g066(.a(new_n94_), .b(new_n78_), .c(x25), .d(x01), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(new_n48_), .O(new_n112_));
  nand4  g068(.a(x30), .b(x29), .c(x28), .d(x27), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n112_), .O(z7));
  inv1   g071(.a(x00), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand2  g073(.a(new_n96_), .b(new_n79_), .O(new_n118_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(new_n49_), .O(new_n136_));
  nand2  g092(.a(x32), .b(x30), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(x30), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n118_), .c(x29), .O(new_n139_));
  nand2  g095(.a(new_n118_), .b(x29), .O(new_n140_));
  oai21  g096(.a(new_n135_), .b(new_n133_), .c(new_n140_), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(x32), .O(new_n142_));
  aoi21  g098(.a(new_n123_), .b(x14), .c(new_n121_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x17), .c(x16), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n119_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nor2   g102(.a(new_n121_), .b(new_n120_), .O(new_n147_));
  ...
  nor2   g110(.a(x18), .b(x13), .O(new_n155_));
  nor2   g111(.a(x30), .b(x28), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n79_), .c(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n158_));
  aoi21  g114(.a(new_n148_), .b(new_n123_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n146_), .c(new_n49_), .O(new_n160_));
  aoi21  g116(.a(new_n142_), .b(x30), .c(new_n160_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n139_), .c(new_n117_), .O(new_n162_));
  nand2  g118(.a(x31), .b(x30), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(x32), .c(new_n45_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n162_), .c(new_n78_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n116_), .O(z8));
  nand2  g123(.a(new_n148_), .b(new_n123_), .O(new_n168_));
  nor2   g124(.a(new_n155_), .b(new_n153_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n152_), .c(new_n150_), .d(new_n168_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n145_), .c(new_n48_), .O(new_n171_));
  nand2  g127(.a(new_n117_), .b(new_n102_), .O(new_n172_));
  nand2  g128(.a(new_n118_), .b(x30), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(x31), .c(new_n172_), .d(new_n45_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  nand4  g132(.a(new_n118_), .b(x31), .c(x30), .d(x29), .O(new_n177_));
  oai21  g133(.a(new_n172_), .b(x29), .c(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n135_), .b(new_n133_), .c(new_n178_), .O(new_n179_));
