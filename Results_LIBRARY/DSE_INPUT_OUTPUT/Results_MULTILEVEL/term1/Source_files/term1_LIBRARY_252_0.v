...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n93_), .c(new_n60_), .d(new_n80_), .O(new_n98_));
  ...
  nand2  g067(.a(new_n111_), .b(x01), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x30), .O(new_n113_));
  nand3  g069(.a(new_n95_), .b(x30), .c(x29), .O(new_n114_));
  ...
  nor2   g075(.a(x26), .b(new_n79_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n119_), .c(new_n115_), .d(new_n60_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x01), .O(new_n122_));
  ...
  nor3   g094(.a(new_n138_), .b(new_n137_), .c(new_n110_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n128_), .c(new_n56_), .O(new_n141_));
  nor2   g097(.a(x28), .b(x27), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n94_), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n102_), .c(x01), .O(new_n145_));
  inv1   g101(.a(new_n142_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x30), .c(x29), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n145_), .c(new_n141_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nand4  g106(.a(new_n146_), .b(new_n102_), .c(x29), .d(x01), .O(new_n151_));
  oai21  g107(.a(new_n143_), .b(new_n102_), .c(new_n151_), .O(new_n152_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n152_), .c(new_n150_), .d(x31), .O(new_n168_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n128_), .c(x33), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n180_), .c(new_n176_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n80_), .c(x00), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n56_), .O(z9));
endmodule
