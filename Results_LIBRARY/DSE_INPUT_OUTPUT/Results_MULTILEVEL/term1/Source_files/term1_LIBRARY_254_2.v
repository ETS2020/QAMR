...
module FAU ( 
  ...
  nand3  g066(.a(new_n110_), .b(x30), .c(new_n80_), .O(new_n111_));
  nand3  g067(.a(new_n103_), .b(new_n45_), .c(x29), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n100_), .c(new_n61_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n59_), .c(new_n46_), .O(z6));
  ...
  oai22  g129(.a(new_n173_), .b(new_n156_), .c(new_n45_), .d(new_n80_), .O(new_n174_));
  nand2  g130(.a(new_n149_), .b(new_n123_), .O(new_n175_));
  nor2   g131(.a(new_n123_), .b(new_n101_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n128_), .c(new_n45_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n80_), .c(new_n175_), .d(new_n45_), .O(new_n178_));
