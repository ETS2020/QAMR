...
module FAU ( 
  ...
  nand2  g016(.a(new_n60_), .b(new_n51_), .O(new_n61_));
  inv1   g017(.a(new_n60_), .O(new_n62_));
  ...
  nor4   g047(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n69_), .c(new_n68_), .d(new_n87_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n86_), .c(x25), .d(x01), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z3));
  nand3  g053(.a(new_n68_), .b(x28), .c(new_n87_), .O(new_n98_));
  oai21  g054(.a(x28), .b(new_n87_), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n93_), .c(new_n69_), .d(new_n86_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x25), .c(x01), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n68_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n93_), .c(new_n69_), .d(new_n86_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x25), .c(x01), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n68_), .O(z5));
  ...
  nand4  g074(.a(new_n118_), .b(new_n69_), .c(new_n86_), .d(x25), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n58_), .c(new_n68_), .O(z6));
  oai21  g076(.a(x31), .b(new_n59_), .c(new_n113_), .O(new_n121_));
  nor4   g077(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n122_));
  nand4  g078(.a(new_n69_), .b(new_n86_), .c(x25), .d(x01), .O(new_n123_));
  ...
  nand3  g083(.a(new_n106_), .b(new_n127_), .c(x29), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nor2   g085(.a(new_n127_), .b(x30), .O(new_n130_));
  aoi22  g086(.a(new_n130_), .b(x06), .c(new_n129_), .d(x30), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n124_), .O(z7));
  nand2  g088(.a(new_n105_), .b(new_n87_), .O(new_n133_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n134_), .c(x31), .d(new_n113_), .O(new_n153_));
  ...
  nand2  g114(.a(x32), .b(new_n113_), .O(new_n159_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n86_), .c(x00), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n68_), .O(z8));
  nor2   g135(.a(new_n173_), .b(new_n172_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n171_), .c(new_n169_), .d(new_n167_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n164_), .c(new_n68_), .O(new_n182_));
  aoi21  g138(.a(new_n157_), .b(new_n127_), .c(x30), .O(new_n183_));
  nor2   g139(.a(new_n127_), .b(new_n104_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n133_), .c(new_n113_), .O(new_n185_));
  aoi21  g141(.a(new_n183_), .b(x06), .c(new_n185_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand4  g144(.a(new_n157_), .b(new_n127_), .c(new_n113_), .d(x06), .O(new_n189_));
  ...
  nand3  g149(.a(new_n193_), .b(new_n86_), .c(x00), .O(new_n194_));
