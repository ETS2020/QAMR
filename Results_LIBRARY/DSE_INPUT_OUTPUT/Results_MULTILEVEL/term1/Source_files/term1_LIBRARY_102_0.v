...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n98_));
  ...
  oai21  g063(.a(new_n107_), .b(new_n59_), .c(new_n47_), .O(z6));
  ...
  nand4  g074(.a(new_n118_), .b(new_n116_), .c(new_n80_), .d(x25), .O(new_n119_));
  ...
  nor2   g094(.a(new_n138_), .b(new_n117_), .O(new_n139_));
  and2   g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n134_), .c(new_n131_), .d(new_n129_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n126_), .c(new_n47_), .O(new_n142_));
  nor2   g098(.a(x28), .b(x27), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x30), .c(x29), .O(new_n145_));
  nor2   g101(.a(new_n143_), .b(new_n94_), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x33), .c(new_n45_), .O(new_n148_));
  ...
  nand4  g107(.a(new_n144_), .b(x33), .c(new_n45_), .d(x29), .O(new_n152_));
  oai21  g108(.a(new_n146_), .b(new_n45_), .c(new_n152_), .O(new_n153_));
  inv1   g109(.a(x18), .O(new_n154_));
  nand3  g110(.a(x19), .b(new_n154_), .c(x13), .O(new_n155_));
  nand3  g111(.a(new_n123_), .b(x18), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n135_), .O(new_n157_));
  nand4  g113(.a(x19), .b(x18), .c(new_n135_), .d(x12), .O(new_n158_));
  ...
  aoi21  g119(.a(new_n163_), .b(new_n160_), .c(new_n122_), .O(new_n164_));
  nand3  g120(.a(x16), .b(new_n122_), .c(x10), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  or2    g122(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n153_), .c(new_n151_), .d(x31), .O(new_n168_));
  ...
  oai21  g127(.a(new_n166_), .b(new_n164_), .c(new_n46_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n117_), .c(x30), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n144_), .c(x29), .O(new_n174_));
  nand2  g130(.a(x31), .b(x29), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n143_), .c(x30), .O(new_n176_));
  inv1   g132(.a(new_n138_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n137_), .c(new_n134_), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n176_), .c(new_n131_), .d(new_n129_), .O(new_n180_));
  or2    g136(.a(new_n180_), .b(new_n126_), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(x33), .c(x31), .d(new_n45_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n174_), .O(new_n183_));
