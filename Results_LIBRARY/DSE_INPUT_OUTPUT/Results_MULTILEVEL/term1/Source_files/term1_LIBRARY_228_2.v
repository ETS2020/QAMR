...
module FAU ( 
  ...
  nand4  g061(.a(new_n105_), .b(new_n90_), .c(new_n61_), .d(new_n46_), .O(new_n106_));
  ...
  inv1   g101(.a(x06), .O(new_n146_));
  nand2  g102(.a(new_n102_), .b(new_n81_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n45_), .c(new_n146_), .O(new_n149_));
  ...
  nand4  g109(.a(new_n147_), .b(new_n45_), .c(x29), .d(new_n146_), .O(new_n154_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n132_), .c(new_n46_), .O(new_n178_));
  aoi21  g134(.a(new_n148_), .b(new_n123_), .c(x30), .O(new_n179_));
  nor2   g135(.a(new_n123_), .b(new_n101_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n147_), .c(new_n45_), .O(new_n181_));
  aoi21  g137(.a(new_n179_), .b(new_n146_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  aoi21  g140(.a(new_n167_), .b(new_n164_), .c(new_n128_), .O(new_n185_));
  inv1   g141(.a(new_n170_), .O(new_n186_));
  nand4  g142(.a(new_n148_), .b(new_n123_), .c(new_n45_), .d(new_n146_), .O(new_n187_));
