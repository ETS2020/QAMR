...
module FAU ( 
  ...
  aoi21  g035(.a(new_n79_), .b(new_n57_), .c(new_n56_), .O(z2));
  ...
  nand4  g043(.a(new_n87_), .b(new_n81_), .c(new_n57_), .d(x25), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n60_), .c(new_n45_), .O(z3));
  inv1   g045(.a(x25), .O(new_n90_));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n87_), .c(new_n57_), .O(new_n92_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n62_), .d(new_n57_), .O(new_n100_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(new_n57_), .d(x25), .O(new_n110_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n119_), .c(new_n57_), .O(new_n122_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n57_), .c(x00), .O(new_n170_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n57_), .c(x00), .O(new_n189_));
