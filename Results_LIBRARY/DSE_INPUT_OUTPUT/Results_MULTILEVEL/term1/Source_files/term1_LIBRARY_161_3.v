...
module FAU ( 
  ...
  and2   g048(.a(new_n92_), .b(new_n80_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n79_), .c(new_n78_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n77_), .c(new_n60_), .O(z3));
  ...
  nand3  g055(.a(new_n99_), .b(new_n93_), .c(new_n78_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n77_), .c(new_n60_), .O(z4));
  oai21  g057(.a(new_n97_), .b(new_n79_), .c(x29), .O(new_n102_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n80_), .d(new_n78_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n77_), .c(new_n60_), .O(z5));
  nor2   g064(.a(new_n103_), .b(new_n96_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x27), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n104_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n93_), .c(new_n78_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n60_), .c(new_n46_), .O(z6));
  nand3  g069(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n46_), .b(new_n115_), .c(new_n78_), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(new_n53_), .c(new_n77_), .d(new_n60_), .O(new_n117_));
  oai21  g073(.a(new_n114_), .b(new_n90_), .c(new_n117_), .O(z7));
  aoi21  g074(.a(new_n104_), .b(x28), .c(x27), .O(new_n119_));
  oai22  g075(.a(new_n119_), .b(new_n103_), .c(new_n109_), .d(new_n104_), .O(new_n120_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n120_), .c(new_n47_), .d(x31), .O(new_n137_));
  nand2  g093(.a(new_n122_), .b(x14), .O(new_n138_));
  ...
  nand2  g097(.a(new_n141_), .b(new_n104_), .O(new_n142_));
  nand2  g098(.a(x16), .b(x15), .O(new_n143_));
  nand2  g099(.a(x18), .b(x17), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(new_n122_), .O(new_n145_));
  nand2  g101(.a(x16), .b(x10), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(new_n134_), .O(new_n147_));
  inv1   g103(.a(x11), .O(new_n148_));
  oai21  g104(.a(new_n144_), .b(new_n148_), .c(new_n128_), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  aoi21  g106(.a(x18), .b(x12), .c(x17), .O(new_n151_));
  inv1   g107(.a(x13), .O(new_n152_));
  nand2  g108(.a(new_n87_), .b(new_n152_), .O(new_n153_));
  nand3  g109(.a(x30), .b(x29), .c(x28), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n153_), .c(x31), .O(new_n155_));
  nor3   g111(.a(new_n155_), .b(new_n151_), .c(new_n150_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n147_), .c(new_n145_), .d(new_n142_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n140_), .c(x32), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n137_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n78_), .c(x00), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n46_), .O(z8));
  aoi21  g117(.a(new_n87_), .b(new_n152_), .c(new_n151_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n140_), .c(new_n46_), .O(new_n164_));
  nand2  g120(.a(new_n141_), .b(new_n115_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n104_), .O(new_n166_));
  nand3  g122(.a(x31), .b(x29), .c(x28), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(x30), .c(new_n79_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n166_), .c(new_n164_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x33), .O(new_n170_));
  aoi21  g126(.a(new_n131_), .b(new_n127_), .c(new_n134_), .O(new_n171_));
  inv1   g127(.a(new_n135_), .O(new_n172_));
  nand3  g128(.a(new_n109_), .b(x31), .c(x30), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  nor3   g130(.a(x31), .b(x30), .c(x28), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n174_), .c(new_n79_), .O(new_n176_));
  nand3  g132(.a(new_n115_), .b(new_n104_), .c(new_n103_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  oai21  g134(.a(new_n172_), .b(new_n171_), .c(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(x33), .c(new_n170_), .O(new_n180_));
