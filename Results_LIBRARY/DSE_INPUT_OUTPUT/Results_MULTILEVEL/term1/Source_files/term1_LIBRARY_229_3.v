...
module FAU ( 
  ...
  nand3  g055(.a(new_n45_), .b(x28), .c(x27), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n91_), .c(new_n63_), .d(new_n82_), .O(new_n102_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n82_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n61_), .c(new_n48_), .O(z6));
  inv1   g065(.a(new_n88_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n87_), .c(new_n85_), .O(new_n111_));
  nand3  g067(.a(new_n63_), .b(x25), .c(x01), .O(new_n112_));
  ...
  nand2  g079(.a(new_n123_), .b(new_n115_), .O(new_n124_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n119_), .c(new_n48_), .O(new_n136_));
  nand2  g092(.a(new_n98_), .b(new_n83_), .O(new_n137_));
  ...
  nand3  g098(.a(new_n137_), .b(new_n46_), .c(x29), .O(new_n143_));
  oai21  g099(.a(new_n46_), .b(x29), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n131_), .c(x13), .O(new_n145_));
  nand3  g101(.a(new_n116_), .b(x18), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n128_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n128_), .d(x12), .O(new_n148_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n126_), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x15), .O(new_n155_));
  nand4  g111(.a(new_n152_), .b(x16), .c(new_n115_), .d(x10), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n144_), .c(new_n142_), .d(x31), .O(new_n158_));
  ...
  nand4  g119(.a(new_n157_), .b(new_n138_), .c(new_n163_), .d(new_n162_), .O(new_n164_));
  nand2  g120(.a(new_n129_), .b(new_n128_), .O(new_n165_));
  nor2   g121(.a(x31), .b(x30), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n132_), .c(new_n165_), .d(new_n127_), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n138_), .c(new_n124_), .d(new_n122_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n119_), .c(x33), .O(new_n170_));
  oai21  g126(.a(new_n164_), .b(x30), .c(new_n170_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n82_), .c(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n48_), .O(z9));
endmodule
