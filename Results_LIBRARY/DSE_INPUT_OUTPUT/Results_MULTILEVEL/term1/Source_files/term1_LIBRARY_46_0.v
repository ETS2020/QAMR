...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(new_n93_), .c(x30), .O(new_n98_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n61_), .d(x30), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x25), .c(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x30), .c(x26), .O(z5));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n102_), .c(new_n61_), .d(x30), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n96_), .c(x25), .d(x01), .O(new_n115_));
  ...
  nand3  g075(.a(new_n61_), .b(x25), .c(x01), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x29), .c(x28), .d(x27), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x30), .c(new_n96_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n119_), .c(new_n117_), .O(z7));
  ...
  aoi21  g112(.a(new_n85_), .b(new_n156_), .c(new_n121_), .O(new_n157_));
  ...
  nand4  g118(.a(new_n162_), .b(x30), .c(new_n96_), .d(x00), .O(new_n163_));
