...
module FAU ( 
  ...
  nand2  g59(.a(new_n95_), .b(x30), .O(new_n104_));
  inv1   g60(.a(x30), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x28), .c(x27), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(x29), .O(new_n108_));
  nand2  g64(.a(x30), .b(new_n97_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n87_), .c(new_n61_), .d(new_n94_), .O(new_n111_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n95_), .c(x31), .O(new_n116_));
  nand4  g72(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n117_));
  nand3  g73(.a(new_n61_), .b(x01), .c(new_n45_), .O(new_n118_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n95_), .c(new_n94_), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n119_), .c(new_n117_), .d(new_n116_), .O(z7));
  zero   g81(.O(z9));
endmodule
