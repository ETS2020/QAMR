...
module FAU ( 
  ...
  nand3  g066(.a(new_n110_), .b(x30), .c(new_n81_), .O(new_n111_));
  nand3  g067(.a(new_n103_), .b(new_n45_), .c(x29), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n95_), .c(new_n61_), .d(x25), .O(new_n114_));
  ...
  nor2   g079(.a(new_n123_), .b(new_n80_), .O(new_n124_));
  ...
  oai22  g098(.a(new_n142_), .b(new_n130_), .c(new_n45_), .d(new_n81_), .O(new_n143_));
  nor2   g099(.a(x28), .b(x27), .O(new_n144_));
  nor3   g100(.a(new_n144_), .b(new_n45_), .c(new_n101_), .O(new_n145_));
  inv1   g101(.a(new_n144_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(new_n45_), .c(new_n145_), .d(new_n81_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n143_), .c(new_n126_), .O(new_n149_));
  nand3  g105(.a(new_n147_), .b(x30), .c(new_n81_), .O(new_n150_));
  nand3  g106(.a(new_n146_), .b(new_n45_), .c(x29), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n89_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n92_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n86_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n156_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n137_), .c(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x15), .O(new_n163_));
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n127_), .d(x10), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n152_), .c(new_n126_), .d(x31), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n149_), .c(x00), .O(new_n168_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n146_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n165_), .b(new_n170_), .c(new_n121_), .d(new_n45_), .O(new_n175_));
  ...
  inv1   g134(.a(new_n139_), .O(new_n179_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n130_), .c(x33), .O(new_n185_));
