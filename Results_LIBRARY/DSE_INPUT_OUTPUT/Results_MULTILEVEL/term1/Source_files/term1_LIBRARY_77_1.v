...
module FAU ( 
  ...
  nor2   g041(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(new_n80_), .c(new_n45_), .d(x25), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(new_n61_), .c(new_n48_), .O(z3));
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n62_), .d(new_n45_), .O(new_n98_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n61_), .c(new_n48_), .O(z6));
  ...
  nor2   g071(.a(new_n56_), .b(new_n61_), .O(new_n116_));
  inv1   g072(.a(x25), .O(new_n117_));
  inv1   g073(.a(new_n95_), .O(new_n118_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n116_), .c(new_n115_), .d(new_n111_), .O(z7));
  ...
  nand4  g098(.a(new_n142_), .b(new_n49_), .c(x31), .d(new_n102_), .O(new_n143_));
  ...
  nor3   g119(.a(new_n163_), .b(new_n162_), .c(new_n119_), .O(new_n164_));
  ...
  nand4  g125(.a(new_n142_), .b(new_n53_), .c(x31), .d(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n102_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n124_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n142_), .b(new_n53_), .c(new_n119_), .d(new_n102_), .O(new_n174_));
