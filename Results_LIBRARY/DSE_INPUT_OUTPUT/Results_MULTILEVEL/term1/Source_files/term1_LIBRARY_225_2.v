...
module FAU ( 
  ...
  inv1   g52(.a(new_n60_), .O(new_n97_));
  inv1   g53(.a(x28), .O(new_n98_));
  nor2   g54(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  nor2   g56(.a(x29), .b(new_n98_), .O(new_n101_));
  aoi22  g57(.a(new_n101_), .b(x27), .c(new_n100_), .d(x29), .O(new_n102_));
  nor2   g58(.a(new_n102_), .b(new_n90_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n97_), .c(x25), .d(x01), .O(new_n104_));
  ...
  nand3  g64(.a(new_n99_), .b(new_n108_), .c(x29), .O(new_n109_));
  aoi22  g65(.a(new_n109_), .b(new_n107_), .c(new_n89_), .d(new_n85_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n97_), .c(x25), .d(x01), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n45_), .c(x26), .O(z6));
  inv1   g68(.a(x26), .O(new_n113_));
  nand3  g69(.a(new_n99_), .b(x30), .c(x29), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(x31), .O(new_n115_));
  inv1   g71(.a(new_n87_), .O(new_n116_));
  inv1   g72(.a(new_n88_), .O(new_n117_));
  nor3   g73(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(new_n119_));
  nor2   g75(.a(new_n60_), .b(new_n63_), .O(new_n120_));
  ...
  aoi21  g80(.a(new_n124_), .b(new_n99_), .c(new_n121_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(new_n115_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n45_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n113_), .O(z7));
  zero   g84(.O(z9));
endmodule
