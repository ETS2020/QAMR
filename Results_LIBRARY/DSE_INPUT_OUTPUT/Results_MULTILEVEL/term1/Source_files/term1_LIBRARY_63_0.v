...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n89_), .c(new_n79_), .O(new_n95_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n80_), .c(x29), .O(new_n100_));
  ...
  nor2   g064(.a(new_n99_), .b(new_n80_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n108_), .c(x29), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n107_), .c(new_n88_), .O(new_n111_));
  ...
  nand2  g084(.a(new_n99_), .b(new_n80_), .O(new_n129_));
  ...
  oai21  g110(.a(new_n149_), .b(new_n108_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n134_), .b(x14), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x18), .c(x17), .d(x16), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n146_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  nand2  g115(.a(x18), .b(x17), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n134_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n160_), .c(new_n146_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n160_), .b(new_n164_), .c(new_n140_), .O(new_n165_));
  ...
  aoi21  g127(.a(new_n155_), .b(new_n153_), .c(new_n171_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n152_), .c(x26), .O(z8));
  ...
  nand4  g134(.a(new_n148_), .b(new_n174_), .c(new_n122_), .d(new_n108_), .O(new_n179_));
  nand2  g135(.a(x33), .b(x30), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n153_), .O(new_n182_));
