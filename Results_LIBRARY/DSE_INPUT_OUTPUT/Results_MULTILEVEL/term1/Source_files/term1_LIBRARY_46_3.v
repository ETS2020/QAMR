...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n63_), .d(new_n45_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x25), .c(x01), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n48_), .O(z5));
  nand3  g060(.a(new_n46_), .b(x28), .c(x27), .O(new_n105_));
  oai21  g061(.a(new_n98_), .b(new_n46_), .c(new_n105_), .O(new_n106_));
  nor2   g062(.a(new_n46_), .b(x29), .O(new_n107_));
  aoi21  g063(.a(new_n106_), .b(x29), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n63_), .c(new_n45_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n61_), .O(z6));
  ...
  nor2   g073(.a(new_n62_), .b(new_n61_), .O(new_n118_));
  ...
  nand2  g080(.a(new_n97_), .b(new_n82_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(x31), .d(new_n46_), .O(new_n145_));
  ...
  oai22  g129(.a(new_n173_), .b(new_n156_), .c(x30), .d(new_n45_), .O(new_n174_));
  aoi21  g130(.a(new_n149_), .b(new_n120_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n120_), .b(new_n96_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n125_), .c(new_n46_), .O(new_n177_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n120_), .c(new_n46_), .d(new_n45_), .O(new_n181_));
  ...
  nand2  g141(.a(new_n185_), .b(x00), .O(new_n186_));
