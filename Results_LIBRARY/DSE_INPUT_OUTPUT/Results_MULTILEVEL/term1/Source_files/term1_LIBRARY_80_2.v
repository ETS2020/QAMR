...
module FAU ( 
  ...
  nor2   g046(.a(new_n90_), .b(new_n82_), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(x30), .c(new_n81_), .O(new_n92_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n58_), .c(new_n80_), .d(x25), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x30), .c(new_n101_), .O(z5));
  aoi21  g064(.a(new_n103_), .b(x29), .c(new_n90_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n58_), .c(new_n80_), .d(x25), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x30), .c(new_n101_), .O(z6));
  ...
  nand4  g072(.a(new_n116_), .b(new_n115_), .c(new_n114_), .d(new_n85_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x29), .c(x28), .d(x27), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n58_), .c(new_n80_), .d(x25), .O(new_n120_));
  ...
  oai21  g097(.a(new_n141_), .b(new_n129_), .c(new_n46_), .O(new_n142_));
  nand2  g098(.a(new_n102_), .b(new_n81_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x29), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n45_), .c(new_n101_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n143_), .b(new_n45_), .c(x29), .d(new_n101_), .O(new_n150_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n129_), .c(new_n46_), .O(new_n174_));
  aoi21  g130(.a(new_n144_), .b(new_n118_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n118_), .b(new_n104_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n143_), .c(new_n45_), .O(new_n177_));
  aoi21  g133(.a(new_n175_), .b(new_n101_), .c(new_n177_), .O(new_n178_));
  ...
  nand4  g138(.a(new_n144_), .b(new_n118_), .c(new_n45_), .d(new_n101_), .O(new_n183_));
