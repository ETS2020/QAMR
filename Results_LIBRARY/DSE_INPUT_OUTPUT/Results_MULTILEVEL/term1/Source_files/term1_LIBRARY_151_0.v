...
module FAU ( 
  ...
  oai21  g074(.a(new_n118_), .b(new_n116_), .c(new_n79_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n92_), .O(new_n120_));
  ...
  nor2   g096(.a(new_n140_), .b(new_n94_), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n101_), .c(x01), .O(new_n143_));
  inv1   g099(.a(new_n140_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x30), .c(x29), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n143_), .c(new_n139_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nand4  g104(.a(new_n144_), .b(new_n101_), .c(x29), .d(x01), .O(new_n149_));
  oai21  g105(.a(new_n141_), .b(new_n101_), .c(new_n149_), .O(new_n150_));
  inv1   g106(.a(x17), .O(new_n151_));
  inv1   g107(.a(x18), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n152_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n123_), .b(x18), .c(x14), .O(new_n154_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n133_), .c(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x15), .O(new_n163_));
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n122_), .d(x10), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n150_), .c(new_n148_), .d(x31), .O(new_n166_));
  ...
  nand4  g126(.a(new_n165_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n101_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n144_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n165_), .b(new_n170_), .c(new_n117_), .d(new_n101_), .O(new_n175_));
  ...
  inv1   g134(.a(new_n135_), .O(new_n179_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n134_), .c(new_n131_), .d(new_n129_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n126_), .c(x33), .O(new_n185_));
