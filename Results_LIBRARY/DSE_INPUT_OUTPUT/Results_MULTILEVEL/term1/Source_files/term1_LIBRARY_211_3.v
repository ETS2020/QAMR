...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n61_), .c(new_n48_), .O(z4));
  ...
  nand4  g065(.a(new_n109_), .b(new_n63_), .c(new_n46_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n61_), .c(new_n48_), .O(z6));
  ...
  oai21  g081(.a(new_n46_), .b(x22), .c(new_n125_), .O(z7));
  nand2  g082(.a(new_n96_), .b(new_n82_), .O(new_n127_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(x31), .d(new_n104_), .O(new_n147_));
  ...
  nand2  g108(.a(x32), .b(new_n104_), .O(new_n153_));
  ...
  nand2  g131(.a(x33), .b(new_n104_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n127_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n146_), .b(new_n174_), .c(new_n120_), .d(new_n104_), .O(new_n179_));
  ...
  nand3  g146(.a(new_n190_), .b(new_n46_), .c(x00), .O(new_n191_));
