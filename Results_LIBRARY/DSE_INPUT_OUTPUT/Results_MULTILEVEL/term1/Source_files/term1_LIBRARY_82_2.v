...
module FAU ( 
  ...
  nor3   g027(.a(new_n45_), .b(new_n71_), .c(x04), .O(new_n72_));
  aoi21  g028(.a(new_n71_), .b(x04), .c(new_n72_), .O(new_n73_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n90_), .c(new_n62_), .d(new_n45_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x25), .c(new_n71_), .d(x01), .O(new_n105_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n71_), .c(x26), .O(z6));
  ...
  nand4  g074(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n85_), .O(new_n119_));
  nand3  g075(.a(new_n62_), .b(new_n71_), .c(x01), .O(new_n120_));
  ...
  oai21  g110(.a(new_n149_), .b(new_n109_), .c(new_n154_), .O(new_n155_));
  ...
  nand4  g128(.a(new_n172_), .b(new_n45_), .c(new_n71_), .d(x00), .O(new_n173_));
  ...
  nand4  g135(.a(new_n148_), .b(new_n175_), .c(new_n124_), .d(new_n109_), .O(new_n180_));
  ...
  aoi21  g148(.a(new_n192_), .b(new_n71_), .c(x26), .O(z9));
endmodule
