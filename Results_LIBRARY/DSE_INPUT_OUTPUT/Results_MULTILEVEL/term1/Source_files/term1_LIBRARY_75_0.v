...
module FAU ( 
  ...
  nand4  g074(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n119_));
  nor2   g075(.a(new_n59_), .b(new_n62_), .O(new_n120_));
  ...
  nand2  g101(.a(new_n101_), .b(new_n82_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n109_), .c(x01), .O(new_n148_));
  ...
  nand4  g108(.a(new_n146_), .b(new_n109_), .c(x29), .d(x01), .O(new_n153_));
  ...
  nand4  g126(.a(new_n170_), .b(new_n155_), .c(new_n152_), .d(x31), .O(new_n171_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n132_), .c(new_n46_), .O(new_n177_));
  aoi21  g133(.a(new_n147_), .b(new_n123_), .c(x30), .O(new_n178_));
  nor2   g134(.a(new_n123_), .b(new_n100_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n146_), .c(new_n109_), .O(new_n180_));
  aoi21  g136(.a(new_n178_), .b(x01), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  aoi21  g139(.a(new_n166_), .b(new_n163_), .c(new_n128_), .O(new_n184_));
  inv1   g140(.a(new_n169_), .O(new_n185_));
  nand4  g141(.a(new_n147_), .b(new_n123_), .c(new_n109_), .d(x01), .O(new_n186_));
  nand4  g142(.a(new_n146_), .b(x31), .c(x30), .d(x29), .O(new_n187_));
