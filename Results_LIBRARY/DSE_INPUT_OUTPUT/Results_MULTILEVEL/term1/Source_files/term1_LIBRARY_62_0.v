...
module FAU ( 
  ...
  aoi21  g046(.a(new_n90_), .b(x19), .c(x26), .O(z3));
  xnor2a g047(.a(x28), .b(x27), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n46_), .c(x25), .d(x19), .O(new_n94_));
  ...
  aoi21  g056(.a(new_n100_), .b(new_n98_), .c(new_n96_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n61_), .c(x25), .d(x01), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(x19), .c(x26), .O(z5));
  nand3  g059(.a(x29), .b(x28), .c(x27), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x30), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nor2   g062(.a(new_n97_), .b(new_n80_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n106_), .c(x29), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n105_), .c(new_n96_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n61_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x19), .c(x26), .O(z6));
  inv1   g067(.a(x31), .O(new_n112_));
  nor2   g068(.a(new_n106_), .b(new_n99_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n107_), .c(new_n112_), .O(new_n114_));
  inv1   g070(.a(new_n84_), .O(new_n115_));
  inv1   g071(.a(new_n85_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n115_), .c(new_n83_), .O(new_n117_));
  nor2   g073(.a(new_n60_), .b(new_n59_), .O(new_n118_));
  nand4  g074(.a(new_n107_), .b(new_n112_), .c(x30), .d(x29), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(x25), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n114_), .c(x19), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n46_), .O(z7));
  nand2  g078(.a(new_n97_), .b(new_n80_), .O(new_n123_));
  inv1   g079(.a(x32), .O(new_n124_));
  inv1   g080(.a(x16), .O(new_n125_));
  inv1   g081(.a(x17), .O(new_n126_));
  nand3  g082(.a(x18), .b(new_n126_), .c(x12), .O(new_n127_));
  inv1   g083(.a(x18), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x17), .c(x13), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(new_n125_), .O(new_n130_));
  nand4  g086(.a(x18), .b(x17), .c(new_n125_), .d(x11), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x15), .O(new_n133_));
  inv1   g089(.a(x15), .O(new_n134_));
  nor2   g090(.a(new_n128_), .b(new_n126_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(x16), .c(new_n134_), .d(x10), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n124_), .c(x31), .d(new_n106_), .O(new_n138_));
  nand2  g094(.a(x32), .b(x30), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n123_), .c(x29), .O(new_n141_));
  nand2  g097(.a(new_n123_), .b(x29), .O(new_n142_));
  nand4  g098(.a(new_n137_), .b(new_n124_), .c(x31), .d(x30), .O(new_n143_));
  nand2  g099(.a(x32), .b(new_n106_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g102(.a(new_n128_), .b(x13), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x17), .c(x16), .d(x15), .O(new_n148_));
  nand2  g104(.a(x17), .b(x16), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n134_), .c(new_n128_), .O(new_n150_));
  inv1   g106(.a(x10), .O(new_n151_));
  oai21  g107(.a(new_n149_), .b(new_n151_), .c(new_n134_), .O(new_n152_));
  aoi21  g108(.a(x17), .b(x11), .c(x16), .O(new_n153_));
  nor2   g109(.a(x17), .b(x12), .O(new_n154_));
  nor3   g110(.a(new_n154_), .b(new_n153_), .c(new_n112_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x32), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n146_), .c(new_n141_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x00), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(x19), .c(x26), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  nand4  g117(.a(new_n137_), .b(new_n161_), .c(x31), .d(x30), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n106_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n123_), .c(x29), .O(new_n165_));
  nand4  g121(.a(new_n137_), .b(new_n161_), .c(new_n112_), .d(new_n106_), .O(new_n166_));
  nand2  g122(.a(x33), .b(x30), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n142_), .O(new_n169_));
  inv1   g125(.a(new_n148_), .O(new_n170_));
  inv1   g126(.a(new_n153_), .O(new_n171_));
  xor2a  g127(.a(x31), .b(x30), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n154_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n171_), .c(new_n152_), .d(new_n150_), .O(new_n174_));
  ...
  aoi21  g133(.a(new_n177_), .b(x19), .c(x26), .O(z9));
endmodule
