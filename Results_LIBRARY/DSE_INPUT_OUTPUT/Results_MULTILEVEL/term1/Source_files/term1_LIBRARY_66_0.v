...
module FAU ( 
  ...
  nand4  g033(.a(new_n77_), .b(x30), .c(new_n59_), .d(x08), .O(new_n78_));
  ...
  nand4  g043(.a(new_n87_), .b(new_n62_), .c(new_n47_), .d(new_n81_), .O(new_n88_));
  ...
  nand4  g049(.a(new_n93_), .b(new_n87_), .c(new_n62_), .d(new_n80_), .O(new_n94_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n87_), .c(new_n62_), .d(new_n47_), .O(new_n102_));
  ...
  nand4  g062(.a(new_n106_), .b(x28), .c(x27), .d(x09), .O(new_n107_));
  ...
  oai21  g069(.a(x31), .b(new_n59_), .c(new_n106_), .O(new_n114_));
  nor4   g070(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n115_));
  nand4  g071(.a(new_n62_), .b(new_n80_), .c(x25), .d(x01), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  nand3  g073(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  nand3  g076(.a(new_n99_), .b(new_n120_), .c(x29), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nor2   g078(.a(new_n120_), .b(x30), .O(new_n123_));
  aoi22  g079(.a(new_n123_), .b(x09), .c(new_n122_), .d(x30), .O(new_n124_));
  ...
  nor2   g100(.a(new_n144_), .b(new_n98_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n106_), .c(x09), .O(new_n147_));
  inv1   g103(.a(new_n144_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(x30), .c(x29), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n147_), .c(new_n143_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  nand4  g107(.a(new_n148_), .b(new_n106_), .c(x29), .d(x09), .O(new_n152_));
  oai21  g108(.a(new_n145_), .b(new_n106_), .c(new_n152_), .O(new_n153_));
  ...
  nand4  g124(.a(new_n168_), .b(new_n153_), .c(new_n48_), .d(x31), .O(new_n169_));
  ...
  nand4  g128(.a(new_n168_), .b(new_n52_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n106_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n148_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n168_), .b(new_n52_), .c(new_n120_), .d(new_n106_), .O(new_n177_));
  ...
  nor2   g137(.a(x31), .b(new_n106_), .O(new_n182_));
  nor3   g138(.a(new_n182_), .b(new_n140_), .c(new_n123_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n181_), .c(new_n138_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n135_), .c(new_n133_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n130_), .c(x33), .O(new_n187_));
