...
module FAU ( 
  ...
  oai21  g064(.a(new_n103_), .b(new_n46_), .c(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x29), .c(new_n45_), .O(new_n110_));
  oai21  g066(.a(new_n46_), .b(x29), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n95_), .c(new_n62_), .d(x25), .O(new_n112_));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n103_), .c(new_n81_), .O(new_n122_));
  ...
  nand2  g083(.a(new_n92_), .b(x14), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n92_), .O(new_n133_));
  ...
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n119_), .O(new_n141_));
  ...
  nand2  g099(.a(new_n102_), .b(new_n82_), .O(new_n144_));
  ...
  nand3  g109(.a(x19), .b(new_n89_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n92_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n86_), .O(new_n156_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n58_), .O(z8));
  ...
  aoi21  g129(.a(new_n145_), .b(new_n119_), .c(x30), .O(new_n174_));
  nor2   g130(.a(new_n119_), .b(new_n101_), .O(new_n175_));
  ...
  nand4  g137(.a(new_n145_), .b(new_n119_), .c(new_n46_), .d(new_n45_), .O(new_n182_));
  ...
  nand2  g143(.a(new_n187_), .b(new_n58_), .O(z9));
endmodule
