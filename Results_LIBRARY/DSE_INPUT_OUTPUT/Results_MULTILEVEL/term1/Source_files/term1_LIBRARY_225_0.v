...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n80_), .c(x29), .O(new_n97_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(x00), .c(x26), .O(z5));
  nand3  g058(.a(x29), .b(x28), .c(x27), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x30), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nor2   g061(.a(new_n96_), .b(new_n80_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n105_), .c(x29), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n104_), .c(new_n88_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n95_), .c(x25), .d(x01), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x00), .c(x26), .O(z6));
  inv1   g066(.a(x26), .O(new_n111_));
  nand3  g067(.a(new_n106_), .b(x30), .c(x29), .O(new_n112_));
  ...
  nor2   g073(.a(new_n58_), .b(new_n61_), .O(new_n118_));
  ...
  nand2  g107(.a(x32), .b(new_n105_), .O(new_n152_));
  oai21  g108(.a(new_n147_), .b(new_n105_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g129(.a(x33), .b(new_n105_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n127_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n146_), .b(new_n172_), .c(new_n120_), .d(new_n105_), .O(new_n177_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n111_), .c(x00), .O(new_n189_));
