...
module FAU ( 
  ...
  oai21  g064(.a(new_n108_), .b(new_n91_), .c(x17), .O(new_n109_));
  ...
  nand4  g077(.a(new_n107_), .b(new_n90_), .c(new_n87_), .d(x17), .O(new_n122_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(x31), .d(new_n133_), .O(new_n150_));
  nand2  g106(.a(x32), .b(x30), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n132_), .c(x29), .O(new_n153_));
  nand2  g109(.a(new_n132_), .b(x29), .O(new_n154_));
  nand4  g110(.a(new_n149_), .b(new_n134_), .c(x31), .d(x30), .O(new_n155_));
  nand2  g111(.a(x32), .b(new_n133_), .O(new_n156_));
  ...
  nand2  g134(.a(x33), .b(new_n133_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n132_), .c(x29), .O(new_n181_));
  nand4  g137(.a(new_n149_), .b(new_n177_), .c(new_n125_), .d(new_n133_), .O(new_n182_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n119_), .c(new_n45_), .d(x00), .O(new_n194_));
