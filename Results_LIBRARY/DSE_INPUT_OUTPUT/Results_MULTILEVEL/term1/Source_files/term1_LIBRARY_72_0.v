...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n58_), .c(new_n56_), .O(z4));
  ...
  nand2  g057(.a(new_n101_), .b(new_n56_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n60_), .c(new_n80_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n58_), .O(z6));
  inv1   g066(.a(x31), .O(new_n111_));
  nand3  g067(.a(new_n96_), .b(new_n111_), .c(x29), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x30), .O(new_n114_));
  nand3  g070(.a(new_n96_), .b(x30), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x31), .O(new_n116_));
  inv1   g072(.a(new_n84_), .O(new_n117_));
  inv1   g073(.a(new_n85_), .O(new_n118_));
  nor2   g074(.a(new_n83_), .b(new_n82_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n118_), .c(new_n117_), .O(new_n120_));
  nor2   g076(.a(x26), .b(new_n79_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n116_), .d(new_n60_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x01), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n114_), .O(z7));
  nand2  g080(.a(new_n95_), .b(new_n81_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(x31), .d(new_n103_), .O(new_n145_));
  ...
  nand2  g106(.a(x32), .b(new_n103_), .O(new_n151_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n111_), .O(new_n166_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n56_), .O(z8));
  nor2   g127(.a(new_n165_), .b(new_n164_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n156_), .c(new_n56_), .O(new_n174_));
  aoi21  g130(.a(new_n149_), .b(new_n111_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n111_), .b(new_n94_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n125_), .c(new_n103_), .O(new_n177_));
  aoi21  g133(.a(new_n175_), .b(x01), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  nand4  g136(.a(new_n149_), .b(new_n111_), .c(new_n103_), .d(x01), .O(new_n181_));
  nand4  g137(.a(new_n125_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n144_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(x33), .c(new_n180_), .O(new_n185_));
