...
module FAU ( 
  ...
  nand4  g090(.a(new_n134_), .b(new_n116_), .c(new_n49_), .d(x31), .O(new_n135_));
  ...
  oai21  g111(.a(new_n135_), .b(new_n101_), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n45_), .c(new_n93_), .d(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(z8));
  nand2  g114(.a(new_n116_), .b(x29), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n134_), .c(new_n53_), .d(new_n149_), .O(new_n160_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n45_), .c(new_n93_), .d(x00), .O(new_n167_));
