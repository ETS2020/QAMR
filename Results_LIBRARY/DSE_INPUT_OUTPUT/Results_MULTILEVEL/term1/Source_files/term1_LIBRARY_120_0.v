...
module FAU ( 
  ...
  nand3  g041(.a(new_n85_), .b(new_n79_), .c(new_n78_), .O(new_n86_));
  nor3   g042(.a(new_n86_), .b(new_n77_), .c(new_n60_), .O(z3));
  xor2a  g043(.a(x28), .b(x27), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n85_), .c(new_n78_), .d(x25), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(new_n60_), .c(new_n47_), .O(z4));
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n91_), .d(new_n78_), .O(new_n98_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n91_), .c(new_n78_), .d(x25), .O(new_n108_));
  ...
  nor2   g071(.a(new_n54_), .b(new_n60_), .O(new_n116_));
  ...
  nand2  g096(.a(new_n94_), .b(new_n79_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x29), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n102_), .c(x01), .O(new_n143_));
  ...
  nand4  g102(.a(new_n141_), .b(new_n102_), .c(x29), .d(x01), .O(new_n147_));
  nand2  g103(.a(new_n142_), .b(x30), .O(new_n148_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n149_), .c(new_n48_), .d(x31), .O(new_n165_));
  ...
  nor2   g124(.a(new_n137_), .b(new_n136_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n135_), .c(new_n132_), .d(new_n130_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n127_), .c(new_n47_), .O(new_n171_));
  aoi21  g127(.a(new_n142_), .b(new_n118_), .c(x30), .O(new_n172_));
  nor2   g128(.a(new_n118_), .b(new_n93_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n141_), .c(new_n102_), .O(new_n174_));
  aoi21  g130(.a(new_n172_), .b(x01), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  aoi21  g133(.a(new_n160_), .b(new_n157_), .c(new_n123_), .O(new_n178_));
  inv1   g134(.a(new_n163_), .O(new_n179_));
  nand4  g135(.a(new_n142_), .b(new_n118_), .c(new_n102_), .d(x01), .O(new_n180_));
