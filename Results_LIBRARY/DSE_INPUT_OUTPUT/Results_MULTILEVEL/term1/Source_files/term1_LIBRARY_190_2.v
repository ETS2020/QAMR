...
module FAU ( 
  ...
  nand4  g075(.a(new_n119_), .b(new_n59_), .c(new_n82_), .d(x25), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n117_), .c(new_n116_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x30), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x01), .O(z7));
  inv1   g080(.a(x15), .O(new_n125_));
  nand2  g081(.a(new_n92_), .b(x14), .O(new_n126_));
  ...
  oai21  g086(.a(new_n130_), .b(new_n129_), .c(new_n92_), .O(new_n131_));
  ...
  nand2  g097(.a(new_n102_), .b(new_n83_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x29), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n45_), .c(new_n81_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n142_), .b(new_n45_), .c(x29), .d(new_n81_), .O(new_n149_));
  nand2  g105(.a(new_n143_), .b(x30), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand3  g107(.a(x19), .b(new_n89_), .c(x13), .O(new_n152_));
  nand3  g108(.a(new_n92_), .b(x18), .c(x14), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n152_), .c(new_n86_), .O(new_n154_));
  nand4  g110(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n155_));
  ...
  oai21  g126(.a(new_n170_), .b(new_n128_), .c(new_n46_), .O(new_n171_));
  aoi21  g127(.a(new_n143_), .b(new_n118_), .c(x30), .O(new_n172_));
  nor2   g128(.a(new_n118_), .b(new_n104_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n142_), .c(new_n45_), .O(new_n174_));
  aoi21  g130(.a(new_n172_), .b(new_n81_), .c(new_n174_), .O(new_n175_));
  ...
  nand4  g135(.a(new_n143_), .b(new_n118_), .c(new_n45_), .d(new_n81_), .O(new_n180_));
