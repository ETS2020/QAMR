...
module FAU ( 
  ...
  nand3  g014(.a(new_n58_), .b(new_n46_), .c(x06), .O(new_n59_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n119_), .c(new_n47_), .O(new_n122_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n49_), .c(x31), .O(new_n144_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n47_), .c(new_n79_), .d(x00), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(z8));
  aoi21  g125(.a(new_n142_), .b(new_n140_), .c(x33), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x31), .c(x30), .d(x06), .O(new_n171_));
  ...
  nand4  g130(.a(new_n170_), .b(new_n120_), .c(new_n103_), .d(x06), .O(new_n175_));
