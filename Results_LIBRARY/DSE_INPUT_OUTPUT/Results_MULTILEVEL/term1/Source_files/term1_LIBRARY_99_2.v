...
module FAU ( 
  ...
  nor3   g043(.a(new_n87_), .b(new_n79_), .c(new_n62_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n86_), .c(new_n45_), .d(x25), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(new_n62_), .c(new_n48_), .O(z4));
  ...
  nor3   g055(.a(new_n99_), .b(new_n79_), .c(new_n62_), .O(z5));
  ...
  nor2   g070(.a(new_n55_), .b(new_n62_), .O(new_n115_));
  ...
  nor2   g123(.a(new_n161_), .b(new_n160_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n169_));
  oai22  g125(.a(new_n169_), .b(new_n152_), .c(new_n101_), .d(new_n45_), .O(new_n170_));
  nand2  g126(.a(new_n145_), .b(new_n117_), .O(new_n171_));
  nor2   g127(.a(new_n117_), .b(new_n94_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n122_), .c(new_n101_), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(new_n45_), .c(new_n171_), .d(new_n101_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  nand4  g132(.a(new_n122_), .b(x31), .c(x30), .d(x29), .O(new_n177_));
  oai22  g133(.a(new_n177_), .b(x26), .c(new_n171_), .d(x30), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n140_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(x33), .c(new_n176_), .O(new_n180_));
