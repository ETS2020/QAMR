...
module FAU ( 
  ...
  nand4  g031(.a(new_n75_), .b(new_n54_), .c(new_n56_), .d(x08), .O(new_n76_));
  ...
  nand4  g047(.a(new_n91_), .b(new_n59_), .c(new_n54_), .d(new_n79_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n91_), .c(new_n59_), .d(new_n54_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n91_), .c(new_n59_), .d(new_n54_), .O(new_n106_));
  ...
  nand4  g068(.a(new_n110_), .b(x29), .c(x28), .d(x27), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n110_), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n91_), .c(new_n59_), .d(new_n78_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n54_), .O(z6));
  nand3  g074(.a(new_n88_), .b(new_n85_), .c(new_n82_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n89_), .O(new_n120_));
  nand4  g076(.a(new_n59_), .b(new_n78_), .c(x25), .d(x01), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n120_), .c(new_n54_), .O(new_n122_));
  oai21  g078(.a(new_n112_), .b(z0), .c(x30), .O(new_n123_));
  nor4   g079(.a(new_n111_), .b(z0), .c(x31), .d(new_n110_), .O(new_n124_));
  aoi21  g080(.a(new_n123_), .b(x31), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(z7));
  nand2  g082(.a(new_n101_), .b(new_n79_), .O(new_n127_));
  nand3  g083(.a(x19), .b(new_n86_), .c(x13), .O(new_n128_));
  inv1   g084(.a(x19), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x18), .c(x14), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n128_), .c(new_n83_), .O(new_n131_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n127_), .c(x29), .O(new_n146_));
  aoi21  g102(.a(new_n129_), .b(x14), .c(new_n86_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x17), .c(x16), .d(x15), .O(new_n148_));
  nand2  g104(.a(new_n127_), .b(x29), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n110_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x15), .O(new_n151_));
  nand2  g107(.a(x18), .b(x17), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n129_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(new_n141_), .O(new_n155_));
  inv1   g111(.a(x11), .O(new_n156_));
  oai21  g112(.a(new_n152_), .b(new_n156_), .c(new_n135_), .O(new_n157_));
  ...
  aoi21  g117(.a(new_n86_), .b(new_n160_), .c(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n153_), .c(new_n150_), .d(new_n148_), .O(new_n165_));
  ...
  nand4  g126(.a(new_n143_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n110_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n127_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n143_), .b(new_n170_), .c(new_n161_), .d(new_n110_), .O(new_n175_));
  ...
  nand2  g134(.a(new_n86_), .b(new_n160_), .O(new_n179_));
  xnor2a g135(.a(x31), .b(x30), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n159_), .d(new_n157_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n155_), .c(new_n153_), .d(new_n148_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n178_), .c(new_n174_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n78_), .c(x00), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n54_), .O(z9));
endmodule
