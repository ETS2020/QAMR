...
module FAU ( 
  ...
  oai21  g057(.a(new_n101_), .b(new_n82_), .c(new_n45_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n97_), .c(new_n62_), .d(x25), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n61_), .c(new_n48_), .O(z5));
  inv1   g061(.a(x30), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n95_), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  ...
  nand4  g072(.a(new_n98_), .b(new_n100_), .c(new_n99_), .d(new_n116_), .O(new_n117_));
  nor2   g073(.a(new_n56_), .b(new_n61_), .O(new_n118_));
  inv1   g074(.a(new_n95_), .O(new_n119_));
  ...
  nand2  g080(.a(new_n94_), .b(new_n81_), .O(new_n125_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n49_), .c(x31), .d(new_n106_), .O(new_n144_));
  ...
  nand4  g130(.a(new_n143_), .b(new_n53_), .c(new_n120_), .d(new_n106_), .O(new_n175_));
