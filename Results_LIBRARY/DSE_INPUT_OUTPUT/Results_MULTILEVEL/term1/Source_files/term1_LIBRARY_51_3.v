...
module FAU ( 
  ...
  nor3   g056(.a(new_n100_), .b(new_n89_), .c(new_n62_), .O(z5));
  ...
  nand2  g078(.a(new_n96_), .b(new_n80_), .O(new_n123_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n50_), .c(x31), .d(new_n102_), .O(new_n142_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n127_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x10), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n157_), .c(new_n139_), .O(new_n160_));
  inv1   g116(.a(x11), .O(new_n161_));
  oai21  g117(.a(new_n157_), .b(new_n161_), .c(new_n133_), .O(new_n162_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n150_), .c(new_n145_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n46_), .c(x00), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(z8));
  nand4  g126(.a(new_n141_), .b(new_n53_), .c(x31), .d(x30), .O(new_n171_));
  oai21  g127(.a(new_n53_), .b(x30), .c(new_n171_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n123_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n141_), .b(new_n53_), .c(new_n118_), .d(new_n102_), .O(new_n174_));
  oai21  g130(.a(new_n53_), .b(new_n102_), .c(new_n174_), .O(new_n175_));
  inv1   g131(.a(new_n163_), .O(new_n176_));
  inv1   g132(.a(new_n164_), .O(new_n177_));
  xnor2a g133(.a(x31), .b(x30), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n177_), .c(new_n176_), .d(new_n162_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n160_), .c(new_n158_), .d(new_n154_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n46_), .O(new_n183_));
  aoi21  g139(.a(new_n175_), .b(new_n146_), .c(new_n183_), .O(new_n184_));
