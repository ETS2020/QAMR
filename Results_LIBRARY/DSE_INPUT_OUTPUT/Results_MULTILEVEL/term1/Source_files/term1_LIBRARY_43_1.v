...
module FAU ( 
  ...
  oai21  g014(.a(x30), .b(x05), .c(new_n58_), .O(new_n59_));
  nand2  g015(.a(x06), .b(new_n52_), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand4  g017(.a(x06), .b(x05), .c(new_n49_), .d(new_n52_), .O(new_n62_));
  aoi21  g018(.a(new_n62_), .b(new_n61_), .c(x01), .O(new_n63_));
  inv1   g019(.a(new_n46_), .O(new_n64_));
  xor2a  g020(.a(x03), .b(x02), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(new_n64_), .c(x01), .O(new_n66_));
  inv1   g022(.a(new_n66_), .O(new_n67_));
  oai21  g023(.a(new_n67_), .b(new_n63_), .c(new_n57_), .O(new_n68_));
  xnor2a g024(.a(x07), .b(x04), .O(new_n69_));
  nand3  g025(.a(new_n59_), .b(x06), .c(new_n52_), .O(new_n70_));
  nand3  g026(.a(new_n60_), .b(x05), .c(new_n49_), .O(new_n71_));
  ...
  oai21  g063(.a(new_n100_), .b(new_n45_), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n45_), .b(x29), .O(new_n109_));
  ...
  oai21  g070(.a(x31), .b(x30), .c(new_n114_), .O(new_n115_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(x31), .d(new_n45_), .O(new_n148_));
  ...
  nand2  g133(.a(new_n152_), .b(new_n123_), .O(new_n178_));
  nor2   g134(.a(new_n123_), .b(new_n98_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n128_), .c(new_n45_), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(x05), .c(new_n178_), .d(new_n45_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand4  g139(.a(new_n128_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
  oai22  g140(.a(new_n184_), .b(new_n114_), .c(new_n178_), .d(x30), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n147_), .O(new_n186_));
