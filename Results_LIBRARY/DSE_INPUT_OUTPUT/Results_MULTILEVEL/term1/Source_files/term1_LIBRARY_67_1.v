...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n45_), .c(new_n80_), .O(new_n94_));
  ...
  nand3  g054(.a(new_n98_), .b(new_n93_), .c(new_n45_), .O(new_n99_));
  ...
  nor2   g072(.a(new_n116_), .b(new_n90_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand4  g074(.a(new_n60_), .b(new_n118_), .c(x25), .d(x01), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n117_), .c(new_n45_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n79_), .O(z7));
  inv1   g077(.a(x32), .O(new_n122_));
  nand2  g078(.a(new_n103_), .b(new_n80_), .O(new_n123_));
  nand3  g079(.a(x19), .b(new_n87_), .c(x13), .O(new_n124_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n123_), .c(new_n122_), .d(x31), .O(new_n140_));
  aoi21  g096(.a(new_n125_), .b(x14), .c(new_n87_), .O(new_n141_));
  ...
  nor2   g109(.a(new_n118_), .b(new_n105_), .O(new_n154_));
  ...
  oai21  g115(.a(new_n140_), .b(new_n105_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x00), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n45_), .c(x26), .O(z8));
  inv1   g118(.a(x33), .O(new_n163_));
  nand2  g119(.a(new_n123_), .b(x29), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n139_), .c(new_n163_), .d(new_n118_), .O(new_n165_));
  aoi21  g121(.a(new_n87_), .b(new_n152_), .c(x31), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n151_), .c(new_n149_), .d(new_n147_), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n164_), .c(new_n145_), .d(new_n142_), .O(new_n169_));
