// Benchmark "FAU" written by ABC on Fri Aug 14 02:51:14 2020
...
module FAU ( 
  ...
  nor3   g047(.a(new_n91_), .b(new_n80_), .c(new_n59_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n61_), .c(new_n45_), .d(x25), .O(new_n109_));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n96_), .c(new_n80_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n117_), .c(new_n116_), .d(new_n112_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n45_), .O(new_n123_));
  nand2  g079(.a(x26), .b(x00), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n123_), .O(z7));
  nand2  g081(.a(new_n95_), .b(new_n81_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(x31), .d(new_n103_), .O(new_n146_));
  ...
  nand2  g107(.a(x32), .b(new_n103_), .O(new_n152_));
  ...
  nor3   g122(.a(new_n166_), .b(new_n165_), .c(new_n118_), .O(new_n167_));
  ...
  nand2  g130(.a(x33), .b(new_n103_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n126_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n145_), .b(new_n173_), .c(new_n118_), .d(new_n103_), .O(new_n178_));
  ...
  nand3  g145(.a(new_n189_), .b(new_n45_), .c(x00), .O(new_n190_));
