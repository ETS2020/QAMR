...
module FAU ( 
  ...
  oai21  g049(.a(new_n93_), .b(new_n45_), .c(new_n46_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n92_), .c(new_n78_), .d(x25), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n45_), .c(new_n46_), .O(z4));
  ...
  nand4  g058(.a(new_n102_), .b(new_n100_), .c(new_n91_), .d(x29), .O(new_n103_));
  inv1   g059(.a(x29), .O(new_n104_));
  nand4  g060(.a(new_n91_), .b(new_n104_), .c(x28), .d(x27), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n45_), .c(new_n103_), .O(new_n106_));
  ...
  nand4  g065(.a(new_n101_), .b(x28), .c(x27), .d(x01), .O(new_n110_));
  oai21  g066(.a(new_n99_), .b(new_n101_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x29), .O(new_n112_));
  oai21  g068(.a(new_n101_), .b(x29), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n91_), .c(new_n59_), .d(new_n78_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n109_), .c(new_n46_), .O(z6));
  nand3  g071(.a(new_n99_), .b(x30), .c(x29), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  nand4  g073(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n81_), .O(new_n118_));
  nor2   g074(.a(new_n58_), .b(new_n45_), .O(new_n119_));
  ...
  nand2  g097(.a(new_n98_), .b(new_n79_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x30), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n104_), .O(new_n144_));
  nand2  g100(.a(new_n142_), .b(x29), .O(new_n145_));
  aoi22  g101(.a(new_n145_), .b(new_n101_), .c(new_n144_), .d(x01), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  inv1   g104(.a(x32), .O(new_n149_));
  nand3  g105(.a(new_n145_), .b(x30), .c(x01), .O(new_n150_));
  nand3  g106(.a(new_n142_), .b(new_n101_), .c(x29), .O(new_n151_));
  ...
  nand2  g128(.a(new_n145_), .b(new_n120_), .O(new_n173_));
  nor2   g129(.a(new_n120_), .b(new_n104_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n142_), .c(new_n101_), .O(new_n175_));
  aoi22  g131(.a(new_n175_), .b(x01), .c(new_n173_), .d(new_n101_), .O(new_n176_));
  ...
  oai22  g136(.a(new_n180_), .b(new_n45_), .c(new_n173_), .d(x30), .O(new_n181_));
