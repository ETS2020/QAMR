...
module FAU ( 
  ...
  nand2  g034(.a(x32), .b(x26), .O(new_n79_));
  ...
  nand2  g058(.a(new_n102_), .b(new_n79_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n61_), .c(new_n46_), .d(x25), .O(new_n110_));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n97_), .c(new_n90_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n118_), .c(new_n117_), .d(new_n113_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n46_), .O(new_n124_));
  oai21  g080(.a(x32), .b(new_n46_), .c(new_n124_), .O(z7));
  nand2  g081(.a(new_n96_), .b(new_n81_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n144_), .b(z0), .c(x31), .d(new_n104_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n144_), .b(z0), .c(x31), .d(x30), .O(new_n150_));
  ...
  nand4  g127(.a(new_n144_), .b(new_n47_), .c(x31), .d(x30), .O(new_n172_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n47_), .c(new_n119_), .d(new_n104_), .O(new_n176_));
