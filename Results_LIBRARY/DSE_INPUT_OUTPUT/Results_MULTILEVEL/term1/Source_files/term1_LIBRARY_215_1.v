...
module FAU ( 
  ...
  nor3   g054(.a(new_n98_), .b(new_n88_), .c(new_n45_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x28), .c(x27), .O(new_n101_));
  oai21  g057(.a(new_n95_), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nor2   g058(.a(new_n100_), .b(x29), .O(new_n103_));
  aoi21  g059(.a(new_n102_), .b(x29), .c(new_n103_), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n84_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n45_), .O(z6));
  oai21  g063(.a(x31), .b(new_n45_), .c(new_n100_), .O(new_n108_));
  nand3  g064(.a(x29), .b(x28), .c(x27), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x31), .O(new_n110_));
  inv1   g066(.a(new_n82_), .O(new_n111_));
  ...
  nor2   g070(.a(new_n58_), .b(new_n88_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x30), .c(x29), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n95_), .c(x26), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n115_), .c(new_n114_), .d(new_n110_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x01), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n108_), .O(z7));
  nand2  g078(.a(new_n94_), .b(new_n79_), .O(new_n123_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(x31), .d(new_n100_), .O(new_n143_));
  ...
  nand2  g104(.a(x32), .b(new_n100_), .O(new_n149_));
  ...
  nand2  g127(.a(x33), .b(new_n100_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n123_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n142_), .b(new_n170_), .c(new_n116_), .d(new_n100_), .O(new_n175_));
