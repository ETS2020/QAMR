...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n45_), .c(new_n47_), .O(z4));
  ...
  nor2   g073(.a(new_n60_), .b(new_n45_), .O(new_n118_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n156_), .c(new_n47_), .O(new_n174_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n120_), .c(new_n46_), .d(x01), .O(new_n181_));
