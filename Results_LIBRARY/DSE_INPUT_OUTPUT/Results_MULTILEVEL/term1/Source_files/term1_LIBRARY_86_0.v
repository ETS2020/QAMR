...
module FAU ( 
  ...
  nor2   g047(.a(new_n46_), .b(x23), .O(new_n92_));
  aoi22  g048(.a(new_n92_), .b(new_n82_), .c(new_n91_), .d(new_n47_), .O(new_n93_));
  ...
  nand3  g052(.a(x30), .b(x28), .c(new_n81_), .O(new_n97_));
  oai21  g053(.a(x28), .b(new_n81_), .c(new_n97_), .O(new_n98_));
  nand2  g054(.a(new_n45_), .b(new_n82_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n61_), .O(new_n101_));
  nand4  g057(.a(new_n91_), .b(new_n61_), .c(x28), .d(new_n81_), .O(new_n102_));
  ...
  nand3  g070(.a(new_n108_), .b(new_n100_), .c(x30), .O(new_n115_));
  nand4  g071(.a(new_n91_), .b(new_n46_), .c(x28), .d(x27), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n115_), .c(new_n110_), .O(new_n117_));
  nand2  g073(.a(new_n91_), .b(x30), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n99_), .c(x29), .O(new_n119_));
  or2    g075(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n59_), .c(new_n47_), .O(z6));
  oai21  g078(.a(x31), .b(new_n45_), .c(new_n46_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x18), .O(new_n130_));
  inv1   g086(.a(x31), .O(new_n131_));
  nand3  g087(.a(new_n107_), .b(new_n131_), .c(x29), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n127_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x30), .O(new_n134_));
  nor2   g090(.a(new_n131_), .b(x30), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n129_), .c(x23), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n134_), .c(new_n125_), .O(z7));
  nand2  g093(.a(new_n106_), .b(new_n81_), .O(new_n138_));
  inv1   g094(.a(x32), .O(new_n139_));
  nand3  g095(.a(x19), .b(new_n82_), .c(x13), .O(new_n140_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n139_), .c(x31), .d(new_n46_), .O(new_n155_));
  ...
  nand4  g115(.a(new_n154_), .b(new_n139_), .c(x31), .d(x30), .O(new_n160_));
  ...
  nand2  g119(.a(new_n88_), .b(x14), .O(new_n164_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n167_), .c(new_n88_), .O(new_n169_));
  ...
  oai21  g139(.a(new_n183_), .b(new_n166_), .c(new_n47_), .O(new_n184_));
  aoi21  g140(.a(new_n159_), .b(new_n131_), .c(x30), .O(new_n185_));
  nor2   g141(.a(new_n131_), .b(new_n110_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n138_), .c(new_n46_), .O(new_n187_));
  aoi21  g143(.a(new_n185_), .b(x23), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n184_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand4  g146(.a(new_n159_), .b(new_n131_), .c(new_n46_), .d(x23), .O(new_n191_));
  nand4  g147(.a(new_n138_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
