...
module FAU ( 
  ...
  nand3  g031(.a(new_n75_), .b(new_n62_), .c(new_n45_), .O(new_n76_));
  ...
  nor3   g045(.a(new_n89_), .b(new_n80_), .c(new_n45_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n88_), .c(new_n81_), .d(x25), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n45_), .c(new_n46_), .O(z4));
  ...
  nand3  g060(.a(new_n62_), .b(x28), .c(x27), .O(new_n105_));
  oai21  g061(.a(new_n98_), .b(new_n62_), .c(new_n105_), .O(new_n106_));
  nor2   g062(.a(new_n62_), .b(x29), .O(new_n107_));
  aoi21  g063(.a(new_n106_), .b(x29), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n45_), .O(z6));
  ...
  nor2   g073(.a(new_n59_), .b(new_n45_), .O(new_n118_));
  ...
  nor2   g078(.a(new_n122_), .b(new_n80_), .O(new_n123_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(x31), .d(new_n62_), .O(new_n145_));
  ...
  nand2  g106(.a(x32), .b(new_n62_), .O(new_n151_));
  ...
  nand2  g130(.a(new_n149_), .b(new_n120_), .O(new_n175_));
  nor2   g131(.a(new_n120_), .b(new_n96_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n125_), .c(new_n62_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(x01), .c(new_n175_), .d(new_n62_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  nand4  g136(.a(new_n125_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  oai22  g137(.a(new_n181_), .b(new_n45_), .c(new_n175_), .d(x30), .O(new_n182_));
