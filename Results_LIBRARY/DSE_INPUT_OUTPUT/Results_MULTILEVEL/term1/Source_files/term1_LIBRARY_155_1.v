...
module FAU ( 
  ...
  nand4  g091(.a(new_n135_), .b(new_n117_), .c(new_n116_), .d(x31), .O(new_n136_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n149_), .c(new_n147_), .d(new_n117_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  and2   g109(.a(new_n153_), .b(new_n145_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n143_), .c(new_n141_), .d(new_n138_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  oai21  g112(.a(new_n136_), .b(new_n101_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x00), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n45_), .c(x26), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  nand2  g116(.a(new_n117_), .b(x29), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n135_), .c(new_n160_), .d(new_n150_), .O(new_n162_));
  aoi21  g118(.a(new_n119_), .b(new_n148_), .c(x31), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n161_), .c(new_n141_), .d(new_n138_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x33), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n169_));
