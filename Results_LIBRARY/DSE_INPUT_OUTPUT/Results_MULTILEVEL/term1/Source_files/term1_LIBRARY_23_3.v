...
module FAU ( 
  ...
  nand3  g045(.a(new_n89_), .b(new_n83_), .c(new_n46_), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n82_), .c(new_n63_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n89_), .c(new_n46_), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n82_), .c(new_n63_), .O(z4));
  ...
  nor3   g057(.a(new_n101_), .b(new_n82_), .c(new_n63_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n64_), .c(new_n46_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n63_), .O(z6));
  ...
  nand4  g098(.a(new_n142_), .b(new_n50_), .c(x31), .d(new_n103_), .O(new_n143_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n49_), .O(z9));
endmodule
