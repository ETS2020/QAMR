...
module FAU ( 
  ...
  nand3  g079(.a(new_n123_), .b(new_n119_), .c(new_n117_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n95_), .O(z7));
  inv1   g082(.a(x32), .O(new_n127_));
  nand2  g083(.a(new_n102_), .b(new_n79_), .O(new_n128_));
  ...
  aoi21  g101(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n146_));
  ...
  aoi21  g113(.a(new_n84_), .b(new_n157_), .c(new_n120_), .O(new_n158_));
  ...
  nand4  g119(.a(new_n163_), .b(x30), .c(new_n95_), .d(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n144_), .b(new_n128_), .c(new_n166_), .d(x31), .O(new_n167_));
  nand2  g123(.a(new_n84_), .b(new_n157_), .O(new_n168_));
  nor2   g124(.a(new_n120_), .b(new_n104_), .O(new_n169_));
  ...
  oai21  g130(.a(new_n167_), .b(new_n104_), .c(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x30), .c(new_n95_), .d(x00), .O(new_n176_));
