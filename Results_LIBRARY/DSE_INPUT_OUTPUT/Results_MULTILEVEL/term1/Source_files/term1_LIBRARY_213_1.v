...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n61_), .c(new_n48_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n87_), .c(new_n80_), .d(x25), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n61_), .c(new_n48_), .O(z4));
  ...
  nand4  g053(.a(new_n97_), .b(new_n93_), .c(new_n62_), .d(new_n80_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(x25), .c(x01), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n48_), .O(z5));
  ...
  nor4   g064(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n109_));
  nand4  g065(.a(new_n62_), .b(new_n80_), .c(x25), .d(x01), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n109_), .c(new_n48_), .O(new_n111_));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x31), .O(new_n113_));
  nor2   g069(.a(x31), .b(new_n45_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n95_), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(x30), .O(new_n118_));
  aoi21  g074(.a(new_n116_), .b(x04), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n111_), .O(z7));
  ...
  nor3   g091(.a(new_n135_), .b(new_n134_), .c(new_n117_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n133_), .c(new_n130_), .d(new_n128_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n125_), .c(new_n48_), .O(new_n138_));
  nor2   g094(.a(x28), .b(x27), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(new_n45_), .c(new_n94_), .O(new_n140_));
  inv1   g096(.a(new_n139_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x29), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(new_n45_), .c(new_n140_), .d(x04), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  nand3  g101(.a(new_n142_), .b(x30), .c(x04), .O(new_n146_));
  nand3  g102(.a(new_n141_), .b(new_n45_), .c(x29), .O(new_n147_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n148_), .c(new_n49_), .d(x31), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n145_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n80_), .c(x00), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(z8));
  nand4  g123(.a(new_n163_), .b(new_n53_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n45_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n141_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n163_), .b(new_n53_), .c(new_n117_), .d(new_n45_), .O(new_n172_));
  ...
  nor3   g132(.a(new_n135_), .b(new_n118_), .c(new_n114_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n176_), .c(new_n133_), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n130_), .c(new_n128_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n125_), .c(x33), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n175_), .c(new_n171_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n80_), .c(x00), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n48_), .O(z9));
endmodule
