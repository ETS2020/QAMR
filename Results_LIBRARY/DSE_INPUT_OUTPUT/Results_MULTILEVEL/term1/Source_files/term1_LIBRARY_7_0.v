...
module FAU ( 
  ...
  aoi21  g043(.a(new_n87_), .b(new_n83_), .c(new_n55_), .O(new_n88_));
  ...
  nand2  g050(.a(new_n87_), .b(new_n83_), .O(new_n95_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n62_), .d(x30), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n94_), .c(x25), .d(x01), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z5));
  oai21  g060(.a(new_n97_), .b(new_n80_), .c(x30), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(x29), .c(new_n87_), .d(new_n83_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n62_), .c(x25), .d(x01), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x30), .c(x26), .O(z6));
  ...
  nand4  g069(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n83_), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n98_), .b(new_n115_), .c(x29), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n62_), .c(x25), .d(x01), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n114_), .c(new_n110_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x30), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n94_), .O(z7));
  nand2  g077(.a(new_n97_), .b(new_n80_), .O(new_n122_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n123_), .c(new_n48_), .d(x31), .O(new_n142_));
  aoi21  g098(.a(new_n127_), .b(x14), .c(new_n125_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(x17), .c(x16), .d(x15), .O(new_n144_));
  nand2  g100(.a(x16), .b(x15), .O(new_n145_));
  nand2  g101(.a(x18), .b(x17), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(new_n127_), .O(new_n147_));
  ...
  aoi21  g110(.a(new_n125_), .b(new_n154_), .c(new_n115_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n153_), .c(new_n151_), .d(new_n149_), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n147_), .c(new_n144_), .d(new_n123_), .O(new_n158_));
  ...
  aoi21  g117(.a(new_n161_), .b(x30), .c(x26), .O(z8));
  nand4  g118(.a(new_n141_), .b(new_n122_), .c(new_n52_), .d(x31), .O(new_n163_));
  nand2  g119(.a(new_n125_), .b(new_n154_), .O(new_n164_));
  nor2   g120(.a(new_n115_), .b(new_n96_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n153_), .d(new_n122_), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  and2   g123(.a(new_n167_), .b(new_n151_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n149_), .c(new_n147_), .d(new_n144_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x33), .O(new_n170_));
  oai21  g126(.a(new_n163_), .b(new_n96_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x00), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(x30), .c(x26), .O(z9));
endmodule
