...
module FAU ( 
  ...
  nand3  g071(.a(new_n115_), .b(new_n62_), .c(new_n96_), .O(new_n116_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n104_), .c(new_n96_), .O(new_n129_));
  ...
  oai21  g110(.a(new_n149_), .b(new_n113_), .c(new_n154_), .O(new_n155_));
  ...
  nand4  g128(.a(new_n172_), .b(new_n96_), .c(new_n45_), .d(x00), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(z8));
  inv1   g130(.a(x33), .O(new_n175_));
  nand4  g131(.a(new_n148_), .b(new_n175_), .c(x31), .d(x30), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n113_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n132_), .c(x29), .O(new_n179_));
  nand4  g135(.a(new_n148_), .b(new_n175_), .c(new_n127_), .d(new_n113_), .O(new_n180_));
  ...
  aoi21  g148(.a(new_n192_), .b(new_n45_), .c(x26), .O(z9));
endmodule
