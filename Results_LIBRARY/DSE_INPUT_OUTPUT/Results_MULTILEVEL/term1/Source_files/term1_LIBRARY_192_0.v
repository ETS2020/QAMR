...
module FAU ( 
  ...
  nand4  g087(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n132_));
  ...
  nand2  g095(.a(new_n136_), .b(x11), .O(new_n140_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n141_), .c(new_n138_), .d(new_n133_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n131_), .c(new_n56_), .O(new_n146_));
  nand2  g102(.a(new_n98_), .b(new_n79_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n106_), .c(x10), .O(new_n149_));
  oai21  g105(.a(x15), .b(x10), .c(new_n148_), .O(new_n150_));
  ...
  nand3  g110(.a(x19), .b(new_n135_), .c(x13), .O(new_n155_));
  nand3  g111(.a(new_n128_), .b(x18), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n134_), .O(new_n157_));
  ...
  nor2   g121(.a(new_n139_), .b(x15), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n147_), .c(new_n106_), .d(x29), .O(new_n169_));
  nand4  g125(.a(new_n148_), .b(x30), .c(x19), .d(x18), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x17), .c(x16), .d(new_n127_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n169_), .c(new_n114_), .O(new_n173_));
  nand4  g129(.a(new_n164_), .b(new_n148_), .c(x30), .d(x15), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n173_), .c(new_n154_), .O(new_n176_));
  ...
  nand3  g136(.a(new_n166_), .b(new_n162_), .c(x10), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n165_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(x31), .d(x30), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(x30), .c(new_n183_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n147_), .c(x29), .O(new_n185_));
  nand4  g141(.a(new_n168_), .b(new_n180_), .c(new_n121_), .d(new_n106_), .O(new_n186_));
  oai21  g142(.a(new_n180_), .b(new_n106_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n148_), .O(new_n188_));
  nand3  g144(.a(new_n136_), .b(x16), .c(x15), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n128_), .O(new_n190_));
  nand3  g146(.a(new_n136_), .b(x16), .c(x10), .O(new_n191_));
  inv1   g147(.a(new_n142_), .O(new_n192_));
  nor2   g148(.a(x31), .b(new_n106_), .O(new_n193_));
  nor3   g149(.a(new_n193_), .b(new_n143_), .c(new_n124_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n192_), .c(new_n141_), .O(new_n195_));
  aoi21  g151(.a(new_n191_), .b(new_n127_), .c(new_n195_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n190_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n131_), .c(x33), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n188_), .c(new_n185_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n78_), .c(x00), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n56_), .O(z9));
endmodule
