...
module FAU ( 
  ...
  nand4  g052(.a(new_n96_), .b(x25), .c(new_n80_), .d(x01), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n61_), .d(new_n45_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(x25), .c(new_n80_), .d(x01), .O(new_n102_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n114_), .c(new_n126_), .O(new_n130_));
  ...
  nand2  g089(.a(new_n104_), .b(new_n81_), .O(new_n134_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n135_), .c(x31), .d(new_n113_), .O(new_n147_));
  nand2  g103(.a(x32), .b(x30), .O(new_n148_));
  oai21  g104(.a(new_n147_), .b(new_n89_), .c(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n134_), .c(x29), .O(new_n150_));
  nand2  g106(.a(new_n134_), .b(x29), .O(new_n151_));
  nand4  g107(.a(new_n146_), .b(new_n135_), .c(x31), .d(x30), .O(new_n152_));
  nand2  g108(.a(x32), .b(new_n113_), .O(new_n153_));
  oai21  g109(.a(new_n152_), .b(new_n89_), .c(new_n153_), .O(new_n154_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n143_), .c(new_n86_), .O(new_n160_));
  inv1   g116(.a(x10), .O(new_n161_));
  oai21  g117(.a(new_n159_), .b(new_n161_), .c(new_n143_), .O(new_n162_));
  nand2  g118(.a(x17), .b(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n136_), .O(new_n164_));
  nor2   g120(.a(x17), .b(x12), .O(new_n165_));
  nor3   g121(.a(new_n165_), .b(new_n127_), .c(new_n89_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n158_), .c(x32), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n155_), .c(new_n150_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x00), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n80_), .c(x26), .O(z8));
  aoi21  g127(.a(new_n145_), .b(new_n142_), .c(x33), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x31), .c(x30), .d(x19), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n113_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n134_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n172_), .b(new_n127_), .c(new_n113_), .d(x19), .O(new_n177_));
  ...
  nor3   g137(.a(new_n181_), .b(new_n165_), .c(new_n89_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n183_));
  ...
  aoi21  g142(.a(new_n186_), .b(new_n80_), .c(x26), .O(z9));
endmodule
