...
module FAU ( 
  ...
  nand4  g077(.a(new_n121_), .b(new_n61_), .c(x25), .d(x01), .O(new_n122_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(new_n48_), .d(x31), .O(new_n144_));
  ...
  aoi21  g112(.a(new_n85_), .b(new_n156_), .c(new_n120_), .O(new_n157_));
  ...
  nand4  g118(.a(new_n162_), .b(x30), .c(new_n79_), .d(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z8));
  nand4  g120(.a(new_n143_), .b(new_n127_), .c(new_n52_), .d(x31), .O(new_n165_));
  nand2  g121(.a(new_n85_), .b(new_n156_), .O(new_n166_));
  nor2   g122(.a(new_n120_), .b(new_n105_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n166_), .c(new_n155_), .d(new_n127_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  and2   g125(.a(new_n169_), .b(new_n153_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n151_), .c(new_n149_), .d(new_n146_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x33), .O(new_n172_));
  oai21  g128(.a(new_n165_), .b(new_n105_), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x30), .c(new_n79_), .d(x00), .O(new_n174_));
