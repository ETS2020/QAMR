...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n80_), .d(new_n78_), .O(new_n99_));
  ...
  nor2   g060(.a(new_n104_), .b(new_n79_), .O(new_n105_));
  ...
  aoi21  g073(.a(new_n117_), .b(x00), .c(x26), .O(z6));
  ...
  nor2   g078(.a(new_n54_), .b(new_n60_), .O(new_n123_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n105_), .c(new_n124_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x00), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n78_), .O(z7));
  nand2  g087(.a(new_n104_), .b(new_n79_), .O(new_n132_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n48_), .c(x31), .d(new_n114_), .O(new_n148_));
  ...
  nand4  g108(.a(new_n147_), .b(new_n48_), .c(x31), .d(x30), .O(new_n153_));
  ...
  nand4  g130(.a(new_n147_), .b(new_n51_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n114_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n132_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n147_), .b(new_n51_), .c(new_n125_), .d(new_n114_), .O(new_n179_));
