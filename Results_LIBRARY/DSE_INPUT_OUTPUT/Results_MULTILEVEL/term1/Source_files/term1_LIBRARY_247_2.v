...
module FAU ( 
  ...
  nand2  g077(.a(x30), .b(x26), .O(new_n122_));
  ...
  nand2  g096(.a(new_n95_), .b(new_n80_), .O(new_n141_));
  ...
  aoi22  g100(.a(new_n144_), .b(new_n101_), .c(new_n143_), .d(new_n45_), .O(new_n145_));
  ...
  nand3  g105(.a(new_n141_), .b(new_n101_), .c(x29), .O(new_n150_));
  ...
  oai21  g128(.a(new_n172_), .b(new_n127_), .c(new_n122_), .O(new_n173_));
  nand2  g129(.a(new_n144_), .b(new_n117_), .O(new_n174_));
  nor2   g130(.a(new_n117_), .b(new_n94_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n141_), .c(new_n101_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(new_n45_), .c(new_n174_), .d(new_n101_), .O(new_n177_));
