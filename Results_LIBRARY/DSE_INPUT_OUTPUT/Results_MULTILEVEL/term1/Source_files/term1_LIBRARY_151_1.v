...
module FAU ( 
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n93_), .c(new_n59_), .O(z5));
  ...
  nor3   g096(.a(new_n140_), .b(new_n45_), .c(new_n95_), .O(new_n141_));
  inv1   g097(.a(new_n140_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x29), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(new_n45_), .c(new_n141_), .d(x01), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x32), .O(new_n146_));
  inv1   g102(.a(x32), .O(new_n147_));
  nand3  g103(.a(new_n143_), .b(x30), .c(x01), .O(new_n148_));
  nand3  g104(.a(new_n142_), .b(new_n45_), .c(x29), .O(new_n149_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n142_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n165_), .b(new_n170_), .c(new_n117_), .d(new_n45_), .O(new_n175_));
