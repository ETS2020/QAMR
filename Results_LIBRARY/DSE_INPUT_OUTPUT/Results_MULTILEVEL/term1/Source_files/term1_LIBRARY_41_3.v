...
module FAU ( 
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n64_), .d(new_n45_), .O(new_n108_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n102_), .c(new_n64_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n63_), .c(new_n49_), .O(z6));
  ...
  nand2  g084(.a(new_n104_), .b(new_n83_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n50_), .c(x31), .d(new_n46_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n144_), .b(new_n50_), .c(x31), .d(x30), .O(new_n150_));
  ...
  nand2  g109(.a(new_n91_), .b(x14), .O(new_n154_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n122_), .O(new_n166_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n54_), .c(new_n122_), .d(new_n46_), .O(new_n176_));
