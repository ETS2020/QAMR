...
module FAU ( 
  ...
  oai21  g019(.a(x26), .b(x05), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g046(.a(new_n90_), .b(new_n84_), .c(new_n45_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n83_), .c(new_n82_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n90_), .c(new_n45_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n83_), .c(new_n82_), .O(z4));
  ...
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n57_), .d(new_n45_), .O(new_n102_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n57_), .c(new_n45_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n82_), .O(z6));
  ...
  nand4  g103(.a(new_n147_), .b(new_n49_), .c(x31), .d(new_n106_), .O(new_n148_));
  ...
  nand2  g109(.a(x32), .b(new_n106_), .O(new_n154_));
  ...
  nor3   g124(.a(new_n168_), .b(new_n167_), .c(new_n121_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n147_), .b(new_n53_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n106_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n129_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n147_), .b(new_n53_), .c(new_n121_), .d(new_n106_), .O(new_n179_));
