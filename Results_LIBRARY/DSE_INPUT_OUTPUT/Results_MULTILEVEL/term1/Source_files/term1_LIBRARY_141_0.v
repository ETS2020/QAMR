...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(x30), .c(new_n81_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n45_), .c(x25), .d(x01), .O(new_n97_));
  ...
  aoi21  g057(.a(new_n101_), .b(x30), .c(x26), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n62_), .d(x30), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n45_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z5));
  nand2  g068(.a(new_n105_), .b(x29), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n103_), .c(new_n62_), .d(x30), .O(new_n114_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n62_), .c(x25), .d(x01), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n121_), .c(new_n119_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x30), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n45_), .O(z7));
  inv1   g084(.a(x32), .O(new_n129_));
  nand2  g085(.a(new_n104_), .b(new_n81_), .O(new_n130_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n131_), .c(new_n129_), .d(x31), .O(new_n147_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n150_), .c(new_n89_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(new_n144_), .O(new_n154_));
  inv1   g110(.a(x11), .O(new_n155_));
  oai21  g111(.a(new_n151_), .b(new_n155_), .c(new_n138_), .O(new_n156_));
  nand2  g112(.a(x18), .b(x12), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n83_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  aoi21  g115(.a(new_n86_), .b(new_n159_), .c(new_n122_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n152_), .c(new_n149_), .d(new_n131_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x32), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n147_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x00), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(x30), .c(x26), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n146_), .b(new_n130_), .c(new_n168_), .d(x31), .O(new_n169_));
  nand2  g125(.a(new_n86_), .b(new_n159_), .O(new_n170_));
  nor2   g126(.a(new_n122_), .b(new_n106_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n170_), .c(new_n158_), .d(new_n130_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  and2   g129(.a(new_n173_), .b(new_n156_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n154_), .c(new_n152_), .d(new_n149_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  oai21  g132(.a(new_n169_), .b(new_n106_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x00), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(x30), .c(x26), .O(z9));
endmodule
