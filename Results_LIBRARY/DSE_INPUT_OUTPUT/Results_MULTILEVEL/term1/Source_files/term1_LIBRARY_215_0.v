...
module FAU ( 
  ...
  nor3   g055(.a(new_n99_), .b(new_n89_), .c(new_n45_), .O(z5));
  nand3  g056(.a(new_n46_), .b(x28), .c(x27), .O(new_n101_));
  oai21  g057(.a(new_n96_), .b(new_n46_), .c(new_n101_), .O(new_n102_));
  nor2   g058(.a(new_n46_), .b(x29), .O(new_n103_));
  ...
  nand3  g064(.a(new_n96_), .b(new_n108_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x30), .O(new_n111_));
  nand3  g067(.a(new_n96_), .b(x30), .c(x29), .O(new_n112_));
  ...
  nor2   g073(.a(x26), .b(new_n89_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n117_), .c(new_n113_), .d(new_n60_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x01), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n111_), .O(z7));
  ...
  nor3   g118(.a(new_n162_), .b(new_n161_), .c(new_n108_), .O(new_n163_));
  ...
  nand4  g129(.a(new_n141_), .b(new_n169_), .c(new_n108_), .d(new_n46_), .O(new_n174_));
