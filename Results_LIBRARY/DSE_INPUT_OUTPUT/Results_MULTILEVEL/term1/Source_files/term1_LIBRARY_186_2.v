...
module FAU ( 
  ...
  nand2  g057(.a(new_n101_), .b(new_n58_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n62_), .c(new_n45_), .d(x25), .O(new_n109_));
  ...
  oai22  g098(.a(new_n142_), .b(new_n130_), .c(new_n103_), .d(new_n45_), .O(new_n143_));
  nor2   g099(.a(x28), .b(x27), .O(new_n144_));
  nor3   g100(.a(new_n144_), .b(new_n103_), .c(new_n94_), .O(new_n145_));
  inv1   g101(.a(new_n144_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(new_n103_), .c(new_n145_), .d(new_n45_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n143_), .c(new_n125_), .O(new_n149_));
  nand3  g105(.a(new_n147_), .b(x30), .c(new_n45_), .O(new_n150_));
  nand3  g106(.a(new_n146_), .b(new_n103_), .c(x29), .O(new_n151_));
  ...
  nand3  g111(.a(new_n127_), .b(x18), .c(x14), .O(new_n156_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n137_), .c(x11), .O(new_n163_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n152_), .c(new_n125_), .d(x31), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n149_), .c(x00), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n58_), .O(z8));
  ...
  nand3  g131(.a(new_n175_), .b(new_n146_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n167_), .b(new_n172_), .c(new_n120_), .d(new_n103_), .O(new_n177_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n186_));
