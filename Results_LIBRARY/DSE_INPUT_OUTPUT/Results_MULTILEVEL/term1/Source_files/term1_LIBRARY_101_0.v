...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n61_), .c(x30), .d(new_n80_), .O(new_n94_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n61_), .d(x30), .O(new_n99_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n61_), .d(x30), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n45_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z5));
  oai21  g067(.a(new_n104_), .b(new_n80_), .c(x30), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(x29), .c(new_n92_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n61_), .c(x25), .d(x01), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(x30), .c(x26), .O(z6));
  ...
  nand2  g082(.a(new_n104_), .b(new_n80_), .O(new_n127_));
  ...
  nor2   g123(.a(new_n121_), .b(new_n103_), .O(new_n168_));
