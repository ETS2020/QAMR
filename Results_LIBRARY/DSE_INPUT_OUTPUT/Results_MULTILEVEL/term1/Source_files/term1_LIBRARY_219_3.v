...
module FAU ( 
  ...
  nand3  g060(.a(new_n104_), .b(new_n60_), .c(new_n79_), .O(new_n105_));
  ...
  nand4  g065(.a(new_n99_), .b(x29), .c(x28), .d(x27), .O(new_n110_));
  oai21  g066(.a(new_n99_), .b(x28), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n93_), .c(new_n79_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n109_), .c(new_n58_), .O(z6));
  inv1   g069(.a(new_n81_), .O(new_n114_));
  nand4  g070(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n114_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n79_), .c(x25), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n59_), .c(new_n58_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n115_), .c(new_n47_), .O(z7));
  inv1   g075(.a(x32), .O(new_n120_));
  aoi21  g076(.a(new_n99_), .b(x27), .c(x28), .O(new_n121_));
  oai21  g077(.a(new_n102_), .b(new_n80_), .c(x30), .O(new_n122_));
  oai21  g078(.a(new_n121_), .b(new_n102_), .c(new_n122_), .O(new_n123_));
  nand3  g079(.a(x19), .b(new_n85_), .c(x13), .O(new_n124_));
  nand3  g080(.a(new_n88_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n124_), .c(new_n82_), .O(new_n126_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n123_), .c(new_n120_), .d(x31), .O(new_n139_));
  nand2  g095(.a(new_n88_), .b(x14), .O(new_n140_));
  ...
  nand2  g099(.a(new_n143_), .b(new_n99_), .O(new_n144_));
  nand2  g100(.a(x16), .b(x15), .O(new_n145_));
  nand2  g101(.a(x18), .b(x17), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(new_n88_), .O(new_n147_));
  nand2  g103(.a(x16), .b(x10), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n146_), .c(new_n136_), .O(new_n149_));
  inv1   g105(.a(x11), .O(new_n150_));
  oai21  g106(.a(new_n146_), .b(new_n150_), .c(new_n130_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  aoi21  g108(.a(x18), .b(x12), .c(x17), .O(new_n153_));
  inv1   g109(.a(x13), .O(new_n154_));
  nand2  g110(.a(new_n85_), .b(new_n154_), .O(new_n155_));
  nand3  g111(.a(x30), .b(x29), .c(x27), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n155_), .c(x31), .O(new_n157_));
  nor3   g113(.a(new_n157_), .b(new_n153_), .c(new_n152_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n149_), .c(new_n147_), .d(new_n144_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n142_), .c(x32), .O(new_n160_));
  ...
  aoi21  g119(.a(new_n85_), .b(new_n154_), .c(new_n153_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n151_), .c(new_n149_), .d(new_n147_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n142_), .c(new_n45_), .O(new_n166_));
  nand2  g122(.a(new_n143_), .b(new_n116_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n99_), .O(new_n168_));
  inv1   g124(.a(x28), .O(new_n169_));
  nand3  g125(.a(x31), .b(x29), .c(x27), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(x30), .c(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n168_), .c(new_n166_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x33), .O(new_n173_));
  aoi21  g129(.a(new_n133_), .b(new_n129_), .c(new_n136_), .O(new_n174_));
  inv1   g130(.a(new_n137_), .O(new_n175_));
  nand2  g131(.a(new_n116_), .b(new_n99_), .O(new_n176_));
  nand4  g132(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(x27), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n169_), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(x29), .c(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n175_), .b(new_n174_), .c(new_n180_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(x33), .c(new_n173_), .O(new_n182_));
