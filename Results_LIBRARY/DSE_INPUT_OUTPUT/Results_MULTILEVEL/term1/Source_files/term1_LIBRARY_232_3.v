...
module FAU ( 
  ...
  nand2  g049(.a(new_n93_), .b(new_n59_), .O(new_n94_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n59_), .d(new_n79_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n80_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z5));
  nor4   g067(.a(new_n94_), .b(x30), .c(new_n105_), .d(new_n103_), .O(new_n112_));
  ...
  nand2  g074(.a(new_n103_), .b(new_n81_), .O(new_n119_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n120_), .c(x31), .d(new_n79_), .O(new_n137_));
  ...
  nand2  g098(.a(x32), .b(new_n79_), .O(new_n143_));
  ...
  nor3   g114(.a(new_n158_), .b(new_n157_), .c(new_n156_), .O(new_n159_));
  ...
  nor2   g120(.a(new_n158_), .b(new_n157_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n155_), .c(new_n153_), .d(new_n151_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n148_), .c(new_n45_), .O(new_n167_));
  nand2  g123(.a(new_n141_), .b(new_n156_), .O(new_n168_));
  nor2   g124(.a(new_n156_), .b(new_n105_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n119_), .c(new_n79_), .O(new_n170_));
  aoi22  g126(.a(new_n170_), .b(new_n78_), .c(new_n168_), .d(new_n79_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n167_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x33), .O(new_n173_));
  nand4  g129(.a(new_n119_), .b(x31), .c(x30), .d(x29), .O(new_n174_));
  oai22  g130(.a(new_n174_), .b(x25), .c(new_n168_), .d(x30), .O(new_n175_));
