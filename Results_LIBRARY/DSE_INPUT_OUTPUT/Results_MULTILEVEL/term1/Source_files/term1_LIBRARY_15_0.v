...
module FAU ( 
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n61_), .d(x31), .O(new_n108_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n61_), .d(x31), .O(new_n117_));
  ...
  nand4  g078(.a(new_n61_), .b(new_n79_), .c(x25), .d(x01), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand3  g080(.a(x31), .b(x30), .c(x29), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n124_), .c(new_n122_), .d(new_n105_), .O(z7));
  nand2  g083(.a(new_n104_), .b(new_n80_), .O(new_n128_));
  ...
  aoi21  g095(.a(new_n139_), .b(new_n135_), .c(new_n129_), .O(new_n140_));
  nand3  g096(.a(x16), .b(new_n129_), .c(x10), .O(new_n141_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n128_), .c(x29), .O(new_n146_));
  nand2  g102(.a(new_n128_), .b(x29), .O(new_n147_));
  nand2  g103(.a(x32), .b(new_n112_), .O(new_n148_));
  oai21  g104(.a(new_n143_), .b(new_n112_), .c(new_n148_), .O(new_n149_));
  ...
  nor2   g111(.a(new_n85_), .b(new_n82_), .O(new_n156_));
  ...
  nand4  g124(.a(new_n168_), .b(x31), .c(new_n79_), .d(x00), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(z8));
  or2    g126(.a(new_n142_), .b(new_n140_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n128_), .c(new_n52_), .d(x30), .O(new_n172_));
  inv1   g128(.a(new_n164_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n128_), .c(x30), .d(x29), .O(new_n174_));
  ...
  oai21  g133(.a(new_n172_), .b(new_n103_), .c(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x31), .c(new_n79_), .d(x00), .O(new_n179_));
