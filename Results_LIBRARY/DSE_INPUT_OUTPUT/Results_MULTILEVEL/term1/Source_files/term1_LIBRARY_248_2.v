...
module FAU ( 
  ...
  aoi21  g050(.a(new_n94_), .b(new_n80_), .c(x26), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n93_), .c(new_n45_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(x25), .c(new_n80_), .d(x01), .O(new_n99_));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n80_), .c(x26), .O(z5));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n80_), .c(x26), .O(z6));
  ...
  nand4  g076(.a(new_n120_), .b(new_n90_), .c(new_n87_), .d(x17), .O(new_n121_));
  nand3  g077(.a(new_n61_), .b(new_n80_), .c(x01), .O(new_n122_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n103_), .c(new_n45_), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n123_), .c(new_n121_), .d(new_n119_), .O(z7));
  nand2  g085(.a(new_n101_), .b(new_n81_), .O(new_n130_));
  inv1   g086(.a(x32), .O(new_n131_));
  nand3  g087(.a(x19), .b(new_n85_), .c(x13), .O(new_n132_));
  nand3  g088(.a(new_n88_), .b(x18), .c(x14), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n82_), .O(new_n134_));
  nand4  g090(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n135_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n131_), .c(x31), .d(new_n110_), .O(new_n147_));
  ...
  nand2  g108(.a(x32), .b(new_n110_), .O(new_n153_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n88_), .O(new_n161_));
  ...
  nor3   g123(.a(new_n167_), .b(new_n166_), .c(new_n125_), .O(new_n168_));
  ...
  aoi21  g128(.a(new_n172_), .b(new_n80_), .c(x26), .O(z8));
  ...
  nand4  g134(.a(new_n146_), .b(new_n174_), .c(new_n125_), .d(new_n110_), .O(new_n179_));
  ...
  nand4  g146(.a(new_n190_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n191_));
