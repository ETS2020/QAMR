...
module FAU ( 
  ...
  and2   g55(.a(x28), .b(x27), .O(new_n100_));
  nand3  g56(.a(new_n99_), .b(x28), .c(x27), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n89_), .c(new_n52_), .d(new_n93_), .O(new_n103_));
  ...
  nand3  g65(.a(new_n100_), .b(new_n109_), .c(x29), .O(new_n110_));
  aoi22  g66(.a(new_n110_), .b(new_n108_), .c(new_n88_), .d(new_n84_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n52_), .c(x25), .d(x01), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g69(.a(new_n100_), .b(x30), .c(x29), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(x31), .O(new_n115_));
  inv1   g71(.a(new_n85_), .O(new_n116_));
  inv1   g72(.a(new_n86_), .O(new_n117_));
  inv1   g73(.a(new_n87_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n84_), .O(new_n119_));
  nand3  g75(.a(new_n52_), .b(x01), .c(new_n45_), .O(new_n120_));
  ...
  oai21  g81(.a(new_n125_), .b(new_n123_), .c(new_n93_), .O(new_n126_));
  nor2   g82(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n121_), .c(new_n119_), .d(new_n115_), .O(z7));
  zero   g84(.O(z8));
  zero   g85(.O(z9));
endmodule
