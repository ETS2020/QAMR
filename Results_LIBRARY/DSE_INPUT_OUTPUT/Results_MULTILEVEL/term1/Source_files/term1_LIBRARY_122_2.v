...
module FAU ( 
  ...
  nor3   g047(.a(new_n91_), .b(new_n89_), .c(new_n59_), .O(z4));
  ...
  nor3   g055(.a(new_n99_), .b(new_n89_), .c(new_n59_), .O(z5));
  ...
  oai22  g095(.a(new_n139_), .b(new_n127_), .c(new_n101_), .d(new_n45_), .O(new_n140_));
  nor2   g096(.a(x28), .b(x27), .O(new_n141_));
  nor3   g097(.a(new_n141_), .b(new_n101_), .c(new_n94_), .O(new_n142_));
  inv1   g098(.a(new_n141_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x29), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(new_n101_), .c(new_n142_), .d(new_n45_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n140_), .c(new_n122_), .O(new_n146_));
  nand3  g102(.a(new_n144_), .b(x30), .c(new_n45_), .O(new_n147_));
  nand3  g103(.a(new_n143_), .b(new_n101_), .c(x29), .O(new_n148_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n149_), .c(new_n122_), .d(x31), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n146_), .c(x00), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n57_), .O(z8));
  ...
  nand4  g129(.a(new_n164_), .b(new_n169_), .c(new_n117_), .d(new_n101_), .O(new_n174_));
