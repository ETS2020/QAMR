...
module FAU ( 
  ...
  and2   g045(.a(new_n89_), .b(new_n63_), .O(new_n90_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n89_), .c(new_n63_), .d(new_n45_), .O(new_n102_));
  ...
  nand2  g070(.a(new_n97_), .b(new_n81_), .O(new_n115_));
  ...
  nor2   g103(.a(new_n111_), .b(new_n99_), .O(new_n148_));
  ...
  oai21  g109(.a(new_n134_), .b(new_n99_), .c(new_n153_), .O(new_n154_));
  ...
  aoi21  g121(.a(new_n165_), .b(new_n45_), .c(x26), .O(z9));
endmodule
