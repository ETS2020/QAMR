...
module FAU ( 
  ...
  nand4  g054(.a(new_n94_), .b(x27), .c(x25), .d(x01), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n45_), .c(x26), .O(z4));
  nand3  g056(.a(new_n94_), .b(x29), .c(new_n45_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n80_), .c(x25), .d(x01), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z5));
  nand4  g060(.a(new_n94_), .b(x30), .c(x25), .d(x01), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g062(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n107_));
  nand3  g063(.a(new_n62_), .b(x25), .c(x01), .O(new_n108_));
  nor4   g064(.a(new_n108_), .b(x31), .c(x28), .d(x26), .O(new_n109_));
  oai21  g065(.a(new_n107_), .b(new_n91_), .c(new_n109_), .O(z7));
  and2   g066(.a(x29), .b(x27), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(x19), .b(new_n88_), .c(x13), .O(new_n113_));
  inv1   g069(.a(x19), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x18), .c(x14), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(new_n85_), .O(new_n116_));
  nand4  g072(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n117_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n49_), .c(x31), .d(x30), .O(new_n129_));
  inv1   g085(.a(x30), .O(new_n130_));
  nand2  g086(.a(x32), .b(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n112_), .O(new_n133_));
  nand3  g089(.a(new_n49_), .b(x31), .c(new_n130_), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n111_), .O(new_n136_));
  nand3  g092(.a(x27), .b(new_n88_), .c(x13), .O(new_n137_));
  nand4  g093(.a(new_n49_), .b(x31), .c(new_n130_), .d(x29), .O(new_n138_));
  oai22  g094(.a(new_n138_), .b(new_n137_), .c(new_n49_), .d(new_n88_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x19), .O(new_n140_));
  nand3  g096(.a(x27), .b(new_n114_), .c(x14), .O(new_n141_));
  oai22  g097(.a(new_n141_), .b(new_n138_), .c(new_n49_), .d(x14), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x18), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(new_n85_), .O(new_n144_));
  nor2   g100(.a(new_n136_), .b(new_n117_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(x16), .O(new_n146_));
  oai21  g102(.a(new_n136_), .b(new_n123_), .c(new_n146_), .O(new_n147_));
  nand4  g103(.a(x17), .b(x16), .c(new_n126_), .d(x10), .O(new_n148_));
  nand3  g104(.a(new_n135_), .b(x19), .c(x18), .O(new_n149_));
  oai22  g105(.a(new_n149_), .b(new_n148_), .c(new_n49_), .d(new_n130_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x29), .c(x27), .O(new_n151_));
  nand2  g107(.a(x16), .b(x15), .O(new_n152_));
  nand2  g108(.a(x18), .b(x17), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n114_), .O(new_n154_));
  nand4  g110(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n126_), .O(new_n156_));
  inv1   g112(.a(x11), .O(new_n157_));
  oai21  g113(.a(new_n153_), .b(new_n157_), .c(new_n120_), .O(new_n158_));
  ...
  aoi21  g118(.a(new_n159_), .b(new_n85_), .c(new_n162_), .O(new_n163_));
  ...
  aoi21  g122(.a(new_n147_), .b(x15), .c(new_n166_), .O(new_n167_));
  ...
  aoi21  g127(.a(new_n127_), .b(new_n125_), .c(x33), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n171_), .c(new_n130_), .O(new_n173_));
  nand2  g129(.a(x33), .b(x30), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n173_), .c(new_n111_), .O(new_n175_));
  aoi21  g131(.a(new_n114_), .b(x14), .c(new_n88_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x17), .c(x16), .d(x15), .O(new_n177_));
  oai21  g133(.a(new_n111_), .b(x31), .c(new_n130_), .O(new_n178_));
  nand2  g134(.a(new_n159_), .b(new_n85_), .O(new_n179_));
  nand2  g135(.a(new_n171_), .b(x30), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n161_), .c(new_n179_), .d(new_n158_), .O(new_n181_));
  aoi21  g137(.a(new_n155_), .b(new_n126_), .c(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n178_), .c(new_n177_), .d(new_n154_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand4  g140(.a(new_n172_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n81_), .c(new_n184_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n175_), .c(x00), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n45_), .c(x26), .O(z9));
endmodule
