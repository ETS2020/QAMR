...
module FAU ( 
  ...
  nand2  g077(.a(new_n95_), .b(new_n80_), .O(new_n122_));
  ...
  nand2  g123(.a(new_n167_), .b(new_n46_), .O(z8));
  ...
  nand3  g128(.a(new_n172_), .b(new_n122_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n141_), .b(new_n169_), .c(new_n117_), .d(new_n101_), .O(new_n174_));
