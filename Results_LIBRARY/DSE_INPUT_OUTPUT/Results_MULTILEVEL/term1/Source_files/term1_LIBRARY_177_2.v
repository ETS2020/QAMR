// Benchmark "FAU" written by ABC on Fri Aug 14 02:51:15 2020
...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(new_n45_), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n81_), .c(new_n60_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n62_), .c(new_n45_), .d(x25), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n60_), .O(z6));
  inv1   g065(.a(x31), .O(new_n110_));
  nand3  g066(.a(new_n97_), .b(new_n110_), .c(x29), .O(new_n111_));
  ...
  nor2   g075(.a(new_n61_), .b(new_n81_), .O(new_n120_));
  ...
  nor3   g120(.a(new_n164_), .b(new_n163_), .c(new_n110_), .O(new_n165_));
  ...
  nand2  g128(.a(x33), .b(new_n102_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n124_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n143_), .b(new_n171_), .c(new_n110_), .d(new_n102_), .O(new_n176_));
