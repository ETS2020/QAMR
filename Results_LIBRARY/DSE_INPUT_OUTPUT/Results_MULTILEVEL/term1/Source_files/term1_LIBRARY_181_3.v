...
module FAU ( 
  ...
  nand3  g061(.a(new_n105_), .b(new_n60_), .c(new_n80_), .O(new_n106_));
  ...
  nor2   g066(.a(new_n103_), .b(new_n110_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n81_), .c(new_n100_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n58_), .c(new_n45_), .O(z6));
  inv1   g071(.a(new_n82_), .O(new_n116_));
  nand4  g072(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n116_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n80_), .c(x25), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n59_), .c(new_n58_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n117_), .c(new_n47_), .O(z7));
  ...
  oai21  g083(.a(new_n127_), .b(new_n126_), .c(new_n89_), .O(new_n128_));
  ...
  oai21  g093(.a(new_n137_), .b(new_n125_), .c(new_n45_), .O(new_n138_));
  nand3  g094(.a(x30), .b(x29), .c(x28), .O(new_n139_));
  oai21  g095(.a(x30), .b(x28), .c(new_n139_), .O(new_n140_));
  aoi22  g096(.a(new_n140_), .b(new_n81_), .c(new_n100_), .d(new_n103_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x32), .O(new_n143_));
  inv1   g099(.a(x32), .O(new_n144_));
  nand3  g100(.a(new_n112_), .b(x30), .c(new_n81_), .O(new_n145_));
  nand2  g101(.a(new_n110_), .b(new_n81_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n100_), .c(x29), .O(new_n147_));
  ...
  nand3  g112(.a(new_n156_), .b(new_n132_), .c(x11), .O(new_n157_));
  ...
  nor2   g121(.a(new_n135_), .b(new_n134_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n133_), .c(new_n130_), .d(new_n128_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n125_), .c(new_n45_), .O(new_n168_));
  aoi21  g124(.a(new_n110_), .b(new_n81_), .c(new_n103_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(x31), .c(new_n100_), .O(new_n170_));
  nand3  g126(.a(x31), .b(x29), .c(x28), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x30), .c(new_n81_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n170_), .c(new_n168_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x33), .O(new_n174_));
  aoi21  g130(.a(new_n157_), .b(new_n154_), .c(new_n122_), .O(new_n175_));
  inv1   g131(.a(new_n160_), .O(new_n176_));
  nand3  g132(.a(new_n111_), .b(x31), .c(x30), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nor3   g134(.a(x31), .b(x30), .c(x28), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n81_), .O(new_n180_));
  nand3  g136(.a(new_n118_), .b(new_n100_), .c(new_n103_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g138(.a(new_n176_), .b(new_n175_), .c(new_n182_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(x33), .c(new_n174_), .O(new_n184_));
