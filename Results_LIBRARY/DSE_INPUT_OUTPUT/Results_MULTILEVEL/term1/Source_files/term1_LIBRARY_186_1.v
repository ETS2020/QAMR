...
module FAU ( 
  ...
  aoi21  g032(.a(new_n76_), .b(new_n69_), .c(new_n46_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n57_), .c(x08), .O(new_n78_));
  ...
  aoi22  g055(.a(new_n99_), .b(new_n97_), .c(new_n87_), .d(new_n83_), .O(new_n100_));
  ...
  nor4   g059(.a(new_n89_), .b(x30), .c(new_n98_), .d(new_n96_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x27), .c(new_n103_), .d(x25), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n59_), .O(z6));
  inv1   g062(.a(new_n84_), .O(new_n107_));
  inv1   g063(.a(new_n85_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n83_), .O(new_n109_));
  nand3  g065(.a(new_n61_), .b(x25), .c(x01), .O(new_n110_));
  nor4   g066(.a(new_n110_), .b(x31), .c(x30), .d(x26), .O(new_n111_));
  oai21  g067(.a(new_n109_), .b(new_n86_), .c(new_n111_), .O(z7));
  inv1   g068(.a(x32), .O(new_n113_));
  nand2  g069(.a(new_n96_), .b(new_n80_), .O(new_n114_));
  ...
  oai21  g109(.a(new_n133_), .b(new_n98_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n45_), .c(new_n103_), .d(x00), .O(new_n166_));
