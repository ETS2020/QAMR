...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n89_), .c(new_n78_), .d(x25), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n80_), .c(new_n57_), .O(z4));
  ...
  nand4  g058(.a(new_n102_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n80_), .c(new_n57_), .O(z5));
  nand3  g060(.a(new_n89_), .b(new_n80_), .c(x29), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n78_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n57_), .O(z6));
  ...
  nor3   g090(.a(new_n134_), .b(new_n80_), .c(new_n100_), .O(new_n135_));
  inv1   g091(.a(new_n134_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x29), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n80_), .c(new_n135_), .d(new_n57_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand3  g097(.a(new_n137_), .b(x30), .c(new_n57_), .O(new_n142_));
  nand3  g098(.a(new_n136_), .b(new_n80_), .c(x29), .O(new_n143_));
  ...
  nand4  g120(.a(new_n159_), .b(new_n164_), .c(x31), .d(x30), .O(new_n165_));
  nand2  g121(.a(x33), .b(new_n80_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n136_), .c(x29), .O(new_n168_));
  nand4  g124(.a(new_n159_), .b(new_n164_), .c(new_n128_), .d(new_n80_), .O(new_n169_));
  nand2  g125(.a(x33), .b(x30), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n137_), .O(new_n172_));
  inv1   g128(.a(new_n129_), .O(new_n173_));
  inv1   g129(.a(new_n130_), .O(new_n174_));
  ...
  nand4  g133(.a(new_n177_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n119_), .c(x33), .O(new_n179_));
