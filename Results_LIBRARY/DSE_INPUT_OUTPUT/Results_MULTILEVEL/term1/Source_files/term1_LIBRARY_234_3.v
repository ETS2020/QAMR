...
module FAU ( 
  ...
  nand3  g045(.a(new_n89_), .b(new_n61_), .c(new_n58_), .O(new_n90_));
  ...
  nand3  g065(.a(new_n46_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n102_), .b(new_n46_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x29), .O(new_n112_));
  nand2  g068(.a(x30), .b(new_n101_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n109_), .O(new_n114_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n58_), .O(new_n119_));
  nand3  g075(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  nor2   g077(.a(x31), .b(new_n46_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n102_), .c(x29), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  inv1   g080(.a(x31), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(x30), .O(new_n126_));
  aoi21  g082(.a(new_n124_), .b(new_n45_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n119_), .O(z7));
  ...
  oai21  g101(.a(new_n145_), .b(new_n133_), .c(new_n58_), .O(new_n146_));
  nor2   g102(.a(x28), .b(x27), .O(new_n147_));
  nor3   g103(.a(new_n147_), .b(new_n46_), .c(new_n101_), .O(new_n148_));
  inv1   g104(.a(new_n147_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x29), .O(new_n150_));
  aoi22  g106(.a(new_n150_), .b(new_n46_), .c(new_n148_), .d(new_n45_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x32), .O(new_n153_));
  inv1   g109(.a(x32), .O(new_n154_));
  nand3  g110(.a(new_n150_), .b(x30), .c(new_n45_), .O(new_n155_));
  nand3  g111(.a(new_n149_), .b(new_n46_), .c(x29), .O(new_n156_));
  ...
  nand4  g128(.a(new_n172_), .b(new_n157_), .c(new_n154_), .d(x31), .O(new_n173_));
  ...
  nand2  g134(.a(x33), .b(new_n46_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n149_), .c(x29), .O(new_n181_));
  nand4  g137(.a(new_n172_), .b(new_n177_), .c(new_n125_), .d(new_n46_), .O(new_n182_));
  nand2  g138(.a(x33), .b(x30), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n150_), .O(new_n185_));
  inv1   g141(.a(new_n142_), .O(new_n186_));
  nor3   g142(.a(new_n143_), .b(new_n126_), .c(new_n122_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n186_), .c(new_n141_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n138_), .c(new_n136_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n133_), .c(x33), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n185_), .c(new_n181_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n80_), .c(x00), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n58_), .O(z9));
endmodule
