...
module FAU ( 
  ...
  aoi21  g049(.a(new_n93_), .b(new_n78_), .c(x26), .O(z3));
  ...
  nand4  g060(.a(new_n104_), .b(new_n91_), .c(new_n59_), .d(new_n78_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n45_), .c(x25), .d(x01), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z5));
  nand3  g064(.a(new_n92_), .b(x29), .c(x28), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(x27), .c(x25), .d(x01), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n78_), .c(x26), .O(z6));
  nand3  g068(.a(new_n88_), .b(new_n85_), .c(new_n82_), .O(new_n113_));
  nand3  g069(.a(new_n59_), .b(x25), .c(x01), .O(new_n114_));
  nor4   g070(.a(new_n114_), .b(x31), .c(x30), .d(x26), .O(new_n115_));
  oai21  g071(.a(new_n113_), .b(new_n89_), .c(new_n115_), .O(z7));
  inv1   g072(.a(x32), .O(new_n117_));
  nand2  g073(.a(new_n100_), .b(new_n79_), .O(new_n118_));
  nand3  g074(.a(x19), .b(new_n86_), .c(x13), .O(new_n119_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n118_), .c(new_n117_), .d(x31), .O(new_n135_));
  aoi21  g091(.a(new_n120_), .b(x14), .c(new_n86_), .O(new_n136_));
  ...
  nand2  g103(.a(new_n86_), .b(new_n147_), .O(new_n148_));
  inv1   g104(.a(x31), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n102_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .d(new_n118_), .O(new_n151_));
  ...
  oai21  g111(.a(new_n135_), .b(new_n102_), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n78_), .c(new_n45_), .d(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(z8));
  inv1   g114(.a(x33), .O(new_n159_));
  nand2  g115(.a(new_n118_), .b(x29), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n134_), .c(new_n159_), .d(new_n149_), .O(new_n161_));
  aoi21  g117(.a(new_n86_), .b(new_n147_), .c(x31), .O(new_n162_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n78_), .c(new_n45_), .d(x00), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(z9));
endmodule
