...
module FAU ( 
  ...
  nand4  g58(.a(new_n102_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n103_));
  ...
  nand4  g69(.a(new_n113_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n114_));
  ...
  nand4  g75(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n84_), .O(new_n120_));
  aoi21  g76(.a(x03), .b(x02), .c(new_n60_), .O(new_n121_));
