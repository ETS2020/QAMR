...
module FAU ( 
  ...
  nor3   g055(.a(new_n99_), .b(new_n88_), .c(new_n86_), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n85_), .c(new_n61_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n98_), .c(new_n81_), .d(x25), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n60_), .c(new_n47_), .O(z4));
  ...
  nand3  g063(.a(x30), .b(new_n93_), .c(x18), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n90_), .c(new_n99_), .O(new_n109_));
  aoi21  g065(.a(new_n107_), .b(new_n105_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n60_), .c(new_n47_), .O(z5));
  nand3  g068(.a(x29), .b(x28), .c(x27), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x30), .c(x23), .O(new_n114_));
  nor2   g070(.a(new_n104_), .b(new_n82_), .O(new_n115_));
  ...
  nor2   g075(.a(new_n82_), .b(x23), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n116_), .c(x28), .d(new_n92_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n60_), .O(z6));
  oai21  g080(.a(x31), .b(x30), .c(new_n93_), .O(new_n125_));
  inv1   g081(.a(new_n84_), .O(new_n126_));
  nor2   g082(.a(x31), .b(x23), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n92_), .c(new_n83_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n89_), .c(new_n87_), .d(new_n126_), .O(new_n129_));
  nand3  g085(.a(new_n115_), .b(x30), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n61_), .b(new_n60_), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand4  g088(.a(new_n115_), .b(new_n132_), .c(x30), .d(x29), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n131_), .c(new_n81_), .d(x25), .O(new_n134_));
  aoi21  g090(.a(new_n130_), .b(x31), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n129_), .c(new_n125_), .O(z7));
  nand2  g092(.a(new_n104_), .b(new_n82_), .O(new_n137_));
  inv1   g093(.a(x32), .O(new_n138_));
  inv1   g094(.a(x17), .O(new_n139_));
  nand3  g095(.a(x19), .b(new_n92_), .c(x13), .O(new_n140_));
  ...
  nand4  g111(.a(new_n155_), .b(new_n138_), .c(x31), .d(new_n45_), .O(new_n156_));
  ...
  nor3   g132(.a(new_n176_), .b(new_n175_), .c(new_n132_), .O(new_n177_));
  ...
  nand3  g142(.a(new_n186_), .b(new_n137_), .c(x29), .O(new_n187_));
  nand4  g143(.a(new_n155_), .b(new_n183_), .c(new_n132_), .d(new_n45_), .O(new_n188_));
  ...
  nand4  g152(.a(new_n196_), .b(new_n174_), .c(new_n172_), .d(new_n170_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n167_), .c(x33), .O(new_n198_));
