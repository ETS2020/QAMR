...
module FAU ( 
  ...
  nor2   g59(.a(new_n98_), .b(new_n81_), .O(new_n104_));
  nand3  g60(.a(new_n103_), .b(x28), .c(x27), .O(new_n105_));
  oai21  g61(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(x25), .c(x01), .d(new_n45_), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(z5));
  nand3  g66(.a(x29), .b(x28), .c(x27), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(x30), .O(new_n112_));
  nor2   g68(.a(x30), .b(new_n103_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n104_), .O(new_n114_));
  aoi22  g70(.a(new_n114_), .b(new_n112_), .c(new_n96_), .d(new_n84_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n61_), .c(x25), .d(x01), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g73(.a(new_n104_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g75(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n120_));
  nand3  g76(.a(new_n61_), .b(x01), .c(new_n45_), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  inv1   g79(.a(new_n104_), .O(new_n124_));
  inv1   g80(.a(x31), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(x30), .c(x29), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n124_), .c(new_n80_), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n122_), .c(new_n120_), .d(new_n119_), .O(z7));
  zero   g85(.O(z8));
endmodule
