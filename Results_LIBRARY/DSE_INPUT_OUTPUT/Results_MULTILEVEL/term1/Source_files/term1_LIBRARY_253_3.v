...
module FAU ( 
  ...
  nand3  g017(.a(new_n61_), .b(new_n57_), .c(x01), .O(new_n62_));
  ...
  oai21  g024(.a(new_n68_), .b(new_n63_), .c(new_n56_), .O(new_n69_));
  xor2a  g025(.a(x07), .b(x04), .O(new_n70_));
  xor2a  g026(.a(x03), .b(x02), .O(new_n71_));
  nand3  g027(.a(new_n71_), .b(new_n57_), .c(x01), .O(new_n72_));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n90_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n59_), .c(new_n81_), .d(x25), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n57_), .c(new_n96_), .O(z5));
  nand3  g063(.a(new_n91_), .b(new_n57_), .c(x29), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n101_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x27), .c(new_n81_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n96_), .O(z6));
  inv1   g067(.a(new_n86_), .O(new_n112_));
  inv1   g068(.a(new_n87_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(new_n85_), .O(new_n114_));
  nand3  g070(.a(new_n59_), .b(x25), .c(x01), .O(new_n115_));
  nor4   g071(.a(new_n115_), .b(x31), .c(x30), .d(x26), .O(new_n116_));
  oai21  g072(.a(new_n114_), .b(new_n88_), .c(new_n116_), .O(z7));
  nand2  g073(.a(new_n101_), .b(new_n82_), .O(new_n118_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n119_), .c(x31), .d(new_n57_), .O(new_n138_));
  nand2  g094(.a(x32), .b(x30), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n118_), .c(x29), .O(new_n141_));
  nand2  g097(.a(new_n118_), .b(x29), .O(new_n142_));
  nand4  g098(.a(new_n137_), .b(new_n119_), .c(x31), .d(x30), .O(new_n143_));
  nand2  g099(.a(x32), .b(new_n57_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g102(.a(new_n123_), .b(x14), .O(new_n147_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n150_), .c(new_n123_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(new_n135_), .O(new_n154_));
  inv1   g110(.a(x11), .O(new_n155_));
  oai21  g111(.a(new_n151_), .b(new_n155_), .c(new_n129_), .O(new_n156_));
  inv1   g112(.a(x31), .O(new_n157_));
  aoi21  g113(.a(x18), .b(x12), .c(x17), .O(new_n158_));
  nor2   g114(.a(x18), .b(x13), .O(new_n159_));
  nor3   g115(.a(new_n159_), .b(new_n158_), .c(new_n157_), .O(new_n160_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n146_), .c(new_n141_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n81_), .c(x00), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n45_), .O(z8));
  nor2   g121(.a(new_n159_), .b(new_n158_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n149_), .c(new_n45_), .O(new_n168_));
  nand2  g124(.a(new_n142_), .b(new_n157_), .O(new_n169_));
  nor2   g125(.a(new_n157_), .b(new_n103_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n118_), .c(new_n57_), .O(new_n171_));
  aoi22  g127(.a(new_n171_), .b(new_n96_), .c(new_n169_), .d(new_n57_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x33), .O(new_n174_));
  nand4  g130(.a(new_n118_), .b(x31), .c(x30), .d(x29), .O(new_n175_));
