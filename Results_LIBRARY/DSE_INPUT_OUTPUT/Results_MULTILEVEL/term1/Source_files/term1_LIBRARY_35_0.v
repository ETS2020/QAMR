...
module FAU ( 
  ...
  nand2  g075(.a(new_n119_), .b(new_n45_), .O(z7));
  ...
  nand4  g116(.a(new_n160_), .b(x30), .c(new_n45_), .d(x00), .O(new_n161_));
  ...
  nand4  g128(.a(new_n172_), .b(x30), .c(new_n45_), .d(x00), .O(new_n173_));
