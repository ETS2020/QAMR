...
module FAU ( 
  ...
  nand4  g074(.a(new_n118_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n114_), .c(new_n59_), .O(z6));
  nand3  g076(.a(new_n107_), .b(x31), .c(x29), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x30), .O(new_n122_));
  nand4  g078(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n123_));
  nand2  g079(.a(x31), .b(new_n45_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n80_), .c(x25), .O(new_n125_));
  nor3   g081(.a(new_n125_), .b(new_n60_), .c(new_n59_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n123_), .c(new_n122_), .O(z7));
  ...
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(x31), .d(new_n45_), .O(new_n151_));
  ...
  aoi21  g111(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n156_));
  oai21  g112(.a(new_n148_), .b(new_n156_), .c(new_n133_), .O(new_n157_));
  nand2  g113(.a(x32), .b(new_n45_), .O(new_n158_));
  oai21  g114(.a(new_n157_), .b(new_n45_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n91_), .b(x14), .O(new_n160_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n91_), .O(new_n165_));
  ...
  aoi21  g129(.a(new_n162_), .b(x15), .c(new_n173_), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n133_), .O(new_n175_));
  aoi21  g131(.a(new_n159_), .b(new_n155_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n154_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n80_), .c(x00), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n131_), .O(z8));
  nand2  g135(.a(new_n155_), .b(new_n128_), .O(new_n180_));
  aoi21  g136(.a(new_n132_), .b(x29), .c(new_n128_), .O(new_n181_));
  aoi21  g137(.a(new_n180_), .b(new_n45_), .c(new_n181_), .O(new_n182_));
  oai21  g138(.a(new_n174_), .b(new_n46_), .c(new_n182_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand4  g140(.a(new_n132_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
  oai21  g141(.a(new_n180_), .b(x30), .c(new_n185_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n150_), .O(new_n187_));
