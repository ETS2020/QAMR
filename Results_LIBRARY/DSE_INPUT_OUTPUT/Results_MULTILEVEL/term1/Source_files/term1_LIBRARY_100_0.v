...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n61_), .c(new_n47_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nor4   g052(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n97_));
  nor2   g053(.a(new_n97_), .b(new_n45_), .O(new_n98_));
  nand3  g054(.a(x30), .b(new_n83_), .c(new_n82_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n55_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n96_), .c(new_n80_), .d(x25), .O(new_n103_));
  nor2   g059(.a(new_n103_), .b(new_n61_), .O(z4));
  ...
  nand3  g070(.a(new_n114_), .b(new_n92_), .c(x30), .O(new_n115_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n62_), .c(new_n80_), .d(x25), .O(new_n119_));
  ...
  nor2   g078(.a(new_n100_), .b(new_n84_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n91_), .c(new_n89_), .d(new_n87_), .O(new_n124_));
  inv1   g080(.a(x25), .O(new_n125_));
  nand3  g081(.a(new_n62_), .b(new_n47_), .c(x01), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x30), .c(x29), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n107_), .c(new_n80_), .O(new_n129_));
  nor3   g085(.a(new_n129_), .b(new_n126_), .c(new_n125_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n124_), .c(new_n122_), .O(z7));
  inv1   g087(.a(x19), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x14), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x18), .c(x17), .d(x16), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n82_), .O(new_n135_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(new_n82_), .O(new_n140_));
  ...
  nor2   g106(.a(new_n150_), .b(new_n109_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n149_), .c(x20), .O(new_n153_));
  inv1   g109(.a(new_n150_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(x30), .c(x29), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n153_), .c(new_n148_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x32), .O(new_n157_));
  nand4  g113(.a(new_n154_), .b(new_n149_), .c(x29), .d(x20), .O(new_n158_));
  oai21  g114(.a(new_n151_), .b(new_n149_), .c(new_n158_), .O(new_n159_));
  ...
  nand4  g128(.a(new_n169_), .b(x16), .c(new_n82_), .d(x10), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n159_), .c(new_n48_), .d(x31), .O(new_n175_));
  ...
  nand4  g134(.a(new_n174_), .b(new_n52_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n149_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n154_), .c(x29), .O(new_n182_));
  nand4  g138(.a(new_n174_), .b(new_n52_), .c(new_n127_), .d(new_n149_), .O(new_n183_));
  nand2  g139(.a(x33), .b(x30), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n152_), .O(new_n186_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n143_), .c(new_n140_), .d(new_n138_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n135_), .c(x33), .O(new_n193_));
