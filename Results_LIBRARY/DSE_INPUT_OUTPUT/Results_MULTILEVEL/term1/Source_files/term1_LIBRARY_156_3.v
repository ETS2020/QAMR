...
module FAU ( 
  ...
  nand2  g000(.a(x31), .b(x24), .O(new_n45_));
  ...
  oai21  g043(.a(new_n87_), .b(new_n58_), .c(new_n45_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n86_), .c(new_n79_), .d(x25), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(new_n58_), .c(new_n45_), .O(z4));
  ...
  oai21  g055(.a(new_n99_), .b(new_n81_), .c(new_n45_), .O(new_n100_));
  aoi22  g056(.a(new_n100_), .b(new_n92_), .c(new_n96_), .d(new_n94_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n58_), .O(z5));
  nand3  g059(.a(x29), .b(x28), .c(x27), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x30), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nor2   g062(.a(new_n93_), .b(new_n80_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n106_), .c(x29), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n105_), .c(new_n85_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n60_), .c(new_n79_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x25), .c(x01), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n45_), .O(z6));
  inv1   g069(.a(x19), .O(new_n114_));
  inv1   g070(.a(new_n81_), .O(new_n115_));
  nand3  g071(.a(new_n98_), .b(new_n97_), .c(new_n115_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand4  g073(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n118_));
  ...
  nand3  g077(.a(new_n121_), .b(x31), .c(new_n120_), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  oai21  g079(.a(new_n116_), .b(new_n120_), .c(new_n121_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n119_), .O(z7));
  inv1   g082(.a(x00), .O(new_n127_));
  nand2  g083(.a(new_n93_), .b(new_n80_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n114_), .b(x18), .c(x14), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n130_), .O(new_n134_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n129_), .c(x31), .d(new_n106_), .O(new_n147_));
  ...
  nand4  g107(.a(new_n146_), .b(new_n129_), .c(x31), .d(x30), .O(new_n152_));
  ...
  nand2  g111(.a(new_n114_), .b(x14), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x18), .c(x17), .d(x16), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n144_), .O(new_n158_));
  nor2   g114(.a(new_n131_), .b(new_n130_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(x16), .c(x15), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n114_), .O(new_n161_));
  nand3  g117(.a(new_n159_), .b(x16), .c(x10), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n144_), .O(new_n163_));
  nand2  g119(.a(new_n159_), .b(x11), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n138_), .O(new_n165_));
  ...
  nor2   g127(.a(new_n129_), .b(x31), .O(new_n172_));
  aoi21  g128(.a(new_n171_), .b(new_n120_), .c(new_n172_), .O(new_n173_));
  nor3   g129(.a(new_n173_), .b(x26), .c(new_n127_), .O(z8));
  aoi21  g130(.a(new_n145_), .b(new_n143_), .c(x33), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(x31), .c(x30), .O(new_n176_));
  ...
  nand3  g135(.a(new_n175_), .b(new_n123_), .c(new_n106_), .O(new_n180_));
  nand2  g136(.a(x33), .b(x31), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n151_), .O(new_n183_));
  inv1   g139(.a(new_n166_), .O(new_n184_));
  inv1   g140(.a(new_n167_), .O(new_n185_));
