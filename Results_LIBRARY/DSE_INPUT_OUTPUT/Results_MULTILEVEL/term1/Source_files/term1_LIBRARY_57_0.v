...
module FAU ( 
  ...
  nor2   g000(.a(x26), .b(x10), .O(new_n45_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n61_), .c(x25), .d(x01), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(x10), .c(x26), .O(z5));
  nand3  g056(.a(x29), .b(x28), .c(x27), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x30), .O(new_n102_));
  inv1   g058(.a(x30), .O(new_n103_));
  nor2   g059(.a(new_n94_), .b(new_n79_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(x29), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n102_), .c(new_n87_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n61_), .c(x25), .d(x01), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x10), .c(x26), .O(z6));
  inv1   g064(.a(x26), .O(new_n109_));
  nand3  g065(.a(new_n104_), .b(x30), .c(x29), .O(new_n110_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n82_), .O(new_n115_));
  nor2   g071(.a(new_n55_), .b(new_n60_), .O(new_n116_));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n104_), .c(new_n117_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n116_), .c(new_n115_), .d(new_n111_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x10), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n109_), .O(z7));
  nand2  g080(.a(new_n94_), .b(new_n79_), .O(new_n125_));
  ...
  nand3  g097(.a(new_n137_), .b(x16), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n48_), .c(x31), .d(new_n103_), .O(new_n144_));
  ...
  nand4  g111(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n141_), .O(new_n157_));
  nand2  g113(.a(x18), .b(x17), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n135_), .c(new_n129_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n158_), .b(new_n160_), .c(new_n135_), .O(new_n161_));
  ...
  nand3  g122(.a(new_n166_), .b(new_n152_), .c(new_n147_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x00), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(x10), .c(x26), .O(z8));
  nand4  g125(.a(new_n143_), .b(new_n52_), .c(x31), .d(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n103_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n125_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n143_), .b(new_n52_), .c(new_n118_), .d(new_n103_), .O(new_n174_));
