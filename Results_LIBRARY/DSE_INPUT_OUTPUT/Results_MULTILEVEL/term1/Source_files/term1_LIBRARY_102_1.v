...
module FAU ( 
  ...
  nand4  g014(.a(new_n58_), .b(new_n55_), .c(new_n51_), .d(new_n46_), .O(z1));
  ...
  aoi21  g092(.a(new_n136_), .b(x11), .c(x16), .O(new_n137_));
  ...
  nand4  g124(.a(new_n165_), .b(x16), .c(new_n126_), .d(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n156_), .c(new_n56_), .d(x31), .O(new_n171_));
  ...
  aoi21  g131(.a(new_n167_), .b(x15), .c(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n148_), .b(new_n57_), .c(x31), .d(x30), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n148_), .b(x29), .c(x31), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n45_), .c(new_n178_), .d(x29), .O(new_n180_));
  nand2  g136(.a(new_n140_), .b(new_n139_), .O(new_n181_));
  nor2   g137(.a(new_n121_), .b(new_n100_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n148_), .c(new_n143_), .d(new_n181_), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n130_), .c(x33), .O(new_n186_));
  oai21  g142(.a(new_n180_), .b(new_n176_), .c(new_n186_), .O(new_n187_));
