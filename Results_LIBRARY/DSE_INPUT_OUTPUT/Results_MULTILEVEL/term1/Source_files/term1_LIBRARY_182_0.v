...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n45_), .c(new_n47_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n79_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n45_), .c(new_n47_), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n60_), .d(new_n79_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n47_), .O(z5));
  inv1   g064(.a(x25), .O(new_n109_));
  nand2  g065(.a(new_n102_), .b(x29), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x30), .c(x01), .O(new_n111_));
  nand3  g067(.a(new_n102_), .b(new_n46_), .c(x29), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(new_n60_), .d(new_n79_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n109_), .c(new_n47_), .O(z6));
  ...
  nor2   g075(.a(new_n59_), .b(new_n45_), .O(new_n120_));
  inv1   g076(.a(new_n102_), .O(new_n121_));
  inv1   g077(.a(x31), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x30), .c(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n79_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n109_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(z7));
  inv1   g082(.a(x15), .O(new_n127_));
  nand2  g083(.a(new_n88_), .b(x14), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n88_), .O(new_n133_));
  nand2  g089(.a(x16), .b(x10), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(new_n127_), .O(new_n135_));
  ...
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n122_), .O(new_n141_));
  ...
  nand2  g099(.a(new_n101_), .b(new_n80_), .O(new_n144_));
  ...
  nand3  g109(.a(x19), .b(new_n85_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n88_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n82_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n157_));
  ...
  nand3  g117(.a(new_n161_), .b(new_n137_), .c(x11), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x15), .O(new_n164_));
  nand4  g120(.a(new_n161_), .b(x16), .c(new_n127_), .d(x10), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n153_), .c(new_n150_), .d(x31), .O(new_n167_));
  ...
  nor2   g126(.a(new_n140_), .b(new_n139_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n130_), .c(new_n47_), .O(new_n173_));
  aoi21  g129(.a(new_n145_), .b(new_n122_), .c(x30), .O(new_n174_));
  nor2   g130(.a(new_n122_), .b(new_n100_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n144_), .c(new_n46_), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(x01), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x33), .O(new_n179_));
  aoi21  g135(.a(new_n162_), .b(new_n159_), .c(new_n127_), .O(new_n180_));
  inv1   g136(.a(new_n165_), .O(new_n181_));
  nand4  g137(.a(new_n145_), .b(new_n122_), .c(new_n46_), .d(x01), .O(new_n182_));
  nand4  g138(.a(new_n144_), .b(x31), .c(x30), .d(x29), .O(new_n183_));
