...
module FAU ( 
  ...
  nand2  g001(.a(new_n45_), .b(x01), .O(new_n46_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(x30), .c(new_n58_), .O(z5));
  aoi21  g057(.a(new_n96_), .b(x29), .c(new_n88_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(x30), .c(new_n58_), .O(z6));
  ...
  nand4  g065(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n83_), .O(new_n110_));
  ...
  nand3  g069(.a(new_n113_), .b(x30), .c(new_n79_), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n110_), .c(new_n106_), .O(z7));
  inv1   g072(.a(x15), .O(new_n117_));
  inv1   g073(.a(x19), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x14), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x18), .c(x17), .d(x16), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand2  g077(.a(x16), .b(x15), .O(new_n122_));
  nand2  g078(.a(x18), .b(x17), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n118_), .O(new_n124_));
  nand2  g080(.a(x16), .b(x10), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n117_), .O(new_n126_));
  inv1   g082(.a(x11), .O(new_n127_));
  inv1   g083(.a(x16), .O(new_n128_));
  oai21  g084(.a(new_n123_), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  aoi21  g085(.a(x18), .b(x12), .c(x17), .O(new_n130_));
  nor2   g086(.a(x18), .b(x13), .O(new_n131_));
  nor3   g087(.a(new_n131_), .b(new_n130_), .c(new_n112_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n129_), .c(new_n126_), .d(new_n124_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n121_), .c(new_n46_), .O(new_n134_));
  nand2  g090(.a(new_n95_), .b(new_n80_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x29), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n45_), .c(new_n58_), .O(new_n137_));
  nand3  g093(.a(new_n135_), .b(x30), .c(x29), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(new_n134_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand4  g097(.a(new_n135_), .b(new_n45_), .c(x29), .d(new_n58_), .O(new_n142_));
  nand2  g098(.a(new_n136_), .b(x30), .O(new_n143_));
  ...
  nand3  g103(.a(new_n118_), .b(x18), .c(x14), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n145_), .O(new_n149_));
  nand4  g105(.a(x19), .b(x18), .c(new_n145_), .d(x12), .O(new_n150_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n128_), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x15), .O(new_n157_));
  nand4  g113(.a(new_n154_), .b(x16), .c(new_n117_), .d(x10), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n144_), .c(new_n141_), .d(x31), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n140_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n79_), .c(x00), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(z8));
  nor2   g119(.a(new_n131_), .b(new_n130_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n129_), .c(new_n126_), .d(new_n124_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n121_), .c(new_n46_), .O(new_n166_));
  aoi21  g122(.a(new_n136_), .b(new_n112_), .c(x30), .O(new_n167_));
  nor2   g123(.a(new_n112_), .b(new_n97_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n135_), .c(new_n45_), .O(new_n169_));
  aoi21  g125(.a(new_n167_), .b(new_n58_), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n166_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x33), .O(new_n172_));
  aoi21  g128(.a(new_n155_), .b(new_n152_), .c(new_n117_), .O(new_n173_));
  inv1   g129(.a(new_n158_), .O(new_n174_));
  nand4  g130(.a(new_n136_), .b(new_n112_), .c(new_n45_), .d(new_n58_), .O(new_n175_));
  nand4  g131(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n173_), .c(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(x33), .c(new_n172_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n79_), .c(x00), .O(new_n180_));
