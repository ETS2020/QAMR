...
module FAU ( 
  ...
  nand3  g014(.a(x30), .b(x07), .c(x04), .O(new_n59_));
  oai21  g015(.a(x07), .b(x04), .c(new_n59_), .O(new_n60_));
  ...
  inv1   g026(.a(x30), .O(new_n71_));
  nor3   g027(.a(new_n71_), .b(new_n45_), .c(x04), .O(new_n72_));
  aoi21  g028(.a(new_n45_), .b(x04), .c(new_n72_), .O(new_n73_));
  ...
  aoi21  g033(.a(new_n74_), .b(x01), .c(new_n77_), .O(new_n78_));
  oai21  g034(.a(new_n78_), .b(new_n73_), .c(new_n70_), .O(new_n79_));
  ...
  nand4  g045(.a(new_n89_), .b(new_n62_), .c(new_n47_), .d(new_n83_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n82_), .c(x25), .d(x01), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z3));
  nand3  g049(.a(new_n47_), .b(x28), .c(new_n83_), .O(new_n94_));
  oai21  g050(.a(x28), .b(new_n83_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n89_), .c(new_n62_), .d(new_n82_), .O(new_n96_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n89_), .c(new_n62_), .d(new_n47_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n82_), .c(x25), .d(x01), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z5));
  nand3  g064(.a(new_n71_), .b(x28), .c(x27), .O(new_n109_));
  oai21  g065(.a(new_n102_), .b(new_n71_), .c(new_n109_), .O(new_n110_));
  nor2   g066(.a(new_n71_), .b(x29), .O(new_n111_));
  aoi21  g067(.a(new_n110_), .b(x29), .c(new_n111_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n88_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n62_), .c(new_n82_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n61_), .c(new_n47_), .O(z6));
  oai21  g071(.a(x31), .b(x07), .c(new_n71_), .O(new_n116_));
  nor4   g072(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n84_), .O(new_n117_));
  ...
  nand2  g083(.a(new_n101_), .b(new_n83_), .O(new_n128_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(x31), .d(new_n71_), .O(new_n148_));
  ...
  nand2  g109(.a(x32), .b(new_n71_), .O(new_n154_));
  ...
  aoi21  g133(.a(new_n152_), .b(new_n122_), .c(x30), .O(new_n178_));
  nor2   g134(.a(new_n122_), .b(new_n100_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n128_), .c(new_n71_), .O(new_n180_));
  aoi21  g136(.a(new_n178_), .b(new_n45_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand4  g139(.a(new_n152_), .b(new_n122_), .c(new_n71_), .d(new_n45_), .O(new_n184_));
