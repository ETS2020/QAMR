...
module FAU ( 
  ...
  nand4  g098(.a(new_n142_), .b(new_n49_), .c(x31), .d(new_n103_), .O(new_n143_));
  ...
  nand2  g124(.a(new_n168_), .b(new_n48_), .O(z8));
  ...
  nand4  g129(.a(new_n142_), .b(new_n53_), .c(new_n119_), .d(new_n103_), .O(new_n174_));
