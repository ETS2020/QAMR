...
module FAU ( 
  ...
  nand4  g067(.a(new_n111_), .b(new_n87_), .c(new_n97_), .d(new_n46_), .O(new_n112_));
  ...
  nand3  g077(.a(new_n97_), .b(x01), .c(x00), .O(new_n122_));
  ...
  nand2  g085(.a(new_n98_), .b(new_n79_), .O(new_n130_));
