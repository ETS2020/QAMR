...
module FAU ( 
  ...
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(new_n45_), .d(x25), .O(new_n110_));
  ...
  oai22  g129(.a(new_n173_), .b(new_n156_), .c(new_n104_), .d(new_n45_), .O(new_n174_));
  nand2  g130(.a(new_n149_), .b(new_n120_), .O(new_n175_));
  nor2   g131(.a(new_n120_), .b(new_n95_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n125_), .c(new_n104_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n45_), .c(new_n175_), .d(new_n104_), .O(new_n178_));
