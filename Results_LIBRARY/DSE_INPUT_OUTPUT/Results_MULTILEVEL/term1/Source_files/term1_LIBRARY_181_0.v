...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n89_), .c(new_n79_), .d(x25), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n58_), .c(new_n46_), .O(z4));
  ...
  xnor2a g062(.a(x30), .b(x28), .O(new_n107_));
  aoi21  g063(.a(x30), .b(new_n100_), .c(new_n80_), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(new_n100_), .c(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n88_), .c(new_n60_), .d(new_n79_), .O(new_n110_));
  ...
  oai21  g070(.a(x31), .b(new_n114_), .c(new_n80_), .O(new_n115_));
  ...
  xnor2a g100(.a(x30), .b(x29), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(x27), .c(new_n123_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  inv1   g104(.a(x32), .O(new_n149_));
  aoi21  g105(.a(new_n98_), .b(new_n80_), .c(new_n100_), .O(new_n150_));
  nand3  g106(.a(new_n114_), .b(x29), .c(x27), .O(new_n151_));
  oai21  g107(.a(new_n150_), .b(new_n114_), .c(new_n151_), .O(new_n152_));
  ...
  nor2   g127(.a(new_n141_), .b(new_n140_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n131_), .c(new_n46_), .O(new_n174_));
  aoi21  g130(.a(new_n119_), .b(new_n100_), .c(x30), .O(new_n175_));
  nand2  g131(.a(new_n98_), .b(new_n80_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(x31), .c(x29), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(x30), .c(new_n175_), .d(x27), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  aoi21  g136(.a(new_n163_), .b(new_n160_), .c(new_n127_), .O(new_n181_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n184_), .c(x27), .O(new_n186_));
