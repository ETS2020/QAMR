...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(new_n63_), .c(new_n81_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(x25), .c(x01), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n49_), .O(z5));
  inv1   g057(.a(x25), .O(new_n102_));
  nand4  g058(.a(new_n46_), .b(x29), .c(x28), .d(x27), .O(new_n103_));
  oai21  g059(.a(new_n46_), .b(x29), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n88_), .c(new_n81_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n102_), .c(new_n62_), .O(z6));
  inv1   g062(.a(new_n85_), .O(new_n107_));
  nor2   g063(.a(new_n84_), .b(new_n83_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g065(.a(new_n63_), .b(x25), .c(x01), .O(new_n110_));
  ...
  nand4  g088(.a(new_n132_), .b(new_n114_), .c(new_n50_), .d(x31), .O(new_n133_));
  ...
  nand2  g102(.a(new_n116_), .b(new_n146_), .O(new_n147_));
  nand3  g103(.a(x29), .b(new_n94_), .c(new_n82_), .O(new_n148_));
  inv1   g104(.a(x31), .O(new_n149_));
  aoi21  g105(.a(new_n46_), .b(new_n45_), .c(new_n149_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n147_), .d(new_n145_), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n143_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n140_), .c(new_n138_), .d(new_n135_), .O(new_n153_));
  ...
  nand2  g112(.a(new_n156_), .b(new_n49_), .O(z8));
  inv1   g113(.a(x00), .O(new_n158_));
  nand4  g114(.a(new_n132_), .b(new_n113_), .c(new_n54_), .d(new_n149_), .O(new_n159_));
  aoi21  g115(.a(new_n116_), .b(new_n146_), .c(x31), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n145_), .c(new_n142_), .d(new_n140_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n138_), .c(new_n135_), .d(new_n113_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x33), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n159_), .c(x30), .O(new_n165_));
  nor3   g121(.a(new_n54_), .b(new_n46_), .c(x29), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n165_), .c(new_n81_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n158_), .O(z9));
endmodule
