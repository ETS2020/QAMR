...
module FAU ( 
  ...
  nor3   g058(.a(new_n102_), .b(new_n94_), .c(new_n63_), .O(z5));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n99_), .c(new_n94_), .O(new_n122_));
  ...
  aoi21  g128(.a(new_n172_), .b(new_n149_), .c(new_n45_), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n145_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n104_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n126_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n145_), .b(new_n174_), .c(new_n119_), .d(new_n104_), .O(new_n179_));
  nand2  g135(.a(x33), .b(x30), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g137(.a(new_n164_), .b(new_n128_), .O(new_n182_));
  xnor2a g138(.a(x31), .b(x30), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n166_), .c(new_n182_), .d(new_n163_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n161_), .c(new_n159_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n156_), .c(x33), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n46_), .O(new_n188_));
  aoi21  g144(.a(new_n181_), .b(new_n150_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n178_), .c(new_n45_), .O(z9));
endmodule
