...
module FAU ( 
  ...
  nor2   g049(.a(new_n93_), .b(new_n56_), .O(new_n94_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n94_), .c(x25), .d(x01), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n45_), .c(x26), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n103_), .c(new_n62_), .d(new_n45_), .O(new_n108_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n103_), .c(new_n62_), .d(new_n45_), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n80_), .c(x25), .d(x01), .O(new_n119_));
  ...
  nand3  g078(.a(new_n62_), .b(x25), .c(x01), .O(new_n123_));
  nand3  g079(.a(new_n105_), .b(x30), .c(x29), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n45_), .c(new_n80_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n122_), .O(z7));
  nand4  g083(.a(x32), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(z8));
