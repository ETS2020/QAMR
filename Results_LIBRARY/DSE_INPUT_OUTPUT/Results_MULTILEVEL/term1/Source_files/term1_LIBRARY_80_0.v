...
module FAU ( 
  ...
  inv1   g039(.a(new_n60_), .O(new_n84_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n81_), .c(new_n45_), .O(z3));
  xor2a  g055(.a(x28), .b(x27), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n97_), .c(new_n84_), .d(new_n82_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n81_), .c(new_n45_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n97_), .c(new_n84_), .d(new_n82_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x25), .c(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n47_), .O(z5));
  nand2  g067(.a(new_n105_), .b(x29), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x30), .c(x01), .O(new_n113_));
  nand3  g069(.a(new_n105_), .b(new_n46_), .c(x29), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n97_), .c(new_n84_), .d(new_n82_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n81_), .c(new_n47_), .O(z6));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(new_n105_), .b(new_n118_), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x01), .O(new_n120_));
  ...
  nand4  g079(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n124_));
  nor2   g080(.a(x26), .b(new_n81_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n84_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x01), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n121_), .O(z7));
  inv1   g084(.a(x15), .O(new_n129_));
  nand2  g085(.a(new_n94_), .b(x14), .O(new_n130_));
  ...
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n94_), .O(new_n135_));
  ...
  nor3   g098(.a(new_n142_), .b(new_n141_), .c(new_n118_), .O(new_n143_));
  ...
  nand2  g101(.a(new_n104_), .b(new_n83_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n46_), .c(x01), .O(new_n148_));
  ...
  nand4  g108(.a(new_n146_), .b(new_n46_), .c(x29), .d(x01), .O(new_n153_));
  nand2  g109(.a(new_n147_), .b(x30), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n91_), .c(x13), .O(new_n156_));
  nand3  g112(.a(new_n94_), .b(x18), .c(x14), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n88_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(new_n88_), .d(x12), .O(new_n159_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n139_), .c(x11), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x15), .O(new_n166_));
  nand4  g122(.a(new_n163_), .b(x16), .c(new_n129_), .d(x10), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n155_), .c(new_n152_), .d(x31), .O(new_n169_));
  ...
  nor2   g128(.a(new_n142_), .b(new_n141_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n132_), .c(new_n47_), .O(new_n175_));
  aoi21  g131(.a(new_n147_), .b(new_n118_), .c(x30), .O(new_n176_));
  nor2   g132(.a(new_n118_), .b(new_n103_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n146_), .c(new_n46_), .O(new_n178_));
  ...
  aoi21  g137(.a(new_n164_), .b(new_n161_), .c(new_n129_), .O(new_n182_));
  inv1   g138(.a(new_n167_), .O(new_n183_));
  nand4  g139(.a(new_n147_), .b(new_n118_), .c(new_n46_), .d(x01), .O(new_n184_));
  nand4  g140(.a(new_n146_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
