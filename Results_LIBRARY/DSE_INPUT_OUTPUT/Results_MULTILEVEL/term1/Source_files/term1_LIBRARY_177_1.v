...
module FAU ( 
  ...
  nand4  g076(.a(new_n61_), .b(new_n120_), .c(x25), .d(x01), .O(new_n121_));
  aoi21  g077(.a(new_n119_), .b(new_n93_), .c(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(x30), .c(new_n80_), .O(z7));
  inv1   g079(.a(x32), .O(new_n124_));
  nand2  g080(.a(new_n105_), .b(new_n81_), .O(new_n125_));
  nand3  g081(.a(x19), .b(new_n88_), .c(x13), .O(new_n126_));
  nand3  g082(.a(new_n91_), .b(x18), .c(x14), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(new_n85_), .O(new_n128_));
  nand4  g084(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n129_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n125_), .c(new_n124_), .d(x31), .O(new_n141_));
  aoi21  g097(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(x17), .c(x16), .d(x15), .O(new_n143_));
  nand2  g099(.a(x16), .b(x15), .O(new_n144_));
  nand2  g100(.a(x18), .b(x17), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(new_n91_), .O(new_n146_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n85_), .O(new_n152_));
  inv1   g108(.a(x13), .O(new_n153_));
  nand2  g109(.a(new_n88_), .b(new_n153_), .O(new_n154_));
  nor2   g110(.a(new_n120_), .b(new_n107_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n154_), .c(new_n152_), .d(new_n125_), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  and2   g113(.a(new_n157_), .b(new_n150_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n148_), .c(new_n146_), .d(new_n143_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x32), .O(new_n160_));
  oai21  g116(.a(new_n141_), .b(new_n107_), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(z8));
  inv1   g119(.a(x33), .O(new_n164_));
  nand2  g120(.a(new_n125_), .b(x29), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n140_), .c(new_n164_), .d(new_n120_), .O(new_n166_));
  aoi21  g122(.a(new_n88_), .b(new_n153_), .c(x31), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n165_), .c(new_n146_), .d(new_n143_), .O(new_n170_));
