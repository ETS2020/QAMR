...
module FAU ( 
  ...
  nand2  g013(.a(x05), .b(x03), .O(new_n58_));
  oai21  g014(.a(new_n57_), .b(x05), .c(new_n58_), .O(new_n59_));
  nand2  g015(.a(x06), .b(new_n51_), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand4  g017(.a(x06), .b(x05), .c(new_n48_), .d(new_n51_), .O(new_n62_));
  ...
  oai21  g023(.a(new_n67_), .b(new_n63_), .c(new_n56_), .O(new_n68_));
  xnor2a g024(.a(x07), .b(x04), .O(new_n69_));
  nand3  g025(.a(new_n59_), .b(x06), .c(new_n51_), .O(new_n70_));
  nand3  g026(.a(new_n60_), .b(x05), .c(new_n48_), .O(new_n71_));
  aoi21  g027(.a(new_n71_), .b(new_n70_), .c(x01), .O(new_n72_));
  nand2  g028(.a(new_n48_), .b(new_n51_), .O(new_n73_));
  nor2   g029(.a(new_n48_), .b(new_n51_), .O(new_n74_));
  inv1   g030(.a(new_n74_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(new_n64_), .c(x01), .O(new_n77_));
  ...
  oai21  g048(.a(new_n92_), .b(new_n83_), .c(new_n64_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n91_), .c(new_n84_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n83_), .c(new_n64_), .O(z4));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n75_), .d(new_n84_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x25), .c(x01), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n64_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n75_), .c(new_n84_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n83_), .c(new_n64_), .O(z6));
  inv1   g069(.a(x05), .O(new_n114_));
  oai21  g070(.a(x31), .b(new_n114_), .c(new_n57_), .O(new_n115_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(x31), .d(new_n57_), .O(new_n148_));
  ...
  nand2  g109(.a(x32), .b(new_n57_), .O(new_n154_));
  ...
  nor3   g124(.a(new_n168_), .b(new_n167_), .c(new_n123_), .O(new_n169_));
  ...
  nand2  g129(.a(new_n173_), .b(new_n64_), .O(z8));
  nor2   g130(.a(new_n168_), .b(new_n167_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n166_), .c(new_n164_), .d(new_n162_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n159_), .c(new_n64_), .O(new_n177_));
  aoi21  g133(.a(new_n152_), .b(new_n123_), .c(x30), .O(new_n178_));
  nor2   g134(.a(new_n123_), .b(new_n98_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n128_), .c(new_n57_), .O(new_n180_));
  aoi21  g136(.a(new_n178_), .b(x05), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand4  g139(.a(new_n152_), .b(new_n123_), .c(new_n57_), .d(x05), .O(new_n184_));
  nand4  g140(.a(new_n128_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
