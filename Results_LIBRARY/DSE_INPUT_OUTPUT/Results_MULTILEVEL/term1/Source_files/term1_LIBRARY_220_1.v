...
module FAU ( 
  ...
  nand3  g055(.a(new_n45_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n97_), .c(new_n61_), .O(new_n101_));
  ...
  oai21  g065(.a(new_n45_), .b(x24), .c(new_n96_), .O(new_n110_));
  aoi22  g066(.a(new_n110_), .b(new_n100_), .c(new_n109_), .d(new_n107_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n60_), .O(z5));
  nand3  g069(.a(new_n106_), .b(x30), .c(x24), .O(new_n114_));
  ...
  oai21  g073(.a(new_n117_), .b(new_n116_), .c(new_n96_), .O(new_n118_));
  nand4  g074(.a(new_n88_), .b(x29), .c(x28), .d(x27), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(new_n61_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n81_), .c(x25), .d(x01), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n47_), .O(z6));
  oai21  g078(.a(x31), .b(x30), .c(new_n99_), .O(new_n123_));
  inv1   g079(.a(new_n84_), .O(new_n124_));
  nor2   g080(.a(x31), .b(x24), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n98_), .c(new_n83_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n95_), .c(new_n94_), .d(new_n124_), .O(new_n127_));
  nand3  g083(.a(new_n105_), .b(x30), .c(x29), .O(new_n128_));
  nor2   g084(.a(new_n61_), .b(new_n60_), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  nand4  g086(.a(new_n105_), .b(new_n130_), .c(x30), .d(x29), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n129_), .c(new_n81_), .d(x25), .O(new_n132_));
  aoi21  g088(.a(new_n128_), .b(x31), .c(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n127_), .c(new_n123_), .O(z7));
  nand2  g090(.a(new_n104_), .b(new_n82_), .O(new_n135_));
  ...
  nand3  g095(.a(new_n98_), .b(x18), .c(x14), .O(new_n140_));
  ...
  nand2  g118(.a(new_n98_), .b(x14), .O(new_n163_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n166_), .c(new_n98_), .O(new_n168_));
  ...
  nand2  g139(.a(new_n158_), .b(new_n130_), .O(new_n184_));
  nor2   g140(.a(new_n130_), .b(new_n108_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n135_), .c(new_n45_), .O(new_n186_));
  aoi22  g142(.a(new_n186_), .b(x24), .c(new_n184_), .d(new_n45_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n183_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  nand4  g145(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n190_));
  oai22  g146(.a(new_n190_), .b(new_n99_), .c(new_n184_), .d(x30), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n153_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(x33), .c(new_n189_), .O(new_n193_));
