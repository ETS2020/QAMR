...
module FAU ( 
  ...
  nand4  g057(.a(new_n101_), .b(new_n98_), .c(x25), .d(x01), .O(new_n102_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n93_), .c(new_n61_), .d(new_n45_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n98_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z5));
  nor4   g068(.a(new_n94_), .b(x30), .c(new_n106_), .d(new_n104_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x27), .c(new_n98_), .d(x25), .O(new_n114_));
  ...
  nand4  g074(.a(new_n61_), .b(new_n118_), .c(x25), .d(x01), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(new_n92_), .c(new_n119_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(x30), .c(new_n98_), .O(z7));
  inv1   g077(.a(x32), .O(new_n122_));
  nand2  g078(.a(new_n104_), .b(new_n80_), .O(new_n123_));
  nand3  g079(.a(x19), .b(new_n87_), .c(x13), .O(new_n124_));
  nand3  g080(.a(new_n90_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n124_), .c(new_n84_), .O(new_n126_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n123_), .c(new_n122_), .d(x31), .O(new_n139_));
  aoi21  g095(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(x17), .c(x16), .d(x15), .O(new_n141_));
  nand2  g097(.a(x16), .b(x15), .O(new_n142_));
  nand2  g098(.a(x18), .b(x17), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n90_), .O(new_n144_));
  ...
  nor2   g108(.a(new_n118_), .b(new_n106_), .O(new_n153_));
  ...
  nand4  g115(.a(new_n159_), .b(new_n45_), .c(new_n98_), .d(x00), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(z8));
  inv1   g117(.a(x33), .O(new_n162_));
  nand2  g118(.a(new_n123_), .b(x29), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n138_), .c(new_n162_), .d(new_n118_), .O(new_n164_));
