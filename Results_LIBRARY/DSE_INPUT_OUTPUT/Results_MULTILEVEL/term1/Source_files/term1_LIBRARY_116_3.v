...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n60_), .c(new_n45_), .O(z4));
  ...
  nand2  g106(.a(x32), .b(new_n102_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  aoi21  g108(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n130_), .O(new_n158_));
  ...
  nand2  g120(.a(new_n128_), .b(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x31), .O(new_n166_));
  aoi21  g122(.a(new_n163_), .b(new_n127_), .c(new_n166_), .O(new_n167_));
  ...
  aoi21  g144(.a(new_n188_), .b(new_n177_), .c(new_n124_), .O(z9));
endmodule
