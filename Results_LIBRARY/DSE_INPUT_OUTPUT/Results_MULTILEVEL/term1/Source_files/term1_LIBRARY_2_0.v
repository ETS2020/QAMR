...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n61_), .d(x30), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x30), .c(x26), .O(z5));
  nand3  g066(.a(x29), .b(x28), .c(x27), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n101_), .c(new_n61_), .d(x30), .O(new_n112_));
  ...
  nand3  g077(.a(new_n121_), .b(x30), .c(new_n95_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n118_), .c(new_n116_), .O(z7));
  nand2  g080(.a(new_n102_), .b(new_n79_), .O(new_n125_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n126_), .c(new_n48_), .d(x31), .O(new_n142_));
  ...
  aoi21  g110(.a(new_n84_), .b(new_n154_), .c(new_n120_), .O(new_n155_));
  ...
  nand4  g118(.a(new_n141_), .b(new_n125_), .c(new_n52_), .d(x31), .O(new_n163_));
  nand2  g119(.a(new_n84_), .b(new_n154_), .O(new_n164_));
  nor2   g120(.a(new_n120_), .b(new_n104_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n153_), .d(new_n125_), .O(new_n166_));
  ...
  oai21  g126(.a(new_n163_), .b(new_n104_), .c(new_n170_), .O(new_n171_));
