...
module FAU ( 
  ...
  nand3  g061(.a(new_n105_), .b(new_n89_), .c(new_n84_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n102_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n47_), .O(z5));
  oai22  g066(.a(new_n90_), .b(new_n85_), .c(x30), .d(x22), .O(new_n111_));
  nand3  g067(.a(x30), .b(new_n45_), .c(new_n103_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n100_), .O(new_n113_));
  inv1   g069(.a(new_n83_), .O(new_n114_));
  nor2   g070(.a(new_n82_), .b(new_n103_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n89_), .c(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n104_), .c(x28), .d(x27), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n113_), .c(x29), .O(new_n119_));
  inv1   g075(.a(new_n91_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x30), .c(new_n98_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n119_), .c(new_n60_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n80_), .c(x25), .d(x01), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n47_), .O(z6));
  oai21  g080(.a(x31), .b(x22), .c(new_n104_), .O(new_n125_));
  ...
  nand4  g086(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n84_), .O(new_n131_));
  nor2   g087(.a(new_n60_), .b(new_n59_), .O(new_n132_));
  inv1   g088(.a(x31), .O(new_n133_));
  nand4  g089(.a(new_n100_), .b(new_n133_), .c(x30), .d(x29), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n132_), .c(new_n80_), .d(x25), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n131_), .c(new_n127_), .d(new_n125_), .O(z7));
  nand2  g093(.a(new_n99_), .b(new_n81_), .O(new_n138_));
  ...
  aoi21  g099(.a(new_n143_), .b(new_n141_), .c(new_n103_), .O(new_n144_));
  nand4  g100(.a(x19), .b(x18), .c(new_n103_), .d(x12), .O(new_n145_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n139_), .c(x31), .d(new_n104_), .O(new_n157_));
  ...
  nand2  g118(.a(x32), .b(new_n104_), .O(new_n163_));
  ...
  nor3   g133(.a(new_n177_), .b(new_n176_), .c(new_n133_), .O(new_n178_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n168_), .c(new_n47_), .O(new_n186_));
  aoi21  g142(.a(new_n161_), .b(new_n133_), .c(x30), .O(new_n187_));
  nor2   g143(.a(new_n133_), .b(new_n98_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n138_), .c(new_n104_), .O(new_n189_));
  aoi21  g145(.a(new_n187_), .b(new_n45_), .c(new_n189_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand4  g148(.a(new_n161_), .b(new_n133_), .c(new_n104_), .d(new_n45_), .O(new_n193_));
  nand4  g149(.a(new_n138_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n156_), .O(new_n196_));
