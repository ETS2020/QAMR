...
module FAU ( 
  ...
  nand4  g081(.a(new_n125_), .b(new_n119_), .c(new_n118_), .d(new_n114_), .O(z7));
  ...
  nand4  g135(.a(new_n146_), .b(new_n176_), .c(new_n122_), .d(new_n105_), .O(new_n180_));
  oai21  g136(.a(new_n176_), .b(new_n105_), .c(new_n180_), .O(new_n181_));
  ...
  nand2  g144(.a(new_n188_), .b(new_n46_), .O(new_n189_));
  aoi21  g145(.a(new_n181_), .b(new_n151_), .c(new_n189_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n179_), .c(new_n45_), .O(z9));
endmodule
