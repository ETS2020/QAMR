...
module FAU ( 
  ...
  nand3  g074(.a(new_n59_), .b(x25), .c(x01), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  nand3  g076(.a(new_n104_), .b(new_n120_), .c(x29), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x30), .c(new_n78_), .O(new_n122_));
  ...
  nand4  g129(.a(new_n173_), .b(x30), .c(new_n78_), .d(x00), .O(new_n174_));
