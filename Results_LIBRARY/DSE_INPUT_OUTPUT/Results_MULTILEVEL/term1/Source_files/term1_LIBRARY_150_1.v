...
module FAU ( 
  ...
  nor2   g045(.a(new_n89_), .b(new_n83_), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n61_), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n58_), .c(new_n82_), .O(new_n92_));
  ...
  nand3  g052(.a(new_n96_), .b(new_n91_), .c(new_n58_), .O(new_n97_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n62_), .d(new_n58_), .O(new_n107_));
  ...
  nand2  g070(.a(x30), .b(new_n102_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n90_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n60_), .c(new_n58_), .O(z6));
  nor4   g074(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n83_), .O(new_n119_));
  nand4  g075(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n58_), .O(new_n121_));
  nand3  g077(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x31), .O(new_n123_));
  nand3  g079(.a(new_n104_), .b(new_n45_), .c(x29), .O(new_n124_));
  ...
  nand2  g084(.a(new_n103_), .b(new_n82_), .O(new_n129_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(new_n128_), .d(x31), .O(new_n149_));
  nand2  g105(.a(new_n134_), .b(x14), .O(new_n150_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n153_), .c(new_n134_), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(new_n146_), .O(new_n157_));
  inv1   g113(.a(x11), .O(new_n158_));
  oai21  g114(.a(new_n154_), .b(new_n158_), .c(new_n140_), .O(new_n159_));
  aoi21  g115(.a(x18), .b(x12), .c(x17), .O(new_n160_));
  nor2   g116(.a(x18), .b(x13), .O(new_n161_));
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n45_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n159_), .c(new_n157_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n155_), .c(new_n130_), .O(new_n165_));
  ...
  nand2  g124(.a(new_n168_), .b(new_n58_), .O(z8));
  nor2   g125(.a(new_n161_), .b(new_n160_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n152_), .c(new_n58_), .O(new_n172_));
  aoi21  g128(.a(new_n130_), .b(new_n111_), .c(x31), .O(new_n173_));
  aoi21  g129(.a(new_n130_), .b(x30), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  inv1   g132(.a(x33), .O(new_n177_));
  nand4  g133(.a(new_n129_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  nand3  g134(.a(new_n130_), .b(new_n45_), .c(new_n111_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n148_), .c(new_n177_), .O(new_n181_));
