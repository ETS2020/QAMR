...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n60_), .c(new_n46_), .O(new_n91_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n90_), .c(new_n60_), .d(new_n79_), .O(new_n107_));
  ...
  oai21  g068(.a(new_n104_), .b(new_n45_), .c(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x29), .O(new_n114_));
  nand2  g070(.a(x30), .b(new_n102_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n111_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n59_), .c(new_n46_), .O(z6));
  oai21  g074(.a(x31), .b(x05), .c(new_n45_), .O(new_n119_));
  nand2  g075(.a(new_n86_), .b(new_n83_), .O(new_n120_));
  nor3   g076(.a(new_n120_), .b(new_n88_), .c(new_n87_), .O(new_n121_));
  nand4  g077(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(new_n119_), .O(new_n123_));
  inv1   g079(.a(x05), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand3  g083(.a(new_n104_), .b(new_n127_), .c(x29), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nor2   g085(.a(new_n127_), .b(x30), .O(new_n130_));
  aoi22  g086(.a(new_n130_), .b(new_n124_), .c(new_n129_), .d(x30), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n123_), .O(z7));
  inv1   g088(.a(x15), .O(new_n133_));
  inv1   g089(.a(x19), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x14), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(x18), .c(x17), .d(x16), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g093(.a(x16), .b(x15), .O(new_n138_));
  nand2  g094(.a(x18), .b(x17), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(new_n134_), .O(new_n140_));
  nand2  g096(.a(x16), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n139_), .c(new_n133_), .O(new_n142_));
  inv1   g098(.a(x11), .O(new_n143_));
  inv1   g099(.a(x16), .O(new_n144_));
  oai21  g100(.a(new_n139_), .b(new_n143_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(x18), .b(x12), .c(x17), .O(new_n146_));
  nor2   g102(.a(x18), .b(x13), .O(new_n147_));
  nor3   g103(.a(new_n147_), .b(new_n146_), .c(new_n127_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n145_), .c(new_n142_), .d(new_n140_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n137_), .c(new_n46_), .O(new_n150_));
  nand2  g106(.a(new_n103_), .b(new_n80_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x29), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n45_), .c(new_n124_), .O(new_n153_));
  nand3  g109(.a(new_n151_), .b(x30), .c(x29), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n153_), .c(new_n150_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  inv1   g112(.a(x32), .O(new_n157_));
  nand4  g113(.a(new_n151_), .b(new_n45_), .c(x29), .d(new_n124_), .O(new_n158_));
  nand2  g114(.a(new_n152_), .b(x30), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  inv1   g116(.a(x18), .O(new_n161_));
  nand3  g117(.a(x19), .b(new_n161_), .c(x13), .O(new_n162_));
  nand3  g118(.a(new_n134_), .b(x18), .c(x14), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n162_), .c(new_n84_), .O(new_n164_));
  nand4  g120(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n165_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n144_), .c(x11), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x15), .O(new_n172_));
  nand4  g128(.a(new_n169_), .b(x16), .c(new_n133_), .d(x10), .O(new_n173_));
  ...
  nor2   g134(.a(new_n147_), .b(new_n146_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n145_), .c(new_n142_), .d(new_n140_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n137_), .c(new_n46_), .O(new_n181_));
  aoi21  g137(.a(new_n152_), .b(new_n127_), .c(x30), .O(new_n182_));
  nor2   g138(.a(new_n127_), .b(new_n102_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n151_), .c(new_n45_), .O(new_n184_));
  aoi21  g140(.a(new_n182_), .b(new_n124_), .c(new_n184_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n181_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x33), .O(new_n187_));
  aoi21  g143(.a(new_n170_), .b(new_n167_), .c(new_n133_), .O(new_n188_));
  inv1   g144(.a(new_n173_), .O(new_n189_));
  nand4  g145(.a(new_n152_), .b(new_n127_), .c(new_n45_), .d(new_n124_), .O(new_n190_));
  nand4  g146(.a(new_n151_), .b(x31), .c(x30), .d(x29), .O(new_n191_));
