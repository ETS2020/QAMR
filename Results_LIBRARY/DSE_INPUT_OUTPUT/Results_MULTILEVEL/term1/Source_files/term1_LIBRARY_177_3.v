...
module FAU ( 
  ...
  aoi21  g076(.a(new_n120_), .b(new_n98_), .c(new_n82_), .O(new_n121_));
  ...
  nand2  g080(.a(new_n97_), .b(new_n83_), .O(new_n125_));
  ...
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n118_), .d(new_n46_), .O(new_n177_));
