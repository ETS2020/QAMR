...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n62_), .c(new_n49_), .O(z3));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n63_), .d(new_n46_), .O(new_n100_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n63_), .c(new_n46_), .d(x25), .O(new_n108_));
  ...
  nor2   g071(.a(new_n57_), .b(new_n62_), .O(new_n116_));
  ...
  nand4  g102(.a(new_n141_), .b(new_n50_), .c(x31), .d(x30), .O(new_n147_));
  nand2  g103(.a(x32), .b(new_n102_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  aoi21  g105(.a(new_n127_), .b(x14), .c(new_n125_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x17), .c(x16), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n139_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x15), .O(new_n153_));
  nand2  g109(.a(x18), .b(x17), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n153_), .c(new_n127_), .O(new_n155_));
  ...
  nand2  g117(.a(new_n125_), .b(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x31), .O(new_n163_));
  aoi21  g119(.a(new_n160_), .b(new_n124_), .c(new_n163_), .O(new_n164_));
  ...
  aoi21  g123(.a(new_n149_), .b(new_n146_), .c(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n145_), .c(new_n45_), .O(z8));
  nand4  g125(.a(new_n141_), .b(new_n54_), .c(x31), .d(x30), .O(new_n170_));
  ...
  nand4  g129(.a(new_n141_), .b(new_n54_), .c(new_n118_), .d(new_n102_), .O(new_n174_));
  nand2  g130(.a(x33), .b(x30), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g132(.a(new_n160_), .b(new_n124_), .O(new_n177_));
  xnor2a g133(.a(x31), .b(x30), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n162_), .c(new_n177_), .d(new_n159_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n157_), .c(new_n155_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n152_), .c(x33), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n46_), .O(new_n183_));
  aoi21  g139(.a(new_n176_), .b(new_n146_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n173_), .c(new_n45_), .O(z9));
endmodule
