...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(x30), .O(new_n92_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n83_), .O(new_n115_));
  nand3  g071(.a(new_n61_), .b(x25), .c(x01), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n99_), .b(new_n117_), .c(x29), .O(new_n118_));
  ...
  nand2  g078(.a(new_n98_), .b(new_n80_), .O(new_n123_));
  ...
  nor2   g122(.a(new_n117_), .b(new_n97_), .O(new_n167_));
  ...
  oai21  g128(.a(new_n165_), .b(new_n97_), .c(new_n172_), .O(new_n173_));
