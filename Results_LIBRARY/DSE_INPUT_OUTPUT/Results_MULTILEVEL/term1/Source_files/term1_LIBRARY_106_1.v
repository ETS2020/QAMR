...
module FAU ( 
  ...
  nand4  g067(.a(new_n111_), .b(new_n106_), .c(new_n93_), .d(new_n61_), .O(new_n112_));
  ...
  nand3  g073(.a(new_n117_), .b(x30), .c(x13), .O(new_n118_));
  nand3  g074(.a(new_n109_), .b(new_n45_), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n116_), .c(new_n60_), .O(z6));
  nand3  g078(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n123_));
  ...
  aoi22  g088(.a(new_n132_), .b(x13), .c(x31), .d(new_n45_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n126_), .O(z7));
  nand2  g090(.a(new_n108_), .b(new_n81_), .O(new_n135_));
  ...
  aoi21  g095(.a(new_n139_), .b(new_n137_), .c(new_n85_), .O(new_n140_));
  ...
  oai21  g109(.a(new_n136_), .b(new_n45_), .c(new_n153_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n135_), .c(x29), .O(new_n155_));
  nand2  g111(.a(new_n135_), .b(x29), .O(new_n156_));
  nand2  g112(.a(x19), .b(new_n88_), .O(new_n157_));
  aoi21  g113(.a(new_n139_), .b(new_n157_), .c(new_n85_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n142_), .c(x16), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n147_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x15), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n151_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n136_), .c(x31), .d(x30), .O(new_n163_));
  oai21  g119(.a(new_n136_), .b(x30), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n156_), .O(new_n165_));
  nand2  g121(.a(new_n138_), .b(x14), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x18), .c(x17), .d(x16), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n150_), .O(new_n168_));
  nor2   g124(.a(new_n88_), .b(new_n85_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(x16), .c(x15), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n138_), .O(new_n171_));
  nand3  g127(.a(new_n169_), .b(x16), .c(x10), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n150_), .O(new_n173_));
  nand2  g129(.a(new_n169_), .b(x11), .O(new_n174_));
  ...
  nand3  g136(.a(new_n180_), .b(new_n165_), .c(new_n155_), .O(new_n181_));
  ...
  nor2   g140(.a(new_n138_), .b(new_n85_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(x16), .c(x15), .O(new_n186_));
  nand2  g142(.a(x17), .b(x16), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n150_), .c(new_n138_), .O(new_n188_));
  inv1   g144(.a(x10), .O(new_n189_));
  oai21  g145(.a(new_n187_), .b(new_n189_), .c(new_n150_), .O(new_n190_));
  nand2  g146(.a(x17), .b(x11), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n144_), .O(new_n192_));
  ...
  aoi21  g151(.a(new_n186_), .b(new_n88_), .c(new_n195_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n184_), .c(new_n46_), .O(new_n197_));
  nor2   g153(.a(new_n177_), .b(x31), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n156_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n45_), .O(new_n200_));
  nand3  g156(.a(new_n135_), .b(x31), .c(x29), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(x30), .c(x13), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n200_), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(new_n197_), .c(x33), .O(new_n204_));
  nand4  g160(.a(new_n162_), .b(new_n135_), .c(x31), .d(x30), .O(new_n205_));
  nand4  g161(.a(new_n156_), .b(new_n130_), .c(new_n45_), .d(x19), .O(new_n206_));
  nor2   g162(.a(new_n206_), .b(x18), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(x17), .c(x16), .d(x15), .O(new_n208_));
  oai21  g164(.a(new_n205_), .b(new_n107_), .c(new_n208_), .O(new_n209_));
  nand3  g165(.a(x19), .b(new_n85_), .c(x12), .O(new_n210_));
  nand3  g166(.a(new_n138_), .b(x17), .c(x14), .O(new_n211_));
  aoi21  g167(.a(new_n211_), .b(new_n210_), .c(new_n144_), .O(new_n212_));
  nand3  g168(.a(new_n185_), .b(new_n144_), .c(x11), .O(new_n213_));
  inv1   g169(.a(new_n213_), .O(new_n214_));
  oai21  g170(.a(new_n214_), .b(new_n212_), .c(x15), .O(new_n215_));
  nand4  g171(.a(new_n185_), .b(x16), .c(new_n150_), .d(x10), .O(new_n216_));
  nand2  g172(.a(new_n216_), .b(new_n215_), .O(new_n217_));
  nand4  g173(.a(new_n217_), .b(new_n156_), .c(new_n130_), .d(new_n45_), .O(new_n218_));
  nor2   g174(.a(new_n218_), .b(new_n88_), .O(new_n219_));
  aoi21  g175(.a(new_n209_), .b(x13), .c(new_n219_), .O(new_n220_));
  oai21  g176(.a(new_n220_), .b(x33), .c(new_n204_), .O(new_n221_));
  nand3  g177(.a(new_n221_), .b(new_n80_), .c(x00), .O(new_n222_));
