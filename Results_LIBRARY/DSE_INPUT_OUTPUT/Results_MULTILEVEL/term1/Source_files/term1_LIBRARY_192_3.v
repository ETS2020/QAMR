...
module FAU ( 
  ...
  nand2  g086(.a(x31), .b(new_n46_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n130_), .c(new_n125_), .O(z7));
  ...
  nand2  g100(.a(new_n144_), .b(x11), .O(new_n145_));
  nor2   g101(.a(new_n138_), .b(new_n88_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x17), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  aoi21  g104(.a(new_n143_), .b(x16), .c(new_n148_), .O(new_n149_));
  inv1   g105(.a(new_n147_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(x16), .c(new_n136_), .d(x10), .O(new_n151_));
  oai21  g107(.a(new_n149_), .b(new_n136_), .c(new_n151_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n135_), .c(x31), .d(new_n46_), .O(new_n153_));
  nand3  g109(.a(x32), .b(x30), .c(new_n45_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n134_), .c(x29), .O(new_n156_));
  nor2   g112(.a(new_n133_), .b(new_n105_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n139_), .b(new_n137_), .c(new_n85_), .O(new_n159_));
  inv1   g115(.a(new_n142_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(x16), .O(new_n161_));
  nand3  g117(.a(new_n150_), .b(new_n144_), .c(x11), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(x32), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x31), .c(x30), .d(x15), .O(new_n164_));
  nand2  g120(.a(x32), .b(new_n46_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(x10), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(x18), .b(x17), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n144_), .c(new_n138_), .O(new_n168_));
  inv1   g124(.a(x11), .O(new_n169_));
  oai21  g125(.a(new_n167_), .b(new_n169_), .c(new_n144_), .O(new_n170_));
  nand2  g126(.a(x18), .b(x12), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n85_), .O(new_n172_));
  inv1   g128(.a(x13), .O(new_n173_));
  aoi21  g129(.a(new_n88_), .b(new_n173_), .c(new_n126_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n58_), .O(new_n176_));
  nand2  g132(.a(x30), .b(new_n45_), .O(new_n177_));
  nand2  g133(.a(new_n46_), .b(x15), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n177_), .c(new_n138_), .d(x14), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x18), .c(x17), .d(x16), .O(new_n180_));
  nand3  g136(.a(new_n146_), .b(x17), .c(x16), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n46_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x10), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n136_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n180_), .c(new_n176_), .O(new_n185_));
  and2   g141(.a(new_n185_), .b(x32), .O(new_n186_));
  aoi21  g142(.a(new_n166_), .b(new_n158_), .c(new_n186_), .O(new_n187_));
  ...
  nand2  g148(.a(new_n162_), .b(new_n161_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n46_), .c(x15), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n151_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n192_), .c(new_n126_), .O(new_n196_));
  nand2  g152(.a(x33), .b(x30), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n196_), .c(new_n157_), .O(new_n198_));
  nand4  g154(.a(new_n193_), .b(new_n192_), .c(x31), .d(x30), .O(new_n199_));
  nand2  g155(.a(x33), .b(new_n46_), .O(new_n200_));
  oai21  g156(.a(new_n199_), .b(new_n136_), .c(new_n200_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n134_), .c(x29), .O(new_n202_));
  aoi22  g158(.a(new_n46_), .b(new_n136_), .c(new_n138_), .d(x14), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(x18), .c(x17), .d(x16), .O(new_n204_));
  oai21  g160(.a(new_n126_), .b(new_n136_), .c(x30), .O(new_n205_));
  nand2  g161(.a(x16), .b(x15), .O(new_n206_));
  oai21  g162(.a(new_n206_), .b(new_n167_), .c(new_n138_), .O(new_n207_));
  nand4  g163(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n208_));
  nand2  g164(.a(new_n88_), .b(new_n173_), .O(new_n209_));
  nand4  g165(.a(new_n209_), .b(new_n172_), .c(new_n170_), .d(new_n131_), .O(new_n210_));
  aoi21  g166(.a(new_n208_), .b(new_n136_), .c(new_n210_), .O(new_n211_));
  nand4  g167(.a(new_n211_), .b(new_n207_), .c(new_n205_), .d(new_n204_), .O(new_n212_));
  nand2  g168(.a(new_n212_), .b(x33), .O(new_n213_));
  nand2  g169(.a(new_n213_), .b(new_n202_), .O(new_n214_));
  oai21  g170(.a(new_n214_), .b(new_n198_), .c(new_n80_), .O(new_n215_));
  oai21  g171(.a(new_n215_), .b(new_n191_), .c(new_n58_), .O(z9));
endmodule
