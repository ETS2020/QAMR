...
module FAU ( 
  ...
  nor2   g000(.a(x26), .b(x11), .O(new_n45_));
  ...
  nand4  g049(.a(new_n93_), .b(new_n61_), .c(new_n80_), .d(new_n79_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(x25), .c(x11), .d(x01), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n61_), .d(new_n79_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(x25), .c(x11), .d(x01), .O(new_n101_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n61_), .d(new_n79_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x25), .c(x11), .d(x01), .O(new_n110_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(new_n92_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n61_), .c(x25), .d(x01), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(x11), .c(x26), .O(z6));
  nand3  g074(.a(new_n105_), .b(x30), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x31), .O(new_n120_));
  inv1   g076(.a(new_n81_), .O(new_n121_));
  nand4  g077(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n121_), .O(new_n122_));
  nand3  g078(.a(new_n61_), .b(x11), .c(x01), .O(new_n123_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n79_), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n124_), .c(new_n122_), .d(new_n120_), .O(z7));
  nand2  g087(.a(new_n104_), .b(new_n80_), .O(new_n132_));
  ...
  nor2   g095(.a(new_n88_), .b(new_n85_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x17), .c(new_n139_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x15), .O(new_n143_));
  nor2   g099(.a(new_n139_), .b(x15), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n140_), .c(x17), .d(x10), .O(new_n145_));
  ...
  nand3  g105(.a(new_n149_), .b(new_n132_), .c(x29), .O(new_n150_));
  nand2  g106(.a(new_n132_), .b(x29), .O(new_n151_));
  nand2  g107(.a(x32), .b(new_n114_), .O(new_n152_));
  oai21  g108(.a(new_n147_), .b(new_n114_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  inv1   g110(.a(x15), .O(new_n155_));
  nand2  g111(.a(new_n88_), .b(x14), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x18), .c(x17), .d(x16), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g114(.a(new_n140_), .b(x17), .c(x15), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n139_), .O(new_n160_));
  nand2  g116(.a(x18), .b(x17), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n155_), .c(new_n88_), .O(new_n162_));
  inv1   g118(.a(x10), .O(new_n163_));
  oai21  g119(.a(new_n161_), .b(new_n163_), .c(new_n155_), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  nor2   g121(.a(x18), .b(x13), .O(new_n166_));
  nor3   g122(.a(new_n166_), .b(new_n165_), .c(new_n127_), .O(new_n167_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n154_), .c(new_n150_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n79_), .c(x11), .d(x00), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(z8));
  nand4  g128(.a(new_n146_), .b(new_n52_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n114_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n132_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n146_), .b(new_n52_), .c(new_n127_), .d(new_n114_), .O(new_n177_));
  ...
  xnor2a g138(.a(x31), .b(x30), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n182_), .c(new_n181_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n158_), .c(x33), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n180_), .c(new_n176_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x00), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(x11), .c(x26), .O(z9));
endmodule
