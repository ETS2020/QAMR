...
module FAU ( 
  ...
  nand3  g054(.a(new_n94_), .b(x28), .c(x27), .O(new_n99_));
  ...
  nor2   g063(.a(new_n101_), .b(new_n93_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n80_), .c(new_n94_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n89_), .c(new_n79_), .d(x25), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n58_), .c(new_n45_), .O(z6));
  inv1   g068(.a(new_n85_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n84_), .c(new_n82_), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n45_), .b(new_n115_), .c(new_n79_), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(new_n59_), .c(new_n92_), .d(new_n58_), .O(new_n117_));
  oai21  g073(.a(new_n114_), .b(new_n86_), .c(new_n117_), .O(z7));
  ...
  nor3   g089(.a(new_n133_), .b(new_n132_), .c(new_n115_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n131_), .c(new_n128_), .d(new_n126_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n123_), .c(new_n45_), .O(new_n136_));
  nand3  g092(.a(x30), .b(x29), .c(x28), .O(new_n137_));
  oai21  g093(.a(x30), .b(x28), .c(new_n137_), .O(new_n138_));
  aoi22  g094(.a(new_n138_), .b(new_n80_), .c(new_n94_), .d(new_n101_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x32), .O(new_n141_));
  inv1   g097(.a(x32), .O(new_n142_));
  nand3  g098(.a(new_n109_), .b(x30), .c(new_n80_), .O(new_n143_));
  nand2  g099(.a(new_n93_), .b(new_n80_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n94_), .c(x29), .O(new_n145_));
  ...
  nor2   g121(.a(new_n133_), .b(new_n132_), .O(new_n166_));
  ...
  aoi21  g124(.a(new_n93_), .b(new_n80_), .c(new_n101_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(x31), .c(new_n94_), .O(new_n170_));
  ...
  nand3  g132(.a(new_n108_), .b(x31), .c(x30), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nor3   g134(.a(x31), .b(x30), .c(x28), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n80_), .O(new_n180_));
  nand3  g136(.a(new_n115_), .b(new_n94_), .c(new_n101_), .O(new_n181_));
