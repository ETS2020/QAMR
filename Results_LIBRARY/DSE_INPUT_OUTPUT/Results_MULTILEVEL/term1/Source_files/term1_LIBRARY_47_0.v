...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(x29), .c(x26), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n90_), .c(x29), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n45_), .c(x25), .d(x01), .O(new_n96_));
  ...
  nand3  g056(.a(new_n100_), .b(new_n90_), .c(x29), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n45_), .c(x25), .d(x01), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z5));
  nand3  g060(.a(new_n100_), .b(x30), .c(x29), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x28), .c(x27), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n89_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n62_), .c(x25), .d(x01), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x29), .c(x26), .O(z6));
  ...
  nand3  g072(.a(new_n62_), .b(x25), .c(x01), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(new_n99_), .b(new_n118_), .c(x30), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x29), .c(new_n45_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n116_), .c(new_n112_), .O(z7));
  ...
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(x31), .d(new_n106_), .O(new_n143_));
  nand2  g099(.a(x32), .b(x30), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(new_n123_), .O(new_n145_));
  nand3  g101(.a(new_n81_), .b(new_n126_), .c(x13), .O(new_n146_));
  nand4  g102(.a(new_n124_), .b(x31), .c(x30), .d(new_n98_), .O(new_n147_));
  oai22  g103(.a(new_n147_), .b(new_n146_), .c(new_n124_), .d(new_n126_), .O(new_n148_));
  nand3  g104(.a(new_n81_), .b(new_n128_), .c(x14), .O(new_n149_));
  oai22  g105(.a(new_n149_), .b(new_n147_), .c(new_n124_), .d(x14), .O(new_n150_));
  aoi22  g106(.a(new_n150_), .b(x18), .c(new_n148_), .d(x19), .O(new_n151_));
  nand3  g107(.a(new_n124_), .b(x31), .c(x30), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n123_), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n131_), .c(new_n151_), .d(new_n125_), .O(new_n155_));
  nor2   g111(.a(new_n154_), .b(new_n137_), .O(new_n156_));
  aoi21  g112(.a(new_n155_), .b(x16), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(x32), .b(new_n106_), .O(new_n158_));
  nand4  g114(.a(x17), .b(x16), .c(new_n140_), .d(x10), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n153_), .c(x19), .d(x18), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n158_), .c(x28), .O(new_n162_));
  nor2   g118(.a(new_n126_), .b(new_n125_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(x16), .c(x15), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n128_), .O(new_n165_));
  nand3  g121(.a(new_n163_), .b(x16), .c(x10), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n140_), .O(new_n167_));
  nand2  g123(.a(new_n163_), .b(x11), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n134_), .O(new_n169_));
  aoi21  g125(.a(x18), .b(x12), .c(x17), .O(new_n170_));
  nor2   g126(.a(x18), .b(x13), .O(new_n171_));
  nor3   g127(.a(new_n171_), .b(new_n170_), .c(new_n118_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(x32), .c(new_n162_), .d(new_n81_), .O(new_n174_));
  oai21  g130(.a(new_n157_), .b(new_n140_), .c(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n145_), .c(x00), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(x29), .c(x26), .O(z8));
  inv1   g133(.a(new_n123_), .O(new_n178_));
  inv1   g134(.a(x33), .O(new_n179_));
  nand4  g135(.a(new_n142_), .b(new_n179_), .c(x31), .d(x30), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n106_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  aoi21  g139(.a(new_n128_), .b(x14), .c(new_n126_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  oai21  g141(.a(new_n123_), .b(new_n118_), .c(x30), .O(new_n186_));
  inv1   g142(.a(new_n170_), .O(new_n187_));
  aoi21  g143(.a(x31), .b(new_n106_), .c(new_n171_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n187_), .c(new_n169_), .O(new_n189_));
  aoi21  g145(.a(new_n166_), .b(new_n140_), .c(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n186_), .c(new_n185_), .d(new_n165_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  aoi21  g148(.a(new_n137_), .b(new_n133_), .c(new_n140_), .O(new_n193_));
  inv1   g149(.a(new_n141_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n193_), .c(new_n179_), .O(new_n195_));
  nor2   g151(.a(new_n195_), .b(x31), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n106_), .c(new_n98_), .d(new_n81_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n192_), .c(new_n183_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(x29), .c(new_n45_), .d(x00), .O(new_n199_));
