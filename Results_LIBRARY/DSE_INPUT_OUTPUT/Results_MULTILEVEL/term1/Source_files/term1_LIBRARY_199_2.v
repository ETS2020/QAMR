...
module FAU ( 
  ...
  nor3   g051(.a(new_n95_), .b(new_n80_), .c(new_n61_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n61_), .c(new_n48_), .O(z4));
  ...
  nand4  g069(.a(new_n113_), .b(new_n100_), .c(new_n62_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n61_), .c(new_n48_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n102_), .b(new_n116_), .c(x29), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n45_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  nand3  g075(.a(new_n102_), .b(x30), .c(x29), .O(new_n120_));
  ...
  nor2   g079(.a(new_n56_), .b(new_n80_), .O(new_n124_));
  ...
  oai22  g099(.a(new_n143_), .b(new_n131_), .c(new_n111_), .d(new_n45_), .O(new_n144_));
  nor2   g100(.a(x28), .b(x27), .O(new_n145_));
  nor3   g101(.a(new_n145_), .b(new_n111_), .c(new_n101_), .O(new_n146_));
  inv1   g102(.a(new_n145_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(new_n111_), .c(new_n146_), .d(new_n45_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n144_), .c(new_n49_), .O(new_n150_));
  nand3  g106(.a(new_n148_), .b(x30), .c(new_n45_), .O(new_n151_));
  nand3  g107(.a(new_n147_), .b(new_n111_), .c(x29), .O(new_n152_));
  ...
  nand3  g117(.a(new_n161_), .b(new_n138_), .c(x11), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x15), .O(new_n164_));
  nand4  g120(.a(new_n161_), .b(x16), .c(new_n128_), .d(x10), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n153_), .c(new_n49_), .d(x31), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n150_), .c(x00), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n48_), .O(z8));
  nand4  g126(.a(new_n166_), .b(new_n53_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n111_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n147_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n166_), .b(new_n53_), .c(new_n116_), .d(new_n111_), .O(new_n175_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n184_));
