...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n187_;
  nor2   g000(.a(x26), .b(x01), .O(new_n45_));
  ...
  nand3  g022(.a(new_n66_), .b(x26), .c(new_n61_), .O(new_n67_));
  ...
  nand3  g030(.a(new_n74_), .b(x26), .c(new_n61_), .O(new_n75_));
  ...
  nand3  g041(.a(new_n85_), .b(new_n79_), .c(x25), .O(new_n86_));
  aoi21  g042(.a(new_n86_), .b(x01), .c(x26), .O(z3));
  xor2a  g043(.a(x28), .b(x27), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n85_), .c(x25), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(x01), .c(x26), .O(z4));
  inv1   g046(.a(x25), .O(new_n91_));
  inv1   g047(.a(x26), .O(new_n92_));
  inv1   g048(.a(new_n58_), .O(new_n93_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n91_), .c(new_n61_), .O(z5));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n92_), .d(x25), .O(new_n108_));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n97_), .c(new_n91_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n115_), .c(new_n111_), .d(new_n93_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x01), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n92_), .O(z7));
  nand2  g078(.a(new_n96_), .b(new_n79_), .O(new_n123_));
  ...
  aoi21  g124(.a(new_n168_), .b(x01), .c(x26), .O(z8));
  ...
  nand4  g130(.a(new_n142_), .b(new_n170_), .c(new_n116_), .d(new_n102_), .O(new_n175_));
  ...
  aoi21  g143(.a(new_n187_), .b(x01), .c(x26), .O(z9));
endmodule
