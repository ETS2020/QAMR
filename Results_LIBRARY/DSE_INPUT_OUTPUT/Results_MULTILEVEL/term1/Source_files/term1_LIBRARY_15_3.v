...
module FAU ( 
  ...
  nor2   g075(.a(new_n119_), .b(new_n81_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n116_), .c(new_n115_), .d(new_n111_), .O(z7));
  ...
  nand4  g096(.a(new_n140_), .b(new_n50_), .c(x31), .d(new_n102_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n140_), .b(new_n50_), .c(x31), .d(x30), .O(new_n146_));
  nand2  g102(.a(x32), .b(new_n102_), .O(new_n147_));
  ...
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n46_), .O(new_n162_));
  ...
  nand4  g123(.a(new_n140_), .b(new_n54_), .c(x31), .d(x30), .O(new_n168_));
  ...
  nand4  g127(.a(new_n140_), .b(new_n54_), .c(new_n46_), .d(new_n102_), .O(new_n172_));
