...
module FAU ( 
  ...
  and2   g43(.a(new_n87_), .b(new_n60_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n80_), .c(x25), .d(x01), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n79_), .c(x26), .O(z3));
  xor2a  g46(.a(x28), .b(x27), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n88_), .c(x25), .d(x01), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n79_), .c(x26), .O(z4));
  inv1   g49(.a(x29), .O(new_n94_));
  nand2  g50(.a(x28), .b(x27), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n94_), .b(x28), .c(x27), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n94_), .c(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n87_), .c(new_n60_), .d(new_n45_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(x25), .c(x01), .d(new_n79_), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(z5));
  nand2  g58(.a(new_n95_), .b(x30), .O(new_n103_));
  ...
  nand2  g63(.a(x30), .b(new_n94_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n87_), .c(new_n60_), .d(new_n45_), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(x25), .c(x01), .d(new_n79_), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(z6));
  nand2  g69(.a(x30), .b(x29), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n95_), .c(x31), .O(new_n115_));
  nand4  g71(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n116_));
  aoi21  g72(.a(x03), .b(x02), .c(new_n59_), .O(new_n117_));
  ...
  aoi21  g77(.a(new_n121_), .b(new_n96_), .c(new_n118_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n79_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n45_), .O(z7));
  zero   g81(.O(z8));
  zero   g82(.O(z9));
endmodule
