...
module FAU ( 
  ...
  nand4  g042(.a(new_n86_), .b(new_n60_), .c(new_n47_), .d(new_n80_), .O(new_n87_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n86_), .c(new_n60_), .d(new_n47_), .O(new_n102_));
  ...
  oai21  g069(.a(x31), .b(x06), .c(new_n106_), .O(new_n114_));
  ...
  aoi22  g079(.a(new_n123_), .b(new_n45_), .c(new_n122_), .d(x30), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n117_), .O(z7));
  nand2  g081(.a(new_n98_), .b(new_n80_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(x31), .d(new_n106_), .O(new_n146_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n157_), .c(new_n47_), .O(new_n175_));
  aoi21  g131(.a(new_n150_), .b(new_n120_), .c(x30), .O(new_n176_));
  nor2   g132(.a(new_n120_), .b(new_n97_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n126_), .c(new_n106_), .O(new_n178_));
  ...
  nand4  g137(.a(new_n150_), .b(new_n120_), .c(new_n106_), .d(new_n45_), .O(new_n182_));
  nand4  g138(.a(new_n126_), .b(x31), .c(x30), .d(x29), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n145_), .O(new_n185_));
