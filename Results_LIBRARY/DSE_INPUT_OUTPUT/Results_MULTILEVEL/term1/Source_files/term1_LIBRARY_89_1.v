...
module FAU ( 
  ...
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n45_), .d(x25), .O(new_n109_));
  ...
  nor2   g072(.a(new_n55_), .b(new_n61_), .O(new_n117_));
  ...
  nand2  g079(.a(new_n95_), .b(new_n79_), .O(new_n124_));
  ...
  nand4  g129(.a(new_n142_), .b(new_n52_), .c(new_n119_), .d(new_n103_), .O(new_n174_));
