...
module FAU ( 
  ...
  nor2   g41(.a(x22), .b(x17), .O(new_n86_));
  nor2   g42(.a(x23), .b(x18), .O(new_n87_));
  nor2   g43(.a(x24), .b(x19), .O(new_n88_));
  nor3   g44(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  and2   g45(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  nor2   g46(.a(new_n90_), .b(new_n60_), .O(new_n91_));
  ...
  nand2  g51(.a(new_n89_), .b(new_n85_), .O(new_n96_));
  xor2a  g52(.a(x28), .b(x27), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n98_));
  ...
  inv1   g58(.a(x28), .O(new_n103_));
  nor2   g59(.a(x29), .b(new_n103_), .O(new_n104_));
  aoi22  g60(.a(new_n104_), .b(x27), .c(new_n102_), .d(x29), .O(new_n105_));
  nor2   g61(.a(new_n105_), .b(new_n90_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n95_), .c(x25), .d(x01), .O(new_n107_));
  ...
  nand4  g69(.a(new_n113_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n114_));
  ...
  inv1   g75(.a(new_n86_), .O(new_n120_));
  inv1   g76(.a(new_n87_), .O(new_n121_));
  inv1   g77(.a(new_n88_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n85_), .O(new_n123_));
  nand3  g79(.a(new_n95_), .b(x01), .c(new_n45_), .O(new_n124_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n102_), .c(new_n94_), .O(new_n129_));
  nor2   g85(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n125_), .c(new_n123_), .d(new_n119_), .O(z7));
  zero   g87(.O(z9));
endmodule
