...
module FAU ( 
  ...
  nand2  g040(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  nor2   g041(.a(new_n85_), .b(x27), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(new_n79_), .c(x25), .d(x24), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n58_), .O(z3));
  xnor2a g044(.a(x28), .b(x27), .O(new_n89_));
  nor2   g045(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n79_), .c(x25), .d(x24), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n58_), .O(z4));
  inv1   g048(.a(x29), .O(new_n93_));
  inv1   g049(.a(x27), .O(new_n94_));
  inv1   g050(.a(x28), .O(new_n95_));
  nor2   g051(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand3  g052(.a(new_n93_), .b(x28), .c(x27), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n93_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n84_), .c(new_n60_), .d(new_n79_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(x25), .c(x24), .d(x01), .O(new_n101_));
  ...
  nand3  g061(.a(new_n96_), .b(new_n105_), .c(x29), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n83_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n60_), .c(x25), .d(x01), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(x24), .c(x26), .O(z6));
  inv1   g065(.a(x31), .O(new_n110_));
  nor2   g066(.a(new_n105_), .b(new_n93_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n96_), .c(new_n110_), .O(new_n112_));
  ...
  nor2   g071(.a(new_n59_), .b(new_n58_), .O(new_n116_));
  nand4  g072(.a(new_n96_), .b(new_n110_), .c(x30), .d(x29), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(x25), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n112_), .c(x24), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n79_), .O(z7));
  nand2  g076(.a(new_n95_), .b(new_n94_), .O(new_n121_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n122_), .c(x31), .d(new_n105_), .O(new_n141_));
  nand2  g097(.a(x32), .b(x30), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n121_), .c(x29), .O(new_n144_));
  nand2  g100(.a(new_n121_), .b(x29), .O(new_n145_));
  nand4  g101(.a(new_n140_), .b(new_n122_), .c(x31), .d(x30), .O(new_n146_));
  nand2  g102(.a(x32), .b(new_n105_), .O(new_n147_));
  ...
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n110_), .O(new_n162_));
  ...
  aoi21  g122(.a(new_n166_), .b(x24), .c(x26), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n140_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n105_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n121_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n140_), .b(new_n168_), .c(new_n110_), .d(new_n105_), .O(new_n173_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n79_), .c(x24), .d(x00), .O(new_n185_));
