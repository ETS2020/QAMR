...
module FAU ( 
  ...
  aoi22  g058(.a(new_n102_), .b(new_n100_), .c(new_n87_), .d(new_n83_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n62_), .c(x25), .d(x01), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n45_), .c(x26), .O(z5));
  nor4   g061(.a(new_n89_), .b(x30), .c(new_n101_), .d(new_n99_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n93_), .d(x25), .O(new_n107_));
  ...
  nand2  g070(.a(new_n99_), .b(new_n80_), .O(new_n115_));
  ...
  oai21  g110(.a(new_n134_), .b(new_n101_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x00), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n45_), .c(x26), .O(z8));
  nand2  g113(.a(new_n115_), .b(x29), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n133_), .c(new_n53_), .d(new_n148_), .O(new_n159_));
  aoi21  g115(.a(new_n117_), .b(new_n146_), .c(x31), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n158_), .c(new_n139_), .d(new_n136_), .O(new_n163_));
