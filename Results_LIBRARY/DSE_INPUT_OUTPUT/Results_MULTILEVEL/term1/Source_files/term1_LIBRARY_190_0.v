...
module FAU ( 
  ...
  oai21  g018(.a(new_n62_), .b(x03), .c(x06), .O(new_n63_));
  inv1   g019(.a(x06), .O(new_n64_));
  oai21  g020(.a(new_n64_), .b(x02), .c(x05), .O(new_n65_));
  oai22  g021(.a(new_n65_), .b(x03), .c(new_n63_), .d(x02), .O(new_n66_));
  ...
  nor2   g027(.a(new_n62_), .b(x03), .O(new_n72_));
  nor2   g028(.a(new_n64_), .b(x02), .O(new_n73_));
  nand3  g029(.a(new_n59_), .b(x06), .c(x05), .O(new_n74_));
  oai21  g030(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(new_n75_));
  nand3  g031(.a(new_n75_), .b(x30), .c(new_n61_), .O(new_n76_));
  aoi21  g032(.a(new_n76_), .b(new_n71_), .c(new_n69_), .O(new_n77_));
  aoi21  g033(.a(new_n68_), .b(new_n57_), .c(new_n77_), .O(new_n78_));
  nor3   g034(.a(new_n78_), .b(x09), .c(new_n56_), .O(z2));
  inv1   g035(.a(new_n45_), .O(new_n80_));
  ...
  oai21  g050(.a(new_n94_), .b(new_n61_), .c(new_n80_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n81_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n61_), .c(new_n80_), .O(z4));
  ...
  oai21  g101(.a(new_n145_), .b(new_n133_), .c(new_n80_), .O(new_n146_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n133_), .c(new_n80_), .O(new_n178_));
