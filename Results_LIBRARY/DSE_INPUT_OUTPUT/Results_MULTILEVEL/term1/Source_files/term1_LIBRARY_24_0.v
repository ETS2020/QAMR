...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n88_), .c(new_n60_), .d(x30), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n79_), .c(x25), .d(x01), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z5));
  inv1   g063(.a(new_n101_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(x30), .c(new_n99_), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n89_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n60_), .c(x25), .d(x01), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(x30), .c(x26), .O(z6));
  ...
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n83_), .O(new_n118_));
  ...
  nand3  g077(.a(new_n121_), .b(x30), .c(new_n79_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n118_), .c(new_n114_), .O(z7));
  inv1   g080(.a(x32), .O(new_n125_));
  nand2  g081(.a(new_n100_), .b(new_n80_), .O(new_n126_));
  ...
  aoi21  g114(.a(new_n129_), .b(new_n158_), .c(new_n120_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n151_), .c(new_n148_), .d(new_n127_), .O(new_n162_));
  ...
  aoi21  g121(.a(new_n165_), .b(x30), .c(x26), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n145_), .b(new_n126_), .c(new_n167_), .d(x31), .O(new_n168_));
  nand2  g124(.a(new_n129_), .b(new_n158_), .O(new_n169_));
  nor2   g125(.a(new_n120_), .b(new_n99_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n169_), .c(new_n157_), .d(new_n126_), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  and2   g128(.a(new_n172_), .b(new_n155_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n153_), .c(new_n151_), .d(new_n148_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  oai21  g131(.a(new_n168_), .b(new_n99_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x00), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(x30), .c(x26), .O(z9));
endmodule
