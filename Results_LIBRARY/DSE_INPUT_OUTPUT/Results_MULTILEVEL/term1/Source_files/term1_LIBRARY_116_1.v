...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n94_), .d(new_n81_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n80_), .c(new_n61_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n61_), .O(z6));
  ...
  nand2  g129(.a(x33), .b(new_n103_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n125_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n118_), .d(new_n103_), .O(new_n177_));
