...
module FAU ( 
  ...
  oai21  g072(.a(x31), .b(x26), .c(new_n103_), .O(new_n117_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n101_), .c(new_n78_), .O(new_n126_));
  ...
  nand2  g085(.a(new_n100_), .b(new_n80_), .O(new_n130_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n131_), .c(x31), .d(new_n103_), .O(new_n147_));
  ...
  nand2  g108(.a(x32), .b(new_n103_), .O(new_n153_));
  ...
  nand2  g131(.a(x33), .b(new_n103_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n130_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n146_), .b(new_n174_), .c(new_n123_), .d(new_n103_), .O(new_n179_));
