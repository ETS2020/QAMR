...
module FAU ( 
  ...
  nand3  g071(.a(new_n115_), .b(new_n46_), .c(x30), .O(new_n116_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(new_n127_), .d(x31), .O(new_n144_));
  aoi21  g100(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x17), .c(x16), .d(x15), .O(new_n146_));
  nand2  g102(.a(x16), .b(x15), .O(new_n147_));
  nand2  g103(.a(x18), .b(x17), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n91_), .O(new_n149_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n85_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  nand2  g113(.a(new_n88_), .b(new_n157_), .O(new_n158_));
  nor2   g114(.a(new_n46_), .b(new_n105_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n158_), .c(new_n156_), .d(new_n128_), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n154_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n151_), .c(new_n149_), .d(new_n146_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x32), .O(new_n163_));
  oai21  g119(.a(new_n144_), .b(new_n105_), .c(new_n163_), .O(new_n164_));
  ...
  nand2  g124(.a(new_n128_), .b(x29), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n143_), .c(new_n168_), .d(new_n46_), .O(new_n170_));
  aoi21  g126(.a(new_n88_), .b(new_n157_), .c(x31), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n156_), .c(new_n153_), .d(new_n151_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n169_), .c(new_n149_), .d(new_n146_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n170_), .c(x30), .O(new_n176_));
  nand3  g132(.a(x33), .b(new_n46_), .c(x30), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n176_), .c(new_n80_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n167_), .O(z9));
endmodule
