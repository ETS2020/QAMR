...
module FAU ( 
  ...
  nor3   g039(.a(new_n83_), .b(new_n55_), .c(x27), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n79_), .c(x25), .d(x22), .O(new_n85_));
  nor2   g041(.a(new_n85_), .b(new_n60_), .O(z3));
  nor2   g042(.a(new_n83_), .b(new_n55_), .O(new_n87_));
  inv1   g043(.a(x27), .O(new_n88_));
  nand3  g044(.a(x28), .b(new_n88_), .c(x22), .O(new_n89_));
  oai21  g045(.a(x28), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n87_), .c(x25), .d(x01), .O(new_n91_));
  aoi21  g047(.a(new_n91_), .b(x22), .c(x26), .O(z4));
  inv1   g048(.a(x28), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n88_), .O(new_n94_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n96_), .c(new_n83_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n61_), .c(x25), .d(x01), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(x22), .c(x26), .O(z5));
  nand3  g057(.a(x29), .b(x28), .c(x27), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x30), .O(new_n103_));
  inv1   g059(.a(x30), .O(new_n104_));
  nand3  g060(.a(new_n94_), .b(new_n104_), .c(x29), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(new_n83_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n61_), .c(new_n79_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(x25), .c(x22), .d(x01), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z6));
  nand3  g066(.a(new_n94_), .b(x30), .c(x29), .O(new_n111_));
  ...
  nand3  g071(.a(new_n61_), .b(x22), .c(x01), .O(new_n116_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n95_), .c(new_n79_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(new_n115_), .d(new_n112_), .O(z7));
  nand2  g079(.a(new_n93_), .b(new_n88_), .O(new_n124_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n48_), .c(x31), .d(new_n104_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n142_), .b(new_n48_), .c(x31), .d(x30), .O(new_n148_));
  ...
  aoi21  g124(.a(new_n168_), .b(x22), .c(x26), .O(z8));
  ...
  nand4  g129(.a(new_n142_), .b(new_n52_), .c(new_n119_), .d(new_n104_), .O(new_n174_));
  ...
  aoi21  g142(.a(new_n186_), .b(x22), .c(x26), .O(z9));
endmodule
