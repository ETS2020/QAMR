...
module FAU ( 
  ...
  aoi21  g050(.a(new_n94_), .b(x30), .c(new_n58_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n93_), .c(x30), .O(new_n97_));
  ...
  nand2  g081(.a(new_n125_), .b(x01), .O(z7));
  nand2  g082(.a(new_n102_), .b(new_n80_), .O(new_n127_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n88_), .O(new_n158_));
  ...
  nand4  g131(.a(new_n143_), .b(new_n171_), .c(new_n120_), .d(new_n45_), .O(new_n176_));
