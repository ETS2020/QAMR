...
module FAU ( 
  ...
  nand3  g019(.a(new_n63_), .b(new_n46_), .c(x01), .O(new_n64_));
  ...
  oai21  g026(.a(new_n70_), .b(new_n65_), .c(new_n59_), .O(new_n71_));
  ...
  oai21  g034(.a(new_n78_), .b(new_n75_), .c(new_n72_), .O(new_n79_));
  ...
  aoi21  g051(.a(new_n95_), .b(new_n46_), .c(new_n45_), .O(z3));
  ...
  oai21  g058(.a(new_n102_), .b(new_n84_), .c(x29), .O(new_n103_));
  inv1   g059(.a(x29), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x28), .c(x27), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(new_n103_), .c(new_n91_), .d(new_n87_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n61_), .c(new_n83_), .d(x25), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n46_), .c(new_n45_), .O(z5));
  nor4   g064(.a(new_n93_), .b(x30), .c(new_n104_), .d(new_n102_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x27), .c(new_n83_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n45_), .O(z6));
  inv1   g067(.a(new_n88_), .O(new_n112_));
  inv1   g068(.a(new_n89_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(new_n87_), .O(new_n114_));
  ...
  nand2  g073(.a(new_n102_), .b(new_n84_), .O(new_n118_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n119_), .c(x31), .d(new_n46_), .O(new_n138_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n83_), .c(x00), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n48_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n137_), .b(new_n166_), .c(x31), .d(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n46_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n118_), .c(x29), .O(new_n170_));
  nand4  g126(.a(new_n137_), .b(new_n166_), .c(new_n157_), .d(new_n46_), .O(new_n171_));
  ...
  nand4  g135(.a(new_n179_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n149_), .c(x33), .O(new_n181_));
