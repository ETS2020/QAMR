...
module FAU ( 
  ...
  nand3  g055(.a(new_n99_), .b(new_n60_), .c(new_n46_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n82_), .c(x25), .d(x01), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(z5));
  nand3  g059(.a(new_n89_), .b(x29), .c(x28), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(x27), .c(new_n82_), .d(x25), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n46_), .c(new_n45_), .O(z6));
  inv1   g063(.a(new_n86_), .O(new_n108_));
  nor2   g064(.a(new_n85_), .b(new_n84_), .O(new_n109_));
  ...
  oai21  g068(.a(new_n110_), .b(new_n87_), .c(new_n112_), .O(z7));
  inv1   g069(.a(new_n47_), .O(new_n114_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n119_), .c(new_n114_), .O(new_n133_));
  nor2   g089(.a(x28), .b(x27), .O(new_n134_));
  nor3   g090(.a(new_n134_), .b(new_n46_), .c(new_n97_), .O(new_n135_));
  inv1   g091(.a(new_n134_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x29), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n46_), .c(new_n135_), .d(new_n45_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand3  g097(.a(new_n137_), .b(x30), .c(new_n45_), .O(new_n142_));
  nand3  g098(.a(new_n136_), .b(new_n46_), .c(x29), .O(new_n143_));
  ...
  nand2  g121(.a(x33), .b(new_n46_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n136_), .c(x29), .O(new_n168_));
  nand4  g124(.a(new_n159_), .b(new_n164_), .c(new_n128_), .d(new_n46_), .O(new_n169_));
  ...
  nand2  g137(.a(new_n181_), .b(new_n114_), .O(z9));
endmodule
