...
module FAU ( 
  ...
  nand2  g58(.a(x28), .b(x27), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(x29), .O(new_n104_));
  inv1   g60(.a(x29), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x28), .c(x27), .O(new_n106_));
  aoi22  g62(.a(new_n106_), .b(new_n104_), .c(new_n96_), .d(new_n84_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n61_), .c(x25), .d(x01), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n45_), .c(x26), .O(z5));
  nand3  g65(.a(x29), .b(x28), .c(x27), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(x30), .O(new_n111_));
  inv1   g67(.a(x30), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(x29), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n103_), .c(new_n111_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n115_));
  inv1   g71(.a(new_n115_), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(x25), .c(x01), .d(new_n45_), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(z6));
  nand2  g74(.a(x30), .b(x29), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n103_), .c(x31), .O(new_n120_));
  nand4  g76(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n121_));
  nand3  g77(.a(new_n61_), .b(x01), .c(new_n45_), .O(new_n122_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n103_), .c(new_n80_), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n123_), .c(new_n121_), .d(new_n120_), .O(z7));
  zero   g85(.O(z9));
endmodule
