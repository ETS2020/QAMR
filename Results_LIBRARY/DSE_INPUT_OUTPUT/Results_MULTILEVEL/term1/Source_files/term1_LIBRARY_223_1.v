...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n60_), .c(new_n46_), .O(new_n94_));
  ...
  nand2  g060(.a(x30), .b(new_n45_), .O(new_n105_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n105_), .c(new_n93_), .d(new_n60_), .O(new_n111_));
  ...
  nand3  g072(.a(new_n116_), .b(x30), .c(x06), .O(new_n117_));
  inv1   g073(.a(x30), .O(new_n118_));
  nand3  g074(.a(new_n108_), .b(new_n118_), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n93_), .c(new_n60_), .d(new_n79_), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n115_), .c(new_n58_), .O(z6));
  ...
  nand2  g088(.a(new_n107_), .b(new_n80_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(x31), .d(new_n118_), .O(new_n150_));
  ...
  nand2  g111(.a(x32), .b(new_n118_), .O(new_n156_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n90_), .O(new_n164_));
  ...
  nand4  g137(.a(new_n149_), .b(new_n177_), .c(new_n128_), .d(new_n118_), .O(new_n182_));
