...
module FAU ( 
  ...
  nor2   g061(.a(new_n105_), .b(new_n61_), .O(z6));
  ...
  nand2  g068(.a(new_n96_), .b(new_n80_), .O(new_n113_));
  ...
  nand4  g087(.a(new_n131_), .b(new_n113_), .c(new_n49_), .d(x31), .O(new_n132_));
  aoi21  g088(.a(new_n117_), .b(x14), .c(new_n115_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x17), .c(x16), .d(x15), .O(new_n134_));
  nand2  g090(.a(x16), .b(x15), .O(new_n135_));
  nand2  g091(.a(x18), .b(x17), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n135_), .c(new_n117_), .O(new_n137_));
  nand2  g093(.a(x16), .b(x10), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(new_n129_), .O(new_n139_));
  inv1   g095(.a(x11), .O(new_n140_));
  oai21  g096(.a(new_n136_), .b(new_n140_), .c(new_n123_), .O(new_n141_));
  nand2  g097(.a(x18), .b(x12), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n114_), .O(new_n143_));
  inv1   g099(.a(x13), .O(new_n144_));
  nand2  g100(.a(new_n115_), .b(new_n144_), .O(new_n145_));
  inv1   g101(.a(x31), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n98_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n143_), .d(new_n113_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  and2   g105(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n139_), .c(new_n137_), .d(new_n134_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  oai21  g108(.a(new_n132_), .b(new_n98_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x00), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n45_), .c(x26), .O(z8));
  nand2  g111(.a(new_n113_), .b(x29), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n131_), .c(new_n53_), .d(new_n146_), .O(new_n157_));
  aoi21  g113(.a(new_n115_), .b(new_n144_), .c(x31), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n143_), .c(new_n141_), .d(new_n139_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n156_), .c(new_n137_), .d(new_n134_), .O(new_n161_));
