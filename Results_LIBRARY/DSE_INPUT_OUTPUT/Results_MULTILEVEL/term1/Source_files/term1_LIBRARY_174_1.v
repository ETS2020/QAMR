...
module FAU ( 
  ...
  oai21  g049(.a(new_n93_), .b(new_n61_), .c(new_n84_), .O(z3));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n63_), .d(new_n85_), .O(new_n106_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n61_), .c(new_n84_), .O(z6));
  oai21  g072(.a(x31), .b(x30), .c(new_n58_), .O(new_n117_));
  ...
  aoi22  g139(.a(new_n183_), .b(x07), .c(new_n181_), .d(new_n45_), .O(new_n184_));
  ...
  oai22  g144(.a(new_n188_), .b(new_n58_), .c(new_n181_), .d(x30), .O(new_n189_));
