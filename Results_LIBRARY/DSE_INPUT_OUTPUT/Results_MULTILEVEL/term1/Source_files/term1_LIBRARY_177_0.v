...
module FAU ( 
  ...
  nand4  g077(.a(new_n121_), .b(new_n60_), .c(x25), .d(x01), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n119_), .c(new_n118_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n79_), .O(z7));
  inv1   g082(.a(x32), .O(new_n127_));
  nand2  g083(.a(new_n103_), .b(new_n80_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x29), .O(new_n129_));
  nand3  g085(.a(x19), .b(new_n87_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n90_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n84_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n133_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n84_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  aoi21  g113(.a(new_n87_), .b(new_n157_), .c(new_n120_), .O(new_n158_));
  ...
  nand4  g119(.a(new_n163_), .b(x30), .c(new_n79_), .d(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n144_), .b(new_n128_), .c(new_n166_), .d(x31), .O(new_n167_));
  nand2  g123(.a(new_n87_), .b(new_n157_), .O(new_n168_));
  nor2   g124(.a(new_n120_), .b(new_n105_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n156_), .d(new_n128_), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  and2   g127(.a(new_n171_), .b(new_n154_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n152_), .c(new_n150_), .d(new_n147_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x33), .O(new_n174_));
  oai21  g130(.a(new_n167_), .b(new_n105_), .c(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x30), .c(new_n79_), .d(x00), .O(new_n176_));
