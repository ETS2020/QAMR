...
module FAU ( 
  ...
  nand4  g061(.a(new_n105_), .b(new_n101_), .c(new_n62_), .d(new_n48_), .O(new_n106_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n119_), .c(new_n62_), .d(x01), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n46_), .O(new_n124_));
  oai21  g080(.a(new_n46_), .b(x30), .c(new_n124_), .O(z7));
  ...
  nand2  g100(.a(new_n90_), .b(x14), .O(new_n145_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n81_), .O(new_n163_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n173_), .c(new_n81_), .O(new_n176_));
