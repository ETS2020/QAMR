...
module FAU ( 
  ...
  aoi21  g017(.a(new_n61_), .b(new_n54_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g025(.a(new_n69_), .b(new_n62_), .c(new_n59_), .O(new_n70_));
  xor2a  g026(.a(x07), .b(x04), .O(new_n71_));
  nor2   g027(.a(new_n50_), .b(new_n60_), .O(new_n72_));
  ...
  and2   g050(.a(new_n94_), .b(new_n54_), .O(new_n95_));
  ...
  nand4  g075(.a(new_n54_), .b(new_n119_), .c(x25), .d(x01), .O(new_n120_));
  aoi21  g076(.a(new_n118_), .b(new_n93_), .c(new_n120_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(x30), .c(new_n80_), .O(z7));
  nand2  g078(.a(new_n104_), .b(new_n81_), .O(new_n123_));
  nand3  g079(.a(x19), .b(new_n88_), .c(x13), .O(new_n124_));
  nand3  g080(.a(new_n91_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n124_), .c(new_n85_), .O(new_n126_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n123_), .c(new_n49_), .d(x31), .O(new_n139_));
  aoi21  g095(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(x17), .c(x16), .d(x15), .O(new_n141_));
  nand2  g097(.a(x16), .b(x15), .O(new_n142_));
  nand2  g098(.a(x18), .b(x17), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n91_), .O(new_n144_));
  ...
  nor2   g108(.a(new_n119_), .b(new_n106_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n152_), .c(new_n150_), .d(new_n123_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  and2   g111(.a(new_n155_), .b(new_n148_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n146_), .c(new_n144_), .d(new_n141_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  oai21  g114(.a(new_n139_), .b(new_n106_), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n45_), .c(new_n80_), .d(x00), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(z8));
  nand2  g117(.a(new_n123_), .b(x29), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n138_), .c(new_n53_), .d(new_n119_), .O(new_n163_));
  aoi21  g119(.a(new_n88_), .b(new_n151_), .c(x31), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n150_), .c(new_n148_), .d(new_n146_), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n162_), .c(new_n144_), .d(new_n141_), .O(new_n167_));
