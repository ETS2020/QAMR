...
module FAU ( 
  ...
  nand2  g001(.a(new_n45_), .b(x09), .O(new_n46_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n87_), .c(new_n61_), .d(new_n46_), .O(new_n103_));
  ...
  oai21  g069(.a(x31), .b(x09), .c(new_n45_), .O(new_n114_));
  ...
  nand2  g108(.a(x32), .b(new_n45_), .O(new_n153_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n158_), .c(new_n46_), .O(new_n176_));
  aoi21  g132(.a(new_n151_), .b(new_n122_), .c(x30), .O(new_n177_));
  nor2   g133(.a(new_n122_), .b(new_n98_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n127_), .c(new_n45_), .O(new_n179_));
  aoi21  g135(.a(new_n177_), .b(new_n57_), .c(new_n179_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nand4  g138(.a(new_n151_), .b(new_n122_), .c(new_n45_), .d(new_n57_), .O(new_n183_));
