...
module FAU ( 
  ...
  nand3  g060(.a(new_n89_), .b(x29), .c(x28), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(x25), .d(x01), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n45_), .c(x26), .O(z6));
  ...
  nand4  g123(.a(new_n167_), .b(new_n45_), .c(new_n92_), .d(x00), .O(new_n168_));
