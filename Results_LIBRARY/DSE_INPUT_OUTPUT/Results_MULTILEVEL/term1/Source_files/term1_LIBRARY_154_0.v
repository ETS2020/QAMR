...
module FAU ( 
  ...
  nand3  g067(.a(new_n98_), .b(new_n111_), .c(x29), .O(new_n112_));
  ...
  nor2   g076(.a(x26), .b(new_n90_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n116_), .d(new_n94_), .O(new_n122_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n79_), .O(z8));
  ...
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n111_), .d(new_n103_), .O(new_n177_));
  ...
  nand2  g145(.a(new_n189_), .b(new_n79_), .O(z9));
endmodule
