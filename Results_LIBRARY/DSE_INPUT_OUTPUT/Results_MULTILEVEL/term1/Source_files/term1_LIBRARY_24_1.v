...
module FAU ( 
  ...
  nand3  g053(.a(new_n45_), .b(x28), .c(new_n80_), .O(new_n98_));
  ...
  nand2  g075(.a(new_n102_), .b(new_n80_), .O(new_n120_));
  ...
  aoi21  g093(.a(new_n122_), .b(x14), .c(new_n87_), .O(new_n138_));
  ...
  nand2  g105(.a(new_n87_), .b(new_n149_), .O(new_n150_));
  ...
  aoi21  g119(.a(new_n87_), .b(new_n149_), .c(x31), .O(new_n164_));
