...
module FAU ( 
  ...
  nand4  g066(.a(new_n110_), .b(new_n64_), .c(x25), .d(x01), .O(new_n111_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n64_), .d(x25), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n63_), .c(new_n49_), .O(z6));
  ...
  oai21  g081(.a(new_n125_), .b(new_n105_), .c(new_n45_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n98_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(z7));
  ...
  nand2  g109(.a(new_n90_), .b(x14), .O(new_n154_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n90_), .O(new_n159_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n54_), .c(new_n124_), .d(new_n46_), .O(new_n176_));
