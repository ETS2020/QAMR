...
module FAU ( 
  ...
  nand4  g071(.a(new_n115_), .b(new_n61_), .c(x25), .d(x01), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n113_), .c(new_n109_), .O(new_n118_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n122_), .c(new_n48_), .d(x31), .O(new_n141_));
  ...
  aoi21  g109(.a(new_n124_), .b(new_n153_), .c(new_n114_), .O(new_n154_));
  ...
  nand4  g117(.a(new_n140_), .b(new_n121_), .c(new_n52_), .d(x31), .O(new_n162_));
  nand2  g118(.a(new_n124_), .b(new_n153_), .O(new_n163_));
  nor2   g119(.a(new_n114_), .b(new_n100_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n163_), .c(new_n152_), .d(new_n121_), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  and2   g122(.a(new_n166_), .b(new_n150_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n148_), .c(new_n146_), .d(new_n143_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x33), .O(new_n169_));
  oai21  g125(.a(new_n162_), .b(new_n100_), .c(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x30), .c(new_n79_), .d(x00), .O(new_n171_));
