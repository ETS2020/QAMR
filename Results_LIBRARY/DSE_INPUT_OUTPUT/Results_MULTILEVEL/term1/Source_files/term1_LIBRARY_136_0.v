...
module FAU ( 
  ...
  nor3   g039(.a(new_n83_), .b(new_n60_), .c(x27), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n46_), .c(x25), .d(x22), .O(new_n85_));
  nor2   g041(.a(new_n85_), .b(new_n59_), .O(z3));
  nor2   g042(.a(new_n83_), .b(new_n60_), .O(new_n87_));
  ...
  nor2   g051(.a(new_n95_), .b(new_n88_), .O(new_n96_));
  ...
  nand4  g056(.a(new_n100_), .b(x25), .c(x22), .d(x01), .O(new_n101_));
  ...
  aoi21  g064(.a(new_n108_), .b(x22), .c(x26), .O(z6));
  inv1   g065(.a(x31), .O(new_n110_));
  nor2   g066(.a(new_n105_), .b(new_n94_), .O(new_n111_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n112_), .c(x22), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n46_), .O(z7));
  nand2  g076(.a(new_n95_), .b(new_n88_), .O(new_n121_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n46_), .c(x22), .d(x00), .O(new_n166_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n46_), .c(x22), .d(x00), .O(new_n185_));
