...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n82_), .c(new_n46_), .d(x25), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n63_), .c(new_n48_), .O(z3));
  inv1   g051(.a(x25), .O(new_n96_));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n93_), .c(new_n46_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n96_), .c(new_n63_), .O(z4));
  inv1   g055(.a(new_n60_), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  inv1   g057(.a(x28), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n82_), .O(new_n103_));
  nand3  g059(.a(new_n101_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n101_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n91_), .c(new_n100_), .d(new_n46_), .O(new_n106_));
  ...
  oai21  g067(.a(new_n103_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n100_), .c(new_n46_), .d(x25), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n63_), .O(z6));
  nand3  g073(.a(new_n103_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n120_));
  nor2   g076(.a(new_n60_), .b(new_n63_), .O(new_n121_));
  ...
  nand4  g081(.a(new_n125_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n46_), .O(new_n127_));
  oai21  g083(.a(new_n46_), .b(x00), .c(new_n127_), .O(z7));
  nand2  g084(.a(new_n102_), .b(new_n82_), .O(new_n129_));
  ...
  nand2  g129(.a(new_n173_), .b(new_n46_), .O(new_n174_));
  aoi21  g130(.a(new_n156_), .b(new_n153_), .c(new_n174_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n152_), .c(new_n45_), .O(z8));
  ...
  nand4  g137(.a(new_n148_), .b(new_n177_), .c(new_n122_), .d(new_n110_), .O(new_n182_));
  ...
  aoi21  g148(.a(new_n192_), .b(new_n181_), .c(new_n45_), .O(z9));
endmodule
