...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n59_), .c(new_n57_), .O(z4));
  ...
  nand2  g058(.a(new_n102_), .b(new_n57_), .O(z5));
  ...
  oai21  g066(.a(x31), .b(new_n59_), .c(new_n45_), .O(new_n111_));
  ...
  nor2   g128(.a(new_n166_), .b(new_n165_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n157_), .c(new_n57_), .O(new_n175_));
  nand2  g131(.a(new_n150_), .b(new_n119_), .O(new_n176_));
  nor2   g132(.a(new_n119_), .b(new_n95_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n126_), .c(new_n45_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(x01), .c(new_n176_), .d(new_n45_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  nand4  g137(.a(new_n126_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  oai22  g138(.a(new_n182_), .b(new_n59_), .c(new_n176_), .d(x30), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n145_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(x33), .c(new_n181_), .O(new_n185_));
