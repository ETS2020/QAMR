...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n187_, new_n188_;
  nand2  g000(.a(x26), .b(x07), .O(new_n45_));
  ...
  nand3  g026(.a(new_n56_), .b(x07), .c(new_n70_), .O(new_n71_));
  oai21  g027(.a(x07), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  xnor2a g028(.a(x03), .b(x02), .O(new_n73_));
  nor2   g029(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  nand2  g030(.a(new_n66_), .b(new_n64_), .O(new_n75_));
  ...
  aoi21  g034(.a(new_n78_), .b(new_n69_), .c(x09), .O(new_n79_));
  ...
  nand4  g044(.a(new_n88_), .b(new_n82_), .c(new_n56_), .d(x25), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(new_n59_), .c(new_n45_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n88_), .c(new_n56_), .d(x25), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n59_), .c(new_n45_), .O(z4));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n61_), .d(new_n56_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n94_), .c(new_n59_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n61_), .c(new_n56_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n59_), .c(new_n45_), .O(z6));
  ...
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n56_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n94_), .O(new_n122_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n56_), .c(x00), .O(new_n169_));
  ...
  nand3  g143(.a(new_n187_), .b(new_n56_), .c(x00), .O(new_n188_));
