...
module FAU ( 
  ...
  nor2   g073(.a(new_n57_), .b(new_n62_), .O(new_n118_));
  ...
  nor2   g078(.a(new_n122_), .b(new_n81_), .O(new_n123_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n50_), .c(x31), .d(new_n104_), .O(new_n144_));
  ...
  nand4  g126(.a(new_n143_), .b(new_n54_), .c(x31), .d(x30), .O(new_n171_));
  ...
  nand4  g130(.a(new_n143_), .b(new_n54_), .c(new_n120_), .d(new_n104_), .O(new_n175_));
