...
module FAU ( 
  ...
  nand4  g101(.a(new_n145_), .b(new_n125_), .c(x31), .d(new_n102_), .O(new_n146_));
  ...
  nand2  g105(.a(new_n124_), .b(x29), .O(new_n150_));
  nand3  g106(.a(new_n145_), .b(new_n125_), .c(x31), .O(new_n151_));
  nand2  g107(.a(x32), .b(new_n102_), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(new_n102_), .c(new_n152_), .O(new_n153_));
  ...
  nand4  g129(.a(new_n79_), .b(x19), .c(new_n127_), .d(x13), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n130_), .c(new_n126_), .O(new_n175_));
  nand2  g131(.a(new_n126_), .b(x12), .O(new_n176_));
  nand3  g132(.a(new_n79_), .b(x19), .c(x18), .O(new_n177_));
  ...
  nand4  g136(.a(new_n180_), .b(x17), .c(new_n135_), .d(x11), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x15), .O(new_n183_));
  inv1   g139(.a(new_n159_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n143_), .c(new_n79_), .d(x19), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n183_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n173_), .c(x31), .d(x30), .O(new_n187_));
  nand3  g143(.a(x33), .b(new_n102_), .c(new_n79_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n124_), .c(x29), .O(new_n190_));
  nand4  g146(.a(new_n186_), .b(new_n173_), .c(new_n119_), .d(new_n102_), .O(new_n191_));
  nand3  g147(.a(x33), .b(x30), .c(new_n79_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n150_), .O(new_n194_));
  inv1   g150(.a(new_n157_), .O(new_n195_));
  inv1   g151(.a(new_n165_), .O(new_n196_));
  inv1   g152(.a(new_n166_), .O(new_n197_));
  xnor2a g153(.a(x31), .b(x30), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n197_), .c(new_n196_), .d(new_n164_), .O(new_n199_));
  inv1   g155(.a(new_n199_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n162_), .c(new_n160_), .d(new_n195_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(x33), .c(new_n79_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n194_), .c(new_n190_), .O(new_n203_));
