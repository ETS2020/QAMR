...
module FAU ( 
  ...
  aoi21  g048(.a(new_n91_), .b(new_n47_), .c(new_n92_), .O(new_n93_));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n97_), .c(x18), .O(new_n100_));
  nand2  g056(.a(new_n91_), .b(x28), .O(new_n101_));
  ...
  nor2   g066(.a(new_n98_), .b(new_n81_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n110_), .c(x29), .O(new_n113_));
  inv1   g069(.a(x29), .O(new_n114_));
  inv1   g070(.a(new_n92_), .O(new_n115_));
  oai21  g071(.a(x30), .b(new_n45_), .c(new_n91_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n114_), .c(x28), .d(x27), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n113_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n59_), .O(z5));
  nand2  g077(.a(new_n111_), .b(x29), .O(new_n122_));
  nand4  g078(.a(new_n115_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(x30), .O(new_n124_));
  inv1   g080(.a(x30), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x29), .O(new_n126_));
  oai22  g082(.a(new_n126_), .b(new_n112_), .c(x29), .d(new_n45_), .O(new_n127_));
  nor4   g083(.a(new_n126_), .b(new_n98_), .c(new_n81_), .d(x18), .O(new_n128_));
  aoi21  g084(.a(new_n127_), .b(new_n91_), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n124_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n59_), .c(new_n47_), .O(z6));
  nor2   g088(.a(x31), .b(x23), .O(new_n133_));
  nand4  g089(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n134_));
  oai21  g090(.a(new_n133_), .b(x30), .c(new_n134_), .O(new_n135_));
  inv1   g091(.a(new_n83_), .O(new_n136_));
  nand2  g092(.a(x30), .b(x23), .O(new_n137_));
  inv1   g093(.a(x31), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n125_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n133_), .c(x18), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n137_), .c(new_n82_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n90_), .c(new_n87_), .d(new_n136_), .O(new_n142_));
  nand3  g098(.a(x29), .b(x28), .c(x27), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x31), .O(new_n144_));
  nand3  g100(.a(new_n111_), .b(new_n138_), .c(x29), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nor2   g102(.a(new_n138_), .b(x30), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(new_n45_), .c(new_n146_), .d(x30), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n142_), .c(new_n135_), .O(z7));
  nand2  g105(.a(new_n98_), .b(new_n81_), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  inv1   g107(.a(x18), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n152_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n88_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n85_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n156_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n151_), .c(x31), .d(new_n125_), .O(new_n168_));
  nand2  g124(.a(x32), .b(x30), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n150_), .c(x29), .O(new_n171_));
  nand2  g127(.a(new_n150_), .b(x29), .O(new_n172_));
  nand4  g128(.a(new_n167_), .b(new_n151_), .c(x31), .d(x30), .O(new_n173_));
  ...
  nor2   g134(.a(new_n178_), .b(new_n165_), .O(new_n179_));
  nand2  g135(.a(x16), .b(x15), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n180_), .c(new_n88_), .O(new_n182_));
  nand2  g138(.a(x16), .b(x10), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n181_), .c(new_n165_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n181_), .b(new_n185_), .c(new_n159_), .O(new_n186_));
  aoi21  g142(.a(x18), .b(x12), .c(x17), .O(new_n187_));
  nor2   g143(.a(x18), .b(x13), .O(new_n188_));
  nor3   g144(.a(new_n188_), .b(new_n187_), .c(new_n138_), .O(new_n189_));
  ...
  nand2  g149(.a(new_n193_), .b(new_n47_), .O(z8));
  nor2   g150(.a(new_n188_), .b(new_n187_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n186_), .c(new_n184_), .d(new_n182_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n179_), .c(new_n47_), .O(new_n197_));
  aoi21  g153(.a(new_n172_), .b(new_n138_), .c(x30), .O(new_n198_));
  nor2   g154(.a(new_n138_), .b(new_n114_), .O(new_n199_));
  aoi21  g155(.a(new_n199_), .b(new_n150_), .c(new_n125_), .O(new_n200_));
  aoi21  g156(.a(new_n198_), .b(new_n45_), .c(new_n200_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n197_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(x33), .O(new_n203_));
  nand4  g159(.a(new_n172_), .b(new_n138_), .c(new_n125_), .d(new_n45_), .O(new_n204_));
  nand4  g160(.a(new_n150_), .b(x31), .c(x30), .d(x29), .O(new_n205_));
