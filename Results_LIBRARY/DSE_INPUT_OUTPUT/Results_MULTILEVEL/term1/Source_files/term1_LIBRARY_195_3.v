...
module FAU ( 
  ...
  nand3  g043(.a(new_n87_), .b(new_n81_), .c(new_n46_), .O(new_n88_));
  nor3   g044(.a(new_n88_), .b(new_n80_), .c(new_n62_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n87_), .c(new_n46_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n80_), .c(new_n62_), .O(z4));
  ...
  nor3   g056(.a(new_n100_), .b(new_n80_), .c(new_n62_), .O(z5));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n46_), .d(x25), .O(new_n108_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n50_), .c(x31), .d(new_n102_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n142_), .b(new_n50_), .c(x31), .d(x30), .O(new_n148_));
  ...
  nand4  g129(.a(new_n142_), .b(new_n53_), .c(new_n117_), .d(new_n102_), .O(new_n174_));
  ...
  nand3  g141(.a(new_n185_), .b(new_n46_), .c(x00), .O(new_n186_));
