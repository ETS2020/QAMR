...
module FAU ( 
  ...
  nor2   g042(.a(new_n86_), .b(new_n55_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(x30), .c(new_n81_), .O(new_n88_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n61_), .c(new_n47_), .O(z4));
  ...
  oai22  g056(.a(new_n100_), .b(new_n97_), .c(new_n98_), .d(new_n81_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n62_), .d(new_n80_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n95_), .c(new_n61_), .O(z5));
  inv1   g059(.a(x30), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x28), .c(x27), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n100_), .c(new_n97_), .O(new_n106_));
  aoi21  g062(.a(x30), .b(new_n97_), .c(new_n106_), .O(new_n107_));
  ...
  oai21  g066(.a(x31), .b(new_n104_), .c(new_n81_), .O(new_n111_));
  nand3  g067(.a(x30), .b(x29), .c(x28), .O(new_n112_));
  ...
  nor2   g073(.a(new_n55_), .b(new_n61_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  inv1   g075(.a(new_n99_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n119_), .c(x30), .d(x29), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n118_), .c(new_n80_), .d(x25), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n117_), .c(new_n113_), .d(new_n111_), .O(z7));
  ...
  aoi21  g099(.a(new_n139_), .b(new_n138_), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n137_), .c(new_n134_), .d(new_n131_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n129_), .c(new_n47_), .O(new_n146_));
  xnor2a g102(.a(x30), .b(x29), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x27), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n146_), .c(new_n112_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  nor2   g106(.a(x28), .b(x27), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n97_), .c(x30), .O(new_n152_));
  nand3  g108(.a(new_n104_), .b(x29), .c(x27), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand3  g110(.a(x19), .b(new_n141_), .c(x13), .O(new_n155_));
  nand3  g111(.a(new_n126_), .b(x18), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n138_), .O(new_n157_));
  nand4  g113(.a(x19), .b(x18), .c(new_n138_), .d(x12), .O(new_n158_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n154_), .c(new_n48_), .d(x31), .O(new_n168_));
  ...
  nand4  g128(.a(x33), .b(new_n172_), .c(new_n80_), .d(x00), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x30), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n81_), .O(new_n175_));
  inv1   g131(.a(new_n151_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x31), .c(x30), .d(x29), .O(new_n177_));
  nand3  g133(.a(new_n119_), .b(new_n104_), .c(new_n97_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n167_), .c(new_n52_), .O(new_n180_));
  oai21  g136(.a(new_n119_), .b(new_n97_), .c(x30), .O(new_n181_));
  oai21  g137(.a(x31), .b(x29), .c(new_n104_), .O(new_n182_));
  nand2  g138(.a(new_n139_), .b(new_n138_), .O(new_n183_));
  nand4  g139(.a(new_n142_), .b(new_n183_), .c(new_n137_), .d(new_n134_), .O(new_n184_));
  aoi21  g140(.a(new_n130_), .b(new_n126_), .c(new_n184_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n182_), .c(new_n181_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n129_), .c(x33), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n180_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n80_), .c(x00), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n175_), .O(z9));
endmodule
