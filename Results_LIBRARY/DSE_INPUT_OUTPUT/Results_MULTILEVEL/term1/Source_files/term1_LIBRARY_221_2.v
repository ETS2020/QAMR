...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n91_), .c(new_n84_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n83_), .c(new_n61_), .O(z4));
  ...
  nor3   g059(.a(new_n103_), .b(new_n83_), .c(new_n61_), .O(z5));
  ...
  nand4  g066(.a(new_n110_), .b(new_n63_), .c(new_n84_), .d(x25), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n61_), .c(new_n81_), .O(z6));
  ...
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n84_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n83_), .O(new_n124_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n57_), .c(x31), .d(new_n105_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n144_), .b(new_n57_), .c(x31), .d(x30), .O(new_n150_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n84_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  nand4  g127(.a(new_n144_), .b(new_n48_), .c(x31), .d(x30), .O(new_n172_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n48_), .c(new_n121_), .d(new_n105_), .O(new_n176_));
  ...
  nand3  g143(.a(new_n187_), .b(new_n84_), .c(x00), .O(new_n188_));
