...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(new_n87_), .c(new_n46_), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n90_), .c(new_n60_), .O(z4));
  ...
  nand2  g058(.a(new_n102_), .b(new_n48_), .O(z5));
  ...
  nor2   g064(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(new_n46_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n60_), .c(new_n48_), .O(z6));
  ...
  nor2   g073(.a(new_n61_), .b(new_n60_), .O(new_n118_));
  ...
  nand2  g080(.a(new_n96_), .b(new_n81_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(x31), .d(new_n104_), .O(new_n145_));
  ...
  nand2  g129(.a(x33), .b(new_n104_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n125_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n120_), .d(new_n104_), .O(new_n177_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n46_), .c(x00), .O(new_n189_));
