...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n63_), .c(new_n45_), .d(new_n82_), .O(new_n96_));
  ...
  nand3  g056(.a(new_n45_), .b(x28), .c(new_n82_), .O(new_n101_));
  oai21  g057(.a(x28), .b(new_n82_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n95_), .c(new_n63_), .d(new_n81_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n100_), .c(new_n62_), .O(z4));
  xnor2a g060(.a(x29), .b(x28), .O(new_n105_));
  nand3  g061(.a(new_n45_), .b(x29), .c(new_n82_), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n82_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n95_), .c(new_n63_), .d(new_n81_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n100_), .c(new_n62_), .O(z5));
  xor2a  g065(.a(x30), .b(x28), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x29), .c(x27), .O(new_n111_));
  inv1   g067(.a(x29), .O(new_n112_));
  nand2  g068(.a(x30), .b(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n95_), .c(new_n63_), .d(new_n81_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n48_), .O(z6));
  oai21  g074(.a(x31), .b(x30), .c(new_n82_), .O(new_n119_));
  ...
  nand3  g080(.a(new_n124_), .b(new_n81_), .c(x25), .O(new_n125_));
  nor3   g081(.a(new_n125_), .b(new_n56_), .c(new_n62_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(z7));
  inv1   g083(.a(x28), .O(new_n128_));
  nand4  g084(.a(x32), .b(new_n128_), .c(new_n81_), .d(x00), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n82_), .O(new_n131_));
  nor2   g087(.a(x28), .b(x27), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n45_), .c(x29), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n113_), .O(new_n135_));
  nand3  g091(.a(x19), .b(new_n89_), .c(x13), .O(new_n136_));
  nand3  g092(.a(new_n92_), .b(x18), .c(x14), .O(new_n137_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n135_), .c(new_n49_), .d(x31), .O(new_n151_));
  nand2  g107(.a(new_n92_), .b(x14), .O(new_n152_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n92_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x10), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n148_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n156_), .b(new_n160_), .c(new_n142_), .O(new_n161_));
  nand2  g117(.a(x18), .b(x12), .O(new_n162_));
  nor2   g118(.a(x18), .b(x13), .O(new_n163_));
  aoi21  g119(.a(x30), .b(x29), .c(new_n163_), .O(new_n164_));
  aoi21  g120(.a(new_n45_), .b(new_n112_), .c(new_n123_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  aoi21  g122(.a(new_n162_), .b(new_n86_), .c(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n154_), .c(x32), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n151_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n81_), .c(x00), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n131_), .O(z8));
  aoi21  g128(.a(new_n162_), .b(new_n86_), .c(new_n163_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n154_), .c(new_n48_), .O(new_n175_));
  oai21  g131(.a(new_n132_), .b(new_n112_), .c(new_n123_), .O(new_n176_));
  aoi21  g132(.a(x31), .b(x29), .c(new_n45_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(x27), .c(new_n176_), .d(new_n45_), .O(new_n178_));
  ...
  oai21  g137(.a(new_n176_), .b(x30), .c(new_n181_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n150_), .c(new_n53_), .O(new_n183_));
