...
module FAU ( 
  ...
  xor2a  g060(.a(x30), .b(x27), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x29), .c(x28), .O(new_n106_));
  oai21  g062(.a(new_n97_), .b(new_n95_), .c(x30), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n88_), .c(new_n60_), .d(new_n79_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n104_), .c(new_n58_), .O(z6));
  inv1   g066(.a(x30), .O(new_n111_));
  oai21  g067(.a(x31), .b(new_n111_), .c(new_n95_), .O(new_n112_));
  ...
  oai21  g073(.a(new_n116_), .b(x28), .c(new_n117_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  nand3  g075(.a(x30), .b(x29), .c(x27), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x31), .c(x28), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n119_), .c(new_n115_), .O(z7));
  inv1   g078(.a(x32), .O(new_n123_));
  nand2  g079(.a(new_n95_), .b(new_n80_), .O(new_n124_));
  nand2  g080(.a(x30), .b(new_n97_), .O(new_n125_));
  nand2  g081(.a(new_n111_), .b(x29), .O(new_n126_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(new_n123_), .d(x31), .O(new_n146_));
  nand2  g102(.a(new_n131_), .b(x14), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x18), .c(x17), .d(x16), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  nand3  g105(.a(new_n124_), .b(x30), .c(x29), .O(new_n150_));
  nand2  g106(.a(x16), .b(x15), .O(new_n151_));
  nand2  g107(.a(x18), .b(x17), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n131_), .O(new_n153_));
  nand4  g109(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n154_));
  inv1   g110(.a(x11), .O(new_n155_));
  oai21  g111(.a(new_n152_), .b(new_n155_), .c(new_n137_), .O(new_n156_));
  nand2  g112(.a(x18), .b(x12), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n128_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  nand2  g115(.a(new_n129_), .b(new_n159_), .O(new_n160_));
  aoi21  g116(.a(new_n111_), .b(new_n97_), .c(new_n116_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n160_), .c(new_n158_), .d(new_n156_), .O(new_n162_));
  aoi21  g118(.a(new_n154_), .b(new_n143_), .c(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n153_), .c(new_n150_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n149_), .c(x32), .O(new_n165_));
  ...
  nand2  g124(.a(new_n154_), .b(new_n143_), .O(new_n169_));
  and2   g125(.a(new_n160_), .b(new_n158_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n156_), .c(new_n169_), .d(new_n153_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n149_), .c(new_n46_), .O(new_n172_));
  aoi21  g128(.a(new_n116_), .b(new_n97_), .c(x30), .O(new_n173_));
  nand3  g129(.a(new_n124_), .b(x31), .c(x29), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(x30), .c(new_n173_), .d(x28), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  aoi21  g133(.a(new_n140_), .b(new_n136_), .c(new_n143_), .O(new_n178_));
  inv1   g134(.a(new_n144_), .O(new_n179_));
  nand3  g135(.a(x31), .b(x30), .c(x29), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nor3   g137(.a(x31), .b(x30), .c(x29), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n181_), .c(x28), .O(new_n183_));
  nand4  g139(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n184_));
