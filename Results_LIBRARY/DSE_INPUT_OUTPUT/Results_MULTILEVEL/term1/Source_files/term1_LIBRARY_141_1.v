...
module FAU ( 
  ...
  nand3  g067(.a(new_n94_), .b(new_n80_), .c(x29), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n103_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x27), .c(new_n45_), .d(x25), .O(new_n114_));
  ...
  oai21  g076(.a(new_n120_), .b(x30), .c(new_n45_), .O(z7));
  inv1   g077(.a(x32), .O(new_n122_));
  nand2  g078(.a(new_n103_), .b(new_n79_), .O(new_n123_));
