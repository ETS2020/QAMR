...
module FAU ( 
  ...
  aoi21  g051(.a(new_n95_), .b(new_n47_), .c(new_n86_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n61_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n91_), .c(new_n81_), .d(x25), .O(new_n98_));
  ...
  inv1   g061(.a(new_n86_), .O(new_n106_));
  oai21  g062(.a(x30), .b(new_n45_), .c(new_n95_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n105_), .c(x28), .d(x27), .O(new_n109_));
  ...
  nand2  g069(.a(new_n102_), .b(x29), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n113_), .c(x30), .O(new_n115_));
  inv1   g071(.a(x30), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x29), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n103_), .c(x29), .d(new_n45_), .O(new_n118_));
  nor4   g074(.a(new_n117_), .b(new_n101_), .c(new_n82_), .d(x19), .O(new_n119_));
  aoi21  g075(.a(new_n118_), .b(new_n95_), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g079(.a(x31), .b(x24), .c(new_n116_), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  nand4  g082(.a(new_n106_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n127_));
  nor2   g083(.a(new_n61_), .b(new_n60_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand4  g085(.a(new_n102_), .b(new_n129_), .c(x30), .d(x29), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n81_), .d(x25), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n126_), .d(new_n124_), .O(z7));
  nand2  g089(.a(new_n101_), .b(new_n82_), .O(new_n134_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n135_), .c(x31), .d(new_n116_), .O(new_n154_));
  nand2  g110(.a(x32), .b(x30), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n134_), .c(x29), .O(new_n157_));
  nand2  g113(.a(new_n134_), .b(x29), .O(new_n158_));
  nand4  g114(.a(new_n153_), .b(new_n135_), .c(x31), .d(x30), .O(new_n159_));
  nand2  g115(.a(x32), .b(new_n116_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n139_), .b(x14), .O(new_n163_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n166_), .c(new_n139_), .O(new_n168_));
  ...
  nor3   g130(.a(new_n174_), .b(new_n173_), .c(new_n129_), .O(new_n175_));
  ...
  oai21  g138(.a(new_n182_), .b(new_n165_), .c(new_n47_), .O(new_n183_));
  aoi21  g139(.a(new_n158_), .b(new_n129_), .c(x30), .O(new_n184_));
  nor2   g140(.a(new_n129_), .b(new_n105_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n134_), .c(new_n116_), .O(new_n186_));
  aoi21  g142(.a(new_n184_), .b(new_n45_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n183_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  nand4  g145(.a(new_n158_), .b(new_n129_), .c(new_n116_), .d(new_n45_), .O(new_n190_));
  nand4  g146(.a(new_n134_), .b(x31), .c(x30), .d(x29), .O(new_n191_));
