...
module FAU ( 
  ...
  nand4  g034(.a(new_n78_), .b(new_n45_), .c(new_n60_), .d(x08), .O(new_n79_));
  ...
  nand4  g050(.a(new_n94_), .b(new_n63_), .c(new_n48_), .d(new_n82_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n81_), .c(x25), .d(x01), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z3));
  nand3  g054(.a(new_n48_), .b(x28), .c(new_n82_), .O(new_n99_));
  ...
  nand2  g060(.a(x30), .b(new_n60_), .O(new_n105_));
