...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n62_), .c(new_n81_), .d(new_n45_), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n80_), .c(new_n61_), .O(z3));
  inv1   g047(.a(new_n83_), .O(new_n92_));
  ...
  nand2  g053(.a(new_n86_), .b(new_n97_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  oai21  g055(.a(new_n93_), .b(new_n92_), .c(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n62_), .c(new_n45_), .O(new_n101_));
  inv1   g057(.a(x17), .O(new_n102_));
  inv1   g058(.a(x22), .O(new_n103_));
  nor2   g059(.a(new_n56_), .b(x28), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x27), .c(new_n103_), .d(new_n102_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n48_), .O(z4));
  inv1   g064(.a(x29), .O(new_n109_));
  nor2   g065(.a(new_n94_), .b(new_n81_), .O(new_n110_));
  nand3  g066(.a(new_n109_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(new_n112_));
  nand2  g068(.a(new_n98_), .b(new_n45_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n92_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n112_), .c(new_n62_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n61_), .c(new_n48_), .O(z5));
  inv1   g072(.a(x30), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x28), .c(x27), .O(new_n118_));
  oai21  g074(.a(new_n110_), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nor2   g075(.a(new_n117_), .b(x29), .O(new_n120_));
  aoi21  g076(.a(new_n119_), .b(x29), .c(new_n120_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n88_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n62_), .c(new_n45_), .d(x25), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n61_), .O(z6));
  nand3  g080(.a(new_n110_), .b(x30), .c(x29), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  inv1   g082(.a(new_n84_), .O(new_n127_));
  inv1   g083(.a(new_n85_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n92_), .d(new_n97_), .O(new_n129_));
  nor2   g085(.a(new_n56_), .b(new_n61_), .O(new_n130_));
  inv1   g086(.a(new_n110_), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x30), .c(x29), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n131_), .c(new_n45_), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n80_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n130_), .c(new_n129_), .d(new_n126_), .O(z7));
  nand2  g092(.a(new_n94_), .b(new_n81_), .O(new_n137_));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n139_), .c(new_n102_), .O(new_n142_));
  nand4  g098(.a(x19), .b(x18), .c(new_n102_), .d(x12), .O(new_n143_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n49_), .c(x31), .d(new_n117_), .O(new_n155_));
  nand2  g111(.a(x32), .b(x30), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n137_), .c(x29), .O(new_n158_));
  nand2  g114(.a(new_n137_), .b(x29), .O(new_n159_));
  nand4  g115(.a(new_n154_), .b(new_n49_), .c(x31), .d(x30), .O(new_n160_));
  nand2  g116(.a(x32), .b(new_n117_), .O(new_n161_));
  ...
  nand3  g135(.a(new_n179_), .b(new_n45_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n48_), .O(z8));
  nand4  g137(.a(new_n154_), .b(new_n53_), .c(x31), .d(x30), .O(new_n182_));
  nand2  g138(.a(x33), .b(new_n117_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n137_), .c(x29), .O(new_n185_));
  nand4  g141(.a(new_n154_), .b(new_n53_), .c(new_n132_), .d(new_n117_), .O(new_n186_));
  ...
  nand3  g153(.a(new_n197_), .b(new_n45_), .c(x00), .O(new_n198_));
