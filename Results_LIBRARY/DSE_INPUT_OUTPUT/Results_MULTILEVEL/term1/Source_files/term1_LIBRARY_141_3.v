...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n58_), .c(new_n45_), .O(z4));
  ...
  oai21  g064(.a(x31), .b(x26), .c(new_n101_), .O(new_n109_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n96_), .c(new_n79_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n101_), .b(x26), .O(new_n124_));
  ...
  nor3   g095(.a(new_n139_), .b(new_n138_), .c(new_n117_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n129_), .c(new_n124_), .O(new_n142_));
  nand2  g098(.a(new_n95_), .b(new_n81_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x29), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n101_), .c(new_n80_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n143_), .b(new_n101_), .c(x29), .d(new_n80_), .O(new_n150_));
  nand2  g106(.a(new_n144_), .b(x30), .O(new_n151_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n152_), .c(new_n149_), .d(x31), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n148_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x00), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n45_), .O(z8));
  nor2   g127(.a(new_n139_), .b(new_n138_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n129_), .c(new_n124_), .O(new_n174_));
  aoi21  g130(.a(new_n144_), .b(new_n117_), .c(x30), .O(new_n175_));
  nor2   g131(.a(new_n117_), .b(new_n94_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n143_), .c(new_n101_), .O(new_n177_));
  aoi21  g133(.a(new_n175_), .b(new_n80_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  aoi21  g136(.a(new_n163_), .b(new_n160_), .c(new_n125_), .O(new_n181_));
  inv1   g137(.a(new_n166_), .O(new_n182_));
  nand4  g138(.a(new_n144_), .b(new_n117_), .c(new_n101_), .d(new_n80_), .O(new_n183_));
  nand4  g139(.a(new_n143_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
  ...
  nand2  g144(.a(new_n188_), .b(new_n45_), .O(z9));
endmodule
