...
module FAU ( 
  ...
  nand2  g000(.a(x30), .b(x04), .O(new_n45_));
  ...
  inv1   g011(.a(x30), .O(new_n56_));
  nand3  g012(.a(new_n56_), .b(x07), .c(x04), .O(new_n57_));
  oai21  g013(.a(x07), .b(x04), .c(new_n57_), .O(new_n58_));
  ...
  nand3  g025(.a(new_n56_), .b(new_n69_), .c(x04), .O(new_n70_));
  oai21  g026(.a(new_n69_), .b(x04), .c(new_n70_), .O(new_n71_));
  xnor2a g027(.a(x03), .b(x02), .O(new_n72_));
  nor2   g028(.a(new_n72_), .b(new_n59_), .O(new_n73_));
  nand2  g029(.a(new_n65_), .b(new_n63_), .O(new_n74_));
  ...
  aoi21  g033(.a(new_n77_), .b(new_n68_), .c(x09), .O(new_n78_));
  ...
  nand4  g065(.a(new_n45_), .b(new_n109_), .c(x28), .d(x27), .O(new_n110_));
  inv1   g066(.a(x28), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n82_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand2  g069(.a(x30), .b(x04), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n113_), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n110_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n96_), .c(new_n81_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n108_), .c(new_n59_), .O(z5));
  inv1   g074(.a(x04), .O(new_n119_));
  nand2  g075(.a(new_n112_), .b(x29), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x30), .c(new_n119_), .O(new_n121_));
  nand3  g077(.a(new_n112_), .b(new_n56_), .c(x29), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n95_), .c(new_n60_), .d(new_n81_), .O(new_n124_));
  nor3   g080(.a(new_n124_), .b(new_n108_), .c(new_n59_), .O(z6));
  inv1   g081(.a(new_n94_), .O(new_n126_));
  nand3  g082(.a(new_n91_), .b(new_n88_), .c(new_n85_), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g084(.a(new_n60_), .b(new_n81_), .c(x25), .d(x01), .O(new_n129_));
  ...
  aoi22  g091(.a(new_n135_), .b(new_n119_), .c(x31), .d(new_n56_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n130_), .O(z7));
  inv1   g093(.a(x15), .O(new_n138_));
  nand2  g094(.a(new_n92_), .b(x14), .O(new_n139_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n92_), .O(new_n144_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n141_), .c(new_n45_), .O(new_n154_));
  nand2  g110(.a(new_n111_), .b(new_n82_), .O(new_n155_));
  ...
  aoi22  g114(.a(new_n158_), .b(new_n56_), .c(new_n157_), .d(new_n119_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n154_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x32), .O(new_n161_));
  inv1   g117(.a(x32), .O(new_n162_));
  nand3  g118(.a(new_n158_), .b(x30), .c(new_n119_), .O(new_n163_));
  nand3  g119(.a(new_n155_), .b(new_n56_), .c(x29), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand3  g121(.a(x19), .b(new_n89_), .c(x13), .O(new_n166_));
  nand3  g122(.a(new_n92_), .b(x18), .c(x14), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n166_), .c(new_n86_), .O(new_n168_));
  nand4  g124(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n169_));
  ...
  oai21  g140(.a(new_n184_), .b(new_n141_), .c(new_n45_), .O(new_n185_));
  nand2  g141(.a(new_n158_), .b(new_n133_), .O(new_n186_));
  nor2   g142(.a(new_n133_), .b(new_n109_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n155_), .c(new_n56_), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(new_n119_), .c(new_n186_), .d(new_n56_), .O(new_n189_));
  ...
  oai22  g149(.a(new_n193_), .b(x04), .c(new_n186_), .d(x30), .O(new_n194_));
