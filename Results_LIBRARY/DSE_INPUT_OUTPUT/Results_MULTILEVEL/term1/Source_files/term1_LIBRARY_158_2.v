...
module FAU ( 
  ...
  nand4  g103(.a(new_n147_), .b(new_n58_), .c(x31), .d(new_n107_), .O(new_n148_));
  ...
  nand4  g108(.a(new_n147_), .b(new_n58_), .c(x31), .d(x30), .O(new_n153_));
  nand2  g109(.a(x32), .b(new_n107_), .O(new_n154_));
  ...
  nand3  g128(.a(new_n172_), .b(new_n57_), .c(x00), .O(new_n173_));
  ...
  nand4  g134(.a(new_n147_), .b(new_n48_), .c(new_n122_), .d(new_n107_), .O(new_n179_));
  ...
  nand3  g146(.a(new_n190_), .b(new_n57_), .c(x00), .O(new_n191_));
