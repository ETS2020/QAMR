...
module FAU ( 
  ...
  nor2   g076(.a(new_n56_), .b(new_n80_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n116_), .d(x01), .O(new_n122_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n49_), .c(x31), .d(new_n103_), .O(new_n144_));
  ...
  nor3   g120(.a(new_n164_), .b(new_n163_), .c(new_n111_), .O(new_n165_));
  ...
  nand4  g130(.a(new_n143_), .b(new_n53_), .c(new_n111_), .d(new_n103_), .O(new_n175_));
