...
module FAU ( 
  ...
  nor3   g122(.a(new_n166_), .b(new_n165_), .c(new_n117_), .O(new_n167_));
  ...
  nand4  g129(.a(new_n143_), .b(new_n173_), .c(x31), .d(x30), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(x30), .c(new_n174_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n124_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n143_), .b(new_n173_), .c(new_n117_), .d(new_n102_), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n102_), .c(new_n177_), .O(new_n178_));
  inv1   g134(.a(new_n165_), .O(new_n179_));
  inv1   g135(.a(new_n166_), .O(new_n180_));
  xnor2a g136(.a(x31), .b(x30), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n164_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n162_), .c(new_n160_), .d(new_n156_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n46_), .O(new_n186_));
  aoi21  g142(.a(new_n178_), .b(new_n148_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n176_), .c(new_n45_), .O(z9));
endmodule
