...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n62_), .c(new_n81_), .d(new_n80_), .O(new_n96_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n62_), .d(new_n80_), .O(new_n101_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n95_), .c(new_n62_), .d(new_n80_), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x25), .c(new_n45_), .d(x01), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(z6));
  nand3  g078(.a(new_n106_), .b(x30), .c(x29), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x31), .O(new_n124_));
  nor2   g080(.a(new_n85_), .b(new_n83_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n91_), .c(new_n88_), .d(x19), .O(new_n126_));
  nand3  g082(.a(new_n62_), .b(new_n45_), .c(x01), .O(new_n127_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n49_), .c(x31), .O(new_n151_));
  nand2  g107(.a(x32), .b(x30), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(x30), .c(new_n152_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n135_), .c(x29), .O(new_n154_));
  nand2  g110(.a(new_n135_), .b(x29), .O(new_n155_));
  ...
  nand2  g114(.a(new_n82_), .b(x14), .O(new_n159_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n82_), .O(new_n164_));
  ...
  nor3   g126(.a(new_n170_), .b(new_n169_), .c(new_n130_), .O(new_n171_));
  ...
  nand4  g130(.a(new_n174_), .b(new_n80_), .c(new_n45_), .d(x00), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(z8));
  nand4  g132(.a(new_n150_), .b(new_n53_), .c(x31), .d(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n116_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n135_), .c(x29), .O(new_n180_));
  nand4  g136(.a(new_n150_), .b(new_n53_), .c(new_n130_), .d(new_n116_), .O(new_n181_));
  ...
  aoi21  g149(.a(new_n193_), .b(new_n45_), .c(x26), .O(z9));
endmodule
