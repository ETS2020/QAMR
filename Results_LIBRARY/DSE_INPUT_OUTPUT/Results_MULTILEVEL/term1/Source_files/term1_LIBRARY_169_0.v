...
module FAU ( 
  ...
  nand3  g126(.a(new_n170_), .b(new_n89_), .c(x00), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(z8));
  nand4  g128(.a(new_n145_), .b(new_n51_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n107_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n127_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n145_), .b(new_n51_), .c(new_n122_), .d(new_n107_), .O(new_n177_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n89_), .c(x00), .O(new_n189_));
