...
module FAU ( 
  ...
  or2    g038(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  ...
  oai21  g046(.a(new_n90_), .b(new_n83_), .c(new_n45_), .O(new_n91_));
  ...
  nand2  g051(.a(new_n95_), .b(new_n47_), .O(z3));
  ...
  nand2  g055(.a(new_n93_), .b(new_n91_), .O(new_n100_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n61_), .d(x25), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n59_), .c(new_n47_), .O(z5));
  ...
  nor2   g068(.a(new_n92_), .b(new_n81_), .O(new_n113_));
  nor2   g069(.a(new_n90_), .b(new_n82_), .O(new_n114_));
  aoi22  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n61_), .c(new_n45_), .d(x25), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n59_), .O(z6));
  nand3  g073(.a(new_n103_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  inv1   g075(.a(new_n82_), .O(new_n120_));
  nand4  g076(.a(new_n113_), .b(new_n89_), .c(new_n86_), .d(new_n120_), .O(new_n121_));
  nor2   g077(.a(new_n60_), .b(new_n59_), .O(new_n122_));
  inv1   g078(.a(x25), .O(new_n123_));
  inv1   g079(.a(new_n103_), .O(new_n124_));
  inv1   g080(.a(x31), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x30), .c(x29), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(new_n45_), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(z7));
  aoi21  g085(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(x17), .c(x16), .d(x15), .O(new_n131_));
  nand2  g087(.a(new_n102_), .b(new_n80_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x30), .c(x29), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n132_), .b(x29), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n108_), .O(new_n136_));
  inv1   g092(.a(x16), .O(new_n137_));
  nand2  g093(.a(x18), .b(x17), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n87_), .O(new_n139_));
  inv1   g095(.a(x11), .O(new_n140_));
  oai21  g096(.a(new_n138_), .b(new_n140_), .c(new_n137_), .O(new_n141_));
  aoi21  g097(.a(x18), .b(x12), .c(x17), .O(new_n142_));
  nor2   g098(.a(x18), .b(x13), .O(new_n143_));
  nor3   g099(.a(new_n143_), .b(new_n142_), .c(new_n125_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n141_), .c(new_n139_), .d(new_n136_), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n134_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n131_), .c(x26), .O(new_n147_));
  inv1   g103(.a(x15), .O(new_n148_));
  nand3  g104(.a(x17), .b(x16), .c(x10), .O(new_n149_));
  nor4   g105(.a(new_n149_), .b(new_n125_), .c(new_n87_), .d(new_n84_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n136_), .c(new_n133_), .O(new_n151_));
  and2   g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n147_), .c(x32), .O(new_n153_));
  inv1   g109(.a(x32), .O(new_n154_));
  nand3  g110(.a(new_n132_), .b(new_n108_), .c(x29), .O(new_n155_));
  nand2  g111(.a(new_n135_), .b(x30), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  inv1   g113(.a(x17), .O(new_n158_));
  nand3  g114(.a(x19), .b(new_n84_), .c(x13), .O(new_n159_));
  nand3  g115(.a(new_n87_), .b(x18), .c(x14), .O(new_n160_));
  ...
  nand3  g122(.a(new_n166_), .b(new_n137_), .c(x11), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n45_), .c(x15), .O(new_n169_));
  nand4  g125(.a(new_n166_), .b(x16), .c(new_n148_), .d(x10), .O(new_n170_));
  ...
  nand2  g132(.a(new_n168_), .b(x15), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n170_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n176_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n108_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n132_), .c(x29), .O(new_n182_));
  nand4  g138(.a(new_n178_), .b(new_n176_), .c(new_n125_), .d(new_n108_), .O(new_n183_));
  nand2  g139(.a(x33), .b(x30), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n135_), .O(new_n186_));
  nand2  g142(.a(x16), .b(x15), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n138_), .c(new_n87_), .O(new_n188_));
  nand2  g144(.a(x16), .b(x10), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n138_), .c(new_n148_), .O(new_n190_));
  inv1   g146(.a(new_n142_), .O(new_n191_));
  inv1   g147(.a(new_n143_), .O(new_n192_));
  xnor2a g148(.a(x31), .b(x30), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n192_), .c(new_n191_), .d(new_n141_), .O(new_n194_));
  inv1   g150(.a(new_n194_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n190_), .c(new_n188_), .d(new_n131_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(x33), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n186_), .c(new_n182_), .O(new_n198_));
