...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n87_), .c(new_n57_), .O(new_n93_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n61_), .d(new_n57_), .O(new_n103_));
  ...
  nand4  g076(.a(new_n100_), .b(new_n120_), .c(x30), .d(x29), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n119_), .c(new_n117_), .O(z7));
  nand3  g078(.a(x32), .b(new_n80_), .c(x00), .O(new_n123_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n127_), .c(new_n107_), .O(new_n146_));
  ...
  nor2   g115(.a(new_n129_), .b(new_n128_), .O(new_n160_));
  ...
  nand2  g123(.a(new_n167_), .b(new_n128_), .O(new_n168_));
  inv1   g124(.a(x13), .O(new_n169_));
  nand2  g125(.a(new_n129_), .b(new_n169_), .O(new_n170_));
  and2   g126(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n154_), .c(new_n149_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n80_), .c(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n125_), .O(z8));
  inv1   g132(.a(x00), .O(new_n177_));
  inv1   g133(.a(x33), .O(new_n178_));
  inv1   g134(.a(new_n126_), .O(new_n179_));
  aoi21  g135(.a(new_n144_), .b(new_n142_), .c(new_n179_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(x31), .d(x29), .O(new_n181_));
  nor2   g137(.a(new_n120_), .b(new_n98_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n170_), .c(new_n168_), .d(new_n126_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n165_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n164_), .c(new_n162_), .d(new_n158_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n181_), .c(new_n107_), .O(new_n187_));
  nor3   g143(.a(new_n178_), .b(new_n120_), .c(x30), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(new_n80_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n177_), .O(z9));
endmodule
