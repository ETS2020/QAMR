...
module FAU ( 
  ...
  and2   g60(.a(new_n104_), .b(new_n100_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n99_), .c(x25), .d(x01), .O(new_n106_));
  ...
  aoi21  g83(.a(new_n127_), .b(new_n102_), .c(new_n124_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n123_), .c(new_n122_), .d(new_n118_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n93_), .O(z7));
  nor2   g87(.a(x26), .b(new_n45_), .O(z9));
endmodule
