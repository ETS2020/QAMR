...
module FAU ( 
  ...
  nor3   g060(.a(new_n104_), .b(new_n78_), .c(new_n57_), .O(z5));
  inv1   g061(.a(x30), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n101_), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x29), .c(new_n79_), .O(new_n109_));
  oai21  g065(.a(new_n106_), .b(x29), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n93_), .c(new_n59_), .d(x25), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n57_), .c(new_n45_), .O(z6));
  nand3  g068(.a(new_n101_), .b(x30), .c(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  nand4  g070(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n115_));
  nor2   g071(.a(new_n58_), .b(new_n57_), .O(new_n116_));
  inv1   g072(.a(new_n101_), .O(new_n117_));
  ...
  nand2  g078(.a(new_n100_), .b(new_n80_), .O(new_n123_));
  inv1   g079(.a(x32), .O(new_n124_));
  nand3  g080(.a(x19), .b(new_n87_), .c(x13), .O(new_n125_));
  nand3  g081(.a(new_n90_), .b(x18), .c(x14), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n125_), .c(new_n84_), .O(new_n127_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n124_), .c(x31), .d(new_n106_), .O(new_n140_));
  nand2  g096(.a(x32), .b(x30), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n123_), .c(x29), .O(new_n143_));
  nand2  g099(.a(new_n123_), .b(x29), .O(new_n144_));
  nand4  g100(.a(new_n139_), .b(new_n124_), .c(x31), .d(x30), .O(new_n145_));
  nand2  g101(.a(x32), .b(new_n106_), .O(new_n146_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n90_), .O(new_n154_));
  ...
  nand4  g123(.a(new_n139_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n106_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n123_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n139_), .b(new_n167_), .c(new_n118_), .d(new_n106_), .O(new_n172_));
  ...
  nand4  g136(.a(new_n180_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n151_), .c(x33), .O(new_n182_));
