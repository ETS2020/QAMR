...
module FAU ( 
  ...
  nor3   g044(.a(new_n88_), .b(new_n80_), .c(new_n59_), .O(z3));
  ...
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n61_), .d(new_n45_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n80_), .c(new_n59_), .O(z5));
  ...
  nand4  g062(.a(new_n106_), .b(new_n61_), .c(new_n45_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n59_), .O(z6));
  inv1   g064(.a(x31), .O(new_n109_));
  nand3  g065(.a(new_n96_), .b(new_n109_), .c(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n45_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x30), .O(new_n112_));
  nand3  g068(.a(new_n96_), .b(x30), .c(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(new_n84_), .O(new_n115_));
  inv1   g071(.a(new_n85_), .O(new_n116_));
  nor2   g072(.a(new_n83_), .b(new_n82_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nor2   g074(.a(new_n60_), .b(new_n80_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(new_n114_), .d(x01), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n112_), .O(z7));
  nand2  g078(.a(new_n95_), .b(new_n81_), .O(new_n123_));
  ...
  nor3   g119(.a(new_n163_), .b(new_n162_), .c(new_n109_), .O(new_n164_));
  ...
  oai22  g127(.a(new_n171_), .b(new_n154_), .c(new_n101_), .d(new_n45_), .O(new_n172_));
  nand2  g128(.a(new_n147_), .b(new_n109_), .O(new_n173_));
  nor2   g129(.a(new_n109_), .b(new_n94_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n123_), .c(new_n101_), .O(new_n175_));
  aoi22  g131(.a(new_n175_), .b(new_n45_), .c(new_n173_), .d(new_n101_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x33), .O(new_n178_));
  nand4  g134(.a(new_n123_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  oai22  g135(.a(new_n179_), .b(x26), .c(new_n173_), .d(x30), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n142_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(x33), .c(new_n178_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x00), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n47_), .O(z9));
endmodule
