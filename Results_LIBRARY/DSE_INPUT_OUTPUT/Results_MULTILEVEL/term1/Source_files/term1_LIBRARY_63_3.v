...
module FAU ( 
  ...
  nand3  g044(.a(new_n88_), .b(new_n82_), .c(new_n46_), .O(new_n89_));
  nor3   g045(.a(new_n89_), .b(new_n81_), .c(new_n60_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(new_n46_), .O(new_n92_));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n97_), .c(new_n81_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n118_), .c(new_n117_), .d(new_n113_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n46_), .O(new_n124_));
  oai21  g080(.a(new_n46_), .b(x00), .c(new_n124_), .O(z7));
  nand2  g081(.a(new_n96_), .b(new_n82_), .O(new_n126_));
  ...
  aoi21  g125(.a(new_n169_), .b(new_n149_), .c(new_n45_), .O(z8));
  ...
  nand4  g131(.a(new_n145_), .b(new_n171_), .c(new_n119_), .d(new_n104_), .O(new_n176_));
  ...
  nand3  g143(.a(new_n187_), .b(new_n46_), .c(x00), .O(new_n188_));
