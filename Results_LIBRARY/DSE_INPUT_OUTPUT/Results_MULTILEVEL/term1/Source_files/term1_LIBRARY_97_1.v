...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n61_), .c(new_n47_), .d(new_n81_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n80_), .c(x25), .d(x01), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z3));
  nand3  g054(.a(new_n47_), .b(x28), .c(new_n81_), .O(new_n99_));
  ...
  nand2  g088(.a(new_n108_), .b(new_n81_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(x31), .d(new_n45_), .O(new_n150_));
  oai21  g106(.a(new_n134_), .b(new_n45_), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n133_), .c(x29), .O(new_n152_));
  nand2  g108(.a(new_n133_), .b(x29), .O(new_n153_));
  nand2  g109(.a(new_n91_), .b(x18), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n135_), .c(new_n85_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n139_), .c(x16), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n144_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x15), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n148_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n134_), .c(x31), .d(x30), .O(new_n160_));
  oai21  g116(.a(new_n134_), .b(x30), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n153_), .O(new_n162_));
  nand2  g118(.a(new_n91_), .b(x14), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x18), .c(x17), .d(x16), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n147_), .O(new_n165_));
  nor2   g121(.a(new_n141_), .b(new_n147_), .O(new_n166_));
  nor2   g122(.a(new_n88_), .b(new_n85_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n166_), .c(x19), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand3  g125(.a(new_n167_), .b(x16), .c(x10), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n147_), .O(new_n171_));
  nand2  g127(.a(new_n167_), .b(x11), .O(new_n172_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n165_), .c(x32), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n162_), .c(new_n152_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n80_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n47_), .O(z8));
  inv1   g137(.a(new_n174_), .O(new_n182_));
  aoi21  g138(.a(new_n166_), .b(new_n143_), .c(new_n175_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n173_), .d(new_n171_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n168_), .c(new_n47_), .O(new_n185_));
  nand2  g141(.a(new_n167_), .b(x16), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(x15), .c(new_n105_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n153_), .c(new_n128_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n45_), .O(new_n190_));
  nand3  g146(.a(new_n133_), .b(x31), .c(x29), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(x30), .c(x14), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n190_), .c(new_n185_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand4  g150(.a(new_n159_), .b(new_n133_), .c(x31), .d(x30), .O(new_n195_));
  nand4  g151(.a(new_n153_), .b(new_n128_), .c(new_n45_), .d(new_n91_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n88_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(x17), .c(x16), .d(x15), .O(new_n198_));
  oai21  g154(.a(new_n195_), .b(new_n107_), .c(new_n198_), .O(new_n199_));
  nand3  g155(.a(x18), .b(new_n85_), .c(x12), .O(new_n200_));
  nand3  g156(.a(new_n88_), .b(x17), .c(x13), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n200_), .c(new_n141_), .O(new_n202_));
  nand3  g158(.a(new_n167_), .b(new_n141_), .c(x11), .O(new_n203_));
  inv1   g159(.a(new_n203_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n202_), .c(x15), .O(new_n205_));
  nand3  g161(.a(new_n187_), .b(new_n147_), .c(x10), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(new_n153_), .c(new_n128_), .d(new_n45_), .O(new_n208_));
  nor2   g164(.a(new_n208_), .b(new_n91_), .O(new_n209_));
  aoi21  g165(.a(new_n199_), .b(x14), .c(new_n209_), .O(new_n210_));
  oai21  g166(.a(new_n210_), .b(x33), .c(new_n194_), .O(new_n211_));
  nand3  g167(.a(new_n211_), .b(new_n80_), .c(x00), .O(new_n212_));
