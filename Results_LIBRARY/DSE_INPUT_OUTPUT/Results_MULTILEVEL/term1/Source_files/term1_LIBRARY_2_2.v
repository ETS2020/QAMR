...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n86_), .c(new_n45_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n89_), .c(new_n61_), .O(z4));
  ...
  nand2  g079(.a(x30), .b(x26), .O(new_n124_));
  ...
  nand2  g098(.a(new_n95_), .b(new_n80_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x30), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n94_), .O(new_n145_));
  nand2  g101(.a(new_n143_), .b(x29), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n103_), .c(new_n145_), .d(new_n45_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n142_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  nand3  g105(.a(new_n146_), .b(x30), .c(new_n45_), .O(new_n150_));
  nand3  g106(.a(new_n143_), .b(new_n103_), .c(x29), .O(new_n151_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n152_), .c(new_n49_), .d(x31), .O(new_n168_));
  ...
  nand2  g130(.a(new_n146_), .b(new_n119_), .O(new_n175_));
  nor2   g131(.a(new_n119_), .b(new_n94_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n143_), .c(new_n103_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n45_), .c(new_n175_), .d(new_n103_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  nand4  g136(.a(new_n143_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  oai22  g137(.a(new_n181_), .b(x26), .c(new_n175_), .d(x30), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n167_), .c(new_n53_), .O(new_n183_));
