// Benchmark "FAU" written by ABC on Fri Aug 14 02:50:21 2020
...
module FAU ( 
  ...
  nor2   g055(.a(new_n94_), .b(new_n79_), .O(new_n100_));
  nand3  g056(.a(new_n99_), .b(x28), .c(x27), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n87_), .c(new_n60_), .d(new_n46_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x25), .c(x01), .d(x00), .O(new_n105_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n92_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n60_), .c(x25), .d(x01), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(x00), .c(x26), .O(z6));
  nand3  g069(.a(new_n100_), .b(x30), .c(x29), .O(new_n114_));
  ...
  nand3  g075(.a(new_n60_), .b(x01), .c(x00), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  inv1   g077(.a(x25), .O(new_n122_));
  inv1   g078(.a(new_n100_), .O(new_n123_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n121_), .c(new_n119_), .d(new_n115_), .O(z7));
  nand2  g084(.a(new_n94_), .b(new_n79_), .O(new_n129_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(x31), .d(new_n109_), .O(new_n149_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n134_), .O(new_n165_));
  ...
  nand3  g131(.a(new_n175_), .b(new_n46_), .c(x00), .O(new_n176_));
  ...
  nand4  g137(.a(new_n148_), .b(new_n178_), .c(new_n124_), .d(new_n109_), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n109_), .c(new_n182_), .O(new_n183_));
