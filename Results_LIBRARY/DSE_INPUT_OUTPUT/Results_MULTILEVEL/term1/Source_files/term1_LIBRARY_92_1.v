...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n91_), .c(new_n63_), .d(x25), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n62_), .c(new_n48_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n91_), .c(new_n63_), .d(x25), .O(new_n110_));
  ...
  oai21  g081(.a(new_n116_), .b(x26), .c(x24), .O(new_n126_));
  ...
  aoi21  g087(.a(new_n131_), .b(new_n129_), .c(new_n83_), .O(new_n132_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n49_), .c(x31), .d(new_n105_), .O(new_n145_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n53_), .c(new_n120_), .d(new_n105_), .O(new_n176_));
