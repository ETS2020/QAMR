...
module FAU ( 
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n92_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n62_), .c(x25), .d(x01), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n45_), .c(x26), .O(z5));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n92_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n62_), .c(new_n80_), .O(new_n116_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n90_), .c(new_n87_), .d(x17), .O(new_n123_));
  nand3  g079(.a(new_n62_), .b(new_n45_), .c(x01), .O(new_n124_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n104_), .c(new_n80_), .O(new_n129_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n49_), .c(x31), .d(new_n113_), .O(new_n148_));
  ...
  aoi21  g129(.a(new_n173_), .b(new_n45_), .c(x26), .O(z8));
  ...
  nand4  g134(.a(new_n147_), .b(new_n53_), .c(new_n127_), .d(new_n113_), .O(new_n179_));
  ...
  aoi21  g147(.a(new_n191_), .b(new_n45_), .c(x26), .O(z9));
endmodule
