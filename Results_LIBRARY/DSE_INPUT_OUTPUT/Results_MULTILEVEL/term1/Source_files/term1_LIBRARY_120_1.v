...
module FAU ( 
  ...
  oai21  g060(.a(new_n97_), .b(new_n45_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n128_), .c(new_n48_), .O(new_n141_));
  nand2  g097(.a(new_n96_), .b(new_n82_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x30), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n95_), .O(new_n144_));
  nand2  g100(.a(new_n142_), .b(x29), .O(new_n145_));
  aoi22  g101(.a(new_n145_), .b(new_n45_), .c(new_n144_), .d(x01), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  nand3  g104(.a(new_n145_), .b(x30), .c(x01), .O(new_n149_));
  nand3  g105(.a(new_n142_), .b(new_n45_), .c(x29), .O(new_n150_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n151_), .c(new_n49_), .d(x31), .O(new_n167_));
  ...
  oai21  g128(.a(new_n172_), .b(new_n128_), .c(new_n48_), .O(new_n173_));
  nand2  g129(.a(new_n145_), .b(new_n119_), .O(new_n174_));
  nor2   g130(.a(new_n119_), .b(new_n95_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n142_), .c(new_n45_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(x01), .c(new_n174_), .d(new_n45_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x33), .O(new_n179_));
  nand4  g135(.a(new_n142_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
  oai22  g136(.a(new_n180_), .b(new_n61_), .c(new_n174_), .d(x30), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n166_), .c(new_n53_), .O(new_n182_));
