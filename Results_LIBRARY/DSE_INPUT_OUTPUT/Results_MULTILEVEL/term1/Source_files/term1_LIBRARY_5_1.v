...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n83_), .c(new_n57_), .O(new_n93_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n105_), .c(new_n92_), .d(new_n83_), .O(new_n111_));
  ...
  nand3  g072(.a(new_n116_), .b(x30), .c(x00), .O(new_n117_));
  ...
  nand2  g076(.a(x30), .b(new_n106_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n83_), .c(new_n81_), .d(x25), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n62_), .c(new_n57_), .O(z6));
  oai21  g080(.a(x31), .b(x30), .c(new_n104_), .O(new_n125_));
  nand3  g081(.a(new_n108_), .b(x30), .c(x29), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x31), .O(new_n127_));
  nand4  g083(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n128_));
  nor2   g084(.a(new_n59_), .b(new_n62_), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  nand4  g086(.a(new_n108_), .b(new_n130_), .c(x30), .d(x29), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n129_), .c(new_n81_), .d(x25), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n128_), .c(new_n127_), .d(new_n125_), .O(z7));
  nand2  g090(.a(new_n107_), .b(new_n82_), .O(new_n135_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n136_), .c(x31), .d(new_n45_), .O(new_n155_));
  ...
  nand2  g116(.a(x32), .b(new_n45_), .O(new_n161_));
  ...
  nor3   g131(.a(new_n175_), .b(new_n174_), .c(new_n130_), .O(new_n176_));
  ...
  nand2  g139(.a(x33), .b(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n135_), .c(x29), .O(new_n186_));
  nand4  g142(.a(new_n154_), .b(new_n182_), .c(new_n130_), .d(new_n45_), .O(new_n187_));
