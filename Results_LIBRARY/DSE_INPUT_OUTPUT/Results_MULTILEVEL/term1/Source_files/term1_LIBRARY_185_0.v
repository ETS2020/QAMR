...
module FAU ( 
  ...
  nand4  g033(.a(new_n77_), .b(new_n55_), .c(new_n57_), .d(x08), .O(new_n78_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n61_), .d(new_n55_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n80_), .c(x25), .d(x01), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z5));
  nand3  g062(.a(new_n54_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n100_), .b(new_n54_), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n54_), .b(x29), .O(new_n109_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n59_), .c(new_n55_), .O(z6));
  oai21  g069(.a(z0), .b(x31), .c(new_n54_), .O(new_n114_));
  ...
  nand3  g076(.a(new_n100_), .b(new_n120_), .c(x29), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nor3   g078(.a(z0), .b(new_n120_), .c(x30), .O(new_n123_));
  ...
  aoi21  g104(.a(new_n131_), .b(x14), .c(new_n129_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x17), .c(x16), .d(x15), .O(new_n150_));
  nand3  g106(.a(new_n126_), .b(x30), .c(x29), .O(new_n151_));
  nand2  g107(.a(x16), .b(x15), .O(new_n152_));
  nand2  g108(.a(x18), .b(x17), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n131_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(new_n143_), .O(new_n156_));
  inv1   g112(.a(x11), .O(new_n157_));
  oai21  g113(.a(new_n153_), .b(new_n157_), .c(new_n137_), .O(new_n158_));
  nand2  g114(.a(x18), .b(x12), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n128_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  aoi21  g117(.a(new_n129_), .b(new_n161_), .c(new_n120_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n160_), .c(new_n158_), .d(new_n156_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n154_), .c(new_n151_), .d(new_n150_), .O(new_n165_));
  ...
  nand2  g124(.a(new_n168_), .b(new_n55_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n145_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n54_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n126_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n145_), .b(new_n170_), .c(new_n120_), .d(new_n54_), .O(new_n175_));
  nand2  g131(.a(x33), .b(x30), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n127_), .O(new_n178_));
  nand2  g134(.a(new_n129_), .b(new_n161_), .O(new_n179_));
  xnor2a g135(.a(x31), .b(x30), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n160_), .d(new_n158_), .O(new_n181_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n55_), .O(z9));
endmodule
