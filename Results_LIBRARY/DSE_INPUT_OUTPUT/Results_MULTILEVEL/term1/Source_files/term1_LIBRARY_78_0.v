...
module FAU ( 
  ...
  nand2  g075(.a(new_n119_), .b(new_n92_), .O(z7));
  inv1   g076(.a(x32), .O(new_n121_));
  nand2  g077(.a(new_n98_), .b(new_n80_), .O(new_n122_));
  ...
  aoi21  g110(.a(new_n125_), .b(new_n154_), .c(new_n114_), .O(new_n155_));
  ...
  nand4  g116(.a(new_n160_), .b(x30), .c(new_n92_), .d(x00), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(z8));
  inv1   g118(.a(x33), .O(new_n163_));
  nand4  g119(.a(new_n141_), .b(new_n122_), .c(new_n163_), .d(x31), .O(new_n164_));
  nand2  g120(.a(new_n125_), .b(new_n154_), .O(new_n165_));
  nor2   g121(.a(new_n114_), .b(new_n100_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n165_), .c(new_n153_), .d(new_n122_), .O(new_n167_));
  ...
  oai21  g127(.a(new_n164_), .b(new_n100_), .c(new_n171_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x30), .c(new_n92_), .d(x00), .O(new_n173_));
