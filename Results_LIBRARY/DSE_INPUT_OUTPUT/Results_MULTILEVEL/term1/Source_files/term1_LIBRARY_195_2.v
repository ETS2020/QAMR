...
module FAU ( 
  ...
  nand4  g50(.a(new_n94_), .b(new_n89_), .c(new_n52_), .d(new_n81_), .O(new_n95_));
  ...
  nand4  g58(.a(new_n102_), .b(new_n89_), .c(new_n52_), .d(new_n81_), .O(new_n103_));
  ...
  and2   g67(.a(new_n111_), .b(new_n89_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n52_), .c(x25), .d(x01), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g70(.a(new_n100_), .b(x30), .c(x29), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(x31), .O(new_n116_));
  nand4  g72(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n117_));
  aoi21  g73(.a(x03), .b(x02), .c(new_n61_), .O(new_n118_));
