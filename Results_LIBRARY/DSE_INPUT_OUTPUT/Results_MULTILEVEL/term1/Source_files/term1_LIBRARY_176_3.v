...
module FAU ( 
  ...
  nand4  g042(.a(new_n86_), .b(new_n60_), .c(new_n45_), .d(new_n80_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n79_), .c(x25), .d(x01), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z3));
  nand3  g046(.a(new_n45_), .b(x28), .c(new_n80_), .O(new_n91_));
  ...
  nand2  g051(.a(new_n95_), .b(new_n45_), .O(z4));
  nand2  g052(.a(x30), .b(x09), .O(new_n97_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n86_), .d(new_n60_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n107_), .b(x30), .c(new_n56_), .O(new_n108_));
  ...
  nand2  g068(.a(x30), .b(new_n98_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n85_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n58_), .c(new_n45_), .O(z6));
  oai21  g072(.a(x31), .b(x30), .c(x09), .O(new_n117_));
  ...
  nor2   g077(.a(new_n82_), .b(new_n81_), .O(new_n122_));
  ...
  nand4  g081(.a(new_n100_), .b(new_n125_), .c(x30), .d(x29), .O(new_n126_));
  ...
  nand2  g085(.a(new_n99_), .b(new_n80_), .O(new_n130_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n161_), .c(new_n45_), .O(new_n179_));
  nand2  g135(.a(new_n154_), .b(new_n125_), .O(new_n180_));
  nor2   g136(.a(new_n125_), .b(new_n98_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n130_), .c(new_n109_), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n56_), .c(new_n180_), .d(new_n109_), .O(new_n183_));
  ...
  oai22  g142(.a(new_n186_), .b(x09), .c(new_n180_), .d(x30), .O(new_n187_));
