...
module FAU ( 
  ...
  oai21  g014(.a(x26), .b(x05), .c(new_n58_), .O(new_n59_));
  ...
  nor3   g048(.a(new_n92_), .b(new_n84_), .c(new_n83_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n91_), .c(new_n45_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n84_), .c(new_n83_), .O(z4));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n75_), .d(new_n45_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n84_), .c(new_n83_), .O(z5));
  ...
  nand4  g066(.a(new_n110_), .b(new_n75_), .c(new_n45_), .d(x25), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n83_), .O(z6));
  ...
  nor2   g074(.a(new_n74_), .b(new_n83_), .O(new_n119_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n64_), .O(z8));
  ...
  nand2  g146(.a(new_n190_), .b(new_n64_), .O(z9));
endmodule
