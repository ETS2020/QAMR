...
module FAU ( 
  ...
  aoi21  g043(.a(new_n87_), .b(new_n83_), .c(new_n80_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n79_), .c(new_n78_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n77_), .c(x25), .d(x01), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z3));
  nand3  g048(.a(new_n79_), .b(x28), .c(new_n78_), .O(new_n93_));
  oai21  g049(.a(x28), .b(new_n78_), .c(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n88_), .c(new_n77_), .d(x25), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n79_), .c(new_n57_), .O(z4));
  ...
  aoi22  g056(.a(new_n100_), .b(new_n98_), .c(new_n87_), .d(new_n83_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n58_), .c(new_n77_), .d(x25), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n79_), .c(new_n57_), .O(z5));
  nand3  g059(.a(new_n88_), .b(new_n79_), .c(x29), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n97_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(x27), .c(new_n77_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n57_), .O(z6));
  inv1   g063(.a(new_n84_), .O(new_n108_));
  inv1   g064(.a(new_n85_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n108_), .c(new_n83_), .O(new_n110_));
  nand3  g066(.a(new_n58_), .b(x25), .c(x01), .O(new_n111_));
  nor4   g067(.a(new_n111_), .b(x31), .c(x30), .d(x26), .O(new_n112_));
  ...
  nand4  g072(.a(new_n116_), .b(x18), .c(x17), .d(x16), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  nand2  g074(.a(x16), .b(x15), .O(new_n119_));
  nand2  g075(.a(x18), .b(x17), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n115_), .O(new_n121_));
  nand2  g077(.a(x16), .b(x10), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n114_), .O(new_n123_));
  inv1   g079(.a(x11), .O(new_n124_));
  inv1   g080(.a(x16), .O(new_n125_));
  oai21  g081(.a(new_n120_), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  aoi21  g083(.a(x18), .b(x12), .c(x17), .O(new_n128_));
  nor2   g084(.a(x18), .b(x13), .O(new_n129_));
  nor3   g085(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n126_), .c(new_n123_), .d(new_n121_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n118_), .c(new_n45_), .O(new_n132_));
  nand2  g088(.a(new_n97_), .b(new_n78_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x30), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n99_), .O(new_n135_));
  nand2  g091(.a(new_n133_), .b(x29), .O(new_n136_));
  aoi22  g092(.a(new_n136_), .b(new_n79_), .c(new_n135_), .d(new_n57_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x32), .O(new_n139_));
  inv1   g095(.a(x32), .O(new_n140_));
  nand3  g096(.a(new_n136_), .b(x30), .c(new_n57_), .O(new_n141_));
  nand3  g097(.a(new_n133_), .b(new_n79_), .c(x29), .O(new_n142_));
  ...
  nand3  g102(.a(new_n115_), .b(x18), .c(x14), .O(new_n147_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n125_), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nand4  g112(.a(new_n153_), .b(x16), .c(new_n114_), .d(x10), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n143_), .c(new_n140_), .d(x31), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n139_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n77_), .c(x00), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(z8));
  nor2   g118(.a(new_n129_), .b(new_n128_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n126_), .c(new_n123_), .d(new_n121_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n118_), .c(new_n45_), .O(new_n165_));
  nand2  g121(.a(new_n136_), .b(new_n127_), .O(new_n166_));
  nor2   g122(.a(new_n127_), .b(new_n99_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n133_), .c(new_n79_), .O(new_n168_));
  aoi22  g124(.a(new_n168_), .b(new_n57_), .c(new_n166_), .d(new_n79_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x33), .O(new_n171_));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n133_), .b(x31), .c(x30), .d(x29), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(x01), .c(new_n166_), .d(x30), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n158_), .c(new_n172_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n77_), .c(x00), .O(new_n177_));
