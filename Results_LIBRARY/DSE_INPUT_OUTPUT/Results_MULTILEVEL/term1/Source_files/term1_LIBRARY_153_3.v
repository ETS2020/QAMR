...
module FAU ( 
  ...
  nand3  g044(.a(new_n88_), .b(new_n82_), .c(new_n45_), .O(new_n89_));
  nor3   g045(.a(new_n89_), .b(new_n81_), .c(new_n60_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n88_), .c(new_n45_), .d(x25), .O(new_n92_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n62_), .d(new_n45_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n81_), .c(new_n60_), .O(z5));
  ...
  nor2   g069(.a(new_n84_), .b(new_n83_), .O(new_n114_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n97_), .c(new_n81_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n96_), .b(new_n82_), .O(new_n124_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n125_), .c(x31), .d(new_n46_), .O(new_n144_));
  ...
  oai22  g128(.a(new_n172_), .b(new_n155_), .c(x30), .d(new_n45_), .O(new_n173_));
  aoi21  g129(.a(new_n148_), .b(new_n117_), .c(x30), .O(new_n174_));
  nor2   g130(.a(new_n117_), .b(new_n95_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n124_), .c(new_n46_), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(new_n45_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x33), .O(new_n179_));
  nand4  g135(.a(new_n148_), .b(new_n117_), .c(new_n46_), .d(new_n45_), .O(new_n180_));
  nand4  g136(.a(new_n124_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  ...
  nand2  g141(.a(new_n185_), .b(new_n48_), .O(z9));
endmodule
