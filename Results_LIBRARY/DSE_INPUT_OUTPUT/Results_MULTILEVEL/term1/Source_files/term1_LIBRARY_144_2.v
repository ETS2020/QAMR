...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n88_), .c(new_n79_), .O(new_n94_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n98_), .c(new_n61_), .d(new_n81_), .O(new_n103_));
  ...
  oai21  g069(.a(new_n113_), .b(new_n59_), .c(new_n79_), .O(z6));
  ...
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n79_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x33), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(x30), .c(new_n118_), .O(new_n121_));
  nor4   g077(.a(new_n119_), .b(new_n45_), .c(x31), .d(new_n107_), .O(new_n122_));
  ...
  nand4  g088(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n133_));
  ...
  nor2   g097(.a(new_n141_), .b(new_n118_), .O(new_n142_));
  and2   g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n129_), .c(new_n79_), .O(new_n145_));
  nor2   g101(.a(x28), .b(x27), .O(new_n146_));
  nor3   g102(.a(new_n146_), .b(new_n45_), .c(new_n107_), .O(new_n147_));
  nor2   g103(.a(new_n146_), .b(new_n99_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  aoi22  g105(.a(new_n149_), .b(new_n107_), .c(new_n147_), .d(x29), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(new_n146_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n107_), .c(x29), .O(new_n154_));
  nand3  g110(.a(new_n149_), .b(x33), .c(x30), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  inv1   g112(.a(x18), .O(new_n157_));
  nand3  g113(.a(x19), .b(new_n157_), .c(x13), .O(new_n158_));
  nand3  g114(.a(new_n126_), .b(x18), .c(x14), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n138_), .O(new_n160_));
  nand4  g116(.a(x19), .b(x18), .c(new_n138_), .d(x12), .O(new_n161_));
  ...
  nand4  g124(.a(new_n165_), .b(x16), .c(new_n125_), .d(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n156_), .c(new_n48_), .d(x31), .O(new_n171_));
  ...
  nand4  g131(.a(new_n170_), .b(new_n45_), .c(new_n118_), .d(new_n107_), .O(new_n176_));
  nand2  g132(.a(x33), .b(x30), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n176_), .c(new_n148_), .O(new_n178_));
  oai21  g134(.a(new_n148_), .b(x31), .c(new_n107_), .O(new_n179_));
  aoi21  g135(.a(new_n118_), .b(x30), .c(new_n141_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n140_), .c(new_n137_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n179_), .c(new_n134_), .d(new_n132_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n129_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n45_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n178_), .c(new_n81_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n175_), .O(z9));
endmodule
