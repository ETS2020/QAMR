...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n59_), .c(x30), .d(new_n79_), .O(new_n93_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n59_), .d(x30), .O(new_n98_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n59_), .d(x30), .O(new_n107_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n59_), .c(x25), .d(x01), .O(new_n113_));
  ...
  nand3  g075(.a(new_n104_), .b(new_n119_), .c(x29), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n59_), .c(x25), .d(x01), .O(new_n121_));
  ...
  nand2  g080(.a(new_n124_), .b(new_n78_), .O(z7));
  inv1   g081(.a(x32), .O(new_n126_));
  nand2  g082(.a(new_n103_), .b(new_n79_), .O(new_n127_));
  ...
  aoi21  g112(.a(new_n84_), .b(new_n156_), .c(new_n119_), .O(new_n157_));
  ...
  nor2   g123(.a(new_n119_), .b(new_n102_), .O(new_n168_));
  ...
  oai21  g129(.a(new_n166_), .b(new_n102_), .c(new_n173_), .O(new_n174_));
