...
module FAU ( 
  ...
  nand2  g096(.a(new_n95_), .b(new_n81_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x29), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n46_), .c(x01), .O(new_n143_));
  nand3  g099(.a(new_n141_), .b(x30), .c(x29), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(new_n140_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x32), .O(new_n146_));
  inv1   g102(.a(x32), .O(new_n147_));
  nand4  g103(.a(new_n141_), .b(new_n46_), .c(x29), .d(x01), .O(new_n148_));
  nand2  g104(.a(new_n142_), .b(x30), .O(new_n149_));
  ...
  nand3  g109(.a(new_n124_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n151_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n151_), .d(x12), .O(new_n156_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n134_), .c(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x15), .O(new_n163_));
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n123_), .d(x10), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n150_), .c(new_n147_), .d(x31), .O(new_n166_));
  ...
  nor2   g125(.a(new_n137_), .b(new_n136_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n135_), .c(new_n132_), .d(new_n130_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n127_), .c(new_n47_), .O(new_n172_));
  aoi21  g128(.a(new_n142_), .b(new_n118_), .c(x30), .O(new_n173_));
  nor2   g129(.a(new_n118_), .b(new_n94_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n141_), .c(new_n46_), .O(new_n175_));
  aoi21  g131(.a(new_n173_), .b(x01), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x33), .O(new_n178_));
  aoi21  g134(.a(new_n161_), .b(new_n158_), .c(new_n123_), .O(new_n179_));
  inv1   g135(.a(new_n164_), .O(new_n180_));
  nand4  g136(.a(new_n142_), .b(new_n118_), .c(new_n46_), .d(x01), .O(new_n181_));
  nand4  g137(.a(new_n141_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n179_), .c(new_n183_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(x33), .c(new_n178_), .O(new_n185_));
