...
module FAU ( 
  ...
  nor3   g003(.a(x32), .b(x30), .c(x03), .O(new_n48_));
  nor2   g004(.a(x33), .b(new_n45_), .O(new_n49_));
  oai21  g005(.a(new_n49_), .b(new_n48_), .c(x02), .O(new_n50_));
  inv1   g006(.a(x02), .O(new_n51_));
  nor2   g007(.a(x32), .b(new_n45_), .O(new_n52_));
  nor3   g008(.a(x33), .b(x30), .c(x03), .O(new_n53_));
  oai21  g009(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  nand2  g010(.a(new_n54_), .b(new_n50_), .O(z1));
  xnor2a g011(.a(x07), .b(x04), .O(new_n56_));
  inv1   g012(.a(x01), .O(new_n57_));
  nand2  g013(.a(x03), .b(x02), .O(new_n58_));
  nand2  g014(.a(new_n45_), .b(new_n51_), .O(new_n59_));
  aoi21  g015(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  nand2  g016(.a(x05), .b(new_n45_), .O(new_n61_));
  nand3  g017(.a(new_n61_), .b(x06), .c(new_n51_), .O(new_n62_));
  nand2  g018(.a(x06), .b(new_n51_), .O(new_n63_));
  nand3  g019(.a(new_n63_), .b(x05), .c(new_n45_), .O(new_n64_));
  aoi21  g020(.a(new_n64_), .b(new_n62_), .c(x01), .O(new_n65_));
  oai21  g021(.a(new_n65_), .b(new_n60_), .c(new_n56_), .O(new_n66_));
  xor2a  g022(.a(x07), .b(x04), .O(new_n67_));
  nor2   g023(.a(new_n45_), .b(x02), .O(new_n68_));
  nor2   g024(.a(x03), .b(new_n51_), .O(new_n69_));
  oai21  g025(.a(new_n69_), .b(new_n68_), .c(x01), .O(new_n70_));
  nor2   g026(.a(new_n45_), .b(x01), .O(new_n71_));
  nor2   g027(.a(x05), .b(x03), .O(new_n72_));
  oai21  g028(.a(new_n72_), .b(new_n71_), .c(x02), .O(new_n73_));
  inv1   g029(.a(new_n61_), .O(new_n74_));
  nand2  g030(.a(x06), .b(x05), .O(new_n75_));
  oai22  g031(.a(new_n75_), .b(new_n59_), .c(new_n74_), .d(x06), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n57_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n73_), .c(new_n70_), .O(new_n78_));
  ...
  nand2  g037(.a(new_n81_), .b(new_n46_), .O(z2));
  ...
  aoi21  g045(.a(x03), .b(x02), .c(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n84_), .c(new_n83_), .d(x25), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n57_), .c(new_n46_), .O(z3));
  ...
  oai21  g053(.a(new_n45_), .b(x02), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n94_), .d(new_n83_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n93_), .c(new_n57_), .O(z4));
  ...
  oai21  g061(.a(new_n96_), .b(x03), .c(new_n51_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n97_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n105_), .c(new_n94_), .d(new_n83_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n93_), .c(new_n57_), .O(z5));
  inv1   g065(.a(new_n103_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x30), .c(x03), .O(new_n111_));
  nand3  g067(.a(new_n96_), .b(x28), .c(x27), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(x02), .O(new_n113_));
  nand4  g069(.a(new_n96_), .b(x28), .c(x27), .d(new_n45_), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n113_), .c(x29), .O(new_n116_));
  nand3  g072(.a(new_n68_), .b(x30), .c(new_n101_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n94_), .c(new_n83_), .d(x25), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n57_), .O(z6));
  nor4   g076(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n121_));
  nand3  g077(.a(new_n83_), .b(x25), .c(x01), .O(new_n122_));
  ...
  nor2   g081(.a(x31), .b(new_n96_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n103_), .c(x29), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n125_), .c(new_n51_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(x30), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(x03), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n123_), .O(z7));
  nand2  g088(.a(new_n102_), .b(new_n84_), .O(new_n133_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n134_), .c(x31), .d(new_n96_), .O(new_n153_));
  ...
  nand2  g114(.a(x32), .b(new_n96_), .O(new_n159_));
  ...
  nand2  g137(.a(x33), .b(new_n96_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n133_), .c(x29), .O(new_n184_));
  nand4  g140(.a(new_n152_), .b(new_n180_), .c(new_n129_), .d(new_n96_), .O(new_n185_));
  ...
  nor3   g145(.a(new_n173_), .b(new_n130_), .c(new_n126_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n189_), .c(new_n171_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n169_), .c(new_n167_), .O(new_n193_));
