...
module FAU ( 
  ...
  nand3  g011(.a(new_n55_), .b(new_n52_), .c(new_n45_), .O(new_n56_));
  nand2  g012(.a(new_n56_), .b(new_n51_), .O(z1));
  xnor2a g013(.a(x07), .b(x04), .O(new_n58_));
  inv1   g014(.a(x01), .O(new_n59_));
  nand2  g015(.a(x03), .b(x02), .O(new_n60_));
  nand2  g016(.a(new_n49_), .b(new_n45_), .O(new_n61_));
  ...
  nand2  g039(.a(new_n83_), .b(new_n46_), .O(z2));
  ...
  nand4  g055(.a(new_n99_), .b(new_n60_), .c(new_n86_), .d(new_n52_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n85_), .c(new_n59_), .O(z3));
  xor2a  g057(.a(x28), .b(x27), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n99_), .c(new_n60_), .d(new_n52_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n85_), .c(new_n59_), .O(z4));
  oai21  g060(.a(x26), .b(x03), .c(x02), .O(new_n105_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n105_), .c(new_n99_), .d(x25), .O(new_n111_));
  ...
  oai21  g070(.a(new_n108_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n113_), .b(x29), .c(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n105_), .c(new_n99_), .d(x25), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n59_), .c(new_n46_), .O(z6));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n108_), .c(new_n85_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n122_), .c(new_n121_), .d(x01), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n52_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n105_), .O(z7));
  nand2  g085(.a(new_n107_), .b(new_n86_), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n93_), .c(x13), .O(new_n131_));
  nand3  g087(.a(new_n96_), .b(x18), .c(x14), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n90_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n90_), .d(x12), .O(new_n134_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n96_), .O(new_n160_));
  ...
  nand3  g145(.a(new_n189_), .b(new_n52_), .c(x00), .O(new_n190_));
