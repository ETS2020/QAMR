...
module FAU ( 
  ...
  oai21  g015(.a(x30), .b(x05), .c(new_n59_), .O(new_n60_));
  nand2  g016(.a(x06), .b(new_n53_), .O(new_n61_));
  nand2  g017(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand4  g018(.a(x06), .b(x05), .c(new_n50_), .d(new_n53_), .O(new_n63_));
  aoi21  g019(.a(new_n63_), .b(new_n62_), .c(x01), .O(new_n64_));
  xor2a  g020(.a(x03), .b(x02), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(new_n47_), .c(x01), .O(new_n66_));
  inv1   g022(.a(new_n66_), .O(new_n67_));
  oai21  g023(.a(new_n67_), .b(new_n64_), .c(new_n58_), .O(new_n68_));
  xnor2a g024(.a(x07), .b(x04), .O(new_n69_));
  nand3  g025(.a(new_n60_), .b(x06), .c(new_n53_), .O(new_n70_));
  nand3  g026(.a(new_n61_), .b(x05), .c(new_n50_), .O(new_n71_));
  aoi21  g027(.a(new_n71_), .b(new_n70_), .c(x01), .O(new_n72_));
  nand2  g028(.a(new_n50_), .b(new_n53_), .O(new_n73_));
  nor2   g029(.a(new_n50_), .b(new_n53_), .O(new_n74_));
  inv1   g030(.a(new_n74_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(new_n47_), .c(x01), .O(new_n77_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n75_), .c(new_n47_), .d(new_n84_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n83_), .c(x25), .d(x01), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z3));
  nand3  g057(.a(new_n47_), .b(x28), .c(new_n84_), .O(new_n102_));
  oai21  g058(.a(x28), .b(new_n84_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n97_), .c(new_n75_), .d(new_n83_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x25), .c(x01), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n47_), .O(z4));
  inv1   g063(.a(x29), .O(new_n108_));
  inv1   g064(.a(x28), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  nand3  g066(.a(new_n108_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n108_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n97_), .c(new_n75_), .d(new_n83_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x25), .c(x01), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n47_), .O(z5));
  inv1   g072(.a(x01), .O(new_n117_));
  inv1   g073(.a(x25), .O(new_n118_));
  nand3  g074(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x30), .c(x05), .O(new_n120_));
  nand3  g076(.a(new_n110_), .b(new_n45_), .c(x29), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n97_), .c(new_n75_), .d(new_n83_), .O(new_n123_));
  nor3   g079(.a(new_n123_), .b(new_n118_), .c(new_n117_), .O(z6));
  inv1   g080(.a(x05), .O(new_n125_));
  oai21  g081(.a(x31), .b(x30), .c(new_n125_), .O(new_n126_));
  nand3  g082(.a(new_n110_), .b(x30), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x31), .O(new_n128_));
  nand4  g084(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n129_));
  nor2   g085(.a(new_n74_), .b(new_n117_), .O(new_n130_));
  inv1   g086(.a(x31), .O(new_n131_));
  nand4  g087(.a(new_n110_), .b(new_n131_), .c(x30), .d(x29), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n130_), .c(new_n83_), .d(x25), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n129_), .c(new_n128_), .d(new_n126_), .O(z7));
  nand2  g091(.a(new_n109_), .b(new_n84_), .O(new_n136_));
  inv1   g092(.a(x32), .O(new_n137_));
  nand3  g093(.a(x19), .b(new_n91_), .c(x13), .O(new_n138_));
  nand3  g094(.a(new_n94_), .b(x18), .c(x14), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n138_), .c(new_n88_), .O(new_n140_));
  nand4  g096(.a(x19), .b(x18), .c(new_n88_), .d(x12), .O(new_n141_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n137_), .c(x31), .d(new_n45_), .O(new_n153_));
  ...
  oai21  g122(.a(new_n166_), .b(new_n165_), .c(new_n94_), .O(new_n167_));
  ...
  nor3   g129(.a(new_n173_), .b(new_n172_), .c(new_n131_), .O(new_n174_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n83_), .c(x00), .O(new_n178_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n164_), .c(new_n47_), .O(new_n182_));
  nand2  g138(.a(new_n157_), .b(new_n131_), .O(new_n183_));
  nor2   g139(.a(new_n131_), .b(new_n108_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n136_), .c(new_n45_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(x05), .c(new_n183_), .d(new_n45_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand4  g144(.a(new_n136_), .b(x31), .c(x30), .d(x29), .O(new_n189_));
  oai22  g145(.a(new_n189_), .b(new_n125_), .c(new_n183_), .d(x30), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n152_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(x33), .c(new_n188_), .O(new_n192_));
