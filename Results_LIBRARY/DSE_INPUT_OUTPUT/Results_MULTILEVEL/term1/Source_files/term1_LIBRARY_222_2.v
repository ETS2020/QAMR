...
module FAU ( 
  ...
  aoi21  g001(.a(new_n45_), .b(x01), .c(x32), .O(z0));
  nand2  g002(.a(new_n45_), .b(x01), .O(new_n47_));
  ...
  nand2  g007(.a(x03), .b(x02), .O(new_n52_));
  inv1   g008(.a(x02), .O(new_n53_));
  inv1   g009(.a(x03), .O(new_n54_));
  nand2  g010(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g011(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  nand2  g012(.a(new_n56_), .b(new_n51_), .O(new_n57_));
  nand3  g013(.a(new_n57_), .b(new_n50_), .c(new_n47_), .O(z1));
  xnor2a g014(.a(x07), .b(x04), .O(new_n59_));
  nand3  g015(.a(new_n56_), .b(x30), .c(x01), .O(new_n60_));
  ...
  nand3  g024(.a(new_n49_), .b(x30), .c(x01), .O(new_n69_));
  inv1   g025(.a(new_n69_), .O(new_n70_));
  nand2  g026(.a(new_n64_), .b(new_n62_), .O(new_n71_));
  nand4  g027(.a(x06), .b(x05), .c(new_n54_), .d(new_n53_), .O(new_n72_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n52_), .c(x30), .d(new_n79_), .O(new_n93_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n52_), .d(x30), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n78_), .c(x25), .d(x01), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z4));
  inv1   g057(.a(x01), .O(new_n102_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n52_), .d(x30), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n78_), .c(x25), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x30), .c(new_n102_), .O(z5));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n92_), .c(new_n52_), .d(x30), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n78_), .c(x25), .d(x01), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(z6));
  nand2  g072(.a(new_n112_), .b(x31), .O(new_n117_));
  ...
  nand4  g076(.a(new_n120_), .b(new_n52_), .c(new_n78_), .d(x25), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n118_), .c(new_n117_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x30), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x01), .O(z7));
  inv1   g081(.a(x15), .O(new_n126_));
  nand2  g082(.a(new_n89_), .b(x14), .O(new_n127_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(new_n89_), .O(new_n132_));
  nand2  g088(.a(x16), .b(x10), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n131_), .c(new_n126_), .O(new_n134_));
  ...
  nor3   g095(.a(new_n139_), .b(new_n138_), .c(new_n119_), .O(new_n140_));
  ...
  nand2  g098(.a(new_n103_), .b(new_n79_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x29), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n45_), .c(new_n102_), .O(new_n145_));
  nand3  g101(.a(new_n143_), .b(x30), .c(x29), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n145_), .c(new_n142_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  nand4  g104(.a(new_n143_), .b(new_n45_), .c(x29), .d(new_n102_), .O(new_n149_));
  nand2  g105(.a(new_n144_), .b(x30), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand3  g107(.a(x19), .b(new_n86_), .c(x13), .O(new_n152_));
  nand3  g108(.a(new_n89_), .b(x18), .c(x14), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n152_), .c(new_n83_), .O(new_n154_));
  nand4  g110(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n155_));
  ...
  nand3  g115(.a(new_n159_), .b(new_n136_), .c(x11), .O(new_n160_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n151_), .c(new_n48_), .d(x31), .O(new_n165_));
  ...
  nor2   g124(.a(new_n139_), .b(new_n138_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n129_), .c(new_n47_), .O(new_n171_));
  aoi21  g127(.a(new_n144_), .b(new_n119_), .c(x30), .O(new_n172_));
  nor2   g128(.a(new_n119_), .b(new_n105_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n143_), .c(new_n45_), .O(new_n174_));
  aoi21  g130(.a(new_n172_), .b(new_n102_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  nand4  g133(.a(new_n144_), .b(new_n119_), .c(new_n45_), .d(new_n102_), .O(new_n178_));
  nand4  g134(.a(new_n143_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n164_), .c(new_n51_), .O(new_n181_));
