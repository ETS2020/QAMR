...
module FAU ( 
  ...
  nand4  g065(.a(new_n109_), .b(new_n96_), .c(x25), .d(x01), .O(new_n110_));
  ...
  nand2  g082(.a(new_n126_), .b(new_n96_), .O(z7));
  ...
  nand4  g120(.a(new_n164_), .b(x30), .c(new_n96_), .d(x00), .O(new_n165_));
