...
module FAU ( 
  ...
  oai21  g065(.a(new_n109_), .b(new_n63_), .c(new_n107_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n84_), .c(new_n82_), .d(x25), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n47_), .O(z5));
  nand4  g068(.a(new_n45_), .b(x28), .c(x27), .d(x01), .O(new_n113_));
  oai21  g069(.a(new_n104_), .b(new_n45_), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g073(.a(new_n117_), .b(new_n81_), .c(new_n47_), .O(z6));
  nand3  g074(.a(new_n104_), .b(x30), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x31), .O(new_n120_));
  nand4  g076(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n121_));
  nor2   g077(.a(new_n60_), .b(new_n63_), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x30), .c(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n105_), .c(new_n82_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n81_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(z7));
  nand2  g083(.a(new_n103_), .b(new_n83_), .O(new_n128_));
  inv1   g084(.a(x32), .O(new_n129_));
  nand3  g085(.a(x19), .b(new_n91_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n94_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n88_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n88_), .d(x12), .O(new_n133_));
  ...
  nand2  g109(.a(new_n94_), .b(x14), .O(new_n154_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n94_), .O(new_n159_));
  ...
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n123_), .d(new_n45_), .O(new_n177_));
