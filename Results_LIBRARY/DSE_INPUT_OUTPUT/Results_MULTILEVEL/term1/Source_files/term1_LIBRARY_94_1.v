...
module FAU ( 
  ...
  oai21  g061(.a(new_n98_), .b(new_n45_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n59_), .c(new_n57_), .O(z6));
  ...
  aoi22  g076(.a(new_n120_), .b(x14), .c(x31), .d(new_n45_), .O(new_n121_));
  ...
  oai21  g099(.a(new_n124_), .b(new_n45_), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n123_), .c(x29), .O(new_n145_));
  nand2  g101(.a(new_n123_), .b(x29), .O(new_n146_));
  nand2  g102(.a(new_n128_), .b(x18), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n127_), .c(new_n125_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n132_), .c(x16), .O(new_n149_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n124_), .c(x31), .d(x30), .O(new_n153_));
  oai21  g109(.a(new_n124_), .b(x30), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n146_), .O(new_n155_));
  nand2  g111(.a(new_n128_), .b(x14), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x18), .c(x17), .d(x16), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n140_), .O(new_n158_));
  nor2   g114(.a(new_n134_), .b(new_n140_), .O(new_n159_));
  nor2   g115(.a(new_n126_), .b(new_n125_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n159_), .c(x19), .O(new_n161_));
  ...
  nor3   g124(.a(new_n168_), .b(new_n167_), .c(new_n118_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n166_), .c(new_n164_), .d(new_n162_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n158_), .c(x32), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n155_), .c(new_n145_), .O(new_n172_));
  ...
  aoi21  g131(.a(new_n159_), .b(new_n136_), .c(new_n168_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n175_), .c(new_n166_), .d(new_n164_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n161_), .c(new_n57_), .O(new_n178_));
  nor2   g134(.a(new_n140_), .b(x14), .O(new_n179_));
  nand2  g135(.a(new_n160_), .b(x16), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n146_), .c(new_n118_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n45_), .O(new_n184_));
  nand3  g140(.a(new_n123_), .b(x31), .c(x29), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(x30), .c(x14), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n184_), .c(new_n178_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand4  g144(.a(new_n152_), .b(new_n123_), .c(x31), .d(x30), .O(new_n189_));
  nand4  g145(.a(new_n146_), .b(new_n118_), .c(new_n45_), .d(new_n128_), .O(new_n190_));
  nor2   g146(.a(new_n190_), .b(new_n126_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x17), .c(x16), .d(x15), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n96_), .c(new_n192_), .O(new_n193_));
  nand3  g149(.a(x18), .b(new_n125_), .c(x12), .O(new_n194_));
  nand3  g150(.a(new_n126_), .b(x17), .c(x13), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n194_), .c(new_n134_), .O(new_n196_));
  nand3  g152(.a(new_n160_), .b(new_n134_), .c(x11), .O(new_n197_));
  inv1   g153(.a(new_n197_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n196_), .c(x15), .O(new_n199_));
  nand3  g155(.a(new_n181_), .b(new_n140_), .c(x10), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n146_), .c(new_n118_), .d(new_n45_), .O(new_n202_));
  nor2   g158(.a(new_n202_), .b(new_n128_), .O(new_n203_));
  aoi21  g159(.a(new_n193_), .b(x14), .c(new_n203_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(x33), .c(new_n188_), .O(new_n205_));
