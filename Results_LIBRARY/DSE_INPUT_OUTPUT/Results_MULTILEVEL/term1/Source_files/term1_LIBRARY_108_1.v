...
module FAU ( 
  ...
  nand2  g060(.a(new_n45_), .b(new_n59_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n104_), .c(new_n101_), .d(x29), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  nand4  g063(.a(new_n101_), .b(new_n107_), .c(x28), .d(x27), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n59_), .c(new_n106_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n47_), .O(z5));
  nand4  g067(.a(new_n45_), .b(x28), .c(x27), .d(x01), .O(new_n112_));
  oai21  g068(.a(new_n103_), .b(new_n45_), .c(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x29), .O(new_n114_));
  oai21  g070(.a(new_n45_), .b(x29), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n61_), .d(new_n80_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n97_), .c(new_n47_), .O(z6));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n45_), .O(new_n145_));
  ...
  nor2   g131(.a(new_n123_), .b(new_n107_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n128_), .c(new_n45_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(x01), .c(new_n175_), .d(new_n45_), .O(new_n178_));
  ...
  oai22  g137(.a(new_n181_), .b(new_n59_), .c(new_n175_), .d(x30), .O(new_n182_));
