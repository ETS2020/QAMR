...
module FAU ( 
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n60_), .d(new_n45_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(x25), .c(new_n79_), .d(x01), .O(new_n111_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n114_), .c(new_n93_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n60_), .c(x25), .d(x01), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n79_), .c(x26), .O(z6));
  nand3  g075(.a(new_n106_), .b(x30), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  nor2   g077(.a(new_n84_), .b(new_n82_), .O(new_n122_));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n106_), .c(new_n125_), .O(new_n129_));
  ...
  nand2  g088(.a(new_n105_), .b(new_n80_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(x31), .d(new_n115_), .O(new_n150_));
  ...
  nand2  g111(.a(x32), .b(new_n115_), .O(new_n156_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n45_), .c(new_n79_), .d(x00), .O(new_n194_));
