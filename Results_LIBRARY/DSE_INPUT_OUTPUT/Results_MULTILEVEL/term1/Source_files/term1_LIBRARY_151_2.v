...
module FAU ( 
  ...
  nand2  g080(.a(new_n88_), .b(x14), .O(new_n125_));
  ...
  inv1   g096(.a(x30), .O(new_n141_));
  nor2   g097(.a(x28), .b(x27), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n102_), .O(new_n143_));
  ...
  nand4  g106(.a(new_n146_), .b(new_n141_), .c(x29), .d(new_n45_), .O(new_n151_));
  oai21  g107(.a(new_n143_), .b(new_n141_), .c(new_n151_), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n85_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n88_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n82_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n156_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n135_), .c(new_n132_), .d(new_n130_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n127_), .c(x33), .O(new_n185_));
