...
module FAU ( 
  ...
  aoi22  g050(.a(new_n94_), .b(new_n59_), .c(new_n84_), .d(new_n45_), .O(new_n95_));
  ...
  aoi22  g060(.a(new_n104_), .b(x27), .c(new_n102_), .d(x29), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n95_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n63_), .c(new_n82_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n61_), .O(z5));
  inv1   g064(.a(x29), .O(new_n109_));
  nand3  g065(.a(new_n102_), .b(x30), .c(new_n45_), .O(new_n110_));
  nor2   g066(.a(new_n46_), .b(x18), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x28), .c(x27), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(new_n114_));
  nor2   g070(.a(new_n46_), .b(x29), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n94_), .O(new_n116_));
  inv1   g072(.a(new_n102_), .O(new_n117_));
  nand3  g073(.a(new_n46_), .b(x28), .c(x27), .O(new_n118_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n115_), .c(new_n84_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n116_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n63_), .c(new_n82_), .d(x25), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n61_), .c(new_n59_), .O(z6));
  inv1   g081(.a(x31), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x29), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n102_), .c(new_n45_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x30), .O(new_n129_));
  nand2  g085(.a(x27), .b(new_n45_), .O(new_n130_));
  nand3  g086(.a(x30), .b(x29), .c(x28), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(x31), .O(new_n132_));
  nand2  g088(.a(new_n84_), .b(new_n45_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n134_));
  nand4  g090(.a(new_n63_), .b(new_n82_), .c(x25), .d(x01), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n134_), .c(new_n132_), .d(new_n129_), .O(z7));
  nor2   g093(.a(x28), .b(x27), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  inv1   g095(.a(x32), .O(new_n140_));
  inv1   g096(.a(x15), .O(new_n141_));
  nand3  g097(.a(new_n91_), .b(x18), .c(x14), .O(new_n142_));
  nand4  g098(.a(new_n46_), .b(x19), .c(new_n45_), .d(x13), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n142_), .c(new_n88_), .O(new_n144_));
  ...
  aoi21  g107(.a(new_n151_), .b(new_n147_), .c(new_n141_), .O(new_n152_));
  nand3  g108(.a(x16), .b(new_n141_), .c(x10), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(new_n140_), .O(new_n155_));
  nand2  g111(.a(x32), .b(x30), .O(new_n156_));
  oai21  g112(.a(new_n155_), .b(new_n126_), .c(new_n156_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n139_), .c(x29), .O(new_n158_));
  nor2   g114(.a(new_n138_), .b(new_n109_), .O(new_n159_));
  nand2  g115(.a(new_n112_), .b(x32), .O(new_n160_));
  nand4  g116(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nor2   g118(.a(new_n46_), .b(new_n91_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n140_), .d(x31), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n160_), .c(new_n159_), .O(new_n165_));
  aoi21  g121(.a(new_n91_), .b(x14), .c(new_n45_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x17), .c(x16), .d(x15), .O(new_n167_));
  nand2  g123(.a(x16), .b(x15), .O(new_n168_));
  nand2  g124(.a(x18), .b(x17), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n168_), .c(new_n91_), .O(new_n170_));
  nand2  g126(.a(x16), .b(x10), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(new_n141_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n169_), .b(new_n173_), .c(new_n148_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x12), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n88_), .O(new_n176_));
  inv1   g132(.a(x13), .O(new_n177_));
  nand2  g133(.a(new_n45_), .b(new_n177_), .O(new_n178_));
  ...
  aoi21  g137(.a(new_n181_), .b(x32), .c(new_n165_), .O(new_n182_));
  ...
  oai21  g143(.a(new_n154_), .b(new_n152_), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(x33), .b(x30), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(x31), .c(new_n189_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand3  g147(.a(new_n163_), .b(new_n187_), .c(x31), .O(new_n192_));
  oai22  g148(.a(new_n192_), .b(new_n161_), .c(new_n111_), .d(new_n187_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n139_), .c(x29), .O(new_n194_));
  nand2  g150(.a(new_n91_), .b(x14), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(x17), .c(x16), .d(x15), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n126_), .c(new_n45_), .O(new_n197_));
  xnor2a g153(.a(x31), .b(x30), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n178_), .c(new_n176_), .d(new_n174_), .O(new_n199_));
  inv1   g155(.a(new_n199_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n172_), .c(new_n170_), .O(new_n201_));
  oai21  g157(.a(new_n201_), .b(new_n197_), .c(x33), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n194_), .c(new_n191_), .O(new_n203_));
  nand3  g159(.a(new_n203_), .b(new_n82_), .c(x00), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n59_), .O(z9));
endmodule
