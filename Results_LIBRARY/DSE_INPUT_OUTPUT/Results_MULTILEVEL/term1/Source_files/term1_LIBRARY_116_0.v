...
module FAU ( 
  ...
  nand3  g055(.a(x28), .b(new_n81_), .c(x00), .O(new_n100_));
  inv1   g056(.a(x28), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x27), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n100_), .c(new_n94_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n82_), .c(x25), .d(x01), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(x00), .c(x26), .O(z4));
  inv1   g061(.a(x29), .O(new_n106_));
  nor2   g062(.a(new_n101_), .b(new_n81_), .O(new_n107_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n95_), .c(new_n82_), .d(new_n46_), .O(new_n119_));
  ...
  nand4  g081(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n125_), .O(new_n126_));
  nor2   g082(.a(new_n59_), .b(new_n62_), .O(new_n127_));
  ...
  aoi21  g087(.a(new_n131_), .b(new_n107_), .c(new_n128_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n126_), .d(new_n124_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x00), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n46_), .O(z7));
  ...
  nand3  g108(.a(new_n152_), .b(new_n137_), .c(x31), .O(new_n153_));
  nand2  g109(.a(x32), .b(x30), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(x30), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g114(.a(x32), .b(new_n114_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  aoi21  g116(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x17), .c(x16), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n150_), .O(new_n163_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n165_), .c(new_n150_), .O(new_n168_));
  ...
  nand2  g128(.a(new_n87_), .b(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x31), .O(new_n174_));
  aoi21  g130(.a(new_n171_), .b(new_n84_), .c(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n170_), .c(new_n168_), .d(new_n166_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n163_), .c(x32), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x00), .O(new_n178_));
  aoi21  g134(.a(new_n160_), .b(new_n157_), .c(new_n178_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n156_), .c(x26), .O(z8));
  inv1   g136(.a(x33), .O(new_n181_));
  nand4  g137(.a(new_n152_), .b(new_n181_), .c(x31), .d(x30), .O(new_n182_));
  nand2  g138(.a(x33), .b(new_n114_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n136_), .c(x29), .O(new_n185_));
  nand4  g141(.a(new_n152_), .b(new_n181_), .c(new_n129_), .d(new_n114_), .O(new_n186_));
  nand2  g142(.a(x33), .b(x30), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand2  g144(.a(new_n171_), .b(new_n84_), .O(new_n189_));
  xnor2a g145(.a(x31), .b(x30), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n173_), .c(new_n189_), .d(new_n170_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n168_), .c(new_n166_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n163_), .c(x33), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(x00), .O(new_n195_));
  aoi21  g151(.a(new_n188_), .b(new_n157_), .c(new_n195_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n185_), .c(x26), .O(z9));
endmodule
