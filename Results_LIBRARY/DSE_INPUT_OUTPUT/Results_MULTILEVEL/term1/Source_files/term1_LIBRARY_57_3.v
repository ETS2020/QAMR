...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n93_), .c(new_n63_), .d(new_n46_), .O(new_n98_));
  ...
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(x32), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x31), .c(new_n102_), .d(x15), .O(new_n140_));
  nand2  g096(.a(x32), .b(x30), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  inv1   g098(.a(new_n137_), .O(new_n143_));
  inv1   g099(.a(x15), .O(new_n144_));
  nand4  g100(.a(x17), .b(x16), .c(new_n144_), .d(x10), .O(new_n145_));
  nand2  g101(.a(new_n50_), .b(x31), .O(new_n146_));
  nor4   g102(.a(new_n146_), .b(new_n145_), .c(new_n143_), .d(x30), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n142_), .c(new_n126_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n94_), .O(new_n149_));
  nor2   g105(.a(new_n125_), .b(new_n94_), .O(new_n150_));
  nand3  g106(.a(new_n139_), .b(x31), .c(x30), .O(new_n151_));
  nand2  g107(.a(x32), .b(new_n102_), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(new_n144_), .c(new_n152_), .O(new_n153_));
  nor4   g109(.a(new_n146_), .b(new_n145_), .c(new_n143_), .d(new_n102_), .O(new_n154_));
  aoi21  g110(.a(new_n153_), .b(new_n46_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n156_));
  ...
  oai21  g119(.a(new_n159_), .b(new_n163_), .c(new_n136_), .O(new_n164_));
  nand2  g120(.a(x18), .b(x12), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n127_), .O(new_n166_));
  inv1   g122(.a(x13), .O(new_n167_));
  nand2  g123(.a(new_n128_), .b(new_n167_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n166_), .c(new_n164_), .d(x31), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x32), .c(new_n46_), .O(new_n172_));
  oai21  g128(.a(new_n155_), .b(new_n150_), .c(new_n172_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n149_), .c(x00), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n49_), .O(z8));
  aoi21  g131(.a(new_n138_), .b(new_n135_), .c(x33), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x31), .c(x30), .d(x15), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n102_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n177_), .c(x26), .O(new_n179_));
  nand3  g135(.a(new_n54_), .b(x31), .c(x30), .O(new_n180_));
  nor3   g136(.a(new_n180_), .b(new_n145_), .c(new_n143_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n179_), .c(new_n126_), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n94_), .O(new_n183_));
  nand4  g139(.a(new_n176_), .b(new_n118_), .c(new_n102_), .d(x15), .O(new_n184_));
  nand2  g140(.a(x33), .b(x30), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand3  g142(.a(new_n54_), .b(new_n118_), .c(new_n102_), .O(new_n187_));
  nor3   g143(.a(new_n187_), .b(new_n145_), .c(new_n143_), .O(new_n188_));
  aoi21  g144(.a(new_n186_), .b(new_n46_), .c(new_n188_), .O(new_n189_));
  ...
  nand4  g148(.a(new_n192_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(x33), .c(new_n46_), .O(new_n194_));
  oai21  g150(.a(new_n189_), .b(new_n150_), .c(new_n194_), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n183_), .c(x00), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n49_), .O(z9));
endmodule
