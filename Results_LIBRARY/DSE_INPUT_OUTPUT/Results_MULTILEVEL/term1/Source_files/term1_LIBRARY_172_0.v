...
module FAU ( 
  ...
  nand3  g134(.a(new_n178_), .b(new_n133_), .c(x29), .O(new_n179_));
  nand4  g135(.a(new_n149_), .b(new_n175_), .c(new_n126_), .d(new_n112_), .O(new_n180_));
