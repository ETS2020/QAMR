...
module FAU ( 
  ...
  inv1   g035(.a(new_n58_), .O(new_n80_));
  ...
  nand3  g076(.a(new_n80_), .b(x01), .c(x00), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  inv1   g078(.a(x25), .O(new_n123_));
  inv1   g079(.a(new_n101_), .O(new_n124_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n122_), .c(new_n120_), .d(new_n116_), .O(z7));
  ...
  nand4  g105(.a(new_n149_), .b(new_n131_), .c(x31), .d(new_n110_), .O(new_n150_));
  ...
  nand2  g111(.a(x32), .b(new_n110_), .O(new_n156_));
  ...
  nand2  g134(.a(x33), .b(new_n110_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n130_), .c(x29), .O(new_n181_));
  nand4  g137(.a(new_n149_), .b(new_n177_), .c(new_n125_), .d(new_n110_), .O(new_n182_));
