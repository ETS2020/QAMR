...
module FAU ( 
  ...
  nor3   g009(.a(x33), .b(x05), .c(x03), .O(new_n54_));
  ...
  nor2   g034(.a(z0), .b(new_n46_), .O(new_n79_));
  ...
  oai21  g046(.a(new_n90_), .b(new_n59_), .c(new_n80_), .O(z3));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n80_), .d(new_n61_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n82_), .c(x25), .d(x01), .O(new_n105_));
  ...
  nand3  g065(.a(new_n100_), .b(new_n109_), .c(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n97_), .c(new_n61_), .d(new_n82_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x25), .c(x01), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n80_), .O(z6));
  nand3  g071(.a(new_n100_), .b(x30), .c(x29), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  nor4   g073(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n84_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand4  g075(.a(new_n100_), .b(new_n119_), .c(x30), .d(x29), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n82_), .c(x25), .O(new_n121_));
  nor4   g077(.a(new_n121_), .b(new_n118_), .c(new_n60_), .d(new_n59_), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n117_), .c(new_n79_), .O(z7));
  nand2  g079(.a(new_n99_), .b(new_n83_), .O(new_n124_));
  ...
  nand4  g098(.a(new_n142_), .b(z0), .c(x31), .d(new_n109_), .O(new_n143_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n82_), .c(x00), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n80_), .O(z8));
  nand4  g125(.a(new_n142_), .b(new_n47_), .c(x31), .d(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n109_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n124_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n142_), .b(new_n47_), .c(new_n119_), .d(new_n109_), .O(new_n174_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n80_), .O(z9));
endmodule
