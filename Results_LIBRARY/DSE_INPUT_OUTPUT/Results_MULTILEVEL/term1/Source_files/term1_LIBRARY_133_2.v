...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n61_), .d(new_n45_), .O(new_n105_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(new_n61_), .d(x25), .O(new_n114_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(z7));
  nand2  g083(.a(new_n101_), .b(new_n80_), .O(new_n128_));
  ...
  oai22  g129(.a(new_n173_), .b(new_n156_), .c(new_n111_), .d(new_n45_), .O(new_n174_));
  nand2  g130(.a(new_n149_), .b(new_n123_), .O(new_n175_));
  nor2   g131(.a(new_n123_), .b(new_n100_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n128_), .c(new_n111_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n45_), .c(new_n175_), .d(new_n111_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  nand4  g136(.a(new_n128_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  oai22  g137(.a(new_n181_), .b(x26), .c(new_n175_), .d(x30), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n144_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(x33), .c(new_n180_), .O(new_n184_));
