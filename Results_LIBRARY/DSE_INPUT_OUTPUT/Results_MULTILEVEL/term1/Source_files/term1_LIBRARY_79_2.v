...
module FAU ( 
  ...
  nand3  g105(.a(new_n149_), .b(x15), .c(x13), .O(new_n150_));
  nor2   g106(.a(x32), .b(new_n130_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(x30), .c(x19), .O(new_n152_));
  oai22  g108(.a(new_n152_), .b(new_n150_), .c(new_n147_), .d(x30), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n45_), .O(new_n154_));
  inv1   g110(.a(x16), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n85_), .c(x12), .O(new_n156_));
  nand3  g112(.a(new_n90_), .b(x17), .c(x14), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n155_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x17), .c(new_n155_), .d(x11), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(x15), .O(new_n161_));
  inv1   g117(.a(x15), .O(new_n162_));
  nor2   g118(.a(new_n90_), .b(new_n85_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x16), .c(new_n162_), .d(x10), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n161_), .c(x32), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x31), .c(x30), .d(x18), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n154_), .c(new_n146_), .O(new_n167_));
  inv1   g123(.a(new_n145_), .O(new_n168_));
  nor2   g124(.a(new_n90_), .b(x18), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n151_), .c(new_n118_), .O(new_n170_));
  oai22  g126(.a(new_n170_), .b(new_n150_), .c(new_n147_), .d(new_n118_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n168_), .c(x29), .O(new_n172_));
  aoi21  g128(.a(new_n90_), .b(x14), .c(new_n45_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x17), .c(x16), .d(x15), .O(new_n174_));
  oai21  g130(.a(new_n148_), .b(new_n162_), .c(new_n90_), .O(new_n175_));
  inv1   g131(.a(x10), .O(new_n176_));
  oai21  g132(.a(new_n148_), .b(new_n176_), .c(new_n162_), .O(new_n177_));
  aoi21  g133(.a(x17), .b(x11), .c(x16), .O(new_n178_));
  oai21  g134(.a(x17), .b(x12), .c(x31), .O(new_n179_));
  ...
  nand3  g138(.a(x16), .b(x15), .c(x13), .O(new_n183_));
  nand3  g139(.a(x31), .b(x19), .c(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(new_n45_), .O(new_n185_));
  and2   g141(.a(new_n185_), .b(new_n182_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n147_), .c(new_n172_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n167_), .c(new_n81_), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n144_), .O(z8));
  inv1   g145(.a(x33), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(x31), .c(x30), .d(x19), .O(new_n191_));
  oai22  g147(.a(new_n191_), .b(new_n150_), .c(new_n190_), .d(x30), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n45_), .O(new_n193_));
  nand2  g149(.a(new_n164_), .b(new_n161_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n190_), .c(x31), .d(x30), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n45_), .c(new_n193_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n168_), .c(x29), .O(new_n197_));
  nand2  g153(.a(x33), .b(x30), .O(new_n198_));
  inv1   g154(.a(new_n150_), .O(new_n199_));
  nor3   g155(.a(x33), .b(x31), .c(x30), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n169_), .c(new_n199_), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n198_), .c(new_n146_), .O(new_n202_));
  nand3  g158(.a(new_n140_), .b(x19), .c(x17), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(new_n183_), .c(new_n45_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n182_), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(x33), .c(new_n202_), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(new_n197_), .O(new_n207_));
  nand3  g163(.a(new_n207_), .b(new_n81_), .c(x00), .O(new_n208_));
