...
module FAU ( 
  ...
  nor3   g050(.a(new_n94_), .b(new_n79_), .c(new_n62_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n45_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n62_), .c(new_n49_), .O(z4));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n99_), .d(new_n45_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n79_), .c(new_n62_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n100_), .c(new_n99_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n62_), .c(new_n49_), .O(z6));
  ...
  nand3  g082(.a(new_n88_), .b(x18), .c(x14), .O(new_n127_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n50_), .c(x31), .d(new_n46_), .O(new_n141_));
  nand2  g097(.a(x32), .b(x30), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n125_), .c(x29), .O(new_n144_));
  nand2  g100(.a(new_n125_), .b(x29), .O(new_n145_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n153_), .c(new_n88_), .O(new_n155_));
  ...
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n120_), .O(new_n162_));
  ...
  oai22  g125(.a(new_n169_), .b(new_n152_), .c(x30), .d(new_n45_), .O(new_n170_));
  aoi21  g126(.a(new_n145_), .b(new_n120_), .c(x30), .O(new_n171_));
  nor2   g127(.a(new_n120_), .b(new_n101_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n125_), .c(new_n46_), .O(new_n173_));
  aoi21  g129(.a(new_n171_), .b(new_n45_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  nand4  g132(.a(new_n145_), .b(new_n120_), .c(new_n46_), .d(new_n45_), .O(new_n177_));
  nand4  g133(.a(new_n125_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n140_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(x33), .c(new_n176_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n49_), .O(z9));
endmodule
