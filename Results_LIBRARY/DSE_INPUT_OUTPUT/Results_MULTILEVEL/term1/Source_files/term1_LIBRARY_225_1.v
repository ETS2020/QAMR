...
module FAU ( 
  ...
  inv1   g048(.a(new_n59_), .O(new_n93_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n93_), .d(new_n45_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x25), .c(x01), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n47_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n93_), .c(new_n45_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n62_), .c(new_n47_), .O(z6));
  ...
  nor2   g073(.a(new_n59_), .b(new_n62_), .O(new_n118_));
  ...
  nand2  g083(.a(new_n96_), .b(new_n81_), .O(new_n128_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(x31), .d(new_n104_), .O(new_n148_));
  ...
  nand2  g109(.a(x32), .b(new_n104_), .O(new_n154_));
  ...
  nand2  g132(.a(x33), .b(new_n104_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n128_), .c(x29), .O(new_n179_));
  nand4  g135(.a(new_n147_), .b(new_n175_), .c(new_n120_), .d(new_n104_), .O(new_n180_));
