...
module FAU ( 
  ...
  oai21  g025(.a(new_n69_), .b(new_n65_), .c(new_n46_), .O(new_n70_));
  inv1   g026(.a(new_n66_), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n62_), .O(new_n72_));
  inv1   g028(.a(new_n72_), .O(new_n73_));
  oai21  g029(.a(new_n73_), .b(new_n65_), .c(new_n45_), .O(new_n74_));
  aoi21  g030(.a(new_n74_), .b(new_n70_), .c(new_n61_), .O(new_n75_));
  xor2a  g031(.a(x07), .b(x04), .O(new_n76_));
  aoi21  g032(.a(new_n46_), .b(x03), .c(new_n45_), .O(new_n77_));
  nand4  g033(.a(new_n57_), .b(new_n46_), .c(x06), .d(x05), .O(new_n78_));
  oai21  g034(.a(new_n77_), .b(new_n71_), .c(new_n78_), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(new_n62_), .O(new_n80_));
  nand2  g036(.a(new_n46_), .b(x01), .O(new_n81_));
  aoi21  g037(.a(new_n81_), .b(x05), .c(x03), .O(new_n82_));
  nand4  g038(.a(new_n49_), .b(x03), .c(new_n54_), .d(x01), .O(new_n83_));
  inv1   g039(.a(new_n83_), .O(new_n84_));
  aoi21  g040(.a(new_n82_), .b(x02), .c(new_n84_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n80_), .O(new_n86_));
  aoi21  g042(.a(new_n86_), .b(new_n76_), .c(new_n75_), .O(new_n87_));
  ...
  nor2   g051(.a(new_n95_), .b(new_n56_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n90_), .c(new_n46_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n89_), .c(new_n62_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n96_), .c(new_n46_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n89_), .c(new_n62_), .O(z4));
  inv1   g057(.a(new_n95_), .O(new_n102_));
  inv1   g058(.a(x29), .O(new_n103_));
  inv1   g059(.a(x28), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n90_), .O(new_n105_));
  nand3  g061(.a(new_n103_), .b(x28), .c(x27), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n63_), .d(new_n46_), .O(new_n108_));
  ...
  nor2   g070(.a(new_n112_), .b(x29), .O(new_n115_));
  aoi21  g071(.a(new_n114_), .b(x29), .c(new_n115_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n95_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n63_), .c(new_n46_), .d(x25), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n62_), .O(z6));
  nand3  g075(.a(new_n105_), .b(x30), .c(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  inv1   g077(.a(new_n93_), .O(new_n122_));
  inv1   g078(.a(new_n94_), .O(new_n123_));
  nor2   g079(.a(new_n92_), .b(new_n91_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n125_));
  nor2   g081(.a(new_n56_), .b(new_n62_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x30), .c(x29), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n105_), .c(new_n89_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n126_), .c(new_n125_), .d(new_n121_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n46_), .O(new_n132_));
  oai21  g088(.a(new_n46_), .b(x05), .c(new_n132_), .O(z7));
  nand2  g089(.a(new_n104_), .b(new_n90_), .O(new_n134_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n50_), .c(x31), .d(new_n112_), .O(new_n153_));
  ...
  nand4  g113(.a(new_n152_), .b(new_n50_), .c(x31), .d(x30), .O(new_n158_));
  ...
  nand2  g134(.a(new_n178_), .b(new_n49_), .O(z8));
  nand4  g135(.a(new_n152_), .b(new_n53_), .c(x31), .d(x30), .O(new_n180_));
  ...
  nand4  g139(.a(new_n152_), .b(new_n53_), .c(new_n127_), .d(new_n112_), .O(new_n184_));
