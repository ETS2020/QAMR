...
module FAU ( 
  ...
  aoi21  g031(.a(new_n75_), .b(new_n68_), .c(new_n45_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(new_n56_), .c(x08), .O(new_n77_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n98_), .c(new_n60_), .d(x30), .O(new_n104_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n98_), .c(new_n60_), .d(x30), .O(new_n110_));
  ...
  nand3  g081(.a(x19), .b(new_n84_), .c(x13), .O(new_n126_));
  nand3  g082(.a(new_n87_), .b(x18), .c(x14), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(new_n81_), .O(new_n128_));
  nand4  g084(.a(x19), .b(x18), .c(new_n81_), .d(x12), .O(new_n129_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n125_), .c(new_n123_), .d(x31), .O(new_n141_));
  aoi21  g097(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(x17), .c(x16), .d(x15), .O(new_n143_));
  nand2  g099(.a(x16), .b(x15), .O(new_n144_));
  nand2  g100(.a(x18), .b(x17), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(new_n87_), .O(new_n146_));
  ...
  aoi21  g109(.a(new_n84_), .b(new_n153_), .c(new_n118_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n146_), .c(new_n143_), .d(new_n125_), .O(new_n157_));
  ...
  nand4  g118(.a(new_n140_), .b(new_n124_), .c(new_n162_), .d(x31), .O(new_n163_));
  nand2  g119(.a(new_n84_), .b(new_n153_), .O(new_n164_));
  nor2   g120(.a(new_n118_), .b(new_n101_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n152_), .d(new_n124_), .O(new_n166_));
  ...
  oai21  g126(.a(new_n163_), .b(new_n101_), .c(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x30), .c(new_n108_), .d(x00), .O(new_n172_));
