...
module FAU ( 
  ...
  aoi21  g072(.a(new_n116_), .b(new_n45_), .c(x26), .O(z6));
  ...
  nand4  g076(.a(new_n120_), .b(new_n89_), .c(new_n86_), .d(x19), .O(new_n121_));
  nand3  g077(.a(new_n61_), .b(new_n45_), .c(x01), .O(new_n122_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n103_), .c(new_n95_), .O(new_n127_));
  ...
  nand3  g088(.a(new_n81_), .b(x18), .c(x14), .O(new_n133_));
  ...
  nand2  g111(.a(new_n81_), .b(x14), .O(new_n156_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n81_), .O(new_n161_));
  ...
  nand4  g127(.a(new_n171_), .b(new_n95_), .c(new_n45_), .d(x00), .O(new_n172_));
  ...
  nand4  g146(.a(new_n190_), .b(new_n95_), .c(new_n45_), .d(x00), .O(new_n191_));
