...
module FAU ( 
  ...
  nand3  g024(.a(new_n68_), .b(new_n57_), .c(new_n56_), .O(new_n69_));
  ...
  nand3  g031(.a(new_n75_), .b(new_n70_), .c(new_n56_), .O(new_n76_));
  ...
  inv1   g037(.a(new_n58_), .O(new_n82_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n82_), .c(new_n56_), .O(new_n92_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n91_), .c(new_n82_), .d(new_n56_), .O(new_n108_));
  ...
  oai21  g070(.a(new_n105_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n82_), .c(new_n80_), .d(x25), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n61_), .c(new_n56_), .O(z6));
  inv1   g076(.a(x00), .O(new_n121_));
  oai21  g077(.a(x31), .b(new_n121_), .c(new_n113_), .O(new_n122_));
  ...
  nand2  g087(.a(new_n104_), .b(new_n81_), .O(new_n132_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n133_), .c(x31), .d(new_n113_), .O(new_n152_));
  ...
  nand2  g113(.a(x32), .b(new_n113_), .O(new_n158_));
  ...
  nand4  g139(.a(new_n151_), .b(new_n179_), .c(new_n127_), .d(new_n113_), .O(new_n184_));
