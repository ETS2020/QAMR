...
module FAU ( 
  ...
  nor3   g044(.a(new_n88_), .b(new_n79_), .c(new_n60_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n87_), .c(new_n80_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n79_), .c(new_n60_), .O(z4));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n93_), .d(new_n80_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n79_), .c(new_n60_), .O(z5));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n80_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n60_), .c(new_n45_), .O(z6));
  ...
  nand3  g100(.a(new_n144_), .b(new_n126_), .c(x31), .O(new_n145_));
  ...
  nand2  g105(.a(x32), .b(new_n102_), .O(new_n150_));
  oai21  g106(.a(new_n145_), .b(new_n102_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n130_), .b(x14), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(x18), .c(x17), .d(x16), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n142_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x15), .O(new_n155_));
  nand2  g111(.a(x18), .b(x17), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n130_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x10), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n142_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n156_), .b(new_n160_), .c(new_n136_), .O(new_n161_));
  aoi21  g117(.a(x18), .b(x12), .c(x17), .O(new_n162_));
  nor2   g118(.a(x18), .b(x13), .O(new_n163_));
  nor3   g119(.a(new_n163_), .b(new_n162_), .c(new_n117_), .O(new_n164_));
  ...
  aoi21  g123(.a(new_n151_), .b(new_n149_), .c(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n148_), .c(new_n124_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n144_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n102_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n125_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n144_), .b(new_n170_), .c(new_n117_), .d(new_n102_), .O(new_n175_));
  nand2  g131(.a(x33), .b(x30), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n149_), .O(new_n178_));
