...
module FAU ( 
  ...
  nand3  g044(.a(new_n88_), .b(new_n82_), .c(x25), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(new_n46_), .c(new_n45_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(x25), .O(new_n92_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n60_), .d(new_n46_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n94_), .c(new_n45_), .O(z5));
  ...
  nand4  g064(.a(new_n108_), .b(new_n60_), .c(new_n46_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n45_), .O(z6));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n98_), .c(new_n94_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n116_), .c(new_n112_), .d(new_n60_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n46_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x01), .O(z7));
  inv1   g079(.a(new_n47_), .O(new_n124_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n117_), .O(new_n166_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n124_), .O(z8));
  ...
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n117_), .d(new_n103_), .O(new_n177_));
  ...
  nand2  g145(.a(new_n189_), .b(new_n124_), .O(z9));
endmodule
