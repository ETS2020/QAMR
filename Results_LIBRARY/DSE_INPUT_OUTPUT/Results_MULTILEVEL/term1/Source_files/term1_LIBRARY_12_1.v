...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n62_), .c(new_n47_), .O(z3));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n98_), .c(new_n90_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n119_), .c(new_n118_), .d(new_n114_), .O(new_n124_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(x31), .d(new_n105_), .O(new_n148_));
  ...
  nand2  g109(.a(x32), .b(new_n105_), .O(new_n154_));
  ...
  nand4  g131(.a(new_n147_), .b(new_n175_), .c(x31), .d(x30), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n105_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n128_), .c(x29), .O(new_n179_));
  nand4  g135(.a(new_n147_), .b(new_n175_), .c(new_n120_), .d(new_n105_), .O(new_n180_));
