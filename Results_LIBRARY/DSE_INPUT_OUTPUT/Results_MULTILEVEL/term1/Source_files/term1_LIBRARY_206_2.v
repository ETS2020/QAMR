...
module FAU ( 
  ...
  aoi21  g053(.a(new_n97_), .b(new_n95_), .c(x18), .O(new_n98_));
  nand2  g054(.a(new_n89_), .b(x28), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(x27), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n98_), .c(new_n45_), .O(new_n101_));
  ...
  oai21  g062(.a(new_n106_), .b(new_n60_), .c(new_n47_), .O(z4));
  oai21  g063(.a(new_n96_), .b(new_n82_), .c(x29), .O(new_n108_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n60_), .c(new_n47_), .O(z5));
  nor2   g069(.a(new_n96_), .b(new_n82_), .O(new_n114_));
  oai21  g070(.a(x29), .b(x23), .c(new_n89_), .O(new_n115_));
  inv1   g071(.a(x18), .O(new_n116_));
  nand3  g072(.a(x29), .b(new_n45_), .c(new_n116_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(new_n118_));
  nor3   g074(.a(new_n90_), .b(new_n87_), .c(new_n86_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n85_), .c(x29), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(x30), .O(new_n121_));
  inv1   g077(.a(x30), .O(new_n122_));
  inv1   g078(.a(new_n84_), .O(new_n123_));
  nor2   g079(.a(new_n83_), .b(new_n116_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n88_), .c(new_n123_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n122_), .c(x29), .d(x28), .O(new_n126_));
  ...
  oai21  g087(.a(x31), .b(x23), .c(new_n122_), .O(new_n132_));
  nand3  g088(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x31), .O(new_n134_));
  inv1   g090(.a(new_n86_), .O(new_n135_));
  inv1   g091(.a(new_n87_), .O(new_n136_));
  inv1   g092(.a(new_n90_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n85_), .O(new_n138_));
  nor2   g094(.a(new_n61_), .b(new_n60_), .O(new_n139_));
  inv1   g095(.a(x31), .O(new_n140_));
  nand4  g096(.a(new_n114_), .b(new_n140_), .c(x30), .d(x29), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n139_), .c(new_n81_), .d(x25), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n138_), .c(new_n134_), .d(new_n132_), .O(z7));
  nand2  g100(.a(new_n96_), .b(new_n82_), .O(new_n145_));
  inv1   g101(.a(x32), .O(new_n146_));
  inv1   g102(.a(x17), .O(new_n147_));
  nand3  g103(.a(x19), .b(new_n116_), .c(x13), .O(new_n148_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n146_), .c(x31), .d(new_n122_), .O(new_n164_));
  nand2  g120(.a(x32), .b(x30), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n145_), .c(x29), .O(new_n167_));
  nand2  g123(.a(new_n145_), .b(x29), .O(new_n168_));
  nand4  g124(.a(new_n163_), .b(new_n146_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x32), .b(new_n122_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n149_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x18), .c(x17), .d(x16), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n161_), .O(new_n175_));
  nand2  g131(.a(x16), .b(x15), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n176_), .c(new_n149_), .O(new_n178_));
  nand2  g134(.a(x16), .b(x10), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n177_), .c(new_n161_), .O(new_n180_));
  inv1   g136(.a(x11), .O(new_n181_));
  oai21  g137(.a(new_n177_), .b(new_n181_), .c(new_n155_), .O(new_n182_));
  aoi21  g138(.a(x18), .b(x12), .c(x17), .O(new_n183_));
  nor2   g139(.a(x18), .b(x13), .O(new_n184_));
  nor3   g140(.a(new_n184_), .b(new_n183_), .c(new_n140_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n182_), .c(new_n180_), .d(new_n178_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n175_), .c(x32), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n172_), .c(new_n167_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n81_), .c(x00), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n47_), .O(z8));
  inv1   g146(.a(x33), .O(new_n191_));
  nand4  g147(.a(new_n163_), .b(new_n191_), .c(x31), .d(x30), .O(new_n192_));
  nand2  g148(.a(x33), .b(new_n122_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n145_), .c(x29), .O(new_n195_));
  nand4  g151(.a(new_n163_), .b(new_n191_), .c(new_n140_), .d(new_n122_), .O(new_n196_));
  ...
  inv1   g155(.a(new_n183_), .O(new_n200_));
  ...
  nand4  g160(.a(new_n204_), .b(new_n182_), .c(new_n180_), .d(new_n178_), .O(new_n205_));
  oai21  g161(.a(new_n205_), .b(new_n175_), .c(x33), .O(new_n206_));
