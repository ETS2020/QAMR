...
module FAU ( 
  ...
  nor2   g055(.a(new_n95_), .b(new_n79_), .O(new_n100_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n88_), .c(new_n80_), .d(new_n78_), .O(new_n113_));
  ...
  nand3  g078(.a(new_n80_), .b(x01), .c(x00), .O(new_n123_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n132_), .c(x31), .d(new_n110_), .O(new_n151_));
  ...
  nand4  g138(.a(new_n150_), .b(new_n178_), .c(new_n126_), .d(new_n110_), .O(new_n183_));
