...
module FAU ( 
  ...
  oai21  g020(.a(new_n64_), .b(x03), .c(x06), .O(new_n65_));
  inv1   g021(.a(x06), .O(new_n66_));
  oai21  g022(.a(new_n66_), .b(x02), .c(x05), .O(new_n67_));
  oai22  g023(.a(new_n67_), .b(x03), .c(new_n65_), .d(x02), .O(new_n68_));
  ...
  nor2   g029(.a(new_n64_), .b(x03), .O(new_n74_));
  nor2   g030(.a(new_n66_), .b(x02), .O(new_n75_));
  nand3  g031(.a(new_n61_), .b(x06), .c(x05), .O(new_n76_));
  oai21  g032(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n45_), .c(new_n63_), .O(new_n78_));
  aoi21  g034(.a(new_n78_), .b(new_n73_), .c(new_n71_), .O(new_n79_));
  aoi21  g035(.a(new_n70_), .b(new_n59_), .c(new_n79_), .O(new_n80_));
  nor3   g036(.a(new_n80_), .b(x09), .c(new_n58_), .O(z2));
  ...
  oai21  g051(.a(new_n95_), .b(new_n63_), .c(new_n47_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n82_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n63_), .c(new_n47_), .O(z4));
  ...
  nor2   g075(.a(new_n60_), .b(new_n63_), .O(new_n120_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(new_n82_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n121_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(z7));
  ...
  nor3   g098(.a(new_n142_), .b(new_n141_), .c(new_n123_), .O(new_n143_));
  ...
  nand2  g101(.a(new_n102_), .b(new_n83_), .O(new_n146_));
  ...
  nand3  g110(.a(new_n146_), .b(new_n45_), .c(x29), .O(new_n155_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n82_), .c(x00), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(z8));
  nor2   g131(.a(new_n142_), .b(new_n141_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n140_), .c(new_n137_), .d(new_n135_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n132_), .c(new_n47_), .O(new_n178_));
  nand2  g134(.a(new_n149_), .b(new_n123_), .O(new_n179_));
  nor2   g135(.a(new_n123_), .b(new_n101_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n146_), .c(new_n45_), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(x01), .c(new_n179_), .d(new_n45_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  inv1   g140(.a(x33), .O(new_n185_));
  nand4  g141(.a(new_n146_), .b(x31), .c(x30), .d(x29), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n63_), .c(new_n179_), .d(x30), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n171_), .c(new_n185_), .O(new_n188_));
