...
module FAU ( 
  ...
  nor3   g064(.a(new_n108_), .b(new_n98_), .c(new_n61_), .O(z5));
  nand3  g065(.a(new_n46_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n105_), .b(new_n46_), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x29), .c(new_n45_), .O(new_n112_));
  oai21  g068(.a(new_n46_), .b(x29), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n102_), .c(new_n63_), .d(x25), .O(new_n114_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n105_), .c(new_n98_), .O(new_n125_));
  ...
  nand2  g084(.a(new_n104_), .b(new_n82_), .O(new_n129_));
  inv1   g085(.a(x32), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n87_), .c(x13), .O(new_n131_));
  nand3  g087(.a(new_n90_), .b(x18), .c(x14), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n84_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n134_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n130_), .c(x31), .d(new_n46_), .O(new_n146_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n90_), .O(new_n160_));
  ...
  nand3  g132(.a(new_n176_), .b(new_n129_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n145_), .b(new_n173_), .c(new_n122_), .d(new_n46_), .O(new_n178_));
