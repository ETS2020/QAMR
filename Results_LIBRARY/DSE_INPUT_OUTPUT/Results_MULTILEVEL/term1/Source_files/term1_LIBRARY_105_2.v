...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n59_), .c(new_n47_), .O(z4));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n90_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n59_), .c(new_n47_), .O(z6));
  nor4   g071(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n116_));
  nand4  g072(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n116_), .c(new_n47_), .O(new_n118_));
  nand2  g074(.a(x30), .b(x29), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n100_), .c(x31), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n118_), .O(z7));
  ...
  oai21  g094(.a(new_n138_), .b(new_n126_), .c(new_n47_), .O(new_n139_));
  inv1   g095(.a(x28), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n81_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(x31), .c(x30), .d(x29), .O(new_n142_));
  nand3  g098(.a(new_n141_), .b(x31), .c(x29), .O(new_n143_));
  ...
  nand3  g103(.a(new_n141_), .b(new_n45_), .c(x29), .O(new_n148_));
  nand2  g104(.a(new_n141_), .b(x29), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x30), .O(new_n150_));
  ...
  nand2  g126(.a(new_n149_), .b(new_n97_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n45_), .O(new_n172_));
  nand2  g128(.a(new_n149_), .b(x31), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n172_), .c(new_n139_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  inv1   g131(.a(x33), .O(new_n176_));
  oai21  g132(.a(new_n171_), .b(x30), .c(new_n142_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n166_), .c(new_n176_), .O(new_n178_));
