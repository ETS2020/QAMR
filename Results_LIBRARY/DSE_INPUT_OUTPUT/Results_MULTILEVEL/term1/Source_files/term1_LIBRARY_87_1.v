...
module FAU ( 
  ...
  oai21  g127(.a(new_n171_), .b(new_n154_), .c(new_n46_), .O(new_n172_));
  ...
  aoi22  g131(.a(new_n175_), .b(x25), .c(new_n173_), .d(new_n102_), .O(new_n176_));
  ...
  oai22  g135(.a(new_n179_), .b(new_n45_), .c(new_n173_), .d(x30), .O(new_n180_));
