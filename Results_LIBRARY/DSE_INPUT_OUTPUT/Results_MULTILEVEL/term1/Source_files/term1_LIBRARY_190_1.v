...
module FAU ( 
  ...
  nand3  g032(.a(new_n76_), .b(new_n45_), .c(new_n62_), .O(new_n77_));
  ...
  inv1   g036(.a(new_n46_), .O(new_n81_));
  ...
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n92_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n62_), .c(new_n81_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n82_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n62_), .c(new_n81_), .O(z4));
  inv1   g055(.a(new_n59_), .O(new_n100_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n92_), .c(new_n100_), .d(new_n82_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n81_), .O(z5));
  nand3  g065(.a(new_n45_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n103_), .b(new_n45_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x29), .O(new_n112_));
  nand2  g068(.a(x30), .b(new_n101_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n93_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n82_), .d(x25), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n62_), .O(z6));
  oai21  g072(.a(x31), .b(new_n62_), .c(new_n45_), .O(new_n117_));
  nand3  g073(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n120_));
  inv1   g076(.a(x25), .O(new_n121_));
  nor2   g077(.a(new_n59_), .b(new_n121_), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x30), .c(x29), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n103_), .c(x26), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n122_), .c(new_n120_), .d(new_n119_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x01), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n117_), .O(z7));
  inv1   g085(.a(x15), .O(new_n130_));
  inv1   g086(.a(x19), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x14), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(x18), .c(x17), .d(x16), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g090(.a(x16), .b(x15), .O(new_n135_));
  nand2  g091(.a(x18), .b(x17), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n135_), .c(new_n131_), .O(new_n137_));
  nand2  g093(.a(x16), .b(x10), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(new_n130_), .O(new_n139_));
  inv1   g095(.a(x11), .O(new_n140_));
  inv1   g096(.a(x16), .O(new_n141_));
  oai21  g097(.a(new_n136_), .b(new_n140_), .c(new_n141_), .O(new_n142_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n142_), .c(new_n139_), .d(new_n137_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n134_), .c(new_n81_), .O(new_n147_));
  nand2  g103(.a(new_n102_), .b(new_n83_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x30), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n101_), .O(new_n150_));
  nand2  g106(.a(new_n148_), .b(x29), .O(new_n151_));
  aoi22  g107(.a(new_n151_), .b(new_n45_), .c(new_n150_), .d(x01), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n147_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x32), .O(new_n154_));
  inv1   g110(.a(x32), .O(new_n155_));
  nand3  g111(.a(new_n151_), .b(x30), .c(x01), .O(new_n156_));
  nand3  g112(.a(new_n148_), .b(new_n45_), .c(x29), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  inv1   g114(.a(x17), .O(new_n159_));
  inv1   g115(.a(x18), .O(new_n160_));
  nand3  g116(.a(x19), .b(new_n160_), .c(x13), .O(new_n161_));
  nand3  g117(.a(new_n131_), .b(x18), .c(x14), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n159_), .O(new_n163_));
  nand4  g119(.a(x19), .b(x18), .c(new_n159_), .d(x12), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n163_), .c(x16), .O(new_n166_));
  nand3  g122(.a(x19), .b(x18), .c(x17), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n141_), .c(x11), .O(new_n169_));
  ...
  nand4  g129(.a(new_n173_), .b(new_n158_), .c(new_n155_), .d(x31), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n154_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n82_), .c(x00), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(z8));
  nor2   g133(.a(new_n144_), .b(new_n143_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n142_), .c(new_n139_), .d(new_n137_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n134_), .c(new_n81_), .O(new_n180_));
  nand2  g136(.a(new_n151_), .b(new_n123_), .O(new_n181_));
  nor2   g137(.a(new_n123_), .b(new_n101_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n148_), .c(new_n45_), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(x01), .c(new_n181_), .d(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  inv1   g142(.a(x33), .O(new_n187_));
  nand4  g143(.a(new_n148_), .b(x31), .c(x30), .d(x29), .O(new_n188_));
  oai22  g144(.a(new_n188_), .b(new_n62_), .c(new_n181_), .d(x30), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n173_), .c(new_n187_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n82_), .c(x00), .O(new_n192_));
