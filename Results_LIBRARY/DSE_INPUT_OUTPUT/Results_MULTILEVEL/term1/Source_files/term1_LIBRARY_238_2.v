...
module FAU ( 
  ...
  aoi21  g001(.a(new_n45_), .b(x27), .c(x32), .O(z0));
  nand2  g002(.a(new_n45_), .b(x27), .O(new_n47_));
  ...
  nand4  g031(.a(new_n75_), .b(new_n47_), .c(new_n59_), .d(x08), .O(new_n76_));
  ...
  nor2   g048(.a(new_n92_), .b(new_n54_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n80_), .c(new_n79_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n78_), .c(new_n61_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n79_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n61_), .c(new_n47_), .O(z4));
  inv1   g054(.a(new_n54_), .O(new_n99_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n99_), .d(new_n79_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n47_), .O(z5));
  oai21  g065(.a(new_n101_), .b(new_n103_), .c(x30), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n104_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n100_), .c(new_n99_), .d(new_n79_), .O(new_n112_));
  ...
  nand2  g074(.a(new_n118_), .b(x27), .O(new_n119_));
  nand2  g075(.a(x30), .b(x29), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n101_), .c(x31), .O(new_n121_));
  inv1   g077(.a(new_n81_), .O(new_n122_));
  nand4  g078(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n99_), .b(new_n79_), .c(x25), .d(x01), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n123_), .c(new_n121_), .d(new_n119_), .O(z7));
  nand4  g082(.a(x32), .b(x29), .c(new_n79_), .d(x00), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x30), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x27), .O(new_n129_));
  nor2   g085(.a(x28), .b(x27), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n103_), .c(x30), .O(new_n131_));
  nand3  g087(.a(new_n45_), .b(x29), .c(x28), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n85_), .c(x13), .O(new_n134_));
  nand3  g090(.a(new_n88_), .b(x18), .c(x14), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n134_), .c(new_n82_), .O(new_n136_));
  nand4  g092(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n137_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(new_n48_), .d(x31), .O(new_n149_));
  nand2  g105(.a(new_n88_), .b(x14), .O(new_n150_));
  ...
  oai21  g109(.a(new_n103_), .b(new_n153_), .c(new_n45_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x15), .O(new_n155_));
  nand2  g111(.a(x18), .b(x17), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n88_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x10), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n146_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n156_), .b(new_n160_), .c(new_n140_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  aoi21  g118(.a(x18), .b(x12), .c(x17), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  nand2  g120(.a(new_n85_), .b(new_n164_), .O(new_n165_));
  nand3  g121(.a(x30), .b(x29), .c(x28), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(x31), .O(new_n167_));
  nor3   g123(.a(new_n167_), .b(new_n163_), .c(new_n162_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n152_), .c(x32), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n149_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n79_), .c(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n129_), .O(z8));
  aoi21  g129(.a(new_n85_), .b(new_n164_), .c(new_n163_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n152_), .c(new_n47_), .O(new_n176_));
  aoi21  g132(.a(x29), .b(x28), .c(x31), .O(new_n177_));
  nand2  g133(.a(x30), .b(new_n153_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(x30), .c(new_n178_), .O(new_n179_));
  aoi21  g135(.a(x31), .b(x29), .c(new_n45_), .O(new_n180_));
  aoi21  g136(.a(new_n179_), .b(new_n80_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n176_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  aoi21  g139(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n184_));
  inv1   g140(.a(new_n147_), .O(new_n185_));
  nand3  g141(.a(new_n177_), .b(new_n45_), .c(new_n80_), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nor4   g143(.a(new_n130_), .b(new_n116_), .c(new_n45_), .d(new_n103_), .O(new_n188_));
  oai22  g144(.a(new_n188_), .b(new_n187_), .c(new_n185_), .d(new_n184_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(x33), .c(new_n183_), .O(new_n190_));
