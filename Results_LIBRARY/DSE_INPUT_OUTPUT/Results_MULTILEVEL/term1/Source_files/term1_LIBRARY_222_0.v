...
module FAU ( 
  ...
  nand2  g011(.a(new_n53_), .b(new_n52_), .O(new_n56_));
  nand2  g012(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand2  g013(.a(new_n57_), .b(new_n51_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n50_), .c(new_n47_), .O(z1));
  inv1   g015(.a(x08), .O(new_n60_));
  xor2a  g016(.a(x07), .b(x04), .O(new_n61_));
  nand2  g017(.a(new_n57_), .b(x01), .O(new_n62_));
  ...
  nand3  g024(.a(new_n68_), .b(x30), .c(new_n63_), .O(new_n69_));
  aoi21  g025(.a(new_n69_), .b(new_n62_), .c(new_n61_), .O(new_n70_));
  xnor2a g026(.a(x07), .b(x04), .O(new_n71_));
  nand2  g027(.a(new_n49_), .b(x01), .O(new_n72_));
  nor2   g028(.a(new_n64_), .b(x03), .O(new_n73_));
  nor2   g029(.a(new_n66_), .b(x02), .O(new_n74_));
  nand2  g030(.a(x06), .b(x05), .O(new_n75_));
  oai22  g031(.a(new_n75_), .b(new_n56_), .c(new_n74_), .d(new_n73_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(x30), .c(new_n63_), .O(new_n77_));
  aoi21  g033(.a(new_n77_), .b(new_n72_), .c(new_n71_), .O(new_n78_));
  nor2   g034(.a(new_n78_), .b(new_n70_), .O(new_n79_));
  nor3   g035(.a(new_n79_), .b(x09), .c(new_n60_), .O(z2));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n55_), .d(new_n82_), .O(new_n101_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n55_), .c(new_n82_), .d(x25), .O(new_n111_));
  ...
  nand3  g072(.a(new_n98_), .b(x30), .c(x29), .O(new_n117_));
  ...
  nor2   g078(.a(x26), .b(new_n81_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n122_), .c(new_n118_), .d(new_n55_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x01), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n116_), .O(z7));
  ...
  nand2  g100(.a(new_n97_), .b(new_n83_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x29), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n105_), .c(x01), .O(new_n147_));
  ...
  nand4  g106(.a(new_n145_), .b(new_n105_), .c(x29), .d(x01), .O(new_n151_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n131_), .c(new_n47_), .O(new_n175_));
  aoi21  g131(.a(new_n146_), .b(new_n113_), .c(x30), .O(new_n176_));
  nor2   g132(.a(new_n113_), .b(new_n96_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n145_), .c(new_n105_), .O(new_n178_));
  ...
  nand4  g137(.a(new_n146_), .b(new_n113_), .c(new_n105_), .d(x01), .O(new_n182_));
  nand4  g138(.a(new_n145_), .b(x31), .c(x30), .d(x29), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n168_), .c(new_n51_), .O(new_n185_));
