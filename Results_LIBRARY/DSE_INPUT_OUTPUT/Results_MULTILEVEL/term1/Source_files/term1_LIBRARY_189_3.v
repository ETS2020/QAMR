...
module FAU ( 
  ...
  nand3  g103(.a(x16), .b(new_n147_), .c(x10), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nor2   g105(.a(new_n87_), .b(new_n84_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n117_), .d(x19), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n134_), .c(x31), .O(new_n153_));
  ...
  nor2   g113(.a(new_n140_), .b(new_n138_), .O(new_n158_));
  inv1   g114(.a(new_n142_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n147_), .c(x10), .O(new_n160_));
  ...
  nor2   g120(.a(x19), .b(new_n164_), .O(new_n165_));
  aoi21  g121(.a(new_n117_), .b(new_n135_), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x18), .c(x17), .d(x15), .O(new_n167_));
  nand3  g123(.a(new_n150_), .b(x16), .c(x15), .O(new_n168_));
  nand3  g124(.a(new_n150_), .b(x16), .c(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n147_), .O(new_n170_));
  nand3  g126(.a(x18), .b(x16), .c(x12), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n84_), .O(new_n172_));
  inv1   g128(.a(x13), .O(new_n173_));
  oai21  g129(.a(new_n135_), .b(new_n173_), .c(new_n87_), .O(new_n174_));
  nand2  g130(.a(new_n117_), .b(x11), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n135_), .c(new_n127_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n174_), .c(new_n172_), .d(new_n170_), .O(new_n177_));
  aoi21  g133(.a(new_n168_), .b(new_n90_), .c(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n167_), .c(new_n134_), .O(new_n179_));
  aoi21  g135(.a(new_n163_), .b(new_n157_), .c(new_n179_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n156_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n79_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n45_), .O(z8));
  inv1   g139(.a(x00), .O(new_n184_));
  aoi21  g140(.a(new_n150_), .b(x15), .c(x19), .O(new_n185_));
  nand2  g141(.a(new_n150_), .b(x10), .O(new_n186_));
  ...
  nand2  g145(.a(new_n87_), .b(new_n173_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n189_), .c(new_n187_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n185_), .c(new_n45_), .O(new_n192_));
  nand2  g148(.a(x30), .b(new_n114_), .O(new_n193_));
  nand2  g149(.a(new_n117_), .b(x16), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n193_), .c(new_n165_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(x18), .c(x17), .d(x15), .O(new_n196_));
  nand4  g152(.a(x19), .b(x18), .c(x17), .d(x15), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n135_), .c(x31), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n157_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n117_), .O(new_n200_));
  nand2  g156(.a(x31), .b(x29), .O(new_n201_));
  oai21  g157(.a(new_n201_), .b(new_n132_), .c(x30), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(x16), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n114_), .O(new_n204_));
  nand4  g160(.a(new_n204_), .b(new_n200_), .c(new_n196_), .d(new_n192_), .O(new_n205_));
  and2   g161(.a(new_n205_), .b(x33), .O(new_n206_));
  nand2  g162(.a(new_n137_), .b(new_n136_), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(x17), .O(new_n208_));
  nand2  g164(.a(new_n139_), .b(new_n208_), .O(new_n209_));
  aoi21  g165(.a(new_n209_), .b(x16), .c(new_n143_), .O(new_n210_));
  oai22  g166(.a(new_n210_), .b(new_n147_), .c(new_n148_), .d(new_n142_), .O(new_n211_));
  nand4  g167(.a(new_n211_), .b(new_n157_), .c(new_n127_), .d(new_n117_), .O(new_n212_));
  nand4  g168(.a(new_n161_), .b(new_n133_), .c(x31), .d(x30), .O(new_n213_));
  inv1   g169(.a(new_n213_), .O(new_n214_));
  nand4  g170(.a(new_n214_), .b(x29), .c(x16), .d(new_n114_), .O(new_n215_));
  aoi21  g171(.a(new_n215_), .b(new_n212_), .c(x33), .O(new_n216_));
  oai21  g172(.a(new_n216_), .b(new_n206_), .c(new_n79_), .O(new_n217_));
  nor2   g173(.a(new_n217_), .b(new_n184_), .O(z9));
endmodule
