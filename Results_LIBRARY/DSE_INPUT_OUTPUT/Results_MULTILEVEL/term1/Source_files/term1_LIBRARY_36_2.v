...
module FAU ( 
  ...
  nor3   g049(.a(new_n93_), .b(new_n78_), .c(new_n61_), .O(z3));
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n98_), .d(new_n45_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n78_), .c(new_n61_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n99_), .c(new_n98_), .d(x25), .O(new_n112_));
  ...
  nor2   g078(.a(new_n122_), .b(new_n78_), .O(new_n123_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n49_), .c(x31), .d(new_n109_), .O(new_n141_));
  ...
  nand2  g102(.a(x32), .b(new_n109_), .O(new_n147_));
  ...
  oai22  g125(.a(new_n169_), .b(new_n152_), .c(new_n109_), .d(new_n45_), .O(new_n170_));
  nand2  g126(.a(new_n145_), .b(new_n120_), .O(new_n171_));
  nor2   g127(.a(new_n120_), .b(new_n100_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n125_), .c(new_n109_), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(new_n45_), .c(new_n171_), .d(new_n109_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  nand4  g132(.a(new_n125_), .b(x31), .c(x30), .d(x29), .O(new_n177_));
