...
module FAU ( 
  ...
  nor2   g063(.a(new_n107_), .b(new_n61_), .O(z6));
  ...
  nand4  g123(.a(new_n140_), .b(new_n53_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n117_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n122_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n140_), .b(new_n53_), .c(new_n117_), .d(new_n101_), .O(new_n172_));
  ...
  nand4  g136(.a(new_n180_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n152_), .c(x33), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n175_), .c(new_n171_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n45_), .c(x00), .O(new_n184_));
