...
module FAU ( 
  ...
  nand3  g067(.a(new_n111_), .b(x30), .c(x01), .O(new_n112_));
  ...
  oai21  g072(.a(new_n116_), .b(new_n80_), .c(new_n46_), .O(z6));
  nand3  g073(.a(new_n104_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n95_), .b(new_n92_), .c(new_n89_), .d(new_n86_), .O(new_n120_));
  ...
  nand3  g085(.a(x19), .b(new_n90_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n93_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n87_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n87_), .d(x12), .O(new_n133_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n113_), .O(new_n145_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n93_), .O(new_n159_));
  ...
  nand2  g129(.a(x33), .b(new_n113_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n128_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n144_), .b(new_n172_), .c(new_n123_), .d(new_n113_), .O(new_n177_));
