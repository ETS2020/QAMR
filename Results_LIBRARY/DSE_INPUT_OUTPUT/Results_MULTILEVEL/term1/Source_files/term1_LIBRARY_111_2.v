...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n90_), .c(new_n62_), .d(new_n48_), .O(new_n96_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n90_), .c(new_n62_), .d(new_n80_), .O(new_n105_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n62_), .c(new_n80_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n61_), .c(new_n48_), .O(z6));
  oai21  g072(.a(x31), .b(x00), .c(new_n109_), .O(new_n117_));
  ...
  nor2   g076(.a(new_n56_), .b(new_n61_), .O(new_n121_));
  ...
  nand2  g082(.a(new_n101_), .b(new_n81_), .O(new_n127_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(new_n49_), .d(x31), .O(new_n147_));
  aoi21  g103(.a(new_n132_), .b(x14), .c(new_n130_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x17), .c(x16), .d(x15), .O(new_n149_));
  nand2  g105(.a(x16), .b(x15), .O(new_n150_));
  nand2  g106(.a(x18), .b(x17), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n150_), .c(new_n132_), .O(new_n152_));
  ...
  aoi21  g115(.a(new_n130_), .b(new_n159_), .c(new_n122_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n152_), .c(new_n149_), .d(new_n128_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x32), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n147_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n80_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(x30), .c(new_n45_), .O(z8));
  nand4  g123(.a(new_n146_), .b(new_n127_), .c(new_n53_), .d(x31), .O(new_n168_));
  nand2  g124(.a(new_n130_), .b(new_n159_), .O(new_n169_));
  nor2   g125(.a(new_n122_), .b(new_n100_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n169_), .c(new_n158_), .d(new_n127_), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  and2   g128(.a(new_n172_), .b(new_n156_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n154_), .c(new_n152_), .d(new_n149_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  oai21  g131(.a(new_n168_), .b(new_n100_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n80_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(x30), .c(new_n45_), .O(z9));
endmodule
