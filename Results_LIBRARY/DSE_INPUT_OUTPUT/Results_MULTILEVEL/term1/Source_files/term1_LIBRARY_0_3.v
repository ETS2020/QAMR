...
module FAU ( 
  ...
  nor3   g054(.a(new_n98_), .b(new_n78_), .c(new_n57_), .O(z5));
  ...
  nand4  g061(.a(new_n105_), .b(new_n59_), .c(new_n79_), .d(x25), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n57_), .c(new_n45_), .O(z6));
  nand3  g063(.a(new_n95_), .b(x30), .c(x29), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x31), .O(new_n109_));
  inv1   g065(.a(new_n83_), .O(new_n110_));
  inv1   g066(.a(new_n84_), .O(new_n111_));
  nor2   g067(.a(new_n82_), .b(new_n81_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nor2   g069(.a(new_n58_), .b(new_n57_), .O(new_n114_));
  inv1   g070(.a(new_n95_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x30), .c(x29), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n115_), .c(new_n79_), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n78_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n114_), .c(new_n113_), .d(new_n109_), .O(z7));
  nand2  g076(.a(new_n94_), .b(new_n80_), .O(new_n121_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n122_), .c(x31), .d(new_n100_), .O(new_n141_));
  ...
  nand2  g102(.a(x32), .b(new_n100_), .O(new_n147_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n126_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x10), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n138_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n156_), .b(new_n160_), .c(new_n132_), .O(new_n161_));
  ...
  inv1   g125(.a(x00), .O(new_n170_));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n140_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  oai21  g128(.a(new_n171_), .b(x30), .c(new_n172_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n121_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n140_), .b(new_n171_), .c(new_n116_), .d(new_n100_), .O(new_n175_));
  oai21  g131(.a(new_n171_), .b(new_n100_), .c(new_n175_), .O(new_n176_));
  inv1   g132(.a(new_n162_), .O(new_n177_));
  inv1   g133(.a(new_n163_), .O(new_n178_));
  xnor2a g134(.a(x31), .b(x30), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n178_), .c(new_n177_), .d(new_n161_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n159_), .c(new_n157_), .d(new_n153_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n79_), .O(new_n184_));
  aoi21  g140(.a(new_n176_), .b(new_n145_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n174_), .c(new_n170_), .O(z9));
endmodule
