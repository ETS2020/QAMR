...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n60_), .d(new_n79_), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n96_), .c(new_n46_), .O(z6));
  ...
  aoi21  g132(.a(new_n176_), .b(new_n128_), .c(new_n112_), .O(new_n177_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n123_), .c(new_n112_), .d(x01), .O(new_n181_));
