...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n57_), .c(new_n45_), .O(z4));
  ...
  nor3   g054(.a(new_n98_), .b(new_n91_), .c(new_n57_), .O(z5));
  ...
  inv1   g065(.a(new_n82_), .O(new_n110_));
  ...
  nand2  g077(.a(new_n94_), .b(new_n79_), .O(new_n122_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n123_), .c(x31), .O(new_n142_));
  ...
  oai21  g103(.a(new_n142_), .b(new_n100_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n127_), .b(x14), .O(new_n149_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n127_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(new_n139_), .O(new_n156_));
  inv1   g112(.a(x11), .O(new_n157_));
  oai21  g113(.a(new_n153_), .b(new_n157_), .c(new_n133_), .O(new_n158_));
  ...
  nand2  g119(.a(new_n163_), .b(new_n78_), .O(new_n164_));
  aoi21  g120(.a(new_n148_), .b(new_n146_), .c(new_n164_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n145_), .c(new_n121_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n141_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n100_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n122_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n141_), .b(new_n167_), .c(new_n116_), .d(new_n100_), .O(new_n172_));
