...
module FAU ( 
  ...
  nand4  g063(.a(new_n107_), .b(new_n94_), .c(new_n62_), .d(new_n45_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n102_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z5));
  nor4   g067(.a(new_n95_), .b(x30), .c(new_n105_), .d(new_n103_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(x27), .c(new_n102_), .d(x25), .O(new_n113_));
  ...
  nand4  g073(.a(new_n62_), .b(new_n117_), .c(x25), .d(x01), .O(new_n118_));
  aoi21  g074(.a(new_n116_), .b(new_n93_), .c(new_n118_), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(x30), .c(new_n102_), .O(z7));
  inv1   g076(.a(x32), .O(new_n121_));
  nand2  g077(.a(new_n103_), .b(new_n81_), .O(new_n122_));
  nand3  g078(.a(x19), .b(new_n88_), .c(x13), .O(new_n123_));
  nand3  g079(.a(new_n91_), .b(x18), .c(x14), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n123_), .c(new_n85_), .O(new_n125_));
  nand4  g081(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n126_));
  ...
  aoi21  g094(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n139_));
  ...
  aoi21  g115(.a(new_n159_), .b(new_n45_), .c(x26), .O(z8));
  ...
  aoi21  g119(.a(new_n88_), .b(new_n150_), .c(x31), .O(new_n164_));
