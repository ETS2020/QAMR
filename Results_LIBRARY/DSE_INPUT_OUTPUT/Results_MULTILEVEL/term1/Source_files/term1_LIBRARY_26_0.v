...
module FAU ( 
  ...
  nand3  g021(.a(new_n63_), .b(x30), .c(new_n60_), .O(new_n66_));
  inv1   g022(.a(new_n66_), .O(new_n67_));
  oai21  g023(.a(new_n67_), .b(new_n65_), .c(new_n59_), .O(new_n68_));
  nor2   g024(.a(new_n49_), .b(new_n52_), .O(new_n69_));
  ...
  nand2  g031(.a(x30), .b(new_n60_), .O(new_n76_));
  ...
  nand3  g038(.a(new_n82_), .b(new_n46_), .c(x01), .O(new_n83_));
  ...
  nor2   g049(.a(new_n93_), .b(new_n69_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n88_), .c(new_n87_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n59_), .c(new_n46_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n94_), .c(new_n46_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n87_), .c(x25), .d(x01), .O(new_n100_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n102_), .c(new_n70_), .d(new_n46_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n87_), .c(x25), .d(x01), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z5));
  inv1   g066(.a(x30), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(x28), .c(x27), .d(x06), .O(new_n112_));
  oai21  g068(.a(new_n104_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x29), .O(new_n114_));
  nand2  g070(.a(x30), .b(new_n103_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n93_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n70_), .c(new_n87_), .d(x25), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(new_n59_), .O(z6));
  oai21  g074(.a(x31), .b(new_n60_), .c(new_n111_), .O(new_n119_));
  nor4   g075(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n89_), .O(new_n120_));
  nand4  g076(.a(new_n70_), .b(new_n87_), .c(x25), .d(x01), .O(new_n121_));
  ...
  nand3  g081(.a(new_n104_), .b(new_n125_), .c(x29), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nor2   g083(.a(new_n125_), .b(x30), .O(new_n128_));
  aoi22  g084(.a(new_n128_), .b(x06), .c(new_n127_), .d(x30), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n122_), .O(z7));
  inv1   g086(.a(x15), .O(new_n131_));
  inv1   g087(.a(x19), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x14), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x18), .c(x17), .d(x16), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g091(.a(x16), .b(x15), .O(new_n136_));
  nand2  g092(.a(x18), .b(x17), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(new_n132_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(new_n131_), .O(new_n140_));
  inv1   g096(.a(x11), .O(new_n141_));
  inv1   g097(.a(x16), .O(new_n142_));
  oai21  g098(.a(new_n137_), .b(new_n141_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(x18), .b(x12), .c(x17), .O(new_n144_));
  nor2   g100(.a(x18), .b(x13), .O(new_n145_));
  nor3   g101(.a(new_n145_), .b(new_n144_), .c(new_n125_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n143_), .c(new_n140_), .d(new_n138_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n135_), .c(new_n46_), .O(new_n148_));
  nor2   g104(.a(x28), .b(x27), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n103_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n111_), .c(x06), .O(new_n152_));
  inv1   g108(.a(new_n149_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(x30), .c(x29), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n152_), .c(new_n148_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  inv1   g112(.a(x32), .O(new_n157_));
  nand4  g113(.a(new_n153_), .b(new_n111_), .c(x29), .d(x06), .O(new_n158_));
  oai21  g114(.a(new_n150_), .b(new_n111_), .c(new_n158_), .O(new_n159_));
  ...
  aoi21  g119(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(new_n164_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n142_), .c(x11), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x15), .O(new_n172_));
  nand4  g128(.a(new_n169_), .b(x16), .c(new_n131_), .d(x10), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n159_), .c(new_n157_), .d(x31), .O(new_n175_));
  ...
  nand2  g136(.a(x33), .b(new_n111_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n153_), .c(x29), .O(new_n183_));
  nand4  g139(.a(new_n174_), .b(new_n179_), .c(new_n125_), .d(new_n111_), .O(new_n184_));
  nand2  g140(.a(x33), .b(x30), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n151_), .O(new_n187_));
  inv1   g143(.a(new_n144_), .O(new_n188_));
  nor2   g144(.a(x31), .b(new_n111_), .O(new_n189_));
  nor3   g145(.a(new_n189_), .b(new_n145_), .c(new_n128_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n188_), .c(new_n143_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n140_), .c(new_n138_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n135_), .c(x33), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n187_), .c(new_n183_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n87_), .c(x00), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n46_), .O(z9));
endmodule
