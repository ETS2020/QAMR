...
module FAU ( 
  ...
  nor3   g056(.a(new_n100_), .b(new_n79_), .c(new_n58_), .O(z5));
  ...
  nand4  g123(.a(new_n167_), .b(new_n80_), .c(x25), .d(x00), .O(new_n168_));
  ...
  nand4  g142(.a(new_n186_), .b(new_n80_), .c(x25), .d(x00), .O(new_n187_));
