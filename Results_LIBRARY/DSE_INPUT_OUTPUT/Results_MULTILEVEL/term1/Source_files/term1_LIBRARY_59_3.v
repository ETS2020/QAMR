...
module FAU ( 
  ...
  nand4  g032(.a(new_n76_), .b(new_n45_), .c(new_n57_), .d(x08), .O(new_n77_));
  ...
  oai21  g050(.a(new_n94_), .b(new_n59_), .c(new_n45_), .O(z3));
  inv1   g051(.a(x25), .O(new_n96_));
  nand2  g052(.a(x28), .b(new_n80_), .O(new_n97_));
  inv1   g053(.a(x28), .O(new_n98_));
  inv1   g054(.a(x30), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n80_), .c(new_n97_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n93_), .c(new_n79_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n96_), .c(new_n59_), .O(z4));
  inv1   g059(.a(x29), .O(new_n104_));
  aoi21  g060(.a(new_n99_), .b(new_n98_), .c(new_n80_), .O(new_n105_));
  nand2  g061(.a(x28), .b(x27), .O(new_n106_));
  nand2  g062(.a(new_n99_), .b(new_n104_), .O(new_n107_));
  ...
  nor3   g065(.a(new_n109_), .b(new_n96_), .c(new_n59_), .O(z5));
  nand2  g066(.a(new_n99_), .b(x29), .O(new_n111_));
  oai22  g067(.a(new_n111_), .b(new_n106_), .c(new_n99_), .d(x27), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n93_), .c(new_n79_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n96_), .c(new_n59_), .O(z6));
  nand3  g070(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n115_));
  nand3  g071(.a(new_n60_), .b(x25), .c(x01), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(new_n47_), .c(x31), .d(x26), .O(new_n117_));
  oai21  g073(.a(new_n115_), .b(new_n90_), .c(new_n117_), .O(z7));
  inv1   g074(.a(x15), .O(new_n119_));
  inv1   g075(.a(x19), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x14), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x18), .c(x17), .d(x16), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand2  g079(.a(x16), .b(x15), .O(new_n124_));
  nand2  g080(.a(x18), .b(x17), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n124_), .c(new_n120_), .O(new_n126_));
  nand2  g082(.a(x16), .b(x10), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n125_), .c(new_n119_), .O(new_n128_));
  inv1   g084(.a(x11), .O(new_n129_));
  inv1   g085(.a(x16), .O(new_n130_));
  oai21  g086(.a(new_n125_), .b(new_n129_), .c(new_n130_), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  aoi21  g088(.a(x18), .b(x12), .c(x17), .O(new_n133_));
  nor2   g089(.a(x18), .b(x13), .O(new_n134_));
  nor3   g090(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n131_), .c(new_n128_), .d(new_n126_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n123_), .c(new_n45_), .O(new_n137_));
  nand3  g093(.a(x30), .b(x29), .c(x28), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n100_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n80_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n137_), .c(new_n107_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  nand2  g099(.a(x29), .b(x28), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x30), .c(new_n80_), .O(new_n145_));
  nand2  g101(.a(new_n98_), .b(new_n80_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n99_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g104(.a(x19), .b(new_n87_), .c(x13), .O(new_n149_));
  nand3  g105(.a(new_n120_), .b(x18), .c(x14), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(new_n84_), .O(new_n151_));
  nand4  g107(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n152_));
  ...
  nand3  g112(.a(new_n156_), .b(new_n130_), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x15), .O(new_n159_));
  nand4  g115(.a(new_n156_), .b(x16), .c(new_n119_), .d(x10), .O(new_n160_));
  ...
  nor2   g121(.a(new_n134_), .b(new_n133_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n131_), .c(new_n128_), .d(new_n126_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n123_), .c(new_n45_), .O(new_n168_));
  aoi21  g124(.a(new_n98_), .b(new_n80_), .c(new_n104_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(x31), .c(new_n99_), .O(new_n170_));
  nand3  g126(.a(x31), .b(x29), .c(x28), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x30), .c(new_n80_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n170_), .c(new_n168_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x33), .O(new_n174_));
  aoi21  g130(.a(new_n157_), .b(new_n154_), .c(new_n119_), .O(new_n175_));
  inv1   g131(.a(new_n160_), .O(new_n176_));
  nand2  g132(.a(new_n132_), .b(new_n99_), .O(new_n177_));
  nand2  g133(.a(x31), .b(x30), .O(new_n178_));
  oai22  g134(.a(new_n177_), .b(x28), .c(new_n178_), .d(new_n144_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n80_), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(x29), .c(new_n180_), .O(new_n181_));
  oai21  g137(.a(new_n176_), .b(new_n175_), .c(new_n181_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(x33), .c(new_n174_), .O(new_n183_));
