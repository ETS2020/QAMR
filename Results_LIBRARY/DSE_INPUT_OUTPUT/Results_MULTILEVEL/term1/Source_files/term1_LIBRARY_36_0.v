...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n88_), .c(new_n61_), .d(x30), .O(new_n104_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n61_), .c(x25), .d(x01), .O(new_n111_));
  ...
  aoi21  g113(.a(new_n128_), .b(new_n157_), .c(new_n120_), .O(new_n158_));
  ...
  nor2   g123(.a(new_n120_), .b(new_n99_), .O(new_n168_));
