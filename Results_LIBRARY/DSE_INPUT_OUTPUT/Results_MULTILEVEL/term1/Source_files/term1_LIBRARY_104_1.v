...
module FAU ( 
  ...
  oai21  g043(.a(new_n87_), .b(new_n82_), .c(new_n81_), .O(new_n88_));
  ...
  nor4   g051(.a(new_n89_), .b(new_n85_), .c(new_n83_), .d(new_n82_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n95_), .c(new_n61_), .d(new_n81_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n94_), .c(new_n59_), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n97_), .c(new_n61_), .d(new_n81_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n94_), .c(new_n59_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n61_), .c(new_n81_), .d(x25), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n59_), .O(z6));
  nand3  g070(.a(new_n102_), .b(x30), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x31), .O(new_n116_));
  inv1   g072(.a(new_n82_), .O(new_n117_));
  nand3  g073(.a(new_n86_), .b(new_n84_), .c(new_n117_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n102_), .c(new_n94_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n121_), .c(new_n120_), .d(new_n116_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n81_), .O(new_n127_));
  oai21  g083(.a(new_n119_), .b(x26), .c(x23), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(z7));
  nand2  g085(.a(new_n101_), .b(new_n80_), .O(new_n130_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n131_), .c(x31), .d(new_n107_), .O(new_n150_));
  ...
  nand2  g111(.a(x32), .b(new_n107_), .O(new_n156_));
  ...
  nor3   g126(.a(new_n170_), .b(new_n169_), .c(new_n122_), .O(new_n171_));
  ...
  nand2  g134(.a(x33), .b(new_n107_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n130_), .c(x29), .O(new_n181_));
  nand4  g137(.a(new_n149_), .b(new_n177_), .c(new_n122_), .d(new_n107_), .O(new_n182_));
