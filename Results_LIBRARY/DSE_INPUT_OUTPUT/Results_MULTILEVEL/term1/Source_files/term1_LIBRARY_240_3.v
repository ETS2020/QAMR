...
module FAU ( 
  ...
  nor2   g019(.a(new_n48_), .b(new_n51_), .O(new_n64_));
  inv1   g020(.a(new_n64_), .O(new_n65_));
  nand2  g021(.a(new_n48_), .b(new_n51_), .O(new_n66_));
  aoi21  g022(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(new_n67_));
  nand2  g023(.a(x05), .b(new_n48_), .O(new_n68_));
  nand3  g024(.a(new_n68_), .b(x06), .c(new_n51_), .O(new_n69_));
  nand2  g025(.a(x06), .b(new_n51_), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(x05), .c(new_n48_), .O(new_n71_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n85_), .c(new_n45_), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n84_), .c(new_n63_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n91_), .c(new_n45_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n84_), .c(new_n63_), .O(z4));
  inv1   g052(.a(new_n90_), .O(new_n97_));
  inv1   g053(.a(x29), .O(new_n98_));
  inv1   g054(.a(x28), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(new_n85_), .O(new_n100_));
  nand3  g056(.a(new_n98_), .b(x28), .c(x27), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n65_), .d(new_n45_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n84_), .c(new_n63_), .O(z5));
  inv1   g060(.a(x30), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x28), .c(x27), .O(new_n106_));
  oai21  g062(.a(new_n100_), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nor2   g063(.a(new_n105_), .b(x29), .O(new_n108_));
  aoi21  g064(.a(new_n107_), .b(x29), .c(new_n108_), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n90_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n65_), .c(new_n45_), .d(x25), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n63_), .O(z6));
  nand3  g068(.a(new_n100_), .b(x30), .c(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(new_n88_), .O(new_n115_));
  inv1   g071(.a(new_n89_), .O(new_n116_));
  nor2   g072(.a(new_n87_), .b(new_n86_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nor2   g074(.a(new_n64_), .b(new_n63_), .O(new_n119_));
  ...
  nor2   g079(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n114_), .O(z7));
  nand2  g081(.a(new_n99_), .b(new_n85_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n55_), .c(x31), .d(new_n105_), .O(new_n145_));
  nand2  g101(.a(x32), .b(x30), .O(new_n146_));
  oai21  g102(.a(new_n145_), .b(x26), .c(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n126_), .c(x29), .O(new_n148_));
  nand2  g104(.a(new_n126_), .b(x29), .O(new_n149_));
  nand4  g105(.a(new_n144_), .b(new_n55_), .c(x31), .d(x30), .O(new_n150_));
  nand2  g106(.a(x32), .b(new_n105_), .O(new_n151_));
  oai21  g107(.a(new_n150_), .b(x26), .c(new_n151_), .O(new_n152_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n164_), .c(new_n121_), .O(new_n166_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n61_), .O(z8));
  nand4  g127(.a(new_n144_), .b(new_n56_), .c(x31), .d(x30), .O(new_n172_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n56_), .c(new_n121_), .d(new_n105_), .O(new_n176_));
  oai21  g132(.a(new_n56_), .b(new_n105_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n149_), .O(new_n178_));
  inv1   g134(.a(new_n164_), .O(new_n179_));
  inv1   g135(.a(new_n165_), .O(new_n180_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n156_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n178_), .c(new_n175_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n45_), .c(x00), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n61_), .O(z9));
endmodule
