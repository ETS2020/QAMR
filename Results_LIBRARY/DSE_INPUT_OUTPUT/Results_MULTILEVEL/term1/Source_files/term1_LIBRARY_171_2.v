...
module FAU ( 
  ...
  nor2   g078(.a(new_n60_), .b(new_n80_), .O(new_n123_));
  ...
  nand2  g082(.a(x30), .b(x26), .O(new_n127_));
  ...
  nor3   g097(.a(new_n141_), .b(new_n140_), .c(new_n115_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n131_), .c(new_n127_), .O(new_n144_));
  nand2  g100(.a(new_n102_), .b(new_n81_), .O(new_n145_));
  ...
  aoi22  g104(.a(new_n148_), .b(new_n110_), .c(new_n147_), .d(new_n45_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand3  g108(.a(new_n148_), .b(x30), .c(new_n45_), .O(new_n153_));
  nand3  g109(.a(new_n145_), .b(new_n110_), .c(x29), .O(new_n154_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n131_), .c(new_n127_), .O(new_n175_));
  nand2  g131(.a(new_n148_), .b(new_n115_), .O(new_n176_));
  nor2   g132(.a(new_n115_), .b(new_n101_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n145_), .c(new_n110_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n45_), .c(new_n176_), .d(new_n110_), .O(new_n179_));
  ...
  oai22  g139(.a(new_n183_), .b(x26), .c(new_n176_), .d(x30), .O(new_n184_));
