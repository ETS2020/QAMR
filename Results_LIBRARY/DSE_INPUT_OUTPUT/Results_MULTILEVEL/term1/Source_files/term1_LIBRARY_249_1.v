...
module FAU ( 
  ...
  nor3   g097(.a(new_n141_), .b(new_n102_), .c(new_n93_), .O(new_n142_));
  inv1   g098(.a(new_n141_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x29), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(new_n102_), .c(new_n142_), .d(x01), .O(new_n145_));
  ...
  nand3  g105(.a(new_n143_), .b(new_n102_), .c(x29), .O(new_n150_));
  ...
  nand3  g130(.a(new_n174_), .b(new_n143_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n166_), .b(new_n171_), .c(new_n118_), .d(new_n102_), .O(new_n176_));
  nand2  g132(.a(x33), .b(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n144_), .O(new_n179_));
