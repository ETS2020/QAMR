...
module FAU ( 
  ...
  nand3  g045(.a(x30), .b(new_n45_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g062(.a(new_n90_), .b(new_n106_), .c(new_n104_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n97_), .c(new_n102_), .O(new_n108_));
  ...
  nand4  g078(.a(new_n122_), .b(x21), .c(new_n121_), .d(new_n117_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(new_n113_), .O(new_n124_));
  oai21  g080(.a(new_n85_), .b(new_n83_), .c(x20), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(x15), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(x17), .O(new_n127_));
  nand2  g083(.a(new_n45_), .b(new_n89_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n86_), .c(new_n84_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x29), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n127_), .c(new_n60_), .O(new_n131_));
  nand3  g087(.a(new_n129_), .b(new_n61_), .c(new_n98_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n131_), .b(new_n112_), .c(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n87_), .b(new_n61_), .c(new_n46_), .d(x29), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(x28), .c(x27), .d(x22), .O(new_n137_));
  oai21  g093(.a(new_n134_), .b(new_n46_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n80_), .c(x25), .d(x01), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(z6));
  oai21  g096(.a(x31), .b(new_n45_), .c(new_n46_), .O(new_n141_));
  ...
  nand3  g101(.a(new_n106_), .b(new_n104_), .c(new_n84_), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x17), .O(new_n148_));
  inv1   g104(.a(x31), .O(new_n149_));
  nand3  g105(.a(new_n100_), .b(new_n149_), .c(x29), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n148_), .c(new_n145_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x30), .O(new_n152_));
  nor2   g108(.a(new_n149_), .b(x30), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n147_), .c(x22), .O(new_n154_));
  ...
  nor2   g113(.a(new_n157_), .b(new_n113_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  nand2  g115(.a(x18), .b(x17), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n114_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n160_), .c(new_n113_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n160_), .b(new_n164_), .c(new_n117_), .O(new_n165_));
  aoi21  g121(.a(x18), .b(x12), .c(x17), .O(new_n166_));
  nor2   g122(.a(x18), .b(x13), .O(new_n167_));
  nor3   g123(.a(new_n167_), .b(new_n166_), .c(new_n149_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n158_), .c(new_n47_), .O(new_n170_));
  nand2  g126(.a(new_n99_), .b(new_n81_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x29), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n46_), .c(x22), .O(new_n173_));
  nand3  g129(.a(new_n171_), .b(x30), .c(x29), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n170_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x32), .O(new_n176_));
  inv1   g132(.a(x32), .O(new_n177_));
  nand4  g133(.a(new_n171_), .b(new_n46_), .c(x29), .d(x22), .O(new_n178_));
  nand2  g134(.a(new_n172_), .b(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(x19), .b(new_n121_), .c(x13), .O(new_n181_));
  nand3  g137(.a(new_n114_), .b(x18), .c(x14), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n181_), .c(new_n89_), .O(new_n183_));
  nand4  g139(.a(x19), .b(x18), .c(new_n89_), .d(x12), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n183_), .c(x16), .O(new_n186_));
  nand3  g142(.a(x19), .b(x18), .c(x17), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n117_), .c(x11), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x15), .O(new_n191_));
  nand4  g147(.a(new_n188_), .b(x16), .c(new_n113_), .d(x10), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n180_), .c(new_n177_), .d(x31), .O(new_n194_));
  ...
  nor2   g153(.a(new_n167_), .b(new_n166_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n158_), .c(new_n47_), .O(new_n200_));
  aoi21  g156(.a(new_n172_), .b(new_n149_), .c(x30), .O(new_n201_));
  nor2   g157(.a(new_n149_), .b(new_n98_), .O(new_n202_));
  aoi21  g158(.a(new_n202_), .b(new_n171_), .c(new_n46_), .O(new_n203_));
  aoi21  g159(.a(new_n201_), .b(x22), .c(new_n203_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n200_), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(x33), .O(new_n206_));
  nand4  g162(.a(new_n172_), .b(new_n149_), .c(new_n46_), .d(x22), .O(new_n207_));
  nand4  g163(.a(new_n171_), .b(x31), .c(x30), .d(x29), .O(new_n208_));
