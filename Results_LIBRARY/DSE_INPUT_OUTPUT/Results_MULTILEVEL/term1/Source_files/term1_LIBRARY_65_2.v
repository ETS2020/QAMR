...
module FAU ( 
  ...
  nand4  g60(.a(new_n104_), .b(new_n91_), .c(new_n84_), .d(new_n82_), .O(new_n105_));
  ...
  and2   g69(.a(new_n113_), .b(new_n91_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n84_), .c(x25), .d(x01), .O(new_n115_));
  ...
  nand4  g74(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n87_), .O(new_n119_));
