...
module FAU ( 
  ...
  aoi21  g045(.a(new_n88_), .b(new_n46_), .c(new_n89_), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n59_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n80_), .c(new_n79_), .d(x25), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(new_n58_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n91_), .c(new_n79_), .d(x25), .O(new_n95_));
  nor2   g051(.a(new_n95_), .b(new_n58_), .O(z4));
  ...
  aoi21  g056(.a(new_n100_), .b(new_n98_), .c(new_n90_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n58_), .c(new_n46_), .O(z5));
  nor2   g059(.a(new_n97_), .b(new_n80_), .O(new_n104_));
  oai21  g060(.a(x29), .b(x22), .c(new_n88_), .O(new_n105_));
  inv1   g061(.a(x17), .O(new_n106_));
  inv1   g062(.a(x22), .O(new_n107_));
  nand3  g063(.a(x29), .b(new_n107_), .c(new_n106_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n105_), .c(new_n104_), .O(new_n109_));
  nor3   g065(.a(new_n89_), .b(new_n86_), .c(new_n85_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n84_), .c(x29), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n109_), .c(x30), .O(new_n112_));
  nand2  g068(.a(new_n82_), .b(new_n81_), .O(new_n113_));
  nor2   g069(.a(new_n83_), .b(new_n106_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n87_), .c(new_n113_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n45_), .c(x29), .d(x28), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x27), .c(new_n107_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n112_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n58_), .O(z6));
  nor2   g077(.a(x31), .b(x22), .O(new_n122_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n122_), .c(x17), .O(new_n129_));
  nand2  g085(.a(x30), .b(x22), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(new_n83_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n126_), .c(new_n125_), .d(new_n113_), .O(new_n132_));
  nand3  g088(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x31), .O(new_n134_));
  nand3  g090(.a(new_n104_), .b(new_n127_), .c(x29), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nor2   g092(.a(new_n127_), .b(x30), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n107_), .c(new_n136_), .d(x30), .O(new_n138_));
  ...
  oai21  g106(.a(new_n146_), .b(new_n150_), .c(new_n81_), .O(new_n151_));
  aoi21  g107(.a(x18), .b(x12), .c(x17), .O(new_n152_));
  nor2   g108(.a(x18), .b(x13), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n152_), .c(new_n127_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n151_), .c(new_n149_), .d(new_n147_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n144_), .c(new_n46_), .O(new_n156_));
  nand2  g112(.a(new_n97_), .b(new_n80_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x29), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n45_), .c(new_n107_), .O(new_n159_));
  ...
  nand4  g119(.a(new_n157_), .b(new_n45_), .c(x29), .d(new_n107_), .O(new_n164_));
  ...
  nand3  g124(.a(new_n141_), .b(x18), .c(x14), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n168_), .c(new_n106_), .O(new_n170_));
  nand4  g126(.a(x19), .b(x18), .c(new_n106_), .d(x12), .O(new_n171_));
  ...
  nand3  g131(.a(new_n175_), .b(new_n81_), .c(x11), .O(new_n176_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n151_), .c(new_n149_), .d(new_n147_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n144_), .c(new_n46_), .O(new_n187_));
  aoi21  g143(.a(new_n158_), .b(new_n127_), .c(x30), .O(new_n188_));
  nor2   g144(.a(new_n127_), .b(new_n99_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n157_), .c(new_n45_), .O(new_n190_));
  aoi21  g146(.a(new_n188_), .b(new_n107_), .c(new_n190_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n187_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  aoi21  g149(.a(new_n176_), .b(new_n173_), .c(new_n140_), .O(new_n194_));
  inv1   g150(.a(new_n179_), .O(new_n195_));
  nand4  g151(.a(new_n158_), .b(new_n127_), .c(new_n45_), .d(new_n107_), .O(new_n196_));
