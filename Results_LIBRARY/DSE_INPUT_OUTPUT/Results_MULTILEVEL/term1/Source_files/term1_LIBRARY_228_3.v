...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n60_), .c(new_n45_), .d(new_n80_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n79_), .c(x25), .d(x01), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z3));
  nand3  g049(.a(new_n45_), .b(x28), .c(new_n80_), .O(new_n94_));
  ...
  nand2  g054(.a(new_n98_), .b(new_n45_), .O(z4));
  nand2  g055(.a(x30), .b(x06), .O(new_n100_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n89_), .d(new_n60_), .O(new_n106_));
  ...
  inv1   g066(.a(x06), .O(new_n111_));
  nand3  g067(.a(new_n102_), .b(x30), .c(new_n111_), .O(new_n112_));
  ...
  nand2  g072(.a(x30), .b(new_n101_), .O(new_n117_));
  ...
  oai21  g076(.a(x31), .b(x30), .c(x06), .O(new_n121_));
  nand2  g077(.a(x30), .b(x29), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n102_), .c(x31), .O(new_n123_));
  nand4  g079(.a(new_n88_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n124_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n135_), .c(new_n45_), .O(new_n148_));
  ...
  aoi22  g109(.a(new_n153_), .b(new_n113_), .c(new_n152_), .d(new_n111_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n148_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  inv1   g112(.a(x32), .O(new_n157_));
  nand3  g113(.a(new_n153_), .b(x30), .c(new_n111_), .O(new_n158_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n135_), .c(new_n45_), .O(new_n182_));
  nand2  g138(.a(new_n153_), .b(new_n126_), .O(new_n183_));
  nor2   g139(.a(new_n126_), .b(new_n101_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n150_), .c(new_n113_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(new_n111_), .c(new_n183_), .d(new_n113_), .O(new_n186_));
  ...
  oai22  g146(.a(new_n190_), .b(x06), .c(new_n183_), .d(x30), .O(new_n191_));
