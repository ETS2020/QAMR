...
module FAU ( 
  ...
  aoi21  g062(.a(new_n106_), .b(new_n80_), .c(x26), .O(z5));
  nand3  g063(.a(new_n90_), .b(x29), .c(x28), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x27), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n80_), .c(x26), .O(z6));
  inv1   g067(.a(new_n86_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n85_), .c(new_n83_), .O(new_n113_));
  nand3  g069(.a(new_n60_), .b(x25), .c(x01), .O(new_n114_));
  nor4   g070(.a(new_n114_), .b(x31), .c(x30), .d(x26), .O(new_n115_));
  oai21  g071(.a(new_n113_), .b(new_n87_), .c(new_n115_), .O(z7));
  inv1   g072(.a(x32), .O(new_n117_));
  nand2  g073(.a(new_n101_), .b(new_n79_), .O(new_n118_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n150_), .c(new_n148_), .d(new_n118_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n137_), .b(new_n103_), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x00), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n80_), .c(x26), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  nand2  g117(.a(new_n118_), .b(x29), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n136_), .c(new_n161_), .d(new_n151_), .O(new_n163_));
  aoi21  g119(.a(new_n120_), .b(new_n149_), .c(x31), .O(new_n164_));
  ...
  nand4  g125(.a(new_n169_), .b(new_n80_), .c(new_n45_), .d(x00), .O(new_n170_));
