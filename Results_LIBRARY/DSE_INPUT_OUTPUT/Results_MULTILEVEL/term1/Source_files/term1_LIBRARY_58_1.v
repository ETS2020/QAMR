...
module FAU ( 
  ...
  nor2   g010(.a(z0), .b(x26), .O(new_n55_));
  aoi21  g011(.a(new_n54_), .b(z0), .c(new_n55_), .O(new_n56_));
  ...
  nand2  g020(.a(x05), .b(new_n47_), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(x06), .c(new_n50_), .O(new_n66_));
  nand2  g022(.a(x06), .b(new_n50_), .O(new_n67_));
  nand3  g023(.a(new_n67_), .b(x05), .c(new_n47_), .O(new_n68_));
  ...
  nand4  g030(.a(x06), .b(x05), .c(new_n47_), .d(new_n50_), .O(new_n75_));
  aoi21  g031(.a(new_n75_), .b(new_n74_), .c(x01), .O(new_n76_));
  oai21  g032(.a(new_n76_), .b(new_n73_), .c(new_n71_), .O(new_n77_));
  aoi21  g033(.a(new_n77_), .b(new_n70_), .c(new_n55_), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n58_), .c(x08), .O(new_n79_));
  ...
  nand2  g044(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  ...
  aoi21  g048(.a(new_n92_), .b(z0), .c(x26), .O(z3));
  inv1   g049(.a(x26), .O(new_n94_));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n91_), .c(z0), .O(new_n96_));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(new_n90_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n62_), .c(x25), .d(x01), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(z0), .c(x26), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n89_), .c(new_n62_), .d(z0), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n94_), .c(x25), .d(x01), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(z6));
  nand3  g073(.a(new_n101_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  inv1   g075(.a(new_n85_), .O(new_n120_));
  inv1   g076(.a(new_n86_), .O(new_n121_));
  inv1   g077(.a(new_n87_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n84_), .O(new_n123_));
  nand3  g079(.a(new_n62_), .b(x25), .c(x01), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  inv1   g081(.a(x31), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x30), .c(x29), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n102_), .c(z0), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(x26), .O(new_n129_));
  ...
  nor2   g088(.a(new_n132_), .b(x30), .O(new_n133_));
  inv1   g089(.a(new_n132_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x29), .O(new_n135_));
  aoi22  g091(.a(new_n135_), .b(x30), .c(new_n133_), .d(x29), .O(new_n136_));
  ...
  aoi21  g109(.a(new_n153_), .b(new_n151_), .c(new_n136_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(z0), .c(x31), .d(new_n94_), .O(new_n155_));
  nor2   g111(.a(new_n155_), .b(new_n131_), .O(z8));
  nand2  g112(.a(new_n153_), .b(new_n151_), .O(new_n157_));
  nand4  g113(.a(x33), .b(z0), .c(x31), .d(x30), .O(new_n158_));
  nand3  g114(.a(new_n54_), .b(new_n126_), .c(new_n111_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n157_), .c(new_n135_), .O(new_n161_));
  nand4  g117(.a(new_n157_), .b(new_n54_), .c(x31), .d(x30), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n111_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n134_), .c(x29), .O(new_n165_));
  aoi21  g121(.a(new_n140_), .b(x14), .c(new_n138_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x17), .c(x16), .d(x15), .O(new_n167_));
  nand2  g123(.a(x16), .b(x15), .O(new_n168_));
  nand2  g124(.a(x18), .b(x17), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n168_), .c(new_n140_), .O(new_n170_));
  nand2  g126(.a(x16), .b(x10), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(new_n152_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n169_), .b(new_n173_), .c(new_n146_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x12), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n137_), .O(new_n176_));
  inv1   g132(.a(x13), .O(new_n177_));
  nand2  g133(.a(new_n138_), .b(new_n177_), .O(new_n178_));
  xnor2a g134(.a(x31), .b(x30), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n178_), .c(new_n176_), .d(new_n174_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n172_), .c(new_n170_), .d(new_n167_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n165_), .c(new_n161_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x00), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(z0), .c(x26), .O(z9));
endmodule
