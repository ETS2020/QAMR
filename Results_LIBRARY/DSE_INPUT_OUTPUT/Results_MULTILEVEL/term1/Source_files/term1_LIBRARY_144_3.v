...
module FAU ( 
  ...
  nand2  g007(.a(x33), .b(new_n45_), .O(new_n52_));
  ...
  aoi21  g014(.a(new_n58_), .b(new_n52_), .c(new_n47_), .O(new_n59_));
  oai21  g015(.a(new_n51_), .b(x32), .c(new_n59_), .O(z1));
  inv1   g016(.a(new_n47_), .O(new_n61_));
  ...
  nor2   g027(.a(new_n49_), .b(new_n63_), .O(new_n72_));
  ...
  nand2  g034(.a(new_n78_), .b(new_n61_), .O(z2));
  ...
  nand4  g059(.a(new_n103_), .b(new_n98_), .c(new_n97_), .d(new_n80_), .O(new_n104_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n97_), .c(new_n80_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n63_), .c(new_n61_), .O(z6));
  nor4   g070(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n115_));
  nand4  g071(.a(new_n97_), .b(new_n80_), .c(x25), .d(x01), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n61_), .O(new_n117_));
  ...
  nor4   g077(.a(new_n119_), .b(x33), .c(x31), .d(new_n45_), .O(new_n122_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n129_), .c(new_n61_), .O(new_n146_));
  nand2  g102(.a(new_n100_), .b(new_n81_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n46_), .c(x30), .d(x29), .O(new_n148_));
  ...
  nand3  g110(.a(new_n149_), .b(new_n46_), .c(x30), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g112(.a(x19), .b(new_n141_), .c(x13), .O(new_n157_));
  nand3  g113(.a(new_n126_), .b(x18), .c(x14), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(new_n138_), .O(new_n159_));
  nand4  g115(.a(x19), .b(x18), .c(new_n138_), .d(x12), .O(new_n160_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n136_), .c(x11), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x15), .O(new_n167_));
  nand4  g123(.a(new_n164_), .b(x16), .c(new_n125_), .d(x10), .O(new_n168_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n52_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n147_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n169_), .b(new_n149_), .c(new_n46_), .d(new_n118_), .O(new_n177_));
  nand2  g133(.a(new_n142_), .b(new_n118_), .O(new_n178_));
  aoi21  g134(.a(new_n139_), .b(new_n138_), .c(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n129_), .c(x33), .O(new_n181_));
