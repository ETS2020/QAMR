...
module FAU ( 
  ...
  oai21  g042(.a(new_n86_), .b(new_n62_), .c(new_n49_), .O(z3));
  inv1   g043(.a(x25), .O(new_n88_));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n85_), .c(new_n45_), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n88_), .c(new_n62_), .O(z4));
  inv1   g047(.a(new_n56_), .O(new_n92_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n45_), .d(x25), .O(new_n108_));
  ...
  nand2  g078(.a(new_n46_), .b(x26), .O(new_n123_));
  ...
  nand2  g097(.a(new_n95_), .b(new_n79_), .O(new_n142_));
  ...
  nand4  g103(.a(new_n142_), .b(new_n46_), .c(x29), .d(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n143_), .b(x30), .O(new_n149_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n150_), .c(new_n50_), .d(x31), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n147_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x00), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n49_), .O(z8));
  nor2   g125(.a(new_n138_), .b(new_n137_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n128_), .c(new_n123_), .O(new_n172_));
  aoi21  g128(.a(new_n143_), .b(new_n118_), .c(x30), .O(new_n173_));
  nor2   g129(.a(new_n118_), .b(new_n94_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n142_), .c(new_n46_), .O(new_n175_));
  ...
  aoi21  g134(.a(new_n161_), .b(new_n158_), .c(new_n124_), .O(new_n179_));
  inv1   g135(.a(new_n164_), .O(new_n180_));
  nand4  g136(.a(new_n143_), .b(new_n118_), .c(new_n46_), .d(new_n45_), .O(new_n181_));
