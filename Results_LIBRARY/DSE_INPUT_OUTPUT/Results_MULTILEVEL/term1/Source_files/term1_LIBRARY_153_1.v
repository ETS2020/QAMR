...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n45_), .c(new_n80_), .O(new_n95_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n60_), .d(new_n45_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n79_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z5));
  nand3  g067(.a(new_n94_), .b(new_n45_), .c(x29), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n103_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x27), .c(new_n79_), .d(x25), .O(new_n114_));
  ...
  oai21  g076(.a(new_n120_), .b(x30), .c(new_n79_), .O(z7));
  ...
  nor2   g108(.a(new_n118_), .b(new_n105_), .O(new_n153_));
  ...
  oai21  g114(.a(new_n139_), .b(new_n105_), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n45_), .c(new_n79_), .d(x00), .O(new_n160_));
