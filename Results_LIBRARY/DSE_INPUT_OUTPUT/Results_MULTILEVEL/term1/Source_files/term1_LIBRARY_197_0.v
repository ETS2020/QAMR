...
module FAU ( 
  ...
  aoi21  g053(.a(new_n97_), .b(x15), .c(x26), .O(z5));
  ...
  nand4  g062(.a(new_n106_), .b(x25), .c(x15), .d(x01), .O(new_n107_));
  ...
  nand3  g069(.a(new_n60_), .b(x15), .c(x01), .O(new_n114_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n92_), .c(new_n99_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n115_), .c(new_n113_), .d(new_n110_), .O(z7));
  nand2  g077(.a(new_n90_), .b(new_n79_), .O(new_n122_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n123_), .c(x31), .d(new_n102_), .O(new_n137_));
  ...
  nand2  g096(.a(new_n122_), .b(x29), .O(new_n141_));
  nand4  g097(.a(new_n136_), .b(new_n123_), .c(x31), .d(x30), .O(new_n142_));
  nand2  g098(.a(x32), .b(new_n102_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g101(.a(new_n127_), .b(x14), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(x18), .c(x17), .d(x16), .O(new_n147_));
  nand2  g103(.a(x18), .b(x17), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n133_), .c(new_n127_), .O(new_n149_));
  inv1   g105(.a(x11), .O(new_n150_));
  oai21  g106(.a(new_n148_), .b(new_n150_), .c(new_n133_), .O(new_n151_));
  aoi21  g107(.a(x18), .b(x12), .c(x17), .O(new_n152_));
  nor2   g108(.a(x18), .b(x13), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n152_), .c(new_n117_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n151_), .c(new_n149_), .d(new_n147_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n145_), .c(new_n140_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x00), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(x15), .c(x26), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  nand4  g116(.a(new_n136_), .b(new_n160_), .c(x31), .d(x30), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n102_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n122_), .c(x29), .O(new_n164_));
  nand4  g120(.a(new_n136_), .b(new_n160_), .c(new_n117_), .d(new_n102_), .O(new_n165_));
  ...
  inv1   g124(.a(new_n147_), .O(new_n169_));
  inv1   g125(.a(new_n152_), .O(new_n170_));
  xor2a  g126(.a(x31), .b(x30), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n153_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n170_), .c(new_n151_), .d(new_n149_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n169_), .c(x33), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n168_), .c(new_n164_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n99_), .c(x15), .d(x00), .O(new_n176_));
