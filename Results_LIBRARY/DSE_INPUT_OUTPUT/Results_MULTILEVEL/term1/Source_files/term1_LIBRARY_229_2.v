...
module FAU ( 
  ...
  oai21  g065(.a(new_n45_), .b(x29), .c(new_n102_), .O(new_n110_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n101_), .c(x31), .O(new_n120_));
  ...
  aoi21  g100(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x17), .c(x16), .d(x15), .O(new_n146_));
  nor2   g102(.a(new_n135_), .b(new_n141_), .O(new_n147_));
  ...
  oai21  g109(.a(new_n148_), .b(new_n153_), .c(new_n135_), .O(new_n154_));
  nand2  g110(.a(x18), .b(x12), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n83_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  aoi21  g113(.a(new_n86_), .b(new_n157_), .c(new_n115_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n150_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n146_), .c(new_n128_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n144_), .c(new_n45_), .O(new_n163_));
  nand3  g119(.a(x32), .b(new_n45_), .c(new_n103_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n163_), .c(new_n80_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n126_), .O(z8));
  oai21  g123(.a(x28), .b(x27), .c(x31), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x29), .O(new_n169_));
  nand2  g125(.a(new_n115_), .b(new_n45_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n103_), .O(new_n171_));
  nand2  g127(.a(new_n86_), .b(new_n157_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n150_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n171_), .c(new_n169_), .d(new_n146_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  oai21  g132(.a(new_n168_), .b(new_n103_), .c(new_n170_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n143_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(x33), .c(new_n176_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n80_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n46_), .O(z9));
endmodule
