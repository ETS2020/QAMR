...
module FAU ( 
  ...
  nor2   g59(.a(x29), .b(new_n98_), .O(new_n104_));
  aoi22  g60(.a(new_n104_), .b(x27), .c(new_n103_), .d(x29), .O(new_n105_));
  aoi21  g61(.a(new_n91_), .b(new_n87_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n103_), .c(new_n110_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n92_), .c(new_n84_), .d(new_n82_), .O(new_n114_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n103_), .c(x31), .O(new_n119_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n103_), .c(new_n82_), .O(new_n129_));
