...
module FAU ( 
  ...
  nand3  g054(.a(new_n98_), .b(new_n90_), .c(new_n79_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n93_), .c(new_n58_), .O(z4));
  nor2   g056(.a(new_n45_), .b(x27), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n96_), .c(x29), .O(new_n102_));
  ...
  xnor2a g063(.a(x30), .b(x27), .O(new_n108_));
  aoi21  g064(.a(x30), .b(new_n103_), .c(new_n94_), .O(new_n109_));
  oai21  g065(.a(new_n108_), .b(new_n103_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n88_), .c(new_n60_), .d(new_n79_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x25), .c(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n46_), .O(z6));
  oai21  g070(.a(x31), .b(new_n95_), .c(new_n94_), .O(new_n115_));
  ...
  oai21  g076(.a(new_n119_), .b(x28), .c(new_n120_), .O(new_n121_));
  nand3  g077(.a(x30), .b(x29), .c(x27), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n119_), .O(new_n124_));
  aoi22  g080(.a(new_n124_), .b(x28), .c(new_n121_), .d(x30), .O(new_n125_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n134_), .c(new_n127_), .O(new_n136_));
  ...
  aoi21  g101(.a(new_n141_), .b(new_n140_), .c(new_n145_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n139_), .c(new_n136_), .d(new_n133_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n131_), .c(new_n46_), .O(new_n148_));
  xnor2a g104(.a(x30), .b(x29), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(x28), .c(new_n123_), .O(new_n150_));
  ...
  nand4  g130(.a(x33), .b(new_n80_), .c(new_n79_), .d(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x30), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n94_), .O(new_n177_));
  inv1   g133(.a(x33), .O(new_n178_));
  inv1   g134(.a(new_n154_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
  nand3  g136(.a(new_n119_), .b(new_n95_), .c(new_n103_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n170_), .c(new_n178_), .O(new_n183_));
  oai21  g139(.a(new_n119_), .b(new_n103_), .c(x30), .O(new_n184_));
  oai21  g140(.a(x31), .b(x29), .c(new_n95_), .O(new_n185_));
  nand2  g141(.a(new_n141_), .b(new_n140_), .O(new_n186_));
  nand4  g142(.a(new_n144_), .b(new_n186_), .c(new_n139_), .d(new_n136_), .O(new_n187_));
  aoi21  g143(.a(new_n132_), .b(new_n128_), .c(new_n187_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n185_), .c(new_n184_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n131_), .c(x33), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n183_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n79_), .c(x00), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n177_), .O(z9));
endmodule
