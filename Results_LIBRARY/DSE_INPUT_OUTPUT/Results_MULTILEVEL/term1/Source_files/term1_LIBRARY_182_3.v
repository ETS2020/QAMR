...
module FAU ( 
  ...
  nand4  g055(.a(new_n99_), .b(new_n59_), .c(new_n79_), .d(x25), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n78_), .c(new_n57_), .O(z5));
  nand3  g057(.a(new_n89_), .b(x29), .c(x28), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(x27), .c(new_n79_), .d(x25), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n78_), .c(new_n57_), .O(z6));
  ...
  nand3  g064(.a(new_n59_), .b(x25), .c(x01), .O(new_n109_));
  ...
  nand4  g070(.a(new_n114_), .b(x18), .c(x17), .d(x16), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g072(.a(x16), .b(x15), .O(new_n117_));
  nand2  g073(.a(x18), .b(x17), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n113_), .O(new_n119_));
  nand2  g075(.a(x16), .b(x10), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n112_), .O(new_n121_));
  inv1   g077(.a(x11), .O(new_n122_));
  inv1   g078(.a(x16), .O(new_n123_));
  oai21  g079(.a(new_n118_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  inv1   g080(.a(x31), .O(new_n125_));
  aoi21  g081(.a(x18), .b(x12), .c(x17), .O(new_n126_));
  nor2   g082(.a(x18), .b(x13), .O(new_n127_));
  nor3   g083(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n124_), .c(new_n121_), .d(new_n119_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n116_), .c(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n95_), .b(new_n80_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x30), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n97_), .O(new_n133_));
  nand2  g089(.a(new_n131_), .b(x29), .O(new_n134_));
  aoi22  g090(.a(new_n134_), .b(new_n78_), .c(new_n133_), .d(new_n57_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n130_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x32), .O(new_n137_));
  inv1   g093(.a(x32), .O(new_n138_));
  nand3  g094(.a(new_n134_), .b(x30), .c(new_n57_), .O(new_n139_));
  nand3  g095(.a(new_n131_), .b(new_n78_), .c(x29), .O(new_n140_));
  ...
  nand3  g100(.a(new_n113_), .b(x18), .c(x14), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n144_), .c(new_n142_), .O(new_n146_));
  nand4  g102(.a(x19), .b(x18), .c(new_n142_), .d(x12), .O(new_n147_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n123_), .c(x11), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x15), .O(new_n154_));
  nand4  g110(.a(new_n151_), .b(x16), .c(new_n112_), .d(x10), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n141_), .c(new_n138_), .d(x31), .O(new_n157_));
  ...
  nor2   g116(.a(new_n127_), .b(new_n126_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n124_), .c(new_n121_), .d(new_n119_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n116_), .c(new_n45_), .O(new_n163_));
  nand2  g119(.a(new_n134_), .b(new_n125_), .O(new_n164_));
  nor2   g120(.a(new_n125_), .b(new_n97_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n131_), .c(new_n78_), .O(new_n166_));
  aoi22  g122(.a(new_n166_), .b(new_n57_), .c(new_n164_), .d(new_n78_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x33), .O(new_n169_));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n131_), .b(x31), .c(x30), .d(x29), .O(new_n171_));
  oai22  g127(.a(new_n171_), .b(x01), .c(new_n164_), .d(x30), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n156_), .c(new_n170_), .O(new_n173_));
