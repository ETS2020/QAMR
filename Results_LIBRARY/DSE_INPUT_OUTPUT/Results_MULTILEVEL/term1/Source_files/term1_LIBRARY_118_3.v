...
module FAU ( 
  ...
  nand3  g024(.a(new_n68_), .b(new_n57_), .c(new_n45_), .O(new_n69_));
  ...
  nand3  g031(.a(new_n75_), .b(new_n70_), .c(new_n45_), .O(new_n76_));
  ...
  oai21  g044(.a(new_n88_), .b(new_n61_), .c(new_n45_), .O(z3));
  ...
  oai21  g065(.a(new_n109_), .b(new_n61_), .c(new_n45_), .O(z6));
  ...
  nand2  g079(.a(new_n97_), .b(new_n81_), .O(new_n124_));
