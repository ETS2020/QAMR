...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n61_), .c(new_n48_), .d(new_n81_), .O(new_n94_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n100_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n93_), .c(new_n61_), .d(new_n48_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n80_), .c(x25), .d(x01), .O(new_n111_));
  ...
  oai21  g071(.a(new_n114_), .b(new_n46_), .c(new_n115_), .O(new_n116_));
  ...
  nand2  g075(.a(new_n119_), .b(new_n48_), .O(z6));
  ...
  nand3  g082(.a(new_n125_), .b(x30), .c(x29), .O(new_n127_));
  oai22  g083(.a(new_n127_), .b(new_n126_), .c(new_n114_), .d(new_n125_), .O(new_n128_));
  aoi22  g084(.a(new_n128_), .b(new_n45_), .c(x31), .d(new_n46_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n124_), .O(z7));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n85_), .O(new_n136_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n132_), .c(x31), .d(new_n46_), .O(new_n149_));
  ...
  nand2  g110(.a(x32), .b(new_n46_), .O(new_n155_));
  ...
  nor3   g125(.a(new_n169_), .b(new_n168_), .c(new_n125_), .O(new_n170_));
  ...
  nor2   g131(.a(new_n169_), .b(new_n168_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n167_), .c(new_n165_), .d(new_n163_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n160_), .c(new_n48_), .O(new_n178_));
  nand2  g134(.a(new_n153_), .b(new_n125_), .O(new_n179_));
  nor2   g135(.a(new_n125_), .b(new_n104_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n131_), .c(new_n46_), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n45_), .c(new_n179_), .d(new_n46_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand4  g140(.a(new_n131_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
  oai22  g141(.a(new_n185_), .b(x06), .c(new_n179_), .d(x30), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n148_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(x33), .c(new_n184_), .O(new_n188_));
