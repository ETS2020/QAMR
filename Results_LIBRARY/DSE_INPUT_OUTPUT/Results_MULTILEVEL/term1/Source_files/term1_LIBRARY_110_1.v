...
module FAU ( 
  ...
  nand4  g047(.a(new_n91_), .b(new_n45_), .c(x25), .d(x01), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z3));
  nand3  g049(.a(new_n80_), .b(x28), .c(new_n79_), .O(new_n94_));
  oai21  g050(.a(x28), .b(new_n79_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n89_), .c(x25), .d(x01), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n80_), .c(x26), .O(z4));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n80_), .c(x26), .O(z5));
  nand3  g060(.a(new_n89_), .b(new_n80_), .c(x29), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x27), .c(new_n45_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n58_), .O(z6));
  inv1   g064(.a(new_n84_), .O(new_n109_));
  inv1   g065(.a(new_n85_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n109_), .c(new_n83_), .O(new_n111_));
  nand3  g067(.a(new_n60_), .b(x25), .c(x01), .O(new_n112_));
  nor4   g068(.a(new_n112_), .b(x31), .c(x30), .d(x26), .O(new_n113_));
  oai21  g069(.a(new_n111_), .b(new_n86_), .c(new_n113_), .O(z7));
  ...
  nor2   g105(.a(new_n149_), .b(new_n100_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .d(new_n116_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  and2   g108(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n142_), .c(new_n140_), .d(new_n137_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  oai21  g111(.a(new_n135_), .b(new_n100_), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n80_), .c(new_n45_), .d(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(z8));
  inv1   g114(.a(x33), .O(new_n159_));
  nand2  g115(.a(new_n116_), .b(x29), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n134_), .c(new_n159_), .d(new_n149_), .O(new_n161_));
  aoi21  g117(.a(new_n118_), .b(new_n147_), .c(x31), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n146_), .c(new_n144_), .d(new_n142_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n160_), .c(new_n140_), .d(new_n137_), .O(new_n165_));
  ...
  aoi21  g124(.a(new_n168_), .b(new_n80_), .c(x26), .O(z9));
endmodule
