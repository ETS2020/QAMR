...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n98_), .d(new_n78_), .O(new_n105_));
  ...
  nand3  g076(.a(new_n102_), .b(new_n120_), .c(x30), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n78_), .c(x25), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n55_), .c(new_n61_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n119_), .c(new_n117_), .d(new_n115_), .O(z7));
  inv1   g080(.a(x00), .O(new_n125_));
  nand3  g081(.a(x32), .b(new_n78_), .c(x00), .O(new_n126_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n142_), .c(x32), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x31), .c(new_n45_), .d(x29), .O(new_n146_));
  nand2  g102(.a(x32), .b(x30), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n146_), .c(new_n130_), .O(new_n148_));
  nand3  g104(.a(new_n79_), .b(new_n84_), .c(x13), .O(new_n149_));
  nand4  g105(.a(new_n49_), .b(x31), .c(x30), .d(new_n101_), .O(new_n150_));
  oai22  g106(.a(new_n150_), .b(new_n149_), .c(new_n49_), .d(new_n84_), .O(new_n151_));
  nand3  g107(.a(new_n79_), .b(new_n87_), .c(x14), .O(new_n152_));
  oai22  g108(.a(new_n152_), .b(new_n150_), .c(new_n49_), .d(x14), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(x18), .c(new_n151_), .d(x19), .O(new_n154_));
  nand3  g110(.a(new_n49_), .b(x31), .c(x30), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n130_), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n134_), .c(new_n154_), .d(new_n81_), .O(new_n158_));
  nor2   g114(.a(new_n157_), .b(new_n140_), .O(new_n159_));
  aoi21  g115(.a(new_n158_), .b(x16), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(x32), .b(new_n45_), .O(new_n161_));
  nand4  g117(.a(x17), .b(x16), .c(new_n143_), .d(x10), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n156_), .c(x19), .d(x18), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n161_), .c(x28), .O(new_n165_));
  nand2  g121(.a(x16), .b(x15), .O(new_n166_));
  nand2  g122(.a(x18), .b(x17), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n166_), .c(new_n87_), .O(new_n168_));
  nand2  g124(.a(x16), .b(x10), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n167_), .c(new_n143_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n167_), .b(new_n171_), .c(new_n137_), .O(new_n172_));
  aoi21  g128(.a(x18), .b(x12), .c(x17), .O(new_n173_));
  nor2   g129(.a(x18), .b(x13), .O(new_n174_));
  nor3   g130(.a(new_n174_), .b(new_n173_), .c(new_n120_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(x32), .c(new_n165_), .d(new_n79_), .O(new_n177_));
  oai21  g133(.a(new_n160_), .b(new_n143_), .c(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n148_), .c(new_n78_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n125_), .c(new_n128_), .O(z8));
  nand2  g136(.a(new_n87_), .b(x14), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x18), .c(x17), .d(x16), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n143_), .O(new_n183_));
  nor2   g139(.a(new_n174_), .b(new_n173_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n183_), .c(new_n48_), .O(new_n186_));
  oai21  g142(.a(new_n130_), .b(new_n120_), .c(x30), .O(new_n187_));
  oai21  g143(.a(new_n130_), .b(x30), .c(new_n187_), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(x29), .c(x31), .d(new_n45_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand2  g147(.a(new_n144_), .b(new_n142_), .O(new_n192_));
  nand4  g148(.a(new_n129_), .b(x31), .c(x30), .d(x29), .O(new_n193_));
  nand2  g149(.a(new_n129_), .b(x29), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n120_), .c(new_n45_), .O(new_n195_));
