...
module FAU ( 
  ...
  nor2   g011(.a(new_n54_), .b(x26), .O(new_n56_));
  ...
  aoi21  g033(.a(new_n77_), .b(new_n70_), .c(new_n56_), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n59_), .c(x08), .O(new_n79_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n62_), .c(new_n54_), .d(new_n82_), .O(new_n96_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n62_), .d(new_n54_), .O(new_n101_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n95_), .c(new_n62_), .d(new_n54_), .O(new_n110_));
  ...
  oai21  g071(.a(new_n107_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x29), .O(new_n117_));
  oai21  g073(.a(new_n114_), .b(x29), .c(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n95_), .c(new_n62_), .d(new_n54_), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n81_), .c(x25), .d(x01), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(z6));
  nand3  g078(.a(new_n107_), .b(x30), .c(x29), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x31), .O(new_n124_));
  nand4  g080(.a(new_n94_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n125_));
  nand3  g081(.a(new_n62_), .b(x25), .c(x01), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  inv1   g083(.a(new_n107_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x30), .c(x29), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n128_), .c(new_n54_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(x26), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n125_), .d(new_n124_), .O(z7));
  ...
  nand4  g109(.a(new_n153_), .b(new_n138_), .c(x31), .d(x00), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n54_), .c(x26), .O(z8));
  inv1   g111(.a(new_n137_), .O(new_n156_));
  nand3  g112(.a(x33), .b(x31), .c(x30), .O(new_n157_));
  nand3  g113(.a(new_n55_), .b(new_n129_), .c(new_n114_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n153_), .c(new_n156_), .O(new_n160_));
  nand4  g116(.a(new_n153_), .b(new_n55_), .c(x31), .d(x30), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n114_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n135_), .c(x29), .O(new_n164_));
  aoi21  g120(.a(new_n92_), .b(x14), .c(new_n89_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x17), .c(x16), .d(x15), .O(new_n166_));
  nand2  g122(.a(x16), .b(x15), .O(new_n167_));
  nand2  g123(.a(x18), .b(x17), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n167_), .c(new_n92_), .O(new_n169_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n86_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  nand2  g132(.a(new_n89_), .b(new_n176_), .O(new_n177_));
  ...
  aoi21  g140(.a(new_n184_), .b(new_n54_), .c(x26), .O(z9));
endmodule
