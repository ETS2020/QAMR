...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n98_));
  ...
  oai21  g065(.a(x31), .b(x30), .c(new_n45_), .O(new_n110_));
  ...
  nor2   g070(.a(new_n82_), .b(new_n81_), .O(new_n115_));
  ...
  nand4  g074(.a(new_n95_), .b(new_n118_), .c(x30), .d(x29), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n117_), .c(new_n79_), .d(x25), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n116_), .c(new_n112_), .d(new_n110_), .O(z7));
  ...
  nand4  g088(.a(x19), .b(x18), .c(new_n132_), .d(x12), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n131_), .c(new_n125_), .O(new_n134_));
  nand3  g090(.a(x19), .b(x18), .c(x17), .O(new_n135_));
  nor3   g091(.a(new_n135_), .b(x16), .c(new_n45_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n134_), .c(x15), .O(new_n137_));
  inv1   g093(.a(x15), .O(new_n138_));
  inv1   g094(.a(new_n135_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x16), .c(new_n138_), .d(x10), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n124_), .c(x31), .d(new_n102_), .O(new_n142_));
  ...
  nand4  g102(.a(x19), .b(x18), .c(x17), .d(new_n125_), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n134_), .c(x15), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n140_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n124_), .c(x31), .d(x30), .O(new_n151_));
  nand2  g107(.a(x32), .b(new_n102_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n146_), .O(new_n154_));
  nand2  g110(.a(new_n128_), .b(x14), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(x18), .c(x17), .d(x16), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(new_n138_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x15), .O(new_n158_));
  nand2  g114(.a(x18), .b(x17), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n128_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x10), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(new_n138_), .O(new_n162_));
  oai21  g118(.a(new_n159_), .b(new_n45_), .c(new_n125_), .O(new_n163_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n163_), .c(new_n162_), .d(new_n160_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n157_), .c(x32), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n154_), .c(new_n145_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n79_), .c(x00), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n46_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n141_), .b(new_n172_), .c(new_n118_), .d(new_n102_), .O(new_n173_));
  ...
  nand4  g132(.a(new_n150_), .b(new_n172_), .c(x31), .d(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n102_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n123_), .c(x29), .O(new_n180_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n163_), .c(new_n162_), .d(new_n160_), .O(new_n186_));
