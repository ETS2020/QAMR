...
module FAU ( 
  ...
  inv1   g014(.a(x07), .O(new_n59_));
  nand2  g015(.a(new_n45_), .b(new_n59_), .O(new_n60_));
  oai21  g016(.a(new_n60_), .b(x04), .c(new_n58_), .O(new_n61_));
  ...
  oai21  g029(.a(new_n60_), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n63_), .c(new_n47_), .d(new_n85_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n84_), .c(x25), .d(x01), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z3));
  nand3  g057(.a(new_n47_), .b(x28), .c(new_n85_), .O(new_n102_));
  oai21  g058(.a(x28), .b(new_n85_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n97_), .c(new_n63_), .d(new_n84_), .O(new_n104_));
  ...
  nor2   g065(.a(new_n109_), .b(new_n85_), .O(new_n110_));
  nand3  g066(.a(new_n108_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n108_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n97_), .c(new_n63_), .d(new_n47_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n84_), .c(x25), .d(x01), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(z5));
  nand3  g072(.a(x29), .b(x28), .c(x27), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand3  g074(.a(new_n110_), .b(new_n45_), .c(x29), .O(new_n119_));
  oai21  g075(.a(new_n118_), .b(new_n45_), .c(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n97_), .c(new_n63_), .d(new_n84_), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x25), .c(x01), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n47_), .O(z6));
  nand3  g080(.a(new_n94_), .b(new_n91_), .c(new_n88_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n95_), .O(new_n126_));
  nand4  g082(.a(new_n63_), .b(new_n84_), .c(x25), .d(x01), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n126_), .c(new_n47_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  inv1   g085(.a(new_n110_), .O(new_n130_));
  nand3  g086(.a(new_n129_), .b(x30), .c(x29), .O(new_n131_));
  oai22  g087(.a(new_n131_), .b(new_n130_), .c(new_n118_), .d(new_n129_), .O(new_n132_));
  aoi22  g088(.a(new_n132_), .b(x07), .c(x31), .d(new_n45_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n128_), .O(z7));
  nand2  g090(.a(new_n109_), .b(new_n85_), .O(new_n135_));
  inv1   g091(.a(x32), .O(new_n136_));
  nand3  g092(.a(x19), .b(new_n92_), .c(x13), .O(new_n137_));
  inv1   g093(.a(x19), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x18), .c(x14), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n137_), .c(new_n89_), .O(new_n140_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n136_), .c(x31), .d(new_n45_), .O(new_n153_));
  nand2  g109(.a(x32), .b(x30), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n135_), .c(x29), .O(new_n156_));
  nand2  g112(.a(new_n135_), .b(x29), .O(new_n157_));
  nand4  g113(.a(new_n152_), .b(new_n136_), .c(x31), .d(x30), .O(new_n158_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n84_), .c(x00), .O(new_n178_));
  ...
  nand2  g138(.a(new_n157_), .b(new_n129_), .O(new_n183_));
  nor2   g139(.a(new_n129_), .b(new_n108_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n135_), .c(new_n45_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(x07), .c(new_n183_), .d(new_n45_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand4  g144(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n189_));
  oai22  g145(.a(new_n189_), .b(new_n59_), .c(new_n183_), .d(x30), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n152_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(x33), .c(new_n188_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n84_), .c(x00), .O(new_n193_));
