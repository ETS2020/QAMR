...
module FAU ( 
  ...
  nand4  g068(.a(new_n112_), .b(new_n61_), .c(x25), .d(x01), .O(new_n113_));
  ...
  nand3  g074(.a(new_n61_), .b(x01), .c(x00), .O(new_n119_));
  ...
  nand2  g083(.a(new_n98_), .b(new_n79_), .O(new_n128_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n48_), .c(x31), .d(new_n107_), .O(new_n144_));
  nand2  g100(.a(x32), .b(x30), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n128_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n128_), .b(x29), .O(new_n148_));
  nand4  g104(.a(new_n143_), .b(new_n48_), .c(x31), .d(x30), .O(new_n149_));
  nand2  g105(.a(x32), .b(new_n107_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g108(.a(new_n87_), .b(x14), .O(new_n153_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n87_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x10), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(new_n141_), .O(new_n162_));
  inv1   g118(.a(x11), .O(new_n163_));
  oai21  g119(.a(new_n159_), .b(new_n163_), .c(new_n135_), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  nor2   g121(.a(x18), .b(x13), .O(new_n166_));
  nor3   g122(.a(new_n166_), .b(new_n165_), .c(new_n123_), .O(new_n167_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n152_), .c(new_n147_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n122_), .c(x00), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(z8));
  nand4  g128(.a(new_n143_), .b(new_n52_), .c(x31), .d(x30), .O(new_n173_));
  oai21  g129(.a(new_n52_), .b(x30), .c(new_n173_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n128_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n143_), .b(new_n52_), .c(new_n123_), .d(new_n107_), .O(new_n176_));
  oai21  g132(.a(new_n52_), .b(new_n107_), .c(new_n176_), .O(new_n177_));
  inv1   g133(.a(new_n165_), .O(new_n178_));
  inv1   g134(.a(new_n166_), .O(new_n179_));
  xnor2a g135(.a(x31), .b(x30), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n178_), .d(new_n164_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n162_), .c(new_n160_), .d(new_n156_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x00), .O(new_n185_));
  aoi21  g141(.a(new_n177_), .b(new_n148_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n175_), .c(x26), .O(z9));
endmodule
