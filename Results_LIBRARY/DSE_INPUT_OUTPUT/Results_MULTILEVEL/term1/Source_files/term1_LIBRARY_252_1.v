...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n94_), .c(new_n61_), .d(new_n81_), .O(new_n99_));
  ...
  oai21  g065(.a(x31), .b(new_n59_), .c(new_n45_), .O(new_n110_));
  ...
  nor3   g095(.a(new_n139_), .b(new_n138_), .c(new_n118_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n137_), .c(new_n134_), .d(new_n132_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n129_), .c(new_n57_), .O(new_n142_));
  nor2   g098(.a(x28), .b(x27), .O(new_n143_));
  nor3   g099(.a(new_n143_), .b(new_n45_), .c(new_n95_), .O(new_n144_));
  inv1   g100(.a(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x29), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n45_), .c(new_n144_), .d(x01), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n142_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nand3  g106(.a(new_n146_), .b(x30), .c(x01), .O(new_n151_));
  nand3  g107(.a(new_n145_), .b(new_n45_), .c(x29), .O(new_n152_));
  ...
  nand3  g132(.a(new_n176_), .b(new_n145_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n168_), .b(new_n173_), .c(new_n118_), .d(new_n45_), .O(new_n178_));
  nand2  g134(.a(x33), .b(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n146_), .O(new_n181_));
