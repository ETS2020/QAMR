...
module FAU ( 
  ...
  nand3  g050(.a(new_n45_), .b(new_n94_), .c(x27), .O(new_n95_));
  ...
  xnor2a g054(.a(x29), .b(x27), .O(new_n99_));
  inv1   g055(.a(x29), .O(new_n100_));
  nor2   g056(.a(x30), .b(new_n100_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n94_), .O(new_n102_));
  oai21  g058(.a(new_n99_), .b(new_n94_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n93_), .c(new_n59_), .O(z5));
  xor2a  g061(.a(x30), .b(x27), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x29), .c(x28), .O(new_n107_));
  nor2   g063(.a(new_n45_), .b(x29), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x25), .c(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n47_), .O(z6));
  ...
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n124_), .O(new_n133_));
  ...
  aoi21  g098(.a(new_n138_), .b(new_n137_), .c(new_n142_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n136_), .c(new_n133_), .d(new_n130_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n128_), .c(new_n47_), .O(new_n145_));
  aoi21  g101(.a(new_n94_), .b(new_n81_), .c(new_n100_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(x30), .O(new_n147_));
  nor2   g103(.a(new_n45_), .b(new_n100_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(x28), .c(new_n147_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  oai21  g108(.a(new_n108_), .b(new_n101_), .c(x28), .O(new_n153_));
  nand2  g109(.a(new_n101_), .b(x27), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n140_), .c(x13), .O(new_n156_));
  nand3  g112(.a(new_n125_), .b(x18), .c(x14), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n137_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(new_n137_), .d(x12), .O(new_n159_));
  ...
  aoi21  g128(.a(new_n164_), .b(new_n161_), .c(new_n124_), .O(new_n173_));
  inv1   g129(.a(new_n167_), .O(new_n174_));
  aoi22  g130(.a(new_n45_), .b(new_n100_), .c(new_n94_), .d(new_n81_), .O(new_n175_));
  ...
  oai21  g134(.a(new_n146_), .b(x31), .c(new_n45_), .O(new_n179_));
  oai21  g135(.a(new_n118_), .b(new_n100_), .c(x30), .O(new_n180_));
  nand2  g136(.a(new_n138_), .b(new_n137_), .O(new_n181_));
  nand4  g137(.a(new_n141_), .b(new_n181_), .c(new_n136_), .d(new_n133_), .O(new_n182_));
  aoi21  g138(.a(new_n129_), .b(new_n125_), .c(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n180_), .c(new_n179_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n128_), .c(x33), .O(new_n185_));
  oai21  g141(.a(new_n178_), .b(x33), .c(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n80_), .c(x00), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n47_), .O(z9));
endmodule
