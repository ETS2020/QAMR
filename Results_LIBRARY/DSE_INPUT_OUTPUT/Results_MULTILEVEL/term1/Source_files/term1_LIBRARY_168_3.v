...
module FAU ( 
  ...
  nand2  g016(.a(new_n46_), .b(x07), .O(new_n61_));
  oai21  g017(.a(new_n61_), .b(new_n59_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g029(.a(new_n61_), .b(x04), .c(new_n73_), .O(new_n74_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n64_), .c(new_n48_), .d(new_n85_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n84_), .c(x25), .d(x01), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z3));
  nand3  g057(.a(new_n48_), .b(x28), .c(new_n85_), .O(new_n102_));
  oai21  g058(.a(x28), .b(new_n85_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n97_), .c(new_n64_), .d(new_n84_), .O(new_n104_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n97_), .c(new_n64_), .d(new_n48_), .O(new_n113_));
  ...
  nand3  g074(.a(new_n110_), .b(new_n46_), .c(x29), .O(new_n119_));
  oai21  g075(.a(new_n118_), .b(new_n46_), .c(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n97_), .c(new_n64_), .d(new_n84_), .O(new_n121_));
  ...
  nand4  g082(.a(new_n64_), .b(new_n84_), .c(x25), .d(x01), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n126_), .c(new_n48_), .O(new_n128_));
  ...
  aoi22  g088(.a(new_n132_), .b(new_n45_), .c(x31), .d(new_n46_), .O(new_n133_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n136_), .c(x31), .d(new_n46_), .O(new_n153_));
  ...
  aoi21  g140(.a(new_n184_), .b(new_n135_), .c(new_n46_), .O(new_n185_));
  ...
  oai22  g145(.a(new_n189_), .b(x07), .c(new_n183_), .d(x30), .O(new_n190_));
