...
module FAU ( 
  ...
  aoi21  g056(.a(new_n100_), .b(x30), .c(x26), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n60_), .d(x30), .O(new_n108_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n102_), .c(new_n60_), .d(x30), .O(new_n113_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n60_), .c(x25), .d(x01), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n120_), .c(new_n118_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x30), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n79_), .O(z7));
  inv1   g083(.a(x32), .O(new_n128_));
  nand2  g084(.a(new_n103_), .b(new_n80_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x29), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n85_), .c(x13), .O(new_n131_));
  nand3  g087(.a(new_n88_), .b(x18), .c(x14), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n82_), .O(new_n133_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n130_), .c(new_n128_), .d(x31), .O(new_n146_));
  aoi21  g102(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x17), .c(x16), .d(x15), .O(new_n148_));
  nand2  g104(.a(x16), .b(x15), .O(new_n149_));
  nand2  g105(.a(x18), .b(x17), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n88_), .O(new_n151_));
  ...
  nand2  g112(.a(new_n156_), .b(new_n82_), .O(new_n157_));
  inv1   g113(.a(x13), .O(new_n158_));
  aoi21  g114(.a(new_n85_), .b(new_n158_), .c(new_n121_), .O(new_n159_));
  ...
  nand4  g120(.a(new_n164_), .b(x30), .c(new_n79_), .d(x00), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n145_), .b(new_n129_), .c(new_n167_), .d(x31), .O(new_n168_));
  nand2  g124(.a(new_n85_), .b(new_n158_), .O(new_n169_));
  nor2   g125(.a(new_n121_), .b(new_n105_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n169_), .c(new_n157_), .d(new_n129_), .O(new_n171_));
  ...
  oai21  g131(.a(new_n168_), .b(new_n105_), .c(new_n175_), .O(new_n176_));
