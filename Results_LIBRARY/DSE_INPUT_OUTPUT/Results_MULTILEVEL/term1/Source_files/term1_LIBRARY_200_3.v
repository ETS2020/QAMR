...
module FAU ( 
  ...
  nand3  g003(.a(new_n47_), .b(new_n45_), .c(x03), .O(new_n48_));
  ...
  inv1   g011(.a(x32), .O(new_n56_));
  nand2  g012(.a(new_n47_), .b(new_n56_), .O(new_n57_));
  nand3  g013(.a(new_n57_), .b(new_n55_), .c(new_n50_), .O(z1));
  ...
  nand4  g030(.a(x06), .b(x05), .c(new_n52_), .d(new_n51_), .O(new_n75_));
  ...
  nand4  g071(.a(new_n62_), .b(new_n82_), .c(x25), .d(x01), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n80_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n56_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(x30), .c(new_n118_), .O(new_n121_));
  nor4   g077(.a(new_n119_), .b(x32), .c(x31), .d(new_n45_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n117_), .O(z7));
  nor2   g080(.a(x28), .b(x27), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n45_), .c(x29), .O(new_n127_));
  nor2   g083(.a(new_n125_), .b(new_n100_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n45_), .c(new_n127_), .O(new_n129_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(new_n56_), .d(x31), .O(new_n148_));
  aoi21  g104(.a(new_n133_), .b(x14), .c(new_n131_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x17), .c(x16), .d(x15), .O(new_n150_));
  nand2  g106(.a(x16), .b(x15), .O(new_n151_));
  nand2  g107(.a(x18), .b(x17), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n133_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(new_n145_), .O(new_n155_));
  inv1   g111(.a(x11), .O(new_n156_));
  oai21  g112(.a(new_n152_), .b(new_n156_), .c(new_n139_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand2  g114(.a(x18), .b(x12), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n130_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  nand2  g117(.a(new_n131_), .b(new_n161_), .O(new_n162_));
  nor2   g118(.a(new_n118_), .b(new_n100_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n160_), .d(new_n126_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n158_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n155_), .c(new_n153_), .d(new_n150_), .O(new_n166_));
  ...
  nand4  g126(.a(new_n147_), .b(new_n47_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n45_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n126_), .c(x29), .O(new_n174_));
  inv1   g130(.a(new_n128_), .O(new_n175_));
  nand4  g131(.a(new_n147_), .b(new_n47_), .c(new_n118_), .d(new_n45_), .O(new_n176_));
  ...
  nand4  g136(.a(new_n180_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n155_), .c(new_n153_), .d(new_n150_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n179_), .c(new_n174_), .O(new_n185_));
