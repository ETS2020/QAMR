...
module FAU ( 
  ...
  oai21  g077(.a(new_n45_), .b(new_n79_), .c(new_n121_), .O(z7));
  ...
  nand4  g125(.a(new_n142_), .b(new_n45_), .c(x31), .d(x30), .O(new_n170_));
  nand3  g126(.a(x33), .b(new_n101_), .c(new_n79_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n123_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n142_), .b(new_n45_), .c(new_n116_), .d(new_n101_), .O(new_n174_));
  nand3  g130(.a(x33), .b(x30), .c(new_n79_), .O(new_n175_));
  ...
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n161_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n159_), .c(new_n157_), .d(new_n178_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(x33), .c(new_n79_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n177_), .c(new_n173_), .O(new_n186_));
