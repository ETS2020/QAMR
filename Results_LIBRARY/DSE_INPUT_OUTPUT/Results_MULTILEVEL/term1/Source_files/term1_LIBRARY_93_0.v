...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n79_), .c(x29), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x28), .c(x27), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n98_), .c(new_n61_), .d(x30), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x25), .c(x01), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(x30), .c(x26), .O(z5));
  inv1   g063(.a(x26), .O(new_n108_));
  nand3  g064(.a(x29), .b(x28), .c(x27), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n98_), .c(new_n61_), .d(x30), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n108_), .c(x25), .d(x01), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z6));
  nand2  g069(.a(new_n109_), .b(x31), .O(new_n114_));
  inv1   g070(.a(new_n80_), .O(new_n115_));
  nand4  g071(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n61_), .b(x25), .c(x01), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x29), .c(x28), .d(x27), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x30), .c(new_n108_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n116_), .c(new_n114_), .O(z7));
  nand2  g078(.a(new_n99_), .b(new_n79_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x29), .O(new_n124_));
  nand3  g080(.a(x19), .b(new_n84_), .c(x13), .O(new_n125_));
  nand3  g081(.a(new_n87_), .b(x18), .c(x14), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n125_), .c(new_n81_), .O(new_n127_));
  nand4  g083(.a(x19), .b(x18), .c(new_n81_), .d(x12), .O(new_n128_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n124_), .c(new_n48_), .d(x31), .O(new_n140_));
  aoi21  g096(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(x17), .c(x16), .d(x15), .O(new_n142_));
  nand2  g098(.a(x16), .b(x15), .O(new_n143_));
  nand2  g099(.a(x18), .b(x17), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(new_n87_), .O(new_n145_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n81_), .O(new_n151_));
  inv1   g107(.a(x13), .O(new_n152_));
  aoi21  g108(.a(new_n84_), .b(new_n152_), .c(new_n118_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n151_), .c(new_n149_), .d(new_n147_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n145_), .c(new_n142_), .d(new_n124_), .O(new_n156_));
  ...
  aoi21  g115(.a(new_n159_), .b(x30), .c(x26), .O(z8));
  nand4  g116(.a(new_n139_), .b(new_n123_), .c(new_n52_), .d(x31), .O(new_n161_));
  nand2  g117(.a(new_n84_), .b(new_n152_), .O(new_n162_));
  nor2   g118(.a(new_n118_), .b(new_n101_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n151_), .d(new_n123_), .O(new_n164_));
  ...
  oai21  g124(.a(new_n161_), .b(new_n101_), .c(new_n168_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x00), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(x30), .c(x26), .O(z9));
endmodule
