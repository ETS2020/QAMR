...
module FAU ( 
  ...
  oai21  g023(.a(new_n67_), .b(new_n63_), .c(new_n46_), .O(new_n68_));
  inv1   g024(.a(new_n64_), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n62_), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(new_n71_));
  oai21  g027(.a(new_n71_), .b(new_n63_), .c(new_n45_), .O(new_n72_));
  aoi21  g028(.a(new_n72_), .b(new_n68_), .c(new_n61_), .O(new_n73_));
  xor2a  g029(.a(x07), .b(x04), .O(new_n74_));
  aoi21  g030(.a(new_n46_), .b(x03), .c(new_n45_), .O(new_n75_));
  nand4  g031(.a(new_n56_), .b(new_n46_), .c(x06), .d(x05), .O(new_n76_));
  oai21  g032(.a(new_n75_), .b(new_n69_), .c(new_n76_), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(new_n62_), .O(new_n78_));
  nand2  g034(.a(new_n46_), .b(x01), .O(new_n79_));
  aoi21  g035(.a(new_n79_), .b(x05), .c(x03), .O(new_n80_));
  nand4  g036(.a(new_n49_), .b(x03), .c(new_n53_), .d(x01), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  aoi21  g038(.a(new_n80_), .b(x02), .c(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n78_), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n74_), .c(new_n73_), .O(new_n85_));
  nor3   g041(.a(new_n85_), .b(x09), .c(new_n60_), .O(z2));
  ...
  nand3  g058(.a(new_n102_), .b(new_n89_), .c(new_n49_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n88_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n87_), .c(x25), .d(x01), .O(new_n107_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n87_), .c(x25), .d(x01), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z4));
  nand2  g069(.a(x30), .b(x05), .O(new_n114_));
  inv1   g070(.a(x29), .O(new_n115_));
  inv1   g071(.a(x28), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n88_), .O(new_n117_));
  nand3  g073(.a(new_n115_), .b(x28), .c(x27), .O(new_n118_));
  oai21  g074(.a(new_n117_), .b(new_n115_), .c(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n114_), .c(new_n102_), .d(new_n89_), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n87_), .c(x25), .d(x01), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(z5));
  inv1   g079(.a(x25), .O(new_n124_));
  nand2  g080(.a(new_n117_), .b(x29), .O(new_n125_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n102_), .c(new_n89_), .d(new_n87_), .O(new_n129_));
  nor3   g085(.a(new_n129_), .b(new_n124_), .c(new_n62_), .O(z6));
  ...
  nand4  g089(.a(new_n101_), .b(new_n98_), .c(new_n95_), .d(new_n92_), .O(new_n134_));
  nor2   g090(.a(new_n55_), .b(new_n62_), .O(new_n135_));
  inv1   g091(.a(x31), .O(new_n136_));
  nand4  g092(.a(new_n117_), .b(new_n136_), .c(x30), .d(x29), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n87_), .d(x25), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n134_), .c(new_n133_), .d(new_n131_), .O(z7));
  nand2  g096(.a(new_n116_), .b(new_n88_), .O(new_n141_));
  nand3  g097(.a(x19), .b(new_n96_), .c(x13), .O(new_n142_));
  nand3  g098(.a(new_n99_), .b(x18), .c(x14), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n142_), .c(new_n93_), .O(new_n144_));
  nand4  g100(.a(x19), .b(x18), .c(new_n93_), .d(x12), .O(new_n145_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n50_), .c(x31), .d(new_n46_), .O(new_n157_));
  nand2  g113(.a(x32), .b(x30), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n141_), .c(x29), .O(new_n160_));
  nand2  g116(.a(new_n141_), .b(x29), .O(new_n161_));
  nand4  g117(.a(new_n156_), .b(new_n50_), .c(x31), .d(x30), .O(new_n162_));
  ...
  nand2  g121(.a(new_n99_), .b(x14), .O(new_n166_));
  ...
  oai21  g126(.a(new_n170_), .b(new_n169_), .c(new_n99_), .O(new_n171_));
  ...
  nor3   g133(.a(new_n177_), .b(new_n176_), .c(new_n136_), .O(new_n178_));
  ...
  nand3  g137(.a(new_n181_), .b(new_n87_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n49_), .O(z8));
  nor2   g139(.a(new_n177_), .b(new_n176_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n175_), .c(new_n173_), .d(new_n171_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n168_), .c(new_n49_), .O(new_n186_));
  nand2  g142(.a(new_n161_), .b(new_n136_), .O(new_n187_));
  nor2   g143(.a(new_n136_), .b(new_n115_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n141_), .c(new_n46_), .O(new_n189_));
  aoi22  g145(.a(new_n189_), .b(new_n45_), .c(new_n187_), .d(new_n46_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand4  g148(.a(new_n141_), .b(x31), .c(x30), .d(x29), .O(new_n193_));
  oai22  g149(.a(new_n193_), .b(x05), .c(new_n187_), .d(x30), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n156_), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(x33), .c(new_n192_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n87_), .c(x00), .O(new_n197_));
