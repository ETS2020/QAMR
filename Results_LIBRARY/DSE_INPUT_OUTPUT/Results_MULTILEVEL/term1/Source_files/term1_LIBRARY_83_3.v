...
module FAU ( 
  ...
  nand4  g078(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(x23), .O(new_n123_));
  ...
  nand2  g101(.a(x17), .b(x16), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x15), .c(x13), .O(new_n148_));
  nor2   g104(.a(x32), .b(new_n136_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n46_), .c(x19), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n148_), .c(new_n145_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n45_), .O(new_n152_));
  inv1   g108(.a(x16), .O(new_n153_));
  inv1   g109(.a(x17), .O(new_n154_));
  nand3  g110(.a(x19), .b(new_n154_), .c(x12), .O(new_n155_));
  inv1   g111(.a(x19), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(x17), .c(x14), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n155_), .c(new_n153_), .O(new_n158_));
  nor2   g114(.a(new_n156_), .b(new_n154_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n153_), .c(x11), .O(new_n160_));
  ...
  aoi21  g120(.a(new_n164_), .b(new_n162_), .c(x32), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x31), .c(new_n46_), .d(x18), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n152_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n144_), .c(x29), .O(new_n168_));
  nor2   g124(.a(new_n143_), .b(new_n112_), .O(new_n169_));
  nand2  g125(.a(x32), .b(new_n46_), .O(new_n170_));
  inv1   g126(.a(new_n148_), .O(new_n171_));
  nor2   g127(.a(new_n156_), .b(x18), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n149_), .c(new_n171_), .d(x30), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n170_), .c(new_n169_), .O(new_n174_));
  aoi21  g130(.a(new_n156_), .b(x14), .c(new_n45_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x17), .c(x16), .d(x15), .O(new_n176_));
  oai21  g132(.a(new_n146_), .b(new_n163_), .c(new_n156_), .O(new_n177_));
  inv1   g133(.a(x10), .O(new_n178_));
  oai21  g134(.a(new_n146_), .b(new_n178_), .c(new_n163_), .O(new_n179_));
  aoi21  g135(.a(x17), .b(x11), .c(x16), .O(new_n180_));
  oai21  g136(.a(x17), .b(x12), .c(x31), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n179_), .c(new_n177_), .d(new_n176_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n46_), .O(new_n184_));
  nand3  g140(.a(x16), .b(x15), .c(x13), .O(new_n185_));
  nand3  g141(.a(x31), .b(x19), .c(x17), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n185_), .c(new_n45_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n184_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(x32), .c(new_n174_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n168_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n82_), .c(x00), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(z8));
  inv1   g148(.a(new_n169_), .O(new_n193_));
  inv1   g149(.a(x33), .O(new_n194_));
  nand3  g150(.a(new_n156_), .b(x18), .c(x14), .O(new_n195_));
  nand4  g151(.a(new_n46_), .b(x19), .c(new_n45_), .d(x13), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n195_), .c(new_n154_), .O(new_n197_));
  nand4  g153(.a(x19), .b(x18), .c(new_n154_), .d(x12), .O(new_n198_));
  inv1   g154(.a(new_n198_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n197_), .c(x16), .O(new_n200_));
  nand3  g156(.a(x19), .b(x18), .c(x17), .O(new_n201_));
  inv1   g157(.a(new_n201_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n153_), .c(x11), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(new_n200_), .c(new_n163_), .O(new_n204_));
  nor4   g160(.a(new_n201_), .b(new_n153_), .c(x15), .d(new_n178_), .O(new_n205_));
  oai21  g161(.a(new_n205_), .b(new_n204_), .c(new_n194_), .O(new_n206_));
  ...
  oai21  g165(.a(new_n46_), .b(x18), .c(x33), .O(new_n210_));
  nand4  g166(.a(new_n194_), .b(x31), .c(x30), .d(x19), .O(new_n211_));
  oai21  g167(.a(new_n211_), .b(new_n148_), .c(new_n210_), .O(new_n212_));
  nand3  g168(.a(new_n212_), .b(new_n144_), .c(x29), .O(new_n213_));
  inv1   g169(.a(new_n213_), .O(new_n214_));
  nand2  g170(.a(new_n156_), .b(x14), .O(new_n215_));
  nand4  g171(.a(new_n215_), .b(x17), .c(x16), .d(x15), .O(new_n216_));
  nand2  g172(.a(new_n216_), .b(new_n136_), .O(new_n217_));
  nand2  g173(.a(new_n217_), .b(x18), .O(new_n218_));
  nand2  g174(.a(x16), .b(x15), .O(new_n219_));
  nand2  g175(.a(x18), .b(x17), .O(new_n220_));
  oai21  g176(.a(new_n220_), .b(new_n219_), .c(new_n156_), .O(new_n221_));
  nand4  g177(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n222_));
  inv1   g178(.a(x11), .O(new_n223_));
  oai21  g179(.a(new_n220_), .b(new_n223_), .c(new_n153_), .O(new_n224_));
  nand2  g180(.a(x18), .b(x12), .O(new_n225_));
  nand2  g181(.a(new_n225_), .b(new_n154_), .O(new_n226_));
  inv1   g182(.a(x13), .O(new_n227_));
  nand2  g183(.a(new_n45_), .b(new_n227_), .O(new_n228_));
  xnor2a g184(.a(x31), .b(x30), .O(new_n229_));
  nand4  g185(.a(new_n229_), .b(new_n228_), .c(new_n226_), .d(new_n224_), .O(new_n230_));
  aoi21  g186(.a(new_n222_), .b(new_n163_), .c(new_n230_), .O(new_n231_));
  nand3  g187(.a(new_n231_), .b(new_n221_), .c(new_n218_), .O(new_n232_));
  aoi21  g188(.a(new_n232_), .b(x33), .c(new_n214_), .O(new_n233_));
  nand2  g189(.a(new_n233_), .b(new_n209_), .O(new_n234_));
  nand3  g190(.a(new_n234_), .b(new_n82_), .c(x00), .O(new_n235_));
  nand2  g191(.a(new_n235_), .b(new_n48_), .O(z9));
endmodule
