...
module FAU ( 
  ...
  aoi21  g052(.a(new_n96_), .b(new_n80_), .c(x26), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n95_), .c(new_n45_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(x25), .c(new_n80_), .d(x01), .O(new_n101_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n61_), .d(new_n45_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(x25), .c(new_n80_), .d(x01), .O(new_n111_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n103_), .c(new_n61_), .d(new_n45_), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x25), .c(new_n80_), .d(x01), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(z6));
  nand3  g077(.a(new_n106_), .b(x30), .c(x29), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x31), .O(new_n123_));
  nor2   g079(.a(new_n85_), .b(new_n83_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n91_), .c(new_n88_), .d(x18), .O(new_n125_));
  ...
  nand2  g088(.a(new_n132_), .b(new_n80_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n45_), .O(z7));
  nand2  g090(.a(new_n105_), .b(new_n81_), .O(new_n135_));
  inv1   g091(.a(x32), .O(new_n136_));
  nand3  g092(.a(x19), .b(new_n82_), .c(x13), .O(new_n137_));
  ...
  nand2  g115(.a(new_n89_), .b(x14), .O(new_n160_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n89_), .O(new_n165_));
  ...
  nor3   g127(.a(new_n171_), .b(new_n170_), .c(new_n128_), .O(new_n172_));
  ...
  aoi21  g151(.a(new_n195_), .b(new_n80_), .c(x26), .O(z9));
endmodule
