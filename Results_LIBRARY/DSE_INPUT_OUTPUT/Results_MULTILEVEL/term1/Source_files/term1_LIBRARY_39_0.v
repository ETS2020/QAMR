...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(x31), .c(new_n96_), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n95_), .c(new_n61_), .d(new_n79_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n94_), .c(new_n60_), .O(z5));
  ...
  nand4  g063(.a(new_n107_), .b(new_n61_), .c(new_n79_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n60_), .c(new_n47_), .O(z6));
  nor4   g065(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n110_));
  nand4  g066(.a(new_n61_), .b(new_n79_), .c(x25), .d(x01), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(new_n47_), .O(new_n112_));
  nand3  g068(.a(new_n97_), .b(x30), .c(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand4  g071(.a(new_n97_), .b(new_n115_), .c(x30), .d(x29), .O(new_n116_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n48_), .c(x31), .d(new_n102_), .O(new_n137_));
  nand2  g093(.a(x32), .b(x30), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n137_), .c(new_n118_), .O(new_n139_));
  nor2   g095(.a(new_n48_), .b(x31), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x29), .O(new_n141_));
  nor2   g097(.a(new_n118_), .b(new_n96_), .O(new_n142_));
  nand3  g098(.a(new_n136_), .b(new_n48_), .c(x30), .O(new_n143_));
  ...
  aoi21  g115(.a(new_n148_), .b(x15), .c(new_n159_), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n48_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n145_), .c(x31), .O(new_n162_));
  ...
  nor2   g121(.a(x30), .b(x28), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n80_), .c(x31), .O(new_n167_));
  inv1   g123(.a(new_n118_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(x30), .c(x29), .O(new_n169_));
  aoi22  g125(.a(new_n169_), .b(x31), .c(new_n167_), .d(x29), .O(new_n170_));
  oai21  g126(.a(new_n160_), .b(new_n45_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x33), .O(new_n172_));
  nand3  g128(.a(new_n168_), .b(x31), .c(x30), .O(new_n173_));
  nand3  g129(.a(new_n118_), .b(new_n115_), .c(new_n102_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n136_), .c(new_n52_), .d(x29), .O(new_n176_));
