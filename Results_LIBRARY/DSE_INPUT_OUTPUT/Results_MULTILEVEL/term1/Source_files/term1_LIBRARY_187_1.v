...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n62_), .c(new_n80_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n81_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n62_), .c(new_n80_), .O(z4));
  inv1   g056(.a(x25), .O(new_n101_));
  inv1   g057(.a(new_n59_), .O(new_n102_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n102_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n101_), .c(new_n62_), .O(z5));
  nand3  g066(.a(new_n45_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n106_), .b(new_n45_), .c(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x29), .c(x01), .O(new_n113_));
  oai21  g069(.a(new_n45_), .b(x29), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n103_), .c(new_n102_), .d(new_n81_), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n101_), .c(new_n80_), .O(z6));
  nand3  g072(.a(new_n106_), .b(x30), .c(x29), .O(new_n117_));
  ...
  nor2   g076(.a(new_n59_), .b(new_n62_), .O(new_n121_));
  inv1   g077(.a(new_n106_), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x30), .c(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(new_n81_), .O(new_n125_));
  ...
  nand2  g084(.a(new_n90_), .b(x14), .O(new_n129_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n132_), .c(new_n90_), .O(new_n134_));
  ...
  nor3   g097(.a(new_n141_), .b(new_n140_), .c(new_n123_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n131_), .c(new_n80_), .O(new_n144_));
  nor2   g100(.a(x28), .b(x27), .O(new_n145_));
  nor3   g101(.a(new_n145_), .b(new_n45_), .c(new_n104_), .O(new_n146_));
  inv1   g102(.a(new_n145_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(new_n45_), .c(new_n146_), .d(x01), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand3  g108(.a(new_n148_), .b(x30), .c(x01), .O(new_n153_));
  nand3  g109(.a(new_n147_), .b(new_n45_), .c(x29), .O(new_n154_));
  ...
  nand3  g132(.a(new_n176_), .b(new_n147_), .c(x29), .O(new_n177_));
  nand4  g133(.a(new_n168_), .b(new_n173_), .c(new_n123_), .d(new_n45_), .O(new_n178_));
