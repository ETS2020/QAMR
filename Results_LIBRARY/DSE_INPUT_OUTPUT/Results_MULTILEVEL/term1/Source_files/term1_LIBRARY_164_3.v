...
module FAU ( 
  ...
  oai21  g066(.a(new_n110_), .b(new_n59_), .c(new_n79_), .O(z6));
  ...
  nand4  g099(.a(new_n143_), .b(z0), .c(x31), .d(new_n104_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n143_), .b(z0), .c(x31), .d(x30), .O(new_n149_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n46_), .c(x00), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(z8));
  nand4  g126(.a(new_n143_), .b(new_n47_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n104_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n125_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n143_), .b(new_n47_), .c(new_n120_), .d(new_n104_), .O(new_n175_));
