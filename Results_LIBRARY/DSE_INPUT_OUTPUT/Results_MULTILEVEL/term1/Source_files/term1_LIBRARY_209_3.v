...
module FAU ( 
  ...
  aoi21  g050(.a(new_n94_), .b(new_n91_), .c(new_n58_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n79_), .c(new_n78_), .d(x25), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n57_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n78_), .d(x25), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(new_n57_), .O(z4));
  ...
  nand3  g061(.a(new_n94_), .b(new_n89_), .c(new_n86_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(new_n59_), .d(new_n78_), .O(new_n107_));
  ...
  nand4  g067(.a(new_n89_), .b(new_n85_), .c(new_n82_), .d(x17), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n111_), .c(x30), .O(new_n113_));
  inv1   g069(.a(x30), .O(new_n114_));
  nor2   g070(.a(new_n79_), .b(x17), .O(new_n115_));
  ...
  aoi21  g074(.a(new_n89_), .b(new_n86_), .c(x30), .O(new_n119_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n124_), .c(new_n86_), .O(new_n126_));
  ...
  inv1   g085(.a(new_n103_), .O(new_n130_));
  nand2  g086(.a(new_n111_), .b(x31), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x30), .c(x29), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n130_), .c(new_n131_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  oai21  g091(.a(new_n126_), .b(new_n93_), .c(new_n132_), .O(new_n136_));
  ...
  nor2   g097(.a(new_n141_), .b(new_n80_), .O(new_n142_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(new_n80_), .O(new_n147_));
  inv1   g103(.a(x11), .O(new_n148_));
  oai21  g104(.a(new_n144_), .b(new_n148_), .c(new_n83_), .O(new_n149_));
  aoi21  g105(.a(x18), .b(x12), .c(x17), .O(new_n150_));
  nor2   g106(.a(x18), .b(x13), .O(new_n151_));
  nor3   g107(.a(new_n151_), .b(new_n150_), .c(new_n132_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n142_), .c(new_n45_), .O(new_n154_));
  nand2  g110(.a(new_n102_), .b(new_n79_), .O(new_n155_));
  ...
  aoi22  g114(.a(new_n158_), .b(new_n114_), .c(new_n157_), .d(new_n93_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n154_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x32), .O(new_n161_));
  inv1   g117(.a(x32), .O(new_n162_));
  nand3  g118(.a(new_n158_), .b(x30), .c(new_n93_), .O(new_n163_));
  nand3  g119(.a(new_n155_), .b(new_n114_), .c(x29), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  inv1   g121(.a(x18), .O(new_n166_));
  nand3  g122(.a(x19), .b(new_n166_), .c(x13), .O(new_n167_));
  nand3  g123(.a(new_n139_), .b(x18), .c(x14), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n92_), .O(new_n169_));
  nand4  g125(.a(x19), .b(x18), .c(new_n92_), .d(x12), .O(new_n170_));
  ...
  nand3  g130(.a(new_n174_), .b(new_n83_), .c(x11), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x15), .O(new_n177_));
  nand4  g133(.a(new_n174_), .b(x16), .c(new_n80_), .d(x10), .O(new_n178_));
  ...
  nor2   g139(.a(new_n151_), .b(new_n150_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n142_), .c(new_n45_), .O(new_n186_));
  nand2  g142(.a(new_n158_), .b(new_n132_), .O(new_n187_));
  nor2   g143(.a(new_n132_), .b(new_n101_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n155_), .c(new_n114_), .O(new_n189_));
  aoi22  g145(.a(new_n189_), .b(new_n93_), .c(new_n187_), .d(new_n114_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  inv1   g148(.a(x33), .O(new_n193_));
  nand4  g149(.a(new_n155_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  oai22  g150(.a(new_n194_), .b(x22), .c(new_n187_), .d(x30), .O(new_n195_));
