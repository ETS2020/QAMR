...
module FAU ( 
  ...
  nand3  g003(.a(z0), .b(new_n47_), .c(new_n46_), .O(new_n48_));
  ...
  nand3  g009(.a(z0), .b(new_n47_), .c(x03), .O(new_n54_));
  nand3  g010(.a(new_n49_), .b(x32), .c(new_n46_), .O(new_n55_));
  nand2  g011(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g012(.a(new_n56_), .b(new_n53_), .O(new_n57_));
  nand3  g013(.a(new_n49_), .b(z0), .c(new_n47_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n57_), .c(new_n52_), .O(z1));
  ...
  nand4  g031(.a(x06), .b(x05), .c(new_n46_), .d(new_n53_), .O(new_n76_));
  ...
  nand2  g036(.a(z0), .b(x30), .O(new_n81_));
  ...
  nor2   g045(.a(new_n89_), .b(new_n62_), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n81_), .c(new_n84_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n83_), .c(x25), .d(x01), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n90_), .c(new_n81_), .O(new_n96_));
  ...
  nor2   g058(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  nand3  g059(.a(new_n101_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n101_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n63_), .d(new_n83_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n81_), .O(z5));
  nand3  g065(.a(new_n47_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n103_), .b(new_n47_), .c(new_n110_), .O(new_n111_));
  nor2   g067(.a(new_n47_), .b(x29), .O(new_n112_));
  aoi21  g068(.a(new_n111_), .b(x29), .c(new_n112_), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n89_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n63_), .c(new_n83_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n61_), .c(new_n81_), .O(z6));
  nor4   g072(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n117_));
  nand4  g073(.a(new_n63_), .b(new_n83_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n81_), .O(new_n119_));
  ...
  nor4   g079(.a(new_n121_), .b(z0), .c(x31), .d(new_n47_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n119_), .O(z7));
  nand2  g082(.a(new_n102_), .b(new_n84_), .O(new_n127_));
  ...
  nand4  g101(.a(new_n145_), .b(z0), .c(x31), .d(new_n47_), .O(new_n146_));
  ...
  nand2  g135(.a(new_n129_), .b(new_n163_), .O(new_n180_));
  xnor2a g136(.a(x31), .b(x30), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n162_), .d(new_n160_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n158_), .c(new_n156_), .d(new_n151_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n179_), .c(new_n175_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n83_), .c(x00), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n81_), .O(z9));
endmodule
