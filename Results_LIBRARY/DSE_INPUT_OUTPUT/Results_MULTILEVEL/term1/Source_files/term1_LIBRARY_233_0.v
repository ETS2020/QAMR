...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(x00), .c(x26), .O(z3));
  inv1   g048(.a(x26), .O(new_n93_));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n90_), .c(new_n93_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(x25), .c(x01), .d(x00), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z4));
  inv1   g054(.a(new_n58_), .O(new_n99_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n88_), .c(new_n99_), .d(new_n93_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x25), .c(x01), .d(x00), .O(new_n107_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n89_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(x25), .d(x01), .O(new_n114_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n102_), .c(new_n123_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n122_), .c(new_n121_), .d(new_n117_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x00), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n93_), .O(z7));
  nand2  g086(.a(new_n101_), .b(new_n80_), .O(new_n131_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n132_), .c(x31), .d(new_n111_), .O(new_n151_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n136_), .O(new_n165_));
  ...
  nor3   g127(.a(new_n171_), .b(new_n170_), .c(new_n124_), .O(new_n172_));
  ...
  nand3  g150(.a(new_n194_), .b(new_n93_), .c(x00), .O(new_n195_));
