...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n58_), .c(new_n46_), .O(z4));
  ...
  nand3  g058(.a(new_n45_), .b(x28), .c(x27), .O(new_n103_));
  oai21  g059(.a(new_n96_), .b(new_n45_), .c(new_n103_), .O(new_n104_));
  ...
  nor2   g064(.a(new_n108_), .b(new_n58_), .O(z6));
  ...
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(x31), .d(new_n45_), .O(new_n143_));
  ...
  oai22  g127(.a(new_n171_), .b(new_n154_), .c(new_n45_), .d(new_n80_), .O(new_n172_));
  nand2  g128(.a(new_n147_), .b(new_n118_), .O(new_n173_));
  nor2   g129(.a(new_n118_), .b(new_n94_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n123_), .c(new_n45_), .O(new_n175_));
  aoi22  g131(.a(new_n175_), .b(new_n80_), .c(new_n173_), .d(new_n45_), .O(new_n176_));
