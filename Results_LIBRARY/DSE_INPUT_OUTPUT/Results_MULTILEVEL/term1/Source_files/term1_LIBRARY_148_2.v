...
module FAU ( 
  ...
  oai21  g043(.a(new_n87_), .b(new_n59_), .c(new_n47_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n86_), .c(new_n45_), .d(x25), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(new_n59_), .c(new_n47_), .O(z4));
  ...
  nand3  g065(.a(new_n96_), .b(new_n109_), .c(x30), .O(new_n110_));
  ...
  nor2   g072(.a(new_n82_), .b(new_n81_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nor2   g074(.a(new_n60_), .b(new_n92_), .O(new_n119_));
  ...
  nand4  g130(.a(new_n142_), .b(new_n170_), .c(new_n109_), .d(new_n101_), .O(new_n175_));
