...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(x33), .c(x26), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n90_), .c(x33), .O(new_n94_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n88_), .c(new_n61_), .d(x33), .O(new_n102_));
  ...
  aoi21  g067(.a(new_n111_), .b(x33), .c(x26), .O(z6));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n99_), .c(new_n120_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n114_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x33), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n45_), .O(z7));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(x31), .d(new_n108_), .O(new_n149_));
  ...
  nor2   g108(.a(new_n128_), .b(new_n98_), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand4  g110(.a(new_n148_), .b(new_n130_), .c(x31), .d(x30), .O(new_n155_));
  ...
  nor2   g117(.a(new_n132_), .b(new_n131_), .O(new_n162_));
  ...
  nor3   g126(.a(new_n170_), .b(new_n169_), .c(new_n121_), .O(new_n171_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n158_), .c(new_n152_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x00), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(x33), .c(x26), .O(z8));
  oai21  g132(.a(new_n153_), .b(x31), .c(new_n108_), .O(new_n177_));
  nand2  g133(.a(x31), .b(x29), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n128_), .c(x30), .O(new_n179_));
  inv1   g135(.a(new_n164_), .O(new_n180_));
  nor2   g136(.a(new_n170_), .b(new_n169_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n168_), .c(new_n166_), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n180_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n179_), .c(new_n177_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n161_), .c(x00), .O(new_n185_));
