...
module FAU ( 
  ...
  nor2   g079(.a(new_n123_), .b(new_n82_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n114_), .O(z7));
  nand2  g081(.a(new_n97_), .b(new_n83_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n50_), .c(x31), .d(new_n105_), .O(new_n145_));
  ...
  nand4  g131(.a(new_n144_), .b(new_n54_), .c(new_n121_), .d(new_n105_), .O(new_n176_));
