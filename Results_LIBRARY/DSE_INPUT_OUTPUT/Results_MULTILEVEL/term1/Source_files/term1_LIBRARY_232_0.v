...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(new_n81_), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n45_), .c(new_n60_), .O(z4));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n62_), .d(new_n81_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n45_), .c(new_n60_), .O(z5));
  nand3  g057(.a(new_n46_), .b(x28), .c(x27), .O(new_n102_));
  oai21  g058(.a(new_n97_), .b(new_n46_), .c(new_n102_), .O(new_n103_));
  nor2   g059(.a(new_n46_), .b(x29), .O(new_n104_));
  aoi21  g060(.a(new_n103_), .b(x29), .c(new_n104_), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  ...
  nor2   g070(.a(new_n61_), .b(new_n60_), .O(new_n115_));
  inv1   g071(.a(new_n97_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x30), .c(x29), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n116_), .c(new_n81_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n45_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n115_), .c(new_n114_), .d(new_n110_), .O(z7));
  nand2  g077(.a(new_n96_), .b(new_n82_), .O(new_n122_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n123_), .c(x31), .d(new_n46_), .O(new_n142_));
  ...
  nand2  g103(.a(x32), .b(new_n46_), .O(new_n148_));
  ...
  nor3   g118(.a(new_n162_), .b(new_n161_), .c(new_n117_), .O(new_n163_));
  ...
  nor2   g124(.a(new_n162_), .b(new_n161_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n160_), .c(new_n158_), .d(new_n156_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n153_), .c(new_n47_), .O(new_n171_));
  aoi21  g127(.a(new_n146_), .b(new_n117_), .c(x30), .O(new_n172_));
  nor2   g128(.a(new_n117_), .b(new_n95_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n122_), .c(new_n46_), .O(new_n174_));
  aoi21  g130(.a(new_n172_), .b(x25), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  nand4  g133(.a(new_n146_), .b(new_n117_), .c(new_n46_), .d(x25), .O(new_n178_));
  nand4  g134(.a(new_n122_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n141_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(x33), .c(new_n177_), .O(new_n182_));
