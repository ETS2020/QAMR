...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n187_, new_n188_;
  nor2   g000(.a(x26), .b(x14), .O(new_n45_));
  ...
  aoi21  g058(.a(new_n102_), .b(x14), .c(x26), .O(z5));
  ...
  nand3  g063(.a(new_n96_), .b(new_n107_), .c(x29), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n87_), .c(new_n60_), .d(new_n104_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(x25), .c(x14), .d(x01), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z6));
  nand3  g069(.a(new_n96_), .b(x30), .c(x29), .O(new_n114_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n82_), .O(new_n119_));
  nand3  g075(.a(new_n60_), .b(x14), .c(x01), .O(new_n120_));
  ...
  oai21  g109(.a(new_n148_), .b(new_n107_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g111(.a(x16), .b(x15), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  nor2   g113(.a(new_n131_), .b(new_n130_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(x19), .O(new_n159_));
  nand3  g115(.a(new_n158_), .b(x16), .c(x10), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n145_), .O(new_n161_));
  nand2  g117(.a(new_n158_), .b(x11), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n139_), .O(new_n163_));
  nand2  g119(.a(x18), .b(x12), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n130_), .O(new_n165_));
  nor2   g121(.a(x18), .b(x13), .O(new_n166_));
  nor2   g122(.a(new_n156_), .b(new_n140_), .O(new_n167_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n155_), .c(new_n151_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n104_), .c(x14), .d(x00), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n147_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n107_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n128_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n147_), .b(new_n174_), .c(new_n123_), .d(new_n107_), .O(new_n179_));
  ...
  xor2a  g138(.a(x31), .b(x30), .O(new_n183_));
  nor3   g139(.a(new_n183_), .b(new_n167_), .c(new_n166_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n159_), .c(x33), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n182_), .c(new_n178_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x00), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(x14), .c(x26), .O(z9));
endmodule
