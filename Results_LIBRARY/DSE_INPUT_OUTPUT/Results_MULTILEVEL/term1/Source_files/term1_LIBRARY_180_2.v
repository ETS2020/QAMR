...
module FAU ( 
  ...
  nand4  g46(.a(new_n90_), .b(new_n86_), .c(new_n79_), .d(new_n45_), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(x25), .c(x01), .d(new_n77_), .O(new_n93_));
  ...
  nand4  g55(.a(new_n99_), .b(new_n86_), .c(new_n79_), .d(new_n45_), .O(new_n100_));
  inv1   g56(.a(new_n100_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(x25), .c(x01), .d(new_n77_), .O(new_n102_));
  ...
  and2   g64(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n79_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n77_), .c(x26), .O(z6));
  nand2  g67(.a(x30), .b(x29), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n96_), .c(x31), .O(new_n113_));
  nand4  g69(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n114_));
  nand3  g70(.a(new_n79_), .b(x25), .c(x01), .O(new_n115_));
  inv1   g71(.a(new_n115_), .O(new_n116_));
  inv1   g72(.a(x31), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x30), .c(x29), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n96_), .c(new_n46_), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(x26), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n116_), .c(new_n114_), .d(new_n113_), .O(z7));
  inv1   g77(.a(new_n46_), .O(z9));
endmodule
