...
module FAU ( 
  ...
  oai21  g048(.a(x22), .b(x17), .c(new_n92_), .O(new_n93_));
  ...
  nand3  g055(.a(new_n92_), .b(new_n88_), .c(new_n85_), .O(new_n100_));
  aoi22  g056(.a(new_n100_), .b(new_n58_), .c(new_n45_), .d(new_n99_), .O(new_n101_));
  ...
  oai21  g061(.a(new_n105_), .b(new_n82_), .c(x29), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x28), .c(x27), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n101_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n60_), .c(new_n58_), .O(z5));
  nor2   g067(.a(new_n105_), .b(new_n82_), .O(new_n112_));
  oai21  g068(.a(x29), .b(x22), .c(new_n100_), .O(new_n113_));
  nand3  g069(.a(x29), .b(new_n45_), .c(new_n99_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n115_));
  nor2   g071(.a(new_n94_), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(x30), .O(new_n117_));
  inv1   g073(.a(x30), .O(new_n118_));
  nand4  g074(.a(new_n92_), .b(new_n88_), .c(new_n85_), .d(x17), .O(new_n119_));
  ...
  inv1   g085(.a(new_n91_), .O(new_n130_));
  inv1   g086(.a(x31), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n118_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n126_), .c(x17), .O(new_n133_));
  nand2  g089(.a(x30), .b(x22), .O(new_n134_));
  aoi22  g090(.a(new_n134_), .b(new_n133_), .c(new_n84_), .d(new_n83_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n130_), .c(new_n129_), .d(new_n88_), .O(new_n136_));
  nand3  g092(.a(x29), .b(x28), .c(x27), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x31), .O(new_n138_));
  nand3  g094(.a(new_n112_), .b(new_n131_), .c(x29), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nor2   g096(.a(new_n131_), .b(x30), .O(new_n141_));
  aoi22  g097(.a(new_n141_), .b(new_n45_), .c(new_n140_), .d(x30), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n136_), .c(new_n128_), .O(z7));
  inv1   g099(.a(x19), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x14), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x18), .c(x17), .d(x16), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n83_), .O(new_n147_));
  nand2  g103(.a(x16), .b(x15), .O(new_n148_));
  nand2  g104(.a(x18), .b(x17), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n144_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(new_n83_), .O(new_n152_));
  inv1   g108(.a(x11), .O(new_n153_));
  oai21  g109(.a(new_n149_), .b(new_n153_), .c(new_n86_), .O(new_n154_));
  aoi21  g110(.a(x18), .b(x12), .c(x17), .O(new_n155_));
  nor2   g111(.a(x18), .b(x13), .O(new_n156_));
  nor3   g112(.a(new_n156_), .b(new_n155_), .c(new_n131_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n147_), .c(new_n58_), .O(new_n159_));
  nor2   g115(.a(x28), .b(x27), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n107_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n118_), .c(new_n45_), .O(new_n163_));
  inv1   g119(.a(new_n160_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(x30), .c(x29), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n163_), .c(new_n159_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x32), .O(new_n167_));
  inv1   g123(.a(x32), .O(new_n168_));
  nand4  g124(.a(new_n164_), .b(new_n118_), .c(x29), .d(new_n45_), .O(new_n169_));
  oai21  g125(.a(new_n161_), .b(new_n118_), .c(new_n169_), .O(new_n170_));
  inv1   g126(.a(x18), .O(new_n171_));
  nand3  g127(.a(x19), .b(new_n171_), .c(x13), .O(new_n172_));
  nand3  g128(.a(new_n144_), .b(x18), .c(x14), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n172_), .c(new_n99_), .O(new_n174_));
  nand4  g130(.a(x19), .b(x18), .c(new_n99_), .d(x12), .O(new_n175_));
  ...
  nand3  g135(.a(new_n179_), .b(new_n86_), .c(x11), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x15), .O(new_n182_));
  nand4  g138(.a(new_n179_), .b(x16), .c(new_n83_), .d(x10), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n170_), .c(new_n168_), .d(x31), .O(new_n185_));
  ...
  nand4  g145(.a(new_n184_), .b(new_n189_), .c(x31), .d(x30), .O(new_n190_));
  nand2  g146(.a(x33), .b(new_n118_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n164_), .c(x29), .O(new_n193_));
  nand4  g149(.a(new_n184_), .b(new_n189_), .c(new_n131_), .d(new_n118_), .O(new_n194_));
  nand2  g150(.a(x33), .b(x30), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n162_), .O(new_n197_));
  inv1   g153(.a(new_n155_), .O(new_n198_));
  nor2   g154(.a(x31), .b(new_n118_), .O(new_n199_));
  nor3   g155(.a(new_n199_), .b(new_n156_), .c(new_n141_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n198_), .c(new_n154_), .O(new_n201_));
  inv1   g157(.a(new_n201_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n152_), .c(new_n150_), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(new_n147_), .c(x33), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n197_), .c(new_n193_), .O(new_n205_));
  nand3  g161(.a(new_n205_), .b(new_n81_), .c(x00), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(new_n58_), .O(z9));
endmodule
