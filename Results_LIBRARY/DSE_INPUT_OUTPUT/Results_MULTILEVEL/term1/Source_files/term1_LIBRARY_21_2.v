...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n81_), .c(new_n45_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n60_), .c(new_n47_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n92_), .c(new_n45_), .d(x25), .O(new_n96_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n90_), .c(new_n62_), .d(new_n45_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n98_), .c(new_n60_), .O(z5));
  ...
  nand2  g065(.a(x30), .b(new_n99_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n91_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n62_), .c(new_n45_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n60_), .O(z6));
  ...
  nand4  g075(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n120_));
  nor2   g076(.a(new_n61_), .b(new_n98_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(x01), .O(new_n122_));
  ...
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n114_), .O(new_n141_));
  ...
  nand2  g099(.a(new_n100_), .b(new_n81_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x30), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n99_), .O(new_n146_));
  ...
  nand3  g107(.a(new_n147_), .b(x30), .c(new_n45_), .O(new_n152_));
  nand3  g108(.a(new_n144_), .b(new_n106_), .c(x29), .O(new_n153_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n130_), .c(new_n125_), .O(new_n176_));
  nand2  g132(.a(new_n147_), .b(new_n114_), .O(new_n177_));
  nor2   g133(.a(new_n114_), .b(new_n99_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n144_), .c(new_n106_), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n45_), .c(new_n177_), .d(new_n106_), .O(new_n180_));
  ...
  oai22  g140(.a(new_n184_), .b(x26), .c(new_n177_), .d(x30), .O(new_n185_));
