...
module FAU ( 
  ...
  nand4  g047(.a(new_n91_), .b(new_n80_), .c(new_n45_), .d(x25), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n61_), .c(new_n48_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n91_), .c(new_n45_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n61_), .c(new_n48_), .O(z4));
  ...
  nand2  g065(.a(x30), .b(new_n97_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n90_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n62_), .c(new_n45_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n61_), .O(z6));
  nand3  g069(.a(new_n99_), .b(x30), .c(x29), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  nand4  g071(.a(new_n88_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n116_));
  nor2   g072(.a(new_n56_), .b(new_n61_), .O(new_n117_));
  inv1   g073(.a(x25), .O(new_n118_));
  inv1   g074(.a(new_n99_), .O(new_n119_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(z7));
  nand2  g080(.a(x30), .b(x26), .O(new_n125_));
  ...
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n120_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n138_), .c(new_n135_), .d(new_n133_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n130_), .c(new_n125_), .O(new_n143_));
  nand2  g099(.a(new_n98_), .b(new_n80_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x30), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n97_), .O(new_n146_));
  nand2  g102(.a(new_n144_), .b(x29), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(new_n106_), .c(new_n146_), .d(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  nand3  g106(.a(new_n147_), .b(x30), .c(new_n45_), .O(new_n151_));
  nand3  g107(.a(new_n144_), .b(new_n106_), .c(x29), .O(new_n152_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n130_), .c(new_n125_), .O(new_n175_));
  nand2  g131(.a(new_n147_), .b(new_n120_), .O(new_n176_));
  nor2   g132(.a(new_n120_), .b(new_n97_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n144_), .c(new_n106_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n45_), .c(new_n176_), .d(new_n106_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  nand4  g137(.a(new_n144_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  oai22  g138(.a(new_n182_), .b(x26), .c(new_n176_), .d(x30), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n168_), .c(new_n53_), .O(new_n184_));
