...
module FAU ( 
  ...
  nand4  g066(.a(new_n110_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n62_), .O(z6));
  ...
  nor2   g074(.a(new_n59_), .b(new_n62_), .O(new_n119_));
  ...
  nand2  g081(.a(new_n97_), .b(new_n82_), .O(new_n126_));
