...
module FAU ( 
  ...
  nand4  g083(.a(new_n127_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(new_n128_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n132_), .c(x31), .d(new_n109_), .O(new_n148_));
  ...
  nand2  g109(.a(x32), .b(new_n109_), .O(new_n154_));
  ...
  nand3  g128(.a(new_n172_), .b(new_n46_), .c(x00), .O(new_n173_));
  ...
  nand4  g135(.a(new_n147_), .b(new_n175_), .c(new_n124_), .d(new_n109_), .O(new_n180_));
