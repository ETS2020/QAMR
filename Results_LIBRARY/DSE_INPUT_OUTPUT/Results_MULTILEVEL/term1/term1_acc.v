...
module FAU ( 
  ...
  nand4  g093(.a(new_n137_), .b(z0), .c(x31), .d(new_n107_), .O(new_n138_));
  nand2  g094(.a(x32), .b(x30), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n122_), .c(x29), .O(new_n141_));
  nand2  g097(.a(new_n122_), .b(x29), .O(new_n142_));
  nand4  g098(.a(new_n137_), .b(z0), .c(x31), .d(x30), .O(new_n143_));
  ...
  nand2  g102(.a(new_n135_), .b(x10), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x19), .c(x18), .d(x17), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n129_), .O(new_n149_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n150_), .c(new_n129_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n150_), .b(new_n155_), .c(new_n83_), .O(new_n156_));
  aoi21  g112(.a(x19), .b(x13), .c(x18), .O(new_n157_));
  nor2   g113(.a(x19), .b(x14), .O(new_n158_));
  nor3   g114(.a(new_n158_), .b(new_n157_), .c(new_n117_), .O(new_n159_));
  ...
  nand3  g117(.a(new_n161_), .b(new_n146_), .c(new_n141_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n78_), .c(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z8));
  inv1   g120(.a(x33), .O(new_n165_));
  nand4  g121(.a(new_n137_), .b(new_n165_), .c(x31), .d(x30), .O(new_n166_));
  nand2  g122(.a(x33), .b(new_n107_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n122_), .c(x29), .O(new_n169_));
  nand4  g125(.a(new_n137_), .b(new_n165_), .c(new_n117_), .d(new_n107_), .O(new_n170_));
  ...
  nand4  g134(.a(new_n178_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n149_), .c(x33), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n173_), .c(new_n169_), .O(new_n181_));
