...
module FAU ( 
  ...
  nor2   g07(.a(x2), .b(new_n18_), .O(new_n22_));
  inv1   g08(.a(new_n22_), .O(z2));
  nor2   g09(.a(new_n15_), .b(x1), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n16_), .O(z4));
  aoi21  g11(.a(new_n25_), .b(new_n20_), .c(new_n22_), .O(z5));
  nand3  g12(.a(new_n16_), .b(x2), .c(x1), .O(z6));
  nand3  g13(.a(new_n20_), .b(x2), .c(x1), .O(z7));
  inv1   g14(.a(x3), .O(new_n30_));
  oai21  g15(.a(new_n30_), .b(x0), .c(new_n18_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n15_), .O(z8));
  oai21  g17(.a(new_n30_), .b(new_n19_), .c(new_n18_), .O(new_n33_));
