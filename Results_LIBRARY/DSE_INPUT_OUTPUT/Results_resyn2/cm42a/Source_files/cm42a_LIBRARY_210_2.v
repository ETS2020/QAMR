...
module FAU ( 
  ...
  nor2   g14(.a(new_n21_), .b(x2), .O(new_n31_));
  aoi21  g15(.a(new_n31_), .b(new_n16_), .c(new_n28_), .O(z8));
  aoi21  g16(.a(new_n31_), .b(new_n19_), .c(new_n28_), .O(z9));
  one    g17(.O(z4));
  one    g18(.O(z7));
  inv1   g19(.a(new_n28_), .O(z6));
endmodule
