...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n20_, new_n27_;
  ...
  nand3  g08(.a(new_n16_), .b(x2), .c(x0), .O(z5));
  nand4  g09(.a(new_n20_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g10(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g11(.a(new_n20_), .b(x1), .c(new_n19_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n15_), .O(z8));
  one    g13(.O(z1));
