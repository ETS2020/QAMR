...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n25_, new_n29_,
    new_n30_;
  ...
  nor2   g09(.a(x3), .b(new_n19_), .O(new_n25_));
  nand3  g10(.a(new_n25_), .b(x2), .c(new_n15_), .O(z5));
  nand3  g11(.a(new_n17_), .b(x2), .c(x1), .O(z6));
  nand3  g12(.a(new_n25_), .b(x2), .c(x1), .O(z7));
  inv1   g13(.a(x3), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(x0), .c(new_n15_), .O(new_n30_));
