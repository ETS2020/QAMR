...
module FAU ( 
  ...
  nor2   g15(.a(x3), .b(new_n21_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(z4));
  nand2  g17(.a(new_n30_), .b(new_n19_), .O(z5));
  nand2  g18(.a(new_n30_), .b(new_n25_), .O(z6));
  nand2  g19(.a(new_n27_), .b(x2), .O(z7));
  nand3  g20(.a(new_n16_), .b(x3), .c(new_n21_), .O(z8));
  nand3  g21(.a(new_n19_), .b(x3), .c(new_n21_), .O(z9));
endmodule
