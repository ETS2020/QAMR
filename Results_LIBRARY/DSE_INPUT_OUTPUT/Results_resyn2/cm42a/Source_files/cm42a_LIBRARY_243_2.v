...
module FAU ( 
  ...
  nor2   g12(.a(x3), .b(new_n23_), .O(new_n29_));
  inv1   g13(.a(new_n29_), .O(z6));
  nor2   g14(.a(new_n21_), .b(x2), .O(new_n31_));
  aoi21  g15(.a(new_n31_), .b(new_n16_), .c(new_n29_), .O(z8));
  aoi21  g16(.a(new_n31_), .b(new_n19_), .c(new_n29_), .O(z9));
  one    g17(.O(z4));
  one    g18(.O(z5));
  inv1   g19(.a(new_n29_), .O(z7));
endmodule
