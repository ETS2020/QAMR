...
module FAU ( 
  ...
  nand3  g06(.a(new_n16_), .b(new_n19_), .c(x1), .O(z2));
  nand4  g07(.a(new_n19_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  inv1   g08(.a(x0), .O(new_n23_));
  nand3  g09(.a(new_n19_), .b(x2), .c(new_n23_), .O(new_n24_));
  ...
  nand2  g16(.a(new_n24_), .b(x1), .O(new_n31_));
