...
module FAU ( 
  ...
  oai21  g09(.a(new_n22_), .b(x0), .c(new_n23_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n21_), .O(z2));
  nand3  g11(.a(new_n15_), .b(x1), .c(x0), .O(z3));
  nor2   g12(.a(x3), .b(new_n23_), .O(new_n27_));
  inv1   g13(.a(new_n27_), .O(z4));
  nor2   g14(.a(new_n21_), .b(x2), .O(new_n29_));
  aoi21  g15(.a(new_n29_), .b(new_n16_), .c(new_n27_), .O(z8));
  aoi21  g16(.a(new_n29_), .b(new_n19_), .c(new_n27_), .O(z9));
  inv1   g17(.a(new_n27_), .O(z5));
  inv1   g18(.a(new_n27_), .O(z6));
