...
module FAU ( 
  ...
  oai21  g06(.a(new_n20_), .b(x3), .c(new_n18_), .O(z1));
  nand3  g07(.a(new_n16_), .b(x1), .c(new_n19_), .O(z2));
  ...
  nand2  g13(.a(new_n24_), .b(new_n20_), .O(z5));
  nand3  g14(.a(new_n24_), .b(x1), .c(new_n19_), .O(z6));
