...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n21_, new_n25_, new_n27_, new_n28_;
  ...
  oai21  g07(.a(new_n21_), .b(x0), .c(x1), .O(new_n25_));
  nand2  g08(.a(new_n25_), .b(new_n16_), .O(z6));
  nand2  g09(.a(x2), .b(x0), .O(new_n27_));
