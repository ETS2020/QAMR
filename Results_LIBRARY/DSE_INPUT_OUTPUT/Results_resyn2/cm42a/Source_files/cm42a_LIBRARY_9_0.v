...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n23_, new_n27_;
  ...
  nand4  g08(.a(new_n23_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g09(.a(new_n23_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g10(.a(new_n23_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g11(.a(new_n23_), .b(x2), .c(x0), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n16_), .O(z9));
  one    g13(.O(z4));
  nand2  g14(.a(new_n16_), .b(new_n15_), .O(z8));
endmodule
