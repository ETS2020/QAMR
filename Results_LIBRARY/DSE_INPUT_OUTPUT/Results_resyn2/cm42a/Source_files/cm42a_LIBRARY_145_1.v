...
module FAU ( 
  ...
  nand2  g07(.a(new_n19_), .b(new_n15_), .O(new_n22_));
  oai21  g08(.a(new_n16_), .b(new_n15_), .c(new_n22_), .O(z2));
  inv1   g09(.a(x3), .O(new_n24_));
  nand3  g10(.a(new_n24_), .b(new_n19_), .c(x0), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x1), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n22_), .O(z3));
  nand4  g13(.a(new_n24_), .b(x2), .c(x1), .d(new_n18_), .O(z6));
  nand4  g14(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g15(.a(x3), .b(new_n19_), .c(new_n15_), .d(new_n18_), .O(z8));
  oai21  g16(.a(new_n24_), .b(new_n18_), .c(new_n19_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n15_), .O(z9));
  one    g18(.O(z4));
  one    g19(.O(z5));
endmodule
