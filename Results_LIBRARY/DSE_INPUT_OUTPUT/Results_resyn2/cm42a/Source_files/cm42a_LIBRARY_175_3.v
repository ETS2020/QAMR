...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n25_, new_n27_, new_n28_, new_n32_;
  ...
  oai21  g10(.a(x2), .b(new_n19_), .c(new_n24_), .O(new_n25_));
  ...
  nand4  g15(.a(new_n24_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand4  g16(.a(new_n24_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  oai21  g17(.a(new_n27_), .b(new_n19_), .c(new_n24_), .O(new_n32_));
