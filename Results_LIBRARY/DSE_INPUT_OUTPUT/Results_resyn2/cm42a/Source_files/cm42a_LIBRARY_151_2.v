...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n26_;
  ...
  nand4  g09(.a(new_n15_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
  inv1   g10(.a(x2), .O(new_n26_));
  nand4  g11(.a(x3), .b(new_n26_), .c(new_n19_), .d(new_n18_), .O(z8));
  nand4  g12(.a(x3), .b(new_n26_), .c(new_n19_), .d(x0), .O(z9));
  one    g13(.O(z3));
  nand2  g14(.a(new_n15_), .b(x1), .O(z6));
