...
module FAU ( 
  ...
  nand3  g05(.a(new_n16_), .b(new_n19_), .c(x1), .O(z2));
  ...
  oai21  g12(.a(x3), .b(new_n21_), .c(new_n25_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x2), .O(z6));
  nand3  g14(.a(new_n16_), .b(x3), .c(new_n21_), .O(z8));
  oai21  g15(.a(new_n19_), .b(x1), .c(new_n22_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(x0), .O(z9));
  one    g17(.O(z5));
  one    g18(.O(z7));
endmodule
