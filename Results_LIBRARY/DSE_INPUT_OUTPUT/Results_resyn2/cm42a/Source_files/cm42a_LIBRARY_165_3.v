...
module FAU ( 
  ...
  nand4  g10(.a(new_n21_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  nand3  g11(.a(new_n23_), .b(x2), .c(new_n15_), .O(z4));
  inv1   g12(.a(x0), .O(new_n27_));
  oai21  g13(.a(x3), .b(new_n27_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x2), .O(z5));
  oai21  g15(.a(new_n21_), .b(x2), .c(new_n15_), .O(new_n32_));
  nand3  g16(.a(new_n32_), .b(new_n19_), .c(new_n17_), .O(z8));
  oai21  g17(.a(x1), .b(new_n27_), .c(new_n18_), .O(new_n34_));
