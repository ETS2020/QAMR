...
module FAU ( 
  ...
  nand3  g09(.a(new_n15_), .b(x1), .c(new_n20_), .O(z2));
  oai21  g10(.a(x2), .b(new_n20_), .c(new_n21_), .O(new_n25_));
  ...
  nand3  g19(.a(new_n16_), .b(x3), .c(new_n27_), .O(z8));
  nand3  g20(.a(new_n30_), .b(x3), .c(new_n27_), .O(z9));
endmodule
