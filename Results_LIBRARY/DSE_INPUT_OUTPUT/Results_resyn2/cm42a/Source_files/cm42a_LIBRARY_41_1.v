...
module FAU ( 
  ...
  inv1   g12(.a(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n24_), .b(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n27_), .O(z3));
  nor2   g15(.a(new_n22_), .b(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(z4));
  oai21  g17(.a(new_n30_), .b(x3), .c(new_n19_), .O(z5));
  nand3  g18(.a(new_n16_), .b(x2), .c(x1), .O(z6));
  nand4  g19(.a(new_n23_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g20(.a(x3), .b(new_n21_), .O(z8));
  nand2  g21(.a(new_n18_), .b(x3), .O(z9));
endmodule
