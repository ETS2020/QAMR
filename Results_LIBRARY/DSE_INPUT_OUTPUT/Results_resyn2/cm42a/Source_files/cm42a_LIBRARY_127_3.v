...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(new_n20_), .c(x1), .d(new_n19_), .O(z2));
  nand2  g10(.a(new_n21_), .b(x1), .O(z3));
  nand2  g11(.a(new_n16_), .b(x2), .O(z4));
  nand4  g12(.a(new_n23_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand2  g13(.a(x2), .b(x1), .O(z6));
  nand4  g14(.a(x3), .b(new_n20_), .c(new_n15_), .d(new_n19_), .O(z8));
  oai21  g15(.a(new_n23_), .b(new_n19_), .c(new_n15_), .O(new_n31_));
