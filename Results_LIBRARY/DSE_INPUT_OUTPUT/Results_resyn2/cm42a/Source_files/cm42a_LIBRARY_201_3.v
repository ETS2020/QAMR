...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n23_,
    new_n25_, new_n26_, new_n28_, new_n30_, new_n35_;
  ...
  oai21  g13(.a(x3), .b(new_n21_), .c(new_n15_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n19_), .c(new_n17_), .O(z4));
  oai21  g15(.a(x1), .b(new_n25_), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n28_), .O(z5));
  nand4  g17(.a(new_n18_), .b(x2), .c(x1), .d(new_n25_), .O(z6));
  nand4  g18(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand3  g19(.a(new_n23_), .b(x3), .c(new_n15_), .O(z8));
  oai21  g20(.a(x2), .b(new_n25_), .c(new_n15_), .O(new_n35_));
