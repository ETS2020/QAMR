...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n23_, new_n25_, new_n28_;
  ...
  oai21  g09(.a(new_n20_), .b(new_n23_), .c(x1), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n16_), .O(z7));
  oai21  g11(.a(new_n18_), .b(new_n16_), .c(new_n15_), .O(z8));
  oai21  g12(.a(x2), .b(new_n23_), .c(x3), .O(new_n28_));
