...
module FAU ( 
  ...
  nor2   g12(.a(x3), .b(new_n25_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n15_), .c(new_n20_), .O(z4));
  oai21  g14(.a(x3), .b(new_n25_), .c(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n21_), .O(z5));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n20_), .O(z6));
  oai21  g17(.a(new_n25_), .b(new_n20_), .c(new_n17_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x1), .O(z7));
  oai21  g19(.a(new_n23_), .b(x1), .c(x3), .O(z8));
  oai21  g20(.a(x2), .b(new_n20_), .c(new_n15_), .O(new_n35_));
