...
module FAU ( 
  ...
  nand2  g08(.a(new_n18_), .b(x1), .O(z2));
  nand3  g09(.a(new_n15_), .b(x2), .c(new_n20_), .O(z4));
  xor2a  g10(.a(x2), .b(x1), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n21_), .O(z5));
  oai21  g12(.a(new_n15_), .b(new_n18_), .c(x1), .O(z6));
  ...
  nand2  g17(.a(new_n18_), .b(x1), .O(z3));
endmodule
