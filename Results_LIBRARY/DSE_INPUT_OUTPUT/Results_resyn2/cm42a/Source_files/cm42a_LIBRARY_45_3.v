...
module FAU ( 
  ...
  nand4  g12(.a(new_n26_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand2  g13(.a(new_n23_), .b(x1), .O(z6));
  oai21  g14(.a(new_n26_), .b(x2), .c(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n24_), .O(z8));
  nand2  g16(.a(new_n29_), .b(x0), .O(z9));
