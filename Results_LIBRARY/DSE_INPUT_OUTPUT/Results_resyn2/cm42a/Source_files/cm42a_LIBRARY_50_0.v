...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n23_, new_n26_, new_n28_;
  ...
  nand2  g11(.a(new_n26_), .b(new_n15_), .O(z8));
  xnor2a g12(.a(x3), .b(x0), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n18_), .O(z9));
  one    g14(.O(z4));
