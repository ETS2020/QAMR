...
module FAU ( 
  ...
  nand3  g11(.a(new_n25_), .b(new_n23_), .c(new_n15_), .O(z4));
  nand3  g12(.a(new_n25_), .b(new_n23_), .c(x0), .O(z5));
  oai21  g13(.a(x3), .b(new_n24_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x1), .O(z6));
  inv1   g15(.a(x3), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(x2), .c(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n17_), .O(z8));
  nand4  g18(.a(x3), .b(new_n24_), .c(new_n23_), .d(x0), .O(z9));
