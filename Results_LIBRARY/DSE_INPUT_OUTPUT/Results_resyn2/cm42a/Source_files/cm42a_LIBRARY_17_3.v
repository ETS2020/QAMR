...
module FAU ( 
  ...
  oai21  g11(.a(new_n24_), .b(new_n20_), .c(new_n25_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n17_), .O(z3));
  nor2   g13(.a(x1), .b(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n25_), .c(x2), .O(z4));
  oai21  g15(.a(x1), .b(new_n20_), .c(new_n25_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x2), .O(z5));
  oai21  g17(.a(new_n24_), .b(x0), .c(new_n25_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z6));
  nand2  g19(.a(new_n26_), .b(x2), .O(z7));
  nand3  g20(.a(new_n28_), .b(x3), .c(new_n15_), .O(z8));
  nand3  g21(.a(new_n21_), .b(x3), .c(new_n15_), .O(z9));
endmodule
