...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n24_,
    new_n25_, new_n27_, new_n28_, new_n30_, new_n32_, new_n34_, new_n36_;
  ...
  nand2  g09(.a(new_n18_), .b(new_n16_), .O(new_n24_));
  ...
  nand2  g19(.a(new_n18_), .b(x1), .O(new_n34_));
  nand2  g20(.a(x3), .b(new_n16_), .O(z9));
  nand2  g21(.a(z9), .b(new_n34_), .O(new_n36_));
