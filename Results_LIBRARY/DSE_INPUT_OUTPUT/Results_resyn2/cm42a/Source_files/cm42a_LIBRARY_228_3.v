...
module FAU ( 
  ...
  nand4  g08(.a(new_n16_), .b(new_n15_), .c(x1), .d(new_n19_), .O(z2));
  nand2  g09(.a(new_n20_), .b(x1), .O(z3));
  nand3  g10(.a(new_n17_), .b(new_n16_), .c(x2), .O(z4));
  inv1   g11(.a(x1), .O(new_n26_));
  nand4  g12(.a(new_n16_), .b(x2), .c(new_n26_), .d(x0), .O(z5));
  nor2   g13(.a(new_n15_), .b(new_n26_), .O(new_n30_));
  nor2   g14(.a(new_n16_), .b(x2), .O(new_n31_));
  aoi21  g15(.a(new_n31_), .b(new_n17_), .c(new_n30_), .O(z8));
  nand3  g16(.a(new_n31_), .b(new_n26_), .c(x0), .O(z9));
  one    g17(.O(z6));
  one    g18(.O(z7));
endmodule
