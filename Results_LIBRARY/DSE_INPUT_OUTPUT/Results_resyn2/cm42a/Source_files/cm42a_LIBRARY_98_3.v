...
module FAU ( 
  ...
  nand3  g08(.a(new_n16_), .b(x1), .c(new_n18_), .O(z2));
  inv1   g09(.a(x1), .O(new_n24_));
  oai21  g10(.a(new_n24_), .b(new_n18_), .c(new_n19_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n21_), .O(z3));
  oai21  g12(.a(new_n15_), .b(x3), .c(x2), .O(z4));
  nor2   g13(.a(x3), .b(new_n19_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n24_), .c(x0), .O(z5));
  nand3  g15(.a(new_n28_), .b(x1), .c(new_n18_), .O(z6));
  nand3  g16(.a(new_n28_), .b(x1), .c(x0), .O(z7));
  nand3  g17(.a(new_n15_), .b(x3), .c(new_n19_), .O(z8));
  nand2  g18(.a(new_n20_), .b(x3), .O(z9));
endmodule
