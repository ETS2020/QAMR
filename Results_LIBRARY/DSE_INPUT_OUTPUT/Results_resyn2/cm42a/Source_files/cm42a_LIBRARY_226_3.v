...
module FAU ( 
  ...
  oai21  g10(.a(new_n17_), .b(x0), .c(x2), .O(z4));
  nand2  g11(.a(x2), .b(x0), .O(z5));
  inv1   g12(.a(x3), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g14(.a(new_n27_), .b(x1), .c(new_n16_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n22_), .O(z8));
