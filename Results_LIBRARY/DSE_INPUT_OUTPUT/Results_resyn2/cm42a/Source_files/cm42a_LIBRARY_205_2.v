...
module FAU ( 
  ...
  nand2  g08(.a(new_n18_), .b(x2), .O(z4));
  nand3  g09(.a(x3), .b(new_n16_), .c(new_n15_), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n17_), .O(new_n26_));
  nand2  g11(.a(x3), .b(x2), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n26_), .O(z8));
  nand3  g13(.a(x3), .b(new_n16_), .c(x0), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n17_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n27_), .O(z9));
  one    g16(.O(z7));
  nand2  g17(.a(new_n18_), .b(x2), .O(z5));
