...
module FAU ( 
  ...
  xor2a  g09(.a(x3), .b(x1), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n20_), .O(z3));
  inv1   g11(.a(x2), .O(new_n26_));
  oai21  g12(.a(new_n26_), .b(x0), .c(new_n19_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n15_), .O(z4));
  oai21  g14(.a(new_n26_), .b(new_n18_), .c(new_n19_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z5));
  nand3  g16(.a(new_n22_), .b(x2), .c(new_n18_), .O(z6));
  nand2  g17(.a(new_n29_), .b(new_n24_), .O(z7));
