...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n20_, new_n21_, new_n23_, new_n25_, new_n26_;
  ...
  nand2  g07(.a(new_n17_), .b(new_n23_), .O(z4));
  ...
  nand4  g12(.a(x3), .b(new_n25_), .c(new_n23_), .d(new_n20_), .O(z8));
  nand4  g13(.a(x3), .b(new_n25_), .c(new_n23_), .d(x0), .O(z9));
  one    g14(.O(z0));
  one    g15(.O(z1));
  nand2  g16(.a(new_n17_), .b(new_n23_), .O(z5));
endmodule
