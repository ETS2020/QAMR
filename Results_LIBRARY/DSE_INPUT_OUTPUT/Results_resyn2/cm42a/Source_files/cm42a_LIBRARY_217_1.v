...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n28_, new_n30_, new_n32_, new_n34_;
  ...
  nand3  g10(.a(new_n24_), .b(x1), .c(new_n23_), .O(z2));
  nor2   g11(.a(new_n18_), .b(new_n23_), .O(new_n26_));
  ...
  nor2   g17(.a(x3), .b(new_n15_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(x1), .c(new_n23_), .O(z6));
  nor2   g19(.a(new_n19_), .b(x2), .O(new_n34_));
  aoi21  g20(.a(new_n32_), .b(new_n26_), .c(new_n34_), .O(z7));
  inv1   g21(.a(new_n34_), .O(z8));
  one    g22(.O(z9));
endmodule
