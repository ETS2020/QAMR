...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n27_, new_n28_, new_n30_, new_n32_, new_n34_;
  ...
  oai21  g12(.a(x3), .b(new_n19_), .c(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n16_), .b(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n23_), .O(z4));
  inv1   g15(.a(new_n28_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n20_), .c(x2), .O(z5));
  oai21  g17(.a(new_n19_), .b(x0), .c(new_n20_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x1), .O(z6));
  oai21  g19(.a(new_n19_), .b(new_n15_), .c(new_n20_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x1), .O(z7));
  nand4  g21(.a(x3), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand3  g22(.a(new_n30_), .b(x3), .c(new_n19_), .O(z9));
endmodule
