...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n20_, new_n22_, new_n24_, new_n26_, new_n27_;
  inv1   g00(.a(x2), .O(new_n15_));
  inv1   g01(.a(x3), .O(new_n16_));
  nand2  g02(.a(new_n16_), .b(new_n15_), .O(z0));
  nor2   g03(.a(x1), .b(x0), .O(new_n20_));
  nand3  g04(.a(new_n20_), .b(new_n16_), .c(x2), .O(z4));
  ...
  nand2  g09(.a(x1), .b(x0), .O(new_n26_));
  nand2  g10(.a(new_n26_), .b(x2), .O(new_n27_));
  nand2  g11(.a(new_n27_), .b(new_n16_), .O(z7));
  oai21  g12(.a(new_n20_), .b(new_n16_), .c(new_n15_), .O(z8));
  nand4  g13(.a(x3), .b(new_n15_), .c(new_n22_), .d(x0), .O(z9));
  one    g14(.O(z2));
  one    g15(.O(z3));
