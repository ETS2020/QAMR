...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n22_, new_n23_,
    new_n24_, new_n26_, new_n29_, new_n33_;
  ...
  oai21  g11(.a(new_n21_), .b(new_n18_), .c(new_n22_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n24_), .O(z3));
  nand3  g13(.a(new_n16_), .b(new_n22_), .c(x2), .O(z4));
  oai21  g14(.a(x1), .b(new_n18_), .c(new_n22_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(z5));
  nand2  g16(.a(new_n23_), .b(x2), .O(z6));
  nand2  g17(.a(new_n26_), .b(x2), .O(z7));
  inv1   g18(.a(x2), .O(new_n33_));
  nand3  g19(.a(new_n16_), .b(x3), .c(new_n33_), .O(z8));
  nand3  g20(.a(new_n19_), .b(x3), .c(new_n33_), .O(z9));
endmodule
