...
module FAU ( 
  ...
  xor2a  g07(.a(x3), .b(x0), .O(new_n22_));
  ...
  nand2  g13(.a(new_n26_), .b(new_n22_), .O(z5));
  oai21  g14(.a(new_n20_), .b(new_n23_), .c(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z6));
  nand2  g16(.a(new_n29_), .b(new_n22_), .O(z7));
  oai21  g17(.a(new_n17_), .b(new_n15_), .c(x3), .O(z9));
  one    g18(.O(z8));
endmodule
