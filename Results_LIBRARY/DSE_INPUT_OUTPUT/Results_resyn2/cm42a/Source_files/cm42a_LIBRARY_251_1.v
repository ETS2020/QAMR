...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n22_, new_n28_;
  ...
  oai21  g10(.a(new_n16_), .b(new_n18_), .c(x2), .O(z5));
  oai21  g11(.a(x3), .b(new_n21_), .c(x0), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(x2), .O(z7));
  nand3  g13(.a(new_n15_), .b(x3), .c(new_n21_), .O(z8));
  nand3  g14(.a(new_n19_), .b(x3), .c(new_n21_), .O(z9));
  one    g15(.O(z4));
  one    g16(.O(z6));
endmodule
