...
module FAU ( 
  ...
  nand3  g06(.a(new_n21_), .b(new_n15_), .c(new_n19_), .O(z2));
  nand2  g07(.a(new_n15_), .b(x0), .O(z3));
  nand3  g08(.a(new_n16_), .b(x2), .c(new_n19_), .O(z4));
  oai21  g09(.a(new_n16_), .b(new_n15_), .c(x0), .O(z5));
  nand3  g10(.a(new_n21_), .b(x2), .c(new_n19_), .O(z6));
  oai21  g11(.a(x3), .b(new_n20_), .c(x2), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(x0), .O(z7));
  inv1   g13(.a(x3), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(x1), .c(new_n19_), .O(new_n30_));
