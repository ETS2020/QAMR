...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n23_, new_n24_,
    new_n26_, new_n28_, new_n31_, new_n32_, new_n33_;
  ...
  oai21  g17(.a(new_n31_), .b(x1), .c(new_n19_), .O(new_n32_));
  xnor2a g18(.a(x2), .b(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z8));
  nand2  g20(.a(new_n32_), .b(x0), .O(z9));
