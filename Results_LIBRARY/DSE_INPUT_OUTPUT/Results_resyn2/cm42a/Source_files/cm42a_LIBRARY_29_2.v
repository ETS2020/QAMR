...
module FAU ( 
  ...
  nor2   g13(.a(x3), .b(new_n15_), .O(new_n30_));
  nor2   g14(.a(new_n16_), .b(x2), .O(new_n31_));
  aoi21  g15(.a(new_n31_), .b(new_n17_), .c(new_n30_), .O(z8));
  nand2  g16(.a(x3), .b(new_n15_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(z4), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(new_n20_), .O(z9));
  one    g19(.O(z6));
  one    g20(.O(z7));
  nand2  g21(.a(new_n16_), .b(x2), .O(z5));
endmodule
