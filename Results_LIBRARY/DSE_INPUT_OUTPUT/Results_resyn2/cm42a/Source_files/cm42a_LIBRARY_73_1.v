...
module FAU ( 
  ...
  aoi21  g09(.a(new_n23_), .b(new_n15_), .c(new_n21_), .O(z2));
  nand3  g10(.a(new_n23_), .b(new_n18_), .c(x0), .O(z3));
  ...
  aoi21  g16(.a(new_n26_), .b(new_n23_), .c(new_n21_), .O(z6));
  oai21  g17(.a(new_n23_), .b(new_n21_), .c(new_n29_), .O(z7));
  one    g18(.O(z8));
  one    g19(.O(z9));
endmodule
