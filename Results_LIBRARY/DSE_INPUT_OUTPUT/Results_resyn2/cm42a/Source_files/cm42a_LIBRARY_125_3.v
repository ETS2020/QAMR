...
module FAU ( 
  ...
  nand4  g08(.a(new_n15_), .b(new_n20_), .c(x1), .d(x0), .O(z3));
  oai21  g09(.a(new_n20_), .b(x1), .c(new_n15_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n17_), .O(z4));
  nand2  g11(.a(new_n24_), .b(x0), .O(z5));
  nand3  g12(.a(new_n21_), .b(x2), .c(x1), .O(z6));
  nand4  g13(.a(new_n15_), .b(x2), .c(x1), .d(x0), .O(z7));
  inv1   g14(.a(x0), .O(new_n29_));
  inv1   g15(.a(x1), .O(new_n30_));
  nand4  g16(.a(x3), .b(new_n20_), .c(new_n30_), .d(new_n29_), .O(z8));
