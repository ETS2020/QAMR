...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n24_;
  ...
  nand3  g09(.a(new_n24_), .b(new_n19_), .c(new_n18_), .O(z4));
  nand3  g10(.a(new_n24_), .b(new_n19_), .c(x0), .O(z5));
  oai21  g11(.a(new_n16_), .b(new_n15_), .c(x1), .O(z6));
  nand3  g12(.a(new_n24_), .b(x1), .c(x0), .O(z7));
  nand4  g13(.a(x3), .b(new_n15_), .c(new_n19_), .d(new_n18_), .O(z8));
