...
module FAU ( 
  ...
  nand3  g08(.a(new_n22_), .b(new_n17_), .c(x1), .O(z3));
  oai21  g09(.a(new_n17_), .b(x1), .c(new_n18_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n15_), .O(z4));
  nand3  g11(.a(new_n22_), .b(x2), .c(new_n16_), .O(z5));
  oai21  g12(.a(new_n17_), .b(new_n16_), .c(new_n18_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n15_), .O(z6));
  nand3  g14(.a(new_n22_), .b(x2), .c(x1), .O(z7));
