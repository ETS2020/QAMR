...
module FAU ( 
  ...
  nand3  g12(.a(new_n19_), .b(x2), .c(new_n26_), .O(z5));
  nand2  g13(.a(new_n23_), .b(x1), .O(z6));
  nand3  g14(.a(new_n19_), .b(x2), .c(x1), .O(z7));
  oai21  g15(.a(new_n16_), .b(x0), .c(new_n26_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n21_), .O(z8));
  nand3  g17(.a(new_n17_), .b(x3), .c(x0), .O(z9));
  nand2  g18(.a(new_n21_), .b(x1), .O(z3));
endmodule
