...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n26_, new_n29_, new_n31_, new_n32_, new_n34_;
  ...
  nand3  g07(.a(new_n19_), .b(x1), .c(new_n18_), .O(new_n22_));
  ...
  nand3  g13(.a(new_n16_), .b(new_n19_), .c(x2), .O(z4));
  inv1   g14(.a(x1), .O(new_n29_));
  nand4  g15(.a(new_n19_), .b(x2), .c(new_n29_), .d(x0), .O(z5));
  nand2  g16(.a(new_n19_), .b(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n22_), .b(x2), .O(new_n32_));
