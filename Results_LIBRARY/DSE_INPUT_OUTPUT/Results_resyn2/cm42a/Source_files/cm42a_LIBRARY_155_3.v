...
module FAU ( 
  ...
  nand3  g12(.a(new_n26_), .b(new_n15_), .c(x1), .O(z3));
  ...
  nand4  g21(.a(new_n15_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g22(.a(x2), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(x1), .c(x3), .O(z8));
  oai21  g24(.a(new_n26_), .b(x1), .c(x3), .O(z9));
endmodule
