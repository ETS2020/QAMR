...
module FAU ( 
  ...
  xor2a  g08(.a(x2), .b(x1), .O(new_n25_));
  nand2  g09(.a(new_n25_), .b(new_n20_), .O(z5));
  nand3  g10(.a(new_n16_), .b(x2), .c(x1), .O(z6));
  oai21  g11(.a(x3), .b(new_n18_), .c(x2), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(x1), .O(z7));
  inv1   g13(.a(x3), .O(new_n30_));
  oai21  g14(.a(new_n30_), .b(x0), .c(new_n19_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n15_), .O(z8));
  oai21  g16(.a(new_n30_), .b(new_n18_), .c(new_n19_), .O(new_n33_));
