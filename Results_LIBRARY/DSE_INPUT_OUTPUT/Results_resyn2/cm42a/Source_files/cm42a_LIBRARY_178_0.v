...
module FAU ( 
  ...
  nor2   g08(.a(x3), .b(new_n16_), .O(new_n24_));
  nand3  g09(.a(new_n24_), .b(new_n18_), .c(new_n15_), .O(z4));
  nand3  g10(.a(new_n24_), .b(new_n18_), .c(x0), .O(z5));
  nand3  g11(.a(new_n24_), .b(x1), .c(new_n15_), .O(z6));
  nand3  g12(.a(new_n24_), .b(x1), .c(x0), .O(z7));
  oai21  g13(.a(new_n19_), .b(x1), .c(x0), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n16_), .O(z9));
  one    g15(.O(z2));
