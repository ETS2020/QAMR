...
module FAU ( 
  ...
  oai21  g10(.a(x3), .b(new_n24_), .c(x0), .O(new_n25_));
  xor2a  g11(.a(x2), .b(x0), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n25_), .O(z3));
  nand3  g13(.a(new_n17_), .b(x2), .c(x0), .O(z5));
  nand2  g14(.a(new_n25_), .b(x2), .O(z7));
  oai21  g15(.a(new_n22_), .b(x1), .c(new_n16_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n15_), .O(z8));
  nand3  g17(.a(new_n20_), .b(x3), .c(new_n24_), .O(z9));
  one    g18(.O(z4));
  one    g19(.O(z6));
endmodule
