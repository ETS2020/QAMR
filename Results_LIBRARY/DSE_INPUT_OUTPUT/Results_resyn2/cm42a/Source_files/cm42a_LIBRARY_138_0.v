...
module FAU ( 
  ...
  oai21  g11(.a(x3), .b(new_n20_), .c(x2), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(new_n23_), .O(z6));
  nand4  g13(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g14(.a(new_n16_), .b(new_n23_), .O(z8));
  nand4  g15(.a(x3), .b(new_n16_), .c(new_n20_), .d(x0), .O(z9));
  one    g16(.O(z0));
  one    g17(.O(z2));
endmodule
