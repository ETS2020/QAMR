...
module FAU ( 
  ...
  oai21  g10(.a(x3), .b(new_n19_), .c(x2), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n23_), .O(z5));
  inv1   g12(.a(x3), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand2  g14(.a(new_n25_), .b(x1), .O(z7));
  oai21  g15(.a(new_n27_), .b(x0), .c(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z8));
  nand4  g17(.a(x3), .b(new_n15_), .c(new_n16_), .d(x0), .O(z9));
