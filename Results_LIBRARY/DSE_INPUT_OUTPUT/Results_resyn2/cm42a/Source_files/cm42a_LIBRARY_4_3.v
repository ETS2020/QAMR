...
module FAU ( 
  ...
  nand2  g06(.a(new_n19_), .b(new_n17_), .O(new_n21_));
  ...
  nand3  g13(.a(new_n17_), .b(x2), .c(new_n27_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n18_), .O(z4));
  inv1   g16(.a(new_n19_), .O(new_n31_));
  nor2   g17(.a(x3), .b(new_n25_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z5));
  nand3  g19(.a(new_n32_), .b(x1), .c(new_n27_), .O(z6));
  nand3  g20(.a(new_n32_), .b(x1), .c(x0), .O(z7));
  oai21  g21(.a(new_n23_), .b(x1), .c(x3), .O(z8));
  nand3  g22(.a(new_n31_), .b(x3), .c(new_n25_), .O(z9));
endmodule
