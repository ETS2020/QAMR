...
module FAU ( 
  ...
  nand3  g13(.a(new_n28_), .b(x2), .c(new_n20_), .O(z6));
  nand3  g14(.a(new_n28_), .b(x2), .c(x0), .O(z7));
  oai21  g15(.a(new_n18_), .b(x1), .c(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n17_), .O(z9));
  one    g17(.O(z0));
  nand2  g18(.a(new_n17_), .b(new_n20_), .O(z8));
endmodule
