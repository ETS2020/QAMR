...
module FAU ( 
  ...
  nand4  g07(.a(new_n15_), .b(new_n21_), .c(x1), .d(new_n18_), .O(z2));
  oai21  g08(.a(new_n21_), .b(x1), .c(new_n18_), .O(new_n23_));
  nand2  g09(.a(new_n23_), .b(new_n15_), .O(z4));
  nand4  g10(.a(new_n15_), .b(x2), .c(x1), .d(new_n18_), .O(z6));
  nor2   g11(.a(new_n15_), .b(x0), .O(new_n27_));
  aoi21  g12(.a(new_n27_), .b(new_n16_), .c(new_n19_), .O(z8));
  oai21  g13(.a(new_n16_), .b(new_n15_), .c(x0), .O(z9));
  one    g14(.O(z7));
  inv1   g15(.a(new_n19_), .O(z3));
  inv1   g16(.a(new_n19_), .O(z5));
endmodule
