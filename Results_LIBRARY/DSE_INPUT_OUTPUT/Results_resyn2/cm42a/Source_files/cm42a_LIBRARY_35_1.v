...
module FAU ( 
  ...
  nor2   g11(.a(new_n23_), .b(new_n19_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n15_), .O(z3));
  nor2   g13(.a(new_n20_), .b(x2), .O(new_n28_));
  nor2   g14(.a(x3), .b(new_n18_), .O(new_n29_));
  aoi21  g15(.a(new_n29_), .b(new_n16_), .c(new_n28_), .O(z4));
  nand3  g16(.a(new_n29_), .b(new_n23_), .c(x0), .O(z5));
  aoi21  g17(.a(new_n29_), .b(new_n24_), .c(new_n28_), .O(z6));
  aoi21  g18(.a(new_n29_), .b(new_n26_), .c(new_n28_), .O(z7));
  inv1   g19(.a(new_n28_), .O(z8));
  inv1   g20(.a(new_n28_), .O(z9));
endmodule
