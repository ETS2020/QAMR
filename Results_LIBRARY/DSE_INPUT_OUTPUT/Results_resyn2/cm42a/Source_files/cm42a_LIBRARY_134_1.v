...
module FAU ( 
  ...
  nand4  g10(.a(new_n16_), .b(x2), .c(new_n21_), .d(new_n15_), .O(z4));
  nand4  g11(.a(new_n16_), .b(x2), .c(new_n21_), .d(x0), .O(z5));
  nand4  g12(.a(new_n16_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g13(.a(x2), .b(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n19_), .O(z7));
  oai21  g16(.a(x2), .b(x1), .c(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(x3), .O(z9));
  one    g18(.O(z8));
endmodule
