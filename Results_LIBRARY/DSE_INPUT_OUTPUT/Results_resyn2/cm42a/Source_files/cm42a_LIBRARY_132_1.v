...
module FAU ( 
  ...
  oai21  g09(.a(new_n15_), .b(new_n18_), .c(new_n19_), .O(new_n24_));
  oai21  g10(.a(x3), .b(x2), .c(x1), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z3));
  nand4  g12(.a(new_n19_), .b(x2), .c(new_n15_), .d(new_n18_), .O(z4));
  oai21  g13(.a(new_n22_), .b(new_n18_), .c(new_n19_), .O(new_n28_));
