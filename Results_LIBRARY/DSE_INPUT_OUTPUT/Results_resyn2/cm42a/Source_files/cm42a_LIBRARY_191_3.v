...
module FAU ( 
  ...
  nand2  g10(.a(new_n22_), .b(x2), .O(new_n25_));
  inv1   g11(.a(x2), .O(new_n26_));
  nand2  g12(.a(x3), .b(new_n26_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n25_), .c(new_n24_), .O(z3));
  oai21  g14(.a(new_n16_), .b(x3), .c(x2), .O(z4));
  nand4  g15(.a(new_n22_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  nand4  g16(.a(new_n22_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  nand2  g17(.a(new_n24_), .b(x2), .O(z7));
  nand3  g18(.a(new_n16_), .b(x3), .c(new_n26_), .O(z8));
  nand4  g19(.a(x3), .b(new_n26_), .c(new_n18_), .d(x0), .O(z9));
endmodule
