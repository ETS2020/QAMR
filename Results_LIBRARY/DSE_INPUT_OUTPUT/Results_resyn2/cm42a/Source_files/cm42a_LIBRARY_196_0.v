...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n20_, new_n21_, new_n23_, new_n24_, new_n27_,
    new_n31_;
  ...
  nand4  g09(.a(new_n24_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  oai21  g10(.a(x3), .b(new_n20_), .c(x2), .O(new_n27_));
  nand2  g11(.a(new_n27_), .b(new_n23_), .O(z6));
  nand4  g12(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g13(.a(new_n24_), .b(x1), .c(x0), .O(new_n31_));
