...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n21_, new_n22_, new_n26_,
    new_n27_, new_n30_, new_n32_, new_n34_;
  ...
  oai21  g15(.a(new_n18_), .b(new_n26_), .c(new_n20_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x2), .O(z7));
  inv1   g17(.a(x2), .O(new_n32_));
  nand3  g18(.a(new_n16_), .b(x3), .c(new_n32_), .O(z8));
  oai21  g19(.a(x1), .b(new_n26_), .c(new_n32_), .O(new_n34_));
