...
module FAU ( 
  ...
  nand3  g08(.a(new_n15_), .b(x1), .c(new_n18_), .O(z2));
  nand3  g09(.a(new_n15_), .b(x1), .c(x0), .O(z3));
  oai21  g10(.a(new_n16_), .b(x3), .c(x2), .O(z4));
  inv1   g11(.a(x1), .O(new_n26_));
  inv1   g12(.a(x3), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(x2), .c(new_n26_), .d(x0), .O(z5));
  oai21  g14(.a(new_n26_), .b(x0), .c(new_n27_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(z6));
  oai21  g16(.a(new_n26_), .b(new_n18_), .c(new_n27_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(z7));
  oai21  g18(.a(new_n16_), .b(x2), .c(x3), .O(z8));
