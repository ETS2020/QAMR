...
module FAU ( 
  ...
  nor2   g10(.a(x3), .b(new_n16_), .O(new_n27_));
  nor2   g11(.a(new_n18_), .b(x1), .O(new_n28_));
  nor2   g12(.a(x2), .b(x0), .O(new_n29_));
  aoi21  g13(.a(new_n29_), .b(new_n28_), .c(new_n27_), .O(z8));
  nand2  g14(.a(x3), .b(new_n16_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(z2), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n20_), .O(z9));
  one    g17(.O(z3));
  one    g18(.O(z6));
