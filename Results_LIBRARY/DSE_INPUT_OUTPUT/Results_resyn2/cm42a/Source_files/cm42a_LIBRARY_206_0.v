...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n21_, new_n22_, new_n25_, new_n28_;
  ...
  oai21  g08(.a(new_n19_), .b(new_n16_), .c(new_n15_), .O(z4));
  oai21  g09(.a(x3), .b(new_n21_), .c(x2), .O(new_n25_));
