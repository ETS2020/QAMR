...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n23_;
  ...
  nand4  g08(.a(new_n19_), .b(x2), .c(new_n18_), .d(new_n23_), .O(z4));
  nand4  g09(.a(new_n19_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  oai21  g10(.a(new_n16_), .b(new_n15_), .c(x1), .O(z6));
  nand4  g11(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g12(.a(x3), .b(new_n15_), .c(new_n18_), .d(new_n23_), .O(z8));
  nand4  g13(.a(x3), .b(new_n15_), .c(new_n18_), .d(x0), .O(z9));
  one    g14(.O(z2));
endmodule
