...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n20_, new_n21_, new_n23_, new_n28_;
  ...
  nand4  g08(.a(new_n18_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  nand4  g09(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g10(.a(x3), .b(new_n17_), .c(new_n21_), .d(new_n20_), .O(z8));
  oai21  g11(.a(x1), .b(new_n20_), .c(x3), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(new_n17_), .O(z9));
  one    g13(.O(z0));
  one    g14(.O(z1));
