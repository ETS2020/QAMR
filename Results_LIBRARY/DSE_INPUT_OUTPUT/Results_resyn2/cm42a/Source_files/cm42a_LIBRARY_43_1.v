...
module FAU ( 
  ...
  oai21  g14(.a(new_n28_), .b(x3), .c(new_n26_), .O(z4));
  oai21  g15(.a(new_n28_), .b(new_n19_), .c(new_n20_), .O(z5));
  oai21  g16(.a(new_n27_), .b(new_n22_), .c(new_n18_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n26_), .O(z6));
  nand2  g18(.a(new_n31_), .b(new_n20_), .O(z7));
  nand3  g19(.a(new_n15_), .b(x3), .c(x0), .O(z9));
  one    g20(.O(z8));
endmodule
