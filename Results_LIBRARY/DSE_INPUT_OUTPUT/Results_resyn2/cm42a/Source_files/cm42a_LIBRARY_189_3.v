...
module FAU ( 
  ...
  nand3  g11(.a(new_n23_), .b(x2), .c(new_n19_), .O(z4));
  nand3  g12(.a(new_n21_), .b(x2), .c(new_n19_), .O(z5));
  oai21  g13(.a(new_n20_), .b(new_n19_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n17_), .O(z6));
  nand3  g15(.a(new_n21_), .b(x2), .c(x1), .O(z7));
