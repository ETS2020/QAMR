...
module FAU ( 
  ...
  xor2a  g09(.a(x2), .b(x1), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n20_), .O(z5));
  nand3  g11(.a(new_n17_), .b(x2), .c(x1), .O(z6));
  inv1   g12(.a(x3), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g14(.a(new_n27_), .b(x0), .c(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n16_), .O(z8));
  nand4  g16(.a(x3), .b(new_n16_), .c(new_n15_), .d(x0), .O(z9));
  nand2  g17(.a(new_n16_), .b(x1), .O(z3));
endmodule
