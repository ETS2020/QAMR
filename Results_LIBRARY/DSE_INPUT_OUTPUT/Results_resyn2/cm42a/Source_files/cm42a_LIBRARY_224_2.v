...
module FAU ( 
  ...
  inv1   g12(.a(new_n26_), .O(z4));
  nor2   g13(.a(new_n21_), .b(x2), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n16_), .c(new_n15_), .O(z8));
  aoi21  g15(.a(new_n28_), .b(new_n19_), .c(new_n26_), .O(z9));
  inv1   g16(.a(new_n26_), .O(z5));
  inv1   g17(.a(new_n26_), .O(z6));
  inv1   g18(.a(new_n26_), .O(z7));
endmodule
