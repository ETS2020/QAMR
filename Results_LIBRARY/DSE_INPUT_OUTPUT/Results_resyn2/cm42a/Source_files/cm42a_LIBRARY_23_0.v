...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n21_, new_n22_, new_n24_, new_n26_;
  ...
  nand4  g09(.a(new_n24_), .b(x2), .c(new_n15_), .d(new_n21_), .O(z4));
  oai21  g10(.a(x3), .b(new_n21_), .c(x2), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n15_), .O(z5));
  nand4  g12(.a(new_n24_), .b(x2), .c(x1), .d(new_n21_), .O(z6));
  nand4  g13(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  one    g14(.O(z1));
  one    g15(.O(z8));
  one    g16(.O(z9));
endmodule
