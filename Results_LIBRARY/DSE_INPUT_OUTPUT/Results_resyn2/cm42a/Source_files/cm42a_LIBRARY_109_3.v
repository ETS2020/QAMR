...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n21_, new_n22_, new_n23_, new_n24_, new_n27_,
    new_n28_;
  ...
  oai21  g08(.a(x3), .b(new_n22_), .c(new_n21_), .O(new_n23_));
  ...
  nand4  g14(.a(new_n28_), .b(x2), .c(x1), .d(new_n27_), .O(z6));
  nand3  g15(.a(new_n16_), .b(x3), .c(new_n22_), .O(z8));
  nand4  g16(.a(x3), .b(new_n22_), .c(new_n21_), .d(x0), .O(z9));
