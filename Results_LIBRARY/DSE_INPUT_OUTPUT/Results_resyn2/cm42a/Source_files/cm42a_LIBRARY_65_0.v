...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n21_, new_n22_, new_n27_, new_n29_;
  ...
  nand4  g11(.a(x3), .b(new_n27_), .c(new_n15_), .d(new_n21_), .O(z8));
  oai21  g12(.a(x2), .b(new_n21_), .c(x3), .O(new_n29_));
