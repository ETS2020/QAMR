...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n20_, new_n21_, new_n25_, new_n26_;
  ...
  nand4  g07(.a(new_n17_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  nand2  g08(.a(x1), .b(x0), .O(new_n25_));
  nand2  g09(.a(new_n25_), .b(x2), .O(new_n26_));
  nand2  g10(.a(new_n26_), .b(new_n17_), .O(z7));
  nand4  g11(.a(x3), .b(new_n16_), .c(new_n21_), .d(new_n20_), .O(z8));
  nand4  g12(.a(x3), .b(new_n16_), .c(new_n21_), .d(x0), .O(z9));
  one    g13(.O(z0));
  one    g14(.O(z2));
  nand2  g15(.a(new_n17_), .b(new_n16_), .O(z3));
endmodule
