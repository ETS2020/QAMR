...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(x2), .c(new_n20_), .d(new_n15_), .O(z4));
  nand4  g10(.a(new_n23_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  nand4  g11(.a(new_n23_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  xnor2a g12(.a(x2), .b(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n21_), .O(z7));
  nand4  g14(.a(x3), .b(new_n16_), .c(new_n20_), .d(x0), .O(z9));
