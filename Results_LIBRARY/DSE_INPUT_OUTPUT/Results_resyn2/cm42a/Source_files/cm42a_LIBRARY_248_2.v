...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n23_, new_n25_, new_n26_;
  ...
  nand2  g06(.a(new_n16_), .b(x0), .O(z3));
  oai21  g07(.a(new_n20_), .b(x1), .c(new_n15_), .O(new_n23_));
  ...
  nand3  g12(.a(new_n17_), .b(x3), .c(new_n15_), .O(z8));
  oai21  g13(.a(new_n17_), .b(new_n16_), .c(x0), .O(z9));
  one    g14(.O(z1));
  nand2  g15(.a(new_n16_), .b(x0), .O(z5));
  nand2  g16(.a(new_n16_), .b(x0), .O(z7));
endmodule
