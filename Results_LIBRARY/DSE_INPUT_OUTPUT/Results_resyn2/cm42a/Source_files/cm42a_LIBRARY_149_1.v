...
module FAU ( 
  ...
  nand3  g11(.a(new_n23_), .b(new_n25_), .c(x0), .O(z3));
  oai21  g12(.a(new_n25_), .b(x0), .c(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n15_), .O(z4));
  oai21  g14(.a(new_n25_), .b(new_n19_), .c(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z5));
  nand3  g16(.a(new_n23_), .b(x2), .c(new_n19_), .O(z6));
