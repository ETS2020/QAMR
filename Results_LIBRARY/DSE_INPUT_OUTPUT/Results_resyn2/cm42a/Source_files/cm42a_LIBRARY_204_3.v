...
module FAU ( 
  ...
  oai21  g08(.a(x2), .b(new_n18_), .c(new_n22_), .O(new_n23_));
  ...
  oai21  g13(.a(new_n25_), .b(x1), .c(new_n22_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x0), .O(z5));
  nand3  g15(.a(new_n26_), .b(x1), .c(new_n20_), .O(z6));
  nand3  g16(.a(new_n26_), .b(x1), .c(x0), .O(z7));
  nand3  g17(.a(new_n16_), .b(x3), .c(new_n25_), .O(z8));
  one    g18(.O(z9));
endmodule
