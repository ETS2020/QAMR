...
module FAU ( 
  ...
  nand2  g10(.a(new_n16_), .b(x2), .O(z4));
  oai21  g11(.a(x1), .b(new_n22_), .c(new_n15_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x2), .O(z5));
  nand4  g13(.a(new_n15_), .b(x2), .c(x1), .d(new_n22_), .O(z6));
  nand4  g14(.a(new_n15_), .b(x2), .c(x1), .d(x0), .O(z7));
  inv1   g15(.a(x2), .O(new_n30_));
  nand4  g16(.a(x3), .b(new_n30_), .c(new_n19_), .d(new_n22_), .O(z8));
  oai21  g17(.a(x1), .b(new_n22_), .c(new_n30_), .O(new_n32_));
