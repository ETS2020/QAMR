...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n27_, new_n32_, new_n33_;
  ...
  nand3  g13(.a(new_n16_), .b(new_n27_), .c(x2), .O(z4));
  nand4  g14(.a(new_n27_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  nand2  g15(.a(x2), .b(x1), .O(z7));
  oai21  g16(.a(new_n27_), .b(x2), .c(new_n18_), .O(new_n32_));
  oai21  g17(.a(x1), .b(x0), .c(new_n21_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n32_), .O(z8));
  nand2  g19(.a(new_n32_), .b(new_n22_), .O(z9));
  one    g20(.O(z6));
endmodule
