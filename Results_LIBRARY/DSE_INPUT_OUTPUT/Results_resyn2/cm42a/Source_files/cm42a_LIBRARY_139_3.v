...
module FAU ( 
  ...
  nand2  g10(.a(new_n24_), .b(new_n22_), .O(z4));
  oai21  g11(.a(x3), .b(new_n23_), .c(new_n16_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x0), .O(z5));
  nand2  g13(.a(new_n24_), .b(x1), .O(z6));
  inv1   g14(.a(x3), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(x2), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n22_), .O(z8));
