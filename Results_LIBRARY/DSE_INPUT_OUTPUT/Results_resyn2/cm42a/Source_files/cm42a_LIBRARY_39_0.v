...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n27_, new_n30_;
  ...
  nand4  g08(.a(new_n17_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  ...
  oai21  g12(.a(x2), .b(new_n19_), .c(x3), .O(new_n30_));
