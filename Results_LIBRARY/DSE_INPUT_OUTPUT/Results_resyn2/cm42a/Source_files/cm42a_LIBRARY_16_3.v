...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n26_, new_n29_, new_n34_;
  ...
  oai21  g14(.a(x1), .b(new_n20_), .c(new_n25_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(z5));
  nand4  g16(.a(new_n25_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  nand4  g17(.a(new_n25_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g18(.a(new_n16_), .b(x2), .c(x3), .O(z8));
  oai21  g19(.a(x1), .b(new_n20_), .c(new_n22_), .O(new_n34_));
