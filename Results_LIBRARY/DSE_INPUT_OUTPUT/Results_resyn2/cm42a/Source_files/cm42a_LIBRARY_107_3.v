...
module FAU ( 
  ...
  and2   g04(.a(x3), .b(x0), .O(new_n19_));
  inv1   g05(.a(x1), .O(new_n20_));
  nor2   g06(.a(x2), .b(new_n20_), .O(new_n21_));
  aoi21  g07(.a(new_n21_), .b(new_n16_), .c(new_n19_), .O(z2));
  inv1   g08(.a(x3), .O(new_n23_));
  nand3  g09(.a(new_n21_), .b(new_n23_), .c(x0), .O(z3));
  inv1   g10(.a(x2), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(x1), .c(new_n23_), .O(new_n26_));
  xnor2a g12(.a(x3), .b(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n26_), .O(z4));
  nand2  g14(.a(new_n26_), .b(x0), .O(z5));
  nor2   g15(.a(new_n25_), .b(new_n20_), .O(new_n30_));
