...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n24_, new_n25_,
    new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_, new_n36_;
  ...
  nand2  g08(.a(x3), .b(new_n16_), .O(z9));
  nand2  g09(.a(new_n18_), .b(x1), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(z9), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n20_), .O(z3));
  nand3  g12(.a(new_n18_), .b(x2), .c(new_n15_), .O(new_n27_));
  ...
  nand2  g19(.a(new_n27_), .b(x1), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n33_), .O(z6));
  nand2  g21(.a(new_n30_), .b(x1), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n33_), .O(z7));
  one    g23(.O(z8));
endmodule
