...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n21_, new_n23_, new_n24_, new_n29_;
  ...
  nand4  g08(.a(new_n19_), .b(x2), .c(x1), .d(new_n23_), .O(z6));
  nand4  g09(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g10(.a(new_n21_), .b(new_n19_), .c(new_n18_), .O(z8));
  oai21  g11(.a(x1), .b(new_n23_), .c(x3), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n18_), .O(z9));
  one    g13(.O(z0));
  one    g14(.O(z1));
  one    g15(.O(z2));
endmodule
