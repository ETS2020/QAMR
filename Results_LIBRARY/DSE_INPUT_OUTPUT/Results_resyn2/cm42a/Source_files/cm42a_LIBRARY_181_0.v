...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n21_, new_n24_, new_n26_, new_n28_,
    new_n31_;
  ...
  oai21  g10(.a(new_n18_), .b(new_n17_), .c(x1), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n19_), .O(z7));
  nand4  g12(.a(x3), .b(new_n18_), .c(new_n24_), .d(new_n17_), .O(z8));
