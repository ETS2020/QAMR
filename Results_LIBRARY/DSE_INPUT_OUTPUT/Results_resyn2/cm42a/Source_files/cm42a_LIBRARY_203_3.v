...
module FAU ( 
  ...
  oai21  g18(.a(new_n32_), .b(x3), .c(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n18_), .O(z5));
  oai21  g20(.a(new_n21_), .b(x0), .c(new_n17_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x1), .O(z6));
  nand2  g22(.a(new_n32_), .b(new_n17_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x1), .O(z7));
  oai21  g24(.a(new_n24_), .b(x1), .c(x3), .O(z8));
