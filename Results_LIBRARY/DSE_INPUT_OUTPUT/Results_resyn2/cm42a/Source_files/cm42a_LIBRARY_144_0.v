...
module FAU ( 
  ...
  nand3  g07(.a(new_n22_), .b(new_n16_), .c(x0), .O(z3));
  oai21  g08(.a(x3), .b(x1), .c(x2), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n19_), .O(z4));
  xnor2a g10(.a(x2), .b(x0), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n17_), .O(z5));
  oai21  g12(.a(x3), .b(new_n21_), .c(x2), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n19_), .O(z6));
  nand3  g14(.a(new_n22_), .b(x2), .c(x0), .O(z7));
  inv1   g15(.a(x3), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(x1), .c(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n16_), .O(z9));
  one    g18(.O(z0));
  nand2  g19(.a(new_n16_), .b(new_n19_), .O(z8));
endmodule
