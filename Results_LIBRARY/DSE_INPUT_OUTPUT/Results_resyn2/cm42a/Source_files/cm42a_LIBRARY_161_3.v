...
module FAU ( 
  ...
  nand3  g14(.a(new_n15_), .b(x2), .c(new_n26_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(z4));
  nand2  g17(.a(x2), .b(x0), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(x3), .c(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(z5));
  inv1   g20(.a(new_n29_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x1), .O(z6));
  nand2  g22(.a(new_n32_), .b(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x1), .O(z7));
  nand3  g24(.a(new_n24_), .b(x3), .c(new_n19_), .O(z8));
  oai21  g25(.a(new_n27_), .b(x1), .c(x3), .O(z9));
endmodule
