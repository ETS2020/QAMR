...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n28_, new_n30_, new_n32_, new_n34_, new_n37_;
  ...
  oai21  g10(.a(x3), .b(new_n21_), .c(new_n15_), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n19_), .c(new_n17_), .O(z2));
  nand3  g12(.a(new_n23_), .b(new_n18_), .c(x1), .O(z3));
  nor2   g13(.a(x1), .b(x0), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(x3), .c(x2), .O(z4));
  oai21  g15(.a(x1), .b(new_n22_), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x2), .O(z5));
  oai21  g17(.a(new_n21_), .b(x0), .c(new_n18_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z6));
  oai21  g19(.a(new_n21_), .b(new_n22_), .c(new_n18_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x2), .O(z7));
  oai21  g21(.a(new_n28_), .b(x2), .c(x3), .O(z8));
  oai21  g22(.a(x1), .b(new_n22_), .c(new_n15_), .O(new_n37_));
