...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n24_, new_n28_;
  ...
  nor2   g11(.a(new_n15_), .b(x2), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(new_n16_), .O(z8));
  aoi21  g13(.a(new_n28_), .b(new_n20_), .c(new_n24_), .O(z9));
  one    g14(.O(z6));
  one    g15(.O(z7));
  inv1   g16(.a(new_n24_), .O(z5));
endmodule
