...
module FAU ( 
  ...
  oai21  g15(.a(x08), .b(x00), .c(x01), .O(new_n44_));
  ...
  aoi21  g24(.a(new_n47_), .b(x13), .c(x14), .O(new_n53_));
  nand2  g25(.a(new_n36_), .b(new_n30_), .O(new_n54_));
  aoi21  g26(.a(x08), .b(x03), .c(new_n39_), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(z4));
  inv1   g28(.a(x15), .O(new_n57_));
  aoi21  g29(.a(new_n30_), .b(new_n57_), .c(new_n35_), .O(new_n58_));
  oai21  g30(.a(new_n30_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  ...
  nand4  g35(.a(new_n63_), .b(new_n47_), .c(x16), .d(x15), .O(new_n64_));
  inv1   g36(.a(x16), .O(new_n65_));
  oai21  g37(.a(new_n30_), .b(new_n57_), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n36_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n62_), .c(new_n39_), .O(z6));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n69_), .c(new_n39_), .O(z7));
  nand2  g46(.a(new_n32_), .b(x18), .O(new_n75_));
  inv1   g47(.a(x18), .O(new_n76_));
  oai21  g48(.a(new_n31_), .b(new_n30_), .c(new_n76_), .O(new_n77_));
