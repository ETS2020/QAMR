...
module FAU ( 
  ...
  nand4  g02(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n31_));
  ...
  aoi21  g08(.a(new_n36_), .b(x14), .c(x10), .O(z0));
  ...
  nand3  g14(.a(new_n30_), .b(x14), .c(new_n39_), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(x11), .c(new_n42_), .O(z1));
  nor2   g16(.a(x12), .b(x11), .O(new_n45_));
  nand2  g17(.a(x12), .b(x11), .O(new_n46_));
  nand3  g18(.a(new_n46_), .b(x09), .c(new_n38_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n45_), .c(x14), .O(new_n48_));
  ...
  nand3  g24(.a(new_n52_), .b(x09), .c(new_n38_), .O(new_n53_));
  ...
  nand2  g35(.a(new_n52_), .b(new_n63_), .O(new_n64_));
  ...
  inv1   g42(.a(new_n43_), .O(new_n71_));
  nand2  g43(.a(new_n31_), .b(new_n33_), .O(new_n72_));
  nand2  g44(.a(new_n32_), .b(x16), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n70_), .O(z6));
  nand2  g47(.a(new_n41_), .b(x06), .O(new_n76_));
  nand2  g48(.a(new_n35_), .b(new_n32_), .O(new_n77_));
  nand2  g49(.a(new_n73_), .b(new_n34_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n71_), .c(new_n77_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n76_), .O(z7));
  nand2  g52(.a(new_n41_), .b(x07), .O(new_n81_));
  nand3  g53(.a(new_n35_), .b(new_n32_), .c(x18), .O(new_n82_));
  inv1   g54(.a(x18), .O(new_n83_));
  nand2  g55(.a(new_n77_), .b(new_n83_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n71_), .c(new_n82_), .O(new_n85_));
