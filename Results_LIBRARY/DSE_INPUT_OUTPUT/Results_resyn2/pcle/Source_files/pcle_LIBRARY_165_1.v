...
module FAU ( 
  ...
  nor2   g14(.a(x12), .b(x10), .O(new_n43_));
  nand3  g15(.a(new_n43_), .b(new_n42_), .c(x11), .O(new_n44_));
  oai21  g16(.a(new_n40_), .b(new_n39_), .c(new_n44_), .O(z2));
  nand3  g17(.a(x13), .b(x09), .c(new_n32_), .O(new_n46_));
  ...
  nand3  g22(.a(x14), .b(x09), .c(new_n32_), .O(new_n51_));
  ...
  nand3  g27(.a(x15), .b(x09), .c(new_n32_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n29_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n31_), .O(new_n58_));
  nand2  g30(.a(x08), .b(x04), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z5));
  nand3  g32(.a(x16), .b(x09), .c(new_n32_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n29_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n31_), .O(new_n63_));
  nand2  g35(.a(x08), .b(x05), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(z6));
  inv1   g37(.a(x06), .O(new_n66_));
  nand3  g38(.a(new_n43_), .b(new_n42_), .c(x17), .O(new_n67_));
  oai21  g39(.a(new_n40_), .b(new_n66_), .c(new_n67_), .O(z7));
  inv1   g40(.a(x07), .O(new_n69_));
  nand3  g41(.a(new_n43_), .b(new_n42_), .c(x18), .O(new_n70_));
  oai21  g42(.a(new_n40_), .b(new_n69_), .c(new_n70_), .O(z8));
endmodule
