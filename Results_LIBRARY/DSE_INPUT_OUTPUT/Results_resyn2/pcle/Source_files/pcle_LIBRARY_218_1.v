...
module FAU ( 
  ...
  oai21  g29(.a(new_n53_), .b(new_n52_), .c(new_n57_), .O(z3));
  ...
  oai22  g34(.a(new_n62_), .b(new_n61_), .c(new_n53_), .d(new_n59_), .O(z4));
  ...
  oai22  g40(.a(new_n68_), .b(new_n66_), .c(new_n53_), .d(new_n64_), .O(z5));
  ...
  aoi21  g48(.a(new_n66_), .b(x16), .c(x17), .O(new_n77_));
  nand2  g49(.a(new_n35_), .b(new_n33_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n39_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x06), .c(new_n49_), .O(new_n80_));
