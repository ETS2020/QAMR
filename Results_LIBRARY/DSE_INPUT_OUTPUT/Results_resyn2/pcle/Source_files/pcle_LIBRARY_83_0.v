...
module FAU ( 
  ...
  nor2   g11(.a(x18), .b(x05), .O(new_n40_));
  ...
  aoi21  g22(.a(new_n50_), .b(new_n46_), .c(new_n40_), .O(z2));
  aoi21  g23(.a(x12), .b(x11), .c(x13), .O(new_n52_));
  nand2  g24(.a(new_n43_), .b(new_n30_), .O(new_n53_));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n56_), .c(new_n40_), .O(z4));
  nand2  g33(.a(x08), .b(x04), .O(new_n62_));
  nand2  g34(.a(new_n33_), .b(new_n31_), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n57_), .b(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n43_), .c(new_n63_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n62_), .c(new_n40_), .O(z5));
  inv1   g39(.a(x05), .O(new_n68_));
  nand3  g40(.a(new_n33_), .b(new_n31_), .c(x16), .O(new_n69_));
  inv1   g41(.a(new_n69_), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  oai21  g43(.a(new_n32_), .b(new_n30_), .c(new_n71_), .O(new_n72_));
  oai21  g44(.a(new_n29_), .b(x08), .c(new_n68_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n72_), .c(new_n37_), .d(x09), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(z6));
  inv1   g47(.a(x17), .O(new_n76_));
  nand2  g48(.a(new_n69_), .b(new_n76_), .O(new_n77_));
  nor2   g49(.a(new_n32_), .b(new_n30_), .O(new_n78_));
  aoi21  g50(.a(new_n34_), .b(new_n78_), .c(new_n38_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x06), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n80_), .c(new_n40_), .O(z7));
  nand2  g54(.a(x08), .b(x07), .O(new_n83_));
  inv1   g55(.a(new_n83_), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n79_), .c(x18), .O(new_n85_));
  nand4  g57(.a(new_n29_), .b(new_n37_), .c(x09), .d(new_n36_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n35_), .c(new_n83_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x05), .O(new_n88_));
