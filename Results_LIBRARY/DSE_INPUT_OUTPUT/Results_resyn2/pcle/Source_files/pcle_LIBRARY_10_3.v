...
module FAU ( 
  ...
  nor2   g11(.a(new_n29_), .b(new_n33_), .O(new_n40_));
  aoi21  g12(.a(x08), .b(x01), .c(new_n40_), .O(new_n41_));
  oai21  g13(.a(new_n39_), .b(new_n34_), .c(new_n41_), .O(z2));
  ...
  oai22  g18(.a(new_n46_), .b(new_n44_), .c(new_n37_), .d(new_n43_), .O(z3));
  ...
  aoi21  g23(.a(x08), .b(x03), .c(new_n40_), .O(new_n52_));
  ...
  nand2  g46(.a(new_n61_), .b(x07), .O(new_n75_));
  oai21  g47(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n76_));
  nor2   g48(.a(x18), .b(new_n71_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n54_), .c(new_n65_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n45_), .O(new_n80_));
