...
module FAU ( 
  ...
  oai21  g32(.a(new_n49_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  ...
  nor2   g40(.a(new_n62_), .b(new_n49_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x17), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  oai22  g43(.a(new_n62_), .b(new_n49_), .c(x18), .d(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n36_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n68_), .O(z7));
  aoi21  g46(.a(new_n69_), .b(x17), .c(x18), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x07), .c(z0), .O(new_n76_));
  oai21  g48(.a(new_n75_), .b(new_n35_), .c(new_n76_), .O(z8));
endmodule
