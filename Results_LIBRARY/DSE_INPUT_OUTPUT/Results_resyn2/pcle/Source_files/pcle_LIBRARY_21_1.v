...
module FAU ( 
  ...
  nand2  g23(.a(new_n41_), .b(new_n51_), .O(new_n52_));
  ...
  nand2  g28(.a(new_n41_), .b(new_n30_), .O(new_n57_));
  ...
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n41_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n60_), .c(new_n38_), .O(z5));
  nand3  g38(.a(new_n61_), .b(x16), .c(x15), .O(new_n67_));
  inv1   g39(.a(x16), .O(new_n68_));
  oai21  g40(.a(new_n30_), .b(new_n63_), .c(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n41_), .c(new_n67_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x05), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n38_), .O(z6));
  nor2   g44(.a(new_n32_), .b(x17), .O(new_n73_));
  nand2  g45(.a(new_n41_), .b(new_n33_), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x06), .c(new_n38_), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(new_n73_), .c(new_n75_), .O(z7));
  oai21  g48(.a(new_n36_), .b(new_n32_), .c(x17), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x18), .O(new_n78_));
  inv1   g50(.a(x17), .O(new_n79_));
  nor3   g51(.a(new_n31_), .b(new_n30_), .c(new_n79_), .O(new_n80_));
  and2   g52(.a(x08), .b(x07), .O(new_n81_));
  nand4  g53(.a(new_n29_), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n82_));
  inv1   g54(.a(new_n82_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n80_), .c(new_n81_), .O(new_n84_));
