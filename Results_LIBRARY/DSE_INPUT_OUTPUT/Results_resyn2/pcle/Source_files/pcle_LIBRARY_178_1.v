...
module FAU ( 
  ...
  nor2   g10(.a(new_n29_), .b(x16), .O(new_n39_));
  ...
  oai21  g33(.a(new_n34_), .b(new_n54_), .c(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n33_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n58_), .c(new_n39_), .O(z5));
  aoi21  g36(.a(new_n36_), .b(new_n33_), .c(x18), .O(new_n65_));
  nand4  g37(.a(x16), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n66_));
  inv1   g38(.a(new_n66_), .O(new_n67_));
  and2   g39(.a(x08), .b(x05), .O(new_n68_));
  aoi21  g40(.a(new_n67_), .b(new_n60_), .c(new_n68_), .O(new_n69_));
  oai21  g41(.a(new_n65_), .b(x16), .c(new_n69_), .O(z6));
  inv1   g42(.a(new_n39_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(x08), .c(x06), .O(new_n72_));
  nand3  g44(.a(new_n36_), .b(x17), .c(x16), .O(new_n73_));
  inv1   g45(.a(x17), .O(new_n74_));
  nand3  g46(.a(new_n59_), .b(new_n52_), .c(x16), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nor2   g48(.a(new_n39_), .b(new_n32_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n76_), .c(new_n73_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n72_), .O(z7));
  nand3  g51(.a(new_n71_), .b(x08), .c(x07), .O(new_n80_));
  aoi21  g52(.a(new_n36_), .b(x17), .c(x18), .O(new_n81_));
  nand3  g53(.a(new_n36_), .b(x18), .c(x17), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n67_), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n81_), .c(new_n80_), .O(z8));
endmodule
