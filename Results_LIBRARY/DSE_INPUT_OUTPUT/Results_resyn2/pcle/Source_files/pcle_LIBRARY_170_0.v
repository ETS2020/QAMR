...
module FAU ( 
  ...
  nand3  g16(.a(new_n30_), .b(x08), .c(x02), .O(new_n45_));
  nand2  g17(.a(new_n37_), .b(new_n30_), .O(new_n46_));
  ...
  oai21  g23(.a(new_n36_), .b(new_n51_), .c(x18), .O(new_n52_));
  ...
  nand3  g29(.a(new_n57_), .b(new_n56_), .c(new_n37_), .O(new_n58_));
  ...
  nand3  g34(.a(new_n62_), .b(new_n61_), .c(new_n37_), .O(new_n63_));
  oai21  g35(.a(new_n36_), .b(new_n60_), .c(x18), .O(new_n64_));
  ...
  nand2  g43(.a(new_n71_), .b(new_n37_), .O(new_n72_));
  oai21  g44(.a(new_n36_), .b(new_n69_), .c(x18), .O(new_n73_));
  ...
  oai21  g54(.a(new_n36_), .b(new_n79_), .c(x18), .O(new_n83_));
  and2   g55(.a(x08), .b(x06), .O(new_n84_));
  aoi21  g56(.a(new_n83_), .b(new_n50_), .c(new_n84_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n82_), .O(z7));
  nand3  g58(.a(new_n30_), .b(x08), .c(x07), .O(new_n87_));
  and2   g59(.a(new_n33_), .b(x18), .O(new_n88_));
  oai21  g60(.a(new_n33_), .b(x18), .c(new_n37_), .O(new_n89_));
