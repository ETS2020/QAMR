...
module FAU ( 
  ...
  oai21  g43(.a(new_n56_), .b(new_n64_), .c(new_n71_), .O(new_n72_));
  ...
  oai21  g48(.a(new_n75_), .b(new_n32_), .c(new_n76_), .O(z7));
  oai21  g49(.a(new_n35_), .b(new_n34_), .c(x17), .O(new_n78_));
  nand2  g50(.a(x18), .b(new_n29_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n33_), .O(new_n81_));
  aoi21  g53(.a(x08), .b(x07), .c(new_n39_), .O(new_n82_));
