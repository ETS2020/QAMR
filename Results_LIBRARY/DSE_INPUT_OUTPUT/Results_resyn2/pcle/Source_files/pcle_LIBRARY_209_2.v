...
module FAU ( 
  ...
  and2   g01(.a(x17), .b(x16), .O(new_n30_));
  ...
  nand3  g08(.a(new_n36_), .b(new_n34_), .c(new_n30_), .O(new_n37_));
  aoi21  g09(.a(new_n37_), .b(x18), .c(new_n29_), .O(z0));
  nor2   g10(.a(x18), .b(new_n29_), .O(new_n39_));
  nand2  g11(.a(x08), .b(x00), .O(new_n40_));
  inv1   g12(.a(x11), .O(new_n41_));
  nand2  g13(.a(new_n34_), .b(new_n41_), .O(new_n42_));
  ...
  aoi21  g23(.a(new_n45_), .b(new_n51_), .c(new_n33_), .O(new_n52_));
  oai21  g24(.a(new_n45_), .b(new_n51_), .c(new_n52_), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n50_), .c(new_n39_), .O(z3));
  inv1   g26(.a(new_n45_), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(x13), .c(x14), .O(new_n56_));
  nand3  g28(.a(new_n55_), .b(x14), .c(x13), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n34_), .O(new_n58_));
  ...
  nand2  g35(.a(new_n35_), .b(x18), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(x14), .c(new_n33_), .O(new_n65_));
  oai21  g37(.a(new_n63_), .b(x15), .c(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n62_), .O(z5));
  nand3  g39(.a(new_n61_), .b(x08), .c(x05), .O(new_n68_));
  nor2   g40(.a(new_n35_), .b(new_n29_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(x16), .c(new_n33_), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  oai21  g43(.a(new_n35_), .b(new_n29_), .c(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n61_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n68_), .O(z6));
  nand2  g46(.a(new_n70_), .b(x17), .O(new_n75_));
  inv1   g47(.a(x09), .O(new_n76_));
  nor2   g48(.a(new_n76_), .b(x08), .O(new_n77_));
  nor2   g49(.a(x17), .b(new_n71_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n36_), .c(new_n77_), .d(new_n32_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(x18), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(x14), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n75_), .O(z7));
  nand2  g55(.a(new_n69_), .b(new_n30_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n34_), .c(x18), .O(new_n85_));
