...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n35_), .c(new_n33_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n51_), .c(new_n40_), .O(z3));
  nand2  g27(.a(x08), .b(x03), .O(new_n56_));
  inv1   g28(.a(new_n35_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x14), .O(new_n58_));
  inv1   g30(.a(x14), .O(new_n59_));
  nand2  g31(.a(new_n35_), .b(new_n59_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(new_n33_), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n56_), .c(new_n40_), .O(z4));
  aoi21  g34(.a(new_n57_), .b(x14), .c(x15), .O(new_n63_));
  oai21  g35(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(new_n64_));
  ...
  nand4  g39(.a(new_n57_), .b(x16), .c(x15), .d(x14), .O(new_n68_));
  oai21  g40(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n68_), .c(new_n33_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n67_), .c(new_n40_), .O(z6));
  aoi21  g43(.a(new_n37_), .b(new_n33_), .c(x18), .O(new_n72_));
  and2   g44(.a(x08), .b(x06), .O(new_n73_));
  nand4  g45(.a(x17), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n74_));
  inv1   g46(.a(new_n74_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n68_), .c(new_n73_), .O(new_n76_));
  oai21  g48(.a(new_n72_), .b(x17), .c(new_n76_), .O(z7));
  nor2   g49(.a(new_n37_), .b(x18), .O(new_n78_));
  oai21  g50(.a(new_n68_), .b(new_n29_), .c(new_n75_), .O(new_n79_));
  inv1   g51(.a(new_n40_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(x08), .c(x07), .O(new_n81_));
  oai21  g53(.a(new_n79_), .b(new_n78_), .c(new_n81_), .O(z8));
endmodule
