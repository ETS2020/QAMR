...
module FAU ( 
  ...
  nand2  g20(.a(new_n43_), .b(new_n49_), .O(new_n50_));
  nand3  g21(.a(new_n50_), .b(new_n48_), .c(new_n42_), .O(new_n51_));
  ...
  nand3  g28(.a(new_n57_), .b(new_n55_), .c(new_n42_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n53_), .c(new_n35_), .O(z5));
  nand2  g30(.a(x08), .b(x05), .O(new_n60_));
  xnor2a g31(.a(x16), .b(x15), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n54_), .O(new_n62_));
  inv1   g33(.a(x16), .O(new_n63_));
  nand2  g34(.a(new_n48_), .b(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n62_), .c(new_n42_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n60_), .c(new_n35_), .O(z6));
  nand2  g37(.a(x16), .b(x15), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n48_), .O(new_n68_));
  xor2a  g39(.a(new_n68_), .b(new_n33_), .O(new_n69_));
  aoi21  g40(.a(x08), .b(x06), .c(new_n35_), .O(new_n70_));
  oai21  g41(.a(new_n69_), .b(new_n32_), .c(new_n70_), .O(z7));
  nor2   g42(.a(new_n68_), .b(new_n33_), .O(new_n72_));
  inv1   g43(.a(new_n35_), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(x08), .c(x07), .O(new_n74_));
  nand2  g45(.a(new_n34_), .b(new_n33_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(new_n73_), .c(new_n42_), .O(new_n76_));
  oai21  g47(.a(new_n76_), .b(new_n72_), .c(new_n74_), .O(z8));
  zero   g48(.O(z0));
endmodule
