...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n42_), .c(new_n29_), .O(new_n54_));
  ...
  nand2  g29(.a(new_n42_), .b(new_n57_), .O(new_n58_));
  ...
  inv1   g33(.a(new_n57_), .O(new_n62_));
  ...
  oai21  g40(.a(new_n57_), .b(new_n64_), .c(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n62_), .b(x16), .c(x15), .O(new_n70_));
  ...
  oai21  g50(.a(new_n78_), .b(x08), .c(new_n74_), .O(new_n79_));
  inv1   g51(.a(x09), .O(new_n80_));
  nor2   g52(.a(x10), .b(new_n80_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n79_), .c(new_n77_), .d(new_n33_), .O(new_n82_));
  oai21  g54(.a(new_n34_), .b(new_n74_), .c(new_n82_), .O(z7));
  nor2   g55(.a(new_n31_), .b(new_n57_), .O(new_n84_));
  aoi21  g56(.a(new_n42_), .b(new_n84_), .c(new_n74_), .O(new_n85_));
  inv1   g57(.a(new_n36_), .O(new_n86_));
  and2   g58(.a(x08), .b(x07), .O(new_n87_));
  aoi21  g59(.a(new_n86_), .b(new_n33_), .c(new_n87_), .O(new_n88_));
