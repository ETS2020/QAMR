...
module FAU ( 
  ...
  nor2   g32(.a(new_n34_), .b(new_n32_), .O(new_n61_));
  nor2   g33(.a(new_n61_), .b(new_n31_), .O(new_n62_));
  oai21  g34(.a(new_n60_), .b(x15), .c(new_n62_), .O(new_n63_));
  ...
  aoi21  g40(.a(new_n61_), .b(x16), .c(new_n31_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n66_), .c(new_n38_), .O(z6));
  inv1   g43(.a(x17), .O(new_n72_));
  nand2  g44(.a(new_n37_), .b(new_n72_), .O(new_n73_));
  and2   g45(.a(x08), .b(x06), .O(new_n74_));
  aoi21  g46(.a(new_n69_), .b(x17), .c(new_n74_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n73_), .O(z7));
  nand2  g48(.a(new_n40_), .b(new_n36_), .O(new_n77_));
  nand3  g49(.a(new_n61_), .b(x18), .c(x16), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n77_), .c(new_n46_), .O(new_n79_));
  nand2  g51(.a(new_n31_), .b(x18), .O(new_n80_));
  aoi22  g52(.a(new_n80_), .b(new_n72_), .c(x08), .d(x07), .O(new_n81_));
