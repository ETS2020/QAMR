...
module FAU ( 
  ...
  oai21  g11(.a(new_n40_), .b(new_n37_), .c(new_n39_), .O(z2));
  ...
  nand3  g16(.a(new_n45_), .b(new_n42_), .c(new_n36_), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(new_n34_), .O(new_n47_));
  ...
  nand2  g23(.a(new_n42_), .b(new_n52_), .O(new_n53_));
  ...
  inv1   g32(.a(new_n51_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x15), .c(new_n61_), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n60_), .c(x18), .O(new_n64_));
  nand2  g35(.a(x08), .b(x04), .O(new_n65_));
  oai21  g36(.a(new_n64_), .b(x10), .c(new_n65_), .O(z5));
  inv1   g37(.a(x16), .O(new_n67_));
  oai21  g38(.a(new_n51_), .b(new_n59_), .c(new_n67_), .O(new_n68_));
  nor2   g39(.a(new_n67_), .b(new_n59_), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(new_n62_), .c(new_n61_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n68_), .c(x18), .O(new_n71_));
  nand2  g42(.a(x08), .b(x05), .O(new_n72_));
  oai21  g43(.a(new_n71_), .b(x10), .c(new_n72_), .O(z6));
  nand2  g44(.a(new_n32_), .b(x06), .O(new_n74_));
  nand3  g45(.a(new_n69_), .b(new_n62_), .c(x17), .O(new_n75_));
  inv1   g46(.a(x17), .O(new_n76_));
  nand2  g47(.a(new_n69_), .b(new_n62_), .O(new_n77_));
  aoi21  g48(.a(new_n77_), .b(new_n76_), .c(new_n37_), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n74_), .O(z7));
  nand2  g51(.a(new_n32_), .b(x07), .O(new_n81_));
  oai21  g52(.a(new_n75_), .b(new_n37_), .c(new_n81_), .O(z8));
  zero   g53(.O(z0));
endmodule
