...
module FAU ( 
  ...
  aoi21  g38(.a(new_n66_), .b(new_n65_), .c(new_n38_), .O(z5));
  inv1   g39(.a(new_n33_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n56_), .O(new_n69_));
  ...
  nand2  g53(.a(new_n69_), .b(new_n37_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n35_), .c(new_n76_), .O(new_n83_));
