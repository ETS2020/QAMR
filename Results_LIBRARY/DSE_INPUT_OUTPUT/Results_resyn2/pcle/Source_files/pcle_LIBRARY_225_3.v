...
module FAU ( 
  ...
  oai21  g31(.a(new_n59_), .b(new_n42_), .c(new_n58_), .O(new_n60_));
  nor2   g32(.a(new_n59_), .b(new_n42_), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n61_), .b(x16), .c(x17), .O(new_n66_));
  inv1   g38(.a(new_n59_), .O(new_n67_));
  and2   g39(.a(x17), .b(x16), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n67_), .c(new_n46_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n35_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x06), .c(z0), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n66_), .c(new_n71_), .O(z7));
  aoi21  g44(.a(new_n68_), .b(new_n61_), .c(x18), .O(new_n73_));
  aoi21  g45(.a(x08), .b(x07), .c(z0), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n34_), .c(new_n74_), .O(z8));
endmodule
