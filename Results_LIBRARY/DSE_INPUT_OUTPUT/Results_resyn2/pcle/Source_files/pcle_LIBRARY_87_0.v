...
module FAU ( 
  ...
  nand2  g27(.a(new_n38_), .b(new_n55_), .O(new_n56_));
  nor2   g28(.a(new_n36_), .b(new_n29_), .O(new_n57_));
  nand2  g29(.a(new_n39_), .b(x14), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n54_), .O(z4));
  inv1   g32(.a(x15), .O(new_n61_));
  nand2  g33(.a(new_n38_), .b(new_n61_), .O(new_n62_));
  nand4  g34(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n62_), .c(new_n37_), .d(x14), .O(new_n64_));
  oai21  g36(.a(new_n36_), .b(new_n61_), .c(x18), .O(new_n65_));
  ...
  nand4  g41(.a(new_n39_), .b(x16), .c(x15), .d(x14), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  nand3  g43(.a(new_n39_), .b(x15), .c(x14), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n70_), .c(new_n57_), .O(new_n74_));
  ...
  inv1   g50(.a(new_n63_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n78_), .c(new_n36_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  oai21  g53(.a(new_n36_), .b(new_n76_), .c(x18), .O(new_n82_));
  and2   g54(.a(x08), .b(x06), .O(new_n83_));
  aoi21  g55(.a(new_n82_), .b(new_n55_), .c(new_n83_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n81_), .O(z7));
  nand3  g57(.a(new_n79_), .b(new_n78_), .c(x18), .O(new_n86_));
  inv1   g58(.a(x18), .O(new_n87_));
  oai21  g59(.a(new_n63_), .b(new_n31_), .c(new_n87_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n86_), .c(new_n37_), .O(new_n89_));
  oai21  g61(.a(new_n37_), .b(new_n87_), .c(new_n55_), .O(new_n90_));
