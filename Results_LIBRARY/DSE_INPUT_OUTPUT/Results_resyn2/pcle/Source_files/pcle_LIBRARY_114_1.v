...
module FAU ( 
  ...
  nand2  g16(.a(new_n32_), .b(x09), .O(new_n45_));
  oai21  g17(.a(new_n45_), .b(new_n44_), .c(new_n30_), .O(new_n46_));
  ...
  nand3  g27(.a(new_n55_), .b(new_n53_), .c(new_n51_), .O(new_n56_));
  ...
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n58_), .O(z5));
  nand2  g36(.a(x08), .b(x05), .O(new_n65_));
  nand3  g37(.a(new_n61_), .b(x16), .c(x15), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  oai21  g39(.a(new_n53_), .b(new_n59_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n51_), .O(new_n69_));
  ...
  oai21  g45(.a(new_n33_), .b(new_n32_), .c(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n72_), .c(x09), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n30_), .O(new_n76_));
  ...
  aoi21  g52(.a(new_n34_), .b(x17), .c(x18), .O(new_n81_));
  nand2  g53(.a(new_n35_), .b(new_n51_), .O(new_n82_));
