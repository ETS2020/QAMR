...
module FAU ( 
  ...
  nand2  g21(.a(new_n44_), .b(new_n30_), .O(new_n50_));
  ...
  nand3  g31(.a(new_n31_), .b(x15), .c(x14), .O(new_n60_));
  inv1   g32(.a(x15), .O(new_n61_));
  nand2  g33(.a(new_n54_), .b(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n44_), .O(new_n63_));
  ...
  oai21  g39(.a(new_n54_), .b(new_n61_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n44_), .c(new_n66_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n65_), .c(new_n40_), .O(z6));
  oai21  g42(.a(new_n32_), .b(new_n30_), .c(new_n39_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n44_), .c(new_n34_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x06), .c(new_n40_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(z7));
  nand3  g46(.a(new_n44_), .b(new_n34_), .c(x18), .O(new_n75_));
  nand2  g47(.a(x08), .b(x07), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n40_), .c(new_n75_), .O(z8));
endmodule
