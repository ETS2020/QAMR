...
module FAU ( 
  ...
  nand3  g25(.a(new_n50_), .b(x14), .c(x13), .O(new_n54_));
  inv1   g26(.a(x14), .O(new_n55_));
  nand2  g27(.a(new_n51_), .b(new_n55_), .O(new_n56_));
  nand3  g28(.a(new_n56_), .b(new_n54_), .c(new_n33_), .O(new_n57_));
  ...
  nand2  g35(.a(new_n34_), .b(new_n63_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n33_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n60_), .c(new_n39_), .O(z5));
  inv1   g38(.a(x16), .O(new_n67_));
  nor2   g39(.a(new_n62_), .b(new_n67_), .O(new_n68_));
  oai21  g40(.a(new_n34_), .b(new_n63_), .c(new_n67_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n33_), .O(new_n70_));
  ...
  aoi21  g46(.a(new_n36_), .b(new_n29_), .c(x17), .O(new_n75_));
  nand4  g47(.a(new_n61_), .b(x17), .c(x16), .d(x15), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n33_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(z7));
  nand3  g50(.a(new_n73_), .b(x08), .c(x07), .O(new_n79_));
  xor2a  g51(.a(new_n36_), .b(new_n29_), .O(new_n80_));
  nand2  g52(.a(new_n33_), .b(x17), .O(new_n81_));
