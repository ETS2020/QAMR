...
module FAU ( 
  ...
  nand4  g21(.a(new_n49_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n50_));
  ...
  aoi21  g27(.a(x08), .b(x02), .c(new_n39_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n55_), .O(z3));
  nand2  g29(.a(new_n42_), .b(x03), .O(new_n58_));
  inv1   g30(.a(new_n52_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(x14), .O(new_n60_));
  inv1   g32(.a(x14), .O(new_n61_));
  nand2  g33(.a(new_n52_), .b(new_n61_), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(new_n60_), .c(new_n45_), .d(new_n44_), .O(new_n63_));
  ...
  nand2  g40(.a(x14), .b(new_n48_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n44_), .O(new_n70_));
  nand4  g42(.a(x15), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x18), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n48_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n73_), .c(new_n70_), .O(z5));
  nand2  g47(.a(new_n42_), .b(x05), .O(new_n76_));
  inv1   g48(.a(x16), .O(new_n77_));
  oai21  g49(.a(new_n68_), .b(new_n48_), .c(new_n77_), .O(new_n78_));
  nand2  g50(.a(new_n35_), .b(new_n33_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n78_), .c(new_n45_), .d(new_n44_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n76_), .O(z6));
  inv1   g53(.a(x17), .O(new_n82_));
  oai21  g54(.a(new_n34_), .b(new_n32_), .c(new_n82_), .O(new_n83_));
  nand3  g55(.a(x17), .b(x13), .c(x11), .O(new_n84_));
  inv1   g56(.a(new_n84_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n33_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n83_), .c(new_n44_), .O(new_n87_));
  nand2  g59(.a(new_n31_), .b(x18), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n48_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(new_n87_), .O(z7));
  nand3  g63(.a(new_n85_), .b(new_n33_), .c(x18), .O(new_n92_));
  inv1   g64(.a(x18), .O(new_n93_));
  oai21  g65(.a(new_n84_), .b(new_n32_), .c(new_n93_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n92_), .c(new_n44_), .O(new_n95_));
  nand2  g67(.a(new_n38_), .b(x18), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n48_), .O(new_n97_));
  nand2  g69(.a(x08), .b(x07), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(z8));
endmodule
