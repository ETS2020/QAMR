...
module FAU ( 
  ...
  nand4  g08(.a(new_n36_), .b(new_n35_), .c(new_n33_), .d(x18), .O(new_n37_));
  ...
  nand3  g26(.a(new_n54_), .b(new_n32_), .c(new_n43_), .O(new_n55_));
  ...
  oai21  g37(.a(new_n32_), .b(new_n64_), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n63_), .c(new_n43_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n62_), .c(new_n40_), .O(z5));
  nand2  g40(.a(x08), .b(x05), .O(new_n69_));
  nand3  g41(.a(new_n35_), .b(new_n33_), .c(x16), .O(new_n70_));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n69_), .c(new_n40_), .O(z6));
  nor2   g46(.a(new_n34_), .b(new_n32_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(x16), .c(x17), .O(new_n76_));
  nand3  g48(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(new_n77_));
  inv1   g49(.a(new_n40_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n77_), .c(new_n43_), .O(new_n79_));
  nand3  g51(.a(x18), .b(x08), .c(x06), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(new_n76_), .c(new_n80_), .O(z7));
  aoi21  g53(.a(new_n36_), .b(new_n75_), .c(x18), .O(new_n82_));
  nand2  g54(.a(new_n37_), .b(new_n43_), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x07), .c(new_n40_), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(new_n82_), .c(new_n84_), .O(z8));
endmodule
