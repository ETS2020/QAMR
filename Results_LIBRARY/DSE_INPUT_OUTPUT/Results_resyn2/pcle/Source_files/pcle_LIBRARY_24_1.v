...
module FAU ( 
  ...
  aoi21  g09(.a(new_n37_), .b(x09), .c(x08), .O(new_n38_));
  inv1   g10(.a(x17), .O(new_n39_));
  nand4  g11(.a(new_n37_), .b(new_n39_), .c(x09), .d(new_n31_), .O(new_n40_));
  oai21  g12(.a(new_n38_), .b(new_n36_), .c(new_n40_), .O(z1));
  ...
  nor2   g17(.a(new_n39_), .b(x00), .O(new_n46_));
  ...
  aoi21  g24(.a(new_n52_), .b(new_n49_), .c(new_n46_), .O(z3));
  ...
  aoi21  g29(.a(x08), .b(x03), .c(new_n46_), .O(new_n58_));
  ...
  nand2  g33(.a(new_n61_), .b(new_n43_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x04), .c(new_n46_), .O(new_n63_));
  ...
  aoi21  g42(.a(x08), .b(x05), .c(new_n46_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z6));
  inv1   g44(.a(new_n46_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x08), .c(x06), .O(new_n74_));
  aoi22  g46(.a(new_n66_), .b(x16), .c(x17), .d(x00), .O(new_n75_));
  inv1   g47(.a(new_n30_), .O(new_n76_));
  ...
  nand4  g52(.a(new_n76_), .b(new_n54_), .c(x18), .d(x17), .O(new_n81_));
  inv1   g53(.a(x18), .O(new_n82_));
  nand2  g54(.a(new_n77_), .b(new_n82_), .O(new_n83_));
  nor2   g55(.a(new_n46_), .b(new_n33_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(new_n81_), .O(new_n85_));
