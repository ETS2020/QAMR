...
module FAU ( 
  ...
  oai21  g33(.a(new_n34_), .b(new_n60_), .c(new_n61_), .O(new_n62_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n65_), .c(new_n39_), .O(z5));
  aoi21  g39(.a(new_n63_), .b(new_n54_), .c(x16), .O(new_n68_));
  inv1   g40(.a(new_n35_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n33_), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x05), .c(new_n39_), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(new_n68_), .c(new_n72_), .O(z6));
  nand2  g45(.a(new_n36_), .b(x17), .O(new_n74_));
  oai21  g46(.a(new_n35_), .b(new_n34_), .c(new_n29_), .O(new_n75_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n33_), .c(x18), .O(new_n79_));
