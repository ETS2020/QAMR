...
module FAU ( 
  ...
  aoi21  g08(.a(new_n36_), .b(x17), .c(new_n29_), .O(z0));
  ...
  nand3  g21(.a(new_n49_), .b(new_n47_), .c(new_n45_), .O(new_n50_));
  aoi21  g22(.a(x08), .b(x01), .c(new_n38_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n50_), .O(z2));
  nor2   g24(.a(new_n46_), .b(x13), .O(new_n53_));
  nand3  g25(.a(x13), .b(x12), .c(x11), .O(new_n54_));
  nand3  g26(.a(new_n54_), .b(new_n32_), .c(new_n30_), .O(new_n55_));
  inv1   g27(.a(x17), .O(new_n56_));
  aoi22  g28(.a(x18), .b(new_n56_), .c(x08), .d(x02), .O(new_n57_));
  oai21  g29(.a(new_n55_), .b(new_n53_), .c(new_n57_), .O(z3));
  inv1   g30(.a(new_n54_), .O(new_n59_));
  nor2   g31(.a(new_n59_), .b(x14), .O(new_n60_));
  nand3  g32(.a(new_n33_), .b(new_n32_), .c(new_n30_), .O(new_n61_));
  aoi22  g33(.a(x18), .b(new_n56_), .c(x08), .d(x03), .O(new_n62_));
  ...
  nand2  g41(.a(new_n35_), .b(new_n34_), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  oai21  g43(.a(new_n33_), .b(new_n65_), .c(new_n71_), .O(new_n72_));
  ...
  and2   g47(.a(x14), .b(x13), .O(new_n76_));
  nand2  g48(.a(new_n29_), .b(new_n56_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n35_), .c(new_n76_), .d(new_n46_), .O(new_n78_));
  nand2  g50(.a(x16), .b(x15), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n33_), .c(new_n56_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n78_), .c(new_n45_), .O(new_n81_));
  inv1   g53(.a(new_n38_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(x08), .c(x06), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n81_), .O(z7));
  nand2  g56(.a(new_n29_), .b(x17), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n35_), .c(new_n76_), .d(new_n46_), .O(new_n86_));
  oai21  g58(.a(new_n79_), .b(new_n33_), .c(new_n29_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n45_), .O(new_n88_));
