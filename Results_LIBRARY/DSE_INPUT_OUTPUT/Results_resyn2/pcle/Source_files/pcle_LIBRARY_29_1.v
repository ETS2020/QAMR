...
module FAU ( 
  ...
  nor2   g11(.a(new_n39_), .b(x16), .O(new_n40_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n31_), .c(new_n39_), .O(new_n69_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n39_), .O(new_n80_));
  aoi21  g52(.a(new_n36_), .b(new_n35_), .c(new_n31_), .O(new_n81_));
