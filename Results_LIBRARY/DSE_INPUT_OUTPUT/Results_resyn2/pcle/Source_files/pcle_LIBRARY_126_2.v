...
module FAU ( 
  ...
  nand3  g26(.a(new_n34_), .b(new_n45_), .c(new_n30_), .O(new_n55_));
  inv1   g27(.a(x18), .O(new_n56_));
  aoi22  g28(.a(new_n56_), .b(x17), .c(x08), .d(x02), .O(new_n57_));
  oai21  g29(.a(new_n55_), .b(new_n54_), .c(new_n57_), .O(z3));
  ...
  aoi22  g40(.a(new_n56_), .b(x17), .c(x08), .d(x04), .O(new_n69_));
  ...
  nand2  g49(.a(new_n56_), .b(x17), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x08), .c(x06), .O(new_n79_));
  oai22  g51(.a(new_n36_), .b(new_n34_), .c(new_n56_), .d(new_n40_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n38_), .c(new_n32_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n79_), .O(z7));
  nand3  g54(.a(new_n78_), .b(x08), .c(x07), .O(new_n83_));
