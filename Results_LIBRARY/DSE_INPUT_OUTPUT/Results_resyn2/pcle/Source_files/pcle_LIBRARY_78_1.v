...
module FAU ( 
  ...
  inv1   g30(.a(new_n36_), .O(new_n59_));
  ...
  aoi21  g36(.a(new_n36_), .b(x16), .c(new_n32_), .O(new_n65_));
  ...
  nand3  g45(.a(new_n70_), .b(x08), .c(x06), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n69_), .c(new_n74_), .O(z7));
  nand2  g47(.a(new_n72_), .b(new_n29_), .O(new_n76_));
  nand3  g48(.a(new_n36_), .b(x18), .c(x17), .O(new_n77_));
