...
module FAU ( 
  ...
  oai21  g34(.a(new_n51_), .b(new_n55_), .c(new_n62_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n37_), .c(new_n33_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x05), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n40_), .O(z6));
  inv1   g38(.a(x17), .O(new_n67_));
  nand2  g39(.a(x18), .b(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n32_), .c(new_n57_), .O(new_n69_));
  ...
  nand3  g48(.a(new_n32_), .b(new_n57_), .c(x18), .O(new_n77_));
