...
module FAU ( 
  ...
  nand4  g08(.a(new_n36_), .b(x09), .c(new_n35_), .d(new_n34_), .O(new_n37_));
  inv1   g09(.a(new_n37_), .O(new_n38_));
  nand2  g10(.a(new_n38_), .b(x18), .O(new_n39_));
  nor2   g11(.a(new_n39_), .b(new_n33_), .O(z0));
  nand3  g12(.a(new_n36_), .b(x09), .c(new_n35_), .O(new_n41_));
  inv1   g13(.a(x17), .O(new_n42_));
  nor2   g14(.a(new_n42_), .b(new_n34_), .O(new_n43_));
