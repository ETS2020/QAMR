...
module FAU ( 
  ...
  nand3  g11(.a(new_n39_), .b(new_n36_), .c(new_n33_), .O(new_n40_));
  aoi21  g12(.a(new_n40_), .b(x02), .c(new_n29_), .O(z0));
  nor2   g13(.a(new_n29_), .b(x02), .O(new_n42_));
  ...
  nand3  g19(.a(new_n47_), .b(new_n46_), .c(new_n33_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n45_), .c(new_n42_), .O(z2));
  inv1   g21(.a(x13), .O(new_n50_));
  nand2  g22(.a(new_n46_), .b(new_n50_), .O(new_n51_));
  nand3  g23(.a(new_n51_), .b(new_n34_), .c(new_n33_), .O(new_n52_));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n55_), .c(new_n42_), .O(z4));
  nand2  g33(.a(x08), .b(x04), .O(new_n62_));
  inv1   g34(.a(new_n36_), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  oai21  g36(.a(new_n34_), .b(new_n58_), .c(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n33_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n62_), .c(new_n42_), .O(z5));
  nand2  g39(.a(x08), .b(x05), .O(new_n68_));
  inv1   g40(.a(new_n35_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n56_), .c(x16), .O(new_n70_));
  oai21  g42(.a(new_n35_), .b(new_n34_), .c(new_n37_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n70_), .c(new_n33_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n68_), .c(new_n42_), .O(z6));
  nand3  g45(.a(new_n36_), .b(x17), .c(x16), .O(new_n74_));
  nand2  g46(.a(new_n70_), .b(new_n38_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(new_n33_), .O(new_n76_));
  aoi21  g48(.a(x08), .b(x06), .c(new_n42_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z7));
  aoi22  g50(.a(new_n39_), .b(new_n36_), .c(x18), .d(x02), .O(new_n79_));
  nand3  g51(.a(new_n39_), .b(new_n36_), .c(x18), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n33_), .O(new_n81_));
  inv1   g53(.a(new_n42_), .O(new_n82_));
