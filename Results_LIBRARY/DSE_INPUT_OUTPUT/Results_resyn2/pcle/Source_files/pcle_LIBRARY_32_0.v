...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n86_;
  nor2   g00(.a(x17), .b(x01), .O(new_n29_));
  inv1   g01(.a(new_n29_), .O(new_n30_));
  inv1   g02(.a(x08), .O(new_n31_));
  inv1   g03(.a(x10), .O(new_n32_));
  nand4  g04(.a(x17), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n33_));
  ...
  nand2  g25(.a(new_n35_), .b(x14), .O(new_n54_));
  ...
  nand3  g33(.a(new_n35_), .b(x15), .c(x14), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n61_), .c(new_n43_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n59_), .c(new_n29_), .O(z5));
  nor2   g36(.a(new_n36_), .b(new_n34_), .O(new_n65_));
  ...
  inv1   g43(.a(x01), .O(new_n72_));
  aoi21  g44(.a(new_n65_), .b(new_n43_), .c(new_n72_), .O(new_n73_));
  inv1   g45(.a(new_n33_), .O(new_n74_));
  aoi22  g46(.a(new_n66_), .b(new_n74_), .c(x08), .d(x06), .O(new_n75_));
  oai21  g47(.a(new_n73_), .b(x17), .c(new_n75_), .O(z7));
  nand2  g48(.a(x08), .b(x07), .O(new_n77_));
  inv1   g49(.a(x17), .O(new_n78_));
  nand2  g50(.a(x18), .b(new_n78_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n42_), .c(new_n77_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(x01), .O(new_n81_));
  inv1   g53(.a(x18), .O(new_n82_));
  oai21  g54(.a(new_n36_), .b(new_n34_), .c(new_n82_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n38_), .c(new_n43_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n77_), .O(new_n85_));
