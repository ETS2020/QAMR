...
module FAU ( 
  ...
  nor2   g14(.a(new_n29_), .b(x09), .O(new_n43_));
  ...
  oai22  g20(.a(new_n48_), .b(new_n47_), .c(new_n37_), .d(new_n46_), .O(z3));
  ...
  nand3  g42(.a(new_n58_), .b(new_n66_), .c(x17), .O(new_n71_));
  inv1   g43(.a(x17), .O(new_n72_));
  nand2  g44(.a(new_n67_), .b(new_n72_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n71_), .c(new_n40_), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x06), .c(new_n43_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n74_), .O(z7));
  nand2  g48(.a(new_n56_), .b(x07), .O(new_n77_));
