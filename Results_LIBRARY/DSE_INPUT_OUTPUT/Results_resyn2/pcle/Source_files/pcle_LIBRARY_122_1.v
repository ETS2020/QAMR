...
module FAU ( 
  ...
  nand4  g03(.a(x18), .b(x15), .c(x14), .d(x13), .O(new_n32_));
  ...
  nor2   g08(.a(new_n36_), .b(x15), .O(new_n37_));
  ...
  nand3  g13(.a(new_n41_), .b(new_n34_), .c(new_n40_), .O(new_n42_));
  aoi21  g14(.a(x08), .b(x01), .c(new_n37_), .O(new_n43_));
  ...
  nor2   g27(.a(new_n37_), .b(new_n29_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(x04), .O(new_n57_));
  inv1   g29(.a(x15), .O(new_n58_));
  nand2  g30(.a(new_n52_), .b(new_n58_), .O(new_n59_));
  nor2   g31(.a(new_n37_), .b(new_n31_), .O(new_n60_));
  and2   g32(.a(x15), .b(x14), .O(new_n61_));
  nand2  g33(.a(new_n50_), .b(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n57_), .O(z5));
  nand2  g36(.a(new_n56_), .b(x05), .O(new_n65_));
  inv1   g37(.a(x16), .O(new_n66_));
  nand2  g38(.a(new_n62_), .b(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n50_), .b(new_n61_), .c(x16), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n67_), .c(new_n60_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n65_), .O(z6));
  nand2  g42(.a(new_n56_), .b(x06), .O(new_n71_));
  nand4  g43(.a(new_n50_), .b(new_n61_), .c(x17), .d(x16), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  nand2  g45(.a(new_n68_), .b(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n72_), .c(new_n60_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n71_), .O(z7));
  nor2   g48(.a(new_n52_), .b(new_n33_), .O(new_n77_));
  nand2  g49(.a(new_n36_), .b(x15), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  oai21  g51(.a(new_n52_), .b(new_n33_), .c(new_n36_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(new_n40_), .O(new_n81_));
