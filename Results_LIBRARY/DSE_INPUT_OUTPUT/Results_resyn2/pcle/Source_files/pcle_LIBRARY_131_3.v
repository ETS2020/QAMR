...
module FAU ( 
  ...
  nand2  g19(.a(new_n38_), .b(new_n30_), .O(new_n48_));
  aoi21  g20(.a(x08), .b(x02), .c(new_n41_), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(new_n47_), .c(new_n49_), .O(z3));
  nor2   g22(.a(new_n41_), .b(new_n35_), .O(new_n51_));
  ...
  oai21  g28(.a(x10), .b(x08), .c(x04), .O(new_n57_));
  ...
  nand3  g33(.a(new_n61_), .b(new_n59_), .c(new_n38_), .O(new_n62_));
  ...
  nand2  g42(.a(new_n51_), .b(x06), .O(new_n71_));
  ...
  nand2  g48(.a(new_n51_), .b(x07), .O(new_n77_));
  oai21  g49(.a(new_n32_), .b(new_n30_), .c(x18), .O(new_n78_));
  nor2   g50(.a(x18), .b(new_n73_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n58_), .c(new_n66_), .O(new_n80_));
