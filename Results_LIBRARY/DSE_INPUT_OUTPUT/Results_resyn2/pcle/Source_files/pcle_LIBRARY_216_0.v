...
module FAU ( 
  ...
  nand3  g04(.a(new_n32_), .b(x18), .c(new_n29_), .O(new_n33_));
  aoi21  g05(.a(new_n33_), .b(x09), .c(x10), .O(z0));
  inv1   g06(.a(x00), .O(new_n35_));
  oai21  g07(.a(x10), .b(x09), .c(x08), .O(new_n36_));
  inv1   g08(.a(x10), .O(new_n37_));
  nand3  g09(.a(new_n37_), .b(x09), .c(new_n29_), .O(new_n38_));
  oai22  g10(.a(new_n38_), .b(x11), .c(new_n36_), .d(new_n35_), .O(z1));
  ...
  aoi21  g28(.a(new_n30_), .b(new_n56_), .c(x08), .O(new_n57_));
  ...
  oai21  g35(.a(new_n55_), .b(new_n63_), .c(new_n29_), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n62_), .c(x09), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n37_), .O(new_n66_));
  ...
  oai21  g47(.a(new_n36_), .b(new_n69_), .c(new_n75_), .O(z6));
  ...
  oai22  g53(.a(new_n81_), .b(new_n79_), .c(new_n36_), .d(new_n77_), .O(z7));
  ...
  oai21  g58(.a(new_n86_), .b(new_n40_), .c(new_n37_), .O(new_n87_));
