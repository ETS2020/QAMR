...
module FAU ( 
  ...
  nand2  g17(.a(new_n35_), .b(new_n29_), .O(new_n46_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(new_n36_), .O(z6));
  ...
  aoi21  g44(.a(x08), .b(x06), .c(new_n36_), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n79_), .c(new_n36_), .O(z8));
endmodule
