...
module FAU ( 
  ...
  nand3  g24(.a(new_n47_), .b(x14), .c(x13), .O(new_n53_));
  ...
  oai21  g39(.a(new_n34_), .b(new_n62_), .c(new_n66_), .O(new_n68_));
  ...
  aoi21  g45(.a(new_n36_), .b(new_n29_), .c(x17), .O(new_n74_));
  nand4  g46(.a(new_n60_), .b(x17), .c(x16), .d(x15), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n33_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(z7));
  nand3  g49(.a(new_n72_), .b(x08), .c(x07), .O(new_n78_));
  xor2a  g50(.a(new_n36_), .b(new_n29_), .O(new_n79_));
