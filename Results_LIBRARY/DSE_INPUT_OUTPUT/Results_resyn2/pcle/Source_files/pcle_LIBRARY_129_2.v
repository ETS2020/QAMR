...
module FAU ( 
  ...
  nor2   g08(.a(x13), .b(new_n36_), .O(new_n37_));
  ...
  nand3  g15(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(new_n44_));
  aoi21  g16(.a(x08), .b(x01), .c(new_n37_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n44_), .O(z2));
  inv1   g18(.a(x02), .O(new_n47_));
  inv1   g19(.a(new_n37_), .O(new_n48_));
  nand2  g20(.a(new_n48_), .b(x08), .O(new_n49_));
  nand3  g21(.a(new_n41_), .b(new_n40_), .c(x13), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(new_n47_), .c(new_n50_), .O(z3));
  inv1   g23(.a(x03), .O(new_n52_));
  nand2  g24(.a(new_n48_), .b(new_n40_), .O(new_n53_));
  xor2a  g25(.a(new_n41_), .b(x14), .O(new_n54_));
  oai22  g26(.a(new_n54_), .b(new_n53_), .c(new_n49_), .d(new_n52_), .O(z4));
  nand3  g27(.a(x14), .b(x12), .c(x11), .O(new_n56_));
  ...
  nand3  g41(.a(new_n58_), .b(new_n40_), .c(x16), .O(new_n70_));
  nand2  g42(.a(x08), .b(x05), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(z6));
  nand3  g44(.a(new_n48_), .b(x08), .c(x06), .O(new_n73_));
  ...
  aoi21  g51(.a(new_n78_), .b(x13), .c(new_n79_), .O(new_n80_));
