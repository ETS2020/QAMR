...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n52_), .c(new_n37_), .O(new_n54_));
  ...
  oai21  g35(.a(new_n53_), .b(new_n58_), .c(new_n63_), .O(new_n64_));
  ...
  oai21  g42(.a(new_n31_), .b(new_n29_), .c(new_n68_), .O(new_n71_));
  ...
  oai22  g48(.a(new_n31_), .b(new_n29_), .c(new_n76_), .d(new_n68_), .O(new_n77_));
  nand2  g49(.a(new_n67_), .b(x18), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n77_), .c(new_n37_), .O(new_n79_));
  oai21  g51(.a(new_n37_), .b(new_n76_), .c(new_n68_), .O(new_n80_));
