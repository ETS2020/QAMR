...
module FAU ( 
  ...
  inv1   g42(.a(new_n36_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(x08), .c(x06), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  nand2  g45(.a(x18), .b(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n57_), .c(new_n66_), .O(new_n75_));
  nand2  g47(.a(new_n67_), .b(new_n73_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n75_), .c(new_n39_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n72_), .O(z7));
  nand3  g50(.a(new_n71_), .b(x08), .c(x07), .O(new_n79_));
  oai21  g51(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n80_));
  nor2   g52(.a(x18), .b(new_n73_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n57_), .c(new_n66_), .O(new_n82_));
