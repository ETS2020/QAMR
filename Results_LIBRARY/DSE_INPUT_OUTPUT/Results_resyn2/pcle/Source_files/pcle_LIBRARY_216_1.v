...
module FAU ( 
  ...
  nor2   g40(.a(new_n67_), .b(new_n61_), .O(new_n69_));
  ...
  nand2  g44(.a(new_n42_), .b(x06), .O(new_n73_));
  nand3  g45(.a(new_n59_), .b(new_n69_), .c(x17), .O(new_n74_));
  ...
  nand3  g52(.a(new_n80_), .b(new_n59_), .c(new_n69_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n39_), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x07), .c(new_n30_), .O(new_n84_));
