...
module FAU ( 
  ...
  nand2  g35(.a(new_n63_), .b(new_n31_), .O(new_n64_));
  ...
  oai22  g49(.a(new_n32_), .b(new_n30_), .c(new_n29_), .d(new_n39_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n43_), .c(new_n34_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n77_), .O(z7));
  nand3  g52(.a(new_n76_), .b(x08), .c(x07), .O(new_n81_));
  nand3  g53(.a(new_n43_), .b(new_n34_), .c(x18), .O(new_n82_));
