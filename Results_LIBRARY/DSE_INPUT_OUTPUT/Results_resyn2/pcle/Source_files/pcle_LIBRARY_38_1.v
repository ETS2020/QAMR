...
module FAU ( 
  ...
  nor2   g07(.a(new_n33_), .b(x04), .O(new_n36_));
  ...
  nand2  g18(.a(new_n42_), .b(new_n30_), .O(new_n47_));
  aoi21  g19(.a(x08), .b(x02), .c(new_n36_), .O(new_n48_));
