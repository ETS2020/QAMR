...
module FAU ( 
  ...
  nand3  g20(.a(new_n49_), .b(new_n47_), .c(new_n41_), .O(new_n50_));
  aoi21  g21(.a(new_n50_), .b(new_n46_), .c(new_n34_), .O(z4));
  nand2  g22(.a(x08), .b(x04), .O(new_n52_));
  inv1   g23(.a(new_n42_), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(x15), .c(x14), .O(new_n54_));
  inv1   g25(.a(x15), .O(new_n55_));
  nand2  g26(.a(new_n47_), .b(new_n55_), .O(new_n56_));
  ...
  nand3  g32(.a(new_n61_), .b(new_n53_), .c(x16), .O(new_n62_));
  inv1   g33(.a(x16), .O(new_n63_));
  oai21  g34(.a(new_n60_), .b(new_n42_), .c(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n62_), .c(new_n41_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n59_), .c(new_n34_), .O(z6));
  nand3  g37(.a(new_n33_), .b(x08), .c(x06), .O(new_n67_));
  nand4  g38(.a(new_n61_), .b(new_n53_), .c(x17), .d(x16), .O(new_n68_));
  inv1   g39(.a(x18), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(x17), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n62_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(new_n68_), .c(new_n41_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n67_), .O(z7));
  nand2  g44(.a(new_n68_), .b(new_n69_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n41_), .O(new_n75_));
  aoi21  g46(.a(x08), .b(x07), .c(new_n34_), .O(new_n76_));
