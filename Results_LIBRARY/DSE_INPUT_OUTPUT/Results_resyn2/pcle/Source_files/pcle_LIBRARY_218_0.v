...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(new_n29_), .c(new_n37_), .O(new_n39_));
  ...
  aoi21  g17(.a(new_n45_), .b(new_n43_), .c(new_n37_), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(x10), .c(new_n47_), .O(z2));
  aoi21  g20(.a(new_n30_), .b(new_n37_), .c(new_n29_), .O(new_n49_));
