...
module FAU ( 
  ...
  aoi21  g21(.a(x08), .b(x03), .c(new_n30_), .O(new_n51_));
  ...
  nand2  g27(.a(new_n49_), .b(new_n56_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(new_n55_), .c(new_n36_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n53_), .c(new_n30_), .O(z5));
  inv1   g30(.a(x16), .O(new_n60_));
  oai21  g31(.a(new_n49_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  nand2  g32(.a(x16), .b(x15), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n54_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n61_), .c(new_n36_), .O(new_n65_));
  nand2  g36(.a(x08), .b(x05), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n65_), .c(new_n30_), .O(z6));
  inv1   g38(.a(x17), .O(new_n68_));
  oai21  g39(.a(new_n62_), .b(new_n49_), .c(new_n68_), .O(new_n69_));
  nor2   g40(.a(new_n62_), .b(new_n49_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(x17), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(new_n69_), .c(new_n36_), .O(new_n72_));
  aoi21  g43(.a(x08), .b(x06), .c(new_n30_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n72_), .O(z7));
  aoi21  g45(.a(new_n70_), .b(x17), .c(x18), .O(new_n75_));
  aoi21  g46(.a(x08), .b(x07), .c(new_n30_), .O(new_n76_));
  oai21  g47(.a(new_n75_), .b(new_n35_), .c(new_n76_), .O(z8));
  zero   g48(.O(z0));
endmodule
