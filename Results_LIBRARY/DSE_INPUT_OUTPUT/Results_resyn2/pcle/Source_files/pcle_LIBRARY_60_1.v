...
module FAU ( 
  ...
  nand2  g12(.a(x18), .b(new_n40_), .O(new_n41_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n58_), .c(new_n42_), .O(z4));
  nand2  g35(.a(new_n59_), .b(new_n40_), .O(new_n64_));
  nand3  g36(.a(new_n37_), .b(x15), .c(x14), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n64_), .c(new_n41_), .d(new_n35_), .O(new_n66_));
  nand3  g38(.a(new_n41_), .b(x08), .c(x04), .O(new_n67_));
  ...
  oai21  g43(.a(new_n59_), .b(new_n40_), .c(new_n71_), .O(new_n72_));
  ...
  aoi21  g62(.a(x08), .b(x07), .c(new_n42_), .O(new_n91_));
