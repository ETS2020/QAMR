...
module FAU ( 
  ...
  aoi21  g10(.a(new_n31_), .b(new_n38_), .c(x04), .O(new_n39_));
  ...
  oai21  g17(.a(new_n45_), .b(new_n43_), .c(new_n29_), .O(new_n46_));
  ...
  nand2  g22(.a(new_n33_), .b(new_n31_), .O(new_n51_));
  oai21  g23(.a(new_n51_), .b(new_n50_), .c(new_n29_), .O(new_n52_));
  ...
  aoi21  g28(.a(new_n42_), .b(x04), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g33(.a(new_n31_), .b(new_n42_), .c(new_n29_), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n60_), .c(new_n58_), .O(z4));
  oai21  g37(.a(new_n42_), .b(x08), .c(x04), .O(new_n66_));
  aoi21  g38(.a(new_n59_), .b(x14), .c(x15), .O(new_n67_));
  inv1   g39(.a(new_n34_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n59_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n31_), .c(new_n42_), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(z5));
  nand3  g43(.a(new_n68_), .b(new_n59_), .c(x16), .O(new_n72_));
  oai21  g44(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n31_), .O(new_n74_));
  ...
  nand2  g50(.a(new_n57_), .b(x06), .O(new_n79_));
  nor2   g51(.a(new_n35_), .b(x17), .O(new_n80_));
  nand4  g52(.a(new_n68_), .b(new_n59_), .c(x17), .d(x16), .O(new_n81_));
  nand2  g53(.a(new_n63_), .b(new_n81_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n80_), .c(new_n79_), .O(z7));
  nand2  g55(.a(new_n57_), .b(x07), .O(new_n84_));
  nand3  g56(.a(new_n35_), .b(x18), .c(x17), .O(new_n85_));
  inv1   g57(.a(x18), .O(new_n86_));
  nand2  g58(.a(new_n81_), .b(new_n86_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n63_), .c(new_n85_), .O(new_n88_));
