...
module FAU ( 
  ...
  nand3  g17(.a(new_n45_), .b(new_n44_), .c(new_n34_), .O(new_n46_));
  ...
  nand3  g23(.a(new_n51_), .b(new_n50_), .c(new_n34_), .O(new_n52_));
  aoi21  g24(.a(new_n52_), .b(new_n48_), .c(new_n40_), .O(z3));
  inv1   g25(.a(x14), .O(new_n54_));
  aoi21  g26(.a(new_n51_), .b(new_n54_), .c(new_n33_), .O(new_n55_));
  ...
  oai21  g44(.a(x18), .b(x08), .c(x06), .O(new_n73_));
  aoi21  g45(.a(new_n66_), .b(x16), .c(x17), .O(new_n74_));
  nand2  g46(.a(new_n37_), .b(x17), .O(new_n75_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n51_), .c(x18), .O(new_n79_));
  inv1   g51(.a(new_n36_), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  nor2   g53(.a(x18), .b(new_n81_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n80_), .c(new_n60_), .O(new_n83_));
