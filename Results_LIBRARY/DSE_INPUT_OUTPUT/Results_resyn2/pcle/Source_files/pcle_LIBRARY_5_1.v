...
module FAU ( 
  ...
  nor2   g30(.a(new_n53_), .b(new_n58_), .O(new_n59_));
  nand2  g31(.a(new_n53_), .b(new_n58_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n42_), .O(new_n61_));
  ...
  aoi21  g44(.a(new_n34_), .b(new_n42_), .c(x18), .O(new_n73_));
  inv1   g45(.a(new_n31_), .O(new_n74_));
  and2   g46(.a(x08), .b(x06), .O(new_n75_));
  aoi21  g47(.a(new_n66_), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  oai21  g48(.a(new_n73_), .b(x17), .c(new_n76_), .O(z7));
  inv1   g49(.a(new_n39_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x08), .c(x07), .O(new_n79_));
  nand2  g51(.a(new_n66_), .b(new_n38_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n35_), .c(new_n74_), .O(new_n81_));
