...
module FAU ( 
  ...
  nand2  g29(.a(new_n55_), .b(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n57_), .c(new_n42_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n54_), .c(new_n35_), .O(z5));
  inv1   g32(.a(x16), .O(new_n62_));
  nor2   g33(.a(new_n57_), .b(new_n62_), .O(new_n63_));
  oai21  g34(.a(new_n55_), .b(new_n58_), .c(new_n62_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n42_), .O(new_n65_));
  aoi21  g36(.a(x08), .b(x05), .c(new_n35_), .O(new_n66_));
  oai21  g37(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(z6));
  nand2  g38(.a(x16), .b(x15), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n55_), .O(new_n69_));
  xor2a  g40(.a(new_n69_), .b(new_n33_), .O(new_n70_));
  aoi21  g41(.a(x08), .b(x06), .c(new_n35_), .O(new_n71_));
  oai21  g42(.a(new_n70_), .b(new_n32_), .c(new_n71_), .O(z7));
  nor2   g43(.a(new_n69_), .b(new_n33_), .O(new_n73_));
  inv1   g44(.a(new_n35_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(x08), .c(x07), .O(new_n75_));
  nand2  g46(.a(new_n34_), .b(new_n33_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n74_), .c(new_n42_), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n73_), .c(new_n75_), .O(z8));
  zero   g49(.O(z0));
endmodule
