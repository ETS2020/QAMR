...
module FAU ( 
  ...
  oai21  g37(.a(new_n34_), .b(new_n64_), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n63_), .c(new_n33_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n61_), .c(new_n39_), .O(z5));
  nand2  g40(.a(x08), .b(x05), .O(new_n69_));
  nand3  g41(.a(new_n62_), .b(new_n55_), .c(x16), .O(new_n70_));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n69_), .c(new_n39_), .O(z6));
  nand4  g46(.a(new_n62_), .b(new_n55_), .c(x17), .d(x16), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n33_), .O(new_n76_));
  aoi21  g48(.a(new_n36_), .b(x16), .c(x17), .O(new_n77_));
  ...
  oai21  g54(.a(new_n76_), .b(new_n80_), .c(new_n82_), .O(z8));
endmodule
