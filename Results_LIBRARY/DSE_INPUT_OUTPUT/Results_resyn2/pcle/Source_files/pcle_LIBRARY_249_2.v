...
module FAU ( 
  ...
  oai21  g02(.a(x10), .b(new_n31_), .c(x08), .O(new_n32_));
  nor2   g03(.a(new_n32_), .b(new_n30_), .O(z1));
  inv1   g04(.a(x10), .O(new_n34_));
  nand2  g05(.a(new_n34_), .b(x09), .O(new_n35_));
  nand2  g06(.a(x08), .b(x01), .O(new_n36_));
  nand2  g07(.a(new_n36_), .b(new_n35_), .O(z2));
  nand2  g08(.a(x08), .b(x02), .O(new_n38_));
  nand2  g09(.a(new_n38_), .b(new_n35_), .O(z3));
  nand2  g10(.a(x08), .b(x03), .O(new_n40_));
  nand2  g11(.a(new_n40_), .b(new_n35_), .O(z4));
  inv1   g12(.a(x04), .O(new_n42_));
  nor2   g13(.a(new_n32_), .b(new_n42_), .O(z5));
  nand2  g14(.a(x08), .b(x05), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(new_n35_), .O(z6));
  inv1   g16(.a(x06), .O(new_n46_));
  nor2   g17(.a(new_n32_), .b(new_n46_), .O(z7));
  nand2  g18(.a(x08), .b(x07), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(new_n35_), .O(z8));
  zero   g20(.O(z0));
endmodule
