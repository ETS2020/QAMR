...
module FAU ( 
  ...
  nand2  g21(.a(new_n45_), .b(new_n49_), .O(new_n50_));
  nand4  g22(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n51_));
  nand3  g23(.a(new_n51_), .b(new_n50_), .c(new_n37_), .O(new_n52_));
  ...
  nand3  g29(.a(new_n57_), .b(new_n55_), .c(new_n37_), .O(new_n58_));
  aoi21  g30(.a(x08), .b(x04), .c(z0), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z5));
  aoi21  g32(.a(new_n54_), .b(x15), .c(x16), .O(new_n61_));
  nand3  g33(.a(new_n54_), .b(x16), .c(x15), .O(new_n62_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n51_), .c(new_n67_), .O(new_n69_));
  nor2   g41(.a(new_n68_), .b(new_n51_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(x17), .O(new_n71_));
  nand4  g43(.a(new_n29_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n72_));
  inv1   g44(.a(new_n72_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n71_), .c(new_n69_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n66_), .O(z7));
  nand3  g47(.a(new_n29_), .b(x08), .c(x07), .O(new_n76_));
  aoi21  g48(.a(new_n70_), .b(x17), .c(x18), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n72_), .c(new_n76_), .O(z8));
endmodule
