...
module FAU ( 
  ...
  nand3  g08(.a(x18), .b(x15), .c(x07), .O(new_n37_));
  nor3   g09(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n38_));
  nand4  g10(.a(new_n38_), .b(new_n34_), .c(new_n30_), .d(x14), .O(new_n39_));
  inv1   g11(.a(new_n39_), .O(z0));
  inv1   g12(.a(x18), .O(new_n41_));
  nor2   g13(.a(new_n41_), .b(x07), .O(new_n42_));
  ...
  nand3  g19(.a(new_n47_), .b(new_n34_), .c(new_n46_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n45_), .c(new_n42_), .O(z2));
  aoi21  g21(.a(x12), .b(x11), .c(x13), .O(new_n50_));
  nand2  g22(.a(new_n34_), .b(new_n29_), .O(new_n51_));
  ...
  aoi21  g39(.a(x08), .b(x05), .c(new_n42_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z6));
  nand2  g41(.a(x08), .b(x06), .O(new_n70_));
  and2   g42(.a(x17), .b(x16), .O(new_n71_));
  nand3  g43(.a(new_n60_), .b(new_n71_), .c(new_n30_), .O(new_n72_));
  nand3  g44(.a(x16), .b(x15), .c(x14), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n29_), .c(new_n36_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n72_), .c(new_n34_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n70_), .c(new_n42_), .O(z7));
  nand2  g48(.a(new_n41_), .b(new_n31_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n60_), .c(new_n71_), .d(new_n30_), .O(new_n78_));
  nand2  g50(.a(new_n72_), .b(new_n41_), .O(new_n79_));
  inv1   g51(.a(x09), .O(new_n80_));
  nor2   g52(.a(x10), .b(new_n80_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(new_n82_));
