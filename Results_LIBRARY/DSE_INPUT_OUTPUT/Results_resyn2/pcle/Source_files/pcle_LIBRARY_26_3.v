...
module FAU ( 
  ...
  nand2  g08(.a(x10), .b(x09), .O(new_n37_));
  nand2  g09(.a(new_n37_), .b(x08), .O(new_n38_));
  oai22  g10(.a(new_n38_), .b(new_n36_), .c(new_n34_), .d(x11), .O(z1));
  inv1   g11(.a(x01), .O(new_n40_));
  xnor2a g12(.a(x12), .b(x11), .O(new_n41_));
  oai22  g13(.a(new_n41_), .b(new_n34_), .c(new_n38_), .d(new_n40_), .O(z2));
  aoi21  g14(.a(x12), .b(x11), .c(x13), .O(new_n43_));
  nand2  g15(.a(new_n30_), .b(new_n32_), .O(new_n44_));
  oai21  g16(.a(new_n44_), .b(new_n43_), .c(new_n33_), .O(new_n45_));
  ...
  aoi21  g23(.a(new_n30_), .b(new_n49_), .c(new_n51_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(x10), .c(x09), .O(new_n53_));
  nand2  g25(.a(x08), .b(x03), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n53_), .O(z4));
  inv1   g27(.a(x04), .O(new_n56_));
  inv1   g28(.a(x15), .O(new_n57_));
  aoi21  g29(.a(new_n50_), .b(new_n57_), .c(new_n34_), .O(new_n58_));
  oai21  g30(.a(new_n50_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  oai21  g31(.a(new_n38_), .b(new_n56_), .c(new_n59_), .O(z5));
  ...
  nand3  g38(.a(new_n66_), .b(new_n62_), .c(new_n32_), .O(new_n67_));
  ...
  nand3  g43(.a(new_n65_), .b(new_n64_), .c(x17), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  oai21  g45(.a(new_n50_), .b(new_n63_), .c(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n72_), .c(new_n32_), .O(new_n75_));
  ...
  nor2   g52(.a(x18), .b(new_n73_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n65_), .c(new_n64_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(x08), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(x10), .c(x09), .O(new_n84_));
