...
module FAU ( 
  ...
  nand3  g22(.a(new_n50_), .b(new_n49_), .c(new_n41_), .O(new_n51_));
  ...
  nand3  g35(.a(new_n63_), .b(new_n61_), .c(new_n41_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n59_), .c(new_n38_), .O(z5));
  inv1   g37(.a(x16), .O(new_n66_));
  oai21  g38(.a(new_n54_), .b(new_n62_), .c(new_n66_), .O(new_n67_));
  inv1   g39(.a(new_n54_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n33_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n67_), .c(new_n41_), .O(new_n70_));
  ...
  oai21  g47(.a(new_n54_), .b(new_n32_), .c(new_n75_), .O(new_n76_));
  nand3  g48(.a(new_n68_), .b(new_n33_), .c(x17), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n76_), .c(new_n41_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n74_), .O(z7));
  nand3  g51(.a(new_n73_), .b(x08), .c(x07), .O(new_n80_));
  nand3  g52(.a(new_n77_), .b(new_n41_), .c(x18), .O(new_n81_));
