...
module FAU ( 
  ...
  nor2   g14(.a(new_n41_), .b(new_n40_), .O(new_n43_));
  nor2   g15(.a(new_n43_), .b(x08), .O(new_n44_));
  aoi21  g16(.a(new_n44_), .b(new_n42_), .c(x10), .O(new_n45_));
  nand2  g17(.a(x08), .b(x01), .O(new_n46_));
  oai21  g18(.a(new_n45_), .b(new_n39_), .c(new_n46_), .O(z2));
  nor2   g19(.a(new_n43_), .b(x13), .O(new_n48_));
  nand2  g20(.a(new_n30_), .b(new_n32_), .O(new_n49_));
  oai21  g21(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(new_n50_));
  ...
  aoi21  g27(.a(new_n30_), .b(new_n55_), .c(x08), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n54_), .c(x10), .O(new_n57_));
  nand2  g29(.a(x08), .b(x03), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n39_), .c(new_n58_), .O(z4));
  nand2  g31(.a(new_n36_), .b(x04), .O(new_n60_));
  ...
  oai21  g37(.a(new_n61_), .b(x15), .c(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n60_), .O(z5));
  nand3  g39(.a(new_n64_), .b(new_n62_), .c(x16), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  oai21  g41(.a(new_n63_), .b(new_n30_), .c(new_n69_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n68_), .c(new_n32_), .O(new_n71_));
  ...
  nand2  g47(.a(new_n36_), .b(x06), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  aoi21  g49(.a(new_n68_), .b(new_n77_), .c(new_n34_), .O(new_n78_));
  oai21  g50(.a(new_n68_), .b(new_n77_), .c(new_n78_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n76_), .O(z7));
  oai21  g52(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n81_));
  nor2   g53(.a(new_n77_), .b(new_n69_), .O(new_n82_));
  inv1   g54(.a(x15), .O(new_n83_));
  nor2   g55(.a(x18), .b(new_n83_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n61_), .c(new_n82_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n81_), .c(x08), .O(new_n86_));
