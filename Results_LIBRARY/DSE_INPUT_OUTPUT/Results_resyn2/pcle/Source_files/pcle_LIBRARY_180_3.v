...
module FAU ( 
  ...
  nand3  g34(.a(new_n57_), .b(x15), .c(x14), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n29_), .b(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n42_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n62_), .c(new_n39_), .O(z5));
  inv1   g39(.a(x16), .O(new_n68_));
  oai21  g40(.a(new_n29_), .b(new_n64_), .c(new_n68_), .O(new_n69_));
  nand2  g41(.a(x16), .b(x15), .O(new_n70_));
  inv1   g42(.a(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n57_), .c(x14), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n69_), .c(new_n42_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x05), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n73_), .c(new_n39_), .O(z6));
  inv1   g47(.a(new_n39_), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  oai21  g49(.a(new_n70_), .b(new_n29_), .c(new_n77_), .O(new_n78_));
  inv1   g50(.a(new_n29_), .O(new_n79_));
  nand2  g51(.a(new_n35_), .b(new_n79_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n78_), .c(new_n76_), .d(new_n42_), .O(new_n81_));
  nand3  g53(.a(new_n38_), .b(x08), .c(x06), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n81_), .O(z7));
  nand3  g55(.a(new_n35_), .b(new_n79_), .c(x18), .O(new_n84_));
  oai21  g56(.a(new_n34_), .b(new_n29_), .c(new_n38_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(new_n42_), .O(new_n86_));
