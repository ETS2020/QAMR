...
module FAU ( 
  ...
  nor2   g07(.a(x09), .b(x07), .O(new_n36_));
  ...
  inv1   g25(.a(new_n51_), .O(new_n54_));
  ...
  aoi21  g30(.a(x08), .b(x04), .c(new_n36_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z5));
  nand2  g32(.a(new_n39_), .b(x05), .O(new_n61_));
  inv1   g33(.a(x16), .O(new_n62_));
  nand2  g34(.a(new_n55_), .b(new_n62_), .O(new_n63_));
  nor2   g35(.a(new_n62_), .b(new_n56_), .O(new_n64_));
  nand2  g36(.a(new_n54_), .b(new_n64_), .O(new_n65_));
  ...
  nand3  g40(.a(new_n54_), .b(new_n64_), .c(x17), .O(new_n69_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n54_), .c(new_n64_), .O(new_n76_));
