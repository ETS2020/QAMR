...
module FAU ( 
  ...
  oai21  g16(.a(x17), .b(x08), .c(x01), .O(new_n45_));
  xnor2a g17(.a(x12), .b(x11), .O(new_n46_));
  oai21  g18(.a(new_n46_), .b(new_n36_), .c(new_n45_), .O(z2));
  ...
  nand3  g31(.a(new_n53_), .b(x15), .c(x14), .O(new_n60_));
  ...
  nor2   g42(.a(new_n33_), .b(x17), .O(new_n71_));
  inv1   g43(.a(new_n32_), .O(new_n72_));
