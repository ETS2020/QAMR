...
module FAU ( 
  ...
  oai21  g22(.a(new_n50_), .b(x08), .c(x02), .O(new_n51_));
  nor2   g23(.a(new_n34_), .b(x13), .O(new_n52_));
  nand2  g24(.a(new_n34_), .b(x13), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n46_), .O(new_n54_));
  oai21  g26(.a(new_n54_), .b(new_n52_), .c(new_n51_), .O(z3));
  nand2  g27(.a(x08), .b(x03), .O(new_n56_));
  inv1   g28(.a(x14), .O(new_n57_));
  nand2  g29(.a(new_n53_), .b(new_n57_), .O(new_n58_));
  nand3  g30(.a(new_n34_), .b(x14), .c(x13), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n56_), .c(new_n30_), .O(z4));
  nand2  g33(.a(x08), .b(x04), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  nand2  g35(.a(new_n59_), .b(new_n63_), .O(new_n64_));
  nand2  g36(.a(new_n37_), .b(new_n34_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n64_), .c(new_n46_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n62_), .c(new_n30_), .O(z5));
  nand2  g39(.a(x08), .b(x05), .O(new_n68_));
  nor2   g40(.a(new_n36_), .b(new_n45_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  nand2  g43(.a(new_n65_), .b(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n46_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n68_), .c(new_n30_), .O(z6));
  aoi21  g46(.a(new_n69_), .b(x16), .c(x17), .O(new_n75_));
  aoi21  g47(.a(new_n69_), .b(new_n38_), .c(new_n41_), .O(new_n76_));
  ...
  nand3  g52(.a(new_n38_), .b(new_n37_), .c(new_n50_), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n35_), .c(new_n80_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n29_), .O(new_n83_));
  inv1   g55(.a(new_n80_), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n76_), .c(x18), .O(new_n85_));
