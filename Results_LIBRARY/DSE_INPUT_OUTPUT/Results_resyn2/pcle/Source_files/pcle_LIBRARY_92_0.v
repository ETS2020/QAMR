...
module FAU ( 
  ...
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(new_n45_), .O(new_n61_));
  ...
  nor2   g37(.a(new_n34_), .b(new_n32_), .O(new_n66_));
  nor2   g38(.a(new_n66_), .b(new_n31_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n63_), .c(new_n38_), .O(z5));
  aoi21  g41(.a(new_n66_), .b(x16), .c(new_n31_), .O(new_n70_));
  oai21  g42(.a(new_n66_), .b(x16), .c(new_n70_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n66_), .b(x18), .c(x16), .O(new_n80_));
