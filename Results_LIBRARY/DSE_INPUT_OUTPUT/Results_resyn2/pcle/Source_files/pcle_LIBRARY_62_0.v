...
module FAU ( 
  ...
  aoi21  g32(.a(new_n31_), .b(new_n60_), .c(new_n36_), .O(new_n61_));
  oai21  g33(.a(new_n31_), .b(new_n60_), .c(new_n61_), .O(new_n62_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n65_), .c(new_n29_), .O(z6));
  ...
  nand2  g49(.a(new_n33_), .b(x18), .O(new_n78_));
  inv1   g50(.a(x18), .O(new_n79_));
  oai21  g51(.a(new_n32_), .b(new_n31_), .c(new_n79_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n78_), .c(new_n37_), .O(new_n81_));
  aoi21  g53(.a(x08), .b(x07), .c(new_n29_), .O(new_n82_));
