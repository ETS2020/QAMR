...
module FAU ( 
  ...
  nand4  g32(.a(new_n60_), .b(new_n42_), .c(new_n58_), .d(new_n33_), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n57_), .c(new_n38_), .O(z4));
  inv1   g34(.a(new_n34_), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n58_), .b(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n31_), .O(new_n66_));
  aoi21  g38(.a(x08), .b(x04), .c(new_n38_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(z5));
  nand4  g40(.a(new_n30_), .b(new_n29_), .c(x16), .d(x15), .O(new_n69_));
  inv1   g41(.a(x16), .O(new_n70_));
  oai21  g42(.a(new_n58_), .b(new_n64_), .c(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n69_), .c(new_n63_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n75_), .c(new_n30_), .d(new_n29_), .O(new_n78_));
  nand2  g50(.a(x16), .b(x15), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n58_), .c(new_n76_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n78_), .c(new_n63_), .O(new_n81_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n75_), .c(new_n30_), .d(new_n29_), .O(new_n86_));
  oai21  g58(.a(new_n79_), .b(new_n58_), .c(new_n37_), .O(new_n87_));
