...
module FAU ( 
  ...
  aoi21  g07(.a(new_n35_), .b(x01), .c(x10), .O(z0));
  ...
  nand4  g18(.a(new_n46_), .b(new_n44_), .c(new_n43_), .d(x09), .O(new_n47_));
  aoi21  g19(.a(new_n47_), .b(new_n42_), .c(new_n37_), .O(z2));
  aoi21  g20(.a(x12), .b(x11), .c(x13), .O(new_n49_));
  nand2  g21(.a(new_n32_), .b(new_n30_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(new_n49_), .c(x01), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n43_), .O(new_n52_));
  nand2  g24(.a(x08), .b(x02), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n52_), .O(z3));
  aoi21  g26(.a(new_n43_), .b(new_n37_), .c(new_n42_), .O(new_n55_));
  ...
  nand3  g31(.a(new_n30_), .b(new_n43_), .c(x01), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n58_), .c(new_n56_), .O(z4));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n59_), .b(new_n64_), .O(new_n65_));
  nand2  g37(.a(x09), .b(new_n42_), .O(new_n66_));
  inv1   g38(.a(new_n33_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n57_), .c(new_n66_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n65_), .c(new_n37_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(x10), .c(new_n70_), .O(z5));
  nand3  g43(.a(new_n67_), .b(new_n57_), .c(x16), .O(new_n72_));
  oai21  g44(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n30_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(x01), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  ...
  nand4  g52(.a(new_n67_), .b(new_n57_), .c(x17), .d(x16), .O(new_n81_));
  nand2  g53(.a(new_n61_), .b(new_n81_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n80_), .c(new_n79_), .O(z7));
  nand2  g55(.a(new_n55_), .b(x07), .O(new_n84_));
  nand3  g56(.a(new_n34_), .b(x18), .c(x17), .O(new_n85_));
  inv1   g57(.a(x18), .O(new_n86_));
  nand2  g58(.a(new_n81_), .b(new_n86_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n61_), .c(new_n85_), .O(new_n88_));
