...
module FAU ( 
  ...
  and2   g17(.a(new_n42_), .b(new_n46_), .O(new_n47_));
  ...
  nand4  g24(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x14), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n41_), .O(new_n57_));
  aoi21  g28(.a(x08), .b(x04), .c(new_n34_), .O(new_n58_));
  oai21  g29(.a(new_n57_), .b(new_n53_), .c(new_n58_), .O(z5));
  nand3  g30(.a(new_n33_), .b(x08), .c(x05), .O(new_n60_));
  nand3  g31(.a(new_n55_), .b(x16), .c(x14), .O(new_n61_));
  nand4  g32(.a(new_n33_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  inv1   g34(.a(x16), .O(new_n64_));
  nand2  g35(.a(new_n56_), .b(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(new_n63_), .c(new_n61_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n60_), .O(z6));
  inv1   g38(.a(x17), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(x16), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n55_), .c(x18), .O(new_n71_));
  and2   g42(.a(x08), .b(x06), .O(new_n72_));
  nand3  g43(.a(new_n52_), .b(x16), .c(x15), .O(new_n73_));
  nand4  g44(.a(x17), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  aoi21  g46(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(new_n76_));
  oai21  g47(.a(new_n71_), .b(new_n46_), .c(new_n76_), .O(z7));
  nand3  g48(.a(new_n33_), .b(x08), .c(x07), .O(new_n78_));
  nand2  g49(.a(x16), .b(x15), .O(new_n79_));
  nor2   g50(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  aoi21  g51(.a(new_n80_), .b(x17), .c(x18), .O(new_n81_));
  oai21  g52(.a(new_n81_), .b(new_n62_), .c(new_n78_), .O(z8));
  zero   g53(.O(z0));
endmodule
