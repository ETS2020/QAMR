...
module FAU ( 
  ...
  oai21  g26(.a(x18), .b(x04), .c(x08), .O(new_n55_));
  ...
  oai21  g38(.a(new_n33_), .b(new_n32_), .c(new_n47_), .O(new_n67_));
  aoi21  g39(.a(new_n57_), .b(x16), .c(x17), .O(new_n68_));
  nand2  g40(.a(new_n43_), .b(x06), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(z7));
  ...
  aoi21  g45(.a(new_n67_), .b(x18), .c(new_n73_), .O(z8));
endmodule
