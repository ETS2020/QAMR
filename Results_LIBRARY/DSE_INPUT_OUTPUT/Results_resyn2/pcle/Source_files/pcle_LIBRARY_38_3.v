...
module FAU ( 
  ...
  oai21  g25(.a(x10), .b(x08), .c(x04), .O(new_n54_));
  ...
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n44_), .O(new_n65_));
  aoi21  g37(.a(x08), .b(x05), .c(new_n36_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(z6));
  nand2  g39(.a(new_n39_), .b(x06), .O(new_n68_));
  nand3  g40(.a(new_n55_), .b(new_n63_), .c(x17), .O(new_n69_));
  ...
  nand2  g45(.a(new_n39_), .b(x07), .O(new_n74_));
