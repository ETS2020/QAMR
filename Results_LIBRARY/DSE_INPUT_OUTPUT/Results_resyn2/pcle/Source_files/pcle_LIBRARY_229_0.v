...
module FAU ( 
  ...
  oai21  g21(.a(new_n48_), .b(new_n31_), .c(new_n49_), .O(z2));
  ...
  nand3  g26(.a(new_n54_), .b(new_n32_), .c(new_n45_), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n51_), .c(new_n38_), .O(z3));
  nor2   g28(.a(new_n33_), .b(x14), .O(new_n57_));
  nand2  g29(.a(new_n33_), .b(x14), .O(new_n58_));
  ...
  nor2   g36(.a(new_n34_), .b(new_n32_), .O(new_n65_));
  ...
  oai21  g42(.a(new_n34_), .b(new_n32_), .c(new_n70_), .O(new_n71_));
  aoi21  g43(.a(new_n65_), .b(x16), .c(new_n31_), .O(new_n72_));
