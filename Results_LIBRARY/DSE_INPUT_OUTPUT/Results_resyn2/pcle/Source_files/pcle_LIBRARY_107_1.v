...
module FAU ( 
  ...
  oai21  g28(.a(new_n34_), .b(new_n56_), .c(new_n33_), .O(new_n57_));
  aoi21  g29(.a(x08), .b(x03), .c(new_n39_), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n55_), .c(new_n58_), .O(z4));
  inv1   g31(.a(x15), .O(new_n60_));
  oai21  g32(.a(new_n34_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  nand3  g33(.a(new_n54_), .b(x15), .c(x14), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n61_), .c(new_n33_), .O(new_n63_));
  nand2  g35(.a(x08), .b(x04), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n63_), .c(new_n39_), .O(z5));
  inv1   g37(.a(new_n35_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n54_), .O(new_n67_));
  ...
  aoi21  g44(.a(new_n36_), .b(new_n33_), .c(x18), .O(new_n73_));
  and2   g45(.a(x08), .b(x06), .O(new_n74_));
  nand4  g46(.a(x17), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n75_));
  inv1   g47(.a(new_n75_), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n67_), .c(new_n74_), .O(new_n77_));
  oai21  g49(.a(new_n73_), .b(x17), .c(new_n77_), .O(z7));
  nor2   g50(.a(new_n36_), .b(x18), .O(new_n79_));
  oai21  g51(.a(new_n67_), .b(new_n29_), .c(new_n76_), .O(new_n80_));
  inv1   g52(.a(new_n39_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x08), .c(x07), .O(new_n82_));
  oai21  g54(.a(new_n80_), .b(new_n79_), .c(new_n82_), .O(z8));
endmodule
