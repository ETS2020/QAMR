...
module FAU ( 
  ...
  nand2  g39(.a(new_n60_), .b(x05), .O(new_n68_));
  nand2  g40(.a(new_n64_), .b(x16), .O(new_n69_));
  inv1   g41(.a(x16), .O(new_n70_));
  oai21  g42(.a(new_n31_), .b(new_n62_), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g51(.a(new_n79_), .b(new_n75_), .c(new_n74_), .O(z7));
  ...
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(new_n30_), .O(z8));
endmodule
