...
module FAU ( 
  ...
  nand3  g04(.a(x15), .b(x13), .c(x12), .O(new_n33_));
  ...
  and2   g23(.a(new_n48_), .b(new_n29_), .O(new_n52_));
  ...
  aoi21  g41(.a(new_n69_), .b(new_n61_), .c(new_n67_), .O(new_n70_));
  oai21  g42(.a(new_n66_), .b(new_n29_), .c(new_n70_), .O(z6));
  nand3  g43(.a(new_n60_), .b(x16), .c(x15), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n42_), .c(x17), .O(new_n73_));
  ...
  nor2   g53(.a(new_n61_), .b(new_n81_), .O(new_n82_));
  nand2  g54(.a(new_n42_), .b(x18), .O(new_n83_));
