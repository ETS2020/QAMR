// Benchmark "FAU" written by ABC on Tue Aug 11 19:38:58 2020
...
module FAU ( 
  ...
  nand3  g02(.a(x18), .b(x15), .c(new_n30_), .O(new_n31_));
  inv1   g03(.a(x08), .O(new_n32_));
  and2   g04(.a(x17), .b(x16), .O(new_n33_));
  nand3  g05(.a(new_n33_), .b(x09), .c(new_n32_), .O(new_n34_));
  nor3   g06(.a(new_n34_), .b(new_n31_), .c(new_n29_), .O(z0));
  inv1   g07(.a(x18), .O(new_n36_));
  aoi21  g08(.a(new_n36_), .b(x09), .c(new_n32_), .O(new_n37_));
  nand2  g09(.a(new_n37_), .b(x00), .O(new_n38_));
  nor2   g10(.a(x10), .b(x08), .O(new_n39_));
  nand3  g11(.a(new_n39_), .b(x18), .c(x09), .O(new_n40_));
  ...
  nand3  g30(.a(new_n58_), .b(new_n56_), .c(new_n39_), .O(new_n59_));
  ...
  nand2  g39(.a(new_n30_), .b(new_n32_), .O(new_n68_));
  aoi21  g40(.a(new_n29_), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n66_), .c(new_n36_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n64_), .c(new_n71_), .O(z5));
  nand2  g44(.a(new_n37_), .b(x05), .O(new_n73_));
  nor2   g45(.a(new_n29_), .b(new_n67_), .O(new_n74_));
  nor2   g46(.a(new_n74_), .b(x16), .O(new_n75_));
  nand3  g47(.a(new_n65_), .b(x16), .c(x15), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(z6));
  nand2  g50(.a(new_n37_), .b(x06), .O(new_n79_));
  nand3  g51(.a(new_n74_), .b(x17), .c(x16), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  nand2  g53(.a(new_n76_), .b(new_n81_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n80_), .c(new_n50_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n79_), .O(z7));
  nand3  g56(.a(new_n33_), .b(new_n65_), .c(x15), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n39_), .c(new_n36_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x07), .O(new_n87_));
  oai21  g59(.a(new_n86_), .b(new_n64_), .c(new_n87_), .O(z8));
endmodule
