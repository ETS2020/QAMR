...
module FAU ( 
  ...
  nand2  g22(.a(new_n45_), .b(new_n30_), .O(new_n51_));
  ...
  nand2  g26(.a(new_n31_), .b(x14), .O(new_n55_));
  inv1   g27(.a(x14), .O(new_n56_));
  nand2  g28(.a(new_n30_), .b(new_n56_), .O(new_n57_));
  ...
  xnor2a g32(.a(x15), .b(x14), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n60_), .c(new_n41_), .O(z5));
  ...
  aoi21  g43(.a(x08), .b(x05), .c(new_n41_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z6));
  aoi21  g45(.a(new_n69_), .b(x16), .c(x17), .O(new_n74_));
  nand2  g46(.a(new_n45_), .b(new_n35_), .O(new_n75_));
  ...
  nand3  g50(.a(new_n45_), .b(new_n35_), .c(x18), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n41_), .c(new_n79_), .O(z8));
endmodule
