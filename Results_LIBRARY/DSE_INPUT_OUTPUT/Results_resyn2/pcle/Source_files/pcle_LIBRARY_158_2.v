...
module FAU ( 
  ...
  nand2  g21(.a(new_n37_), .b(new_n29_), .O(new_n50_));
  ...
  nand2  g26(.a(new_n37_), .b(new_n54_), .O(new_n55_));
  aoi21  g27(.a(x08), .b(x03), .c(new_n41_), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(z4));
  nand2  g29(.a(x08), .b(x04), .O(new_n58_));
  nand3  g30(.a(new_n30_), .b(x15), .c(x14), .O(new_n59_));
  inv1   g31(.a(x15), .O(new_n60_));
  nand2  g32(.a(new_n54_), .b(new_n60_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n59_), .c(new_n37_), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n58_), .c(new_n41_), .O(z5));
  inv1   g35(.a(x16), .O(new_n64_));
  oai21  g36(.a(new_n54_), .b(new_n60_), .c(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n37_), .c(new_n33_), .O(new_n66_));
  nand2  g38(.a(x08), .b(x05), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(new_n41_), .O(z6));
  nand2  g40(.a(x18), .b(x17), .O(new_n69_));
  oai21  g41(.a(new_n31_), .b(new_n54_), .c(new_n69_), .O(new_n70_));
  inv1   g42(.a(new_n54_), .O(new_n71_));
  nand3  g43(.a(new_n32_), .b(new_n71_), .c(x17), .O(new_n72_));
  ...
  nand2  g47(.a(new_n75_), .b(new_n73_), .O(z7));
  nand3  g48(.a(new_n72_), .b(new_n37_), .c(x18), .O(new_n77_));
