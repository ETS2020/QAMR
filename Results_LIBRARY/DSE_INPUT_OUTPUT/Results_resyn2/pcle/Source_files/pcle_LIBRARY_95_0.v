...
module FAU ( 
  ...
  aoi21  g15(.a(x08), .b(x01), .c(new_n29_), .O(new_n44_));
  oai21  g16(.a(new_n43_), .b(new_n40_), .c(new_n44_), .O(z2));
  nor2   g17(.a(new_n29_), .b(new_n31_), .O(new_n46_));
  ...
  nand2  g23(.a(new_n46_), .b(x03), .O(new_n52_));
  ...
  nand2  g28(.a(new_n46_), .b(x04), .O(new_n57_));
  ...
  nand2  g35(.a(new_n46_), .b(x05), .O(new_n64_));
  ...
  nand2  g42(.a(new_n38_), .b(new_n49_), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x06), .c(new_n29_), .O(new_n72_));
