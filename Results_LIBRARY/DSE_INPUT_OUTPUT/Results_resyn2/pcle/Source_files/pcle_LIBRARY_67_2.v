...
module FAU ( 
  ...
  aoi21  g43(.a(new_n36_), .b(x16), .c(x17), .O(new_n72_));
  nand4  g44(.a(new_n61_), .b(x17), .c(x16), .d(x15), .O(new_n73_));
  ...
  nand3  g50(.a(new_n78_), .b(x08), .c(x07), .O(new_n79_));
  oai21  g51(.a(new_n74_), .b(new_n77_), .c(new_n79_), .O(z8));
endmodule
