...
module FAU ( 
  ...
  oai21  g43(.a(new_n34_), .b(new_n64_), .c(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n33_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n68_), .c(new_n39_), .O(z6));
  nand2  g46(.a(new_n36_), .b(x17), .O(new_n75_));
  inv1   g47(.a(x17), .O(new_n76_));
  oai21  g48(.a(new_n35_), .b(new_n34_), .c(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n75_), .c(new_n33_), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x06), .c(new_n39_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z7));
  aoi21  g52(.a(new_n36_), .b(x17), .c(x18), .O(new_n81_));
  nand3  g53(.a(new_n69_), .b(new_n62_), .c(x18), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n33_), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x07), .c(new_n39_), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(new_n81_), .c(new_n84_), .O(z8));
endmodule
