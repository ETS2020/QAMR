...
module FAU ( 
  ...
  nor2   g07(.a(x16), .b(x09), .O(new_n36_));
  ...
  aoi21  g16(.a(x08), .b(x02), .c(new_n36_), .O(new_n45_));
  ...
  aoi21  g22(.a(x08), .b(x03), .c(new_n36_), .O(new_n51_));
  ...
  nand3  g31(.a(new_n59_), .b(x08), .c(x05), .O(new_n60_));
  nand2  g32(.a(x15), .b(x14), .O(new_n61_));
  inv1   g33(.a(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n47_), .c(x16), .O(new_n63_));
  inv1   g35(.a(x16), .O(new_n64_));
  oai21  g36(.a(new_n61_), .b(new_n30_), .c(new_n64_), .O(new_n65_));
  ...
  nor2   g41(.a(new_n61_), .b(new_n30_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(x17), .c(new_n34_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g44(.a(x17), .b(new_n33_), .c(new_n32_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x09), .O(new_n74_));
  aoi22  g46(.a(new_n74_), .b(new_n64_), .c(x08), .d(x06), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n72_), .O(z7));
  nand3  g48(.a(new_n59_), .b(x08), .c(x07), .O(new_n77_));
  oai21  g49(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n78_));
  nor2   g50(.a(new_n68_), .b(new_n64_), .O(new_n79_));
  nor2   g51(.a(x18), .b(new_n53_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n55_), .c(new_n79_), .O(new_n81_));
