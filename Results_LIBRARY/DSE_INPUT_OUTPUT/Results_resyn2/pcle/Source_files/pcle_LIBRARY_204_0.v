...
module FAU ( 
  ...
  aoi21  g05(.a(new_n33_), .b(x00), .c(x10), .O(z0));
  ...
  aoi21  g25(.a(new_n36_), .b(new_n35_), .c(new_n29_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x03), .O(new_n55_));
  inv1   g27(.a(x14), .O(new_n56_));
  nand2  g28(.a(new_n48_), .b(new_n56_), .O(new_n57_));
  nand4  g29(.a(new_n36_), .b(x09), .c(new_n29_), .d(x00), .O(new_n58_));
  inv1   g30(.a(new_n58_), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(new_n57_), .c(new_n30_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n55_), .O(z4));
  nand2  g33(.a(new_n54_), .b(x04), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  nor2   g35(.a(new_n30_), .b(new_n63_), .O(new_n64_));
  nand2  g36(.a(new_n30_), .b(new_n63_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n59_), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n64_), .c(new_n62_), .O(z5));
  nand2  g39(.a(new_n54_), .b(x05), .O(new_n68_));
  nand2  g40(.a(new_n64_), .b(x16), .O(new_n69_));
  inv1   g41(.a(x16), .O(new_n70_));
  oai21  g42(.a(new_n30_), .b(new_n63_), .c(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n69_), .c(new_n59_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n68_), .O(z6));
  nand2  g45(.a(new_n54_), .b(x06), .O(new_n74_));
  ...
  nand2  g50(.a(new_n59_), .b(new_n78_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n75_), .c(new_n74_), .O(z7));
  nand2  g52(.a(new_n54_), .b(x07), .O(new_n81_));
  nand2  g53(.a(new_n32_), .b(x18), .O(new_n82_));
  inv1   g54(.a(x18), .O(new_n83_));
  oai21  g55(.a(new_n31_), .b(new_n30_), .c(new_n83_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n82_), .c(new_n59_), .O(new_n85_));
