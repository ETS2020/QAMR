...
module FAU ( 
  ...
  nand2  g13(.a(new_n39_), .b(x01), .O(new_n42_));
  ...
  nand2  g18(.a(new_n46_), .b(new_n42_), .O(z2));
  ...
  nand2  g28(.a(new_n32_), .b(new_n43_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z4));
  nand2  g30(.a(new_n39_), .b(x04), .O(new_n59_));
  ...
  nand2  g36(.a(new_n39_), .b(x05), .O(new_n65_));
  nand2  g37(.a(new_n61_), .b(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  oai21  g39(.a(new_n32_), .b(new_n60_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n43_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n65_), .O(z6));
  nand2  g42(.a(new_n39_), .b(x06), .O(new_n71_));
  aoi21  g43(.a(new_n61_), .b(x16), .c(x17), .O(new_n72_));
  ...
  nand2  g49(.a(new_n36_), .b(new_n43_), .O(new_n78_));
