...
module FAU ( 
  ...
  nand2  g29(.a(new_n53_), .b(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n57_), .c(new_n37_), .O(new_n60_));
  aoi21  g31(.a(x08), .b(x04), .c(new_n31_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n60_), .O(z5));
  aoi21  g33(.a(new_n56_), .b(x15), .c(x16), .O(new_n63_));
  nand3  g34(.a(new_n56_), .b(x16), .c(x15), .O(new_n64_));
  ...
  nand3  g38(.a(new_n30_), .b(x08), .c(x06), .O(new_n68_));
  inv1   g39(.a(x17), .O(new_n69_));
  nand2  g40(.a(x16), .b(x15), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n53_), .c(new_n69_), .O(new_n71_));
  nor2   g42(.a(new_n70_), .b(new_n53_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(x17), .O(new_n73_));
  nand4  g44(.a(new_n30_), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n68_), .O(z7));
  nand3  g48(.a(new_n30_), .b(x08), .c(x07), .O(new_n78_));
  aoi21  g49(.a(new_n72_), .b(x17), .c(x18), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(new_n74_), .c(new_n78_), .O(z8));
  zero   g51(.O(z0));
endmodule
