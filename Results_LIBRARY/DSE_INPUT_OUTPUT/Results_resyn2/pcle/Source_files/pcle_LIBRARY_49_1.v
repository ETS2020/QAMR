...
module FAU ( 
  ...
  nand3  g14(.a(new_n42_), .b(new_n41_), .c(new_n30_), .O(z1));
  inv1   g15(.a(x01), .O(new_n44_));
  nand2  g16(.a(new_n30_), .b(x08), .O(new_n45_));
  xnor2a g17(.a(x12), .b(x11), .O(new_n46_));
  oai22  g18(.a(new_n46_), .b(new_n36_), .c(new_n45_), .d(new_n44_), .O(z2));
  ...
  nor2   g43(.a(new_n35_), .b(x05), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x05), .c(new_n72_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n71_), .O(z6));
  aoi21  g46(.a(new_n64_), .b(x16), .c(x17), .O(new_n75_));
  inv1   g47(.a(new_n31_), .O(new_n76_));
  inv1   g48(.a(new_n32_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g50(.a(new_n37_), .b(new_n78_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x06), .c(new_n72_), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(new_n75_), .c(new_n80_), .O(z7));
  nand2  g53(.a(new_n60_), .b(x07), .O(new_n82_));
  nand2  g54(.a(new_n33_), .b(x18), .O(new_n83_));
  inv1   g55(.a(x18), .O(new_n84_));
  oai21  g56(.a(new_n32_), .b(new_n31_), .c(new_n84_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n83_), .c(new_n37_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n82_), .O(z8));
endmodule
