...
module FAU ( 
  ...
  nand2  g28(.a(new_n36_), .b(new_n30_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z4));
  nand2  g30(.a(new_n46_), .b(x04), .O(new_n59_));
  inv1   g31(.a(x15), .O(new_n60_));
  nand2  g32(.a(new_n30_), .b(new_n60_), .O(new_n61_));
  nor2   g33(.a(new_n30_), .b(new_n60_), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n61_), .c(new_n36_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n59_), .O(z5));
  oai21  g37(.a(x10), .b(x08), .c(x05), .O(new_n66_));
  nand2  g38(.a(new_n62_), .b(x16), .O(new_n67_));
  inv1   g39(.a(x16), .O(new_n68_));
  oai21  g40(.a(new_n30_), .b(new_n60_), .c(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n67_), .c(new_n36_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n66_), .O(z6));
  aoi21  g43(.a(new_n62_), .b(x16), .c(x17), .O(new_n72_));
  inv1   g44(.a(new_n30_), .O(new_n73_));
  inv1   g45(.a(new_n31_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g47(.a(new_n36_), .b(new_n75_), .O(new_n76_));
