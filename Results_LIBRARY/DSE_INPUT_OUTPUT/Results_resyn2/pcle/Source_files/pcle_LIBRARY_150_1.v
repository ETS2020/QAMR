...
module FAU ( 
  ...
  oai21  g17(.a(new_n33_), .b(x07), .c(x08), .O(new_n46_));
  aoi21  g18(.a(x12), .b(x11), .c(x13), .O(new_n47_));
  nand2  g19(.a(new_n40_), .b(new_n30_), .O(new_n48_));
  ...
  aoi21  g25(.a(x08), .b(x03), .c(new_n36_), .O(new_n54_));
  oai21  g26(.a(new_n53_), .b(new_n51_), .c(new_n54_), .O(z4));
  inv1   g27(.a(new_n46_), .O(new_n56_));
  ...
  nand2  g35(.a(new_n56_), .b(x05), .O(new_n64_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n40_), .O(new_n69_));
  ...
  nand3  g50(.a(new_n78_), .b(new_n58_), .c(new_n67_), .O(new_n79_));
