...
module FAU ( 
  ...
  nand3  g09(.a(new_n37_), .b(new_n35_), .c(new_n31_), .O(new_n38_));
  aoi21  g10(.a(new_n38_), .b(x06), .c(new_n29_), .O(z0));
  nor2   g11(.a(new_n29_), .b(x06), .O(new_n40_));
  ...
  nand3  g17(.a(new_n45_), .b(new_n35_), .c(new_n44_), .O(new_n46_));
  ...
  nand3  g36(.a(new_n64_), .b(new_n61_), .c(new_n35_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n59_), .c(new_n40_), .O(z5));
  nor2   g38(.a(new_n62_), .b(new_n49_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x16), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  oai21  g41(.a(new_n62_), .b(new_n49_), .c(new_n69_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n68_), .c(new_n35_), .O(new_n71_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n63_), .c(new_n54_), .O(new_n76_));
  ...
  nand3  g53(.a(new_n81_), .b(new_n54_), .c(x18), .O(new_n82_));
  oai21  g54(.a(new_n80_), .b(new_n49_), .c(new_n29_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n35_), .O(new_n84_));
