...
module FAU ( 
  ...
  nor2   g21(.a(new_n30_), .b(x09), .O(new_n50_));
  aoi21  g22(.a(x08), .b(x02), .c(new_n50_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n49_), .O(z3));
  inv1   g24(.a(new_n45_), .O(new_n53_));
  nor2   g25(.a(new_n53_), .b(x14), .O(new_n54_));
  nand2  g26(.a(new_n32_), .b(new_n44_), .O(new_n55_));
  aoi21  g27(.a(x08), .b(x03), .c(new_n50_), .O(new_n56_));
  ...
  oai22  g34(.a(new_n62_), .b(new_n60_), .c(new_n39_), .d(new_n58_), .O(z5));
  nand2  g35(.a(new_n60_), .b(x16), .O(new_n64_));
  inv1   g36(.a(x16), .O(new_n65_));
  oai21  g37(.a(new_n32_), .b(new_n59_), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n67_));
  aoi21  g39(.a(x08), .b(x05), .c(new_n50_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z6));
  aoi21  g41(.a(new_n60_), .b(x16), .c(x17), .O(new_n70_));
  nand2  g42(.a(new_n35_), .b(new_n33_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n44_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x06), .c(new_n50_), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(new_n70_), .c(new_n73_), .O(z7));
  aoi21  g46(.a(new_n35_), .b(new_n33_), .c(x18), .O(new_n75_));
  nand2  g47(.a(new_n36_), .b(new_n44_), .O(new_n76_));
  aoi21  g48(.a(x08), .b(x07), .c(new_n50_), .O(new_n77_));
