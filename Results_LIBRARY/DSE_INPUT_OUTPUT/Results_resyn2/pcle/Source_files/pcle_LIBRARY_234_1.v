...
module FAU ( 
  ...
  oai22  g18(.a(new_n46_), .b(new_n38_), .c(new_n45_), .d(new_n44_), .O(z2));
  inv1   g19(.a(x02), .O(new_n48_));
  aoi21  g20(.a(x12), .b(x11), .c(x13), .O(new_n49_));
  nand2  g21(.a(new_n39_), .b(new_n32_), .O(new_n50_));
  oai22  g22(.a(new_n50_), .b(new_n49_), .c(new_n45_), .d(new_n48_), .O(z3));
  ...
  oai22  g27(.a(new_n55_), .b(new_n53_), .c(new_n45_), .d(new_n52_), .O(z4));
