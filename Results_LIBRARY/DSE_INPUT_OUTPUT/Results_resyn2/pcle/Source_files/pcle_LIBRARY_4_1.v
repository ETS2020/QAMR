...
module FAU ( 
  ...
  nand3  g23(.a(new_n51_), .b(new_n50_), .c(new_n33_), .O(new_n52_));
  ...
  nand3  g33(.a(new_n61_), .b(new_n60_), .c(x15), .O(new_n62_));
  ...
  nand2  g38(.a(new_n37_), .b(new_n35_), .O(new_n67_));
  inv1   g39(.a(x16), .O(new_n68_));
  oai21  g40(.a(new_n34_), .b(new_n63_), .c(new_n68_), .O(new_n69_));
  ...
  nand3  g48(.a(new_n76_), .b(new_n37_), .c(new_n35_), .O(new_n77_));
  oai21  g49(.a(new_n36_), .b(new_n34_), .c(new_n75_), .O(new_n78_));
  ...
  nand3  g54(.a(new_n37_), .b(new_n35_), .c(x18), .O(new_n83_));
  nand4  g55(.a(x17), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n84_));
  inv1   g56(.a(new_n84_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n83_), .c(new_n82_), .O(new_n86_));
