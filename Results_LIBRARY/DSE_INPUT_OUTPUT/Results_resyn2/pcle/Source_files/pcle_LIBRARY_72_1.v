...
module FAU ( 
  ...
  nand3  g41(.a(new_n69_), .b(new_n63_), .c(x14), .O(new_n70_));
  ...
  aoi21  g47(.a(new_n34_), .b(new_n42_), .c(x18), .O(new_n76_));
  inv1   g48(.a(new_n31_), .O(new_n77_));
  and2   g49(.a(x08), .b(x06), .O(new_n78_));
  aoi21  g50(.a(new_n70_), .b(new_n77_), .c(new_n78_), .O(new_n79_));
  oai21  g51(.a(new_n76_), .b(x17), .c(new_n79_), .O(z7));
  inv1   g52(.a(new_n38_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x08), .c(x07), .O(new_n82_));
  nand2  g54(.a(new_n70_), .b(new_n37_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n35_), .c(new_n77_), .O(new_n84_));
