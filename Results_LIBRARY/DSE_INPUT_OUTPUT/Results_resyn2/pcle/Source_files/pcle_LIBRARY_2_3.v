...
module FAU ( 
  ...
  oai21  g17(.a(x08), .b(x00), .c(x01), .O(new_n46_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n50_), .c(new_n38_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n49_), .c(new_n41_), .O(z3));
  nand2  g27(.a(x08), .b(x03), .O(new_n56_));
  inv1   g28(.a(x14), .O(new_n57_));
  nand2  g29(.a(new_n50_), .b(new_n57_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n38_), .c(new_n30_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(new_n41_), .O(z4));
  nand2  g32(.a(x08), .b(x04), .O(new_n61_));
  inv1   g33(.a(x15), .O(new_n62_));
  nand2  g34(.a(new_n30_), .b(new_n62_), .O(new_n63_));
  ...
  nand3  g39(.a(new_n31_), .b(x16), .c(x15), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  oai21  g41(.a(new_n30_), .b(new_n62_), .c(new_n69_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n68_), .c(new_n38_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n67_), .c(new_n41_), .O(z6));
  nor2   g44(.a(new_n30_), .b(new_n62_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(x16), .c(x17), .O(new_n74_));
  nand2  g46(.a(new_n38_), .b(new_n34_), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x06), .c(new_n41_), .O(new_n76_));
  oai21  g48(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(z7));
  nand2  g49(.a(x08), .b(x07), .O(new_n78_));
  nand3  g50(.a(new_n33_), .b(new_n31_), .c(x18), .O(new_n79_));
  inv1   g51(.a(x18), .O(new_n80_));
  oai21  g52(.a(new_n32_), .b(new_n30_), .c(new_n80_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n79_), .c(new_n38_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n78_), .c(new_n41_), .O(z8));
endmodule
