...
module FAU ( 
  ...
  nand4  g05(.a(x16), .b(x14), .c(x13), .d(x12), .O(new_n34_));
  inv1   g06(.a(new_n34_), .O(new_n35_));
  nand3  g07(.a(new_n35_), .b(new_n33_), .c(x11), .O(new_n36_));
  ...
  nand3  g20(.a(new_n48_), .b(new_n46_), .c(new_n42_), .O(new_n49_));
  ...
  aoi21  g25(.a(x08), .b(x02), .c(new_n38_), .O(new_n54_));
  ...
  nor2   g33(.a(new_n58_), .b(new_n29_), .O(new_n62_));
  nand2  g34(.a(new_n58_), .b(new_n29_), .O(new_n63_));
  ...
  oai21  g40(.a(new_n58_), .b(new_n29_), .c(new_n68_), .O(new_n69_));
  nand2  g41(.a(new_n62_), .b(x16), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n69_), .c(new_n42_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n67_), .c(new_n38_), .O(z6));
  inv1   g44(.a(x09), .O(new_n73_));
  nor2   g45(.a(new_n73_), .b(x08), .O(new_n74_));
  nor2   g46(.a(x17), .b(new_n40_), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(new_n35_), .c(new_n74_), .d(new_n31_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x18), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x15), .O(new_n78_));
  nand3  g50(.a(new_n62_), .b(x18), .c(x16), .O(new_n79_));
  and2   g51(.a(x08), .b(x06), .O(new_n80_));
  aoi21  g52(.a(new_n79_), .b(new_n33_), .c(new_n80_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n78_), .O(z7));
  nand3  g54(.a(new_n62_), .b(x17), .c(x16), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n42_), .c(x18), .O(new_n84_));
