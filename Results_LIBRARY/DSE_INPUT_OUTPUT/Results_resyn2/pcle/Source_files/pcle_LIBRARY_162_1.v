...
module FAU ( 
  ...
  nand4  g09(.a(new_n37_), .b(new_n35_), .c(new_n33_), .d(x17), .O(new_n38_));
  aoi21  g10(.a(new_n38_), .b(x01), .c(new_n29_), .O(z0));
  nor2   g11(.a(new_n29_), .b(x01), .O(new_n40_));
  aoi21  g12(.a(x08), .b(x00), .c(new_n40_), .O(new_n41_));
  oai21  g13(.a(new_n32_), .b(x11), .c(new_n41_), .O(z1));
  aoi21  g14(.a(new_n29_), .b(new_n30_), .c(x01), .O(new_n43_));
  ...
  aoi21  g36(.a(new_n35_), .b(x15), .c(x16), .O(new_n65_));
  oai21  g37(.a(new_n36_), .b(new_n34_), .c(new_n33_), .O(new_n66_));
  ...
  nand3  g41(.a(new_n37_), .b(new_n35_), .c(x17), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  oai21  g43(.a(new_n36_), .b(new_n34_), .c(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n33_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n69_), .c(new_n40_), .O(z7));
  nand4  g46(.a(new_n37_), .b(new_n35_), .c(x18), .d(x17), .O(new_n75_));
  nand2  g47(.a(new_n70_), .b(new_n29_), .O(new_n76_));
