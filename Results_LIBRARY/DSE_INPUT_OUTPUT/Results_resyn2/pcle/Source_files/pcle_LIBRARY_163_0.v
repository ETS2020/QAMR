...
module FAU ( 
  ...
  nand3  g13(.a(new_n32_), .b(x09), .c(new_n31_), .O(new_n42_));
  ...
  aoi21  g29(.a(x08), .b(x03), .c(new_n29_), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n55_), .c(new_n58_), .O(z4));
  inv1   g31(.a(x04), .O(new_n60_));
  aoi21  g32(.a(new_n54_), .b(x14), .c(x15), .O(new_n61_));
  nand2  g33(.a(new_n36_), .b(new_n33_), .O(new_n62_));
  inv1   g34(.a(x18), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(x08), .c(new_n60_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n62_), .c(new_n32_), .d(x09), .O(new_n65_));
  oai22  g37(.a(new_n65_), .b(new_n61_), .c(new_n31_), .d(new_n60_), .O(z5));
  ...
  nand2  g43(.a(new_n71_), .b(new_n54_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n69_), .c(new_n43_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n67_), .c(new_n29_), .O(z6));
  inv1   g46(.a(x17), .O(new_n75_));
  nand2  g47(.a(new_n72_), .b(new_n75_), .O(new_n76_));
  nor2   g48(.a(new_n70_), .b(new_n50_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(x17), .c(new_n42_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x06), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n79_), .c(new_n29_), .O(z7));
  nand2  g53(.a(x08), .b(x07), .O(new_n82_));
  nand3  g54(.a(new_n37_), .b(new_n36_), .c(new_n63_), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n34_), .c(new_n82_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(x04), .O(new_n85_));
  inv1   g57(.a(new_n82_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n78_), .c(x18), .O(new_n87_));
