...
module FAU ( 
  ...
  oai21  g10(.a(new_n30_), .b(x09), .c(x08), .O(new_n39_));
  ...
  nor2   g16(.a(new_n30_), .b(x09), .O(new_n45_));
  ...
  nand3  g22(.a(new_n50_), .b(new_n48_), .c(new_n41_), .O(new_n51_));
  aoi21  g23(.a(x08), .b(x02), .c(new_n45_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(z3));
  inv1   g25(.a(new_n48_), .O(new_n54_));
  nor2   g26(.a(new_n54_), .b(x14), .O(new_n55_));
  nand2  g27(.a(new_n32_), .b(new_n41_), .O(new_n56_));
  aoi21  g28(.a(x08), .b(x03), .c(new_n45_), .O(new_n57_));
  ...
  nand2  g33(.a(new_n32_), .b(new_n60_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n41_), .O(new_n63_));
  oai22  g35(.a(new_n63_), .b(new_n61_), .c(new_n39_), .d(new_n59_), .O(z5));
  nand2  g36(.a(new_n61_), .b(x16), .O(new_n65_));
  inv1   g37(.a(x16), .O(new_n66_));
  oai21  g38(.a(new_n32_), .b(new_n60_), .c(new_n66_), .O(new_n67_));
  ...
  aoi21  g42(.a(new_n61_), .b(x16), .c(x17), .O(new_n71_));
  nand2  g43(.a(new_n35_), .b(new_n33_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n41_), .O(new_n73_));
  aoi21  g45(.a(x08), .b(x06), .c(new_n45_), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n71_), .c(new_n74_), .O(z7));
  aoi21  g47(.a(new_n35_), .b(new_n33_), .c(x18), .O(new_n76_));
  nand2  g48(.a(new_n36_), .b(new_n41_), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x07), .c(new_n45_), .O(new_n78_));
  oai21  g50(.a(new_n77_), .b(new_n76_), .c(new_n78_), .O(z8));
endmodule
