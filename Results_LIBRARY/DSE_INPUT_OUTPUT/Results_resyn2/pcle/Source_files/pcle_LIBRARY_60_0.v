...
module FAU ( 
  ...
  nand3  g31(.a(new_n59_), .b(new_n57_), .c(new_n42_), .O(new_n60_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n64_), .c(new_n62_), .d(new_n42_), .O(new_n66_));
  nand3  g38(.a(new_n62_), .b(x08), .c(x04), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(z5));
  nand3  g40(.a(new_n35_), .b(new_n33_), .c(x16), .O(new_n69_));
  ...
  oai21  g50(.a(new_n57_), .b(new_n70_), .c(new_n76_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n42_), .O(new_n80_));
  ...
  nand2  g56(.a(x17), .b(x16), .O(new_n85_));
  inv1   g57(.a(new_n85_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n75_), .c(x18), .O(new_n87_));
  inv1   g59(.a(x18), .O(new_n88_));
  oai21  g60(.a(new_n85_), .b(new_n57_), .c(new_n88_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n87_), .c(new_n42_), .O(new_n90_));
  oai21  g62(.a(new_n42_), .b(new_n88_), .c(new_n63_), .O(new_n91_));
