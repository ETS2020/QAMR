...
module FAU ( 
  ...
  nand4  g18(.a(new_n46_), .b(new_n40_), .c(new_n44_), .d(new_n37_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n43_), .O(z2));
  ...
  aoi22  g23(.a(x18), .b(new_n39_), .c(x08), .d(x02), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n49_), .c(new_n52_), .O(z3));
  nand3  g25(.a(new_n40_), .b(x08), .c(x03), .O(new_n54_));
  ...
  nand4  g31(.a(new_n59_), .b(new_n57_), .c(new_n40_), .d(new_n37_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n54_), .O(z4));
  inv1   g33(.a(x15), .O(new_n62_));
  oai21  g34(.a(new_n55_), .b(new_n39_), .c(new_n62_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n32_), .c(new_n37_), .O(new_n64_));
  ...
  nand3  g44(.a(new_n72_), .b(new_n56_), .c(x15), .O(new_n73_));
  nand2  g45(.a(new_n32_), .b(new_n71_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n73_), .c(new_n37_), .O(new_n75_));
  nand4  g47(.a(x16), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n65_), .O(new_n77_));
  ...
  nand3  g56(.a(new_n84_), .b(new_n82_), .c(new_n56_), .O(new_n85_));
  oai21  g57(.a(new_n81_), .b(new_n55_), .c(new_n83_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n85_), .c(new_n37_), .O(new_n87_));
  nand2  g59(.a(new_n31_), .b(new_n65_), .O(new_n88_));
  ...
  nand3  g63(.a(new_n40_), .b(x08), .c(x07), .O(new_n92_));
  nand3  g64(.a(x17), .b(x16), .c(x15), .O(new_n93_));
  inv1   g65(.a(new_n93_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n56_), .c(x18), .O(new_n95_));
  oai21  g67(.a(new_n93_), .b(new_n55_), .c(new_n65_), .O(new_n96_));
  nand4  g68(.a(x13), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n97_));
