...
module FAU ( 
  ...
  nand3  g27(.a(new_n55_), .b(new_n35_), .c(new_n34_), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n53_), .c(new_n40_), .O(z4));
  inv1   g29(.a(x15), .O(new_n58_));
  aoi21  g30(.a(new_n35_), .b(new_n58_), .c(new_n33_), .O(new_n59_));
  oai21  g31(.a(new_n35_), .b(new_n58_), .c(new_n59_), .O(new_n60_));
  ...
  oai21  g40(.a(new_n35_), .b(new_n58_), .c(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n67_), .c(new_n34_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n63_), .c(new_n40_), .O(z6));
  nand2  g43(.a(x08), .b(x06), .O(new_n72_));
  nand4  g44(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(x17), .O(new_n73_));
  inv1   g45(.a(x17), .O(new_n74_));
  oai21  g46(.a(new_n36_), .b(new_n35_), .c(new_n74_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n73_), .c(new_n34_), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n72_), .c(new_n40_), .O(z7));
  nand3  g49(.a(new_n37_), .b(x18), .c(x17), .O(new_n78_));
  nand2  g50(.a(new_n73_), .b(new_n30_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n34_), .O(new_n80_));
