...
module FAU ( 
  ...
  nand2  g20(.a(new_n45_), .b(new_n49_), .O(new_n50_));
  nand4  g21(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(new_n50_), .c(new_n41_), .O(new_n52_));
  ...
  nand3  g28(.a(new_n57_), .b(new_n55_), .c(new_n41_), .O(new_n58_));
  ...
  aoi21  g34(.a(x08), .b(x05), .c(new_n34_), .O(new_n64_));
  oai21  g35(.a(new_n63_), .b(new_n61_), .c(new_n64_), .O(z6));
  nand3  g36(.a(new_n33_), .b(x08), .c(x06), .O(new_n66_));
