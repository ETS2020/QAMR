...
module FAU ( 
  ...
  nand4  g23(.a(new_n51_), .b(new_n49_), .c(new_n45_), .d(new_n30_), .O(new_n52_));
  aoi21  g24(.a(new_n52_), .b(new_n48_), .c(new_n41_), .O(z2));
  ...
  nand3  g55(.a(new_n38_), .b(new_n32_), .c(x18), .O(new_n84_));
  nand2  g56(.a(x08), .b(x07), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(new_n79_), .O(z8));
endmodule
