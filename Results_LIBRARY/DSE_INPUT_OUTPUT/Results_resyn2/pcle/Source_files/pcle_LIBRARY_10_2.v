...
module FAU ( 
  ...
  nor2   g14(.a(x18), .b(new_n33_), .O(new_n43_));
  ...
  aoi21  g32(.a(x08), .b(x04), .c(new_n43_), .O(new_n61_));
  ...
  nand2  g42(.a(new_n63_), .b(x06), .O(new_n71_));
  nand3  g43(.a(new_n56_), .b(new_n67_), .c(x17), .O(new_n72_));
  ...
  nand2  g48(.a(new_n63_), .b(x07), .O(new_n77_));
  oai21  g49(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n78_));
  nor2   g50(.a(x18), .b(new_n73_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n56_), .c(new_n67_), .O(new_n80_));
