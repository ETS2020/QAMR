...
module FAU ( 
  ...
  nand4  g05(.a(new_n33_), .b(new_n31_), .c(x17), .d(x16), .O(new_n34_));
  inv1   g06(.a(x08), .O(new_n35_));
  inv1   g07(.a(x10), .O(new_n36_));
  nand4  g08(.a(x18), .b(new_n36_), .c(x09), .d(new_n35_), .O(new_n37_));
  oai22  g09(.a(new_n37_), .b(new_n34_), .c(x18), .d(new_n29_), .O(z0));
  ...
  oai21  g39(.a(new_n67_), .b(x08), .c(x05), .O(new_n68_));
  nor2   g40(.a(new_n32_), .b(new_n30_), .O(new_n69_));
  ...
  nand2  g47(.a(new_n43_), .b(new_n34_), .O(new_n76_));
  aoi21  g48(.a(x08), .b(x06), .c(new_n39_), .O(new_n77_));
  oai21  g49(.a(new_n76_), .b(new_n75_), .c(new_n77_), .O(z7));
  nand2  g50(.a(x17), .b(x16), .O(new_n79_));
  nor2   g51(.a(new_n42_), .b(new_n79_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n69_), .c(x05), .O(new_n81_));
  inv1   g53(.a(new_n37_), .O(new_n82_));
  and2   g54(.a(x08), .b(x07), .O(new_n83_));
  aoi21  g55(.a(new_n82_), .b(new_n34_), .c(new_n83_), .O(new_n84_));
  oai21  g56(.a(new_n81_), .b(x18), .c(new_n84_), .O(z8));
endmodule
