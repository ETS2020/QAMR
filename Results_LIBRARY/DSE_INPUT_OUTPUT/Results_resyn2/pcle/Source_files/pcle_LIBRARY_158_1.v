...
module FAU ( 
  ...
  oai21  g26(.a(new_n29_), .b(new_n54_), .c(new_n44_), .O(new_n55_));
  ...
  oai21  g31(.a(new_n29_), .b(new_n54_), .c(new_n59_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n44_), .c(new_n33_), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n58_), .c(new_n40_), .O(z5));
  nand2  g34(.a(x08), .b(x05), .O(new_n63_));
  nand3  g35(.a(new_n32_), .b(new_n30_), .c(x16), .O(new_n64_));
  inv1   g36(.a(x16), .O(new_n65_));
  oai21  g37(.a(new_n31_), .b(new_n29_), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n63_), .c(new_n40_), .O(z6));
  inv1   g40(.a(x17), .O(new_n69_));
  nand2  g41(.a(new_n39_), .b(new_n69_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n32_), .c(new_n30_), .d(x16), .O(new_n71_));
  nand2  g43(.a(new_n64_), .b(new_n69_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n71_), .c(new_n44_), .O(new_n73_));
  inv1   g45(.a(new_n40_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(x08), .c(x06), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n73_), .O(z7));
  nand2  g48(.a(new_n39_), .b(x17), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n32_), .c(new_n30_), .d(x16), .O(new_n78_));
  nand2  g50(.a(new_n64_), .b(new_n39_), .O(new_n79_));
