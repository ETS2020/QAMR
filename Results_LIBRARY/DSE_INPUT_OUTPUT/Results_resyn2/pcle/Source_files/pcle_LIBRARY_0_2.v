...
module FAU ( 
  ...
  oai21  g27(.a(new_n29_), .b(x08), .c(x03), .O(new_n56_));
  ...
  nor3   g46(.a(new_n67_), .b(new_n30_), .c(new_n70_), .O(new_n75_));
  nand4  g47(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n76_));
  inv1   g48(.a(new_n76_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n31_), .c(new_n35_), .O(new_n78_));
  oai21  g50(.a(new_n75_), .b(x17), .c(new_n78_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x06), .c(new_n39_), .O(new_n80_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n78_), .c(x18), .O(new_n90_));
