...
module FAU ( 
  ...
  nand2  g00(.a(x18), .b(x09), .O(new_n30_));
  and2   g01(.a(new_n30_), .b(x08), .O(new_n31_));
  ...
  nand2  g14(.a(new_n31_), .b(x02), .O(new_n44_));
  ...
  oai21  g19(.a(new_n48_), .b(new_n45_), .c(new_n44_), .O(z3));
  ...
  and2   g29(.a(new_n50_), .b(new_n58_), .O(new_n59_));
  nand4  g30(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n58_), .c(new_n34_), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n59_), .c(new_n33_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(x09), .O(new_n63_));
  nand2  g34(.a(x08), .b(x04), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n63_), .O(z5));
  nand2  g36(.a(new_n31_), .b(x05), .O(new_n66_));
  inv1   g37(.a(x16), .O(new_n67_));
  oai21  g38(.a(new_n60_), .b(new_n58_), .c(new_n67_), .O(new_n68_));
  inv1   g39(.a(new_n60_), .O(new_n69_));
  nor2   g40(.a(new_n67_), .b(new_n58_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(new_n68_), .c(new_n46_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n66_), .O(z6));
  nand2  g44(.a(new_n31_), .b(x06), .O(new_n74_));
  aoi21  g45(.a(new_n70_), .b(new_n69_), .c(x17), .O(new_n75_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(x17), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n46_), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(z7));
  nand4  g49(.a(new_n70_), .b(new_n69_), .c(new_n34_), .d(x17), .O(new_n79_));
