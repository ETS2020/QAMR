...
module FAU ( 
  ...
  nand3  g43(.a(new_n30_), .b(x08), .c(x06), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  nand2  g45(.a(x18), .b(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n58_), .c(new_n67_), .O(new_n75_));
  ...
  nand3  g50(.a(new_n30_), .b(x08), .c(x07), .O(new_n79_));
  oai21  g51(.a(new_n32_), .b(new_n31_), .c(x18), .O(new_n80_));
  nor2   g52(.a(x18), .b(new_n73_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n58_), .c(new_n67_), .O(new_n82_));
