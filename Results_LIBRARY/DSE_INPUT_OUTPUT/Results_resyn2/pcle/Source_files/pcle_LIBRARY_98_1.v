...
module FAU ( 
  ...
  nand2  g21(.a(new_n39_), .b(new_n32_), .O(new_n50_));
  ...
  aoi21  g40(.a(x08), .b(x05), .c(new_n30_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z6));
  nand3  g42(.a(new_n31_), .b(x08), .c(x06), .O(new_n71_));
  ...
  oai21  g48(.a(new_n34_), .b(new_n32_), .c(x18), .O(new_n77_));
  nor2   g49(.a(x18), .b(new_n73_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n57_), .c(new_n66_), .O(new_n79_));
