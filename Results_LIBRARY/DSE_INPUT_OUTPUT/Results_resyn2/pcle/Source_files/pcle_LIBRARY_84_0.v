...
module FAU ( 
  ...
  nand2  g19(.a(new_n37_), .b(new_n31_), .O(new_n48_));
  aoi21  g20(.a(x08), .b(x02), .c(new_n29_), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(new_n47_), .c(new_n49_), .O(z3));
  inv1   g22(.a(x14), .O(new_n51_));
  aoi21  g23(.a(new_n31_), .b(new_n51_), .c(new_n36_), .O(new_n52_));
  oai21  g24(.a(new_n31_), .b(new_n51_), .c(new_n52_), .O(new_n53_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n56_), .c(new_n29_), .O(z5));
