...
module FAU ( 
  ...
  nand2  g41(.a(new_n65_), .b(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  oai21  g43(.a(new_n32_), .b(new_n64_), .c(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n60_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n69_), .O(z6));
  nand2  g46(.a(new_n56_), .b(x06), .O(new_n75_));
  aoi21  g47(.a(new_n65_), .b(x16), .c(x17), .O(new_n76_));
  nand2  g48(.a(new_n35_), .b(new_n33_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n60_), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(z7));
  nand2  g51(.a(new_n56_), .b(x07), .O(new_n80_));
  aoi21  g52(.a(new_n35_), .b(new_n33_), .c(x18), .O(new_n81_));
  nand2  g53(.a(new_n36_), .b(new_n60_), .O(new_n82_));
