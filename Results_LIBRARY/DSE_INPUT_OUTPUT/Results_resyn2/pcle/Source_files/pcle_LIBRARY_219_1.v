...
module FAU ( 
  ...
  nand2  g05(.a(x18), .b(x02), .O(new_n34_));
  ...
  nor2   g11(.a(new_n39_), .b(x02), .O(new_n40_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n43_), .c(new_n29_), .O(new_n54_));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n57_), .c(new_n40_), .O(z4));
  aoi21  g34(.a(new_n30_), .b(x14), .c(x15), .O(new_n63_));
  and2   g35(.a(x15), .b(x14), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n30_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n43_), .O(new_n66_));
  aoi21  g38(.a(x08), .b(x04), .c(new_n40_), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n63_), .c(new_n67_), .O(z5));
  nand3  g40(.a(new_n64_), .b(new_n30_), .c(x16), .O(new_n69_));
  ...
  aoi21  g49(.a(new_n32_), .b(new_n30_), .c(new_n37_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n75_), .c(new_n40_), .O(z7));
  nand2  g52(.a(new_n34_), .b(new_n33_), .O(new_n81_));
  nand3  g53(.a(new_n32_), .b(new_n30_), .c(x18), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(new_n83_));
