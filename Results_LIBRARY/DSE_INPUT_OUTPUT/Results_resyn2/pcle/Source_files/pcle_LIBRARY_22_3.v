...
module FAU ( 
  ...
  aoi21  g26(.a(x08), .b(x03), .c(new_n31_), .O(new_n56_));
  oai21  g27(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(z4));
  inv1   g28(.a(x15), .O(new_n58_));
  nor2   g29(.a(new_n54_), .b(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n54_), .b(new_n58_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n37_), .O(new_n61_));
  aoi21  g32(.a(x08), .b(x04), .c(new_n31_), .O(new_n62_));
  oai21  g33(.a(new_n61_), .b(new_n59_), .c(new_n62_), .O(z5));
  inv1   g34(.a(x16), .O(new_n64_));
  nand2  g35(.a(x15), .b(x14), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n49_), .c(new_n64_), .O(new_n66_));
  nand3  g37(.a(x16), .b(x15), .c(x14), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n49_), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n66_), .c(new_n37_), .O(new_n70_));
  aoi21  g41(.a(x08), .b(x05), .c(new_n31_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(z6));
  nand3  g43(.a(new_n30_), .b(x08), .c(x06), .O(new_n73_));
  nand2  g44(.a(new_n68_), .b(x17), .O(new_n74_));
  inv1   g45(.a(x17), .O(new_n75_));
  oai22  g46(.a(new_n67_), .b(new_n49_), .c(x18), .d(new_n75_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n74_), .c(new_n37_), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n73_), .O(z7));
  aoi21  g49(.a(new_n68_), .b(x17), .c(x18), .O(new_n79_));
  aoi21  g50(.a(x08), .b(x07), .c(new_n31_), .O(new_n80_));
  oai21  g51(.a(new_n79_), .b(new_n36_), .c(new_n80_), .O(z8));
  zero   g52(.O(z0));
endmodule
