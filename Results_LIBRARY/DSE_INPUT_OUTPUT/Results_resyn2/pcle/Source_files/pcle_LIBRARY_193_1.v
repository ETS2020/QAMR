...
module FAU ( 
  ...
  nand2  g44(.a(new_n29_), .b(new_n72_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n37_), .c(new_n35_), .O(new_n74_));
  oai21  g46(.a(new_n36_), .b(new_n34_), .c(new_n72_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(new_n33_), .O(new_n76_));
  inv1   g48(.a(new_n40_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x08), .c(x06), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(z7));
  nand2  g51(.a(new_n29_), .b(x17), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n37_), .c(new_n35_), .O(new_n81_));
  oai21  g53(.a(new_n36_), .b(new_n34_), .c(new_n29_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n33_), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x07), .c(new_n40_), .O(new_n84_));
