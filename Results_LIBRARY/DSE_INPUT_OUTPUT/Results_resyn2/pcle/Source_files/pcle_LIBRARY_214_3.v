...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(new_n33_), .c(new_n46_), .O(new_n49_));
  ...
  nand3  g26(.a(new_n54_), .b(new_n33_), .c(new_n52_), .O(new_n55_));
  ...
  nand2  g33(.a(new_n29_), .b(new_n34_), .O(new_n62_));
  nand2  g34(.a(x15), .b(x14), .O(new_n63_));
  nor2   g35(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n62_), .c(new_n33_), .O(new_n66_));
  ...
  oai21  g43(.a(new_n63_), .b(new_n52_), .c(new_n71_), .O(new_n72_));
  ...
  inv1   g48(.a(new_n63_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n76_), .c(new_n57_), .O(new_n78_));
  ...
  oai21  g57(.a(new_n82_), .b(new_n52_), .c(new_n85_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n84_), .c(new_n33_), .O(new_n87_));
  aoi21  g59(.a(x08), .b(x07), .c(new_n40_), .O(new_n88_));
