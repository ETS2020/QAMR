...
module FAU ( 
  ...
  nand3  g17(.a(new_n45_), .b(new_n43_), .c(new_n35_), .O(new_n46_));
  ...
  nand3  g22(.a(new_n50_), .b(new_n37_), .c(new_n48_), .O(new_n51_));
  ...
  nand4  g28(.a(new_n56_), .b(new_n45_), .c(new_n29_), .d(new_n35_), .O(new_n57_));
  ...
  nand4  g34(.a(new_n62_), .b(new_n60_), .c(new_n45_), .d(new_n35_), .O(new_n63_));
  ...
  nand3  g39(.a(new_n67_), .b(new_n45_), .c(new_n35_), .O(new_n68_));
  ...
  nand2  g43(.a(new_n32_), .b(new_n30_), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  nand2  g45(.a(x15), .b(x14), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n29_), .c(new_n73_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n37_), .c(new_n72_), .O(new_n76_));
  aoi21  g48(.a(x08), .b(x05), .c(new_n41_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z6));
  oai21  g50(.a(new_n31_), .b(new_n29_), .c(new_n40_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n37_), .c(new_n33_), .O(new_n80_));
  aoi21  g52(.a(x08), .b(x06), .c(new_n41_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(z7));
  nand3  g54(.a(new_n37_), .b(new_n33_), .c(x18), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x07), .c(new_n41_), .O(new_n84_));
