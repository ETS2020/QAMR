...
module FAU ( 
  ...
  oai21  g32(.a(new_n56_), .b(new_n32_), .c(new_n29_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g34(.a(new_n56_), .b(new_n33_), .c(x15), .O(new_n63_));
  ...
  oai21  g40(.a(new_n57_), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n66_), .O(new_n70_));
  oai21  g42(.a(new_n56_), .b(new_n60_), .c(new_n67_), .O(new_n71_));
  nand2  g43(.a(x16), .b(x15), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n71_), .c(new_n66_), .d(new_n33_), .O(new_n73_));
  ...
  oai21  g50(.a(new_n56_), .b(new_n67_), .c(new_n76_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n33_), .O(new_n80_));
  oai21  g52(.a(new_n32_), .b(new_n76_), .c(new_n29_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n60_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x06), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(z7));
  oai21  g56(.a(new_n35_), .b(new_n34_), .c(x18), .O(new_n85_));
  nand2  g57(.a(x17), .b(x15), .O(new_n86_));
  nor2   g58(.a(new_n86_), .b(x18), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n75_), .c(x16), .O(new_n88_));
