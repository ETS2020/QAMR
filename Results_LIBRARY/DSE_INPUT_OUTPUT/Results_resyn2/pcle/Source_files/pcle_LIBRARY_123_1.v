...
module FAU ( 
  ...
  nor2   g22(.a(new_n39_), .b(new_n30_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(x03), .O(new_n52_));
  inv1   g24(.a(x14), .O(new_n53_));
  aoi21  g25(.a(new_n29_), .b(new_n53_), .c(new_n34_), .O(new_n54_));
  inv1   g26(.a(new_n34_), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(x14), .c(new_n33_), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z4));
  inv1   g29(.a(x15), .O(new_n58_));
  nand2  g30(.a(new_n34_), .b(new_n58_), .O(new_n59_));
  nand4  g31(.a(x14), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(new_n61_));
  nand2  g33(.a(new_n55_), .b(x15), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n61_), .c(new_n59_), .O(new_n63_));
  oai21  g35(.a(new_n32_), .b(new_n58_), .c(new_n29_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n53_), .O(new_n65_));
  ...
  nand3  g41(.a(new_n69_), .b(new_n55_), .c(x15), .O(new_n70_));
  nand2  g42(.a(new_n62_), .b(new_n68_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n70_), .c(new_n33_), .O(new_n72_));
  oai21  g44(.a(new_n32_), .b(new_n68_), .c(new_n29_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n53_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(z6));
  nand2  g48(.a(new_n51_), .b(x06), .O(new_n77_));
  nand3  g49(.a(new_n29_), .b(x17), .c(new_n53_), .O(new_n78_));
  inv1   g50(.a(new_n35_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n55_), .c(x17), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  oai21  g53(.a(new_n35_), .b(new_n34_), .c(new_n81_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n80_), .c(x14), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n78_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n33_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n77_), .O(z7));
  nand2  g58(.a(new_n51_), .b(x07), .O(new_n87_));
  aoi21  g59(.a(new_n36_), .b(x17), .c(x18), .O(new_n88_));
  oai21  g60(.a(new_n80_), .b(new_n29_), .c(new_n61_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(z8));
endmodule
