...
module FAU ( 
  ...
  nand3  g23(.a(new_n51_), .b(new_n34_), .c(new_n43_), .O(new_n52_));
  ...
  nand3  g48(.a(new_n64_), .b(new_n54_), .c(new_n29_), .O(new_n77_));
