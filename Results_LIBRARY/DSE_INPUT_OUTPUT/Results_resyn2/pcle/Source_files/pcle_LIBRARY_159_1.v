...
module FAU ( 
  ...
  wire new_n29_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n78_, new_n79_, new_n80_, new_n82_, new_n83_, new_n84_;
  ...
  nand3  g08(.a(new_n36_), .b(new_n29_), .c(new_n34_), .O(new_n37_));
  oai21  g09(.a(new_n37_), .b(x11), .c(new_n33_), .O(z1));
  nor2   g10(.a(x12), .b(x11), .O(new_n39_));
  nand2  g11(.a(x12), .b(x11), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n36_), .O(new_n41_));
  oai21  g13(.a(new_n41_), .b(new_n39_), .c(new_n29_), .O(new_n42_));
  ...
  nand2  g19(.a(new_n47_), .b(new_n36_), .O(new_n48_));
  ...
  inv1   g25(.a(new_n37_), .O(new_n54_));
  ...
  nand2  g33(.a(x09), .b(new_n31_), .O(new_n62_));
  nand4  g34(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n63_));
  inv1   g35(.a(new_n63_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(x15), .c(new_n62_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n61_), .c(x18), .O(new_n66_));
  ...
  oai21  g42(.a(new_n63_), .b(new_n60_), .c(new_n70_), .O(new_n71_));
  nor2   g43(.a(new_n70_), .b(new_n60_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n64_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n71_), .c(new_n54_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n69_), .O(z6));
  nand2  g47(.a(new_n32_), .b(x06), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  nand2  g49(.a(new_n73_), .b(new_n77_), .O(new_n78_));
  nand3  g50(.a(new_n72_), .b(new_n64_), .c(x17), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n76_), .O(z7));
  oai21  g53(.a(new_n79_), .b(new_n62_), .c(new_n29_), .O(new_n82_));
