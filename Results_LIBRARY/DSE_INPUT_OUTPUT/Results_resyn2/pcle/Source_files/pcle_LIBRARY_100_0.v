...
module FAU ( 
  ...
  nor2   g31(.a(new_n34_), .b(new_n31_), .O(new_n60_));
  ...
  nor2   g35(.a(new_n40_), .b(new_n29_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(x05), .O(new_n65_));
  oai21  g37(.a(new_n33_), .b(new_n32_), .c(x16), .O(new_n66_));
  inv1   g38(.a(new_n33_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n52_), .c(x18), .d(new_n35_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n47_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n65_), .O(z6));
  nand2  g43(.a(new_n64_), .b(x06), .O(new_n72_));
  aoi21  g44(.a(x18), .b(new_n35_), .c(new_n36_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  nand3  g46(.a(new_n67_), .b(new_n52_), .c(x16), .O(new_n75_));
  ...
  nand2  g50(.a(new_n64_), .b(x07), .O(new_n79_));
  aoi21  g51(.a(new_n37_), .b(new_n34_), .c(x18), .O(new_n80_));
  nand2  g52(.a(new_n38_), .b(new_n47_), .O(new_n81_));
