...
module FAU ( 
  ...
  nand2  g17(.a(new_n29_), .b(new_n39_), .O(new_n46_));
  nand3  g18(.a(new_n46_), .b(new_n45_), .c(new_n40_), .O(new_n47_));
  inv1   g19(.a(x18), .O(new_n48_));
  nor2   g20(.a(new_n48_), .b(x12), .O(new_n49_));
  aoi21  g21(.a(x08), .b(x01), .c(new_n49_), .O(new_n50_));
  nand2  g22(.a(new_n50_), .b(new_n47_), .O(z2));
  inv1   g23(.a(x02), .O(new_n52_));
  nand2  g24(.a(new_n42_), .b(x08), .O(new_n53_));
  nand2  g25(.a(new_n42_), .b(new_n40_), .O(new_n54_));
  xor2a  g26(.a(new_n45_), .b(x13), .O(new_n55_));
  oai22  g27(.a(new_n55_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(z3));
  inv1   g28(.a(x14), .O(new_n57_));
  oai21  g29(.a(new_n32_), .b(new_n57_), .c(new_n48_), .O(new_n58_));
  ...
  nand3  g35(.a(new_n63_), .b(new_n62_), .c(new_n40_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n60_), .c(new_n59_), .O(z4));
  inv1   g37(.a(new_n53_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x04), .O(new_n67_));
  nor2   g39(.a(new_n49_), .b(new_n32_), .O(new_n68_));
  ...
  nand3  g56(.a(new_n84_), .b(new_n82_), .c(new_n68_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n81_), .O(z7));
  nand2  g58(.a(new_n66_), .b(x07), .O(new_n87_));
  oai21  g59(.a(new_n35_), .b(new_n33_), .c(new_n48_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n37_), .c(new_n40_), .d(x12), .O(new_n89_));
