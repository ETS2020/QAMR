...
module FAU ( 
  ...
  nor2   g07(.a(new_n29_), .b(x17), .O(new_n36_));
  ...
  nand2  g19(.a(new_n39_), .b(new_n47_), .O(new_n48_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n40_), .c(new_n30_), .O(new_n54_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n56_), .c(new_n36_), .O(z5));
  nand2  g35(.a(x08), .b(x05), .O(new_n64_));
  nand4  g36(.a(new_n58_), .b(new_n57_), .c(x16), .d(x15), .O(new_n65_));
  inv1   g37(.a(x16), .O(new_n66_));
  oai21  g38(.a(new_n30_), .b(new_n60_), .c(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n65_), .c(new_n40_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n64_), .c(new_n36_), .O(z6));
  nor2   g41(.a(new_n30_), .b(new_n60_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(x17), .c(x16), .O(new_n71_));
  ...
  nand3  g48(.a(new_n70_), .b(x18), .c(x16), .O(new_n77_));
  oai21  g49(.a(new_n31_), .b(new_n30_), .c(new_n29_), .O(new_n78_));
