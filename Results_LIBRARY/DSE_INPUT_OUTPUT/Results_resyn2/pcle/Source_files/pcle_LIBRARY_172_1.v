...
module FAU ( 
  ...
  nand2  g21(.a(new_n31_), .b(x08), .O(new_n50_));
  aoi21  g22(.a(x12), .b(x11), .c(x13), .O(new_n51_));
  nand2  g23(.a(new_n39_), .b(new_n32_), .O(new_n52_));
  oai22  g24(.a(new_n52_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(z3));
  ...
  oai22  g29(.a(new_n57_), .b(new_n55_), .c(new_n50_), .d(new_n54_), .O(z4));
  ...
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n39_), .O(new_n63_));
  aoi21  g35(.a(x08), .b(x04), .c(new_n30_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(z5));
  nor2   g37(.a(new_n30_), .b(new_n37_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x05), .O(new_n67_));
  inv1   g39(.a(x16), .O(new_n68_));
  nand2  g40(.a(new_n60_), .b(new_n68_), .O(new_n69_));
  nor2   g41(.a(new_n68_), .b(new_n61_), .O(new_n70_));
  nand2  g42(.a(new_n59_), .b(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n69_), .c(new_n39_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n67_), .O(z6));
  nand2  g45(.a(new_n66_), .b(x06), .O(new_n74_));
  nand3  g46(.a(new_n59_), .b(new_n70_), .c(x17), .O(new_n75_));
  ...
  nand2  g51(.a(new_n66_), .b(x07), .O(new_n80_));
  oai21  g52(.a(new_n34_), .b(new_n32_), .c(x18), .O(new_n81_));
  nor2   g53(.a(x18), .b(new_n76_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n59_), .c(new_n70_), .O(new_n83_));
