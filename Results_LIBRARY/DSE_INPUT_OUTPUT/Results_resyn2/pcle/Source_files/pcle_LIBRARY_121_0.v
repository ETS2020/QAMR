...
module FAU ( 
  ...
  nor2   g12(.a(x18), .b(x07), .O(new_n41_));
  ...
  nand2  g33(.a(new_n61_), .b(new_n45_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x04), .c(new_n41_), .O(new_n63_));
  oai21  g35(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(z5));
  nand2  g36(.a(new_n34_), .b(x16), .O(new_n65_));
  nand2  g37(.a(new_n61_), .b(new_n35_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n65_), .c(new_n45_), .O(new_n67_));
  aoi21  g39(.a(x08), .b(x05), .c(new_n41_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z6));
  nand2  g41(.a(x08), .b(x06), .O(new_n70_));
  nand3  g42(.a(x16), .b(x15), .c(x14), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n32_), .c(new_n36_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n38_), .c(new_n45_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n70_), .c(new_n41_), .O(z7));
  inv1   g46(.a(x18), .O(new_n75_));
  inv1   g47(.a(x09), .O(new_n76_));
  nor2   g48(.a(x10), .b(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n37_), .c(new_n34_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x07), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n75_), .O(new_n80_));
  inv1   g52(.a(new_n31_), .O(new_n81_));
  inv1   g53(.a(x07), .O(new_n82_));
  aoi21  g54(.a(x18), .b(new_n82_), .c(new_n29_), .O(new_n83_));
  aoi21  g55(.a(new_n38_), .b(new_n81_), .c(new_n83_), .O(new_n84_));
