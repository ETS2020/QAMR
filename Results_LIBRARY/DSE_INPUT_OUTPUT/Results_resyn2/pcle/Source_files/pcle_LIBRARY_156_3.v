...
module FAU ( 
  ...
  nand2  g22(.a(new_n44_), .b(new_n51_), .O(new_n52_));
  nand3  g23(.a(new_n52_), .b(new_n50_), .c(new_n37_), .O(new_n53_));
  aoi21  g24(.a(new_n53_), .b(new_n48_), .c(new_n31_), .O(z4));
  ...
  aoi21  g32(.a(new_n61_), .b(new_n55_), .c(new_n31_), .O(z5));
  nor2   g33(.a(new_n56_), .b(new_n59_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(x16), .O(new_n64_));
  inv1   g35(.a(x16), .O(new_n65_));
  oai21  g36(.a(new_n56_), .b(new_n59_), .c(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(new_n64_), .c(new_n37_), .O(new_n67_));
  aoi21  g38(.a(x08), .b(x05), .c(new_n31_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n67_), .O(z6));
  nand3  g40(.a(new_n30_), .b(x08), .c(x06), .O(new_n70_));
  inv1   g41(.a(x17), .O(new_n71_));
  nor2   g42(.a(x18), .b(new_n71_), .O(new_n72_));
  aoi21  g43(.a(new_n63_), .b(x16), .c(new_n72_), .O(new_n73_));
  nor2   g44(.a(new_n71_), .b(new_n65_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(new_n57_), .c(x15), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n37_), .O(new_n76_));
  oai21  g47(.a(new_n76_), .b(new_n73_), .c(new_n70_), .O(z7));
  nand3  g48(.a(new_n30_), .b(x08), .c(x07), .O(new_n78_));
  aoi21  g49(.a(new_n74_), .b(new_n63_), .c(x18), .O(new_n79_));
  nand2  g50(.a(new_n37_), .b(new_n30_), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(z8));
  zero   g52(.O(z0));
endmodule
