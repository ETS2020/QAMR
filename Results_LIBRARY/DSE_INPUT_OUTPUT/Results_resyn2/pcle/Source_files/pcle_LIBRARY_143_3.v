...
module FAU ( 
  ...
  aoi21  g12(.a(x10), .b(x09), .c(new_n32_), .O(new_n41_));
  nand2  g13(.a(new_n41_), .b(x01), .O(new_n42_));
  xnor2a g14(.a(x12), .b(x11), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(new_n34_), .c(new_n42_), .O(z2));
  nand2  g16(.a(new_n41_), .b(x02), .O(new_n45_));
  ...
  nand2  g21(.a(new_n41_), .b(x03), .O(new_n50_));
  ...
  nand2  g27(.a(new_n41_), .b(x04), .O(new_n56_));
  ...
  nand2  g32(.a(new_n41_), .b(x05), .O(new_n61_));
  ...
  nand4  g48(.a(new_n67_), .b(new_n51_), .c(new_n29_), .d(x17), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n76_), .c(x08), .O(new_n78_));
