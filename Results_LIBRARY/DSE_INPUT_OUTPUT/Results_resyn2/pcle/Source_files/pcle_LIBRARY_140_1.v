...
module FAU ( 
  ...
  nand3  g27(.a(new_n49_), .b(new_n43_), .c(x14), .O(new_n56_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n60_), .c(new_n43_), .d(x14), .O(new_n62_));
  ...
  nand4  g42(.a(new_n70_), .b(new_n67_), .c(new_n43_), .d(new_n34_), .O(new_n71_));
  ...
  nand3  g58(.a(new_n86_), .b(new_n43_), .c(x14), .O(new_n87_));
