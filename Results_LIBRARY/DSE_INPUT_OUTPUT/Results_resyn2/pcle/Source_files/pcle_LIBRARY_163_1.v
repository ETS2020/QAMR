...
module FAU ( 
  ...
  nor2   g33(.a(new_n34_), .b(new_n61_), .O(new_n62_));
  nand2  g34(.a(new_n34_), .b(new_n61_), .O(new_n63_));
  oai21  g35(.a(x18), .b(x08), .c(new_n60_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n63_), .c(new_n31_), .d(x09), .O(new_n65_));
  oai22  g37(.a(new_n65_), .b(new_n62_), .c(new_n30_), .d(new_n60_), .O(z5));
  ...
  oai21  g43(.a(new_n34_), .b(new_n61_), .c(new_n71_), .O(new_n72_));
  ...
  nand3  g47(.a(new_n69_), .b(new_n68_), .c(x17), .O(new_n76_));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n75_), .c(new_n39_), .O(z7));
  nor2   g52(.a(new_n29_), .b(new_n60_), .O(new_n81_));
  aoi21  g53(.a(new_n36_), .b(x17), .c(new_n81_), .O(new_n82_));
  nand4  g54(.a(new_n69_), .b(new_n68_), .c(x18), .d(x17), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n33_), .O(new_n84_));
  inv1   g56(.a(new_n39_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(x08), .c(x07), .O(new_n86_));
  oai21  g58(.a(new_n84_), .b(new_n82_), .c(new_n86_), .O(z8));
endmodule
