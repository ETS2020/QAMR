...
module FAU ( 
  ...
  inv1   g46(.a(new_n38_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x08), .c(x06), .O(new_n76_));
  aoi21  g48(.a(new_n34_), .b(new_n37_), .c(x17), .O(new_n77_));
  inv1   g49(.a(new_n33_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n65_), .c(x17), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n42_), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n77_), .c(new_n76_), .O(z7));
  nand3  g53(.a(new_n75_), .b(x08), .c(x07), .O(new_n82_));
  inv1   g54(.a(new_n31_), .O(new_n83_));
  oai21  g55(.a(new_n33_), .b(new_n32_), .c(new_n37_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n35_), .c(new_n83_), .O(new_n85_));
