...
module FAU ( 
  ...
  aoi21  g06(.a(new_n34_), .b(x04), .c(new_n29_), .O(z0));
  inv1   g07(.a(x00), .O(new_n36_));
  oai21  g08(.a(new_n29_), .b(x04), .c(x08), .O(new_n37_));
  nand3  g09(.a(new_n33_), .b(x09), .c(x04), .O(new_n38_));
  ...
  oai21  g15(.a(new_n43_), .b(new_n40_), .c(x04), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(x09), .O(new_n45_));
  nand2  g17(.a(x08), .b(x01), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n45_), .O(z2));
  nor2   g19(.a(new_n41_), .b(x13), .O(new_n48_));
  nand2  g20(.a(new_n41_), .b(x13), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n51_));
  ...
  aoi21  g27(.a(new_n41_), .b(x13), .c(x14), .O(new_n56_));
  inv1   g28(.a(new_n38_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n30_), .O(new_n58_));
  oai22  g30(.a(new_n58_), .b(new_n56_), .c(new_n37_), .d(new_n55_), .O(z4));
  inv1   g31(.a(x04), .O(new_n60_));
  and2   g32(.a(x14), .b(x13), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n41_), .c(x15), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  aoi21  g35(.a(new_n30_), .b(new_n63_), .c(x10), .O(new_n64_));
  ...
  nand4  g39(.a(new_n61_), .b(new_n41_), .c(x16), .d(x15), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  oai21  g41(.a(new_n30_), .b(new_n63_), .c(new_n69_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n68_), .c(new_n33_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x04), .O(new_n72_));
  ...
  aoi21  g49(.a(new_n68_), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n60_), .c(x09), .O(new_n79_));
  nand2  g51(.a(x08), .b(x06), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z7));
  inv1   g53(.a(x07), .O(new_n82_));
  nand2  g54(.a(new_n32_), .b(x18), .O(new_n83_));
  inv1   g55(.a(x18), .O(new_n84_));
  oai21  g56(.a(new_n31_), .b(new_n30_), .c(new_n84_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n83_), .c(new_n57_), .O(new_n86_));
  oai21  g58(.a(new_n37_), .b(new_n82_), .c(new_n86_), .O(z8));
endmodule
