...
module FAU ( 
  ...
  nand3  g08(.a(new_n36_), .b(new_n33_), .c(x15), .O(new_n37_));
  nor2   g09(.a(new_n37_), .b(new_n31_), .O(z0));
  nor2   g10(.a(new_n35_), .b(x15), .O(new_n39_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n32_), .c(new_n43_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n57_), .c(new_n39_), .O(z4));
  inv1   g33(.a(x15), .O(new_n62_));
  oai21  g34(.a(new_n32_), .b(new_n42_), .c(new_n35_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x04), .O(new_n65_));
  nand4  g37(.a(x15), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n66_));
  inv1   g38(.a(new_n66_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n32_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n65_), .c(new_n64_), .O(z5));
  inv1   g41(.a(x16), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(x15), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n33_), .O(new_n72_));
  nand2  g44(.a(new_n32_), .b(new_n70_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n43_), .O(new_n74_));
  nand2  g46(.a(new_n31_), .b(new_n35_), .O(new_n75_));
  ...
  nand2  g51(.a(x16), .b(x14), .O(new_n80_));
  inv1   g52(.a(new_n80_), .O(new_n81_));
  nand2  g53(.a(new_n34_), .b(x15), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(new_n83_));
  oai21  g55(.a(new_n80_), .b(new_n53_), .c(new_n34_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(new_n43_), .O(new_n85_));
  oai21  g57(.a(new_n42_), .b(new_n34_), .c(new_n35_), .O(new_n86_));
  ...
  nand3  g61(.a(new_n81_), .b(new_n36_), .c(new_n79_), .O(new_n90_));
  nand3  g62(.a(x17), .b(x16), .c(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n53_), .c(new_n35_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n90_), .c(new_n67_), .O(new_n93_));
  inv1   g65(.a(new_n39_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(x08), .c(x07), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n93_), .O(z8));
endmodule
