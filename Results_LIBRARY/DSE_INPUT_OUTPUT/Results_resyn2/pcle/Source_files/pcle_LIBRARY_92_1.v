...
module FAU ( 
  ...
  oai21  g41(.a(new_n34_), .b(new_n64_), .c(new_n69_), .O(new_n70_));
  ...
  nand3  g48(.a(new_n76_), .b(new_n74_), .c(new_n33_), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x06), .c(new_n39_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z7));
  aoi21  g51(.a(new_n36_), .b(x17), .c(x18), .O(new_n80_));
  inv1   g52(.a(new_n35_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n62_), .c(x18), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n33_), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x07), .c(new_n39_), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(new_n80_), .c(new_n84_), .O(z8));
endmodule
