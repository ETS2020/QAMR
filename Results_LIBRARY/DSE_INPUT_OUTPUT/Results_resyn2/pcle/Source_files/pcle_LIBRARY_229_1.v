...
module FAU ( 
  ...
  aoi21  g43(.a(new_n71_), .b(new_n67_), .c(new_n39_), .O(z6));
  aoi21  g44(.a(new_n36_), .b(x16), .c(x17), .O(new_n73_));
  inv1   g45(.a(new_n35_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n55_), .c(x17), .d(x16), .O(new_n75_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n29_), .O(new_n79_));
  nand3  g51(.a(new_n36_), .b(x18), .c(x16), .O(new_n80_));
