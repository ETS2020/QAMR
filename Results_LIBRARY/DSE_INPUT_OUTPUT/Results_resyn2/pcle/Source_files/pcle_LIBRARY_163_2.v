...
module FAU ( 
  ...
  nand3  g08(.a(new_n36_), .b(new_n35_), .c(x18), .O(new_n37_));
  oai22  g09(.a(new_n37_), .b(new_n33_), .c(x18), .d(new_n29_), .O(z0));
  ...
  nor2   g23(.a(new_n32_), .b(x13), .O(new_n52_));
  ...
  nand3  g35(.a(new_n57_), .b(x15), .c(x14), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand2  g37(.a(new_n59_), .b(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n43_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n63_), .c(new_n39_), .O(z5));
  nand2  g40(.a(x08), .b(x05), .O(new_n69_));
  nand2  g41(.a(x15), .b(x14), .O(new_n70_));
  nor2   g42(.a(new_n53_), .b(new_n70_), .O(new_n71_));
  nand3  g43(.a(x16), .b(x15), .c(x14), .O(new_n72_));
  inv1   g44(.a(new_n72_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n57_), .c(new_n42_), .O(new_n74_));
  oai21  g46(.a(new_n71_), .b(x16), .c(new_n74_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n69_), .c(new_n39_), .O(z6));
  inv1   g48(.a(x17), .O(new_n77_));
  oai21  g49(.a(new_n72_), .b(new_n53_), .c(new_n77_), .O(new_n78_));
  aoi21  g50(.a(new_n71_), .b(new_n36_), .c(new_n42_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x06), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n80_), .c(new_n39_), .O(z7));
  nand2  g54(.a(x08), .b(x07), .O(new_n83_));
  inv1   g55(.a(x18), .O(new_n84_));
  nand3  g56(.a(new_n36_), .b(new_n35_), .c(new_n84_), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n33_), .c(new_n83_), .O(new_n86_));
