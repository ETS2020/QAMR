...
module FAU ( 
  ...
  aoi21  g29(.a(new_n30_), .b(x14), .c(x15), .O(new_n58_));
  nand2  g30(.a(new_n44_), .b(new_n33_), .O(new_n59_));
  ...
  nand3  g34(.a(new_n32_), .b(new_n30_), .c(x16), .O(new_n63_));
  inv1   g35(.a(x16), .O(new_n64_));
  oai21  g36(.a(new_n31_), .b(new_n29_), .c(new_n64_), .O(new_n65_));
  ...
  nand2  g40(.a(new_n39_), .b(new_n68_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n32_), .c(new_n30_), .d(x16), .O(new_n70_));
  nand2  g42(.a(new_n63_), .b(new_n68_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n70_), .c(new_n44_), .O(new_n72_));
  inv1   g44(.a(new_n40_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x08), .c(x06), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n72_), .O(z7));
  nand2  g47(.a(new_n39_), .b(x17), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(new_n32_), .c(new_n30_), .d(x16), .O(new_n77_));
  nand2  g49(.a(new_n63_), .b(new_n39_), .O(new_n78_));
