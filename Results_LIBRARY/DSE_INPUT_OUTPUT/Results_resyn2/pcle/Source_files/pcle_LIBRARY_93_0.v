...
module FAU ( 
  ...
  nand3  g06(.a(new_n34_), .b(new_n30_), .c(x17), .O(new_n35_));
  aoi21  g07(.a(new_n35_), .b(x18), .c(x08), .O(z0));
  inv1   g08(.a(x08), .O(new_n37_));
  inv1   g09(.a(x10), .O(new_n38_));
  nand2  g10(.a(new_n38_), .b(x09), .O(new_n39_));
  oai21  g11(.a(new_n39_), .b(x11), .c(x18), .O(new_n40_));
  ...
  nand3  g25(.a(new_n30_), .b(x18), .c(new_n37_), .O(new_n54_));
  inv1   g26(.a(new_n54_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n53_), .c(new_n32_), .O(new_n56_));
  ...
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n55_), .O(new_n63_));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n59_), .c(new_n39_), .O(new_n69_));
  ...
  nand2  g52(.a(new_n34_), .b(x17), .O(new_n81_));
  nand2  g53(.a(new_n55_), .b(new_n81_), .O(new_n82_));
  nor2   g54(.a(new_n34_), .b(x17), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(z7));
