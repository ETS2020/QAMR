...
module FAU ( 
  ...
  nand3  g33(.a(new_n61_), .b(new_n59_), .c(new_n39_), .O(new_n62_));
  ...
  nor2   g38(.a(new_n65_), .b(new_n60_), .O(new_n67_));
  nand2  g39(.a(new_n58_), .b(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n39_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n64_), .O(z6));
  nand2  g42(.a(new_n44_), .b(x06), .O(new_n71_));
  nand3  g43(.a(new_n58_), .b(new_n67_), .c(x17), .O(new_n72_));
  ...
  nand3  g51(.a(new_n79_), .b(new_n58_), .c(new_n67_), .O(new_n80_));
