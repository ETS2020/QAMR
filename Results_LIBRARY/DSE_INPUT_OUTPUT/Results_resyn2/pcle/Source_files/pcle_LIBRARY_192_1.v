...
module FAU ( 
  ...
  nor2   g13(.a(new_n30_), .b(new_n37_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(x00), .O(new_n43_));
  oai21  g15(.a(new_n38_), .b(x11), .c(new_n43_), .O(z1));
  ...
  nand3  g23(.a(new_n51_), .b(new_n39_), .c(new_n32_), .O(new_n52_));
  ...
  nand2  g51(.a(new_n42_), .b(x07), .O(new_n80_));
  oai21  g52(.a(new_n34_), .b(new_n32_), .c(x18), .O(new_n81_));
  nor2   g53(.a(x18), .b(new_n76_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n61_), .c(new_n69_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n39_), .O(new_n85_));
