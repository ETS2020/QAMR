...
module FAU ( 
  ...
  nand2  g30(.a(new_n54_), .b(new_n58_), .O(new_n59_));
  ...
  oai21  g37(.a(new_n54_), .b(new_n58_), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g42(.a(new_n31_), .b(new_n54_), .c(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n32_), .b(new_n60_), .c(x17), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n71_), .c(new_n37_), .O(new_n73_));
