...
module FAU ( 
  ...
  nand2  g29(.a(new_n46_), .b(new_n57_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n34_), .c(new_n56_), .d(new_n30_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n54_), .c(new_n51_), .O(z3));
  ...
  nand4  g36(.a(new_n64_), .b(new_n62_), .c(new_n56_), .d(new_n30_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n61_), .c(new_n51_), .O(z4));
  inv1   g38(.a(x15), .O(new_n67_));
  nor2   g39(.a(new_n62_), .b(new_n67_), .O(new_n68_));
  nand2  g40(.a(new_n62_), .b(new_n67_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n56_), .c(new_n30_), .O(new_n70_));
  aoi22  g42(.a(new_n42_), .b(x17), .c(x08), .d(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n68_), .c(new_n71_), .O(z5));
  nand2  g44(.a(new_n37_), .b(new_n35_), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand2  g46(.a(x15), .b(x14), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n34_), .c(new_n74_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n73_), .c(new_n32_), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x05), .c(new_n51_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z6));
  nand3  g51(.a(new_n43_), .b(x08), .c(x06), .O(new_n80_));
  oai22  g52(.a(new_n36_), .b(new_n34_), .c(new_n42_), .d(new_n50_), .O(new_n81_));
