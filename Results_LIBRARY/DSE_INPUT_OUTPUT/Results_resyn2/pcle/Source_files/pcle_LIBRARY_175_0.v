...
module FAU ( 
  ...
  nand3  g07(.a(x17), .b(x16), .c(x13), .O(new_n36_));
  ...
  nand2  g23(.a(new_n30_), .b(x08), .O(new_n52_));
  nand2  g24(.a(new_n42_), .b(new_n30_), .O(new_n53_));
  ...
  oai22  g29(.a(new_n57_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(z3));
  ...
  nand3  g34(.a(new_n62_), .b(new_n42_), .c(new_n30_), .O(new_n63_));
  ...
  oai21  g42(.a(new_n33_), .b(new_n65_), .c(x18), .O(new_n71_));
  ...
  nand2  g47(.a(new_n60_), .b(new_n67_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  aoi21  g49(.a(new_n35_), .b(x16), .c(new_n33_), .O(new_n78_));
  ...
  oai21  g60(.a(new_n33_), .b(new_n85_), .c(x18), .O(new_n89_));
  ...
  aoi21  g65(.a(new_n37_), .b(new_n35_), .c(x18), .O(new_n94_));
  nand2  g66(.a(new_n38_), .b(new_n42_), .O(new_n95_));
  oai22  g67(.a(new_n95_), .b(new_n94_), .c(new_n52_), .d(new_n93_), .O(z8));
endmodule
