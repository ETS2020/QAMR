...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n79_, new_n80_;
  nor2   g00(.a(x07), .b(x02), .O(new_n29_));
  ...
  aoi21  g10(.a(x08), .b(x00), .c(new_n29_), .O(new_n39_));
  ...
  nand3  g16(.a(new_n44_), .b(new_n43_), .c(new_n41_), .O(new_n45_));
  aoi21  g17(.a(x08), .b(x01), .c(new_n29_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n45_), .O(z2));
  inv1   g19(.a(x07), .O(new_n48_));
  nand2  g20(.a(new_n31_), .b(x02), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(x02), .c(new_n49_), .O(new_n50_));
  nor2   g22(.a(new_n42_), .b(x13), .O(new_n51_));
  nand2  g23(.a(new_n42_), .b(x13), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n41_), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(new_n51_), .c(new_n50_), .O(z3));
  aoi21  g26(.a(new_n42_), .b(x13), .c(x14), .O(new_n55_));
  nand2  g27(.a(new_n34_), .b(new_n41_), .O(new_n56_));
  aoi21  g28(.a(x08), .b(x03), .c(new_n29_), .O(new_n57_));
  oai21  g29(.a(new_n56_), .b(new_n55_), .c(new_n57_), .O(z4));
  inv1   g30(.a(x15), .O(new_n59_));
  aoi21  g31(.a(new_n34_), .b(new_n59_), .c(new_n33_), .O(new_n60_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n42_), .c(x16), .d(x15), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  oai21  g39(.a(new_n34_), .b(new_n59_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n41_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n64_), .c(new_n29_), .O(z6));
  nand2  g42(.a(x08), .b(x06), .O(new_n71_));
  inv1   g43(.a(x17), .O(new_n72_));
  nand2  g44(.a(new_n66_), .b(new_n72_), .O(new_n73_));
  nor2   g45(.a(new_n36_), .b(new_n33_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n71_), .c(new_n29_), .O(z7));
  nor2   g48(.a(new_n36_), .b(x18), .O(new_n77_));
  nand2  g49(.a(new_n32_), .b(x09), .O(new_n78_));
  aoi21  g50(.a(new_n49_), .b(new_n48_), .c(new_n78_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n37_), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(new_n77_), .c(new_n31_), .d(new_n48_), .O(z8));
endmodule
