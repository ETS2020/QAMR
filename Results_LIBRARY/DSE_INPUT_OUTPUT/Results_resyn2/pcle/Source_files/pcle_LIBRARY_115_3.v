...
module FAU ( 
  ...
  nand2  g22(.a(new_n46_), .b(new_n29_), .O(new_n51_));
  ...
  nand2  g27(.a(new_n54_), .b(new_n46_), .O(new_n56_));
  xor2a  g28(.a(new_n29_), .b(x14), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(z4));
  nand3  g30(.a(new_n40_), .b(x08), .c(x04), .O(new_n59_));
  aoi21  g31(.a(new_n30_), .b(x14), .c(x15), .O(new_n60_));
  and2   g32(.a(x15), .b(x14), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n30_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n54_), .c(new_n46_), .O(new_n63_));
  ...
  nand3  g48(.a(new_n54_), .b(x08), .c(x07), .O(new_n77_));
