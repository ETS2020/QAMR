...
module FAU ( 
  ...
  aoi21  g13(.a(x10), .b(x09), .c(new_n29_), .O(new_n42_));
  ...
  nand2  g18(.a(new_n32_), .b(new_n29_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n46_), .c(new_n30_), .O(new_n48_));
  nand2  g20(.a(new_n48_), .b(x09), .O(new_n49_));
  nand2  g21(.a(x08), .b(x02), .O(new_n50_));
  nand2  g22(.a(new_n50_), .b(new_n49_), .O(z3));
  nand2  g23(.a(new_n42_), .b(x03), .O(new_n52_));
  ...
  nand2  g37(.a(new_n42_), .b(x05), .O(new_n66_));
