...
module FAU ( 
  ...
  nor2   g00(.a(x18), .b(x00), .O(new_n29_));
  ...
  nand2  g26(.a(new_n31_), .b(new_n54_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n53_), .c(new_n47_), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n51_), .c(new_n29_), .O(z4));
  ...
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n47_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n58_), .c(new_n29_), .O(z5));
  ...
  oai21  g40(.a(new_n68_), .b(new_n31_), .c(new_n67_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n47_), .c(new_n66_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x05), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n29_), .O(z6));
  nand3  g44(.a(new_n65_), .b(new_n52_), .c(x17), .O(new_n73_));
  inv1   g45(.a(x17), .O(new_n74_));
  nand2  g46(.a(new_n66_), .b(new_n74_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n73_), .c(new_n47_), .O(new_n76_));
  aoi21  g48(.a(x08), .b(x06), .c(new_n29_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z7));
  inv1   g50(.a(x00), .O(new_n79_));
  aoi21  g51(.a(new_n37_), .b(new_n33_), .c(new_n79_), .O(new_n80_));
  and2   g52(.a(x08), .b(x07), .O(new_n81_));
  nand4  g53(.a(x18), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n82_));
  inv1   g54(.a(new_n82_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n73_), .c(new_n81_), .O(new_n84_));
  oai21  g56(.a(new_n80_), .b(x18), .c(new_n84_), .O(z8));
endmodule
