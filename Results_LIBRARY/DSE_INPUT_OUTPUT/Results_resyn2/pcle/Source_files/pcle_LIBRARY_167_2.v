...
module FAU ( 
  ...
  oai21  g42(.a(new_n55_), .b(new_n60_), .c(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n69_), .c(new_n33_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n66_), .c(new_n39_), .O(z6));
  inv1   g45(.a(new_n39_), .O(new_n74_));
  ...
  nand3  g52(.a(new_n74_), .b(x08), .c(x07), .O(new_n81_));
  nand3  g53(.a(new_n78_), .b(new_n33_), .c(x18), .O(new_n82_));
