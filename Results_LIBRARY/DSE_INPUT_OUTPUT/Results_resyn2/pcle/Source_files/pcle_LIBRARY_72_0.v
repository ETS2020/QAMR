...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(new_n39_), .c(new_n30_), .O(new_n49_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n57_), .c(new_n36_), .O(z5));
  ...
  nor2   g42(.a(new_n54_), .b(new_n70_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n39_), .c(new_n29_), .O(new_n72_));
  inv1   g44(.a(new_n47_), .O(new_n73_));
  inv1   g45(.a(new_n70_), .O(new_n74_));
  and2   g46(.a(x14), .b(x13), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(new_n76_));
  and2   g48(.a(x08), .b(x06), .O(new_n77_));
  nand4  g49(.a(x17), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n78_));
  inv1   g50(.a(new_n78_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n76_), .c(new_n77_), .O(new_n80_));
  oai21  g52(.a(new_n72_), .b(x17), .c(new_n80_), .O(z7));
  oai21  g53(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nor2   g55(.a(x18), .b(new_n83_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n58_), .c(new_n74_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n39_), .O(new_n87_));
  inv1   g59(.a(new_n36_), .O(new_n88_));
