...
module FAU ( 
  ...
  aoi21  g29(.a(new_n52_), .b(x14), .c(x15), .O(new_n58_));
  inv1   g30(.a(new_n35_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n52_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n33_), .O(new_n61_));
  aoi21  g33(.a(x08), .b(x04), .c(new_n39_), .O(new_n62_));
  oai21  g34(.a(new_n61_), .b(new_n58_), .c(new_n62_), .O(z5));
  nand2  g35(.a(x08), .b(x05), .O(new_n64_));
  nand3  g36(.a(new_n59_), .b(new_n52_), .c(x16), .O(new_n65_));
  ...
  aoi21  g43(.a(new_n36_), .b(x16), .c(new_n71_), .O(new_n72_));
  nand4  g44(.a(new_n59_), .b(new_n52_), .c(x17), .d(x16), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n33_), .O(new_n74_));
  inv1   g46(.a(new_n39_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x08), .c(x06), .O(new_n76_));
  oai21  g48(.a(new_n74_), .b(new_n72_), .c(new_n76_), .O(z7));
  aoi21  g49(.a(x08), .b(x07), .c(new_n39_), .O(new_n78_));
  oai21  g50(.a(new_n74_), .b(new_n70_), .c(new_n78_), .O(z8));
endmodule
