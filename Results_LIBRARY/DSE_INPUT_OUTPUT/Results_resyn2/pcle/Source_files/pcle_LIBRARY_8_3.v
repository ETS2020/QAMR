...
module FAU ( 
  ...
  nand3  g13(.a(new_n41_), .b(new_n39_), .c(new_n35_), .O(new_n42_));
  aoi21  g14(.a(new_n42_), .b(new_n38_), .c(z0), .O(z2));
  ...
  nand3  g19(.a(new_n47_), .b(new_n46_), .c(new_n35_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n44_), .c(z0), .O(z3));
  ...
  nand3  g25(.a(new_n53_), .b(new_n51_), .c(new_n35_), .O(new_n54_));
  ...
  oai21  g35(.a(new_n51_), .b(new_n59_), .c(new_n63_), .O(new_n64_));
  nand2  g36(.a(x16), .b(x15), .O(new_n65_));
  inv1   g37(.a(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n57_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n64_), .c(new_n35_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x05), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(z0), .O(z6));
  inv1   g42(.a(x17), .O(new_n71_));
  oai21  g43(.a(new_n65_), .b(new_n51_), .c(new_n71_), .O(new_n72_));
  nor2   g44(.a(new_n65_), .b(new_n51_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x17), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n72_), .c(new_n35_), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x06), .c(z0), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z7));
  aoi21  g49(.a(new_n73_), .b(x17), .c(x18), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x07), .c(z0), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n34_), .c(new_n79_), .O(z8));
endmodule
