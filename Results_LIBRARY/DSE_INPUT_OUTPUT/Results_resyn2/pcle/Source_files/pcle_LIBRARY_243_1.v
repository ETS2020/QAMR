...
module FAU ( 
  ...
  nand2  g12(.a(new_n40_), .b(new_n36_), .O(new_n41_));
  nor2   g13(.a(new_n41_), .b(new_n33_), .O(z0));
  nor2   g14(.a(new_n35_), .b(x00), .O(new_n43_));
  aoi21  g15(.a(x08), .b(x00), .c(new_n43_), .O(new_n44_));
  oai21  g16(.a(new_n39_), .b(x11), .c(new_n44_), .O(z1));
  nand2  g17(.a(x08), .b(x01), .O(new_n46_));
  nand2  g18(.a(x12), .b(x11), .O(new_n47_));
  or2    g19(.a(x12), .b(x11), .O(new_n48_));
  nand3  g20(.a(new_n48_), .b(new_n40_), .c(new_n47_), .O(new_n49_));
  aoi21  g21(.a(new_n49_), .b(new_n46_), .c(new_n43_), .O(z2));
  ...
  nand3  g30(.a(new_n58_), .b(new_n40_), .c(new_n29_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(new_n43_), .O(z4));
  inv1   g32(.a(x15), .O(new_n61_));
  nor2   g33(.a(new_n29_), .b(new_n61_), .O(new_n62_));
  oai21  g34(.a(new_n30_), .b(x15), .c(new_n40_), .O(new_n63_));
  aoi21  g35(.a(x08), .b(x04), .c(new_n43_), .O(new_n64_));
  ...
  nand3  g41(.a(new_n69_), .b(new_n40_), .c(new_n67_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n66_), .c(new_n43_), .O(z6));
  nand2  g43(.a(x08), .b(x06), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  oai21  g45(.a(new_n31_), .b(new_n29_), .c(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n40_), .c(new_n33_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n72_), .c(new_n43_), .O(z7));
  nor2   g48(.a(new_n31_), .b(new_n29_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(x17), .c(new_n36_), .O(new_n78_));
  nand4  g50(.a(new_n32_), .b(new_n30_), .c(x18), .d(x17), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n40_), .O(new_n80_));
  inv1   g52(.a(new_n43_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x08), .c(x07), .O(new_n82_));
  oai21  g54(.a(new_n80_), .b(new_n78_), .c(new_n82_), .O(z8));
endmodule
