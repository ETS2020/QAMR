...
module FAU ( 
  ...
  nor2   g14(.a(x18), .b(new_n42_), .O(new_n43_));
  nand2  g15(.a(x08), .b(x00), .O(new_n44_));
  inv1   g16(.a(x11), .O(new_n45_));
  nand3  g17(.a(new_n30_), .b(x09), .c(new_n29_), .O(new_n46_));
  inv1   g18(.a(new_n46_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n44_), .c(new_n43_), .O(z1));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n50_), .c(new_n43_), .O(z2));
  nand2  g27(.a(x08), .b(x02), .O(new_n56_));
  inv1   g28(.a(x13), .O(new_n57_));
  nand2  g29(.a(new_n51_), .b(new_n57_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n35_), .c(new_n47_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(new_n43_), .O(z3));
  nand4  g32(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n61_));
  nand2  g33(.a(new_n35_), .b(new_n37_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(new_n63_));
  aoi21  g35(.a(x08), .b(x03), .c(new_n43_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(z4));
  nor2   g37(.a(new_n61_), .b(new_n38_), .O(new_n66_));
  inv1   g38(.a(new_n61_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(x15), .c(new_n47_), .O(new_n68_));
  aoi21  g40(.a(x08), .b(x04), .c(new_n43_), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n66_), .c(new_n69_), .O(z5));
  inv1   g42(.a(x18), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(x08), .c(x05), .O(new_n72_));
  nand3  g44(.a(new_n39_), .b(new_n36_), .c(x16), .O(new_n73_));
  nand2  g45(.a(new_n39_), .b(new_n36_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n73_), .c(new_n47_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n72_), .O(z6));
  nor2   g49(.a(x17), .b(x16), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n34_), .c(new_n66_), .O(new_n79_));
  nand2  g51(.a(new_n74_), .b(new_n33_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(new_n47_), .O(new_n81_));
  aoi21  g53(.a(x08), .b(x06), .c(new_n43_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n81_), .O(z7));
  nand3  g55(.a(x17), .b(x16), .c(x15), .O(new_n84_));
  nor2   g56(.a(new_n84_), .b(new_n46_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n67_), .c(x05), .O(new_n86_));
  inv1   g58(.a(new_n31_), .O(new_n87_));
  and2   g59(.a(x08), .b(x07), .O(new_n88_));
  aoi21  g60(.a(new_n40_), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  oai21  g61(.a(new_n86_), .b(x18), .c(new_n89_), .O(z8));
endmodule
