...
module FAU ( 
  ...
  nand3  g33(.a(new_n61_), .b(x15), .c(x14), .O(new_n62_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n68_), .c(new_n74_), .O(new_n77_));
  oai21  g49(.a(new_n37_), .b(x17), .c(new_n77_), .O(z7));
  nand2  g50(.a(new_n40_), .b(new_n68_), .O(new_n79_));
  nand2  g51(.a(new_n36_), .b(x18), .O(new_n80_));
