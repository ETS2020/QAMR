...
module FAU ( 
  ...
  nand2  g07(.a(x10), .b(x07), .O(new_n36_));
  ...
  aoi21  g17(.a(x08), .b(x02), .c(new_n37_), .O(new_n46_));
  ...
  aoi21  g23(.a(x08), .b(x03), .c(new_n37_), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n49_), .c(new_n52_), .O(z4));
  nand3  g25(.a(new_n36_), .b(x08), .c(x04), .O(new_n54_));
