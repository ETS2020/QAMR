...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(new_n29_), .c(x10), .O(new_n40_));
  ...
  aoi21  g17(.a(new_n45_), .b(new_n44_), .c(x10), .O(new_n46_));
  ...
  oai21  g32(.a(new_n59_), .b(new_n38_), .c(new_n60_), .O(z4));
  aoi21  g33(.a(x10), .b(x09), .c(new_n29_), .O(new_n62_));
