...
module FAU ( 
  ...
  nand3  g24(.a(new_n52_), .b(x08), .c(x03), .O(new_n53_));
  inv1   g25(.a(x14), .O(new_n54_));
  aoi21  g26(.a(new_n29_), .b(new_n54_), .c(new_n34_), .O(new_n55_));
  inv1   g27(.a(new_n34_), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(x14), .c(new_n33_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(z4));
  nand3  g30(.a(new_n52_), .b(x08), .c(x04), .O(new_n59_));
  nand3  g31(.a(new_n29_), .b(x15), .c(new_n54_), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(new_n61_));
  nand2  g33(.a(new_n56_), .b(x15), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  aoi21  g35(.a(new_n34_), .b(new_n63_), .c(new_n54_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n61_), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n32_), .c(new_n59_), .O(z5));
  inv1   g38(.a(x16), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n56_), .c(x15), .O(new_n69_));
  nand2  g41(.a(new_n62_), .b(new_n67_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n69_), .c(new_n33_), .O(new_n71_));
  oai21  g43(.a(new_n32_), .b(new_n67_), .c(new_n29_), .O(new_n72_));
  ...
  inv1   g47(.a(new_n35_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n56_), .c(x17), .O(new_n77_));
  inv1   g49(.a(x17), .O(new_n78_));
  nand3  g50(.a(new_n76_), .b(new_n56_), .c(x14), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n77_), .c(new_n33_), .O(new_n81_));
  oai21  g53(.a(new_n32_), .b(new_n78_), .c(new_n29_), .O(new_n82_));
  and2   g54(.a(x08), .b(x06), .O(new_n83_));
  aoi21  g55(.a(new_n82_), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n81_), .O(z7));
  nand2  g57(.a(new_n29_), .b(x14), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n36_), .c(x17), .O(new_n87_));
  nand2  g59(.a(new_n77_), .b(new_n29_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n33_), .O(new_n89_));
