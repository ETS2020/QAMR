...
module FAU ( 
  ...
  nand2  g14(.a(new_n30_), .b(new_n32_), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(new_n42_), .c(x09), .O(new_n44_));
  ...
  oai21  g24(.a(new_n52_), .b(new_n48_), .c(new_n33_), .O(new_n53_));
  ...
  oai21  g31(.a(new_n37_), .b(new_n56_), .c(new_n59_), .O(z5));
  ...
  oai21  g55(.a(new_n83_), .b(new_n48_), .c(new_n33_), .O(new_n84_));
