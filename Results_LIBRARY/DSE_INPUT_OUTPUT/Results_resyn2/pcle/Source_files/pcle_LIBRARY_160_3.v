...
module FAU ( 
  ...
  nor2   g22(.a(new_n32_), .b(new_n35_), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(x03), .O(new_n53_));
  nand3  g24(.a(x14), .b(x12), .c(x11), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(new_n31_), .c(new_n30_), .O(new_n55_));
  inv1   g26(.a(new_n48_), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(x14), .c(new_n38_), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(z4));
  nand2  g29(.a(new_n52_), .b(x04), .O(new_n59_));
  inv1   g30(.a(new_n54_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x15), .c(x13), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n38_), .O(new_n62_));
  nand4  g33(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  oai22  g35(.a(new_n64_), .b(x15), .c(new_n31_), .d(new_n30_), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n62_), .c(new_n59_), .O(z5));
  nand2  g37(.a(new_n60_), .b(x15), .O(new_n67_));
  inv1   g38(.a(x16), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n36_), .c(x09), .d(new_n35_), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n67_), .c(new_n31_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(x13), .O(new_n71_));
  nand3  g42(.a(new_n61_), .b(new_n38_), .c(x16), .O(new_n72_));
  nand2  g43(.a(x08), .b(x05), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z6));
  nand2  g45(.a(new_n52_), .b(x06), .O(new_n75_));
  inv1   g46(.a(x17), .O(new_n76_));
  nand2  g47(.a(x16), .b(x15), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n54_), .c(new_n31_), .O(new_n78_));
  aoi21  g49(.a(new_n78_), .b(x13), .c(new_n76_), .O(new_n79_));
  nand4  g50(.a(new_n31_), .b(new_n76_), .c(x16), .d(x15), .O(new_n80_));
  nor2   g51(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  oai21  g52(.a(new_n81_), .b(new_n79_), .c(new_n38_), .O(new_n82_));
  nand2  g53(.a(new_n82_), .b(new_n75_), .O(z7));
  nand2  g54(.a(new_n52_), .b(x07), .O(new_n84_));
  nand4  g55(.a(new_n31_), .b(x17), .c(x16), .d(x15), .O(new_n85_));
  oai22  g56(.a(new_n85_), .b(new_n63_), .c(new_n31_), .d(x13), .O(new_n86_));
  nand2  g57(.a(new_n86_), .b(new_n38_), .O(new_n87_));
  nand2  g58(.a(new_n87_), .b(new_n84_), .O(z8));
  zero   g59(.O(z0));
endmodule
