...
module FAU ( 
  ...
  nand3  g09(.a(new_n37_), .b(x18), .c(x01), .O(new_n38_));
  nor2   g10(.a(new_n38_), .b(new_n33_), .O(z0));
  inv1   g11(.a(x18), .O(new_n40_));
  nor2   g12(.a(new_n40_), .b(x01), .O(new_n41_));
  ...
  aoi21  g49(.a(new_n32_), .b(new_n30_), .c(new_n36_), .O(new_n78_));
  ...
  nand2  g53(.a(new_n33_), .b(new_n40_), .O(new_n82_));
