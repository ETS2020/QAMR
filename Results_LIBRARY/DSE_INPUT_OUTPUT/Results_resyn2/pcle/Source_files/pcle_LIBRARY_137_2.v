...
module FAU ( 
  ...
  oai21  g25(.a(new_n34_), .b(new_n53_), .c(new_n33_), .O(new_n54_));
  ...
  nand2  g29(.a(new_n37_), .b(new_n35_), .O(new_n58_));
  inv1   g30(.a(x15), .O(new_n59_));
  oai21  g31(.a(new_n34_), .b(new_n53_), .c(new_n59_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(new_n33_), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n57_), .c(new_n40_), .O(z5));
  nand2  g34(.a(x08), .b(x05), .O(new_n63_));
  nand3  g35(.a(new_n37_), .b(new_n35_), .c(x16), .O(new_n64_));
  inv1   g36(.a(x16), .O(new_n65_));
  oai21  g37(.a(new_n36_), .b(new_n34_), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n33_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n63_), .c(new_n40_), .O(z6));
  xor2a  g40(.a(new_n64_), .b(x17), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x06), .c(new_n40_), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(new_n32_), .c(new_n70_), .O(z7));
  inv1   g43(.a(x18), .O(new_n72_));
  nor2   g44(.a(new_n72_), .b(x17), .O(new_n73_));
  aoi21  g45(.a(new_n64_), .b(x17), .c(new_n73_), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x07), .c(new_n40_), .O(new_n75_));
