...
module FAU ( 
  ...
  nand3  g15(.a(new_n43_), .b(new_n41_), .c(new_n38_), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(new_n40_), .O(z1));
  nand2  g17(.a(new_n39_), .b(x01), .O(new_n46_));
  nand2  g18(.a(x18), .b(new_n38_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n43_), .O(new_n48_));
  xnor2a g20(.a(x12), .b(x11), .O(new_n49_));
  oai21  g21(.a(new_n49_), .b(new_n48_), .c(new_n46_), .O(z2));
  nand2  g22(.a(new_n39_), .b(x02), .O(new_n51_));
  nand2  g23(.a(x12), .b(x11), .O(new_n52_));
  xor2a  g24(.a(new_n52_), .b(x13), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(new_n48_), .c(new_n51_), .O(z3));
  inv1   g26(.a(x14), .O(new_n55_));
  oai21  g27(.a(new_n42_), .b(new_n55_), .c(new_n41_), .O(new_n56_));
  ...
  nand3  g33(.a(new_n61_), .b(new_n60_), .c(new_n43_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n58_), .c(new_n57_), .O(z4));
  inv1   g35(.a(x15), .O(new_n64_));
  oai21  g36(.a(new_n42_), .b(new_n64_), .c(new_n41_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n38_), .O(new_n66_));
  nand2  g38(.a(new_n61_), .b(x15), .O(new_n67_));
  nand2  g39(.a(new_n64_), .b(x14), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n59_), .c(new_n67_), .O(new_n69_));
  ...
  nand2  g44(.a(new_n39_), .b(x05), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand2  g46(.a(x15), .b(x14), .O(new_n75_));
  oai21  g47(.a(new_n59_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  inv1   g48(.a(new_n59_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n33_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n76_), .c(new_n47_), .d(new_n43_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n73_), .O(z6));
  nand2  g52(.a(new_n35_), .b(new_n33_), .O(new_n81_));
  inv1   g53(.a(x17), .O(new_n82_));
  oai21  g54(.a(new_n59_), .b(new_n32_), .c(new_n82_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n81_), .c(new_n43_), .O(new_n84_));
  oai21  g56(.a(new_n42_), .b(new_n82_), .c(new_n41_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n38_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z7));
  nand2  g60(.a(new_n39_), .b(x07), .O(new_n89_));
  inv1   g61(.a(new_n31_), .O(new_n90_));
  oai21  g62(.a(new_n34_), .b(new_n32_), .c(new_n41_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n36_), .c(new_n90_), .O(new_n92_));
