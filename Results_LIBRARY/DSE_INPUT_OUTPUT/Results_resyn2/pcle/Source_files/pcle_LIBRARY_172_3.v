...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x00), .O(new_n29_));
  ...
  oai21  g11(.a(new_n39_), .b(new_n34_), .c(new_n29_), .O(z0));
  oai21  g12(.a(x10), .b(x08), .c(x00), .O(new_n41_));
  ...
  oai21  g17(.a(new_n43_), .b(new_n37_), .c(new_n45_), .O(z2));
  nor2   g18(.a(new_n44_), .b(new_n35_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(x02), .O(new_n48_));
  aoi21  g20(.a(x12), .b(x11), .c(x13), .O(new_n49_));
  nand2  g21(.a(new_n38_), .b(new_n30_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(z3));
  nand2  g23(.a(new_n47_), .b(x03), .O(new_n52_));
  nor2   g24(.a(new_n31_), .b(x14), .O(new_n53_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(new_n38_), .O(new_n61_));
  aoi21  g33(.a(x08), .b(x04), .c(new_n44_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z5));
  nand2  g35(.a(new_n47_), .b(x05), .O(new_n64_));
  inv1   g36(.a(x16), .O(new_n65_));
  nand2  g37(.a(new_n58_), .b(new_n65_), .O(new_n66_));
  nor2   g38(.a(new_n65_), .b(new_n59_), .O(new_n67_));
  nand2  g39(.a(new_n57_), .b(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n38_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n64_), .O(z6));
  nand2  g42(.a(new_n47_), .b(x06), .O(new_n71_));
  nand3  g43(.a(new_n57_), .b(new_n67_), .c(x17), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  nand2  g45(.a(new_n68_), .b(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n72_), .c(new_n38_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n71_), .O(z7));
  nand2  g48(.a(new_n47_), .b(x07), .O(new_n77_));
  oai21  g49(.a(new_n32_), .b(new_n30_), .c(x18), .O(new_n78_));
  nor2   g50(.a(x18), .b(new_n73_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n57_), .c(new_n67_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n38_), .O(new_n82_));
