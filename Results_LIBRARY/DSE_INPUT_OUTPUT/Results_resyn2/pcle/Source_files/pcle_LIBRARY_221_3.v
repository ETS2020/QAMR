...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n51_), .c(new_n36_), .O(new_n54_));
  ...
  nor2   g34(.a(new_n51_), .b(new_n59_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x16), .O(new_n64_));
  inv1   g36(.a(x16), .O(new_n65_));
  oai21  g37(.a(new_n51_), .b(new_n59_), .c(new_n65_), .O(new_n66_));
  ...
  nand2  g51(.a(new_n36_), .b(new_n29_), .O(new_n80_));
