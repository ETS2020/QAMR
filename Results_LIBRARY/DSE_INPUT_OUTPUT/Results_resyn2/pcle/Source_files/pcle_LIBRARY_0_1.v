...
module FAU ( 
  ...
  and2   g03(.a(x18), .b(x03), .O(new_n32_));
  nand3  g04(.a(new_n32_), .b(new_n31_), .c(x17), .O(new_n33_));
  ...
  nor2   g11(.a(new_n39_), .b(x03), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n52_), .c(new_n40_), .O(z3));
  inv1   g29(.a(x14), .O(new_n58_));
  aoi21  g30(.a(new_n55_), .b(new_n58_), .c(new_n37_), .O(new_n59_));
  oai21  g31(.a(new_n55_), .b(new_n58_), .c(new_n59_), .O(new_n60_));
  ...
  nand2  g37(.a(new_n34_), .b(new_n29_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n65_), .c(new_n43_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n63_), .c(new_n40_), .O(z5));
  nand3  g40(.a(new_n64_), .b(x16), .c(x15), .O(new_n69_));
  nand2  g41(.a(new_n65_), .b(new_n30_), .O(new_n70_));
  ...
  nand3  g45(.a(new_n64_), .b(new_n31_), .c(x17), .O(new_n74_));
  inv1   g46(.a(x17), .O(new_n75_));
  nand2  g47(.a(new_n64_), .b(new_n31_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n74_), .c(new_n43_), .O(new_n78_));
  ...
  oai21  g53(.a(new_n81_), .b(new_n55_), .c(new_n32_), .O(new_n82_));
  nor2   g54(.a(x18), .b(new_n75_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n64_), .c(new_n31_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n43_), .O(new_n86_));
  inv1   g58(.a(new_n40_), .O(new_n87_));
