...
module FAU ( 
  ...
  nand3  g38(.a(new_n61_), .b(new_n54_), .c(x16), .O(new_n67_));
  nand2  g39(.a(new_n62_), .b(new_n35_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n67_), .c(new_n43_), .O(new_n69_));
  ...
  nand2  g45(.a(x18), .b(new_n36_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n34_), .c(x16), .O(new_n75_));
  nand2  g47(.a(new_n67_), .b(new_n36_), .O(new_n76_));
  ...
  nand2  g52(.a(new_n38_), .b(new_n43_), .O(new_n81_));
