...
module FAU ( 
  ...
  aoi21  g17(.a(new_n45_), .b(new_n32_), .c(new_n42_), .O(z2));
  ...
  inv1   g22(.a(new_n29_), .O(new_n51_));
  ...
  aoi21  g26(.a(x08), .b(x03), .c(new_n36_), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(z4));
  inv1   g28(.a(x15), .O(new_n57_));
  nand2  g29(.a(new_n53_), .b(new_n57_), .O(new_n58_));
  inv1   g30(.a(new_n53_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(x15), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(new_n35_), .O(new_n61_));
  aoi21  g33(.a(x08), .b(x04), .c(new_n36_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z5));
  inv1   g35(.a(x16), .O(new_n64_));
  nand2  g36(.a(new_n60_), .b(new_n64_), .O(new_n65_));
  nor2   g37(.a(new_n64_), .b(new_n57_), .O(new_n66_));
  nand2  g38(.a(new_n59_), .b(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n65_), .c(new_n35_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x05), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(new_n36_), .O(z6));
  inv1   g42(.a(x17), .O(new_n71_));
  nor2   g43(.a(new_n67_), .b(new_n71_), .O(new_n72_));
  nand2  g44(.a(new_n67_), .b(new_n71_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n35_), .O(new_n74_));
  ...
  nor2   g49(.a(x18), .b(new_n71_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n59_), .c(new_n66_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n35_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x07), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n81_), .c(new_n36_), .O(z8));
endmodule
