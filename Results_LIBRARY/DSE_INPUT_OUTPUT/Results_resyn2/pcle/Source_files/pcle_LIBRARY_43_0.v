...
module FAU ( 
  ...
  nor2   g13(.a(new_n29_), .b(new_n36_), .O(new_n42_));
  ...
  nor2   g37(.a(new_n64_), .b(new_n59_), .O(new_n66_));
  nand2  g38(.a(new_n57_), .b(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n65_), .c(new_n39_), .O(new_n68_));
  aoi21  g40(.a(x08), .b(x05), .c(new_n29_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z6));
  nand2  g42(.a(new_n42_), .b(x06), .O(new_n71_));
  nand3  g43(.a(new_n57_), .b(new_n66_), .c(x17), .O(new_n72_));
  ...
  nand2  g48(.a(new_n42_), .b(x07), .O(new_n77_));
  oai21  g49(.a(new_n33_), .b(new_n31_), .c(x18), .O(new_n78_));
  nor2   g50(.a(x18), .b(new_n73_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n57_), .c(new_n66_), .O(new_n80_));
