...
module FAU ( 
  ...
  nand2  g11(.a(x18), .b(x04), .O(new_n40_));
  ...
  nand2  g22(.a(new_n50_), .b(new_n34_), .O(new_n51_));
  ...
  nand4  g35(.a(new_n40_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n64_));
  ...
  nand2  g41(.a(new_n69_), .b(new_n60_), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  oai21  g43(.a(new_n35_), .b(new_n62_), .c(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n34_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n68_), .c(new_n41_), .O(z6));
  nand2  g46(.a(x08), .b(x06), .O(new_n75_));
  nand3  g47(.a(new_n69_), .b(new_n60_), .c(x17), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  oai21  g49(.a(new_n36_), .b(new_n35_), .c(new_n77_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n76_), .c(new_n34_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n75_), .c(new_n41_), .O(z7));
  aoi21  g52(.a(new_n37_), .b(x17), .c(x18), .O(new_n81_));
  nand4  g53(.a(new_n69_), .b(new_n60_), .c(x18), .d(x17), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n65_), .O(new_n83_));
  nand3  g55(.a(new_n40_), .b(x08), .c(x07), .O(new_n84_));
