...
module FAU ( 
  ...
  oai21  g12(.a(new_n40_), .b(new_n35_), .c(new_n29_), .O(z0));
  ...
  oai21  g18(.a(x08), .b(x00), .c(x01), .O(new_n47_));
  ...
  aoi21  g23(.a(x08), .b(x02), .c(new_n42_), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(z3));
  nor2   g25(.a(new_n31_), .b(x14), .O(new_n54_));
  inv1   g26(.a(x14), .O(new_n55_));
  oai21  g27(.a(new_n30_), .b(new_n55_), .c(new_n39_), .O(new_n56_));
  aoi21  g28(.a(x08), .b(x03), .c(new_n42_), .O(new_n57_));
  oai21  g29(.a(new_n56_), .b(new_n54_), .c(new_n57_), .O(z4));
  nand2  g30(.a(x08), .b(x04), .O(new_n59_));
  nand2  g31(.a(new_n33_), .b(new_n31_), .O(new_n60_));
  inv1   g32(.a(x15), .O(new_n61_));
  oai21  g33(.a(new_n30_), .b(new_n55_), .c(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n39_), .c(new_n60_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n59_), .c(new_n42_), .O(z5));
  nand2  g36(.a(x08), .b(x05), .O(new_n65_));
  nand3  g37(.a(new_n33_), .b(new_n31_), .c(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  oai21  g39(.a(new_n32_), .b(new_n30_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n39_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n65_), .c(new_n42_), .O(z6));
  nand4  g42(.a(new_n33_), .b(new_n31_), .c(x17), .d(x16), .O(new_n71_));
