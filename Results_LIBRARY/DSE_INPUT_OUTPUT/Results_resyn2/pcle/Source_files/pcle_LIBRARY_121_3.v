...
module FAU ( 
  ...
  nand2  g22(.a(new_n38_), .b(new_n29_), .O(new_n51_));
  ...
  aoi21  g47(.a(new_n75_), .b(new_n71_), .c(new_n42_), .O(z7));
  oai21  g48(.a(x18), .b(x08), .c(x07), .O(new_n77_));
  nand3  g49(.a(new_n32_), .b(new_n30_), .c(x18), .O(new_n78_));
  nand2  g50(.a(new_n33_), .b(new_n41_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n38_), .O(new_n80_));
