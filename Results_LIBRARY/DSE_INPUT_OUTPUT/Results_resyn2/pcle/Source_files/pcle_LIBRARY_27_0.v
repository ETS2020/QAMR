...
module FAU ( 
  ...
  nand3  g10(.a(new_n38_), .b(x17), .c(x16), .O(new_n39_));
  ...
  nand3  g23(.a(new_n51_), .b(new_n49_), .c(new_n38_), .O(new_n52_));
  ...
  nand3  g28(.a(new_n56_), .b(new_n38_), .c(new_n32_), .O(new_n57_));
  ...
  nand3  g34(.a(new_n62_), .b(new_n38_), .c(new_n61_), .O(new_n63_));
  ...
  aoi21  g41(.a(new_n69_), .b(new_n65_), .c(new_n29_), .O(z6));
  inv1   g42(.a(x17), .O(new_n71_));
  aoi21  g43(.a(new_n33_), .b(x16), .c(new_n71_), .O(new_n72_));
  nor2   g44(.a(x17), .b(new_n67_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n60_), .c(x18), .d(x15), .O(new_n74_));
  inv1   g46(.a(new_n74_), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n72_), .c(new_n38_), .O(new_n76_));
  nand3  g48(.a(new_n30_), .b(x08), .c(x06), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z7));
  inv1   g50(.a(x18), .O(new_n79_));
  aoi21  g51(.a(new_n66_), .b(x17), .c(new_n79_), .O(new_n80_));
  nand2  g52(.a(new_n66_), .b(new_n79_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n38_), .O(new_n82_));
  nand2  g54(.a(new_n37_), .b(x18), .O(new_n83_));
  aoi22  g55(.a(new_n83_), .b(new_n71_), .c(x08), .d(x07), .O(new_n84_));
