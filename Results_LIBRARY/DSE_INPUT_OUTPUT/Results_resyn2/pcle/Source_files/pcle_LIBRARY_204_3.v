...
module FAU ( 
  ...
  nand2  g52(.a(new_n32_), .b(x18), .O(new_n81_));
  inv1   g53(.a(x18), .O(new_n82_));
  oai21  g54(.a(new_n31_), .b(new_n30_), .c(new_n82_), .O(new_n83_));
