...
module FAU ( 
  ...
  aoi21  g09(.a(new_n37_), .b(x05), .c(new_n29_), .O(z0));
  nor2   g10(.a(new_n29_), .b(x05), .O(new_n39_));
  ...
  oai21  g39(.a(new_n56_), .b(new_n60_), .c(new_n67_), .O(new_n68_));
  ...
  nor2   g43(.a(new_n36_), .b(x17), .O(new_n72_));
  inv1   g44(.a(new_n35_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n54_), .c(x17), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n33_), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x06), .c(new_n39_), .O(new_n76_));
  oai21  g48(.a(new_n75_), .b(new_n72_), .c(new_n76_), .O(z7));
  nand3  g49(.a(new_n36_), .b(x18), .c(x17), .O(new_n78_));
  nand2  g50(.a(new_n74_), .b(new_n29_), .O(new_n79_));
