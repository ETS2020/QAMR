...
module FAU ( 
  ...
  aoi21  g19(.a(x12), .b(x11), .c(new_n47_), .O(new_n48_));
  nand3  g20(.a(x13), .b(x12), .c(x11), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n37_), .O(new_n50_));
  oai22  g22(.a(new_n50_), .b(new_n48_), .c(new_n42_), .d(new_n46_), .O(z3));
  ...
  nand4  g29(.a(new_n57_), .b(new_n55_), .c(new_n37_), .d(new_n41_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n53_), .O(z4));
  inv1   g31(.a(x15), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(x14), .c(new_n35_), .O(new_n61_));
  nand4  g33(.a(x12), .b(x11), .c(x09), .d(new_n34_), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n61_), .c(new_n30_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x13), .O(new_n64_));
  nand4  g36(.a(x15), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n65_));
  inv1   g37(.a(new_n65_), .O(new_n66_));
  aoi22  g38(.a(new_n66_), .b(new_n55_), .c(x08), .d(x04), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n64_), .O(z5));
  nand4  g40(.a(x11), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n69_));
  inv1   g41(.a(x16), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x15), .c(x14), .d(x12), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n69_), .c(new_n30_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(x13), .O(new_n73_));
  nor2   g45(.a(new_n60_), .b(new_n56_), .O(new_n74_));
  nand4  g46(.a(x16), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n75_));
  aoi21  g47(.a(new_n74_), .b(new_n54_), .c(new_n75_), .O(new_n76_));
  aoi21  g48(.a(x08), .b(x05), .c(new_n76_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n73_), .O(z6));
  inv1   g50(.a(new_n69_), .O(new_n79_));
  nand2  g51(.a(x14), .b(x12), .O(new_n80_));
  nand2  g52(.a(x16), .b(x15), .O(new_n81_));
  nor3   g53(.a(new_n81_), .b(new_n80_), .c(x17), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n79_), .c(x18), .O(new_n83_));
  and2   g55(.a(x08), .b(x06), .O(new_n84_));
  nand3  g56(.a(x16), .b(x12), .c(x11), .O(new_n85_));
  inv1   g57(.a(new_n85_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n74_), .c(new_n47_), .O(new_n87_));
  nand4  g59(.a(x17), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(new_n90_));
  oai21  g62(.a(new_n83_), .b(new_n29_), .c(new_n90_), .O(z7));
  nand2  g63(.a(new_n52_), .b(x07), .O(new_n92_));
  nand2  g64(.a(x18), .b(new_n29_), .O(new_n93_));
  nand4  g65(.a(new_n30_), .b(x17), .c(x16), .d(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n55_), .c(new_n93_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n37_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n92_), .O(z8));
endmodule
