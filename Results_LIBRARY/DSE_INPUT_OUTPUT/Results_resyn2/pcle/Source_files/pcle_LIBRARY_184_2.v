...
module FAU ( 
  ...
  nand2  g13(.a(new_n35_), .b(new_n41_), .O(new_n42_));
  ...
  nand3  g19(.a(new_n47_), .b(new_n35_), .c(new_n45_), .O(new_n48_));
  ...
  nand3  g30(.a(new_n58_), .b(new_n35_), .c(new_n29_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(new_n39_), .O(z4));
  ...
  nand3  g36(.a(new_n64_), .b(new_n35_), .c(new_n62_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n61_), .c(new_n39_), .O(z5));
  nor2   g38(.a(new_n29_), .b(new_n63_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x16), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  oai21  g41(.a(new_n29_), .b(new_n63_), .c(new_n69_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n35_), .c(new_n68_), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x05), .c(new_n39_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z6));
  aoi21  g45(.a(new_n67_), .b(x16), .c(x17), .O(new_n74_));
  nand2  g46(.a(new_n35_), .b(new_n31_), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x06), .c(new_n39_), .O(new_n76_));
  ...
  oai21  g52(.a(new_n36_), .b(new_n78_), .c(new_n80_), .O(z8));
endmodule
