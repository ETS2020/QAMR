...
module FAU ( 
  ...
  aoi21  g15(.a(new_n29_), .b(new_n30_), .c(x01), .O(new_n44_));
  ...
  aoi21  g20(.a(new_n48_), .b(new_n30_), .c(new_n44_), .O(z2));
  ...
  nand3  g39(.a(new_n63_), .b(new_n56_), .c(x16), .O(new_n68_));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n56_), .c(new_n32_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n74_), .c(new_n39_), .O(z7));
  nand2  g52(.a(new_n36_), .b(x18), .O(new_n81_));
  oai21  g53(.a(new_n35_), .b(new_n34_), .c(new_n29_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n33_), .O(new_n83_));
