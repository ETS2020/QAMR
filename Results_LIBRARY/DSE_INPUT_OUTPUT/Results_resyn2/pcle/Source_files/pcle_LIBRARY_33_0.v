...
module FAU ( 
  ...
  aoi21  g35(.a(new_n63_), .b(new_n59_), .c(new_n40_), .O(z5));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n67_), .c(new_n40_), .O(z6));
  inv1   g41(.a(new_n55_), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  nand2  g43(.a(x18), .b(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n32_), .c(new_n70_), .O(new_n73_));
  oai21  g45(.a(new_n31_), .b(new_n55_), .c(new_n71_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n73_), .c(new_n37_), .O(new_n75_));
  inv1   g47(.a(new_n40_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x08), .c(x06), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n75_), .O(z7));
  inv1   g50(.a(x18), .O(new_n79_));
  oai22  g51(.a(new_n31_), .b(new_n55_), .c(new_n79_), .d(new_n71_), .O(new_n80_));
  nand3  g52(.a(new_n32_), .b(new_n70_), .c(x18), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n37_), .O(new_n82_));
  oai21  g54(.a(new_n37_), .b(new_n79_), .c(new_n71_), .O(new_n83_));
