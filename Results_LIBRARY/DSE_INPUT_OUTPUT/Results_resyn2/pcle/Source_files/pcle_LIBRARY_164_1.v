...
module FAU ( 
  ...
  oai21  g08(.a(new_n33_), .b(x06), .c(x08), .O(new_n37_));
  ...
  nor2   g16(.a(new_n33_), .b(x06), .O(new_n45_));
  ...
  oai22  g24(.a(new_n52_), .b(new_n50_), .c(new_n37_), .d(new_n48_), .O(z4));
  ...
  nand3  g40(.a(new_n54_), .b(new_n63_), .c(x17), .O(new_n69_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n54_), .c(new_n63_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x07), .c(new_n45_), .O(new_n79_));
