...
module FAU ( 
  ...
  nand3  g24(.a(new_n52_), .b(new_n51_), .c(new_n43_), .O(new_n53_));
  ...
  nand2  g47(.a(new_n39_), .b(new_n75_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n35_), .c(new_n33_), .O(new_n77_));
  oai21  g49(.a(new_n34_), .b(new_n32_), .c(new_n75_), .O(new_n78_));
  ...
  aoi21  g53(.a(new_n66_), .b(x16), .c(x18), .O(new_n82_));
  inv1   g54(.a(new_n31_), .O(new_n83_));
  nand2  g55(.a(new_n36_), .b(new_n83_), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z8));
endmodule
