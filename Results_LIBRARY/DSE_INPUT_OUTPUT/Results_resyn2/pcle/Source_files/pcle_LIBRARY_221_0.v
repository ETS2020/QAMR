...
module FAU ( 
  ...
  aoi21  g22(.a(new_n50_), .b(new_n46_), .c(new_n29_), .O(z2));
  aoi21  g23(.a(x12), .b(x11), .c(x13), .O(new_n52_));
  nand3  g24(.a(x13), .b(x12), .c(x11), .O(new_n53_));
  nand2  g25(.a(new_n39_), .b(new_n53_), .O(new_n54_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n39_), .c(new_n31_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n57_), .c(new_n29_), .O(z4));
  nand2  g33(.a(x08), .b(x04), .O(new_n62_));
  nand2  g34(.a(new_n32_), .b(x15), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n31_), .b(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n39_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n62_), .c(new_n29_), .O(z5));
  inv1   g39(.a(x16), .O(new_n68_));
  nand2  g40(.a(new_n63_), .b(new_n68_), .O(new_n69_));
  nor2   g41(.a(new_n68_), .b(new_n64_), .O(new_n70_));
  ...
  nand3  g46(.a(new_n30_), .b(x08), .c(x06), .O(new_n75_));
  inv1   g47(.a(x17), .O(new_n76_));
  nand2  g48(.a(x18), .b(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n70_), .c(new_n32_), .O(new_n78_));
  nand2  g50(.a(new_n71_), .b(new_n76_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n39_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n75_), .O(z7));
  nand3  g53(.a(new_n30_), .b(x08), .c(x07), .O(new_n82_));
  oai21  g54(.a(new_n33_), .b(new_n31_), .c(x18), .O(new_n83_));
  nand2  g55(.a(x17), .b(x16), .O(new_n84_));
  nor2   g56(.a(new_n84_), .b(x18), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n32_), .c(x15), .O(new_n86_));
