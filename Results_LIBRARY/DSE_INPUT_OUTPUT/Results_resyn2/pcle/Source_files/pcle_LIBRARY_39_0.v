...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(new_n32_), .c(new_n30_), .d(x17), .O(new_n36_));
  ...
  nand3  g12(.a(new_n32_), .b(x18), .c(new_n40_), .O(new_n41_));
  ...
  inv1   g40(.a(new_n47_), .O(new_n69_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n68_), .c(new_n59_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x05), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(x10), .c(new_n74_), .O(z6));
  inv1   g47(.a(x17), .O(new_n76_));
  oai21  g48(.a(new_n70_), .b(new_n47_), .c(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n71_), .b(new_n69_), .c(x17), .O(new_n78_));
  ...
  aoi21  g55(.a(new_n78_), .b(new_n32_), .c(new_n59_), .O(new_n84_));
  nand2  g56(.a(x08), .b(x07), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(x10), .c(new_n85_), .O(z8));
endmodule
