...
module FAU ( 
  ...
  nand2  g24(.a(new_n34_), .b(x14), .O(new_n53_));
  inv1   g25(.a(x14), .O(new_n54_));
  nand2  g26(.a(new_n33_), .b(new_n54_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n53_), .c(new_n43_), .O(new_n56_));
  ...
  nand2  g32(.a(new_n60_), .b(new_n34_), .O(new_n61_));
  inv1   g33(.a(x15), .O(new_n62_));
  nand2  g34(.a(new_n33_), .b(new_n62_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n61_), .c(new_n43_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n59_), .c(new_n40_), .O(z5));
  nand2  g37(.a(new_n36_), .b(new_n34_), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  nand2  g39(.a(x15), .b(x14), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n33_), .c(new_n67_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n66_), .c(new_n43_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x05), .c(new_n40_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z6));
  nand2  g44(.a(x08), .b(x06), .O(new_n73_));
  oai22  g45(.a(new_n35_), .b(new_n33_), .c(new_n29_), .d(new_n39_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n37_), .c(new_n43_), .O(new_n75_));
  oai21  g47(.a(new_n73_), .b(new_n40_), .c(new_n75_), .O(z7));
  nand3  g48(.a(new_n37_), .b(new_n43_), .c(x18), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x07), .c(new_n40_), .O(new_n78_));
