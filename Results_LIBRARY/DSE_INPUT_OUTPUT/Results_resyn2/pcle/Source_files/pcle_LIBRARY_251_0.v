...
module FAU ( 
  ...
  oai21  g09(.a(new_n32_), .b(x11), .c(new_n37_), .O(z1));
  ...
  nand2  g17(.a(new_n33_), .b(new_n40_), .O(new_n46_));
  aoi21  g18(.a(x08), .b(x02), .c(new_n36_), .O(new_n47_));
  ...
  nand2  g23(.a(new_n51_), .b(new_n40_), .O(new_n52_));
  aoi21  g24(.a(x08), .b(x03), .c(new_n36_), .O(new_n53_));
  ...
  nand3  g30(.a(new_n58_), .b(new_n56_), .c(new_n40_), .O(new_n59_));
  aoi21  g31(.a(x08), .b(x04), .c(new_n36_), .O(new_n60_));
  ...
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n40_), .O(new_n65_));
  aoi21  g37(.a(x08), .b(x05), .c(new_n36_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(z6));
  nor2   g39(.a(new_n33_), .b(new_n32_), .O(new_n68_));
  ...
  and2   g43(.a(x08), .b(x06), .O(new_n72_));
  nor2   g44(.a(new_n63_), .b(new_n57_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n55_), .O(new_n74_));
  ...
  oai21  g49(.a(new_n71_), .b(x17), .c(new_n77_), .O(z7));
  oai21  g50(.a(new_n34_), .b(new_n33_), .c(x18), .O(new_n79_));
  inv1   g51(.a(x17), .O(new_n80_));
  nor2   g52(.a(x18), .b(new_n80_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n73_), .c(new_n55_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n40_), .O(new_n84_));
  inv1   g56(.a(new_n36_), .O(new_n85_));
