...
module FAU ( 
  ...
  aoi21  g19(.a(x08), .b(x02), .c(new_n31_), .O(new_n49_));
  oai21  g20(.a(new_n48_), .b(new_n46_), .c(new_n49_), .O(z3));
  inv1   g21(.a(new_n47_), .O(new_n51_));
  nor2   g22(.a(new_n51_), .b(x14), .O(new_n52_));
  nand4  g23(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n37_), .O(new_n54_));
  aoi21  g25(.a(x08), .b(x03), .c(new_n31_), .O(new_n55_));
  oai21  g26(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(z4));
  ...
  aoi21  g34(.a(new_n57_), .b(x15), .c(x16), .O(new_n64_));
  nand3  g35(.a(new_n57_), .b(x16), .c(x15), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n37_), .O(new_n66_));
  aoi21  g37(.a(x08), .b(x05), .c(new_n31_), .O(new_n67_));
  oai21  g38(.a(new_n66_), .b(new_n64_), .c(new_n67_), .O(z6));
  nand3  g39(.a(new_n30_), .b(x08), .c(x06), .O(new_n69_));
  inv1   g40(.a(x17), .O(new_n70_));
  nand2  g41(.a(x16), .b(x15), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n53_), .c(new_n70_), .O(new_n72_));
  nor2   g43(.a(new_n71_), .b(new_n53_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(x17), .O(new_n74_));
  nand4  g45(.a(new_n30_), .b(new_n35_), .c(x09), .d(new_n34_), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n69_), .O(z7));
  nand3  g49(.a(new_n30_), .b(x08), .c(x07), .O(new_n79_));
  aoi21  g50(.a(new_n73_), .b(x17), .c(x18), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n75_), .c(new_n79_), .O(z8));
  zero   g52(.O(z0));
endmodule
