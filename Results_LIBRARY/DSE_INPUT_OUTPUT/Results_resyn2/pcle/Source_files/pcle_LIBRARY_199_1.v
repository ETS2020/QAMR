...
module FAU ( 
  ...
  oai21  g23(.a(new_n34_), .b(new_n32_), .c(new_n29_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand3  g25(.a(new_n34_), .b(new_n33_), .c(x14), .O(new_n54_));
  ...
  oai21  g40(.a(new_n32_), .b(new_n65_), .c(new_n29_), .O(new_n69_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n34_), .c(x17), .O(new_n74_));
  inv1   g46(.a(new_n59_), .O(new_n75_));
  nor2   g47(.a(x17), .b(new_n65_), .O(new_n76_));
  ...
  oai21  g52(.a(new_n32_), .b(new_n80_), .c(new_n29_), .O(new_n81_));
  and2   g53(.a(x08), .b(x06), .O(new_n82_));
  aoi21  g54(.a(new_n81_), .b(new_n51_), .c(new_n82_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n79_), .O(z7));
  oai21  g56(.a(x18), .b(new_n51_), .c(new_n36_), .O(new_n85_));
  oai21  g57(.a(new_n35_), .b(new_n34_), .c(new_n29_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n85_), .c(new_n33_), .O(new_n87_));
