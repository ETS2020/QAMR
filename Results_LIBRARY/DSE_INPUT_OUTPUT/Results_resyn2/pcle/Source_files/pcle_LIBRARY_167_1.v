...
module FAU ( 
  ...
  nand2  g23(.a(new_n34_), .b(new_n33_), .O(new_n52_));
  ...
  inv1   g44(.a(new_n40_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x08), .c(x06), .O(new_n74_));
  inv1   g46(.a(x17), .O(new_n75_));
  nand4  g47(.a(new_n37_), .b(new_n35_), .c(new_n29_), .d(x16), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g49(.a(new_n37_), .b(new_n35_), .c(x17), .d(x16), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n77_), .c(new_n33_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n74_), .O(z7));
  nand3  g52(.a(new_n73_), .b(x08), .c(x07), .O(new_n81_));
  xor2a  g53(.a(new_n68_), .b(x18), .O(new_n82_));
