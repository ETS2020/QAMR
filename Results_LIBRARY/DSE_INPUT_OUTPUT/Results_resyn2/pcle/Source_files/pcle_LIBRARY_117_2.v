...
module FAU ( 
  ...
  nand3  g24(.a(new_n52_), .b(new_n34_), .c(new_n44_), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n50_), .c(new_n41_), .O(z3));
  ...
  nand2  g33(.a(new_n37_), .b(new_n44_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x04), .c(new_n41_), .O(new_n63_));
  oai21  g35(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z5));
  oai21  g36(.a(new_n29_), .b(x08), .c(x05), .O(new_n65_));
  inv1   g37(.a(new_n35_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n55_), .c(x16), .O(new_n67_));
  inv1   g39(.a(new_n67_), .O(new_n68_));
  oai21  g40(.a(new_n36_), .b(x16), .c(new_n44_), .O(new_n69_));
  ...
  nand2  g44(.a(new_n67_), .b(new_n72_), .O(new_n73_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n55_), .c(new_n29_), .O(new_n78_));
