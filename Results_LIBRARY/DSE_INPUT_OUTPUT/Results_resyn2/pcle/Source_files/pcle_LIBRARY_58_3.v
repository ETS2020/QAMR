...
module FAU ( 
  ...
  inv1   g02(.a(x18), .O(new_n31_));
  nor2   g03(.a(new_n31_), .b(x06), .O(new_n32_));
  ...
  nand2  g10(.a(x18), .b(x06), .O(new_n39_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n49_), .c(new_n40_), .O(z3));
  inv1   g27(.a(new_n53_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(x14), .O(new_n57_));
  inv1   g29(.a(new_n57_), .O(new_n58_));
  oai21  g30(.a(new_n56_), .b(x14), .c(new_n43_), .O(new_n59_));
  ...
  oai21  g46(.a(x18), .b(x08), .c(x06), .O(new_n75_));
  nor2   g47(.a(new_n34_), .b(new_n29_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x17), .O(new_n77_));
  inv1   g49(.a(x17), .O(new_n78_));
  oai21  g50(.a(new_n34_), .b(new_n29_), .c(new_n78_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n77_), .c(new_n43_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n75_), .O(z7));
  and2   g53(.a(x17), .b(x14), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n56_), .c(new_n30_), .O(new_n83_));
  nor2   g55(.a(x18), .b(new_n78_), .O(new_n84_));
  aoi22  g56(.a(new_n84_), .b(new_n76_), .c(new_n83_), .d(new_n32_), .O(new_n85_));
  nand3  g57(.a(new_n39_), .b(x08), .c(x07), .O(new_n86_));
  oai21  g58(.a(new_n85_), .b(new_n37_), .c(new_n86_), .O(z8));
endmodule
