...
module FAU ( 
  ...
  nand2  g22(.a(new_n36_), .b(new_n30_), .O(new_n51_));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n54_), .c(new_n39_), .O(z4));
  ...
  nand2  g40(.a(new_n62_), .b(new_n67_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n36_), .O(new_n70_));
  ...
  nand3  g46(.a(new_n74_), .b(new_n55_), .c(x17), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n36_), .O(new_n76_));
  ...
  nand3  g51(.a(new_n32_), .b(x18), .c(x17), .O(new_n80_));
  inv1   g52(.a(x18), .O(new_n81_));
  nand2  g53(.a(new_n75_), .b(new_n81_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n80_), .c(new_n36_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n79_), .c(new_n39_), .O(z8));
endmodule
