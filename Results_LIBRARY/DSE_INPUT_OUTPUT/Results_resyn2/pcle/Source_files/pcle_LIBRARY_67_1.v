...
module FAU ( 
  ...
  nor2   g17(.a(new_n45_), .b(new_n41_), .O(new_n46_));
  inv1   g18(.a(new_n46_), .O(new_n47_));
  nand2  g19(.a(new_n45_), .b(new_n41_), .O(new_n48_));
  nand3  g20(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(new_n49_));
  aoi21  g21(.a(new_n49_), .b(new_n44_), .c(new_n39_), .O(z2));
  nor2   g22(.a(new_n46_), .b(x13), .O(new_n51_));
  nand2  g23(.a(new_n46_), .b(x13), .O(new_n52_));
  ...
  nand3  g30(.a(new_n58_), .b(new_n35_), .c(new_n33_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(new_n39_), .O(z4));
  nand2  g32(.a(x08), .b(x04), .O(new_n61_));
  nand2  g33(.a(new_n35_), .b(new_n34_), .O(new_n62_));
  nor2   g34(.a(new_n36_), .b(new_n32_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n61_), .c(new_n39_), .O(z5));
  aoi21  g37(.a(new_n36_), .b(x16), .c(new_n32_), .O(new_n66_));
  oai21  g38(.a(new_n36_), .b(x16), .c(new_n66_), .O(new_n67_));
  aoi21  g39(.a(x08), .b(x05), .c(new_n39_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z6));
  inv1   g41(.a(x17), .O(new_n70_));
  nand2  g42(.a(new_n37_), .b(new_n29_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  and2   g44(.a(x08), .b(x06), .O(new_n73_));
  aoi21  g45(.a(new_n66_), .b(x17), .c(new_n73_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n72_), .O(z7));
  aoi21  g47(.a(new_n36_), .b(x16), .c(x18), .O(new_n76_));
  nand3  g48(.a(new_n36_), .b(x18), .c(x16), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n33_), .c(x17), .O(new_n78_));
  nand2  g50(.a(x08), .b(x07), .O(new_n79_));
  oai22  g51(.a(new_n79_), .b(new_n39_), .c(new_n78_), .d(new_n76_), .O(z8));
endmodule
