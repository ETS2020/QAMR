...
module FAU ( 
  ...
  nand3  g15(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(new_n44_));
  aoi21  g16(.a(new_n44_), .b(new_n38_), .c(z0), .O(z3));
  ...
  inv1   g24(.a(new_n48_), .O(new_n53_));
  ...
  oai21  g31(.a(new_n48_), .b(new_n55_), .c(new_n59_), .O(new_n60_));
  nand2  g32(.a(x16), .b(x15), .O(new_n61_));
  inv1   g33(.a(new_n61_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n53_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n60_), .c(new_n39_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x05), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(z0), .O(z6));
  inv1   g38(.a(x17), .O(new_n67_));
  oai21  g39(.a(new_n61_), .b(new_n48_), .c(new_n67_), .O(new_n68_));
  nor2   g40(.a(new_n61_), .b(new_n48_), .O(new_n69_));
  ...
  aoi21  g45(.a(new_n69_), .b(x17), .c(x18), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x07), .c(z0), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(new_n32_), .c(new_n75_), .O(z8));
endmodule
