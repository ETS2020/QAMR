...
module FAU ( 
  ...
  nand2  g31(.a(new_n59_), .b(new_n43_), .O(new_n60_));
  ...
  aoi21  g41(.a(new_n34_), .b(new_n43_), .c(x18), .O(new_n70_));
  inv1   g42(.a(new_n31_), .O(new_n71_));
  and2   g43(.a(x08), .b(x06), .O(new_n72_));
  aoi21  g44(.a(new_n64_), .b(new_n71_), .c(new_n72_), .O(new_n73_));
  oai21  g45(.a(new_n70_), .b(x17), .c(new_n73_), .O(z7));
  inv1   g46(.a(new_n39_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x08), .c(x07), .O(new_n76_));
  nand2  g48(.a(new_n64_), .b(new_n38_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n35_), .c(new_n71_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(z8));
endmodule
