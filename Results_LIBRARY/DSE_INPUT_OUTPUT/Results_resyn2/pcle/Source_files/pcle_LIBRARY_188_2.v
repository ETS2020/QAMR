...
module FAU ( 
  ...
  nor2   g14(.a(x17), .b(new_n42_), .O(new_n43_));
  nand2  g15(.a(x08), .b(x01), .O(new_n44_));
  nand2  g16(.a(x12), .b(x11), .O(new_n45_));
  or2    g17(.a(x12), .b(x11), .O(new_n46_));
  nand3  g18(.a(new_n46_), .b(new_n36_), .c(new_n45_), .O(new_n47_));
  aoi21  g19(.a(new_n47_), .b(new_n44_), .c(new_n43_), .O(z2));
  nand2  g20(.a(x08), .b(x02), .O(new_n49_));
  inv1   g21(.a(x13), .O(new_n50_));
  nand2  g22(.a(new_n45_), .b(new_n50_), .O(new_n51_));
  nand2  g23(.a(new_n29_), .b(x13), .O(new_n52_));
  nand3  g24(.a(new_n52_), .b(new_n51_), .c(new_n36_), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n49_), .c(new_n43_), .O(z3));
  aoi21  g26(.a(new_n29_), .b(x13), .c(x14), .O(new_n55_));
  nand3  g27(.a(new_n29_), .b(x14), .c(x13), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n36_), .O(new_n57_));
  aoi21  g29(.a(x08), .b(x03), .c(new_n43_), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n55_), .c(new_n58_), .O(z4));
  nand2  g31(.a(x08), .b(x04), .O(new_n60_));
  nand2  g32(.a(new_n31_), .b(new_n29_), .O(new_n61_));
  inv1   g33(.a(x15), .O(new_n62_));
  nand2  g34(.a(new_n56_), .b(new_n62_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n36_), .c(new_n61_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n60_), .c(new_n43_), .O(z5));
  inv1   g37(.a(x16), .O(new_n66_));
  nand2  g38(.a(new_n61_), .b(new_n66_), .O(new_n67_));
  nor2   g39(.a(new_n30_), .b(new_n45_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(x16), .c(new_n35_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x05), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n43_), .O(z6));
  nand2  g44(.a(x08), .b(x06), .O(new_n73_));
  nand4  g45(.a(new_n39_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n32_), .c(new_n73_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n42_), .O(new_n76_));
  inv1   g48(.a(new_n73_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n69_), .c(x17), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(z7));
  inv1   g51(.a(x18), .O(new_n80_));
  nand2  g52(.a(new_n32_), .b(new_n80_), .O(new_n81_));
  nand3  g53(.a(new_n68_), .b(x18), .c(x16), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n81_), .c(new_n36_), .d(x17), .O(new_n83_));
  oai21  g55(.a(new_n35_), .b(new_n80_), .c(new_n42_), .O(new_n84_));
  aoi22  g56(.a(new_n84_), .b(new_n39_), .c(x08), .d(x07), .O(new_n85_));
