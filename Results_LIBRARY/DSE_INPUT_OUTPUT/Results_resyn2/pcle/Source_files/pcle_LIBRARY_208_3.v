...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(new_n33_), .c(x18), .d(new_n31_), .O(new_n36_));
  aoi21  g08(.a(new_n36_), .b(new_n30_), .c(new_n29_), .O(z0));
  inv1   g09(.a(x00), .O(new_n38_));
  oai21  g10(.a(new_n30_), .b(new_n29_), .c(x08), .O(new_n39_));
  nand3  g11(.a(new_n30_), .b(x09), .c(new_n31_), .O(new_n40_));
  oai22  g12(.a(new_n40_), .b(x11), .c(new_n39_), .d(new_n38_), .O(z1));
  ...
  oai21  g20(.a(new_n47_), .b(new_n29_), .c(new_n48_), .O(z2));
  nor2   g21(.a(new_n45_), .b(x13), .O(new_n50_));
  nand2  g22(.a(new_n32_), .b(new_n31_), .O(new_n51_));
  ...
  nor2   g37(.a(new_n65_), .b(new_n32_), .O(new_n66_));
  nor2   g38(.a(new_n66_), .b(new_n40_), .O(new_n67_));
  oai21  g39(.a(new_n64_), .b(x15), .c(new_n67_), .O(new_n68_));
  oai21  g40(.a(new_n39_), .b(new_n63_), .c(new_n68_), .O(z5));
  nand2  g41(.a(new_n66_), .b(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  oai21  g43(.a(new_n65_), .b(new_n32_), .c(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n70_), .c(new_n31_), .O(new_n73_));
  ...
  nand3  g51(.a(new_n79_), .b(new_n33_), .c(x17), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  oai21  g53(.a(new_n78_), .b(new_n32_), .c(new_n81_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n80_), .c(new_n31_), .O(new_n83_));
  ...
  oai21  g59(.a(new_n34_), .b(new_n32_), .c(x18), .O(new_n88_));
  nor2   g60(.a(x18), .b(new_n81_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n79_), .c(new_n33_), .O(new_n90_));
