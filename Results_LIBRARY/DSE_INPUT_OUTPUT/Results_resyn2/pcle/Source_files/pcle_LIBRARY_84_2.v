...
module FAU ( 
  ...
  nand2  g34(.a(new_n62_), .b(new_n54_), .O(new_n63_));
  ...
  oai21  g42(.a(new_n70_), .b(new_n34_), .c(new_n69_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n68_), .c(new_n33_), .O(new_n72_));
  ...
  nand2  g48(.a(x18), .b(x17), .O(new_n77_));
  oai21  g49(.a(new_n35_), .b(new_n34_), .c(new_n77_), .O(new_n78_));
  nand2  g50(.a(new_n36_), .b(x17), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n33_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n76_), .O(z7));
  nand3  g53(.a(new_n75_), .b(x08), .c(x07), .O(new_n82_));
  nand3  g54(.a(new_n79_), .b(new_n33_), .c(x18), .O(new_n83_));
