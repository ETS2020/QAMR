...
module FAU ( 
  ...
  nand3  g31(.a(new_n59_), .b(new_n32_), .c(new_n42_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n57_), .c(new_n38_), .O(z4));
  ...
  aoi21  g46(.a(new_n34_), .b(new_n42_), .c(x18), .O(new_n75_));
  inv1   g47(.a(new_n31_), .O(new_n76_));
  and2   g48(.a(x08), .b(x06), .O(new_n77_));
  aoi21  g49(.a(new_n69_), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  oai21  g50(.a(new_n75_), .b(x17), .c(new_n78_), .O(z7));
  nor2   g51(.a(new_n32_), .b(new_n65_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(x16), .c(x18), .O(new_n81_));
  nand2  g53(.a(new_n35_), .b(new_n76_), .O(new_n82_));
  inv1   g54(.a(new_n38_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x08), .c(x07), .O(new_n84_));
  oai21  g56(.a(new_n82_), .b(new_n81_), .c(new_n84_), .O(z8));
endmodule
