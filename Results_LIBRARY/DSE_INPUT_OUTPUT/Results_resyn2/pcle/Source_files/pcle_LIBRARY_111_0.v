...
module FAU ( 
  ...
  nand3  g22(.a(new_n50_), .b(new_n37_), .c(new_n29_), .O(new_n51_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(z6));
  inv1   g40(.a(new_n54_), .O(new_n69_));
  inv1   g41(.a(x17), .O(new_n70_));
  nand2  g42(.a(x18), .b(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n32_), .c(new_n69_), .O(new_n72_));
  oai21  g44(.a(new_n31_), .b(new_n54_), .c(new_n70_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n37_), .O(new_n74_));
  ...
  oai22  g50(.a(new_n31_), .b(new_n54_), .c(new_n78_), .d(new_n70_), .O(new_n79_));
  nand3  g51(.a(new_n32_), .b(new_n69_), .c(x18), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(new_n37_), .O(new_n81_));
  oai21  g53(.a(new_n37_), .b(new_n78_), .c(new_n70_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x07), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z8));
endmodule
