...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(new_n37_), .c(new_n47_), .O(new_n50_));
  aoi21  g22(.a(new_n50_), .b(new_n46_), .c(new_n41_), .O(z2));
  aoi21  g23(.a(x12), .b(x11), .c(x13), .O(new_n52_));
  nand2  g24(.a(new_n37_), .b(new_n29_), .O(new_n53_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n37_), .c(new_n57_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n56_), .c(new_n41_), .O(z4));
  ...
  oai21  g41(.a(new_n57_), .b(new_n64_), .c(new_n69_), .O(new_n70_));
  inv1   g42(.a(new_n57_), .O(new_n71_));
  ...
  oai21  g47(.a(x18), .b(x08), .c(new_n75_), .O(new_n76_));
  inv1   g48(.a(x09), .O(new_n77_));
  nor2   g49(.a(x10), .b(new_n77_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n70_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n68_), .O(z6));
  nand2  g52(.a(x08), .b(x06), .O(new_n81_));
  inv1   g53(.a(x17), .O(new_n82_));
  oai21  g54(.a(new_n72_), .b(new_n57_), .c(new_n82_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n37_), .c(new_n33_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n81_), .c(new_n41_), .O(z7));
  oai22  g57(.a(new_n31_), .b(new_n57_), .c(new_n40_), .d(new_n75_), .O(new_n86_));
  nand3  g58(.a(new_n32_), .b(new_n71_), .c(x18), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n37_), .O(new_n88_));
  inv1   g60(.a(new_n41_), .O(new_n89_));
