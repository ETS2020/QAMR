...
module FAU ( 
  ...
  nor2   g07(.a(new_n33_), .b(x07), .O(new_n36_));
  ...
  nand2  g17(.a(new_n40_), .b(new_n30_), .O(new_n46_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(new_n40_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n56_), .O(z5));
  nand3  g34(.a(new_n55_), .b(x08), .c(x05), .O(new_n63_));
