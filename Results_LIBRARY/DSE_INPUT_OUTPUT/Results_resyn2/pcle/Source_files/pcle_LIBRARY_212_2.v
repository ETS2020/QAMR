...
module FAU ( 
  ...
  nand3  g01(.a(x14), .b(x13), .c(x12), .O(new_n30_));
  inv1   g02(.a(new_n30_), .O(new_n31_));
  nand2  g03(.a(new_n31_), .b(x15), .O(new_n32_));
  inv1   g04(.a(new_n32_), .O(new_n33_));
  nor2   g05(.a(x10), .b(x08), .O(new_n34_));
  and2   g06(.a(x17), .b(x16), .O(new_n35_));
  nand4  g07(.a(new_n35_), .b(new_n34_), .c(new_n33_), .d(x18), .O(new_n36_));
  aoi21  g08(.a(new_n36_), .b(x11), .c(new_n29_), .O(z0));
  nand2  g09(.a(x08), .b(x00), .O(new_n38_));
  oai21  g10(.a(x11), .b(new_n29_), .c(new_n38_), .O(z1));
  inv1   g11(.a(x11), .O(new_n40_));
  inv1   g12(.a(x12), .O(new_n41_));
  aoi21  g13(.a(new_n34_), .b(new_n41_), .c(new_n40_), .O(new_n42_));
  nand2  g14(.a(x08), .b(x01), .O(new_n43_));
  oai21  g15(.a(new_n42_), .b(new_n29_), .c(new_n43_), .O(z2));
  nor2   g16(.a(x13), .b(x12), .O(new_n45_));
  nand2  g17(.a(x13), .b(x12), .O(new_n46_));
  nand2  g18(.a(new_n34_), .b(new_n46_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n45_), .c(x11), .O(new_n48_));
  ...
  oai21  g24(.a(x11), .b(new_n29_), .c(x08), .O(new_n53_));
  inv1   g25(.a(x14), .O(new_n54_));
  nand2  g26(.a(new_n46_), .b(new_n54_), .O(new_n55_));
  nand3  g27(.a(new_n34_), .b(x11), .c(x09), .O(new_n56_));
  ...
  nand3  g33(.a(new_n61_), .b(new_n34_), .c(new_n32_), .O(new_n62_));
  ...
  nor2   g41(.a(new_n67_), .b(new_n60_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n31_), .c(new_n69_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n68_), .c(new_n40_), .O(new_n72_));
  nand2  g44(.a(x08), .b(x05), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(new_n29_), .c(new_n73_), .O(z6));
  inv1   g46(.a(x06), .O(new_n75_));
  aoi21  g47(.a(new_n70_), .b(new_n31_), .c(x17), .O(new_n76_));
  nand3  g48(.a(x17), .b(x16), .c(x15), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n30_), .c(new_n57_), .O(new_n78_));
  oai22  g50(.a(new_n78_), .b(new_n76_), .c(new_n53_), .d(new_n75_), .O(z7));
  inv1   g51(.a(new_n77_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n31_), .c(x18), .O(new_n81_));
  inv1   g53(.a(x18), .O(new_n82_));
  oai21  g54(.a(new_n77_), .b(new_n30_), .c(new_n82_), .O(new_n83_));
