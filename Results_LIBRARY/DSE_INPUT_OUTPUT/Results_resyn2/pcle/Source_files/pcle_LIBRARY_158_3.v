...
module FAU ( 
  ...
  nand3  g27(.a(new_n56_), .b(new_n54_), .c(new_n41_), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n52_), .c(new_n34_), .O(z5));
  inv1   g29(.a(x16), .O(new_n59_));
  oai21  g30(.a(new_n48_), .b(new_n55_), .c(new_n59_), .O(new_n60_));
  nand2  g31(.a(x16), .b(x15), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n53_), .O(new_n63_));
