...
module FAU ( 
  ...
  and2   g36(.a(new_n30_), .b(new_n32_), .O(new_n65_));
  oai21  g37(.a(new_n30_), .b(new_n32_), .c(x09), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n65_), .c(x04), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n36_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  oai21  g42(.a(new_n30_), .b(new_n32_), .c(new_n33_), .O(new_n71_));
  nand2  g43(.a(x09), .b(new_n46_), .O(new_n72_));
  aoi21  g44(.a(new_n34_), .b(new_n31_), .c(new_n72_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n71_), .c(new_n41_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(x10), .c(new_n75_), .O(z6));
  nand2  g48(.a(new_n47_), .b(x06), .O(new_n77_));
  nor3   g49(.a(new_n30_), .b(new_n33_), .c(new_n32_), .O(new_n78_));
  nor2   g50(.a(new_n78_), .b(x17), .O(new_n79_));
  inv1   g51(.a(new_n39_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n35_), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n79_), .c(new_n77_), .O(z7));
  nand2  g54(.a(new_n47_), .b(x07), .O(new_n83_));
  nand3  g55(.a(new_n78_), .b(x18), .c(x17), .O(new_n84_));
  aoi21  g56(.a(new_n35_), .b(new_n29_), .c(new_n39_), .O(new_n85_));
