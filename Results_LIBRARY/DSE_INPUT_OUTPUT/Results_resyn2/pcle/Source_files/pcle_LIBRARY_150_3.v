...
module FAU ( 
  ...
  and2   g07(.a(x10), .b(x07), .O(new_n36_));
  aoi21  g08(.a(x08), .b(x00), .c(new_n36_), .O(new_n37_));
  oai21  g09(.a(new_n34_), .b(x11), .c(new_n37_), .O(z1));
  xnor2a g10(.a(x12), .b(x11), .O(new_n39_));
  aoi21  g11(.a(x08), .b(x01), .c(new_n36_), .O(new_n40_));
  oai21  g12(.a(new_n39_), .b(new_n34_), .c(new_n40_), .O(z2));
  ...
  nand2  g25(.a(new_n42_), .b(x04), .O(new_n54_));
  ...
  nand2  g32(.a(new_n42_), .b(x05), .O(new_n61_));
  nand3  g33(.a(new_n57_), .b(new_n48_), .c(x16), .O(new_n62_));
  ...
  nand2  g38(.a(new_n42_), .b(x06), .O(new_n67_));
  nand4  g39(.a(new_n57_), .b(new_n48_), .c(x17), .d(x16), .O(new_n68_));
  ...
  nor2   g47(.a(new_n69_), .b(new_n63_), .O(new_n76_));
  inv1   g48(.a(new_n50_), .O(new_n77_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n81_), .c(x10), .O(z8));
endmodule
