...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(new_n46_), .c(new_n34_), .O(new_n49_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n51_), .c(new_n40_), .O(z3));
  inv1   g28(.a(new_n54_), .O(new_n57_));
  nor2   g29(.a(new_n57_), .b(x14), .O(new_n58_));
  nand2  g30(.a(new_n35_), .b(new_n34_), .O(new_n59_));
  ...
  nand2  g37(.a(new_n63_), .b(x15), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n65_), .c(new_n34_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n64_), .c(new_n62_), .O(z5));
  aoi21  g40(.a(new_n63_), .b(x15), .c(x16), .O(new_n69_));
  ...
  oai21  g45(.a(new_n72_), .b(new_n69_), .c(new_n73_), .O(z6));
  nor2   g46(.a(new_n37_), .b(x17), .O(new_n75_));
  inv1   g47(.a(x17), .O(new_n76_));
  oai21  g48(.a(new_n71_), .b(new_n76_), .c(new_n34_), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x06), .c(new_n40_), .O(new_n78_));
  oai21  g50(.a(new_n77_), .b(new_n75_), .c(new_n78_), .O(z7));
  and2   g51(.a(x17), .b(x14), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n57_), .c(new_n70_), .O(new_n81_));
  nor2   g53(.a(new_n30_), .b(x04), .O(new_n82_));
  nor2   g54(.a(x18), .b(new_n76_), .O(new_n83_));
  aoi22  g55(.a(new_n83_), .b(new_n37_), .c(new_n82_), .d(new_n81_), .O(new_n84_));
  nand3  g56(.a(new_n65_), .b(x08), .c(x07), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(new_n33_), .c(new_n85_), .O(z8));
endmodule
