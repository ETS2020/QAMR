...
module FAU ( 
  ...
  nand4  g04(.a(new_n32_), .b(x18), .c(x17), .d(new_n29_), .O(new_n33_));
  aoi21  g05(.a(new_n33_), .b(x09), .c(x10), .O(z0));
  inv1   g06(.a(x09), .O(new_n35_));
  inv1   g07(.a(x10), .O(new_n36_));
  aoi21  g08(.a(new_n36_), .b(new_n35_), .c(new_n29_), .O(new_n37_));
  ...
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(new_n35_), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n62_), .c(new_n35_), .O(new_n66_));
  nand2  g38(.a(x08), .b(x05), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(x10), .c(new_n67_), .O(z6));
  nand2  g40(.a(new_n37_), .b(x06), .O(new_n69_));
  nor2   g41(.a(new_n32_), .b(x17), .O(new_n70_));
  nand2  g42(.a(new_n32_), .b(x17), .O(new_n71_));
  ...
  aoi21  g46(.a(new_n32_), .b(x17), .c(x18), .O(new_n75_));
