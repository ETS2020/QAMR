...
module FAU ( 
  ...
  nand2  g18(.a(new_n39_), .b(new_n46_), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(new_n40_), .c(new_n30_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n45_), .c(new_n36_), .O(z3));
  ...
  nand3  g25(.a(new_n53_), .b(new_n52_), .c(new_n40_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n50_), .c(new_n36_), .O(z4));
  ...
  nand3  g31(.a(new_n59_), .b(new_n57_), .c(new_n40_), .O(new_n60_));
  ...
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n40_), .O(new_n67_));
  aoi21  g39(.a(x08), .b(x05), .c(new_n36_), .O(new_n68_));
  ...
  nand3  g45(.a(new_n73_), .b(new_n56_), .c(new_n65_), .O(new_n74_));
  ...
  nand3  g52(.a(new_n80_), .b(new_n56_), .c(new_n65_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n40_), .O(new_n83_));
