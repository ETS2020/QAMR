...
module FAU ( 
  ...
  nor2   g00(.a(x09), .b(x06), .O(new_n29_));
  ...
  nand3  g15(.a(new_n43_), .b(new_n37_), .c(new_n42_), .O(new_n44_));
  aoi21  g16(.a(x08), .b(x01), .c(new_n29_), .O(new_n45_));
  ...
  oai21  g36(.a(new_n54_), .b(new_n59_), .c(new_n64_), .O(z5));
  nor2   g37(.a(new_n31_), .b(new_n60_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x16), .O(new_n67_));
  inv1   g39(.a(x16), .O(new_n68_));
  oai21  g40(.a(new_n31_), .b(new_n60_), .c(new_n68_), .O(new_n69_));
  ...
  aoi21  g45(.a(new_n66_), .b(x16), .c(x17), .O(new_n74_));
  ...
  aoi21  g54(.a(x08), .b(x07), .c(new_n29_), .O(new_n83_));
