...
module FAU ( 
  ...
  oai21  g11(.a(x08), .b(new_n29_), .c(x00), .O(new_n40_));
  ...
  nor2   g19(.a(new_n42_), .b(x13), .O(new_n48_));
  nand2  g20(.a(new_n42_), .b(x13), .O(new_n49_));
  ...
  aoi21  g25(.a(new_n42_), .b(x13), .c(x14), .O(new_n54_));
  nand2  g26(.a(new_n37_), .b(new_n31_), .O(new_n55_));
  aoi21  g27(.a(x08), .b(x03), .c(new_n51_), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z4));
  inv1   g29(.a(x15), .O(new_n58_));
  aoi21  g30(.a(new_n31_), .b(new_n58_), .c(new_n36_), .O(new_n59_));
  oai21  g31(.a(new_n31_), .b(new_n58_), .c(new_n59_), .O(new_n60_));
  ...
  nand4  g36(.a(new_n64_), .b(new_n42_), .c(x16), .d(x15), .O(new_n65_));
  inv1   g37(.a(x16), .O(new_n66_));
  oai21  g38(.a(new_n31_), .b(new_n58_), .c(new_n66_), .O(new_n67_));
  ...
  nor2   g44(.a(new_n36_), .b(new_n33_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n70_), .c(new_n51_), .O(z7));
  nand2  g47(.a(new_n33_), .b(x18), .O(new_n76_));
  inv1   g48(.a(x18), .O(new_n77_));
  oai21  g49(.a(new_n32_), .b(new_n31_), .c(new_n77_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n76_), .c(new_n37_), .O(new_n79_));
