...
module FAU ( 
  ...
  nor2   g30(.a(new_n35_), .b(x14), .O(new_n59_));
  nand4  g31(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n45_), .c(new_n30_), .O(new_n61_));
  inv1   g33(.a(x18), .O(new_n62_));
  aoi22  g34(.a(new_n62_), .b(x17), .c(x08), .d(x03), .O(new_n63_));
  oai21  g35(.a(new_n61_), .b(new_n59_), .c(new_n63_), .O(z4));
  ...
  aoi22  g40(.a(new_n62_), .b(x17), .c(x08), .d(x04), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n66_), .c(new_n69_), .O(z5));
  nand2  g42(.a(new_n37_), .b(new_n35_), .O(new_n71_));
  inv1   g43(.a(x16), .O(new_n72_));
  nand2  g44(.a(x15), .b(x14), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n34_), .c(new_n72_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n71_), .c(new_n32_), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x05), .c(new_n41_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  nand2  g49(.a(new_n62_), .b(x17), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x08), .c(x06), .O(new_n79_));
  oai22  g51(.a(new_n36_), .b(new_n34_), .c(new_n62_), .d(new_n40_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n38_), .c(new_n32_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n79_), .O(z7));
  nand3  g54(.a(new_n38_), .b(new_n32_), .c(x18), .O(new_n83_));
  nand2  g55(.a(x08), .b(x07), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(new_n78_), .O(z8));
endmodule
