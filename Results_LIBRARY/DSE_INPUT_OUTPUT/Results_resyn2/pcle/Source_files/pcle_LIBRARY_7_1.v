...
module FAU ( 
  ...
  nand4  g06(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n35_));
  ...
  aoi21  g29(.a(new_n29_), .b(new_n30_), .c(x04), .O(new_n58_));
  inv1   g30(.a(x15), .O(new_n59_));
  nand2  g31(.a(new_n53_), .b(new_n59_), .O(new_n60_));
  and2   g32(.a(x15), .b(x14), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n52_), .O(new_n62_));
  inv1   g34(.a(x09), .O(new_n63_));
  nor2   g35(.a(x10), .b(new_n63_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n60_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n30_), .c(new_n58_), .O(z5));
  nand3  g38(.a(new_n61_), .b(new_n52_), .c(x16), .O(new_n67_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n52_), .c(new_n32_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n73_), .c(new_n39_), .O(z7));
  aoi21  g51(.a(x18), .b(x04), .c(new_n36_), .O(new_n80_));
  nand2  g52(.a(new_n36_), .b(x18), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n33_), .O(new_n82_));
  inv1   g54(.a(new_n39_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x08), .c(x07), .O(new_n84_));
  oai21  g56(.a(new_n82_), .b(new_n80_), .c(new_n84_), .O(z8));
endmodule
