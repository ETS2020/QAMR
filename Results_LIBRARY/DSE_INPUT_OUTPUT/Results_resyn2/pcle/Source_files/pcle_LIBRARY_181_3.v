...
module FAU ( 
  ...
  nand2  g25(.a(new_n49_), .b(new_n54_), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(new_n53_), .c(new_n37_), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n52_), .c(new_n31_), .O(z4));
  inv1   g28(.a(x15), .O(new_n58_));
  nor2   g29(.a(new_n53_), .b(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n53_), .b(new_n58_), .O(new_n60_));
