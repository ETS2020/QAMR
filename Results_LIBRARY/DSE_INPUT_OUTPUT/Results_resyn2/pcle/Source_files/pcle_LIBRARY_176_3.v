...
module FAU ( 
  ...
  oai21  g09(.a(new_n33_), .b(new_n37_), .c(x08), .O(new_n38_));
  ...
  aoi21  g14(.a(new_n42_), .b(new_n40_), .c(x10), .O(new_n43_));
  nand2  g15(.a(x08), .b(x01), .O(new_n44_));
  oai21  g16(.a(new_n43_), .b(new_n37_), .c(new_n44_), .O(z2));
  nor2   g17(.a(new_n41_), .b(x13), .O(new_n46_));
  nand2  g18(.a(new_n30_), .b(new_n32_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n46_), .c(new_n33_), .O(new_n48_));
