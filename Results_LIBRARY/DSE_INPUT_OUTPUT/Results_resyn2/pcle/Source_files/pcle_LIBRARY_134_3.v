...
module FAU ( 
  ...
  oai21  g11(.a(new_n30_), .b(new_n39_), .c(x08), .O(new_n40_));
  ...
  oai21  g23(.a(new_n51_), .b(new_n50_), .c(new_n30_), .O(new_n52_));
  ...
  oai22  g32(.a(new_n60_), .b(new_n57_), .c(new_n40_), .d(new_n56_), .O(z4));
  ...
  oai21  g39(.a(new_n40_), .b(new_n62_), .c(new_n67_), .O(z5));
  ...
  nand2  g44(.a(new_n72_), .b(new_n30_), .O(new_n73_));
  ...
  oai22  g57(.a(new_n85_), .b(new_n84_), .c(new_n40_), .d(new_n83_), .O(z8));
endmodule
