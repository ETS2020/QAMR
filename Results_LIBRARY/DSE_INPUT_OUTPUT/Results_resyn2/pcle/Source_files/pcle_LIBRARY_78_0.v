...
module FAU ( 
  ...
  nand3  g17(.a(new_n45_), .b(new_n38_), .c(new_n44_), .O(new_n46_));
  ...
  nand3  g22(.a(new_n50_), .b(new_n38_), .c(new_n31_), .O(new_n51_));
  ...
  inv1   g30(.a(new_n55_), .O(new_n59_));
  inv1   g31(.a(new_n32_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n53_), .c(new_n37_), .O(new_n61_));
  oai21  g33(.a(new_n59_), .b(x15), .c(new_n61_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x04), .c(new_n29_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(z5));
  inv1   g36(.a(x16), .O(new_n65_));
  nand2  g37(.a(new_n60_), .b(new_n53_), .O(new_n66_));
  oai21  g38(.a(new_n37_), .b(new_n66_), .c(x18), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  aoi22  g40(.a(new_n61_), .b(x16), .c(x08), .d(x05), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z6));
  nand2  g42(.a(x08), .b(x06), .O(new_n71_));
  inv1   g43(.a(x17), .O(new_n72_));
  nand3  g44(.a(new_n60_), .b(new_n53_), .c(x16), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n38_), .c(new_n34_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n71_), .c(new_n29_), .O(z7));
  nand3  g48(.a(new_n33_), .b(x18), .c(x17), .O(new_n77_));
  inv1   g49(.a(x18), .O(new_n78_));
  oai21  g50(.a(new_n66_), .b(new_n72_), .c(new_n78_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n77_), .c(new_n38_), .O(new_n80_));
  nand2  g52(.a(new_n37_), .b(x18), .O(new_n81_));
  aoi22  g53(.a(new_n81_), .b(new_n65_), .c(x08), .d(x07), .O(new_n82_));
