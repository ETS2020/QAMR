...
module FAU ( 
  ...
  nand3  g09(.a(new_n37_), .b(x18), .c(x02), .O(new_n38_));
  nor2   g10(.a(new_n38_), .b(new_n33_), .O(z0));
  inv1   g11(.a(x18), .O(new_n40_));
  nor2   g12(.a(new_n40_), .b(x02), .O(new_n41_));
  ...
  nand3  g23(.a(new_n51_), .b(new_n37_), .c(new_n49_), .O(new_n52_));
  ...
  nand3  g29(.a(new_n57_), .b(new_n37_), .c(new_n29_), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n55_), .c(new_n41_), .O(z4));
  ...
  oai21  g40(.a(new_n29_), .b(new_n63_), .c(new_n68_), .O(new_n69_));
  ...
  aoi21  g48(.a(x08), .b(x06), .c(new_n41_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z7));
  nand2  g50(.a(x18), .b(x02), .O(new_n79_));
  oai21  g51(.a(new_n31_), .b(new_n29_), .c(new_n79_), .O(new_n80_));
  nand3  g52(.a(new_n32_), .b(new_n30_), .c(x18), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n37_), .O(new_n82_));
  inv1   g54(.a(new_n41_), .O(new_n83_));
