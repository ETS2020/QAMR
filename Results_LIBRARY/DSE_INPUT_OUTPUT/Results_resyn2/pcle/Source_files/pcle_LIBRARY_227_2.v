...
module FAU ( 
  ...
  nand3  g26(.a(new_n54_), .b(new_n34_), .c(new_n32_), .O(new_n55_));
  ...
  xnor2a g35(.a(x15), .b(x14), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n35_), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand2  g38(.a(new_n34_), .b(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n65_), .c(new_n32_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n63_), .c(new_n41_), .O(z5));
  nand2  g41(.a(new_n37_), .b(new_n35_), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  nand2  g43(.a(x15), .b(x14), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n34_), .c(new_n71_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n70_), .c(new_n32_), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x05), .c(new_n41_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n74_), .O(z6));
  oai21  g48(.a(new_n36_), .b(new_n34_), .c(new_n40_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n38_), .c(new_n32_), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x06), .c(new_n41_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z7));
  nand3  g52(.a(new_n38_), .b(new_n32_), .c(x18), .O(new_n81_));
  nand2  g53(.a(x08), .b(x07), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n41_), .c(new_n81_), .O(z8));
endmodule
