...
module FAU ( 
  ...
  nor2   g12(.a(new_n38_), .b(new_n29_), .O(new_n41_));
  nand2  g13(.a(new_n41_), .b(x01), .O(new_n42_));
  xnor2a g14(.a(x12), .b(x11), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(new_n31_), .c(new_n42_), .O(z2));
  oai21  g16(.a(new_n38_), .b(x02), .c(x08), .O(new_n45_));
  ...
  nand2  g24(.a(new_n41_), .b(x03), .O(new_n53_));
  ...
  nand2  g29(.a(new_n41_), .b(x04), .O(new_n58_));
  ...
  nand2  g35(.a(new_n41_), .b(x05), .O(new_n64_));
  ...
  nand2  g46(.a(new_n41_), .b(x07), .O(new_n75_));
  oai21  g47(.a(new_n34_), .b(new_n32_), .c(new_n38_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n36_), .c(new_n46_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n75_), .O(z8));
endmodule
