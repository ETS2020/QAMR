...
module FAU ( 
  ...
  nand3  g27(.a(new_n50_), .b(x14), .c(x13), .O(new_n56_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n62_), .c(new_n39_), .O(z5));
  inv1   g40(.a(x16), .O(new_n69_));
  nor2   g41(.a(new_n64_), .b(new_n69_), .O(new_n70_));
  oai21  g42(.a(new_n34_), .b(new_n65_), .c(new_n69_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n33_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x05), .c(new_n39_), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(new_n70_), .c(new_n73_), .O(z6));
  inv1   g46(.a(new_n39_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x08), .c(x06), .O(new_n76_));
  aoi21  g48(.a(new_n36_), .b(new_n29_), .c(x17), .O(new_n77_));
  nand4  g49(.a(new_n63_), .b(x17), .c(x16), .d(x15), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n33_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(z7));
  nand3  g52(.a(new_n75_), .b(x08), .c(x07), .O(new_n81_));
  xor2a  g53(.a(new_n36_), .b(new_n29_), .O(new_n82_));
  nand2  g54(.a(new_n33_), .b(x17), .O(new_n83_));
