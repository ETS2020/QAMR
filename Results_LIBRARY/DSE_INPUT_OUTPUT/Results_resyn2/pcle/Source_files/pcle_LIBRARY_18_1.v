...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(new_n35_), .c(new_n46_), .O(new_n49_));
  aoi21  g21(.a(x08), .b(x01), .c(new_n39_), .O(new_n50_));
  ...
  nand4  g27(.a(new_n55_), .b(new_n54_), .c(new_n43_), .d(new_n33_), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n52_), .c(new_n39_), .O(z3));
  ...
  nand4  g33(.a(new_n61_), .b(new_n59_), .c(new_n43_), .d(new_n33_), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n58_), .c(new_n39_), .O(z4));
  inv1   g35(.a(x15), .O(new_n64_));
  nor2   g36(.a(new_n59_), .b(new_n64_), .O(new_n65_));
  nand2  g37(.a(new_n59_), .b(new_n64_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n43_), .c(new_n33_), .O(new_n67_));
  inv1   g39(.a(x17), .O(new_n68_));
  aoi22  g40(.a(x18), .b(new_n68_), .c(x08), .d(x04), .O(new_n69_));
  oai21  g41(.a(new_n67_), .b(new_n65_), .c(new_n69_), .O(z5));
  inv1   g42(.a(x16), .O(new_n71_));
  nand4  g43(.a(x15), .b(x14), .c(x12), .d(x11), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n53_), .c(new_n71_), .O(new_n73_));
