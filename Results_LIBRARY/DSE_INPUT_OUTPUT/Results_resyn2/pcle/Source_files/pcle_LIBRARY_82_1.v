...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x00), .c(new_n29_), .O(z0));
  nor2   g11(.a(new_n29_), .b(x00), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n52_), .c(new_n40_), .O(z4));
  ...
  nand3  g38(.a(new_n66_), .b(new_n59_), .c(x16), .O(new_n67_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n65_), .c(new_n40_), .O(z6));
  nand3  g43(.a(new_n36_), .b(x17), .c(x16), .O(new_n72_));
  ...
  nand3  g49(.a(new_n37_), .b(new_n36_), .c(x18), .O(new_n78_));
  nand3  g50(.a(new_n37_), .b(new_n66_), .c(new_n59_), .O(new_n79_));
