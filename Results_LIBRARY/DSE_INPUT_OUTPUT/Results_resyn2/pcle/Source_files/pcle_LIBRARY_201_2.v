...
module FAU ( 
  ...
  nand2  g05(.a(new_n33_), .b(x18), .O(new_n34_));
  nand4  g06(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n35_));
  inv1   g07(.a(new_n35_), .O(new_n36_));
  nand3  g08(.a(new_n36_), .b(x16), .c(x15), .O(new_n37_));
  ...
  inv1   g24(.a(new_n40_), .O(new_n53_));
  nand3  g25(.a(new_n53_), .b(x08), .c(x03), .O(new_n54_));
  inv1   g26(.a(x14), .O(new_n55_));
  nand2  g27(.a(new_n49_), .b(new_n55_), .O(new_n56_));
  nand4  g28(.a(new_n56_), .b(new_n53_), .c(new_n35_), .d(new_n33_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n54_), .O(z4));
  inv1   g30(.a(x15), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(x14), .c(new_n31_), .O(new_n60_));
  nand4  g32(.a(x12), .b(x11), .c(x09), .d(new_n30_), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n60_), .c(x18), .O(new_n62_));
  ...
  aoi22  g37(.a(new_n65_), .b(new_n35_), .c(x08), .d(x04), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n63_), .O(z5));
  nand4  g39(.a(x11), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(x15), .c(x14), .d(x12), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n68_), .c(x18), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x13), .O(new_n72_));
  nand4  g44(.a(x16), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n73_));
  aoi21  g45(.a(new_n36_), .b(x15), .c(new_n73_), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x05), .c(new_n74_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n72_), .O(z6));
  inv1   g48(.a(x18), .O(new_n77_));
  inv1   g49(.a(new_n68_), .O(new_n78_));
  nand2  g50(.a(x14), .b(x12), .O(new_n79_));
  nand3  g51(.a(new_n29_), .b(x16), .c(x15), .O(new_n80_));
  nor2   g52(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n77_), .O(new_n82_));
  nand4  g54(.a(x17), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n83_));
  ...
  nor2   g59(.a(new_n37_), .b(new_n29_), .O(new_n88_));
  nand3  g60(.a(new_n53_), .b(x08), .c(x07), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(new_n34_), .c(new_n89_), .O(z8));
endmodule
