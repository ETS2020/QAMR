...
module FAU ( 
  ...
  oai21  g24(.a(new_n48_), .b(new_n45_), .c(new_n26_), .O(new_n49_));
  ...
  aoi21  g30(.a(x12), .b(new_n35_), .c(new_n54_), .O(z3));
  ...
  nand2  g34(.a(new_n58_), .b(new_n36_), .O(z4));
  inv1   g35(.a(x12), .O(new_n60_));
  nor2   g36(.a(x10), .b(x07), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n60_), .d(new_n35_), .O(z5));
  nand2  g38(.a(new_n32_), .b(new_n31_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n47_), .c(x09), .O(new_n64_));
  nand4  g40(.a(x09), .b(x03), .c(new_n27_), .d(new_n26_), .O(new_n65_));
  nand2  g41(.a(x08), .b(x00), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n65_), .d(new_n46_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n47_), .c(new_n64_), .O(z6));
  inv1   g45(.a(new_n36_), .O(new_n70_));
  and2   g46(.a(new_n65_), .b(new_n46_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(new_n32_), .b(x03), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(x10), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n71_), .c(new_n70_), .O(z7));
  nand2  g51(.a(new_n56_), .b(new_n44_), .O(new_n76_));
  nand3  g52(.a(new_n32_), .b(new_n60_), .c(x03), .O(new_n77_));
