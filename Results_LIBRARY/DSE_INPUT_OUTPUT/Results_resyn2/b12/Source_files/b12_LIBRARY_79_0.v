...
module FAU ( 
  ...
  aoi21  g17(.a(new_n41_), .b(new_n40_), .c(new_n36_), .O(new_n42_));
  oai21  g18(.a(new_n42_), .b(new_n30_), .c(new_n31_), .O(z2));
  inv1   g19(.a(x12), .O(new_n44_));
  nand2  g20(.a(x11), .b(x07), .O(new_n45_));
  oai21  g21(.a(new_n44_), .b(x00), .c(new_n45_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n31_), .O(z3));
  ...
  nand2  g27(.a(new_n45_), .b(new_n31_), .O(new_n52_));
  ...
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n48_), .d(new_n31_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z6));
  nand3  g36(.a(new_n57_), .b(new_n31_), .c(x08), .O(z7));
  nand4  g37(.a(new_n57_), .b(new_n31_), .c(new_n50_), .d(x00), .O(z8));
endmodule
