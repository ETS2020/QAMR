...
module FAU ( 
  ...
  nand2  g27(.a(new_n45_), .b(new_n34_), .O(new_n52_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n48_), .c(new_n34_), .O(new_n60_));
  nor2   g36(.a(new_n60_), .b(new_n58_), .O(z6));
  nand3  g37(.a(new_n59_), .b(new_n34_), .c(x08), .O(z7));
  nor2   g38(.a(x09), .b(new_n25_), .O(new_n63_));
  aoi22  g39(.a(new_n63_), .b(new_n59_), .c(new_n33_), .d(new_n32_), .O(z8));
endmodule
