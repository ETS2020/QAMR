...
module FAU ( 
  ...
  aoi21  g22(.a(new_n46_), .b(new_n28_), .c(x07), .O(new_n47_));
  ...
  nor2   g40(.a(x07), .b(x05), .O(new_n65_));
  ...
  nor3   g46(.a(x10), .b(x07), .c(x05), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n55_), .O(new_n72_));
  aoi21  g48(.a(new_n69_), .b(new_n68_), .c(new_n72_), .O(z6));
  nand4  g49(.a(x09), .b(x03), .c(new_n36_), .d(new_n35_), .O(new_n74_));
  oai21  g50(.a(new_n37_), .b(x01), .c(new_n53_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n71_), .O(z7));
  oai22  g52(.a(new_n74_), .b(x12), .c(x09), .d(new_n25_), .O(new_n77_));
