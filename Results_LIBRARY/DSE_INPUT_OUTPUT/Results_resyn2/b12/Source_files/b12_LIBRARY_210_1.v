...
module FAU ( 
  ...
  nand2  g34(.a(new_n54_), .b(new_n33_), .O(new_n59_));
  aoi21  g35(.a(new_n58_), .b(new_n43_), .c(new_n59_), .O(z4));
  ...
  nand2  g40(.a(new_n42_), .b(new_n45_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(x01), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n57_), .c(new_n46_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n33_), .O(z6));
  nand2  g45(.a(new_n64_), .b(new_n26_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n46_), .O(z7));
  nand2  g51(.a(new_n42_), .b(x00), .O(new_n76_));
  aoi21  g52(.a(x02), .b(new_n32_), .c(new_n76_), .O(new_n77_));
  nand3  g53(.a(new_n53_), .b(x09), .c(new_n26_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n73_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n46_), .O(z8));
endmodule
