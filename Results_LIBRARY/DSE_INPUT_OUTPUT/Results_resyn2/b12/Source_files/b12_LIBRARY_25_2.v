...
module FAU ( 
  ...
  oai21  g26(.a(new_n49_), .b(new_n47_), .c(new_n50_), .O(z3));
  nand4  g27(.a(x09), .b(x08), .c(new_n37_), .d(x00), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n47_), .c(new_n50_), .O(z4));
  nor2   g30(.a(x12), .b(x10), .O(new_n55_));
  nor2   g31(.a(x07), .b(x00), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(new_n55_), .c(new_n50_), .d(x13), .O(z5));
  nand2  g33(.a(x09), .b(new_n32_), .O(new_n58_));
  nand2  g34(.a(new_n41_), .b(x03), .O(new_n59_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n63_), .c(new_n60_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  nand3  g44(.a(new_n42_), .b(new_n41_), .c(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n40_), .O(new_n70_));
  nand2  g46(.a(x03), .b(new_n36_), .O(new_n71_));
  nand2  g47(.a(new_n42_), .b(x08), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n71_), .c(new_n70_), .d(new_n36_), .O(z7));
  nand2  g50(.a(new_n41_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n36_), .b(x01), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n48_), .b(x09), .c(new_n40_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n71_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n42_), .O(z8));
endmodule
