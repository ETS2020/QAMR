...
module FAU ( 
  ...
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n40_), .O(z3));
  nand4  g30(.a(x09), .b(x08), .c(new_n42_), .d(x00), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n51_), .c(new_n40_), .O(z4));
  nor2   g33(.a(x12), .b(x10), .O(new_n58_));
  nor2   g34(.a(x07), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n40_), .d(x13), .O(z5));
  ...
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n61_), .d(new_n46_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n40_), .O(z6));
  nand2  g45(.a(x03), .b(new_n25_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n47_), .c(x05), .O(new_n71_));
  nand2  g47(.a(new_n46_), .b(x08), .O(new_n72_));
  aoi21  g48(.a(new_n64_), .b(x03), .c(new_n72_), .O(new_n73_));
  aoi21  g49(.a(new_n71_), .b(new_n26_), .c(new_n73_), .O(z7));
  inv1   g50(.a(new_n64_), .O(new_n75_));
  nand3  g51(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n76_));
  nand4  g52(.a(new_n52_), .b(x09), .c(x05), .d(x03), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n76_), .O(new_n78_));
