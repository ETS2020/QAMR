...
module FAU ( 
  ...
  nand2  g16(.a(new_n33_), .b(new_n25_), .O(new_n41_));
  ...
  aoi22  g26(.a(new_n50_), .b(new_n40_), .c(new_n44_), .d(new_n41_), .O(z2));
  inv1   g27(.a(x11), .O(new_n52_));
  nand2  g28(.a(x14), .b(new_n52_), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(x07), .c(x12), .d(new_n25_), .O(z3));
  nor2   g30(.a(new_n43_), .b(new_n25_), .O(new_n55_));
  nor2   g31(.a(new_n46_), .b(x07), .O(new_n56_));
  nor2   g32(.a(new_n32_), .b(new_n42_), .O(new_n57_));
  aoi22  g33(.a(new_n57_), .b(x11), .c(new_n56_), .d(new_n55_), .O(z4));
  inv1   g34(.a(x12), .O(new_n59_));
  nand4  g35(.a(new_n47_), .b(x13), .c(new_n59_), .d(new_n25_), .O(new_n60_));
  and2   g36(.a(new_n60_), .b(new_n33_), .O(z5));
  oai21  g37(.a(new_n27_), .b(x00), .c(new_n42_), .O(new_n62_));
  nor2   g38(.a(x02), .b(x01), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  aoi21  g41(.a(x08), .b(x00), .c(x10), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(new_n42_), .c(new_n62_), .d(x14), .O(z6));
  inv1   g44(.a(new_n57_), .O(new_n69_));
  inv1   g45(.a(x10), .O(new_n70_));
  nand3  g46(.a(new_n63_), .b(x09), .c(x03), .O(new_n71_));
  nand3  g47(.a(x03), .b(new_n40_), .c(new_n45_), .O(new_n72_));
  ...
  nand4  g52(.a(new_n63_), .b(new_n59_), .c(x09), .d(x03), .O(new_n77_));
  nand2  g53(.a(new_n46_), .b(x00), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(x10), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x07), .c(new_n69_), .O(z8));
endmodule
