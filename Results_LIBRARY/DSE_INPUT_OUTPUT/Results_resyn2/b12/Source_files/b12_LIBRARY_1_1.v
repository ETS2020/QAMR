...
module FAU ( 
  ...
  inv1   g36(.a(new_n33_), .O(new_n61_));
  nor2   g37(.a(x10), .b(x07), .O(new_n62_));
  nand3  g38(.a(x13), .b(new_n55_), .c(new_n25_), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n62_), .c(new_n61_), .O(z5));
  ...
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n62_), .d(new_n33_), .O(new_n70_));
  aoi21  g46(.a(new_n67_), .b(new_n66_), .c(new_n70_), .O(z6));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(new_n66_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n66_), .b(x09), .c(x03), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n62_), .d(new_n33_), .O(z7));
  oai22  g52(.a(new_n75_), .b(x12), .c(x09), .d(new_n25_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n62_), .c(new_n61_), .O(z8));
endmodule
