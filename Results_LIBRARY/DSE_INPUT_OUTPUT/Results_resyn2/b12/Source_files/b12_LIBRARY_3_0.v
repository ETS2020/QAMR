...
module FAU ( 
  ...
  oai21  g18(.a(new_n42_), .b(new_n29_), .c(new_n30_), .O(z2));
  ...
  nand4  g33(.a(x14), .b(x02), .c(x01), .d(new_n34_), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n48_), .d(new_n30_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z6));
  nand3  g36(.a(new_n57_), .b(new_n30_), .c(x08), .O(z7));
  nand4  g37(.a(new_n57_), .b(new_n30_), .c(new_n50_), .d(x00), .O(z8));
endmodule
