...
module FAU ( 
  ...
  nor2   g22(.a(x07), .b(x01), .O(new_n47_));
  ...
  nand3  g27(.a(x07), .b(new_n39_), .c(new_n32_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n27_), .O(new_n53_));
  nor2   g29(.a(x07), .b(new_n27_), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(new_n28_), .c(new_n53_), .d(new_n51_), .O(new_n55_));
  ...
  oai22  g35(.a(new_n59_), .b(new_n57_), .c(new_n28_), .d(x02), .O(z3));
  inv1   g36(.a(x07), .O(new_n61_));
  oai21  g37(.a(x08), .b(new_n61_), .c(new_n27_), .O(new_n62_));
  nand4  g38(.a(x09), .b(x08), .c(new_n61_), .d(x00), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n57_), .c(new_n62_), .O(z4));
  nor2   g41(.a(new_n28_), .b(x02), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n58_), .c(new_n45_), .O(new_n67_));
  nor3   g43(.a(new_n67_), .b(x07), .c(x00), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n66_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n28_), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  nand3  g52(.a(x14), .b(x01), .c(new_n51_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(x02), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n75_), .c(new_n71_), .O(z6));
  nand2  g55(.a(new_n27_), .b(new_n32_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n72_), .c(new_n28_), .O(new_n81_));
  oai21  g57(.a(new_n70_), .b(new_n66_), .c(new_n81_), .O(z7));
  nand2  g58(.a(new_n28_), .b(new_n27_), .O(new_n83_));
  nand4  g59(.a(new_n58_), .b(x09), .c(x03), .d(new_n32_), .O(new_n84_));
  nand2  g60(.a(new_n44_), .b(x00), .O(new_n85_));
  oai22  g61(.a(new_n85_), .b(new_n66_), .c(new_n84_), .d(new_n83_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n70_), .O(z8));
endmodule
