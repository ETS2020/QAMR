...
module FAU ( 
  ...
  nand3  g00(.a(x05), .b(x02), .c(x01), .O(new_n25_));
  ...
  nand3  g07(.a(new_n31_), .b(new_n29_), .c(new_n26_), .O(new_n32_));
  aoi21  g08(.a(new_n32_), .b(new_n25_), .c(x00), .O(z0));
  inv1   g09(.a(new_n25_), .O(new_n34_));
  nand2  g10(.a(new_n34_), .b(x06), .O(new_n35_));
  inv1   g11(.a(x01), .O(new_n36_));
  inv1   g12(.a(x02), .O(new_n37_));
  oai21  g13(.a(x04), .b(new_n36_), .c(new_n37_), .O(new_n38_));
  aoi21  g14(.a(new_n26_), .b(new_n27_), .c(x00), .O(new_n39_));
  ...
  nand2  g41(.a(x09), .b(new_n27_), .O(new_n66_));
  ...
  nand3  g46(.a(new_n58_), .b(new_n70_), .c(new_n43_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n68_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n56_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n36_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n26_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n37_), .O(new_n77_));
  nand3  g53(.a(x03), .b(new_n37_), .c(new_n36_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n44_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n48_), .O(z7));
  nand2  g56(.a(new_n47_), .b(x00), .O(new_n81_));
  aoi21  g57(.a(x04), .b(new_n37_), .c(new_n81_), .O(new_n82_));
  nand3  g58(.a(new_n53_), .b(x09), .c(new_n26_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(new_n78_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(z8));
endmodule
