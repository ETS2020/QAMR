...
module FAU ( 
  ...
  aoi21  g14(.a(new_n38_), .b(x02), .c(new_n30_), .O(new_n39_));
  nand3  g15(.a(x03), .b(new_n29_), .c(x01), .O(new_n40_));
  oai21  g16(.a(new_n39_), .b(new_n37_), .c(new_n40_), .O(new_n41_));
  ...
  nand4  g27(.a(new_n51_), .b(new_n50_), .c(x06), .d(new_n47_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n29_), .c(new_n46_), .O(z2));
  ...
  nor2   g33(.a(new_n45_), .b(new_n36_), .O(new_n58_));
  nor2   g34(.a(new_n48_), .b(x07), .O(new_n59_));
  nand2  g35(.a(new_n55_), .b(new_n31_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z4));
  nor2   g37(.a(x12), .b(x10), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n44_), .d(new_n36_), .O(new_n63_));
  and2   g39(.a(new_n63_), .b(new_n31_), .O(z5));
  nor2   g40(.a(new_n48_), .b(x03), .O(new_n65_));
  inv1   g41(.a(x03), .O(new_n66_));
  oai21  g42(.a(x09), .b(new_n66_), .c(new_n47_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n65_), .c(x06), .O(new_n68_));
  inv1   g44(.a(new_n58_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n36_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n49_), .O(new_n71_));
  aoi21  g47(.a(new_n68_), .b(new_n29_), .c(new_n71_), .O(z6));
  nand2  g48(.a(x03), .b(new_n47_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n50_), .c(x06), .O(new_n74_));
  nand2  g50(.a(new_n49_), .b(x08), .O(new_n75_));
  aoi21  g51(.a(new_n32_), .b(x03), .c(new_n75_), .O(new_n76_));
  aoi21  g52(.a(new_n74_), .b(new_n29_), .c(new_n76_), .O(z7));
  nand3  g53(.a(new_n31_), .b(new_n48_), .c(x00), .O(new_n78_));
  nand4  g54(.a(new_n54_), .b(x09), .c(x06), .d(x03), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n33_), .c(new_n78_), .O(new_n80_));
