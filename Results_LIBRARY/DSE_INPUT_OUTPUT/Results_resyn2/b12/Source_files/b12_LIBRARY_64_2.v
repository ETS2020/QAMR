...
module FAU ( 
  ...
  and2   g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g46(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n59_), .c(new_n45_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n70_), .c(new_n33_), .O(z6));
  inv1   g49(.a(x08), .O(new_n74_));
  nand3  g50(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  and2   g52(.a(x09), .b(x03), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n68_), .c(new_n49_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(new_n64_), .O(z7));
  nand3  g55(.a(new_n77_), .b(new_n68_), .c(new_n55_), .O(new_n80_));
  nand3  g56(.a(new_n33_), .b(new_n44_), .c(x00), .O(new_n81_));
