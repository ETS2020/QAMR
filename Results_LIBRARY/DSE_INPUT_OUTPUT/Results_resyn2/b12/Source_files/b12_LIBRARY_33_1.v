...
module FAU ( 
  ...
  nand2  g29(.a(new_n51_), .b(new_n34_), .O(new_n54_));
  ...
  nand4  g36(.a(new_n60_), .b(new_n59_), .c(new_n34_), .d(x13), .O(z5));
  nand2  g37(.a(x09), .b(x03), .O(new_n62_));
  nand2  g38(.a(new_n41_), .b(new_n29_), .O(new_n63_));
  ...
  nand2  g44(.a(new_n62_), .b(new_n28_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n33_), .O(new_n70_));
  oai21  g46(.a(new_n29_), .b(x01), .c(new_n46_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z7));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n42_), .c(new_n40_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n62_), .c(new_n28_), .O(new_n75_));
  nand3  g51(.a(new_n65_), .b(new_n41_), .c(x00), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n75_), .b(new_n33_), .c(new_n77_), .O(z8));
endmodule
