...
module FAU ( 
  ...
  nand4  g36(.a(new_n44_), .b(x13), .c(new_n55_), .d(new_n25_), .O(z5));
  ...
  nand4  g43(.a(x09), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n68_));
  inv1   g44(.a(x08), .O(new_n69_));
  nand3  g45(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n68_), .c(new_n44_), .O(z7));
  oai22  g48(.a(new_n68_), .b(x12), .c(x09), .d(new_n25_), .O(new_n73_));
