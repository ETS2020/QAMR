...
module FAU ( 
  ...
  aoi21  g02(.a(new_n25_), .b(x02), .c(new_n26_), .O(new_n27_));
  ...
  nand3  g21(.a(x07), .b(new_n32_), .c(new_n35_), .O(new_n46_));
  ...
  nand2  g26(.a(new_n29_), .b(x10), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n36_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n49_), .c(new_n33_), .O(z2));
  inv1   g30(.a(x07), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x03), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(x11), .c(x12), .d(new_n35_), .O(z3));
  inv1   g33(.a(x09), .O(new_n58_));
  oai21  g34(.a(new_n48_), .b(new_n58_), .c(new_n55_), .O(new_n59_));
  inv1   g35(.a(x11), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x07), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n59_), .c(new_n33_), .O(z4));
  nor2   g38(.a(x12), .b(x10), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n55_), .d(new_n35_), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n33_), .O(z5));
  xor2a  g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n36_), .b(new_n43_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n48_), .c(new_n44_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n33_), .O(z6));
  nand2  g47(.a(new_n33_), .b(x08), .O(new_n72_));
  oai21  g48(.a(new_n67_), .b(new_n32_), .c(new_n72_), .O(new_n73_));
  nand4  g49(.a(x09), .b(x03), .c(new_n36_), .d(new_n43_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n44_), .O(z7));
  nand3  g51(.a(new_n33_), .b(new_n58_), .c(x00), .O(new_n76_));
