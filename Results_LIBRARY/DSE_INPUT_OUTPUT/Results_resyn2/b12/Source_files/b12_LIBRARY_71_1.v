...
module FAU ( 
  ...
  nand3  g23(.a(new_n47_), .b(new_n43_), .c(new_n26_), .O(new_n48_));
  oai21  g24(.a(x08), .b(x07), .c(x00), .O(new_n49_));
  oai21  g25(.a(x02), .b(new_n32_), .c(new_n49_), .O(new_n50_));
  aoi21  g26(.a(new_n48_), .b(new_n32_), .c(new_n50_), .O(z2));
  ...
  nor2   g34(.a(new_n41_), .b(x07), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(new_n56_), .O(z4));
  inv1   g36(.a(x12), .O(new_n61_));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n61_), .d(new_n45_), .O(new_n63_));
  and2   g39(.a(new_n63_), .b(new_n33_), .O(z5));
  nand2  g40(.a(x14), .b(new_n25_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(x01), .c(new_n26_), .O(new_n66_));
  inv1   g42(.a(x03), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n41_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n32_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n57_), .c(new_n42_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n66_), .O(z6));
  oai21  g48(.a(new_n69_), .b(new_n46_), .c(new_n26_), .O(new_n73_));
  nand2  g49(.a(new_n42_), .b(x08), .O(new_n74_));
  aoi21  g50(.a(x03), .b(new_n32_), .c(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n73_), .b(new_n32_), .c(new_n75_), .O(z7));
  inv1   g52(.a(new_n43_), .O(new_n77_));
  nand3  g53(.a(new_n61_), .b(x09), .c(x03), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n46_), .c(new_n26_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n32_), .c(new_n77_), .d(x00), .O(z8));
endmodule
