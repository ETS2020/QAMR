...
module FAU ( 
  ...
  nand2  g07(.a(x11), .b(x03), .O(new_n32_));
  ...
  nand3  g26(.a(new_n50_), .b(new_n49_), .c(new_n42_), .O(new_n51_));
  oai21  g27(.a(x08), .b(x07), .c(x00), .O(new_n52_));
  nor2   g28(.a(x10), .b(x09), .O(new_n53_));
  nand2  g29(.a(new_n47_), .b(new_n42_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n53_), .c(new_n34_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n51_), .c(new_n32_), .O(z2));
  nand2  g33(.a(new_n44_), .b(new_n47_), .O(new_n58_));
  aoi22  g34(.a(new_n58_), .b(x11), .c(x12), .d(new_n25_), .O(z3));
  oai21  g35(.a(new_n50_), .b(new_n43_), .c(new_n44_), .O(new_n60_));
  inv1   g36(.a(x11), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x07), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n60_), .c(new_n32_), .O(z4));
  nor2   g39(.a(x12), .b(x10), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n44_), .d(new_n25_), .O(new_n65_));
  and2   g41(.a(new_n65_), .b(new_n32_), .O(z5));
  nand2  g42(.a(new_n34_), .b(new_n42_), .O(new_n67_));
  ...
  nand4  g46(.a(new_n70_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n32_), .O(z6));
  oai21  g48(.a(new_n67_), .b(new_n43_), .c(new_n61_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x03), .O(new_n74_));
  inv1   g50(.a(x08), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n34_), .c(new_n42_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(new_n46_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(z7));
  oai21  g54(.a(new_n76_), .b(x12), .c(x09), .O(new_n79_));
  oai21  g55(.a(x09), .b(x03), .c(x11), .O(new_n80_));
  aoi21  g56(.a(new_n43_), .b(new_n25_), .c(new_n46_), .O(new_n81_));
