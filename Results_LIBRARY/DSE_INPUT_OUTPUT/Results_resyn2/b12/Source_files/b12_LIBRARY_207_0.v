...
module FAU ( 
  ...
  nand4  g15(.a(x14), .b(x03), .c(new_n25_), .d(x01), .O(new_n40_));
  ...
  nand4  g25(.a(new_n49_), .b(new_n46_), .c(x14), .d(new_n45_), .O(new_n50_));
  ...
  nor2   g30(.a(x14), .b(x02), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n54_), .b(new_n52_), .c(new_n56_), .O(z3));
  nand4  g33(.a(x09), .b(x08), .c(new_n42_), .d(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n52_), .c(new_n56_), .O(z4));
  nor2   g36(.a(x07), .b(x00), .O(new_n61_));
  inv1   g37(.a(x10), .O(new_n62_));
  nand3  g38(.a(x13), .b(new_n53_), .c(new_n62_), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n61_), .c(new_n55_), .O(z5));
  ...
  nand4  g46(.a(x14), .b(x02), .c(x01), .d(new_n26_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(new_n72_));
  aoi21  g48(.a(new_n69_), .b(new_n25_), .c(new_n72_), .O(z6));
  nand3  g49(.a(x09), .b(x03), .c(new_n45_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x14), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(z7));
  nand2  g55(.a(new_n47_), .b(x00), .O(new_n80_));
  nand3  g56(.a(x14), .b(new_n53_), .c(x09), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n77_), .c(new_n80_), .d(new_n55_), .O(new_n82_));
