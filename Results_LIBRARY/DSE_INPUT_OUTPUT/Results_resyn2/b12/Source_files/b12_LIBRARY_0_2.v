...
module FAU ( 
  ...
  nor3   g32(.a(new_n37_), .b(x07), .c(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n51_), .d(new_n43_), .O(z5));
  xor2a  g34(.a(x09), .b(x03), .O(new_n59_));
  nor3   g35(.a(new_n59_), .b(x02), .c(x01), .O(new_n60_));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n32_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n40_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n60_), .c(new_n38_), .O(z6));
  aoi21  g40(.a(x03), .b(new_n27_), .c(x08), .O(new_n65_));
  nand3  g41(.a(x09), .b(x03), .c(new_n27_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n65_), .c(new_n25_), .O(new_n68_));
  inv1   g44(.a(new_n40_), .O(new_n69_));
  nor2   g45(.a(x08), .b(new_n25_), .O(new_n70_));
  nor2   g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n68_), .c(new_n37_), .O(z7));
  inv1   g48(.a(x09), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x00), .O(new_n74_));
  nand2  g50(.a(new_n51_), .b(new_n25_), .O(new_n75_));
  oai22  g51(.a(new_n75_), .b(new_n66_), .c(new_n74_), .d(new_n37_), .O(new_n76_));
