...
module FAU ( 
  ...
  oai21  g05(.a(new_n28_), .b(x01), .c(new_n29_), .O(new_n30_));
  nor3   g06(.a(new_n30_), .b(new_n27_), .c(new_n26_), .O(z0));
  inv1   g07(.a(x01), .O(new_n32_));
  aoi21  g08(.a(x03), .b(new_n25_), .c(x02), .O(new_n33_));
  nor2   g09(.a(x04), .b(x03), .O(new_n34_));
  nand2  g10(.a(x02), .b(new_n25_), .O(new_n35_));
  oai22  g11(.a(new_n35_), .b(new_n34_), .c(new_n33_), .d(new_n32_), .O(z1));
  ...
  nand2  g20(.a(new_n44_), .b(new_n32_), .O(new_n45_));
  aoi21  g21(.a(new_n43_), .b(new_n38_), .c(new_n45_), .O(z2));
  ...
  nand2  g30(.a(new_n48_), .b(new_n29_), .O(new_n55_));
  aoi21  g31(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n29_), .d(x13), .O(z5));
  nand2  g35(.a(x09), .b(new_n39_), .O(new_n60_));
  nand2  g36(.a(new_n53_), .b(x03), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n27_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n51_), .c(new_n37_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n29_), .O(z6));
  inv1   g40(.a(x08), .O(new_n65_));
  oai21  g41(.a(new_n39_), .b(x02), .c(new_n65_), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x02), .c(x01), .O(new_n67_));
  nand3  g43(.a(new_n27_), .b(x09), .c(x03), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n37_), .O(z7));
  nand3  g45(.a(new_n29_), .b(new_n53_), .c(x00), .O(new_n70_));
