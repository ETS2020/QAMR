...
module FAU ( 
  ...
  nand2  g09(.a(x11), .b(x06), .O(new_n34_));
  ...
  aoi21  g21(.a(new_n45_), .b(new_n44_), .c(x03), .O(new_n46_));
  nand3  g22(.a(new_n45_), .b(x09), .c(new_n44_), .O(new_n47_));
  inv1   g23(.a(new_n47_), .O(new_n48_));
  oai21  g24(.a(new_n48_), .b(new_n46_), .c(new_n26_), .O(new_n49_));
  oai21  g25(.a(x08), .b(x07), .c(x00), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n34_), .O(new_n51_));
  aoi21  g27(.a(new_n49_), .b(new_n27_), .c(new_n51_), .O(z2));
  ...
  and2   g37(.a(new_n61_), .b(new_n34_), .O(z5));
  xor2a  g38(.a(x09), .b(x03), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(new_n28_), .O(new_n64_));
  nand2  g40(.a(x08), .b(x00), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n33_), .O(new_n66_));
  nand3  g42(.a(new_n34_), .b(new_n45_), .c(new_n44_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(new_n64_), .O(z6));
  nand4  g46(.a(x09), .b(x03), .c(new_n27_), .d(new_n26_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand3  g48(.a(x03), .b(new_n27_), .c(new_n26_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n68_), .O(z7));
  oai22  g51(.a(new_n71_), .b(x12), .c(x09), .d(new_n33_), .O(new_n76_));
