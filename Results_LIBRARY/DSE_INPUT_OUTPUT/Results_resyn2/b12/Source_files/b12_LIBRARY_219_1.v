...
module FAU ( 
  ...
  aoi21  g02(.a(x03), .b(new_n26_), .c(new_n25_), .O(new_n27_));
  ...
  aoi21  g08(.a(new_n32_), .b(new_n29_), .c(new_n27_), .O(z0));
  inv1   g09(.a(x03), .O(new_n34_));
  nand3  g10(.a(x06), .b(x05), .c(x01), .O(new_n35_));
  nand2  g11(.a(new_n35_), .b(new_n25_), .O(new_n36_));
  aoi22  g12(.a(new_n36_), .b(x02), .c(new_n28_), .d(new_n34_), .O(z1));
  ...
  nor2   g21(.a(x03), .b(x02), .O(new_n46_));
  aoi22  g22(.a(new_n46_), .b(new_n45_), .c(new_n40_), .d(new_n27_), .O(z2));
  nand2  g23(.a(x03), .b(new_n26_), .O(new_n48_));
  ...
  nand2  g29(.a(x09), .b(new_n38_), .O(new_n54_));
  ...
  nand3  g36(.a(new_n42_), .b(new_n26_), .c(new_n41_), .O(new_n61_));
  nor2   g37(.a(x10), .b(x07), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n61_), .c(new_n60_), .d(new_n53_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n48_), .O(z6));
  nand3  g40(.a(new_n62_), .b(new_n48_), .c(x08), .O(z7));
  inv1   g41(.a(new_n44_), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(x00), .c(x03), .d(new_n26_), .O(z8));
endmodule
