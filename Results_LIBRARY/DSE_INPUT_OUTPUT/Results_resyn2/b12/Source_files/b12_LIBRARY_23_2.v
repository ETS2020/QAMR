...
module FAU ( 
  ...
  nand2  g11(.a(new_n35_), .b(x11), .O(new_n36_));
  ...
  nor2   g30(.a(new_n35_), .b(x07), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  aoi21  g32(.a(x12), .b(new_n34_), .c(new_n56_), .O(z3));
  ...
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n36_), .O(z4));
  nor3   g37(.a(x12), .b(x10), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n55_), .O(z5));
  ...
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n58_), .d(new_n64_), .O(new_n69_));
  ...
  and2   g50(.a(new_n64_), .b(new_n36_), .O(new_n75_));
