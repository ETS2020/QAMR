...
module FAU ( 
  ...
  nand3  g11(.a(x03), .b(new_n29_), .c(x01), .O(new_n36_));
  ...
  nand3  g26(.a(new_n50_), .b(new_n46_), .c(new_n28_), .O(new_n51_));
  ...
  oai21  g34(.a(new_n58_), .b(x07), .c(new_n25_), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(x09), .c(x11), .d(x07), .O(z4));
  inv1   g36(.a(new_n42_), .O(new_n61_));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  inv1   g38(.a(x12), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n63_), .c(new_n48_), .O(new_n64_));
  ...
  nand4  g45(.a(new_n69_), .b(new_n58_), .c(new_n45_), .d(new_n42_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(z6));
  nand3  g47(.a(x03), .b(new_n29_), .c(new_n28_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x09), .O(new_n74_));
  inv1   g50(.a(x08), .O(new_n75_));
  aoi21  g51(.a(new_n72_), .b(new_n75_), .c(new_n49_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(z7));
  nand2  g53(.a(new_n63_), .b(x09), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(new_n72_), .c(x09), .d(new_n35_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n45_), .c(new_n61_), .O(z8));
endmodule
