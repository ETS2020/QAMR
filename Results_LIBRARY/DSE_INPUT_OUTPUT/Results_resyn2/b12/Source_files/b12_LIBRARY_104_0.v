...
module FAU ( 
  ...
  nand2  g16(.a(new_n34_), .b(new_n25_), .O(new_n41_));
  aoi21  g17(.a(new_n40_), .b(new_n37_), .c(new_n41_), .O(z1));
  inv1   g18(.a(x01), .O(new_n43_));
  inv1   g19(.a(x07), .O(new_n44_));
  aoi21  g20(.a(new_n32_), .b(new_n44_), .c(x03), .O(new_n45_));
  nand3  g21(.a(new_n32_), .b(x09), .c(new_n44_), .O(new_n46_));
  inv1   g22(.a(new_n46_), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n43_), .O(new_n48_));
  ...
  nand2  g35(.a(new_n53_), .b(new_n34_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n57_), .c(new_n60_), .O(z4));
  nand4  g37(.a(x13), .b(new_n52_), .c(new_n44_), .d(new_n25_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x14), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n32_), .O(z5));
  nor2   g40(.a(x02), .b(x01), .O(new_n65_));
  xnor2a g41(.a(x09), .b(x03), .O(new_n66_));
  inv1   g42(.a(new_n59_), .O(new_n67_));
  nand3  g43(.a(x02), .b(x01), .c(new_n25_), .O(new_n68_));
  nand3  g44(.a(x14), .b(new_n32_), .c(new_n44_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n67_), .O(new_n71_));
  aoi21  g47(.a(new_n66_), .b(new_n65_), .c(new_n71_), .O(z6));
  nand4  g48(.a(x09), .b(x03), .c(new_n36_), .d(new_n43_), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n36_), .c(new_n43_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(z7));
  oai22  g52(.a(new_n73_), .b(x12), .c(x09), .d(new_n25_), .O(new_n77_));
