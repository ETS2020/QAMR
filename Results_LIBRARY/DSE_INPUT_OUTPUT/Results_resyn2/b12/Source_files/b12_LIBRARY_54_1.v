...
module FAU ( 
  ...
  nand2  g24(.a(x02), .b(new_n37_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n48_), .O(z3));
  nand2  g26(.a(x08), .b(x00), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  nor2   g28(.a(new_n38_), .b(x07), .O(new_n53_));
  nand2  g29(.a(new_n49_), .b(new_n47_), .O(new_n54_));
  aoi21  g30(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(z4));
  inv1   g31(.a(x10), .O(new_n56_));
  nor2   g32(.a(x07), .b(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n46_), .d(new_n56_), .O(new_n58_));
  and2   g34(.a(new_n58_), .b(new_n49_), .O(z5));
  ...
  nand2  g38(.a(new_n38_), .b(x03), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n37_), .O(new_n64_));
  inv1   g40(.a(x07), .O(new_n65_));
  nand3  g41(.a(new_n51_), .b(new_n56_), .c(new_n65_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n61_), .O(z6));
  nand2  g45(.a(new_n56_), .b(new_n65_), .O(new_n70_));
  oai21  g46(.a(new_n63_), .b(new_n70_), .c(new_n27_), .O(new_n71_));
  nand3  g47(.a(new_n56_), .b(x08), .c(new_n65_), .O(new_n72_));
  aoi21  g48(.a(x03), .b(new_n37_), .c(new_n72_), .O(new_n73_));
  aoi21  g49(.a(new_n71_), .b(new_n37_), .c(new_n73_), .O(z7));
  nand3  g50(.a(new_n46_), .b(x09), .c(x03), .O(new_n75_));
