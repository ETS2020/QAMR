...
module FAU ( 
  ...
  nand2  g45(.a(new_n69_), .b(new_n31_), .O(z6));
  nand3  g46(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n42_), .O(new_n72_));
  nand3  g48(.a(new_n58_), .b(x08), .c(new_n39_), .O(new_n73_));
  aoi21  g49(.a(x03), .b(new_n30_), .c(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n30_), .c(new_n74_), .O(z7));
  nand2  g51(.a(new_n43_), .b(x00), .O(new_n76_));
  aoi21  g52(.a(new_n30_), .b(x01), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(x03), .b(new_n30_), .O(new_n78_));
  nand3  g54(.a(new_n59_), .b(x09), .c(new_n42_), .O(new_n79_));
