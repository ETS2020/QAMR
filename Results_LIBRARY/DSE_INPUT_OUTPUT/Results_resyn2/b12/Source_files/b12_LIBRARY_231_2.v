...
module FAU ( 
  ...
  nor2   g29(.a(x12), .b(new_n39_), .O(new_n54_));
  ...
  nand4  g39(.a(new_n63_), .b(new_n43_), .c(x13), .d(new_n51_), .O(z5));
  ...
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n65_), .O(z6));
  ...
  oai22  g52(.a(new_n76_), .b(new_n54_), .c(new_n72_), .d(x12), .O(new_n77_));
