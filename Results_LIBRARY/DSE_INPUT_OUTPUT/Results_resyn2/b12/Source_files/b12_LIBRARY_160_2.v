...
module FAU ( 
  ...
  aoi21  g35(.a(new_n59_), .b(x02), .c(new_n41_), .O(new_n60_));
  nand2  g36(.a(x09), .b(new_n34_), .O(new_n61_));
  nand2  g37(.a(new_n42_), .b(x03), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n31_), .O(new_n63_));
  nand2  g39(.a(x08), .b(x00), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n55_), .c(new_n38_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n60_), .O(z6));
  nand2  g44(.a(new_n55_), .b(new_n38_), .O(new_n69_));
  oai21  g45(.a(new_n62_), .b(new_n69_), .c(new_n41_), .O(new_n70_));
  nand3  g46(.a(new_n55_), .b(x08), .c(new_n38_), .O(new_n71_));
  aoi21  g47(.a(x03), .b(new_n31_), .c(new_n71_), .O(new_n72_));
  aoi21  g48(.a(new_n70_), .b(new_n31_), .c(new_n72_), .O(z7));
  nand3  g49(.a(new_n49_), .b(x09), .c(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n69_), .c(new_n41_), .O(new_n75_));
  nand3  g51(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n75_), .b(new_n31_), .c(new_n77_), .O(z8));
endmodule
