...
module FAU ( 
  ...
  oai21  g19(.a(x10), .b(new_n43_), .c(new_n32_), .O(new_n44_));
  ...
  aoi21  g25(.a(x10), .b(new_n32_), .c(x02), .O(new_n50_));
  aoi22  g26(.a(new_n50_), .b(new_n49_), .c(new_n44_), .d(x00), .O(z2));
  and2   g27(.a(x11), .b(x07), .O(new_n52_));
  inv1   g28(.a(x12), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(x00), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n33_), .c(new_n52_), .O(z3));
  nand3  g31(.a(x09), .b(new_n32_), .c(x00), .O(new_n56_));
  nor3   g32(.a(new_n56_), .b(x10), .c(new_n43_), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(new_n52_), .O(z4));
  nand3  g34(.a(x13), .b(new_n53_), .c(new_n25_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x10), .c(new_n32_), .O(z5));
  inv1   g37(.a(x03), .O(new_n62_));
  nand2  g38(.a(x09), .b(new_n62_), .O(new_n63_));
  nand2  g39(.a(new_n47_), .b(x03), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n35_), .d(new_n45_), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n66_));
  nor2   g42(.a(x10), .b(x07), .O(new_n67_));
  nand2  g43(.a(x08), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(z6));
  nand3  g46(.a(x03), .b(new_n35_), .c(new_n45_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n43_), .O(new_n72_));
  nand4  g48(.a(x09), .b(x03), .c(new_n35_), .d(new_n45_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n67_), .O(z7));
  aoi21  g50(.a(new_n47_), .b(x00), .c(x10), .O(new_n75_));
  oai21  g51(.a(new_n73_), .b(x12), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n32_), .O(z8));
endmodule
