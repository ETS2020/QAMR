...
module FAU ( 
  ...
  aoi21  g25(.a(new_n46_), .b(new_n42_), .c(new_n49_), .O(z2));
  ...
  aoi21  g33(.a(new_n57_), .b(new_n41_), .c(new_n55_), .O(z4));
  nor2   g34(.a(new_n26_), .b(x01), .O(new_n59_));
  nor2   g35(.a(x07), .b(x00), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  nand3  g37(.a(x13), .b(new_n61_), .c(new_n39_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n60_), .c(new_n59_), .O(z5));
  nor2   g40(.a(x10), .b(x07), .O(new_n65_));
  nand2  g41(.a(new_n40_), .b(x03), .O(new_n66_));
  ...
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n56_), .d(new_n65_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n33_), .O(z6));
  oai21  g47(.a(new_n66_), .b(new_n45_), .c(new_n26_), .O(new_n72_));
  nand2  g48(.a(x03), .b(new_n32_), .O(new_n73_));
  nand2  g49(.a(new_n65_), .b(x08), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n32_), .O(z7));
  nand2  g52(.a(new_n40_), .b(x00), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  nand3  g54(.a(new_n61_), .b(x09), .c(new_n26_), .O(new_n79_));
  nor2   g55(.a(new_n79_), .b(new_n73_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n65_), .O(z8));
endmodule
