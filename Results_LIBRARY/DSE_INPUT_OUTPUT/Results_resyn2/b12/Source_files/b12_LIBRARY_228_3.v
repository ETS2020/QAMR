...
module FAU ( 
  ...
  nand2  g23(.a(x02), .b(x01), .O(new_n48_));
  and2   g24(.a(x11), .b(x07), .O(new_n49_));
  aoi21  g25(.a(x12), .b(new_n30_), .c(new_n49_), .O(new_n50_));
  ...
  oai21  g30(.a(new_n54_), .b(new_n49_), .c(new_n48_), .O(z4));
  nor2   g31(.a(x12), .b(x10), .O(new_n56_));
  nor2   g32(.a(x07), .b(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n48_), .d(x13), .O(z5));
  nor2   g34(.a(x02), .b(x01), .O(new_n59_));
  xnor2a g35(.a(x09), .b(x03), .O(new_n60_));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n48_), .c(new_n39_), .O(new_n62_));
  aoi21  g38(.a(new_n60_), .b(new_n59_), .c(new_n62_), .O(z6));
  nand2  g39(.a(new_n59_), .b(x03), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n44_), .O(new_n65_));
  nand3  g41(.a(new_n59_), .b(x09), .c(x03), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n48_), .d(new_n39_), .O(z7));
  inv1   g43(.a(new_n48_), .O(new_n68_));
  nand2  g44(.a(new_n38_), .b(x00), .O(new_n69_));
  inv1   g45(.a(x12), .O(new_n70_));
  nand4  g46(.a(new_n59_), .b(new_n70_), .c(x09), .d(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n39_), .c(new_n68_), .O(z8));
endmodule
