...
module FAU ( 
  ...
  oai21  g10(.a(new_n34_), .b(new_n26_), .c(x02), .O(new_n35_));
  ...
  nand4  g17(.a(new_n41_), .b(new_n38_), .c(x13), .d(x02), .O(new_n42_));
  ...
  nand2  g28(.a(new_n26_), .b(x02), .O(new_n53_));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n44_), .d(new_n25_), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n53_), .O(z5));
  xor2a  g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n30_), .b(new_n28_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n59_), .c(new_n48_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n53_), .O(z6));
  nand4  g47(.a(x09), .b(x03), .c(new_n30_), .d(new_n28_), .O(new_n72_));
  oai21  g48(.a(new_n39_), .b(x01), .c(new_n45_), .O(new_n73_));
  oai21  g49(.a(new_n26_), .b(new_n45_), .c(x02), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n48_), .O(z7));
  nand3  g51(.a(new_n53_), .b(new_n47_), .c(x00), .O(new_n76_));
