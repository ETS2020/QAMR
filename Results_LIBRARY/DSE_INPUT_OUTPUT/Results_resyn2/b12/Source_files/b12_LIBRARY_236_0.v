...
module FAU ( 
  ...
  nand2  g22(.a(new_n44_), .b(new_n31_), .O(new_n47_));
  ...
  nand4  g30(.a(new_n54_), .b(new_n53_), .c(new_n31_), .d(x13), .O(z5));
  nor2   g31(.a(new_n30_), .b(new_n29_), .O(new_n56_));
  ...
  aoi22  g36(.a(new_n60_), .b(new_n56_), .c(new_n58_), .d(new_n31_), .O(z6));
