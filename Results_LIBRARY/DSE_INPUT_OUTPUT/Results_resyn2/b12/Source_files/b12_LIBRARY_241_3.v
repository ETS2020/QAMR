...
module FAU ( 
  ...
  aoi22  g45(.a(new_n69_), .b(new_n68_), .c(new_n46_), .d(new_n40_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(z7));
  nand3  g47(.a(new_n46_), .b(new_n52_), .c(x00), .O(new_n72_));
  nand3  g48(.a(new_n55_), .b(x09), .c(new_n42_), .O(new_n73_));
