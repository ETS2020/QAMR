...
module FAU ( 
  ...
  aoi21  g20(.a(new_n43_), .b(new_n42_), .c(new_n44_), .O(new_n45_));
  aoi21  g21(.a(new_n41_), .b(new_n25_), .c(new_n45_), .O(z2));
  nor2   g22(.a(new_n25_), .b(new_n36_), .O(new_n47_));
  ...
  nand4  g32(.a(new_n56_), .b(x13), .c(new_n42_), .d(new_n29_), .O(new_n57_));
  ...
  oai21  g38(.a(new_n43_), .b(new_n29_), .c(new_n38_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n48_), .O(z6));
  oai21  g40(.a(new_n60_), .b(new_n26_), .c(new_n43_), .O(new_n65_));
  nand3  g41(.a(new_n59_), .b(x09), .c(x03), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n48_), .d(new_n38_), .O(z7));
  nand2  g43(.a(new_n37_), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n59_), .b(new_n50_), .c(x09), .d(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n38_), .c(new_n47_), .O(z8));
endmodule
