...
module FAU ( 
  ...
  nand2  g13(.a(x13), .b(x02), .O(new_n38_));
  aoi21  g14(.a(new_n37_), .b(new_n36_), .c(new_n38_), .O(new_n39_));
  ...
  nor2   g34(.a(new_n45_), .b(new_n25_), .O(new_n59_));
  nor2   g35(.a(new_n48_), .b(x07), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z4));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n49_), .c(x13), .O(z5));
  inv1   g39(.a(new_n59_), .O(new_n64_));
  nand2  g40(.a(new_n48_), .b(x03), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n36_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n47_), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n64_), .d(new_n49_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n33_), .O(z6));
  oai21  g46(.a(new_n36_), .b(x01), .c(new_n45_), .O(new_n71_));
  oai21  g47(.a(new_n32_), .b(new_n45_), .c(x02), .O(new_n72_));
  inv1   g48(.a(x01), .O(new_n73_));
  nand4  g49(.a(x09), .b(x03), .c(new_n41_), .d(new_n73_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(new_n49_), .O(z7));
  inv1   g51(.a(new_n33_), .O(new_n76_));
  nand2  g52(.a(new_n48_), .b(x00), .O(new_n77_));
  oai21  g53(.a(new_n74_), .b(x12), .c(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n49_), .c(new_n76_), .O(z8));
endmodule
