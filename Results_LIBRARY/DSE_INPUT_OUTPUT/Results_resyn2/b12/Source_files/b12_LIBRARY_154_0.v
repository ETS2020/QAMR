...
module FAU ( 
  ...
  and2   g20(.a(x11), .b(x07), .O(new_n45_));
  inv1   g21(.a(x12), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(x00), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(z3));
  nand4  g24(.a(x09), .b(x08), .c(new_n41_), .d(x00), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n45_), .c(new_n33_), .O(z4));
  nor3   g27(.a(x10), .b(x07), .c(x00), .O(new_n52_));
  inv1   g28(.a(x13), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(x12), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n52_), .c(new_n32_), .O(z5));
  inv1   g31(.a(x01), .O(new_n56_));
  oai21  g32(.a(new_n52_), .b(new_n35_), .c(new_n56_), .O(new_n57_));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  nand3  g34(.a(x14), .b(x02), .c(new_n25_), .O(new_n59_));
  nor2   g35(.a(x10), .b(x07), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n57_), .O(z6));
