...
module FAU ( 
  ...
  oai21  g19(.a(new_n43_), .b(new_n33_), .c(new_n34_), .O(z2));
  nand2  g20(.a(x12), .b(new_n25_), .O(new_n45_));
  nand2  g21(.a(x11), .b(x07), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(new_n45_), .c(new_n34_), .O(new_n47_));
  inv1   g23(.a(new_n47_), .O(z3));
  nand2  g24(.a(new_n46_), .b(new_n34_), .O(new_n49_));
  nor2   g25(.a(new_n42_), .b(new_n25_), .O(new_n50_));
  inv1   g26(.a(x09), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(x07), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(new_n49_), .O(z4));
