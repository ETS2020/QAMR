...
module FAU ( 
  ...
  nand2  g02(.a(x04), .b(x02), .O(new_n27_));
  nor2   g03(.a(x02), .b(x01), .O(new_n28_));
  inv1   g04(.a(new_n28_), .O(new_n29_));
  nand4  g05(.a(new_n29_), .b(new_n27_), .c(new_n26_), .d(x03), .O(new_n30_));
  ...
  nand3  g11(.a(x05), .b(x02), .c(x01), .O(new_n36_));
  ...
  nand2  g15(.a(new_n39_), .b(new_n26_), .O(z1));
  ...
  aoi21  g27(.a(new_n49_), .b(new_n41_), .c(new_n51_), .O(z2));
  ...
  nand2  g36(.a(new_n54_), .b(new_n26_), .O(new_n61_));
  aoi21  g37(.a(new_n60_), .b(new_n58_), .c(new_n61_), .O(z4));
  inv1   g38(.a(new_n26_), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n53_), .c(new_n46_), .O(new_n64_));
  nor3   g40(.a(new_n64_), .b(x07), .c(x00), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(new_n63_), .O(z5));
  nand2  g42(.a(new_n57_), .b(x03), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n37_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n28_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n59_), .d(new_n43_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n26_), .O(z6));
  nand2  g48(.a(new_n28_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x08), .O(new_n74_));
  nand3  g50(.a(new_n28_), .b(new_n57_), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n43_), .c(new_n63_), .O(z7));
  nand2  g53(.a(new_n53_), .b(x09), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(new_n73_), .c(x09), .d(new_n35_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n43_), .c(new_n63_), .O(z8));
endmodule
