...
module FAU ( 
  ...
  aoi21  g02(.a(x05), .b(x02), .c(new_n26_), .O(new_n27_));
  inv1   g03(.a(x00), .O(new_n28_));
  nand2  g04(.a(x01), .b(new_n28_), .O(new_n29_));
  inv1   g05(.a(x04), .O(new_n30_));
  nand2  g06(.a(new_n30_), .b(x02), .O(new_n31_));
  oai21  g07(.a(new_n29_), .b(new_n27_), .c(new_n31_), .O(z0));
  nand2  g08(.a(new_n26_), .b(x01), .O(new_n33_));
  ...
  nand2  g24(.a(x12), .b(new_n28_), .O(new_n49_));
  ...
  nand2  g30(.a(new_n50_), .b(new_n31_), .O(new_n55_));
  inv1   g31(.a(x08), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n28_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n54_), .c(new_n55_), .O(z4));
  ...
  nand4  g40(.a(x14), .b(x02), .c(x01), .d(new_n28_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n39_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(new_n31_), .O(z6));
  oai21  g43(.a(new_n25_), .b(x01), .c(new_n56_), .O(new_n68_));
  oai21  g44(.a(new_n56_), .b(new_n30_), .c(x02), .O(new_n69_));
  nand3  g45(.a(new_n26_), .b(x09), .c(new_n38_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n39_), .O(z7));
  nand3  g47(.a(new_n31_), .b(new_n53_), .c(x00), .O(new_n72_));
