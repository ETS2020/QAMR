...
module FAU ( 
  ...
  aoi21  g40(.a(new_n64_), .b(x02), .c(new_n63_), .O(new_n65_));
  xnor2a g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n30_), .O(new_n67_));
  nand2  g43(.a(x08), .b(x00), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n45_), .c(new_n56_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n65_), .O(z6));
  nand2  g48(.a(x09), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n63_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n30_), .O(new_n75_));
  oai21  g51(.a(new_n34_), .b(x02), .c(new_n48_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n39_), .O(z7));
  nand3  g53(.a(new_n53_), .b(new_n45_), .c(new_n56_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n73_), .c(new_n63_), .O(new_n79_));
  inv1   g55(.a(x09), .O(new_n80_));
  nand3  g56(.a(new_n39_), .b(new_n80_), .c(x00), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n79_), .b(new_n30_), .c(new_n82_), .O(z8));
endmodule
