...
module FAU ( 
  ...
  nand3  g38(.a(new_n45_), .b(new_n26_), .c(new_n25_), .O(new_n63_));
  nand4  g39(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n64_));
  nor2   g40(.a(x10), .b(x07), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n55_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n31_), .O(z6));
  nand3  g43(.a(new_n65_), .b(new_n31_), .c(x08), .O(z7));
  nand4  g44(.a(new_n41_), .b(new_n46_), .c(new_n45_), .d(new_n42_), .O(z8));
endmodule
