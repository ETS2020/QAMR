...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n29_), .c(new_n38_), .O(z0));
  nand3  g15(.a(new_n28_), .b(x06), .c(x05), .O(new_n40_));
  oai21  g16(.a(new_n30_), .b(new_n26_), .c(new_n27_), .O(new_n41_));
  aoi21  g17(.a(new_n25_), .b(new_n30_), .c(x00), .O(new_n42_));
  nand3  g18(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(new_n43_));
  nand2  g19(.a(new_n43_), .b(new_n37_), .O(z1));
  aoi21  g20(.a(new_n36_), .b(new_n35_), .c(new_n27_), .O(new_n45_));
  aoi21  g21(.a(x13), .b(x10), .c(x07), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(x09), .O(new_n48_));
  nand2  g24(.a(x13), .b(new_n35_), .O(new_n49_));
  oai22  g25(.a(new_n49_), .b(new_n48_), .c(new_n46_), .d(x03), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n26_), .c(new_n45_), .O(new_n51_));
  nand2  g27(.a(x10), .b(new_n30_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n48_), .c(x01), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nand3  g30(.a(x13), .b(new_n54_), .c(new_n35_), .O(new_n55_));
  ...
  aoi22  g36(.a(new_n60_), .b(new_n49_), .c(x12), .d(new_n34_), .O(z3));
  nand4  g37(.a(x13), .b(x09), .c(x08), .d(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n35_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n60_), .O(z4));
  inv1   g40(.a(x12), .O(new_n65_));
  nand3  g41(.a(x13), .b(new_n47_), .c(new_n35_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n34_), .O(z5));
  ...
  nand3  g48(.a(new_n28_), .b(x14), .c(new_n34_), .O(new_n73_));
  aoi21  g49(.a(x08), .b(x00), .c(x10), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(x13), .c(x07), .O(z6));
  nand2  g52(.a(new_n31_), .b(x03), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n54_), .c(new_n66_), .O(new_n78_));
  oai21  g54(.a(new_n77_), .b(new_n70_), .c(new_n78_), .O(z7));
  nand2  g55(.a(new_n70_), .b(x00), .O(new_n80_));
  nand4  g56(.a(new_n31_), .b(new_n65_), .c(x09), .d(x03), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(x10), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n36_), .c(new_n35_), .O(z8));
endmodule
