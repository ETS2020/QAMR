...
module FAU ( 
  ...
  nand4  g15(.a(x13), .b(x03), .c(new_n25_), .d(x01), .O(new_n40_));
  ...
  nand4  g25(.a(new_n49_), .b(new_n46_), .c(x13), .d(new_n45_), .O(new_n50_));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n42_), .d(new_n26_), .O(z5));
  nand2  g40(.a(new_n47_), .b(new_n36_), .O(new_n65_));
  nand2  g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n25_), .b(new_n45_), .O(new_n67_));
  aoi21  g43(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n26_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n59_), .c(new_n48_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n55_), .O(z6));
  oai21  g47(.a(new_n66_), .b(x01), .c(x13), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand2  g49(.a(x03), .b(new_n45_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(x09), .d(new_n42_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n74_), .c(x13), .O(new_n80_));
  nand3  g56(.a(new_n48_), .b(new_n47_), .c(x00), .O(new_n81_));
