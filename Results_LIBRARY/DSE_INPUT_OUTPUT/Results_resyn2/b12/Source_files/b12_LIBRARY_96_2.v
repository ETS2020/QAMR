...
module FAU ( 
  ...
  nand2  g31(.a(new_n55_), .b(new_n37_), .O(z3));
  ...
  nand2  g36(.a(new_n54_), .b(new_n37_), .O(new_n61_));
  aoi21  g37(.a(new_n60_), .b(new_n58_), .c(new_n61_), .O(z4));
  nor2   g38(.a(new_n46_), .b(x02), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n53_), .d(new_n25_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n65_), .c(new_n45_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n27_), .c(x10), .O(z6));
  oai21  g47(.a(new_n26_), .b(x01), .c(new_n57_), .O(new_n72_));
  nand3  g48(.a(x09), .b(x03), .c(new_n66_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n63_), .O(z7));
  nand3  g50(.a(new_n53_), .b(x03), .c(new_n66_), .O(new_n75_));
