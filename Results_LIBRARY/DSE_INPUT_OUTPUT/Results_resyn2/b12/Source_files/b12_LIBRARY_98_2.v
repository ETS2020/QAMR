...
module FAU ( 
  ...
  nor2   g02(.a(x12), .b(new_n26_), .O(new_n27_));
  ...
  aoi21  g16(.a(new_n30_), .b(x03), .c(new_n27_), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(new_n40_), .c(new_n28_), .O(z1));
  ...
  nand3  g27(.a(new_n51_), .b(new_n48_), .c(new_n29_), .O(new_n52_));
  aoi22  g28(.a(new_n52_), .b(new_n26_), .c(new_n45_), .d(new_n28_), .O(z2));
  nand2  g29(.a(x11), .b(x07), .O(new_n54_));
  nor2   g30(.a(new_n54_), .b(new_n27_), .O(new_n55_));
  aoi21  g31(.a(x12), .b(new_n25_), .c(new_n55_), .O(z3));
  nor2   g32(.a(new_n44_), .b(new_n25_), .O(new_n57_));
  nand2  g33(.a(x09), .b(new_n43_), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(new_n27_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n57_), .c(new_n55_), .O(z4));
  nor2   g36(.a(x02), .b(x00), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n47_), .c(x13), .d(new_n33_), .O(z5));
  nand3  g38(.a(x14), .b(x01), .c(new_n25_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(x12), .c(new_n26_), .O(new_n64_));
  inv1   g40(.a(new_n57_), .O(new_n65_));
  xnor2a g41(.a(x09), .b(x03), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n26_), .c(new_n29_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n47_), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n64_), .O(z6));
  aoi21  g45(.a(x03), .b(new_n29_), .c(x08), .O(new_n70_));
  nand3  g46(.a(x09), .b(x03), .c(new_n29_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n70_), .c(new_n26_), .O(new_n73_));
  aoi21  g49(.a(new_n44_), .b(x02), .c(new_n50_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n27_), .O(z7));
  inv1   g51(.a(new_n48_), .O(new_n76_));
  oai21  g52(.a(new_n71_), .b(new_n50_), .c(new_n26_), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n33_), .c(new_n76_), .d(x00), .O(z8));
endmodule
