...
module FAU ( 
  ...
  nand2  g02(.a(x13), .b(new_n26_), .O(new_n27_));
  ...
  nand3  g14(.a(new_n35_), .b(new_n27_), .c(new_n25_), .O(new_n39_));
  inv1   g15(.a(x03), .O(new_n40_));
  nand2  g16(.a(new_n36_), .b(new_n40_), .O(new_n41_));
  nand3  g17(.a(new_n32_), .b(x06), .c(x05), .O(new_n42_));
  ...
  nand2  g38(.a(new_n56_), .b(new_n27_), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(z4));
  nand3  g40(.a(new_n45_), .b(new_n55_), .c(new_n25_), .O(new_n65_));
  ...
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n71_));
  nand3  g46(.a(new_n69_), .b(new_n31_), .c(new_n30_), .O(new_n74_));
  nand2  g47(.a(new_n48_), .b(new_n47_), .O(new_n75_));
  aoi21  g48(.a(x13), .b(new_n26_), .c(new_n75_), .O(new_n76_));
  ...
  oai21  g52(.a(new_n35_), .b(new_n40_), .c(new_n61_), .O(new_n80_));
  nand3  g53(.a(new_n80_), .b(new_n79_), .c(new_n76_), .O(z7));
  oai22  g54(.a(new_n79_), .b(x12), .c(x09), .d(new_n25_), .O(new_n82_));
