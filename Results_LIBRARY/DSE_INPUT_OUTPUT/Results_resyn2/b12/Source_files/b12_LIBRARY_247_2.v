...
module FAU ( 
  ...
  nand2  g36(.a(new_n41_), .b(new_n32_), .O(new_n61_));
  ...
  nand2  g41(.a(new_n60_), .b(new_n40_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n36_), .O(new_n67_));
  oai21  g43(.a(new_n32_), .b(x02), .c(new_n38_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n42_), .O(z7));
  inv1   g45(.a(x10), .O(new_n70_));
  nand3  g46(.a(new_n47_), .b(new_n70_), .c(new_n37_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n60_), .c(new_n40_), .O(new_n72_));
  nand3  g48(.a(new_n42_), .b(new_n41_), .c(x00), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n36_), .c(new_n74_), .O(z8));
endmodule
