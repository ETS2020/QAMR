...
module FAU ( 
  ...
  nand4  g18(.a(new_n42_), .b(new_n40_), .c(new_n37_), .d(new_n27_), .O(new_n43_));
  nand2  g19(.a(new_n43_), .b(new_n36_), .O(z1));
  nor2   g20(.a(x06), .b(x02), .O(new_n45_));
  ...
  oai21  g27(.a(new_n51_), .b(new_n47_), .c(new_n41_), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  nand2  g29(.a(new_n36_), .b(x00), .O(new_n54_));
  aoi21  g30(.a(new_n53_), .b(new_n48_), .c(new_n54_), .O(new_n55_));
  aoi21  g31(.a(new_n52_), .b(new_n45_), .c(new_n55_), .O(z2));
  nand2  g32(.a(x12), .b(new_n27_), .O(new_n57_));
  nor2   g33(.a(new_n26_), .b(x02), .O(new_n58_));
  ...
  nand4  g38(.a(x09), .b(x08), .c(new_n48_), .d(x00), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n59_), .c(new_n36_), .O(z4));
  nor2   g41(.a(x12), .b(x10), .O(new_n66_));
  nor2   g42(.a(x07), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n36_), .d(x13), .O(z5));
  xor2a  g44(.a(x09), .b(x03), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(new_n42_), .O(new_n70_));
  ...
  oai21  g50(.a(new_n38_), .b(x01), .c(new_n53_), .O(new_n75_));
  nand4  g51(.a(x09), .b(x03), .c(new_n25_), .d(new_n41_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n26_), .O(new_n78_));
  inv1   g54(.a(new_n46_), .O(new_n79_));
  aoi21  g55(.a(new_n53_), .b(x02), .c(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n78_), .c(new_n58_), .O(z7));
  nand2  g57(.a(x03), .b(new_n41_), .O(new_n82_));
  inv1   g58(.a(x12), .O(new_n83_));
  nand3  g59(.a(new_n45_), .b(new_n83_), .c(x09), .O(new_n84_));
  oai22  g60(.a(new_n84_), .b(new_n82_), .c(new_n54_), .d(x09), .O(new_n85_));
