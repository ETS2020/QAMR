...
module FAU ( 
  ...
  nand3  g21(.a(x07), .b(new_n45_), .c(new_n25_), .O(new_n46_));
  ...
  nand3  g26(.a(x10), .b(new_n45_), .c(new_n42_), .O(new_n51_));
  ...
  nor2   g31(.a(new_n43_), .b(new_n55_), .O(new_n56_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n48_), .c(new_n43_), .O(new_n67_));
  aoi21  g43(.a(new_n65_), .b(new_n64_), .c(new_n67_), .O(z6));
  nand4  g44(.a(x09), .b(x03), .c(new_n34_), .d(new_n42_), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  nand3  g46(.a(x03), .b(new_n34_), .c(new_n42_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n43_), .O(z7));
  oai22  g49(.a(new_n69_), .b(x12), .c(x09), .d(new_n25_), .O(new_n74_));
