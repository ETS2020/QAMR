...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x02), .O(new_n26_));
  ...
  nand2  g35(.a(x09), .b(new_n47_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n59_), .c(new_n56_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n54_), .O(z4));
  ...
  nand3  g44(.a(x02), .b(x01), .c(new_n50_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n59_), .c(new_n43_), .O(new_n70_));
