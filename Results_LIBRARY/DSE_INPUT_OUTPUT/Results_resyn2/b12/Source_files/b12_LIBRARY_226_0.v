...
module FAU ( 
  ...
  nand2  g29(.a(new_n53_), .b(new_n40_), .O(z4));
  nor2   g30(.a(x12), .b(x10), .O(new_n55_));
  nor2   g31(.a(x07), .b(x00), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(new_n55_), .c(new_n40_), .d(x13), .O(z5));
  nor2   g33(.a(x10), .b(x07), .O(new_n58_));
  oai21  g34(.a(new_n44_), .b(new_n35_), .c(new_n58_), .O(new_n59_));
  and2   g35(.a(x14), .b(x01), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(new_n29_), .c(new_n59_), .d(new_n40_), .O(z6));
  nand3  g37(.a(new_n58_), .b(new_n40_), .c(x08), .O(z7));
  nor2   g38(.a(x09), .b(new_n35_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n58_), .c(new_n39_), .O(z8));
endmodule
