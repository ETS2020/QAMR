...
module FAU ( 
  ...
  nand3  g49(.a(new_n73_), .b(new_n44_), .c(new_n39_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n60_), .c(new_n72_), .O(new_n75_));
  nand3  g51(.a(new_n63_), .b(new_n43_), .c(x00), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n75_), .b(new_n30_), .c(new_n77_), .O(z8));
endmodule
