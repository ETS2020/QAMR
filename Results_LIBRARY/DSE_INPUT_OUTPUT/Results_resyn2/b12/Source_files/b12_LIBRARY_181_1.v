...
module FAU ( 
  ...
  nand3  g19(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(new_n44_));
  ...
  aoi22  g24(.a(new_n48_), .b(new_n47_), .c(new_n44_), .d(new_n28_), .O(z2));
  ...
  nor2   g32(.a(new_n40_), .b(x07), .O(new_n57_));
  ...
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n51_), .d(new_n60_), .O(new_n62_));
  and2   g38(.a(new_n62_), .b(new_n50_), .O(z5));
  nand2  g39(.a(x14), .b(new_n25_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x01), .c(new_n28_), .O(new_n65_));
  xnor2a g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n39_), .O(new_n67_));
  nand3  g43(.a(new_n55_), .b(new_n60_), .c(new_n45_), .O(new_n68_));
  ...
  oai21  g48(.a(x08), .b(x03), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n33_), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n39_), .c(new_n41_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n50_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(z7));
  nand3  g53(.a(new_n51_), .b(new_n60_), .c(new_n45_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n72_), .c(new_n28_), .O(new_n79_));
  nand3  g55(.a(new_n41_), .b(new_n40_), .c(x00), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n39_), .c(new_n81_), .O(z8));
endmodule
