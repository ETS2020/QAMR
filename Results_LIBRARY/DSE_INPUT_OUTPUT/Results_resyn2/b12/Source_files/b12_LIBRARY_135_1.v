...
module FAU ( 
  ...
  nand2  g24(.a(new_n48_), .b(new_n34_), .O(new_n49_));
  aoi21  g25(.a(new_n47_), .b(new_n28_), .c(new_n49_), .O(z2));
  and2   g26(.a(x11), .b(x07), .O(new_n51_));
  inv1   g27(.a(x12), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(x00), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n34_), .O(z3));
  nand4  g30(.a(x09), .b(x08), .c(new_n43_), .d(x00), .O(new_n55_));
  ...
  nand2  g36(.a(x14), .b(new_n35_), .O(new_n61_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n41_), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(new_n62_), .O(z6));
  inv1   g43(.a(x09), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n37_), .c(new_n28_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n31_), .O(new_n70_));
  inv1   g46(.a(x08), .O(new_n71_));
  nand2  g47(.a(x03), .b(new_n31_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n70_), .c(new_n41_), .O(z7));
  nand2  g50(.a(new_n68_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(x02), .b(new_n31_), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n52_), .b(x09), .c(new_n28_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n72_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n41_), .O(z8));
endmodule
