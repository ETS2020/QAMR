...
module FAU ( 
  ...
  nor2   g24(.a(x14), .b(x02), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nand2  g26(.a(x14), .b(new_n25_), .O(new_n51_));
  ...
  nor2   g32(.a(new_n27_), .b(x02), .O(new_n57_));
  ...
  oai21  g39(.a(new_n63_), .b(new_n58_), .c(new_n51_), .O(z4));
  inv1   g40(.a(x12), .O(new_n65_));
  nand3  g41(.a(x13), .b(new_n65_), .c(new_n45_), .O(new_n66_));
  nor3   g42(.a(new_n66_), .b(x07), .c(x00), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n57_), .O(z5));
  inv1   g44(.a(x09), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n38_), .O(new_n70_));
  nand2  g46(.a(x09), .b(x03), .O(new_n71_));
  nand2  g47(.a(new_n25_), .b(new_n32_), .O(new_n72_));
  aoi21  g48(.a(new_n71_), .b(new_n70_), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  nand3  g50(.a(new_n33_), .b(x14), .c(new_n55_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n42_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n51_), .O(z6));
  oai21  g53(.a(new_n71_), .b(x01), .c(new_n27_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n25_), .O(new_n79_));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n32_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n50_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n42_), .O(z7));
  nand2  g58(.a(new_n69_), .b(x00), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(new_n57_), .O(new_n84_));
  nand3  g60(.a(new_n27_), .b(new_n65_), .c(x09), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(new_n80_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n84_), .c(new_n42_), .O(z8));
endmodule
