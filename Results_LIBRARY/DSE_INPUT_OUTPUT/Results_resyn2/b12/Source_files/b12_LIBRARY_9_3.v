...
module FAU ( 
  ...
  nand2  g11(.a(x12), .b(x02), .O(new_n36_));
  ...
  nand2  g16(.a(new_n29_), .b(new_n26_), .O(new_n41_));
  ...
  nor2   g31(.a(new_n39_), .b(x00), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n55_), .c(new_n36_), .O(z3));
  nand4  g33(.a(x09), .b(x08), .c(new_n47_), .d(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n55_), .c(new_n36_), .O(z4));
  nand4  g36(.a(new_n45_), .b(x13), .c(new_n39_), .d(new_n25_), .O(z5));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n27_), .O(new_n68_));
  inv1   g44(.a(x08), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n25_), .c(new_n45_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n63_), .c(new_n70_), .O(z6));
  inv1   g47(.a(new_n36_), .O(new_n72_));
  aoi21  g48(.a(x03), .b(new_n44_), .c(x08), .O(new_n73_));
  nand3  g49(.a(x09), .b(x03), .c(new_n44_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n27_), .O(new_n76_));
  inv1   g52(.a(new_n45_), .O(new_n77_));
  aoi21  g53(.a(new_n69_), .b(x02), .c(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(new_n72_), .O(z7));
  nand3  g55(.a(new_n36_), .b(new_n65_), .c(x00), .O(new_n80_));
  nand2  g56(.a(new_n39_), .b(new_n27_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n74_), .c(new_n80_), .O(new_n82_));
