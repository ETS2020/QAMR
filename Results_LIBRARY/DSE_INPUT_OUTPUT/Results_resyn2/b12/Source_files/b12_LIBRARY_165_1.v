...
module FAU ( 
  ...
  nor2   g28(.a(x11), .b(x01), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n52_), .c(new_n49_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n27_), .c(new_n46_), .O(z2));
  aoi21  g31(.a(new_n44_), .b(x02), .c(new_n28_), .O(new_n56_));
  aoi21  g32(.a(x12), .b(new_n43_), .c(new_n56_), .O(z3));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  nor2   g35(.a(new_n50_), .b(x07), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(new_n56_), .O(z4));
  nor2   g37(.a(new_n28_), .b(x02), .O(new_n62_));
  ...
  nand2  g43(.a(new_n50_), .b(new_n39_), .O(new_n68_));
  nand2  g44(.a(x09), .b(x03), .O(new_n69_));
  nand2  g45(.a(new_n27_), .b(new_n32_), .O(new_n70_));
  aoi21  g46(.a(new_n69_), .b(new_n68_), .c(new_n70_), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n43_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n58_), .c(new_n51_), .O(new_n73_));
  oai22  g49(.a(new_n73_), .b(new_n71_), .c(new_n28_), .d(x02), .O(z6));
  oai21  g50(.a(new_n69_), .b(x01), .c(new_n28_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n27_), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n45_), .c(new_n48_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n76_), .O(z7));
  nand2  g55(.a(new_n50_), .b(x00), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  nand3  g57(.a(new_n64_), .b(new_n28_), .c(x09), .O(new_n82_));
  nor2   g58(.a(new_n82_), .b(new_n77_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(new_n51_), .O(z8));
endmodule
