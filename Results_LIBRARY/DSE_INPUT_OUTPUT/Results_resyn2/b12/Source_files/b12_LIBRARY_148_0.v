...
module FAU ( 
  ...
  nor2   g12(.a(new_n25_), .b(x02), .O(new_n37_));
  nand2  g13(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand2  g14(.a(new_n31_), .b(x00), .O(new_n39_));
  nand2  g15(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  aoi21  g16(.a(new_n35_), .b(x02), .c(new_n40_), .O(z1));
  inv1   g17(.a(x07), .O(new_n42_));
  inv1   g18(.a(x08), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(new_n44_));
  nor2   g20(.a(x10), .b(x07), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(x03), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(x09), .c(new_n42_), .O(new_n48_));
  inv1   g24(.a(new_n48_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n46_), .c(new_n26_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n37_), .c(new_n44_), .O(z2));
  inv1   g27(.a(x00), .O(new_n52_));
  nand2  g28(.a(x12), .b(new_n52_), .O(new_n53_));
  nand2  g29(.a(x11), .b(x07), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n53_), .c(new_n31_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(z3));
  inv1   g32(.a(x09), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(x07), .O(new_n58_));
  nand2  g34(.a(new_n54_), .b(new_n31_), .O(new_n59_));
  nor2   g35(.a(new_n43_), .b(new_n52_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n58_), .c(new_n59_), .O(z4));
  ...
  aoi21  g45(.a(new_n69_), .b(x04), .c(x02), .O(new_n70_));
  inv1   g46(.a(new_n60_), .O(new_n71_));
  nand3  g47(.a(new_n28_), .b(x14), .c(new_n52_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n45_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(new_n70_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n26_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x04), .O(new_n76_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n45_), .O(z7));
  nand3  g56(.a(new_n62_), .b(x09), .c(x04), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n78_), .c(new_n39_), .d(x09), .O(new_n82_));
