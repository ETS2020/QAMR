...
module FAU ( 
  ...
  nor2   g29(.a(x06), .b(x02), .O(new_n54_));
  ...
  nor2   g34(.a(new_n58_), .b(new_n38_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z3));
  nand4  g37(.a(x09), .b(x08), .c(new_n49_), .d(x00), .O(new_n62_));
  ...
  nand2  g45(.a(x09), .b(new_n40_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n32_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n27_), .c(x02), .O(new_n72_));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand3  g49(.a(new_n33_), .b(x14), .c(new_n56_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n47_), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(new_n72_), .O(z6));
  nor2   g52(.a(new_n40_), .b(x01), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n47_), .c(new_n68_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n27_), .O(new_n79_));
  nand2  g55(.a(new_n47_), .b(x08), .O(new_n80_));
  aoi21  g56(.a(new_n77_), .b(new_n25_), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n25_), .c(new_n81_), .O(z7));
  inv1   g58(.a(x12), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x03), .c(new_n32_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n51_), .c(new_n27_), .O(new_n85_));
  nor2   g61(.a(x09), .b(new_n56_), .O(new_n86_));
  aoi22  g62(.a(new_n86_), .b(new_n47_), .c(new_n85_), .d(new_n25_), .O(z8));
endmodule
