...
module FAU ( 
  ...
  nand2  g24(.a(x12), .b(new_n30_), .O(new_n49_));
  ...
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n38_), .d(new_n30_), .O(new_n58_));
  and2   g34(.a(new_n58_), .b(new_n48_), .O(z5));
  nor2   g35(.a(x10), .b(x07), .O(new_n60_));
  nand2  g36(.a(new_n53_), .b(new_n60_), .O(new_n61_));
  xnor2a g37(.a(x09), .b(x03), .O(new_n62_));
  nor2   g38(.a(x02), .b(x01), .O(new_n63_));
  aoi22  g39(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(new_n48_), .O(z6));
  inv1   g40(.a(x08), .O(new_n65_));
  oai21  g41(.a(new_n33_), .b(x02), .c(new_n65_), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x02), .c(x01), .O(new_n67_));
  nand4  g43(.a(x09), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n60_), .O(z7));
  nand3  g45(.a(new_n48_), .b(new_n39_), .c(x00), .O(new_n70_));
  oai21  g46(.a(new_n68_), .b(x12), .c(new_n70_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n60_), .O(z8));
endmodule
