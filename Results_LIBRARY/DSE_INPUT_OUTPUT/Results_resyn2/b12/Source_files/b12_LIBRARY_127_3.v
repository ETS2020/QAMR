...
module FAU ( 
  ...
  oai22  g31(.a(new_n55_), .b(x00), .c(new_n28_), .d(new_n49_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n51_), .O(z3));
  aoi21  g33(.a(new_n49_), .b(new_n25_), .c(new_n28_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n49_), .d(new_n63_), .O(new_n65_));
  and2   g41(.a(new_n65_), .b(new_n51_), .O(z5));
  xor2a  g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n25_), .b(new_n43_), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n63_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n59_), .c(new_n45_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n51_), .O(z6));
  nand4  g48(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n73_));
  oai21  g49(.a(new_n38_), .b(x01), .c(new_n50_), .O(new_n74_));
  oai21  g50(.a(x11), .b(new_n50_), .c(x02), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n45_), .O(z7));
  nand3  g52(.a(new_n51_), .b(new_n44_), .c(x00), .O(new_n77_));
