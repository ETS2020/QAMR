...
module FAU ( 
  ...
  nand2  g29(.a(new_n53_), .b(new_n45_), .O(z4));
  ...
  nand3  g38(.a(new_n62_), .b(new_n51_), .c(new_n61_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n60_), .c(new_n45_), .O(z6));
  inv1   g40(.a(x01), .O(new_n65_));
  nand2  g41(.a(new_n58_), .b(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n44_), .O(new_n67_));
  oai21  g43(.a(new_n32_), .b(x02), .c(new_n37_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n61_), .O(z7));
  inv1   g45(.a(x12), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n41_), .c(new_n36_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n58_), .c(new_n65_), .O(new_n72_));
  nand3  g48(.a(new_n61_), .b(new_n40_), .c(x00), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n44_), .c(new_n74_), .O(z8));
endmodule
