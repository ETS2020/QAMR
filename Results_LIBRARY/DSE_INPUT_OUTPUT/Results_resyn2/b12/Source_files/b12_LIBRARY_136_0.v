...
module FAU ( 
  ...
  nand4  g26(.a(new_n50_), .b(new_n47_), .c(x13), .d(new_n46_), .O(new_n51_));
  ...
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n57_), .d(new_n49_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n36_), .O(z6));
  nand3  g48(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n73_));
  ...
  aoi21  g53(.a(new_n73_), .b(new_n44_), .c(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n75_), .c(new_n35_), .O(z7));
  nand2  g55(.a(x03), .b(new_n46_), .O(new_n80_));
  nand4  g56(.a(new_n53_), .b(new_n76_), .c(x09), .d(new_n43_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n82_));
  nand3  g58(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n83_));
