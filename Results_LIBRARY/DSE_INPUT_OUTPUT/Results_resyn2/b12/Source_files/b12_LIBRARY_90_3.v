...
module FAU ( 
  ...
  nand2  g38(.a(new_n55_), .b(x03), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n33_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n53_), .c(new_n39_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(z6));
  nand3  g42(.a(new_n42_), .b(x08), .c(new_n41_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n45_), .c(new_n31_), .O(new_n68_));
  oai21  g44(.a(new_n35_), .b(x01), .c(x08), .O(new_n69_));
  nand3  g45(.a(new_n33_), .b(new_n55_), .c(x03), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n39_), .c(new_n68_), .O(z7));
  nand3  g48(.a(new_n25_), .b(new_n55_), .c(x00), .O(new_n73_));
  nand3  g49(.a(new_n49_), .b(x09), .c(new_n45_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n32_), .c(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n39_), .O(z8));
endmodule
