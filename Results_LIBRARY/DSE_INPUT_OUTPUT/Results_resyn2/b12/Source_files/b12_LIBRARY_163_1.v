...
module FAU ( 
  ...
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n52_), .d(new_n41_), .O(new_n59_));
  and2   g35(.a(new_n59_), .b(new_n50_), .O(z5));
  nand2  g36(.a(x09), .b(x03), .O(new_n61_));
  nand2  g37(.a(new_n40_), .b(new_n30_), .O(new_n62_));
  ...
  nand2  g44(.a(new_n61_), .b(new_n29_), .O(new_n69_));
  ...
  nand3  g48(.a(new_n52_), .b(new_n41_), .c(new_n39_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n61_), .c(new_n29_), .O(new_n74_));
  nand3  g50(.a(new_n64_), .b(new_n40_), .c(x00), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  aoi21  g52(.a(new_n74_), .b(new_n27_), .c(new_n76_), .O(z8));
endmodule
