...
module FAU ( 
  ...
  inv1   g22(.a(new_n35_), .O(new_n47_));
  ...
  nand4  g31(.a(new_n55_), .b(new_n36_), .c(x13), .d(new_n49_), .O(z5));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  inv1   g33(.a(x00), .O(new_n58_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n58_), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n55_), .c(new_n57_), .d(new_n47_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z6));
  aoi21  g37(.a(new_n55_), .b(x08), .c(new_n35_), .O(z7));
  nor2   g38(.a(x09), .b(new_n58_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n55_), .c(new_n47_), .O(z8));
endmodule
