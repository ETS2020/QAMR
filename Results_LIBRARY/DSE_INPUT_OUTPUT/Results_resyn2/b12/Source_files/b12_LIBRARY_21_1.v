...
module FAU ( 
  ...
  oai21  g28(.a(new_n52_), .b(new_n50_), .c(new_n38_), .O(z3));
  nand4  g29(.a(x09), .b(x08), .c(new_n41_), .d(x00), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n50_), .c(new_n38_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n38_), .d(x13), .O(z5));
  nand2  g35(.a(x14), .b(new_n25_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(x01), .c(new_n28_), .O(new_n61_));
  ...
  nand3  g50(.a(new_n51_), .b(new_n64_), .c(new_n41_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n70_), .c(new_n28_), .O(new_n76_));
  nand3  g52(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n76_), .b(new_n26_), .c(new_n78_), .O(z8));
endmodule
