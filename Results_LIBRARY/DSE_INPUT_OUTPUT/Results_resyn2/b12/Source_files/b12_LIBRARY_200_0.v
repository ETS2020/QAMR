...
module FAU ( 
  ...
  oai21  g33(.a(new_n57_), .b(new_n55_), .c(new_n41_), .O(z3));
  nand4  g34(.a(x09), .b(x08), .c(new_n43_), .d(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n55_), .c(new_n41_), .O(z4));
  nor2   g37(.a(x12), .b(x10), .O(new_n62_));
  nor2   g38(.a(x07), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n41_), .d(x13), .O(z5));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x01), .c(x06), .O(new_n66_));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n26_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n48_), .O(new_n69_));
  aoi21  g45(.a(new_n66_), .b(new_n25_), .c(new_n69_), .O(z6));
  nand2  g46(.a(x09), .b(x03), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x01), .c(x06), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n44_), .c(new_n51_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n73_), .O(z7));
  oai21  g52(.a(new_n74_), .b(x12), .c(x09), .O(new_n77_));
  oai21  g53(.a(x09), .b(new_n25_), .c(new_n36_), .O(new_n78_));
  aoi21  g54(.a(new_n47_), .b(new_n26_), .c(new_n51_), .O(new_n79_));
