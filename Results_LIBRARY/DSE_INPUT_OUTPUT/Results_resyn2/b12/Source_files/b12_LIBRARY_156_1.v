...
module FAU ( 
  ...
  nand2  g11(.a(x14), .b(new_n25_), .O(new_n36_));
  nand2  g12(.a(new_n29_), .b(x03), .O(new_n37_));
  nor2   g13(.a(new_n27_), .b(x02), .O(new_n38_));
  nand3  g14(.a(x06), .b(x05), .c(x01), .O(new_n39_));
  inv1   g15(.a(x03), .O(new_n40_));
  aoi21  g16(.a(new_n31_), .b(new_n40_), .c(new_n25_), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(new_n39_), .c(new_n38_), .O(new_n42_));
  aoi22  g18(.a(new_n42_), .b(new_n37_), .c(new_n36_), .d(x00), .O(z1));
  inv1   g19(.a(x07), .O(new_n44_));
  inv1   g20(.a(x08), .O(new_n45_));
  nand2  g21(.a(new_n36_), .b(x00), .O(new_n46_));
  ...
  oai21  g28(.a(new_n52_), .b(new_n49_), .c(new_n32_), .O(new_n53_));
  nor2   g29(.a(x14), .b(x02), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n53_), .c(new_n47_), .O(z2));
  ...
  nand2  g42(.a(x01), .b(new_n66_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(x02), .c(new_n27_), .O(new_n68_));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  xnor2a g45(.a(x09), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n25_), .c(new_n32_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n48_), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n68_), .O(z6));
  nand2  g49(.a(x09), .b(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x01), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n25_), .c(new_n32_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n45_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(z7));
  nand3  g55(.a(new_n27_), .b(new_n57_), .c(x09), .O(new_n80_));
  oai22  g56(.a(new_n80_), .b(new_n77_), .c(new_n46_), .d(x09), .O(new_n81_));
