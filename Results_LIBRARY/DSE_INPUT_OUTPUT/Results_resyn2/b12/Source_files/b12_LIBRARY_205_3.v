...
module FAU ( 
  ...
  nand2  g23(.a(x12), .b(new_n30_), .O(new_n48_));
  ...
  nand2  g29(.a(new_n53_), .b(new_n47_), .O(z4));
  ...
  oai21  g34(.a(new_n58_), .b(new_n30_), .c(new_n38_), .O(new_n59_));
  xnor2a g35(.a(x09), .b(x03), .O(new_n60_));
  nor2   g36(.a(x02), .b(x01), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(new_n47_), .O(z6));
  oai21  g38(.a(new_n33_), .b(x02), .c(new_n58_), .O(new_n63_));
  oai21  g39(.a(new_n58_), .b(x02), .c(x01), .O(new_n64_));
  nand3  g40(.a(new_n61_), .b(x09), .c(x03), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n38_), .O(z7));
  inv1   g42(.a(x09), .O(new_n67_));
  nand3  g43(.a(new_n47_), .b(new_n67_), .c(x00), .O(new_n68_));
  oai21  g44(.a(new_n65_), .b(x12), .c(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n38_), .O(z8));
endmodule
