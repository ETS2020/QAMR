...
module FAU ( 
  ...
  aoi22  g07(.a(x04), .b(x02), .c(x03), .d(x01), .O(new_n32_));
  nand4  g08(.a(x06), .b(x05), .c(x02), .d(x01), .O(new_n33_));
  nand2  g09(.a(new_n33_), .b(new_n29_), .O(new_n34_));
  nor2   g10(.a(new_n34_), .b(new_n32_), .O(z1));
  ...
  oai21  g17(.a(new_n41_), .b(x03), .c(x04), .O(new_n42_));
  oai21  g18(.a(new_n42_), .b(new_n40_), .c(new_n36_), .O(new_n43_));
  inv1   g19(.a(x08), .O(new_n44_));
  nand2  g20(.a(new_n25_), .b(new_n36_), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(x00), .O(new_n46_));
  aoi21  g22(.a(new_n44_), .b(new_n37_), .c(new_n46_), .O(new_n47_));
  aoi21  g23(.a(new_n43_), .b(new_n27_), .c(new_n47_), .O(z2));
  ...
  nor2   g28(.a(new_n44_), .b(new_n29_), .O(new_n53_));
  ...
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n45_), .d(x13), .O(z5));
  xor2a  g36(.a(x09), .b(x03), .O(new_n61_));
  nor3   g37(.a(new_n61_), .b(x02), .c(x01), .O(new_n62_));
  inv1   g38(.a(new_n53_), .O(new_n63_));
  nand4  g39(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n41_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n62_), .c(new_n45_), .O(z6));
  nand3  g42(.a(x09), .b(x03), .c(new_n27_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x04), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n36_), .O(new_n69_));
  oai21  g45(.a(new_n28_), .b(x01), .c(new_n44_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n41_), .O(z7));
  nand3  g47(.a(new_n49_), .b(x04), .c(new_n36_), .O(new_n72_));
  oai22  g48(.a(new_n72_), .b(new_n67_), .c(new_n46_), .d(x09), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n41_), .O(z8));
endmodule
