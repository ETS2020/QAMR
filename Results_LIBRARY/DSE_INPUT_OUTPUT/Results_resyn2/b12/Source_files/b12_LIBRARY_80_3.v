...
module FAU ( 
  ...
  nand3  g36(.a(new_n51_), .b(new_n47_), .c(new_n60_), .O(new_n61_));
  aoi21  g37(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(z6));
  inv1   g38(.a(x08), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x01), .O(new_n64_));
  nand3  g40(.a(x09), .b(x03), .c(new_n36_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n25_), .O(new_n67_));
  nand2  g43(.a(new_n39_), .b(new_n37_), .O(new_n68_));
  nand2  g44(.a(x03), .b(new_n25_), .O(new_n69_));
  nor2   g45(.a(x08), .b(x01), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n69_), .c(new_n47_), .d(new_n68_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n67_), .O(z7));
  nand3  g48(.a(new_n47_), .b(new_n38_), .c(x00), .O(new_n73_));
  inv1   g49(.a(x12), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x09), .c(new_n36_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n69_), .c(new_n73_), .O(new_n76_));
