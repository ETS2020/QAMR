...
module FAU ( 
  ...
  nor2   g07(.a(x13), .b(x12), .O(new_n32_));
  ...
  nor2   g45(.a(new_n63_), .b(new_n32_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  aoi21  g47(.a(new_n67_), .b(new_n66_), .c(new_n71_), .O(z6));
  nand3  g48(.a(x03), .b(new_n35_), .c(new_n45_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  nor2   g50(.a(new_n47_), .b(new_n38_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n66_), .c(new_n63_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(new_n32_), .O(z7));
  nand3  g53(.a(new_n75_), .b(new_n66_), .c(new_n62_), .O(new_n78_));
  oai21  g54(.a(x09), .b(new_n25_), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n70_), .O(z8));
endmodule
