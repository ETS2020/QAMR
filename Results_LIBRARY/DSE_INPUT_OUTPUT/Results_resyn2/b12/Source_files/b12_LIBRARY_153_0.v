...
module FAU ( 
  ...
  nor2   g07(.a(x08), .b(x04), .O(new_n32_));
  ...
  nand2  g32(.a(new_n56_), .b(new_n33_), .O(z3));
  ...
  nand2  g37(.a(new_n55_), .b(new_n33_), .O(new_n62_));
  ...
  nand2  g41(.a(new_n58_), .b(x03), .O(new_n66_));
  inv1   g42(.a(x03), .O(new_n67_));
  nand2  g43(.a(new_n35_), .b(new_n43_), .O(new_n68_));
  aoi21  g44(.a(x09), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n47_), .b(new_n46_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n32_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n60_), .O(new_n73_));
  aoi21  g49(.a(new_n69_), .b(new_n66_), .c(new_n73_), .O(z6));
  nand3  g50(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x08), .O(new_n76_));
  nand4  g52(.a(new_n58_), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n44_), .c(new_n32_), .O(z7));
  oai21  g55(.a(new_n75_), .b(x12), .c(x09), .O(new_n80_));
  nand2  g56(.a(new_n58_), .b(new_n25_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n72_), .O(z8));
endmodule
