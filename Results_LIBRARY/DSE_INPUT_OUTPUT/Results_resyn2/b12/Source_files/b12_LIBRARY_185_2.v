...
module FAU ( 
  ...
  nand4  g36(.a(new_n45_), .b(x13), .c(new_n52_), .d(new_n25_), .O(new_n61_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n56_), .c(new_n45_), .O(new_n66_));
  aoi21  g42(.a(new_n64_), .b(new_n63_), .c(new_n66_), .O(z6));
  nand3  g43(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n68_));
  ...
  nand2  g49(.a(x13), .b(x10), .O(new_n74_));
  nand4  g50(.a(new_n52_), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n75_));
  inv1   g51(.a(x07), .O(new_n76_));
  oai21  g52(.a(x09), .b(x00), .c(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n75_), .b(x09), .c(new_n77_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x10), .c(new_n74_), .O(z8));
endmodule
