...
module FAU ( 
  ...
  nor2   g10(.a(x12), .b(x10), .O(new_n35_));
  inv1   g11(.a(new_n35_), .O(z5));
  nand2  g12(.a(z5), .b(new_n34_), .O(new_n37_));
  ...
  nand3  g21(.a(x07), .b(new_n30_), .c(new_n34_), .O(new_n46_));
  oai21  g22(.a(new_n45_), .b(x10), .c(new_n46_), .O(new_n47_));
  inv1   g23(.a(x08), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n34_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(x01), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n47_), .O(new_n51_));
  oai21  g27(.a(x08), .b(x07), .c(x00), .O(new_n52_));
  nand3  g28(.a(x10), .b(new_n30_), .c(new_n26_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n52_), .c(new_n35_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n51_), .O(z2));
  nand2  g32(.a(x11), .b(x07), .O(new_n57_));
  nand2  g33(.a(x12), .b(new_n34_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(z5), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z3));
  inv1   g36(.a(new_n45_), .O(new_n61_));
  nand2  g37(.a(new_n57_), .b(z5), .O(new_n62_));
  aoi21  g38(.a(new_n49_), .b(new_n61_), .c(new_n62_), .O(z4));
  nand2  g39(.a(x09), .b(new_n30_), .O(new_n64_));
  inv1   g40(.a(x09), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x03), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n31_), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n70_), .b(x12), .c(x10), .O(z6));
  inv1   g47(.a(x10), .O(new_n72_));
  nand3  g48(.a(new_n31_), .b(x09), .c(x03), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n27_), .c(new_n26_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n48_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n44_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x12), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n72_), .O(z7));
  nor2   g54(.a(x10), .b(x09), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(x12), .c(new_n44_), .d(x00), .O(z8));
endmodule
