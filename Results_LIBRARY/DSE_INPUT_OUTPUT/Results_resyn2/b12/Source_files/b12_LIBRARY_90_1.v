...
module FAU ( 
  ...
  aoi21  g33(.a(new_n56_), .b(new_n41_), .c(new_n57_), .O(z4));
  nor2   g34(.a(new_n26_), .b(x01), .O(new_n59_));
  nor2   g35(.a(x07), .b(x00), .O(new_n60_));
  nand3  g36(.a(x13), .b(new_n51_), .c(new_n39_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z5));
  nor2   g39(.a(x10), .b(x07), .O(new_n64_));
  nand2  g40(.a(new_n40_), .b(x03), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n43_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n32_), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n55_), .d(new_n64_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n33_), .O(z6));
  oai21  g46(.a(new_n65_), .b(new_n45_), .c(new_n26_), .O(new_n71_));
  nand2  g47(.a(x03), .b(new_n32_), .O(new_n72_));
  nand2  g48(.a(new_n64_), .b(x08), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  aoi22  g50(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(new_n32_), .O(z7));
  nand2  g51(.a(new_n40_), .b(x00), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nand3  g53(.a(new_n51_), .b(x09), .c(new_n26_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n72_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n64_), .O(z8));
endmodule
