...
module FAU ( 
  ...
  nand2  g17(.a(new_n29_), .b(new_n26_), .O(new_n42_));
  nand4  g18(.a(new_n42_), .b(new_n41_), .c(new_n36_), .d(x02), .O(new_n43_));
  ...
  nor3   g32(.a(new_n56_), .b(new_n55_), .c(new_n37_), .O(z3));
  ...
  nand3  g42(.a(new_n66_), .b(new_n36_), .c(x02), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n26_), .O(new_n68_));
  nand2  g44(.a(new_n36_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n45_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n27_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n25_), .c(new_n46_), .O(new_n73_));
  aoi21  g49(.a(new_n71_), .b(new_n67_), .c(new_n73_), .O(z6));
  aoi21  g50(.a(x03), .b(new_n45_), .c(x08), .O(new_n75_));
  nand3  g51(.a(x09), .b(x03), .c(new_n45_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n27_), .O(new_n78_));
  aoi21  g54(.a(new_n72_), .b(x02), .c(new_n48_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(new_n37_), .O(z7));
  oai22  g56(.a(new_n76_), .b(x12), .c(x09), .d(new_n25_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n46_), .c(new_n37_), .O(z8));
endmodule
