...
module FAU ( 
  ...
  oai22  g16(.a(new_n40_), .b(new_n39_), .c(new_n26_), .d(new_n37_), .O(new_n41_));
  nand2  g17(.a(new_n41_), .b(new_n36_), .O(new_n42_));
  nand2  g18(.a(x11), .b(x02), .O(new_n43_));
  ...
  oai22  g32(.a(new_n56_), .b(x00), .c(new_n27_), .d(new_n48_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n43_), .O(z3));
  inv1   g34(.a(x09), .O(new_n59_));
  nor2   g35(.a(new_n59_), .b(x07), .O(new_n60_));
  aoi21  g36(.a(new_n48_), .b(new_n25_), .c(new_n27_), .O(new_n61_));
  inv1   g37(.a(x08), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(new_n36_), .O(new_n63_));
  ...
  nand3  g43(.a(x14), .b(x01), .c(new_n36_), .O(new_n68_));
  ...
  oai21  g49(.a(new_n62_), .b(new_n36_), .c(new_n46_), .O(new_n74_));
