...
module FAU ( 
  ...
  nand4  g32(.a(new_n56_), .b(x13), .c(new_n55_), .d(new_n39_), .O(new_n57_));
  and2   g33(.a(new_n57_), .b(new_n46_), .O(z5));
  nand2  g34(.a(x09), .b(new_n26_), .O(new_n59_));
  ...
  nand3  g38(.a(new_n62_), .b(new_n50_), .c(new_n36_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n46_), .O(z6));
  nand3  g40(.a(new_n39_), .b(x08), .c(new_n38_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n42_), .c(new_n25_), .O(new_n66_));
  oai21  g42(.a(new_n26_), .b(x01), .c(x08), .O(new_n67_));
  nand3  g43(.a(new_n60_), .b(new_n52_), .c(x03), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n36_), .c(new_n66_), .O(z7));
  inv1   g46(.a(new_n60_), .O(new_n71_));
  nand3  g47(.a(new_n46_), .b(new_n52_), .c(x00), .O(new_n72_));
  nand3  g48(.a(new_n55_), .b(x09), .c(x03), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n72_), .O(new_n74_));
