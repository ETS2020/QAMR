...
module FAU ( 
  ...
  nand2  g37(.a(new_n55_), .b(new_n49_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n59_), .c(new_n62_), .O(z4));
  nor2   g39(.a(x12), .b(x10), .O(new_n64_));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n49_), .d(x13), .O(z5));
  nor2   g42(.a(x10), .b(x07), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n68_));
  nand3  g44(.a(x09), .b(new_n25_), .c(new_n26_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n58_), .d(new_n67_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n49_), .O(z6));
  oai21  g47(.a(new_n60_), .b(x01), .c(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n40_), .b(new_n44_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n67_), .O(z7));
  nand3  g51(.a(new_n49_), .b(new_n60_), .c(x00), .O(new_n76_));
  nand4  g52(.a(new_n39_), .b(new_n54_), .c(x09), .d(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n67_), .O(z8));
endmodule
