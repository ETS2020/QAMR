...
module FAU ( 
  ...
  oai21  g25(.a(new_n49_), .b(new_n47_), .c(new_n32_), .O(z3));
  nand4  g26(.a(x09), .b(x08), .c(new_n38_), .d(x00), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n47_), .c(new_n32_), .O(z4));
  nor2   g29(.a(x07), .b(x00), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n48_), .d(new_n43_), .O(new_n55_));
  and2   g31(.a(new_n55_), .b(new_n32_), .O(z5));
  nand2  g32(.a(new_n42_), .b(new_n34_), .O(new_n57_));
  ...
  oai21  g39(.a(new_n63_), .b(new_n59_), .c(new_n32_), .O(z6));
  inv1   g40(.a(x01), .O(new_n65_));
  oai21  g41(.a(new_n44_), .b(new_n34_), .c(new_n65_), .O(new_n66_));
  nand3  g42(.a(new_n43_), .b(x08), .c(new_n38_), .O(new_n67_));
  aoi21  g43(.a(x03), .b(new_n31_), .c(new_n67_), .O(new_n68_));
  aoi21  g44(.a(new_n66_), .b(new_n31_), .c(new_n68_), .O(z7));
  nand3  g45(.a(new_n48_), .b(new_n43_), .c(new_n38_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n58_), .c(new_n65_), .O(new_n71_));
  nand3  g47(.a(new_n60_), .b(new_n42_), .c(x00), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(new_n73_));
  aoi21  g49(.a(new_n71_), .b(new_n31_), .c(new_n73_), .O(z8));
endmodule
