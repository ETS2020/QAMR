...
module FAU ( 
  ...
  nand2  g30(.a(new_n48_), .b(new_n25_), .O(new_n55_));
  aoi21  g31(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(z4));
  nor2   g32(.a(x07), .b(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n47_), .d(new_n41_), .O(new_n58_));
  and2   g34(.a(new_n58_), .b(new_n25_), .O(z5));
  xnor2a g35(.a(x09), .b(x03), .O(new_n60_));
  nor2   g36(.a(x02), .b(x01), .O(new_n61_));
  nand3  g37(.a(new_n51_), .b(new_n38_), .c(new_n25_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(z6));
  oai21  g39(.a(new_n53_), .b(new_n34_), .c(new_n33_), .O(new_n64_));
  aoi21  g40(.a(x08), .b(x01), .c(x02), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g42(.a(new_n42_), .b(new_n25_), .O(new_n67_));
  nand2  g43(.a(x03), .b(new_n31_), .O(new_n68_));
  nor2   g44(.a(x08), .b(x01), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(z7));
  nand3  g47(.a(new_n25_), .b(new_n53_), .c(x00), .O(new_n72_));
  nand3  g48(.a(new_n47_), .b(x09), .c(new_n33_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n68_), .c(new_n72_), .O(new_n74_));
