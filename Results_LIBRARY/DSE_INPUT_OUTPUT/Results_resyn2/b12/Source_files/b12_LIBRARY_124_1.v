...
module FAU ( 
  ...
  nor2   g31(.a(new_n55_), .b(new_n25_), .O(new_n56_));
  ...
  nand2  g42(.a(new_n40_), .b(x03), .O(new_n67_));
  ...
  oai21  g46(.a(new_n55_), .b(new_n25_), .c(new_n70_), .O(new_n71_));
  aoi21  g47(.a(new_n69_), .b(new_n65_), .c(new_n71_), .O(z6));
  oai21  g48(.a(new_n67_), .b(new_n45_), .c(new_n26_), .O(new_n73_));
  ...
  nand2  g53(.a(new_n40_), .b(x00), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n59_), .O(new_n79_));
  nand3  g55(.a(new_n51_), .b(x09), .c(new_n26_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n74_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n70_), .O(z8));
endmodule
