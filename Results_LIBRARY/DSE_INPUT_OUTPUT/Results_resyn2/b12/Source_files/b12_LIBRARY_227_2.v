...
module FAU ( 
  ...
  nand3  g22(.a(x07), .b(new_n46_), .c(new_n25_), .O(new_n47_));
  ...
  nand3  g27(.a(x10), .b(new_n46_), .c(new_n43_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n35_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n50_), .c(new_n33_), .O(z2));
  nand2  g31(.a(x12), .b(new_n25_), .O(new_n56_));
  nand2  g32(.a(x11), .b(x07), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n33_), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(z3));
  inv1   g35(.a(new_n49_), .O(new_n60_));
  nand2  g36(.a(new_n57_), .b(new_n33_), .O(new_n61_));
  inv1   g37(.a(x09), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(x07), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n60_), .c(new_n61_), .O(z4));
  nor2   g40(.a(x12), .b(x00), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n44_), .c(x13), .O(z5));
  ...
  nand4  g47(.a(x09), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n44_), .O(z7));
  oai22  g52(.a(new_n72_), .b(x12), .c(x09), .d(new_n25_), .O(new_n77_));
