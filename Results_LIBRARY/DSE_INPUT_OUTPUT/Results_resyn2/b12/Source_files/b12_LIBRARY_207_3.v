...
module FAU ( 
  ...
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n44_), .d(new_n25_), .O(new_n62_));
  ...
  nand4  g43(.a(new_n67_), .b(new_n64_), .c(new_n49_), .d(new_n32_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(z6));
  oai21  g45(.a(new_n36_), .b(x01), .c(new_n45_), .O(new_n70_));
  oai21  g46(.a(x14), .b(new_n45_), .c(x02), .O(new_n71_));
  inv1   g47(.a(x01), .O(new_n72_));
  nand4  g48(.a(x09), .b(x03), .c(new_n40_), .d(new_n72_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n71_), .c(new_n70_), .d(new_n49_), .O(z7));
  nand3  g50(.a(new_n32_), .b(new_n48_), .c(x00), .O(new_n75_));
