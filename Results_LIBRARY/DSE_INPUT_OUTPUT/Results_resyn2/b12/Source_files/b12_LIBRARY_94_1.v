...
module FAU ( 
  ...
  aoi21  g23(.a(new_n45_), .b(new_n26_), .c(new_n47_), .O(z2));
  ...
  nor2   g31(.a(new_n55_), .b(new_n28_), .O(new_n56_));
  ...
  nand2  g38(.a(new_n53_), .b(new_n27_), .O(new_n63_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n39_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n64_), .c(new_n34_), .O(z6));
  nand2  g44(.a(new_n62_), .b(new_n26_), .O(new_n69_));
  ...
  aoi21  g50(.a(x02), .b(new_n33_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n49_), .b(x09), .c(new_n26_), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n71_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n39_), .O(z8));
endmodule
