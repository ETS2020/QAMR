...
module FAU ( 
  ...
  nand2  g17(.a(x06), .b(new_n25_), .O(new_n42_));
  ...
  oai21  g34(.a(new_n58_), .b(new_n56_), .c(new_n42_), .O(z3));
  ...
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n42_), .d(x13), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n51_), .O(new_n70_));
  ...
  inv1   g50(.a(x01), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n25_), .c(new_n75_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n45_), .c(new_n48_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(z7));
  oai21  g54(.a(new_n76_), .b(x12), .c(x09), .O(new_n79_));
  oai21  g55(.a(x09), .b(new_n25_), .c(x06), .O(new_n80_));
  aoi21  g56(.a(new_n50_), .b(new_n27_), .c(new_n48_), .O(new_n81_));
