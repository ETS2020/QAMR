...
module FAU ( 
  ...
  nand2  g03(.a(new_n27_), .b(x07), .O(new_n28_));
  ...
  oai21  g20(.a(new_n31_), .b(x02), .c(new_n26_), .O(new_n45_));
  inv1   g21(.a(x08), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n25_), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(x07), .c(new_n45_), .O(z2));
  ...
  nand3  g28(.a(x09), .b(new_n36_), .c(x00), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(new_n47_), .c(x11), .d(x07), .O(z4));
  inv1   g31(.a(x10), .O(new_n56_));
  inv1   g32(.a(x12), .O(new_n57_));
  nand4  g33(.a(x13), .b(new_n57_), .c(new_n56_), .d(new_n26_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x02), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n36_), .O(z5));
  ...
  oai21  g40(.a(x10), .b(new_n46_), .c(x02), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n36_), .O(z7));
  inv1   g42(.a(x09), .O(new_n67_));
  nand3  g43(.a(new_n56_), .b(new_n67_), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x02), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n36_), .O(z8));
endmodule
