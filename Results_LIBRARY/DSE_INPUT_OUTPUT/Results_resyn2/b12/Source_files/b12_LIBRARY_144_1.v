...
module FAU ( 
  ...
  oai21  g20(.a(x02), .b(new_n32_), .c(new_n44_), .O(new_n45_));
  aoi21  g21(.a(new_n43_), .b(new_n32_), .c(new_n45_), .O(z2));
  ...
  nand2  g26(.a(new_n48_), .b(new_n33_), .O(new_n51_));
  ...
  and2   g35(.a(new_n59_), .b(new_n33_), .O(z5));
  ...
  nand3  g41(.a(new_n52_), .b(new_n56_), .c(new_n65_), .O(new_n66_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n40_), .O(z7));
  nand3  g52(.a(new_n57_), .b(new_n56_), .c(new_n65_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n70_), .c(new_n26_), .O(new_n78_));
  nand3  g54(.a(new_n40_), .b(new_n39_), .c(x00), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n78_), .b(new_n32_), .c(new_n80_), .O(z8));
endmodule
