...
module FAU ( 
  ...
  nand2  g32(.a(x14), .b(new_n25_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(x01), .c(new_n30_), .O(new_n58_));
  ...
  nor2   g41(.a(new_n65_), .b(new_n58_), .O(z6));
  inv1   g42(.a(x03), .O(new_n67_));
  oai21  g43(.a(new_n40_), .b(new_n67_), .c(new_n30_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n26_), .O(new_n69_));
  oai21  g45(.a(new_n67_), .b(x01), .c(new_n38_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n41_), .O(z7));
  nand2  g47(.a(new_n27_), .b(new_n40_), .O(new_n72_));
  nor2   g48(.a(new_n67_), .b(x01), .O(new_n73_));
  nor2   g49(.a(new_n40_), .b(x02), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(new_n75_));
