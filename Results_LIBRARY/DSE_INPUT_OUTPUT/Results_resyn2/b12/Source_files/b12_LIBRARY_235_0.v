...
module FAU ( 
  ...
  nand3  g03(.a(x13), .b(new_n27_), .c(x01), .O(new_n28_));
  ...
  nand4  g25(.a(new_n49_), .b(new_n46_), .c(x13), .d(new_n31_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n27_), .c(new_n45_), .O(z2));
  nand2  g27(.a(x12), .b(new_n42_), .O(new_n52_));
  nand2  g28(.a(x11), .b(x07), .O(new_n53_));
  inv1   g29(.a(x13), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n27_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(z3));
  nand2  g33(.a(new_n55_), .b(new_n53_), .O(new_n58_));
  nand2  g34(.a(x08), .b(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  nor2   g36(.a(new_n47_), .b(x07), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(new_n58_), .O(z4));
  nor2   g38(.a(x12), .b(x10), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n43_), .d(new_n42_), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n55_), .O(z5));
  nand2  g41(.a(new_n47_), .b(new_n38_), .O(new_n66_));
  nand2  g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n27_), .b(new_n31_), .O(new_n68_));
  aoi21  g44(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n42_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n59_), .c(new_n48_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n55_), .O(z6));
  oai21  g48(.a(new_n67_), .b(x01), .c(x13), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n27_), .O(new_n74_));
  oai21  g50(.a(new_n68_), .b(new_n38_), .c(new_n44_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z7));
  inv1   g52(.a(new_n63_), .O(new_n77_));
  nand4  g53(.a(x09), .b(new_n43_), .c(x03), .d(new_n31_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x13), .O(new_n79_));
  nand3  g55(.a(new_n48_), .b(new_n47_), .c(x00), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n27_), .c(new_n81_), .O(z8));
endmodule
