...
module FAU ( 
  ...
  nand2  g33(.a(new_n25_), .b(new_n27_), .O(new_n58_));
  nand2  g34(.a(x09), .b(x03), .O(new_n59_));
  inv1   g35(.a(x09), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n33_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n59_), .c(new_n58_), .O(new_n62_));
  inv1   g38(.a(x08), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n30_), .c(new_n38_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n62_), .c(new_n47_), .O(z6));
  nand2  g41(.a(new_n59_), .b(new_n27_), .O(new_n66_));
  aoi21  g42(.a(x08), .b(x01), .c(x02), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g44(.a(new_n47_), .b(new_n42_), .O(new_n69_));
  nand2  g45(.a(x03), .b(new_n25_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n63_), .c(new_n27_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(z7));
  inv1   g48(.a(x12), .O(new_n73_));
  nor2   g49(.a(x02), .b(x01), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(x09), .d(x03), .O(new_n75_));
  nand2  g51(.a(new_n60_), .b(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n47_), .O(new_n77_));
