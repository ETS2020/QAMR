...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n53_), .c(new_n63_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n62_), .c(new_n31_), .O(z6));
  inv1   g42(.a(x01), .O(new_n67_));
  nand2  g43(.a(new_n60_), .b(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n30_), .O(new_n69_));
  oai21  g45(.a(new_n34_), .b(x02), .c(new_n40_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(z7));
  inv1   g47(.a(x12), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n44_), .c(new_n39_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n60_), .c(new_n67_), .O(new_n74_));
