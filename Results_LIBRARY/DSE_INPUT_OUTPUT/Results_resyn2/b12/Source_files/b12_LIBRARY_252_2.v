...
module FAU ( 
  ...
  nand3  g03(.a(x14), .b(new_n27_), .c(x02), .O(new_n28_));
  ...
  nand4  g08(.a(new_n32_), .b(x14), .c(x02), .d(x01), .O(new_n33_));
  aoi21  g09(.a(new_n33_), .b(new_n30_), .c(x00), .O(z0));
  inv1   g10(.a(x14), .O(new_n35_));
  ...
  nor2   g19(.a(x14), .b(new_n43_), .O(new_n44_));
  ...
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n36_), .d(x13), .O(z5));
  xor2a  g43(.a(x09), .b(x03), .O(new_n68_));
  nor3   g44(.a(new_n68_), .b(x02), .c(x01), .O(new_n69_));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  inv1   g46(.a(x00), .O(new_n71_));
  nand3  g47(.a(x02), .b(x01), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n51_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n69_), .c(new_n36_), .O(z6));
  ...
  nand2  g56(.a(new_n59_), .b(new_n43_), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n76_), .c(new_n37_), .d(x09), .O(new_n82_));
