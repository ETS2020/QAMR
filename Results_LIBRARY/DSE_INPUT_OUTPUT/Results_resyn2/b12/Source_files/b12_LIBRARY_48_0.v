...
module FAU ( 
  ...
  nor2   g16(.a(x06), .b(x02), .O(new_n41_));
  ...
  nand2  g29(.a(new_n53_), .b(new_n42_), .O(z2));
  inv1   g30(.a(x12), .O(new_n55_));
  and2   g31(.a(x11), .b(x07), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n41_), .O(new_n57_));
  ...
  nor3   g38(.a(new_n41_), .b(x07), .c(x00), .O(new_n63_));
  ...
  nand2  g45(.a(new_n47_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n26_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n66_), .d(new_n65_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n42_), .O(z6));
  nand2  g50(.a(x03), .b(new_n45_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n49_), .c(x06), .O(new_n76_));
  nand2  g52(.a(new_n65_), .b(x08), .O(new_n77_));
  aoi21  g53(.a(new_n69_), .b(x03), .c(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n76_), .b(new_n25_), .c(new_n78_), .O(z7));
  inv1   g55(.a(new_n69_), .O(new_n80_));
  nand2  g56(.a(new_n47_), .b(x00), .O(new_n81_));
  nand4  g57(.a(new_n55_), .b(x09), .c(x06), .d(x03), .O(new_n82_));
  oai22  g58(.a(new_n82_), .b(new_n80_), .c(new_n81_), .d(new_n41_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n65_), .O(z8));
endmodule
