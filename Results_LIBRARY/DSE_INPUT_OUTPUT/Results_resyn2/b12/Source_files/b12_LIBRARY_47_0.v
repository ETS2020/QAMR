...
module FAU ( 
  ...
  nand2  g19(.a(x12), .b(new_n25_), .O(new_n44_));
  nand2  g20(.a(x11), .b(x07), .O(new_n45_));
  nand3  g21(.a(new_n45_), .b(new_n44_), .c(new_n34_), .O(new_n46_));
  inv1   g22(.a(new_n46_), .O(z3));
  inv1   g23(.a(x07), .O(new_n48_));
  nand4  g24(.a(x09), .b(x08), .c(new_n48_), .d(x00), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n45_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n34_), .O(z4));
  nor2   g27(.a(x12), .b(x10), .O(new_n52_));
  nand4  g28(.a(new_n52_), .b(x13), .c(new_n48_), .d(new_n25_), .O(new_n53_));
  and2   g29(.a(new_n53_), .b(new_n34_), .O(z5));
  nand2  g30(.a(x08), .b(x00), .O(new_n55_));
  nor2   g31(.a(x10), .b(x07), .O(new_n56_));
  nand4  g32(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n55_), .d(new_n34_), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(z6));
  and2   g35(.a(new_n56_), .b(new_n34_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x08), .O(z7));
  nor2   g37(.a(x09), .b(new_n25_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n60_), .O(z8));
endmodule
