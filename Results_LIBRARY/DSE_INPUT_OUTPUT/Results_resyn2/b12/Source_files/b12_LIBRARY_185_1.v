...
module FAU ( 
  ...
  nand2  g22(.a(new_n32_), .b(new_n44_), .O(new_n47_));
  ...
  nand3  g47(.a(new_n62_), .b(x09), .c(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(z7));
  nand4  g49(.a(new_n53_), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n74_));
  oai21  g50(.a(x09), .b(x00), .c(new_n44_), .O(new_n75_));
  aoi21  g51(.a(new_n74_), .b(x09), .c(new_n75_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x13), .c(new_n32_), .O(z8));
endmodule
