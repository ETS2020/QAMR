...
module FAU ( 
  ...
  nand4  g35(.a(new_n59_), .b(x13), .c(new_n52_), .d(new_n58_), .O(new_n60_));
  ...
  nand2  g40(.a(new_n64_), .b(new_n39_), .O(new_n65_));
  ...
  oai21  g47(.a(x08), .b(x03), .c(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n33_), .O(new_n73_));
  oai21  g49(.a(x08), .b(new_n39_), .c(new_n41_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n50_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n73_), .O(z7));
  nand3  g52(.a(new_n52_), .b(new_n58_), .c(new_n45_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n71_), .c(new_n28_), .O(new_n78_));
  nand3  g54(.a(new_n41_), .b(new_n40_), .c(x00), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n78_), .b(new_n39_), .c(new_n80_), .O(z8));
endmodule
