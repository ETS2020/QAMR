...
module FAU ( 
  ...
  aoi22  g24(.a(new_n48_), .b(new_n39_), .c(new_n42_), .d(new_n27_), .O(z2));
  ...
  nand2  g29(.a(new_n53_), .b(new_n50_), .O(z3));
  nor2   g30(.a(new_n41_), .b(new_n25_), .O(new_n55_));
  ...
  nand2  g46(.a(new_n70_), .b(new_n50_), .O(z6));
  nand4  g47(.a(x09), .b(x03), .c(new_n39_), .d(new_n43_), .O(new_n72_));
  oai21  g48(.a(new_n26_), .b(x01), .c(new_n41_), .O(new_n73_));
  oai21  g49(.a(new_n41_), .b(new_n26_), .c(x02), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n45_), .O(z7));
  nand2  g51(.a(new_n27_), .b(new_n44_), .O(new_n76_));
