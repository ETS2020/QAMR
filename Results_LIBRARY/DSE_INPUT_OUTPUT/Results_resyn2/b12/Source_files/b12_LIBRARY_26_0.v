...
module FAU ( 
  ...
  nand4  g32(.a(x14), .b(x02), .c(x01), .d(new_n36_), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n47_), .d(new_n31_), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(z6));
  aoi22  g35(.a(new_n56_), .b(x08), .c(new_n30_), .d(new_n29_), .O(z7));
  nand4  g36(.a(new_n56_), .b(new_n31_), .c(new_n49_), .d(x00), .O(z8));
endmodule
