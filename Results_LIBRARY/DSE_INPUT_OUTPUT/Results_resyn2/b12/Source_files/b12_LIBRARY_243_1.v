...
module FAU ( 
  ...
  nand4  g37(.a(new_n61_), .b(new_n60_), .c(new_n46_), .d(x13), .O(z5));
  nand2  g38(.a(x09), .b(x03), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n30_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(x01), .O(new_n66_));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  nand3  g43(.a(new_n28_), .b(x14), .c(x02), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n38_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n66_), .c(new_n46_), .O(z6));
  nand2  g46(.a(new_n63_), .b(new_n29_), .O(new_n71_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n38_), .O(z7));
  nand2  g51(.a(new_n64_), .b(x00), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n52_), .O(new_n77_));
  nand2  g53(.a(x09), .b(new_n29_), .O(new_n78_));
  nor3   g54(.a(new_n78_), .b(new_n73_), .c(x12), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n38_), .O(z8));
endmodule
