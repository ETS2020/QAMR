...
module FAU ( 
  ...
  nand2  g29(.a(x12), .b(new_n28_), .O(new_n54_));
  nand2  g30(.a(x11), .b(x07), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n54_), .c(new_n39_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(z3));
  inv1   g33(.a(x09), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(x07), .O(new_n59_));
  nand2  g35(.a(new_n55_), .b(new_n39_), .O(new_n60_));
  ...
  nand2  g41(.a(new_n65_), .b(x05), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x13), .O(z5));
  xnor2a g43(.a(x09), .b(x03), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n28_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n61_), .c(new_n44_), .d(new_n39_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n37_), .c(new_n70_), .O(z6));
  nand2  g47(.a(new_n37_), .b(x03), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  nand2  g49(.a(new_n44_), .b(new_n39_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n73_), .c(new_n74_), .O(new_n75_));
  oai21  g51(.a(new_n72_), .b(new_n58_), .c(new_n75_), .O(z7));
  oai21  g52(.a(new_n72_), .b(x12), .c(x09), .O(new_n77_));
  inv1   g53(.a(new_n44_), .O(new_n78_));
  aoi21  g54(.a(new_n58_), .b(new_n28_), .c(new_n78_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n77_), .c(x13), .d(new_n25_), .O(z8));
endmodule
