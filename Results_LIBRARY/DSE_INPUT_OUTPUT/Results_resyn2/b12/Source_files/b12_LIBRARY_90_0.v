...
module FAU ( 
  ...
  nand2  g25(.a(new_n49_), .b(new_n40_), .O(z3));
  ...
  nand2  g30(.a(new_n48_), .b(new_n40_), .O(new_n55_));
  aoi21  g31(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(z4));
  nor3   g32(.a(x10), .b(x07), .c(x00), .O(new_n57_));
  inv1   g33(.a(x13), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(x12), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n57_), .c(new_n39_), .O(z5));
  inv1   g36(.a(x01), .O(new_n61_));
  oai21  g37(.a(new_n57_), .b(new_n25_), .c(new_n61_), .O(new_n62_));
  nand3  g38(.a(x14), .b(x02), .c(new_n35_), .O(new_n63_));
  nor2   g39(.a(x10), .b(x07), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n51_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n62_), .O(z6));
  aoi21  g42(.a(new_n64_), .b(x08), .c(new_n39_), .O(z7));
  nand4  g43(.a(new_n64_), .b(new_n40_), .c(new_n53_), .d(x00), .O(z8));
endmodule
