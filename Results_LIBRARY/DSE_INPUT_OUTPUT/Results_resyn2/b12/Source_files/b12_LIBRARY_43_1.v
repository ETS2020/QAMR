...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(new_n43_), .c(new_n32_), .O(new_n47_));
  nor2   g23(.a(x11), .b(x02), .O(new_n48_));
  inv1   g24(.a(x07), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  inv1   g27(.a(x00), .O(new_n52_));
  aoi21  g28(.a(x11), .b(new_n27_), .c(new_n52_), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(new_n51_), .c(new_n48_), .d(new_n47_), .O(z2));
  aoi21  g30(.a(new_n49_), .b(x02), .c(new_n28_), .O(new_n55_));
  aoi21  g31(.a(x12), .b(new_n52_), .c(new_n55_), .O(z3));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  nor2   g34(.a(new_n44_), .b(x07), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(new_n55_), .O(z4));
  nand2  g36(.a(x11), .b(new_n27_), .O(new_n61_));
  inv1   g37(.a(x12), .O(new_n62_));
  nand2  g38(.a(new_n45_), .b(new_n62_), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n61_), .c(x13), .d(new_n52_), .O(z5));
  xor2a  g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n27_), .b(new_n32_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n52_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n57_), .c(new_n45_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n61_), .O(z6));
  nand3  g47(.a(x09), .b(x03), .c(new_n32_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n28_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n27_), .O(new_n74_));
  nand3  g50(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n50_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n45_), .O(z7));
  oai21  g53(.a(new_n72_), .b(new_n63_), .c(new_n28_), .O(new_n78_));
  nand3  g54(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n78_), .b(new_n27_), .c(new_n80_), .O(z8));
endmodule
