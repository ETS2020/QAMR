...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n76_, new_n78_, new_n79_, new_n80_, new_n82_, new_n83_;
  ...
  nand2  g35(.a(new_n55_), .b(new_n37_), .O(new_n60_));
  ...
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n45_), .d(new_n29_), .O(new_n65_));
  and2   g41(.a(new_n65_), .b(new_n37_), .O(z5));
  inv1   g42(.a(new_n62_), .O(new_n67_));
  ...
  nand2  g51(.a(new_n34_), .b(x03), .O(new_n79_));
  nand2  g52(.a(new_n79_), .b(new_n61_), .O(new_n80_));
  nand3  g53(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(z7));
  oai21  g54(.a(new_n79_), .b(x12), .c(x09), .O(new_n82_));
  aoi21  g55(.a(new_n58_), .b(new_n29_), .c(new_n74_), .O(new_n83_));
  aoi21  g56(.a(new_n83_), .b(new_n82_), .c(new_n36_), .O(z8));
endmodule
