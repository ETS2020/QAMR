...
module FAU ( 
  ...
  oai21  g45(.a(new_n42_), .b(new_n30_), .c(new_n29_), .O(new_n70_));
  nand3  g46(.a(new_n41_), .b(x08), .c(new_n39_), .O(new_n71_));
  ...
  oai21  g51(.a(new_n75_), .b(new_n64_), .c(new_n29_), .O(new_n76_));
