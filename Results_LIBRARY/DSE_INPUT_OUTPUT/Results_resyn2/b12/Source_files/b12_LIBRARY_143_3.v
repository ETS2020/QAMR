...
module FAU ( 
  ...
  nand2  g07(.a(x12), .b(x11), .O(new_n32_));
  ...
  nand2  g42(.a(new_n60_), .b(new_n32_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(new_n69_));
  aoi21  g45(.a(new_n64_), .b(new_n63_), .c(new_n69_), .O(z6));
  inv1   g46(.a(x08), .O(new_n71_));
  nand2  g47(.a(new_n63_), .b(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g49(.a(new_n63_), .b(x09), .c(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n68_), .O(z7));
  nand3  g51(.a(new_n32_), .b(new_n45_), .c(x00), .O(new_n76_));
  oai21  g52(.a(new_n74_), .b(x12), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n60_), .O(z8));
endmodule
