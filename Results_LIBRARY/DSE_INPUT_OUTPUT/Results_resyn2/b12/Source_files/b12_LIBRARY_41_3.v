...
module FAU ( 
  ...
  nand2  g36(.a(new_n25_), .b(new_n27_), .O(new_n61_));
  nand2  g37(.a(x09), .b(x03), .O(new_n62_));
  nand2  g38(.a(new_n54_), .b(new_n33_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  oai21  g40(.a(new_n52_), .b(new_n30_), .c(new_n38_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n50_), .O(z6));
  nand2  g42(.a(new_n62_), .b(new_n27_), .O(new_n67_));
  aoi21  g43(.a(x08), .b(x01), .c(x02), .O(new_n68_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n52_), .c(new_n27_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(z7));
  nor2   g49(.a(x02), .b(x01), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n47_), .c(x09), .d(x03), .O(new_n75_));
