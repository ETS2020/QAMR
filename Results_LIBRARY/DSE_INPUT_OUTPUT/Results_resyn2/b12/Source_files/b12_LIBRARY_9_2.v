...
module FAU ( 
  ...
  nor2   g11(.a(x12), .b(new_n27_), .O(new_n36_));
  ...
  nor2   g31(.a(new_n55_), .b(new_n36_), .O(new_n56_));
  ...
  nor2   g36(.a(new_n60_), .b(new_n36_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n59_), .c(new_n56_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nor2   g39(.a(x02), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n45_), .c(x13), .d(new_n63_), .O(z5));
  nand3  g41(.a(x14), .b(x01), .c(new_n25_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(x12), .c(x02), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n26_), .O(new_n68_));
  inv1   g44(.a(x09), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n44_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n27_), .O(new_n72_));
  oai21  g48(.a(new_n58_), .b(new_n25_), .c(new_n45_), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n67_), .c(new_n73_), .O(z6));
  ...
  aoi21  g55(.a(new_n58_), .b(x02), .c(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n78_), .c(new_n36_), .O(z7));
  oai22  g57(.a(new_n76_), .b(x12), .c(x09), .d(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n45_), .c(new_n37_), .O(z8));
endmodule
