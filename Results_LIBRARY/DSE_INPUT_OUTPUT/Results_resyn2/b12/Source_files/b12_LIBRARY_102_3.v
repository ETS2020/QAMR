...
module FAU ( 
  ...
  nand2  g07(.a(x14), .b(x02), .O(new_n32_));
  nand2  g08(.a(new_n32_), .b(new_n31_), .O(z0));
  inv1   g09(.a(x14), .O(new_n34_));
  ...
  nand4  g14(.a(new_n38_), .b(new_n35_), .c(new_n34_), .d(x02), .O(new_n39_));
  inv1   g15(.a(x02), .O(new_n40_));
  nand3  g16(.a(x03), .b(new_n40_), .c(x01), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(new_n39_), .c(x00), .O(z1));
  nand2  g18(.a(new_n34_), .b(x02), .O(new_n43_));
  inv1   g19(.a(x07), .O(new_n44_));
  inv1   g20(.a(x08), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n44_), .c(new_n25_), .O(new_n46_));
  nor2   g22(.a(x02), .b(x01), .O(new_n47_));
  ...
  aoi21  g28(.a(new_n52_), .b(new_n43_), .c(new_n46_), .O(z2));
  ...
  nor2   g33(.a(new_n45_), .b(new_n25_), .O(new_n58_));
  nor2   g34(.a(new_n48_), .b(x07), .O(new_n59_));
  nand2  g35(.a(new_n55_), .b(new_n32_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z4));
  nor2   g37(.a(x12), .b(x10), .O(new_n62_));
  nor2   g38(.a(x07), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n32_), .d(x13), .O(z5));
  inv1   g40(.a(new_n58_), .O(new_n65_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n65_), .c(new_n49_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n32_), .O(z6));
  inv1   g46(.a(new_n32_), .O(new_n71_));
  inv1   g47(.a(x01), .O(new_n72_));
  nand3  g48(.a(x03), .b(new_n40_), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x08), .O(new_n74_));
  nand3  g50(.a(new_n47_), .b(new_n48_), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n49_), .c(new_n71_), .O(z7));
  nand2  g53(.a(new_n54_), .b(x09), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(new_n73_), .c(x09), .d(new_n25_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n49_), .c(new_n71_), .O(z8));
endmodule
