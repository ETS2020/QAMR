...
module FAU ( 
  ...
  nand2  g30(.a(new_n51_), .b(new_n31_), .O(new_n55_));
  ...
  nand2  g41(.a(new_n56_), .b(x03), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n37_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  aoi21  g44(.a(x08), .b(x00), .c(x02), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n64_), .c(new_n47_), .O(z6));
  nand3  g47(.a(new_n28_), .b(x09), .c(x03), .O(new_n72_));
  oai21  g48(.a(new_n29_), .b(new_n37_), .c(new_n30_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z7));
  nand3  g50(.a(new_n31_), .b(new_n56_), .c(x00), .O(new_n75_));
  oai21  g51(.a(new_n72_), .b(x12), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n46_), .O(z8));
endmodule
