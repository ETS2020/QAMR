...
module FAU ( 
  ...
  nand3  g27(.a(new_n51_), .b(new_n47_), .c(new_n44_), .O(new_n52_));
  oai21  g28(.a(x08), .b(x07), .c(x00), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n34_), .O(new_n54_));
  aoi21  g30(.a(new_n52_), .b(new_n36_), .c(new_n54_), .O(z2));
  inv1   g31(.a(x11), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n48_), .O(new_n57_));
  aoi22  g33(.a(new_n57_), .b(new_n34_), .c(x12), .d(new_n25_), .O(z3));
  nand2  g34(.a(x08), .b(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  nor2   g36(.a(new_n45_), .b(x07), .O(new_n61_));
  oai21  g37(.a(new_n56_), .b(new_n48_), .c(new_n34_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(z4));
  oai21  g39(.a(new_n50_), .b(x00), .c(x13), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n32_), .O(z5));
  nor2   g41(.a(x02), .b(x01), .O(new_n66_));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  and2   g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n59_), .c(new_n46_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n34_), .O(z6));
  inv1   g47(.a(x08), .O(new_n72_));
  nand3  g48(.a(x03), .b(new_n36_), .c(new_n44_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  and2   g50(.a(x09), .b(x03), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n66_), .c(new_n50_), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n74_), .c(new_n33_), .d(new_n32_), .O(z7));
  nand3  g53(.a(new_n75_), .b(new_n66_), .c(new_n32_), .O(new_n78_));
  oai21  g54(.a(x09), .b(new_n25_), .c(new_n78_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n46_), .c(new_n34_), .O(z8));
endmodule
