...
module FAU ( 
  ...
  nand2  g07(.a(x14), .b(x10), .O(new_n32_));
  ...
  nand2  g14(.a(new_n32_), .b(new_n25_), .O(new_n39_));
  aoi21  g15(.a(new_n38_), .b(new_n35_), .c(new_n39_), .O(z1));
  ...
  nand2  g35(.a(new_n53_), .b(new_n32_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n57_), .c(new_n60_), .O(z4));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n52_), .d(new_n45_), .O(new_n63_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n42_), .O(new_n69_));
  aoi21  g45(.a(new_n66_), .b(new_n65_), .c(new_n69_), .O(z6));
  nand4  g46(.a(x09), .b(x03), .c(new_n34_), .d(new_n41_), .O(new_n71_));
  nand3  g47(.a(x03), .b(new_n34_), .c(new_n41_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n42_), .O(z7));
  oai22  g50(.a(new_n71_), .b(x12), .c(x09), .d(new_n25_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n42_), .O(z8));
endmodule
