...
module FAU ( 
  ...
  nand2  g10(.a(x13), .b(x02), .O(new_n35_));
  ...
  nand2  g31(.a(new_n55_), .b(new_n35_), .O(z3));
  ...
  nand2  g36(.a(new_n54_), .b(new_n35_), .O(new_n61_));
  aoi21  g37(.a(new_n60_), .b(new_n58_), .c(new_n61_), .O(z4));
  nand3  g38(.a(new_n43_), .b(new_n53_), .c(new_n37_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n28_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(x13), .O(z5));
  nand2  g41(.a(x09), .b(new_n32_), .O(new_n66_));
  nand2  g42(.a(new_n57_), .b(x03), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n30_), .O(new_n68_));
  nand3  g44(.a(new_n29_), .b(x14), .c(new_n37_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n59_), .d(new_n43_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n35_), .O(z6));
  inv1   g47(.a(new_n35_), .O(new_n72_));
  nand2  g48(.a(new_n30_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x08), .O(new_n74_));
  nand3  g50(.a(new_n30_), .b(new_n57_), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n43_), .c(new_n72_), .O(z7));
  nand2  g53(.a(new_n53_), .b(x09), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(new_n73_), .c(x09), .d(new_n37_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n43_), .c(new_n72_), .O(z8));
endmodule
