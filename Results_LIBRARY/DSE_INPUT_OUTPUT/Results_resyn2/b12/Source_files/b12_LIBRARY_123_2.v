...
module FAU ( 
  ...
  oai21  g30(.a(x13), .b(new_n48_), .c(x00), .O(new_n55_));
  ...
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n66_), .d(new_n68_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n33_), .O(z6));
  nand3  g51(.a(new_n69_), .b(x09), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n69_), .b(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n54_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n66_), .O(z7));
  nand2  g55(.a(x13), .b(x07), .O(new_n80_));
  nand3  g56(.a(new_n69_), .b(new_n59_), .c(x03), .O(new_n81_));
  oai21  g57(.a(x09), .b(x00), .c(new_n49_), .O(new_n82_));
  aoi21  g58(.a(new_n81_), .b(x09), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x07), .c(new_n80_), .O(z8));
endmodule
