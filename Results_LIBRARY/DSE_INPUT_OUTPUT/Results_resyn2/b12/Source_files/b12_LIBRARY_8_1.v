...
module FAU ( 
  ...
  nand2  g43(.a(new_n42_), .b(x03), .O(new_n68_));
  ...
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n58_), .d(new_n67_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n33_), .O(z6));
  oai21  g49(.a(new_n68_), .b(new_n47_), .c(new_n26_), .O(new_n74_));
  nand2  g50(.a(x03), .b(new_n32_), .O(new_n75_));
  nand2  g51(.a(new_n67_), .b(x08), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n75_), .c(new_n74_), .d(new_n32_), .O(z7));
  nand2  g54(.a(new_n42_), .b(x00), .O(new_n79_));
  nor2   g55(.a(new_n79_), .b(new_n61_), .O(new_n80_));
  nand3  g56(.a(new_n63_), .b(x09), .c(new_n26_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(new_n75_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n80_), .c(new_n67_), .O(z8));
endmodule
