...
module FAU ( 
  ...
  nand3  g30(.a(x13), .b(new_n43_), .c(new_n54_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n53_), .c(new_n52_), .O(z5));
  nand4  g33(.a(x14), .b(x02), .c(x01), .d(new_n36_), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  nor2   g35(.a(x10), .b(x07), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n47_), .c(new_n31_), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(new_n59_), .O(z6));
  aoi21  g38(.a(new_n60_), .b(x08), .c(new_n52_), .O(z7));
  nor2   g39(.a(x09), .b(new_n36_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n60_), .c(new_n52_), .O(z8));
endmodule
