...
module FAU ( 
  ...
  nor2   g08(.a(new_n32_), .b(x12), .O(new_n33_));
  ...
  nor2   g33(.a(new_n57_), .b(new_n33_), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(new_n56_), .O(z3));
  inv1   g35(.a(x08), .O(new_n60_));
  nor2   g36(.a(new_n60_), .b(new_n25_), .O(new_n61_));
  nand2  g37(.a(x09), .b(new_n47_), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(new_n33_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n61_), .c(new_n58_), .O(z4));
  nor2   g40(.a(x14), .b(x12), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n45_), .c(x13), .d(new_n25_), .O(z5));
  inv1   g42(.a(new_n61_), .O(new_n67_));
  nand4  g43(.a(new_n56_), .b(x14), .c(x02), .d(x01), .O(new_n68_));
  inv1   g44(.a(x09), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x03), .O(new_n70_));
  inv1   g46(.a(x03), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n70_), .c(new_n36_), .d(new_n44_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n68_), .c(new_n67_), .d(new_n45_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n34_), .O(z6));
  nand4  g51(.a(x09), .b(x03), .c(new_n36_), .d(new_n44_), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n36_), .c(new_n44_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n60_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n76_), .c(new_n45_), .d(new_n34_), .O(z7));
  inv1   g55(.a(new_n65_), .O(new_n80_));
  nand2  g56(.a(new_n69_), .b(x00), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n33_), .c(new_n76_), .d(new_n80_), .O(new_n82_));
