...
module FAU ( 
  ...
  oai21  g30(.a(new_n54_), .b(x00), .c(new_n45_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x11), .O(z3));
  oai21  g32(.a(x12), .b(x07), .c(new_n32_), .O(new_n57_));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n46_), .c(new_n45_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n57_), .O(z4));
  nor2   g36(.a(x10), .b(x07), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n54_), .d(new_n25_), .O(new_n62_));
  and2   g38(.a(new_n62_), .b(new_n33_), .O(z5));
  nor2   g39(.a(x02), .b(x01), .O(new_n64_));
  xnor2a g40(.a(x09), .b(x03), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n58_), .c(new_n61_), .d(new_n33_), .O(new_n67_));
  ...
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n61_), .d(new_n33_), .O(z7));
  nand3  g49(.a(new_n33_), .b(new_n46_), .c(x00), .O(new_n74_));
  oai21  g50(.a(new_n72_), .b(x12), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n61_), .O(z8));
endmodule
