...
module FAU ( 
  ...
  nor2   g09(.a(x14), .b(new_n33_), .O(new_n34_));
  inv1   g10(.a(new_n34_), .O(new_n35_));
  oai21  g11(.a(new_n32_), .b(x00), .c(new_n35_), .O(z0));
  nand3  g12(.a(x06), .b(x05), .c(x01), .O(new_n37_));
  aoi21  g13(.a(new_n37_), .b(x14), .c(new_n33_), .O(new_n38_));
  aoi21  g14(.a(x04), .b(x02), .c(x03), .O(new_n39_));
  ...
  nand2  g37(.a(new_n55_), .b(new_n35_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n59_), .c(new_n62_), .O(z4));
  nor3   g39(.a(new_n34_), .b(x07), .c(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n54_), .d(new_n47_), .O(z5));
  ...
  nand3  g44(.a(x02), .b(x01), .c(new_n40_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n60_), .d(new_n44_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n35_), .O(z6));
  nand2  g47(.a(new_n28_), .b(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x08), .O(new_n73_));
  nand3  g49(.a(new_n28_), .b(new_n58_), .c(x03), .O(new_n74_));
  ...
  oai22  g53(.a(new_n77_), .b(new_n72_), .c(x09), .d(new_n40_), .O(new_n78_));
