...
module FAU ( 
  ...
  nand2  g19(.a(new_n43_), .b(x08), .O(new_n44_));
  ...
  nor2   g24(.a(new_n32_), .b(x03), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n46_), .O(new_n50_));
  aoi21  g26(.a(x10), .b(new_n32_), .c(x02), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(new_n45_), .O(z2));
  and2   g28(.a(x11), .b(x07), .O(new_n53_));
  inv1   g29(.a(x12), .O(new_n54_));
  nor2   g30(.a(new_n54_), .b(x00), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n33_), .c(new_n53_), .O(z3));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  nand2  g34(.a(new_n48_), .b(new_n43_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n58_), .c(new_n53_), .O(z4));
  nand3  g37(.a(x13), .b(new_n54_), .c(new_n25_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n43_), .O(new_n63_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n57_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n43_), .c(x07), .O(z6));
  nand4  g46(.a(new_n47_), .b(x03), .c(new_n35_), .d(new_n46_), .O(new_n71_));
  nand3  g47(.a(x03), .b(new_n35_), .c(new_n46_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x08), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n43_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n32_), .O(z7));
  nand2  g51(.a(new_n54_), .b(x09), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n72_), .O(new_n77_));
  oai21  g53(.a(x09), .b(new_n25_), .c(new_n43_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(new_n32_), .O(z8));
endmodule
