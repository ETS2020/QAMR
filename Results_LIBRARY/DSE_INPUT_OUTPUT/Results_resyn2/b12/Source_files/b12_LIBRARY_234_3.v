...
module FAU ( 
  ...
  nand4  g30(.a(new_n54_), .b(new_n53_), .c(new_n29_), .d(x13), .O(z5));
  ...
  nand2  g42(.a(x03), .b(new_n61_), .O(new_n67_));
  nor2   g43(.a(x08), .b(x01), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(new_n67_), .c(new_n41_), .d(new_n29_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n66_), .O(z7));
  inv1   g46(.a(x09), .O(new_n71_));
  nand3  g47(.a(new_n29_), .b(new_n71_), .c(x00), .O(new_n72_));
  nand3  g48(.a(new_n47_), .b(x09), .c(new_n25_), .O(new_n73_));
