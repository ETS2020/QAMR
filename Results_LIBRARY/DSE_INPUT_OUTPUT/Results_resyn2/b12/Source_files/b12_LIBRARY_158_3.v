...
module FAU ( 
  ...
  nor2   g07(.a(x14), .b(new_n25_), .O(new_n32_));
  ...
  nand2  g26(.a(x14), .b(x02), .O(new_n51_));
  ...
  aoi21  g33(.a(x12), .b(new_n55_), .c(new_n57_), .O(z3));
  ...
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n49_), .d(new_n55_), .O(new_n63_));
  and2   g39(.a(new_n63_), .b(new_n51_), .O(z5));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  nand2  g41(.a(new_n25_), .b(new_n43_), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  oai21  g43(.a(new_n50_), .b(new_n55_), .c(new_n45_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n67_), .c(new_n51_), .O(z6));
  oai21  g45(.a(new_n39_), .b(x01), .c(new_n50_), .O(new_n70_));
  oai21  g46(.a(x14), .b(new_n50_), .c(x02), .O(new_n71_));
  nand4  g47(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n45_), .O(z7));
  nand3  g49(.a(new_n51_), .b(new_n44_), .c(x00), .O(new_n74_));
  oai21  g50(.a(new_n72_), .b(x12), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n45_), .O(z8));
endmodule
