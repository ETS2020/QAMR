...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n64_,
  ...
  inv1   g27(.a(new_n35_), .O(new_n52_));
  oai21  g28(.a(x08), .b(x07), .c(x00), .O(new_n53_));
  nand3  g29(.a(x10), .b(new_n47_), .c(new_n29_), .O(new_n54_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n35_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z3));
  oai21  g37(.a(new_n50_), .b(x07), .c(x12), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(x09), .c(x11), .d(x07), .O(z4));
  nor2   g39(.a(x09), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n45_), .c(x13), .d(new_n34_), .O(z5));
  inv1   g41(.a(x09), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x03), .O(new_n67_));
  aoi21  g43(.a(x09), .b(new_n47_), .c(new_n31_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n33_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n50_), .c(new_n45_), .d(new_n35_), .O(new_n70_));
  ...
  and2   g51(.a(new_n75_), .b(new_n45_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(new_n52_), .O(z7));
  nand3  g53(.a(new_n45_), .b(new_n66_), .c(x00), .O(z8));
endmodule
