...
module FAU ( 
  ...
  nand2  g07(.a(x13), .b(x10), .O(new_n32_));
  ...
  nand2  g33(.a(new_n52_), .b(new_n32_), .O(new_n58_));
  aoi21  g34(.a(new_n57_), .b(new_n56_), .c(new_n58_), .O(z4));
  nor3   g35(.a(x12), .b(x07), .c(x00), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x10), .c(x13), .O(z5));
  nor2   g37(.a(x02), .b(x01), .O(new_n62_));
  xnor2a g38(.a(x09), .b(x03), .O(new_n63_));
  nand4  g39(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n55_), .c(new_n44_), .O(new_n65_));
  ...
  nand2  g46(.a(new_n67_), .b(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n44_), .O(z7));
  inv1   g48(.a(x13), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x10), .O(new_n74_));
  nand4  g50(.a(new_n51_), .b(x03), .c(new_n34_), .d(new_n42_), .O(new_n75_));
