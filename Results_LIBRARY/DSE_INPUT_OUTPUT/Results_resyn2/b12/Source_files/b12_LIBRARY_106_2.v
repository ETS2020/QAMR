...
module FAU ( 
  ...
  nand3  g34(.a(x13), .b(new_n58_), .c(new_n38_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n57_), .c(new_n46_), .O(z5));
  nand2  g37(.a(x09), .b(x03), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n32_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n62_), .c(x02), .O(new_n65_));
  nand2  g41(.a(x08), .b(x00), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n42_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n47_), .O(z6));
  nand2  g45(.a(new_n62_), .b(new_n45_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n41_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(x03), .b(new_n41_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n42_), .O(z7));
  nand2  g51(.a(new_n63_), .b(x00), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n46_), .O(new_n77_));
  nand3  g53(.a(new_n58_), .b(x09), .c(new_n45_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n73_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n42_), .O(z8));
endmodule
