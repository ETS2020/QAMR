...
module FAU ( 
  ...
  oai21  g30(.a(new_n54_), .b(new_n49_), .c(new_n34_), .O(z4));
  nor2   g31(.a(x12), .b(x10), .O(new_n56_));
  nor2   g32(.a(x07), .b(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n34_), .d(x13), .O(z5));
  xor2a  g34(.a(x09), .b(x03), .O(new_n59_));
  nor2   g35(.a(new_n59_), .b(new_n28_), .O(new_n60_));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n30_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n39_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n60_), .c(new_n34_), .O(z6));
  inv1   g40(.a(new_n34_), .O(new_n65_));
  nor2   g41(.a(x02), .b(x01), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(x09), .c(x03), .O(new_n67_));
  inv1   g43(.a(new_n39_), .O(new_n68_));
  aoi21  g44(.a(new_n66_), .b(x03), .c(x08), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(new_n65_), .O(z7));
  inv1   g47(.a(x09), .O(new_n72_));
  nand3  g48(.a(new_n34_), .b(new_n72_), .c(x00), .O(new_n73_));
  oai21  g49(.a(new_n67_), .b(x12), .c(new_n73_), .O(new_n74_));
