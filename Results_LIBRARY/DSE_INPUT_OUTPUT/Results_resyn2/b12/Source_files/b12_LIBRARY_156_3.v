...
module FAU ( 
  ...
  oai21  g35(.a(new_n59_), .b(new_n57_), .c(new_n36_), .O(z3));
  nand4  g36(.a(x09), .b(x08), .c(new_n48_), .d(x00), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n57_), .c(new_n36_), .O(z4));
  ...
  nand3  g45(.a(new_n69_), .b(new_n52_), .c(new_n36_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(z6));
  nand3  g47(.a(new_n68_), .b(x09), .c(x03), .O(new_n72_));
  oai21  g48(.a(new_n40_), .b(x01), .c(new_n49_), .O(new_n73_));
  oai21  g49(.a(x14), .b(new_n49_), .c(x02), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n52_), .O(z7));
  oai22  g51(.a(new_n72_), .b(x12), .c(new_n37_), .d(x09), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n52_), .O(z8));
endmodule
