...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n57_, new_n59_, new_n61_, new_n62_, new_n65_, new_n66_;
  ...
  and2   g36(.a(x14), .b(x01), .O(new_n61_));
  nand3  g37(.a(new_n59_), .b(new_n53_), .c(new_n48_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n29_), .c(new_n62_), .O(z6));
  aoi21  g39(.a(new_n59_), .b(x08), .c(new_n35_), .O(z7));
  inv1   g40(.a(x00), .O(new_n65_));
  nor2   g41(.a(x09), .b(new_n65_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n59_), .c(new_n35_), .O(z8));
endmodule
