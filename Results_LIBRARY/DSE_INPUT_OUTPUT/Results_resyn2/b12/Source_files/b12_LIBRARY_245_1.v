...
module FAU ( 
  ...
  nand2  g27(.a(new_n51_), .b(new_n38_), .O(new_n52_));
  ...
  inv1   g45(.a(new_n59_), .O(new_n70_));
  nand3  g46(.a(new_n35_), .b(x14), .c(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n68_), .c(new_n33_), .O(z6));
  nand3  g49(.a(new_n66_), .b(x09), .c(x03), .O(new_n74_));
  inv1   g50(.a(new_n69_), .O(new_n75_));
  nand2  g51(.a(new_n66_), .b(x03), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n58_), .c(new_n75_), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n74_), .c(x14), .d(new_n32_), .O(z7));
  oai22  g54(.a(new_n74_), .b(x12), .c(x09), .d(new_n25_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n69_), .c(new_n33_), .O(z8));
endmodule
