...
module FAU ( 
  ...
  nand2  g22(.a(x12), .b(new_n35_), .O(new_n47_));
  nand2  g23(.a(x11), .b(x07), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(new_n47_), .c(new_n40_), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(z3));
  nand2  g26(.a(new_n48_), .b(new_n40_), .O(new_n51_));
  ...
  aoi21  g31(.a(new_n55_), .b(new_n53_), .c(new_n51_), .O(z4));
  ...
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n52_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n62_), .O(z6));
  aoi21  g42(.a(new_n64_), .b(x08), .c(new_n39_), .O(z7));
  nand4  g43(.a(new_n64_), .b(new_n40_), .c(new_n54_), .d(x00), .O(z8));
endmodule
