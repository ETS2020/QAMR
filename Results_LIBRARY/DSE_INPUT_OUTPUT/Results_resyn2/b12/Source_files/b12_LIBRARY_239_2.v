...
module FAU ( 
  ...
  aoi21  g21(.a(new_n45_), .b(new_n32_), .c(x01), .O(new_n46_));
  ...
  oai21  g31(.a(new_n55_), .b(x07), .c(new_n52_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(x09), .O(z4));
  nand4  g33(.a(new_n44_), .b(x13), .c(new_n51_), .d(new_n25_), .O(z5));
  inv1   g34(.a(x01), .O(new_n59_));
  nand2  g35(.a(new_n35_), .b(new_n59_), .O(new_n60_));
  ...
  nand3  g39(.a(new_n63_), .b(new_n55_), .c(new_n44_), .O(new_n64_));
  nor2   g40(.a(new_n64_), .b(new_n62_), .O(z6));
  inv1   g41(.a(x07), .O(new_n66_));
  nand3  g42(.a(x03), .b(new_n35_), .c(new_n59_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x09), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  aoi21  g46(.a(new_n67_), .b(new_n70_), .c(x10), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x07), .c(new_n69_), .O(z7));
  nor2   g48(.a(x09), .b(x00), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x10), .c(new_n66_), .O(new_n74_));
  nand3  g50(.a(new_n51_), .b(new_n66_), .c(x03), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n60_), .c(x09), .O(new_n76_));
