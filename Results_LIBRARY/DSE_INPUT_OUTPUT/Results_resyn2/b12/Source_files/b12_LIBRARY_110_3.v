...
module FAU ( 
  ...
  nand3  g30(.a(x13), .b(new_n47_), .c(new_n40_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n54_), .c(new_n53_), .O(z5));
  xnor2a g33(.a(x09), .b(x03), .O(new_n58_));
  nor2   g34(.a(x02), .b(x01), .O(new_n59_));
  nand2  g35(.a(x08), .b(x00), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n36_), .c(new_n29_), .O(new_n61_));
  aoi21  g37(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(z6));
  nand3  g38(.a(new_n59_), .b(x09), .c(x03), .O(new_n63_));
  inv1   g39(.a(x08), .O(new_n64_));
  oai21  g40(.a(new_n38_), .b(x02), .c(new_n64_), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x02), .c(x01), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n63_), .d(new_n36_), .O(z7));
  inv1   g43(.a(x09), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n59_), .b(new_n47_), .c(x09), .d(x03), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n36_), .c(new_n53_), .O(z8));
endmodule
