...
module FAU ( 
  ...
  or2    g02(.a(new_n26_), .b(x12), .O(new_n27_));
  ...
  nand2  g14(.a(x12), .b(new_n25_), .O(new_n39_));
  ...
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n39_), .O(z3));
  nand4  g33(.a(x09), .b(x08), .c(new_n46_), .d(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n54_), .c(new_n39_), .O(z4));
  nand4  g36(.a(new_n44_), .b(x13), .c(new_n55_), .d(new_n28_), .O(z5));
  xnor2a g37(.a(x09), .b(x03), .O(new_n62_));
  nand2  g38(.a(x08), .b(x00), .O(new_n63_));
  nand4  g39(.a(x14), .b(x02), .c(x01), .d(new_n28_), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n44_), .d(new_n39_), .O(new_n65_));
  aoi21  g41(.a(new_n62_), .b(new_n37_), .c(new_n65_), .O(z6));
  inv1   g42(.a(new_n39_), .O(new_n67_));
  nand3  g43(.a(new_n37_), .b(x09), .c(x03), .O(new_n68_));
  inv1   g44(.a(new_n44_), .O(new_n69_));
  aoi21  g45(.a(new_n37_), .b(x03), .c(x08), .O(new_n70_));
  nor2   g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n68_), .c(new_n67_), .O(z7));
  inv1   g48(.a(x09), .O(new_n73_));
  nand3  g49(.a(new_n39_), .b(new_n73_), .c(x00), .O(new_n74_));
  oai21  g50(.a(new_n68_), .b(x12), .c(new_n74_), .O(new_n75_));
