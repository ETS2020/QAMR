...
module FAU ( 
  ...
  nand2  g27(.a(new_n49_), .b(new_n31_), .O(new_n52_));
  ...
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n57_), .d(new_n44_), .O(new_n59_));
  and2   g35(.a(new_n59_), .b(new_n31_), .O(z5));
  nand2  g36(.a(x09), .b(x03), .O(new_n61_));
  nand2  g37(.a(new_n43_), .b(new_n34_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(x02), .O(new_n63_));
  nor2   g39(.a(x10), .b(x07), .O(new_n64_));
  nand4  g40(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n53_), .c(new_n64_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(new_n31_), .O(z6));
  inv1   g43(.a(x01), .O(new_n68_));
  nand2  g44(.a(new_n61_), .b(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n30_), .O(new_n70_));
  oai21  g46(.a(new_n34_), .b(x02), .c(new_n40_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z7));
  nand3  g48(.a(new_n57_), .b(new_n44_), .c(new_n39_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n61_), .c(new_n68_), .O(new_n74_));
  nand3  g50(.a(new_n64_), .b(new_n43_), .c(x00), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  aoi21  g52(.a(new_n74_), .b(new_n30_), .c(new_n76_), .O(z8));
endmodule
