...
module FAU ( 
  ...
  nand2  g30(.a(new_n49_), .b(new_n32_), .O(new_n55_));
  ...
  nand3  g39(.a(new_n63_), .b(new_n52_), .c(new_n43_), .O(new_n64_));
  ...
  aoi21  g47(.a(new_n31_), .b(x01), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n48_), .b(x09), .c(new_n41_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(new_n68_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n72_), .c(new_n43_), .O(z8));
endmodule
