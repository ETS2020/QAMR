...
module FAU ( 
  ...
  nand2  g51(.a(new_n75_), .b(new_n65_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n30_), .O(new_n77_));
  oai21  g53(.a(new_n34_), .b(x02), .c(new_n48_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n39_), .O(z7));
  nand3  g55(.a(new_n52_), .b(new_n45_), .c(new_n70_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n75_), .c(new_n65_), .O(new_n81_));
  nand3  g57(.a(new_n39_), .b(new_n58_), .c(x00), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n30_), .c(new_n83_), .O(z8));
endmodule
