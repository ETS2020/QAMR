...
module FAU ( 
  ...
  nand3  g26(.a(new_n50_), .b(new_n49_), .c(new_n26_), .O(new_n51_));
  oai21  g27(.a(x08), .b(x07), .c(x00), .O(new_n52_));
  nand3  g28(.a(x10), .b(new_n47_), .c(new_n26_), .O(new_n53_));
  ...
  and2   g44(.a(new_n68_), .b(new_n35_), .O(z5));
  xor2a  g45(.a(x09), .b(x03), .O(new_n70_));
  nor2   g46(.a(new_n70_), .b(new_n28_), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n33_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n50_), .c(new_n45_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(new_n71_), .O(z6));
  nand4  g50(.a(x09), .b(x03), .c(new_n27_), .d(new_n26_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n27_), .c(new_n26_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n75_), .c(new_n45_), .O(z7));
  oai22  g55(.a(new_n75_), .b(x12), .c(x09), .d(new_n33_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n45_), .O(z8));
endmodule
