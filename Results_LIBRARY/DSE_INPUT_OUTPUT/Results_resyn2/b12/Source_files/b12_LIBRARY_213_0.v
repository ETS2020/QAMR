...
module FAU ( 
  ...
  nor2   g24(.a(new_n30_), .b(x02), .O(new_n49_));
  inv1   g25(.a(x00), .O(new_n50_));
  nor2   g26(.a(x08), .b(x07), .O(new_n51_));
  nor2   g27(.a(x05), .b(x02), .O(new_n52_));
  ...
  nand2  g31(.a(x12), .b(new_n50_), .O(new_n56_));
  nand2  g32(.a(x11), .b(x07), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  ...
  nor2   g39(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n61_), .c(new_n62_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n66_), .c(new_n45_), .O(new_n67_));
  nor3   g43(.a(new_n67_), .b(x07), .c(x00), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n52_), .O(z5));
  nand2  g45(.a(new_n60_), .b(x03), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n36_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n41_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x05), .O(new_n73_));
  inv1   g49(.a(new_n64_), .O(new_n74_));
  nand4  g50(.a(x14), .b(x02), .c(x01), .d(new_n50_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n42_), .O(new_n76_));
  aoi21  g52(.a(new_n73_), .b(new_n25_), .c(new_n76_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n41_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x05), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n41_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n63_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n42_), .O(z7));
  nand2  g59(.a(new_n60_), .b(x00), .O(new_n84_));
  nand3  g60(.a(new_n66_), .b(x09), .c(x05), .O(new_n85_));
  oai22  g61(.a(new_n85_), .b(new_n81_), .c(new_n84_), .d(new_n52_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n42_), .O(z8));
endmodule
