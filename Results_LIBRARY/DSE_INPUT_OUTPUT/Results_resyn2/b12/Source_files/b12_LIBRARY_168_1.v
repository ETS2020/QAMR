...
module FAU ( 
  ...
  nor2   g14(.a(x08), .b(x07), .O(new_n39_));
  nand2  g15(.a(new_n34_), .b(x00), .O(new_n40_));
  ...
  oai21  g23(.a(new_n47_), .b(new_n43_), .c(new_n33_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n26_), .c(new_n41_), .O(z2));
  ...
  nand4  g30(.a(x09), .b(x08), .c(new_n44_), .d(x00), .O(new_n55_));
  ...
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n33_), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n28_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n61_), .d(new_n42_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n34_), .O(z6));
  nand3  g44(.a(new_n42_), .b(new_n62_), .c(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n26_), .O(new_n70_));
  nor2   g46(.a(new_n27_), .b(x01), .O(new_n71_));
  nand2  g47(.a(new_n42_), .b(x08), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  aoi21  g49(.a(new_n70_), .b(new_n33_), .c(new_n73_), .O(z7));
  nand3  g50(.a(new_n34_), .b(new_n62_), .c(x00), .O(new_n75_));
  nand4  g51(.a(new_n71_), .b(new_n50_), .c(x09), .d(new_n26_), .O(new_n76_));
