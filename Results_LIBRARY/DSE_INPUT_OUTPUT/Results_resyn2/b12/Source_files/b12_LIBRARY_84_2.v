...
module FAU ( 
  ...
  nand3  g29(.a(new_n53_), .b(new_n50_), .c(new_n43_), .O(new_n54_));
  inv1   g30(.a(new_n33_), .O(new_n55_));
  oai21  g31(.a(x08), .b(x07), .c(x00), .O(new_n56_));
  nand3  g32(.a(x10), .b(new_n48_), .c(new_n43_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n35_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n54_), .O(z2));
  inv1   g36(.a(x11), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(new_n45_), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n33_), .c(x12), .d(new_n25_), .O(z3));
  nor2   g39(.a(new_n44_), .b(x07), .O(new_n64_));
  oai21  g40(.a(new_n61_), .b(new_n45_), .c(new_n33_), .O(new_n65_));
  aoi21  g41(.a(new_n64_), .b(new_n52_), .c(new_n65_), .O(z4));
  inv1   g42(.a(new_n47_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n32_), .d(new_n25_), .O(z5));
  nand2  g44(.a(x09), .b(new_n48_), .O(new_n69_));
  nand2  g45(.a(new_n44_), .b(x03), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n35_), .d(new_n43_), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n53_), .d(new_n67_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n33_), .O(z6));
  nand4  g50(.a(x09), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n51_), .c(new_n47_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n75_), .c(new_n55_), .O(z7));
  oai22  g54(.a(new_n75_), .b(x12), .c(x09), .d(new_n25_), .O(new_n79_));
