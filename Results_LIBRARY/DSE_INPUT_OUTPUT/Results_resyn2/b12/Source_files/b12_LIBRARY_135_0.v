...
module FAU ( 
  ...
  nand4  g33(.a(x14), .b(x02), .c(x01), .d(new_n36_), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(new_n45_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z6));
  nor3   g36(.a(new_n37_), .b(x10), .c(x07), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x08), .O(z7));
  nor2   g38(.a(x09), .b(new_n36_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n61_), .O(z8));
endmodule
