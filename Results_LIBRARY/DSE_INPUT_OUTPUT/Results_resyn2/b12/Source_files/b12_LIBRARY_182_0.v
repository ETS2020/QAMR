...
module FAU ( 
  ...
  nand3  g51(.a(x03), .b(new_n35_), .c(new_n44_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x08), .O(new_n77_));
  nand3  g53(.a(new_n66_), .b(new_n46_), .c(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n72_), .c(new_n32_), .O(z7));
  oai21  g56(.a(new_n76_), .b(x12), .c(x09), .O(new_n81_));
  inv1   g57(.a(new_n72_), .O(new_n82_));
  aoi21  g58(.a(new_n46_), .b(new_n25_), .c(new_n82_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n81_), .c(new_n32_), .O(z8));
endmodule
