...
module FAU ( 
  ...
  nand4  g16(.a(new_n40_), .b(new_n37_), .c(x07), .d(x02), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(new_n36_), .c(x00), .O(z1));
  nand2  g18(.a(x03), .b(new_n35_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n25_), .c(new_n32_), .O(new_n44_));
  ...
  aoi21  g26(.a(new_n50_), .b(new_n35_), .c(new_n44_), .O(z2));
  inv1   g27(.a(x12), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(x00), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(new_n33_), .c(x11), .d(x07), .O(z3));
  inv1   g30(.a(new_n48_), .O(new_n55_));
  nor2   g31(.a(new_n45_), .b(x07), .O(new_n56_));
  nand2  g32(.a(x11), .b(x07), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n33_), .O(new_n58_));
  aoi21  g34(.a(new_n56_), .b(new_n55_), .c(new_n58_), .O(z4));
  nand4  g35(.a(x13), .b(new_n52_), .c(new_n46_), .d(new_n25_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n35_), .O(new_n61_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n48_), .c(new_n46_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n35_), .c(x07), .O(z6));
  oai21  g44(.a(new_n38_), .b(x01), .c(x08), .O(new_n69_));
  nand3  g45(.a(new_n45_), .b(x03), .c(new_n63_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n69_), .c(x10), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x02), .c(new_n32_), .O(z7));
  nand3  g48(.a(new_n52_), .b(x03), .c(new_n63_), .O(new_n73_));
  oai21  g49(.a(x09), .b(x00), .c(new_n46_), .O(new_n74_));
  aoi21  g50(.a(new_n73_), .b(x09), .c(new_n74_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x02), .c(new_n32_), .O(z8));
endmodule
