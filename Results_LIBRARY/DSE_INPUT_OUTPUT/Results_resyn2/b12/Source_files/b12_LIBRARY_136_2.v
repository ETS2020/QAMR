...
module FAU ( 
  ...
  nor2   g10(.a(x13), .b(new_n28_), .O(new_n35_));
  ...
  oai21  g25(.a(new_n49_), .b(new_n45_), .c(new_n27_), .O(new_n50_));
  oai21  g26(.a(x08), .b(x07), .c(x00), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n36_), .O(new_n52_));
  aoi21  g28(.a(new_n50_), .b(new_n28_), .c(new_n52_), .O(z2));
  ...
  nand3  g39(.a(x13), .b(new_n54_), .c(new_n47_), .O(new_n64_));
  nor3   g40(.a(new_n64_), .b(x07), .c(x00), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(new_n35_), .O(z5));
  nand2  g42(.a(x09), .b(new_n32_), .O(new_n67_));
  nand2  g43(.a(new_n58_), .b(x03), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n30_), .O(new_n69_));
  nand3  g45(.a(new_n29_), .b(x14), .c(new_n38_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n60_), .d(new_n44_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n36_), .O(z6));
  nand2  g48(.a(new_n30_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x08), .O(new_n74_));
  nand3  g50(.a(new_n30_), .b(new_n58_), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n44_), .c(new_n35_), .O(z7));
  nand2  g53(.a(new_n54_), .b(x09), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(new_n73_), .c(x09), .d(new_n38_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n44_), .c(new_n35_), .O(z8));
endmodule
