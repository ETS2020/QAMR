...
module FAU ( 
  ...
  oai22  g33(.a(new_n57_), .b(x00), .c(new_n56_), .d(new_n48_), .O(new_n58_));
  ...
  oai21  g38(.a(new_n56_), .b(new_n48_), .c(new_n32_), .O(new_n63_));
  ...
  aoi21  g42(.a(new_n66_), .b(new_n46_), .c(new_n42_), .O(z5));
  ...
  nand3  g48(.a(new_n40_), .b(x14), .c(new_n25_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n68_), .d(new_n46_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n32_), .O(z6));
  nand2  g51(.a(new_n69_), .b(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x08), .O(new_n77_));
  nand3  g53(.a(new_n69_), .b(new_n60_), .c(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n46_), .c(new_n42_), .O(z7));
  oai21  g56(.a(new_n76_), .b(x12), .c(x09), .O(new_n81_));
  nand2  g57(.a(new_n60_), .b(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n46_), .O(z8));
endmodule
