...
module FAU ( 
  ...
  nand2  g08(.a(x13), .b(x06), .O(new_n33_));
  ...
  aoi21  g30(.a(new_n52_), .b(new_n43_), .c(new_n54_), .O(z2));
  nand2  g31(.a(x11), .b(x07), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n33_), .O(new_n57_));
  aoi21  g33(.a(x12), .b(new_n40_), .c(new_n57_), .O(z3));
  ...
  aoi21  g43(.a(new_n45_), .b(x03), .c(new_n29_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n40_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n59_), .c(new_n46_), .d(new_n33_), .O(new_n70_));
  ...
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n50_), .O(new_n76_));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n46_), .c(new_n72_), .O(z8));
endmodule
