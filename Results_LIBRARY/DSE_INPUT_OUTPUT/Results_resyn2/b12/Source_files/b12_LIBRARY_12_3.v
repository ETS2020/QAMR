...
module FAU ( 
  ...
  nand4  g31(.a(new_n55_), .b(x13), .c(new_n43_), .d(new_n28_), .O(new_n56_));
  and2   g32(.a(new_n56_), .b(new_n25_), .O(z5));
  xor2a  g33(.a(x09), .b(x03), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(new_n34_), .O(new_n59_));
  oai21  g35(.a(new_n44_), .b(new_n28_), .c(new_n39_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n59_), .c(new_n25_), .O(z6));
  nand2  g37(.a(new_n33_), .b(x03), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n44_), .O(new_n63_));
  nand3  g39(.a(new_n33_), .b(x09), .c(x03), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n39_), .d(new_n25_), .O(z7));
  inv1   g41(.a(new_n25_), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n69_), .b(new_n39_), .c(new_n66_), .O(z8));
endmodule
