...
module FAU ( 
  ...
  aoi21  g24(.a(x12), .b(new_n30_), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g41(.a(new_n58_), .b(x09), .c(x03), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n47_), .d(new_n38_), .O(z7));
  inv1   g43(.a(new_n47_), .O(new_n68_));
  inv1   g44(.a(x09), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x00), .O(new_n70_));
  inv1   g46(.a(x12), .O(new_n71_));
  nand4  g47(.a(new_n58_), .b(new_n71_), .c(x09), .d(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n38_), .c(new_n68_), .O(z8));
endmodule
