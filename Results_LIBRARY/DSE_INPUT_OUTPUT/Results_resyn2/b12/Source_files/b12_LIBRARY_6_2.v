...
module FAU ( 
  ...
  nor2   g07(.a(x02), .b(new_n31_), .O(new_n32_));
  inv1   g08(.a(new_n32_), .O(new_n33_));
  nand3  g09(.a(x06), .b(x05), .c(x01), .O(new_n34_));
  inv1   g10(.a(x03), .O(new_n35_));
  aoi21  g11(.a(new_n28_), .b(new_n35_), .c(new_n26_), .O(new_n36_));
  nand2  g12(.a(new_n36_), .b(new_n34_), .O(new_n37_));
  nand2  g13(.a(new_n37_), .b(new_n33_), .O(z1));
  ...
  oai21  g21(.a(new_n45_), .b(x03), .c(new_n44_), .O(new_n46_));
  oai21  g22(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n33_), .O(z2));
  nand2  g24(.a(x12), .b(new_n25_), .O(new_n49_));
  and2   g25(.a(x11), .b(x07), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n32_), .O(new_n51_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n50_), .c(new_n33_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n33_), .d(x13), .O(z5));
  ...
  nand2  g43(.a(new_n60_), .b(new_n31_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n44_), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  nand2  g46(.a(x03), .b(new_n44_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n45_), .O(z7));
  nand2  g49(.a(new_n61_), .b(x00), .O(new_n74_));
  nor2   g50(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  inv1   g51(.a(x12), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x09), .c(new_n31_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n71_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n45_), .O(z8));
endmodule
