...
module FAU ( 
  ...
  aoi21  g21(.a(new_n34_), .b(new_n45_), .c(x03), .O(new_n46_));
  nand3  g22(.a(new_n34_), .b(x09), .c(new_n45_), .O(new_n47_));
  ...
  aoi21  g27(.a(new_n49_), .b(new_n26_), .c(new_n51_), .O(z2));
  ...
  nand4  g38(.a(x13), .b(new_n53_), .c(new_n45_), .d(new_n42_), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x14), .c(new_n34_), .O(z5));
  nand2  g41(.a(x09), .b(new_n28_), .O(new_n66_));
  nand2  g42(.a(new_n57_), .b(x03), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n26_), .d(new_n25_), .O(new_n68_));
  nor3   g44(.a(x14), .b(x10), .c(x07), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n59_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(z6));
  nand3  g47(.a(x03), .b(new_n26_), .c(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x08), .O(new_n73_));
  oai21  g49(.a(new_n67_), .b(new_n27_), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n69_), .O(z7));
  oai21  g51(.a(new_n72_), .b(x12), .c(x09), .O(new_n76_));
  nand2  g52(.a(new_n57_), .b(new_n42_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n69_), .O(z8));
endmodule
