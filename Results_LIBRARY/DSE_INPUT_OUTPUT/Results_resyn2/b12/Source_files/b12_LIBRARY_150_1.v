...
module FAU ( 
  ...
  nor2   g10(.a(new_n34_), .b(x06), .O(new_n35_));
  inv1   g11(.a(new_n35_), .O(new_n36_));
  oai21  g12(.a(new_n33_), .b(x00), .c(new_n36_), .O(z0));
  inv1   g13(.a(x00), .O(new_n38_));
  nand3  g14(.a(new_n36_), .b(new_n30_), .c(new_n38_), .O(new_n39_));
  and2   g15(.a(x04), .b(x02), .O(new_n40_));
  nand2  g16(.a(x06), .b(x05), .O(new_n41_));
  oai22  g17(.a(new_n41_), .b(new_n26_), .c(new_n40_), .d(x03), .O(new_n42_));
  ...
  nand2  g29(.a(x12), .b(new_n38_), .O(new_n54_));
  ...
  nor2   g37(.a(new_n61_), .b(new_n38_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n59_), .c(new_n60_), .O(z4));
  nor2   g39(.a(x12), .b(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n44_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x06), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x13), .O(z5));
  xor2a  g43(.a(x09), .b(x03), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n38_), .O(new_n69_));
  oai21  g45(.a(new_n68_), .b(new_n30_), .c(new_n69_), .O(new_n70_));
  nor2   g46(.a(new_n68_), .b(new_n30_), .O(new_n71_));
  inv1   g47(.a(new_n69_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  inv1   g49(.a(new_n62_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n44_), .c(new_n36_), .O(new_n75_));
  aoi21  g51(.a(new_n73_), .b(new_n70_), .c(new_n75_), .O(z6));
  nor2   g52(.a(x02), .b(x01), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x09), .c(x03), .O(new_n78_));
  inv1   g54(.a(new_n44_), .O(new_n79_));
  nand2  g55(.a(new_n77_), .b(x03), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n61_), .c(new_n79_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n78_), .c(new_n35_), .O(z7));
  oai21  g58(.a(new_n80_), .b(x12), .c(x09), .O(new_n83_));
  aoi21  g59(.a(new_n58_), .b(new_n38_), .c(new_n79_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(new_n35_), .O(z8));
endmodule
