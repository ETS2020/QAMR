...
module FAU ( 
  ...
  nor2   g27(.a(x14), .b(x02), .O(new_n52_));
  ...
  inv1   g35(.a(new_n52_), .O(new_n60_));
  nand4  g36(.a(x09), .b(x08), .c(new_n43_), .d(x00), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n56_), .c(new_n60_), .O(z4));
  nand3  g39(.a(x13), .b(new_n55_), .c(new_n44_), .O(new_n64_));
  nor3   g40(.a(new_n64_), .b(x07), .c(x00), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(new_n52_), .O(z5));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  xnor2a g43(.a(x09), .b(x03), .O(new_n68_));
  nand2  g44(.a(new_n48_), .b(new_n50_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n25_), .d(new_n31_), .O(new_n70_));
  nand3  g46(.a(new_n32_), .b(x14), .c(new_n50_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n67_), .d(new_n41_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n60_), .O(z6));
  nand2  g49(.a(x09), .b(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x01), .c(x14), .O(new_n75_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n76_), .c(new_n41_), .O(z7));
  inv1   g56(.a(x09), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x00), .O(new_n82_));
  nand3  g58(.a(x14), .b(new_n55_), .c(x09), .O(new_n83_));
  oai22  g59(.a(new_n83_), .b(new_n78_), .c(new_n82_), .d(new_n52_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n41_), .O(z8));
endmodule
