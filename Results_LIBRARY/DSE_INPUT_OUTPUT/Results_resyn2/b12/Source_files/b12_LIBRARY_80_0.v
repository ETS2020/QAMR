...
module FAU ( 
  ...
  nand3  g36(.a(new_n60_), .b(new_n50_), .c(new_n34_), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(new_n59_), .O(z6));
  aoi22  g38(.a(new_n60_), .b(x08), .c(new_n33_), .d(new_n32_), .O(z7));
  nand4  g39(.a(new_n60_), .b(new_n34_), .c(new_n52_), .d(x00), .O(z8));
endmodule
