...
module FAU ( 
  ...
  nand2  g08(.a(x13), .b(new_n32_), .O(new_n33_));
  ...
  oai22  g13(.a(new_n37_), .b(x02), .c(x04), .d(x03), .O(new_n38_));
  aoi21  g14(.a(x13), .b(new_n32_), .c(x00), .O(new_n39_));
  nand2  g15(.a(x06), .b(x05), .O(new_n40_));
  oai21  g16(.a(new_n40_), .b(new_n27_), .c(new_n39_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n38_), .O(z1));
  inv1   g18(.a(x13), .O(new_n43_));
  nand2  g19(.a(new_n43_), .b(x08), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n32_), .c(new_n25_), .O(new_n45_));
  inv1   g21(.a(x10), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(x09), .c(new_n35_), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n39_), .b(x12), .c(new_n54_), .O(z3));
  nand3  g31(.a(x09), .b(new_n32_), .c(x00), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(new_n54_), .O(z4));
  nor2   g34(.a(x02), .b(x01), .O(new_n60_));
  nand2  g35(.a(x09), .b(new_n36_), .O(new_n61_));
  inv1   g36(.a(x09), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x03), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(new_n64_));
  nand4  g39(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n65_));
  aoi21  g40(.a(x08), .b(x00), .c(x10), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n43_), .c(x07), .O(z6));
  nand3  g43(.a(new_n60_), .b(x09), .c(x03), .O(new_n69_));
  inv1   g44(.a(x08), .O(new_n70_));
  nand2  g45(.a(new_n60_), .b(x03), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nor2   g47(.a(new_n50_), .b(x13), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n72_), .c(new_n69_), .O(z7));
  inv1   g49(.a(x12), .O(new_n75_));
  nand3  g50(.a(new_n60_), .b(new_n75_), .c(x03), .O(new_n76_));
  oai21  g51(.a(x09), .b(x00), .c(new_n46_), .O(new_n77_));
  aoi21  g52(.a(new_n76_), .b(x09), .c(new_n77_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(x13), .c(new_n32_), .O(z8));
  one    g54(.O(z5));
endmodule
