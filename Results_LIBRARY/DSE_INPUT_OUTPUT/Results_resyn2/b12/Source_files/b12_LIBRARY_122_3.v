...
module FAU ( 
  ...
  aoi21  g26(.a(x12), .b(new_n28_), .c(new_n50_), .O(z3));
  ...
  aoi21  g31(.a(new_n55_), .b(new_n53_), .c(new_n50_), .O(z4));
  inv1   g32(.a(x12), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n57_), .d(new_n42_), .O(new_n59_));
  and2   g35(.a(new_n59_), .b(new_n25_), .O(z5));
  nand2  g36(.a(x09), .b(new_n35_), .O(new_n61_));
  nand2  g37(.a(new_n54_), .b(x03), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n33_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n52_), .c(new_n39_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n25_), .O(z6));
  nand3  g41(.a(new_n42_), .b(x08), .c(new_n41_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n45_), .c(new_n31_), .O(new_n67_));
  oai21  g43(.a(new_n35_), .b(x01), .c(x08), .O(new_n68_));
  nand3  g44(.a(new_n33_), .b(new_n54_), .c(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n39_), .c(new_n67_), .O(z7));
  nand3  g47(.a(new_n25_), .b(new_n54_), .c(x00), .O(new_n72_));
  nand3  g48(.a(new_n57_), .b(x09), .c(new_n45_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n32_), .c(new_n72_), .O(new_n74_));
