...
module FAU ( 
  ...
  nand2  g08(.a(x10), .b(new_n32_), .O(new_n33_));
  ...
  nor2   g22(.a(x07), .b(x02), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(x10), .c(new_n32_), .O(new_n48_));
  oai21  g24(.a(x08), .b(x07), .c(x00), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  aoi21  g26(.a(new_n46_), .b(new_n35_), .c(new_n50_), .O(z2));
  ...
  aoi22  g34(.a(new_n58_), .b(new_n57_), .c(new_n52_), .d(new_n33_), .O(z4));
  nand4  g35(.a(new_n45_), .b(x13), .c(new_n53_), .d(new_n25_), .O(z5));
  nor2   g36(.a(x02), .b(x01), .O(new_n61_));
  xnor2a g37(.a(x09), .b(x03), .O(new_n62_));
  nand4  g38(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n56_), .c(new_n45_), .O(new_n64_));
  aoi21  g40(.a(new_n62_), .b(new_n61_), .c(new_n64_), .O(z6));
  inv1   g41(.a(x08), .O(new_n66_));
  nand3  g42(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g44(.a(x09), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n45_), .O(z7));
  oai22  g46(.a(new_n69_), .b(x12), .c(x09), .d(new_n25_), .O(new_n71_));
