...
module FAU ( 
  ...
  nor2   g08(.a(new_n32_), .b(new_n28_), .O(new_n33_));
  ...
  nand4  g47(.a(new_n71_), .b(new_n57_), .c(new_n70_), .d(new_n34_), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n69_), .O(z6));
  nand3  g49(.a(x03), .b(new_n36_), .c(new_n45_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x08), .O(new_n75_));
  nand3  g51(.a(new_n64_), .b(new_n47_), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n70_), .c(new_n33_), .O(z7));
  oai21  g54(.a(new_n74_), .b(x12), .c(x09), .O(new_n79_));
  inv1   g55(.a(new_n70_), .O(new_n80_));
  aoi21  g56(.a(new_n47_), .b(new_n25_), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n79_), .c(new_n33_), .O(z8));
endmodule
