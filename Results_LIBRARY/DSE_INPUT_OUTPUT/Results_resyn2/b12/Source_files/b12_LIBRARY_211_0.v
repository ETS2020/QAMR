...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(x08), .O(new_n26_));
  ...
  nand3  g12(.a(new_n36_), .b(new_n34_), .c(x03), .O(new_n37_));
  ...
  oai21  g17(.a(new_n39_), .b(new_n30_), .c(new_n31_), .O(new_n42_));
  nand3  g18(.a(new_n32_), .b(x06), .c(x05), .O(new_n43_));
  ...
  oai21  g27(.a(new_n51_), .b(new_n47_), .c(new_n30_), .O(new_n52_));
  oai21  g28(.a(x08), .b(x07), .c(x00), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  aoi21  g30(.a(new_n52_), .b(new_n31_), .c(new_n54_), .O(z2));
  ...
  nand3  g40(.a(x13), .b(new_n57_), .c(new_n49_), .O(new_n65_));
  nor3   g41(.a(new_n65_), .b(x07), .c(x00), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(new_n26_), .O(z5));
  nand2  g43(.a(new_n60_), .b(x03), .O(new_n68_));
  aoi21  g44(.a(x09), .b(new_n39_), .c(new_n36_), .O(new_n69_));
  inv1   g45(.a(new_n63_), .O(new_n70_));
  nand3  g46(.a(new_n32_), .b(x14), .c(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n49_), .b(new_n48_), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n26_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  aoi21  g50(.a(new_n69_), .b(new_n68_), .c(new_n74_), .O(z6));
  nand2  g51(.a(new_n35_), .b(x03), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n56_), .c(new_n62_), .O(new_n77_));
  nand3  g53(.a(new_n35_), .b(x09), .c(x03), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n46_), .O(z7));
  oai21  g55(.a(new_n76_), .b(x12), .c(x09), .O(new_n80_));
  nand2  g56(.a(new_n60_), .b(new_n25_), .O(new_n81_));
