...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n59_, new_n60_, new_n61_, new_n62_, new_n64_;
  ...
  oai21  g27(.a(new_n51_), .b(new_n49_), .c(new_n35_), .O(z3));
  inv1   g28(.a(x07), .O(new_n53_));
  nand4  g29(.a(x09), .b(x08), .c(new_n53_), .d(x00), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n49_), .c(new_n35_), .O(z4));
  nor3   g32(.a(x10), .b(x09), .c(x07), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n50_), .d(new_n37_), .O(z5));
  nand3  g34(.a(x14), .b(x01), .c(new_n37_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(x02), .O(new_n60_));
  inv1   g36(.a(x08), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n37_), .c(new_n57_), .O(new_n62_));
  aoi21  g38(.a(new_n60_), .b(new_n46_), .c(new_n62_), .O(z6));
  oai21  g39(.a(new_n30_), .b(new_n31_), .c(new_n61_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n57_), .O(z7));
  nand2  g41(.a(new_n57_), .b(x00), .O(z8));
endmodule
