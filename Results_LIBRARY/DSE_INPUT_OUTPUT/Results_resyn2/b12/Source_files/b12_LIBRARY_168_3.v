...
module FAU ( 
  ...
  aoi21  g22(.a(new_n43_), .b(new_n38_), .c(new_n46_), .O(z2));
  ...
  nand2  g30(.a(new_n54_), .b(new_n30_), .O(z4));
  ...
  nand2  g36(.a(new_n39_), .b(x03), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n26_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n51_), .c(new_n40_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n30_), .O(z6));
  inv1   g40(.a(x10), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(x08), .c(new_n52_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n33_), .c(new_n38_), .O(new_n67_));
  oai21  g43(.a(new_n59_), .b(x01), .c(x08), .O(new_n68_));
  nand3  g44(.a(new_n26_), .b(new_n39_), .c(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n40_), .c(new_n67_), .O(z7));
  nand3  g47(.a(new_n30_), .b(new_n39_), .c(x00), .O(new_n72_));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x09), .c(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n27_), .c(new_n72_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n40_), .O(z8));
endmodule
