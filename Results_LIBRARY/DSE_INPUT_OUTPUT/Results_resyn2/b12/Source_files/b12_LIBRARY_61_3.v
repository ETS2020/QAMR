...
module FAU ( 
  ...
  nand2  g45(.a(new_n58_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n43_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n27_), .O(new_n72_));
  oai21  g48(.a(new_n60_), .b(new_n25_), .c(new_n44_), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n68_), .c(new_n73_), .O(z6));
  inv1   g50(.a(new_n36_), .O(new_n75_));
  aoi21  g51(.a(x03), .b(new_n43_), .c(x08), .O(new_n76_));
  nand3  g52(.a(x09), .b(x03), .c(new_n43_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n27_), .O(new_n79_));
  inv1   g55(.a(new_n44_), .O(new_n80_));
  aoi21  g56(.a(new_n60_), .b(x02), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n79_), .c(new_n75_), .O(z7));
  nand3  g58(.a(new_n36_), .b(new_n58_), .c(x00), .O(new_n83_));
  nand2  g59(.a(new_n54_), .b(new_n27_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n77_), .c(new_n83_), .O(new_n85_));
