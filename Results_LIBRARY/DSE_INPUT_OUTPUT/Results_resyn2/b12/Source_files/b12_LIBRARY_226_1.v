...
module FAU ( 
  ...
  nand2  g28(.a(x09), .b(new_n38_), .O(new_n53_));
  ...
  aoi21  g37(.a(new_n61_), .b(new_n59_), .c(x01), .O(new_n62_));
  ...
  oai21  g41(.a(new_n65_), .b(new_n62_), .c(new_n47_), .O(z6));
  nand2  g42(.a(new_n59_), .b(new_n28_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n26_), .O(new_n68_));
  oai21  g44(.a(new_n60_), .b(x01), .c(new_n39_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n63_), .O(z7));
  inv1   g46(.a(x12), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n42_), .c(new_n38_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n59_), .c(new_n28_), .O(new_n73_));
  nand3  g49(.a(new_n63_), .b(new_n41_), .c(x00), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n73_), .b(new_n26_), .c(new_n75_), .O(z8));
endmodule
