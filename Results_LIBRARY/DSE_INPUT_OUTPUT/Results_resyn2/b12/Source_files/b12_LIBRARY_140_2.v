...
module FAU ( 
  ...
  nand2  g34(.a(new_n42_), .b(new_n34_), .O(new_n59_));
  ...
  oai21  g42(.a(new_n44_), .b(new_n34_), .c(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n43_), .b(x08), .c(new_n38_), .O(new_n68_));
  aoi21  g44(.a(x03), .b(new_n31_), .c(new_n68_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n31_), .c(new_n69_), .O(z7));
