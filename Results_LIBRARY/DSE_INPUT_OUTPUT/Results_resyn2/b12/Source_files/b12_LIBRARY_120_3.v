...
module FAU ( 
  ...
  oai22  g19(.a(x08), .b(new_n43_), .c(new_n38_), .d(x02), .O(new_n44_));
  ...
  aoi22  g26(.a(new_n50_), .b(new_n25_), .c(new_n44_), .d(x07), .O(z2));
  nor2   g27(.a(new_n28_), .b(new_n25_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  nand2  g29(.a(x12), .b(new_n43_), .O(new_n54_));
  ...
  nand3  g40(.a(x13), .b(new_n64_), .c(new_n63_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n62_), .c(new_n52_), .O(z5));
  inv1   g43(.a(new_n46_), .O(new_n68_));
  inv1   g44(.a(x01), .O(new_n69_));
  nand2  g45(.a(new_n45_), .b(x03), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n38_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  aoi21  g48(.a(x08), .b(x00), .c(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g50(.a(x14), .b(x01), .c(new_n43_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n32_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(new_n68_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n69_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n46_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n69_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n28_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  nand2  g59(.a(new_n64_), .b(new_n25_), .O(new_n84_));
  oai22  g60(.a(new_n84_), .b(new_n78_), .c(x09), .d(new_n43_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n46_), .c(new_n52_), .O(z8));
endmodule
