...
module FAU ( 
  ...
  oai21  g26(.a(new_n50_), .b(new_n46_), .c(new_n29_), .O(new_n51_));
  ...
  nand4  g43(.a(new_n67_), .b(new_n61_), .c(new_n45_), .d(new_n37_), .O(new_n68_));
  aoi21  g44(.a(new_n66_), .b(new_n38_), .c(new_n68_), .O(z6));
  and2   g45(.a(new_n45_), .b(new_n37_), .O(new_n70_));
  nand3  g46(.a(new_n38_), .b(x09), .c(x03), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  oai21  g48(.a(new_n39_), .b(new_n31_), .c(new_n72_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(z7));
  oai22  g50(.a(new_n71_), .b(x12), .c(x09), .d(new_n36_), .O(new_n75_));
