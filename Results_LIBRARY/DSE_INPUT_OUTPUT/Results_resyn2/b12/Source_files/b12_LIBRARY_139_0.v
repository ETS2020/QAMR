...
module FAU ( 
  ...
  nand2  g18(.a(new_n34_), .b(new_n25_), .O(new_n43_));
  aoi21  g19(.a(new_n42_), .b(new_n37_), .c(new_n43_), .O(z1));
  inv1   g20(.a(x01), .O(new_n45_));
  inv1   g21(.a(x07), .O(new_n46_));
  nand3  g22(.a(new_n32_), .b(x09), .c(new_n46_), .O(new_n47_));
  nand3  g23(.a(x07), .b(new_n39_), .c(new_n25_), .O(new_n48_));
  ...
  nand3  g28(.a(x10), .b(new_n39_), .c(new_n45_), .O(new_n53_));
  ...
  nand2  g37(.a(new_n58_), .b(new_n34_), .O(new_n62_));
  ...
  nand2  g43(.a(new_n67_), .b(x11), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n32_), .O(z5));
  nor2   g45(.a(x02), .b(x01), .O(new_n70_));
  xnor2a g46(.a(x09), .b(x03), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n72_));
  nand3  g48(.a(x11), .b(new_n32_), .c(new_n46_), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n50_), .O(new_n75_));
  aoi21  g51(.a(new_n71_), .b(new_n70_), .c(new_n75_), .O(z6));
  nand4  g52(.a(x09), .b(x03), .c(new_n36_), .d(new_n45_), .O(new_n77_));
  inv1   g53(.a(x08), .O(new_n78_));
  nand3  g54(.a(x03), .b(new_n36_), .c(new_n45_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n77_), .c(new_n74_), .O(z7));
  oai22  g57(.a(new_n77_), .b(x12), .c(x09), .d(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n74_), .O(z8));
endmodule
