...
module FAU ( 
  ...
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n48_), .d(new_n39_), .O(new_n55_));
  and2   g31(.a(new_n55_), .b(new_n46_), .O(z5));
  nand2  g32(.a(new_n25_), .b(new_n42_), .O(new_n57_));
  nand2  g33(.a(x09), .b(x03), .O(new_n58_));
  inv1   g34(.a(x09), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n26_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n58_), .c(new_n57_), .O(new_n61_));
  inv1   g37(.a(x08), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n29_), .c(new_n36_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n61_), .c(new_n46_), .O(z6));
  nand2  g40(.a(new_n58_), .b(new_n42_), .O(new_n65_));
  aoi21  g41(.a(x08), .b(x01), .c(x02), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g43(.a(new_n46_), .b(new_n40_), .O(new_n68_));
  nand2  g44(.a(x03), .b(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n62_), .c(new_n42_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n67_), .O(z7));
  nor2   g47(.a(x02), .b(x01), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n48_), .c(x09), .d(x03), .O(new_n73_));
  nand2  g49(.a(new_n59_), .b(x00), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n46_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n68_), .O(z8));
endmodule
