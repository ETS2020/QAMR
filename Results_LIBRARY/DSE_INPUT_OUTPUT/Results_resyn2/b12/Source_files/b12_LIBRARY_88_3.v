...
module FAU ( 
  ...
  nand2  g09(.a(x09), .b(x05), .O(new_n34_));
  nand2  g10(.a(new_n31_), .b(new_n30_), .O(new_n35_));
  nand4  g11(.a(new_n35_), .b(new_n34_), .c(new_n33_), .d(new_n29_), .O(new_n36_));
  nor2   g12(.a(new_n36_), .b(new_n28_), .O(z0));
  ...
  inv1   g25(.a(new_n34_), .O(new_n50_));
  oai21  g26(.a(x08), .b(x07), .c(x00), .O(new_n51_));
  nand3  g27(.a(x10), .b(new_n32_), .c(new_n30_), .O(new_n52_));
  ...
  aoi21  g33(.a(x12), .b(new_n29_), .c(new_n57_), .O(z3));
  inv1   g34(.a(x07), .O(new_n59_));
  oai21  g35(.a(x09), .b(new_n59_), .c(x05), .O(new_n60_));
  nand2  g36(.a(x09), .b(new_n59_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n48_), .c(new_n56_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n60_), .O(z4));
  nor2   g39(.a(x12), .b(x10), .O(new_n64_));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n34_), .d(x13), .O(z5));
  nand2  g42(.a(x09), .b(new_n32_), .O(new_n67_));
  aoi21  g43(.a(new_n38_), .b(x03), .c(new_n35_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n48_), .c(new_n44_), .d(new_n34_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(z6));
  inv1   g47(.a(x08), .O(new_n72_));
  oai21  g48(.a(new_n35_), .b(new_n32_), .c(new_n72_), .O(new_n73_));
  nand4  g49(.a(x09), .b(x03), .c(new_n31_), .d(new_n30_), .O(new_n74_));
  and2   g50(.a(new_n74_), .b(new_n44_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n73_), .c(new_n50_), .O(z7));
  inv1   g52(.a(x12), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n26_), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(new_n74_), .c(x09), .d(new_n29_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n44_), .O(z8));
endmodule
