...
module FAU ( 
  ...
  nand3  g02(.a(x08), .b(new_n25_), .c(x01), .O(new_n27_));
  ...
  nand2  g14(.a(new_n28_), .b(x03), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(new_n38_), .c(x00), .O(z1));
  inv1   g16(.a(x00), .O(new_n41_));
  oai21  g17(.a(x10), .b(x07), .c(new_n36_), .O(new_n42_));
  ...
  nor2   g41(.a(x09), .b(new_n36_), .O(new_n66_));
  oai21  g42(.a(new_n59_), .b(x03), .c(new_n31_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n57_), .c(new_n43_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n25_), .c(new_n70_), .O(z6));
  nand4  g47(.a(x09), .b(x03), .c(new_n25_), .d(new_n31_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n43_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x08), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n25_), .c(new_n74_), .O(z7));
  inv1   g51(.a(x12), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x03), .c(new_n31_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n44_), .c(x08), .O(new_n78_));
  nor2   g54(.a(x09), .b(new_n41_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n43_), .c(new_n78_), .d(new_n25_), .O(z8));
endmodule
