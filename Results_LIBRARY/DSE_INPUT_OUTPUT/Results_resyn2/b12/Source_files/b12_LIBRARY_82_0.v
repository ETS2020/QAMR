...
module FAU ( 
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n42_), .d(new_n26_), .O(new_n64_));
  ...
  nand3  g54(.a(new_n55_), .b(new_n47_), .c(x00), .O(new_n79_));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x09), .c(x06), .d(new_n25_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n73_), .c(new_n79_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n48_), .O(z8));
endmodule
