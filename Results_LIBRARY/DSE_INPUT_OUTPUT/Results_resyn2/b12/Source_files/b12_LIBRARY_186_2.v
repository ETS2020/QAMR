...
module FAU ( 
  ...
  oai21  g15(.a(new_n39_), .b(new_n38_), .c(new_n26_), .O(new_n40_));
  ...
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n34_), .O(z3));
  ...
  nor3   g36(.a(new_n33_), .b(x07), .c(x00), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n55_), .d(new_n47_), .O(z5));
  nor2   g38(.a(x10), .b(x07), .O(new_n63_));
  nand2  g39(.a(x08), .b(x00), .O(new_n64_));
  xnor2a g40(.a(x09), .b(x03), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n25_), .c(new_n44_), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n67_), .b(new_n34_), .c(new_n69_), .O(z6));
  nand4  g46(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  inv1   g48(.a(new_n63_), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n72_), .c(new_n73_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n71_), .c(new_n33_), .O(z7));
  oai22  g52(.a(new_n71_), .b(x12), .c(x09), .d(new_n36_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n63_), .c(new_n33_), .O(z8));
endmodule
