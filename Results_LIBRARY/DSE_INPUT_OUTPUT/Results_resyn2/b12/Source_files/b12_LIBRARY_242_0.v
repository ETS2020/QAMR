...
module FAU ( 
  ...
  nand4  g41(.a(x13), .b(new_n65_), .c(new_n46_), .d(new_n25_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x14), .O(new_n67_));
  ...
  nand2  g55(.a(new_n79_), .b(x08), .O(new_n80_));
  nand3  g56(.a(new_n69_), .b(new_n71_), .c(x03), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(x10), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n78_), .c(new_n48_), .O(z7));
  nand3  g59(.a(new_n69_), .b(new_n65_), .c(x03), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n46_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n78_), .c(new_n48_), .O(z8));
endmodule
