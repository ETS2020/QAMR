...
module FAU ( 
  ...
  nand3  g25(.a(new_n49_), .b(new_n45_), .c(new_n42_), .O(new_n50_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n58_), .c(new_n44_), .O(new_n69_));
  ...
  aoi21  g50(.a(new_n74_), .b(new_n65_), .c(new_n48_), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n73_), .c(x13), .d(x12), .O(z7));
  nand3  g52(.a(new_n74_), .b(new_n65_), .c(new_n54_), .O(new_n77_));
  nand3  g53(.a(new_n32_), .b(new_n43_), .c(x00), .O(new_n78_));
