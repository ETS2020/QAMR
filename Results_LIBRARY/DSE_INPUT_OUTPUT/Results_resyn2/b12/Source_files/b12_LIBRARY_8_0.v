...
module FAU ( 
  ...
  aoi21  g33(.a(new_n57_), .b(new_n55_), .c(new_n32_), .O(z5));
  inv1   g34(.a(x01), .O(new_n59_));
  oai21  g35(.a(new_n55_), .b(new_n35_), .c(new_n59_), .O(new_n60_));
  nand3  g36(.a(x14), .b(x02), .c(new_n25_), .O(new_n61_));
  nor2   g37(.a(x10), .b(x07), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n50_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n60_), .O(z6));
  aoi21  g40(.a(new_n62_), .b(x08), .c(new_n32_), .O(z7));
  nand4  g41(.a(new_n62_), .b(new_n33_), .c(new_n52_), .d(x00), .O(z8));
endmodule
