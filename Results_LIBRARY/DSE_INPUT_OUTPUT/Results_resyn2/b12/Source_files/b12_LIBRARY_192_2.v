...
module FAU ( 
  ...
  nand2  g29(.a(new_n53_), .b(new_n43_), .O(z2));
  ...
  nand2  g37(.a(new_n61_), .b(new_n43_), .O(z4));
  nor2   g38(.a(x10), .b(x07), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(x13), .c(new_n36_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n27_), .O(z5));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nor2   g43(.a(x02), .b(x01), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n36_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n59_), .c(new_n63_), .d(new_n43_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(z6));
  inv1   g47(.a(new_n43_), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  oai21  g49(.a(new_n37_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n68_), .b(x09), .c(x03), .O(new_n75_));
  and2   g51(.a(new_n75_), .b(new_n63_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(z7));
  oai22  g53(.a(new_n75_), .b(x12), .c(x09), .d(new_n36_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n63_), .c(new_n43_), .O(z8));
endmodule
