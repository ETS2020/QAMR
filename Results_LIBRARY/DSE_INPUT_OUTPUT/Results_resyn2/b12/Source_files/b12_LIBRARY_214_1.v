...
module FAU ( 
  ...
  nand2  g15(.a(new_n33_), .b(new_n25_), .O(new_n40_));
  ...
  nand3  g20(.a(new_n32_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  ...
  aoi21  g25(.a(new_n47_), .b(new_n35_), .c(new_n49_), .O(z2));
  ...
  nand2  g33(.a(new_n52_), .b(new_n33_), .O(new_n58_));
  aoi21  g34(.a(new_n57_), .b(new_n56_), .c(new_n58_), .O(z4));
  nand3  g35(.a(x13), .b(new_n43_), .c(new_n25_), .O(new_n60_));
  ...
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n55_), .d(new_n43_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n51_), .c(x10), .O(z6));
  inv1   g44(.a(x08), .O(new_n69_));
  nand3  g45(.a(x03), .b(new_n35_), .c(new_n42_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g47(.a(new_n63_), .b(x09), .c(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n43_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n51_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n32_), .O(z7));
  nand2  g51(.a(new_n44_), .b(x00), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n72_), .c(x07), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x12), .c(new_n32_), .O(z8));
endmodule
