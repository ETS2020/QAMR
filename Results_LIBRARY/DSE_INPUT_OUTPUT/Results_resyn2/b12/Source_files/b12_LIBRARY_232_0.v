...
module FAU ( 
  ...
  nand3  g14(.a(x13), .b(new_n27_), .c(new_n31_), .O(new_n39_));
  oai21  g15(.a(x13), .b(x02), .c(x00), .O(new_n40_));
  nand3  g16(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(new_n41_));
  aoi21  g17(.a(new_n37_), .b(new_n35_), .c(new_n41_), .O(z1));
  nor2   g18(.a(new_n36_), .b(x02), .O(new_n43_));
  ...
  nand2  g26(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(x03), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n49_), .c(new_n31_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n43_), .c(new_n46_), .O(z2));
  nand2  g30(.a(new_n36_), .b(new_n27_), .O(new_n55_));
  ...
  oai21  g37(.a(new_n61_), .b(new_n56_), .c(new_n55_), .O(z4));
  inv1   g38(.a(x00), .O(new_n63_));
  nor2   g39(.a(x12), .b(x10), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n44_), .d(new_n63_), .O(z5));
  ...
  nand2  g44(.a(new_n68_), .b(x13), .O(new_n69_));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand4  g46(.a(x14), .b(x02), .c(x01), .d(new_n63_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(new_n72_));
  aoi21  g48(.a(new_n69_), .b(new_n27_), .c(new_n72_), .O(z6));
  nand2  g49(.a(x03), .b(new_n31_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n47_), .c(x13), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n27_), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n27_), .c(new_n31_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n45_), .c(new_n51_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n76_), .O(z7));
  nand4  g55(.a(new_n57_), .b(new_n50_), .c(x09), .d(new_n44_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n74_), .c(x13), .O(new_n81_));
