...
module FAU ( 
  ...
  nand3  g23(.a(new_n33_), .b(x09), .c(new_n47_), .O(new_n48_));
  inv1   g24(.a(new_n48_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n46_), .c(new_n44_), .O(new_n50_));
  ...
  nor2   g36(.a(new_n32_), .b(x00), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n45_), .c(x13), .d(new_n55_), .O(z5));
  ...
  nand3  g42(.a(new_n33_), .b(new_n47_), .c(x04), .O(new_n67_));
  ...
  nand4  g46(.a(x09), .b(x03), .c(new_n36_), .d(new_n44_), .O(new_n71_));
