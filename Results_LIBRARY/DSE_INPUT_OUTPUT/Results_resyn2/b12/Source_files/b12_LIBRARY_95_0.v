...
module FAU ( 
  ...
  nand3  g14(.a(x03), .b(new_n30_), .c(x01), .O(new_n39_));
  ...
  nand2  g20(.a(new_n44_), .b(new_n36_), .O(z1));
  oai21  g21(.a(x08), .b(x07), .c(x00), .O(new_n46_));
  nor2   g22(.a(x03), .b(x01), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n48_));
  aoi21  g24(.a(x08), .b(x00), .c(x07), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n29_), .c(new_n34_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(x10), .c(new_n48_), .O(z2));
  inv1   g27(.a(x12), .O(new_n52_));
  nand2  g28(.a(x11), .b(x07), .O(new_n53_));
  oai21  g29(.a(new_n52_), .b(x00), .c(new_n53_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n36_), .O(z3));
  and2   g31(.a(x08), .b(x00), .O(new_n56_));
  nor2   g32(.a(new_n34_), .b(x07), .O(new_n57_));
  nand2  g33(.a(new_n53_), .b(new_n36_), .O(new_n58_));
  aoi21  g34(.a(new_n57_), .b(new_n56_), .c(new_n58_), .O(z4));
  inv1   g35(.a(x07), .O(new_n60_));
  nor2   g36(.a(x10), .b(new_n34_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n52_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n60_), .d(new_n33_), .O(z5));
  nand4  g40(.a(x14), .b(x02), .c(x01), .d(new_n33_), .O(new_n65_));
  nand3  g41(.a(x03), .b(new_n30_), .c(new_n29_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n61_), .d(new_n49_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  nand3  g44(.a(new_n66_), .b(x08), .c(new_n60_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x09), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n35_), .O(z7));
  inv1   g47(.a(new_n66_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n63_), .c(new_n60_), .O(z8));
endmodule
