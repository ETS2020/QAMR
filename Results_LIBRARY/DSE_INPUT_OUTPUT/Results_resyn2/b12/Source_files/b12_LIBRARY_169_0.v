...
module FAU ( 
  ...
  nor2   g07(.a(x06), .b(x01), .O(new_n32_));
  ...
  nor2   g17(.a(new_n32_), .b(x00), .O(new_n42_));
  ...
  nand3  g25(.a(new_n49_), .b(new_n47_), .c(new_n35_), .O(new_n50_));
  oai21  g26(.a(x08), .b(x07), .c(x00), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n33_), .O(new_n52_));
  aoi21  g28(.a(new_n50_), .b(new_n36_), .c(new_n52_), .O(z2));
  ...
  nand4  g34(.a(x09), .b(x08), .c(new_n58_), .d(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n54_), .c(new_n33_), .O(z4));
  nand4  g37(.a(new_n46_), .b(new_n42_), .c(x13), .d(new_n55_), .O(z5));
  nor2   g38(.a(x02), .b(x01), .O(new_n63_));
  xnor2a g39(.a(x09), .b(x03), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g41(.a(x08), .b(x00), .O(new_n66_));
  nand3  g42(.a(new_n40_), .b(x14), .c(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n46_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n33_), .O(z6));
  inv1   g45(.a(x08), .O(new_n70_));
  oai21  g46(.a(new_n37_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n63_), .b(x09), .c(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x06), .O(new_n74_));
  aoi21  g50(.a(new_n70_), .b(x01), .c(new_n48_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n32_), .O(z7));
  inv1   g52(.a(new_n47_), .O(new_n77_));
  nand2  g53(.a(new_n46_), .b(new_n55_), .O(new_n78_));
  nand3  g54(.a(x09), .b(x03), .c(new_n36_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(x06), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n35_), .c(new_n77_), .d(x00), .O(z8));
endmodule
