...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n52_), .c(new_n63_), .O(new_n65_));
  ...
  oai21  g44(.a(x08), .b(new_n30_), .c(new_n63_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n31_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n68_), .O(z7));
  inv1   g47(.a(x01), .O(new_n72_));
  nand3  g48(.a(new_n48_), .b(new_n44_), .c(new_n39_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n60_), .c(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n63_), .b(new_n43_), .c(x00), .O(new_n75_));
