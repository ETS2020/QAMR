...
module FAU ( 
  ...
  or2    g09(.a(x04), .b(x03), .O(new_n34_));
  nand4  g10(.a(new_n34_), .b(new_n33_), .c(x02), .d(new_n25_), .O(new_n35_));
  nand2  g11(.a(new_n35_), .b(new_n31_), .O(z1));
  ...
  aoi21  g21(.a(new_n45_), .b(new_n30_), .c(new_n39_), .O(z2));
  nand2  g22(.a(x12), .b(new_n25_), .O(new_n47_));
  nand2  g23(.a(x11), .b(x07), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(new_n47_), .c(new_n31_), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(z3));
  nand2  g26(.a(new_n48_), .b(new_n31_), .O(new_n51_));
  ...
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n57_), .d(new_n56_), .O(new_n59_));
  and2   g35(.a(new_n59_), .b(new_n31_), .O(z5));
  nand2  g36(.a(x14), .b(new_n25_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(x02), .c(new_n40_), .O(new_n62_));
  xnor2a g38(.a(x09), .b(x03), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n30_), .O(new_n64_));
  nand3  g40(.a(new_n52_), .b(new_n56_), .c(new_n37_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n62_), .O(z6));
  nand2  g44(.a(x09), .b(x03), .O(new_n69_));
  oai21  g45(.a(x08), .b(x03), .c(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n27_), .O(new_n71_));
  oai21  g47(.a(x08), .b(new_n30_), .c(new_n42_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n31_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(z7));
  nand3  g50(.a(new_n57_), .b(new_n56_), .c(new_n37_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n69_), .c(new_n40_), .O(new_n76_));
  nand3  g52(.a(new_n42_), .b(new_n41_), .c(x00), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n76_), .b(new_n30_), .c(new_n78_), .O(z8));
endmodule
