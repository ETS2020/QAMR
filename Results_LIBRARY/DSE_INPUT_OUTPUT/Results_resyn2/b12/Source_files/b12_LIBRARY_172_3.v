...
module FAU ( 
  ...
  nand3  g36(.a(new_n51_), .b(new_n39_), .c(new_n37_), .O(new_n61_));
  ...
  oai21  g42(.a(x10), .b(x07), .c(new_n25_), .O(new_n67_));
  ...
  nand4  g48(.a(new_n72_), .b(new_n47_), .c(x09), .d(x03), .O(new_n73_));
