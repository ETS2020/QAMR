...
module FAU ( 
  ...
  nand2  g44(.a(new_n68_), .b(new_n31_), .O(z6));
  nand3  g45(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n42_), .O(new_n71_));
  nand3  g47(.a(new_n58_), .b(x08), .c(new_n39_), .O(new_n72_));
  aoi21  g48(.a(x03), .b(new_n30_), .c(new_n72_), .O(new_n73_));
  aoi21  g49(.a(new_n71_), .b(new_n30_), .c(new_n73_), .O(z7));
  nand2  g50(.a(new_n43_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n30_), .b(x01), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(x03), .b(new_n30_), .O(new_n77_));
  nand3  g53(.a(new_n49_), .b(x09), .c(new_n42_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n76_), .c(new_n44_), .O(z8));
endmodule
