...
module FAU ( 
  ...
  inv1   g14(.a(new_n37_), .O(new_n39_));
  nand2  g15(.a(new_n39_), .b(x03), .O(new_n40_));
  nand3  g16(.a(new_n40_), .b(new_n38_), .c(new_n28_), .O(new_n41_));
  inv1   g17(.a(x00), .O(new_n42_));
  nor2   g18(.a(x08), .b(x07), .O(new_n43_));
  nand2  g19(.a(x05), .b(x02), .O(new_n44_));
  inv1   g20(.a(new_n44_), .O(new_n45_));
  nor3   g21(.a(new_n45_), .b(new_n43_), .c(new_n42_), .O(new_n46_));
  aoi21  g22(.a(new_n41_), .b(new_n25_), .c(new_n46_), .O(z2));
  ...
  nor2   g28(.a(new_n52_), .b(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n36_), .b(x07), .O(new_n54_));
  nand2  g30(.a(new_n49_), .b(new_n44_), .O(new_n55_));
  aoi21  g31(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n44_), .d(x13), .O(z5));
  nand3  g35(.a(x14), .b(x01), .c(new_n42_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n31_), .O(new_n61_));
  nand2  g37(.a(x09), .b(new_n29_), .O(new_n62_));
  nand2  g38(.a(new_n36_), .b(x03), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n28_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n25_), .O(new_n65_));
  oai21  g41(.a(new_n52_), .b(new_n42_), .c(new_n37_), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(new_n61_), .c(new_n66_), .O(z6));
  aoi21  g43(.a(x03), .b(new_n28_), .c(x08), .O(new_n68_));
  nand3  g44(.a(x09), .b(x03), .c(new_n28_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n25_), .O(new_n71_));
  aoi21  g47(.a(new_n52_), .b(x02), .c(new_n39_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(new_n45_), .O(z7));
  nand3  g49(.a(new_n44_), .b(new_n36_), .c(x00), .O(new_n74_));
  nand2  g50(.a(new_n48_), .b(new_n25_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n69_), .c(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n37_), .O(z8));
endmodule
