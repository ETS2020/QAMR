...
module FAU ( 
  ...
  nand3  g16(.a(x03), .b(new_n31_), .c(x01), .O(new_n41_));
  ...
  oai21  g21(.a(x03), .b(x01), .c(new_n31_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  aoi21  g23(.a(new_n44_), .b(new_n26_), .c(new_n47_), .O(z2));
  nand2  g24(.a(x12), .b(new_n25_), .O(new_n49_));
  ...
  nand2  g32(.a(new_n56_), .b(new_n27_), .O(z4));
  nor2   g33(.a(x09), .b(x07), .O(new_n58_));
  nor2   g34(.a(x12), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(x13), .d(new_n26_), .O(z5));
  nand3  g36(.a(x14), .b(x01), .c(new_n25_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x02), .O(new_n62_));
  nand3  g38(.a(new_n58_), .b(new_n53_), .c(new_n26_), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(new_n46_), .c(new_n63_), .O(z6));
  inv1   g40(.a(x08), .O(new_n65_));
  nand3  g41(.a(x03), .b(new_n31_), .c(new_n30_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n65_), .c(x07), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x09), .c(new_n26_), .O(z7));
  oai21  g44(.a(x07), .b(new_n25_), .c(new_n43_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n26_), .O(z8));
endmodule
