...
module FAU ( 
  ...
  nand2  g42(.a(x14), .b(new_n25_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(x01), .c(new_n26_), .O(new_n68_));
  xnor2a g44(.a(x09), .b(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n58_), .c(new_n46_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n68_), .O(z6));
  aoi21  g48(.a(x09), .b(x03), .c(x02), .O(new_n73_));
  inv1   g49(.a(x08), .O(new_n74_));
  nand2  g50(.a(x03), .b(new_n32_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n47_), .O(new_n76_));
  oai21  g52(.a(new_n73_), .b(x01), .c(new_n76_), .O(z7));
  nand2  g53(.a(new_n42_), .b(x00), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n61_), .O(new_n79_));
  nand3  g55(.a(new_n63_), .b(x09), .c(new_n26_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n46_), .O(z8));
endmodule
