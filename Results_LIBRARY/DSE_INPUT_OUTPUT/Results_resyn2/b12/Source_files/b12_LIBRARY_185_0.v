...
module FAU ( 
  ...
  nand2  g35(.a(new_n54_), .b(new_n34_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z4));
  nor3   g37(.a(x12), .b(x07), .c(x00), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n33_), .c(new_n32_), .O(z5));
  ...
  nand2  g44(.a(new_n46_), .b(x13), .O(new_n69_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(z7));
  nand4  g52(.a(new_n53_), .b(x03), .c(new_n36_), .d(new_n44_), .O(new_n77_));
  inv1   g53(.a(x07), .O(new_n78_));
  oai21  g54(.a(x09), .b(x00), .c(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n77_), .b(x09), .c(new_n79_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n33_), .c(new_n32_), .O(z8));
endmodule
