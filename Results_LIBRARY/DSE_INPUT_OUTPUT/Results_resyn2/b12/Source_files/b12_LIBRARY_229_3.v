...
module FAU ( 
  ...
  nor2   g27(.a(new_n44_), .b(new_n30_), .O(new_n52_));
  nor2   g28(.a(new_n38_), .b(x07), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n52_), .c(new_n50_), .O(z4));
  inv1   g30(.a(x10), .O(new_n55_));
  inv1   g31(.a(x12), .O(new_n56_));
  nor2   g32(.a(x07), .b(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n56_), .d(new_n55_), .O(new_n58_));
  and2   g34(.a(new_n58_), .b(new_n49_), .O(z5));
  nand2  g35(.a(new_n25_), .b(new_n27_), .O(new_n60_));
  xor2a  g36(.a(x09), .b(x03), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  oai21  g38(.a(new_n44_), .b(new_n30_), .c(new_n39_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n49_), .O(z6));
  nand3  g40(.a(new_n55_), .b(x08), .c(new_n43_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n27_), .c(new_n25_), .O(new_n66_));
  oai21  g42(.a(new_n33_), .b(x01), .c(x08), .O(new_n67_));
  nand4  g43(.a(new_n38_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n39_), .c(new_n66_), .O(z7));
  nand3  g46(.a(new_n56_), .b(x09), .c(x03), .O(new_n71_));
  nand3  g47(.a(new_n49_), .b(new_n38_), .c(x00), .O(new_n72_));
  oai21  g48(.a(new_n71_), .b(new_n60_), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n39_), .O(z8));
endmodule
