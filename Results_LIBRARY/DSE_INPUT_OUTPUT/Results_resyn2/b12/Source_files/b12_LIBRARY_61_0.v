...
module FAU ( 
  ...
  nand4  g15(.a(x06), .b(x03), .c(new_n25_), .d(x01), .O(new_n40_));
  ...
  nand4  g25(.a(new_n49_), .b(new_n46_), .c(x06), .d(new_n45_), .O(new_n50_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n58_), .c(new_n48_), .O(new_n71_));
  aoi21  g47(.a(new_n69_), .b(new_n25_), .c(new_n71_), .O(z6));
  nand2  g48(.a(x03), .b(new_n45_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n49_), .c(x06), .O(new_n74_));
  nor2   g50(.a(new_n36_), .b(x01), .O(new_n75_));
  nand2  g51(.a(new_n48_), .b(x08), .O(new_n76_));
  aoi21  g52(.a(new_n75_), .b(new_n25_), .c(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n74_), .b(new_n25_), .c(new_n77_), .O(z7));
  nand3  g54(.a(new_n56_), .b(new_n47_), .c(x00), .O(new_n79_));
  nand4  g55(.a(new_n52_), .b(x09), .c(x06), .d(new_n25_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n73_), .c(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n48_), .O(z8));
endmodule
