...
module FAU ( 
  ...
  oai21  g40(.a(new_n64_), .b(x00), .c(x01), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n45_), .O(new_n66_));
  nand2  g42(.a(new_n42_), .b(x03), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n32_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n26_), .O(new_n69_));
  nor2   g45(.a(x10), .b(x07), .O(new_n70_));
  oai21  g46(.a(new_n58_), .b(new_n25_), .c(new_n70_), .O(new_n71_));
  aoi21  g47(.a(new_n69_), .b(new_n65_), .c(new_n71_), .O(z6));
  oai21  g48(.a(new_n67_), .b(new_n47_), .c(new_n26_), .O(new_n73_));
  nand2  g49(.a(x03), .b(new_n32_), .O(new_n74_));
  nand2  g50(.a(new_n70_), .b(x08), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n32_), .O(z7));
  nand2  g53(.a(new_n42_), .b(x00), .O(new_n78_));
  aoi21  g54(.a(x02), .b(new_n32_), .c(new_n78_), .O(new_n79_));
  inv1   g55(.a(x12), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x09), .c(new_n26_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(new_n74_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n79_), .c(new_n70_), .O(z8));
endmodule
