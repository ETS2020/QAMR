...
module FAU ( 
  ...
  aoi21  g09(.a(new_n33_), .b(x02), .c(new_n32_), .O(new_n34_));
  inv1   g10(.a(x04), .O(new_n35_));
  nand2  g11(.a(new_n35_), .b(new_n28_), .O(new_n36_));
  nand2  g12(.a(x06), .b(x01), .O(new_n37_));
  nand3  g13(.a(new_n37_), .b(new_n36_), .c(x02), .O(new_n38_));
  nand2  g14(.a(new_n33_), .b(x02), .O(new_n39_));
  and2   g15(.a(new_n39_), .b(new_n26_), .O(new_n40_));
  aoi21  g16(.a(new_n40_), .b(new_n38_), .c(new_n34_), .O(z1));
  ...
  aoi22  g25(.a(new_n49_), .b(new_n25_), .c(new_n44_), .d(new_n34_), .O(z2));
  and2   g26(.a(x11), .b(x07), .O(new_n51_));
  inv1   g27(.a(x12), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(x00), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n39_), .O(z3));
  nand4  g30(.a(x09), .b(x08), .c(new_n42_), .d(x00), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n51_), .c(new_n39_), .O(z4));
  nor2   g33(.a(x12), .b(x10), .O(new_n58_));
  nor2   g34(.a(x07), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n39_), .d(x13), .O(z5));
  nand3  g36(.a(x14), .b(x01), .c(new_n32_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(x05), .c(x02), .O(new_n62_));
  nand2  g38(.a(x09), .b(new_n28_), .O(new_n63_));
  ...
  oai21  g42(.a(new_n43_), .b(new_n32_), .c(new_n46_), .O(new_n67_));
  aoi21  g43(.a(new_n66_), .b(new_n62_), .c(new_n67_), .O(z6));
  nand2  g44(.a(new_n43_), .b(x02), .O(new_n69_));
  and2   g45(.a(new_n46_), .b(new_n39_), .O(new_n70_));
  oai21  g46(.a(new_n28_), .b(x01), .c(new_n43_), .O(new_n71_));
  nor2   g47(.a(new_n28_), .b(x01), .O(new_n72_));
  nor2   g48(.a(new_n45_), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(z7));
  nand2  g51(.a(new_n34_), .b(new_n45_), .O(new_n76_));
  nand3  g52(.a(new_n73_), .b(new_n72_), .c(new_n52_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n46_), .O(z8));
endmodule
