...
module FAU ( 
  ...
  nand3  g39(.a(new_n51_), .b(new_n63_), .c(new_n37_), .O(new_n64_));
  ...
  oai21  g44(.a(new_n40_), .b(new_n68_), .c(new_n30_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n26_), .O(new_n70_));
  oai21  g46(.a(new_n68_), .b(x01), .c(new_n38_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n41_), .O(z7));
  nand2  g48(.a(new_n27_), .b(new_n40_), .O(new_n73_));
  nor2   g49(.a(new_n68_), .b(x01), .O(new_n74_));
  nor2   g50(.a(new_n40_), .b(x02), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n47_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n41_), .O(z8));
endmodule
