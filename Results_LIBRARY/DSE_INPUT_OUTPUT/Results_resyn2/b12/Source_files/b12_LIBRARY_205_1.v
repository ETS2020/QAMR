...
module FAU ( 
  ...
  aoi21  g23(.a(new_n44_), .b(new_n29_), .c(new_n47_), .O(z2));
  ...
  nand2  g29(.a(x09), .b(new_n40_), .O(new_n54_));
  nand2  g30(.a(x08), .b(x00), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n54_), .c(new_n49_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n46_), .O(z4));
  nor2   g33(.a(x12), .b(x10), .O(new_n58_));
  nor2   g34(.a(x07), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(x13), .O(z5));
  ...
  nand3  g40(.a(new_n28_), .b(x14), .c(x02), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n55_), .c(new_n38_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n64_), .c(new_n46_), .O(z6));
  nand2  g43(.a(new_n61_), .b(new_n29_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n27_), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  nand2  g46(.a(x03), .b(new_n27_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n38_), .O(z7));
  nand2  g49(.a(new_n62_), .b(x00), .O(new_n74_));
  aoi21  g50(.a(x02), .b(new_n27_), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n29_), .O(new_n76_));
  nor3   g52(.a(new_n76_), .b(new_n71_), .c(x12), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n38_), .O(z8));
endmodule
