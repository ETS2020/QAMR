...
module FAU ( 
  ...
  oai21  g31(.a(new_n55_), .b(x02), .c(new_n32_), .O(new_n56_));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(x07), .c(new_n52_), .O(new_n58_));
  ...
  nand2  g44(.a(new_n57_), .b(new_n45_), .O(new_n69_));
  ...
  nand4  g54(.a(new_n51_), .b(x09), .c(x03), .d(new_n43_), .O(new_n79_));
  oai21  g55(.a(x09), .b(new_n25_), .c(new_n79_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n45_), .c(new_n38_), .O(z8));
endmodule
