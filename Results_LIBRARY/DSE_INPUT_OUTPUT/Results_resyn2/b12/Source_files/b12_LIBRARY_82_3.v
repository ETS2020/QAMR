...
module FAU ( 
  ...
  nor2   g35(.a(new_n59_), .b(new_n25_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n58_), .c(new_n55_), .O(z4));
  inv1   g37(.a(new_n36_), .O(new_n62_));
  inv1   g38(.a(x12), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n63_), .c(new_n47_), .O(new_n64_));
  nor3   g40(.a(new_n64_), .b(x07), .c(x00), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(new_n62_), .O(z5));
  nand3  g42(.a(x14), .b(x01), .c(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n38_), .c(x02), .O(new_n68_));
  nand2  g44(.a(x09), .b(new_n26_), .O(new_n69_));
  nand2  g45(.a(new_n57_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n43_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n27_), .O(new_n72_));
  oai21  g48(.a(new_n59_), .b(new_n25_), .c(new_n44_), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n68_), .c(new_n73_), .O(z6));
  aoi21  g50(.a(x03), .b(new_n43_), .c(x08), .O(new_n75_));
  nand3  g51(.a(x09), .b(x03), .c(new_n43_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n27_), .O(new_n78_));
  inv1   g54(.a(new_n44_), .O(new_n79_));
  aoi21  g55(.a(new_n59_), .b(x02), .c(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n78_), .c(new_n62_), .O(z7));
  nand3  g57(.a(new_n36_), .b(new_n57_), .c(x00), .O(new_n82_));
  nand2  g58(.a(new_n63_), .b(new_n27_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n76_), .c(new_n82_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n44_), .O(z8));
endmodule
