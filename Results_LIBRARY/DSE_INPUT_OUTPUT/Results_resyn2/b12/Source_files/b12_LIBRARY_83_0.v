...
module FAU ( 
  ...
  nand3  g03(.a(x12), .b(new_n27_), .c(x01), .O(new_n28_));
  ...
  oai21  g12(.a(new_n36_), .b(x02), .c(new_n26_), .O(new_n37_));
  nand4  g13(.a(x06), .b(x05), .c(x02), .d(x01), .O(new_n38_));
  nor2   g14(.a(x02), .b(x01), .O(new_n39_));
  nand2  g15(.a(new_n39_), .b(x12), .O(new_n40_));
  oai21  g16(.a(x12), .b(x02), .c(x00), .O(new_n41_));
  nand3  g17(.a(new_n41_), .b(new_n40_), .c(new_n38_), .O(new_n42_));
  aoi21  g18(.a(new_n37_), .b(new_n35_), .c(new_n42_), .O(z1));
  ...
  aoi21  g27(.a(new_n51_), .b(new_n44_), .c(new_n46_), .O(z2));
  nand2  g28(.a(new_n36_), .b(new_n27_), .O(new_n53_));
  nand2  g29(.a(x11), .b(x07), .O(new_n54_));
  inv1   g30(.a(x00), .O(new_n55_));
  nand2  g31(.a(x12), .b(new_n55_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n54_), .c(new_n53_), .O(new_n57_));
  ...
  nor2   g39(.a(new_n27_), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n48_), .c(x13), .d(new_n36_), .O(z5));
  ...
  nand3  g44(.a(new_n32_), .b(x14), .c(new_n55_), .O(new_n69_));
  nand2  g45(.a(new_n60_), .b(new_n48_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n53_), .O(z6));
  nand2  g49(.a(new_n48_), .b(new_n31_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n66_), .c(x12), .O(new_n75_));
  nand2  g51(.a(new_n48_), .b(x08), .O(new_n76_));
  aoi21  g52(.a(new_n39_), .b(x03), .c(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n75_), .b(new_n27_), .c(new_n77_), .O(z7));
  or2    g54(.a(new_n49_), .b(new_n41_), .O(z8));
endmodule
