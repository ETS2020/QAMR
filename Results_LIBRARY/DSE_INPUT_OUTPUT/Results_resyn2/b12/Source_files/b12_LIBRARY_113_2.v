...
module FAU ( 
  ...
  nor2   g36(.a(new_n48_), .b(new_n35_), .O(new_n61_));
  nor2   g37(.a(new_n50_), .b(x07), .O(new_n62_));
  nand2  g38(.a(new_n58_), .b(new_n56_), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z4));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  inv1   g41(.a(x10), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n57_), .c(new_n66_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n65_), .c(new_n44_), .O(z5));
  oai21  g45(.a(new_n25_), .b(x00), .c(new_n30_), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n39_), .O(new_n71_));
  nand2  g47(.a(new_n50_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n43_), .O(new_n74_));
  oai21  g50(.a(new_n48_), .b(new_n35_), .c(new_n51_), .O(new_n75_));
  aoi21  g51(.a(new_n74_), .b(new_n70_), .c(new_n75_), .O(z6));
  nand2  g52(.a(new_n48_), .b(x02), .O(new_n77_));
  and2   g53(.a(new_n51_), .b(new_n56_), .O(new_n78_));
  oai21  g54(.a(new_n39_), .b(x01), .c(new_n48_), .O(new_n79_));
  nor2   g55(.a(new_n39_), .b(x01), .O(new_n80_));
  nor2   g56(.a(new_n50_), .b(x02), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n79_), .c(new_n78_), .d(new_n77_), .O(z7));
  nand2  g59(.a(new_n37_), .b(new_n50_), .O(new_n84_));
  nand3  g60(.a(new_n81_), .b(new_n80_), .c(new_n57_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n51_), .O(z8));
endmodule
