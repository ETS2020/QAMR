...
module FAU ( 
  ...
  aoi21  g41(.a(new_n65_), .b(x02), .c(new_n47_), .O(new_n66_));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n31_), .O(new_n68_));
  nand3  g44(.a(new_n58_), .b(new_n40_), .c(new_n39_), .O(new_n69_));
  ...
  oai21  g49(.a(new_n49_), .b(new_n34_), .c(new_n47_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n31_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand2  g52(.a(x03), .b(new_n31_), .O(new_n77_));
  ...
  nor2   g56(.a(new_n80_), .b(new_n48_), .O(new_n81_));
  nand3  g57(.a(new_n53_), .b(x09), .c(new_n47_), .O(new_n82_));
