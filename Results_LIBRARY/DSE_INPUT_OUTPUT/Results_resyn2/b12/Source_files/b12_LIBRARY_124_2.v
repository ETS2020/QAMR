...
module FAU ( 
  ...
  nand2  g27(.a(new_n51_), .b(new_n31_), .O(z3));
  nand2  g28(.a(x08), .b(x00), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  nor2   g30(.a(new_n43_), .b(x07), .O(new_n55_));
  nand2  g31(.a(new_n50_), .b(new_n31_), .O(new_n56_));
  aoi21  g32(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z4));
  nor2   g33(.a(x02), .b(new_n42_), .O(new_n58_));
  nor2   g34(.a(x07), .b(x00), .O(new_n59_));
  inv1   g35(.a(x10), .O(new_n60_));
  nand3  g36(.a(x13), .b(new_n49_), .c(new_n60_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n59_), .c(new_n58_), .O(z5));
  nand2  g39(.a(x09), .b(new_n34_), .O(new_n64_));
  nand2  g40(.a(new_n43_), .b(x03), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n30_), .O(new_n66_));
  inv1   g42(.a(x14), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x00), .c(x02), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x01), .O(new_n69_));
  nand2  g45(.a(new_n53_), .b(new_n44_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(z6));
  nand3  g49(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n42_), .O(new_n75_));
  nand2  g51(.a(x03), .b(new_n30_), .O(new_n76_));
  nand2  g52(.a(new_n44_), .b(x08), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  aoi22  g54(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n30_), .O(z7));
  nand2  g55(.a(new_n43_), .b(x00), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n58_), .O(new_n81_));
  nand3  g57(.a(new_n49_), .b(x09), .c(new_n42_), .O(new_n82_));
  nor2   g58(.a(new_n82_), .b(new_n76_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(new_n44_), .O(z8));
endmodule
