...
module FAU ( 
  ...
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n56_), .d(new_n40_), .O(new_n58_));
  ...
  nand3  g38(.a(new_n52_), .b(new_n49_), .c(new_n62_), .O(new_n63_));
  aoi21  g39(.a(new_n61_), .b(new_n60_), .c(new_n63_), .O(z6));
  ...
  aoi22  g48(.a(new_n72_), .b(new_n71_), .c(new_n49_), .d(new_n70_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n69_), .O(z7));
  nand3  g50(.a(new_n49_), .b(new_n39_), .c(x00), .O(new_n75_));
  nand3  g51(.a(new_n56_), .b(x09), .c(new_n27_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n71_), .c(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n62_), .O(z8));
endmodule
