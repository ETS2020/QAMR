...
module FAU ( 
  ...
  nand2  g11(.a(new_n27_), .b(new_n26_), .O(new_n36_));
  ...
  nand2  g23(.a(new_n47_), .b(new_n36_), .O(z3));
  inv1   g24(.a(x00), .O(new_n49_));
  nor2   g25(.a(new_n42_), .b(new_n49_), .O(new_n50_));
  inv1   g26(.a(x09), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(x07), .O(new_n52_));
  nand2  g28(.a(new_n46_), .b(new_n36_), .O(new_n53_));
  aoi21  g29(.a(new_n52_), .b(new_n50_), .c(new_n53_), .O(z4));
  nor2   g30(.a(x12), .b(x10), .O(new_n55_));
  nor2   g31(.a(x07), .b(x00), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(new_n55_), .c(new_n36_), .d(x13), .O(z5));
  nor2   g33(.a(x10), .b(x07), .O(new_n58_));
  oai21  g34(.a(new_n42_), .b(new_n49_), .c(new_n58_), .O(new_n59_));
  inv1   g35(.a(x14), .O(new_n60_));
  nor2   g36(.a(new_n60_), .b(x00), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(new_n28_), .c(new_n59_), .d(new_n36_), .O(z6));
  nand3  g38(.a(new_n58_), .b(new_n36_), .c(x08), .O(z7));
  nand4  g39(.a(new_n58_), .b(new_n36_), .c(new_n51_), .d(x00), .O(z8));
endmodule
