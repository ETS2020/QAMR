...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n59_, new_n60_, new_n61_, new_n62_, new_n64_, new_n65_;
  ...
  nand2  g28(.a(new_n46_), .b(new_n34_), .O(new_n53_));
  aoi21  g29(.a(new_n52_), .b(new_n50_), .c(new_n53_), .O(z4));
  nor2   g30(.a(x12), .b(x10), .O(new_n55_));
  nor2   g31(.a(x07), .b(x00), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(new_n55_), .c(new_n34_), .d(x13), .O(z5));
  inv1   g33(.a(new_n27_), .O(new_n58_));
  inv1   g34(.a(x10), .O(new_n59_));
  nand3  g35(.a(new_n49_), .b(new_n59_), .c(new_n41_), .O(new_n60_));
  inv1   g36(.a(x14), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(x00), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n58_), .c(new_n60_), .d(new_n34_), .O(z6));
  nand2  g39(.a(new_n59_), .b(new_n41_), .O(new_n64_));
  aoi21  g40(.a(new_n33_), .b(new_n32_), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x08), .O(z7));
  nand3  g42(.a(new_n65_), .b(new_n51_), .c(x00), .O(z8));
endmodule
