...
module FAU ( 
  ...
  nand3  g28(.a(new_n52_), .b(new_n51_), .c(new_n46_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(z3));
  inv1   g30(.a(x09), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(x07), .O(new_n56_));
  nand2  g32(.a(new_n52_), .b(new_n46_), .O(new_n57_));
  nor2   g33(.a(new_n45_), .b(new_n50_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n56_), .c(new_n57_), .O(z4));
  inv1   g35(.a(new_n46_), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  nand3  g37(.a(x13), .b(new_n61_), .c(new_n41_), .O(new_n62_));
  nor3   g38(.a(new_n62_), .b(x07), .c(x00), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(new_n60_), .O(z5));
  inv1   g40(.a(new_n58_), .O(new_n65_));
  nand2  g41(.a(new_n55_), .b(x03), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n30_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n27_), .O(new_n68_));
  nand3  g44(.a(new_n28_), .b(x14), .c(x02), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n65_), .d(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n46_), .O(z6));
  nand3  g47(.a(new_n38_), .b(new_n55_), .c(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n29_), .O(new_n73_));
  nand2  g49(.a(x03), .b(new_n27_), .O(new_n74_));
  nand2  g50(.a(new_n38_), .b(x08), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n27_), .O(z7));
  nand2  g53(.a(new_n55_), .b(x00), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n60_), .O(new_n79_));
  nand3  g55(.a(new_n61_), .b(x09), .c(new_n29_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n74_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n38_), .O(z8));
endmodule
