...
module FAU ( 
  ...
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n51_), .d(new_n57_), .O(new_n59_));
  and2   g35(.a(new_n59_), .b(new_n38_), .O(z5));
  nand2  g36(.a(x09), .b(x03), .O(new_n61_));
  nand2  g37(.a(new_n44_), .b(new_n34_), .O(new_n62_));
  ...
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(new_n38_), .O(z6));
  nand2  g43(.a(new_n61_), .b(new_n28_), .O(new_n68_));
  ...
  nand3  g47(.a(new_n51_), .b(new_n57_), .c(new_n41_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n61_), .c(new_n28_), .O(new_n73_));
  nand3  g49(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n74_));
