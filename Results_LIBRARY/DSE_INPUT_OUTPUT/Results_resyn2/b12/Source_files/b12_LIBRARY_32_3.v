...
module FAU ( 
  ...
  nor2   g26(.a(new_n43_), .b(new_n29_), .O(new_n51_));
  nor2   g27(.a(new_n37_), .b(x07), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n51_), .c(new_n49_), .O(z4));
  nor2   g29(.a(x12), .b(x10), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n42_), .d(new_n29_), .O(new_n55_));
  and2   g31(.a(new_n55_), .b(new_n47_), .O(z5));
  ...
  oai21  g36(.a(new_n43_), .b(new_n29_), .c(new_n38_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z6));
  oai21  g38(.a(new_n58_), .b(new_n26_), .c(new_n43_), .O(new_n63_));
  nand3  g39(.a(new_n57_), .b(x09), .c(x03), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n47_), .d(new_n38_), .O(z7));
  inv1   g41(.a(new_n47_), .O(new_n66_));
  nand2  g42(.a(new_n37_), .b(x00), .O(new_n67_));
