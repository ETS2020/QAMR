...
module FAU ( 
  ...
  nor2   g07(.a(x12), .b(x11), .O(new_n32_));
  ...
  nand2  g35(.a(new_n47_), .b(new_n45_), .O(new_n60_));
  nand2  g36(.a(x13), .b(new_n25_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(x11), .O(new_n62_));
  ...
  nor2   g42(.a(new_n60_), .b(new_n32_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n57_), .O(new_n68_));
  ...
  oai22  g50(.a(new_n73_), .b(x12), .c(x09), .d(new_n25_), .O(new_n75_));
