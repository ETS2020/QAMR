...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n74_, new_n75_, new_n76_, new_n77_, new_n78_, new_n80_;
  ...
  nor2   g33(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  aoi21  g34(.a(x12), .b(new_n52_), .c(new_n58_), .O(z3));
  nand2  g35(.a(x08), .b(x00), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(new_n61_));
  nor3   g37(.a(new_n54_), .b(new_n42_), .c(x07), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(new_n58_), .O(z4));
  nor2   g39(.a(new_n27_), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n43_), .c(x13), .d(new_n50_), .O(z5));
  nand2  g41(.a(new_n42_), .b(x03), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n38_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n31_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x12), .O(new_n69_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n47_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n75_), .O(z7));
  inv1   g55(.a(new_n44_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(x00), .c(new_n54_), .O(z8));
endmodule
