...
module FAU ( 
  ...
  nand2  g39(.a(new_n41_), .b(new_n29_), .O(new_n64_));
  ...
  oai21  g45(.a(x08), .b(x03), .c(new_n63_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n33_), .O(new_n71_));
  oai21  g47(.a(x08), .b(new_n39_), .c(new_n66_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n50_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(z7));
  inv1   g50(.a(x12), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n42_), .c(new_n40_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n63_), .c(new_n28_), .O(new_n77_));
  nand3  g53(.a(new_n66_), .b(new_n41_), .c(x00), .O(new_n78_));
