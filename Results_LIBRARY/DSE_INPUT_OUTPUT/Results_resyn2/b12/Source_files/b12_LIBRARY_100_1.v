...
module FAU ( 
  ...
  nand2  g10(.a(x11), .b(new_n34_), .O(new_n35_));
  ...
  oai21  g26(.a(new_n50_), .b(new_n46_), .c(new_n26_), .O(new_n51_));
  oai21  g27(.a(x08), .b(x07), .c(x00), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n35_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n55_), .c(new_n35_), .O(z3));
  nand4  g34(.a(x09), .b(x08), .c(new_n47_), .d(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n55_), .c(new_n35_), .O(z4));
  inv1   g37(.a(new_n35_), .O(new_n62_));
  nand3  g38(.a(x13), .b(new_n56_), .c(new_n48_), .O(new_n63_));
  nor3   g39(.a(new_n63_), .b(x07), .c(x00), .O(new_n64_));
  nor2   g40(.a(new_n64_), .b(new_n62_), .O(z5));
  ...
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n45_), .d(new_n35_), .O(new_n70_));
  nor2   g46(.a(new_n70_), .b(new_n67_), .O(z6));
  and2   g47(.a(new_n45_), .b(new_n35_), .O(new_n72_));
  nand4  g48(.a(x09), .b(x03), .c(new_n27_), .d(new_n26_), .O(new_n73_));
  inv1   g49(.a(x08), .O(new_n74_));
  nand3  g50(.a(x03), .b(new_n27_), .c(new_n26_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n73_), .c(new_n72_), .O(z7));
  oai22  g53(.a(new_n73_), .b(x12), .c(x09), .d(new_n33_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n72_), .O(z8));
endmodule
