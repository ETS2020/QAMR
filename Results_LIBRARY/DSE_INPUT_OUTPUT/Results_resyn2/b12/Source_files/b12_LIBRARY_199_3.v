...
module FAU ( 
  ...
  nand2  g07(.a(x13), .b(x12), .O(new_n32_));
  ...
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n32_), .O(z3));
  nand4  g33(.a(x09), .b(x08), .c(new_n45_), .d(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n54_), .c(new_n32_), .O(z4));
  nor2   g36(.a(x10), .b(x07), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x00), .c(new_n55_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x13), .O(z5));
  nand2  g40(.a(x09), .b(new_n37_), .O(new_n65_));
  nand2  g41(.a(new_n34_), .b(new_n44_), .O(new_n66_));
  aoi21  g42(.a(new_n46_), .b(x03), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(x08), .b(x00), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n61_), .d(new_n32_), .O(new_n70_));
  aoi21  g46(.a(new_n67_), .b(new_n65_), .c(new_n70_), .O(z6));
  nand4  g47(.a(x09), .b(x03), .c(new_n34_), .d(new_n44_), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n34_), .c(new_n44_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n62_), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n72_), .c(x13), .d(x12), .O(z7));
  nand3  g52(.a(new_n32_), .b(new_n46_), .c(x00), .O(new_n77_));
  oai21  g53(.a(new_n72_), .b(x12), .c(new_n77_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n61_), .O(z8));
endmodule
