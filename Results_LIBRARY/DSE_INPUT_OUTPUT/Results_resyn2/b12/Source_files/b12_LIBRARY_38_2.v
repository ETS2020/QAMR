...
module FAU ( 
  ...
  nand2  g02(.a(new_n26_), .b(x10), .O(new_n27_));
  ...
  aoi21  g33(.a(new_n26_), .b(x10), .c(new_n57_), .O(new_n58_));
  ...
  aoi21  g38(.a(new_n26_), .b(x10), .c(new_n62_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n61_), .c(new_n58_), .O(z4));
  nor2   g40(.a(x10), .b(x07), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n26_), .d(new_n25_), .O(z5));
  xor2a  g42(.a(x09), .b(x03), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n32_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n60_), .c(new_n65_), .O(new_n70_));
  nor2   g46(.a(new_n70_), .b(new_n68_), .O(z6));
  nand4  g47(.a(x09), .b(x03), .c(new_n31_), .d(new_n30_), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n31_), .c(new_n30_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n65_), .O(z7));
  inv1   g52(.a(x09), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x00), .O(new_n78_));
  oai21  g54(.a(new_n72_), .b(x12), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n65_), .O(z8));
endmodule
