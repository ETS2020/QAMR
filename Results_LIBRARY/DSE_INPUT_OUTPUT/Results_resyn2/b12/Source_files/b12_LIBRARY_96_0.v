...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n57_, new_n59_, new_n61_, new_n62_, new_n65_, new_n66_, new_n67_;
  ...
  nand2  g19(.a(new_n32_), .b(x10), .O(new_n44_));
  ...
  oai21  g27(.a(x10), .b(x02), .c(new_n51_), .O(z3));
  ...
  oai21  g32(.a(x10), .b(x02), .c(new_n50_), .O(new_n57_));
  aoi21  g33(.a(new_n56_), .b(new_n54_), .c(new_n57_), .O(z4));
  nor2   g34(.a(x10), .b(x07), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n30_), .c(x13), .d(new_n49_), .O(z5));
  nand3  g36(.a(x14), .b(x01), .c(new_n26_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n53_), .c(new_n45_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(x02), .c(x10), .O(z6));
  nand3  g39(.a(new_n59_), .b(x08), .c(x02), .O(z7));
  inv1   g40(.a(x10), .O(new_n65_));
  nand3  g41(.a(new_n55_), .b(new_n45_), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x02), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n65_), .O(z8));
endmodule
