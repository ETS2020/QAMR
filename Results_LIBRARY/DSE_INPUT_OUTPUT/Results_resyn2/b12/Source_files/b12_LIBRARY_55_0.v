...
module FAU ( 
  ...
  inv1   g28(.a(new_n30_), .O(new_n53_));
  nor2   g29(.a(x07), .b(x00), .O(new_n54_));
  inv1   g30(.a(x10), .O(new_n55_));
  inv1   g31(.a(x12), .O(new_n56_));
  nand3  g32(.a(x13), .b(new_n56_), .c(new_n55_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n54_), .c(new_n53_), .O(z5));
  nand4  g35(.a(x14), .b(x02), .c(x01), .d(new_n34_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(new_n61_));
  nor2   g37(.a(x10), .b(x07), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n48_), .c(new_n30_), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(new_n61_), .O(z6));
  aoi21  g40(.a(new_n62_), .b(x08), .c(new_n53_), .O(z7));
  nand4  g41(.a(new_n62_), .b(new_n30_), .c(new_n50_), .d(x00), .O(z8));
endmodule
