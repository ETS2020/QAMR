...
module FAU ( 
  ...
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n30_), .O(new_n63_));
  inv1   g39(.a(x14), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x00), .c(x02), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x01), .O(new_n66_));
  nand2  g42(.a(new_n54_), .b(new_n44_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n63_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(z6));
  nand3  g46(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n42_), .O(new_n72_));
  nand2  g48(.a(x03), .b(new_n30_), .O(new_n73_));
  nand2  g49(.a(new_n44_), .b(x08), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n30_), .O(z7));
  nand2  g52(.a(new_n43_), .b(x00), .O(new_n77_));
  aoi21  g53(.a(new_n30_), .b(x01), .c(new_n77_), .O(new_n78_));
  inv1   g54(.a(x12), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x09), .c(new_n42_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n73_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n78_), .c(new_n44_), .O(z8));
endmodule
