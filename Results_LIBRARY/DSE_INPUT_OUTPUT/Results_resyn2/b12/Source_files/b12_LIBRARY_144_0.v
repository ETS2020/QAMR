...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n58_, new_n60_, new_n61_, new_n62_, new_n65_;
  ...
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n43_), .d(new_n35_), .O(new_n58_));
  and2   g34(.a(new_n58_), .b(new_n40_), .O(z5));
  nor2   g35(.a(x10), .b(x07), .O(new_n60_));
  nand4  g36(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n60_), .c(new_n52_), .d(new_n40_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(z6));
  nand3  g39(.a(new_n60_), .b(new_n40_), .c(x08), .O(z7));
  nor2   g40(.a(x09), .b(new_n35_), .O(new_n65_));
  aoi22  g41(.a(new_n65_), .b(new_n60_), .c(new_n25_), .d(new_n39_), .O(z8));
endmodule
