...
module FAU ( 
  ...
  nand4  g22(.a(x07), .b(new_n39_), .c(new_n28_), .d(new_n33_), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(new_n46_), .c(new_n35_), .O(z2));
  ...
  oai21  g29(.a(new_n53_), .b(x07), .c(x10), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(x09), .c(x11), .d(x07), .O(z4));
  inv1   g31(.a(x12), .O(new_n56_));
  nor2   g32(.a(x10), .b(x09), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(x13), .d(new_n56_), .O(z5));
  ...
  aoi21  g40(.a(new_n64_), .b(new_n60_), .c(x10), .O(z6));
  ...
  nand3  g46(.a(new_n57_), .b(new_n70_), .c(x00), .O(z8));
endmodule
