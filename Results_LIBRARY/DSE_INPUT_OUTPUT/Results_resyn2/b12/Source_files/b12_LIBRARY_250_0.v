...
module FAU ( 
  ...
  nor2   g07(.a(x11), .b(x05), .O(new_n32_));
  ...
  aoi22  g31(.a(new_n55_), .b(new_n33_), .c(x11), .d(x07), .O(z3));
  ...
  nand2  g36(.a(new_n60_), .b(new_n33_), .O(new_n61_));
  aoi21  g37(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(z4));
  nor3   g38(.a(new_n32_), .b(x07), .c(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n54_), .d(new_n47_), .O(z5));
  ...
  nor2   g46(.a(x10), .b(x07), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n57_), .c(new_n71_), .d(new_n33_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(new_n70_), .O(z6));
  nand3  g50(.a(x03), .b(new_n35_), .c(new_n44_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x08), .O(new_n76_));
  nand3  g52(.a(new_n65_), .b(new_n46_), .c(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n71_), .c(new_n32_), .O(z7));
  oai21  g55(.a(new_n75_), .b(x12), .c(x09), .O(new_n80_));
  inv1   g56(.a(new_n71_), .O(new_n81_));
  aoi21  g57(.a(new_n46_), .b(new_n25_), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n80_), .c(new_n32_), .O(z8));
endmodule
