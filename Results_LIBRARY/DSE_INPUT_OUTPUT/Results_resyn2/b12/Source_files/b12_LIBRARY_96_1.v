...
module FAU ( 
  ...
  nand3  g23(.a(x07), .b(new_n37_), .c(new_n27_), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g25(.a(x08), .b(x00), .O(new_n50_));
  nand4  g26(.a(new_n50_), .b(new_n49_), .c(new_n26_), .d(new_n45_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n44_), .O(z2));
  inv1   g28(.a(x12), .O(new_n53_));
  nand2  g29(.a(x11), .b(x07), .O(new_n54_));
  oai21  g30(.a(new_n53_), .b(x00), .c(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n26_), .b(x02), .c(new_n55_), .O(z3));
  inv1   g32(.a(new_n47_), .O(new_n57_));
  inv1   g33(.a(new_n50_), .O(new_n58_));
  oai21  g34(.a(new_n26_), .b(x02), .c(new_n54_), .O(new_n59_));
  aoi21  g35(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z4));
  nor2   g36(.a(x10), .b(x07), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n53_), .d(new_n27_), .O(z5));
  nand3  g38(.a(x14), .b(x01), .c(new_n27_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n26_), .c(new_n25_), .O(new_n64_));
  ...
  aoi21  g45(.a(x08), .b(x00), .c(x07), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n26_), .c(new_n64_), .O(z6));
  inv1   g48(.a(x08), .O(new_n73_));
  nand2  g49(.a(new_n67_), .b(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g51(.a(new_n67_), .b(x09), .c(x03), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n61_), .O(z7));
  nand3  g53(.a(new_n53_), .b(x03), .c(new_n45_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n47_), .c(new_n26_), .O(new_n79_));
  nor2   g55(.a(x09), .b(new_n27_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n61_), .c(new_n79_), .d(new_n25_), .O(z8));
endmodule
