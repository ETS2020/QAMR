...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(new_n26_), .O(new_n33_));
  ...
  aoi21  g30(.a(new_n32_), .b(new_n26_), .c(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n53_), .b(x00), .c(new_n55_), .O(new_n56_));
  ...
  nand4  g37(.a(x13), .b(new_n53_), .c(new_n58_), .d(new_n25_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x05), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n32_), .O(z5));
  nand2  g40(.a(x09), .b(new_n35_), .O(new_n65_));
  nor2   g41(.a(x02), .b(x01), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  aoi21  g43(.a(new_n45_), .b(x03), .c(new_n67_), .O(new_n68_));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n46_), .d(x05), .O(new_n71_));
  aoi21  g47(.a(new_n68_), .b(new_n65_), .c(new_n71_), .O(z6));
  nand3  g48(.a(new_n66_), .b(x09), .c(x03), .O(new_n73_));
  inv1   g49(.a(x08), .O(new_n74_));
  nand3  g50(.a(x03), .b(new_n40_), .c(new_n39_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n73_), .c(new_n58_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x05), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n32_), .O(z7));
  nand3  g55(.a(new_n66_), .b(new_n53_), .c(x03), .O(new_n80_));
  oai21  g56(.a(x09), .b(x00), .c(new_n58_), .O(new_n81_));
  aoi21  g57(.a(new_n80_), .b(x09), .c(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n26_), .c(new_n32_), .O(z8));
endmodule
