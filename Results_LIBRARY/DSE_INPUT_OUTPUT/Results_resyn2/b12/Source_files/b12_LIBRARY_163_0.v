...
module FAU ( 
  ...
  aoi21  g18(.a(x02), .b(new_n34_), .c(new_n42_), .O(new_n43_));
  ...
  nand2  g23(.a(new_n47_), .b(new_n30_), .O(z3));
  ...
  nand2  g27(.a(new_n51_), .b(new_n30_), .O(z4));
  ...
  aoi21  g34(.a(new_n58_), .b(new_n57_), .c(new_n29_), .O(new_n59_));
  nand3  g35(.a(x14), .b(x02), .c(new_n34_), .O(new_n60_));
  ...
  nand3  g39(.a(new_n61_), .b(new_n30_), .c(x08), .O(z7));
  nor2   g40(.a(x09), .b(new_n34_), .O(new_n65_));
