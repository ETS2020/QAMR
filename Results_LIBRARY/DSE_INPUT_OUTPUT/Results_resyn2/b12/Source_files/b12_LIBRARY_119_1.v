...
module FAU ( 
  ...
  nand4  g27(.a(new_n51_), .b(new_n48_), .c(new_n47_), .d(new_n32_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n26_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n25_), .O(new_n54_));
  nor2   g30(.a(x08), .b(new_n25_), .O(new_n55_));
  oai21  g31(.a(new_n34_), .b(new_n47_), .c(new_n25_), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(new_n27_), .c(new_n55_), .d(new_n47_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n54_), .O(z2));
  inv1   g34(.a(x12), .O(new_n59_));
  aoi21  g35(.a(x11), .b(x07), .c(new_n44_), .O(new_n60_));
  oai21  g36(.a(new_n59_), .b(x00), .c(new_n60_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z3));
  nand3  g38(.a(x09), .b(new_n47_), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x02), .O(new_n64_));
  aoi22  g40(.a(new_n64_), .b(x08), .c(x11), .d(x07), .O(z4));
  nand3  g41(.a(x13), .b(new_n59_), .c(new_n50_), .O(new_n66_));
  nor3   g42(.a(new_n66_), .b(x07), .c(x00), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n44_), .O(z5));
  nand2  g44(.a(x09), .b(new_n33_), .O(new_n69_));
  nand2  g45(.a(new_n49_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n32_), .O(new_n71_));
  nand3  g47(.a(x14), .b(x01), .c(new_n27_), .O(new_n72_));
  aoi21  g48(.a(x08), .b(x00), .c(new_n25_), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n50_), .b(new_n47_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(z6));
  nand2  g52(.a(new_n26_), .b(new_n32_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n70_), .c(new_n25_), .O(new_n78_));
  nor2   g54(.a(new_n75_), .b(new_n55_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(z7));
  nand4  g56(.a(new_n59_), .b(x09), .c(x03), .d(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n49_), .b(x00), .O(new_n82_));
  oai22  g58(.a(new_n82_), .b(new_n44_), .c(new_n81_), .d(new_n77_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n50_), .c(new_n47_), .O(z8));
endmodule
