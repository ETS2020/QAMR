...
module FAU ( 
  ...
  nor2   g09(.a(x06), .b(new_n29_), .O(new_n34_));
  inv1   g10(.a(new_n34_), .O(new_n35_));
  oai21  g11(.a(new_n33_), .b(x00), .c(new_n35_), .O(z0));
  nand2  g12(.a(x05), .b(x02), .O(new_n37_));
  aoi21  g13(.a(new_n37_), .b(x06), .c(new_n29_), .O(new_n38_));
  inv1   g14(.a(x00), .O(new_n39_));
  nor2   g15(.a(x02), .b(x01), .O(new_n40_));
  oai21  g16(.a(new_n40_), .b(new_n31_), .c(new_n28_), .O(new_n41_));
  nand2  g17(.a(new_n41_), .b(new_n39_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n38_), .O(z1));
  ...
  nand2  g23(.a(x06), .b(x02), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(x01), .O(new_n49_));
  oai21  g25(.a(x08), .b(x07), .c(x00), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  aoi21  g27(.a(new_n47_), .b(new_n45_), .c(new_n51_), .O(z2));
  ...
  nand4  g33(.a(x09), .b(x08), .c(new_n57_), .d(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n53_), .c(new_n35_), .O(z4));
  nor2   g36(.a(x12), .b(x10), .O(new_n61_));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n61_), .c(new_n35_), .d(x13), .O(z5));
  nand2  g39(.a(x08), .b(x00), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n31_), .O(new_n65_));
  inv1   g41(.a(x09), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x03), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n40_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n39_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n64_), .d(new_n44_), .O(new_n70_));
  ...
  nand3  g49(.a(new_n40_), .b(new_n66_), .c(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n44_), .c(new_n34_), .O(z7));
  nand2  g52(.a(new_n54_), .b(x09), .O(new_n77_));
  oai22  g53(.a(new_n77_), .b(new_n72_), .c(x09), .d(new_n39_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n44_), .c(new_n34_), .O(z8));
endmodule
