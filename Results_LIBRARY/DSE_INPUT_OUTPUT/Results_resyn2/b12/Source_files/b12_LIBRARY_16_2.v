...
module FAU ( 
  ...
  nand2  g27(.a(new_n51_), .b(new_n42_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n35_), .O(z2));
  nand2  g29(.a(x12), .b(new_n37_), .O(new_n54_));
  nand2  g30(.a(x11), .b(x07), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n54_), .c(new_n35_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(z3));
  nor2   g33(.a(x07), .b(x06), .O(new_n58_));
  nand2  g34(.a(x08), .b(x00), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n46_), .c(new_n45_), .O(new_n60_));
  oai21  g36(.a(new_n58_), .b(x11), .c(new_n60_), .O(z4));
  nor2   g37(.a(x12), .b(x10), .O(new_n62_));
  nor2   g38(.a(x07), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n35_), .d(x13), .O(z5));
  xnor2a g40(.a(x09), .b(x03), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n37_), .O(new_n67_));
  nand3  g42(.a(new_n65_), .b(new_n43_), .c(new_n44_), .O(new_n70_));
  nand2  g43(.a(new_n47_), .b(new_n45_), .O(new_n71_));
  nor2   g44(.a(new_n71_), .b(new_n34_), .O(new_n72_));
  nand4  g45(.a(new_n72_), .b(new_n70_), .c(new_n67_), .d(new_n59_), .O(new_n73_));
  inv1   g46(.a(new_n73_), .O(z6));
  nand3  g47(.a(new_n30_), .b(x09), .c(x03), .O(new_n75_));
  inv1   g48(.a(x08), .O(new_n76_));
  nand2  g49(.a(new_n30_), .b(x03), .O(new_n77_));
  aoi21  g50(.a(new_n77_), .b(new_n76_), .c(new_n71_), .O(new_n78_));
  aoi21  g51(.a(new_n78_), .b(new_n75_), .c(new_n34_), .O(z7));
  oai21  g52(.a(new_n77_), .b(x12), .c(x09), .O(new_n80_));
  nand2  g53(.a(new_n46_), .b(new_n37_), .O(new_n81_));
  nand3  g54(.a(new_n81_), .b(new_n80_), .c(new_n72_), .O(z8));
endmodule
