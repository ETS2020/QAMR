...
module FAU ( 
  ...
  inv1   g35(.a(x13), .O(new_n60_));
  nor2   g36(.a(new_n60_), .b(x12), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n30_), .c(new_n36_), .d(new_n46_), .O(z5));
  nand3  g38(.a(x14), .b(x01), .c(new_n26_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n55_), .c(new_n46_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x02), .c(x10), .O(z6));
  oai21  g41(.a(new_n47_), .b(x07), .c(x02), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n36_), .O(z7));
  nand3  g43(.a(new_n57_), .b(new_n46_), .c(x00), .O(new_n68_));
