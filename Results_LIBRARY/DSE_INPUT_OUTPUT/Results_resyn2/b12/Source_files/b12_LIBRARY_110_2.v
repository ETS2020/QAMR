...
module FAU ( 
  ...
  nand3  g39(.a(new_n63_), .b(new_n55_), .c(new_n38_), .O(new_n64_));
  ...
  oai21  g46(.a(new_n34_), .b(x02), .c(new_n39_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n43_), .O(z7));
  nand3  g48(.a(new_n49_), .b(new_n55_), .c(new_n38_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n68_), .c(new_n41_), .O(new_n74_));
  nand3  g50(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  aoi21  g52(.a(new_n74_), .b(new_n31_), .c(new_n76_), .O(z8));
endmodule
