...
module FAU ( 
  ...
  nand2  g03(.a(new_n27_), .b(x11), .O(new_n28_));
  ...
  nand4  g26(.a(new_n50_), .b(new_n47_), .c(x11), .d(new_n46_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n25_), .c(new_n45_), .O(z2));
  aoi21  g28(.a(new_n35_), .b(new_n25_), .c(x00), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(x12), .c(x11), .d(x07), .O(z3));
  nand2  g30(.a(x08), .b(x00), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  nor2   g32(.a(new_n48_), .b(x07), .O(new_n57_));
  oai21  g33(.a(new_n35_), .b(new_n43_), .c(new_n36_), .O(new_n58_));
  aoi21  g34(.a(new_n57_), .b(new_n56_), .c(new_n58_), .O(z4));
  inv1   g35(.a(x12), .O(new_n60_));
  nor2   g36(.a(x10), .b(x07), .O(new_n61_));
  nand4  g37(.a(new_n53_), .b(new_n61_), .c(x13), .d(new_n60_), .O(z5));
  nand2  g38(.a(new_n48_), .b(x03), .O(new_n63_));
  inv1   g39(.a(x03), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n64_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n39_), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n26_), .O(new_n67_));
  nand3  g43(.a(new_n55_), .b(new_n49_), .c(new_n43_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n36_), .O(z6));
  nand3  g47(.a(x09), .b(x03), .c(new_n46_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x11), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n25_), .O(new_n74_));
  oai21  g50(.a(new_n40_), .b(new_n64_), .c(new_n44_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n61_), .O(z7));
  nand3  g52(.a(new_n60_), .b(new_n49_), .c(new_n43_), .O(new_n77_));
  oai21  g53(.a(new_n72_), .b(new_n77_), .c(x11), .O(new_n78_));
  nand3  g54(.a(new_n61_), .b(new_n48_), .c(x00), .O(new_n79_));
