...
module FAU ( 
  ...
  nand2  g24(.a(x09), .b(new_n40_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n45_), .O(new_n50_));
  ...
  nand3  g33(.a(new_n57_), .b(new_n48_), .c(new_n30_), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(new_n56_), .O(z6));
  aoi22  g35(.a(new_n57_), .b(x08), .c(new_n29_), .d(new_n28_), .O(z7));
  inv1   g36(.a(x09), .O(new_n61_));
  nand4  g37(.a(new_n57_), .b(new_n30_), .c(new_n61_), .d(x00), .O(z8));
endmodule
