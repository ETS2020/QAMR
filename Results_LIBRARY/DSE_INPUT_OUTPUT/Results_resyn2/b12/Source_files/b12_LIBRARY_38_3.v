...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(x10), .O(new_n26_));
  ...
  aoi21  g18(.a(new_n42_), .b(new_n37_), .c(new_n27_), .O(z1));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n57_), .d(new_n25_), .O(z5));
