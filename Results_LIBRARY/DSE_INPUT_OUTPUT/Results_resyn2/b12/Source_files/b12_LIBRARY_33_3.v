...
module FAU ( 
  ...
  nor3   g20(.a(new_n44_), .b(x01), .c(new_n25_), .O(new_n45_));
  ...
  aoi21  g24(.a(x12), .b(new_n25_), .c(new_n48_), .O(z3));
  inv1   g25(.a(x08), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n25_), .O(new_n51_));
  nor2   g27(.a(new_n39_), .b(x07), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n51_), .c(new_n48_), .O(z4));
  nor2   g29(.a(x12), .b(x10), .O(new_n54_));
  nor2   g30(.a(x07), .b(x00), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(new_n54_), .c(new_n30_), .d(x13), .O(z5));
  xor2a  g32(.a(x09), .b(x03), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(new_n27_), .O(new_n58_));
  oai21  g34(.a(new_n50_), .b(new_n25_), .c(new_n40_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n58_), .c(new_n30_), .O(z6));
  nand2  g36(.a(new_n26_), .b(x03), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n50_), .O(new_n62_));
  nand3  g38(.a(new_n26_), .b(x09), .c(x03), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n40_), .d(new_n30_), .O(z7));
  inv1   g40(.a(new_n30_), .O(new_n65_));
  nand2  g41(.a(new_n39_), .b(x00), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  nand4  g43(.a(new_n26_), .b(new_n67_), .c(x09), .d(x03), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n40_), .c(new_n65_), .O(z8));
endmodule
