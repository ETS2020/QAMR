...
module FAU ( 
  ...
  nand2  g32(.a(new_n50_), .b(new_n31_), .O(new_n57_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n40_), .O(z7));
  nand2  g51(.a(new_n55_), .b(x00), .O(new_n76_));
  aoi21  g52(.a(new_n30_), .b(x01), .c(new_n76_), .O(new_n77_));
  nand3  g53(.a(new_n49_), .b(x09), .c(new_n41_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n73_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n40_), .O(z8));
endmodule
