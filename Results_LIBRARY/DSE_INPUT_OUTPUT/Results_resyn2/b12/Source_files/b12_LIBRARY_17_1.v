...
module FAU ( 
  ...
  nand2  g11(.a(x11), .b(new_n25_), .O(new_n36_));
  ...
  nor2   g25(.a(x11), .b(x01), .O(new_n50_));
  ...
  oai22  g29(.a(new_n53_), .b(x00), .c(new_n26_), .d(new_n43_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n36_), .O(z3));
  aoi21  g31(.a(new_n43_), .b(x02), .c(new_n26_), .O(new_n56_));
  ...
  nand3  g37(.a(new_n53_), .b(new_n61_), .c(new_n43_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n36_), .c(x13), .d(new_n27_), .O(z5));
  nand2  g40(.a(new_n47_), .b(x03), .O(new_n65_));
  inv1   g41(.a(x03), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n39_), .O(new_n68_));
  nand4  g44(.a(x14), .b(x02), .c(x01), .d(new_n27_), .O(new_n69_));
  nand3  g45(.a(new_n57_), .b(new_n61_), .c(new_n43_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n36_), .O(z6));
  inv1   g49(.a(x01), .O(new_n74_));
  nand3  g50(.a(x09), .b(x03), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n26_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n39_), .b(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n44_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n48_), .O(z7));
  oai21  g56(.a(new_n75_), .b(new_n62_), .c(new_n26_), .O(new_n81_));
  nand3  g57(.a(new_n48_), .b(new_n47_), .c(x00), .O(new_n82_));
