...
module FAU ( 
  ...
  nor3   g19(.a(new_n43_), .b(x01), .c(new_n30_), .O(new_n44_));
  aoi21  g20(.a(new_n42_), .b(new_n25_), .c(new_n44_), .O(z2));
  nand2  g21(.a(x11), .b(x07), .O(new_n46_));
  nand2  g22(.a(x02), .b(x01), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  aoi21  g24(.a(x12), .b(new_n30_), .c(new_n48_), .O(z3));
  ...
  nand4  g31(.a(new_n55_), .b(new_n54_), .c(new_n47_), .d(x13), .O(z5));
  nor2   g32(.a(x02), .b(x01), .O(new_n57_));
  xnor2a g33(.a(x09), .b(x03), .O(new_n58_));
  nand3  g34(.a(new_n50_), .b(new_n47_), .c(new_n39_), .O(new_n59_));
  ...
  nand3  g39(.a(new_n57_), .b(x09), .c(x03), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n47_), .d(new_n39_), .O(z7));
  inv1   g41(.a(new_n47_), .O(new_n66_));
  nand2  g42(.a(new_n38_), .b(x00), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(new_n57_), .b(new_n68_), .c(x09), .d(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n39_), .c(new_n66_), .O(z8));
endmodule
