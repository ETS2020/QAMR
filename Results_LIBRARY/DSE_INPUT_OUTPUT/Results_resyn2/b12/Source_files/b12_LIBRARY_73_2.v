...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(x02), .O(new_n26_));
  ...
  aoi22  g28(.a(new_n52_), .b(new_n49_), .c(new_n46_), .d(new_n34_), .O(z2));
  nor2   g29(.a(x12), .b(new_n34_), .O(new_n54_));
  nand2  g30(.a(x11), .b(x07), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  aoi21  g32(.a(x12), .b(new_n50_), .c(new_n56_), .O(z3));
  nor2   g33(.a(new_n48_), .b(new_n50_), .O(new_n58_));
  nand2  g34(.a(x09), .b(new_n47_), .O(new_n59_));
  nor2   g35(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(z4));
  nor2   g37(.a(x02), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n43_), .c(x13), .d(new_n51_), .O(z5));
  nand3  g39(.a(x14), .b(x01), .c(new_n50_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n37_), .O(new_n66_));
  nand2  g42(.a(new_n42_), .b(x03), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n34_), .O(new_n69_));
  oai21  g45(.a(new_n48_), .b(new_n50_), .c(new_n43_), .O(new_n70_));
  aoi21  g46(.a(new_n69_), .b(new_n65_), .c(new_n70_), .O(z6));
  nand2  g47(.a(x03), .b(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n48_), .O(new_n73_));
  oai21  g49(.a(new_n51_), .b(new_n48_), .c(x02), .O(new_n74_));
  nand4  g50(.a(x09), .b(x03), .c(new_n34_), .d(new_n25_), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n43_), .O(z7));
  nand2  g52(.a(new_n43_), .b(x09), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n72_), .c(new_n34_), .O(new_n78_));
  nand3  g54(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n78_), .b(new_n51_), .c(new_n80_), .O(z8));
endmodule
