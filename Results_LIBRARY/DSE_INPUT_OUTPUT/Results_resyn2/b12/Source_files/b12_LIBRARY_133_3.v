...
module FAU ( 
  ...
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n36_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n53_), .c(new_n40_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(z6));
  inv1   g42(.a(x08), .O(new_n67_));
  oai21  g43(.a(new_n34_), .b(x02), .c(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n67_), .b(x02), .c(x01), .O(new_n69_));
  nand3  g45(.a(new_n36_), .b(x09), .c(x03), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n40_), .O(z7));
  nand3  g47(.a(new_n25_), .b(new_n55_), .c(x00), .O(new_n72_));
  oai21  g48(.a(new_n70_), .b(x12), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n40_), .O(z8));
endmodule
