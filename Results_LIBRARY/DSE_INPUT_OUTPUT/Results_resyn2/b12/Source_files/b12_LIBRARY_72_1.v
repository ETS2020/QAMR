...
module FAU ( 
  ...
  aoi21  g14(.a(new_n38_), .b(new_n37_), .c(x00), .O(new_n39_));
  nand4  g15(.a(x06), .b(x05), .c(x02), .d(x01), .O(new_n40_));
  inv1   g16(.a(x01), .O(new_n41_));
  oai21  g17(.a(x09), .b(new_n41_), .c(new_n25_), .O(new_n42_));
  nand3  g18(.a(new_n42_), .b(new_n40_), .c(new_n39_), .O(new_n43_));
  ...
  oai21  g32(.a(x09), .b(new_n45_), .c(new_n25_), .O(new_n57_));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  nand2  g34(.a(x09), .b(new_n45_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n58_), .c(new_n54_), .O(new_n60_));
  ...
  nand2  g40(.a(new_n37_), .b(new_n41_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n26_), .c(x02), .O(new_n66_));
  nor2   g42(.a(x10), .b(x07), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n27_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n58_), .c(new_n67_), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(new_n66_), .O(z6));
  nand4  g46(.a(new_n48_), .b(new_n45_), .c(x03), .d(new_n41_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n26_), .O(new_n72_));
  nand2  g48(.a(new_n67_), .b(x08), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n25_), .c(new_n74_), .O(z7));
  nor2   g51(.a(x09), .b(new_n27_), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n67_), .c(x09), .d(new_n25_), .O(z8));
endmodule
