...
module FAU ( 
  ...
  nand2  g23(.a(x12), .b(new_n35_), .O(new_n48_));
  nand2  g24(.a(x11), .b(x07), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n48_), .c(new_n40_), .O(new_n50_));
  inv1   g26(.a(new_n50_), .O(z3));
  nand2  g27(.a(new_n49_), .b(new_n40_), .O(new_n52_));
  ...
  aoi21  g32(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z4));
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n63_), .O(z6));
  nand3  g43(.a(new_n65_), .b(new_n40_), .c(x08), .O(z7));
  nor2   g44(.a(x09), .b(new_n35_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n65_), .c(new_n39_), .O(z8));
endmodule
