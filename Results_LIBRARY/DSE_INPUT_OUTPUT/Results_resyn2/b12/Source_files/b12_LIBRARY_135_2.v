...
module FAU ( 
  ...
  aoi21  g34(.a(new_n58_), .b(x02), .c(new_n41_), .O(new_n59_));
  ...
  oai21  g43(.a(new_n42_), .b(new_n34_), .c(new_n41_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n31_), .O(new_n69_));
  nand2  g45(.a(x03), .b(new_n31_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n39_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n43_), .O(z7));
  nand2  g48(.a(new_n42_), .b(x00), .O(new_n73_));
  aoi21  g49(.a(new_n31_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n49_), .b(x09), .c(new_n41_), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(new_n70_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n74_), .c(new_n43_), .O(z8));
endmodule
