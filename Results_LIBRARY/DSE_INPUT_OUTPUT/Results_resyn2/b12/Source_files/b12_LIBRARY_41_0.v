...
module FAU ( 
  ...
  nand2  g28(.a(new_n46_), .b(new_n31_), .O(new_n53_));
  ...
  aoi22  g37(.a(new_n61_), .b(new_n27_), .c(new_n59_), .d(new_n31_), .O(z6));
  inv1   g38(.a(new_n31_), .O(new_n63_));
  aoi21  g39(.a(new_n58_), .b(x08), .c(new_n63_), .O(z7));
  nor2   g40(.a(x09), .b(new_n35_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n58_), .c(new_n63_), .O(z8));
endmodule
