...
module FAU ( 
  ...
  nand2  g17(.a(new_n41_), .b(z5), .O(z1));
  ...
  nand3  g26(.a(new_n50_), .b(new_n46_), .c(new_n43_), .O(new_n51_));
  oai21  g27(.a(x08), .b(x07), .c(x00), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(z5), .O(new_n53_));
  aoi21  g29(.a(new_n51_), .b(new_n35_), .c(new_n53_), .O(z2));
  inv1   g30(.a(x11), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n47_), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(z5), .c(x12), .d(new_n25_), .O(z3));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  nor2   g35(.a(new_n44_), .b(x07), .O(new_n60_));
  oai21  g36(.a(new_n55_), .b(new_n47_), .c(z5), .O(new_n61_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n58_), .c(new_n45_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n65_), .c(z5), .O(z6));
  inv1   g44(.a(x08), .O(new_n69_));
  nand3  g45(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  and2   g47(.a(x09), .b(x03), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n63_), .c(new_n49_), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n71_), .c(x13), .d(new_n32_), .O(z7));
  nand3  g50(.a(new_n72_), .b(new_n63_), .c(new_n32_), .O(new_n75_));
  oai21  g51(.a(x09), .b(new_n25_), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n45_), .c(z5), .O(z8));
endmodule
