...
module FAU ( 
  ...
  oai21  g14(.a(x10), .b(x07), .c(new_n34_), .O(new_n39_));
  nor2   g15(.a(x10), .b(x07), .O(new_n40_));
  inv1   g16(.a(x01), .O(new_n41_));
  nand2  g17(.a(new_n30_), .b(new_n41_), .O(new_n42_));
  aoi21  g18(.a(new_n40_), .b(x09), .c(new_n42_), .O(new_n43_));
  inv1   g19(.a(x07), .O(new_n44_));
  inv1   g20(.a(x08), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  aoi21  g22(.a(new_n30_), .b(x01), .c(new_n25_), .O(new_n47_));
  aoi22  g23(.a(new_n47_), .b(new_n46_), .c(new_n43_), .d(new_n39_), .O(z2));
  ...
  oai21  g45(.a(new_n69_), .b(new_n34_), .c(new_n41_), .O(new_n70_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n40_), .O(z7));
  nand2  g50(.a(new_n69_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n30_), .b(x01), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n50_), .b(x09), .c(new_n41_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n72_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n40_), .O(z8));
endmodule
