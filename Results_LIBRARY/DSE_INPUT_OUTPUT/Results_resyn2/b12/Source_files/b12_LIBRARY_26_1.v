...
module FAU ( 
  ...
  nand2  g42(.a(new_n56_), .b(x03), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n31_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n28_), .O(new_n69_));
  oai21  g45(.a(new_n42_), .b(new_n35_), .c(new_n45_), .O(new_n70_));
  aoi21  g46(.a(new_n69_), .b(new_n65_), .c(new_n70_), .O(z6));
  nand3  g47(.a(new_n45_), .b(new_n56_), .c(x03), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n28_), .c(x01), .O(new_n73_));
  nand2  g49(.a(new_n45_), .b(x08), .O(new_n74_));
  aoi21  g50(.a(x03), .b(new_n31_), .c(new_n74_), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(new_n73_), .O(z7));
  nand3  g52(.a(new_n52_), .b(x09), .c(new_n31_), .O(new_n77_));
  oai22  g53(.a(new_n77_), .b(new_n29_), .c(new_n43_), .d(x09), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n45_), .O(z8));
endmodule
