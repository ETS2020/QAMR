...
module FAU ( 
  ...
  aoi21  g23(.a(new_n47_), .b(x10), .c(x02), .O(new_n48_));
  nor2   g24(.a(new_n44_), .b(x00), .O(new_n49_));
  nor2   g25(.a(new_n28_), .b(x02), .O(new_n50_));
  aoi21  g26(.a(new_n49_), .b(new_n47_), .c(new_n50_), .O(new_n51_));
  oai21  g27(.a(new_n48_), .b(new_n46_), .c(new_n51_), .O(z2));
  ...
  oai21  g33(.a(x09), .b(new_n44_), .c(new_n27_), .O(new_n58_));
  ...
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n53_), .d(x13), .O(z5));
  oai21  g40(.a(x03), .b(x01), .c(new_n28_), .O(new_n65_));
  nand2  g41(.a(x08), .b(x00), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n43_), .O(new_n67_));
  nor2   g43(.a(x10), .b(x07), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(new_n69_));
  aoi21  g45(.a(new_n65_), .b(new_n27_), .c(new_n69_), .O(z6));
  nand3  g46(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n45_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n53_), .O(z7));
  nor2   g49(.a(x09), .b(new_n43_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n68_), .c(new_n50_), .O(z8));
endmodule
