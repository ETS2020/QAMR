...
module FAU ( 
  ...
  nand2  g26(.a(new_n46_), .b(x01), .O(new_n51_));
  ...
  nand2  g31(.a(new_n53_), .b(new_n51_), .O(new_n56_));
  ...
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n51_), .d(x13), .O(z5));
  nand2  g40(.a(x14), .b(new_n25_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(x02), .c(new_n43_), .O(new_n66_));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  inv1   g44(.a(x07), .O(new_n69_));
  nand3  g45(.a(new_n57_), .b(new_n47_), .c(new_n69_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n68_), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n66_), .O(z6));
  nand2  g49(.a(x09), .b(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n43_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n46_), .O(new_n76_));
  oai21  g52(.a(new_n32_), .b(x02), .c(new_n41_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n36_), .O(z7));
  inv1   g54(.a(x12), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n47_), .c(new_n69_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n74_), .c(new_n43_), .O(new_n81_));
  nand3  g57(.a(new_n36_), .b(new_n59_), .c(x00), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n46_), .c(new_n83_), .O(z8));
endmodule
