...
module FAU ( 
  ...
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n32_), .d(x13), .O(z5));
  ...
  nand2  g40(.a(new_n28_), .b(x02), .O(new_n65_));
  oai21  g41(.a(x10), .b(x07), .c(new_n32_), .O(new_n66_));
  nand3  g42(.a(x14), .b(x01), .c(new_n41_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n65_), .c(new_n66_), .O(new_n68_));
  aoi21  g44(.a(new_n64_), .b(new_n35_), .c(new_n68_), .O(z6));
  oai21  g45(.a(new_n36_), .b(x01), .c(new_n28_), .O(new_n70_));
  nand3  g46(.a(x09), .b(x03), .c(new_n43_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n45_), .d(new_n35_), .O(z7));
  nor3   g48(.a(new_n71_), .b(x12), .c(x02), .O(new_n73_));
  oai21  g49(.a(x09), .b(new_n41_), .c(new_n32_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(z8));
endmodule
