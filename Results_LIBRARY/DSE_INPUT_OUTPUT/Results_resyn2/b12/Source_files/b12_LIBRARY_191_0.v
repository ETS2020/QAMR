...
module FAU ( 
  ...
  nand2  g38(.a(new_n56_), .b(new_n41_), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(z4));
  nand3  g40(.a(x13), .b(new_n55_), .c(new_n47_), .O(new_n65_));
  nor3   g41(.a(new_n65_), .b(x07), .c(x00), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(new_n40_), .O(z5));
  ...
  oai21  g51(.a(new_n39_), .b(new_n30_), .c(new_n61_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n72_), .O(z7));
  oai22  g53(.a(new_n75_), .b(x12), .c(x09), .d(new_n29_), .O(new_n78_));
