...
module FAU ( 
  ...
  nor2   g28(.a(new_n44_), .b(new_n35_), .O(new_n53_));
  inv1   g29(.a(x09), .O(new_n54_));
  nor2   g30(.a(new_n54_), .b(x07), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(z4));
  ...
  oai21  g36(.a(new_n44_), .b(new_n35_), .c(new_n60_), .O(new_n61_));
  and2   g37(.a(x14), .b(x01), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n29_), .c(new_n61_), .d(new_n40_), .O(z6));
  aoi21  g39(.a(new_n60_), .b(x08), .c(new_n39_), .O(z7));
  nor2   g40(.a(x09), .b(new_n35_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n60_), .c(new_n39_), .O(z8));
endmodule
