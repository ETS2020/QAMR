...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n52_), .c(new_n64_), .O(new_n66_));
  ...
  nand3  g47(.a(new_n48_), .b(new_n42_), .c(new_n38_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n62_), .c(new_n28_), .O(new_n73_));
  nand3  g49(.a(new_n64_), .b(new_n41_), .c(x00), .O(new_n74_));
