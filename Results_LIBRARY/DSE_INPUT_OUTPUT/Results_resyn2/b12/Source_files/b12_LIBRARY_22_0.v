...
module FAU ( 
  ...
  aoi21  g20(.a(new_n44_), .b(x00), .c(new_n25_), .O(z2));
  inv1   g21(.a(new_n35_), .O(new_n46_));
  ...
  nand4  g26(.a(x09), .b(x08), .c(new_n42_), .d(x00), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n47_), .c(new_n46_), .O(z4));
  nor2   g29(.a(x10), .b(x07), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(new_n36_), .c(x13), .d(new_n48_), .O(z5));
  nand2  g31(.a(x08), .b(x00), .O(new_n56_));
  inv1   g32(.a(x00), .O(new_n57_));
  nand4  g33(.a(x14), .b(x02), .c(x01), .d(new_n57_), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n54_), .c(new_n56_), .d(new_n46_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z6));
  aoi21  g36(.a(new_n54_), .b(x08), .c(new_n35_), .O(z7));
  nor2   g37(.a(x09), .b(new_n57_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n54_), .c(new_n46_), .O(z8));
endmodule
