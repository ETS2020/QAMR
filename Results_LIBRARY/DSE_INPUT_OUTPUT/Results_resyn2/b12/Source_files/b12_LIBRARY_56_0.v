...
module FAU ( 
  ...
  nor2   g15(.a(x05), .b(x02), .O(new_n40_));
  inv1   g16(.a(new_n40_), .O(new_n41_));
  nand2  g17(.a(new_n41_), .b(new_n39_), .O(z1));
  inv1   g18(.a(x07), .O(new_n43_));
  inv1   g19(.a(x08), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n43_), .c(new_n33_), .O(new_n45_));
  ...
  nand4  g27(.a(new_n51_), .b(new_n48_), .c(x05), .d(new_n25_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n26_), .c(new_n45_), .O(z2));
  inv1   g29(.a(x12), .O(new_n54_));
  nand2  g30(.a(x11), .b(x07), .O(new_n55_));
  oai21  g31(.a(new_n54_), .b(x00), .c(new_n55_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n41_), .O(z3));
  nor2   g33(.a(new_n44_), .b(new_n33_), .O(new_n58_));
  nor2   g34(.a(new_n46_), .b(x07), .O(new_n59_));
  nand2  g35(.a(new_n55_), .b(new_n41_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z4));
  nand3  g37(.a(x13), .b(new_n54_), .c(new_n49_), .O(new_n62_));
  nor3   g38(.a(new_n62_), .b(x07), .c(x00), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(new_n40_), .O(z5));
  inv1   g40(.a(x03), .O(new_n65_));
  nand2  g41(.a(new_n46_), .b(new_n65_), .O(new_n66_));
  nand2  g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n26_), .b(new_n25_), .O(new_n68_));
  aoi21  g44(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(new_n69_));
  inv1   g45(.a(new_n58_), .O(new_n70_));
  nand4  g46(.a(x14), .b(x02), .c(x01), .d(new_n33_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n47_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n69_), .c(new_n41_), .O(z6));
  oai21  g49(.a(new_n67_), .b(x01), .c(x05), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n26_), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n26_), .c(new_n25_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n44_), .c(new_n50_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n75_), .O(z7));
  nand2  g54(.a(new_n46_), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n54_), .b(x09), .c(x05), .O(new_n80_));
  oai22  g56(.a(new_n80_), .b(new_n76_), .c(new_n79_), .d(new_n40_), .O(new_n81_));
