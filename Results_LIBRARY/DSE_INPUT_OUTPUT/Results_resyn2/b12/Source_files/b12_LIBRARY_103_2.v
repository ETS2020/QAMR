...
module FAU ( 
  ...
  oai21  g11(.a(new_n35_), .b(new_n25_), .c(x02), .O(new_n36_));
  ...
  nor2   g16(.a(x11), .b(new_n31_), .O(new_n41_));
  aoi21  g17(.a(new_n30_), .b(x03), .c(new_n41_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(new_n40_), .c(new_n28_), .O(z1));
  ...
  nand3  g28(.a(new_n52_), .b(new_n49_), .c(new_n29_), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(new_n31_), .c(new_n46_), .d(new_n28_), .O(z2));
  inv1   g30(.a(x12), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(x00), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(new_n26_), .c(x11), .d(x07), .O(z3));
  oai21  g33(.a(x07), .b(x02), .c(new_n25_), .O(new_n58_));
  nand2  g34(.a(x08), .b(x00), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n47_), .c(new_n44_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n58_), .O(z4));
  nor2   g37(.a(x12), .b(x10), .O(new_n62_));
  nor2   g38(.a(x07), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n26_), .d(x13), .O(z5));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  nor3   g41(.a(new_n65_), .b(x02), .c(x01), .O(new_n66_));
  inv1   g42(.a(x00), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n59_), .c(new_n48_), .O(new_n69_));
  ...
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n31_), .O(new_n74_));
  aoi21  g50(.a(new_n45_), .b(x02), .c(new_n51_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n41_), .O(z7));
  nand2  g52(.a(new_n55_), .b(new_n31_), .O(new_n77_));
  oai22  g53(.a(new_n77_), .b(new_n72_), .c(new_n27_), .d(x09), .O(new_n78_));
