...
module FAU ( 
  ...
  nand3  g36(.a(new_n58_), .b(new_n34_), .c(x08), .O(z7));
  nor2   g37(.a(x09), .b(new_n25_), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n58_), .c(new_n33_), .d(new_n32_), .O(z8));
endmodule
