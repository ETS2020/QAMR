...
module FAU ( 
  ...
  nand3  g42(.a(new_n66_), .b(new_n53_), .c(new_n65_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n64_), .c(new_n47_), .O(z6));
  nand2  g44(.a(new_n61_), .b(new_n28_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n26_), .O(new_n70_));
  oai21  g46(.a(new_n62_), .b(x01), .c(new_n39_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z7));
  nand3  g48(.a(new_n57_), .b(new_n42_), .c(new_n38_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n61_), .c(new_n28_), .O(new_n74_));
  nand3  g50(.a(new_n65_), .b(new_n41_), .c(x00), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  aoi21  g52(.a(new_n74_), .b(new_n26_), .c(new_n76_), .O(z8));
endmodule
