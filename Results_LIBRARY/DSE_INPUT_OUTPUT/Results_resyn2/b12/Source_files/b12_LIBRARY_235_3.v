...
module FAU ( 
  ...
  nor2   g07(.a(x13), .b(new_n25_), .O(new_n32_));
  ...
  nand2  g31(.a(x13), .b(x02), .O(new_n56_));
  ...
  nand3  g39(.a(new_n49_), .b(new_n63_), .c(new_n44_), .O(new_n64_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n52_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n44_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n59_), .d(new_n49_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n56_), .O(z6));
  oai21  g48(.a(new_n39_), .b(x01), .c(new_n46_), .O(new_n73_));
  oai21  g49(.a(x13), .b(new_n46_), .c(x02), .O(new_n74_));
  nand3  g50(.a(new_n52_), .b(x09), .c(x03), .O(new_n75_));
  ...
  nand4  g54(.a(new_n52_), .b(new_n63_), .c(x09), .d(x03), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n49_), .c(new_n77_), .O(z8));
endmodule
