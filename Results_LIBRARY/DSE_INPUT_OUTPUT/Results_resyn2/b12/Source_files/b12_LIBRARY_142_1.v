...
module FAU ( 
  ...
  oai21  g21(.a(x02), .b(new_n33_), .c(new_n45_), .O(new_n46_));
  aoi21  g22(.a(new_n44_), .b(new_n33_), .c(new_n46_), .O(z2));
  ...
  nand2  g27(.a(new_n49_), .b(new_n34_), .O(new_n52_));
  nand2  g28(.a(x08), .b(x00), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  nor2   g30(.a(new_n40_), .b(x07), .O(new_n55_));
  ...
  nand2  g36(.a(new_n40_), .b(new_n29_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(x01), .O(new_n62_));
  nand4  g38(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n53_), .c(new_n41_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n62_), .c(new_n34_), .O(z6));
  nand2  g41(.a(new_n60_), .b(new_n28_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n33_), .O(new_n67_));
  inv1   g43(.a(x08), .O(new_n68_));
  oai21  g44(.a(new_n29_), .b(x01), .c(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n41_), .O(z7));
  ...
  oai21  g50(.a(new_n74_), .b(new_n60_), .c(new_n28_), .O(new_n75_));
  nand3  g51(.a(new_n41_), .b(new_n40_), .c(x00), .O(new_n76_));
