...
module FAU ( 
  ...
  nand2  g06(.a(x08), .b(new_n27_), .O(new_n31_));
  nand2  g07(.a(new_n27_), .b(new_n26_), .O(new_n32_));
  nand4  g08(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(x03), .O(new_n33_));
  ...
  nand4  g14(.a(new_n38_), .b(new_n36_), .c(new_n32_), .d(new_n35_), .O(new_n39_));
  nand2  g15(.a(new_n39_), .b(new_n31_), .O(z1));
  inv1   g16(.a(x08), .O(new_n41_));
  nand4  g17(.a(new_n41_), .b(x07), .c(new_n37_), .d(new_n26_), .O(new_n42_));
  ...
  aoi21  g24(.a(new_n48_), .b(new_n45_), .c(x02), .O(new_n49_));
  inv1   g25(.a(x07), .O(new_n50_));
  nand2  g26(.a(new_n41_), .b(new_n50_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n49_), .c(new_n44_), .O(z2));
  ...
  nand3  g32(.a(x09), .b(new_n50_), .c(x00), .O(new_n57_));
  ...
  nand4  g37(.a(new_n61_), .b(new_n60_), .c(new_n31_), .d(x13), .O(z5));
  nand2  g38(.a(new_n46_), .b(x03), .O(new_n63_));
  ...
  aoi21  g46(.a(new_n66_), .b(new_n27_), .c(new_n70_), .O(z6));
  nand2  g47(.a(x08), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n41_), .b(new_n27_), .O(new_n73_));
  nand3  g49(.a(new_n46_), .b(x03), .c(new_n26_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n69_), .O(z7));
  nand3  g52(.a(new_n31_), .b(new_n46_), .c(x00), .O(new_n77_));
  inv1   g53(.a(x12), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(x09), .c(x03), .d(new_n26_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n73_), .c(new_n77_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n69_), .O(z8));
endmodule
