...
module FAU ( 
  ...
  nor2   g23(.a(new_n47_), .b(x01), .O(new_n48_));
  oai21  g24(.a(new_n46_), .b(new_n38_), .c(new_n48_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n27_), .c(new_n45_), .O(z2));
  inv1   g26(.a(x12), .O(new_n51_));
  nand2  g27(.a(x11), .b(x07), .O(new_n52_));
  oai21  g28(.a(new_n51_), .b(x00), .c(new_n52_), .O(new_n53_));
  nand2  g29(.a(new_n47_), .b(new_n27_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n53_), .O(z3));
  nand2  g31(.a(x08), .b(x00), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(new_n57_));
  nor2   g33(.a(new_n47_), .b(x07), .O(new_n58_));
  nand2  g34(.a(new_n54_), .b(new_n52_), .O(new_n59_));
  aoi21  g35(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z4));
  nor2   g36(.a(x12), .b(x10), .O(new_n61_));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n61_), .c(new_n54_), .d(x13), .O(z5));
  nand2  g39(.a(x03), .b(new_n31_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x09), .c(x02), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n42_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n56_), .c(new_n46_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n65_), .O(z6));
  nand3  g44(.a(x03), .b(new_n27_), .c(new_n31_), .O(new_n69_));
  nand2  g45(.a(new_n46_), .b(x08), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  aoi22  g47(.a(new_n71_), .b(new_n69_), .c(new_n47_), .d(new_n27_), .O(z7));
  nand3  g48(.a(new_n47_), .b(x02), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n51_), .b(x09), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n69_), .c(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n46_), .O(z8));
endmodule
