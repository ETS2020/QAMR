...
module FAU ( 
  ...
  nand3  g19(.a(new_n43_), .b(new_n42_), .c(new_n38_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n41_), .c(x02), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(new_n40_), .c(new_n32_), .O(z2));
