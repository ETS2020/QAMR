...
module FAU ( 
  ...
  nor2   g07(.a(x14), .b(x11), .O(new_n32_));
  ...
  aoi21  g38(.a(new_n60_), .b(new_n59_), .c(new_n62_), .O(z4));
  nor3   g39(.a(new_n32_), .b(x07), .c(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n55_), .d(new_n48_), .O(z5));
  nor2   g41(.a(x10), .b(x07), .O(new_n66_));
  nor2   g42(.a(x02), .b(x01), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n39_), .O(new_n68_));
  nand2  g44(.a(new_n47_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(new_n70_));
  nand3  g46(.a(new_n35_), .b(x14), .c(new_n25_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n58_), .d(new_n66_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n33_), .O(z6));
  nand2  g49(.a(new_n67_), .b(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x08), .O(new_n75_));
  nand3  g51(.a(new_n67_), .b(new_n47_), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n66_), .c(new_n32_), .O(z7));
  oai21  g54(.a(new_n74_), .b(x12), .c(x09), .O(new_n79_));
  nand2  g55(.a(new_n47_), .b(new_n25_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n66_), .d(new_n33_), .O(z8));
endmodule
