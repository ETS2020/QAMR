...
module FAU ( 
  ...
  nand3  g19(.a(new_n43_), .b(new_n42_), .c(new_n27_), .O(new_n44_));
  inv1   g20(.a(x08), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(new_n39_), .O(new_n46_));
  inv1   g22(.a(x00), .O(new_n47_));
  aoi21  g23(.a(x02), .b(new_n27_), .c(new_n47_), .O(new_n48_));
  aoi22  g24(.a(new_n48_), .b(new_n46_), .c(new_n44_), .d(new_n29_), .O(z2));
  ...
  nand2  g31(.a(x09), .b(new_n39_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n55_), .c(new_n52_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n50_), .O(z4));
  nor2   g34(.a(x12), .b(x10), .O(new_n59_));
  nor2   g35(.a(x07), .b(x00), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n59_), .c(new_n50_), .d(x13), .O(z5));
  nand2  g37(.a(x09), .b(x03), .O(new_n62_));
  nand2  g38(.a(new_n40_), .b(new_n30_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(x01), .O(new_n64_));
  nor2   g40(.a(x10), .b(x07), .O(new_n65_));
  nand4  g41(.a(x14), .b(x02), .c(x01), .d(new_n47_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n55_), .c(new_n65_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n64_), .c(new_n50_), .O(z6));
  nand2  g44(.a(new_n62_), .b(new_n29_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n27_), .O(new_n70_));
  oai21  g46(.a(new_n30_), .b(x01), .c(new_n45_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z7));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n41_), .c(new_n39_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n62_), .c(new_n29_), .O(new_n75_));
  nand3  g51(.a(new_n65_), .b(new_n40_), .c(x00), .O(new_n76_));
