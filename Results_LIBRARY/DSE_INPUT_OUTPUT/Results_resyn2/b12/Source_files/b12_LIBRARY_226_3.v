...
module FAU ( 
  ...
  inv1   g23(.a(new_n25_), .O(new_n48_));
  inv1   g24(.a(x12), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(x00), .O(new_n50_));
  and2   g26(.a(x11), .b(x07), .O(new_n51_));
  nor3   g27(.a(new_n51_), .b(new_n50_), .c(new_n48_), .O(z3));
  nand4  g28(.a(x09), .b(x08), .c(new_n43_), .d(x00), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n51_), .c(new_n25_), .O(z4));
  nor2   g31(.a(x12), .b(x10), .O(new_n56_));
  nor2   g32(.a(x07), .b(x00), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n25_), .d(x13), .O(z5));
  xor2a  g34(.a(x09), .b(x03), .O(new_n59_));
  nor2   g35(.a(new_n59_), .b(new_n34_), .O(new_n60_));
  oai21  g36(.a(new_n44_), .b(new_n28_), .c(new_n39_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n25_), .O(z6));
  nand2  g38(.a(new_n33_), .b(x03), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  nand3  g40(.a(new_n33_), .b(x09), .c(x03), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n39_), .d(new_n25_), .O(z7));
  nand2  g42(.a(new_n38_), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n33_), .b(new_n49_), .c(x09), .d(x03), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n39_), .c(new_n48_), .O(z8));
endmodule
