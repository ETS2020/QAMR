...
module FAU ( 
  ...
  nand2  g11(.a(x07), .b(new_n32_), .O(new_n36_));
  ...
  oai21  g19(.a(new_n38_), .b(x03), .c(new_n43_), .O(new_n44_));
  oai21  g20(.a(new_n42_), .b(new_n25_), .c(new_n44_), .O(new_n45_));
  inv1   g21(.a(x01), .O(new_n46_));
  nor2   g22(.a(x02), .b(new_n46_), .O(new_n47_));
  inv1   g23(.a(x09), .O(new_n48_));
  nor2   g24(.a(x10), .b(new_n48_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n42_), .c(new_n47_), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(new_n45_), .c(new_n41_), .O(z2));
  nand2  g27(.a(new_n43_), .b(x01), .O(new_n52_));
  ...
  nor2   g32(.a(new_n48_), .b(x07), .O(new_n57_));
  nand2  g33(.a(new_n54_), .b(new_n52_), .O(new_n58_));
  nand2  g34(.a(x08), .b(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n57_), .c(new_n58_), .O(z4));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  inv1   g38(.a(x12), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n63_), .c(new_n38_), .O(new_n64_));
  inv1   g40(.a(new_n64_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n62_), .c(new_n47_), .O(z5));
  nand2  g42(.a(new_n48_), .b(x03), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n32_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n43_), .O(new_n69_));
  inv1   g45(.a(x14), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x00), .c(x02), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x01), .O(new_n72_));
  nor2   g48(.a(x10), .b(x07), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n69_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  nand3  g53(.a(new_n73_), .b(new_n48_), .c(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n46_), .O(new_n79_));
  nand2  g55(.a(x03), .b(new_n43_), .O(new_n80_));
  nand2  g56(.a(new_n73_), .b(x08), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(new_n82_));
  aoi22  g58(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n43_), .O(z7));
  nand2  g59(.a(new_n48_), .b(x00), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  nand3  g61(.a(new_n63_), .b(x09), .c(new_n46_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(new_n80_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n85_), .c(new_n73_), .O(z8));
endmodule
