...
module FAU ( 
  ...
  nand2  g18(.a(x02), .b(new_n34_), .O(new_n43_));
  nand3  g19(.a(new_n43_), .b(new_n42_), .c(new_n30_), .O(z2));
  ...
  nand2  g24(.a(new_n46_), .b(new_n30_), .O(new_n49_));
  ...
  inv1   g30(.a(new_n30_), .O(new_n55_));
  nor3   g31(.a(x10), .b(x07), .c(x00), .O(new_n56_));
  inv1   g32(.a(x13), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(x12), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(z5));
  inv1   g35(.a(x10), .O(new_n60_));
  nor2   g36(.a(x07), .b(x00), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(new_n29_), .O(new_n62_));
  nand3  g38(.a(x14), .b(x02), .c(new_n34_), .O(new_n63_));
  nor2   g39(.a(x10), .b(x07), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n50_), .O(new_n65_));
  oai21  g41(.a(new_n62_), .b(x01), .c(new_n65_), .O(z6));
  aoi21  g42(.a(new_n64_), .b(x08), .c(new_n55_), .O(z7));
  nand4  g43(.a(new_n64_), .b(new_n30_), .c(new_n52_), .d(x00), .O(z8));
endmodule
