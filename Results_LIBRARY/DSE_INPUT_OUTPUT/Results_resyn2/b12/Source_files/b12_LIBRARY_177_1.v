...
module FAU ( 
  ...
  nand2  g28(.a(new_n50_), .b(new_n48_), .O(new_n53_));
  ...
  nand3  g41(.a(new_n54_), .b(new_n65_), .c(new_n43_), .O(new_n66_));
  ...
  nand2  g47(.a(new_n71_), .b(new_n37_), .O(new_n72_));
  oai21  g48(.a(new_n33_), .b(x01), .c(new_n44_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n39_), .O(z7));
  inv1   g50(.a(x12), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n65_), .c(new_n43_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n70_), .c(new_n27_), .O(new_n77_));
  nand3  g53(.a(new_n39_), .b(new_n38_), .c(x00), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n77_), .b(new_n37_), .c(new_n79_), .O(z8));
endmodule
