...
module FAU ( 
  ...
  nor2   g11(.a(x13), .b(new_n26_), .O(new_n36_));
  inv1   g12(.a(new_n36_), .O(new_n37_));
  nand4  g13(.a(new_n37_), .b(new_n35_), .c(new_n33_), .d(new_n29_), .O(new_n38_));
  nor2   g14(.a(new_n38_), .b(new_n28_), .O(z0));
  nand3  g15(.a(x06), .b(x02), .c(x01), .O(new_n40_));
  aoi21  g16(.a(new_n40_), .b(x13), .c(new_n26_), .O(new_n41_));
  ...
  nand3  g23(.a(new_n46_), .b(x09), .c(new_n45_), .O(new_n48_));
  inv1   g24(.a(new_n48_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n47_), .c(new_n30_), .O(new_n50_));
  ...
  nand2  g32(.a(new_n56_), .b(new_n37_), .O(z3));
  ...
  nand2  g37(.a(new_n55_), .b(new_n37_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n59_), .c(new_n62_), .O(z4));
  nand3  g39(.a(x13), .b(new_n54_), .c(new_n46_), .O(new_n64_));
  nor3   g40(.a(new_n64_), .b(x07), .c(x00), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(new_n36_), .O(z5));
  ...
  nand2  g46(.a(new_n46_), .b(new_n45_), .O(new_n74_));
  nor2   g47(.a(new_n74_), .b(new_n36_), .O(new_n75_));
  nand4  g48(.a(new_n75_), .b(new_n73_), .c(new_n70_), .d(new_n67_), .O(new_n76_));
  inv1   g49(.a(new_n76_), .O(z6));
  nand3  g50(.a(new_n34_), .b(x09), .c(x03), .O(new_n78_));
  oai21  g51(.a(new_n35_), .b(new_n32_), .c(new_n60_), .O(new_n79_));
  nand3  g52(.a(new_n79_), .b(new_n78_), .c(new_n75_), .O(z7));
  oai22  g53(.a(new_n78_), .b(x12), .c(x09), .d(new_n29_), .O(new_n81_));
  nand2  g54(.a(new_n81_), .b(new_n75_), .O(z8));
endmodule
