...
module FAU ( 
  ...
  nor2   g47(.a(x08), .b(x01), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n71_), .c(new_n51_), .d(new_n70_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n69_), .O(z7));
  nand2  g50(.a(new_n51_), .b(new_n70_), .O(new_n75_));
  nor2   g51(.a(x12), .b(x02), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(x09), .c(x03), .d(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n39_), .b(x00), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n51_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n75_), .O(z8));
endmodule
