...
module FAU ( 
  ...
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z3));
  nand4  g24(.a(x09), .b(x08), .c(new_n41_), .d(x00), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n45_), .c(new_n34_), .O(z4));
  nor2   g27(.a(x12), .b(x10), .O(new_n52_));
  nor2   g28(.a(x07), .b(x00), .O(new_n53_));
  nand4  g29(.a(new_n53_), .b(new_n52_), .c(new_n34_), .d(x13), .O(z5));
  nand4  g30(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n55_));
  ...
  nor2   g35(.a(new_n59_), .b(new_n56_), .O(z6));
  aoi22  g36(.a(new_n58_), .b(x08), .c(new_n33_), .d(new_n32_), .O(z7));
  inv1   g37(.a(x09), .O(new_n62_));
  nand4  g38(.a(new_n58_), .b(new_n34_), .c(new_n62_), .d(x00), .O(z8));
endmodule
