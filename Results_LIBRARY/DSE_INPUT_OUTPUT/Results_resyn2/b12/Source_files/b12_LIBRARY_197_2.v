...
module FAU ( 
  ...
  nand2  g31(.a(new_n49_), .b(new_n31_), .O(new_n56_));
  aoi21  g32(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(z4));
  inv1   g33(.a(x01), .O(new_n58_));
  nor2   g34(.a(x02), .b(new_n58_), .O(new_n59_));
  nor2   g35(.a(x07), .b(x00), .O(new_n60_));
  nand3  g36(.a(x13), .b(new_n48_), .c(new_n41_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z5));
  nand2  g39(.a(x09), .b(x03), .O(new_n64_));
  nand2  g40(.a(new_n54_), .b(new_n34_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(x02), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n52_), .c(new_n44_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n31_), .O(z6));
  nand2  g45(.a(new_n64_), .b(new_n58_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n30_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(x03), .b(new_n30_), .O(new_n73_));
  ...
  nor2   g52(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nand3  g53(.a(new_n48_), .b(x09), .c(new_n58_), .O(new_n78_));
