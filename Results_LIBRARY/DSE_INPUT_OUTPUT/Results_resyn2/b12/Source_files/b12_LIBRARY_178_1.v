...
module FAU ( 
  ...
  aoi21  g01(.a(x14), .b(new_n25_), .c(x00), .O(new_n26_));
  ...
  nand2  g19(.a(x14), .b(new_n25_), .O(new_n44_));
  ...
  aoi22  g30(.a(new_n26_), .b(x12), .c(x11), .d(x07), .O(z3));
  oai21  g31(.a(x14), .b(x07), .c(new_n25_), .O(new_n56_));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n47_), .c(new_n46_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n56_), .O(z4));
  nor2   g35(.a(x10), .b(x07), .O(new_n60_));
  and2   g36(.a(new_n60_), .b(new_n44_), .O(new_n61_));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(x13), .O(z5));
  xor2a  g39(.a(x09), .b(x03), .O(new_n64_));
  nor2   g40(.a(new_n64_), .b(new_n35_), .O(new_n65_));
  inv1   g41(.a(x00), .O(new_n66_));
  nand3  g42(.a(new_n31_), .b(x14), .c(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n57_), .c(new_n60_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n44_), .O(z6));
  inv1   g45(.a(x08), .O(new_n70_));
  nand2  g46(.a(new_n34_), .b(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g48(.a(new_n34_), .b(x09), .c(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n61_), .O(z7));
  oai21  g50(.a(new_n71_), .b(x12), .c(x09), .O(new_n75_));
  nand2  g51(.a(new_n47_), .b(new_n66_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n61_), .O(z8));
endmodule
