...
module FAU ( 
  ...
  nand2  g38(.a(new_n57_), .b(new_n33_), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(z4));
  nand4  g40(.a(new_n44_), .b(x13), .c(new_n56_), .d(new_n25_), .O(z5));
  nor2   g41(.a(x02), .b(x01), .O(new_n66_));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n49_), .c(new_n44_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n66_), .c(new_n69_), .O(z6));
  nand3  g46(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x09), .O(new_n73_));
  inv1   g49(.a(x08), .O(new_n74_));
  nand2  g50(.a(new_n71_), .b(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n44_), .O(z7));
  nand4  g52(.a(new_n56_), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n77_));
  inv1   g53(.a(x07), .O(new_n78_));
  oai21  g54(.a(x09), .b(x00), .c(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n77_), .b(x09), .c(new_n79_), .O(new_n80_));
  nand2  g56(.a(x10), .b(x06), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(x10), .c(new_n81_), .O(z8));
endmodule
