...
module FAU ( 
  ...
  oai21  g02(.a(new_n26_), .b(x00), .c(x13), .O(new_n27_));
  ...
  nor2   g11(.a(new_n35_), .b(x02), .O(new_n36_));
  ...
  oai21  g17(.a(new_n30_), .b(new_n38_), .c(new_n41_), .O(new_n42_));
  ...
  nor2   g28(.a(x13), .b(x02), .O(new_n53_));
  nor3   g29(.a(new_n53_), .b(new_n52_), .c(new_n29_), .O(new_n54_));
  aoi21  g30(.a(new_n51_), .b(new_n36_), .c(new_n54_), .O(z2));
  inv1   g31(.a(new_n53_), .O(new_n56_));
  nand2  g32(.a(x12), .b(new_n29_), .O(new_n57_));
  ...
  nor2   g40(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n62_), .c(new_n63_), .O(z4));
  nor2   g42(.a(new_n35_), .b(x12), .O(new_n67_));
  inv1   g43(.a(new_n45_), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(x00), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n67_), .c(new_n53_), .O(z5));
  nand2  g46(.a(new_n61_), .b(new_n39_), .O(new_n71_));
  nand2  g47(.a(x09), .b(x03), .O(new_n72_));
  nand2  g48(.a(new_n25_), .b(new_n44_), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  inv1   g50(.a(new_n65_), .O(new_n75_));
  nand4  g51(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n74_), .c(new_n56_), .O(z6));
  oai21  g54(.a(new_n72_), .b(x01), .c(x13), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n64_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n45_), .O(z7));
  nand2  g59(.a(new_n61_), .b(x00), .O(new_n84_));
  inv1   g60(.a(x12), .O(new_n85_));
  nand3  g61(.a(x13), .b(new_n85_), .c(x09), .O(new_n86_));
  oai22  g62(.a(new_n86_), .b(new_n81_), .c(new_n84_), .d(new_n53_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n45_), .O(z8));
endmodule
