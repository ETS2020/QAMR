...
module FAU ( 
  ...
  oai21  g19(.a(new_n31_), .b(x02), .c(new_n26_), .O(new_n44_));
  inv1   g20(.a(x07), .O(new_n45_));
  inv1   g21(.a(x08), .O(new_n46_));
  oai21  g22(.a(new_n46_), .b(new_n25_), .c(new_n45_), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n44_), .O(z2));
  nand2  g24(.a(new_n45_), .b(new_n25_), .O(new_n49_));
  inv1   g25(.a(x12), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(x00), .O(new_n51_));
  aoi22  g27(.a(new_n51_), .b(new_n49_), .c(x11), .d(x07), .O(z3));
  ...
  nand2  g33(.a(new_n49_), .b(new_n57_), .O(new_n58_));
  aoi21  g34(.a(new_n56_), .b(new_n54_), .c(new_n58_), .O(z4));
  inv1   g35(.a(x10), .O(new_n60_));
  nand4  g36(.a(x13), .b(new_n50_), .c(new_n60_), .d(new_n26_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x02), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n45_), .O(z5));
  nand3  g39(.a(x14), .b(x01), .c(new_n26_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n53_), .c(new_n60_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(x02), .c(x07), .O(z6));
  oai21  g42(.a(x10), .b(new_n46_), .c(x02), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n45_), .O(z7));
  nand3  g44(.a(new_n60_), .b(new_n55_), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x02), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n45_), .O(z8));
endmodule
