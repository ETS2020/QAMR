...
module FAU ( 
  ...
  nand2  g34(.a(new_n41_), .b(new_n32_), .O(new_n59_));
  ...
  nand3  g40(.a(new_n42_), .b(new_n41_), .c(x03), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n40_), .O(new_n66_));
  inv1   g42(.a(x10), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(x08), .c(new_n37_), .O(new_n68_));
  aoi21  g44(.a(x03), .b(new_n36_), .c(new_n68_), .O(new_n69_));
  aoi21  g45(.a(new_n66_), .b(new_n36_), .c(new_n69_), .O(z7));
  inv1   g46(.a(x12), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n37_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n60_), .c(new_n40_), .O(new_n73_));
