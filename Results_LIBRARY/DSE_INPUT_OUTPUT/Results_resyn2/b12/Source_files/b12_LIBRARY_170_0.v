...
module FAU ( 
  ...
  oai21  g05(.a(new_n29_), .b(new_n25_), .c(x09), .O(new_n30_));
  ...
  aoi21  g27(.a(new_n49_), .b(new_n25_), .c(new_n51_), .O(z2));
  inv1   g28(.a(x00), .O(new_n53_));
  nand2  g29(.a(x12), .b(new_n53_), .O(new_n54_));
  nand2  g30(.a(x11), .b(x07), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n54_), .c(new_n38_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(z3));
  nor2   g33(.a(new_n37_), .b(x07), .O(new_n58_));
  nand2  g34(.a(new_n55_), .b(new_n38_), .O(new_n59_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n38_), .d(x13), .O(z5));
  nand2  g41(.a(new_n37_), .b(x03), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n33_), .O(new_n67_));
  nor2   g43(.a(x02), .b(x01), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n53_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n60_), .d(new_n43_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n38_), .O(z6));
  nand2  g48(.a(new_n68_), .b(x03), .O(new_n73_));
  inv1   g49(.a(new_n43_), .O(new_n74_));
  oai21  g50(.a(new_n73_), .b(new_n74_), .c(x05), .O(new_n75_));
  nand2  g51(.a(new_n43_), .b(x08), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n73_), .c(new_n75_), .d(new_n37_), .O(z7));
  nor2   g54(.a(new_n73_), .b(new_n74_), .O(new_n79_));
  nand2  g55(.a(new_n43_), .b(x00), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(x05), .c(x09), .O(new_n81_));
  nor2   g57(.a(x12), .b(new_n37_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n79_), .c(new_n81_), .O(z8));
endmodule
