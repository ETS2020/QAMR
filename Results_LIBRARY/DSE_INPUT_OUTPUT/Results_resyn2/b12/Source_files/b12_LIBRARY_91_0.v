...
module FAU ( 
  ...
  aoi22  g25(.a(new_n49_), .b(new_n27_), .c(new_n47_), .d(x00), .O(z2));
  and2   g26(.a(x11), .b(x07), .O(new_n51_));
  inv1   g27(.a(x12), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(x00), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n43_), .O(z3));
  nand4  g30(.a(x09), .b(x08), .c(new_n45_), .d(x00), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n51_), .c(new_n43_), .O(z4));
  nand4  g33(.a(x13), .b(new_n52_), .c(new_n45_), .d(new_n35_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x02), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n42_), .O(z5));
  nor2   g36(.a(new_n31_), .b(x00), .O(new_n61_));
  nand2  g37(.a(x08), .b(x00), .O(new_n62_));
  nor2   g38(.a(x10), .b(x07), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(x02), .O(new_n64_));
  aoi21  g40(.a(new_n61_), .b(x14), .c(new_n64_), .O(z6));
  oai21  g41(.a(new_n46_), .b(x07), .c(x02), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n42_), .O(z7));
  inv1   g43(.a(x09), .O(new_n68_));
  nand4  g44(.a(new_n63_), .b(new_n68_), .c(x02), .d(x00), .O(z8));
endmodule
