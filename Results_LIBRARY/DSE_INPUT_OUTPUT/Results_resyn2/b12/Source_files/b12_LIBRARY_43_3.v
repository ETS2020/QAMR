...
module FAU ( 
  ...
  nand2  g26(.a(x11), .b(x02), .O(new_n51_));
  ...
  aoi21  g31(.a(new_n49_), .b(new_n25_), .c(new_n28_), .O(new_n56_));
  aoi21  g32(.a(x12), .b(new_n55_), .c(new_n56_), .O(z3));
  ...
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n55_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n58_), .c(new_n45_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n67_), .c(new_n51_), .O(z6));
  nand4  g46(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n71_));
  oai21  g47(.a(new_n38_), .b(x01), .c(new_n50_), .O(new_n72_));
  oai21  g48(.a(x11), .b(new_n50_), .c(x02), .O(new_n73_));
