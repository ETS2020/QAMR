...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n58_, new_n60_, new_n61_, new_n62_, new_n64_, new_n65_;
  ...
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n40_), .d(x13), .O(z5));
  inv1   g35(.a(x10), .O(new_n60_));
  nand3  g36(.a(new_n51_), .b(new_n60_), .c(new_n43_), .O(new_n61_));
  and2   g37(.a(x14), .b(x01), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n26_), .c(new_n61_), .d(new_n40_), .O(z6));
  nand2  g39(.a(new_n60_), .b(new_n43_), .O(new_n64_));
  aoi21  g40(.a(new_n25_), .b(new_n39_), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x08), .O(z7));
  nand3  g42(.a(new_n65_), .b(new_n53_), .c(x00), .O(z8));
endmodule
