...
module FAU ( 
  ...
  nand2  g30(.a(new_n54_), .b(new_n32_), .O(z4));
  ...
  nand3  g40(.a(new_n52_), .b(new_n56_), .c(new_n38_), .O(new_n65_));
  ...
  nand3  g46(.a(new_n56_), .b(x08), .c(new_n38_), .O(new_n71_));
  aoi21  g47(.a(x03), .b(new_n31_), .c(new_n71_), .O(new_n72_));
  aoi21  g48(.a(new_n70_), .b(new_n31_), .c(new_n72_), .O(z7));
  nand2  g49(.a(new_n42_), .b(x00), .O(new_n74_));
  aoi21  g50(.a(new_n31_), .b(x01), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(x03), .b(new_n31_), .O(new_n76_));
  nand3  g52(.a(new_n57_), .b(x09), .c(new_n41_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n43_), .O(z8));
endmodule
