...
module FAU ( 
  ...
  nand2  g38(.a(new_n58_), .b(new_n36_), .O(new_n63_));
  nor2   g39(.a(new_n45_), .b(new_n56_), .O(new_n64_));
  ...
  nor2   g44(.a(new_n68_), .b(new_n38_), .O(z5));
  nand2  g45(.a(new_n61_), .b(x03), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n40_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n32_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n27_), .c(x02), .O(new_n73_));
  inv1   g49(.a(new_n64_), .O(new_n74_));
  nand3  g50(.a(new_n33_), .b(x14), .c(new_n56_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n73_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n32_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n27_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n32_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n48_), .O(z7));
  nand3  g59(.a(new_n66_), .b(x09), .c(new_n27_), .O(new_n84_));
  oai22  g60(.a(new_n84_), .b(new_n81_), .c(new_n46_), .d(x09), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n48_), .O(z8));
endmodule
