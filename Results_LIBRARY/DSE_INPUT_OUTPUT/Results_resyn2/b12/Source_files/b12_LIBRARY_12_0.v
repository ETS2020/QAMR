...
module FAU ( 
  ...
  oai21  g26(.a(new_n50_), .b(new_n48_), .c(new_n40_), .O(z3));
  nand4  g27(.a(x09), .b(x08), .c(new_n43_), .d(x00), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n48_), .c(new_n40_), .O(z4));
  nor3   g30(.a(x10), .b(x07), .c(x00), .O(new_n55_));
  inv1   g31(.a(x13), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(x12), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n55_), .c(new_n39_), .O(z5));
  inv1   g34(.a(x01), .O(new_n59_));
  oai21  g35(.a(new_n55_), .b(new_n25_), .c(new_n59_), .O(new_n60_));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand3  g37(.a(x14), .b(x02), .c(new_n35_), .O(new_n62_));
  nor2   g38(.a(x10), .b(x07), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n60_), .O(z6));
  nand3  g41(.a(new_n63_), .b(new_n40_), .c(x08), .O(z7));
  nor2   g42(.a(x09), .b(new_n35_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n63_), .c(new_n39_), .O(z8));
endmodule
