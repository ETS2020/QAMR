...
module FAU ( 
  ...
  nor2   g32(.a(new_n44_), .b(x07), .O(new_n57_));
  ...
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n60_), .d(new_n59_), .O(new_n62_));
  and2   g38(.a(new_n62_), .b(new_n38_), .O(z5));
  nand2  g39(.a(x09), .b(x03), .O(new_n64_));
  nand2  g40(.a(new_n44_), .b(new_n34_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(x01), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n55_), .c(new_n45_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n38_), .O(z6));
  nand2  g45(.a(new_n64_), .b(new_n28_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(new_n71_));
  oai21  g47(.a(new_n34_), .b(x01), .c(new_n42_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n45_), .O(z7));
  nand3  g49(.a(new_n60_), .b(new_n59_), .c(new_n41_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n64_), .c(new_n28_), .O(new_n75_));
