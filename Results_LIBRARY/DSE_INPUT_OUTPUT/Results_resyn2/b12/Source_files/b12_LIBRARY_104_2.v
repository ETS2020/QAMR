...
module FAU ( 
  ...
  nand2  g36(.a(new_n54_), .b(new_n33_), .O(new_n61_));
  aoi21  g37(.a(new_n60_), .b(new_n58_), .c(new_n61_), .O(z4));
  nor2   g38(.a(x07), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n53_), .d(new_n46_), .O(new_n64_));
  ...
  nand4  g47(.a(x09), .b(x03), .c(new_n35_), .d(new_n42_), .O(new_n72_));
  nand3  g48(.a(x03), .b(new_n35_), .c(new_n42_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n43_), .O(z7));
  oai22  g51(.a(new_n72_), .b(x12), .c(x09), .d(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n43_), .O(z8));
endmodule
