...
module FAU ( 
  ...
  nand2  g20(.a(new_n32_), .b(x00), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  aoi21  g22(.a(new_n43_), .b(new_n37_), .c(new_n46_), .O(z2));
  ...
  nand2  g27(.a(x09), .b(new_n38_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n51_), .c(new_n48_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n29_), .O(z4));
  nor2   g30(.a(x12), .b(x10), .O(new_n55_));
  nor2   g31(.a(x07), .b(x00), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(new_n55_), .c(new_n29_), .d(x13), .O(z5));
  inv1   g33(.a(x03), .O(new_n58_));
  nand2  g34(.a(x09), .b(new_n58_), .O(new_n59_));
  nand2  g35(.a(new_n39_), .b(x03), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n27_), .O(new_n61_));
  nand3  g37(.a(new_n51_), .b(new_n40_), .c(new_n38_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n29_), .O(z6));
  nor2   g41(.a(x10), .b(x07), .O(new_n66_));
  inv1   g42(.a(x08), .O(new_n67_));
  oai21  g43(.a(new_n58_), .b(x02), .c(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n67_), .b(x02), .c(x01), .O(new_n69_));
  nand3  g45(.a(new_n27_), .b(x09), .c(x03), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n66_), .O(z7));
  inv1   g47(.a(x12), .O(new_n72_));
  nand4  g48(.a(new_n27_), .b(new_n72_), .c(x09), .d(x03), .O(new_n73_));
  nand3  g49(.a(new_n29_), .b(new_n39_), .c(x00), .O(new_n74_));
