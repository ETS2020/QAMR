...
module FAU ( 
  ...
  aoi21  g23(.a(x12), .b(new_n31_), .c(new_n47_), .O(z3));
  ...
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(new_n47_), .O(z4));
  nor2   g29(.a(x12), .b(x10), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n37_), .d(new_n31_), .O(new_n55_));
  and2   g31(.a(new_n55_), .b(new_n45_), .O(z5));
  xnor2a g32(.a(x09), .b(x03), .O(new_n57_));
  nor2   g33(.a(x02), .b(x01), .O(new_n58_));
  nand3  g34(.a(new_n49_), .b(new_n45_), .c(new_n35_), .O(new_n59_));
  aoi21  g35(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z6));
  nand3  g36(.a(new_n58_), .b(x09), .c(x03), .O(new_n61_));
  inv1   g37(.a(x08), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x02), .c(x01), .O(new_n63_));
  oai21  g39(.a(new_n25_), .b(x02), .c(new_n62_), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n61_), .d(new_n35_), .O(z7));
  nand3  g41(.a(new_n45_), .b(new_n51_), .c(x00), .O(new_n66_));
  oai21  g42(.a(new_n61_), .b(x12), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n35_), .O(z8));
endmodule
