...
module FAU ( 
  ...
  aoi21  g41(.a(new_n65_), .b(x02), .c(new_n42_), .O(new_n66_));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nand3  g44(.a(new_n54_), .b(new_n60_), .c(new_n39_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n66_), .O(z6));
  oai21  g48(.a(new_n43_), .b(new_n34_), .c(new_n42_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n30_), .O(new_n74_));
  nand2  g50(.a(x03), .b(new_n30_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n40_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n44_), .O(z7));
  nand2  g53(.a(new_n43_), .b(x00), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n58_), .O(new_n79_));
  nand3  g55(.a(new_n61_), .b(x09), .c(new_n42_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n44_), .O(z8));
endmodule
