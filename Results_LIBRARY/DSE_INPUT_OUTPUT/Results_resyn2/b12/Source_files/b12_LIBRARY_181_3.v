...
module FAU ( 
  ...
  nand2  g44(.a(x03), .b(new_n36_), .O(new_n69_));
  nor2   g45(.a(x08), .b(x01), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n29_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n67_), .O(z7));
  nand2  g48(.a(new_n68_), .b(new_n29_), .O(new_n73_));
  nor2   g49(.a(x12), .b(x02), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(x09), .c(x03), .d(new_n25_), .O(new_n75_));
  nand2  g51(.a(new_n38_), .b(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n29_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n73_), .O(z8));
endmodule
