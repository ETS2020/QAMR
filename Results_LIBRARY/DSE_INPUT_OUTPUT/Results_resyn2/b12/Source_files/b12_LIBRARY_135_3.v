...
module FAU ( 
  ...
  oai21  g38(.a(new_n38_), .b(x02), .c(new_n62_), .O(new_n63_));
  oai21  g39(.a(new_n62_), .b(x02), .c(x01), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n61_), .d(new_n36_), .O(z7));
  inv1   g41(.a(x09), .O(new_n66_));
  nand3  g42(.a(new_n29_), .b(new_n66_), .c(x00), .O(new_n67_));
  oai21  g43(.a(new_n61_), .b(x12), .c(new_n67_), .O(new_n68_));
