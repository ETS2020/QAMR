...
module FAU ( 
  ...
  nand3  g06(.a(x05), .b(x02), .c(x01), .O(new_n31_));
  oai21  g07(.a(new_n30_), .b(x04), .c(new_n31_), .O(new_n32_));
  ...
  nand4  g15(.a(x04), .b(x03), .c(new_n25_), .d(x01), .O(new_n40_));
  ...
  nand3  g24(.a(new_n48_), .b(new_n47_), .c(new_n42_), .O(new_n49_));
  nand4  g25(.a(new_n49_), .b(new_n46_), .c(x04), .d(new_n45_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n25_), .c(new_n44_), .O(z2));
  nand2  g27(.a(x12), .b(new_n26_), .O(new_n52_));
  nand2  g28(.a(x11), .b(x07), .O(new_n53_));
  nor2   g29(.a(x04), .b(x02), .O(new_n54_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n55_), .d(x13), .O(z5));
  xor2a  g41(.a(x09), .b(x03), .O(new_n66_));
  nand2  g42(.a(new_n25_), .b(new_n45_), .O(new_n67_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n59_), .c(new_n69_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n55_), .O(z6));
  nand2  g48(.a(x09), .b(x03), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x01), .c(x04), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n69_), .O(z7));
  nand2  g54(.a(new_n47_), .b(x00), .O(new_n79_));
  inv1   g55(.a(x12), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x09), .c(x04), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n76_), .c(new_n79_), .d(new_n54_), .O(new_n82_));
