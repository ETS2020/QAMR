...
module FAU ( 
  ...
  nand2  g38(.a(x09), .b(new_n37_), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(x03), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n31_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n28_), .O(new_n67_));
  nand2  g43(.a(x08), .b(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n41_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n62_), .c(new_n69_), .O(z6));
  nand3  g46(.a(new_n41_), .b(new_n64_), .c(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n28_), .O(new_n72_));
  nand2  g48(.a(x03), .b(new_n31_), .O(new_n73_));
  nand2  g49(.a(new_n41_), .b(x08), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n31_), .O(z7));
  nand2  g52(.a(new_n64_), .b(x00), .O(new_n77_));
  aoi21  g53(.a(x02), .b(new_n31_), .c(new_n77_), .O(new_n78_));
  nand3  g54(.a(new_n52_), .b(x09), .c(new_n28_), .O(new_n79_));
  nor2   g55(.a(new_n79_), .b(new_n73_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n41_), .O(z8));
endmodule
