...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n59_, new_n60_, new_n62_, new_n64_;
  ...
  nand2  g18(.a(new_n42_), .b(new_n31_), .O(z2));
  nand2  g19(.a(x12), .b(new_n35_), .O(new_n44_));
  nand2  g20(.a(x11), .b(x07), .O(new_n45_));
  nand3  g21(.a(new_n45_), .b(new_n44_), .c(new_n31_), .O(new_n46_));
  inv1   g22(.a(new_n46_), .O(z3));
  nand2  g23(.a(new_n45_), .b(new_n31_), .O(new_n48_));
  ...
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(new_n48_), .O(z4));
  nor2   g29(.a(x12), .b(x10), .O(new_n54_));
  nor2   g30(.a(x07), .b(x00), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(new_n54_), .c(new_n31_), .d(x13), .O(z5));
  ...
  aoi22  g36(.a(new_n60_), .b(new_n27_), .c(new_n58_), .d(new_n31_), .O(z6));
  inv1   g37(.a(new_n31_), .O(new_n62_));
  aoi21  g38(.a(new_n57_), .b(x08), .c(new_n62_), .O(z7));
  nor2   g39(.a(x09), .b(new_n35_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n57_), .c(new_n62_), .O(z8));
endmodule
