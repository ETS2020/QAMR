...
module FAU ( 
  ...
  nand2  g46(.a(new_n70_), .b(new_n43_), .O(new_n71_));
  oai21  g47(.a(new_n48_), .b(new_n35_), .c(new_n51_), .O(new_n72_));
  aoi21  g48(.a(new_n71_), .b(new_n67_), .c(new_n72_), .O(z6));
  nand2  g49(.a(new_n48_), .b(x02), .O(new_n74_));
  and2   g50(.a(new_n51_), .b(new_n56_), .O(new_n75_));
  oai21  g51(.a(new_n39_), .b(x01), .c(new_n48_), .O(new_n76_));
  nor2   g52(.a(new_n39_), .b(x01), .O(new_n77_));
  nor2   g53(.a(new_n50_), .b(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(z7));
  nand2  g56(.a(new_n37_), .b(new_n50_), .O(new_n81_));
  nand3  g57(.a(new_n78_), .b(new_n77_), .c(new_n58_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n51_), .O(z8));
endmodule
