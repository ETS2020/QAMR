...
module FAU ( 
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(z7));
  inv1   g46(.a(x10), .O(new_n71_));
  nand3  g47(.a(new_n49_), .b(new_n71_), .c(new_n39_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n61_), .c(new_n42_), .O(new_n73_));
