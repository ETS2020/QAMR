...
module FAU ( 
  ...
  nand4  g27(.a(x09), .b(x08), .c(new_n40_), .d(x00), .O(new_n52_));
  ...
  aoi22  g45(.a(new_n69_), .b(new_n68_), .c(new_n50_), .d(new_n42_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(z7));
  inv1   g47(.a(x09), .O(new_n72_));
  nand3  g48(.a(new_n50_), .b(new_n72_), .c(x00), .O(new_n73_));
  nand3  g49(.a(new_n48_), .b(x09), .c(new_n27_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n68_), .c(new_n73_), .O(new_n75_));
