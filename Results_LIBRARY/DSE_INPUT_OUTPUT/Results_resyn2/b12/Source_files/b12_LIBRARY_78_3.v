...
module FAU ( 
  ...
  nor2   g07(.a(x09), .b(new_n25_), .O(new_n32_));
  ...
  nand2  g19(.a(x09), .b(x02), .O(new_n44_));
  ...
  aoi21  g28(.a(new_n50_), .b(new_n25_), .c(new_n52_), .O(z2));
  ...
  oai21  g34(.a(x09), .b(new_n58_), .c(x02), .O(new_n59_));
  nand4  g35(.a(x09), .b(x08), .c(new_n58_), .d(x00), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n54_), .c(new_n59_), .O(z4));
  nor2   g38(.a(x12), .b(x10), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n58_), .d(new_n37_), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n44_), .O(z5));
  nand3  g41(.a(x14), .b(x01), .c(new_n37_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n32_), .O(new_n67_));
  inv1   g43(.a(x03), .O(new_n68_));
  nand2  g44(.a(x09), .b(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n28_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n37_), .c(new_n47_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n67_), .c(new_n74_), .O(z6));
  nand3  g51(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand3  g53(.a(x09), .b(x03), .c(new_n46_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n47_), .d(new_n44_), .O(z7));
  inv1   g55(.a(new_n44_), .O(new_n80_));
  oai22  g56(.a(new_n78_), .b(x12), .c(x09), .d(new_n37_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n47_), .c(new_n80_), .O(z8));
endmodule
