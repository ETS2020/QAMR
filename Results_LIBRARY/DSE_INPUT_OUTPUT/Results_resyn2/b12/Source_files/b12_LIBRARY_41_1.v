...
module FAU ( 
  ...
  nand2  g35(.a(new_n39_), .b(new_n30_), .O(new_n60_));
  ...
  nand3  g42(.a(new_n40_), .b(new_n39_), .c(x03), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n29_), .O(new_n68_));
  inv1   g44(.a(x07), .O(new_n69_));
  inv1   g45(.a(x10), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(x08), .c(new_n69_), .O(new_n71_));
  aoi21  g47(.a(x03), .b(new_n27_), .c(new_n71_), .O(new_n72_));
  aoi21  g48(.a(new_n68_), .b(new_n27_), .c(new_n72_), .O(z7));
  nand3  g49(.a(new_n47_), .b(new_n70_), .c(new_n69_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n61_), .c(new_n29_), .O(new_n75_));
