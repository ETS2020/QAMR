...
module FAU ( 
  ...
  nand4  g16(.a(new_n40_), .b(new_n38_), .c(new_n37_), .d(x02), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(new_n36_), .c(x00), .O(z1));
  inv1   g18(.a(x07), .O(new_n43_));
  inv1   g19(.a(x09), .O(new_n44_));
  nand3  g20(.a(new_n37_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  aoi21  g21(.a(x07), .b(x03), .c(x01), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n45_), .c(x02), .O(new_n47_));
  inv1   g23(.a(x08), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n43_), .c(new_n25_), .O(new_n49_));
  inv1   g25(.a(x02), .O(new_n50_));
  aoi21  g26(.a(new_n34_), .b(new_n50_), .c(new_n37_), .O(new_n51_));
  nor3   g27(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(z2));
  ...
  nand4  g36(.a(new_n60_), .b(x13), .c(new_n53_), .d(new_n37_), .O(new_n61_));
  ...
  aoi21  g43(.a(new_n64_), .b(new_n50_), .c(new_n67_), .O(z6));
  nand2  g44(.a(x09), .b(x03), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x01), .c(new_n37_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n50_), .O(new_n71_));
  inv1   g47(.a(x01), .O(new_n72_));
  nand2  g48(.a(new_n35_), .b(new_n72_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n48_), .c(x07), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x10), .c(new_n71_), .O(z7));
  nand2  g51(.a(x10), .b(new_n50_), .O(new_n76_));
  nor2   g52(.a(x12), .b(new_n44_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n35_), .c(new_n72_), .O(new_n78_));
  nand2  g54(.a(new_n44_), .b(x00), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(x07), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x10), .c(new_n76_), .O(z8));
endmodule
