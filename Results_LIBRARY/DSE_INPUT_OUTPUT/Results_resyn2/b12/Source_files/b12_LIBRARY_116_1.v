...
module FAU ( 
  ...
  nor2   g17(.a(new_n41_), .b(new_n36_), .O(z1));
  ...
  nand4  g28(.a(new_n52_), .b(new_n49_), .c(new_n26_), .d(new_n46_), .O(new_n53_));
  ...
  oai21  g49(.a(new_n73_), .b(new_n70_), .c(new_n61_), .O(z6));
  oai21  g50(.a(new_n37_), .b(x01), .c(new_n44_), .O(new_n75_));
  nand3  g51(.a(new_n39_), .b(x09), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n26_), .O(new_n78_));
  aoi21  g54(.a(new_n44_), .b(x02), .c(new_n48_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(new_n57_), .O(z7));
  nand2  g56(.a(x03), .b(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n50_), .b(x00), .O(new_n82_));
  nand4  g58(.a(new_n65_), .b(x09), .c(new_n26_), .d(new_n25_), .O(new_n83_));
  oai22  g59(.a(new_n83_), .b(new_n81_), .c(new_n82_), .d(new_n57_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n51_), .O(z8));
endmodule
