...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(new_n45_), .c(new_n32_), .O(new_n47_));
  nor2   g23(.a(x12), .b(x02), .O(new_n48_));
  inv1   g24(.a(x07), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  inv1   g27(.a(x00), .O(new_n52_));
  aoi21  g28(.a(x12), .b(new_n27_), .c(new_n52_), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(new_n51_), .c(new_n48_), .d(new_n47_), .O(z2));
  nand2  g30(.a(x12), .b(new_n27_), .O(new_n55_));
  and2   g31(.a(x11), .b(x07), .O(new_n56_));
  nor2   g32(.a(new_n28_), .b(x00), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(z3));
  nand4  g34(.a(x09), .b(x08), .c(new_n49_), .d(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n56_), .c(new_n55_), .O(z4));
  nand4  g37(.a(new_n44_), .b(x13), .c(new_n28_), .d(new_n52_), .O(z5));
  nand2  g38(.a(new_n43_), .b(x03), .O(new_n63_));
  nand2  g39(.a(x09), .b(new_n39_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n32_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n28_), .O(new_n66_));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n52_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n44_), .O(new_n69_));
  aoi21  g45(.a(new_n66_), .b(new_n27_), .c(new_n69_), .O(z6));
  nand3  g46(.a(x09), .b(x03), .c(new_n32_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n28_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n27_), .O(new_n73_));
  inv1   g49(.a(x10), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n49_), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n50_), .c(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n73_), .O(z7));
  inv1   g54(.a(new_n45_), .O(new_n79_));
  oai21  g55(.a(new_n71_), .b(new_n75_), .c(new_n28_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n27_), .c(new_n79_), .d(x00), .O(z8));
endmodule
