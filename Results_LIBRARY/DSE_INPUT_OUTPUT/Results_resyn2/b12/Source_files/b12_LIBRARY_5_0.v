...
module FAU ( 
  ...
  nand2  g21(.a(new_n45_), .b(new_n30_), .O(z3));
  ...
  nand2  g26(.a(new_n44_), .b(new_n30_), .O(new_n51_));
  ...
  nand3  g34(.a(new_n58_), .b(new_n47_), .c(new_n30_), .O(new_n59_));
  nor2   g35(.a(new_n59_), .b(new_n57_), .O(z6));
  inv1   g36(.a(new_n30_), .O(new_n61_));
  aoi21  g37(.a(new_n58_), .b(x08), .c(new_n61_), .O(z7));
  nor2   g38(.a(x09), .b(new_n34_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n58_), .c(new_n61_), .O(z8));
endmodule
