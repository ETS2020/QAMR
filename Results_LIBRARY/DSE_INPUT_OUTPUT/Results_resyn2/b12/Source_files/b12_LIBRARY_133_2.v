...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n53_), .c(new_n44_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n63_), .c(new_n31_), .O(z6));
  nand2  g42(.a(new_n61_), .b(new_n42_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nand2  g44(.a(x03), .b(new_n30_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n40_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n44_), .O(z7));
  nand2  g47(.a(new_n43_), .b(x00), .O(new_n72_));
  aoi21  g48(.a(new_n30_), .b(x01), .c(new_n72_), .O(new_n73_));
  nand3  g49(.a(new_n49_), .b(x09), .c(new_n42_), .O(new_n74_));
  nor2   g50(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n44_), .O(z8));
endmodule
