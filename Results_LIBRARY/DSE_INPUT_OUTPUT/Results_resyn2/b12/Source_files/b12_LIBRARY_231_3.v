...
module FAU ( 
  ...
  nand3  g15(.a(new_n39_), .b(new_n37_), .c(new_n32_), .O(new_n40_));
  ...
  nand2  g39(.a(new_n25_), .b(new_n43_), .O(new_n64_));
  nor2   g40(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g41(.a(x08), .b(x00), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n61_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n51_), .O(z6));
  nand4  g45(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n70_));
  oai21  g46(.a(new_n38_), .b(x01), .c(new_n50_), .O(new_n71_));
  oai21  g47(.a(x12), .b(new_n50_), .c(x02), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n45_), .O(z7));
  nand3  g49(.a(new_n51_), .b(new_n44_), .c(x00), .O(new_n74_));
  oai21  g50(.a(new_n70_), .b(x12), .c(new_n74_), .O(new_n75_));
