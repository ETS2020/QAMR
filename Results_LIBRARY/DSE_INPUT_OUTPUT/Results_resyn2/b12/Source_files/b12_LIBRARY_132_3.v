...
module FAU ( 
  ...
  nor2   g30(.a(new_n38_), .b(x00), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n54_), .c(new_n35_), .O(z3));
  nand4  g32(.a(x09), .b(x08), .c(new_n46_), .d(x00), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n54_), .c(new_n35_), .O(z4));
  nand4  g35(.a(new_n44_), .b(x13), .c(new_n38_), .d(new_n29_), .O(z5));
  xor2a  g36(.a(x09), .b(x03), .O(new_n61_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n62_));
  oai21  g38(.a(new_n61_), .b(new_n34_), .c(new_n62_), .O(new_n63_));
  nor2   g39(.a(new_n61_), .b(new_n34_), .O(new_n64_));
  inv1   g40(.a(new_n62_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n44_), .c(new_n35_), .O(new_n68_));
  aoi21  g44(.a(new_n66_), .b(new_n63_), .c(new_n68_), .O(z6));
  inv1   g45(.a(x08), .O(new_n70_));
  oai21  g46(.a(new_n34_), .b(new_n32_), .c(new_n70_), .O(new_n71_));
  ...
  aoi21  g51(.a(new_n75_), .b(new_n72_), .c(new_n73_), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n71_), .c(x12), .d(x05), .O(z7));
  nand3  g53(.a(new_n75_), .b(new_n72_), .c(new_n38_), .O(new_n78_));
  nand3  g54(.a(new_n35_), .b(new_n74_), .c(x00), .O(new_n79_));
