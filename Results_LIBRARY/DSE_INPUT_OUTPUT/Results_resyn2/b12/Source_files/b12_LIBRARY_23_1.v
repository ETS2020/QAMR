...
module FAU ( 
  ...
  oai21  g33(.a(x13), .b(x07), .c(new_n35_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n62_), .c(x11), .d(new_n34_), .O(z5));
  ...
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n59_), .d(new_n62_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n36_), .O(z6));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(new_n31_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n31_), .b(x09), .c(x03), .O(new_n75_));
  and2   g51(.a(new_n62_), .b(new_n36_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(z7));
  oai21  g53(.a(new_n73_), .b(x12), .c(x09), .O(new_n78_));
  nand2  g54(.a(new_n46_), .b(new_n34_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n76_), .O(z8));
endmodule
