...
module FAU ( 
  ...
  nor2   g02(.a(x13), .b(new_n26_), .O(new_n27_));
  ...
  inv1   g29(.a(new_n27_), .O(new_n54_));
  ...
  nor2   g35(.a(new_n44_), .b(new_n25_), .O(new_n60_));
  nor2   g36(.a(new_n46_), .b(x07), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nand4  g39(.a(new_n47_), .b(x13), .c(new_n63_), .d(new_n25_), .O(z5));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  nor3   g41(.a(new_n65_), .b(x02), .c(x01), .O(new_n66_));
  inv1   g42(.a(new_n60_), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n47_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n66_), .c(new_n54_), .O(z6));
  aoi21  g46(.a(x03), .b(new_n29_), .c(x08), .O(new_n71_));
  nand3  g47(.a(x09), .b(x03), .c(new_n29_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n26_), .O(new_n74_));
  aoi21  g50(.a(new_n44_), .b(x02), .c(new_n50_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n27_), .O(z7));
  nand2  g52(.a(new_n63_), .b(new_n26_), .O(new_n77_));
  oai22  g53(.a(new_n77_), .b(new_n72_), .c(x09), .d(new_n25_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n47_), .c(new_n27_), .O(z8));
endmodule
