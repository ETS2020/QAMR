...
module FAU ( 
  ...
  aoi21  g24(.a(x12), .b(new_n29_), .c(new_n48_), .O(z3));
  ...
  nand4  g31(.a(new_n55_), .b(x13), .c(new_n38_), .d(new_n29_), .O(new_n56_));
  and2   g32(.a(new_n56_), .b(new_n46_), .O(z5));
  xnor2a g33(.a(x09), .b(x03), .O(new_n58_));
  nor2   g34(.a(x02), .b(x01), .O(new_n59_));
  nand3  g35(.a(new_n50_), .b(new_n46_), .c(new_n36_), .O(new_n60_));
  ...
  nand2  g42(.a(new_n46_), .b(new_n40_), .O(new_n67_));
  nand2  g43(.a(x03), .b(new_n25_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n62_), .c(new_n42_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(z7));
  nor2   g46(.a(x12), .b(x02), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x09), .c(x03), .d(new_n42_), .O(new_n72_));
  nand2  g48(.a(new_n52_), .b(x00), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n67_), .O(z8));
endmodule
