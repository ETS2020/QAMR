...
module FAU ( 
  ...
  oai21  g16(.a(new_n34_), .b(new_n39_), .c(new_n40_), .O(new_n41_));
  inv1   g17(.a(new_n27_), .O(new_n42_));
  nand3  g18(.a(new_n42_), .b(x06), .c(x05), .O(new_n43_));
  nand4  g19(.a(new_n43_), .b(new_n41_), .c(new_n38_), .d(new_n36_), .O(new_n44_));
  ...
  nand3  g25(.a(new_n49_), .b(new_n48_), .c(new_n39_), .O(new_n50_));
  oai21  g26(.a(x08), .b(x07), .c(x00), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n32_), .O(new_n52_));
  aoi21  g28(.a(new_n50_), .b(new_n40_), .c(new_n52_), .O(z2));
  ...
  nand2  g36(.a(new_n55_), .b(new_n32_), .O(new_n61_));
  ...
  nand3  g46(.a(new_n42_), .b(x14), .c(new_n25_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n58_), .d(new_n47_), .O(new_n72_));
  ...
  nand3  g51(.a(new_n67_), .b(new_n46_), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n47_), .c(new_n37_), .O(z7));
  nand2  g54(.a(new_n54_), .b(x10), .O(new_n79_));
  nand3  g55(.a(new_n67_), .b(new_n54_), .c(x03), .O(new_n80_));
  inv1   g56(.a(x07), .O(new_n81_));
  oai21  g57(.a(x09), .b(x00), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n80_), .b(x09), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x10), .c(new_n79_), .O(z8));
endmodule
