...
module FAU ( 
  ...
  oai21  g21(.a(new_n33_), .b(new_n45_), .c(new_n44_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n36_), .O(new_n47_));
  oai21  g23(.a(new_n45_), .b(x02), .c(new_n25_), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(x07), .O(new_n49_));
  nand2  g25(.a(x08), .b(x00), .O(new_n50_));
  nand4  g26(.a(new_n50_), .b(new_n49_), .c(new_n47_), .d(new_n34_), .O(new_n51_));
  ...
  nand2  g31(.a(new_n55_), .b(new_n34_), .O(z3));
  inv1   g32(.a(x07), .O(new_n57_));
  oai21  g33(.a(new_n33_), .b(new_n57_), .c(new_n32_), .O(new_n58_));
  oai21  g34(.a(new_n50_), .b(x07), .c(new_n54_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n58_), .O(z4));
  nand3  g36(.a(new_n33_), .b(x09), .c(new_n57_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n53_), .d(new_n25_), .O(z5));
  nand3  g39(.a(x03), .b(new_n36_), .c(new_n44_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g41(.a(x14), .b(new_n25_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n27_), .c(new_n50_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n65_), .O(z6));
  nand3  g44(.a(new_n64_), .b(new_n62_), .c(x08), .O(z7));
  nor2   g45(.a(x02), .b(x01), .O(new_n70_));
  nand4  g46(.a(new_n62_), .b(new_n70_), .c(new_n53_), .d(x03), .O(z8));
endmodule
