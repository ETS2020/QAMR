...
module FAU ( 
  ...
  nand2  g42(.a(new_n39_), .b(new_n37_), .O(new_n67_));
  nand2  g43(.a(x03), .b(new_n36_), .O(new_n68_));
  nor2   g44(.a(x08), .b(x01), .O(new_n69_));
  aoi22  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n29_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n66_), .O(z7));
  nand2  g47(.a(new_n67_), .b(new_n29_), .O(new_n72_));
  nor2   g48(.a(x12), .b(x02), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(x09), .c(x03), .d(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n38_), .b(x00), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n29_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n72_), .O(z8));
endmodule
