...
module FAU ( 
  ...
  oai21  g07(.a(new_n31_), .b(x00), .c(x01), .O(new_n32_));
  ...
  aoi21  g21(.a(new_n45_), .b(x00), .c(new_n25_), .O(z2));
  and2   g22(.a(x11), .b(x07), .O(new_n47_));
  inv1   g23(.a(x12), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(x00), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n47_), .c(new_n40_), .O(z3));
  nand4  g26(.a(x09), .b(x08), .c(new_n43_), .d(x00), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n47_), .c(new_n40_), .O(z4));
  nor2   g29(.a(x12), .b(x10), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n43_), .d(new_n35_), .O(new_n55_));
  and2   g31(.a(new_n55_), .b(new_n40_), .O(z5));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  nor2   g33(.a(x10), .b(x07), .O(new_n58_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(new_n40_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z6));
  and2   g37(.a(new_n58_), .b(new_n40_), .O(new_n62_));
