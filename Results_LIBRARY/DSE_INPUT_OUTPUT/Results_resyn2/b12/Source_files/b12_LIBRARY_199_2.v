...
module FAU ( 
  ...
  inv1   g07(.a(x13), .O(new_n32_));
  nand2  g08(.a(new_n32_), .b(x12), .O(new_n33_));
  ...
  nand2  g17(.a(new_n33_), .b(new_n25_), .O(new_n42_));
  aoi21  g18(.a(new_n41_), .b(new_n36_), .c(new_n42_), .O(z1));
  ...
  nand2  g28(.a(new_n52_), .b(new_n44_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n33_), .O(z2));
  ...
  inv1   g37(.a(new_n33_), .O(new_n62_));
  nor2   g38(.a(x10), .b(x07), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n56_), .c(new_n25_), .O(new_n64_));
  inv1   g40(.a(new_n64_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(z5));
  nand2  g42(.a(x09), .b(new_n38_), .O(new_n67_));
  nand2  g43(.a(new_n35_), .b(new_n45_), .O(new_n68_));
  aoi21  g44(.a(new_n47_), .b(x03), .c(new_n68_), .O(new_n69_));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand4  g46(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n63_), .d(new_n33_), .O(new_n72_));
  aoi21  g48(.a(new_n69_), .b(new_n67_), .c(new_n72_), .O(z6));
  nand4  g49(.a(x09), .b(x03), .c(new_n35_), .d(new_n45_), .O(new_n74_));
  inv1   g50(.a(x08), .O(new_n75_));
  inv1   g51(.a(new_n63_), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n35_), .c(new_n45_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n75_), .c(new_n76_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n74_), .c(new_n62_), .O(z7));
  nand3  g55(.a(new_n33_), .b(new_n47_), .c(x00), .O(new_n80_));
  oai21  g56(.a(new_n74_), .b(x12), .c(new_n80_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n63_), .O(z8));
endmodule
