...
module FAU ( 
  ...
  nor2   g07(.a(x11), .b(x06), .O(new_n32_));
  ...
  nand2  g44(.a(new_n47_), .b(new_n45_), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n60_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n67_), .O(z6));
  nand3  g48(.a(x03), .b(new_n35_), .c(new_n44_), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x09), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  aoi21  g52(.a(new_n73_), .b(new_n76_), .c(new_n69_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n75_), .c(new_n32_), .O(z7));
  oai21  g54(.a(new_n73_), .b(x12), .c(x09), .O(new_n79_));
  nand2  g55(.a(new_n46_), .b(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n70_), .O(z8));
endmodule
