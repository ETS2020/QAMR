...
module FAU ( 
  ...
  and2   g37(.a(new_n61_), .b(new_n31_), .O(z5));
  nand2  g38(.a(x14), .b(new_n25_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(x02), .c(new_n42_), .O(new_n64_));
  xnor2a g40(.a(x09), .b(x03), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  nand3  g42(.a(new_n54_), .b(new_n58_), .c(new_n39_), .O(new_n67_));
  ...
  oai21  g49(.a(new_n34_), .b(x02), .c(new_n40_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n44_), .O(z7));
  nand3  g51(.a(new_n59_), .b(new_n58_), .c(new_n39_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n71_), .c(new_n42_), .O(new_n77_));
  nand3  g53(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n77_), .b(new_n30_), .c(new_n79_), .O(z8));
endmodule
