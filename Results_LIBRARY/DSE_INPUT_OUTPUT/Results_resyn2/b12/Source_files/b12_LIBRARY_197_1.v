...
module FAU ( 
  ...
  nand2  g06(.a(x04), .b(x01), .O(new_n31_));
  oai21  g07(.a(new_n31_), .b(x05), .c(x02), .O(new_n32_));
  ...
  nand2  g12(.a(new_n36_), .b(new_n28_), .O(new_n37_));
  nand3  g13(.a(new_n37_), .b(x01), .c(new_n25_), .O(new_n38_));
  aoi21  g14(.a(new_n35_), .b(new_n34_), .c(new_n38_), .O(z1));
  ...
  aoi22  g24(.a(new_n48_), .b(new_n40_), .c(new_n43_), .d(new_n27_), .O(z2));
  nand2  g25(.a(x02), .b(new_n26_), .O(new_n50_));
  ...
  nand4  g36(.a(new_n60_), .b(x13), .c(new_n51_), .d(new_n45_), .O(new_n61_));
  and2   g37(.a(new_n61_), .b(new_n50_), .O(z5));
  nand2  g38(.a(x09), .b(x03), .O(new_n63_));
  nand2  g39(.a(new_n44_), .b(new_n28_), .O(new_n64_));
  ...
  nand3  g43(.a(new_n67_), .b(new_n55_), .c(new_n66_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n50_), .O(z6));
  nand2  g45(.a(new_n63_), .b(new_n40_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(new_n71_));
  oai21  g47(.a(new_n28_), .b(x01), .c(new_n42_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(z7));
  nand3  g49(.a(new_n50_), .b(new_n44_), .c(x00), .O(new_n74_));
  nor2   g50(.a(new_n44_), .b(x01), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n29_), .c(new_n51_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n66_), .O(z8));
endmodule
