...
module FAU ( 
  ...
  oai22  g31(.a(new_n55_), .b(x00), .c(new_n32_), .d(new_n46_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n34_), .O(z3));
  aoi21  g33(.a(new_n46_), .b(x05), .c(new_n32_), .O(new_n58_));
  ...
  nor3   g38(.a(new_n33_), .b(x07), .c(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n55_), .d(new_n48_), .O(z5));
  nor2   g40(.a(x02), .b(x01), .O(new_n65_));
  inv1   g41(.a(x03), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n47_), .b(x03), .O(new_n68_));
  ...
  nand4  g48(.a(new_n72_), .b(new_n59_), .c(new_n71_), .d(new_n34_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(new_n70_), .O(z6));
  nand3  g50(.a(x03), .b(new_n36_), .c(new_n45_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x08), .O(new_n76_));
  nand3  g52(.a(new_n65_), .b(new_n47_), .c(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n71_), .c(new_n33_), .O(z7));
  oai21  g55(.a(new_n75_), .b(x12), .c(x09), .O(new_n80_));
  inv1   g56(.a(new_n71_), .O(new_n81_));
  aoi21  g57(.a(new_n47_), .b(new_n25_), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n80_), .c(new_n33_), .O(z8));
endmodule
