...
module FAU ( 
  ...
  nand4  g39(.a(x09), .b(x03), .c(new_n36_), .d(new_n25_), .O(new_n64_));
  inv1   g40(.a(x03), .O(new_n65_));
  inv1   g41(.a(x08), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n66_), .b(x02), .c(x01), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n64_), .d(new_n61_), .O(z7));
  nand3  g45(.a(new_n29_), .b(new_n38_), .c(x00), .O(new_n70_));
  oai21  g46(.a(new_n64_), .b(x12), .c(new_n70_), .O(new_n71_));
