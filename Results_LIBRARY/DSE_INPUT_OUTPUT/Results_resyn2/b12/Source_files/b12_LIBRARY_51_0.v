...
module FAU ( 
  ...
  and2   g32(.a(new_n56_), .b(new_n34_), .O(z5));
  nor2   g33(.a(x10), .b(x07), .O(new_n58_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(new_n50_), .d(new_n34_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z6));
  and2   g37(.a(new_n58_), .b(new_n34_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x08), .O(z7));
  nand3  g39(.a(new_n62_), .b(new_n52_), .c(x00), .O(z8));
endmodule
