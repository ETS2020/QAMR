...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(new_n30_), .O(new_n31_));
  ...
  nand3  g14(.a(new_n38_), .b(new_n31_), .c(new_n36_), .O(new_n39_));
  ...
  nand2  g28(.a(new_n52_), .b(new_n31_), .O(new_n53_));
  ...
  nand2  g38(.a(new_n56_), .b(new_n31_), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(z4));
  nor2   g40(.a(new_n33_), .b(x12), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n45_), .c(x04), .d(new_n36_), .O(z5));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n36_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n61_), .c(new_n45_), .d(new_n31_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n37_), .c(new_n69_), .O(z6));
  and2   g46(.a(new_n45_), .b(new_n31_), .O(new_n71_));
  nand3  g47(.a(new_n37_), .b(x09), .c(x03), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  oai21  g49(.a(new_n38_), .b(new_n28_), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(z7));
  oai22  g51(.a(new_n72_), .b(x12), .c(x09), .d(new_n36_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n71_), .O(z8));
endmodule
