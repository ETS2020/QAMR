...
module FAU ( 
  ...
  nand2  g30(.a(x12), .b(new_n50_), .O(new_n55_));
  nand2  g31(.a(x11), .b(x07), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(z3));
  nand2  g34(.a(new_n56_), .b(new_n54_), .O(new_n59_));
  nand2  g35(.a(x08), .b(x00), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(new_n61_));
  nor2   g37(.a(new_n42_), .b(x07), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(new_n59_), .O(z4));
  nor2   g39(.a(x12), .b(x10), .O(new_n64_));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n54_), .d(x13), .O(z5));
  xor2a  g42(.a(x09), .b(x03), .O(new_n67_));
  nand2  g43(.a(new_n39_), .b(new_n25_), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n50_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n60_), .c(new_n43_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n54_), .O(z6));
  nand4  g48(.a(x09), .b(x03), .c(new_n39_), .d(new_n25_), .O(new_n73_));
  oai21  g49(.a(new_n35_), .b(x01), .c(new_n48_), .O(new_n74_));
  oai21  g50(.a(new_n51_), .b(new_n48_), .c(x02), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n43_), .O(z7));
  inv1   g52(.a(new_n54_), .O(new_n77_));
  nand2  g53(.a(new_n42_), .b(x00), .O(new_n78_));
  oai21  g54(.a(new_n73_), .b(x12), .c(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n43_), .c(new_n77_), .O(z8));
endmodule
