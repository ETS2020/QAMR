...
module FAU ( 
  ...
  nand2  g15(.a(new_n25_), .b(new_n32_), .O(new_n40_));
  nand3  g16(.a(new_n40_), .b(new_n35_), .c(new_n29_), .O(new_n41_));
  oai21  g17(.a(new_n32_), .b(new_n30_), .c(new_n31_), .O(new_n42_));
  ...
  nand2  g35(.a(new_n59_), .b(x09), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(x07), .c(x12), .d(new_n29_), .O(z3));
  nand2  g37(.a(x08), .b(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n49_), .O(new_n63_));
  nand2  g39(.a(new_n59_), .b(x07), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(x09), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nor2   g42(.a(x10), .b(x07), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n66_), .d(new_n29_), .O(z5));
  nand2  g44(.a(new_n37_), .b(new_n49_), .O(new_n69_));
  nor2   g45(.a(x07), .b(x03), .O(new_n70_));
  xor2a  g46(.a(new_n70_), .b(x09), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n62_), .c(new_n50_), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n49_), .c(new_n71_), .d(new_n69_), .O(z6));
  inv1   g50(.a(x08), .O(new_n75_));
  oai21  g51(.a(new_n37_), .b(new_n32_), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n36_), .b(x09), .c(x03), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n67_), .O(z7));
  nor2   g54(.a(x09), .b(x00), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x10), .c(new_n49_), .O(new_n80_));
  nand3  g56(.a(new_n66_), .b(new_n49_), .c(x03), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n37_), .c(x09), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z8));
endmodule
