...
module FAU ( 
  ...
  oai21  g26(.a(new_n50_), .b(new_n48_), .c(new_n31_), .O(z3));
  nand4  g27(.a(x09), .b(x08), .c(new_n39_), .d(x00), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n48_), .c(new_n31_), .O(z4));
  nor2   g30(.a(x07), .b(x00), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(x13), .c(new_n49_), .d(new_n44_), .O(new_n56_));
  and2   g32(.a(new_n56_), .b(new_n31_), .O(z5));
  nand2  g33(.a(x09), .b(x03), .O(new_n58_));
  nand2  g34(.a(new_n43_), .b(new_n34_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(x02), .O(new_n60_));
  ...
  oai21  g40(.a(new_n64_), .b(new_n60_), .c(new_n31_), .O(z6));
  inv1   g41(.a(x01), .O(new_n66_));
  nand2  g42(.a(new_n58_), .b(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  oai21  g44(.a(new_n34_), .b(x02), .c(new_n40_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n61_), .O(z7));
  nand3  g46(.a(new_n49_), .b(new_n44_), .c(new_n39_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n58_), .c(new_n66_), .O(new_n72_));
  nand3  g48(.a(new_n61_), .b(new_n43_), .c(x00), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n72_), .b(new_n30_), .c(new_n74_), .O(z8));
endmodule
