...
module FAU ( 
  ...
  nor2   g15(.a(x13), .b(x05), .O(new_n40_));
  inv1   g16(.a(new_n40_), .O(new_n41_));
  nand3  g17(.a(new_n41_), .b(new_n39_), .c(new_n29_), .O(new_n42_));
  nand2  g18(.a(x06), .b(x05), .O(new_n43_));
  oai22  g19(.a(new_n43_), .b(new_n31_), .c(new_n27_), .d(x03), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n42_), .O(z1));
  ...
  oai21  g26(.a(new_n50_), .b(new_n48_), .c(new_n33_), .O(new_n51_));
  oai21  g27(.a(x08), .b(x07), .c(x00), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n41_), .O(new_n53_));
  aoi21  g29(.a(new_n51_), .b(new_n34_), .c(new_n53_), .O(z2));
  nand2  g30(.a(x12), .b(new_n29_), .O(new_n55_));
  ...
  nor2   g38(.a(new_n62_), .b(new_n29_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n60_), .c(new_n61_), .O(z4));
  nor2   g40(.a(x12), .b(x10), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n46_), .d(new_n29_), .O(new_n66_));
  and2   g42(.a(new_n66_), .b(new_n41_), .O(z5));
  xnor2a g43(.a(x09), .b(x03), .O(new_n68_));
  inv1   g44(.a(new_n63_), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n29_), .O(new_n70_));
  nand2  g46(.a(new_n47_), .b(new_n46_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n40_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(new_n73_));
  aoi21  g49(.a(new_n68_), .b(new_n38_), .c(new_n73_), .O(z6));
  nand3  g50(.a(new_n38_), .b(x09), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n38_), .b(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n62_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n72_), .O(z7));
  oai21  g54(.a(new_n76_), .b(x12), .c(x09), .O(new_n79_));
  aoi21  g55(.a(new_n59_), .b(new_n29_), .c(new_n71_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(new_n40_), .O(z8));
endmodule
