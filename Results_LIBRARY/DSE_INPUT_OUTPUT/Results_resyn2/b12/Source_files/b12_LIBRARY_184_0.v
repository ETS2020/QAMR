...
module FAU ( 
  ...
  nor2   g07(.a(x14), .b(x12), .O(new_n32_));
  ...
  nor3   g35(.a(new_n32_), .b(new_n44_), .c(x07), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(new_n56_), .O(z4));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n45_), .c(x14), .d(x13), .O(z5));
  ...
  aoi21  g47(.a(new_n69_), .b(new_n33_), .c(new_n71_), .O(z6));
  inv1   g48(.a(x08), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g51(.a(x09), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n76_));
  nor2   g52(.a(new_n49_), .b(new_n32_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(z7));
  oai22  g54(.a(new_n76_), .b(x12), .c(x09), .d(new_n25_), .O(new_n79_));
