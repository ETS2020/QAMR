...
module FAU ( 
  ...
  nor2   g11(.a(x11), .b(new_n35_), .O(new_n36_));
  inv1   g12(.a(new_n36_), .O(new_n37_));
  oai21  g13(.a(new_n34_), .b(x00), .c(new_n37_), .O(z0));
  nand3  g14(.a(x05), .b(x02), .c(x01), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(x11), .c(new_n35_), .O(new_n40_));
  aoi21  g16(.a(x03), .b(x01), .c(x02), .O(new_n41_));
  inv1   g17(.a(x00), .O(new_n42_));
  oai21  g18(.a(x04), .b(x03), .c(new_n42_), .O(new_n43_));
  nor3   g19(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(z1));
  ...
  nand2  g29(.a(new_n53_), .b(new_n37_), .O(z2));
  nand2  g30(.a(x12), .b(new_n42_), .O(new_n55_));
  nand2  g31(.a(x11), .b(x07), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n55_), .c(new_n37_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(z3));
  nor2   g34(.a(x07), .b(x06), .O(new_n59_));
  nand2  g35(.a(x08), .b(x00), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n47_), .c(new_n46_), .O(new_n61_));
  ...
  nand3  g45(.a(new_n29_), .b(x14), .c(new_n42_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n60_), .c(new_n69_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n37_), .O(z6));
  nand3  g48(.a(new_n30_), .b(x09), .c(x03), .O(new_n73_));
  inv1   g49(.a(new_n69_), .O(new_n74_));
  aoi21  g50(.a(new_n30_), .b(x03), .c(x08), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n73_), .c(new_n36_), .O(z7));
  oai22  g53(.a(new_n73_), .b(x12), .c(x09), .d(new_n42_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n69_), .c(new_n36_), .O(z8));
endmodule
