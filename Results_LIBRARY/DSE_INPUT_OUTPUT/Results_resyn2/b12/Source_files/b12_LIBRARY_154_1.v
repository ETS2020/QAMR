...
module FAU ( 
  ...
  oai21  g22(.a(x02), .b(new_n32_), .c(new_n46_), .O(new_n47_));
  aoi21  g23(.a(new_n45_), .b(new_n32_), .c(new_n47_), .O(z2));
  ...
  oai21  g31(.a(new_n55_), .b(new_n49_), .c(new_n33_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(x13), .c(new_n53_), .d(new_n25_), .O(new_n58_));
  and2   g34(.a(new_n58_), .b(new_n33_), .O(z5));
  inv1   g35(.a(x03), .O(new_n60_));
  nand2  g36(.a(new_n41_), .b(new_n60_), .O(new_n61_));
  nand2  g37(.a(x09), .b(x03), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(x01), .O(new_n63_));
  nand2  g39(.a(x08), .b(x00), .O(new_n64_));
  nand4  g40(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n42_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(new_n33_), .O(z6));
  oai21  g43(.a(new_n43_), .b(new_n60_), .c(new_n26_), .O(new_n68_));
  nand2  g44(.a(new_n42_), .b(x08), .O(new_n69_));
  aoi21  g45(.a(x03), .b(new_n32_), .c(new_n69_), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n32_), .c(new_n70_), .O(z7));
  nand2  g47(.a(new_n42_), .b(new_n50_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n62_), .c(new_n26_), .O(new_n73_));
  nand3  g49(.a(new_n42_), .b(new_n41_), .c(x00), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n73_), .b(new_n32_), .c(new_n75_), .O(z8));
endmodule
