...
module FAU ( 
  ...
  nand2  g11(.a(x09), .b(x02), .O(new_n36_));
  ...
  oai22  g16(.a(new_n40_), .b(new_n39_), .c(new_n28_), .d(new_n26_), .O(new_n41_));
  ...
  nand3  g25(.a(new_n49_), .b(new_n47_), .c(new_n44_), .O(new_n50_));
  ...
  oai21  g33(.a(new_n57_), .b(x07), .c(new_n27_), .O(new_n58_));
  ...
  nand3  g40(.a(x09), .b(x03), .c(new_n44_), .O(new_n65_));
  oai21  g41(.a(new_n26_), .b(x02), .c(new_n45_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n64_), .c(new_n28_), .O(new_n68_));
  nand2  g44(.a(new_n57_), .b(new_n46_), .O(new_n69_));
  ...
  inv1   g49(.a(new_n65_), .O(new_n74_));
  ...
  nor2   g53(.a(new_n77_), .b(new_n48_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(new_n73_), .O(z7));
  nand2  g55(.a(x03), .b(new_n27_), .O(new_n80_));
  inv1   g56(.a(x12), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x09), .c(new_n44_), .O(new_n82_));
  oai22  g58(.a(new_n82_), .b(new_n80_), .c(x09), .d(new_n25_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n46_), .O(z8));
endmodule
