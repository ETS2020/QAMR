...
module FAU ( 
  ...
  nand2  g31(.a(new_n51_), .b(new_n38_), .O(new_n56_));
  inv1   g32(.a(x08), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n55_), .c(new_n56_), .O(z4));
  inv1   g35(.a(x12), .O(new_n60_));
  nand3  g36(.a(x13), .b(new_n60_), .c(new_n43_), .O(new_n61_));
  nor3   g37(.a(new_n61_), .b(x07), .c(x00), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(new_n37_), .O(z5));
  xor2a  g39(.a(x09), .b(x03), .O(new_n64_));
  nor3   g40(.a(new_n64_), .b(x02), .c(x01), .O(new_n65_));
  inv1   g41(.a(new_n58_), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n32_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n38_), .O(z6));
  aoi21  g45(.a(x03), .b(new_n27_), .c(x08), .O(new_n70_));
  nand3  g46(.a(x09), .b(x03), .c(new_n27_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n70_), .c(new_n25_), .O(new_n73_));
  inv1   g49(.a(new_n40_), .O(new_n74_));
  aoi21  g50(.a(new_n57_), .b(x02), .c(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n73_), .c(new_n37_), .O(z7));
  nand2  g52(.a(new_n60_), .b(new_n25_), .O(new_n77_));
  oai22  g53(.a(new_n77_), .b(new_n71_), .c(x09), .d(new_n32_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n40_), .c(new_n37_), .O(z8));
endmodule
