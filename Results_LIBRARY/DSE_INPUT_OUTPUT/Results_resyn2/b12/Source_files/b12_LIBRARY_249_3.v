...
module FAU ( 
  ...
  nor2   g25(.a(new_n27_), .b(new_n25_), .O(new_n50_));
  inv1   g26(.a(new_n50_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  aoi21  g28(.a(new_n48_), .b(new_n25_), .c(new_n52_), .O(z2));
  ...
  nand3  g40(.a(x14), .b(x01), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n31_), .O(new_n66_));
  ...
  nand2  g46(.a(new_n58_), .b(new_n44_), .O(new_n71_));
  aoi21  g47(.a(new_n70_), .b(new_n66_), .c(new_n71_), .O(z6));
  nand3  g48(.a(x09), .b(x03), .c(new_n43_), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  aoi21  g50(.a(x03), .b(new_n43_), .c(x08), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n74_), .c(new_n25_), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n25_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(new_n50_), .O(z7));
  nand2  g55(.a(new_n54_), .b(new_n25_), .O(new_n80_));
  oai22  g56(.a(new_n80_), .b(new_n73_), .c(x09), .d(new_n64_), .O(new_n81_));
