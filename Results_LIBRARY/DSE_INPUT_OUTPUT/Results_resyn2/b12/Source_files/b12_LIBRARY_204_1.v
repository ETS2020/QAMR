...
module FAU ( 
  ...
  nor2   g33(.a(new_n40_), .b(x07), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n57_), .c(new_n55_), .O(z4));
  nor2   g35(.a(x12), .b(x10), .O(new_n60_));
  nor2   g36(.a(x07), .b(x00), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n60_), .c(new_n50_), .d(x13), .O(z5));
  nand2  g38(.a(x09), .b(x03), .O(new_n63_));
  nand2  g39(.a(new_n40_), .b(new_n30_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(x01), .O(new_n65_));
  nor2   g41(.a(x10), .b(x07), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n47_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n56_), .c(new_n66_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n65_), .c(new_n50_), .O(z6));
  nand2  g45(.a(new_n63_), .b(new_n29_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n27_), .O(new_n71_));
  oai21  g47(.a(new_n30_), .b(x01), .c(new_n45_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(z7));
  inv1   g49(.a(x12), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n41_), .c(new_n39_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n63_), .c(new_n29_), .O(new_n76_));
  nand3  g52(.a(new_n66_), .b(new_n40_), .c(x00), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n76_), .b(new_n27_), .c(new_n78_), .O(z8));
endmodule
