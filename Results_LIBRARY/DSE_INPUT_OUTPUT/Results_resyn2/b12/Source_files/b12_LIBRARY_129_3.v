...
module FAU ( 
  ...
  nand2  g28(.a(new_n52_), .b(new_n25_), .O(z3));
  nand2  g29(.a(x08), .b(x00), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  nor2   g31(.a(new_n41_), .b(x07), .O(new_n56_));
  nand2  g32(.a(new_n51_), .b(new_n25_), .O(new_n57_));
  ...
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n34_), .O(new_n64_));
  nand3  g40(.a(new_n25_), .b(new_n42_), .c(new_n40_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n54_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  nor2   g44(.a(x10), .b(x07), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  oai21  g46(.a(new_n36_), .b(x02), .c(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n70_), .b(x02), .c(x01), .O(new_n72_));
  nand3  g48(.a(new_n34_), .b(x09), .c(x03), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n69_), .O(z7));
  nand4  g50(.a(new_n34_), .b(new_n50_), .c(x09), .d(x03), .O(new_n75_));
  nand3  g51(.a(new_n25_), .b(new_n41_), .c(x00), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n69_), .O(z8));
endmodule
