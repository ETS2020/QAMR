...
module FAU ( 
  ...
  nand2  g40(.a(new_n44_), .b(x03), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n62_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n61_), .c(new_n45_), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n33_), .c(new_n69_), .O(z6));
  nand4  g46(.a(x09), .b(x03), .c(new_n35_), .d(new_n43_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand3  g48(.a(x03), .b(new_n35_), .c(new_n43_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n71_), .c(new_n45_), .d(new_n33_), .O(z7));
  nand3  g51(.a(new_n33_), .b(new_n44_), .c(x00), .O(new_n76_));
  oai21  g52(.a(new_n71_), .b(x12), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n45_), .O(z8));
endmodule
