...
module FAU ( 
  ...
  oai21  g49(.a(new_n37_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n42_), .O(z7));
  nand3  g51(.a(new_n50_), .b(new_n57_), .c(new_n53_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n70_), .c(new_n28_), .O(new_n77_));
  nand3  g53(.a(new_n42_), .b(new_n41_), .c(x00), .O(new_n78_));
