...
module FAU ( 
  ...
  nand3  g21(.a(new_n32_), .b(x09), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g41(.a(x11), .b(new_n32_), .c(new_n45_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  nor2   g43(.a(x12), .b(x00), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(x13), .O(z5));
  nor2   g45(.a(x02), .b(x01), .O(new_n70_));
  xnor2a g46(.a(x09), .b(x03), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n67_), .c(new_n50_), .O(new_n73_));
  aoi21  g49(.a(new_n71_), .b(new_n70_), .c(new_n73_), .O(z6));
  nand4  g50(.a(x09), .b(x03), .c(new_n36_), .d(new_n44_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n36_), .c(new_n44_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n75_), .c(new_n67_), .O(z7));
