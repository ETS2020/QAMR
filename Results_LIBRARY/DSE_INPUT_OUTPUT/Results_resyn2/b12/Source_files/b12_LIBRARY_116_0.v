...
module FAU ( 
  ...
  oai21  g14(.a(new_n30_), .b(new_n35_), .c(new_n38_), .O(new_n39_));
  ...
  nand4  g27(.a(new_n51_), .b(new_n48_), .c(x06), .d(new_n45_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n25_), .c(new_n44_), .O(z2));
  inv1   g29(.a(x12), .O(new_n54_));
  and2   g30(.a(x11), .b(x07), .O(new_n55_));
  nor2   g31(.a(x06), .b(x02), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  oai21  g33(.a(new_n54_), .b(x00), .c(new_n57_), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(z3));
  inv1   g35(.a(new_n56_), .O(new_n60_));
  ...
  nor2   g41(.a(new_n65_), .b(new_n56_), .O(z5));
  xor2a  g42(.a(x09), .b(x03), .O(new_n67_));
  nor3   g43(.a(new_n67_), .b(x02), .c(x01), .O(new_n68_));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand4  g45(.a(x14), .b(x02), .c(x01), .d(new_n26_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n50_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n60_), .O(z6));
  oai21  g48(.a(new_n36_), .b(x01), .c(new_n43_), .O(new_n73_));
  nand4  g49(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x06), .O(new_n76_));
  aoi21  g52(.a(new_n43_), .b(x02), .c(new_n47_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n56_), .O(z7));
  nand2  g54(.a(x03), .b(new_n45_), .O(new_n79_));
  nand2  g55(.a(new_n49_), .b(x00), .O(new_n80_));
  nand4  g56(.a(new_n54_), .b(x09), .c(x06), .d(new_n25_), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n79_), .c(new_n80_), .d(new_n56_), .O(new_n82_));
