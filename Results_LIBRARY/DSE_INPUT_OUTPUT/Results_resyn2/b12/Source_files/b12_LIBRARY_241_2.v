...
module FAU ( 
  ...
  nand2  g28(.a(new_n50_), .b(new_n31_), .O(new_n53_));
  nand2  g29(.a(x08), .b(x00), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  nor2   g31(.a(new_n43_), .b(x07), .O(new_n56_));
  ...
  nand3  g37(.a(x13), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n59_), .c(new_n58_), .O(z5));
  nand2  g40(.a(x09), .b(new_n34_), .O(new_n65_));
  nand2  g41(.a(new_n43_), .b(x03), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n30_), .O(new_n67_));
  inv1   g43(.a(x14), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x00), .c(x02), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x01), .O(new_n70_));
  nand2  g46(.a(new_n54_), .b(new_n44_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n67_), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(z6));
  nand3  g50(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n42_), .O(new_n76_));
  nand2  g52(.a(x03), .b(new_n30_), .O(new_n77_));
  nand2  g53(.a(new_n44_), .b(x08), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n77_), .c(new_n76_), .d(new_n30_), .O(z7));
  nand2  g56(.a(new_n43_), .b(x00), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(new_n58_), .O(new_n82_));
  nand3  g58(.a(new_n61_), .b(x09), .c(new_n42_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(new_n77_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n82_), .c(new_n44_), .O(z8));
endmodule
