...
module FAU ( 
  ...
  nand4  g35(.a(new_n59_), .b(x13), .c(new_n49_), .d(new_n58_), .O(new_n60_));
  and2   g36(.a(new_n60_), .b(new_n31_), .O(z5));
  nand2  g37(.a(x14), .b(new_n25_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(x02), .c(new_n42_), .O(new_n63_));
  xnor2a g39(.a(x09), .b(x03), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n30_), .O(new_n65_));
  nand3  g41(.a(new_n53_), .b(new_n58_), .c(new_n39_), .O(new_n66_));
  ...
  oai21  g48(.a(new_n34_), .b(x02), .c(new_n40_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z7));
  nand3  g50(.a(new_n49_), .b(new_n58_), .c(new_n39_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n70_), .c(new_n42_), .O(new_n76_));
  nand3  g52(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n77_));
