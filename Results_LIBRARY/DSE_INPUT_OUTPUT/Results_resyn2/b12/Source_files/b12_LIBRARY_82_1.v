...
module FAU ( 
  ...
  oai21  g32(.a(new_n26_), .b(x02), .c(new_n56_), .O(new_n57_));
  or2    g33(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  ...
  nor2   g38(.a(new_n26_), .b(x02), .O(new_n63_));
  ...
  oai21  g43(.a(new_n67_), .b(x01), .c(new_n26_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n68_), .b(new_n25_), .c(new_n71_), .O(z6));
  inv1   g48(.a(x03), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x01), .c(new_n43_), .O(new_n74_));
  nand4  g50(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n26_), .O(new_n77_));
  aoi21  g53(.a(new_n43_), .b(x02), .c(new_n47_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n63_), .O(z7));
  nand2  g55(.a(x03), .b(new_n45_), .O(new_n80_));
  nand2  g56(.a(new_n49_), .b(x00), .O(new_n81_));
  nand4  g57(.a(new_n54_), .b(x09), .c(new_n26_), .d(new_n25_), .O(new_n82_));
  oai22  g58(.a(new_n82_), .b(new_n80_), .c(new_n81_), .d(new_n63_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n50_), .O(z8));
endmodule
