...
module FAU ( 
  ...
  nor2   g10(.a(new_n34_), .b(x04), .O(new_n35_));
  ...
  oai21  g17(.a(new_n41_), .b(new_n29_), .c(new_n31_), .O(new_n42_));
  oai21  g18(.a(new_n40_), .b(new_n26_), .c(new_n42_), .O(new_n43_));
  ...
  nand2  g29(.a(new_n53_), .b(new_n36_), .O(z2));
  nand2  g30(.a(x12), .b(new_n38_), .O(new_n55_));
  and2   g31(.a(x11), .b(x07), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n35_), .O(new_n57_));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n46_), .d(new_n38_), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n36_), .O(z5));
  ...
  oai21  g47(.a(new_n71_), .b(new_n67_), .c(new_n36_), .O(z6));
  inv1   g48(.a(x08), .O(new_n73_));
  oai21  g49(.a(new_n30_), .b(new_n31_), .c(new_n73_), .O(new_n74_));
  nand4  g50(.a(x09), .b(x03), .c(new_n29_), .d(new_n28_), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n68_), .d(new_n36_), .O(z7));
  oai22  g52(.a(new_n75_), .b(x12), .c(x09), .d(new_n38_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n68_), .c(new_n35_), .O(z8));
endmodule
