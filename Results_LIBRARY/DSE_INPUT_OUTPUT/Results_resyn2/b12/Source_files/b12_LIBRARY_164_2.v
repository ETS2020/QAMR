...
module FAU ( 
  ...
  nand2  g24(.a(x12), .b(new_n33_), .O(new_n49_));
  ...
  nand2  g31(.a(new_n55_), .b(new_n35_), .O(z4));
  inv1   g32(.a(x12), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nor2   g34(.a(x10), .b(x09), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(x13), .d(new_n57_), .O(z5));
  nand3  g36(.a(new_n39_), .b(new_n29_), .c(new_n28_), .O(new_n61_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n33_), .O(new_n62_));
  aoi21  g38(.a(x08), .b(x00), .c(x07), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n43_), .c(x10), .O(z6));
  inv1   g41(.a(x08), .O(new_n66_));
  nand3  g42(.a(x03), .b(new_n29_), .c(new_n28_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(x07), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x09), .c(new_n34_), .O(z7));
  oai21  g45(.a(x07), .b(new_n33_), .c(new_n43_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n34_), .O(z8));
endmodule
