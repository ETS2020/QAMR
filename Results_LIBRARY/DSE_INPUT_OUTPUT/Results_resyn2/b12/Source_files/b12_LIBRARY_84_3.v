...
module FAU ( 
  ...
  nand2  g07(.a(x12), .b(x10), .O(new_n32_));
  ...
  oai21  g24(.a(new_n46_), .b(new_n43_), .c(new_n48_), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n25_), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n49_), .c(new_n42_), .O(new_n53_));
  inv1   g29(.a(new_n32_), .O(new_n54_));
  oai21  g30(.a(x08), .b(x07), .c(x00), .O(new_n55_));
  nand3  g31(.a(x10), .b(new_n47_), .c(new_n42_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n34_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n55_), .c(new_n54_), .O(new_n58_));
  ...
  nor2   g39(.a(new_n43_), .b(x07), .O(new_n64_));
  nand2  g40(.a(new_n61_), .b(new_n32_), .O(new_n65_));
  aoi21  g41(.a(new_n64_), .b(new_n51_), .c(new_n65_), .O(z4));
  inv1   g42(.a(new_n46_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n60_), .d(new_n25_), .O(z5));
  nand2  g44(.a(x09), .b(new_n47_), .O(new_n69_));
  nand2  g45(.a(new_n43_), .b(x03), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n34_), .d(new_n42_), .O(new_n71_));
  nand4  g47(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n52_), .d(new_n67_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n32_), .O(z6));
  nand4  g50(.a(x09), .b(x03), .c(new_n34_), .d(new_n42_), .O(new_n75_));
  nand3  g51(.a(x03), .b(new_n34_), .c(new_n42_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n50_), .c(new_n46_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n75_), .c(new_n54_), .O(z7));
