...
module FAU ( 
  ...
  oai21  g11(.a(x10), .b(x07), .c(new_n32_), .O(new_n36_));
  ...
  aoi21  g16(.a(new_n37_), .b(x09), .c(new_n40_), .O(new_n41_));
  nand2  g17(.a(new_n39_), .b(x01), .O(new_n42_));
  inv1   g18(.a(x07), .O(new_n43_));
  inv1   g19(.a(x08), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n43_), .c(new_n25_), .O(new_n45_));
  aoi22  g21(.a(new_n45_), .b(new_n42_), .c(new_n41_), .d(new_n36_), .O(z2));
  inv1   g22(.a(x12), .O(new_n47_));
  nand2  g23(.a(x11), .b(x07), .O(new_n48_));
  oai21  g24(.a(new_n47_), .b(x00), .c(new_n48_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n42_), .O(z3));
  ...
  nand2  g30(.a(new_n48_), .b(new_n42_), .O(new_n55_));
  aoi21  g31(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n42_), .d(x13), .O(z5));
  nand2  g35(.a(x14), .b(new_n25_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(x02), .c(new_n38_), .O(new_n61_));
  xnor2a g37(.a(x09), .b(x03), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n39_), .O(new_n63_));
  inv1   g39(.a(x10), .O(new_n64_));
  nand3  g40(.a(new_n51_), .b(new_n64_), .c(new_n43_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n61_), .O(z6));
  nand3  g44(.a(new_n37_), .b(new_n53_), .c(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n38_), .O(new_n70_));
  nand3  g46(.a(new_n64_), .b(x08), .c(new_n43_), .O(new_n71_));
  aoi21  g47(.a(x03), .b(new_n39_), .c(new_n71_), .O(new_n72_));
  aoi21  g48(.a(new_n70_), .b(new_n39_), .c(new_n72_), .O(z7));
  nand2  g49(.a(x09), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n47_), .b(new_n64_), .c(new_n43_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n74_), .c(new_n38_), .O(new_n76_));
  nand3  g52(.a(new_n37_), .b(new_n53_), .c(x00), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n76_), .b(new_n39_), .c(new_n78_), .O(z8));
endmodule
