...
module FAU ( 
  ...
  nand2  g26(.a(new_n50_), .b(z5), .O(new_n51_));
  aoi21  g27(.a(new_n49_), .b(new_n36_), .c(new_n51_), .O(z2));
  nand2  g28(.a(x11), .b(x07), .O(new_n53_));
  nand2  g29(.a(x12), .b(new_n25_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n53_), .c(z5), .O(new_n55_));
  ...
  nand2  g35(.a(new_n59_), .b(z5), .O(z4));
  ...
  aoi21  g42(.a(new_n66_), .b(x12), .c(x10), .O(z6));
  inv1   g43(.a(x08), .O(new_n68_));
  nand2  g44(.a(new_n61_), .b(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g46(.a(new_n61_), .b(x09), .c(x03), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n46_), .d(x12), .O(z7));
  nand3  g48(.a(new_n45_), .b(new_n57_), .c(x00), .O(new_n73_));
