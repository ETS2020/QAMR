...
module FAU ( 
  ...
  nand4  g32(.a(new_n56_), .b(new_n36_), .c(x13), .d(new_n50_), .O(z5));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  inv1   g34(.a(x00), .O(new_n59_));
  nand4  g35(.a(x14), .b(x02), .c(x01), .d(new_n59_), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n56_), .c(new_n58_), .d(new_n48_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z6));
  and2   g38(.a(new_n56_), .b(new_n48_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x08), .O(z7));
  nor2   g40(.a(x09), .b(new_n59_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z8));
endmodule
