...
module FAU ( 
  ...
  nor2   g23(.a(new_n25_), .b(new_n27_), .O(new_n48_));
  inv1   g24(.a(new_n48_), .O(new_n49_));
  and2   g25(.a(x11), .b(x07), .O(new_n50_));
  aoi21  g26(.a(x12), .b(new_n30_), .c(new_n50_), .O(new_n51_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n50_), .c(new_n49_), .O(z4));
  nor2   g32(.a(x12), .b(x10), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n57_), .c(new_n49_), .d(x13), .O(z5));
  ...
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n49_), .O(z6));
  oai21  g41(.a(new_n61_), .b(new_n33_), .c(new_n44_), .O(new_n66_));
  nand3  g42(.a(new_n60_), .b(x09), .c(x03), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n49_), .d(new_n39_), .O(z7));
  nand2  g44(.a(new_n38_), .b(x00), .O(new_n69_));
  inv1   g45(.a(x12), .O(new_n70_));
  nand4  g46(.a(new_n60_), .b(new_n70_), .c(x09), .d(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n39_), .c(new_n48_), .O(z8));
endmodule
