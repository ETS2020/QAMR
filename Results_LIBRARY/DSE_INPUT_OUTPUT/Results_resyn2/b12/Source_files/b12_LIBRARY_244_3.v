...
module FAU ( 
  ...
  nand4  g31(.a(new_n55_), .b(x13), .c(new_n49_), .d(new_n40_), .O(new_n56_));
  ...
  nand3  g36(.a(new_n60_), .b(new_n40_), .c(new_n38_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n59_), .c(new_n31_), .O(z6));
  ...
  oai21  g42(.a(x10), .b(x07), .c(new_n31_), .O(new_n67_));
  ...
  nand4  g48(.a(new_n72_), .b(new_n49_), .c(x09), .d(x03), .O(new_n73_));
