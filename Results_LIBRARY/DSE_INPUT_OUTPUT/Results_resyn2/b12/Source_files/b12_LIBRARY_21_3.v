...
module FAU ( 
  ...
  nand4  g27(.a(x09), .b(x08), .c(new_n42_), .d(x00), .O(new_n52_));
  ...
  nand3  g36(.a(new_n60_), .b(new_n47_), .c(new_n38_), .O(new_n61_));
  ...
  nand4  g41(.a(new_n65_), .b(new_n64_), .c(new_n47_), .d(new_n38_), .O(z7));
  inv1   g42(.a(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n37_), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n58_), .b(new_n49_), .c(x09), .d(x03), .O(new_n69_));
