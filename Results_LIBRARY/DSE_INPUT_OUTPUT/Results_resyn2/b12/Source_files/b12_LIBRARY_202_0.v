...
module FAU ( 
  ...
  nand3  g22(.a(new_n34_), .b(x09), .c(new_n46_), .O(new_n47_));
  inv1   g23(.a(x03), .O(new_n48_));
  nand3  g24(.a(x07), .b(new_n48_), .c(new_n33_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g26(.a(x08), .b(x00), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n50_), .c(new_n26_), .O(new_n52_));
  oai21  g28(.a(x08), .b(x07), .c(x00), .O(new_n53_));
  nand3  g29(.a(x10), .b(new_n48_), .c(new_n26_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n27_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n52_), .c(new_n36_), .O(z2));
  ...
  inv1   g37(.a(new_n51_), .O(new_n62_));
  nand2  g38(.a(new_n59_), .b(new_n36_), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  nor2   g40(.a(new_n64_), .b(x07), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n62_), .c(new_n63_), .O(z4));
  inv1   g42(.a(x12), .O(new_n67_));
  nand4  g43(.a(x13), .b(new_n67_), .c(new_n46_), .d(new_n33_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x14), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n34_), .O(z5));
  xor2a  g46(.a(x09), .b(x03), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n28_), .O(new_n72_));
  nand3  g48(.a(x02), .b(x01), .c(new_n33_), .O(new_n73_));
  nand3  g49(.a(x14), .b(new_n34_), .c(new_n46_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n51_), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n72_), .O(z6));
  nand4  g53(.a(x09), .b(x03), .c(new_n27_), .d(new_n26_), .O(new_n78_));
  inv1   g54(.a(x08), .O(new_n79_));
  nand3  g55(.a(x03), .b(new_n27_), .c(new_n26_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n78_), .c(new_n75_), .O(z7));
  oai22  g58(.a(new_n78_), .b(x12), .c(x09), .d(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n75_), .O(z8));
endmodule
