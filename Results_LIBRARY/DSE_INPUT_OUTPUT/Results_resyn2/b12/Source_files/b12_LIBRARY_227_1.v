...
module FAU ( 
  ...
  nand3  g20(.a(new_n32_), .b(x09), .c(new_n44_), .O(new_n45_));
  ...
  aoi21  g32(.a(x10), .b(new_n44_), .c(new_n56_), .O(new_n57_));
  ...
  nor3   g38(.a(x11), .b(x10), .c(x07), .O(new_n63_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n63_), .c(new_n49_), .O(new_n69_));
