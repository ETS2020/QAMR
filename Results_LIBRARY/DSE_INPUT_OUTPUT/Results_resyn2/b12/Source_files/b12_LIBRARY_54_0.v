...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n58_, new_n60_, new_n61_, new_n62_, new_n63_, new_n66_;
  ...
  aoi21  g18(.a(new_n42_), .b(x00), .c(new_n29_), .O(z2));
  inv1   g19(.a(x12), .O(new_n44_));
  nand2  g20(.a(x11), .b(x07), .O(new_n45_));
  oai21  g21(.a(new_n44_), .b(x00), .c(new_n45_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n30_), .O(z3));
  ...
  nand2  g27(.a(new_n45_), .b(new_n30_), .O(new_n52_));
  aoi21  g28(.a(new_n51_), .b(new_n49_), .c(new_n52_), .O(z4));
  inv1   g29(.a(new_n30_), .O(new_n54_));
  nor2   g30(.a(x07), .b(x00), .O(new_n55_));
  inv1   g31(.a(x10), .O(new_n56_));
  nand3  g32(.a(x13), .b(new_n44_), .c(new_n56_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n55_), .c(new_n54_), .O(z5));
  ...
  aoi21  g40(.a(new_n62_), .b(x08), .c(new_n54_), .O(z7));
  nor2   g41(.a(x09), .b(new_n34_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n62_), .c(new_n54_), .O(z8));
endmodule
