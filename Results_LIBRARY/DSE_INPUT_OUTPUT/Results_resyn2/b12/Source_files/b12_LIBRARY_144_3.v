...
module FAU ( 
  ...
  inv1   g32(.a(new_n25_), .O(new_n57_));
  nor2   g33(.a(x07), .b(x00), .O(new_n58_));
  inv1   g34(.a(x12), .O(new_n59_));
  nand3  g35(.a(x13), .b(new_n59_), .c(new_n42_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n58_), .c(new_n57_), .O(z5));
  xnor2a g38(.a(x09), .b(x03), .O(new_n63_));
  nand3  g39(.a(new_n52_), .b(new_n39_), .c(new_n25_), .O(new_n64_));
  aoi21  g40(.a(new_n63_), .b(new_n33_), .c(new_n64_), .O(z6));
  inv1   g41(.a(x08), .O(new_n66_));
  oai21  g42(.a(new_n32_), .b(x01), .c(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n33_), .b(x09), .c(x03), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n39_), .d(new_n25_), .O(z7));
  nand2  g45(.a(new_n54_), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n33_), .b(new_n59_), .c(x09), .d(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n39_), .c(new_n57_), .O(z8));
endmodule
