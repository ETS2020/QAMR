...
module FAU ( 
  ...
  nor2   g07(.a(x11), .b(new_n25_), .O(new_n32_));
  ...
  inv1   g18(.a(new_n32_), .O(new_n43_));
  ...
  aoi21  g29(.a(new_n53_), .b(new_n43_), .c(new_n47_), .O(z2));
  aoi21  g30(.a(new_n45_), .b(new_n25_), .c(new_n28_), .O(new_n55_));
  aoi21  g31(.a(x12), .b(new_n44_), .c(new_n55_), .O(z3));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  nor2   g34(.a(new_n48_), .b(x07), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(new_n55_), .O(z4));
  nand2  g36(.a(x11), .b(x02), .O(new_n61_));
  nor2   g37(.a(x12), .b(x10), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n45_), .d(new_n44_), .O(new_n63_));
  and2   g39(.a(new_n63_), .b(new_n61_), .O(z5));
  nand2  g40(.a(new_n48_), .b(x03), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n39_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n52_), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n44_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n57_), .d(new_n49_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n61_), .O(z6));
  oai21  g46(.a(new_n39_), .b(x01), .c(new_n46_), .O(new_n71_));
  oai21  g47(.a(x11), .b(new_n46_), .c(x02), .O(new_n72_));
  nand3  g48(.a(new_n52_), .b(x09), .c(x03), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n49_), .O(z7));
  nand3  g50(.a(new_n61_), .b(new_n48_), .c(x00), .O(new_n75_));
  oai21  g51(.a(new_n73_), .b(x12), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n49_), .O(z8));
endmodule
