...
module FAU ( 
  ...
  or2    g02(.a(new_n26_), .b(x13), .O(new_n27_));
  ...
  nand3  g10(.a(new_n34_), .b(new_n31_), .c(new_n28_), .O(new_n35_));
  aoi21  g11(.a(new_n27_), .b(new_n25_), .c(new_n35_), .O(z0));
  nor2   g12(.a(x02), .b(x01), .O(new_n37_));
  inv1   g13(.a(new_n37_), .O(new_n38_));
  nand2  g14(.a(x13), .b(new_n25_), .O(new_n39_));
  nand3  g15(.a(new_n39_), .b(new_n38_), .c(new_n28_), .O(new_n40_));
  nand2  g16(.a(x06), .b(x05), .O(new_n41_));
  oai22  g17(.a(new_n41_), .b(new_n30_), .c(new_n26_), .d(x03), .O(new_n42_));
  ...
  nand2  g37(.a(new_n55_), .b(new_n39_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n59_), .c(new_n62_), .O(z4));
  nand3  g39(.a(new_n44_), .b(new_n54_), .c(new_n28_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(x05), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x13), .O(z5));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n28_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n60_), .c(new_n44_), .d(new_n39_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n37_), .c(new_n69_), .O(z6));
  and2   g46(.a(new_n44_), .b(new_n39_), .O(new_n71_));
  nand3  g47(.a(new_n37_), .b(x09), .c(x03), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  oai21  g49(.a(new_n38_), .b(new_n29_), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(z7));
  oai22  g51(.a(new_n72_), .b(x12), .c(x09), .d(new_n28_), .O(new_n76_));
