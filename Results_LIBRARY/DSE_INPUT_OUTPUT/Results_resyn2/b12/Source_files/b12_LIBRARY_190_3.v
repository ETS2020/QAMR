...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x02), .O(new_n26_));
  ...
  nor2   g07(.a(x04), .b(new_n31_), .O(new_n32_));
  ...
  oai21  g11(.a(new_n35_), .b(x13), .c(x02), .O(new_n36_));
  ...
  aoi22  g28(.a(new_n52_), .b(new_n31_), .c(new_n45_), .d(new_n28_), .O(z2));
  ...
  nor2   g35(.a(x12), .b(x02), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n47_), .c(x13), .d(new_n25_), .O(z5));
  xor2a  g37(.a(x09), .b(x03), .O(new_n62_));
  nor3   g38(.a(new_n62_), .b(x02), .c(x01), .O(new_n63_));
  inv1   g39(.a(new_n57_), .O(new_n64_));
  nand4  g40(.a(x14), .b(x02), .c(x01), .d(new_n25_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(new_n26_), .O(z6));
  aoi21  g43(.a(x03), .b(new_n29_), .c(x08), .O(new_n68_));
  nand3  g44(.a(x09), .b(x03), .c(new_n29_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n31_), .O(new_n71_));
  aoi21  g47(.a(new_n44_), .b(x02), .c(new_n50_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(new_n27_), .O(z7));
  inv1   g49(.a(new_n60_), .O(new_n74_));
  oai22  g50(.a(new_n69_), .b(new_n74_), .c(x09), .d(new_n25_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n47_), .c(new_n27_), .O(z8));
endmodule
