...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n37_, new_n41_;
  ...
  aoi21  g14(.a(new_n23_), .b(x0), .c(x1), .O(z04));
  nand2  g15(.a(new_n26_), .b(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n29_), .O(z05));
  nor2   g17(.a(new_n37_), .b(new_n32_), .O(z06));
  nor2   g18(.a(new_n37_), .b(new_n34_), .O(z07));
  nand2  g19(.a(x1), .b(new_n25_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n23_), .O(z08));
  nor2   g21(.a(new_n41_), .b(new_n29_), .O(z09));
  nor2   g22(.a(new_n41_), .b(new_n32_), .O(z10));
  aoi21  g23(.a(new_n34_), .b(x1), .c(x0), .O(z11));
  inv1   g24(.a(new_n27_), .O(z14));
  zero   g25(.O(z12));
  zero   g26(.O(z13));
  zero   g27(.O(z15));
endmodule
