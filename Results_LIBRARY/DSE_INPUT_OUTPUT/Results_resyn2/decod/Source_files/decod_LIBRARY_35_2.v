...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n36_, new_n40_, new_n42_, new_n43_,
  ...
  aoi21  g11(.a(new_n32_), .b(x4), .c(new_n31_), .O(z03));
  ...
  aoi21  g22(.a(new_n43_), .b(x4), .c(new_n31_), .O(z08));
  nand2  g23(.a(x1), .b(new_n42_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n26_), .O(z09));
  nand3  g25(.a(x3), .b(new_n28_), .c(new_n42_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(new_n31_), .O(z10));
  nor2   g27(.a(new_n45_), .b(new_n40_), .O(z11));
  nand2  g28(.a(new_n31_), .b(new_n42_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n23_), .c(new_n35_), .O(z12));
  nor2   g30(.a(new_n50_), .b(new_n26_), .O(z13));
  oai21  g31(.a(new_n50_), .b(new_n29_), .c(new_n35_), .O(z14));
  nor2   g32(.a(new_n50_), .b(new_n40_), .O(z15));
endmodule
