...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n35_, new_n36_, new_n39_, new_n43_, new_n47_;
  ...
  oai21  g18(.a(new_n39_), .b(new_n29_), .c(new_n36_), .O(z10));
  xnor2a g19(.a(x1), .b(x0), .O(new_n43_));
  aoi21  g20(.a(new_n32_), .b(new_n31_), .c(new_n43_), .O(z11));
  aoi21  g21(.a(new_n23_), .b(new_n31_), .c(x1), .O(z12));
  aoi21  g22(.a(new_n26_), .b(new_n31_), .c(x1), .O(z13));
  nand2  g23(.a(new_n35_), .b(new_n31_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n29_), .O(z14));
  aoi21  g25(.a(new_n32_), .b(new_n31_), .c(x1), .O(z15));
  zero   g26(.O(z04));
  zero   g27(.O(z07));
