...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n35_, new_n38_, new_n40_, new_n41_, new_n44_, new_n46_;
  ...
  nand2  g10(.a(new_n31_), .b(x0), .O(new_n35_));
  nor2   g11(.a(new_n35_), .b(new_n28_), .O(z06));
  nor2   g12(.a(new_n22_), .b(x3), .O(z07));
  nand3  g13(.a(x4), .b(x3), .c(x2), .O(new_n38_));
  nor3   g14(.a(new_n38_), .b(new_n31_), .c(x0), .O(z08));
  inv1   g15(.a(x0), .O(new_n40_));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n40_), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(x3), .c(new_n22_), .O(z10));
  nand3  g18(.a(x2), .b(new_n31_), .c(new_n40_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x3), .c(new_n22_), .O(z12));
  nand2  g20(.a(new_n31_), .b(new_n40_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n28_), .O(z14));
  zero   g22(.O(z01));
  zero   g23(.O(z03));
  zero   g24(.O(z05));
  zero   g25(.O(z11));
