...
module FAU ( 
  ...
  nor2   g25(.a(new_n44_), .b(new_n28_), .O(z09));
  nor2   g26(.a(new_n44_), .b(new_n31_), .O(z10));
  nor2   g27(.a(new_n44_), .b(new_n33_), .O(z11));
  nand2  g28(.a(new_n35_), .b(new_n43_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n45_), .O(z12));
  ...
  oai21  g33(.a(new_n50_), .b(new_n33_), .c(new_n27_), .O(z15));
endmodule
