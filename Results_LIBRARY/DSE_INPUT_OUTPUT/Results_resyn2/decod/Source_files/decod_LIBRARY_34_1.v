...
module FAU ( 
  ...
  nor2   g16(.a(new_n38_), .b(new_n30_), .O(z06));
  nand3  g17(.a(x4), .b(new_n25_), .c(x0), .O(new_n40_));
  aoi21  g18(.a(new_n40_), .b(new_n29_), .c(x1), .O(z07));
  ...
  oai21  g25(.a(new_n46_), .b(new_n32_), .c(new_n35_), .O(z11));
  nand2  g26(.a(new_n34_), .b(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n30_), .O(z14));
  nor2   g28(.a(new_n49_), .b(new_n32_), .O(z15));
  zero   g29(.O(z05));
  inv1   g30(.a(new_n35_), .O(z12));
