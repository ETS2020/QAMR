...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n33_, new_n34_, new_n38_, new_n41_, new_n42_, new_n44_,
    new_n46_, new_n50_;
  ...
  inv1   g14(.a(new_n34_), .O(z04));
  nand3  g15(.a(new_n22_), .b(new_n33_), .c(x0), .O(new_n38_));
  ...
  nand3  g23(.a(new_n22_), .b(x1), .c(new_n41_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n29_), .O(z10));
  nor2   g25(.a(new_n46_), .b(new_n32_), .O(z11));
  nand3  g26(.a(new_n22_), .b(new_n33_), .c(new_n41_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n29_), .O(z14));
  nor2   g28(.a(new_n50_), .b(new_n32_), .O(z15));
  zero   g29(.O(z05));
  zero   g30(.O(z13));
