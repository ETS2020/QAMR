...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n38_, new_n42_, new_n44_, new_n45_;
  ...
  aoi21  g14(.a(new_n23_), .b(x1), .c(new_n38_), .O(z08));
  aoi21  g15(.a(new_n26_), .b(new_n22_), .c(new_n38_), .O(z09));
  aoi21  g16(.a(new_n29_), .b(x1), .c(new_n38_), .O(z10));
  nand2  g17(.a(x1), .b(new_n22_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n31_), .O(z11));
  inv1   g19(.a(x1), .O(new_n44_));
  nand2  g20(.a(new_n44_), .b(new_n22_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n23_), .O(z12));
  aoi21  g22(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  nor2   g23(.a(new_n45_), .b(new_n29_), .O(z14));
  aoi21  g24(.a(new_n31_), .b(new_n22_), .c(x1), .O(z15));
  zero   g25(.O(z04));
  zero   g26(.O(z05));
  zero   g27(.O(z07));
endmodule
