...
module FAU ( 
  ...
  aoi21  g16(.a(new_n29_), .b(new_n25_), .c(x1), .O(z07));
  inv1   g17(.a(x0), .O(new_n40_));
  nand3  g18(.a(x4), .b(x2), .c(new_n40_), .O(new_n41_));
  aoi21  g19(.a(new_n41_), .b(x1), .c(new_n25_), .O(z08));
  ...
  oai21  g24(.a(new_n43_), .b(new_n31_), .c(new_n37_), .O(z11));
  aoi21  g25(.a(new_n41_), .b(new_n25_), .c(x1), .O(z13));
  nand2  g26(.a(new_n34_), .b(new_n40_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n31_), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z14));
  inv1   g30(.a(new_n37_), .O(z12));
endmodule
