...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n36_, new_n41_, new_n42_, new_n45_,
  ...
  nor2   g17(.a(new_n36_), .b(new_n29_), .O(z06));
  ...
  oai21  g22(.a(new_n42_), .b(new_n26_), .c(new_n32_), .O(z09));
  nand3  g23(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(x4), .c(new_n25_), .O(z10));
  oai21  g25(.a(new_n42_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand3  g26(.a(x2), .b(new_n35_), .c(new_n41_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n25_), .O(z12));
  nand2  g28(.a(new_n35_), .b(new_n41_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n26_), .c(new_n32_), .O(z13));
  nand3  g30(.a(new_n28_), .b(new_n35_), .c(new_n41_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(new_n25_), .O(z14));
