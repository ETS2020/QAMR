...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n34_, new_n36_, new_n39_, new_n42_, new_n44_,
  ...
  nor3   g15(.a(new_n26_), .b(x1), .c(new_n36_), .O(z04));
