...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n38_, new_n41_, new_n42_, new_n44_,
  ...
  nand2  g24(.a(new_n45_), .b(x3), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n26_), .c(new_n46_), .O(z09));
  nand3  g26(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n22_), .O(z10));
  nor2   g28(.a(new_n44_), .b(new_n31_), .O(z11));
  nand2  g29(.a(new_n33_), .b(new_n41_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n35_), .O(z12));
  oai21  g31(.a(new_n51_), .b(new_n26_), .c(new_n46_), .O(z13));
  nor2   g32(.a(new_n51_), .b(new_n29_), .O(z14));
  oai21  g33(.a(new_n51_), .b(new_n31_), .c(new_n46_), .O(z15));
endmodule
