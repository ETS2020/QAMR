...
module FAU ( 
  ...
  oai21  g19(.a(new_n40_), .b(new_n34_), .c(new_n39_), .O(z06));
  nand3  g20(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n34_), .c(new_n39_), .O(z07));
  inv1   g22(.a(x0), .O(new_n44_));
  nand2  g23(.a(x1), .b(new_n44_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(z08));
  nand3  g25(.a(new_n26_), .b(x2), .c(new_n44_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(new_n25_), .O(z09));
  nand3  g27(.a(x3), .b(new_n29_), .c(new_n44_), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(x4), .c(new_n25_), .O(z10));
  nor2   g29(.a(new_n45_), .b(new_n32_), .O(z11));
  nand2  g30(.a(new_n25_), .b(new_n44_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n23_), .c(new_n39_), .O(z12));
  oai21  g32(.a(new_n52_), .b(new_n36_), .c(new_n39_), .O(z13));
  nor2   g33(.a(new_n52_), .b(new_n40_), .O(z14));
  oai21  g34(.a(new_n52_), .b(new_n42_), .c(new_n39_), .O(z15));
endmodule
