...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n40_, new_n43_, new_n46_;
  inv1   g00(.a(x0), .O(new_n22_));
  inv1   g01(.a(x1), .O(new_n23_));
  nor2   g02(.a(new_n23_), .b(new_n22_), .O(z00));
  nand2  g03(.a(new_n23_), .b(x0), .O(new_n27_));
  ...
  aoi21  g08(.a(new_n31_), .b(new_n23_), .c(new_n22_), .O(z05));
  ...
  aoi21  g14(.a(new_n28_), .b(new_n22_), .c(new_n23_), .O(z08));
  aoi21  g15(.a(new_n31_), .b(new_n22_), .c(new_n23_), .O(z09));
  nand2  g16(.a(x1), .b(new_n22_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n34_), .O(z10));
  aoi21  g18(.a(new_n36_), .b(new_n22_), .c(new_n23_), .O(z11));
  xor2a  g19(.a(x1), .b(x0), .O(new_n43_));
  aoi21  g20(.a(new_n28_), .b(new_n22_), .c(new_n43_), .O(z12));
  aoi21  g21(.a(new_n31_), .b(new_n23_), .c(new_n43_), .O(z13));
  nand2  g22(.a(new_n23_), .b(new_n22_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n34_), .O(z14));
  nor2   g24(.a(new_n46_), .b(new_n36_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z03));
