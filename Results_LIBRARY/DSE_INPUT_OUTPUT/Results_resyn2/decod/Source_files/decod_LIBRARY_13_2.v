...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n35_, new_n37_, new_n41_, new_n42_, new_n45_;
  ...
  aoi21  g16(.a(new_n26_), .b(new_n22_), .c(x2), .O(z07));
  nor3   g17(.a(new_n33_), .b(new_n22_), .c(x0), .O(z08));
  inv1   g18(.a(x0), .O(new_n41_));
  nand3  g19(.a(x4), .b(new_n25_), .c(new_n41_), .O(new_n42_));
  aoi21  g20(.a(new_n42_), .b(x2), .c(new_n22_), .O(z09));
  nand2  g21(.a(new_n22_), .b(new_n41_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n33_), .O(z12));
  oai21  g23(.a(new_n45_), .b(new_n35_), .c(new_n29_), .O(z13));
  nor2   g24(.a(new_n45_), .b(new_n37_), .O(z14));
  aoi21  g25(.a(new_n42_), .b(new_n22_), .c(x2), .O(z15));
  zero   g26(.O(z03));
  zero   g27(.O(z11));
  inv1   g28(.a(new_n29_), .O(z10));
endmodule
