...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n37_, new_n40_, new_n41_, new_n45_, new_n47_, new_n49_;
  ...
  nor2   g18(.a(new_n41_), .b(new_n34_), .O(z09));
  nor2   g19(.a(new_n41_), .b(new_n37_), .O(z11));
  nand3  g20(.a(x4), .b(x2), .c(new_n40_), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand2  g22(.a(new_n24_), .b(new_n40_), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(new_n34_), .c(new_n22_), .O(z13));
  nand3  g24(.a(x4), .b(x3), .c(new_n29_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n47_), .O(z14));
