...
module FAU ( 
  ...
  nor3   g13(.a(new_n22_), .b(x1), .c(new_n34_), .O(z04));
  ...
  nor2   g19(.a(new_n26_), .b(new_n40_), .O(z09));
  nor2   g20(.a(new_n29_), .b(new_n40_), .O(z10));
  nor2   g21(.a(new_n32_), .b(new_n40_), .O(z11));
  nor2   g22(.a(x1), .b(x0), .O(z15));
  zero   g23(.O(z12));
  zero   g24(.O(z13));
  zero   g25(.O(z14));
endmodule
