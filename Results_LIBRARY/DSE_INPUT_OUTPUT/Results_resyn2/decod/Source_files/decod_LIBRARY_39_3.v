...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n29_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n38_, new_n43_, new_n45_;
  ...
  nor2   g11(.a(new_n34_), .b(new_n29_), .O(z06));
  ...
  nor2   g16(.a(new_n38_), .b(new_n31_), .O(z09));
