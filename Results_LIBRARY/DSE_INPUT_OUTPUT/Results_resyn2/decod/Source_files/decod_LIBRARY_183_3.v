...
module FAU ( 
  ...
  nand3  g03(.a(x2), .b(new_n24_), .c(x0), .O(new_n27_));
  ...
  nand2  g09(.a(new_n24_), .b(x0), .O(new_n33_));
  ...
  aoi21  g14(.a(new_n37_), .b(new_n24_), .c(new_n23_), .O(z07));
  nand3  g15(.a(x2), .b(x1), .c(new_n23_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n28_), .O(z08));
  nor2   g17(.a(new_n39_), .b(new_n31_), .O(z09));
  nand2  g18(.a(x1), .b(new_n23_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n35_), .O(z10));
  aoi21  g20(.a(new_n37_), .b(new_n23_), .c(new_n24_), .O(z11));
  nand3  g21(.a(x2), .b(new_n24_), .c(new_n23_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n28_), .O(z12));
  nor2   g23(.a(new_n45_), .b(new_n31_), .O(z13));
  nand2  g24(.a(new_n24_), .b(new_n23_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n35_), .O(z14));
  xor2a  g26(.a(x1), .b(x0), .O(new_n50_));
  aoi21  g27(.a(new_n37_), .b(new_n23_), .c(new_n50_), .O(z15));
  zero   g28(.O(z00));
  zero   g29(.O(z03));
  nor2   g30(.a(new_n24_), .b(new_n23_), .O(z02));
endmodule
