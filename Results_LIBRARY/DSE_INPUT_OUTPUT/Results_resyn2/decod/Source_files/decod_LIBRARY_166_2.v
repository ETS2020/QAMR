...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n36_, new_n39_, new_n42_, new_n43_;
  ...
  nor2   g15(.a(new_n36_), .b(new_n27_), .O(z09));
  xnor2a g16(.a(x1), .b(x0), .O(new_n39_));
  aoi21  g17(.a(new_n30_), .b(new_n22_), .c(new_n39_), .O(z10));
  aoi21  g18(.a(new_n32_), .b(x1), .c(new_n39_), .O(z11));
  inv1   g19(.a(x1), .O(new_n42_));
  nand2  g20(.a(new_n42_), .b(new_n22_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n43_), .b(new_n27_), .O(z13));
  aoi21  g23(.a(new_n30_), .b(new_n22_), .c(x1), .O(z14));
  nor2   g24(.a(new_n43_), .b(new_n32_), .O(z15));
  zero   g25(.O(z06));
  nor2   g26(.a(x1), .b(new_n22_), .O(z05));
