...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n41_, new_n42_, new_n47_,
    new_n50_;
  ...
  nor2   g22(.a(new_n42_), .b(new_n28_), .O(z09));
  nor2   g23(.a(new_n42_), .b(new_n31_), .O(z10));
  oai21  g24(.a(new_n42_), .b(new_n33_), .c(new_n26_), .O(z11));
  nand2  g25(.a(new_n35_), .b(new_n41_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z12));
  oai21  g27(.a(new_n47_), .b(new_n28_), .c(new_n26_), .O(z13));
  nand3  g28(.a(new_n30_), .b(new_n35_), .c(new_n41_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(new_n27_), .O(z14));
  oai21  g30(.a(new_n47_), .b(new_n33_), .c(new_n26_), .O(z15));
endmodule
