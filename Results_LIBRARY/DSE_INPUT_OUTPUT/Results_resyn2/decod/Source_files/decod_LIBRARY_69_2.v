...
module FAU ( 
  ...
  nor2   g24(.a(new_n43_), .b(new_n39_), .O(z10));
  nand3  g25(.a(new_n25_), .b(new_n29_), .c(new_n42_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(new_n28_), .O(z11));
  nand2  g27(.a(new_n28_), .b(new_n42_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z12));
  nor2   g29(.a(new_n49_), .b(new_n26_), .O(z13));
  oai21  g30(.a(new_n49_), .b(new_n39_), .c(new_n35_), .O(z14));
