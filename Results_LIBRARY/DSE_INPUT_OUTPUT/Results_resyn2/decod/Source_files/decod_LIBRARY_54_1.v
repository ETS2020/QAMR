...
module FAU ( 
  ...
  aoi21  g15(.a(new_n39_), .b(x1), .c(new_n22_), .O(z08));
  nand2  g16(.a(x1), .b(new_n38_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n27_), .O(z09));
  nand3  g18(.a(x4), .b(x3), .c(new_n29_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n41_), .O(z10));
  nand3  g20(.a(new_n26_), .b(new_n29_), .c(new_n38_), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(x1), .c(new_n22_), .O(z11));
  zero   g22(.O(z05));
  zero   g23(.O(z06));
  zero   g24(.O(z07));
  zero   g25(.O(z13));
