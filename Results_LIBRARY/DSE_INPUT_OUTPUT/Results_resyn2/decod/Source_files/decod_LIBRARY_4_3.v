...
module FAU ( 
  ...
  wire new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n42_, new_n44_;
  ...
  aoi21  g09(.a(new_n32_), .b(new_n26_), .c(new_n30_), .O(z05));
  inv1   g10(.a(x2), .O(new_n34_));
  nand3  g11(.a(x4), .b(x3), .c(new_n34_), .O(new_n35_));
  aoi21  g12(.a(new_n35_), .b(new_n26_), .c(new_n30_), .O(z06));
  nand3  g13(.a(x4), .b(new_n31_), .c(new_n34_), .O(new_n37_));
  nor2   g14(.a(new_n37_), .b(new_n27_), .O(z07));
  aoi21  g15(.a(new_n28_), .b(new_n30_), .c(new_n26_), .O(z08));
  aoi21  g16(.a(new_n32_), .b(new_n30_), .c(new_n26_), .O(z09));
  aoi21  g17(.a(new_n35_), .b(new_n30_), .c(new_n26_), .O(z10));
  nand2  g18(.a(x1), .b(new_n30_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n37_), .O(z11));
  nand2  g20(.a(new_n26_), .b(new_n30_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n28_), .O(z12));
  nor2   g22(.a(new_n44_), .b(new_n32_), .O(z13));
  nor2   g23(.a(new_n44_), .b(new_n35_), .O(z14));
  oai21  g24(.a(new_n44_), .b(new_n37_), .c(new_n24_), .O(z15));
  zero   g25(.O(z00));
  zero   g26(.O(z01));
  inv1   g27(.a(new_n24_), .O(z03));
endmodule
