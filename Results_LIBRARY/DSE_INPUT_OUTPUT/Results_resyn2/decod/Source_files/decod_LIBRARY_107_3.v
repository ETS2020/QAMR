...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n37_, new_n40_, new_n41_, new_n44_, new_n46_;
  ...
  nand3  g12(.a(new_n29_), .b(new_n33_), .c(x0), .O(new_n37_));
  aoi21  g13(.a(new_n37_), .b(new_n24_), .c(new_n27_), .O(z07));
  inv1   g14(.a(x0), .O(new_n40_));
  nand2  g15(.a(x1), .b(new_n40_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n25_), .O(z09));
  nand3  g17(.a(new_n29_), .b(x1), .c(new_n40_), .O(new_n44_));
  aoi21  g18(.a(new_n44_), .b(new_n24_), .c(new_n27_), .O(z11));
  nand2  g19(.a(new_n33_), .b(new_n40_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n25_), .O(z13));
  ...
  zero   g25(.O(z08));
  zero   g26(.O(z10));
  nor2   g27(.a(new_n27_), .b(new_n24_), .O(z12));
  nor2   g28(.a(new_n27_), .b(new_n24_), .O(z14));
endmodule
