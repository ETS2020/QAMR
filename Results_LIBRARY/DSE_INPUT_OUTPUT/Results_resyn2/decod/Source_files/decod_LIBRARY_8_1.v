...
module FAU ( 
  ...
  nor3   g12(.a(new_n23_), .b(new_n31_), .c(x0), .O(z08));
  inv1   g13(.a(x0), .O(new_n38_));
  nand3  g14(.a(new_n26_), .b(x1), .c(new_n38_), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(x3), .c(new_n29_), .O(z10));
  nand3  g16(.a(x2), .b(new_n31_), .c(new_n38_), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(x3), .c(new_n29_), .O(z12));
  nand3  g18(.a(new_n26_), .b(new_n31_), .c(new_n38_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(x3), .c(new_n29_), .O(z14));
  zero   g20(.O(z01));
  zero   g21(.O(z05));
  zero   g22(.O(z07));
  zero   g23(.O(z15));
  nor2   g24(.a(new_n29_), .b(x3), .O(z09));
  nor2   g25(.a(new_n29_), .b(x3), .O(z11));
  nor2   g26(.a(new_n29_), .b(x3), .O(z13));
endmodule
