...
module FAU ( 
  ...
  nand3  g10(.a(new_n23_), .b(x1), .c(x0), .O(new_n32_));
  ...
  nor2   g25(.a(new_n46_), .b(new_n29_), .O(z09));
  inv1   g26(.a(new_n24_), .O(z10));
  aoi21  g27(.a(new_n40_), .b(x2), .c(x0), .O(z12));
  nand2  g28(.a(new_n36_), .b(new_n22_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n29_), .O(z13));
  zero   g30(.O(z11));
  zero   g31(.O(z14));
  zero   g32(.O(z15));
endmodule
