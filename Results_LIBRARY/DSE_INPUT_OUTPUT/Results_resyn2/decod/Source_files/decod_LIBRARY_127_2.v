...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n40_, new_n44_, new_n45_;
  ...
  aoi21  g14(.a(new_n23_), .b(new_n22_), .c(new_n37_), .O(z08));
  aoi21  g15(.a(new_n27_), .b(new_n22_), .c(new_n37_), .O(z09));
  nand2  g16(.a(x1), .b(new_n22_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n30_), .O(z10));
  aoi21  g18(.a(new_n32_), .b(new_n22_), .c(new_n37_), .O(z11));
  aoi21  g19(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  inv1   g20(.a(x1), .O(new_n44_));
  nand2  g21(.a(new_n44_), .b(new_n22_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n27_), .O(z13));
  nor2   g23(.a(new_n45_), .b(new_n30_), .O(z14));
  aoi21  g24(.a(new_n32_), .b(new_n22_), .c(x1), .O(z15));
  zero   g25(.O(z04));
  zero   g26(.O(z07));
  nor2   g27(.a(x1), .b(new_n22_), .O(z06));
endmodule
