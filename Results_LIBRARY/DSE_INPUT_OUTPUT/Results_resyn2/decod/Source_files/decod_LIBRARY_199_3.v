...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n36_, new_n39_, new_n40_, new_n43_, new_n45_,
    new_n46_;
  inv1   g00(.a(x1), .O(new_n22_));
  inv1   g01(.a(x3), .O(new_n23_));
  nor2   g02(.a(new_n23_), .b(new_n22_), .O(z00));
  nand2  g03(.a(x1), .b(x0), .O(new_n25_));
  nand3  g04(.a(x4), .b(new_n23_), .c(x2), .O(new_n26_));
  nor2   g05(.a(new_n26_), .b(new_n25_), .O(z01));
  inv1   g06(.a(x2), .O(new_n28_));
  nand3  g07(.a(x4), .b(new_n23_), .c(new_n28_), .O(new_n29_));
  nor2   g08(.a(new_n29_), .b(new_n25_), .O(z03));
  nand3  g09(.a(x4), .b(x2), .c(x0), .O(new_n31_));
  ...
  nand3  g14(.a(new_n28_), .b(new_n22_), .c(x0), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n35_), .O(z06));
  nor2   g16(.a(new_n33_), .b(new_n29_), .O(z07));
  inv1   g17(.a(x0), .O(new_n39_));
  nand3  g18(.a(x4), .b(x2), .c(new_n39_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n23_), .c(new_n22_), .O(z09));
  nand3  g20(.a(x4), .b(new_n28_), .c(new_n39_), .O(new_n43_));
  aoi21  g21(.a(new_n43_), .b(new_n23_), .c(new_n22_), .O(z11));
  nand2  g22(.a(new_n22_), .b(new_n39_), .O(new_n45_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n45_), .O(z12));
  nor2   g25(.a(new_n45_), .b(new_n26_), .O(z13));
  aoi21  g26(.a(new_n43_), .b(new_n22_), .c(new_n23_), .O(z14));
  nor2   g27(.a(new_n45_), .b(new_n29_), .O(z15));
  zero   g28(.O(z10));
