...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n46_;
  ...
  nor2   g13(.a(new_n33_), .b(new_n28_), .O(z06));
  ...
  nand3  g20(.a(x4), .b(new_n37_), .c(x2), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n41_), .O(z09));
  nor2   g22(.a(new_n41_), .b(new_n28_), .O(z10));
  nand3  g23(.a(x4), .b(new_n27_), .c(new_n40_), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(x1), .c(x3), .O(z11));
  nor3   g25(.a(new_n23_), .b(x1), .c(x0), .O(z12));
  aoi21  g26(.a(new_n46_), .b(x3), .c(x1), .O(z14));
  zero   g27(.O(z05));
  zero   g28(.O(z15));
  inv1   g29(.a(new_n38_), .O(z13));
endmodule
