...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n37_, new_n39_, new_n40_, new_n42_, new_n46_,
    new_n48_;
  ...
  inv1   g16(.a(x1), .O(new_n39_));
  nand2  g17(.a(new_n25_), .b(new_n39_), .O(new_n40_));
  inv1   g18(.a(new_n40_), .O(z07));
  nand2  g19(.a(x1), .b(new_n34_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n23_), .O(z08));
  nor2   g21(.a(new_n42_), .b(new_n26_), .O(z09));
  oai21  g22(.a(new_n42_), .b(new_n29_), .c(new_n40_), .O(z10));
  nand3  g23(.a(x4), .b(new_n28_), .c(new_n34_), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(x1), .c(x3), .O(z11));
  nand2  g25(.a(new_n39_), .b(new_n34_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g27(.a(new_n48_), .b(new_n29_), .O(z14));
  zero   g28(.O(z05));
  zero   g29(.O(z15));
