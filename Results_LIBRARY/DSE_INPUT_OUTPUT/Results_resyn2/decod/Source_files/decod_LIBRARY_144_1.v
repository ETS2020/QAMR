...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n38_, new_n45_, new_n46_;
  ...
  aoi21  g17(.a(new_n32_), .b(x0), .c(new_n38_), .O(z07));
  ...
  nand2  g22(.a(new_n28_), .b(new_n45_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n30_), .O(z14));
  nor2   g24(.a(new_n46_), .b(new_n32_), .O(z15));
  zero   g25(.O(z09));
  zero   g26(.O(z11));
  nor2   g27(.a(new_n28_), .b(x0), .O(z10));
endmodule
