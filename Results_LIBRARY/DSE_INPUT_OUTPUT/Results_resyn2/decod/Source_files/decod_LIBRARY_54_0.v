...
module FAU ( 
  ...
  nor2   g24(.a(new_n43_), .b(new_n32_), .O(z10));
  ...
  nand2  g28(.a(new_n22_), .b(new_n42_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n29_), .O(z13));
  nand3  g30(.a(x3), .b(new_n31_), .c(new_n42_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x1), .O(z14));
  nand3  g32(.a(new_n28_), .b(new_n31_), .c(new_n42_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x1), .O(z15));
endmodule
