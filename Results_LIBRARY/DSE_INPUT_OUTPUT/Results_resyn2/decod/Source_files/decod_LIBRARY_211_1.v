...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n41_, new_n42_, new_n46_;
  ...
  nand2  g11(.a(new_n22_), .b(x0), .O(new_n33_));
  nor2   g12(.a(new_n33_), .b(new_n23_), .O(z04));
  nor2   g13(.a(new_n33_), .b(new_n26_), .O(z05));
  nor2   g14(.a(new_n33_), .b(new_n29_), .O(z06));
  nor2   g15(.a(new_n31_), .b(x1), .O(z07));
  nor2   g16(.a(new_n22_), .b(x0), .O(z08));
  inv1   g17(.a(x0), .O(new_n41_));
  nand2  g18(.a(new_n22_), .b(new_n41_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z12));
  nor2   g20(.a(new_n42_), .b(new_n26_), .O(z13));
  aoi21  g21(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  nand3  g22(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n46_));
  nor2   g23(.a(new_n42_), .b(new_n46_), .O(z15));
  zero   g24(.O(z09));
  zero   g25(.O(z10));
