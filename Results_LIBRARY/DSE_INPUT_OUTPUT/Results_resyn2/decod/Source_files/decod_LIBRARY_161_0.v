...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    ...
    new_n44_, new_n45_, new_n50_, new_n52_;
  ...
  nand3  g20(.a(new_n25_), .b(new_n31_), .c(x0), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x4), .c(x1), .O(z07));
  inv1   g22(.a(x0), .O(new_n44_));
  nand2  g23(.a(x1), .b(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n23_), .c(new_n30_), .O(z08));
  oai21  g25(.a(new_n45_), .b(new_n26_), .c(new_n30_), .O(z09));
  oai21  g26(.a(new_n45_), .b(new_n32_), .c(new_n30_), .O(z10));
  oai21  g27(.a(new_n45_), .b(new_n34_), .c(new_n30_), .O(z11));
  nand3  g28(.a(x3), .b(x2), .c(new_n44_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(x1), .O(z12));
  nand2  g30(.a(new_n28_), .b(new_n44_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n26_), .O(z13));
  nor2   g32(.a(new_n52_), .b(new_n32_), .O(z14));
  nor2   g33(.a(new_n52_), .b(new_n34_), .O(z15));
endmodule
