...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n37_, new_n38_, new_n46_;
  ...
  inv1   g19(.a(new_n38_), .O(z09));
  aoi21  g20(.a(new_n23_), .b(new_n31_), .c(x0), .O(z12));
  aoi21  g21(.a(new_n26_), .b(new_n31_), .c(x0), .O(z13));
  nand2  g22(.a(new_n31_), .b(new_n37_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n29_), .O(z14));
  aoi21  g24(.a(new_n32_), .b(new_n31_), .c(x0), .O(z15));
  zero   g25(.O(z08));
  zero   g26(.O(z10));
  inv1   g27(.a(new_n38_), .O(z11));
endmodule
