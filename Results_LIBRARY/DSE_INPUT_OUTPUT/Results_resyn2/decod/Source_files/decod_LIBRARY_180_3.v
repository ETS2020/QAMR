...
module FAU ( 
  ...
  nand3  g11(.a(x3), .b(new_n33_), .c(x0), .O(new_n34_));
  ...
  nor2   g17(.a(new_n36_), .b(new_n30_), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand2  g19(.a(x1), .b(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n25_), .O(z09));
  nand3  g21(.a(x4), .b(new_n29_), .c(new_n42_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n24_), .c(new_n33_), .O(z11));
  nand3  g23(.a(x4), .b(x2), .c(new_n42_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n33_), .c(new_n24_), .O(z12));
  nand2  g25(.a(new_n33_), .b(new_n42_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n25_), .c(new_n27_), .O(z13));
  nand3  g27(.a(x4), .b(x3), .c(new_n29_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n50_), .O(z14));
  oai21  g29(.a(new_n50_), .b(new_n30_), .c(new_n27_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z08));
  zero   g32(.O(z10));
endmodule
