...
module FAU ( 
  ...
  nand2  g13(.a(x2), .b(new_n34_), .O(new_n35_));
  ...
  nand2  g22(.a(x1), .b(new_n40_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(new_n35_), .O(z10));
  nor2   g24(.a(new_n44_), .b(new_n32_), .O(z11));
  nand3  g25(.a(x4), .b(x3), .c(new_n40_), .O(new_n49_));
  aoi21  g26(.a(new_n49_), .b(new_n29_), .c(x1), .O(z14));
  nand3  g27(.a(x4), .b(new_n25_), .c(new_n40_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(new_n29_), .c(x1), .O(z15));
  zero   g29(.O(z12));
  zero   g30(.O(z13));
