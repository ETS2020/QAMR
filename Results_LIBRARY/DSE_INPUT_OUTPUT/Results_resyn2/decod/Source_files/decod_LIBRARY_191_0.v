...
module FAU ( 
  ...
  nor2   g25(.a(new_n43_), .b(new_n31_), .O(z10));
  nand3  g26(.a(new_n30_), .b(x1), .c(new_n42_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(x3), .O(z11));
  nand2  g28(.a(new_n35_), .b(new_n42_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z12));
  nand3  g30(.a(x2), .b(new_n35_), .c(new_n42_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x3), .O(z13));
  nor2   g32(.a(new_n50_), .b(new_n31_), .O(z14));
