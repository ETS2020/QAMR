...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n45_,
    new_n48_;
  ...
  nor2   g18(.a(new_n39_), .b(new_n32_), .O(z07));
  ...
  nor2   g23(.a(new_n45_), .b(new_n24_), .O(z12));
  oai21  g24(.a(new_n45_), .b(new_n34_), .c(new_n30_), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n22_), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n23_), .c(x2), .O(z14));
  nor2   g27(.a(new_n45_), .b(new_n39_), .O(z15));
  zero   g28(.O(z11));
