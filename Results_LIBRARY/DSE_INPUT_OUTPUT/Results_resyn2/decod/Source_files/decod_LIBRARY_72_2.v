...
module FAU ( 
  ...
  nor2   g26(.a(new_n44_), .b(new_n40_), .O(z10));
  nor2   g27(.a(new_n44_), .b(new_n32_), .O(z11));
  nand2  g28(.a(new_n22_), .b(new_n43_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n37_), .O(z12));
  oai21  g30(.a(new_n50_), .b(new_n27_), .c(new_n35_), .O(z13));
  oai21  g31(.a(new_n50_), .b(new_n40_), .c(new_n35_), .O(z14));
