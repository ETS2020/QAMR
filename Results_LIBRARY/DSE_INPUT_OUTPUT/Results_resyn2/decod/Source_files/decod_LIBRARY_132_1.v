...
module FAU ( 
  ...
  aoi21  g16(.a(new_n29_), .b(new_n22_), .c(new_n37_), .O(z06));
  aoi21  g17(.a(new_n31_), .b(new_n22_), .c(new_n37_), .O(z07));
  aoi21  g18(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  aoi21  g19(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g20(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  inv1   g21(.a(x0), .O(new_n47_));
  nand2  g22(.a(new_n22_), .b(new_n47_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n31_), .O(z15));
  zero   g24(.O(z08));
  zero   g25(.O(z09));
  zero   g26(.O(z10));
  zero   g27(.O(z11));
