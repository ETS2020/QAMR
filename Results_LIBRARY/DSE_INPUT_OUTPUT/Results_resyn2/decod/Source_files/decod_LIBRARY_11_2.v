...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n36_, new_n37_, new_n40_, new_n43_,
  ...
  nor2   g17(.a(new_n36_), .b(new_n26_), .O(z05));
  nand3  g18(.a(new_n28_), .b(new_n35_), .c(x0), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(x4), .c(new_n22_), .O(z06));
  oai21  g20(.a(new_n36_), .b(new_n33_), .c(new_n32_), .O(z07));
  ...
  oai21  g28(.a(new_n46_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand2  g29(.a(new_n35_), .b(new_n43_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n37_), .O(z12));
  oai21  g31(.a(new_n51_), .b(new_n26_), .c(new_n32_), .O(z13));
  nor2   g32(.a(new_n51_), .b(new_n29_), .O(z14));
  nor2   g33(.a(new_n51_), .b(new_n33_), .O(z15));
endmodule
