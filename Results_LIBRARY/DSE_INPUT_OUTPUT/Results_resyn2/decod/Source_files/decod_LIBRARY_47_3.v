...
module FAU ( 
  ...
  nor2   g21(.a(new_n42_), .b(new_n40_), .O(z11));
  nand3  g22(.a(x4), .b(x2), .c(new_n39_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand2  g24(.a(new_n24_), .b(new_n39_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n34_), .c(new_n22_), .O(z13));
  nand3  g26(.a(x4), .b(new_n28_), .c(new_n39_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n24_), .c(new_n25_), .O(z14));
  oai21  g28(.a(new_n46_), .b(new_n42_), .c(new_n22_), .O(z15));
