...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n37_, new_n43_;
  ...
  nor2   g16(.a(new_n37_), .b(new_n23_), .O(z08));
  oai21  g17(.a(new_n37_), .b(new_n26_), .c(new_n35_), .O(z09));
  nor2   g18(.a(new_n37_), .b(new_n30_), .O(z10));
  nor2   g19(.a(new_n37_), .b(new_n32_), .O(z11));
  aoi21  g20(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand2  g21(.a(new_n34_), .b(new_n22_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n26_), .O(z13));
  aoi21  g23(.a(new_n30_), .b(new_n22_), .c(x1), .O(z14));
  aoi21  g24(.a(new_n32_), .b(new_n22_), .c(x1), .O(z15));
  inv1   g25(.a(new_n35_), .O(z05));
  inv1   g26(.a(new_n35_), .O(z06));
  inv1   g27(.a(new_n35_), .O(z07));
endmodule
