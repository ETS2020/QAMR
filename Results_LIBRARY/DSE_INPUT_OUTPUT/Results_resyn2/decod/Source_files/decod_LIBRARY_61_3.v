...
module FAU ( 
  ...
  nand2  g13(.a(x1), .b(new_n23_), .O(new_n37_));
  nor2   g14(.a(new_n37_), .b(new_n27_), .O(z08));
  aoi21  g15(.a(new_n30_), .b(new_n23_), .c(new_n24_), .O(z09));
  nor2   g16(.a(new_n37_), .b(new_n33_), .O(z10));
  nor2   g17(.a(new_n37_), .b(new_n35_), .O(z11));
  nand2  g18(.a(new_n24_), .b(new_n23_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n27_), .O(z12));
  nor2   g20(.a(new_n42_), .b(new_n30_), .O(z13));
  nor2   g21(.a(new_n42_), .b(new_n33_), .O(z14));
  nor2   g22(.a(new_n42_), .b(new_n35_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z03));
