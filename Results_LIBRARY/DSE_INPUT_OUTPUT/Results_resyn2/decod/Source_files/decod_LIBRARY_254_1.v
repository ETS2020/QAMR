...
module FAU ( 
  ...
  aoi21  g14(.a(new_n26_), .b(x0), .c(new_n35_), .O(z05));
  aoi21  g15(.a(new_n29_), .b(x0), .c(new_n35_), .O(z06));
  aoi21  g16(.a(new_n31_), .b(x0), .c(new_n35_), .O(z07));
  nor2   g17(.a(new_n22_), .b(x0), .O(z09));
  nand2  g18(.a(new_n22_), .b(new_n33_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z12));
  nor2   g20(.a(new_n42_), .b(new_n26_), .O(z13));
  nor2   g21(.a(new_n42_), .b(new_n29_), .O(z14));
