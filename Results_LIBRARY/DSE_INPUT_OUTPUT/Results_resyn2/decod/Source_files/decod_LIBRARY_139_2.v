...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n38_, new_n40_, new_n41_, new_n42_,
  ...
  inv1   g18(.a(x4), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x1), .O(new_n41_));
  nand3  g20(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n34_), .c(new_n41_), .O(z07));
  ...
  oai21  g32(.a(new_n53_), .b(new_n35_), .c(new_n41_), .O(z12));
  nor2   g33(.a(new_n53_), .b(new_n26_), .O(z13));
  oai21  g34(.a(new_n53_), .b(new_n38_), .c(new_n41_), .O(z14));
  oai21  g35(.a(new_n53_), .b(new_n42_), .c(new_n41_), .O(z15));
endmodule
