...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n39_, new_n40_, new_n41_, new_n43_,
    new_n46_;
  ...
  aoi21  g13(.a(new_n34_), .b(x2), .c(new_n25_), .O(z04));
  nand2  g14(.a(new_n33_), .b(x0), .O(new_n36_));
  oai21  g15(.a(new_n36_), .b(new_n26_), .c(new_n29_), .O(z05));
  nor2   g16(.a(new_n36_), .b(new_n31_), .O(z07));
  nand2  g17(.a(x3), .b(x2), .O(new_n39_));
  inv1   g18(.a(x0), .O(new_n40_));
  nand3  g19(.a(x4), .b(x1), .c(new_n40_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n39_), .O(z08));
  nand2  g21(.a(x1), .b(new_n40_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n26_), .c(new_n29_), .O(z09));
  aoi21  g23(.a(new_n41_), .b(new_n25_), .c(x2), .O(z11));
  nand2  g24(.a(new_n33_), .b(new_n40_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g26(.a(new_n46_), .b(new_n26_), .O(z13));
  nor2   g27(.a(new_n46_), .b(new_n31_), .O(z15));
  inv1   g28(.a(new_n29_), .O(z06));
  inv1   g29(.a(new_n29_), .O(z10));
  inv1   g30(.a(new_n29_), .O(z14));
endmodule
