...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n38_, new_n41_, new_n42_, new_n45_, new_n48_;
  ...
  aoi21  g14(.a(new_n35_), .b(new_n27_), .c(new_n24_), .O(z06));
  ...
  aoi21  g19(.a(new_n42_), .b(new_n24_), .c(new_n27_), .O(z09));
  aoi21  g20(.a(new_n42_), .b(new_n27_), .c(new_n24_), .O(z10));
  nand2  g21(.a(x1), .b(new_n41_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n31_), .c(new_n30_), .O(z11));
  nand2  g23(.a(new_n34_), .b(new_n41_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n25_), .O(z13));
  nor2   g25(.a(new_n48_), .b(new_n28_), .O(z14));
  oai21  g26(.a(new_n48_), .b(new_n31_), .c(new_n30_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z08));
  zero   g29(.O(z12));
endmodule
