...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n36_, new_n39_, new_n40_, new_n41_, new_n46_,
    new_n49_;
  ...
  nor2   g21(.a(new_n40_), .b(new_n28_), .O(z09));
  nor2   g22(.a(new_n40_), .b(new_n31_), .O(z10));
  nor2   g23(.a(new_n40_), .b(new_n33_), .O(z11));
  nand3  g24(.a(x4), .b(x2), .c(new_n39_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n22_), .c(x1), .O(z13));
  nand2  g26(.a(new_n25_), .b(new_n39_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n33_), .O(z15));
  zero   g28(.O(z14));
  inv1   g29(.a(new_n26_), .O(z06));
  inv1   g30(.a(new_n26_), .O(z12));
endmodule
