...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n40_, new_n41_, new_n44_, new_n46_,
    new_n48_;
  ...
  nand2  g23(.a(x1), .b(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n32_), .O(z11));
  nand3  g25(.a(x2), .b(new_n34_), .c(new_n40_), .O(new_n48_));
