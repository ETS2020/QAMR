...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(new_n26_), .c(new_n35_), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(x0), .c(new_n25_), .O(z05));
  ...
  nand2  g24(.a(x1), .b(new_n29_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n33_), .O(z11));
  aoi21  g26(.a(new_n36_), .b(new_n25_), .c(x0), .O(z14));
  nand2  g27(.a(new_n35_), .b(new_n29_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n33_), .O(z15));
  zero   g29(.O(z12));
  zero   g30(.O(z13));
  inv1   g31(.a(new_n30_), .O(z09));
endmodule
