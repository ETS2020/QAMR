...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n36_, new_n38_, new_n40_, new_n45_;
  ...
  oai21  g19(.a(new_n40_), .b(new_n29_), .c(new_n32_), .O(z06));
  nor2   g20(.a(new_n40_), .b(new_n33_), .O(z07));
  nand2  g21(.a(x1), .b(new_n31_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n29_), .O(z10));
  nor2   g23(.a(new_n45_), .b(new_n33_), .O(z11));
  aoi21  g24(.a(new_n36_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g25(.a(new_n38_), .b(new_n22_), .c(x0), .O(z15));
  zero   g26(.O(z08));
  zero   g27(.O(z09));
  zero   g28(.O(z12));
  zero   g29(.O(z13));
