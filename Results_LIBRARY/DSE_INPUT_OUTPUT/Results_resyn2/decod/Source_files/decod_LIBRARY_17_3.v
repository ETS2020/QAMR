...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n41_, new_n43_, new_n45_;
  ...
  nor2   g18(.a(new_n41_), .b(new_n36_), .O(z11));
  nand2  g19(.a(new_n23_), .b(new_n22_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n28_), .O(z12));
  xor2a  g21(.a(x1), .b(x0), .O(new_n45_));
  aoi21  g22(.a(new_n31_), .b(new_n22_), .c(new_n45_), .O(z13));
  aoi21  g23(.a(new_n34_), .b(new_n23_), .c(new_n45_), .O(z14));
