...
module FAU ( 
  ...
  nand2  g13(.a(x4), .b(new_n25_), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n33_), .O(z05));
  nand2  g15(.a(new_n22_), .b(x0), .O(new_n38_));
  oai21  g16(.a(new_n38_), .b(new_n29_), .c(new_n26_), .O(z06));
  ...
  nand3  g24(.a(x2), .b(new_n22_), .c(new_n42_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n34_), .O(z12));
  nor2   g26(.a(new_n49_), .b(new_n36_), .O(z13));
  nand2  g27(.a(new_n22_), .b(new_n42_), .O(new_n52_));
