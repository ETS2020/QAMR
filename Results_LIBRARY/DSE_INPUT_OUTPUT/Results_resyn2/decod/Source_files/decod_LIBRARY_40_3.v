...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n34_, new_n36_, new_n37_, new_n40_, new_n41_, new_n43_, new_n46_,
    new_n47_;
  ...
  nand3  g11(.a(x4), .b(new_n29_), .c(x0), .O(new_n34_));
  aoi21  g12(.a(new_n34_), .b(new_n25_), .c(new_n26_), .O(z05));
  nand2  g13(.a(new_n25_), .b(x0), .O(new_n36_));
  nand3  g14(.a(x4), .b(x3), .c(new_n26_), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n36_), .O(z06));
  oai21  g16(.a(new_n36_), .b(new_n30_), .c(new_n23_), .O(z07));
  inv1   g17(.a(x0), .O(new_n40_));
  nand3  g18(.a(x4), .b(x3), .c(new_n40_), .O(new_n41_));
  aoi21  g19(.a(new_n41_), .b(new_n26_), .c(new_n25_), .O(z10));
  nand2  g20(.a(x1), .b(new_n40_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n30_), .O(z11));
  aoi21  g22(.a(new_n41_), .b(new_n25_), .c(new_n26_), .O(z12));
  nand2  g23(.a(new_n25_), .b(new_n40_), .O(new_n46_));
  nand3  g24(.a(x4), .b(new_n29_), .c(x2), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n46_), .O(z13));
  oai21  g26(.a(new_n46_), .b(new_n37_), .c(new_n23_), .O(z14));
  oai21  g27(.a(new_n46_), .b(new_n30_), .c(new_n23_), .O(z15));
  zero   g28(.O(z00));
  inv1   g29(.a(new_n23_), .O(z08));
