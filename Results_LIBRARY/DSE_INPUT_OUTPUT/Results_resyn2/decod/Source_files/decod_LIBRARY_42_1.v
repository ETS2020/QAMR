...
module FAU ( 
  ...
  aoi21  g17(.a(new_n32_), .b(new_n25_), .c(new_n37_), .O(z07));
  nor2   g18(.a(new_n25_), .b(x0), .O(z08));
  aoi21  g19(.a(new_n23_), .b(new_n25_), .c(x0), .O(z12));
  aoi21  g20(.a(new_n27_), .b(new_n25_), .c(x0), .O(z13));
  aoi21  g21(.a(new_n30_), .b(new_n25_), .c(x0), .O(z14));
  aoi21  g22(.a(new_n32_), .b(new_n25_), .c(x0), .O(z15));
  zero   g23(.O(z09));
  zero   g24(.O(z10));
  nor2   g25(.a(new_n25_), .b(x0), .O(z11));
endmodule
