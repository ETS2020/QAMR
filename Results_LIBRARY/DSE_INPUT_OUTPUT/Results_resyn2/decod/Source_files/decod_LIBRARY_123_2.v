...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n38_, new_n41_, new_n45_, new_n48_;
  ...
  nand3  g16(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n38_));
  nor2   g17(.a(new_n38_), .b(new_n32_), .O(z07));
  nor3   g18(.a(new_n24_), .b(new_n23_), .c(x0), .O(z08));
  nand3  g19(.a(x4), .b(new_n26_), .c(new_n22_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x2), .c(new_n23_), .O(z09));
  nand2  g21(.a(new_n23_), .b(new_n22_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n24_), .c(new_n30_), .O(z12));
  oai21  g23(.a(new_n45_), .b(new_n34_), .c(new_n30_), .O(z13));
  nand3  g24(.a(x4), .b(x3), .c(new_n22_), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(new_n23_), .c(x2), .O(z14));
  aoi21  g26(.a(new_n41_), .b(new_n23_), .c(x2), .O(z15));
  zero   g27(.O(z10));
  zero   g28(.O(z11));
