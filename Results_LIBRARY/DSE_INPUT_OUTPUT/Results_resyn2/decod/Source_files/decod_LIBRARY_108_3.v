...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n37_, new_n39_, new_n40_, new_n43_, new_n45_, new_n47_;
  ...
  nand3  g20(.a(x4), .b(x2), .c(new_n39_), .O(new_n43_));
  aoi21  g21(.a(new_n43_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand2  g22(.a(new_n24_), .b(new_n39_), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n34_), .c(new_n22_), .O(z13));
  nand3  g24(.a(x4), .b(new_n29_), .c(new_n39_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(new_n24_), .c(new_n25_), .O(z14));
