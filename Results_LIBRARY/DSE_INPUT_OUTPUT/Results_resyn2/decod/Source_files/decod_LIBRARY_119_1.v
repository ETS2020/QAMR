...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n36_,
    new_n37_, new_n39_, new_n43_, new_n47_, new_n48_;
  ...
  aoi21  g06(.a(new_n22_), .b(new_n25_), .c(x2), .O(z03));
  ...
  aoi21  g11(.a(new_n31_), .b(new_n25_), .c(x2), .O(z07));
  inv1   g12(.a(x0), .O(new_n36_));
  nand3  g13(.a(x4), .b(x1), .c(new_n36_), .O(new_n37_));
  aoi21  g14(.a(new_n37_), .b(x2), .c(new_n25_), .O(z08));
  xnor2a g15(.a(x3), .b(x2), .O(new_n39_));
  aoi21  g16(.a(new_n37_), .b(new_n25_), .c(new_n39_), .O(z09));
  nor2   g17(.a(new_n25_), .b(x2), .O(z10));
  aoi21  g18(.a(new_n37_), .b(new_n25_), .c(x2), .O(z11));
  nand3  g19(.a(x4), .b(new_n30_), .c(new_n36_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(x2), .c(new_n25_), .O(z12));
  nor2   g21(.a(new_n43_), .b(new_n26_), .O(z13));
  inv1   g22(.a(x2), .O(new_n47_));
