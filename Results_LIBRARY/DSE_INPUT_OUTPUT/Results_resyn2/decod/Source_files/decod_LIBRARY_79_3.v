...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n38_, new_n39_, new_n41_, new_n43_, new_n44_;
  ...
  aoi21  g18(.a(new_n41_), .b(new_n23_), .c(new_n24_), .O(z11));
  nand2  g19(.a(new_n32_), .b(new_n38_), .O(new_n43_));
  nand3  g20(.a(x4), .b(new_n23_), .c(x2), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n43_), .O(z13));
  nor2   g22(.a(new_n43_), .b(new_n30_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z06));
