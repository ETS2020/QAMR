...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n29_, new_n32_, new_n33_,
    new_n36_, new_n38_, new_n39_, new_n44_, new_n45_;
  ...
  aoi21  g11(.a(new_n33_), .b(new_n24_), .c(new_n23_), .O(z05));
  aoi21  g12(.a(new_n33_), .b(new_n23_), .c(new_n24_), .O(z06));
  xor2a  g13(.a(x3), .b(x2), .O(new_n36_));
  aoi21  g14(.a(new_n33_), .b(new_n24_), .c(new_n36_), .O(z07));
  inv1   g15(.a(x0), .O(new_n38_));
  nand3  g16(.a(x4), .b(x1), .c(new_n38_), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(new_n24_), .c(new_n23_), .O(z09));
  nor2   g18(.a(new_n39_), .b(new_n27_), .O(z10));
  aoi21  g19(.a(new_n39_), .b(new_n24_), .c(new_n36_), .O(z11));
  nand3  g20(.a(x4), .b(new_n32_), .c(new_n38_), .O(new_n44_));
  nand2  g21(.a(new_n24_), .b(x2), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n44_), .O(z13));
  aoi21  g23(.a(new_n44_), .b(new_n23_), .c(new_n24_), .O(z14));
  nor2   g24(.a(new_n44_), .b(new_n29_), .O(z15));
  zero   g25(.O(z00));
  zero   g26(.O(z12));
