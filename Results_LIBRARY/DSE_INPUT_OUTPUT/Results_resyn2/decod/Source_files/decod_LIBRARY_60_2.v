...
module FAU ( 
  ...
  aoi21  g17(.a(new_n26_), .b(new_n22_), .c(x2), .O(z07));
  ...
  nor2   g22(.a(new_n44_), .b(new_n27_), .O(z09));
  nand2  g23(.a(new_n22_), .b(new_n41_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n34_), .O(z12));
  oai21  g25(.a(new_n46_), .b(new_n36_), .c(new_n31_), .O(z13));
  aoi21  g26(.a(new_n42_), .b(new_n22_), .c(x2), .O(z14));
  aoi21  g27(.a(new_n44_), .b(new_n22_), .c(x2), .O(z15));
  zero   g28(.O(z02));
  inv1   g29(.a(new_n31_), .O(z10));
