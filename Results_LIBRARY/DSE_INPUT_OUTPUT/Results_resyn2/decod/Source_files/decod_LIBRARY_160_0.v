...
module FAU ( 
  ...
  oai21  g24(.a(new_n42_), .b(new_n26_), .c(new_n45_), .O(z09));
  nand3  g25(.a(new_n29_), .b(x1), .c(new_n41_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n28_), .O(z10));
  nor2   g27(.a(new_n47_), .b(new_n32_), .O(z11));
  nand2  g28(.a(new_n34_), .b(new_n41_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n23_), .c(new_n45_), .O(z12));
  oai21  g30(.a(new_n50_), .b(new_n26_), .c(new_n45_), .O(z13));
  nand3  g31(.a(new_n29_), .b(new_n34_), .c(new_n41_), .O(new_n53_));
