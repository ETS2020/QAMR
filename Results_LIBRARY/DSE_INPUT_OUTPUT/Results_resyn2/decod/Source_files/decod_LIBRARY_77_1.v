...
module FAU ( 
  ...
  aoi21  g19(.a(new_n40_), .b(x1), .c(new_n27_), .O(z08));
  ...
  oai21  g24(.a(new_n42_), .b(new_n33_), .c(new_n26_), .O(z11));
  aoi21  g25(.a(new_n40_), .b(new_n27_), .c(x1), .O(z13));
  aoi21  g26(.a(new_n44_), .b(new_n27_), .c(x1), .O(z15));
  zero   g27(.O(z14));
  inv1   g28(.a(new_n26_), .O(z06));
  inv1   g29(.a(new_n26_), .O(z12));
endmodule
