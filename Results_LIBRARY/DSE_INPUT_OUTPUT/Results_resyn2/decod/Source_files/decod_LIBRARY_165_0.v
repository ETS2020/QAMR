...
module FAU ( 
  ...
  oai21  g22(.a(new_n41_), .b(new_n31_), .c(new_n29_), .O(z10));
  nand3  g23(.a(x4), .b(new_n30_), .c(new_n40_), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(x1), .c(x3), .O(z11));
  aoi21  g25(.a(new_n43_), .b(x3), .c(x1), .O(z12));
  aoi21  g26(.a(new_n46_), .b(x3), .c(x1), .O(z14));
  zero   g27(.O(z05));
  inv1   g28(.a(new_n29_), .O(z13));
  inv1   g29(.a(new_n29_), .O(z15));
endmodule
