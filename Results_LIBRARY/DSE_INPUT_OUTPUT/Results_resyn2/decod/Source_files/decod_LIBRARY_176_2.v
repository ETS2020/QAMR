...
module FAU ( 
  ...
  nand2  g11(.a(new_n33_), .b(x2), .O(new_n34_));
  inv1   g12(.a(new_n34_), .O(z05));
  nor2   g13(.a(new_n31_), .b(new_n27_), .O(z06));
  aoi21  g14(.a(new_n31_), .b(new_n26_), .c(x3), .O(z07));
  inv1   g15(.a(x0), .O(new_n38_));
  nand3  g16(.a(x4), .b(x1), .c(new_n38_), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(x3), .c(new_n26_), .O(z08));
  nor2   g18(.a(new_n39_), .b(new_n27_), .O(z10));
  aoi21  g19(.a(new_n39_), .b(new_n26_), .c(x3), .O(z11));
  nand3  g20(.a(x4), .b(new_n30_), .c(new_n38_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n22_), .O(z12));
  oai21  g22(.a(new_n44_), .b(new_n27_), .c(new_n34_), .O(z14));
  nand2  g23(.a(new_n33_), .b(new_n26_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n44_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z09));
  zero   g27(.O(z13));
endmodule
