...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_, new_n43_,
  ...
  nand3  g17(.a(new_n26_), .b(new_n35_), .c(x0), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x4), .c(new_n22_), .O(z05));
  nor2   g19(.a(new_n36_), .b(new_n31_), .O(z06));
  ...
  oai21  g28(.a(new_n48_), .b(new_n33_), .c(new_n30_), .O(z11));
  ...
  nor2   g32(.a(new_n53_), .b(new_n27_), .O(z13));
  nor2   g33(.a(new_n53_), .b(new_n31_), .O(z14));
  nor2   g34(.a(new_n53_), .b(new_n33_), .O(z15));
endmodule
