...
module FAU ( 
  ...
  aoi21  g15(.a(new_n26_), .b(new_n31_), .c(new_n36_), .O(z05));
  ...
  nand2  g20(.a(new_n31_), .b(new_n42_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n23_), .O(z12));
  aoi21  g22(.a(new_n26_), .b(new_n31_), .c(x0), .O(z13));
  aoi21  g23(.a(new_n29_), .b(new_n31_), .c(x0), .O(z14));
  nor2   g24(.a(new_n43_), .b(new_n32_), .O(z15));
  zero   g25(.O(z11));
  nor2   g26(.a(new_n31_), .b(x0), .O(z09));
