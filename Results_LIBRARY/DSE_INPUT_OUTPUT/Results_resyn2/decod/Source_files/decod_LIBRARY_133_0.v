...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n40_, new_n41_, new_n44_, new_n45_,
    new_n47_, new_n50_;
  ...
  oai21  g20(.a(new_n41_), .b(new_n26_), .c(new_n37_), .O(z09));
  nand2  g21(.a(x4), .b(x3), .O(new_n44_));
  nand3  g22(.a(new_n36_), .b(x1), .c(new_n40_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n44_), .O(z10));
  nand2  g24(.a(x4), .b(new_n25_), .O(new_n47_));
  nor2   g25(.a(new_n45_), .b(new_n47_), .O(z11));
  nor3   g26(.a(new_n23_), .b(x1), .c(x0), .O(z12));
  nand3  g27(.a(x4), .b(new_n25_), .c(new_n40_), .O(new_n50_));
  aoi21  g28(.a(new_n50_), .b(x2), .c(x1), .O(z13));
  zero   g29(.O(z07));
  inv1   g30(.a(new_n37_), .O(z14));
