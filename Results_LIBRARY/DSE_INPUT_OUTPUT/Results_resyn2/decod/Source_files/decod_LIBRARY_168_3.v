...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n39_, new_n40_, new_n42_, new_n44_, new_n45_,
    new_n47_;
  ...
  nand3  g10(.a(x4), .b(x3), .c(new_n22_), .O(new_n33_));
  ...
  nand3  g17(.a(new_n28_), .b(x2), .c(new_n39_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand2  g19(.a(x4), .b(x3), .O(new_n44_));
  nand3  g20(.a(new_n31_), .b(new_n22_), .c(new_n39_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n44_), .O(z14));
  nand2  g22(.a(x4), .b(new_n28_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n45_), .O(z15));
  zero   g24(.O(z03));
  zero   g25(.O(z09));
  zero   g26(.O(z11));
