...
module FAU ( 
  ...
  oai21  g13(.a(new_n34_), .b(new_n22_), .c(new_n27_), .O(z03));
  ...
  oai21  g22(.a(new_n42_), .b(new_n29_), .c(new_n27_), .O(z09));
  nor2   g23(.a(new_n42_), .b(new_n32_), .O(z10));
  oai21  g24(.a(new_n42_), .b(new_n34_), .c(new_n27_), .O(z11));
  nand3  g25(.a(x3), .b(x2), .c(new_n41_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(x1), .O(z12));
  nand3  g27(.a(new_n28_), .b(x2), .c(new_n41_), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(x4), .c(x1), .O(z13));
  nand3  g29(.a(x3), .b(new_n31_), .c(new_n41_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(x1), .O(z14));
  nand3  g31(.a(new_n28_), .b(new_n31_), .c(new_n41_), .O(new_n53_));
