...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n41_, new_n45_, new_n46_;
  ...
  nor2   g16(.a(new_n37_), .b(new_n30_), .O(z10));
  xnor2a g17(.a(x1), .b(x0), .O(new_n41_));
  aoi21  g18(.a(new_n32_), .b(new_n22_), .c(new_n41_), .O(z11));
  aoi21  g19(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g20(.a(new_n27_), .b(new_n22_), .c(x1), .O(z13));
  inv1   g21(.a(x1), .O(new_n45_));
  nand2  g22(.a(new_n45_), .b(new_n22_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n30_), .O(z14));
