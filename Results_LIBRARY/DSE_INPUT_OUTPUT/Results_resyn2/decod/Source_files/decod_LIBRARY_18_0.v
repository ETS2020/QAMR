...
module FAU ( 
  ...
  nand2  g20(.a(x4), .b(new_n23_), .O(new_n43_));
  nand3  g21(.a(x2), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n43_), .O(z09));
  nor2   g23(.a(new_n41_), .b(new_n31_), .O(z10));
  nand3  g24(.a(new_n30_), .b(x1), .c(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n43_), .O(z11));
  nand2  g26(.a(new_n22_), .b(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n26_), .O(z12));
  nor2   g28(.a(new_n49_), .b(new_n31_), .O(z14));
  zero   g29(.O(z05));
