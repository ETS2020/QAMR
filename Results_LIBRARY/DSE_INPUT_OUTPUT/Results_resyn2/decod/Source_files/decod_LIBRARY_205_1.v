...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n45_,
    new_n49_;
  ...
  nand3  g15(.a(x4), .b(new_n25_), .c(new_n33_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x0), .c(new_n22_), .O(z05));
  ...
  inv1   g24(.a(new_n40_), .O(z12));
  nand2  g25(.a(new_n33_), .b(new_n39_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n29_), .O(z14));
  nor2   g27(.a(new_n49_), .b(new_n31_), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z09));
  inv1   g30(.a(new_n40_), .O(z13));
endmodule
