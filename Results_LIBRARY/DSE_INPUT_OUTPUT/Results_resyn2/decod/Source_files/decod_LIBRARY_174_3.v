...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n39_, new_n43_, new_n46_;
  ...
  nor2   g21(.a(new_n43_), .b(new_n31_), .O(z13));
  xor2a  g22(.a(x1), .b(x0), .O(new_n46_));
  aoi21  g23(.a(new_n34_), .b(new_n24_), .c(new_n46_), .O(z14));
  aoi21  g24(.a(new_n36_), .b(new_n24_), .c(new_n46_), .O(z15));
  zero   g25(.O(z00));
  zero   g26(.O(z02));
