...
module FAU ( 
  ...
  nor2   g26(.a(new_n45_), .b(new_n32_), .O(z10));
  oai21  g27(.a(new_n45_), .b(new_n34_), .c(new_n24_), .O(z11));
  nand3  g28(.a(x3), .b(x2), .c(new_n44_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(x1), .O(z12));
  nand3  g30(.a(new_n28_), .b(x2), .c(new_n44_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x1), .O(z13));
  nand2  g32(.a(new_n22_), .b(new_n44_), .O(new_n54_));
