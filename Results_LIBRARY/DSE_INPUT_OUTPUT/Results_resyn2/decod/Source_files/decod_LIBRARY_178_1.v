...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n37_, new_n47_, new_n48_;
  ...
  aoi21  g16(.a(new_n30_), .b(new_n28_), .c(new_n37_), .O(z06));
  nor2   g17(.a(new_n34_), .b(new_n32_), .O(z07));
  nor2   g18(.a(new_n28_), .b(x0), .O(z10));
  aoi21  g19(.a(new_n23_), .b(new_n28_), .c(x0), .O(z12));
  aoi21  g20(.a(new_n26_), .b(new_n28_), .c(x0), .O(z13));
  aoi21  g21(.a(new_n30_), .b(new_n28_), .c(x0), .O(z14));
  inv1   g22(.a(x0), .O(new_n47_));
  nand2  g23(.a(new_n28_), .b(new_n47_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n32_), .O(z15));
  zero   g25(.O(z08));
  zero   g26(.O(z09));
  zero   g27(.O(z11));
endmodule
