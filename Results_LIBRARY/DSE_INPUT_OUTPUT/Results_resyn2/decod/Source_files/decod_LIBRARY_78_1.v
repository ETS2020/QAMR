...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n37_, new_n40_, new_n41_, new_n43_, new_n44_,
    new_n49_, new_n51_;
  ...
  nand3  g21(.a(x4), .b(new_n26_), .c(x2), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n43_), .O(z09));
  nor2   g23(.a(new_n43_), .b(new_n29_), .O(z10));
  oai21  g24(.a(new_n43_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand2  g25(.a(new_n31_), .b(new_n40_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n29_), .O(z14));
  nand3  g27(.a(x4), .b(new_n26_), .c(new_n40_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(new_n25_), .c(x1), .O(z15));
  zero   g29(.O(z05));
  zero   g30(.O(z12));
  inv1   g31(.a(new_n32_), .O(z13));
endmodule
