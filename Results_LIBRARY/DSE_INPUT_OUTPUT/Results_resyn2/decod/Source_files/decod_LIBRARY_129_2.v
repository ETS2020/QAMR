...
module FAU ( 
  ...
  nand3  g06(.a(x4), .b(x3), .c(new_n28_), .O(new_n29_));
  oai21  g07(.a(new_n29_), .b(new_n22_), .c(new_n27_), .O(z02));
  nand3  g08(.a(x4), .b(new_n26_), .c(new_n28_), .O(new_n31_));
  nor2   g09(.a(new_n31_), .b(new_n22_), .O(z03));
  inv1   g10(.a(x1), .O(new_n33_));
  nand3  g11(.a(x4), .b(new_n33_), .c(x0), .O(new_n34_));
  aoi21  g12(.a(new_n34_), .b(x3), .c(new_n28_), .O(z04));
  inv1   g13(.a(new_n27_), .O(z05));
  nand2  g14(.a(new_n33_), .b(x0), .O(new_n37_));
  oai21  g15(.a(new_n37_), .b(new_n29_), .c(new_n27_), .O(z06));
  ...
  oai21  g20(.a(new_n41_), .b(new_n29_), .c(new_n27_), .O(z10));
  nand3  g21(.a(x4), .b(x1), .c(new_n40_), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(new_n28_), .c(x3), .O(z11));
  nand2  g23(.a(new_n33_), .b(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n23_), .O(z12));
  oai21  g25(.a(new_n46_), .b(new_n29_), .c(new_n27_), .O(z14));
  nor2   g26(.a(new_n46_), .b(new_n31_), .O(z15));
  zero   g27(.O(z01));
  zero   g28(.O(z13));
  inv1   g29(.a(new_n27_), .O(z09));
endmodule
