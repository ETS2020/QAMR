...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n38_, new_n41_, new_n45_;
  ...
  nor2   g14(.a(new_n38_), .b(new_n24_), .O(z08));
  nor2   g15(.a(new_n38_), .b(new_n27_), .O(z09));
  xnor2a g16(.a(x1), .b(x0), .O(new_n41_));
  aoi21  g17(.a(new_n30_), .b(x1), .c(new_n41_), .O(z10));
  nor2   g18(.a(new_n38_), .b(new_n32_), .O(z11));
  aoi21  g19(.a(new_n24_), .b(new_n22_), .c(x1), .O(z12));
