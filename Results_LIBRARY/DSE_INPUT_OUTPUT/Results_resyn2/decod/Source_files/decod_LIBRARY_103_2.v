...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n38_, new_n40_, new_n41_, new_n44_,
    new_n46_, new_n50_;
  ...
  nand3  g13(.a(x2), .b(new_n31_), .c(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n34_), .O(z05));
  nor2   g15(.a(new_n32_), .b(new_n29_), .O(z06));
  nand3  g16(.a(x4), .b(new_n28_), .c(x0), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(new_n31_), .c(x3), .O(z07));
  inv1   g18(.a(x0), .O(new_n40_));
  nand3  g19(.a(x4), .b(x2), .c(new_n40_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x3), .c(new_n31_), .O(z08));
  nand2  g21(.a(x1), .b(new_n40_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n29_), .O(z10));
  nand2  g23(.a(new_n31_), .b(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n23_), .O(z12));
  aoi21  g25(.a(new_n41_), .b(new_n31_), .c(x3), .O(z13));
  oai21  g26(.a(new_n46_), .b(new_n29_), .c(new_n26_), .O(z14));
