...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n39_, new_n40_, new_n42_, new_n45_;
  ...
  nor2   g21(.a(new_n42_), .b(new_n29_), .O(z10));
  aoi21  g22(.a(new_n40_), .b(new_n28_), .c(x3), .O(z11));
  nand2  g23(.a(new_n33_), .b(new_n39_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(z12));
  oai21  g25(.a(new_n45_), .b(new_n29_), .c(new_n26_), .O(z14));
  nor2   g26(.a(new_n45_), .b(new_n31_), .O(z15));
  zero   g27(.O(z13));
