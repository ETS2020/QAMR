...
module FAU ( 
  ...
  aoi21  g09(.a(new_n31_), .b(new_n23_), .c(new_n29_), .O(z03));
  nand3  g10(.a(x4), .b(x2), .c(x0), .O(new_n33_));
  aoi21  g11(.a(new_n33_), .b(new_n29_), .c(new_n23_), .O(z04));
  nand2  g12(.a(new_n29_), .b(x0), .O(new_n35_));
  oai21  g13(.a(new_n35_), .b(new_n24_), .c(new_n27_), .O(z05));
  nand3  g14(.a(x4), .b(x3), .c(new_n30_), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n35_), .O(z06));
  nand3  g16(.a(x4), .b(new_n23_), .c(new_n30_), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n35_), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand3  g19(.a(x4), .b(x2), .c(new_n42_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(new_n23_), .c(new_n29_), .O(z09));
  nand2  g21(.a(x1), .b(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n39_), .O(z11));
  aoi21  g23(.a(new_n43_), .b(new_n29_), .c(new_n23_), .O(z12));
  nand2  g24(.a(new_n29_), .b(new_n42_), .O(new_n48_));
  oai21  g25(.a(new_n48_), .b(new_n24_), .c(new_n27_), .O(z13));
  nand3  g26(.a(x4), .b(new_n30_), .c(new_n42_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n29_), .c(new_n23_), .O(z14));
