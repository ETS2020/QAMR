...
module FAU ( 
  ...
  aoi21  g16(.a(new_n26_), .b(x1), .c(new_n38_), .O(z09));
  nor2   g17(.a(new_n36_), .b(new_n29_), .O(z10));
  aoi21  g18(.a(new_n31_), .b(x1), .c(new_n38_), .O(z11));
  aoi21  g19(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g20(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  aoi21  g21(.a(new_n29_), .b(new_n22_), .c(x1), .O(z14));
  inv1   g22(.a(x1), .O(new_n45_));
  nand2  g23(.a(new_n45_), .b(new_n22_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n31_), .O(z15));
  zero   g25(.O(z04));
