...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n35_, new_n39_, new_n40_, new_n44_;
  ...
  aoi21  g08(.a(new_n29_), .b(x1), .c(new_n23_), .O(z02));
  ...
  nor2   g15(.a(new_n29_), .b(new_n35_), .O(z06));
  ...
  nor2   g20(.a(new_n26_), .b(new_n40_), .O(z09));
  aoi21  g21(.a(new_n29_), .b(x1), .c(x0), .O(z10));
