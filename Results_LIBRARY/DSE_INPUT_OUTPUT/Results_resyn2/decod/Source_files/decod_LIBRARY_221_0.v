...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n44_, new_n45_;
  ...
  aoi21  g14(.a(new_n33_), .b(x3), .c(x2), .O(z06));
  ...
  nor2   g19(.a(new_n39_), .b(new_n29_), .O(z10));
  nand3  g20(.a(x4), .b(new_n32_), .c(new_n38_), .O(new_n44_));
  xor2a  g21(.a(x3), .b(x2), .O(new_n45_));
  aoi21  g22(.a(new_n44_), .b(x3), .c(new_n45_), .O(z12));
  nor2   g23(.a(new_n44_), .b(new_n26_), .O(z13));
