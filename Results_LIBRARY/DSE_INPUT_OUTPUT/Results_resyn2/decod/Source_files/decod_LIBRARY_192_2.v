...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n38_, new_n41_, new_n43_, new_n45_, new_n46_;
  ...
  nor2   g12(.a(x1), .b(new_n28_), .O(z05));
  nand3  g13(.a(x2), .b(x1), .c(new_n28_), .O(new_n38_));
  nor2   g14(.a(new_n38_), .b(new_n23_), .O(z08));
  nor2   g15(.a(new_n38_), .b(new_n26_), .O(z09));
  nand2  g16(.a(x1), .b(new_n28_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n30_), .O(z10));
  xnor2a g18(.a(x1), .b(x0), .O(new_n43_));
  aoi21  g19(.a(new_n32_), .b(new_n28_), .c(new_n43_), .O(z11));
  inv1   g20(.a(x1), .O(new_n45_));
  nand3  g21(.a(x2), .b(new_n45_), .c(new_n28_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n46_), .b(new_n26_), .O(z13));
  aoi21  g24(.a(new_n30_), .b(new_n28_), .c(x1), .O(z14));
