...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n36_, new_n37_, new_n40_, new_n42_;
  ...
  aoi21  g15(.a(new_n37_), .b(x3), .c(new_n25_), .O(z08));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n36_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(x3), .c(new_n25_), .O(z10));
  nand2  g18(.a(new_n30_), .b(new_n36_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z12));
  nor2   g20(.a(new_n42_), .b(new_n28_), .O(z14));
  zero   g21(.O(z07));
  zero   g22(.O(z09));
  zero   g23(.O(z13));
  nor2   g24(.a(new_n25_), .b(x3), .O(z03));
  nor2   g25(.a(new_n25_), .b(x3), .O(z05));
  nor2   g26(.a(new_n25_), .b(x3), .O(z11));
