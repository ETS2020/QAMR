...
module FAU ( 
  ...
  aoi21  g14(.a(new_n23_), .b(new_n25_), .c(new_n37_), .O(z08));
  nand2  g15(.a(x1), .b(new_n25_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n27_), .O(z09));
  nor2   g17(.a(new_n39_), .b(new_n30_), .O(z10));
  aoi21  g18(.a(new_n32_), .b(new_n25_), .c(new_n37_), .O(z11));
  aoi21  g19(.a(new_n23_), .b(new_n25_), .c(x1), .O(z12));
  aoi21  g20(.a(new_n27_), .b(new_n25_), .c(x1), .O(z13));
  aoi21  g21(.a(new_n30_), .b(new_n25_), .c(x1), .O(z14));
  aoi21  g22(.a(new_n32_), .b(new_n25_), .c(x1), .O(z15));
  zero   g23(.O(z04));
  zero   g24(.O(z05));
  nor2   g25(.a(x1), .b(new_n25_), .O(z07));
endmodule
