...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n40_, new_n46_,
    new_n49_;
  ...
  oai21  g20(.a(new_n36_), .b(new_n33_), .c(new_n26_), .O(z07));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x0), .O(z09));
  inv1   g22(.a(new_n26_), .O(z10));
  nand2  g23(.a(x1), .b(new_n25_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n33_), .O(z11));
  nand3  g25(.a(x4), .b(x2), .c(new_n35_), .O(new_n49_));
  aoi21  g26(.a(new_n49_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g27(.a(new_n40_), .b(new_n22_), .c(x0), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z12));
