...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n38_, new_n39_, new_n41_;
  ...
  nor3   g13(.a(new_n23_), .b(new_n30_), .c(x0), .O(z08));
  inv1   g14(.a(x0), .O(new_n38_));
  nand3  g15(.a(new_n27_), .b(x1), .c(new_n38_), .O(new_n39_));
  aoi21  g16(.a(new_n39_), .b(x3), .c(new_n25_), .O(z10));
  nand2  g17(.a(new_n30_), .b(new_n38_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n23_), .O(z12));
  nor2   g19(.a(new_n41_), .b(new_n28_), .O(z14));
  zero   g20(.O(z05));
  zero   g21(.O(z09));
  zero   g22(.O(z15));
