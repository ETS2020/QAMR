...
module FAU ( 
  ...
  oai21  g24(.a(new_n43_), .b(new_n32_), .c(new_n27_), .O(z10));
  oai21  g25(.a(new_n43_), .b(new_n34_), .c(new_n27_), .O(z11));
  nand2  g26(.a(new_n25_), .b(new_n42_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z12));
  nand3  g28(.a(new_n28_), .b(x2), .c(new_n42_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(x1), .O(z13));
  nor2   g30(.a(new_n48_), .b(new_n32_), .O(z14));
  nand3  g31(.a(new_n28_), .b(new_n31_), .c(new_n42_), .O(new_n53_));
