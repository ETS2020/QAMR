...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n36_, new_n37_, new_n40_, new_n43_;
  ...
  nor2   g11(.a(new_n32_), .b(new_n28_), .O(z06));
  nor3   g12(.a(new_n23_), .b(new_n31_), .c(x0), .O(z08));
  inv1   g13(.a(x0), .O(new_n36_));
  nand3  g14(.a(new_n27_), .b(x1), .c(new_n36_), .O(new_n37_));
  aoi21  g15(.a(new_n37_), .b(x3), .c(new_n25_), .O(z10));
  nand3  g16(.a(x2), .b(new_n31_), .c(new_n36_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(x3), .c(new_n25_), .O(z12));
  nand2  g18(.a(new_n31_), .b(new_n36_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n28_), .O(z14));
  zero   g20(.O(z03));
  zero   g21(.O(z11));
  zero   g22(.O(z13));
  zero   g23(.O(z15));
  nor2   g24(.a(new_n25_), .b(x3), .O(z05));
  nor2   g25(.a(new_n25_), .b(x3), .O(z07));
