...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n37_, new_n39_, new_n46_;
  ...
  nand2  g17(.a(new_n28_), .b(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n30_), .O(z06));
  nor2   g19(.a(new_n39_), .b(new_n32_), .O(z07));
  inv1   g20(.a(new_n37_), .O(z11));
  nand3  g21(.a(x2), .b(new_n28_), .c(new_n36_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n46_), .b(new_n26_), .O(z13));
  aoi21  g24(.a(new_n30_), .b(new_n28_), .c(x0), .O(z14));
  aoi21  g25(.a(new_n32_), .b(new_n28_), .c(x0), .O(z15));
  zero   g26(.O(z08));
  zero   g27(.O(z09));
  zero   g28(.O(z10));
endmodule
