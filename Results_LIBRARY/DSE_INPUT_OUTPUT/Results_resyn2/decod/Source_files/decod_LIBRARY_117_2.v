...
module FAU ( 
  ...
  nor2   g14(.a(new_n38_), .b(new_n27_), .O(z09));
  xnor2a g15(.a(x1), .b(x0), .O(new_n41_));
  aoi21  g16(.a(new_n30_), .b(x1), .c(new_n41_), .O(z10));
  aoi21  g17(.a(new_n32_), .b(new_n22_), .c(new_n41_), .O(z11));
  inv1   g18(.a(x1), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(new_n22_), .O(new_n45_));
