...
module FAU ( 
  ...
  nand3  g06(.a(x3), .b(new_n25_), .c(x0), .O(new_n28_));
  aoi21  g07(.a(new_n28_), .b(x1), .c(new_n22_), .O(z02));
  inv1   g08(.a(x3), .O(new_n30_));
  nand3  g09(.a(new_n30_), .b(new_n25_), .c(x0), .O(new_n31_));
  ...
  nand3  g17(.a(x3), .b(new_n25_), .c(new_n37_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(x1), .c(new_n22_), .O(z10));
  nand3  g19(.a(new_n30_), .b(new_n25_), .c(new_n37_), .O(new_n44_));
