...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n46_, new_n47_;
  ...
  aoi21  g17(.a(new_n32_), .b(x0), .c(new_n34_), .O(z07));
  nor2   g18(.a(new_n31_), .b(x0), .O(z08));
  aoi21  g19(.a(new_n23_), .b(new_n31_), .c(x0), .O(z12));
  aoi21  g20(.a(new_n26_), .b(new_n31_), .c(x0), .O(z13));
  aoi21  g21(.a(new_n29_), .b(new_n31_), .c(x0), .O(z14));
  inv1   g22(.a(x0), .O(new_n46_));
  nand2  g23(.a(new_n31_), .b(new_n46_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n32_), .O(z15));
  zero   g25(.O(z09));
  zero   g26(.O(z11));
  nor2   g27(.a(new_n31_), .b(x0), .O(z10));
endmodule
