...
module FAU ( 
  ...
  nand3  g22(.a(x2), .b(new_n28_), .c(new_n36_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g24(.a(new_n45_), .b(new_n26_), .O(z13));
  nand2  g25(.a(new_n28_), .b(new_n36_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n30_), .O(z14));
  aoi21  g27(.a(new_n32_), .b(new_n28_), .c(x0), .O(z15));
  zero   g28(.O(z11));
  inv1   g29(.a(new_n37_), .O(z09));
