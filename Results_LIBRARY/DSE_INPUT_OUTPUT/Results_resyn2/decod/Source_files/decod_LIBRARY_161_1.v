...
module FAU ( 
  ...
  nand2  g04(.a(x4), .b(new_n22_), .O(new_n26_));
  ...
  aoi21  g14(.a(new_n36_), .b(x1), .c(new_n23_), .O(z08));
  nand3  g15(.a(new_n22_), .b(x2), .c(new_n35_), .O(new_n38_));
  aoi21  g16(.a(new_n38_), .b(x1), .c(new_n23_), .O(z09));
  nand3  g17(.a(x3), .b(new_n28_), .c(new_n35_), .O(new_n40_));
  aoi21  g18(.a(new_n40_), .b(x1), .c(new_n23_), .O(z10));
  nand3  g19(.a(new_n22_), .b(new_n28_), .c(new_n35_), .O(new_n42_));
  aoi21  g20(.a(new_n42_), .b(x1), .c(new_n23_), .O(z11));
  zero   g21(.O(z05));
  zero   g22(.O(z13));
  zero   g23(.O(z14));
  zero   g24(.O(z15));
  ...
  nor2   g27(.a(new_n23_), .b(x1), .O(z12));
endmodule
