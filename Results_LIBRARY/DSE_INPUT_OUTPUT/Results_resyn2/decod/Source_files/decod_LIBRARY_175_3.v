...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n25_, new_n26_, new_n28_, new_n30_, new_n31_, new_n32_, new_n34_,
    new_n35_, new_n37_, new_n40_, new_n44_, new_n48_;
  ...
  nand2  g05(.a(new_n26_), .b(x0), .O(new_n30_));
  ...
  nor2   g11(.a(new_n35_), .b(new_n30_), .O(z06));
  ...
  nor2   g16(.a(new_n40_), .b(new_n32_), .O(z09));
  ...
  aoi21  g22(.a(new_n35_), .b(new_n25_), .c(new_n44_), .O(z14));
  nand2  g23(.a(new_n26_), .b(new_n25_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n37_), .O(z15));
  zero   g25(.O(z00));
  zero   g26(.O(z01));
  zero   g27(.O(z02));
endmodule
