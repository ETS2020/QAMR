...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n37_, new_n39_, new_n40_, new_n44_;
  ...
  nand2  g11(.a(x3), .b(new_n33_), .O(new_n34_));
  oai21  g12(.a(new_n31_), .b(new_n26_), .c(new_n34_), .O(z05));
  inv1   g13(.a(new_n34_), .O(z06));
  nand2  g14(.a(new_n25_), .b(new_n33_), .O(new_n37_));
  ...
  oai21  g19(.a(new_n40_), .b(new_n26_), .c(new_n34_), .O(z09));
  ...
  aoi21  g24(.a(new_n44_), .b(new_n25_), .c(x2), .O(z15));
  zero   g25(.O(z02));
  zero   g26(.O(z14));
