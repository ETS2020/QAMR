...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n41_, new_n44_, new_n45_;
  ...
  nor2   g12(.a(x1), .b(new_n22_), .O(z06));
  ...
  aoi21  g16(.a(new_n30_), .b(new_n22_), .c(new_n37_), .O(z10));
  nand2  g17(.a(x1), .b(new_n22_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n32_), .O(z11));
