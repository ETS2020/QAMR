...
module FAU ( 
  ...
  nand2  g13(.a(new_n22_), .b(new_n25_), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n23_), .O(z05));
  nand2  g15(.a(new_n25_), .b(x0), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n33_), .O(z07));
  ...
  nand3  g22(.a(x4), .b(new_n30_), .c(new_n41_), .O(new_n46_));
  aoi21  g23(.a(new_n46_), .b(x1), .c(new_n22_), .O(z10));
  nor2   g24(.a(new_n44_), .b(new_n33_), .O(z11));
  inv1   g25(.a(new_n26_), .O(z12));
  nor2   g26(.a(new_n42_), .b(new_n36_), .O(z13));
  aoi21  g27(.a(new_n46_), .b(new_n22_), .c(x1), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z06));
  zero   g30(.O(z14));
endmodule
