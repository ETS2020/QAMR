...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n29_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n39_, new_n43_, new_n47_;
  ...
  aoi21  g21(.a(new_n30_), .b(new_n22_), .c(new_n43_), .O(z13));
  aoi21  g22(.a(new_n34_), .b(new_n23_), .c(new_n43_), .O(z14));
  nand2  g23(.a(new_n23_), .b(new_n22_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n36_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
