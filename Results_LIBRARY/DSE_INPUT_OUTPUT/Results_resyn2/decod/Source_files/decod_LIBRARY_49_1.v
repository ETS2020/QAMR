...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n35_, new_n36_, new_n39_, new_n42_, new_n45_;
  ...
  nor3   g09(.a(new_n32_), .b(x1), .c(new_n31_), .O(z04));
  inv1   g10(.a(x1), .O(new_n35_));
  nand3  g11(.a(new_n27_), .b(new_n35_), .c(x0), .O(new_n36_));
  aoi21  g12(.a(new_n36_), .b(x3), .c(new_n22_), .O(z06));
  nand3  g13(.a(x2), .b(x1), .c(new_n31_), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(x3), .c(new_n22_), .O(z08));
  nor2   g15(.a(new_n22_), .b(x3), .O(z09));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n31_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x3), .c(new_n22_), .O(z10));
  nand2  g18(.a(new_n35_), .b(new_n31_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n32_), .O(z12));
  nor2   g20(.a(new_n45_), .b(new_n28_), .O(z14));
  zero   g21(.O(z01));
  zero   g22(.O(z03));
  zero   g23(.O(z05));
  zero   g24(.O(z07));
