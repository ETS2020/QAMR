...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_, new_n45_,
    new_n50_;
  ...
  inv1   g21(.a(new_n29_), .O(z09));
  nand2  g22(.a(x1), .b(new_n28_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n31_), .O(z10));
  nor2   g24(.a(new_n45_), .b(new_n33_), .O(z11));
  nand3  g25(.a(x4), .b(x3), .c(new_n35_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g27(.a(new_n39_), .b(new_n22_), .c(x0), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z12));
  zero   g30(.O(z13));
endmodule
