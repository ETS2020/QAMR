...
module FAU ( 
  ...
  nor2   g15(.a(new_n36_), .b(new_n28_), .O(z10));
  nor3   g16(.a(new_n23_), .b(x1), .c(x0), .O(z12));
  nand3  g17(.a(new_n27_), .b(new_n30_), .c(new_n35_), .O(new_n41_));
  aoi21  g18(.a(new_n41_), .b(x3), .c(new_n25_), .O(z14));
  zero   g19(.O(z05));
  zero   g20(.O(z09));
  nor2   g21(.a(new_n25_), .b(x3), .O(z03));
  nor2   g22(.a(new_n25_), .b(x3), .O(z07));
  nor2   g23(.a(new_n25_), .b(x3), .O(z11));
  nor2   g24(.a(new_n25_), .b(x3), .O(z13));
  nor2   g25(.a(new_n25_), .b(x3), .O(z15));
endmodule
