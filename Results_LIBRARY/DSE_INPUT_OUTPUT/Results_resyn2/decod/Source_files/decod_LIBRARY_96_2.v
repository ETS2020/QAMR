...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n36_, new_n41_, new_n42_, new_n47_;
  ...
  oai21  g18(.a(new_n36_), .b(new_n33_), .c(new_n32_), .O(z07));
  ...
  oai21  g24(.a(new_n42_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand2  g25(.a(new_n35_), .b(new_n41_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z12));
  oai21  g27(.a(new_n47_), .b(new_n26_), .c(new_n32_), .O(z13));
  nor2   g28(.a(new_n47_), .b(new_n29_), .O(z14));
  nor2   g29(.a(new_n47_), .b(new_n33_), .O(z15));
endmodule
