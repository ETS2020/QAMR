...
module FAU ( 
  ...
  wire new_n22_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n44_;
  ...
  aoi21  g14(.a(new_n37_), .b(new_n26_), .c(new_n36_), .O(z07));
  nand2  g15(.a(x1), .b(new_n36_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n28_), .O(z08));
  aoi21  g17(.a(new_n31_), .b(new_n36_), .c(new_n26_), .O(z09));
  nor2   g18(.a(new_n39_), .b(new_n34_), .O(z10));
  nor2   g19(.a(new_n39_), .b(new_n37_), .O(z11));
  nand2  g20(.a(new_n26_), .b(new_n36_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n28_), .O(z12));
  nor2   g22(.a(new_n44_), .b(new_n31_), .O(z13));
  oai21  g23(.a(new_n44_), .b(new_n34_), .c(new_n22_), .O(z14));
