...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n43_, new_n45_;
  ...
  nand3  g19(.a(x2), .b(new_n31_), .c(new_n37_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(x3), .c(new_n25_), .O(z12));
  ...
  nor2   g29(.a(new_n25_), .b(x3), .O(z13));
endmodule
