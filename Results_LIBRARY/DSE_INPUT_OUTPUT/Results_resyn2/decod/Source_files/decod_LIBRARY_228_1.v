...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n36_, new_n41_, new_n42_, new_n46_;
  ...
  nand2  g19(.a(new_n22_), .b(new_n41_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n23_), .O(z12));
  nor2   g21(.a(new_n42_), .b(new_n26_), .O(z13));
  aoi21  g22(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  nand3  g23(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n46_));
  nor2   g24(.a(new_n42_), .b(new_n46_), .O(z15));
  zero   g25(.O(z10));
