...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n43_, new_n46_;
  ...
  aoi21  g14(.a(new_n36_), .b(new_n25_), .c(new_n32_), .O(z07));
  nand2  g15(.a(x1), .b(new_n32_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n27_), .O(z08));
  nor2   g17(.a(new_n38_), .b(new_n30_), .O(z09));
  nor2   g18(.a(new_n38_), .b(new_n34_), .O(z10));
  nor2   g19(.a(new_n38_), .b(new_n36_), .O(z11));
  ...
  xor2a  g23(.a(x1), .b(x0), .O(new_n46_));
  aoi21  g24(.a(new_n34_), .b(new_n25_), .c(new_n46_), .O(z14));
