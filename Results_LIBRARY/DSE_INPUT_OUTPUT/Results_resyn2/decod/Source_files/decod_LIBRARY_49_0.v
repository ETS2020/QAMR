...
module FAU ( 
  ...
  nand3  g22(.a(x2), .b(x1), .c(new_n41_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x4), .c(x3), .O(z09));
  oai21  g24(.a(new_n42_), .b(new_n31_), .c(new_n24_), .O(z10));
  nor2   g25(.a(new_n42_), .b(new_n33_), .O(z11));
  nand2  g26(.a(x4), .b(x3), .O(new_n48_));
  nand3  g27(.a(x2), .b(new_n35_), .c(new_n41_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n48_), .O(z12));
  aoi21  g29(.a(new_n49_), .b(x4), .c(x3), .O(z13));
  nand3  g30(.a(new_n30_), .b(new_n35_), .c(new_n41_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n48_), .O(z14));
