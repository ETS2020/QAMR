...
module FAU ( 
  ...
  oai21  g12(.a(new_n33_), .b(new_n28_), .c(new_n30_), .O(z03));
  ...
  nor2   g27(.a(new_n44_), .b(new_n31_), .O(z10));
  oai21  g28(.a(new_n44_), .b(new_n33_), .c(new_n30_), .O(z11));
  ...
  oai21  g34(.a(new_n53_), .b(new_n31_), .c(new_n30_), .O(z14));
