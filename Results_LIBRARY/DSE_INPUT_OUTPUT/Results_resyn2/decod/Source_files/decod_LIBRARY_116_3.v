...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n35_, new_n36_, new_n38_, new_n39_, new_n42_, new_n45_,
  ...
  aoi21  g11(.a(new_n33_), .b(new_n25_), .c(new_n24_), .O(z06));
  nand3  g12(.a(x4), .b(new_n28_), .c(new_n25_), .O(new_n35_));
  ...
  aoi21  g18(.a(new_n29_), .b(new_n24_), .c(new_n25_), .O(z09));
  nand3  g19(.a(x4), .b(x3), .c(new_n25_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n38_), .O(z10));
  nor2   g21(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g22(.a(x4), .b(x3), .O(new_n45_));
  nand3  g23(.a(x2), .b(new_n32_), .c(new_n24_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n45_), .O(z12));
  nand2  g25(.a(x4), .b(new_n28_), .O(new_n48_));
  nor2   g26(.a(new_n46_), .b(new_n48_), .O(z13));
  nand2  g27(.a(new_n32_), .b(new_n24_), .O(new_n50_));
  oai21  g28(.a(new_n50_), .b(new_n42_), .c(new_n22_), .O(z14));
  oai21  g29(.a(new_n50_), .b(new_n35_), .c(new_n22_), .O(z15));
  zero   g30(.O(z04));
