...
module FAU ( 
  ...
  nor2   g11(.a(new_n32_), .b(new_n25_), .O(z02));
  ...
  nor2   g26(.a(new_n46_), .b(new_n34_), .O(z11));
  nand2  g27(.a(new_n36_), .b(new_n22_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n26_), .O(z12));
  nand3  g29(.a(new_n28_), .b(x2), .c(new_n36_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(x0), .O(z13));
  nor2   g31(.a(new_n49_), .b(new_n32_), .O(z14));
  nor2   g32(.a(new_n49_), .b(new_n34_), .O(z15));
endmodule
