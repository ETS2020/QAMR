...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n40_, new_n41_;
  ...
  aoi21  g11(.a(new_n31_), .b(x1), .c(new_n32_), .O(z03));
  ...
  nor2   g17(.a(new_n35_), .b(new_n31_), .O(z07));
  ...
  aoi21  g23(.a(new_n31_), .b(x1), .c(x0), .O(z11));
  nor2   g24(.a(x1), .b(x0), .O(z12));
  zero   g25(.O(z14));
  nor2   g26(.a(x1), .b(x0), .O(z13));
