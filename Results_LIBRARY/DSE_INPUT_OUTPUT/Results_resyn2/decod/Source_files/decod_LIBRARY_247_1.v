...
module FAU ( 
  ...
  nand2  g09(.a(x3), .b(new_n30_), .O(new_n31_));
  inv1   g10(.a(x2), .O(new_n32_));
  nand3  g11(.a(x4), .b(new_n25_), .c(new_n32_), .O(new_n33_));
  oai21  g12(.a(new_n33_), .b(new_n22_), .c(new_n31_), .O(z03));
  inv1   g13(.a(new_n31_), .O(z04));
  nand3  g14(.a(x4), .b(x2), .c(x0), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(new_n25_), .c(x1), .O(z05));
  nand3  g16(.a(x4), .b(new_n32_), .c(x0), .O(new_n39_));
  ...
  nand3  g22(.a(x4), .b(new_n32_), .c(new_n41_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(x1), .c(new_n25_), .O(z10));
  nor2   g24(.a(new_n42_), .b(new_n33_), .O(z11));
  nand2  g25(.a(new_n30_), .b(new_n41_), .O(new_n49_));
