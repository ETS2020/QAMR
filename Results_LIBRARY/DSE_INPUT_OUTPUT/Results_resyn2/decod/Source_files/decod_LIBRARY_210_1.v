...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n42_;
  ...
  aoi21  g12(.a(new_n33_), .b(x3), .c(new_n22_), .O(z06));
  nand3  g13(.a(x4), .b(x3), .c(x2), .O(new_n36_));
  nor3   g14(.a(new_n36_), .b(new_n30_), .c(x0), .O(z08));
  inv1   g15(.a(x0), .O(new_n39_));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n39_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(x3), .c(new_n22_), .O(z10));
  nand2  g18(.a(new_n30_), .b(new_n39_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n36_), .O(z12));
  nor2   g20(.a(new_n42_), .b(new_n28_), .O(z14));
  zero   g21(.O(z07));
  zero   g22(.O(z09));
  zero   g23(.O(z13));
