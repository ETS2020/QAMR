...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n42_, new_n48_;
  ...
  nand3  g11(.a(x4), .b(x2), .c(x0), .O(new_n34_));
  aoi21  g12(.a(new_n34_), .b(new_n25_), .c(x1), .O(z05));
  inv1   g13(.a(x1), .O(new_n36_));
  nand2  g14(.a(x3), .b(new_n36_), .O(new_n37_));
  inv1   g15(.a(new_n37_), .O(z06));
  nand2  g16(.a(new_n36_), .b(x0), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n31_), .O(z07));
  ...
  oai21  g23(.a(new_n42_), .b(new_n31_), .c(new_n37_), .O(z11));
  nand2  g24(.a(new_n36_), .b(new_n41_), .O(new_n48_));
