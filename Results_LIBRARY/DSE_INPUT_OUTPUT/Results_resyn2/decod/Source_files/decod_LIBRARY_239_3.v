...
module FAU ( 
  ...
  oai21  g12(.a(new_n32_), .b(new_n25_), .c(new_n35_), .O(z05));
  nand3  g13(.a(x4), .b(new_n28_), .c(x0), .O(new_n37_));
  aoi21  g14(.a(new_n37_), .b(new_n31_), .c(new_n24_), .O(z06));
  nor2   g15(.a(new_n32_), .b(new_n29_), .O(z07));
  inv1   g16(.a(x0), .O(new_n41_));
  nand2  g17(.a(x1), .b(new_n41_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n25_), .O(z09));
  nand3  g19(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n24_), .c(new_n31_), .O(z11));
  nand2  g21(.a(new_n31_), .b(new_n41_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n33_), .O(z12));
  nor2   g23(.a(new_n47_), .b(new_n25_), .O(z13));
  aoi21  g24(.a(new_n45_), .b(new_n31_), .c(new_n24_), .O(z14));
  nor2   g25(.a(new_n47_), .b(new_n29_), .O(z15));
  zero   g26(.O(z00));
  zero   g27(.O(z02));
  zero   g28(.O(z08));
  zero   g29(.O(z10));
