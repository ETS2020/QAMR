...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n44_, new_n46_, new_n47_, new_n51_, new_n53_, new_n55_;
  ...
  nand3  g11(.a(x4), .b(x1), .c(x0), .O(new_n33_));
  ...
  nor2   g20(.a(new_n37_), .b(new_n35_), .O(z07));
  inv1   g21(.a(x0), .O(new_n43_));
  nand2  g22(.a(x1), .b(new_n43_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n26_), .c(new_n24_), .O(z08));
  nand2  g24(.a(new_n28_), .b(x2), .O(new_n46_));
  nand3  g25(.a(x4), .b(x1), .c(new_n43_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n46_), .O(z09));
  nor2   g27(.a(new_n47_), .b(new_n32_), .O(z10));
  nor2   g28(.a(new_n44_), .b(new_n35_), .O(z11));
  nand3  g29(.a(x3), .b(x2), .c(new_n43_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(x1), .O(z12));
  nand2  g31(.a(new_n22_), .b(new_n43_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n29_), .O(z13));
  nand3  g33(.a(x3), .b(new_n31_), .c(new_n43_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x1), .O(z14));
  nor2   g35(.a(new_n53_), .b(new_n35_), .O(z15));
endmodule
