...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n37_, new_n40_, new_n41_, new_n43_, new_n47_;
  ...
  nand3  g20(.a(x4), .b(new_n26_), .c(x2), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n41_), .O(z09));
  oai21  g22(.a(new_n41_), .b(new_n29_), .c(new_n32_), .O(z10));
  oai21  g23(.a(new_n41_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand2  g24(.a(new_n31_), .b(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n29_), .O(z14));
  nor2   g26(.a(new_n47_), .b(new_n33_), .O(z15));
  zero   g27(.O(z04));
  inv1   g28(.a(new_n32_), .O(z12));
