...
module FAU ( 
  ...
  nor2   g15(.a(new_n38_), .b(new_n28_), .O(z08));
  aoi21  g16(.a(new_n31_), .b(new_n22_), .c(new_n23_), .O(z09));
  ...
  aoi21  g23(.a(new_n34_), .b(new_n22_), .c(new_n46_), .O(z14));
  aoi21  g24(.a(new_n36_), .b(new_n23_), .c(new_n46_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z03));
