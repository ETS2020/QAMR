...
module FAU ( 
  ...
  xnor2a g11(.a(x2), .b(x1), .O(new_n33_));
  aoi21  g12(.a(new_n27_), .b(new_n25_), .c(new_n33_), .O(z03));
  ...
  nand3  g19(.a(x4), .b(new_n26_), .c(new_n40_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(x1), .c(new_n25_), .O(z09));
  nand2  g21(.a(new_n25_), .b(x1), .O(new_n45_));
  nor2   g22(.a(new_n41_), .b(new_n45_), .O(z10));
  nor2   g23(.a(new_n43_), .b(new_n45_), .O(z11));
  inv1   g24(.a(new_n30_), .O(z12));
  nand2  g25(.a(new_n29_), .b(new_n40_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n31_), .O(z14));
  aoi21  g27(.a(new_n43_), .b(new_n25_), .c(x1), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z05));
