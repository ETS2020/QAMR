...
module FAU ( 
  ...
  oai21  g21(.a(new_n41_), .b(new_n29_), .c(new_n26_), .O(z10));
  nor2   g22(.a(new_n41_), .b(new_n31_), .O(z11));
  nand3  g23(.a(x4), .b(new_n33_), .c(new_n40_), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(x3), .c(new_n22_), .O(z12));
  nand2  g25(.a(new_n33_), .b(new_n40_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n29_), .c(new_n26_), .O(z14));
  nand2  g27(.a(new_n25_), .b(new_n22_), .O(new_n51_));
  nor2   g28(.a(new_n46_), .b(new_n51_), .O(z15));
  zero   g29(.O(z05));
  zero   g30(.O(z13));
