...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n34_, new_n37_, new_n41_, new_n45_;
  ...
  nor2   g15(.a(new_n37_), .b(new_n29_), .O(z09));
  nor2   g16(.a(new_n37_), .b(new_n32_), .O(z10));
  nor2   g17(.a(new_n37_), .b(new_n34_), .O(z11));
  nand2  g18(.a(new_n23_), .b(new_n22_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n26_), .O(z12));
  nor2   g20(.a(new_n41_), .b(new_n29_), .O(z13));
  nor2   g21(.a(new_n41_), .b(new_n32_), .O(z14));
  xor2a  g22(.a(x1), .b(x0), .O(new_n45_));
  aoi21  g23(.a(new_n34_), .b(new_n23_), .c(new_n45_), .O(z15));
  zero   g24(.O(z02));
