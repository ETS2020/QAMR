...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n35_, new_n40_, new_n41_;
  ...
  xnor2a g13(.a(x1), .b(x0), .O(new_n35_));
  aoi21  g14(.a(new_n23_), .b(x1), .c(new_n35_), .O(z08));
  aoi21  g15(.a(new_n26_), .b(new_n22_), .c(new_n35_), .O(z09));
  aoi21  g16(.a(new_n30_), .b(x1), .c(new_n35_), .O(z10));
  aoi21  g17(.a(new_n32_), .b(x1), .c(new_n35_), .O(z11));
  inv1   g18(.a(x1), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n22_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n23_), .O(z12));
  aoi21  g21(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  nor2   g22(.a(new_n41_), .b(new_n30_), .O(z14));
  nor2   g23(.a(new_n41_), .b(new_n32_), .O(z15));
  nor2   g24(.a(x1), .b(new_n22_), .O(z05));
  nor2   g25(.a(x1), .b(new_n22_), .O(z06));
  nor2   g26(.a(x1), .b(new_n22_), .O(z07));
endmodule
