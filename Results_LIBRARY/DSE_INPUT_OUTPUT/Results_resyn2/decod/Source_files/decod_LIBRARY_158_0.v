...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n33_, new_n35_, new_n37_, new_n42_;
  ...
  nor2   g14(.a(new_n35_), .b(new_n25_), .O(z03));
  ...
  nor2   g19(.a(new_n37_), .b(new_n35_), .O(z07));
  nand2  g20(.a(x1), .b(new_n22_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n26_), .O(z08));
  aoi21  g22(.a(new_n29_), .b(x1), .c(x0), .O(z09));
  aoi21  g23(.a(new_n32_), .b(x1), .c(x0), .O(z10));
  nor2   g24(.a(new_n42_), .b(new_n35_), .O(z11));
  inv1   g25(.a(new_n24_), .O(z14));
  zero   g26(.O(z12));
  zero   g27(.O(z13));
