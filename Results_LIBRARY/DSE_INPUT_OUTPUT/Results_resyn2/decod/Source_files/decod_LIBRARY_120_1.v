...
module FAU ( 
  ...
  aoi21  g13(.a(new_n23_), .b(new_n25_), .c(new_n34_), .O(z04));
  nand2  g14(.a(new_n25_), .b(x0), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n27_), .O(z05));
  aoi21  g16(.a(new_n30_), .b(new_n25_), .c(new_n34_), .O(z06));
  aoi21  g17(.a(new_n32_), .b(new_n25_), .c(new_n34_), .O(z07));
  nor2   g18(.a(new_n25_), .b(x0), .O(z09));
  aoi21  g19(.a(new_n23_), .b(new_n25_), .c(x0), .O(z12));
  inv1   g20(.a(x0), .O(new_n45_));
  nand2  g21(.a(new_n25_), .b(new_n45_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n27_), .O(z13));
