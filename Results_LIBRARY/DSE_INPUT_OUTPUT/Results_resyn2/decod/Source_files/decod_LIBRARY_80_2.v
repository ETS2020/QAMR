...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n43_, new_n45_, new_n47_,
    new_n51_;
  ...
  nand4  g05(.a(x4), .b(x3), .c(new_n27_), .d(x0), .O(new_n28_));
  ...
  nand3  g10(.a(x4), .b(x2), .c(new_n26_), .O(new_n33_));
  nand2  g11(.a(x3), .b(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n33_), .O(z04));
  nor2   g13(.a(new_n28_), .b(x1), .O(z06));
  ...
  nand3  g18(.a(x4), .b(x3), .c(new_n27_), .O(new_n43_));
  nor2   g19(.a(new_n40_), .b(new_n43_), .O(z10));
  nand3  g20(.a(x4), .b(new_n27_), .c(x1), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n22_), .c(x3), .O(z11));
  nand2  g22(.a(new_n26_), .b(new_n22_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n39_), .O(z12));
  aoi21  g24(.a(new_n33_), .b(new_n22_), .c(x3), .O(z13));
  oai21  g25(.a(new_n47_), .b(new_n43_), .c(new_n31_), .O(z14));
  nand3  g26(.a(x4), .b(new_n30_), .c(new_n27_), .O(new_n51_));
