...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n40_, new_n42_, new_n46_;
  ...
  nand3  g09(.a(x4), .b(x3), .c(new_n23_), .O(new_n31_));
  ...
  nand3  g18(.a(x4), .b(new_n28_), .c(new_n23_), .O(new_n40_));
  ...
  inv1   g23(.a(new_n24_), .O(z10));
  nand2  g24(.a(new_n35_), .b(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n26_), .O(z12));
  nor2   g26(.a(new_n46_), .b(new_n29_), .O(z13));
  zero   g27(.O(z15));
