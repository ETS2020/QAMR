...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n40_, new_n43_;
  ...
  aoi21  g11(.a(new_n34_), .b(new_n25_), .c(new_n24_), .O(z06));
  ...
  aoi21  g15(.a(new_n31_), .b(new_n24_), .c(new_n25_), .O(z09));
  nand2  g16(.a(x1), .b(new_n24_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n34_), .O(z10));
  nor2   g18(.a(new_n40_), .b(new_n36_), .O(z11));
  nand2  g19(.a(new_n25_), .b(new_n24_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n28_), .O(z12));
  nor2   g21(.a(new_n43_), .b(new_n31_), .O(z13));
  nor2   g22(.a(new_n43_), .b(new_n34_), .O(z14));
