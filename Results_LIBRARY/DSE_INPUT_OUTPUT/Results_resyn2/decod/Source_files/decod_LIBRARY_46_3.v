...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n42_, new_n47_;
  ...
  nand3  g13(.a(x4), .b(new_n29_), .c(new_n34_), .O(new_n37_));
  ...
  nand2  g17(.a(x1), .b(new_n33_), .O(new_n41_));
  nand3  g18(.a(x4), .b(new_n29_), .c(x2), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n41_), .O(z09));
  oai21  g20(.a(new_n41_), .b(new_n27_), .c(new_n22_), .O(z10));
  nor2   g21(.a(new_n41_), .b(new_n30_), .O(z11));
  aoi21  g22(.a(new_n35_), .b(new_n33_), .c(new_n26_), .O(z12));
  nand2  g23(.a(new_n34_), .b(new_n33_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n42_), .O(z13));
