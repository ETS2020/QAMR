...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n28_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n35_, new_n38_, new_n39_, new_n41_, new_n44_;
  ...
  nand3  g11(.a(x4), .b(x3), .c(new_n22_), .O(new_n35_));
  nor2   g12(.a(new_n35_), .b(new_n34_), .O(z06));
  nor2   g13(.a(new_n34_), .b(new_n30_), .O(z07));
  inv1   g14(.a(x0), .O(new_n38_));
  nand2  g15(.a(x1), .b(new_n38_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n35_), .O(z10));
  nand3  g17(.a(new_n29_), .b(x1), .c(new_n38_), .O(new_n41_));
  aoi21  g18(.a(new_n41_), .b(new_n22_), .c(new_n23_), .O(z11));
  nand2  g19(.a(new_n33_), .b(new_n38_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n35_), .O(z14));
  nor2   g21(.a(new_n44_), .b(new_n30_), .O(z15));
  zero   g22(.O(z01));
  zero   g23(.O(z04));
  zero   g24(.O(z13));
  nor2   g25(.a(new_n23_), .b(new_n22_), .O(z05));
