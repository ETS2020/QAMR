...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    ...
    new_n44_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_;
  ...
  nand3  g13(.a(x4), .b(new_n25_), .c(new_n32_), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n28_), .O(z03));
  inv1   g15(.a(x1), .O(new_n37_));
  nand3  g16(.a(x2), .b(new_n37_), .c(x0), .O(new_n38_));
  nor2   g17(.a(new_n38_), .b(new_n23_), .O(z04));
  oai21  g18(.a(new_n38_), .b(new_n26_), .c(new_n31_), .O(z05));
  nand2  g19(.a(new_n37_), .b(x0), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n33_), .c(new_n31_), .O(z06));
  nor2   g21(.a(new_n41_), .b(new_n35_), .O(z07));
  nand3  g22(.a(x2), .b(x1), .c(new_n29_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(z08));
  nor2   g24(.a(new_n44_), .b(new_n26_), .O(z09));
  nand3  g25(.a(x3), .b(new_n32_), .c(x1), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(x0), .O(z10));
  nand3  g27(.a(new_n25_), .b(new_n32_), .c(x1), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(x4), .c(x0), .O(z11));
  nand3  g29(.a(x3), .b(x2), .c(new_n37_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(x0), .O(z12));
  nand3  g31(.a(new_n25_), .b(x2), .c(new_n37_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(x0), .O(z13));
  nand3  g33(.a(x3), .b(new_n32_), .c(new_n37_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x0), .O(z14));
  nand2  g35(.a(new_n37_), .b(new_n29_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n35_), .O(z15));
endmodule
