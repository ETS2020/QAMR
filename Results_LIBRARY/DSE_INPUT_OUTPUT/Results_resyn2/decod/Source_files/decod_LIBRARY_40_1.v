...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n26_), .c(new_n39_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x1), .c(new_n25_), .O(z09));
  nand2  g22(.a(x1), .b(new_n39_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n31_), .c(new_n30_), .O(z10));
  nor2   g24(.a(new_n44_), .b(new_n33_), .O(z11));
  aoi21  g25(.a(new_n40_), .b(new_n25_), .c(x1), .O(z14));
  aoi21  g26(.a(new_n42_), .b(new_n25_), .c(x1), .O(z15));
  zero   g27(.O(z13));
  inv1   g28(.a(new_n30_), .O(z05));
