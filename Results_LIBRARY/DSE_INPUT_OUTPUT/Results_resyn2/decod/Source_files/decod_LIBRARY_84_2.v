...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n39_, new_n43_, new_n46_;
  ...
  oai21  g18(.a(new_n39_), .b(new_n30_), .c(new_n35_), .O(z10));
  xnor2a g19(.a(x1), .b(x0), .O(new_n43_));
  aoi21  g20(.a(new_n32_), .b(new_n25_), .c(new_n43_), .O(z11));
  aoi21  g21(.a(new_n23_), .b(new_n25_), .c(x1), .O(z12));
  nand2  g22(.a(new_n34_), .b(new_n25_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n27_), .O(z13));
  nor2   g24(.a(new_n46_), .b(new_n30_), .O(z14));
  aoi21  g25(.a(new_n32_), .b(new_n25_), .c(x1), .O(z15));
  zero   g26(.O(z06));
  zero   g27(.O(z07));
  inv1   g28(.a(new_n35_), .O(z05));
endmodule
