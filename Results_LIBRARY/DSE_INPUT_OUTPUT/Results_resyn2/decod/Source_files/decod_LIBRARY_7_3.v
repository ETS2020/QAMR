...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n34_, new_n37_, new_n39_, new_n41_, new_n42_, new_n45_, new_n47_;
  ...
  aoi21  g19(.a(new_n42_), .b(new_n24_), .c(new_n23_), .O(z09));
  nand3  g20(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n24_), .c(new_n23_), .O(z11));
  nand2  g22(.a(new_n23_), .b(new_n41_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n32_), .O(z12));
  oai21  g24(.a(new_n47_), .b(new_n34_), .c(new_n39_), .O(z13));
  aoi21  g25(.a(new_n45_), .b(new_n23_), .c(new_n24_), .O(z14));
  oai21  g26(.a(new_n47_), .b(new_n37_), .c(new_n39_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z02));
  zero   g29(.O(z10));
endmodule
