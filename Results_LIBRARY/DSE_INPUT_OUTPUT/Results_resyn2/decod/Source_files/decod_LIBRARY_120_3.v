...
module FAU ( 
  ...
  aoi21  g16(.a(new_n30_), .b(new_n23_), .c(new_n24_), .O(z09));
  nor2   g17(.a(new_n38_), .b(new_n34_), .O(z10));
  nor2   g18(.a(new_n38_), .b(new_n36_), .O(z11));
  ...
  aoi21  g23(.a(new_n34_), .b(new_n24_), .c(new_n43_), .O(z14));
