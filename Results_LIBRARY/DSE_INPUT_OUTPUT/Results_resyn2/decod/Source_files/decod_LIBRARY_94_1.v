...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n43_, new_n44_, new_n47_;
  ...
  nor2   g16(.a(new_n22_), .b(x0), .O(z11));
  aoi21  g17(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  inv1   g18(.a(x0), .O(new_n43_));
  nand2  g19(.a(new_n22_), .b(new_n43_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n26_), .O(z13));
  aoi21  g21(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  nand3  g22(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n47_));
  nor2   g23(.a(new_n44_), .b(new_n47_), .O(z15));
  zero   g24(.O(z08));
  zero   g25(.O(z09));
  zero   g26(.O(z10));
endmodule
