...
module FAU ( 
  ...
  aoi21  g17(.a(new_n34_), .b(new_n22_), .c(new_n23_), .O(z10));
  nor2   g18(.a(new_n39_), .b(new_n36_), .O(z11));
  xor2a  g19(.a(x1), .b(x0), .O(new_n43_));
  aoi21  g20(.a(new_n27_), .b(new_n22_), .c(new_n43_), .O(z12));
  nand2  g21(.a(new_n23_), .b(new_n22_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n30_), .O(z13));
  nor2   g23(.a(new_n45_), .b(new_n34_), .O(z14));
  nor2   g24(.a(new_n45_), .b(new_n36_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
