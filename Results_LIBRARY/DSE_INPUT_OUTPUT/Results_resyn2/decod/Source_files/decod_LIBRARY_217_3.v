...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n34_, new_n36_, new_n41_, new_n45_;
  ...
  aoi21  g15(.a(new_n29_), .b(new_n22_), .c(new_n23_), .O(z09));
  nor2   g16(.a(new_n36_), .b(new_n32_), .O(z10));
  aoi21  g17(.a(new_n34_), .b(new_n22_), .c(new_n23_), .O(z11));
  xor2a  g18(.a(x1), .b(x0), .O(new_n41_));
  aoi21  g19(.a(new_n26_), .b(new_n22_), .c(new_n41_), .O(z12));
  aoi21  g20(.a(new_n29_), .b(new_n23_), .c(new_n41_), .O(z13));
  aoi21  g21(.a(new_n32_), .b(new_n23_), .c(new_n41_), .O(z14));
  nand2  g22(.a(new_n23_), .b(new_n22_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n34_), .O(z15));
  zero   g24(.O(z03));
