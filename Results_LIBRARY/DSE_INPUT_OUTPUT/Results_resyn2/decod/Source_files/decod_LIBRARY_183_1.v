...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n38_, new_n44_, new_n45_;
  ...
  aoi21  g17(.a(new_n32_), .b(new_n25_), .c(new_n38_), .O(z07));
  nor2   g18(.a(new_n25_), .b(x0), .O(z11));
  inv1   g19(.a(x0), .O(new_n44_));
  nand2  g20(.a(new_n25_), .b(new_n44_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n45_), .b(new_n27_), .O(z13));
  nor2   g23(.a(new_n45_), .b(new_n30_), .O(z14));
  aoi21  g24(.a(new_n32_), .b(new_n25_), .c(x0), .O(z15));
  zero   g25(.O(z08));
  zero   g26(.O(z09));
  zero   g27(.O(z10));
endmodule
