...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n32_), .c(new_n27_), .O(z06));
  ...
  nor2   g23(.a(new_n44_), .b(new_n29_), .O(z09));
  nor2   g24(.a(new_n44_), .b(new_n32_), .O(z10));
  nor2   g25(.a(new_n44_), .b(new_n34_), .O(z11));
  nand3  g26(.a(x3), .b(x2), .c(new_n36_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(x0), .O(z12));
  nand2  g28(.a(new_n36_), .b(new_n25_), .O(new_n50_));
