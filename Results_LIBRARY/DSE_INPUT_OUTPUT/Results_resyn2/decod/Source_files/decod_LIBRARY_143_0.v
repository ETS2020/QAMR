...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n42_, new_n43_;
  ...
  aoi21  g09(.a(new_n30_), .b(x1), .c(new_n23_), .O(z02));
  ...
  nor2   g16(.a(new_n35_), .b(new_n30_), .O(z06));
  nor2   g17(.a(new_n35_), .b(new_n32_), .O(z07));
  aoi21  g18(.a(new_n22_), .b(x1), .c(x0), .O(z08));
  aoi21  g19(.a(new_n27_), .b(x1), .c(x0), .O(z09));
  inv1   g20(.a(x0), .O(new_n42_));
  nand2  g21(.a(x1), .b(new_n42_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n30_), .O(z10));
