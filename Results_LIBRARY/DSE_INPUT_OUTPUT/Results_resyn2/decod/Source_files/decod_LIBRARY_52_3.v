...
module FAU ( 
  ...
  nand3  g10(.a(x2), .b(new_n24_), .c(x0), .O(new_n32_));
  ...
  nand3  g15(.a(new_n28_), .b(new_n24_), .c(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n31_), .O(z06));
  nand3  g17(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n34_), .c(new_n22_), .O(z07));
  inv1   g19(.a(x0), .O(new_n41_));
  nand3  g20(.a(x4), .b(x2), .c(new_n41_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n25_), .c(new_n24_), .O(z09));
  nand3  g22(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n25_), .c(new_n24_), .O(z11));
  aoi21  g24(.a(new_n42_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand2  g25(.a(new_n24_), .b(new_n41_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n35_), .c(new_n22_), .O(z13));
  aoi21  g27(.a(new_n44_), .b(new_n24_), .c(new_n25_), .O(z14));
