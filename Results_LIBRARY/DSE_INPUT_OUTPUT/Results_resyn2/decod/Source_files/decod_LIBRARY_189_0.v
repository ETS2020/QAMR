...
module FAU ( 
  ...
  oai21  g14(.a(new_n29_), .b(new_n32_), .c(new_n35_), .O(z03));
  aoi21  g15(.a(new_n22_), .b(x0), .c(x1), .O(z04));
  aoi21  g16(.a(new_n26_), .b(x0), .c(x1), .O(z05));
  nand3  g17(.a(new_n28_), .b(new_n34_), .c(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n30_), .O(z06));
  nor2   g19(.a(new_n39_), .b(new_n32_), .O(z07));
  nor3   g20(.a(new_n22_), .b(new_n34_), .c(x0), .O(z08));
  aoi21  g21(.a(new_n26_), .b(x1), .c(x0), .O(z09));
  nand3  g22(.a(new_n28_), .b(x1), .c(new_n33_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n30_), .O(z10));
  nor2   g24(.a(new_n44_), .b(new_n32_), .O(z11));
  inv1   g25(.a(new_n35_), .O(z14));
  zero   g26(.O(z12));
  zero   g27(.O(z13));
  inv1   g28(.a(new_n35_), .O(z15));
endmodule
