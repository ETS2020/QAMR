...
module FAU ( 
  ...
  aoi21  g13(.a(new_n23_), .b(new_n28_), .c(new_n34_), .O(z04));
  ...
  aoi21  g18(.a(new_n23_), .b(new_n28_), .c(x0), .O(z12));
  aoi21  g19(.a(new_n26_), .b(new_n28_), .c(x0), .O(z13));
  inv1   g20(.a(x0), .O(new_n46_));
  nand2  g21(.a(new_n28_), .b(new_n46_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n30_), .O(z14));
  aoi21  g23(.a(new_n32_), .b(new_n28_), .c(x0), .O(z15));
  zero   g24(.O(z08));
  zero   g25(.O(z09));
  zero   g26(.O(z10));
  zero   g27(.O(z11));
