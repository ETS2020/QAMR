...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n40_, new_n41_, new_n46_;
  ...
  oai21  g21(.a(new_n41_), .b(new_n31_), .c(new_n24_), .O(z10));
  nor2   g22(.a(new_n41_), .b(new_n33_), .O(z11));
  nand2  g23(.a(new_n22_), .b(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n26_), .O(z12));
  nor2   g25(.a(new_n46_), .b(new_n31_), .O(z14));
  zero   g26(.O(z05));
  zero   g27(.O(z13));
