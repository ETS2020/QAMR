...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n31_, new_n33_, new_n39_, new_n40_, new_n42_, new_n43_, new_n50_;
  ...
  inv1   g13(.a(new_n29_), .O(z05));
  aoi21  g14(.a(new_n23_), .b(new_n22_), .c(x1), .O(z06));
  aoi21  g15(.a(new_n26_), .b(new_n22_), .c(x1), .O(z07));
  ...
  oai21  g23(.a(new_n42_), .b(new_n33_), .c(new_n29_), .O(z11));
  aoi21  g24(.a(new_n40_), .b(new_n22_), .c(x1), .O(z14));
  nand3  g25(.a(x4), .b(new_n25_), .c(new_n39_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n22_), .c(x1), .O(z15));
  zero   g27(.O(z04));
  zero   g28(.O(z12));
  zero   g29(.O(z13));
endmodule
