...
module FAU ( 
  ...
  nand3  g12(.a(new_n28_), .b(x1), .c(x0), .O(new_n34_));
  ...
  oai21  g19(.a(new_n42_), .b(new_n23_), .c(new_n29_), .O(z08));
  ...
  nand3  g23(.a(x4), .b(new_n30_), .c(new_n41_), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(x1), .c(x3), .O(z11));
  aoi21  g25(.a(new_n44_), .b(x3), .c(x1), .O(z12));
  inv1   g26(.a(new_n29_), .O(z13));
  nand2  g27(.a(new_n27_), .b(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n31_), .O(z14));
  zero   g29(.O(z05));
  zero   g30(.O(z07));
  inv1   g31(.a(new_n29_), .O(z15));
endmodule
