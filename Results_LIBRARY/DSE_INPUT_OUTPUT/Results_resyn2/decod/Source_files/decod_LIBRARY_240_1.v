...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n27_, new_n28_, new_n32_,
    new_n34_, new_n35_, new_n40_, new_n44_;
  ...
  nor2   g08(.a(new_n26_), .b(x2), .O(z03));
  nand3  g09(.a(x3), .b(new_n23_), .c(x0), .O(new_n32_));
  ...
  nor3   g14(.a(new_n24_), .b(new_n23_), .c(x0), .O(z08));
  nand3  g15(.a(new_n27_), .b(x1), .c(new_n22_), .O(new_n40_));
  aoi21  g16(.a(new_n40_), .b(x2), .c(new_n26_), .O(z09));
  nor3   g17(.a(new_n24_), .b(x1), .c(x0), .O(z12));
  nand3  g18(.a(new_n27_), .b(new_n23_), .c(new_n22_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x2), .c(new_n26_), .O(z13));
  zero   g20(.O(z02));
  zero   g21(.O(z06));
  zero   g22(.O(z07));
  zero   g23(.O(z10));
  zero   g24(.O(z15));
  nor2   g25(.a(new_n26_), .b(x2), .O(z11));
  nor2   g26(.a(new_n26_), .b(x2), .O(z14));
endmodule
