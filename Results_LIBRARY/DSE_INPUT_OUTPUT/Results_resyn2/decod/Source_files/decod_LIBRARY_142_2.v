...
module FAU ( 
  ...
  oai21  g20(.a(new_n41_), .b(new_n34_), .c(new_n37_), .O(z07));
  ...
  nor2   g26(.a(new_n44_), .b(new_n39_), .O(z10));
  nor2   g27(.a(new_n44_), .b(new_n41_), .O(z11));
  nand2  g28(.a(new_n28_), .b(new_n43_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z12));
  nor2   g30(.a(new_n50_), .b(new_n26_), .O(z13));
  nor2   g31(.a(new_n50_), .b(new_n39_), .O(z14));
  oai21  g32(.a(new_n50_), .b(new_n41_), .c(new_n37_), .O(z15));
endmodule
