...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n44_;
  ...
  aoi21  g15(.a(new_n26_), .b(x0), .c(new_n36_), .O(z05));
  aoi21  g16(.a(new_n29_), .b(new_n22_), .c(new_n36_), .O(z06));
  aoi21  g17(.a(new_n32_), .b(new_n22_), .c(new_n36_), .O(z07));
  nor2   g18(.a(new_n22_), .b(x0), .O(z08));
  nand2  g19(.a(new_n22_), .b(new_n34_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n23_), .O(z12));
  nor2   g21(.a(new_n44_), .b(new_n26_), .O(z13));
  nor2   g22(.a(new_n44_), .b(new_n29_), .O(z14));
  aoi21  g23(.a(new_n32_), .b(new_n22_), .c(x0), .O(z15));
  zero   g24(.O(z09));
  zero   g25(.O(z10));
  zero   g26(.O(z11));
endmodule
