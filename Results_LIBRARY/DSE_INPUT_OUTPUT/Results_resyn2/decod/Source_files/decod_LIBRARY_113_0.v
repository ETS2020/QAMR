...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n36_, new_n37_, new_n41_, new_n42_;
  ...
  aoi21  g11(.a(new_n32_), .b(x1), .c(new_n23_), .O(z03));
  ...
  nor2   g17(.a(new_n32_), .b(new_n37_), .O(z07));
  aoi21  g18(.a(new_n22_), .b(x1), .c(x0), .O(z08));
  inv1   g19(.a(x0), .O(new_n41_));
  nand2  g20(.a(x1), .b(new_n41_), .O(new_n42_));
  nor2   g21(.a(new_n27_), .b(new_n42_), .O(z09));
  nor2   g22(.a(new_n30_), .b(new_n42_), .O(z10));
