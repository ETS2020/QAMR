...
module FAU ( 
  ...
  oai21  g11(.a(new_n33_), .b(new_n23_), .c(new_n29_), .O(z04));
  ...
  nand3  g16(.a(x4), .b(new_n25_), .c(x0), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(new_n32_), .c(x2), .O(z07));
  inv1   g18(.a(x0), .O(new_n41_));
  nand3  g19(.a(x4), .b(x3), .c(new_n41_), .O(new_n42_));
  aoi21  g20(.a(new_n42_), .b(x2), .c(new_n32_), .O(z08));
  nand3  g21(.a(x4), .b(new_n25_), .c(new_n41_), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(x2), .c(new_n32_), .O(z09));
  nand2  g23(.a(new_n32_), .b(new_n41_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n23_), .O(z12));
  oai21  g25(.a(new_n47_), .b(new_n26_), .c(new_n29_), .O(z13));
  aoi21  g26(.a(new_n42_), .b(new_n32_), .c(x2), .O(z14));
  nand3  g27(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n47_), .O(z15));
  zero   g29(.O(z03));
  zero   g30(.O(z11));
  inv1   g31(.a(new_n29_), .O(z10));
endmodule
