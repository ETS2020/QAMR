...
module FAU ( 
  ...
  nor2   g16(.a(new_n35_), .b(new_n31_), .O(z07));
  ...
  nor2   g22(.a(new_n44_), .b(new_n41_), .O(z10));
  oai21  g23(.a(new_n41_), .b(new_n31_), .c(new_n37_), .O(z11));
  nand3  g24(.a(x4), .b(x2), .c(new_n40_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(new_n25_), .c(x1), .O(z13));
  nand3  g26(.a(x4), .b(new_n28_), .c(new_n40_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n25_), .c(x1), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z14));
