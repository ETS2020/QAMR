...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_, new_n45_;
  nand2  g00(.a(x4), .b(x1), .O(new_n22_));
  ...
  nand3  g14(.a(x3), .b(x2), .c(new_n37_), .O(new_n38_));
  aoi21  g15(.a(new_n38_), .b(x1), .c(new_n25_), .O(z08));
  ...
  nand2  g20(.a(new_n26_), .b(new_n29_), .O(new_n44_));
  nand3  g21(.a(x4), .b(x1), .c(new_n37_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n44_), .O(z11));
  zero   g23(.O(z06));
  zero   g24(.O(z07));
  zero   g25(.O(z13));
  nor2   g26(.a(new_n25_), .b(x1), .O(z05));
  nor2   g27(.a(new_n25_), .b(x1), .O(z12));
  nor2   g28(.a(new_n25_), .b(x1), .O(z14));
  nor2   g29(.a(new_n25_), .b(x1), .O(z15));
endmodule
