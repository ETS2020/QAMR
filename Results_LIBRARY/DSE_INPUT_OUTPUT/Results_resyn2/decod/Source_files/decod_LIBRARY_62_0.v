...
module FAU ( 
  ...
  aoi21  g06(.a(new_n27_), .b(x3), .c(new_n23_), .O(z02));
  inv1   g07(.a(x3), .O(new_n29_));
  nand2  g08(.a(x4), .b(new_n29_), .O(new_n30_));
  nor2   g09(.a(new_n27_), .b(new_n30_), .O(z03));
  ...
  aoi21  g14(.a(new_n33_), .b(x4), .c(x3), .O(z05));
  ...
  nand3  g22(.a(x4), .b(new_n29_), .c(x2), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n41_), .O(z09));
  nand3  g24(.a(new_n26_), .b(x1), .c(new_n40_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n34_), .O(z10));
  aoi21  g26(.a(new_n46_), .b(x4), .c(x3), .O(z11));
  nand3  g27(.a(x2), .b(new_n32_), .c(new_n40_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n34_), .O(z12));
  aoi21  g29(.a(new_n49_), .b(x4), .c(x3), .O(z13));
  nand3  g30(.a(new_n26_), .b(new_n32_), .c(new_n40_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n34_), .O(z14));
  nor2   g32(.a(new_n52_), .b(new_n30_), .O(z15));
endmodule
