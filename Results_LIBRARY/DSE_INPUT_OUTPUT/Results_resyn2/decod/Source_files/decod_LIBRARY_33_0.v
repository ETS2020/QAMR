...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n44_, new_n47_, new_n50_, new_n52_, new_n54_, new_n56_, new_n57_;
  ...
  nand3  g25(.a(new_n31_), .b(x1), .c(new_n43_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n33_), .O(z10));
  nor2   g27(.a(new_n47_), .b(new_n35_), .O(z11));
  nand3  g28(.a(x3), .b(x2), .c(new_n43_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(x1), .O(z12));
  nand3  g30(.a(new_n28_), .b(x2), .c(new_n43_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x1), .O(z13));
  nand3  g32(.a(x3), .b(new_n31_), .c(new_n43_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x1), .O(z14));
  nand2  g34(.a(new_n31_), .b(new_n43_), .O(new_n56_));
  nand3  g35(.a(x4), .b(new_n28_), .c(new_n22_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n56_), .O(z15));
endmodule
