...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n44_, new_n45_, new_n50_, new_n52_, new_n55_;
  ...
  nand2  g28(.a(new_n22_), .b(new_n44_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n26_), .O(z12));
  nand3  g30(.a(new_n28_), .b(x2), .c(new_n44_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x1), .O(z13));
  nor2   g32(.a(new_n50_), .b(new_n32_), .O(z14));
  nand3  g33(.a(new_n28_), .b(new_n31_), .c(new_n44_), .O(new_n55_));
