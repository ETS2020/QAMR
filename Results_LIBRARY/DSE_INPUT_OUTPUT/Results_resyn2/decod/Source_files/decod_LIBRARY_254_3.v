...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n35_, new_n40_, new_n44_;
  inv1   g00(.a(x0), .O(new_n22_));
  inv1   g01(.a(x1), .O(new_n23_));
  nor2   g02(.a(new_n23_), .b(new_n22_), .O(z00));
  nand3  g03(.a(x4), .b(x3), .c(x2), .O(new_n25_));
  nor3   g04(.a(new_n25_), .b(x1), .c(new_n22_), .O(z04));
  ...
  nand2  g13(.a(x1), .b(new_n22_), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n25_), .O(z08));
  aoi21  g15(.a(new_n28_), .b(new_n22_), .c(new_n23_), .O(z09));
  aoi21  g16(.a(new_n31_), .b(new_n22_), .c(new_n23_), .O(z10));
  nor2   g17(.a(new_n35_), .b(new_n33_), .O(z11));
  nand2  g18(.a(new_n23_), .b(new_n22_), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n25_), .O(z12));
  nor2   g20(.a(new_n40_), .b(new_n28_), .O(z13));
  nor2   g21(.a(new_n40_), .b(new_n31_), .O(z14));
  xor2a  g22(.a(x1), .b(x0), .O(new_n44_));
  aoi21  g23(.a(new_n33_), .b(new_n23_), .c(new_n44_), .O(z15));
