...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n42_, new_n46_;
  ...
  nand2  g09(.a(new_n25_), .b(new_n28_), .O(new_n32_));
  inv1   g10(.a(x1), .O(new_n33_));
  nand2  g11(.a(new_n33_), .b(x0), .O(new_n34_));
  oai21  g12(.a(new_n34_), .b(new_n23_), .c(new_n32_), .O(z04));
  nor2   g13(.a(new_n34_), .b(new_n26_), .O(z05));
  nor2   g14(.a(new_n34_), .b(new_n29_), .O(z06));
  inv1   g15(.a(x0), .O(new_n39_));
  nand2  g16(.a(x1), .b(new_n39_), .O(new_n40_));
  oai21  g17(.a(new_n40_), .b(new_n23_), .c(new_n32_), .O(z08));
  nand3  g18(.a(x4), .b(x1), .c(new_n39_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(x2), .c(x3), .O(z09));
  nor2   g20(.a(new_n40_), .b(new_n29_), .O(z10));
  inv1   g21(.a(new_n32_), .O(z11));
  nand2  g22(.a(new_n33_), .b(new_n39_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n23_), .c(new_n32_), .O(z12));
  nor2   g24(.a(new_n46_), .b(new_n26_), .O(z13));
  nor2   g25(.a(new_n46_), .b(new_n29_), .O(z14));
  zero   g26(.O(z03));
  zero   g27(.O(z07));
  inv1   g28(.a(new_n32_), .O(z15));
endmodule
