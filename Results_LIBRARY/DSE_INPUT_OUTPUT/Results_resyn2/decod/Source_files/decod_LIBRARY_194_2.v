...
module FAU ( 
  ...
  aoi21  g22(.a(new_n43_), .b(x4), .c(new_n27_), .O(z08));
  nand2  g23(.a(x4), .b(new_n27_), .O(new_n45_));
  nor2   g24(.a(new_n43_), .b(new_n45_), .O(z09));
  nand3  g25(.a(new_n30_), .b(x1), .c(new_n42_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(new_n27_), .O(z10));
  nand2  g27(.a(x1), .b(new_n42_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n33_), .c(new_n26_), .O(z11));
  nand2  g29(.a(new_n35_), .b(new_n42_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n23_), .O(z12));
  nor2   g31(.a(new_n51_), .b(new_n28_), .O(z13));
  nor2   g32(.a(new_n51_), .b(new_n31_), .O(z14));
  oai21  g33(.a(new_n51_), .b(new_n33_), .c(new_n26_), .O(z15));
endmodule
