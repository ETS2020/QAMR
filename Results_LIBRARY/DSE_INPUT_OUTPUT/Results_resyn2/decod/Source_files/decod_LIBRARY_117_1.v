...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n42_, new_n43_;
  ...
  nor2   g16(.a(new_n34_), .b(new_n32_), .O(z07));
  nor2   g17(.a(new_n22_), .b(x0), .O(z10));
  inv1   g18(.a(x0), .O(new_n42_));
  nand2  g19(.a(new_n22_), .b(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n23_), .O(z12));
  nor2   g21(.a(new_n43_), .b(new_n27_), .O(z13));
  nor2   g22(.a(new_n43_), .b(new_n30_), .O(z14));
  nor2   g23(.a(new_n43_), .b(new_n32_), .O(z15));
  zero   g24(.O(z08));
  zero   g25(.O(z09));
