...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n38_, new_n40_, new_n41_, new_n46_;
  nand2  g00(.a(x1), .b(x0), .O(new_n22_));
  nand3  g01(.a(x4), .b(x3), .c(x2), .O(new_n23_));
  oai22  g02(.a(new_n23_), .b(new_n22_), .c(x3), .d(x0), .O(z00));
  ...
  nand3  g09(.a(x4), .b(new_n28_), .c(x1), .O(new_n31_));
  aoi21  g10(.a(new_n31_), .b(x0), .c(x3), .O(z03));
  inv1   g11(.a(x1), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x0), .O(new_n34_));
  nor2   g13(.a(new_n34_), .b(new_n23_), .O(z04));
  nor2   g14(.a(new_n34_), .b(new_n26_), .O(z05));
  nor2   g15(.a(new_n34_), .b(new_n29_), .O(z06));
  ...
  nand3  g24(.a(x4), .b(new_n28_), .c(new_n33_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x3), .c(x0), .O(z14));
  zero   g26(.O(z15));
  nor2   g27(.a(x3), .b(x0), .O(z11));
  nor2   g28(.a(x3), .b(x0), .O(z13));
endmodule
