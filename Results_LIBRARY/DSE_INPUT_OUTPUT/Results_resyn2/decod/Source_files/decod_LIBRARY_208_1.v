...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n38_, new_n40_;
  ...
  nor2   g11(.a(new_n31_), .b(new_n28_), .O(z06));
  inv1   g12(.a(x0), .O(new_n34_));
  nand3  g13(.a(x2), .b(x1), .c(new_n34_), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(x3), .c(new_n25_), .O(z08));
  nand3  g15(.a(new_n27_), .b(x1), .c(new_n34_), .O(new_n38_));
  aoi21  g16(.a(new_n38_), .b(x3), .c(new_n25_), .O(z10));
  nand2  g17(.a(new_n30_), .b(new_n34_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n23_), .O(z12));
  nor2   g19(.a(new_n40_), .b(new_n28_), .O(z14));
  zero   g20(.O(z09));
  zero   g21(.O(z13));
  nor2   g22(.a(new_n25_), .b(x3), .O(z03));
  nor2   g23(.a(new_n25_), .b(x3), .O(z05));
  nor2   g24(.a(new_n25_), .b(x3), .O(z07));
  nor2   g25(.a(new_n25_), .b(x3), .O(z11));
  nor2   g26(.a(new_n25_), .b(x3), .O(z15));
endmodule
