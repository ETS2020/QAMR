...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    new_n31_, new_n33_, new_n34_, new_n40_, new_n41_, new_n44_, new_n46_,
    new_n49_;
  ...
  nand2  g12(.a(new_n26_), .b(x1), .O(new_n34_));
  ...
  oai21  g18(.a(new_n41_), .b(new_n23_), .c(new_n27_), .O(z08));
  nor2   g19(.a(new_n41_), .b(new_n29_), .O(z09));
  nand3  g20(.a(x4), .b(x3), .c(new_n40_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n34_), .O(z10));
  nand3  g22(.a(x4), .b(new_n28_), .c(new_n40_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n34_), .O(z11));
  aoi21  g24(.a(new_n44_), .b(x2), .c(x1), .O(z12));
  nand2  g25(.a(new_n25_), .b(new_n40_), .O(new_n49_));
