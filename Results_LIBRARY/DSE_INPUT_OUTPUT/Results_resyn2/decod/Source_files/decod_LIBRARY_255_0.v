...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n36_;
  ...
  nor3   g19(.a(new_n26_), .b(new_n23_), .c(x0), .O(z08));
  aoi21  g20(.a(new_n29_), .b(x1), .c(x0), .O(z09));
  aoi21  g21(.a(new_n32_), .b(x1), .c(x0), .O(z10));
  aoi21  g22(.a(new_n34_), .b(x1), .c(x0), .O(z11));
  inv1   g23(.a(new_n24_), .O(z12));
  zero   g24(.O(z13));
  zero   g25(.O(z15));
