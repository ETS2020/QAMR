...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n42_, new_n44_, new_n47_;
  ...
  aoi21  g16(.a(new_n40_), .b(new_n22_), .c(new_n23_), .O(z09));
  nand2  g17(.a(x1), .b(new_n39_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n30_), .O(z11));
  nand3  g19(.a(x2), .b(new_n32_), .c(new_n39_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand3  g21(.a(new_n29_), .b(new_n32_), .c(new_n39_), .O(new_n47_));
  ...
  nor2   g29(.a(new_n23_), .b(new_n22_), .O(z12));
endmodule
