...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n36_, new_n38_, new_n40_, new_n44_,
    new_n51_;
  ...
  nand3  g14(.a(x4), .b(x2), .c(new_n35_), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(x0), .c(new_n22_), .O(z04));
  nand2  g16(.a(new_n35_), .b(x0), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n26_), .c(new_n32_), .O(z05));
  nand3  g18(.a(x4), .b(new_n28_), .c(new_n35_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(x0), .c(new_n22_), .O(z06));
  oai21  g20(.a(new_n38_), .b(new_n33_), .c(new_n32_), .O(z07));
  nand2  g21(.a(x1), .b(new_n31_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n26_), .O(z09));
  inv1   g23(.a(new_n32_), .O(z10));
  nor2   g24(.a(new_n44_), .b(new_n33_), .O(z11));
  aoi21  g25(.a(new_n36_), .b(new_n22_), .c(x0), .O(z13));
