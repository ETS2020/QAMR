...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_, new_n34_,
    new_n35_, new_n37_, new_n42_, new_n44_, new_n46_;
  ...
  aoi21  g14(.a(new_n29_), .b(new_n25_), .c(new_n26_), .O(z08));
  aoi21  g15(.a(new_n32_), .b(new_n25_), .c(new_n26_), .O(z09));
  aoi21  g16(.a(new_n35_), .b(new_n25_), .c(new_n26_), .O(z10));
  ...
  aoi21  g22(.a(new_n32_), .b(new_n25_), .c(new_n46_), .O(z13));
  aoi21  g23(.a(new_n35_), .b(new_n25_), .c(new_n46_), .O(z14));
