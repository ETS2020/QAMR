...
module FAU ( 
  ...
  aoi21  g21(.a(new_n45_), .b(new_n25_), .c(new_n32_), .O(z11));
  nand2  g22(.a(x4), .b(x3), .O(new_n47_));
  nand3  g23(.a(x2), .b(new_n32_), .c(new_n41_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n47_), .O(z12));
  nand2  g25(.a(new_n32_), .b(new_n41_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n26_), .O(z13));
  nand3  g27(.a(new_n29_), .b(new_n32_), .c(new_n41_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n47_), .O(z14));
  oai21  g29(.a(new_n50_), .b(new_n30_), .c(new_n22_), .O(z15));
  zero   g30(.O(z02));
  zero   g31(.O(z08));
  zero   g32(.O(z10));
endmodule
