...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n37_, new_n39_, new_n40_, new_n42_, new_n47_;
  ...
  nand3  g15(.a(x4), .b(new_n30_), .c(x0), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x3), .c(x1), .O(z06));
  inv1   g17(.a(x0), .O(new_n39_));
  nand2  g18(.a(x1), .b(new_n39_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n26_), .c(new_n24_), .O(z08));
  nand3  g20(.a(x4), .b(new_n23_), .c(x2), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n40_), .O(z09));
  oai21  g22(.a(new_n40_), .b(new_n31_), .c(new_n24_), .O(z10));
  nor2   g23(.a(new_n40_), .b(new_n33_), .O(z11));
  nor3   g24(.a(new_n26_), .b(x1), .c(x0), .O(z12));
  nand3  g25(.a(x4), .b(new_n30_), .c(new_n39_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x3), .c(x1), .O(z14));
  zero   g27(.O(z15));
  inv1   g28(.a(new_n24_), .O(z07));
