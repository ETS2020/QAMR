...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n44_, new_n47_, new_n48_, new_n50_, new_n52_, new_n55_;
  ...
  nand2  g25(.a(x4), .b(x3), .O(new_n47_));
  nand3  g26(.a(new_n25_), .b(x1), .c(new_n43_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n47_), .O(z10));
  nand2  g28(.a(x4), .b(new_n28_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n48_), .O(z11));
  nand2  g30(.a(new_n35_), .b(new_n43_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n23_), .c(new_n27_), .O(z12));
  oai21  g32(.a(new_n52_), .b(new_n29_), .c(new_n27_), .O(z13));
  nand3  g33(.a(new_n25_), .b(new_n35_), .c(new_n43_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n47_), .O(z14));
  nor2   g35(.a(new_n55_), .b(new_n50_), .O(z15));
endmodule
