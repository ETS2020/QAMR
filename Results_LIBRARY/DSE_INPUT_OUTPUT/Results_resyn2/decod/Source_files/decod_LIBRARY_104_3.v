...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n43_, new_n47_;
  ...
  nand2  g06(.a(new_n26_), .b(x0), .O(new_n29_));
  ...
  nor2   g16(.a(new_n38_), .b(new_n27_), .O(z08));
  ...
  oai21  g22(.a(new_n43_), .b(new_n31_), .c(new_n22_), .O(z13));
  nor2   g23(.a(new_n43_), .b(new_n34_), .O(z14));
  xor2a  g24(.a(x1), .b(x0), .O(new_n47_));
  aoi21  g25(.a(new_n36_), .b(new_n25_), .c(new_n47_), .O(z15));
  zero   g26(.O(z03));
