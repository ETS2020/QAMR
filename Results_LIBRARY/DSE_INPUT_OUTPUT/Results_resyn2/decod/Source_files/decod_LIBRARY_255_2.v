...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n38_, new_n40_, new_n45_;
  ...
  nor2   g12(.a(x1), .b(new_n22_), .O(z07));
  inv1   g13(.a(x1), .O(new_n38_));
  nor3   g14(.a(new_n23_), .b(new_n38_), .c(x0), .O(z08));
  xnor2a g15(.a(x1), .b(x0), .O(new_n40_));
  aoi21  g16(.a(new_n27_), .b(new_n22_), .c(new_n40_), .O(z09));
  aoi21  g17(.a(new_n30_), .b(new_n22_), .c(new_n40_), .O(z10));
  aoi21  g18(.a(new_n32_), .b(x1), .c(new_n40_), .O(z11));
  aoi21  g19(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand2  g20(.a(new_n38_), .b(new_n22_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n27_), .O(z13));
  aoi21  g22(.a(new_n30_), .b(new_n22_), .c(x1), .O(z14));
