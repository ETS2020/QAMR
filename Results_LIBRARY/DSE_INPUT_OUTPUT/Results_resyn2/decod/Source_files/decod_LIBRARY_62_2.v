...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n40_, new_n42_,
    new_n44_, new_n45_, new_n50_;
  ...
  oai21  g17(.a(new_n36_), .b(new_n28_), .c(new_n27_), .O(z05));
  nand3  g18(.a(x4), .b(x3), .c(new_n30_), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n36_), .O(z06));
  nand3  g20(.a(x4), .b(new_n22_), .c(new_n30_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n36_), .c(new_n27_), .O(z07));
  inv1   g22(.a(x0), .O(new_n44_));
  nand2  g23(.a(x1), .b(new_n44_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n37_), .O(z08));
  nor2   g25(.a(new_n45_), .b(new_n28_), .O(z09));
  nor2   g26(.a(new_n45_), .b(new_n40_), .O(z10));
  oai21  g27(.a(new_n45_), .b(new_n42_), .c(new_n27_), .O(z11));
  nand2  g28(.a(new_n35_), .b(new_n44_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n37_), .O(z12));
  oai21  g30(.a(new_n50_), .b(new_n28_), .c(new_n27_), .O(z13));
  nor2   g31(.a(new_n50_), .b(new_n40_), .O(z14));
  nor2   g32(.a(new_n50_), .b(new_n42_), .O(z15));
endmodule
