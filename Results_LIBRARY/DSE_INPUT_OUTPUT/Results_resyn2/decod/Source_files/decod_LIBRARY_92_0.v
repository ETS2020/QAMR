...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n36_, new_n39_, new_n41_, new_n42_, new_n47_,
    new_n49_;
  ...
  aoi22  g05(.a(new_n26_), .b(x1), .c(new_n22_), .d(x4), .O(z01));
  ...
  nand3  g11(.a(x3), .b(x2), .c(x0), .O(new_n33_));
  aoi21  g12(.a(new_n33_), .b(x4), .c(x1), .O(z04));
  inv1   g13(.a(x1), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x0), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n26_), .O(z05));
  nor2   g16(.a(new_n36_), .b(new_n29_), .O(z06));
  nand3  g17(.a(new_n25_), .b(new_n28_), .c(x0), .O(new_n39_));
  ...
  nor2   g23(.a(new_n42_), .b(new_n29_), .O(z10));
  nor2   g24(.a(new_n42_), .b(new_n31_), .O(z11));
  nand3  g25(.a(x3), .b(x2), .c(new_n41_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(x1), .O(z12));
  nand2  g27(.a(new_n35_), .b(new_n41_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n26_), .O(z13));
  nor2   g29(.a(new_n49_), .b(new_n29_), .O(z14));
  nor2   g30(.a(new_n49_), .b(new_n31_), .O(z15));
endmodule
