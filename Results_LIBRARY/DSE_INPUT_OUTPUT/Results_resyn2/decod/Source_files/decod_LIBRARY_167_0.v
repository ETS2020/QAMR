...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n39_, new_n40_, new_n42_, new_n45_, new_n48_;
  ...
  nand3  g19(.a(x4), .b(x2), .c(new_n39_), .O(new_n42_));
  aoi21  g20(.a(new_n42_), .b(x1), .c(x3), .O(z09));
  oai21  g21(.a(new_n40_), .b(new_n31_), .c(new_n24_), .O(z10));
  nand3  g22(.a(x4), .b(new_n30_), .c(new_n39_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(x1), .c(x3), .O(z11));
  aoi21  g24(.a(new_n42_), .b(x3), .c(x1), .O(z12));
