...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(new_n29_), .c(new_n26_), .O(z06));
  nand3  g16(.a(new_n28_), .b(new_n31_), .c(x0), .O(new_n38_));
  ...
  nor2   g22(.a(new_n43_), .b(new_n29_), .O(z10));
  nand2  g23(.a(new_n31_), .b(new_n40_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(z12));
  aoi21  g25(.a(new_n41_), .b(new_n31_), .c(x3), .O(z13));
  oai21  g26(.a(new_n45_), .b(new_n29_), .c(new_n26_), .O(z14));
  nand3  g27(.a(x4), .b(new_n28_), .c(new_n40_), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n31_), .c(x3), .O(z15));
  inv1   g29(.a(new_n26_), .O(z03));
