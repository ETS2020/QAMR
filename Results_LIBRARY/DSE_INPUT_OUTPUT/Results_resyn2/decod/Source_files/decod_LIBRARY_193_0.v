...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n39_, new_n41_;
  ...
  aoi21  g24(.a(new_n39_), .b(x2), .c(x0), .O(z12));
  aoi21  g25(.a(new_n41_), .b(x2), .c(x0), .O(z13));
  zero   g26(.O(z14));
  inv1   g27(.a(new_n27_), .O(z11));
