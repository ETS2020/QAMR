...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n45_, new_n46_;
  ...
  xnor2a g11(.a(x1), .b(x0), .O(new_n33_));
  aoi21  g12(.a(new_n23_), .b(new_n22_), .c(new_n33_), .O(z04));
  nand2  g13(.a(new_n22_), .b(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n26_), .O(z05));
  nor2   g15(.a(new_n35_), .b(new_n29_), .O(z06));
  aoi21  g16(.a(new_n31_), .b(new_n22_), .c(new_n33_), .O(z07));
  aoi21  g17(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  aoi21  g18(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  inv1   g19(.a(x0), .O(new_n45_));
  nand2  g20(.a(new_n22_), .b(new_n45_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n29_), .O(z14));
  aoi21  g22(.a(new_n31_), .b(new_n22_), .c(x0), .O(z15));
  zero   g23(.O(z08));
  zero   g24(.O(z09));
  zero   g25(.O(z10));
  zero   g26(.O(z11));
