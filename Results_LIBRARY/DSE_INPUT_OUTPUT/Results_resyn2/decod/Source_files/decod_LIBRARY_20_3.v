...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n34_,
    new_n35_, new_n37_, new_n41_, new_n42_, new_n45_, new_n46_, new_n48_;
  ...
  nor2   g18(.a(new_n42_), .b(new_n35_), .O(z10));
  nor2   g19(.a(new_n42_), .b(new_n37_), .O(z11));
  nand2  g20(.a(new_n25_), .b(new_n41_), .O(new_n45_));
  nand3  g21(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n45_), .O(z12));
  nand3  g23(.a(x4), .b(new_n29_), .c(new_n41_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n25_), .c(new_n26_), .O(z13));
  nor2   g25(.a(new_n45_), .b(new_n35_), .O(z14));
  oai21  g26(.a(new_n45_), .b(new_n37_), .c(new_n23_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z08));
  zero   g29(.O(z09));
endmodule
