...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n38_, new_n41_, new_n46_, new_n47_;
  ...
  aoi21  g14(.a(new_n23_), .b(new_n22_), .c(new_n38_), .O(z08));
  aoi21  g15(.a(new_n27_), .b(new_n22_), .c(new_n38_), .O(z09));
  nand2  g16(.a(x1), .b(new_n22_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n30_), .O(z10));
  aoi21  g18(.a(new_n32_), .b(new_n22_), .c(new_n38_), .O(z11));
  aoi21  g19(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g20(.a(new_n27_), .b(new_n22_), .c(x1), .O(z13));
  inv1   g21(.a(x1), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n22_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n30_), .O(z14));
