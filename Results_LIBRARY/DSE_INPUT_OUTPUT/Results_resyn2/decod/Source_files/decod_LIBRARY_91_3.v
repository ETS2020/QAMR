...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n37_, new_n40_, new_n41_, new_n44_, new_n45_,
    new_n48_;
  ...
  oai21  g16(.a(new_n34_), .b(new_n30_), .c(new_n22_), .O(z07));
  ...
  nand2  g21(.a(new_n24_), .b(new_n40_), .O(new_n44_));
  nand3  g22(.a(x4), .b(x3), .c(x2), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n44_), .O(z12));
  oai21  g24(.a(new_n44_), .b(new_n35_), .c(new_n22_), .O(z13));
  nand3  g25(.a(x4), .b(new_n29_), .c(new_n40_), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n24_), .c(new_n25_), .O(z14));
  nor2   g27(.a(new_n44_), .b(new_n30_), .O(z15));
  zero   g28(.O(z02));
