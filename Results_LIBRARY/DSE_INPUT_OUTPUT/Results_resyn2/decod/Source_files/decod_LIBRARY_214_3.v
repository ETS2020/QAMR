...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n38_, new_n42_, new_n43_, new_n45_, new_n47_,
    new_n49_;
  ...
  nand2  g22(.a(new_n25_), .b(new_n42_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n33_), .O(z12));
  nand3  g24(.a(x4), .b(new_n29_), .c(new_n42_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n25_), .c(new_n26_), .O(z13));
  oai21  g26(.a(new_n47_), .b(new_n36_), .c(new_n23_), .O(z14));
