...
module FAU ( 
  ...
  aoi21  g13(.a(new_n31_), .b(x3), .c(x2), .O(z06));
  nand2  g14(.a(new_n33_), .b(new_n26_), .O(new_n37_));
  inv1   g15(.a(new_n37_), .O(z07));
  inv1   g16(.a(x0), .O(new_n39_));
  nand3  g17(.a(x4), .b(x1), .c(new_n39_), .O(new_n40_));
  oai21  g18(.a(new_n40_), .b(new_n22_), .c(new_n37_), .O(z08));
  nor2   g19(.a(new_n40_), .b(new_n34_), .O(z09));
  nor2   g20(.a(new_n40_), .b(new_n27_), .O(z10));
  nand3  g21(.a(x4), .b(new_n30_), .c(new_n39_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n22_), .O(z12));
  aoi21  g23(.a(new_n45_), .b(x2), .c(x3), .O(z13));
  aoi21  g24(.a(new_n45_), .b(x3), .c(x2), .O(z14));
  zero   g25(.O(z03));
  zero   g26(.O(z11));
  inv1   g27(.a(new_n37_), .O(z15));
endmodule
