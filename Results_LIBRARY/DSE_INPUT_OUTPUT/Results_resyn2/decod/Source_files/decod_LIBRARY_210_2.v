...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    ...
    new_n44_, new_n45_, new_n46_, new_n49_, new_n52_;
  ...
  oai21  g17(.a(new_n38_), .b(new_n28_), .c(new_n27_), .O(z05));
  ...
  nor2   g21(.a(new_n40_), .b(new_n42_), .O(z07));
  inv1   g22(.a(x0), .O(new_n44_));
  nand2  g23(.a(x1), .b(new_n44_), .O(new_n45_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n45_), .O(z08));
  nor2   g26(.a(new_n45_), .b(new_n28_), .O(z09));
  nand3  g27(.a(new_n30_), .b(x1), .c(new_n44_), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(x4), .c(new_n22_), .O(z10));
  oai21  g29(.a(new_n45_), .b(new_n33_), .c(new_n27_), .O(z11));
  nand2  g30(.a(new_n35_), .b(new_n44_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n46_), .O(z12));
  nor2   g32(.a(new_n52_), .b(new_n28_), .O(z13));
  nor2   g33(.a(new_n52_), .b(new_n31_), .O(z14));
  oai21  g34(.a(new_n52_), .b(new_n33_), .c(new_n27_), .O(z15));
endmodule
