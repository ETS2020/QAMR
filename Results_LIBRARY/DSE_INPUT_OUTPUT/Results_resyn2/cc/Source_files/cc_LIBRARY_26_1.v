...
module FAU ( 
  ...
  nor2   g24(.a(new_n59_), .b(new_n65_), .O(z08));
  ...
  nand3  g30(.a(new_n48_), .b(new_n46_), .c(new_n71_), .O(new_n72_));
  ...
  oai21  g35(.a(new_n48_), .b(new_n43_), .c(x15), .O(new_n77_));
  ...
  nand2  g40(.a(new_n52_), .b(x02), .O(new_n82_));
  ...
  nand2  g44(.a(new_n46_), .b(x03), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n48_), .O(new_n87_));
  oai21  g46(.a(new_n65_), .b(x14), .c(new_n51_), .O(new_n88_));
  ...
  nand2  g54(.a(new_n48_), .b(new_n46_), .O(new_n96_));
  oai21  g55(.a(new_n51_), .b(x05), .c(x12), .O(new_n97_));
  nor2   g56(.a(x18), .b(new_n43_), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n96_), .c(new_n97_), .d(new_n46_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand3  g59(.a(new_n48_), .b(new_n46_), .c(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n51_), .b(x15), .c(new_n61_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n48_), .b(new_n46_), .c(new_n105_), .O(new_n106_));
  inv1   g65(.a(x20), .O(new_n107_));
  oai21  g66(.a(new_n51_), .b(x15), .c(new_n107_), .O(new_n108_));
