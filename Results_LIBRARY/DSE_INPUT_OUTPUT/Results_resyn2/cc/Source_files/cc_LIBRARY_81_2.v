...
module FAU ( 
  ...
  nand3  g41(.a(new_n51_), .b(new_n82_), .c(x02), .O(new_n83_));
  nand2  g42(.a(new_n48_), .b(x12), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n44_), .c(new_n84_), .O(z14));
  nand2  g44(.a(x12), .b(x03), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n73_), .c(new_n82_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(new_n88_));
  nand2  g47(.a(new_n52_), .b(x12), .O(new_n89_));
  nand2  g48(.a(x16), .b(new_n50_), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(z15));
  nand2  g50(.a(x12), .b(x04), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n73_), .c(new_n82_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(new_n94_));
  oai21  g53(.a(new_n89_), .b(new_n60_), .c(new_n94_), .O(z16));
  nand2  g54(.a(new_n73_), .b(new_n82_), .O(new_n96_));
  nand2  g55(.a(x18), .b(x12), .O(new_n97_));
  aoi21  g56(.a(new_n96_), .b(new_n44_), .c(new_n97_), .O(z17));
  nand2  g57(.a(x12), .b(x06), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n73_), .c(new_n82_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(new_n101_));
  oai21  g60(.a(new_n89_), .b(new_n58_), .c(new_n101_), .O(z18));
  nand2  g61(.a(x20), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n44_), .b(x07), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n51_), .O(new_n105_));
  aoi21  g64(.a(new_n73_), .b(new_n43_), .c(x05), .O(new_n106_));
