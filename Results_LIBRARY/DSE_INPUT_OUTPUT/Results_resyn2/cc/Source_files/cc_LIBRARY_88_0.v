...
module FAU ( 
  ...
  oai21  g31(.a(new_n52_), .b(new_n72_), .c(x12), .O(new_n73_));
  ...
  oai21  g37(.a(new_n52_), .b(new_n78_), .c(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n47_), .c(new_n57_), .O(z13));
  ...
  oai21  g43(.a(new_n52_), .b(new_n84_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n62_), .O(new_n86_));
  nand4  g45(.a(new_n75_), .b(x16), .c(new_n46_), .d(x12), .O(new_n87_));
  ...
  oai21  g53(.a(new_n52_), .b(new_n94_), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n62_), .O(new_n96_));
  nand3  g55(.a(new_n75_), .b(x18), .c(x12), .O(new_n97_));
  ...
  nand3  g60(.a(new_n75_), .b(x19), .c(x12), .O(new_n102_));
  ...
  nand3  g65(.a(new_n75_), .b(x20), .c(x12), .O(new_n107_));
