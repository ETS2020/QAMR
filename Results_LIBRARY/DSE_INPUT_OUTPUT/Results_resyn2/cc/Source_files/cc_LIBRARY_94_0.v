...
module FAU ( 
  ...
  nand2  g26(.a(new_n67_), .b(x07), .O(new_n68_));
  ...
  nand2  g40(.a(new_n81_), .b(x07), .O(new_n82_));
  ...
  nand3  g57(.a(new_n51_), .b(x19), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(z18));
  nand2  g59(.a(new_n45_), .b(x12), .O(new_n101_));
  aoi21  g60(.a(new_n51_), .b(new_n43_), .c(new_n101_), .O(z19));
  buf    g61(.a(x15), .O(z06));
endmodule
