...
module FAU ( 
  ...
  nand4  g25(.a(new_n49_), .b(x10), .c(x08), .d(new_n66_), .O(new_n67_));
  ...
  oai21  g32(.a(new_n69_), .b(new_n73_), .c(x14), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n46_), .c(new_n54_), .O(z13));
  ...
  oai21  g38(.a(new_n69_), .b(new_n79_), .c(x12), .O(new_n80_));
  ...
  oai21  g50(.a(new_n69_), .b(x15), .c(new_n91_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n90_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z17));
  inv1   g53(.a(x06), .O(new_n95_));
  nand4  g54(.a(new_n49_), .b(x10), .c(x08), .d(new_n95_), .O(new_n96_));
  oai21  g55(.a(new_n69_), .b(x15), .c(new_n57_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n96_), .c(x12), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  oai21  g59(.a(new_n69_), .b(new_n100_), .c(x12), .O(new_n101_));
