...
module FAU ( 
  ...
  nor2   g17(.a(new_n48_), .b(x01), .O(z06));
  ...
  inv1   g30(.a(new_n54_), .O(z11));
  nand2  g31(.a(x13), .b(x12), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n47_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x15), .O(new_n75_));
  nand2  g34(.a(new_n50_), .b(x13), .O(new_n76_));
  nand4  g35(.a(new_n48_), .b(x10), .c(x08), .d(x00), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n75_), .O(z12));
  nand2  g39(.a(new_n58_), .b(new_n47_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  inv1   g41(.a(x12), .O(new_n83_));
  nor2   g42(.a(new_n49_), .b(new_n83_), .O(new_n84_));
  oai21  g43(.a(new_n50_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n82_), .O(z13));
  nand2  g45(.a(z06), .b(new_n50_), .O(new_n87_));
  nand3  g46(.a(new_n51_), .b(new_n48_), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n83_), .O(z14));
  ...
  nand3  g51(.a(new_n50_), .b(x16), .c(new_n49_), .O(new_n93_));
  nand4  g52(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n92_), .O(z15));
  oai21  g56(.a(new_n65_), .b(new_n83_), .c(new_n47_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n50_), .b(x17), .O(new_n100_));
  nand4  g59(.a(new_n48_), .b(x10), .c(x08), .d(x04), .O(new_n101_));
  ...
  nand2  g66(.a(new_n50_), .b(x18), .O(new_n108_));
  nand4  g67(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n109_));
  ...
  nand2  g71(.a(z06), .b(x19), .O(new_n113_));
  inv1   g72(.a(x06), .O(new_n114_));
  nand3  g73(.a(x10), .b(x08), .c(new_n114_), .O(new_n115_));
  nand2  g74(.a(new_n50_), .b(new_n63_), .O(new_n116_));
  nand3  g75(.a(new_n116_), .b(new_n115_), .c(new_n48_), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n113_), .c(new_n83_), .O(z18));
  oai21  g77(.a(new_n43_), .b(new_n83_), .c(new_n47_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x15), .O(new_n120_));
  nand2  g79(.a(new_n50_), .b(x20), .O(new_n121_));
  nand4  g80(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n122_));
