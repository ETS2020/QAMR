...
module FAU ( 
  ...
  nor2   g27(.a(new_n61_), .b(new_n47_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  inv1   g29(.a(x15), .O(new_n71_));
  nand3  g30(.a(new_n48_), .b(new_n71_), .c(new_n70_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  nand3  g32(.a(new_n71_), .b(x10), .c(x08), .O(new_n74_));
  ...
  nand2  g41(.a(new_n48_), .b(x02), .O(new_n83_));
  ...
  nand3  g48(.a(new_n48_), .b(new_n71_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n48_), .b(new_n71_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g59(.a(new_n48_), .b(new_n71_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n74_), .b(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n48_), .b(new_n71_), .c(new_n105_), .O(new_n106_));
