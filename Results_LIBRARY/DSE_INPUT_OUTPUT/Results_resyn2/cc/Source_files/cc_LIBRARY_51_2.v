...
module FAU ( 
  ...
  aoi21  g10(.a(new_n43_), .b(x18), .c(new_n51_), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(new_n42_), .O(new_n53_));
  aoi21  g12(.a(new_n50_), .b(new_n48_), .c(new_n53_), .O(z02));
  nand2  g13(.a(new_n44_), .b(x14), .O(new_n55_));
  nand2  g14(.a(new_n46_), .b(new_n44_), .O(new_n56_));
  nand2  g15(.a(new_n44_), .b(new_n51_), .O(new_n57_));
  ...
  nor2   g22(.a(new_n62_), .b(new_n49_), .O(z06));
  ...
  nand2  g36(.a(new_n46_), .b(new_n48_), .O(new_n78_));
  nand4  g37(.a(new_n49_), .b(x10), .c(x08), .d(x01), .O(new_n79_));
  ...
  nand4  g45(.a(new_n49_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  ...
  nand4  g51(.a(new_n49_), .b(x10), .c(x08), .d(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n50_), .b(new_n65_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n44_), .O(z16));
  ...
  nand2  g62(.a(new_n50_), .b(new_n61_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n52_), .O(new_n105_));
  inv1   g64(.a(new_n105_), .O(z18));
  nand4  g65(.a(z04), .b(new_n49_), .c(x10), .d(x08), .O(new_n107_));
  inv1   g66(.a(x07), .O(new_n108_));
  nand4  g67(.a(new_n49_), .b(x10), .c(x08), .d(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x12), .O(new_n110_));
  aoi21  g69(.a(new_n107_), .b(new_n43_), .c(new_n110_), .O(z19));
endmodule
