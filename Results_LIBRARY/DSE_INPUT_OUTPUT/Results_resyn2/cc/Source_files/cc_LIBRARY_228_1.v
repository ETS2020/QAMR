...
module FAU ( 
  ...
  nand2  g03(.a(x19), .b(z04), .O(new_n45_));
  ...
  aoi21  g24(.a(x19), .b(z04), .c(new_n65_), .O(z09));
  and2   g25(.a(new_n65_), .b(new_n45_), .O(z10));
  nand2  g26(.a(new_n45_), .b(new_n47_), .O(z11));
  aoi21  g27(.a(x19), .b(z04), .c(new_n56_), .O(new_n69_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n48_), .c(new_n77_), .O(z13));
  ...
  inv1   g51(.a(x19), .O(new_n93_));
  nand4  g52(.a(new_n93_), .b(new_n52_), .c(x10), .d(x08), .O(new_n94_));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n58_), .c(new_n101_), .O(z18));
