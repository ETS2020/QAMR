...
module FAU ( 
  ...
  nor2   g27(.a(new_n42_), .b(new_n46_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  and2   g29(.a(x10), .b(x08), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n51_), .c(new_n70_), .O(new_n72_));
  ...
  nand2  g40(.a(new_n71_), .b(x02), .O(new_n82_));
  nand2  g41(.a(new_n47_), .b(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n51_), .c(new_n83_), .O(z14));
  aoi21  g43(.a(new_n71_), .b(x03), .c(new_n56_), .O(new_n85_));
  nand4  g44(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n86_));
  oai21  g45(.a(new_n85_), .b(x15), .c(new_n86_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand3  g47(.a(new_n71_), .b(new_n51_), .c(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n52_), .b(new_n62_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z16));
  aoi21  g51(.a(new_n71_), .b(x05), .c(new_n56_), .O(new_n93_));
  nand3  g52(.a(new_n52_), .b(x18), .c(x12), .O(new_n94_));
  oai21  g53(.a(new_n93_), .b(x15), .c(new_n94_), .O(z17));
  inv1   g54(.a(x06), .O(new_n96_));
  nand3  g55(.a(new_n71_), .b(new_n51_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n52_), .b(new_n59_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(x12), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z18));
  aoi21  g59(.a(new_n71_), .b(x07), .c(new_n56_), .O(new_n101_));
  nand3  g60(.a(new_n52_), .b(x20), .c(x12), .O(new_n102_));
  oai21  g61(.a(new_n101_), .b(x15), .c(new_n102_), .O(z19));
endmodule
