...
module FAU ( 
  ...
  nand4  g15(.a(new_n56_), .b(new_n43_), .c(new_n48_), .d(x12), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(z03));
  inv1   g17(.a(x13), .O(new_n59_));
  nand2  g18(.a(x18), .b(new_n59_), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n45_), .b(new_n61_), .O(z05));
  nand2  g21(.a(new_n43_), .b(new_n49_), .O(z06));
  ...
  nand2  g32(.a(new_n50_), .b(new_n59_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n73_), .c(x12), .O(new_n75_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n43_), .O(z15));
  ...
  nand3  g71(.a(new_n112_), .b(new_n110_), .c(new_n99_), .O(new_n113_));
