...
module FAU ( 
  ...
  aoi21  g28(.a(x18), .b(x05), .c(new_n56_), .O(new_n70_));
  ...
  nand2  g36(.a(new_n44_), .b(x12), .O(new_n78_));
  ...
  nand4  g52(.a(new_n52_), .b(x12), .c(x10), .d(x08), .O(new_n94_));
  oai21  g53(.a(new_n74_), .b(x15), .c(x12), .O(new_n95_));
  aoi22  g54(.a(new_n95_), .b(new_n58_), .c(new_n94_), .d(new_n93_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  nand4  g56(.a(new_n52_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  oai21  g57(.a(new_n74_), .b(x15), .c(new_n60_), .O(new_n99_));
