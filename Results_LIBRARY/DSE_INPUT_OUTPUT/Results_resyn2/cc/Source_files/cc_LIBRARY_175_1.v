...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n64_, new_n66_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  aoi21  g15(.a(x19), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  aoi21  g17(.a(new_n55_), .b(new_n49_), .c(new_n58_), .O(z02));
  oai21  g18(.a(new_n52_), .b(new_n56_), .c(new_n48_), .O(z03));
  nand2  g19(.a(new_n48_), .b(x18), .O(z04));
  nor2   g20(.a(new_n44_), .b(new_n47_), .O(z05));
  nand2  g21(.a(new_n48_), .b(new_n54_), .O(z06));
  ...
  nand2  g31(.a(new_n55_), .b(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n71_), .c(new_n57_), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z12));
  inv1   g34(.a(new_n57_), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x14), .c(new_n51_), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n76_), .O(z13));
  nand3  g38(.a(x10), .b(x08), .c(x02), .O(new_n80_));
  nand2  g39(.a(new_n57_), .b(new_n50_), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n54_), .c(new_n81_), .O(z14));
  inv1   g41(.a(x03), .O(new_n83_));
  nand4  g42(.a(new_n54_), .b(x10), .c(x08), .d(new_n83_), .O(new_n84_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n48_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n54_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n55_), .b(new_n64_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n57_), .O(new_n92_));
  ...
  nand2  g55(.a(new_n55_), .b(new_n96_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n57_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n54_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n55_), .b(new_n44_), .O(new_n102_));
  ...
  nand2  g65(.a(new_n55_), .b(new_n43_), .O(new_n107_));
