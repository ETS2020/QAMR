...
module FAU ( 
  ...
  oai21  g16(.a(new_n49_), .b(new_n52_), .c(new_n45_), .O(z03));
  ...
  nand2  g43(.a(new_n73_), .b(x02), .O(new_n85_));
  xor2a  g44(.a(x15), .b(x12), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n48_), .O(z14));
  aoi21  g46(.a(new_n73_), .b(x03), .c(new_n52_), .O(new_n88_));
  nand4  g47(.a(new_n76_), .b(x16), .c(new_n46_), .d(x12), .O(new_n89_));
  oai21  g48(.a(new_n88_), .b(x15), .c(new_n89_), .O(z15));
  inv1   g49(.a(x04), .O(new_n91_));
  nand3  g50(.a(new_n73_), .b(new_n62_), .c(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n76_), .b(new_n64_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z16));
  aoi21  g54(.a(new_n73_), .b(x05), .c(new_n52_), .O(new_n96_));
  nand3  g55(.a(new_n76_), .b(x18), .c(x12), .O(new_n97_));
  oai21  g56(.a(new_n96_), .b(x15), .c(new_n97_), .O(z17));
  aoi21  g57(.a(new_n73_), .b(x06), .c(new_n52_), .O(new_n99_));
  nand3  g58(.a(new_n76_), .b(x19), .c(x12), .O(new_n100_));
  oai21  g59(.a(new_n99_), .b(x15), .c(new_n100_), .O(z18));
  aoi21  g60(.a(new_n73_), .b(x07), .c(new_n52_), .O(new_n102_));
  nand3  g61(.a(new_n76_), .b(x20), .c(x12), .O(new_n103_));
