...
module FAU ( 
  ...
  oai21  g41(.a(new_n82_), .b(new_n48_), .c(x18), .O(new_n83_));
  ...
  oai21  g47(.a(new_n88_), .b(new_n48_), .c(x18), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n67_), .O(new_n90_));
  ...
  aoi21  g53(.a(new_n49_), .b(new_n93_), .c(new_n94_), .O(z17));
  nand2  g54(.a(x19), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n67_), .b(x06), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n78_), .O(new_n98_));
  aoi21  g57(.a(new_n48_), .b(new_n56_), .c(z04), .O(new_n99_));
  ...
  nand2  g61(.a(new_n67_), .b(x07), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n78_), .O(new_n104_));
  inv1   g63(.a(x20), .O(new_n105_));
  aoi21  g64(.a(new_n48_), .b(new_n105_), .c(z04), .O(new_n106_));
