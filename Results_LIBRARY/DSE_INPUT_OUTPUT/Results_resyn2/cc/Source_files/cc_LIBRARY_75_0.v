...
module FAU ( 
  ...
  nand2  g13(.a(new_n54_), .b(new_n44_), .O(new_n55_));
  ...
  oai21  g36(.a(new_n46_), .b(new_n53_), .c(x15), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  aoi21  g38(.a(x08), .b(x01), .c(new_n46_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n48_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n79_), .O(z13));
  nand2  g41(.a(new_n71_), .b(x02), .O(new_n83_));
  aoi21  g42(.a(x15), .b(new_n70_), .c(new_n77_), .O(new_n84_));
  aoi22  g43(.a(new_n84_), .b(new_n83_), .c(new_n44_), .d(new_n53_), .O(z14));
  nand3  g44(.a(new_n51_), .b(x08), .c(x03), .O(new_n86_));
  nand3  g45(.a(x16), .b(new_n46_), .c(new_n70_), .O(new_n87_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n53_), .O(z15));
  nand3  g50(.a(new_n51_), .b(x08), .c(x04), .O(new_n92_));
  nand2  g51(.a(x17), .b(new_n70_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x10), .O(new_n95_));
  nand2  g54(.a(x17), .b(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n53_), .O(z16));
  nand3  g56(.a(new_n51_), .b(x08), .c(x05), .O(new_n98_));
  nand2  g57(.a(x18), .b(new_n70_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x10), .O(new_n101_));
  nand2  g60(.a(x18), .b(x15), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n53_), .O(z17));
  nand3  g62(.a(new_n51_), .b(x08), .c(x06), .O(new_n104_));
  nand2  g63(.a(x19), .b(new_n70_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x10), .O(new_n107_));
  nand2  g66(.a(x19), .b(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n53_), .O(z18));
  nand3  g68(.a(new_n51_), .b(x08), .c(x07), .O(new_n110_));
  nand2  g69(.a(x20), .b(new_n70_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x10), .O(new_n113_));
  nand2  g72(.a(x20), .b(x15), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n53_), .O(z19));
  buf    g74(.a(x15), .O(z06));
endmodule
