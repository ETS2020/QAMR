...
module FAU ( 
  ...
  nand2  g09(.a(new_n43_), .b(x12), .O(new_n51_));
  nor3   g10(.a(new_n51_), .b(new_n50_), .c(x11), .O(z02));
  oai21  g11(.a(new_n43_), .b(new_n42_), .c(x18), .O(z04));
  inv1   g12(.a(x19), .O(new_n54_));
  nor2   g13(.a(z03), .b(new_n54_), .O(z05));
  nor2   g14(.a(new_n43_), .b(x12), .O(z06));
  inv1   g15(.a(x17), .O(new_n57_));
  nor2   g16(.a(z03), .b(new_n57_), .O(z07));
  inv1   g17(.a(x16), .O(new_n59_));
  nor2   g18(.a(z03), .b(new_n59_), .O(z08));
  ...
  nor2   g23(.a(x15), .b(new_n42_), .O(new_n65_));
  ...
  aoi21  g33(.a(new_n74_), .b(new_n43_), .c(new_n42_), .O(z13));
  nand3  g34(.a(x10), .b(x08), .c(x02), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n43_), .c(new_n42_), .O(z14));
  nand2  g36(.a(new_n50_), .b(x16), .O(new_n78_));
  nand3  g37(.a(x10), .b(x08), .c(x03), .O(new_n79_));
  and2   g38(.a(new_n79_), .b(new_n43_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n42_), .O(z15));
  nand3  g40(.a(x10), .b(x08), .c(x04), .O(new_n82_));
  aoi21  g41(.a(new_n69_), .b(x17), .c(x15), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n42_), .O(z16));
  ...
  nand3  g47(.a(new_n88_), .b(new_n86_), .c(new_n65_), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z17));
  nand3  g49(.a(x10), .b(x08), .c(x06), .O(new_n91_));
  aoi21  g50(.a(new_n69_), .b(x19), .c(x15), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n42_), .O(z18));
  nand3  g52(.a(x10), .b(x08), .c(x07), .O(new_n94_));
  aoi21  g53(.a(new_n69_), .b(x20), .c(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n42_), .O(z19));
endmodule
