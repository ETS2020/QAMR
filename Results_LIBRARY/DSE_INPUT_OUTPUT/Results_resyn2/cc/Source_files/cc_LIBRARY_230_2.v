...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n59_, new_n61_, new_n63_,
  ...
  nor2   g17(.a(x15), .b(x00), .O(new_n59_));
  ...
  nand2  g25(.a(new_n45_), .b(new_n50_), .O(z11));
  ...
  nand2  g31(.a(new_n72_), .b(new_n48_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x12), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n45_), .O(z13));
  aoi21  g34(.a(new_n59_), .b(x02), .c(new_n71_), .O(new_n76_));
  oai21  g35(.a(new_n51_), .b(x15), .c(x12), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n76_), .O(z14));
  nand3  g37(.a(x16), .b(x15), .c(new_n50_), .O(new_n79_));
  inv1   g38(.a(x00), .O(new_n80_));
  nand2  g39(.a(new_n44_), .b(x03), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  oai21  g41(.a(new_n63_), .b(x14), .c(new_n71_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n79_), .c(new_n55_), .O(z15));
  nand2  g44(.a(x17), .b(x15), .O(new_n86_));
  nand2  g45(.a(new_n44_), .b(x04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n51_), .O(new_n88_));
  aoi21  g47(.a(new_n71_), .b(new_n61_), .c(x00), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n86_), .c(new_n55_), .O(z16));
  ...
  aoi21  g54(.a(new_n71_), .b(new_n95_), .c(x00), .O(new_n96_));
  ...
  oai21  g58(.a(new_n99_), .b(new_n71_), .c(new_n80_), .O(new_n100_));
  ...
  aoi21  g65(.a(new_n71_), .b(new_n43_), .c(x00), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n104_), .c(new_n55_), .O(z19));
endmodule
