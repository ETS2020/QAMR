...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n55_, new_n57_, new_n60_, new_n62_,
  ...
  nor2   g07(.a(new_n48_), .b(new_n44_), .O(z06));
  nand2  g08(.a(x10), .b(x08), .O(new_n50_));
  nor2   g09(.a(new_n50_), .b(x14), .O(new_n51_));
  and2   g10(.a(new_n51_), .b(z06), .O(z01));
  ...
  nand3  g15(.a(new_n51_), .b(z06), .c(x12), .O(new_n57_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n95_), .c(new_n84_), .O(z17));
  nand2  g60(.a(z06), .b(x19), .O(new_n102_));
  inv1   g61(.a(x06), .O(new_n103_));
  nand3  g62(.a(x10), .b(x08), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n50_), .b(new_n60_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n48_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n102_), .c(new_n84_), .O(z18));
  oai21  g66(.a(new_n43_), .b(new_n84_), .c(x00), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n50_), .b(x20), .O(new_n110_));
  nand4  g69(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n111_));
