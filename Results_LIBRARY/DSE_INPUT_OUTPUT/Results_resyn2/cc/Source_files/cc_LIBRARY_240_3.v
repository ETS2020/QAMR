...
module FAU ( 
  ...
  nand4  g30(.a(new_n61_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  ...
  aoi21  g41(.a(new_n81_), .b(new_n61_), .c(new_n82_), .O(z14));
  nand3  g42(.a(new_n61_), .b(x10), .c(x08), .O(new_n84_));
  ...
  aoi21  g47(.a(x18), .b(x06), .c(new_n88_), .O(new_n89_));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n61_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n50_), .b(x15), .c(new_n64_), .O(new_n92_));
  ...
  oai21  g56(.a(new_n50_), .b(x15), .c(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n44_), .O(z17));
  nand4  g59(.a(new_n61_), .b(x10), .c(x08), .d(new_n57_), .O(new_n101_));
  oai21  g60(.a(new_n50_), .b(x15), .c(new_n59_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(new_n89_), .O(new_n103_));
