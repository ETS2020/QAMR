...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n61_, new_n63_, new_n65_, new_n66_, new_n69_, new_n73_, new_n74_,
  ...
  aoi21  g15(.a(x18), .b(new_n43_), .c(new_n53_), .O(new_n57_));
  ...
  and2   g26(.a(new_n44_), .b(x16), .O(z08));
  nand2  g27(.a(x09), .b(x08), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n66_), .O(z09));
  ...
  nand3  g34(.a(new_n63_), .b(x10), .c(x08), .O(new_n76_));
  ...
  oai21  g44(.a(new_n51_), .b(new_n85_), .c(new_n63_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(new_n47_), .c(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z14));
  inv1   g47(.a(x03), .O(new_n89_));
  nand4  g48(.a(new_n63_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  nand2  g49(.a(x16), .b(new_n46_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n76_), .O(new_n92_));
  ...
  nand3  g71(.a(new_n112_), .b(new_n110_), .c(new_n57_), .O(new_n113_));
