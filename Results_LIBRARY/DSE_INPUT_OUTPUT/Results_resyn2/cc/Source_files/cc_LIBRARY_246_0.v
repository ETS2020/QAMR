...
module FAU ( 
  ...
  nand2  g16(.a(new_n57_), .b(new_n53_), .O(z03));
  ...
  nand2  g23(.a(new_n53_), .b(new_n64_), .O(z08));
  ...
  nand2  g39(.a(new_n80_), .b(new_n53_), .O(z13));
  ...
  nand3  g61(.a(new_n71_), .b(new_n49_), .c(new_n102_), .O(new_n103_));
