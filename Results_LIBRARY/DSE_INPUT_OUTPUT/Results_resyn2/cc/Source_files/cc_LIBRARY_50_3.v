...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n61_, new_n64_, new_n67_, new_n71_, new_n72_, new_n73_,
  ...
  nand2  g30(.a(new_n55_), .b(x00), .O(new_n72_));
  nand3  g31(.a(new_n48_), .b(x10), .c(x08), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n44_), .c(x13), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(z12));
  inv1   g34(.a(x01), .O(new_n76_));
  nand2  g35(.a(new_n48_), .b(new_n76_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n50_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(z11), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n61_), .c(new_n71_), .O(z13));
  nand2  g39(.a(new_n54_), .b(x15), .O(new_n81_));
  nand4  g40(.a(new_n48_), .b(x10), .c(x08), .d(x02), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z14));
  oai21  g44(.a(new_n59_), .b(new_n67_), .c(new_n47_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand4  g46(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  nand3  g47(.a(new_n54_), .b(x16), .c(new_n49_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n87_), .O(z15));
  aoi21  g51(.a(new_n50_), .b(x12), .c(x15), .O(new_n93_));
  nand3  g52(.a(new_n73_), .b(x17), .c(x12), .O(new_n94_));
  oai21  g53(.a(new_n93_), .b(new_n47_), .c(new_n94_), .O(z16));
  nand2  g54(.a(new_n60_), .b(x18), .O(new_n96_));
  inv1   g55(.a(x05), .O(new_n97_));
  nand3  g56(.a(x10), .b(x08), .c(new_n97_), .O(new_n98_));
  inv1   g57(.a(x18), .O(new_n99_));
  nand2  g58(.a(new_n54_), .b(new_n99_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n98_), .c(new_n48_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n96_), .c(new_n71_), .O(z17));
  nand2  g61(.a(new_n60_), .b(x19), .O(new_n103_));
  inv1   g62(.a(x06), .O(new_n104_));
  nand3  g63(.a(x10), .b(x08), .c(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n54_), .b(new_n64_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n48_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n103_), .c(new_n71_), .O(z18));
  oai21  g67(.a(new_n43_), .b(new_n71_), .c(new_n47_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n54_), .b(x20), .O(new_n111_));
  nand4  g70(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n112_));
