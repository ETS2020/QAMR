...
module FAU ( 
  ...
  nor4   g07(.a(new_n48_), .b(new_n47_), .c(x14), .d(x05), .O(z01));
  ...
  nor2   g20(.a(new_n47_), .b(x05), .O(z06));
  ...
  oai21  g49(.a(new_n63_), .b(new_n71_), .c(new_n54_), .O(new_n91_));
  ...
  nand4  g56(.a(new_n47_), .b(x10), .c(x08), .d(new_n54_), .O(new_n98_));
  inv1   g57(.a(x18), .O(new_n99_));
  nand2  g58(.a(new_n51_), .b(new_n99_), .O(new_n100_));
  nand4  g59(.a(new_n100_), .b(new_n98_), .c(new_n44_), .d(x12), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  oai21  g61(.a(new_n60_), .b(new_n71_), .c(new_n54_), .O(new_n103_));
  ...
  nand2  g71(.a(new_n48_), .b(new_n43_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n112_), .c(new_n47_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n110_), .c(new_n71_), .O(z19));
endmodule
