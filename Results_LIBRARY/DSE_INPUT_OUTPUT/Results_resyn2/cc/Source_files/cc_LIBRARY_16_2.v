...
module FAU ( 
  ...
  aoi21  g31(.a(new_n72_), .b(x15), .c(new_n49_), .O(z14));
  nand2  g32(.a(x16), .b(new_n46_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x15), .c(new_n49_), .O(z15));
