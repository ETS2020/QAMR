...
module FAU ( 
  ...
  nand2  g08(.a(z04), .b(x15), .O(new_n50_));
  ...
  aoi21  g15(.a(new_n56_), .b(x18), .c(new_n44_), .O(z03));
  inv1   g16(.a(x19), .O(new_n58_));
  nand2  g17(.a(new_n50_), .b(new_n58_), .O(z05));
  nor2   g18(.a(z04), .b(new_n44_), .O(z06));
  ...
  nand2  g26(.a(new_n50_), .b(new_n55_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  nand3  g28(.a(new_n52_), .b(new_n50_), .c(x13), .O(new_n70_));
  ...
  nand2  g33(.a(new_n74_), .b(new_n55_), .O(new_n75_));
  nand4  g34(.a(new_n44_), .b(x10), .c(x08), .d(x01), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n50_), .d(x12), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z13));
  inv1   g37(.a(x02), .O(new_n79_));
  oai21  g38(.a(new_n48_), .b(new_n79_), .c(new_n44_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n74_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n50_), .O(z14));
  nand2  g41(.a(new_n71_), .b(x03), .O(new_n83_));
  nand4  g42(.a(new_n52_), .b(new_n50_), .c(x16), .d(new_n55_), .O(new_n84_));
  ...
  nand2  g47(.a(new_n48_), .b(new_n61_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n44_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n86_), .c(new_n69_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand4  g51(.a(new_n44_), .b(x10), .c(x08), .d(new_n92_), .O(new_n93_));
  ...
  nand2  g58(.a(new_n48_), .b(new_n58_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n44_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n97_), .c(new_n69_), .O(z18));
  nand2  g61(.a(z06), .b(x20), .O(new_n103_));
  inv1   g62(.a(x07), .O(new_n104_));
  nand3  g63(.a(x10), .b(x08), .c(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n48_), .b(new_n43_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n44_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n103_), .c(new_n69_), .O(z19));
endmodule
