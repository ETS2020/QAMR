...
module FAU ( 
  ...
  nand2  g10(.a(new_n51_), .b(x04), .O(new_n52_));
  ...
  oai21  g31(.a(new_n72_), .b(new_n51_), .c(new_n71_), .O(z12));
  inv1   g32(.a(x01), .O(new_n74_));
  oai21  g33(.a(new_n50_), .b(new_n74_), .c(x04), .O(new_n75_));
  nand2  g34(.a(new_n47_), .b(new_n66_), .O(new_n76_));
  ...
  nand3  g38(.a(new_n51_), .b(x04), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n55_), .O(z14));
  nand2  g40(.a(x12), .b(x03), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n50_), .c(x04), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  nand3  g43(.a(x16), .b(new_n66_), .c(x12), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n51_), .c(new_n84_), .O(z15));
  inv1   g45(.a(new_n51_), .O(new_n87_));
  nand2  g46(.a(new_n45_), .b(x12), .O(new_n88_));
  aoi21  g47(.a(new_n87_), .b(new_n60_), .c(new_n88_), .O(z16));
  nand2  g48(.a(x18), .b(x15), .O(new_n90_));
  and2   g49(.a(x10), .b(x08), .O(new_n91_));
  nand2  g50(.a(new_n68_), .b(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  inv1   g52(.a(x04), .O(new_n94_));
  inv1   g53(.a(x18), .O(new_n95_));
  aoi21  g54(.a(new_n50_), .b(new_n95_), .c(new_n94_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n90_), .c(new_n55_), .O(z17));
  nand2  g57(.a(x19), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n68_), .b(x06), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n91_), .O(new_n101_));
  aoi21  g60(.a(new_n50_), .b(new_n58_), .c(new_n94_), .O(new_n102_));
  ...
  nand2  g64(.a(new_n68_), .b(x07), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n91_), .O(new_n107_));
  aoi21  g66(.a(new_n50_), .b(new_n43_), .c(new_n94_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n105_), .c(new_n55_), .O(z19));
  buf    g69(.a(x15), .O(z06));
endmodule
