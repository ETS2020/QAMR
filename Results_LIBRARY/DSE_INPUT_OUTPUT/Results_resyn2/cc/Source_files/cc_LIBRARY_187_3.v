...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n51_, new_n52_, new_n54_, new_n55_, new_n61_, new_n67_,
  ...
  nand2  g24(.a(new_n51_), .b(x00), .O(new_n67_));
  aoi21  g25(.a(new_n50_), .b(x13), .c(x15), .O(new_n68_));
  aoi21  g26(.a(new_n68_), .b(new_n67_), .c(new_n47_), .O(z12));
  nand3  g27(.a(new_n48_), .b(x14), .c(x12), .O(new_n70_));
  aoi21  g28(.a(new_n51_), .b(x01), .c(new_n70_), .O(z13));
  nand2  g29(.a(new_n51_), .b(x02), .O(new_n72_));
  aoi21  g30(.a(new_n72_), .b(new_n48_), .c(new_n47_), .O(z14));
  nand2  g31(.a(new_n48_), .b(x12), .O(new_n74_));
  nand2  g32(.a(new_n51_), .b(x03), .O(new_n75_));
  nand3  g33(.a(new_n50_), .b(x16), .c(new_n49_), .O(new_n76_));
  aoi21  g34(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(z15));
  nand2  g35(.a(new_n51_), .b(x04), .O(new_n78_));
  aoi21  g36(.a(new_n50_), .b(x17), .c(x15), .O(new_n79_));
  aoi21  g37(.a(new_n79_), .b(new_n78_), .c(new_n47_), .O(z16));
  nor2   g38(.a(x15), .b(new_n47_), .O(new_n81_));
  inv1   g39(.a(x05), .O(new_n82_));
  nand3  g40(.a(x10), .b(x08), .c(new_n82_), .O(new_n83_));
  inv1   g41(.a(x18), .O(new_n84_));
  nand2  g42(.a(new_n50_), .b(new_n84_), .O(new_n85_));
  nand3  g43(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(new_n86_));
  inv1   g44(.a(new_n86_), .O(z17));
  nand2  g45(.a(new_n51_), .b(x06), .O(new_n88_));
  aoi21  g46(.a(new_n50_), .b(x19), .c(x15), .O(new_n89_));
  aoi21  g47(.a(new_n89_), .b(new_n88_), .c(new_n47_), .O(z18));
  inv1   g48(.a(x07), .O(new_n91_));
  nand3  g49(.a(x10), .b(x08), .c(new_n91_), .O(new_n92_));
  nand2  g50(.a(new_n50_), .b(new_n43_), .O(new_n93_));
  nand3  g51(.a(new_n93_), .b(new_n92_), .c(new_n81_), .O(new_n94_));
