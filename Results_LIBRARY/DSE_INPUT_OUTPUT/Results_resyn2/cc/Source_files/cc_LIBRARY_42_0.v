...
module FAU ( 
  ...
  nor2   g02(.a(x19), .b(x09), .O(new_n44_));
  ...
  nor3   g13(.a(new_n54_), .b(new_n44_), .c(new_n50_), .O(z03));
  nor2   g14(.a(new_n44_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x09), .O(z05));
  ...
  nand2  g24(.a(new_n46_), .b(new_n49_), .O(z11));
  inv1   g25(.a(x12), .O(new_n67_));
  nor2   g26(.a(new_n44_), .b(new_n67_), .O(new_n68_));
  inv1   g27(.a(x00), .O(new_n69_));
  nand4  g28(.a(new_n50_), .b(x10), .c(x08), .d(new_n69_), .O(new_n70_));
  ...
  nand3  g39(.a(new_n47_), .b(new_n46_), .c(x12), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n50_), .c(new_n81_), .O(z14));
  ...
  nand2  g47(.a(new_n51_), .b(new_n60_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n46_), .O(z16));
  ...
  nand2  g58(.a(new_n99_), .b(x19), .O(new_n100_));
  nand4  g59(.a(z09), .b(new_n50_), .c(x10), .d(x06), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n67_), .O(z18));
  ...
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n68_), .O(new_n106_));
