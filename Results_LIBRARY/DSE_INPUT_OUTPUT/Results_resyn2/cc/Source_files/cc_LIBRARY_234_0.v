...
module FAU ( 
  ...
  oai21  g36(.a(new_n48_), .b(new_n77_), .c(x05), .O(new_n78_));
  nand2  g37(.a(new_n46_), .b(new_n65_), .O(new_n79_));
  ...
  oai21  g44(.a(new_n85_), .b(new_n48_), .c(x05), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n69_), .O(new_n87_));
  nand2  g46(.a(new_n68_), .b(new_n69_), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(x16), .c(new_n65_), .d(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n87_), .O(z15));
  nand2  g49(.a(x12), .b(x04), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n48_), .c(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n69_), .O(new_n93_));
  nand2  g52(.a(new_n88_), .b(x12), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n59_), .c(new_n93_), .O(z16));
  oai21  g54(.a(new_n49_), .b(x18), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(z17));
  nand2  g56(.a(x12), .b(x06), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n48_), .c(x05), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n69_), .O(new_n100_));
  oai21  g59(.a(new_n94_), .b(new_n57_), .c(new_n100_), .O(z18));
