...
module FAU ( 
  ...
  nand2  g13(.a(new_n45_), .b(x14), .O(new_n55_));
  nand2  g14(.a(new_n47_), .b(new_n45_), .O(new_n56_));
  inv1   g15(.a(x12), .O(new_n57_));
  nand2  g16(.a(new_n45_), .b(new_n57_), .O(new_n58_));
  ...
  and2   g36(.a(new_n47_), .b(new_n49_), .O(new_n78_));
  inv1   g37(.a(x01), .O(new_n79_));
  oai21  g38(.a(new_n51_), .b(new_n79_), .c(x12), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n45_), .O(z13));
  ...
  nand4  g44(.a(new_n50_), .b(x12), .c(x10), .d(x08), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x19), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x03), .O(new_n88_));
  nand4  g47(.a(new_n51_), .b(x16), .c(new_n49_), .d(x12), .O(new_n89_));
  ...
  nand4  g52(.a(new_n93_), .b(new_n92_), .c(new_n45_), .d(x12), .O(new_n94_));
  ...
  nand2  g62(.a(new_n51_), .b(new_n44_), .O(new_n104_));
