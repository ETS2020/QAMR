...
module FAU ( 
  ...
  nor2   g05(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  aoi21  g20(.a(x15), .b(new_n43_), .c(new_n61_), .O(z07));
  ...
  nand2  g29(.a(new_n70_), .b(x04), .O(new_n71_));
  ...
  nand4  g36(.a(new_n46_), .b(x10), .c(x08), .d(x01), .O(new_n78_));
  nand3  g37(.a(x15), .b(x10), .c(x08), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n68_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n78_), .c(new_n44_), .d(x12), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n48_), .b(new_n83_), .c(new_n46_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n79_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n44_), .O(z14));
  nand2  g45(.a(new_n51_), .b(x03), .O(new_n87_));
  nand3  g46(.a(new_n46_), .b(x10), .c(x08), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n44_), .c(x16), .d(new_n68_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n52_), .O(z15));
  nand4  g49(.a(new_n46_), .b(x10), .c(x08), .d(new_n43_), .O(new_n91_));
  nand2  g50(.a(new_n88_), .b(new_n61_), .O(new_n92_));
  ...
  oai21  g61(.a(new_n59_), .b(new_n52_), .c(x04), .O(new_n103_));
  ...
  nand3  g73(.a(new_n114_), .b(new_n112_), .c(new_n46_), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n110_), .c(new_n52_), .O(z19));
endmodule
