...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n54_, new_n55_, new_n60_, new_n62_, new_n64_,
  ...
  nor2   g09(.a(new_n50_), .b(new_n44_), .O(z06));
  ...
  aoi21  g15(.a(new_n49_), .b(x12), .c(new_n50_), .O(z03));
  ...
  nand3  g27(.a(new_n48_), .b(new_n50_), .c(new_n68_), .O(new_n69_));
  ...
  nand2  g37(.a(new_n71_), .b(x15), .O(new_n79_));
  nand3  g38(.a(new_n48_), .b(new_n50_), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .O(z14));
  ...
  nand3  g48(.a(new_n48_), .b(new_n50_), .c(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n71_), .b(x15), .c(new_n60_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  oai21  g52(.a(new_n71_), .b(x05), .c(x12), .O(new_n94_));
  nor2   g53(.a(x18), .b(new_n44_), .O(new_n95_));
  aoi22  g54(.a(new_n95_), .b(new_n54_), .c(new_n94_), .d(new_n50_), .O(z17));
  oai21  g55(.a(new_n71_), .b(x06), .c(x12), .O(new_n97_));
  nor2   g56(.a(x19), .b(new_n44_), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n54_), .c(new_n97_), .d(new_n50_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  nand3  g59(.a(new_n48_), .b(new_n50_), .c(new_n100_), .O(new_n101_));
