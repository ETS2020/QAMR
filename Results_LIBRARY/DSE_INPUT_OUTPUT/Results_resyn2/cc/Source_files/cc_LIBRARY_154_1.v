...
module FAU ( 
  ...
  aoi21  g35(.a(new_n46_), .b(x02), .c(new_n76_), .O(new_n77_));
  ...
  nor2   g61(.a(x20), .b(new_n43_), .O(new_n103_));
  aoi22  g62(.a(new_n103_), .b(new_n68_), .c(new_n102_), .d(new_n46_), .O(z19));
  aoi21  g63(.a(new_n49_), .b(x12), .c(new_n46_), .O(z03));
  buf    g64(.a(x15), .O(z06));
endmodule
