...
module FAU ( 
  ...
  nand2  g20(.a(new_n54_), .b(new_n52_), .O(z06));
  ...
  aoi21  g27(.a(x09), .b(x08), .c(new_n46_), .O(z10));
  nor2   g28(.a(new_n46_), .b(new_n47_), .O(z11));
  nor2   g29(.a(new_n46_), .b(new_n57_), .O(new_n71_));
  ...
  aoi21  g42(.a(new_n49_), .b(x02), .c(x15), .O(new_n84_));
  ...
  nand3  g46(.a(new_n49_), .b(new_n52_), .c(x03), .O(new_n88_));
  ...
  aoi21  g52(.a(new_n53_), .b(new_n63_), .c(new_n57_), .O(new_n94_));
  ...
  aoi21  g57(.a(new_n53_), .b(new_n45_), .c(new_n57_), .O(new_n99_));
  ...
  aoi21  g62(.a(new_n53_), .b(new_n60_), .c(new_n57_), .O(new_n104_));
  ...
  aoi21  g67(.a(new_n53_), .b(new_n43_), .c(new_n57_), .O(new_n109_));
