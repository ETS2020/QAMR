...
module FAU ( 
  ...
  aoi21  g36(.a(new_n77_), .b(new_n46_), .c(new_n75_), .O(z13));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(z14));
  nand2  g42(.a(new_n80_), .b(new_n69_), .O(new_n84_));
  nand2  g43(.a(x16), .b(new_n66_), .O(new_n85_));
  inv1   g44(.a(x03), .O(new_n86_));
  nand4  g45(.a(new_n69_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  aoi21  g47(.a(new_n85_), .b(new_n84_), .c(new_n88_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n69_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n49_), .b(x15), .c(new_n59_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand4  g54(.a(new_n69_), .b(x10), .c(x08), .d(new_n95_), .O(new_n96_));
  ...
  nand4  g60(.a(new_n69_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  oai21  g61(.a(new_n49_), .b(x15), .c(new_n57_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand4  g65(.a(new_n69_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  oai21  g66(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n108_));
