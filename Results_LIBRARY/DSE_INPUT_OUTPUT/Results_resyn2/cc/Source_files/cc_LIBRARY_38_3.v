...
module FAU ( 
  ...
  nand3  g09(.a(new_n44_), .b(x12), .c(new_n42_), .O(new_n51_));
  ...
  nor2   g17(.a(new_n58_), .b(new_n49_), .O(z06));
  ...
  nor2   g24(.a(new_n58_), .b(new_n48_), .O(z11));
  aoi21  g25(.a(x19), .b(x06), .c(new_n53_), .O(new_n67_));
  ...
  nand2  g33(.a(new_n46_), .b(new_n48_), .O(new_n75_));
  nand4  g34(.a(new_n49_), .b(x10), .c(x08), .d(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n75_), .c(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n44_), .O(z13));
  inv1   g37(.a(x02), .O(new_n79_));
  oai21  g38(.a(new_n71_), .b(new_n79_), .c(new_n49_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n46_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z14));
  nand2  g41(.a(new_n44_), .b(x12), .O(new_n83_));
  nand3  g42(.a(new_n50_), .b(x16), .c(new_n48_), .O(new_n84_));
  ...
  oai21  g47(.a(new_n71_), .b(x15), .c(new_n60_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n67_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n95_), .b(new_n93_), .c(new_n67_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  inv1   g57(.a(x19), .O(new_n99_));
  nand4  g58(.a(new_n49_), .b(x12), .c(x10), .d(x08), .O(new_n100_));
  oai21  g59(.a(new_n71_), .b(x15), .c(x12), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n98_), .c(new_n100_), .d(new_n99_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand4  g62(.a(new_n49_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
  oai21  g63(.a(new_n71_), .b(x15), .c(new_n43_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n67_), .O(new_n106_));
