...
module FAU ( 
  ...
  nand2  g23(.a(new_n48_), .b(new_n64_), .O(z07));
  ...
  nand2  g37(.a(new_n50_), .b(new_n49_), .O(new_n79_));
  nand4  g38(.a(new_n62_), .b(x10), .c(x08), .d(x01), .O(new_n80_));
  ...
  nand2  g44(.a(new_n48_), .b(x12), .O(new_n86_));
  ...
  aoi22  g55(.a(new_n96_), .b(z04), .c(new_n48_), .d(new_n58_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n62_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  oai21  g58(.a(new_n54_), .b(x15), .c(new_n60_), .O(new_n100_));
