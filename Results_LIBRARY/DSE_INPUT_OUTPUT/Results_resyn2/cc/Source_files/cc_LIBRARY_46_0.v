...
module FAU ( 
  ...
  oai21  g16(.a(new_n49_), .b(new_n57_), .c(new_n45_), .O(z03));
  ...
  nor2   g28(.a(new_n42_), .b(new_n46_), .O(z11));
  ...
  nand3  g65(.a(new_n74_), .b(x20), .c(x12), .O(new_n107_));
