...
module FAU ( 
  ...
  nand2  g02(.a(x18), .b(new_n42_), .O(new_n44_));
  ...
  nor2   g29(.a(new_n60_), .b(new_n46_), .O(z11));
  ...
  oai21  g38(.a(new_n52_), .b(new_n79_), .c(x14), .O(new_n80_));
  nand2  g39(.a(new_n44_), .b(x12), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n47_), .c(new_n81_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n52_), .b(new_n83_), .c(new_n62_), .O(new_n84_));
  ...
  nand2  g53(.a(new_n75_), .b(new_n64_), .O(new_n95_));
  ...
  nand2  g58(.a(new_n75_), .b(new_n51_), .O(new_n100_));
  ...
  nand2  g63(.a(new_n75_), .b(new_n59_), .O(new_n105_));
  ...
  nand2  g68(.a(new_n75_), .b(new_n43_), .O(new_n110_));
