...
module FAU ( 
  ...
  aoi22  g30(.a(new_n71_), .b(new_n52_), .c(new_n70_), .d(new_n51_), .O(z12));
  ...
  aoi21  g36(.a(new_n51_), .b(x02), .c(new_n77_), .O(new_n78_));
  aoi21  g37(.a(new_n77_), .b(new_n51_), .c(new_n78_), .O(z14));
  oai21  g38(.a(new_n63_), .b(x14), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand2  g40(.a(new_n51_), .b(x03), .O(new_n82_));
  ...
  nand3  g46(.a(new_n47_), .b(new_n51_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g51(.a(new_n47_), .b(new_n51_), .c(new_n92_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  oai21  g53(.a(new_n69_), .b(x15), .c(new_n94_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n93_), .c(x12), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand3  g57(.a(new_n47_), .b(new_n51_), .c(new_n98_), .O(new_n99_));
  oai21  g58(.a(new_n69_), .b(x15), .c(new_n59_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z18));
  oai21  g61(.a(new_n69_), .b(x07), .c(x12), .O(new_n103_));
  nor2   g62(.a(x20), .b(new_n43_), .O(new_n104_));
  aoi22  g63(.a(new_n104_), .b(new_n52_), .c(new_n103_), .d(new_n51_), .O(z19));
  buf    g64(.a(x15), .O(z06));
endmodule
