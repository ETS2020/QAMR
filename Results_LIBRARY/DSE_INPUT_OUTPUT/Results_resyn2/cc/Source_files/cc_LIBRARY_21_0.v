...
module FAU ( 
  ...
  aoi21  g36(.a(new_n77_), .b(new_n48_), .c(new_n56_), .O(z13));
  ...
  oai21  g41(.a(new_n72_), .b(new_n82_), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n52_), .O(new_n84_));
  nand4  g43(.a(new_n53_), .b(x16), .c(new_n47_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z15));
  inv1   g45(.a(x04), .O(new_n87_));
  oai21  g46(.a(new_n72_), .b(new_n87_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n52_), .O(new_n89_));
  nand3  g48(.a(new_n53_), .b(x17), .c(x12), .O(new_n90_));
  ...
  oai21  g53(.a(new_n72_), .b(x15), .c(new_n94_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n72_), .b(x15), .c(new_n59_), .O(new_n100_));
  ...
  oai21  g63(.a(new_n72_), .b(x15), .c(new_n43_), .O(new_n105_));
