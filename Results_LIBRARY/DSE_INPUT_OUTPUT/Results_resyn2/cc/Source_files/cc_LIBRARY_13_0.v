...
module FAU ( 
  ...
  nor2   g27(.a(new_n42_), .b(new_n50_), .O(z11));
  ...
  nand2  g42(.a(new_n45_), .b(x12), .O(new_n84_));
  ...
  aoi21  g58(.a(new_n71_), .b(x07), .c(new_n49_), .O(new_n100_));
  nand3  g59(.a(new_n74_), .b(x20), .c(x12), .O(new_n101_));
  oai21  g60(.a(new_n100_), .b(x15), .c(new_n101_), .O(z19));
endmodule
