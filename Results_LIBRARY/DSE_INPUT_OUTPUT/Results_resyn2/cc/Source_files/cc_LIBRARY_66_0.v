...
module FAU ( 
  ...
  oai21  g17(.a(new_n49_), .b(new_n58_), .c(new_n44_), .O(z03));
  ...
  nand3  g31(.a(new_n72_), .b(new_n53_), .c(new_n71_), .O(new_n73_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n48_), .O(z14));
  aoi21  g44(.a(new_n72_), .b(x03), .c(new_n58_), .O(new_n86_));
  nand4  g45(.a(new_n54_), .b(x16), .c(new_n46_), .d(x12), .O(new_n87_));
  oai21  g46(.a(new_n86_), .b(x15), .c(new_n87_), .O(z15));
  aoi21  g47(.a(new_n72_), .b(x04), .c(new_n58_), .O(new_n89_));
  nand3  g48(.a(new_n54_), .b(x17), .c(x12), .O(new_n90_));
  oai21  g49(.a(new_n89_), .b(x15), .c(new_n90_), .O(z16));
  aoi21  g50(.a(new_n72_), .b(x05), .c(new_n58_), .O(new_n92_));
  nand3  g51(.a(new_n54_), .b(x18), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n92_), .b(x15), .c(new_n93_), .O(z17));
  aoi21  g53(.a(new_n72_), .b(x06), .c(new_n58_), .O(new_n95_));
  nand3  g54(.a(new_n54_), .b(x19), .c(x12), .O(new_n96_));
  oai21  g55(.a(new_n95_), .b(x15), .c(new_n96_), .O(z18));
  aoi21  g56(.a(new_n72_), .b(x07), .c(new_n58_), .O(new_n98_));
  nand3  g57(.a(new_n54_), .b(x20), .c(x12), .O(new_n99_));
  oai21  g58(.a(new_n98_), .b(x15), .c(new_n99_), .O(z19));
  buf    g59(.a(x15), .O(z06));
endmodule
