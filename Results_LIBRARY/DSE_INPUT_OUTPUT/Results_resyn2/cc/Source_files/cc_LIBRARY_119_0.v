...
module FAU ( 
  ...
  nand4  g15(.a(new_n56_), .b(new_n45_), .c(new_n49_), .d(x12), .O(new_n57_));
  ...
  nand3  g32(.a(new_n73_), .b(new_n71_), .c(new_n53_), .O(new_n74_));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n47_), .c(new_n76_), .O(z13));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n69_), .b(new_n80_), .c(new_n50_), .O(new_n81_));
  ...
  aoi21  g59(.a(new_n100_), .b(x12), .c(new_n98_), .O(new_n101_));
  oai21  g60(.a(new_n69_), .b(x15), .c(new_n98_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x12), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(x06), .c(new_n101_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand2  g64(.a(new_n70_), .b(new_n105_), .O(new_n106_));
