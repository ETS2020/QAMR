...
module FAU ( 
  ...
  nor2   g01(.a(new_n42_), .b(x00), .O(new_n43_));
  ...
  aoi21  g17(.a(new_n58_), .b(x00), .c(new_n42_), .O(z03));
  nor2   g18(.a(new_n43_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n43_), .b(new_n61_), .O(z05));
  nor2   g21(.a(new_n42_), .b(new_n46_), .O(z06));
  ...
  nand2  g29(.a(new_n49_), .b(new_n50_), .O(z11));
  nand4  g30(.a(new_n42_), .b(x10), .c(x08), .d(new_n46_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  oai21  g32(.a(new_n47_), .b(x15), .c(new_n73_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n72_), .c(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n49_), .O(z12));
  oai21  g35(.a(new_n57_), .b(new_n46_), .c(x15), .O(new_n77_));
  ...
  nand4  g40(.a(new_n42_), .b(x10), .c(x08), .d(x02), .O(new_n82_));
  ...
  oai21  g52(.a(new_n64_), .b(new_n52_), .c(x00), .O(new_n94_));
