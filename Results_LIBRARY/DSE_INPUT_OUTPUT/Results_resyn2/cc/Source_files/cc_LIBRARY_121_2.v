...
module FAU ( 
  ...
  nand2  g20(.a(new_n48_), .b(new_n54_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nor2   g22(.a(new_n45_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nor2   g24(.a(new_n45_), .b(new_n65_), .O(z08));
  nand2  g25(.a(x09), .b(x08), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n48_), .O(z09));
  nand3  g27(.a(new_n48_), .b(x09), .c(x08), .O(z10));
  nor2   g28(.a(new_n45_), .b(new_n49_), .O(z11));
  inv1   g29(.a(x00), .O(new_n71_));
  nand4  g30(.a(new_n54_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  ...
  nand2  g35(.a(new_n76_), .b(new_n48_), .O(z12));
  inv1   g36(.a(x01), .O(new_n78_));
  oai21  g37(.a(new_n74_), .b(new_n78_), .c(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n50_), .c(new_n58_), .O(z13));
  inv1   g39(.a(x02), .O(new_n81_));
  oai21  g40(.a(new_n74_), .b(new_n81_), .c(new_n54_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n50_), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n48_), .O(z14));
  nand3  g43(.a(new_n55_), .b(x16), .c(new_n49_), .O(new_n85_));
  nand4  g44(.a(new_n54_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  ...
  oai21  g48(.a(new_n74_), .b(x15), .c(new_n63_), .O(new_n90_));
  ...
  oai21  g54(.a(new_n74_), .b(x15), .c(new_n95_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n48_), .O(z17));
  inv1   g57(.a(new_n55_), .O(new_n99_));
  nand2  g58(.a(x19), .b(x12), .O(new_n100_));
  aoi21  g59(.a(new_n99_), .b(new_n44_), .c(new_n100_), .O(z18));
  inv1   g60(.a(x12), .O(new_n102_));
  aoi21  g61(.a(new_n47_), .b(x06), .c(new_n102_), .O(new_n103_));
  inv1   g62(.a(x07), .O(new_n104_));
  nand4  g63(.a(new_n54_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  oai21  g64(.a(new_n74_), .b(x15), .c(new_n43_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n103_), .O(new_n107_));
