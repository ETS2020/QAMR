...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(x01), .c(new_n48_), .O(z01));
  ...
  nand2  g16(.a(x15), .b(x01), .O(new_n58_));
  nor4   g17(.a(new_n58_), .b(new_n57_), .c(x14), .d(new_n56_), .O(z03));
  nand2  g18(.a(new_n45_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n46_), .b(new_n61_), .O(z05));
  inv1   g21(.a(new_n58_), .O(z06));
  ...
  nand4  g34(.a(new_n48_), .b(x10), .c(x08), .d(x00), .O(new_n76_));
  ...
  nand2  g39(.a(new_n57_), .b(new_n49_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n53_), .c(x12), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(x01), .c(new_n82_), .O(z13));
  nand2  g42(.a(z06), .b(new_n57_), .O(new_n84_));
  nand4  g43(.a(new_n48_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n56_), .O(z14));
  nand3  g45(.a(x16), .b(new_n49_), .c(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x01), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x15), .O(new_n89_));
  nand4  g48(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n90_));
  nand3  g49(.a(new_n57_), .b(x16), .c(new_n49_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n89_), .O(z15));
  oai21  g53(.a(new_n64_), .b(new_n56_), .c(x01), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n57_), .b(x17), .O(new_n97_));
  nand4  g56(.a(new_n48_), .b(x10), .c(x08), .d(x04), .O(new_n98_));
  ...
  nand2  g61(.a(new_n102_), .b(x01), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x15), .O(new_n104_));
  nand2  g63(.a(new_n57_), .b(x18), .O(new_n105_));
  nand4  g64(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n106_));
  ...
  nand2  g68(.a(z06), .b(x19), .O(new_n110_));
  inv1   g69(.a(x06), .O(new_n111_));
  nand3  g70(.a(x10), .b(x08), .c(new_n111_), .O(new_n112_));
  nand2  g71(.a(new_n57_), .b(new_n61_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n112_), .c(new_n48_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n110_), .c(new_n56_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n56_), .c(x01), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n57_), .b(x20), .O(new_n118_));
  nand4  g77(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n119_));
