...
module FAU ( 
  ...
  aoi21  g30(.a(new_n43_), .b(x16), .c(new_n50_), .O(new_n72_));
  ...
  nand4  g44(.a(new_n74_), .b(x17), .c(x16), .d(new_n55_), .O(new_n86_));
  nand3  g45(.a(new_n49_), .b(new_n44_), .c(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n50_), .O(z15));
  nand2  g47(.a(new_n49_), .b(new_n64_), .O(new_n89_));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n70_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x12), .O(new_n92_));
  aoi21  g51(.a(new_n89_), .b(new_n43_), .c(new_n92_), .O(z16));
