...
module FAU ( 
  ...
  nand2  g12(.a(new_n49_), .b(x12), .O(new_n54_));
  oai21  g13(.a(new_n54_), .b(new_n47_), .c(new_n45_), .O(z03));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n47_), .c(new_n74_), .O(z13));
  nand3  g36(.a(x10), .b(x08), .c(x02), .O(new_n78_));
  nand2  g37(.a(new_n47_), .b(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n50_), .c(new_n79_), .O(z14));
  inv1   g39(.a(x03), .O(new_n81_));
  oai21  g40(.a(new_n70_), .b(new_n81_), .c(x12), .O(new_n82_));
  ...
  nand4  g45(.a(new_n50_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  oai21  g46(.a(new_n70_), .b(x15), .c(new_n60_), .O(new_n88_));
  ...
  oai21  g56(.a(new_n70_), .b(new_n97_), .c(x12), .O(new_n98_));
