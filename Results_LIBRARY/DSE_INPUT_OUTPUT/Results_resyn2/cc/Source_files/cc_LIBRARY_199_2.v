...
module FAU ( 
  ...
  aoi21  g40(.a(new_n43_), .b(x14), .c(new_n50_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n46_), .O(new_n83_));
  aoi21  g42(.a(new_n81_), .b(new_n60_), .c(new_n83_), .O(z14));
  nand3  g43(.a(new_n72_), .b(x16), .c(new_n58_), .O(new_n85_));
  nand3  g44(.a(x10), .b(x08), .c(x03), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n44_), .c(new_n60_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n85_), .c(new_n50_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n60_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n72_), .b(new_n62_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n82_), .O(new_n93_));
  ...
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n82_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  nand2  g59(.a(new_n49_), .b(new_n58_), .O(new_n101_));
  ...
  aoi21  g63(.a(new_n101_), .b(new_n43_), .c(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand4  g65(.a(new_n60_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  inv1   g66(.a(x20), .O(new_n108_));
  nand2  g67(.a(new_n72_), .b(new_n108_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n107_), .c(new_n82_), .O(new_n110_));
