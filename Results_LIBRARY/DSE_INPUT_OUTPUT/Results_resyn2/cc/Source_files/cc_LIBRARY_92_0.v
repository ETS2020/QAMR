...
module FAU ( 
  ...
  nor2   g10(.a(x15), .b(new_n48_), .O(new_n52_));
  ...
  nand2  g32(.a(new_n62_), .b(x10), .O(new_n74_));
  ...
  oai21  g40(.a(new_n48_), .b(new_n47_), .c(x15), .O(new_n82_));
  nand4  g41(.a(new_n62_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n57_), .O(z14));
  nand3  g43(.a(new_n62_), .b(x10), .c(x03), .O(new_n85_));
  nand3  g44(.a(x16), .b(new_n46_), .c(new_n48_), .O(new_n86_));
  ...
  nand3  g49(.a(new_n62_), .b(x10), .c(x04), .O(new_n91_));
  nand2  g50(.a(x17), .b(new_n48_), .O(new_n92_));
  ...
  nand3  g55(.a(new_n62_), .b(x10), .c(x05), .O(new_n97_));
  nand2  g56(.a(x18), .b(new_n48_), .O(new_n98_));
  ...
  nand3  g61(.a(new_n62_), .b(x10), .c(x06), .O(new_n103_));
  nand2  g62(.a(x19), .b(new_n48_), .O(new_n104_));
  ...
  nand3  g70(.a(new_n74_), .b(x20), .c(x12), .O(new_n112_));
