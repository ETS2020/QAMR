...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    ...
    new_n64_, new_n67_, new_n69_, new_n70_, new_n71_, new_n72_, new_n74_,
  ...
  nor2   g21(.a(new_n62_), .b(new_n44_), .O(z08));
  ...
  aoi21  g28(.a(x10), .b(x08), .c(x16), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(x15), .c(x13), .O(new_n71_));
  nand3  g30(.a(new_n51_), .b(new_n62_), .c(x00), .O(new_n72_));
  ...
  nand3  g38(.a(new_n51_), .b(new_n62_), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n69_), .O(z14));
  nand2  g40(.a(x16), .b(new_n67_), .O(new_n82_));
  ...
  aoi21  g49(.a(new_n50_), .b(new_n60_), .c(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n87_), .c(new_n69_), .O(z16));
  nand2  g52(.a(x18), .b(x15), .O(new_n94_));
  nand2  g53(.a(new_n44_), .b(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n88_), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  aoi21  g56(.a(new_n50_), .b(new_n97_), .c(x16), .O(new_n98_));
  ...
  nand2  g60(.a(new_n44_), .b(x06), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n88_), .O(new_n103_));
  aoi21  g62(.a(new_n50_), .b(new_n58_), .c(x16), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n101_), .c(new_n69_), .O(z18));
  nand2  g65(.a(x20), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n44_), .b(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n88_), .O(new_n109_));
  aoi21  g68(.a(new_n50_), .b(new_n43_), .c(x16), .O(new_n110_));
