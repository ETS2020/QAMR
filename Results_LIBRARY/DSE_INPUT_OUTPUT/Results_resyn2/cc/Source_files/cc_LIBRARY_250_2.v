...
module FAU ( 
  ...
  nor2   g22(.a(new_n45_), .b(new_n63_), .O(z06));
  ...
  inv1   g53(.a(new_n86_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n54_), .b(x15), .c(new_n61_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n48_), .O(z18));
  aoi21  g61(.a(new_n47_), .b(x05), .c(new_n58_), .O(new_n103_));
  inv1   g62(.a(x07), .O(new_n104_));
  nand4  g63(.a(new_n63_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
