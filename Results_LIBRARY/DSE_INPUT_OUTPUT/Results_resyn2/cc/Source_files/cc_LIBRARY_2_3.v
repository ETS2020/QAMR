...
module FAU ( 
  ...
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(new_n54_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand4  g63(.a(new_n51_), .b(x12), .c(x10), .d(x08), .O(new_n105_));
  nand2  g64(.a(new_n52_), .b(x12), .O(new_n106_));
  aoi22  g65(.a(new_n106_), .b(new_n104_), .c(new_n105_), .d(new_n60_), .O(z18));
