...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n61_,
  ...
  oai21  g16(.a(new_n49_), .b(new_n54_), .c(new_n45_), .O(z03));
  nor2   g17(.a(new_n42_), .b(x18), .O(z04));
  nor2   g18(.a(new_n42_), .b(new_n51_), .O(z06));
  ...
  nand4  g34(.a(new_n51_), .b(x10), .c(x08), .d(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n75_), .c(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n45_), .O(z13));
  nand3  g37(.a(x10), .b(x08), .c(x02), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n51_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n47_), .c(x12), .O(new_n81_));
  ...
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n70_), .O(new_n98_));
  ...
  nand3  g62(.a(new_n103_), .b(new_n101_), .c(x12), .O(new_n104_));
