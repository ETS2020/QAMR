...
module FAU ( 
  ...
  nand2  g42(.a(new_n79_), .b(new_n54_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z14));
  inv1   g44(.a(x03), .O(new_n86_));
  nand3  g45(.a(new_n71_), .b(new_n51_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g51(.a(new_n71_), .b(new_n51_), .c(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n52_), .b(new_n62_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n44_), .O(z16));
  inv1   g55(.a(x05), .O(new_n97_));
  nand3  g56(.a(new_n71_), .b(new_n51_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g62(.a(new_n71_), .b(new_n51_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g67(.a(new_n71_), .b(new_n51_), .c(new_n108_), .O(new_n109_));
