...
module FAU ( 
  ...
  nand2  g15(.a(x09), .b(x08), .O(new_n57_));
  nand4  g16(.a(x15), .b(new_n48_), .c(x12), .d(x10), .O(new_n58_));
  ...
  nand2  g25(.a(new_n57_), .b(new_n43_), .O(z09));
  ...
  nand4  g39(.a(new_n80_), .b(new_n78_), .c(new_n43_), .d(x12), .O(new_n81_));
  ...
  nand2  g64(.a(new_n91_), .b(x19), .O(new_n106_));
  inv1   g65(.a(x06), .O(new_n107_));
  nand3  g66(.a(x10), .b(x08), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n51_), .b(new_n61_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n47_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n106_), .c(new_n53_), .O(z18));
  nand2  g70(.a(new_n91_), .b(x20), .O(new_n112_));
  ...
  nand3  g75(.a(new_n116_), .b(new_n114_), .c(new_n47_), .O(new_n117_));
