...
module FAU ( 
  ...
  nor2   g24(.a(new_n44_), .b(new_n65_), .O(z11));
  ...
  aoi21  g37(.a(new_n77_), .b(new_n67_), .c(new_n78_), .O(z14));
  nand2  g38(.a(x16), .b(new_n65_), .O(new_n80_));
  inv1   g39(.a(x03), .O(new_n81_));
  nand4  g40(.a(new_n67_), .b(x10), .c(x08), .d(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x12), .O(new_n83_));
  aoi21  g42(.a(new_n80_), .b(new_n71_), .c(new_n83_), .O(z15));
  inv1   g43(.a(x04), .O(new_n85_));
  oai21  g44(.a(new_n49_), .b(new_n85_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  nand3  g46(.a(new_n71_), .b(x17), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z16));
  inv1   g48(.a(x05), .O(new_n90_));
  oai21  g49(.a(new_n49_), .b(new_n90_), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n67_), .O(new_n92_));
  nand3  g51(.a(new_n71_), .b(x18), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(z17));
  inv1   g53(.a(x06), .O(new_n95_));
  oai21  g54(.a(new_n49_), .b(new_n95_), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n67_), .O(new_n97_));
  nand3  g56(.a(new_n71_), .b(x19), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  nand4  g59(.a(new_n67_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n102_));
