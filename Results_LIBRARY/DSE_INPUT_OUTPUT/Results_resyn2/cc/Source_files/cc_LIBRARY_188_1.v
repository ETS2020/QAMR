...
module FAU ( 
  ...
  oai21  g14(.a(new_n44_), .b(x06), .c(x14), .O(new_n56_));
  oai21  g15(.a(new_n44_), .b(x06), .c(new_n49_), .O(new_n57_));
  inv1   g16(.a(x12), .O(new_n58_));
  oai21  g17(.a(new_n44_), .b(x06), .c(new_n58_), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z03));
  nand2  g20(.a(new_n48_), .b(x18), .O(z04));
  ...
  nand3  g42(.a(new_n49_), .b(new_n48_), .c(x12), .O(new_n84_));
  ...
  aoi21  g47(.a(x19), .b(new_n47_), .c(new_n58_), .O(new_n89_));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n52_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n75_), .b(x15), .c(new_n64_), .O(new_n92_));
  ...
  oai21  g56(.a(new_n75_), .b(x15), .c(new_n97_), .O(new_n98_));
  ...
  aoi22  g60(.a(new_n101_), .b(new_n44_), .c(new_n48_), .d(new_n58_), .O(z18));
