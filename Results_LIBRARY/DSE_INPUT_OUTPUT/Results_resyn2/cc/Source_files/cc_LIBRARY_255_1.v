...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n60_, new_n62_,
  ...
  oai21  g32(.a(new_n51_), .b(x15), .c(new_n73_), .O(new_n74_));
  ...
  aoi21  g38(.a(new_n78_), .b(new_n49_), .c(new_n79_), .O(z13));
  nand3  g39(.a(x10), .b(x08), .c(x02), .O(new_n81_));
  nand3  g40(.a(new_n49_), .b(new_n45_), .c(x12), .O(new_n82_));
  ...
  oai21  g48(.a(new_n51_), .b(x15), .c(new_n64_), .O(new_n90_));
