...
module FAU ( 
  ...
  aoi21  g16(.a(new_n49_), .b(x12), .c(new_n57_), .O(z03));
  ...
  nand3  g29(.a(new_n48_), .b(new_n57_), .c(new_n70_), .O(new_n71_));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n42_), .O(z13));
  nand3  g38(.a(x12), .b(x10), .c(x08), .O(new_n80_));
  aoi21  g39(.a(new_n57_), .b(x02), .c(new_n80_), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n57_), .c(new_n81_), .O(z14));
  oai21  g41(.a(new_n64_), .b(x14), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand2  g43(.a(new_n57_), .b(x03), .O(new_n85_));
  ...
  nand3  g49(.a(new_n48_), .b(new_n57_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g54(.a(new_n48_), .b(new_n57_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n48_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g64(.a(new_n48_), .b(new_n57_), .O(new_n106_));
  oai21  g65(.a(new_n52_), .b(x07), .c(x12), .O(new_n107_));
  nor2   g66(.a(x20), .b(new_n42_), .O(new_n108_));
  aoi22  g67(.a(new_n108_), .b(new_n106_), .c(new_n107_), .d(new_n57_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
