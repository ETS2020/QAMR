...
module FAU ( 
  ...
  nand2  g11(.a(x14), .b(x12), .O(new_n53_));
  oai21  g12(.a(new_n52_), .b(x15), .c(new_n53_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n44_), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  oai21  g16(.a(new_n49_), .b(new_n57_), .c(new_n44_), .O(z03));
  ...
  nand4  g29(.a(new_n70_), .b(x10), .c(x08), .d(new_n69_), .O(new_n71_));
  ...
  oai21  g35(.a(new_n52_), .b(new_n76_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n47_), .c(new_n57_), .O(z13));
  nand3  g37(.a(x10), .b(x08), .c(x02), .O(new_n79_));
  nand2  g38(.a(new_n47_), .b(x12), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(new_n70_), .c(new_n80_), .O(z14));
  nand3  g40(.a(new_n70_), .b(x10), .c(x08), .O(new_n82_));
  nand2  g41(.a(x16), .b(new_n46_), .O(new_n83_));
  inv1   g42(.a(x03), .O(new_n84_));
  nand4  g43(.a(new_n70_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x12), .O(new_n86_));
  aoi21  g45(.a(new_n83_), .b(new_n82_), .c(new_n86_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n70_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n52_), .b(x15), .c(new_n62_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z16));
  inv1   g51(.a(x05), .O(new_n93_));
  nand4  g52(.a(new_n70_), .b(x10), .c(x08), .d(new_n93_), .O(new_n94_));
  ...
  oai21  g58(.a(new_n52_), .b(new_n99_), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n70_), .O(new_n101_));
  nand3  g60(.a(new_n82_), .b(x19), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  oai21  g63(.a(new_n52_), .b(new_n104_), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n70_), .O(new_n106_));
