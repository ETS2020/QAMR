...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n67_), .c(new_n46_), .O(z12));
  inv1   g28(.a(x01), .O(new_n70_));
  oai21  g29(.a(new_n51_), .b(new_n70_), .c(x14), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n47_), .c(new_n46_), .O(z13));
  nand3  g31(.a(x10), .b(x08), .c(x02), .O(new_n73_));
  nor3   g32(.a(new_n73_), .b(x15), .c(new_n46_), .O(z14));
  nand3  g33(.a(new_n51_), .b(x16), .c(new_n48_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x03), .O(new_n76_));
  and2   g35(.a(new_n76_), .b(new_n47_), .O(new_n77_));
  ...
  nand2  g56(.a(new_n51_), .b(new_n43_), .O(new_n98_));
