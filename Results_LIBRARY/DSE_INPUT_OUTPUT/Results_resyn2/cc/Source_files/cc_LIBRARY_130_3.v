...
module FAU ( 
  ...
  nand2  g02(.a(x18), .b(x08), .O(new_n44_));
  ...
  aoi21  g08(.a(new_n49_), .b(z04), .c(new_n46_), .O(z01));
  inv1   g09(.a(x10), .O(new_n51_));
  nor2   g10(.a(x15), .b(new_n51_), .O(new_n52_));
  nand3  g11(.a(new_n52_), .b(z04), .c(x08), .O(new_n53_));
  ...
  nor4   g15(.a(new_n56_), .b(x18), .c(x14), .d(new_n46_), .O(z03));
  ...
  oai21  g40(.a(new_n81_), .b(new_n69_), .c(z04), .O(new_n82_));
  ...
  aoi21  g46(.a(new_n60_), .b(x10), .c(x18), .O(new_n88_));
  nor2   g47(.a(new_n63_), .b(x14), .O(new_n89_));
  oai21  g48(.a(new_n88_), .b(new_n46_), .c(new_n89_), .O(new_n90_));
  nand4  g49(.a(new_n52_), .b(z04), .c(x08), .d(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n87_), .O(z15));
  oai21  g51(.a(new_n88_), .b(new_n46_), .c(x17), .O(new_n93_));
  nand4  g52(.a(new_n52_), .b(z04), .c(x08), .d(x04), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n87_), .O(z16));
  nand2  g54(.a(new_n44_), .b(x12), .O(new_n96_));
  nand3  g55(.a(new_n52_), .b(x08), .c(x05), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(z04), .c(new_n96_), .O(z17));
  nand2  g57(.a(x19), .b(new_n46_), .O(new_n99_));
  nand2  g58(.a(x08), .b(x06), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n60_), .c(x10), .O(new_n101_));
  nand2  g60(.a(new_n69_), .b(new_n58_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(z04), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n99_), .c(new_n87_), .O(z18));
  nand2  g63(.a(x20), .b(new_n46_), .O(new_n105_));
  nand2  g64(.a(x08), .b(x07), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n60_), .c(x10), .O(new_n107_));
  nand2  g66(.a(new_n69_), .b(new_n43_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(z04), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n105_), .c(new_n87_), .O(z19));
endmodule
