...
module FAU ( 
  ...
  oai21  g16(.a(new_n57_), .b(new_n49_), .c(new_n44_), .O(z03));
  ...
  nand3  g53(.a(new_n94_), .b(new_n92_), .c(new_n54_), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  inv1   g56(.a(x19), .O(new_n98_));
  nand4  g57(.a(new_n51_), .b(x12), .c(x10), .d(x08), .O(new_n99_));
