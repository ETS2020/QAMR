...
module FAU ( 
  ...
  oai21  g14(.a(new_n55_), .b(new_n46_), .c(new_n48_), .O(z03));
  ...
  oai21  g36(.a(new_n49_), .b(new_n77_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n46_), .c(new_n76_), .O(z13));
  ...
  nand4  g59(.a(new_n60_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n49_), .b(x15), .c(new_n58_), .O(new_n102_));
