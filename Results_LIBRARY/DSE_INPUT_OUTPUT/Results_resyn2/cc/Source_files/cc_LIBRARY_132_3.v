...
module FAU ( 
  ...
  and2   g22(.a(new_n62_), .b(new_n43_), .O(z10));
  nand2  g23(.a(new_n43_), .b(new_n47_), .O(z11));
  nand3  g24(.a(x10), .b(x08), .c(x00), .O(new_n66_));
  aoi21  g25(.a(new_n45_), .b(x13), .c(x15), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n66_), .c(new_n46_), .O(z12));
  inv1   g27(.a(x01), .O(new_n69_));
  oai21  g28(.a(new_n45_), .b(new_n69_), .c(x14), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n51_), .c(new_n46_), .O(z13));
  nand3  g30(.a(x10), .b(x08), .c(x02), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n51_), .c(new_n46_), .O(z14));
  nand2  g32(.a(new_n50_), .b(x16), .O(new_n74_));
  nand3  g33(.a(x10), .b(x08), .c(x03), .O(new_n75_));
  and2   g34(.a(new_n75_), .b(new_n51_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n46_), .O(z15));
  nor2   g36(.a(x15), .b(new_n46_), .O(new_n78_));
  inv1   g37(.a(x04), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(new_n79_), .O(new_n80_));
  nand2  g39(.a(new_n45_), .b(new_n58_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n80_), .c(new_n78_), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z16));
  inv1   g42(.a(x05), .O(new_n84_));
  nand3  g43(.a(x10), .b(x08), .c(new_n84_), .O(new_n85_));
  inv1   g44(.a(x18), .O(new_n86_));
  nand2  g45(.a(new_n45_), .b(new_n86_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n85_), .c(new_n78_), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z17));
  inv1   g48(.a(x06), .O(new_n90_));
  nand3  g49(.a(x10), .b(x08), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n45_), .b(new_n56_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n78_), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z18));
  nand3  g53(.a(x10), .b(x08), .c(x07), .O(new_n95_));
  aoi21  g54(.a(new_n45_), .b(x20), .c(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n46_), .O(z19));
  buf    g56(.a(x15), .O(z06));
endmodule
