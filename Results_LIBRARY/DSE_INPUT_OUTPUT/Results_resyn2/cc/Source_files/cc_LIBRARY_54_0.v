...
module FAU ( 
  ...
  nor2   g27(.a(new_n42_), .b(new_n68_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  oai21  g29(.a(new_n49_), .b(new_n70_), .c(x12), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n59_), .O(new_n72_));
  nand3  g31(.a(new_n59_), .b(x10), .c(x08), .O(new_n73_));
  ...
  aoi21  g36(.a(new_n77_), .b(new_n46_), .c(new_n54_), .O(z13));
  nand3  g37(.a(x10), .b(x08), .c(x02), .O(new_n79_));
  nand2  g38(.a(new_n46_), .b(x12), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(new_n59_), .c(new_n80_), .O(z14));
  inv1   g40(.a(x03), .O(new_n82_));
  oai21  g41(.a(new_n49_), .b(new_n82_), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n59_), .O(new_n84_));
  nand4  g43(.a(new_n73_), .b(x16), .c(new_n68_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z15));
  inv1   g45(.a(x04), .O(new_n87_));
  nand4  g46(.a(new_n59_), .b(x10), .c(x08), .d(new_n87_), .O(new_n88_));
  oai21  g47(.a(new_n49_), .b(x15), .c(new_n61_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  oai21  g51(.a(new_n49_), .b(new_n92_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n59_), .O(new_n94_));
  nand3  g53(.a(new_n73_), .b(x18), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  nand4  g56(.a(new_n59_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  oai21  g57(.a(new_n49_), .b(x15), .c(new_n57_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z18));
  inv1   g60(.a(x07), .O(new_n102_));
  oai21  g61(.a(new_n49_), .b(new_n102_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n59_), .O(new_n104_));
  nand3  g63(.a(new_n73_), .b(x20), .c(x12), .O(new_n105_));
