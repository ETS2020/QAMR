...
module FAU ( 
  ...
  aoi21  g42(.a(new_n71_), .b(x03), .c(new_n52_), .O(new_n84_));
  nand4  g43(.a(new_n73_), .b(x16), .c(new_n46_), .d(x12), .O(new_n85_));
  ...
  nand3  g57(.a(new_n71_), .b(new_n62_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n73_), .b(new_n60_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z18));
  aoi21  g61(.a(new_n71_), .b(x07), .c(new_n52_), .O(new_n103_));
  nand3  g62(.a(new_n73_), .b(x20), .c(x12), .O(new_n104_));
  oai21  g63(.a(new_n103_), .b(x15), .c(new_n104_), .O(z19));
endmodule
