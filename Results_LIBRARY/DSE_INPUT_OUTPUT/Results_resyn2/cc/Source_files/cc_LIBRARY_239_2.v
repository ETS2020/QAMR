...
module FAU ( 
  ...
  nand2  g21(.a(new_n53_), .b(new_n44_), .O(z05));
  ...
  oai21  g39(.a(new_n58_), .b(new_n80_), .c(x14), .O(new_n81_));
  nand3  g40(.a(x15), .b(x10), .c(x08), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(z13));
  inv1   g42(.a(x02), .O(new_n84_));
  oai21  g43(.a(new_n58_), .b(new_n84_), .c(new_n47_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n82_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n57_), .O(z14));
  ...
  nand4  g59(.a(new_n47_), .b(x10), .c(x08), .d(new_n44_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n54_), .O(new_n102_));
  ...
  aoi21  g65(.a(new_n101_), .b(new_n53_), .c(new_n106_), .O(z18));
