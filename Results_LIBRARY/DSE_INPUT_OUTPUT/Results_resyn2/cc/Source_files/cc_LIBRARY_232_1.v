...
module FAU ( 
  ...
  nand2  g27(.a(new_n58_), .b(new_n47_), .O(z11));
  nand2  g28(.a(x10), .b(x08), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(x00), .c(x12), .O(new_n71_));
  nor2   g30(.a(x13), .b(new_n50_), .O(new_n72_));
  aoi22  g31(.a(new_n72_), .b(new_n54_), .c(new_n71_), .d(new_n44_), .O(z12));
  inv1   g32(.a(x01), .O(new_n74_));
  oai21  g33(.a(new_n70_), .b(new_n74_), .c(x14), .O(new_n75_));
  nand2  g34(.a(new_n48_), .b(x15), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n50_), .O(z13));
  nand2  g36(.a(new_n48_), .b(x02), .O(new_n78_));
  oai21  g37(.a(new_n70_), .b(new_n44_), .c(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n44_), .c(new_n79_), .O(z14));
  oai21  g39(.a(new_n64_), .b(x14), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  nand2  g41(.a(new_n44_), .b(x03), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n48_), .O(new_n84_));
  oai21  g43(.a(new_n64_), .b(x14), .c(new_n70_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n82_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand3  g47(.a(new_n48_), .b(new_n44_), .c(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n70_), .b(x15), .c(new_n62_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z16));
  oai21  g51(.a(new_n70_), .b(x05), .c(x12), .O(new_n93_));
  nor2   g52(.a(x18), .b(new_n50_), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n54_), .c(new_n93_), .d(new_n44_), .O(z17));
  inv1   g54(.a(x06), .O(new_n96_));
  nand3  g55(.a(new_n48_), .b(new_n44_), .c(new_n96_), .O(new_n97_));
  oai21  g56(.a(new_n70_), .b(x15), .c(new_n60_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(x12), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z18));
  inv1   g59(.a(x07), .O(new_n101_));
  nand3  g60(.a(new_n48_), .b(new_n44_), .c(new_n101_), .O(new_n102_));
