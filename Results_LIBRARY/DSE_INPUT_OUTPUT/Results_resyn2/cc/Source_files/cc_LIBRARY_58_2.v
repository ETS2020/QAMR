...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(z13));
  nand2  g30(.a(x15), .b(x12), .O(new_n72_));
  nor2   g31(.a(new_n72_), .b(new_n47_), .O(z14));
  nand2  g32(.a(x16), .b(new_n46_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x15), .c(new_n53_), .O(z15));
  ...
  aoi21  g38(.a(new_n57_), .b(x15), .c(new_n53_), .O(z18));
