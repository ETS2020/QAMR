...
module FAU ( 
  ...
  nand2  g16(.a(new_n44_), .b(new_n49_), .O(z06));
  ...
  nor2   g23(.a(x19), .b(new_n48_), .O(z11));
  inv1   g24(.a(x00), .O(new_n66_));
  and2   g25(.a(x10), .b(x08), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(new_n49_), .c(new_n66_), .O(new_n68_));
  inv1   g27(.a(x13), .O(new_n69_));
  nand2  g28(.a(new_n50_), .b(new_n69_), .O(new_n70_));
  ...
  aoi21  g36(.a(new_n67_), .b(x02), .c(x15), .O(new_n78_));
  inv1   g37(.a(x12), .O(new_n79_));
  aoi21  g38(.a(x19), .b(x14), .c(new_n79_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n78_), .O(z14));
  nand3  g41(.a(new_n50_), .b(x16), .c(new_n48_), .O(new_n83_));
  nand4  g42(.a(new_n67_), .b(new_n44_), .c(new_n49_), .d(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n79_), .O(z15));
  inv1   g44(.a(x04), .O(new_n86_));
  nand3  g45(.a(new_n67_), .b(new_n49_), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n50_), .b(new_n59_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n80_), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z16));
  inv1   g49(.a(x05), .O(new_n91_));
  nand3  g50(.a(new_n67_), .b(new_n49_), .c(new_n91_), .O(new_n92_));
  inv1   g51(.a(x18), .O(new_n93_));
  nand2  g52(.a(new_n50_), .b(new_n93_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n92_), .c(new_n80_), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  nand3  g56(.a(new_n67_), .b(new_n49_), .c(new_n97_), .O(new_n98_));
  inv1   g57(.a(x19), .O(new_n99_));
  nand2  g58(.a(new_n50_), .b(new_n99_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n98_), .c(new_n80_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand3  g62(.a(new_n67_), .b(new_n49_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n50_), .b(new_n43_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n80_), .O(new_n106_));
