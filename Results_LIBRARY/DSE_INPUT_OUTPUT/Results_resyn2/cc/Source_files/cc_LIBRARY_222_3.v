...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n62_,
  ...
  nor3   g09(.a(new_n50_), .b(new_n45_), .c(new_n47_), .O(z01));
  ...
  nand3  g40(.a(new_n55_), .b(new_n44_), .c(x12), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n47_), .c(new_n82_), .O(z14));
  inv1   g42(.a(x03), .O(new_n84_));
  nand3  g43(.a(new_n49_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  ...
  nand3  g49(.a(new_n49_), .b(new_n47_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g54(.a(new_n49_), .b(new_n47_), .c(new_n95_), .O(new_n96_));
  nand2  g55(.a(new_n52_), .b(z04), .O(new_n97_));
  nand4  g56(.a(new_n97_), .b(new_n96_), .c(new_n44_), .d(x12), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  nand4  g58(.a(new_n47_), .b(x12), .c(x10), .d(x08), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(z04), .O(new_n101_));
  ...
  nand3  g64(.a(new_n49_), .b(new_n47_), .c(new_n105_), .O(new_n106_));
