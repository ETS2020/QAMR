...
module FAU ( 
  ...
  aoi21  g10(.a(new_n51_), .b(x03), .c(new_n48_), .O(z01));
  ...
  aoi21  g16(.a(new_n57_), .b(x03), .c(new_n48_), .O(z03));
  nand2  g17(.a(new_n45_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n46_), .b(new_n60_), .O(z05));
  nor2   g20(.a(new_n48_), .b(new_n44_), .O(z06));
  ...
  nand3  g38(.a(new_n50_), .b(new_n48_), .c(x01), .O(new_n80_));
  oai21  g39(.a(new_n74_), .b(new_n48_), .c(new_n49_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n80_), .c(new_n45_), .d(x12), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  nand2  g42(.a(new_n50_), .b(x15), .O(new_n84_));
  nand2  g43(.a(new_n74_), .b(new_n48_), .O(new_n85_));
  inv1   g44(.a(x02), .O(new_n86_));
  inv1   g45(.a(x12), .O(new_n87_));
  aoi21  g46(.a(new_n48_), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n85_), .c(new_n84_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z14));
  nand2  g49(.a(new_n85_), .b(new_n44_), .O(new_n91_));
  oai22  g50(.a(new_n74_), .b(x15), .c(new_n65_), .d(x14), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z15));
  oai21  g53(.a(new_n63_), .b(new_n87_), .c(x03), .O(new_n95_));
  ...
  nand2  g71(.a(new_n74_), .b(new_n60_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n112_), .c(new_n48_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n110_), .c(new_n87_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n87_), .c(x03), .O(new_n116_));
