...
module FAU ( 
  ...
  nor4   g06(.a(new_n47_), .b(new_n46_), .c(x14), .d(x00), .O(z01));
  ...
  aoi21  g17(.a(new_n58_), .b(new_n54_), .c(new_n46_), .O(z03));
  ...
  nor2   g28(.a(new_n43_), .b(new_n55_), .O(z11));
  oai21  g29(.a(new_n57_), .b(x15), .c(x00), .O(new_n71_));
  ...
  nand4  g33(.a(new_n46_), .b(x10), .c(x08), .d(x01), .O(new_n75_));
  nand3  g34(.a(x15), .b(x10), .c(x08), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n55_), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n75_), .c(new_n42_), .d(x12), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z13));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n47_), .b(new_n80_), .c(new_n46_), .O(new_n81_));
  ...
  nand4  g43(.a(new_n72_), .b(new_n42_), .c(x16), .d(new_n55_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n50_), .O(z15));
  oai21  g45(.a(new_n63_), .b(new_n50_), .c(new_n54_), .O(new_n87_));
  ...
  nand2  g53(.a(new_n94_), .b(new_n54_), .O(new_n95_));
  ...
  nand3  g60(.a(x19), .b(x15), .c(new_n54_), .O(new_n102_));
  inv1   g61(.a(x06), .O(new_n103_));
  nand3  g62(.a(x10), .b(x08), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n47_), .b(new_n61_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n46_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n102_), .c(new_n50_), .O(z18));
