...
module FAU ( 
  ...
  nor2   g16(.a(x18), .b(new_n56_), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n45_), .b(new_n59_), .O(z05));
  nor2   g19(.a(new_n44_), .b(new_n52_), .O(z06));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n48_), .c(new_n56_), .O(z13));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n73_), .b(new_n80_), .c(new_n52_), .O(new_n81_));
  ...
  oai21  g47(.a(new_n73_), .b(x15), .c(new_n62_), .O(new_n89_));
