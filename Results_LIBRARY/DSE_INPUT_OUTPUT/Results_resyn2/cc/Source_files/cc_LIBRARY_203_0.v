...
module FAU ( 
  ...
  nor3   g14(.a(new_n48_), .b(x14), .c(new_n52_), .O(z03));
  ...
  oai21  g28(.a(new_n69_), .b(new_n50_), .c(x04), .O(new_n70_));
  ...
  nand3  g34(.a(new_n75_), .b(x14), .c(x04), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n52_), .O(z13));
  aoi21  g36(.a(new_n47_), .b(x02), .c(x15), .O(new_n78_));
  nand2  g37(.a(new_n48_), .b(x12), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n45_), .O(z14));
  nand3  g39(.a(x16), .b(x15), .c(new_n66_), .O(new_n81_));
  nand2  g40(.a(new_n44_), .b(x03), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  oai21  g42(.a(new_n61_), .b(x14), .c(new_n50_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(x04), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n81_), .c(new_n52_), .O(z15));
  oai21  g45(.a(new_n51_), .b(x17), .c(x12), .O(new_n87_));
  ...
  oai21  g51(.a(new_n72_), .b(new_n89_), .c(new_n92_), .O(z17));
  ...
  oai21  g55(.a(new_n72_), .b(new_n58_), .c(new_n96_), .O(z18));
  nand2  g56(.a(x20), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n44_), .b(x07), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  inv1   g59(.a(x20), .O(new_n101_));
  aoi21  g60(.a(new_n50_), .b(new_n101_), .c(new_n43_), .O(new_n102_));
