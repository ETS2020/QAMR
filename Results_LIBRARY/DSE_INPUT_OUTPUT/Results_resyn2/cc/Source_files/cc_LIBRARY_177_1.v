...
module FAU ( 
  ...
  oai21  g38(.a(new_n56_), .b(new_n43_), .c(x15), .O(new_n80_));
  ...
  nand2  g45(.a(new_n46_), .b(x02), .O(new_n87_));
  ...
  nand2  g49(.a(new_n49_), .b(x03), .O(new_n91_));
  nand3  g50(.a(new_n46_), .b(x10), .c(x08), .O(new_n92_));
  nand4  g51(.a(new_n92_), .b(new_n44_), .c(x16), .d(new_n54_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n91_), .c(new_n50_), .O(z15));
  oai21  g53(.a(new_n64_), .b(new_n50_), .c(x07), .O(new_n95_));
  ...
  oai21  g68(.a(new_n61_), .b(new_n50_), .c(x07), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n47_), .b(x19), .O(new_n112_));
  ...
  oai21  g76(.a(new_n85_), .b(x07), .c(x12), .O(new_n118_));
  aoi21  g77(.a(new_n92_), .b(new_n117_), .c(new_n118_), .O(z19));
endmodule
