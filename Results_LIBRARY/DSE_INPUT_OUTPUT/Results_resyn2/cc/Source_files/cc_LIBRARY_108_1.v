...
module FAU ( 
  ...
  nand4  g05(.a(x15), .b(x12), .c(x10), .d(x08), .O(new_n47_));
  ...
  oai21  g29(.a(new_n49_), .b(x15), .c(new_n70_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n69_), .c(x12), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z12));
  oai21  g32(.a(new_n68_), .b(new_n51_), .c(x15), .O(new_n74_));
  ...
  nand3  g37(.a(new_n68_), .b(x12), .c(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n43_), .c(new_n78_), .O(z14));
  ...
  oai21  g43(.a(new_n60_), .b(x14), .c(new_n49_), .O(new_n85_));
  ...
  oai21  g47(.a(new_n49_), .b(x04), .c(x12), .O(new_n89_));
  nor2   g48(.a(x17), .b(new_n51_), .O(new_n90_));
  aoi22  g49(.a(new_n90_), .b(new_n88_), .c(new_n89_), .d(new_n43_), .O(z16));
  oai21  g50(.a(new_n49_), .b(x05), .c(x12), .O(new_n92_));
  nor2   g51(.a(x18), .b(new_n51_), .O(new_n93_));
  aoi22  g52(.a(new_n93_), .b(new_n88_), .c(new_n92_), .d(new_n43_), .O(z17));
  oai21  g53(.a(new_n49_), .b(x06), .c(x12), .O(new_n95_));
  nor2   g54(.a(x19), .b(new_n51_), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n88_), .c(new_n95_), .d(new_n43_), .O(z18));
  inv1   g56(.a(x07), .O(new_n98_));
  nand3  g57(.a(new_n68_), .b(new_n43_), .c(new_n98_), .O(new_n99_));
  ...
  nor2   g62(.a(new_n47_), .b(x14), .O(z03));
  buf    g63(.a(x15), .O(z06));
endmodule
