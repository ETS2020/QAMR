...
module FAU ( 
  ...
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n69_), .c(new_n57_), .O(z12));
  ...
  nand4  g41(.a(new_n48_), .b(new_n53_), .c(x09), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n57_), .O(z14));
  nand2  g43(.a(new_n53_), .b(x03), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n48_), .O(new_n86_));
  oai21  g45(.a(new_n65_), .b(x14), .c(new_n74_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n86_), .c(x09), .O(new_n88_));
  ...
  nand2  g50(.a(new_n53_), .b(x04), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n48_), .O(new_n93_));
  aoi21  g52(.a(new_n74_), .b(new_n63_), .c(new_n72_), .O(new_n94_));
  ...
  nand2  g56(.a(new_n53_), .b(x05), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  inv1   g58(.a(x18), .O(new_n100_));
  aoi21  g59(.a(new_n74_), .b(new_n100_), .c(new_n72_), .O(new_n101_));
  ...
  nand2  g63(.a(new_n53_), .b(x06), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  aoi21  g65(.a(new_n74_), .b(new_n60_), .c(new_n72_), .O(new_n107_));
  ...
  nand2  g69(.a(new_n53_), .b(x07), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n48_), .O(new_n112_));
  aoi21  g71(.a(new_n74_), .b(new_n43_), .c(new_n72_), .O(new_n113_));
