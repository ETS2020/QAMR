...
module FAU ( 
  ...
  inv1   g04(.a(new_n45_), .O(z00));
  nand2  g05(.a(new_n43_), .b(x11), .O(new_n47_));
  ...
  oai21  g10(.a(new_n51_), .b(x14), .c(x12), .O(new_n52_));
  aoi21  g11(.a(new_n52_), .b(new_n42_), .c(new_n44_), .O(z02));
  inv1   g12(.a(x12), .O(new_n54_));
  nand2  g13(.a(new_n47_), .b(new_n54_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(z01), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(z03));
  nor2   g16(.a(x18), .b(x11), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n47_), .b(new_n59_), .O(z05));
  inv1   g19(.a(x15), .O(new_n61_));
  nor2   g20(.a(x18), .b(new_n42_), .O(new_n62_));
  ...
  and2   g28(.a(new_n68_), .b(new_n47_), .O(z10));
  inv1   g29(.a(x14), .O(new_n71_));
  nor2   g30(.a(new_n62_), .b(new_n71_), .O(z11));
  inv1   g31(.a(x00), .O(new_n73_));
  nand2  g32(.a(new_n51_), .b(new_n73_), .O(new_n74_));
  aoi21  g33(.a(new_n43_), .b(x11), .c(new_n54_), .O(new_n75_));
  ...
  oai21  g41(.a(new_n50_), .b(new_n82_), .c(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n48_), .c(new_n81_), .O(z13));
  nand3  g43(.a(x10), .b(x08), .c(x02), .O(new_n85_));
  nand3  g44(.a(new_n48_), .b(new_n47_), .c(x12), .O(new_n86_));
  aoi21  g45(.a(new_n85_), .b(new_n61_), .c(new_n86_), .O(z14));
  inv1   g46(.a(new_n55_), .O(new_n88_));
  nand3  g47(.a(new_n77_), .b(x16), .c(new_n71_), .O(new_n89_));
  aoi21  g48(.a(new_n51_), .b(x03), .c(new_n62_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(z15));
  inv1   g50(.a(x04), .O(new_n92_));
  nand2  g51(.a(new_n51_), .b(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n77_), .b(new_n64_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n47_), .O(z16));
  inv1   g55(.a(x05), .O(new_n97_));
  nand2  g56(.a(new_n51_), .b(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n77_), .b(new_n43_), .O(new_n99_));
  ...
  nand2  g62(.a(new_n77_), .b(new_n59_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n75_), .O(new_n105_));
  ...
  nand2  g70(.a(new_n111_), .b(new_n47_), .O(z19));
endmodule
