...
module FAU ( 
  ...
  nand2  g16(.a(new_n57_), .b(new_n50_), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n44_), .c(new_n43_), .O(z03));
  ...
  oai21  g35(.a(new_n57_), .b(x17), .c(x15), .O(new_n77_));
  ...
  nand3  g47(.a(new_n48_), .b(x16), .c(new_n50_), .O(new_n89_));
  ...
  oai21  g65(.a(new_n61_), .b(new_n52_), .c(new_n44_), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand2  g67(.a(new_n48_), .b(x19), .O(new_n109_));
  nand4  g68(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n110_));
  ...
  nand3  g72(.a(x20), .b(new_n44_), .c(x15), .O(new_n114_));
  inv1   g73(.a(x07), .O(new_n115_));
  nand3  g74(.a(x10), .b(x08), .c(new_n115_), .O(new_n116_));
  inv1   g75(.a(x20), .O(new_n117_));
  nand2  g76(.a(new_n48_), .b(new_n117_), .O(new_n118_));
  nand3  g77(.a(new_n118_), .b(new_n116_), .c(new_n43_), .O(new_n119_));
  aoi21  g78(.a(new_n119_), .b(new_n114_), .c(new_n52_), .O(z19));
  buf    g79(.a(x15), .O(z06));
  buf    g80(.a(x17), .O(z07));
endmodule
