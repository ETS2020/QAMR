...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n63_, new_n64_, new_n67_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  aoi21  g13(.a(x18), .b(new_n44_), .c(new_n54_), .O(new_n55_));
  ...
  inv1   g35(.a(new_n55_), .O(new_n77_));
  inv1   g36(.a(x01), .O(new_n78_));
  nand2  g37(.a(x10), .b(x08), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n48_), .c(new_n77_), .O(z13));
  inv1   g40(.a(x02), .O(new_n82_));
  oai21  g41(.a(new_n79_), .b(new_n82_), .c(new_n52_), .O(new_n83_));
  ...
  aoi21  g51(.a(new_n53_), .b(new_n92_), .c(x04), .O(new_n93_));
  oai21  g52(.a(new_n79_), .b(x15), .c(new_n63_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x12), .O(new_n95_));
  nor2   g54(.a(new_n95_), .b(new_n93_), .O(z16));
  nand2  g55(.a(new_n53_), .b(new_n92_), .O(new_n97_));
  inv1   g56(.a(x05), .O(new_n98_));
  nand4  g57(.a(new_n52_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n97_), .c(new_n55_), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z17));
  inv1   g60(.a(x06), .O(new_n102_));
  nand4  g61(.a(new_n52_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n53_), .b(new_n60_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n55_), .O(new_n105_));
  ...
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n55_), .O(new_n110_));
