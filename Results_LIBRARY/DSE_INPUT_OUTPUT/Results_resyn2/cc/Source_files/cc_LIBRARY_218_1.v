...
module FAU ( 
  ...
  inv1   g21(.a(new_n54_), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n43_), .O(z08));
  nand3  g24(.a(new_n44_), .b(x09), .c(x08), .O(z10));
  inv1   g25(.a(z10), .O(z09));
  nor2   g26(.a(new_n59_), .b(new_n55_), .O(z11));
  inv1   g27(.a(x00), .O(new_n69_));
  inv1   g28(.a(x15), .O(new_n70_));
  nand3  g29(.a(new_n56_), .b(new_n70_), .c(new_n69_), .O(new_n71_));
  aoi21  g30(.a(x17), .b(new_n43_), .c(new_n50_), .O(new_n72_));
  ...
  nand2  g41(.a(new_n56_), .b(x02), .O(new_n83_));
  nand3  g42(.a(new_n46_), .b(new_n44_), .c(x12), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n70_), .c(new_n84_), .O(z14));
  nand3  g44(.a(new_n74_), .b(x16), .c(new_n55_), .O(new_n86_));
  nand3  g45(.a(new_n49_), .b(new_n44_), .c(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n50_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand3  g48(.a(new_n56_), .b(new_n70_), .c(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n74_), .b(new_n64_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n72_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand3  g53(.a(new_n56_), .b(new_n70_), .c(new_n94_), .O(new_n95_));
  inv1   g54(.a(x18), .O(new_n96_));
  nand2  g55(.a(new_n74_), .b(new_n96_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n72_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand3  g59(.a(new_n56_), .b(new_n70_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n74_), .b(new_n61_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n56_), .b(new_n70_), .c(new_n105_), .O(new_n106_));
  inv1   g65(.a(x20), .O(new_n107_));
  nand2  g66(.a(new_n74_), .b(new_n107_), .O(new_n108_));
