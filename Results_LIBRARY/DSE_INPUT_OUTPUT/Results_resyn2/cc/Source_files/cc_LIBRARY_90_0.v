...
module FAU ( 
  ...
  nor2   g02(.a(x19), .b(x14), .O(new_n44_));
  inv1   g03(.a(new_n44_), .O(new_n45_));
  oai21  g04(.a(new_n43_), .b(new_n42_), .c(new_n45_), .O(z00));
  nand3  g05(.a(x15), .b(x10), .c(x08), .O(new_n47_));
  aoi21  g06(.a(new_n47_), .b(x19), .c(x14), .O(z01));
  ...
  nand3  g27(.a(new_n68_), .b(new_n59_), .c(new_n67_), .O(new_n69_));
  ...
  aoi21  g38(.a(new_n68_), .b(x02), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n47_), .b(x12), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(z14));
  inv1   g41(.a(x12), .O(new_n83_));
  nand4  g42(.a(new_n71_), .b(x19), .c(x16), .d(new_n49_), .O(new_n84_));
  nand3  g43(.a(new_n51_), .b(new_n45_), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z15));
  inv1   g45(.a(x04), .O(new_n87_));
  nand3  g46(.a(new_n68_), .b(new_n59_), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(new_n71_), .b(new_n61_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n45_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand3  g51(.a(new_n68_), .b(new_n59_), .c(new_n92_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  nand2  g53(.a(new_n71_), .b(new_n94_), .O(new_n95_));
  nor2   g54(.a(new_n44_), .b(new_n83_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z17));
  inv1   g57(.a(x19), .O(new_n99_));
  nand2  g58(.a(new_n51_), .b(x14), .O(new_n100_));
  inv1   g59(.a(x06), .O(new_n101_));
  nand4  g60(.a(new_n59_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x12), .O(new_n103_));
  aoi21  g62(.a(new_n100_), .b(new_n99_), .c(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n68_), .b(new_n59_), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n71_), .b(new_n43_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n96_), .O(new_n108_));
