...
module FAU ( 
  ...
  oai21  g39(.a(new_n73_), .b(new_n80_), .c(new_n54_), .O(new_n81_));
  ...
  aoi21  g57(.a(new_n55_), .b(new_n44_), .c(new_n98_), .O(z18));
  inv1   g58(.a(x12), .O(new_n100_));
  aoi21  g59(.a(x19), .b(new_n47_), .c(new_n100_), .O(new_n101_));
