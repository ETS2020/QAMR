...
module FAU ( 
  ...
  nor2   g02(.a(x19), .b(x04), .O(new_n44_));
  ...
  aoi21  g29(.a(new_n52_), .b(new_n70_), .c(new_n55_), .O(new_n71_));
  ...
  oai21  g40(.a(new_n75_), .b(new_n81_), .c(new_n51_), .O(new_n82_));
  ...
  aoi21  g67(.a(new_n52_), .b(new_n43_), .c(new_n55_), .O(new_n109_));
