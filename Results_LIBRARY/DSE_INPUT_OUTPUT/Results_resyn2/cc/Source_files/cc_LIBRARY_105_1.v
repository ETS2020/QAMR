...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x11), .c(new_n45_), .O(z01));
  nand3  g09(.a(new_n45_), .b(x12), .c(new_n42_), .O(new_n51_));
  aoi21  g10(.a(new_n47_), .b(new_n46_), .c(new_n51_), .O(z02));
  nand3  g11(.a(x12), .b(x10), .c(x08), .O(new_n53_));
  inv1   g12(.a(new_n53_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n46_), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(x11), .c(new_n45_), .O(z03));
  nand2  g15(.a(x15), .b(new_n42_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  inv1   g18(.a(new_n57_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n59_), .O(z05));
  nor2   g20(.a(new_n45_), .b(new_n42_), .O(z06));
  ...
  oai21  g36(.a(new_n54_), .b(new_n42_), .c(x15), .O(new_n78_));
  ...
  nand2  g41(.a(z06), .b(new_n47_), .O(new_n83_));
  nor2   g42(.a(new_n47_), .b(x15), .O(new_n84_));
  ...
  nand3  g46(.a(new_n45_), .b(x10), .c(x08), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n57_), .c(x16), .d(new_n46_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n82_), .O(z15));
  oai21  g49(.a(new_n63_), .b(new_n82_), .c(x11), .O(new_n91_));
  ...
  nand3  g61(.a(new_n102_), .b(new_n100_), .c(new_n45_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n98_), .c(new_n82_), .O(z17));
  nand2  g63(.a(z06), .b(x19), .O(new_n105_));
  inv1   g64(.a(x06), .O(new_n106_));
  nand3  g65(.a(x10), .b(x08), .c(new_n106_), .O(new_n107_));
  nand2  g66(.a(new_n47_), .b(new_n59_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n45_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n105_), .c(new_n82_), .O(z18));
  oai21  g69(.a(new_n43_), .b(new_n82_), .c(x11), .O(new_n111_));
