...
module FAU ( 
  ...
  oai21  g28(.a(new_n49_), .b(new_n69_), .c(x12), .O(new_n70_));
  ...
  aoi21  g39(.a(new_n79_), .b(new_n68_), .c(new_n80_), .O(z14));
  inv1   g40(.a(x03), .O(new_n82_));
  oai21  g41(.a(new_n49_), .b(new_n82_), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  nand4  g43(.a(new_n72_), .b(x16), .c(new_n66_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z15));
  inv1   g45(.a(x04), .O(new_n87_));
  oai21  g46(.a(new_n49_), .b(new_n87_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n68_), .O(new_n89_));
  nand3  g48(.a(new_n72_), .b(x17), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  oai21  g51(.a(new_n49_), .b(new_n92_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n68_), .O(new_n94_));
  nand3  g53(.a(new_n72_), .b(x18), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  nand4  g56(.a(new_n68_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  ...
  nand3  g63(.a(new_n72_), .b(x20), .c(x12), .O(new_n105_));
