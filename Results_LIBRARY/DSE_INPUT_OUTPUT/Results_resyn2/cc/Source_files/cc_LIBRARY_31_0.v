...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n59_, new_n60_, new_n62_, new_n65_, new_n67_, new_n69_, new_n73_,
  ...
  nand2  g15(.a(new_n45_), .b(x14), .O(new_n57_));
  nand2  g16(.a(new_n47_), .b(new_n45_), .O(new_n58_));
  nand2  g17(.a(new_n45_), .b(new_n53_), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z03));
  nor2   g20(.a(x19), .b(x03), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(x18), .O(z04));
  nor2   g22(.a(new_n62_), .b(new_n50_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nor2   g24(.a(new_n62_), .b(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n45_), .b(new_n67_), .O(z08));
  nand2  g27(.a(x09), .b(x08), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n62_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n62_), .O(z10));
  inv1   g30(.a(new_n57_), .O(z11));
  inv1   g31(.a(x00), .O(new_n73_));
  nand4  g32(.a(new_n50_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nand2  g34(.a(new_n51_), .b(new_n75_), .O(new_n76_));
  nor2   g35(.a(new_n62_), .b(new_n53_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z12));
  nand2  g38(.a(new_n47_), .b(new_n49_), .O(new_n80_));
  nand4  g39(.a(new_n50_), .b(x10), .c(x08), .d(x01), .O(new_n81_));
  ...
  nand4  g46(.a(new_n50_), .b(x10), .c(x08), .d(new_n43_), .O(new_n88_));
  nand2  g47(.a(x16), .b(new_n49_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n51_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n88_), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n45_), .O(z15));
  inv1   g51(.a(x04), .O(new_n93_));
  nand4  g52(.a(new_n50_), .b(x10), .c(x08), .d(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n51_), .b(new_n65_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n77_), .O(new_n96_));
