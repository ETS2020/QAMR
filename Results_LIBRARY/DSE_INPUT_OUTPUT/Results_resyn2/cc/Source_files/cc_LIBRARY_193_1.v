...
module FAU ( 
  ...
  nand2  g06(.a(x09), .b(x08), .O(new_n48_));
  inv1   g07(.a(x14), .O(new_n49_));
  nand3  g08(.a(x15), .b(new_n49_), .c(x10), .O(new_n50_));
  ...
  nor3   g16(.a(new_n50_), .b(new_n48_), .c(new_n57_), .O(z03));
  ...
  oai21  g58(.a(new_n60_), .b(new_n57_), .c(x09), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x15), .O(new_n101_));
  nand2  g60(.a(new_n70_), .b(x19), .O(new_n102_));
  nand4  g61(.a(new_n53_), .b(x10), .c(x08), .d(x06), .O(new_n103_));
  ...
  nand3  g65(.a(x20), .b(x15), .c(x09), .O(new_n107_));
  inv1   g66(.a(x07), .O(new_n108_));
  nand3  g67(.a(x10), .b(x08), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n70_), .b(new_n43_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(new_n53_), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n107_), .c(new_n57_), .O(z19));
  buf    g71(.a(x15), .O(z06));
endmodule
