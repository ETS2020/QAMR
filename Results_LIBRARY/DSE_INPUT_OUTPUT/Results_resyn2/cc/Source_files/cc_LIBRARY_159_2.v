...
module FAU ( 
  ...
  nand4  g43(.a(new_n72_), .b(x20), .c(x16), .d(new_n46_), .O(new_n85_));
  nand4  g44(.a(new_n81_), .b(new_n44_), .c(new_n61_), .d(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n53_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand2  g47(.a(new_n52_), .b(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n72_), .b(new_n63_), .O(new_n90_));
  aoi21  g49(.a(new_n43_), .b(x16), .c(new_n53_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  ...
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n91_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand2  g59(.a(new_n52_), .b(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n72_), .b(new_n59_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(z18));
  oai21  g63(.a(new_n51_), .b(x15), .c(x20), .O(new_n105_));
  nand4  g64(.a(new_n61_), .b(x10), .c(x08), .d(x07), .O(new_n106_));
