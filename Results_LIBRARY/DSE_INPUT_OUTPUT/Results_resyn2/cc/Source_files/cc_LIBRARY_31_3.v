...
module FAU ( 
  ...
  nand2  g02(.a(x19), .b(x03), .O(new_n44_));
  ...
  oai21  g13(.a(new_n54_), .b(x12), .c(z01), .O(new_n55_));
  inv1   g14(.a(new_n55_), .O(z03));
  nor2   g15(.a(new_n54_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(x03), .O(z05));
  nor2   g18(.a(new_n54_), .b(new_n49_), .O(z06));
  inv1   g19(.a(x17), .O(new_n61_));
  nor2   g20(.a(new_n54_), .b(new_n61_), .O(z07));
  inv1   g21(.a(x16), .O(new_n63_));
  nand2  g22(.a(new_n44_), .b(new_n63_), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n54_), .O(z09));
  and2   g25(.a(new_n65_), .b(new_n44_), .O(z10));
  nor2   g26(.a(new_n54_), .b(new_n48_), .O(z11));
  ...
  nand4  g31(.a(new_n72_), .b(new_n70_), .c(new_n44_), .d(x12), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z12));
  and2   g33(.a(new_n46_), .b(new_n48_), .O(new_n75_));
  inv1   g34(.a(x01), .O(new_n76_));
  oai21  g35(.a(new_n50_), .b(new_n76_), .c(x12), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n44_), .O(z13));
  ...
  nand4  g41(.a(new_n49_), .b(x12), .c(x10), .d(x08), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n58_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x03), .O(new_n85_));
  nand4  g44(.a(new_n50_), .b(x16), .c(new_n48_), .d(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n49_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n50_), .b(new_n61_), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(new_n89_), .c(new_n44_), .d(x12), .O(new_n91_));
  ...
  nand2  g59(.a(new_n50_), .b(new_n58_), .O(new_n101_));
  ...
  nand2  g64(.a(new_n50_), .b(new_n43_), .O(new_n106_));
