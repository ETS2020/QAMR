...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n56_, new_n59_, new_n66_,
  ...
  nand2  g02(.a(x18), .b(x17), .O(new_n44_));
  ...
  nor2   g23(.a(new_n46_), .b(new_n47_), .O(z11));
  aoi21  g24(.a(x18), .b(x17), .c(new_n56_), .O(new_n66_));
  inv1   g25(.a(x00), .O(new_n67_));
  nand4  g26(.a(new_n52_), .b(x10), .c(x08), .d(new_n67_), .O(new_n68_));
  inv1   g27(.a(x13), .O(new_n69_));
  nand2  g28(.a(x10), .b(x08), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(x15), .c(new_n69_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n68_), .c(new_n66_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z12));
  nand2  g32(.a(new_n44_), .b(x12), .O(new_n74_));
  inv1   g33(.a(x01), .O(new_n75_));
  oai21  g34(.a(new_n70_), .b(new_n75_), .c(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n48_), .c(new_n74_), .O(z13));
  inv1   g36(.a(x02), .O(new_n78_));
  oai21  g37(.a(new_n70_), .b(new_n78_), .c(new_n52_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n48_), .c(x12), .O(new_n80_));
  ...
  oai21  g56(.a(new_n70_), .b(x15), .c(new_n59_), .O(new_n98_));
  ...
  oai21  g61(.a(new_n70_), .b(x15), .c(new_n43_), .O(new_n103_));
