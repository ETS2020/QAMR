...
module FAU ( 
  ...
  oai21  g16(.a(new_n51_), .b(new_n57_), .c(new_n47_), .O(z03));
  ...
  nand2  g27(.a(new_n47_), .b(new_n48_), .O(z11));
  inv1   g28(.a(x15), .O(new_n70_));
  nand2  g29(.a(x12), .b(x00), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n53_), .c(new_n44_), .O(new_n72_));
  ...
  aoi21  g37(.a(new_n78_), .b(x14), .c(new_n50_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n57_), .c(new_n47_), .O(z13));
  aoi21  g39(.a(new_n74_), .b(x02), .c(x15), .O(new_n81_));
  nand2  g40(.a(new_n49_), .b(x12), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n47_), .O(z14));
  nand2  g42(.a(x12), .b(x03), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n53_), .c(new_n44_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n70_), .O(new_n86_));
  nand4  g45(.a(new_n75_), .b(x16), .c(new_n48_), .d(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(z15));
  aoi21  g47(.a(new_n53_), .b(new_n44_), .c(x15), .O(new_n89_));
  nor3   g48(.a(new_n89_), .b(new_n62_), .c(new_n57_), .O(z16));
  nand2  g49(.a(x18), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n70_), .b(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n74_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  aoi21  g53(.a(new_n53_), .b(new_n94_), .c(x04), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n91_), .c(new_n57_), .O(z17));
  nand2  g56(.a(x19), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n70_), .b(x06), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n74_), .O(new_n100_));
  aoi21  g59(.a(new_n53_), .b(new_n60_), .c(x04), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n98_), .c(new_n57_), .O(z18));
  nand2  g62(.a(x20), .b(x15), .O(new_n104_));
  nand2  g63(.a(new_n70_), .b(x07), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n74_), .O(new_n106_));
  aoi21  g65(.a(new_n53_), .b(new_n43_), .c(x04), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n104_), .c(new_n57_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
