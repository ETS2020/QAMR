...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n55_, new_n56_, new_n57_, new_n60_,
  ...
  aoi21  g09(.a(new_n50_), .b(new_n47_), .c(new_n48_), .O(z01));
  ...
  nor2   g14(.a(new_n48_), .b(x00), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n49_), .O(new_n57_));
  ...
  nand2  g37(.a(new_n56_), .b(new_n78_), .O(new_n79_));
  nor2   g38(.a(new_n78_), .b(x15), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n77_), .O(z14));
  nand2  g41(.a(new_n80_), .b(x03), .O(new_n83_));
  nand4  g42(.a(new_n52_), .b(new_n44_), .c(x16), .d(new_n49_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n77_), .O(z15));
  nand2  g44(.a(new_n56_), .b(x17), .O(new_n86_));
  inv1   g45(.a(x04), .O(new_n87_));
  nand3  g46(.a(x10), .b(x08), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(new_n78_), .b(new_n62_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n86_), .c(new_n77_), .O(z16));
  ...
  nand2  g54(.a(new_n78_), .b(new_n95_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(new_n48_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n92_), .c(new_n77_), .O(z17));
  oai21  g57(.a(new_n60_), .b(new_n77_), .c(new_n47_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n78_), .b(x19), .O(new_n101_));
  ...
  nand2  g64(.a(new_n56_), .b(x20), .O(new_n106_));
  inv1   g65(.a(x07), .O(new_n107_));
  nand3  g66(.a(x10), .b(x08), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n78_), .b(new_n43_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n48_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n106_), .c(new_n77_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
