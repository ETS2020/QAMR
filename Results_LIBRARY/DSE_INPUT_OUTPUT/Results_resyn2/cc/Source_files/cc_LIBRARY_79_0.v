...
module FAU ( 
  ...
  nor3   g16(.a(new_n57_), .b(new_n44_), .c(new_n56_), .O(z03));
  nor2   g17(.a(new_n44_), .b(x18), .O(z04));
  nor2   g18(.a(new_n44_), .b(new_n56_), .O(z06));
  ...
  aoi21  g44(.a(new_n47_), .b(new_n46_), .c(new_n85_), .O(new_n86_));
  ...
  nand4  g56(.a(new_n56_), .b(x10), .c(x08), .d(new_n46_), .O(new_n98_));
  oai21  g57(.a(new_n52_), .b(x15), .c(new_n47_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z18));
  inv1   g60(.a(x07), .O(new_n102_));
  nand4  g61(.a(new_n56_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
