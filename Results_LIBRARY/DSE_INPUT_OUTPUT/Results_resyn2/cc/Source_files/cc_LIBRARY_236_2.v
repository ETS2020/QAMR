...
module FAU ( 
  ...
  nor2   g03(.a(x15), .b(new_n42_), .O(new_n45_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n46_), .O(z14));
  nand2  g40(.a(x12), .b(x03), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n68_), .c(new_n42_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n50_), .O(new_n84_));
  nand2  g43(.a(x16), .b(new_n49_), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n72_), .c(new_n84_), .O(z15));
  nand2  g45(.a(x12), .b(x04), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n68_), .c(new_n42_), .O(new_n88_));
  ...
  nand2  g50(.a(new_n50_), .b(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n51_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  aoi21  g53(.a(new_n68_), .b(new_n94_), .c(x11), .O(new_n95_));
  ...
  oai21  g57(.a(new_n98_), .b(new_n68_), .c(new_n42_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n50_), .O(new_n100_));
  oai21  g59(.a(new_n72_), .b(new_n58_), .c(new_n100_), .O(z18));
  nand2  g60(.a(x12), .b(x07), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n68_), .c(new_n42_), .O(new_n103_));
