...
module FAU ( 
  ...
  inv1   g15(.a(z01), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n53_), .O(z03));
  ...
  nor2   g28(.a(x18), .b(new_n42_), .O(z11));
  ...
  aoi21  g33(.a(x18), .b(x14), .c(new_n53_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z12));
  nand4  g36(.a(new_n50_), .b(x10), .c(x08), .d(x01), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(z11), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n57_), .c(new_n53_), .O(z13));
  ...
  nand2  g53(.a(new_n94_), .b(new_n49_), .O(z16));
  ...
  nand4  g60(.a(new_n50_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n51_), .b(new_n60_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n49_), .O(z18));
  ...
  nand2  g69(.a(new_n110_), .b(new_n49_), .O(z19));
endmodule
