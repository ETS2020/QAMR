...
module FAU ( 
  ...
  nand2  g03(.a(new_n43_), .b(x19), .O(new_n45_));
  ...
  aoi21  g12(.a(new_n43_), .b(x19), .c(new_n53_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n42_), .O(new_n55_));
  aoi21  g14(.a(new_n52_), .b(new_n46_), .c(new_n55_), .O(z02));
  inv1   g15(.a(new_n54_), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n49_), .O(z03));
  ...
  nand2  g42(.a(new_n54_), .b(new_n47_), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n51_), .c(new_n84_), .O(z14));
  nand3  g44(.a(new_n52_), .b(x16), .c(new_n46_), .O(new_n86_));
  nand2  g45(.a(x10), .b(x08), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(x15), .O(new_n88_));
