...
module FAU ( 
  ...
  nor2   g27(.a(new_n47_), .b(new_n48_), .O(z11));
  aoi21  g28(.a(x18), .b(new_n44_), .c(new_n57_), .O(new_n70_));
  ...
  nand3  g41(.a(new_n49_), .b(new_n45_), .c(x12), .O(new_n83_));
  ...
  aoi22  g53(.a(new_n94_), .b(new_n93_), .c(new_n57_), .d(x05), .O(z17));
  inv1   g54(.a(x06), .O(new_n96_));
  nand4  g55(.a(new_n53_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  oai21  g56(.a(new_n74_), .b(x15), .c(new_n60_), .O(new_n98_));
