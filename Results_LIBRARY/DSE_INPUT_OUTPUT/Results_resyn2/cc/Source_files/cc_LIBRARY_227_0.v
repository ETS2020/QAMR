...
module FAU ( 
  ...
  oai21  g36(.a(new_n73_), .b(new_n77_), .c(x02), .O(new_n78_));
  nand2  g37(.a(new_n47_), .b(new_n49_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  aoi21  g39(.a(new_n78_), .b(new_n50_), .c(new_n80_), .O(z13));
  nor2   g40(.a(new_n51_), .b(x15), .O(new_n82_));
  ...
  nand4  g46(.a(new_n52_), .b(x16), .c(new_n49_), .d(x12), .O(new_n88_));
  ...
  nand2  g54(.a(new_n50_), .b(x05), .O(new_n96_));
  ...
  oai21  g63(.a(new_n93_), .b(new_n58_), .c(new_n104_), .O(z18));
  nand2  g64(.a(x20), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n50_), .b(x07), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n51_), .O(new_n108_));
  aoi21  g67(.a(new_n73_), .b(new_n43_), .c(new_n71_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n106_), .c(new_n55_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
