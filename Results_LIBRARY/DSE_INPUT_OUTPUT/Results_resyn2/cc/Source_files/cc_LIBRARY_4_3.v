...
module FAU ( 
  ...
  aoi21  g13(.a(x19), .b(x06), .c(new_n54_), .O(new_n55_));
  ...
  nor2   g25(.a(new_n46_), .b(new_n47_), .O(z11));
  inv1   g26(.a(x00), .O(new_n68_));
  and2   g27(.a(x10), .b(x08), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(new_n52_), .c(new_n68_), .O(new_n70_));
  inv1   g29(.a(x13), .O(new_n71_));
  nand2  g30(.a(new_n53_), .b(new_n71_), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(new_n70_), .c(new_n55_), .O(new_n73_));
  ...
  aoi21  g38(.a(new_n69_), .b(x02), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n55_), .b(new_n48_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z14));
  inv1   g41(.a(x03), .O(new_n83_));
  nand3  g42(.a(new_n69_), .b(new_n52_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g48(.a(new_n69_), .b(new_n52_), .c(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n53_), .b(new_n61_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n55_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand3  g53(.a(new_n69_), .b(new_n52_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g60(.a(new_n69_), .b(new_n52_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n53_), .b(x12), .O(new_n103_));
  aoi22  g62(.a(new_n103_), .b(new_n100_), .c(new_n102_), .d(new_n101_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n69_), .b(new_n52_), .c(new_n105_), .O(new_n106_));
