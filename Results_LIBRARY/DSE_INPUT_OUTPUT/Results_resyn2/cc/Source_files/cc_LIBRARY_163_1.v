...
module FAU ( 
  ...
  nand2  g03(.a(x05), .b(new_n44_), .O(new_n45_));
  ...
  aoi21  g13(.a(x05), .b(new_n44_), .c(new_n54_), .O(new_n55_));
  ...
  nand3  g31(.a(new_n72_), .b(new_n52_), .c(new_n44_), .O(new_n73_));
  ...
  aoi21  g40(.a(new_n72_), .b(x02), .c(x15), .O(new_n82_));
  nand2  g41(.a(new_n55_), .b(new_n48_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z14));
  nand3  g43(.a(new_n53_), .b(x16), .c(new_n47_), .O(new_n85_));
  nand3  g44(.a(new_n72_), .b(new_n52_), .c(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n78_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand3  g47(.a(new_n72_), .b(new_n52_), .c(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n53_), .b(new_n64_), .O(new_n90_));
  ...
  nand2  g53(.a(new_n94_), .b(x05), .O(new_n95_));
  nand3  g54(.a(new_n53_), .b(x18), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n95_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand3  g57(.a(new_n72_), .b(new_n52_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n53_), .b(new_n61_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n55_), .O(new_n101_));
