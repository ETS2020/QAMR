...
module FAU ( 
  ...
  nand3  g12(.a(new_n48_), .b(x12), .c(new_n42_), .O(new_n54_));
  aoi21  g13(.a(new_n53_), .b(new_n51_), .c(new_n54_), .O(z02));
  nand4  g14(.a(new_n51_), .b(x12), .c(x10), .d(x08), .O(new_n56_));
  nor3   g15(.a(new_n56_), .b(new_n45_), .c(new_n52_), .O(z03));
  nor2   g16(.a(x18), .b(x05), .O(z04));
  ...
  and2   g26(.a(new_n66_), .b(new_n48_), .O(z10));
  nand2  g27(.a(new_n48_), .b(new_n51_), .O(z11));
  inv1   g28(.a(x12), .O(new_n70_));
  aoi21  g29(.a(new_n47_), .b(x05), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g34(.a(new_n75_), .b(x15), .c(new_n74_), .O(new_n76_));
  ...
  oai21  g39(.a(new_n75_), .b(new_n80_), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n49_), .c(new_n79_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n75_), .b(new_n83_), .c(new_n52_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n49_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n48_), .O(z14));
  nand3  g45(.a(new_n53_), .b(x16), .c(new_n51_), .O(new_n87_));
  ...
  oai21  g50(.a(new_n75_), .b(x15), .c(new_n62_), .O(new_n92_));
  ...
  aoi21  g55(.a(new_n95_), .b(new_n44_), .c(new_n96_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n52_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  oai21  g58(.a(new_n75_), .b(x15), .c(new_n59_), .O(new_n100_));
  ...
  oai21  g63(.a(new_n75_), .b(x15), .c(new_n43_), .O(new_n105_));
