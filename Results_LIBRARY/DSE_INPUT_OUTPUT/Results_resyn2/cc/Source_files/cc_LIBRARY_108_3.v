...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n58_, new_n65_, new_n66_,
  ...
  nand2  g10(.a(new_n46_), .b(new_n48_), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(new_n42_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n51_), .c(new_n47_), .O(z02));
  ...
  nand3  g19(.a(new_n44_), .b(x09), .c(x08), .O(z10));
  inv1   g20(.a(z10), .O(z09));
  nand2  g21(.a(new_n44_), .b(new_n48_), .O(z11));
  inv1   g22(.a(x00), .O(new_n65_));
  nand3  g23(.a(x10), .b(x08), .c(new_n65_), .O(new_n66_));
  inv1   g24(.a(x13), .O(new_n67_));
  nand2  g25(.a(new_n46_), .b(new_n67_), .O(new_n68_));
  nor2   g26(.a(x15), .b(new_n47_), .O(new_n69_));
  nand3  g27(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(new_n70_));
  inv1   g28(.a(new_n70_), .O(z12));
  inv1   g29(.a(x01), .O(new_n72_));
  oai21  g30(.a(new_n46_), .b(new_n72_), .c(x14), .O(new_n73_));
  aoi21  g31(.a(new_n73_), .b(new_n51_), .c(new_n47_), .O(z13));
  nand3  g32(.a(x10), .b(x08), .c(x02), .O(new_n75_));
  aoi21  g33(.a(new_n75_), .b(new_n51_), .c(new_n47_), .O(z14));
  nand3  g34(.a(new_n46_), .b(x16), .c(new_n48_), .O(new_n77_));
  nand3  g35(.a(x10), .b(x08), .c(x03), .O(new_n78_));
  and2   g36(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  aoi21  g37(.a(new_n79_), .b(new_n77_), .c(new_n47_), .O(z15));
  nand3  g38(.a(x10), .b(x08), .c(x04), .O(new_n81_));
  aoi21  g39(.a(new_n46_), .b(x17), .c(x15), .O(new_n82_));
  aoi21  g40(.a(new_n82_), .b(new_n81_), .c(new_n47_), .O(z16));
  nand3  g41(.a(x10), .b(x08), .c(x05), .O(new_n84_));
  aoi21  g42(.a(new_n46_), .b(x18), .c(x15), .O(new_n85_));
  aoi21  g43(.a(new_n85_), .b(new_n84_), .c(new_n47_), .O(z17));
  nand3  g44(.a(x10), .b(x08), .c(x06), .O(new_n87_));
  aoi21  g45(.a(new_n46_), .b(x19), .c(x15), .O(new_n88_));
  aoi21  g46(.a(new_n88_), .b(new_n87_), .c(new_n47_), .O(z18));
  inv1   g47(.a(x07), .O(new_n90_));
  nand3  g48(.a(x10), .b(x08), .c(new_n90_), .O(new_n91_));
  nand2  g49(.a(new_n46_), .b(new_n43_), .O(new_n92_));
  nand3  g50(.a(new_n92_), .b(new_n91_), .c(new_n69_), .O(new_n93_));
  inv1   g51(.a(new_n93_), .O(z19));
  zero   g52(.O(z03));
  buf    g53(.a(x15), .O(z06));
endmodule
