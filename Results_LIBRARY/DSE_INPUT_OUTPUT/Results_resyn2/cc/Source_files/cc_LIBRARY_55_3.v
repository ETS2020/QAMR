...
module FAU ( 
  ...
  nor2   g21(.a(new_n62_), .b(z03), .O(z09));
  and2   g22(.a(new_n62_), .b(new_n42_), .O(z10));
  ...
  nor2   g28(.a(x15), .b(new_n46_), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z12));
  inv1   g31(.a(x01), .O(new_n73_));
  oai21  g32(.a(new_n52_), .b(new_n73_), .c(x14), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n47_), .c(new_n46_), .O(z13));
  nand3  g34(.a(x10), .b(x08), .c(x02), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n47_), .c(new_n46_), .O(z14));
  nand3  g36(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n78_));
  nand3  g37(.a(x10), .b(x08), .c(x03), .O(new_n79_));
  and2   g38(.a(new_n79_), .b(new_n47_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n46_), .O(z15));
  inv1   g40(.a(x04), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(new_n82_), .O(new_n83_));
  nand2  g42(.a(new_n52_), .b(new_n58_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(new_n70_), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z16));
  nand3  g45(.a(x10), .b(x08), .c(x05), .O(new_n87_));
  aoi21  g46(.a(new_n52_), .b(x18), .c(x15), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(z17));
  nand3  g48(.a(x10), .b(x08), .c(x06), .O(new_n90_));
  aoi21  g49(.a(new_n52_), .b(x19), .c(x15), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(z18));
  nand3  g51(.a(x10), .b(x08), .c(x07), .O(new_n93_));
  aoi21  g52(.a(new_n52_), .b(x20), .c(x15), .O(new_n94_));
