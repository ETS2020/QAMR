...
module FAU ( 
  ...
  aoi21  g31(.a(x18), .b(x05), .c(new_n56_), .O(new_n73_));
  inv1   g32(.a(x13), .O(new_n74_));
  oai21  g33(.a(new_n52_), .b(x15), .c(new_n74_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z12));
  nand2  g36(.a(new_n48_), .b(new_n47_), .O(new_n78_));
  nand4  g37(.a(new_n61_), .b(x10), .c(x08), .d(x01), .O(new_n79_));
  ...
  nand3  g41(.a(new_n48_), .b(new_n44_), .c(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n61_), .c(new_n83_), .O(z14));
  nand2  g43(.a(new_n44_), .b(x12), .O(new_n85_));
  nand3  g44(.a(new_n61_), .b(x10), .c(x08), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x16), .c(new_n47_), .O(new_n87_));
  nand4  g46(.a(new_n61_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  ...
  oai21  g50(.a(new_n52_), .b(x15), .c(new_n63_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n73_), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand4  g54(.a(new_n61_), .b(x12), .c(x10), .d(x08), .O(new_n96_));
  oai21  g55(.a(new_n52_), .b(x15), .c(x12), .O(new_n97_));
  aoi22  g56(.a(new_n97_), .b(new_n95_), .c(new_n96_), .d(z04), .O(z17));
  ...
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n73_), .O(new_n102_));
