...
module FAU ( 
  ...
  nor2   g02(.a(x18), .b(x13), .O(new_n44_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n77_), .c(x14), .O(new_n78_));
  ...
  oai21  g41(.a(new_n70_), .b(new_n82_), .c(new_n50_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n47_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n45_), .O(z14));
  nand3  g44(.a(new_n51_), .b(x16), .c(new_n49_), .O(new_n86_));
  ...
  nand4  g65(.a(new_n106_), .b(new_n105_), .c(new_n45_), .d(x12), .O(new_n107_));
