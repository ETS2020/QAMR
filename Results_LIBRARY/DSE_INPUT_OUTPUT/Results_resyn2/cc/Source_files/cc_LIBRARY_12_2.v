...
module FAU ( 
  ...
  nand2  g29(.a(new_n51_), .b(x00), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n52_), .O(z12));
  oai21  g31(.a(new_n48_), .b(new_n52_), .c(x18), .O(new_n73_));
  ...
  nand2  g41(.a(new_n51_), .b(x03), .O(new_n83_));
  nand4  g42(.a(new_n69_), .b(new_n44_), .c(x16), .d(new_n67_), .O(new_n84_));
  ...
  nand2  g47(.a(new_n48_), .b(new_n60_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n46_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n86_), .c(new_n52_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand4  g51(.a(new_n46_), .b(x10), .c(x08), .d(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n69_), .b(z04), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z17));
  oai21  g55(.a(new_n58_), .b(new_n52_), .c(x18), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n48_), .b(x19), .O(new_n99_));
  nand4  g58(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n100_));
  ...
  nand2  g66(.a(new_n48_), .b(new_n107_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n106_), .c(new_n46_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n104_), .c(new_n52_), .O(z19));
endmodule
