...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n61_, new_n64_, new_n70_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  nor2   g03(.a(z04), .b(x16), .O(new_n45_));
  ...
  nand2  g24(.a(z04), .b(new_n53_), .O(z08));
  ...
  nand2  g49(.a(new_n51_), .b(new_n64_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n51_), .b(z04), .O(new_n96_));
  ...
  nand2  g59(.a(new_n51_), .b(new_n61_), .O(new_n101_));
