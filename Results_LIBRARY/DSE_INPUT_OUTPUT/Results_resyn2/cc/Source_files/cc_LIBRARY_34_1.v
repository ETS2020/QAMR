...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n57_, new_n59_, new_n61_,
  ...
  nor2   g18(.a(new_n44_), .b(new_n59_), .O(z06));
  ...
  oai21  g34(.a(new_n52_), .b(new_n75_), .c(x14), .O(new_n76_));
  nand2  g35(.a(new_n49_), .b(x15), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n59_), .O(z13));
  nand2  g37(.a(new_n49_), .b(x12), .O(new_n79_));
  oai21  g38(.a(new_n52_), .b(new_n59_), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n44_), .b(x02), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n80_), .O(z14));
  nand2  g41(.a(new_n49_), .b(new_n44_), .O(new_n83_));
  nand2  g42(.a(x16), .b(new_n48_), .O(new_n84_));
  inv1   g43(.a(x03), .O(new_n85_));
  nand4  g44(.a(new_n44_), .b(x10), .c(x08), .d(new_n85_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  aoi21  g46(.a(new_n84_), .b(new_n83_), .c(new_n87_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n44_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n52_), .b(x15), .c(new_n61_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand4  g53(.a(new_n44_), .b(x10), .c(x08), .d(new_n94_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n52_), .b(x06), .c(x12), .O(new_n100_));
  nor2   g59(.a(x19), .b(new_n59_), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n83_), .c(new_n100_), .d(new_n44_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand4  g62(.a(new_n44_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
  oai21  g63(.a(new_n52_), .b(x15), .c(new_n43_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(x12), .O(new_n106_));
  inv1   g65(.a(new_n106_), .O(z19));
  aoi21  g66(.a(new_n50_), .b(x12), .c(new_n44_), .O(z03));
endmodule
