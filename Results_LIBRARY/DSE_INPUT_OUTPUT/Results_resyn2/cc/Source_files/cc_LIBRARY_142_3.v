...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n55_, new_n57_, new_n63_, new_n64_, new_n65_,
  ...
  oai21  g22(.a(x15), .b(x10), .c(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(x13), .O(new_n65_));
  nand3  g24(.a(new_n50_), .b(new_n48_), .c(x00), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(z12));
  nand2  g26(.a(new_n50_), .b(x01), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x14), .c(x12), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n44_), .O(z13));
  nand2  g29(.a(new_n50_), .b(x02), .O(new_n71_));
  nand2  g30(.a(new_n44_), .b(x12), .O(new_n72_));
  aoi21  g31(.a(new_n71_), .b(new_n48_), .c(new_n72_), .O(z14));
  nand3  g32(.a(x12), .b(x10), .c(x03), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n48_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x08), .O(new_n76_));
  nand2  g35(.a(new_n49_), .b(x12), .O(new_n77_));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(x16), .b(new_n78_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(z15));
  nand3  g39(.a(x10), .b(x08), .c(x04), .O(new_n81_));
  oai21  g40(.a(new_n57_), .b(x10), .c(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n48_), .O(new_n83_));
  inv1   g42(.a(x08), .O(new_n84_));
  nand2  g43(.a(x17), .b(new_n84_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n63_), .O(z16));
  inv1   g45(.a(x18), .O(new_n87_));
  nand3  g46(.a(x10), .b(x08), .c(x05), .O(new_n88_));
  oai21  g47(.a(new_n87_), .b(x10), .c(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n48_), .O(new_n90_));
  nand2  g49(.a(x18), .b(new_n84_), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n63_), .O(z17));
  nand3  g51(.a(x12), .b(x10), .c(x06), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n48_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x08), .O(new_n95_));
  oai21  g54(.a(new_n77_), .b(new_n55_), .c(new_n95_), .O(z18));
  nand3  g55(.a(x10), .b(x08), .c(x07), .O(new_n97_));
  oai21  g56(.a(new_n43_), .b(x10), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  nand2  g58(.a(x20), .b(new_n84_), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n63_), .O(z19));
  inv1   g60(.a(new_n44_), .O(z03));
  buf    g61(.a(x15), .O(z06));
endmodule
