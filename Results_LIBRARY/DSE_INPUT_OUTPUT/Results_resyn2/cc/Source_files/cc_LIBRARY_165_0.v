...
module FAU ( 
  ...
  nand3  g34(.a(new_n75_), .b(new_n73_), .c(new_n53_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z12));
  nand2  g36(.a(new_n47_), .b(x15), .O(new_n78_));
  inv1   g37(.a(new_n53_), .O(new_n79_));
  inv1   g38(.a(x01), .O(new_n80_));
  oai21  g39(.a(new_n71_), .b(new_n80_), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n78_), .c(new_n79_), .O(z13));
  aoi21  g41(.a(new_n47_), .b(x02), .c(x15), .O(new_n83_));
  nand2  g42(.a(new_n78_), .b(x12), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n56_), .O(z14));
  nand3  g44(.a(new_n51_), .b(x16), .c(new_n46_), .O(new_n86_));
  nand2  g45(.a(new_n72_), .b(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n79_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand2  g48(.a(new_n72_), .b(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n51_), .b(new_n63_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n53_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  inv1   g52(.a(x18), .O(new_n94_));
  nand4  g53(.a(new_n50_), .b(x10), .c(x08), .d(new_n58_), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(x12), .c(new_n94_), .O(new_n96_));
  oai21  g55(.a(new_n71_), .b(x15), .c(new_n94_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x12), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(x05), .c(new_n96_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand2  g59(.a(new_n72_), .b(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n51_), .b(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(new_n53_), .O(new_n103_));
  ...
  nand2  g67(.a(new_n108_), .b(new_n56_), .O(z19));
endmodule
