...
module FAU ( 
  ...
  nor2   g12(.a(new_n47_), .b(x11), .O(new_n54_));
  ...
  oai21  g16(.a(new_n57_), .b(new_n50_), .c(new_n48_), .O(z03));
  nand2  g17(.a(x18), .b(x12), .O(z04));
  ...
  nand2  g42(.a(new_n72_), .b(x02), .O(new_n84_));
  nand2  g43(.a(new_n50_), .b(x12), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n62_), .c(new_n85_), .O(z14));
  nand3  g45(.a(new_n75_), .b(x16), .c(new_n46_), .O(new_n87_));
  nand2  g46(.a(new_n53_), .b(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n47_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand3  g49(.a(new_n72_), .b(new_n62_), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n75_), .b(new_n64_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n48_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand3  g54(.a(new_n72_), .b(new_n62_), .c(new_n95_), .O(new_n96_));
  nand2  g55(.a(new_n75_), .b(new_n42_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n96_), .c(x12), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand3  g59(.a(new_n72_), .b(new_n62_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n75_), .b(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n72_), .b(new_n62_), .c(new_n105_), .O(new_n106_));
  ...
  nand2  g68(.a(new_n109_), .b(new_n48_), .O(z19));
endmodule
