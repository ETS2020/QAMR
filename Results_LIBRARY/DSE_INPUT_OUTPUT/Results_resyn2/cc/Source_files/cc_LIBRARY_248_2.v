...
module FAU ( 
  ...
  aoi21  g14(.a(new_n44_), .b(x16), .c(new_n55_), .O(new_n56_));
  ...
  nor2   g21(.a(new_n46_), .b(new_n53_), .O(z06));
  ...
  nand2  g55(.a(new_n54_), .b(new_n96_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n56_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand2  g59(.a(new_n72_), .b(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n54_), .b(new_n61_), .O(new_n102_));
  ...
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n56_), .O(new_n108_));
