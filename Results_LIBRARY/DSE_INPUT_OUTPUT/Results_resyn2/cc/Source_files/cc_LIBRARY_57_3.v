...
module FAU ( 
  ...
  nor2   g08(.a(new_n45_), .b(x14), .O(z06));
  nand2  g09(.a(z06), .b(new_n49_), .O(new_n51_));
  inv1   g10(.a(new_n51_), .O(z01));
  nand3  g11(.a(new_n45_), .b(x12), .c(new_n42_), .O(new_n53_));
  aoi21  g12(.a(new_n48_), .b(new_n44_), .c(new_n53_), .O(z02));
  nand2  g13(.a(new_n49_), .b(x12), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n44_), .c(new_n45_), .O(z03));
  ...
  nand2  g22(.a(new_n57_), .b(new_n63_), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n46_), .O(z09));
  aoi21  g25(.a(x09), .b(x08), .c(new_n46_), .O(z10));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n51_), .c(new_n76_), .O(z13));
  ...
  nand3  g43(.a(new_n49_), .b(new_n45_), .c(x03), .O(new_n85_));
  nand3  g44(.a(new_n45_), .b(x10), .c(x08), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x16), .c(new_n44_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n76_), .O(z15));
  oai21  g47(.a(new_n61_), .b(new_n76_), .c(new_n44_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand2  g49(.a(new_n48_), .b(x17), .O(new_n91_));
  nand4  g50(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n90_), .O(z16));
  ...
  nand4  g58(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n100_));
  ...
  oai21  g62(.a(new_n59_), .b(new_n76_), .c(new_n44_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x15), .O(new_n105_));
  nand2  g64(.a(new_n48_), .b(x19), .O(new_n106_));
  nand4  g65(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n107_));
  ...
  nand2  g72(.a(new_n48_), .b(new_n43_), .O(new_n114_));
  nand3  g73(.a(new_n114_), .b(new_n113_), .c(new_n45_), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n111_), .c(new_n76_), .O(z19));
  buf    g75(.a(x14), .O(z11));
endmodule
