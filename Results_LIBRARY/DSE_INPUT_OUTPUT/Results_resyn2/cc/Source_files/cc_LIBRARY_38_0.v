...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    ...
    new_n59_, new_n64_, new_n66_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  nor2   g12(.a(x19), .b(x06), .O(new_n54_));
  nor2   g13(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n42_), .O(new_n56_));
  aoi21  g15(.a(new_n52_), .b(new_n50_), .c(new_n56_), .O(z02));
  nand2  g16(.a(new_n46_), .b(new_n53_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(z01), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z03));
  nand2  g19(.a(new_n46_), .b(x18), .O(z04));
  nand2  g20(.a(new_n45_), .b(x06), .O(z05));
  nor2   g21(.a(new_n54_), .b(new_n51_), .O(z06));
  ...
  nor2   g28(.a(new_n54_), .b(new_n50_), .O(z11));
  ...
  nand4  g60(.a(new_n51_), .b(x10), .c(x08), .d(new_n44_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(x12), .c(new_n45_), .O(new_n103_));
  oai21  g62(.a(new_n72_), .b(x15), .c(new_n45_), .O(new_n104_));
