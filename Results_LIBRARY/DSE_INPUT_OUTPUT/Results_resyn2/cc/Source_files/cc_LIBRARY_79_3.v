...
module FAU ( 
  ...
  nor2   g18(.a(new_n59_), .b(x06), .O(z05));
  ...
  aoi21  g39(.a(new_n79_), .b(new_n61_), .c(new_n80_), .O(z14));
  nand3  g40(.a(new_n61_), .b(x10), .c(x08), .O(new_n82_));
  ...
  aoi21  g45(.a(x19), .b(x06), .c(new_n86_), .O(new_n87_));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n61_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n52_), .b(x15), .c(new_n63_), .O(new_n90_));
