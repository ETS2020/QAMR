...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n61_, new_n65_, new_n70_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  aoi21  g10(.a(new_n51_), .b(x17), .c(new_n47_), .O(z01));
  nand2  g11(.a(new_n45_), .b(x14), .O(new_n53_));
  nand2  g12(.a(new_n50_), .b(new_n47_), .O(new_n54_));
  nand2  g13(.a(x12), .b(new_n42_), .O(new_n55_));
  aoi21  g14(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(z02));
  nand3  g15(.a(new_n50_), .b(new_n48_), .c(x12), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x17), .c(new_n47_), .O(z03));
  nand2  g17(.a(new_n45_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(x17), .b(new_n47_), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(new_n60_), .O(z05));
  nor2   g21(.a(new_n44_), .b(new_n47_), .O(z06));
  nand2  g22(.a(new_n44_), .b(new_n47_), .O(z07));
  ...
  oai21  g37(.a(new_n49_), .b(new_n78_), .c(x17), .O(new_n79_));
  ...
  nor2   g42(.a(new_n61_), .b(x12), .O(new_n84_));
  nand3  g43(.a(new_n50_), .b(new_n47_), .c(x02), .O(new_n85_));
  oai21  g44(.a(new_n49_), .b(new_n44_), .c(x15), .O(new_n86_));
  ...
  nand3  g49(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n50_), .b(x04), .O(new_n96_));
  aoi21  g55(.a(new_n49_), .b(x17), .c(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n84_), .O(z16));
  ...
  oai21  g65(.a(new_n60_), .b(new_n78_), .c(x17), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand2  g67(.a(new_n49_), .b(x19), .O(new_n109_));
  nand4  g68(.a(new_n47_), .b(x10), .c(x08), .d(x06), .O(new_n110_));
  ...
  oai21  g72(.a(new_n43_), .b(new_n78_), .c(x17), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x15), .O(new_n115_));
  nand2  g74(.a(new_n49_), .b(x20), .O(new_n116_));
  nand4  g75(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n117_));
