...
module FAU ( 
  ...
  nand4  g13(.a(new_n54_), .b(new_n44_), .c(new_n46_), .d(x12), .O(new_n55_));
  ...
  nand4  g30(.a(new_n62_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  oai21  g32(.a(new_n50_), .b(x15), .c(new_n73_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n72_), .c(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n44_), .O(z12));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n50_), .b(new_n77_), .c(x14), .O(new_n78_));
  nand2  g37(.a(new_n44_), .b(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n48_), .c(new_n79_), .O(z13));
  nand3  g39(.a(x10), .b(x08), .c(x02), .O(new_n81_));
  nand3  g40(.a(new_n48_), .b(new_n44_), .c(x12), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n62_), .c(new_n82_), .O(z14));
  nand3  g42(.a(new_n62_), .b(x10), .c(x08), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x16), .c(new_n46_), .O(new_n85_));
  nand4  g44(.a(new_n62_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n62_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n50_), .b(x15), .c(new_n64_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(z16));
  inv1   g51(.a(x12), .O(new_n93_));
  aoi21  g52(.a(x18), .b(x05), .c(new_n93_), .O(new_n94_));
  nand4  g53(.a(new_n62_), .b(x10), .c(x08), .d(new_n57_), .O(new_n95_));
  inv1   g54(.a(x18), .O(new_n96_));
  oai21  g55(.a(new_n50_), .b(x15), .c(new_n96_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n62_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n50_), .b(x15), .c(new_n59_), .O(new_n102_));
  ...
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n94_), .O(new_n108_));
