...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n50_,
    ...
    new_n59_, new_n61_, new_n63_, new_n66_, new_n68_, new_n70_, new_n74_,
  ...
  nor2   g22(.a(new_n63_), .b(new_n43_), .O(z05));
  nor2   g23(.a(new_n61_), .b(new_n49_), .O(z06));
  ...
  nor2   g29(.a(new_n70_), .b(new_n61_), .O(z09));
  and2   g30(.a(new_n70_), .b(new_n44_), .O(z10));
  inv1   g31(.a(new_n56_), .O(z11));
  inv1   g32(.a(x00), .O(new_n74_));
  nand4  g33(.a(new_n49_), .b(x10), .c(x08), .d(new_n74_), .O(new_n75_));
  inv1   g34(.a(x13), .O(new_n76_));
  nand2  g35(.a(new_n50_), .b(new_n76_), .O(new_n77_));
  aoi21  g36(.a(x19), .b(new_n43_), .c(new_n52_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z12));
  nand2  g39(.a(new_n46_), .b(new_n48_), .O(new_n81_));
  nand4  g40(.a(new_n49_), .b(x10), .c(x08), .d(x01), .O(new_n82_));
  ...
  nand4  g47(.a(new_n49_), .b(x10), .c(x08), .d(new_n43_), .O(new_n89_));
  ...
  nand2  g54(.a(new_n50_), .b(new_n66_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n78_), .O(new_n97_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(z17));
  inv1   g63(.a(x06), .O(new_n105_));
  nand4  g64(.a(new_n49_), .b(x10), .c(x08), .d(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n50_), .b(new_n63_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(x12), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n44_), .O(z18));
  inv1   g68(.a(x07), .O(new_n110_));
  nand4  g69(.a(new_n49_), .b(x10), .c(x08), .d(new_n110_), .O(new_n111_));
