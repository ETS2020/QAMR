...
module FAU ( 
  ...
  nand3  g10(.a(new_n45_), .b(x12), .c(new_n51_), .O(new_n52_));
  ...
  nor2   g24(.a(new_n58_), .b(new_n49_), .O(z11));
  ...
  oai21  g33(.a(new_n49_), .b(new_n54_), .c(x15), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  inv1   g35(.a(new_n47_), .O(new_n77_));
  aoi21  g36(.a(x10), .b(x01), .c(new_n49_), .O(new_n78_));
  ...
  aoi21  g40(.a(x15), .b(new_n68_), .c(new_n43_), .O(new_n82_));
  aoi22  g41(.a(new_n82_), .b(new_n81_), .c(new_n45_), .d(new_n54_), .O(z14));
  nand3  g42(.a(new_n44_), .b(x10), .c(x03), .O(new_n84_));
  nand3  g43(.a(x16), .b(new_n49_), .c(new_n68_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x08), .O(new_n87_));
  nand3  g46(.a(x16), .b(x15), .c(new_n49_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n54_), .O(z15));
  nand3  g48(.a(new_n44_), .b(x10), .c(x04), .O(new_n90_));
  nand2  g49(.a(x17), .b(new_n68_), .O(new_n91_));
