...
module FAU ( 
  ...
  oai21  g16(.a(new_n57_), .b(new_n49_), .c(new_n47_), .O(z03));
  ...
  oai21  g41(.a(new_n70_), .b(new_n82_), .c(new_n51_), .O(new_n83_));
  ...
  nand2  g46(.a(new_n71_), .b(x03), .O(new_n88_));
  ...
  nand2  g54(.a(new_n71_), .b(new_n95_), .O(new_n96_));
  ...
  aoi21  g61(.a(new_n102_), .b(x12), .c(new_n60_), .O(new_n103_));
  oai21  g62(.a(new_n70_), .b(x15), .c(new_n60_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x12), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(x06), .c(new_n103_), .O(z18));
