...
module FAU ( 
  ...
  aoi22  g30(.a(new_n71_), .b(new_n54_), .c(new_n70_), .d(new_n50_), .O(z12));
  inv1   g31(.a(x01), .O(new_n73_));
  oai21  g32(.a(new_n69_), .b(new_n73_), .c(x14), .O(new_n74_));
  nand2  g33(.a(new_n48_), .b(x15), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z13));
  nand2  g35(.a(new_n48_), .b(x02), .O(new_n77_));
  oai21  g36(.a(new_n69_), .b(new_n50_), .c(x12), .O(new_n78_));
  ...
  aoi21  g42(.a(new_n80_), .b(new_n54_), .c(new_n83_), .O(z15));
  inv1   g43(.a(x04), .O(new_n85_));
  nand4  g44(.a(new_n50_), .b(x10), .c(x08), .d(new_n85_), .O(new_n86_));
  oai21  g45(.a(new_n69_), .b(x15), .c(new_n62_), .O(new_n87_));
  ...
  oai21  g51(.a(new_n69_), .b(x15), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n69_), .b(x15), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g61(.a(new_n69_), .b(x15), .c(new_n43_), .O(new_n103_));
