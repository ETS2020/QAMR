...
module FAU ( 
  ...
  nand2  g01(.a(x18), .b(x00), .O(new_n43_));
  ...
  nand4  g15(.a(new_n56_), .b(new_n43_), .c(new_n45_), .d(x12), .O(new_n57_));
  ...
  nand3  g31(.a(new_n72_), .b(new_n49_), .c(new_n71_), .O(new_n73_));
  aoi21  g32(.a(x18), .b(x00), .c(new_n52_), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nand2  g34(.a(new_n50_), .b(new_n75_), .O(new_n76_));
  ...
  aoi21  g42(.a(new_n72_), .b(x02), .c(x15), .O(new_n84_));
  nand2  g43(.a(new_n74_), .b(new_n47_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z14));
  inv1   g45(.a(x03), .O(new_n87_));
  nand3  g46(.a(new_n72_), .b(new_n49_), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(x16), .b(new_n45_), .O(new_n89_));
  ...
  nand3  g52(.a(new_n72_), .b(new_n49_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n50_), .b(new_n64_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n74_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  nand3  g57(.a(new_n72_), .b(new_n49_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n50_), .b(z04), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n74_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  nand3  g62(.a(new_n72_), .b(new_n49_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g67(.a(new_n72_), .b(new_n49_), .c(new_n108_), .O(new_n109_));
  ...
  nand2  g71(.a(new_n112_), .b(new_n43_), .O(z19));
endmodule
