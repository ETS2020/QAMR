...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n109_, new_n110_;
  nand2  g00(.a(x19), .b(x06), .O(new_n42_));
  ...
  oai21  g16(.a(new_n49_), .b(new_n54_), .c(new_n42_), .O(z03));
  nor2   g17(.a(new_n43_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(x06), .O(z05));
  nor2   g20(.a(new_n43_), .b(new_n51_), .O(z06));
  ...
  nand2  g26(.a(new_n42_), .b(new_n46_), .O(z11));
  inv1   g27(.a(x00), .O(new_n69_));
  nand4  g28(.a(new_n51_), .b(x10), .c(x08), .d(new_n69_), .O(new_n70_));
  aoi21  g29(.a(x19), .b(x06), .c(new_n54_), .O(new_n71_));
  inv1   g30(.a(x13), .O(new_n72_));
  nand2  g31(.a(new_n52_), .b(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z12));
  nand2  g34(.a(new_n47_), .b(new_n46_), .O(new_n76_));
  nand4  g35(.a(new_n51_), .b(x10), .c(x08), .d(x01), .O(new_n77_));
  ...
  nand2  g41(.a(new_n82_), .b(new_n42_), .O(z14));
  ...
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n71_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand4  g60(.a(new_n51_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n52_), .b(new_n60_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n71_), .O(new_n104_));
  ...
  nand2  g69(.a(new_n110_), .b(new_n42_), .O(z19));
endmodule
