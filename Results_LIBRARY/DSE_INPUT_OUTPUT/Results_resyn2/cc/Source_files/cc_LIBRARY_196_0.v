...
module FAU ( 
  ...
  oai21  g30(.a(new_n52_), .b(new_n71_), .c(x12), .O(new_n72_));
  ...
  aoi21  g45(.a(new_n83_), .b(new_n74_), .c(new_n86_), .O(z15));
  ...
  nand4  g58(.a(new_n70_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
  oai21  g59(.a(new_n52_), .b(x15), .c(new_n60_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(x12), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand4  g63(.a(new_n70_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
