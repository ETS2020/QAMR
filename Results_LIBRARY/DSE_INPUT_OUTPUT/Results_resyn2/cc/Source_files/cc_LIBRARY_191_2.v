...
module FAU ( 
  ...
  aoi21  g34(.a(new_n43_), .b(x00), .c(new_n53_), .O(new_n76_));
  ...
  nand2  g43(.a(new_n76_), .b(new_n48_), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n50_), .c(new_n85_), .O(z14));
  ...
  aoi21  g59(.a(new_n75_), .b(new_n43_), .c(new_n100_), .O(z17));
