...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    new_n52_, new_n53_, new_n54_, new_n56_, new_n60_, new_n62_, new_n63_,
  ...
  nor2   g26(.a(new_n63_), .b(new_n67_), .O(new_n68_));
  ...
  nand4  g50(.a(x19), .b(new_n52_), .c(x10), .d(x08), .O(new_n92_));
  ...
  nand4  g55(.a(x18), .b(new_n52_), .c(x10), .d(x08), .O(new_n97_));
  ...
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n68_), .O(new_n105_));
