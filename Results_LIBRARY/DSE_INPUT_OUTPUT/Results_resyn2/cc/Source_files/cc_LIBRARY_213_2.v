...
module FAU ( 
  ...
  nand3  g06(.a(x20), .b(x15), .c(new_n47_), .O(new_n48_));
  nor2   g07(.a(new_n48_), .b(new_n46_), .O(z01));
  nor2   g08(.a(new_n46_), .b(x15), .O(new_n50_));
  ...
  nor2   g14(.a(new_n55_), .b(new_n48_), .O(z03));
  ...
  and2   g24(.a(new_n64_), .b(new_n43_), .O(z10));
  nand2  g25(.a(new_n43_), .b(new_n47_), .O(z11));
  ...
  nand2  g35(.a(new_n55_), .b(x20), .O(new_n77_));
  ...
  nand4  g41(.a(new_n72_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  ...
  nand4  g47(.a(new_n88_), .b(new_n43_), .c(x16), .d(new_n47_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n51_), .O(z15));
  oai21  g49(.a(new_n61_), .b(new_n51_), .c(x20), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n46_), .b(x17), .O(new_n93_));
  nand4  g52(.a(new_n72_), .b(x10), .c(x08), .d(x04), .O(new_n94_));
  ...
  nand4  g60(.a(new_n72_), .b(x10), .c(x08), .d(x05), .O(new_n102_));
  ...
  oai21  g64(.a(new_n59_), .b(new_n51_), .c(x20), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n46_), .b(x19), .O(new_n108_));
  nand4  g67(.a(new_n72_), .b(x10), .c(x08), .d(x06), .O(new_n109_));
  ...
  nand4  g72(.a(new_n72_), .b(x10), .c(x08), .d(new_n113_), .O(new_n114_));
  nand2  g73(.a(new_n88_), .b(new_n42_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n114_), .c(x12), .O(new_n116_));
