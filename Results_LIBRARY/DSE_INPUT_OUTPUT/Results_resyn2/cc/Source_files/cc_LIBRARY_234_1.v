...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(x05), .c(new_n46_), .O(z03));
  ...
  nand2  g30(.a(new_n47_), .b(new_n54_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(z06), .O(new_n73_));
  nand3  g32(.a(x10), .b(x08), .c(x01), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n46_), .c(x14), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n50_), .O(z13));
  nand2  g35(.a(new_n47_), .b(x15), .O(new_n77_));
  nand4  g36(.a(new_n46_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  ...
  nand3  g43(.a(new_n47_), .b(x16), .c(new_n54_), .O(new_n85_));
  ...
  oai21  g48(.a(new_n62_), .b(new_n50_), .c(x05), .O(new_n90_));
  ...
  nand4  g55(.a(new_n46_), .b(x10), .c(x08), .d(new_n43_), .O(new_n97_));
  inv1   g56(.a(x18), .O(new_n98_));
  nand2  g57(.a(new_n69_), .b(new_n98_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n97_), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(z17));
  oai21  g60(.a(new_n59_), .b(new_n50_), .c(x05), .O(new_n102_));
  ...
  nand2  g71(.a(new_n47_), .b(new_n112_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n111_), .c(new_n46_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n109_), .c(new_n50_), .O(z19));
endmodule
