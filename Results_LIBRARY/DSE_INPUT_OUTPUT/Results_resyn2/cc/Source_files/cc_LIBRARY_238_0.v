...
module FAU ( 
  ...
  oai21  g16(.a(new_n50_), .b(new_n52_), .c(new_n45_), .O(z03));
  ...
  aoi21  g43(.a(new_n72_), .b(x03), .c(new_n52_), .O(new_n85_));
  nand4  g44(.a(new_n74_), .b(x16), .c(new_n47_), .d(x12), .O(new_n86_));
  ...
  nand3  g52(.a(new_n72_), .b(new_n62_), .c(new_n93_), .O(new_n94_));
  inv1   g53(.a(x18), .O(new_n95_));
  nand2  g54(.a(new_n74_), .b(new_n95_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(x12), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z17));
  inv1   g57(.a(x06), .O(new_n99_));
  nand3  g58(.a(new_n72_), .b(new_n62_), .c(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n74_), .b(new_n60_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(x12), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand3  g63(.a(new_n72_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n74_), .b(new_n43_), .O(new_n106_));
