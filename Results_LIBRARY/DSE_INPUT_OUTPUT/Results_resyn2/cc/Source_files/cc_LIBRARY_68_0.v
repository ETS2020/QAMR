...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(new_n50_), .c(new_n68_), .O(new_n70_));
  ...
  nand3  g41(.a(new_n51_), .b(x16), .c(new_n49_), .O(new_n83_));
  nand3  g42(.a(new_n69_), .b(new_n50_), .c(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n54_), .O(z15));
  inv1   g44(.a(x04), .O(new_n86_));
  nand3  g45(.a(new_n69_), .b(new_n50_), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n51_), .b(new_n60_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(x12), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z16));
  aoi21  g49(.a(new_n69_), .b(x05), .c(new_n54_), .O(new_n91_));
  nand3  g50(.a(new_n51_), .b(x18), .c(x12), .O(new_n92_));
  oai21  g51(.a(new_n91_), .b(x15), .c(new_n92_), .O(z17));
  aoi21  g52(.a(new_n69_), .b(x06), .c(new_n54_), .O(new_n94_));
  nand3  g53(.a(new_n51_), .b(x19), .c(x12), .O(new_n95_));
  oai21  g54(.a(new_n94_), .b(x15), .c(new_n95_), .O(z18));
  inv1   g55(.a(x07), .O(new_n97_));
  nand3  g56(.a(new_n69_), .b(new_n50_), .c(new_n97_), .O(new_n98_));
