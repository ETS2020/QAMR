...
module FAU ( 
  ...
  nor2   g01(.a(x09), .b(x04), .O(new_n43_));
  ...
  nand2  g16(.a(new_n44_), .b(x12), .O(new_n58_));
  ...
  nand2  g27(.a(z10), .b(new_n44_), .O(z09));
  ...
  nand3  g41(.a(new_n47_), .b(new_n44_), .c(x12), .O(new_n83_));
  ...
  aoi21  g49(.a(new_n52_), .b(x09), .c(x04), .O(new_n91_));
  nand2  g50(.a(x10), .b(x08), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(x15), .c(new_n64_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x12), .O(new_n94_));
  nor2   g53(.a(new_n94_), .b(new_n91_), .O(z16));
  nor2   g54(.a(new_n43_), .b(new_n54_), .O(new_n96_));
  ...
  nand2  g63(.a(new_n52_), .b(new_n61_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n96_), .O(new_n106_));
  inv1   g65(.a(new_n106_), .O(z18));
  inv1   g66(.a(x07), .O(new_n108_));
  nand4  g67(.a(new_n51_), .b(x10), .c(x08), .d(new_n108_), .O(new_n109_));
  inv1   g68(.a(x20), .O(new_n110_));
  nand2  g69(.a(new_n52_), .b(new_n110_), .O(new_n111_));
  nand3  g70(.a(new_n111_), .b(new_n109_), .c(new_n96_), .O(new_n112_));
