...
module FAU ( 
  ...
  nor2   g14(.a(new_n55_), .b(new_n44_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n42_), .O(new_n57_));
  aoi21  g16(.a(new_n54_), .b(new_n48_), .c(new_n57_), .O(z02));
  aoi21  g17(.a(new_n51_), .b(x18), .c(new_n44_), .O(z03));
  nor2   g18(.a(x18), .b(x12), .O(z04));
  ...
  nand4  g31(.a(new_n53_), .b(x10), .c(x08), .d(new_n72_), .O(new_n73_));
  inv1   g32(.a(x13), .O(new_n74_));
  nand2  g33(.a(x10), .b(x08), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(x15), .c(new_n74_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n73_), .c(new_n56_), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z12));
  inv1   g37(.a(new_n56_), .O(new_n79_));
  ...
  nand4  g41(.a(new_n53_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n75_), .b(x15), .c(new_n55_), .O(new_n84_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n56_), .O(new_n89_));
  aoi21  g48(.a(new_n86_), .b(new_n54_), .c(new_n89_), .O(z15));
  inv1   g49(.a(x04), .O(new_n91_));
  nand4  g50(.a(new_n53_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  oai21  g51(.a(new_n75_), .b(x15), .c(new_n64_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n56_), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z16));
  inv1   g54(.a(new_n54_), .O(new_n96_));
  nor2   g55(.a(new_n55_), .b(x05), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n44_), .O(z17));
  inv1   g57(.a(x06), .O(new_n99_));
  nand4  g58(.a(new_n53_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
  oai21  g59(.a(new_n75_), .b(x15), .c(new_n61_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n56_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand4  g63(.a(new_n53_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  oai21  g64(.a(new_n75_), .b(x15), .c(new_n43_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n56_), .O(new_n107_));
