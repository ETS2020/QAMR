...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n49_, new_n51_, new_n52_,
    new_n53_, new_n55_, new_n57_, new_n59_, new_n61_, new_n64_, new_n67_,
  ...
  nand2  g15(.a(x19), .b(x18), .O(new_n57_));
  ...
  aoi21  g23(.a(x19), .b(z04), .c(new_n64_), .O(z09));
  ...
  and2   g36(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  inv1   g37(.a(x12), .O(new_n79_));
  aoi21  g38(.a(x19), .b(z04), .c(new_n79_), .O(new_n80_));
  ...
  nand4  g57(.a(new_n59_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x12), .O(new_n100_));
  aoi21  g59(.a(new_n93_), .b(new_n57_), .c(new_n100_), .O(z18));
  inv1   g60(.a(x07), .O(new_n102_));
  nand4  g61(.a(new_n59_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n51_), .b(x15), .c(new_n43_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n80_), .O(new_n105_));
