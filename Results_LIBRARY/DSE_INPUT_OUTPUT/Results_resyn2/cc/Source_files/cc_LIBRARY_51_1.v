...
module FAU ( 
  ...
  aoi21  g11(.a(x20), .b(new_n45_), .c(new_n52_), .O(new_n53_));
  ...
  nor2   g17(.a(x20), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n43_), .b(x18), .O(new_n61_));
  ...
  inv1   g46(.a(new_n56_), .O(new_n88_));
  nand3  g47(.a(new_n51_), .b(x16), .c(new_n49_), .O(new_n89_));
  aoi21  g48(.a(new_n74_), .b(x03), .c(new_n61_), .O(new_n90_));
  ...
  nand2  g57(.a(new_n51_), .b(new_n45_), .O(new_n99_));
  ...
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n53_), .O(new_n105_));
  ...
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n53_), .O(new_n110_));
