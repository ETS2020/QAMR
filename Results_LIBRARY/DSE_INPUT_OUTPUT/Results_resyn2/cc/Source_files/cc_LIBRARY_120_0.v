...
module FAU ( 
  ...
  nor3   g07(.a(new_n48_), .b(new_n44_), .c(new_n46_), .O(z01));
  ...
  oai21  g14(.a(new_n55_), .b(new_n54_), .c(new_n51_), .O(z03));
  nor2   g15(.a(new_n44_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(x06), .O(z05));
  nor2   g18(.a(new_n44_), .b(new_n46_), .O(z06));
  ...
  nand3  g25(.a(new_n51_), .b(x09), .c(x08), .O(z10));
  ...
  nand2  g37(.a(new_n78_), .b(new_n54_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n51_), .O(z13));
  nand3  g40(.a(x10), .b(x08), .c(x02), .O(new_n82_));
  nand3  g41(.a(new_n54_), .b(new_n51_), .c(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n46_), .c(new_n83_), .O(z14));
  ...
  nand2  g51(.a(new_n50_), .b(new_n61_), .O(new_n93_));
  ...
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n70_), .O(new_n110_));
