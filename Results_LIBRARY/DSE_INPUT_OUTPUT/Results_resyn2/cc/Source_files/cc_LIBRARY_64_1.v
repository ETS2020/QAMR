...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n61_, new_n63_, new_n66_, new_n68_, new_n70_, new_n71_,
  ...
  nand2  g02(.a(x09), .b(new_n43_), .O(new_n44_));
  ...
  aoi21  g16(.a(x09), .b(new_n43_), .c(new_n54_), .O(new_n58_));
  ...
  nand2  g23(.a(new_n44_), .b(new_n51_), .O(z06));
  ...
  aoi21  g30(.a(new_n70_), .b(x04), .c(new_n71_), .O(z09));
  nand3  g31(.a(x09), .b(x08), .c(x04), .O(z10));
  nor2   g32(.a(new_n61_), .b(new_n46_), .O(z11));
  inv1   g33(.a(x00), .O(new_n75_));
  nand4  g34(.a(new_n51_), .b(x10), .c(x08), .d(new_n75_), .O(new_n76_));
  inv1   g35(.a(x13), .O(new_n77_));
  nand2  g36(.a(new_n52_), .b(new_n77_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n76_), .c(x12), .O(new_n79_));
  ...
  nand3  g44(.a(x10), .b(x08), .c(x02), .O(new_n86_));
  nand2  g45(.a(new_n58_), .b(new_n47_), .O(new_n87_));
  aoi21  g46(.a(new_n86_), .b(new_n51_), .c(new_n87_), .O(z14));
  inv1   g47(.a(x03), .O(new_n89_));
  nand4  g48(.a(new_n51_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  nand2  g49(.a(x16), .b(new_n46_), .O(new_n91_));
  ...
  aoi21  g53(.a(new_n52_), .b(new_n71_), .c(x04), .O(new_n95_));
  nand2  g54(.a(x10), .b(x08), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(x15), .c(new_n66_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x12), .O(new_n98_));
  nor2   g57(.a(new_n98_), .b(new_n95_), .O(z16));
  ...
  nand3  g62(.a(new_n103_), .b(new_n101_), .c(new_n58_), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z17));
  inv1   g64(.a(x06), .O(new_n106_));
  nand4  g65(.a(new_n51_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  nand2  g66(.a(new_n52_), .b(new_n63_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n58_), .O(new_n109_));
  inv1   g68(.a(new_n109_), .O(z18));
  inv1   g69(.a(x07), .O(new_n111_));
  nand4  g70(.a(new_n51_), .b(x10), .c(x08), .d(new_n111_), .O(new_n112_));
  inv1   g71(.a(x20), .O(new_n113_));
  nand2  g72(.a(new_n52_), .b(new_n113_), .O(new_n114_));
  nand3  g73(.a(new_n114_), .b(new_n112_), .c(new_n58_), .O(new_n115_));
