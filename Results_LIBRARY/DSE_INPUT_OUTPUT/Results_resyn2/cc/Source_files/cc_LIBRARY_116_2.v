...
module FAU ( 
  ...
  nand2  g03(.a(new_n44_), .b(x17), .O(new_n45_));
  ...
  nor2   g24(.a(new_n47_), .b(new_n48_), .O(z11));
  aoi21  g25(.a(new_n44_), .b(x17), .c(new_n57_), .O(new_n67_));
  ...
  nand4  g45(.a(new_n53_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n71_), .b(x15), .c(new_n88_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n87_), .c(new_n67_), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand4  g51(.a(new_n53_), .b(x10), .c(x08), .d(new_n92_), .O(new_n93_));
  oai21  g52(.a(new_n71_), .b(x15), .c(new_n44_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n45_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  nand4  g56(.a(new_n53_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  oai21  g57(.a(new_n71_), .b(x15), .c(new_n60_), .O(new_n99_));
