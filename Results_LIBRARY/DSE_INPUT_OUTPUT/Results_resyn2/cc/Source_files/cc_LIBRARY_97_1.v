...
module FAU ( 
  ...
  aoi21  g10(.a(new_n51_), .b(x07), .c(new_n47_), .O(z01));
  ...
  nand2  g15(.a(new_n56_), .b(new_n43_), .O(z02));
  nand3  g16(.a(x12), .b(x10), .c(x08), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n48_), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(x07), .c(new_n47_), .O(z03));
  nand2  g20(.a(new_n43_), .b(x18), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nor2   g22(.a(new_n44_), .b(new_n63_), .O(z05));
  nor2   g23(.a(new_n47_), .b(new_n42_), .O(z06));
  inv1   g24(.a(x17), .O(new_n66_));
  nand2  g25(.a(new_n43_), .b(new_n66_), .O(z07));
  inv1   g26(.a(x16), .O(new_n68_));
  nand2  g27(.a(new_n43_), .b(new_n68_), .O(z08));
  nand2  g28(.a(x09), .b(x08), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n43_), .O(z09));
  nand3  g30(.a(new_n43_), .b(x09), .c(x08), .O(z10));
  nand2  g31(.a(new_n43_), .b(new_n48_), .O(z11));
  nand2  g32(.a(x13), .b(x12), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x07), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x15), .O(new_n76_));
  nand2  g35(.a(new_n49_), .b(x13), .O(new_n77_));
  ...
  nand4  g49(.a(new_n90_), .b(new_n43_), .c(x16), .d(new_n48_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n49_), .b(new_n66_), .O(new_n96_));
  ...
  nand2  g58(.a(new_n99_), .b(x07), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x15), .O(new_n101_));
  nand2  g60(.a(new_n49_), .b(x18), .O(new_n102_));
  ...
  nand2  g68(.a(new_n49_), .b(new_n63_), .O(new_n110_));
  ...
  aoi21  g72(.a(x10), .b(x08), .c(x15), .O(new_n114_));
  oai21  g73(.a(new_n114_), .b(x07), .c(x12), .O(new_n115_));
  aoi21  g74(.a(new_n90_), .b(new_n113_), .c(new_n115_), .O(z19));
endmodule
