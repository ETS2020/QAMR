...
module FAU ( 
  ...
  oai21  g15(.a(new_n56_), .b(new_n48_), .c(new_n42_), .O(z03));
  ...
  nand2  g21(.a(new_n42_), .b(new_n62_), .O(z06));
  ...
  nand2  g46(.a(new_n42_), .b(x12), .O(new_n88_));
  aoi21  g47(.a(new_n87_), .b(new_n86_), .c(new_n88_), .O(z15));
  inv1   g48(.a(new_n88_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n90_), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z16));
  inv1   g54(.a(x18), .O(new_n96_));
  nand4  g55(.a(new_n62_), .b(x12), .c(x10), .d(x08), .O(new_n97_));
  nand2  g56(.a(new_n73_), .b(x12), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n58_), .c(new_n97_), .d(new_n96_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n62_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n73_), .b(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n42_), .O(z18));
  ...
  nand3  g67(.a(new_n108_), .b(new_n106_), .c(new_n90_), .O(new_n109_));
