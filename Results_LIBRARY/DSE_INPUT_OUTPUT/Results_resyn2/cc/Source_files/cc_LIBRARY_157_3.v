...
module FAU ( 
  ...
  nand2  g05(.a(x20), .b(x19), .O(new_n47_));
  ...
  nand2  g18(.a(new_n47_), .b(new_n59_), .O(z06));
  ...
  oai21  g37(.a(new_n51_), .b(new_n78_), .c(new_n59_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n49_), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n47_), .O(z14));
  ...
  aoi21  g45(.a(x20), .b(x19), .c(new_n86_), .O(new_n87_));
  ...
  oai21  g59(.a(new_n51_), .b(x15), .c(new_n43_), .O(new_n101_));
  ...
  oai21  g64(.a(new_n51_), .b(x15), .c(new_n44_), .O(new_n106_));
