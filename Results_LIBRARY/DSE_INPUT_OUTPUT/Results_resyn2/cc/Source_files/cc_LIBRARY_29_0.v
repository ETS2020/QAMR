...
module FAU ( 
  ...
  oai21  g14(.a(new_n49_), .b(new_n55_), .c(new_n45_), .O(z03));
  nor2   g15(.a(x18), .b(new_n51_), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nor2   g17(.a(new_n44_), .b(new_n58_), .O(z05));
  nand2  g18(.a(x18), .b(new_n51_), .O(z06));
  ...
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(x18), .O(new_n71_));
  ...
  aoi21  g57(.a(new_n69_), .b(new_n58_), .c(new_n92_), .O(new_n99_));
  ...
  nand2  g61(.a(new_n51_), .b(x07), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n48_), .O(new_n104_));
  aoi21  g63(.a(new_n69_), .b(new_n43_), .c(new_n92_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n102_), .c(new_n55_), .O(z19));
endmodule
