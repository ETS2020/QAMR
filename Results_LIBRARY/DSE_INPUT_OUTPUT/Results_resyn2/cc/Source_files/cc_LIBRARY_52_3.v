...
module FAU ( 
  ...
  nor2   g17(.a(x19), .b(new_n51_), .O(z06));
  ...
  nand4  g26(.a(new_n51_), .b(x10), .c(x08), .d(x00), .O(new_n68_));
  nand3  g27(.a(new_n52_), .b(new_n44_), .c(x13), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z12));
  nand2  g29(.a(x10), .b(x08), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n55_), .c(new_n46_), .O(new_n72_));
  ...
  nand3  g40(.a(x16), .b(new_n48_), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n46_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand3  g43(.a(new_n71_), .b(x16), .c(new_n48_), .O(new_n85_));
  ...
  nand2  g51(.a(new_n71_), .b(new_n60_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n51_), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n90_), .c(new_n55_), .O(z16));
  ...
  nand3  g59(.a(new_n100_), .b(new_n98_), .c(new_n51_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n96_), .c(new_n55_), .O(z17));
  ...
  nand2  g69(.a(new_n71_), .b(new_n43_), .O(new_n111_));
  nand3  g70(.a(new_n111_), .b(new_n110_), .c(new_n51_), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n108_), .c(new_n55_), .O(z19));
  buf    g72(.a(x19), .O(z05));
endmodule
