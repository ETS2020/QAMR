...
module FAU ( 
  ...
  nor2   g07(.a(x16), .b(new_n42_), .O(new_n49_));
  ...
  aoi21  g19(.a(new_n60_), .b(new_n43_), .c(new_n42_), .O(z03));
  ...
  nand2  g66(.a(new_n47_), .b(new_n63_), .O(new_n108_));
  ...
  nand2  g73(.a(new_n47_), .b(new_n114_), .O(new_n115_));
