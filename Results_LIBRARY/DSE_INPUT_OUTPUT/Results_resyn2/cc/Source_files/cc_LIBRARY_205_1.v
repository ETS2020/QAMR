...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n59_, new_n61_, new_n64_, new_n66_, new_n72_, new_n73_, new_n74_,
  ...
  oai21  g13(.a(new_n54_), .b(x02), .c(x14), .O(new_n55_));
  oai21  g14(.a(new_n54_), .b(x02), .c(new_n47_), .O(new_n56_));
  inv1   g15(.a(x12), .O(new_n57_));
  oai21  g16(.a(new_n54_), .b(x02), .c(new_n57_), .O(new_n58_));
  ...
  nor2   g21(.a(new_n54_), .b(new_n44_), .O(z05));
  inv1   g22(.a(x15), .O(new_n64_));
  nor2   g23(.a(new_n61_), .b(new_n64_), .O(z06));
  inv1   g24(.a(x17), .O(new_n66_));
  nor2   g25(.a(new_n61_), .b(new_n66_), .O(z07));
  and2   g26(.a(new_n45_), .b(x16), .O(z08));
  nand3  g27(.a(new_n45_), .b(x09), .c(x08), .O(z10));
  inv1   g28(.a(z10), .O(z09));
  inv1   g29(.a(new_n55_), .O(z11));
  inv1   g30(.a(x00), .O(new_n72_));
  nand4  g31(.a(new_n64_), .b(x10), .c(x08), .d(new_n72_), .O(new_n73_));
  ...
  nand4  g38(.a(new_n64_), .b(x10), .c(x08), .d(x01), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n79_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z13));
  oai21  g41(.a(new_n50_), .b(new_n44_), .c(new_n64_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n47_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n45_), .O(z14));
  nand2  g44(.a(new_n45_), .b(x12), .O(new_n86_));
  nand3  g45(.a(new_n64_), .b(x10), .c(x08), .O(new_n87_));
  ...
  nand4  g50(.a(new_n64_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  oai21  g51(.a(new_n50_), .b(x15), .c(new_n66_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z16));
  inv1   g54(.a(x05), .O(new_n96_));
  nand4  g55(.a(new_n64_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  inv1   g56(.a(x18), .O(new_n98_));
  oai21  g57(.a(new_n50_), .b(x15), .c(new_n98_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n97_), .c(new_n74_), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z17));
  inv1   g60(.a(x06), .O(new_n102_));
  nand4  g61(.a(new_n64_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n50_), .b(x15), .c(new_n54_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n45_), .O(z18));
  inv1   g65(.a(x07), .O(new_n107_));
  nand4  g66(.a(new_n64_), .b(x10), .c(x08), .d(new_n107_), .O(new_n108_));
  oai21  g67(.a(new_n50_), .b(x15), .c(new_n43_), .O(new_n109_));
