...
module FAU ( 
  ...
  aoi21  g15(.a(new_n53_), .b(new_n48_), .c(new_n56_), .O(z02));
  ...
  nand3  g30(.a(new_n49_), .b(new_n52_), .c(new_n71_), .O(new_n72_));
  ...
  aoi21  g40(.a(new_n49_), .b(x02), .c(x15), .O(new_n82_));
  nand2  g41(.a(new_n58_), .b(new_n55_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z14));
  inv1   g43(.a(x03), .O(new_n85_));
  nand3  g44(.a(new_n49_), .b(new_n52_), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g50(.a(new_n49_), .b(new_n52_), .c(new_n91_), .O(new_n92_));
  ...
  nand3  g55(.a(new_n49_), .b(new_n52_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g61(.a(new_n49_), .b(new_n52_), .c(new_n102_), .O(new_n103_));
  inv1   g62(.a(x19), .O(new_n104_));
  nand2  g63(.a(new_n53_), .b(new_n104_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n103_), .c(new_n55_), .O(new_n106_));
  inv1   g65(.a(new_n106_), .O(z18));
  inv1   g66(.a(x07), .O(new_n108_));
  nand3  g67(.a(new_n49_), .b(new_n52_), .c(new_n108_), .O(new_n109_));
