...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n55_, new_n58_, new_n60_, new_n63_, new_n66_,
  ...
  nand2  g15(.a(x19), .b(x18), .O(z04));
  inv1   g16(.a(x15), .O(new_n58_));
  nand2  g17(.a(new_n45_), .b(new_n58_), .O(z06));
  inv1   g18(.a(x17), .O(new_n60_));
  nand2  g19(.a(new_n45_), .b(new_n60_), .O(z07));
  and2   g20(.a(new_n45_), .b(x16), .O(z08));
  nand2  g21(.a(x09), .b(x08), .O(new_n63_));
  aoi21  g22(.a(new_n44_), .b(x18), .c(new_n63_), .O(z09));
  and2   g23(.a(new_n63_), .b(new_n45_), .O(z10));
  inv1   g24(.a(x00), .O(new_n66_));
  nand4  g25(.a(new_n58_), .b(x10), .c(x08), .d(new_n66_), .O(new_n67_));
  inv1   g26(.a(x13), .O(new_n68_));
  oai21  g27(.a(new_n51_), .b(x15), .c(new_n68_), .O(new_n69_));
  ...
  nand2  g32(.a(new_n45_), .b(x12), .O(new_n74_));
  aoi21  g33(.a(new_n73_), .b(new_n49_), .c(new_n74_), .O(z13));
  nand3  g34(.a(x10), .b(x08), .c(x02), .O(new_n76_));
  and2   g35(.a(new_n76_), .b(new_n58_), .O(new_n77_));
  inv1   g36(.a(x12), .O(new_n78_));
  aoi21  g37(.a(new_n44_), .b(x18), .c(new_n78_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n49_), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n77_), .O(z14));
  nand3  g40(.a(new_n58_), .b(x10), .c(x08), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x16), .c(new_n47_), .O(new_n83_));
  nand4  g42(.a(new_n58_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n74_), .O(z15));
  inv1   g44(.a(x04), .O(new_n86_));
  nand4  g45(.a(new_n58_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  oai21  g46(.a(new_n51_), .b(x15), .c(new_n60_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n79_), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z16));
  inv1   g49(.a(x18), .O(new_n91_));
  nand4  g50(.a(new_n91_), .b(new_n58_), .c(x10), .d(x08), .O(new_n92_));
  ...
  nand4  g56(.a(new_n58_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x12), .O(new_n99_));
  aoi21  g58(.a(new_n92_), .b(new_n44_), .c(new_n99_), .O(z18));
  inv1   g59(.a(x07), .O(new_n101_));
  nand4  g60(.a(new_n58_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  oai21  g61(.a(new_n51_), .b(x15), .c(new_n43_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n79_), .O(new_n104_));
