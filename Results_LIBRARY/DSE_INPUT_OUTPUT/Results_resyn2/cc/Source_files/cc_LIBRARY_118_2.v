...
module FAU ( 
  ...
  oai21  g36(.a(new_n57_), .b(new_n47_), .c(x15), .O(new_n78_));
  ...
  nor2   g41(.a(new_n44_), .b(x12), .O(new_n83_));
  nand2  g42(.a(new_n50_), .b(x02), .O(new_n84_));
  oai21  g43(.a(new_n48_), .b(new_n47_), .c(x15), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z14));
  nand3  g45(.a(x16), .b(new_n55_), .c(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x17), .O(new_n88_));
  ...
  nand2  g53(.a(new_n79_), .b(x04), .O(new_n95_));
  aoi21  g54(.a(new_n48_), .b(x17), .c(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n83_), .O(z16));
  ...
  oai21  g64(.a(new_n61_), .b(new_n51_), .c(x17), .O(new_n106_));
  ...
  nand3  g71(.a(x20), .b(x17), .c(x15), .O(new_n113_));
  inv1   g72(.a(x07), .O(new_n114_));
  nand3  g73(.a(x10), .b(x08), .c(new_n114_), .O(new_n115_));
  inv1   g74(.a(x20), .O(new_n116_));
  nand2  g75(.a(new_n48_), .b(new_n116_), .O(new_n117_));
  nand3  g76(.a(new_n117_), .b(new_n115_), .c(new_n43_), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n113_), .c(new_n51_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
