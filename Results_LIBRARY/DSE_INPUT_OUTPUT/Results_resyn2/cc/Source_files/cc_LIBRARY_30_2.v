...
module FAU ( 
  ...
  nand2  g18(.a(new_n59_), .b(new_n47_), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(x16), .c(new_n42_), .O(z03));
  nor2   g20(.a(new_n43_), .b(x18), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nor2   g22(.a(new_n43_), .b(new_n63_), .O(z05));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n52_), .b(new_n65_), .O(z07));
  nand2  g25(.a(new_n48_), .b(new_n42_), .O(z08));
  nand2  g26(.a(x09), .b(x08), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n52_), .O(z09));
  inv1   g28(.a(z09), .O(z10));
  nor2   g29(.a(new_n43_), .b(new_n47_), .O(z11));
  nand2  g30(.a(x13), .b(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x16), .O(new_n73_));
  ...
  oai21  g38(.a(new_n59_), .b(new_n48_), .c(x15), .O(new_n80_));
  nand3  g39(.a(x10), .b(x08), .c(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x14), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n80_), .O(z13));
  nand2  g42(.a(new_n49_), .b(new_n46_), .O(new_n84_));
  nand2  g43(.a(new_n53_), .b(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n54_), .O(z14));
  nand3  g45(.a(new_n42_), .b(x10), .c(x08), .O(new_n87_));
  ...
  nand2  g49(.a(new_n49_), .b(x17), .O(new_n91_));
  inv1   g50(.a(x04), .O(new_n92_));
  nand3  g51(.a(x10), .b(x08), .c(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n46_), .b(new_n65_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n42_), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n91_), .c(new_n54_), .O(z16));
  ...
  nand2  g66(.a(new_n46_), .b(new_n63_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n42_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n105_), .c(new_n54_), .O(z18));
  ...
  nand2  g73(.a(new_n46_), .b(new_n114_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n113_), .c(new_n42_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n111_), .c(new_n54_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
