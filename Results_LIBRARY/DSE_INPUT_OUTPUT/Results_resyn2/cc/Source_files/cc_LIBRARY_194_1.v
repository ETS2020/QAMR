...
module FAU ( 
  ...
  nand3  g41(.a(new_n51_), .b(new_n49_), .c(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n53_), .c(new_n83_), .O(z14));
  nand2  g43(.a(new_n49_), .b(x12), .O(new_n85_));
  nand3  g44(.a(new_n54_), .b(x16), .c(new_n47_), .O(new_n86_));
