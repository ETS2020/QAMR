...
module FAU ( 
  ...
  aoi21  g22(.a(new_n44_), .b(new_n43_), .c(new_n63_), .O(z08));
  ...
  oai21  g28(.a(new_n69_), .b(new_n50_), .c(x18), .O(new_n70_));
  ...
  nand3  g38(.a(new_n51_), .b(x18), .c(x02), .O(new_n80_));
  ...
  nand3  g44(.a(new_n51_), .b(x18), .c(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n56_), .O(z15));
  nand2  g46(.a(x12), .b(x04), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n50_), .c(x18), .O(new_n89_));
  ...
  aoi21  g53(.a(new_n51_), .b(new_n93_), .c(new_n94_), .O(z17));
  nand2  g54(.a(x12), .b(x06), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n50_), .c(x18), .O(new_n97_));
  ...
  oai21  g60(.a(new_n101_), .b(new_n50_), .c(x18), .O(new_n102_));
