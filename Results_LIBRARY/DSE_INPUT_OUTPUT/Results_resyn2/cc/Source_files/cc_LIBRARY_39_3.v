...
module FAU ( 
  ...
  nand2  g05(.a(x19), .b(x11), .O(new_n47_));
  ...
  inv1   g17(.a(new_n47_), .O(new_n59_));
  ...
  and2   g23(.a(new_n47_), .b(x16), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n59_), .O(z09));
  and2   g26(.a(new_n66_), .b(new_n47_), .O(z10));
  ...
  aoi21  g46(.a(new_n86_), .b(new_n85_), .c(new_n87_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n61_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n72_), .b(new_n63_), .O(new_n91_));
