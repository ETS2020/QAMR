...
module FAU ( 
  ...
  oai21  g16(.a(new_n57_), .b(new_n56_), .c(new_n43_), .O(z03));
  inv1   g17(.a(new_n43_), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(x18), .O(z04));
  inv1   g19(.a(new_n45_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n43_), .b(new_n62_), .O(z07));
  nand3  g22(.a(new_n43_), .b(x09), .c(x08), .O(z10));
  inv1   g23(.a(z10), .O(z09));
  nor2   g24(.a(new_n59_), .b(new_n48_), .O(z11));
  inv1   g25(.a(x00), .O(new_n67_));
  nand4  g26(.a(new_n49_), .b(x10), .c(x08), .d(new_n67_), .O(new_n68_));
  inv1   g27(.a(x13), .O(new_n69_));
  oai21  g28(.a(new_n46_), .b(x15), .c(new_n69_), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(new_n68_), .c(x12), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n43_), .O(z12));
  inv1   g31(.a(x01), .O(new_n73_));
  oai21  g32(.a(new_n46_), .b(new_n73_), .c(x14), .O(new_n74_));
  nand2  g33(.a(new_n43_), .b(x12), .O(new_n75_));
  aoi21  g34(.a(new_n74_), .b(new_n56_), .c(new_n75_), .O(z13));
  and2   g35(.a(x10), .b(x08), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x02), .O(new_n78_));
  nand3  g37(.a(new_n56_), .b(new_n43_), .c(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n49_), .c(new_n79_), .O(z14));
  inv1   g39(.a(x19), .O(new_n81_));
  nand4  g40(.a(new_n50_), .b(new_n81_), .c(x16), .d(new_n48_), .O(new_n82_));
  nand4  g41(.a(new_n77_), .b(new_n43_), .c(new_n49_), .d(x03), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n52_), .O(z15));
  inv1   g43(.a(new_n75_), .O(new_n85_));
  inv1   g44(.a(x04), .O(new_n86_));
  nand3  g45(.a(new_n77_), .b(new_n49_), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n50_), .b(new_n62_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z16));
  inv1   g49(.a(x05), .O(new_n91_));
  nand3  g50(.a(new_n77_), .b(new_n49_), .c(new_n91_), .O(new_n92_));
  ...
  oai21  g57(.a(new_n46_), .b(x15), .c(new_n81_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n43_), .O(z18));
  inv1   g60(.a(x07), .O(new_n102_));
  nand3  g61(.a(new_n77_), .b(new_n49_), .c(new_n102_), .O(new_n103_));
  inv1   g62(.a(x20), .O(new_n104_));
  nand2  g63(.a(new_n50_), .b(new_n104_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n103_), .c(new_n85_), .O(new_n106_));
