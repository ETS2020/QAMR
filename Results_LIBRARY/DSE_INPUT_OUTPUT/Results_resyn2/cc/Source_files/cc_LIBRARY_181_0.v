...
module FAU ( 
  ...
  nor2   g03(.a(x20), .b(x18), .O(new_n45_));
  ...
  aoi21  g41(.a(new_n48_), .b(x02), .c(x15), .O(new_n83_));
  nand2  g42(.a(new_n54_), .b(new_n78_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z14));
  nand3  g44(.a(new_n52_), .b(x16), .c(new_n46_), .O(new_n86_));
  nand3  g45(.a(new_n48_), .b(new_n51_), .c(x03), .O(new_n87_));
  ...
  aoi21  g51(.a(new_n52_), .b(new_n63_), .c(new_n53_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n57_), .O(z16));
  inv1   g54(.a(x05), .O(new_n96_));
  nand2  g55(.a(new_n72_), .b(new_n96_), .O(new_n97_));
  aoi21  g56(.a(new_n52_), .b(z04), .c(new_n53_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n57_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand2  g60(.a(new_n72_), .b(new_n101_), .O(new_n102_));
  aoi21  g61(.a(new_n52_), .b(new_n60_), .c(new_n53_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n57_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand2  g65(.a(new_n72_), .b(new_n106_), .O(new_n107_));
  aoi21  g66(.a(new_n52_), .b(new_n43_), .c(new_n53_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n57_), .O(z19));
endmodule
