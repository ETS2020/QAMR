...
module FAU ( 
  ...
  nor2   g28(.a(new_n45_), .b(new_n69_), .O(new_n70_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(new_n76_));
  ...
  aoi21  g42(.a(new_n56_), .b(x02), .c(x15), .O(new_n84_));
  nand2  g43(.a(new_n80_), .b(new_n70_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z14));
  nand3  g45(.a(new_n52_), .b(x16), .c(new_n51_), .O(new_n87_));
  nand3  g46(.a(new_n56_), .b(new_n48_), .c(x03), .O(new_n88_));
  ...
  nand2  g52(.a(new_n52_), .b(new_n61_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n70_), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z16));
  inv1   g55(.a(x05), .O(new_n97_));
  nand2  g56(.a(new_n72_), .b(new_n97_), .O(new_n98_));
  aoi21  g57(.a(new_n52_), .b(z04), .c(new_n69_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n46_), .O(z17));
  inv1   g60(.a(x06), .O(new_n102_));
  nand2  g61(.a(new_n72_), .b(new_n102_), .O(new_n103_));
  aoi21  g62(.a(new_n52_), .b(new_n59_), .c(new_n69_), .O(new_n104_));
  ...
  aoi21  g67(.a(new_n52_), .b(new_n43_), .c(new_n69_), .O(new_n109_));
