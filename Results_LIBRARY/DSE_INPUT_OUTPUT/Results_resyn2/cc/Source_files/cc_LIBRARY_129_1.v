...
module FAU ( 
  ...
  nor2   g26(.a(new_n44_), .b(new_n67_), .O(z11));
  ...
  oai21  g35(.a(new_n49_), .b(new_n53_), .c(x09), .O(new_n77_));
  ...
  nand4  g47(.a(new_n88_), .b(new_n43_), .c(x16), .d(new_n67_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n49_), .b(new_n62_), .O(new_n94_));
  ...
  nand2  g59(.a(new_n49_), .b(new_n100_), .O(new_n101_));
  ...
  nand2  g65(.a(new_n49_), .b(new_n60_), .O(new_n107_));
  ...
  nand2  g71(.a(new_n49_), .b(x20), .O(new_n113_));
