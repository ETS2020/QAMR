...
module FAU ( 
  ...
  nand2  g14(.a(new_n55_), .b(new_n49_), .O(z03));
  ...
  nor2   g22(.a(new_n44_), .b(new_n60_), .O(z08));
  ...
  oai21  g28(.a(new_n69_), .b(new_n51_), .c(new_n44_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n60_), .O(new_n71_));
  oai21  g30(.a(new_n51_), .b(x15), .c(x12), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n68_), .c(new_n71_), .O(z12));
  inv1   g32(.a(x01), .O(new_n74_));
  oai21  g33(.a(new_n51_), .b(new_n74_), .c(new_n44_), .O(new_n75_));
  nand2  g34(.a(new_n47_), .b(new_n50_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x12), .O(new_n77_));
  aoi21  g36(.a(new_n75_), .b(new_n60_), .c(new_n77_), .O(z13));
  and2   g37(.a(x10), .b(x08), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x02), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n47_), .b(x12), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n49_), .O(z14));
  inv1   g41(.a(x12), .O(new_n83_));
  nand2  g42(.a(z08), .b(new_n50_), .O(new_n84_));
  nand4  g43(.a(new_n79_), .b(new_n44_), .c(new_n60_), .d(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z15));
  nand2  g45(.a(x12), .b(x04), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n51_), .c(new_n44_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n60_), .O(new_n89_));
  oai21  g48(.a(new_n72_), .b(new_n62_), .c(new_n89_), .O(z16));
  nand2  g49(.a(x18), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n60_), .b(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  aoi21  g53(.a(new_n51_), .b(new_n94_), .c(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n91_), .c(new_n83_), .O(z17));
  nand2  g56(.a(x12), .b(x06), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n51_), .c(new_n44_), .O(new_n99_));
  ...
  nand2  g61(.a(new_n60_), .b(x07), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n79_), .O(new_n104_));
  aoi21  g63(.a(new_n51_), .b(new_n43_), .c(x16), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n102_), .c(new_n83_), .O(z19));
endmodule
