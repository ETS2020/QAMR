...
module FAU ( 
  ...
  nand2  g54(.a(new_n53_), .b(new_n65_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n55_), .O(new_n97_));
  ...
  nand3  g61(.a(new_n102_), .b(new_n100_), .c(new_n55_), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z17));
  nand4  g63(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n105_));
  aoi22  g64(.a(new_n105_), .b(new_n61_), .c(new_n54_), .d(x06), .O(z18));
