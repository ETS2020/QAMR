...
module FAU ( 
  ...
  oai21  g14(.a(new_n48_), .b(new_n52_), .c(new_n44_), .O(z03));
  ...
  nand2  g27(.a(new_n50_), .b(x18), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x13), .O(new_n71_));
  nand3  g30(.a(new_n51_), .b(x18), .c(x00), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n52_), .O(z12));
  ...
  nand3  g36(.a(new_n47_), .b(x18), .c(x02), .O(new_n78_));
  oai21  g37(.a(new_n50_), .b(new_n68_), .c(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n68_), .c(new_n79_), .O(z14));
  nand2  g39(.a(x12), .b(x03), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n50_), .c(x18), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n68_), .O(new_n83_));
  nand2  g42(.a(new_n47_), .b(new_n68_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(x16), .c(new_n46_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n83_), .O(z15));
  nand2  g45(.a(new_n70_), .b(x17), .O(new_n87_));
  nand3  g46(.a(new_n51_), .b(x18), .c(x04), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n52_), .O(z16));
  nor2   g48(.a(z04), .b(new_n52_), .O(new_n90_));
  oai21  g49(.a(new_n84_), .b(x05), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(z17));
  nand2  g51(.a(x12), .b(x06), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n50_), .c(x18), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n68_), .O(new_n95_));
  nand3  g54(.a(new_n84_), .b(x19), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n95_), .O(z18));
  nand2  g56(.a(x20), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n68_), .b(x07), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  inv1   g59(.a(x20), .O(new_n101_));
  aoi21  g60(.a(new_n50_), .b(new_n101_), .c(z04), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n98_), .c(new_n52_), .O(z19));
  buf    g63(.a(x15), .O(z06));
endmodule
