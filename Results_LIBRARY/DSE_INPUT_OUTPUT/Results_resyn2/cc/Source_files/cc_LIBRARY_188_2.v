...
module FAU ( 
  ...
  nor2   g20(.a(new_n45_), .b(new_n54_), .O(z06));
  ...
  aoi21  g39(.a(new_n80_), .b(new_n50_), .c(new_n78_), .O(z13));
  nand3  g40(.a(x10), .b(x08), .c(x02), .O(new_n82_));
  nand3  g41(.a(new_n50_), .b(new_n48_), .c(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n54_), .c(new_n83_), .O(z14));
  ...
  aoi21  g46(.a(new_n47_), .b(x06), .c(new_n58_), .O(new_n88_));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n54_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n74_), .b(x15), .c(new_n63_), .O(new_n91_));
  ...
  nor2   g58(.a(new_n47_), .b(x12), .O(new_n100_));
  nand2  g59(.a(new_n55_), .b(x19), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n44_), .c(new_n100_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand4  g62(.a(new_n54_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
  oai21  g63(.a(new_n74_), .b(x15), .c(new_n43_), .O(new_n105_));
