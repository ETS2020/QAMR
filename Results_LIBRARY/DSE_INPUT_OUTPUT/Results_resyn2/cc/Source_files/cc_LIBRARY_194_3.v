...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n51_,
    ...
    new_n62_, new_n65_, new_n68_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  nand3  g31(.a(new_n72_), .b(new_n51_), .c(new_n71_), .O(new_n73_));
  ...
  nand2  g42(.a(new_n54_), .b(new_n49_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z14));
  inv1   g44(.a(new_n54_), .O(new_n86_));
  nand3  g45(.a(new_n52_), .b(x16), .c(new_n47_), .O(new_n87_));
  nand3  g46(.a(new_n72_), .b(new_n51_), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand3  g49(.a(new_n72_), .b(new_n51_), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n52_), .b(new_n65_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z16));
  nand3  g53(.a(new_n72_), .b(new_n51_), .c(new_n60_), .O(new_n95_));
  ...
  nand3  g59(.a(new_n72_), .b(new_n51_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n52_), .b(new_n62_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n72_), .b(new_n51_), .c(new_n105_), .O(new_n106_));
