...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n73_, new_n76_, new_n79_;
  ...
  nor2   g24(.a(new_n43_), .b(new_n48_), .O(z11));
  ...
  aoi21  g29(.a(new_n69_), .b(new_n48_), .c(new_n70_), .O(z13));
  ...
  aoi21  g35(.a(new_n76_), .b(x15), .c(new_n42_), .O(z17));
