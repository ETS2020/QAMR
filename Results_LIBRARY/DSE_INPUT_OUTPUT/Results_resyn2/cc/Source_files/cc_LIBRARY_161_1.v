...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n55_, new_n58_, new_n61_, new_n66_, new_n67_,
  ...
  nor2   g15(.a(x19), .b(x18), .O(z04));
  nand2  g16(.a(x19), .b(x18), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z05));
  ...
  aoi21  g25(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n67_));
  ...
  nand3  g31(.a(new_n72_), .b(new_n69_), .c(new_n67_), .O(new_n73_));
  ...
  oai21  g38(.a(new_n71_), .b(new_n79_), .c(new_n51_), .O(new_n80_));
  ...
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n67_), .O(new_n104_));
