...
module FAU ( 
  ...
  nand2  g38(.a(new_n68_), .b(x02), .O(new_n80_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n49_), .O(z15));
  aoi21  g44(.a(new_n68_), .b(x04), .c(new_n49_), .O(new_n86_));
  nand3  g45(.a(new_n71_), .b(x17), .c(x12), .O(new_n87_));
  oai21  g46(.a(new_n86_), .b(x15), .c(new_n87_), .O(z16));
  aoi21  g47(.a(new_n68_), .b(x05), .c(new_n49_), .O(new_n89_));
  nand3  g48(.a(new_n71_), .b(x18), .c(x12), .O(new_n90_));
  oai21  g49(.a(new_n89_), .b(x15), .c(new_n90_), .O(z17));
  aoi21  g50(.a(new_n68_), .b(x06), .c(new_n49_), .O(new_n92_));
  nand3  g51(.a(new_n71_), .b(x19), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n92_), .b(x15), .c(new_n93_), .O(z18));
  inv1   g53(.a(x07), .O(new_n95_));
  nand3  g54(.a(new_n68_), .b(new_n70_), .c(new_n95_), .O(new_n96_));
  nand2  g55(.a(new_n71_), .b(new_n43_), .O(new_n97_));
