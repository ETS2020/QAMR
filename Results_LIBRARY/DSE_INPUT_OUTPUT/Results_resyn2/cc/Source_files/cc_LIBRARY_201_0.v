...
module FAU ( 
  ...
  oai21  g14(.a(new_n48_), .b(new_n55_), .c(new_n52_), .O(z03));
  nor2   g15(.a(new_n44_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(x15), .O(z05));
  ...
  nand2  g25(.a(new_n52_), .b(new_n46_), .O(z11));
  ...
  nor2   g30(.a(new_n68_), .b(x15), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(x19), .c(x00), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n71_), .c(new_n55_), .O(z12));
  ...
  nand3  g38(.a(new_n72_), .b(x19), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n55_), .O(z14));
  nand2  g40(.a(x12), .b(x03), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n68_), .c(x19), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n50_), .O(new_n84_));
  nand4  g43(.a(new_n51_), .b(x16), .c(new_n46_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z15));
  nand2  g45(.a(new_n70_), .b(x17), .O(new_n87_));
  nand3  g46(.a(new_n72_), .b(x19), .c(x04), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n55_), .O(z16));
  nand2  g48(.a(new_n70_), .b(x18), .O(new_n90_));
  nand3  g49(.a(new_n72_), .b(x19), .c(x05), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n55_), .O(z17));
  nor2   g51(.a(new_n58_), .b(new_n55_), .O(new_n93_));
  oai21  g52(.a(new_n51_), .b(x06), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n52_), .O(z18));
  nand2  g54(.a(x20), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n50_), .b(x07), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  aoi21  g57(.a(new_n68_), .b(new_n43_), .c(new_n58_), .O(new_n99_));
