...
module FAU ( 
  ...
  nand3  g13(.a(new_n54_), .b(x12), .c(new_n53_), .O(new_n55_));
  aoi21  g14(.a(new_n52_), .b(new_n46_), .c(new_n55_), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  oai21  g16(.a(new_n49_), .b(new_n57_), .c(new_n54_), .O(z03));
  inv1   g17(.a(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n45_), .b(new_n60_), .O(z05));
  nand2  g20(.a(new_n54_), .b(new_n51_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n54_), .b(new_n63_), .O(z07));
  ...
  nor2   g29(.a(new_n45_), .b(new_n57_), .O(new_n71_));
  ...
  and2   g41(.a(new_n82_), .b(new_n71_), .O(z13));
  aoi21  g42(.a(new_n48_), .b(x02), .c(x15), .O(new_n84_));
  nand2  g43(.a(new_n71_), .b(new_n79_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z14));
  nand3  g45(.a(new_n52_), .b(x16), .c(new_n46_), .O(new_n87_));
  nand3  g46(.a(new_n48_), .b(new_n51_), .c(x03), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n54_), .O(z15));
  inv1   g50(.a(x04), .O(new_n92_));
  nand2  g51(.a(new_n73_), .b(new_n92_), .O(new_n93_));
  aoi21  g52(.a(new_n52_), .b(new_n63_), .c(new_n57_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n54_), .O(z16));
  inv1   g55(.a(x05), .O(new_n97_));
  nand2  g56(.a(new_n73_), .b(new_n97_), .O(new_n98_));
  aoi21  g57(.a(new_n52_), .b(z04), .c(new_n57_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n54_), .O(z17));
  inv1   g60(.a(x06), .O(new_n102_));
  nand2  g61(.a(new_n73_), .b(new_n102_), .O(new_n103_));
  aoi21  g62(.a(new_n52_), .b(new_n60_), .c(new_n57_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n54_), .O(z18));
  inv1   g65(.a(x07), .O(new_n107_));
  nand2  g66(.a(new_n73_), .b(new_n107_), .O(new_n108_));
  aoi21  g67(.a(new_n52_), .b(new_n44_), .c(new_n57_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n54_), .O(z19));
endmodule
