...
module FAU ( 
  ...
  nand2  g02(.a(x17), .b(x16), .O(new_n44_));
  ...
  aoi21  g24(.a(x17), .b(x16), .c(new_n56_), .O(new_n66_));
  inv1   g25(.a(x00), .O(new_n67_));
  and2   g26(.a(x10), .b(x08), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(new_n52_), .c(new_n67_), .O(new_n69_));
  inv1   g28(.a(x13), .O(new_n70_));
  nand2  g29(.a(new_n53_), .b(new_n70_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z12));
  nand2  g32(.a(new_n48_), .b(new_n47_), .O(new_n74_));
  nand4  g33(.a(new_n52_), .b(x10), .c(x08), .d(x01), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n74_), .c(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n44_), .O(z13));
  inv1   g36(.a(x02), .O(new_n78_));
  nand2  g37(.a(x10), .b(x08), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n52_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n48_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z14));
  inv1   g41(.a(x17), .O(new_n83_));
  nand4  g42(.a(new_n53_), .b(new_n83_), .c(x16), .d(new_n47_), .O(new_n84_));
  nand4  g43(.a(new_n68_), .b(new_n44_), .c(new_n52_), .d(x03), .O(new_n85_));
  ...
  oai21  g47(.a(new_n79_), .b(x15), .c(new_n83_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n44_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand3  g51(.a(new_n68_), .b(new_n52_), .c(new_n92_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  nand2  g53(.a(new_n53_), .b(new_n94_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n93_), .c(new_n66_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand3  g57(.a(new_n68_), .b(new_n52_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n53_), .b(new_n59_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n66_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand3  g62(.a(new_n68_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n53_), .b(new_n43_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n66_), .O(new_n106_));
