...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(new_n47_), .O(z02));
  ...
  nor2   g23(.a(z03), .b(new_n49_), .O(z11));
  nand3  g24(.a(x10), .b(x08), .c(x00), .O(new_n66_));
  aoi21  g25(.a(new_n52_), .b(x13), .c(x15), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n66_), .c(new_n47_), .O(z12));
  inv1   g27(.a(x01), .O(new_n69_));
  oai21  g28(.a(new_n52_), .b(new_n69_), .c(x14), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n48_), .c(new_n47_), .O(z13));
  nand3  g30(.a(x10), .b(x08), .c(x02), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n48_), .c(new_n47_), .O(z14));
  nand3  g32(.a(x10), .b(x08), .c(x03), .O(new_n74_));
  nand3  g33(.a(new_n52_), .b(x16), .c(new_n49_), .O(new_n75_));
  nand2  g34(.a(new_n48_), .b(x12), .O(new_n76_));
  aoi21  g35(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(z15));
  nor2   g36(.a(x15), .b(new_n47_), .O(new_n78_));
  inv1   g37(.a(x04), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(new_n79_), .O(new_n80_));
  nand2  g39(.a(new_n52_), .b(new_n58_), .O(new_n81_));
  ...
  nand2  g45(.a(new_n52_), .b(new_n86_), .O(new_n87_));
