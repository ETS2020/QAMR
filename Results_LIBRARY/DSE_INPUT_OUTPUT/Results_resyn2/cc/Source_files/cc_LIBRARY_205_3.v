...
module FAU ( 
  ...
  and2   g11(.a(x19), .b(x02), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(x12), .c(z01), .O(new_n54_));
  inv1   g13(.a(new_n54_), .O(z03));
  nor2   g14(.a(new_n53_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(x02), .O(z05));
  inv1   g17(.a(x15), .O(new_n59_));
  nor2   g18(.a(new_n53_), .b(new_n59_), .O(z06));
  ...
  and2   g35(.a(new_n45_), .b(new_n43_), .O(new_n77_));
  inv1   g36(.a(x01), .O(new_n78_));
  oai21  g37(.a(new_n47_), .b(new_n78_), .c(x14), .O(new_n79_));
  aoi22  g38(.a(new_n79_), .b(new_n77_), .c(new_n43_), .d(new_n49_), .O(z13));
  nand4  g39(.a(new_n59_), .b(x12), .c(x10), .d(x08), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n57_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x02), .O(new_n83_));
  nand3  g42(.a(new_n47_), .b(x15), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n83_), .O(z14));
  nand3  g44(.a(new_n73_), .b(x16), .c(new_n66_), .O(new_n86_));
  nand2  g45(.a(new_n48_), .b(x03), .O(new_n87_));
  ...
  nand2  g49(.a(new_n73_), .b(new_n61_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n43_), .O(z16));
  ...
  nand2  g60(.a(new_n73_), .b(new_n57_), .O(new_n102_));
  ...
  nand2  g68(.a(new_n109_), .b(new_n43_), .O(z19));
endmodule
