...
module FAU ( 
  ...
  nor2   g18(.a(new_n43_), .b(new_n53_), .O(z06));
  ...
  nand4  g28(.a(new_n43_), .b(x10), .c(x08), .d(new_n69_), .O(new_n70_));
  ...
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n53_), .O(z13));
  nand2  g37(.a(new_n48_), .b(x02), .O(new_n79_));
  oai21  g38(.a(new_n51_), .b(new_n43_), .c(x12), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(new_n43_), .c(new_n80_), .O(z14));
  nand2  g40(.a(new_n48_), .b(new_n43_), .O(new_n82_));
  ...
  oai21  g48(.a(new_n51_), .b(x15), .c(new_n61_), .O(new_n90_));
  ...
  oai21  g57(.a(new_n51_), .b(x06), .c(x12), .O(new_n99_));
  nor2   g58(.a(x19), .b(new_n53_), .O(new_n100_));
  aoi22  g59(.a(new_n100_), .b(new_n82_), .c(new_n99_), .d(new_n43_), .O(z18));
  oai21  g60(.a(new_n51_), .b(x07), .c(x12), .O(new_n102_));
  nor2   g61(.a(x20), .b(new_n53_), .O(new_n103_));
  aoi22  g62(.a(new_n103_), .b(new_n82_), .c(new_n102_), .d(new_n43_), .O(z19));
