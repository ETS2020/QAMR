...
module FAU ( 
  ...
  nand2  g34(.a(new_n75_), .b(new_n54_), .O(z12));
  ...
  oai21  g42(.a(new_n49_), .b(new_n83_), .c(new_n47_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n79_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n54_), .O(z14));
  nand3  g45(.a(new_n53_), .b(x16), .c(new_n52_), .O(new_n87_));
  ...
  nand2  g62(.a(new_n53_), .b(new_n44_), .O(new_n104_));
