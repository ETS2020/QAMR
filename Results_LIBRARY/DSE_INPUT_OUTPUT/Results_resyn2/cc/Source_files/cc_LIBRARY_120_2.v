...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n64_, new_n66_, new_n68_, new_n72_, new_n73_, new_n74_,
  ...
  aoi21  g12(.a(new_n53_), .b(x06), .c(new_n52_), .O(new_n54_));
  ...
  nand2  g38(.a(new_n79_), .b(new_n58_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n57_), .O(z13));
  nand3  g41(.a(x10), .b(x08), .c(x02), .O(new_n83_));
  nand2  g42(.a(new_n58_), .b(new_n54_), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n47_), .c(new_n84_), .O(z14));
  inv1   g44(.a(x03), .O(new_n86_));
  nand4  g45(.a(new_n47_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  nand2  g46(.a(x16), .b(new_n48_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n51_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n87_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n57_), .O(z15));
  inv1   g50(.a(x04), .O(new_n92_));
  nand4  g51(.a(new_n47_), .b(x10), .c(x08), .d(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n51_), .b(new_n64_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n54_), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z16));
  inv1   g55(.a(x05), .O(new_n97_));
  nand4  g56(.a(new_n47_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  inv1   g57(.a(x18), .O(new_n99_));
  nand2  g58(.a(new_n51_), .b(new_n99_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n98_), .c(new_n54_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  inv1   g61(.a(new_n51_), .O(new_n103_));
  nand2  g62(.a(x19), .b(x12), .O(new_n104_));
  aoi21  g63(.a(new_n103_), .b(new_n44_), .c(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand4  g65(.a(new_n47_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  nand2  g66(.a(new_n51_), .b(new_n43_), .O(new_n108_));
