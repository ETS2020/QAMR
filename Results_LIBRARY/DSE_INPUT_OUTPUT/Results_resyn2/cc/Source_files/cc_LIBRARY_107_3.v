...
module FAU ( 
  ...
  nor2   g15(.a(z03), .b(new_n56_), .O(z07));
  ...
  nand3  g27(.a(new_n46_), .b(x14), .c(x12), .O(new_n69_));
  aoi21  g28(.a(new_n68_), .b(x01), .c(new_n69_), .O(z13));
  nand2  g29(.a(new_n68_), .b(x02), .O(new_n71_));
  ...
  nand2  g37(.a(new_n65_), .b(new_n56_), .O(new_n79_));
  ...
  aoi21  g47(.a(new_n65_), .b(x19), .c(x15), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(z18));
  nand3  g49(.a(x10), .b(x08), .c(x07), .O(new_n91_));
  aoi21  g50(.a(new_n65_), .b(x20), .c(x15), .O(new_n92_));
