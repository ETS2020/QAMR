...
module FAU ( 
  ...
  nand2  g13(.a(x18), .b(new_n54_), .O(new_n55_));
  ...
  nand2  g20(.a(new_n55_), .b(new_n52_), .O(z06));
  ...
  aoi21  g28(.a(x18), .b(new_n54_), .c(new_n58_), .O(new_n70_));
  ...
  nand2  g36(.a(new_n55_), .b(x12), .O(new_n78_));
  ...
  aoi22  g53(.a(new_n94_), .b(z04), .c(new_n58_), .d(x05), .O(z17));
  ...
  nand2  g63(.a(new_n104_), .b(new_n55_), .O(z19));
endmodule
