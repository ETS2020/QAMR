...
module FAU ( 
  ...
  nor2   g27(.a(new_n68_), .b(new_n61_), .O(z09));
  and2   g28(.a(new_n68_), .b(new_n46_), .O(z10));
  nor2   g29(.a(new_n61_), .b(new_n47_), .O(z11));
  ...
  aoi21  g40(.a(new_n80_), .b(new_n48_), .c(new_n81_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n52_), .O(new_n84_));
  ...
  nand2  g58(.a(new_n53_), .b(new_n43_), .O(new_n100_));
