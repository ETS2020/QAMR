...
module FAU ( 
  ...
  nor2   g09(.a(new_n46_), .b(x15), .O(new_n51_));
  ...
  and2   g22(.a(new_n50_), .b(x16), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n58_), .O(z09));
  and2   g25(.a(new_n65_), .b(new_n50_), .O(z10));
  ...
  nand2  g35(.a(new_n56_), .b(new_n44_), .O(new_n77_));
  ...
  nand2  g44(.a(new_n85_), .b(new_n50_), .O(z14));
  nand2  g45(.a(new_n51_), .b(x03), .O(new_n87_));
  nand3  g46(.a(new_n43_), .b(x10), .c(x08), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n50_), .c(x16), .d(new_n47_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n52_), .O(z15));
  oai21  g49(.a(new_n62_), .b(new_n52_), .c(new_n44_), .O(new_n91_));
  ...
  oai21  g64(.a(new_n60_), .b(new_n52_), .c(new_n44_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n46_), .b(x19), .O(new_n108_));
  nand4  g67(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n109_));
  ...
  nand2  g71(.a(new_n46_), .b(new_n44_), .O(new_n113_));
  inv1   g72(.a(x07), .O(new_n114_));
  nand3  g73(.a(x10), .b(x08), .c(new_n114_), .O(new_n115_));
  nand4  g74(.a(new_n115_), .b(new_n113_), .c(new_n43_), .d(x12), .O(new_n116_));
