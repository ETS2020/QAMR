...
module FAU ( 
  ...
  nand2  g27(.a(new_n47_), .b(new_n68_), .O(z11));
  ...
  aoi21  g36(.a(new_n77_), .b(new_n45_), .c(new_n54_), .O(z13));
  ...
  nand2  g41(.a(x16), .b(new_n68_), .O(new_n83_));
  inv1   g42(.a(x03), .O(new_n84_));
  nand4  g43(.a(new_n59_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x12), .O(new_n86_));
  aoi21  g45(.a(new_n83_), .b(new_n73_), .c(new_n86_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  oai21  g47(.a(new_n49_), .b(new_n88_), .c(x12), .O(new_n89_));
