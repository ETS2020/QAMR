...
module FAU ( 
  ...
  nand3  g28(.a(new_n48_), .b(new_n44_), .c(x00), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n68_), .c(new_n69_), .O(z12));
  oai21  g30(.a(new_n48_), .b(x14), .c(x15), .O(new_n72_));
  nand2  g31(.a(new_n48_), .b(x01), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x14), .c(new_n68_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n54_), .O(z13));
  nand2  g34(.a(x10), .b(x08), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x15), .O(new_n77_));
  nand4  g36(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  ...
  oai21  g42(.a(new_n62_), .b(x14), .c(new_n76_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(new_n68_), .O(new_n85_));
  ...
  aoi21  g49(.a(new_n76_), .b(new_n60_), .c(x13), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n88_), .c(new_n54_), .O(z16));
  ...
  aoi21  g56(.a(new_n76_), .b(new_n97_), .c(x13), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n94_), .c(new_n54_), .O(z17));
  nand2  g59(.a(x12), .b(x06), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n76_), .c(new_n68_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n44_), .O(new_n103_));
  nand2  g62(.a(new_n51_), .b(x12), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n57_), .c(new_n103_), .O(z18));
  nand2  g64(.a(x12), .b(x07), .O(new_n106_));
  oai21  g65(.a(new_n106_), .b(new_n76_), .c(new_n68_), .O(new_n107_));
