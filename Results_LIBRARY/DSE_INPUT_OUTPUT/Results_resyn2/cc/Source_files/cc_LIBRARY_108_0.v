...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(x12), .O(z06));
  ...
  nand3  g29(.a(new_n70_), .b(new_n60_), .c(new_n69_), .O(new_n71_));
  ...
  inv1   g40(.a(new_n47_), .O(new_n82_));
  nand2  g41(.a(new_n70_), .b(x02), .O(new_n83_));
  xor2a  g42(.a(x15), .b(x12), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(z14));
  aoi21  g44(.a(new_n70_), .b(x03), .c(new_n49_), .O(new_n86_));
  nand4  g45(.a(new_n73_), .b(x16), .c(new_n50_), .d(x12), .O(new_n87_));
  oai21  g46(.a(new_n86_), .b(x15), .c(new_n87_), .O(z15));
  aoi21  g47(.a(new_n70_), .b(x04), .c(new_n49_), .O(new_n89_));
  nand3  g48(.a(new_n73_), .b(x17), .c(x12), .O(new_n90_));
  oai21  g49(.a(new_n89_), .b(x15), .c(new_n90_), .O(z16));
  aoi21  g50(.a(new_n70_), .b(x05), .c(new_n49_), .O(new_n92_));
  nand3  g51(.a(new_n73_), .b(x18), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n92_), .b(x15), .c(new_n93_), .O(z17));
  aoi21  g53(.a(new_n70_), .b(x06), .c(new_n49_), .O(new_n95_));
  nand3  g54(.a(new_n73_), .b(x19), .c(x12), .O(new_n96_));
  oai21  g55(.a(new_n95_), .b(x15), .c(new_n96_), .O(z18));
  inv1   g56(.a(x07), .O(new_n98_));
  nand3  g57(.a(new_n70_), .b(new_n60_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n73_), .b(new_n43_), .O(new_n100_));
