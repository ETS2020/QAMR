...
module FAU ( 
  ...
  oai21  g08(.a(new_n49_), .b(x14), .c(new_n47_), .O(z01));
  ...
  nor3   g15(.a(new_n49_), .b(x14), .c(new_n56_), .O(z03));
  ...
  oai21  g25(.a(new_n61_), .b(x08), .c(x09), .O(z10));
  ...
  nand3  g36(.a(new_n77_), .b(x14), .c(new_n44_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n56_), .O(z13));
  aoi21  g38(.a(new_n48_), .b(x02), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n49_), .b(x12), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n47_), .O(z14));
  nand3  g41(.a(x16), .b(x15), .c(new_n51_), .O(new_n83_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n48_), .O(new_n85_));
  oai21  g44(.a(new_n65_), .b(x14), .c(new_n52_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(new_n85_), .c(new_n44_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n83_), .c(new_n56_), .O(z15));
  nand2  g47(.a(x17), .b(x15), .O(new_n89_));
  nand2  g48(.a(new_n61_), .b(x04), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n48_), .O(new_n91_));
  aoi21  g50(.a(new_n52_), .b(new_n63_), .c(x09), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n89_), .c(new_n56_), .O(z16));
  inv1   g53(.a(x18), .O(new_n95_));
  nand2  g54(.a(x12), .b(x05), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n52_), .c(new_n44_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n61_), .O(new_n98_));
  oai21  g57(.a(new_n74_), .b(new_n95_), .c(new_n98_), .O(z17));
  nand2  g58(.a(x19), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n61_), .b(x06), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  aoi21  g61(.a(new_n52_), .b(new_n59_), .c(x09), .O(new_n103_));
  ...
  nand2  g65(.a(new_n61_), .b(x07), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  aoi21  g67(.a(new_n52_), .b(new_n43_), .c(x09), .O(new_n109_));
