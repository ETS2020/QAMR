...
module FAU ( 
  ...
  nand3  g30(.a(new_n71_), .b(new_n49_), .c(new_n70_), .O(new_n72_));
  ...
  xor2a  g41(.a(x15), .b(x12), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n54_), .O(z14));
  aoi21  g43(.a(new_n71_), .b(x03), .c(new_n55_), .O(new_n85_));
  nand3  g44(.a(new_n56_), .b(new_n50_), .c(x16), .O(new_n86_));
  oai21  g45(.a(new_n85_), .b(x15), .c(new_n86_), .O(z15));
  aoi21  g46(.a(new_n71_), .b(x04), .c(new_n55_), .O(new_n88_));
  nand3  g47(.a(new_n50_), .b(x17), .c(x12), .O(new_n89_));
  oai21  g48(.a(new_n88_), .b(x15), .c(new_n89_), .O(z16));
