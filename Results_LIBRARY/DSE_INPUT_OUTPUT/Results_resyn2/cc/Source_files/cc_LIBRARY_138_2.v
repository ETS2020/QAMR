...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n62_, new_n65_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  aoi21  g37(.a(new_n78_), .b(new_n58_), .c(new_n76_), .O(z13));
  nand3  g38(.a(x10), .b(x08), .c(x02), .O(new_n80_));
  nand2  g39(.a(new_n58_), .b(new_n54_), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n47_), .c(new_n81_), .O(z14));
  inv1   g41(.a(x03), .O(new_n83_));
  nand4  g42(.a(new_n47_), .b(x10), .c(x08), .d(new_n83_), .O(new_n84_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n57_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n47_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n51_), .b(new_n65_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n54_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  nand4  g52(.a(new_n44_), .b(new_n47_), .c(x10), .d(x08), .O(new_n94_));
  inv1   g53(.a(x05), .O(new_n95_));
  nand4  g54(.a(new_n47_), .b(x10), .c(x08), .d(new_n95_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x12), .O(new_n97_));
  aoi21  g56(.a(new_n94_), .b(new_n53_), .c(new_n97_), .O(z17));
  ...
  nand2  g61(.a(new_n102_), .b(new_n57_), .O(z18));
  ...
  nand2  g66(.a(new_n107_), .b(new_n57_), .O(z19));
  buf    g67(.a(x16), .O(z08));
endmodule
