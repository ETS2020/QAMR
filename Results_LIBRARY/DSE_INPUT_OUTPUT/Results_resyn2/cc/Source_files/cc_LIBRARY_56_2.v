...
module FAU ( 
  ...
  nand2  g04(.a(z04), .b(x11), .O(new_n46_));
  ...
  nand2  g13(.a(new_n46_), .b(new_n51_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(z01), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(z03));
  inv1   g16(.a(x19), .O(new_n58_));
  nor2   g17(.a(x18), .b(new_n42_), .O(new_n59_));
  ...
  nor2   g29(.a(new_n59_), .b(new_n70_), .O(z11));
  ...
  oai21  g42(.a(new_n49_), .b(new_n83_), .c(new_n61_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n47_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n46_), .O(z14));
  inv1   g45(.a(new_n55_), .O(new_n87_));
  nand3  g46(.a(new_n75_), .b(x16), .c(new_n70_), .O(new_n88_));
  aoi21  g47(.a(new_n50_), .b(x03), .c(new_n59_), .O(new_n89_));
  ...
  nand2  g61(.a(new_n75_), .b(new_n58_), .O(new_n103_));
