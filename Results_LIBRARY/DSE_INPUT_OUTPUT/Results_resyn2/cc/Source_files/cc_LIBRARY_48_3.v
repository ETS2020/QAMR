...
module FAU ( 
  ...
  nand2  g01(.a(x18), .b(x02), .O(new_n43_));
  ...
  nand4  g30(.a(new_n48_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  nand2  g32(.a(new_n49_), .b(new_n73_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n72_), .c(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(z12));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x14), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n45_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(z13));
  nand4  g40(.a(new_n48_), .b(x12), .c(x10), .d(x08), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(z04), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x02), .O(new_n84_));
  nand3  g43(.a(new_n55_), .b(x15), .c(x12), .O(new_n85_));
  ...
  nand4  g52(.a(new_n48_), .b(x10), .c(x08), .d(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n49_), .b(new_n64_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  nand4  g57(.a(new_n48_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  nor2   g58(.a(new_n61_), .b(new_n51_), .O(new_n100_));
  nand2  g59(.a(new_n49_), .b(z04), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand4  g63(.a(new_n48_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n49_), .b(new_n60_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n100_), .O(new_n107_));
  inv1   g66(.a(new_n107_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  nand4  g68(.a(new_n48_), .b(x10), .c(x08), .d(new_n109_), .O(new_n110_));
  inv1   g69(.a(x20), .O(new_n111_));
  nand2  g70(.a(new_n49_), .b(new_n111_), .O(new_n112_));
  nand3  g71(.a(new_n112_), .b(new_n110_), .c(new_n100_), .O(new_n113_));
