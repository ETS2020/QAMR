...
module FAU ( 
  ...
  nand2  g04(.a(x20), .b(x07), .O(new_n46_));
  ...
  oai21  g10(.a(new_n51_), .b(x15), .c(new_n48_), .O(new_n52_));
  nand3  g11(.a(new_n52_), .b(x12), .c(new_n43_), .O(new_n53_));
  ...
  and2   g26(.a(new_n66_), .b(new_n46_), .O(z10));
  nor2   g27(.a(new_n57_), .b(new_n48_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  inv1   g29(.a(x15), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(x10), .c(x08), .d(new_n70_), .O(new_n72_));
  aoi21  g31(.a(x20), .b(x07), .c(new_n55_), .O(new_n73_));
  ...
  oai21  g42(.a(new_n51_), .b(new_n83_), .c(new_n71_), .O(new_n84_));
  ...
  nand4  g47(.a(new_n71_), .b(x10), .c(x08), .d(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n78_), .O(z15));
  inv1   g49(.a(x04), .O(new_n91_));
  nand4  g50(.a(new_n71_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  oai21  g51(.a(new_n51_), .b(x15), .c(new_n62_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n46_), .O(z16));
  inv1   g54(.a(x05), .O(new_n96_));
  nand4  g55(.a(new_n71_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  inv1   g56(.a(x18), .O(new_n98_));
  oai21  g57(.a(new_n51_), .b(x15), .c(new_n98_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n97_), .c(new_n73_), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z17));
  inv1   g60(.a(x06), .O(new_n102_));
  nand4  g61(.a(new_n71_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n51_), .b(x15), .c(new_n59_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n73_), .O(new_n105_));
  inv1   g64(.a(new_n105_), .O(z18));
  nand4  g65(.a(new_n71_), .b(x12), .c(x10), .d(x08), .O(new_n107_));
  oai21  g66(.a(new_n51_), .b(x15), .c(x12), .O(new_n108_));
  aoi22  g67(.a(new_n108_), .b(new_n42_), .c(new_n107_), .d(new_n44_), .O(z19));
endmodule
