...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n50_, new_n51_, new_n52_,
  ...
  nand2  g08(.a(z04), .b(new_n45_), .O(new_n50_));
  ...
  nand2  g21(.a(new_n50_), .b(new_n62_), .O(z06));
  ...
  nand3  g30(.a(new_n71_), .b(new_n62_), .c(new_n70_), .O(new_n72_));
  nor2   g31(.a(new_n42_), .b(new_n53_), .O(new_n73_));
  ...
  nand4  g37(.a(new_n62_), .b(x10), .c(x08), .d(x01), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x14), .O(new_n80_));
  nand3  g39(.a(new_n71_), .b(x18), .c(x15), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n53_), .O(z13));
  nand2  g41(.a(new_n71_), .b(x02), .O(new_n83_));
  nand3  g42(.a(new_n47_), .b(new_n50_), .c(x12), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n62_), .c(new_n84_), .O(z14));
  nand4  g44(.a(new_n71_), .b(new_n50_), .c(new_n62_), .d(x03), .O(new_n86_));
  nand4  g45(.a(new_n75_), .b(x18), .c(x16), .d(new_n45_), .O(new_n87_));
  ...
  oai21  g49(.a(new_n51_), .b(x15), .c(new_n64_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n50_), .O(z16));
  nand2  g52(.a(new_n52_), .b(x14), .O(new_n94_));
  inv1   g53(.a(x05), .O(new_n95_));
  nand4  g54(.a(new_n62_), .b(x10), .c(x08), .d(new_n95_), .O(new_n96_));
  ...
  oai21  g59(.a(new_n51_), .b(x15), .c(new_n60_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n50_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand3  g63(.a(new_n71_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  inv1   g64(.a(x20), .O(new_n106_));
  nand2  g65(.a(new_n75_), .b(new_n106_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n105_), .c(new_n73_), .O(new_n108_));
