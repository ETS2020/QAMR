...
module FAU ( 
  ...
  nor2   g18(.a(new_n43_), .b(new_n51_), .O(z06));
  ...
  nand2  g28(.a(new_n42_), .b(x12), .O(new_n70_));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n47_), .c(new_n70_), .O(z13));
  ...
  nand3  g68(.a(new_n109_), .b(new_n107_), .c(new_n71_), .O(new_n110_));
