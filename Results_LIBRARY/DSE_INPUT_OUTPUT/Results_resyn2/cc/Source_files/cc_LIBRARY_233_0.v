...
module FAU ( 
  ...
  aoi21  g28(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(z12));
  oai21  g29(.a(new_n48_), .b(x14), .c(x15), .O(new_n71_));
  nand2  g30(.a(new_n48_), .b(x01), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(x14), .c(x13), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n71_), .c(new_n55_), .O(z13));
  nand2  g33(.a(x10), .b(x08), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x15), .O(new_n76_));
  nand4  g35(.a(new_n51_), .b(x10), .c(x08), .d(x02), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n45_), .O(z14));
  nand2  g39(.a(new_n51_), .b(x03), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n48_), .O(new_n82_));
  oai21  g41(.a(new_n62_), .b(x14), .c(new_n75_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n82_), .c(x13), .O(new_n84_));
  nand3  g43(.a(x16), .b(x15), .c(new_n47_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n55_), .O(z15));
  nand2  g45(.a(x17), .b(x15), .O(new_n87_));
  nand2  g46(.a(new_n51_), .b(x04), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n48_), .O(new_n89_));
  inv1   g48(.a(x13), .O(new_n90_));
  aoi21  g49(.a(new_n75_), .b(new_n60_), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n87_), .c(new_n55_), .O(z16));
  nand2  g52(.a(x18), .b(x15), .O(new_n94_));
  nand2  g53(.a(new_n51_), .b(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n48_), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  aoi21  g56(.a(new_n75_), .b(new_n97_), .c(new_n90_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n94_), .c(new_n55_), .O(z17));
  nand2  g59(.a(x12), .b(x06), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n75_), .c(x13), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n51_), .O(new_n103_));
  nand2  g62(.a(new_n52_), .b(x12), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n58_), .c(new_n103_), .O(z18));
  ...
  oai21  g67(.a(new_n104_), .b(new_n43_), .c(new_n108_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
