...
module FAU ( 
  ...
  oai21  g24(.a(new_n44_), .b(x08), .c(x09), .O(z10));
  inv1   g25(.a(z10), .O(z09));
  nand2  g26(.a(new_n45_), .b(new_n51_), .O(z11));
  ...
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(x09), .O(new_n74_));
  ...
  nand3  g37(.a(new_n78_), .b(x14), .c(new_n60_), .O(new_n79_));
  ...
  nand3  g42(.a(x16), .b(x15), .c(new_n51_), .O(new_n84_));
  nand2  g43(.a(new_n44_), .b(x03), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n48_), .O(new_n86_));
  oai21  g45(.a(new_n64_), .b(x14), .c(new_n73_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n86_), .c(new_n60_), .O(new_n88_));
  ...
  aoi21  g51(.a(new_n73_), .b(new_n62_), .c(x09), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n90_), .c(new_n55_), .O(z16));
  inv1   g54(.a(x18), .O(new_n96_));
  nand2  g55(.a(x12), .b(x05), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n73_), .c(new_n60_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n44_), .O(new_n99_));
  nand2  g58(.a(new_n52_), .b(x12), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n96_), .c(new_n99_), .O(z17));
  nand2  g60(.a(x12), .b(x06), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n73_), .c(new_n60_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(new_n104_));
  oai21  g63(.a(new_n100_), .b(new_n58_), .c(new_n104_), .O(z18));
  nand2  g64(.a(x20), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n44_), .b(x07), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  aoi21  g67(.a(new_n73_), .b(new_n43_), .c(x09), .O(new_n109_));
