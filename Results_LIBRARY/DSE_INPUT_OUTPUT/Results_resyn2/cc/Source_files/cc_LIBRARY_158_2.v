...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x17), .c(new_n43_), .O(z01));
  ...
  nand3  g15(.a(new_n48_), .b(x17), .c(x15), .O(new_n57_));
  nor3   g16(.a(new_n57_), .b(x14), .c(new_n53_), .O(z03));
  nand2  g17(.a(new_n45_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n44_), .b(new_n60_), .O(z05));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n43_), .O(z07));
  ...
  aoi21  g38(.a(new_n62_), .b(x15), .c(new_n47_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n57_), .c(new_n53_), .O(z13));
  nand2  g41(.a(new_n52_), .b(x02), .O(new_n83_));
  nand3  g42(.a(new_n51_), .b(x17), .c(x15), .O(new_n84_));
  ...
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n43_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z16));
  ...
  nand3  g65(.a(x19), .b(x17), .c(x15), .O(new_n107_));
  inv1   g66(.a(x06), .O(new_n108_));
  nand3  g67(.a(x10), .b(x08), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n51_), .b(new_n60_), .O(new_n110_));
  ...
  nand2  g72(.a(new_n113_), .b(x17), .O(new_n114_));
