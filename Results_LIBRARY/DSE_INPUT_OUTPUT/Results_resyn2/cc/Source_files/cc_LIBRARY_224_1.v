...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n63_, new_n66_, new_n68_, new_n70_, new_n73_, new_n74_,
  ...
  nand2  g07(.a(x18), .b(new_n48_), .O(new_n49_));
  ...
  aoi21  g14(.a(x18), .b(new_n48_), .c(new_n55_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n42_), .O(new_n57_));
  aoi21  g16(.a(new_n54_), .b(new_n47_), .c(new_n57_), .O(z02));
  inv1   g17(.a(new_n51_), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(new_n49_), .c(new_n47_), .d(x12), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z03));
  nand2  g20(.a(x18), .b(x05), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nand2  g22(.a(new_n49_), .b(new_n63_), .O(z05));
  nor2   g23(.a(new_n45_), .b(new_n53_), .O(z06));
  ...
  nand2  g29(.a(new_n70_), .b(new_n49_), .O(z09));
  inv1   g30(.a(z09), .O(z10));
  inv1   g31(.a(x00), .O(new_n73_));
  nand4  g32(.a(new_n53_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nand2  g34(.a(new_n54_), .b(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n74_), .c(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n49_), .O(z12));
  ...
  nand2  g43(.a(new_n56_), .b(new_n51_), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n53_), .c(new_n85_), .O(z14));
  ...
  nand2  g50(.a(new_n91_), .b(new_n49_), .O(z15));
  inv1   g51(.a(x04), .O(new_n93_));
  nand4  g52(.a(new_n53_), .b(x10), .c(x08), .d(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n54_), .b(new_n66_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n49_), .O(z16));
  nand2  g56(.a(x12), .b(x05), .O(new_n98_));
  aoi21  g57(.a(new_n54_), .b(new_n44_), .c(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n53_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n54_), .b(new_n63_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(new_n56_), .O(new_n103_));
