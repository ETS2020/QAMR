...
module FAU ( 
  ...
  nor2   g06(.a(z04), .b(x11), .O(new_n48_));
  ...
  oai21  g43(.a(new_n55_), .b(new_n84_), .c(new_n46_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n80_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z14));
  inv1   g46(.a(x03), .O(new_n88_));
  nand4  g47(.a(new_n46_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  nand2  g48(.a(x16), .b(new_n49_), .O(new_n90_));
  ...
  nand4  g53(.a(new_n46_), .b(x10), .c(x08), .d(new_n94_), .O(new_n95_));
  nand2  g54(.a(new_n52_), .b(new_n62_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n73_), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z16));
  inv1   g57(.a(x05), .O(new_n99_));
  nand4  g58(.a(new_n46_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
