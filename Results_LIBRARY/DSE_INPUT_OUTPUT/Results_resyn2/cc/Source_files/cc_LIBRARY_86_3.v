...
module FAU ( 
  ...
  nand2  g02(.a(x18), .b(x04), .O(new_n44_));
  ...
  aoi21  g12(.a(x18), .b(x04), .c(new_n53_), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n47_), .c(new_n76_), .O(z13));
  inv1   g39(.a(x02), .O(new_n81_));
  oai21  g40(.a(new_n78_), .b(new_n81_), .c(new_n51_), .O(new_n82_));
  ...
  nand4  g49(.a(new_n51_), .b(x10), .c(x08), .d(new_n58_), .O(new_n91_));
  ...
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n54_), .O(new_n99_));
  ...
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n54_), .O(new_n104_));
