...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(z04), .c(new_n45_), .O(z01));
  ...
  oai21  g32(.a(new_n48_), .b(new_n53_), .c(z04), .O(new_n74_));
  ...
  nor2   g37(.a(x18), .b(new_n45_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  nand2  g39(.a(new_n52_), .b(x02), .O(new_n81_));
  ...
  nand2  g52(.a(new_n48_), .b(new_n62_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n45_), .O(new_n95_));
