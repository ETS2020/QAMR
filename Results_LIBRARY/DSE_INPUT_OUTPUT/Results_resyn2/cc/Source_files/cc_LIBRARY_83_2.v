...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n42_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
  ...
  nor2   g07(.a(z04), .b(new_n48_), .O(z06));
  ...
  aoi21  g16(.a(new_n57_), .b(x18), .c(new_n48_), .O(z03));
  ...
  nor2   g24(.a(new_n65_), .b(new_n60_), .O(z09));
  and2   g25(.a(new_n65_), .b(new_n44_), .O(z10));
  nor2   g26(.a(new_n60_), .b(new_n47_), .O(z11));
  ...
  nand3  g37(.a(new_n46_), .b(x18), .c(x15), .O(new_n79_));
  ...
  nand3  g42(.a(new_n46_), .b(x16), .c(new_n47_), .O(new_n84_));
  ...
  nand2  g50(.a(new_n46_), .b(new_n62_), .O(new_n92_));
  ...
  oai21  g58(.a(new_n59_), .b(new_n53_), .c(x18), .O(new_n100_));
  ...
  nand2  g69(.a(new_n46_), .b(new_n110_), .O(new_n111_));
  nand3  g70(.a(new_n111_), .b(new_n109_), .c(new_n48_), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n107_), .c(new_n53_), .O(z19));
endmodule
