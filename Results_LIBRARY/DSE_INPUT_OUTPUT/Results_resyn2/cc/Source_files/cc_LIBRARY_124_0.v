...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n55_, new_n56_, new_n60_, new_n62_,
  ...
  nor3   g15(.a(new_n56_), .b(new_n43_), .c(new_n54_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  nor2   g17(.a(new_n43_), .b(new_n54_), .O(z06));
  ...
  nor2   g25(.a(new_n43_), .b(new_n55_), .O(z11));
  inv1   g26(.a(x00), .O(new_n68_));
  nand4  g27(.a(new_n54_), .b(x10), .c(x08), .d(new_n68_), .O(new_n69_));
  nor2   g28(.a(new_n43_), .b(new_n50_), .O(new_n70_));
  inv1   g29(.a(x13), .O(new_n71_));
  nand3  g30(.a(new_n54_), .b(x10), .c(x08), .O(new_n72_));
  ...
  nand3  g40(.a(new_n46_), .b(new_n44_), .c(x12), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n54_), .c(new_n82_), .O(z14));
  inv1   g42(.a(x03), .O(new_n84_));
  nand4  g43(.a(new_n54_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  nand2  g44(.a(x16), .b(new_n55_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n72_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n85_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n54_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n72_), .b(new_n60_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n70_), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z16));
  aoi21  g53(.a(new_n72_), .b(x19), .c(x05), .O(new_n95_));
  inv1   g54(.a(x18), .O(new_n96_));
  oai21  g55(.a(new_n48_), .b(x15), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x12), .O(new_n98_));
  nor2   g57(.a(new_n98_), .b(new_n95_), .O(z17));
  inv1   g58(.a(x19), .O(new_n100_));
  nand2  g59(.a(new_n49_), .b(x05), .O(new_n101_));
  ...
  aoi21  g63(.a(new_n101_), .b(new_n100_), .c(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand4  g65(.a(new_n54_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
