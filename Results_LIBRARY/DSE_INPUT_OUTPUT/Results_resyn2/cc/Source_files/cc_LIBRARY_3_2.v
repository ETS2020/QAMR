...
module FAU ( 
  ...
  nor2   g23(.a(x19), .b(new_n58_), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n64_), .O(z08));
  ...
  aoi21  g30(.a(new_n43_), .b(x18), .c(new_n52_), .O(new_n72_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(z14));
  nor2   g44(.a(new_n65_), .b(x12), .O(new_n86_));
  nand3  g45(.a(new_n74_), .b(x16), .c(new_n46_), .O(new_n87_));
  aoi21  g46(.a(new_n51_), .b(x03), .c(new_n65_), .O(new_n88_));
  ...
  nand2  g55(.a(new_n74_), .b(new_n58_), .O(new_n97_));
  ...
  nand3  g67(.a(new_n108_), .b(new_n106_), .c(new_n72_), .O(new_n109_));
