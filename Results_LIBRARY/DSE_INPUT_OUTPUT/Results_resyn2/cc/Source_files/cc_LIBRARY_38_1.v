...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n59_, new_n62_, new_n64_, new_n66_, new_n71_, new_n72_, new_n73_,
  ...
  nor2   g21(.a(new_n62_), .b(new_n50_), .O(z06));
  ...
  aoi21  g29(.a(x19), .b(new_n44_), .c(new_n57_), .O(new_n71_));
  inv1   g30(.a(x00), .O(new_n72_));
  nand4  g31(.a(new_n50_), .b(x10), .c(x08), .d(new_n72_), .O(new_n73_));
  ...
  nand3  g46(.a(new_n51_), .b(x16), .c(new_n49_), .O(new_n88_));
  ...
  oai21  g57(.a(new_n75_), .b(x15), .c(new_n98_), .O(new_n99_));
  ...
  aoi22  g61(.a(new_n102_), .b(new_n54_), .c(new_n45_), .d(new_n57_), .O(z18));
