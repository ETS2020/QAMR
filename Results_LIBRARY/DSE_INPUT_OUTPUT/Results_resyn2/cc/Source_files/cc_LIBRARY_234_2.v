...
module FAU ( 
  ...
  aoi21  g32(.a(new_n51_), .b(new_n73_), .c(x05), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n68_), .c(new_n67_), .O(z12));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n51_), .b(new_n77_), .c(new_n44_), .O(new_n78_));
  nand2  g37(.a(new_n48_), .b(new_n50_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  aoi21  g39(.a(new_n78_), .b(new_n70_), .c(new_n80_), .O(z13));
  aoi21  g40(.a(new_n69_), .b(x02), .c(x15), .O(new_n82_));
  nand2  g41(.a(new_n48_), .b(x12), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n46_), .O(z14));
  nand2  g43(.a(x12), .b(x03), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n51_), .c(new_n44_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n70_), .O(new_n87_));
  nand2  g46(.a(x16), .b(x12), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n52_), .c(new_n87_), .O(z15));
  nand2  g48(.a(x12), .b(x04), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n51_), .c(new_n44_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n70_), .O(new_n92_));
  oai21  g51(.a(new_n51_), .b(x15), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n60_), .c(new_n92_), .O(z16));
  aoi21  g53(.a(new_n93_), .b(new_n46_), .c(z04), .O(z17));
  nand2  g54(.a(x12), .b(x06), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n51_), .c(new_n44_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n70_), .O(new_n98_));
  oai21  g57(.a(new_n93_), .b(new_n58_), .c(new_n98_), .O(z18));
  nand2  g58(.a(x20), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n70_), .b(x07), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n69_), .O(new_n102_));
  aoi21  g61(.a(new_n51_), .b(new_n43_), .c(x05), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n100_), .c(new_n67_), .O(z19));
  buf    g64(.a(x15), .O(z06));
endmodule
