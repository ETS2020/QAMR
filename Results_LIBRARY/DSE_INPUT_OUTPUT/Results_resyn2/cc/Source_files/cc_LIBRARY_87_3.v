...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    new_n52_, new_n53_, new_n54_, new_n56_, new_n59_, new_n62_, new_n63_,
  ...
  aoi21  g11(.a(x19), .b(x06), .c(new_n52_), .O(new_n53_));
