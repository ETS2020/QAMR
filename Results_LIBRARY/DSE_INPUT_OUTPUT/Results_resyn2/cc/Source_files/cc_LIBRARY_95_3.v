...
module FAU ( 
  ...
  nor2   g15(.a(new_n47_), .b(x09), .O(new_n57_));
  ...
  nand4  g36(.a(new_n47_), .b(x10), .c(x08), .d(x01), .O(new_n78_));
  nand3  g37(.a(x15), .b(x10), .c(x08), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n78_), .c(new_n42_), .d(x12), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n51_), .b(new_n83_), .c(new_n47_), .O(new_n84_));
  ...
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n47_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n105_), .c(new_n53_), .O(z18));
  nand2  g69(.a(new_n57_), .b(x20), .O(new_n111_));
  ...
  nand3  g74(.a(new_n115_), .b(new_n113_), .c(new_n47_), .O(new_n116_));
