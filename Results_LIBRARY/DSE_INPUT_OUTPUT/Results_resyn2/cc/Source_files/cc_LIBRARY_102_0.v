...
module FAU ( 
  ...
  nand2  g20(.a(new_n50_), .b(x12), .O(z06));
  ...
  nand3  g31(.a(new_n72_), .b(new_n50_), .c(new_n71_), .O(new_n73_));
  ...
  aoi21  g44(.a(new_n72_), .b(x03), .c(new_n55_), .O(new_n86_));
  nand3  g45(.a(new_n56_), .b(new_n51_), .c(x16), .O(new_n87_));
  oai21  g46(.a(new_n86_), .b(x15), .c(new_n87_), .O(z15));
  aoi21  g47(.a(new_n72_), .b(x04), .c(new_n55_), .O(new_n89_));
  nand3  g48(.a(new_n51_), .b(x17), .c(x12), .O(new_n90_));
  oai21  g49(.a(new_n89_), .b(x15), .c(new_n90_), .O(z16));
  aoi21  g50(.a(new_n72_), .b(x05), .c(new_n55_), .O(new_n92_));
  nand3  g51(.a(new_n51_), .b(x18), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n92_), .b(x15), .c(new_n93_), .O(z17));
  inv1   g53(.a(x06), .O(new_n95_));
  nand3  g54(.a(new_n72_), .b(new_n50_), .c(new_n95_), .O(new_n96_));
  nand2  g55(.a(new_n51_), .b(new_n60_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n96_), .c(x12), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  nand3  g59(.a(new_n72_), .b(new_n50_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n51_), .b(new_n43_), .O(new_n102_));
