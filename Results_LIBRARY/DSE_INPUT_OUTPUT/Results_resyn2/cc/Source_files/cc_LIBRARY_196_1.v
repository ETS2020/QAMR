...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n57_, new_n60_, new_n63_,
  ...
  nand2  g26(.a(new_n49_), .b(new_n47_), .O(new_n68_));
  oai21  g27(.a(new_n52_), .b(x00), .c(x12), .O(new_n69_));
  nor2   g28(.a(x13), .b(new_n44_), .O(new_n70_));
  aoi22  g29(.a(new_n70_), .b(new_n68_), .c(new_n69_), .d(new_n47_), .O(z12));
  inv1   g30(.a(x01), .O(new_n72_));
  oai21  g31(.a(new_n52_), .b(new_n72_), .c(x14), .O(new_n73_));
  nand2  g32(.a(new_n49_), .b(x15), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n44_), .O(z13));
  nand2  g34(.a(new_n49_), .b(x12), .O(new_n76_));
  oai21  g35(.a(new_n52_), .b(new_n44_), .c(x15), .O(new_n77_));
  ...
  nand4  g49(.a(new_n47_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  inv1   g50(.a(x18), .O(new_n92_));
  oai21  g51(.a(new_n52_), .b(x15), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n52_), .b(x15), .c(new_n57_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(x12), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z18));
  inv1   g59(.a(x07), .O(new_n101_));
  nand4  g60(.a(new_n47_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  ...
  aoi21  g64(.a(new_n50_), .b(x12), .c(new_n47_), .O(z03));
endmodule
