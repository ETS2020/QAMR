...
module FAU ( 
  ...
  nor2   g01(.a(x17), .b(x16), .O(new_n43_));
  ...
  nand2  g12(.a(new_n44_), .b(x15), .O(new_n54_));
  inv1   g13(.a(x14), .O(new_n55_));
  and2   g14(.a(x10), .b(x08), .O(new_n56_));
  nand3  g15(.a(new_n56_), .b(new_n55_), .c(x12), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n54_), .O(z03));
  nor2   g17(.a(new_n43_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n43_), .b(new_n60_), .O(z05));
  inv1   g20(.a(new_n54_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(x16), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nand2  g24(.a(x17), .b(new_n65_), .O(z08));
  nand3  g25(.a(new_n44_), .b(x09), .c(x08), .O(z10));
  inv1   g26(.a(z10), .O(z09));
  nor2   g27(.a(new_n43_), .b(new_n55_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  inv1   g29(.a(x15), .O(new_n71_));
  nand3  g30(.a(new_n56_), .b(new_n71_), .c(new_n70_), .O(new_n72_));
  nor2   g31(.a(new_n43_), .b(new_n50_), .O(new_n73_));
  inv1   g32(.a(x13), .O(new_n74_));
  nand3  g33(.a(new_n71_), .b(x10), .c(x08), .O(new_n75_));
  ...
  nand3  g45(.a(new_n75_), .b(x16), .c(new_n55_), .O(new_n87_));
  nand3  g46(.a(new_n49_), .b(new_n44_), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n50_), .O(z15));
  nand2  g48(.a(new_n49_), .b(x16), .O(new_n90_));
  inv1   g49(.a(x04), .O(new_n91_));
  nand4  g50(.a(new_n71_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x12), .O(new_n93_));
  aoi21  g52(.a(new_n90_), .b(new_n63_), .c(new_n93_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand3  g54(.a(new_n56_), .b(new_n71_), .c(new_n95_), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  nand2  g56(.a(new_n75_), .b(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n73_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand3  g60(.a(new_n56_), .b(new_n71_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n75_), .b(new_n60_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n44_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand3  g65(.a(new_n56_), .b(new_n71_), .c(new_n106_), .O(new_n107_));
