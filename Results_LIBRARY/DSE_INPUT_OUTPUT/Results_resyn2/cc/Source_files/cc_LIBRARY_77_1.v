...
module FAU ( 
  ...
  oai21  g15(.a(new_n49_), .b(new_n53_), .c(new_n46_), .O(z03));
  ...
  nand3  g29(.a(new_n61_), .b(new_n48_), .c(x00), .O(new_n71_));
  ...
  nor2   g33(.a(x16), .b(new_n47_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n73_), .c(new_n53_), .O(z13));
  aoi21  g36(.a(new_n61_), .b(x02), .c(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n48_), .b(x15), .c(x12), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n78_), .O(z14));
  inv1   g39(.a(x15), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  ...
  oai21  g46(.a(new_n87_), .b(new_n51_), .c(new_n42_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n81_), .O(new_n89_));
  oai21  g48(.a(new_n51_), .b(x15), .c(x12), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n63_), .c(new_n89_), .O(z16));
  inv1   g50(.a(x18), .O(new_n92_));
  nand2  g51(.a(x12), .b(x05), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n51_), .c(new_n42_), .O(new_n94_));
  ...
  nand2  g56(.a(new_n81_), .b(x06), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  aoi21  g58(.a(new_n51_), .b(new_n59_), .c(x16), .O(new_n100_));
  ...
  oai21  g63(.a(new_n104_), .b(new_n51_), .c(new_n42_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n81_), .O(new_n106_));
  oai21  g65(.a(new_n90_), .b(new_n103_), .c(new_n106_), .O(z19));
  buf    g66(.a(x16), .O(z08));
endmodule
