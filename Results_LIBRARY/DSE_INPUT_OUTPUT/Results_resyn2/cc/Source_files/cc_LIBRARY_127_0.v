...
module FAU ( 
  ...
  nor2   g27(.a(new_n44_), .b(new_n50_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  and2   g29(.a(x10), .b(x08), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n60_), .c(new_n70_), .O(new_n72_));
  ...
  aoi21  g43(.a(new_n83_), .b(new_n60_), .c(new_n84_), .O(z14));
  nand2  g44(.a(new_n53_), .b(x03), .O(new_n86_));
  nand3  g45(.a(new_n74_), .b(x16), .c(new_n50_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n49_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand3  g48(.a(new_n71_), .b(new_n60_), .c(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n74_), .b(new_n62_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  aoi21  g52(.a(new_n71_), .b(x05), .c(new_n49_), .O(new_n94_));
  nand3  g53(.a(new_n74_), .b(x18), .c(x12), .O(new_n95_));
  oai21  g54(.a(new_n94_), .b(x15), .c(new_n95_), .O(z17));
  aoi21  g55(.a(new_n71_), .b(x06), .c(new_n49_), .O(new_n97_));
  nand3  g56(.a(new_n74_), .b(x19), .c(x12), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(x15), .c(new_n98_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  nand3  g59(.a(new_n71_), .b(new_n60_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n74_), .b(new_n43_), .O(new_n102_));
