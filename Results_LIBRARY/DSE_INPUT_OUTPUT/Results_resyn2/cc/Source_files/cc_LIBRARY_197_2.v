...
module FAU ( 
  ...
  nand2  g19(.a(new_n48_), .b(new_n49_), .O(z06));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n70_), .c(new_n52_), .O(new_n71_));
  ...
  oai21  g39(.a(new_n75_), .b(new_n80_), .c(new_n49_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n46_), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n48_), .O(z14));
  nand3  g42(.a(new_n50_), .b(x16), .c(new_n42_), .O(new_n84_));
  ...
  nand2  g49(.a(new_n50_), .b(new_n62_), .O(new_n91_));
  ...
  aoi21  g55(.a(new_n50_), .b(z04), .c(new_n52_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n48_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand2  g59(.a(new_n51_), .b(new_n100_), .O(new_n101_));
  aoi21  g60(.a(new_n50_), .b(new_n59_), .c(new_n52_), .O(new_n102_));
  ...
  nand3  g67(.a(new_n108_), .b(new_n106_), .c(new_n92_), .O(new_n109_));
