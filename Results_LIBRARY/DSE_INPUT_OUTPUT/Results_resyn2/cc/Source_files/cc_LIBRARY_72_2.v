...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n42_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
  ...
  nand2  g02(.a(z04), .b(x13), .O(new_n44_));
  nand2  g03(.a(new_n44_), .b(new_n42_), .O(z00));
  inv1   g04(.a(x13), .O(new_n46_));
  nor2   g05(.a(x18), .b(new_n46_), .O(new_n47_));
  ...
  nand4  g16(.a(new_n57_), .b(new_n44_), .c(new_n56_), .d(x12), .O(new_n58_));
  ...
  nor2   g29(.a(new_n47_), .b(new_n56_), .O(z11));
  ...
  nand2  g53(.a(new_n74_), .b(new_n64_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(z16));
  nand2  g56(.a(new_n51_), .b(new_n46_), .O(new_n98_));
  inv1   g57(.a(x05), .O(new_n99_));
  nand4  g58(.a(new_n62_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  aoi21  g60(.a(new_n98_), .b(z04), .c(new_n101_), .O(z17));
  ...
  nand4  g67(.a(new_n62_), .b(x10), .c(x08), .d(new_n108_), .O(new_n109_));
  inv1   g68(.a(x20), .O(new_n110_));
  nand2  g69(.a(new_n74_), .b(new_n110_), .O(new_n111_));
  aoi21  g70(.a(z04), .b(x13), .c(new_n52_), .O(new_n112_));
  nand3  g71(.a(new_n112_), .b(new_n111_), .c(new_n109_), .O(new_n113_));
