...
module FAU ( 
  ...
  nand2  g02(.a(x19), .b(x16), .O(new_n44_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n73_), .c(new_n55_), .O(new_n76_));
  ...
  aoi21  g41(.a(new_n72_), .b(x02), .c(x15), .O(new_n83_));
  ...
  nand3  g59(.a(new_n100_), .b(new_n98_), .c(new_n55_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  nand3  g62(.a(new_n72_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g67(.a(new_n72_), .b(new_n52_), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n53_), .b(new_n43_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(new_n55_), .O(new_n111_));
