...
module FAU ( 
  ...
  nor2   g15(.a(new_n43_), .b(new_n53_), .O(z06));
  ...
  nand4  g30(.a(new_n43_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z13));
  nand2  g39(.a(new_n48_), .b(x12), .O(new_n81_));
  oai21  g40(.a(new_n51_), .b(new_n53_), .c(x15), .O(new_n82_));
  nand2  g41(.a(new_n43_), .b(x02), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n82_), .O(z14));
  nand2  g43(.a(new_n48_), .b(new_n43_), .O(new_n85_));
  nand2  g44(.a(x16), .b(new_n47_), .O(new_n86_));
  inv1   g45(.a(x03), .O(new_n87_));
  nand4  g46(.a(new_n43_), .b(x10), .c(x08), .d(new_n87_), .O(new_n88_));
  ...
  oai21  g51(.a(new_n51_), .b(x15), .c(new_n63_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z16));
  inv1   g54(.a(x05), .O(new_n96_));
  nand4  g55(.a(new_n43_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n43_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n51_), .b(x15), .c(new_n61_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(x12), .O(new_n105_));
  inv1   g64(.a(new_n105_), .O(z18));
  oai21  g65(.a(new_n51_), .b(x07), .c(x12), .O(new_n107_));
  nor2   g66(.a(x20), .b(new_n53_), .O(new_n108_));
  aoi22  g67(.a(new_n108_), .b(new_n85_), .c(new_n107_), .d(new_n43_), .O(z19));
endmodule
