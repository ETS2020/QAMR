...
module FAU ( 
  ...
  nor2   g01(.a(x18), .b(x02), .O(new_n43_));
  ...
  nor2   g28(.a(new_n43_), .b(new_n48_), .O(z11));
  ...
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(z16));
  inv1   g57(.a(x18), .O(new_n99_));
  oai21  g58(.a(new_n50_), .b(x05), .c(x12), .O(new_n100_));
  aoi21  g59(.a(new_n84_), .b(new_n99_), .c(new_n100_), .O(z17));
  inv1   g60(.a(x06), .O(new_n102_));
  nand4  g61(.a(new_n49_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n50_), .b(new_n60_), .O(new_n104_));
  nor2   g63(.a(new_n43_), .b(new_n52_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n103_), .O(new_n106_));
  ...
  nand3  g70(.a(new_n111_), .b(new_n109_), .c(new_n105_), .O(new_n112_));
