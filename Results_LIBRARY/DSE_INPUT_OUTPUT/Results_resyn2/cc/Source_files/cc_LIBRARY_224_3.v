...
module FAU ( 
  ...
  nand2  g43(.a(new_n54_), .b(new_n49_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z14));
  inv1   g45(.a(x03), .O(new_n87_));
  nand3  g46(.a(new_n73_), .b(new_n51_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g52(.a(new_n73_), .b(new_n51_), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g56(.a(new_n73_), .b(new_n51_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g62(.a(new_n73_), .b(new_n51_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g67(.a(new_n73_), .b(new_n51_), .c(new_n108_), .O(new_n109_));
