...
module FAU ( 
  ...
  nor2   g12(.a(new_n44_), .b(new_n53_), .O(new_n54_));
  ...
  nand2  g18(.a(new_n59_), .b(x06), .O(z05));
  ...
  oai21  g38(.a(new_n70_), .b(new_n79_), .c(x14), .O(new_n80_));
  ...
  nand2  g44(.a(new_n71_), .b(new_n85_), .O(new_n86_));
  ...
  nand2  g68(.a(new_n52_), .b(new_n43_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(x12), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n45_), .O(z19));
endmodule
