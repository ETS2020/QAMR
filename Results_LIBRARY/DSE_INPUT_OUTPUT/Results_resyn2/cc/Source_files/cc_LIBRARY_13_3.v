...
module FAU ( 
  ...
  oai21  g13(.a(new_n43_), .b(new_n42_), .c(x18), .O(z04));
  ...
  nor2   g19(.a(new_n44_), .b(new_n61_), .O(z08));
  ...
  nor2   g26(.a(x15), .b(new_n42_), .O(new_n69_));
