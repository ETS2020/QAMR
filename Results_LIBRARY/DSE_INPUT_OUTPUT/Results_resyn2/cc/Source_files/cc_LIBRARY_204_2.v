...
module FAU ( 
  ...
  oai21  g07(.a(new_n48_), .b(new_n44_), .c(new_n45_), .O(z01));
  ...
  nor2   g12(.a(x15), .b(new_n52_), .O(new_n54_));
  ...
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z13));
  inv1   g29(.a(new_n68_), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(x15), .c(new_n52_), .O(z14));
  ...
  aoi21  g39(.a(new_n43_), .b(x15), .c(new_n52_), .O(z19));
  buf    g40(.a(x15), .O(z06));
endmodule
