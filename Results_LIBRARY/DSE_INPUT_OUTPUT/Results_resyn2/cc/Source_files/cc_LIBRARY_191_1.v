...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    ...
    new_n62_, new_n65_, new_n67_, new_n69_, new_n72_, new_n73_, new_n74_,
  ...
  nor2   g21(.a(new_n62_), .b(new_n61_), .O(z05));
  nand2  g22(.a(new_n44_), .b(new_n50_), .O(z06));
  ...
  aoi21  g30(.a(new_n51_), .b(z04), .c(x00), .O(new_n72_));
  ...
  nor2   g35(.a(new_n76_), .b(new_n72_), .O(z12));
  ...
  aoi21  g42(.a(x18), .b(new_n43_), .c(new_n53_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n48_), .O(new_n85_));
  aoi21  g44(.a(new_n83_), .b(new_n50_), .c(new_n85_), .O(z14));
  ...
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n84_), .O(new_n96_));
