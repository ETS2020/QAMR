...
module FAU ( 
  ...
  oai21  g13(.a(x19), .b(new_n54_), .c(x14), .O(new_n55_));
  oai21  g14(.a(x19), .b(new_n54_), .c(new_n47_), .O(new_n56_));
  inv1   g15(.a(x12), .O(new_n57_));
  oai21  g16(.a(x19), .b(new_n54_), .c(new_n57_), .O(new_n58_));
  nand3  g17(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z03));
  nand2  g19(.a(new_n45_), .b(x18), .O(z04));
  nand2  g20(.a(new_n44_), .b(new_n54_), .O(z05));
  ...
  aoi21  g30(.a(new_n44_), .b(x06), .c(new_n57_), .O(new_n72_));
  ...
  oai21  g35(.a(new_n76_), .b(x15), .c(new_n75_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n74_), .c(new_n72_), .O(new_n78_));
  ...
  oai21  g43(.a(new_n76_), .b(new_n84_), .c(new_n50_), .O(new_n85_));
  ...
  nand3  g47(.a(new_n51_), .b(x16), .c(new_n49_), .O(new_n89_));
  ...
  oai21  g52(.a(new_n76_), .b(x15), .c(new_n65_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n72_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n76_), .b(x15), .c(new_n99_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n98_), .c(new_n72_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  nor2   g61(.a(new_n44_), .b(x12), .O(new_n103_));
  nand2  g62(.a(new_n51_), .b(x19), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n54_), .c(new_n103_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand4  g65(.a(new_n50_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  oai21  g66(.a(new_n76_), .b(x15), .c(new_n43_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n72_), .O(new_n109_));
