...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n63_, new_n69_, new_n70_, new_n71_, new_n72_, new_n73_, new_n75_,
  ...
  nor2   g07(.a(x19), .b(x16), .O(new_n49_));
  nor2   g08(.a(new_n49_), .b(new_n48_), .O(z06));
  nand2  g09(.a(x10), .b(x08), .O(new_n51_));
  nor2   g10(.a(new_n51_), .b(x14), .O(new_n52_));
  and2   g11(.a(new_n52_), .b(z06), .O(z01));
  inv1   g12(.a(x14), .O(new_n54_));
  oai21  g13(.a(new_n51_), .b(x15), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g17(.a(new_n54_), .b(x12), .O(new_n59_));
  oai21  g18(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z03));
  nor2   g19(.a(new_n49_), .b(x18), .O(z04));
  nand2  g20(.a(new_n45_), .b(x16), .O(z05));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n46_), .b(new_n63_), .O(z07));
  nand2  g23(.a(x19), .b(new_n44_), .O(z08));
  nand3  g24(.a(new_n46_), .b(x09), .c(x08), .O(z10));
  inv1   g25(.a(z10), .O(z09));
  nor2   g26(.a(new_n49_), .b(new_n54_), .O(z11));
  ...
  aoi21  g36(.a(new_n76_), .b(new_n58_), .c(new_n77_), .O(z13));
  and2   g37(.a(x10), .b(x08), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x02), .O(new_n80_));
  nand3  g39(.a(new_n58_), .b(new_n46_), .c(x12), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n48_), .c(new_n81_), .O(z14));
  inv1   g41(.a(x12), .O(new_n83_));
  nand3  g42(.a(new_n48_), .b(x10), .c(x08), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x16), .c(new_n54_), .O(new_n85_));
  nand4  g44(.a(new_n79_), .b(new_n46_), .c(new_n48_), .d(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(z15));
  nor2   g46(.a(new_n49_), .b(new_n83_), .O(new_n88_));
