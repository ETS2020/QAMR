...
module FAU ( 
  ...
  oai21  g11(.a(new_n48_), .b(x15), .c(new_n47_), .O(new_n53_));
  ...
  nand2  g26(.a(new_n52_), .b(new_n47_), .O(z11));
  ...
  nand3  g36(.a(new_n77_), .b(new_n43_), .c(x15), .O(new_n78_));
  ...
  nand3  g48(.a(new_n48_), .b(x16), .c(new_n47_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n43_), .b(x17), .c(x15), .O(new_n95_));
  inv1   g54(.a(x04), .O(new_n96_));
  nand3  g55(.a(x10), .b(x08), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n48_), .b(new_n61_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n42_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n95_), .c(new_n54_), .O(z16));
  ...
  nand4  g63(.a(new_n42_), .b(x10), .c(x08), .d(x05), .O(new_n105_));
  ...
  nand2  g69(.a(new_n49_), .b(new_n110_), .O(new_n111_));
  nand4  g70(.a(new_n111_), .b(new_n109_), .c(new_n42_), .d(x12), .O(new_n112_));
  ...
  nand4  g76(.a(new_n42_), .b(x10), .c(x08), .d(x07), .O(new_n118_));
