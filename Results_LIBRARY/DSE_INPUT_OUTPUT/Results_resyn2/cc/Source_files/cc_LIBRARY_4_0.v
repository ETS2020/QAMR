...
module FAU ( 
  ...
  nand2  g45(.a(new_n72_), .b(new_n86_), .O(new_n87_));
  ...
  aoi21  g63(.a(new_n104_), .b(x12), .c(new_n60_), .O(new_n105_));
  oai21  g64(.a(new_n71_), .b(x15), .c(new_n60_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x12), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(x06), .c(new_n105_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  nand2  g68(.a(new_n72_), .b(new_n109_), .O(new_n110_));
