...
module FAU ( 
  ...
  nand2  g10(.a(new_n51_), .b(new_n45_), .O(z01));
  ...
  oai21  g15(.a(new_n54_), .b(x14), .c(new_n56_), .O(new_n57_));
  ...
  aoi21  g20(.a(new_n44_), .b(new_n43_), .c(new_n61_), .O(z05));
  ...
  oai21  g31(.a(new_n72_), .b(new_n53_), .c(x07), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n44_), .O(new_n74_));
  oai21  g33(.a(new_n53_), .b(x15), .c(x12), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n71_), .c(new_n74_), .O(z12));
  ...
  nand3  g41(.a(new_n54_), .b(x07), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n55_), .O(z14));
  nand3  g43(.a(x16), .b(x15), .c(new_n48_), .O(new_n85_));
  and2   g44(.a(x10), .b(x08), .O(new_n86_));
  nand2  g45(.a(new_n44_), .b(x03), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  oai21  g47(.a(new_n65_), .b(x14), .c(new_n53_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x07), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n85_), .c(new_n55_), .O(z15));
  nand2  g50(.a(x17), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n44_), .b(x04), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n86_), .O(new_n94_));
  aoi21  g53(.a(new_n53_), .b(new_n63_), .c(new_n43_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n92_), .c(new_n55_), .O(z16));
  inv1   g56(.a(x18), .O(new_n98_));
  nand2  g57(.a(x12), .b(x05), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n53_), .c(x07), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(new_n101_));
  oai21  g60(.a(new_n75_), .b(new_n98_), .c(new_n101_), .O(z17));
  nand2  g61(.a(x19), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n44_), .b(x06), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  aoi21  g64(.a(new_n53_), .b(new_n61_), .c(new_n43_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n103_), .c(new_n55_), .O(z18));
  nand2  g67(.a(new_n54_), .b(x07), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n46_), .c(new_n55_), .O(z19));
  buf    g69(.a(x15), .O(z06));
endmodule
