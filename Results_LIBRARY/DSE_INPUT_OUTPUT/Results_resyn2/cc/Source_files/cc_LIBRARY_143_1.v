...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n59_, new_n61_, new_n64_, new_n66_, new_n68_, new_n72_, new_n73_,
  ...
  aoi21  g11(.a(x19), .b(new_n44_), .c(new_n52_), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(new_n42_), .O(new_n54_));
  aoi21  g13(.a(new_n51_), .b(new_n49_), .c(new_n54_), .O(z02));
  nand2  g14(.a(new_n45_), .b(x14), .O(new_n56_));
  nand2  g15(.a(new_n47_), .b(new_n45_), .O(new_n57_));
  nand2  g16(.a(new_n45_), .b(new_n52_), .O(new_n58_));
  ...
  nor2   g21(.a(new_n61_), .b(new_n50_), .O(z06));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n47_), .c(new_n78_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n80_), .b(new_n83_), .c(new_n50_), .O(new_n84_));
  ...
  aoi22  g64(.a(new_n105_), .b(new_n104_), .c(new_n45_), .d(new_n52_), .O(z18));
