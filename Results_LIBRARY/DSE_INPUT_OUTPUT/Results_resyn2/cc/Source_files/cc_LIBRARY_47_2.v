...
module FAU ( 
  ...
  nor2   g18(.a(x15), .b(x03), .O(new_n60_));
  ...
  nand2  g27(.a(new_n45_), .b(new_n50_), .O(z11));
  inv1   g28(.a(x12), .O(new_n70_));
  nand2  g29(.a(x15), .b(x13), .O(new_n71_));
  nand2  g30(.a(new_n44_), .b(x00), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n51_), .O(new_n73_));
  inv1   g32(.a(x13), .O(new_n74_));
  nand2  g33(.a(x10), .b(x08), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(x03), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n73_), .O(new_n77_));
