...
module FAU ( 
  ...
  aoi21  g13(.a(x19), .b(new_n47_), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g39(.a(new_n55_), .b(new_n49_), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n52_), .c(new_n81_), .O(z14));
  inv1   g41(.a(new_n55_), .O(new_n83_));
  nand3  g42(.a(new_n53_), .b(x16), .c(new_n51_), .O(new_n84_));
  ...
  nand2  g47(.a(new_n53_), .b(new_n62_), .O(new_n89_));
  ...
  nand2  g58(.a(new_n53_), .b(new_n44_), .O(new_n100_));
  ...
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n55_), .O(new_n106_));
