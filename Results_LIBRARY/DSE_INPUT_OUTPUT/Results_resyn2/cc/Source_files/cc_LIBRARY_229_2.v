...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    ...
    new_n61_, new_n68_, new_n69_, new_n70_, new_n72_, new_n73_, new_n74_,
  ...
  oai21  g30(.a(new_n56_), .b(new_n43_), .c(x15), .O(new_n72_));
  nand3  g31(.a(x10), .b(x08), .c(x01), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x14), .c(x12), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n72_), .O(z13));
  nand2  g34(.a(new_n49_), .b(x02), .O(new_n76_));
  nand3  g35(.a(new_n47_), .b(x17), .c(x15), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n50_), .O(z14));
  nand3  g37(.a(x16), .b(new_n54_), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x17), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand3  g40(.a(new_n47_), .b(x16), .c(new_n54_), .O(new_n82_));
  ...
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n44_), .O(z16));
  nand3  g50(.a(x18), .b(x17), .c(x15), .O(new_n92_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(new_n46_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n92_), .c(new_n50_), .O(z17));
  oai21  g57(.a(new_n61_), .b(new_n50_), .c(x17), .O(new_n99_));
