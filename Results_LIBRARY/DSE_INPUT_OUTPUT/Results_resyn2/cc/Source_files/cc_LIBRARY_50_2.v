...
module FAU ( 
  ...
  nand2  g01(.a(new_n42_), .b(x04), .O(new_n43_));
  ...
  nand2  g19(.a(new_n42_), .b(new_n60_), .O(z06));
  ...
  nand2  g50(.a(new_n42_), .b(x05), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n50_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  aoi21  g53(.a(new_n72_), .b(new_n94_), .c(x04), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n91_), .c(new_n55_), .O(z17));
  nand2  g56(.a(x19), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n42_), .b(x06), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n50_), .O(new_n100_));
  aoi21  g59(.a(new_n72_), .b(new_n58_), .c(x04), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n98_), .c(new_n55_), .O(z18));
  nand2  g62(.a(x12), .b(x07), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n72_), .c(new_n60_), .O(new_n105_));
