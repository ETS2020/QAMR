...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n61_, new_n63_, new_n65_, new_n69_, new_n70_, new_n71_, new_n73_,
  ...
  aoi21  g10(.a(new_n51_), .b(new_n47_), .c(new_n46_), .O(z01));
  nor2   g11(.a(new_n49_), .b(x15), .O(new_n53_));
  ...
  nand3  g16(.a(new_n50_), .b(new_n48_), .c(x12), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n47_), .c(new_n46_), .O(z03));
  ...
  nand2  g27(.a(new_n53_), .b(x00), .O(new_n69_));
  nand3  g28(.a(new_n46_), .b(x10), .c(x08), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(new_n42_), .c(x13), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n69_), .c(new_n54_), .O(z12));
  nor2   g31(.a(x16), .b(new_n46_), .O(new_n73_));
  nand2  g32(.a(new_n49_), .b(new_n48_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n46_), .c(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n75_), .c(new_n54_), .O(z13));
  nand2  g37(.a(new_n73_), .b(new_n49_), .O(new_n79_));
  nand2  g38(.a(new_n53_), .b(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n54_), .O(z14));
  nand3  g40(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n82_));
  nand4  g41(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n42_), .O(z15));
  oai21  g45(.a(new_n63_), .b(new_n54_), .c(new_n47_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand2  g47(.a(new_n49_), .b(x17), .O(new_n89_));
  ...
  nand2  g69(.a(new_n49_), .b(x20), .O(new_n111_));
