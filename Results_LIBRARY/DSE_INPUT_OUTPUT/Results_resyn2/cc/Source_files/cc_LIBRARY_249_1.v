...
module FAU ( 
  ...
  nand2  g04(.a(x20), .b(z04), .O(new_n46_));
  ...
  nor2   g14(.a(new_n43_), .b(x18), .O(new_n56_));
  inv1   g15(.a(x14), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(x12), .c(x10), .d(x08), .O(new_n58_));
  nor3   g17(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(z03));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n56_), .b(new_n60_), .O(z05));
  nor2   g20(.a(new_n56_), .b(new_n55_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nor2   g22(.a(new_n56_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nor2   g24(.a(new_n56_), .b(new_n65_), .O(z08));
  nand2  g25(.a(x09), .b(x08), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n56_), .O(z09));
  and2   g27(.a(new_n67_), .b(new_n46_), .O(z10));
  nor2   g28(.a(new_n56_), .b(new_n57_), .O(z11));
  inv1   g29(.a(x00), .O(new_n71_));
  nand4  g30(.a(new_n55_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  aoi21  g31(.a(x20), .b(z04), .c(new_n51_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n47_), .b(new_n46_), .c(x12), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n55_), .c(new_n85_), .O(z14));
  inv1   g45(.a(new_n73_), .O(new_n87_));
  nand3  g46(.a(new_n75_), .b(x16), .c(new_n57_), .O(new_n88_));
  nand2  g47(.a(new_n50_), .b(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(z15));
  inv1   g49(.a(x04), .O(new_n91_));
  nand4  g50(.a(new_n55_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n75_), .b(new_n63_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n73_), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z16));
  inv1   g54(.a(x05), .O(new_n96_));
  nand4  g55(.a(new_n55_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n75_), .b(z04), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n46_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand4  g60(.a(new_n55_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  ...
  nand4  g65(.a(new_n55_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  nand2  g66(.a(new_n75_), .b(new_n43_), .O(new_n108_));
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n73_), .O(new_n109_));
