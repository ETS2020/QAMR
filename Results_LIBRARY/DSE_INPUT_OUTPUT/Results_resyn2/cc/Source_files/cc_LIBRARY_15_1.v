...
module FAU ( 
  ...
  nor2   g01(.a(new_n42_), .b(x06), .O(new_n43_));
  ...
  nor2   g21(.a(new_n43_), .b(new_n52_), .O(z06));
  ...
  aoi21  g32(.a(x19), .b(new_n61_), .c(new_n55_), .O(new_n74_));
  ...
  nand4  g38(.a(new_n52_), .b(x10), .c(x08), .d(x01), .O(new_n80_));
  ...
  nand2  g62(.a(x12), .b(x06), .O(new_n104_));
