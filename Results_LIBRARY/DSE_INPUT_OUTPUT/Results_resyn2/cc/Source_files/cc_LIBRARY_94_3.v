...
module FAU ( 
  ...
  nand2  g02(.a(x15), .b(x07), .O(new_n44_));
  oai21  g03(.a(new_n43_), .b(new_n42_), .c(new_n44_), .O(z00));
  inv1   g04(.a(x15), .O(new_n46_));
  nand2  g05(.a(x10), .b(x08), .O(new_n47_));
  nor4   g06(.a(new_n47_), .b(new_n46_), .c(x14), .d(x07), .O(z01));
  ...
  nand2  g29(.a(new_n44_), .b(new_n49_), .O(z11));
  nand2  g30(.a(x13), .b(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n54_), .O(new_n73_));
  ...
  nand3  g50(.a(new_n47_), .b(x16), .c(new_n49_), .O(new_n92_));
  ...
  oai21  g56(.a(new_n64_), .b(new_n97_), .c(new_n54_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n47_), .b(x17), .O(new_n100_));
  ...
  nand2  g64(.a(new_n105_), .b(new_n54_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n47_), .b(x18), .O(new_n108_));
  nand4  g67(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n109_));
  ...
  oai21  g71(.a(new_n61_), .b(new_n97_), .c(new_n54_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x15), .O(new_n114_));
  nand2  g73(.a(new_n47_), .b(x19), .O(new_n115_));
  nand4  g74(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n116_));
  ...
  nand3  g78(.a(new_n50_), .b(new_n46_), .c(new_n54_), .O(new_n120_));
  oai21  g79(.a(new_n47_), .b(x15), .c(new_n43_), .O(new_n121_));
  nand4  g80(.a(new_n121_), .b(new_n120_), .c(new_n44_), .d(x12), .O(new_n122_));
  inv1   g81(.a(new_n122_), .O(z19));
endmodule
