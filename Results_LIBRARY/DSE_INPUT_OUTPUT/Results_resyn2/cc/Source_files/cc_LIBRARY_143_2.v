...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n59_,
  ...
  aoi21  g13(.a(new_n44_), .b(x06), .c(new_n54_), .O(new_n55_));
  ...
  nor2   g21(.a(new_n59_), .b(new_n52_), .O(z06));
  ...
  nor2   g29(.a(new_n59_), .b(new_n47_), .O(z11));
  ...
  nand2  g55(.a(new_n96_), .b(new_n45_), .O(z16));
  ...
  aoi22  g63(.a(new_n104_), .b(new_n61_), .c(x19), .d(new_n54_), .O(z18));
