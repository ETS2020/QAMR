...
module FAU ( 
  ...
  nand2  g12(.a(new_n51_), .b(new_n48_), .O(new_n54_));
  nand3  g13(.a(new_n44_), .b(x12), .c(new_n42_), .O(new_n55_));
  aoi21  g14(.a(new_n54_), .b(new_n49_), .c(new_n55_), .O(z02));
  nand2  g15(.a(new_n49_), .b(x12), .O(new_n57_));
  nand2  g16(.a(x15), .b(new_n47_), .O(new_n58_));
  ...
  nand2  g27(.a(new_n44_), .b(new_n49_), .O(z11));
  ...
  oai21  g37(.a(new_n50_), .b(new_n78_), .c(new_n47_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  nand2  g39(.a(new_n51_), .b(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x14), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n80_), .O(z13));
  oai21  g42(.a(new_n50_), .b(x02), .c(x12), .O(new_n84_));
  aoi21  g43(.a(new_n58_), .b(new_n54_), .c(new_n84_), .O(z14));
  ...
  nand2  g64(.a(new_n50_), .b(new_n105_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n104_), .c(new_n48_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n102_), .c(new_n78_), .O(z17));
  nand2  g67(.a(new_n101_), .b(x19), .O(new_n109_));
  inv1   g68(.a(x06), .O(new_n110_));
  nand3  g69(.a(x10), .b(x08), .c(new_n110_), .O(new_n111_));
  nand2  g70(.a(new_n50_), .b(new_n61_), .O(new_n112_));
  nand3  g71(.a(new_n112_), .b(new_n111_), .c(new_n48_), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n109_), .c(new_n78_), .O(z18));
  oai21  g73(.a(new_n43_), .b(new_n78_), .c(new_n47_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n50_), .b(x20), .O(new_n117_));
  nand4  g76(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n118_));
