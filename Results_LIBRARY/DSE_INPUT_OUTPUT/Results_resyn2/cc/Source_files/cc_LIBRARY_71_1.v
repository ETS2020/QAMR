...
module FAU ( 
  ...
  nor2   g19(.a(new_n51_), .b(new_n42_), .O(z05));
  ...
  aoi21  g39(.a(new_n80_), .b(new_n47_), .c(new_n58_), .O(z13));
  nand3  g40(.a(x10), .b(x08), .c(x02), .O(new_n82_));
  nand2  g41(.a(new_n57_), .b(new_n47_), .O(new_n83_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n75_), .O(new_n88_));
  ...
  nand2  g51(.a(new_n75_), .b(new_n65_), .O(new_n93_));
  ...
  nand2  g57(.a(new_n75_), .b(new_n98_), .O(new_n99_));
  ...
  nand2  g62(.a(new_n75_), .b(new_n51_), .O(new_n104_));
  ...
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n57_), .O(new_n110_));
