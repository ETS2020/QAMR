...
module FAU ( 
  ...
  oai21  g33(.a(new_n54_), .b(x15), .c(new_n74_), .O(new_n75_));
  ...
  aoi21  g39(.a(new_n79_), .b(new_n50_), .c(new_n80_), .O(z13));
  ...
  nand3  g43(.a(new_n62_), .b(x10), .c(x08), .O(new_n85_));
  ...
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(new_n105_));
