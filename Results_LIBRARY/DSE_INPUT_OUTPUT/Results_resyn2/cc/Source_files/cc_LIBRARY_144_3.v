...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(new_n44_), .c(new_n45_), .O(z02));
  aoi21  g16(.a(new_n52_), .b(new_n44_), .c(new_n45_), .O(z03));
  ...
  nor2   g30(.a(new_n54_), .b(x15), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x00), .O(new_n73_));
  nand3  g32(.a(new_n62_), .b(x10), .c(x08), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x13), .c(x02), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n45_), .O(z12));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n54_), .b(new_n77_), .c(x14), .O(new_n78_));
  nor2   g37(.a(new_n51_), .b(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n45_), .O(z13));
  nand2  g39(.a(new_n54_), .b(x15), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n44_), .c(new_n45_), .O(z14));
  nand3  g41(.a(new_n74_), .b(x16), .c(new_n49_), .O(new_n83_));
  nand2  g42(.a(new_n72_), .b(x03), .O(new_n84_));
  nor2   g43(.a(new_n45_), .b(x02), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(new_n86_));
  aoi21  g45(.a(new_n84_), .b(new_n83_), .c(new_n86_), .O(z15));
  nand2  g46(.a(new_n72_), .b(x04), .O(new_n88_));
  aoi21  g47(.a(new_n74_), .b(x17), .c(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(z16));
  ...
  nand2  g57(.a(new_n74_), .b(new_n60_), .O(new_n99_));
  ...
  nand2  g62(.a(new_n74_), .b(new_n43_), .O(new_n104_));
