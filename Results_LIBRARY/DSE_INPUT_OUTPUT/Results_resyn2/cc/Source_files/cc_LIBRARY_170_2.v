...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n52_, new_n54_, new_n57_, new_n58_, new_n60_, new_n62_,
  ...
  nor2   g23(.a(new_n64_), .b(new_n58_), .O(z09));
  ...
  aoi21  g39(.a(new_n57_), .b(x15), .c(new_n51_), .O(z18));
  aoi21  g40(.a(new_n43_), .b(x15), .c(new_n51_), .O(z19));
  buf    g41(.a(x15), .O(z06));
endmodule
