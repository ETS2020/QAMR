...
module FAU ( 
  ...
  aoi21  g34(.a(new_n50_), .b(x01), .c(new_n75_), .O(z13));
  nand2  g35(.a(new_n50_), .b(x02), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n47_), .c(new_n46_), .O(z14));
  nand2  g37(.a(new_n47_), .b(x12), .O(new_n79_));
  nand2  g38(.a(new_n50_), .b(x03), .O(new_n80_));
  nand3  g39(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(z15));
  inv1   g41(.a(x04), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(new_n83_), .O(new_n84_));
  nand2  g43(.a(new_n49_), .b(new_n61_), .O(new_n85_));
  ...
  nand3  g50(.a(new_n91_), .b(new_n89_), .c(new_n70_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z17));
  nand2  g52(.a(new_n50_), .b(x06), .O(new_n94_));
  aoi21  g53(.a(new_n49_), .b(x19), .c(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n46_), .O(z18));
  inv1   g55(.a(x07), .O(new_n97_));
  nand3  g56(.a(x10), .b(x08), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n49_), .b(new_n43_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(new_n70_), .O(new_n100_));
