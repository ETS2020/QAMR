...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n50_,
    ...
    new_n109_;
  nor2   g00(.a(x20), .b(x18), .O(new_n42_));
  ...
  nor3   g15(.a(new_n56_), .b(new_n42_), .c(new_n54_), .O(z03));
  inv1   g16(.a(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n42_), .b(new_n59_), .O(z05));
  nor2   g19(.a(new_n42_), .b(new_n54_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nor2   g21(.a(new_n42_), .b(new_n62_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nor2   g23(.a(new_n42_), .b(new_n64_), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n42_), .O(z09));
  aoi21  g26(.a(x09), .b(x08), .c(new_n42_), .O(z10));
  nor2   g27(.a(new_n42_), .b(new_n55_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  nand4  g29(.a(new_n54_), .b(x10), .c(x08), .d(new_n70_), .O(new_n71_));
  nor2   g30(.a(new_n42_), .b(new_n50_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  nand3  g32(.a(new_n54_), .b(x10), .c(x08), .O(new_n74_));
  ...
  nand3  g42(.a(new_n46_), .b(new_n43_), .c(x12), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n54_), .c(new_n84_), .O(z14));
  nand2  g44(.a(new_n43_), .b(x12), .O(new_n86_));
  nand3  g45(.a(new_n74_), .b(x16), .c(new_n55_), .O(new_n87_));
  nand2  g46(.a(new_n49_), .b(x03), .O(new_n88_));
  ...
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n72_), .O(new_n93_));
  ...
  aoi21  g68(.a(new_n106_), .b(new_n105_), .c(new_n109_), .O(z19));
endmodule
