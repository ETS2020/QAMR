...
module FAU ( 
  ...
  nor2   g00(.a(x09), .b(x01), .O(new_n42_));
  ...
  nand2  g20(.a(new_n45_), .b(new_n51_), .O(z06));
  ...
  nand2  g27(.a(new_n45_), .b(new_n46_), .O(z11));
  ...
  nor2   g32(.a(new_n42_), .b(new_n54_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n73_), .c(new_n71_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z12));
  inv1   g35(.a(x09), .O(new_n77_));
  aoi21  g36(.a(x14), .b(x12), .c(new_n77_), .O(new_n78_));
  nand2  g37(.a(x10), .b(x08), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n46_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n52_), .c(x12), .O(new_n81_));
  oai21  g40(.a(new_n78_), .b(x01), .c(new_n81_), .O(z13));
  inv1   g41(.a(x02), .O(new_n83_));
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n51_), .O(new_n84_));
  ...
  nand2  g53(.a(new_n52_), .b(new_n63_), .O(new_n95_));
