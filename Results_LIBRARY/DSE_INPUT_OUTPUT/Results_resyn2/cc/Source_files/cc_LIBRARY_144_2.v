...
module FAU ( 
  ...
  oai21  g14(.a(new_n49_), .b(new_n43_), .c(new_n44_), .O(z03));
  ...
  aoi21  g25(.a(new_n43_), .b(x02), .c(new_n46_), .O(z11));
  ...
  oai21  g38(.a(new_n52_), .b(new_n43_), .c(x02), .O(new_n80_));
  nand3  g39(.a(new_n51_), .b(x15), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n80_), .O(z14));
  nand3  g41(.a(new_n71_), .b(x16), .c(new_n46_), .O(new_n83_));
  nand2  g42(.a(new_n52_), .b(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n43_), .O(z15));
  inv1   g44(.a(x04), .O(new_n86_));
  nand4  g45(.a(new_n60_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n71_), .b(new_n62_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n44_), .O(z16));
  inv1   g49(.a(x05), .O(new_n91_));
  nand4  g50(.a(new_n60_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  ...
  nand4  g56(.a(new_n60_), .b(x10), .c(x08), .d(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n71_), .b(new_n58_), .O(new_n99_));
