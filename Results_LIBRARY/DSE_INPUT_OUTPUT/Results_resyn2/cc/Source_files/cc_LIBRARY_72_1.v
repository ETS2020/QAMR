...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(new_n45_), .c(new_n56_), .d(x12), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z03));
  nand2  g18(.a(x18), .b(x13), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n44_), .b(new_n61_), .O(z05));
  nand2  g21(.a(new_n45_), .b(new_n49_), .O(z06));
  ...
  oai21  g43(.a(new_n79_), .b(new_n84_), .c(new_n49_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n47_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n45_), .O(z14));
  nand3  g46(.a(new_n50_), .b(x16), .c(new_n56_), .O(new_n88_));
  ...
  aoi21  g53(.a(new_n50_), .b(new_n64_), .c(new_n52_), .O(new_n95_));
  ...
  nor2   g58(.a(new_n44_), .b(new_n52_), .O(new_n100_));
  nand2  g59(.a(new_n50_), .b(new_n43_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand2  g63(.a(new_n51_), .b(new_n104_), .O(new_n105_));
  aoi21  g64(.a(new_n50_), .b(new_n61_), .c(new_n52_), .O(new_n106_));
