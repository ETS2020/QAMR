...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n68_, new_n69_, new_n71_, new_n73_, new_n76_, new_n78_;
  ...
  nor2   g11(.a(new_n48_), .b(new_n50_), .O(z03));
  nor2   g12(.a(x15), .b(new_n50_), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n43_), .b(x15), .c(new_n50_), .O(z19));
  buf    g39(.a(x15), .O(z06));
endmodule
