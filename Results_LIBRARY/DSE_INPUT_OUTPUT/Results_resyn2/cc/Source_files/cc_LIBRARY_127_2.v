...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n55_, new_n56_, new_n59_, new_n61_, new_n63_, new_n67_,
  ...
  nor2   g14(.a(x15), .b(new_n49_), .O(new_n56_));
  ...
  aoi21  g29(.a(new_n70_), .b(new_n69_), .c(new_n49_), .O(z13));
  ...
  aoi21  g37(.a(new_n78_), .b(x15), .c(new_n49_), .O(z17));
  aoi21  g38(.a(new_n55_), .b(x15), .c(new_n49_), .O(z18));
