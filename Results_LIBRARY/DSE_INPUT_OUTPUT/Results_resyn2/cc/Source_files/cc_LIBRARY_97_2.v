...
module FAU ( 
  ...
  oai21  g31(.a(new_n72_), .b(new_n52_), .c(new_n42_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  oai21  g33(.a(new_n52_), .b(x15), .c(x12), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n70_), .c(new_n74_), .O(z12));
  ...
  nand3  g41(.a(new_n82_), .b(new_n42_), .c(x02), .O(new_n83_));
  nand2  g42(.a(new_n48_), .b(x12), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n71_), .c(new_n84_), .O(z14));
  nand3  g44(.a(x16), .b(x15), .c(new_n47_), .O(new_n86_));
  nand2  g45(.a(new_n71_), .b(x03), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n82_), .O(new_n88_));
  oai21  g47(.a(new_n64_), .b(x14), .c(new_n52_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n42_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n86_), .c(new_n54_), .O(z15));
  nand2  g50(.a(x17), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n71_), .b(x04), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  aoi21  g53(.a(new_n52_), .b(new_n62_), .c(x07), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n92_), .c(new_n54_), .O(z16));
  inv1   g56(.a(x18), .O(new_n98_));
  nand2  g57(.a(x12), .b(x05), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n52_), .c(new_n42_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n71_), .O(new_n101_));
  oai21  g60(.a(new_n75_), .b(new_n98_), .c(new_n101_), .O(z17));
  nand2  g61(.a(x19), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n71_), .b(x06), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  aoi21  g64(.a(new_n52_), .b(new_n60_), .c(x07), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n103_), .c(new_n54_), .O(z18));
  nand2  g67(.a(new_n52_), .b(new_n42_), .O(new_n109_));
  nand2  g68(.a(x20), .b(x12), .O(new_n110_));
  aoi21  g69(.a(new_n109_), .b(new_n71_), .c(new_n110_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
