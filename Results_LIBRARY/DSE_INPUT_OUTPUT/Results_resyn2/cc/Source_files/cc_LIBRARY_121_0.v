...
module FAU ( 
  ...
  nand2  g19(.a(new_n47_), .b(x06), .O(z05));
  ...
  nand4  g57(.a(new_n54_), .b(x10), .c(x08), .d(new_n46_), .O(new_n99_));
  oai21  g58(.a(new_n74_), .b(x15), .c(new_n47_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z18));
  inv1   g61(.a(x12), .O(new_n103_));
  aoi21  g62(.a(new_n47_), .b(new_n46_), .c(new_n103_), .O(new_n104_));
