...
module FAU ( 
  ...
  nand2  g06(.a(x19), .b(z04), .O(new_n48_));
  ...
  nand2  g19(.a(new_n48_), .b(new_n60_), .O(z06));
  ...
  aoi21  g30(.a(x19), .b(z04), .c(new_n58_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  oai21  g32(.a(new_n54_), .b(x15), .c(new_n73_), .O(new_n74_));
  ...
  oai21  g37(.a(new_n54_), .b(new_n78_), .c(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n50_), .c(new_n77_), .O(z13));
  nand3  g39(.a(x10), .b(x08), .c(x02), .O(new_n81_));
  and2   g40(.a(new_n81_), .b(new_n60_), .O(new_n82_));
  nand2  g41(.a(new_n72_), .b(new_n50_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z14));
  nand3  g43(.a(new_n60_), .b(x10), .c(x08), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x16), .c(new_n49_), .O(new_n86_));
  nand4  g45(.a(new_n60_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n77_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n60_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n54_), .b(x15), .c(new_n62_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n48_), .O(z16));
  nand4  g52(.a(new_n44_), .b(new_n60_), .c(x10), .d(x08), .O(new_n94_));
  ...
  oai21  g59(.a(new_n54_), .b(x15), .c(new_n44_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n72_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand4  g63(.a(new_n60_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  oai21  g64(.a(new_n54_), .b(x15), .c(new_n43_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n48_), .O(z19));
  buf    g67(.a(x19), .O(z05));
endmodule
