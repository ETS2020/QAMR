...
module FAU ( 
  ...
  oai21  g23(.a(x15), .b(x08), .c(x09), .O(z10));
  inv1   g24(.a(z10), .O(z09));
  nand2  g25(.a(new_n44_), .b(new_n49_), .O(z11));
  nand3  g26(.a(new_n53_), .b(new_n44_), .c(x13), .O(new_n68_));
  ...
  nand2  g32(.a(new_n73_), .b(new_n49_), .O(new_n74_));
  ...
  oai21  g37(.a(new_n69_), .b(new_n78_), .c(new_n52_), .O(new_n79_));
  ...
  nand4  g41(.a(new_n53_), .b(new_n44_), .c(x16), .d(new_n49_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n56_), .O(z15));
  nor2   g43(.a(new_n52_), .b(x09), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x17), .O(new_n86_));
  inv1   g45(.a(x04), .O(new_n87_));
  nand3  g46(.a(x10), .b(x08), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(new_n69_), .b(new_n61_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n52_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n86_), .c(new_n56_), .O(z16));
  ...
  oai21  g58(.a(new_n59_), .b(new_n56_), .c(new_n47_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x15), .O(new_n101_));
  nand2  g60(.a(new_n69_), .b(x19), .O(new_n102_));
  ...
  nand2  g65(.a(new_n85_), .b(x20), .O(new_n107_));
  inv1   g66(.a(x07), .O(new_n108_));
  nand3  g67(.a(x10), .b(x08), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n69_), .b(new_n43_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(new_n52_), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n107_), .c(new_n56_), .O(z19));
  buf    g71(.a(x15), .O(z06));
endmodule
