...
module FAU ( 
  ...
  nor2   g02(.a(z04), .b(x02), .O(new_n44_));
  ...
  nor3   g16(.a(new_n57_), .b(new_n44_), .c(new_n50_), .O(z03));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n44_), .b(new_n59_), .O(z05));
  nor2   g19(.a(new_n44_), .b(new_n50_), .O(z06));
  ...
  aoi21  g57(.a(x18), .b(new_n98_), .c(new_n53_), .O(new_n99_));
  nand2  g58(.a(new_n51_), .b(z04), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n97_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  nand4  g62(.a(new_n50_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n51_), .b(new_n59_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n99_), .O(new_n106_));
  ...
  nand3  g70(.a(new_n111_), .b(new_n109_), .c(new_n99_), .O(new_n112_));
