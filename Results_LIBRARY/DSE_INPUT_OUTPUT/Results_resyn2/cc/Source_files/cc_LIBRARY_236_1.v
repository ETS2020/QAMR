...
module FAU ( 
  ...
  oai21  g34(.a(new_n51_), .b(new_n54_), .c(x11), .O(new_n76_));
  ...
  nand4  g40(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n82_));
  ...
  nand3  g47(.a(new_n51_), .b(x16), .c(new_n48_), .O(new_n89_));
  ...
  oai21  g52(.a(new_n61_), .b(new_n54_), .c(x11), .O(new_n94_));
  ...
  nand3  g64(.a(new_n105_), .b(new_n103_), .c(new_n44_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n101_), .c(new_n54_), .O(z17));
  oai21  g66(.a(new_n58_), .b(new_n54_), .c(x11), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n51_), .b(x19), .O(new_n110_));
  ...
  oai21  g73(.a(new_n43_), .b(new_n54_), .c(x11), .O(new_n115_));
