...
module FAU ( 
  ...
  aoi21  g14(.a(x20), .b(x18), .c(new_n55_), .O(new_n56_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n48_), .c(new_n79_), .O(z13));
  aoi21  g42(.a(new_n73_), .b(x02), .c(x15), .O(new_n84_));
  nand2  g43(.a(new_n56_), .b(new_n48_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z14));
  inv1   g45(.a(x03), .O(new_n87_));
  nand3  g46(.a(new_n73_), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g52(.a(new_n73_), .b(new_n52_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n53_), .b(new_n65_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n45_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  nand3  g57(.a(new_n73_), .b(new_n52_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n53_), .b(new_n42_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n45_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  nand3  g62(.a(new_n73_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n53_), .b(new_n62_), .O(new_n105_));
  ...
  nand2  g68(.a(new_n53_), .b(new_n60_), .O(new_n110_));
