...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n57_, new_n62_,
  ...
  nor2   g06(.a(new_n47_), .b(x06), .O(new_n48_));
  ...
  nor2   g26(.a(new_n48_), .b(new_n51_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  aoi21  g28(.a(x19), .b(new_n44_), .c(new_n69_), .O(new_n70_));
  ...
  oai21  g49(.a(new_n74_), .b(x15), .c(new_n62_), .O(new_n91_));
  ...
  oai21  g55(.a(new_n74_), .b(x15), .c(new_n96_), .O(new_n97_));
  ...
  aoi22  g59(.a(new_n100_), .b(new_n47_), .c(new_n69_), .d(x06), .O(z18));
  inv1   g60(.a(x07), .O(new_n102_));
  nand4  g61(.a(new_n52_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n74_), .b(x15), .c(new_n43_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n70_), .O(new_n105_));
