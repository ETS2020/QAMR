...
module FAU ( 
  ...
  nand4  g30(.a(new_n53_), .b(x10), .c(x08), .d(new_n44_), .O(new_n72_));
  ...
  nand2  g36(.a(new_n49_), .b(new_n48_), .O(new_n78_));
  nand4  g37(.a(new_n53_), .b(x10), .c(x08), .d(x01), .O(new_n79_));
  ...
  aoi21  g42(.a(new_n82_), .b(new_n53_), .c(new_n83_), .O(z14));
  ...
  aoi21  g47(.a(new_n45_), .b(new_n44_), .c(new_n57_), .O(new_n89_));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n53_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n74_), .b(x15), .c(new_n64_), .O(new_n92_));
  ...
  oai21  g56(.a(new_n74_), .b(x15), .c(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n89_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  nand4  g59(.a(new_n53_), .b(x10), .c(x08), .d(new_n45_), .O(new_n101_));
  oai21  g60(.a(new_n74_), .b(x15), .c(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n46_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand4  g64(.a(new_n53_), .b(x10), .c(x08), .d(new_n105_), .O(new_n106_));
  oai21  g65(.a(new_n74_), .b(x15), .c(new_n43_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n89_), .O(new_n108_));
