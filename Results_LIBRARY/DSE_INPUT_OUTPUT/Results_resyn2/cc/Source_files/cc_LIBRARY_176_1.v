...
module FAU ( 
  ...
  nor2   g20(.a(new_n61_), .b(new_n51_), .O(z06));
  ...
  aoi21  g47(.a(x18), .b(new_n44_), .c(new_n88_), .O(new_n89_));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n51_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n73_), .b(x15), .c(new_n63_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n73_), .b(x15), .c(z04), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n96_), .c(new_n89_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n51_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n73_), .b(x15), .c(new_n59_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n45_), .O(z18));
  nand4  g63(.a(new_n51_), .b(x10), .c(x08), .d(new_n44_), .O(new_n105_));
