...
module FAU ( 
  ...
  nor3   g15(.a(new_n56_), .b(new_n44_), .c(new_n52_), .O(z03));
  nor2   g16(.a(x18), .b(new_n46_), .O(z04));
  ...
  aoi21  g29(.a(new_n47_), .b(new_n46_), .c(new_n70_), .O(new_n71_));
  ...
  nand4  g53(.a(new_n52_), .b(x10), .c(x08), .d(new_n46_), .O(new_n95_));
  oai21  g54(.a(new_n75_), .b(x15), .c(new_n47_), .O(new_n96_));
  ...
  oai21  g59(.a(new_n75_), .b(x15), .c(new_n59_), .O(new_n101_));
