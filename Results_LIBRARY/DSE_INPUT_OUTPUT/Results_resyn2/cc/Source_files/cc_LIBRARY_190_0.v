...
module FAU ( 
  ...
  aoi21  g38(.a(new_n78_), .b(new_n59_), .c(new_n79_), .O(z14));
  inv1   g39(.a(x03), .O(new_n81_));
  oai21  g40(.a(new_n49_), .b(new_n81_), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n59_), .O(new_n83_));
  nand4  g42(.a(new_n72_), .b(x16), .c(new_n67_), .d(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n83_), .O(z15));
  inv1   g44(.a(x04), .O(new_n86_));
  nand4  g45(.a(new_n59_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  oai21  g46(.a(new_n49_), .b(x15), .c(new_n61_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(x12), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z16));
  inv1   g49(.a(x05), .O(new_n91_));
  oai21  g50(.a(new_n49_), .b(new_n91_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n59_), .O(new_n93_));
  nand3  g52(.a(new_n72_), .b(x18), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(z17));
  inv1   g54(.a(x06), .O(new_n96_));
  nand4  g55(.a(new_n59_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  oai21  g56(.a(new_n49_), .b(x15), .c(new_n57_), .O(new_n98_));
  ...
  oai21  g61(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n103_));
