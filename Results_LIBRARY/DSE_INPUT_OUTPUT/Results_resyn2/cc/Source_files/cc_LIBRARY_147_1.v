...
module FAU ( 
  ...
  nand2  g03(.a(x18), .b(new_n42_), .O(new_n45_));
  ...
  aoi21  g13(.a(new_n54_), .b(z04), .c(x11), .O(z02));
  ...
  nand4  g30(.a(new_n60_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  aoi21  g31(.a(x18), .b(new_n42_), .c(new_n56_), .O(new_n73_));
  ...
  oai21  g39(.a(new_n52_), .b(new_n80_), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n47_), .c(new_n79_), .O(z13));
  nand3  g41(.a(x10), .b(x08), .c(x02), .O(new_n83_));
  nand2  g42(.a(new_n73_), .b(new_n47_), .O(new_n84_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n75_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n75_), .b(new_n63_), .O(new_n94_));
  ...
  nand2  g57(.a(new_n75_), .b(z04), .O(new_n99_));
  ...
  nand2  g62(.a(new_n75_), .b(new_n58_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n73_), .O(new_n105_));
  inv1   g64(.a(new_n105_), .O(z18));
  inv1   g65(.a(x07), .O(new_n107_));
  nand4  g66(.a(new_n60_), .b(x10), .c(x08), .d(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n75_), .b(new_n43_), .O(new_n109_));
