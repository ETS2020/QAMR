...
module FAU ( 
  ...
  aoi21  g29(.a(x19), .b(x18), .c(new_n56_), .O(new_n71_));
  ...
  nand3  g39(.a(new_n48_), .b(new_n44_), .c(x12), .O(new_n81_));
  ...
  oai21  g47(.a(new_n52_), .b(x15), .c(new_n62_), .O(new_n89_));
