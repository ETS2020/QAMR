...
module FAU ( 
  ...
  aoi21  g12(.a(x19), .b(new_n44_), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g16(.a(new_n57_), .b(new_n49_), .c(new_n45_), .O(z03));
  nand2  g17(.a(new_n45_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n44_), .O(z05));
  ...
  inv1   g42(.a(new_n54_), .O(new_n84_));
  ...
  nand2  g48(.a(new_n52_), .b(new_n63_), .O(new_n90_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(new_n54_), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z17));
  nand2  g57(.a(x12), .b(x06), .O(new_n99_));
  aoi21  g58(.a(new_n52_), .b(new_n60_), .c(new_n99_), .O(z18));
