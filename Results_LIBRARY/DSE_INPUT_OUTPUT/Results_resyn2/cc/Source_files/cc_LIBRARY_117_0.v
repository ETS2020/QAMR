...
module FAU ( 
  ...
  nand2  g18(.a(new_n50_), .b(x02), .O(z06));
  ...
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(x02), .O(new_n71_));
  ...
  nand2  g38(.a(new_n69_), .b(new_n50_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n47_), .c(new_n46_), .d(x12), .O(new_n81_));
  ...
  oai21  g49(.a(new_n73_), .b(new_n61_), .c(new_n90_), .O(z16));
  nand2  g50(.a(x18), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n50_), .b(x05), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n51_), .O(new_n94_));
  inv1   g53(.a(x02), .O(new_n95_));
  inv1   g54(.a(x18), .O(new_n96_));
  aoi21  g55(.a(new_n69_), .b(new_n96_), .c(new_n95_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n92_), .c(new_n55_), .O(z17));
  nand2  g58(.a(x19), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n50_), .b(x06), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n51_), .O(new_n102_));
  aoi21  g61(.a(new_n69_), .b(new_n58_), .c(new_n95_), .O(new_n103_));
  ...
  oai21  g67(.a(new_n73_), .b(new_n43_), .c(new_n108_), .O(z19));
endmodule
