...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n42_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_, new_n51_,
  ...
  aoi21  g03(.a(z04), .b(new_n42_), .c(new_n44_), .O(z00));
  ...
  aoi21  g11(.a(x20), .b(x18), .c(new_n52_), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(new_n42_), .O(new_n54_));
  aoi21  g13(.a(new_n51_), .b(new_n49_), .c(new_n54_), .O(z02));
  nand2  g14(.a(new_n46_), .b(new_n52_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(z01), .O(new_n57_));
  ...
  nor2   g25(.a(new_n66_), .b(new_n60_), .O(z09));
  and2   g26(.a(new_n66_), .b(new_n46_), .O(z10));
  nor2   g27(.a(new_n60_), .b(new_n49_), .O(z11));
  ...
  nand4  g35(.a(new_n50_), .b(x10), .c(x08), .d(x01), .O(new_n77_));
  ...
  nand4  g49(.a(new_n50_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n51_), .b(new_n63_), .O(new_n92_));
  ...
  nand2  g55(.a(new_n51_), .b(z04), .O(new_n97_));
  ...
  nand2  g60(.a(new_n51_), .b(new_n59_), .O(new_n102_));
  ...
  nand2  g65(.a(new_n51_), .b(new_n44_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n53_), .O(new_n108_));
