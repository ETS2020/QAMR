...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n65_, new_n67_, new_n69_, new_n72_, new_n73_, new_n74_,
  ...
  nand2  g20(.a(new_n49_), .b(x18), .O(z04));
  nand2  g21(.a(new_n48_), .b(new_n44_), .O(z05));
  nor2   g22(.a(new_n45_), .b(new_n53_), .O(z06));
  ...
  nand2  g35(.a(new_n76_), .b(new_n49_), .O(z12));
  ...
  nand2  g42(.a(new_n83_), .b(new_n53_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n51_), .c(x12), .O(new_n85_));
  ...
  nand2  g53(.a(new_n54_), .b(new_n65_), .O(new_n95_));
  ...
  nand2  g59(.a(new_n54_), .b(new_n100_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n49_), .O(z17));
  inv1   g62(.a(new_n54_), .O(new_n104_));
  nand2  g63(.a(x19), .b(x12), .O(new_n105_));
  aoi21  g64(.a(new_n104_), .b(new_n44_), .c(new_n105_), .O(z18));
  inv1   g65(.a(x07), .O(new_n107_));
  nand4  g66(.a(new_n53_), .b(x10), .c(x08), .d(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n54_), .b(new_n43_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n56_), .O(new_n110_));
