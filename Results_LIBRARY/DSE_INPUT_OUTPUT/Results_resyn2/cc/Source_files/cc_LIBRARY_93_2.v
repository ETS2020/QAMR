...
module FAU ( 
  ...
  nand2  g03(.a(new_n44_), .b(x01), .O(new_n45_));
  ...
  aoi21  g14(.a(new_n54_), .b(new_n50_), .c(new_n55_), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  nor3   g16(.a(new_n48_), .b(x14), .c(new_n57_), .O(z03));
  ...
  oai21  g30(.a(new_n71_), .b(new_n52_), .c(new_n51_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n44_), .O(new_n73_));
  oai21  g32(.a(new_n52_), .b(x15), .c(x12), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n70_), .c(new_n73_), .O(z12));
  ...
  nand2  g38(.a(new_n52_), .b(x15), .O(new_n80_));
  nand3  g39(.a(new_n53_), .b(x02), .c(new_n51_), .O(new_n81_));
  ...
  nand3  g44(.a(x16), .b(new_n76_), .c(x12), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n53_), .c(new_n85_), .O(z15));
  ...
  and2   g56(.a(x10), .b(x08), .O(new_n98_));
  nand2  g57(.a(new_n44_), .b(x06), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  aoi21  g59(.a(new_n52_), .b(new_n60_), .c(x01), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n97_), .c(new_n57_), .O(z18));
  ...
  oai21  g65(.a(new_n74_), .b(new_n43_), .c(new_n106_), .O(z19));
  buf    g66(.a(x15), .O(z06));
endmodule
