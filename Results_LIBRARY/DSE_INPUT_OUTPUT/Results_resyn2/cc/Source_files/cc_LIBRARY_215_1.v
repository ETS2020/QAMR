...
module FAU ( 
  ...
  nor2   g01(.a(new_n42_), .b(x08), .O(new_n43_));
  ...
  oai21  g09(.a(new_n50_), .b(x11), .c(x08), .O(new_n51_));
  ...
  nand3  g29(.a(new_n49_), .b(x10), .c(x00), .O(new_n71_));
  ...
  oai21  g61(.a(new_n50_), .b(new_n102_), .c(x08), .O(new_n103_));
  ...
  oai21  g66(.a(new_n50_), .b(new_n107_), .c(x08), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x10), .O(new_n109_));
