...
module FAU ( 
  ...
  nand2  g07(.a(new_n43_), .b(x15), .O(new_n49_));
  ...
  nand3  g12(.a(x20), .b(x15), .c(x12), .O(new_n54_));
  nor2   g13(.a(new_n54_), .b(new_n47_), .O(z03));
  nand2  g14(.a(new_n49_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  nand2  g16(.a(new_n49_), .b(new_n57_), .O(z05));
  inv1   g17(.a(x17), .O(new_n59_));
  inv1   g18(.a(new_n49_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n59_), .O(z07));
  inv1   g20(.a(x16), .O(new_n62_));
  nand2  g21(.a(new_n49_), .b(new_n62_), .O(z08));
  nand3  g22(.a(new_n49_), .b(x09), .c(x08), .O(z10));
  inv1   g23(.a(z10), .O(z09));
  nand2  g24(.a(new_n49_), .b(new_n46_), .O(z11));
  ...
  nand4  g33(.a(new_n45_), .b(x10), .c(x08), .d(x01), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n74_), .c(new_n49_), .d(x12), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z13));
  inv1   g36(.a(x02), .O(new_n78_));
  oai21  g37(.a(new_n69_), .b(new_n78_), .c(new_n45_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n73_), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n49_), .O(z14));
  ...
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(new_n45_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n92_), .c(new_n67_), .O(z17));
  oai21  g57(.a(new_n57_), .b(new_n67_), .c(x20), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n69_), .b(x19), .O(new_n101_));
  nand4  g60(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n102_));
  ...
  nand4  g65(.a(new_n45_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
