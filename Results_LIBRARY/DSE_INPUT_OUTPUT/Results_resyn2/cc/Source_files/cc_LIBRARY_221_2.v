...
module FAU ( 
  ...
  nand2  g01(.a(new_n42_), .b(x01), .O(new_n43_));
  ...
  nand2  g21(.a(new_n43_), .b(new_n52_), .O(z06));
  ...
  aoi21  g33(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(new_n76_));
  ...
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(new_n75_), .O(new_n102_));
