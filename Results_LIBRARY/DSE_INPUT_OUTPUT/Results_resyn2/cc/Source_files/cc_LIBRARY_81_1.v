...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x05), .c(new_n48_), .O(z03));
  nor2   g18(.a(new_n46_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n46_), .b(new_n61_), .O(z05));
  nor2   g21(.a(new_n48_), .b(new_n44_), .O(z06));
  ...
  nand3  g45(.a(new_n49_), .b(x16), .c(new_n55_), .O(new_n87_));
  ...
  oai21  g50(.a(new_n64_), .b(new_n72_), .c(x05), .O(new_n92_));
  ...
  aoi21  g58(.a(x10), .b(x08), .c(x15), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(x05), .c(x12), .O(new_n101_));
  aoi21  g60(.a(new_n52_), .b(new_n99_), .c(new_n101_), .O(z17));
  oai21  g61(.a(new_n61_), .b(new_n72_), .c(x05), .O(new_n103_));
  ...
  nand2  g71(.a(new_n49_), .b(new_n43_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n112_), .c(new_n48_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n110_), .c(new_n72_), .O(z19));
endmodule
