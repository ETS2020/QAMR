...
module FAU ( 
  ...
  nor2   g15(.a(x20), .b(x19), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(x18), .O(z04));
  nand2  g17(.a(x20), .b(new_n44_), .O(z05));
  inv1   g18(.a(x15), .O(new_n60_));
  nand2  g19(.a(new_n45_), .b(new_n60_), .O(z06));
  ...
  oai21  g37(.a(new_n51_), .b(new_n78_), .c(new_n60_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n49_), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n45_), .O(z14));
  nand3  g40(.a(new_n60_), .b(x10), .c(x08), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x16), .c(new_n47_), .O(new_n83_));
  nand4  g42(.a(new_n60_), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n76_), .O(z15));
  inv1   g44(.a(x12), .O(new_n86_));
  nor2   g45(.a(new_n57_), .b(new_n86_), .O(new_n87_));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n60_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  ...
  nand4  g57(.a(x20), .b(new_n60_), .c(x10), .d(x08), .O(new_n99_));
  ...
  aoi21  g61(.a(new_n99_), .b(new_n44_), .c(new_n102_), .O(z18));
  nand4  g62(.a(x19), .b(new_n60_), .c(x10), .d(x08), .O(new_n104_));
