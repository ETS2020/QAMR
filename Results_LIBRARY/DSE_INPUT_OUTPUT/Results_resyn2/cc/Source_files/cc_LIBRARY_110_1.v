...
module FAU ( 
  ...
  nand3  g30(.a(new_n54_), .b(new_n45_), .c(x13), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(z12));
  oai21  g32(.a(new_n50_), .b(new_n70_), .c(x02), .O(new_n74_));
  ...
  nand2  g38(.a(x12), .b(x02), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(new_n54_), .c(new_n80_), .O(z14));
  nand3  g40(.a(x16), .b(new_n68_), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x02), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand3  g43(.a(new_n50_), .b(x16), .c(new_n68_), .O(new_n85_));
  ...
  oai21  g48(.a(new_n62_), .b(new_n70_), .c(x02), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n50_), .b(x17), .O(new_n92_));
  nand4  g51(.a(new_n48_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  ...
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(new_n48_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n97_), .c(new_n70_), .O(z17));
  nand2  g62(.a(z06), .b(x19), .O(new_n104_));
  inv1   g63(.a(x06), .O(new_n105_));
  nand3  g64(.a(x10), .b(x08), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n50_), .b(new_n60_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n48_), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n104_), .c(new_n70_), .O(z18));
  oai21  g68(.a(new_n43_), .b(new_n70_), .c(x02), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n50_), .b(x20), .O(new_n112_));
  nand4  g71(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n113_));
