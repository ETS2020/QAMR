...
module FAU ( 
  ...
  nand2  g07(.a(new_n48_), .b(x06), .O(new_n49_));
  ...
  aoi21  g14(.a(new_n48_), .b(x06), .c(new_n55_), .O(new_n56_));
  ...
  nand4  g30(.a(new_n53_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  nand2  g32(.a(new_n54_), .b(new_n73_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n72_), .c(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n49_), .O(z12));
  ...
  nand2  g50(.a(new_n54_), .b(new_n64_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n56_), .O(new_n93_));
  ...
  nand2  g56(.a(new_n54_), .b(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n56_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  nand2  g59(.a(new_n54_), .b(x19), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n44_), .c(x19), .d(new_n55_), .O(z18));
  ...
  nand2  g65(.a(new_n106_), .b(new_n49_), .O(z19));
endmodule
