...
module FAU ( 
  ...
  nor2   g02(.a(x19), .b(x05), .O(new_n44_));
  nor3   g03(.a(new_n44_), .b(new_n43_), .c(new_n42_), .O(z00));
  oai21  g04(.a(x19), .b(x05), .c(x15), .O(new_n46_));
  ...
  nand2  g17(.a(new_n58_), .b(x05), .O(z05));
  ...
  nor2   g26(.a(new_n44_), .b(new_n55_), .O(new_n68_));
  ...
  nand2  g33(.a(new_n52_), .b(x12), .O(new_n75_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n75_), .O(z13));
  inv1   g39(.a(x02), .O(new_n81_));
  oai21  g40(.a(new_n77_), .b(new_n81_), .c(new_n50_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n79_), .c(x12), .O(new_n83_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n52_), .O(z15));
  ...
  nand2  g53(.a(new_n94_), .b(new_n52_), .O(z16));
  aoi21  g54(.a(new_n51_), .b(x19), .c(x05), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  oai21  g56(.a(new_n77_), .b(x15), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x12), .O(new_n99_));
  nor2   g58(.a(new_n99_), .b(new_n96_), .O(z17));
  ...
  aoi21  g63(.a(new_n101_), .b(new_n58_), .c(new_n104_), .O(z18));
  ...
  nand3  g67(.a(new_n108_), .b(new_n107_), .c(new_n68_), .O(new_n109_));
