...
module FAU ( 
  ...
  oai21  g16(.a(new_n57_), .b(new_n48_), .c(new_n42_), .O(z03));
  ...
  nand3  g27(.a(new_n68_), .b(new_n50_), .c(new_n67_), .O(new_n69_));
  aoi21  g28(.a(x19), .b(x06), .c(new_n53_), .O(new_n70_));
  ...
  nand2  g39(.a(new_n70_), .b(new_n48_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z14));
  inv1   g41(.a(x03), .O(new_n83_));
  nand3  g42(.a(new_n68_), .b(new_n50_), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n42_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand3  g48(.a(new_n68_), .b(new_n50_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n68_), .b(new_n50_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g59(.a(new_n68_), .b(new_n50_), .c(new_n100_), .O(new_n101_));
  inv1   g60(.a(x19), .O(new_n102_));
  nand2  g61(.a(new_n51_), .b(new_n102_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n101_), .c(new_n70_), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand3  g65(.a(new_n68_), .b(new_n50_), .c(new_n106_), .O(new_n107_));
