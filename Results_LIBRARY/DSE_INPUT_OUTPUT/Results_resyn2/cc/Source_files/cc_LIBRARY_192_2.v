...
module FAU ( 
  ...
  aoi21  g31(.a(new_n44_), .b(x06), .c(new_n57_), .O(new_n73_));
  ...
  oai21  g41(.a(new_n50_), .b(new_n82_), .c(new_n62_), .O(new_n83_));
  ...
  oai21  g51(.a(new_n50_), .b(x15), .c(new_n64_), .O(new_n93_));
  ...
  nor2   g60(.a(new_n44_), .b(x12), .O(new_n102_));
  nand2  g61(.a(new_n87_), .b(x19), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n54_), .c(new_n102_), .O(z18));
