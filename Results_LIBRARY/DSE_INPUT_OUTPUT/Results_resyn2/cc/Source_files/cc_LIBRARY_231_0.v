...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x08), .O(new_n43_));
  ...
  oai21  g11(.a(new_n52_), .b(new_n50_), .c(new_n44_), .O(z02));
  ...
  inv1   g35(.a(new_n46_), .O(new_n77_));
  ...
  aoi21  g41(.a(new_n81_), .b(new_n59_), .c(new_n82_), .O(z14));
  nand3  g42(.a(new_n59_), .b(x10), .c(x03), .O(new_n84_));
  nand3  g43(.a(x16), .b(new_n67_), .c(new_n48_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x08), .O(new_n87_));
  nand3  g46(.a(x16), .b(x15), .c(new_n67_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n54_), .O(z15));
  nand3  g48(.a(new_n59_), .b(x10), .c(x04), .O(new_n90_));
  nand2  g49(.a(x17), .b(new_n48_), .O(new_n91_));
