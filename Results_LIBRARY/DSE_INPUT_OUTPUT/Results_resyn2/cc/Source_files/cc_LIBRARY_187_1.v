...
module FAU ( 
  ...
  nor2   g15(.a(new_n44_), .b(new_n56_), .O(z06));
  inv1   g16(.a(z06), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(new_n49_), .O(z03));
  nand2  g18(.a(new_n51_), .b(x18), .O(z04));
  ...
  nand2  g28(.a(new_n51_), .b(new_n47_), .O(z11));
  nand2  g29(.a(new_n48_), .b(new_n44_), .O(new_n71_));
  oai21  g30(.a(new_n52_), .b(x00), .c(x12), .O(new_n72_));
  nor2   g31(.a(x13), .b(new_n56_), .O(new_n73_));
  ...
  oai21  g38(.a(new_n52_), .b(new_n56_), .c(x15), .O(new_n80_));
  ...
  oai21  g46(.a(new_n52_), .b(x04), .c(x12), .O(new_n88_));
  nor2   g47(.a(x17), .b(new_n56_), .O(new_n89_));
  aoi22  g48(.a(new_n89_), .b(new_n71_), .c(new_n88_), .d(new_n44_), .O(z16));
  ...
  nor2   g56(.a(x19), .b(new_n56_), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n71_), .c(new_n97_), .d(new_n44_), .O(z18));
