...
module FAU ( 
  ...
  nand2  g04(.a(x18), .b(new_n42_), .O(new_n46_));
  ...
  aoi21  g48(.a(x18), .b(new_n42_), .c(new_n89_), .O(new_n90_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n46_), .O(z17));
  inv1   g57(.a(x06), .O(new_n99_));
  nand4  g58(.a(new_n50_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n51_), .b(new_n57_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n90_), .O(new_n102_));
  ...
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n90_), .O(new_n107_));
