...
module FAU ( 
  ...
  nand2  g02(.a(new_n43_), .b(x05), .O(new_n44_));
  ...
  aoi21  g30(.a(new_n43_), .b(x05), .c(new_n52_), .O(new_n72_));
  inv1   g31(.a(x13), .O(new_n73_));
  nand2  g32(.a(new_n50_), .b(new_n73_), .O(new_n74_));
  ...
  nand3  g41(.a(new_n46_), .b(new_n44_), .c(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n49_), .c(new_n83_), .O(z14));
  inv1   g43(.a(x03), .O(new_n85_));
  nand4  g44(.a(new_n49_), .b(x10), .c(x08), .d(new_n85_), .O(new_n86_));
  ...
  nand4  g50(.a(new_n49_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n50_), .b(new_n62_), .O(new_n93_));
  ...
  nand4  g56(.a(new_n49_), .b(x10), .c(x08), .d(new_n56_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n72_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand4  g60(.a(new_n49_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x12), .O(new_n103_));
  aoi21  g62(.a(new_n98_), .b(new_n43_), .c(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand4  g64(.a(new_n49_), .b(x10), .c(x08), .d(new_n105_), .O(new_n106_));
  inv1   g65(.a(x20), .O(new_n107_));
  nand2  g66(.a(new_n50_), .b(new_n107_), .O(new_n108_));
