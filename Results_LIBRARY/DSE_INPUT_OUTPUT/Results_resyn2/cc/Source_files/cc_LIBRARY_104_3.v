...
module FAU ( 
  ...
  nor2   g08(.a(x16), .b(new_n49_), .O(z06));
  ...
  aoi21  g18(.a(new_n59_), .b(new_n56_), .c(new_n49_), .O(z03));
  ...
  nor2   g24(.a(new_n56_), .b(x15), .O(z08));
  ...
  nand2  g49(.a(new_n47_), .b(new_n64_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n49_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n88_), .c(new_n71_), .O(z16));
  ...
  nand2  g56(.a(new_n47_), .b(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(new_n49_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n94_), .c(new_n71_), .O(z17));
  nand2  g59(.a(z06), .b(x19), .O(new_n101_));
  inv1   g60(.a(x06), .O(new_n102_));
  nand3  g61(.a(x10), .b(x08), .c(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n47_), .b(new_n62_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n49_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n101_), .c(new_n71_), .O(z18));
  ...
  aoi21  g70(.a(new_n111_), .b(new_n107_), .c(new_n71_), .O(z19));
endmodule
