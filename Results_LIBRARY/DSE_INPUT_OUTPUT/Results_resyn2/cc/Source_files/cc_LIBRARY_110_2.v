...
module FAU ( 
  ...
  nor3   g38(.a(new_n51_), .b(new_n44_), .c(new_n55_), .O(z14));
  ...
  nand4  g43(.a(new_n52_), .b(x16), .c(new_n50_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z15));
  nand4  g45(.a(x12), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n81_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(new_n89_));
  nand2  g48(.a(new_n52_), .b(x12), .O(new_n90_));
  ...
  aoi21  g54(.a(new_n71_), .b(new_n95_), .c(x02), .O(new_n96_));
  ...
  nand2  g58(.a(new_n44_), .b(x06), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n51_), .O(new_n101_));
  aoi21  g60(.a(new_n71_), .b(new_n58_), .c(x02), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n99_), .c(new_n55_), .O(z18));
  nand4  g63(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n81_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n44_), .O(new_n107_));
  oai21  g66(.a(new_n90_), .b(new_n43_), .c(new_n107_), .O(z19));
  buf    g67(.a(x15), .O(z06));
endmodule
