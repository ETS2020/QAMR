...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n59_, new_n60_, new_n64_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  aoi21  g11(.a(new_n52_), .b(x19), .c(new_n48_), .O(z01));
  ...
  aoi21  g19(.a(new_n60_), .b(x19), .c(new_n48_), .O(z03));
  nand2  g20(.a(new_n45_), .b(x18), .O(z04));
  nand2  g21(.a(new_n44_), .b(new_n48_), .O(z05));
  ...
  nand3  g29(.a(new_n55_), .b(new_n45_), .c(x13), .O(new_n71_));
  ...
  oai21  g33(.a(new_n59_), .b(new_n44_), .c(x15), .O(new_n75_));
  nand2  g34(.a(new_n51_), .b(x01), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x14), .c(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n75_), .O(z13));
  nand2  g37(.a(new_n72_), .b(x02), .O(new_n79_));
  nand3  g38(.a(new_n50_), .b(x19), .c(x15), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n70_), .O(z14));
  nand3  g40(.a(new_n45_), .b(x16), .c(new_n49_), .O(new_n82_));
  oai21  g41(.a(new_n55_), .b(x03), .c(x12), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n55_), .c(new_n83_), .O(z15));
  nand3  g43(.a(x19), .b(x17), .c(x15), .O(new_n85_));
  inv1   g44(.a(x04), .O(new_n86_));
  nand3  g45(.a(x10), .b(x08), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n50_), .b(new_n64_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n48_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n85_), .c(new_n70_), .O(z16));
  ...
  nand4  g53(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n95_));
