...
module FAU ( 
  ...
  aoi21  g38(.a(new_n78_), .b(new_n51_), .c(new_n79_), .O(z14));
  inv1   g39(.a(x03), .O(new_n81_));
  nand4  g40(.a(new_n51_), .b(x10), .c(x08), .d(new_n81_), .O(new_n82_));
  ...
  nand2  g47(.a(new_n52_), .b(new_n63_), .O(new_n89_));
