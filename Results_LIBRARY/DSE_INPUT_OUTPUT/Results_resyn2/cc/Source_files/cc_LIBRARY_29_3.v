...
module FAU ( 
  ...
  nand3  g16(.a(new_n53_), .b(new_n47_), .c(x12), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(z04), .c(new_n48_), .O(z03));
  inv1   g18(.a(x19), .O(new_n60_));
  aoi21  g19(.a(x18), .b(x15), .c(new_n60_), .O(z05));
  ...
  nand3  g48(.a(new_n46_), .b(x16), .c(new_n47_), .O(new_n90_));
  nand4  g49(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n91_));
  ...
  nand2  g56(.a(new_n46_), .b(new_n62_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n48_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n95_), .c(new_n78_), .O(z16));
  ...
  nand2  g63(.a(new_n104_), .b(new_n44_), .O(z17));
  nand2  g64(.a(new_n49_), .b(x19), .O(new_n106_));
  inv1   g65(.a(x06), .O(new_n107_));
  nand3  g66(.a(x10), .b(x08), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n46_), .b(new_n60_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n108_), .c(new_n48_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n106_), .c(new_n78_), .O(z18));
  nand2  g70(.a(new_n49_), .b(x20), .O(new_n112_));
  inv1   g71(.a(x07), .O(new_n113_));
  nand3  g72(.a(x10), .b(x08), .c(new_n113_), .O(new_n114_));
  nand2  g73(.a(new_n46_), .b(new_n43_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n114_), .c(new_n48_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n112_), .c(new_n78_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
