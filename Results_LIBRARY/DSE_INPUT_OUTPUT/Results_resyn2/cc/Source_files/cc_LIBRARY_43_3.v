...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n51_, new_n53_, new_n54_, new_n58_, new_n60_, new_n63_,
  ...
  nor2   g26(.a(x15), .b(new_n46_), .O(new_n69_));
  ...
  aoi21  g34(.a(new_n76_), .b(new_n47_), .c(new_n46_), .O(z14));
  nand2  g35(.a(new_n47_), .b(x12), .O(new_n78_));
  nand2  g36(.a(new_n50_), .b(x03), .O(new_n79_));
  nand3  g37(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n80_));
  aoi21  g38(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(z15));
  nand2  g39(.a(new_n50_), .b(x04), .O(new_n82_));
  aoi21  g40(.a(new_n49_), .b(x17), .c(x15), .O(new_n83_));
  aoi21  g41(.a(new_n83_), .b(new_n82_), .c(new_n46_), .O(z16));
  inv1   g42(.a(x05), .O(new_n85_));
  nand3  g43(.a(x10), .b(x08), .c(new_n85_), .O(new_n86_));
  inv1   g44(.a(x18), .O(new_n87_));
  nand2  g45(.a(new_n49_), .b(new_n87_), .O(new_n88_));
  nand3  g46(.a(new_n88_), .b(new_n86_), .c(new_n69_), .O(new_n89_));
  inv1   g47(.a(new_n89_), .O(z17));
  nand2  g48(.a(new_n50_), .b(x06), .O(new_n91_));
  aoi21  g49(.a(new_n49_), .b(x19), .c(x15), .O(new_n92_));
  aoi21  g50(.a(new_n92_), .b(new_n91_), .c(new_n46_), .O(z18));
  inv1   g51(.a(x07), .O(new_n94_));
  nand3  g52(.a(x10), .b(x08), .c(new_n94_), .O(new_n95_));
  nand2  g53(.a(new_n49_), .b(new_n43_), .O(new_n96_));
  nand3  g54(.a(new_n96_), .b(new_n95_), .c(new_n69_), .O(new_n97_));
