...
module FAU ( 
  ...
  aoi21  g14(.a(new_n44_), .b(x06), .c(new_n55_), .O(new_n56_));
  ...
  inv1   g35(.a(new_n56_), .O(new_n77_));
  ...
  nand2  g40(.a(new_n56_), .b(new_n49_), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n53_), .c(new_n82_), .O(z14));
  inv1   g42(.a(x03), .O(new_n84_));
  nand4  g43(.a(new_n53_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  nand2  g44(.a(x16), .b(new_n48_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  ...
  aoi22  g60(.a(new_n101_), .b(new_n61_), .c(x19), .d(new_n55_), .O(z18));
