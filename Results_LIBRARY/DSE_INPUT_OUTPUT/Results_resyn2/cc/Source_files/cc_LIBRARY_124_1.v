...
module FAU ( 
  ...
  aoi21  g16(.a(x19), .b(new_n43_), .c(new_n54_), .O(new_n58_));
  ...
  nor2   g21(.a(new_n62_), .b(new_n43_), .O(z05));
  inv1   g22(.a(new_n44_), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n51_), .O(z06));
  inv1   g24(.a(x17), .O(new_n66_));
  nor2   g25(.a(new_n64_), .b(new_n66_), .O(z07));
  inv1   g26(.a(x16), .O(new_n68_));
  nand2  g27(.a(new_n44_), .b(new_n68_), .O(z08));
  nand2  g28(.a(x09), .b(x08), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n64_), .O(z09));
  and2   g30(.a(new_n70_), .b(new_n44_), .O(z10));
  nor2   g31(.a(new_n64_), .b(new_n46_), .O(z11));
  inv1   g32(.a(x00), .O(new_n74_));
  nand4  g33(.a(new_n51_), .b(x10), .c(x08), .d(new_n74_), .O(new_n75_));
  inv1   g34(.a(x13), .O(new_n76_));
  nand2  g35(.a(new_n52_), .b(new_n76_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n75_), .c(new_n58_), .O(new_n78_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n58_), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z16));
  aoi21  g57(.a(new_n52_), .b(new_n62_), .c(x05), .O(new_n99_));
  inv1   g58(.a(x18), .O(new_n100_));
  nand2  g59(.a(x10), .b(x08), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(x15), .c(new_n100_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x12), .O(new_n103_));
  nor2   g62(.a(new_n103_), .b(new_n99_), .O(z17));
  nand2  g63(.a(new_n52_), .b(new_n62_), .O(new_n105_));
  inv1   g64(.a(x06), .O(new_n106_));
  nand4  g65(.a(new_n51_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n105_), .c(new_n58_), .O(new_n108_));
  inv1   g67(.a(new_n108_), .O(z18));
  inv1   g68(.a(x07), .O(new_n110_));
  nand4  g69(.a(new_n51_), .b(x10), .c(x08), .d(new_n110_), .O(new_n111_));
  inv1   g70(.a(x20), .O(new_n112_));
  nand2  g71(.a(new_n52_), .b(new_n112_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n111_), .c(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n44_), .O(z19));
endmodule
