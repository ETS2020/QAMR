...
module FAU ( 
  ...
  oai21  g17(.a(new_n58_), .b(new_n49_), .c(new_n43_), .O(z03));
  ...
  aoi21  g28(.a(x19), .b(new_n42_), .c(new_n54_), .O(new_n70_));
  ...
  inv1   g33(.a(new_n70_), .O(new_n75_));
  ...
  nand2  g38(.a(new_n70_), .b(new_n49_), .O(new_n80_));
