...
module FAU ( 
  ...
  nand3  g12(.a(new_n45_), .b(x12), .c(new_n53_), .O(new_n54_));
  aoi21  g13(.a(new_n52_), .b(new_n47_), .c(new_n54_), .O(z02));
  inv1   g14(.a(x12), .O(new_n56_));
  oai21  g15(.a(new_n50_), .b(new_n56_), .c(new_n45_), .O(z03));
  nand2  g16(.a(new_n45_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(x17), .b(x15), .O(new_n60_));
  ...
  nor2   g25(.a(new_n60_), .b(new_n47_), .O(z11));
  nand2  g26(.a(x10), .b(x08), .O(new_n68_));
  nand2  g27(.a(x12), .b(x00), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(x17), .O(new_n70_));
  ...
  nor2   g32(.a(new_n60_), .b(x12), .O(new_n74_));
  inv1   g33(.a(x01), .O(new_n75_));
  oai21  g34(.a(new_n68_), .b(new_n75_), .c(x14), .O(new_n76_));
  nor2   g35(.a(new_n49_), .b(new_n60_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(z13));
  inv1   g37(.a(x02), .O(new_n79_));
  oai21  g38(.a(new_n68_), .b(new_n79_), .c(new_n43_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n48_), .c(x12), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z14));
  nand2  g41(.a(x12), .b(x03), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n68_), .c(x17), .O(new_n84_));
  ...
  nor2   g46(.a(new_n44_), .b(new_n56_), .O(new_n88_));
  oai21  g47(.a(new_n52_), .b(x04), .c(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z16));
  nand2  g49(.a(x12), .b(x05), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n68_), .c(x17), .O(new_n92_));
  ...
  oai21  g55(.a(new_n96_), .b(new_n68_), .c(x17), .O(new_n97_));
  ...
  oai21  g60(.a(new_n101_), .b(new_n68_), .c(x17), .O(new_n102_));
