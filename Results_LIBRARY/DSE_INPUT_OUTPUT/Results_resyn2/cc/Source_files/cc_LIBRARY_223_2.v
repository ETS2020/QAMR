...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(x20), .c(new_n42_), .O(z01));
  ...
  nor2   g17(.a(new_n58_), .b(new_n42_), .O(z06));
  ...
  nor2   g44(.a(new_n43_), .b(x12), .O(new_n86_));
  nand2  g45(.a(new_n52_), .b(x02), .O(new_n87_));
  oai21  g46(.a(new_n48_), .b(new_n58_), .c(x15), .O(new_n88_));
  ...
  nand2  g56(.a(z06), .b(x17), .O(new_n98_));
  inv1   g57(.a(x04), .O(new_n99_));
  nand3  g58(.a(x10), .b(x08), .c(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n48_), .b(new_n65_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(new_n42_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n98_), .c(new_n53_), .O(z16));
  ...
  nand4  g66(.a(new_n42_), .b(x10), .c(x08), .d(x05), .O(new_n108_));
  ...
  nand2  g70(.a(z06), .b(x19), .O(new_n112_));
  inv1   g71(.a(x06), .O(new_n113_));
  nand3  g72(.a(x10), .b(x08), .c(new_n113_), .O(new_n114_));
  nand2  g73(.a(new_n48_), .b(new_n63_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n114_), .c(new_n42_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n112_), .c(new_n53_), .O(z18));
  nand2  g76(.a(new_n49_), .b(x07), .O(new_n118_));
  aoi21  g77(.a(new_n48_), .b(x20), .c(x15), .O(new_n119_));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n86_), .O(z19));
endmodule
