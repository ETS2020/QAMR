...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n54_, new_n55_, new_n57_, new_n61_, new_n62_,
  ...
  aoi21  g12(.a(new_n44_), .b(x06), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n51_), .O(new_n80_));
  ...
  nor2   g43(.a(new_n79_), .b(x15), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n51_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n52_), .b(new_n61_), .O(new_n90_));
  ...
  aoi21  g59(.a(new_n85_), .b(new_n99_), .c(new_n100_), .O(z18));
