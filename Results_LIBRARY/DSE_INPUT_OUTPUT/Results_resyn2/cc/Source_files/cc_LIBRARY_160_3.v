...
module FAU ( 
  ...
  nand2  g12(.a(new_n50_), .b(new_n46_), .O(new_n54_));
  ...
  aoi21  g16(.a(new_n57_), .b(new_n47_), .c(new_n46_), .O(z03));
  aoi21  g17(.a(x16), .b(x15), .c(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nand2  g19(.a(new_n44_), .b(new_n60_), .O(z05));
  nor2   g20(.a(x16), .b(new_n46_), .O(z06));
  ...
  nand2  g37(.a(new_n78_), .b(z06), .O(new_n79_));
  ...
  oai21  g51(.a(new_n63_), .b(new_n77_), .c(new_n47_), .O(new_n93_));
  ...
  nand2  g58(.a(z06), .b(x18), .O(new_n100_));
  inv1   g59(.a(x05), .O(new_n101_));
  nand3  g60(.a(x10), .b(x08), .c(new_n101_), .O(new_n102_));
  inv1   g61(.a(x18), .O(new_n103_));
  nand2  g62(.a(new_n49_), .b(new_n103_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n102_), .c(new_n46_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n100_), .c(new_n77_), .O(z17));
  nand2  g65(.a(z06), .b(x19), .O(new_n107_));
  inv1   g66(.a(x06), .O(new_n108_));
  nand3  g67(.a(x10), .b(x08), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n49_), .b(new_n60_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(new_n46_), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n107_), .c(new_n77_), .O(z18));
  nand2  g71(.a(z06), .b(x20), .O(new_n113_));
  inv1   g72(.a(x07), .O(new_n114_));
  nand3  g73(.a(x10), .b(x08), .c(new_n114_), .O(new_n115_));
  nand2  g74(.a(new_n49_), .b(new_n43_), .O(new_n116_));
  nand3  g75(.a(new_n116_), .b(new_n115_), .c(new_n46_), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n113_), .c(new_n77_), .O(z19));
  buf    g77(.a(x16), .O(z08));
endmodule
