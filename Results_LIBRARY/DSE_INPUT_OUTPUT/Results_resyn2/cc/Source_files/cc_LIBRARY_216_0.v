...
module FAU ( 
  ...
  nand2  g06(.a(new_n47_), .b(z04), .O(new_n48_));
  ...
  nand2  g18(.a(new_n47_), .b(x18), .O(z05));
  inv1   g19(.a(x15), .O(new_n61_));
  nand2  g20(.a(new_n48_), .b(new_n61_), .O(z06));
  ...
  nand4  g32(.a(new_n73_), .b(new_n71_), .c(new_n48_), .d(x12), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z12));
  nand2  g34(.a(new_n48_), .b(x12), .O(new_n76_));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n54_), .b(new_n77_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n50_), .c(new_n76_), .O(z13));
  nand3  g38(.a(x10), .b(x08), .c(x02), .O(new_n80_));
  nand3  g39(.a(new_n50_), .b(new_n48_), .c(x12), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n61_), .c(new_n81_), .O(z14));
  nand3  g41(.a(new_n61_), .b(x10), .c(x08), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x16), .c(new_n49_), .O(new_n84_));
  nand4  g43(.a(new_n61_), .b(x10), .c(x08), .d(x03), .O(new_n85_));
  ...
  oai21  g47(.a(new_n54_), .b(x15), .c(new_n63_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n48_), .O(z16));
  nand4  g50(.a(x19), .b(new_n61_), .c(x10), .d(x08), .O(new_n92_));
