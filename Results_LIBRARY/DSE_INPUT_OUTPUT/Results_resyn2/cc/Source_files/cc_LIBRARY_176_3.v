...
module FAU ( 
  ...
  nand2  g01(.a(x18), .b(x07), .O(new_n43_));
  ...
  aoi21  g11(.a(x18), .b(x07), .c(new_n52_), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  aoi21  g13(.a(new_n50_), .b(new_n45_), .c(new_n54_), .O(z02));
  ...
  oai21  g40(.a(new_n78_), .b(new_n81_), .c(new_n49_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n47_), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n43_), .O(z14));
  nand3  g43(.a(new_n50_), .b(x16), .c(new_n45_), .O(new_n85_));
  ...
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n53_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n49_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n50_), .b(new_n59_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n43_), .O(z18));
  nand4  g61(.a(new_n49_), .b(x12), .c(x10), .d(x08), .O(new_n103_));
