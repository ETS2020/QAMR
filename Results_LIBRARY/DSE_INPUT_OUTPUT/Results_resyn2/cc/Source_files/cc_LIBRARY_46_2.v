...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n54_, new_n56_, new_n59_, new_n61_, new_n63_, new_n67_,
  ...
  aoi21  g11(.a(new_n46_), .b(x15), .c(new_n49_), .O(z03));
  ...
  aoi21  g18(.a(new_n42_), .b(x12), .c(new_n59_), .O(z07));
  ...
  aoi21  g26(.a(x15), .b(new_n67_), .c(new_n49_), .O(z12));
  ...
  nand4  g31(.a(x16), .b(x15), .c(new_n45_), .d(x12), .O(new_n73_));
  ...
  aoi21  g39(.a(new_n80_), .b(x15), .c(new_n49_), .O(z19));
endmodule
