...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(x12), .c(x10), .d(x08), .O(new_n58_));
  nor3   g17(.a(new_n58_), .b(new_n43_), .c(new_n51_), .O(z03));
  nand2  g18(.a(x18), .b(x05), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n43_), .b(new_n61_), .O(z05));
  nor2   g21(.a(new_n43_), .b(new_n51_), .O(z06));
  ...
  nand2  g28(.a(new_n47_), .b(new_n50_), .O(z11));
  ...
  nand2  g34(.a(new_n75_), .b(new_n47_), .O(z12));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x14), .O(new_n78_));
  aoi21  g37(.a(x18), .b(new_n46_), .c(new_n54_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  aoi21  g39(.a(new_n78_), .b(new_n48_), .c(new_n80_), .O(z13));
  nand3  g40(.a(x10), .b(x08), .c(x02), .O(new_n82_));
  nand2  g41(.a(new_n79_), .b(new_n48_), .O(new_n83_));
  ...
  nand3  g65(.a(new_n106_), .b(new_n104_), .c(new_n79_), .O(new_n107_));
