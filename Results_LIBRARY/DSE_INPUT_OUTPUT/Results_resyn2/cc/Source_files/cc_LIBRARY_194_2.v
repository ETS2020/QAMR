...
module FAU ( 
  ...
  nand2  g07(.a(z04), .b(x05), .O(new_n49_));
  ...
  nand3  g13(.a(new_n49_), .b(x12), .c(new_n42_), .O(new_n55_));
  aoi21  g14(.a(new_n54_), .b(new_n47_), .c(new_n55_), .O(z02));
  inv1   g15(.a(new_n51_), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n49_), .c(new_n47_), .d(x12), .O(new_n58_));
  ...
  nand3  g40(.a(new_n51_), .b(new_n49_), .c(x12), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n53_), .c(new_n82_), .O(z14));
  nand2  g42(.a(new_n49_), .b(x12), .O(new_n84_));
  nand3  g43(.a(new_n54_), .b(x16), .c(new_n47_), .O(new_n85_));
  ...
  nand2  g64(.a(new_n105_), .b(new_n49_), .O(z19));
endmodule
