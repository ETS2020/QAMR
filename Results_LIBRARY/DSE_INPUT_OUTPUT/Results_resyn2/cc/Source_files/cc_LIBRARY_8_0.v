...
module FAU ( 
  ...
  aoi21  g45(.a(new_n69_), .b(x04), .c(new_n49_), .O(new_n87_));
  nand3  g46(.a(new_n72_), .b(x17), .c(x12), .O(new_n88_));
  oai21  g47(.a(new_n87_), .b(x15), .c(new_n88_), .O(z16));
  aoi21  g48(.a(new_n69_), .b(x05), .c(new_n49_), .O(new_n90_));
  nand3  g49(.a(new_n72_), .b(x18), .c(x12), .O(new_n91_));
  oai21  g50(.a(new_n90_), .b(x15), .c(new_n91_), .O(z17));
  inv1   g51(.a(x06), .O(new_n93_));
  nand3  g52(.a(new_n69_), .b(new_n68_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n72_), .b(new_n58_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z18));
  aoi21  g56(.a(new_n69_), .b(x07), .c(new_n49_), .O(new_n98_));
  nand3  g57(.a(new_n72_), .b(x20), .c(x12), .O(new_n99_));
