...
module FAU ( 
  ...
  nand2  g42(.a(new_n71_), .b(x02), .O(new_n84_));
  xor2a  g43(.a(x15), .b(x12), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z14));
  aoi21  g45(.a(new_n71_), .b(x03), .c(new_n49_), .O(new_n87_));
  nand4  g46(.a(new_n74_), .b(x16), .c(new_n50_), .d(x12), .O(new_n88_));
  oai21  g47(.a(new_n87_), .b(x15), .c(new_n88_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand3  g49(.a(new_n71_), .b(new_n60_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g54(.a(new_n71_), .b(new_n60_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n71_), .b(new_n60_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n74_), .b(new_n58_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand3  g65(.a(new_n71_), .b(new_n60_), .c(new_n106_), .O(new_n107_));
  nand2  g66(.a(new_n74_), .b(new_n43_), .O(new_n108_));
