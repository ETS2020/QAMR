...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(new_n49_), .c(new_n68_), .O(new_n70_));
  ...
  aoi21  g36(.a(x19), .b(x06), .c(new_n52_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  aoi21  g38(.a(new_n77_), .b(new_n47_), .c(new_n79_), .O(z13));
  aoi21  g39(.a(new_n69_), .b(x02), .c(x15), .O(new_n81_));
  nand2  g40(.a(new_n78_), .b(new_n47_), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n81_), .O(z14));
  inv1   g42(.a(x03), .O(new_n84_));
  nand3  g43(.a(new_n69_), .b(new_n49_), .c(new_n84_), .O(new_n85_));
  nand2  g44(.a(x16), .b(new_n45_), .O(new_n86_));
  ...
  nand3  g49(.a(new_n69_), .b(new_n49_), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n50_), .b(new_n63_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n43_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand3  g54(.a(new_n69_), .b(new_n49_), .c(new_n95_), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  nand2  g56(.a(new_n50_), .b(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n43_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand3  g60(.a(new_n69_), .b(new_n49_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n50_), .b(new_n60_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n78_), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand3  g65(.a(new_n69_), .b(new_n49_), .c(new_n106_), .O(new_n107_));
  inv1   g66(.a(x20), .O(new_n108_));
  nand2  g67(.a(new_n50_), .b(new_n108_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n107_), .c(x12), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n43_), .O(z19));
endmodule
