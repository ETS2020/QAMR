...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n56_, new_n59_, new_n61_, new_n64_, new_n67_,
  ...
  nor2   g16(.a(new_n56_), .b(x18), .O(z05));
  ...
  aoi21  g23(.a(x19), .b(x18), .c(new_n64_), .O(z09));
  ...
  nand3  g36(.a(new_n48_), .b(new_n44_), .c(x12), .O(new_n78_));
  aoi21  g37(.a(new_n77_), .b(new_n59_), .c(new_n78_), .O(z14));
  nand3  g38(.a(new_n59_), .b(x10), .c(x08), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x16), .c(new_n46_), .O(new_n81_));
  nand4  g40(.a(new_n59_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n75_), .O(z15));
  inv1   g42(.a(x12), .O(new_n84_));
  aoi21  g43(.a(x19), .b(x18), .c(new_n84_), .O(new_n85_));
  inv1   g44(.a(x04), .O(new_n86_));
  nand4  g45(.a(new_n59_), .b(x10), .c(x08), .d(new_n86_), .O(new_n87_));
  oai21  g46(.a(new_n50_), .b(x15), .c(new_n61_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z16));
  inv1   g49(.a(x05), .O(new_n91_));
  nand4  g50(.a(new_n59_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  inv1   g51(.a(x18), .O(new_n93_));
  oai21  g52(.a(new_n50_), .b(x15), .c(new_n93_), .O(new_n94_));
  ...
  oai21  g57(.a(new_n50_), .b(x15), .c(new_n56_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(new_n85_), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z18));
  inv1   g60(.a(x07), .O(new_n102_));
  nand4  g61(.a(new_n59_), .b(x10), .c(x08), .d(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n50_), .b(x15), .c(new_n43_), .O(new_n104_));
  nand3  g63(.a(new_n104_), .b(new_n103_), .c(new_n85_), .O(new_n105_));
