...
module FAU ( 
  ...
  and2   g23(.a(x16), .b(x09), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(z10));
  inv1   g25(.a(z10), .O(z09));
  inv1   g26(.a(x00), .O(new_n68_));
  nand4  g27(.a(new_n61_), .b(x10), .c(x08), .d(new_n68_), .O(new_n69_));
  inv1   g28(.a(x13), .O(new_n70_));
  oai21  g29(.a(new_n51_), .b(x15), .c(new_n70_), .O(new_n71_));
  ...
  nand3  g37(.a(new_n49_), .b(new_n45_), .c(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n61_), .c(new_n79_), .O(z14));
  inv1   g39(.a(x12), .O(new_n81_));
  nand3  g40(.a(new_n61_), .b(x10), .c(x08), .O(new_n82_));
  nand3  g41(.a(z08), .b(new_n82_), .c(new_n47_), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x03), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n45_), .c(new_n61_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n81_), .O(z15));
  aoi21  g46(.a(x16), .b(new_n44_), .c(new_n81_), .O(new_n88_));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n61_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  ...
  nand4  g53(.a(new_n61_), .b(x10), .c(x08), .d(new_n94_), .O(new_n95_));
  ...
  oai21  g60(.a(new_n51_), .b(x15), .c(new_n59_), .O(new_n102_));
