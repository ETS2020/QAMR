...
module FAU ( 
  ...
  nand2  g17(.a(new_n58_), .b(x18), .O(z05));
  ...
  nor2   g43(.a(new_n43_), .b(x12), .O(new_n85_));
  nand3  g44(.a(new_n73_), .b(x16), .c(new_n46_), .O(new_n86_));
  aoi21  g45(.a(new_n51_), .b(x03), .c(new_n43_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand2  g48(.a(new_n51_), .b(new_n89_), .O(new_n90_));
  ...
  nand2  g54(.a(new_n73_), .b(z04), .O(new_n96_));
  ...
  nand2  g59(.a(new_n73_), .b(new_n58_), .O(new_n101_));
  ...
  nand3  g66(.a(new_n107_), .b(new_n105_), .c(new_n71_), .O(new_n108_));
