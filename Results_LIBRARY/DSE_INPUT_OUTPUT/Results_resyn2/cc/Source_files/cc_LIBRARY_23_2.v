...
module FAU ( 
  ...
  nand3  g23(.a(x16), .b(x09), .c(x08), .O(z10));
  inv1   g24(.a(z10), .O(z09));
  inv1   g25(.a(x00), .O(new_n67_));
  nand4  g26(.a(new_n61_), .b(x10), .c(x08), .d(new_n67_), .O(new_n68_));
  ...
  nand2  g30(.a(new_n71_), .b(new_n45_), .O(z12));
  inv1   g31(.a(x01), .O(new_n73_));
  oai21  g32(.a(new_n51_), .b(new_n73_), .c(x14), .O(new_n74_));
  nand2  g33(.a(new_n45_), .b(x12), .O(new_n75_));
  aoi21  g34(.a(new_n74_), .b(new_n49_), .c(new_n75_), .O(z13));
  nand3  g35(.a(x10), .b(x08), .c(x02), .O(new_n77_));
  nand3  g36(.a(new_n49_), .b(new_n45_), .c(x12), .O(new_n78_));
  aoi21  g37(.a(new_n77_), .b(new_n61_), .c(new_n78_), .O(z14));
  inv1   g38(.a(x12), .O(new_n80_));
  nand3  g39(.a(new_n61_), .b(x10), .c(x08), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x16), .c(new_n47_), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x03), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n45_), .c(new_n61_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n80_), .O(z15));
  aoi21  g45(.a(new_n44_), .b(x09), .c(new_n80_), .O(new_n87_));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n61_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n51_), .b(x15), .c(new_n63_), .O(new_n90_));
