...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n50_, new_n51_,
    new_n55_, new_n57_, new_n60_, new_n64_, new_n65_, new_n66_, new_n68_,
  ...
  nor2   g34(.a(x15), .b(new_n64_), .O(new_n76_));
  inv1   g35(.a(x04), .O(new_n77_));
  nand3  g36(.a(x10), .b(x08), .c(new_n77_), .O(new_n78_));
  nand2  g37(.a(new_n47_), .b(new_n57_), .O(new_n79_));
  ...
  nand2  g43(.a(new_n47_), .b(new_n84_), .O(new_n85_));
  ...
  nand2  g48(.a(new_n47_), .b(new_n55_), .O(new_n90_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(new_n76_), .O(new_n97_));
