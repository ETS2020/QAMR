...
module FAU ( 
  ...
  nor2   g02(.a(x10), .b(x08), .O(new_n44_));
  ...
  nor2   g14(.a(new_n47_), .b(new_n55_), .O(z03));
  nor2   g15(.a(new_n44_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nor2   g17(.a(new_n44_), .b(new_n58_), .O(z05));
  nor2   g18(.a(new_n44_), .b(new_n50_), .O(z06));
  ...
  nand3  g28(.a(new_n50_), .b(x08), .c(x00), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x10), .O(new_n72_));
  nand2  g31(.a(new_n50_), .b(x10), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x13), .c(x08), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n55_), .O(z12));
  nand2  g34(.a(new_n50_), .b(x08), .O(new_n76_));
  nand2  g35(.a(new_n46_), .b(new_n68_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n76_), .c(x10), .O(new_n78_));
  nand2  g37(.a(x10), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x14), .c(x08), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n55_), .O(z13));
  oai21  g40(.a(new_n50_), .b(new_n55_), .c(x10), .O(new_n82_));
  ...
  oai21  g45(.a(new_n51_), .b(new_n84_), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n83_), .O(z14));
  nand3  g48(.a(new_n50_), .b(x08), .c(x03), .O(new_n90_));
  nand3  g49(.a(x16), .b(new_n46_), .c(new_n68_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x10), .O(new_n93_));
  nand4  g52(.a(new_n73_), .b(x16), .c(new_n46_), .d(x08), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n55_), .O(z15));
  oai21  g54(.a(new_n61_), .b(new_n55_), .c(x10), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n68_), .O(new_n97_));
  oai21  g56(.a(x15), .b(new_n85_), .c(x17), .O(new_n98_));
  nand4  g57(.a(new_n50_), .b(x10), .c(x08), .d(x04), .O(new_n99_));
  ...
  nand2  g63(.a(new_n104_), .b(new_n68_), .O(new_n105_));
  oai21  g64(.a(x15), .b(new_n85_), .c(x18), .O(new_n106_));
  nand4  g65(.a(new_n50_), .b(x10), .c(x08), .d(x05), .O(new_n107_));
  ...
  oai21  g69(.a(new_n58_), .b(new_n55_), .c(x10), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n68_), .O(new_n112_));
  oai21  g71(.a(x15), .b(new_n85_), .c(x19), .O(new_n113_));
  nand4  g72(.a(new_n50_), .b(x10), .c(x08), .d(x06), .O(new_n114_));
  ...
  oai21  g76(.a(new_n43_), .b(new_n55_), .c(x10), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(new_n68_), .O(new_n119_));
