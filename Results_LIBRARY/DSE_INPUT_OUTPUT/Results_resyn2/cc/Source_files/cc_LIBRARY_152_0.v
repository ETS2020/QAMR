...
module FAU ( 
  ...
  nand2  g15(.a(new_n45_), .b(x12), .O(new_n57_));
  oai21  g16(.a(new_n57_), .b(new_n48_), .c(new_n46_), .O(z03));
  nand2  g17(.a(new_n46_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x06), .O(z05));
  nor2   g20(.a(new_n42_), .b(new_n50_), .O(z06));
  ...
  nor2   g29(.a(new_n42_), .b(new_n53_), .O(new_n71_));
  ...
  nand3  g39(.a(new_n48_), .b(new_n46_), .c(x12), .O(new_n81_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n46_), .O(z15));
  ...
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n71_), .O(new_n92_));
  ...
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n71_), .O(new_n98_));
