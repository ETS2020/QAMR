...
module FAU ( 
  ...
  inv1   g13(.a(z01), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(new_n51_), .O(z03));
  ...
  nor2   g27(.a(z04), .b(new_n42_), .O(z11));
  ...
  nand4  g32(.a(new_n60_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  aoi21  g33(.a(z04), .b(x14), .c(new_n51_), .O(new_n75_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n55_), .c(new_n51_), .O(z13));
  ...
  nand2  g61(.a(new_n71_), .b(new_n58_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n48_), .O(z18));
  ...
  nand2  g69(.a(new_n110_), .b(new_n48_), .O(z19));
endmodule
