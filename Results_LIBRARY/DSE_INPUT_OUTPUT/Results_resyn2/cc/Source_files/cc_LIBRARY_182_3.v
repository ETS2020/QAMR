...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    new_n52_, new_n53_, new_n54_, new_n56_, new_n58_, new_n60_, new_n64_,
  ...
  aoi21  g11(.a(x18), .b(x04), .c(new_n52_), .O(new_n53_));
  ...
  aoi21  g20(.a(x18), .b(x04), .c(new_n50_), .O(z06));
  ...
  nand3  g29(.a(new_n70_), .b(new_n50_), .c(new_n69_), .O(new_n71_));
  ...
  aoi21  g39(.a(new_n70_), .b(x02), .c(x15), .O(new_n81_));
  nand2  g40(.a(new_n53_), .b(new_n48_), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n81_), .O(z14));
  inv1   g42(.a(x03), .O(new_n84_));
  nand3  g43(.a(new_n70_), .b(new_n50_), .c(new_n84_), .O(new_n85_));
  ...
  nand4  g49(.a(new_n50_), .b(x12), .c(x10), .d(x08), .O(new_n91_));
  ...
  nand3  g55(.a(new_n70_), .b(new_n50_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n51_), .b(new_n90_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n53_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand3  g60(.a(new_n70_), .b(new_n50_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g65(.a(new_n70_), .b(new_n50_), .c(new_n106_), .O(new_n107_));
