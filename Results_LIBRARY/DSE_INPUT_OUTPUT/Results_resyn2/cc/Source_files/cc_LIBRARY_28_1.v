...
module FAU ( 
  ...
  nor2   g16(.a(new_n50_), .b(new_n54_), .O(z03));
  nand2  g17(.a(new_n45_), .b(x18), .O(z04));
  nor2   g18(.a(new_n43_), .b(new_n54_), .O(z05));
  ...
  oai21  g42(.a(new_n52_), .b(new_n83_), .c(new_n61_), .O(new_n84_));
  ...
  nand2  g46(.a(new_n53_), .b(x03), .O(new_n88_));
  ...
  nand2  g50(.a(new_n74_), .b(new_n63_), .O(new_n92_));
  ...
  nand4  g60(.a(new_n61_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n74_), .b(new_n43_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand4  g65(.a(new_n61_), .b(x10), .c(x08), .d(new_n106_), .O(new_n107_));
