...
module FAU ( 
  ...
  nor2   g19(.a(new_n44_), .b(new_n47_), .O(z05));
  ...
  nand2  g28(.a(new_n48_), .b(new_n49_), .O(z11));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n50_), .c(new_n58_), .O(z13));
  ...
  nand3  g41(.a(new_n62_), .b(x10), .c(x08), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x16), .c(new_n49_), .O(new_n84_));
  nand4  g43(.a(new_n62_), .b(x10), .c(x08), .d(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(z15));
  inv1   g45(.a(x12), .O(new_n87_));
  aoi21  g46(.a(x19), .b(new_n47_), .c(new_n87_), .O(new_n88_));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n62_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n54_), .b(x15), .c(new_n64_), .O(new_n91_));
