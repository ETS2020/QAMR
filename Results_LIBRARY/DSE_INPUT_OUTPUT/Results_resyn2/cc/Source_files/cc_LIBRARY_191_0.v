...
module FAU ( 
  ...
  nor2   g01(.a(x18), .b(x00), .O(new_n43_));
  ...
  nand3  g30(.a(new_n63_), .b(x10), .c(x08), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(x18), .c(x00), .O(new_n73_));
  inv1   g32(.a(x13), .O(new_n74_));
  oai21  g33(.a(new_n50_), .b(x15), .c(new_n74_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x12), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n73_), .O(z12));
  ...
  aoi21  g61(.a(new_n99_), .b(new_n98_), .c(new_n102_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand4  g63(.a(new_n63_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n72_), .b(new_n61_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n44_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  nand4  g68(.a(new_n63_), .b(x10), .c(x08), .d(new_n109_), .O(new_n110_));
  inv1   g69(.a(x20), .O(new_n111_));
  nand2  g70(.a(new_n72_), .b(new_n111_), .O(new_n112_));
