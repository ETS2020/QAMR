...
module FAU ( 
  ...
  nand2  g15(.a(new_n43_), .b(x12), .O(new_n57_));
  ...
  nand2  g21(.a(new_n43_), .b(new_n50_), .O(z06));
  ...
  nand2  g29(.a(new_n43_), .b(new_n45_), .O(z11));
  ...
  nand2  g35(.a(new_n76_), .b(new_n43_), .O(z12));
  ...
  nand2  g59(.a(new_n51_), .b(x12), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n59_), .c(new_n100_), .d(new_n99_), .O(z17));
  ...
  nand3  g70(.a(new_n111_), .b(new_n109_), .c(new_n93_), .O(new_n112_));
