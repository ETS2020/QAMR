...
module FAU ( 
  ...
  oai21  g42(.a(new_n52_), .b(new_n83_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  nand3  g44(.a(new_n71_), .b(x10), .c(x08), .O(new_n86_));
  ...
  nand3  g55(.a(new_n86_), .b(x18), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(z17));
  inv1   g57(.a(x06), .O(new_n99_));
  nand4  g58(.a(new_n71_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
  ...
  nand4  g63(.a(new_n71_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
