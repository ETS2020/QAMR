...
module FAU ( 
  ...
  oai21  g29(.a(new_n70_), .b(new_n48_), .c(x17), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n59_), .O(new_n72_));
  and2   g31(.a(x10), .b(x08), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x12), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n69_), .c(new_n72_), .O(z12));
  ...
  oai21  g44(.a(new_n85_), .b(new_n48_), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n59_), .O(new_n87_));
  nand2  g46(.a(x16), .b(new_n67_), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n75_), .c(new_n87_), .O(z15));
  nor2   g48(.a(new_n61_), .b(new_n50_), .O(new_n90_));
  oai21  g49(.a(new_n74_), .b(x04), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(z16));
  inv1   g51(.a(x18), .O(new_n93_));
  nand2  g52(.a(x12), .b(x05), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n48_), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n59_), .O(new_n96_));
  oai21  g55(.a(new_n75_), .b(new_n93_), .c(new_n96_), .O(z17));
  nand2  g56(.a(x12), .b(x06), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n48_), .c(x17), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n59_), .O(new_n100_));
  oai21  g59(.a(new_n75_), .b(new_n57_), .c(new_n100_), .O(z18));
  nand2  g60(.a(x20), .b(x15), .O(new_n102_));
  nand2  g61(.a(new_n59_), .b(x07), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n73_), .O(new_n104_));
  inv1   g63(.a(x20), .O(new_n105_));
  aoi21  g64(.a(new_n48_), .b(new_n105_), .c(new_n61_), .O(new_n106_));
