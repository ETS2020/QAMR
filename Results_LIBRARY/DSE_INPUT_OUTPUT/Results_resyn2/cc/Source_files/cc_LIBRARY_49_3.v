...
module FAU ( 
  ...
  nand2  g03(.a(x20), .b(x19), .O(new_n45_));
  ...
  nor2   g29(.a(new_n62_), .b(new_n46_), .O(z11));
  inv1   g30(.a(x00), .O(new_n72_));
  and2   g31(.a(x10), .b(x08), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n51_), .c(new_n72_), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nand2  g34(.a(new_n52_), .b(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n74_), .c(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n45_), .O(z12));
  ...
  aoi21  g42(.a(new_n73_), .b(x02), .c(x15), .O(new_n84_));
  nand2  g43(.a(new_n55_), .b(new_n47_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z14));
  nand3  g45(.a(new_n52_), .b(x16), .c(new_n46_), .O(new_n87_));
  nand3  g46(.a(new_n73_), .b(new_n51_), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n58_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand3  g49(.a(new_n73_), .b(new_n51_), .c(new_n90_), .O(new_n91_));
  nand2  g50(.a(new_n52_), .b(new_n64_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n55_), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand3  g54(.a(new_n73_), .b(new_n51_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n73_), .b(new_n51_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n52_), .b(new_n42_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n45_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand3  g65(.a(new_n73_), .b(new_n51_), .c(new_n106_), .O(new_n107_));
  inv1   g66(.a(x20), .O(new_n108_));
  nand2  g67(.a(new_n52_), .b(new_n108_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(new_n107_), .c(new_n55_), .O(new_n110_));
