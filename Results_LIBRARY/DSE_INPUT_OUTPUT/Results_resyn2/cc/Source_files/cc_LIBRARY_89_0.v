...
module FAU ( 
  ...
  nor3   g14(.a(new_n45_), .b(x14), .c(new_n49_), .O(z03));
  ...
  nor2   g26(.a(new_n42_), .b(new_n50_), .O(z11));
  ...
  inv1   g40(.a(new_n45_), .O(new_n82_));
  ...
  nand3  g45(.a(new_n73_), .b(x16), .c(new_n50_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n49_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand3  g48(.a(new_n70_), .b(new_n60_), .c(new_n89_), .O(new_n90_));
  nand2  g49(.a(new_n73_), .b(new_n62_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  aoi21  g52(.a(new_n70_), .b(x05), .c(new_n49_), .O(new_n94_));
  nand3  g53(.a(new_n73_), .b(x18), .c(x12), .O(new_n95_));
  oai21  g54(.a(new_n94_), .b(x15), .c(new_n95_), .O(z17));
  inv1   g55(.a(x06), .O(new_n97_));
  nand3  g56(.a(new_n70_), .b(new_n60_), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n73_), .b(new_n58_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z18));
  aoi21  g60(.a(new_n70_), .b(x07), .c(new_n49_), .O(new_n102_));
  nand3  g61(.a(new_n73_), .b(x20), .c(x12), .O(new_n103_));
