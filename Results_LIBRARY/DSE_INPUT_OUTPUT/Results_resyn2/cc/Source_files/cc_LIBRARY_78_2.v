...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n54_, new_n56_, new_n59_, new_n61_, new_n64_,
  ...
  nor2   g06(.a(new_n44_), .b(new_n47_), .O(z06));
  ...
  nand3  g14(.a(new_n50_), .b(z06), .c(x12), .O(new_n56_));
  ...
  nand2  g28(.a(new_n69_), .b(x18), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x15), .O(new_n71_));
  nand2  g30(.a(new_n49_), .b(x13), .O(new_n72_));
  ...
  oai21  g36(.a(new_n49_), .b(new_n77_), .c(x18), .O(new_n78_));
  ...
  nand2  g41(.a(new_n49_), .b(z06), .O(new_n83_));
  nor2   g42(.a(new_n49_), .b(x15), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n77_), .O(z14));
  nand2  g45(.a(new_n84_), .b(x03), .O(new_n87_));
  nand4  g46(.a(new_n53_), .b(new_n45_), .c(x16), .d(new_n67_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n77_), .O(z15));
  oai21  g48(.a(new_n61_), .b(new_n77_), .c(x18), .O(new_n90_));
  ...
  nand2  g57(.a(new_n53_), .b(new_n44_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z17));
  oai21  g60(.a(new_n59_), .b(new_n77_), .c(x18), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n49_), .b(x19), .O(new_n104_));
  ...
  oai21  g67(.a(new_n43_), .b(new_n77_), .c(x18), .O(new_n109_));
