...
module FAU ( 
  ...
  nand2  g05(.a(new_n42_), .b(new_n46_), .O(z11));
  ...
  nor2   g28(.a(new_n69_), .b(new_n43_), .O(z09));
  ...
  nand2  g35(.a(new_n76_), .b(new_n50_), .O(z12));
  ...
  nand2  g40(.a(new_n81_), .b(new_n50_), .O(z13));
  ...
  nand2  g50(.a(new_n91_), .b(new_n50_), .O(z15));
  inv1   g51(.a(x04), .O(new_n93_));
  nand4  g52(.a(new_n51_), .b(x10), .c(x08), .d(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n52_), .b(new_n65_), .O(new_n95_));
  aoi21  g54(.a(x18), .b(new_n46_), .c(new_n54_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z16));
  inv1   g57(.a(x05), .O(new_n99_));
  nand4  g58(.a(new_n51_), .b(x10), .c(x08), .d(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n52_), .b(new_n42_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n50_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand4  g63(.a(new_n51_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n52_), .b(new_n62_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n50_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  nand4  g68(.a(new_n51_), .b(x10), .c(x08), .d(new_n109_), .O(new_n110_));
  inv1   g69(.a(x20), .O(new_n111_));
  nand2  g70(.a(new_n52_), .b(new_n111_), .O(new_n112_));
  nand3  g71(.a(new_n112_), .b(new_n110_), .c(new_n96_), .O(new_n113_));
