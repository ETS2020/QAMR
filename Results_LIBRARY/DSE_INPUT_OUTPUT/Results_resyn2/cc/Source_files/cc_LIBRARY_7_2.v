...
module FAU ( 
  ...
  nand2  g21(.a(new_n56_), .b(new_n62_), .O(z08));
  nand2  g22(.a(x09), .b(x08), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n43_), .O(z09));
  and2   g24(.a(new_n64_), .b(new_n56_), .O(z10));
  ...
  nor2   g29(.a(new_n55_), .b(x14), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n42_), .O(z13));
  nand2  g31(.a(x15), .b(x12), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n47_), .O(z14));
  nand2  g33(.a(x16), .b(new_n46_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x15), .c(new_n42_), .O(z15));
  aoi21  g35(.a(new_n60_), .b(x15), .c(new_n42_), .O(z16));
  inv1   g36(.a(x18), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x15), .c(new_n42_), .O(z17));
  aoi21  g38(.a(new_n58_), .b(x15), .c(new_n42_), .O(z18));
  inv1   g39(.a(x20), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x15), .c(new_n42_), .O(z19));
  buf    g41(.a(x15), .O(z06));
endmodule
