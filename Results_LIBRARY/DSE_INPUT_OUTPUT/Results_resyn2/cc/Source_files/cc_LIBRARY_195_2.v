...
module FAU ( 
  ...
  aoi21  g32(.a(new_n51_), .b(new_n73_), .c(x03), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n68_), .c(new_n55_), .O(z12));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n51_), .b(new_n77_), .c(new_n44_), .O(new_n78_));
  nand2  g37(.a(new_n47_), .b(new_n50_), .O(new_n79_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n70_), .O(new_n99_));
  oai21  g58(.a(new_n90_), .b(new_n58_), .c(new_n99_), .O(z18));
  nand2  g59(.a(x20), .b(x15), .O(new_n101_));
  nand2  g60(.a(new_n70_), .b(x07), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n69_), .O(new_n103_));
  aoi21  g62(.a(new_n51_), .b(new_n43_), .c(x03), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n101_), .c(new_n55_), .O(z19));
  buf    g65(.a(x15), .O(z06));
endmodule
