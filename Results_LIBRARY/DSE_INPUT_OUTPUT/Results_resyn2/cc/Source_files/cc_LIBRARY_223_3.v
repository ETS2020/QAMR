...
module FAU ( 
  ...
  nor2   g07(.a(new_n44_), .b(new_n43_), .O(new_n49_));
  ...
  nor2   g14(.a(x20), .b(new_n43_), .O(z06));
  nand2  g15(.a(z06), .b(new_n46_), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n55_), .O(z03));
  nor2   g17(.a(new_n49_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nor2   g19(.a(new_n49_), .b(new_n60_), .O(z05));
  ...
  nand2  g31(.a(new_n51_), .b(x13), .O(new_n73_));
  ...
  nand2  g36(.a(new_n55_), .b(new_n44_), .O(new_n78_));
  ...
  nand3  g49(.a(new_n51_), .b(x16), .c(new_n46_), .O(new_n91_));
  ...
  nand2  g58(.a(new_n51_), .b(new_n62_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n43_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n97_), .c(new_n96_), .O(z16));
  nand2  g61(.a(x18), .b(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x15), .O(new_n105_));
  nand2  g64(.a(new_n51_), .b(x18), .O(new_n106_));
  nand4  g65(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n107_));
  ...
  nand2  g69(.a(z06), .b(x19), .O(new_n111_));
  inv1   g70(.a(x06), .O(new_n112_));
  nand3  g71(.a(x10), .b(x08), .c(new_n112_), .O(new_n113_));
  nand2  g72(.a(new_n51_), .b(new_n60_), .O(new_n114_));
  nand3  g73(.a(new_n114_), .b(new_n113_), .c(new_n43_), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n111_), .c(new_n96_), .O(z18));
  nand2  g75(.a(new_n51_), .b(x20), .O(new_n117_));
  nand4  g76(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x12), .O(new_n120_));
  nand2  g79(.a(new_n120_), .b(new_n50_), .O(z19));
endmodule
