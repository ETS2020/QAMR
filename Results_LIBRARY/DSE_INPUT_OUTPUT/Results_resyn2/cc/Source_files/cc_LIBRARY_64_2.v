...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n61_, new_n63_, new_n66_, new_n68_, new_n73_, new_n74_,
  ...
  aoi21  g16(.a(new_n43_), .b(x04), .c(new_n54_), .O(new_n58_));
  ...
  nand2  g28(.a(x09), .b(x08), .O(z10));
  nand2  g29(.a(z10), .b(new_n44_), .O(z09));
  nor2   g30(.a(new_n61_), .b(new_n46_), .O(z11));
  inv1   g31(.a(x00), .O(new_n73_));
  nand4  g32(.a(new_n51_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  ...
  nand2  g43(.a(new_n58_), .b(new_n47_), .O(new_n85_));
  ...
  nand2  g53(.a(new_n52_), .b(new_n66_), .O(new_n95_));
  ...
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(new_n58_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand4  g63(.a(new_n51_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n52_), .b(new_n63_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n58_), .O(new_n107_));
  ...
  nand3  g71(.a(new_n112_), .b(new_n110_), .c(new_n58_), .O(new_n113_));
