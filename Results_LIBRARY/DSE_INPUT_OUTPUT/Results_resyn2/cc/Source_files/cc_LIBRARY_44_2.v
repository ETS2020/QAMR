...
module FAU ( 
  ...
  nand2  g15(.a(new_n53_), .b(x06), .O(new_n57_));
  ...
  nand2  g43(.a(new_n80_), .b(new_n54_), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n47_), .c(new_n85_), .O(z14));
  ...
  nand4  g57(.a(new_n47_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  inv1   g58(.a(x18), .O(new_n100_));
  nand2  g59(.a(new_n51_), .b(new_n100_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n57_), .O(z17));
  inv1   g62(.a(new_n51_), .O(new_n104_));
