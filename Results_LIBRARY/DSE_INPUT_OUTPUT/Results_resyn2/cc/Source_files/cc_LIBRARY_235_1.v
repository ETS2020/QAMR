...
module FAU ( 
  ...
  nand2  g23(.a(new_n64_), .b(new_n44_), .O(z08));
  nand3  g24(.a(new_n45_), .b(x09), .c(x08), .O(z10));
  inv1   g25(.a(z10), .O(z09));
  nor2   g26(.a(new_n59_), .b(new_n48_), .O(z11));
  ...
  aoi21  g37(.a(new_n77_), .b(new_n56_), .c(new_n78_), .O(z13));
  aoi21  g38(.a(new_n49_), .b(x02), .c(x15), .O(new_n80_));
  inv1   g39(.a(x12), .O(new_n81_));
  aoi21  g40(.a(x19), .b(new_n44_), .c(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n56_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n80_), .O(z14));
  nand3  g43(.a(new_n70_), .b(x10), .c(x08), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x16), .c(new_n48_), .O(new_n86_));
  nand4  g45(.a(new_n49_), .b(new_n45_), .c(new_n70_), .d(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n81_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n70_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n52_), .b(x15), .c(new_n62_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n82_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand4  g53(.a(new_n70_), .b(x10), .c(x08), .d(new_n94_), .O(new_n95_));
  inv1   g54(.a(x18), .O(new_n96_));
  oai21  g55(.a(new_n52_), .b(x15), .c(new_n96_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n82_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n70_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n52_), .b(x15), .c(new_n64_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n45_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand4  g64(.a(new_n70_), .b(x10), .c(x08), .d(new_n105_), .O(new_n106_));
  oai21  g65(.a(new_n52_), .b(x15), .c(new_n43_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n82_), .O(new_n108_));
