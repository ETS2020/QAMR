...
module FAU ( 
  ...
  nor2   g03(.a(z04), .b(x05), .O(new_n45_));
  ...
  nand2  g26(.a(new_n48_), .b(new_n51_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  aoi21  g28(.a(x18), .b(new_n47_), .c(new_n69_), .O(new_n70_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n72_), .c(new_n70_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z12));
  nand2  g36(.a(new_n48_), .b(x12), .O(new_n78_));
  inv1   g37(.a(x01), .O(new_n79_));
  oai21  g38(.a(new_n74_), .b(new_n79_), .c(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n49_), .c(new_n78_), .O(z13));
  inv1   g40(.a(x02), .O(new_n82_));
  oai21  g41(.a(new_n74_), .b(new_n82_), .c(new_n52_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n49_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n48_), .O(z14));
  nand3  g44(.a(new_n53_), .b(x16), .c(new_n51_), .O(new_n86_));
