...
module FAU ( 
  ...
  aoi21  g27(.a(z04), .b(x05), .c(new_n57_), .O(new_n69_));
  ...
  nor2   g51(.a(z04), .b(x12), .O(new_n93_));
  nand2  g52(.a(new_n54_), .b(x18), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n93_), .O(z17));
  inv1   g54(.a(x06), .O(new_n96_));
  nand4  g55(.a(new_n53_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  oai21  g56(.a(new_n73_), .b(x15), .c(new_n59_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z18));
  inv1   g59(.a(x07), .O(new_n101_));
  nand4  g60(.a(new_n53_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  oai21  g61(.a(new_n73_), .b(x15), .c(new_n43_), .O(new_n103_));
