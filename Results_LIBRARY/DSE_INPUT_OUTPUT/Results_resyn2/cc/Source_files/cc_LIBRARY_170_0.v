...
module FAU ( 
  ...
  nand2  g15(.a(new_n56_), .b(new_n44_), .O(z03));
  ...
  nand3  g41(.a(new_n71_), .b(x16), .c(new_n50_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n49_), .O(z15));
  inv1   g43(.a(x04), .O(new_n85_));
  nand3  g44(.a(new_n68_), .b(new_n70_), .c(new_n85_), .O(new_n86_));
  nand2  g45(.a(new_n71_), .b(new_n61_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n86_), .c(x12), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z16));
  inv1   g48(.a(x05), .O(new_n90_));
  nand3  g49(.a(new_n68_), .b(new_n70_), .c(new_n90_), .O(new_n91_));
  ...
  aoi21  g54(.a(new_n68_), .b(x06), .c(new_n49_), .O(new_n96_));
  nand3  g55(.a(new_n71_), .b(x19), .c(x12), .O(new_n97_));
  oai21  g56(.a(new_n96_), .b(x15), .c(new_n97_), .O(z18));
  aoi21  g57(.a(new_n68_), .b(x07), .c(new_n49_), .O(new_n99_));
  nand3  g58(.a(new_n71_), .b(x20), .c(x12), .O(new_n100_));
