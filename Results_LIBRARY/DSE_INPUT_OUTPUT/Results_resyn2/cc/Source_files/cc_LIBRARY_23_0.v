...
module FAU ( 
  ...
  nand4  g27(.a(new_n62_), .b(x10), .c(x08), .d(new_n68_), .O(new_n69_));
  ...
  aoi21  g38(.a(new_n78_), .b(new_n62_), .c(new_n79_), .O(z14));
  inv1   g39(.a(x12), .O(new_n81_));
  nand3  g40(.a(new_n62_), .b(x10), .c(x08), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x16), .c(new_n48_), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x03), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n46_), .c(new_n62_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n81_), .O(z15));
  aoi21  g46(.a(new_n45_), .b(new_n44_), .c(new_n81_), .O(new_n88_));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n62_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n52_), .b(x15), .c(new_n64_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand4  g53(.a(new_n62_), .b(x10), .c(x08), .d(new_n94_), .O(new_n95_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n46_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n62_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n52_), .b(x15), .c(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(new_n88_), .O(new_n103_));
