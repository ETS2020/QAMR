...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n62_, new_n64_, new_n66_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  nor2   g11(.a(new_n47_), .b(new_n52_), .O(new_n53_));
  nand2  g12(.a(x10), .b(x08), .O(new_n54_));
  nor2   g13(.a(new_n54_), .b(x15), .O(new_n55_));
  oai21  g14(.a(new_n55_), .b(new_n53_), .c(new_n42_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n46_), .O(z02));
  oai21  g16(.a(new_n50_), .b(new_n52_), .c(new_n46_), .O(z03));
  ...
  aoi21  g30(.a(new_n71_), .b(x00), .c(new_n52_), .O(new_n72_));
  nand3  g31(.a(new_n62_), .b(x10), .c(x08), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x13), .c(x12), .O(new_n74_));
  oai21  g33(.a(new_n72_), .b(x15), .c(new_n74_), .O(z12));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n49_), .O(z14));
  nand2  g42(.a(new_n55_), .b(x03), .O(new_n84_));
  ...
  nand3  g46(.a(new_n71_), .b(new_n62_), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(new_n73_), .b(new_n64_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand3  g51(.a(new_n71_), .b(new_n62_), .c(new_n92_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  nand2  g53(.a(new_n73_), .b(new_n94_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n93_), .c(x12), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z17));
  aoi21  g56(.a(new_n71_), .b(x06), .c(new_n52_), .O(new_n98_));
  nand3  g57(.a(new_n73_), .b(x19), .c(x12), .O(new_n99_));
  oai21  g58(.a(new_n98_), .b(x15), .c(new_n99_), .O(z18));
  inv1   g59(.a(x07), .O(new_n101_));
  nand3  g60(.a(new_n71_), .b(new_n62_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n73_), .b(new_n43_), .O(new_n103_));
