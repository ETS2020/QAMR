...
module FAU ( 
  ...
  aoi21  g42(.a(new_n70_), .b(x03), .c(new_n56_), .O(new_n84_));
  nand4  g43(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n85_));
  oai21  g44(.a(new_n84_), .b(x15), .c(new_n85_), .O(z15));
  aoi21  g45(.a(new_n70_), .b(x04), .c(new_n56_), .O(new_n87_));
  nand3  g46(.a(new_n52_), .b(x17), .c(x12), .O(new_n88_));
  ...
  aoi21  g54(.a(new_n70_), .b(x06), .c(new_n56_), .O(new_n96_));
  nand3  g55(.a(new_n52_), .b(x19), .c(x12), .O(new_n97_));
  oai21  g56(.a(new_n96_), .b(x15), .c(new_n97_), .O(z18));
  aoi21  g57(.a(new_n70_), .b(x07), .c(new_n56_), .O(new_n99_));
