...
module FAU ( 
  ...
  nor2   g35(.a(new_n62_), .b(new_n46_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n75_), .c(new_n52_), .O(z13));
  nand3  g38(.a(x17), .b(new_n60_), .c(x02), .O(new_n80_));
  oai21  g39(.a(new_n47_), .b(x15), .c(x12), .O(new_n81_));
  ...
  nand2  g43(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  ...
  aoi21  g48(.a(new_n51_), .b(new_n88_), .c(new_n89_), .O(z16));
  inv1   g49(.a(x18), .O(new_n91_));
  nand2  g50(.a(x12), .b(x05), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n50_), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n60_), .O(new_n94_));
  oai21  g53(.a(new_n73_), .b(new_n91_), .c(new_n94_), .O(z17));
  nand2  g54(.a(x19), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n60_), .b(x06), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  aoi21  g57(.a(new_n50_), .b(new_n58_), .c(new_n62_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n96_), .c(new_n52_), .O(z18));
  ...
  aoi21  g64(.a(new_n50_), .b(new_n105_), .c(new_n62_), .O(new_n106_));
