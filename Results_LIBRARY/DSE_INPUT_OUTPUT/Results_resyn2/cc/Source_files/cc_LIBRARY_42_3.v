...
module FAU ( 
  ...
  aoi21  g38(.a(new_n57_), .b(x02), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n53_), .b(new_n47_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z14));
  inv1   g41(.a(new_n53_), .O(new_n83_));
  nand3  g42(.a(new_n51_), .b(x16), .c(new_n49_), .O(new_n84_));
  nand3  g43(.a(new_n57_), .b(new_n50_), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z15));
  inv1   g45(.a(x04), .O(new_n87_));
  nand3  g46(.a(new_n57_), .b(new_n50_), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(new_n51_), .b(new_n62_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n44_), .O(z16));
  inv1   g50(.a(x05), .O(new_n92_));
  nand3  g51(.a(new_n57_), .b(new_n50_), .c(new_n92_), .O(new_n93_));
  ...
  nand3  g57(.a(new_n57_), .b(new_n50_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n51_), .b(new_n65_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n53_), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand3  g62(.a(new_n57_), .b(new_n50_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n51_), .b(new_n43_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(new_n53_), .O(new_n106_));
