...
module FAU ( 
  ...
  nor2   g03(.a(new_n44_), .b(x16), .O(new_n45_));
  nor3   g04(.a(new_n45_), .b(new_n43_), .c(new_n42_), .O(z00));
  inv1   g05(.a(x16), .O(new_n47_));
  nand2  g06(.a(x17), .b(new_n47_), .O(new_n48_));
  ...
  nand2  g22(.a(new_n44_), .b(new_n47_), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n48_), .O(z09));
  nand3  g25(.a(new_n48_), .b(x09), .c(x08), .O(z10));
  nand2  g26(.a(new_n48_), .b(new_n49_), .O(z11));
  aoi21  g27(.a(x17), .b(new_n47_), .c(new_n58_), .O(new_n69_));
  ...
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(new_n77_));
  nand4  g36(.a(new_n54_), .b(x10), .c(x08), .d(x01), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n48_), .O(z13));
  inv1   g39(.a(x02), .O(new_n81_));
  oai21  g40(.a(new_n73_), .b(new_n81_), .c(new_n54_), .O(new_n82_));
  ...
  nand4  g45(.a(new_n86_), .b(new_n48_), .c(new_n54_), .d(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n58_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n54_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n73_), .b(x15), .c(new_n44_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n48_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand4  g53(.a(new_n54_), .b(x10), .c(x08), .d(new_n94_), .O(new_n95_));
  inv1   g54(.a(x18), .O(new_n96_));
  oai21  g55(.a(new_n73_), .b(x15), .c(new_n96_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n95_), .c(new_n69_), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n54_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n73_), .b(x15), .c(new_n61_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(new_n69_), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand4  g64(.a(new_n54_), .b(x10), .c(x08), .d(new_n105_), .O(new_n106_));
  oai21  g65(.a(new_n73_), .b(x15), .c(new_n43_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(new_n106_), .c(new_n69_), .O(new_n108_));
