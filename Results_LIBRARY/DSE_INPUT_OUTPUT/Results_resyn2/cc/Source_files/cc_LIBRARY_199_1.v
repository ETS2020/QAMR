...
module FAU ( 
  ...
  nor3   g05(.a(new_n46_), .b(x19), .c(x14), .O(z01));
  ...
  aoi21  g16(.a(new_n57_), .b(new_n55_), .c(x14), .O(z03));
  ...
  aoi21  g38(.a(x19), .b(new_n43_), .c(new_n51_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  aoi21  g40(.a(new_n79_), .b(new_n48_), .c(new_n81_), .O(z14));
  nand4  g41(.a(new_n49_), .b(new_n55_), .c(x16), .d(new_n43_), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x03), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n44_), .c(new_n48_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n51_), .O(z15));
  ...
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n80_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n49_), .b(new_n95_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n94_), .c(new_n80_), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z17));
  nand2  g57(.a(new_n49_), .b(new_n55_), .O(new_n99_));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n48_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(new_n80_), .O(new_n102_));
  ...
  nand3  g66(.a(new_n107_), .b(new_n105_), .c(new_n80_), .O(new_n108_));
