...
module FAU ( 
  ...
  nand2  g14(.a(new_n50_), .b(x12), .O(new_n56_));
  ...
  nor2   g25(.a(new_n43_), .b(new_n50_), .O(z11));
  and2   g26(.a(x10), .b(x08), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(x00), .c(new_n49_), .O(new_n69_));
  inv1   g28(.a(x15), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(x10), .c(x08), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x13), .c(x12), .O(new_n72_));
  oai21  g31(.a(new_n69_), .b(x15), .c(new_n72_), .O(z12));
  ...
  aoi21  g40(.a(new_n68_), .b(x03), .c(new_n49_), .O(new_n82_));
  nand4  g41(.a(new_n71_), .b(x16), .c(new_n50_), .d(x12), .O(new_n83_));
  oai21  g42(.a(new_n82_), .b(x15), .c(new_n83_), .O(z15));
  aoi21  g43(.a(new_n68_), .b(x04), .c(new_n49_), .O(new_n85_));
  nand3  g44(.a(new_n71_), .b(x17), .c(x12), .O(new_n86_));
  oai21  g45(.a(new_n85_), .b(x15), .c(new_n86_), .O(z16));
  inv1   g46(.a(x05), .O(new_n88_));
  nand3  g47(.a(new_n68_), .b(new_n70_), .c(new_n88_), .O(new_n89_));
  inv1   g48(.a(x18), .O(new_n90_));
  nand2  g49(.a(new_n71_), .b(new_n90_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n89_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z17));
  aoi21  g52(.a(new_n68_), .b(x06), .c(new_n49_), .O(new_n94_));
  nand3  g53(.a(new_n71_), .b(x19), .c(x12), .O(new_n95_));
  oai21  g54(.a(new_n94_), .b(x15), .c(new_n95_), .O(z18));
  aoi21  g55(.a(new_n68_), .b(x07), .c(new_n49_), .O(new_n97_));
  nand3  g56(.a(new_n71_), .b(x20), .c(x12), .O(new_n98_));
