...
module FAU ( 
  ...
  nor2   g24(.a(new_n65_), .b(new_n57_), .O(z09));
  and2   g25(.a(new_n65_), .b(new_n44_), .O(z10));
  nor2   g26(.a(new_n57_), .b(new_n51_), .O(z11));
  inv1   g27(.a(x00), .O(new_n69_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(new_n69_), .O(new_n70_));
  inv1   g29(.a(x12), .O(new_n71_));
  aoi21  g30(.a(new_n43_), .b(x07), .c(new_n71_), .O(new_n72_));
  ...
  oai21  g41(.a(new_n48_), .b(new_n82_), .c(new_n46_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n80_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z14));
  nand3  g44(.a(new_n46_), .b(x10), .c(x08), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x16), .c(new_n51_), .O(new_n87_));
  nand4  g46(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n77_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand4  g49(.a(new_n46_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n48_), .b(x15), .c(new_n61_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand4  g54(.a(new_n46_), .b(x10), .c(x08), .d(new_n95_), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  oai21  g56(.a(new_n48_), .b(x15), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g61(.a(new_n48_), .b(x15), .c(new_n59_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(new_n72_), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nor2   g65(.a(new_n43_), .b(x12), .O(new_n107_));
  nand2  g66(.a(new_n86_), .b(x20), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n106_), .c(new_n107_), .O(z19));
endmodule
