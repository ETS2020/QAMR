...
module FAU ( 
  ...
  nand2  g13(.a(new_n44_), .b(x15), .O(new_n55_));
  nand2  g14(.a(new_n49_), .b(x12), .O(new_n56_));
  nor3   g15(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(z03));
  inv1   g16(.a(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n44_), .b(new_n59_), .O(z05));
  inv1   g19(.a(new_n55_), .O(z06));
  ...
  aoi21  g28(.a(x18), .b(x05), .c(new_n69_), .O(new_n70_));
  inv1   g29(.a(x00), .O(new_n71_));
  nand4  g30(.a(new_n50_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  ...
  oai21  g40(.a(new_n54_), .b(new_n81_), .c(new_n50_), .O(new_n82_));
  ...
  oai21  g48(.a(new_n54_), .b(x15), .c(new_n62_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n54_), .b(x15), .c(z04), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n70_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n50_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  oai21  g58(.a(new_n54_), .b(x15), .c(new_n59_), .O(new_n100_));
  ...
  oai21  g63(.a(new_n54_), .b(x15), .c(new_n43_), .O(new_n105_));
