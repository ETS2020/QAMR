...
module FAU ( 
  ...
  nand4  g04(.a(x15), .b(x12), .c(x10), .d(x08), .O(new_n46_));
  ...
  oai21  g32(.a(new_n73_), .b(new_n52_), .c(x15), .O(new_n74_));
  nand2  g33(.a(new_n73_), .b(x01), .O(new_n75_));
  nor2   g34(.a(new_n49_), .b(new_n52_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n74_), .O(z13));
  inv1   g37(.a(new_n46_), .O(new_n79_));
  nand3  g38(.a(new_n73_), .b(x12), .c(x02), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n42_), .c(new_n79_), .O(z14));
  nand2  g40(.a(new_n73_), .b(new_n42_), .O(new_n82_));
  nand2  g41(.a(x16), .b(new_n49_), .O(new_n83_));
  inv1   g42(.a(x03), .O(new_n84_));
  nand4  g43(.a(new_n42_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x12), .O(new_n86_));
  aoi21  g45(.a(new_n83_), .b(new_n82_), .c(new_n86_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n42_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n50_), .b(x15), .c(new_n59_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z16));
  oai21  g51(.a(new_n50_), .b(x05), .c(x12), .O(new_n93_));
  nor2   g52(.a(x18), .b(new_n52_), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n82_), .c(new_n93_), .d(new_n42_), .O(z17));
  inv1   g54(.a(x06), .O(new_n96_));
  nand4  g55(.a(new_n42_), .b(x10), .c(x08), .d(new_n96_), .O(new_n97_));
  oai21  g56(.a(new_n50_), .b(x15), .c(new_n57_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(x12), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z18));
  oai21  g59(.a(new_n50_), .b(x07), .c(x12), .O(new_n101_));
  nor2   g60(.a(x20), .b(new_n52_), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n82_), .c(new_n101_), .d(new_n42_), .O(z19));
  nor2   g62(.a(new_n46_), .b(x14), .O(z03));
  buf    g63(.a(x15), .O(z06));
endmodule
