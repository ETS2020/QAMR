...
module FAU ( 
  ...
  nor2   g01(.a(x17), .b(new_n42_), .O(new_n43_));
  ...
  aoi21  g08(.a(new_n49_), .b(x17), .c(new_n42_), .O(z01));
  ...
  nand2  g35(.a(new_n47_), .b(new_n46_), .O(new_n77_));
  nor2   g36(.a(new_n62_), .b(new_n42_), .O(new_n78_));
  ...
  nand2  g41(.a(new_n78_), .b(new_n47_), .O(new_n83_));
  ...
  nand3  g47(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n89_));
  ...
  nand3  g53(.a(new_n48_), .b(new_n42_), .c(new_n94_), .O(new_n95_));
  oai21  g54(.a(new_n47_), .b(x15), .c(new_n62_), .O(new_n96_));
  ...
  nand4  g61(.a(new_n42_), .b(x10), .c(x08), .d(x05), .O(new_n103_));
  ...
  nand2  g65(.a(new_n78_), .b(x19), .O(new_n107_));
  inv1   g66(.a(x06), .O(new_n108_));
  nand3  g67(.a(x10), .b(x08), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n47_), .b(new_n60_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(new_n42_), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n107_), .c(new_n53_), .O(z18));
  nand2  g71(.a(new_n78_), .b(x20), .O(new_n113_));
  inv1   g72(.a(x07), .O(new_n114_));
  nand3  g73(.a(x10), .b(x08), .c(new_n114_), .O(new_n115_));
  inv1   g74(.a(x20), .O(new_n116_));
  nand2  g75(.a(new_n47_), .b(new_n116_), .O(new_n117_));
  nand3  g76(.a(new_n117_), .b(new_n115_), .c(new_n42_), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n113_), .c(new_n53_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
