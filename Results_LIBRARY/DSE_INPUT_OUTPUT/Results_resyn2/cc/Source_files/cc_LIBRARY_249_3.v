...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    ...
    new_n61_, new_n62_, new_n65_, new_n68_, new_n72_, new_n73_, new_n74_,
  ...
  nand2  g04(.a(x20), .b(x18), .O(new_n46_));
  ...
  nor2   g29(.a(new_n62_), .b(new_n56_), .O(z11));
  inv1   g30(.a(x00), .O(new_n72_));
  inv1   g31(.a(x15), .O(new_n73_));
  nand3  g32(.a(new_n57_), .b(new_n73_), .c(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n46_), .b(x12), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  inv1   g35(.a(x13), .O(new_n77_));
  nand3  g36(.a(new_n73_), .b(x10), .c(x08), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n76_), .c(new_n74_), .O(new_n80_));
  ...
  nand2  g45(.a(new_n57_), .b(x02), .O(new_n87_));
  nand3  g46(.a(new_n47_), .b(new_n46_), .c(x12), .O(new_n88_));
  aoi21  g47(.a(new_n87_), .b(new_n73_), .c(new_n88_), .O(z14));
  nand3  g48(.a(new_n78_), .b(x16), .c(new_n56_), .O(new_n90_));
  nand2  g49(.a(new_n50_), .b(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n75_), .O(z15));
  inv1   g51(.a(x04), .O(new_n93_));
  nand3  g52(.a(new_n57_), .b(new_n73_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n78_), .b(new_n65_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n76_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  nand3  g57(.a(new_n57_), .b(new_n73_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n78_), .b(new_n43_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n46_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  nand3  g62(.a(new_n57_), .b(new_n73_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n78_), .b(new_n61_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n46_), .O(z18));
  inv1   g66(.a(x07), .O(new_n108_));
  nand3  g67(.a(new_n57_), .b(new_n73_), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n78_), .b(new_n44_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(new_n76_), .O(new_n111_));
