...
module FAU ( 
  ...
  nand2  g00(.a(x09), .b(x01), .O(new_n42_));
  ...
  aoi21  g31(.a(x09), .b(x01), .c(new_n54_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n72_), .c(new_n70_), .O(new_n74_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n42_), .O(z15));
  ...
  nand2  g64(.a(new_n105_), .b(new_n42_), .O(z18));
  ...
  nand2  g70(.a(new_n111_), .b(new_n42_), .O(z19));
endmodule
