...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x12), .O(new_n43_));
  inv1   g02(.a(new_n43_), .O(new_n44_));
  nand2  g03(.a(new_n44_), .b(new_n42_), .O(z00));
  inv1   g04(.a(x15), .O(new_n46_));
  nor2   g05(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  oai21  g17(.a(new_n58_), .b(new_n56_), .c(new_n44_), .O(z03));
  ...
  nand2  g24(.a(new_n65_), .b(x12), .O(z08));
  aoi21  g25(.a(x09), .b(x08), .c(new_n43_), .O(z10));
  inv1   g26(.a(z10), .O(z09));
  nor2   g27(.a(new_n43_), .b(new_n57_), .O(z11));
  inv1   g28(.a(x00), .O(new_n70_));
  and2   g29(.a(x10), .b(x08), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n46_), .c(new_n70_), .O(new_n72_));
  ...
  nand2  g42(.a(new_n56_), .b(x12), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n46_), .c(new_n84_), .O(z14));
  nand3  g44(.a(new_n74_), .b(x16), .c(new_n57_), .O(new_n86_));
  nand2  g45(.a(new_n51_), .b(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n52_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand3  g48(.a(new_n71_), .b(new_n46_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n71_), .b(new_n46_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g59(.a(new_n71_), .b(new_n46_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g64(.a(new_n71_), .b(new_n46_), .c(new_n105_), .O(new_n106_));
