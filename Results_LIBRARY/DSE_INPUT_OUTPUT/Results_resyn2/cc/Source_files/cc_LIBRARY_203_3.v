...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n58_, new_n60_, new_n63_,
  ...
  nand2  g04(.a(x15), .b(new_n45_), .O(new_n46_));
  ...
  nand2  g30(.a(new_n50_), .b(x13), .O(new_n72_));
  nand4  g31(.a(new_n60_), .b(x10), .c(x08), .d(x00), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(z12));
  nand4  g35(.a(new_n60_), .b(x10), .c(x08), .d(x01), .O(new_n77_));
  nand3  g36(.a(x15), .b(x10), .c(x08), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n77_), .c(new_n43_), .d(x12), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z13));
  inv1   g40(.a(x02), .O(new_n82_));
  oai21  g41(.a(new_n50_), .b(new_n82_), .c(new_n60_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n78_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n43_), .O(z14));
  nand2  g44(.a(new_n51_), .b(x03), .O(new_n86_));
  nand3  g45(.a(new_n60_), .b(x10), .c(x08), .O(new_n87_));
  nand4  g46(.a(new_n87_), .b(new_n43_), .c(x16), .d(new_n47_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n52_), .O(z15));
  oai21  g48(.a(new_n50_), .b(new_n52_), .c(new_n60_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x04), .O(new_n91_));
  nand3  g50(.a(new_n87_), .b(x17), .c(x12), .O(new_n92_));
  ...
  nand2  g55(.a(new_n50_), .b(x18), .O(new_n97_));
  nand4  g56(.a(new_n60_), .b(x10), .c(x08), .d(x05), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n96_), .O(z17));
  oai21  g60(.a(new_n58_), .b(new_n52_), .c(new_n45_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n50_), .b(x19), .O(new_n104_));
  nand4  g63(.a(new_n60_), .b(x10), .c(x08), .d(x06), .O(new_n105_));
  ...
  nand2  g71(.a(new_n50_), .b(new_n112_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(new_n111_), .c(new_n60_), .O(new_n114_));
