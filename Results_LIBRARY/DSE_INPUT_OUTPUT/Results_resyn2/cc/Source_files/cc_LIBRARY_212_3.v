...
module FAU ( 
  ...
  nand2  g32(.a(new_n46_), .b(x12), .O(new_n74_));
  nor3   g33(.a(new_n74_), .b(new_n51_), .c(new_n73_), .O(z14));
  nand3  g34(.a(x10), .b(x08), .c(x03), .O(new_n76_));
  nand3  g35(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(z15));
  inv1   g37(.a(x04), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(new_n79_), .O(new_n80_));
  nand2  g39(.a(new_n51_), .b(new_n59_), .O(new_n81_));
