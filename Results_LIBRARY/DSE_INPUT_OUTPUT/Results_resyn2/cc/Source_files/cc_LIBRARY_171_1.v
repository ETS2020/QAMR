...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n63_, new_n66_, new_n68_, new_n72_, new_n73_,
  ...
  nand2  g06(.a(x18), .b(new_n47_), .O(new_n48_));
  ...
  aoi21  g15(.a(x18), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  aoi21  g17(.a(new_n55_), .b(new_n49_), .c(new_n58_), .O(z02));
  inv1   g18(.a(new_n57_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n52_), .O(z03));
  nand2  g20(.a(x18), .b(x16), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nor2   g22(.a(new_n45_), .b(new_n63_), .O(z05));
  nand2  g23(.a(new_n48_), .b(new_n54_), .O(z06));
  ...
  nand2  g33(.a(new_n55_), .b(new_n74_), .O(new_n75_));
  ...
  nand2  g42(.a(new_n83_), .b(new_n54_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n50_), .c(x12), .O(new_n85_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n55_), .O(new_n90_));
  ...
  nand2  g53(.a(new_n55_), .b(new_n66_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n57_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  nand4  g57(.a(new_n54_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n55_), .b(new_n44_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n48_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  nand4  g62(.a(new_n54_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n55_), .b(new_n63_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(new_n104_), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n48_), .O(z18));
  inv1   g66(.a(x07), .O(new_n108_));
  nand4  g67(.a(new_n54_), .b(x10), .c(x08), .d(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n55_), .b(new_n43_), .O(new_n110_));
  nand3  g69(.a(new_n110_), .b(new_n109_), .c(x12), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n48_), .O(z19));
  buf    g71(.a(x16), .O(z08));
endmodule
