...
module FAU ( 
  ...
  nor2   g14(.a(new_n47_), .b(x02), .O(z06));
  nand2  g15(.a(z06), .b(x12), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n50_), .O(z03));
  ...
  nand3  g30(.a(new_n49_), .b(new_n47_), .c(x00), .O(new_n72_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n47_), .c(new_n48_), .O(new_n76_));
  nand3  g35(.a(new_n49_), .b(new_n47_), .c(x01), .O(new_n77_));
  ...
  aoi21  g39(.a(new_n75_), .b(x12), .c(x02), .O(new_n81_));
  ...
  oai21  g49(.a(new_n63_), .b(new_n71_), .c(new_n46_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n75_), .b(x17), .O(new_n93_));
  ...
  nand2  g60(.a(new_n75_), .b(new_n101_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n100_), .c(new_n47_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n98_), .c(new_n71_), .O(z17));
  oai21  g63(.a(new_n61_), .b(new_n71_), .c(new_n46_), .O(new_n105_));
  ...
  nand2  g73(.a(new_n75_), .b(new_n43_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n114_), .c(new_n47_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n112_), .c(new_n71_), .O(z19));
endmodule
