...
module FAU ( 
  ...
  nand2  g25(.a(new_n66_), .b(new_n44_), .O(z08));
  nand2  g26(.a(x09), .b(x08), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n46_), .O(z09));
  and2   g28(.a(new_n68_), .b(new_n45_), .O(z10));
  nor2   g29(.a(new_n46_), .b(new_n47_), .O(z11));
  ...
  nand3  g45(.a(new_n53_), .b(x16), .c(new_n47_), .O(new_n87_));
  nand3  g46(.a(x10), .b(x08), .c(x03), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n45_), .c(new_n52_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n87_), .c(new_n55_), .O(z15));
  inv1   g50(.a(x04), .O(new_n92_));
  nand4  g51(.a(new_n52_), .b(x10), .c(x08), .d(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n53_), .b(new_n64_), .O(new_n94_));
  aoi21  g53(.a(x20), .b(new_n44_), .c(new_n55_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n101_), .b(new_n99_), .c(new_n95_), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand4  g63(.a(new_n52_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n53_), .b(new_n61_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n45_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  nand4  g68(.a(new_n52_), .b(x10), .c(x08), .d(new_n109_), .O(new_n110_));
  nand2  g69(.a(new_n53_), .b(new_n66_), .O(new_n111_));
