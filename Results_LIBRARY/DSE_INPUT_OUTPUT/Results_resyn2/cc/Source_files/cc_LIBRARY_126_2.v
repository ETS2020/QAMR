...
module FAU ( 
  ...
  nand4  g30(.a(new_n52_), .b(x12), .c(x10), .d(x08), .O(new_n72_));
  ...
  nand3  g45(.a(new_n81_), .b(new_n52_), .c(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand3  g48(.a(new_n81_), .b(new_n52_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n81_), .b(new_n52_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g58(.a(new_n81_), .b(new_n52_), .c(new_n44_), .O(new_n100_));
  nand2  g59(.a(new_n53_), .b(new_n60_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n100_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n45_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand3  g63(.a(new_n81_), .b(new_n52_), .c(new_n104_), .O(new_n105_));
