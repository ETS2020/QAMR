...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_,
  ...
  aoi21  g11(.a(new_n52_), .b(x19), .c(x11), .O(z02));
  ...
  nand2  g16(.a(new_n57_), .b(x11), .O(z05));
  ...
  nand4  g27(.a(new_n59_), .b(x10), .c(x08), .d(new_n68_), .O(new_n69_));
  inv1   g28(.a(x13), .O(new_n70_));
  nand3  g29(.a(new_n59_), .b(x10), .c(x08), .O(new_n71_));
  ...
  oai21  g39(.a(new_n50_), .b(new_n80_), .c(new_n59_), .O(new_n81_));
  ...
  nor2   g43(.a(new_n50_), .b(x15), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x03), .O(new_n86_));
  nand2  g45(.a(new_n44_), .b(x12), .O(new_n87_));
  ...
  nand2  g49(.a(new_n71_), .b(new_n61_), .O(new_n91_));
  ...
  nand2  g58(.a(new_n85_), .b(x11), .O(new_n100_));
  oai21  g59(.a(new_n71_), .b(x06), .c(x12), .O(new_n101_));
  aoi21  g60(.a(new_n100_), .b(new_n57_), .c(new_n101_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand4  g62(.a(new_n59_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
