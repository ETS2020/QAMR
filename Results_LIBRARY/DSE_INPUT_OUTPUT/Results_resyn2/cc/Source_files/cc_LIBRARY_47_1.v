...
module FAU ( 
  ...
  aoi21  g19(.a(new_n60_), .b(x03), .c(new_n50_), .O(z03));
  ...
  nand2  g56(.a(new_n97_), .b(x03), .O(new_n98_));
  ...
  oai21  g63(.a(new_n63_), .b(new_n72_), .c(x03), .O(new_n105_));
  ...
  nand2  g73(.a(new_n48_), .b(new_n43_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n114_), .c(new_n50_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n112_), .c(new_n72_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
