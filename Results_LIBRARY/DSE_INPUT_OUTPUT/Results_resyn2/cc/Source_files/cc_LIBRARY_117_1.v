...
module FAU ( 
  ...
  aoi21  g11(.a(new_n52_), .b(x02), .c(new_n48_), .O(z01));
  nand2  g12(.a(new_n45_), .b(x14), .O(new_n54_));
  nand2  g13(.a(new_n51_), .b(new_n48_), .O(new_n55_));
  ...
  nor2   g17(.a(new_n48_), .b(new_n44_), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n49_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n58_), .O(z03));
  nor2   g20(.a(new_n46_), .b(x18), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nor2   g22(.a(new_n46_), .b(new_n63_), .O(z05));
  ...
  nand2  g31(.a(new_n72_), .b(x02), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x15), .O(new_n74_));
  nand2  g33(.a(new_n50_), .b(x13), .O(new_n75_));
  ...
  nand2  g38(.a(new_n58_), .b(x02), .O(new_n80_));
  ...
  nand2  g43(.a(new_n50_), .b(x15), .O(new_n85_));
  nand2  g44(.a(x12), .b(x02), .O(new_n86_));
  aoi21  g45(.a(new_n85_), .b(new_n55_), .c(new_n86_), .O(z14));
  nand3  g46(.a(x16), .b(new_n49_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x02), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand3  g49(.a(new_n50_), .b(x16), .c(new_n49_), .O(new_n91_));
  nand4  g50(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n92_));
  ...
  oai21  g55(.a(new_n65_), .b(new_n96_), .c(x02), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n50_), .b(x17), .O(new_n99_));
  nand4  g58(.a(new_n48_), .b(x10), .c(x08), .d(x04), .O(new_n100_));
  ...
  nand2  g62(.a(new_n59_), .b(x18), .O(new_n104_));
  ...
  nand3  g67(.a(new_n108_), .b(new_n106_), .c(new_n48_), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n104_), .c(new_n96_), .O(z17));
  nand2  g69(.a(new_n59_), .b(x19), .O(new_n111_));
  inv1   g70(.a(x06), .O(new_n112_));
  nand3  g71(.a(x10), .b(x08), .c(new_n112_), .O(new_n113_));
  nand2  g72(.a(new_n50_), .b(new_n63_), .O(new_n114_));
  nand3  g73(.a(new_n114_), .b(new_n113_), .c(new_n48_), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n111_), .c(new_n96_), .O(z18));
  oai21  g75(.a(new_n43_), .b(new_n96_), .c(x02), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x15), .O(new_n118_));
  nand2  g77(.a(new_n50_), .b(x20), .O(new_n119_));
  nand4  g78(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n120_));
