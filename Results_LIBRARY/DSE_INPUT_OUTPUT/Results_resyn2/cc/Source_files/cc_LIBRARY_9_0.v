...
module FAU ( 
  ...
  aoi21  g33(.a(new_n74_), .b(new_n47_), .c(new_n72_), .O(z13));
  ...
  aoi21  g41(.a(new_n79_), .b(new_n51_), .c(new_n82_), .O(z15));
  ...
  oai21  g50(.a(new_n67_), .b(x15), .c(new_n91_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n67_), .b(x15), .c(new_n57_), .O(new_n97_));
  ...
  oai21  g60(.a(new_n67_), .b(x15), .c(new_n43_), .O(new_n102_));
