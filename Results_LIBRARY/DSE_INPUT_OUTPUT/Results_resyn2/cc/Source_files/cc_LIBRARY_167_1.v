...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(x12), .O(new_n49_));
  nor2   g08(.a(new_n49_), .b(new_n48_), .O(z01));
  inv1   g09(.a(new_n43_), .O(new_n51_));
  nand2  g10(.a(x10), .b(x08), .O(new_n52_));
  oai21  g11(.a(new_n52_), .b(x15), .c(new_n46_), .O(new_n53_));
  ...
  aoi21  g16(.a(new_n48_), .b(x12), .c(new_n42_), .O(z03));
  ...
  nand3  g29(.a(new_n47_), .b(new_n42_), .c(new_n70_), .O(new_n71_));
  inv1   g30(.a(x13), .O(new_n72_));
  oai21  g31(.a(new_n52_), .b(x15), .c(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n71_), .c(x12), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z12));
  nand2  g34(.a(new_n47_), .b(x15), .O(new_n76_));
  ...
  nand2  g38(.a(new_n47_), .b(x02), .O(new_n80_));
  oai21  g39(.a(new_n52_), .b(new_n42_), .c(x12), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n42_), .c(new_n81_), .O(z14));
  oai21  g41(.a(new_n64_), .b(x14), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand2  g43(.a(new_n42_), .b(x03), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  oai21  g45(.a(new_n64_), .b(x14), .c(new_n52_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n86_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n84_), .O(z15));
  inv1   g48(.a(x04), .O(new_n90_));
  nand3  g49(.a(new_n47_), .b(new_n42_), .c(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n52_), .b(x15), .c(new_n62_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z16));
  inv1   g53(.a(x05), .O(new_n95_));
  nand3  g54(.a(new_n47_), .b(new_n42_), .c(new_n95_), .O(new_n96_));
  inv1   g55(.a(x18), .O(new_n97_));
  oai21  g56(.a(new_n52_), .b(x15), .c(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n96_), .c(x12), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand3  g60(.a(new_n47_), .b(new_n42_), .c(new_n101_), .O(new_n102_));
  oai21  g61(.a(new_n52_), .b(x15), .c(new_n60_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z18));
  inv1   g64(.a(x07), .O(new_n106_));
  nand3  g65(.a(new_n47_), .b(new_n42_), .c(new_n106_), .O(new_n107_));
  inv1   g66(.a(x20), .O(new_n108_));
  oai21  g67(.a(new_n52_), .b(x15), .c(new_n108_), .O(new_n109_));
