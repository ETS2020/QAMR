...
module FAU ( 
  ...
  aoi21  g13(.a(new_n44_), .b(x00), .c(new_n54_), .O(new_n55_));
  ...
  nand4  g29(.a(new_n52_), .b(x12), .c(x10), .d(x08), .O(new_n71_));
  ...
  inv1   g39(.a(new_n78_), .O(new_n81_));
  ...
  nand3  g44(.a(new_n81_), .b(new_n52_), .c(x03), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n76_), .O(z15));
  inv1   g46(.a(x04), .O(new_n88_));
  nand3  g47(.a(new_n81_), .b(new_n52_), .c(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n53_), .b(new_n64_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n55_), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z16));
  nand3  g51(.a(new_n81_), .b(new_n52_), .c(new_n44_), .O(new_n93_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n52_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g62(.a(new_n81_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
