...
module FAU ( 
  ...
  nand2  g09(.a(new_n50_), .b(x15), .O(new_n51_));
  ...
  oai21  g18(.a(new_n59_), .b(new_n51_), .c(new_n45_), .O(z03));
  inv1   g19(.a(x18), .O(z04));
  inv1   g20(.a(x19), .O(new_n62_));
  nand2  g21(.a(new_n45_), .b(new_n62_), .O(z05));
  nor2   g22(.a(new_n44_), .b(new_n53_), .O(z06));
  ...
  nand3  g35(.a(new_n76_), .b(new_n74_), .c(new_n56_), .O(new_n77_));
  ...
  aoi21  g42(.a(new_n50_), .b(x02), .c(x15), .O(new_n84_));
