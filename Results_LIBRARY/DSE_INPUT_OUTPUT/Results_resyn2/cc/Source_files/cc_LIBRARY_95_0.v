...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(x09), .O(z06));
  ...
  oai21  g29(.a(new_n70_), .b(new_n51_), .c(x09), .O(new_n71_));
  ...
  nand3  g35(.a(new_n76_), .b(x14), .c(x09), .O(new_n77_));
  ...
  nand3  g40(.a(x16), .b(x15), .c(new_n50_), .O(new_n82_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n47_), .O(new_n84_));
  oai21  g43(.a(new_n64_), .b(x14), .c(new_n51_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(x09), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n82_), .c(new_n55_), .O(z15));
  nand2  g46(.a(x17), .b(x15), .O(new_n88_));
  nand2  g47(.a(new_n60_), .b(x04), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n47_), .O(new_n90_));
  inv1   g49(.a(x09), .O(new_n91_));
  aoi21  g50(.a(new_n51_), .b(new_n62_), .c(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n88_), .c(new_n55_), .O(z16));
  inv1   g53(.a(x18), .O(new_n95_));
  nand2  g54(.a(x12), .b(x05), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n51_), .c(x09), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n60_), .O(new_n98_));
  oai21  g57(.a(new_n73_), .b(new_n95_), .c(new_n98_), .O(z17));
  nand2  g58(.a(x19), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n60_), .b(x06), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  aoi21  g61(.a(new_n51_), .b(new_n58_), .c(new_n91_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n100_), .c(new_n55_), .O(z18));
  nand2  g64(.a(x20), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n60_), .b(x07), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  aoi21  g67(.a(new_n51_), .b(new_n43_), .c(new_n91_), .O(new_n109_));
