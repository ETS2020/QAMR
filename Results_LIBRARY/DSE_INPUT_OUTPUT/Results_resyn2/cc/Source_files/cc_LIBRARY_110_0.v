...
module FAU ( 
  ...
  nand2  g25(.a(new_n52_), .b(new_n48_), .O(z11));
  ...
  nand2  g40(.a(new_n73_), .b(new_n49_), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n46_), .c(new_n52_), .d(x12), .O(new_n83_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n49_), .O(new_n92_));
  nand2  g51(.a(new_n51_), .b(x12), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n60_), .c(new_n92_), .O(z16));
  nand2  g53(.a(x18), .b(x15), .O(new_n95_));
  nand2  g54(.a(new_n49_), .b(x05), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n50_), .O(new_n97_));
  inv1   g56(.a(x18), .O(new_n98_));
  aoi21  g57(.a(new_n73_), .b(new_n98_), .c(new_n71_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n95_), .c(new_n55_), .O(z17));
  nand2  g60(.a(x19), .b(x15), .O(new_n102_));
  nand2  g61(.a(new_n49_), .b(x06), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n50_), .O(new_n104_));
  aoi21  g63(.a(new_n73_), .b(new_n58_), .c(new_n71_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n102_), .c(new_n55_), .O(z18));
  nand4  g66(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x02), .O(new_n109_));
