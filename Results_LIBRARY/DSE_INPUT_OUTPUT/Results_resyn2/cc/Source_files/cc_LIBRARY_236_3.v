...
module FAU ( 
  ...
  nor2   g13(.a(new_n43_), .b(x11), .O(z06));
  nand2  g14(.a(z06), .b(new_n46_), .O(new_n56_));
  ...
  inv1   g24(.a(new_n58_), .O(new_n66_));
  ...
  nand2  g36(.a(new_n54_), .b(new_n42_), .O(new_n78_));
  ...
  oai21  g55(.a(new_n62_), .b(new_n96_), .c(new_n42_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n47_), .b(x17), .O(new_n99_));
  nand4  g58(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n100_));
  ...
  oai21  g76(.a(new_n44_), .b(new_n96_), .c(new_n42_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n47_), .b(x20), .O(new_n120_));
  nand4  g79(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n121_));
