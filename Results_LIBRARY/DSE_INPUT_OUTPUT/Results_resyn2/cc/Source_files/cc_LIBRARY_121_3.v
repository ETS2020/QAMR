...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n56_, new_n60_, new_n63_,
  ...
  nand2  g17(.a(new_n44_), .b(new_n52_), .O(z06));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n48_), .c(new_n56_), .O(z13));
  inv1   g35(.a(x02), .O(new_n77_));
  oai21  g36(.a(new_n70_), .b(new_n77_), .c(new_n52_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n48_), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z14));
  nand3  g39(.a(new_n53_), .b(x16), .c(new_n47_), .O(new_n81_));
  ...
  oai21  g44(.a(new_n70_), .b(x15), .c(new_n60_), .O(new_n86_));
  ...
  oai21  g63(.a(new_n70_), .b(x15), .c(new_n43_), .O(new_n105_));
