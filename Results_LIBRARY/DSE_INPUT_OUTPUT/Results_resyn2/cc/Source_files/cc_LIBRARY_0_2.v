...
module FAU ( 
  ...
  nand2  g06(.a(z04), .b(x05), .O(new_n48_));
  nand2  g07(.a(new_n48_), .b(new_n46_), .O(z11));
  ...
  nand2  g16(.a(new_n46_), .b(x12), .O(new_n58_));
  oai21  g17(.a(new_n58_), .b(new_n50_), .c(new_n48_), .O(z03));
  ...
  nand2  g25(.a(new_n48_), .b(new_n66_), .O(z08));
  ...
  nand3  g31(.a(new_n62_), .b(x10), .c(x08), .O(new_n73_));
  ...
  oai21  g41(.a(new_n52_), .b(new_n82_), .c(new_n62_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n50_), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n48_), .O(z14));
  nand3  g44(.a(new_n73_), .b(x16), .c(new_n46_), .O(new_n86_));
  nand2  g45(.a(new_n53_), .b(x03), .O(new_n87_));
  aoi21  g46(.a(z04), .b(x05), .c(new_n54_), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(new_n89_));
  aoi21  g48(.a(new_n87_), .b(new_n86_), .c(new_n89_), .O(z15));
  inv1   g49(.a(x04), .O(new_n91_));
  nand4  g50(.a(new_n62_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n73_), .b(new_n64_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n88_), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z16));
  nand2  g54(.a(new_n73_), .b(x18), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n42_), .c(x18), .d(new_n54_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n62_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n73_), .b(new_n60_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n48_), .O(z18));
  inv1   g61(.a(x07), .O(new_n103_));
  nand4  g62(.a(new_n62_), .b(x10), .c(x08), .d(new_n103_), .O(new_n104_));
  inv1   g63(.a(x20), .O(new_n105_));
  nand2  g64(.a(new_n73_), .b(new_n105_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n104_), .c(new_n88_), .O(new_n107_));
