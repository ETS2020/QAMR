...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n55_, new_n57_, new_n59_, new_n65_,
  ...
  nand2  g22(.a(new_n43_), .b(new_n54_), .O(z11));
  nand2  g23(.a(new_n48_), .b(x00), .O(new_n65_));
  nand3  g24(.a(new_n45_), .b(x10), .c(x08), .O(new_n66_));
  nand3  g25(.a(new_n66_), .b(new_n43_), .c(x13), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n49_), .O(z12));
  oai21  g27(.a(new_n46_), .b(new_n49_), .c(new_n53_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x15), .O(new_n70_));
  nand3  g29(.a(x10), .b(x08), .c(x01), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x14), .c(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n70_), .O(z13));
  nor2   g32(.a(x17), .b(new_n45_), .O(new_n74_));
  nand2  g33(.a(new_n46_), .b(new_n74_), .O(new_n75_));
  nand2  g34(.a(new_n48_), .b(x02), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n49_), .O(z14));
  nand3  g36(.a(x16), .b(new_n54_), .c(x12), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  nand3  g39(.a(new_n46_), .b(x16), .c(new_n54_), .O(new_n81_));
  nand4  g40(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  ...
  nand4  g45(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n43_), .O(z16));
  nand2  g49(.a(new_n74_), .b(x18), .O(new_n91_));
  inv1   g50(.a(x05), .O(new_n92_));
  nand3  g51(.a(x10), .b(x08), .c(new_n92_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  nand2  g53(.a(new_n46_), .b(new_n94_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n93_), .c(new_n45_), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n91_), .c(new_n49_), .O(z17));
  oai21  g56(.a(new_n59_), .b(new_n49_), .c(new_n53_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n46_), .b(x19), .O(new_n100_));
  nand4  g59(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n101_));
  ...
  nand2  g66(.a(new_n46_), .b(x20), .O(new_n108_));
  nand4  g67(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n109_));
