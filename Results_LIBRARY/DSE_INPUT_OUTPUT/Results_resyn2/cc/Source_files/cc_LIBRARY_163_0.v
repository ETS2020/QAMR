...
module FAU ( 
  ...
  nand3  g40(.a(new_n49_), .b(new_n46_), .c(x12), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n53_), .c(new_n82_), .O(z14));
  nand3  g42(.a(new_n54_), .b(x16), .c(new_n48_), .O(new_n84_));
  nand4  g43(.a(new_n53_), .b(x10), .c(x08), .d(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n77_), .O(z15));
  aoi21  g45(.a(new_n45_), .b(new_n44_), .c(new_n57_), .O(new_n87_));
  inv1   g46(.a(x04), .O(new_n88_));
  nand4  g47(.a(new_n53_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g48(.a(new_n73_), .b(x15), .c(new_n64_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n87_), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z16));
  nand4  g51(.a(new_n53_), .b(x10), .c(x08), .d(new_n45_), .O(new_n93_));
  inv1   g52(.a(x18), .O(new_n94_));
  oai21  g53(.a(new_n73_), .b(x15), .c(new_n94_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(new_n93_), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n46_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n53_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  oai21  g58(.a(new_n73_), .b(x15), .c(new_n61_), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(new_n87_), .O(new_n101_));
  ...
  nand2  g65(.a(new_n106_), .b(new_n46_), .O(z19));
endmodule
