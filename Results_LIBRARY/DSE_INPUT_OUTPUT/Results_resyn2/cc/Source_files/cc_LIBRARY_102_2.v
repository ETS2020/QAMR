...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n57_, new_n58_, new_n61_, new_n63_,
    new_n65_, new_n69_, new_n71_, new_n72_, new_n75_, new_n78_, new_n80_,
    new_n82_;
  ...
  nand3  g12(.a(new_n46_), .b(x10), .c(x08), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(x15), .c(new_n53_), .O(z03));
  nand2  g14(.a(new_n44_), .b(x18), .O(z04));
  inv1   g15(.a(x19), .O(new_n57_));
  nor2   g16(.a(x15), .b(new_n53_), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(new_n57_), .O(z05));
  nand2  g18(.a(new_n43_), .b(new_n53_), .O(z06));
  ...
  aoi21  g32(.a(new_n47_), .b(x15), .c(new_n53_), .O(z14));
  nand2  g33(.a(x16), .b(new_n46_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x15), .c(new_n53_), .O(z15));
  aoi21  g35(.a(new_n61_), .b(x15), .c(new_n53_), .O(z16));
  inv1   g36(.a(x18), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x15), .c(new_n53_), .O(z17));
