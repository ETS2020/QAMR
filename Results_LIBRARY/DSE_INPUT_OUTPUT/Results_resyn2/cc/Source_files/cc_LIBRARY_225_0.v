...
module FAU ( 
  ...
  nor2   g02(.a(x18), .b(x11), .O(new_n44_));
  ...
  nor2   g30(.a(new_n44_), .b(new_n55_), .O(new_n72_));
  ...
  oai21  g43(.a(new_n78_), .b(new_n84_), .c(new_n51_), .O(new_n85_));
  ...
  nand2  g53(.a(new_n52_), .b(new_n61_), .O(new_n95_));
  ...
  aoi21  g59(.a(new_n52_), .b(new_n100_), .c(new_n55_), .O(new_n101_));
  ...
  aoi21  g64(.a(new_n52_), .b(new_n58_), .c(new_n55_), .O(new_n106_));
  ...
  nand3  g70(.a(new_n111_), .b(new_n110_), .c(new_n72_), .O(new_n112_));
