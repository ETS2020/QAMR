...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n59_, new_n60_, new_n63_, new_n65_, new_n70_, new_n71_, new_n72_,
  ...
  aoi21  g09(.a(new_n50_), .b(new_n44_), .c(new_n43_), .O(z01));
  ...
  nand2  g37(.a(new_n43_), .b(new_n78_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n49_), .O(new_n80_));
  aoi21  g39(.a(x17), .b(x15), .c(new_n48_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n60_), .c(new_n54_), .O(z13));
  nand2  g42(.a(new_n59_), .b(new_n52_), .O(new_n84_));
  nand2  g43(.a(new_n53_), .b(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n54_), .O(z14));
  oai21  g45(.a(new_n58_), .b(new_n65_), .c(new_n44_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand4  g47(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n89_));
  nand3  g48(.a(new_n52_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  nand4  g61(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n103_));
  ...
  nand2  g74(.a(new_n52_), .b(x20), .O(new_n116_));
