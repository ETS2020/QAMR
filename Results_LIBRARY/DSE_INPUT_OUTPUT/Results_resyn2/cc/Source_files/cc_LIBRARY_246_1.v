...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n54_, new_n55_, new_n58_, new_n60_, new_n62_,
  ...
  nand3  g29(.a(new_n48_), .b(new_n44_), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g35(.a(new_n48_), .b(new_n50_), .c(x15), .O(new_n77_));
  ...
  aoi21  g40(.a(new_n44_), .b(x02), .c(new_n81_), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n44_), .c(new_n82_), .O(z14));
  oai21  g42(.a(new_n64_), .b(x14), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x15), .O(new_n85_));
  nand2  g44(.a(new_n44_), .b(x03), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n48_), .O(new_n87_));
  oai21  g46(.a(new_n64_), .b(x14), .c(new_n73_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n85_), .O(z15));
  oai21  g49(.a(new_n73_), .b(x04), .c(x12), .O(new_n91_));
  nor2   g50(.a(x17), .b(new_n50_), .O(new_n92_));
  aoi22  g51(.a(new_n92_), .b(new_n54_), .c(new_n91_), .d(new_n44_), .O(z16));
  inv1   g52(.a(x05), .O(new_n94_));
  nand3  g53(.a(new_n48_), .b(new_n44_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g59(.a(new_n48_), .b(new_n44_), .c(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n73_), .b(x15), .c(new_n60_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z18));
  inv1   g63(.a(x07), .O(new_n105_));
  nand3  g64(.a(new_n48_), .b(new_n44_), .c(new_n105_), .O(new_n106_));
