...
module FAU ( 
  ...
  nand2  g06(.a(new_n47_), .b(x05), .O(new_n48_));
  ...
  nor2   g18(.a(x18), .b(x05), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n45_), .b(new_n61_), .O(z05));
  inv1   g21(.a(x15), .O(new_n63_));
  nand2  g22(.a(new_n48_), .b(new_n63_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n48_), .b(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n48_), .b(new_n67_), .O(z08));
  nand2  g27(.a(x09), .b(x08), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n45_), .O(z09));
  and2   g29(.a(new_n69_), .b(new_n48_), .O(z10));
  nand2  g30(.a(new_n48_), .b(new_n49_), .O(z11));
  inv1   g31(.a(x00), .O(new_n73_));
  nand4  g32(.a(new_n63_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  aoi21  g33(.a(new_n47_), .b(x05), .c(new_n58_), .O(new_n75_));
  inv1   g34(.a(x13), .O(new_n76_));
  oai21  g35(.a(new_n54_), .b(x15), .c(new_n76_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z12));
  nand2  g38(.a(new_n50_), .b(new_n49_), .O(new_n80_));
  nand4  g39(.a(new_n63_), .b(x10), .c(x08), .d(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n80_), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n48_), .O(z13));
  nand3  g42(.a(x10), .b(x08), .c(x02), .O(new_n84_));
  nand3  g43(.a(new_n50_), .b(new_n48_), .c(x12), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n63_), .c(new_n85_), .O(z14));
  nand2  g45(.a(new_n48_), .b(x12), .O(new_n87_));
  ...
  oai21  g52(.a(new_n54_), .b(x15), .c(new_n65_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n75_), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z16));
  nor2   g55(.a(new_n47_), .b(x12), .O(new_n97_));
  nand2  g56(.a(new_n88_), .b(x18), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n44_), .c(new_n97_), .O(z17));
  inv1   g58(.a(x06), .O(new_n100_));
  nand4  g59(.a(new_n63_), .b(x10), .c(x08), .d(new_n100_), .O(new_n101_));
  oai21  g60(.a(new_n54_), .b(x15), .c(new_n61_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n101_), .c(new_n75_), .O(new_n103_));
