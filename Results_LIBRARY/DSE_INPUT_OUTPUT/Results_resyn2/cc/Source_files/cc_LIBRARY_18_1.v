...
module FAU ( 
  ...
  nor2   g19(.a(new_n45_), .b(new_n53_), .O(z06));
  ...
  oai21  g36(.a(new_n73_), .b(new_n77_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n49_), .c(new_n57_), .O(z13));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n73_), .b(new_n80_), .c(new_n53_), .O(new_n81_));
  ...
  nand4  g44(.a(new_n53_), .b(x10), .c(x08), .d(new_n85_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  aoi21  g46(.a(new_n84_), .b(new_n54_), .c(new_n87_), .O(z15));
  inv1   g47(.a(x04), .O(new_n89_));
  nand4  g48(.a(new_n53_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g49(.a(new_n73_), .b(x15), .c(new_n62_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z16));
  oai21  g52(.a(new_n54_), .b(new_n57_), .c(x18), .O(new_n94_));
  nor2   g53(.a(new_n73_), .b(x15), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(x12), .c(x05), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n94_), .O(z17));
  inv1   g56(.a(x06), .O(new_n98_));
  nand4  g57(.a(new_n53_), .b(x10), .c(x08), .d(new_n98_), .O(new_n99_));
  oai21  g58(.a(new_n73_), .b(x15), .c(new_n59_), .O(new_n100_));
