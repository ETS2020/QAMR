...
module FAU ( 
  ...
  nor3   g15(.a(new_n56_), .b(new_n44_), .c(new_n50_), .O(z03));
  ...
  nand2  g51(.a(new_n51_), .b(new_n60_), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n104_), .b(x12), .c(new_n102_), .O(new_n105_));
  oai21  g64(.a(new_n69_), .b(x15), .c(new_n102_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x12), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(x06), .c(new_n105_), .O(z18));
