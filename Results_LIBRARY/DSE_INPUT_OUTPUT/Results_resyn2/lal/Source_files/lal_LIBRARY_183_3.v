...
module FAU ( 
  ...
  nand2  g23(.a(new_n50_), .b(new_n68_), .O(new_n69_));
  ...
  inv1   g32(.a(new_n69_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(x14), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z06));
  nand2  g35(.a(new_n78_), .b(x06), .O(z07));
  aoi21  g36(.a(new_n61_), .b(new_n53_), .c(new_n49_), .O(z08));
  inv1   g37(.a(x07), .O(new_n83_));
  nand4  g38(.a(new_n48_), .b(new_n83_), .c(x05), .d(x04), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z09));
  nand2  g40(.a(new_n63_), .b(new_n48_), .O(new_n86_));
  ...
  nor3   g50(.a(new_n95_), .b(new_n94_), .c(new_n86_), .O(z12));
  nand2  g51(.a(x15), .b(new_n47_), .O(new_n97_));
  nand2  g52(.a(new_n94_), .b(new_n54_), .O(new_n98_));
  nand2  g53(.a(new_n93_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n63_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n97_), .O(z13));
  nand2  g57(.a(new_n98_), .b(x21), .O(new_n103_));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n94_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n63_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n97_), .O(z14));
  nand2  g63(.a(new_n105_), .b(x22), .O(new_n109_));
  inv1   g64(.a(x22), .O(new_n110_));
  nor3   g65(.a(new_n93_), .b(x21), .c(x20), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n63_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n48_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n97_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n104_), .c(new_n94_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n87_), .O(z16));
  ...
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n63_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n97_), .O(z17));
  aoi21  g80(.a(new_n122_), .b(x25), .c(new_n86_), .O(new_n126_));
