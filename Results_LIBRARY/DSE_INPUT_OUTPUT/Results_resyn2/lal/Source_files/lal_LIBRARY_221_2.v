...
module FAU ( 
  ...
  nand2  g46(.a(new_n88_), .b(new_n57_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n83_), .c(new_n50_), .O(z12));
  ...
  oai21  g53(.a(new_n91_), .b(x15), .c(x20), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(z13));
  nand2  g55(.a(new_n96_), .b(x21), .O(new_n101_));
  inv1   g56(.a(x21), .O(new_n102_));
  nand3  g57(.a(new_n95_), .b(new_n102_), .c(new_n54_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n84_), .O(z14));
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n84_), .O(z15));
  oai21  g63(.a(x23), .b(x15), .c(x20), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand4  g65(.a(new_n106_), .b(new_n95_), .c(new_n110_), .d(new_n54_), .O(new_n111_));
  nand2  g66(.a(new_n106_), .b(new_n95_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(x23), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n63_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n48_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n109_), .O(z16));
  nand2  g71(.a(new_n111_), .b(x24), .O(new_n117_));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n106_), .c(new_n95_), .d(new_n54_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n84_), .O(z17));
  oai21  g75(.a(x25), .b(x15), .c(x20), .O(new_n121_));
  nor2   g76(.a(new_n119_), .b(x25), .O(new_n122_));
  inv1   g77(.a(x22), .O(new_n123_));
  inv1   g78(.a(x24), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n110_), .c(new_n123_), .d(new_n102_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n91_), .c(x25), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n63_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n122_), .c(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n121_), .O(z18));
endmodule
