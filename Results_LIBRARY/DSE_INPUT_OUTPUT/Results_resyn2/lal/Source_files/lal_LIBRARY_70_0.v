...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n74_, new_n77_, new_n78_, new_n80_, new_n82_, new_n83_, new_n84_,
  ...
  nand3  g18(.a(new_n58_), .b(new_n49_), .c(new_n50_), .O(z08));
  ...
  aoi21  g33(.a(new_n78_), .b(x14), .c(x15), .O(z09));
  nand2  g34(.a(new_n60_), .b(new_n52_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(x14), .c(x15), .O(z10));
  nor2   g36(.a(x18), .b(x17), .O(new_n82_));
  inv1   g37(.a(x15), .O(new_n83_));
  nand3  g38(.a(new_n60_), .b(new_n83_), .c(x14), .O(new_n84_));
  nor2   g39(.a(new_n53_), .b(new_n52_), .O(new_n85_));
  nor3   g40(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(z11));
  oai21  g41(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(new_n87_));
  nand2  g42(.a(new_n85_), .b(x19), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n87_), .c(new_n60_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(x14), .c(x15), .O(z12));
  nand2  g45(.a(new_n88_), .b(x20), .O(new_n91_));
  nand4  g46(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n60_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(x14), .O(new_n94_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n96_), .c(new_n60_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x14), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n83_), .O(z14));
  inv1   g57(.a(new_n84_), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nor2   g59(.a(new_n92_), .b(x21), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g61(.a(new_n99_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n103_), .O(z15));
  inv1   g63(.a(x23), .O(new_n109_));
  nand3  g64(.a(new_n105_), .b(new_n109_), .c(new_n104_), .O(new_n110_));
  nand2  g65(.a(new_n106_), .b(x23), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n103_), .O(z16));
  nand2  g67(.a(new_n110_), .b(x24), .O(new_n113_));
  inv1   g68(.a(x24), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n109_), .c(new_n104_), .d(new_n97_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n98_), .c(new_n84_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n113_), .O(z17));
  nand3  g73(.a(new_n116_), .b(new_n98_), .c(new_n50_), .O(new_n119_));
  oai21  g74(.a(new_n115_), .b(new_n92_), .c(x25), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n60_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(x14), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n83_), .O(z18));
endmodule
