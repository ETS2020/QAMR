...
module FAU ( 
  ...
  oai21  g35(.a(new_n80_), .b(new_n53_), .c(new_n49_), .O(z09));
  nand2  g36(.a(new_n79_), .b(new_n53_), .O(new_n82_));
  ...
  nand2  g46(.a(new_n88_), .b(new_n59_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nor3   g48(.a(new_n93_), .b(new_n82_), .c(new_n48_), .O(z12));
  ...
  aoi21  g55(.a(new_n95_), .b(new_n100_), .c(new_n82_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n99_), .c(new_n48_), .O(z14));
  inv1   g57(.a(x22), .O(new_n103_));
  nand3  g58(.a(new_n95_), .b(new_n103_), .c(new_n100_), .O(new_n104_));
  nand2  g59(.a(new_n95_), .b(new_n100_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(x22), .c(new_n82_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n48_), .O(z15));
  nor2   g62(.a(new_n104_), .b(x23), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n104_), .b(x23), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n83_), .O(z16));
  inv1   g66(.a(x24), .O(new_n112_));
  inv1   g67(.a(new_n82_), .O(new_n113_));
  oai22  g68(.a(new_n108_), .b(new_n112_), .c(new_n113_), .d(new_n48_), .O(z17));
  nand2  g69(.a(new_n113_), .b(new_n64_), .O(z18));
endmodule
