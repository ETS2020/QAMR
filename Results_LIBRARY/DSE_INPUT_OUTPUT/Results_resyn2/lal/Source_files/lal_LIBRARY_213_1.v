...
module FAU ( 
  ...
  nand3  g21(.a(new_n58_), .b(new_n48_), .c(new_n50_), .O(z08));
  ...
  nand3  g35(.a(new_n61_), .b(x05), .c(x04), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z09));
  inv1   g37(.a(x15), .O(new_n83_));
  nand2  g38(.a(new_n60_), .b(new_n52_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(x07), .O(z10));
  ...
  aoi21  g43(.a(new_n88_), .b(new_n83_), .c(x07), .O(z11));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n63_), .O(new_n91_));
  aoi21  g46(.a(new_n87_), .b(new_n54_), .c(new_n91_), .O(z12));
