...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n73_, new_n77_, new_n78_, new_n79_, new_n81_, new_n82_, new_n83_,
  ...
  nand2  g00(.a(x15), .b(x07), .O(new_n46_));
  ...
  oai21  g28(.a(new_n73_), .b(x08), .c(new_n46_), .O(z06));
  nand2  g29(.a(new_n50_), .b(x06), .O(z07));
  nand3  g30(.a(new_n60_), .b(new_n46_), .c(new_n52_), .O(z08));
  inv1   g31(.a(x07), .O(new_n77_));
  inv1   g32(.a(x15), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(new_n46_), .c(new_n62_), .O(z09));
  nand2  g35(.a(new_n62_), .b(new_n78_), .O(new_n81_));
  ...
  nand2  g43(.a(new_n86_), .b(new_n56_), .O(new_n89_));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(new_n81_), .c(new_n46_), .O(z12));
  inv1   g47(.a(new_n46_), .O(new_n93_));
  nor2   g48(.a(new_n90_), .b(x20), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(new_n95_));
  aoi21  g50(.a(new_n90_), .b(x20), .c(new_n81_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(z13));
  nand2  g52(.a(new_n95_), .b(x21), .O(new_n98_));
  inv1   g53(.a(x21), .O(new_n99_));
  nand2  g54(.a(new_n94_), .b(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n82_), .O(z14));
  ...
  nand3  g66(.a(new_n111_), .b(new_n103_), .c(new_n94_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n82_), .O(z17));
  aoi21  g68(.a(new_n112_), .b(x25), .c(new_n81_), .O(new_n114_));
