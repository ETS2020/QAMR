...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n78_, new_n81_, new_n85_, new_n86_, new_n88_, new_n90_, new_n91_,
  ...
  oai21  g21(.a(new_n50_), .b(new_n66_), .c(new_n63_), .O(new_n67_));
  inv1   g22(.a(x25), .O(new_n68_));
  inv1   g23(.a(new_n47_), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g25(.a(new_n67_), .b(x24), .c(new_n70_), .O(z03));
  nand2  g26(.a(new_n69_), .b(new_n46_), .O(new_n72_));
  ...
  nand2  g36(.a(new_n81_), .b(new_n69_), .O(z06));
  ...
  nand2  g41(.a(new_n86_), .b(new_n69_), .O(z09));
  nand2  g42(.a(new_n85_), .b(new_n57_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(x17), .c(new_n69_), .O(z10));
  inv1   g44(.a(new_n65_), .O(new_n90_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n91_), .O(z15));
  nand2  g66(.a(new_n88_), .b(new_n69_), .O(new_n112_));
  nand4  g67(.a(new_n109_), .b(new_n100_), .c(x24), .d(new_n63_), .O(new_n113_));
  ...
  nand3  g72(.a(new_n95_), .b(new_n69_), .c(new_n68_), .O(z18));
endmodule
