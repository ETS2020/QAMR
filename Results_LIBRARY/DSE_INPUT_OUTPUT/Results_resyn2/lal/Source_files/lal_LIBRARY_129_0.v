...
module FAU ( 
  ...
  aoi21  g24(.a(new_n69_), .b(new_n57_), .c(x20), .O(new_n70_));
  inv1   g25(.a(x24), .O(new_n71_));
  nor2   g26(.a(new_n71_), .b(x23), .O(new_n72_));
  oai21  g27(.a(new_n60_), .b(new_n70_), .c(new_n72_), .O(new_n73_));
  nand2  g28(.a(new_n71_), .b(x12), .O(new_n74_));
  ...
  oai21  g44(.a(new_n88_), .b(new_n71_), .c(new_n89_), .O(z08));
  nor3   g45(.a(new_n48_), .b(x15), .c(x07), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n66_), .O(new_n92_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n91_), .c(new_n65_), .d(new_n97_), .O(new_n99_));
  ...
  nor2   g59(.a(new_n104_), .b(new_n101_), .O(z12));
  nor2   g60(.a(new_n102_), .b(x20), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  aoi21  g62(.a(new_n102_), .b(x20), .c(new_n95_), .O(new_n108_));
  ...
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n95_), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(new_n110_), .c(new_n48_), .O(z14));
  nand2  g69(.a(new_n112_), .b(new_n111_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x22), .O(new_n116_));
  inv1   g71(.a(x22), .O(new_n117_));
  nand3  g72(.a(new_n112_), .b(new_n111_), .c(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n91_), .d(new_n65_), .O(z15));
  nor3   g74(.a(x22), .b(x21), .c(x20), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n111_), .c(new_n52_), .O(new_n121_));
  ...
  nand4  g81(.a(new_n126_), .b(new_n120_), .c(new_n111_), .d(x12), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n124_), .O(z17));
  nor2   g83(.a(x22), .b(x21), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n126_), .c(new_n106_), .d(new_n53_), .O(new_n130_));
  nand3  g85(.a(new_n129_), .b(new_n126_), .c(new_n106_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(x25), .O(new_n132_));
  aoi21  g87(.a(new_n53_), .b(x24), .c(x12), .O(new_n133_));
