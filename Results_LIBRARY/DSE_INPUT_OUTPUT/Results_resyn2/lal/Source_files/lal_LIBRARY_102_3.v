...
module FAU ( 
  ...
  nand2  g50(.a(new_n95_), .b(new_n52_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  nor2   g52(.a(x18), .b(x17), .O(new_n98_));
  nand2  g53(.a(x18), .b(x17), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nor3   g55(.a(new_n100_), .b(new_n94_), .c(new_n98_), .O(z11));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n99_), .b(new_n54_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(new_n93_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(z12));
  nand2  g60(.a(new_n102_), .b(x20), .O(new_n106_));
  inv1   g61(.a(new_n102_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n51_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n95_), .O(z13));
  nor2   g64(.a(new_n102_), .b(x21), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n51_), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(x21), .c(new_n92_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n81_), .O(z14));
  inv1   g68(.a(x22), .O(new_n114_));
  nand3  g69(.a(new_n110_), .b(new_n114_), .c(new_n51_), .O(new_n115_));
  aoi21  g70(.a(new_n111_), .b(x22), .c(new_n92_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(new_n81_), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  nor3   g73(.a(new_n102_), .b(x22), .c(x21), .O(new_n119_));
  xor2a  g74(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nor2   g75(.a(new_n118_), .b(new_n51_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n92_), .c(new_n47_), .O(new_n122_));
  oai21  g77(.a(new_n120_), .b(x20), .c(new_n122_), .O(z16));
  nand2  g78(.a(new_n119_), .b(new_n118_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(x24), .O(new_n125_));
  nor3   g80(.a(x24), .b(x23), .c(x20), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n119_), .O(new_n127_));
  oai21  g82(.a(x24), .b(x14), .c(x20), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n127_), .c(new_n125_), .d(new_n93_), .O(z17));
  nand3  g84(.a(new_n126_), .b(new_n119_), .c(new_n50_), .O(new_n130_));
  oai21  g85(.a(new_n81_), .b(x25), .c(new_n127_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n130_), .c(new_n93_), .O(z18));
endmodule
