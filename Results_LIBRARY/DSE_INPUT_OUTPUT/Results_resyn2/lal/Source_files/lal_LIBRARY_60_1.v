...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n61_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_, new_n71_,
    new_n72_, new_n75_, new_n78_, new_n80_, new_n81_, new_n82_, new_n84_,
  ...
  oai21  g16(.a(new_n61_), .b(x15), .c(new_n47_), .O(z01));
  ...
  aoi21  g33(.a(new_n59_), .b(new_n78_), .c(x07), .O(z09));
  nand3  g34(.a(new_n59_), .b(new_n78_), .c(new_n47_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n52_), .O(new_n82_));
  ...
  nor2   g45(.a(new_n87_), .b(x20), .O(new_n91_));
  nand2  g46(.a(new_n87_), .b(x20), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n59_), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n91_), .c(new_n78_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n47_), .O(z13));
  oai21  g50(.a(new_n87_), .b(x20), .c(x21), .O(new_n96_));
  inv1   g51(.a(x21), .O(new_n97_));
  nand2  g52(.a(new_n91_), .b(new_n97_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n96_), .c(new_n81_), .O(z14));
  nand2  g54(.a(new_n98_), .b(x22), .O(new_n100_));
  inv1   g55(.a(x22), .O(new_n101_));
  nand3  g56(.a(new_n91_), .b(new_n101_), .c(new_n97_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n81_), .O(z15));
  nand2  g58(.a(new_n102_), .b(x23), .O(new_n104_));
  inv1   g59(.a(x23), .O(new_n105_));
  nand4  g60(.a(new_n91_), .b(new_n105_), .c(new_n101_), .d(new_n97_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n59_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(z16));
  nand2  g64(.a(new_n106_), .b(x24), .O(new_n110_));
  inv1   g65(.a(x24), .O(new_n111_));
  inv1   g66(.a(new_n102_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n105_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n81_), .O(z17));
  nand4  g69(.a(new_n112_), .b(new_n50_), .c(new_n111_), .d(new_n105_), .O(new_n115_));
  nand2  g70(.a(new_n113_), .b(x25), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n81_), .O(z18));
endmodule
