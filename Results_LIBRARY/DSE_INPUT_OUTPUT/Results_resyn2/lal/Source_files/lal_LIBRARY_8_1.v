...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n76_, new_n81_, new_n83_, new_n84_,
  ...
  aoi22  g32(.a(x15), .b(new_n47_), .c(new_n46_), .d(x06), .O(z07));
  nand3  g33(.a(new_n58_), .b(new_n48_), .c(new_n50_), .O(z08));
  aoi21  g34(.a(new_n61_), .b(new_n60_), .c(x07), .O(z09));
  nand2  g35(.a(new_n63_), .b(new_n52_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z10));
  nor2   g37(.a(x18), .b(x17), .O(new_n83_));
  nor2   g38(.a(new_n53_), .b(new_n52_), .O(new_n84_));
  nor3   g39(.a(new_n84_), .b(new_n62_), .c(new_n83_), .O(z11));
  nand3  g40(.a(x19), .b(x18), .c(x17), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor2   g42(.a(new_n84_), .b(x19), .O(new_n88_));
  nor3   g43(.a(new_n88_), .b(new_n87_), .c(new_n62_), .O(z12));
  nand4  g44(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n90_));
  nand2  g45(.a(new_n86_), .b(x20), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n61_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n60_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n47_), .O(z13));
  nand2  g49(.a(new_n90_), .b(x21), .O(new_n95_));
  nor2   g50(.a(x21), .b(x20), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n87_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n95_), .c(new_n61_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n60_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n47_), .O(z14));
  nand2  g55(.a(new_n97_), .b(x22), .O(new_n101_));
  inv1   g56(.a(x22), .O(new_n102_));
  nand3  g57(.a(new_n96_), .b(new_n87_), .c(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n63_), .O(z15));
  nand2  g59(.a(new_n103_), .b(x23), .O(new_n105_));
  nor2   g60(.a(x23), .b(x22), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n96_), .c(new_n87_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n61_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n60_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n47_), .O(z16));
  nor2   g65(.a(x24), .b(x21), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n106_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n90_), .c(new_n61_), .O(new_n113_));
  aoi21  g68(.a(new_n107_), .b(x24), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n47_), .O(z17));
  nor2   g70(.a(new_n112_), .b(new_n90_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n50_), .O(new_n117_));
  oai21  g72(.a(new_n112_), .b(new_n90_), .c(x25), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n63_), .O(z18));
endmodule
