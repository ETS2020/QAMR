...
module FAU ( 
  ...
  aoi21  g56(.a(new_n98_), .b(new_n59_), .c(new_n93_), .O(new_n102_));
  ...
  aoi21  g61(.a(new_n101_), .b(x20), .c(new_n93_), .O(new_n107_));
  ...
  nand3  g72(.a(new_n116_), .b(x24), .c(x23), .O(new_n118_));
  nand2  g73(.a(new_n93_), .b(new_n49_), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n110_), .c(new_n105_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(z16));
  inv1   g77(.a(x24), .O(new_n123_));
  inv1   g78(.a(new_n121_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g80(.a(new_n121_), .b(x24), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n119_), .O(z17));
  inv1   g82(.a(new_n116_), .O(new_n128_));
  nand2  g83(.a(new_n55_), .b(x24), .O(new_n129_));
  nand2  g84(.a(x25), .b(new_n123_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand2  g86(.a(new_n116_), .b(x25), .O(new_n132_));
  aoi21  g87(.a(new_n129_), .b(x23), .c(new_n93_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(z18));
endmodule
