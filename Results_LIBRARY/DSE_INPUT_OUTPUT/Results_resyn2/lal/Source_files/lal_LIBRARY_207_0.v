...
module FAU ( 
  ...
  inv1   g19(.a(z11), .O(z17));
  nand3  g20(.a(new_n59_), .b(z17), .c(new_n51_), .O(new_n66_));
  ...
  nand2  g28(.a(z17), .b(new_n46_), .O(new_n74_));
  aoi21  g29(.a(new_n73_), .b(new_n70_), .c(new_n74_), .O(z04));
  oai21  g30(.a(x13), .b(x08), .c(z17), .O(z05));
  nand2  g31(.a(x14), .b(new_n46_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(z17), .O(z06));
  aoi21  g33(.a(new_n46_), .b(x06), .c(z11), .O(z07));
  aoi21  g34(.a(new_n59_), .b(new_n51_), .c(z11), .O(z08));
  zero   g35(.O(z09));
  zero   g36(.O(z10));
  zero   g37(.O(z12));
  one    g38(.O(z13));
