...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n79_, new_n80_, new_n83_, new_n86_, new_n87_, new_n89_, new_n90_,
    ...
    new_n123_, new_n124_, new_n125_, new_n127_;
  inv1   g00(.a(x16), .O(new_n46_));
  inv1   g01(.a(x08), .O(new_n47_));
  nor2   g02(.a(x15), .b(new_n47_), .O(new_n48_));
  nand2  g03(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  inv1   g04(.a(new_n49_), .O(z00));
  inv1   g05(.a(x15), .O(new_n51_));
  nor2   g06(.a(new_n51_), .b(new_n47_), .O(new_n52_));
  ...
  aoi21  g18(.a(new_n63_), .b(new_n62_), .c(new_n52_), .O(z01));
  nor2   g19(.a(new_n52_), .b(new_n46_), .O(z02));
  aoi21  g20(.a(new_n61_), .b(new_n53_), .c(new_n52_), .O(z08));
  inv1   g21(.a(z08), .O(z03));
  inv1   g22(.a(x11), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(x02), .O(new_n69_));
  inv1   g24(.a(x00), .O(new_n70_));
  inv1   g25(.a(x01), .O(new_n71_));
  aoi22  g26(.a(x10), .b(new_n71_), .c(x09), .d(new_n70_), .O(new_n72_));
  nand2  g27(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(new_n74_));
  oai21  g29(.a(new_n68_), .b(x02), .c(new_n47_), .O(new_n75_));
  inv1   g30(.a(x03), .O(new_n76_));
  oai22  g31(.a(x12), .b(new_n76_), .c(x09), .d(new_n70_), .O(new_n77_));
  inv1   g32(.a(x12), .O(new_n78_));
  oai22  g33(.a(new_n78_), .b(x03), .c(x10), .d(new_n71_), .O(new_n79_));
  nor3   g34(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n74_), .c(new_n48_), .O(z04));
  nor2   g36(.a(x13), .b(x08), .O(z05));
  nor2   g37(.a(x14), .b(x08), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(new_n48_), .O(z06));
  nand2  g39(.a(new_n47_), .b(x06), .O(z07));
  inv1   g40(.a(x07), .O(new_n86_));
  nand4  g41(.a(new_n51_), .b(new_n86_), .c(x05), .d(x04), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand2  g43(.a(new_n63_), .b(new_n51_), .O(new_n89_));
  ...
  nand2  g54(.a(x15), .b(new_n47_), .O(new_n100_));
  nand2  g55(.a(new_n97_), .b(new_n54_), .O(new_n101_));
  nand2  g56(.a(new_n96_), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n63_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n51_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n100_), .O(z13));
  ...
  nor3   g66(.a(new_n96_), .b(x21), .c(x20), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n63_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n51_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n100_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n107_), .c(new_n97_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n90_), .O(z16));
  nand2  g75(.a(new_n119_), .b(x24), .O(new_n121_));
  inv1   g76(.a(x24), .O(new_n122_));
  nand3  g77(.a(new_n118_), .b(new_n112_), .c(new_n122_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n63_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n51_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n100_), .O(z17));
  aoi21  g81(.a(new_n123_), .b(x25), .c(new_n89_), .O(new_n127_));
  oai21  g82(.a(new_n123_), .b(x25), .c(new_n127_), .O(z18));
endmodule
