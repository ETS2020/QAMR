...
module FAU ( 
  ...
  nand3  g36(.a(new_n64_), .b(new_n81_), .c(new_n48_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z09));
  nand2  g38(.a(new_n65_), .b(new_n81_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n55_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  nand2  g42(.a(new_n56_), .b(new_n55_), .O(new_n88_));
  nand2  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n63_), .c(new_n88_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n48_), .c(x15), .O(z11));
  nand2  g46(.a(new_n89_), .b(new_n57_), .O(new_n92_));
  nand3  g47(.a(x19), .b(x18), .c(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n63_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n48_), .c(x15), .O(z12));
  ...
  nor2   g55(.a(new_n96_), .b(new_n100_), .O(new_n101_));
  oai21  g56(.a(new_n97_), .b(x21), .c(new_n63_), .O(new_n102_));
  oai21  g57(.a(new_n102_), .b(new_n101_), .c(new_n48_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n81_), .O(z14));
  inv1   g59(.a(x22), .O(new_n105_));
  aoi21  g60(.a(new_n96_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  ...
  nand2  g65(.a(new_n110_), .b(new_n81_), .O(z15));
  inv1   g66(.a(x23), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(new_n96_), .c(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n107_), .b(new_n96_), .c(new_n112_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n63_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n113_), .c(new_n48_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n81_), .O(z16));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n107_), .c(new_n96_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n63_), .O(new_n120_));
  aoi21  g75(.a(new_n114_), .b(x24), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x07), .c(new_n81_), .O(z17));
  nand4  g77(.a(new_n118_), .b(new_n107_), .c(new_n96_), .d(new_n53_), .O(new_n123_));
  nand2  g78(.a(new_n119_), .b(x25), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n63_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n81_), .O(z18));
endmodule
