...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n79_, new_n81_, new_n83_, new_n85_, new_n86_, new_n87_, new_n89_,
  ...
  nand3  g14(.a(new_n59_), .b(new_n57_), .c(x24), .O(new_n60_));
  nand3  g15(.a(new_n60_), .b(new_n51_), .c(new_n50_), .O(new_n61_));
  ...
  nor2   g21(.a(new_n51_), .b(x23), .O(new_n67_));
  nor2   g22(.a(x18), .b(x17), .O(new_n68_));
  aoi21  g23(.a(new_n68_), .b(new_n55_), .c(x20), .O(new_n69_));
  oai21  g24(.a(new_n58_), .b(new_n69_), .c(new_n50_), .O(new_n70_));
  aoi21  g25(.a(new_n70_), .b(x24), .c(new_n67_), .O(z03));
  ...
  inv1   g37(.a(new_n48_), .O(new_n83_));
  aoi21  g38(.a(new_n46_), .b(x06), .c(new_n83_), .O(z07));
  inv1   g39(.a(new_n67_), .O(new_n85_));
  aoi21  g40(.a(new_n56_), .b(new_n52_), .c(new_n58_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(x23), .c(x24), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n85_), .O(z08));
  nor2   g43(.a(x15), .b(x07), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n63_), .c(new_n48_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand2  g46(.a(new_n89_), .b(new_n62_), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(x17), .c(new_n48_), .O(z10));
  inv1   g48(.a(new_n68_), .O(new_n94_));
  ...
  nand3  g52(.a(new_n89_), .b(new_n62_), .c(new_n48_), .O(new_n98_));
  ...
  inv1   g57(.a(new_n98_), .O(new_n103_));
  inv1   g58(.a(new_n99_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n52_), .O(new_n105_));
  nand2  g60(.a(new_n99_), .b(x20), .O(new_n106_));
  ...
  aoi21  g65(.a(new_n110_), .b(new_n108_), .c(new_n83_), .O(z14));
  ...
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n103_), .O(z15));
  inv1   g71(.a(new_n92_), .O(new_n117_));
  oai21  g72(.a(new_n115_), .b(new_n47_), .c(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n109_), .c(new_n104_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(z16));
  nand2  g76(.a(new_n92_), .b(new_n48_), .O(new_n122_));
  inv1   g77(.a(new_n120_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n120_), .b(x24), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n122_), .O(z17));
  inv1   g81(.a(new_n115_), .O(new_n127_));
  nand2  g82(.a(new_n51_), .b(x24), .O(new_n128_));
  nand2  g83(.a(x25), .b(new_n47_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nand2  g85(.a(new_n115_), .b(x25), .O(new_n131_));
  aoi21  g86(.a(new_n128_), .b(x23), .c(new_n92_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n131_), .c(new_n130_), .O(z18));
endmodule
