...
module FAU ( 
  ...
  nor2   g21(.a(new_n48_), .b(x25), .O(new_n67_));
  nand3  g22(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(new_n55_), .O(z01));
  inv1   g24(.a(x25), .O(new_n70_));
  nor2   g25(.a(new_n48_), .b(new_n70_), .O(new_n71_));
  nor2   g26(.a(x18), .b(x17), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(new_n60_), .c(x20), .O(new_n73_));
  oai21  g28(.a(new_n63_), .b(new_n73_), .c(new_n56_), .O(new_n74_));
  ...
  aoi21  g43(.a(new_n61_), .b(new_n57_), .c(new_n63_), .O(new_n89_));
  ...
  nand2  g48(.a(new_n93_), .b(new_n49_), .O(z09));
  nand2  g49(.a(new_n92_), .b(new_n53_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(new_n48_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n58_), .O(new_n97_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n96_), .O(z14));
  inv1   g69(.a(x22), .O(new_n115_));
  nand3  g70(.a(new_n112_), .b(new_n107_), .c(new_n115_), .O(new_n116_));
  aoi21  g71(.a(new_n113_), .b(x22), .c(new_n95_), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(new_n116_), .c(new_n48_), .O(z15));
  nand4  g73(.a(new_n112_), .b(new_n107_), .c(new_n56_), .d(new_n115_), .O(new_n119_));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n96_), .O(z16));
  nand2  g76(.a(new_n119_), .b(x24), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n96_), .O(z17));
  nand2  g78(.a(new_n96_), .b(new_n70_), .O(z18));
endmodule
