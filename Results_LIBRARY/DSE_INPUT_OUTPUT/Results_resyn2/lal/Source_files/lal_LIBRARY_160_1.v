...
module FAU ( 
  ...
  oai21  g27(.a(new_n71_), .b(x03), .c(new_n72_), .O(new_n73_));
  inv1   g28(.a(x11), .O(new_n74_));
  oai22  g29(.a(new_n74_), .b(x02), .c(x09), .d(new_n67_), .O(new_n75_));
  nand2  g30(.a(new_n71_), .b(x03), .O(new_n76_));
  ...
  aoi21  g34(.a(new_n79_), .b(new_n70_), .c(x08), .O(z04));
  aoi21  g35(.a(new_n72_), .b(x13), .c(x08), .O(z05));
  nand3  g36(.a(new_n72_), .b(x14), .c(new_n46_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z06));
  oai21  g38(.a(x24), .b(x06), .c(new_n46_), .O(z07));
  inv1   g39(.a(new_n47_), .O(new_n85_));
  aoi21  g40(.a(new_n57_), .b(new_n49_), .c(new_n85_), .O(z08));
  nor2   g41(.a(x15), .b(x07), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n60_), .c(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand2  g44(.a(new_n87_), .b(new_n59_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x17), .c(new_n47_), .O(z10));
  nand2  g46(.a(new_n52_), .b(new_n51_), .O(new_n92_));
  ...
  nand3  g50(.a(new_n87_), .b(new_n59_), .c(new_n47_), .O(new_n96_));
  ...
  nand3  g70(.a(new_n111_), .b(new_n102_), .c(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n101_), .O(z16));
  aoi21  g72(.a(new_n116_), .b(x24), .c(new_n96_), .O(new_n118_));
  oai21  g73(.a(new_n116_), .b(x24), .c(new_n118_), .O(z17));
  nor2   g74(.a(new_n49_), .b(new_n72_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n90_), .c(new_n47_), .O(new_n121_));
  nor2   g76(.a(new_n116_), .b(new_n49_), .O(new_n122_));
  nand2  g77(.a(new_n116_), .b(new_n49_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n72_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n122_), .c(new_n121_), .O(z18));
endmodule
