...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n74_, new_n76_, new_n80_, new_n81_, new_n83_,
  ...
  nand2  g20(.a(new_n60_), .b(new_n48_), .O(z03));
  ...
  aoi21  g32(.a(new_n46_), .b(x06), .c(new_n50_), .O(z07));
  nand3  g33(.a(new_n59_), .b(new_n48_), .c(new_n51_), .O(z08));
  inv1   g34(.a(x07), .O(new_n80_));
  nand3  g35(.a(new_n61_), .b(new_n47_), .c(new_n80_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z09));
  nand2  g37(.a(new_n62_), .b(new_n47_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n53_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z10));
  aoi21  g41(.a(new_n54_), .b(new_n53_), .c(new_n61_), .O(new_n87_));
  oai21  g42(.a(new_n54_), .b(new_n53_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n80_), .c(x15), .O(z11));
  ...
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n84_), .O(z17));
  nand4  g67(.a(new_n110_), .b(new_n98_), .c(new_n51_), .d(new_n102_), .O(new_n113_));
  nand2  g68(.a(new_n111_), .b(x25), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n84_), .O(z18));
endmodule
