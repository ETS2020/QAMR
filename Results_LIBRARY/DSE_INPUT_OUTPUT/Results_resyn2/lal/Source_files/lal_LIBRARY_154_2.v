...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n76_, new_n81_, new_n82_, new_n83_,
  ...
  aoi22  g33(.a(new_n58_), .b(new_n50_), .c(new_n47_), .d(x07), .O(z08));
  ...
  nor2   g40(.a(new_n53_), .b(new_n52_), .O(new_n86_));
  ...
  aoi21  g56(.a(new_n101_), .b(new_n92_), .c(new_n81_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n100_), .O(z15));
  inv1   g58(.a(x07), .O(new_n104_));
  inv1   g59(.a(x23), .O(new_n105_));
  aoi21  g60(.a(new_n101_), .b(new_n92_), .c(new_n105_), .O(new_n106_));
  nand2  g61(.a(x05), .b(x04), .O(new_n107_));
  nand3  g62(.a(new_n101_), .b(new_n92_), .c(new_n105_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n106_), .c(new_n104_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(z16));
  nand2  g66(.a(new_n108_), .b(x24), .O(new_n112_));
  nor2   g67(.a(x24), .b(x23), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n101_), .c(new_n89_), .d(new_n51_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n82_), .O(z17));
  nand4  g70(.a(new_n113_), .b(new_n101_), .c(new_n92_), .d(new_n50_), .O(new_n116_));
  nand2  g71(.a(new_n114_), .b(x25), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n107_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n104_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(z18));
endmodule
