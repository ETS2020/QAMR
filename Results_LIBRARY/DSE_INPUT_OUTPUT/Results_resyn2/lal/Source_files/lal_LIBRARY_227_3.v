...
module FAU ( 
  ...
  aoi21  g55(.a(new_n95_), .b(x20), .c(new_n85_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n100_), .c(new_n65_), .O(z13));
  nand2  g57(.a(new_n100_), .b(x21), .O(new_n103_));
  inv1   g58(.a(x21), .O(new_n104_));
  aoi21  g59(.a(new_n99_), .b(new_n104_), .c(new_n85_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n103_), .c(new_n65_), .O(z14));
  ...
  nand3  g66(.a(new_n108_), .b(new_n99_), .c(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(x23), .O(new_n113_));
  inv1   g68(.a(x23), .O(new_n114_));
  nand3  g69(.a(new_n108_), .b(new_n99_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n86_), .O(z16));
  aoi21  g71(.a(new_n115_), .b(x24), .c(new_n85_), .O(new_n117_));
  oai21  g72(.a(new_n115_), .b(x24), .c(new_n117_), .O(z17));
  inv1   g73(.a(new_n115_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n54_), .c(new_n111_), .O(new_n120_));
  nand2  g75(.a(new_n112_), .b(x25), .O(new_n121_));
  oai21  g76(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n86_), .O(z18));
endmodule
