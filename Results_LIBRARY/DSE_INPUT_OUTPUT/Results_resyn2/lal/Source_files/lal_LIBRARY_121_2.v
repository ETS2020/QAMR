...
module FAU ( 
  ...
  nor2   g14(.a(x24), .b(x03), .O(new_n60_));
  aoi21  g15(.a(new_n59_), .b(new_n57_), .c(new_n60_), .O(new_n61_));
  ...
  nand2  g24(.a(new_n57_), .b(new_n69_), .O(new_n70_));
  ...
  nand3  g49(.a(new_n94_), .b(new_n64_), .c(new_n62_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand3  g51(.a(new_n94_), .b(new_n63_), .c(new_n62_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n51_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z10));
  nand2  g55(.a(new_n94_), .b(new_n63_), .O(new_n101_));
  nand2  g56(.a(new_n52_), .b(new_n51_), .O(new_n102_));
  nand2  g57(.a(x18), .b(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n101_), .c(new_n62_), .O(z11));
  nand3  g60(.a(x19), .b(x18), .c(x17), .O(new_n106_));
  aoi21  g61(.a(new_n103_), .b(new_n53_), .c(new_n101_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n62_), .O(z12));
  inv1   g64(.a(new_n106_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n50_), .O(new_n111_));
  nand2  g66(.a(new_n106_), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n98_), .O(z13));
  nand2  g68(.a(new_n111_), .b(x21), .O(new_n114_));
  nor2   g69(.a(x21), .b(x20), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n110_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(new_n101_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n114_), .c(new_n48_), .O(z14));
  nand2  g74(.a(new_n116_), .b(x22), .O(new_n120_));
  inv1   g75(.a(x22), .O(new_n121_));
  aoi21  g76(.a(new_n117_), .b(new_n121_), .c(new_n101_), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(new_n120_), .c(new_n48_), .O(z15));
  oai21  g78(.a(new_n116_), .b(x22), .c(x23), .O(new_n124_));
  nor2   g79(.a(x23), .b(x22), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n115_), .c(new_n110_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n98_), .O(z16));
  nand2  g82(.a(new_n126_), .b(x24), .O(new_n128_));
  nand2  g83(.a(new_n101_), .b(new_n62_), .O(new_n129_));
  inv1   g84(.a(new_n126_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n60_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(z17));
  nand2  g87(.a(new_n126_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n115_), .c(new_n110_), .d(new_n121_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(x25), .b(x24), .O(new_n138_));
  nand3  g93(.a(new_n138_), .b(new_n137_), .c(new_n129_), .O(z18));
endmodule
