...
module FAU ( 
  ...
  nor3   g34(.a(new_n79_), .b(x13), .c(x08), .O(z05));
  nand2  g35(.a(x14), .b(new_n46_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n48_), .O(z06));
  aoi21  g37(.a(new_n46_), .b(x06), .c(new_n79_), .O(z07));
  inv1   g38(.a(new_n67_), .O(new_n84_));
  aoi21  g39(.a(new_n56_), .b(new_n52_), .c(new_n58_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x23), .c(x24), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n84_), .O(z08));
  nor2   g42(.a(x15), .b(x07), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n63_), .c(new_n48_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand3  g45(.a(new_n88_), .b(new_n62_), .c(new_n48_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  nand2  g49(.a(new_n88_), .b(new_n62_), .O(new_n95_));
  inv1   g50(.a(new_n68_), .O(new_n96_));
  nand2  g51(.a(x18), .b(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n95_), .c(new_n48_), .O(z11));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n97_), .b(new_n55_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nor2   g57(.a(new_n102_), .b(new_n91_), .O(z12));
  ...
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(new_n79_), .O(z13));
  nand2  g62(.a(new_n105_), .b(x21), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n104_), .c(new_n95_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n108_), .c(new_n79_), .O(z14));
  ...
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n92_), .O(z15));
  nand3  g71(.a(new_n115_), .b(x24), .c(x23), .O(new_n117_));
  nand2  g72(.a(new_n95_), .b(new_n48_), .O(new_n118_));
  ...
  inv1   g76(.a(new_n95_), .O(new_n122_));
  nand2  g77(.a(new_n115_), .b(x24), .O(new_n123_));
  nor2   g78(.a(x24), .b(x22), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n109_), .c(new_n104_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n122_), .d(new_n50_), .O(z17));
  xor2a  g81(.a(new_n125_), .b(x25), .O(new_n127_));
  oai21  g82(.a(x25), .b(new_n47_), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n127_), .c(new_n122_), .O(z18));
endmodule
