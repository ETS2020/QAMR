...
module FAU ( 
  ...
  oai21  g22(.a(new_n64_), .b(new_n62_), .c(new_n67_), .O(z01));
  inv1   g23(.a(x16), .O(new_n69_));
  nand2  g24(.a(new_n48_), .b(new_n69_), .O(z02));
  nor2   g25(.a(new_n64_), .b(new_n62_), .O(z03));
  ...
  nand2  g38(.a(new_n61_), .b(new_n50_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(x24), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n48_), .c(new_n63_), .O(z08));
  ...
  nor3   g55(.a(new_n100_), .b(new_n99_), .c(new_n90_), .O(z12));
  nand2  g56(.a(new_n99_), .b(new_n52_), .O(new_n102_));
  nand2  g57(.a(new_n98_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(new_n91_), .O(z13));
  nand2  g59(.a(new_n102_), .b(x21), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n91_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  nand3  g64(.a(new_n106_), .b(new_n99_), .c(new_n59_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n87_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n48_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n65_), .O(z15));
  nand4  g68(.a(new_n50_), .b(new_n59_), .c(new_n58_), .d(new_n52_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n98_), .c(new_n87_), .O(new_n115_));
  aoi21  g70(.a(new_n110_), .b(x23), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n47_), .c(new_n65_), .O(z16));
  inv1   g72(.a(x05), .O(new_n118_));
  nand2  g73(.a(new_n51_), .b(new_n50_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n110_), .c(new_n118_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x04), .O(new_n121_));
  inv1   g76(.a(new_n114_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n99_), .O(new_n123_));
  nor2   g78(.a(new_n87_), .b(new_n47_), .O(new_n124_));
  aoi21  g79(.a(new_n123_), .b(x24), .c(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n121_), .O(z17));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n106_), .c(new_n99_), .d(new_n59_), .O(new_n128_));
  oai21  g83(.a(new_n114_), .b(new_n98_), .c(x25), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n128_), .c(new_n118_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x04), .O(new_n131_));
  aoi21  g86(.a(x25), .b(x24), .c(new_n124_), .O(new_n132_));
