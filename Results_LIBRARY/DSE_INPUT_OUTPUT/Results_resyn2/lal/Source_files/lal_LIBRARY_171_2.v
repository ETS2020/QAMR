...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n72_, new_n77_, new_n78_, new_n80_, new_n81_, new_n82_, new_n83_,
  ...
  or2    g07(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  ...
  nor2   g16(.a(new_n48_), .b(x25), .O(new_n62_));
  ...
  oai22  g28(.a(x15), .b(new_n47_), .c(x13), .d(x08), .O(z05));
  and2   g29(.a(new_n50_), .b(x14), .O(z06));
  nand2  g30(.a(new_n50_), .b(x06), .O(z07));
  inv1   g31(.a(x07), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(x05), .c(x04), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g34(.a(x15), .O(new_n80_));
  nand3  g35(.a(new_n52_), .b(new_n80_), .c(new_n47_), .O(new_n81_));
  ...
  nand3  g41(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(new_n87_));
  ...
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n52_), .O(new_n91_));
  ...
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n52_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n47_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n80_), .O(z13));
  inv1   g52(.a(x21), .O(new_n98_));
  nor2   g53(.a(new_n90_), .b(x20), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n98_), .c(new_n81_), .O(new_n100_));
  oai21  g55(.a(new_n99_), .b(new_n98_), .c(new_n100_), .O(z14));
  inv1   g56(.a(x22), .O(new_n102_));
  aoi21  g57(.a(new_n99_), .b(new_n98_), .c(new_n102_), .O(new_n103_));
  nor2   g58(.a(x22), .b(x21), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n99_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n52_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n103_), .c(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n80_), .O(z15));
  nand2  g63(.a(new_n105_), .b(x23), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand3  g65(.a(new_n104_), .b(new_n99_), .c(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n82_), .O(z16));
  nand2  g67(.a(new_n111_), .b(x24), .O(new_n113_));
  nor2   g68(.a(x24), .b(x23), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n104_), .c(new_n99_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n82_), .O(z17));
  inv1   g71(.a(x25), .O(new_n117_));
  nand4  g72(.a(new_n114_), .b(new_n104_), .c(new_n99_), .d(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n114_), .b(new_n104_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n93_), .c(x25), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n52_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n80_), .O(z18));
endmodule
