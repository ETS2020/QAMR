...
module FAU ( 
  ...
  nor2   g34(.a(new_n79_), .b(new_n49_), .O(new_n80_));
  aoi21  g35(.a(x05), .b(x04), .c(x15), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(new_n80_), .O(z09));
  nand2  g37(.a(new_n62_), .b(new_n48_), .O(new_n83_));
  ...
  nand2  g48(.a(new_n48_), .b(x07), .O(new_n94_));
  nand4  g49(.a(new_n53_), .b(x19), .c(x18), .d(x17), .O(new_n95_));
  nand2  g50(.a(new_n90_), .b(x20), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n81_), .O(new_n97_));
  ...
  oai21  g60(.a(new_n79_), .b(new_n49_), .c(new_n105_), .O(z14));
  ...
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n84_), .O(z15));
  nand2  g65(.a(new_n109_), .b(x23), .O(new_n111_));
  nor2   g66(.a(x23), .b(x22), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n102_), .c(new_n91_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n81_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n94_), .O(z16));
  nor2   g71(.a(x24), .b(x21), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n112_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n95_), .c(new_n81_), .O(new_n119_));
  aoi21  g74(.a(new_n113_), .b(x24), .c(new_n119_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(x07), .c(new_n94_), .O(z17));
  nor2   g76(.a(new_n118_), .b(new_n95_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n52_), .O(new_n123_));
  oai21  g78(.a(new_n118_), .b(new_n95_), .c(x25), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n84_), .O(z18));
endmodule
