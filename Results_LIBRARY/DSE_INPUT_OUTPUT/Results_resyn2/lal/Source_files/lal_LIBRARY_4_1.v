...
module FAU ( 
  ...
  nand3  g31(.a(new_n61_), .b(new_n50_), .c(new_n53_), .O(z08));
  inv1   g32(.a(x07), .O(new_n78_));
  nand4  g33(.a(new_n48_), .b(new_n78_), .c(x05), .d(x04), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z09));
  nand2  g35(.a(new_n63_), .b(new_n48_), .O(new_n81_));
  ...
  oai21  g42(.a(x15), .b(x04), .c(x05), .O(new_n88_));
  nand2  g43(.a(new_n86_), .b(x19), .O(new_n89_));
  oai21  g44(.a(new_n56_), .b(new_n55_), .c(new_n57_), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n78_), .O(new_n91_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n96_), .c(new_n78_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n88_), .O(z14));
  ...
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n78_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n88_), .O(z15));
  ...
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n82_), .O(z16));
  inv1   g68(.a(x23), .O(new_n114_));
  inv1   g69(.a(x24), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n103_), .d(new_n97_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n94_), .c(new_n78_), .O(new_n117_));
  aoi21  g72(.a(new_n112_), .b(x24), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n88_), .O(z17));
  inv1   g74(.a(new_n116_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n98_), .c(new_n53_), .O(new_n121_));
  oai21  g76(.a(new_n116_), .b(new_n94_), .c(x25), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n78_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n88_), .O(z18));
endmodule
