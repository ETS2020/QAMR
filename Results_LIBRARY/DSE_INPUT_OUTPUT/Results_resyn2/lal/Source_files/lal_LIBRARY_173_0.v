...
module FAU ( 
  ...
  nor3   g42(.a(z10), .b(x13), .c(x08), .O(z05));
  inv1   g43(.a(x14), .O(new_n89_));
  nor3   g44(.a(z10), .b(new_n89_), .c(x08), .O(z06));
  aoi21  g45(.a(new_n46_), .b(x06), .c(z10), .O(z07));
  aoi21  g46(.a(new_n59_), .b(new_n51_), .c(z10), .O(z08));
  zero   g47(.O(z09));
  zero   g48(.O(z11));
  zero   g49(.O(z12));
  one    g50(.O(z15));
  one    g51(.O(z17));
  inv1   g52(.a(z10), .O(z14));
  inv1   g53(.a(z10), .O(z16));
  inv1   g54(.a(z10), .O(z18));
endmodule
