...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n116_, new_n118_, new_n119_, new_n120_, new_n122_;
  ...
  aoi21  g34(.a(new_n79_), .b(x08), .c(new_n78_), .O(z06));
  aoi21  g35(.a(new_n67_), .b(x06), .c(new_n64_), .O(z07));
  nand3  g36(.a(new_n58_), .b(new_n47_), .c(new_n50_), .O(z08));
  inv1   g37(.a(x07), .O(new_n83_));
  nand4  g38(.a(new_n79_), .b(new_n83_), .c(x05), .d(x04), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z09));
  nand2  g40(.a(new_n60_), .b(new_n79_), .O(new_n86_));
  ...
  oai21  g45(.a(new_n90_), .b(new_n86_), .c(new_n47_), .O(z11));
  nand3  g46(.a(x19), .b(x18), .c(x17), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(new_n93_));
  aoi21  g48(.a(x18), .b(x17), .c(x19), .O(new_n94_));
  nor3   g49(.a(new_n94_), .b(new_n93_), .c(new_n86_), .O(z12));
  nand2  g50(.a(x15), .b(new_n78_), .O(new_n96_));
  nand2  g51(.a(new_n93_), .b(new_n51_), .O(new_n97_));
  nand2  g52(.a(new_n92_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n60_), .O(new_n99_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n87_), .O(z14));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n106_));
  inv1   g61(.a(x22), .O(new_n107_));
  nand3  g62(.a(new_n103_), .b(new_n93_), .c(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n60_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n79_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n96_), .O(z15));
  nand2  g66(.a(new_n108_), .b(x23), .O(new_n112_));
  nor2   g67(.a(x23), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n103_), .c(new_n93_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n60_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n79_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n96_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  inv1   g73(.a(x24), .O(new_n119_));
  nand4  g74(.a(new_n113_), .b(new_n103_), .c(new_n93_), .d(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n87_), .O(z17));
  aoi21  g76(.a(new_n120_), .b(x25), .c(new_n86_), .O(new_n122_));
  oai21  g77(.a(new_n120_), .b(x25), .c(new_n122_), .O(z18));
endmodule
