...
module FAU ( 
  ...
  nor2   g15(.a(x23), .b(new_n48_), .O(new_n61_));
  oai21  g16(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(new_n62_));
  oai21  g17(.a(new_n62_), .b(x25), .c(new_n56_), .O(z01));
  inv1   g18(.a(x24), .O(new_n64_));
  nand2  g19(.a(new_n50_), .b(new_n64_), .O(new_n65_));
  aoi21  g20(.a(new_n65_), .b(new_n62_), .c(x25), .O(z03));
  ...
  nand3  g36(.a(new_n57_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  ...
  nand2  g61(.a(new_n106_), .b(new_n79_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n54_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x23), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n48_), .O(z13));
  ...
  aoi21  g71(.a(new_n113_), .b(new_n106_), .c(new_n116_), .O(new_n117_));
  inv1   g72(.a(x21), .O(new_n118_));
  nand3  g73(.a(new_n116_), .b(new_n118_), .c(new_n79_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n101_), .c(new_n54_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n117_), .c(x23), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n48_), .O(z15));
  nor2   g77(.a(new_n119_), .b(new_n101_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n111_), .O(z16));
  oai21  g79(.a(new_n55_), .b(x24), .c(x23), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(z17));
  oai21  g81(.a(new_n55_), .b(x25), .c(x23), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(z18));
endmodule
