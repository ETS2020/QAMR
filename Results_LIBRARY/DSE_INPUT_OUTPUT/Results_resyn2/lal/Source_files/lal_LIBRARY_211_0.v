...
module FAU ( 
  ...
  nand2  g36(.a(new_n68_), .b(x24), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(new_n49_), .c(new_n81_), .O(z08));
  inv1   g38(.a(x15), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n52_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n53_), .c(new_n49_), .O(z09));
  nand3  g41(.a(new_n53_), .b(new_n84_), .c(new_n52_), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(x17), .c(new_n49_), .O(z10));
  xnor2a g43(.a(x18), .b(x17), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(new_n87_), .c(new_n49_), .O(z11));
  ...
  oai21  g49(.a(new_n94_), .b(new_n91_), .c(new_n49_), .O(z12));
  inv1   g50(.a(new_n93_), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n61_), .c(new_n63_), .O(new_n97_));
  aoi21  g52(.a(new_n93_), .b(x20), .c(new_n87_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(z13));
  nand2  g54(.a(new_n87_), .b(new_n49_), .O(new_n100_));
  nand2  g55(.a(new_n97_), .b(x21), .O(new_n101_));
  nand4  g56(.a(new_n96_), .b(x24), .c(new_n57_), .d(new_n63_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(z14));
  nand3  g58(.a(new_n96_), .b(new_n58_), .c(new_n57_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x24), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n63_), .O(new_n106_));
  aoi21  g61(.a(new_n102_), .b(x22), .c(new_n87_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z15));
  oai21  g63(.a(new_n104_), .b(x23), .c(x24), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n63_), .O(new_n110_));
  oai21  g65(.a(new_n102_), .b(x22), .c(x23), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n92_), .O(z16));
  nand2  g67(.a(new_n62_), .b(new_n63_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n104_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n64_), .c(new_n92_), .O(z17));
  nand3  g70(.a(new_n92_), .b(new_n49_), .c(new_n81_), .O(z18));
endmodule
