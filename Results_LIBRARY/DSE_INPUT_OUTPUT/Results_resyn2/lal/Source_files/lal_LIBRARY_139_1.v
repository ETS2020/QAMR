...
module FAU ( 
  ...
  nor2   g06(.a(x24), .b(x07), .O(new_n52_));
  nand3  g07(.a(new_n52_), .b(new_n51_), .c(x25), .O(z01));
  inv1   g08(.a(x16), .O(new_n54_));
  nand2  g09(.a(new_n49_), .b(new_n54_), .O(z02));
  ...
  aoi21  g33(.a(new_n64_), .b(new_n56_), .c(new_n48_), .O(z08));
  nor4   g34(.a(new_n51_), .b(x24), .c(x15), .d(x07), .O(z09));
  aoi21  g35(.a(x05), .b(x04), .c(x15), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n58_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n47_), .c(x07), .O(z10));
  nand2  g38(.a(new_n59_), .b(new_n58_), .O(new_n84_));
  nand2  g39(.a(x18), .b(x17), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n81_), .c(new_n84_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n47_), .c(x07), .O(z11));
  nand2  g42(.a(new_n81_), .b(new_n52_), .O(new_n88_));
  ...
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n81_), .O(new_n101_));
  ...
  nand3  g60(.a(new_n99_), .b(new_n90_), .c(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n81_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n97_), .O(z15));
  nand2  g64(.a(new_n106_), .b(x23), .O(new_n110_));
  nor2   g65(.a(x23), .b(x22), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n99_), .c(new_n90_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n81_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n97_), .O(z16));
  nand2  g70(.a(new_n112_), .b(new_n93_), .O(z17));
  aoi21  g71(.a(new_n112_), .b(x25), .c(new_n88_), .O(new_n117_));
  oai21  g72(.a(new_n112_), .b(x25), .c(new_n117_), .O(z18));
endmodule
