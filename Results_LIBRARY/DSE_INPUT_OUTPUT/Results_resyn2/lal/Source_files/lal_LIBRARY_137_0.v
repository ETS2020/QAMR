...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x11), .O(new_n48_));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n52_), .c(new_n48_), .O(z08));
  nand2  g33(.a(x05), .b(x04), .O(new_n79_));
  inv1   g34(.a(x07), .O(new_n80_));
  inv1   g35(.a(x15), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(x11), .c(new_n80_), .O(new_n82_));
  ...
  inv1   g48(.a(new_n85_), .O(new_n94_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n94_), .O(z16));
  inv1   g65(.a(x11), .O(new_n111_));
  inv1   g66(.a(x24), .O(new_n112_));
  nand3  g67(.a(new_n104_), .b(new_n112_), .c(new_n108_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n95_), .c(new_n62_), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n111_), .c(new_n81_), .O(z17));
  inv1   g71(.a(new_n113_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n100_), .c(new_n52_), .O(new_n118_));
  oai21  g73(.a(new_n113_), .b(new_n95_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n62_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x11), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n81_), .O(z18));
endmodule
