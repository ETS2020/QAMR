...
module FAU ( 
  ...
  nor2   g17(.a(new_n62_), .b(new_n48_), .O(new_n63_));
  ...
  nand2  g36(.a(new_n47_), .b(new_n60_), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(new_n61_), .c(new_n67_), .O(z09));
  ...
  oai21  g44(.a(new_n89_), .b(new_n85_), .c(new_n67_), .O(z11));
  ...
  oai21  g49(.a(new_n91_), .b(x15), .c(x20), .O(new_n95_));
  nor2   g50(.a(new_n91_), .b(x20), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(new_n62_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n95_), .c(new_n48_), .O(z13));
  oai21  g53(.a(new_n91_), .b(x20), .c(x21), .O(new_n99_));
  inv1   g54(.a(x21), .O(new_n100_));
  nand2  g55(.a(new_n96_), .b(new_n100_), .O(new_n101_));
  ...
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n92_), .c(new_n51_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n86_), .O(z16));
  oai21  g65(.a(x24), .b(x15), .c(x20), .O(new_n111_));
  inv1   g66(.a(x24), .O(new_n112_));
  nand4  g67(.a(new_n108_), .b(new_n92_), .c(new_n112_), .d(new_n51_), .O(new_n113_));
  inv1   g68(.a(x23), .O(new_n114_));
  nand2  g69(.a(new_n104_), .b(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n91_), .c(x24), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n84_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n111_), .O(z17));
  aoi21  g74(.a(new_n113_), .b(x25), .c(new_n85_), .O(new_n120_));
