...
module FAU ( 
  ...
  oai21  g37(.a(new_n82_), .b(new_n79_), .c(new_n49_), .O(z09));
  ...
  nor2   g41(.a(new_n84_), .b(new_n48_), .O(new_n87_));
  ...
  nor4   g48(.a(new_n93_), .b(new_n92_), .c(new_n84_), .d(new_n48_), .O(z12));
  nor2   g49(.a(new_n91_), .b(x20), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(new_n96_));
  nand2  g51(.a(new_n91_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n87_), .O(z13));
  nand2  g53(.a(new_n96_), .b(x21), .O(new_n99_));
  inv1   g54(.a(x21), .O(new_n100_));
  nand2  g55(.a(new_n95_), .b(new_n100_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n87_), .O(z14));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nor3   g59(.a(new_n91_), .b(x21), .c(x20), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n104_), .c(new_n84_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n103_), .c(new_n48_), .O(z15));
  oai21  g62(.a(new_n101_), .b(x22), .c(x23), .O(new_n108_));
  nor2   g63(.a(x23), .b(x22), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n105_), .c(new_n84_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n108_), .c(new_n48_), .O(z16));
  nand3  g66(.a(new_n109_), .b(new_n105_), .c(new_n47_), .O(new_n112_));
  nand3  g67(.a(new_n109_), .b(new_n95_), .c(new_n100_), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(x24), .c(new_n84_), .O(new_n114_));
  aoi21  g69(.a(new_n114_), .b(new_n112_), .c(new_n48_), .O(z17));
  nor2   g70(.a(new_n51_), .b(new_n47_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n84_), .c(new_n49_), .O(new_n117_));
  nor2   g72(.a(new_n113_), .b(new_n51_), .O(new_n118_));
  nand2  g73(.a(new_n113_), .b(new_n51_), .O(new_n119_));
