...
module FAU ( 
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n98_), .O(z14));
  inv1   g60(.a(x22), .O(new_n106_));
  inv1   g61(.a(new_n94_), .O(new_n107_));
  nand3  g62(.a(new_n103_), .b(new_n107_), .c(new_n106_), .O(new_n108_));
  nand2  g63(.a(new_n104_), .b(x22), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n98_), .O(z15));
  nand2  g65(.a(x24), .b(new_n106_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n104_), .c(x23), .O(new_n112_));
  nand4  g67(.a(new_n103_), .b(new_n107_), .c(new_n59_), .d(new_n106_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n90_), .O(z16));
  nand2  g69(.a(new_n87_), .b(new_n49_), .O(new_n115_));
  nand2  g70(.a(new_n113_), .b(x24), .O(new_n116_));
  inv1   g71(.a(new_n99_), .O(new_n117_));
  inv1   g72(.a(x21), .O(new_n118_));
  nand3  g73(.a(new_n48_), .b(new_n106_), .c(new_n118_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n117_), .c(new_n59_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n116_), .c(new_n115_), .O(z17));
  oai21  g77(.a(new_n119_), .b(new_n99_), .c(x25), .O(new_n123_));
  nand3  g78(.a(new_n120_), .b(new_n117_), .c(new_n60_), .O(new_n124_));
  nand2  g79(.a(new_n60_), .b(x24), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(x23), .c(new_n87_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(z18));
endmodule
