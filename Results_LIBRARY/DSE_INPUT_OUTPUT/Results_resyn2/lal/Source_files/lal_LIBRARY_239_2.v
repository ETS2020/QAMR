...
module FAU ( 
  ...
  nand2  g27(.a(new_n48_), .b(x01), .O(new_n73_));
  ...
  nor3   g43(.a(x15), .b(x10), .c(x07), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(new_n88_), .O(z09));
  nand2  g46(.a(new_n63_), .b(new_n55_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n48_), .c(x15), .O(z10));
  nor2   g48(.a(x18), .b(x17), .O(new_n94_));
  nand2  g49(.a(new_n89_), .b(new_n88_), .O(new_n95_));
  ...
  nor3   g55(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(z12));
  ...
  nor2   g63(.a(new_n103_), .b(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n103_), .b(new_n108_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n63_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n109_), .c(new_n48_), .O(new_n112_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n102_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x23), .O(new_n119_));
  nand3  g74(.a(new_n115_), .b(new_n103_), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n115_), .c(new_n103_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n102_), .O(z17));
  nand4  g80(.a(new_n123_), .b(new_n115_), .c(new_n103_), .d(new_n53_), .O(new_n126_));
  nand2  g81(.a(new_n124_), .b(x25), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n63_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n107_), .O(z18));
endmodule
