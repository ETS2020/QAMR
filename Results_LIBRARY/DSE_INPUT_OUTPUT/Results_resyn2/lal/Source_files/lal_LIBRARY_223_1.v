...
module FAU ( 
  ...
  aoi21  g16(.a(x25), .b(new_n50_), .c(x04), .O(new_n62_));
  ...
  nand2  g23(.a(new_n61_), .b(new_n48_), .O(z03));
  ...
  aoi22  g35(.a(x24), .b(new_n47_), .c(new_n46_), .d(x06), .O(z07));
  inv1   g36(.a(x23), .O(new_n82_));
  nor2   g37(.a(x18), .b(x17), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(new_n55_), .c(x20), .O(new_n84_));
  oai21  g39(.a(new_n58_), .b(new_n84_), .c(new_n82_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n47_), .c(x24), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n51_), .O(z08));
  nor2   g42(.a(x15), .b(x07), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n64_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand3  g45(.a(new_n88_), .b(new_n63_), .c(new_n48_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  inv1   g49(.a(new_n83_), .O(new_n95_));
  nand2  g50(.a(x18), .b(x17), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n92_), .c(new_n95_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z11));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n96_), .b(new_n55_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(new_n91_), .O(z12));
  ...
  nand3  g67(.a(new_n108_), .b(new_n103_), .c(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n88_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n48_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n63_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n108_), .c(new_n103_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n88_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n63_), .O(z16));
  aoi21  g77(.a(new_n119_), .b(x24), .c(x05), .O(new_n123_));
  inv1   g78(.a(new_n119_), .O(new_n124_));
  aoi21  g79(.a(x24), .b(new_n47_), .c(new_n88_), .O(new_n125_));
  aoi21  g80(.a(new_n124_), .b(new_n50_), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n123_), .b(new_n47_), .c(new_n126_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  aoi21  g83(.a(new_n119_), .b(new_n51_), .c(x24), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  inv1   g85(.a(x05), .O(new_n131_));
  oai21  g86(.a(new_n51_), .b(new_n50_), .c(new_n131_), .O(new_n132_));
  aoi21  g87(.a(new_n132_), .b(x04), .c(new_n125_), .O(new_n133_));
