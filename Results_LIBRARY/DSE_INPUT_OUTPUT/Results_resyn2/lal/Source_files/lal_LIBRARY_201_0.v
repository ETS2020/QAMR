...
module FAU ( 
  ...
  nand3  g51(.a(new_n96_), .b(new_n85_), .c(new_n84_), .O(new_n97_));
  ...
  nand2  g58(.a(new_n99_), .b(new_n60_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n91_), .O(z14));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n106_));
  nand3  g61(.a(new_n99_), .b(new_n61_), .c(new_n60_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n91_), .O(z15));
  nand2  g63(.a(new_n88_), .b(new_n48_), .O(new_n109_));
  nor2   g64(.a(new_n107_), .b(x23), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(x24), .O(new_n111_));
  nand2  g66(.a(new_n107_), .b(x23), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n109_), .O(z16));
  oai21  g68(.a(new_n110_), .b(new_n53_), .c(new_n109_), .O(z17));
  nand2  g69(.a(new_n91_), .b(new_n50_), .O(z18));
endmodule
