...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n111_, new_n112_, new_n113_, new_n114_, new_n116_;
  ...
  oai21  g28(.a(x13), .b(x08), .c(new_n59_), .O(z05));
  inv1   g29(.a(x14), .O(new_n75_));
  nor2   g30(.a(new_n66_), .b(new_n75_), .O(z06));
  nand3  g31(.a(new_n59_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g32(.a(new_n57_), .b(new_n50_), .c(new_n48_), .O(z08));
  inv1   g33(.a(x07), .O(new_n79_));
  nand3  g34(.a(new_n79_), .b(x05), .c(x04), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g36(.a(x15), .O(new_n82_));
  nand3  g37(.a(new_n60_), .b(new_n47_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g49(.a(new_n91_), .b(new_n60_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n47_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n82_), .O(z13));
  inv1   g52(.a(x21), .O(new_n98_));
  nand2  g53(.a(new_n92_), .b(new_n98_), .O(new_n99_));
  nand2  g54(.a(new_n91_), .b(x21), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n84_), .O(z14));
  ...
  nand3  g62(.a(new_n103_), .b(new_n92_), .c(new_n107_), .O(new_n108_));
  ...
  nand3  g66(.a(new_n111_), .b(new_n103_), .c(new_n92_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n60_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n82_), .O(z17));
  aoi21  g70(.a(new_n112_), .b(x25), .c(new_n83_), .O(new_n116_));
  oai21  g71(.a(new_n112_), .b(x25), .c(new_n116_), .O(z18));
endmodule
