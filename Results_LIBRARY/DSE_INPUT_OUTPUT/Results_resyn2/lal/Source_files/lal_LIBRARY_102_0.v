...
module FAU ( 
  ...
  nor2   g02(.a(x20), .b(x14), .O(new_n48_));
  ...
  nand3  g20(.a(new_n60_), .b(new_n49_), .c(new_n52_), .O(z08));
  ...
  oai21  g32(.a(new_n77_), .b(x08), .c(new_n49_), .O(z06));
  ...
  nand2  g37(.a(new_n80_), .b(new_n62_), .O(new_n83_));
  ...
  aoi21  g46(.a(new_n88_), .b(new_n56_), .c(new_n83_), .O(new_n92_));
  ...
  nand4  g76(.a(new_n121_), .b(new_n106_), .c(new_n95_), .d(new_n53_), .O(new_n122_));
  oai21  g77(.a(x24), .b(new_n53_), .c(new_n77_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n120_), .d(new_n119_), .O(z17));
  xor2a  g79(.a(new_n122_), .b(x25), .O(new_n125_));
  oai21  g80(.a(x25), .b(new_n53_), .c(new_n77_), .O(new_n126_));
