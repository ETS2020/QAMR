...
module FAU ( 
  ...
  aoi21  g30(.a(new_n73_), .b(new_n70_), .c(new_n75_), .O(z04));
  oai21  g31(.a(x13), .b(x08), .c(new_n47_), .O(z05));
  inv1   g32(.a(x14), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(x08), .c(new_n47_), .O(z06));
  aoi21  g34(.a(new_n74_), .b(x06), .c(new_n50_), .O(z07));
  aoi21  g35(.a(new_n59_), .b(new_n51_), .c(new_n50_), .O(z08));
  inv1   g36(.a(x07), .O(new_n82_));
  inv1   g37(.a(x15), .O(new_n83_));
  nand3  g38(.a(new_n62_), .b(new_n83_), .c(new_n82_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z09));
  nand2  g40(.a(new_n63_), .b(new_n83_), .O(new_n86_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n87_), .O(z16));
  inv1   g66(.a(x24), .O(new_n112_));
  nand4  g67(.a(new_n109_), .b(new_n96_), .c(new_n112_), .d(new_n101_), .O(new_n113_));
  ...
  nand2  g71(.a(new_n83_), .b(new_n82_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n116_), .O(z17));
  aoi21  g74(.a(new_n113_), .b(x25), .c(new_n86_), .O(new_n120_));
