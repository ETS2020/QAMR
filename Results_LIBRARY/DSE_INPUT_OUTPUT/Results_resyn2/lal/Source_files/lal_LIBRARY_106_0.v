...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n79_, new_n81_, new_n85_, new_n86_, new_n88_, new_n90_, new_n91_,
  ...
  nand2  g42(.a(new_n85_), .b(new_n58_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(x17), .c(new_n48_), .O(z10));
  inv1   g44(.a(new_n66_), .O(new_n90_));
  ...
  nand2  g51(.a(new_n92_), .b(new_n65_), .O(new_n97_));
  ...
  aoi21  g57(.a(new_n96_), .b(x20), .c(new_n88_), .O(new_n103_));
  ...
  nand2  g65(.a(new_n106_), .b(new_n101_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x22), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n91_), .O(z15));
  nand4  g68(.a(new_n106_), .b(new_n101_), .c(new_n64_), .d(new_n109_), .O(new_n114_));
  ...
  nand3  g73(.a(new_n95_), .b(new_n48_), .c(new_n69_), .O(z18));
endmodule
