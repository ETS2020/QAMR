...
module FAU ( 
  ...
  nand3  g11(.a(x24), .b(x22), .c(x21), .O(new_n57_));
  oai21  g12(.a(new_n57_), .b(new_n56_), .c(new_n53_), .O(new_n58_));
  nand2  g13(.a(x05), .b(x04), .O(new_n59_));
  nand4  g14(.a(new_n59_), .b(new_n58_), .c(new_n50_), .d(new_n52_), .O(z01));
  inv1   g15(.a(x16), .O(new_n61_));
  nand2  g16(.a(new_n50_), .b(new_n61_), .O(z02));
  nand2  g17(.a(new_n58_), .b(new_n50_), .O(z03));
  ...
  nor2   g25(.a(x13), .b(x08), .O(new_n71_));
  ...
  aoi21  g30(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  inv1   g31(.a(x20), .O(new_n77_));
  inv1   g32(.a(x17), .O(new_n78_));
  inv1   g33(.a(x18), .O(new_n79_));
  nand3  g34(.a(new_n54_), .b(new_n79_), .c(new_n78_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  inv1   g36(.a(new_n57_), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(new_n81_), .c(new_n47_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(new_n53_), .c(new_n49_), .O(z08));
  inv1   g39(.a(x15), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n59_), .c(new_n50_), .O(z09));
  nand3  g42(.a(new_n59_), .b(new_n85_), .c(new_n52_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n50_), .c(new_n78_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  nand2  g46(.a(new_n89_), .b(new_n50_), .O(new_n92_));
  inv1   g47(.a(new_n55_), .O(new_n93_));
  ...
  nor2   g54(.a(new_n99_), .b(new_n92_), .O(z12));
  inv1   g55(.a(new_n97_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n77_), .O(new_n102_));
  nand2  g57(.a(new_n97_), .b(x20), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n89_), .d(new_n50_), .O(z13));
  nand2  g59(.a(new_n102_), .b(x21), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n101_), .c(new_n88_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n105_), .c(new_n49_), .O(z14));
  inv1   g63(.a(x22), .O(new_n109_));
  nand3  g64(.a(new_n106_), .b(new_n101_), .c(new_n109_), .O(new_n110_));
  nand4  g65(.a(new_n106_), .b(x19), .c(x18), .d(x17), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(x22), .c(new_n88_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n110_), .c(new_n49_), .O(z15));
  nand4  g68(.a(new_n106_), .b(new_n101_), .c(new_n48_), .d(new_n109_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x23), .O(new_n115_));
  nor2   g70(.a(new_n97_), .b(x20), .O(new_n116_));
  nor3   g71(.a(x23), .b(x22), .c(x21), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n115_), .c(new_n89_), .O(z16));
  nand3  g74(.a(new_n117_), .b(new_n116_), .c(new_n48_), .O(new_n120_));
  nand2  g75(.a(new_n118_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n89_), .O(z17));
  nand4  g77(.a(new_n117_), .b(new_n116_), .c(new_n53_), .d(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n114_), .b(x25), .O(new_n124_));
  oai21  g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n89_), .O(z18));
endmodule
