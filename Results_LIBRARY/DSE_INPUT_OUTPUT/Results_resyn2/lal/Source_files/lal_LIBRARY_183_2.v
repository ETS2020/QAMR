...
module FAU ( 
  ...
  nor4   g35(.a(new_n80_), .b(x15), .c(x07), .d(x01), .O(z09));
  inv1   g36(.a(x07), .O(new_n82_));
  inv1   g37(.a(x15), .O(new_n83_));
  nand4  g38(.a(new_n80_), .b(new_n83_), .c(new_n82_), .d(new_n48_), .O(new_n84_));
  ...
  nand2  g53(.a(new_n98_), .b(new_n83_), .O(z13));
  ...
  nor3   g62(.a(new_n91_), .b(x21), .c(x20), .O(new_n108_));
  ...
  nand2  g66(.a(new_n111_), .b(new_n83_), .O(z15));
  nand2  g67(.a(new_n109_), .b(x23), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n101_), .c(new_n92_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n85_), .O(z16));
  ...
  nand2  g76(.a(new_n121_), .b(new_n83_), .O(z17));
  aoi21  g77(.a(new_n119_), .b(x25), .c(new_n84_), .O(new_n123_));
