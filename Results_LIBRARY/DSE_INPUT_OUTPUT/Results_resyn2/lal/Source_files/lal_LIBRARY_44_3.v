...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n86_, new_n87_, new_n90_, new_n93_, new_n94_, new_n96_, new_n97_,
  ...
  nand2  g13(.a(new_n58_), .b(new_n50_), .O(z08));
  ...
  nand3  g46(.a(new_n47_), .b(new_n68_), .c(x06), .O(z07));
  inv1   g47(.a(x15), .O(new_n93_));
  nand3  g48(.a(new_n47_), .b(new_n93_), .c(new_n60_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(new_n61_), .O(z09));
  ...
  nand3  g55(.a(new_n61_), .b(new_n93_), .c(new_n60_), .O(new_n101_));
  ...
  oai21  g59(.a(new_n104_), .b(new_n101_), .c(new_n47_), .O(z11));
  inv1   g60(.a(new_n101_), .O(new_n106_));
  nand3  g61(.a(x19), .b(x18), .c(x17), .O(new_n107_));
  nand2  g62(.a(new_n103_), .b(new_n54_), .O(new_n108_));
  ...
  aoi21  g67(.a(new_n107_), .b(x20), .c(new_n101_), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(new_n112_), .c(new_n65_), .O(z13));
  ...
  nand3  g75(.a(new_n111_), .b(new_n120_), .c(new_n115_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n98_), .O(z15));
  inv1   g77(.a(x24), .O(new_n123_));
  nand4  g78(.a(new_n111_), .b(new_n123_), .c(new_n120_), .d(new_n115_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(x23), .O(new_n125_));
  inv1   g80(.a(x23), .O(new_n126_));
  nand4  g81(.a(new_n111_), .b(new_n126_), .c(new_n120_), .d(new_n115_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n106_), .O(z16));
  aoi21  g83(.a(new_n127_), .b(x24), .c(new_n101_), .O(new_n129_));
  oai21  g84(.a(new_n127_), .b(x24), .c(new_n129_), .O(z17));
  nand2  g85(.a(new_n127_), .b(new_n50_), .O(new_n131_));
  nor2   g86(.a(new_n50_), .b(x23), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(x24), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  oai21  g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  aoi22  g90(.a(new_n135_), .b(new_n101_), .c(new_n132_), .d(new_n124_), .O(new_n136_));
