...
module FAU ( 
  ...
  aoi21  g43(.a(new_n46_), .b(x06), .c(new_n47_), .O(z07));
  inv1   g44(.a(x25), .O(new_n90_));
  aoi21  g45(.a(new_n57_), .b(new_n53_), .c(new_n59_), .O(new_n91_));
  inv1   g46(.a(x23), .O(new_n92_));
  nand2  g47(.a(new_n90_), .b(new_n92_), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n91_), .c(x24), .O(new_n94_));
  oai21  g49(.a(new_n90_), .b(new_n64_), .c(new_n94_), .O(z08));
  ...
  nand2  g56(.a(new_n99_), .b(new_n50_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n54_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(z10));
  nand3  g60(.a(new_n50_), .b(new_n97_), .c(new_n96_), .O(new_n106_));
  xnor2a g61(.a(x18), .b(x17), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n106_), .c(new_n48_), .O(z11));
  nand3  g63(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  aoi21  g65(.a(x18), .b(x17), .c(x19), .O(new_n111_));
  nor3   g66(.a(new_n111_), .b(new_n110_), .c(new_n102_), .O(z12));
  ...
  nand2  g73(.a(new_n113_), .b(new_n118_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n122_), .b(new_n113_), .c(new_n92_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n103_), .O(z16));
  nand2  g82(.a(new_n126_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n122_), .b(new_n113_), .c(new_n62_), .d(new_n92_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n128_), .c(new_n103_), .O(z17));
  xor2a  g85(.a(new_n129_), .b(x25), .O(new_n131_));
  nand2  g86(.a(new_n90_), .b(x24), .O(new_n132_));
  aoi21  g87(.a(new_n132_), .b(new_n64_), .c(new_n106_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n131_), .O(z18));
endmodule
