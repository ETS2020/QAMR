...
module FAU ( 
  ...
  nand2  g14(.a(new_n53_), .b(new_n48_), .O(z03));
  xnor2a g15(.a(x11), .b(x02), .O(new_n61_));
  ...
  nor2   g24(.a(new_n69_), .b(new_n50_), .O(z06));
  ...
  aoi21  g37(.a(x18), .b(x17), .c(x19), .O(new_n83_));
  nor3   g38(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(z12));
  ...
  aoi21  g47(.a(new_n92_), .b(new_n91_), .c(new_n50_), .O(z14));
  ...
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n85_), .O(z15));
  nand2  g53(.a(new_n76_), .b(new_n48_), .O(new_n99_));
  oai21  g54(.a(new_n91_), .b(x22), .c(x23), .O(new_n100_));
  nor2   g55(.a(x23), .b(x22), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n51_), .c(new_n90_), .O(new_n102_));
  ...
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n51_), .O(z17));
  nand4  g62(.a(new_n52_), .b(new_n94_), .c(new_n90_), .d(new_n87_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n81_), .c(new_n51_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n47_), .O(new_n110_));
  oai21  g65(.a(new_n102_), .b(new_n88_), .c(x25), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n105_), .O(z18));
endmodule
