...
module FAU ( 
  ...
  aoi21  g19(.a(new_n64_), .b(new_n55_), .c(new_n56_), .O(new_n65_));
  inv1   g20(.a(x25), .O(new_n66_));
  nand2  g21(.a(new_n49_), .b(new_n66_), .O(new_n67_));
  oai21  g22(.a(new_n67_), .b(new_n65_), .c(new_n54_), .O(z01));
  aoi21  g23(.a(new_n49_), .b(x25), .c(new_n65_), .O(z03));
  ...
  nand2  g36(.a(new_n64_), .b(new_n55_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(x24), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n49_), .c(new_n66_), .O(z08));
  nor2   g39(.a(x15), .b(x07), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n53_), .c(new_n49_), .O(new_n86_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n60_), .O(new_n96_));
  ...
  nor3   g58(.a(new_n95_), .b(x21), .c(x20), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n88_), .O(new_n105_));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n108_), .c(new_n88_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n107_), .c(new_n48_), .O(z15));
  nand2  g65(.a(new_n88_), .b(new_n49_), .O(new_n111_));
  nand4  g66(.a(new_n104_), .b(x24), .c(new_n55_), .d(new_n108_), .O(new_n112_));
  nand2  g67(.a(new_n104_), .b(new_n108_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x23), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(z16));
  oai21  g70(.a(new_n113_), .b(x23), .c(x24), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n111_), .O(z17));
  nand3  g72(.a(new_n94_), .b(new_n49_), .c(new_n66_), .O(z18));
endmodule
