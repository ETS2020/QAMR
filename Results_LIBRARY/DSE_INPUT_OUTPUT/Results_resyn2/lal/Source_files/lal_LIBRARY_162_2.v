...
module FAU ( 
  ...
  nand2  g66(.a(new_n88_), .b(new_n48_), .O(new_n112_));
  nand3  g67(.a(new_n110_), .b(x24), .c(x23), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n105_), .c(new_n100_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(z16));
  inv1   g71(.a(new_n115_), .O(new_n117_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nand2  g79(.a(new_n110_), .b(x25), .O(new_n125_));
  aoi21  g80(.a(new_n122_), .b(x23), .c(new_n88_), .O(new_n126_));
