...
module FAU ( 
  ...
  nand2  g14(.a(new_n59_), .b(new_n53_), .O(z01));
  inv1   g15(.a(x24), .O(new_n61_));
  nor2   g16(.a(new_n61_), .b(new_n54_), .O(z02));
  inv1   g17(.a(x19), .O(new_n63_));
  nor2   g18(.a(x18), .b(x17), .O(new_n64_));
  aoi21  g19(.a(new_n64_), .b(new_n63_), .c(x20), .O(new_n65_));
  nor2   g20(.a(new_n61_), .b(x23), .O(new_n66_));
  oai21  g21(.a(new_n49_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  nand2  g22(.a(new_n61_), .b(new_n54_), .O(new_n68_));
  aoi21  g23(.a(new_n68_), .b(new_n67_), .c(x25), .O(z03));
  nor2   g24(.a(x24), .b(new_n54_), .O(new_n70_));
  ...
  nand2  g32(.a(new_n77_), .b(new_n71_), .O(z04));
  nand2  g33(.a(new_n71_), .b(new_n46_), .O(new_n79_));
  ...
  aoi21  g38(.a(new_n52_), .b(new_n51_), .c(new_n55_), .O(z08));
  inv1   g39(.a(x15), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n57_), .c(new_n71_), .O(z09));
  nand3  g42(.a(new_n57_), .b(new_n85_), .c(new_n56_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(x17), .c(new_n71_), .O(z10));
  inv1   g44(.a(new_n64_), .O(new_n90_));
  nor2   g45(.a(new_n88_), .b(new_n70_), .O(new_n91_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n111_), .c(new_n61_), .O(new_n118_));
  ...
  aoi21  g81(.a(new_n126_), .b(x16), .c(new_n88_), .O(new_n127_));
