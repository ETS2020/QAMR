...
module FAU ( 
  ...
  nand2  g14(.a(new_n59_), .b(new_n58_), .O(z08));
  inv1   g15(.a(new_n47_), .O(new_n61_));
  aoi22  g16(.a(new_n61_), .b(x07), .c(x05), .d(x04), .O(new_n62_));
  ...
  and2   g24(.a(new_n69_), .b(new_n49_), .O(z04));
  oai21  g25(.a(x13), .b(x08), .c(new_n61_), .O(z05));
  inv1   g26(.a(x14), .O(new_n72_));
  oai21  g27(.a(new_n72_), .b(x08), .c(new_n61_), .O(z06));
  nand2  g28(.a(new_n49_), .b(x06), .O(z07));
  inv1   g29(.a(x07), .O(new_n75_));
  nand2  g30(.a(new_n75_), .b(x05), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(x04), .c(x15), .O(z09));
  inv1   g32(.a(x15), .O(new_n78_));
  nor2   g33(.a(x07), .b(x05), .O(new_n79_));
  nand3  g34(.a(new_n79_), .b(new_n78_), .c(x04), .O(new_n80_));
  nor2   g35(.a(new_n80_), .b(x17), .O(z10));
  nand2  g36(.a(new_n53_), .b(new_n52_), .O(new_n82_));
  nand2  g37(.a(x18), .b(x17), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n79_), .c(new_n82_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x04), .c(x15), .O(z11));
  nand2  g40(.a(new_n83_), .b(new_n54_), .O(new_n86_));
  nand3  g41(.a(x19), .b(x18), .c(x17), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n86_), .c(new_n79_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(x04), .c(x15), .O(z12));
  ...
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n90_), .O(z13));
  ...
  nand3  g53(.a(new_n98_), .b(new_n95_), .c(new_n79_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n78_), .O(z14));
  nand2  g56(.a(new_n98_), .b(x22), .O(new_n102_));
  inv1   g57(.a(x22), .O(new_n103_));
  nand3  g58(.a(new_n97_), .b(new_n103_), .c(new_n96_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n90_), .O(z15));
  nand2  g60(.a(new_n104_), .b(x23), .O(new_n106_));
  inv1   g61(.a(x23), .O(new_n107_));
  nand4  g62(.a(new_n97_), .b(new_n107_), .c(new_n103_), .d(new_n96_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n90_), .O(z16));
  ...
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n90_), .O(z17));
  inv1   g69(.a(x25), .O(new_n115_));
  nand3  g70(.a(new_n112_), .b(new_n115_), .c(new_n111_), .O(new_n116_));
  oai21  g71(.a(new_n108_), .b(x24), .c(x25), .O(new_n117_));
