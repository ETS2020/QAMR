...
module FAU ( 
  ...
  aoi21  g31(.a(new_n58_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g32(.a(x07), .O(new_n78_));
  nand3  g33(.a(new_n78_), .b(x05), .c(x04), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g35(.a(x15), .O(new_n81_));
  nand3  g36(.a(new_n60_), .b(new_n47_), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g42(.a(new_n87_), .b(new_n60_), .c(new_n86_), .O(new_n88_));
  ...
  nand2  g47(.a(new_n87_), .b(new_n54_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n47_), .c(x15), .O(z12));
  oai21  g50(.a(new_n92_), .b(x20), .c(new_n81_), .O(z13));
  ...
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n83_), .O(z14));
  nand2  g56(.a(new_n99_), .b(x22), .O(new_n102_));
  inv1   g57(.a(x22), .O(new_n103_));
  nor2   g58(.a(new_n90_), .b(x21), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n102_), .c(new_n60_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n81_), .O(z15));
  nand2  g63(.a(new_n105_), .b(x23), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand3  g65(.a(new_n104_), .b(new_n110_), .c(new_n103_), .O(new_n111_));
  ...
  aoi21  g71(.a(new_n115_), .b(x25), .c(new_n82_), .O(new_n117_));
