...
module FAU ( 
  ...
  inv1   g17(.a(new_n49_), .O(new_n63_));
  ...
  nand2  g22(.a(new_n62_), .b(new_n63_), .O(z03));
  ...
  and2   g28(.a(new_n73_), .b(new_n51_), .O(z04));
  oai21  g29(.a(x13), .b(x08), .c(new_n63_), .O(z05));
  nand2  g30(.a(new_n51_), .b(x14), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z06));
  nand2  g32(.a(new_n51_), .b(x06), .O(z07));
  oai21  g33(.a(new_n60_), .b(x23), .c(x24), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n53_), .O(z08));
  inv1   g35(.a(x07), .O(new_n81_));
  inv1   g36(.a(x15), .O(new_n82_));
  nand4  g37(.a(new_n82_), .b(new_n81_), .c(x05), .d(x04), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n63_), .O(z09));
  nand2  g39(.a(new_n64_), .b(new_n82_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x17), .c(new_n63_), .O(z10));
  nand2  g41(.a(new_n56_), .b(new_n55_), .O(new_n87_));
  nand2  g42(.a(x18), .b(x17), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(new_n85_), .c(new_n63_), .O(z11));
  nand2  g45(.a(new_n88_), .b(new_n57_), .O(new_n91_));
  nand3  g46(.a(x19), .b(x18), .c(x17), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n85_), .c(new_n63_), .O(z12));
  inv1   g49(.a(new_n85_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n63_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(new_n97_));
  xor2a  g52(.a(new_n92_), .b(x20), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(z13));
  oai21  g54(.a(new_n92_), .b(x20), .c(x21), .O(new_n100_));
  inv1   g55(.a(new_n92_), .O(new_n101_));
  nor2   g56(.a(x21), .b(x20), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n101_), .c(new_n85_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n100_), .c(new_n49_), .O(z14));
  nand2  g59(.a(new_n102_), .b(new_n101_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x22), .O(new_n106_));
  inv1   g61(.a(x22), .O(new_n107_));
  nand3  g62(.a(new_n102_), .b(new_n101_), .c(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n97_), .O(z15));
  nand4  g64(.a(new_n102_), .b(new_n101_), .c(new_n48_), .d(new_n107_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(x23), .O(new_n111_));
  nand4  g66(.a(new_n102_), .b(new_n101_), .c(new_n47_), .d(new_n107_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n95_), .O(z16));
  nand2  g68(.a(new_n85_), .b(new_n63_), .O(new_n114_));
  xor2a  g69(.a(new_n108_), .b(x24), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x23), .c(new_n114_), .O(z17));
  inv1   g71(.a(new_n112_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n53_), .c(new_n48_), .O(new_n118_));
  nand2  g73(.a(new_n110_), .b(x25), .O(new_n119_));
  oai21  g74(.a(x25), .b(x24), .c(x23), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n95_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(z18));
endmodule
