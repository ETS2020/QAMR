...
module FAU ( 
  ...
  nand4  g09(.a(new_n54_), .b(z08), .c(new_n49_), .d(new_n51_), .O(z01));
  ...
  nor2   g29(.a(new_n73_), .b(new_n48_), .O(new_n75_));
  ...
  inv1   g34(.a(new_n73_), .O(new_n80_));
  nand3  g35(.a(x19), .b(x18), .c(x17), .O(new_n81_));
  inv1   g36(.a(x19), .O(new_n82_));
  nand2  g37(.a(new_n76_), .b(new_n82_), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n81_), .c(new_n80_), .O(new_n84_));
  ...
  inv1   g50(.a(new_n76_), .O(new_n96_));
  nor2   g51(.a(x20), .b(new_n82_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n90_), .O(new_n98_));
  oai21  g53(.a(new_n88_), .b(x21), .c(x22), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n75_), .O(z15));
  nand2  g55(.a(new_n73_), .b(new_n49_), .O(new_n101_));
  nand2  g56(.a(new_n98_), .b(x23), .O(new_n102_));
  inv1   g57(.a(x23), .O(new_n103_));
  nor2   g58(.a(x22), .b(x21), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n47_), .c(new_n103_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n91_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n102_), .c(new_n101_), .O(z16));
  inv1   g63(.a(new_n81_), .O(new_n109_));
  nor2   g64(.a(x23), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n104_), .c(new_n109_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n80_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(x24), .b(x23), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n113_), .O(z17));
  nand2  g70(.a(new_n104_), .b(new_n52_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n88_), .c(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n103_), .O(new_n118_));
  oai21  g73(.a(new_n105_), .b(new_n88_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n80_), .O(z18));
endmodule
