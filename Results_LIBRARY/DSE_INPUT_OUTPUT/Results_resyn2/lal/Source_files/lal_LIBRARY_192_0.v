...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n74_, new_n77_, new_n78_, new_n79_, new_n81_, new_n82_,
  ...
  aoi21  g04(.a(x25), .b(x23), .c(x24), .O(new_n50_));
  ...
  nor3   g31(.a(x19), .b(x18), .c(x17), .O(new_n77_));
  inv1   g32(.a(new_n55_), .O(new_n78_));
  oai21  g33(.a(new_n77_), .b(x20), .c(new_n78_), .O(new_n79_));
  aoi21  g34(.a(new_n56_), .b(new_n79_), .c(new_n50_), .O(z08));
  nor2   g35(.a(x15), .b(x07), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(new_n59_), .c(new_n48_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z09));
  nand2  g38(.a(new_n81_), .b(new_n58_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(x17), .c(new_n48_), .O(z10));
  xnor2a g40(.a(x18), .b(x17), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n84_), .c(new_n48_), .O(z11));
  nand3  g42(.a(new_n81_), .b(new_n58_), .c(new_n48_), .O(new_n88_));
  nand3  g43(.a(x19), .b(x18), .c(x17), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  aoi21  g45(.a(x18), .b(x17), .c(x19), .O(new_n91_));
  nor3   g46(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(z12));
  inv1   g47(.a(x20), .O(new_n93_));
  nand2  g48(.a(new_n90_), .b(new_n93_), .O(new_n94_));
  aoi21  g49(.a(new_n89_), .b(x20), .c(new_n84_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n94_), .c(new_n47_), .O(z13));
  ...
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n97_), .O(z14));
  inv1   g56(.a(x22), .O(new_n102_));
  nand3  g57(.a(new_n99_), .b(new_n90_), .c(new_n102_), .O(new_n103_));
  aoi21  g58(.a(new_n100_), .b(x22), .c(new_n84_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n47_), .O(z15));
  inv1   g60(.a(x23), .O(new_n106_));
  nand4  g61(.a(new_n99_), .b(new_n90_), .c(new_n106_), .d(new_n102_), .O(new_n107_));
  nand2  g62(.a(new_n103_), .b(x23), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n97_), .O(z16));
  nand2  g64(.a(new_n84_), .b(new_n48_), .O(new_n110_));
  nand2  g65(.a(new_n107_), .b(x24), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(z17));
  inv1   g67(.a(x25), .O(new_n113_));
  nand2  g68(.a(new_n97_), .b(new_n113_), .O(z18));
endmodule
