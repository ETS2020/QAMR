...
module FAU ( 
  ...
  oai21  g21(.a(new_n63_), .b(new_n50_), .c(new_n66_), .O(z01));
  inv1   g22(.a(x16), .O(new_n68_));
  nor2   g23(.a(new_n47_), .b(new_n68_), .O(z02));
  nor2   g24(.a(new_n63_), .b(new_n50_), .O(z03));
  ...
  nand2  g38(.a(new_n62_), .b(new_n51_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(x24), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n71_), .c(new_n49_), .O(z08));
  nor2   g41(.a(x15), .b(x07), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n65_), .c(new_n71_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand2  g44(.a(new_n87_), .b(new_n64_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n87_), .c(new_n64_), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n98_), .c(new_n71_), .O(z12));
  ...
  nand3  g64(.a(new_n106_), .b(new_n60_), .c(new_n59_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n91_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  nand2  g67(.a(new_n60_), .b(new_n59_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n102_), .O(new_n114_));
  aoi21  g69(.a(new_n114_), .b(new_n51_), .c(new_n90_), .O(new_n115_));
  aoi21  g70(.a(new_n115_), .b(new_n112_), .c(new_n47_), .O(z16));
  oai21  g71(.a(new_n110_), .b(x23), .c(x24), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n91_), .O(z17));
  nand2  g73(.a(new_n91_), .b(new_n49_), .O(z18));
endmodule
