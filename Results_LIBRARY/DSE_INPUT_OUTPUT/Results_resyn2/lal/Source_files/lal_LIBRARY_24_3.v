...
module FAU ( 
  ...
  oai21  g24(.a(new_n65_), .b(new_n55_), .c(new_n69_), .O(new_n70_));
  ...
  aoi21  g38(.a(new_n72_), .b(x06), .c(new_n83_), .O(z07));
  nand2  g39(.a(new_n65_), .b(new_n54_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(x24), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n69_), .O(z08));
  inv1   g42(.a(x15), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n50_), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(new_n51_), .c(new_n47_), .O(z09));
  nand3  g45(.a(new_n51_), .b(new_n88_), .c(new_n50_), .O(new_n91_));
  ...
  aoi21  g69(.a(new_n114_), .b(new_n63_), .c(new_n91_), .O(new_n115_));
  aoi21  g70(.a(new_n115_), .b(new_n113_), .c(new_n83_), .O(z15));
  oai21  g71(.a(new_n111_), .b(x22), .c(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n110_), .b(new_n118_), .c(new_n63_), .d(new_n62_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n94_), .O(z16));
  oai21  g75(.a(new_n119_), .b(x13), .c(x24), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n114_), .c(new_n63_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n92_), .O(z17));
  nand4  g79(.a(new_n122_), .b(new_n114_), .c(new_n69_), .d(new_n63_), .O(new_n125_));
  nand2  g80(.a(new_n47_), .b(new_n69_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n92_), .O(z18));
endmodule
