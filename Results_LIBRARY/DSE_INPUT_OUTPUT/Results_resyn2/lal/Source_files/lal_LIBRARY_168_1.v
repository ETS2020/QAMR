// Benchmark "FAU" written by ABC on Tue Aug 11 20:07:54 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n87_, new_n90_, new_n91_, new_n93_, new_n94_, new_n96_, new_n97_,
  ...
  aoi21  g19(.a(new_n64_), .b(x08), .c(new_n48_), .O(new_n65_));
  ...
  oai21  g24(.a(new_n64_), .b(new_n48_), .c(new_n69_), .O(new_n70_));
  nand2  g25(.a(new_n70_), .b(new_n50_), .O(z03));
  inv1   g26(.a(x10), .O(new_n72_));
  inv1   g27(.a(x00), .O(new_n73_));
  aoi22  g28(.a(new_n72_), .b(x01), .c(x09), .d(new_n73_), .O(new_n74_));
  oai21  g29(.a(new_n72_), .b(x01), .c(new_n74_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(new_n76_));
  inv1   g31(.a(x12), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(x03), .c(new_n48_), .O(new_n78_));
  inv1   g33(.a(x11), .O(new_n79_));
  oai22  g34(.a(new_n79_), .b(x02), .c(x09), .d(new_n73_), .O(new_n80_));
  nand2  g35(.a(new_n77_), .b(x03), .O(new_n81_));
  nand2  g36(.a(new_n79_), .b(x02), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nor3   g38(.a(new_n83_), .b(new_n80_), .c(new_n78_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n76_), .c(x08), .O(z04));
  aoi21  g40(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  nand3  g41(.a(new_n48_), .b(x14), .c(new_n46_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z06));
  nand3  g43(.a(new_n48_), .b(new_n46_), .c(x06), .O(z07));
  nand2  g44(.a(new_n64_), .b(x08), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(x24), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n69_), .O(z08));
  nor2   g47(.a(x15), .b(x07), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n52_), .c(new_n50_), .O(z09));
  nand2  g50(.a(new_n93_), .b(new_n52_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(new_n49_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n56_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z10));
  nand2  g54(.a(new_n57_), .b(new_n56_), .O(new_n100_));
  nand2  g55(.a(x18), .b(x17), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n97_), .c(new_n100_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z11));
  inv1   g58(.a(new_n96_), .O(new_n104_));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n101_), .b(new_n58_), .O(new_n106_));
  ...
  aoi21  g65(.a(new_n105_), .b(x20), .c(new_n96_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n49_), .O(z13));
  nand2  g67(.a(new_n110_), .b(x21), .O(new_n113_));
  inv1   g68(.a(new_n110_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n61_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n97_), .O(z14));
  nand2  g71(.a(new_n115_), .b(x22), .O(new_n117_));
  nand2  g72(.a(new_n62_), .b(new_n61_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(new_n110_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n117_), .c(new_n97_), .O(z15));
  nand2  g76(.a(new_n120_), .b(x23), .O(new_n122_));
  inv1   g77(.a(x23), .O(new_n123_));
  nand2  g78(.a(new_n119_), .b(new_n123_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n97_), .O(z16));
  nand3  g80(.a(new_n119_), .b(new_n48_), .c(new_n123_), .O(new_n126_));
  nand2  g81(.a(new_n124_), .b(x24), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n97_), .O(z17));
  nand4  g83(.a(new_n119_), .b(new_n69_), .c(new_n48_), .d(new_n123_), .O(new_n129_));
  nand2  g84(.a(new_n50_), .b(new_n69_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n104_), .O(z18));
endmodule
