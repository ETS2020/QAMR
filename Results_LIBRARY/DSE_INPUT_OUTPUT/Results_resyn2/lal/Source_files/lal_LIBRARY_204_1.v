...
module FAU ( 
  ...
  aoi21  g15(.a(new_n60_), .b(x10), .c(new_n50_), .O(new_n61_));
  ...
  nand2  g37(.a(new_n59_), .b(new_n56_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(x24), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n81_), .c(new_n79_), .O(z08));
  nor2   g41(.a(x15), .b(x07), .O(new_n87_));
  and2   g42(.a(new_n87_), .b(new_n48_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n63_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand2  g45(.a(new_n88_), .b(new_n62_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n52_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  nand2  g49(.a(new_n87_), .b(new_n62_), .O(new_n95_));
  xnor2a g50(.a(x18), .b(x17), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n95_), .c(new_n48_), .O(z11));
  ...
  nand2  g56(.a(new_n99_), .b(new_n51_), .O(new_n102_));
  ...
  nand2  g61(.a(new_n106_), .b(new_n57_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n92_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  nand2  g64(.a(new_n58_), .b(new_n57_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(new_n102_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n92_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nand2  g69(.a(new_n111_), .b(new_n82_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n92_), .O(z16));
  nand3  g71(.a(new_n111_), .b(new_n50_), .c(new_n82_), .O(new_n117_));
  nand2  g72(.a(new_n115_), .b(x24), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n92_), .O(z17));
  inv1   g74(.a(new_n95_), .O(new_n120_));
  nand4  g75(.a(new_n111_), .b(new_n81_), .c(new_n50_), .d(new_n82_), .O(new_n121_));
  nand2  g76(.a(new_n48_), .b(new_n81_), .O(new_n122_));
