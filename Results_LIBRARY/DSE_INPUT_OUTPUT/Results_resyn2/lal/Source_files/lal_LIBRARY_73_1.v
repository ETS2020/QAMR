...
module FAU ( 
  ...
  aoi21  g21(.a(new_n46_), .b(x01), .c(x15), .O(new_n67_));
  ...
  nand2  g45(.a(new_n61_), .b(new_n47_), .O(new_n91_));
  ...
  oai21  g52(.a(new_n97_), .b(new_n91_), .c(new_n50_), .O(z11));
  ...
  oai21  g57(.a(new_n102_), .b(new_n91_), .c(new_n50_), .O(z12));
  nand2  g58(.a(x15), .b(x10), .O(new_n104_));
  ...
  nand2  g64(.a(new_n109_), .b(new_n104_), .O(z13));
  inv1   g65(.a(x21), .O(new_n111_));
  nand3  g66(.a(new_n106_), .b(new_n100_), .c(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n61_), .O(new_n113_));
  aoi21  g68(.a(new_n107_), .b(x21), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n104_), .O(z14));
  inv1   g70(.a(x22), .O(new_n116_));
  nand4  g71(.a(new_n106_), .b(new_n100_), .c(new_n116_), .d(new_n111_), .O(new_n117_));
  nand2  g72(.a(new_n112_), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n92_), .O(z15));
  nand2  g74(.a(new_n117_), .b(x23), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n106_), .c(new_n100_), .d(new_n111_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n61_), .O(new_n123_));
  ...
  nor2   g81(.a(x24), .b(x21), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n121_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n106_), .c(new_n100_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n126_), .c(new_n92_), .O(z17));
  nand4  g86(.a(new_n129_), .b(new_n106_), .c(new_n100_), .d(new_n51_), .O(new_n132_));
  aoi21  g87(.a(new_n130_), .b(x25), .c(new_n91_), .O(new_n133_));
  aoi21  g88(.a(new_n133_), .b(new_n132_), .c(new_n48_), .O(z18));
endmodule
