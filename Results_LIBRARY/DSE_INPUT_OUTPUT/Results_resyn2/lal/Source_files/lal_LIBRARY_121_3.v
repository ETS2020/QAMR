...
module FAU ( 
  ...
  nand2  g01(.a(x24), .b(x03), .O(new_n47_));
  ...
  oai21  g25(.a(new_n61_), .b(new_n51_), .c(new_n70_), .O(new_n71_));
  ...
  inv1   g37(.a(new_n74_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z05));
  nand2  g40(.a(new_n83_), .b(x14), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z06));
  nand2  g42(.a(new_n83_), .b(x06), .O(z07));
  nand2  g43(.a(new_n61_), .b(new_n50_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(x24), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n70_), .O(z08));
  inv1   g46(.a(x15), .O(new_n92_));
  nand3  g47(.a(new_n47_), .b(new_n92_), .c(new_n63_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(new_n64_), .O(z09));
  ...
  nand3  g54(.a(new_n64_), .b(new_n92_), .c(new_n63_), .O(new_n100_));
  ...
  oai21  g58(.a(new_n103_), .b(new_n100_), .c(new_n47_), .O(z11));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  aoi21  g60(.a(new_n102_), .b(new_n55_), .c(new_n100_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n47_), .O(z12));
  inv1   g63(.a(new_n105_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n52_), .O(new_n110_));
  nand2  g65(.a(new_n105_), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n97_), .O(z13));
  ...
  aoi21  g70(.a(new_n115_), .b(new_n113_), .c(new_n68_), .O(z14));
  oai21  g71(.a(new_n110_), .b(x21), .c(x22), .O(new_n117_));
  aoi21  g72(.a(new_n114_), .b(new_n59_), .c(new_n100_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n117_), .c(new_n68_), .O(z15));
  nand2  g74(.a(new_n114_), .b(new_n59_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x23), .O(new_n121_));
  nor2   g76(.a(new_n105_), .b(x20), .O(new_n122_));
  nor2   g77(.a(x23), .b(x22), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n58_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n97_), .O(z16));
  inv1   g80(.a(new_n124_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n51_), .O(new_n127_));
  aoi21  g82(.a(new_n124_), .b(x24), .c(new_n100_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n127_), .c(new_n68_), .O(z17));
  nor2   g84(.a(new_n70_), .b(new_n51_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n100_), .c(new_n47_), .O(new_n131_));
  nor2   g86(.a(new_n124_), .b(new_n70_), .O(new_n132_));
  oai21  g87(.a(new_n126_), .b(x25), .c(new_n51_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(z18));
endmodule
