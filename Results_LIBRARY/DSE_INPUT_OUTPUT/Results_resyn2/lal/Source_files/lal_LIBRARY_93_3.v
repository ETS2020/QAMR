...
module FAU ( 
  ...
  oai21  g18(.a(new_n63_), .b(x25), .c(new_n58_), .O(z01));
  nand2  g19(.a(new_n50_), .b(new_n46_), .O(z02));
  nand2  g20(.a(new_n50_), .b(new_n53_), .O(new_n66_));
  aoi21  g21(.a(new_n66_), .b(new_n63_), .c(x25), .O(z03));
  ...
  oai21  g28(.a(new_n73_), .b(x08), .c(new_n50_), .O(z04));
  inv1   g29(.a(x13), .O(new_n75_));
  nor2   g30(.a(new_n49_), .b(x08), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  inv1   g32(.a(new_n77_), .O(z05));
  nand2  g33(.a(new_n76_), .b(x14), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z06));
  nand2  g35(.a(new_n76_), .b(x06), .O(z07));
  oai21  g36(.a(new_n53_), .b(new_n48_), .c(new_n54_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  inv1   g38(.a(x20), .O(new_n84_));
  nand2  g39(.a(new_n60_), .b(new_n59_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand3  g41(.a(x24), .b(x22), .c(x21), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n86_), .c(x25), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(x23), .c(new_n83_), .O(z08));
  inv1   g45(.a(x07), .O(new_n91_));
  nand4  g46(.a(new_n47_), .b(new_n91_), .c(x05), .d(x04), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z09));
  inv1   g48(.a(x17), .O(new_n94_));
  nand2  g49(.a(new_n56_), .b(new_n47_), .O(new_n95_));
  ...
  nand2  g68(.a(new_n48_), .b(x15), .O(new_n114_));
  oai21  g69(.a(new_n107_), .b(x21), .c(x22), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n99_), .c(new_n84_), .d(x19), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n115_), .c(new_n56_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n114_), .O(z15));
  nand2  g75(.a(new_n117_), .b(x23), .O(new_n121_));
  inv1   g76(.a(x22), .O(new_n122_));
  nand4  g77(.a(new_n48_), .b(new_n122_), .c(new_n111_), .d(new_n84_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n103_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n121_), .c(new_n96_), .O(z16));
  oai21  g81(.a(new_n117_), .b(x24), .c(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  oai21  g83(.a(new_n123_), .b(new_n102_), .c(x24), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n56_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n128_), .O(z17));
  oai21  g87(.a(new_n117_), .b(new_n55_), .c(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  nand4  g89(.a(new_n53_), .b(new_n48_), .c(new_n122_), .d(new_n111_), .O(new_n135_));
  oai21  g90(.a(new_n135_), .b(new_n107_), .c(x25), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n56_), .O(new_n137_));
