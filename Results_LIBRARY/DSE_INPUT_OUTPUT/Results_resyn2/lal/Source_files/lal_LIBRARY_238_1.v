...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_,
    ...
    new_n116_, new_n117_, new_n118_, new_n121_;
  ...
  oai21  g10(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  nand2  g11(.a(new_n56_), .b(new_n48_), .O(z01));
  ...
  aoi21  g20(.a(new_n65_), .b(new_n63_), .c(x23), .O(new_n66_));
  oai21  g21(.a(new_n66_), .b(new_n52_), .c(new_n53_), .O(new_n67_));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n61_), .c(x20), .O(new_n83_));
  oai21  g38(.a(new_n64_), .b(new_n83_), .c(new_n81_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n48_), .c(x24), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n53_), .O(z08));
  nor3   g41(.a(x24), .b(x15), .c(x07), .O(new_n87_));
  and2   g42(.a(new_n87_), .b(new_n55_), .O(z09));
  nor2   g43(.a(new_n55_), .b(x15), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n59_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n52_), .c(x07), .O(z10));
  nor2   g46(.a(new_n60_), .b(new_n59_), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(new_n82_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n52_), .c(x07), .O(z11));
  nand2  g50(.a(new_n87_), .b(new_n54_), .O(new_n96_));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nor2   g53(.a(new_n92_), .b(x19), .O(new_n99_));
  nor3   g54(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(z12));
  inv1   g55(.a(new_n96_), .O(new_n101_));
  nand2  g56(.a(new_n98_), .b(new_n58_), .O(new_n102_));
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n101_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(x22), .O(new_n110_));
  nand3  g65(.a(new_n106_), .b(new_n98_), .c(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n89_), .O(new_n112_));
  ...
  nand4  g70(.a(new_n106_), .b(new_n98_), .c(new_n81_), .d(new_n110_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n89_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n52_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n48_), .O(z16));
  nand2  g74(.a(new_n116_), .b(new_n101_), .O(z17));
  aoi21  g75(.a(new_n116_), .b(x25), .c(new_n96_), .O(new_n121_));
  oai21  g76(.a(new_n116_), .b(x25), .c(new_n121_), .O(z18));
endmodule
