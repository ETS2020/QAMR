...
module FAU ( 
  ...
  oai21  g42(.a(new_n87_), .b(new_n83_), .c(new_n60_), .O(z11));
  nand3  g43(.a(x19), .b(x18), .c(x17), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  aoi21  g45(.a(x18), .b(x17), .c(x19), .O(new_n91_));
  nor3   g46(.a(new_n91_), .b(new_n90_), .c(new_n83_), .O(z12));
  nand2  g47(.a(x15), .b(x14), .O(new_n93_));
  nand2  g48(.a(new_n90_), .b(new_n51_), .O(new_n94_));
  ...
  nand3  g59(.a(new_n100_), .b(new_n90_), .c(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n61_), .O(new_n106_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n100_), .c(new_n90_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n61_), .O(new_n112_));
  ...
  nand4  g71(.a(new_n110_), .b(new_n100_), .c(new_n90_), .d(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n115_), .c(new_n84_), .O(z17));
  aoi21  g73(.a(new_n117_), .b(x25), .c(new_n83_), .O(new_n119_));
