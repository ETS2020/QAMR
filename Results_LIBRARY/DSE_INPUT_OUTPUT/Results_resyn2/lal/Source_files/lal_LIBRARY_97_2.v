...
module FAU ( 
  ...
  nand3  g15(.a(x24), .b(x22), .c(x21), .O(new_n61_));
  ...
  oai21  g20(.a(new_n65_), .b(new_n62_), .c(new_n55_), .O(z01));
  ...
  inv1   g34(.a(new_n62_), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(new_n64_), .c(new_n63_), .O(z08));
  inv1   g36(.a(x15), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n52_), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(new_n53_), .c(new_n49_), .O(z09));
  nor2   g39(.a(x24), .b(new_n63_), .O(new_n85_));
  nand3  g40(.a(new_n53_), .b(new_n82_), .c(new_n52_), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n57_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  nand2  g44(.a(new_n58_), .b(new_n57_), .O(new_n90_));
  nand2  g45(.a(x18), .b(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(new_n86_), .c(new_n49_), .O(z11));
  nand3  g48(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  aoi21  g49(.a(new_n91_), .b(new_n59_), .c(new_n86_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n49_), .O(z12));
  inv1   g52(.a(new_n94_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n56_), .O(new_n99_));
  nand2  g54(.a(new_n94_), .b(x20), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n87_), .O(z13));
  nand2  g56(.a(new_n99_), .b(x21), .O(new_n102_));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n98_), .c(new_n86_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n102_), .c(new_n85_), .O(z14));
  ...
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n87_), .O(z15));
  nand2  g65(.a(new_n109_), .b(x23), .O(new_n111_));
  nand3  g66(.a(new_n108_), .b(new_n98_), .c(new_n63_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n87_), .O(z16));
  nand4  g68(.a(new_n108_), .b(new_n98_), .c(new_n48_), .d(new_n63_), .O(new_n114_));
  nand2  g69(.a(new_n86_), .b(new_n49_), .O(new_n115_));
  nand2  g70(.a(new_n112_), .b(x24), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(z17));
  nand2  g72(.a(new_n64_), .b(new_n48_), .O(new_n118_));
  ...
  oai21  g77(.a(new_n122_), .b(new_n94_), .c(new_n64_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n63_), .O(new_n124_));
  aoi22  g79(.a(new_n86_), .b(new_n49_), .c(x25), .d(x24), .O(new_n125_));
