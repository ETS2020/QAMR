...
module FAU ( 
  ...
  oai21  g06(.a(x25), .b(x24), .c(new_n51_), .O(new_n52_));
  ...
  nand2  g15(.a(new_n50_), .b(new_n60_), .O(new_n61_));
  oai21  g16(.a(new_n61_), .b(new_n59_), .c(new_n53_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nor2   g18(.a(new_n48_), .b(new_n63_), .O(z02));
  aoi21  g19(.a(new_n59_), .b(x24), .c(new_n61_), .O(z03));
  nand2  g20(.a(new_n50_), .b(new_n46_), .O(new_n66_));
  ...
  nand3  g36(.a(new_n55_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  inv1   g38(.a(new_n58_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(x23), .O(new_n85_));
  nor2   g40(.a(new_n48_), .b(x25), .O(new_n86_));
  oai21  g41(.a(new_n85_), .b(new_n78_), .c(new_n86_), .O(z08));
  inv1   g42(.a(x07), .O(new_n88_));
  nand4  g43(.a(new_n47_), .b(new_n88_), .c(x05), .d(x04), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n50_), .O(z09));
  nand2  g45(.a(new_n51_), .b(new_n47_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n80_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  nor2   g49(.a(new_n81_), .b(new_n80_), .O(new_n95_));
  nor3   g50(.a(new_n95_), .b(new_n91_), .c(new_n56_), .O(z11));
  ...
  nand2  g56(.a(new_n98_), .b(new_n79_), .O(new_n102_));
  nand2  g57(.a(new_n97_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(new_n51_), .O(new_n104_));
  ...
  nor3   g67(.a(new_n97_), .b(x21), .c(x20), .O(new_n113_));
  ...
  nand3  g72(.a(new_n117_), .b(new_n108_), .c(new_n98_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n92_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  nand3  g75(.a(new_n117_), .b(new_n113_), .c(new_n78_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n92_), .O(z17));
  oai21  g77(.a(new_n118_), .b(x24), .c(x25), .O(new_n123_));
  nand4  g78(.a(new_n117_), .b(new_n113_), .c(new_n60_), .d(new_n78_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n92_), .O(z18));
endmodule
