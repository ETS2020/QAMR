...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_,
    ...
    new_n71_, new_n72_, new_n73_, new_n75_, new_n77_, new_n79_, new_n82_,
  ...
  nand2  g03(.a(x25), .b(new_n48_), .O(new_n49_));
  ...
  nand3  g15(.a(new_n60_), .b(new_n57_), .c(x24), .O(z01));
  ...
  oai21  g20(.a(new_n53_), .b(new_n65_), .c(new_n62_), .O(new_n66_));
  ...
  aoi21  g35(.a(new_n56_), .b(new_n55_), .c(new_n48_), .O(z08));
  nor2   g36(.a(x15), .b(x07), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(new_n59_), .c(new_n49_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z09));
  nand2  g39(.a(new_n82_), .b(new_n58_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x17), .c(new_n49_), .O(z10));
  inv1   g41(.a(new_n64_), .O(new_n87_));
  nand3  g42(.a(new_n82_), .b(new_n58_), .c(new_n49_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nand2  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n87_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z11));
  nand3  g47(.a(x19), .b(x18), .c(x17), .O(new_n93_));
  aoi21  g48(.a(new_n90_), .b(new_n63_), .c(new_n85_), .O(new_n94_));
  ...
  aoi21  g54(.a(new_n99_), .b(new_n98_), .c(new_n79_), .O(z13));
  nand2  g55(.a(new_n98_), .b(x21), .O(new_n101_));
  inv1   g56(.a(x21), .O(new_n102_));
  nand2  g57(.a(new_n97_), .b(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n89_), .O(z14));
  nand2  g59(.a(new_n103_), .b(x22), .O(new_n105_));
  inv1   g60(.a(x22), .O(new_n106_));
  nand3  g61(.a(new_n97_), .b(new_n106_), .c(new_n102_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n89_), .O(z15));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n109_));
  nor2   g64(.a(x23), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n97_), .c(new_n102_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n89_), .O(z16));
  nand2  g67(.a(new_n85_), .b(new_n49_), .O(new_n113_));
  nand2  g68(.a(new_n111_), .b(x24), .O(new_n114_));
  nor2   g69(.a(x25), .b(x24), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n110_), .c(new_n97_), .d(new_n102_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z17));
  oai21  g72(.a(new_n85_), .b(x25), .c(new_n49_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n116_), .O(z18));
endmodule
