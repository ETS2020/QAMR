...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n53_, new_n54_,
    ...
    new_n71_, new_n72_, new_n73_, new_n74_, new_n77_, new_n80_, new_n82_,
  ...
  aoi21  g16(.a(x25), .b(new_n48_), .c(x24), .O(new_n62_));
  ...
  oai21  g21(.a(new_n61_), .b(new_n59_), .c(new_n66_), .O(z01));
  aoi21  g22(.a(new_n59_), .b(x24), .c(new_n61_), .O(z03));
  ...
  nor2   g34(.a(new_n61_), .b(new_n59_), .O(new_n80_));
  nor2   g35(.a(new_n62_), .b(new_n80_), .O(z08));
  inv1   g36(.a(x15), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(new_n64_), .c(new_n50_), .O(z09));
  nand3  g39(.a(new_n64_), .b(new_n82_), .c(new_n63_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x17), .c(new_n50_), .O(z10));
  nand2  g41(.a(new_n55_), .b(new_n54_), .O(new_n87_));
  nor2   g42(.a(new_n85_), .b(new_n49_), .O(new_n88_));
  ...
  oai21  g50(.a(new_n95_), .b(new_n92_), .c(new_n50_), .O(z12));
  ...
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n88_), .O(z14));
  nand2  g59(.a(new_n103_), .b(x22), .O(new_n105_));
  inv1   g60(.a(x22), .O(new_n106_));
  nand3  g61(.a(new_n102_), .b(new_n97_), .c(new_n106_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n88_), .O(z15));
  nand2  g63(.a(new_n85_), .b(new_n50_), .O(new_n109_));
  nand3  g64(.a(new_n107_), .b(x24), .c(x23), .O(new_n110_));
  nand4  g65(.a(new_n102_), .b(new_n97_), .c(new_n48_), .d(new_n106_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(z16));
  nand2  g67(.a(new_n107_), .b(x24), .O(new_n113_));
  inv1   g68(.a(x24), .O(new_n114_));
  nand4  g69(.a(new_n102_), .b(new_n97_), .c(new_n114_), .d(new_n106_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n93_), .d(new_n48_), .O(z17));
  nand2  g71(.a(new_n115_), .b(new_n60_), .O(new_n117_));
  nand4  g72(.a(new_n102_), .b(new_n97_), .c(x25), .d(new_n106_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n48_), .O(new_n119_));
  aoi22  g74(.a(new_n85_), .b(new_n50_), .c(x25), .d(x24), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n119_), .O(z18));
endmodule
