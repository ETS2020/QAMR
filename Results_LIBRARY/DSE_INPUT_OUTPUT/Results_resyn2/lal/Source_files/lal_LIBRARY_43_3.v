...
module FAU ( 
  ...
  nand3  g18(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z01));
  nand2  g19(.a(new_n61_), .b(new_n46_), .O(z03));
  ...
  nand2  g50(.a(new_n95_), .b(new_n46_), .O(z12));
  ...
  aoi21  g61(.a(new_n106_), .b(new_n97_), .c(new_n87_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n105_), .c(new_n48_), .O(z15));
  inv1   g63(.a(x24), .O(new_n109_));
  inv1   g64(.a(x22), .O(new_n110_));
  nand3  g65(.a(new_n102_), .b(new_n97_), .c(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(x23), .O(new_n112_));
  nand2  g67(.a(new_n87_), .b(new_n46_), .O(new_n113_));
  inv1   g68(.a(x23), .O(new_n114_));
  nand3  g69(.a(new_n106_), .b(new_n97_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(z16));
  nand2  g71(.a(new_n111_), .b(new_n109_), .O(new_n117_));
  nand3  g72(.a(new_n106_), .b(new_n97_), .c(x24), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n114_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n113_), .O(z17));
  nor2   g75(.a(x25), .b(x24), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n106_), .c(new_n97_), .d(new_n114_), .O(new_n122_));
  oai21  g77(.a(new_n111_), .b(x24), .c(x25), .O(new_n123_));
  oai21  g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n92_), .O(z18));
endmodule
