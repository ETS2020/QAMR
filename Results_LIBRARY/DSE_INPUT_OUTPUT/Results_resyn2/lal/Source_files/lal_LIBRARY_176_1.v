...
module FAU ( 
  ...
  xnor2a g13(.a(x12), .b(x03), .O(new_n59_));
  ...
  aoi21  g39(.a(new_n78_), .b(new_n84_), .c(new_n74_), .O(new_n85_));
  ...
  aoi21  g45(.a(new_n83_), .b(x20), .c(new_n74_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n90_), .c(new_n49_), .O(z13));
  nand2  g47(.a(new_n90_), .b(x21), .O(new_n93_));
  nor2   g48(.a(x21), .b(x20), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n89_), .c(new_n74_), .O(new_n95_));
  ...
  nand2  g61(.a(new_n74_), .b(new_n50_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(z16));
  nand3  g63(.a(new_n70_), .b(new_n56_), .c(new_n48_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n103_), .c(new_n49_), .O(z17));
  nand2  g66(.a(new_n103_), .b(new_n54_), .O(new_n112_));
  nand4  g67(.a(new_n94_), .b(new_n89_), .c(x25), .d(new_n99_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n48_), .O(new_n114_));
  aoi22  g69(.a(new_n74_), .b(new_n50_), .c(x25), .d(x23), .O(new_n115_));
