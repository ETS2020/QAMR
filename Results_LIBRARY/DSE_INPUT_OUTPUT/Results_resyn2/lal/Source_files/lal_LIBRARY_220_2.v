...
module FAU ( 
  ...
  nand2  g02(.a(new_n47_), .b(x09), .O(new_n48_));
  ...
  aoi21  g10(.a(new_n54_), .b(new_n47_), .c(new_n55_), .O(new_n56_));
  ...
  nand3  g20(.a(new_n57_), .b(new_n48_), .c(new_n50_), .O(z08));
  inv1   g21(.a(z08), .O(z03));
  oai21  g22(.a(x08), .b(x00), .c(x20), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(x09), .O(new_n69_));
  ...
  oai21  g38(.a(x13), .b(x08), .c(new_n48_), .O(z05));
  nand2  g39(.a(x14), .b(new_n46_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n48_), .O(z06));
  aoi21  g41(.a(new_n46_), .b(x06), .c(new_n59_), .O(z07));
  inv1   g42(.a(x07), .O(new_n88_));
  inv1   g43(.a(x15), .O(new_n89_));
  nand4  g44(.a(new_n61_), .b(new_n48_), .c(new_n89_), .d(new_n88_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand3  g46(.a(new_n60_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  ...
  oai21  g51(.a(new_n96_), .b(new_n92_), .c(new_n48_), .O(z11));
  ...
  nor3   g55(.a(new_n100_), .b(new_n92_), .c(new_n59_), .O(z12));
  nor2   g56(.a(new_n98_), .b(x20), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  aoi21  g58(.a(new_n98_), .b(x20), .c(new_n92_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n59_), .O(z13));
  inv1   g60(.a(new_n98_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(x21), .c(x09), .O(new_n107_));
  oai21  g62(.a(new_n102_), .b(x21), .c(new_n107_), .O(new_n108_));
  and2   g63(.a(new_n92_), .b(new_n48_), .O(new_n109_));
  aoi21  g64(.a(x21), .b(x20), .c(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n108_), .O(z14));
  oai21  g66(.a(new_n98_), .b(x21), .c(x22), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n106_), .c(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n70_), .O(new_n116_));
  aoi21  g71(.a(x22), .b(x20), .c(new_n109_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n116_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  nor3   g74(.a(new_n98_), .b(x22), .c(x21), .O(new_n120_));
  nand4  g75(.a(new_n113_), .b(new_n106_), .c(new_n119_), .d(new_n47_), .O(new_n121_));
  oai21  g76(.a(new_n120_), .b(new_n119_), .c(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n70_), .O(new_n123_));
  aoi21  g78(.a(x23), .b(x20), .c(new_n109_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n123_), .O(z16));
  nand2  g80(.a(new_n121_), .b(x24), .O(new_n126_));
  inv1   g81(.a(x24), .O(new_n127_));
  nand3  g82(.a(new_n113_), .b(new_n127_), .c(new_n119_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n102_), .O(new_n130_));
  nand2  g85(.a(new_n127_), .b(x20), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(x09), .c(new_n92_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n126_), .O(z17));
  oai21  g88(.a(new_n128_), .b(new_n103_), .c(new_n50_), .O(new_n134_));
  nand3  g89(.a(new_n129_), .b(new_n106_), .c(x25), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n134_), .c(new_n70_), .O(new_n136_));
  aoi21  g91(.a(x25), .b(x20), .c(new_n109_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n136_), .O(z18));
endmodule
