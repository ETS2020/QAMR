...
module FAU ( 
  ...
  nand2  g37(.a(new_n65_), .b(new_n57_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(new_n47_), .c(x15), .O(z10));
  nor2   g39(.a(x18), .b(x17), .O(new_n85_));
  inv1   g40(.a(x15), .O(new_n86_));
  nand3  g41(.a(new_n65_), .b(new_n86_), .c(new_n47_), .O(new_n87_));
  ...
  aoi21  g48(.a(new_n93_), .b(new_n47_), .c(x15), .O(z12));
  ...
  nand2  g69(.a(new_n114_), .b(new_n86_), .O(z16));
  ...
  nand2  g75(.a(new_n120_), .b(new_n86_), .O(z17));
  aoi21  g76(.a(new_n118_), .b(x25), .c(new_n87_), .O(new_n122_));
