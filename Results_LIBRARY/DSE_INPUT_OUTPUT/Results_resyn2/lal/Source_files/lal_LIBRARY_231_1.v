...
module FAU ( 
  ...
  nand4  g19(.a(new_n64_), .b(new_n51_), .c(new_n52_), .d(new_n60_), .O(new_n65_));
  oai21  g20(.a(new_n59_), .b(new_n50_), .c(new_n65_), .O(z01));
  and2   g21(.a(new_n48_), .b(x16), .O(z02));
  nand3  g22(.a(new_n64_), .b(new_n52_), .c(new_n60_), .O(new_n68_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n63_), .O(new_n102_));
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n93_), .O(z13));
  ...
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n50_), .O(z14));
  ...
  nand2  g72(.a(new_n117_), .b(new_n60_), .O(new_n118_));
  and2   g73(.a(x22), .b(x20), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n92_), .c(new_n48_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(z15));
  xor2a  g76(.a(new_n116_), .b(x23), .O(new_n122_));
  nor2   g77(.a(new_n52_), .b(new_n60_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n92_), .c(new_n48_), .O(new_n124_));
  ...
  oai21  g83(.a(x24), .b(new_n47_), .c(x20), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n128_), .c(new_n126_), .d(new_n100_), .O(z17));
  nand4  g85(.a(new_n127_), .b(new_n115_), .c(new_n110_), .d(new_n51_), .O(new_n131_));
  oai21  g86(.a(new_n50_), .b(x25), .c(new_n128_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n131_), .c(new_n100_), .O(z18));
endmodule
