...
module FAU ( 
  ...
  nand2  g01(.a(x17), .b(x07), .O(new_n47_));
  ...
  nand3  g31(.a(new_n47_), .b(x14), .c(new_n67_), .O(new_n77_));
  inv1   g32(.a(new_n77_), .O(z06));
  aoi21  g33(.a(new_n67_), .b(x06), .c(new_n63_), .O(z07));
  ...
  oai21  g40(.a(new_n85_), .b(new_n55_), .c(new_n84_), .O(z08));
  ...
  nand2  g45(.a(new_n61_), .b(new_n88_), .O(new_n91_));
  ...
  nand2  g52(.a(new_n96_), .b(x19), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nor2   g54(.a(new_n96_), .b(x19), .O(new_n100_));
  nor3   g55(.a(new_n100_), .b(new_n99_), .c(new_n91_), .O(z12));
  and2   g56(.a(x19), .b(x18), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n51_), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n98_), .b(x20), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n92_), .O(z13));
  oai21  g60(.a(x21), .b(x07), .c(new_n52_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n102_), .c(x17), .O(new_n108_));
  nor2   g63(.a(new_n60_), .b(x15), .O(new_n109_));
  nand2  g64(.a(new_n102_), .b(new_n51_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n106_), .O(z14));
  oai21  g69(.a(x22), .b(x07), .c(new_n52_), .O(new_n115_));
  inv1   g70(.a(x22), .O(new_n116_));
  nand4  g71(.a(new_n107_), .b(new_n102_), .c(new_n116_), .d(x17), .O(new_n117_));
  nand2  g72(.a(new_n107_), .b(new_n102_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n109_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n87_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n115_), .O(z15));
  oai21  g77(.a(x23), .b(x07), .c(new_n52_), .O(new_n123_));
  nor2   g78(.a(new_n117_), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n107_), .b(new_n116_), .c(x19), .d(x18), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n109_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n124_), .c(new_n87_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n123_), .O(z16));
  inv1   g84(.a(x21), .O(new_n130_));
  nand4  g85(.a(new_n81_), .b(new_n80_), .c(new_n116_), .d(new_n130_), .O(new_n131_));
  nor2   g86(.a(new_n131_), .b(new_n103_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(new_n91_), .O(new_n133_));
  oai21  g88(.a(new_n124_), .b(new_n81_), .c(new_n133_), .O(z17));
  nand2  g89(.a(new_n132_), .b(new_n50_), .O(new_n135_));
  oai21  g90(.a(new_n131_), .b(new_n103_), .c(x25), .O(new_n136_));
  nand3  g91(.a(new_n136_), .b(new_n135_), .c(new_n92_), .O(z18));
endmodule
