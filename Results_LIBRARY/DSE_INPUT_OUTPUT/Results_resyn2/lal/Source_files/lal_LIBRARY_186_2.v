...
module FAU ( 
  ...
  nand2  g15(.a(x25), .b(new_n47_), .O(new_n61_));
  ...
  oai21  g20(.a(new_n59_), .b(new_n57_), .c(new_n65_), .O(z01));
  inv1   g21(.a(x16), .O(new_n67_));
  nor2   g22(.a(new_n48_), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n61_), .b(new_n60_), .O(new_n69_));
  oai21  g24(.a(new_n59_), .b(new_n57_), .c(new_n69_), .O(z03));
  ...
  nand3  g38(.a(new_n83_), .b(new_n58_), .c(new_n47_), .O(z08));
  inv1   g39(.a(x15), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n62_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n63_), .c(new_n49_), .O(z09));
  ...
  nand2  g50(.a(new_n91_), .b(new_n54_), .O(new_n96_));
  ...
  nor2   g55(.a(new_n100_), .b(new_n88_), .O(new_n101_));
  ...
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(new_n88_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n104_), .c(new_n48_), .O(z14));
  nand4  g63(.a(new_n106_), .b(x19), .c(x18), .d(x17), .O(new_n109_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n94_), .d(new_n49_), .O(z15));
  nand2  g68(.a(x24), .b(new_n111_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n109_), .c(x23), .O(new_n115_));
  nand4  g70(.a(new_n106_), .b(new_n105_), .c(new_n47_), .d(new_n111_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n94_), .O(z16));
  nand2  g72(.a(new_n88_), .b(new_n49_), .O(new_n118_));
  nand2  g73(.a(new_n116_), .b(x24), .O(new_n119_));
  inv1   g74(.a(x21), .O(new_n120_));
  nand3  g75(.a(new_n60_), .b(new_n111_), .c(new_n120_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n100_), .c(new_n47_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n118_), .O(z17));
  oai21  g79(.a(new_n121_), .b(new_n103_), .c(x25), .O(new_n125_));
  nand3  g80(.a(new_n122_), .b(new_n100_), .c(new_n58_), .O(new_n126_));
  nand2  g81(.a(new_n58_), .b(x24), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(x23), .c(new_n88_), .O(new_n128_));
