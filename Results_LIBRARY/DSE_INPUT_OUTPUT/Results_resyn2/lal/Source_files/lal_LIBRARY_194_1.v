...
module FAU ( 
  ...
  oai21  g16(.a(new_n52_), .b(x24), .c(new_n48_), .O(new_n62_));
  nand2  g17(.a(x05), .b(x04), .O(new_n63_));
  inv1   g18(.a(new_n63_), .O(new_n64_));
  nor2   g19(.a(new_n64_), .b(x07), .O(new_n65_));
  nand3  g20(.a(new_n65_), .b(new_n62_), .c(new_n61_), .O(z01));
  nand2  g21(.a(new_n61_), .b(new_n49_), .O(z03));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n52_), .c(new_n79_), .O(z08));
  nor2   g36(.a(x15), .b(x07), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n64_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z09));
  oai21  g39(.a(x15), .b(x07), .c(new_n49_), .O(new_n85_));
  aoi21  g40(.a(new_n49_), .b(x17), .c(new_n64_), .O(new_n86_));
  and2   g41(.a(new_n86_), .b(new_n85_), .O(z10));
  inv1   g42(.a(x15), .O(new_n88_));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n65_), .c(new_n49_), .d(new_n88_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z11));
  nand2  g46(.a(new_n65_), .b(new_n88_), .O(new_n92_));
  ...
  oai21  g50(.a(new_n95_), .b(new_n92_), .c(new_n49_), .O(z12));
  nor2   g51(.a(new_n92_), .b(new_n79_), .O(new_n97_));
  ...
  aoi21  g61(.a(new_n99_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nor2   g62(.a(x22), .b(x21), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n99_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n82_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n107_), .c(new_n49_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n63_), .O(z15));
  inv1   g67(.a(x23), .O(new_n113_));
  aoi21  g68(.a(new_n108_), .b(new_n99_), .c(new_n113_), .O(new_n114_));
  nand3  g69(.a(new_n108_), .b(new_n99_), .c(new_n113_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n82_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n49_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n63_), .O(z16));
  aoi21  g73(.a(new_n115_), .b(x24), .c(x04), .O(new_n119_));
  inv1   g74(.a(x24), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n99_), .c(new_n120_), .d(new_n113_), .O(new_n121_));
  and2   g76(.a(new_n121_), .b(new_n85_), .O(new_n122_));
  oai21  g77(.a(new_n119_), .b(new_n48_), .c(new_n122_), .O(z17));
  or2    g78(.a(new_n121_), .b(x25), .O(new_n124_));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n97_), .O(z18));
endmodule
