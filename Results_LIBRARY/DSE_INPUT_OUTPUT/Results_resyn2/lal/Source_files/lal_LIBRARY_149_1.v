...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n73_, new_n76_, new_n79_, new_n80_, new_n82_, new_n84_,
  ...
  nand3  g19(.a(new_n59_), .b(new_n48_), .c(new_n51_), .O(z08));
  ...
  nand3  g34(.a(new_n61_), .b(new_n79_), .c(new_n47_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z09));
  nand2  g36(.a(new_n60_), .b(new_n53_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n79_), .c(x07), .O(z10));
  nand2  g38(.a(new_n54_), .b(new_n53_), .O(new_n84_));
  nand2  g39(.a(x18), .b(x17), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n60_), .c(new_n84_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n79_), .c(x07), .O(z11));
  nand3  g42(.a(new_n60_), .b(new_n79_), .c(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  aoi21  g46(.a(new_n85_), .b(new_n55_), .c(new_n91_), .O(z12));
  nor2   g47(.a(new_n90_), .b(x20), .O(new_n93_));
  nand2  g48(.a(new_n90_), .b(x20), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n60_), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n93_), .c(new_n79_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n47_), .O(z13));
  inv1   g52(.a(x21), .O(new_n98_));
  aoi21  g53(.a(new_n93_), .b(new_n98_), .c(new_n61_), .O(new_n99_));
  oai21  g54(.a(new_n93_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n79_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(z14));
  inv1   g57(.a(x22), .O(new_n103_));
  aoi21  g58(.a(new_n93_), .b(new_n98_), .c(new_n103_), .O(new_n104_));
  nor2   g59(.a(x22), .b(x21), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n93_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n60_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n104_), .c(new_n79_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(z15));
  nand2  g64(.a(new_n106_), .b(x23), .O(new_n110_));
  inv1   g65(.a(x23), .O(new_n111_));
  nand3  g66(.a(new_n105_), .b(new_n93_), .c(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n89_), .O(z16));
  nor2   g68(.a(x24), .b(x23), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n105_), .c(new_n93_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n60_), .O(new_n116_));
  aoi21  g71(.a(new_n112_), .b(x24), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(x15), .c(new_n47_), .O(z17));
  nor2   g73(.a(new_n115_), .b(x25), .O(new_n119_));
  nand2  g74(.a(new_n115_), .b(x25), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n60_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(new_n79_), .O(new_n122_));
