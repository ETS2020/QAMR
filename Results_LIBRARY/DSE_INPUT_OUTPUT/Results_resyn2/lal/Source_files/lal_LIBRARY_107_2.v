...
module FAU ( 
  ...
  nand3  g19(.a(new_n58_), .b(new_n64_), .c(new_n50_), .O(z08));
  inv1   g20(.a(z08), .O(z03));
  nand2  g21(.a(new_n64_), .b(new_n46_), .O(new_n67_));
  ...
  nor2   g33(.a(new_n60_), .b(x15), .O(z09));
  ...
  nand2  g39(.a(new_n60_), .b(new_n84_), .O(new_n85_));
  nand2  g40(.a(x18), .b(x17), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor3   g42(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(z11));
  nand2  g43(.a(new_n86_), .b(new_n54_), .O(new_n89_));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n80_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n47_), .c(x15), .O(z12));
  inv1   g47(.a(new_n90_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n51_), .O(new_n94_));
  nand2  g49(.a(new_n90_), .b(x20), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n80_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n84_), .O(z13));
  inv1   g53(.a(new_n85_), .O(new_n99_));
  ...
  nand3  g60(.a(new_n101_), .b(new_n93_), .c(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n99_), .O(z15));
  nand2  g62(.a(new_n106_), .b(x23), .O(new_n108_));
  nor2   g63(.a(x23), .b(x22), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n101_), .c(new_n93_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n80_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n84_), .O(z16));
  nand2  g68(.a(new_n110_), .b(x24), .O(new_n114_));
  inv1   g69(.a(x24), .O(new_n115_));
  nand4  g70(.a(new_n109_), .b(new_n101_), .c(new_n93_), .d(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n99_), .O(z17));
  aoi21  g72(.a(new_n116_), .b(x25), .c(new_n85_), .O(new_n118_));
  oai21  g73(.a(new_n116_), .b(x25), .c(new_n118_), .O(z18));
endmodule
