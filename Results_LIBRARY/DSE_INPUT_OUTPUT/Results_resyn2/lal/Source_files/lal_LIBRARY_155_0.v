...
module FAU ( 
  ...
  nand2  g03(.a(new_n48_), .b(new_n47_), .O(z16));
  oai21  g04(.a(x16), .b(new_n46_), .c(z16), .O(z00));
  ...
  nand2  g20(.a(z16), .b(new_n65_), .O(z02));
  nand2  g21(.a(new_n60_), .b(z16), .O(z03));
  nand2  g22(.a(z16), .b(new_n46_), .O(new_n68_));
  ...
  inv1   g33(.a(z16), .O(z11));
  aoi21  g34(.a(new_n46_), .b(x06), .c(z11), .O(z07));
  aoi21  g35(.a(new_n59_), .b(new_n51_), .c(z11), .O(z08));
  zero   g36(.O(z09));
  zero   g37(.O(z10));
  zero   g38(.O(z12));
  one    g39(.O(z13));
  ...
  one    g41(.O(z15));
  one    g42(.O(z18));
  nand2  g43(.a(new_n48_), .b(new_n47_), .O(z17));
endmodule
