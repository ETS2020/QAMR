...
module FAU ( 
  ...
  nor2   g27(.a(new_n72_), .b(new_n49_), .O(new_n73_));
  nand3  g28(.a(new_n73_), .b(x05), .c(x04), .O(new_n74_));
  inv1   g29(.a(new_n74_), .O(z09));
  nand2  g30(.a(new_n53_), .b(new_n71_), .O(new_n76_));
  oai21  g31(.a(new_n76_), .b(x17), .c(new_n50_), .O(z10));
  xnor2a g32(.a(x18), .b(x17), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n76_), .c(new_n50_), .O(z11));
  aoi21  g34(.a(x18), .b(x17), .c(x19), .O(new_n80_));
  nand3  g35(.a(x19), .b(x18), .c(x17), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(new_n82_));
  or2    g37(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(new_n76_), .c(new_n50_), .O(z12));
  ...
  nand4  g43(.a(new_n88_), .b(new_n86_), .c(new_n73_), .d(new_n85_), .O(z13));
  inv1   g44(.a(x21), .O(new_n90_));
  nand3  g45(.a(new_n82_), .b(new_n90_), .c(new_n87_), .O(new_n91_));
  aoi21  g46(.a(new_n88_), .b(x21), .c(new_n76_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n91_), .c(new_n49_), .O(z14));
  inv1   g48(.a(x22), .O(new_n94_));
  nor3   g49(.a(new_n81_), .b(x21), .c(x20), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g51(.a(new_n91_), .b(x22), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n96_), .c(new_n73_), .d(new_n85_), .O(z15));
  nand2  g53(.a(new_n76_), .b(new_n50_), .O(new_n99_));
  oai21  g54(.a(new_n91_), .b(x22), .c(x23), .O(new_n100_));
  nor2   g55(.a(x23), .b(x22), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n48_), .c(new_n90_), .O(new_n102_));
  or2    g57(.a(new_n102_), .b(new_n88_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n100_), .c(new_n99_), .O(z16));
  inv1   g59(.a(new_n76_), .O(new_n105_));
  nand2  g60(.a(new_n101_), .b(new_n95_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n48_), .O(z17));
  inv1   g62(.a(x23), .O(new_n108_));
  nand4  g63(.a(new_n54_), .b(new_n94_), .c(new_n90_), .d(new_n87_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n81_), .c(new_n48_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  oai21  g66(.a(new_n102_), .b(new_n88_), .c(x25), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n105_), .O(z18));
endmodule
