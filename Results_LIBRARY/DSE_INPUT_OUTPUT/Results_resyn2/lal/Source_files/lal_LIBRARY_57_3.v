...
module FAU ( 
  ...
  oai21  g22(.a(new_n62_), .b(x25), .c(new_n67_), .O(z01));
  nor2   g23(.a(new_n49_), .b(new_n46_), .O(z02));
  inv1   g24(.a(x24), .O(new_n70_));
  inv1   g25(.a(x25), .O(new_n71_));
  aoi21  g26(.a(new_n60_), .b(new_n58_), .c(x23), .O(new_n72_));
  oai21  g27(.a(new_n72_), .b(new_n70_), .c(new_n71_), .O(new_n73_));
  ...
  nor2   g38(.a(x13), .b(x08), .O(z05));
  nand2  g39(.a(x14), .b(new_n75_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n50_), .O(z06));
  nand3  g41(.a(new_n50_), .b(new_n75_), .c(x06), .O(z07));
  nand2  g42(.a(new_n62_), .b(x24), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n50_), .c(new_n71_), .O(z08));
  ...
  nand3  g48(.a(new_n63_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  ...
  nor3   g54(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(z11));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(new_n102_));
  nor2   g57(.a(new_n99_), .b(x19), .O(new_n103_));
  nor3   g58(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z12));
  inv1   g59(.a(new_n98_), .O(new_n105_));
  nand2  g60(.a(new_n102_), .b(new_n53_), .O(new_n106_));
  ...
  aoi21  g65(.a(new_n110_), .b(new_n102_), .c(new_n94_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n109_), .c(new_n49_), .O(z14));
  nand2  g67(.a(new_n110_), .b(new_n102_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x22), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  nand3  g70(.a(new_n110_), .b(new_n102_), .c(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n105_), .O(z15));
  oai21  g72(.a(new_n116_), .b(new_n94_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n97_), .b(new_n48_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  aoi22  g75(.a(new_n120_), .b(new_n116_), .c(new_n118_), .d(x23), .O(z16));
  inv1   g76(.a(new_n116_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n70_), .c(new_n48_), .O(new_n123_));
  oai22  g78(.a(new_n116_), .b(x23), .c(new_n49_), .d(x24), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n97_), .O(z17));
  nor2   g80(.a(new_n71_), .b(new_n48_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n94_), .c(new_n50_), .O(new_n127_));
  nor2   g82(.a(x24), .b(x22), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n110_), .c(new_n102_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(x25), .O(new_n130_));
  nand4  g85(.a(new_n110_), .b(new_n102_), .c(new_n64_), .d(new_n115_), .O(new_n131_));
