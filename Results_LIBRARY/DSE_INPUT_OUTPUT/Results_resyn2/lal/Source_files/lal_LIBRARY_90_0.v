...
module FAU ( 
  ...
  nand3  g16(.a(new_n61_), .b(new_n53_), .c(new_n52_), .O(new_n62_));
  aoi21  g17(.a(x25), .b(x13), .c(x24), .O(new_n63_));
  nand2  g18(.a(x05), .b(x04), .O(new_n64_));
  inv1   g19(.a(new_n64_), .O(new_n65_));
  nor3   g20(.a(new_n65_), .b(new_n63_), .c(x07), .O(new_n66_));
  nand2  g21(.a(new_n66_), .b(new_n62_), .O(z01));
  inv1   g22(.a(new_n63_), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(new_n62_), .O(z03));
  ...
  aoi21  g32(.a(x24), .b(x08), .c(x13), .O(z05));
  ...
  aoi21  g37(.a(new_n60_), .b(new_n59_), .c(x23), .O(new_n83_));
  nor2   g38(.a(new_n48_), .b(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n82_), .c(new_n84_), .O(z08));
  nor2   g40(.a(x15), .b(x07), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n65_), .c(new_n49_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand2  g43(.a(new_n86_), .b(new_n64_), .O(new_n89_));
  ...
  nor3   g53(.a(new_n98_), .b(new_n89_), .c(new_n48_), .O(z12));
