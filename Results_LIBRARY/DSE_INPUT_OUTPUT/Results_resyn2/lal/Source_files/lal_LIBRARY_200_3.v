...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n74_, new_n77_, new_n78_, new_n79_, new_n80_, new_n82_, new_n83_,
  ...
  and2   g16(.a(new_n59_), .b(x16), .O(z02));
  nand2  g17(.a(new_n59_), .b(new_n58_), .O(z03));
  ...
  nand2  g24(.a(new_n69_), .b(new_n59_), .O(z04));
  oai21  g25(.a(x13), .b(x08), .c(new_n59_), .O(z05));
  inv1   g26(.a(x14), .O(new_n72_));
  oai21  g27(.a(new_n72_), .b(x08), .c(new_n59_), .O(z06));
  inv1   g28(.a(new_n59_), .O(new_n74_));
  aoi21  g29(.a(new_n46_), .b(x06), .c(new_n74_), .O(z07));
  aoi21  g30(.a(new_n57_), .b(new_n49_), .c(new_n74_), .O(z08));
  nand2  g31(.a(x05), .b(x04), .O(new_n77_));
  inv1   g32(.a(x07), .O(new_n78_));
  inv1   g33(.a(x15), .O(new_n79_));
  nand3  g34(.a(new_n59_), .b(new_n79_), .c(new_n78_), .O(new_n80_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n96_), .c(new_n101_), .O(new_n110_));
  ...
  aoi21  g68(.a(new_n110_), .b(x24), .c(new_n87_), .O(new_n114_));
  aoi21  g69(.a(new_n114_), .b(new_n113_), .c(new_n74_), .O(z17));
  nor2   g70(.a(new_n49_), .b(new_n47_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n87_), .c(new_n59_), .O(new_n117_));
  nor2   g72(.a(new_n110_), .b(new_n49_), .O(new_n118_));
  nand2  g73(.a(new_n110_), .b(new_n49_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(z18));
endmodule
