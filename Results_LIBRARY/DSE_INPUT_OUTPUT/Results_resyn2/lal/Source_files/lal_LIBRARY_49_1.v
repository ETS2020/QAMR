...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n74_, new_n76_, new_n78_, new_n82_,
  ...
  nand3  g21(.a(new_n58_), .b(new_n48_), .c(new_n50_), .O(new_n67_));
  ...
  aoi22  g35(.a(new_n58_), .b(new_n50_), .c(x15), .d(new_n47_), .O(z08));
  nand4  g36(.a(new_n60_), .b(new_n47_), .c(x05), .d(x04), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z09));
  nand2  g38(.a(new_n61_), .b(new_n52_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n60_), .c(x07), .O(z10));
  nor2   g40(.a(x18), .b(x17), .O(new_n86_));
  nand2  g41(.a(x18), .b(x17), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(new_n88_));
  nor3   g43(.a(new_n88_), .b(new_n62_), .c(new_n86_), .O(z11));
  ...
  aoi21  g47(.a(new_n92_), .b(new_n60_), .c(x07), .O(z12));
  inv1   g48(.a(new_n91_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n51_), .O(new_n95_));
  ...
  nand3  g60(.a(new_n99_), .b(new_n94_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g66(.a(new_n111_), .b(new_n99_), .c(new_n94_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n61_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n60_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(z16));
  nand2  g70(.a(new_n112_), .b(x24), .O(new_n116_));
  inv1   g71(.a(x24), .O(new_n117_));
  nand4  g72(.a(new_n111_), .b(new_n99_), .c(new_n94_), .d(new_n117_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n63_), .O(z17));
  aoi21  g74(.a(new_n118_), .b(x25), .c(new_n62_), .O(new_n120_));
