...
module FAU ( 
  ...
  nor2   g00(.a(x15), .b(x07), .O(z09));
  inv1   g01(.a(z09), .O(z13));
  nor2   g02(.a(z09), .b(x08), .O(new_n48_));
  aoi21  g03(.a(z13), .b(x16), .c(new_n48_), .O(z00));
  ...
  nand3  g20(.a(new_n60_), .b(z13), .c(new_n52_), .O(z08));
  ...
  oai21  g28(.a(new_n73_), .b(x08), .c(z13), .O(z04));
  nor3   g29(.a(z09), .b(x13), .c(x08), .O(z05));
  and2   g30(.a(new_n48_), .b(x14), .O(z06));
  nand2  g31(.a(new_n48_), .b(x06), .O(z07));
  zero   g32(.O(z10));
  one    g33(.O(z15));
  one    g34(.O(z16));
  nor2   g35(.a(x15), .b(x07), .O(z11));
  nor2   g36(.a(x15), .b(x07), .O(z12));
  inv1   g37(.a(z09), .O(z14));
  inv1   g38(.a(z09), .O(z17));
  inv1   g39(.a(z09), .O(z18));
endmodule
