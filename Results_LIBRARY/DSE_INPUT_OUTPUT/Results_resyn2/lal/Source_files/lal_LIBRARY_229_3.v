...
module FAU ( 
  ...
  oai21  g23(.a(new_n64_), .b(new_n54_), .c(new_n68_), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(new_n47_), .O(z03));
  inv1   g25(.a(x08), .O(new_n71_));
  nand2  g26(.a(new_n47_), .b(new_n71_), .O(new_n72_));
  ...
  nor3   g49(.a(new_n94_), .b(new_n90_), .c(new_n92_), .O(z11));
  ...
  nand2  g56(.a(new_n101_), .b(new_n55_), .O(new_n102_));
  ...
  nor2   g60(.a(new_n102_), .b(x21), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  nand2  g64(.a(new_n106_), .b(new_n62_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n100_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  nor2   g67(.a(new_n97_), .b(x20), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n61_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n51_), .d(new_n53_), .O(z16));
  nand3  g71(.a(new_n115_), .b(x24), .c(new_n53_), .O(new_n117_));
  inv1   g72(.a(new_n115_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n54_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n52_), .O(z17));
  nand3  g75(.a(new_n118_), .b(new_n68_), .c(new_n54_), .O(new_n121_));
  oai21  g76(.a(new_n115_), .b(x24), .c(x25), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n100_), .O(z18));
endmodule
