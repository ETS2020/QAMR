...
module FAU ( 
  ...
  nand3  g37(.a(new_n48_), .b(new_n46_), .c(x06), .O(z07));
  ...
  oai21  g51(.a(new_n96_), .b(new_n90_), .c(new_n48_), .O(z11));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n95_), .b(new_n59_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nor3   g55(.a(new_n100_), .b(new_n90_), .c(new_n47_), .O(z12));
  nor2   g56(.a(new_n98_), .b(x20), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand2  g58(.a(new_n98_), .b(x20), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n91_), .O(z13));
  nand2  g60(.a(new_n103_), .b(x21), .O(new_n106_));
  inv1   g61(.a(x21), .O(new_n107_));
  aoi21  g62(.a(new_n102_), .b(new_n107_), .c(new_n90_), .O(new_n108_));
  aoi21  g63(.a(new_n108_), .b(new_n106_), .c(new_n47_), .O(z14));
  inv1   g64(.a(x22), .O(new_n110_));
  nand3  g65(.a(new_n102_), .b(new_n110_), .c(new_n107_), .O(new_n111_));
  oai21  g66(.a(new_n103_), .b(x21), .c(x22), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n91_), .O(z15));
  nor2   g68(.a(new_n111_), .b(x23), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand2  g70(.a(new_n111_), .b(x23), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n91_), .O(z16));
  inv1   g72(.a(new_n90_), .O(new_n118_));
  oai22  g73(.a(new_n114_), .b(new_n55_), .c(new_n118_), .d(new_n47_), .O(z17));
  nand3  g74(.a(new_n118_), .b(new_n48_), .c(new_n66_), .O(z18));
endmodule
