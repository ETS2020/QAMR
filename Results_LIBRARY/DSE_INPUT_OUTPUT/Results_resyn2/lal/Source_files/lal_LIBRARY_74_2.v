...
module FAU ( 
  ...
  nand3  g32(.a(new_n59_), .b(new_n48_), .c(new_n51_), .O(z08));
  inv1   g33(.a(x07), .O(new_n79_));
  inv1   g34(.a(x15), .O(new_n80_));
  nand3  g35(.a(new_n61_), .b(new_n80_), .c(new_n79_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z09));
  nand2  g37(.a(new_n62_), .b(new_n80_), .O(new_n83_));
  ...
  nor2   g53(.a(new_n61_), .b(x15), .O(new_n99_));
  ...
  nor2   g58(.a(new_n96_), .b(new_n103_), .O(new_n104_));
  nand2  g59(.a(new_n96_), .b(new_n103_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n99_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n104_), .c(new_n79_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n95_), .O(z14));
  inv1   g63(.a(x22), .O(new_n109_));
  nand3  g64(.a(new_n96_), .b(new_n109_), .c(new_n103_), .O(new_n110_));
  ...
  nand2  g68(.a(new_n113_), .b(new_n95_), .O(z15));
  ...
  nand4  g73(.a(new_n96_), .b(new_n118_), .c(new_n109_), .d(new_n103_), .O(new_n119_));
  or2    g74(.a(new_n119_), .b(x07), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n117_), .c(new_n95_), .O(z16));
  oai21  g76(.a(new_n119_), .b(x07), .c(x24), .O(new_n122_));
  oai21  g77(.a(new_n119_), .b(x24), .c(new_n99_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n79_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n122_), .O(z17));
  nor2   g80(.a(new_n119_), .b(x24), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n51_), .O(new_n127_));
  oai21  g82(.a(new_n119_), .b(x24), .c(x25), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n127_), .c(new_n84_), .O(z18));
endmodule
