...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n70_, new_n73_, new_n77_, new_n78_, new_n80_, new_n81_, new_n82_,
  ...
  nand2  g18(.a(new_n61_), .b(new_n50_), .O(z03));
  ...
  oai21  g26(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  nand2  g27(.a(x14), .b(new_n46_), .O(new_n73_));
  nand2  g28(.a(new_n73_), .b(new_n50_), .O(z06));
  aoi21  g29(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  nand3  g30(.a(new_n60_), .b(new_n50_), .c(new_n52_), .O(z08));
  inv1   g31(.a(x07), .O(new_n77_));
  nand4  g32(.a(new_n47_), .b(new_n77_), .c(x05), .d(x04), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n50_), .O(z09));
  nand2  g34(.a(new_n62_), .b(new_n47_), .O(new_n80_));
