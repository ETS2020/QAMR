...
module FAU ( 
  ...
  or2    g05(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  ...
  aoi21  g16(.a(new_n61_), .b(new_n52_), .c(new_n53_), .O(new_n62_));
  oai21  g17(.a(new_n62_), .b(x25), .c(new_n51_), .O(z01));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n78_), .c(new_n49_), .O(z08));
  inv1   g38(.a(x07), .O(new_n84_));
  nand4  g39(.a(new_n52_), .b(new_n84_), .c(x05), .d(x04), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n47_), .O(z09));
  nand2  g41(.a(new_n50_), .b(new_n52_), .O(new_n87_));
  ...
  oai21  g47(.a(new_n56_), .b(new_n55_), .c(new_n57_), .O(new_n93_));
  nand3  g48(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n87_), .c(new_n47_), .O(z12));
  nor2   g51(.a(new_n94_), .b(x20), .O(new_n97_));
  ...
  aoi21  g57(.a(new_n97_), .b(new_n102_), .c(new_n87_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n101_), .c(new_n49_), .O(z14));
  oai21  g59(.a(new_n98_), .b(x21), .c(x22), .O(new_n105_));
  ...
  nand3  g64(.a(new_n106_), .b(new_n97_), .c(new_n79_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n88_), .O(z16));
  ...
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n88_), .O(z17));
  oai21  g70(.a(new_n110_), .b(x25), .c(new_n52_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n53_), .O(new_n117_));
  nand2  g72(.a(new_n114_), .b(x25), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n50_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n52_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n117_), .O(z18));
endmodule
