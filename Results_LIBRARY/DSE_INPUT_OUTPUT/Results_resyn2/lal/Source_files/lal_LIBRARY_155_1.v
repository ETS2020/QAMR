// Benchmark "FAU" written by ABC on Tue Aug 11 20:07:46 2020
...
module FAU ( 
  ...
  nor2   g15(.a(x15), .b(x07), .O(new_n61_));
  ...
  nand3  g55(.a(new_n100_), .b(new_n97_), .c(new_n63_), .O(z14));
  nand2  g56(.a(new_n100_), .b(x22), .O(new_n102_));
  inv1   g57(.a(x22), .O(new_n103_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n63_), .O(z15));
  nand2  g60(.a(new_n104_), .b(x23), .O(new_n106_));
  nor2   g61(.a(x23), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n99_), .c(new_n98_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n60_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n86_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(z16));
  nor2   g66(.a(x24), .b(x21), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n107_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n94_), .c(new_n60_), .O(new_n114_));
  aoi21  g69(.a(new_n108_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x15), .c(new_n47_), .O(z17));
  nor2   g71(.a(new_n113_), .b(new_n94_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n50_), .O(new_n118_));
  oai21  g73(.a(new_n113_), .b(new_n94_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n63_), .O(z18));
endmodule
