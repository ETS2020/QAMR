...
module FAU ( 
  ...
  nand3  g21(.a(new_n58_), .b(z13), .c(new_n50_), .O(new_n67_));
  ...
  aoi21  g34(.a(new_n58_), .b(new_n50_), .c(z11), .O(z08));
  zero   g35(.O(z09));
  zero   g36(.O(z10));
  zero   g37(.O(z12));
  one    g38(.O(z17));
  inv1   g39(.a(z11), .O(z14));
  inv1   g40(.a(z11), .O(z15));
  inv1   g41(.a(z11), .O(z16));
  inv1   g42(.a(z11), .O(z18));
endmodule
