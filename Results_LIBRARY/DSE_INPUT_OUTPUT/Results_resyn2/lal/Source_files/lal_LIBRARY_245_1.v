...
module FAU ( 
  ...
  nand2  g37(.a(new_n82_), .b(new_n74_), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n81_), .c(new_n77_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z11));
  inv1   g40(.a(new_n76_), .O(new_n86_));
  nand3  g41(.a(x19), .b(x18), .c(x17), .O(new_n87_));
  inv1   g42(.a(x19), .O(new_n88_));
  nand2  g43(.a(new_n81_), .b(new_n88_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(new_n90_));
  ...
  nor2   g50(.a(new_n95_), .b(new_n76_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n92_), .c(new_n48_), .O(z13));
  nand2  g52(.a(new_n94_), .b(x21), .O(new_n98_));
  inv1   g53(.a(x21), .O(new_n99_));
  nand4  g54(.a(new_n80_), .b(new_n99_), .c(new_n93_), .d(x19), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n86_), .O(new_n101_));
  and2   g56(.a(new_n101_), .b(new_n49_), .O(z14));
  inv1   g57(.a(x22), .O(new_n103_));
  nand3  g58(.a(new_n95_), .b(new_n103_), .c(new_n99_), .O(new_n104_));
  nand2  g59(.a(new_n100_), .b(x22), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n77_), .O(z15));
  oai21  g61(.a(new_n100_), .b(x22), .c(x23), .O(new_n107_));
  nand2  g62(.a(new_n76_), .b(new_n49_), .O(new_n108_));
  inv1   g63(.a(x23), .O(new_n109_));
  nor2   g64(.a(x22), .b(x21), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n47_), .c(new_n109_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n95_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n108_), .c(new_n107_), .O(z16));
  nand2  g69(.a(x24), .b(x23), .O(new_n115_));
  inv1   g70(.a(new_n87_), .O(new_n116_));
  nor2   g71(.a(x23), .b(x20), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n110_), .c(new_n116_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n86_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n115_), .O(z17));
  nand2  g76(.a(new_n110_), .b(new_n51_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n94_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n109_), .O(new_n124_));
  oai21  g79(.a(new_n111_), .b(new_n94_), .c(x25), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n86_), .O(z18));
endmodule
