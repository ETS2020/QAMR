...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n76_, new_n79_, new_n81_, new_n83_,
  ...
  nand3  g19(.a(new_n58_), .b(new_n48_), .c(new_n50_), .O(new_n65_));
  ...
  aoi21  g34(.a(new_n58_), .b(new_n50_), .c(new_n79_), .O(z08));
  inv1   g35(.a(x15), .O(new_n81_));
  aoi21  g36(.a(new_n59_), .b(new_n81_), .c(x07), .O(z09));
  nand3  g37(.a(new_n59_), .b(new_n81_), .c(new_n47_), .O(new_n83_));
  ...
  and2   g60(.a(new_n104_), .b(x23), .O(new_n106_));
  oai21  g61(.a(new_n104_), .b(x23), .c(new_n59_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n106_), .c(new_n81_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(z16));
  oai21  g64(.a(new_n104_), .b(x23), .c(x24), .O(new_n110_));
  nor2   g65(.a(x24), .b(x23), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n103_), .c(new_n94_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n84_), .O(z17));
  nor2   g68(.a(new_n112_), .b(x25), .O(new_n114_));
  nand2  g69(.a(new_n112_), .b(x25), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n59_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n81_), .O(new_n117_));
