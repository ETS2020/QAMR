...
module FAU ( 
  ...
  nand2  g40(.a(new_n85_), .b(new_n64_), .O(z04));
  nor3   g41(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  nand2  g42(.a(x14), .b(new_n46_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n64_), .O(z06));
  nand3  g44(.a(new_n64_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g45(.a(new_n58_), .b(new_n50_), .c(new_n48_), .O(z08));
  inv1   g46(.a(x15), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n47_), .c(x05), .d(x04), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  nand2  g49(.a(new_n60_), .b(new_n92_), .O(new_n95_));
  ...
  nand2  g60(.a(new_n103_), .b(new_n51_), .O(new_n106_));
  ...
  nor2   g64(.a(new_n106_), .b(x21), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n96_), .O(z14));
  nand2  g67(.a(new_n111_), .b(x22), .O(new_n113_));
  inv1   g68(.a(x22), .O(new_n114_));
  nand2  g69(.a(new_n110_), .b(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n96_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand3  g73(.a(new_n110_), .b(new_n118_), .c(new_n114_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n96_), .O(z16));
  nand2  g75(.a(new_n119_), .b(x24), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n110_), .c(new_n114_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n96_), .O(z17));
  nand4  g79(.a(new_n122_), .b(new_n110_), .c(new_n50_), .d(new_n114_), .O(new_n125_));
  nand2  g80(.a(new_n123_), .b(x25), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n96_), .O(z18));
endmodule
