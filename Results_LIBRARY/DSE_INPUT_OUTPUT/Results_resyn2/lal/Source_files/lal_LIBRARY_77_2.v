...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n73_, new_n74_, new_n77_, new_n81_, new_n82_, new_n83_,
  ...
  nor2   g34(.a(new_n60_), .b(x15), .O(z09));
  inv1   g35(.a(x07), .O(new_n81_));
  nand2  g36(.a(x05), .b(x04), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n52_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(new_n81_), .c(x15), .O(z10));
  nand2  g39(.a(new_n53_), .b(new_n52_), .O(new_n85_));
  nand2  g40(.a(x18), .b(x17), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n82_), .c(new_n85_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n81_), .c(x15), .O(z11));
  nand2  g43(.a(new_n60_), .b(new_n47_), .O(new_n89_));
  ...
  nand2  g50(.a(new_n95_), .b(new_n82_), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n94_), .c(new_n81_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n47_), .O(z13));
  inv1   g53(.a(new_n89_), .O(new_n99_));
  oai21  g54(.a(new_n90_), .b(x20), .c(x21), .O(new_n100_));
  ...
  aoi21  g60(.a(new_n105_), .b(new_n94_), .c(new_n89_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n104_), .O(z15));
  inv1   g62(.a(x23), .O(new_n108_));
  aoi21  g63(.a(new_n105_), .b(new_n94_), .c(new_n108_), .O(new_n109_));
  nand3  g64(.a(new_n105_), .b(new_n94_), .c(new_n108_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n82_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n109_), .c(new_n81_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(z16));
  nand2  g68(.a(new_n110_), .b(x24), .O(new_n114_));
  nor2   g69(.a(x24), .b(x23), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n105_), .c(new_n91_), .d(new_n51_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n99_), .O(z17));
  nand4  g72(.a(new_n115_), .b(new_n105_), .c(new_n94_), .d(new_n50_), .O(new_n118_));
  nand2  g73(.a(new_n116_), .b(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n82_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n81_), .O(new_n121_));
