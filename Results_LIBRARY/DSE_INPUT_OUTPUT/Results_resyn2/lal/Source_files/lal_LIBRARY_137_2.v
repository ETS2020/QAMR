...
module FAU ( 
  ...
  nor3   g35(.a(x15), .b(x11), .c(x07), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(new_n80_), .O(z09));
  nand2  g38(.a(new_n81_), .b(new_n80_), .O(new_n84_));
  ...
  nand2  g49(.a(new_n92_), .b(new_n54_), .O(new_n95_));
  nand2  g50(.a(new_n91_), .b(x20), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n85_), .O(z13));
  nand2  g52(.a(new_n95_), .b(x21), .O(new_n98_));
  inv1   g53(.a(x21), .O(new_n99_));
  nor2   g54(.a(new_n91_), .b(x20), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n98_), .c(new_n85_), .O(z14));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n103_));
  nor2   g58(.a(x22), .b(x21), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n100_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n85_), .O(z15));
  nand2  g61(.a(new_n105_), .b(x23), .O(new_n107_));
  inv1   g62(.a(x23), .O(new_n108_));
  nand3  g63(.a(new_n104_), .b(new_n100_), .c(new_n108_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n85_), .O(z16));
  inv1   g65(.a(x15), .O(new_n111_));
  inv1   g66(.a(x24), .O(new_n112_));
  nand3  g67(.a(new_n104_), .b(new_n112_), .c(new_n108_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n95_), .c(new_n63_), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x11), .c(new_n111_), .O(z17));
  inv1   g71(.a(new_n113_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n100_), .c(new_n53_), .O(new_n118_));
  oai21  g73(.a(new_n113_), .b(new_n95_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n63_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n111_), .O(z18));
endmodule
