...
module FAU ( 
  ...
  nor3   g28(.a(new_n73_), .b(new_n48_), .c(x17), .O(z10));
  ...
  nand2  g38(.a(new_n78_), .b(x20), .O(new_n84_));
  inv1   g39(.a(x20), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(x19), .c(x18), .d(x17), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(new_n73_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n84_), .c(new_n48_), .O(z13));
  nand2  g44(.a(new_n86_), .b(x21), .O(new_n90_));
  inv1   g45(.a(x21), .O(new_n91_));
  aoi21  g46(.a(new_n87_), .b(new_n91_), .c(new_n73_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n90_), .c(new_n48_), .O(z14));
  oai21  g48(.a(new_n86_), .b(x21), .c(x22), .O(new_n94_));
  nor2   g49(.a(x22), .b(x21), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(new_n87_), .c(new_n73_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n94_), .c(new_n48_), .O(z15));
  inv1   g52(.a(new_n95_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n86_), .c(x23), .O(new_n99_));
  nand2  g54(.a(new_n73_), .b(new_n49_), .O(new_n100_));
  inv1   g55(.a(x23), .O(new_n101_));
  nand3  g56(.a(new_n95_), .b(new_n47_), .c(new_n101_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n100_), .c(new_n99_), .O(z16));
  nand3  g60(.a(new_n95_), .b(new_n87_), .c(new_n101_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n77_), .c(new_n47_), .O(z17));
  nand3  g62(.a(new_n95_), .b(new_n52_), .c(new_n85_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n78_), .c(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n101_), .O(new_n110_));
  oai21  g65(.a(new_n102_), .b(new_n86_), .c(x25), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n77_), .O(z18));
endmodule
