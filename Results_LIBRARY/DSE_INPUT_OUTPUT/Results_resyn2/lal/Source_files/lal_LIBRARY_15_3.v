...
module FAU ( 
  ...
  nand3  g13(.a(new_n58_), .b(x24), .c(new_n57_), .O(new_n59_));
  inv1   g14(.a(new_n59_), .O(new_n60_));
  nand3  g15(.a(new_n60_), .b(new_n56_), .c(x21), .O(new_n61_));
  nand2  g16(.a(new_n61_), .b(new_n50_), .O(new_n62_));
  aoi21  g17(.a(x05), .b(x04), .c(x07), .O(new_n63_));
  inv1   g18(.a(new_n63_), .O(new_n64_));
  aoi21  g19(.a(x24), .b(x23), .c(x25), .O(new_n65_));
  nor2   g20(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  aoi21  g21(.a(new_n62_), .b(x22), .c(new_n66_), .O(z01));
  inv1   g22(.a(new_n47_), .O(new_n68_));
  nor2   g23(.a(new_n68_), .b(new_n46_), .O(z02));
  inv1   g24(.a(x23), .O(new_n70_));
  nand3  g25(.a(new_n56_), .b(x22), .c(x21), .O(new_n71_));
  nand2  g26(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  inv1   g27(.a(x25), .O(new_n73_));
  nand2  g28(.a(new_n47_), .b(new_n73_), .O(new_n74_));
  aoi21  g29(.a(new_n72_), .b(x24), .c(new_n74_), .O(z03));
  inv1   g30(.a(x08), .O(new_n76_));
  nand2  g31(.a(new_n47_), .b(new_n76_), .O(new_n77_));
  ...
  nand3  g40(.a(new_n47_), .b(x14), .c(new_n76_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z06));
  aoi21  g42(.a(new_n76_), .b(x06), .c(new_n68_), .O(z07));
  inv1   g43(.a(x22), .O(new_n89_));
  inv1   g44(.a(x21), .O(new_n90_));
  aoi21  g45(.a(new_n55_), .b(new_n51_), .c(new_n90_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(x24), .c(x15), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(new_n89_), .c(new_n65_), .O(z08));
  nand2  g48(.a(new_n50_), .b(new_n57_), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n58_), .c(new_n47_), .O(z09));
  nand2  g50(.a(new_n63_), .b(new_n50_), .O(new_n96_));
  ...
  nor2   g55(.a(new_n53_), .b(new_n52_), .O(new_n101_));
  nor3   g56(.a(new_n101_), .b(new_n96_), .c(new_n100_), .O(z11));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor2   g59(.a(new_n101_), .b(x19), .O(new_n105_));
  nor3   g60(.a(new_n105_), .b(new_n104_), .c(new_n96_), .O(z12));
  nand2  g61(.a(new_n103_), .b(x20), .O(new_n107_));
  nor2   g62(.a(new_n103_), .b(x20), .O(new_n108_));
  nor2   g63(.a(new_n108_), .b(new_n96_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n107_), .c(new_n68_), .O(z13));
  oai21  g65(.a(new_n103_), .b(x20), .c(x21), .O(new_n111_));
  nand2  g66(.a(new_n108_), .b(new_n90_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n97_), .O(z14));
  nand2  g68(.a(new_n112_), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n108_), .b(new_n89_), .c(new_n90_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n97_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  nand4  g72(.a(new_n108_), .b(new_n70_), .c(new_n89_), .d(new_n90_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n97_), .O(z16));
  nor2   g74(.a(x24), .b(x23), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n108_), .c(new_n89_), .d(new_n90_), .O(new_n121_));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n97_), .O(z17));
  nand2  g78(.a(new_n121_), .b(x25), .O(new_n124_));
  inv1   g79(.a(new_n115_), .O(new_n125_));
  nand3  g80(.a(new_n120_), .b(new_n125_), .c(new_n73_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n97_), .O(z18));
endmodule
