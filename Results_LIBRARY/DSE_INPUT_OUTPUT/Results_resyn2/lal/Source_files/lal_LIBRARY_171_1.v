...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n72_, new_n74_, new_n78_, new_n79_, new_n81_, new_n82_, new_n83_,
  ...
  oai21  g29(.a(x13), .b(x08), .c(new_n74_), .O(z05));
  and2   g30(.a(new_n50_), .b(x14), .O(z06));
  nand2  g31(.a(new_n50_), .b(x06), .O(z07));
  inv1   g32(.a(x07), .O(new_n78_));
  nand4  g33(.a(new_n47_), .b(new_n78_), .c(x05), .d(x04), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n74_), .O(z09));
  nand2  g35(.a(new_n52_), .b(new_n47_), .O(new_n81_));
  ...
  oai21  g42(.a(new_n87_), .b(new_n81_), .c(new_n74_), .O(z11));
  ...
  oai21  g46(.a(new_n91_), .b(new_n81_), .c(new_n74_), .O(z12));
  nand2  g47(.a(x15), .b(x11), .O(new_n93_));
  ...
  nand2  g52(.a(new_n97_), .b(new_n93_), .O(z13));
  inv1   g53(.a(x21), .O(new_n99_));
  aoi21  g54(.a(new_n94_), .b(new_n99_), .c(new_n81_), .O(new_n100_));
  oai21  g55(.a(new_n94_), .b(new_n99_), .c(new_n100_), .O(z14));
  inv1   g56(.a(x22), .O(new_n102_));
  aoi21  g57(.a(new_n94_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  ...
  nand2  g62(.a(new_n107_), .b(new_n93_), .O(z15));
  nand2  g63(.a(new_n105_), .b(x23), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand3  g65(.a(new_n104_), .b(new_n94_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n104_), .c(new_n94_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n82_), .O(z17));
  inv1   g71(.a(x25), .O(new_n117_));
  nand4  g72(.a(new_n114_), .b(new_n104_), .c(new_n94_), .d(new_n117_), .O(new_n118_));
  aoi21  g73(.a(new_n115_), .b(x25), .c(new_n81_), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n118_), .c(new_n48_), .O(z18));
endmodule
