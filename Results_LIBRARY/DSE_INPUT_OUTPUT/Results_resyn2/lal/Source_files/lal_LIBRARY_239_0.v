...
module FAU ( 
  ...
  aoi21  g18(.a(new_n60_), .b(new_n52_), .c(new_n48_), .O(z08));
  ...
  nand3  g44(.a(new_n66_), .b(x10), .c(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(new_n88_), .O(z09));
  nand2  g46(.a(new_n62_), .b(new_n54_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x10), .c(x15), .O(z10));
  ...
  nor2   g63(.a(new_n104_), .b(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n104_), .b(new_n108_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n62_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n109_), .c(x10), .O(new_n112_));
  ...
  nand3  g74(.a(new_n115_), .b(new_n104_), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g78(.a(new_n123_), .b(new_n115_), .c(new_n104_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n103_), .O(z17));
  nand4  g80(.a(new_n123_), .b(new_n115_), .c(new_n104_), .d(new_n52_), .O(new_n126_));
  nand2  g81(.a(new_n124_), .b(x25), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n62_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(x10), .O(new_n129_));
