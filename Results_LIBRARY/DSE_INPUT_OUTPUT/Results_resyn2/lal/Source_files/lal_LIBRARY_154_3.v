...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n74_, new_n77_, new_n78_, new_n81_,
  ...
  aoi21  g14(.a(new_n57_), .b(new_n49_), .c(new_n59_), .O(new_n60_));
  inv1   g15(.a(x15), .O(new_n61_));
  nand2  g16(.a(new_n61_), .b(x07), .O(new_n62_));
  oai21  g17(.a(new_n60_), .b(x07), .c(new_n62_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nand2  g19(.a(new_n47_), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n57_), .b(new_n47_), .c(new_n49_), .O(new_n66_));
  ...
  inv1   g31(.a(new_n68_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(x14), .O(new_n78_));
  inv1   g33(.a(new_n78_), .O(z06));
  nand2  g34(.a(new_n77_), .b(x06), .O(z07));
  inv1   g35(.a(new_n47_), .O(new_n81_));
  aoi21  g36(.a(new_n57_), .b(new_n49_), .c(new_n81_), .O(z08));
  nor2   g37(.a(new_n59_), .b(x15), .O(new_n83_));
  inv1   g38(.a(x07), .O(new_n84_));
  nand2  g39(.a(new_n61_), .b(new_n84_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n47_), .c(new_n83_), .O(z09));
  nand3  g41(.a(new_n58_), .b(new_n61_), .c(new_n84_), .O(new_n87_));
  ...
  nor2   g48(.a(new_n92_), .b(x19), .O(new_n94_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n88_), .O(z14));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n98_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n88_), .O(z15));
  and2   g64(.a(new_n108_), .b(x23), .O(new_n110_));
  oai21  g65(.a(new_n108_), .b(x23), .c(new_n83_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n110_), .c(new_n84_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n62_), .O(z16));
  oai21  g68(.a(new_n108_), .b(x23), .c(x24), .O(new_n114_));
  nor2   g69(.a(x24), .b(x23), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n107_), .c(new_n98_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n88_), .O(z17));
  nor2   g72(.a(new_n116_), .b(x25), .O(new_n118_));
  ...
  nand2  g76(.a(new_n121_), .b(new_n62_), .O(z18));
endmodule
