...
module FAU ( 
  ...
  nand3  g45(.a(new_n90_), .b(x14), .c(new_n68_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z06));
  aoi21  g47(.a(new_n68_), .b(x06), .c(new_n64_), .O(z07));
  inv1   g48(.a(x07), .O(new_n94_));
  nand4  g49(.a(new_n90_), .b(new_n94_), .c(x05), .d(x04), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n47_), .O(z09));
  nand2  g51(.a(new_n60_), .b(new_n90_), .O(new_n97_));
  oai21  g52(.a(new_n97_), .b(x17), .c(new_n47_), .O(z10));
  nor2   g53(.a(x18), .b(x17), .O(new_n99_));
  nor2   g54(.a(new_n53_), .b(new_n52_), .O(new_n100_));
  nor3   g55(.a(new_n100_), .b(new_n97_), .c(new_n99_), .O(z11));
  oai21  g56(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(new_n102_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n97_), .c(new_n47_), .O(z12));
  inv1   g60(.a(x14), .O(new_n106_));
  nand2  g61(.a(x15), .b(new_n106_), .O(new_n107_));
  nand2  g62(.a(new_n103_), .b(x20), .O(new_n108_));
  nand4  g63(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n60_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n90_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n107_), .O(z13));
  nand2  g67(.a(new_n109_), .b(x21), .O(new_n113_));
  inv1   g68(.a(x21), .O(new_n114_));
  nor2   g69(.a(x20), .b(new_n54_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n100_), .c(new_n114_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n60_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n90_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n107_), .O(z14));
  inv1   g74(.a(new_n97_), .O(new_n120_));
  inv1   g75(.a(x22), .O(new_n121_));
  nand4  g76(.a(new_n115_), .b(new_n100_), .c(new_n121_), .d(new_n114_), .O(new_n122_));
  nand2  g77(.a(new_n116_), .b(x22), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n120_), .O(z15));
  aoi21  g79(.a(new_n122_), .b(x23), .c(new_n97_), .O(new_n125_));
  oai21  g80(.a(new_n122_), .b(x23), .c(new_n125_), .O(z16));
  oai21  g81(.a(new_n122_), .b(x23), .c(x24), .O(new_n127_));
  nor2   g82(.a(x22), .b(x21), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n128_), .c(new_n115_), .d(new_n100_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n127_), .c(new_n120_), .O(z17));
  inv1   g86(.a(new_n109_), .O(new_n132_));
  nand4  g87(.a(new_n129_), .b(new_n128_), .c(new_n132_), .d(new_n50_), .O(new_n133_));
  aoi21  g88(.a(new_n130_), .b(x25), .c(new_n97_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n133_), .c(new_n64_), .O(z18));
endmodule
