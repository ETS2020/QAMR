...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n64_, new_n67_, new_n71_, new_n72_, new_n73_, new_n74_, new_n76_,
  ...
  nand3  g31(.a(new_n71_), .b(new_n73_), .c(new_n72_), .O(new_n77_));
  nor2   g32(.a(new_n77_), .b(new_n48_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z10));
  xnor2a g35(.a(x18), .b(x17), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(new_n77_), .c(new_n49_), .O(z11));
  inv1   g37(.a(new_n78_), .O(new_n83_));
  and2   g38(.a(x18), .b(x17), .O(new_n84_));
  xnor2a g39(.a(new_n84_), .b(x19), .O(new_n85_));
  nor2   g40(.a(new_n85_), .b(new_n83_), .O(z12));
  ...
  inv1   g46(.a(new_n77_), .O(new_n92_));
  nand2  g47(.a(new_n90_), .b(x21), .O(new_n93_));
  inv1   g48(.a(x21), .O(new_n94_));
  nand4  g49(.a(new_n84_), .b(new_n94_), .c(new_n89_), .d(x19), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n93_), .c(new_n92_), .O(new_n96_));
  and2   g51(.a(new_n96_), .b(new_n49_), .O(z14));
  ...
  nand3  g56(.a(new_n101_), .b(new_n98_), .c(new_n78_), .O(z15));
  inv1   g57(.a(x23), .O(new_n103_));
  nand3  g58(.a(new_n100_), .b(new_n99_), .c(new_n103_), .O(new_n104_));
  nand2  g59(.a(new_n101_), .b(x23), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n78_), .O(z16));
  nand2  g61(.a(x24), .b(x23), .O(new_n107_));
  inv1   g62(.a(new_n87_), .O(new_n108_));
  ...
  nand2  g68(.a(new_n113_), .b(new_n107_), .O(z17));
  nand2  g69(.a(new_n100_), .b(new_n51_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n90_), .c(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n103_), .O(new_n117_));
  nand3  g72(.a(new_n100_), .b(new_n47_), .c(new_n103_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n90_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n92_), .O(z18));
endmodule
