...
module FAU ( 
  ...
  aoi21  g47(.a(new_n58_), .b(new_n50_), .c(new_n48_), .O(z08));
  ...
  nand3  g53(.a(new_n98_), .b(new_n61_), .c(new_n97_), .O(new_n99_));
  ...
  nand2  g72(.a(new_n117_), .b(new_n60_), .O(z15));
  nand2  g73(.a(new_n115_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n110_), .c(new_n105_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n61_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n60_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  inv1   g80(.a(x24), .O(new_n126_));
  nand4  g81(.a(new_n120_), .b(new_n110_), .c(new_n105_), .d(new_n126_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n63_), .O(z17));
  aoi21  g83(.a(new_n127_), .b(x25), .c(new_n62_), .O(new_n129_));
  oai21  g84(.a(new_n127_), .b(x25), .c(new_n129_), .O(z18));
endmodule
