...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n76_, new_n78_, new_n81_, new_n82_,
  ...
  aoi21  g34(.a(new_n58_), .b(new_n50_), .c(new_n78_), .O(z08));
  inv1   g35(.a(x07), .O(new_n81_));
  nand3  g36(.a(new_n61_), .b(new_n47_), .c(new_n81_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z09));
  nand2  g38(.a(new_n62_), .b(new_n47_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  aoi21  g42(.a(new_n53_), .b(new_n52_), .c(new_n61_), .O(new_n88_));
  oai21  g43(.a(new_n53_), .b(new_n52_), .c(new_n88_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n81_), .c(x15), .O(z11));
  ...
  nand3  g58(.a(new_n99_), .b(new_n92_), .c(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n85_), .O(z15));
  nand2  g60(.a(new_n104_), .b(x23), .O(new_n106_));
  nor2   g61(.a(x23), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n99_), .c(new_n92_), .O(new_n108_));
