...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n85_, new_n86_, new_n87_, new_n89_, new_n91_, new_n95_, new_n97_,
  ...
  aoi21  g48(.a(new_n59_), .b(new_n51_), .c(new_n48_), .O(z08));
  nand3  g49(.a(new_n61_), .b(new_n47_), .c(new_n50_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand2  g51(.a(new_n60_), .b(new_n53_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x07), .O(z10));
  nor2   g53(.a(x18), .b(x17), .O(new_n99_));
  nand3  g54(.a(new_n60_), .b(new_n47_), .c(new_n50_), .O(new_n100_));
  ...
  nor3   g60(.a(new_n105_), .b(new_n103_), .c(new_n100_), .O(z12));
  ...
  nand2  g65(.a(new_n110_), .b(new_n50_), .O(z13));
  inv1   g66(.a(x21), .O(new_n112_));
  nor2   g67(.a(new_n107_), .b(new_n112_), .O(new_n113_));
  nand2  g68(.a(new_n107_), .b(new_n112_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n60_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n113_), .c(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n50_), .O(z14));
  inv1   g72(.a(new_n100_), .O(new_n118_));
  nand2  g73(.a(new_n114_), .b(x22), .O(new_n119_));
  ...
  and2   g77(.a(new_n121_), .b(x23), .O(new_n123_));
  oai21  g78(.a(new_n121_), .b(x23), .c(new_n60_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n123_), .c(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n50_), .O(z16));
  oai21  g81(.a(new_n121_), .b(x23), .c(x24), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n120_), .c(new_n107_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n118_), .O(z17));
  nor2   g85(.a(new_n129_), .b(x25), .O(new_n131_));
  nand2  g86(.a(new_n129_), .b(x25), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n60_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n131_), .c(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n50_), .O(z18));
endmodule
