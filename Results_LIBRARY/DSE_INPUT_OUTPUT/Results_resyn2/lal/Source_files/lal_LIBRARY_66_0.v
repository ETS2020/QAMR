...
module FAU ( 
  ...
  oai21  g13(.a(new_n54_), .b(x25), .c(new_n58_), .O(z01));
  ...
  aoi21  g18(.a(new_n54_), .b(x24), .c(new_n63_), .O(z03));
  ...
  nand2  g30(.a(new_n75_), .b(new_n65_), .O(z06));
  ...
  nand3  g36(.a(new_n50_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  inv1   g38(.a(new_n53_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(x23), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n78_), .c(new_n62_), .O(z08));
  nor2   g41(.a(x15), .b(x07), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n57_), .c(new_n65_), .O(new_n88_));
  ...
  inv1   g48(.a(new_n51_), .O(new_n94_));
  ...
  nand2  g53(.a(new_n95_), .b(new_n50_), .O(new_n99_));
  ...
  nand3  g65(.a(new_n107_), .b(new_n102_), .c(new_n110_), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(x22), .c(new_n90_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n47_), .O(z15));
  nand4  g68(.a(new_n107_), .b(new_n102_), .c(new_n49_), .d(new_n110_), .O(new_n114_));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n91_), .O(z16));
  inv1   g71(.a(new_n90_), .O(new_n117_));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  oai21  g73(.a(new_n117_), .b(new_n47_), .c(new_n118_), .O(z17));
  inv1   g74(.a(x25), .O(new_n120_));
  aoi21  g75(.a(new_n117_), .b(new_n120_), .c(new_n47_), .O(z18));
endmodule
