...
module FAU ( 
  ...
  nand2  g01(.a(x24), .b(x16), .O(new_n47_));
  ...
  nand2  g21(.a(new_n59_), .b(new_n66_), .O(new_n67_));
  ...
  nand2  g29(.a(new_n47_), .b(new_n46_), .O(new_n75_));
  ...
  aoi21  g38(.a(new_n83_), .b(new_n54_), .c(x20), .O(new_n84_));
  oai21  g39(.a(new_n57_), .b(new_n84_), .c(new_n82_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(x24), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n50_), .c(new_n80_), .O(z08));
  ...
  nor3   g52(.a(new_n97_), .b(new_n93_), .c(new_n83_), .O(z11));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nor2   g55(.a(new_n97_), .b(x19), .O(new_n101_));
  nor3   g56(.a(new_n101_), .b(new_n100_), .c(new_n93_), .O(z12));
  nand4  g57(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n103_));
  aoi21  g58(.a(new_n99_), .b(x20), .c(new_n91_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n80_), .O(z13));
  ...
  nand3  g64(.a(new_n109_), .b(new_n106_), .c(new_n94_), .O(z14));
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n111_));
  inv1   g66(.a(x22), .O(new_n112_));
  nand3  g67(.a(new_n108_), .b(new_n112_), .c(new_n107_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n94_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  nand2  g70(.a(new_n112_), .b(new_n107_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n103_), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(new_n82_), .c(new_n91_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n115_), .c(new_n80_), .O(z16));
  nand3  g74(.a(new_n117_), .b(new_n82_), .c(new_n66_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n117_), .b(new_n49_), .c(new_n82_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n92_), .O(z17));
  nand4  g78(.a(new_n117_), .b(new_n50_), .c(new_n49_), .d(new_n82_), .O(new_n124_));
  nand2  g79(.a(new_n47_), .b(new_n50_), .O(new_n125_));
