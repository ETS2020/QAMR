...
module FAU ( 
  ...
  oai21  g13(.a(new_n55_), .b(x20), .c(new_n58_), .O(new_n59_));
  aoi21  g14(.a(new_n59_), .b(new_n53_), .c(new_n54_), .O(new_n60_));
  oai21  g15(.a(new_n60_), .b(x25), .c(new_n52_), .O(z01));
  and2   g16(.a(new_n47_), .b(x16), .O(z02));
  nor2   g17(.a(new_n60_), .b(x25), .O(z03));
  ...
  nand2  g24(.a(new_n69_), .b(new_n47_), .O(z04));
  ...
  aoi21  g29(.a(new_n46_), .b(x06), .c(new_n74_), .O(z07));
  ...
  oai21  g35(.a(new_n80_), .b(x19), .c(new_n77_), .O(new_n81_));
  nand3  g36(.a(new_n58_), .b(new_n81_), .c(x24), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n76_), .c(new_n74_), .O(z08));
  inv1   g38(.a(x15), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n49_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n50_), .c(new_n47_), .O(z09));
  nand3  g41(.a(new_n50_), .b(new_n84_), .c(new_n49_), .O(new_n87_));
  ...
  oai21  g49(.a(new_n94_), .b(new_n87_), .c(new_n47_), .O(z11));
  ...
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n90_), .O(z13));
  nand2  g58(.a(new_n101_), .b(x21), .O(new_n104_));
  nand2  g59(.a(new_n100_), .b(new_n56_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n90_), .O(z14));
  nand2  g61(.a(new_n105_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n100_), .b(new_n57_), .c(new_n56_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n90_), .O(z15));
  nand3  g64(.a(new_n108_), .b(new_n54_), .c(x23), .O(new_n110_));
  nand2  g65(.a(new_n87_), .b(new_n47_), .O(new_n111_));
  nand4  g66(.a(new_n100_), .b(new_n53_), .c(new_n57_), .d(new_n56_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(z16));
  nand2  g68(.a(new_n108_), .b(new_n54_), .O(new_n114_));
  nand4  g69(.a(new_n100_), .b(x24), .c(new_n57_), .d(new_n56_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n53_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n111_), .O(z17));
  nand2  g72(.a(new_n112_), .b(new_n76_), .O(new_n118_));
  nor2   g73(.a(new_n76_), .b(x23), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(x24), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  oai21  g76(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nand4  g77(.a(new_n100_), .b(new_n54_), .c(new_n57_), .d(new_n56_), .O(new_n123_));
  aoi22  g78(.a(new_n123_), .b(new_n119_), .c(new_n122_), .d(new_n87_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(z18));
endmodule
