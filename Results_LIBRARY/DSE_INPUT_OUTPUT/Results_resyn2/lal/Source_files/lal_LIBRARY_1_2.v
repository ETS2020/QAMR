...
module FAU ( 
  ...
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n88_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n49_), .O(z12));
  nand2  g51(.a(new_n93_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n82_), .b(new_n64_), .c(new_n49_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n89_), .b(new_n103_), .c(new_n52_), .d(x19), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n88_), .O(new_n105_));
  and2   g60(.a(new_n105_), .b(new_n49_), .O(z14));
  nand2  g61(.a(new_n104_), .b(x22), .O(new_n107_));
  nor2   g62(.a(x22), .b(x21), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n89_), .c(new_n52_), .d(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n99_), .O(z15));
  nand2  g65(.a(new_n85_), .b(new_n49_), .O(new_n111_));
  nand3  g66(.a(new_n109_), .b(x24), .c(x23), .O(new_n112_));
  inv1   g67(.a(new_n100_), .O(new_n113_));
  nand3  g68(.a(new_n108_), .b(new_n113_), .c(new_n59_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(z16));
  nand2  g70(.a(new_n109_), .b(x24), .O(new_n116_));
  nand3  g71(.a(new_n108_), .b(new_n113_), .c(new_n48_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n116_), .c(new_n88_), .d(new_n59_), .O(z17));
  oai21  g73(.a(new_n109_), .b(x24), .c(x25), .O(new_n119_));
  nand4  g74(.a(new_n108_), .b(new_n113_), .c(new_n60_), .d(new_n48_), .O(new_n120_));
  oai21  g75(.a(x25), .b(new_n48_), .c(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n88_), .O(z18));
endmodule
