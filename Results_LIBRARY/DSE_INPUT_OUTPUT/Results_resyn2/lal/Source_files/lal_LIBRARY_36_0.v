...
module FAU ( 
  ...
  nand2  g52(.a(new_n94_), .b(new_n58_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nor3   g54(.a(new_n99_), .b(new_n89_), .c(new_n47_), .O(z12));
  ...
  aoi21  g65(.a(new_n107_), .b(x22), .c(new_n89_), .O(new_n111_));
  ...
  nand2  g71(.a(new_n89_), .b(new_n49_), .O(new_n117_));
  oai21  g72(.a(new_n113_), .b(new_n54_), .c(new_n117_), .O(z17));
  nand2  g73(.a(new_n90_), .b(new_n65_), .O(z18));
endmodule
