...
module FAU ( 
  ...
  nand3  g35(.a(new_n60_), .b(new_n49_), .c(new_n52_), .O(z08));
  nand3  g36(.a(new_n62_), .b(new_n47_), .c(new_n51_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z09));
  nand3  g38(.a(new_n61_), .b(new_n47_), .c(new_n51_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  nand2  g42(.a(new_n55_), .b(new_n54_), .O(new_n88_));
  nand2  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n61_), .c(new_n88_), .O(new_n90_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n56_), .c(new_n93_), .O(z12));
  nor2   g49(.a(new_n92_), .b(x20), .O(new_n95_));
  ...
  nand3  g69(.a(new_n108_), .b(new_n52_), .c(new_n112_), .O(new_n115_));
  nand2  g70(.a(new_n113_), .b(x25), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n85_), .O(z18));
endmodule
