...
module FAU ( 
  ...
  nand3  g18(.a(new_n58_), .b(new_n47_), .c(new_n50_), .O(z08));
  ...
  aoi21  g33(.a(new_n66_), .b(x06), .c(new_n62_), .O(z07));
  ...
  nand2  g39(.a(new_n60_), .b(new_n81_), .O(new_n85_));
  ...
  oai21  g48(.a(new_n93_), .b(new_n85_), .c(new_n47_), .O(z12));
  nand2  g49(.a(new_n81_), .b(x07), .O(new_n95_));
  inv1   g50(.a(new_n92_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n51_), .O(new_n97_));
  nand2  g52(.a(new_n92_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n83_), .O(new_n99_));
  ...
  nand3  g63(.a(new_n104_), .b(new_n96_), .c(new_n108_), .O(new_n109_));
  ...
  nand3  g67(.a(new_n112_), .b(new_n104_), .c(new_n96_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n83_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n80_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n95_), .O(z16));
  nand2  g71(.a(new_n113_), .b(x24), .O(new_n117_));
  inv1   g72(.a(x24), .O(new_n118_));
  nand4  g73(.a(new_n112_), .b(new_n104_), .c(new_n96_), .d(new_n118_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n102_), .O(z17));
