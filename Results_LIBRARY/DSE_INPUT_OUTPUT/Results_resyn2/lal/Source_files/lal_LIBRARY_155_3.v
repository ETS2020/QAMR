...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n73_, new_n75_, new_n77_, new_n80_, new_n81_, new_n82_,
  ...
  aoi21  g33(.a(new_n57_), .b(new_n49_), .c(new_n77_), .O(z08));
  ...
  nand2  g38(.a(new_n60_), .b(new_n81_), .O(new_n84_));
  ...
  oai21  g43(.a(new_n88_), .b(new_n84_), .c(new_n47_), .O(z11));
  ...
  nand2  g53(.a(new_n98_), .b(new_n91_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n97_), .c(new_n85_), .O(z14));
  nand2  g55(.a(new_n99_), .b(x22), .O(new_n101_));
  inv1   g56(.a(x22), .O(new_n102_));
  nand3  g57(.a(new_n98_), .b(new_n91_), .c(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n85_), .O(z15));
  nand2  g59(.a(new_n103_), .b(x23), .O(new_n105_));
  aoi21  g60(.a(x05), .b(x04), .c(x15), .O(new_n106_));
  nor2   g61(.a(x23), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n98_), .c(new_n91_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n80_), .O(new_n110_));
  nand2  g65(.a(new_n81_), .b(x07), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(z16));
  nor2   g67(.a(x24), .b(x21), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n107_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n94_), .c(new_n106_), .O(new_n115_));
  aoi21  g70(.a(new_n108_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x07), .c(new_n111_), .O(z17));
  nor2   g72(.a(new_n114_), .b(new_n94_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n49_), .O(new_n119_));
  oai21  g74(.a(new_n114_), .b(new_n94_), .c(x25), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n85_), .O(z18));
endmodule
