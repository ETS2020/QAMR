...
module FAU ( 
  ...
  nor2   g39(.a(new_n63_), .b(new_n58_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x23), .c(x24), .O(new_n86_));
  aoi21  g41(.a(new_n59_), .b(x20), .c(x25), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n86_), .O(z08));
  inv1   g43(.a(x15), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n53_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(new_n54_), .c(new_n50_), .O(z09));
  nand3  g46(.a(new_n54_), .b(new_n89_), .c(new_n53_), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(x17), .c(new_n50_), .O(z10));
  nand2  g48(.a(new_n61_), .b(new_n60_), .O(new_n94_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n62_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n98_), .d(new_n50_), .O(z13));
  inv1   g61(.a(x21), .O(new_n107_));
  nand2  g62(.a(new_n103_), .b(new_n107_), .O(new_n108_));
  aoi21  g63(.a(new_n104_), .b(x21), .c(new_n92_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n108_), .c(new_n49_), .O(z14));
  inv1   g65(.a(x22), .O(new_n111_));
  nand3  g66(.a(new_n103_), .b(new_n111_), .c(new_n107_), .O(new_n112_));
  oai21  g67(.a(new_n49_), .b(x22), .c(new_n108_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n98_), .O(z15));
  inv1   g69(.a(new_n112_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n69_), .O(new_n116_));
  oai21  g71(.a(new_n49_), .b(x23), .c(new_n112_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n98_), .O(z16));
  inv1   g73(.a(x24), .O(new_n119_));
  inv1   g74(.a(new_n99_), .O(new_n120_));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n69_), .O(new_n122_));
  nand2  g77(.a(new_n121_), .b(new_n69_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n99_), .c(x24), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n98_), .d(new_n48_), .O(z17));
  xor2a  g80(.a(new_n122_), .b(x25), .O(new_n126_));
  nand2  g81(.a(new_n57_), .b(x24), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(x20), .c(new_n92_), .O(new_n128_));
