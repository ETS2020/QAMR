...
module FAU ( 
  ...
  aoi21  g19(.a(new_n59_), .b(new_n51_), .c(new_n49_), .O(z08));
  ...
  nand3  g36(.a(new_n60_), .b(new_n79_), .c(new_n47_), .O(new_n82_));
  ...
  aoi21  g43(.a(new_n88_), .b(new_n79_), .c(x07), .O(z11));
  nand2  g44(.a(new_n87_), .b(new_n55_), .O(new_n90_));
  nand3  g45(.a(x19), .b(x18), .c(x17), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n60_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n79_), .c(x07), .O(z12));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n98_), .c(new_n82_), .O(new_n99_));
  oai21  g54(.a(new_n94_), .b(new_n98_), .c(new_n99_), .O(z14));
  inv1   g55(.a(x22), .O(new_n101_));
  aoi21  g56(.a(new_n94_), .b(new_n98_), .c(new_n101_), .O(new_n102_));
  nor2   g57(.a(x22), .b(x21), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n94_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n60_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(new_n102_), .c(new_n79_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(z15));
  nand2  g62(.a(new_n104_), .b(x23), .O(new_n108_));
  or2    g63(.a(new_n104_), .b(x23), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n83_), .O(z16));
  nand2  g65(.a(new_n109_), .b(x24), .O(new_n111_));
  nor2   g66(.a(x24), .b(x23), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n103_), .c(new_n94_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n83_), .O(z17));
  nor2   g69(.a(new_n113_), .b(x25), .O(new_n115_));
  nand2  g70(.a(new_n113_), .b(x25), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n79_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(z18));
endmodule
