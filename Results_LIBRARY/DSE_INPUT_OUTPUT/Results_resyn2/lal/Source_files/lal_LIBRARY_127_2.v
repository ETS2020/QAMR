...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n78_, new_n81_, new_n83_, new_n85_, new_n86_, new_n87_, new_n89_,
  ...
  aoi21  g60(.a(new_n105_), .b(new_n104_), .c(new_n83_), .O(z13));
  inv1   g61(.a(new_n98_), .O(new_n107_));
  ...
  nand3  g68(.a(new_n109_), .b(new_n103_), .c(new_n113_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n107_), .O(z15));
  nand2  g70(.a(new_n92_), .b(new_n48_), .O(new_n116_));
  nand3  g71(.a(new_n114_), .b(x24), .c(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n109_), .c(new_n103_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n116_), .O(z16));
  inv1   g75(.a(new_n119_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n116_), .O(z17));
  inv1   g79(.a(new_n114_), .O(new_n125_));
  nand2  g80(.a(new_n51_), .b(x24), .O(new_n126_));
  nand2  g81(.a(x25), .b(new_n47_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  nand2  g83(.a(new_n114_), .b(x25), .O(new_n129_));
  aoi21  g84(.a(new_n126_), .b(x23), .c(new_n92_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(z18));
endmodule
