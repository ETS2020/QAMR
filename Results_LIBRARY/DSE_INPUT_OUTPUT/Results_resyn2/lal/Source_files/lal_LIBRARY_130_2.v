...
module FAU ( 
  ...
  nand3  g017(.a(new_n62_), .b(new_n52_), .c(new_n51_), .O(new_n63_));
  inv1   g018(.a(x24), .O(new_n64_));
  oai21  g019(.a(new_n52_), .b(x06), .c(new_n64_), .O(new_n65_));
  nand2  g020(.a(x05), .b(x04), .O(new_n66_));
  nand4  g021(.a(new_n66_), .b(new_n65_), .c(new_n63_), .d(new_n50_), .O(z01));
  inv1   g022(.a(x16), .O(new_n68_));
  nor2   g023(.a(new_n48_), .b(new_n68_), .O(z02));
  nor2   g024(.a(x18), .b(x17), .O(new_n70_));
  aoi21  g025(.a(new_n70_), .b(new_n56_), .c(x20), .O(new_n71_));
  inv1   g026(.a(new_n61_), .O(new_n72_));
  nor2   g027(.a(new_n64_), .b(x23), .O(new_n73_));
  oai21  g028(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand2  g029(.a(new_n64_), .b(new_n47_), .O(new_n75_));
  ...
  nor3   g052(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  nand2  g053(.a(x14), .b(new_n46_), .O(new_n99_));
  nand2  g054(.a(new_n99_), .b(new_n77_), .O(z06));
  nand3  g055(.a(x24), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g056(.a(new_n61_), .b(new_n58_), .c(x23), .O(new_n102_));
  nor2   g057(.a(new_n48_), .b(x25), .O(new_n103_));
  oai21  g058(.a(new_n102_), .b(new_n64_), .c(new_n103_), .O(z08));
  ...
  nor2   g063(.a(new_n108_), .b(new_n48_), .O(new_n109_));
  ...
  aoi21  g071(.a(new_n113_), .b(new_n56_), .c(new_n108_), .O(new_n117_));
  ...
  nand3  g080(.a(new_n125_), .b(new_n59_), .c(new_n53_), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n124_), .c(new_n109_), .O(z14));
  nand2  g082(.a(new_n126_), .b(x22), .O(new_n128_));
  nand2  g083(.a(new_n59_), .b(new_n53_), .O(new_n129_));
  nor2   g084(.a(new_n129_), .b(new_n116_), .O(new_n130_));
  aoi21  g085(.a(new_n130_), .b(new_n60_), .c(new_n108_), .O(new_n131_));
  aoi21  g086(.a(new_n131_), .b(new_n128_), .c(new_n48_), .O(z15));
  ...
  nand3  g091(.a(new_n134_), .b(new_n130_), .c(new_n64_), .O(new_n137_));
  ...
  nand4  g095(.a(new_n140_), .b(new_n134_), .c(new_n120_), .d(new_n52_), .O(new_n141_));
  nand3  g096(.a(new_n140_), .b(new_n134_), .c(new_n120_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(x25), .O(new_n143_));
  aoi21  g098(.a(new_n52_), .b(x24), .c(new_n47_), .O(new_n144_));
