...
module FAU ( 
  ...
  nand2  g53(.a(new_n95_), .b(new_n54_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nor3   g55(.a(new_n100_), .b(new_n92_), .c(new_n47_), .O(z12));
  ...
  aoi21  g61(.a(new_n106_), .b(x21), .c(new_n68_), .O(new_n107_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n106_), .c(new_n51_), .O(new_n114_));
  ...
  nand4  g75(.a(new_n113_), .b(new_n106_), .c(new_n119_), .d(new_n51_), .O(new_n121_));
  ...
  aoi21  g86(.a(new_n131_), .b(new_n68_), .c(new_n92_), .O(new_n132_));
  ...
  nand3  g90(.a(new_n135_), .b(new_n134_), .c(x09), .O(new_n136_));
