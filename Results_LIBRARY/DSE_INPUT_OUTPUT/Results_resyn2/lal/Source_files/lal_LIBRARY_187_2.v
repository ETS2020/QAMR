...
module FAU ( 
  ...
  nand2  g39(.a(new_n60_), .b(new_n52_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n47_), .c(x15), .O(z10));
  aoi21  g41(.a(new_n53_), .b(new_n52_), .c(new_n61_), .O(new_n87_));
  oai21  g42(.a(new_n53_), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z11));
  nand2  g44(.a(new_n62_), .b(new_n82_), .O(new_n90_));
  ...
  oai21  g52(.a(new_n97_), .b(new_n95_), .c(new_n47_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n82_), .O(z13));
  inv1   g54(.a(x21), .O(new_n100_));
  aoi21  g55(.a(new_n95_), .b(new_n100_), .c(new_n90_), .O(new_n101_));
  oai21  g56(.a(new_n95_), .b(new_n100_), .c(new_n101_), .O(z14));
  inv1   g57(.a(x22), .O(new_n103_));
  aoi21  g58(.a(new_n95_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  ...
  nand2  g63(.a(new_n108_), .b(new_n82_), .O(z15));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n62_), .d(new_n82_), .O(z16));
  nor2   g68(.a(x24), .b(x23), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n105_), .c(new_n95_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n60_), .O(new_n116_));
  aoi21  g71(.a(new_n112_), .b(x24), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(x07), .c(new_n82_), .O(z17));
  nand4  g73(.a(new_n114_), .b(new_n105_), .c(new_n95_), .d(new_n50_), .O(new_n119_));
  ...
  nand2  g77(.a(new_n122_), .b(new_n82_), .O(z18));
endmodule
