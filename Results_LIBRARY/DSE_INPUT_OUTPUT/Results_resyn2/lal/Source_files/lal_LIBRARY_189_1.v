...
module FAU ( 
  ...
  aoi21  g19(.a(new_n58_), .b(new_n50_), .c(new_n64_), .O(z08));
  ...
  aoi21  g32(.a(new_n46_), .b(x06), .c(new_n64_), .O(z07));
  inv1   g33(.a(x15), .O(new_n79_));
  nand3  g34(.a(new_n60_), .b(new_n79_), .c(new_n47_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z09));
  nand2  g36(.a(new_n59_), .b(new_n52_), .O(new_n82_));
  ...
  nand3  g42(.a(new_n59_), .b(new_n79_), .c(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  aoi21  g46(.a(new_n85_), .b(new_n54_), .c(new_n91_), .O(z12));
  nor2   g47(.a(new_n90_), .b(x20), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  nand2  g49(.a(new_n90_), .b(x20), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z13));
  inv1   g51(.a(x21), .O(new_n97_));
  nor2   g52(.a(new_n93_), .b(new_n97_), .O(new_n98_));
  nand2  g53(.a(new_n93_), .b(new_n97_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n59_), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n98_), .c(new_n79_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(z14));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nand3  g59(.a(new_n93_), .b(new_n104_), .c(new_n97_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n89_), .O(z15));
  nand2  g61(.a(new_n105_), .b(x23), .O(new_n107_));
  inv1   g62(.a(x23), .O(new_n108_));
  nand4  g63(.a(new_n93_), .b(new_n108_), .c(new_n104_), .d(new_n97_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n59_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n79_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(z16));
  nand2  g67(.a(new_n109_), .b(x24), .O(new_n113_));
  inv1   g68(.a(x24), .O(new_n114_));
  inv1   g69(.a(new_n105_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n108_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n89_), .O(z17));
  nand4  g72(.a(new_n115_), .b(new_n50_), .c(new_n114_), .d(new_n108_), .O(new_n118_));
