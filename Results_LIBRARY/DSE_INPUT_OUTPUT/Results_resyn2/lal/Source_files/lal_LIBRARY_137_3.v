...
module FAU ( 
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n87_), .O(z15));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand3  g65(.a(new_n106_), .b(new_n97_), .c(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n87_), .O(z16));
  nor2   g67(.a(x24), .b(x23), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n106_), .c(new_n97_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n63_), .O(new_n115_));
  aoi21  g70(.a(new_n111_), .b(x24), .c(new_n115_), .O(new_n116_));
  nand2  g71(.a(x15), .b(new_n47_), .O(new_n117_));
  oai21  g72(.a(new_n116_), .b(x15), .c(new_n117_), .O(z17));
  or2    g73(.a(new_n114_), .b(x25), .O(new_n119_));
  aoi21  g74(.a(new_n114_), .b(x25), .c(new_n86_), .O(new_n120_));
  aoi21  g75(.a(new_n120_), .b(new_n119_), .c(new_n49_), .O(z18));
endmodule
