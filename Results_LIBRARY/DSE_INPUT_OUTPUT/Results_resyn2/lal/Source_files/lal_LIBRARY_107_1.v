...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n73_, new_n74_, new_n75_, new_n76_, new_n79_, new_n83_,
  ...
  nand3  g22(.a(new_n58_), .b(new_n67_), .c(new_n50_), .O(z08));
  inv1   g23(.a(z08), .O(z03));
  nand2  g24(.a(new_n67_), .b(new_n46_), .O(new_n70_));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n47_), .c(x07), .O(z09));
  nand2  g37(.a(new_n61_), .b(new_n52_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(new_n47_), .c(x07), .O(z10));
  nor2   g39(.a(x18), .b(x17), .O(new_n85_));
  nand2  g40(.a(x18), .b(x17), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor3   g42(.a(new_n87_), .b(new_n62_), .c(new_n85_), .O(z11));
  nand2  g43(.a(new_n86_), .b(new_n54_), .O(new_n89_));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n61_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n47_), .c(x07), .O(z12));
  ...
  nand2  g52(.a(new_n97_), .b(new_n60_), .O(z13));
  nand2  g53(.a(new_n94_), .b(x21), .O(new_n99_));
  nor2   g54(.a(x21), .b(x20), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n63_), .O(z14));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nand3  g59(.a(new_n100_), .b(new_n93_), .c(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n63_), .O(z15));
  nand2  g61(.a(new_n105_), .b(x23), .O(new_n107_));
  nor2   g62(.a(x23), .b(x22), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n100_), .c(new_n93_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n61_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n60_), .O(z16));
  nand2  g67(.a(new_n109_), .b(x24), .O(new_n113_));
  inv1   g68(.a(x24), .O(new_n114_));
  nand4  g69(.a(new_n108_), .b(new_n100_), .c(new_n93_), .d(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n63_), .O(z17));
  aoi21  g71(.a(new_n115_), .b(x25), .c(new_n62_), .O(new_n117_));
