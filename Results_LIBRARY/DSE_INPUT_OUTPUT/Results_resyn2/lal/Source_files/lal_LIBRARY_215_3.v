...
module FAU ( 
  ...
  nand3  g23(.a(new_n58_), .b(new_n56_), .c(x24), .O(new_n69_));
  ...
  aoi21  g38(.a(new_n46_), .b(x06), .c(new_n68_), .O(z07));
  inv1   g39(.a(x15), .O(new_n85_));
  nand3  g40(.a(new_n47_), .b(new_n85_), .c(new_n61_), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n62_), .O(z09));
  ...
  nand3  g47(.a(new_n62_), .b(new_n85_), .c(new_n61_), .O(new_n93_));
  xnor2a g48(.a(x18), .b(x17), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n93_), .c(new_n47_), .O(z11));
  ...
  aoi21  g55(.a(new_n96_), .b(x20), .c(new_n93_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n100_), .c(new_n68_), .O(z13));
  nand2  g57(.a(new_n100_), .b(x21), .O(new_n103_));
  inv1   g58(.a(x21), .O(new_n104_));
  nor2   g59(.a(new_n96_), .b(x20), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n104_), .c(new_n93_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n103_), .c(new_n68_), .O(z14));
  ...
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n90_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  nand2  g67(.a(new_n109_), .b(new_n104_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n100_), .O(new_n114_));
  aoi21  g69(.a(new_n114_), .b(new_n49_), .c(new_n93_), .O(new_n115_));
  aoi21  g70(.a(new_n115_), .b(new_n112_), .c(new_n68_), .O(z16));
  inv1   g71(.a(new_n93_), .O(new_n117_));
  nand3  g72(.a(new_n114_), .b(new_n50_), .c(new_n49_), .O(new_n118_));
  oai21  g73(.a(new_n110_), .b(x23), .c(x24), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n117_), .O(z17));
  nand4  g75(.a(new_n114_), .b(new_n67_), .c(new_n50_), .d(new_n49_), .O(new_n121_));
  oai21  g76(.a(new_n110_), .b(x24), .c(x25), .O(new_n122_));
  oai21  g77(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n117_), .O(z18));
endmodule
