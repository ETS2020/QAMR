...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_,
    ...
    new_n109_, new_n111_, new_n112_, new_n113_, new_n115_;
  ...
  oai21  g24(.a(new_n66_), .b(new_n53_), .c(new_n69_), .O(z01));
  nor2   g25(.a(new_n66_), .b(new_n53_), .O(z03));
  ...
  nand2  g37(.a(new_n65_), .b(new_n54_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(x24), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(new_n49_), .c(new_n52_), .O(z08));
  nor2   g40(.a(x15), .b(x07), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n68_), .c(new_n49_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand2  g43(.a(new_n86_), .b(new_n67_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n94_), .b(new_n59_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nor3   g54(.a(new_n99_), .b(new_n89_), .c(new_n48_), .O(z12));
  ...
  nand2  g60(.a(new_n101_), .b(new_n62_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n90_), .O(z14));
  nand3  g62(.a(new_n101_), .b(new_n63_), .c(new_n62_), .O(new_n108_));
  nand2  g63(.a(new_n106_), .b(x22), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n90_), .O(z15));
  ...
  nand2  g69(.a(new_n89_), .b(new_n49_), .O(new_n115_));
  oai21  g70(.a(new_n111_), .b(new_n55_), .c(new_n115_), .O(z17));
  nand2  g71(.a(new_n90_), .b(new_n52_), .O(z18));
endmodule
