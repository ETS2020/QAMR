...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n73_, new_n76_, new_n79_, new_n80_, new_n81_, new_n83_,
  ...
  nand3  g19(.a(new_n58_), .b(new_n47_), .c(new_n50_), .O(z08));
  inv1   g20(.a(z08), .O(z03));
  nand2  g21(.a(new_n47_), .b(new_n46_), .O(new_n67_));
  ...
  aoi21  g36(.a(new_n81_), .b(new_n47_), .c(new_n62_), .O(z09));
  nand3  g37(.a(new_n60_), .b(new_n80_), .c(new_n79_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n52_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z10));
  nor2   g41(.a(x18), .b(x17), .O(new_n87_));
  nor2   g42(.a(new_n53_), .b(new_n52_), .O(new_n88_));
  ...
  nor3   g47(.a(new_n92_), .b(new_n90_), .c(new_n83_), .O(z12));
  nand2  g48(.a(new_n80_), .b(x07), .O(new_n94_));
  nor2   g49(.a(new_n91_), .b(x20), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(new_n96_));
  nand2  g51(.a(new_n91_), .b(x20), .O(new_n97_));
  nor2   g52(.a(new_n61_), .b(x15), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n79_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n94_), .O(z13));
  nand2  g56(.a(new_n96_), .b(x21), .O(new_n102_));
  inv1   g57(.a(x21), .O(new_n103_));
  nand2  g58(.a(new_n95_), .b(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n84_), .O(z14));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n106_));
  inv1   g61(.a(x22), .O(new_n107_));
  nand3  g62(.a(new_n95_), .b(new_n107_), .c(new_n103_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n84_), .O(z15));
  nand2  g64(.a(new_n108_), .b(x23), .O(new_n110_));
  inv1   g65(.a(x23), .O(new_n111_));
  nand4  g66(.a(new_n95_), .b(new_n111_), .c(new_n107_), .d(new_n103_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n98_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n79_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n94_), .O(z16));
  nand2  g70(.a(new_n112_), .b(x24), .O(new_n116_));
  nor2   g71(.a(new_n112_), .b(x24), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n116_), .O(z17));
  nand2  g74(.a(new_n117_), .b(new_n50_), .O(new_n120_));
  oai21  g75(.a(new_n112_), .b(x24), .c(x25), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n84_), .O(z18));
endmodule
