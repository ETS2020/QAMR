...
module FAU ( 
  ...
  oai21  g40(.a(new_n85_), .b(x15), .c(x24), .O(new_n86_));
  ...
  oai21  g45(.a(new_n90_), .b(new_n88_), .c(new_n47_), .O(z09));
  nand2  g46(.a(new_n62_), .b(new_n67_), .O(new_n92_));
  ...
  oai21  g53(.a(new_n98_), .b(new_n92_), .c(new_n47_), .O(z11));
  ...
  oai21  g57(.a(new_n102_), .b(new_n92_), .c(new_n47_), .O(z12));
  ...
  nand2  g68(.a(new_n109_), .b(new_n113_), .O(new_n114_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n104_), .c(new_n82_), .d(new_n113_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n62_), .d(new_n67_), .O(z16));
  nand3  g74(.a(new_n118_), .b(x24), .c(new_n67_), .O(new_n120_));
  inv1   g75(.a(new_n118_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x15), .c(new_n50_), .O(new_n122_));
  or2    g77(.a(new_n62_), .b(x15), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n120_), .O(z17));
  nand3  g79(.a(new_n121_), .b(new_n51_), .c(new_n50_), .O(new_n125_));
  oai21  g80(.a(new_n118_), .b(x24), .c(x25), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n93_), .O(z18));
endmodule
