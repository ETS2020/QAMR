...
module FAU ( 
  ...
  aoi21  g21(.a(new_n48_), .b(x25), .c(new_n61_), .O(z03));
  ...
  nor2   g31(.a(new_n76_), .b(new_n47_), .O(z06));
  ...
  nand3  g35(.a(new_n80_), .b(new_n48_), .c(new_n62_), .O(z08));
  inv1   g36(.a(x15), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n50_), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(new_n51_), .c(new_n48_), .O(z09));
  ...
  oai21  g42(.a(new_n87_), .b(new_n85_), .c(new_n48_), .O(z11));
  nand3  g43(.a(x19), .b(x18), .c(x17), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  aoi21  g45(.a(x18), .b(x17), .c(x19), .O(new_n91_));
  nor4   g46(.a(new_n91_), .b(new_n90_), .c(new_n85_), .d(new_n47_), .O(z12));
  nor2   g47(.a(new_n85_), .b(new_n47_), .O(new_n93_));
  ...
  nand3  g56(.a(new_n94_), .b(new_n58_), .c(new_n57_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n93_), .O(z15));
  nand2  g58(.a(new_n85_), .b(new_n48_), .O(new_n104_));
  nor2   g59(.a(new_n102_), .b(x23), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x24), .O(new_n106_));
  nand2  g61(.a(new_n102_), .b(x23), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(z16));
  oai21  g63(.a(new_n105_), .b(new_n55_), .c(new_n104_), .O(z17));
  or2    g64(.a(new_n85_), .b(new_n63_), .O(z18));
endmodule
