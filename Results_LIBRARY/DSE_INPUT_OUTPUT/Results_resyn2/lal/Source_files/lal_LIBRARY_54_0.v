...
module FAU ( 
  ...
  aoi21  g20(.a(new_n57_), .b(x24), .c(new_n65_), .O(z03));
  ...
  nand3  g37(.a(new_n53_), .b(new_n82_), .c(new_n81_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  inv1   g39(.a(new_n56_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n84_), .c(x23), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n79_), .c(new_n64_), .O(z08));
  inv1   g42(.a(x15), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n59_), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(new_n60_), .c(new_n49_), .O(z09));
  nand3  g45(.a(new_n60_), .b(new_n88_), .c(new_n59_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(x17), .c(new_n49_), .O(z10));
  inv1   g47(.a(new_n54_), .O(new_n93_));
  nor2   g48(.a(new_n91_), .b(new_n48_), .O(new_n94_));
  ...
  nand2  g58(.a(new_n103_), .b(new_n80_), .O(new_n104_));
  aoi21  g59(.a(new_n99_), .b(x20), .c(new_n91_), .O(new_n105_));
  ...
  aoi21  g63(.a(new_n108_), .b(new_n103_), .c(new_n91_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n107_), .c(new_n48_), .O(z14));
  inv1   g65(.a(x22), .O(new_n111_));
  nand3  g66(.a(new_n108_), .b(new_n103_), .c(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n108_), .b(new_n103_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n94_), .O(z15));
  nand4  g70(.a(new_n108_), .b(new_n103_), .c(new_n52_), .d(new_n111_), .O(new_n116_));
  nand2  g71(.a(new_n112_), .b(x23), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n94_), .O(z16));
  nand2  g73(.a(new_n116_), .b(x24), .O(new_n119_));
  oai21  g74(.a(new_n98_), .b(new_n48_), .c(new_n119_), .O(z17));
  inv1   g75(.a(x25), .O(new_n121_));
  aoi21  g76(.a(new_n98_), .b(new_n121_), .c(new_n48_), .O(z18));
endmodule
