...
module FAU ( 
  ...
  aoi21  g01(.a(x24), .b(x23), .c(x08), .O(new_n47_));
  aoi21  g02(.a(new_n46_), .b(x16), .c(new_n47_), .O(z00));
  ...
  nand3  g15(.a(new_n60_), .b(new_n59_), .c(new_n46_), .O(z01));
  inv1   g16(.a(x16), .O(new_n62_));
  nand2  g17(.a(new_n46_), .b(new_n62_), .O(z02));
  inv1   g18(.a(x23), .O(new_n64_));
  nor2   g19(.a(x18), .b(x17), .O(new_n65_));
  aoi21  g20(.a(new_n65_), .b(new_n53_), .c(x20), .O(new_n66_));
  oai21  g21(.a(new_n56_), .b(new_n66_), .c(new_n64_), .O(new_n67_));
  ...
  oai21  g29(.a(new_n74_), .b(x08), .c(new_n46_), .O(z04));
  inv1   g30(.a(x13), .O(new_n76_));
  nand2  g31(.a(new_n47_), .b(new_n76_), .O(new_n77_));
  inv1   g32(.a(new_n77_), .O(z05));
  inv1   g33(.a(x14), .O(new_n79_));
  oai21  g34(.a(new_n79_), .b(x08), .c(new_n46_), .O(z06));
  nand2  g35(.a(new_n47_), .b(x06), .O(z07));
  aoi21  g36(.a(new_n54_), .b(new_n50_), .c(new_n56_), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(x23), .c(x24), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n49_), .O(z08));
  nand2  g39(.a(x05), .b(x04), .O(new_n85_));
  inv1   g40(.a(x07), .O(new_n86_));
  inv1   g41(.a(x15), .O(new_n87_));
  nand3  g42(.a(new_n46_), .b(new_n87_), .c(new_n86_), .O(new_n88_));
  ...
  nand2  g70(.a(new_n90_), .b(new_n46_), .O(new_n116_));
