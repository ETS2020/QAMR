// Benchmark "FAU" written by ABC on Tue Aug 11 20:08:04 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n79_, new_n80_, new_n82_, new_n86_, new_n88_, new_n90_, new_n91_,
  ...
  inv1   g33(.a(new_n70_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z05));
  nand2  g36(.a(x14), .b(new_n69_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n50_), .O(z06));
  nand2  g38(.a(new_n79_), .b(x06), .O(z07));
  aoi21  g39(.a(new_n61_), .b(new_n53_), .c(new_n49_), .O(z08));
  nand3  g40(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(new_n64_), .b(new_n48_), .O(new_n88_));
  ...
  oai21  g47(.a(new_n92_), .b(new_n88_), .c(new_n50_), .O(z11));
  ...
  nor2   g51(.a(new_n96_), .b(new_n88_), .O(z12));
  nand2  g52(.a(new_n48_), .b(x07), .O(new_n98_));
  nor2   g53(.a(new_n94_), .b(x20), .O(new_n99_));
  nand2  g54(.a(new_n94_), .b(x20), .O(new_n100_));
  nor2   g55(.a(new_n63_), .b(x15), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  oai21  g57(.a(new_n102_), .b(new_n99_), .c(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n98_), .O(z13));
  inv1   g59(.a(x21), .O(new_n105_));
  aoi21  g60(.a(new_n99_), .b(new_n105_), .c(new_n88_), .O(new_n106_));
  oai21  g61(.a(new_n99_), .b(new_n105_), .c(new_n106_), .O(z14));
  inv1   g62(.a(x22), .O(new_n108_));
  aoi21  g63(.a(new_n99_), .b(new_n105_), .c(new_n108_), .O(new_n109_));
  nor2   g64(.a(x22), .b(x21), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n99_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n101_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n109_), .c(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n98_), .O(z15));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand3  g71(.a(new_n110_), .b(new_n99_), .c(new_n116_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n64_), .d(new_n48_), .O(z16));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n110_), .c(new_n99_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n101_), .O(new_n121_));
  aoi21  g76(.a(new_n117_), .b(x24), .c(new_n121_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(x07), .c(new_n98_), .O(z17));
  nand4  g78(.a(new_n119_), .b(new_n110_), .c(new_n99_), .d(new_n53_), .O(new_n124_));
  nand2  g79(.a(new_n120_), .b(x25), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n101_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n98_), .O(z18));
endmodule
