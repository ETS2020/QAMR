...
module FAU ( 
  ...
  oai21  g15(.a(new_n60_), .b(new_n47_), .c(new_n51_), .O(new_n61_));
  ...
  nand2  g35(.a(new_n71_), .b(x02), .O(new_n81_));
  ...
  aoi21  g45(.a(new_n90_), .b(new_n55_), .c(x20), .O(new_n91_));
  oai21  g46(.a(new_n58_), .b(new_n91_), .c(new_n89_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(x24), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g49(.a(x07), .O(new_n95_));
  inv1   g50(.a(x15), .O(new_n96_));
  nand4  g51(.a(new_n63_), .b(new_n49_), .c(new_n96_), .d(new_n95_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z09));
  nand3  g53(.a(new_n62_), .b(new_n96_), .c(new_n95_), .O(new_n99_));
  oai21  g54(.a(new_n99_), .b(x17), .c(new_n49_), .O(z10));
  nor2   g55(.a(new_n54_), .b(new_n53_), .O(new_n101_));
  or2    g56(.a(new_n101_), .b(new_n90_), .O(new_n102_));
  oai21  g57(.a(new_n102_), .b(new_n99_), .c(new_n49_), .O(z11));
  nand4  g58(.a(new_n62_), .b(new_n49_), .c(new_n96_), .d(new_n95_), .O(new_n104_));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nor2   g61(.a(new_n101_), .b(x19), .O(new_n107_));
  nor3   g62(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(z12));
  nor2   g63(.a(new_n105_), .b(x20), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x20), .c(new_n99_), .O(new_n111_));
  ...
  nand2  g70(.a(new_n109_), .b(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z14));
  inv1   g72(.a(x22), .O(new_n118_));
  nand3  g73(.a(new_n109_), .b(new_n118_), .c(new_n115_), .O(new_n119_));
  nand2  g74(.a(new_n116_), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n113_), .O(z15));
  ...
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n113_), .O(z16));
  inv1   g80(.a(new_n99_), .O(new_n126_));
  nand2  g81(.a(new_n124_), .b(x24), .O(new_n127_));
  nand2  g82(.a(x24), .b(x02), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n123_), .c(new_n109_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n126_), .O(z17));
  nor2   g85(.a(new_n51_), .b(new_n47_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n99_), .c(new_n49_), .O(new_n132_));
  nand3  g87(.a(new_n123_), .b(new_n109_), .c(x25), .O(new_n133_));
  nand2  g88(.a(new_n124_), .b(new_n51_), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n133_), .c(new_n47_), .O(new_n135_));
