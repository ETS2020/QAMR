...
module FAU ( 
  ...
  nand2  g35(.a(new_n50_), .b(x03), .O(new_n81_));
  ...
  aoi21  g42(.a(new_n73_), .b(x06), .c(new_n68_), .O(z07));
  inv1   g43(.a(x25), .O(new_n89_));
  inv1   g44(.a(x23), .O(new_n90_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(x24), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n89_), .c(new_n68_), .O(z08));
  inv1   g49(.a(x15), .O(new_n95_));
  nand3  g50(.a(new_n47_), .b(new_n95_), .c(new_n63_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(new_n64_), .O(z09));
  nand3  g52(.a(new_n64_), .b(new_n95_), .c(new_n63_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(x17), .c(new_n47_), .O(z10));
  xnor2a g54(.a(x18), .b(x17), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n98_), .c(new_n47_), .O(z11));
  ...
  nand2  g63(.a(new_n105_), .b(new_n52_), .O(new_n109_));
  ...
  nor2   g67(.a(new_n104_), .b(x20), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n58_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n108_), .O(z14));
  nand2  g70(.a(new_n114_), .b(x22), .O(new_n116_));
  inv1   g71(.a(new_n114_), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(new_n59_), .c(new_n98_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n116_), .c(new_n68_), .O(z15));
  oai21  g74(.a(new_n114_), .b(x22), .c(x23), .O(new_n120_));
  nand4  g75(.a(new_n113_), .b(new_n90_), .c(new_n59_), .d(new_n58_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n108_), .O(z16));
  inv1   g77(.a(new_n98_), .O(new_n123_));
  oai21  g78(.a(new_n121_), .b(x12), .c(x24), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n117_), .c(new_n59_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(z17));
  nand4  g82(.a(new_n125_), .b(new_n117_), .c(new_n89_), .d(new_n59_), .O(new_n128_));
  nand2  g83(.a(new_n47_), .b(new_n89_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n123_), .O(z18));
endmodule
