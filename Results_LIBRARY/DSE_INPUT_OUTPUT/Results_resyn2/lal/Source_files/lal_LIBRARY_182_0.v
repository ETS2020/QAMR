...
module FAU ( 
  ...
  nor3   g29(.a(new_n47_), .b(new_n74_), .c(x08), .O(z06));
  aoi21  g30(.a(new_n46_), .b(x06), .c(new_n47_), .O(z07));
  nor2   g31(.a(x18), .b(x17), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(x24), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n56_), .c(x15), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n54_), .O(new_n80_));
  inv1   g35(.a(x23), .O(new_n81_));
  oai21  g36(.a(new_n56_), .b(new_n51_), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g42(.a(x19), .b(new_n87_), .c(new_n86_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(new_n85_), .O(z09));
  nand2  g44(.a(new_n60_), .b(new_n52_), .O(new_n90_));
  ...
  nor2   g51(.a(new_n96_), .b(new_n77_), .O(z11));
  inv1   g52(.a(new_n96_), .O(z12));
  nand2  g53(.a(new_n95_), .b(x20), .O(new_n99_));
  nor2   g54(.a(new_n95_), .b(x20), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n60_), .O(new_n102_));
  ...
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n94_), .O(z14));
  nand2  g63(.a(new_n106_), .b(x22), .O(new_n109_));
  inv1   g64(.a(x22), .O(new_n110_));
  nand3  g65(.a(new_n100_), .b(new_n110_), .c(new_n105_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n94_), .O(z15));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n113_));
  nand4  g68(.a(new_n100_), .b(new_n81_), .c(new_n110_), .d(new_n105_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n94_), .O(z16));
  nand2  g70(.a(new_n114_), .b(x24), .O(new_n116_));
  nor2   g71(.a(x24), .b(x23), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n100_), .c(new_n110_), .d(new_n105_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n94_), .O(z17));
  aoi21  g74(.a(new_n118_), .b(x25), .c(new_n93_), .O(new_n120_));
