// Benchmark "FAU" written by ABC on Tue Aug 11 20:08:30 2020
...
module FAU ( 
  ...
  aoi21  g29(.a(new_n74_), .b(new_n71_), .c(new_n52_), .O(z04));
  nor2   g30(.a(new_n52_), .b(x13), .O(z05));
  nand2  g31(.a(x14), .b(new_n50_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n51_), .O(z06));
  nand2  g33(.a(new_n53_), .b(x06), .O(z07));
  inv1   g34(.a(x07), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(x05), .c(x04), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g37(.a(x15), .O(new_n83_));
  nand3  g38(.a(new_n65_), .b(new_n83_), .c(new_n47_), .O(new_n84_));
  ...
  nand2  g46(.a(new_n89_), .b(new_n59_), .O(new_n92_));
  ...
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n65_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n83_), .O(z14));
  inv1   g60(.a(x22), .O(new_n106_));
  nor3   g61(.a(new_n93_), .b(x21), .c(x20), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n106_), .c(new_n84_), .O(new_n108_));
  oai21  g63(.a(new_n107_), .b(new_n106_), .c(new_n108_), .O(z15));
  oai21  g64(.a(new_n102_), .b(x22), .c(x23), .O(new_n110_));
  nor2   g65(.a(x23), .b(x22), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n101_), .c(new_n96_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n65_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n83_), .O(z16));
  ...
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n65_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n83_), .O(z17));
