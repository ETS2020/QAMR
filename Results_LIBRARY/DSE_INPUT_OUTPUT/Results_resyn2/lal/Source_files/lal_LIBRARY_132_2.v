...
module FAU ( 
  ...
  aoi21  g15(.a(new_n60_), .b(new_n53_), .c(new_n54_), .O(new_n61_));
  inv1   g16(.a(x21), .O(new_n62_));
  oai21  g17(.a(x25), .b(x23), .c(new_n48_), .O(new_n63_));
  ...
  oai21  g22(.a(new_n61_), .b(x25), .c(new_n67_), .O(z01));
  nand2  g23(.a(x22), .b(x21), .O(new_n69_));
  oai21  g24(.a(new_n69_), .b(new_n58_), .c(new_n53_), .O(new_n70_));
  inv1   g25(.a(x25), .O(new_n71_));
  inv1   g26(.a(x22), .O(new_n72_));
  oai21  g27(.a(new_n54_), .b(new_n72_), .c(x21), .O(new_n73_));
  nand2  g28(.a(new_n73_), .b(x20), .O(new_n74_));
  nand2  g29(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  aoi21  g30(.a(new_n70_), .b(x24), .c(new_n75_), .O(z03));
  ...
  nor2   g40(.a(new_n85_), .b(new_n49_), .O(z06));
  ...
  oai21  g45(.a(new_n90_), .b(new_n65_), .c(new_n50_), .O(z09));
  nand2  g46(.a(new_n89_), .b(new_n65_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n50_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z11));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n96_), .b(new_n57_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(new_n101_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n95_), .d(new_n50_), .O(z13));
  nand2  g61(.a(new_n99_), .b(x21), .O(new_n107_));
  nor2   g62(.a(new_n99_), .b(x21), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n95_), .d(new_n48_), .O(z14));
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(new_n72_), .c(new_n92_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n49_), .O(z15));
  oai21  g68(.a(new_n109_), .b(x22), .c(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  aoi21  g70(.a(new_n115_), .b(new_n108_), .c(new_n92_), .O(new_n116_));
  oai21  g71(.a(x23), .b(new_n62_), .c(x20), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n114_), .O(z16));
  nand4  g73(.a(new_n115_), .b(new_n89_), .c(new_n65_), .d(x24), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n99_), .c(new_n48_), .O(new_n120_));
  aoi22  g75(.a(new_n120_), .b(new_n62_), .c(new_n116_), .d(new_n54_), .O(z17));
  nand3  g76(.a(new_n115_), .b(new_n108_), .c(new_n54_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n71_), .O(new_n124_));
  nand2  g79(.a(new_n122_), .b(x25), .O(new_n125_));
  oai21  g80(.a(x25), .b(new_n62_), .c(x20), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n95_), .O(z18));
endmodule
