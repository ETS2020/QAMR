...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n75_, new_n78_, new_n79_, new_n80_, new_n82_, new_n83_,
  ...
  nand3  g15(.a(new_n60_), .b(new_n59_), .c(new_n48_), .O(z01));
  inv1   g16(.a(x16), .O(new_n62_));
  nand2  g17(.a(new_n48_), .b(new_n62_), .O(z02));
  nand3  g18(.a(new_n58_), .b(new_n48_), .c(new_n50_), .O(z08));
  ...
  aoi22  g31(.a(x15), .b(new_n47_), .c(new_n46_), .d(x06), .O(z07));
  inv1   g32(.a(x07), .O(new_n78_));
  inv1   g33(.a(x15), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n78_), .c(x05), .d(x04), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z09));
  nand2  g36(.a(new_n60_), .b(new_n79_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n52_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z10));
  oai21  g40(.a(x15), .b(x05), .c(x04), .O(new_n86_));
  nor2   g41(.a(new_n53_), .b(new_n52_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n53_), .b(new_n52_), .c(x07), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n86_), .O(new_n90_));
  ...
  nor2   g49(.a(new_n94_), .b(new_n82_), .O(z12));
  nand2  g50(.a(new_n92_), .b(x20), .O(new_n96_));
  nand4  g51(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n78_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n79_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n86_), .O(z13));
  nand2  g55(.a(new_n97_), .b(x21), .O(new_n101_));
  inv1   g56(.a(x21), .O(new_n102_));
  inv1   g57(.a(new_n97_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n101_), .c(new_n83_), .O(z14));
  inv1   g60(.a(x22), .O(new_n106_));
  nand3  g61(.a(new_n103_), .b(new_n106_), .c(new_n102_), .O(new_n107_));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n83_), .O(z15));
  nand2  g64(.a(new_n107_), .b(x23), .O(new_n110_));
  nor2   g65(.a(x20), .b(new_n54_), .O(new_n111_));
  nor2   g66(.a(x23), .b(x22), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n111_), .c(new_n87_), .d(new_n102_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n83_), .O(z16));
  inv1   g69(.a(x23), .O(new_n115_));
  inv1   g70(.a(x24), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n115_), .c(new_n106_), .d(new_n102_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n97_), .c(new_n78_), .O(new_n118_));
  aoi21  g73(.a(new_n113_), .b(x24), .c(new_n118_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(x15), .c(new_n86_), .O(z17));
  inv1   g75(.a(new_n117_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n103_), .c(new_n50_), .O(new_n122_));
  oai21  g77(.a(new_n117_), .b(new_n97_), .c(x25), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n78_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n79_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n86_), .O(z18));
endmodule
