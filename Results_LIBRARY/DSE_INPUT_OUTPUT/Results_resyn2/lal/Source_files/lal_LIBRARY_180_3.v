...
module FAU ( 
  ...
  aoi21  g39(.a(new_n46_), .b(x06), .c(new_n69_), .O(z07));
  ...
  aoi21  g63(.a(new_n103_), .b(new_n108_), .c(new_n89_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n107_), .c(new_n69_), .O(z14));
  ...
  aoi21  g68(.a(new_n113_), .b(new_n111_), .c(new_n69_), .O(z15));
  nand3  g69(.a(new_n112_), .b(new_n103_), .c(new_n54_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x23), .O(new_n116_));
  nand3  g71(.a(new_n112_), .b(new_n103_), .c(new_n53_), .O(new_n117_));
  ...
  nand3  g76(.a(new_n121_), .b(new_n68_), .c(new_n54_), .O(new_n122_));
