...
module FAU ( 
  ...
  aoi21  g17(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(new_n63_));
  oai21  g18(.a(new_n63_), .b(x07), .c(new_n52_), .O(z01));
  nand2  g19(.a(new_n47_), .b(new_n46_), .O(z02));
  aoi21  g20(.a(new_n59_), .b(new_n58_), .c(x23), .O(new_n66_));
  oai21  g21(.a(new_n66_), .b(new_n50_), .c(new_n51_), .O(new_n67_));
  nand2  g22(.a(new_n67_), .b(new_n47_), .O(z03));
  aoi21  g23(.a(x24), .b(x07), .c(x08), .O(new_n69_));
  ...
  nand3  g38(.a(new_n60_), .b(new_n83_), .c(new_n82_), .O(new_n84_));
  ...
  nor2   g44(.a(new_n62_), .b(x15), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n82_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(x17), .c(new_n47_), .O(z10));
  xnor2a g47(.a(x18), .b(x17), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n91_), .c(new_n47_), .O(z11));
  nand3  g49(.a(x19), .b(x18), .c(x17), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(new_n96_));
  aoi21  g51(.a(x18), .b(x17), .c(x19), .O(new_n97_));
  nor3   g52(.a(new_n97_), .b(new_n96_), .c(new_n91_), .O(z12));
  inv1   g53(.a(new_n91_), .O(new_n99_));
  nand2  g54(.a(new_n96_), .b(new_n53_), .O(new_n100_));
  nand2  g55(.a(new_n95_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(z13));
  ...
  nand2  g61(.a(new_n50_), .b(x07), .O(new_n107_));
  nand2  g62(.a(new_n105_), .b(x22), .O(new_n108_));
  inv1   g63(.a(x22), .O(new_n109_));
  nand3  g64(.a(new_n104_), .b(new_n96_), .c(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n90_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n82_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n107_), .O(z15));
  nand2  g68(.a(new_n110_), .b(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n104_), .c(new_n96_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n90_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n82_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n107_), .O(z16));
  nand2  g74(.a(new_n116_), .b(x24), .O(new_n120_));
  nand4  g75(.a(new_n115_), .b(new_n104_), .c(new_n96_), .d(new_n50_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n99_), .O(z17));
  inv1   g77(.a(new_n121_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n51_), .O(new_n124_));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n99_), .O(z18));
endmodule
