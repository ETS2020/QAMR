...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n75_, new_n79_, new_n80_, new_n82_, new_n83_,
  ...
  nand4  g34(.a(new_n79_), .b(new_n47_), .c(x05), .d(x04), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z09));
  nand3  g36(.a(new_n61_), .b(new_n79_), .c(new_n47_), .O(new_n82_));
  ...
  nand3  g58(.a(new_n103_), .b(new_n100_), .c(new_n61_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n79_), .O(z14));
  inv1   g61(.a(x22), .O(new_n107_));
  nor2   g62(.a(x20), .b(new_n55_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n90_), .c(new_n107_), .d(new_n101_), .O(new_n109_));
  oai21  g64(.a(new_n96_), .b(x21), .c(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n61_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n79_), .O(z15));
  ...
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n61_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n79_), .O(z16));
  ...
  nor2   g77(.a(new_n122_), .b(new_n96_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(new_n82_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n120_), .O(z17));
  nand2  g80(.a(new_n123_), .b(new_n51_), .O(new_n126_));
  oai21  g81(.a(new_n122_), .b(new_n96_), .c(x25), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n61_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n79_), .O(z18));
endmodule
