...
module FAU ( 
  ...
  oai21  g16(.a(new_n60_), .b(new_n57_), .c(new_n61_), .O(new_n62_));
  nand2  g17(.a(new_n62_), .b(x24), .O(new_n63_));
  nand2  g18(.a(new_n63_), .b(new_n47_), .O(z01));
  and2   g19(.a(new_n49_), .b(x16), .O(z02));
  oai21  g20(.a(new_n59_), .b(new_n47_), .c(new_n48_), .O(new_n66_));
  oai21  g21(.a(new_n60_), .b(new_n57_), .c(new_n66_), .O(z03));
  ...
  aoi22  g33(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(x06), .O(z07));
  oai21  g34(.a(new_n57_), .b(x23), .c(x24), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(new_n49_), .c(new_n59_), .O(z08));
  inv1   g36(.a(x15), .O(new_n82_));
  nand3  g37(.a(x24), .b(new_n82_), .c(new_n47_), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(new_n61_), .O(z09));
  inv1   g39(.a(new_n83_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n61_), .O(new_n86_));
  ...
  nand2  g51(.a(new_n94_), .b(new_n51_), .O(new_n97_));
  nand2  g52(.a(new_n93_), .b(x20), .O(new_n98_));
  nand2  g53(.a(new_n61_), .b(new_n82_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n97_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x24), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n47_), .O(z13));
  nand2  g58(.a(new_n97_), .b(x21), .O(new_n104_));
  ...
  nor2   g64(.a(new_n93_), .b(x20), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g67(.a(new_n106_), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n100_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x24), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(z15));
  aoi21  g71(.a(new_n111_), .b(new_n110_), .c(new_n58_), .O(new_n117_));
  nand3  g72(.a(new_n111_), .b(new_n110_), .c(new_n58_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n100_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n117_), .c(x24), .O(new_n120_));
  ...
  nand2  g78(.a(new_n87_), .b(new_n59_), .O(z18));
endmodule
