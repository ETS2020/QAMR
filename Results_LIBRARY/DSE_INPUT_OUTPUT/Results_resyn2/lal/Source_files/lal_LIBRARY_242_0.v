...
module FAU ( 
  ...
  nor2   g02(.a(x13), .b(x12), .O(new_n48_));
  ...
  oai21  g24(.a(x08), .b(new_n69_), .c(x13), .O(new_n70_));
  ...
  nand3  g38(.a(new_n83_), .b(x12), .c(new_n46_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z05));
  nand2  g40(.a(x14), .b(new_n46_), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n48_), .O(z06));
  nand3  g42(.a(new_n49_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g43(.a(new_n60_), .b(new_n52_), .c(new_n48_), .O(z08));
  nor3   g44(.a(new_n48_), .b(x15), .c(x07), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n63_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  inv1   g47(.a(x07), .O(new_n93_));
  inv1   g48(.a(x15), .O(new_n94_));
  nand3  g49(.a(new_n62_), .b(new_n94_), .c(new_n93_), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(x17), .c(new_n49_), .O(z10));
  nand2  g51(.a(new_n55_), .b(new_n54_), .O(new_n97_));
  nand2  g52(.a(x18), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g54(.a(new_n99_), .b(new_n95_), .c(new_n49_), .O(z11));
  nand2  g55(.a(new_n98_), .b(new_n56_), .O(new_n101_));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n95_), .c(new_n49_), .O(z12));
  inv1   g59(.a(new_n102_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  aoi21  g61(.a(new_n102_), .b(x20), .c(new_n95_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n106_), .c(new_n48_), .O(z13));
  nand2  g63(.a(new_n106_), .b(x21), .O(new_n109_));
  nor3   g64(.a(new_n102_), .b(x21), .c(x20), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand2  g66(.a(new_n90_), .b(new_n62_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n109_), .O(z14));
  nand2  g69(.a(new_n111_), .b(x22), .O(new_n115_));
  inv1   g70(.a(x22), .O(new_n116_));
  nand2  g71(.a(new_n110_), .b(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  aoi21  g75(.a(new_n120_), .b(new_n110_), .c(new_n95_), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n119_), .c(new_n48_), .O(z16));
  nand2  g77(.a(new_n120_), .b(new_n110_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n95_), .O(new_n125_));
  inv1   g80(.a(x24), .O(new_n126_));
  nor2   g81(.a(x21), .b(x20), .O(new_n127_));
  nand4  g82(.a(new_n120_), .b(new_n127_), .c(new_n105_), .d(new_n126_), .O(new_n128_));
  and2   g83(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  aoi21  g84(.a(new_n129_), .b(new_n124_), .c(new_n48_), .O(z17));
  inv1   g85(.a(new_n128_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n52_), .O(new_n132_));
  nand2  g87(.a(new_n128_), .b(x25), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n113_), .O(z18));
endmodule
