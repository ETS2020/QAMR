...
module FAU ( 
  ...
  oai21  g48(.a(new_n93_), .b(new_n83_), .c(new_n51_), .O(z12));
  inv1   g49(.a(new_n92_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n56_), .O(new_n96_));
  nand2  g51(.a(new_n92_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n84_), .O(z13));
  nand2  g53(.a(x15), .b(x11), .O(new_n99_));
  ...
  nand2  g59(.a(new_n104_), .b(new_n99_), .O(z14));
  inv1   g60(.a(x22), .O(new_n106_));
  nor3   g61(.a(new_n92_), .b(x21), .c(x20), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n106_), .c(new_n83_), .O(new_n108_));
  ...
  nand2  g75(.a(new_n120_), .b(new_n99_), .O(z17));
  aoi21  g76(.a(new_n118_), .b(x25), .c(new_n83_), .O(new_n122_));
