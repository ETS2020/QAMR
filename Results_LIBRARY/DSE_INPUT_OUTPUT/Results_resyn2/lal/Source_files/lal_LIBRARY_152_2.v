...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n74_, new_n76_, new_n80_, new_n81_, new_n82_, new_n83_,
  ...
  aoi21  g16(.a(new_n61_), .b(new_n51_), .c(new_n48_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nand2  g18(.a(new_n49_), .b(new_n63_), .O(z02));
  nand3  g19(.a(new_n60_), .b(new_n49_), .c(new_n52_), .O(z08));
  ...
  nor2   g33(.a(new_n51_), .b(x15), .O(z09));
  ...
  nand2  g50(.a(new_n95_), .b(new_n85_), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n94_), .c(new_n47_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n80_), .O(z13));
  ...
  nand2  g69(.a(new_n114_), .b(new_n85_), .O(new_n115_));
  aoi21  g70(.a(new_n111_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x07), .c(new_n80_), .O(z17));
  nand4  g72(.a(new_n113_), .b(new_n106_), .c(new_n94_), .d(new_n52_), .O(new_n118_));
  nand2  g73(.a(new_n114_), .b(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n85_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n80_), .O(z18));
endmodule
