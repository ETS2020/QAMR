...
module FAU ( 
  ...
  aoi21  g35(.a(new_n59_), .b(new_n80_), .c(x07), .O(z09));
  nand2  g36(.a(new_n59_), .b(new_n52_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n80_), .c(x07), .O(z10));
  aoi21  g38(.a(new_n53_), .b(new_n52_), .c(new_n60_), .O(new_n84_));
  oai21  g39(.a(new_n53_), .b(new_n52_), .c(new_n84_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n80_), .c(x07), .O(z11));
  nand3  g41(.a(new_n59_), .b(new_n80_), .c(new_n47_), .O(new_n87_));
  ...
  oai21  g49(.a(new_n94_), .b(new_n92_), .c(new_n80_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n47_), .O(z13));
  inv1   g51(.a(new_n87_), .O(new_n97_));
  oai21  g52(.a(new_n88_), .b(x20), .c(x21), .O(new_n98_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n97_), .O(z15));
  and2   g60(.a(new_n104_), .b(x23), .O(new_n106_));
  oai21  g61(.a(new_n104_), .b(x23), .c(new_n59_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n106_), .c(new_n80_), .O(new_n108_));
  ...
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n97_), .O(z17));
  ...
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n80_), .O(new_n117_));
