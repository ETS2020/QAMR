...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n61_, new_n63_, new_n65_, new_n66_, new_n67_, new_n70_, new_n71_,
  ...
  nand2  g13(.a(x24), .b(x15), .O(new_n59_));
  oai21  g14(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(new_n60_));
  ...
  nand2  g20(.a(new_n48_), .b(x15), .O(new_n66_));
  inv1   g21(.a(new_n66_), .O(new_n67_));
  oai21  g22(.a(new_n58_), .b(new_n65_), .c(new_n67_), .O(z08));
  inv1   g23(.a(z08), .O(z03));
  ...
  nand3  g38(.a(x25), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  nor2   g39(.a(new_n84_), .b(new_n82_), .O(z09));
  inv1   g40(.a(new_n84_), .O(new_n86_));
  ...
  nand3  g47(.a(new_n92_), .b(new_n61_), .c(new_n91_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(x25), .c(x15), .O(z11));
  ...
  nand2  g53(.a(new_n96_), .b(new_n51_), .O(new_n99_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n61_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x25), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(z14));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n108_));
  inv1   g63(.a(x22), .O(new_n109_));
  nand3  g64(.a(new_n103_), .b(new_n96_), .c(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n88_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  inv1   g67(.a(x23), .O(new_n113_));
  nand4  g68(.a(new_n103_), .b(new_n96_), .c(new_n113_), .d(new_n109_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n61_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x25), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n47_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  inv1   g73(.a(new_n114_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n65_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n88_), .O(z17));
  nand3  g76(.a(new_n119_), .b(new_n88_), .c(new_n65_), .O(z18));
endmodule
