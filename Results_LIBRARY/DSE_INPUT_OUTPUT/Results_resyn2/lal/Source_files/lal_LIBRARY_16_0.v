...
module FAU ( 
  ...
  oai21  g025(.a(new_n51_), .b(new_n58_), .c(new_n50_), .O(new_n71_));
  nand2  g026(.a(new_n71_), .b(x24), .O(new_n72_));
  nand3  g027(.a(new_n72_), .b(new_n70_), .c(new_n59_), .O(z08));
  inv1   g028(.a(z08), .O(z03));
  aoi21  g029(.a(new_n46_), .b(x03), .c(new_n61_), .O(new_n75_));
  ...
  oai21  g043(.a(new_n88_), .b(new_n82_), .c(new_n46_), .O(new_n89_));
  oai21  g044(.a(new_n75_), .b(x12), .c(new_n89_), .O(z04));
  oai21  g045(.a(x13), .b(x08), .c(new_n48_), .O(z05));
  nand2  g046(.a(x14), .b(new_n46_), .O(new_n92_));
  nand2  g047(.a(new_n92_), .b(new_n48_), .O(z06));
  nand3  g048(.a(new_n48_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g049(.a(x15), .O(new_n95_));
  nand2  g050(.a(new_n95_), .b(new_n54_), .O(new_n96_));
  oai21  g051(.a(new_n96_), .b(new_n55_), .c(new_n48_), .O(z09));
  nand3  g052(.a(new_n55_), .b(new_n95_), .c(new_n54_), .O(new_n98_));
  oai21  g053(.a(new_n98_), .b(x17), .c(new_n48_), .O(z10));
  xnor2a g054(.a(x18), .b(x17), .O(new_n100_));
  oai21  g055(.a(new_n100_), .b(new_n98_), .c(new_n48_), .O(z11));
  ...
  oai21  g064(.a(new_n47_), .b(x20), .c(new_n105_), .O(new_n110_));
  ...
  oai21  g070(.a(new_n47_), .b(x21), .c(new_n112_), .O(new_n116_));
  nand3  g071(.a(new_n116_), .b(new_n115_), .c(new_n102_), .O(z14));
  oai21  g072(.a(new_n47_), .b(x22), .c(new_n115_), .O(new_n118_));
  ...
  nand3  g077(.a(new_n58_), .b(x19), .c(x17), .O(new_n123_));
  inv1   g078(.a(x22), .O(new_n124_));
  nand3  g079(.a(new_n50_), .b(new_n124_), .c(new_n114_), .O(new_n125_));
  nor2   g080(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  aoi21  g081(.a(new_n122_), .b(x23), .c(new_n126_), .O(new_n127_));
  nor2   g082(.a(new_n50_), .b(x18), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(new_n98_), .c(new_n48_), .O(new_n129_));
  ...
  oai21  g092(.a(new_n137_), .b(new_n98_), .c(new_n48_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n135_), .O(z17));
  nand4  g094(.a(new_n136_), .b(new_n50_), .c(new_n124_), .d(new_n114_), .O(new_n140_));
  ...
  nor2   g100(.a(new_n59_), .b(x18), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n98_), .c(new_n48_), .O(new_n147_));
