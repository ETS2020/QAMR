...
module FAU ( 
  ...
  nor2   g02(.a(x09), .b(new_n47_), .O(new_n48_));
  ...
  aoi21  g15(.a(x09), .b(new_n60_), .c(new_n47_), .O(new_n61_));
  ...
  nand3  g21(.a(new_n58_), .b(new_n66_), .c(new_n50_), .O(z08));
  inv1   g22(.a(z08), .O(z03));
  inv1   g23(.a(x09), .O(new_n69_));
  inv1   g24(.a(x00), .O(new_n70_));
  oai21  g25(.a(x08), .b(new_n70_), .c(new_n47_), .O(new_n71_));
  ...
  oai21  g30(.a(new_n69_), .b(x00), .c(new_n75_), .O(new_n76_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n46_), .c(x06), .O(z07));
  nand2  g43(.a(x05), .b(x04), .O(new_n89_));
  nor2   g44(.a(x15), .b(x07), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(new_n91_));
  nor3   g46(.a(new_n91_), .b(new_n89_), .c(new_n69_), .O(z09));
  nor2   g47(.a(new_n91_), .b(new_n61_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n52_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z10));
  nand2  g50(.a(new_n53_), .b(new_n52_), .O(new_n96_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n93_), .O(new_n102_));
  ...
  nor3   g63(.a(new_n100_), .b(x21), .c(x20), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n93_), .O(z14));
  inv1   g66(.a(x22), .O(new_n112_));
  nand2  g67(.a(new_n109_), .b(new_n112_), .O(new_n113_));
  nand2  g68(.a(new_n110_), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n93_), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand2  g72(.a(new_n90_), .b(new_n89_), .O(new_n118_));
  aoi21  g73(.a(new_n117_), .b(new_n109_), .c(new_n118_), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n116_), .c(new_n48_), .O(z16));
  nand2  g75(.a(new_n117_), .b(new_n109_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n117_), .c(new_n105_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n93_), .O(z17));
  nand4  g80(.a(new_n123_), .b(new_n117_), .c(new_n105_), .d(new_n50_), .O(new_n126_));
  aoi21  g81(.a(new_n124_), .b(x25), .c(new_n118_), .O(new_n127_));
