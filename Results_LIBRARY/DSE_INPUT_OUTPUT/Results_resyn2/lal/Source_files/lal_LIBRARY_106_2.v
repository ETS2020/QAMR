...
module FAU ( 
  ...
  nand2  g53(.a(new_n94_), .b(new_n57_), .O(new_n99_));
  ...
  nand2  g57(.a(new_n102_), .b(new_n54_), .O(new_n103_));
  aoi21  g58(.a(new_n98_), .b(x20), .c(new_n90_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n48_), .O(z13));
  ...
  aoi21  g63(.a(new_n108_), .b(new_n106_), .c(new_n48_), .O(z14));
  inv1   g64(.a(x22), .O(new_n110_));
  or2    g65(.a(new_n107_), .b(new_n110_), .O(new_n111_));
  nand2  g66(.a(new_n107_), .b(new_n110_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n93_), .O(z15));
  nand3  g68(.a(new_n107_), .b(new_n47_), .c(new_n110_), .O(new_n114_));
  nand2  g69(.a(new_n112_), .b(x23), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n93_), .O(z16));
  nand2  g71(.a(new_n112_), .b(x24), .O(new_n117_));
  nor2   g72(.a(x21), .b(x20), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n102_), .c(new_n53_), .d(new_n110_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n97_), .d(new_n47_), .O(z17));
  xor2a  g75(.a(new_n119_), .b(x25), .O(new_n121_));
  nand2  g76(.a(new_n51_), .b(x24), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(x23), .c(new_n90_), .O(new_n123_));
