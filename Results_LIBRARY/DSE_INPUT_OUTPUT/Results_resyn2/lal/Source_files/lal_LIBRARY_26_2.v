...
module FAU ( 
  ...
  inv1   g39(.a(new_n69_), .O(new_n85_));
  aoi21  g40(.a(new_n60_), .b(new_n56_), .c(new_n62_), .O(new_n86_));
  ...
  inv1   g50(.a(new_n70_), .O(new_n96_));
  ...
  aoi21  g55(.a(new_n97_), .b(new_n59_), .c(new_n92_), .O(new_n101_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n93_), .O(z15));
  nand3  g71(.a(new_n115_), .b(x24), .c(x23), .O(new_n117_));
  nand2  g72(.a(new_n92_), .b(new_n49_), .O(new_n118_));
  ...
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n118_), .O(z17));
  inv1   g81(.a(new_n115_), .O(new_n127_));
  nand2  g82(.a(new_n55_), .b(x24), .O(new_n128_));
  nand2  g83(.a(x25), .b(new_n122_), .O(new_n129_));
