...
module FAU ( 
  ...
  nor2   g18(.a(x24), .b(new_n54_), .O(new_n64_));
  ...
  nor2   g23(.a(new_n65_), .b(x25), .O(z03));
  ...
  oai21  g37(.a(new_n81_), .b(new_n62_), .c(new_n82_), .O(z08));
  nor2   g38(.a(x15), .b(x07), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n51_), .c(new_n49_), .O(z09));
  ...
  nor4   g52(.a(new_n97_), .b(new_n96_), .c(new_n87_), .d(new_n47_), .O(z12));
  nor2   g53(.a(new_n95_), .b(x20), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x24), .O(new_n100_));
  nand2  g55(.a(new_n87_), .b(new_n49_), .O(new_n101_));
  nand2  g56(.a(new_n95_), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(z13));
  inv1   g58(.a(x21), .O(new_n104_));
  aoi21  g59(.a(new_n96_), .b(new_n104_), .c(new_n62_), .O(new_n105_));
  aoi21  g60(.a(new_n100_), .b(x21), .c(new_n87_), .O(new_n106_));
  oai21  g61(.a(new_n105_), .b(x20), .c(new_n106_), .O(z14));
  inv1   g62(.a(new_n87_), .O(new_n108_));
  oai21  g63(.a(new_n100_), .b(x21), .c(x22), .O(new_n109_));
  ...
  nand3  g70(.a(new_n110_), .b(new_n99_), .c(new_n63_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n101_), .O(z16));
  oai21  g72(.a(x24), .b(new_n54_), .c(new_n116_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n108_), .O(z17));
  nand2  g74(.a(new_n49_), .b(x25), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n101_), .O(z18));
endmodule
