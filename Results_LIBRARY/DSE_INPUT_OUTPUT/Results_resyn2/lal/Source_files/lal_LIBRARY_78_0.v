...
module FAU ( 
  ...
  oai21  g19(.a(new_n63_), .b(new_n50_), .c(new_n64_), .O(z01));
  inv1   g20(.a(x16), .O(new_n66_));
  nor2   g21(.a(new_n47_), .b(new_n66_), .O(z02));
  nor2   g22(.a(new_n63_), .b(new_n50_), .O(z03));
  ...
  nor2   g33(.a(new_n78_), .b(new_n47_), .O(z06));
  nand3  g34(.a(new_n69_), .b(new_n46_), .c(x06), .O(z07));
  nand2  g35(.a(new_n62_), .b(new_n51_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(x24), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(new_n69_), .c(new_n49_), .O(z08));
  ...
  oai21  g42(.a(new_n87_), .b(new_n84_), .c(new_n69_), .O(z09));
  nand3  g43(.a(new_n84_), .b(new_n86_), .c(new_n85_), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(x17), .c(new_n69_), .O(z10));
  ...
  nand2  g52(.a(new_n93_), .b(new_n56_), .O(new_n98_));
  ...
  nor2   g61(.a(new_n106_), .b(new_n89_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n105_), .c(new_n47_), .O(z14));
  oai21  g63(.a(new_n102_), .b(x21), .c(x22), .O(new_n109_));
  aoi21  g64(.a(new_n106_), .b(new_n60_), .c(new_n89_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n109_), .c(new_n47_), .O(z15));
  nand4  g66(.a(new_n101_), .b(new_n60_), .c(new_n59_), .d(new_n53_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n89_), .c(x23), .O(new_n113_));
  nand2  g68(.a(x24), .b(new_n51_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n110_), .c(new_n113_), .O(z16));
  oai21  g70(.a(new_n112_), .b(x23), .c(x24), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n92_), .O(z17));
  aoi21  g72(.a(new_n96_), .b(new_n49_), .c(new_n47_), .O(z18));
endmodule
