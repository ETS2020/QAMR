...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n52_, new_n53_, new_n54_,
    ...
    new_n78_, new_n83_, new_n85_, new_n86_, new_n88_, new_n89_, new_n90_,
  ...
  aoi21  g22(.a(new_n67_), .b(new_n56_), .c(new_n57_), .O(new_n68_));
  inv1   g23(.a(x25), .O(new_n69_));
  nand2  g24(.a(new_n51_), .b(new_n69_), .O(new_n70_));
  oai21  g25(.a(new_n70_), .b(new_n68_), .c(new_n55_), .O(z01));
  nor2   g26(.a(new_n70_), .b(new_n68_), .O(z03));
  ...
  oai21  g33(.a(new_n78_), .b(x08), .c(new_n51_), .O(z04));
  oai21  g34(.a(x13), .b(x08), .c(new_n51_), .O(z05));
  and2   g35(.a(new_n49_), .b(x14), .O(z06));
  nand2  g36(.a(new_n49_), .b(x06), .O(z07));
  aoi21  g37(.a(new_n66_), .b(new_n63_), .c(x23), .O(new_n83_));
  oai22  g38(.a(new_n83_), .b(new_n57_), .c(new_n47_), .d(new_n69_), .O(z08));
  nor2   g39(.a(x15), .b(x07), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n53_), .c(new_n51_), .O(z09));
  ...
  nand2  g46(.a(new_n60_), .b(new_n59_), .O(new_n92_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n61_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n51_), .O(z12));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n64_), .c(new_n88_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(new_n47_), .O(z14));
  nand3  g62(.a(new_n101_), .b(new_n65_), .c(new_n64_), .O(new_n108_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n89_), .O(z16));
  oai22  g69(.a(new_n111_), .b(new_n57_), .c(new_n96_), .d(new_n47_), .O(z17));
  aoi21  g70(.a(new_n96_), .b(new_n69_), .c(new_n47_), .O(z18));
endmodule
