...
module FAU ( 
  ...
  nand3  g33(.a(x20), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g34(.a(new_n59_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g35(.a(x07), .O(new_n81_));
  inv1   g36(.a(x15), .O(new_n82_));
  nand4  g37(.a(new_n62_), .b(new_n49_), .c(new_n82_), .d(new_n81_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z09));
  nand2  g39(.a(new_n63_), .b(new_n82_), .O(new_n85_));
