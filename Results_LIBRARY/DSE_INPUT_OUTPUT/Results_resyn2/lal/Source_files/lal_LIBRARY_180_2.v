...
module FAU ( 
  ...
  nand4  g16(.a(new_n61_), .b(x24), .c(x22), .d(x21), .O(new_n62_));
  nand3  g17(.a(new_n62_), .b(new_n55_), .c(new_n47_), .O(new_n63_));
  nand2  g18(.a(new_n63_), .b(new_n54_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nand2  g20(.a(new_n49_), .b(new_n65_), .O(z02));
  nor2   g21(.a(new_n55_), .b(x23), .O(new_n67_));
  nor2   g22(.a(x18), .b(x17), .O(new_n68_));
  aoi21  g23(.a(new_n68_), .b(new_n59_), .c(x20), .O(new_n69_));
  ...
  aoi21  g40(.a(new_n60_), .b(new_n56_), .c(new_n70_), .O(new_n86_));
  ...
  nand2  g55(.a(new_n97_), .b(new_n59_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nor3   g57(.a(new_n102_), .b(new_n92_), .c(new_n48_), .O(z12));
  inv1   g58(.a(new_n100_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n56_), .O(new_n105_));
  nand2  g60(.a(new_n100_), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n93_), .O(z13));
  nand2  g62(.a(new_n105_), .b(x21), .O(new_n108_));
  inv1   g63(.a(x21), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n56_), .O(new_n110_));
  nor2   g65(.a(new_n110_), .b(new_n100_), .O(new_n111_));
  nor2   g66(.a(new_n111_), .b(new_n92_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n108_), .c(new_n48_), .O(z14));
  oai21  g68(.a(new_n110_), .b(new_n100_), .c(x22), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  aoi21  g70(.a(new_n111_), .b(new_n115_), .c(new_n92_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n114_), .c(new_n48_), .O(z15));
  nand3  g72(.a(new_n111_), .b(new_n47_), .c(new_n115_), .O(new_n118_));
  nand2  g73(.a(new_n111_), .b(new_n115_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(x23), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n93_), .O(z16));
  nand2  g76(.a(new_n119_), .b(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x22), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n104_), .c(new_n109_), .d(new_n56_), .O(new_n124_));
  nand3  g79(.a(new_n89_), .b(new_n52_), .c(new_n47_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n122_), .O(z17));
  xor2a  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  aoi21  g83(.a(new_n55_), .b(x24), .c(new_n47_), .O(new_n129_));
  nor2   g84(.a(new_n129_), .b(new_n92_), .O(new_n130_));
