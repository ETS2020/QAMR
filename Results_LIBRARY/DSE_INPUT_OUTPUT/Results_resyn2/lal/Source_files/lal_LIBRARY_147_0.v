...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n73_, new_n74_, new_n75_, new_n79_, new_n81_,
  ...
  nor2   g16(.a(new_n48_), .b(x23), .O(new_n62_));
  nor2   g17(.a(x24), .b(new_n47_), .O(new_n63_));
  aoi21  g18(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(new_n64_));
  oai21  g19(.a(new_n64_), .b(x25), .c(new_n53_), .O(z01));
  inv1   g20(.a(x16), .O(new_n66_));
  nand2  g21(.a(new_n49_), .b(new_n66_), .O(z02));
  nor2   g22(.a(new_n64_), .b(x25), .O(z03));
  ...
  nor2   g32(.a(new_n47_), .b(x08), .O(z06));
  inv1   g33(.a(new_n49_), .O(new_n79_));
  aoi21  g34(.a(new_n46_), .b(x06), .c(new_n79_), .O(z07));
  aoi21  g35(.a(new_n60_), .b(new_n59_), .c(x23), .O(new_n81_));
  nor2   g36(.a(new_n79_), .b(x25), .O(new_n82_));
  oai21  g37(.a(new_n81_), .b(new_n48_), .c(new_n82_), .O(z08));
  nor2   g38(.a(x15), .b(x07), .O(new_n84_));
  and2   g39(.a(new_n84_), .b(new_n49_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(new_n84_), .b(new_n51_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(x17), .c(new_n49_), .O(z10));
  ...
  aoi21  g49(.a(new_n91_), .b(new_n57_), .c(new_n88_), .O(new_n95_));
  ...
  aoi21  g54(.a(new_n94_), .b(x20), .c(new_n88_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n99_), .c(new_n79_), .O(z13));
  nand2  g56(.a(new_n99_), .b(x21), .O(new_n102_));
  nand2  g57(.a(new_n85_), .b(new_n51_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(z14));
  nand2  g62(.a(new_n106_), .b(x22), .O(new_n108_));
  inv1   g63(.a(x22), .O(new_n109_));
  inv1   g64(.a(new_n106_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n109_), .c(new_n88_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n108_), .c(new_n79_), .O(z15));
  oai21  g67(.a(new_n106_), .b(x22), .c(x23), .O(new_n113_));
  nor2   g68(.a(x23), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n105_), .c(new_n98_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n88_), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(new_n113_), .c(new_n79_), .O(z16));
  nand2  g73(.a(new_n116_), .b(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n115_), .b(x24), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n104_), .O(z17));
  nand2  g76(.a(new_n115_), .b(x25), .O(new_n122_));
  nor3   g77(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n105_), .c(new_n98_), .d(new_n109_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x14), .O(new_n126_));
  aoi22  g81(.a(new_n88_), .b(new_n49_), .c(x25), .d(x24), .O(new_n127_));
