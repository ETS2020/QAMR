...
module FAU ( 
  ...
  aoi21  g01(.a(x15), .b(x07), .c(x08), .O(new_n47_));
  ...
  nand3  g18(.a(new_n57_), .b(new_n46_), .c(new_n49_), .O(z08));
  ...
  nand2  g29(.a(new_n47_), .b(new_n74_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z05));
  inv1   g31(.a(x14), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(x08), .c(new_n46_), .O(z06));
  nand2  g33(.a(new_n47_), .b(x06), .O(z07));
  ...
  oai21  g41(.a(new_n86_), .b(new_n84_), .c(new_n46_), .O(z11));
  ...
  nand4  g47(.a(new_n50_), .b(x19), .c(x18), .d(x17), .O(new_n93_));
  ...
  nand3  g52(.a(new_n89_), .b(new_n97_), .c(new_n50_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n96_), .c(new_n92_), .O(z14));
  nand2  g54(.a(new_n81_), .b(x07), .O(new_n100_));
  nand2  g55(.a(new_n98_), .b(x22), .O(new_n101_));
  inv1   g56(.a(x22), .O(new_n102_));
  nand4  g57(.a(new_n89_), .b(new_n102_), .c(new_n97_), .d(new_n50_), .O(new_n103_));
  aoi21  g58(.a(x05), .b(x04), .c(x15), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(new_n105_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n89_), .c(new_n97_), .d(new_n50_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n92_), .O(z16));
  nor2   g66(.a(x24), .b(x21), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n93_), .c(new_n104_), .O(new_n114_));
  aoi21  g69(.a(new_n110_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x07), .c(new_n100_), .O(z17));
  nor2   g71(.a(new_n113_), .b(new_n93_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n49_), .O(new_n118_));
  oai21  g73(.a(new_n113_), .b(new_n93_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n92_), .O(z18));
endmodule
