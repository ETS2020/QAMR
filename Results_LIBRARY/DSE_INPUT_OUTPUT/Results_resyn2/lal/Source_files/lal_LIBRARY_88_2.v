...
module FAU ( 
  ...
  aoi21  g19(.a(new_n64_), .b(new_n59_), .c(x23), .O(new_n65_));
  nor2   g20(.a(x24), .b(x20), .O(new_n66_));
  oai21  g21(.a(new_n66_), .b(new_n65_), .c(new_n57_), .O(new_n67_));
  nand2  g22(.a(new_n67_), .b(new_n56_), .O(z01));
  inv1   g23(.a(x23), .O(new_n69_));
  inv1   g24(.a(new_n58_), .O(new_n70_));
  nand2  g25(.a(new_n64_), .b(new_n70_), .O(new_n71_));
  nand2  g26(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  aoi22  g27(.a(new_n72_), .b(x24), .c(new_n50_), .d(x25), .O(z03));
  ...
  nor2   g40(.a(new_n63_), .b(new_n58_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(x23), .c(x24), .O(new_n87_));
  aoi21  g42(.a(new_n59_), .b(x20), .c(x25), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(z08));
  inv1   g44(.a(x15), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n53_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(new_n54_), .c(new_n50_), .O(z09));
  nand3  g47(.a(new_n54_), .b(new_n90_), .c(new_n53_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n50_), .c(new_n60_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  xnor2a g51(.a(x18), .b(x17), .O(new_n97_));
  oai21  g52(.a(new_n97_), .b(new_n93_), .c(new_n50_), .O(z11));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  aoi21  g55(.a(x18), .b(x17), .c(x19), .O(new_n101_));
  nor4   g56(.a(new_n101_), .b(new_n100_), .c(new_n93_), .d(new_n49_), .O(z12));
  nand3  g57(.a(new_n99_), .b(x24), .c(x20), .O(new_n103_));
  nand2  g58(.a(new_n93_), .b(new_n50_), .O(new_n104_));
  ...
  nand3  g62(.a(new_n100_), .b(new_n107_), .c(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n105_), .b(x21), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n108_), .c(new_n94_), .d(new_n50_), .O(z14));
  and2   g65(.a(new_n108_), .b(new_n50_), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(x22), .c(new_n93_), .O(new_n112_));
  oai21  g67(.a(new_n111_), .b(x22), .c(new_n112_), .O(z15));
  oai22  g68(.a(new_n108_), .b(x22), .c(new_n49_), .d(x23), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  nand3  g70(.a(new_n69_), .b(new_n115_), .c(new_n107_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n99_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n48_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n114_), .c(new_n94_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  nand2  g75(.a(new_n117_), .b(new_n66_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n104_), .O(z17));
  oai21  g77(.a(x25), .b(x24), .c(new_n117_), .O(new_n123_));
  oai21  g78(.a(new_n116_), .b(new_n99_), .c(new_n57_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n48_), .O(new_n125_));
  nand2  g80(.a(x25), .b(x24), .O(new_n126_));
