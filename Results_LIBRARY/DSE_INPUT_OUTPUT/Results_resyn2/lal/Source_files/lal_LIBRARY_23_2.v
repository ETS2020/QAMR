...
module FAU ( 
  ...
  nor2   g05(.a(new_n50_), .b(x23), .O(new_n51_));
  ...
  aoi21  g16(.a(new_n61_), .b(new_n47_), .c(new_n52_), .O(new_n62_));
  aoi21  g17(.a(x05), .b(x04), .c(x07), .O(new_n63_));
  oai21  g18(.a(new_n62_), .b(new_n51_), .c(new_n63_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nor2   g20(.a(new_n48_), .b(new_n65_), .O(z02));
  aoi21  g21(.a(new_n57_), .b(new_n53_), .c(new_n59_), .O(new_n67_));
  nand2  g22(.a(new_n50_), .b(new_n47_), .O(new_n68_));
  ...
  oai21  g37(.a(new_n67_), .b(x23), .c(x24), .O(new_n83_));
  oai21  g38(.a(new_n50_), .b(x23), .c(new_n83_), .O(z08));
  ...
  oai21  g43(.a(new_n88_), .b(new_n85_), .c(new_n70_), .O(z09));
  nand3  g44(.a(new_n85_), .b(new_n87_), .c(new_n86_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x17), .c(new_n70_), .O(z10));
  ...
  aoi21  g52(.a(new_n94_), .b(new_n56_), .c(new_n90_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n70_), .O(z12));
  inv1   g55(.a(new_n97_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  nand2  g57(.a(new_n97_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(new_n93_), .O(z13));
  nand2  g59(.a(new_n102_), .b(x21), .O(new_n105_));
  nor3   g60(.a(new_n97_), .b(x21), .c(x20), .O(new_n106_));
  nor2   g61(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n105_), .c(new_n48_), .O(z14));
  inv1   g63(.a(x22), .O(new_n109_));
  or2    g64(.a(new_n106_), .b(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n106_), .b(new_n109_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n93_), .O(z15));
  nand2  g67(.a(new_n90_), .b(new_n70_), .O(new_n113_));
  nand3  g68(.a(new_n111_), .b(x24), .c(x23), .O(new_n114_));
  nand3  g69(.a(new_n106_), .b(new_n47_), .c(new_n109_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(z16));
  nand4  g71(.a(new_n106_), .b(new_n52_), .c(new_n47_), .d(new_n109_), .O(new_n117_));
  nand2  g72(.a(new_n115_), .b(x24), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n113_), .O(z17));
  nand2  g74(.a(new_n50_), .b(x24), .O(new_n120_));
  nand2  g75(.a(x25), .b(new_n52_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n120_), .c(new_n106_), .d(new_n109_), .O(new_n122_));
  nand2  g77(.a(new_n111_), .b(x25), .O(new_n123_));
  aoi21  g78(.a(new_n120_), .b(x23), .c(new_n90_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(z18));
endmodule
