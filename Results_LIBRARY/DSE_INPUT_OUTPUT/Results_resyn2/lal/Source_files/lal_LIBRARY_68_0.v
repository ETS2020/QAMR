...
module FAU ( 
  ...
  nor2   g31(.a(new_n76_), .b(z11), .O(z06));
  aoi21  g32(.a(new_n46_), .b(x06), .c(z11), .O(z07));
  aoi21  g33(.a(new_n62_), .b(new_n54_), .c(z11), .O(z08));
  zero   g34(.O(z09));
  zero   g35(.O(z10));
  one    g36(.O(z13));
  nor2   g37(.a(x15), .b(x07), .O(z12));
  inv1   g38(.a(z11), .O(z15));
  inv1   g39(.a(z11), .O(z16));
  inv1   g40(.a(z11), .O(z17));
