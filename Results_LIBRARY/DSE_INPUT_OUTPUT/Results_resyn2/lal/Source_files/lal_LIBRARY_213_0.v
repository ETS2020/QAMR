...
module FAU ( 
  ...
  nand2  g20(.a(z15), .b(new_n65_), .O(z02));
  nand3  g21(.a(new_n58_), .b(z15), .c(new_n50_), .O(z08));
  inv1   g22(.a(z08), .O(z03));
  nand2  g23(.a(z15), .b(new_n46_), .O(new_n69_));
  ...
  nand3  g34(.a(z15), .b(new_n46_), .c(x06), .O(z07));
  zero   g35(.O(z09));
  zero   g36(.O(z12));
  one    g37(.O(z13));
  one    g38(.O(z14));
