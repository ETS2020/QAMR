...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n73_, new_n78_, new_n79_, new_n80_, new_n82_, new_n83_, new_n85_,
  ...
  aoi22  g29(.a(new_n47_), .b(x07), .c(new_n46_), .d(x06), .O(z07));
  nand3  g30(.a(new_n58_), .b(new_n48_), .c(new_n50_), .O(z08));
  nor2   g31(.a(new_n60_), .b(x15), .O(z09));
  nand2  g32(.a(new_n60_), .b(new_n47_), .O(new_n78_));
  ...
  nor2   g37(.a(new_n53_), .b(new_n52_), .O(new_n83_));
  nor3   g38(.a(new_n83_), .b(new_n78_), .c(new_n82_), .O(z11));
  nand3  g39(.a(x19), .b(x18), .c(x17), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(new_n86_));
  nor2   g41(.a(new_n83_), .b(x19), .O(new_n87_));
  nor3   g42(.a(new_n87_), .b(new_n86_), .c(new_n78_), .O(z12));
  inv1   g43(.a(x07), .O(new_n89_));
  nand2  g44(.a(x05), .b(x04), .O(new_n90_));
  nand4  g45(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n91_));
  ...
  nand2  g52(.a(new_n97_), .b(new_n86_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n96_), .c(new_n90_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n89_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n47_), .O(z14));
  nand2  g56(.a(new_n98_), .b(x22), .O(new_n102_));
  inv1   g57(.a(x22), .O(new_n103_));
  nand3  g58(.a(new_n97_), .b(new_n86_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g62(.a(new_n107_), .b(new_n97_), .c(new_n86_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n90_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n89_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(z16));
  nor2   g66(.a(x24), .b(x21), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n107_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n91_), .c(new_n90_), .O(new_n114_));
  aoi21  g69(.a(new_n108_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(x07), .c(new_n47_), .O(z17));
  nor2   g71(.a(new_n113_), .b(new_n91_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n50_), .O(new_n118_));
  oai21  g73(.a(new_n113_), .b(new_n91_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n79_), .O(z18));
endmodule
