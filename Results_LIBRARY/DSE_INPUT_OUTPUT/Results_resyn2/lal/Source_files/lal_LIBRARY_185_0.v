...
module FAU ( 
  ...
  aoi21  g19(.a(new_n59_), .b(new_n51_), .c(z10), .O(z08));
  ...
  nand2  g41(.a(new_n86_), .b(z13), .O(z04));
  oai21  g42(.a(x13), .b(x08), .c(z13), .O(z05));
  nand2  g43(.a(x14), .b(new_n46_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(z10), .O(z06));
  aoi21  g45(.a(new_n46_), .b(x06), .c(z10), .O(z07));
  zero   g46(.O(z09));
  zero   g47(.O(z12));
  one    g48(.O(z14));
  one    g49(.O(z15));
  one    g50(.O(z16));
  nor2   g51(.a(x15), .b(x07), .O(z11));
  inv1   g52(.a(z10), .O(z17));
  inv1   g53(.a(z10), .O(z18));
endmodule
