...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_,
    ...
    new_n110_, new_n111_, new_n112_, new_n113_, new_n115_;
  ...
  nor2   g33(.a(new_n78_), .b(new_n48_), .O(z06));
  ...
  nor3   g53(.a(new_n98_), .b(new_n88_), .c(new_n48_), .O(z12));
  nand4  g54(.a(new_n56_), .b(x19), .c(x18), .d(x17), .O(new_n100_));
  ...
  aoi21  g59(.a(new_n104_), .b(new_n62_), .c(new_n88_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n103_), .c(new_n48_), .O(z14));
  oai21  g61(.a(new_n100_), .b(x21), .c(x22), .O(new_n107_));
  nand3  g62(.a(new_n104_), .b(new_n63_), .c(new_n62_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n89_), .O(z15));
  nand2  g64(.a(new_n108_), .b(x23), .O(new_n110_));
  nand2  g65(.a(new_n63_), .b(new_n62_), .O(new_n111_));
  nor2   g66(.a(new_n111_), .b(new_n100_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n54_), .c(new_n88_), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(new_n110_), .c(new_n48_), .O(z16));
  oai21  g69(.a(new_n108_), .b(x23), .c(x24), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n89_), .O(z17));
  nand2  g71(.a(new_n89_), .b(new_n52_), .O(z18));
endmodule
