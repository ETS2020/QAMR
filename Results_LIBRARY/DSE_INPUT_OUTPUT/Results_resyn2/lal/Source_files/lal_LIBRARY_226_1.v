...
module FAU ( 
  ...
  aoi21  g41(.a(new_n58_), .b(new_n51_), .c(new_n48_), .O(z08));
  nor3   g42(.a(new_n48_), .b(x15), .c(x07), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n61_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand2  g45(.a(new_n88_), .b(new_n60_), .O(new_n91_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n88_), .d(new_n60_), .O(z13));
  inv1   g59(.a(x21), .O(new_n105_));
  nand2  g60(.a(new_n101_), .b(new_n105_), .O(new_n106_));
  inv1   g61(.a(x07), .O(new_n107_));
  inv1   g62(.a(x15), .O(new_n108_));
  nand3  g63(.a(new_n60_), .b(new_n108_), .c(new_n107_), .O(new_n109_));
  aoi21  g64(.a(new_n102_), .b(x21), .c(new_n109_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n106_), .c(new_n48_), .O(z14));
  oai21  g66(.a(new_n97_), .b(x21), .c(x22), .O(new_n112_));
  inv1   g67(.a(new_n97_), .O(new_n113_));
  ...
  inv1   g71(.a(new_n109_), .O(new_n117_));
  nand2  g72(.a(x22), .b(x20), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n47_), .c(new_n119_), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(new_n48_), .O(z15));
  nand2  g76(.a(new_n115_), .b(x23), .O(new_n122_));
  nor3   g77(.a(x23), .b(x22), .c(x21), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n101_), .O(new_n124_));
  inv1   g79(.a(x23), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x12), .O(new_n126_));
  aoi21  g81(.a(new_n126_), .b(x20), .c(new_n109_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n124_), .c(new_n122_), .O(z16));
  inv1   g83(.a(x24), .O(new_n129_));
  nand2  g84(.a(new_n114_), .b(new_n125_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(new_n97_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n47_), .O(new_n132_));
  nand3  g87(.a(new_n123_), .b(new_n113_), .c(new_n47_), .O(new_n133_));
  aoi21  g88(.a(new_n133_), .b(x24), .c(new_n109_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n132_), .c(new_n48_), .O(z17));
  nor2   g90(.a(new_n51_), .b(new_n47_), .O(new_n136_));
  oai21  g91(.a(new_n136_), .b(new_n109_), .c(new_n49_), .O(new_n137_));
  nand3  g92(.a(new_n131_), .b(x25), .c(new_n129_), .O(new_n138_));
  nand3  g93(.a(new_n123_), .b(new_n113_), .c(new_n129_), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n51_), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n138_), .c(new_n47_), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(new_n137_), .O(z18));
endmodule
