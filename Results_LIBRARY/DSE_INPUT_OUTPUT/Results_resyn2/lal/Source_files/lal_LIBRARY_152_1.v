...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n72_, new_n73_, new_n74_, new_n76_, new_n78_, new_n82_, new_n83_,
  ...
  nand3  g21(.a(new_n60_), .b(new_n49_), .c(new_n52_), .O(z08));
  ...
  nand2  g52(.a(new_n97_), .b(new_n51_), .O(z13));
  ...
  oai21  g57(.a(new_n102_), .b(new_n100_), .c(new_n47_), .O(new_n103_));
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n83_), .O(z15));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand3  g65(.a(new_n106_), .b(new_n94_), .c(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n83_), .O(z16));
  nor2   g67(.a(x24), .b(x23), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n106_), .c(new_n94_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n61_), .O(new_n115_));
  aoi21  g70(.a(new_n111_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x15), .c(new_n51_), .O(z17));
  nor2   g72(.a(new_n114_), .b(x25), .O(new_n118_));
  ...
  nand2  g76(.a(new_n121_), .b(new_n51_), .O(z18));
endmodule
