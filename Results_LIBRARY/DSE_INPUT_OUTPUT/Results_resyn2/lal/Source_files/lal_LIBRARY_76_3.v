...
module FAU ( 
  ...
  oai21  g10(.a(new_n55_), .b(x19), .c(new_n52_), .O(new_n56_));
  ...
  aoi21  g23(.a(new_n68_), .b(new_n67_), .c(x20), .O(new_n69_));
  oai21  g24(.a(new_n57_), .b(new_n69_), .c(new_n66_), .O(new_n70_));
  ...
  nand2  g33(.a(new_n78_), .b(new_n46_), .O(z04));
  inv1   g34(.a(x13), .O(new_n80_));
  nand2  g35(.a(new_n49_), .b(new_n80_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z05));
  nand2  g37(.a(new_n49_), .b(x14), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z06));
  aoi21  g39(.a(new_n72_), .b(x06), .c(new_n48_), .O(z07));
  aoi21  g40(.a(new_n59_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g41(.a(x15), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(new_n62_), .c(new_n46_), .O(z09));
  nand3  g44(.a(new_n62_), .b(new_n87_), .c(new_n61_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x17), .c(new_n46_), .O(z10));
  nand2  g46(.a(x18), .b(x17), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n55_), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n90_), .c(new_n46_), .O(z11));
  inv1   g49(.a(new_n90_), .O(new_n95_));
  nand3  g50(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand2  g51(.a(new_n92_), .b(new_n67_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n46_), .O(z12));
  nand2  g54(.a(new_n64_), .b(new_n87_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  xor2a  g56(.a(new_n96_), .b(x20), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n101_), .O(z13));
  oai21  g58(.a(new_n96_), .b(x20), .c(x21), .O(new_n104_));
  inv1   g59(.a(new_n96_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n104_), .c(new_n101_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(x22), .O(new_n110_));
  nand3  g65(.a(new_n106_), .b(new_n105_), .c(new_n110_), .O(new_n111_));
  and2   g66(.a(new_n111_), .b(new_n95_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n109_), .c(new_n48_), .O(z15));
  inv1   g68(.a(x24), .O(new_n114_));
  nand4  g69(.a(new_n106_), .b(new_n105_), .c(new_n114_), .d(new_n110_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x23), .O(new_n116_));
  nand4  g71(.a(new_n106_), .b(new_n105_), .c(new_n66_), .d(new_n110_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n95_), .O(z16));
  nand2  g73(.a(new_n90_), .b(new_n46_), .O(new_n119_));
  xor2a  g74(.a(new_n111_), .b(x24), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(x23), .c(new_n119_), .O(z17));
  nand2  g76(.a(new_n117_), .b(new_n51_), .O(new_n122_));
  nor2   g77(.a(new_n51_), .b(x23), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(x24), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  oai21  g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  aoi22  g81(.a(new_n126_), .b(new_n90_), .c(new_n123_), .d(new_n115_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n125_), .O(z18));
endmodule
