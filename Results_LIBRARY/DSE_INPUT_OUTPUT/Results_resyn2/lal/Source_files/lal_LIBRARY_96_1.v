...
module FAU ( 
  ...
  aoi21  g21(.a(new_n66_), .b(x01), .c(new_n48_), .O(new_n67_));
  ...
  nand2  g39(.a(new_n65_), .b(new_n62_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x24), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n69_), .c(new_n49_), .O(z08));
  ...
  oai21  g54(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(new_n100_));
  ...
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n93_), .O(z13));
  nand2  g61(.a(new_n104_), .b(x21), .O(new_n107_));
  nand2  g62(.a(new_n103_), .b(new_n63_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n93_), .O(z14));
  nand2  g64(.a(new_n108_), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n103_), .b(new_n64_), .c(new_n63_), .O(new_n111_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n103_), .c(new_n63_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n92_), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(new_n113_), .c(new_n49_), .O(z16));
  nand2  g73(.a(new_n116_), .b(new_n48_), .O(new_n119_));
  aoi21  g74(.a(new_n115_), .b(x24), .c(new_n92_), .O(new_n120_));
  aoi21  g75(.a(new_n120_), .b(new_n119_), .c(new_n49_), .O(z17));
  nor2   g76(.a(new_n69_), .b(new_n48_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n92_), .c(new_n50_), .O(new_n123_));
  nor2   g78(.a(new_n115_), .b(new_n69_), .O(new_n124_));
  oai21  g79(.a(new_n116_), .b(x25), .c(new_n48_), .O(new_n125_));
