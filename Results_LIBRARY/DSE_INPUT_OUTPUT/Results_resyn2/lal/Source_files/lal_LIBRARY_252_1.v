...
module FAU ( 
  ...
  aoi21  g33(.a(new_n58_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g34(.a(x07), .O(new_n80_));
  inv1   g35(.a(x15), .O(new_n81_));
  nand4  g36(.a(new_n61_), .b(new_n49_), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  ...
  aoi21  g60(.a(new_n105_), .b(new_n94_), .c(new_n96_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n48_), .O(z15));
  inv1   g62(.a(x23), .O(new_n108_));
  nand3  g63(.a(new_n105_), .b(new_n94_), .c(new_n108_), .O(new_n109_));
  inv1   g64(.a(new_n90_), .O(new_n110_));
  nand2  g65(.a(new_n105_), .b(new_n110_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x23), .O(new_n112_));
  nand2  g67(.a(new_n108_), .b(x06), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(x20), .c(new_n96_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n109_), .O(z16));
  nand3  g70(.a(new_n105_), .b(new_n110_), .c(new_n108_), .O(new_n116_));
  xor2a  g71(.a(new_n116_), .b(x24), .O(new_n117_));
  and2   g72(.a(x24), .b(x20), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n96_), .c(new_n49_), .O(new_n119_));
  oai21  g74(.a(new_n117_), .b(x20), .c(new_n119_), .O(z17));
  oai21  g75(.a(new_n116_), .b(x24), .c(x25), .O(new_n121_));
  nor3   g76(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n105_), .c(new_n94_), .O(new_n123_));
  nand2  g78(.a(new_n51_), .b(x06), .O(new_n124_));
  aoi21  g79(.a(new_n124_), .b(x20), .c(new_n96_), .O(new_n125_));
