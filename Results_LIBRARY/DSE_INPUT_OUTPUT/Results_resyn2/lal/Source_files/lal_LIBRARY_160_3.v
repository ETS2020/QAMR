...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n73_, new_n75_, new_n78_, new_n79_, new_n80_, new_n81_, new_n83_,
  ...
  nand2  g13(.a(x24), .b(x08), .O(new_n59_));
  aoi21  g14(.a(x05), .b(x04), .c(x07), .O(new_n60_));
  nand3  g15(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z01));
  inv1   g16(.a(x16), .O(new_n62_));
  nand2  g17(.a(new_n59_), .b(new_n62_), .O(z02));
  nand2  g18(.a(new_n59_), .b(new_n58_), .O(z03));
  ...
  nand2  g25(.a(new_n70_), .b(new_n59_), .O(z04));
  oai21  g26(.a(x13), .b(x08), .c(new_n59_), .O(z05));
  inv1   g27(.a(x14), .O(new_n73_));
  nor2   g28(.a(new_n73_), .b(x08), .O(z06));
  inv1   g29(.a(new_n59_), .O(new_n75_));
  aoi21  g30(.a(new_n46_), .b(x06), .c(new_n75_), .O(z07));
  aoi21  g31(.a(new_n57_), .b(new_n49_), .c(new_n75_), .O(z08));
  nand2  g32(.a(x05), .b(x04), .O(new_n78_));
  inv1   g33(.a(x07), .O(new_n79_));
  inv1   g34(.a(x15), .O(new_n80_));
  nand3  g35(.a(new_n59_), .b(new_n80_), .c(new_n79_), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(new_n78_), .O(z09));
  nand3  g37(.a(new_n78_), .b(new_n80_), .c(new_n79_), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(x17), .c(new_n59_), .O(z10));
  xnor2a g39(.a(x18), .b(x17), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n83_), .c(new_n59_), .O(z11));
  inv1   g41(.a(new_n81_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n78_), .O(new_n88_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n93_), .O(z16));
  aoi21  g64(.a(new_n108_), .b(x24), .c(new_n88_), .O(new_n110_));
  oai21  g65(.a(new_n108_), .b(x24), .c(new_n110_), .O(z17));
  nor2   g66(.a(new_n49_), .b(new_n47_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n83_), .c(new_n59_), .O(new_n113_));
  nor2   g68(.a(new_n108_), .b(new_n49_), .O(new_n114_));
  nand2  g69(.a(new_n108_), .b(new_n49_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z18));
endmodule
