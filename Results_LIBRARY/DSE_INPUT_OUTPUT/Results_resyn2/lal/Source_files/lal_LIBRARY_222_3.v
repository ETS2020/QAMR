...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n78_, new_n81_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_,
  ...
  aoi22  g23(.a(new_n67_), .b(x03), .c(new_n68_), .d(x01), .O(new_n69_));
  oai21  g24(.a(new_n67_), .b(x03), .c(new_n69_), .O(new_n70_));
  inv1   g25(.a(new_n70_), .O(new_n71_));
  aoi21  g26(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n72_));
  inv1   g27(.a(x11), .O(new_n73_));
  nand2  g28(.a(new_n73_), .b(x02), .O(new_n74_));
  nand2  g29(.a(x09), .b(new_n47_), .O(new_n75_));
  nand2  g30(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  oai22  g31(.a(new_n73_), .b(x02), .c(new_n68_), .d(x01), .O(new_n77_));
  nor3   g32(.a(new_n77_), .b(new_n76_), .c(new_n72_), .O(new_n78_));
  aoi22  g33(.a(new_n78_), .b(new_n71_), .c(new_n50_), .d(x08), .O(z04));
  ...
  aoi21  g38(.a(new_n60_), .b(new_n52_), .c(new_n49_), .O(z08));
  ...
  nor3   g51(.a(new_n96_), .b(new_n94_), .c(new_n92_), .O(z11));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n95_), .b(new_n56_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n93_), .O(new_n100_));
  ...
  nand2  g59(.a(new_n98_), .b(x20), .O(new_n105_));
  ...
  aoi21  g64(.a(new_n109_), .b(new_n107_), .c(new_n49_), .O(z14));
  oai21  g65(.a(new_n104_), .b(x21), .c(x22), .O(new_n111_));
  inv1   g66(.a(x22), .O(new_n112_));
  inv1   g67(.a(new_n98_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n112_), .c(new_n108_), .d(new_n53_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n102_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n103_), .b(new_n117_), .c(new_n112_), .d(new_n108_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n93_), .O(new_n119_));
  and2   g74(.a(new_n119_), .b(new_n50_), .O(z16));
  nand2  g75(.a(new_n90_), .b(new_n50_), .O(new_n121_));
  nand3  g76(.a(new_n118_), .b(x24), .c(new_n47_), .O(new_n122_));
  inv1   g77(.a(new_n114_), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(z17));
  nand3  g81(.a(new_n124_), .b(new_n123_), .c(new_n52_), .O(new_n127_));
  nand2  g82(.a(new_n50_), .b(new_n52_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n93_), .O(z18));
endmodule
