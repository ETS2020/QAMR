...
module FAU ( 
  ...
  aoi21  g33(.a(new_n59_), .b(new_n51_), .c(new_n48_), .O(z08));
  ...
  oai21  g40(.a(new_n85_), .b(new_n83_), .c(new_n49_), .O(z11));
  ...
  nor2   g51(.a(new_n61_), .b(x15), .O(new_n97_));
  ...
  nand2  g56(.a(new_n101_), .b(new_n95_), .O(z14));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nand3  g59(.a(new_n98_), .b(new_n88_), .c(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n97_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n95_), .O(z15));
  nand2  g63(.a(new_n105_), .b(x23), .O(new_n109_));
  nor2   g64(.a(x23), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n98_), .c(new_n88_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n97_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n95_), .O(z16));
  nand2  g69(.a(new_n111_), .b(x24), .O(new_n115_));
  inv1   g70(.a(x24), .O(new_n116_));
  nand4  g71(.a(new_n110_), .b(new_n98_), .c(new_n88_), .d(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n115_), .c(new_n91_), .O(z17));
  inv1   g73(.a(new_n117_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n51_), .O(new_n120_));
  nand2  g75(.a(new_n117_), .b(x25), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n91_), .O(z18));
endmodule
