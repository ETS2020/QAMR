...
module FAU ( 
  ...
  oai21  g20(.a(new_n65_), .b(new_n63_), .c(new_n52_), .O(z01));
  inv1   g21(.a(x16), .O(new_n67_));
  nor2   g22(.a(new_n47_), .b(new_n67_), .O(z02));
  aoi21  g23(.a(new_n48_), .b(x25), .c(new_n63_), .O(z03));
  ...
  nand2  g35(.a(new_n62_), .b(new_n53_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(x24), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(new_n48_), .c(new_n64_), .O(z08));
  nor2   g38(.a(x15), .b(x07), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(new_n51_), .c(new_n48_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z09));
  nand3  g41(.a(new_n84_), .b(new_n50_), .c(new_n48_), .O(new_n87_));
  ...
  nor2   g52(.a(new_n97_), .b(new_n87_), .O(z12));
  inv1   g53(.a(new_n95_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n55_), .O(new_n100_));
  nand2  g55(.a(new_n84_), .b(new_n50_), .O(new_n101_));
  aoi21  g56(.a(new_n95_), .b(x20), .c(new_n101_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n100_), .c(new_n47_), .O(z13));
  nand2  g58(.a(new_n100_), .b(x21), .O(new_n104_));
  nor3   g59(.a(new_n95_), .b(x21), .c(x20), .O(new_n105_));
  nor2   g60(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n109_), .c(new_n101_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n108_), .c(new_n47_), .O(z15));
  nand4  g66(.a(new_n105_), .b(x24), .c(new_n53_), .d(new_n109_), .O(new_n112_));
  nand2  g67(.a(new_n105_), .b(new_n109_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x23), .O(new_n114_));
  nand2  g69(.a(new_n101_), .b(new_n48_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n112_), .O(z16));
  oai21  g71(.a(new_n113_), .b(x23), .c(x24), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n115_), .O(z17));
  or2    g73(.a(new_n101_), .b(new_n65_), .O(z18));
endmodule
