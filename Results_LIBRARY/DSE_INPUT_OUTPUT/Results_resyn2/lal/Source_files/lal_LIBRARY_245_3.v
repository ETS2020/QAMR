...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n79_, new_n82_, new_n85_, new_n86_, new_n88_, new_n89_, new_n90_,
  ...
  aoi21  g19(.a(new_n64_), .b(new_n47_), .c(new_n48_), .O(new_n65_));
  ...
  nand3  g24(.a(new_n63_), .b(new_n61_), .c(x24), .O(new_n70_));
  ...
  oai21  g41(.a(new_n86_), .b(new_n53_), .c(new_n50_), .O(z09));
  ...
  nand3  g68(.a(new_n112_), .b(new_n48_), .c(x23), .O(new_n114_));
  nand2  g69(.a(new_n88_), .b(new_n50_), .O(new_n115_));
  nand3  g70(.a(new_n111_), .b(new_n102_), .c(new_n47_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(z16));
  nand2  g72(.a(new_n112_), .b(new_n48_), .O(new_n118_));
  nand3  g73(.a(new_n111_), .b(new_n102_), .c(x24), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n115_), .O(z17));
  inv1   g76(.a(new_n116_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n69_), .c(new_n48_), .O(new_n123_));
  oai21  g78(.a(new_n112_), .b(x24), .c(x25), .O(new_n124_));
