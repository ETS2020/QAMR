// Benchmark "FAU" written by ABC on Tue Aug 11 20:07:53 2020
...
module FAU ( 
  ...
  nand2  g22(.a(new_n66_), .b(new_n46_), .O(new_n68_));
  ...
  nand3  g34(.a(new_n58_), .b(new_n66_), .c(new_n50_), .O(z08));
  ...
  nand3  g49(.a(new_n94_), .b(new_n92_), .c(new_n60_), .O(new_n95_));
  ...
  nand2  g60(.a(new_n105_), .b(new_n81_), .O(z14));
  inv1   g61(.a(x22), .O(new_n107_));
  nor2   g62(.a(x20), .b(new_n54_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n93_), .c(new_n107_), .d(new_n101_), .O(new_n109_));
  oai21  g64(.a(new_n98_), .b(x21), .c(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n60_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n81_), .O(z15));
  nand2  g68(.a(new_n109_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand4  g70(.a(new_n102_), .b(new_n115_), .c(new_n107_), .d(new_n101_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n60_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n81_), .O(z16));
  nand2  g74(.a(new_n116_), .b(x24), .O(new_n120_));
  inv1   g75(.a(x24), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n115_), .c(new_n107_), .d(new_n101_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(new_n98_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n120_), .O(z17));
  nand2  g80(.a(new_n123_), .b(new_n50_), .O(new_n126_));
  oai21  g81(.a(new_n122_), .b(new_n98_), .c(x25), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n60_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n81_), .O(z18));
endmodule
