...
module FAU ( 
  ...
  oai21  g56(.a(new_n101_), .b(new_n98_), .c(new_n49_), .O(z12));
  ...
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n93_), .O(z15));
  nand4  g69(.a(new_n108_), .b(new_n103_), .c(new_n52_), .d(new_n111_), .O(new_n115_));
  ...
  oai21  g73(.a(new_n99_), .b(new_n48_), .c(new_n118_), .O(z17));
  nand2  g74(.a(new_n99_), .b(new_n64_), .O(z18));
endmodule
