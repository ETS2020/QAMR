...
module FAU ( 
  ...
  nor2   g30(.a(new_n75_), .b(new_n47_), .O(z06));
  ...
  nand2  g58(.a(new_n99_), .b(new_n103_), .O(new_n104_));
  nand2  g59(.a(new_n100_), .b(x21), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n85_), .O(z14));
  inv1   g61(.a(x22), .O(new_n107_));
  nand3  g62(.a(new_n99_), .b(new_n107_), .c(new_n103_), .O(new_n108_));
  nand2  g63(.a(new_n104_), .b(x22), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n85_), .O(z15));
  nor2   g65(.a(new_n108_), .b(x23), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  aoi21  g67(.a(new_n108_), .b(x23), .c(new_n84_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(z16));
  inv1   g69(.a(x24), .O(new_n115_));
  oai21  g70(.a(new_n111_), .b(new_n115_), .c(new_n85_), .O(z17));
  inv1   g71(.a(x25), .O(new_n117_));
  aoi21  g72(.a(new_n94_), .b(new_n117_), .c(new_n47_), .O(z18));
endmodule
