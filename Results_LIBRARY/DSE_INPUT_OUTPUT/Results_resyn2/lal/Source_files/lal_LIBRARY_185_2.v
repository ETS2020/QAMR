...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n86_, new_n87_, new_n90_, new_n93_, new_n94_, new_n96_, new_n98_,
  ...
  nand3  g48(.a(new_n61_), .b(new_n93_), .c(new_n47_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z09));
  nand2  g50(.a(new_n60_), .b(new_n52_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n47_), .c(x15), .O(z10));
  aoi21  g52(.a(new_n53_), .b(new_n52_), .c(new_n61_), .O(new_n98_));
  oai21  g53(.a(new_n53_), .b(new_n52_), .c(new_n98_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n47_), .c(x15), .O(z11));
  nand2  g55(.a(new_n62_), .b(new_n93_), .O(new_n101_));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  aoi21  g58(.a(x18), .b(x17), .c(x19), .O(new_n104_));
  nor3   g59(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(z12));
  ...
  nand2  g64(.a(new_n109_), .b(new_n93_), .O(z13));
  inv1   g65(.a(new_n101_), .O(new_n111_));
  oai21  g66(.a(new_n102_), .b(x20), .c(x21), .O(new_n112_));
  inv1   g67(.a(x21), .O(new_n113_));
  nand2  g68(.a(new_n106_), .b(new_n113_), .O(new_n114_));
  ...
  nand3  g76(.a(new_n117_), .b(new_n106_), .c(new_n121_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n111_), .O(z16));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n117_), .c(new_n106_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n60_), .O(new_n126_));
  aoi21  g81(.a(new_n122_), .b(x24), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x07), .c(new_n93_), .O(z17));
  nand4  g83(.a(new_n124_), .b(new_n117_), .c(new_n106_), .d(new_n50_), .O(new_n129_));
  nand2  g84(.a(new_n125_), .b(x25), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n129_), .c(new_n60_), .O(new_n131_));
