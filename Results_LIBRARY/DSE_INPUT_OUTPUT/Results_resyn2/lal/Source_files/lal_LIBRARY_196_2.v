...
module FAU ( 
  ...
  nand3  g09(.a(x24), .b(x22), .c(x21), .O(new_n55_));
  ...
  oai21  g16(.a(new_n61_), .b(x07), .c(new_n48_), .O(new_n62_));
  oai21  g17(.a(new_n59_), .b(new_n56_), .c(new_n62_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nand2  g19(.a(new_n48_), .b(new_n64_), .O(z02));
  nor2   g20(.a(new_n59_), .b(new_n56_), .O(z03));
  ...
  inv1   g28(.a(new_n48_), .O(new_n74_));
  nor3   g29(.a(new_n74_), .b(x13), .c(x08), .O(z05));
  nand2  g30(.a(x14), .b(new_n46_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n48_), .O(z06));
  aoi21  g32(.a(new_n46_), .b(x06), .c(new_n74_), .O(z07));
  nand2  g33(.a(new_n54_), .b(new_n50_), .O(new_n79_));
  inv1   g34(.a(new_n55_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(new_n58_), .c(new_n57_), .O(z08));
  nor2   g37(.a(x15), .b(x07), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n61_), .c(new_n48_), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z09));
  nand4  g40(.a(new_n83_), .b(new_n60_), .c(new_n48_), .d(new_n51_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  nand2  g42(.a(new_n83_), .b(new_n60_), .O(new_n88_));
  xnor2a g43(.a(x18), .b(x17), .O(new_n89_));
  oai21  g44(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(z11));
  nand3  g45(.a(new_n83_), .b(new_n60_), .c(new_n48_), .O(new_n91_));
  ...
  nand2  g51(.a(new_n93_), .b(new_n50_), .O(new_n97_));
  ...
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n96_), .O(z14));
  nand2  g58(.a(new_n102_), .b(x22), .O(new_n104_));
  nor3   g59(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n93_), .c(new_n88_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n74_), .O(z15));
  nand3  g62(.a(new_n105_), .b(new_n93_), .c(new_n57_), .O(new_n108_));
  inv1   g63(.a(x22), .O(new_n109_));
  nand3  g64(.a(new_n101_), .b(new_n93_), .c(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(x23), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n96_), .O(z16));
  inv1   g67(.a(new_n88_), .O(new_n113_));
  nand3  g68(.a(new_n105_), .b(new_n93_), .c(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n110_), .b(x24), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n57_), .O(z17));
  nand2  g71(.a(new_n114_), .b(x25), .O(new_n117_));
  nand4  g72(.a(new_n105_), .b(new_n93_), .c(new_n58_), .d(new_n47_), .O(new_n118_));
  aoi21  g73(.a(new_n58_), .b(x24), .c(new_n57_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(new_n88_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(z18));
endmodule
