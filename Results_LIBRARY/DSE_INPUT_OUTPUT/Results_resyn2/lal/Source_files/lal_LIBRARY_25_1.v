...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n71_, new_n77_, new_n78_, new_n80_, new_n82_, new_n83_, new_n84_,
  ...
  and2   g28(.a(new_n50_), .b(x14), .O(z06));
  nand2  g29(.a(new_n50_), .b(x06), .O(z07));
  aoi21  g30(.a(new_n61_), .b(new_n47_), .c(new_n48_), .O(z08));
  inv1   g31(.a(x07), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(x05), .c(x04), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(new_n47_), .c(x15), .O(z09));
  nand2  g34(.a(new_n52_), .b(new_n55_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n47_), .c(x15), .O(z10));
  nand2  g36(.a(new_n56_), .b(new_n55_), .O(new_n82_));
  nand2  g37(.a(x18), .b(x17), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n82_), .c(new_n52_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n47_), .c(x15), .O(z11));
  nand2  g40(.a(new_n83_), .b(new_n57_), .O(new_n86_));
  nand3  g41(.a(x19), .b(x18), .c(x17), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n86_), .c(new_n52_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z12));
  inv1   g44(.a(x15), .O(new_n90_));
  nand3  g45(.a(new_n52_), .b(new_n47_), .c(new_n90_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand2  g47(.a(new_n87_), .b(x20), .O(new_n93_));
  nand4  g48(.a(new_n54_), .b(x19), .c(x18), .d(x17), .O(new_n94_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n96_), .c(new_n52_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n90_), .O(z14));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nand3  g59(.a(new_n98_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n52_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n90_), .O(z15));
  nand2  g63(.a(new_n105_), .b(x23), .O(new_n109_));
  nor2   g64(.a(x23), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n98_), .c(new_n97_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n52_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n90_), .O(z16));
  nor2   g69(.a(x24), .b(x21), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n110_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n94_), .c(new_n52_), .O(new_n117_));
  aoi21  g72(.a(new_n111_), .b(x24), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x25), .c(new_n90_), .O(z17));
  oai21  g74(.a(new_n116_), .b(new_n94_), .c(new_n92_), .O(z18));
endmodule
