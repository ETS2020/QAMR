...
module FAU ( 
  ...
  nor3   g42(.a(new_n47_), .b(x13), .c(x08), .O(z05));
  nand2  g43(.a(x14), .b(new_n46_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n65_), .O(z06));
  nand3  g45(.a(new_n65_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g46(.a(new_n59_), .b(new_n51_), .c(new_n47_), .O(z08));
  zero   g47(.O(z09));
  zero   g48(.O(z10));
  zero   g49(.O(z11));
  zero   g50(.O(z12));
