...
module FAU ( 
  ...
  nand2  g34(.a(new_n72_), .b(x14), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z06));
  nand2  g36(.a(new_n72_), .b(x06), .O(z07));
  nor4   g37(.a(new_n64_), .b(new_n49_), .c(x15), .d(x07), .O(z09));
  inv1   g38(.a(x15), .O(new_n84_));
  nand3  g39(.a(new_n64_), .b(new_n84_), .c(new_n63_), .O(new_n85_));
  ...
  aoi21  g53(.a(new_n98_), .b(new_n97_), .c(new_n49_), .O(z13));
  nand2  g54(.a(new_n97_), .b(x21), .O(new_n100_));
  inv1   g55(.a(x21), .O(new_n101_));
  aoi21  g56(.a(new_n96_), .b(new_n101_), .c(new_n85_), .O(new_n102_));
  ...
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n49_), .O(z15));
  nand2  g62(.a(new_n85_), .b(new_n50_), .O(new_n108_));
  nand2  g63(.a(new_n105_), .b(new_n96_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n48_), .c(x23), .O(new_n110_));
  nand3  g65(.a(new_n105_), .b(new_n96_), .c(new_n47_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n108_), .O(z16));
  nand2  g67(.a(new_n109_), .b(new_n48_), .O(new_n113_));
  nand3  g68(.a(new_n105_), .b(new_n96_), .c(x24), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n108_), .O(z17));
  ...
  nand4  g75(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n91_), .O(z18));
endmodule
