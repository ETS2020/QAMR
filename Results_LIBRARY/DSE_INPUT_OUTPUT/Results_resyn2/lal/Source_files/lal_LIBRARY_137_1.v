...
module FAU ( 
  ...
  nor2   g03(.a(new_n48_), .b(x11), .O(new_n49_));
  ...
  nand3  g62(.a(new_n103_), .b(new_n94_), .c(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n84_), .O(z16));
  nor2   g64(.a(x24), .b(x23), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n103_), .c(new_n94_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n63_), .O(new_n112_));
  aoi21  g67(.a(new_n108_), .b(x24), .c(new_n112_), .O(new_n113_));
  nand2  g68(.a(x15), .b(x11), .O(new_n114_));
  oai21  g69(.a(new_n113_), .b(x15), .c(new_n114_), .O(z17));
  or2    g70(.a(new_n111_), .b(x25), .O(new_n116_));
  aoi21  g71(.a(new_n111_), .b(x25), .c(new_n83_), .O(new_n117_));
