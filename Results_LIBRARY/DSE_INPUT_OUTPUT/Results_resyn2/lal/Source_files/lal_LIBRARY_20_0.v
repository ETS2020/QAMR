...
module FAU ( 
  ...
  nand3  g63(.a(new_n100_), .b(new_n108_), .c(new_n105_), .O(new_n109_));
  oai21  g64(.a(new_n101_), .b(x21), .c(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n99_), .O(z15));
  ...
  inv1   g70(.a(new_n89_), .O(new_n116_));
  oai22  g71(.a(new_n112_), .b(new_n54_), .c(new_n116_), .d(new_n47_), .O(z17));
  nand3  g72(.a(new_n116_), .b(new_n48_), .c(new_n65_), .O(z18));
endmodule
