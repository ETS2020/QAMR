...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(new_n54_), .c(x20), .O(new_n85_));
  oai21  g40(.a(new_n57_), .b(new_n85_), .c(new_n83_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x24), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n50_), .c(new_n82_), .O(z08));
  inv1   g43(.a(x15), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(new_n62_), .c(new_n47_), .O(z09));
  ...
  oai21  g55(.a(new_n100_), .b(new_n92_), .c(new_n47_), .O(z11));
  ...
  aoi21  g61(.a(new_n102_), .b(x20), .c(new_n92_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n106_), .c(new_n82_), .O(z13));
  ...
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n95_), .O(z14));
  nand2  g68(.a(new_n111_), .b(x22), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  nand3  g70(.a(new_n110_), .b(new_n115_), .c(new_n109_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n95_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  nand2  g73(.a(new_n115_), .b(new_n109_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(new_n106_), .O(new_n120_));
  aoi21  g75(.a(new_n120_), .b(new_n83_), .c(new_n92_), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n118_), .c(new_n82_), .O(z16));
  nand3  g77(.a(new_n120_), .b(new_n83_), .c(new_n66_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x24), .O(new_n124_));
  nand3  g79(.a(new_n120_), .b(new_n49_), .c(new_n83_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n93_), .O(z17));
  nand4  g81(.a(new_n120_), .b(new_n50_), .c(new_n49_), .d(new_n83_), .O(new_n127_));
  nand2  g82(.a(new_n47_), .b(new_n50_), .O(new_n128_));
