...
module FAU ( 
  ...
  nand3  g15(.a(new_n60_), .b(new_n58_), .c(x24), .O(new_n61_));
  nand2  g16(.a(new_n61_), .b(new_n52_), .O(new_n62_));
  nand2  g17(.a(x05), .b(x04), .O(new_n63_));
  nor2   g18(.a(new_n49_), .b(x07), .O(new_n64_));
  nand3  g19(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(z01));
  inv1   g20(.a(x16), .O(new_n66_));
  nor2   g21(.a(new_n49_), .b(new_n66_), .O(z02));
  nand2  g22(.a(new_n62_), .b(new_n50_), .O(z03));
  ...
  aoi21  g34(.a(new_n57_), .b(new_n53_), .c(new_n59_), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(x23), .c(x24), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n52_), .O(z08));
  inv1   g37(.a(x07), .O(new_n83_));
  inv1   g38(.a(x15), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n63_), .c(new_n50_), .O(z09));
  nand3  g41(.a(new_n63_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  nor3   g42(.a(new_n87_), .b(new_n49_), .c(x17), .O(z10));
  nand2  g43(.a(new_n55_), .b(new_n54_), .O(new_n89_));
  nand2  g44(.a(x18), .b(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(new_n87_), .c(new_n50_), .O(z11));
  inv1   g47(.a(new_n87_), .O(new_n93_));
  nand3  g48(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  nand2  g49(.a(new_n90_), .b(new_n56_), .O(new_n95_));
  ...
  aoi21  g55(.a(new_n100_), .b(new_n99_), .c(new_n49_), .O(z13));
  nand2  g56(.a(new_n99_), .b(x21), .O(new_n102_));
  inv1   g57(.a(new_n94_), .O(new_n103_));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n87_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n102_), .c(new_n49_), .O(z14));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n98_), .O(new_n108_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(x22), .c(new_n87_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n108_), .c(new_n49_), .O(z15));
  nand3  g66(.a(new_n108_), .b(new_n48_), .c(x23), .O(new_n112_));
  nand2  g67(.a(new_n87_), .b(new_n50_), .O(new_n113_));
  nand3  g68(.a(new_n107_), .b(new_n98_), .c(new_n47_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(z16));
  nand4  g70(.a(new_n107_), .b(new_n98_), .c(new_n48_), .d(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n114_), .b(x24), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n93_), .O(z17));
  nor2   g73(.a(x25), .b(x24), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n107_), .c(new_n98_), .d(new_n47_), .O(new_n120_));
  inv1   g75(.a(x22), .O(new_n121_));
  nand2  g76(.a(new_n48_), .b(new_n121_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n109_), .c(x25), .O(new_n123_));
  oai21  g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n120_), .d(new_n93_), .O(z18));
endmodule
