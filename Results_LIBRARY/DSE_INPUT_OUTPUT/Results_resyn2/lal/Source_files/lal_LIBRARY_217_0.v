...
module FAU ( 
  ...
  nand3  g43(.a(x19), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(new_n86_), .O(z09));
  inv1   g45(.a(new_n89_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n86_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z10));
  nand2  g50(.a(x18), .b(x17), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n65_), .O(z11));
  inv1   g53(.a(new_n97_), .O(z12));
  ...
  nor2   g60(.a(new_n96_), .b(x20), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g62(.a(new_n101_), .b(x21), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n62_), .O(new_n109_));
  ...
  nand3  g68(.a(new_n106_), .b(new_n113_), .c(new_n105_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n93_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  nand4  g71(.a(new_n106_), .b(new_n68_), .c(new_n113_), .d(new_n105_), .O(new_n117_));
  ...
  nand4  g75(.a(new_n120_), .b(new_n106_), .c(new_n113_), .d(new_n105_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n93_), .O(z17));
  aoi21  g77(.a(new_n121_), .b(x25), .c(new_n92_), .O(new_n123_));
