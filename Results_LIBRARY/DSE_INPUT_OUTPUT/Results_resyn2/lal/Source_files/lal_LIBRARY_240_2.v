...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(new_n53_), .c(new_n55_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x23), .c(x24), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n49_), .c(new_n52_), .O(z08));
  inv1   g42(.a(new_n63_), .O(new_n88_));
  nor2   g43(.a(x15), .b(x07), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n49_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand2  g46(.a(new_n89_), .b(new_n63_), .O(new_n92_));
  nor3   g47(.a(new_n92_), .b(new_n48_), .c(x17), .O(z10));
  nand2  g48(.a(new_n83_), .b(new_n82_), .O(new_n94_));
  ...
  nand2  g52(.a(x24), .b(x19), .O(new_n98_));
  inv1   g53(.a(new_n92_), .O(new_n99_));
  oai21  g54(.a(new_n95_), .b(new_n47_), .c(new_n99_), .O(new_n100_));
  aoi21  g55(.a(new_n98_), .b(new_n95_), .c(new_n100_), .O(z12));
  nor2   g56(.a(new_n95_), .b(x20), .O(new_n102_));
  oai21  g57(.a(new_n102_), .b(new_n51_), .c(x19), .O(new_n103_));
  nand4  g58(.a(x24), .b(x19), .c(x18), .d(x17), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(x20), .c(new_n92_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n103_), .O(z13));
  nand3  g61(.a(new_n53_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(x21), .c(x24), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x19), .O(new_n109_));
  oai21  g64(.a(new_n107_), .b(new_n98_), .c(x21), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n99_), .O(z14));
  nand2  g66(.a(new_n109_), .b(x22), .O(new_n112_));
  nand2  g67(.a(new_n92_), .b(new_n49_), .O(new_n113_));
  nor2   g68(.a(new_n107_), .b(new_n98_), .O(new_n114_));
  ...
  aoi21  g72(.a(new_n115_), .b(new_n102_), .c(new_n51_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n47_), .c(x23), .O(new_n119_));
  nand3  g74(.a(new_n115_), .b(new_n114_), .c(new_n59_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n113_), .O(z16));
  nand2  g76(.a(new_n51_), .b(new_n47_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n99_), .O(z17));
  aoi21  g79(.a(new_n99_), .b(new_n52_), .c(new_n48_), .O(z18));
endmodule
