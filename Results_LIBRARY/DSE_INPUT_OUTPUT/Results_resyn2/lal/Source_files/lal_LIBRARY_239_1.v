...
module FAU ( 
  ...
  nand4  g43(.a(new_n48_), .b(new_n88_), .c(x05), .d(x04), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand2  g45(.a(new_n63_), .b(new_n48_), .O(new_n91_));
  ...
  nor2   g61(.a(new_n96_), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n105_), .c(new_n63_), .O(new_n109_));
  ...
  nand3  g72(.a(new_n113_), .b(new_n107_), .c(new_n117_), .O(new_n118_));
  ...
  nand3  g76(.a(new_n121_), .b(new_n113_), .c(new_n107_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n100_), .O(z17));
  or2    g78(.a(new_n122_), .b(x25), .O(new_n124_));
  aoi21  g79(.a(new_n122_), .b(x25), .c(new_n91_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n124_), .c(new_n49_), .O(z18));
endmodule
