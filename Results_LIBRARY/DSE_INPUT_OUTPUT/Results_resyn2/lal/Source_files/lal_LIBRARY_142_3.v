...
module FAU ( 
  ...
  aoi21  g35(.a(new_n60_), .b(new_n52_), .c(new_n49_), .O(z08));
  inv1   g36(.a(x07), .O(new_n82_));
  nand4  g37(.a(new_n47_), .b(new_n82_), .c(x05), .d(x04), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z09));
  nand2  g39(.a(new_n62_), .b(new_n47_), .O(new_n85_));
  ...
  oai21  g48(.a(new_n93_), .b(new_n85_), .c(new_n50_), .O(z12));
  ...
  nand2  g54(.a(new_n48_), .b(x15), .O(new_n100_));
  nand2  g55(.a(new_n97_), .b(x21), .O(new_n101_));
  inv1   g56(.a(x21), .O(new_n102_));
  nor2   g57(.a(new_n91_), .b(x20), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n101_), .c(new_n62_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n100_), .O(z14));
  inv1   g62(.a(x22), .O(new_n108_));
  aoi21  g63(.a(new_n103_), .b(new_n102_), .c(new_n108_), .O(new_n109_));
  nand3  g64(.a(new_n103_), .b(new_n108_), .c(new_n102_), .O(new_n110_));
  ...
  or2    g69(.a(new_n110_), .b(x23), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n95_), .O(z16));
  oai21  g71(.a(new_n110_), .b(x23), .c(x24), .O(new_n117_));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n103_), .c(new_n108_), .d(new_n102_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n95_), .O(z17));
