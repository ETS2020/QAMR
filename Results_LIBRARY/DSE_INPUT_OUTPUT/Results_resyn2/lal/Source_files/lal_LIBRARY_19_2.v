...
module FAU ( 
  ...
  aoi21  g20(.a(new_n58_), .b(new_n50_), .c(new_n48_), .O(z08));
  ...
  nand3  g36(.a(new_n61_), .b(new_n81_), .c(new_n47_), .O(new_n82_));
  ...
  nand2  g42(.a(new_n53_), .b(new_n52_), .O(new_n88_));
  nand2  g43(.a(x18), .b(x17), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n60_), .c(new_n88_), .O(new_n90_));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n100_), .c(new_n84_), .O(new_n101_));
  oai21  g56(.a(new_n96_), .b(new_n100_), .c(new_n101_), .O(z14));
  inv1   g57(.a(x22), .O(new_n103_));
  aoi21  g58(.a(new_n96_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  ...
  nand2  g63(.a(new_n108_), .b(new_n81_), .O(z15));
  nand2  g64(.a(new_n106_), .b(x23), .O(new_n110_));
  or2    g65(.a(new_n106_), .b(x23), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n85_), .O(z16));
  oai21  g67(.a(new_n106_), .b(x23), .c(x24), .O(new_n113_));
  nor2   g68(.a(x24), .b(x23), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n105_), .c(new_n96_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n85_), .O(z17));
  nand4  g71(.a(new_n114_), .b(new_n105_), .c(new_n96_), .d(new_n50_), .O(new_n117_));
  nand2  g72(.a(new_n115_), .b(x25), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n60_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n81_), .O(z18));
endmodule
