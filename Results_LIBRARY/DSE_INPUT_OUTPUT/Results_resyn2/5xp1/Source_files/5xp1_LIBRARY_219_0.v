...
module FAU ( 
  ...
  inv1   g41(.a(new_n26_), .O(new_n59_));
  nand2  g42(.a(x2), .b(x1), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n18_), .c(new_n29_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n59_), .c(x5), .O(new_n62_));
  nand3  g45(.a(new_n39_), .b(new_n24_), .c(x0), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x6), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n34_), .c(new_n20_), .O(new_n65_));
  oai21  g48(.a(x5), .b(new_n24_), .c(x6), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n23_), .O(new_n67_));
  nand2  g50(.a(new_n46_), .b(x5), .O(new_n68_));
  oai21  g51(.a(new_n39_), .b(x0), .c(new_n20_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n68_), .c(x3), .O(new_n70_));
  nand4  g53(.a(new_n70_), .b(new_n67_), .c(new_n65_), .d(new_n62_), .O(z3));
  inv1   g54(.a(new_n29_), .O(new_n72_));
  aoi21  g55(.a(new_n34_), .b(new_n72_), .c(x6), .O(new_n73_));
  oai21  g56(.a(x3), .b(x0), .c(x2), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n24_), .O(new_n75_));
  nor2   g58(.a(new_n34_), .b(new_n29_), .O(new_n76_));
  inv1   g59(.a(x3), .O(new_n77_));
  oai21  g60(.a(new_n60_), .b(new_n77_), .c(x6), .O(new_n78_));
  nor2   g61(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n75_), .c(new_n73_), .O(z4));
  inv1   g63(.a(new_n25_), .O(new_n81_));
  aoi21  g64(.a(x3), .b(x1), .c(x2), .O(new_n82_));
  nor2   g65(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(x6), .c(new_n23_), .O(new_n84_));
  oai21  g67(.a(new_n83_), .b(new_n23_), .c(new_n84_), .O(z5));
  inv1   g68(.a(new_n56_), .O(new_n86_));
  nand3  g69(.a(x3), .b(new_n39_), .c(new_n24_), .O(new_n87_));
  oai21  g70(.a(new_n77_), .b(x2), .c(x1), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(z6));
  nor2   g72(.a(x3), .b(x2), .O(new_n90_));
  nor3   g73(.a(new_n56_), .b(new_n90_), .c(new_n81_), .O(z7));
  nor2   g74(.a(new_n56_), .b(x3), .O(z8));
  nor3   g75(.a(new_n56_), .b(new_n20_), .c(new_n22_), .O(z9));
endmodule
