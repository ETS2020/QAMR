...
module FAU ( 
  ...
  nand4  g64(.a(new_n76_), .b(new_n81_), .c(new_n27_), .d(new_n20_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n80_), .c(new_n78_), .O(z5));
  inv1   g66(.a(x2), .O(new_n84_));
  nand3  g67(.a(x3), .b(new_n84_), .c(new_n26_), .O(new_n85_));
  inv1   g68(.a(x3), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(x2), .c(x1), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n80_), .O(z6));
  nand2  g71(.a(new_n80_), .b(new_n77_), .O(z7));
  nor2   g72(.a(new_n79_), .b(x3), .O(z8));
  nand3  g73(.a(new_n23_), .b(x5), .c(x4), .O(new_n91_));
