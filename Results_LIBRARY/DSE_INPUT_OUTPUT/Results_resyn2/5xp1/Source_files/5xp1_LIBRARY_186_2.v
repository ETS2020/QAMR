...
module FAU ( 
  ...
  nand4  g42(.a(new_n59_), .b(new_n42_), .c(x4), .d(new_n58_), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n57_), .c(x3), .O(new_n61_));
  nor2   g44(.a(new_n35_), .b(new_n18_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n47_), .c(new_n61_), .O(new_n63_));
  nand4  g46(.a(new_n63_), .b(new_n56_), .c(new_n51_), .d(new_n46_), .O(z2));
  nand2  g47(.a(new_n49_), .b(new_n22_), .O(new_n65_));
  nand2  g48(.a(new_n32_), .b(new_n59_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  oai21  g50(.a(new_n23_), .b(new_n22_), .c(new_n59_), .O(new_n68_));
  ...
  nand2  g56(.a(new_n23_), .b(new_n21_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n33_), .c(new_n47_), .O(new_n75_));
  nand3  g58(.a(new_n74_), .b(new_n33_), .c(new_n59_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(x1), .O(new_n77_));
  oai21  g60(.a(x3), .b(x0), .c(x2), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n59_), .c(x1), .O(new_n79_));
  oai21  g62(.a(new_n78_), .b(new_n47_), .c(new_n79_), .O(new_n80_));
  oai21  g63(.a(new_n77_), .b(new_n75_), .c(new_n80_), .O(z4));
  inv1   g64(.a(new_n43_), .O(new_n82_));
  nand4  g65(.a(new_n33_), .b(new_n82_), .c(new_n23_), .d(x0), .O(new_n83_));
  nand2  g66(.a(new_n59_), .b(x5), .O(new_n84_));
  nand2  g67(.a(new_n33_), .b(new_n23_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n43_), .c(new_n21_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  inv1   g70(.a(new_n87_), .O(z5));
  nand2  g71(.a(x3), .b(new_n58_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n22_), .c(new_n84_), .O(new_n90_));
  aoi21  g73(.a(new_n89_), .b(new_n22_), .c(new_n90_), .O(z6));
  inv1   g74(.a(new_n84_), .O(new_n92_));
  nor2   g75(.a(new_n92_), .b(new_n85_), .O(z7));
  nor2   g76(.a(new_n92_), .b(x3), .O(z8));
  nand2  g77(.a(new_n40_), .b(x6), .O(new_n95_));
