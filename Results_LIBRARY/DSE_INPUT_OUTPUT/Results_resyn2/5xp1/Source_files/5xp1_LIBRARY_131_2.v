...
module FAU ( 
  ...
  oai22  g14(.a(new_n31_), .b(new_n30_), .c(new_n19_), .d(new_n26_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n29_), .O(new_n33_));
  oai21  g16(.a(x6), .b(x0), .c(x4), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n25_), .c(x5), .O(new_n35_));
  ...
  nand2  g27(.a(new_n29_), .b(new_n30_), .O(new_n45_));
  nand3  g28(.a(new_n39_), .b(new_n38_), .c(new_n22_), .O(new_n46_));
  ...
  xnor2a g50(.a(x3), .b(x2), .O(new_n68_));
  oai21  g51(.a(new_n68_), .b(new_n56_), .c(x0), .O(new_n69_));
  nor2   g52(.a(new_n63_), .b(new_n22_), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(x2), .c(new_n23_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n69_), .c(new_n20_), .O(z5));
  nor2   g55(.a(new_n63_), .b(x2), .O(new_n73_));
  nand2  g56(.a(x6), .b(x1), .O(new_n74_));
  oai22  g57(.a(new_n74_), .b(new_n73_), .c(new_n57_), .d(new_n63_), .O(z6));
  nand2  g58(.a(new_n68_), .b(new_n20_), .O(z7));
  nand2  g59(.a(new_n20_), .b(x3), .O(z8));
  aoi21  g60(.a(new_n22_), .b(x0), .c(x6), .O(new_n78_));
  nor3   g61(.a(new_n78_), .b(new_n29_), .c(new_n26_), .O(z9));
endmodule
