...
module FAU ( 
  ...
  nand4  g58(.a(new_n75_), .b(new_n73_), .c(new_n25_), .d(x0), .O(new_n76_));
  nand3  g59(.a(new_n75_), .b(new_n73_), .c(new_n25_), .O(new_n77_));
  ...
  oai21  g64(.a(new_n81_), .b(new_n24_), .c(new_n52_), .O(new_n82_));
  aoi21  g65(.a(new_n81_), .b(new_n24_), .c(new_n82_), .O(z6));
  nand2  g66(.a(new_n75_), .b(new_n25_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(new_n51_), .O(z7));
  nor2   g68(.a(new_n51_), .b(x3), .O(z8));
  aoi21  g69(.a(x6), .b(new_n18_), .c(new_n21_), .O(z9));
endmodule
