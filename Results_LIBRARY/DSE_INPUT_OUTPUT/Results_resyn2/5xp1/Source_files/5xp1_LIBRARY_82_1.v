...
module FAU ( 
  ...
  nand3  g62(.a(x3), .b(new_n55_), .c(x1), .O(new_n80_));
  ...
  aoi21  g69(.a(x3), .b(new_n55_), .c(x1), .O(new_n87_));
  nor3   g70(.a(new_n87_), .b(new_n86_), .c(new_n23_), .O(z6));
  inv1   g71(.a(new_n50_), .O(new_n89_));
  nor2   g72(.a(x3), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(new_n67_), .O(z7));
