...
module FAU ( 
  ...
  inv1   g72(.a(new_n53_), .O(new_n90_));
  oai21  g73(.a(new_n68_), .b(x2), .c(x1), .O(new_n91_));
  nand3  g74(.a(x3), .b(new_n70_), .c(new_n19_), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(z6));
  nand2  g76(.a(new_n86_), .b(new_n53_), .O(z7));
  nand2  g77(.a(new_n53_), .b(x3), .O(z8));
endmodule
