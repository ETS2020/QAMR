...
module FAU ( 
  ...
  aoi22  g12(.a(new_n29_), .b(new_n27_), .c(new_n24_), .d(new_n21_), .O(z0));
  nor2   g13(.a(new_n28_), .b(new_n22_), .O(new_n31_));
  inv1   g14(.a(x2), .O(new_n32_));
  aoi21  g15(.a(x4), .b(x1), .c(x6), .O(new_n33_));
  aoi21  g16(.a(x4), .b(x3), .c(x6), .O(new_n34_));
  oai22  g17(.a(new_n34_), .b(new_n18_), .c(new_n33_), .d(new_n32_), .O(new_n35_));
  aoi21  g18(.a(new_n35_), .b(x0), .c(new_n31_), .O(new_n36_));
  ...
  aoi21  g25(.a(new_n28_), .b(new_n22_), .c(new_n42_), .O(new_n43_));
  ...
  oai21  g30(.a(new_n28_), .b(new_n22_), .c(new_n23_), .O(new_n48_));
  ...
  aoi21  g35(.a(new_n52_), .b(x1), .c(x6), .O(new_n53_));
  nor3   g36(.a(x4), .b(x2), .c(x1), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n53_), .c(new_n23_), .O(new_n55_));
  nand2  g38(.a(new_n32_), .b(new_n18_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x0), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n23_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n31_), .c(new_n26_), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n55_), .c(new_n50_), .d(new_n46_), .O(z2));
  ...
  oai21  g46(.a(new_n34_), .b(new_n18_), .c(x0), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n63_), .c(x5), .O(new_n65_));
  nand2  g48(.a(x6), .b(x2), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n46_), .c(new_n18_), .O(new_n67_));
  nor2   g50(.a(x3), .b(x2), .O(new_n68_));
  nor2   g51(.a(x6), .b(new_n22_), .O(new_n69_));
  ...
  nor2   g56(.a(new_n33_), .b(new_n32_), .O(new_n74_));
  oai21  g57(.a(new_n51_), .b(x0), .c(new_n23_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n42_), .c(new_n74_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n73_), .c(new_n65_), .O(z3));
  nor2   g60(.a(new_n68_), .b(new_n25_), .O(new_n78_));
  nor2   g61(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  nand2  g62(.a(new_n78_), .b(new_n28_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  oai21  g64(.a(x3), .b(x0), .c(x2), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n28_), .c(x1), .O(new_n83_));
  oai21  g66(.a(new_n82_), .b(new_n69_), .c(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n81_), .b(new_n79_), .c(new_n84_), .O(z4));
  nand3  g68(.a(new_n56_), .b(new_n52_), .c(new_n19_), .O(new_n86_));
  nand2  g69(.a(new_n52_), .b(new_n19_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n57_), .c(new_n46_), .O(new_n88_));
  aoi21  g71(.a(new_n86_), .b(new_n41_), .c(new_n88_), .O(z5));
  nand3  g72(.a(x3), .b(new_n32_), .c(new_n18_), .O(new_n90_));
  oai21  g73(.a(new_n51_), .b(x2), .c(x1), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(z6));
  nand2  g75(.a(new_n87_), .b(new_n46_), .O(z7));
  nand2  g76(.a(new_n46_), .b(x3), .O(z8));
  nand2  g77(.a(new_n24_), .b(new_n21_), .O(new_n95_));
  nand2  g78(.a(new_n46_), .b(new_n95_), .O(z9));
endmodule
