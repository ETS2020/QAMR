...
module FAU ( 
  ...
  nand3  g41(.a(x6), .b(new_n51_), .c(new_n19_), .O(new_n59_));
  ...
  inv1   g57(.a(new_n21_), .O(new_n75_));
  inv1   g58(.a(x3), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(new_n20_), .O(new_n78_));
  nor2   g61(.a(x3), .b(x2), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n21_), .c(x6), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n70_), .b(new_n20_), .c(x1), .O(new_n82_));
  oai21  g65(.a(new_n70_), .b(new_n20_), .c(new_n82_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n43_), .O(z4));
  nand4  g67(.a(new_n77_), .b(new_n52_), .c(new_n24_), .d(x0), .O(new_n85_));
  nand3  g68(.a(new_n77_), .b(new_n52_), .c(new_n24_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n37_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n43_), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(z5));
  nand3  g72(.a(x3), .b(new_n51_), .c(new_n19_), .O(new_n90_));
  oai21  g73(.a(new_n76_), .b(x2), .c(x1), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(z6));
  nor2   g75(.a(x6), .b(x4), .O(new_n93_));
  nor3   g76(.a(new_n93_), .b(new_n79_), .c(new_n25_), .O(z7));
