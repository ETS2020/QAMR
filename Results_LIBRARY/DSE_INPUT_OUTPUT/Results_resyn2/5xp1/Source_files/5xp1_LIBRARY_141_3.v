...
module FAU ( 
  ...
  nand3  g52(.a(new_n47_), .b(new_n25_), .c(x6), .O(new_n70_));
  nand2  g53(.a(new_n47_), .b(new_n25_), .O(new_n71_));
  ...
  or2    g59(.a(new_n75_), .b(new_n19_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n76_), .c(new_n24_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n74_), .O(z4));
  nand2  g62(.a(new_n65_), .b(x2), .O(new_n80_));
  ...
  nand3  g67(.a(new_n84_), .b(new_n82_), .c(new_n43_), .O(new_n85_));
  inv1   g68(.a(new_n85_), .O(z5));
  inv1   g69(.a(new_n81_), .O(new_n87_));
  aoi21  g70(.a(x3), .b(new_n35_), .c(x1), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n87_), .c(new_n43_), .O(z6));
  nand2  g72(.a(new_n43_), .b(new_n25_), .O(new_n90_));
  aoi21  g73(.a(new_n65_), .b(new_n35_), .c(new_n90_), .O(z7));
  nor2   g74(.a(new_n34_), .b(x3), .O(z8));
  nor2   g75(.a(new_n23_), .b(x6), .O(new_n93_));
  nor2   g76(.a(new_n93_), .b(new_n18_), .O(z9));
endmodule
