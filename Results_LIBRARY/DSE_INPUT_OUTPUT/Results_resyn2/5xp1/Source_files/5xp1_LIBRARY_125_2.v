...
module FAU ( 
  ...
  aoi21  g62(.a(new_n35_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nand3  g63(.a(new_n35_), .b(new_n78_), .c(new_n25_), .O(new_n81_));
  ...
  nand2  g70(.a(new_n87_), .b(new_n66_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x0), .O(new_n89_));
  nand2  g72(.a(new_n87_), .b(new_n20_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n26_), .O(z5));
  nand2  g74(.a(x3), .b(new_n33_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n19_), .c(new_n26_), .O(new_n93_));
  aoi21  g76(.a(new_n92_), .b(new_n19_), .c(new_n93_), .O(z6));
  nand3  g77(.a(new_n35_), .b(new_n26_), .c(new_n66_), .O(new_n95_));
