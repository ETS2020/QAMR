...
module FAU ( 
  ...
  and2   g12(.a(new_n29_), .b(new_n25_), .O(z1));
  ...
  nand4  g41(.a(new_n58_), .b(new_n35_), .c(new_n32_), .d(new_n19_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n55_), .c(new_n51_), .O(z3));
  inv1   g43(.a(new_n43_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x6), .O(new_n62_));
  nand2  g45(.a(x3), .b(x0), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n45_), .c(new_n33_), .O(new_n64_));
  oai21  g47(.a(new_n62_), .b(new_n20_), .c(new_n64_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x1), .O(new_n66_));
  aoi21  g49(.a(new_n33_), .b(new_n23_), .c(x1), .O(new_n67_));
  oai21  g50(.a(new_n45_), .b(new_n33_), .c(new_n67_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n66_), .O(z4));
  nor2   g52(.a(x2), .b(x1), .O(new_n70_));
  nand2  g53(.a(x3), .b(x2), .O(new_n71_));
  nand2  g54(.a(new_n61_), .b(new_n71_), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n70_), .c(x0), .O(new_n73_));
  nor2   g56(.a(x6), .b(new_n18_), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  nor2   g58(.a(new_n72_), .b(new_n70_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n31_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(z5));
  inv1   g61(.a(x2), .O(new_n79_));
  nand3  g62(.a(x3), .b(new_n79_), .c(new_n19_), .O(new_n80_));
  oai21  g63(.a(new_n56_), .b(x2), .c(x1), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(new_n75_), .O(z6));
  nor2   g65(.a(new_n74_), .b(new_n72_), .O(z7));
  nor2   g66(.a(new_n74_), .b(x3), .O(z8));
  aoi21  g67(.a(x6), .b(new_n22_), .c(new_n18_), .O(z9));
endmodule
