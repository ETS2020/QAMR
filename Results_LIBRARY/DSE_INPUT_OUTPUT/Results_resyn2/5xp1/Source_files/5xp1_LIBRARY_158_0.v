...
module FAU ( 
  ...
  oai21  g61(.a(new_n78_), .b(new_n77_), .c(new_n56_), .O(new_n79_));
  ...
  nand2  g65(.a(new_n72_), .b(new_n56_), .O(new_n83_));
  aoi21  g66(.a(new_n71_), .b(new_n21_), .c(x1), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n82_), .O(z4));
  nand2  g69(.a(new_n50_), .b(new_n49_), .O(new_n87_));
  inv1   g70(.a(x3), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n50_), .O(new_n89_));
  nand4  g72(.a(new_n89_), .b(new_n87_), .c(new_n57_), .d(x0), .O(new_n90_));
  nand3  g73(.a(new_n89_), .b(new_n87_), .c(new_n57_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n18_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n30_), .O(new_n93_));
  inv1   g76(.a(new_n93_), .O(z5));
  nand3  g77(.a(x3), .b(new_n50_), .c(new_n49_), .O(new_n95_));
  oai21  g78(.a(new_n88_), .b(x2), .c(x1), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n30_), .O(z6));
  nand2  g80(.a(new_n89_), .b(new_n57_), .O(new_n98_));
  nor2   g81(.a(new_n98_), .b(new_n27_), .O(z7));
  nor2   g82(.a(new_n27_), .b(x3), .O(z8));
  nor3   g83(.a(new_n24_), .b(new_n26_), .c(new_n31_), .O(z9));
endmodule
