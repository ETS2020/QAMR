...
module FAU ( 
  ...
  inv1   g27(.a(new_n21_), .O(new_n45_));
  nor2   g28(.a(x3), .b(x2), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n45_), .c(x1), .O(new_n48_));
  ...
  nand2  g35(.a(new_n50_), .b(new_n46_), .O(new_n53_));
  ...
  oai21  g44(.a(new_n61_), .b(new_n19_), .c(new_n20_), .O(new_n62_));
  ...
  aoi21  g49(.a(new_n66_), .b(x0), .c(new_n29_), .O(new_n67_));
  inv1   g50(.a(x3), .O(new_n68_));
  oai21  g51(.a(new_n35_), .b(new_n68_), .c(new_n38_), .O(new_n69_));
  inv1   g52(.a(x2), .O(new_n70_));
  nand2  g53(.a(new_n18_), .b(x1), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n19_), .c(new_n70_), .O(new_n72_));
  aoi22  g55(.a(new_n72_), .b(new_n69_), .c(new_n67_), .d(new_n65_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n60_), .O(z3));
  oai21  g57(.a(new_n46_), .b(new_n34_), .c(new_n63_), .O(new_n75_));
  nand3  g58(.a(new_n47_), .b(new_n45_), .c(x6), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x1), .O(new_n78_));
  nand2  g61(.a(new_n37_), .b(x6), .O(new_n79_));
  oai21  g62(.a(new_n36_), .b(x1), .c(new_n50_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n78_), .O(z4));
  nor2   g65(.a(x2), .b(x1), .O(new_n83_));
  nand2  g66(.a(new_n47_), .b(new_n61_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n83_), .c(x0), .O(new_n85_));
  nor2   g68(.a(new_n84_), .b(new_n83_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n34_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n54_), .O(z5));
  nand3  g71(.a(x3), .b(new_n70_), .c(new_n20_), .O(new_n89_));
  oai21  g72(.a(new_n68_), .b(x2), .c(x1), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n54_), .O(z6));
  nand2  g74(.a(new_n84_), .b(new_n54_), .O(z7));
  nand2  g75(.a(new_n54_), .b(x3), .O(z8));
  nand3  g76(.a(x6), .b(x5), .c(x4), .O(new_n94_));
