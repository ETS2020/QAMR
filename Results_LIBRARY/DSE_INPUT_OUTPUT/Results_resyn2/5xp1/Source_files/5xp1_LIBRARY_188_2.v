...
module FAU ( 
  ...
  aoi21  g40(.a(new_n57_), .b(new_n42_), .c(new_n38_), .O(new_n58_));
  nand2  g41(.a(new_n38_), .b(new_n18_), .O(new_n59_));
  ...
  nand3  g48(.a(new_n65_), .b(new_n38_), .c(x0), .O(new_n66_));
  ...
  nand3  g53(.a(new_n70_), .b(new_n25_), .c(x1), .O(new_n71_));
  nand2  g54(.a(new_n70_), .b(x1), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(x6), .c(x2), .O(new_n73_));
  nand2  g56(.a(new_n44_), .b(new_n19_), .O(new_n74_));
  nand2  g57(.a(new_n56_), .b(new_n18_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(x1), .c(new_n25_), .O(new_n76_));
  aoi22  g59(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n71_), .O(z4));
  nand2  g60(.a(new_n70_), .b(x6), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(x2), .O(new_n79_));
  nand2  g62(.a(x3), .b(x1), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n28_), .c(x0), .O(new_n81_));
  nand2  g64(.a(new_n80_), .b(new_n28_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n20_), .c(new_n18_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(z5));
  nand2  g67(.a(x3), .b(new_n28_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(x1), .c(new_n29_), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(x1), .c(new_n86_), .O(z6));
  oai21  g70(.a(new_n25_), .b(new_n56_), .c(x2), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n85_), .O(z7));
  nand2  g72(.a(new_n30_), .b(x3), .O(z8));
  aoi21  g73(.a(new_n28_), .b(x0), .c(x6), .O(new_n91_));
  nor3   g74(.a(new_n91_), .b(new_n38_), .c(new_n23_), .O(z9));
endmodule
