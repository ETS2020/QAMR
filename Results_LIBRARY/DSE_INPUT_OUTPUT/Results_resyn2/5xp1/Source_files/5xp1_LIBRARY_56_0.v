...
module FAU ( 
  ...
  oai21  g43(.a(new_n60_), .b(new_n21_), .c(new_n23_), .O(new_n61_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n23_), .c(x6), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n62_), .c(x1), .O(new_n68_));
  nand2  g51(.a(new_n26_), .b(new_n19_), .O(new_n69_));
  oai21  g52(.a(x3), .b(x0), .c(x2), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n26_), .c(x1), .O(new_n71_));
  oai21  g54(.a(new_n70_), .b(new_n26_), .c(new_n71_), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n69_), .c(new_n68_), .O(z4));
  nor2   g56(.a(x2), .b(x1), .O(new_n74_));
  nand2  g57(.a(new_n65_), .b(new_n23_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n74_), .c(x0), .O(new_n76_));
  nor2   g59(.a(new_n75_), .b(new_n74_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n21_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n76_), .c(new_n69_), .O(z5));
  nand2  g62(.a(x3), .b(new_n63_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n22_), .c(new_n69_), .O(new_n81_));
  aoi21  g64(.a(new_n80_), .b(new_n22_), .c(new_n81_), .O(z6));
  nand2  g65(.a(new_n75_), .b(new_n69_), .O(z7));
  nand2  g66(.a(new_n69_), .b(x3), .O(z8));
