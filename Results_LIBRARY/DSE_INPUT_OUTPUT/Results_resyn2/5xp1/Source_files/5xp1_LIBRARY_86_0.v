...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n85_, new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n96_;
  ...
  nand2  g39(.a(new_n32_), .b(new_n18_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x0), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n23_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n31_), .c(new_n26_), .O(new_n60_));
  nand4  g43(.a(new_n60_), .b(new_n56_), .c(new_n51_), .d(new_n47_), .O(z2));
  ...
  oai21  g47(.a(new_n34_), .b(new_n18_), .c(x0), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n64_), .c(x5), .O(new_n66_));
  nand2  g49(.a(x6), .b(x2), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n47_), .c(new_n18_), .O(new_n68_));
  nor2   g51(.a(x3), .b(x2), .O(new_n69_));
  nor2   g52(.a(x6), .b(new_n22_), .O(new_n70_));
  ...
  nor2   g57(.a(new_n33_), .b(new_n32_), .O(new_n75_));
  oai21  g58(.a(new_n52_), .b(x0), .c(new_n23_), .O(new_n76_));
  ...
  nand3  g69(.a(new_n57_), .b(new_n53_), .c(new_n19_), .O(new_n87_));
  nand2  g70(.a(new_n53_), .b(new_n19_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n58_), .c(new_n47_), .O(new_n89_));
  aoi21  g72(.a(new_n87_), .b(new_n41_), .c(new_n89_), .O(z5));
  nand3  g73(.a(x3), .b(new_n32_), .c(new_n18_), .O(new_n91_));
  oai21  g74(.a(new_n52_), .b(x2), .c(x1), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n91_), .c(new_n47_), .O(z6));
  nand2  g76(.a(new_n88_), .b(new_n47_), .O(z7));
