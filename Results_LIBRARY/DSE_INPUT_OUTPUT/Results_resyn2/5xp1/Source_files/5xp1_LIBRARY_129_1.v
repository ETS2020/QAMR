...
module FAU ( 
  ...
  nand2  g53(.a(new_n64_), .b(new_n50_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n28_), .c(x1), .O(new_n72_));
  aoi21  g55(.a(new_n28_), .b(x1), .c(new_n48_), .O(new_n73_));
  oai21  g56(.a(x3), .b(x0), .c(new_n73_), .O(new_n74_));
  oai21  g57(.a(new_n49_), .b(new_n21_), .c(x1), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(x6), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(z4));
  nand2  g60(.a(new_n49_), .b(x2), .O(new_n78_));
  nand3  g61(.a(x3), .b(new_n48_), .c(x1), .O(new_n79_));
  ...
  nand3  g65(.a(new_n82_), .b(new_n80_), .c(new_n31_), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(z5));
  inv1   g67(.a(new_n79_), .O(new_n85_));
  aoi21  g68(.a(x3), .b(new_n48_), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n85_), .c(new_n31_), .O(z6));
  nand3  g70(.a(new_n50_), .b(new_n31_), .c(new_n66_), .O(new_n88_));
