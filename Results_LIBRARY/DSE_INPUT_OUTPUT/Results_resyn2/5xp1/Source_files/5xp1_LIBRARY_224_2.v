...
module FAU ( 
  ...
  oai21  g41(.a(new_n58_), .b(new_n51_), .c(new_n22_), .O(new_n59_));
  ...
  oai21  g54(.a(x5), .b(x3), .c(new_n19_), .O(new_n72_));
  nand2  g55(.a(x6), .b(new_n23_), .O(new_n73_));
  aoi21  g56(.a(x6), .b(new_n28_), .c(new_n51_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand3  g58(.a(new_n68_), .b(new_n49_), .c(new_n48_), .O(new_n76_));
  nand4  g59(.a(new_n76_), .b(new_n75_), .c(new_n71_), .d(new_n67_), .O(z3));
  nand3  g60(.a(new_n48_), .b(x6), .c(new_n23_), .O(new_n78_));
  nand2  g61(.a(x3), .b(x0), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n48_), .c(x6), .O(new_n80_));
  nand2  g63(.a(new_n79_), .b(new_n31_), .O(new_n81_));
