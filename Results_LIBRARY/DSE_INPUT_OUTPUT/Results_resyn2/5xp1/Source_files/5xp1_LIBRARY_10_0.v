...
module FAU ( 
  ...
  oai21  g47(.a(new_n64_), .b(new_n21_), .c(new_n23_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n19_), .O(new_n66_));
  inv1   g49(.a(x2), .O(new_n67_));
  nand2  g50(.a(new_n56_), .b(new_n67_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x0), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n23_), .c(x6), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(new_n66_), .c(x1), .O(new_n71_));
  nand2  g54(.a(new_n19_), .b(new_n18_), .O(new_n72_));
  oai21  g55(.a(x3), .b(x0), .c(x2), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n19_), .c(x1), .O(new_n74_));
  oai21  g57(.a(new_n73_), .b(new_n19_), .c(new_n74_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n72_), .c(new_n71_), .O(z4));
  nor2   g59(.a(x2), .b(x1), .O(new_n77_));
  nand2  g60(.a(new_n68_), .b(new_n23_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n77_), .c(x0), .O(new_n79_));
  nor2   g62(.a(new_n78_), .b(new_n77_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n21_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(new_n72_), .O(z5));
  nand2  g65(.a(x3), .b(new_n67_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n22_), .c(new_n72_), .O(new_n84_));
  aoi21  g67(.a(new_n83_), .b(new_n22_), .c(new_n84_), .O(z6));
  nand2  g68(.a(new_n78_), .b(new_n72_), .O(z7));
  aoi21  g69(.a(new_n19_), .b(new_n18_), .c(x3), .O(z8));
  aoi21  g70(.a(new_n28_), .b(x5), .c(new_n34_), .O(z9));
endmodule
