...
module FAU ( 
  ...
  nand3  g37(.a(new_n35_), .b(new_n23_), .c(new_n18_), .O(new_n55_));
  inv1   g38(.a(new_n39_), .O(new_n56_));
  nand2  g39(.a(new_n42_), .b(new_n56_), .O(new_n57_));
  nor2   g40(.a(new_n18_), .b(new_n45_), .O(new_n58_));
  ...
  oai21  g46(.a(new_n63_), .b(new_n44_), .c(new_n38_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n18_), .O(new_n65_));
  aoi21  g48(.a(new_n58_), .b(new_n52_), .c(x1), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n42_), .c(new_n56_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n65_), .c(new_n61_), .O(z3));
  nand3  g51(.a(new_n35_), .b(new_n23_), .c(new_n18_), .O(new_n69_));
  inv1   g52(.a(new_n69_), .O(new_n70_));
  aoi21  g53(.a(new_n35_), .b(new_n23_), .c(new_n18_), .O(new_n71_));
  ...
  oai21  g60(.a(new_n77_), .b(new_n28_), .c(x0), .O(new_n78_));
  nor2   g61(.a(new_n77_), .b(new_n28_), .O(new_n79_));
  ...
  oai21  g65(.a(new_n82_), .b(new_n22_), .c(new_n74_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n22_), .c(new_n83_), .O(z6));
  aoi21  g67(.a(new_n18_), .b(x4), .c(new_n77_), .O(z7));
  nand2  g68(.a(new_n74_), .b(x3), .O(z8));
  nor2   g69(.a(new_n30_), .b(new_n38_), .O(z9));
endmodule
