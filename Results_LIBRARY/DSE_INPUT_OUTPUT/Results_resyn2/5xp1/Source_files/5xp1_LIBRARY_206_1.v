...
module FAU ( 
  ...
  oai21  g60(.a(new_n60_), .b(new_n18_), .c(new_n37_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n19_), .c(new_n46_), .O(new_n79_));
  nand2  g62(.a(new_n78_), .b(new_n19_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x0), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(new_n25_), .O(z5));
  nand2  g65(.a(x3), .b(new_n37_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n18_), .c(new_n25_), .O(new_n84_));
  aoi21  g67(.a(new_n83_), .b(new_n18_), .c(new_n84_), .O(z6));
  nand2  g68(.a(new_n60_), .b(new_n37_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n25_), .c(new_n19_), .O(new_n87_));
  inv1   g70(.a(new_n87_), .O(z7));
  nand2  g71(.a(new_n25_), .b(x3), .O(z8));
  inv1   g72(.a(new_n31_), .O(z9));
endmodule
