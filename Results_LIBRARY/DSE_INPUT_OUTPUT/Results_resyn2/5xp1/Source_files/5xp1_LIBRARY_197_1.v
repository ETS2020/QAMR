...
module FAU ( 
  ...
  aoi22  g50(.a(new_n28_), .b(new_n34_), .c(x6), .d(x4), .O(new_n68_));
  nand3  g51(.a(new_n28_), .b(new_n34_), .c(x6), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x1), .O(new_n70_));
  nand2  g53(.a(x6), .b(x4), .O(new_n71_));
  and2   g54(.a(new_n71_), .b(new_n42_), .O(new_n72_));
  oai21  g55(.a(new_n42_), .b(new_n20_), .c(new_n27_), .O(new_n73_));
  ...
  oai21  g69(.a(new_n35_), .b(new_n59_), .c(new_n75_), .O(z7));
  nor2   g70(.a(new_n63_), .b(x3), .O(z8));
  nand2  g71(.a(new_n26_), .b(x5), .O(new_n89_));
  nand2  g72(.a(new_n75_), .b(new_n89_), .O(z9));
endmodule
