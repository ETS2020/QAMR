...
module FAU ( 
  ...
  oai21  g63(.a(new_n75_), .b(new_n18_), .c(new_n34_), .O(new_n81_));
  nand3  g64(.a(x3), .b(x1), .c(x0), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(new_n30_), .O(new_n83_));
  oai21  g66(.a(x3), .b(new_n30_), .c(x6), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n34_), .O(new_n85_));
  nand3  g68(.a(x3), .b(x2), .c(x0), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(z5));
  inv1   g70(.a(new_n24_), .O(new_n88_));
  nand3  g71(.a(x3), .b(new_n30_), .c(x1), .O(new_n89_));
  oai21  g72(.a(new_n75_), .b(x2), .c(new_n18_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  inv1   g74(.a(new_n91_), .O(z6));
  nand3  g75(.a(new_n76_), .b(new_n88_), .c(new_n35_), .O(new_n93_));
  inv1   g76(.a(new_n93_), .O(z7));
  nand2  g77(.a(new_n88_), .b(x3), .O(z8));
  oai21  g78(.a(new_n21_), .b(new_n46_), .c(new_n88_), .O(z9));
endmodule
