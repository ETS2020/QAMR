...
module FAU ( 
  ...
  nand3  g48(.a(new_n28_), .b(new_n57_), .c(x6), .O(new_n66_));
  nand2  g49(.a(new_n28_), .b(new_n57_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n18_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n66_), .c(x1), .O(new_n69_));
  nand2  g52(.a(new_n47_), .b(new_n21_), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(x6), .c(x2), .O(new_n71_));
  oai21  g54(.a(x3), .b(x0), .c(x2), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n18_), .c(x1), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n71_), .c(new_n19_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n69_), .O(z4));
  inv1   g58(.a(new_n19_), .O(new_n76_));
  nand2  g59(.a(new_n47_), .b(x2), .O(new_n77_));
  nand3  g60(.a(x3), .b(new_n49_), .c(x1), .O(new_n78_));
  ...
  aoi21  g67(.a(x3), .b(new_n49_), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(new_n76_), .O(z6));
  nor2   g69(.a(x3), .b(x2), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n58_), .c(new_n76_), .O(z7));
  nand2  g71(.a(new_n76_), .b(x3), .O(z8));
  inv1   g72(.a(new_n23_), .O(new_n90_));
  nor2   g73(.a(new_n31_), .b(new_n90_), .O(z9));
endmodule
