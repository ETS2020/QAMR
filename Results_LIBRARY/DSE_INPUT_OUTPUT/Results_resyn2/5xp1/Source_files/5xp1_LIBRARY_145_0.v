...
module FAU ( 
  ...
  nor2   g20(.a(x6), .b(new_n31_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n18_), .O(new_n39_));
  nor2   g22(.a(x4), .b(new_n18_), .O(new_n40_));
  oai21  g23(.a(new_n26_), .b(new_n31_), .c(new_n19_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(new_n42_));
  nor2   g25(.a(new_n30_), .b(x0), .O(new_n43_));
  ...
  aoi21  g58(.a(new_n75_), .b(new_n26_), .c(new_n52_), .O(new_n76_));
  ...
  nand3  g62(.a(new_n54_), .b(new_n51_), .c(new_n26_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  aoi21  g64(.a(new_n47_), .b(new_n26_), .c(x1), .O(new_n82_));
  ...
  nand3  g77(.a(new_n37_), .b(new_n54_), .c(new_n19_), .O(new_n95_));
  inv1   g78(.a(new_n95_), .O(z7));
  aoi21  g79(.a(new_n26_), .b(new_n31_), .c(x3), .O(z8));
  aoi21  g80(.a(new_n22_), .b(x4), .c(new_n27_), .O(z9));
endmodule
