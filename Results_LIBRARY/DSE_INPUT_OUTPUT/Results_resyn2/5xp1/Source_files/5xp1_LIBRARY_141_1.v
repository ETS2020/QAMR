...
module FAU ( 
  ...
  aoi22  g50(.a(new_n27_), .b(new_n59_), .c(x6), .d(x4), .O(new_n68_));
  nand3  g51(.a(new_n27_), .b(new_n59_), .c(x6), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x1), .O(new_n70_));
  nand2  g53(.a(x6), .b(x4), .O(new_n71_));
  oai21  g54(.a(x3), .b(x0), .c(x2), .O(new_n72_));
  and2   g55(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  oai21  g56(.a(new_n72_), .b(new_n20_), .c(new_n48_), .O(new_n74_));
  oai22  g57(.a(new_n74_), .b(new_n73_), .c(new_n70_), .d(new_n68_), .O(z4));
  inv1   g58(.a(new_n23_), .O(new_n76_));
  nand2  g59(.a(new_n49_), .b(x2), .O(new_n77_));
  nand3  g60(.a(x3), .b(new_n51_), .c(x1), .O(new_n78_));
  ...
  aoi21  g67(.a(x3), .b(new_n51_), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(new_n76_), .O(z6));
  nand2  g69(.a(new_n49_), .b(new_n51_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n76_), .c(new_n59_), .O(new_n88_));
