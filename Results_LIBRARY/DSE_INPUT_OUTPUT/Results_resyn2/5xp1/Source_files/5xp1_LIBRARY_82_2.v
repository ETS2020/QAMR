...
module FAU ( 
  ...
  nand3  g71(.a(x3), .b(new_n38_), .c(new_n20_), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(z6));
  nand2  g73(.a(new_n83_), .b(new_n54_), .O(z7));
  nor2   g74(.a(new_n87_), .b(x3), .O(z8));
