...
module FAU ( 
  ...
  nand2  g32(.a(new_n34_), .b(x1), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n49_), .c(new_n37_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n19_), .c(new_n18_), .O(new_n52_));
  ...
  nand2  g39(.a(new_n37_), .b(new_n34_), .O(new_n57_));
  nand2  g40(.a(new_n55_), .b(new_n20_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  aoi21  g42(.a(new_n54_), .b(x6), .c(x1), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n37_), .c(new_n34_), .O(new_n61_));
  nand2  g44(.a(new_n21_), .b(x5), .O(new_n62_));
  nor2   g45(.a(x3), .b(x2), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n28_), .c(x0), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n62_), .c(new_n18_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n19_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n61_), .c(new_n59_), .O(z3));
  xor2a  g50(.a(new_n49_), .b(x6), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x1), .O(new_n69_));
  oai21  g52(.a(new_n54_), .b(x6), .c(new_n60_), .O(new_n70_));
  ...
  nand4  g57(.a(new_n48_), .b(new_n74_), .c(new_n44_), .d(x0), .O(new_n75_));
  nand2  g58(.a(new_n48_), .b(new_n44_), .O(new_n76_));
  ...
  nand3  g62(.a(x3), .b(new_n46_), .c(new_n20_), .O(new_n80_));
  oai21  g63(.a(new_n47_), .b(x2), .c(x1), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(new_n71_), .O(z6));
  nand2  g65(.a(new_n76_), .b(new_n71_), .O(z7));
  aoi21  g66(.a(new_n19_), .b(x4), .c(x3), .O(z8));
