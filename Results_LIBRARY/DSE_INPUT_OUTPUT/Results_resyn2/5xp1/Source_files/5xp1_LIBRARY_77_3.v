...
module FAU ( 
  ...
  oai21  g52(.a(new_n54_), .b(new_n69_), .c(new_n49_), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n61_), .c(new_n36_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n68_), .c(new_n64_), .O(z3));
  aoi21  g55(.a(new_n55_), .b(new_n18_), .c(x1), .O(new_n73_));
  oai21  g56(.a(new_n55_), .b(new_n18_), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n69_), .b(new_n38_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n47_), .c(x6), .O(new_n76_));
  nand3  g59(.a(new_n44_), .b(new_n25_), .c(new_n18_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(x1), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n74_), .c(new_n37_), .O(z4));
  oai21  g63(.a(new_n69_), .b(new_n24_), .c(new_n38_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(x0), .O(new_n83_));
  nand3  g66(.a(new_n81_), .b(new_n25_), .c(new_n20_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n83_), .c(new_n37_), .O(z5));
  nand2  g68(.a(x3), .b(new_n38_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n24_), .c(new_n37_), .O(new_n87_));
  aoi21  g70(.a(new_n86_), .b(new_n24_), .c(new_n87_), .O(z6));
  nand2  g71(.a(new_n75_), .b(new_n25_), .O(new_n89_));
