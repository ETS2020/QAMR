...
module FAU ( 
  ...
  nand2  g52(.a(x6), .b(x3), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n28_), .c(new_n18_), .O(new_n71_));
  oai21  g54(.a(new_n56_), .b(new_n18_), .c(new_n25_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n20_), .O(new_n73_));
  oai21  g56(.a(new_n73_), .b(new_n71_), .c(x1), .O(new_n74_));
  nor2   g57(.a(new_n25_), .b(x1), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n44_), .c(new_n29_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n74_), .O(z4));
  oai21  g60(.a(new_n56_), .b(new_n19_), .c(new_n28_), .O(new_n78_));
  nand3  g61(.a(x6), .b(x3), .c(x2), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x0), .O(new_n81_));
  nand2  g64(.a(new_n25_), .b(new_n56_), .O(new_n82_));
  nand4  g65(.a(new_n78_), .b(new_n82_), .c(new_n20_), .d(new_n18_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n81_), .O(z5));
  nand3  g67(.a(x3), .b(new_n28_), .c(new_n19_), .O(new_n85_));
  oai21  g68(.a(new_n56_), .b(x2), .c(x1), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n85_), .c(new_n30_), .O(z6));
  inv1   g70(.a(new_n79_), .O(new_n88_));
  aoi21  g71(.a(new_n56_), .b(new_n28_), .c(new_n88_), .O(z7));
  nor2   g72(.a(new_n29_), .b(x3), .O(z8));
  nand3  g73(.a(new_n26_), .b(x5), .c(x4), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n30_), .O(z9));
endmodule
