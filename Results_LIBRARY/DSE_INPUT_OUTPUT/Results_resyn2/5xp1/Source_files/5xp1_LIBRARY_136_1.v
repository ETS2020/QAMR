...
module FAU ( 
  ...
  aoi21  g14(.a(new_n29_), .b(x0), .c(new_n31_), .O(new_n32_));
  nand2  g15(.a(new_n19_), .b(x0), .O(new_n33_));
  aoi21  g16(.a(new_n33_), .b(x1), .c(new_n30_), .O(new_n34_));
  aoi21  g17(.a(new_n20_), .b(new_n30_), .c(new_n34_), .O(new_n35_));
  oai21  g18(.a(new_n32_), .b(new_n26_), .c(new_n35_), .O(z1));
  ...
  nand2  g26(.a(new_n40_), .b(new_n39_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x1), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n37_), .c(new_n43_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n30_), .O(new_n47_));
  nand2  g30(.a(new_n19_), .b(new_n22_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n43_), .O(new_n49_));
  nand3  g32(.a(new_n19_), .b(x4), .c(new_n22_), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(new_n49_), .c(x6), .d(x1), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n47_), .O(z2));
  nand2  g35(.a(x3), .b(x2), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n18_), .c(new_n22_), .O(new_n54_));
  oai22  g37(.a(new_n54_), .b(new_n19_), .c(new_n33_), .d(new_n29_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n30_), .O(new_n56_));
  nor2   g39(.a(new_n48_), .b(new_n23_), .O(new_n57_));
  nor2   g40(.a(x3), .b(x2), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n30_), .c(new_n37_), .O(new_n59_));
  ...
  aoi21  g46(.a(new_n63_), .b(x2), .c(x1), .O(new_n64_));
  aoi21  g47(.a(new_n53_), .b(new_n22_), .c(new_n28_), .O(new_n65_));
  xor2a  g48(.a(new_n65_), .b(x6), .O(new_n66_));
  nor2   g49(.a(new_n66_), .b(new_n64_), .O(z4));
  inv1   g50(.a(new_n58_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n53_), .O(new_n69_));
  ...
  oai21  g56(.a(new_n70_), .b(new_n69_), .c(x0), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z5));
  nor2   g58(.a(new_n62_), .b(x2), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n30_), .c(new_n18_), .O(new_n77_));
  oai21  g60(.a(new_n76_), .b(new_n18_), .c(new_n77_), .O(z6));
  nand2  g61(.a(new_n73_), .b(new_n69_), .O(z7));
  nand2  g62(.a(new_n73_), .b(x3), .O(z8));
  nor2   g63(.a(new_n19_), .b(new_n43_), .O(new_n81_));
  oai21  g64(.a(new_n54_), .b(x6), .c(new_n81_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n73_), .O(z9));
endmodule
