...
module FAU ( 
  ...
  nand4  g25(.a(new_n42_), .b(new_n35_), .c(new_n39_), .d(new_n37_), .O(new_n43_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n48_), .c(x6), .O(new_n52_));
  nor2   g35(.a(x5), .b(x0), .O(new_n53_));
  nor2   g36(.a(new_n53_), .b(new_n19_), .O(new_n54_));
  aoi21  g37(.a(new_n27_), .b(new_n40_), .c(new_n20_), .O(new_n55_));
  aoi22  g38(.a(new_n55_), .b(new_n54_), .c(new_n50_), .d(new_n37_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n52_), .c(new_n45_), .O(z2));
  nand2  g40(.a(new_n49_), .b(new_n35_), .O(new_n58_));
  aoi21  g41(.a(new_n46_), .b(new_n18_), .c(new_n37_), .O(new_n59_));
  nand2  g42(.a(x3), .b(x0), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n46_), .c(new_n18_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n59_), .c(new_n58_), .O(new_n62_));
  nand2  g45(.a(new_n20_), .b(x5), .O(new_n63_));
  nand4  g46(.a(new_n27_), .b(new_n41_), .c(new_n40_), .d(x0), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n63_), .c(new_n19_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n37_), .O(new_n66_));
  nand2  g49(.a(new_n41_), .b(new_n34_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(x6), .c(x2), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n49_), .c(new_n35_), .d(new_n18_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n66_), .c(new_n62_), .O(z3));
  nor2   g53(.a(x6), .b(x4), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n60_), .c(new_n46_), .O(new_n72_));
  nand3  g55(.a(new_n42_), .b(new_n39_), .c(x6), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x1), .O(new_n75_));
  aoi21  g58(.a(new_n46_), .b(new_n37_), .c(x1), .O(new_n76_));
  oai21  g59(.a(new_n71_), .b(new_n46_), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n75_), .O(z4));
  inv1   g61(.a(new_n28_), .O(new_n79_));
  nand2  g62(.a(new_n42_), .b(new_n38_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n29_), .c(x0), .O(new_n81_));
  nor2   g64(.a(new_n80_), .b(new_n29_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n34_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(z5));
  nand3  g67(.a(x3), .b(new_n40_), .c(new_n18_), .O(new_n85_));
  oai21  g68(.a(new_n41_), .b(x2), .c(x1), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(z6));
  nand2  g70(.a(new_n80_), .b(new_n79_), .O(z7));
  nor2   g71(.a(new_n28_), .b(x3), .O(z8));
