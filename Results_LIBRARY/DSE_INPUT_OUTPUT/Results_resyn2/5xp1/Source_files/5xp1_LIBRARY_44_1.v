...
module FAU ( 
  ...
  nor2   g49(.a(new_n66_), .b(new_n58_), .O(new_n67_));
  nor2   g50(.a(new_n34_), .b(new_n18_), .O(new_n68_));
  oai21  g51(.a(new_n68_), .b(new_n67_), .c(x0), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n67_), .c(x6), .O(new_n70_));
  nand3  g53(.a(new_n29_), .b(new_n58_), .c(new_n19_), .O(new_n71_));
  nand4  g54(.a(new_n71_), .b(new_n69_), .c(new_n42_), .d(new_n22_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n70_), .O(z4));
  aoi21  g56(.a(x3), .b(x1), .c(x2), .O(new_n74_));
  nor2   g57(.a(new_n74_), .b(new_n50_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n18_), .c(new_n19_), .O(new_n76_));
  oai21  g59(.a(new_n75_), .b(new_n19_), .c(new_n76_), .O(z5));
  nand3  g60(.a(x3), .b(new_n28_), .c(new_n58_), .O(new_n78_));
  nor2   g61(.a(new_n18_), .b(x0), .O(new_n79_));
  inv1   g62(.a(new_n79_), .O(new_n80_));
  oai21  g63(.a(new_n29_), .b(x2), .c(x1), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(new_n78_), .O(z6));
  nor3   g65(.a(new_n79_), .b(new_n66_), .c(new_n50_), .O(z7));
  nand2  g66(.a(new_n80_), .b(x3), .O(z8));
  inv1   g67(.a(new_n22_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n18_), .c(x0), .O(new_n86_));
  nor3   g69(.a(new_n86_), .b(new_n27_), .c(new_n20_), .O(z9));
endmodule
