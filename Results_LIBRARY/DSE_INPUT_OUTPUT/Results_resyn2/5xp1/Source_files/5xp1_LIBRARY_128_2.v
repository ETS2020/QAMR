...
module FAU ( 
  ...
  oai21  g55(.a(new_n29_), .b(new_n20_), .c(new_n23_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n67_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n72_), .c(new_n40_), .O(new_n75_));
  oai21  g58(.a(new_n68_), .b(new_n61_), .c(new_n75_), .O(z3));
  aoi21  g59(.a(new_n21_), .b(new_n19_), .c(new_n29_), .O(new_n77_));
  nor2   g60(.a(x6), .b(x5), .O(new_n78_));
  nor2   g61(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g62(.a(new_n77_), .b(new_n23_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  oai21  g64(.a(x3), .b(x0), .c(x2), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n23_), .c(x1), .O(new_n83_));
  oai21  g66(.a(new_n82_), .b(new_n78_), .c(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n81_), .b(new_n79_), .c(new_n84_), .O(z4));
  xnor2a g68(.a(x3), .b(x2), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(new_n31_), .O(new_n87_));
  nor2   g70(.a(x6), .b(new_n40_), .O(new_n88_));
  aoi21  g71(.a(new_n87_), .b(new_n19_), .c(new_n88_), .O(new_n89_));
  oai21  g72(.a(new_n87_), .b(new_n19_), .c(new_n89_), .O(z5));
  nand2  g73(.a(x3), .b(new_n45_), .O(new_n91_));
  oai22  g74(.a(new_n91_), .b(new_n20_), .c(x6), .d(new_n40_), .O(new_n92_));
  aoi21  g75(.a(new_n91_), .b(new_n20_), .c(new_n92_), .O(z6));
  nor2   g76(.a(new_n88_), .b(new_n86_), .O(z7));
  nor2   g77(.a(new_n88_), .b(x3), .O(z8));
