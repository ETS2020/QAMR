...
module FAU ( 
  ...
  oai21  g61(.a(new_n78_), .b(new_n76_), .c(new_n55_), .O(new_n79_));
  inv1   g62(.a(new_n76_), .O(new_n80_));
  nand3  g63(.a(new_n77_), .b(new_n80_), .c(new_n21_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(x1), .O(new_n82_));
  nand2  g65(.a(new_n71_), .b(new_n55_), .O(new_n83_));
  aoi21  g66(.a(new_n70_), .b(new_n21_), .c(x1), .O(new_n84_));
  ...
  oai21  g71(.a(new_n88_), .b(new_n56_), .c(new_n87_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n57_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(x0), .O(new_n91_));
  aoi21  g74(.a(new_n89_), .b(new_n78_), .c(new_n27_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n91_), .O(z5));
  nand3  g76(.a(x3), .b(new_n87_), .c(new_n56_), .O(new_n94_));
  oai21  g77(.a(new_n88_), .b(x2), .c(x1), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n30_), .O(z6));
  nand3  g79(.a(new_n80_), .b(new_n30_), .c(new_n57_), .O(new_n97_));
  inv1   g80(.a(new_n97_), .O(z7));
  nor2   g81(.a(new_n27_), .b(x3), .O(z8));
  nand3  g82(.a(new_n23_), .b(x5), .c(x4), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n30_), .O(z9));
endmodule
