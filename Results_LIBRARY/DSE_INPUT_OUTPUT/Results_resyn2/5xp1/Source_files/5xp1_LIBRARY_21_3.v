...
module FAU ( 
  ...
  oai21  g11(.a(new_n24_), .b(new_n27_), .c(new_n28_), .O(new_n29_));
  ...
  aoi22  g18(.a(new_n35_), .b(new_n32_), .c(new_n29_), .d(x5), .O(z1));
  ...
  oai21  g23(.a(new_n19_), .b(new_n40_), .c(new_n20_), .O(new_n41_));
  nand2  g24(.a(x5), .b(x0), .O(new_n42_));
  aoi21  g25(.a(new_n42_), .b(new_n21_), .c(x6), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n41_), .c(new_n39_), .O(new_n44_));
  nand2  g27(.a(new_n33_), .b(x6), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(x4), .O(new_n46_));
  nand2  g29(.a(new_n40_), .b(new_n37_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n28_), .c(x0), .O(new_n48_));
  inv1   g31(.a(new_n22_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x5), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n48_), .c(new_n21_), .O(new_n51_));
  nand2  g34(.a(new_n45_), .b(new_n42_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n51_), .c(new_n27_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n46_), .c(new_n18_), .O(z2));
  nand2  g37(.a(new_n31_), .b(x0), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n23_), .c(x5), .O(new_n56_));
  oai21  g39(.a(new_n31_), .b(new_n20_), .c(new_n19_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n56_), .c(new_n28_), .O(new_n58_));
  oai21  g41(.a(new_n49_), .b(x1), .c(x6), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n33_), .c(new_n19_), .O(new_n61_));
  ...
  nand3  g48(.a(new_n63_), .b(new_n47_), .c(new_n28_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n65_), .c(x1), .O(new_n67_));
  oai21  g50(.a(x3), .b(x0), .c(x2), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n28_), .c(x1), .O(new_n69_));
  oai21  g52(.a(new_n68_), .b(new_n28_), .c(new_n69_), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(new_n67_), .c(new_n18_), .O(z4));
  oai21  g54(.a(new_n40_), .b(new_n21_), .c(new_n37_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n22_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(x0), .O(new_n74_));
  nand3  g57(.a(new_n72_), .b(new_n22_), .c(new_n20_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n74_), .c(new_n18_), .O(z5));
  nand3  g59(.a(x3), .b(new_n37_), .c(new_n21_), .O(new_n77_));
  oai21  g60(.a(new_n40_), .b(x2), .c(x1), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n77_), .c(new_n18_), .O(z6));
  nand2  g62(.a(new_n22_), .b(new_n18_), .O(new_n80_));
  nor2   g63(.a(new_n80_), .b(new_n30_), .O(z7));
  nand2  g64(.a(new_n18_), .b(x3), .O(z8));
  nand4  g65(.a(new_n23_), .b(new_n28_), .c(x5), .d(x4), .O(new_n83_));
