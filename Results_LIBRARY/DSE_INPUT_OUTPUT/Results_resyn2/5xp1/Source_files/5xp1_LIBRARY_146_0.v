...
module FAU ( 
  ...
  nand2  g57(.a(new_n26_), .b(x4), .O(new_n75_));
  nand2  g58(.a(new_n19_), .b(new_n24_), .O(new_n76_));
  ...
  nand2  g63(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  nand3  g64(.a(new_n79_), .b(new_n76_), .c(new_n26_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(x1), .O(new_n83_));
  nand2  g66(.a(new_n71_), .b(new_n75_), .O(new_n84_));
  aoi21  g67(.a(new_n70_), .b(new_n26_), .c(x1), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n83_), .O(z4));
  nand2  g70(.a(new_n79_), .b(new_n19_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n51_), .c(x0), .O(new_n89_));
  nand4  g72(.a(new_n79_), .b(new_n52_), .c(new_n19_), .d(new_n24_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z5));
  nand2  g74(.a(x3), .b(new_n77_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n18_), .c(new_n43_), .O(new_n93_));
  aoi21  g76(.a(new_n92_), .b(new_n18_), .c(new_n93_), .O(z6));
  aoi21  g77(.a(new_n26_), .b(new_n31_), .c(new_n88_), .O(z7));
  nand2  g78(.a(new_n43_), .b(x3), .O(z8));
