...
module FAU ( 
  ...
  nor2   g56(.a(x6), .b(x5), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  nand2  g58(.a(new_n72_), .b(new_n70_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(x0), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(new_n78_));
  inv1   g61(.a(new_n78_), .O(z5));
  nand2  g62(.a(x3), .b(new_n71_), .O(new_n80_));
  nand2  g63(.a(new_n75_), .b(new_n72_), .O(new_n81_));
  aoi21  g64(.a(new_n80_), .b(new_n22_), .c(new_n81_), .O(z6));
  aoi21  g65(.a(new_n80_), .b(new_n70_), .c(new_n74_), .O(z7));
  nor2   g66(.a(new_n74_), .b(x3), .O(z8));
