...
module FAU ( 
  ...
  aoi21  g09(.a(new_n26_), .b(new_n20_), .c(new_n24_), .O(z9));
  ...
  aoi21  g16(.a(new_n33_), .b(x6), .c(x5), .O(new_n34_));
  aoi21  g17(.a(new_n34_), .b(new_n31_), .c(z9), .O(z1));
  nand3  g18(.a(new_n30_), .b(x1), .c(x0), .O(new_n36_));
  nand2  g19(.a(new_n25_), .b(x5), .O(new_n37_));
  aoi21  g20(.a(new_n37_), .b(new_n36_), .c(new_n18_), .O(new_n38_));
  aoi21  g21(.a(new_n21_), .b(new_n19_), .c(new_n24_), .O(new_n39_));
  inv1   g22(.a(x1), .O(new_n40_));
  oai21  g23(.a(x3), .b(x2), .c(x0), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n40_), .c(new_n18_), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n39_), .c(new_n20_), .O(new_n43_));
  xor2a  g26(.a(new_n32_), .b(x4), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(x6), .c(new_n24_), .O(new_n45_));
  oai21  g28(.a(new_n43_), .b(new_n38_), .c(new_n45_), .O(z2));
  nand3  g29(.a(new_n24_), .b(x3), .c(x2), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n20_), .c(x0), .O(new_n48_));
  nor2   g31(.a(new_n41_), .b(new_n24_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n48_), .c(x1), .O(new_n50_));
  nand2  g33(.a(x5), .b(new_n19_), .O(new_n51_));
  nand3  g34(.a(new_n20_), .b(new_n24_), .c(x0), .O(new_n52_));
  ...
  oai21  g39(.a(new_n56_), .b(x0), .c(new_n24_), .O(new_n57_));
  nand3  g40(.a(new_n24_), .b(new_n40_), .c(x0), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n51_), .O(new_n59_));
  aoi22  g42(.a(new_n59_), .b(new_n28_), .c(new_n57_), .d(x6), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n55_), .c(new_n50_), .O(z3));
  nand3  g44(.a(new_n56_), .b(new_n41_), .c(x6), .O(new_n62_));
  ...
  aoi21  g50(.a(new_n67_), .b(new_n20_), .c(x1), .O(new_n68_));
  oai21  g51(.a(new_n67_), .b(new_n20_), .c(new_n68_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n66_), .c(new_n65_), .O(z4));
  ...
  aoi21  g57(.a(new_n73_), .b(x0), .c(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n73_), .b(x0), .c(new_n75_), .O(z5));
  nand3  g59(.a(x3), .b(new_n28_), .c(new_n40_), .O(new_n77_));
  oai21  g60(.a(new_n29_), .b(x2), .c(x1), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n77_), .c(new_n66_), .O(z6));
  nand2  g62(.a(new_n56_), .b(new_n30_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n66_), .O(z7));
  nor2   g64(.a(new_n74_), .b(x3), .O(z8));
endmodule
