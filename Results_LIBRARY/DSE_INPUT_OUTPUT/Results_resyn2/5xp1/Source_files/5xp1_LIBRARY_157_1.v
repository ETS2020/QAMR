...
module FAU ( 
  ...
  aoi22  g56(.a(x6), .b(new_n29_), .c(new_n21_), .d(new_n20_), .O(new_n74_));
  oai21  g57(.a(x5), .b(x1), .c(new_n19_), .O(new_n75_));
  aoi21  g58(.a(new_n29_), .b(x3), .c(x0), .O(new_n76_));
  nand2  g59(.a(new_n24_), .b(new_n20_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n39_), .O(new_n78_));
  oai22  g61(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(new_n79_));
  ...
  nor2   g69(.a(x6), .b(new_n20_), .O(new_n87_));
  oai21  g70(.a(x3), .b(x2), .c(x0), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  oai21  g72(.a(new_n85_), .b(new_n83_), .c(new_n89_), .O(z4));
  nor2   g73(.a(x3), .b(new_n31_), .O(new_n91_));
  nor2   g74(.a(new_n21_), .b(x2), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(new_n87_), .c(new_n91_), .O(new_n93_));
  nor2   g76(.a(new_n93_), .b(new_n19_), .O(new_n94_));
  nand2  g77(.a(new_n32_), .b(x0), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n93_), .c(new_n94_), .O(z5));
  oai21  g79(.a(x6), .b(x3), .c(new_n31_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(x1), .O(new_n98_));
  nand3  g81(.a(new_n92_), .b(new_n24_), .c(new_n20_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n98_), .O(z6));
  oai21  g83(.a(x3), .b(new_n31_), .c(new_n97_), .O(z7));
  nand2  g84(.a(new_n32_), .b(x3), .O(z8));
  nand3  g85(.a(new_n26_), .b(x5), .c(x4), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n32_), .O(z9));
endmodule
