...
module FAU ( 
  ...
  nand2  g77(.a(x3), .b(new_n50_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n49_), .c(new_n30_), .O(new_n96_));
  aoi21  g79(.a(new_n95_), .b(new_n49_), .c(new_n96_), .O(z6));
  nand2  g80(.a(new_n89_), .b(new_n57_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n30_), .O(z7));
  nor2   g82(.a(new_n27_), .b(x3), .O(z8));
  nand3  g83(.a(new_n23_), .b(x5), .c(x4), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n30_), .O(z9));
endmodule
