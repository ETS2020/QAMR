...
module FAU ( 
  ...
  nand2  g48(.a(new_n24_), .b(new_n27_), .O(new_n66_));
  nand4  g49(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n61_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n63_), .c(new_n55_), .O(z3));
  nor2   g51(.a(new_n24_), .b(new_n18_), .O(new_n69_));
  aoi21  g52(.a(new_n28_), .b(new_n47_), .c(new_n69_), .O(new_n70_));
  nand3  g53(.a(new_n28_), .b(new_n47_), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x1), .O(new_n72_));
  nor2   g55(.a(new_n64_), .b(new_n69_), .O(new_n73_));
  ...
  nand2  g59(.a(new_n57_), .b(x2), .O(new_n77_));
  nand3  g60(.a(x3), .b(new_n52_), .c(x1), .O(new_n78_));
  ...
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(new_n65_), .O(new_n82_));
  inv1   g65(.a(new_n82_), .O(z5));
  inv1   g66(.a(new_n78_), .O(new_n84_));
  aoi21  g67(.a(x3), .b(new_n52_), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(z6));
  inv1   g69(.a(new_n47_), .O(new_n87_));
  nor2   g70(.a(x3), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n87_), .c(new_n65_), .O(z7));
  aoi21  g72(.a(x6), .b(new_n18_), .c(x3), .O(z8));
  aoi22  g73(.a(new_n25_), .b(new_n24_), .c(new_n40_), .d(x4), .O(z9));
endmodule
