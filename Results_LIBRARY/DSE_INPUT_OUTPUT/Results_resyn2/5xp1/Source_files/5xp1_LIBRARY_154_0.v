...
module FAU ( 
  ...
  nand3  g07(.a(new_n19_), .b(new_n18_), .c(new_n24_), .O(new_n25_));
  ...
  inv1   g20(.a(new_n19_), .O(new_n38_));
  nor2   g21(.a(x6), .b(x1), .O(new_n39_));
  inv1   g22(.a(new_n39_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n38_), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n37_), .c(x5), .d(new_n24_), .O(new_n42_));
  nand2  g25(.a(new_n26_), .b(new_n31_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n42_), .c(new_n36_), .O(z1));
  nand2  g27(.a(new_n33_), .b(new_n30_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n32_), .c(new_n25_), .O(new_n46_));
  oai21  g29(.a(new_n39_), .b(new_n19_), .c(new_n37_), .O(new_n47_));
  oai21  g30(.a(new_n26_), .b(new_n31_), .c(new_n30_), .O(new_n48_));
  ...
  nand2  g36(.a(new_n34_), .b(new_n30_), .O(new_n54_));
  ...
  nand3  g40(.a(new_n34_), .b(new_n26_), .c(x4), .O(new_n58_));
  nand3  g41(.a(x6), .b(new_n51_), .c(new_n18_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n58_), .c(x0), .O(new_n60_));
  nand2  g43(.a(x6), .b(x1), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n24_), .c(x5), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  oai21  g46(.a(x6), .b(x3), .c(x1), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x0), .O(new_n65_));
  nand2  g48(.a(new_n61_), .b(new_n19_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n40_), .c(new_n24_), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n65_), .c(new_n43_), .d(x5), .O(new_n68_));
  oai21  g51(.a(new_n31_), .b(new_n18_), .c(new_n26_), .O(new_n69_));
  ...
  nand2  g57(.a(new_n19_), .b(new_n24_), .O(new_n75_));
  inv1   g58(.a(x3), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(new_n26_), .O(new_n78_));
  nand2  g61(.a(new_n77_), .b(new_n75_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x6), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n70_), .b(new_n26_), .c(x1), .O(new_n82_));
  oai21  g65(.a(new_n70_), .b(new_n26_), .c(new_n82_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n43_), .O(z4));
  nand4  g67(.a(new_n77_), .b(new_n52_), .c(new_n19_), .d(x0), .O(new_n85_));
  nand3  g68(.a(new_n77_), .b(new_n52_), .c(new_n19_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n24_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n43_), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(z5));
  nand2  g72(.a(x3), .b(new_n51_), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n18_), .c(new_n43_), .O(new_n91_));
  aoi21  g74(.a(new_n90_), .b(new_n18_), .c(new_n91_), .O(z6));
  nand2  g75(.a(new_n77_), .b(new_n19_), .O(new_n93_));
  aoi21  g76(.a(new_n26_), .b(new_n31_), .c(new_n93_), .O(z7));
  nand2  g77(.a(new_n43_), .b(x3), .O(z8));
