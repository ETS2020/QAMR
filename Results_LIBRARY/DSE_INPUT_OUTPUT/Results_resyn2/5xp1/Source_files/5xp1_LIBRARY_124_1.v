...
module FAU ( 
  ...
  nand2  g59(.a(new_n59_), .b(x2), .O(new_n77_));
  nand3  g60(.a(x3), .b(new_n37_), .c(x1), .O(new_n78_));
  ...
  nand2  g69(.a(new_n59_), .b(new_n37_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n22_), .c(new_n19_), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(z7));
  nand2  g72(.a(new_n19_), .b(x3), .O(z8));
  nand2  g73(.a(new_n29_), .b(x5), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n19_), .O(z9));
endmodule
