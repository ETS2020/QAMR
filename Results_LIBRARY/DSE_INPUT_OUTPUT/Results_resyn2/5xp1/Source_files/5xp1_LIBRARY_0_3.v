...
module FAU ( 
  ...
  nand2  g47(.a(new_n60_), .b(new_n19_), .O(new_n65_));
  aoi21  g48(.a(new_n65_), .b(new_n47_), .c(new_n26_), .O(new_n66_));
  nand2  g49(.a(x6), .b(new_n20_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n65_), .c(new_n47_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x1), .O(new_n69_));
  oai21  g52(.a(x3), .b(x0), .c(x2), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  or2    g54(.a(new_n70_), .b(new_n26_), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n71_), .c(new_n29_), .O(new_n73_));
  oai21  g56(.a(new_n69_), .b(new_n66_), .c(new_n73_), .O(z4));
  nor2   g57(.a(x2), .b(x1), .O(new_n75_));
  nand2  g58(.a(new_n47_), .b(new_n60_), .O(new_n76_));
  nor2   g59(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x0), .O(new_n78_));
  oai21  g61(.a(new_n76_), .b(new_n75_), .c(new_n19_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n78_), .c(new_n23_), .O(new_n80_));
  inv1   g63(.a(new_n80_), .O(z5));
  nand3  g64(.a(x3), .b(new_n25_), .c(new_n29_), .O(new_n82_));
  oai21  g65(.a(new_n39_), .b(x2), .c(x1), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n23_), .O(z6));
  nand2  g67(.a(new_n76_), .b(new_n23_), .O(z7));
  nand2  g68(.a(new_n23_), .b(x3), .O(z8));
  aoi21  g69(.a(new_n34_), .b(new_n26_), .c(new_n20_), .O(z9));
endmodule
