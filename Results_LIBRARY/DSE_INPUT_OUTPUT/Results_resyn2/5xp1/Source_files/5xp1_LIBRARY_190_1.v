...
module FAU ( 
  ...
  nor2   g50(.a(new_n38_), .b(x4), .O(new_n68_));
  ...
  aoi21  g70(.a(x3), .b(new_n42_), .c(x1), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n87_), .c(new_n69_), .O(z6));
  inv1   g72(.a(new_n51_), .O(new_n90_));
  nor2   g73(.a(x3), .b(x2), .O(new_n91_));
  nor3   g74(.a(new_n68_), .b(new_n91_), .c(new_n90_), .O(z7));
  nor2   g75(.a(new_n68_), .b(x3), .O(z8));
endmodule
