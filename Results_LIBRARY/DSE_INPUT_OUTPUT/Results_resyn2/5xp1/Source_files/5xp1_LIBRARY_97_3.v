...
module FAU ( 
  ...
  nand3  g33(.a(new_n50_), .b(new_n48_), .c(x4), .O(new_n51_));
  inv1   g34(.a(x3), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n35_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(x1), .c(x0), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n22_), .c(new_n31_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n51_), .c(new_n26_), .O(new_n56_));
  inv1   g39(.a(new_n36_), .O(new_n57_));
  aoi21  g40(.a(new_n52_), .b(new_n18_), .c(new_n35_), .O(new_n58_));
  ...
  nand3  g45(.a(new_n20_), .b(x5), .c(new_n19_), .O(new_n63_));
  nand3  g46(.a(x6), .b(new_n25_), .c(x1), .O(new_n64_));
  aoi21  g47(.a(new_n64_), .b(new_n63_), .c(x0), .O(new_n65_));
  aoi21  g48(.a(new_n25_), .b(new_n35_), .c(x1), .O(new_n66_));
  nand2  g49(.a(new_n26_), .b(x1), .O(new_n67_));
  nand2  g50(.a(new_n25_), .b(x1), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n67_), .c(x0), .O(new_n69_));
  nor2   g52(.a(new_n69_), .b(new_n66_), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(new_n65_), .c(new_n31_), .O(new_n71_));
  nand3  g54(.a(new_n25_), .b(new_n52_), .c(new_n35_), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n46_), .c(new_n18_), .O(new_n73_));
  xnor2a g56(.a(x5), .b(x0), .O(new_n74_));
  aoi21  g57(.a(new_n24_), .b(x1), .c(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(new_n26_), .O(new_n76_));
  nand2  g59(.a(new_n67_), .b(new_n36_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n74_), .c(new_n58_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n76_), .c(new_n71_), .O(z3));
  nand3  g62(.a(new_n53_), .b(new_n57_), .c(new_n24_), .O(new_n80_));
  nand2  g63(.a(new_n53_), .b(x0), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n20_), .c(new_n26_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x1), .O(new_n84_));
  aoi21  g67(.a(new_n58_), .b(x6), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n58_), .b(new_n57_), .c(new_n85_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n84_), .O(z4));
  oai21  g70(.a(new_n52_), .b(new_n19_), .c(new_n35_), .O(new_n88_));
  ...
  nand2  g78(.a(new_n53_), .b(new_n20_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n40_), .O(z7));
  nand2  g80(.a(new_n40_), .b(x3), .O(z8));
  aoi21  g81(.a(new_n22_), .b(new_n26_), .c(new_n31_), .O(z9));
endmodule
