...
module FAU ( 
  ...
  nor2   g55(.a(new_n71_), .b(new_n70_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n19_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n72_), .c(new_n52_), .O(z5));
  nand2  g58(.a(x3), .b(new_n25_), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(new_n41_), .c(new_n52_), .O(new_n77_));
  aoi21  g60(.a(new_n76_), .b(new_n41_), .c(new_n77_), .O(z6));
  inv1   g61(.a(new_n52_), .O(new_n79_));
  nor2   g62(.a(new_n71_), .b(new_n79_), .O(z7));
  nor2   g63(.a(new_n79_), .b(x3), .O(z8));
