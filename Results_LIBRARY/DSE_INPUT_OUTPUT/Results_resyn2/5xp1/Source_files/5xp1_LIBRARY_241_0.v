...
module FAU ( 
  ...
  xor2a  g49(.a(x6), .b(x2), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n66_), .c(new_n21_), .O(new_n68_));
  nor2   g51(.a(x3), .b(x2), .O(new_n69_));
  inv1   g52(.a(new_n69_), .O(new_n70_));
  aoi21  g53(.a(new_n65_), .b(new_n70_), .c(new_n28_), .O(new_n71_));
  oai21  g54(.a(new_n51_), .b(new_n69_), .c(x1), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n71_), .c(new_n68_), .O(z4));
  inv1   g56(.a(new_n22_), .O(new_n74_));
  nand2  g57(.a(x6), .b(new_n20_), .O(new_n75_));
  inv1   g58(.a(x2), .O(new_n76_));
  nor2   g59(.a(x3), .b(new_n76_), .O(new_n77_));
  oai22  g60(.a(new_n77_), .b(new_n75_), .c(new_n74_), .d(new_n20_), .O(new_n78_));
  inv1   g61(.a(x3), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n21_), .c(new_n20_), .O(new_n80_));
  nand3  g63(.a(x3), .b(x1), .c(x0), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(new_n76_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n78_), .O(z5));
  inv1   g66(.a(new_n25_), .O(new_n84_));
  nand3  g67(.a(x3), .b(new_n76_), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n79_), .b(x2), .c(new_n21_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  inv1   g70(.a(new_n87_), .O(z6));
  oai21  g71(.a(new_n69_), .b(new_n74_), .c(new_n84_), .O(z7));
