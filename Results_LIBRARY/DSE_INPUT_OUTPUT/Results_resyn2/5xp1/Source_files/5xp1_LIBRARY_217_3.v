...
module FAU ( 
  ...
  nand3  g57(.a(new_n74_), .b(new_n71_), .c(x1), .O(new_n75_));
  oai21  g58(.a(x3), .b(x0), .c(x2), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  or2    g60(.a(new_n76_), .b(new_n19_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n77_), .c(new_n24_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n75_), .O(z4));
  inv1   g63(.a(new_n35_), .O(new_n81_));
  nand2  g64(.a(new_n66_), .b(x2), .O(new_n82_));
  nand3  g65(.a(x3), .b(new_n36_), .c(x1), .O(new_n83_));
  ...
  nand3  g69(.a(new_n86_), .b(new_n84_), .c(new_n81_), .O(new_n87_));
  inv1   g70(.a(new_n87_), .O(z5));
  inv1   g71(.a(new_n83_), .O(new_n89_));
  aoi21  g72(.a(x3), .b(new_n36_), .c(x1), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(new_n81_), .O(z6));
  nand2  g74(.a(new_n81_), .b(new_n25_), .O(new_n92_));
  aoi21  g75(.a(new_n66_), .b(new_n36_), .c(new_n92_), .O(z7));
  nand2  g76(.a(new_n81_), .b(x3), .O(z8));
  nand3  g77(.a(new_n23_), .b(new_n19_), .c(x4), .O(new_n95_));
