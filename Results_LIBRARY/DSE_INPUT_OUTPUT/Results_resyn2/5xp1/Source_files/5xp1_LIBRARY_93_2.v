...
module FAU ( 
  ...
  nand2  g58(.a(new_n41_), .b(new_n19_), .O(new_n76_));
  ...
  nand3  g62(.a(new_n79_), .b(new_n72_), .c(new_n24_), .O(z3));
  inv1   g63(.a(new_n20_), .O(new_n81_));
  nand3  g64(.a(new_n34_), .b(new_n81_), .c(new_n23_), .O(new_n82_));
  oai21  g65(.a(new_n33_), .b(new_n20_), .c(x6), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(x1), .O(new_n84_));
  oai21  g67(.a(x3), .b(x0), .c(x2), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n23_), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n23_), .c(new_n86_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n84_), .c(new_n24_), .O(z4));
  nand3  g71(.a(new_n34_), .b(new_n76_), .c(new_n67_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x0), .O(new_n90_));
  or2    g73(.a(new_n89_), .b(x0), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n90_), .c(new_n24_), .O(z5));
  nand3  g75(.a(x3), .b(new_n41_), .c(new_n19_), .O(new_n93_));
  oai21  g76(.a(new_n58_), .b(x2), .c(x1), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n24_), .O(z6));
  inv1   g78(.a(new_n24_), .O(new_n96_));
  nor3   g79(.a(new_n33_), .b(new_n96_), .c(new_n69_), .O(z7));
  nor2   g80(.a(new_n96_), .b(x3), .O(z8));
  inv1   g81(.a(new_n53_), .O(z9));
endmodule
