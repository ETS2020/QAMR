...
module FAU ( 
  ...
  nand2  g51(.a(new_n57_), .b(x0), .O(new_n69_));
  nor2   g52(.a(x6), .b(new_n22_), .O(new_n70_));
  inv1   g53(.a(new_n70_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n69_), .c(new_n26_), .O(new_n72_));
  nor2   g55(.a(x3), .b(x2), .O(new_n73_));
  oai21  g56(.a(new_n73_), .b(new_n18_), .c(new_n26_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n19_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n72_), .c(x1), .O(new_n76_));
  oai21  g59(.a(x3), .b(x0), .c(x2), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n19_), .c(x1), .O(new_n78_));
  oai21  g61(.a(new_n77_), .b(new_n70_), .c(new_n78_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n76_), .O(z4));
  nand4  g63(.a(new_n57_), .b(new_n59_), .c(new_n26_), .d(x0), .O(new_n81_));
  nand3  g64(.a(new_n57_), .b(new_n59_), .c(new_n26_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n18_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n51_), .O(new_n84_));
  inv1   g67(.a(new_n84_), .O(z5));
  nand2  g68(.a(x3), .b(new_n55_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n25_), .c(new_n51_), .O(new_n87_));
  aoi21  g70(.a(new_n86_), .b(new_n25_), .c(new_n87_), .O(z6));
  nand2  g71(.a(new_n57_), .b(new_n26_), .O(new_n89_));
  nor2   g72(.a(new_n89_), .b(new_n50_), .O(z7));
  nor2   g73(.a(new_n50_), .b(x3), .O(z8));
  nor2   g74(.a(new_n22_), .b(new_n24_), .O(new_n92_));
  oai21  g75(.a(new_n30_), .b(x6), .c(new_n92_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n51_), .O(z9));
endmodule
