...
module FAU ( 
  ...
  nor2   g50(.a(x6), .b(new_n18_), .O(new_n68_));
  inv1   g51(.a(new_n68_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n67_), .c(new_n19_), .O(new_n70_));
  oai21  g53(.a(new_n65_), .b(new_n22_), .c(new_n19_), .O(new_n71_));
  ...
  aoi21  g57(.a(new_n74_), .b(new_n23_), .c(x1), .O(new_n75_));
  oai21  g58(.a(new_n74_), .b(new_n68_), .c(new_n75_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n73_), .O(z4));
  nor2   g60(.a(x2), .b(x1), .O(new_n78_));
  inv1   g61(.a(new_n78_), .O(new_n79_));
  nand4  g62(.a(new_n66_), .b(new_n79_), .c(new_n19_), .d(x0), .O(new_n80_));
  nand2  g63(.a(new_n23_), .b(new_n18_), .O(new_n81_));
  nand2  g64(.a(new_n66_), .b(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n78_), .c(new_n22_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n80_), .O(new_n84_));
  inv1   g67(.a(new_n84_), .O(z5));
  inv1   g68(.a(x2), .O(new_n86_));
  nand2  g69(.a(x3), .b(new_n86_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n33_), .c(new_n81_), .O(new_n88_));
  aoi21  g71(.a(new_n87_), .b(new_n33_), .c(new_n88_), .O(z6));
  nand2  g72(.a(new_n81_), .b(new_n82_), .O(z7));
  aoi21  g73(.a(new_n23_), .b(new_n18_), .c(x3), .O(z8));
  nor3   g74(.a(new_n26_), .b(new_n18_), .c(new_n32_), .O(z9));
endmodule
