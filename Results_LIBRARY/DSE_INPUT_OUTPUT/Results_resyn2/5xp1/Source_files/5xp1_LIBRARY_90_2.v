...
module FAU ( 
  ...
  aoi21  g52(.a(new_n35_), .b(new_n19_), .c(x1), .O(new_n70_));
  ...
  nand2  g59(.a(new_n19_), .b(x4), .O(new_n77_));
  ...
  oai21  g65(.a(new_n82_), .b(new_n20_), .c(new_n77_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n20_), .c(new_n83_), .O(z6));
  nand2  g67(.a(new_n77_), .b(new_n78_), .O(z7));
  aoi21  g68(.a(new_n19_), .b(x4), .c(x3), .O(z8));
  aoi21  g69(.a(x6), .b(new_n28_), .c(new_n18_), .O(z9));
endmodule
