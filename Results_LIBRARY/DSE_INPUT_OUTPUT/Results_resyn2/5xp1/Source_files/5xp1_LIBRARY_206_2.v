...
module FAU ( 
  ...
  nand3  g60(.a(new_n77_), .b(new_n35_), .c(new_n25_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(x0), .O(new_n79_));
  or2    g62(.a(new_n78_), .b(x0), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n79_), .c(new_n52_), .O(z5));
  nand2  g64(.a(x3), .b(new_n34_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n24_), .c(new_n52_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n24_), .c(new_n83_), .O(z6));
  inv1   g67(.a(new_n52_), .O(new_n85_));
  nand2  g68(.a(new_n77_), .b(new_n25_), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(new_n85_), .O(z7));
  nand2  g70(.a(new_n52_), .b(x3), .O(z8));
endmodule
