...
module FAU ( 
  ...
  nor3   g28(.a(new_n45_), .b(new_n20_), .c(new_n19_), .O(new_n46_));
  ...
  aoi21  g34(.a(new_n35_), .b(new_n19_), .c(new_n23_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n46_), .c(new_n51_), .O(new_n53_));
  nand2  g36(.a(new_n20_), .b(x5), .O(new_n54_));
  nand3  g37(.a(new_n45_), .b(new_n22_), .c(x0), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n54_), .c(new_n18_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n23_), .O(new_n57_));
  inv1   g40(.a(x2), .O(new_n58_));
  nor2   g41(.a(new_n23_), .b(new_n58_), .O(new_n59_));
  oai21  g42(.a(x3), .b(x0), .c(new_n59_), .O(new_n60_));
  nor2   g43(.a(new_n51_), .b(x1), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n57_), .c(new_n53_), .O(z3));
  inv1   g46(.a(new_n45_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x6), .O(new_n65_));
  nand2  g48(.a(x3), .b(x0), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n47_), .c(new_n35_), .O(new_n67_));
  oai21  g50(.a(new_n65_), .b(new_n20_), .c(new_n67_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x1), .O(new_n69_));
  aoi21  g52(.a(new_n35_), .b(new_n23_), .c(x1), .O(new_n70_));
  oai21  g53(.a(new_n47_), .b(new_n35_), .c(new_n70_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n69_), .O(z4));
  nand2  g55(.a(x3), .b(x2), .O(new_n73_));
  nor2   g56(.a(x2), .b(x1), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  nand4  g58(.a(new_n64_), .b(new_n75_), .c(new_n73_), .d(x0), .O(new_n76_));
  nand2  g59(.a(new_n23_), .b(x4), .O(new_n77_));
  nand2  g60(.a(new_n64_), .b(new_n73_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n74_), .c(new_n33_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(new_n80_));
  inv1   g63(.a(new_n80_), .O(z5));
  nand2  g64(.a(x3), .b(new_n58_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n19_), .c(new_n77_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n19_), .c(new_n83_), .O(z6));
  nand2  g67(.a(new_n77_), .b(new_n78_), .O(z7));
  aoi21  g68(.a(new_n23_), .b(x4), .c(x3), .O(z8));
endmodule
