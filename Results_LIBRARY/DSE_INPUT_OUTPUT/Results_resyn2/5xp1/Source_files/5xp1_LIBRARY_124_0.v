...
module FAU ( 
  ...
  aoi21  g42(.a(x6), .b(x1), .c(new_n59_), .O(new_n60_));
  nand3  g43(.a(new_n37_), .b(x3), .c(x2), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n18_), .O(new_n63_));
  oai21  g46(.a(new_n38_), .b(new_n51_), .c(new_n22_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x1), .O(new_n65_));
  aoi21  g48(.a(new_n65_), .b(x0), .c(new_n49_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nor2   g50(.a(new_n33_), .b(new_n32_), .O(new_n68_));
  nand2  g51(.a(x5), .b(x0), .O(new_n69_));
  oai21  g52(.a(new_n50_), .b(new_n51_), .c(new_n69_), .O(new_n70_));
  nand2  g53(.a(x6), .b(x2), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n39_), .c(new_n31_), .O(new_n72_));
  nand4  g55(.a(new_n22_), .b(x4), .c(new_n51_), .d(new_n32_), .O(new_n73_));
  ...
  nor2   g60(.a(x6), .b(new_n38_), .O(new_n78_));
  aoi21  g61(.a(new_n52_), .b(new_n20_), .c(new_n78_), .O(new_n79_));
  nand3  g62(.a(new_n52_), .b(new_n20_), .c(new_n22_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  aoi21  g64(.a(new_n46_), .b(new_n22_), .c(x1), .O(new_n82_));
  oai21  g65(.a(new_n46_), .b(new_n78_), .c(new_n82_), .O(new_n83_));
  ...
  oai21  g69(.a(new_n86_), .b(new_n18_), .c(new_n39_), .O(new_n87_));
  aoi21  g70(.a(new_n86_), .b(new_n18_), .c(new_n87_), .O(z5));
  oai21  g71(.a(new_n51_), .b(x2), .c(x1), .O(new_n89_));
  nand3  g72(.a(x3), .b(new_n32_), .c(new_n31_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n39_), .O(z6));
