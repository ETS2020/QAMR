...
module FAU ( 
  ...
  inv1   g55(.a(new_n26_), .O(new_n73_));
  ...
  nand2  g70(.a(x3), .b(new_n55_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n25_), .c(new_n53_), .O(new_n89_));
