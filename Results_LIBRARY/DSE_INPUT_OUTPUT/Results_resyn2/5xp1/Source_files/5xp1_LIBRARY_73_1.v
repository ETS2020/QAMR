...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n87_, new_n89_, new_n90_, new_n93_, new_n94_;
  ...
  aoi21  g32(.a(new_n20_), .b(new_n49_), .c(new_n48_), .O(new_n50_));
  inv1   g33(.a(x2), .O(new_n51_));
  aoi21  g34(.a(new_n20_), .b(new_n48_), .c(new_n51_), .O(new_n52_));
  ...
  aoi21  g48(.a(new_n65_), .b(new_n52_), .c(new_n23_), .O(new_n66_));
  ...
  nand2  g54(.a(new_n49_), .b(new_n19_), .O(new_n72_));
  ...
  nand2  g61(.a(new_n49_), .b(x2), .O(new_n79_));
  nand3  g62(.a(x3), .b(new_n51_), .c(x1), .O(new_n80_));
  ...
  aoi21  g69(.a(x3), .b(new_n51_), .c(x1), .O(new_n87_));
  nor3   g70(.a(new_n87_), .b(new_n86_), .c(new_n23_), .O(z6));
  nand2  g71(.a(new_n49_), .b(new_n51_), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n78_), .c(new_n59_), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(z7));
  nand2  g74(.a(new_n78_), .b(x3), .O(z8));
  nand2  g75(.a(new_n21_), .b(new_n19_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(x4), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n20_), .c(new_n24_), .O(z9));
endmodule
