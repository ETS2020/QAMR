...
module FAU ( 
  ...
  nand2  g15(.a(new_n27_), .b(new_n24_), .O(new_n33_));
  nand4  g16(.a(new_n33_), .b(new_n22_), .c(x6), .d(new_n18_), .O(new_n34_));
  inv1   g17(.a(x6), .O(new_n35_));
  oai21  g18(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n36_));
  ...
  nand3  g24(.a(new_n41_), .b(new_n37_), .c(new_n35_), .O(new_n42_));
  nand3  g25(.a(new_n33_), .b(new_n22_), .c(x6), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x4), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n42_), .c(new_n34_), .O(new_n45_));
  ...
  nand3  g32(.a(new_n47_), .b(new_n21_), .c(new_n35_), .O(new_n50_));
  ...
  nor2   g37(.a(new_n35_), .b(new_n38_), .O(new_n55_));
  nand3  g38(.a(x5), .b(new_n39_), .c(new_n19_), .O(new_n56_));
  ...
  nand4  g42(.a(new_n24_), .b(new_n39_), .c(new_n38_), .d(x0), .O(new_n60_));
  ...
  nand3  g46(.a(new_n47_), .b(new_n21_), .c(new_n35_), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  aoi21  g48(.a(new_n47_), .b(new_n21_), .c(new_n35_), .O(new_n66_));
  oai21  g49(.a(new_n66_), .b(new_n65_), .c(x1), .O(new_n67_));
  nand2  g50(.a(new_n48_), .b(new_n35_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n52_), .c(new_n20_), .O(new_n69_));
  nand2  g52(.a(new_n35_), .b(x4), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(z4));
  nand2  g54(.a(new_n38_), .b(new_n20_), .O(new_n72_));
  nand4  g55(.a(new_n40_), .b(new_n72_), .c(new_n21_), .d(x0), .O(new_n73_));
  nand3  g56(.a(new_n40_), .b(new_n72_), .c(new_n21_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n19_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(new_n76_));
  inv1   g59(.a(new_n76_), .O(z5));
  nand2  g60(.a(x3), .b(new_n38_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n20_), .c(new_n70_), .O(new_n79_));
  aoi21  g62(.a(new_n78_), .b(new_n20_), .c(new_n79_), .O(z6));
  nand2  g63(.a(new_n40_), .b(new_n21_), .O(new_n81_));
