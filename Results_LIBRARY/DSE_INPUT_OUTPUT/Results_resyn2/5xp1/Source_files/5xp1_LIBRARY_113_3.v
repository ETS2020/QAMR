...
module FAU ( 
  ...
  nand3  g71(.a(x3), .b(new_n37_), .c(x1), .O(new_n89_));
  ...
  aoi21  g78(.a(x3), .b(new_n37_), .c(x1), .O(new_n96_));
  nor3   g79(.a(new_n96_), .b(new_n95_), .c(new_n36_), .O(z6));
  nand2  g80(.a(new_n47_), .b(new_n25_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n87_), .O(z7));
  nor2   g82(.a(new_n36_), .b(x3), .O(z8));
  nand3  g83(.a(new_n23_), .b(new_n18_), .c(x4), .O(new_n101_));
