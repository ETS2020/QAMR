...
module FAU ( 
  ...
  nor2   g61(.a(new_n50_), .b(new_n21_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n20_), .c(new_n19_), .O(new_n80_));
  ...
  oai21  g69(.a(new_n86_), .b(new_n19_), .c(new_n29_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n37_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x0), .O(new_n89_));
  aoi21  g72(.a(new_n87_), .b(new_n21_), .c(new_n41_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n89_), .O(z5));
  nand3  g74(.a(x3), .b(new_n29_), .c(new_n19_), .O(new_n92_));
  oai21  g75(.a(new_n86_), .b(x2), .c(x1), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n40_), .O(z6));
  or2    g77(.a(new_n61_), .b(new_n50_), .O(new_n95_));
