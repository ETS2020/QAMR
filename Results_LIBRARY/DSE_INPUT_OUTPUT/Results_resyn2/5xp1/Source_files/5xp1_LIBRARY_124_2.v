...
module FAU ( 
  ...
  nand4  g60(.a(new_n77_), .b(new_n76_), .c(new_n25_), .d(x0), .O(new_n78_));
  nand2  g61(.a(new_n77_), .b(new_n25_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n75_), .c(new_n23_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n49_), .O(new_n81_));
  inv1   g64(.a(new_n81_), .O(z5));
  nand3  g65(.a(x3), .b(new_n64_), .c(new_n24_), .O(new_n83_));
  inv1   g66(.a(x3), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(x2), .c(x1), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n83_), .c(new_n49_), .O(z6));
  inv1   g69(.a(new_n49_), .O(new_n87_));
  nor2   g70(.a(new_n79_), .b(new_n87_), .O(z7));
  nand2  g71(.a(new_n49_), .b(x3), .O(z8));
