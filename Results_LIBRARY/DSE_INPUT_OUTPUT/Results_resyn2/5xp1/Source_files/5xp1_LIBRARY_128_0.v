...
module FAU ( 
  ...
  nand2  g60(.a(new_n21_), .b(x5), .O(new_n78_));
  oai21  g61(.a(new_n77_), .b(new_n25_), .c(new_n78_), .O(new_n79_));
  inv1   g62(.a(new_n25_), .O(new_n80_));
  inv1   g63(.a(new_n77_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(new_n21_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n79_), .c(x1), .O(new_n83_));
  inv1   g66(.a(new_n78_), .O(new_n84_));
  oai21  g67(.a(x3), .b(x0), .c(x2), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n21_), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n84_), .c(new_n86_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n83_), .O(z4));
  oai21  g71(.a(new_n40_), .b(new_n24_), .c(new_n50_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n31_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(x0), .O(new_n91_));
  aoi21  g74(.a(new_n89_), .b(new_n25_), .c(new_n59_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n91_), .O(z5));
  nand2  g76(.a(x3), .b(new_n50_), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n24_), .c(new_n60_), .O(new_n95_));
  aoi21  g78(.a(new_n94_), .b(new_n24_), .c(new_n95_), .O(z6));
  nand3  g79(.a(new_n81_), .b(new_n60_), .c(new_n31_), .O(new_n97_));
  inv1   g80(.a(new_n97_), .O(z7));
  nor2   g81(.a(new_n59_), .b(x3), .O(z8));
  nand3  g82(.a(new_n22_), .b(new_n21_), .c(new_n20_), .O(new_n100_));
  inv1   g83(.a(new_n100_), .O(new_n101_));
  nor3   g84(.a(new_n101_), .b(new_n18_), .c(new_n30_), .O(z9));
endmodule
