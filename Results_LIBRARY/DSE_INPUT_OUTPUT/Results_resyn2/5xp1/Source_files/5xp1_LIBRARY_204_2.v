...
module FAU ( 
  ...
  nand4  g25(.a(new_n40_), .b(new_n23_), .c(x6), .d(new_n19_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(new_n44_));
  inv1   g27(.a(new_n44_), .O(z2));
  oai21  g28(.a(new_n22_), .b(new_n21_), .c(new_n18_), .O(new_n46_));
  aoi21  g29(.a(new_n22_), .b(new_n21_), .c(x0), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  oai21  g31(.a(x6), .b(x3), .c(x1), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x0), .O(new_n50_));
  nand2  g33(.a(new_n18_), .b(x4), .O(new_n51_));
  nand4  g34(.a(new_n51_), .b(new_n50_), .c(new_n48_), .d(x5), .O(new_n52_));
  nand2  g35(.a(new_n21_), .b(new_n20_), .O(new_n53_));
  nand3  g36(.a(new_n29_), .b(new_n53_), .c(x6), .O(new_n54_));
  oai21  g37(.a(x3), .b(x2), .c(x1), .O(new_n55_));
  nand4  g38(.a(new_n55_), .b(new_n18_), .c(new_n19_), .d(x0), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n25_), .O(new_n58_));
  nand3  g41(.a(new_n25_), .b(x3), .c(new_n20_), .O(new_n59_));
  oai21  g42(.a(new_n25_), .b(new_n20_), .c(new_n59_), .O(new_n60_));
  oai21  g43(.a(x4), .b(new_n21_), .c(new_n18_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n60_), .c(x2), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n58_), .c(new_n52_), .O(z3));
  nand2  g46(.a(new_n36_), .b(new_n18_), .O(new_n64_));
  nand3  g47(.a(new_n34_), .b(new_n22_), .c(x6), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n64_), .c(x1), .O(new_n66_));
  oai21  g49(.a(x3), .b(x0), .c(x2), .O(new_n67_));
  aoi21  g50(.a(new_n67_), .b(new_n18_), .c(x1), .O(new_n68_));
  oai21  g51(.a(new_n67_), .b(new_n18_), .c(new_n68_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n66_), .c(new_n51_), .O(z4));
  nor2   g53(.a(x2), .b(x1), .O(new_n71_));
  xnor2a g54(.a(x3), .b(x2), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n71_), .c(x0), .O(new_n73_));
  nor2   g56(.a(new_n72_), .b(new_n71_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n20_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n73_), .c(new_n51_), .O(z5));
  inv1   g59(.a(x2), .O(new_n77_));
  nand2  g60(.a(x3), .b(new_n77_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n21_), .c(new_n51_), .O(new_n79_));
  aoi21  g62(.a(new_n78_), .b(new_n21_), .c(new_n79_), .O(z6));
  nand2  g63(.a(new_n72_), .b(new_n51_), .O(z7));
  nand2  g64(.a(new_n51_), .b(x3), .O(z8));
  aoi21  g65(.a(x6), .b(new_n25_), .c(new_n19_), .O(z9));
endmodule
