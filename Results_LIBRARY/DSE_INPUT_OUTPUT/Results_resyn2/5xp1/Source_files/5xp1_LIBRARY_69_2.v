...
module FAU ( 
  ...
  nor2   g65(.a(x6), .b(new_n40_), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(new_n84_));
  oai21  g67(.a(x3), .b(x0), .c(x2), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n23_), .O(new_n86_));
  oai21  g69(.a(x3), .b(x0), .c(new_n71_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n86_), .c(new_n20_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n84_), .c(new_n82_), .O(z4));
  xnor2a g72(.a(x3), .b(x2), .O(new_n90_));
  nor2   g73(.a(new_n90_), .b(new_n31_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n19_), .c(new_n83_), .O(new_n92_));
  oai21  g75(.a(new_n91_), .b(new_n19_), .c(new_n92_), .O(z5));
  nand2  g76(.a(x3), .b(new_n45_), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n20_), .c(new_n84_), .O(new_n95_));
  aoi21  g78(.a(new_n94_), .b(new_n20_), .c(new_n95_), .O(z6));
  nor2   g79(.a(new_n90_), .b(new_n83_), .O(z7));
  nor2   g80(.a(new_n83_), .b(x3), .O(z8));
