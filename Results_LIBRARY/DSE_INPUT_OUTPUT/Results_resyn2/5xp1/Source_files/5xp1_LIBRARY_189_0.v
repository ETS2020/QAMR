...
module FAU ( 
  ...
  oai21  g28(.a(new_n36_), .b(x5), .c(new_n45_), .O(z1));
  nand2  g29(.a(new_n28_), .b(new_n22_), .O(new_n47_));
  oai21  g30(.a(new_n38_), .b(new_n19_), .c(new_n37_), .O(new_n48_));
  oai21  g31(.a(new_n28_), .b(new_n22_), .c(new_n23_), .O(new_n49_));
  ...
  oai21  g38(.a(new_n55_), .b(new_n54_), .c(new_n23_), .O(new_n56_));
  nor2   g39(.a(x2), .b(x1), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n41_), .c(new_n23_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n31_), .c(new_n26_), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n56_), .c(new_n51_), .d(new_n47_), .O(z2));
  ...
  nand3  g49(.a(new_n66_), .b(new_n47_), .c(new_n18_), .O(new_n67_));
  ...
  oai21  g57(.a(new_n52_), .b(x0), .c(new_n23_), .O(new_n75_));
  ...
  nand2  g68(.a(new_n53_), .b(new_n19_), .O(new_n86_));
  ...
  nand3  g72(.a(new_n89_), .b(new_n87_), .c(new_n47_), .O(z5));
  nand2  g73(.a(x3), .b(new_n32_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n18_), .c(new_n47_), .O(new_n92_));
  aoi21  g75(.a(new_n91_), .b(new_n18_), .c(new_n92_), .O(z6));
  nand2  g76(.a(new_n86_), .b(new_n47_), .O(z7));
  nor2   g77(.a(new_n43_), .b(x3), .O(z8));
  nand2  g78(.a(new_n24_), .b(new_n21_), .O(new_n96_));
  nand2  g79(.a(new_n47_), .b(new_n96_), .O(z9));
endmodule
