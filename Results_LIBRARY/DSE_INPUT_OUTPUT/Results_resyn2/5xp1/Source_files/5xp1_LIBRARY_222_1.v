...
module FAU ( 
  ...
  oai22  g65(.a(new_n41_), .b(new_n30_), .c(new_n66_), .d(x1), .O(new_n83_));
  nor2   g66(.a(new_n45_), .b(new_n32_), .O(new_n84_));
  ...
  nor2   g82(.a(new_n62_), .b(x2), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n35_), .O(new_n101_));
  oai21  g84(.a(new_n100_), .b(new_n99_), .c(new_n101_), .O(z6));
  aoi21  g85(.a(x1), .b(new_n32_), .c(new_n96_), .O(z7));
  nand2  g86(.a(new_n33_), .b(x3), .O(z8));
  oai21  g87(.a(new_n25_), .b(new_n18_), .c(new_n33_), .O(z9));
endmodule
