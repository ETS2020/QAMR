...
module FAU ( 
  ...
  nand2  g48(.a(new_n20_), .b(new_n27_), .O(new_n66_));
  nand4  g49(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n61_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n63_), .c(new_n55_), .O(z3));
  aoi22  g51(.a(new_n28_), .b(new_n47_), .c(x6), .d(x4), .O(new_n69_));
  nand3  g52(.a(new_n28_), .b(new_n47_), .c(x6), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x1), .O(new_n71_));
  aoi21  g54(.a(x6), .b(x4), .c(new_n64_), .O(new_n72_));
  nand2  g55(.a(new_n64_), .b(x6), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n27_), .O(new_n74_));
  oai22  g57(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(new_n69_), .O(z4));
  oai21  g58(.a(new_n57_), .b(new_n27_), .c(new_n52_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n47_), .c(new_n19_), .O(new_n77_));
  nand2  g60(.a(new_n76_), .b(new_n47_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(x0), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n77_), .c(new_n65_), .O(z5));
  oai21  g63(.a(new_n57_), .b(x2), .c(x1), .O(new_n81_));
  nand3  g64(.a(x3), .b(new_n52_), .c(new_n27_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(new_n65_), .O(z6));
  inv1   g66(.a(new_n47_), .O(new_n84_));
  nor2   g67(.a(x3), .b(x2), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(z7));
  nand2  g69(.a(new_n65_), .b(x3), .O(z8));
  nand2  g70(.a(new_n26_), .b(x5), .O(new_n88_));
  nand2  g71(.a(new_n65_), .b(new_n88_), .O(z9));
endmodule
