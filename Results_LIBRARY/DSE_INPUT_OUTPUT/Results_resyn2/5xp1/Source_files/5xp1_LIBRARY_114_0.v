...
module FAU ( 
  ...
  oai22  g14(.a(new_n31_), .b(new_n19_), .c(new_n30_), .d(new_n29_), .O(new_n32_));
  aoi22  g15(.a(new_n32_), .b(x0), .c(x6), .d(x4), .O(new_n33_));
  inv1   g16(.a(x5), .O(new_n34_));
  nor2   g17(.a(new_n34_), .b(x0), .O(new_n35_));
  nand3  g18(.a(new_n20_), .b(x4), .c(new_n19_), .O(new_n36_));
  ...
  oai21  g26(.a(new_n33_), .b(x5), .c(new_n43_), .O(z1));
  inv1   g27(.a(x0), .O(new_n45_));
  oai21  g28(.a(x6), .b(x1), .c(x5), .O(new_n46_));
  oai21  g29(.a(new_n20_), .b(new_n18_), .c(new_n46_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n39_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n45_), .O(new_n49_));
  nor2   g32(.a(x3), .b(x2), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n19_), .c(new_n20_), .O(new_n51_));
  nand2  g34(.a(new_n38_), .b(new_n29_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n34_), .O(new_n54_));
  oai21  g37(.a(x2), .b(x1), .c(x0), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n34_), .c(new_n18_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n22_), .O(new_n57_));
  nand4  g40(.a(new_n57_), .b(new_n54_), .c(new_n49_), .d(new_n40_), .O(z2));
  nand2  g41(.a(x6), .b(x1), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  nand2  g43(.a(new_n40_), .b(new_n37_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n36_), .c(new_n60_), .O(new_n62_));
  nand2  g45(.a(x4), .b(x3), .O(new_n63_));
  ...
  oai21  g49(.a(new_n62_), .b(x0), .c(new_n66_), .O(new_n67_));
  nor2   g50(.a(new_n30_), .b(new_n29_), .O(new_n68_));
  nand2  g51(.a(x6), .b(x2), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n40_), .c(new_n19_), .O(new_n70_));
  nand3  g53(.a(new_n50_), .b(new_n20_), .c(x4), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n70_), .c(x0), .O(new_n72_));
  aoi21  g55(.a(new_n59_), .b(new_n45_), .c(x5), .O(new_n73_));
  aoi21  g56(.a(x3), .b(new_n45_), .c(x5), .O(new_n74_));
  nor2   g57(.a(new_n74_), .b(new_n35_), .O(new_n75_));
  aoi22  g58(.a(new_n75_), .b(new_n68_), .c(new_n73_), .d(new_n72_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n67_), .O(z3));
  inv1   g60(.a(new_n21_), .O(new_n78_));
  inv1   g61(.a(new_n50_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n78_), .c(new_n20_), .O(new_n80_));
  oai21  g63(.a(new_n50_), .b(new_n21_), .c(x6), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(x1), .O(new_n82_));
  oai21  g65(.a(x3), .b(x0), .c(x2), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n20_), .c(x1), .O(new_n84_));
  oai21  g67(.a(new_n83_), .b(new_n20_), .c(new_n84_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n82_), .c(new_n40_), .O(z4));
  nand2  g69(.a(x3), .b(x1), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n37_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x0), .O(new_n90_));
  nand2  g73(.a(new_n88_), .b(new_n21_), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n90_), .c(new_n40_), .O(z5));
  nand2  g75(.a(x3), .b(new_n29_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n19_), .c(new_n40_), .O(new_n94_));
  aoi21  g77(.a(new_n93_), .b(new_n19_), .c(new_n94_), .O(z6));
  nand3  g78(.a(new_n79_), .b(new_n40_), .c(new_n37_), .O(new_n96_));
  inv1   g79(.a(new_n96_), .O(z7));
  nand2  g80(.a(new_n40_), .b(x3), .O(z8));
endmodule
