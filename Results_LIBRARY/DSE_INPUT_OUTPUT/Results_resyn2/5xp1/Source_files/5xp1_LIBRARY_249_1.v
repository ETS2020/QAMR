...
module FAU ( 
  ...
  nand3  g51(.a(new_n68_), .b(new_n64_), .c(new_n56_), .O(z3));
  aoi22  g52(.a(new_n48_), .b(new_n27_), .c(x6), .d(x4), .O(new_n70_));
  nand3  g53(.a(new_n48_), .b(new_n27_), .c(x6), .O(new_n71_));
  ...
  oai21  g59(.a(new_n58_), .b(new_n26_), .c(new_n53_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n48_), .c(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n77_), .b(new_n48_), .O(new_n79_));
  ...
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n66_), .O(z6));
