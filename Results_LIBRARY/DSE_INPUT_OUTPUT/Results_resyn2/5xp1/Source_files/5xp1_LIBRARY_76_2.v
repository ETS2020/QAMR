...
module FAU ( 
  ...
  oai21  g09(.a(new_n19_), .b(new_n21_), .c(x1), .O(new_n27_));
  ...
  nor2   g50(.a(new_n52_), .b(x2), .O(new_n68_));
  nand2  g51(.a(x6), .b(x1), .O(new_n69_));
  oai22  g52(.a(new_n69_), .b(new_n68_), .c(new_n33_), .d(new_n52_), .O(z6));
  inv1   g53(.a(new_n50_), .O(new_n71_));
  nor2   g54(.a(x3), .b(new_n32_), .O(new_n72_));
  nor2   g55(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  nor2   g56(.a(new_n73_), .b(new_n71_), .O(z7));
  nor2   g57(.a(new_n71_), .b(x3), .O(z8));
  inv1   g58(.a(x4), .O(new_n76_));
  oai21  g59(.a(new_n25_), .b(new_n76_), .c(new_n50_), .O(z9));
endmodule
