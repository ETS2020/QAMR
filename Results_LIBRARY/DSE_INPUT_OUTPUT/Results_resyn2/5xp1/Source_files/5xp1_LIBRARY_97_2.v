...
module FAU ( 
  ...
  aoi21  g35(.a(new_n52_), .b(new_n49_), .c(new_n23_), .O(new_n53_));
  nand3  g36(.a(x6), .b(x1), .c(new_n23_), .O(new_n54_));
  inv1   g37(.a(new_n54_), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n53_), .c(new_n18_), .O(new_n56_));
  oai21  g39(.a(new_n25_), .b(new_n24_), .c(new_n19_), .O(new_n57_));
  aoi21  g40(.a(new_n25_), .b(new_n24_), .c(x0), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  oai21  g42(.a(x6), .b(x3), .c(x1), .O(new_n60_));
  oai21  g43(.a(x6), .b(new_n21_), .c(x5), .O(new_n61_));
  aoi21  g44(.a(new_n60_), .b(x0), .c(new_n61_), .O(new_n62_));
  nand3  g45(.a(new_n18_), .b(x3), .c(new_n23_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n38_), .O(new_n64_));
  nand2  g47(.a(new_n21_), .b(x1), .O(new_n65_));
  aoi21  g48(.a(new_n65_), .b(new_n19_), .c(new_n46_), .O(new_n66_));
  aoi22  g49(.a(new_n66_), .b(new_n64_), .c(new_n62_), .d(new_n59_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n56_), .O(z3));
  aoi21  g51(.a(new_n36_), .b(new_n19_), .c(new_n24_), .O(new_n69_));
  oai21  g52(.a(new_n48_), .b(new_n36_), .c(new_n69_), .O(new_n70_));
  oai21  g53(.a(x3), .b(x0), .c(x2), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n19_), .c(x1), .O(new_n72_));
  oai21  g55(.a(new_n71_), .b(new_n48_), .c(new_n72_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n70_), .O(z4));
  nor2   g57(.a(x2), .b(x1), .O(new_n75_));
  nand2  g58(.a(new_n47_), .b(new_n46_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(x0), .O(new_n78_));
  nor2   g61(.a(new_n77_), .b(new_n75_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n23_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n50_), .O(z5));
  nand2  g64(.a(x3), .b(new_n46_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n24_), .c(new_n50_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n24_), .c(new_n83_), .O(z6));
  nand2  g67(.a(new_n77_), .b(new_n50_), .O(z7));
  nand2  g68(.a(new_n50_), .b(x3), .O(z8));
