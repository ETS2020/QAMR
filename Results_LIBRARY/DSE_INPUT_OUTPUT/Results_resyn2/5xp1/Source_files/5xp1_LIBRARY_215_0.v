...
module FAU ( 
  ...
  nand3  g56(.a(new_n20_), .b(x2), .c(x0), .O(new_n74_));
  oai21  g57(.a(new_n66_), .b(x3), .c(new_n74_), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n24_), .O(new_n76_));
  oai21  g59(.a(new_n49_), .b(x3), .c(new_n20_), .O(new_n77_));
  aoi21  g60(.a(x6), .b(x1), .c(x2), .O(new_n78_));
  ...
  nand3  g66(.a(new_n83_), .b(x6), .c(new_n34_), .O(new_n84_));
  oai21  g67(.a(new_n83_), .b(new_n34_), .c(new_n84_), .O(z5));
  inv1   g68(.a(new_n62_), .O(new_n86_));
  nand3  g69(.a(x3), .b(new_n43_), .c(new_n24_), .O(new_n87_));
  inv1   g70(.a(x3), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(x2), .c(x1), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(z6));
  nor2   g73(.a(x3), .b(x2), .O(new_n91_));
  nor3   g74(.a(new_n62_), .b(new_n91_), .c(new_n81_), .O(z7));
  nor2   g75(.a(new_n62_), .b(x3), .O(z8));
  nand2  g76(.a(new_n86_), .b(new_n22_), .O(z9));
endmodule
