...
module FAU ( 
  ...
  aoi21  g65(.a(x3), .b(new_n49_), .c(x1), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n82_), .c(new_n74_), .O(z6));
  nand2  g67(.a(x3), .b(new_n49_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n75_), .c(new_n19_), .O(z7));
  nand2  g69(.a(new_n74_), .b(x3), .O(z8));
  inv1   g70(.a(new_n23_), .O(new_n88_));
  nor2   g71(.a(new_n31_), .b(new_n88_), .O(z9));
endmodule
