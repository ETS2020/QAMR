...
module FAU ( 
  ...
  nand3  g21(.a(new_n38_), .b(new_n32_), .c(new_n18_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(x6), .O(new_n40_));
  nor2   g23(.a(new_n27_), .b(x0), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n40_), .c(new_n23_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n37_), .c(new_n31_), .O(z1));
  aoi21  g26(.a(new_n23_), .b(new_n21_), .c(new_n27_), .O(new_n44_));
  oai21  g27(.a(new_n35_), .b(new_n21_), .c(x4), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n44_), .c(new_n22_), .O(new_n46_));
  nand2  g29(.a(new_n19_), .b(new_n18_), .O(new_n47_));
  nand2  g30(.a(new_n34_), .b(new_n27_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  nor2   g33(.a(new_n19_), .b(new_n27_), .O(new_n51_));
  oai21  g34(.a(new_n27_), .b(new_n18_), .c(new_n34_), .O(new_n52_));
  ...
  nand2  g38(.a(new_n41_), .b(new_n38_), .O(new_n56_));
  nor2   g39(.a(x3), .b(x2), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n27_), .c(x0), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n56_), .c(x4), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n22_), .O(new_n60_));
  nand2  g43(.a(x5), .b(new_n21_), .O(new_n61_));
  xnor2a g44(.a(x5), .b(x0), .O(new_n62_));
  inv1   g45(.a(x2), .O(new_n63_));
  nor2   g46(.a(new_n22_), .b(new_n63_), .O(new_n64_));
  oai22  g47(.a(new_n64_), .b(new_n62_), .c(new_n61_), .d(x3), .O(new_n65_));
  ...
  nand2  g53(.a(new_n68_), .b(x2), .O(new_n71_));
  aoi21  g54(.a(x5), .b(x3), .c(x6), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n70_), .c(new_n62_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n66_), .c(new_n60_), .O(z3));
  inv1   g58(.a(new_n19_), .O(new_n76_));
  nand2  g59(.a(new_n67_), .b(new_n63_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n76_), .c(new_n22_), .O(new_n78_));
  oai21  g61(.a(new_n57_), .b(new_n19_), .c(x6), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n78_), .c(x1), .O(new_n80_));
  nand2  g63(.a(new_n71_), .b(new_n22_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n69_), .c(new_n18_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n80_), .c(new_n31_), .O(z4));
  nor2   g66(.a(x2), .b(x1), .O(new_n84_));
  inv1   g67(.a(new_n84_), .O(new_n85_));
  nand4  g68(.a(new_n77_), .b(new_n85_), .c(new_n38_), .d(x0), .O(new_n86_));
  nand2  g69(.a(new_n77_), .b(new_n38_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n84_), .c(new_n21_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n86_), .c(new_n31_), .O(new_n89_));
  inv1   g72(.a(new_n89_), .O(z5));
  nand2  g73(.a(x3), .b(new_n63_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n18_), .c(new_n31_), .O(new_n92_));
  aoi21  g75(.a(new_n91_), .b(new_n18_), .c(new_n92_), .O(z6));
  nor2   g76(.a(new_n87_), .b(new_n28_), .O(z7));
  nor2   g77(.a(new_n28_), .b(x3), .O(z8));
  nand3  g78(.a(new_n24_), .b(x5), .c(x4), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n31_), .O(z9));
endmodule
