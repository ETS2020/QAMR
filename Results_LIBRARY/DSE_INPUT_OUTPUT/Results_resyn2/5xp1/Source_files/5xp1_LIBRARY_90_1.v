...
module FAU ( 
  ...
  aoi22  g50(.a(new_n27_), .b(new_n33_), .c(x6), .d(x4), .O(new_n68_));
  nand3  g51(.a(new_n27_), .b(new_n33_), .c(x6), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x1), .O(new_n70_));
  nand2  g53(.a(x6), .b(x4), .O(new_n71_));
  and2   g54(.a(new_n71_), .b(new_n42_), .O(new_n72_));
  oai21  g55(.a(new_n42_), .b(new_n20_), .c(new_n36_), .O(new_n73_));
  oai22  g56(.a(new_n73_), .b(new_n72_), .c(new_n70_), .d(new_n68_), .O(z4));
  ...
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(new_n75_), .O(new_n82_));
  inv1   g65(.a(new_n82_), .O(z5));
  inv1   g66(.a(new_n78_), .O(new_n84_));
  aoi21  g67(.a(x3), .b(new_n52_), .c(x1), .O(new_n85_));
  nor3   g68(.a(new_n85_), .b(new_n84_), .c(new_n63_), .O(z6));
  oai21  g69(.a(new_n34_), .b(new_n59_), .c(new_n75_), .O(z7));
  nor2   g70(.a(new_n63_), .b(x3), .O(z8));
  nand2  g71(.a(new_n21_), .b(new_n19_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x4), .O(new_n90_));
  aoi22  g73(.a(new_n90_), .b(new_n20_), .c(new_n26_), .d(x4), .O(z9));
endmodule
