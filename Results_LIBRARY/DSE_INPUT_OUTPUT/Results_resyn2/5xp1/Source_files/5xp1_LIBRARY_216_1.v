...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n24_, new_n25_,
    ...
    new_n79_, new_n81_, new_n82_, new_n84_, new_n85_, new_n88_, new_n89_;
  ...
  oai21  g59(.a(new_n57_), .b(new_n26_), .c(new_n35_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n49_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(x0), .c(new_n64_), .O(new_n79_));
  oai21  g62(.a(new_n78_), .b(x0), .c(new_n79_), .O(z5));
  nand2  g63(.a(x3), .b(new_n35_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n26_), .c(new_n65_), .O(new_n82_));
  aoi21  g65(.a(new_n81_), .b(new_n26_), .c(new_n82_), .O(z6));
  inv1   g66(.a(new_n49_), .O(new_n84_));
  nor2   g67(.a(x3), .b(x2), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(z7));
  nor2   g69(.a(new_n64_), .b(x3), .O(z8));
  nand2  g70(.a(new_n21_), .b(new_n19_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x4), .O(new_n89_));
  aoi22  g72(.a(new_n89_), .b(new_n20_), .c(new_n24_), .d(x4), .O(z9));
endmodule
