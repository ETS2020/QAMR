...
module FAU ( 
  ...
  aoi21  g37(.a(new_n20_), .b(new_n42_), .c(new_n37_), .O(new_n56_));
  oai21  g38(.a(x6), .b(x3), .c(x1), .O(new_n57_));
  inv1   g39(.a(new_n57_), .O(new_n58_));
  oai21  g40(.a(new_n58_), .b(new_n56_), .c(x0), .O(new_n59_));
  ...
  nor2   g44(.a(new_n57_), .b(new_n19_), .O(new_n63_));
  ...
  aoi21  g51(.a(new_n69_), .b(new_n56_), .c(new_n23_), .O(new_n70_));
  nand3  g52(.a(new_n70_), .b(new_n67_), .c(new_n62_), .O(z3));
  aoi22  g53(.a(new_n27_), .b(new_n36_), .c(x6), .d(x4), .O(new_n72_));
  nand3  g54(.a(new_n27_), .b(new_n36_), .c(x6), .O(new_n73_));
  nand2  g55(.a(new_n73_), .b(x1), .O(new_n74_));
  nand2  g56(.a(x6), .b(x4), .O(new_n75_));
  and2   g57(.a(new_n75_), .b(new_n48_), .O(new_n76_));
  oai21  g58(.a(new_n48_), .b(new_n20_), .c(new_n42_), .O(new_n77_));
  oai22  g59(.a(new_n77_), .b(new_n76_), .c(new_n74_), .d(new_n72_), .O(z4));
  inv1   g60(.a(new_n23_), .O(new_n79_));
  aoi21  g61(.a(x3), .b(x1), .c(x2), .O(new_n80_));
  nor2   g62(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  nand2  g63(.a(new_n81_), .b(new_n19_), .O(new_n82_));
  oai21  g64(.a(new_n80_), .b(new_n64_), .c(x0), .O(new_n83_));
  nand3  g65(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(z5));
  oai21  g66(.a(new_n38_), .b(x2), .c(x1), .O(new_n85_));
  nand3  g67(.a(x3), .b(new_n37_), .c(new_n42_), .O(new_n86_));
  nand3  g68(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(z6));
  nand3  g69(.a(new_n39_), .b(new_n79_), .c(new_n36_), .O(new_n88_));
  inv1   g70(.a(new_n88_), .O(z7));
  nor2   g71(.a(new_n23_), .b(x3), .O(z8));
  nand2  g72(.a(new_n21_), .b(new_n19_), .O(new_n91_));
  nand2  g73(.a(new_n91_), .b(x4), .O(new_n92_));
  aoi21  g74(.a(new_n92_), .b(new_n20_), .c(new_n24_), .O(z9));
endmodule
