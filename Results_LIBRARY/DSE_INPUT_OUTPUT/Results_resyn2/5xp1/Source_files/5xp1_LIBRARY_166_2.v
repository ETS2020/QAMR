...
module FAU ( 
  ...
  aoi21  g60(.a(new_n77_), .b(new_n37_), .c(new_n48_), .O(new_n78_));
  nand3  g61(.a(new_n77_), .b(new_n37_), .c(new_n26_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x1), .O(new_n80_));
  oai21  g63(.a(x3), .b(x0), .c(x2), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n26_), .c(x1), .O(new_n82_));
  oai21  g65(.a(new_n81_), .b(new_n48_), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n80_), .b(new_n78_), .c(new_n83_), .O(z4));
  nand4  g67(.a(new_n37_), .b(new_n69_), .c(new_n22_), .d(x0), .O(new_n85_));
  nand2  g68(.a(new_n37_), .b(new_n22_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n43_), .c(new_n20_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n27_), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(z5));
  nand2  g72(.a(x3), .b(new_n35_), .O(new_n90_));
  ...
  aoi21  g77(.a(x6), .b(new_n18_), .c(new_n42_), .O(z9));
endmodule
