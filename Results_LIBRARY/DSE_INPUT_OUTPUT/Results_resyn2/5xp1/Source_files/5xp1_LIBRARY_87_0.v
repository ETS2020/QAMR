...
module FAU ( 
  ...
  inv1   g16(.a(x3), .O(z8));
  oai21  g17(.a(x4), .b(z8), .c(new_n22_), .O(new_n35_));
  inv1   g18(.a(x0), .O(new_n36_));
  oai21  g19(.a(x4), .b(new_n22_), .c(new_n36_), .O(new_n37_));
  ...
  nand2  g36(.a(new_n29_), .b(new_n36_), .O(new_n54_));
  nand2  g37(.a(new_n29_), .b(new_n22_), .O(new_n55_));
  ...
  nand3  g47(.a(new_n60_), .b(new_n64_), .c(new_n22_), .O(new_n65_));
  aoi21  g48(.a(new_n29_), .b(new_n36_), .c(x4), .O(new_n66_));
  ...
  oai21  g52(.a(new_n18_), .b(z8), .c(new_n22_), .O(new_n70_));
  inv1   g53(.a(x2), .O(new_n71_));
  nand2  g54(.a(x6), .b(x1), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(x3), .c(new_n71_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n70_), .c(new_n29_), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  nand2  g58(.a(new_n72_), .b(x5), .O(new_n76_));
  aoi21  g59(.a(new_n70_), .b(x2), .c(new_n76_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(new_n36_), .O(new_n78_));
  nand2  g61(.a(new_n43_), .b(new_n29_), .O(new_n79_));
  inv1   g62(.a(new_n43_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(x5), .c(new_n36_), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n79_), .c(new_n30_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n78_), .O(z3));
  nor2   g66(.a(x3), .b(x2), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n23_), .c(x1), .O(new_n85_));
  nand2  g68(.a(z8), .b(new_n36_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(x2), .c(new_n22_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(x6), .O(new_n88_));
  nand3  g71(.a(new_n71_), .b(x1), .c(new_n36_), .O(new_n89_));
  oai21  g72(.a(new_n71_), .b(x1), .c(new_n89_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n18_), .c(x3), .O(new_n91_));
  ...
  nor2   g78(.a(new_n42_), .b(x3), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n95_), .c(new_n36_), .O(new_n97_));
  aoi21  g80(.a(new_n71_), .b(x1), .c(z8), .O(new_n98_));
  nand2  g81(.a(new_n84_), .b(x6), .O(new_n99_));
  ...
  oai21  g86(.a(new_n103_), .b(new_n95_), .c(new_n33_), .O(z6));
  or2    g87(.a(new_n96_), .b(new_n93_), .O(z7));
  oai21  g88(.a(new_n48_), .b(new_n21_), .c(new_n33_), .O(z9));
endmodule
