...
module FAU ( 
  ...
  nand3  g59(.a(new_n45_), .b(new_n27_), .c(new_n76_), .O(new_n77_));
  nand3  g60(.a(new_n48_), .b(new_n25_), .c(new_n18_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x1), .O(new_n80_));
  nand2  g63(.a(new_n52_), .b(new_n71_), .O(new_n81_));
  or2    g64(.a(new_n52_), .b(new_n18_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(new_n24_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n80_), .O(z4));
  nand2  g67(.a(new_n68_), .b(new_n37_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(x0), .O(new_n87_));
  nand3  g70(.a(new_n85_), .b(new_n25_), .c(new_n20_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n87_), .c(new_n36_), .O(z5));
  nand2  g72(.a(x3), .b(new_n37_), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n24_), .c(new_n36_), .O(new_n91_));
  aoi21  g74(.a(new_n90_), .b(new_n24_), .c(new_n91_), .O(z6));
  nand2  g75(.a(new_n45_), .b(new_n25_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n36_), .O(z7));
  nand2  g77(.a(new_n36_), .b(x3), .O(z8));
