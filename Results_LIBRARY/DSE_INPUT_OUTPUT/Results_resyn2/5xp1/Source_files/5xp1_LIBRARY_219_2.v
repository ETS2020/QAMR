...
module FAU ( 
  ...
  nand2  g56(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x0), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n46_), .c(new_n42_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n29_), .c(x1), .O(new_n77_));
  aoi21  g60(.a(x2), .b(x0), .c(x1), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n46_), .c(new_n42_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n77_), .O(z4));
  oai21  g63(.a(x2), .b(x1), .c(x3), .O(new_n81_));
  xnor2a g64(.a(x2), .b(x0), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n81_), .c(new_n29_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n81_), .c(new_n83_), .O(z5));
  nand3  g67(.a(x3), .b(new_n66_), .c(new_n19_), .O(new_n85_));
  oai21  g68(.a(new_n73_), .b(x2), .c(x1), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n85_), .c(new_n29_), .O(z6));
  nand3  g70(.a(new_n74_), .b(new_n29_), .c(new_n20_), .O(new_n88_));
