...
module FAU ( 
  ...
  nand3  g33(.a(new_n44_), .b(new_n50_), .c(new_n35_), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(new_n32_), .c(new_n19_), .O(new_n52_));
  ...
  nand3  g40(.a(new_n54_), .b(x5), .c(new_n27_), .O(new_n58_));
  nor2   g41(.a(x5), .b(new_n27_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x6), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n58_), .c(new_n19_), .O(new_n61_));
  aoi22  g44(.a(x6), .b(x1), .c(new_n44_), .d(new_n35_), .O(new_n62_));
  ...
  nand3  g53(.a(new_n28_), .b(new_n54_), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n28_), .b(new_n54_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n20_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n71_), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n65_), .b(new_n20_), .c(x1), .O(new_n75_));
  oai21  g58(.a(new_n65_), .b(new_n20_), .c(new_n75_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n67_), .O(z4));
  oai21  g60(.a(new_n50_), .b(new_n27_), .c(new_n35_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n54_), .c(new_n19_), .O(new_n79_));
  ...
  oai21  g66(.a(new_n83_), .b(new_n27_), .c(new_n67_), .O(new_n84_));
  aoi21  g67(.a(new_n83_), .b(new_n27_), .c(new_n84_), .O(z6));
  inv1   g68(.a(new_n54_), .O(new_n86_));
  nor2   g69(.a(x3), .b(x2), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(new_n67_), .O(z7));
  nand2  g71(.a(new_n67_), .b(x3), .O(z8));
  nand2  g72(.a(new_n26_), .b(x5), .O(new_n90_));
  nand2  g73(.a(new_n67_), .b(new_n90_), .O(z9));
endmodule
