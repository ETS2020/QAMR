...
module FAU ( 
  ...
  aoi22  g49(.a(new_n29_), .b(new_n56_), .c(x6), .d(x4), .O(new_n67_));
  nand3  g50(.a(new_n29_), .b(new_n56_), .c(x6), .O(new_n68_));
  ...
  oai21  g55(.a(new_n71_), .b(new_n20_), .c(new_n28_), .O(new_n73_));
  oai22  g56(.a(new_n73_), .b(new_n72_), .c(new_n69_), .d(new_n67_), .O(z4));
  oai21  g57(.a(new_n48_), .b(new_n28_), .c(new_n46_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n56_), .c(new_n19_), .O(new_n76_));
  nand2  g59(.a(new_n75_), .b(new_n56_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x0), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n76_), .c(new_n63_), .O(z5));
  nand2  g62(.a(x3), .b(new_n46_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n28_), .c(new_n63_), .O(new_n81_));
  aoi21  g64(.a(new_n80_), .b(new_n28_), .c(new_n81_), .O(z6));
  nor2   g65(.a(x3), .b(x2), .O(new_n83_));
  nor3   g66(.a(new_n64_), .b(new_n83_), .c(new_n57_), .O(z7));
  nor2   g67(.a(new_n64_), .b(x3), .O(z8));
  aoi21  g68(.a(new_n25_), .b(x4), .c(x6), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n24_), .c(new_n63_), .O(z9));
endmodule
