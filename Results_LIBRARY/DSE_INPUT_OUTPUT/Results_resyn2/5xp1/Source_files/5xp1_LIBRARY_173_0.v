...
module FAU ( 
  ...
  nand2  g23(.a(new_n19_), .b(new_n28_), .O(new_n41_));
  ...
  nand2  g33(.a(new_n29_), .b(new_n18_), .O(new_n51_));
  ...
  oai21  g39(.a(new_n54_), .b(new_n28_), .c(new_n56_), .O(z2));
  ...
  nor2   g60(.a(x6), .b(new_n28_), .O(new_n78_));
  ...
  and2   g77(.a(new_n30_), .b(new_n21_), .O(z9));
endmodule
