...
module FAU ( 
  ...
  nand3  g71(.a(x3), .b(new_n69_), .c(new_n20_), .O(new_n89_));
  oai21  g72(.a(new_n67_), .b(x2), .c(x1), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n55_), .O(z6));
  inv1   g74(.a(new_n55_), .O(new_n92_));
  nor2   g75(.a(new_n85_), .b(new_n92_), .O(z7));
  nor2   g76(.a(new_n92_), .b(x3), .O(z8));
