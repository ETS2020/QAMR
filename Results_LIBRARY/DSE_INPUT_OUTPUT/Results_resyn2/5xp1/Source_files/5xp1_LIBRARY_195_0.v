...
module FAU ( 
  ...
  nand2  g70(.a(new_n50_), .b(new_n24_), .O(new_n88_));
  xor2a  g71(.a(x3), .b(x2), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n88_), .c(x0), .O(new_n90_));
  nand2  g73(.a(new_n89_), .b(new_n88_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n20_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n60_), .O(new_n93_));
  inv1   g76(.a(new_n93_), .O(z5));
  nand3  g77(.a(x3), .b(new_n50_), .c(new_n24_), .O(new_n95_));
  oai21  g78(.a(new_n40_), .b(x2), .c(x1), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n60_), .O(z6));
  or2    g80(.a(new_n89_), .b(new_n59_), .O(z7));
  nor2   g81(.a(new_n59_), .b(x3), .O(z8));
  nor2   g82(.a(new_n18_), .b(new_n30_), .O(new_n100_));
  oai21  g83(.a(new_n64_), .b(x0), .c(new_n100_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n60_), .O(z9));
endmodule
