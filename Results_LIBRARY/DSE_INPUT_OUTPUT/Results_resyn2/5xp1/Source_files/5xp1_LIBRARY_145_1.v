...
module FAU ( 
  ...
  nor2   g26(.a(new_n24_), .b(new_n19_), .O(new_n44_));
  aoi21  g27(.a(new_n40_), .b(new_n27_), .c(new_n26_), .O(new_n45_));
  ...
  nand3  g32(.a(new_n49_), .b(x5), .c(new_n26_), .O(new_n50_));
  nor2   g33(.a(x5), .b(new_n26_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x6), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n50_), .c(new_n19_), .O(new_n53_));
  aoi22  g36(.a(x6), .b(x1), .c(new_n24_), .d(new_n35_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n51_), .c(x0), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n53_), .c(x4), .O(new_n56_));
  inv1   g39(.a(x3), .O(new_n57_));
  nand3  g40(.a(new_n24_), .b(new_n57_), .c(new_n35_), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n32_), .c(new_n19_), .O(new_n59_));
  nand2  g42(.a(new_n49_), .b(x5), .O(new_n60_));
  ...
  aoi21  g48(.a(new_n57_), .b(new_n19_), .c(new_n35_), .O(new_n66_));
  nand2  g49(.a(new_n20_), .b(new_n26_), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n66_), .c(new_n61_), .d(new_n65_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n63_), .c(new_n56_), .O(z3));
  aoi22  g52(.a(new_n27_), .b(new_n49_), .c(x6), .d(x4), .O(new_n70_));
  nand3  g53(.a(new_n27_), .b(new_n49_), .c(x6), .O(new_n71_));
  ...
  nor3   g68(.a(new_n85_), .b(new_n84_), .c(new_n64_), .O(z6));
  inv1   g69(.a(new_n49_), .O(new_n87_));
  nor2   g70(.a(x3), .b(x2), .O(new_n88_));
  nor3   g71(.a(new_n64_), .b(new_n88_), .c(new_n87_), .O(z7));
  nor2   g72(.a(new_n64_), .b(x3), .O(z8));
  nand2  g73(.a(new_n21_), .b(new_n19_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(x4), .O(new_n92_));
  aoi22  g75(.a(new_n92_), .b(new_n20_), .c(new_n24_), .d(x4), .O(z9));
endmodule
