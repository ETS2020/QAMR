...
module FAU ( 
  ...
  nand4  g43(.a(new_n60_), .b(new_n37_), .c(new_n34_), .d(new_n19_), .O(new_n61_));
  ...
  oai21  g49(.a(new_n64_), .b(new_n20_), .c(new_n66_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x1), .O(new_n68_));
  aoi21  g51(.a(new_n35_), .b(new_n23_), .c(x1), .O(new_n69_));
  ...
  nand4  g57(.a(new_n63_), .b(new_n74_), .c(new_n72_), .d(x0), .O(new_n75_));
  nand2  g58(.a(new_n23_), .b(x4), .O(new_n76_));
  nand2  g59(.a(new_n63_), .b(new_n72_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n73_), .c(new_n33_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(new_n79_));
  inv1   g62(.a(new_n79_), .O(z5));
  inv1   g63(.a(x2), .O(new_n81_));
  nand3  g64(.a(x3), .b(new_n81_), .c(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n58_), .b(x2), .c(x1), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n76_), .O(z6));
  nand2  g67(.a(new_n76_), .b(new_n77_), .O(z7));
