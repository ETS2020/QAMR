...
module FAU ( 
  ...
  nand3  g71(.a(x3), .b(new_n31_), .c(new_n19_), .O(new_n89_));
  oai21  g72(.a(new_n32_), .b(x2), .c(x1), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n74_), .O(z6));
  nand2  g74(.a(new_n84_), .b(new_n74_), .O(z7));
