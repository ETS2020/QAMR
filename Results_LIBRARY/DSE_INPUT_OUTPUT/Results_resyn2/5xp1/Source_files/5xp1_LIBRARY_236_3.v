...
module FAU ( 
  ...
  nand3  g26(.a(new_n43_), .b(new_n36_), .c(new_n35_), .O(z1));
  ...
  nand2  g69(.a(new_n70_), .b(new_n37_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n25_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x0), .O(new_n89_));
  nand3  g72(.a(new_n87_), .b(new_n25_), .c(new_n20_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n89_), .c(new_n36_), .O(z5));
  nand2  g74(.a(x3), .b(new_n37_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n24_), .c(new_n36_), .O(new_n93_));
  aoi21  g76(.a(new_n92_), .b(new_n24_), .c(new_n93_), .O(z6));
  nand2  g77(.a(new_n36_), .b(new_n25_), .O(new_n95_));
  aoi21  g78(.a(new_n46_), .b(new_n37_), .c(new_n95_), .O(z7));
  nand2  g79(.a(new_n36_), .b(x3), .O(z8));
  nand3  g80(.a(new_n23_), .b(new_n18_), .c(x4), .O(new_n98_));
