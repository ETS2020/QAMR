...
module FAU ( 
  ...
  and2   g15(.a(new_n28_), .b(new_n32_), .O(new_n33_));
  nand2  g16(.a(x3), .b(x2), .O(new_n34_));
  nor2   g17(.a(x3), .b(x2), .O(new_n35_));
  nand2  g18(.a(new_n34_), .b(new_n19_), .O(new_n36_));
  nand2  g19(.a(x5), .b(x0), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n27_), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n36_), .c(new_n20_), .d(x4), .O(new_n39_));
  nor2   g22(.a(new_n39_), .b(new_n33_), .O(new_n40_));
  ...
  nand2  g28(.a(new_n28_), .b(new_n32_), .O(new_n46_));
  aoi21  g29(.a(new_n34_), .b(new_n19_), .c(x6), .O(new_n47_));
  ...
  nand3  g50(.a(new_n28_), .b(new_n34_), .c(x6), .O(new_n68_));
  nand2  g51(.a(new_n28_), .b(new_n34_), .O(new_n69_));
  ...
  oai21  g71(.a(new_n35_), .b(new_n59_), .c(new_n78_), .O(z7));
  nand2  g72(.a(new_n78_), .b(x3), .O(z8));
  nand2  g73(.a(new_n26_), .b(x5), .O(new_n91_));
  nand2  g74(.a(new_n78_), .b(new_n91_), .O(z9));
endmodule
