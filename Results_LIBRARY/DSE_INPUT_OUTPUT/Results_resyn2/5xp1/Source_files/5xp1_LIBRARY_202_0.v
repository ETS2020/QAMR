...
module FAU ( 
  ...
  nand2  g58(.a(new_n19_), .b(new_n18_), .O(new_n76_));
  nand3  g59(.a(new_n74_), .b(new_n72_), .c(new_n23_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n21_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(new_n79_));
  inv1   g62(.a(new_n79_), .O(z5));
  nand2  g63(.a(x3), .b(new_n71_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n22_), .c(new_n76_), .O(new_n82_));
  aoi21  g65(.a(new_n81_), .b(new_n22_), .c(new_n82_), .O(z6));
  nand2  g66(.a(new_n74_), .b(new_n23_), .O(new_n84_));
  aoi21  g67(.a(new_n19_), .b(new_n18_), .c(new_n84_), .O(z7));
  nand2  g68(.a(new_n76_), .b(x3), .O(z8));
  nand3  g69(.a(new_n27_), .b(x5), .c(x4), .O(new_n87_));
