...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n80_, new_n81_, new_n82_, new_n83_, new_n87_, new_n88_;
  ...
  nand4  g55(.a(new_n72_), .b(new_n41_), .c(new_n22_), .d(new_n32_), .O(new_n73_));
  nand2  g56(.a(new_n41_), .b(new_n22_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x0), .O(new_n75_));
  oai21  g58(.a(x2), .b(new_n32_), .c(new_n21_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(z5));
  nor2   g61(.a(new_n21_), .b(x1), .O(new_n79_));
  inv1   g62(.a(new_n79_), .O(new_n80_));
  nand3  g63(.a(x3), .b(new_n39_), .c(x1), .O(new_n81_));
  inv1   g64(.a(new_n81_), .O(new_n82_));
  aoi21  g65(.a(x3), .b(new_n39_), .c(x1), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(z6));
  nor2   g67(.a(new_n79_), .b(new_n74_), .O(z7));
  nor2   g68(.a(new_n79_), .b(x3), .O(z8));
  nor2   g69(.a(new_n18_), .b(new_n27_), .O(new_n87_));
  oai21  g70(.a(new_n34_), .b(x6), .c(new_n87_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n80_), .O(z9));
endmodule
