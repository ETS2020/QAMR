...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n86_, new_n88_, new_n89_, new_n93_;
  ...
  oai21  g30(.a(new_n37_), .b(new_n47_), .c(new_n18_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x2), .O(new_n49_));
  oai21  g32(.a(x5), .b(x0), .c(x1), .O(new_n50_));
  aoi21  g33(.a(x5), .b(x0), .c(x4), .O(new_n51_));
  and2   g34(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n49_), .c(new_n25_), .O(new_n53_));
  nand3  g36(.a(x3), .b(x1), .c(x0), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n41_), .c(x4), .O(new_n55_));
  nand3  g38(.a(new_n54_), .b(new_n41_), .c(x4), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n25_), .c(new_n28_), .O(new_n57_));
  nor2   g40(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  aoi21  g41(.a(new_n53_), .b(new_n46_), .c(new_n58_), .O(z2));
  oai21  g42(.a(x2), .b(x1), .c(x0), .O(new_n60_));
  nand3  g43(.a(new_n47_), .b(new_n19_), .c(new_n18_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n60_), .c(new_n37_), .O(new_n62_));
  inv1   g45(.a(new_n43_), .O(new_n63_));
  aoi21  g46(.a(new_n20_), .b(new_n19_), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g52(.a(new_n69_), .b(new_n37_), .c(x0), .O(new_n70_));
  ...
  nand3  g57(.a(new_n74_), .b(new_n44_), .c(x6), .O(new_n75_));
  nand2  g58(.a(new_n74_), .b(new_n28_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(x1), .O(new_n78_));
  nand3  g61(.a(new_n44_), .b(x6), .c(new_n19_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n78_), .O(z4));
  oai22  g63(.a(new_n25_), .b(new_n28_), .c(new_n47_), .d(new_n19_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n20_), .c(new_n18_), .O(new_n82_));
  nor2   g65(.a(new_n47_), .b(x2), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x1), .O(new_n84_));
  oai21  g67(.a(new_n25_), .b(new_n47_), .c(x2), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n84_), .c(x0), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n82_), .O(z5));
  inv1   g70(.a(new_n84_), .O(new_n88_));
  aoi21  g71(.a(new_n30_), .b(x1), .c(new_n83_), .O(new_n89_));
  nor2   g72(.a(new_n89_), .b(new_n88_), .O(z6));
  oai21  g73(.a(new_n47_), .b(x2), .c(new_n85_), .O(z7));
  nand2  g74(.a(new_n30_), .b(x3), .O(z8));
  nand3  g75(.a(new_n26_), .b(x5), .c(x4), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n30_), .O(z9));
endmodule
