...
module FAU ( 
  ...
  nand3  g53(.a(new_n25_), .b(x5), .c(new_n18_), .O(new_n71_));
  ...
  nand2  g59(.a(new_n25_), .b(new_n18_), .O(new_n77_));
  nand2  g60(.a(new_n45_), .b(new_n38_), .O(new_n78_));
  ...
  nand2  g65(.a(new_n55_), .b(new_n19_), .O(new_n83_));
  nand2  g66(.a(new_n74_), .b(new_n83_), .O(new_n84_));
  nand2  g67(.a(new_n19_), .b(new_n36_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(z4));
  nand2  g69(.a(new_n45_), .b(x2), .O(new_n87_));
  ...
  nand3  g74(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(new_n92_));
  inv1   g75(.a(new_n92_), .O(z5));
  inv1   g76(.a(new_n88_), .O(new_n94_));
  aoi21  g77(.a(x3), .b(new_n38_), .c(x1), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(new_n85_), .O(z6));
  inv1   g79(.a(new_n25_), .O(new_n97_));
  oai21  g80(.a(new_n69_), .b(new_n97_), .c(new_n85_), .O(z7));
  nand2  g81(.a(new_n85_), .b(x3), .O(z8));
  aoi21  g82(.a(new_n22_), .b(x4), .c(new_n27_), .O(z9));
endmodule
