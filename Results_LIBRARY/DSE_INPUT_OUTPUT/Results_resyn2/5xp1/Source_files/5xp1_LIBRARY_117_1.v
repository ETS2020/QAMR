...
module FAU ( 
  ...
  nand2  g49(.a(new_n30_), .b(new_n45_), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n66_), .c(new_n65_), .d(new_n62_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n64_), .c(new_n57_), .O(z3));
  aoi22  g52(.a(new_n50_), .b(new_n25_), .c(x6), .d(x4), .O(new_n70_));
  nand3  g53(.a(new_n50_), .b(new_n25_), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x1), .O(new_n72_));
  aoi21  g55(.a(x6), .b(x4), .c(new_n65_), .O(new_n73_));
  nand2  g56(.a(new_n65_), .b(x6), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n45_), .O(new_n75_));
  oai22  g58(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n70_), .O(z4));
  nand2  g59(.a(new_n20_), .b(new_n19_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n50_), .c(new_n42_), .O(new_n78_));
  nand2  g61(.a(new_n77_), .b(new_n50_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x0), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n66_), .O(z5));
  nand2  g64(.a(x3), .b(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n45_), .c(new_n66_), .O(new_n83_));
  aoi21  g66(.a(new_n82_), .b(new_n45_), .c(new_n83_), .O(z6));
  nor2   g67(.a(x3), .b(x2), .O(new_n85_));
  inv1   g68(.a(new_n50_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n85_), .c(new_n66_), .O(z7));
  nand2  g70(.a(new_n66_), .b(x3), .O(z8));
