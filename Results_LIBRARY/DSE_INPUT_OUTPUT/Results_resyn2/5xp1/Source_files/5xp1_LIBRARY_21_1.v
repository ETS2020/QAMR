...
module FAU ( 
  ...
  nand2  g51(.a(x2), .b(x0), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n20_), .c(new_n68_), .O(new_n70_));
  ...
  oai21  g69(.a(new_n51_), .b(x2), .c(x1), .O(new_n87_));
  nand3  g70(.a(x3), .b(new_n81_), .c(new_n39_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n87_), .c(new_n19_), .O(z6));
