...
module FAU ( 
  ...
  oai21  g76(.a(new_n93_), .b(new_n38_), .c(new_n50_), .O(new_n94_));
  aoi21  g77(.a(new_n93_), .b(new_n38_), .c(new_n94_), .O(z6));
  nor2   g78(.a(new_n89_), .b(new_n27_), .O(z7));
  nand2  g79(.a(new_n50_), .b(x3), .O(z8));
  nand3  g80(.a(new_n23_), .b(x5), .c(x4), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n50_), .O(z9));
endmodule
