...
module FAU ( 
  ...
  oai21  g12(.a(new_n29_), .b(new_n19_), .c(new_n28_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(x6), .O(new_n31_));
  nand3  g14(.a(new_n22_), .b(x6), .c(x5), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n24_), .O(new_n33_));
  aoi21  g16(.a(new_n31_), .b(new_n27_), .c(new_n33_), .O(z1));
  ...
  nor2   g21(.a(new_n38_), .b(new_n28_), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(new_n37_), .c(x1), .O(new_n40_));
  nand2  g23(.a(x5), .b(x0), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(x6), .c(new_n28_), .O(new_n42_));
  aoi21  g25(.a(new_n21_), .b(new_n19_), .c(new_n27_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n29_), .b(new_n19_), .c(new_n27_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n22_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(x6), .c(new_n28_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n46_), .c(new_n40_), .O(z2));
  ...
  nand3  g37(.a(new_n35_), .b(new_n21_), .c(new_n18_), .O(new_n55_));
  inv1   g38(.a(new_n38_), .O(new_n56_));
  nand2  g39(.a(new_n41_), .b(new_n56_), .O(new_n57_));
  nor2   g40(.a(new_n18_), .b(new_n44_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n52_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n57_), .c(new_n55_), .O(new_n61_));
  nor2   g44(.a(x3), .b(x2), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(x0), .c(x5), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n43_), .c(new_n28_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n18_), .O(new_n65_));
  aoi21  g48(.a(new_n58_), .b(new_n52_), .c(x1), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n41_), .c(new_n56_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n65_), .c(new_n61_), .O(z3));
  nand3  g51(.a(new_n35_), .b(new_n21_), .c(new_n18_), .O(new_n69_));
  inv1   g52(.a(new_n69_), .O(new_n70_));
  aoi21  g53(.a(new_n35_), .b(new_n21_), .c(new_n18_), .O(new_n71_));
  oai21  g54(.a(new_n71_), .b(new_n70_), .c(x1), .O(new_n72_));
  oai21  g55(.a(new_n54_), .b(x6), .c(new_n66_), .O(new_n73_));
  nand2  g56(.a(new_n18_), .b(x4), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z4));
  nand2  g58(.a(new_n51_), .b(new_n44_), .O(new_n76_));
  ...
  nand2  g64(.a(x3), .b(new_n44_), .O(new_n82_));
