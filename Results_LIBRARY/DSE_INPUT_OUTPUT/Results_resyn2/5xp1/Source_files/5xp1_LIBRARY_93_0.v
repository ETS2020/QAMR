...
module FAU ( 
  ...
  inv1   g57(.a(new_n71_), .O(new_n75_));
  nand4  g58(.a(new_n72_), .b(new_n75_), .c(new_n23_), .d(new_n21_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n66_), .O(z5));
  inv1   g60(.a(x2), .O(new_n78_));
  nand3  g61(.a(x3), .b(new_n78_), .c(new_n22_), .O(new_n79_));
  inv1   g62(.a(x3), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(x2), .c(x1), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(new_n66_), .O(z6));
  nor2   g65(.a(new_n73_), .b(new_n65_), .O(z7));
  nor2   g66(.a(new_n65_), .b(x3), .O(z8));
  nand3  g67(.a(new_n27_), .b(x5), .c(x4), .O(new_n85_));
