...
module FAU ( 
  ...
  aoi21  g14(.a(new_n25_), .b(new_n24_), .c(x4), .O(new_n32_));
  oai21  g15(.a(new_n32_), .b(new_n29_), .c(new_n31_), .O(new_n33_));
  ...
  nand2  g22(.a(new_n21_), .b(x0), .O(new_n40_));
  nor2   g23(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n38_), .c(new_n35_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n34_), .O(z1));
  inv1   g26(.a(new_n22_), .O(new_n44_));
  oai21  g27(.a(new_n32_), .b(new_n44_), .c(x5), .O(new_n45_));
  nor2   g28(.a(new_n30_), .b(x0), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  oai21  g30(.a(x3), .b(x2), .c(x0), .O(new_n48_));
  nor2   g31(.a(new_n48_), .b(new_n24_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n23_), .c(new_n30_), .O(new_n50_));
  oai21  g33(.a(x3), .b(x2), .c(x1), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x4), .O(new_n52_));
  nand3  g35(.a(x6), .b(new_n36_), .c(new_n24_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n21_), .c(new_n35_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n50_), .c(new_n47_), .O(z2));
  oai21  g39(.a(x6), .b(x1), .c(x2), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n37_), .c(x0), .O(new_n58_));
  nand3  g41(.a(x6), .b(x1), .c(new_n20_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n21_), .O(new_n61_));
  aoi21  g44(.a(new_n25_), .b(new_n24_), .c(x0), .O(new_n62_));
  oai21  g45(.a(new_n44_), .b(x6), .c(new_n62_), .O(new_n63_));
  aoi21  g46(.a(new_n37_), .b(x0), .c(new_n21_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  inv1   g48(.a(x3), .O(new_n66_));
  oai21  g49(.a(new_n66_), .b(x0), .c(new_n21_), .O(new_n67_));
  aoi21  g50(.a(x5), .b(new_n20_), .c(new_n57_), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n67_), .c(new_n35_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n65_), .c(new_n61_), .O(z3));
  inv1   g53(.a(new_n35_), .O(new_n71_));
  nand2  g54(.a(new_n48_), .b(new_n25_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n19_), .O(new_n73_));
  nand3  g56(.a(new_n48_), .b(new_n25_), .c(x6), .O(new_n74_));
  ...
  oai21  g60(.a(new_n76_), .b(new_n19_), .c(new_n77_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n75_), .c(new_n71_), .O(z4));
  nand2  g62(.a(new_n66_), .b(x2), .O(new_n80_));
  nand3  g63(.a(x3), .b(new_n36_), .c(x1), .O(new_n81_));
  ...
  nand3  g67(.a(new_n84_), .b(new_n82_), .c(new_n71_), .O(new_n85_));
  inv1   g68(.a(new_n85_), .O(z5));
  inv1   g69(.a(new_n81_), .O(new_n87_));
  aoi21  g70(.a(x3), .b(new_n36_), .c(x1), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n87_), .c(new_n71_), .O(z6));
  inv1   g72(.a(new_n25_), .O(new_n90_));
  nor2   g73(.a(x3), .b(x2), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(new_n71_), .O(z7));
  nand2  g75(.a(new_n71_), .b(x3), .O(z8));
  nand3  g76(.a(new_n23_), .b(new_n19_), .c(x4), .O(new_n94_));
