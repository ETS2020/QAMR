...
module FAU ( 
  ...
  aoi22  g48(.a(new_n27_), .b(new_n32_), .c(x6), .d(x4), .O(new_n66_));
  nand3  g49(.a(new_n27_), .b(new_n32_), .c(x6), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x1), .O(new_n68_));
  nand2  g51(.a(x6), .b(x4), .O(new_n69_));
  and2   g52(.a(new_n69_), .b(new_n40_), .O(new_n70_));
  oai21  g53(.a(new_n40_), .b(new_n20_), .c(new_n26_), .O(new_n71_));
  oai22  g54(.a(new_n71_), .b(new_n70_), .c(new_n68_), .d(new_n66_), .O(z4));
  nand2  g55(.a(x3), .b(x1), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n48_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(x0), .c(new_n61_), .O(new_n76_));
  oai21  g59(.a(new_n75_), .b(x0), .c(new_n76_), .O(z5));
  nand2  g60(.a(x3), .b(new_n48_), .O(new_n78_));
  inv1   g61(.a(new_n61_), .O(new_n79_));
  oai21  g62(.a(new_n78_), .b(new_n26_), .c(new_n79_), .O(new_n80_));
  aoi21  g63(.a(new_n78_), .b(new_n26_), .c(new_n80_), .O(z6));
  nor3   g64(.a(new_n61_), .b(new_n33_), .c(new_n57_), .O(z7));
  nand2  g65(.a(new_n79_), .b(x3), .O(z8));
