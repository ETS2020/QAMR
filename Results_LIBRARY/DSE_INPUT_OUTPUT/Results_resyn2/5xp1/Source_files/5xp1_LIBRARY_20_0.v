...
module FAU ( 
  ...
  oai21  g62(.a(new_n77_), .b(new_n76_), .c(x6), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n79_), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n70_), .b(new_n21_), .c(x1), .O(new_n82_));
  oai21  g65(.a(new_n70_), .b(new_n21_), .c(new_n82_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n30_), .O(z4));
  xnor2a g67(.a(x3), .b(x2), .O(new_n85_));
  nor2   g68(.a(new_n85_), .b(new_n45_), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n18_), .c(new_n27_), .O(new_n87_));
  oai21  g70(.a(new_n86_), .b(new_n18_), .c(new_n87_), .O(z5));
  inv1   g71(.a(x2), .O(new_n89_));
  nand2  g72(.a(x3), .b(new_n89_), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n56_), .c(new_n30_), .O(new_n91_));
  aoi21  g74(.a(new_n90_), .b(new_n56_), .c(new_n91_), .O(z6));
  nand2  g75(.a(new_n85_), .b(new_n30_), .O(z7));
  nor2   g76(.a(new_n27_), .b(x3), .O(z8));
  nand3  g77(.a(new_n23_), .b(x5), .c(x4), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n30_), .O(z9));
endmodule
