...
module FAU ( 
  ...
  oai21  g07(.a(new_n24_), .b(x6), .c(x5), .O(new_n25_));
  ...
  nand3  g22(.a(new_n39_), .b(new_n36_), .c(new_n18_), .O(new_n40_));
  ...
  aoi21  g30(.a(new_n42_), .b(new_n30_), .c(new_n22_), .O(new_n48_));
  ...
  aoi21  g36(.a(new_n53_), .b(new_n34_), .c(new_n21_), .O(new_n54_));
  xnor2a g37(.a(x5), .b(x0), .O(new_n55_));
  nand2  g38(.a(new_n23_), .b(x5), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(x1), .c(new_n55_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n54_), .c(new_n18_), .O(new_n58_));
  nand3  g41(.a(new_n23_), .b(x5), .c(new_n22_), .O(new_n59_));
  nor2   g42(.a(x5), .b(new_n22_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x6), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n59_), .c(new_n21_), .O(new_n62_));
  ...
  nand2  g50(.a(new_n18_), .b(new_n22_), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n67_), .c(new_n55_), .d(new_n20_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n65_), .c(new_n58_), .O(z3));
  nand3  g53(.a(new_n30_), .b(new_n23_), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n30_), .b(new_n23_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n18_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n71_), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n66_), .b(new_n18_), .c(x1), .O(new_n75_));
  oai21  g58(.a(new_n66_), .b(new_n18_), .c(new_n75_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n20_), .O(z4));
  oai21  g60(.a(new_n52_), .b(new_n22_), .c(new_n37_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n23_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(x0), .c(new_n19_), .O(new_n80_));
  oai21  g63(.a(new_n79_), .b(x0), .c(new_n80_), .O(z5));
  oai21  g64(.a(new_n52_), .b(x2), .c(x1), .O(new_n82_));
  nand3  g65(.a(x3), .b(new_n37_), .c(new_n22_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n20_), .O(z6));
  nand2  g67(.a(new_n52_), .b(new_n37_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n23_), .c(new_n20_), .O(new_n86_));
  inv1   g69(.a(new_n86_), .O(z7));
  nor2   g70(.a(new_n19_), .b(x3), .O(z8));
  nand2  g71(.a(new_n29_), .b(x5), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n20_), .O(z9));
endmodule
