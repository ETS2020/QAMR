...
module FAU ( 
  ...
  nand2  g57(.a(new_n30_), .b(x2), .O(new_n75_));
  nand3  g58(.a(x3), .b(new_n29_), .c(x1), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n75_), .c(new_n21_), .O(new_n77_));
  nand2  g60(.a(x6), .b(new_n22_), .O(new_n78_));
  nand2  g61(.a(new_n76_), .b(new_n75_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x0), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(new_n81_));
  inv1   g64(.a(new_n81_), .O(z5));
  aoi21  g65(.a(x3), .b(new_n29_), .c(x1), .O(new_n83_));
  nand2  g66(.a(new_n78_), .b(new_n76_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(new_n83_), .O(z6));
  inv1   g68(.a(new_n61_), .O(new_n86_));
  oai21  g69(.a(new_n46_), .b(new_n86_), .c(new_n78_), .O(z7));
  nand2  g70(.a(new_n78_), .b(x3), .O(z8));
  nor2   g71(.a(new_n18_), .b(new_n35_), .O(new_n89_));
  oai21  g72(.a(new_n42_), .b(x6), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n78_), .O(z9));
endmodule
