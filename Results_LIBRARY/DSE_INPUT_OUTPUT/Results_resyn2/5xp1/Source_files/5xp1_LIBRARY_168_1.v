...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n86_, new_n88_, new_n89_, new_n93_, new_n94_;
  ...
  aoi21  g38(.a(new_n20_), .b(new_n39_), .c(new_n55_), .O(new_n56_));
  ...
  nor2   g43(.a(new_n53_), .b(new_n19_), .O(new_n61_));
  ...
  aoi21  g50(.a(new_n67_), .b(new_n56_), .c(new_n23_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n65_), .c(new_n60_), .O(z3));
  nand3  g52(.a(new_n27_), .b(new_n36_), .c(x6), .O(new_n70_));
  nand2  g53(.a(new_n27_), .b(new_n36_), .O(new_n71_));
  ...
  aoi21  g59(.a(new_n45_), .b(new_n20_), .c(x1), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n76_), .c(new_n23_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n73_), .O(z4));
  inv1   g62(.a(new_n23_), .O(new_n80_));
  nand2  g63(.a(new_n74_), .b(x2), .O(new_n81_));
  nand3  g64(.a(x3), .b(new_n55_), .c(x1), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(new_n19_), .O(new_n83_));
  ...
  aoi21  g71(.a(x3), .b(new_n55_), .c(x1), .O(new_n89_));
  nor3   g72(.a(new_n89_), .b(new_n88_), .c(new_n23_), .O(z6));
  oai21  g73(.a(new_n37_), .b(new_n62_), .c(new_n80_), .O(z7));
  nor2   g74(.a(new_n23_), .b(x3), .O(z8));
