...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n25_,
    ...
    new_n80_, new_n81_, new_n83_, new_n84_, new_n87_;
  ...
  aoi22  g49(.a(new_n44_), .b(new_n25_), .c(x6), .d(x4), .O(new_n67_));
  nand3  g50(.a(new_n44_), .b(new_n25_), .c(x6), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x1), .O(new_n69_));
  nand2  g52(.a(x6), .b(x4), .O(new_n70_));
  and2   g53(.a(new_n70_), .b(new_n40_), .O(new_n71_));
  oai21  g54(.a(new_n40_), .b(new_n20_), .c(new_n49_), .O(new_n72_));
  oai22  g55(.a(new_n72_), .b(new_n71_), .c(new_n69_), .d(new_n67_), .O(z4));
  nand2  g56(.a(x3), .b(x1), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n44_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(x0), .c(new_n61_), .O(new_n77_));
  oai21  g60(.a(new_n76_), .b(x0), .c(new_n77_), .O(z5));
  inv1   g61(.a(new_n61_), .O(new_n79_));
  oai21  g62(.a(new_n33_), .b(x2), .c(x1), .O(new_n80_));
  nand3  g63(.a(x3), .b(new_n32_), .c(new_n49_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(z6));
  nor2   g65(.a(x3), .b(x2), .O(new_n83_));
  inv1   g66(.a(new_n44_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n83_), .c(new_n79_), .O(z7));
  nor2   g68(.a(new_n61_), .b(x3), .O(z8));
  nand2  g69(.a(new_n23_), .b(x4), .O(new_n87_));
