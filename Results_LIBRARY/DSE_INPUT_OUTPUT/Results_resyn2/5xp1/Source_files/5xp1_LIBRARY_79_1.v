...
module FAU ( 
  ...
  nand2  g57(.a(new_n29_), .b(new_n22_), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n31_), .c(new_n61_), .d(new_n21_), .O(new_n76_));
  nand2  g59(.a(new_n31_), .b(new_n61_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x0), .O(new_n78_));
  oai21  g61(.a(x2), .b(new_n21_), .c(new_n28_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n22_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n76_), .O(z5));
  nand2  g64(.a(x6), .b(new_n22_), .O(new_n82_));
  nand3  g65(.a(x3), .b(new_n29_), .c(x1), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(new_n84_));
  aoi21  g67(.a(x3), .b(new_n29_), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(z6));
  nand2  g69(.a(new_n82_), .b(new_n77_), .O(z7));
  aoi21  g70(.a(x6), .b(new_n22_), .c(x3), .O(z8));
  nor2   g71(.a(new_n18_), .b(new_n35_), .O(new_n89_));
  oai21  g72(.a(new_n42_), .b(x6), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n82_), .O(z9));
endmodule
