...
module FAU ( 
  ...
  nand3  g53(.a(new_n70_), .b(new_n30_), .c(x0), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n69_), .c(x4), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n19_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n68_), .c(new_n65_), .O(z3));
  oai22  g57(.a(new_n70_), .b(new_n25_), .c(x6), .d(new_n31_), .O(new_n75_));
  nor2   g58(.a(new_n70_), .b(new_n25_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n19_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(x1), .O(new_n78_));
  inv1   g61(.a(new_n37_), .O(new_n79_));
  nand2  g62(.a(new_n57_), .b(new_n19_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n64_), .c(new_n78_), .O(z4));
  nor2   g65(.a(x2), .b(x1), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(new_n84_));
  nand2  g67(.a(new_n55_), .b(new_n61_), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n84_), .c(new_n38_), .d(x0), .O(new_n86_));
  nand2  g69(.a(new_n85_), .b(new_n38_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n83_), .c(new_n18_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n86_), .c(new_n79_), .O(new_n89_));
  inv1   g72(.a(new_n89_), .O(z5));
  nand2  g73(.a(x3), .b(new_n61_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n24_), .c(new_n79_), .O(new_n92_));
  aoi21  g75(.a(new_n91_), .b(new_n24_), .c(new_n92_), .O(z6));
  nand2  g76(.a(new_n87_), .b(new_n79_), .O(z7));
