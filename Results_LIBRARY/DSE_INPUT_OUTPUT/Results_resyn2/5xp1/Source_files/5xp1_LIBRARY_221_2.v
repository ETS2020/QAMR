...
module FAU ( 
  ...
  oai21  g63(.a(new_n80_), .b(new_n20_), .c(new_n71_), .O(new_n81_));
  aoi21  g64(.a(new_n80_), .b(new_n20_), .c(new_n81_), .O(z6));
  inv1   g65(.a(new_n71_), .O(new_n83_));
  nor2   g66(.a(new_n76_), .b(new_n83_), .O(z7));
  nor2   g67(.a(new_n83_), .b(x3), .O(z8));
  aoi21  g68(.a(x6), .b(new_n28_), .c(new_n18_), .O(z9));
endmodule
