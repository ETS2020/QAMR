...
module FAU ( 
  ...
  aoi21  g45(.a(new_n62_), .b(new_n27_), .c(new_n20_), .O(new_n63_));
  nand2  g46(.a(x6), .b(new_n24_), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n62_), .c(new_n27_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x1), .O(new_n66_));
  oai21  g49(.a(x3), .b(x0), .c(x2), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  or2    g51(.a(new_n67_), .b(new_n20_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n68_), .c(new_n41_), .O(new_n70_));
  oai21  g53(.a(new_n66_), .b(new_n63_), .c(new_n70_), .O(z4));
  nor2   g54(.a(x2), .b(x1), .O(new_n72_));
  nand2  g55(.a(new_n27_), .b(new_n58_), .O(new_n73_));
  ...
  or2    g66(.a(new_n31_), .b(x6), .O(new_n84_));
