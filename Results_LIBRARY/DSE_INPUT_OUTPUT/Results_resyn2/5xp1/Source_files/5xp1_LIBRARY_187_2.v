...
module FAU ( 
  ...
  inv1   g64(.a(new_n20_), .O(new_n82_));
  nand3  g65(.a(new_n34_), .b(new_n82_), .c(new_n23_), .O(new_n83_));
  oai21  g66(.a(new_n33_), .b(new_n20_), .c(x6), .O(new_n84_));
  ...
  nand3  g71(.a(new_n88_), .b(new_n85_), .c(new_n24_), .O(z4));
  ...
  nand3  g77(.a(x3), .b(new_n41_), .c(new_n19_), .O(new_n95_));
  oai21  g78(.a(new_n58_), .b(x2), .c(x1), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n24_), .O(z6));
  inv1   g80(.a(new_n24_), .O(new_n98_));
  nor2   g81(.a(new_n91_), .b(new_n98_), .O(z7));
  nor2   g82(.a(new_n98_), .b(x3), .O(z8));
