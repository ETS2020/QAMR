...
module FAU ( 
  ...
  nand2  g62(.a(new_n18_), .b(new_n27_), .O(new_n80_));
  oai21  g63(.a(new_n22_), .b(new_n20_), .c(new_n80_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x6), .O(new_n82_));
  nor2   g65(.a(new_n72_), .b(new_n64_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n67_), .c(new_n32_), .O(new_n84_));
  nor2   g67(.a(new_n67_), .b(new_n18_), .O(new_n85_));
  oai21  g68(.a(new_n72_), .b(new_n64_), .c(new_n85_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n84_), .c(new_n82_), .O(z4));
  nand3  g70(.a(new_n22_), .b(x6), .c(new_n18_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n28_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x0), .O(new_n90_));
  nand2  g73(.a(x6), .b(x3), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(x2), .c(new_n75_), .O(z7));
  aoi21  g75(.a(new_n75_), .b(new_n27_), .c(x0), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(z7), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n90_), .O(z5));
  aoi21  g78(.a(x6), .b(new_n50_), .c(x2), .O(new_n96_));
  oai22  g79(.a(new_n96_), .b(new_n27_), .c(new_n91_), .d(new_n80_), .O(z6));
  nor2   g80(.a(new_n19_), .b(x3), .O(z8));
