...
module FAU ( 
  ...
  nor2   g44(.a(new_n26_), .b(new_n45_), .O(new_n62_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n30_), .c(x0), .O(new_n67_));
  ...
  nand3  g61(.a(new_n78_), .b(new_n75_), .c(new_n37_), .O(z4));
  nor2   g62(.a(x2), .b(x1), .O(new_n80_));
  nand2  g63(.a(new_n47_), .b(new_n24_), .O(new_n81_));
  ...
  nand3  g67(.a(new_n84_), .b(new_n82_), .c(new_n37_), .O(z5));
  nand2  g68(.a(x3), .b(new_n45_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n23_), .c(new_n37_), .O(new_n87_));
  aoi21  g70(.a(new_n86_), .b(new_n23_), .c(new_n87_), .O(z6));
  nand2  g71(.a(new_n81_), .b(new_n37_), .O(z7));
  nand2  g72(.a(new_n37_), .b(x3), .O(z8));
  aoi21  g73(.a(new_n21_), .b(x4), .c(new_n27_), .O(z9));
endmodule
