...
module FAU ( 
  ...
  nand3  g31(.a(new_n48_), .b(x5), .c(new_n26_), .O(new_n49_));
  nor2   g32(.a(x5), .b(new_n26_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x6), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n49_), .c(new_n19_), .O(new_n52_));
  inv1   g35(.a(x2), .O(new_n53_));
  aoi22  g36(.a(x6), .b(x1), .c(new_n41_), .d(new_n53_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n50_), .c(x0), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n52_), .c(x4), .O(new_n56_));
  nand3  g39(.a(x5), .b(x3), .c(x1), .O(new_n57_));
  inv1   g40(.a(x3), .O(new_n58_));
  nand3  g41(.a(new_n41_), .b(new_n58_), .c(new_n53_), .O(new_n59_));
  aoi21  g42(.a(new_n59_), .b(new_n57_), .c(new_n19_), .O(new_n60_));
  nand2  g43(.a(new_n48_), .b(x5), .O(new_n61_));
  ...
  aoi21  g47(.a(new_n58_), .b(new_n19_), .c(new_n53_), .O(new_n65_));
  ...
  nand3  g52(.a(new_n69_), .b(new_n64_), .c(new_n56_), .O(z3));
  aoi22  g53(.a(new_n48_), .b(new_n27_), .c(x6), .d(x4), .O(new_n71_));
  nand3  g54(.a(new_n48_), .b(new_n27_), .c(x6), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x1), .O(new_n73_));
  aoi21  g56(.a(x6), .b(x4), .c(new_n65_), .O(new_n74_));
  nand2  g57(.a(new_n65_), .b(x6), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n26_), .O(new_n76_));
  oai22  g59(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n71_), .O(z4));
  oai21  g60(.a(new_n58_), .b(new_n26_), .c(new_n53_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n48_), .O(new_n79_));
  ...
  nand3  g65(.a(x3), .b(new_n53_), .c(new_n26_), .O(new_n83_));
  ...
  nand2  g70(.a(new_n67_), .b(x3), .O(z8));
  nand2  g71(.a(new_n24_), .b(x4), .O(new_n89_));
