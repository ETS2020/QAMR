...
module FAU ( 
  ...
  nand4  g42(.a(new_n27_), .b(new_n59_), .c(new_n58_), .d(x0), .O(new_n60_));
  ...
  oai22  g48(.a(new_n65_), .b(new_n39_), .c(new_n64_), .d(new_n18_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nand2  g50(.a(x5), .b(new_n21_), .O(new_n68_));
  nor2   g51(.a(new_n22_), .b(new_n58_), .O(new_n69_));
  ...
  nand2  g56(.a(new_n59_), .b(new_n58_), .O(new_n74_));
  nor2   g57(.a(x6), .b(new_n32_), .O(new_n75_));
  aoi21  g58(.a(new_n74_), .b(new_n73_), .c(new_n75_), .O(new_n76_));
  nand3  g59(.a(new_n74_), .b(new_n73_), .c(new_n22_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x1), .O(new_n78_));
  aoi21  g61(.a(new_n65_), .b(new_n22_), .c(x1), .O(new_n79_));
  oai21  g62(.a(new_n75_), .b(new_n65_), .c(new_n79_), .O(new_n80_));
  oai21  g63(.a(new_n78_), .b(new_n76_), .c(new_n80_), .O(z4));
  nor2   g64(.a(x2), .b(x1), .O(new_n82_));
  nand2  g65(.a(new_n74_), .b(new_n38_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n82_), .c(x0), .O(new_n84_));
  nor2   g67(.a(new_n83_), .b(new_n82_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n21_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n84_), .c(new_n31_), .O(z5));
  nand3  g70(.a(x3), .b(new_n58_), .c(new_n18_), .O(new_n88_));
  oai21  g71(.a(new_n59_), .b(x2), .c(x1), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n88_), .c(new_n31_), .O(z6));
  nor2   g73(.a(new_n83_), .b(new_n28_), .O(z7));
  nor2   g74(.a(new_n28_), .b(x3), .O(z8));
  nand3  g75(.a(new_n24_), .b(x5), .c(x4), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n31_), .O(z9));
endmodule
