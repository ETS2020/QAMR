...
module FAU ( 
  ...
  inv1   g45(.a(new_n45_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x6), .O(new_n64_));
  nand2  g47(.a(x3), .b(x0), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n47_), .c(new_n35_), .O(new_n66_));
  oai21  g49(.a(new_n64_), .b(new_n21_), .c(new_n66_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x1), .O(new_n68_));
  aoi21  g51(.a(new_n35_), .b(new_n19_), .c(x1), .O(new_n69_));
  oai21  g52(.a(new_n47_), .b(new_n35_), .c(new_n69_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n68_), .O(z4));
  ...
  nor2   g60(.a(new_n74_), .b(new_n72_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n33_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(z5));
  inv1   g63(.a(x2), .O(new_n81_));
  nand3  g64(.a(x3), .b(new_n81_), .c(new_n20_), .O(new_n82_));
  oai21  g65(.a(new_n58_), .b(x2), .c(x1), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n77_), .O(z6));
  nand2  g67(.a(new_n77_), .b(new_n74_), .O(z7));
  nor2   g68(.a(new_n76_), .b(x3), .O(z8));
  nand3  g69(.a(x6), .b(x5), .c(x4), .O(new_n87_));
