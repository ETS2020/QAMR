...
module FAU ( 
  ...
  nand2  g18(.a(new_n21_), .b(new_n19_), .O(new_n36_));
  nand2  g19(.a(new_n33_), .b(new_n19_), .O(new_n37_));
  ...
  oai21  g26(.a(new_n30_), .b(x5), .c(new_n22_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(x6), .c(new_n18_), .O(new_n45_));
  nand2  g28(.a(x5), .b(x0), .O(new_n46_));
  aoi21  g29(.a(new_n46_), .b(new_n18_), .c(x6), .O(new_n47_));
  aoi22  g30(.a(new_n21_), .b(new_n19_), .c(new_n33_), .d(new_n38_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n34_), .c(new_n47_), .O(new_n49_));
  ...
  nand2  g36(.a(new_n35_), .b(x4), .O(new_n54_));
  aoi21  g37(.a(x6), .b(x2), .c(x1), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n53_), .c(new_n19_), .O(new_n57_));
  nand3  g40(.a(x6), .b(x1), .c(new_n19_), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n57_), .c(new_n33_), .O(new_n60_));
  oai21  g43(.a(new_n21_), .b(new_n20_), .c(new_n35_), .O(new_n61_));
  aoi21  g44(.a(new_n21_), .b(new_n20_), .c(x0), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  oai21  g46(.a(x6), .b(x3), .c(x1), .O(new_n64_));
  oai21  g47(.a(x6), .b(new_n18_), .c(x5), .O(new_n65_));
  aoi21  g48(.a(new_n64_), .b(x0), .c(new_n65_), .O(new_n66_));
  oai21  g49(.a(new_n37_), .b(new_n39_), .c(new_n46_), .O(new_n67_));
  ...
  nor2   g55(.a(new_n51_), .b(new_n19_), .O(new_n73_));
  nand2  g56(.a(new_n52_), .b(new_n21_), .O(new_n74_));
  ...
  aoi21  g60(.a(new_n77_), .b(new_n35_), .c(x1), .O(new_n78_));
  oai21  g61(.a(new_n77_), .b(new_n52_), .c(new_n78_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n76_), .O(z4));
  inv1   g63(.a(new_n29_), .O(new_n81_));
  nand4  g64(.a(new_n40_), .b(new_n81_), .c(new_n21_), .d(x0), .O(new_n82_));
  nand2  g65(.a(new_n40_), .b(new_n21_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n29_), .c(new_n19_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n82_), .c(new_n54_), .O(new_n85_));
  inv1   g68(.a(new_n85_), .O(z5));
  nand3  g69(.a(x3), .b(new_n38_), .c(new_n20_), .O(new_n87_));
  oai21  g70(.a(new_n39_), .b(x2), .c(x1), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n87_), .c(new_n54_), .O(z6));
  inv1   g72(.a(new_n54_), .O(new_n90_));
  nor2   g73(.a(new_n83_), .b(new_n90_), .O(z7));
  nand2  g74(.a(new_n54_), .b(x3), .O(z8));
  aoi21  g75(.a(x6), .b(new_n33_), .c(new_n18_), .O(z9));
endmodule
