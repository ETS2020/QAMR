...
module FAU ( 
  ...
  aoi21  g66(.a(new_n80_), .b(new_n21_), .c(new_n83_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n82_), .O(z5));
  nand3  g68(.a(x3), .b(new_n45_), .c(new_n20_), .O(new_n86_));
  oai21  g69(.a(new_n46_), .b(x2), .c(x1), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n86_), .c(new_n54_), .O(z6));
  nand3  g71(.a(new_n47_), .b(new_n54_), .c(new_n61_), .O(new_n89_));
  inv1   g72(.a(new_n89_), .O(z7));
  nor2   g73(.a(new_n83_), .b(x3), .O(z8));
  nand3  g74(.a(x6), .b(x5), .c(x4), .O(new_n92_));
