...
module FAU ( 
  ...
  nand3  g33(.a(new_n43_), .b(new_n50_), .c(new_n19_), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(new_n31_), .c(new_n42_), .O(new_n52_));
  ...
  oai21  g39(.a(new_n56_), .b(new_n52_), .c(new_n30_), .O(new_n57_));
  nand3  g40(.a(new_n54_), .b(x5), .c(new_n45_), .O(new_n58_));
  nor2   g41(.a(x5), .b(new_n45_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x6), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n58_), .c(new_n42_), .O(new_n61_));
  aoi22  g44(.a(x6), .b(x1), .c(new_n43_), .d(new_n19_), .O(new_n62_));
  ...
  nand4  g51(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n53_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n64_), .c(new_n57_), .O(z3));
  nand3  g53(.a(new_n54_), .b(new_n25_), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n54_), .b(new_n25_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n30_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n71_), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n65_), .b(new_n30_), .c(x1), .O(new_n75_));
  oai21  g58(.a(new_n65_), .b(new_n30_), .c(new_n75_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n67_), .O(z4));
  nand2  g60(.a(new_n20_), .b(new_n19_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n54_), .c(new_n42_), .O(new_n79_));
  nand2  g62(.a(new_n78_), .b(new_n54_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x0), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n79_), .c(new_n67_), .O(z5));
  oai21  g65(.a(new_n50_), .b(x2), .c(x1), .O(new_n83_));
  nand3  g66(.a(x3), .b(new_n19_), .c(new_n45_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n83_), .c(new_n67_), .O(z6));
  nor2   g68(.a(x3), .b(x2), .O(new_n86_));
  inv1   g69(.a(new_n54_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(new_n67_), .O(z7));
  nand2  g71(.a(new_n67_), .b(x3), .O(z8));
  inv1   g72(.a(new_n24_), .O(z9));
endmodule
