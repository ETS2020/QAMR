...
module FAU ( 
  ...
  nor2   g03(.a(x14), .b(x10), .O(new_n25_));
  ...
  aoi21  g16(.a(new_n37_), .b(new_n34_), .c(new_n25_), .O(z1));
  ...
  aoi21  g23(.a(new_n44_), .b(new_n22_), .c(new_n36_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(new_n25_), .O(z2));
  nor2   g25(.a(new_n23_), .b(x09), .O(new_n47_));
  nand3  g26(.a(new_n40_), .b(new_n47_), .c(x13), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nand2  g28(.a(new_n41_), .b(new_n49_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n22_), .c(new_n36_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n51_), .c(new_n25_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  oai22  g35(.a(new_n56_), .b(new_n55_), .c(x14), .d(x10), .O(z4));
endmodule
