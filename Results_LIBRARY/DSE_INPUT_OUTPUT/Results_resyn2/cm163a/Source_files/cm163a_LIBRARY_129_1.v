...
module FAU ( 
  ...
  nand3  g14(.a(x04), .b(x03), .c(x02), .O(new_n36_));
  inv1   g15(.a(new_n36_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(new_n35_), .c(new_n26_), .O(new_n38_));
  inv1   g17(.a(x09), .O(new_n39_));
  nand4  g18(.a(new_n29_), .b(new_n39_), .c(x03), .d(x02), .O(new_n40_));
  and2   g19(.a(x12), .b(x04), .O(new_n41_));
  nor2   g20(.a(x06), .b(x04), .O(new_n42_));
  aoi21  g21(.a(new_n41_), .b(new_n40_), .c(new_n42_), .O(new_n43_));
  oai22  g22(.a(new_n43_), .b(new_n26_), .c(new_n38_), .d(x09), .O(z2));
  inv1   g23(.a(x13), .O(new_n45_));
  nand3  g24(.a(new_n37_), .b(new_n35_), .c(new_n45_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x05), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n39_), .O(new_n48_));
  aoi21  g27(.a(new_n35_), .b(new_n30_), .c(new_n45_), .O(new_n49_));
  aoi21  g28(.a(x07), .b(new_n22_), .c(new_n26_), .O(new_n50_));
  oai21  g29(.a(new_n49_), .b(new_n22_), .c(new_n50_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n48_), .O(z3));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  nand3  g32(.a(x15), .b(x14), .c(x10), .O(new_n54_));
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(new_n39_), .d(x05), .O(z4));
endmodule
