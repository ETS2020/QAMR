...
module FAU ( 
  ...
  nand3  g14(.a(x12), .b(new_n35_), .c(x04), .O(new_n36_));
  oai21  g15(.a(new_n36_), .b(new_n23_), .c(x05), .O(new_n37_));
  inv1   g16(.a(x12), .O(new_n38_));
  nand4  g17(.a(new_n35_), .b(new_n29_), .c(x03), .d(x02), .O(new_n39_));
  ...
  aoi22  g22(.a(new_n43_), .b(new_n41_), .c(new_n37_), .d(new_n29_), .O(z2));
  inv1   g23(.a(new_n23_), .O(new_n45_));
  nor2   g24(.a(x12), .b(x11), .O(new_n46_));
  and2   g25(.a(x13), .b(x04), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x05), .c(x09), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nand2  g29(.a(new_n38_), .b(new_n35_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n30_), .c(new_n50_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x04), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n22_), .c(new_n26_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x09), .d(x05), .O(z4));
endmodule
