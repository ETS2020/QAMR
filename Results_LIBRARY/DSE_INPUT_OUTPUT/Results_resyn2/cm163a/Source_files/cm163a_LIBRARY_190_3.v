...
module FAU ( 
  ...
  nand2  g04(.a(x13), .b(x08), .O(new_n26_));
  ...
  inv1   g08(.a(new_n26_), .O(new_n30_));
  ...
  aoi21  g18(.a(new_n39_), .b(new_n36_), .c(new_n30_), .O(z1));
  nor2   g19(.a(new_n23_), .b(x09), .O(new_n41_));
  nor2   g20(.a(x12), .b(x11), .O(new_n42_));
  aoi22  g21(.a(new_n42_), .b(new_n41_), .c(new_n34_), .d(x12), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n27_), .O(new_n45_));
  ...
  aoi22  g28(.a(new_n42_), .b(new_n41_), .c(x13), .d(new_n49_), .O(new_n50_));
  nand3  g29(.a(new_n42_), .b(new_n41_), .c(x13), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x04), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n50_), .c(new_n48_), .O(z3));
  inv1   g32(.a(x13), .O(new_n54_));
  nand4  g33(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n54_), .c(new_n49_), .O(z4));
endmodule
