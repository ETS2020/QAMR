...
module FAU ( 
  ...
  nor2   g01(.a(x10), .b(new_n22_), .O(new_n23_));
  inv1   g02(.a(x04), .O(new_n24_));
  nand2  g03(.a(new_n24_), .b(x00), .O(new_n25_));
  nand2  g04(.a(x03), .b(x02), .O(new_n26_));
  aoi21  g05(.a(new_n26_), .b(x09), .c(new_n24_), .O(new_n27_));
  oai21  g06(.a(new_n26_), .b(x09), .c(new_n27_), .O(new_n28_));
  ...
  oai21  g14(.a(new_n32_), .b(new_n24_), .c(x10), .O(new_n36_));
  oai21  g15(.a(x04), .b(x01), .c(x05), .O(new_n37_));
  aoi21  g16(.a(new_n36_), .b(x09), .c(new_n37_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n35_), .O(z1));
  inv1   g18(.a(x12), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(x05), .c(x04), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x10), .c(new_n22_), .O(new_n42_));
  nand2  g21(.a(x06), .b(new_n24_), .O(new_n43_));
  nand2  g22(.a(new_n33_), .b(x12), .O(new_n44_));
  nand4  g23(.a(new_n40_), .b(new_n32_), .c(x03), .d(x02), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n44_), .c(x04), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n43_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x05), .c(new_n42_), .O(z2));
  inv1   g27(.a(x13), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n22_), .c(new_n45_), .O(new_n50_));
  nand2  g29(.a(new_n45_), .b(new_n49_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x04), .O(new_n52_));
  oai21  g31(.a(new_n49_), .b(new_n24_), .c(x10), .O(new_n53_));
