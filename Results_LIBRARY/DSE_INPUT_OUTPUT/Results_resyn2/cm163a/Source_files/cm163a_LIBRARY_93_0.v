...
module FAU ( 
  ...
  nor2   g12(.a(new_n26_), .b(x09), .O(new_n34_));
  ...
  nand2  g18(.a(new_n39_), .b(new_n23_), .O(z1));
  oai21  g19(.a(new_n25_), .b(x11), .c(x12), .O(new_n41_));
  nor2   g20(.a(x12), .b(x11), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n34_), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n41_), .c(x04), .O(new_n44_));
  aoi21  g23(.a(x06), .b(new_n29_), .c(new_n22_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n23_), .O(z2));
  inv1   g26(.a(x13), .O(new_n48_));
  nand3  g27(.a(new_n42_), .b(new_n34_), .c(new_n48_), .O(new_n49_));
  inv1   g28(.a(x12), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n33_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n25_), .c(x13), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n49_), .c(x04), .O(new_n53_));
  aoi21  g32(.a(x07), .b(new_n29_), .c(new_n22_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n23_), .O(z3));
  nand3  g35(.a(x15), .b(x14), .c(x10), .O(new_n57_));
  nor2   g36(.a(x06), .b(x05), .O(new_n58_));
