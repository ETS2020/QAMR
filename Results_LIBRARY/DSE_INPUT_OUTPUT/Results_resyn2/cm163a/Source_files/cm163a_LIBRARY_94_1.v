...
module FAU ( 
  ...
  nand3  g12(.a(new_n31_), .b(x03), .c(x02), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x11), .O(new_n35_));
  nand3  g14(.a(new_n35_), .b(new_n33_), .c(x04), .O(new_n36_));
  aoi21  g15(.a(new_n22_), .b(x01), .c(new_n26_), .O(new_n37_));
  ...
  aoi22  g20(.a(new_n41_), .b(new_n40_), .c(new_n33_), .d(x12), .O(new_n42_));
  aoi21  g21(.a(new_n29_), .b(new_n22_), .c(new_n26_), .O(new_n43_));
  oai21  g22(.a(new_n42_), .b(new_n22_), .c(new_n43_), .O(z2));
  inv1   g23(.a(x13), .O(new_n45_));
  nand3  g24(.a(new_n41_), .b(new_n40_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n32_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n34_), .c(x13), .O(new_n49_));
  ...
  nand2  g31(.a(new_n52_), .b(new_n30_), .O(z3));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  nand3  g33(.a(x15), .b(x14), .c(x10), .O(new_n55_));
  oai22  g34(.a(new_n55_), .b(new_n54_), .c(new_n29_), .d(x05), .O(z4));
endmodule
