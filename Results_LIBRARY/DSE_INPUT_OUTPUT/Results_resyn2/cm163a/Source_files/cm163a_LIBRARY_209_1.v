...
module FAU ( 
  ...
  oai21  g11(.a(new_n32_), .b(new_n22_), .c(new_n29_), .O(z1));
  nor2   g12(.a(new_n23_), .b(x09), .O(new_n34_));
  inv1   g13(.a(x11), .O(new_n35_));
  nand4  g14(.a(new_n35_), .b(new_n30_), .c(x03), .d(x02), .O(new_n36_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n31_), .c(new_n43_), .O(new_n46_));
