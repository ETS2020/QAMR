...
module FAU ( 
  ...
  oai21  g09(.a(new_n25_), .b(x09), .c(x11), .O(new_n31_));
  ...
  nor2   g22(.a(new_n25_), .b(x11), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n32_), .c(x12), .O(new_n45_));
  nand3  g24(.a(new_n44_), .b(x12), .c(new_n32_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n41_), .c(x04), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n45_), .c(new_n43_), .O(z2));
  inv1   g27(.a(x12), .O(new_n49_));
  nand3  g28(.a(new_n44_), .b(new_n49_), .c(new_n32_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x13), .c(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n23_), .c(new_n38_), .O(new_n53_));
