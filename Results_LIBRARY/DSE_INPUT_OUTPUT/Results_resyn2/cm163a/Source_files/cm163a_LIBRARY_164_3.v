...
module FAU ( 
  ...
  nand4  g06(.a(new_n27_), .b(new_n24_), .c(new_n22_), .d(x05), .O(z0));
  ...
  aoi21  g11(.a(new_n26_), .b(x01), .c(x09), .O(new_n33_));
  oai21  g12(.a(new_n32_), .b(new_n30_), .c(new_n33_), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x05), .O(z1));
  inv1   g14(.a(x12), .O(new_n36_));
  nor2   g15(.a(new_n30_), .b(new_n36_), .O(new_n37_));
  nand4  g16(.a(new_n36_), .b(new_n31_), .c(x03), .d(x02), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x04), .O(new_n39_));
  aoi21  g18(.a(x06), .b(new_n26_), .c(x09), .O(new_n40_));
  ...
  aoi21  g25(.a(x07), .b(new_n26_), .c(x09), .O(new_n47_));
