...
module FAU ( 
  ...
  xor2a  g11(.a(new_n24_), .b(x11), .O(new_n33_));
  inv1   g12(.a(x01), .O(new_n34_));
  aoi21  g13(.a(new_n30_), .b(new_n34_), .c(new_n22_), .O(new_n35_));
  oai21  g14(.a(new_n33_), .b(new_n30_), .c(new_n35_), .O(z1));
  nor2   g15(.a(x12), .b(x11), .O(new_n37_));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n38_));
  inv1   g17(.a(new_n38_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n22_), .O(new_n40_));
  inv1   g19(.a(x11), .O(new_n41_));
  nand4  g20(.a(new_n41_), .b(new_n23_), .c(x03), .d(x02), .O(new_n42_));
  and2   g21(.a(x12), .b(x04), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  aoi21  g23(.a(new_n43_), .b(new_n42_), .c(new_n44_), .O(new_n45_));
  oai22  g24(.a(new_n45_), .b(new_n22_), .c(new_n40_), .d(x09), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nand3  g26(.a(new_n39_), .b(new_n37_), .c(new_n47_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  nor2   g29(.a(new_n25_), .b(x09), .O(new_n51_));
  aoi21  g30(.a(new_n37_), .b(new_n51_), .c(new_n47_), .O(new_n52_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(new_n23_), .d(x05), .O(z4));
endmodule
