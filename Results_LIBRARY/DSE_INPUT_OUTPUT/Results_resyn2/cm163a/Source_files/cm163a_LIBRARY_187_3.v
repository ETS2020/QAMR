...
module FAU ( 
  ...
  nand2  g00(.a(x13), .b(x07), .O(new_n22_));
  ...
  nand4  g27(.a(new_n48_), .b(new_n41_), .c(x03), .d(x02), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x13), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x04), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n47_), .O(new_n52_));
  inv1   g31(.a(new_n49_), .O(new_n53_));
  nor2   g32(.a(x13), .b(new_n30_), .O(new_n54_));
  aoi22  g33(.a(new_n54_), .b(new_n53_), .c(new_n22_), .d(new_n31_), .O(new_n55_));
