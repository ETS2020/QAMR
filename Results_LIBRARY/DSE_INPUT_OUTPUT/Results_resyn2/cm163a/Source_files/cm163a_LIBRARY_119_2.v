...
module FAU ( 
  ...
  and2   g06(.a(new_n27_), .b(new_n24_), .O(new_n28_));
  ...
  nand2  g12(.a(new_n27_), .b(new_n24_), .O(new_n34_));
  xor2a  g13(.a(new_n34_), .b(x11), .O(new_n35_));
  inv1   g14(.a(x01), .O(new_n36_));
  aoi21  g15(.a(new_n23_), .b(new_n36_), .c(new_n30_), .O(new_n37_));
  oai21  g16(.a(new_n35_), .b(new_n23_), .c(new_n37_), .O(z1));
  ...
  nand2  g21(.a(new_n41_), .b(new_n39_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x04), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n23_), .c(new_n30_), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n42_), .c(new_n46_), .O(z2));
  inv1   g26(.a(x13), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n23_), .c(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  nor2   g29(.a(x12), .b(x11), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n27_), .c(new_n48_), .d(new_n24_), .O(new_n52_));
  nand4  g31(.a(new_n39_), .b(new_n40_), .c(new_n24_), .d(x02), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(x13), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n52_), .c(x04), .O(new_n55_));
  aoi21  g34(.a(x07), .b(new_n23_), .c(new_n30_), .O(new_n56_));
  ...
  aoi21  g38(.a(new_n59_), .b(x05), .c(new_n22_), .O(z4));
endmodule
