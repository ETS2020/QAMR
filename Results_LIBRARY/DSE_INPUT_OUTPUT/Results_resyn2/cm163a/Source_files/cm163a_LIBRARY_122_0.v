...
module FAU ( 
  ...
  nand4  g29(.a(new_n50_), .b(new_n40_), .c(new_n33_), .d(x10), .O(new_n51_));
  inv1   g30(.a(new_n51_), .O(new_n52_));
  aoi22  g31(.a(new_n52_), .b(new_n26_), .c(new_n49_), .d(x13), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n29_), .c(new_n47_), .O(z3));
