...
module FAU ( 
  ...
  nand4  g08(.a(new_n29_), .b(new_n27_), .c(x09), .d(x05), .O(z1));
  nand2  g09(.a(x12), .b(x04), .O(new_n31_));
  inv1   g10(.a(x06), .O(new_n32_));
  nand2  g11(.a(new_n32_), .b(new_n23_), .O(new_n33_));
  nand4  g12(.a(new_n33_), .b(new_n31_), .c(x09), .d(x05), .O(z2));
  nand2  g13(.a(x07), .b(new_n23_), .O(new_n35_));
  inv1   g14(.a(x13), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x04), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n35_), .c(x09), .O(new_n38_));
