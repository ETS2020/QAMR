...
module FAU ( 
  ...
  nand3  g25(.a(new_n42_), .b(new_n27_), .c(x13), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  inv1   g27(.a(x12), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n40_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n34_), .c(new_n48_), .O(new_n51_));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n52_), .c(new_n23_), .O(z3));
  nand2  g34(.a(x07), .b(x03), .O(new_n56_));
