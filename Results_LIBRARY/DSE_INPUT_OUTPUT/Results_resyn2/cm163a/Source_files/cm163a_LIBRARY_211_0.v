...
module FAU ( 
  ...
  nor2   g00(.a(x13), .b(x09), .O(new_n22_));
  ...
  aoi21  g08(.a(new_n29_), .b(x05), .c(new_n22_), .O(z0));
  ...
  aoi21  g17(.a(new_n23_), .b(new_n37_), .c(new_n38_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n36_), .c(new_n22_), .O(z1));
  oai21  g19(.a(x06), .b(x04), .c(x05), .O(new_n41_));
  oai21  g20(.a(x13), .b(x09), .c(new_n41_), .O(new_n42_));
  oai21  g21(.a(new_n25_), .b(x11), .c(x13), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n33_), .O(new_n44_));
  nor2   g23(.a(new_n34_), .b(x12), .O(new_n45_));
  aoi22  g24(.a(new_n45_), .b(x13), .c(new_n44_), .d(x12), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n23_), .c(new_n42_), .O(z2));
  nand2  g26(.a(x13), .b(x04), .O(new_n48_));
  nor2   g27(.a(x07), .b(x04), .O(new_n49_));
  nor3   g28(.a(new_n49_), .b(new_n22_), .c(new_n38_), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n45_), .c(new_n50_), .O(z3));
  nand3  g30(.a(x15), .b(x14), .c(x10), .O(new_n52_));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  nor3   g32(.a(new_n53_), .b(new_n52_), .c(new_n22_), .O(z4));
endmodule
