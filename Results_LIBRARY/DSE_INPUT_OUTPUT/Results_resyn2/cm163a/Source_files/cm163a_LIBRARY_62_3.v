...
module FAU ( 
  ...
  aoi21  g13(.a(new_n27_), .b(x01), .c(x08), .O(new_n35_));
  ...
  nor3   g21(.a(new_n42_), .b(x08), .c(new_n41_), .O(new_n43_));
  ...
  aoi21  g29(.a(x07), .b(new_n27_), .c(x08), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x05), .O(z3));
  nand2  g32(.a(new_n41_), .b(x03), .O(new_n54_));
