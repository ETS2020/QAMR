...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_,
    ...
    new_n40_, new_n41_;
  oai21  g00(.a(x09), .b(x02), .c(x04), .O(new_n22_));
  ...
  nand2  g18(.a(x04), .b(x02), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(x08), .c(x03), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n39_), .O(z4));
endmodule
