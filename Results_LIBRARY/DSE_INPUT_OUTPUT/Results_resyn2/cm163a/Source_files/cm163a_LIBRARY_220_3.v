...
module FAU ( 
  ...
  nand2  g04(.a(x13), .b(x12), .O(new_n26_));
  ...
  nor2   g20(.a(new_n34_), .b(new_n41_), .O(new_n42_));
  nand2  g21(.a(new_n34_), .b(new_n41_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x04), .O(new_n44_));
  nor2   g23(.a(x06), .b(x04), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n27_), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n42_), .c(new_n46_), .O(z2));
  oai21  g26(.a(x07), .b(x04), .c(x05), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n26_), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nor2   g29(.a(new_n34_), .b(new_n50_), .O(new_n51_));
  nand2  g30(.a(new_n34_), .b(new_n50_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n41_), .c(x04), .O(new_n53_));
