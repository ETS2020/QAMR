...
module FAU ( 
  ...
  nand4  g26(.a(new_n47_), .b(new_n42_), .c(x03), .d(x02), .O(new_n48_));
  nor2   g27(.a(new_n43_), .b(new_n22_), .O(new_n49_));
  nor2   g28(.a(x07), .b(x04), .O(new_n50_));
  aoi21  g29(.a(new_n49_), .b(new_n48_), .c(new_n50_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n26_), .c(new_n46_), .O(z3));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  aoi21  g32(.a(x12), .b(new_n26_), .c(new_n53_), .O(new_n54_));
