...
module FAU ( 
  ...
  nor2   g14(.a(x05), .b(new_n25_), .O(new_n36_));
  inv1   g15(.a(x12), .O(new_n37_));
  xor2a  g16(.a(new_n32_), .b(new_n37_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x04), .O(new_n39_));
  inv1   g18(.a(x06), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n22_), .c(new_n26_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n39_), .c(new_n36_), .O(z2));
  nor2   g21(.a(x11), .b(x09), .O(new_n43_));
  nand4  g22(.a(new_n43_), .b(new_n37_), .c(x03), .d(x02), .O(new_n44_));
  xor2a  g23(.a(new_n44_), .b(x13), .O(new_n45_));
  ...
  oai22  g29(.a(new_n50_), .b(new_n49_), .c(x05), .d(new_n25_), .O(z4));
endmodule
