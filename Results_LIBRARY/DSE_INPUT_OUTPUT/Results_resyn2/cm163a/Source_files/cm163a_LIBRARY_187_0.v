...
module FAU ( 
  ...
  nor2   g00(.a(x13), .b(x07), .O(new_n22_));
  ...
  nand2  g29(.a(new_n50_), .b(x07), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n49_), .c(new_n40_), .O(new_n52_));
  oai21  g31(.a(new_n34_), .b(x12), .c(new_n50_), .O(new_n53_));
