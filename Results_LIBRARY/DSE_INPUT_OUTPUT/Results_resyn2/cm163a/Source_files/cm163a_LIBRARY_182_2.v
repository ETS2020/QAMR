...
module FAU ( 
  ...
  oai21  g25(.a(new_n46_), .b(new_n30_), .c(x13), .O(new_n47_));
  ...
  inv1   g29(.a(new_n23_), .O(new_n51_));
  oai21  g30(.a(x07), .b(x04), .c(x05), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nor2   g32(.a(new_n25_), .b(x09), .O(new_n54_));
  nand3  g33(.a(new_n42_), .b(new_n54_), .c(x13), .O(new_n55_));
  inv1   g34(.a(x13), .O(new_n56_));
  nand2  g35(.a(new_n46_), .b(new_n35_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n24_), .c(new_n56_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n55_), .c(x04), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(new_n53_), .O(z3));
  nand2  g39(.a(x08), .b(x03), .O(new_n61_));
  nand3  g40(.a(x15), .b(x14), .c(x10), .O(new_n62_));
  oai21  g41(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(z4));
endmodule
