...
module FAU ( 
  ...
  oai21  g10(.a(new_n23_), .b(x09), .c(new_n31_), .O(new_n32_));
  ...
  aoi21  g15(.a(new_n36_), .b(new_n33_), .c(new_n26_), .O(z1));
  ...
  oai21  g19(.a(new_n40_), .b(x09), .c(new_n38_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x04), .O(new_n42_));
  oai21  g21(.a(new_n39_), .b(new_n22_), .c(x13), .O(new_n43_));
  oai21  g22(.a(x06), .b(x04), .c(x05), .O(new_n44_));
  aoi21  g23(.a(new_n43_), .b(x09), .c(new_n44_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n42_), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nand2  g26(.a(new_n40_), .b(new_n47_), .O(new_n48_));
  nor2   g27(.a(new_n23_), .b(x11), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(x13), .c(new_n39_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n51_));
  nand2  g30(.a(x13), .b(new_n22_), .O(new_n52_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x13), .d(new_n25_), .O(z4));
endmodule
