...
module FAU ( 
  ...
  nor2   g09(.a(x04), .b(x01), .O(new_n31_));
  nor3   g10(.a(new_n31_), .b(new_n30_), .c(x00), .O(new_n32_));
  oai21  g11(.a(new_n29_), .b(new_n28_), .c(new_n32_), .O(z1));
  oai21  g12(.a(new_n24_), .b(x11), .c(x12), .O(new_n34_));
