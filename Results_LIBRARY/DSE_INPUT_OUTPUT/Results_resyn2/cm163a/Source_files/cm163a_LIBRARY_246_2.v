...
module FAU ( 
  ...
  xnor2a g03(.a(new_n24_), .b(x09), .O(new_n25_));
  ...
  oai21  g20(.a(new_n41_), .b(new_n28_), .c(x09), .O(new_n42_));
  oai21  g21(.a(x06), .b(x04), .c(x05), .O(new_n43_));
  aoi21  g22(.a(new_n42_), .b(x08), .c(new_n43_), .O(new_n44_));
  oai21  g23(.a(new_n40_), .b(new_n28_), .c(new_n44_), .O(z2));
  inv1   g24(.a(new_n24_), .O(new_n46_));
  nand4  g25(.a(new_n33_), .b(new_n46_), .c(x13), .d(new_n41_), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  oai21  g27(.a(new_n34_), .b(x12), .c(new_n48_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n47_), .c(x04), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n28_), .c(x09), .O(new_n51_));
  oai21  g30(.a(x07), .b(x04), .c(x05), .O(new_n52_));
  aoi21  g31(.a(new_n51_), .b(x08), .c(new_n52_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n50_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  nand4  g34(.a(x15), .b(x14), .c(x10), .d(x09), .O(new_n56_));
