...
module FAU ( 
  ...
  aoi21  g11(.a(new_n32_), .b(new_n31_), .c(new_n27_), .O(new_n33_));
  nand2  g12(.a(new_n24_), .b(new_n23_), .O(new_n34_));
  nor2   g13(.a(x04), .b(x01), .O(new_n35_));
  and2   g14(.a(x11), .b(x04), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(new_n34_), .c(new_n35_), .O(new_n37_));
  oai22  g16(.a(new_n37_), .b(new_n27_), .c(new_n33_), .d(new_n30_), .O(z1));
  inv1   g17(.a(x12), .O(new_n39_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n39_), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x05), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x03), .O(new_n42_));
  aoi21  g21(.a(new_n31_), .b(new_n24_), .c(new_n39_), .O(new_n43_));
  aoi21  g22(.a(x06), .b(new_n22_), .c(new_n27_), .O(new_n44_));
  oai21  g23(.a(new_n43_), .b(new_n22_), .c(new_n44_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n42_), .O(z2));
  oai21  g25(.a(new_n40_), .b(x13), .c(x05), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x03), .O(new_n48_));
  nand4  g27(.a(new_n31_), .b(new_n39_), .c(x03), .d(x02), .O(new_n49_));
