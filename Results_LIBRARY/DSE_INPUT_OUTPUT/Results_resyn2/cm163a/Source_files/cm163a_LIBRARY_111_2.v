...
module FAU ( 
  ...
  nand3  g22(.a(new_n43_), .b(new_n42_), .c(new_n26_), .O(new_n44_));
  inv1   g23(.a(x11), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n26_), .c(x02), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x12), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n44_), .c(x04), .O(new_n48_));
  aoi21  g27(.a(x06), .b(new_n28_), .c(new_n22_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n41_), .O(z2));
  inv1   g30(.a(x13), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n28_), .c(x05), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n32_), .O(new_n54_));
  nand4  g33(.a(new_n43_), .b(new_n42_), .c(new_n52_), .d(new_n26_), .O(new_n55_));
  nand4  g34(.a(new_n39_), .b(new_n45_), .c(new_n26_), .d(x02), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x13), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n55_), .c(x04), .O(new_n58_));
  aoi21  g37(.a(x07), .b(new_n28_), .c(new_n22_), .O(new_n59_));
  ...
  nor3   g41(.a(new_n62_), .b(new_n22_), .c(new_n32_), .O(z4));
endmodule
