...
module FAU ( 
  ...
  nor2   g00(.a(x12), .b(x06), .O(new_n22_));
  ...
  aoi21  g25(.a(new_n46_), .b(new_n45_), .c(new_n31_), .O(new_n47_));
  oai21  g26(.a(new_n44_), .b(new_n30_), .c(new_n47_), .O(z2));
  nand3  g27(.a(new_n43_), .b(new_n42_), .c(x13), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  inv1   g29(.a(new_n43_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n26_), .c(new_n50_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n49_), .c(x04), .O(new_n53_));
  oai21  g32(.a(new_n50_), .b(new_n30_), .c(x12), .O(new_n54_));
  oai21  g33(.a(x07), .b(x04), .c(x05), .O(new_n55_));
  aoi21  g34(.a(new_n54_), .b(new_n45_), .c(new_n55_), .O(new_n56_));
