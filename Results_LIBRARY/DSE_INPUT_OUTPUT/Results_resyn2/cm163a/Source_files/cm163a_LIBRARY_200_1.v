...
module FAU ( 
  ...
  xor2a  g13(.a(new_n27_), .b(x11), .O(new_n35_));
  nor2   g14(.a(x04), .b(x01), .O(new_n36_));
  oai21  g15(.a(new_n22_), .b(x07), .c(x05), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  oai21  g17(.a(new_n35_), .b(new_n31_), .c(new_n38_), .O(z1));
  nor2   g18(.a(new_n24_), .b(x09), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(x12), .c(new_n22_), .O(new_n41_));
  inv1   g20(.a(x12), .O(new_n42_));
  oai21  g21(.a(new_n27_), .b(x11), .c(new_n42_), .O(new_n43_));
  inv1   g22(.a(x07), .O(new_n44_));
  aoi21  g23(.a(x11), .b(new_n44_), .c(new_n31_), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n43_), .c(new_n41_), .O(new_n46_));
  aoi21  g25(.a(x12), .b(x11), .c(x05), .O(new_n47_));
  aoi22  g26(.a(x11), .b(new_n44_), .c(x06), .d(x05), .O(new_n48_));
  oai21  g27(.a(new_n47_), .b(new_n31_), .c(new_n48_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n46_), .O(z2));
  inv1   g29(.a(x13), .O(new_n51_));
  nand2  g30(.a(new_n42_), .b(new_n22_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n27_), .c(new_n51_), .O(new_n53_));
  nor2   g32(.a(x12), .b(x11), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n40_), .c(x13), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n53_), .c(x04), .O(new_n56_));
  nand2  g35(.a(new_n22_), .b(x04), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n44_), .c(new_n32_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n56_), .O(z3));
  inv1   g38(.a(new_n23_), .O(new_n60_));
  nand3  g39(.a(x15), .b(x14), .c(x10), .O(new_n61_));
  inv1   g40(.a(new_n61_), .O(new_n62_));
  nand4  g41(.a(new_n62_), .b(new_n60_), .c(x08), .d(x03), .O(new_n63_));
