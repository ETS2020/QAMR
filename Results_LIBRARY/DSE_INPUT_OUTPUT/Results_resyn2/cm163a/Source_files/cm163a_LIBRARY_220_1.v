...
module FAU ( 
  ...
  nor2   g04(.a(new_n25_), .b(x12), .O(new_n26_));
  ...
  oai21  g19(.a(new_n33_), .b(new_n22_), .c(new_n25_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nor2   g21(.a(new_n40_), .b(new_n22_), .O(new_n43_));
  oai21  g22(.a(x06), .b(x04), .c(x05), .O(new_n44_));
  aoi21  g23(.a(new_n43_), .b(new_n33_), .c(new_n44_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n42_), .O(z2));
  inv1   g25(.a(new_n26_), .O(new_n47_));
  aoi21  g26(.a(new_n25_), .b(x04), .c(x07), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n37_), .c(new_n47_), .O(new_n49_));
  oai21  g28(.a(new_n33_), .b(x12), .c(new_n25_), .O(new_n50_));
  ...
  nand4  g33(.a(new_n54_), .b(new_n47_), .c(x08), .d(x03), .O(new_n55_));
