...
module FAU ( 
  ...
  nand3  g07(.a(x09), .b(x03), .c(x02), .O(new_n29_));
  nand4  g08(.a(new_n29_), .b(new_n28_), .c(new_n23_), .d(x04), .O(new_n30_));
  ...
  oai21  g13(.a(new_n34_), .b(new_n32_), .c(x13), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x03), .O(new_n36_));
  nand4  g15(.a(x13), .b(new_n26_), .c(x03), .d(x02), .O(new_n37_));
  inv1   g16(.a(x04), .O(new_n38_));
  nor2   g17(.a(new_n33_), .b(new_n38_), .O(new_n39_));
  ...
  nand3  g22(.a(new_n43_), .b(new_n33_), .c(new_n26_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n32_), .c(x13), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x03), .O(new_n46_));
  nor2   g25(.a(new_n43_), .b(new_n38_), .O(new_n47_));
  oai21  g26(.a(new_n37_), .b(x11), .c(new_n47_), .O(new_n48_));
  inv1   g27(.a(x05), .O(new_n49_));
  inv1   g28(.a(x06), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n38_), .c(new_n49_), .O(new_n51_));
  ...
  nor2   g33(.a(new_n22_), .b(new_n38_), .O(new_n55_));
  oai21  g34(.a(new_n44_), .b(new_n27_), .c(new_n55_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n54_), .O(z3));
  inv1   g36(.a(x03), .O(new_n58_));
  nand4  g37(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n59_));
  aoi21  g38(.a(new_n59_), .b(x13), .c(new_n58_), .O(z4));
endmodule
