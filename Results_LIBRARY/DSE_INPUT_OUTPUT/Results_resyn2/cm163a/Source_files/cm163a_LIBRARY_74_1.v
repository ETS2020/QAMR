...
module FAU ( 
  ...
  nand2  g08(.a(x12), .b(new_n29_), .O(new_n30_));
  ...
  and2   g23(.a(x12), .b(x08), .O(new_n45_));
  nor2   g24(.a(x12), .b(x11), .O(new_n46_));
  aoi22  g25(.a(new_n46_), .b(new_n26_), .c(new_n45_), .d(new_n44_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n34_), .c(new_n42_), .O(z2));
  nor3   g27(.a(x13), .b(x12), .c(x11), .O(new_n49_));
  aoi22  g28(.a(new_n49_), .b(new_n26_), .c(new_n44_), .d(x13), .O(new_n50_));
  nand2  g29(.a(x13), .b(x04), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x08), .O(new_n52_));
  oai21  g31(.a(x07), .b(x04), .c(x05), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x12), .c(new_n53_), .O(new_n54_));
  oai21  g33(.a(new_n50_), .b(new_n34_), .c(new_n54_), .O(z3));
