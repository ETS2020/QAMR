...
module FAU ( 
  ...
  oai21  g10(.a(new_n31_), .b(new_n23_), .c(x08), .O(new_n32_));
  nand2  g11(.a(new_n32_), .b(new_n26_), .O(new_n33_));
  nand3  g12(.a(new_n26_), .b(x03), .c(x02), .O(new_n34_));
  ...
  nand4  g19(.a(new_n30_), .b(new_n26_), .c(x03), .d(x02), .O(new_n41_));
  aoi22  g20(.a(new_n41_), .b(x12), .c(new_n40_), .d(new_n39_), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n22_), .c(x09), .O(new_n44_));
  oai21  g23(.a(x06), .b(x04), .c(x05), .O(new_n45_));
  aoi21  g24(.a(new_n44_), .b(new_n25_), .c(new_n45_), .O(new_n46_));
  oai21  g25(.a(new_n42_), .b(new_n22_), .c(new_n46_), .O(z2));
  nand3  g26(.a(new_n40_), .b(new_n39_), .c(x13), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nand2  g28(.a(new_n43_), .b(new_n30_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n34_), .c(new_n49_), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n48_), .c(x04), .O(new_n52_));
  oai21  g31(.a(new_n49_), .b(new_n22_), .c(x09), .O(new_n53_));
  oai21  g32(.a(x07), .b(x04), .c(x05), .O(new_n54_));
  aoi21  g33(.a(new_n53_), .b(new_n25_), .c(new_n54_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n52_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x09), .d(x08), .O(z4));
endmodule
