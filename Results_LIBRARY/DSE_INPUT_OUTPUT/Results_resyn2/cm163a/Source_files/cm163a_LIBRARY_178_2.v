...
module FAU ( 
  ...
  nand4  g30(.a(new_n51_), .b(new_n34_), .c(new_n49_), .d(new_n48_), .O(new_n52_));
  oai21  g31(.a(new_n35_), .b(x12), .c(new_n22_), .O(new_n53_));
  ...
  aoi21  g35(.a(new_n56_), .b(x13), .c(new_n50_), .O(z4));
endmodule
