...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(new_n22_), .O(new_n23_));
  ...
  inv1   g24(.a(new_n35_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(x13), .c(new_n22_), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  oai21  g27(.a(new_n35_), .b(x12), .c(new_n48_), .O(new_n49_));
