...
module FAU ( 
  ...
  nor2   g10(.a(x04), .b(new_n22_), .O(new_n32_));
  ...
  nor2   g15(.a(new_n36_), .b(new_n23_), .O(new_n37_));
  and2   g16(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(new_n33_), .c(new_n32_), .O(z1));
  ...
  nand2  g31(.a(x07), .b(new_n22_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n23_), .c(new_n36_), .O(new_n54_));
  oai21  g33(.a(new_n52_), .b(new_n50_), .c(new_n54_), .O(z3));
  nand2  g34(.a(x08), .b(x03), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n32_), .O(new_n57_));
