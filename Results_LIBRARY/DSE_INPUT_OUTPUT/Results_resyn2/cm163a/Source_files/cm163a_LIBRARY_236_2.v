...
module FAU ( 
  ...
  oai21  g24(.a(x15), .b(new_n28_), .c(new_n45_), .O(new_n46_));
  nand3  g25(.a(new_n40_), .b(new_n25_), .c(x13), .O(new_n47_));
  nand2  g26(.a(x15), .b(x04), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x07), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  inv1   g29(.a(x12), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n38_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n33_), .c(new_n50_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n49_), .c(new_n47_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n46_), .O(z3));
