...
module FAU ( 
  ...
  nor2   g04(.a(new_n25_), .b(new_n23_), .O(new_n26_));
  ...
  nor3   g17(.a(new_n38_), .b(new_n22_), .c(new_n31_), .O(new_n39_));
  ...
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(new_n22_), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nor2   g26(.a(x11), .b(x09), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n25_), .c(new_n41_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n30_), .c(x10), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n47_), .O(new_n51_));
  nor2   g30(.a(new_n47_), .b(new_n30_), .O(new_n52_));
  oai21  g31(.a(x07), .b(x04), .c(x05), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(new_n49_), .c(new_n53_), .O(new_n54_));
