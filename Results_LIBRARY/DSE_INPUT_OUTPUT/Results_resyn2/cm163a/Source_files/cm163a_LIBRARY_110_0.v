...
module FAU ( 
  ...
  nand3  g26(.a(new_n31_), .b(x03), .c(x02), .O(new_n48_));
  inv1   g27(.a(new_n41_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n50_));
