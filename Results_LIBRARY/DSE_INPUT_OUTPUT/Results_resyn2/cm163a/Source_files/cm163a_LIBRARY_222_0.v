...
module FAU ( 
  ...
  nor2   g03(.a(x11), .b(x10), .O(new_n25_));
  ...
  nor3   g24(.a(new_n32_), .b(new_n45_), .c(x12), .O(new_n46_));
  oai21  g25(.a(new_n32_), .b(x12), .c(new_n45_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x04), .O(new_n48_));
  inv1   g27(.a(x10), .O(new_n49_));
  oai21  g28(.a(new_n45_), .b(new_n22_), .c(x11), .O(new_n50_));
  oai21  g29(.a(x07), .b(x04), .c(x05), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(new_n49_), .c(new_n51_), .O(new_n52_));
  oai21  g31(.a(new_n48_), .b(new_n46_), .c(new_n52_), .O(z3));
