...
module FAU ( 
  ...
  nor3   g20(.a(new_n41_), .b(new_n27_), .c(new_n40_), .O(new_n42_));
  oai21  g21(.a(new_n39_), .b(new_n26_), .c(new_n42_), .O(z2));
  inv1   g22(.a(x12), .O(new_n44_));
  nand4  g23(.a(new_n23_), .b(new_n44_), .c(new_n33_), .d(x04), .O(new_n45_));
  aoi21  g24(.a(x07), .b(new_n26_), .c(new_n27_), .O(new_n46_));
  ...
  oai22  g29(.a(new_n50_), .b(new_n49_), .c(x13), .d(new_n40_), .O(z4));
endmodule
