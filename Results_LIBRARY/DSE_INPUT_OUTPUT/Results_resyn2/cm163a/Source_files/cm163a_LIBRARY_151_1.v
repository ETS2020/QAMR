...
module FAU ( 
  ...
  nor2   g24(.a(new_n24_), .b(x09), .O(new_n46_));
  nor3   g25(.a(x15), .b(x12), .c(x11), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n46_), .c(new_n37_), .d(x12), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n31_), .c(new_n45_), .O(z2));
  oai21  g28(.a(x07), .b(x04), .c(x05), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n43_), .O(new_n51_));
  inv1   g30(.a(x12), .O(new_n52_));
  nand2  g31(.a(x13), .b(new_n52_), .O(new_n53_));
  aoi21  g32(.a(new_n37_), .b(new_n22_), .c(new_n53_), .O(new_n54_));
  inv1   g33(.a(x13), .O(new_n55_));
  nand3  g34(.a(new_n22_), .b(new_n52_), .c(new_n36_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n27_), .c(new_n55_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x04), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n54_), .c(new_n51_), .O(z3));
