...
module FAU ( 
  ...
  nand2  g13(.a(new_n29_), .b(x01), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(new_n27_), .c(new_n28_), .O(new_n36_));
  oai21  g15(.a(new_n34_), .b(new_n27_), .c(new_n36_), .O(z1));
  ...
  oai21  g23(.a(x07), .b(x04), .c(x05), .O(new_n45_));
  oai21  g24(.a(new_n29_), .b(x04), .c(new_n45_), .O(new_n46_));
  ...
  nand2  g31(.a(new_n52_), .b(new_n46_), .O(z3));
  nand4  g32(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x04), .c(new_n29_), .O(z4));
endmodule
