...
module FAU ( 
  ...
  nand2  g07(.a(x05), .b(x04), .O(new_n29_));
  ...
  aoi21  g12(.a(new_n33_), .b(x11), .c(new_n29_), .O(new_n34_));
  aoi22  g13(.a(new_n34_), .b(new_n32_), .c(new_n29_), .d(x01), .O(z1));
  nor2   g14(.a(new_n23_), .b(x09), .O(new_n36_));
  nor2   g15(.a(x12), .b(x11), .O(new_n37_));
  aoi22  g16(.a(new_n37_), .b(new_n36_), .c(new_n32_), .d(x12), .O(new_n38_));
  ...
  nand3  g20(.a(new_n37_), .b(new_n36_), .c(x13), .O(new_n42_));
  inv1   g21(.a(x13), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n31_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n33_), .c(new_n43_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n42_), .c(x04), .O(new_n47_));
  inv1   g26(.a(x07), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n22_), .c(new_n26_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n47_), .O(z3));
  inv1   g29(.a(x01), .O(new_n51_));
  nand2  g30(.a(x08), .b(x03), .O(new_n52_));
  nand3  g31(.a(x15), .b(x14), .c(x10), .O(new_n53_));
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(x05), .d(new_n51_), .O(z4));
endmodule
