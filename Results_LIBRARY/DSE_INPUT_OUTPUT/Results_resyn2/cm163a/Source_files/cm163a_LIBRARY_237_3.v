...
module FAU ( 
  ...
  nand2  g06(.a(x14), .b(x06), .O(new_n28_));
  ...
  inv1   g23(.a(new_n28_), .O(new_n45_));
  nand3  g24(.a(new_n40_), .b(new_n25_), .c(x13), .O(new_n46_));
  ...
  aoi21  g32(.a(new_n53_), .b(new_n32_), .c(new_n52_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n51_), .c(new_n45_), .O(z3));
  inv1   g34(.a(x03), .O(new_n56_));
  nand4  g35(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n57_));
  nor3   g36(.a(new_n57_), .b(x06), .c(new_n56_), .O(z4));
endmodule
