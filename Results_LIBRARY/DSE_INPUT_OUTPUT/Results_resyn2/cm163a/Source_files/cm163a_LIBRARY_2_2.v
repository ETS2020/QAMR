...
module FAU ( 
  ...
  nor3   g13(.a(new_n34_), .b(new_n28_), .c(new_n33_), .O(new_n35_));
  ...
  nand3  g23(.a(new_n40_), .b(new_n37_), .c(new_n44_), .O(new_n45_));
  ...
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(x06), .d(new_n33_), .O(z4));
endmodule
