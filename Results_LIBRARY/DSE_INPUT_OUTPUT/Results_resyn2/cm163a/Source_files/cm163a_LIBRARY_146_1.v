...
module FAU ( 
  ...
  aoi21  g05(.a(x15), .b(new_n25_), .c(new_n26_), .O(new_n27_));
  oai21  g06(.a(new_n24_), .b(new_n22_), .c(new_n27_), .O(z0));
  nand2  g07(.a(x15), .b(new_n25_), .O(new_n29_));
  oai21  g08(.a(x04), .b(x01), .c(x05), .O(new_n30_));
  nand2  g09(.a(new_n30_), .b(new_n29_), .O(new_n31_));
  nor2   g10(.a(new_n23_), .b(x09), .O(new_n32_));
  inv1   g11(.a(x15), .O(new_n33_));
  nand3  g12(.a(new_n32_), .b(new_n33_), .c(new_n25_), .O(new_n34_));
  oai21  g13(.a(new_n32_), .b(new_n25_), .c(new_n34_), .O(new_n35_));
  ...
  oai21  g19(.a(new_n40_), .b(new_n22_), .c(new_n33_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n25_), .O(new_n42_));
  ...
  nand2  g28(.a(new_n40_), .b(new_n33_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n25_), .c(new_n49_), .O(new_n51_));
  nand2  g30(.a(new_n49_), .b(new_n39_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n34_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n51_), .c(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n48_), .O(z3));
  nand2  g34(.a(x08), .b(x03), .O(new_n56_));
  nand4  g35(.a(x15), .b(x14), .c(x11), .d(x10), .O(new_n57_));
