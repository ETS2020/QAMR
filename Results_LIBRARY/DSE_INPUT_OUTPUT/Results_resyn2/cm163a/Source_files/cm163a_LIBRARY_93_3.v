...
module FAU ( 
  ...
  aoi21  g14(.a(new_n27_), .b(x01), .c(x06), .O(new_n36_));
  ...
  nand2  g22(.a(new_n43_), .b(new_n39_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z2));
  inv1   g24(.a(x13), .O(new_n46_));
  nand3  g25(.a(new_n41_), .b(new_n32_), .c(new_n46_), .O(new_n47_));
  ...
  aoi21  g30(.a(x07), .b(new_n27_), .c(x06), .O(new_n52_));
