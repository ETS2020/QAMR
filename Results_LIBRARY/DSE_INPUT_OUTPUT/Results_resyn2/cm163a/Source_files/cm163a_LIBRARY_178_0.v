...
module FAU ( 
  ...
  inv1   g23(.a(new_n22_), .O(new_n45_));
  oai21  g24(.a(x07), .b(x04), .c(x05), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand4  g27(.a(new_n34_), .b(new_n48_), .c(x03), .d(x02), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n48_), .c(x02), .O(new_n51_));
  inv1   g30(.a(new_n51_), .O(new_n52_));
  nand4  g31(.a(new_n33_), .b(new_n23_), .c(x08), .d(x03), .O(new_n53_));
  inv1   g32(.a(new_n53_), .O(new_n54_));
  aoi22  g33(.a(new_n54_), .b(new_n52_), .c(new_n49_), .d(x13), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n29_), .c(new_n47_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n45_), .O(z4));
endmodule
