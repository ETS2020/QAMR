...
module FAU ( 
  ...
  inv1   g04(.a(new_n23_), .O(new_n26_));
  nand2  g05(.a(new_n26_), .b(new_n25_), .O(new_n27_));
  nand3  g06(.a(new_n27_), .b(new_n24_), .c(new_n22_), .O(new_n28_));
  ...
  nand2  g13(.a(x04), .b(x01), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n32_), .O(new_n36_));
  oai21  g15(.a(new_n23_), .b(x09), .c(x11), .O(new_n37_));
  ...
  xor2a  g21(.a(new_n39_), .b(x12), .O(new_n43_));
  nand2  g22(.a(x04), .b(new_n22_), .O(new_n44_));
  nor2   g23(.a(x06), .b(x04), .O(new_n45_));
  aoi21  g24(.a(new_n35_), .b(new_n32_), .c(new_n45_), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(new_n46_), .O(z2));
  inv1   g26(.a(x12), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nand4  g28(.a(new_n38_), .b(new_n26_), .c(new_n49_), .d(new_n48_), .O(new_n50_));
  nand4  g29(.a(new_n38_), .b(new_n48_), .c(x03), .d(x02), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x13), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n50_), .c(new_n22_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(x04), .O(new_n54_));
  inv1   g33(.a(x07), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n31_), .c(new_n32_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n54_), .O(z3));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  nand3  g37(.a(new_n35_), .b(x08), .c(x03), .O(new_n59_));
