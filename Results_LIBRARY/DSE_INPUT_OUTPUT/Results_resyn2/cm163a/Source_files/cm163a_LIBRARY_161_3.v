...
module FAU ( 
  ...
  nor3   g06(.a(new_n27_), .b(new_n25_), .c(new_n24_), .O(new_n28_));
  ...
  oai21  g11(.a(new_n25_), .b(new_n30_), .c(new_n32_), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x04), .O(new_n34_));
  nor2   g13(.a(x04), .b(x01), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n27_), .O(new_n36_));
  ...
  aoi21  g21(.a(x06), .b(new_n24_), .c(x00), .O(new_n43_));
