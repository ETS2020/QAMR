...
module FAU ( 
  ...
  aoi21  g09(.a(new_n30_), .b(x04), .c(new_n25_), .O(new_n31_));
  oai21  g10(.a(new_n31_), .b(x08), .c(new_n24_), .O(z0));
  nand2  g11(.a(x05), .b(x01), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(new_n22_), .O(new_n34_));
  inv1   g13(.a(x08), .O(new_n35_));
  ...
  oai21  g18(.a(new_n39_), .b(new_n25_), .c(new_n35_), .O(new_n40_));
  ...
  nand3  g24(.a(new_n45_), .b(new_n42_), .c(new_n35_), .O(new_n46_));
  ...
  nor2   g29(.a(new_n35_), .b(new_n22_), .O(new_n51_));
  inv1   g30(.a(x12), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n37_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n29_), .c(x13), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n59_), .b(new_n22_), .c(new_n25_), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(new_n51_), .O(z3));
  nand2  g40(.a(new_n22_), .b(x03), .O(new_n62_));
  nand4  g41(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n63_));
