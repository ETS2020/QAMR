...
module FAU ( 
  ...
  nand3  g13(.a(new_n34_), .b(new_n33_), .c(x15), .O(new_n35_));
  ...
  nand4  g21(.a(new_n42_), .b(x13), .c(new_n41_), .d(new_n30_), .O(new_n43_));
  inv1   g22(.a(x13), .O(new_n44_));
  oai21  g23(.a(new_n31_), .b(x12), .c(new_n44_), .O(new_n45_));
  ...
  nor2   g29(.a(x15), .b(x05), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(x15), .c(new_n51_), .O(z4));
endmodule
