...
module FAU ( 
  ...
  aoi21  g32(.a(new_n53_), .b(new_n32_), .c(new_n42_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n52_), .c(new_n46_), .O(z3));
  nand2  g34(.a(x06), .b(x03), .O(new_n56_));
