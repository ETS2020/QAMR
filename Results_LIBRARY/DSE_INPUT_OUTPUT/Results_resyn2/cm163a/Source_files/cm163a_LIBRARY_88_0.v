...
module FAU ( 
  ...
  nor2   g08(.a(new_n29_), .b(new_n25_), .O(new_n30_));
  oai21  g09(.a(new_n24_), .b(new_n22_), .c(new_n30_), .O(z0));
  ...
  aoi21  g19(.a(new_n22_), .b(new_n39_), .c(new_n40_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n38_), .c(new_n32_), .O(z1));
  nor2   g21(.a(new_n23_), .b(x09), .O(new_n43_));
  nor2   g22(.a(x12), .b(x11), .O(new_n44_));
  aoi22  g23(.a(new_n44_), .b(new_n43_), .c(new_n36_), .d(x12), .O(new_n45_));
  nor2   g24(.a(x06), .b(x04), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n29_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n22_), .c(new_n47_), .O(z2));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(x13), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nand3  g29(.a(new_n34_), .b(x03), .c(x02), .O(new_n51_));
  inv1   g30(.a(x12), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n35_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n51_), .c(new_n50_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n49_), .c(x04), .O(new_n55_));
  inv1   g34(.a(x07), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n22_), .c(new_n40_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n55_), .c(new_n32_), .O(z3));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nand3  g38(.a(x15), .b(x14), .c(x10), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n59_), .c(new_n28_), .O(z4));
endmodule
