...
module FAU ( 
  ...
  oai21  g19(.a(new_n34_), .b(new_n28_), .c(x07), .O(new_n41_));
  ...
  oai21  g27(.a(new_n48_), .b(new_n34_), .c(x07), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n40_), .O(new_n50_));
  nor2   g29(.a(new_n47_), .b(new_n28_), .O(new_n51_));
  oai21  g30(.a(new_n34_), .b(x12), .c(new_n51_), .O(new_n52_));
  inv1   g31(.a(x07), .O(new_n53_));
  aoi21  g32(.a(new_n48_), .b(new_n53_), .c(new_n29_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n52_), .c(new_n50_), .O(z3));
  nand2  g34(.a(x08), .b(x03), .O(new_n56_));
  nand3  g35(.a(x15), .b(x14), .c(x10), .O(new_n57_));
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x12), .d(x07), .O(z4));
endmodule
