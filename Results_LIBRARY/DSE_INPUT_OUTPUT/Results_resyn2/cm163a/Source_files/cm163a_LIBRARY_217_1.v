...
module FAU ( 
  ...
  nand2  g12(.a(new_n22_), .b(x01), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  inv1   g14(.a(x15), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(x05), .O(new_n37_));
  aoi21  g16(.a(new_n35_), .b(x05), .c(new_n37_), .O(z1));
  xor2a  g17(.a(new_n31_), .b(x12), .O(new_n39_));
  ...
  nand4  g23(.a(new_n44_), .b(x13), .c(new_n43_), .d(new_n30_), .O(new_n45_));
  inv1   g24(.a(x13), .O(new_n46_));
  oai21  g25(.a(new_n31_), .b(x12), .c(new_n46_), .O(new_n47_));
  ...
  aoi21  g31(.a(new_n52_), .b(x05), .c(new_n36_), .O(z4));
endmodule
