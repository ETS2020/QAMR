...
module FAU ( 
  ...
  nand2  g28(.a(new_n27_), .b(x07), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n51_));
  nand4  g30(.a(new_n49_), .b(new_n47_), .c(x03), .d(x02), .O(new_n52_));
  ...
  nand3  g35(.a(new_n28_), .b(x08), .c(x03), .O(new_n57_));
