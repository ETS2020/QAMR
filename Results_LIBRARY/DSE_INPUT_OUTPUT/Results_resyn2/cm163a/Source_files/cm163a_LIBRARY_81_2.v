...
module FAU ( 
  ...
  nand3  g19(.a(new_n26_), .b(x06), .c(new_n22_), .O(new_n41_));
  nand3  g20(.a(new_n33_), .b(x03), .c(x02), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x12), .O(new_n43_));
  nand4  g22(.a(new_n25_), .b(new_n33_), .c(x03), .d(x02), .O(new_n44_));
  nor2   g23(.a(x09), .b(new_n22_), .O(new_n45_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n42_), .c(new_n32_), .O(new_n50_));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n22_), .c(new_n38_), .O(new_n55_));
  aoi22  g34(.a(new_n55_), .b(new_n53_), .c(new_n50_), .d(new_n25_), .O(z3));
  nand3  g35(.a(x15), .b(x14), .c(x10), .O(new_n57_));
  inv1   g36(.a(new_n57_), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(new_n26_), .c(x08), .d(x03), .O(new_n59_));
