...
module FAU ( 
  ...
  aoi22  g20(.a(new_n41_), .b(new_n25_), .c(new_n40_), .d(x12), .O(new_n42_));
  nor2   g21(.a(x06), .b(x04), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n30_), .O(new_n44_));
  oai21  g23(.a(new_n42_), .b(new_n33_), .c(new_n44_), .O(z2));
  nand3  g24(.a(new_n41_), .b(new_n25_), .c(x13), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n39_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n34_), .c(new_n29_), .O(new_n49_));
  ...
  nand4  g32(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n29_), .c(new_n28_), .O(z4));
endmodule
