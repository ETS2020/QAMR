...
module FAU ( 
  ...
  nand2  g04(.a(x01), .b(x00), .O(new_n26_));
  ...
  aoi21  g14(.a(new_n35_), .b(x05), .c(new_n29_), .O(z1));
  oai21  g15(.a(x06), .b(x04), .c(x05), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(x01), .O(new_n38_));
  ...
  nand2  g28(.a(x07), .b(x01), .O(new_n50_));
  ...
  nor3   g33(.a(new_n54_), .b(new_n53_), .c(new_n29_), .O(z4));
endmodule
