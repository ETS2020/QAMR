...
module FAU ( 
  ...
  nand2  g04(.a(x14), .b(x00), .O(new_n26_));
  aoi21  g05(.a(new_n26_), .b(new_n22_), .c(new_n25_), .O(new_n27_));
  ...
  aoi21  g11(.a(new_n32_), .b(new_n22_), .c(new_n25_), .O(new_n33_));
  ...
  nand2  g18(.a(x14), .b(x06), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n22_), .c(new_n25_), .O(new_n41_));
  oai21  g20(.a(new_n39_), .b(new_n22_), .c(new_n41_), .O(z2));
  oai21  g21(.a(x07), .b(x04), .c(x05), .O(new_n43_));
  oai21  g22(.a(x14), .b(x04), .c(new_n43_), .O(new_n44_));
  ...
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(x14), .d(x04), .O(z4));
endmodule
