...
module FAU ( 
  ...
  nand3  g21(.a(new_n26_), .b(new_n42_), .c(new_n34_), .O(new_n43_));
  aoi21  g22(.a(new_n35_), .b(x12), .c(new_n41_), .O(new_n44_));
  aoi22  g23(.a(new_n44_), .b(new_n43_), .c(new_n41_), .d(x06), .O(z2));
  nand4  g24(.a(new_n26_), .b(x13), .c(new_n42_), .d(new_n34_), .O(new_n46_));
  ...
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(new_n23_), .d(x05), .O(z4));
endmodule
