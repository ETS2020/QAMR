...
module FAU ( 
  ...
  aoi21  g16(.a(new_n22_), .b(x01), .c(new_n26_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n30_), .O(z1));
  oai21  g19(.a(new_n35_), .b(x11), .c(x12), .O(new_n41_));
  ...
  aoi21  g23(.a(x06), .b(new_n22_), .c(new_n26_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n30_), .O(z2));
  inv1   g26(.a(x13), .O(new_n48_));
  nand3  g27(.a(new_n42_), .b(new_n32_), .c(new_n48_), .O(new_n49_));
  inv1   g28(.a(x12), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n31_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n35_), .c(x13), .O(new_n52_));
  ...
  aoi21  g36(.a(new_n57_), .b(x05), .c(new_n29_), .O(z4));
endmodule
