...
module FAU ( 
  ...
  oai21  g12(.a(new_n33_), .b(x11), .c(x04), .O(new_n34_));
  ...
  oai21  g16(.a(new_n31_), .b(x12), .c(x05), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n29_), .O(new_n39_));
  nand4  g18(.a(new_n29_), .b(new_n30_), .c(x03), .d(x02), .O(new_n40_));
  ...
  nand2  g26(.a(new_n47_), .b(new_n39_), .O(z2));
  inv1   g27(.a(x13), .O(new_n49_));
  nand3  g28(.a(new_n30_), .b(x03), .c(x02), .O(new_n50_));
  nand2  g29(.a(new_n41_), .b(new_n29_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n52_));
  nand4  g31(.a(new_n33_), .b(x13), .c(new_n41_), .d(new_n29_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n52_), .c(x04), .O(new_n54_));
  inv1   g33(.a(x07), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n22_), .c(new_n26_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n54_), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(new_n29_), .d(x05), .O(z4));
endmodule
