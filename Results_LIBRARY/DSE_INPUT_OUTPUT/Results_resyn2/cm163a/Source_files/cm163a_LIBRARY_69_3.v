...
module FAU ( 
  ...
  oai21  g15(.a(new_n23_), .b(new_n22_), .c(new_n36_), .O(new_n37_));
  inv1   g16(.a(new_n27_), .O(new_n38_));
  nor2   g17(.a(x11), .b(x09), .O(new_n39_));
  nor2   g18(.a(new_n23_), .b(x08), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n26_), .c(new_n39_), .d(new_n38_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n32_), .c(new_n37_), .O(z1));
  oai21  g21(.a(new_n27_), .b(x09), .c(x12), .O(new_n43_));
  ...
  nand4  g30(.a(new_n39_), .b(new_n38_), .c(x13), .d(new_n44_), .O(new_n52_));
  ...
  aoi22  g36(.a(x11), .b(x08), .c(x07), .d(x05), .O(new_n58_));
