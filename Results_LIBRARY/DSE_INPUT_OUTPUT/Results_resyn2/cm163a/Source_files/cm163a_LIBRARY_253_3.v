...
module FAU ( 
  ...
  nand4  g21(.a(new_n28_), .b(new_n23_), .c(new_n36_), .d(x04), .O(new_n43_));
  oai21  g22(.a(new_n37_), .b(x06), .c(x12), .O(new_n44_));
  nand2  g23(.a(new_n23_), .b(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n31_), .c(new_n32_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n44_), .c(new_n43_), .O(z2));
  inv1   g26(.a(x13), .O(new_n48_));
  oai21  g27(.a(new_n37_), .b(x12), .c(new_n48_), .O(new_n49_));
  nand3  g28(.a(new_n28_), .b(x13), .c(new_n36_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n49_), .c(x04), .O(new_n51_));
  oai21  g30(.a(new_n48_), .b(new_n31_), .c(new_n22_), .O(new_n52_));
  oai21  g31(.a(x07), .b(x04), .c(x05), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x12), .c(new_n53_), .O(new_n54_));
