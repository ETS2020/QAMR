...
module FAU ( 
  ...
  aoi21  g17(.a(new_n38_), .b(new_n36_), .c(new_n30_), .O(z1));
  xor2a  g18(.a(new_n34_), .b(x12), .O(new_n40_));
  aoi21  g19(.a(new_n29_), .b(new_n22_), .c(new_n26_), .O(new_n41_));
  oai21  g20(.a(new_n40_), .b(new_n22_), .c(new_n41_), .O(z2));
  inv1   g21(.a(x12), .O(new_n43_));
  nor2   g22(.a(new_n23_), .b(x09), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(x13), .c(new_n43_), .d(new_n33_), .O(new_n45_));
