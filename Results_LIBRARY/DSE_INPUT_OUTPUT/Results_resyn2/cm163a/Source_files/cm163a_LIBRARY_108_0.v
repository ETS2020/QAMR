...
module FAU ( 
  ...
  nand2  g07(.a(x10), .b(new_n26_), .O(new_n29_));
  ...
  nand2  g17(.a(new_n38_), .b(new_n29_), .O(z1));
  oai21  g18(.a(new_n34_), .b(x11), .c(x12), .O(new_n40_));
  nor2   g19(.a(x12), .b(x11), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n31_), .O(new_n42_));
  ...
  nand2  g24(.a(new_n45_), .b(new_n29_), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nand3  g26(.a(new_n41_), .b(new_n31_), .c(new_n47_), .O(new_n48_));
  inv1   g27(.a(x12), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n30_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n34_), .c(x13), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n48_), .c(x04), .O(new_n52_));
  aoi21  g31(.a(x07), .b(new_n22_), .c(new_n26_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n29_), .O(z3));
