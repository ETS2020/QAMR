...
module FAU ( 
  ...
  oai21  g22(.a(x12), .b(new_n22_), .c(new_n43_), .O(new_n44_));
  nand2  g23(.a(new_n37_), .b(x12), .O(new_n45_));
  and2   g24(.a(x03), .b(x02), .O(new_n46_));
  nor2   g25(.a(x12), .b(x11), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(new_n46_), .c(new_n22_), .d(new_n26_), .O(new_n48_));
  ...
  nor3   g33(.a(new_n54_), .b(new_n27_), .c(new_n52_), .O(new_n55_));
  oai21  g34(.a(new_n54_), .b(new_n27_), .c(new_n52_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x04), .O(new_n57_));
  oai21  g36(.a(new_n52_), .b(new_n31_), .c(x12), .O(new_n58_));
  oai21  g37(.a(x07), .b(x04), .c(x05), .O(new_n59_));
  aoi21  g38(.a(new_n58_), .b(x10), .c(new_n59_), .O(new_n60_));
  oai21  g39(.a(new_n57_), .b(new_n55_), .c(new_n60_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand4  g41(.a(x15), .b(x14), .c(x12), .d(x10), .O(new_n63_));
