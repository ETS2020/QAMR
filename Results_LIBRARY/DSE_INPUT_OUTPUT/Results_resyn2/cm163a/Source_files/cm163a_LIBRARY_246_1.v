...
module FAU ( 
  ...
  nand4  g11(.a(x11), .b(new_n22_), .c(x03), .d(x02), .O(new_n33_));
  inv1   g12(.a(x11), .O(new_n34_));
  oai21  g13(.a(new_n24_), .b(x09), .c(new_n34_), .O(new_n35_));
  nand3  g14(.a(new_n35_), .b(new_n33_), .c(x04), .O(new_n36_));
  ...
  nand2  g24(.a(new_n45_), .b(x08), .O(new_n46_));
  ...
  aoi21  g28(.a(new_n41_), .b(new_n25_), .c(x13), .O(new_n50_));
  inv1   g29(.a(new_n41_), .O(new_n51_));
  nand3  g30(.a(x13), .b(x03), .c(x02), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x04), .O(new_n53_));
  nand2  g32(.a(x13), .b(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x08), .O(new_n55_));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  aoi21  g35(.a(new_n55_), .b(x09), .c(new_n56_), .O(new_n57_));
  oai21  g36(.a(new_n53_), .b(new_n50_), .c(new_n57_), .O(z3));
