...
module FAU ( 
  ...
  and2   g27(.a(x03), .b(x02), .O(new_n49_));
  nand4  g28(.a(new_n34_), .b(new_n49_), .c(new_n48_), .d(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n41_), .O(new_n52_));
  nor2   g31(.a(x12), .b(x11), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n49_), .c(new_n22_), .d(new_n24_), .O(new_n54_));
  nor2   g33(.a(new_n48_), .b(new_n29_), .O(new_n55_));
  ...
  aoi21  g38(.a(new_n59_), .b(x12), .c(new_n22_), .O(z4));
endmodule
