...
module FAU ( 
  ...
  aoi21  g21(.a(new_n22_), .b(x04), .c(x06), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n31_), .O(new_n44_));
  ...
  oai21  g28(.a(new_n46_), .b(new_n30_), .c(x06), .O(new_n50_));
  oai21  g29(.a(x07), .b(x04), .c(x05), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(x12), .c(new_n51_), .O(new_n52_));
