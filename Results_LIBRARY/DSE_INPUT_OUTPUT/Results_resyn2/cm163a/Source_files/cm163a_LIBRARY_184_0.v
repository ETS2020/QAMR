...
module FAU ( 
  ...
  nand2  g18(.a(new_n34_), .b(x04), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x05), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x12), .O(new_n42_));
  oai21  g21(.a(new_n34_), .b(x12), .c(x04), .O(new_n43_));
  aoi21  g22(.a(x06), .b(new_n29_), .c(new_n22_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n42_), .O(z2));
  inv1   g25(.a(x12), .O(new_n47_));
  nor2   g26(.a(new_n26_), .b(x09), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(x13), .c(new_n47_), .d(new_n33_), .O(new_n49_));
  ...
  nor2   g35(.a(x12), .b(x05), .O(new_n57_));
