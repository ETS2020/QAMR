...
module FAU ( 
  ...
  aoi21  g27(.a(new_n48_), .b(new_n46_), .c(new_n23_), .O(z2));
  nand3  g28(.a(new_n43_), .b(new_n27_), .c(x13), .O(new_n50_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n53_), .c(new_n23_), .O(z3));
  nand2  g35(.a(x07), .b(x03), .O(new_n57_));
