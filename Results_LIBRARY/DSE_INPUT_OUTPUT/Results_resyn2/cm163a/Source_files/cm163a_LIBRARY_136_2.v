...
module FAU ( 
  ...
  aoi21  g17(.a(new_n31_), .b(new_n30_), .c(new_n38_), .O(new_n39_));
  nand4  g18(.a(new_n31_), .b(new_n38_), .c(x03), .d(x02), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x04), .O(new_n41_));
  aoi21  g20(.a(x06), .b(new_n22_), .c(new_n34_), .O(new_n42_));
  oai21  g21(.a(new_n41_), .b(new_n39_), .c(new_n42_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x05), .O(z2));
  inv1   g23(.a(x07), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n26_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n41_), .O(z3));
  inv1   g26(.a(x05), .O(new_n48_));
  nand2  g27(.a(x08), .b(x03), .O(new_n49_));
  nand3  g28(.a(x15), .b(x14), .c(x10), .O(new_n50_));
  oai22  g29(.a(new_n50_), .b(new_n49_), .c(x13), .d(new_n48_), .O(z4));
endmodule
