...
module FAU ( 
  ...
  nand4  g16(.a(x11), .b(new_n22_), .c(x03), .d(x02), .O(new_n38_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n45_), .c(x13), .O(new_n47_));
  ...
  nor2   g33(.a(new_n23_), .b(new_n41_), .O(new_n55_));
  oai21  g34(.a(new_n45_), .b(new_n36_), .c(new_n55_), .O(new_n56_));
