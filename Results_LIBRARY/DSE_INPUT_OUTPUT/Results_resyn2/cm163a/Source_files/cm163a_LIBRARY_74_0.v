// Benchmark "FAU" written by ABC on Sat Aug  8 20:54:58 2020
...
module FAU ( 
  ...
  nor2   g16(.a(new_n37_), .b(new_n32_), .O(new_n38_));
  oai21  g17(.a(new_n36_), .b(new_n35_), .c(new_n38_), .O(z1));
  oai21  g18(.a(x06), .b(x04), .c(x05), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n31_), .O(new_n41_));
  ...
  oai21  g33(.a(new_n51_), .b(new_n35_), .c(x12), .O(new_n55_));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  aoi21  g35(.a(new_n55_), .b(new_n29_), .c(new_n56_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n54_), .O(z3));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nand3  g38(.a(x15), .b(x14), .c(x10), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n59_), .c(new_n31_), .O(z4));
endmodule
