...
module FAU ( 
  ...
  nor3   g12(.a(new_n33_), .b(x15), .c(new_n32_), .O(new_n34_));
  oai21  g13(.a(new_n31_), .b(new_n27_), .c(new_n34_), .O(z1));
  oai21  g14(.a(new_n23_), .b(x11), .c(x12), .O(new_n36_));
  ...
  aoi21  g19(.a(x06), .b(new_n27_), .c(x15), .O(new_n41_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n32_), .c(new_n54_), .O(z4));
endmodule
