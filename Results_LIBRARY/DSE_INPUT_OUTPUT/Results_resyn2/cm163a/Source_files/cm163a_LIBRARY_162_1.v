...
module FAU ( 
  ...
  nor2   g08(.a(x11), .b(new_n22_), .O(new_n30_));
  aoi21  g09(.a(new_n30_), .b(new_n29_), .c(new_n26_), .O(new_n31_));
  ...
  nor2   g14(.a(new_n35_), .b(new_n22_), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(new_n33_), .c(new_n34_), .O(new_n37_));
  oai22  g16(.a(new_n37_), .b(new_n26_), .c(new_n31_), .d(x09), .O(z1));
  nor2   g17(.a(new_n23_), .b(x09), .O(new_n39_));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  nand4  g19(.a(new_n35_), .b(new_n32_), .c(x03), .d(x02), .O(new_n41_));
  aoi22  g20(.a(new_n41_), .b(x12), .c(new_n40_), .d(new_n39_), .O(new_n42_));
  ...
  nand3  g24(.a(new_n40_), .b(new_n39_), .c(x13), .O(new_n46_));
  inv1   g25(.a(x13), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n35_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n33_), .c(new_n47_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n46_), .c(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n22_), .c(new_n26_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n51_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  oai22  g35(.a(new_n56_), .b(new_n55_), .c(new_n32_), .d(x05), .O(z4));
endmodule
