...
module FAU ( 
  ...
  oai21  g11(.a(new_n23_), .b(x09), .c(new_n30_), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x04), .O(new_n34_));
  inv1   g13(.a(x01), .O(new_n35_));
  aoi21  g14(.a(new_n22_), .b(new_n35_), .c(new_n26_), .O(new_n36_));
  aoi22  g15(.a(new_n36_), .b(new_n34_), .c(new_n32_), .d(new_n29_), .O(z1));
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(x03), .d(x02), .O(new_n38_));
