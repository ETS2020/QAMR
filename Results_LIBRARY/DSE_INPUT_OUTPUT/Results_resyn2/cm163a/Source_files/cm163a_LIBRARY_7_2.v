...
module FAU ( 
  ...
  nand2  g04(.a(x12), .b(x05), .O(new_n26_));
  ...
  aoi21  g16(.a(x06), .b(new_n22_), .c(new_n34_), .O(new_n38_));
  oai21  g17(.a(new_n32_), .b(new_n22_), .c(new_n38_), .O(new_n39_));
  ...
  aoi21  g25(.a(new_n34_), .b(x05), .c(new_n46_), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(x15), .c(x14), .d(x10), .O(new_n48_));
