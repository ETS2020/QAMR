...
module FAU ( 
  ...
  oai21  g08(.a(x13), .b(new_n29_), .c(x05), .O(new_n30_));
  ...
  nor2   g18(.a(x13), .b(new_n29_), .O(new_n40_));
  ...
  aoi21  g26(.a(new_n47_), .b(new_n43_), .c(new_n40_), .O(z2));
  inv1   g27(.a(x13), .O(new_n49_));
  nor2   g28(.a(x11), .b(x09), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n24_), .c(new_n41_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n44_), .c(new_n29_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n49_), .O(new_n53_));
  nor2   g32(.a(new_n49_), .b(new_n44_), .O(new_n54_));
