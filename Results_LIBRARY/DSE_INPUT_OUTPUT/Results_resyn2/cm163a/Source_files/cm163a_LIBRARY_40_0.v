...
module FAU ( 
  ...
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(x13), .O(new_n44_));
  inv1   g23(.a(x13), .O(new_n45_));
  nand3  g24(.a(new_n29_), .b(x03), .c(x02), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n30_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n46_), .c(new_n45_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n44_), .c(x04), .O(new_n50_));
