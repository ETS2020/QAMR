...
module FAU ( 
  ...
  nand2  g04(.a(x13), .b(x10), .O(new_n26_));
  ...
  inv1   g33(.a(x10), .O(new_n55_));
  nand4  g34(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n49_), .c(new_n55_), .O(z4));
endmodule
