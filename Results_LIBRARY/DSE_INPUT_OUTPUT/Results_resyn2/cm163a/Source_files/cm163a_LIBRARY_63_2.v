...
module FAU ( 
  ...
  oai21  g19(.a(new_n40_), .b(new_n22_), .c(new_n35_), .O(z2));
  inv1   g20(.a(x13), .O(new_n42_));
  nand3  g21(.a(new_n39_), .b(new_n36_), .c(new_n42_), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n37_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n30_), .c(x13), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n43_), .c(x04), .O(new_n47_));
  inv1   g26(.a(x06), .O(new_n48_));
  aoi21  g27(.a(x07), .b(new_n22_), .c(new_n48_), .O(new_n49_));
  ...
  oai22  g33(.a(new_n54_), .b(new_n53_), .c(x06), .d(new_n52_), .O(z4));
endmodule
