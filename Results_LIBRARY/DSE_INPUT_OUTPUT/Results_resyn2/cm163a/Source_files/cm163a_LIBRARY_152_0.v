...
module FAU ( 
  ...
  nand3  g17(.a(new_n38_), .b(x05), .c(new_n22_), .O(new_n39_));
  ...
  aoi21  g26(.a(new_n41_), .b(new_n40_), .c(new_n47_), .O(new_n48_));
  nand2  g27(.a(new_n41_), .b(new_n47_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n30_), .c(x05), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(x05), .c(new_n22_), .O(new_n53_));
