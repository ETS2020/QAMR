...
module FAU ( 
  ...
  oai21  g08(.a(new_n29_), .b(new_n22_), .c(x05), .O(new_n30_));
  nand2  g09(.a(new_n30_), .b(x09), .O(new_n31_));
  nand2  g10(.a(new_n23_), .b(x11), .O(new_n32_));
  inv1   g11(.a(x09), .O(new_n33_));
  nand4  g12(.a(new_n29_), .b(new_n33_), .c(x03), .d(x02), .O(new_n34_));
  ...
  nand2  g16(.a(new_n37_), .b(new_n31_), .O(z1));
  xor2a  g17(.a(new_n34_), .b(x12), .O(new_n39_));
  ...
  nand4  g24(.a(new_n45_), .b(new_n44_), .c(x13), .d(new_n43_), .O(new_n46_));
  inv1   g25(.a(x13), .O(new_n47_));
  nand4  g26(.a(new_n45_), .b(new_n43_), .c(x03), .d(x02), .O(new_n48_));
  ...
  oai22  g34(.a(new_n55_), .b(new_n54_), .c(x09), .d(x05), .O(z4));
endmodule
