...
module FAU ( 
  ...
  nand3  g08(.a(x05), .b(new_n29_), .c(new_n28_), .O(new_n30_));
  ...
  aoi21  g13(.a(new_n29_), .b(new_n33_), .c(new_n34_), .O(new_n35_));
  oai21  g14(.a(new_n32_), .b(new_n29_), .c(new_n35_), .O(z1));
  ...
  aoi21  g21(.a(new_n42_), .b(new_n29_), .c(new_n34_), .O(new_n43_));
  ...
  oai21  g27(.a(new_n48_), .b(new_n23_), .c(new_n46_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n45_), .c(x04), .O(new_n50_));
  inv1   g29(.a(x07), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n29_), .c(new_n34_), .O(new_n52_));
