...
module FAU ( 
  ...
  aoi21  g23(.a(new_n44_), .b(new_n35_), .c(new_n42_), .O(new_n45_));
  aoi22  g24(.a(new_n45_), .b(new_n43_), .c(new_n42_), .d(x06), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nand3  g26(.a(new_n44_), .b(new_n35_), .c(new_n47_), .O(new_n48_));
  ...
  aoi21  g35(.a(x06), .b(new_n22_), .c(new_n56_), .O(new_n57_));
