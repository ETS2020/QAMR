...
module FAU ( 
  ...
  nor2   g04(.a(x11), .b(new_n25_), .O(new_n26_));
  ...
  nor3   g25(.a(new_n33_), .b(new_n46_), .c(x12), .O(new_n47_));
  oai21  g26(.a(new_n33_), .b(x12), .c(new_n46_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x04), .O(new_n49_));
  oai21  g28(.a(new_n46_), .b(new_n22_), .c(x11), .O(new_n50_));
  oai21  g29(.a(x07), .b(x04), .c(x05), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(x10), .c(new_n51_), .O(new_n52_));
  oai21  g31(.a(new_n49_), .b(new_n47_), .c(new_n52_), .O(z3));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  nand4  g33(.a(x15), .b(x14), .c(x11), .d(x10), .O(new_n55_));
