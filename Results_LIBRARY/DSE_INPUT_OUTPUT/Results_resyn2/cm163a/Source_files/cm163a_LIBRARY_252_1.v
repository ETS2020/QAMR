...
module FAU ( 
  ...
  inv1   g07(.a(x07), .O(new_n29_));
  nand2  g08(.a(new_n29_), .b(new_n26_), .O(new_n30_));
  oai21  g09(.a(new_n23_), .b(x09), .c(x11), .O(new_n31_));
  ...
  aoi21  g22(.a(x06), .b(new_n22_), .c(new_n26_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n30_), .O(z2));
  nand2  g25(.a(x05), .b(x04), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  inv1   g27(.a(new_n34_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n48_), .c(new_n40_), .O(new_n50_));
  aoi21  g29(.a(new_n42_), .b(x13), .c(new_n47_), .O(new_n51_));
  aoi22  g30(.a(new_n51_), .b(new_n50_), .c(new_n47_), .d(x07), .O(z3));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  aoi21  g32(.a(x07), .b(new_n26_), .c(new_n53_), .O(new_n54_));
