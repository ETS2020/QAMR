...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n45_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_;
  ...
  nand4  g16(.a(new_n37_), .b(new_n35_), .c(x13), .d(x05), .O(z1));
  ...
  aoi21  g25(.a(x07), .b(new_n26_), .c(new_n27_), .O(new_n47_));
  oai21  g26(.a(new_n42_), .b(new_n26_), .c(new_n47_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x05), .O(z3));
  nand2  g28(.a(x08), .b(x03), .O(new_n50_));
  aoi21  g29(.a(new_n27_), .b(x05), .c(new_n50_), .O(new_n51_));
