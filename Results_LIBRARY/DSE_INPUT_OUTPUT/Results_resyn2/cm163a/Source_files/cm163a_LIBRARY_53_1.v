...
module FAU ( 
  ...
  nor2   g21(.a(new_n24_), .b(x09), .O(new_n43_));
  ...
  nor3   g25(.a(new_n46_), .b(new_n23_), .c(new_n32_), .O(new_n47_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n27_), .c(new_n50_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n49_), .c(x04), .O(new_n54_));
  ...
  nand2  g36(.a(x07), .b(x03), .O(new_n58_));
  nand4  g37(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n59_));
