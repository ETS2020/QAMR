...
module FAU ( 
  ...
  nor2   g26(.a(x13), .b(new_n29_), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(new_n33_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n45_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x05), .O(new_n51_));
  oai21  g30(.a(new_n34_), .b(x12), .c(x04), .O(new_n52_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x13), .d(x05), .O(z4));
endmodule
