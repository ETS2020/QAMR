...
module FAU ( 
  ...
  aoi21  g13(.a(new_n34_), .b(x11), .c(new_n29_), .O(new_n35_));
  aoi22  g14(.a(new_n35_), .b(new_n32_), .c(new_n29_), .d(x01), .O(z1));
  inv1   g15(.a(x01), .O(new_n37_));
  nand2  g16(.a(new_n26_), .b(new_n37_), .O(new_n38_));
  oai21  g17(.a(new_n34_), .b(x11), .c(x12), .O(new_n39_));
  ...
  aoi21  g21(.a(x06), .b(new_n22_), .c(new_n26_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n38_), .O(z2));
  inv1   g24(.a(x13), .O(new_n46_));
  nand3  g25(.a(new_n40_), .b(new_n31_), .c(new_n46_), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n30_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n34_), .c(x13), .O(new_n50_));
  ...
  nand2  g32(.a(new_n53_), .b(new_n38_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  aoi21  g34(.a(new_n26_), .b(x01), .c(new_n55_), .O(new_n56_));
