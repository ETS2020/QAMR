...
module FAU ( 
  ...
  aoi21  g04(.a(new_n22_), .b(x09), .c(new_n25_), .O(new_n26_));
  oai21  g05(.a(new_n26_), .b(x00), .c(x05), .O(z0));
  ...
  nand3  g10(.a(new_n31_), .b(new_n30_), .c(x04), .O(new_n32_));
  inv1   g11(.a(x04), .O(new_n33_));
  aoi21  g12(.a(new_n33_), .b(x01), .c(x00), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(new_n32_), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x05), .O(z1));
  oai21  g15(.a(new_n24_), .b(x11), .c(x12), .O(new_n37_));
  ...
  aoi21  g28(.a(x07), .b(new_n33_), .c(x00), .O(new_n50_));
