...
module FAU ( 
  ...
  aoi22  g11(.a(new_n32_), .b(new_n28_), .c(new_n23_), .d(new_n22_), .O(z0));
  nand4  g12(.a(new_n24_), .b(x04), .c(x03), .d(x02), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x10), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n23_), .O(new_n36_));
  nor2   g15(.a(new_n23_), .b(new_n30_), .O(new_n37_));
  oai21  g16(.a(x04), .b(x01), .c(x05), .O(new_n38_));
  aoi21  g17(.a(new_n37_), .b(new_n26_), .c(new_n38_), .O(new_n39_));
