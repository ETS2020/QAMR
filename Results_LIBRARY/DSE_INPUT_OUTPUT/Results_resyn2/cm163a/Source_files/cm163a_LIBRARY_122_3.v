...
module FAU ( 
  ...
  nand4  g18(.a(new_n39_), .b(new_n37_), .c(new_n22_), .d(x05), .O(z1));
  ...
  oai22  g28(.a(new_n35_), .b(x12), .c(new_n49_), .d(x10), .O(new_n50_));
  ...
  nand4  g34(.a(x15), .b(x14), .c(new_n49_), .d(x10), .O(new_n56_));
