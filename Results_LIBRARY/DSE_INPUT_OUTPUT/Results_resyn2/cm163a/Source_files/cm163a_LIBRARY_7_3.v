...
module FAU ( 
  ...
  nand3  g10(.a(new_n31_), .b(x11), .c(x04), .O(new_n32_));
  nor2   g11(.a(x11), .b(x09), .O(new_n33_));
  nand4  g12(.a(new_n33_), .b(x04), .c(x03), .d(x02), .O(new_n34_));
  inv1   g13(.a(x01), .O(new_n35_));
  nand2  g14(.a(new_n22_), .b(new_n35_), .O(new_n36_));
  nand3  g15(.a(new_n36_), .b(new_n34_), .c(new_n32_), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n26_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x05), .O(z1));
  oai21  g18(.a(x06), .b(x04), .c(new_n34_), .O(new_n40_));
  ...
  aoi21  g27(.a(x07), .b(new_n22_), .c(x12), .O(new_n49_));
