...
module FAU ( 
  ...
  aoi21  g21(.a(new_n42_), .b(new_n30_), .c(new_n22_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n30_), .c(new_n43_), .O(z2));
  inv1   g23(.a(x12), .O(new_n45_));
  nor2   g24(.a(new_n27_), .b(x09), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n45_), .c(new_n34_), .d(x04), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x05), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n23_), .O(new_n49_));
  nor2   g28(.a(new_n23_), .b(new_n30_), .O(new_n50_));
