...
module FAU ( 
  ...
  aoi22  g11(.a(new_n32_), .b(new_n28_), .c(new_n22_), .d(x08), .O(z0));
  nand2  g12(.a(new_n22_), .b(x08), .O(new_n34_));
  oai21  g13(.a(x04), .b(x01), .c(x05), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  oai21  g15(.a(new_n25_), .b(x09), .c(x11), .O(new_n37_));
  nand4  g16(.a(new_n22_), .b(new_n23_), .c(x03), .d(x02), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(x08), .c(new_n37_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(x04), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n36_), .O(z1));
  nor2   g20(.a(new_n25_), .b(x09), .O(new_n42_));
  ...
  aoi21  g26(.a(new_n46_), .b(x08), .c(new_n47_), .O(new_n48_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n24_), .c(new_n51_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n50_), .c(x04), .O(new_n54_));
  oai21  g33(.a(new_n51_), .b(new_n30_), .c(x11), .O(new_n55_));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  aoi21  g35(.a(new_n55_), .b(x08), .c(new_n56_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n54_), .O(z3));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nand4  g38(.a(x15), .b(x14), .c(x11), .d(x10), .O(new_n60_));
