...
module FAU ( 
  ...
  inv1   g04(.a(x01), .O(new_n26_));
  nand2  g05(.a(x05), .b(new_n26_), .O(new_n27_));
  ...
  nand4  g12(.a(new_n33_), .b(new_n30_), .c(x03), .d(x02), .O(new_n34_));
