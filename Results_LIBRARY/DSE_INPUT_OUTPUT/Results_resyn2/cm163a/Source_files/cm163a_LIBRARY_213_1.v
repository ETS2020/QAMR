...
module FAU ( 
  ...
  oai21  g16(.a(new_n26_), .b(x11), .c(x12), .O(new_n38_));
  nor2   g17(.a(new_n27_), .b(x09), .O(new_n39_));
  ...
  aoi21  g21(.a(x06), .b(new_n30_), .c(new_n22_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n24_), .O(z2));
  ...
  nand4  g34(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n56_));
