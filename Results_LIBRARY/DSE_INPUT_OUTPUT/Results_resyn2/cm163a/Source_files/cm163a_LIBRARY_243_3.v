...
module FAU ( 
  ...
  aoi21  g18(.a(new_n39_), .b(new_n36_), .c(new_n27_), .O(z1));
  ...
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(new_n27_), .O(z2));
  oai21  g25(.a(x07), .b(x04), .c(x05), .O(new_n47_));
  oai21  g26(.a(new_n26_), .b(new_n25_), .c(new_n47_), .O(new_n48_));
  oai22  g27(.a(new_n34_), .b(x12), .c(new_n26_), .d(x10), .O(new_n49_));
  inv1   g28(.a(new_n34_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x13), .c(new_n41_), .O(new_n51_));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n26_), .c(new_n25_), .O(z4));
endmodule
