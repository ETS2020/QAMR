...
module FAU ( 
  ...
  nor2   g18(.a(new_n33_), .b(new_n39_), .O(new_n40_));
  nand2  g19(.a(new_n33_), .b(new_n39_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x04), .O(new_n42_));
  nor2   g21(.a(x06), .b(x04), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n27_), .O(new_n44_));
  oai21  g23(.a(new_n42_), .b(new_n40_), .c(new_n44_), .O(z2));
  inv1   g24(.a(x07), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n22_), .O(new_n47_));
  nand2  g26(.a(new_n39_), .b(x04), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n33_), .c(new_n47_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n26_), .O(new_n50_));
