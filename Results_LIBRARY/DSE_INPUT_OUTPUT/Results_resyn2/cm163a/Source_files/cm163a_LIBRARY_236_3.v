...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(x07), .O(new_n28_));
  ...
  oai21  g26(.a(x15), .b(new_n32_), .c(x07), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  inv1   g28(.a(x12), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n38_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n33_), .c(new_n49_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n48_), .c(new_n47_), .O(new_n53_));
