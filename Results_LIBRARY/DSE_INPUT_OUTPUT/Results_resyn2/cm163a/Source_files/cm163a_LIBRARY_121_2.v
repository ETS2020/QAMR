...
module FAU ( 
  ...
  xor2a  g07(.a(new_n24_), .b(x11), .O(new_n29_));
  inv1   g08(.a(x01), .O(new_n30_));
  inv1   g09(.a(x05), .O(new_n31_));
  aoi21  g10(.a(new_n28_), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  oai21  g11(.a(new_n29_), .b(new_n28_), .c(new_n32_), .O(z1));
  inv1   g12(.a(x00), .O(new_n34_));
  nand2  g13(.a(new_n31_), .b(new_n34_), .O(new_n35_));
  oai21  g14(.a(new_n24_), .b(x11), .c(x12), .O(new_n36_));
  ...
  aoi21  g19(.a(x06), .b(new_n28_), .c(new_n31_), .O(new_n41_));
