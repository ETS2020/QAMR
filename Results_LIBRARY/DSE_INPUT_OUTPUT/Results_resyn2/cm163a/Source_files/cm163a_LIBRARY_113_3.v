...
module FAU ( 
  ...
  nor3   g30(.a(new_n51_), .b(x11), .c(new_n50_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n49_), .O(z3));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  nand3  g33(.a(x15), .b(x14), .c(x10), .O(new_n55_));
  oai22  g34(.a(new_n55_), .b(new_n54_), .c(new_n22_), .d(new_n50_), .O(z4));
endmodule
