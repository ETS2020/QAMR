...
module FAU ( 
  ...
  nand4  g18(.a(new_n30_), .b(new_n39_), .c(x03), .d(x02), .O(new_n40_));
  inv1   g19(.a(x13), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x04), .O(new_n42_));
  oai22  g21(.a(new_n42_), .b(new_n40_), .c(x07), .d(x04), .O(new_n43_));
  ...
  oai22  g29(.a(new_n50_), .b(new_n49_), .c(x13), .d(x05), .O(z4));
endmodule
