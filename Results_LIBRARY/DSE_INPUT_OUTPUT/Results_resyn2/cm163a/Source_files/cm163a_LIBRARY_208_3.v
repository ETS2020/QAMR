...
module FAU ( 
  ...
  aoi21  g13(.a(new_n27_), .b(x01), .c(x15), .O(new_n35_));
  ...
  nor3   g21(.a(new_n42_), .b(x15), .c(new_n41_), .O(new_n43_));
  oai21  g22(.a(new_n40_), .b(new_n27_), .c(new_n43_), .O(z2));
  ...
  aoi21  g29(.a(x07), .b(new_n27_), .c(x15), .O(new_n51_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n41_), .c(new_n54_), .O(z4));
endmodule
