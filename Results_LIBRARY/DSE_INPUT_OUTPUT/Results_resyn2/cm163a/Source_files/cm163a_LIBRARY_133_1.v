...
module FAU ( 
  ...
  aoi22  g09(.a(new_n30_), .b(new_n26_), .c(x14), .d(new_n22_), .O(z0));
  ...
  oai21  g17(.a(new_n38_), .b(x13), .c(x05), .O(new_n39_));
  ...
  oai21  g26(.a(new_n47_), .b(new_n34_), .c(new_n38_), .O(new_n48_));
  ...
  nor2   g30(.a(new_n22_), .b(new_n28_), .O(new_n52_));
