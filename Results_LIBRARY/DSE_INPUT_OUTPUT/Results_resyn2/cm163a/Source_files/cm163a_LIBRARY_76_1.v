...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(new_n36_), .c(new_n31_), .O(new_n37_));
  oai21  g16(.a(new_n35_), .b(new_n30_), .c(new_n37_), .O(z1));
  aoi21  g17(.a(x05), .b(x04), .c(new_n22_), .O(new_n39_));
  oai21  g18(.a(new_n34_), .b(x11), .c(x12), .O(new_n40_));
  nand2  g19(.a(x05), .b(x04), .O(new_n41_));
  nor2   g20(.a(x12), .b(x11), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n27_), .c(new_n41_), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(new_n40_), .c(new_n39_), .O(z2));
  nand3  g23(.a(new_n42_), .b(new_n27_), .c(x13), .O(new_n45_));
  inv1   g24(.a(x13), .O(new_n46_));
  inv1   g25(.a(x11), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n34_), .c(new_n46_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n45_), .c(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n30_), .c(new_n31_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n51_), .O(z3));
  inv1   g33(.a(new_n23_), .O(new_n55_));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  inv1   g35(.a(new_n56_), .O(new_n57_));
  nand4  g36(.a(new_n57_), .b(new_n55_), .c(x08), .d(x03), .O(new_n58_));
