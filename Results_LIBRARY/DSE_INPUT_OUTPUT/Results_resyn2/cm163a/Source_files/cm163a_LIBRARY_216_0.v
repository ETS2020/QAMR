...
module FAU ( 
  ...
  oai21  g21(.a(new_n36_), .b(new_n30_), .c(x15), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nor2   g23(.a(new_n42_), .b(new_n30_), .O(new_n45_));
  oai21  g24(.a(x06), .b(x04), .c(x05), .O(new_n46_));
  aoi21  g25(.a(new_n45_), .b(new_n36_), .c(new_n46_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n44_), .O(z2));
  nor2   g27(.a(new_n23_), .b(x09), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n31_), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n49_), .c(new_n35_), .d(x04), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x15), .c(x12), .O(new_n53_));
  nand2  g32(.a(new_n42_), .b(new_n35_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n26_), .c(new_n50_), .O(new_n55_));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  aoi21  g35(.a(new_n55_), .b(x04), .c(new_n56_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n53_), .O(z3));
