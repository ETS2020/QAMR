...
module FAU ( 
  ...
  nor2   g03(.a(x13), .b(x10), .O(new_n25_));
  ...
  nand4  g10(.a(new_n29_), .b(new_n31_), .c(x03), .d(x02), .O(new_n32_));
  oai21  g11(.a(new_n30_), .b(new_n29_), .c(new_n32_), .O(new_n33_));
  ...
  xor2a  g18(.a(new_n32_), .b(new_n39_), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x04), .O(new_n41_));
  inv1   g20(.a(x06), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n22_), .c(new_n36_), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(new_n41_), .c(new_n25_), .O(z2));
  ...
  nand4  g27(.a(new_n48_), .b(new_n39_), .c(x03), .d(x02), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n39_), .c(new_n29_), .d(x10), .O(new_n51_));
  inv1   g30(.a(new_n51_), .O(new_n52_));
  aoi22  g31(.a(new_n52_), .b(new_n30_), .c(new_n49_), .d(x13), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n22_), .c(new_n47_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n45_), .O(z4));
endmodule
