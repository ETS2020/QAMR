...
module FAU ( 
  ...
  nor2   g07(.a(x13), .b(x05), .O(new_n29_));
  ...
  aoi21  g16(.a(new_n37_), .b(new_n35_), .c(new_n29_), .O(z1));
  ...
  nor2   g25(.a(x13), .b(new_n22_), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n32_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n44_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x05), .O(new_n50_));
  oai21  g29(.a(new_n33_), .b(x12), .c(x04), .O(new_n51_));
  ...
  nor3   g35(.a(new_n56_), .b(new_n55_), .c(new_n29_), .O(z4));
endmodule
