...
module FAU ( 
  ...
  xnor2a g02(.a(new_n23_), .b(x09), .O(new_n24_));
  ...
  aoi21  g08(.a(new_n29_), .b(new_n25_), .c(new_n22_), .O(z0));
  ...
  aoi21  g15(.a(new_n27_), .b(new_n36_), .c(new_n28_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(new_n35_), .c(new_n22_), .O(z1));
  xor2a  g17(.a(new_n33_), .b(x12), .O(new_n39_));
  inv1   g18(.a(x08), .O(new_n40_));
  inv1   g19(.a(x12), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n27_), .c(x09), .O(new_n42_));
  oai21  g21(.a(x06), .b(x04), .c(x05), .O(new_n43_));
  aoi21  g22(.a(new_n42_), .b(new_n40_), .c(new_n43_), .O(new_n44_));
  oai21  g23(.a(new_n39_), .b(new_n27_), .c(new_n44_), .O(z2));
  inv1   g24(.a(new_n23_), .O(new_n46_));
  nand4  g25(.a(new_n32_), .b(new_n46_), .c(x13), .d(new_n41_), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  oai21  g27(.a(new_n33_), .b(x12), .c(new_n48_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n47_), .c(x04), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n27_), .c(x09), .O(new_n51_));
  oai21  g30(.a(x07), .b(x04), .c(x05), .O(new_n52_));
  aoi21  g31(.a(new_n51_), .b(new_n40_), .c(new_n52_), .O(new_n53_));
