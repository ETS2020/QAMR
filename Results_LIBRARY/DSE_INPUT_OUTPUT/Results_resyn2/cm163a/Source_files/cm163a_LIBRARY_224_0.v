...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n54_, new_n55_;
  nor2   g00(.a(x13), .b(x05), .O(new_n22_));
  ...
  nand3  g11(.a(new_n23_), .b(x03), .c(x02), .O(new_n33_));
  ...
  aoi22  g19(.a(new_n40_), .b(new_n26_), .c(new_n39_), .d(x12), .O(new_n41_));
  ...
  nand3  g23(.a(new_n40_), .b(new_n26_), .c(x13), .O(new_n45_));
  ...
  nor3   g34(.a(new_n55_), .b(new_n54_), .c(new_n22_), .O(z4));
endmodule
