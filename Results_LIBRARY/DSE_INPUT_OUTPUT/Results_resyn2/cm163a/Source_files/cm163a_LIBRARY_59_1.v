...
module FAU ( 
  ...
  oai21  g11(.a(x09), .b(new_n24_), .c(x11), .O(new_n33_));
  nand3  g12(.a(new_n33_), .b(new_n32_), .c(x04), .O(new_n34_));
  inv1   g13(.a(x03), .O(new_n35_));
  aoi21  g14(.a(new_n28_), .b(x01), .c(new_n35_), .O(new_n36_));
  ...
  nand4  g19(.a(new_n40_), .b(new_n31_), .c(new_n22_), .d(x02), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n39_), .c(x04), .O(new_n42_));
  aoi21  g21(.a(x06), .b(new_n28_), .c(new_n35_), .O(new_n43_));
  ...
  aoi21  g29(.a(x07), .b(new_n28_), .c(new_n35_), .O(new_n51_));
