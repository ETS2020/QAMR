...
module FAU ( 
  ...
  aoi21  g13(.a(new_n22_), .b(x01), .c(x15), .O(new_n35_));
  ...
  oai21  g21(.a(new_n33_), .b(x12), .c(new_n42_), .O(new_n43_));
  nor2   g22(.a(x11), .b(x09), .O(new_n44_));
  nor2   g23(.a(x13), .b(x12), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n44_), .c(x04), .d(x02), .O(new_n46_));
  nand4  g25(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n47_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(z3));
  inv1   g31(.a(x05), .O(new_n53_));
  nand4  g32(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n53_), .c(new_n26_), .O(z4));
endmodule
