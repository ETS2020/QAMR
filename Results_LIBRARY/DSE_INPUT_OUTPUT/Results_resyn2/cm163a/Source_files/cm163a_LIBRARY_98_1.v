...
module FAU ( 
  ...
  xor2a  g06(.a(new_n25_), .b(x11), .O(new_n28_));
  oai21  g07(.a(new_n28_), .b(new_n27_), .c(x05), .O(z1));
  ...
  oai21  g13(.a(new_n34_), .b(new_n27_), .c(x05), .O(z2));
  inv1   g14(.a(x13), .O(new_n36_));
  inv1   g15(.a(x12), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n31_), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n25_), .c(new_n36_), .O(new_n39_));
  ...
  aoi21  g22(.a(x05), .b(new_n27_), .c(new_n43_), .O(new_n44_));
