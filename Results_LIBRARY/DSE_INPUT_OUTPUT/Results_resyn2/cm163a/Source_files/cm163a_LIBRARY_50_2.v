...
module FAU ( 
  ...
  nand2  g04(.a(new_n25_), .b(x14), .O(new_n26_));
  ...
  nand3  g13(.a(new_n34_), .b(new_n32_), .c(x14), .O(new_n35_));
  ...
  nand3  g21(.a(new_n42_), .b(new_n40_), .c(x14), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x04), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n29_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n44_), .O(z2));
  nor2   g26(.a(x14), .b(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n23_), .b(x09), .O(new_n49_));
  nand3  g28(.a(new_n41_), .b(new_n49_), .c(x13), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n57_), .b(new_n55_), .c(new_n48_), .O(z3));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nand3  g38(.a(x15), .b(x14), .c(x10), .O(new_n60_));
  oai22  g39(.a(new_n60_), .b(new_n59_), .c(x14), .d(new_n22_), .O(z4));
endmodule
