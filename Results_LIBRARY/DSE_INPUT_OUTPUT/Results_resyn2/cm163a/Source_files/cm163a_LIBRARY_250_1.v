...
module FAU ( 
  ...
  nand2  g05(.a(new_n26_), .b(x00), .O(new_n27_));
  aoi21  g06(.a(new_n27_), .b(new_n22_), .c(new_n25_), .O(new_n28_));
  ...
  nand2  g14(.a(x13), .b(new_n22_), .O(new_n36_));
  ...
  nand2  g19(.a(new_n26_), .b(x06), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n22_), .c(new_n25_), .O(new_n42_));
  oai21  g21(.a(new_n40_), .b(new_n22_), .c(new_n42_), .O(z2));
  inv1   g22(.a(x12), .O(new_n44_));
  inv1   g23(.a(new_n33_), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n26_), .c(new_n44_), .d(x04), .O(new_n46_));
  oai21  g25(.a(new_n33_), .b(x12), .c(x13), .O(new_n47_));
  nand2  g26(.a(new_n26_), .b(x07), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n22_), .c(new_n25_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n47_), .c(new_n46_), .O(z3));
  nand3  g29(.a(x15), .b(x14), .c(x10), .O(new_n51_));
  inv1   g30(.a(new_n51_), .O(new_n52_));
  nand4  g31(.a(new_n52_), .b(new_n36_), .c(x08), .d(x03), .O(new_n53_));
