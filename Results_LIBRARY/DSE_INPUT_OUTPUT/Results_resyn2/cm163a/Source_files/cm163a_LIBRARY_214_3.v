...
module FAU ( 
  ...
  aoi21  g06(.a(new_n27_), .b(x00), .c(x08), .O(new_n28_));
  ...
  aoi21  g14(.a(new_n27_), .b(x01), .c(x08), .O(new_n36_));
  ...
  aoi21  g21(.a(x06), .b(new_n27_), .c(x08), .O(new_n43_));
  ...
  aoi21  g30(.a(x07), .b(new_n27_), .c(x08), .O(new_n52_));
