...
module FAU ( 
  ...
  nor2   g21(.a(x06), .b(x05), .O(new_n43_));
  nand3  g22(.a(new_n38_), .b(new_n35_), .c(x13), .O(new_n44_));
  inv1   g23(.a(x13), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n36_), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(z3));
