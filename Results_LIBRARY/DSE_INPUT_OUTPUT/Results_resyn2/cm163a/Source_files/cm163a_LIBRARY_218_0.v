...
module FAU ( 
  ...
  nor2   g09(.a(new_n28_), .b(x09), .O(new_n31_));
  aoi21  g10(.a(new_n31_), .b(x10), .c(new_n30_), .O(new_n32_));
  oai21  g11(.a(new_n32_), .b(new_n22_), .c(new_n27_), .O(z0));
  inv1   g12(.a(x11), .O(new_n34_));
  nand3  g13(.a(new_n29_), .b(new_n34_), .c(x04), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x10), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n23_), .O(new_n37_));
  inv1   g16(.a(new_n31_), .O(new_n38_));
  nor2   g17(.a(new_n34_), .b(new_n22_), .O(new_n39_));
  ...
  oai21  g23(.a(new_n28_), .b(x11), .c(x12), .O(new_n45_));
  nor2   g24(.a(x12), .b(x11), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n23_), .c(x03), .d(x02), .O(new_n47_));
  ...
  nand2  g32(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n35_), .c(x10), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n23_), .O(new_n56_));
  nand3  g35(.a(new_n46_), .b(new_n31_), .c(x10), .O(new_n57_));
  nor2   g36(.a(new_n53_), .b(new_n22_), .O(new_n58_));
