...
module FAU ( 
  ...
  oai21  g06(.a(x14), .b(x10), .c(x05), .O(new_n28_));
  ...
  nor2   g14(.a(new_n35_), .b(new_n28_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n34_), .O(z1));
  nor2   g16(.a(x14), .b(x10), .O(new_n38_));
  ...
  aoi21  g23(.a(new_n44_), .b(new_n41_), .c(new_n38_), .O(z2));
  inv1   g24(.a(x13), .O(new_n46_));
  nor3   g25(.a(new_n32_), .b(new_n46_), .c(x12), .O(new_n47_));
  oai21  g26(.a(new_n32_), .b(x12), .c(new_n46_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x04), .O(new_n49_));
  nor2   g28(.a(x07), .b(x04), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n28_), .O(new_n51_));
