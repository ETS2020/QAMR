...
module FAU ( 
  ...
  aoi21  g27(.a(new_n22_), .b(x04), .c(x07), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n30_), .c(new_n48_), .O(new_n50_));
  oai21  g29(.a(new_n35_), .b(x12), .c(new_n22_), .O(new_n51_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n48_), .O(z4));
endmodule
