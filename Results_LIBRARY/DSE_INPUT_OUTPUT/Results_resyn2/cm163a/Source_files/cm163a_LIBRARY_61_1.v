...
module FAU ( 
  ...
  oai22  g23(.a(new_n44_), .b(new_n26_), .c(new_n38_), .d(x09), .O(z2));
  inv1   g24(.a(x13), .O(new_n46_));
  nand2  g25(.a(new_n41_), .b(new_n39_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n30_), .c(new_n46_), .O(new_n48_));
  nor2   g27(.a(new_n23_), .b(x09), .O(new_n49_));
  nand3  g28(.a(new_n35_), .b(new_n49_), .c(x13), .O(new_n50_));
