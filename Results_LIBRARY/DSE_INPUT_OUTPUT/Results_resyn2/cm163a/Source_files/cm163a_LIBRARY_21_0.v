...
module FAU ( 
  ...
  inv1   g16(.a(new_n22_), .O(new_n38_));
  ...
  nor3   g27(.a(new_n34_), .b(new_n48_), .c(x12), .O(new_n49_));
  oai21  g28(.a(new_n34_), .b(x12), .c(new_n48_), .O(new_n50_));
  ...
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n38_), .O(z4));
endmodule
