...
module FAU ( 
  ...
  nand2  g20(.a(new_n31_), .b(x05), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n34_), .O(z2));
  inv1   g23(.a(x13), .O(new_n45_));
  nand4  g24(.a(new_n32_), .b(new_n22_), .c(x03), .d(x02), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nand2  g26(.a(new_n46_), .b(new_n45_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x04), .O(new_n49_));
  nor2   g28(.a(x07), .b(x04), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n42_), .O(new_n51_));
