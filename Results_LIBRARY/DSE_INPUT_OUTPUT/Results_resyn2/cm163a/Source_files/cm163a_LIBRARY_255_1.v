...
module FAU ( 
  ...
  and2   g07(.a(x05), .b(x04), .O(new_n29_));
  inv1   g08(.a(x11), .O(new_n30_));
  nand4  g09(.a(new_n30_), .b(new_n26_), .c(x03), .d(x02), .O(new_n31_));
  nand3  g10(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(z1));
  ...
  nand3  g15(.a(new_n36_), .b(new_n35_), .c(new_n29_), .O(z2));
  ...
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n41_), .O(new_n42_));
  nand3  g21(.a(new_n42_), .b(new_n40_), .c(new_n29_), .O(z3));
  nand3  g22(.a(x15), .b(x14), .c(x10), .O(new_n44_));
  inv1   g23(.a(new_n44_), .O(new_n45_));
  nand2  g24(.a(x05), .b(new_n22_), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n45_), .c(x08), .d(x03), .O(new_n47_));
