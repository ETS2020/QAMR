...
module FAU ( 
  ...
  oai21  g06(.a(new_n22_), .b(x09), .c(x11), .O(new_n28_));
  ...
  xor2a  g13(.a(new_n30_), .b(x12), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n34_), .c(x05), .O(z2));
  inv1   g15(.a(x13), .O(new_n37_));
  nor2   g16(.a(new_n30_), .b(x12), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  oai21  g18(.a(new_n30_), .b(x12), .c(x13), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n39_), .c(new_n24_), .O(z3));
  nand2  g20(.a(x08), .b(x03), .O(new_n42_));
  aoi21  g21(.a(x05), .b(new_n34_), .c(new_n42_), .O(new_n43_));
