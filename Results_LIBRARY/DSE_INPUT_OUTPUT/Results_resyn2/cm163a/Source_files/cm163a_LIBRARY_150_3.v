...
module FAU ( 
  ...
  nand2  g11(.a(new_n23_), .b(x11), .O(new_n33_));
  nand3  g12(.a(new_n33_), .b(new_n32_), .c(x04), .O(new_n34_));
  aoi21  g13(.a(new_n27_), .b(x01), .c(x06), .O(new_n35_));
  ...
  nand4  g20(.a(new_n41_), .b(new_n40_), .c(new_n31_), .d(new_n22_), .O(new_n42_));
