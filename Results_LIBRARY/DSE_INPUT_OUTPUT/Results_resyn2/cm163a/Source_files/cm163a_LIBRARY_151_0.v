...
module FAU ( 
  ...
  aoi21  g25(.a(new_n35_), .b(new_n46_), .c(new_n45_), .O(new_n47_));
  inv1   g26(.a(x11), .O(new_n48_));
  nand3  g27(.a(x15), .b(new_n45_), .c(new_n48_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n26_), .O(new_n50_));
  ...
  nand2  g32(.a(new_n53_), .b(new_n42_), .O(new_n54_));
  nand2  g33(.a(x13), .b(new_n45_), .O(new_n55_));
  aoi21  g34(.a(new_n36_), .b(x15), .c(new_n55_), .O(new_n56_));
  inv1   g35(.a(x13), .O(new_n57_));
  oai21  g36(.a(new_n49_), .b(new_n26_), .c(new_n57_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(x04), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n56_), .c(new_n54_), .O(z3));
