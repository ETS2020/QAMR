...
module FAU ( 
  ...
  nand2  g04(.a(x14), .b(x05), .O(new_n26_));
  ...
  oai21  g13(.a(new_n30_), .b(x11), .c(x12), .O(new_n35_));
  ...
  aoi21  g19(.a(x06), .b(new_n22_), .c(new_n40_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n39_), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x05), .O(z2));
  inv1   g22(.a(x13), .O(new_n44_));
  nand3  g23(.a(new_n37_), .b(new_n36_), .c(new_n44_), .O(new_n45_));
