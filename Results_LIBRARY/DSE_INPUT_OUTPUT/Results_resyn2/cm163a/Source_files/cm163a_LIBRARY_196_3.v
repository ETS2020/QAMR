...
module FAU ( 
  ...
  xor2a  g04(.a(new_n25_), .b(new_n22_), .O(new_n26_));
  ...
  oai21  g16(.a(new_n33_), .b(new_n29_), .c(new_n23_), .O(new_n38_));
  ...
  oai21  g26(.a(new_n47_), .b(new_n29_), .c(new_n23_), .O(new_n48_));
  ...
  nand3  g33(.a(new_n43_), .b(new_n35_), .c(x13), .O(new_n55_));
  nand4  g34(.a(new_n47_), .b(new_n33_), .c(x03), .d(x02), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n23_), .O(new_n57_));
  nand4  g36(.a(new_n57_), .b(new_n55_), .c(new_n22_), .d(x04), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n54_), .O(z3));
  nand2  g38(.a(x08), .b(x03), .O(new_n60_));
  nand3  g39(.a(x15), .b(x14), .c(x10), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n52_), .O(z4));
endmodule
