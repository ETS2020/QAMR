...
module FAU ( 
  ...
  nand2  g04(.a(x05), .b(x01), .O(new_n26_));
  ...
  nand2  g10(.a(x04), .b(x01), .O(new_n32_));
  oai21  g11(.a(new_n32_), .b(new_n31_), .c(x05), .O(z1));
  nor2   g12(.a(new_n23_), .b(x09), .O(new_n34_));
  inv1   g13(.a(x11), .O(new_n35_));
  nand4  g14(.a(new_n35_), .b(new_n29_), .c(x03), .d(x02), .O(new_n36_));
  nor2   g15(.a(x12), .b(x11), .O(new_n37_));
  aoi22  g16(.a(new_n37_), .b(new_n34_), .c(new_n36_), .d(x12), .O(new_n38_));
  ...
  nand3  g20(.a(new_n37_), .b(new_n34_), .c(x13), .O(new_n42_));
  inv1   g21(.a(x13), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n35_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n30_), .c(new_n43_), .O(new_n46_));
  ...
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(x01), .O(z4));
endmodule
