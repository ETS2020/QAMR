...
module FAU ( 
  ...
  aoi22  g20(.a(new_n41_), .b(new_n27_), .c(new_n40_), .d(x12), .O(new_n42_));
  aoi21  g21(.a(new_n22_), .b(new_n30_), .c(new_n31_), .O(new_n43_));
  oai21  g22(.a(new_n42_), .b(new_n30_), .c(new_n43_), .O(z2));
  nand3  g23(.a(new_n41_), .b(new_n27_), .c(x13), .O(new_n45_));
  inv1   g24(.a(x13), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n39_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n34_), .c(new_n46_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n45_), .c(x04), .O(new_n50_));
  inv1   g29(.a(x07), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n30_), .c(new_n31_), .O(new_n52_));
