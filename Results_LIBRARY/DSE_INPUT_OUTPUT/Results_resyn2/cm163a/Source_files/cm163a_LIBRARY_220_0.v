...
module FAU ( 
  ...
  nor2   g03(.a(x13), .b(x12), .O(new_n25_));
  ...
  oai21  g18(.a(new_n32_), .b(new_n22_), .c(x13), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nor2   g20(.a(new_n39_), .b(new_n22_), .O(new_n42_));
  oai21  g21(.a(x06), .b(x04), .c(x05), .O(new_n43_));
  aoi21  g22(.a(new_n42_), .b(new_n32_), .c(new_n43_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n41_), .O(z2));
  inv1   g24(.a(x07), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n22_), .c(new_n36_), .O(new_n47_));
  nor2   g26(.a(new_n32_), .b(x12), .O(new_n48_));
  nand2  g27(.a(x13), .b(x04), .O(new_n49_));
  oai22  g28(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n25_), .O(z3));
  nand3  g29(.a(x15), .b(x14), .c(x10), .O(new_n51_));
  nand2  g30(.a(x08), .b(x03), .O(new_n52_));
  nor3   g31(.a(new_n52_), .b(new_n51_), .c(new_n25_), .O(z4));
endmodule
