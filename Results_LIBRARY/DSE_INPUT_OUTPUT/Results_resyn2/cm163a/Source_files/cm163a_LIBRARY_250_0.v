...
module FAU ( 
  ...
  nand2  g04(.a(x13), .b(x00), .O(new_n26_));
  ...
  oai21  g14(.a(x13), .b(x04), .c(new_n35_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n34_), .O(z1));
  xor2a  g16(.a(new_n32_), .b(x12), .O(new_n38_));
  nand2  g17(.a(x13), .b(x06), .O(new_n39_));
  ...
  nand2  g25(.a(x13), .b(x07), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n22_), .c(new_n25_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(z3));
  nor2   g28(.a(x13), .b(x04), .O(new_n50_));
