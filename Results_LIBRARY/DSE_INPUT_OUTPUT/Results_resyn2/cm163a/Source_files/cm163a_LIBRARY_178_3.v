...
module FAU ( 
  ...
  aoi22  g21(.a(new_n42_), .b(new_n27_), .c(new_n36_), .d(x12), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  nor3   g23(.a(new_n44_), .b(new_n23_), .c(new_n31_), .O(new_n45_));
  ...
  aoi22  g28(.a(new_n42_), .b(new_n27_), .c(x13), .d(new_n49_), .O(new_n50_));
  nand3  g29(.a(new_n42_), .b(new_n27_), .c(x13), .O(new_n51_));
