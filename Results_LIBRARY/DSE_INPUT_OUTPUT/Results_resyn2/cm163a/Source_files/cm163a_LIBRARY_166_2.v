...
module FAU ( 
  ...
  nand3  g15(.a(new_n25_), .b(x03), .c(x02), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand4  g17(.a(x11), .b(new_n25_), .c(x03), .d(x02), .O(new_n39_));
  aoi21  g18(.a(new_n22_), .b(x02), .c(new_n30_), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(new_n41_));
  ...
  nand4  g24(.a(new_n36_), .b(new_n25_), .c(x03), .d(x02), .O(new_n46_));
  and2   g25(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  oai21  g26(.a(new_n46_), .b(new_n45_), .c(new_n40_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n47_), .c(new_n44_), .O(z2));
  nand2  g28(.a(new_n45_), .b(x08), .O(new_n50_));
  inv1   g29(.a(x13), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n30_), .O(new_n52_));
  oai21  g31(.a(new_n50_), .b(new_n46_), .c(new_n52_), .O(new_n53_));
  nand3  g32(.a(new_n36_), .b(new_n25_), .c(x03), .O(new_n54_));
  nand3  g33(.a(new_n51_), .b(new_n45_), .c(x04), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(x08), .O(new_n56_));
