...
module FAU ( 
  ...
  aoi21  g26(.a(new_n47_), .b(new_n45_), .c(new_n22_), .O(z2));
  nand3  g27(.a(new_n42_), .b(new_n26_), .c(x13), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nand2  g29(.a(new_n43_), .b(new_n50_), .O(new_n51_));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n52_), .c(new_n22_), .O(z3));
