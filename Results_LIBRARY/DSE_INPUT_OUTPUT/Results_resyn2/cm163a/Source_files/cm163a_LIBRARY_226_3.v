...
module FAU ( 
  ...
  nor3   g28(.a(new_n35_), .b(new_n49_), .c(x12), .O(new_n50_));
  oai21  g29(.a(x10), .b(new_n30_), .c(x07), .O(new_n51_));
  oai21  g30(.a(new_n35_), .b(x12), .c(new_n49_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n50_), .c(new_n48_), .O(z3));
  inv1   g33(.a(x03), .O(new_n55_));
  nand4  g34(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n56_));
  nor3   g35(.a(new_n56_), .b(x07), .c(new_n55_), .O(z4));
endmodule
