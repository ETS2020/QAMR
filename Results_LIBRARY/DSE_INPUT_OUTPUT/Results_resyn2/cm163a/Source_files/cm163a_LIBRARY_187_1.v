...
module FAU ( 
  ...
  nand4  g26(.a(new_n26_), .b(new_n42_), .c(new_n35_), .d(new_n24_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x04), .O(new_n49_));
  aoi21  g28(.a(x07), .b(new_n31_), .c(x13), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  inv1   g30(.a(new_n23_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n32_), .O(new_n53_));
  nand4  g32(.a(new_n48_), .b(x13), .c(x07), .d(x04), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(z3));
