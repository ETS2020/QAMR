...
module FAU ( 
  ...
  nand2  g04(.a(x07), .b(x05), .O(new_n26_));
  ...
  nand2  g25(.a(new_n41_), .b(new_n46_), .O(new_n47_));
  inv1   g26(.a(new_n32_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(x13), .c(new_n39_), .O(new_n49_));
  nor2   g28(.a(new_n34_), .b(new_n22_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n49_), .c(new_n47_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x05), .O(z3));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  aoi21  g32(.a(new_n34_), .b(x05), .c(new_n53_), .O(new_n54_));
