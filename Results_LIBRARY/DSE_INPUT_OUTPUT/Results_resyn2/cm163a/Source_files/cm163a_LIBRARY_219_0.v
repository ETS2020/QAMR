...
module FAU ( 
  ...
  nand3  g08(.a(x05), .b(new_n22_), .c(new_n29_), .O(new_n30_));
  ...
  nand4  g13(.a(new_n34_), .b(new_n31_), .c(x03), .d(x02), .O(new_n35_));
  ...
  nand2  g25(.a(new_n40_), .b(new_n45_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n32_), .c(x05), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n46_), .c(x04), .O(new_n49_));
  inv1   g28(.a(x07), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x05), .c(new_n22_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n49_), .O(z3));
  nand3  g31(.a(x15), .b(x14), .c(x10), .O(new_n53_));
  nor2   g32(.a(x05), .b(x04), .O(new_n54_));
