...
module FAU ( 
  ...
  xor2a  g08(.a(new_n29_), .b(x11), .O(new_n30_));
  inv1   g09(.a(x01), .O(new_n31_));
  aoi21  g10(.a(new_n22_), .b(new_n31_), .c(new_n25_), .O(new_n32_));
  oai21  g11(.a(new_n30_), .b(new_n22_), .c(new_n32_), .O(z1));
  oai21  g12(.a(new_n29_), .b(x11), .c(x12), .O(new_n34_));
  ...
  aoi21  g18(.a(x06), .b(new_n22_), .c(new_n39_), .O(new_n40_));
  ...
  oai21  g26(.a(new_n47_), .b(new_n29_), .c(x13), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n44_), .c(x04), .O(new_n49_));
  aoi21  g28(.a(x07), .b(new_n22_), .c(new_n39_), .O(new_n50_));
