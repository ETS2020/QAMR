...
module FAU ( 
  ...
  nor2   g27(.a(new_n44_), .b(new_n23_), .O(new_n49_));
  nand2  g28(.a(new_n44_), .b(new_n23_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x04), .O(new_n51_));
  inv1   g30(.a(x07), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n29_), .c(new_n22_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n49_), .c(new_n53_), .O(z3));
  nand2  g33(.a(x08), .b(x03), .O(new_n55_));
  aoi21  g34(.a(x13), .b(new_n22_), .c(new_n55_), .O(new_n56_));
