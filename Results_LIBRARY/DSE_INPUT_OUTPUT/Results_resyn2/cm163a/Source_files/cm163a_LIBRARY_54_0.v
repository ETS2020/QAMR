...
module FAU ( 
  ...
  nor2   g15(.a(new_n26_), .b(x09), .O(new_n37_));
  ...
  oai21  g27(.a(new_n48_), .b(new_n25_), .c(x13), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n46_), .c(x04), .O(new_n50_));
  aoi21  g29(.a(x07), .b(new_n29_), .c(new_n22_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n23_), .O(z3));
