...
module FAU ( 
  ...
  and2   g00(.a(x09), .b(x02), .O(new_n22_));
  ...
  aoi21  g11(.a(new_n24_), .b(new_n32_), .c(new_n28_), .O(new_n33_));
  oai21  g12(.a(new_n24_), .b(new_n32_), .c(new_n33_), .O(new_n34_));
  inv1   g13(.a(x01), .O(new_n35_));
  aoi21  g14(.a(new_n28_), .b(new_n35_), .c(new_n29_), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(new_n34_), .c(new_n22_), .O(z1));
  nand4  g16(.a(new_n32_), .b(new_n23_), .c(x03), .d(x02), .O(new_n38_));
  nand3  g17(.a(new_n38_), .b(x12), .c(x04), .O(new_n39_));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(x04), .c(x03), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n23_), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x02), .O(new_n43_));
  inv1   g22(.a(x06), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n28_), .c(new_n29_), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n43_), .c(new_n39_), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  nand4  g26(.a(new_n40_), .b(new_n47_), .c(x04), .d(x03), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n23_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x02), .O(new_n50_));
  nand4  g29(.a(new_n40_), .b(new_n23_), .c(x03), .d(x02), .O(new_n51_));
  nor2   g30(.a(new_n47_), .b(new_n28_), .O(new_n52_));
  oai21  g31(.a(x07), .b(x04), .c(x05), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n50_), .O(z3));
  nand3  g34(.a(x15), .b(x14), .c(x10), .O(new_n56_));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nor3   g36(.a(new_n57_), .b(new_n56_), .c(new_n22_), .O(z4));
endmodule
