...
module FAU ( 
  ...
  oai21  g12(.a(new_n25_), .b(x09), .c(x11), .O(new_n34_));
  ...
  aoi21  g19(.a(new_n40_), .b(new_n38_), .c(new_n24_), .O(z1));
  inv1   g20(.a(new_n24_), .O(new_n42_));
  oai21  g21(.a(x06), .b(x04), .c(x05), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nor2   g23(.a(new_n25_), .b(x11), .O(new_n45_));
  xor2a  g24(.a(new_n45_), .b(new_n23_), .O(new_n46_));
  nand2  g25(.a(new_n22_), .b(x04), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n46_), .c(new_n44_), .O(z2));
  nand4  g27(.a(new_n26_), .b(x13), .c(new_n23_), .d(new_n35_), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  oai21  g29(.a(new_n36_), .b(x12), .c(new_n50_), .O(new_n51_));
  nor2   g30(.a(new_n24_), .b(new_n30_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n51_), .c(new_n49_), .O(new_n53_));
  aoi21  g32(.a(x13), .b(x09), .c(x05), .O(new_n54_));
  aoi22  g33(.a(x12), .b(x09), .c(x07), .d(x05), .O(new_n55_));
  oai21  g34(.a(new_n54_), .b(new_n30_), .c(new_n55_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n53_), .O(z3));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nor3   g38(.a(new_n59_), .b(new_n58_), .c(new_n24_), .O(z4));
endmodule
