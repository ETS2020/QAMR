...
module FAU ( 
  ...
  nand2  g00(.a(x07), .b(x04), .O(new_n22_));
  ...
  oai21  g08(.a(new_n29_), .b(new_n28_), .c(x04), .O(new_n30_));
  oai21  g09(.a(new_n30_), .b(new_n27_), .c(new_n25_), .O(new_n31_));
  aoi21  g10(.a(new_n31_), .b(x05), .c(new_n23_), .O(z0));
  inv1   g11(.a(x11), .O(new_n33_));
  nor2   g12(.a(new_n27_), .b(new_n33_), .O(new_n34_));
  inv1   g13(.a(x07), .O(new_n35_));
  nand4  g14(.a(new_n33_), .b(new_n28_), .c(x03), .d(x02), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  oai21  g16(.a(new_n37_), .b(new_n34_), .c(x04), .O(new_n38_));
  inv1   g17(.a(x01), .O(new_n39_));
  inv1   g18(.a(x05), .O(new_n40_));
  aoi21  g19(.a(new_n24_), .b(new_n39_), .c(new_n40_), .O(new_n41_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n24_), .c(new_n40_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n48_), .c(new_n23_), .O(z2));
  inv1   g30(.a(x13), .O(new_n52_));
  nand4  g31(.a(new_n45_), .b(new_n29_), .c(new_n52_), .d(new_n44_), .O(new_n53_));
  nand2  g32(.a(new_n46_), .b(x13), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n53_), .c(new_n35_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x04), .O(new_n56_));
  aoi21  g35(.a(new_n35_), .b(new_n24_), .c(new_n40_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n56_), .O(z3));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nand3  g38(.a(x15), .b(x14), .c(x10), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n59_), .c(new_n22_), .O(z4));
endmodule
