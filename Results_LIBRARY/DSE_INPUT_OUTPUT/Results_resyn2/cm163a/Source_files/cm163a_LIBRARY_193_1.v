...
module FAU ( 
  ...
  aoi21  g10(.a(new_n31_), .b(x05), .c(new_n29_), .O(new_n32_));
  oai21  g11(.a(new_n23_), .b(x09), .c(new_n29_), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x04), .O(new_n34_));
  inv1   g13(.a(x01), .O(new_n35_));
  aoi21  g14(.a(new_n22_), .b(new_n35_), .c(new_n26_), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(new_n34_), .c(new_n32_), .O(z1));
  ...
  oai21  g25(.a(new_n46_), .b(new_n31_), .c(x05), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n29_), .O(new_n48_));
  nand4  g27(.a(new_n38_), .b(new_n44_), .c(x03), .d(x02), .O(new_n49_));
  nor2   g28(.a(new_n45_), .b(new_n22_), .O(new_n50_));
  nor2   g29(.a(x07), .b(x04), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(new_n49_), .c(new_n51_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n26_), .c(new_n48_), .O(z3));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  aoi21  g33(.a(x11), .b(new_n26_), .c(new_n54_), .O(new_n55_));
