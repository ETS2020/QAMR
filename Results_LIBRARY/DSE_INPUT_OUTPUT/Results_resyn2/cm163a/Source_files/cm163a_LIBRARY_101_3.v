...
module FAU ( 
  ...
  nand3  g02(.a(new_n23_), .b(x04), .c(x03), .O(new_n24_));
  ...
  oai21  g13(.a(new_n22_), .b(new_n33_), .c(new_n34_), .O(new_n35_));
  ...
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(x10), .O(new_n40_));
  ...
  nor2   g29(.a(new_n45_), .b(new_n28_), .O(new_n51_));
  ...
  oai21  g33(.a(new_n46_), .b(x13), .c(new_n22_), .O(new_n55_));
  ...
  aoi21  g41(.a(new_n62_), .b(new_n33_), .c(new_n22_), .O(z4));
endmodule
