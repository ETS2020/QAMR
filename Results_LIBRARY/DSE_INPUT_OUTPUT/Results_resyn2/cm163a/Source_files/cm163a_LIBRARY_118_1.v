...
module FAU ( 
  ...
  oai21  g18(.a(new_n33_), .b(new_n29_), .c(new_n22_), .O(new_n40_));
  ...
  nand3  g22(.a(new_n33_), .b(new_n24_), .c(x02), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x12), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nor2   g25(.a(x11), .b(new_n39_), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n35_), .c(new_n46_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n45_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x04), .O(new_n50_));
  oai21  g29(.a(new_n46_), .b(new_n29_), .c(new_n22_), .O(new_n51_));
  oai21  g30(.a(x06), .b(x04), .c(x05), .O(new_n52_));
  aoi21  g31(.a(new_n51_), .b(new_n39_), .c(new_n52_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n50_), .O(z2));
  nand4  g33(.a(new_n47_), .b(new_n35_), .c(x13), .d(new_n46_), .O(new_n55_));
  inv1   g34(.a(x13), .O(new_n56_));
  oai21  g35(.a(new_n36_), .b(x12), .c(new_n56_), .O(new_n57_));
  nor2   g36(.a(new_n23_), .b(new_n29_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n57_), .c(new_n55_), .O(new_n59_));
  aoi21  g38(.a(x13), .b(new_n39_), .c(x05), .O(new_n60_));
  aoi22  g39(.a(x10), .b(new_n39_), .c(x07), .d(x05), .O(new_n61_));
  oai21  g40(.a(new_n60_), .b(new_n29_), .c(new_n61_), .O(new_n62_));
  nand2  g41(.a(new_n62_), .b(new_n59_), .O(z3));
  nand3  g42(.a(x15), .b(x14), .c(x08), .O(new_n64_));
  aoi21  g43(.a(new_n64_), .b(x03), .c(new_n22_), .O(z4));
endmodule
