...
module FAU ( 
  ...
  oai21  g26(.a(x10), .b(new_n22_), .c(new_n47_), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nor3   g28(.a(new_n35_), .b(new_n49_), .c(x12), .O(new_n50_));
  nand2  g29(.a(x10), .b(x04), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x07), .O(new_n52_));
  oai21  g31(.a(new_n35_), .b(x12), .c(new_n49_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n50_), .c(new_n48_), .O(z3));
