...
module FAU ( 
  ...
  nor2   g03(.a(x14), .b(x09), .O(new_n25_));
  ...
  nand2  g10(.a(new_n31_), .b(x14), .O(new_n32_));
  ...
  oai21  g18(.a(x14), .b(x09), .c(new_n39_), .O(new_n40_));
  inv1   g19(.a(x12), .O(new_n41_));
  oai21  g20(.a(new_n23_), .b(x11), .c(x14), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n29_), .c(new_n41_), .O(new_n43_));
  nand3  g22(.a(x14), .b(new_n41_), .c(new_n30_), .O(new_n44_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n31_), .c(x14), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n29_), .O(new_n51_));
  inv1   g30(.a(new_n34_), .O(new_n52_));
  inv1   g31(.a(new_n44_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nor2   g33(.a(new_n48_), .b(new_n22_), .O(new_n55_));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  aoi21  g35(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(new_n57_));
