...
module FAU ( 
  ...
  aoi22  g18(.a(new_n39_), .b(new_n36_), .c(new_n27_), .d(new_n26_), .O(z1));
  ...
  nand4  g26(.a(new_n33_), .b(new_n47_), .c(x03), .d(x02), .O(new_n48_));
  nand3  g27(.a(new_n27_), .b(new_n47_), .c(x02), .O(new_n49_));
  inv1   g28(.a(new_n49_), .O(new_n50_));
  inv1   g29(.a(x09), .O(new_n51_));
  inv1   g30(.a(x11), .O(new_n52_));
  nand4  g31(.a(new_n52_), .b(new_n51_), .c(x08), .d(x03), .O(new_n53_));
  inv1   g32(.a(new_n53_), .O(new_n54_));
  aoi22  g33(.a(new_n54_), .b(new_n50_), .c(new_n48_), .d(x13), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n22_), .c(new_n46_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n28_), .O(z4));
endmodule
