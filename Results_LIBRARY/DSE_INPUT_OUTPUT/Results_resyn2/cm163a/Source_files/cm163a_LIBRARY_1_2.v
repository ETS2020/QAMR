...
module FAU ( 
  ...
  nand4  g17(.a(new_n38_), .b(new_n29_), .c(x03), .d(x02), .O(new_n39_));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n37_), .c(new_n39_), .d(x12), .O(new_n41_));
  nand2  g20(.a(x05), .b(x04), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n41_), .c(new_n36_), .O(z2));
  ...
  nand3  g28(.a(new_n40_), .b(new_n37_), .c(x13), .O(new_n50_));
