...
module FAU ( 
  ...
  oai21  g16(.a(new_n34_), .b(new_n30_), .c(x13), .O(new_n38_));
  ...
  oai21  g26(.a(new_n47_), .b(new_n30_), .c(x13), .O(new_n48_));
  ...
  nor2   g33(.a(new_n25_), .b(x09), .O(new_n55_));
  nand3  g34(.a(new_n43_), .b(new_n55_), .c(x13), .O(new_n56_));
  inv1   g35(.a(x13), .O(new_n57_));
  nand2  g36(.a(new_n47_), .b(new_n34_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n24_), .c(new_n57_), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n56_), .c(x04), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n54_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand3  g41(.a(x15), .b(x14), .c(x10), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n62_), .c(new_n52_), .O(z4));
endmodule
