...
module FAU ( 
  ...
  oai21  g14(.a(new_n22_), .b(x08), .c(new_n35_), .O(new_n36_));
  inv1   g15(.a(new_n26_), .O(new_n37_));
  nor2   g16(.a(x11), .b(x09), .O(new_n38_));
  and2   g17(.a(x11), .b(x08), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n25_), .c(new_n38_), .d(new_n37_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n31_), .c(new_n36_), .O(z1));
  oai21  g20(.a(new_n26_), .b(x09), .c(x12), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  nand4  g22(.a(new_n38_), .b(new_n43_), .c(x03), .d(x02), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x04), .O(new_n46_));
  oai21  g25(.a(new_n43_), .b(new_n31_), .c(x08), .O(new_n47_));
  ...
  nand4  g29(.a(new_n38_), .b(new_n37_), .c(x13), .d(new_n43_), .O(new_n51_));
