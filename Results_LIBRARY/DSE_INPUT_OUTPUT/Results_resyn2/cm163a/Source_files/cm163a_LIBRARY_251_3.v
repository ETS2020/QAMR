...
module FAU ( 
  ...
  nor2   g05(.a(new_n26_), .b(x01), .O(new_n27_));
  ...
  nand4  g14(.a(new_n35_), .b(new_n33_), .c(new_n27_), .d(x04), .O(z1));
  nor2   g15(.a(new_n23_), .b(x09), .O(new_n37_));
  nor2   g16(.a(x12), .b(x11), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n37_), .c(new_n35_), .d(x12), .O(new_n39_));
  ...
  nand3  g22(.a(new_n38_), .b(new_n37_), .c(new_n43_), .O(new_n44_));
  ...
  aoi21  g27(.a(x07), .b(new_n22_), .c(x01), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x05), .O(z3));
  nand2  g30(.a(x05), .b(x01), .O(new_n52_));
