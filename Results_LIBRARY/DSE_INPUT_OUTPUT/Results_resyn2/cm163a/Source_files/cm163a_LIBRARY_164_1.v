...
module FAU ( 
  ...
  nand3  g12(.a(new_n24_), .b(new_n33_), .c(x04), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x05), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n22_), .O(new_n36_));
  inv1   g15(.a(new_n26_), .O(new_n37_));
  nor2   g16(.a(x04), .b(x01), .O(new_n38_));
  nor2   g17(.a(new_n33_), .b(new_n29_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n38_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n30_), .c(new_n36_), .O(z1));
  oai21  g20(.a(new_n34_), .b(x12), .c(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n22_), .O(new_n43_));
  nand4  g22(.a(new_n33_), .b(new_n22_), .c(x03), .d(x02), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(x12), .c(x04), .O(new_n45_));
  inv1   g24(.a(x06), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n29_), .O(new_n47_));
  ...
  nor2   g31(.a(x11), .b(new_n29_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n24_), .c(new_n52_), .d(new_n51_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x05), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n22_), .O(new_n56_));
  nor2   g35(.a(x12), .b(x11), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n26_), .c(new_n52_), .O(new_n58_));
  aoi21  g37(.a(x07), .b(new_n29_), .c(new_n30_), .O(new_n59_));
  oai21  g38(.a(new_n58_), .b(new_n29_), .c(new_n59_), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n56_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand3  g41(.a(x15), .b(x14), .c(x10), .O(new_n63_));
  oai22  g42(.a(new_n63_), .b(new_n62_), .c(new_n22_), .d(x05), .O(z4));
endmodule
