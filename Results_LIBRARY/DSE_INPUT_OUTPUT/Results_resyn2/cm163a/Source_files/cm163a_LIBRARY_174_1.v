...
module FAU ( 
  ...
  nand3  g14(.a(new_n35_), .b(new_n31_), .c(new_n24_), .O(z2));
  inv1   g15(.a(x13), .O(new_n37_));
  nand4  g16(.a(new_n34_), .b(new_n37_), .c(new_n33_), .d(new_n32_), .O(new_n38_));
  nand2  g17(.a(new_n33_), .b(new_n32_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n26_), .c(x13), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n38_), .c(new_n24_), .O(z3));
