...
module FAU ( 
  ...
  aoi21  g14(.a(new_n22_), .b(x01), .c(x14), .O(new_n36_));
  ...
  nor2   g21(.a(new_n42_), .b(new_n27_), .O(new_n43_));
  ...
  aoi21  g29(.a(x07), .b(new_n22_), .c(x14), .O(new_n51_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n54_), .c(new_n26_), .O(z4));
endmodule
