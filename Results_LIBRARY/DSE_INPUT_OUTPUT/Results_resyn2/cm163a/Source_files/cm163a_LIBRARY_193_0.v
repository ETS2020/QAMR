...
module FAU ( 
  ...
  nand4  g11(.a(new_n29_), .b(new_n30_), .c(x03), .d(x02), .O(new_n33_));
  ...
  oai21  g15(.a(new_n32_), .b(new_n29_), .c(new_n36_), .O(z1));
