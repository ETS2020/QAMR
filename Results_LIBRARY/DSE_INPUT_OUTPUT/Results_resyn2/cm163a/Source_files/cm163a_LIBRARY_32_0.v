...
module FAU ( 
  ...
  nand2  g11(.a(new_n29_), .b(x01), .O(new_n33_));
  inv1   g12(.a(x11), .O(new_n34_));
  nor2   g13(.a(new_n26_), .b(new_n34_), .O(new_n35_));
  nand4  g14(.a(new_n34_), .b(new_n22_), .c(x03), .d(x02), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x04), .O(new_n37_));
  oai21  g16(.a(new_n37_), .b(new_n35_), .c(new_n33_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x05), .O(z1));
  nand3  g18(.a(new_n22_), .b(x03), .c(x02), .O(new_n40_));
  nor2   g19(.a(x12), .b(x11), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x04), .O(new_n42_));
  oai22  g21(.a(new_n42_), .b(new_n40_), .c(x06), .d(x04), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x05), .O(new_n44_));
  nand2  g23(.a(new_n37_), .b(x05), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x12), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n44_), .O(z2));
  inv1   g26(.a(x13), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n29_), .c(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x12), .O(new_n50_));
  nand4  g29(.a(new_n41_), .b(new_n23_), .c(new_n48_), .d(new_n22_), .O(new_n51_));
  nand2  g30(.a(new_n36_), .b(x13), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n51_), .c(x04), .O(new_n53_));
  aoi21  g32(.a(x07), .b(new_n29_), .c(new_n30_), .O(new_n54_));
  ...
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x12), .d(x05), .O(z4));
endmodule
