...
module FAU ( 
  ...
  nand4  g23(.a(new_n26_), .b(x13), .c(new_n23_), .d(new_n34_), .O(new_n45_));
  inv1   g24(.a(x13), .O(new_n46_));
  oai21  g25(.a(new_n35_), .b(x12), .c(new_n46_), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n45_), .c(x04), .O(new_n48_));
  inv1   g27(.a(x07), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n29_), .c(new_n22_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n48_), .O(z3));
  nand2  g30(.a(x08), .b(x03), .O(new_n52_));
  aoi21  g31(.a(x12), .b(new_n22_), .c(new_n52_), .O(new_n53_));
