...
module FAU ( 
  ...
  nor2   g07(.a(x14), .b(new_n28_), .O(new_n29_));
  ...
  xor2a  g19(.a(new_n35_), .b(new_n28_), .O(new_n41_));
  ...
  aoi21  g25(.a(new_n46_), .b(new_n42_), .c(new_n29_), .O(z2));
  ...
  nand4  g30(.a(new_n51_), .b(new_n49_), .c(new_n30_), .d(x04), .O(new_n52_));
  aoi21  g31(.a(x13), .b(x12), .c(x05), .O(new_n53_));
  aoi21  g32(.a(x07), .b(x05), .c(new_n29_), .O(new_n54_));
  oai21  g33(.a(new_n53_), .b(new_n43_), .c(new_n54_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n52_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n30_), .O(z4));
endmodule
