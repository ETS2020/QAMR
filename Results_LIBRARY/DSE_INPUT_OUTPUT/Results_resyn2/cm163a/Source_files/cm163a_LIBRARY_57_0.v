...
module FAU ( 
  ...
  nor2   g00(.a(x12), .b(x10), .O(new_n22_));
  ...
  oai21  g21(.a(x12), .b(x10), .c(new_n42_), .O(new_n43_));
  nand2  g22(.a(new_n36_), .b(x12), .O(new_n44_));
  and2   g23(.a(x03), .b(x02), .O(new_n45_));
  nor2   g24(.a(x12), .b(x11), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n45_), .c(x10), .d(new_n25_), .O(new_n47_));
  ...
  nor3   g32(.a(new_n53_), .b(new_n26_), .c(new_n51_), .O(new_n54_));
  oai21  g33(.a(new_n53_), .b(new_n26_), .c(new_n51_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x04), .O(new_n56_));
  inv1   g35(.a(x10), .O(new_n57_));
  oai21  g36(.a(new_n51_), .b(new_n30_), .c(x12), .O(new_n58_));
  oai21  g37(.a(x07), .b(x04), .c(x05), .O(new_n59_));
  aoi21  g38(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(new_n60_));
  oai21  g39(.a(new_n56_), .b(new_n54_), .c(new_n60_), .O(z3));
