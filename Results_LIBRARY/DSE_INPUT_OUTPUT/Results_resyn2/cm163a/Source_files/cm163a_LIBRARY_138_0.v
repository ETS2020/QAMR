...
module FAU ( 
  ...
  nor2   g08(.a(new_n26_), .b(x04), .O(new_n30_));
  ...
  nand4  g14(.a(new_n35_), .b(new_n32_), .c(x03), .d(x02), .O(new_n36_));
  ...
  oai21  g30(.a(new_n51_), .b(new_n33_), .c(x05), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n50_), .c(x04), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  nand2  g33(.a(new_n30_), .b(new_n54_), .O(new_n55_));
