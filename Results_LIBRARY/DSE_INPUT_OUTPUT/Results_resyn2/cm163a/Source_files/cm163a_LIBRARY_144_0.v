...
module FAU ( 
  ...
  and2   g22(.a(new_n35_), .b(x12), .O(new_n44_));
  nor2   g23(.a(x12), .b(x11), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x10), .O(new_n46_));
  nor3   g25(.a(new_n46_), .b(new_n26_), .c(x09), .O(new_n47_));
  ...
  nand4  g33(.a(new_n45_), .b(new_n24_), .c(new_n54_), .d(new_n23_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  ...
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n41_), .O(z4));
endmodule
