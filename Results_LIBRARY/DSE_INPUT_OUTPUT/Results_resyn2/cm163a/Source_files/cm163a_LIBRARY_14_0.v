...
module FAU ( 
  ...
  aoi21  g11(.a(new_n32_), .b(new_n29_), .c(new_n22_), .O(new_n33_));
  oai21  g12(.a(x04), .b(x01), .c(x05), .O(new_n34_));
  or2    g13(.a(new_n34_), .b(new_n33_), .O(z1));
  ...
  nand2  g19(.a(x06), .b(new_n22_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nor2   g21(.a(x10), .b(x05), .O(new_n43_));
  aoi21  g22(.a(new_n42_), .b(x05), .c(new_n43_), .O(z2));
  xor2a  g23(.a(new_n38_), .b(x13), .O(new_n45_));
  inv1   g24(.a(x07), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n22_), .c(new_n26_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n22_), .c(new_n47_), .O(z3));
