...
module FAU ( 
  ...
  xor2a  g21(.a(new_n37_), .b(x12), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  oai21  g23(.a(new_n23_), .b(new_n22_), .c(x05), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  oai21  g25(.a(new_n43_), .b(new_n31_), .c(new_n46_), .O(z2));
  ...
  oai21  g30(.a(new_n48_), .b(new_n31_), .c(new_n23_), .O(new_n52_));
  ...
  aoi21  g35(.a(new_n56_), .b(new_n22_), .c(new_n23_), .O(z4));
endmodule
