...
module FAU ( 
  ...
  nor2   g00(.a(x10), .b(x09), .O(new_n22_));
  ...
  nand4  g08(.a(x10), .b(new_n29_), .c(x03), .d(x02), .O(new_n30_));
  ...
  nand2  g26(.a(new_n47_), .b(x10), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n29_), .O(new_n49_));
  inv1   g28(.a(x06), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n24_), .c(new_n25_), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(z2));
  inv1   g31(.a(x13), .O(new_n53_));
  nand3  g32(.a(new_n46_), .b(new_n44_), .c(new_n53_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x10), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n29_), .O(new_n56_));
  nand3  g35(.a(new_n44_), .b(new_n34_), .c(x10), .O(new_n57_));
  nor2   g36(.a(new_n53_), .b(new_n24_), .O(new_n58_));
