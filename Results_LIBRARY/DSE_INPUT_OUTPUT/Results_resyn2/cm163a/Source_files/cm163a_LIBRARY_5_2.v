...
module FAU ( 
  ...
  aoi22  g19(.a(new_n40_), .b(new_n39_), .c(new_n31_), .d(x12), .O(new_n41_));
  ...
  oai21  g27(.a(new_n48_), .b(new_n32_), .c(x13), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n46_), .c(x04), .O(new_n50_));
  aoi21  g29(.a(x07), .b(new_n22_), .c(new_n35_), .O(new_n51_));
