...
module FAU ( 
  ...
  nor2   g25(.a(new_n46_), .b(new_n30_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n40_), .c(new_n47_), .O(z2));
  oai21  g27(.a(x07), .b(x04), .c(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n29_), .O(new_n50_));
  aoi22  g29(.a(new_n44_), .b(new_n25_), .c(x13), .d(x08), .O(new_n51_));
  nand3  g30(.a(new_n44_), .b(new_n25_), .c(x13), .O(new_n52_));
  ...
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n29_), .O(z4));
endmodule
