...
module FAU ( 
  ...
  nor3   g05(.a(new_n26_), .b(x08), .c(new_n25_), .O(new_n27_));
  ...
  aoi21  g12(.a(new_n22_), .b(x01), .c(x08), .O(new_n34_));
  ...
  nand3  g32(.a(new_n53_), .b(new_n51_), .c(x05), .O(new_n54_));
  aoi21  g33(.a(new_n50_), .b(new_n40_), .c(new_n54_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n49_), .O(z3));
  nand4  g35(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n25_), .c(new_n51_), .O(z4));
endmodule
