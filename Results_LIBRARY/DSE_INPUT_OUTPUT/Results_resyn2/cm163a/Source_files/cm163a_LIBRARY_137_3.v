...
module FAU ( 
  ...
  aoi21  g13(.a(new_n22_), .b(x01), .c(x06), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x05), .O(z1));
  inv1   g16(.a(new_n27_), .O(new_n38_));
  nand2  g17(.a(new_n32_), .b(x12), .O(new_n39_));
  inv1   g18(.a(x12), .O(new_n40_));
  nor2   g19(.a(new_n23_), .b(x09), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n40_), .c(new_n31_), .O(new_n42_));
  nand4  g21(.a(new_n42_), .b(new_n39_), .c(new_n38_), .d(x04), .O(z2));
  nand4  g22(.a(new_n41_), .b(x13), .c(new_n40_), .d(new_n31_), .O(new_n44_));
  ...
  nand2  g29(.a(x06), .b(x05), .O(new_n51_));
