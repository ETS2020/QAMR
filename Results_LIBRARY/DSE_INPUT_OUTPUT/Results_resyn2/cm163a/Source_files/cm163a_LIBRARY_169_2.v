...
module FAU ( 
  ...
  aoi21  g20(.a(new_n41_), .b(new_n22_), .c(new_n40_), .O(new_n42_));
  ...
  nand3  g24(.a(new_n38_), .b(new_n35_), .c(x13), .O(new_n46_));
  inv1   g25(.a(x13), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n36_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n32_), .c(new_n47_), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n46_), .c(x05), .d(x04), .O(new_n51_));
