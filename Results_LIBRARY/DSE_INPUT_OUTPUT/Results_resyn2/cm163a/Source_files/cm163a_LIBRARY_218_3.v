...
module FAU ( 
  ...
  oai21  g15(.a(new_n33_), .b(new_n25_), .c(new_n23_), .O(new_n37_));
  ...
  aoi21  g21(.a(new_n42_), .b(new_n23_), .c(new_n22_), .O(new_n43_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n22_), .c(new_n46_), .O(new_n51_));
  nand2  g30(.a(new_n46_), .b(new_n50_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x04), .O(new_n53_));
  oai21  g32(.a(new_n50_), .b(new_n25_), .c(new_n23_), .O(new_n54_));
  ...
  nand4  g37(.a(x15), .b(x14), .c(x10), .d(new_n22_), .O(new_n59_));
