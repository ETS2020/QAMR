...
module FAU ( 
  ...
  nand3  g15(.a(new_n36_), .b(new_n33_), .c(new_n24_), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(x04), .O(new_n38_));
  inv1   g17(.a(x01), .O(new_n39_));
  aoi21  g18(.a(new_n22_), .b(new_n39_), .c(new_n30_), .O(new_n40_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n42_), .c(new_n24_), .O(new_n45_));
  ...
  nor2   g28(.a(new_n24_), .b(new_n22_), .O(new_n50_));
  ...
  nand3  g33(.a(new_n43_), .b(new_n35_), .c(new_n54_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x04), .O(new_n57_));
  inv1   g36(.a(x07), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n22_), .c(new_n30_), .O(new_n59_));
  aoi21  g38(.a(new_n59_), .b(new_n57_), .c(new_n50_), .O(z3));
  nand4  g39(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n22_), .c(new_n24_), .O(z4));
endmodule
