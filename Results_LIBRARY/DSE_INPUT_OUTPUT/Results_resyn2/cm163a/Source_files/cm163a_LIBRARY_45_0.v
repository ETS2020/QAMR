...
module FAU ( 
  ...
  nand2  g07(.a(x05), .b(new_n22_), .O(new_n29_));
  ...
  nand3  g12(.a(new_n33_), .b(new_n30_), .c(x05), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x04), .O(new_n35_));
  oai21  g14(.a(new_n29_), .b(x01), .c(new_n35_), .O(z1));
  or2    g15(.a(new_n29_), .b(x06), .O(new_n37_));
  ...
  nand3  g20(.a(new_n41_), .b(new_n38_), .c(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x04), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n37_), .O(z2));
  inv1   g23(.a(x13), .O(new_n45_));
  nor2   g24(.a(new_n41_), .b(new_n45_), .O(new_n46_));
  nand2  g25(.a(new_n41_), .b(new_n45_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x04), .O(new_n48_));
  inv1   g27(.a(x07), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n22_), .c(new_n26_), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n46_), .c(new_n50_), .O(z3));
  nand3  g30(.a(x15), .b(x14), .c(x10), .O(new_n52_));
  nor2   g31(.a(x05), .b(x04), .O(new_n53_));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  nor3   g33(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(z4));
endmodule
