...
module FAU ( 
  ...
  nand2  g22(.a(new_n37_), .b(new_n22_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand3  g24(.a(new_n37_), .b(x12), .c(x04), .O(new_n46_));
  nand2  g25(.a(x12), .b(x06), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n31_), .c(new_n32_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n46_), .c(new_n45_), .O(z2));
  inv1   g28(.a(x13), .O(new_n50_));
  nand2  g29(.a(new_n43_), .b(new_n36_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n27_), .c(new_n50_), .O(new_n52_));
  nor2   g31(.a(new_n24_), .b(x09), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(x13), .c(new_n43_), .d(new_n36_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n52_), .c(x04), .O(new_n55_));
  oai21  g34(.a(new_n50_), .b(new_n31_), .c(x12), .O(new_n56_));
  oai21  g35(.a(x07), .b(x04), .c(x05), .O(new_n57_));
  aoi21  g36(.a(new_n56_), .b(x06), .c(new_n57_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n55_), .O(z3));
  nand2  g38(.a(x08), .b(x03), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n23_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(x15), .c(x14), .d(x10), .O(new_n62_));
