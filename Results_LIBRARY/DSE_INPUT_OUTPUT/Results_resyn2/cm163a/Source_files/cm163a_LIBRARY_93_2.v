...
module FAU ( 
  ...
  nand2  g20(.a(x06), .b(x04), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n41_), .c(x05), .O(z2));
  inv1   g22(.a(x13), .O(new_n44_));
  nand3  g23(.a(new_n40_), .b(new_n39_), .c(new_n44_), .O(new_n45_));
  ...
  aoi21  g28(.a(x07), .b(new_n27_), .c(new_n28_), .O(new_n50_));
