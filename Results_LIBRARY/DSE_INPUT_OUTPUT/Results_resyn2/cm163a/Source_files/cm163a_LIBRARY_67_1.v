...
module FAU ( 
  ...
  nor2   g19(.a(new_n40_), .b(x05), .O(new_n41_));
  inv1   g20(.a(x12), .O(new_n42_));
  xor2a  g21(.a(new_n34_), .b(new_n42_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x04), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n29_), .c(new_n30_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(new_n41_), .O(z2));
  aoi21  g26(.a(x05), .b(x04), .c(new_n40_), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  inv1   g28(.a(new_n34_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n49_), .c(new_n42_), .O(new_n51_));
  nand4  g30(.a(new_n24_), .b(new_n42_), .c(new_n33_), .d(new_n22_), .O(new_n52_));
  nand2  g31(.a(x05), .b(x04), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x13), .c(new_n53_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n51_), .c(new_n48_), .O(z3));
  nand2  g34(.a(x08), .b(x03), .O(new_n56_));
  nand3  g35(.a(x15), .b(x14), .c(x10), .O(new_n57_));
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(new_n40_), .d(x05), .O(z4));
endmodule
