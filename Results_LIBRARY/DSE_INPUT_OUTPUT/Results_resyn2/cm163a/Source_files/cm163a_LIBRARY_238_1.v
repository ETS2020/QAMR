...
module FAU ( 
  ...
  oai21  g04(.a(new_n23_), .b(x09), .c(x01), .O(new_n26_));
  ...
  and2   g17(.a(x05), .b(x01), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n38_), .c(new_n33_), .O(z1));
  ...
  aoi21  g26(.a(new_n47_), .b(new_n29_), .c(new_n30_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n46_), .c(new_n33_), .O(z2));
  nand2  g28(.a(new_n44_), .b(x13), .O(new_n50_));
  inv1   g29(.a(x13), .O(new_n51_));
  nand4  g30(.a(new_n43_), .b(new_n24_), .c(new_n51_), .d(new_n42_), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n50_), .c(x01), .O(new_n53_));
  ...
  nor2   g37(.a(new_n58_), .b(new_n33_), .O(new_n59_));
