...
module FAU ( 
  ...
  nor2   g00(.a(x13), .b(x01), .O(new_n22_));
  ...
  aoi21  g15(.a(x13), .b(x04), .c(x01), .O(new_n37_));
  ...
  nor3   g20(.a(new_n41_), .b(new_n22_), .c(new_n29_), .O(new_n42_));
  oai21  g21(.a(new_n40_), .b(new_n28_), .c(new_n42_), .O(z2));
  oai21  g22(.a(x07), .b(x04), .c(x05), .O(new_n44_));
  oai21  g23(.a(x13), .b(x01), .c(new_n44_), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  inv1   g25(.a(new_n24_), .O(new_n47_));
  nor2   g26(.a(x11), .b(x09), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x01), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n51_));
  nand4  g30(.a(new_n48_), .b(new_n46_), .c(x03), .d(x02), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n49_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n51_), .c(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n45_), .O(z3));
