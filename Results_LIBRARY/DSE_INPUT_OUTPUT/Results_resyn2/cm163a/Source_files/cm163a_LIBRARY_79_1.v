...
module FAU ( 
  ...
  nand3  g15(.a(new_n36_), .b(new_n34_), .c(new_n30_), .O(z2));
  inv1   g16(.a(x13), .O(new_n38_));
  nand4  g17(.a(new_n33_), .b(new_n38_), .c(new_n32_), .d(new_n31_), .O(new_n39_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n27_), .c(x13), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n39_), .c(new_n36_), .O(z3));
  nand2  g21(.a(x08), .b(x03), .O(new_n43_));
  nand3  g22(.a(x15), .b(x14), .c(x10), .O(new_n44_));
  oai22  g23(.a(new_n44_), .b(new_n43_), .c(new_n35_), .d(x04), .O(z4));
endmodule
