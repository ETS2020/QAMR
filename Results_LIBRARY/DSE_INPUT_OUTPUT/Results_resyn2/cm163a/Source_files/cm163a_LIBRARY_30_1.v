...
module FAU ( 
  ...
  nand2  g14(.a(x04), .b(x01), .O(new_n36_));
  oai21  g15(.a(new_n36_), .b(new_n35_), .c(x05), .O(z1));
  ...
  nand2  g29(.a(x05), .b(x01), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(new_n28_), .c(new_n51_), .O(new_n52_));
