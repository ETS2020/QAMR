...
module FAU ( 
  ...
  aoi22  g10(.a(new_n31_), .b(new_n27_), .c(x11), .d(x08), .O(z0));
  ...
  oai21  g15(.a(new_n34_), .b(x08), .c(new_n23_), .O(new_n37_));
  nor2   g16(.a(new_n24_), .b(x09), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x11), .O(new_n39_));
  nand3  g18(.a(new_n39_), .b(new_n37_), .c(x04), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n36_), .O(z1));
  inv1   g20(.a(x12), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n34_), .c(new_n23_), .O(new_n43_));
  oai21  g22(.a(new_n38_), .b(x12), .c(x04), .O(new_n44_));
  oai21  g23(.a(new_n42_), .b(new_n29_), .c(new_n33_), .O(new_n45_));
  oai21  g24(.a(x06), .b(x04), .c(x05), .O(new_n46_));
  aoi21  g25(.a(new_n45_), .b(x11), .c(new_n46_), .O(new_n47_));
  oai21  g26(.a(new_n44_), .b(new_n43_), .c(new_n47_), .O(z2));
  nand4  g27(.a(new_n42_), .b(new_n22_), .c(x03), .d(x02), .O(new_n49_));
  nor3   g28(.a(x13), .b(x12), .c(x11), .O(new_n50_));
  aoi22  g29(.a(new_n50_), .b(new_n38_), .c(new_n49_), .d(x13), .O(new_n51_));
  nand2  g30(.a(x13), .b(x04), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n33_), .O(new_n53_));
  oai21  g32(.a(x07), .b(x04), .c(x05), .O(new_n54_));
  aoi21  g33(.a(new_n53_), .b(x11), .c(new_n54_), .O(new_n55_));
  oai21  g34(.a(new_n51_), .b(new_n29_), .c(new_n55_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand4  g36(.a(x15), .b(x14), .c(new_n34_), .d(x10), .O(new_n58_));
