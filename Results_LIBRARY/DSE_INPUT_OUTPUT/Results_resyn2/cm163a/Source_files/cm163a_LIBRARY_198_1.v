...
module FAU ( 
  ...
  nand3  g12(.a(new_n33_), .b(new_n30_), .c(new_n28_), .O(z1));
  nand2  g13(.a(new_n33_), .b(x12), .O(new_n35_));
  nor2   g14(.a(x12), .b(x11), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n32_), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n35_), .c(new_n30_), .O(z2));
  inv1   g17(.a(x13), .O(new_n39_));
  inv1   g18(.a(x12), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n31_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n27_), .c(new_n39_), .O(new_n42_));
  nand3  g21(.a(new_n36_), .b(new_n32_), .c(x13), .O(new_n43_));
  ...
  oai22  g26(.a(new_n47_), .b(new_n46_), .c(new_n29_), .d(x04), .O(z4));
endmodule
