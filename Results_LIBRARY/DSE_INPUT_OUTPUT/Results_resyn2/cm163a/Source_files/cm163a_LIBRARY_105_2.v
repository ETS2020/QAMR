...
module FAU ( 
  ...
  oai21  g12(.a(new_n33_), .b(new_n27_), .c(new_n30_), .O(z1));
  nand2  g13(.a(x06), .b(x05), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n22_), .O(new_n36_));
  nor2   g15(.a(new_n25_), .b(x09), .O(new_n37_));
  inv1   g16(.a(x11), .O(new_n38_));
  nand4  g17(.a(new_n38_), .b(new_n31_), .c(x03), .d(x02), .O(new_n39_));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n37_), .c(new_n39_), .d(x12), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n27_), .c(new_n36_), .O(z2));
  nand2  g21(.a(x07), .b(x05), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n22_), .O(new_n44_));
  nand3  g23(.a(new_n40_), .b(new_n37_), .c(x13), .O(new_n45_));
  ...
  nand4  g28(.a(new_n49_), .b(new_n45_), .c(x05), .d(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n44_), .O(z3));
  inv1   g30(.a(x05), .O(new_n52_));
  nand2  g31(.a(x08), .b(x03), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x04), .c(new_n53_), .O(new_n54_));
