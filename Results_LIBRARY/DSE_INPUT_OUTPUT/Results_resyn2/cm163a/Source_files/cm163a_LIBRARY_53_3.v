...
module FAU ( 
  ...
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(x13), .O(new_n51_));
  oai21  g30(.a(x08), .b(new_n31_), .c(x07), .O(new_n52_));
  inv1   g31(.a(x13), .O(new_n53_));
  inv1   g32(.a(new_n44_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n27_), .c(new_n53_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n52_), .c(new_n51_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n50_), .O(z3));
  inv1   g36(.a(x03), .O(new_n58_));
  nand4  g37(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n59_));
  nor3   g38(.a(new_n59_), .b(x07), .c(new_n58_), .O(z4));
endmodule
