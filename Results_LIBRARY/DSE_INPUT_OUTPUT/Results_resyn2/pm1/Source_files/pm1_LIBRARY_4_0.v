...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n36_, new_n38_, new_n39_, new_n40_,
    new_n41_, new_n43_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
  ...
  nand2  g04(.a(z07), .b(z05), .O(new_n34_));
  nand3  g05(.a(new_n34_), .b(new_n31_), .c(new_n30_), .O(z00));
  inv1   g06(.a(x11), .O(new_n36_));
  nand3  g07(.a(new_n34_), .b(x12), .c(new_n36_), .O(z01));
  nand4  g08(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n38_));
  inv1   g09(.a(new_n38_), .O(new_n39_));
  nand3  g10(.a(x12), .b(x11), .c(x09), .O(new_n40_));
  inv1   g11(.a(new_n40_), .O(new_n41_));
  nand3  g12(.a(new_n41_), .b(new_n39_), .c(new_n34_), .O(z02));
  nor2   g13(.a(x15), .b(x13), .O(new_n43_));
  aoi21  g14(.a(new_n41_), .b(new_n38_), .c(new_n43_), .O(z03));
  nand2  g15(.a(new_n34_), .b(x14), .O(z04));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  aoi21  g17(.a(x12), .b(new_n36_), .c(new_n46_), .O(new_n47_));
  ...
  aoi21  g25(.a(new_n54_), .b(new_n52_), .c(new_n43_), .O(z08));
  nand2  g26(.a(new_n50_), .b(x00), .O(new_n56_));
  xor2a  g27(.a(x12), .b(x11), .O(new_n57_));
  nor3   g28(.a(new_n57_), .b(new_n56_), .c(new_n43_), .O(z09));
  nand3  g29(.a(new_n46_), .b(x12), .c(x09), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n51_), .c(new_n34_), .O(z10));
  ...
  nand4  g36(.a(new_n65_), .b(new_n63_), .c(new_n34_), .d(x11), .O(new_n66_));
  nor2   g37(.a(new_n66_), .b(new_n61_), .O(z11));
