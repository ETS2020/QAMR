...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(new_n30_), .O(new_n37_));
  inv1   g08(.a(new_n37_), .O(new_n38_));
  inv1   g09(.a(x09), .O(new_n39_));
  nand4  g10(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n40_));
  nor3   g11(.a(new_n40_), .b(new_n35_), .c(new_n39_), .O(new_n41_));
  ...
  nand3  g21(.a(new_n37_), .b(x09), .c(x01), .O(new_n51_));
  nor2   g22(.a(new_n51_), .b(new_n50_), .O(z06));
  inv1   g23(.a(new_n49_), .O(new_n53_));
  nor2   g24(.a(new_n30_), .b(new_n39_), .O(new_n54_));
  ...
  nor3   g41(.a(new_n60_), .b(new_n35_), .c(x09), .O(z12));
endmodule
