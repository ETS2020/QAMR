...
module FAU ( 
  ...
  nand3  g05(.a(x12), .b(new_n34_), .c(x01), .O(z01));
  ...
  nor2   g12(.a(new_n31_), .b(x01), .O(new_n42_));
  nor2   g13(.a(new_n42_), .b(x14), .O(z04));
  oai21  g14(.a(new_n31_), .b(x01), .c(x13), .O(z05));
  aoi21  g15(.a(new_n34_), .b(x09), .c(new_n30_), .O(new_n45_));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(x09), .c(x01), .O(new_n47_));
  oai21  g18(.a(new_n45_), .b(new_n31_), .c(new_n47_), .O(z06));
  ...
  nand2  g27(.a(x11), .b(x01), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x12), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n32_), .c(new_n53_), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand4  g31(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n54_), .O(z10));
  nand2  g33(.a(new_n31_), .b(new_n30_), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n61_), .c(new_n54_), .O(z11));
  inv1   g35(.a(x09), .O(new_n65_));
  nand4  g36(.a(x11), .b(new_n53_), .c(new_n65_), .d(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x01), .c(new_n31_), .O(z12));
endmodule
