...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n40_, new_n41_, new_n45_,
    new_n47_, new_n48_, new_n50_, new_n52_;
  inv1   g00(.a(x12), .O(new_n30_));
  nor2   g01(.a(x11), .b(x01), .O(new_n31_));
  nand2  g02(.a(new_n31_), .b(new_n30_), .O(z00));
  inv1   g03(.a(x09), .O(new_n33_));
  aoi21  g04(.a(x11), .b(new_n33_), .c(new_n30_), .O(new_n34_));
  ...
  aoi21  g11(.a(new_n41_), .b(new_n30_), .c(new_n33_), .O(z06));
  inv1   g12(.a(z03), .O(z10));
  nor2   g13(.a(z10), .b(x15), .O(z07));
  inv1   g14(.a(x10), .O(new_n45_));
  nand4  g15(.a(z03), .b(x11), .c(new_n45_), .d(x00), .O(z08));
  nand2  g16(.a(new_n30_), .b(x11), .O(new_n47_));
  nand3  g17(.a(new_n47_), .b(new_n45_), .c(x00), .O(new_n48_));
  nor2   g18(.a(new_n48_), .b(new_n34_), .O(z09));
  nand2  g19(.a(new_n45_), .b(x00), .O(new_n50_));
  nor3   g20(.a(new_n47_), .b(new_n50_), .c(x01), .O(z11));
  nand3  g21(.a(x12), .b(x11), .c(new_n33_), .O(new_n52_));
  nor2   g22(.a(new_n52_), .b(new_n50_), .O(z12));
  one    g23(.O(z02));
endmodule
