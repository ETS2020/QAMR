...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n38_, new_n39_, new_n41_, new_n42_, new_n43_, new_n45_, new_n49_,
  ...
  nand4  g34(.a(new_n63_), .b(new_n50_), .c(new_n59_), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n31_), .O(z09));
  nand4  g36(.a(new_n56_), .b(new_n45_), .c(new_n59_), .d(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x04), .c(new_n34_), .O(z10));
  nand4  g38(.a(new_n56_), .b(new_n39_), .c(x09), .d(x01), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(new_n35_), .c(new_n60_), .O(z11));
  nand2  g40(.a(new_n39_), .b(new_n55_), .O(new_n70_));
