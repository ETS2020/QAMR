...
module FAU ( 
  ...
  oai21  g09(.a(new_n38_), .b(new_n37_), .c(x02), .O(new_n39_));
  ...
  nand2  g15(.a(new_n32_), .b(x13), .O(z05));
  ...
  nand3  g34(.a(new_n63_), .b(new_n61_), .c(z01), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z09));
  nand2  g36(.a(new_n56_), .b(x00), .O(new_n66_));
  nand3  g37(.a(new_n53_), .b(x12), .c(x02), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n66_), .c(new_n38_), .O(z10));
  inv1   g39(.a(new_n34_), .O(new_n69_));
  and2   g40(.a(x12), .b(x02), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(new_n48_), .c(new_n53_), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(new_n69_), .c(new_n57_), .O(z11));
  nand2  g43(.a(new_n70_), .b(new_n52_), .O(new_n73_));
  nor2   g44(.a(new_n73_), .b(new_n57_), .O(z12));
endmodule
