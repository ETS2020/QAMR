...
module FAU ( 
  ...
  aoi21  g13(.a(new_n41_), .b(x08), .c(new_n42_), .O(new_n43_));
  nor2   g14(.a(new_n43_), .b(new_n40_), .O(z03));
  nand2  g15(.a(new_n39_), .b(x14), .O(z04));
  ...
  nand3  g27(.a(new_n56_), .b(new_n53_), .c(new_n39_), .O(z08));
  ...
  nand2  g31(.a(new_n47_), .b(new_n52_), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n55_), .c(new_n39_), .O(z10));
  ...
  nand4  g38(.a(new_n56_), .b(new_n47_), .c(new_n52_), .d(x01), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n67_), .O(z11));
  nor3   g40(.a(new_n55_), .b(new_n30_), .c(x09), .O(z12));
endmodule
