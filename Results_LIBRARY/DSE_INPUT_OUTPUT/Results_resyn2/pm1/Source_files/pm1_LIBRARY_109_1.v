...
module FAU ( 
  ...
  oai21  g13(.a(x13), .b(x12), .c(new_n42_), .O(z03));
  ...
  oai21  g28(.a(new_n53_), .b(new_n36_), .c(new_n57_), .O(z08));
  ...
  oai21  g33(.a(new_n62_), .b(new_n52_), .c(new_n45_), .O(z10));
  nand4  g34(.a(x11), .b(new_n51_), .c(new_n30_), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(z05), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n32_), .O(new_n66_));
  nand4  g37(.a(new_n56_), .b(new_n53_), .c(new_n46_), .d(x01), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(z11));
  nand2  g39(.a(new_n51_), .b(x00), .O(new_n69_));
  nand3  g40(.a(x12), .b(x11), .c(new_n55_), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(z12));
endmodule
