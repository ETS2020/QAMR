...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n35_, new_n36_, new_n40_, new_n41_,
  ...
  nor2   g11(.a(new_n40_), .b(x11), .O(new_n41_));
  ...
  aoi21  g27(.a(new_n56_), .b(x11), .c(new_n40_), .O(z10));
  nand2  g28(.a(new_n40_), .b(new_n30_), .O(new_n58_));
  nand4  g29(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(z11));
  nand3  g31(.a(new_n47_), .b(new_n34_), .c(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x11), .c(new_n40_), .O(z12));
endmodule
