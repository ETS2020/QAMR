...
module FAU ( 
  ...
  nand2  g13(.a(new_n32_), .b(x08), .O(new_n43_));
  ...
  nor2   g40(.a(new_n66_), .b(new_n55_), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n63_), .c(new_n53_), .d(new_n47_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n69_), .O(z11));
  nand2  g43(.a(new_n38_), .b(new_n52_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n61_), .c(new_n43_), .O(z12));
endmodule
