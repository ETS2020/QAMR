...
module FAU ( 
  ...
  nor2   g03(.a(x12), .b(x05), .O(new_n33_));
  nor2   g04(.a(new_n30_), .b(x11), .O(new_n34_));
  nor2   g05(.a(new_n34_), .b(new_n33_), .O(z01));
  ...
  oai21  g27(.a(new_n53_), .b(new_n33_), .c(new_n56_), .O(z08));
  inv1   g28(.a(x11), .O(new_n58_));
  nand2  g29(.a(x12), .b(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n30_), .b(x11), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n59_), .c(new_n51_), .d(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n43_), .O(z09));
  nand2  g33(.a(new_n55_), .b(new_n46_), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n52_), .O(z10));
  inv1   g35(.a(x01), .O(new_n65_));
  nand4  g36(.a(x11), .b(new_n51_), .c(new_n65_), .d(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(x05), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nand4  g39(.a(new_n55_), .b(new_n53_), .c(new_n46_), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n68_), .O(z11));
  nand2  g41(.a(new_n51_), .b(x00), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n37_), .c(x09), .O(z12));
endmodule
