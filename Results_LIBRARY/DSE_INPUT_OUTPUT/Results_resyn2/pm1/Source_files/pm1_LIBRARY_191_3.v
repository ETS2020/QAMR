...
module FAU ( 
  ...
  nand2  g10(.a(x12), .b(new_n34_), .O(new_n40_));
  ...
  nand3  g27(.a(x12), .b(x11), .c(new_n34_), .O(new_n57_));
  nand2  g28(.a(new_n32_), .b(new_n31_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z09));
  nor3   g30(.a(new_n56_), .b(new_n40_), .c(new_n37_), .O(z10));
  aoi21  g31(.a(x12), .b(new_n34_), .c(new_n30_), .O(new_n61_));
