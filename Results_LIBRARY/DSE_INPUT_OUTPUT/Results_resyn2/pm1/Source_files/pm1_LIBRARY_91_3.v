...
module FAU ( 
  ...
  nand3  g06(.a(new_n32_), .b(x12), .c(new_n30_), .O(z01));
  ...
  oai21  g12(.a(new_n41_), .b(new_n37_), .c(new_n32_), .O(new_n42_));
  ...
  oai21  g18(.a(new_n47_), .b(x11), .c(new_n32_), .O(new_n48_));
  ...
  nand2  g23(.a(x15), .b(new_n31_), .O(z07));
  aoi21  g24(.a(new_n51_), .b(x09), .c(x15), .O(new_n54_));
  inv1   g25(.a(x10), .O(new_n55_));
  nand3  g26(.a(x11), .b(new_n55_), .c(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(new_n57_));
  oai21  g28(.a(new_n54_), .b(new_n31_), .c(new_n57_), .O(z08));
  aoi21  g29(.a(new_n32_), .b(x12), .c(new_n30_), .O(new_n59_));
  ...
  nand4  g33(.a(new_n50_), .b(new_n32_), .c(x12), .d(x09), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n56_), .O(z10));
  nand3  g35(.a(x12), .b(x09), .c(x01), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n50_), .c(new_n34_), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n56_), .c(new_n44_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand4  g40(.a(x11), .b(new_n55_), .c(new_n69_), .d(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n32_), .c(new_n31_), .O(z12));
endmodule
