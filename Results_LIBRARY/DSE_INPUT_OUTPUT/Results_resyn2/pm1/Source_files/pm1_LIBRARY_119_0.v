...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n36_, new_n38_,
    new_n39_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
  ...
  nor2   g12(.a(new_n36_), .b(x14), .O(z04));
