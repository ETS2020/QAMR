...
module FAU ( 
  ...
  wire new_n30_, new_n33_, new_n39_, new_n40_, new_n41_, new_n42_, new_n45_,
    new_n46_, new_n47_, new_n49_, new_n52_, new_n53_;
  ...
  nand4  g18(.a(z01), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n49_));
  inv1   g19(.a(new_n49_), .O(z09));
  inv1   g20(.a(x01), .O(new_n52_));
  nand3  g21(.a(z01), .b(x11), .c(new_n52_), .O(new_n53_));
  nor2   g22(.a(new_n53_), .b(new_n46_), .O(z11));
  one    g23(.O(z03));
  zero   g24(.O(z10));
endmodule
