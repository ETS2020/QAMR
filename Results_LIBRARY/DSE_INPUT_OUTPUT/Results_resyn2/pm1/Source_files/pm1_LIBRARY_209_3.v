...
module FAU ( 
  ...
  oai21  g21(.a(new_n32_), .b(new_n34_), .c(x15), .O(z07));
  inv1   g22(.a(x10), .O(new_n52_));
  nand4  g23(.a(new_n32_), .b(x11), .c(new_n52_), .d(x00), .O(z08));
  nand2  g24(.a(new_n31_), .b(new_n52_), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(new_n32_), .c(new_n34_), .O(z09));
  nand3  g26(.a(x11), .b(new_n52_), .c(new_n30_), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n32_), .c(new_n34_), .O(z11));
  nor2   g28(.a(new_n32_), .b(new_n34_), .O(z12));
endmodule
