...
module FAU ( 
  ...
  nand3  g03(.a(new_n32_), .b(x07), .c(new_n31_), .O(new_n33_));
  ...
  nand2  g12(.a(new_n41_), .b(new_n36_), .O(z02));
  nand4  g13(.a(new_n39_), .b(x12), .c(x11), .d(x09), .O(z03));
  ...
  nand3  g31(.a(new_n32_), .b(new_n30_), .c(x07), .O(new_n61_));
