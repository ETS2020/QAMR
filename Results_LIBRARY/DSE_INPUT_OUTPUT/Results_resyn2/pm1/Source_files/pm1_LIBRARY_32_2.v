...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n36_, new_n37_, new_n38_,
    ...
    new_n59_, new_n62_, new_n64_, new_n66_, new_n67_;
  ...
  aoi21  g22(.a(x12), .b(new_n32_), .c(new_n51_), .O(new_n52_));
  oai21  g23(.a(new_n52_), .b(new_n50_), .c(new_n46_), .O(z06));
  ...
  aoi21  g31(.a(new_n56_), .b(x12), .c(new_n30_), .O(z09));
  nand4  g32(.a(new_n51_), .b(new_n40_), .c(new_n55_), .d(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  nand4  g34(.a(new_n51_), .b(new_n49_), .c(x11), .d(new_n55_), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x12), .c(new_n30_), .O(z11));
  inv1   g36(.a(x09), .O(new_n66_));
  nand3  g37(.a(x11), .b(new_n55_), .c(new_n66_), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x12), .c(new_n30_), .O(z12));
endmodule
