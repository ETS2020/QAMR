...
module FAU ( 
  ...
  nand4  g31(.a(new_n48_), .b(new_n58_), .c(x09), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n31_), .O(z10));
  nand4  g33(.a(x12), .b(x11), .c(x09), .d(x01), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n56_), .c(new_n48_), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(z11));
  nand3  g37(.a(new_n58_), .b(new_n38_), .c(x00), .O(new_n67_));
