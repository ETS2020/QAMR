...
module FAU ( 
  ...
  nand4  g14(.a(new_n44_), .b(new_n40_), .c(x09), .d(x01), .O(new_n45_));
  ...
  nor2   g20(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  oai21  g21(.a(new_n51_), .b(new_n49_), .c(x11), .O(new_n52_));
  nand2  g22(.a(new_n32_), .b(new_n31_), .O(new_n53_));
  nand2  g23(.a(new_n53_), .b(new_n52_), .O(z08));
  nand2  g24(.a(x12), .b(x11), .O(new_n55_));
  aoi21  g25(.a(new_n53_), .b(new_n55_), .c(new_n49_), .O(z09));
  ...
  nand3  g30(.a(new_n44_), .b(x12), .c(x09), .O(new_n61_));
  nand2  g31(.a(x12), .b(new_n30_), .O(new_n62_));
  nand3  g32(.a(new_n62_), .b(new_n58_), .c(x11), .O(new_n63_));
  aoi21  g33(.a(new_n61_), .b(x01), .c(new_n63_), .O(z11));
  nor3   g34(.a(new_n49_), .b(new_n55_), .c(x09), .O(z12));
  one    g35(.O(z01));
endmodule
