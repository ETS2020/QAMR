...
module FAU ( 
  ...
  nand2  g21(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  aoi21  g22(.a(new_n49_), .b(new_n47_), .c(new_n51_), .O(z06));
  nand2  g23(.a(new_n44_), .b(x15), .O(z07));
  nand2  g24(.a(x04), .b(x02), .O(new_n54_));
  inv1   g25(.a(x10), .O(new_n55_));
  nand3  g26(.a(x11), .b(new_n55_), .c(x00), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  nand3  g28(.a(x12), .b(x09), .c(x03), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n54_), .c(new_n57_), .O(z08));
  inv1   g30(.a(x00), .O(new_n60_));
  nor2   g31(.a(x10), .b(new_n60_), .O(new_n61_));
  nand2  g32(.a(new_n32_), .b(x11), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n44_), .O(z09));
  nand3  g35(.a(new_n61_), .b(new_n54_), .c(new_n40_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x03), .c(new_n32_), .O(z10));
  aoi21  g37(.a(new_n50_), .b(new_n54_), .c(new_n32_), .O(new_n67_));
  nand2  g38(.a(new_n32_), .b(x01), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(new_n61_), .c(x11), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n67_), .c(new_n44_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(x12), .b(x11), .c(new_n71_), .d(x03), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(x10), .c(new_n60_), .O(z12));
endmodule
