...
module FAU ( 
  ...
  oai21  g19(.a(new_n47_), .b(new_n35_), .c(new_n48_), .O(new_n49_));
  ...
  aoi21  g28(.a(new_n55_), .b(new_n44_), .c(new_n35_), .O(z09));
  inv1   g29(.a(x00), .O(new_n59_));
  nor2   g30(.a(x10), .b(new_n59_), .O(new_n60_));
  nor2   g31(.a(new_n31_), .b(new_n37_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n47_), .d(x12), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  nand4  g34(.a(new_n48_), .b(new_n47_), .c(new_n54_), .d(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x12), .c(new_n31_), .O(z11));
  nand2  g36(.a(new_n60_), .b(new_n37_), .O(new_n66_));
