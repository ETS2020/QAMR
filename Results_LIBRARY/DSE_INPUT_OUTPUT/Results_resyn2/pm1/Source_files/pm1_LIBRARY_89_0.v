...
module FAU ( 
  ...
  inv1   g06(.a(x14), .O(new_n36_));
  oai21  g07(.a(new_n36_), .b(x12), .c(new_n30_), .O(z01));
  ...
  nand2  g13(.a(x14), .b(new_n30_), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(new_n42_), .O(z03));
  nor2   g15(.a(x14), .b(new_n30_), .O(z04));
  nor2   g16(.a(x14), .b(x11), .O(new_n46_));
  nor2   g17(.a(new_n46_), .b(x13), .O(z05));
  oai21  g18(.a(new_n41_), .b(new_n31_), .c(x14), .O(new_n48_));
  ...
  oai21  g36(.a(new_n65_), .b(new_n62_), .c(new_n59_), .O(z10));
  nand2  g37(.a(new_n64_), .b(x11), .O(new_n67_));
  nand4  g38(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(new_n33_), .c(new_n67_), .O(z11));
  nand2  g40(.a(x12), .b(x11), .O(new_n70_));
  nor3   g41(.a(new_n56_), .b(new_n70_), .c(x09), .O(z12));
endmodule
