...
module FAU ( 
  ...
  nand2  g26(.a(new_n41_), .b(z01), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n55_), .O(z09));
  nand4  g28(.a(new_n45_), .b(new_n50_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n33_), .O(z10));
  nand3  g30(.a(new_n45_), .b(new_n50_), .c(x00), .O(new_n60_));
  nand2  g31(.a(new_n38_), .b(x01), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n60_), .O(z11));
