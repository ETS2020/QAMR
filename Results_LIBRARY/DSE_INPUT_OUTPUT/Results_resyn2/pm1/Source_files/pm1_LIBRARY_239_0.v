...
module FAU ( 
  ...
  oai21  g20(.a(new_n49_), .b(new_n47_), .c(new_n46_), .O(z06));
  ...
  nand3  g27(.a(new_n56_), .b(new_n53_), .c(new_n46_), .O(z08));
  ...
  aoi21  g35(.a(new_n64_), .b(new_n33_), .c(new_n55_), .O(z11));
  nand2  g36(.a(x12), .b(x11), .O(new_n66_));
  nand2  g37(.a(new_n54_), .b(x00), .O(new_n67_));
