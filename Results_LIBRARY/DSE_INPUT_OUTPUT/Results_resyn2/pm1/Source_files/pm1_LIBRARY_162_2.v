...
module FAU ( 
  ...
  nor2   g06(.a(new_n35_), .b(new_n33_), .O(z01));
  ...
  nor2   g14(.a(new_n43_), .b(new_n33_), .O(new_n44_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n35_), .c(new_n54_), .O(z08));
  nand2  g26(.a(new_n48_), .b(x00), .O(new_n56_));
  inv1   g27(.a(x07), .O(new_n57_));
  inv1   g28(.a(x11), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n57_), .c(x12), .O(new_n59_));
  nor3   g30(.a(new_n59_), .b(new_n56_), .c(new_n33_), .O(z09));
  nand2  g31(.a(new_n53_), .b(new_n43_), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n49_), .O(z10));
  inv1   g33(.a(x01), .O(new_n63_));
  nand4  g34(.a(x11), .b(new_n48_), .c(new_n63_), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n57_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  nand4  g37(.a(new_n53_), .b(new_n50_), .c(new_n43_), .d(x01), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(z11));
  nand3  g39(.a(x12), .b(x11), .c(new_n52_), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n56_), .c(new_n34_), .O(z12));
endmodule
