...
module FAU ( 
  ...
  nor2   g18(.a(new_n42_), .b(x15), .O(z07));
  ...
  nand4  g26(.a(new_n55_), .b(z01), .c(new_n49_), .d(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(z09));
  nand4  g28(.a(new_n45_), .b(new_n49_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x11), .c(new_n32_), .O(z10));
  nand2  g30(.a(new_n32_), .b(new_n30_), .O(new_n60_));
  nand4  g31(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n60_), .c(new_n50_), .O(z11));
  nand3  g33(.a(new_n49_), .b(new_n35_), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x11), .c(new_n32_), .O(z12));
endmodule
