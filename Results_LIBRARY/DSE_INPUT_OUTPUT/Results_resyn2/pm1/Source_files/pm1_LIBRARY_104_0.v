...
module FAU ( 
  ...
  nor2   g27(.a(x10), .b(new_n47_), .O(new_n58_));
  nand3  g28(.a(new_n58_), .b(x11), .c(x09), .O(new_n59_));
  nor2   g29(.a(new_n59_), .b(new_n57_), .O(z10));
  ...
  nand3  g34(.a(new_n64_), .b(new_n58_), .c(x11), .O(new_n65_));
  nor2   g35(.a(new_n65_), .b(new_n62_), .O(z11));
  oai21  g36(.a(new_n55_), .b(x09), .c(new_n41_), .O(z12));
  one    g37(.O(z00));
endmodule
