...
module FAU ( 
  ...
  nand4  g11(.a(new_n41_), .b(new_n38_), .c(x09), .d(x01), .O(new_n42_));
  inv1   g12(.a(new_n42_), .O(z06));
  aoi21  g13(.a(new_n37_), .b(new_n31_), .c(x15), .O(z07));
  inv1   g14(.a(x00), .O(new_n45_));
  nor2   g15(.a(x10), .b(new_n45_), .O(new_n46_));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g17(.a(new_n47_), .O(new_n48_));
  nand3  g18(.a(new_n48_), .b(x12), .c(x09), .O(new_n49_));
  nand3  g19(.a(new_n49_), .b(new_n46_), .c(x11), .O(z08));
  nand3  g20(.a(new_n46_), .b(x12), .c(x11), .O(new_n51_));
  nand2  g21(.a(new_n51_), .b(new_n38_), .O(z09));
  nand2  g22(.a(new_n47_), .b(x12), .O(new_n53_));
  nand3  g23(.a(new_n46_), .b(x11), .c(x09), .O(new_n54_));
  nor2   g24(.a(new_n54_), .b(new_n53_), .O(z10));
  inv1   g25(.a(x01), .O(new_n56_));
  aoi21  g26(.a(new_n47_), .b(x12), .c(new_n56_), .O(new_n57_));
  nand2  g27(.a(x09), .b(x01), .O(new_n58_));
  nand2  g28(.a(new_n58_), .b(x12), .O(new_n59_));
  nand3  g29(.a(new_n59_), .b(new_n46_), .c(x11), .O(new_n60_));
  nor2   g30(.a(new_n60_), .b(new_n57_), .O(z11));
