...
module FAU ( 
  ...
  nand4  g09(.a(new_n38_), .b(new_n37_), .c(x11), .d(new_n34_), .O(z02));
  ...
  nand3  g24(.a(x11), .b(new_n34_), .c(x00), .O(new_n54_));
  aoi21  g25(.a(new_n53_), .b(new_n38_), .c(new_n54_), .O(new_n55_));
  xor2a  g26(.a(new_n55_), .b(new_n43_), .O(z08));
  aoi21  g27(.a(new_n31_), .b(new_n34_), .c(x12), .O(new_n57_));
  oai21  g28(.a(x10), .b(x00), .c(z01), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n57_), .O(z09));
  nand4  g30(.a(new_n49_), .b(x11), .c(x09), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n34_), .c(new_n32_), .O(z10));
  nand2  g32(.a(new_n50_), .b(x12), .O(new_n62_));
  aoi21  g33(.a(new_n32_), .b(x01), .c(new_n54_), .O(new_n63_));
  and2   g34(.a(new_n63_), .b(new_n62_), .O(z11));
  nor3   g35(.a(new_n54_), .b(new_n32_), .c(x09), .O(z12));
endmodule
