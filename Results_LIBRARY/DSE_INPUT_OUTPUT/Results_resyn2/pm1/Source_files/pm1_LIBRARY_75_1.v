...
module FAU ( 
  ...
  nor3   g12(.a(new_n41_), .b(new_n36_), .c(new_n40_), .O(new_n42_));
  nor2   g13(.a(new_n42_), .b(new_n39_), .O(z02));
  nand3  g14(.a(new_n41_), .b(x11), .c(x09), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x12), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n35_), .O(z03));
  nor2   g17(.a(new_n39_), .b(x14), .O(z04));
  ...
  nor2   g28(.a(new_n31_), .b(new_n40_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  oai21  g30(.a(new_n56_), .b(new_n39_), .c(new_n59_), .O(z08));
  nand2  g31(.a(new_n54_), .b(x00), .O(new_n61_));
  aoi21  g32(.a(new_n36_), .b(new_n33_), .c(new_n61_), .O(z09));
  nand2  g33(.a(new_n58_), .b(new_n49_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n55_), .c(new_n38_), .O(z10));
  ...
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(new_n49_), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n68_), .O(z11));
  nor3   g41(.a(new_n61_), .b(new_n36_), .c(x09), .O(z12));
endmodule
