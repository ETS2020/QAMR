...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n42_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
  ...
  nand4  g28(.a(new_n46_), .b(new_n39_), .c(new_n52_), .d(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z10));
  and2   g30(.a(x01), .b(x00), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n46_), .c(new_n39_), .d(new_n52_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z11));
  inv1   g33(.a(x09), .O(new_n63_));
  nand3  g34(.a(new_n52_), .b(new_n63_), .c(x00), .O(new_n64_));
