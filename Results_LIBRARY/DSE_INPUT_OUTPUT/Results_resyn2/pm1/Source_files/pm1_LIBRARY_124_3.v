...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_,
    ...
    new_n53_, new_n54_, new_n55_, new_n58_, new_n59_, new_n60_, new_n62_,
    new_n63_;
  ...
  oai21  g18(.a(new_n47_), .b(new_n45_), .c(new_n42_), .O(z06));
  ...
  nor2   g27(.a(new_n54_), .b(new_n38_), .O(z10));
  nand2  g28(.a(new_n45_), .b(x12), .O(new_n58_));
  nand2  g29(.a(new_n32_), .b(x01), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n58_), .c(new_n51_), .d(x11), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n42_), .O(z11));
  inv1   g32(.a(x09), .O(new_n62_));
  nand3  g33(.a(x12), .b(new_n62_), .c(new_n34_), .O(new_n63_));
  nor3   g34(.a(new_n63_), .b(new_n54_), .c(new_n31_), .O(z12));
endmodule
