...
module FAU ( 
  ...
  nand3  g11(.a(new_n35_), .b(x11), .c(x09), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x12), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(new_n39_), .O(z03));
  nand2  g14(.a(new_n30_), .b(x00), .O(new_n44_));
  ...
  nand3  g24(.a(new_n53_), .b(x11), .c(new_n52_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(x12), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x00), .O(z08));
  nand2  g27(.a(x11), .b(new_n52_), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(x12), .c(new_n38_), .O(z09));
  nor2   g29(.a(new_n33_), .b(x10), .O(new_n59_));
  nand3  g30(.a(x12), .b(x09), .c(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n59_), .c(new_n47_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  nand4  g34(.a(new_n61_), .b(new_n59_), .c(new_n47_), .d(x01), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z11));
  inv1   g36(.a(x09), .O(new_n66_));
  nand3  g37(.a(x11), .b(new_n52_), .c(new_n66_), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x12), .c(new_n38_), .O(z12));
endmodule
