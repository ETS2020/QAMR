...
module FAU ( 
  ...
  nor2   g13(.a(new_n43_), .b(new_n39_), .O(z06));
  ...
  nor2   g18(.a(new_n48_), .b(new_n42_), .O(new_n49_));
  oai21  g19(.a(new_n49_), .b(new_n47_), .c(x11), .O(new_n50_));
  nand2  g20(.a(new_n31_), .b(new_n30_), .O(new_n51_));
  nand2  g21(.a(new_n51_), .b(new_n50_), .O(z08));
  nand2  g22(.a(x12), .b(x11), .O(new_n53_));
  aoi21  g23(.a(new_n51_), .b(new_n53_), .c(new_n47_), .O(z09));
  inv1   g24(.a(x00), .O(new_n55_));
  nor2   g25(.a(x10), .b(new_n55_), .O(new_n56_));
  nand3  g26(.a(new_n56_), .b(new_n42_), .c(x09), .O(new_n57_));
  aoi21  g27(.a(new_n57_), .b(x11), .c(new_n31_), .O(z10));
  nand3  g28(.a(new_n56_), .b(new_n32_), .c(x11), .O(new_n59_));
  aoi21  g29(.a(new_n43_), .b(x12), .c(new_n59_), .O(z11));
  inv1   g30(.a(x09), .O(new_n61_));
  nand2  g31(.a(new_n56_), .b(new_n61_), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(x11), .c(new_n31_), .O(z12));
  one    g33(.O(z01));
endmodule
