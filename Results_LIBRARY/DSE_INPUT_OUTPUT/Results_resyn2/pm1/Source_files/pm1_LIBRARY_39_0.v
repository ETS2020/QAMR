...
module FAU ( 
  ...
  aoi21  g20(.a(new_n31_), .b(new_n30_), .c(x15), .O(z07));
  ...
  nand4  g28(.a(new_n53_), .b(new_n42_), .c(new_n51_), .d(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z10));
  nand3  g30(.a(new_n55_), .b(new_n45_), .c(x00), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(x11), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n31_), .O(new_n62_));
  and2   g33(.a(x01), .b(x00), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n53_), .c(new_n42_), .d(new_n51_), .O(new_n64_));
