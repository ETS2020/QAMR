...
module FAU ( 
  ...
  nand2  g23(.a(new_n45_), .b(x09), .O(new_n53_));
  nand4  g24(.a(new_n53_), .b(new_n52_), .c(x12), .d(x11), .O(z08));
  nand2  g25(.a(new_n41_), .b(z01), .O(new_n55_));
  nor2   g26(.a(new_n55_), .b(new_n51_), .O(z09));
  nand4  g27(.a(new_n44_), .b(new_n50_), .c(x09), .d(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g29(.a(new_n46_), .b(new_n44_), .c(new_n50_), .d(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n33_), .O(z11));
  nand2  g31(.a(x12), .b(x11), .O(new_n61_));
  nor3   g32(.a(new_n51_), .b(new_n61_), .c(x09), .O(z12));
endmodule
