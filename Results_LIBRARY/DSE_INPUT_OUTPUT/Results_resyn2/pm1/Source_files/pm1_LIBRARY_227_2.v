...
module FAU ( 
  ...
  nand2  g17(.a(new_n30_), .b(x08), .O(new_n47_));
  ...
  aoi21  g22(.a(x12), .b(new_n34_), .c(new_n51_), .O(new_n52_));
  oai21  g23(.a(new_n52_), .b(new_n50_), .c(new_n47_), .O(z06));
  ...
  oai21  g36(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(z10));
  ...
  nand2  g41(.a(new_n55_), .b(x00), .O(new_n71_));
