...
module FAU ( 
  ...
  aoi21  g15(.a(z04), .b(new_n30_), .c(x13), .O(z05));
  oai21  g16(.a(new_n41_), .b(new_n31_), .c(x14), .O(new_n46_));
  ...
  nand2  g21(.a(z04), .b(new_n30_), .O(new_n51_));
  nand2  g22(.a(new_n51_), .b(x15), .O(z07));
  nor2   g23(.a(new_n48_), .b(new_n41_), .O(new_n53_));
  ...
  aoi21  g28(.a(new_n32_), .b(x11), .c(new_n55_), .O(new_n58_));
  and2   g29(.a(new_n58_), .b(z01), .O(z09));
  inv1   g30(.a(x09), .O(new_n60_));
  nand2  g31(.a(new_n48_), .b(x12), .O(new_n61_));
  nand3  g32(.a(x11), .b(new_n54_), .c(x00), .O(new_n62_));
  ...
  nand2  g38(.a(new_n67_), .b(new_n51_), .O(z11));
  nand3  g39(.a(x12), .b(x11), .c(new_n60_), .O(new_n69_));
