...
module FAU ( 
  ...
  nor2   g11(.a(new_n34_), .b(x13), .O(z05));
  ...
  nand2  g21(.a(new_n31_), .b(new_n30_), .O(new_n51_));
  nand2  g22(.a(new_n51_), .b(new_n50_), .O(z08));
  nand2  g23(.a(x12), .b(x11), .O(new_n53_));
  aoi21  g24(.a(new_n51_), .b(new_n53_), .c(new_n47_), .O(z09));
  nand3  g25(.a(new_n42_), .b(x12), .c(x09), .O(new_n55_));
  nor3   g26(.a(new_n55_), .b(new_n47_), .c(new_n30_), .O(z10));
  inv1   g27(.a(x00), .O(new_n57_));
  nor2   g28(.a(x10), .b(new_n57_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n32_), .c(x11), .O(new_n59_));
  aoi21  g30(.a(new_n43_), .b(x12), .c(new_n59_), .O(z11));
  inv1   g31(.a(x09), .O(new_n61_));
  nand2  g32(.a(new_n58_), .b(new_n61_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x11), .c(new_n31_), .O(z12));
endmodule
