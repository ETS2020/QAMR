...
module FAU ( 
  ...
  oai21  g19(.a(new_n41_), .b(new_n45_), .c(new_n48_), .O(z08));
  nand4  g20(.a(x12), .b(x11), .c(new_n46_), .d(x00), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(z00), .O(z09));
  nand2  g22(.a(new_n41_), .b(x09), .O(new_n52_));
  ...
  nand4  g27(.a(new_n56_), .b(x11), .c(new_n46_), .d(x00), .O(new_n57_));
  nor2   g28(.a(new_n57_), .b(new_n55_), .O(z11));
  nor2   g29(.a(new_n50_), .b(x09), .O(z12));
  buf    g30(.a(x11), .O(z01));
endmodule
