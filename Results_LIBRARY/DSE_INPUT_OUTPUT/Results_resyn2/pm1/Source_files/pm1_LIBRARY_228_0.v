...
module FAU ( 
  ...
  nor2   g05(.a(x12), .b(x10), .O(new_n35_));
  ...
  nand2  g25(.a(z09), .b(new_n51_), .O(z08));
  nand3  g26(.a(x12), .b(new_n52_), .c(x00), .O(new_n56_));
  and2   g27(.a(x11), .b(x09), .O(new_n57_));
  nand2  g28(.a(new_n45_), .b(new_n57_), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n56_), .O(z10));
  and2   g30(.a(x01), .b(x00), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n45_), .c(new_n57_), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(x10), .O(z11));
