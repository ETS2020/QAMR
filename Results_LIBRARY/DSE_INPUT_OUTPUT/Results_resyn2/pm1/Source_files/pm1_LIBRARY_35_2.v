...
module FAU ( 
  ...
  oai21  g21(.a(new_n50_), .b(new_n49_), .c(new_n46_), .O(z06));
  ...
  nand3  g33(.a(new_n30_), .b(new_n33_), .c(new_n34_), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z09));
  nand2  g35(.a(new_n58_), .b(new_n48_), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n54_), .c(new_n46_), .O(z10));
  ...
  nand3  g43(.a(new_n53_), .b(new_n57_), .c(x00), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n62_), .c(new_n46_), .O(z12));
endmodule
