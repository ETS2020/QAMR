...
module FAU ( 
  ...
  nor2   g06(.a(new_n33_), .b(x12), .O(new_n36_));
  ...
  nand2  g17(.a(x13), .b(new_n32_), .O(new_n47_));
  ...
  inv1   g25(.a(new_n45_), .O(new_n55_));
  ...
  nand3  g34(.a(new_n33_), .b(new_n32_), .c(new_n30_), .O(new_n64_));
