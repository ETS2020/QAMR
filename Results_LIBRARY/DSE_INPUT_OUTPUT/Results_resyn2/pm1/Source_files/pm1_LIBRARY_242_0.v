...
module FAU ( 
  ...
  nand3  g32(.a(x14), .b(new_n32_), .c(new_n30_), .O(new_n62_));
  ...
  oai21  g36(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(z10));
  nand4  g37(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n33_), .c(new_n56_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand3  g40(.a(x12), .b(x11), .c(new_n69_), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n61_), .c(new_n49_), .O(z12));
endmodule
