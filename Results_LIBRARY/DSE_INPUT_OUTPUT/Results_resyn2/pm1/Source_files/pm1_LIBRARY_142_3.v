...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n38_, new_n39_, new_n40_, new_n41_,
  ...
  inv1   g18(.a(z02), .O(z10));
  nand3  g19(.a(new_n44_), .b(new_n30_), .c(x00), .O(new_n49_));
  aoi21  g20(.a(new_n49_), .b(new_n32_), .c(new_n31_), .O(z11));
