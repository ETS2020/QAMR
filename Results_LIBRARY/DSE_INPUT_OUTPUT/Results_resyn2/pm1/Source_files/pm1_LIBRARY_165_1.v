...
module FAU ( 
  ...
  nand3  g08(.a(x11), .b(x09), .c(x02), .O(new_n38_));
  inv1   g09(.a(new_n38_), .O(new_n39_));
  nand3  g10(.a(new_n39_), .b(new_n37_), .c(x12), .O(z02));
  nand3  g11(.a(new_n36_), .b(x11), .c(x09), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x02), .O(new_n42_));
  ...
  aoi21  g21(.a(new_n48_), .b(new_n44_), .c(new_n50_), .O(z06));
  nand2  g22(.a(new_n44_), .b(x15), .O(z07));
  inv1   g23(.a(x09), .O(new_n53_));
  nand2  g24(.a(x04), .b(x03), .O(new_n54_));
  oai21  g25(.a(new_n54_), .b(new_n53_), .c(x02), .O(new_n55_));
  ...
  nand3  g34(.a(new_n63_), .b(new_n62_), .c(z01), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z09));
  nand2  g36(.a(new_n54_), .b(x12), .O(new_n66_));
  nand2  g37(.a(new_n62_), .b(new_n39_), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n66_), .O(z10));
  nand3  g39(.a(x09), .b(x02), .c(x01), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(new_n54_), .c(x12), .O(new_n71_));
  nand2  g42(.a(new_n32_), .b(new_n30_), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(z11));
  nand4  g44(.a(x11), .b(new_n57_), .c(new_n53_), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x02), .c(new_n32_), .O(z12));
endmodule
