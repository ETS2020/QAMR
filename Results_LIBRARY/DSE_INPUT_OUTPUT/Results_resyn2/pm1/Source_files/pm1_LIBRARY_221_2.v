...
module FAU ( 
  ...
  oai21  g11(.a(x12), .b(x07), .c(new_n40_), .O(z03));
  ...
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(new_n44_), .d(x00), .O(z08));
  nand2  g26(.a(x12), .b(x11), .O(new_n56_));
  inv1   g27(.a(x10), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x00), .O(new_n58_));
  aoi21  g29(.a(new_n56_), .b(new_n33_), .c(new_n58_), .O(z09));
  inv1   g30(.a(x00), .O(new_n60_));
  nand3  g31(.a(new_n54_), .b(new_n52_), .c(new_n46_), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n60_), .c(new_n44_), .O(z10));
  inv1   g33(.a(x01), .O(new_n63_));
  nand4  g34(.a(x11), .b(new_n57_), .c(new_n63_), .d(x00), .O(new_n64_));
  ...
  nand4  g38(.a(new_n67_), .b(new_n54_), .c(new_n52_), .d(new_n46_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n66_), .O(z11));
  nor3   g40(.a(new_n58_), .b(new_n56_), .c(x09), .O(z12));
endmodule
