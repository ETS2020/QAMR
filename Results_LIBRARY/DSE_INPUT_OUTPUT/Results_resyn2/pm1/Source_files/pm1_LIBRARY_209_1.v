...
module FAU ( 
  ...
  nand3  g04(.a(x12), .b(new_n31_), .c(x00), .O(z01));
  ...
  nand4  g11(.a(new_n40_), .b(new_n35_), .c(x11), .d(x00), .O(z03));
  nor2   g12(.a(new_n32_), .b(x00), .O(new_n42_));
  nor2   g13(.a(new_n42_), .b(x14), .O(z04));
  nor2   g14(.a(new_n42_), .b(x13), .O(z05));
  nand2  g15(.a(x09), .b(x01), .O(new_n45_));
  oai21  g16(.a(new_n45_), .b(x11), .c(x00), .O(new_n46_));
  ...
  nand2  g23(.a(new_n49_), .b(new_n40_), .O(new_n53_));
  nor2   g24(.a(new_n31_), .b(x10), .O(new_n54_));
  nand3  g25(.a(new_n54_), .b(new_n53_), .c(x00), .O(z08));
  aoi21  g26(.a(new_n31_), .b(x00), .c(x12), .O(new_n56_));
  nand2  g27(.a(x10), .b(x00), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(z01), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n56_), .O(z09));
  nand3  g30(.a(new_n54_), .b(new_n48_), .c(x09), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x00), .c(new_n32_), .O(z10));
  nand4  g32(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand3  g33(.a(new_n32_), .b(new_n30_), .c(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n54_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n51_), .O(z11));
  nand2  g37(.a(new_n54_), .b(new_n39_), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x00), .c(new_n32_), .O(z12));
endmodule
