...
module FAU ( 
  ...
  nand4  g30(.a(new_n48_), .b(new_n57_), .c(x09), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(new_n31_), .O(z10));
  nand4  g32(.a(new_n48_), .b(new_n47_), .c(new_n57_), .d(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x12), .c(new_n31_), .O(z11));
  nand2  g34(.a(new_n55_), .b(new_n37_), .O(new_n64_));
