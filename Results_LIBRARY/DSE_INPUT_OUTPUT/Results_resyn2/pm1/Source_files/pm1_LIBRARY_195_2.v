...
module FAU ( 
  ...
  and2   g08(.a(x15), .b(x12), .O(new_n38_));
  nand3  g09(.a(new_n38_), .b(new_n37_), .c(new_n36_), .O(z02));
  nand2  g10(.a(new_n37_), .b(new_n35_), .O(new_n40_));
  ...
  aoi21  g16(.a(z07), .b(x12), .c(x13), .O(z05));
  ...
  oai21  g29(.a(z07), .b(new_n32_), .c(x11), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n47_), .c(new_n55_), .d(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  nand4  g32(.a(new_n48_), .b(new_n37_), .c(new_n55_), .d(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x15), .c(new_n32_), .O(z10));
  nand4  g34(.a(new_n48_), .b(new_n38_), .c(x09), .d(x01), .O(new_n64_));
  nand2  g35(.a(new_n32_), .b(new_n30_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n64_), .c(new_n56_), .O(z11));
  inv1   g37(.a(x09), .O(new_n67_));
  nand4  g38(.a(x11), .b(new_n55_), .c(new_n67_), .d(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x15), .c(new_n32_), .O(z12));
endmodule
