...
module FAU ( 
  ...
  nor2   g02(.a(x12), .b(x09), .O(new_n32_));
  ...
  oai21  g18(.a(new_n47_), .b(new_n31_), .c(x01), .O(new_n48_));
  aoi21  g19(.a(new_n48_), .b(x12), .c(new_n46_), .O(z06));
  aoi21  g20(.a(new_n42_), .b(x09), .c(x15), .O(z07));
  nand2  g21(.a(new_n47_), .b(x12), .O(new_n51_));
  ...
  aoi21  g29(.a(new_n34_), .b(new_n57_), .c(new_n58_), .O(z09));
  nand4  g30(.a(new_n47_), .b(x11), .c(new_n53_), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(new_n46_), .O(z10));
  ...
  nor3   g35(.a(new_n58_), .b(new_n34_), .c(x09), .O(z12));
endmodule
