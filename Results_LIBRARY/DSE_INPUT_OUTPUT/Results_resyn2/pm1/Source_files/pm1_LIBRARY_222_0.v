...
module FAU ( 
  ...
  aoi22  g12(.a(new_n41_), .b(new_n39_), .c(z05), .d(new_n32_), .O(z02));
  nand2  g13(.a(new_n41_), .b(new_n38_), .O(z03));
  nand2  g14(.a(z05), .b(new_n32_), .O(new_n44_));
  ...
  nand3  g27(.a(new_n56_), .b(new_n53_), .c(new_n44_), .O(z08));
  ...
  oai21  g39(.a(new_n68_), .b(new_n66_), .c(new_n44_), .O(z12));
endmodule
