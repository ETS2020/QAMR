...
module FAU ( 
  ...
  aoi21  g15(.a(x12), .b(new_n42_), .c(x13), .O(z05));
  nand2  g16(.a(x09), .b(x01), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(x11), .c(x00), .O(new_n47_));
  ...
  nor2   g25(.a(new_n49_), .b(new_n39_), .O(new_n55_));
  oai21  g26(.a(new_n55_), .b(new_n54_), .c(x00), .O(new_n56_));
  nand2  g27(.a(new_n32_), .b(new_n42_), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n56_), .O(z08));
  aoi21  g29(.a(new_n31_), .b(x00), .c(x12), .O(new_n59_));
  oai21  g30(.a(new_n53_), .b(new_n42_), .c(z01), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n59_), .O(z09));
  nor2   g32(.a(new_n31_), .b(x10), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n49_), .c(x09), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x00), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand3  g36(.a(new_n32_), .b(new_n30_), .c(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n62_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n43_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand2  g41(.a(new_n62_), .b(new_n70_), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x00), .c(new_n32_), .O(z12));
endmodule
