...
module FAU ( 
  ...
  aoi22  g22(.a(new_n51_), .b(z01), .c(new_n49_), .d(new_n47_), .O(z06));
  ...
  nand3  g31(.a(new_n32_), .b(new_n30_), .c(x03), .O(new_n61_));
  ...
  nand4  g36(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n33_), .c(new_n55_), .O(z11));
  nand3  g38(.a(x12), .b(x11), .c(new_n63_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n60_), .c(new_n47_), .O(z12));
endmodule
