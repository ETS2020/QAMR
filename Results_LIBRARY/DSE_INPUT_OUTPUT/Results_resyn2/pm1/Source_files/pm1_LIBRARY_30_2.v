...
module FAU ( 
  ...
  nand2  g10(.a(new_n35_), .b(x09), .O(new_n40_));
  ...
  aoi21  g15(.a(new_n32_), .b(x11), .c(x13), .O(z05));
  ...
  inv1   g25(.a(z01), .O(new_n55_));
  inv1   g26(.a(x10), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n43_), .c(new_n55_), .O(z09));
  nand3  g29(.a(new_n53_), .b(new_n46_), .c(new_n38_), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z10));
  nand4  g31(.a(new_n53_), .b(new_n46_), .c(new_n38_), .d(x01), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z11));
  inv1   g33(.a(x09), .O(new_n63_));
  nand3  g34(.a(new_n56_), .b(new_n63_), .c(x00), .O(new_n64_));
