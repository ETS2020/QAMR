...
module FAU ( 
  ...
  nor2   g21(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  oai21  g22(.a(new_n51_), .b(new_n49_), .c(x11), .O(new_n52_));
  nand2  g23(.a(new_n31_), .b(new_n30_), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n52_), .O(z08));
  nand2  g25(.a(x12), .b(x11), .O(new_n55_));
  aoi21  g26(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(z09));
  inv1   g27(.a(new_n44_), .O(new_n57_));
  nand3  g28(.a(x11), .b(new_n48_), .c(x00), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n50_), .c(new_n57_), .O(z10));
  nand2  g30(.a(new_n55_), .b(new_n53_), .O(new_n60_));
  nand4  g31(.a(new_n44_), .b(x11), .c(x09), .d(x01), .O(new_n61_));
  nand3  g32(.a(new_n32_), .b(new_n48_), .c(x00), .O(new_n62_));
  aoi22  g33(.a(new_n62_), .b(x11), .c(new_n61_), .d(new_n60_), .O(z11));
  nor3   g34(.a(new_n55_), .b(new_n49_), .c(x09), .O(z12));
endmodule
