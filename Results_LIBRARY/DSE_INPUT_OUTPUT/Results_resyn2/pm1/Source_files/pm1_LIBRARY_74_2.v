...
module FAU ( 
  ...
  aoi21  g20(.a(new_n46_), .b(new_n44_), .c(new_n49_), .O(z06));
  ...
  nand4  g29(.a(new_n45_), .b(new_n54_), .c(x09), .d(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g31(.a(new_n48_), .b(new_n45_), .c(new_n54_), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n33_), .O(z11));
  nand3  g33(.a(new_n54_), .b(new_n37_), .c(x00), .O(new_n63_));
