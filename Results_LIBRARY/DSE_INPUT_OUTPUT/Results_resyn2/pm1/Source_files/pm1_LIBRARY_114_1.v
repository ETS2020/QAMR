...
module FAU ( 
  ...
  nor2   g15(.a(new_n34_), .b(x15), .O(z07));
  ...
  nor2   g22(.a(new_n49_), .b(new_n34_), .O(new_n52_));
  nor2   g23(.a(new_n52_), .b(new_n51_), .O(z09));
  nand3  g24(.a(new_n49_), .b(new_n42_), .c(x09), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(x11), .c(new_n32_), .O(z10));
  nand4  g26(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n56_));
  aoi21  g27(.a(new_n51_), .b(new_n30_), .c(new_n34_), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n56_), .c(new_n52_), .O(z11));
  inv1   g29(.a(x09), .O(new_n59_));
  nand2  g30(.a(new_n49_), .b(new_n59_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x11), .c(new_n32_), .O(z12));
endmodule
