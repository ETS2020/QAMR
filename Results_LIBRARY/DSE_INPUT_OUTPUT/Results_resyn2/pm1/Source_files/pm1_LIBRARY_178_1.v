...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n38_, new_n39_,
    ...
    new_n51_, new_n54_, new_n55_, new_n57_, new_n60_;
  inv1   g00(.a(x11), .O(new_n30_));
  inv1   g01(.a(x12), .O(new_n31_));
  nor2   g02(.a(new_n31_), .b(x10), .O(z12));
  ...
  nand4  g10(.a(new_n39_), .b(new_n36_), .c(x11), .d(x09), .O(z02));
  ...
  nand2  g29(.a(new_n33_), .b(new_n35_), .O(new_n60_));
  nor2   g30(.a(new_n60_), .b(new_n54_), .O(z11));
  zero   g31(.O(z10));
endmodule
