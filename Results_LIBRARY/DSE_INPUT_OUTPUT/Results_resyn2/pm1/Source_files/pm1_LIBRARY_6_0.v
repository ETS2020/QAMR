...
module FAU ( 
  ...
  nor2   g06(.a(x15), .b(x12), .O(new_n36_));
  inv1   g07(.a(x09), .O(new_n37_));
  nand4  g08(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n38_));
  nor3   g09(.a(new_n38_), .b(new_n34_), .c(new_n37_), .O(new_n39_));
  ...
  inv1   g14(.a(new_n36_), .O(new_n44_));
  ...
  nand3  g29(.a(new_n58_), .b(new_n55_), .c(new_n44_), .O(z08));
  nand2  g30(.a(new_n56_), .b(x00), .O(new_n60_));
  nand3  g31(.a(x15), .b(new_n30_), .c(new_n47_), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n34_), .c(new_n60_), .O(z09));
  nand2  g33(.a(new_n54_), .b(new_n48_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n57_), .c(new_n44_), .O(z10));
  ...
  nor3   g41(.a(new_n60_), .b(new_n34_), .c(x09), .O(z12));
endmodule
