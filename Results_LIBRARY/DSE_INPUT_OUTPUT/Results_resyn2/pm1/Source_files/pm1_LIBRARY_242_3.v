...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n37_, new_n38_, new_n39_,
    new_n41_, new_n42_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
  ...
  nor2   g33(.a(new_n62_), .b(new_n35_), .O(z09));
  nand4  g34(.a(new_n60_), .b(new_n49_), .c(x11), .d(x09), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(z04), .c(new_n32_), .O(z10));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  nand4  g37(.a(new_n56_), .b(new_n49_), .c(x09), .d(x01), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n66_), .c(new_n54_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand3  g40(.a(new_n60_), .b(x11), .c(new_n69_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(z04), .c(new_n32_), .O(z12));
endmodule
