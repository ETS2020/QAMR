...
module FAU ( 
  ...
  nand3  g10(.a(new_n34_), .b(x12), .c(x09), .O(new_n40_));
  nand2  g11(.a(new_n36_), .b(x11), .O(new_n41_));
  or2    g12(.a(new_n41_), .b(new_n40_), .O(z03));
  nand2  g13(.a(x14), .b(new_n32_), .O(z04));
  aoi21  g14(.a(x14), .b(x12), .c(x13), .O(z05));
  nand3  g15(.a(x04), .b(x03), .c(x02), .O(new_n45_));
  inv1   g16(.a(new_n45_), .O(new_n46_));
  nand2  g17(.a(x14), .b(x12), .O(new_n47_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n40_), .c(new_n53_), .O(z08));
  ...
  nand3  g29(.a(new_n58_), .b(new_n57_), .c(new_n55_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n47_), .O(z09));
  nand4  g31(.a(new_n57_), .b(new_n45_), .c(x11), .d(x09), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n34_), .c(new_n32_), .O(z10));
  nand4  g33(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  nor2   g34(.a(x12), .b(x01), .O(new_n64_));
  aoi21  g35(.a(x14), .b(x12), .c(new_n64_), .O(new_n65_));
  aoi22  g36(.a(new_n65_), .b(new_n63_), .c(new_n52_), .d(new_n47_), .O(z11));
  inv1   g37(.a(x09), .O(new_n67_));
  nand3  g38(.a(new_n57_), .b(x11), .c(new_n67_), .O(new_n68_));
