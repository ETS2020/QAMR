...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    new_n40_, new_n41_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
  ...
  oai21  g11(.a(new_n37_), .b(new_n40_), .c(new_n30_), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x12), .O(z03));
  nor2   g13(.a(new_n32_), .b(x14), .O(z04));
  nor2   g14(.a(new_n32_), .b(x13), .O(z05));
  nand2  g15(.a(x09), .b(x01), .O(new_n45_));
  oai21  g16(.a(new_n45_), .b(x11), .c(new_n30_), .O(new_n46_));
  ...
  nand2  g21(.a(z02), .b(x15), .O(z07));
  aoi21  g22(.a(new_n49_), .b(x09), .c(x08), .O(new_n52_));
  inv1   g23(.a(x10), .O(new_n53_));
  nand3  g24(.a(x11), .b(new_n53_), .c(x00), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(new_n55_));
  oai21  g26(.a(new_n52_), .b(new_n31_), .c(new_n55_), .O(z08));
  nand2  g27(.a(new_n53_), .b(x00), .O(new_n57_));
  nand3  g28(.a(x12), .b(x11), .c(new_n30_), .O(new_n58_));
  nand2  g29(.a(new_n31_), .b(new_n37_), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(z09));
  nand2  g31(.a(new_n48_), .b(x12), .O(new_n61_));
  nand3  g32(.a(x11), .b(x09), .c(new_n30_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n61_), .c(new_n57_), .O(z10));
  nand4  g34(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n34_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n55_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(z02), .O(z11));
  nor3   g38(.a(new_n58_), .b(new_n57_), .c(x09), .O(z12));
endmodule
