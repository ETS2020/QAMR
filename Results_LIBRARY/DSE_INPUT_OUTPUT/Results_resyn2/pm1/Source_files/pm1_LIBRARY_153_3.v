...
module FAU ( 
  ...
  inv1   g15(.a(x11), .O(new_n47_));
  nand4  g16(.a(z01), .b(new_n47_), .c(new_n45_), .d(x00), .O(new_n48_));
  nand2  g17(.a(new_n48_), .b(new_n31_), .O(z09));
  inv1   g18(.a(x01), .O(new_n51_));
  nand3  g19(.a(new_n45_), .b(new_n51_), .c(x00), .O(new_n52_));
  aoi21  g20(.a(new_n52_), .b(z01), .c(new_n47_), .O(z11));
  one    g21(.O(z02));
  one    g22(.O(z03));
  zero   g23(.O(z10));
endmodule
