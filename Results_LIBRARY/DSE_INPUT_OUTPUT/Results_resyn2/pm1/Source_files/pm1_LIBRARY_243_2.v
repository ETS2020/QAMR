...
module FAU ( 
  ...
  nor2   g22(.a(new_n51_), .b(new_n49_), .O(z06));
  ...
  nand3  g30(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(new_n60_));
  nand2  g31(.a(new_n56_), .b(x00), .O(new_n61_));
  aoi21  g32(.a(new_n42_), .b(new_n60_), .c(new_n61_), .O(z09));
  ...
  oai21  g41(.a(new_n70_), .b(new_n61_), .c(new_n45_), .O(z12));
endmodule
