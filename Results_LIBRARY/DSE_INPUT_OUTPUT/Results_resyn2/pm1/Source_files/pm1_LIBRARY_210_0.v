...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n35_, new_n40_, new_n41_, new_n42_,
  ...
  oai21  g19(.a(new_n48_), .b(new_n41_), .c(new_n47_), .O(z08));
  nand4  g20(.a(x12), .b(x11), .c(new_n45_), .d(x00), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(z00), .O(z09));
  nand2  g22(.a(new_n41_), .b(x12), .O(new_n52_));
  nand4  g23(.a(x11), .b(new_n45_), .c(x09), .d(x00), .O(new_n53_));
  oai21  g24(.a(new_n53_), .b(new_n52_), .c(z00), .O(z10));
  inv1   g25(.a(x01), .O(new_n55_));
  aoi21  g26(.a(new_n41_), .b(x12), .c(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n40_), .b(x12), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(x11), .c(new_n45_), .d(x00), .O(new_n58_));
