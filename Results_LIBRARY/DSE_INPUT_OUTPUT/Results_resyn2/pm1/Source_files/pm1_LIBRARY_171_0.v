...
module FAU ( 
  ...
  nor2   g03(.a(x10), .b(x02), .O(new_n33_));
  ...
  aoi21  g11(.a(new_n40_), .b(new_n38_), .c(new_n33_), .O(z02));
  nand3  g12(.a(new_n40_), .b(new_n37_), .c(new_n34_), .O(z03));
  nand2  g13(.a(new_n34_), .b(x14), .O(z04));
  nor2   g14(.a(new_n33_), .b(x13), .O(z05));
  nand2  g15(.a(x04), .b(x03), .O(new_n45_));
  ...
  nor2   g21(.a(new_n33_), .b(x15), .O(z07));
  inv1   g22(.a(x10), .O(new_n52_));
  nand4  g23(.a(x11), .b(new_n52_), .c(x02), .d(x00), .O(new_n53_));
  inv1   g24(.a(new_n53_), .O(new_n54_));
  nand3  g25(.a(new_n46_), .b(x12), .c(x09), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n54_), .O(z08));
  nand2  g27(.a(new_n32_), .b(new_n31_), .O(new_n57_));
  nand2  g28(.a(x12), .b(x11), .O(new_n58_));
  nand3  g29(.a(new_n52_), .b(x02), .c(x00), .O(new_n59_));
  aoi21  g30(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z09));
  inv1   g31(.a(x09), .O(new_n61_));
  nand2  g32(.a(new_n45_), .b(x12), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n53_), .c(new_n61_), .O(z10));
  nand2  g34(.a(new_n62_), .b(x01), .O(new_n64_));
  ...
  aoi21  g39(.a(new_n68_), .b(x02), .c(x10), .O(z11));
  nor3   g40(.a(new_n59_), .b(new_n58_), .c(x09), .O(z12));
endmodule
