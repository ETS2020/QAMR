...
module FAU ( 
  ...
  nand4  g09(.a(new_n38_), .b(new_n37_), .c(new_n34_), .d(x12), .O(z02));
  nand2  g10(.a(new_n38_), .b(new_n36_), .O(new_n40_));
  nand2  g11(.a(new_n40_), .b(new_n34_), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x12), .O(z03));
  nand2  g13(.a(x15), .b(x12), .O(new_n43_));
  ...
  nand2  g21(.a(x15), .b(new_n32_), .O(z07));
  ...
  aoi21  g29(.a(new_n34_), .b(x12), .c(new_n31_), .O(new_n59_));
  nand2  g30(.a(x12), .b(new_n31_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n55_), .c(x00), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n59_), .O(z09));
  nand4  g33(.a(new_n46_), .b(new_n38_), .c(new_n55_), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n34_), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n48_), .b(new_n46_), .c(new_n34_), .d(x12), .O(new_n65_));
  ...
  aoi21  g40(.a(new_n69_), .b(new_n34_), .c(new_n32_), .O(z12));
endmodule
