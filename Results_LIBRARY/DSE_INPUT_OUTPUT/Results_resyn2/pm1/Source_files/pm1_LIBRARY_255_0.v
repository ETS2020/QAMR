...
module FAU ( 
  ...
  nand4  g07(.a(x12), .b(x11), .c(x06), .d(x05), .O(new_n37_));
  nor2   g08(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nor2   g09(.a(new_n38_), .b(new_n34_), .O(z02));
  ...
  oai21  g28(.a(new_n54_), .b(new_n34_), .c(new_n57_), .O(z08));
  nand2  g29(.a(new_n30_), .b(x11), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n46_), .c(new_n52_), .d(x00), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n43_), .O(z09));
  nand2  g32(.a(new_n56_), .b(new_n47_), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n53_), .c(new_n43_), .O(z10));
  ...
  nand4  g38(.a(new_n56_), .b(new_n54_), .c(new_n47_), .d(x01), .O(new_n68_));
