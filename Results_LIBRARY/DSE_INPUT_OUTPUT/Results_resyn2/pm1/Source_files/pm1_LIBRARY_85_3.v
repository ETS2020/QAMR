...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n33_, new_n35_, new_n39_, new_n40_, new_n41_,
    new_n42_, new_n45_, new_n46_, new_n48_, new_n49_, new_n52_, new_n54_;
  ...
  nor2   g13(.a(new_n42_), .b(new_n40_), .O(z06));
  nor2   g14(.a(new_n32_), .b(x15), .O(z07));
  inv1   g15(.a(x10), .O(new_n45_));
  nand3  g16(.a(x11), .b(new_n45_), .c(x00), .O(new_n46_));
  and2   g17(.a(new_n46_), .b(z02), .O(z08));
  nand3  g18(.a(new_n30_), .b(new_n45_), .c(x00), .O(new_n48_));
  nor2   g19(.a(new_n41_), .b(x09), .O(new_n49_));
  aoi22  g20(.a(new_n49_), .b(new_n46_), .c(new_n48_), .d(new_n41_), .O(z09));
  inv1   g21(.a(new_n33_), .O(new_n52_));
  oai21  g22(.a(new_n46_), .b(new_n52_), .c(z02), .O(z11));
  nand2  g23(.a(x12), .b(new_n35_), .O(new_n54_));
  nor2   g24(.a(new_n54_), .b(new_n46_), .O(z12));
  zero   g25(.O(z10));
  nand2  g26(.a(x12), .b(x09), .O(z03));
endmodule
