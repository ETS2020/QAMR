...
module FAU ( 
  ...
  nor2   g09(.a(new_n37_), .b(x13), .O(z05));
  ...
  or2    g18(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  ...
  nand2  g23(.a(new_n47_), .b(x12), .O(new_n54_));
  nand3  g24(.a(new_n46_), .b(x11), .c(x09), .O(new_n55_));
  nor2   g25(.a(new_n55_), .b(new_n54_), .O(z10));
  inv1   g26(.a(x01), .O(new_n57_));
  aoi21  g27(.a(new_n47_), .b(x12), .c(new_n57_), .O(new_n58_));
  nand2  g28(.a(x09), .b(x01), .O(new_n59_));
  nand2  g29(.a(new_n59_), .b(x12), .O(new_n60_));
  nand3  g30(.a(new_n60_), .b(new_n46_), .c(x11), .O(new_n61_));
  nor2   g31(.a(new_n61_), .b(new_n58_), .O(z11));
  oai21  g32(.a(new_n52_), .b(x09), .c(new_n38_), .O(z12));
  one    g33(.O(z00));
endmodule
