...
module FAU ( 
  ...
  aoi21  g27(.a(new_n52_), .b(new_n43_), .c(new_n35_), .O(z09));
  ...
  nand4  g31(.a(new_n60_), .b(new_n46_), .c(new_n51_), .d(x09), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n33_), .O(z11));
  nand3  g33(.a(new_n51_), .b(new_n40_), .c(x00), .O(new_n63_));
