...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
  ...
  aoi21  g15(.a(z04), .b(new_n44_), .c(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  inv1   g17(.a(new_n46_), .O(new_n47_));
  nand2  g18(.a(z04), .b(new_n44_), .O(new_n48_));
  ...
  nor2   g26(.a(new_n38_), .b(new_n31_), .O(new_n56_));
  ...
  nor3   g39(.a(new_n58_), .b(new_n37_), .c(x09), .O(z12));
endmodule
