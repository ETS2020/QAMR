...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n35_, new_n38_, new_n39_, new_n41_,
  ...
  oai21  g14(.a(new_n43_), .b(new_n30_), .c(x09), .O(new_n44_));
  aoi21  g15(.a(new_n44_), .b(x12), .c(new_n38_), .O(z06));
  ...
  nand3  g22(.a(new_n51_), .b(new_n48_), .c(new_n41_), .O(z08));
  aoi21  g23(.a(new_n30_), .b(new_n38_), .c(x12), .O(new_n53_));
  ...
  nand2  g28(.a(x12), .b(new_n38_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x11), .c(new_n49_), .d(x00), .O(new_n59_));
  aoi21  g30(.a(new_n56_), .b(x01), .c(new_n59_), .O(z11));
  nand2  g31(.a(new_n49_), .b(x00), .O(new_n61_));
  inv1   g32(.a(x09), .O(new_n62_));
  nand3  g33(.a(x12), .b(x11), .c(new_n62_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n61_), .c(new_n41_), .O(z12));
endmodule
