...
module FAU ( 
  ...
  nor2   g08(.a(x13), .b(new_n32_), .O(new_n38_));
  and2   g09(.a(x11), .b(x09), .O(new_n39_));
  nand3  g10(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(z02));
  nand3  g11(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(z03));
  aoi21  g12(.a(x13), .b(x12), .c(x14), .O(z04));
  nand2  g13(.a(x13), .b(new_n32_), .O(z05));
  ...
  oai21  g21(.a(new_n34_), .b(new_n32_), .c(x15), .O(z07));
  ...
  inv1   g29(.a(new_n38_), .O(new_n59_));
  nand2  g30(.a(x12), .b(new_n31_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n55_), .c(x00), .O(new_n61_));
  aoi21  g32(.a(new_n59_), .b(x11), .c(new_n61_), .O(z09));
  nand4  g33(.a(new_n48_), .b(new_n39_), .c(new_n55_), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n34_), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n48_), .b(new_n47_), .c(new_n34_), .d(x12), .O(new_n65_));
