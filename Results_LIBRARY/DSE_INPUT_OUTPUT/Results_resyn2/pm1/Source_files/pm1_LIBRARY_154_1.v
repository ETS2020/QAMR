...
module FAU ( 
  ...
  nand3  g20(.a(new_n49_), .b(new_n47_), .c(x11), .O(z08));
  nand2  g21(.a(x12), .b(x11), .O(new_n51_));
  inv1   g22(.a(x12), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(new_n31_), .O(new_n53_));
  aoi21  g24(.a(new_n53_), .b(new_n51_), .c(new_n46_), .O(z09));
  nand2  g25(.a(new_n41_), .b(x12), .O(new_n55_));
  nand3  g26(.a(new_n47_), .b(x11), .c(x09), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n55_), .O(z10));
  nand4  g28(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  nand3  g29(.a(new_n52_), .b(x11), .c(new_n30_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n47_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(z01), .O(z11));
  nor3   g33(.a(new_n46_), .b(new_n51_), .c(x09), .O(z12));
endmodule
