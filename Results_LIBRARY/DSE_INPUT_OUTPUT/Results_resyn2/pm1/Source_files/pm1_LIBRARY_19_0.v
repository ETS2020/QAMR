...
module FAU ( 
  ...
  oai21  g09(.a(x12), .b(new_n35_), .c(new_n38_), .O(z02));
  nand4  g10(.a(new_n36_), .b(x12), .c(x11), .d(x09), .O(z03));
  nor2   g11(.a(x12), .b(x06), .O(new_n41_));
  ...
  oai21  g25(.a(new_n52_), .b(new_n41_), .c(new_n54_), .O(z08));
  nand2  g26(.a(x12), .b(x11), .O(new_n56_));
  nand2  g27(.a(new_n50_), .b(x00), .O(new_n57_));
  nand3  g28(.a(new_n30_), .b(new_n33_), .c(x06), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n56_), .c(new_n57_), .O(z09));
  nand2  g30(.a(new_n53_), .b(new_n45_), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n51_), .c(new_n42_), .O(z10));
  ...
  nand4  g36(.a(new_n53_), .b(new_n52_), .c(new_n45_), .d(x01), .O(new_n66_));
