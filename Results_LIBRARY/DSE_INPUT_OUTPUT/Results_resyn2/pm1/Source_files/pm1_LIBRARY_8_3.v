...
module FAU ( 
  ...
  nand3  g12(.a(new_n32_), .b(x09), .c(x01), .O(new_n43_));
  nor2   g13(.a(new_n43_), .b(new_n42_), .O(z06));
  nand2  g14(.a(z02), .b(x15), .O(z07));
  inv1   g15(.a(x10), .O(new_n46_));
  nand3  g16(.a(x11), .b(new_n46_), .c(x00), .O(new_n47_));
  and2   g17(.a(new_n47_), .b(z02), .O(z08));
  aoi21  g18(.a(x11), .b(new_n34_), .c(new_n32_), .O(new_n49_));
  nand2  g19(.a(new_n32_), .b(x11), .O(new_n50_));
  nand3  g20(.a(new_n50_), .b(new_n46_), .c(x00), .O(new_n51_));
  nor2   g21(.a(new_n51_), .b(new_n49_), .O(z09));
  nand3  g22(.a(new_n46_), .b(new_n30_), .c(x00), .O(new_n53_));
  nor2   g23(.a(new_n53_), .b(new_n50_), .O(z11));
  aoi21  g24(.a(new_n47_), .b(new_n34_), .c(new_n32_), .O(z12));
  one    g25(.O(z03));
endmodule
