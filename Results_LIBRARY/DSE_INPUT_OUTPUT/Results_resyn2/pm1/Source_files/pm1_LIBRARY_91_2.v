...
module FAU ( 
  ...
  oai21  g11(.a(new_n40_), .b(new_n36_), .c(x15), .O(new_n41_));
  ...
  oai21  g17(.a(new_n46_), .b(x11), .c(x15), .O(new_n47_));
  ...
  oai21  g24(.a(new_n49_), .b(new_n53_), .c(x15), .O(new_n54_));
  ...
  oai21  g30(.a(z07), .b(new_n31_), .c(x11), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n57_), .c(new_n59_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z09));
  nand2  g33(.a(new_n57_), .b(x11), .O(new_n63_));
  nand4  g34(.a(new_n49_), .b(x15), .c(x12), .d(x09), .O(new_n64_));
  ...
  oai21  g39(.a(new_n68_), .b(new_n63_), .c(new_n43_), .O(z11));
  nand3  g40(.a(new_n57_), .b(x11), .c(new_n53_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(x15), .c(new_n31_), .O(z12));
endmodule
