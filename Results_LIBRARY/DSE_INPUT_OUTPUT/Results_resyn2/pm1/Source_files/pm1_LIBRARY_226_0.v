...
module FAU ( 
  ...
  nand4  g30(.a(new_n59_), .b(x11), .c(new_n45_), .d(x00), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n58_), .O(z11));
  nor3   g32(.a(new_n46_), .b(new_n52_), .c(x09), .O(z12));
  buf    g33(.a(x11), .O(z01));
endmodule
