...
module FAU ( 
  ...
  oai21  g19(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z06));
  ...
  nand4  g28(.a(new_n46_), .b(new_n51_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n34_), .O(z10));
  inv1   g30(.a(new_n46_), .O(new_n60_));
  nand4  g31(.a(x12), .b(x11), .c(x09), .d(x01), .O(new_n61_));
  nor3   g32(.a(new_n61_), .b(new_n56_), .c(new_n60_), .O(z11));
  nand3  g33(.a(new_n51_), .b(new_n38_), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n34_), .O(z12));
endmodule
