...
module FAU ( 
  ...
  nand4  g08(.a(z05), .b(x12), .c(x11), .d(x09), .O(new_n38_));
  ...
  oai21  g23(.a(new_n47_), .b(new_n52_), .c(z05), .O(new_n53_));
  ...
  nand3  g30(.a(new_n59_), .b(new_n56_), .c(new_n58_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n44_), .O(z09));
  nand3  g32(.a(new_n56_), .b(new_n47_), .c(new_n39_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  nand2  g34(.a(new_n56_), .b(x11), .O(new_n64_));
  nand3  g35(.a(x12), .b(x09), .c(x01), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nor2   g37(.a(x12), .b(x01), .O(new_n67_));
  aoi21  g38(.a(new_n66_), .b(new_n47_), .c(new_n67_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n64_), .c(new_n44_), .O(z11));
  nand3  g40(.a(z05), .b(x12), .c(new_n52_), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n64_), .O(z12));
endmodule
