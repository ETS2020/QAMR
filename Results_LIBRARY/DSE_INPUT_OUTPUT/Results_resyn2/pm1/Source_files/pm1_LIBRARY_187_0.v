...
module FAU ( 
  ...
  nor2   g05(.a(x13), .b(x12), .O(new_n35_));
  ...
  nor2   g13(.a(x13), .b(new_n30_), .O(z05));
  ...
  nand3  g25(.a(new_n54_), .b(new_n51_), .c(new_n44_), .O(z08));
  nand2  g26(.a(x12), .b(x11), .O(new_n56_));
  nand2  g27(.a(new_n52_), .b(x00), .O(new_n57_));
  nand3  g28(.a(x13), .b(new_n30_), .c(new_n33_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n56_), .c(new_n57_), .O(z09));
  nand2  g30(.a(new_n46_), .b(x12), .O(new_n60_));
  nand4  g31(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n60_), .O(z10));
  nand4  g33(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  inv1   g34(.a(x01), .O(new_n64_));
  nand3  g35(.a(x13), .b(new_n30_), .c(new_n64_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n63_), .c(new_n53_), .O(z11));
  nor3   g37(.a(new_n57_), .b(new_n56_), .c(x09), .O(z12));
endmodule
