...
module FAU ( 
  ...
  nand4  g09(.a(new_n38_), .b(new_n36_), .c(x12), .d(x08), .O(z02));
  ...
  aoi21  g24(.a(new_n50_), .b(x09), .c(new_n53_), .O(new_n54_));
  inv1   g25(.a(x10), .O(new_n55_));
  nand3  g26(.a(x11), .b(new_n55_), .c(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(new_n57_));
  oai21  g28(.a(new_n54_), .b(new_n32_), .c(new_n57_), .O(z08));
  nand2  g29(.a(new_n56_), .b(x08), .O(new_n59_));
  ...
  nand4  g35(.a(new_n62_), .b(new_n49_), .c(x11), .d(x09), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x08), .c(new_n32_), .O(z10));
  ...
  aoi21  g41(.a(new_n69_), .b(new_n49_), .c(new_n70_), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n56_), .c(new_n67_), .O(z11));
  nand3  g43(.a(new_n62_), .b(x11), .c(new_n37_), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x08), .c(new_n32_), .O(z12));
endmodule
