...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n40_, new_n43_, new_n45_, new_n46_, new_n49_, new_n50_, new_n51_,
  ...
  nor2   g13(.a(new_n32_), .b(x11), .O(new_n43_));
  ...
  aoi21  g25(.a(new_n49_), .b(x00), .c(new_n43_), .O(new_n55_));
  nor2   g26(.a(new_n55_), .b(new_n54_), .O(z09));
  nand2  g27(.a(new_n45_), .b(x12), .O(new_n57_));
  nor3   g28(.a(new_n57_), .b(new_n50_), .c(new_n35_), .O(z10));
  nand4  g29(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  aoi21  g30(.a(new_n54_), .b(new_n30_), .c(new_n43_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n59_), .c(new_n55_), .O(z11));
