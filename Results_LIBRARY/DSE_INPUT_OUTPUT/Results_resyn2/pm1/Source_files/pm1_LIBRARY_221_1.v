...
module FAU ( 
  ...
  nor2   g13(.a(new_n32_), .b(x07), .O(new_n43_));
  ...
  oai21  g18(.a(new_n47_), .b(x11), .c(x07), .O(new_n48_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n54_), .c(x07), .O(new_n55_));
  ...
  aoi21  g33(.a(new_n62_), .b(new_n37_), .c(new_n61_), .O(z09));
  nand4  g34(.a(new_n58_), .b(new_n50_), .c(x11), .d(x09), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x07), .c(new_n32_), .O(z10));
  nand2  g36(.a(new_n58_), .b(x11), .O(new_n66_));
  nand3  g37(.a(x12), .b(x09), .c(x01), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(new_n68_));
  nor2   g39(.a(x12), .b(x01), .O(new_n69_));
  aoi21  g40(.a(new_n68_), .b(new_n50_), .c(new_n69_), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n66_), .c(new_n45_), .O(z11));
  nor3   g42(.a(new_n61_), .b(new_n37_), .c(x09), .O(z12));
endmodule
