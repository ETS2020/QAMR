...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n36_, new_n37_, new_n38_,
    ...
    new_n61_, new_n63_, new_n64_, new_n66_, new_n67_, new_n68_;
  ...
  nand3  g26(.a(new_n55_), .b(new_n52_), .c(new_n42_), .O(z08));
