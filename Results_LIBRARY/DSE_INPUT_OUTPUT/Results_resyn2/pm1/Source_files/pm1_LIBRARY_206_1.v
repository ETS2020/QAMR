...
module FAU ( 
  ...
  oai21  g07(.a(x14), .b(x12), .c(new_n30_), .O(z01));
  ...
  nand2  g14(.a(x14), .b(x11), .O(z04));
  aoi21  g15(.a(x14), .b(new_n30_), .c(x13), .O(z05));
  oai21  g16(.a(new_n41_), .b(new_n33_), .c(new_n31_), .O(new_n46_));
  ...
  nand2  g21(.a(x14), .b(new_n30_), .O(new_n51_));
  ...
  oai21  g26(.a(new_n48_), .b(new_n41_), .c(new_n55_), .O(z08));
  nand2  g27(.a(new_n53_), .b(x00), .O(new_n57_));
  xor2a  g28(.a(x12), .b(x11), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(new_n51_), .O(z09));
  ...
  nand2  g36(.a(new_n65_), .b(new_n51_), .O(z11));
  nand3  g37(.a(x12), .b(x11), .c(new_n60_), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n57_), .O(z12));
endmodule
