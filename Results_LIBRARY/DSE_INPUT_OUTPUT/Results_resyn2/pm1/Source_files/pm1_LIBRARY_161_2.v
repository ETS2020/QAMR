...
module FAU ( 
  ...
  oai21  g18(.a(new_n47_), .b(new_n35_), .c(x01), .O(new_n48_));
  aoi21  g19(.a(new_n48_), .b(x12), .c(new_n31_), .O(z06));
  ...
  nand4  g27(.a(x12), .b(x11), .c(new_n53_), .d(x00), .O(new_n57_));
  nand4  g28(.a(new_n32_), .b(new_n35_), .c(new_n53_), .d(x00), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n57_), .c(new_n44_), .O(z09));
  ...
  aoi21  g33(.a(new_n62_), .b(new_n33_), .c(new_n54_), .O(z11));
  nor2   g34(.a(new_n57_), .b(x09), .O(z12));
endmodule
