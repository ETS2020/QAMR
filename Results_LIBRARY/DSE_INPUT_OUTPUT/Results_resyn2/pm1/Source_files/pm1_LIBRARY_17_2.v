...
module FAU ( 
  ...
  nand3  g05(.a(x12), .b(new_n34_), .c(new_n31_), .O(z01));
  ...
  nor2   g14(.a(x11), .b(new_n31_), .O(new_n44_));
  ...
  nor2   g28(.a(new_n39_), .b(new_n32_), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(new_n47_), .O(z09));
  inv1   g30(.a(x09), .O(new_n60_));
  nand2  g31(.a(new_n48_), .b(x12), .O(new_n61_));
  nor3   g32(.a(new_n61_), .b(new_n53_), .c(new_n60_), .O(z10));
  nand2  g33(.a(new_n38_), .b(new_n30_), .O(new_n63_));
  ...
  nand2  g37(.a(new_n66_), .b(new_n47_), .O(z11));
  nand2  g38(.a(new_n39_), .b(new_n60_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n57_), .c(new_n47_), .O(z12));
endmodule
