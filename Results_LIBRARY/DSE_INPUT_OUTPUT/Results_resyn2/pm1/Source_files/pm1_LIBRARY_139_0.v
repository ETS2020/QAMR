...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n40_, new_n41_,
  ...
  nand3  g06(.a(new_n35_), .b(new_n34_), .c(x09), .O(z02));
  nand3  g07(.a(new_n35_), .b(new_n33_), .c(x09), .O(z03));
  ...
  oai21  g20(.a(new_n46_), .b(new_n30_), .c(new_n49_), .O(z08));
  nand2  g21(.a(new_n46_), .b(new_n35_), .O(new_n51_));
  nand2  g22(.a(new_n51_), .b(z00), .O(z09));
  inv1   g23(.a(x09), .O(new_n53_));
  nor2   g24(.a(x10), .b(new_n53_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n41_), .c(new_n35_), .d(x00), .O(new_n55_));
  ...
  nor2   g32(.a(new_n57_), .b(new_n45_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n54_), .c(new_n41_), .d(new_n35_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n61_), .O(z11));
  nor2   g35(.a(new_n51_), .b(x09), .O(z12));
  buf    g36(.a(x11), .O(z01));
endmodule
