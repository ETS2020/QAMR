...
module FAU ( 
  ...
  oai21  g25(.a(new_n48_), .b(new_n54_), .c(x00), .O(new_n55_));
  ...
  oai21  g31(.a(new_n60_), .b(new_n31_), .c(new_n58_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n45_), .O(z09));
  nor2   g33(.a(x10), .b(new_n54_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n48_), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n59_), .O(z10));
  nand3  g36(.a(x11), .b(new_n58_), .c(new_n30_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(x00), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n35_), .O(new_n68_));
  nand4  g39(.a(new_n63_), .b(new_n60_), .c(new_n48_), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n68_), .O(z11));
  nand2  g41(.a(new_n58_), .b(new_n54_), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n59_), .c(new_n45_), .O(z12));
endmodule
