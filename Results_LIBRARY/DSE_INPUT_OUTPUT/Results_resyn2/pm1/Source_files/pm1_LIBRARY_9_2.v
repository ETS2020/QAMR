...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n40_,
    ...
    new_n52_, new_n53_, new_n55_, new_n57_, new_n59_;
  ...
  nand2  g10(.a(new_n32_), .b(x11), .O(new_n40_));
  ...
  aoi21  g26(.a(new_n55_), .b(new_n40_), .c(new_n34_), .O(z09));
  ...
  nor2   g31(.a(new_n50_), .b(x09), .O(z12));
endmodule
