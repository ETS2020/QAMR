...
module FAU ( 
  ...
  oai21  g09(.a(new_n38_), .b(new_n33_), .c(x11), .O(new_n39_));
  ...
  aoi21  g14(.a(new_n30_), .b(x09), .c(x13), .O(z05));
  nand3  g15(.a(x04), .b(x03), .c(x02), .O(new_n45_));
  inv1   g16(.a(new_n45_), .O(new_n46_));
  nand3  g17(.a(x11), .b(x09), .c(x01), .O(new_n47_));
  ...
  nand3  g25(.a(new_n33_), .b(new_n50_), .c(x00), .O(new_n55_));
  ...
  nand2  g31(.a(new_n60_), .b(new_n57_), .O(z09));
  nand3  g32(.a(new_n59_), .b(new_n45_), .c(x12), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x11), .c(new_n31_), .O(z10));
  nand4  g34(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(new_n34_), .c(new_n51_), .O(z11));
  oai21  g36(.a(new_n60_), .b(x09), .c(new_n42_), .O(z12));
endmodule
