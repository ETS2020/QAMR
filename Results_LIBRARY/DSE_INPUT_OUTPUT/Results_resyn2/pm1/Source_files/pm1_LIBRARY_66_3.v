...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n33_, new_n38_, new_n39_, new_n40_, new_n41_,
    new_n44_, new_n45_, new_n46_, new_n48_, new_n51_;
  ...
  nor2   g07(.a(new_n32_), .b(x13), .O(z05));
  ...
  nand4  g18(.a(z01), .b(new_n30_), .c(new_n44_), .d(x00), .O(new_n48_));
  inv1   g19(.a(new_n48_), .O(z09));
  nand2  g20(.a(new_n33_), .b(x11), .O(new_n51_));
  nor2   g21(.a(new_n51_), .b(new_n45_), .O(z11));
  zero   g22(.O(z10));
  zero   g23(.O(z12));
