...
module FAU ( 
  ...
  and2   g17(.a(x09), .b(x01), .O(new_n48_));
  nand3  g18(.a(new_n48_), .b(new_n47_), .c(new_n42_), .O(new_n49_));
  inv1   g19(.a(new_n49_), .O(z06));
  nor2   g20(.a(new_n41_), .b(x15), .O(z07));
  inv1   g21(.a(x10), .O(new_n52_));
  nand2  g22(.a(new_n46_), .b(new_n34_), .O(new_n53_));
  ...
  nand4  g27(.a(new_n57_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n58_));
  nand2  g28(.a(new_n58_), .b(new_n42_), .O(z10));
  inv1   g29(.a(x12), .O(new_n60_));
  inv1   g30(.a(x01), .O(new_n61_));
  nand3  g31(.a(new_n52_), .b(new_n61_), .c(x00), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(x11), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  and2   g34(.a(x01), .b(x00), .O(new_n65_));
  nand4  g35(.a(new_n65_), .b(new_n57_), .c(new_n45_), .d(new_n34_), .O(new_n66_));
  nand2  g36(.a(new_n66_), .b(new_n64_), .O(z11));
  nor2   g37(.a(new_n55_), .b(x09), .O(z12));
  one    g38(.O(z00));
endmodule
