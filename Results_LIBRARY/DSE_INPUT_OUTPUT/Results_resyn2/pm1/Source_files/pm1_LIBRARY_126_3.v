...
module FAU ( 
  ...
  nor2   g13(.a(new_n32_), .b(new_n34_), .O(z12));
  ...
  oai21  g18(.a(new_n47_), .b(x11), .c(new_n34_), .O(new_n48_));
  ...
  nand4  g25(.a(new_n32_), .b(x11), .c(new_n54_), .d(x00), .O(z08));
  nand4  g26(.a(new_n32_), .b(new_n31_), .c(new_n54_), .d(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(z09));
  nor2   g28(.a(z08), .b(x01), .O(z11));
  zero   g29(.O(z10));
endmodule
