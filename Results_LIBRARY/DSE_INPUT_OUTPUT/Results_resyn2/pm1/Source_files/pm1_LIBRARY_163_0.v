...
module FAU ( 
  ...
  nor2   g25(.a(x10), .b(new_n45_), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(x11), .c(x09), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n54_), .O(z10));
  inv1   g28(.a(x01), .O(new_n58_));
  aoi21  g29(.a(new_n41_), .b(x12), .c(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n40_), .b(x12), .O(new_n60_));
  nand3  g31(.a(new_n55_), .b(new_n60_), .c(x11), .O(new_n61_));
