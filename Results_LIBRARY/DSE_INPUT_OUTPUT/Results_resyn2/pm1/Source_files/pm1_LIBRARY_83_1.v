...
module FAU ( 
  ...
  nand4  g26(.a(new_n43_), .b(new_n47_), .c(x09), .d(x00), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(x11), .c(new_n32_), .O(z10));
  ...
  nand3  g32(.a(new_n47_), .b(new_n61_), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x11), .c(new_n32_), .O(z12));
endmodule
