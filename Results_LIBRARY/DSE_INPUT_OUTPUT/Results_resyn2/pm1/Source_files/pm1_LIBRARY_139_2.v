...
module FAU ( 
  ...
  aoi21  g27(.a(new_n54_), .b(new_n43_), .c(new_n35_), .O(z09));
  nand4  g28(.a(new_n46_), .b(new_n40_), .c(new_n53_), .d(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z10));
  nand4  g30(.a(new_n47_), .b(new_n46_), .c(new_n53_), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(new_n33_), .O(z11));
  nand2  g32(.a(x12), .b(x11), .O(new_n62_));
  nor3   g33(.a(new_n54_), .b(new_n62_), .c(x09), .O(z12));
endmodule
