...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n37_, new_n42_,
  ...
  nor2   g10(.a(new_n33_), .b(x13), .O(z05));
  inv1   g11(.a(new_n33_), .O(new_n42_));
  nand4  g12(.a(x11), .b(x04), .c(x03), .d(x02), .O(new_n43_));
  nand4  g13(.a(new_n43_), .b(new_n42_), .c(x09), .d(x01), .O(new_n44_));
  inv1   g14(.a(new_n44_), .O(z06));
  nand2  g15(.a(new_n42_), .b(x15), .O(z07));
  inv1   g16(.a(x00), .O(new_n47_));
  oai21  g17(.a(x10), .b(new_n47_), .c(x11), .O(new_n48_));
  inv1   g18(.a(x09), .O(new_n49_));
  nand3  g19(.a(x04), .b(x03), .c(x02), .O(new_n50_));
  oai21  g20(.a(new_n50_), .b(new_n49_), .c(x11), .O(new_n51_));
  nand2  g21(.a(new_n51_), .b(x12), .O(new_n52_));
  nand2  g22(.a(new_n52_), .b(new_n48_), .O(z08));
  nor2   g23(.a(x10), .b(new_n47_), .O(new_n54_));
  nand3  g24(.a(new_n54_), .b(x12), .c(x11), .O(new_n55_));
  inv1   g25(.a(new_n55_), .O(z09));
  nand2  g26(.a(new_n50_), .b(x12), .O(new_n57_));
  inv1   g27(.a(x10), .O(new_n58_));
  nand4  g28(.a(x11), .b(new_n58_), .c(x09), .d(x00), .O(new_n59_));
  oai21  g29(.a(new_n59_), .b(new_n57_), .c(new_n42_), .O(z10));
  inv1   g30(.a(x01), .O(new_n61_));
  aoi21  g31(.a(new_n50_), .b(x12), .c(new_n61_), .O(new_n62_));
  nand2  g32(.a(x09), .b(x01), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(x12), .O(new_n64_));
  nand3  g34(.a(new_n64_), .b(new_n54_), .c(x11), .O(new_n65_));
