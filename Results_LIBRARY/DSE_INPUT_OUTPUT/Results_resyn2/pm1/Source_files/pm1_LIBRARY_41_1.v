...
module FAU ( 
  ...
  nand2  g24(.a(new_n53_), .b(new_n34_), .O(z08));
  nand4  g25(.a(new_n32_), .b(new_n31_), .c(new_n34_), .d(x00), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(z09));
  nand2  g27(.a(new_n34_), .b(x00), .O(new_n58_));
  nand3  g28(.a(new_n32_), .b(x11), .c(new_n30_), .O(new_n59_));
  nor2   g29(.a(new_n59_), .b(new_n58_), .O(z11));
  zero   g30(.O(z10));
endmodule
