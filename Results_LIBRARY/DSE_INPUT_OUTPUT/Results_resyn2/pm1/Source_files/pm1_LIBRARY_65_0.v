...
module FAU ( 
  ...
  nand4  g31(.a(x11), .b(new_n51_), .c(x09), .d(x00), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n60_), .O(z10));
  nand4  g33(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  inv1   g34(.a(x01), .O(new_n64_));
  nand3  g35(.a(new_n30_), .b(x04), .c(new_n64_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n63_), .c(new_n52_), .O(z11));
  inv1   g37(.a(x09), .O(new_n67_));
  nand3  g38(.a(x12), .b(x11), .c(new_n67_), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n57_), .O(z12));
endmodule
