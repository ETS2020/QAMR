...
module FAU ( 
  ...
  oai21  g11(.a(new_n32_), .b(x09), .c(x14), .O(z04));
  nor2   g12(.a(new_n32_), .b(x09), .O(new_n42_));
  nor2   g13(.a(new_n42_), .b(x13), .O(z05));
  inv1   g14(.a(x09), .O(new_n44_));
  aoi21  g15(.a(new_n31_), .b(x01), .c(new_n44_), .O(new_n45_));
  ...
  and2   g20(.a(new_n46_), .b(x09), .O(new_n50_));
  ...
  nand4  g29(.a(new_n46_), .b(x11), .c(new_n51_), .d(x00), .O(new_n59_));
  ...
  aoi21  g33(.a(new_n47_), .b(x12), .c(new_n62_), .O(z11));
  zero   g34(.O(z12));
endmodule
