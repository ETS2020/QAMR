...
module FAU ( 
  ...
  oai21  g05(.a(new_n33_), .b(x12), .c(new_n34_), .O(z01));
  nor2   g06(.a(x13), .b(x12), .O(new_n36_));
  ...
  nand3  g27(.a(new_n56_), .b(new_n53_), .c(new_n43_), .O(z08));
  nand2  g28(.a(new_n54_), .b(x00), .O(new_n58_));
  nand3  g29(.a(x13), .b(new_n30_), .c(new_n46_), .O(new_n59_));
