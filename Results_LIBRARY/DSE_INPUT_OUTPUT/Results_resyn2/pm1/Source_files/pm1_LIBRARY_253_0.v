...
module FAU ( 
  ...
  nand2  g03(.a(x14), .b(new_n30_), .O(new_n33_));
  ...
  aoi21  g10(.a(z04), .b(new_n30_), .c(new_n39_), .O(z02));
  ...
  nand3  g29(.a(x14), .b(new_n30_), .c(new_n46_), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n34_), .c(new_n58_), .O(z09));
  ...
  nand3  g36(.a(x14), .b(new_n30_), .c(new_n65_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n64_), .c(new_n53_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand3  g39(.a(x12), .b(x11), .c(new_n68_), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n58_), .c(new_n44_), .O(z12));
endmodule
