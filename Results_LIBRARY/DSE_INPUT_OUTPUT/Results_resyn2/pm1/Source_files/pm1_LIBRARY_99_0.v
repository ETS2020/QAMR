...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n36_, new_n38_,
    new_n39_, new_n40_, new_n41_, new_n42_, new_n46_, new_n48_, new_n49_,
  ...
  nand2  g04(.a(new_n33_), .b(x04), .O(new_n34_));
  nand2  g05(.a(new_n34_), .b(new_n30_), .O(z00));
  aoi21  g06(.a(new_n32_), .b(x04), .c(x11), .O(new_n36_));
  inv1   g07(.a(new_n36_), .O(z01));
  nor2   g08(.a(x11), .b(x04), .O(new_n38_));
  ...
  nor2   g15(.a(new_n38_), .b(x14), .O(z04));
  ...
  nor2   g31(.a(new_n60_), .b(new_n36_), .O(z09));
  nand4  g32(.a(x12), .b(new_n53_), .c(x09), .d(x00), .O(new_n62_));
  nand2  g33(.a(x03), .b(x02), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(x11), .O(new_n64_));
  aoi22  g35(.a(new_n64_), .b(x04), .c(new_n62_), .d(x11), .O(z10));
