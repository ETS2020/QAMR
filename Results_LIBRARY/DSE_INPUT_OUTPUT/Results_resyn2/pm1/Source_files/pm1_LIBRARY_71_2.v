...
module FAU ( 
  ...
  nor2   g14(.a(new_n43_), .b(new_n35_), .O(z03));
  ...
  oai21  g30(.a(new_n55_), .b(new_n35_), .c(new_n59_), .O(z08));
  nand2  g31(.a(new_n53_), .b(x00), .O(new_n61_));
  nand2  g32(.a(x12), .b(x11), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n33_), .c(new_n61_), .O(z09));
  nand2  g34(.a(new_n48_), .b(new_n57_), .O(new_n64_));
  oai21  g35(.a(new_n64_), .b(new_n54_), .c(new_n47_), .O(z10));
  ...
  nand4  g40(.a(new_n55_), .b(new_n48_), .c(new_n57_), .d(x01), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n69_), .O(z11));
  nand3  g42(.a(new_n53_), .b(new_n56_), .c(x00), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(new_n62_), .c(new_n47_), .O(z12));
endmodule
