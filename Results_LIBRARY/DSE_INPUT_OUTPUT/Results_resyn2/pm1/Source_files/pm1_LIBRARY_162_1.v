// Benchmark "FAU" written by ABC on Tue Aug 11 19:15:35 2020
...
module FAU ( 
  ...
  oai21  g06(.a(new_n35_), .b(new_n30_), .c(x12), .O(z01));
  nor2   g07(.a(new_n35_), .b(new_n30_), .O(new_n37_));
  nand3  g08(.a(x12), .b(x09), .c(x08), .O(new_n38_));
  inv1   g09(.a(new_n38_), .O(new_n39_));
  nand4  g10(.a(new_n39_), .b(new_n37_), .c(x06), .d(x05), .O(z02));
  nand3  g11(.a(x08), .b(x06), .c(x05), .O(new_n41_));
  nand3  g12(.a(x12), .b(x09), .c(x07), .O(new_n42_));
  inv1   g13(.a(new_n42_), .O(new_n43_));
  nand3  g14(.a(new_n43_), .b(new_n41_), .c(x11), .O(z03));
  nand2  g15(.a(new_n31_), .b(x14), .O(z04));
  nand2  g16(.a(new_n31_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  aoi21  g18(.a(x12), .b(new_n35_), .c(new_n47_), .O(new_n48_));
  ...
  oai21  g26(.a(new_n47_), .b(new_n42_), .c(new_n55_), .O(z08));
  inv1   g27(.a(x12), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x11), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(z01), .c(new_n53_), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand2  g31(.a(new_n47_), .b(new_n43_), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n54_), .O(z10));
  aoi21  g33(.a(new_n49_), .b(new_n47_), .c(new_n57_), .O(new_n63_));
  nand2  g34(.a(new_n57_), .b(x01), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(x11), .c(new_n53_), .d(x00), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n63_), .c(new_n31_), .O(z11));
  inv1   g37(.a(x09), .O(new_n67_));
  nand4  g38(.a(x11), .b(new_n53_), .c(new_n67_), .d(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x07), .c(new_n57_), .O(z12));
endmodule
