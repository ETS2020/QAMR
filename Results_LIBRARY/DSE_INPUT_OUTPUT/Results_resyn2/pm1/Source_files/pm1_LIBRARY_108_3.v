...
module FAU ( 
  ...
  wire new_n30_, new_n33_, new_n35_, new_n39_, new_n40_, new_n41_, new_n42_,
    new_n45_, new_n47_;
  ...
  nand3  g12(.a(z02), .b(x09), .c(x01), .O(new_n42_));
  aoi21  g13(.a(new_n41_), .b(new_n39_), .c(new_n42_), .O(z06));
  nand2  g14(.a(z02), .b(x15), .O(z07));
  inv1   g15(.a(x10), .O(new_n45_));
  nand4  g16(.a(new_n30_), .b(x11), .c(new_n45_), .d(x00), .O(z08));
  nand4  g17(.a(new_n30_), .b(new_n35_), .c(new_n45_), .d(x00), .O(new_n47_));
