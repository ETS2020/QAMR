...
module FAU ( 
  ...
  nand4  g11(.a(new_n40_), .b(new_n36_), .c(x11), .d(x09), .O(z03));
  nor2   g12(.a(new_n32_), .b(x10), .O(z10));
  ...
  nand4  g23(.a(new_n32_), .b(x11), .c(new_n39_), .d(x00), .O(z08));
  nand2  g24(.a(new_n31_), .b(x00), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(new_n32_), .c(x10), .O(z09));
  nand3  g26(.a(x11), .b(new_n30_), .c(x00), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n32_), .c(x10), .O(z11));
  zero   g28(.O(z12));
endmodule
