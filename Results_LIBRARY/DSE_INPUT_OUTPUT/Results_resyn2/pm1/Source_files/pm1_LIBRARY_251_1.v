...
module FAU ( 
  ...
  nand4  g08(.a(x12), .b(x11), .c(x09), .d(x00), .O(new_n38_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n50_), .c(new_n53_), .O(z08));
  ...
  nor3   g31(.a(new_n60_), .b(new_n52_), .c(new_n59_), .O(z10));
  aoi21  g32(.a(new_n45_), .b(x12), .c(new_n30_), .O(new_n62_));
  nand2  g33(.a(x09), .b(x01), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(x12), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(x11), .c(new_n51_), .d(x00), .O(new_n65_));
  nor2   g36(.a(new_n65_), .b(new_n62_), .O(z11));
  nor3   g37(.a(new_n56_), .b(new_n55_), .c(x09), .O(z12));
endmodule
