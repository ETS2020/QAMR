...
module FAU ( 
  ...
  oai21  g18(.a(new_n41_), .b(new_n48_), .c(x11), .O(new_n49_));
  ...
  nand3  g23(.a(new_n53_), .b(x12), .c(x11), .O(new_n54_));
  nand2  g24(.a(new_n54_), .b(new_n37_), .O(z09));
  nand2  g25(.a(x11), .b(x09), .O(new_n56_));
  nand2  g26(.a(new_n41_), .b(x12), .O(new_n57_));
  nor3   g27(.a(new_n57_), .b(new_n46_), .c(new_n56_), .O(z10));
  inv1   g28(.a(x01), .O(new_n59_));
  aoi21  g29(.a(new_n41_), .b(x12), .c(new_n59_), .O(new_n60_));
  nand2  g30(.a(new_n40_), .b(x12), .O(new_n61_));
  nand3  g31(.a(new_n53_), .b(new_n61_), .c(x11), .O(new_n62_));
