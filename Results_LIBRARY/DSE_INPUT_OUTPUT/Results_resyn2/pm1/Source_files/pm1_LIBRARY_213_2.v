...
module FAU ( 
  ...
  nand2  g01(.a(z05), .b(x12), .O(new_n31_));
  ...
  nand3  g09(.a(x13), .b(x12), .c(new_n38_), .O(z01));
  nand4  g10(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n40_));
  inv1   g11(.a(new_n40_), .O(new_n41_));
  nand3  g12(.a(x13), .b(x12), .c(x09), .O(new_n42_));
  inv1   g13(.a(new_n42_), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x11), .O(new_n44_));
  inv1   g15(.a(new_n44_), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n41_), .O(z02));
  nand2  g17(.a(new_n45_), .b(new_n40_), .O(z03));
  nand2  g18(.a(new_n31_), .b(x14), .O(z04));
  ...
  aoi21  g24(.a(new_n51_), .b(new_n49_), .c(new_n53_), .O(z06));
  ...
  nand2  g30(.a(new_n34_), .b(x11), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n49_), .c(new_n56_), .d(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n31_), .O(z09));
  and2   g33(.a(x11), .b(x09), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n50_), .c(new_n56_), .d(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x13), .c(new_n34_), .O(z10));
  nand4  g36(.a(new_n52_), .b(new_n50_), .c(x13), .d(x12), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n35_), .c(new_n57_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(x11), .b(new_n56_), .c(new_n68_), .d(x00), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(x13), .c(new_n34_), .O(z12));
endmodule
