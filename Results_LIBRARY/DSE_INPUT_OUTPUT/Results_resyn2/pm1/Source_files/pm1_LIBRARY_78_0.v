...
module FAU ( 
  ...
  oai21  g22(.a(new_n48_), .b(new_n46_), .c(new_n51_), .O(z08));
  inv1   g23(.a(x12), .O(new_n53_));
  nor2   g24(.a(new_n53_), .b(new_n46_), .O(new_n54_));
  ...
  nand4  g29(.a(new_n58_), .b(new_n54_), .c(new_n42_), .d(x00), .O(new_n59_));
  ...
  nand2  g35(.a(new_n64_), .b(new_n53_), .O(new_n65_));
  nor2   g36(.a(new_n61_), .b(new_n47_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(new_n58_), .c(new_n54_), .d(new_n42_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n65_), .O(z11));
  nor2   g39(.a(new_n55_), .b(x09), .O(z12));
  buf    g40(.a(x11), .O(z01));
endmodule
