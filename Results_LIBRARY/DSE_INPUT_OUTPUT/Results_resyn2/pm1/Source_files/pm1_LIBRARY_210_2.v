...
module FAU ( 
  ...
  nand2  g09(.a(new_n31_), .b(x11), .O(new_n39_));
  ...
  oai21  g17(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z06));
  nand2  g18(.a(new_n39_), .b(x15), .O(z07));
  ...
  aoi21  g26(.a(new_n55_), .b(new_n39_), .c(new_n33_), .O(z09));
  nand4  g27(.a(new_n45_), .b(new_n49_), .c(x09), .d(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(x12), .c(new_n44_), .O(z10));
  nand3  g29(.a(new_n45_), .b(x09), .c(x01), .O(new_n59_));
  nor2   g30(.a(new_n59_), .b(new_n50_), .O(z11));
  inv1   g31(.a(x09), .O(new_n61_));
  nand3  g32(.a(new_n49_), .b(new_n61_), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x12), .c(new_n44_), .O(z12));
endmodule
