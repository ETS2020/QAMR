...
module FAU ( 
  ...
  nor2   g21(.a(new_n50_), .b(x15), .O(z07));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x11), .b(new_n52_), .c(x00), .O(new_n53_));
  inv1   g24(.a(new_n53_), .O(new_n54_));
  nand2  g25(.a(x14), .b(x12), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(new_n56_));
  nand3  g27(.a(new_n56_), .b(new_n48_), .c(x09), .O(new_n57_));
  oai21  g28(.a(new_n54_), .b(new_n50_), .c(new_n57_), .O(z08));
  inv1   g29(.a(x00), .O(new_n59_));
  nor2   g30(.a(x10), .b(new_n59_), .O(new_n60_));
  nand2  g31(.a(new_n32_), .b(x11), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n60_), .c(z01), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z09));
  nand4  g34(.a(new_n60_), .b(new_n47_), .c(x11), .d(x09), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x14), .c(new_n32_), .O(z10));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  nand4  g37(.a(new_n56_), .b(new_n47_), .c(x09), .d(x01), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n66_), .c(new_n53_), .O(z11));
  nor3   g39(.a(new_n55_), .b(new_n53_), .c(x09), .O(z12));
endmodule
