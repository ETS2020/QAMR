...
module FAU ( 
  ...
  nor2   g06(.a(new_n30_), .b(x04), .O(new_n36_));
  ...
  nand4  g13(.a(new_n40_), .b(new_n36_), .c(x11), .d(x09), .O(z03));
  ...
  oai21  g19(.a(new_n48_), .b(new_n46_), .c(new_n31_), .O(z06));
  ...
  nand3  g26(.a(new_n35_), .b(new_n54_), .c(x00), .O(new_n56_));
  aoi22  g27(.a(new_n56_), .b(new_n30_), .c(new_n55_), .d(new_n36_), .O(z09));
  nand4  g28(.a(x11), .b(new_n54_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n38_), .c(new_n30_), .O(z10));
  inv1   g30(.a(x01), .O(new_n60_));
  aoi21  g31(.a(x12), .b(new_n38_), .c(new_n60_), .O(new_n61_));
  nand2  g32(.a(new_n46_), .b(x12), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n52_), .c(x11), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n61_), .O(z11));
  nand2  g35(.a(x12), .b(new_n38_), .O(new_n65_));
  nor3   g36(.a(new_n55_), .b(new_n65_), .c(x09), .O(z12));
endmodule
