...
module FAU ( 
  ...
  aoi21  g16(.a(x14), .b(new_n30_), .c(x13), .O(z05));
  oai21  g17(.a(new_n41_), .b(new_n32_), .c(new_n31_), .O(new_n47_));
  ...
  aoi21  g29(.a(new_n33_), .b(x11), .c(new_n56_), .O(new_n59_));
  and2   g30(.a(new_n59_), .b(z01), .O(z09));
  inv1   g31(.a(x09), .O(new_n61_));
  nand2  g32(.a(new_n49_), .b(x12), .O(new_n62_));
  nand3  g33(.a(x11), .b(new_n55_), .c(x00), .O(new_n63_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n52_), .O(z11));
  nand3  g40(.a(x12), .b(x11), .c(new_n61_), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n56_), .O(z12));
endmodule
