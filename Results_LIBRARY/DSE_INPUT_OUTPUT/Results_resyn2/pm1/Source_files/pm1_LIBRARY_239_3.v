...
module FAU ( 
  ...
  nand3  g05(.a(z04), .b(x12), .c(new_n31_), .O(z01));
  nand2  g06(.a(x11), .b(x09), .O(new_n36_));
  nand4  g07(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n37_));
  oai21  g08(.a(new_n37_), .b(new_n36_), .c(z04), .O(new_n38_));
  nand2  g09(.a(new_n38_), .b(x12), .O(z02));
  and2   g10(.a(x11), .b(x09), .O(new_n40_));
  nand4  g11(.a(new_n37_), .b(new_n40_), .c(z04), .d(x12), .O(z03));
  aoi21  g12(.a(x14), .b(x12), .c(x13), .O(z05));
  nand2  g13(.a(x09), .b(x01), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(x11), .c(z04), .O(new_n44_));
  ...
  nand2  g32(.a(new_n61_), .b(new_n50_), .O(z09));
  nand4  g33(.a(new_n47_), .b(new_n40_), .c(new_n55_), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(z04), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n47_), .b(new_n46_), .c(z04), .d(x12), .O(new_n65_));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n65_), .c(new_n56_), .O(z11));
  nand2  g38(.a(z04), .b(x12), .O(new_n68_));
  nor3   g39(.a(new_n56_), .b(new_n68_), .c(x09), .O(z12));
endmodule
