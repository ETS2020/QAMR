...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(new_n32_), .O(new_n36_));
  ...
  aoi21  g16(.a(new_n45_), .b(new_n32_), .c(x14), .O(z04));
  ...
  nand3  g31(.a(x13), .b(new_n32_), .c(new_n30_), .O(new_n61_));
