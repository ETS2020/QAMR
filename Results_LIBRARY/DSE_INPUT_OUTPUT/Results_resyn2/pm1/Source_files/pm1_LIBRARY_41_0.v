...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n50_, new_n53_, new_n54_, new_n55_, new_n57_, new_n59_, new_n62_,
    new_n63_;
  ...
  nand2  g12(.a(new_n32_), .b(x10), .O(new_n42_));
  ...
  nand3  g20(.a(new_n35_), .b(x09), .c(x01), .O(new_n50_));
  nor2   g21(.a(new_n50_), .b(new_n49_), .O(z06));
  nor2   g22(.a(new_n36_), .b(x15), .O(z07));
  ...
  nand2  g26(.a(new_n55_), .b(new_n34_), .O(z08));
  nand4  g27(.a(x12), .b(x11), .c(new_n34_), .d(x00), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(z09));
  nand2  g29(.a(new_n48_), .b(x09), .O(new_n59_));
  nor2   g30(.a(new_n59_), .b(new_n57_), .O(z10));
  nor3   g31(.a(new_n59_), .b(new_n57_), .c(new_n30_), .O(z11));
  inv1   g32(.a(x09), .O(new_n62_));
  nand3  g33(.a(x11), .b(new_n62_), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(x10), .O(z12));
endmodule
