...
module FAU ( 
  ...
  nor2   g03(.a(x14), .b(x12), .O(new_n33_));
  ...
  aoi21  g10(.a(x14), .b(new_n30_), .c(new_n39_), .O(z02));
  ...
  nand2  g30(.a(new_n33_), .b(new_n47_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n35_), .c(new_n59_), .O(z09));
