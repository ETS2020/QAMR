...
module FAU ( 
  ...
  aoi22  g10(.a(new_n39_), .b(new_n37_), .c(new_n30_), .d(new_n35_), .O(z02));
  nand2  g11(.a(new_n39_), .b(new_n36_), .O(z03));
  nand2  g12(.a(new_n30_), .b(new_n35_), .O(new_n42_));
  ...
  nand3  g25(.a(new_n54_), .b(new_n51_), .c(new_n42_), .O(z08));
  ...
  nor2   g31(.a(new_n60_), .b(new_n56_), .O(z09));
  nand2  g32(.a(new_n45_), .b(x12), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n53_), .c(new_n35_), .O(z10));
  inv1   g34(.a(x01), .O(new_n64_));
  aoi21  g35(.a(new_n45_), .b(x12), .c(new_n64_), .O(new_n65_));
  nand2  g36(.a(x12), .b(new_n64_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(new_n58_), .c(x11), .d(x09), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n65_), .O(z11));
  aoi21  g39(.a(new_n53_), .b(x12), .c(x09), .O(z12));
endmodule
