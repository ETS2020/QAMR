...
module FAU ( 
  ...
  nand2  g08(.a(new_n37_), .b(x05), .O(z02));
  ...
  nor2   g13(.a(x12), .b(new_n39_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n43_), .c(new_n58_), .O(z08));
  ...
  nand2  g33(.a(new_n57_), .b(new_n47_), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n53_), .O(z10));
  inv1   g35(.a(x01), .O(new_n65_));
  nand4  g36(.a(x11), .b(new_n52_), .c(new_n65_), .d(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n39_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nand4  g39(.a(new_n57_), .b(new_n54_), .c(new_n47_), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n68_), .O(z11));
  nand2  g41(.a(new_n52_), .b(x00), .O(new_n71_));
