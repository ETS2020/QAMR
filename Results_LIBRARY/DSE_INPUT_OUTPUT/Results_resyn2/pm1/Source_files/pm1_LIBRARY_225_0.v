...
module FAU ( 
  ...
  nor2   g03(.a(z04), .b(x12), .O(new_n33_));
  ...
  nor2   g08(.a(x14), .b(x12), .O(new_n38_));
  ...
  nand3  g20(.a(new_n46_), .b(x09), .c(x01), .O(new_n50_));
  ...
  nand2  g34(.a(new_n58_), .b(new_n48_), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n54_), .O(z10));
  ...
  nand4  g39(.a(new_n58_), .b(new_n55_), .c(new_n48_), .d(x01), .O(new_n69_));
