...
module FAU ( 
  ...
  nand2  g08(.a(z01), .b(x14), .O(z04));
  nand2  g09(.a(z01), .b(x13), .O(z05));
  nand3  g10(.a(x04), .b(x03), .c(x02), .O(new_n40_));
  nand3  g11(.a(new_n40_), .b(x09), .c(x01), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(z01), .O(z06));
  aoi21  g13(.a(x12), .b(new_n31_), .c(x15), .O(z07));
  ...
  nand2  g19(.a(new_n48_), .b(new_n46_), .O(z08));
  nand2  g20(.a(new_n44_), .b(x00), .O(new_n50_));
  nor2   g21(.a(x12), .b(new_n31_), .O(new_n51_));
  aoi21  g22(.a(new_n50_), .b(z01), .c(new_n51_), .O(z09));
  inv1   g23(.a(x12), .O(new_n53_));
  nand4  g24(.a(new_n40_), .b(new_n44_), .c(x09), .d(x00), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(x11), .c(new_n53_), .O(z10));
  nand2  g26(.a(new_n53_), .b(new_n30_), .O(new_n56_));
  nand4  g27(.a(new_n40_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n56_), .c(new_n45_), .O(z11));
  inv1   g29(.a(x09), .O(new_n59_));
  nand3  g30(.a(new_n44_), .b(new_n59_), .c(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x11), .c(new_n53_), .O(z12));
endmodule
