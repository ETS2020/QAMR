...
module FAU ( 
  ...
  nand4  g13(.a(new_n39_), .b(x12), .c(x11), .d(x09), .O(new_n43_));
  xor2a  g14(.a(new_n43_), .b(new_n38_), .O(z03));
  nand2  g15(.a(new_n33_), .b(x14), .O(z04));
  nand2  g16(.a(new_n33_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  aoi21  g18(.a(x12), .b(new_n34_), .c(new_n47_), .O(new_n48_));
  nand2  g19(.a(x09), .b(x01), .O(new_n49_));
  oai21  g20(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(z06));
  nor2   g21(.a(new_n38_), .b(x15), .O(z07));
  nand2  g22(.a(x11), .b(x00), .O(new_n52_));
  ...
  aoi21  g28(.a(x12), .b(new_n37_), .c(new_n34_), .O(new_n58_));
  nand2  g29(.a(new_n35_), .b(x00), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(new_n33_), .O(z09));
  nand2  g31(.a(new_n47_), .b(x12), .O(new_n61_));
  inv1   g32(.a(new_n52_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n37_), .c(x09), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n61_), .c(new_n33_), .O(z10));
  nand2  g35(.a(new_n49_), .b(x12), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(new_n62_), .c(new_n37_), .O(new_n66_));
  aoi21  g37(.a(new_n61_), .b(x01), .c(new_n66_), .O(z11));
  nand2  g38(.a(x12), .b(new_n37_), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n52_), .c(x09), .O(z12));
endmodule
