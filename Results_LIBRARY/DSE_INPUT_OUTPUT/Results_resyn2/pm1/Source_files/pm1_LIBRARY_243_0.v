...
module FAU ( 
  ...
  nand4  g12(.a(new_n38_), .b(x12), .c(x11), .d(x09), .O(z03));
  ...
  nand3  g31(.a(new_n32_), .b(new_n30_), .c(x08), .O(new_n61_));
  ...
  oai21  g40(.a(new_n69_), .b(new_n60_), .c(new_n44_), .O(z12));
endmodule
