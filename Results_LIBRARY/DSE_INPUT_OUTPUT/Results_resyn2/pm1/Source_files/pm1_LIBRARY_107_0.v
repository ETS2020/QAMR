...
module FAU ( 
  ...
  nand3  g28(.a(x11), .b(x09), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n45_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(x10), .O(z10));
  nand3  g32(.a(new_n59_), .b(new_n45_), .c(x01), .O(new_n62_));
