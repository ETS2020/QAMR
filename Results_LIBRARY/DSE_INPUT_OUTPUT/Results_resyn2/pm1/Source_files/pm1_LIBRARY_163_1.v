...
module FAU ( 
  ...
  nand2  g22(.a(new_n31_), .b(new_n30_), .O(new_n52_));
  ...
  nor3   g27(.a(new_n56_), .b(new_n48_), .c(new_n30_), .O(z10));
  inv1   g28(.a(x00), .O(new_n58_));
  nor2   g29(.a(x10), .b(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n32_), .c(x11), .O(new_n60_));
  aoi21  g31(.a(new_n44_), .b(x12), .c(new_n60_), .O(z11));
  nand2  g32(.a(new_n59_), .b(new_n36_), .O(new_n62_));
