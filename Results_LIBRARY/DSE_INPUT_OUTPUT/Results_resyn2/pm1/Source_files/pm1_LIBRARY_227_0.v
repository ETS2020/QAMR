...
module FAU ( 
  ...
  nand2  g03(.a(new_n30_), .b(x08), .O(new_n33_));
  ...
  nand2  g23(.a(new_n52_), .b(new_n42_), .O(new_n53_));
  ...
  nand4  g32(.a(x11), .b(new_n51_), .c(x09), .d(x00), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z10));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n64_), .c(new_n52_), .O(z11));
  nand2  g38(.a(new_n51_), .b(x00), .O(new_n68_));
