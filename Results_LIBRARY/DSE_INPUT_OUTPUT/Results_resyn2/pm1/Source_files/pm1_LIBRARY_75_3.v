...
module FAU ( 
  ...
  aoi21  g14(.a(x13), .b(x12), .c(x14), .O(z04));
  nand2  g15(.a(x13), .b(new_n32_), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  inv1   g17(.a(new_n46_), .O(new_n47_));
  nand2  g18(.a(x12), .b(new_n31_), .O(new_n48_));
  nand2  g19(.a(x13), .b(x12), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(x09), .c(x01), .O(new_n50_));
  aoi21  g21(.a(new_n48_), .b(new_n47_), .c(new_n50_), .O(z06));
  ...
  nand4  g26(.a(new_n47_), .b(new_n34_), .c(x12), .d(x09), .O(new_n56_));
  ...
  nor2   g32(.a(new_n61_), .b(new_n35_), .O(z09));
  nand4  g33(.a(new_n59_), .b(new_n46_), .c(x11), .d(x09), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n34_), .c(new_n32_), .O(z10));
  nand2  g35(.a(new_n34_), .b(x12), .O(new_n65_));
  ...
  aoi22  g39(.a(new_n68_), .b(new_n67_), .c(new_n54_), .d(new_n49_), .O(z11));
  nor3   g40(.a(new_n65_), .b(new_n54_), .c(x09), .O(z12));
endmodule
