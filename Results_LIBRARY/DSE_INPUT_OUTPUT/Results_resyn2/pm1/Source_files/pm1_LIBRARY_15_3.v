...
module FAU ( 
  ...
  oai21  g10(.a(new_n40_), .b(x07), .c(x12), .O(z03));
  oai21  g11(.a(new_n31_), .b(new_n30_), .c(x14), .O(z04));
  nor2   g12(.a(new_n32_), .b(x13), .O(z05));
  ...
  nand3  g28(.a(new_n37_), .b(new_n55_), .c(x00), .O(new_n59_));
  nor2   g29(.a(new_n31_), .b(x07), .O(new_n60_));
  aoi22  g30(.a(new_n60_), .b(new_n56_), .c(new_n59_), .d(new_n31_), .O(z09));
  nand4  g31(.a(new_n48_), .b(new_n40_), .c(new_n55_), .d(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(new_n30_), .c(new_n31_), .O(z10));
  nand4  g33(.a(new_n48_), .b(new_n47_), .c(x12), .d(new_n30_), .O(new_n64_));
  aoi21  g34(.a(new_n64_), .b(new_n34_), .c(new_n56_), .O(z11));
  inv1   g35(.a(x09), .O(new_n66_));
  nand4  g36(.a(x11), .b(new_n55_), .c(new_n66_), .d(x00), .O(new_n67_));
  aoi21  g37(.a(new_n67_), .b(new_n30_), .c(new_n31_), .O(z12));
  one    g38(.O(z02));
endmodule
