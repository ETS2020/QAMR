...
module FAU ( 
  ...
  nand2  g32(.a(new_n53_), .b(new_n47_), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n56_), .c(new_n45_), .O(z10));
  nand4  g34(.a(x11), .b(new_n55_), .c(new_n30_), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(x09), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n32_), .O(new_n66_));
  nand4  g37(.a(new_n57_), .b(new_n53_), .c(new_n47_), .d(x01), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(z11));
  nor3   g39(.a(new_n60_), .b(new_n59_), .c(x09), .O(z12));
endmodule
