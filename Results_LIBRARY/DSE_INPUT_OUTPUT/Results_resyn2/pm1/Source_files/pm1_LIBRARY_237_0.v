...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n51_,
  ...
  nand2  g17(.a(z07), .b(new_n30_), .O(new_n47_));
  and2   g18(.a(x09), .b(x01), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nor2   g20(.a(new_n49_), .b(new_n45_), .O(z06));
  ...
  nand3  g26(.a(new_n55_), .b(new_n52_), .c(new_n47_), .O(z08));
  ...
  oai21  g32(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z10));
  nand4  g33(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  inv1   g34(.a(x01), .O(new_n64_));
  nand3  g35(.a(x15), .b(new_n30_), .c(new_n64_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n63_), .c(new_n54_), .O(z11));
  nand2  g37(.a(new_n53_), .b(x00), .O(new_n67_));
  inv1   g38(.a(x09), .O(new_n68_));
  nand3  g39(.a(x12), .b(x11), .c(new_n68_), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n67_), .c(new_n47_), .O(z12));
endmodule
