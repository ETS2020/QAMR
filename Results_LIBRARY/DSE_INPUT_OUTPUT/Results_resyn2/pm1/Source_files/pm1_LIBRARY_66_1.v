...
module FAU ( 
  ...
  nor2   g17(.a(new_n46_), .b(new_n34_), .O(z06));
  ...
  oai21  g23(.a(new_n52_), .b(new_n50_), .c(x11), .O(new_n53_));
  nand2  g24(.a(new_n31_), .b(new_n30_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n53_), .O(z08));
  nand2  g26(.a(x12), .b(x11), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n54_), .c(new_n50_), .O(z09));
  nand3  g28(.a(new_n45_), .b(x12), .c(x09), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n50_), .c(new_n30_), .O(z10));
  nand4  g30(.a(new_n32_), .b(x11), .c(new_n49_), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n46_), .b(x12), .c(new_n60_), .O(z11));
  nor3   g32(.a(new_n56_), .b(new_n50_), .c(x09), .O(z12));
endmodule
