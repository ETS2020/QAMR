...
module FAU ( 
  ...
  nor2   g12(.a(x12), .b(new_n30_), .O(new_n42_));
  ...
  nor2   g18(.a(new_n30_), .b(new_n47_), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x12), .O(new_n49_));
  aoi21  g20(.a(new_n46_), .b(x11), .c(new_n49_), .O(z06));
  oai21  g21(.a(x12), .b(new_n30_), .c(x15), .O(z07));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x11), .b(new_n52_), .c(x00), .O(new_n53_));
  aoi21  g24(.a(new_n46_), .b(x09), .c(new_n53_), .O(new_n54_));
  nor2   g25(.a(new_n54_), .b(new_n42_), .O(z08));
  nand2  g26(.a(new_n52_), .b(x00), .O(new_n56_));
  nand2  g27(.a(x12), .b(x11), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n33_), .c(new_n56_), .O(z09));
  inv1   g29(.a(new_n56_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n45_), .c(new_n39_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z10));
  nand4  g32(.a(x11), .b(new_n52_), .c(new_n47_), .d(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n30_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n32_), .O(new_n64_));
  inv1   g35(.a(new_n53_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(new_n48_), .c(new_n45_), .O(new_n66_));
