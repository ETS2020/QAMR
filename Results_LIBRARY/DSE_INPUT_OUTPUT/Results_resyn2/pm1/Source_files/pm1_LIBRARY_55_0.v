...
module FAU ( 
  ...
  oai21  g15(.a(x12), .b(new_n42_), .c(new_n44_), .O(z03));
  ...
  aoi21  g23(.a(x12), .b(new_n31_), .c(new_n42_), .O(new_n53_));
  aoi22  g24(.a(new_n53_), .b(new_n52_), .c(new_n50_), .d(new_n47_), .O(z06));
  ...
  oai22  g30(.a(new_n59_), .b(new_n51_), .c(new_n58_), .d(new_n46_), .O(z08));
  nand2  g31(.a(new_n56_), .b(x00), .O(new_n61_));
  aoi21  g32(.a(new_n39_), .b(new_n33_), .c(new_n61_), .O(z09));
  nand2  g33(.a(new_n51_), .b(x12), .O(new_n63_));
  nand4  g34(.a(x11), .b(new_n56_), .c(x09), .d(x00), .O(new_n64_));
  aoi22  g35(.a(new_n64_), .b(x12), .c(new_n63_), .d(x04), .O(z10));
  oai21  g36(.a(new_n64_), .b(new_n30_), .c(x12), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n42_), .O(new_n67_));
  nand2  g38(.a(new_n63_), .b(x01), .O(new_n68_));
  nand2  g39(.a(new_n50_), .b(x12), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n68_), .c(new_n58_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n67_), .O(z11));
  nor3   g42(.a(new_n61_), .b(new_n39_), .c(x09), .O(z12));
endmodule
