...
module FAU ( 
  ...
  oai21  g07(.a(new_n36_), .b(new_n31_), .c(x09), .O(new_n37_));
  nand2  g08(.a(new_n37_), .b(x12), .O(z02));
  nand4  g09(.a(new_n36_), .b(x12), .c(x11), .d(x09), .O(z03));
  nor2   g10(.a(new_n32_), .b(x09), .O(new_n40_));
  ...
  nand2  g22(.a(new_n45_), .b(x12), .O(new_n52_));
  aoi21  g23(.a(new_n52_), .b(new_n51_), .c(new_n40_), .O(z08));
  inv1   g24(.a(new_n40_), .O(new_n54_));
  ...
  nand2  g29(.a(new_n58_), .b(new_n54_), .O(z09));
  nand2  g30(.a(new_n49_), .b(x00), .O(new_n60_));
  nand2  g31(.a(new_n44_), .b(x12), .O(new_n61_));
  nor3   g32(.a(new_n61_), .b(new_n60_), .c(new_n34_), .O(z10));
  aoi21  g33(.a(new_n44_), .b(x12), .c(new_n30_), .O(new_n63_));
  nand2  g34(.a(new_n46_), .b(x12), .O(new_n64_));
