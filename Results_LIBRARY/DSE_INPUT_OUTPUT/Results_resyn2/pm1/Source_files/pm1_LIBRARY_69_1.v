...
module FAU ( 
  ...
  nor2   g16(.a(new_n38_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  nand3  g19(.a(new_n37_), .b(x09), .c(x01), .O(new_n49_));
  ...
  nor2   g26(.a(new_n36_), .b(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n48_), .O(new_n57_));
  oai21  g28(.a(new_n54_), .b(new_n38_), .c(new_n57_), .O(z08));
  nand2  g29(.a(new_n52_), .b(x00), .O(new_n59_));
  nor2   g30(.a(new_n36_), .b(new_n34_), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n32_), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n59_), .c(new_n37_), .O(z09));
  nand2  g33(.a(new_n56_), .b(new_n47_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n53_), .c(new_n37_), .O(z10));
  nand4  g35(.a(x11), .b(new_n52_), .c(new_n30_), .d(x00), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n31_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n36_), .O(new_n67_));
  nand4  g38(.a(new_n56_), .b(new_n54_), .c(new_n47_), .d(x01), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n67_), .O(z11));
  nand2  g40(.a(new_n60_), .b(new_n55_), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n59_), .c(new_n37_), .O(z12));
endmodule
