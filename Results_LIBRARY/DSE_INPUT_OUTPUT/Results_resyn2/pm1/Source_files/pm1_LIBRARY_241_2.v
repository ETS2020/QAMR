...
module FAU ( 
  ...
  oai21  g20(.a(new_n49_), .b(new_n48_), .c(x12), .O(new_n50_));
  ...
  nand2  g33(.a(new_n33_), .b(new_n48_), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n35_), .c(new_n62_), .O(z09));
