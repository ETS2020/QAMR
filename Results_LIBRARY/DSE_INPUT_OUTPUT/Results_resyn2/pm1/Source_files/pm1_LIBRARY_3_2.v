...
module FAU ( 
  ...
  nand4  g10(.a(new_n39_), .b(new_n37_), .c(x13), .d(x12), .O(z02));
  nand2  g11(.a(new_n39_), .b(new_n36_), .O(new_n41_));
  ...
  oai21  g23(.a(new_n49_), .b(new_n38_), .c(x13), .O(new_n53_));
  ...
  nand3  g31(.a(new_n60_), .b(new_n56_), .c(new_n59_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n58_), .O(z09));
  nand4  g33(.a(new_n56_), .b(new_n49_), .c(x11), .d(x09), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x13), .c(new_n31_), .O(z10));
  nand2  g35(.a(new_n56_), .b(x11), .O(new_n65_));
  nand3  g36(.a(x12), .b(x09), .c(x01), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n49_), .c(new_n33_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n65_), .c(new_n58_), .O(z11));
  nand3  g40(.a(new_n56_), .b(x11), .c(new_n38_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(x13), .c(new_n31_), .O(z12));
endmodule
