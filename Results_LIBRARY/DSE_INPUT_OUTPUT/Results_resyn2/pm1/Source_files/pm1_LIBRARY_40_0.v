...
module FAU ( 
  ...
  oai21  g14(.a(new_n41_), .b(new_n43_), .c(new_n38_), .O(z03));
  nor2   g15(.a(new_n43_), .b(x14), .O(z04));
  nor2   g16(.a(x13), .b(new_n33_), .O(z05));
  ...
  nand2  g21(.a(new_n35_), .b(x15), .O(z07));
  ...
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(new_n35_), .O(z09));
  nand3  g31(.a(new_n35_), .b(new_n52_), .c(x00), .O(new_n61_));
  nand2  g32(.a(new_n47_), .b(new_n41_), .O(new_n62_));
  ...
  nand4  g36(.a(new_n35_), .b(x11), .c(new_n52_), .d(x00), .O(new_n66_));
