...
module FAU ( 
  ...
  aoi21  g05(.a(x11), .b(new_n30_), .c(new_n31_), .O(new_n35_));
  ...
  nand3  g24(.a(new_n53_), .b(new_n44_), .c(x11), .O(z08));
  nand2  g25(.a(new_n31_), .b(x11), .O(new_n55_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n44_), .O(z11));
  inv1   g35(.a(x09), .O(new_n65_));
  nand4  g36(.a(x11), .b(new_n58_), .c(new_n65_), .d(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n30_), .c(new_n31_), .O(z12));
endmodule
