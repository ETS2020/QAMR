...
module FAU ( 
  ...
  oai21  g18(.a(new_n47_), .b(new_n35_), .c(new_n46_), .O(new_n48_));
  ...
  nand3  g29(.a(new_n54_), .b(new_n47_), .c(new_n40_), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z10));
  nand4  g31(.a(new_n47_), .b(new_n46_), .c(new_n56_), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n31_), .O(z11));
  inv1   g33(.a(x09), .O(new_n63_));
  nand2  g34(.a(new_n54_), .b(new_n63_), .O(new_n64_));
