...
module FAU ( 
  ...
  oai21  g06(.a(new_n35_), .b(x03), .c(x12), .O(z01));
  nand4  g07(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n37_));
  nand4  g08(.a(x12), .b(x11), .c(x09), .d(new_n30_), .O(new_n38_));
  ...
  nor2   g19(.a(new_n32_), .b(x15), .O(z07));
  inv1   g20(.a(x10), .O(new_n50_));
  nand3  g21(.a(x11), .b(new_n50_), .c(x00), .O(new_n51_));
  inv1   g22(.a(new_n51_), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(new_n44_), .O(z08));
  nor2   g24(.a(new_n31_), .b(x03), .O(new_n54_));
  nand3  g25(.a(new_n35_), .b(new_n50_), .c(x00), .O(new_n55_));
  aoi22  g26(.a(new_n55_), .b(new_n31_), .c(new_n51_), .d(new_n54_), .O(z09));
  inv1   g27(.a(x00), .O(new_n57_));
  nor3   g28(.a(new_n38_), .b(x10), .c(new_n57_), .O(z10));
  nor2   g29(.a(x10), .b(new_n57_), .O(new_n59_));
  nand3  g30(.a(x12), .b(x09), .c(x01), .O(new_n60_));
  oai21  g31(.a(x12), .b(x01), .c(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n59_), .c(x11), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n44_), .O(z11));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(x11), .b(new_n50_), .c(new_n64_), .d(x00), .O(new_n65_));
