...
module FAU ( 
  ...
  aoi21  g14(.a(x13), .b(new_n43_), .c(x14), .O(z04));
  inv1   g15(.a(x13), .O(z05));
  nand2  g16(.a(x13), .b(new_n43_), .O(new_n46_));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  aoi21  g18(.a(x12), .b(new_n31_), .c(new_n47_), .O(new_n48_));
  nand2  g19(.a(x09), .b(x01), .O(new_n49_));
  oai21  g20(.a(new_n49_), .b(new_n48_), .c(new_n46_), .O(z06));
  ...
  aoi21  g30(.a(new_n59_), .b(new_n35_), .c(new_n58_), .O(z09));
  nand2  g31(.a(new_n47_), .b(x12), .O(new_n61_));
  nand4  g32(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n61_), .c(new_n46_), .O(z10));
  nand2  g34(.a(new_n32_), .b(new_n30_), .O(new_n64_));
  nand4  g35(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(z11));
  nor3   g37(.a(new_n58_), .b(new_n35_), .c(x09), .O(z12));
endmodule
