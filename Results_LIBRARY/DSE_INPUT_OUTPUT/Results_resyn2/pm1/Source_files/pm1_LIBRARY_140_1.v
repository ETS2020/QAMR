...
module FAU ( 
  ...
  nand4  g11(.a(new_n40_), .b(z01), .c(x09), .d(x01), .O(new_n41_));
  inv1   g12(.a(new_n41_), .O(z06));
  nand2  g13(.a(z01), .b(x15), .O(z07));
  inv1   g14(.a(x10), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x00), .O(new_n45_));
  nand2  g16(.a(x12), .b(x09), .O(new_n46_));
  nor2   g17(.a(new_n46_), .b(new_n40_), .O(new_n47_));
  oai21  g18(.a(new_n47_), .b(new_n45_), .c(x11), .O(new_n48_));
  ...
  nor2   g23(.a(new_n49_), .b(x11), .O(new_n53_));
  inv1   g24(.a(x00), .O(new_n54_));
  nor2   g25(.a(x10), .b(new_n54_), .O(new_n55_));
  nor2   g26(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n52_), .O(z09));
  nand2  g28(.a(x11), .b(x09), .O(new_n58_));
  nand2  g29(.a(new_n40_), .b(x12), .O(new_n59_));
  nor3   g30(.a(new_n59_), .b(new_n45_), .c(new_n58_), .O(z10));
  nand4  g31(.a(new_n40_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  aoi21  g32(.a(new_n52_), .b(new_n30_), .c(new_n53_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n61_), .c(new_n56_), .O(z11));
  inv1   g34(.a(x09), .O(new_n64_));
  nand2  g35(.a(new_n55_), .b(new_n64_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x11), .c(new_n49_), .O(z12));
endmodule
