...
module FAU ( 
  ...
  nand4  g10(.a(new_n39_), .b(new_n35_), .c(x11), .d(x00), .O(z03));
  ...
  aoi21  g30(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(z09));
  nand4  g31(.a(new_n44_), .b(x11), .c(new_n50_), .d(x09), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x00), .c(new_n58_), .O(z10));
  inv1   g33(.a(new_n32_), .O(new_n63_));
  nand4  g34(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(new_n63_), .c(new_n51_), .O(z11));
