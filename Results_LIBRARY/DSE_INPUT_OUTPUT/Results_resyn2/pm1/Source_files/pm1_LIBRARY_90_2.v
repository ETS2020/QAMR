...
module FAU ( 
  ...
  nand3  g06(.a(x13), .b(x12), .c(new_n35_), .O(z01));
  nand4  g07(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n37_));
  inv1   g08(.a(new_n37_), .O(new_n38_));
  nand3  g09(.a(x13), .b(x12), .c(x09), .O(new_n39_));
  ...
  nand3  g33(.a(new_n62_), .b(new_n60_), .c(new_n58_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n31_), .O(z09));
  nand4  g35(.a(new_n60_), .b(new_n50_), .c(x11), .d(x09), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x13), .c(new_n61_), .O(z10));
  nand4  g37(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  nor2   g38(.a(x12), .b(x01), .O(new_n68_));
  aoi21  g39(.a(new_n30_), .b(x12), .c(new_n68_), .O(new_n69_));
  aoi22  g40(.a(new_n69_), .b(new_n67_), .c(new_n55_), .d(new_n31_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand3  g42(.a(new_n60_), .b(x11), .c(new_n71_), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x13), .c(new_n61_), .O(z12));
endmodule
