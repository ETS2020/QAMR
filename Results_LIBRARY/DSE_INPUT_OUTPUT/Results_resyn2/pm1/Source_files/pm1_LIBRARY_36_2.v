...
module FAU ( 
  ...
  nand2  g13(.a(new_n34_), .b(x12), .O(new_n43_));
  ...
  nand2  g25(.a(new_n41_), .b(x09), .O(new_n55_));
  ...
  nand4  g31(.a(new_n58_), .b(new_n47_), .c(x11), .d(x09), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x13), .c(new_n32_), .O(z10));
  oai21  g33(.a(x12), .b(new_n30_), .c(new_n40_), .O(new_n63_));
  nand4  g34(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  aoi22  g35(.a(new_n64_), .b(new_n63_), .c(new_n53_), .d(new_n43_), .O(z11));
  nor3   g36(.a(new_n53_), .b(new_n40_), .c(x09), .O(z12));
endmodule
