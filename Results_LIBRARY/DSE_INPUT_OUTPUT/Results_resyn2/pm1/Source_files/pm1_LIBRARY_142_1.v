...
module FAU ( 
  ...
  inv1   g18(.a(new_n45_), .O(new_n49_));
  nand3  g19(.a(new_n49_), .b(x12), .c(x09), .O(new_n50_));
  ...
  nor2   g24(.a(new_n32_), .b(x11), .O(new_n55_));
  nor2   g25(.a(new_n52_), .b(new_n55_), .O(new_n56_));
  nor2   g26(.a(new_n56_), .b(new_n54_), .O(z09));
  nand3  g27(.a(new_n52_), .b(new_n45_), .c(x09), .O(new_n58_));
  aoi21  g28(.a(new_n58_), .b(x11), .c(new_n32_), .O(z10));
  nand4  g29(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  aoi21  g30(.a(new_n54_), .b(new_n30_), .c(new_n55_), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(new_n60_), .c(new_n56_), .O(z11));
  nand2  g32(.a(new_n52_), .b(new_n35_), .O(new_n63_));
