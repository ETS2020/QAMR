...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n35_, new_n37_, new_n38_, new_n42_,
  ...
  nand2  g23(.a(new_n43_), .b(new_n52_), .O(new_n53_));
  ...
  nand2  g28(.a(new_n57_), .b(z00), .O(z09));
  inv1   g29(.a(x00), .O(new_n59_));
  nand3  g30(.a(new_n54_), .b(new_n42_), .c(new_n52_), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n59_), .c(z00), .O(z10));
  nand3  g32(.a(new_n56_), .b(new_n45_), .c(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(x11), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n51_), .O(new_n64_));
  nor2   g35(.a(new_n45_), .b(new_n59_), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(new_n54_), .c(new_n42_), .d(new_n52_), .O(new_n66_));
