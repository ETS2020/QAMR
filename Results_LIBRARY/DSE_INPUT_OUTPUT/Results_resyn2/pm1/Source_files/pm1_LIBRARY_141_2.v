...
module FAU ( 
  ...
  oai21  g19(.a(new_n48_), .b(new_n47_), .c(new_n41_), .O(z06));
  ...
  aoi21  g28(.a(new_n57_), .b(new_n41_), .c(new_n33_), .O(z09));
  nand4  g29(.a(new_n46_), .b(new_n38_), .c(new_n51_), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z10));
  and2   g31(.a(x01), .b(x00), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n46_), .c(new_n38_), .d(new_n51_), .O(new_n62_));
