...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n37_, new_n41_, new_n42_, new_n43_,
    new_n44_, new_n47_, new_n49_, new_n50_;
  ...
  nand2  g17(.a(new_n32_), .b(new_n31_), .O(new_n49_));
  nand2  g18(.a(new_n47_), .b(x00), .O(new_n50_));
  oai21  g19(.a(new_n50_), .b(new_n49_), .c(new_n37_), .O(z09));
  nor2   g20(.a(z08), .b(x01), .O(z11));
  one    g21(.O(z02));
  one    g22(.O(z03));
  zero   g23(.O(z12));
endmodule
