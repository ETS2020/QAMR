...
module FAU ( 
  ...
  nor2   g09(.a(x12), .b(new_n38_), .O(new_n39_));
  nand3  g10(.a(z02), .b(x09), .c(x01), .O(new_n40_));
  aoi21  g11(.a(new_n39_), .b(new_n37_), .c(new_n40_), .O(z06));
  ...
  nand2  g16(.a(new_n45_), .b(z02), .O(z09));
