...
module FAU ( 
  ...
  aoi21  g28(.a(new_n57_), .b(new_n55_), .c(new_n54_), .O(z09));
  nand4  g29(.a(new_n44_), .b(new_n48_), .c(x09), .d(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x11), .c(new_n56_), .O(z10));
  nand2  g31(.a(new_n56_), .b(new_n30_), .O(new_n61_));
  nand4  g32(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n61_), .c(new_n49_), .O(z11));
  nor3   g34(.a(new_n55_), .b(new_n54_), .c(x09), .O(z12));
endmodule
