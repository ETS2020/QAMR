...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x03), .O(new_n36_));
  ...
  oai22  g27(.a(new_n56_), .b(new_n49_), .c(new_n55_), .d(new_n36_), .O(z08));
  inv1   g28(.a(new_n40_), .O(new_n58_));
  nand2  g29(.a(new_n53_), .b(x00), .O(new_n59_));
  aoi21  g30(.a(new_n58_), .b(new_n33_), .c(new_n59_), .O(z09));
  inv1   g31(.a(new_n49_), .O(new_n61_));
  nor3   g32(.a(new_n56_), .b(new_n54_), .c(new_n61_), .O(z10));
  inv1   g33(.a(x03), .O(new_n63_));
  oai21  g34(.a(new_n54_), .b(new_n48_), .c(x12), .O(new_n64_));
  ...
  oai21  g39(.a(new_n68_), .b(new_n56_), .c(new_n66_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n55_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n65_), .O(z11));
  inv1   g42(.a(x09), .O(new_n72_));
  nand2  g43(.a(new_n40_), .b(new_n72_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n59_), .c(new_n46_), .O(z12));
endmodule
