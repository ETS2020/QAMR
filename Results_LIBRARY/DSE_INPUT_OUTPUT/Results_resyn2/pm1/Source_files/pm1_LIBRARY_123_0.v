...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n40_,
  ...
  nor2   g08(.a(new_n31_), .b(x14), .O(z04));
  inv1   g09(.a(new_n31_), .O(new_n40_));
  nand2  g10(.a(new_n40_), .b(x13), .O(z05));
  nand4  g11(.a(x11), .b(x04), .c(x03), .d(x02), .O(new_n42_));
  nand4  g12(.a(new_n42_), .b(new_n40_), .c(x09), .d(x01), .O(new_n43_));
  inv1   g13(.a(new_n43_), .O(z06));
  nand2  g14(.a(new_n40_), .b(x15), .O(z07));
  inv1   g15(.a(x10), .O(new_n46_));
  and2   g16(.a(x12), .b(x09), .O(new_n47_));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n48_));
  inv1   g18(.a(new_n48_), .O(new_n49_));
  nand2  g19(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand4  g20(.a(new_n50_), .b(x11), .c(new_n46_), .d(x00), .O(z08));
  nand4  g21(.a(x12), .b(x11), .c(new_n46_), .d(x00), .O(new_n52_));
  inv1   g22(.a(new_n52_), .O(z09));
  inv1   g23(.a(x11), .O(new_n54_));
  nor2   g24(.a(new_n54_), .b(x10), .O(new_n55_));
  nand4  g25(.a(new_n55_), .b(new_n48_), .c(new_n47_), .d(x00), .O(new_n56_));
  inv1   g26(.a(new_n56_), .O(z10));
  inv1   g27(.a(x12), .O(new_n58_));
  ...
  nand4  g33(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n62_), .O(z11));
  oai21  g35(.a(new_n52_), .b(x09), .c(new_n40_), .O(z12));
  one    g36(.O(z00));
  buf    g37(.a(x11), .O(z01));
endmodule
