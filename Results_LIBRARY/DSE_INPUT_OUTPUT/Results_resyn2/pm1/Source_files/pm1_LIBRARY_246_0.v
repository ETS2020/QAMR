...
module FAU ( 
  ...
  aoi22  g15(.a(new_n45_), .b(x11), .c(new_n43_), .d(new_n41_), .O(z06));
  ...
  oai21  g22(.a(new_n49_), .b(new_n31_), .c(new_n52_), .O(z08));
  inv1   g23(.a(x12), .O(new_n54_));
  nor2   g24(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand2  g25(.a(new_n49_), .b(new_n55_), .O(new_n56_));
  nand2  g26(.a(new_n56_), .b(new_n41_), .O(z09));
  inv1   g27(.a(x09), .O(new_n58_));
  nor2   g28(.a(x10), .b(new_n58_), .O(new_n59_));
  nand4  g29(.a(new_n59_), .b(new_n44_), .c(new_n55_), .d(x00), .O(new_n60_));
  ...
  nand4  g37(.a(new_n67_), .b(new_n59_), .c(new_n44_), .d(new_n55_), .O(new_n68_));
  nand2  g38(.a(new_n68_), .b(new_n66_), .O(z11));
  oai21  g39(.a(new_n56_), .b(x09), .c(new_n41_), .O(z12));
  one    g40(.O(z00));
endmodule
