...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n37_, new_n38_,
    ...
    new_n52_, new_n53_, new_n54_, new_n57_, new_n59_, new_n60_, new_n62_;
  ...
  aoi21  g26(.a(new_n51_), .b(new_n43_), .c(new_n35_), .O(z09));
  ...
  nand3  g32(.a(x12), .b(x11), .c(new_n37_), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n51_), .O(z12));
endmodule
