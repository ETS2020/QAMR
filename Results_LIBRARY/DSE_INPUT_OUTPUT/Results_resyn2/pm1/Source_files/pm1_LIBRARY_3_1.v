...
module FAU ( 
  ...
  nand3  g08(.a(new_n35_), .b(x11), .c(x09), .O(new_n38_));
  nand2  g09(.a(new_n38_), .b(x12), .O(new_n39_));
  oai21  g10(.a(x13), .b(x12), .c(new_n39_), .O(z03));
  ...
  nand3  g31(.a(new_n54_), .b(new_n52_), .c(new_n45_), .O(new_n61_));
  ...
  nand4  g38(.a(new_n67_), .b(new_n54_), .c(new_n52_), .d(new_n45_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n66_), .O(z11));
  nand2  g40(.a(new_n56_), .b(x00), .O(new_n70_));
  nand3  g41(.a(x12), .b(x11), .c(new_n51_), .O(new_n71_));
