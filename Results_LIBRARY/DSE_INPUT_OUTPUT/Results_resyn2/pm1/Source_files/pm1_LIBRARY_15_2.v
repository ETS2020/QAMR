...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n40_, new_n41_, new_n42_, new_n43_, new_n46_, new_n48_, new_n49_,
  ...
  oai21  g21(.a(new_n50_), .b(new_n48_), .c(new_n35_), .O(z06));
  ...
  nand3  g28(.a(new_n57_), .b(new_n54_), .c(new_n35_), .O(z08));
  ...
  oai21  g34(.a(new_n63_), .b(new_n62_), .c(new_n35_), .O(z10));
  nand4  g35(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  inv1   g36(.a(x01), .O(new_n66_));
  nand3  g37(.a(new_n30_), .b(new_n40_), .c(new_n66_), .O(new_n67_));
  ...
  oai21  g42(.a(new_n71_), .b(new_n69_), .c(new_n35_), .O(z12));
endmodule
