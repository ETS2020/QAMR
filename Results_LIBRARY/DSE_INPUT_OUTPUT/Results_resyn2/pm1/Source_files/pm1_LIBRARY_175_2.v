...
module FAU ( 
  ...
  nand2  g05(.a(new_n30_), .b(x04), .O(new_n35_));
  ...
  nand3  g15(.a(x11), .b(x03), .c(x02), .O(new_n45_));
  ...
  oai21  g22(.a(new_n51_), .b(new_n33_), .c(new_n35_), .O(new_n52_));
  ...
  nand3  g30(.a(new_n53_), .b(new_n56_), .c(new_n41_), .O(new_n60_));
  ...
  nand4  g37(.a(new_n53_), .b(new_n56_), .c(new_n41_), .d(x01), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(z11));
  nand2  g39(.a(x12), .b(x11), .O(new_n69_));
  nor3   g40(.a(new_n51_), .b(new_n69_), .c(x09), .O(z12));
endmodule
