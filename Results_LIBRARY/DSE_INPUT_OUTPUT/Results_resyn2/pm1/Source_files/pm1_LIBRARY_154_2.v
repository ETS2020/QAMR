...
module FAU ( 
  ...
  nand2  g22(.a(new_n47_), .b(x09), .O(new_n52_));
  inv1   g23(.a(x00), .O(new_n53_));
  nor2   g24(.a(x10), .b(new_n53_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n52_), .c(x12), .d(x11), .O(z08));
  inv1   g26(.a(x10), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(x00), .O(new_n57_));
  nor3   g28(.a(new_n57_), .b(new_n35_), .c(new_n34_), .O(z09));
  nand3  g29(.a(new_n46_), .b(x11), .c(x09), .O(new_n59_));
  nor3   g30(.a(new_n59_), .b(new_n57_), .c(new_n31_), .O(z10));
  nand4  g31(.a(new_n48_), .b(new_n46_), .c(new_n56_), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n33_), .O(z11));
  nand3  g33(.a(new_n54_), .b(x12), .c(x11), .O(new_n63_));
