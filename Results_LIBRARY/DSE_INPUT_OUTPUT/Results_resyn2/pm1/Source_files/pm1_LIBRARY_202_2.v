...
module FAU ( 
  ...
  nand2  g12(.a(new_n37_), .b(x09), .O(new_n42_));
  ...
  aoi21  g29(.a(new_n58_), .b(new_n33_), .c(new_n35_), .O(z09));
  nand4  g30(.a(new_n48_), .b(new_n40_), .c(new_n53_), .d(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z10));
  and2   g32(.a(x01), .b(x00), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n48_), .c(new_n40_), .d(new_n53_), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(z11));
  inv1   g35(.a(x09), .O(new_n65_));
  nand3  g36(.a(new_n53_), .b(new_n65_), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n47_), .O(z12));
endmodule
