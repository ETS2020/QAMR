...
module FAU ( 
  ...
  nand2  g03(.a(new_n30_), .b(x07), .O(new_n33_));
  ...
  nor2   g11(.a(x12), .b(x07), .O(new_n41_));
  ...
  nand4  g29(.a(new_n58_), .b(new_n57_), .c(new_n53_), .d(x00), .O(new_n59_));
  ...
  nand3  g36(.a(new_n30_), .b(x07), .c(new_n65_), .O(new_n66_));
