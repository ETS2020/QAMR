...
module FAU ( 
  ...
  aoi21  g27(.a(new_n56_), .b(new_n44_), .c(new_n35_), .O(z09));
  nand3  g28(.a(new_n54_), .b(new_n46_), .c(new_n40_), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z10));
  inv1   g30(.a(x10), .O(new_n60_));
  nand4  g31(.a(new_n47_), .b(new_n46_), .c(new_n60_), .d(x00), .O(new_n61_));
