...
module FAU ( 
  ...
  nand2  g09(.a(new_n30_), .b(x10), .O(new_n39_));
  ...
  oai21  g15(.a(new_n44_), .b(new_n42_), .c(new_n39_), .O(z06));
  aoi21  g16(.a(new_n30_), .b(x10), .c(x15), .O(z07));
  ...
  aoi21  g24(.a(x12), .b(new_n47_), .c(new_n33_), .O(new_n54_));
  nand2  g25(.a(z01), .b(x00), .O(new_n55_));
  oai21  g26(.a(new_n55_), .b(new_n54_), .c(new_n39_), .O(z09));
  nand2  g27(.a(new_n43_), .b(x12), .O(new_n57_));
  inv1   g28(.a(new_n48_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n47_), .c(x09), .O(new_n59_));
  nor2   g30(.a(new_n59_), .b(new_n57_), .O(z10));
  inv1   g31(.a(x01), .O(new_n61_));
  aoi21  g32(.a(new_n43_), .b(x12), .c(new_n61_), .O(new_n62_));
  nand2  g33(.a(new_n42_), .b(x12), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(new_n58_), .c(new_n47_), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n62_), .O(z11));
  nand2  g36(.a(x12), .b(new_n47_), .O(new_n66_));
  nor3   g37(.a(new_n66_), .b(new_n48_), .c(x09), .O(z12));
endmodule
