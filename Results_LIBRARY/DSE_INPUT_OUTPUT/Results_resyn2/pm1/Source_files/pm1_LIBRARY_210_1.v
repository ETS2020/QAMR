...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n35_, new_n38_, new_n39_, new_n42_,
  ...
  nor2   g08(.a(new_n38_), .b(x11), .O(new_n39_));
  ...
  nand2  g15(.a(new_n42_), .b(x15), .O(z07));
  inv1   g16(.a(x10), .O(new_n47_));
  nand3  g17(.a(x11), .b(new_n47_), .c(x00), .O(new_n48_));
  inv1   g18(.a(new_n48_), .O(new_n49_));
  inv1   g19(.a(new_n43_), .O(new_n50_));
  nand3  g20(.a(new_n50_), .b(x12), .c(x09), .O(new_n51_));
  nand2  g21(.a(new_n51_), .b(new_n49_), .O(z08));
  nand2  g22(.a(new_n47_), .b(x00), .O(new_n53_));
  nor2   g23(.a(x12), .b(new_n31_), .O(new_n54_));
  aoi21  g24(.a(new_n53_), .b(new_n42_), .c(new_n54_), .O(z09));
  nand4  g25(.a(new_n43_), .b(new_n47_), .c(x09), .d(x00), .O(new_n56_));
  aoi21  g26(.a(new_n56_), .b(x11), .c(new_n38_), .O(z10));
  nand2  g27(.a(new_n38_), .b(new_n30_), .O(new_n58_));
  nand4  g28(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  aoi21  g29(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(z11));
  inv1   g30(.a(x09), .O(new_n61_));
  nand3  g31(.a(new_n47_), .b(new_n61_), .c(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(x11), .c(new_n38_), .O(z12));
  one    g33(.O(z01));
endmodule
