...
module FAU ( 
  ...
  aoi21  g14(.a(x12), .b(new_n31_), .c(new_n43_), .O(new_n44_));
  and2   g15(.a(x09), .b(x01), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n39_), .O(new_n46_));
  nor2   g17(.a(new_n46_), .b(new_n44_), .O(z06));
  ...
  nand2  g26(.a(new_n39_), .b(z01), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n55_), .O(z09));
  nand4  g28(.a(new_n43_), .b(new_n51_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n31_), .O(z10));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n52_), .O(z11));
