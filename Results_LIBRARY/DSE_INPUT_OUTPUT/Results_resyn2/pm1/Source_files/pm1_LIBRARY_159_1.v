...
module FAU ( 
  ...
  nand3  g07(.a(new_n31_), .b(x12), .c(new_n30_), .O(z01));
  ...
  nor3   g33(.a(new_n62_), .b(new_n55_), .c(new_n61_), .O(z10));
  ...
  nand3  g39(.a(x12), .b(x11), .c(new_n61_), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n68_), .O(z12));
endmodule
