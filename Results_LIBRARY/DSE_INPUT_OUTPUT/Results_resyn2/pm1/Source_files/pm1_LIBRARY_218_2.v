...
module FAU ( 
  ...
  nand4  g29(.a(x12), .b(x11), .c(new_n51_), .d(x00), .O(new_n59_));
  nand2  g30(.a(new_n46_), .b(x09), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n59_), .O(z10));
  nor3   g32(.a(new_n60_), .b(new_n59_), .c(new_n30_), .O(z11));
  nor2   g33(.a(new_n59_), .b(x09), .O(z12));
endmodule
