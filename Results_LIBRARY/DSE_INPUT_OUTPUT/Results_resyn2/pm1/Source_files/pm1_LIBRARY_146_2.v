...
module FAU ( 
  ...
  nand2  g06(.a(new_n32_), .b(x07), .O(new_n36_));
  and2   g07(.a(new_n36_), .b(new_n35_), .O(z01));
  ...
  nand2  g13(.a(new_n42_), .b(x07), .O(new_n43_));
  nor2   g14(.a(new_n32_), .b(new_n31_), .O(new_n44_));
  nand3  g15(.a(new_n44_), .b(new_n43_), .c(x09), .O(z03));
  aoi21  g16(.a(new_n32_), .b(x07), .c(x14), .O(z04));
  nand2  g17(.a(new_n36_), .b(x13), .O(z05));
  nand3  g18(.a(x04), .b(x03), .c(x02), .O(new_n48_));
  inv1   g19(.a(new_n48_), .O(new_n49_));
  nand3  g20(.a(new_n36_), .b(x09), .c(x01), .O(new_n50_));
  aoi21  g21(.a(new_n49_), .b(new_n35_), .c(new_n50_), .O(z06));
  nand2  g22(.a(new_n36_), .b(x15), .O(z07));
  ...
  nand3  g29(.a(new_n58_), .b(new_n55_), .c(new_n36_), .O(z08));
  inv1   g30(.a(new_n44_), .O(new_n60_));
  nand2  g31(.a(new_n56_), .b(x00), .O(new_n61_));
  aoi21  g32(.a(new_n60_), .b(new_n33_), .c(new_n61_), .O(z09));
  nand2  g33(.a(new_n54_), .b(new_n48_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n57_), .c(new_n36_), .O(z10));
  ...
  nand2  g41(.a(new_n44_), .b(new_n53_), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n61_), .c(new_n36_), .O(z12));
endmodule
