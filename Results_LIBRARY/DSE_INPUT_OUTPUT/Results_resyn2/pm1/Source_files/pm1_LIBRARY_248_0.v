...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n51_,
  ...
  aoi22  g19(.a(new_n48_), .b(z01), .c(new_n46_), .d(new_n44_), .O(z06));
  nand2  g20(.a(new_n44_), .b(x15), .O(z07));
  nand3  g21(.a(new_n48_), .b(x12), .c(x09), .O(new_n51_));
  ...
  nand4  g29(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n59_));
  nand2  g30(.a(x03), .b(x02), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(new_n43_), .O(new_n61_));
  aoi21  g32(.a(new_n59_), .b(x12), .c(new_n61_), .O(z10));
