...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n38_, new_n40_,
  ...
  oai21  g08(.a(new_n36_), .b(new_n33_), .c(x12), .O(new_n38_));
  ...
  oai21  g16(.a(new_n45_), .b(new_n33_), .c(x01), .O(new_n46_));
  aoi21  g17(.a(new_n46_), .b(x12), .c(new_n40_), .O(z06));
  nor2   g18(.a(new_n41_), .b(x15), .O(z07));
  nand2  g19(.a(new_n45_), .b(x12), .O(new_n49_));
  ...
  nand4  g25(.a(x12), .b(x11), .c(new_n51_), .d(x00), .O(new_n55_));
  nand4  g26(.a(new_n30_), .b(new_n33_), .c(new_n51_), .d(x00), .O(new_n56_));
  nand3  g27(.a(new_n56_), .b(new_n55_), .c(new_n43_), .O(z09));
  nand4  g28(.a(new_n45_), .b(x11), .c(new_n51_), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n40_), .O(z10));
  inv1   g30(.a(x01), .O(new_n60_));
  nand4  g31(.a(x11), .b(new_n51_), .c(new_n60_), .d(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n40_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n30_), .O(new_n63_));
  nand4  g34(.a(new_n53_), .b(new_n45_), .c(x09), .d(x01), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n63_), .O(z11));
  oai21  g36(.a(new_n55_), .b(x09), .c(new_n43_), .O(z12));
endmodule
