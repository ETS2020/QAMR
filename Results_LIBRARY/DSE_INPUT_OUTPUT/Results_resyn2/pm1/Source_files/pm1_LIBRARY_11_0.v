...
module FAU ( 
  ...
  oai21  g08(.a(x12), .b(new_n36_), .c(new_n37_), .O(z01));
  ...
  nand3  g13(.a(new_n40_), .b(new_n39_), .c(x09), .O(z03));
  aoi21  g14(.a(new_n32_), .b(new_n36_), .c(x14), .O(z04));
  nand2  g15(.a(new_n32_), .b(new_n36_), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(x13), .O(z05));
  nand2  g17(.a(x04), .b(x03), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(x02), .O(new_n48_));
  oai21  g19(.a(new_n30_), .b(new_n36_), .c(x12), .O(new_n49_));
  ...
  nand2  g30(.a(new_n53_), .b(x00), .O(new_n60_));
  nand3  g31(.a(new_n32_), .b(new_n30_), .c(x02), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n37_), .c(new_n60_), .O(z09));
  nand2  g33(.a(new_n56_), .b(x12), .O(new_n63_));
  nand4  g34(.a(x11), .b(new_n53_), .c(x09), .d(x00), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n63_), .O(z10));
  nand4  g36(.a(new_n56_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n33_), .c(new_n54_), .O(z11));
