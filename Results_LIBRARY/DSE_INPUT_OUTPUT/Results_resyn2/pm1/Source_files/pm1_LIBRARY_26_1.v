...
module FAU ( 
  ...
  nand3  g13(.a(new_n42_), .b(new_n41_), .c(z01), .O(new_n43_));
  ...
  inv1   g19(.a(new_n41_), .O(new_n49_));
  ...
  nand4  g25(.a(new_n41_), .b(new_n46_), .c(x09), .d(x00), .O(new_n55_));
  ...
  aoi21  g29(.a(new_n58_), .b(new_n57_), .c(new_n47_), .O(z11));
  inv1   g30(.a(x09), .O(new_n60_));
  nand3  g31(.a(x12), .b(x11), .c(new_n60_), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n52_), .O(z12));
endmodule
