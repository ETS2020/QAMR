...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n35_, new_n38_, new_n39_, new_n40_, new_n42_,
  ...
  inv1   g11(.a(new_n35_), .O(new_n42_));
  nand2  g12(.a(new_n42_), .b(x15), .O(z07));
  ...
  oai21  g17(.a(new_n39_), .b(new_n47_), .c(x11), .O(new_n48_));
  nand2  g18(.a(new_n48_), .b(x12), .O(new_n49_));
  nand2  g19(.a(new_n49_), .b(new_n46_), .O(z08));
  nand4  g20(.a(x12), .b(x11), .c(new_n44_), .d(x00), .O(new_n51_));
  inv1   g21(.a(new_n51_), .O(z09));
  nand2  g22(.a(x11), .b(x09), .O(new_n53_));
  nand2  g23(.a(new_n39_), .b(x12), .O(new_n54_));
  nor3   g24(.a(new_n54_), .b(new_n45_), .c(new_n53_), .O(z10));
  inv1   g25(.a(x01), .O(new_n56_));
  aoi21  g26(.a(new_n39_), .b(x12), .c(new_n56_), .O(new_n57_));
  nand2  g27(.a(new_n38_), .b(x12), .O(new_n58_));
  nand4  g28(.a(new_n58_), .b(x11), .c(new_n44_), .d(x00), .O(new_n59_));
  nor2   g29(.a(new_n59_), .b(new_n57_), .O(z11));
  oai21  g30(.a(new_n51_), .b(x09), .c(new_n42_), .O(z12));
  one    g31(.O(z00));
  buf    g32(.a(x11), .O(z01));
endmodule
