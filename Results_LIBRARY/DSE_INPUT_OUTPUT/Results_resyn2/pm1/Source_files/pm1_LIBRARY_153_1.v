...
module FAU ( 
  ...
  inv1   g18(.a(new_n42_), .O(new_n48_));
  ...
  nor2   g22(.a(new_n47_), .b(new_n34_), .O(new_n52_));
  nor2   g23(.a(new_n52_), .b(new_n51_), .O(z09));
  nand2  g24(.a(new_n42_), .b(x12), .O(new_n54_));
  nand3  g25(.a(new_n47_), .b(x11), .c(x09), .O(new_n55_));
  nor2   g26(.a(new_n55_), .b(new_n54_), .O(z10));
  nand4  g27(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  aoi21  g28(.a(new_n51_), .b(new_n30_), .c(new_n34_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n57_), .c(new_n52_), .O(z11));
  inv1   g30(.a(x09), .O(new_n60_));
  nand2  g31(.a(new_n47_), .b(new_n60_), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x11), .c(new_n33_), .O(z12));
endmodule
