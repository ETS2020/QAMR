// Benchmark "FAU" written by ABC on Tue Aug 11 19:15:09 2020
...
module FAU ( 
  ...
  nand4  g14(.a(new_n44_), .b(new_n42_), .c(x09), .d(x01), .O(new_n45_));
  ...
  inv1   g20(.a(new_n44_), .O(new_n51_));
  nand3  g21(.a(new_n51_), .b(x12), .c(x09), .O(new_n52_));
  nand2  g22(.a(new_n52_), .b(new_n50_), .O(z08));
  nand2  g23(.a(new_n48_), .b(x00), .O(new_n54_));
  nor2   g24(.a(x12), .b(new_n31_), .O(new_n55_));
  aoi21  g25(.a(new_n54_), .b(new_n42_), .c(new_n55_), .O(z09));
  inv1   g26(.a(x12), .O(new_n57_));
  nand4  g27(.a(new_n44_), .b(new_n48_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g28(.a(new_n58_), .b(x11), .c(new_n57_), .O(z10));
  nand2  g29(.a(new_n57_), .b(new_n30_), .O(new_n60_));
  nand4  g30(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(z11));
  nand3  g32(.a(new_n48_), .b(new_n34_), .c(x00), .O(new_n63_));
  aoi21  g33(.a(new_n63_), .b(x11), .c(new_n57_), .O(z12));
  one    g34(.O(z01));
endmodule
