...
module FAU ( 
  ...
  nand4  g07(.a(x12), .b(x11), .c(x09), .d(x04), .O(new_n37_));
  ...
  aoi22  g19(.a(new_n48_), .b(new_n46_), .c(new_n45_), .d(new_n42_), .O(z06));
  aoi21  g20(.a(x12), .b(new_n41_), .c(x15), .O(z07));
  ...
  nand3  g32(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(new_n62_));
  ...
  nand2  g38(.a(new_n45_), .b(x12), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(new_n60_), .c(x11), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n67_), .c(new_n42_), .O(z11));
  nand3  g41(.a(x12), .b(new_n51_), .c(x04), .O(new_n71_));
  nor2   g42(.a(new_n71_), .b(new_n56_), .O(z12));
endmodule
