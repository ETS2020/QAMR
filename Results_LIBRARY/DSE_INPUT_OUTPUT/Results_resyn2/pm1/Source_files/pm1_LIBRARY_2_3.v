...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n37_, new_n38_,
    ...
    new_n50_, new_n53_, new_n54_, new_n55_, new_n57_, new_n58_, new_n61_,
  ...
  nand4  g09(.a(x12), .b(x11), .c(new_n30_), .d(x09), .O(new_n39_));
  ...
  nor2   g15(.a(new_n32_), .b(x13), .O(z05));
  nand2  g16(.a(x09), .b(x01), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(x11), .c(new_n30_), .O(new_n47_));
  ...
  nand3  g23(.a(x11), .b(new_n30_), .c(x00), .O(new_n53_));
  inv1   g24(.a(new_n53_), .O(new_n54_));
  nand2  g25(.a(x12), .b(x09), .O(new_n55_));
  oai21  g26(.a(new_n55_), .b(new_n49_), .c(new_n54_), .O(z08));
  aoi21  g27(.a(new_n35_), .b(new_n30_), .c(x12), .O(new_n57_));
  oai21  g28(.a(new_n31_), .b(x11), .c(x00), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(new_n43_), .O(z09));
  nor3   g30(.a(new_n55_), .b(new_n53_), .c(new_n50_), .O(z10));
  and2   g31(.a(x11), .b(x00), .O(new_n61_));
  nand4  g32(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  inv1   g33(.a(x01), .O(new_n63_));
  nand3  g34(.a(new_n31_), .b(new_n30_), .c(new_n63_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n61_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n43_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand2  g39(.a(new_n61_), .b(new_n68_), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(new_n30_), .c(new_n31_), .O(z12));
endmodule
