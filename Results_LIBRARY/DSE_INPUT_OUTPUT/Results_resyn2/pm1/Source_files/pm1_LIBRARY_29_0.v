...
module FAU ( 
  ...
  inv1   g11(.a(new_n33_), .O(new_n42_));
  ...
  nor2   g17(.a(new_n33_), .b(x15), .O(z07));
  ...
  oai21  g22(.a(new_n45_), .b(new_n49_), .c(new_n52_), .O(z08));
  nand4  g23(.a(x12), .b(x11), .c(new_n50_), .d(x00), .O(new_n54_));
  nand2  g24(.a(new_n54_), .b(new_n42_), .O(z09));
  nand2  g25(.a(new_n45_), .b(x09), .O(new_n56_));
  oai21  g26(.a(new_n56_), .b(new_n54_), .c(new_n42_), .O(z10));
  inv1   g27(.a(x01), .O(new_n58_));
  aoi21  g28(.a(new_n45_), .b(x12), .c(new_n58_), .O(new_n59_));
  nand2  g29(.a(new_n44_), .b(x12), .O(new_n60_));
  nand4  g30(.a(new_n60_), .b(x11), .c(new_n50_), .d(x00), .O(new_n61_));
  nor2   g31(.a(new_n61_), .b(new_n59_), .O(z11));
  oai21  g32(.a(new_n54_), .b(x09), .c(new_n42_), .O(z12));
  one    g33(.O(z00));
endmodule
