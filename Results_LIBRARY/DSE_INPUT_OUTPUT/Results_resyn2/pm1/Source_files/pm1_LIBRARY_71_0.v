...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x08), .O(new_n36_));
  ...
  nor2   g18(.a(new_n36_), .b(x14), .O(z04));
  nor2   g19(.a(new_n36_), .b(x13), .O(z05));
  inv1   g20(.a(new_n36_), .O(new_n50_));
  ...
  nor2   g25(.a(new_n36_), .b(x15), .O(z07));
  ...
  nor2   g30(.a(new_n32_), .b(new_n45_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  oai21  g32(.a(new_n58_), .b(new_n36_), .c(new_n61_), .O(z08));
  nand2  g33(.a(new_n56_), .b(x00), .O(new_n63_));
  nand2  g34(.a(x12), .b(x11), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(new_n33_), .c(new_n63_), .O(z09));
  nand2  g36(.a(new_n60_), .b(new_n51_), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n57_), .c(new_n50_), .O(z10));
  nand4  g38(.a(x11), .b(new_n56_), .c(new_n30_), .d(x00), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(x08), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  nand4  g41(.a(new_n60_), .b(new_n58_), .c(new_n51_), .d(x01), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(z11));
  nand3  g43(.a(new_n56_), .b(new_n45_), .c(x00), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n64_), .c(new_n50_), .O(z12));
endmodule
