...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
  ...
  nand4  g08(.a(x14), .b(x12), .c(x11), .d(x09), .O(new_n38_));
  ...
  oai21  g15(.a(new_n44_), .b(x11), .c(x14), .O(new_n45_));
  ...
  aoi21  g22(.a(new_n51_), .b(x12), .c(x15), .O(z07));
  ...
  nand2  g34(.a(new_n63_), .b(new_n48_), .O(new_n64_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(new_n67_), .c(new_n57_), .O(z11));
