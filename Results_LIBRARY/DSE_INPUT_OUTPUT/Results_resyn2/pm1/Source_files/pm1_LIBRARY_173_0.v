...
module FAU ( 
  ...
  nand2  g08(.a(x14), .b(new_n30_), .O(new_n38_));
  ...
  nand4  g27(.a(new_n56_), .b(z01), .c(new_n50_), .d(x00), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n44_), .O(z09));
  inv1   g29(.a(x09), .O(new_n59_));
  nand2  g30(.a(new_n46_), .b(x12), .O(new_n60_));
  nor3   g31(.a(new_n60_), .b(new_n51_), .c(new_n59_), .O(z10));
  ...
  aoi21  g35(.a(new_n64_), .b(new_n62_), .c(new_n51_), .O(z11));
  nand2  g36(.a(new_n50_), .b(x00), .O(new_n66_));
  nand3  g37(.a(x12), .b(x11), .c(new_n59_), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(z12));
endmodule
