...
module FAU ( 
  ...
  nand2  g03(.a(z07), .b(x13), .O(new_n33_));
  ...
  nand2  g15(.a(x15), .b(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  aoi21  g17(.a(x12), .b(new_n35_), .c(new_n46_), .O(new_n47_));
  nand3  g18(.a(new_n33_), .b(x09), .c(x01), .O(new_n48_));
  ...
  nand3  g31(.a(new_n46_), .b(x12), .c(x09), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n51_), .c(new_n33_), .O(z10));
  aoi21  g33(.a(new_n46_), .b(x12), .c(new_n30_), .O(new_n63_));
