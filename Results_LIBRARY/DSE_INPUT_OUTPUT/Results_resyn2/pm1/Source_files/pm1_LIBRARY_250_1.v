...
module FAU ( 
  ...
  nor2   g09(.a(new_n39_), .b(x11), .O(new_n40_));
  ...
  nor2   g23(.a(new_n51_), .b(new_n40_), .O(new_n54_));
  nor2   g24(.a(new_n54_), .b(new_n53_), .O(z09));
  nand3  g25(.a(new_n51_), .b(new_n44_), .c(x09), .O(new_n56_));
  aoi21  g26(.a(new_n56_), .b(x11), .c(new_n39_), .O(z10));
  ...
  nand2  g30(.a(new_n51_), .b(new_n34_), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(x11), .c(new_n39_), .O(z12));
  one    g32(.O(z01));
endmodule
