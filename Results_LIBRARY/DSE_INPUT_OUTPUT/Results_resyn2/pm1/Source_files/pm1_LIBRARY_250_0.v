...
module FAU ( 
  ...
  nor2   g20(.a(new_n32_), .b(x10), .O(new_n50_));
  nand3  g21(.a(new_n50_), .b(new_n49_), .c(x00), .O(z08));
  inv1   g22(.a(x10), .O(new_n52_));
  nand4  g23(.a(x12), .b(x11), .c(new_n52_), .d(x00), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(z00), .O(z09));
  inv1   g25(.a(x00), .O(new_n55_));
  nand3  g26(.a(new_n50_), .b(new_n48_), .c(new_n46_), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(new_n55_), .c(z00), .O(z10));
  inv1   g28(.a(x12), .O(new_n58_));
  inv1   g29(.a(x01), .O(new_n59_));
  nand3  g30(.a(new_n52_), .b(new_n59_), .c(x00), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(x11), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nor2   g33(.a(new_n59_), .b(new_n55_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n50_), .c(new_n48_), .d(new_n46_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n62_), .O(z11));
  oai21  g36(.a(new_n53_), .b(x09), .c(z00), .O(z12));
endmodule
