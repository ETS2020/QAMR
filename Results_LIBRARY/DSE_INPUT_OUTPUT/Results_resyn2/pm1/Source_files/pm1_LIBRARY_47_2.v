...
module FAU ( 
  ...
  oai21  g12(.a(new_n37_), .b(new_n41_), .c(x12), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(x11), .O(z03));
  nand2  g14(.a(new_n32_), .b(x11), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x14), .O(z04));
  aoi21  g16(.a(new_n32_), .b(x11), .c(x13), .O(z05));
  and2   g17(.a(x09), .b(x01), .O(new_n47_));
  nand3  g18(.a(x04), .b(x03), .c(x02), .O(new_n48_));
  oai21  g19(.a(new_n48_), .b(new_n34_), .c(new_n47_), .O(new_n49_));
  ...
  aoi21  g28(.a(new_n55_), .b(new_n44_), .c(new_n34_), .O(z09));
  nand4  g29(.a(new_n48_), .b(new_n39_), .c(new_n54_), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z10));
  nand4  g31(.a(new_n48_), .b(new_n47_), .c(new_n54_), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n31_), .O(z11));
  nand3  g33(.a(x12), .b(x11), .c(new_n41_), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n55_), .O(z12));
endmodule
