...
module FAU ( 
  ...
  nor2   g20(.a(new_n49_), .b(new_n43_), .O(new_n50_));
  oai21  g21(.a(new_n50_), .b(new_n48_), .c(x11), .O(new_n51_));
  nand2  g22(.a(new_n33_), .b(new_n31_), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(new_n51_), .O(z08));
  nand2  g24(.a(x12), .b(x11), .O(new_n54_));
  aoi21  g25(.a(new_n52_), .b(new_n54_), .c(new_n48_), .O(z09));
  inv1   g26(.a(x00), .O(new_n56_));
  nor2   g27(.a(x10), .b(new_n56_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(new_n43_), .c(x09), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x11), .c(new_n33_), .O(z10));
  nand4  g30(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  nand3  g31(.a(new_n33_), .b(x11), .c(new_n30_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(z01), .O(z11));
  nor3   g35(.a(new_n48_), .b(new_n54_), .c(x09), .O(z12));
endmodule
