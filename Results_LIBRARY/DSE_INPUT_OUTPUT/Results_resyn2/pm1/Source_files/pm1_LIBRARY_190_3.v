...
module FAU ( 
  ...
  nand4  g12(.a(new_n41_), .b(new_n36_), .c(x11), .d(new_n35_), .O(z03));
  ...
  oai21  g23(.a(new_n47_), .b(new_n40_), .c(new_n52_), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n35_), .O(new_n54_));
  nand2  g25(.a(new_n32_), .b(x10), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n54_), .O(z08));
  aoi21  g27(.a(new_n31_), .b(new_n35_), .c(x12), .O(new_n57_));
  oai21  g28(.a(new_n32_), .b(x11), .c(x00), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(new_n43_), .O(z09));
  nand2  g30(.a(new_n47_), .b(x12), .O(new_n60_));
  nand3  g31(.a(new_n52_), .b(new_n35_), .c(x09), .O(new_n61_));
  ...
  nand2  g36(.a(new_n65_), .b(new_n52_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n43_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand2  g39(.a(new_n52_), .b(new_n68_), .O(new_n69_));
