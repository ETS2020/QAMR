...
module FAU ( 
  ...
  nor2   g12(.a(new_n32_), .b(new_n37_), .O(new_n42_));
  ...
  oai21  g19(.a(new_n48_), .b(new_n46_), .c(new_n45_), .O(z06));
  ...
  nand2  g24(.a(new_n53_), .b(new_n45_), .O(z08));
  nand2  g25(.a(new_n52_), .b(new_n37_), .O(new_n55_));
  ...
  aoi21  g30(.a(new_n59_), .b(new_n37_), .c(new_n32_), .O(z10));
  nand2  g31(.a(new_n46_), .b(x12), .O(new_n61_));
  nand2  g32(.a(new_n32_), .b(x01), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n61_), .c(new_n53_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n45_), .O(z11));
