...
module FAU ( 
  ...
  nor2   g05(.a(x12), .b(x08), .O(new_n35_));
  nand3  g06(.a(x12), .b(x08), .c(x07), .O(new_n36_));
  nand4  g07(.a(x11), .b(x09), .c(x06), .d(x05), .O(new_n37_));
  ...
  nand3  g29(.a(new_n58_), .b(new_n55_), .c(new_n46_), .O(z08));
  ...
  nand2  g33(.a(new_n54_), .b(new_n49_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n57_), .c(new_n46_), .O(z10));
  ...
  nand4  g39(.a(new_n58_), .b(new_n54_), .c(new_n49_), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n68_), .O(z11));
  nor3   g41(.a(new_n57_), .b(new_n30_), .c(x09), .O(z12));
endmodule
