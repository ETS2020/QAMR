...
module FAU ( 
  ...
  nand3  g25(.a(new_n54_), .b(new_n51_), .c(new_n41_), .O(z08));
  nand2  g26(.a(new_n52_), .b(x00), .O(new_n56_));
  inv1   g27(.a(x11), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n34_), .c(x12), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n56_), .c(new_n33_), .O(z09));
  nand2  g30(.a(new_n50_), .b(new_n44_), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n53_), .O(z10));
  inv1   g32(.a(x01), .O(new_n62_));
  nand4  g33(.a(x11), .b(new_n52_), .c(new_n62_), .d(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n34_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n30_), .O(new_n65_));
  nand4  g36(.a(new_n54_), .b(new_n50_), .c(new_n44_), .d(x01), .O(new_n66_));
