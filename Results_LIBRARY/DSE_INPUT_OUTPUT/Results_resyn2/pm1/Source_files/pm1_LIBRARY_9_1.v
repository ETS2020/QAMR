...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n39_, new_n41_,
  ...
  aoi21  g24(.a(new_n53_), .b(new_n41_), .c(new_n54_), .O(z09));
  ...
  nand2  g31(.a(x12), .b(new_n61_), .O(new_n62_));
  nor2   g32(.a(new_n62_), .b(new_n48_), .O(z12));
  one    g33(.O(z01));
endmodule
