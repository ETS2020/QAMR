...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n41_, new_n42_, new_n43_, new_n46_, new_n47_, new_n48_, new_n51_,
  ...
  nand4  g24(.a(x12), .b(x04), .c(x03), .d(x02), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(new_n53_), .c(new_n43_), .O(z08));
  nand2  g26(.a(new_n51_), .b(x00), .O(new_n56_));
  nand2  g27(.a(new_n32_), .b(new_n31_), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n37_), .c(new_n56_), .O(z09));
  nand3  g29(.a(new_n46_), .b(x12), .c(x09), .O(new_n59_));
  nor2   g30(.a(new_n59_), .b(new_n52_), .O(z10));
  nand4  g31(.a(new_n54_), .b(x11), .c(new_n51_), .d(x00), .O(new_n61_));
  xor2a  g32(.a(x12), .b(x01), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z11));
  zero   g34(.O(z12));
endmodule
