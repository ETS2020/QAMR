...
module FAU ( 
  ...
  nand2  g14(.a(new_n38_), .b(x04), .O(new_n44_));
  ...
  oai21  g20(.a(new_n47_), .b(new_n34_), .c(new_n49_), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(new_n44_), .O(z06));
  aoi21  g22(.a(new_n38_), .b(x04), .c(x15), .O(z07));
  ...
  nor2   g29(.a(new_n39_), .b(new_n32_), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(z09));
  nor2   g31(.a(x10), .b(new_n48_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n47_), .c(new_n39_), .d(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  nand4  g34(.a(x11), .b(new_n53_), .c(new_n30_), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n31_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n38_), .O(new_n66_));
  and2   g37(.a(x01), .b(x00), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n61_), .c(new_n47_), .d(new_n39_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n66_), .O(z11));
  nand2  g40(.a(new_n39_), .b(new_n48_), .O(new_n70_));
