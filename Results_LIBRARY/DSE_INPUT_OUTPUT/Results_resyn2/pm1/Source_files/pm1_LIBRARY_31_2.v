...
module FAU ( 
  ...
  and2   g07(.a(x13), .b(x12), .O(new_n37_));
  ...
  aoi21  g14(.a(z05), .b(x12), .c(x14), .O(z04));
  ...
  oai21  g22(.a(x13), .b(new_n32_), .c(x15), .O(z07));
  ...
  nand2  g30(.a(x12), .b(new_n31_), .O(new_n60_));
  oai21  g31(.a(z05), .b(new_n32_), .c(x11), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n56_), .d(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z09));
  nand4  g34(.a(new_n49_), .b(new_n38_), .c(new_n56_), .d(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x13), .c(new_n32_), .O(z10));
  nand3  g36(.a(new_n49_), .b(new_n48_), .c(new_n37_), .O(new_n66_));
  ...
  aoi21  g41(.a(new_n70_), .b(x13), .c(new_n32_), .O(z12));
endmodule
