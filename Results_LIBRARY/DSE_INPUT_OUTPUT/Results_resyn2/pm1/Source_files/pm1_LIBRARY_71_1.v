...
module FAU ( 
  ...
  inv1   g23(.a(new_n43_), .O(new_n53_));
  ...
  nand4  g28(.a(new_n50_), .b(x12), .c(x09), .d(x08), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n57_), .O(z08));
  nand2  g30(.a(new_n32_), .b(x11), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n55_), .c(z01), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z09));
  nand4  g33(.a(new_n55_), .b(new_n49_), .c(x11), .d(x09), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x08), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nor2   g36(.a(x12), .b(x01), .O(new_n66_));
  aoi21  g37(.a(x12), .b(new_n34_), .c(new_n66_), .O(new_n67_));
  aoi22  g38(.a(new_n67_), .b(new_n65_), .c(new_n56_), .d(new_n53_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand3  g40(.a(new_n55_), .b(x11), .c(new_n69_), .O(new_n70_));
