...
module FAU ( 
  ...
  and2   g27(.a(x12), .b(x09), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  oai21  g29(.a(new_n55_), .b(new_n35_), .c(new_n58_), .O(z08));
  nand2  g30(.a(new_n53_), .b(x00), .O(new_n60_));
  nor2   g31(.a(new_n40_), .b(new_n32_), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(z09));
  nand2  g33(.a(new_n57_), .b(new_n48_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n54_), .c(new_n45_), .O(z10));
  ...
  nand4  g39(.a(new_n57_), .b(new_n55_), .c(new_n48_), .d(x01), .O(new_n69_));
