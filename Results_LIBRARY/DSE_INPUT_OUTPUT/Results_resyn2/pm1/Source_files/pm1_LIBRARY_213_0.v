...
module FAU ( 
  ...
  nand2  g10(.a(z05), .b(new_n30_), .O(new_n40_));
  ...
  nand2  g26(.a(new_n55_), .b(new_n40_), .O(z09));
  nand2  g27(.a(new_n42_), .b(x12), .O(new_n57_));
  nand4  g28(.a(x11), .b(new_n48_), .c(x09), .d(x00), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(new_n40_), .O(z10));
  nand4  g30(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  inv1   g31(.a(x01), .O(new_n61_));
  nand3  g32(.a(x13), .b(new_n30_), .c(new_n61_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n60_), .c(new_n49_), .O(z11));
  nand2  g34(.a(new_n48_), .b(x00), .O(new_n64_));
  inv1   g35(.a(x09), .O(new_n65_));
  nand3  g36(.a(x12), .b(x11), .c(new_n65_), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n64_), .c(new_n40_), .O(z12));
endmodule
