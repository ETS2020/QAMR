...
module FAU ( 
  ...
  oai21  g19(.a(new_n48_), .b(new_n46_), .c(new_n42_), .O(z06));
  ...
  nor2   g29(.a(new_n58_), .b(new_n57_), .O(z09));
  nand4  g30(.a(new_n47_), .b(new_n53_), .c(x09), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(new_n33_), .O(z10));
  nand3  g32(.a(new_n47_), .b(x09), .c(x01), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n54_), .O(z11));
  nand3  g34(.a(new_n53_), .b(new_n35_), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x12), .c(new_n33_), .O(z12));
endmodule
