...
module FAU ( 
  ...
  aoi21  g26(.a(new_n55_), .b(new_n43_), .c(new_n34_), .O(z09));
  inv1   g27(.a(x10), .O(new_n57_));
  nand4  g28(.a(new_n46_), .b(new_n57_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n31_), .O(z10));
  and2   g30(.a(x01), .b(x00), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n46_), .c(new_n57_), .d(x09), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n31_), .O(z11));
  nand2  g33(.a(new_n53_), .b(new_n36_), .O(new_n63_));
