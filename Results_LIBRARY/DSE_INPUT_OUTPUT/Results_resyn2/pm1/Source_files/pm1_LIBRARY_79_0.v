...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_,
  ...
  nor2   g14(.a(x14), .b(new_n43_), .O(z04));
  inv1   g15(.a(x14), .O(new_n45_));
  aoi21  g16(.a(new_n45_), .b(new_n43_), .c(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  nand2  g19(.a(new_n45_), .b(new_n43_), .O(new_n49_));
  ...
  nor2   g27(.a(new_n38_), .b(new_n31_), .O(new_n57_));
  ...
  nand2  g36(.a(new_n65_), .b(new_n43_), .O(new_n66_));
  ...
  nor3   g40(.a(new_n59_), .b(new_n37_), .c(x09), .O(z12));
endmodule
