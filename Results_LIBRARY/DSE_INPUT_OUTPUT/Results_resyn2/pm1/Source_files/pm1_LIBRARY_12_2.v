...
module FAU ( 
  ...
  nand2  g25(.a(new_n40_), .b(z01), .O(new_n55_));
  ...
  nand4  g30(.a(x12), .b(x11), .c(x09), .d(x01), .O(new_n60_));
  nor3   g31(.a(new_n60_), .b(new_n54_), .c(new_n59_), .O(z11));
  nand3  g32(.a(x12), .b(x11), .c(new_n35_), .O(new_n62_));
