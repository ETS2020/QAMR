...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n37_, new_n38_,
    ...
    new_n52_, new_n53_, new_n55_, new_n56_, new_n58_, new_n61_, new_n62_;
  ...
  oai21  g06(.a(new_n31_), .b(x01), .c(new_n35_), .O(z01));
  ...
  oai21  g17(.a(new_n46_), .b(x12), .c(x09), .O(new_n47_));
  aoi21  g18(.a(new_n47_), .b(new_n31_), .c(new_n30_), .O(z06));
  nor2   g19(.a(new_n32_), .b(x15), .O(z07));
  or2    g20(.a(new_n46_), .b(new_n38_), .O(new_n50_));
  inv1   g21(.a(x10), .O(new_n51_));
  nand4  g22(.a(x11), .b(new_n51_), .c(new_n30_), .d(x00), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n50_), .O(z08));
  nand2  g25(.a(new_n51_), .b(x00), .O(new_n55_));
  nand3  g26(.a(x12), .b(x11), .c(new_n30_), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n35_), .c(new_n55_), .O(z09));
  nand3  g28(.a(new_n46_), .b(x12), .c(x09), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n52_), .O(z10));
  nor2   g30(.a(new_n52_), .b(x12), .O(z11));
  inv1   g31(.a(x09), .O(new_n61_));
  nand4  g32(.a(x12), .b(new_n51_), .c(new_n61_), .d(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n30_), .c(new_n31_), .O(z12));
endmodule
