...
module FAU ( 
  ...
  nand2  g06(.a(new_n35_), .b(new_n33_), .O(z01));
  ...
  nand2  g12(.a(new_n41_), .b(new_n35_), .O(z03));
  ...
  aoi21  g20(.a(x12), .b(new_n48_), .c(new_n49_), .O(new_n50_));
  oai21  g21(.a(new_n50_), .b(new_n47_), .c(new_n43_), .O(z06));
  ...
  nand2  g30(.a(new_n34_), .b(new_n48_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n33_), .c(new_n59_), .O(z09));
  nand2  g32(.a(new_n49_), .b(x12), .O(new_n62_));
  nand4  g33(.a(x11), .b(new_n55_), .c(x09), .d(x00), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n62_), .c(new_n43_), .O(z10));
  nand4  g35(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  inv1   g36(.a(x01), .O(new_n66_));
  nand2  g37(.a(new_n34_), .b(new_n66_), .O(new_n67_));
