...
module FAU ( 
  ...
  oai21  g21(.a(new_n47_), .b(new_n32_), .c(new_n50_), .O(z08));
  ...
  nand4  g29(.a(new_n58_), .b(new_n56_), .c(new_n53_), .d(x00), .O(new_n59_));
  ...
  nand2  g35(.a(new_n64_), .b(new_n52_), .O(new_n65_));
  nor2   g36(.a(new_n61_), .b(new_n46_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(new_n58_), .c(new_n56_), .d(new_n53_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n65_), .O(z11));
  oai21  g39(.a(new_n54_), .b(x09), .c(z00), .O(z12));
endmodule
