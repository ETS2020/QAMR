...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n52_, new_n53_, new_n54_, new_n56_, new_n58_, new_n60_;
  ...
  nand2  g19(.a(new_n34_), .b(x15), .O(z07));
  ...
  nand4  g28(.a(new_n44_), .b(new_n50_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n31_), .O(z10));
  nand2  g30(.a(new_n46_), .b(new_n44_), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(new_n51_), .O(z11));
