...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n40_, new_n41_, new_n43_, new_n47_, new_n48_, new_n49_, new_n52_,
  ...
  oai21  g22(.a(new_n31_), .b(x10), .c(new_n32_), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(x00), .O(z08));
  inv1   g24(.a(x10), .O(new_n54_));
  nand2  g25(.a(new_n31_), .b(new_n54_), .O(new_n55_));
  aoi21  g26(.a(new_n55_), .b(new_n32_), .c(new_n39_), .O(z09));
  nand3  g27(.a(x11), .b(new_n54_), .c(new_n30_), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n32_), .c(new_n39_), .O(z11));
  zero   g29(.O(z12));
endmodule
