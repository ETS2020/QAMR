...
module FAU ( 
  ...
  aoi21  g26(.a(new_n56_), .b(new_n53_), .c(new_n55_), .O(z09));
  nand3  g27(.a(new_n51_), .b(new_n44_), .c(x09), .O(new_n58_));
  ...
  nand2  g32(.a(new_n62_), .b(new_n51_), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n41_), .O(z11));
  nor3   g34(.a(new_n55_), .b(new_n53_), .c(x09), .O(z12));
  one    g35(.O(z01));
endmodule
