...
module FAU ( 
  ...
  nand2  g10(.a(x13), .b(new_n32_), .O(new_n40_));
  ...
  nor2   g15(.a(x13), .b(new_n32_), .O(z05));
  ...
  oai21  g29(.a(new_n54_), .b(new_n35_), .c(new_n58_), .O(z08));
  ...
  oai21  g34(.a(new_n63_), .b(new_n53_), .c(new_n46_), .O(z10));
  ...
  nand4  g38(.a(new_n57_), .b(new_n54_), .c(new_n47_), .d(x01), .O(new_n68_));
