...
module FAU ( 
  ...
  nand4  g08(.a(z04), .b(x12), .c(x11), .d(x09), .O(new_n38_));
  ...
  aoi21  g17(.a(new_n44_), .b(z01), .c(new_n46_), .O(z06));
  nand2  g18(.a(new_n45_), .b(x15), .O(z07));
  aoi21  g19(.a(new_n44_), .b(x09), .c(x14), .O(new_n49_));
  inv1   g20(.a(x10), .O(new_n50_));
  nand3  g21(.a(x11), .b(new_n50_), .c(x00), .O(new_n51_));
  inv1   g22(.a(new_n51_), .O(new_n52_));
  oai21  g23(.a(new_n49_), .b(new_n32_), .c(new_n52_), .O(z08));
  ...
  nand3  g28(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n45_), .O(z09));
  nand4  g30(.a(new_n56_), .b(new_n43_), .c(x11), .d(x09), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(z04), .c(new_n32_), .O(z10));
  nand3  g32(.a(x12), .b(x09), .c(x01), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nor2   g34(.a(x12), .b(x01), .O(new_n64_));
  aoi21  g35(.a(new_n63_), .b(new_n43_), .c(new_n64_), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n51_), .c(new_n45_), .O(z11));
  nand2  g37(.a(z04), .b(x12), .O(new_n67_));
  nor3   g38(.a(new_n51_), .b(new_n67_), .c(x09), .O(z12));
endmodule
