...
module FAU ( 
  ...
  aoi21  g15(.a(new_n33_), .b(x04), .c(x13), .O(z05));
  nand3  g16(.a(x11), .b(x03), .c(x02), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x12), .O(new_n47_));
  nand2  g18(.a(x09), .b(x01), .O(new_n48_));
  aoi21  g19(.a(new_n47_), .b(x04), .c(new_n48_), .O(z06));
  ...
  nand3  g29(.a(new_n32_), .b(new_n54_), .c(x00), .O(new_n59_));
  aoi22  g30(.a(new_n59_), .b(new_n58_), .c(new_n55_), .d(x12), .O(z09));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n40_), .c(new_n54_), .d(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  nand3  g34(.a(new_n33_), .b(new_n31_), .c(new_n30_), .O(new_n64_));
  nand3  g35(.a(x12), .b(x09), .c(x01), .O(new_n65_));
  nand4  g36(.a(new_n61_), .b(x11), .c(new_n54_), .d(x00), .O(new_n66_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z11));
  nand2  g38(.a(new_n54_), .b(x00), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n35_), .c(x09), .O(z12));
endmodule
