...
module FAU ( 
  ...
  oai21  g26(.a(new_n55_), .b(new_n46_), .c(new_n54_), .O(z08));
  inv1   g27(.a(x12), .O(new_n57_));
  and2   g28(.a(x12), .b(x05), .O(new_n58_));
  nand3  g29(.a(new_n30_), .b(new_n52_), .c(x00), .O(new_n59_));
  aoi22  g30(.a(new_n59_), .b(new_n57_), .c(new_n58_), .d(new_n53_), .O(z09));
  inv1   g31(.a(new_n46_), .O(new_n61_));
  nor3   g32(.a(new_n55_), .b(new_n53_), .c(new_n61_), .O(z10));
  inv1   g33(.a(new_n34_), .O(new_n63_));
  nand3  g34(.a(new_n58_), .b(new_n48_), .c(new_n46_), .O(new_n64_));
  ...
  aoi21  g38(.a(new_n67_), .b(x05), .c(new_n57_), .O(z12));
endmodule
