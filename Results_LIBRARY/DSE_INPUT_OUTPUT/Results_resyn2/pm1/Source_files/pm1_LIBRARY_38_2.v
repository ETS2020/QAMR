...
module FAU ( 
  ...
  nand2  g23(.a(new_n48_), .b(x09), .O(new_n53_));
  ...
  nand3  g30(.a(new_n47_), .b(x11), .c(x09), .O(new_n60_));
  nor3   g31(.a(new_n60_), .b(new_n58_), .c(new_n31_), .O(z10));
  nand4  g32(.a(new_n49_), .b(new_n47_), .c(new_n57_), .d(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x12), .c(new_n33_), .O(z11));
  nand3  g34(.a(new_n55_), .b(x12), .c(x11), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(x09), .O(z12));
endmodule
