...
module FAU ( 
  ...
  nand2  g25(.a(new_n47_), .b(x09), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(x12), .d(x11), .O(z08));
  nor3   g27(.a(new_n53_), .b(new_n35_), .c(new_n34_), .O(z09));
  nand4  g28(.a(new_n46_), .b(new_n52_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g30(.a(new_n48_), .b(new_n46_), .c(new_n52_), .d(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x12), .c(new_n33_), .O(z11));
