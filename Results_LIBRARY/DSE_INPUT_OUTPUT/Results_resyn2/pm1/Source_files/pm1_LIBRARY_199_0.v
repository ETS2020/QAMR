...
module FAU ( 
  ...
  aoi21  g22(.a(new_n51_), .b(x12), .c(x09), .O(z12));
  aoi21  g23(.a(new_n46_), .b(x12), .c(new_n51_), .O(new_n53_));
  nor2   g24(.a(new_n53_), .b(z12), .O(z08));
  inv1   g25(.a(x00), .O(new_n55_));
  nor2   g26(.a(x10), .b(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n32_), .b(x11), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(new_n56_), .c(z01), .O(new_n58_));
  ...
  nand3  g34(.a(new_n45_), .b(x12), .c(x01), .O(new_n64_));
