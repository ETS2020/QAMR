...
module FAU ( 
  ...
  aoi21  g25(.a(new_n55_), .b(new_n54_), .c(new_n49_), .O(z09));
  nand2  g26(.a(new_n44_), .b(x12), .O(new_n57_));
  nand3  g27(.a(new_n50_), .b(x11), .c(x09), .O(new_n58_));
  ...
  nand2  g33(.a(new_n63_), .b(new_n41_), .O(z11));
  nor3   g34(.a(new_n49_), .b(new_n54_), .c(x09), .O(z12));
  one    g35(.O(z01));
endmodule
