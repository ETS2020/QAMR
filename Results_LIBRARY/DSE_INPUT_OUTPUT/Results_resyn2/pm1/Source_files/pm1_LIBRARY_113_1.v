...
module FAU ( 
  ...
  nand2  g05(.a(x11), .b(x08), .O(new_n35_));
  nand2  g06(.a(new_n35_), .b(x12), .O(z01));
  nand3  g07(.a(x07), .b(x06), .c(x05), .O(new_n37_));
  inv1   g08(.a(new_n37_), .O(new_n38_));
  nand4  g09(.a(x12), .b(x11), .c(x09), .d(x08), .O(new_n39_));
  ...
  oai21  g24(.a(new_n49_), .b(new_n53_), .c(x08), .O(new_n54_));
  ...
  aoi21  g33(.a(new_n62_), .b(x08), .c(new_n31_), .O(z10));
  nand2  g34(.a(new_n57_), .b(x11), .O(new_n64_));
  nand3  g35(.a(x12), .b(x09), .c(x01), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n49_), .c(new_n33_), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n64_), .c(new_n43_), .O(z11));
  nand3  g39(.a(x12), .b(new_n53_), .c(x08), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n64_), .O(z12));
endmodule
