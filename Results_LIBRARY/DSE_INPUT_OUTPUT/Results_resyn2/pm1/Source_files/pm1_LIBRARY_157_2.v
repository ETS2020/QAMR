...
module FAU ( 
  ...
  nand4  g26(.a(new_n55_), .b(new_n53_), .c(x12), .d(x11), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x00), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n35_), .c(new_n34_), .O(z09));
  nand2  g30(.a(x12), .b(x11), .O(new_n60_));
  nand2  g31(.a(new_n48_), .b(x09), .O(new_n61_));
  nor3   g32(.a(new_n61_), .b(new_n60_), .c(new_n58_), .O(z10));
  nand4  g33(.a(new_n48_), .b(new_n47_), .c(new_n57_), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n33_), .O(z11));
  nand2  g35(.a(new_n55_), .b(new_n37_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x12), .c(new_n33_), .O(z12));
endmodule
