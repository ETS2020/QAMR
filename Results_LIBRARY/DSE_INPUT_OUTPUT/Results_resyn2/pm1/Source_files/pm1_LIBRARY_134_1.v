...
module FAU ( 
  ...
  nor2   g29(.a(new_n58_), .b(new_n55_), .O(z10));
  nand2  g30(.a(new_n57_), .b(x11), .O(new_n60_));
  nand2  g31(.a(new_n32_), .b(new_n30_), .O(new_n61_));
  nand4  g32(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z11));
  inv1   g34(.a(x09), .O(new_n64_));
  nand2  g35(.a(new_n57_), .b(new_n64_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x11), .c(new_n32_), .O(z12));
endmodule
