...
module FAU ( 
  ...
  and2   g08(.a(x12), .b(x08), .O(new_n38_));
  ...
  nand3  g31(.a(new_n31_), .b(new_n57_), .c(x00), .O(new_n61_));
  aoi22  g32(.a(new_n61_), .b(new_n32_), .c(new_n58_), .d(new_n38_), .O(z09));
  nand4  g33(.a(new_n50_), .b(new_n37_), .c(new_n57_), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x08), .c(new_n32_), .O(z10));
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n38_), .O(new_n65_));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand2  g39(.a(new_n38_), .b(new_n68_), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n58_), .O(z12));
endmodule
