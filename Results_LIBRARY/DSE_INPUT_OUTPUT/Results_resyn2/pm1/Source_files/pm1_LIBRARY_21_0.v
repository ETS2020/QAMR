...
module FAU ( 
  ...
  aoi22  g13(.a(new_n42_), .b(x11), .c(new_n40_), .d(z00), .O(z06));
  ...
  nor2   g35(.a(new_n60_), .b(new_n46_), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(new_n57_), .c(new_n41_), .d(new_n53_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n64_), .O(z11));
  nor2   g38(.a(new_n54_), .b(x09), .O(z12));
  buf    g39(.a(x11), .O(z01));
endmodule
