...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(new_n31_), .O(new_n36_));
  ...
  nand3  g21(.a(x11), .b(new_n31_), .c(x00), .O(new_n51_));
  ...
  oai21  g27(.a(new_n56_), .b(new_n32_), .c(x00), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n43_), .O(z09));
  nand3  g29(.a(new_n46_), .b(x12), .c(x09), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n51_), .c(new_n43_), .O(z10));
  inv1   g31(.a(x12), .O(new_n61_));
  nand3  g32(.a(x11), .b(new_n30_), .c(x00), .O(new_n62_));
  ...
  nand2  g38(.a(new_n31_), .b(x00), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n55_), .c(x09), .O(z12));
endmodule
