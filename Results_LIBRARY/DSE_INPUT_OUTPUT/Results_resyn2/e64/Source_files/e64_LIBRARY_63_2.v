...
module FAU ( 
  ...
  nor2   g152(.a(x29), .b(x27), .O(new_n283_));
  nor2   g153(.a(new_n283_), .b(new_n282_), .O(z04));
  inv1   g154(.a(x14), .O(new_n285_));
  inv1   g155(.a(x37), .O(new_n286_));
  nand3  g156(.a(new_n133_), .b(new_n253_), .c(new_n286_), .O(new_n287_));
  nor3   g157(.a(new_n287_), .b(x15), .c(new_n285_), .O(z06));
  nand3  g158(.a(new_n133_), .b(new_n286_), .c(new_n139_), .O(new_n289_));
  nor2   g159(.a(new_n289_), .b(new_n253_), .O(z07));
  nor2   g160(.a(x43), .b(x40), .O(new_n291_));
  nor2   g161(.a(x39), .b(new_n251_), .O(new_n292_));
  nand4  g162(.a(new_n292_), .b(new_n291_), .c(new_n269_), .d(new_n241_), .O(new_n293_));
  nor2   g163(.a(new_n293_), .b(new_n236_), .O(z08));
  nand2  g164(.a(new_n215_), .b(new_n211_), .O(new_n295_));
  nor2   g165(.a(new_n268_), .b(new_n266_), .O(new_n296_));
  inv1   g166(.a(x24), .O(new_n297_));
  nand4  g167(.a(new_n264_), .b(new_n216_), .c(new_n297_), .d(x23), .O(new_n298_));
  inv1   g168(.a(x41), .O(new_n299_));
  nor2   g169(.a(x40), .b(x39), .O(new_n300_));
  nand2  g170(.a(new_n300_), .b(new_n299_), .O(new_n301_));
  nor3   g171(.a(new_n301_), .b(new_n298_), .c(new_n275_), .O(new_n302_));
  nand4  g172(.a(new_n302_), .b(new_n273_), .c(new_n296_), .d(new_n263_), .O(new_n303_));
  nor2   g173(.a(new_n303_), .b(new_n295_), .O(z09));
  nand2  g174(.a(new_n132_), .b(x27), .O(new_n305_));
  nand3  g175(.a(new_n282_), .b(new_n286_), .c(x28), .O(new_n306_));
  ...
  nand3  g202(.a(new_n270_), .b(new_n297_), .c(new_n153_), .O(new_n333_));
  nor2   g203(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  nand2  g204(.a(new_n291_), .b(new_n150_), .O(new_n335_));
  inv1   g205(.a(new_n335_), .O(new_n336_));
  nand3  g206(.a(new_n336_), .b(new_n334_), .c(new_n313_), .O(new_n337_));
  nand2  g207(.a(new_n320_), .b(new_n285_), .O(new_n338_));
  ...
  nand2  g213(.a(new_n343_), .b(new_n286_), .O(new_n344_));
  nand3  g214(.a(new_n220_), .b(x50), .c(new_n253_), .O(new_n345_));
  oai21  g215(.a(new_n345_), .b(new_n344_), .c(new_n305_), .O(z14));
  nand4  g216(.a(new_n220_), .b(new_n253_), .c(new_n285_), .d(x10), .O(new_n347_));
  oai21  g217(.a(new_n347_), .b(new_n289_), .c(new_n305_), .O(z15));
  ...
  nand2  g250(.a(new_n135_), .b(new_n286_), .O(new_n381_));
  nand3  g251(.a(new_n270_), .b(new_n229_), .c(new_n253_), .O(new_n382_));
  nand2  g252(.a(new_n300_), .b(new_n241_), .O(new_n383_));
  ...
  nand2  g270(.a(new_n247_), .b(new_n286_), .O(new_n401_));
  ...
  nand4  g299(.a(new_n286_), .b(x36), .c(new_n237_), .d(new_n146_), .O(new_n430_));
  ...
  nand4  g334(.a(new_n356_), .b(new_n247_), .c(new_n285_), .d(new_n464_), .O(new_n465_));
  ...
  nand4  g379(.a(new_n291_), .b(new_n220_), .c(new_n159_), .d(x39), .O(new_n510_));
  ...
  nand2  g433(.a(new_n349_), .b(new_n300_), .O(new_n564_));
  ...
  nand3  g441(.a(new_n501_), .b(new_n286_), .c(x33), .O(new_n572_));
  ...
  nand2  g446(.a(new_n300_), .b(new_n286_), .O(new_n577_));
  nor4   g447(.a(new_n577_), .b(new_n544_), .c(new_n427_), .d(new_n576_), .O(new_n578_));
  nand3  g448(.a(new_n135_), .b(x49), .c(new_n299_), .O(new_n579_));
  ...
  nand3  g513(.a(new_n160_), .b(new_n285_), .c(x12), .O(new_n644_));
  ...
  oai21  g547(.a(new_n677_), .b(new_n287_), .c(new_n305_), .O(z59));
  ...
  nand3  g561(.a(x56), .b(new_n286_), .c(new_n323_), .O(new_n692_));
