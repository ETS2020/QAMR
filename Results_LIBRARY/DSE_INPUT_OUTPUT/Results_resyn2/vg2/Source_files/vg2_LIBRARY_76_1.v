...
module FAU ( 
  ...
  oai21  g056(.a(new_n82_), .b(x13), .c(new_n83_), .O(new_n90_));
  aoi21  g057(.a(x13), .b(new_n38_), .c(x24), .O(new_n91_));
  aoi21  g058(.a(new_n91_), .b(new_n54_), .c(new_n90_), .O(new_n92_));
  inv1   g059(.a(new_n55_), .O(new_n93_));
  nand3  g060(.a(x20), .b(x03), .c(x01), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n93_), .c(x06), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n92_), .O(z2));
  inv1   g064(.a(new_n58_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n93_), .c(x21), .d(x20), .O(new_n99_));
  ...
  nand4  g071(.a(new_n98_), .b(new_n93_), .c(x20), .d(x15), .O(new_n105_));
  ...
  inv1   g077(.a(x06), .O(new_n111_));
  inv1   g078(.a(x08), .O(new_n112_));
  nor4   g079(.a(new_n94_), .b(new_n55_), .c(new_n112_), .d(new_n111_), .O(new_n113_));
  oai21  g080(.a(new_n80_), .b(x13), .c(new_n47_), .O(new_n114_));
  nand4  g081(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n112_), .O(new_n115_));
  inv1   g082(.a(new_n115_), .O(new_n116_));
  aoi22  g083(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n90_), .O(new_n117_));
  ...
  aoi21  g089(.a(new_n86_), .b(new_n46_), .c(new_n114_), .O(new_n123_));
  ...
  oai22  g093(.a(new_n126_), .b(new_n92_), .c(new_n123_), .d(new_n122_), .O(z4));
  inv1   g094(.a(new_n114_), .O(new_n128_));
  nand3  g095(.a(new_n86_), .b(new_n62_), .c(new_n51_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n128_), .O(z5));
  inv1   g097(.a(x03), .O(new_n131_));
  inv1   g098(.a(x14), .O(new_n132_));
  aoi21  g099(.a(x20), .b(new_n132_), .c(x06), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x11), .c(new_n131_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(z5), .O(new_n135_));
  inv1   g102(.a(new_n90_), .O(new_n136_));
  nand2  g103(.a(new_n91_), .b(new_n54_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n136_), .O(z7));
  inv1   g105(.a(x11), .O(new_n139_));
  aoi21  g106(.a(new_n71_), .b(x14), .c(new_n111_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n139_), .c(x03), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(z7), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n135_), .O(z6));
endmodule
