...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_,
    ...
    new_n139_, new_n140_, new_n141_, new_n142_, new_n144_;
  ...
  nand4  g037(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(x19), .O(new_n71_));
  nand4  g038(.a(x20), .b(x17), .c(x16), .d(x15), .O(new_n72_));
  inv1   g039(.a(new_n72_), .O(new_n73_));
  nand4  g040(.a(new_n73_), .b(new_n54_), .c(new_n52_), .d(new_n50_), .O(new_n74_));
  oai21  g041(.a(new_n71_), .b(new_n60_), .c(new_n74_), .O(new_n75_));
  inv1   g042(.a(x05), .O(new_n76_));
  nor2   g043(.a(new_n66_), .b(new_n76_), .O(new_n77_));
  aoi22  g044(.a(new_n77_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n78_));
  nand3  g045(.a(x24), .b(x18), .c(x05), .O(new_n79_));
  nand2  g046(.a(x15), .b(new_n76_), .O(new_n80_));
  oai21  g047(.a(new_n80_), .b(x13), .c(new_n79_), .O(new_n81_));
  nand3  g048(.a(x20), .b(x17), .c(x16), .O(new_n82_));
  inv1   g049(.a(new_n82_), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n54_), .c(new_n52_), .d(new_n50_), .O(new_n84_));
  inv1   g051(.a(new_n84_), .O(new_n85_));
  nand2  g052(.a(x19), .b(new_n76_), .O(new_n86_));
  oai21  g053(.a(new_n86_), .b(x13), .c(new_n45_), .O(new_n87_));
  nand3  g054(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n88_));
  nor2   g055(.a(new_n88_), .b(new_n60_), .O(new_n89_));
  aoi22  g056(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(new_n81_), .O(new_n90_));
  oai21  g057(.a(new_n78_), .b(x24), .c(new_n90_), .O(z1));
  ...
  aoi21  g062(.a(new_n94_), .b(x15), .c(x13), .O(new_n96_));
  inv1   g063(.a(new_n79_), .O(new_n97_));
  aoi22  g064(.a(new_n68_), .b(x21), .c(x15), .d(x13), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(x24), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  oai22  g067(.a(new_n100_), .b(new_n95_), .c(new_n96_), .d(x05), .O(z2));
  inv1   g068(.a(x24), .O(new_n102_));
  inv1   g069(.a(x08), .O(new_n103_));
  nor3   g070(.a(new_n98_), .b(new_n95_), .c(new_n103_), .O(new_n104_));
  nand2  g071(.a(new_n38_), .b(new_n103_), .O(new_n105_));
  aoi21  g072(.a(new_n43_), .b(new_n42_), .c(new_n105_), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  nand2  g074(.a(new_n80_), .b(new_n79_), .O(new_n108_));
  nand3  g075(.a(new_n94_), .b(new_n108_), .c(x08), .O(new_n109_));
  aoi21  g076(.a(new_n86_), .b(new_n45_), .c(new_n105_), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(new_n67_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n109_), .c(new_n107_), .O(z3));
  ...
  inv1   g085(.a(new_n67_), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n44_), .c(new_n87_), .O(new_n120_));
  inv1   g087(.a(x22), .O(new_n121_));
  inv1   g088(.a(x04), .O(new_n122_));
  inv1   g089(.a(x17), .O(new_n123_));
  aoi21  g090(.a(x23), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n121_), .c(x09), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x16), .c(new_n103_), .O(new_n126_));
  aoi21  g093(.a(new_n99_), .b(new_n119_), .c(new_n81_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n120_), .d(new_n118_), .O(z4));
  oai21  g095(.a(x24), .b(new_n66_), .c(x05), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(x19), .O(new_n130_));
  inv1   g097(.a(new_n42_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n102_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n130_), .c(new_n119_), .d(new_n45_), .O(z5));
  inv1   g100(.a(x11), .O(new_n134_));
  inv1   g101(.a(x06), .O(new_n135_));
  inv1   g102(.a(x20), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x14), .c(new_n135_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n134_), .c(x03), .O(new_n138_));
  inv1   g105(.a(x03), .O(new_n139_));
  inv1   g106(.a(x14), .O(new_n140_));
  oai21  g107(.a(x20), .b(new_n140_), .c(x06), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(x11), .c(new_n139_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n127_), .c(new_n138_), .d(new_n120_), .O(z6));
  oai21  g110(.a(x15), .b(x13), .c(new_n76_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n100_), .O(z7));
endmodule
