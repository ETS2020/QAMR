...
module FAU ( 
  ...
  nor2   g056(.a(new_n39_), .b(x05), .O(new_n90_));
  nor2   g057(.a(new_n90_), .b(x24), .O(new_n91_));
  oai21  g058(.a(new_n82_), .b(x13), .c(new_n83_), .O(new_n92_));
  aoi21  g059(.a(new_n91_), .b(new_n54_), .c(new_n92_), .O(new_n93_));
  inv1   g060(.a(new_n55_), .O(new_n94_));
  nand3  g061(.a(x20), .b(x03), .c(x01), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n94_), .c(x06), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(new_n93_), .O(z2));
  inv1   g065(.a(new_n58_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n94_), .c(x21), .d(x20), .O(new_n100_));
  inv1   g067(.a(x00), .O(new_n101_));
  nor2   g068(.a(x20), .b(new_n101_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n68_), .c(new_n35_), .d(new_n34_), .O(new_n103_));
  nand2  g070(.a(new_n86_), .b(new_n44_), .O(new_n104_));
  aoi21  g071(.a(new_n103_), .b(new_n100_), .c(new_n104_), .O(new_n105_));
  nand4  g072(.a(new_n99_), .b(new_n94_), .c(x20), .d(x15), .O(new_n106_));
  nor2   g073(.a(x20), .b(new_n40_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n68_), .c(new_n35_), .d(new_n34_), .O(new_n108_));
  nand2  g075(.a(x13), .b(x05), .O(new_n109_));
  aoi21  g076(.a(new_n108_), .b(new_n106_), .c(new_n109_), .O(new_n110_));
  oai21  g077(.a(new_n110_), .b(new_n105_), .c(new_n51_), .O(new_n111_));
  nand2  g078(.a(x08), .b(x06), .O(new_n112_));
  nor3   g079(.a(new_n95_), .b(new_n112_), .c(new_n55_), .O(new_n113_));
  oai21  g080(.a(new_n80_), .b(x13), .c(new_n47_), .O(new_n114_));
  inv1   g081(.a(x08), .O(new_n115_));
  nand4  g082(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n115_), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  aoi22  g084(.a(new_n117_), .b(new_n114_), .c(new_n113_), .d(new_n92_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n111_), .O(z3));
  inv1   g086(.a(x16), .O(new_n120_));
  aoi21  g087(.a(new_n73_), .b(x04), .c(x17), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(x22), .c(new_n64_), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(new_n120_), .c(x08), .O(new_n123_));
  aoi21  g090(.a(new_n86_), .b(new_n46_), .c(new_n114_), .O(new_n124_));
  aoi21  g091(.a(x23), .b(new_n63_), .c(new_n70_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n72_), .c(x09), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x16), .c(new_n115_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n93_), .c(new_n124_), .d(new_n123_), .O(z4));
  inv1   g095(.a(new_n124_), .O(z5));
  nand4  g096(.a(new_n44_), .b(new_n51_), .c(x21), .d(x03), .O(new_n130_));
  nand2  g097(.a(new_n51_), .b(x03), .O(new_n131_));
  oai21  g098(.a(new_n51_), .b(x13), .c(new_n131_), .O(new_n132_));
  nand2  g099(.a(new_n39_), .b(x05), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n132_), .c(x15), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n130_), .c(new_n83_), .O(new_n135_));
  nand2  g102(.a(new_n71_), .b(x14), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(x06), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n135_), .c(x11), .O(new_n138_));
  inv1   g105(.a(x03), .O(new_n139_));
  nand2  g106(.a(new_n91_), .b(new_n54_), .O(new_n140_));
  inv1   g107(.a(new_n92_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n140_), .O(z7));
  nand2  g109(.a(z7), .b(new_n139_), .O(new_n143_));
  inv1   g110(.a(x14), .O(new_n144_));
  aoi21  g111(.a(x20), .b(new_n144_), .c(x06), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x11), .c(new_n139_), .O(new_n146_));
  ...
  nand3  g118(.a(new_n151_), .b(new_n143_), .c(new_n138_), .O(z6));
endmodule
