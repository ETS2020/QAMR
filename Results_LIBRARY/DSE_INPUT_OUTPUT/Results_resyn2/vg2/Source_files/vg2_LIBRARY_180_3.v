...
module FAU ( 
  ...
  aoi21  g81(.a(x20), .b(new_n47_), .c(x06), .O(new_n115_));
  oai21  g82(.a(new_n115_), .b(x11), .c(new_n72_), .O(new_n116_));
  aoi21  g83(.a(new_n116_), .b(new_n44_), .c(new_n93_), .O(new_n117_));
  oai21  g84(.a(new_n114_), .b(new_n99_), .c(new_n117_), .O(z6));
endmodule
