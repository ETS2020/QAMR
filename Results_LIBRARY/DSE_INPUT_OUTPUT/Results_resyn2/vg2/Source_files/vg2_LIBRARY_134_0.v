...
module FAU ( 
  ...
  aoi21  g30(.a(new_n38_), .b(new_n34_), .c(new_n49_), .O(new_n64_));
  nor2   g31(.a(x16), .b(x12), .O(new_n65_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n64_), .c(new_n63_), .O(new_n72_));
  nand2  g39(.a(x24), .b(x18), .O(new_n73_));
  nand4  g40(.a(new_n37_), .b(x21), .c(new_n36_), .d(new_n35_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g42(.a(x20), .b(x14), .c(x11), .O(new_n76_));
  nand4  g43(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n77_));
  nor2   g44(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g45(.a(x23), .b(x22), .c(x17), .O(new_n79_));
  nand4  g46(.a(x16), .b(x12), .c(x09), .d(x04), .O(new_n80_));
  nor2   g47(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n78_), .c(new_n75_), .O(new_n82_));
  nand2  g49(.a(new_n82_), .b(new_n72_), .O(new_n83_));
  nand2  g50(.a(new_n83_), .b(new_n54_), .O(new_n84_));
  inv1   g51(.a(new_n59_), .O(new_n85_));
  nand3  g52(.a(new_n85_), .b(new_n61_), .c(new_n60_), .O(new_n86_));
  inv1   g53(.a(new_n70_), .O(new_n87_));
  nand4  g54(.a(new_n87_), .b(new_n65_), .c(new_n50_), .d(x19), .O(new_n88_));
  nand3  g55(.a(new_n81_), .b(new_n78_), .c(x15), .O(new_n89_));
  ...
  nand2  g60(.a(new_n42_), .b(x15), .O(new_n94_));
  nand2  g61(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand3  g62(.a(x06), .b(x03), .c(x01), .O(new_n96_));
  nor2   g63(.a(new_n96_), .b(new_n76_), .O(new_n97_));
  nand2  g64(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand2  g65(.a(new_n98_), .b(new_n54_), .O(z2));
  nand2  g66(.a(new_n78_), .b(new_n75_), .O(new_n100_));
  nand2  g67(.a(new_n64_), .b(new_n85_), .O(new_n101_));
  nand2  g68(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g69(.a(new_n102_), .b(new_n54_), .O(new_n103_));
  and2   g70(.a(new_n78_), .b(x15), .O(new_n104_));
  inv1   g71(.a(x19), .O(new_n105_));
  nor3   g72(.a(new_n59_), .b(new_n49_), .c(new_n105_), .O(new_n106_));
  oai21  g73(.a(new_n106_), .b(new_n104_), .c(new_n42_), .O(new_n107_));
  nand2  g74(.a(new_n107_), .b(new_n103_), .O(z3));
  oai21  g75(.a(x23), .b(new_n60_), .c(new_n67_), .O(new_n109_));
  aoi21  g76(.a(new_n109_), .b(new_n68_), .c(x09), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(x16), .c(new_n58_), .O(new_n111_));
  nand2  g78(.a(new_n111_), .b(new_n44_), .O(new_n112_));
  inv1   g79(.a(x16), .O(new_n113_));
  oai21  g80(.a(new_n69_), .b(x04), .c(x17), .O(new_n114_));
  aoi21  g81(.a(new_n114_), .b(x22), .c(new_n61_), .O(new_n115_));
  oai21  g82(.a(new_n115_), .b(new_n113_), .c(x08), .O(new_n116_));
  nand2  g83(.a(new_n116_), .b(new_n95_), .O(new_n117_));
  nand3  g84(.a(new_n117_), .b(new_n112_), .c(new_n54_), .O(z4));
  nand3  g85(.a(new_n54_), .b(new_n43_), .c(new_n39_), .O(z5));
  aoi21  g86(.a(x20), .b(new_n47_), .c(x06), .O(new_n120_));
  oai21  g87(.a(new_n120_), .b(x11), .c(new_n56_), .O(new_n121_));
  nand3  g88(.a(new_n121_), .b(new_n45_), .c(new_n44_), .O(new_n122_));
  aoi21  g89(.a(new_n48_), .b(x14), .c(new_n57_), .O(new_n123_));
  oai21  g90(.a(new_n123_), .b(new_n46_), .c(x03), .O(new_n124_));
  nand2  g91(.a(new_n41_), .b(new_n40_), .O(new_n125_));
  nand3  g92(.a(new_n125_), .b(new_n124_), .c(new_n95_), .O(new_n126_));
  nand2  g93(.a(new_n126_), .b(new_n122_), .O(z6));
  nand3  g94(.a(new_n94_), .b(new_n93_), .c(new_n54_), .O(z7));
endmodule
