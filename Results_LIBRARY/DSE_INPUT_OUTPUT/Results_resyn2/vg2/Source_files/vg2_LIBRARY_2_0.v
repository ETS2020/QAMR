...
module FAU ( 
  ...
  nand2  g54(.a(x13), .b(x05), .O(new_n88_));
  nor2   g55(.a(new_n88_), .b(x24), .O(new_n89_));
  nand2  g56(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand2  g57(.a(new_n90_), .b(new_n83_), .O(z1));
  nand3  g58(.a(x15), .b(x13), .c(x05), .O(new_n92_));
  inv1   g59(.a(new_n92_), .O(new_n93_));
  aoi21  g60(.a(new_n93_), .b(new_n39_), .c(new_n59_), .O(new_n94_));
  inv1   g61(.a(new_n60_), .O(new_n95_));
  nand4  g62(.a(new_n95_), .b(x06), .c(x03), .d(x01), .O(new_n96_));
  oai21  g63(.a(new_n96_), .b(new_n94_), .c(new_n35_), .O(z2));
  nand2  g64(.a(new_n62_), .b(x18), .O(new_n98_));
  nand3  g65(.a(new_n55_), .b(new_n77_), .c(x07), .O(new_n99_));
  nand2  g66(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g67(.a(new_n100_), .b(x24), .O(new_n101_));
  inv1   g68(.a(new_n57_), .O(new_n102_));
  oai21  g69(.a(new_n93_), .b(new_n102_), .c(new_n62_), .O(new_n103_));
  nand3  g70(.a(new_n38_), .b(new_n37_), .c(x00), .O(new_n104_));
  nand2  g71(.a(new_n104_), .b(new_n43_), .O(new_n105_));
  nand3  g72(.a(new_n105_), .b(new_n55_), .c(new_n77_), .O(new_n106_));
  nand2  g73(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  nand2  g74(.a(new_n107_), .b(new_n39_), .O(new_n108_));
  nand3  g75(.a(new_n108_), .b(new_n101_), .c(new_n35_), .O(z3));
  nor2   g76(.a(new_n102_), .b(x24), .O(new_n110_));
  nand2  g77(.a(new_n93_), .b(new_n39_), .O(new_n111_));
  oai21  g78(.a(new_n58_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  oai21  g79(.a(new_n73_), .b(x04), .c(x17), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(x22), .c(new_n78_), .O(new_n114_));
  oai21  g81(.a(new_n114_), .b(new_n69_), .c(x08), .O(new_n115_));
  nand2  g82(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand3  g83(.a(new_n105_), .b(new_n35_), .c(new_n39_), .O(new_n117_));
  oai21  g84(.a(new_n36_), .b(x08), .c(new_n117_), .O(new_n118_));
  aoi21  g85(.a(new_n73_), .b(x04), .c(x17), .O(new_n119_));
  oai21  g86(.a(new_n119_), .b(x22), .c(new_n78_), .O(new_n120_));
  nand3  g87(.a(new_n120_), .b(new_n118_), .c(new_n69_), .O(new_n121_));
  aoi21  g88(.a(z5), .b(x08), .c(new_n34_), .O(new_n122_));
  nand3  g89(.a(new_n122_), .b(new_n121_), .c(new_n116_), .O(z4));
  aoi21  g90(.a(new_n49_), .b(x14), .c(new_n53_), .O(new_n124_));
  oai21  g91(.a(new_n124_), .b(new_n47_), .c(x03), .O(new_n125_));
  nor2   g92(.a(x13), .b(x05), .O(new_n126_));
  inv1   g93(.a(new_n126_), .O(new_n127_));
  nand3  g94(.a(new_n127_), .b(new_n125_), .c(new_n112_), .O(new_n128_));
  aoi21  g95(.a(x20), .b(new_n48_), .c(x06), .O(new_n129_));
  oai21  g96(.a(new_n129_), .b(x11), .c(new_n52_), .O(new_n130_));
  nand2  g97(.a(new_n130_), .b(z5), .O(new_n131_));
  nand2  g98(.a(new_n131_), .b(new_n128_), .O(z6));
  nor2   g99(.a(new_n126_), .b(new_n94_), .O(z7));
endmodule
