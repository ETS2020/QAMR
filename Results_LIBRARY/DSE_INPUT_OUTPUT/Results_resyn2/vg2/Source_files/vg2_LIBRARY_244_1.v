...
module FAU ( 
  ...
  nand2  g05(.a(x19), .b(x13), .O(new_n39_));
  aoi21  g06(.a(new_n39_), .b(new_n38_), .c(x24), .O(new_n40_));
  ...
  nand3  g41(.a(x21), .b(new_n37_), .c(new_n36_), .O(new_n75_));
  ...
  oai21  g82(.a(x24), .b(new_n64_), .c(x05), .O(new_n116_));
  nand2  g83(.a(new_n116_), .b(x19), .O(new_n117_));
  inv1   g84(.a(new_n38_), .O(new_n118_));
  nand2  g85(.a(new_n118_), .b(new_n85_), .O(new_n119_));
  nand4  g86(.a(new_n119_), .b(new_n117_), .c(new_n43_), .d(new_n35_), .O(z5));
  inv1   g87(.a(x11), .O(new_n121_));
  inv1   g88(.a(x06), .O(new_n122_));
  inv1   g89(.a(x20), .O(new_n123_));
  oai21  g90(.a(new_n123_), .b(x14), .c(new_n122_), .O(new_n124_));
  aoi21  g91(.a(new_n124_), .b(new_n121_), .c(x03), .O(new_n125_));
  inv1   g92(.a(x03), .O(new_n126_));
  inv1   g93(.a(x14), .O(new_n127_));
  oai21  g94(.a(x20), .b(new_n127_), .c(x06), .O(new_n128_));
  aoi21  g95(.a(new_n128_), .b(x11), .c(new_n126_), .O(new_n129_));
  oai22  g96(.a(new_n129_), .b(new_n105_), .c(new_n125_), .d(new_n45_), .O(z6));
endmodule
