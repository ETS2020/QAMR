...
module FAU ( 
  ...
  nand3  g55(.a(new_n88_), .b(new_n87_), .c(new_n77_), .O(new_n89_));
  nand3  g56(.a(x20), .b(x14), .c(x11), .O(new_n90_));
  inv1   g57(.a(new_n90_), .O(new_n91_));
  nand3  g58(.a(new_n91_), .b(new_n89_), .c(new_n84_), .O(new_n92_));
  inv1   g59(.a(new_n92_), .O(z2));
  inv1   g60(.a(new_n65_), .O(new_n94_));
  nand3  g61(.a(new_n91_), .b(new_n89_), .c(new_n94_), .O(new_n95_));
  ...
  nor2   g97(.a(new_n78_), .b(new_n76_), .O(new_n131_));
  oai21  g98(.a(x15), .b(x13), .c(new_n34_), .O(new_n132_));
  nand2  g99(.a(new_n132_), .b(new_n131_), .O(z7));
endmodule
