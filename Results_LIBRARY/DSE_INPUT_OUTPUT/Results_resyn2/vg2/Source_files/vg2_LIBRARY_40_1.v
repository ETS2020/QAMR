...
module FAU ( 
  ...
  oai21  g079(.a(new_n110_), .b(new_n106_), .c(new_n112_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(x14), .c(new_n50_), .O(z2));
  inv1   g081(.a(new_n75_), .O(new_n115_));
  and2   g082(.a(x14), .b(x11), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n115_), .c(new_n74_), .d(x20), .O(new_n117_));
  nand2  g084(.a(new_n69_), .b(new_n65_), .O(new_n118_));
  nand2  g085(.a(new_n47_), .b(new_n66_), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n52_), .O(new_n120_));
  ...
  nand3  g091(.a(new_n116_), .b(new_n115_), .c(x20), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  inv1   g093(.a(x07), .O(new_n127_));
  nor3   g094(.a(new_n119_), .b(new_n52_), .c(new_n127_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n126_), .c(new_n84_), .O(new_n129_));
  inv1   g096(.a(x15), .O(new_n130_));
  nor2   g097(.a(new_n125_), .b(new_n130_), .O(new_n131_));
  nand2  g098(.a(new_n51_), .b(new_n47_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n97_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n131_), .c(new_n43_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n129_), .c(new_n123_), .O(z3));
  inv1   g102(.a(new_n46_), .O(new_n136_));
  oai21  g103(.a(x23), .b(new_n58_), .c(new_n54_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n55_), .c(x09), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x16), .c(new_n66_), .O(new_n139_));
  ...
  nor2   g112(.a(new_n50_), .b(x14), .O(new_n146_));
  inv1   g113(.a(new_n146_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n145_), .c(new_n140_), .O(z4));
  ...
  oai21  g121(.a(new_n110_), .b(new_n106_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n147_), .O(new_n157_));
  nand3  g124(.a(new_n141_), .b(new_n116_), .c(new_n50_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(z6));
  and2   g126(.a(new_n147_), .b(new_n141_), .O(z7));
endmodule
