...
module FAU ( 
  ...
  oai21  g067(.a(new_n100_), .b(x13), .c(new_n99_), .O(new_n101_));
  ...
  nand3  g086(.a(new_n96_), .b(new_n55_), .c(x00), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n119_), .c(new_n41_), .O(new_n121_));
  nand2  g088(.a(new_n87_), .b(new_n55_), .O(new_n122_));
  ...
  aoi21  g094(.a(new_n72_), .b(x04), .c(x17), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(x22), .c(new_n76_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n63_), .c(x08), .O(new_n130_));
  aoi21  g097(.a(x23), .b(new_n68_), .c(new_n64_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n71_), .c(x09), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(x16), .c(new_n85_), .O(new_n133_));
  aoi21  g100(.a(new_n115_), .b(new_n39_), .c(new_n101_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n130_), .d(new_n47_), .O(z4));
  inv1   g102(.a(new_n47_), .O(z5));
  aoi21  g103(.a(new_n49_), .b(x14), .c(new_n48_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n52_), .c(x03), .O(new_n138_));
  nand2  g105(.a(new_n116_), .b(new_n100_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  aoi21  g107(.a(x20), .b(new_n53_), .c(x06), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x11), .c(new_n51_), .O(new_n142_));
  oai21  g109(.a(x24), .b(new_n43_), .c(x05), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(x19), .O(new_n144_));
  nand3  g111(.a(new_n40_), .b(new_n34_), .c(x00), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n144_), .c(new_n45_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n140_), .c(new_n39_), .O(z6));
  oai21  g115(.a(x15), .b(x13), .c(new_n38_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n116_), .O(z7));
endmodule
