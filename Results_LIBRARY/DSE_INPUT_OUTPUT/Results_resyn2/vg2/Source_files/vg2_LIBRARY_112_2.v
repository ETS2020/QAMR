...
module FAU ( 
  ...
  nand2  g064(.a(x15), .b(new_n41_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(x05), .c(new_n89_), .O(new_n99_));
  aoi21  g066(.a(new_n97_), .b(new_n55_), .c(new_n99_), .O(new_n100_));
  nor3   g067(.a(new_n100_), .b(new_n58_), .c(new_n96_), .O(z2));
  nand2  g068(.a(new_n97_), .b(new_n55_), .O(new_n102_));
  inv1   g069(.a(new_n99_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n59_), .c(new_n57_), .O(new_n105_));
  nand3  g072(.a(new_n71_), .b(new_n50_), .c(new_n34_), .O(new_n106_));
  oai21  g073(.a(new_n38_), .b(x08), .c(x13), .O(new_n107_));
  ...
  oai21  g078(.a(new_n75_), .b(x04), .c(x17), .O(new_n112_));
  ...
  oai21  g082(.a(x24), .b(new_n115_), .c(x13), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(x15), .O(new_n117_));
  inv1   g084(.a(new_n54_), .O(new_n118_));
  inv1   g085(.a(new_n89_), .O(new_n119_));
  aoi21  g086(.a(new_n118_), .b(new_n43_), .c(new_n119_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  inv1   g089(.a(x04), .O(new_n123_));
  oai21  g090(.a(x23), .b(new_n123_), .c(new_n72_), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(new_n74_), .c(x09), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(x16), .c(new_n69_), .O(new_n126_));
  nand2  g093(.a(new_n116_), .b(x19), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n49_), .c(new_n48_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n122_), .c(new_n92_), .O(z4));
  inv1   g097(.a(new_n50_), .O(new_n131_));
  oai21  g098(.a(new_n36_), .b(new_n41_), .c(x05), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n131_), .O(z5));
  inv1   g100(.a(x11), .O(new_n134_));
  oai21  g101(.a(new_n73_), .b(x14), .c(new_n68_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n134_), .c(x03), .O(new_n136_));
  oai21  g103(.a(new_n42_), .b(x05), .c(new_n49_), .O(new_n137_));
  aoi21  g104(.a(new_n97_), .b(new_n65_), .c(new_n137_), .O(new_n138_));
  inv1   g105(.a(x14), .O(new_n139_));
  oai21  g106(.a(x20), .b(new_n139_), .c(x06), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x11), .c(new_n67_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n100_), .c(new_n138_), .d(new_n136_), .O(z6));
  nand2  g109(.a(new_n98_), .b(new_n115_), .O(new_n143_));
  aoi21  g110(.a(x24), .b(x18), .c(new_n41_), .O(new_n144_));
  oai21  g111(.a(x24), .b(new_n88_), .c(new_n144_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n120_), .O(z7));
endmodule
