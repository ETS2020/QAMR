...
module FAU ( 
  ...
  aoi21  g093(.a(new_n49_), .b(x14), .c(new_n55_), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n47_), .c(x03), .O(new_n128_));
  nand2  g095(.a(new_n84_), .b(new_n83_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n128_), .c(new_n96_), .O(new_n130_));
  aoi21  g097(.a(x20), .b(new_n48_), .c(x06), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(x11), .c(new_n54_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(z5), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n130_), .O(z6));
  and2   g101(.a(new_n129_), .b(new_n96_), .O(z7));
endmodule
