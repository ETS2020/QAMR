...
module FAU ( 
  ...
  inv1   g048(.a(new_n79_), .O(new_n82_));
  nand3  g049(.a(x24), .b(x18), .c(x13), .O(new_n83_));
  nor2   g050(.a(x13), .b(x05), .O(new_n84_));
  aoi22  g051(.a(new_n84_), .b(x15), .c(new_n40_), .d(x21), .O(new_n85_));
  ...
  oai21  g057(.a(new_n90_), .b(x13), .c(new_n83_), .O(new_n91_));
  aoi22  g058(.a(new_n91_), .b(new_n34_), .c(new_n71_), .d(new_n43_), .O(new_n92_));
  nand2  g059(.a(new_n92_), .b(new_n89_), .O(z7));
  ...
  nor2   g066(.a(new_n84_), .b(new_n70_), .O(new_n100_));
  ...
  oai21  g072(.a(new_n105_), .b(new_n103_), .c(new_n84_), .O(new_n106_));
  ...
  aoi22  g085(.a(new_n84_), .b(x19), .c(new_n40_), .d(x00), .O(new_n119_));
