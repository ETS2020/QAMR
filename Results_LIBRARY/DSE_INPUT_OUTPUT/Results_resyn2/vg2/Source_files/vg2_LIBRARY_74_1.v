...
module FAU ( 
  ...
  oai21  g054(.a(new_n87_), .b(x05), .c(new_n51_), .O(new_n88_));
  ...
  nor2   g063(.a(new_n35_), .b(new_n34_), .O(new_n97_));
  aoi21  g064(.a(new_n56_), .b(new_n55_), .c(x24), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n93_), .O(new_n99_));
  nand3  g066(.a(x15), .b(new_n39_), .c(new_n38_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n99_), .c(new_n90_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n61_), .c(new_n97_), .d(x06), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(z2));
  nand3  g070(.a(new_n101_), .b(new_n61_), .c(new_n59_), .O(new_n104_));
  oai21  g071(.a(new_n67_), .b(new_n41_), .c(new_n39_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n38_), .O(new_n106_));
  nand3  g073(.a(new_n68_), .b(new_n52_), .c(new_n40_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(z3));
  nand2  g075(.a(new_n100_), .b(new_n90_), .O(new_n109_));
  aoi21  g076(.a(new_n98_), .b(new_n93_), .c(new_n109_), .O(new_n110_));
  aoi21  g077(.a(new_n71_), .b(x04), .c(x17), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(x22), .c(new_n74_), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n76_), .c(x08), .O(new_n113_));
  aoi21  g080(.a(new_n48_), .b(new_n45_), .c(x24), .O(new_n114_));
  nand3  g081(.a(x19), .b(new_n39_), .c(new_n38_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n51_), .O(new_n116_));
  aoi21  g083(.a(new_n93_), .b(new_n114_), .c(new_n116_), .O(new_n117_));
  aoi21  g084(.a(x23), .b(new_n73_), .c(new_n69_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n70_), .c(x09), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(x16), .c(new_n66_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n110_), .c(new_n117_), .d(new_n113_), .O(z4));
  inv1   g088(.a(new_n117_), .O(z5));
  inv1   g089(.a(x11), .O(new_n123_));
  inv1   g090(.a(x20), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(x14), .c(new_n36_), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n123_), .c(x03), .O(new_n126_));
  inv1   g093(.a(x14), .O(new_n127_));
  oai21  g094(.a(x20), .b(new_n127_), .c(x06), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x11), .c(new_n35_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n110_), .c(new_n126_), .d(new_n117_), .O(z6));
  inv1   g097(.a(new_n98_), .O(new_n131_));
  inv1   g098(.a(x15), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n39_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n38_), .c(new_n91_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n131_), .O(z7));
endmodule
