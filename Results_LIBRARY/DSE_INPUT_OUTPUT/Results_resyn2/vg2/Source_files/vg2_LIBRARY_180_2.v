...
module FAU ( 
  ...
  aoi21  g006(.a(new_n39_), .b(x05), .c(x24), .O(new_n40_));
  nand2  g007(.a(x19), .b(new_n39_), .O(new_n41_));
  nand3  g008(.a(x24), .b(x13), .c(x07), .O(new_n42_));
  oai21  g009(.a(new_n41_), .b(x05), .c(new_n42_), .O(new_n43_));
  aoi21  g010(.a(new_n40_), .b(new_n38_), .c(new_n43_), .O(new_n44_));
  ...
  and2   g031(.a(new_n40_), .b(new_n38_), .O(new_n65_));
  ...
  nor3   g037(.a(x20), .b(x14), .c(x08), .O(new_n71_));
  nand2  g038(.a(new_n71_), .b(new_n48_), .O(new_n72_));
  nor2   g039(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  oai21  g040(.a(new_n43_), .b(new_n65_), .c(new_n73_), .O(new_n74_));
  inv1   g041(.a(new_n60_), .O(new_n75_));
  nand3  g042(.a(x21), .b(new_n35_), .c(new_n34_), .O(new_n76_));
  inv1   g043(.a(new_n76_), .O(new_n77_));
  nand2  g044(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  nand2  g045(.a(x15), .b(new_n39_), .O(new_n79_));
  ...
  nand3  g049(.a(new_n82_), .b(new_n74_), .c(new_n64_), .O(z1));
  ...
  nand3  g054(.a(x15), .b(new_n39_), .c(new_n87_), .O(new_n88_));
  nand2  g055(.a(new_n88_), .b(new_n80_), .O(new_n89_));
  aoi21  g056(.a(new_n86_), .b(new_n40_), .c(new_n89_), .O(new_n90_));
  inv1   g057(.a(new_n57_), .O(new_n91_));
  nand2  g058(.a(new_n91_), .b(x20), .O(new_n92_));
  nor3   g059(.a(new_n92_), .b(new_n90_), .c(new_n84_), .O(z2));
  nand2  g060(.a(new_n86_), .b(new_n40_), .O(new_n94_));
  nand3  g061(.a(new_n88_), .b(new_n94_), .c(new_n80_), .O(z7));
  inv1   g062(.a(new_n92_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(z7), .c(new_n54_), .O(new_n97_));
  inv1   g064(.a(new_n36_), .O(new_n98_));
  inv1   g065(.a(new_n42_), .O(new_n99_));
  aoi21  g066(.a(new_n98_), .b(new_n61_), .c(new_n99_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n41_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n71_), .c(new_n50_), .O(new_n102_));
  inv1   g069(.a(x19), .O(new_n103_));
  nor2   g070(.a(x24), .b(new_n103_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n71_), .c(new_n48_), .d(new_n47_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(x13), .O(new_n106_));
  nand2  g073(.a(new_n106_), .b(x05), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n102_), .c(new_n97_), .O(z3));
  inv1   g075(.a(x16), .O(new_n109_));
  inv1   g076(.a(x09), .O(new_n110_));
  inv1   g077(.a(x23), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(x04), .c(x17), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(x22), .c(new_n110_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n109_), .c(x08), .O(new_n114_));
  ...
  aoi21  g087(.a(new_n120_), .b(x16), .c(new_n115_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n90_), .c(new_n114_), .d(new_n44_), .O(z4));
  oai21  g089(.a(new_n104_), .b(new_n39_), .c(x05), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n100_), .c(new_n41_), .O(z5));
  nand2  g091(.a(new_n39_), .b(x05), .O(new_n125_));
  inv1   g092(.a(x03), .O(new_n126_));
  nand2  g093(.a(z7), .b(new_n126_), .O(new_n127_));
  oai21  g094(.a(new_n36_), .b(x24), .c(new_n42_), .O(new_n128_));
  aoi21  g095(.a(x20), .b(new_n45_), .c(x06), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(x11), .c(new_n126_), .O(new_n130_));
  nand2  g097(.a(new_n61_), .b(x05), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(x13), .c(new_n103_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n128_), .c(new_n130_), .O(new_n133_));
  nand3  g100(.a(new_n77_), .b(new_n61_), .c(x03), .O(new_n134_));
  nand2  g101(.a(new_n39_), .b(new_n87_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand2  g103(.a(new_n61_), .b(new_n126_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n136_), .c(x15), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n134_), .c(new_n80_), .O(new_n139_));
  nand2  g106(.a(new_n46_), .b(x14), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x06), .c(new_n47_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n133_), .c(new_n127_), .d(new_n125_), .O(z6));
endmodule
