// Benchmark "FAU" written by ABC on Tue Aug 11 20:49:05 2020
...
module FAU ( 
  ...
  nand3  g56(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  nand3  g57(.a(new_n90_), .b(new_n84_), .c(x11), .O(new_n91_));
  ...
  inv1   g84(.a(new_n80_), .O(new_n118_));
  oai21  g85(.a(new_n61_), .b(x13), .c(x05), .O(new_n119_));
  nand2  g86(.a(new_n119_), .b(new_n118_), .O(z7));
endmodule
