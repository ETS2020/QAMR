...
module FAU ( 
  ...
  aoi21  g056(.a(new_n89_), .b(new_n76_), .c(x13), .O(new_n90_));
  nand2  g057(.a(new_n89_), .b(new_n84_), .O(new_n91_));
  oai21  g058(.a(new_n90_), .b(new_n52_), .c(new_n91_), .O(z2));
  nand3  g059(.a(new_n47_), .b(new_n39_), .c(new_n46_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand2  g061(.a(new_n34_), .b(x00), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n57_), .O(new_n96_));
  inv1   g063(.a(x21), .O(new_n97_));
  nor3   g064(.a(new_n87_), .b(new_n69_), .c(new_n97_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(new_n99_));
  nand2  g066(.a(x07), .b(new_n34_), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n57_), .O(new_n101_));
  nor3   g068(.a(new_n87_), .b(new_n69_), .c(new_n75_), .O(new_n102_));
  inv1   g069(.a(new_n39_), .O(new_n103_));
  nor3   g070(.a(new_n81_), .b(new_n103_), .c(new_n46_), .O(new_n104_));
  oai21  g071(.a(new_n102_), .b(new_n101_), .c(new_n104_), .O(new_n105_));
  nand2  g072(.a(x19), .b(new_n56_), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n38_), .O(new_n107_));
  inv1   g074(.a(x15), .O(new_n108_));
  nor3   g075(.a(new_n87_), .b(new_n69_), .c(new_n108_), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(new_n81_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n105_), .c(new_n99_), .O(z3));
  aoi21  g078(.a(x23), .b(new_n63_), .c(new_n59_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n60_), .c(x09), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(x16), .c(new_n56_), .O(new_n114_));
  nand2  g081(.a(x15), .b(new_n40_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n80_), .c(x05), .O(new_n116_));
  nand4  g083(.a(x24), .b(x18), .c(new_n40_), .d(x05), .O(new_n117_));
  oai21  g084(.a(new_n93_), .b(new_n97_), .c(new_n117_), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  aoi21  g086(.a(new_n61_), .b(x04), .c(x17), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(x22), .c(new_n64_), .O(new_n121_));
  aoi21  g088(.a(new_n121_), .b(new_n58_), .c(x08), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n50_), .c(new_n119_), .d(new_n114_), .O(z4));
  nand3  g090(.a(x19), .b(new_n40_), .c(new_n52_), .O(new_n124_));
  oai21  g091(.a(x13), .b(x05), .c(new_n44_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n124_), .c(new_n48_), .d(new_n39_), .O(z5));
  ...
  oai21  g096(.a(new_n118_), .b(new_n116_), .c(new_n129_), .O(new_n130_));
  inv1   g097(.a(x14), .O(new_n131_));
  aoi21  g098(.a(x20), .b(new_n131_), .c(x06), .O(new_n132_));
  nor2   g099(.a(new_n103_), .b(x03), .O(new_n133_));
