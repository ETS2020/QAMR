...
module FAU ( 
  ...
  nand3  g04(.a(new_n37_), .b(x24), .c(x07), .O(new_n38_));
  inv1   g05(.a(x24), .O(new_n39_));
  nor2   g06(.a(x10), .b(x02), .O(new_n40_));
  nand3  g07(.a(new_n40_), .b(new_n39_), .c(x00), .O(new_n41_));
  nor2   g08(.a(x13), .b(x05), .O(new_n42_));
  nand2  g09(.a(new_n42_), .b(x19), .O(new_n43_));
  nand3  g10(.a(new_n43_), .b(new_n41_), .c(new_n38_), .O(new_n44_));
  ...
  nand2  g29(.a(new_n62_), .b(new_n36_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n40_), .b(new_n39_), .c(x21), .O(new_n77_));
  nand3  g44(.a(x24), .b(x18), .c(x13), .O(new_n78_));
  nand2  g45(.a(new_n42_), .b(x15), .O(new_n79_));
  ...
  nand2  g53(.a(new_n86_), .b(new_n35_), .O(new_n87_));
  nand4  g54(.a(new_n40_), .b(new_n34_), .c(new_n39_), .d(x21), .O(new_n88_));
  nand3  g55(.a(new_n61_), .b(new_n36_), .c(x05), .O(new_n89_));
  ...
  aoi21  g65(.a(new_n86_), .b(new_n35_), .c(new_n98_), .O(new_n99_));
  ...
  inv1   g77(.a(new_n97_), .O(z5));
  oai21  g78(.a(x20), .b(new_n47_), .c(x06), .O(new_n112_));
  aoi21  g79(.a(new_n112_), .b(x11), .c(new_n72_), .O(new_n113_));
  oai21  g80(.a(new_n48_), .b(x14), .c(new_n45_), .O(new_n114_));
  aoi21  g81(.a(new_n114_), .b(new_n46_), .c(x03), .O(new_n115_));
  oai22  g82(.a(new_n115_), .b(new_n97_), .c(new_n113_), .d(new_n99_), .O(z6));
endmodule
