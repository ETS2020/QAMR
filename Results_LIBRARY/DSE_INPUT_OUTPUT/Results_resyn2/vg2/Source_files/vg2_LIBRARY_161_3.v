...
module FAU ( 
  ...
  and2   g75(.a(new_n45_), .b(new_n34_), .O(z5));
  inv1   g76(.a(x11), .O(new_n110_));
  aoi21  g77(.a(new_n49_), .b(x14), .c(new_n47_), .O(new_n111_));
  oai21  g78(.a(new_n111_), .b(new_n110_), .c(x03), .O(new_n112_));
  nand3  g79(.a(new_n112_), .b(new_n86_), .c(new_n34_), .O(new_n113_));
  nand2  g80(.a(x20), .b(new_n48_), .O(new_n114_));
  aoi21  g81(.a(new_n114_), .b(new_n47_), .c(x11), .O(new_n115_));
  oai21  g82(.a(new_n115_), .b(x03), .c(new_n45_), .O(new_n116_));
  nand3  g83(.a(new_n116_), .b(new_n113_), .c(new_n34_), .O(z6));
  and2   g84(.a(new_n86_), .b(new_n34_), .O(z7));
endmodule
