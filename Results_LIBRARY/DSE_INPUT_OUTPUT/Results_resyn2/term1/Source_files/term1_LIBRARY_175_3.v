...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(new_n97_));
  ...
  xor2a  g061(.a(new_n105_), .b(new_n47_), .O(z7));
  inv1   g062(.a(x19), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x18), .c(x14), .O(new_n108_));
  nand3  g064(.a(x19), .b(new_n72_), .c(x13), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n108_), .c(new_n71_), .O(new_n110_));
  nand4  g066(.a(x19), .b(x18), .c(new_n71_), .d(x12), .O(new_n111_));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n113_), .c(new_n75_), .O(new_n118_));
  nor2   g074(.a(new_n72_), .b(new_n71_), .O(new_n119_));
  ...
  aoi21  g086(.a(new_n54_), .b(new_n99_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n71_), .O(new_n141_));
  inv1   g097(.a(x13), .O(new_n142_));
  nand2  g098(.a(new_n72_), .b(new_n142_), .O(new_n143_));
  ...
  aoi21  g111(.a(new_n72_), .b(new_n142_), .c(new_n50_), .O(new_n156_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n70_), .O(z9));
endmodule
