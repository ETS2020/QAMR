...
module FAU ( 
  ...
  nand4  g044(.a(new_n88_), .b(new_n87_), .c(new_n82_), .d(new_n46_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z4));
  inv1   g046(.a(x29), .O(new_n91_));
  oai21  g047(.a(new_n45_), .b(new_n91_), .c(new_n87_), .O(new_n92_));
  ...
  xor2a  g055(.a(new_n93_), .b(x31), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n82_), .c(new_n47_), .O(z7));
  ...
  aoi21  g075(.a(new_n88_), .b(x29), .c(new_n119_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n117_), .b(new_n115_), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n112_), .b(new_n111_), .O(new_n124_));
  nand4  g080(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  aoi21  g082(.a(new_n124_), .b(x19), .c(new_n126_), .O(new_n127_));
  ...
  aoi21  g092(.a(new_n136_), .b(x32), .c(new_n45_), .O(new_n137_));
  oai21  g093(.a(new_n118_), .b(x29), .c(new_n45_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n79_), .c(x00), .O(new_n139_));
  aoi21  g095(.a(new_n137_), .b(new_n123_), .c(new_n139_), .O(z8));
  nand2  g096(.a(new_n79_), .b(x00), .O(new_n141_));
  nand2  g097(.a(new_n88_), .b(x31), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(x30), .c(x31), .d(new_n91_), .O(new_n143_));
  oai21  g099(.a(new_n135_), .b(new_n47_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x33), .O(new_n145_));
  nand2  g101(.a(new_n46_), .b(new_n54_), .O(new_n146_));
  aoi21  g102(.a(x30), .b(new_n91_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n117_), .b(new_n115_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n145_), .c(new_n141_), .O(z9));
endmodule
