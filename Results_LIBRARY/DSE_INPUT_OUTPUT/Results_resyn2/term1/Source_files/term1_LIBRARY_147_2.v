...
module FAU ( 
  ...
  oai21  g035(.a(new_n76_), .b(new_n72_), .c(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n47_), .O(z3));
  inv1   g037(.a(x20), .O(new_n82_));
  oai21  g038(.a(new_n72_), .b(new_n82_), .c(new_n45_), .O(new_n83_));
  inv1   g039(.a(new_n78_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  aoi21  g041(.a(new_n83_), .b(new_n75_), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g052(.a(new_n96_), .b(new_n95_), .c(new_n86_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z5));
  inv1   g054(.a(x30), .O(new_n99_));
  xor2a  g055(.a(new_n96_), .b(new_n99_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(z6));
  aoi21  g058(.a(x23), .b(new_n45_), .c(x18), .O(new_n103_));
  nand2  g059(.a(new_n96_), .b(x31), .O(new_n104_));
  xor2a  g060(.a(x31), .b(x30), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n89_), .c(x29), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n104_), .c(new_n84_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  oai21  g064(.a(new_n103_), .b(new_n76_), .c(new_n108_), .O(z7));
  ...
  nand4  g077(.a(x19), .b(x17), .c(new_n116_), .d(x11), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(x15), .O(new_n124_));
  nand3  g080(.a(x17), .b(x16), .c(x10), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(x19), .c(x18), .d(new_n45_), .O(new_n127_));
  nand2  g083(.a(new_n54_), .b(x31), .O(new_n128_));
  aoi21  g084(.a(new_n127_), .b(new_n124_), .c(new_n128_), .O(new_n129_));
  ...
  aoi22  g088(.a(new_n91_), .b(x29), .c(new_n54_), .d(new_n99_), .O(new_n133_));
  oai21  g089(.a(new_n129_), .b(new_n99_), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n117_), .b(x14), .O(new_n135_));
  nand2  g091(.a(x17), .b(x11), .O(new_n136_));
  nor2   g092(.a(new_n119_), .b(new_n116_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x15), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  oai21  g095(.a(x17), .b(x12), .c(x16), .O(new_n140_));
  aoi22  g096(.a(new_n140_), .b(new_n136_), .c(new_n139_), .d(new_n135_), .O(new_n141_));
  nand2  g097(.a(new_n125_), .b(new_n45_), .O(new_n142_));
  inv1   g098(.a(x31), .O(new_n143_));
  aoi21  g099(.a(new_n138_), .b(new_n117_), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n142_), .c(new_n141_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x32), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n134_), .c(new_n132_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n112_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n115_), .O(z8));
  nand2  g105(.a(new_n127_), .b(new_n124_), .O(new_n150_));
  nand2  g106(.a(new_n127_), .b(new_n110_), .O(new_n151_));
  xor2a  g107(.a(new_n130_), .b(new_n99_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n105_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n151_), .c(new_n150_), .O(new_n154_));
  nor2   g110(.a(new_n137_), .b(x19), .O(new_n155_));
  nor2   g111(.a(new_n155_), .b(new_n105_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n141_), .c(new_n110_), .O(new_n157_));
  nand3  g113(.a(new_n126_), .b(x19), .c(x18), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n105_), .c(new_n45_), .O(new_n159_));
  nand2  g115(.a(new_n152_), .b(new_n47_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n159_), .c(x33), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n157_), .c(new_n112_), .O(new_n162_));
  aoi21  g118(.a(new_n154_), .b(new_n50_), .c(new_n162_), .O(z9));
endmodule
