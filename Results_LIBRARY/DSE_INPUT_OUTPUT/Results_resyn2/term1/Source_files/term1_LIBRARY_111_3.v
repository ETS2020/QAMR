...
module FAU ( 
  ...
  nand2  g000(.a(x26), .b(x04), .O(new_n45_));
  ...
  nand2  g048(.a(new_n92_), .b(new_n45_), .O(z5));
  ...
  xnor2a g056(.a(new_n100_), .b(new_n45_), .O(z7));
  ...
  aoi21  g079(.a(new_n83_), .b(new_n70_), .c(new_n90_), .O(new_n124_));
  ...
  nand2  g083(.a(new_n122_), .b(x30), .O(new_n128_));
  aoi21  g084(.a(new_n50_), .b(new_n94_), .c(new_n124_), .O(new_n129_));
  oai21  g085(.a(new_n114_), .b(x16), .c(x15), .O(new_n130_));
  inv1   g086(.a(x14), .O(new_n131_));
  nor2   g087(.a(x19), .b(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n117_), .b(x16), .c(x15), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n104_), .O(new_n134_));
  oai21  g090(.a(new_n133_), .b(new_n132_), .c(new_n134_), .O(new_n135_));
  aoi21  g091(.a(new_n130_), .b(new_n118_), .c(new_n135_), .O(new_n136_));
  aoi21  g092(.a(x18), .b(x12), .c(x17), .O(new_n137_));
  nor2   g093(.a(x18), .b(x13), .O(new_n138_));
  nor3   g094(.a(new_n138_), .b(new_n137_), .c(new_n120_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n136_), .c(new_n50_), .O(new_n140_));
  ...
  aoi21  g100(.a(new_n120_), .b(new_n94_), .c(new_n124_), .O(new_n145_));
  aoi21  g101(.a(new_n144_), .b(new_n124_), .c(new_n145_), .O(new_n146_));
  oai21  g102(.a(new_n119_), .b(new_n116_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  nor3   g104(.a(new_n138_), .b(new_n137_), .c(new_n47_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n136_), .c(new_n142_), .O(new_n152_));
