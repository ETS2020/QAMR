...
module FAU ( 
  ...
  and2   g036(.a(new_n80_), .b(new_n48_), .O(new_n81_));
  and2   g037(.a(x25), .b(x01), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n81_), .c(new_n70_), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(new_n45_), .c(x26), .O(z3));
  nor2   g040(.a(x30), .b(x26), .O(new_n85_));
  nand3  g041(.a(new_n85_), .b(new_n82_), .c(new_n81_), .O(new_n86_));
  ...
  nand3  g069(.a(x19), .b(new_n74_), .c(x13), .O(new_n114_));
  ...
  nand3  g082(.a(new_n45_), .b(new_n102_), .c(x00), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  oai21  g084(.a(new_n121_), .b(x16), .c(x15), .O(new_n129_));
  ...
  aoi21  g090(.a(new_n112_), .b(x14), .c(new_n134_), .O(new_n135_));
  aoi21  g091(.a(new_n134_), .b(new_n112_), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n133_), .c(new_n130_), .O(new_n137_));
  nand2  g093(.a(new_n109_), .b(x32), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n128_), .O(new_n139_));
  aoi21  g095(.a(new_n126_), .b(new_n107_), .c(new_n139_), .O(z8));
  aoi21  g096(.a(new_n91_), .b(x29), .c(x31), .O(new_n141_));
  oai21  g097(.a(new_n125_), .b(new_n123_), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n141_), .b(x33), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n137_), .c(new_n128_), .O(new_n144_));
  aoi21  g100(.a(new_n142_), .b(new_n54_), .c(new_n144_), .O(z9));
endmodule
