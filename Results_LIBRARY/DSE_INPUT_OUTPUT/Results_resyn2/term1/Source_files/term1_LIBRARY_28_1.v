...
module FAU ( 
  ...
  nand3  g054(.a(new_n98_), .b(new_n85_), .c(x29), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n97_), .c(new_n82_), .O(new_n100_));
  xor2a  g056(.a(new_n100_), .b(new_n46_), .O(z7));
  ...
  nor2   g068(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x19), .c(x18), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n111_), .c(new_n103_), .O(new_n115_));
  and2   g071(.a(x17), .b(x16), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x10), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(new_n71_), .c(new_n106_), .d(x15), .O(new_n118_));
  ...
  nand2  g081(.a(new_n116_), .b(x15), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n71_), .O(new_n127_));
  oai21  g083(.a(x17), .b(x12), .c(x16), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n112_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n127_), .c(x18), .O(new_n130_));
  nand3  g086(.a(new_n116_), .b(x19), .c(x13), .O(new_n131_));
  oai21  g087(.a(new_n117_), .b(new_n106_), .c(new_n103_), .O(new_n132_));
  nand2  g088(.a(new_n71_), .b(x14), .O(new_n133_));
  nand4  g089(.a(new_n116_), .b(new_n133_), .c(x18), .d(x15), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(x31), .O(new_n135_));
  aoi21  g091(.a(new_n131_), .b(new_n130_), .c(new_n135_), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n51_), .O(new_n137_));
  nand2  g093(.a(new_n121_), .b(x30), .O(new_n138_));
  aoi22  g094(.a(new_n87_), .b(x29), .c(new_n51_), .d(new_n102_), .O(new_n139_));
  ...
  nand3  g098(.a(x33), .b(new_n106_), .c(x00), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n126_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(x26), .O(new_n145_));
  inv1   g101(.a(x33), .O(new_n146_));
  nor2   g102(.a(new_n118_), .b(new_n115_), .O(new_n147_));
  inv1   g103(.a(new_n98_), .O(new_n148_));
  xor2a  g104(.a(new_n123_), .b(x30), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n147_), .c(new_n146_), .O(new_n151_));
  nand2  g107(.a(new_n117_), .b(new_n103_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n129_), .c(new_n127_), .O(new_n153_));
  oai21  g109(.a(new_n126_), .b(new_n71_), .c(new_n106_), .O(new_n154_));
  nor2   g110(.a(new_n98_), .b(new_n146_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n154_), .c(new_n149_), .d(new_n134_), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n141_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n151_), .O(new_n159_));
  oai21  g115(.a(new_n145_), .b(x13), .c(new_n159_), .O(z9));
endmodule
