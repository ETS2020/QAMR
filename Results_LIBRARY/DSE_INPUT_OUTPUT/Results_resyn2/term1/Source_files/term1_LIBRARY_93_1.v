...
module FAU ( 
  ...
  aoi22  g034(.a(new_n78_), .b(new_n75_), .c(x18), .d(new_n45_), .O(new_n79_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n51_), .c(new_n72_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n45_), .O(new_n110_));
  inv1   g066(.a(new_n108_), .O(new_n111_));
  inv1   g067(.a(x17), .O(new_n112_));
  nand4  g068(.a(x19), .b(new_n72_), .c(x15), .d(x13), .O(new_n113_));
  ...
  nand4  g078(.a(new_n122_), .b(x19), .c(x18), .d(new_n120_), .O(new_n123_));
  nand2  g079(.a(new_n51_), .b(x31), .O(new_n124_));
  aoi21  g080(.a(new_n123_), .b(new_n119_), .c(new_n124_), .O(new_n125_));
  ...
  oai21  g086(.a(new_n121_), .b(new_n72_), .c(new_n120_), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(x19), .c(new_n130_), .O(new_n132_));
  inv1   g088(.a(x13), .O(new_n133_));
  nor2   g089(.a(x17), .b(x12), .O(new_n134_));
  oai22  g090(.a(new_n134_), .b(new_n72_), .c(new_n112_), .d(new_n133_), .O(new_n135_));
  inv1   g091(.a(x14), .O(new_n136_));
  oai21  g092(.a(x19), .b(new_n136_), .c(new_n130_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(x31), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n132_), .c(x32), .O(new_n139_));
  inv1   g095(.a(new_n126_), .O(new_n140_));
  aoi21  g096(.a(new_n51_), .b(new_n98_), .c(new_n140_), .O(new_n141_));
  oai21  g097(.a(new_n125_), .b(new_n98_), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n139_), .c(new_n128_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n111_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n110_), .O(z8));
  nand2  g101(.a(x31), .b(x30), .O(new_n146_));
  nand2  g102(.a(x15), .b(x13), .O(new_n147_));
  nand2  g103(.a(x17), .b(x16), .O(new_n148_));
  nor3   g104(.a(new_n148_), .b(new_n147_), .c(new_n114_), .O(new_n149_));
  and2   g105(.a(new_n149_), .b(new_n48_), .O(new_n150_));
  nor2   g106(.a(new_n146_), .b(x18), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand3  g108(.a(new_n122_), .b(x19), .c(new_n120_), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand3  g110(.a(x19), .b(new_n112_), .c(x12), .O(new_n155_));
  nand3  g111(.a(new_n114_), .b(x17), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n120_), .O(new_n157_));
  nor3   g113(.a(x33), .b(new_n72_), .c(new_n45_), .O(new_n158_));
  oai21  g114(.a(new_n157_), .b(new_n154_), .c(new_n158_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n146_), .c(new_n152_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n140_), .O(new_n161_));
  oai21  g117(.a(new_n134_), .b(new_n114_), .c(new_n148_), .O(new_n162_));
  nand2  g118(.a(new_n104_), .b(new_n98_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n146_), .O(new_n164_));
  nand2  g120(.a(new_n121_), .b(new_n120_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(new_n137_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x15), .O(new_n167_));
  nand2  g123(.a(new_n164_), .b(new_n149_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n72_), .O(new_n169_));
  nand2  g125(.a(new_n140_), .b(x30), .O(new_n170_));
  nand2  g126(.a(new_n126_), .b(new_n98_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n170_), .c(new_n46_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n169_), .c(new_n167_), .O(new_n173_));
  nand2  g129(.a(new_n150_), .b(new_n72_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n159_), .O(new_n175_));
  nor2   g131(.a(new_n163_), .b(new_n140_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(new_n175_), .c(new_n173_), .d(x33), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n161_), .c(new_n108_), .O(z9));
endmodule
