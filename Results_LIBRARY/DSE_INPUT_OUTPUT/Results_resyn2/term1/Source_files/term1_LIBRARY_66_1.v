...
module FAU ( 
  ...
  nor2   g001(.a(new_n45_), .b(x28), .O(new_n46_));
  ...
  nand2  g048(.a(new_n92_), .b(new_n74_), .O(new_n93_));
  aoi21  g049(.a(x28), .b(x27), .c(new_n46_), .O(new_n94_));
  ...
  oai21  g055(.a(new_n92_), .b(new_n74_), .c(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n89_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(z5));
  xnor2a g058(.a(x30), .b(x29), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x27), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n74_), .c(new_n92_), .O(new_n106_));
  nor2   g062(.a(new_n105_), .b(x28), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(new_n45_), .c(new_n106_), .d(new_n104_), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n88_), .O(z6));
  nor2   g065(.a(new_n105_), .b(new_n99_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x27), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n45_), .c(new_n92_), .O(new_n112_));
  oai21  g068(.a(new_n111_), .b(new_n45_), .c(new_n112_), .O(new_n113_));
  oai21  g069(.a(new_n89_), .b(new_n46_), .c(new_n113_), .O(z7));
  nor2   g070(.a(new_n103_), .b(new_n45_), .O(new_n115_));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n118_), .c(new_n78_), .O(new_n121_));
  nand4  g077(.a(x19), .b(x18), .c(new_n78_), .d(x12), .O(new_n122_));
  ...
  nand3  g083(.a(new_n127_), .b(x19), .c(new_n125_), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n124_), .c(new_n116_), .O(new_n129_));
  nor2   g085(.a(new_n119_), .b(new_n78_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x16), .c(x10), .O(new_n131_));
  nor3   g087(.a(new_n131_), .b(new_n117_), .c(x15), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n129_), .c(new_n115_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n54_), .O(new_n134_));
  nand2  g090(.a(new_n85_), .b(x00), .O(new_n135_));
  aoi21  g091(.a(new_n126_), .b(new_n125_), .c(new_n117_), .O(new_n136_));
  nand3  g092(.a(new_n130_), .b(x16), .c(x15), .O(new_n137_));
  ...
  nand2  g098(.a(new_n131_), .b(new_n116_), .O(new_n143_));
  nand2  g099(.a(new_n117_), .b(x14), .O(new_n144_));
  nand2  g100(.a(new_n138_), .b(new_n144_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n143_), .c(new_n142_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n139_), .O(new_n147_));
  nand2  g103(.a(new_n115_), .b(x32), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n147_), .c(new_n135_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n134_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n47_), .O(z8));
  nand2  g108(.a(new_n110_), .b(x31), .O(new_n153_));
  nand2  g109(.a(new_n93_), .b(x29), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n45_), .c(new_n105_), .O(new_n155_));
  ...
  nand3  g115(.a(new_n110_), .b(x31), .c(x28), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n155_), .c(x33), .O(new_n161_));
  oai21  g117(.a(new_n132_), .b(new_n129_), .c(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n159_), .c(new_n135_), .O(z9));
endmodule
