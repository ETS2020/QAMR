...
module FAU ( 
  ...
  or2    g029(.a(new_n73_), .b(x26), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(x18), .O(new_n75_));
  nand2  g031(.a(new_n56_), .b(x25), .O(new_n76_));
  inv1   g032(.a(new_n76_), .O(new_n77_));
  nand2  g033(.a(new_n74_), .b(x23), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(new_n79_));
  ...
  oai21  g047(.a(new_n91_), .b(new_n79_), .c(new_n46_), .O(z5));
  ...
  oai21  g052(.a(new_n96_), .b(new_n79_), .c(new_n46_), .O(z6));
  aoi21  g053(.a(new_n73_), .b(x18), .c(new_n76_), .O(new_n98_));
  xor2a  g054(.a(new_n93_), .b(x31), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(x26), .c(new_n78_), .O(z7));
  ...
  aoi22  g084(.a(new_n85_), .b(x29), .c(new_n51_), .d(new_n94_), .O(new_n129_));
  ...
  nand2  g106(.a(new_n121_), .b(new_n94_), .O(new_n151_));
  ...
  aoi21  g111(.a(new_n153_), .b(new_n48_), .c(new_n155_), .O(z9));
endmodule
