...
module FAU ( 
  ...
  nand3  g061(.a(new_n75_), .b(x18), .c(x14), .O(new_n106_));
  ...
  nor2   g072(.a(new_n107_), .b(new_n105_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x16), .c(x10), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n75_), .c(x15), .O(new_n119_));
  ...
  aoi22  g083(.a(new_n89_), .b(x29), .c(new_n54_), .d(new_n98_), .O(new_n128_));
  ...
  nand2  g096(.a(new_n107_), .b(new_n140_), .O(new_n141_));
  ...
  nand2  g105(.a(new_n120_), .b(new_n98_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n152_), .b(new_n50_), .c(new_n154_), .O(z9));
endmodule
