...
module FAU ( 
  ...
  nand3  g008(.a(new_n52_), .b(new_n50_), .c(new_n45_), .O(z1));
  ...
  nand3  g019(.a(new_n45_), .b(new_n63_), .c(x08), .O(new_n64_));
  ...
  and2   g036(.a(new_n80_), .b(new_n76_), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n45_), .c(new_n66_), .O(new_n82_));
  ...
  nand3  g048(.a(new_n92_), .b(new_n91_), .c(new_n81_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n45_), .O(z5));
  inv1   g050(.a(x30), .O(new_n95_));
  nand2  g051(.a(new_n92_), .b(new_n95_), .O(new_n96_));
  nand2  g052(.a(new_n81_), .b(new_n45_), .O(new_n97_));
  ...
  nor3   g074(.a(new_n118_), .b(new_n70_), .c(x15), .O(new_n119_));
  nand2  g075(.a(new_n85_), .b(x29), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n95_), .c(new_n101_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n45_), .c(new_n51_), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  oai21  g079(.a(new_n119_), .b(new_n117_), .c(new_n123_), .O(new_n124_));
  inv1   g080(.a(z0), .O(new_n125_));
  oai21  g081(.a(new_n115_), .b(x16), .c(x15), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n118_), .O(new_n127_));
  nand4  g083(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n128_));
  aoi21  g084(.a(new_n70_), .b(x14), .c(new_n128_), .O(new_n129_));
  aoi21  g085(.a(new_n128_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n121_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n131_), .c(new_n125_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n124_), .c(new_n103_), .O(z8));
  nand2  g094(.a(new_n47_), .b(new_n101_), .O(new_n139_));
  aoi21  g095(.a(new_n85_), .b(x29), .c(new_n139_), .O(new_n140_));
  oai21  g096(.a(new_n119_), .b(new_n117_), .c(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n135_), .b(new_n133_), .c(new_n120_), .d(new_n101_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n130_), .c(new_n127_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(x33), .c(x30), .O(new_n145_));
  oai21  g101(.a(new_n47_), .b(x29), .c(x30), .O(new_n146_));
