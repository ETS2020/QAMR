...
module FAU ( 
  ...
  nor2   g048(.a(new_n88_), .b(x29), .O(new_n93_));
  nand2  g049(.a(new_n88_), .b(x29), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n85_), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n93_), .c(new_n47_), .O(z5));
  nor2   g052(.a(x30), .b(x29), .O(new_n97_));
  aoi21  g053(.a(new_n95_), .b(x30), .c(new_n97_), .O(z6));
  xor2a  g054(.a(new_n94_), .b(x31), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n85_), .c(new_n46_), .O(z7));
  inv1   g056(.a(x17), .O(new_n101_));
  nand3  g057(.a(new_n75_), .b(x18), .c(x14), .O(new_n102_));
  inv1   g058(.a(x18), .O(new_n103_));
  nand3  g059(.a(x19), .b(new_n103_), .c(x13), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(new_n105_));
  ...
  nor2   g070(.a(new_n103_), .b(new_n101_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x16), .c(x10), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n75_), .c(x15), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nor2   g074(.a(new_n89_), .b(new_n45_), .O(new_n119_));
  ...
  oai21  g079(.a(new_n111_), .b(x16), .c(x15), .O(new_n124_));
  inv1   g080(.a(x14), .O(new_n125_));
  nor2   g081(.a(x19), .b(new_n125_), .O(new_n126_));
  nand3  g082(.a(new_n115_), .b(x16), .c(x15), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n75_), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n126_), .c(new_n128_), .O(new_n129_));
  aoi21  g085(.a(new_n124_), .b(new_n116_), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(x18), .b(x12), .O(new_n131_));
  oai21  g087(.a(x18), .b(x13), .c(x17), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g089(.a(new_n120_), .b(x32), .c(x30), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n130_), .O(new_n136_));
  nand2  g092(.a(new_n83_), .b(x00), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n46_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  aoi21  g095(.a(new_n123_), .b(new_n54_), .c(new_n139_), .O(z8));
  aoi21  g096(.a(new_n113_), .b(x15), .c(new_n117_), .O(new_n141_));
  nand2  g097(.a(new_n118_), .b(x30), .O(new_n142_));
  oai21  g098(.a(new_n119_), .b(new_n118_), .c(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n141_), .c(new_n50_), .O(new_n144_));
  oai21  g100(.a(new_n89_), .b(new_n118_), .c(x29), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n133_), .c(x33), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n130_), .c(new_n137_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n47_), .O(z9));
endmodule
