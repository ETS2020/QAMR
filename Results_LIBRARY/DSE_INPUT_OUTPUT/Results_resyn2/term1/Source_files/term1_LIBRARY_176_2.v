...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n85_), .c(new_n57_), .O(z4));
  ...
  oai21  g053(.a(new_n97_), .b(new_n85_), .c(new_n57_), .O(z5));
  ...
  nor3   g080(.a(new_n124_), .b(new_n120_), .c(x15), .O(new_n125_));
  aoi21  g081(.a(new_n123_), .b(x15), .c(new_n125_), .O(new_n126_));
  aoi21  g082(.a(new_n88_), .b(new_n87_), .c(new_n95_), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x30), .O(new_n129_));
  aoi21  g085(.a(new_n114_), .b(new_n112_), .c(new_n119_), .O(new_n130_));
  nand4  g086(.a(x19), .b(x18), .c(new_n119_), .d(x11), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x15), .O(new_n133_));
  nor2   g089(.a(new_n75_), .b(new_n113_), .O(new_n134_));
  nor2   g090(.a(new_n124_), .b(x15), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g092(.a(new_n101_), .b(x17), .c(new_n45_), .O(new_n137_));
  aoi21  g093(.a(new_n136_), .b(new_n133_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n127_), .O(new_n139_));
  oai21  g095(.a(new_n129_), .b(new_n126_), .c(new_n139_), .O(new_n140_));
  nor2   g096(.a(x32), .b(new_n106_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  inv1   g098(.a(x15), .O(new_n143_));
  oai21  g099(.a(new_n124_), .b(new_n113_), .c(new_n143_), .O(new_n144_));
  nor2   g100(.a(new_n119_), .b(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x18), .O(new_n146_));
  oai21  g102(.a(x18), .b(x13), .c(x16), .O(new_n147_));
  nand2  g103(.a(x18), .b(x11), .O(new_n148_));
  ...
  aoi21  g107(.a(new_n151_), .b(new_n144_), .c(new_n46_), .O(new_n152_));
  aoi21  g108(.a(new_n145_), .b(new_n134_), .c(x17), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n127_), .c(x30), .O(new_n154_));
  oai21  g110(.a(new_n127_), .b(x30), .c(x17), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n45_), .O(new_n156_));
  inv1   g112(.a(new_n146_), .O(new_n157_));
  nand2  g113(.a(x30), .b(new_n111_), .O(new_n158_));
  aoi21  g114(.a(new_n75_), .b(x14), .c(new_n46_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n158_), .c(new_n157_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n156_), .c(new_n154_), .d(new_n108_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n152_), .c(x32), .O(new_n162_));
  nand2  g118(.a(new_n82_), .b(x00), .O(new_n163_));
  aoi21  g119(.a(new_n162_), .b(new_n142_), .c(new_n163_), .O(z8));
  nand3  g120(.a(new_n127_), .b(x31), .c(x30), .O(new_n165_));
  or2    g121(.a(new_n165_), .b(new_n126_), .O(new_n166_));
  nor2   g122(.a(new_n127_), .b(x31), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n138_), .c(x33), .O(new_n168_));
  inv1   g124(.a(new_n163_), .O(new_n169_));
  oai21  g125(.a(new_n167_), .b(x30), .c(x17), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n45_), .O(new_n171_));
  nand2  g127(.a(new_n127_), .b(x31), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n153_), .c(x30), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n171_), .c(new_n160_), .d(x33), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n152_), .c(new_n169_), .O(new_n175_));
  aoi21  g131(.a(new_n168_), .b(new_n166_), .c(new_n175_), .O(z9));
endmodule
