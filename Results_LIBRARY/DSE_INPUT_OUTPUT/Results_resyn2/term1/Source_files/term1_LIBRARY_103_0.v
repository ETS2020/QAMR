...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n82_), .c(new_n68_), .O(z4));
  ...
  oai21  g050(.a(new_n94_), .b(new_n82_), .c(new_n68_), .O(z5));
  ...
  nand3  g055(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  xor2a  g057(.a(new_n99_), .b(x31), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n96_), .O(z7));
  inv1   g059(.a(x31), .O(new_n104_));
  nand2  g060(.a(new_n79_), .b(x00), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n52_), .c(x25), .O(new_n106_));
  ...
  aoi21  g073(.a(new_n72_), .b(x14), .c(new_n109_), .O(new_n118_));
  nand4  g074(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n117_), .c(new_n118_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n116_), .c(new_n113_), .O(new_n121_));
  nand2  g077(.a(new_n88_), .b(x29), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n97_), .O(new_n123_));
  nand3  g079(.a(new_n88_), .b(x30), .c(x29), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n121_), .c(x32), .O(new_n126_));
  inv1   g082(.a(x17), .O(new_n127_));
  nand3  g083(.a(new_n72_), .b(x18), .c(x14), .O(new_n128_));
  ...
  nand3  g091(.a(new_n111_), .b(x19), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nor3   g093(.a(new_n119_), .b(new_n72_), .c(x15), .O(new_n138_));
  aoi21  g094(.a(new_n137_), .b(x15), .c(new_n138_), .O(new_n139_));
  and2   g095(.a(new_n124_), .b(x31), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n123_), .c(new_n52_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n139_), .c(new_n126_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n108_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n107_), .O(z8));
  aoi21  g100(.a(new_n136_), .b(new_n134_), .c(new_n117_), .O(new_n145_));
  aoi21  g101(.a(new_n122_), .b(new_n97_), .c(x31), .O(new_n146_));
  nand2  g102(.a(new_n68_), .b(new_n48_), .O(new_n147_));
  nor3   g103(.a(new_n147_), .b(new_n146_), .c(new_n140_), .O(new_n148_));
  oai21  g104(.a(new_n138_), .b(new_n145_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n121_), .b(new_n68_), .O(new_n150_));
  aoi21  g106(.a(new_n146_), .b(x25), .c(new_n140_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x33), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n149_), .c(new_n105_), .O(z9));
endmodule
