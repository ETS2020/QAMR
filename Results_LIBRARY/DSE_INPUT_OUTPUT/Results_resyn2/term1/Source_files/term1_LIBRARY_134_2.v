...
module FAU ( 
  ...
  nand3  g034(.a(new_n59_), .b(new_n49_), .c(x25), .O(new_n79_));
  inv1   g035(.a(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(x27), .c(new_n51_), .O(z3));
  ...
  oai21  g055(.a(new_n99_), .b(new_n81_), .c(new_n51_), .O(z6));
  xor2a  g056(.a(new_n96_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n83_), .O(z7));
  ...
  nor3   g074(.a(new_n118_), .b(new_n72_), .c(x15), .O(new_n119_));
  ...
  aoi21  g079(.a(new_n85_), .b(new_n84_), .c(new_n92_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  aoi21  g081(.a(z0), .b(x30), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand2  g083(.a(new_n122_), .b(x30), .O(new_n128_));
  aoi21  g084(.a(z0), .b(new_n97_), .c(new_n124_), .O(new_n129_));
