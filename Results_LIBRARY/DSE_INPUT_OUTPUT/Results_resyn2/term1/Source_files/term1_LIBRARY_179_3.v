...
module FAU ( 
  ...
  nand3  g063(.a(new_n73_), .b(x18), .c(x14), .O(new_n108_));
  ...
  aoi21  g086(.a(new_n86_), .b(new_n85_), .c(new_n94_), .O(new_n131_));
  aoi21  g087(.a(new_n50_), .b(new_n99_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g091(.a(new_n135_), .b(new_n73_), .O(new_n136_));
  nand2  g092(.a(new_n73_), .b(x14), .O(new_n137_));
  ...
  nand2  g102(.a(new_n146_), .b(new_n80_), .O(new_n147_));
  aoi21  g103(.a(new_n132_), .b(new_n130_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n129_), .c(new_n105_), .O(z8));
  nand2  g105(.a(x31), .b(x30), .O(new_n150_));
  aoi21  g106(.a(new_n123_), .b(new_n99_), .c(new_n131_), .O(new_n151_));
  aoi21  g107(.a(new_n150_), .b(new_n131_), .c(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n122_), .b(new_n119_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n47_), .O(new_n154_));
  nand4  g110(.a(new_n152_), .b(new_n144_), .c(new_n142_), .d(x33), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n140_), .c(new_n154_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n80_), .c(new_n105_), .O(z9));
endmodule
