...
module FAU ( 
  ...
  nand4  g013(.a(x06), .b(x05), .c(new_n57_), .d(new_n56_), .O(new_n58_));
  nand2  g014(.a(x05), .b(new_n57_), .O(new_n59_));
  nand2  g015(.a(x06), .b(new_n56_), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g017(.a(new_n61_), .b(new_n58_), .c(new_n55_), .O(new_n62_));
  oai21  g018(.a(new_n51_), .b(new_n55_), .c(new_n62_), .O(new_n63_));
  inv1   g019(.a(x09), .O(new_n64_));
  nand2  g020(.a(new_n64_), .b(x08), .O(new_n65_));
  aoi21  g021(.a(new_n63_), .b(new_n54_), .c(new_n65_), .O(new_n66_));
  oai21  g022(.a(new_n63_), .b(new_n54_), .c(new_n66_), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n45_), .O(z2));
  ...
  oai21  g039(.a(new_n83_), .b(new_n80_), .c(new_n45_), .O(z3));
  nand4  g040(.a(new_n45_), .b(new_n81_), .c(x25), .d(x01), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n79_), .c(new_n69_), .O(new_n87_));
  ...
  nand2  g047(.a(new_n89_), .b(new_n82_), .O(new_n92_));
  ...
  nand2  g060(.a(new_n88_), .b(new_n104_), .O(z7));
  ...
  nand2  g078(.a(new_n92_), .b(x29), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n100_), .c(new_n104_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n45_), .c(new_n50_), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  oai21  g082(.a(new_n122_), .b(new_n120_), .c(new_n126_), .O(new_n127_));
  inv1   g083(.a(z0), .O(new_n128_));
  oai21  g084(.a(new_n118_), .b(x16), .c(x15), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n121_), .O(new_n130_));
  nand4  g086(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n131_));
  aoi21  g087(.a(new_n109_), .b(x14), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(new_n109_), .c(new_n132_), .O(new_n133_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n134_), .c(new_n128_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n127_), .c(new_n106_), .O(z8));
  nand2  g097(.a(new_n47_), .b(new_n104_), .O(new_n142_));
  aoi21  g098(.a(new_n92_), .b(x29), .c(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n122_), .b(new_n120_), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n138_), .b(new_n136_), .c(new_n123_), .d(new_n104_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n133_), .c(new_n130_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(x33), .c(x30), .O(new_n148_));
  oai21  g104(.a(new_n47_), .b(x29), .c(x30), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n81_), .c(x00), .O(new_n150_));
  aoi21  g106(.a(new_n148_), .b(new_n144_), .c(new_n150_), .O(z9));
endmodule
