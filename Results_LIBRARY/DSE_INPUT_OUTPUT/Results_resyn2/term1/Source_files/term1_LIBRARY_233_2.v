...
module FAU ( 
  ...
  nand4  g036(.a(new_n80_), .b(new_n59_), .c(new_n70_), .d(x25), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(x27), .c(new_n69_), .O(z3));
  inv1   g038(.a(x27), .O(new_n83_));
  nor2   g039(.a(new_n45_), .b(new_n83_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  nand2  g041(.a(new_n45_), .b(new_n83_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(new_n81_), .c(new_n69_), .O(z4));
  ...
  oai21  g048(.a(new_n92_), .b(new_n81_), .c(new_n69_), .O(z5));
  ...
  oai21  g054(.a(new_n98_), .b(new_n81_), .c(new_n69_), .O(z6));
  nand2  g055(.a(new_n81_), .b(new_n69_), .O(new_n100_));
  nand2  g056(.a(new_n97_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(z7));
  nand2  g058(.a(new_n70_), .b(x00), .O(new_n103_));
  ...
  nor3   g074(.a(new_n118_), .b(new_n74_), .c(x15), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n117_), .c(new_n53_), .O(new_n120_));
  nand2  g076(.a(new_n53_), .b(x30), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n86_), .c(x29), .O(new_n122_));
  aoi21  g078(.a(new_n120_), .b(new_n94_), .c(new_n122_), .O(new_n123_));
  nor2   g079(.a(new_n119_), .b(new_n117_), .O(new_n124_));
  ...
  nand2  g084(.a(new_n128_), .b(new_n118_), .O(new_n129_));
  nand4  g085(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n130_));
  aoi21  g086(.a(new_n74_), .b(x14), .c(new_n130_), .O(new_n131_));
  aoi21  g087(.a(new_n130_), .b(new_n74_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  oai22  g089(.a(new_n115_), .b(x16), .c(x30), .d(x29), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(x32), .O(new_n135_));
  nand2  g091(.a(new_n86_), .b(x29), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n53_), .c(x30), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n124_), .c(new_n135_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n123_), .c(x31), .O(new_n139_));
  oai21  g095(.a(x30), .b(x27), .c(x31), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x32), .c(new_n45_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n139_), .c(new_n103_), .O(z8));
  inv1   g098(.a(x31), .O(new_n143_));
  nand2  g099(.a(x29), .b(x27), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(new_n94_), .O(new_n145_));
  nand3  g101(.a(new_n96_), .b(new_n86_), .c(x31), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n145_), .c(new_n114_), .d(new_n113_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n132_), .c(new_n129_), .O(new_n148_));
  inv1   g104(.a(new_n145_), .O(new_n149_));
  aoi21  g105(.a(x31), .b(x27), .c(x28), .O(new_n150_));
  nor3   g106(.a(new_n150_), .b(new_n94_), .c(new_n90_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(new_n49_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n124_), .O(new_n153_));
  aoi21  g109(.a(new_n148_), .b(x33), .c(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n103_), .c(new_n69_), .O(z9));
endmodule
