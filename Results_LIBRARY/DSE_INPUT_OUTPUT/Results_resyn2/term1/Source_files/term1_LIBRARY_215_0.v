...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n157_;
  nor2   g000(.a(x30), .b(x25), .O(new_n45_));
  ...
  and2   g033(.a(new_n77_), .b(new_n47_), .O(new_n78_));
  inv1   g034(.a(x25), .O(new_n79_));
  nor3   g035(.a(x26), .b(new_n79_), .c(new_n58_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(x27), .c(new_n67_), .O(z3));
  ...
  nand4  g043(.a(new_n87_), .b(new_n86_), .c(new_n80_), .d(new_n78_), .O(new_n88_));
  ...
  inv1   g052(.a(new_n78_), .O(new_n97_));
  inv1   g053(.a(x26), .O(new_n98_));
  inv1   g054(.a(x30), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n79_), .c(new_n92_), .O(new_n100_));
  nand2  g056(.a(new_n93_), .b(x30), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(x01), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n97_), .c(new_n67_), .O(z6));
  xor2a  g059(.a(new_n101_), .b(x31), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n90_), .O(z7));
  inv1   g061(.a(x32), .O(new_n106_));
  inv1   g062(.a(x15), .O(new_n107_));
  inv1   g063(.a(x17), .O(new_n108_));
  nand3  g064(.a(new_n71_), .b(x18), .c(x14), .O(new_n109_));
  ...
  nor2   g076(.a(new_n110_), .b(new_n108_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x16), .c(x10), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n71_), .c(x15), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  oai21  g080(.a(x28), .b(x27), .c(x29), .O(new_n125_));
  and2   g081(.a(new_n125_), .b(new_n99_), .O(new_n126_));
  nor2   g082(.a(new_n125_), .b(new_n99_), .O(new_n127_));
  nor3   g083(.a(new_n127_), .b(new_n126_), .c(new_n124_), .O(new_n128_));
  oai21  g084(.a(new_n123_), .b(new_n120_), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n106_), .O(new_n130_));
  nand2  g086(.a(new_n98_), .b(x00), .O(new_n131_));
  nand3  g087(.a(new_n121_), .b(x16), .c(x15), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n117_), .b(new_n116_), .c(new_n71_), .O(new_n134_));
  ...
  nand2  g094(.a(new_n71_), .b(x14), .O(new_n139_));
  nand2  g095(.a(new_n133_), .b(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n122_), .b(new_n107_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(new_n138_), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n135_), .O(new_n143_));
  nand2  g099(.a(new_n128_), .b(x32), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n143_), .c(new_n131_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n130_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n67_), .O(z8));
  nand2  g104(.a(new_n127_), .b(x31), .O(new_n149_));
  nand2  g105(.a(new_n126_), .b(new_n124_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n143_), .O(new_n152_));
  nor2   g108(.a(new_n45_), .b(new_n52_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand3  g110(.a(new_n126_), .b(new_n124_), .c(x25), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n149_), .c(x33), .O(new_n156_));
  oai21  g112(.a(new_n123_), .b(new_n120_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n154_), .c(new_n131_), .O(z9));
endmodule
