...
module FAU ( 
  ...
  nand2  g38(.a(new_n59_), .b(x25), .O(new_n83_));
  inv1   g39(.a(new_n83_), .O(new_n84_));
  nor2   g40(.a(x26), .b(x00), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n84_), .c(new_n82_), .d(new_n74_), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(z3));
  inv1   g43(.a(x00), .O(new_n88_));
  nand2  g44(.a(x28), .b(x27), .O(new_n89_));
  inv1   g45(.a(x28), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n74_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n89_), .c(new_n84_), .d(new_n82_), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n88_), .c(x26), .O(z4));
  inv1   g49(.a(x29), .O(new_n94_));
  nand2  g50(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nand3  g51(.a(x29), .b(x28), .c(x27), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n95_), .c(new_n84_), .d(new_n82_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n88_), .c(x26), .O(z5));
  xnor2a g54(.a(new_n96_), .b(x30), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n85_), .c(new_n84_), .d(new_n82_), .O(new_n100_));
  inv1   g56(.a(new_n100_), .O(z6));
  nand4  g57(.a(x30), .b(x29), .c(x28), .d(x27), .O(new_n102_));
  xor2a  g58(.a(new_n102_), .b(x31), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n84_), .c(new_n82_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n88_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n45_), .O(z7));
  inv1   g62(.a(new_n46_), .O(z9));
endmodule
