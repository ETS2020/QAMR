...
module FAU ( 
  ...
  oai21  g038(.a(x23), .b(x18), .c(new_n82_), .O(new_n83_));
  and2   g039(.a(new_n83_), .b(new_n57_), .O(new_n84_));
  inv1   g040(.a(x26), .O(new_n85_));
  nand3  g041(.a(new_n59_), .b(new_n85_), .c(x25), .O(new_n86_));
  ...
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n87_), .d(new_n83_), .O(new_n94_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n96_), .c(new_n87_), .d(new_n83_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n57_), .O(z5));
  inv1   g056(.a(x30), .O(new_n101_));
  nand2  g057(.a(new_n96_), .b(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n91_), .b(x30), .c(x29), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n102_), .c(new_n87_), .d(new_n84_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z6));
  aoi21  g061(.a(x23), .b(new_n45_), .c(x18), .O(new_n106_));
  nor2   g062(.a(new_n103_), .b(x31), .O(new_n107_));
  nand2  g063(.a(new_n103_), .b(x31), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n107_), .c(new_n57_), .O(new_n110_));
  oai21  g066(.a(new_n106_), .b(new_n81_), .c(new_n110_), .O(z7));
  ...
  nor2   g082(.a(new_n116_), .b(new_n113_), .O(new_n127_));
  ...
  nand2  g110(.a(new_n85_), .b(x00), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n57_), .O(z8));
  aoi21  g114(.a(x31), .b(x30), .c(new_n134_), .O(new_n159_));
  nand2  g115(.a(new_n130_), .b(new_n101_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n134_), .c(new_n159_), .O(new_n161_));
  oai21  g117(.a(new_n129_), .b(new_n126_), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n49_), .O(new_n163_));
  aoi21  g119(.a(new_n116_), .b(new_n150_), .c(new_n49_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n161_), .c(new_n149_), .d(new_n147_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n163_), .c(new_n156_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n57_), .O(z9));
endmodule
