...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n151_, new_n152_;
  nor2   g000(.a(x26), .b(x20), .O(new_n45_));
  ...
  nand3  g033(.a(new_n77_), .b(new_n72_), .c(x20), .O(new_n78_));
  ...
  nor2   g038(.a(new_n82_), .b(new_n71_), .O(new_n83_));
  inv1   g039(.a(new_n83_), .O(new_n84_));
  nand2  g040(.a(new_n82_), .b(new_n71_), .O(new_n85_));
  ...
  nand3  g046(.a(new_n90_), .b(new_n88_), .c(new_n77_), .O(new_n91_));
  aoi21  g047(.a(new_n91_), .b(x20), .c(x26), .O(z5));
  ...
  nor2   g054(.a(new_n94_), .b(x31), .O(new_n99_));
  nand2  g055(.a(new_n94_), .b(x31), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n77_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(x20), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n72_), .O(z7));
  ...
  aoi22  g085(.a(new_n85_), .b(x29), .c(new_n53_), .d(new_n95_), .O(new_n130_));
  ...
  nor3   g095(.a(new_n139_), .b(new_n138_), .c(new_n122_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n137_), .c(new_n53_), .O(new_n141_));
  aoi21  g097(.a(new_n130_), .b(new_n129_), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n72_), .b(x20), .c(x00), .O(new_n143_));
  aoi21  g099(.a(new_n142_), .b(new_n128_), .c(new_n143_), .O(z8));
  aoi21  g100(.a(x31), .b(x30), .c(new_n126_), .O(new_n145_));
  nand2  g101(.a(new_n122_), .b(new_n95_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n126_), .c(new_n145_), .O(new_n147_));
  oai21  g103(.a(new_n121_), .b(new_n118_), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(new_n143_), .O(new_n149_));
  nor3   g105(.a(new_n139_), .b(new_n138_), .c(new_n49_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n147_), .c(new_n137_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  aoi21  g108(.a(new_n148_), .b(new_n49_), .c(new_n152_), .O(z9));
endmodule
