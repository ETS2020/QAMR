...
module FAU ( 
  ...
  nand2  g044(.a(new_n88_), .b(new_n78_), .O(z5));
  ...
  nand2  g049(.a(new_n93_), .b(new_n78_), .O(z6));
  ...
  nand2  g100(.a(new_n144_), .b(new_n78_), .O(z8));
  aoi21  g101(.a(x31), .b(x30), .c(new_n121_), .O(new_n146_));
  nand2  g102(.a(new_n116_), .b(new_n91_), .O(new_n147_));
  ...
  aoi21  g107(.a(new_n149_), .b(new_n53_), .c(new_n151_), .O(z9));
endmodule
