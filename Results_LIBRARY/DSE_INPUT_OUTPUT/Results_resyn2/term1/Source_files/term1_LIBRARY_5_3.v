...
module FAU ( 
  ...
  nand2  g000(.a(x24), .b(x07), .O(new_n45_));
  ...
  aoi21  g056(.a(new_n93_), .b(new_n100_), .c(new_n47_), .O(new_n101_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n74_), .O(new_n111_));
  nand4  g067(.a(x19), .b(x18), .c(new_n74_), .d(x12), .O(new_n112_));
  ...
  nor2   g075(.a(new_n109_), .b(new_n74_), .O(new_n120_));
  ...
  aoi21  g082(.a(new_n87_), .b(new_n86_), .c(new_n94_), .O(new_n127_));
  ...
  aoi21  g087(.a(new_n53_), .b(new_n100_), .c(new_n127_), .O(new_n132_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n53_), .O(new_n143_));
  aoi21  g099(.a(new_n132_), .b(new_n131_), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n45_), .b(new_n81_), .c(x00), .O(new_n145_));
  ...
  nor3   g107(.a(new_n141_), .b(new_n140_), .c(new_n49_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n149_), .c(new_n139_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n151_), .c(new_n81_), .d(x00), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n45_), .O(z9));
endmodule
