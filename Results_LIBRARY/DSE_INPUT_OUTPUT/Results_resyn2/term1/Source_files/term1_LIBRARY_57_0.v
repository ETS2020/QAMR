...
module FAU ( 
  ...
  nand3  g028(.a(new_n47_), .b(x25), .c(x01), .O(new_n73_));
  aoi21  g029(.a(new_n72_), .b(new_n68_), .c(new_n73_), .O(new_n74_));
  inv1   g030(.a(x00), .O(new_n75_));
  nor2   g031(.a(x26), .b(new_n75_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(new_n74_), .c(new_n65_), .O(new_n77_));
  inv1   g033(.a(new_n77_), .O(z3));
  inv1   g034(.a(x28), .O(new_n79_));
  nor2   g035(.a(new_n79_), .b(new_n65_), .O(new_n80_));
  inv1   g036(.a(new_n80_), .O(new_n81_));
  nand2  g037(.a(new_n79_), .b(new_n65_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n81_), .c(new_n74_), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(x00), .c(x26), .O(z4));
  ...
  aoi21  g051(.a(new_n95_), .b(new_n74_), .c(new_n75_), .O(new_n96_));
  or2    g052(.a(new_n96_), .b(x26), .O(z7));
  ...
  nand2  g074(.a(new_n118_), .b(new_n91_), .O(new_n119_));
  ...
  aoi22  g080(.a(new_n82_), .b(x29), .c(new_n120_), .d(new_n91_), .O(new_n125_));
  oai21  g081(.a(new_n110_), .b(x16), .c(x15), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n114_), .O(new_n127_));
  nand3  g083(.a(new_n113_), .b(x16), .c(x15), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n100_), .O(new_n129_));
  nand2  g085(.a(new_n100_), .b(x14), .O(new_n130_));
  inv1   g086(.a(new_n128_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n129_), .c(new_n127_), .O(new_n133_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(x31), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n133_), .c(x32), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x00), .O(new_n140_));
  aoi21  g096(.a(new_n125_), .b(new_n124_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n123_), .c(x26), .O(z8));
  aoi21  g098(.a(x31), .b(x30), .c(new_n121_), .O(new_n143_));
  nand2  g099(.a(new_n116_), .b(new_n91_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n121_), .c(new_n143_), .O(new_n145_));
  oai21  g101(.a(new_n115_), .b(new_n112_), .c(new_n145_), .O(new_n146_));
  nand4  g102(.a(new_n145_), .b(new_n137_), .c(new_n135_), .d(x33), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n133_), .c(new_n76_), .O(new_n148_));
  aoi21  g104(.a(new_n146_), .b(new_n52_), .c(new_n148_), .O(z9));
endmodule
