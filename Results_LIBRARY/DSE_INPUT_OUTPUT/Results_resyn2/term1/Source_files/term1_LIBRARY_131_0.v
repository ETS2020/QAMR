...
module FAU ( 
  ...
  nand2  g060(.a(new_n104_), .b(new_n46_), .O(z6));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n96_), .c(new_n45_), .O(z7));
  ...
  nand2  g103(.a(new_n147_), .b(new_n46_), .O(z8));
  ...
  nand2  g111(.a(new_n155_), .b(new_n46_), .O(z9));
endmodule
