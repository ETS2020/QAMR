...
module FAU ( 
  ...
  nand4  g035(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n80_));
  ...
  nor3   g044(.a(new_n88_), .b(new_n87_), .c(new_n45_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n84_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z4));
  inv1   g047(.a(x29), .O(new_n92_));
  oai21  g048(.a(new_n86_), .b(new_n85_), .c(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n87_), .b(x29), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n93_), .c(new_n84_), .d(new_n68_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z5));
  xor2a  g052(.a(new_n94_), .b(x30), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n82_), .c(new_n68_), .O(z6));
  nand2  g054(.a(new_n87_), .b(x30), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x31), .O(new_n100_));
  inv1   g056(.a(x31), .O(new_n101_));
  inv1   g057(.a(new_n99_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n101_), .c(new_n92_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n100_), .c(new_n84_), .O(z7));
  inv1   g060(.a(x30), .O(new_n105_));
  aoi21  g061(.a(x32), .b(new_n105_), .c(new_n88_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n101_), .c(x32), .O(new_n107_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n72_), .O(new_n113_));
  ...
  nor2   g077(.a(new_n111_), .b(new_n72_), .O(new_n122_));
  ...
  nand3  g081(.a(new_n106_), .b(x31), .c(new_n105_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n125_), .c(new_n107_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x29), .O(new_n128_));
  nand2  g084(.a(x32), .b(new_n105_), .O(new_n129_));
  nor2   g085(.a(new_n88_), .b(new_n92_), .O(new_n130_));
  nor2   g086(.a(x32), .b(new_n105_), .O(new_n131_));
  oai21  g087(.a(new_n124_), .b(new_n121_), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n129_), .c(new_n130_), .O(new_n133_));
  oai21  g089(.a(new_n119_), .b(x16), .c(x19), .O(new_n134_));
  ...
  nand2  g094(.a(new_n123_), .b(new_n108_), .O(new_n139_));
  nand2  g095(.a(new_n109_), .b(x14), .O(new_n140_));
  inv1   g096(.a(new_n135_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n139_), .c(new_n138_), .O(new_n143_));
  aoi21  g099(.a(new_n135_), .b(new_n134_), .c(new_n143_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n52_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n133_), .c(x31), .O(new_n146_));
  ...
  aoi21  g105(.a(new_n88_), .b(new_n105_), .c(new_n92_), .O(new_n150_));
  nand2  g106(.a(x31), .b(x30), .O(new_n151_));
  oai22  g107(.a(new_n151_), .b(new_n149_), .c(new_n150_), .d(x31), .O(new_n152_));
  oai21  g108(.a(new_n144_), .b(new_n45_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x33), .O(new_n154_));
  nand2  g110(.a(new_n88_), .b(new_n105_), .O(new_n155_));
  nand2  g111(.a(new_n88_), .b(x31), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n48_), .c(x29), .O(new_n157_));
  aoi21  g113(.a(new_n151_), .b(new_n155_), .c(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n124_), .b(new_n121_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n154_), .c(new_n147_), .O(z9));
endmodule
