...
module FAU ( 
  ...
  nand2  g035(.a(new_n59_), .b(x25), .O(new_n80_));
  ...
  oai21  g047(.a(new_n76_), .b(new_n45_), .c(new_n81_), .O(new_n92_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n92_), .c(new_n47_), .O(z5));
  ...
  aoi22  g087(.a(new_n89_), .b(x29), .c(new_n54_), .d(new_n99_), .O(new_n132_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n54_), .O(new_n143_));
  aoi21  g099(.a(new_n132_), .b(new_n131_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n45_), .b(x00), .O(new_n145_));
  aoi21  g101(.a(new_n144_), .b(new_n130_), .c(new_n145_), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n128_), .O(new_n147_));
  nand2  g103(.a(new_n124_), .b(new_n99_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n128_), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n123_), .b(new_n120_), .c(new_n149_), .O(new_n150_));
  inv1   g106(.a(new_n145_), .O(new_n151_));
  nor3   g107(.a(new_n141_), .b(new_n140_), .c(new_n50_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n149_), .c(new_n139_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  aoi21  g110(.a(new_n150_), .b(new_n50_), .c(new_n154_), .O(z9));
endmodule
