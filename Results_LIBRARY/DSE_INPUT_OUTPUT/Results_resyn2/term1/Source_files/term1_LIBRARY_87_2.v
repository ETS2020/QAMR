...
module FAU ( 
  ...
  nand4  g030(.a(new_n49_), .b(new_n45_), .c(x25), .d(x01), .O(new_n75_));
  ...
  nand2  g039(.a(new_n83_), .b(new_n47_), .O(z4));
  ...
  aoi22  g079(.a(new_n82_), .b(x29), .c(new_n54_), .d(new_n90_), .O(new_n124_));
  ...
  nand2  g102(.a(new_n116_), .b(new_n90_), .O(new_n147_));
