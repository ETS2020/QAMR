...
module FAU ( 
  ...
  oai21  g040(.a(new_n84_), .b(x27), .c(new_n48_), .O(z3));
  ...
  oai21  g047(.a(new_n91_), .b(new_n84_), .c(new_n48_), .O(z4));
  ...
  oai21  g052(.a(new_n96_), .b(new_n84_), .c(new_n48_), .O(z5));
  xor2a  g053(.a(new_n93_), .b(x30), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n84_), .c(new_n48_), .O(z6));
  ...
  nand2  g059(.a(new_n102_), .b(new_n101_), .O(new_n104_));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n100_), .c(new_n47_), .O(z7));
  ...
  nand3  g069(.a(x19), .b(new_n46_), .c(x13), .O(new_n114_));
  ...
  nand4  g074(.a(x19), .b(x17), .c(new_n74_), .d(x11), .O(new_n119_));
  ...
  nor2   g078(.a(new_n111_), .b(new_n74_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(x19), .c(new_n110_), .d(x10), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n46_), .O(new_n125_));
  nor2   g081(.a(x32), .b(new_n102_), .O(new_n126_));
  oai21  g082(.a(new_n125_), .b(new_n122_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n101_), .O(new_n128_));
  nand2  g084(.a(new_n90_), .b(x29), .O(new_n129_));
  ...
  aoi21  g089(.a(new_n52_), .b(new_n101_), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g091(.a(new_n123_), .b(x19), .c(x13), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand2  g093(.a(x17), .b(x11), .O(new_n138_));
  nand2  g094(.a(new_n123_), .b(x15), .O(new_n139_));
  oai21  g095(.a(x17), .b(x12), .c(x16), .O(new_n140_));
  aoi22  g096(.a(new_n140_), .b(new_n138_), .c(new_n139_), .d(new_n112_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(x18), .c(new_n137_), .O(new_n142_));
  nand2  g098(.a(new_n123_), .b(x10), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n46_), .c(new_n110_), .O(new_n144_));
  nand2  g100(.a(new_n112_), .b(x14), .O(new_n145_));
  nand4  g101(.a(new_n123_), .b(new_n145_), .c(x18), .d(x15), .O(new_n146_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n48_), .O(z8));
  nand2  g109(.a(x33), .b(x30), .O(new_n154_));
  inv1   g110(.a(x33), .O(new_n155_));
  nand3  g111(.a(new_n123_), .b(x15), .c(x13), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n105_), .c(new_n155_), .d(x19), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n154_), .c(x18), .O(new_n159_));
  nand2  g115(.a(new_n111_), .b(x12), .O(new_n160_));
  oai21  g116(.a(x19), .b(x17), .c(x16), .O(new_n161_));
  aoi21  g117(.a(new_n160_), .b(new_n145_), .c(new_n161_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n120_), .c(x15), .O(new_n163_));
  nand2  g119(.a(new_n155_), .b(x18), .O(new_n164_));
  aoi21  g120(.a(new_n163_), .b(new_n124_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n105_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n154_), .c(x06), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n159_), .c(new_n129_), .O(new_n168_));
  nor2   g124(.a(new_n155_), .b(x30), .O(new_n169_));
  nand3  g125(.a(new_n103_), .b(new_n155_), .c(x19), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n156_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(new_n46_), .O(new_n172_));
  aoi21  g128(.a(new_n165_), .b(new_n103_), .c(new_n169_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(x06), .c(new_n172_), .O(new_n174_));
  inv1   g130(.a(new_n141_), .O(new_n175_));
  nand2  g131(.a(new_n143_), .b(new_n110_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n146_), .c(new_n106_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n175_), .c(new_n45_), .O(new_n178_));
  nand3  g134(.a(new_n157_), .b(new_n106_), .c(x19), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n46_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n178_), .c(new_n155_), .O(new_n181_));
  aoi21  g137(.a(new_n174_), .b(new_n133_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n168_), .c(new_n150_), .O(z9));
endmodule
