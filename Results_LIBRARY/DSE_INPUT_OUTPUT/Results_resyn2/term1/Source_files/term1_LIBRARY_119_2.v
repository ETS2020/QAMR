...
module FAU ( 
  ...
  and2   g037(.a(x28), .b(x27), .O(new_n82_));
  ...
  nor2   g044(.a(new_n82_), .b(x29), .O(new_n89_));
  ...
  nand4  g054(.a(new_n98_), .b(x30), .c(x29), .d(x27), .O(new_n99_));
  ...
  nand2  g058(.a(new_n102_), .b(new_n78_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n45_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n101_), .O(z7));
  ...
  nor2   g079(.a(new_n98_), .b(new_n93_), .O(new_n124_));
  oai21  g080(.a(new_n123_), .b(new_n120_), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n53_), .O(new_n126_));
  inv1   g082(.a(x29), .O(new_n127_));
  nor2   g083(.a(new_n83_), .b(new_n127_), .O(new_n128_));
  aoi21  g084(.a(x32), .b(x30), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nor2   g086(.a(new_n123_), .b(new_n120_), .O(new_n131_));
  nand3  g087(.a(new_n53_), .b(x31), .c(new_n93_), .O(new_n132_));
  oai22  g088(.a(new_n132_), .b(new_n131_), .c(new_n53_), .d(new_n93_), .O(new_n133_));
  ...
  aoi21  g096(.a(new_n134_), .b(new_n122_), .c(new_n140_), .O(new_n141_));
  inv1   g097(.a(x13), .O(new_n142_));
  nand2  g098(.a(new_n110_), .b(new_n142_), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(x17), .c(x18), .d(x12), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n98_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n141_), .c(new_n53_), .O(new_n146_));
  ...
  aoi21  g107(.a(new_n125_), .b(new_n49_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n98_), .b(new_n93_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(x33), .O(new_n154_));
  oai21  g110(.a(new_n123_), .b(new_n120_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n134_), .b(new_n122_), .O(new_n156_));
  nand2  g112(.a(new_n124_), .b(x29), .O(new_n157_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n69_), .O(z9));
endmodule
