...
module FAU ( 
  ...
  aoi22  g033(.a(new_n46_), .b(new_n45_), .c(new_n77_), .d(new_n76_), .O(new_n78_));
  ...
  nand4  g039(.a(new_n67_), .b(new_n83_), .c(x25), .d(x01), .O(new_n84_));
  ...
  nor2   g047(.a(new_n90_), .b(new_n75_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n91_), .c(new_n87_), .O(new_n94_));
  ...
  nand2  g055(.a(new_n99_), .b(new_n58_), .O(z5));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n85_), .c(new_n47_), .O(z7));
  ...
  aoi21  g113(.a(new_n45_), .b(new_n144_), .c(new_n50_), .O(new_n158_));
