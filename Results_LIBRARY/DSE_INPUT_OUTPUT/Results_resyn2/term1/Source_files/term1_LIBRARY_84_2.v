...
module FAU ( 
  ...
  nand2  g035(.a(new_n79_), .b(new_n61_), .O(new_n80_));
  ...
  nand2  g047(.a(new_n83_), .b(new_n61_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n94_), .c(new_n93_), .d(new_n79_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z5));
  nand3  g054(.a(new_n76_), .b(new_n73_), .c(x17), .O(new_n99_));
  nor2   g055(.a(x30), .b(x22), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  oai21  g058(.a(new_n78_), .b(new_n102_), .c(new_n94_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n83_), .c(new_n61_), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n101_), .O(z6));
  inv1   g061(.a(new_n46_), .O(new_n106_));
  inv1   g062(.a(x31), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(x30), .c(new_n93_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n78_), .c(new_n106_), .O(new_n109_));
  aoi21  g065(.a(new_n94_), .b(new_n107_), .c(new_n102_), .O(new_n110_));
  oai21  g066(.a(new_n94_), .b(new_n107_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n109_), .O(z7));
  ...
  and2   g086(.a(new_n130_), .b(new_n102_), .O(new_n131_));
  nor2   g087(.a(new_n130_), .b(new_n102_), .O(new_n132_));
  nor3   g088(.a(new_n132_), .b(new_n131_), .c(new_n107_), .O(new_n133_));
  oai21  g089(.a(new_n129_), .b(new_n126_), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  inv1   g091(.a(x26), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x00), .O(new_n137_));
  nand3  g093(.a(new_n127_), .b(x16), .c(x15), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n123_), .b(new_n122_), .c(new_n114_), .O(new_n140_));
  ...
  nand2  g100(.a(new_n114_), .b(x14), .O(new_n145_));
  nand2  g101(.a(new_n139_), .b(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n128_), .b(new_n113_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n146_), .c(new_n144_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n141_), .O(new_n149_));
  nand2  g105(.a(new_n133_), .b(x32), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n149_), .c(new_n137_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n135_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n106_), .O(z8));
  nand2  g110(.a(new_n132_), .b(x31), .O(new_n155_));
  nand2  g111(.a(new_n131_), .b(new_n107_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n149_), .O(new_n158_));
  nor2   g114(.a(new_n46_), .b(new_n49_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g116(.a(new_n131_), .b(new_n107_), .c(new_n45_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n155_), .c(x33), .O(new_n162_));
  oai21  g118(.a(new_n129_), .b(new_n126_), .c(new_n162_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n160_), .c(new_n137_), .O(z9));
endmodule
