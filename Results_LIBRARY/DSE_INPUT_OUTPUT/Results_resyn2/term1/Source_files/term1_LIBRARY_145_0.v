...
module FAU ( 
  ...
  nand3  g031(.a(new_n55_), .b(new_n75_), .c(x25), .O(new_n76_));
  aoi21  g032(.a(new_n74_), .b(new_n70_), .c(new_n76_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n46_), .c(new_n67_), .O(new_n78_));
  ...
  nand2  g044(.a(new_n82_), .b(new_n88_), .O(new_n89_));
  ...
  nand3  g054(.a(new_n92_), .b(new_n98_), .c(x30), .O(new_n99_));
  oai21  g055(.a(new_n45_), .b(x31), .c(new_n93_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n99_), .c(new_n77_), .O(z7));
  nand2  g057(.a(new_n75_), .b(x00), .O(new_n102_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n109_), .c(new_n105_), .O(new_n112_));
  aoi21  g068(.a(new_n107_), .b(x14), .c(new_n110_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n119_), .b(new_n116_), .c(x31), .O(new_n120_));
  or2    g076(.a(new_n120_), .b(new_n113_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n112_), .c(new_n46_), .O(new_n122_));
  nor2   g078(.a(new_n83_), .b(x30), .O(new_n123_));
  oai21  g079(.a(new_n84_), .b(new_n94_), .c(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x32), .O(new_n126_));
  nand3  g082(.a(new_n107_), .b(x18), .c(x14), .O(new_n127_));
  nand3  g083(.a(x19), .b(new_n118_), .c(x13), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(new_n114_), .O(new_n129_));
  nand4  g085(.a(x19), .b(x18), .c(new_n114_), .d(x12), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n129_), .c(x16), .O(new_n132_));
  inv1   g088(.a(new_n108_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x19), .c(new_n106_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n132_), .c(new_n103_), .O(new_n135_));
  nor3   g091(.a(new_n104_), .b(new_n107_), .c(x15), .O(new_n136_));
  oai21  g092(.a(new_n83_), .b(new_n88_), .c(x30), .O(new_n137_));
  nand2  g093(.a(new_n123_), .b(x29), .O(new_n138_));
  nand2  g094(.a(new_n50_), .b(x31), .O(new_n139_));
  aoi21  g095(.a(new_n138_), .b(new_n137_), .c(new_n139_), .O(new_n140_));
  oai21  g096(.a(new_n136_), .b(new_n135_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n126_), .c(new_n102_), .O(z8));
  inv1   g098(.a(x33), .O(new_n143_));
  oai21  g099(.a(new_n102_), .b(new_n143_), .c(x30), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n88_), .O(new_n145_));
  inv1   g101(.a(new_n102_), .O(new_n146_));
  nand2  g102(.a(new_n134_), .b(new_n132_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(x15), .c(new_n136_), .O(new_n148_));
  nand2  g104(.a(new_n84_), .b(new_n98_), .O(new_n149_));
  nand2  g105(.a(x31), .b(new_n94_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n137_), .d(new_n143_), .O(new_n151_));
  nand3  g107(.a(new_n150_), .b(new_n119_), .c(new_n116_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n123_), .O(new_n153_));
  nand2  g109(.a(new_n84_), .b(x31), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(x30), .c(new_n113_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n112_), .c(x33), .O(new_n157_));
  oai21  g113(.a(new_n151_), .b(new_n148_), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n146_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n145_), .O(z9));
endmodule
