...
module FAU ( 
  ...
  oai21  g029(.a(x23), .b(x18), .c(new_n73_), .O(new_n74_));
  ...
  nand2  g035(.a(new_n79_), .b(new_n57_), .O(z3));
  ...
  nand4  g045(.a(new_n89_), .b(new_n88_), .c(new_n78_), .d(new_n57_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z5));
  inv1   g047(.a(x30), .O(new_n92_));
  inv1   g048(.a(new_n89_), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g050(.a(new_n87_), .b(x23), .O(new_n95_));
  oai22  g051(.a(new_n95_), .b(new_n73_), .c(new_n89_), .d(x30), .O(new_n96_));
  nand2  g052(.a(new_n73_), .b(x18), .O(new_n97_));
  aoi22  g053(.a(new_n97_), .b(new_n96_), .c(new_n94_), .d(new_n74_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n76_), .c(new_n57_), .O(z6));
  inv1   g055(.a(x31), .O(new_n100_));
  nor3   g056(.a(new_n89_), .b(new_n100_), .c(new_n92_), .O(new_n101_));
  nand2  g057(.a(new_n57_), .b(new_n100_), .O(new_n102_));
  aoi21  g058(.a(new_n93_), .b(x30), .c(new_n102_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(new_n78_), .O(z7));
  ...
  nand2  g081(.a(new_n124_), .b(new_n92_), .O(new_n126_));
  ...
  nand2  g086(.a(new_n75_), .b(x00), .O(new_n131_));
  nand3  g087(.a(new_n121_), .b(x16), .c(x15), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n117_), .b(new_n116_), .c(new_n108_), .O(new_n134_));
  ...
  nand2  g094(.a(new_n108_), .b(x14), .O(new_n139_));
  nand2  g095(.a(new_n133_), .b(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n122_), .b(new_n106_), .O(new_n141_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n57_), .O(z8));
  nand3  g104(.a(new_n124_), .b(new_n100_), .c(new_n92_), .O(new_n149_));
  nand2  g105(.a(new_n125_), .b(x31), .O(new_n150_));
  ...
  inv1   g110(.a(new_n149_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n45_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n150_), .c(x33), .O(new_n157_));
  oai21  g113(.a(new_n123_), .b(new_n120_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n154_), .c(new_n131_), .O(z9));
endmodule
