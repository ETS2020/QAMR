...
module FAU ( 
  ...
  nand2  g036(.a(new_n80_), .b(new_n47_), .O(new_n81_));
  ...
  aoi21  g040(.a(new_n72_), .b(new_n45_), .c(new_n73_), .O(new_n85_));
  ...
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n86_), .d(new_n80_), .O(new_n91_));
  ...
  nand2  g057(.a(new_n93_), .b(x31), .O(new_n102_));
  xor2a  g058(.a(x31), .b(x30), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n88_), .c(x29), .O(new_n104_));
  ...
  nand2  g065(.a(x17), .b(x16), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n109_), .O(new_n111_));
  ...
  oai21  g070(.a(x17), .b(x12), .c(x16), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g072(.a(new_n108_), .b(x14), .O(new_n117_));
  nand3  g073(.a(x17), .b(x16), .c(x15), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n116_), .c(new_n113_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n112_), .c(x18), .O(new_n122_));
  nand2  g078(.a(new_n113_), .b(new_n107_), .O(new_n123_));
  nand3  g079(.a(x17), .b(x16), .c(x10), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  inv1   g081(.a(x18), .O(new_n126_));
  nor2   g082(.a(new_n109_), .b(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n125_), .c(x19), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n123_), .c(new_n45_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n122_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x32), .O(new_n131_));
  xor2a  g087(.a(new_n106_), .b(new_n98_), .O(new_n132_));
  inv1   g088(.a(x16), .O(new_n133_));
  nand3  g089(.a(new_n108_), .b(x17), .c(x14), .O(new_n134_));
  ...
  nand3  g096(.a(new_n125_), .b(x19), .c(new_n45_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n127_), .c(new_n132_), .d(new_n54_), .O(new_n143_));
  nand2  g099(.a(new_n78_), .b(x00), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n131_), .c(new_n144_), .O(z8));
  oai21  g101(.a(new_n144_), .b(new_n50_), .c(new_n45_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n126_), .O(new_n147_));
  nand4  g103(.a(new_n125_), .b(x19), .c(x18), .d(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n140_), .O(new_n149_));
  nor2   g105(.a(new_n132_), .b(new_n103_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(x33), .O(new_n151_));
  inv1   g107(.a(new_n144_), .O(new_n152_));
  inv1   g108(.a(new_n150_), .O(new_n153_));
  aoi21  g109(.a(new_n115_), .b(new_n114_), .c(new_n50_), .O(new_n154_));
  nand2  g110(.a(new_n124_), .b(new_n45_), .O(new_n155_));
  nand2  g111(.a(new_n118_), .b(new_n108_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n120_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n153_), .c(new_n152_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n151_), .c(new_n147_), .O(z9));
endmodule
