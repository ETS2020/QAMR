...
module FAU ( 
  ...
  aoi21  g082(.a(new_n54_), .b(new_n94_), .c(new_n126_), .O(new_n127_));
  ...
  aoi21  g107(.a(new_n104_), .b(new_n138_), .c(new_n50_), .O(new_n152_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n47_), .O(z9));
endmodule
