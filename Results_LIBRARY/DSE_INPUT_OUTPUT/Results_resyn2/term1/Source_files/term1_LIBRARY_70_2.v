...
module FAU ( 
  ...
  nand4  g039(.a(new_n83_), .b(new_n80_), .c(new_n77_), .d(x23), .O(new_n84_));
  xor2a  g040(.a(new_n84_), .b(new_n46_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n66_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand2  g043(.a(x25), .b(x01), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(x26), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n87_), .c(new_n74_), .O(new_n90_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n89_), .d(new_n87_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z4));
  nand2  g053(.a(new_n89_), .b(new_n66_), .O(new_n98_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n84_), .O(new_n103_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n106_), .c(new_n99_), .d(new_n85_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(z6));
  nor2   g065(.a(new_n107_), .b(x31), .O(new_n110_));
  nand2  g066(.a(new_n107_), .b(x31), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n99_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n110_), .c(new_n57_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n84_), .O(z7));
  ...
  nand3  g080(.a(new_n124_), .b(x19), .c(new_n75_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n122_), .c(new_n78_), .O(new_n126_));
  nor2   g082(.a(new_n45_), .b(new_n115_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x16), .c(x10), .O(new_n128_));
  nor3   g084(.a(new_n128_), .b(new_n116_), .c(x15), .O(new_n129_));
  ...
  nand2  g089(.a(new_n95_), .b(x29), .O(new_n134_));
  ...
  aoi21  g094(.a(new_n53_), .b(new_n105_), .c(new_n138_), .O(new_n139_));
  ...
  nand2  g106(.a(new_n45_), .b(new_n150_), .O(new_n151_));
  ...
  nand2  g115(.a(new_n130_), .b(new_n105_), .O(new_n160_));
  ...
  aoi21  g119(.a(new_n45_), .b(new_n150_), .c(new_n49_), .O(new_n164_));
