...
module FAU ( 
  ...
  nand3  g045(.a(new_n79_), .b(x30), .c(x29), .O(new_n90_));
  inv1   g046(.a(x30), .O(new_n91_));
  nand2  g047(.a(new_n86_), .b(new_n91_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n90_), .c(new_n75_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n89_), .O(z6));
  xor2a  g050(.a(new_n90_), .b(x31), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n75_), .O(new_n96_));
  xor2a  g052(.a(new_n96_), .b(new_n46_), .O(z7));
  ...
  aoi21  g076(.a(new_n78_), .b(new_n66_), .c(new_n84_), .O(new_n121_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n120_), .O(new_n137_));
  aoi21  g093(.a(new_n126_), .b(new_n125_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n45_), .b(x00), .O(new_n139_));
  aoi21  g095(.a(new_n138_), .b(new_n124_), .c(new_n139_), .O(z8));
  nand2  g096(.a(x31), .b(x30), .O(new_n141_));
  aoi21  g097(.a(new_n116_), .b(new_n91_), .c(new_n121_), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(new_n121_), .c(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n115_), .b(new_n112_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n53_), .O(new_n145_));
  nor3   g101(.a(new_n135_), .b(new_n134_), .c(new_n53_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n133_), .c(new_n139_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n89_), .O(z9));
endmodule
