...
module FAU ( 
  ...
  aoi21  g039(.a(new_n71_), .b(x18), .c(new_n78_), .O(new_n84_));
  nor3   g040(.a(new_n84_), .b(new_n80_), .c(new_n45_), .O(new_n85_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n104_), .c(new_n85_), .O(z7));
  aoi21  g062(.a(new_n87_), .b(new_n86_), .c(new_n94_), .O(new_n107_));
  ...
  nand4  g070(.a(x20), .b(x19), .c(new_n114_), .d(x13), .O(new_n115_));
  ...
  nor2   g080(.a(new_n111_), .b(new_n120_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x10), .O(new_n126_));
  nor4   g082(.a(new_n126_), .b(new_n112_), .c(new_n114_), .d(x15), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n124_), .c(new_n109_), .O(new_n128_));
  nand2  g084(.a(new_n79_), .b(x00), .O(new_n129_));
  ...
  nand2  g090(.a(new_n112_), .b(x14), .O(new_n135_));
  ...
  oai21  g097(.a(new_n141_), .b(new_n112_), .c(new_n114_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n109_), .O(new_n143_));
  aoi21  g099(.a(new_n140_), .b(x18), .c(new_n143_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n45_), .c(x32), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n130_), .O(new_n146_));
  aoi21  g102(.a(new_n128_), .b(new_n52_), .c(new_n146_), .O(z8));
  inv1   g103(.a(new_n107_), .O(new_n148_));
  inv1   g104(.a(x20), .O(new_n149_));
  nand2  g105(.a(x33), .b(x30), .O(new_n150_));
  nand3  g106(.a(new_n48_), .b(x19), .c(new_n114_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n137_), .c(new_n102_), .d(x13), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n150_), .c(new_n149_), .O(new_n154_));
  nand2  g110(.a(new_n111_), .b(x12), .O(new_n155_));
  oai21  g111(.a(x19), .b(x17), .c(x16), .O(new_n156_));
  aoi21  g112(.a(new_n155_), .b(new_n135_), .c(new_n156_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n122_), .c(x15), .O(new_n158_));
  nand4  g114(.a(new_n125_), .b(x19), .c(new_n110_), .d(x10), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(x33), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n102_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n150_), .c(new_n114_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n154_), .c(new_n148_), .O(new_n163_));
  nor2   g119(.a(new_n48_), .b(x30), .O(new_n164_));
  nand2  g120(.a(new_n152_), .b(new_n101_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n141_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n164_), .c(x20), .O(new_n167_));
  aoi21  g123(.a(new_n160_), .b(new_n101_), .c(new_n164_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n114_), .c(new_n167_), .O(new_n169_));
  oai21  g125(.a(new_n140_), .b(new_n103_), .c(x18), .O(new_n170_));
  oai21  g126(.a(new_n102_), .b(new_n101_), .c(new_n142_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x20), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n170_), .c(new_n48_), .O(new_n173_));
  aoi21  g129(.a(new_n169_), .b(new_n107_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n163_), .c(new_n129_), .O(z9));
endmodule
