...
module FAU ( 
  ...
  nand3  g033(.a(new_n60_), .b(new_n45_), .c(x25), .O(new_n78_));
  ...
  nand2  g047(.a(new_n91_), .b(new_n47_), .O(z5));
  ...
  nand2  g054(.a(new_n98_), .b(new_n79_), .O(new_n99_));
  xor2a  g055(.a(new_n99_), .b(new_n46_), .O(z7));
  ...
  nand2  g078(.a(new_n85_), .b(x29), .O(new_n123_));
  ...
  aoi21  g083(.a(new_n54_), .b(new_n94_), .c(new_n127_), .O(new_n128_));
  ...
  aoi21  g103(.a(x31), .b(x30), .c(new_n123_), .O(new_n148_));
  nand2  g104(.a(new_n119_), .b(new_n94_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n123_), .c(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n118_), .b(new_n115_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n50_), .O(new_n152_));
  aoi21  g108(.a(new_n105_), .b(new_n139_), .c(new_n50_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n150_), .c(new_n138_), .d(new_n136_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n152_), .c(new_n145_), .O(new_n155_));
