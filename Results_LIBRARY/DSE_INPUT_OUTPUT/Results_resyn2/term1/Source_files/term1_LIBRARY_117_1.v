...
module FAU ( 
  ...
  oai21  g001(.a(new_n45_), .b(x23), .c(x32), .O(z0));
  nor2   g002(.a(new_n45_), .b(x23), .O(new_n47_));
  ...
  nand2  g029(.a(new_n59_), .b(x25), .O(new_n74_));
  nor3   g030(.a(new_n74_), .b(new_n73_), .c(x26), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n69_), .O(new_n76_));
  inv1   g032(.a(new_n76_), .O(z3));
  inv1   g033(.a(x28), .O(new_n78_));
  nor2   g034(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  inv1   g035(.a(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n78_), .b(new_n69_), .O(new_n81_));
  ...
  nand3  g042(.a(new_n86_), .b(new_n84_), .c(new_n75_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(z5));
  nand3  g044(.a(new_n79_), .b(x30), .c(x29), .O(new_n89_));
  inv1   g045(.a(x30), .O(new_n90_));
  nand2  g046(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n89_), .c(new_n75_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z6));
  nor2   g049(.a(new_n72_), .b(new_n71_), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(x26), .c(x23), .O(new_n95_));
  aoi21  g051(.a(new_n94_), .b(x18), .c(new_n74_), .O(new_n96_));
  xor2a  g052(.a(new_n89_), .b(x31), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n45_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n95_), .O(z7));
  ...
  aoi22  g082(.a(new_n81_), .b(x29), .c(new_n53_), .d(new_n90_), .O(new_n127_));
  ...
  nor3   g102(.a(new_n136_), .b(new_n135_), .c(new_n49_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n144_), .c(new_n134_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  aoi21  g105(.a(new_n145_), .b(new_n49_), .c(new_n149_), .O(z9));
endmodule
