...
module FAU ( 
  ...
  and2   g032(.a(new_n76_), .b(new_n56_), .O(new_n77_));
  inv1   g033(.a(x26), .O(new_n78_));
  nand4  g034(.a(new_n65_), .b(new_n78_), .c(x25), .d(x01), .O(new_n79_));
  ...
  nand2  g041(.a(new_n85_), .b(new_n56_), .O(z4));
  ...
  nand4  g046(.a(new_n90_), .b(new_n87_), .c(new_n83_), .d(new_n77_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z5));
  nand3  g048(.a(new_n87_), .b(new_n76_), .c(x30), .O(new_n93_));
  inv1   g049(.a(x30), .O(new_n94_));
  inv1   g050(.a(new_n75_), .O(new_n95_));
  inv1   g051(.a(new_n87_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(x22), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n93_), .c(new_n79_), .O(z6));
  xor2a  g054(.a(new_n87_), .b(x31), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n76_), .c(x30), .O(new_n100_));
  inv1   g056(.a(x31), .O(new_n101_));
  nand4  g057(.a(new_n95_), .b(new_n101_), .c(new_n94_), .d(x22), .O(new_n102_));
  ...
  xor2a  g081(.a(new_n125_), .b(new_n94_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n121_), .b(x16), .c(x15), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n108_), .O(new_n131_));
  nand2  g087(.a(new_n108_), .b(x14), .O(new_n132_));
  nand4  g088(.a(new_n121_), .b(new_n132_), .c(x16), .d(x15), .O(new_n133_));
  ...
  nand2  g093(.a(new_n110_), .b(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n136_), .c(new_n126_), .d(x31), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n134_), .c(x32), .O(new_n140_));
  oai21  g096(.a(new_n127_), .b(new_n124_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n106_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n56_), .O(z8));
  xor2a  g099(.a(new_n125_), .b(new_n101_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n126_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n124_), .c(new_n48_), .O(new_n147_));
  nand4  g103(.a(new_n145_), .b(new_n138_), .c(new_n136_), .d(x33), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n134_), .O(new_n149_));
