...
module FAU ( 
  ...
  nand2  g29(.a(new_n73_), .b(new_n57_), .O(z2));
  ...
  nor3   g40(.a(new_n84_), .b(x26), .c(x00), .O(new_n85_));
  ...
  nor2   g45(.a(new_n89_), .b(new_n75_), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(new_n91_));
  nand2  g47(.a(new_n89_), .b(new_n75_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(new_n88_), .d(new_n83_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n45_), .c(x26), .O(z4));
  nor2   g50(.a(new_n90_), .b(x29), .O(new_n95_));
  nand2  g51(.a(new_n90_), .b(x29), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  nor2   g53(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n85_), .c(new_n83_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(z5));
  nand2  g56(.a(new_n97_), .b(x30), .O(new_n101_));
  inv1   g57(.a(x30), .O(new_n102_));
  nand2  g58(.a(new_n96_), .b(new_n102_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n101_), .c(new_n88_), .d(new_n83_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n45_), .c(x26), .O(z6));
  xor2a  g61(.a(new_n101_), .b(x31), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n85_), .c(new_n83_), .O(z7));
  zero   g63(.O(z9));
endmodule
