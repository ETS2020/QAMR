...
module FAU ( 
  ...
  aoi21  g084(.a(new_n51_), .b(new_n96_), .c(new_n124_), .O(new_n129_));
  ...
  aoi21  g095(.a(new_n139_), .b(new_n136_), .c(new_n51_), .O(new_n140_));
  ...
  aoi21  g100(.a(new_n120_), .b(new_n96_), .c(new_n124_), .O(new_n145_));
  ...
  nor3   g104(.a(new_n138_), .b(new_n137_), .c(new_n48_), .O(new_n149_));
  ...
  nand2  g109(.a(new_n153_), .b(new_n46_), .O(z9));
endmodule
