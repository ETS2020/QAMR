...
module FAU ( 
  ...
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n93_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(z6));
  xor2a  g059(.a(new_n99_), .b(x31), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n93_), .O(z7));
  ...
  aoi21  g087(.a(new_n51_), .b(new_n100_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g093(.a(new_n137_), .b(new_n74_), .O(new_n138_));
  ...
  nor2   g103(.a(x26), .b(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n46_), .O(z8));
  aoi21  g106(.a(x31), .b(x30), .c(new_n127_), .O(new_n151_));
  nand2  g107(.a(new_n123_), .b(new_n100_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n127_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n122_), .b(new_n119_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n48_), .O(new_n155_));
  aoi21  g111(.a(new_n109_), .b(new_n143_), .c(new_n48_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n153_), .c(new_n142_), .d(new_n140_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n155_), .c(new_n148_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n46_), .O(z9));
endmodule
