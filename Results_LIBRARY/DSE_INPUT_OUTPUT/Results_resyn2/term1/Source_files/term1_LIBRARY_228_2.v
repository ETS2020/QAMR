...
module FAU ( 
  ...
  oai21  g030(.a(x24), .b(x19), .c(new_n74_), .O(new_n75_));
  ...
  oai21  g038(.a(new_n82_), .b(new_n77_), .c(new_n57_), .O(z3));
  oai21  g039(.a(x23), .b(x18), .c(x20), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n45_), .c(new_n75_), .O(new_n85_));
  nor2   g041(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  inv1   g042(.a(x28), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n78_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n87_), .b(new_n78_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n86_), .d(new_n81_), .O(new_n91_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n93_), .c(new_n86_), .d(new_n81_), .O(new_n96_));
  ...
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n81_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n77_), .c(new_n57_), .O(z6));
  inv1   g059(.a(x31), .O(new_n104_));
  nand3  g060(.a(new_n100_), .b(new_n104_), .c(x30), .O(new_n105_));
  aoi21  g061(.a(new_n101_), .b(x31), .c(new_n80_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n105_), .c(new_n86_), .O(z7));
  inv1   g063(.a(x18), .O(new_n108_));
  inv1   g064(.a(x00), .O(new_n109_));
  nor2   g065(.a(x26), .b(new_n109_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x32), .O(new_n111_));
  ...
  nand4  g075(.a(x19), .b(x17), .c(new_n114_), .d(x11), .O(new_n120_));
  ...
  nand4  g080(.a(new_n124_), .b(x19), .c(x18), .d(new_n45_), .O(new_n125_));
  nand2  g081(.a(new_n53_), .b(x31), .O(new_n126_));
  aoi21  g082(.a(new_n125_), .b(new_n122_), .c(new_n126_), .O(new_n127_));
  ...
  aoi22  g086(.a(new_n90_), .b(x29), .c(new_n53_), .d(new_n98_), .O(new_n131_));
  oai21  g087(.a(new_n127_), .b(new_n98_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n115_), .b(x14), .O(new_n133_));
  nand2  g089(.a(x17), .b(x11), .O(new_n134_));
  nor2   g090(.a(new_n117_), .b(new_n114_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x15), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(x17), .b(x12), .c(x16), .O(new_n138_));
  aoi22  g094(.a(new_n138_), .b(new_n134_), .c(new_n137_), .d(new_n133_), .O(new_n139_));
  nand2  g095(.a(new_n123_), .b(new_n45_), .O(new_n140_));
  aoi21  g096(.a(new_n136_), .b(new_n115_), .c(new_n104_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(new_n139_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x32), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n132_), .c(new_n130_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n110_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n113_), .O(z8));
  nand2  g102(.a(new_n125_), .b(new_n122_), .O(new_n147_));
  nand2  g103(.a(new_n125_), .b(new_n108_), .O(new_n148_));
  xor2a  g104(.a(new_n128_), .b(new_n98_), .O(new_n149_));
  ...
  nor2   g108(.a(new_n135_), .b(x19), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n139_), .c(new_n108_), .O(new_n155_));
  nand3  g111(.a(new_n124_), .b(x19), .c(x18), .O(new_n156_));
  oai21  g112(.a(new_n150_), .b(new_n156_), .c(new_n45_), .O(new_n157_));
  nand2  g113(.a(new_n149_), .b(new_n57_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n157_), .c(x33), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n155_), .c(new_n110_), .O(new_n160_));
  aoi21  g116(.a(new_n152_), .b(new_n49_), .c(new_n160_), .O(z9));
endmodule
