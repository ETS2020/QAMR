...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n175_;
  nor2   g000(.a(x31), .b(x10), .O(new_n45_));
  ...
  aoi21  g057(.a(new_n101_), .b(x30), .c(new_n45_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z6));
  inv1   g060(.a(x31), .O(new_n105_));
  nor2   g061(.a(new_n101_), .b(new_n105_), .O(new_n106_));
  nor2   g062(.a(new_n105_), .b(new_n99_), .O(new_n107_));
  nor2   g063(.a(x31), .b(x30), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n101_), .c(new_n106_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n98_), .c(new_n45_), .O(z7));
  inv1   g067(.a(x10), .O(new_n112_));
  inv1   g068(.a(x15), .O(new_n113_));
  inv1   g069(.a(x00), .O(new_n114_));
  nor2   g070(.a(x26), .b(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x32), .c(new_n113_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n112_), .O(new_n118_));
  inv1   g074(.a(x17), .O(new_n119_));
  nand3  g075(.a(new_n74_), .b(x18), .c(x14), .O(new_n120_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n126_), .c(new_n113_), .O(new_n131_));
  nand3  g087(.a(x18), .b(x17), .c(x16), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x19), .c(new_n113_), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n112_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n131_), .c(new_n107_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n53_), .O(new_n137_));
  aoi22  g093(.a(new_n90_), .b(x29), .c(x32), .d(x30), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g095(.a(new_n130_), .b(new_n126_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(x15), .c(new_n135_), .O(new_n141_));
  nand2  g097(.a(new_n53_), .b(x31), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(new_n99_), .O(new_n143_));
  nand2  g099(.a(new_n90_), .b(x29), .O(new_n144_));
  aoi21  g100(.a(new_n53_), .b(x30), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  inv1   g102(.a(x14), .O(new_n147_));
  nor2   g103(.a(x19), .b(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n133_), .b(x15), .O(new_n149_));
  oai22  g105(.a(new_n149_), .b(new_n148_), .c(new_n129_), .d(x16), .O(new_n150_));
  nand2  g106(.a(new_n149_), .b(new_n74_), .O(new_n151_));
  nand2  g107(.a(new_n132_), .b(new_n113_), .O(new_n152_));
  nand2  g108(.a(x18), .b(x12), .O(new_n153_));
  oai21  g109(.a(x18), .b(x13), .c(x17), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n152_), .c(new_n151_), .d(x31), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n150_), .c(x32), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n146_), .c(new_n139_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n115_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n118_), .O(z8));
  nand2  g116(.a(new_n136_), .b(new_n49_), .O(new_n161_));
  aoi21  g117(.a(x33), .b(x31), .c(new_n144_), .O(new_n162_));
  ...
  oai21  g122(.a(new_n165_), .b(new_n131_), .c(new_n166_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n144_), .O(new_n169_));
  inv1   g125(.a(new_n109_), .O(new_n170_));
  oai21  g126(.a(new_n132_), .b(new_n112_), .c(new_n113_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n155_), .c(new_n151_), .d(new_n170_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n150_), .c(x33), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n169_), .c(new_n163_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n115_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n46_), .O(z9));
endmodule
