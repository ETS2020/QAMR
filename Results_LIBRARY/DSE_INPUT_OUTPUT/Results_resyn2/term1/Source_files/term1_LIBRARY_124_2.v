...
module FAU ( 
  ...
  nand4  g44(.a(new_n88_), .b(new_n83_), .c(new_n82_), .d(new_n80_), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(z4));
  xor2a  g46(.a(new_n86_), .b(x29), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n83_), .c(new_n82_), .d(new_n80_), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(z5));
  aoi21  g49(.a(new_n86_), .b(x29), .c(x30), .O(new_n94_));
  nand3  g50(.a(new_n86_), .b(x30), .c(x29), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nor2   g52(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n83_), .c(new_n82_), .d(new_n80_), .O(new_n98_));
  inv1   g54(.a(new_n98_), .O(z6));
  inv1   g55(.a(x00), .O(new_n100_));
  nand2  g56(.a(new_n82_), .b(new_n80_), .O(new_n101_));
  xnor2a g57(.a(new_n95_), .b(x31), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n45_), .O(z7));
