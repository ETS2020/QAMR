...
module FAU ( 
  ...
  aoi21  g063(.a(new_n107_), .b(new_n85_), .c(new_n46_), .O(z7));
  inv1   g064(.a(x15), .O(new_n109_));
  nand2  g065(.a(new_n77_), .b(x00), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n53_), .c(new_n45_), .O(new_n111_));
  ...
  aoi21  g098(.a(new_n53_), .b(new_n97_), .c(new_n142_), .O(new_n143_));
