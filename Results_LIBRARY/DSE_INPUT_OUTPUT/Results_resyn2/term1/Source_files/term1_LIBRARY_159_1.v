...
module FAU ( 
  ...
  aoi21  g036(.a(new_n80_), .b(new_n45_), .c(x27), .O(z3));
  ...
  oai21  g042(.a(x30), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z4));
  inv1   g045(.a(new_n46_), .O(new_n90_));
  ...
  oai21  g050(.a(new_n94_), .b(new_n80_), .c(new_n90_), .O(z5));
  nand3  g051(.a(x30), .b(x29), .c(x28), .O(new_n96_));
  nand2  g052(.a(new_n93_), .b(new_n45_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n80_), .c(new_n90_), .O(z6));
  xor2a  g055(.a(new_n96_), .b(x31), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n82_), .c(new_n46_), .O(z7));
  ...
  nor3   g073(.a(new_n117_), .b(new_n113_), .c(x15), .O(new_n118_));
  inv1   g074(.a(x32), .O(new_n119_));
  xor2a  g075(.a(x30), .b(x29), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n87_), .c(new_n119_), .d(x31), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n118_), .b(new_n116_), .c(new_n122_), .O(new_n123_));
  nor2   g079(.a(new_n106_), .b(new_n70_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n117_), .c(new_n103_), .O(new_n126_));
  nand2  g082(.a(new_n124_), .b(x11), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n112_), .O(new_n128_));
  nand3  g084(.a(new_n124_), .b(x16), .c(x15), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n104_), .O(new_n130_));
  nand2  g086(.a(new_n104_), .b(x14), .O(new_n131_));
  inv1   g087(.a(new_n129_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n130_), .c(new_n128_), .d(new_n126_), .O(new_n134_));
  nand2  g090(.a(x17), .b(x13), .O(new_n135_));
  oai21  g091(.a(x17), .b(x12), .c(x18), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g093(.a(new_n84_), .b(new_n83_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n137_), .c(new_n120_), .d(x31), .O(new_n139_));
  nor2   g095(.a(new_n46_), .b(new_n119_), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(new_n134_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n123_), .c(new_n102_), .O(z8));
  nand2  g098(.a(new_n115_), .b(new_n111_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(x15), .c(new_n118_), .O(new_n144_));
  inv1   g100(.a(x31), .O(new_n145_));
  oai21  g101(.a(x30), .b(x29), .c(new_n138_), .O(new_n146_));
  nand3  g102(.a(x31), .b(x30), .c(x29), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n146_), .b(new_n145_), .c(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n144_), .c(new_n53_), .O(new_n150_));
  inv1   g106(.a(new_n134_), .O(new_n151_));
  nand2  g107(.a(new_n138_), .b(x29), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n145_), .c(new_n45_), .O(new_n153_));
  nand2  g109(.a(new_n137_), .b(x33), .O(new_n154_));
  aoi21  g110(.a(new_n153_), .b(new_n147_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n151_), .c(new_n102_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n150_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n90_), .O(z9));
endmodule
