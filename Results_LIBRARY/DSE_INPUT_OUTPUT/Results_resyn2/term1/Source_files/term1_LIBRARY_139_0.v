...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n157_;
  nor2   g000(.a(x26), .b(x08), .O(new_n45_));
  ...
  aoi21  g037(.a(new_n81_), .b(x08), .c(x26), .O(z3));
  inv1   g038(.a(x08), .O(new_n83_));
  ...
  aoi22  g086(.a(new_n90_), .b(x29), .c(new_n53_), .d(new_n99_), .O(new_n131_));
  ...
  nand2  g092(.a(new_n107_), .b(x14), .O(new_n137_));
  ...
  nand2  g097(.a(new_n141_), .b(new_n106_), .O(new_n142_));
  ...
  aoi21  g104(.a(new_n148_), .b(x08), .c(x26), .O(z8));
  aoi21  g105(.a(x31), .b(x30), .c(new_n127_), .O(new_n150_));
  nand2  g106(.a(new_n123_), .b(new_n99_), .O(new_n151_));
  ...
  nand2  g110(.a(new_n84_), .b(x00), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  oai21  g112(.a(new_n154_), .b(new_n140_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n153_), .b(new_n49_), .c(new_n157_), .O(z9));
endmodule
