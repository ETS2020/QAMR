...
module FAU ( 
  ...
  nor2   g004(.a(x32), .b(x30), .O(new_n49_));
  inv1   g005(.a(new_n49_), .O(new_n50_));
  inv1   g006(.a(x33), .O(new_n51_));
  inv1   g007(.a(x02), .O(new_n52_));
  aoi21  g008(.a(x32), .b(new_n46_), .c(new_n52_), .O(new_n53_));
  oai21  g009(.a(new_n51_), .b(new_n46_), .c(new_n53_), .O(new_n54_));
  nand3  g010(.a(new_n54_), .b(new_n50_), .c(new_n48_), .O(z1));
  ...
  nand2  g015(.a(x06), .b(new_n52_), .O(new_n60_));
  ...
  nor4   g022(.a(new_n66_), .b(new_n49_), .c(x09), .d(new_n56_), .O(z2));
  ...
  nand3  g032(.a(new_n76_), .b(new_n73_), .c(new_n71_), .O(new_n77_));
  inv1   g033(.a(new_n77_), .O(new_n78_));
  inv1   g034(.a(x26), .O(new_n79_));
  nand3  g035(.a(new_n58_), .b(new_n79_), .c(x25), .O(new_n80_));
  nor2   g036(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n50_), .c(new_n68_), .O(new_n82_));
  ...
  nand2  g044(.a(new_n88_), .b(new_n50_), .O(z4));
  nand2  g045(.a(new_n85_), .b(x29), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n77_), .O(new_n91_));
  inv1   g047(.a(new_n80_), .O(new_n92_));
  oai21  g048(.a(new_n85_), .b(x29), .c(new_n92_), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n91_), .c(new_n50_), .O(z5));
  ...
  nor2   g055(.a(new_n75_), .b(new_n72_), .O(new_n100_));
  aoi21  g056(.a(x20), .b(x16), .c(x15), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n71_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n86_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n91_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x30), .O(new_n105_));
  inv1   g061(.a(new_n90_), .O(new_n106_));
  nor2   g062(.a(z0), .b(x30), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n106_), .c(new_n77_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n105_), .c(new_n80_), .O(z6));
  nand2  g065(.a(new_n106_), .b(x30), .O(new_n110_));
  xor2a  g066(.a(new_n110_), .b(x31), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n81_), .c(new_n49_), .O(z7));
  nand2  g068(.a(new_n87_), .b(x29), .O(new_n113_));
  ...
  nor2   g081(.a(new_n116_), .b(new_n97_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x16), .c(x10), .O(new_n127_));
  nor3   g083(.a(new_n127_), .b(new_n114_), .c(x15), .O(new_n128_));
  aoi21  g084(.a(new_n125_), .b(x15), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(z0), .b(x31), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n129_), .c(x30), .O(new_n131_));
  nand2  g087(.a(x18), .b(x12), .O(new_n132_));
  oai21  g088(.a(x18), .b(x13), .c(x17), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n96_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n123_), .c(x15), .O(new_n135_));
  inv1   g091(.a(x14), .O(new_n136_));
  nor2   g092(.a(x19), .b(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n126_), .b(x16), .c(x15), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n114_), .O(new_n139_));
  oai21  g095(.a(new_n138_), .b(new_n137_), .c(new_n139_), .O(new_n140_));
  aoi21  g096(.a(new_n135_), .b(new_n127_), .c(new_n140_), .O(new_n141_));
  inv1   g097(.a(x31), .O(new_n142_));
  inv1   g098(.a(x30), .O(new_n143_));
  nor2   g099(.a(new_n113_), .b(new_n143_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n141_), .c(z0), .O(new_n146_));
  aoi21  g102(.a(new_n131_), .b(new_n113_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n79_), .b(x00), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n50_), .O(z8));
  nand2  g105(.a(new_n113_), .b(new_n142_), .O(new_n150_));
  nand3  g106(.a(new_n87_), .b(x31), .c(x29), .O(new_n151_));
  aoi22  g107(.a(new_n151_), .b(x30), .c(new_n150_), .d(new_n107_), .O(new_n152_));
  oai21  g108(.a(new_n141_), .b(new_n49_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x33), .O(new_n154_));
  nand3  g110(.a(new_n113_), .b(new_n107_), .c(new_n142_), .O(new_n155_));
  nand2  g111(.a(new_n144_), .b(x31), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n51_), .O(new_n158_));
  or2    g114(.a(new_n158_), .b(new_n129_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n154_), .c(new_n148_), .O(z9));
endmodule
