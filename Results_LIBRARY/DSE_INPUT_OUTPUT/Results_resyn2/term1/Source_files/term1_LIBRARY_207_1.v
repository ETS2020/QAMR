...
module FAU ( 
  ...
  oai21  g025(.a(x23), .b(x18), .c(x15), .O(new_n70_));
  ...
  aoi22  g040(.a(new_n84_), .b(new_n83_), .c(new_n45_), .d(new_n82_), .O(new_n85_));
  ...
  nand4  g046(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n77_), .O(new_n91_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n99_), .c(new_n86_), .d(new_n77_), .O(new_n101_));
  ...
  nand3  g063(.a(x19), .b(new_n83_), .c(x13), .O(new_n108_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n112_), .c(new_n82_), .O(new_n117_));
  nor2   g073(.a(new_n83_), .b(new_n105_), .O(new_n118_));
  ...
  nand2  g102(.a(new_n75_), .b(x00), .O(new_n147_));
  ...
  aoi21  g111(.a(new_n83_), .b(new_n142_), .c(new_n54_), .O(new_n156_));
