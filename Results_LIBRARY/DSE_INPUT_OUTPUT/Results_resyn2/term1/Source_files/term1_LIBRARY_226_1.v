...
module FAU ( 
  ...
  aoi22  g034(.a(new_n78_), .b(new_n76_), .c(new_n77_), .d(new_n75_), .O(new_n79_));
  ...
  nor2   g049(.a(new_n45_), .b(new_n78_), .O(new_n94_));
  oai21  g050(.a(x27), .b(x26), .c(x28), .O(new_n95_));
  inv1   g051(.a(x28), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n74_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n95_), .c(new_n88_), .d(new_n86_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n45_), .c(new_n94_), .O(z4));
  nand3  g055(.a(x29), .b(x28), .c(x27), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  aoi21  g057(.a(x28), .b(x27), .c(x29), .O(new_n102_));
  ...
  nand2  g063(.a(new_n100_), .b(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n106_), .c(new_n91_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z6));
  xor2a  g066(.a(new_n106_), .b(x31), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n91_), .O(z7));
  nand3  g068(.a(new_n80_), .b(x18), .c(x14), .O(new_n113_));
  inv1   g069(.a(x18), .O(new_n114_));
  nand3  g070(.a(x19), .b(new_n114_), .c(x13), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(new_n76_), .O(new_n116_));
  nand4  g072(.a(x19), .b(x18), .c(new_n76_), .d(x12), .O(new_n117_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n119_), .c(new_n75_), .O(new_n124_));
  nor2   g080(.a(new_n114_), .b(new_n76_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x16), .c(x10), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n80_), .c(x15), .O(new_n127_));
  ...
  aoi22  g091(.a(new_n97_), .b(x29), .c(new_n54_), .d(new_n107_), .O(new_n136_));
  ...
  aoi21  g102(.a(new_n146_), .b(new_n143_), .c(new_n54_), .O(new_n147_));
  aoi21  g103(.a(new_n136_), .b(new_n135_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n45_), .b(x00), .O(new_n149_));
  aoi21  g105(.a(new_n148_), .b(new_n134_), .c(new_n149_), .O(z8));
  aoi21  g106(.a(x31), .b(x30), .c(new_n132_), .O(new_n151_));
  nand2  g107(.a(new_n128_), .b(new_n107_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n132_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n127_), .b(new_n124_), .c(new_n153_), .O(new_n154_));
  inv1   g110(.a(new_n149_), .O(new_n155_));
  nor3   g111(.a(new_n145_), .b(new_n144_), .c(new_n50_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n153_), .c(new_n143_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  aoi21  g114(.a(new_n154_), .b(new_n50_), .c(new_n158_), .O(z9));
endmodule
