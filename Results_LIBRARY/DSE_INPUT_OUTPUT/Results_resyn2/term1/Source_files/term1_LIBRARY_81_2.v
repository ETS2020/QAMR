...
module FAU ( 
  ...
  oai21  g027(.a(x22), .b(x17), .c(new_n71_), .O(new_n72_));
  nor3   g028(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n73_));
  nand3  g029(.a(new_n48_), .b(x25), .c(x01), .O(new_n74_));
  nor2   g030(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n45_), .O(new_n76_));
  oai21  g032(.a(new_n76_), .b(x27), .c(new_n66_), .O(z3));
  inv1   g033(.a(new_n76_), .O(new_n78_));
  ...
  nand3  g039(.a(new_n83_), .b(new_n82_), .c(new_n78_), .O(new_n84_));
  ...
  nand3  g044(.a(new_n88_), .b(new_n86_), .c(new_n78_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z5));
  xor2a  g046(.a(new_n86_), .b(x30), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n76_), .c(new_n66_), .O(z6));
  oai21  g048(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(new_n93_));
  oai21  g049(.a(new_n86_), .b(x26), .c(x31), .O(new_n94_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n98_), .c(new_n95_), .d(new_n45_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n94_), .c(new_n93_), .O(z7));
  ...
  nor2   g075(.a(x32), .b(new_n97_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n83_), .b(x29), .O(new_n124_));
  aoi21  g080(.a(new_n123_), .b(x30), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand2  g082(.a(new_n121_), .b(x30), .O(new_n127_));
  aoi22  g083(.a(new_n83_), .b(x29), .c(new_n123_), .d(new_n96_), .O(new_n128_));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n118_), .c(new_n134_), .O(new_n135_));
  aoi21  g091(.a(x18), .b(x12), .c(x17), .O(new_n136_));
  nor2   g092(.a(x18), .b(x13), .O(new_n137_));
  nor3   g093(.a(new_n137_), .b(new_n136_), .c(new_n97_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n123_), .O(new_n139_));
  aoi21  g095(.a(new_n128_), .b(new_n127_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n45_), .b(x00), .O(new_n141_));
  aoi21  g097(.a(new_n140_), .b(new_n126_), .c(new_n141_), .O(z8));
  aoi21  g098(.a(x31), .b(x30), .c(new_n124_), .O(new_n143_));
  aoi21  g099(.a(new_n124_), .b(new_n98_), .c(new_n143_), .O(new_n144_));
  oai21  g100(.a(new_n119_), .b(new_n116_), .c(new_n144_), .O(new_n145_));
  inv1   g101(.a(new_n141_), .O(new_n146_));
  nor3   g102(.a(new_n137_), .b(new_n136_), .c(new_n53_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n144_), .c(new_n135_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  aoi21  g105(.a(new_n145_), .b(new_n53_), .c(new_n149_), .O(z9));
endmodule
