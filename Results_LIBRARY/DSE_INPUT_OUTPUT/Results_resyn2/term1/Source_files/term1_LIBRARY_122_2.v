...
module FAU ( 
  ...
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n87_), .O(new_n102_));
  ...
  nor2   g075(.a(new_n45_), .b(new_n107_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x16), .c(x10), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n108_), .c(x15), .O(new_n122_));
  ...
  aoi21  g087(.a(new_n54_), .b(new_n100_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  oai21  g089(.a(new_n117_), .b(x16), .c(x15), .O(new_n134_));
  inv1   g090(.a(x14), .O(new_n135_));
  nor2   g091(.a(x19), .b(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n120_), .b(x16), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n108_), .O(new_n138_));
  oai21  g094(.a(new_n137_), .b(new_n136_), .c(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n134_), .b(new_n121_), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n50_), .O(new_n156_));
  aoi21  g112(.a(new_n45_), .b(new_n143_), .c(new_n50_), .O(new_n157_));
  ...
  nand2  g115(.a(new_n159_), .b(new_n47_), .O(z9));
endmodule
