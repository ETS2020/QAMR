...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n84_), .c(new_n46_), .O(z5));
  ...
  oai21  g057(.a(new_n101_), .b(new_n84_), .c(new_n46_), .O(z6));
  xor2a  g058(.a(new_n100_), .b(x31), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n83_), .c(new_n80_), .O(z7));
  inv1   g060(.a(x31), .O(new_n105_));
  nand2  g061(.a(new_n81_), .b(x00), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n53_), .c(x25), .O(new_n107_));
  ...
  oai21  g068(.a(new_n112_), .b(x16), .c(x19), .O(new_n113_));
  ...
  aoi21  g074(.a(new_n74_), .b(x14), .c(new_n110_), .O(new_n119_));
  nand4  g075(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n118_), .c(new_n119_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n117_), .c(new_n114_), .O(new_n122_));
  nand2  g078(.a(new_n90_), .b(x29), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n98_), .O(new_n124_));
  nand3  g080(.a(new_n90_), .b(x30), .c(x29), .O(new_n125_));
  ...
  nand3  g084(.a(new_n74_), .b(x18), .c(x14), .O(new_n129_));
  ...
  nand3  g092(.a(new_n112_), .b(x19), .c(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nor3   g094(.a(new_n120_), .b(new_n74_), .c(x15), .O(new_n139_));
  ...
  nand2  g100(.a(new_n144_), .b(new_n108_), .O(z8));
  aoi21  g101(.a(new_n137_), .b(new_n135_), .c(new_n118_), .O(new_n146_));
  aoi21  g102(.a(new_n123_), .b(new_n98_), .c(x31), .O(new_n147_));
  ...
  aoi21  g110(.a(new_n154_), .b(new_n150_), .c(new_n106_), .O(z9));
endmodule
