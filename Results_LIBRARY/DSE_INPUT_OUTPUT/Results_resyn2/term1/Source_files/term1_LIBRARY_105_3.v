...
module FAU ( 
  ...
  nand2  g036(.a(new_n61_), .b(x25), .O(new_n81_));
  ...
  nand4  g045(.a(new_n89_), .b(new_n88_), .c(new_n82_), .d(new_n45_), .O(new_n90_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n83_), .c(new_n48_), .O(z5));
  inv1   g052(.a(x30), .O(new_n97_));
  oai21  g053(.a(new_n92_), .b(new_n97_), .c(new_n45_), .O(new_n98_));
  aoi21  g054(.a(new_n92_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  and2   g055(.a(new_n99_), .b(new_n82_), .O(z6));
  xor2a  g056(.a(new_n98_), .b(new_n46_), .O(new_n101_));
  oai21  g057(.a(new_n82_), .b(new_n47_), .c(new_n101_), .O(z7));
  ...
  nor2   g075(.a(x32), .b(new_n46_), .O(new_n120_));
  oai21  g076(.a(new_n119_), .b(new_n116_), .c(new_n120_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n97_), .O(new_n122_));
  aoi21  g078(.a(new_n86_), .b(new_n85_), .c(new_n93_), .O(new_n123_));
  ...
  nand3  g101(.a(new_n124_), .b(new_n46_), .c(new_n97_), .O(new_n146_));
  nand3  g102(.a(new_n123_), .b(x31), .c(x30), .O(new_n147_));
  and2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g104(.a(new_n46_), .b(x26), .c(new_n51_), .O(new_n149_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n48_), .O(z9));
endmodule
