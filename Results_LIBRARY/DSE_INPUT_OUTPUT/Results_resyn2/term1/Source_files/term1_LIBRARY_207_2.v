...
module FAU ( 
  ...
  aoi21  g037(.a(new_n70_), .b(new_n45_), .c(new_n71_), .O(new_n82_));
  aoi21  g038(.a(new_n82_), .b(new_n75_), .c(new_n78_), .O(new_n83_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n90_), .c(new_n79_), .d(new_n76_), .O(new_n93_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n101_), .c(new_n79_), .d(new_n76_), .O(z7));
  ...
  nand2  g081(.a(new_n87_), .b(x29), .O(new_n126_));
  ...
  aoi21  g086(.a(new_n125_), .b(new_n97_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g107(.a(new_n102_), .b(new_n97_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n126_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n121_), .b(new_n118_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n54_), .O(new_n155_));
  aoi21  g111(.a(new_n45_), .b(new_n142_), .c(new_n54_), .O(new_n156_));
