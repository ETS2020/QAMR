...
module FAU ( 
  ...
  nand2  g043(.a(new_n85_), .b(new_n45_), .O(new_n88_));
  ...
  nand2  g053(.a(x30), .b(x29), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n86_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n97_), .c(new_n82_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n47_), .O(z6));
  nand2  g058(.a(new_n100_), .b(x31), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n82_), .c(new_n46_), .O(z7));
  inv1   g060(.a(x31), .O(new_n105_));
  nand2  g061(.a(new_n80_), .b(x00), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n51_), .c(new_n45_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  aoi21  g064(.a(new_n88_), .b(x29), .c(new_n96_), .O(new_n109_));
  aoi21  g065(.a(x31), .b(x28), .c(x27), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(x30), .c(new_n92_), .O(new_n111_));
  aoi21  g067(.a(new_n109_), .b(x31), .c(new_n111_), .O(new_n112_));
  inv1   g068(.a(x17), .O(new_n113_));
  nand3  g069(.a(new_n72_), .b(x18), .c(x14), .O(new_n114_));
  ...
  nor3   g083(.a(new_n127_), .b(new_n72_), .c(x15), .O(new_n128_));
  aoi21  g084(.a(new_n125_), .b(x15), .c(new_n128_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n112_), .c(new_n51_), .O(new_n130_));
  nand2  g086(.a(x18), .b(x12), .O(new_n131_));
  oai21  g087(.a(x18), .b(x13), .c(x17), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(x16), .c(new_n123_), .O(new_n134_));
  nand2  g090(.a(new_n72_), .b(x14), .O(new_n135_));
  nand4  g091(.a(new_n126_), .b(new_n135_), .c(x16), .d(x15), .O(new_n136_));
  inv1   g092(.a(x15), .O(new_n137_));
  nand2  g093(.a(new_n127_), .b(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n126_), .b(x16), .c(x15), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n72_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n138_), .c(new_n136_), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n134_), .O(new_n142_));
  inv1   g098(.a(new_n109_), .O(new_n143_));
  nand3  g099(.a(new_n88_), .b(new_n96_), .c(x29), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(new_n51_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(new_n106_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n130_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n108_), .O(z8));
  nand2  g104(.a(x29), .b(x28), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n105_), .c(new_n96_), .O(new_n150_));
  aoi22  g106(.a(new_n150_), .b(new_n110_), .c(new_n98_), .d(x31), .O(new_n151_));
  oai21  g107(.a(new_n142_), .b(new_n46_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x33), .O(new_n153_));
  aoi21  g109(.a(new_n124_), .b(new_n120_), .c(new_n137_), .O(new_n154_));
  inv1   g110(.a(new_n150_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n45_), .O(new_n156_));
  nand3  g112(.a(new_n99_), .b(new_n88_), .c(x31), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(x33), .O(new_n158_));
  oai21  g114(.a(new_n128_), .b(new_n154_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n153_), .c(new_n106_), .O(z9));
endmodule
