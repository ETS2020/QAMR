// Benchmark "FAU" written by ABC on Tue Aug 11 21:14:46 2020
...
module FAU ( 
  ...
  and2   g035(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  and2   g036(.a(x25), .b(x01), .O(new_n81_));
  nor2   g037(.a(x26), .b(x07), .O(new_n82_));
  ...
  nand2  g042(.a(new_n81_), .b(new_n80_), .O(new_n87_));
  ...
  nand3  g053(.a(new_n97_), .b(new_n95_), .c(new_n88_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n45_), .c(x26), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nand2  g056(.a(new_n95_), .b(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n90_), .b(x30), .c(x29), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n101_), .c(new_n84_), .O(new_n103_));
  ...
  nand3  g066(.a(x19), .b(new_n73_), .c(x13), .O(new_n111_));
  ...
  nor2   g076(.a(new_n73_), .b(new_n108_), .O(new_n121_));
  ...
  aoi21  g106(.a(new_n150_), .b(new_n45_), .c(x26), .O(z8));
  aoi21  g107(.a(x31), .b(x30), .c(new_n129_), .O(new_n152_));
  nand2  g108(.a(new_n124_), .b(new_n100_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n129_), .c(new_n152_), .O(new_n154_));
  oai21  g110(.a(new_n123_), .b(new_n120_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n54_), .O(new_n156_));
  aoi21  g112(.a(new_n73_), .b(new_n145_), .c(new_n54_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n154_), .c(new_n144_), .d(new_n142_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n156_), .c(x00), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n45_), .c(x26), .O(z9));
endmodule
