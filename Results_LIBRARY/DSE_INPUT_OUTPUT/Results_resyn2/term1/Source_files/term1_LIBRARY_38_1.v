...
module FAU ( 
  ...
  oai21  g044(.a(new_n77_), .b(new_n72_), .c(x26), .O(new_n89_));
  ...
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n89_), .d(new_n84_), .O(new_n94_));
  ...
  nand3  g054(.a(new_n98_), .b(new_n96_), .c(new_n86_), .O(new_n99_));
  ...
  nand2  g062(.a(new_n106_), .b(new_n86_), .O(z7));
  ...
  aoi22  g088(.a(new_n93_), .b(x29), .c(new_n53_), .d(new_n102_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n137_), .b(new_n75_), .O(new_n138_));
  nand2  g094(.a(new_n75_), .b(x14), .O(new_n139_));
  ...
  nand3  g104(.a(new_n148_), .b(new_n134_), .c(new_n131_), .O(new_n149_));
  ...
  nand4  g113(.a(new_n156_), .b(new_n146_), .c(new_n144_), .d(x33), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n142_), .c(new_n151_), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(new_n49_), .c(new_n159_), .O(z9));
endmodule
