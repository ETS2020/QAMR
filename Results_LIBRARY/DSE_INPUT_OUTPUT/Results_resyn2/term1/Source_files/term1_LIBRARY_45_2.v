...
module FAU ( 
  ...
  aoi21  g031(.a(new_n75_), .b(new_n72_), .c(new_n46_), .O(new_n76_));
  ...
  nand3  g036(.a(new_n80_), .b(new_n78_), .c(new_n68_), .O(new_n81_));
  ...
  nand2  g044(.a(new_n80_), .b(new_n69_), .O(new_n89_));
  aoi21  g045(.a(new_n70_), .b(new_n45_), .c(new_n71_), .O(new_n90_));
  aoi21  g046(.a(new_n90_), .b(new_n75_), .c(new_n89_), .O(new_n91_));
  ...
  aoi21  g055(.a(new_n99_), .b(x30), .c(new_n89_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n76_), .O(new_n101_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n91_), .c(new_n46_), .O(z7));
  ...
  nand2  g077(.a(new_n51_), .b(x31), .O(new_n122_));
  ...
  aoi22  g082(.a(new_n86_), .b(x29), .c(new_n51_), .d(new_n97_), .O(new_n127_));
  oai21  g083(.a(new_n123_), .b(new_n97_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g101(.a(new_n145_), .b(new_n104_), .O(new_n146_));
  aoi21  g102(.a(new_n121_), .b(new_n118_), .c(new_n146_), .O(new_n147_));
  inv1   g103(.a(x33), .O(new_n148_));
  nor3   g104(.a(new_n134_), .b(new_n103_), .c(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n145_), .c(new_n133_), .d(new_n130_), .O(new_n150_));
  and2   g106(.a(new_n150_), .b(x18), .O(new_n151_));
  oai21  g107(.a(new_n147_), .b(x33), .c(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n144_), .c(new_n109_), .O(z9));
endmodule
