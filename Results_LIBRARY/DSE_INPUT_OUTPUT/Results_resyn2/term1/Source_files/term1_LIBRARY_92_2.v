...
module FAU ( 
  ...
  nand2  g022(.a(new_n45_), .b(x08), .O(new_n67_));
  aoi21  g023(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(new_n68_));
  oai21  g024(.a(new_n66_), .b(new_n65_), .c(new_n68_), .O(new_n69_));
  ...
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n86_), .d(new_n47_), .O(new_n92_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n84_), .c(new_n47_), .O(z5));
  xor2a  g054(.a(new_n94_), .b(x30), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n84_), .c(new_n47_), .O(z6));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n86_), .c(new_n46_), .O(z7));
  ...
  aoi21  g087(.a(new_n54_), .b(x30), .c(new_n131_), .O(new_n132_));
  ...
  aoi21  g102(.a(new_n54_), .b(new_n104_), .c(new_n146_), .O(new_n147_));
  ...
  nand3  g110(.a(new_n50_), .b(x19), .c(new_n112_), .O(new_n155_));
  ...
  aoi21  g115(.a(new_n159_), .b(new_n154_), .c(x09), .O(new_n160_));
  ...
  nor2   g127(.a(new_n50_), .b(x30), .O(new_n172_));
