...
module FAU ( 
  ...
  nand2  g47(.a(new_n89_), .b(new_n74_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(new_n84_), .d(new_n82_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n88_), .c(x26), .O(z4));
  xor2a  g50(.a(new_n90_), .b(x29), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n85_), .c(new_n84_), .d(new_n82_), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(z5));
  nand2  g53(.a(new_n90_), .b(x29), .O(new_n98_));
  xnor2a g54(.a(new_n98_), .b(x30), .O(new_n99_));
  ...
  nand4  g59(.a(new_n103_), .b(new_n85_), .c(new_n84_), .d(new_n82_), .O(z7));
  inv1   g60(.a(new_n46_), .O(z9));
endmodule
