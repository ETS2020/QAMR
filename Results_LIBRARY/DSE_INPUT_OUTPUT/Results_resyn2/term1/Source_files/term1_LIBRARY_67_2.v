...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n94_), .d(new_n47_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z5));
  xor2a  g055(.a(new_n97_), .b(x30), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n85_), .c(new_n47_), .O(z6));
  nand2  g057(.a(new_n97_), .b(x30), .O(new_n102_));
  nand2  g058(.a(x31), .b(new_n45_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n102_), .c(new_n94_), .d(new_n47_), .O(z7));
  inv1   g060(.a(x00), .O(new_n105_));
  nor2   g061(.a(x26), .b(new_n105_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(x32), .c(x30), .O(new_n107_));
  or2    g063(.a(new_n107_), .b(x31), .O(new_n108_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n103_), .c(new_n54_), .O(new_n126_));
  nand2  g082(.a(new_n91_), .b(x29), .O(new_n127_));
  aoi21  g083(.a(x32), .b(new_n45_), .c(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g085(.a(x32), .b(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n54_), .b(x30), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n125_), .c(new_n130_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n127_), .O(new_n133_));
  aoi21  g089(.a(new_n118_), .b(new_n117_), .c(new_n75_), .O(new_n134_));
  ...
  nand2  g097(.a(new_n123_), .b(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n75_), .b(x14), .O(new_n143_));
  nand2  g099(.a(new_n136_), .b(new_n143_), .O(new_n144_));
  ...
  nand2  g104(.a(new_n148_), .b(new_n108_), .O(z8));
  nand2  g105(.a(new_n127_), .b(x31), .O(new_n150_));
  oai21  g106(.a(new_n127_), .b(x30), .c(new_n150_), .O(new_n151_));
  or2    g107(.a(new_n151_), .b(new_n125_), .O(new_n152_));
  nor2   g108(.a(new_n145_), .b(new_n137_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(x33), .c(new_n46_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n151_), .c(new_n106_), .O(new_n155_));
  aoi21  g111(.a(new_n152_), .b(new_n50_), .c(new_n155_), .O(z9));
endmodule
