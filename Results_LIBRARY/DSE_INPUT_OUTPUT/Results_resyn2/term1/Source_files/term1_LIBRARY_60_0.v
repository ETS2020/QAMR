...
module FAU ( 
  ...
  nand2  g034(.a(new_n58_), .b(new_n78_), .O(new_n79_));
  aoi21  g035(.a(new_n77_), .b(new_n73_), .c(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(x25), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(x27), .c(new_n56_), .O(z3));
  ...
  nand4  g043(.a(new_n87_), .b(new_n86_), .c(new_n80_), .d(x25), .O(new_n88_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n81_), .c(new_n56_), .O(z5));
  ...
  oai21  g054(.a(new_n98_), .b(new_n81_), .c(new_n56_), .O(z6));
  inv1   g055(.a(x31), .O(new_n100_));
  inv1   g056(.a(x25), .O(new_n101_));
  nor2   g057(.a(new_n97_), .b(new_n101_), .O(new_n102_));
  xor2a  g058(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  oai21  g059(.a(new_n80_), .b(new_n45_), .c(new_n103_), .O(z7));
  ...
  oai21  g081(.a(new_n125_), .b(new_n122_), .c(new_n107_), .O(new_n126_));
  nand2  g082(.a(x18), .b(x12), .O(new_n127_));
  oai21  g083(.a(x18), .b(x13), .c(x17), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(x16), .c(new_n120_), .O(new_n130_));
  nand3  g086(.a(new_n123_), .b(x16), .c(x15), .O(new_n131_));
  aoi21  g087(.a(new_n110_), .b(x14), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n124_), .b(new_n108_), .O(new_n133_));
  nand2  g089(.a(new_n131_), .b(new_n110_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nor3   g091(.a(new_n135_), .b(new_n132_), .c(new_n130_), .O(new_n136_));
  nor3   g092(.a(new_n106_), .b(new_n52_), .c(new_n100_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand2  g094(.a(new_n78_), .b(x00), .O(new_n139_));
  aoi21  g095(.a(x32), .b(x25), .c(x31), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  aoi21  g098(.a(new_n126_), .b(new_n52_), .c(new_n142_), .O(z8));
  xor2a  g099(.a(new_n105_), .b(new_n100_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n107_), .O(new_n145_));
  oai21  g101(.a(new_n125_), .b(new_n122_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n48_), .O(new_n147_));
  nand2  g103(.a(new_n145_), .b(x33), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n136_), .c(new_n139_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n56_), .O(z9));
endmodule
