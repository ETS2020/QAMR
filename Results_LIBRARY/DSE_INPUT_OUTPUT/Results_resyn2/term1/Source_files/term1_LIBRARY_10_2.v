...
module FAU ( 
  ...
  and2   g043(.a(x28), .b(x27), .O(new_n88_));
  ...
  aoi21  g048(.a(x30), .b(x29), .c(new_n88_), .O(new_n93_));
  ...
  oai21  g055(.a(new_n97_), .b(new_n99_), .c(new_n70_), .O(z6));
  xor2a  g056(.a(new_n96_), .b(x31), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n95_), .c(new_n46_), .O(z7));
  oai21  g058(.a(new_n89_), .b(new_n45_), .c(x31), .O(new_n103_));
  or2    g059(.a(new_n103_), .b(new_n99_), .O(new_n104_));
  ...
  nor2   g073(.a(new_n74_), .b(new_n105_), .O(new_n118_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n104_), .c(new_n53_), .O(new_n122_));
  ...
  nand2  g084(.a(new_n128_), .b(new_n106_), .O(new_n129_));
  ...
  nor2   g091(.a(new_n135_), .b(new_n104_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n131_), .c(new_n124_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n122_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n70_), .O(z8));
  oai21  g095(.a(x31), .b(new_n99_), .c(new_n103_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n121_), .c(new_n49_), .O(new_n141_));
  inv1   g097(.a(x31), .O(new_n142_));
  oai21  g098(.a(new_n89_), .b(new_n142_), .c(x29), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n134_), .c(x33), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n131_), .c(new_n124_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n70_), .O(z9));
endmodule
