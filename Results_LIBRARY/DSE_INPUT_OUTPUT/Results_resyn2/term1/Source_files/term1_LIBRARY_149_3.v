...
module FAU ( 
  ...
  nand2  g14(.a(new_n49_), .b(new_n52_), .O(new_n59_));
  nand2  g15(.a(x03), .b(x02), .O(new_n60_));
  aoi21  g16(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  nand2  g17(.a(x05), .b(new_n49_), .O(new_n62_));
  nand2  g18(.a(x06), .b(new_n52_), .O(new_n63_));
  xor2a  g19(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g20(.a(new_n64_), .b(new_n58_), .c(new_n61_), .O(new_n65_));
  ...
  oai21  g26(.a(x20), .b(x15), .c(x23), .O(new_n71_));
  nand2  g27(.a(x20), .b(x18), .O(new_n72_));
  ...
  nand4  g35(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n80_));
  nor2   g36(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  and2   g37(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n70_), .O(new_n83_));
  ...
  nand2  g43(.a(new_n87_), .b(new_n82_), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(z4));
  inv1   g45(.a(new_n80_), .O(new_n90_));
  and2   g46(.a(new_n71_), .b(x15), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n78_), .c(new_n90_), .O(new_n92_));
  xnor2a g48(.a(new_n85_), .b(x29), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n92_), .c(new_n45_), .O(z5));
  inv1   g50(.a(x30), .O(new_n95_));
  nand2  g51(.a(new_n85_), .b(x29), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand3  g53(.a(new_n85_), .b(x30), .c(x29), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n92_), .c(new_n45_), .O(z6));
  xor2a  g56(.a(new_n98_), .b(x31), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n82_), .O(z7));
  oai21  g58(.a(x28), .b(x27), .c(x29), .O(new_n103_));
  xor2a  g59(.a(new_n103_), .b(new_n95_), .O(new_n104_));
  ...
  nand3  g72(.a(new_n116_), .b(new_n79_), .c(x00), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n45_), .O(z8));
  nand2  g74(.a(new_n79_), .b(x00), .O(new_n119_));
  ...
  nor3   g86(.a(new_n107_), .b(new_n46_), .c(x33), .O(new_n131_));
