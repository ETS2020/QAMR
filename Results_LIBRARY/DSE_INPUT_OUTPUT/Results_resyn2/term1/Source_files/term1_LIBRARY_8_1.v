...
module FAU ( 
  ...
  nand2  g038(.a(new_n82_), .b(new_n65_), .O(z3));
  ...
  nand4  g043(.a(new_n87_), .b(new_n86_), .c(new_n81_), .d(new_n65_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z4));
  aoi21  g045(.a(new_n85_), .b(new_n45_), .c(x29), .O(new_n90_));
  aoi21  g046(.a(new_n85_), .b(x29), .c(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n81_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z5));
  nand2  g049(.a(new_n85_), .b(x30), .O(new_n94_));
  nand2  g050(.a(new_n86_), .b(new_n45_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n81_), .d(x29), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z6));
  nor2   g053(.a(x31), .b(new_n45_), .O(new_n98_));
  aoi22  g054(.a(new_n98_), .b(new_n85_), .c(new_n94_), .d(x31), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n81_), .c(new_n46_), .O(z7));
  nand4  g056(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n101_));
  ...
  aoi21  g061(.a(new_n105_), .b(x19), .c(new_n102_), .O(new_n106_));
  nand2  g062(.a(x17), .b(x13), .O(new_n107_));
  oai21  g063(.a(x17), .b(x12), .c(x18), .O(new_n108_));
  ...
  nand3  g071(.a(new_n115_), .b(new_n112_), .c(new_n109_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n106_), .c(new_n65_), .O(new_n117_));
  nand2  g073(.a(new_n87_), .b(x29), .O(new_n118_));
  xor2a  g074(.a(new_n118_), .b(new_n45_), .O(new_n119_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n124_), .c(new_n71_), .O(new_n127_));
  nand4  g083(.a(x19), .b(x18), .c(new_n71_), .d(x12), .O(new_n128_));
  ...
  nand3  g088(.a(new_n132_), .b(new_n103_), .c(x11), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n130_), .c(new_n113_), .O(new_n134_));
  nand3  g090(.a(x16), .b(new_n113_), .c(x10), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand3  g092(.a(new_n45_), .b(new_n84_), .c(new_n68_), .O(new_n137_));
  nand2  g093(.a(new_n87_), .b(x30), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(x29), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(x32), .c(new_n120_), .O(new_n140_));
  oai21  g096(.a(new_n136_), .b(new_n134_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n79_), .b(x00), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(new_n123_), .c(new_n142_), .O(z8));
  nor2   g099(.a(new_n120_), .b(x30), .O(new_n144_));
  ...
  oai21  g103(.a(new_n136_), .b(new_n134_), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(new_n106_), .O(new_n149_));
  inv1   g105(.a(new_n116_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n145_), .b(new_n139_), .O(new_n152_));
  nor2   g108(.a(new_n46_), .b(new_n53_), .O(new_n153_));
  oai21  g109(.a(new_n152_), .b(new_n151_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n148_), .c(new_n142_), .O(z9));
endmodule
