...
module FAU ( 
  ...
  aoi22  g034(.a(new_n45_), .b(new_n77_), .c(new_n78_), .d(new_n76_), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n75_), .c(new_n72_), .O(new_n80_));
  nand4  g036(.a(new_n49_), .b(new_n46_), .c(x25), .d(x01), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(x27), .c(new_n58_), .O(z3));
  ...
  oai21  g046(.a(new_n90_), .b(new_n83_), .c(new_n58_), .O(z4));
  ...
  nand3  g071(.a(new_n115_), .b(x19), .c(new_n73_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n113_), .c(new_n106_), .O(new_n117_));
  nor2   g073(.a(new_n108_), .b(new_n76_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x16), .c(x10), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n77_), .c(x15), .O(new_n120_));
  ...
  nand2  g084(.a(new_n123_), .b(x30), .O(new_n129_));
  aoi22  g085(.a(new_n89_), .b(x29), .c(new_n125_), .d(new_n98_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  oai21  g087(.a(new_n115_), .b(x16), .c(x15), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n119_), .O(new_n133_));
  nand3  g089(.a(new_n118_), .b(x16), .c(x15), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n77_), .O(new_n135_));
  nand2  g091(.a(new_n77_), .b(x14), .O(new_n136_));
  ...
  nand2  g098(.a(new_n108_), .b(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n141_), .c(x31), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n139_), .c(x32), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n131_), .c(new_n128_), .O(new_n146_));
  inv1   g102(.a(x00), .O(new_n147_));
  nor2   g103(.a(x26), .b(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n58_), .O(z8));
  aoi21  g106(.a(x31), .b(x30), .c(new_n126_), .O(new_n151_));
  nand2  g107(.a(new_n121_), .b(new_n98_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n126_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n120_), .b(new_n117_), .c(new_n153_), .O(new_n154_));
  nand4  g110(.a(new_n153_), .b(new_n143_), .c(new_n141_), .d(x33), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n139_), .c(new_n148_), .O(new_n156_));
  aoi21  g112(.a(new_n154_), .b(new_n55_), .c(new_n156_), .O(z9));
endmodule
