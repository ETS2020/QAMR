...
module FAU ( 
  ...
  nand2  g035(.a(new_n58_), .b(new_n79_), .O(new_n80_));
  ...
  nand2  g053(.a(new_n93_), .b(x30), .O(new_n98_));
  ...
  nand3  g058(.a(new_n93_), .b(x30), .c(x25), .O(new_n103_));
  xor2a  g059(.a(new_n103_), .b(x31), .O(new_n104_));
  oai21  g060(.a(new_n81_), .b(new_n45_), .c(new_n104_), .O(z7));
  ...
  aoi21  g086(.a(new_n130_), .b(x16), .c(new_n121_), .O(new_n131_));
  nand3  g087(.a(new_n124_), .b(x16), .c(x15), .O(new_n132_));
  aoi21  g088(.a(new_n111_), .b(x14), .c(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n125_), .b(new_n109_), .O(new_n134_));
  nand2  g090(.a(new_n132_), .b(new_n111_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nor3   g092(.a(new_n136_), .b(new_n133_), .c(new_n131_), .O(new_n137_));
  inv1   g093(.a(x31), .O(new_n138_));
  nor3   g094(.a(new_n107_), .b(new_n52_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g096(.a(new_n79_), .b(x00), .O(new_n141_));
  aoi21  g097(.a(x32), .b(x25), .c(x31), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  aoi21  g100(.a(new_n127_), .b(new_n52_), .c(new_n144_), .O(z8));
  xor2a  g101(.a(new_n106_), .b(new_n138_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n108_), .O(new_n147_));
  oai21  g103(.a(new_n126_), .b(new_n123_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n48_), .O(new_n149_));
  nand2  g105(.a(new_n147_), .b(x33), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n137_), .c(new_n141_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n56_), .O(z9));
endmodule
