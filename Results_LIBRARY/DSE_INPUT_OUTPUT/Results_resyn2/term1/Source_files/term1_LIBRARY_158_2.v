...
module FAU ( 
  ...
  nand4  g026(.a(new_n48_), .b(new_n70_), .c(x25), .d(x01), .O(new_n71_));
  ...
  aoi21  g033(.a(new_n77_), .b(new_n74_), .c(new_n71_), .O(new_n78_));
  ...
  oai21  g042(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n87_));
  inv1   g043(.a(new_n71_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n57_), .O(new_n89_));
  aoi21  g045(.a(new_n87_), .b(new_n74_), .c(new_n89_), .O(new_n90_));
  inv1   g046(.a(x29), .O(new_n91_));
  nand2  g047(.a(new_n83_), .b(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n82_), .b(x29), .O(new_n93_));
  ...
  nand3  g062(.a(x19), .b(new_n45_), .c(x13), .O(new_n107_));
  ...
  nor2   g072(.a(new_n45_), .b(new_n104_), .O(new_n117_));
  ...
  nand2  g101(.a(new_n70_), .b(x00), .O(new_n146_));
  ...
  nand2  g106(.a(new_n120_), .b(new_n96_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n125_), .c(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n119_), .b(new_n116_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n54_), .O(new_n154_));
  aoi21  g110(.a(new_n45_), .b(new_n141_), .c(new_n54_), .O(new_n155_));
