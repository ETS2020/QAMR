...
module FAU ( 
  ...
  aoi21  g039(.a(new_n69_), .b(x27), .c(new_n83_), .O(z3));
  ...
  nand2  g046(.a(new_n90_), .b(new_n69_), .O(z4));
  inv1   g047(.a(x29), .O(new_n92_));
  nand2  g048(.a(new_n87_), .b(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n88_), .b(x29), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(new_n69_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n83_), .O(z5));
  and2   g053(.a(x30), .b(x29), .O(new_n98_));
  nor2   g054(.a(x30), .b(x29), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  xnor2a g056(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n82_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n69_), .O(z6));
  aoi21  g059(.a(new_n98_), .b(x27), .c(x31), .O(new_n104_));
  nand3  g060(.a(new_n98_), .b(x31), .c(x27), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x28), .O(new_n106_));
  oai22  g062(.a(new_n106_), .b(new_n104_), .c(new_n82_), .d(new_n46_), .O(z7));
  ...
  nand3  g080(.a(new_n100_), .b(new_n53_), .c(x31), .O(new_n125_));
  oai21  g081(.a(new_n118_), .b(x16), .c(x15), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  nand3  g083(.a(new_n121_), .b(x16), .c(x15), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n132_), .c(new_n129_), .d(new_n127_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x32), .O(new_n138_));
  oai21  g094(.a(new_n125_), .b(new_n124_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x28), .O(new_n140_));
  nand2  g096(.a(x32), .b(new_n45_), .O(new_n141_));
  nand2  g097(.a(new_n80_), .b(x00), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(new_n140_), .c(new_n142_), .O(z8));
  nand2  g099(.a(new_n98_), .b(x31), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n89_), .b(x31), .O(new_n146_));
  aoi21  g102(.a(new_n89_), .b(x29), .c(x30), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n124_), .c(new_n49_), .O(new_n149_));
  nand2  g105(.a(new_n132_), .b(new_n129_), .O(new_n150_));
  aoi21  g106(.a(new_n126_), .b(new_n122_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n89_), .b(x29), .O(new_n152_));
  nor2   g108(.a(x31), .b(x30), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g110(.a(new_n135_), .b(x33), .O(new_n155_));
  aoi21  g111(.a(new_n154_), .b(new_n144_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n151_), .c(new_n142_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n149_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n69_), .O(z9));
endmodule
