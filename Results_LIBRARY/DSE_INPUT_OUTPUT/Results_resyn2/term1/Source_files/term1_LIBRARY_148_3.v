...
module FAU ( 
  ...
  nand3  g023(.a(new_n45_), .b(new_n67_), .c(x08), .O(new_n68_));
  ...
  oai21  g040(.a(new_n84_), .b(new_n80_), .c(new_n45_), .O(z3));
  ...
  oai21  g046(.a(new_n90_), .b(new_n80_), .c(new_n45_), .O(z4));
  ...
  oai21  g051(.a(new_n95_), .b(new_n80_), .c(new_n45_), .O(z5));
  inv1   g052(.a(x30), .O(new_n97_));
  nand2  g053(.a(new_n94_), .b(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n83_), .b(new_n79_), .c(new_n60_), .d(new_n45_), .O(new_n99_));
  ...
  nand2  g059(.a(new_n100_), .b(new_n103_), .O(z7));
  inv1   g060(.a(x00), .O(new_n105_));
  nor2   g061(.a(x26), .b(new_n105_), .O(new_n106_));
  ...
  nand3  g067(.a(x19), .b(new_n73_), .c(x13), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n109_), .O(new_n113_));
  ...
  nor3   g078(.a(new_n122_), .b(new_n110_), .c(x15), .O(new_n123_));
  nand2  g079(.a(new_n87_), .b(x29), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n97_), .c(new_n103_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(z0), .O(new_n126_));
  ...
  nand2  g085(.a(new_n129_), .b(new_n122_), .O(new_n130_));
  nand4  g086(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n131_));
  aoi21  g087(.a(new_n110_), .b(x14), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(new_n110_), .c(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g090(.a(x18), .b(x12), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n109_), .O(new_n136_));
  inv1   g092(.a(x13), .O(new_n137_));
  nand2  g093(.a(new_n73_), .b(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n136_), .c(new_n125_), .O(new_n139_));
  nor2   g095(.a(new_n46_), .b(new_n53_), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(new_n134_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n128_), .c(new_n107_), .O(z8));
  nand2  g098(.a(new_n49_), .b(new_n103_), .O(new_n143_));
  aoi21  g099(.a(new_n87_), .b(x29), .c(new_n143_), .O(new_n144_));
  oai21  g100(.a(new_n123_), .b(new_n121_), .c(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n138_), .b(new_n136_), .c(new_n124_), .d(new_n103_), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n133_), .c(new_n130_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(x33), .c(x30), .O(new_n149_));
  oai21  g105(.a(new_n49_), .b(x29), .c(x30), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n106_), .O(new_n151_));
  aoi21  g107(.a(new_n149_), .b(new_n145_), .c(new_n151_), .O(z9));
endmodule
