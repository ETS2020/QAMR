...
module FAU ( 
  ...
  nand3  g016(.a(new_n60_), .b(x06), .c(new_n58_), .O(new_n61_));
  nand2  g017(.a(x06), .b(new_n58_), .O(new_n62_));
  nand3  g018(.a(new_n62_), .b(x05), .c(new_n59_), .O(new_n63_));
  nand3  g019(.a(new_n63_), .b(new_n61_), .c(new_n55_), .O(new_n64_));
  and2   g020(.a(new_n64_), .b(new_n57_), .O(new_n65_));
  xor2a  g021(.a(x07), .b(x04), .O(new_n66_));
  nor2   g022(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g023(.a(new_n66_), .b(new_n65_), .O(new_n68_));
  nand3  g024(.a(new_n68_), .b(new_n45_), .c(x08), .O(new_n69_));
  oai21  g025(.a(new_n69_), .b(new_n67_), .c(new_n48_), .O(z2));
  ...
  aoi21  g058(.a(new_n95_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n48_), .O(z6));
  oai21  g061(.a(new_n101_), .b(x09), .c(x31), .O(new_n106_));
  nand2  g062(.a(new_n102_), .b(new_n46_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n106_), .c(new_n88_), .O(z7));
  ...
  nor3   g079(.a(new_n123_), .b(new_n78_), .c(x15), .O(new_n124_));
  oai21  g080(.a(x28), .b(x27), .c(x29), .O(new_n125_));
  xor2a  g081(.a(new_n125_), .b(x30), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n46_), .O(new_n127_));
  ...
  nand2  g088(.a(new_n78_), .b(x14), .O(new_n133_));
  ...
  nand2  g093(.a(new_n134_), .b(new_n78_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(new_n136_), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n132_), .O(new_n140_));
  nor2   g096(.a(new_n126_), .b(new_n52_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(x09), .O(new_n142_));
  nand2  g098(.a(new_n72_), .b(x00), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  oai21  g100(.a(new_n142_), .b(new_n46_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n128_), .b(new_n52_), .c(new_n145_), .O(z8));
