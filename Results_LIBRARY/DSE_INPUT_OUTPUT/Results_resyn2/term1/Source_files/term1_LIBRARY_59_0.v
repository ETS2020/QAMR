...
module FAU ( 
  ...
  nand3  g042(.a(new_n86_), .b(new_n56_), .c(new_n71_), .O(new_n87_));
  ...
  nor2   g047(.a(x28), .b(x27), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n85_), .c(new_n56_), .O(z4));
  inv1   g051(.a(x29), .O(new_n96_));
  xor2a  g052(.a(new_n90_), .b(new_n96_), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n85_), .c(new_n56_), .O(z5));
  nor2   g054(.a(new_n90_), .b(x30), .O(new_n99_));
  nand2  g055(.a(new_n90_), .b(x30), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(x29), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n56_), .O(z6));
  oai21  g060(.a(new_n85_), .b(x31), .c(x30), .O(new_n105_));
  nand3  g061(.a(new_n90_), .b(x30), .c(x29), .O(new_n106_));
  nor2   g062(.a(new_n100_), .b(x31), .O(new_n107_));
  aoi21  g063(.a(new_n106_), .b(x31), .c(new_n107_), .O(new_n108_));
  aoi22  g064(.a(new_n108_), .b(new_n86_), .c(new_n105_), .d(new_n96_), .O(z7));
  nand2  g065(.a(new_n82_), .b(x00), .O(new_n110_));
  inv1   g066(.a(x15), .O(new_n111_));
  inv1   g067(.a(x17), .O(new_n112_));
  nand3  g068(.a(new_n75_), .b(x18), .c(x14), .O(new_n113_));
  ...
  oai21  g082(.a(new_n92_), .b(new_n96_), .c(x30), .O(new_n127_));
  inv1   g083(.a(x30), .O(new_n128_));
  nand3  g084(.a(new_n93_), .b(new_n128_), .c(x29), .O(new_n129_));
  nand2  g085(.a(new_n52_), .b(x31), .O(new_n130_));
  aoi21  g086(.a(new_n129_), .b(new_n127_), .c(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n126_), .b(new_n124_), .c(new_n131_), .O(new_n132_));
  nand4  g088(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand3  g090(.a(x18), .b(x17), .c(x11), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n120_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(x19), .c(new_n134_), .O(new_n137_));
  ...
  nand2  g097(.a(new_n75_), .b(x14), .O(new_n142_));
  nand2  g098(.a(new_n134_), .b(new_n142_), .O(new_n143_));
  nand4  g099(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n111_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n143_), .c(new_n141_), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n138_), .O(new_n148_));
  xor2a  g104(.a(new_n92_), .b(new_n128_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n96_), .c(x31), .O(new_n150_));
  nor2   g106(.a(new_n45_), .b(new_n52_), .O(new_n151_));
  oai21  g107(.a(new_n150_), .b(new_n148_), .c(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n132_), .c(new_n110_), .O(z8));
  oai21  g109(.a(new_n146_), .b(new_n137_), .c(new_n56_), .O(new_n154_));
  inv1   g110(.a(x31), .O(new_n155_));
  nand2  g111(.a(new_n92_), .b(new_n155_), .O(new_n156_));
  nor2   g112(.a(x30), .b(new_n96_), .O(new_n157_));
  nand2  g113(.a(new_n155_), .b(x30), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n127_), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n154_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x33), .O(new_n162_));
  nand2  g118(.a(new_n93_), .b(x30), .O(new_n163_));
  nand3  g119(.a(new_n158_), .b(new_n48_), .c(x29), .O(new_n164_));
  aoi21  g120(.a(new_n156_), .b(new_n163_), .c(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n126_), .b(new_n124_), .c(new_n165_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n162_), .c(new_n110_), .O(z9));
endmodule
