...
module FAU ( 
  ...
  nand2  g038(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  ...
  nand3  g046(.a(new_n90_), .b(new_n89_), .c(new_n82_), .O(new_n91_));
  ...
  xor2a  g054(.a(new_n95_), .b(new_n98_), .O(new_n99_));
  ...
  aoi21  g059(.a(new_n95_), .b(x31), .c(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n84_), .O(z7));
  nand2  g061(.a(new_n80_), .b(x00), .O(new_n106_));
  nand3  g062(.a(x18), .b(x17), .c(x16), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x19), .c(x10), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  oai21  g066(.a(x28), .b(x27), .c(x29), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(x30), .c(x31), .O(new_n113_));
  aoi21  g069(.a(new_n112_), .b(x30), .c(new_n113_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n110_), .c(x15), .O(new_n115_));
  inv1   g071(.a(x19), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x14), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n108_), .c(x15), .O(new_n118_));
  inv1   g074(.a(x16), .O(new_n119_));
  nand3  g075(.a(x18), .b(x17), .c(x11), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(new_n119_), .c(new_n107_), .d(new_n116_), .O(new_n121_));
  and2   g077(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand2  g078(.a(x17), .b(x13), .O(new_n123_));
  oai21  g079(.a(x17), .b(x12), .c(x18), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n114_), .O(new_n126_));
  and2   g082(.a(new_n126_), .b(x06), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n115_), .c(x32), .O(new_n128_));
  nor2   g084(.a(new_n109_), .b(x15), .O(new_n129_));
  ...
  nand3  g095(.a(new_n139_), .b(x19), .c(new_n119_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x15), .c(x06), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n130_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n114_), .c(new_n54_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n128_), .c(new_n106_), .O(z8));
  nand2  g101(.a(x33), .b(x30), .O(new_n146_));
  nor3   g102(.a(x33), .b(x31), .c(x30), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n110_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n146_), .c(x15), .O(new_n149_));
  inv1   g105(.a(x06), .O(new_n150_));
  nand3  g106(.a(new_n147_), .b(new_n141_), .c(x15), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n146_), .c(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n149_), .c(new_n111_), .O(new_n153_));
  nand2  g109(.a(new_n110_), .b(new_n102_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n45_), .O(new_n155_));
  nand3  g111(.a(new_n125_), .b(new_n122_), .c(new_n102_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x06), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n155_), .c(new_n50_), .O(new_n158_));
  inv1   g114(.a(x31), .O(new_n159_));
  nor3   g115(.a(x33), .b(new_n159_), .c(new_n98_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nor3   g117(.a(new_n46_), .b(new_n50_), .c(x30), .O(new_n162_));
  aoi21  g118(.a(new_n160_), .b(new_n129_), .c(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n161_), .b(new_n142_), .c(new_n163_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n112_), .c(new_n158_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n153_), .c(new_n106_), .O(z9));
endmodule
