...
module FAU ( 
  ...
  nand3  g041(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(new_n86_));
  ...
  oai21  g048(.a(new_n88_), .b(new_n69_), .c(new_n45_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n80_), .d(x28), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z6));
  inv1   g051(.a(x31), .O(new_n96_));
  nand2  g052(.a(new_n92_), .b(new_n96_), .O(new_n97_));
  nand3  g053(.a(x31), .b(x30), .c(x29), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n69_), .c(new_n97_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n80_), .c(new_n46_), .O(z7));
  nand2  g056(.a(new_n78_), .b(x00), .O(new_n101_));
  nand2  g057(.a(x32), .b(new_n69_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  ...
  aoi21  g075(.a(x30), .b(x29), .c(new_n96_), .O(new_n120_));
  oai21  g076(.a(x30), .b(x29), .c(new_n120_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n119_), .c(x32), .O(new_n122_));
  inv1   g078(.a(x17), .O(new_n123_));
  nand3  g079(.a(new_n115_), .b(x18), .c(x14), .O(new_n124_));
  ...
  nand3  g087(.a(new_n108_), .b(x19), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nor3   g089(.a(new_n117_), .b(new_n115_), .c(x15), .O(new_n134_));
  aoi21  g090(.a(new_n133_), .b(x15), .c(new_n134_), .O(new_n135_));
  aoi21  g091(.a(new_n85_), .b(x29), .c(x30), .O(new_n136_));
  nand2  g092(.a(new_n120_), .b(new_n53_), .O(new_n137_));
  or2    g093(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n135_), .c(new_n122_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n105_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n104_), .O(z8));
  inv1   g097(.a(new_n98_), .O(new_n142_));
  aoi21  g098(.a(new_n136_), .b(new_n96_), .c(new_n142_), .O(new_n143_));
  nor2   g099(.a(new_n46_), .b(new_n49_), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(new_n119_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n132_), .b(new_n130_), .c(new_n114_), .O(new_n146_));
  nand2  g102(.a(new_n136_), .b(new_n96_), .O(new_n147_));
  nand2  g103(.a(new_n142_), .b(x28), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(x33), .O(new_n149_));
  oai21  g105(.a(new_n134_), .b(new_n146_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n145_), .c(new_n101_), .O(z9));
endmodule
