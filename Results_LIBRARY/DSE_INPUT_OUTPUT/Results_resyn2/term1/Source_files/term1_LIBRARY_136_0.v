...
module FAU ( 
  ...
  inv1   g034(.a(x00), .O(new_n79_));
  nand2  g035(.a(new_n58_), .b(x25), .O(new_n80_));
  nor3   g036(.a(new_n80_), .b(x26), .c(new_n79_), .O(new_n81_));
  ...
  nand2  g043(.a(new_n85_), .b(new_n68_), .O(new_n88_));
  ...
  nand4  g050(.a(new_n94_), .b(new_n93_), .c(new_n91_), .d(new_n78_), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(x00), .c(x26), .O(z5));
  nand3  g052(.a(new_n86_), .b(x30), .c(x29), .O(new_n97_));
  inv1   g053(.a(x30), .O(new_n98_));
  nand2  g054(.a(new_n94_), .b(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n97_), .c(new_n82_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  xor2a  g057(.a(new_n97_), .b(x31), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n82_), .O(z7));
  ...
  aoi21  g084(.a(new_n85_), .b(new_n68_), .c(new_n92_), .O(new_n129_));
  aoi21  g085(.a(new_n52_), .b(new_n98_), .c(new_n129_), .O(new_n130_));
