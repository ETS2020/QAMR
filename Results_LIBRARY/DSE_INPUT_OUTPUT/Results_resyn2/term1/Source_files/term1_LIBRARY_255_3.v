...
module FAU ( 
  ...
  aoi21  g000(.a(x26), .b(x07), .c(x32), .O(z0));
  nand2  g001(.a(x26), .b(x07), .O(new_n46_));
  ...
  nand2  g008(.a(new_n52_), .b(new_n47_), .O(new_n53_));
  inv1   g009(.a(x33), .O(new_n54_));
  inv1   g010(.a(new_n52_), .O(new_n55_));
  nand2  g011(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand3  g012(.a(new_n56_), .b(new_n53_), .c(new_n46_), .O(z1));
  ...
  aoi21  g107(.a(new_n104_), .b(new_n138_), .c(new_n54_), .O(new_n152_));
