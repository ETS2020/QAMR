...
module FAU ( 
  ...
  aoi21  g085(.a(new_n55_), .b(x30), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g087(.a(new_n127_), .b(x30), .O(new_n132_));
  aoi22  g088(.a(new_n92_), .b(x29), .c(new_n55_), .d(new_n100_), .O(new_n133_));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n131_), .c(new_n45_), .O(z8));
  aoi21  g106(.a(x31), .b(x30), .c(new_n129_), .O(new_n151_));
  nand2  g107(.a(new_n125_), .b(new_n100_), .O(new_n152_));
  ...
  nor2   g111(.a(x26), .b(new_n45_), .O(new_n156_));
  oai21  g112(.a(new_n155_), .b(new_n141_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n154_), .b(new_n51_), .c(new_n157_), .O(z9));
endmodule
