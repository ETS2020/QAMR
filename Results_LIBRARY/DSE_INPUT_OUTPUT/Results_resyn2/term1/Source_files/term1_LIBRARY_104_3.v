...
module FAU ( 
  ...
  nand2  g046(.a(new_n90_), .b(new_n48_), .O(z5));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n123_), .c(new_n45_), .O(z8));
  inv1   g098(.a(x33), .O(new_n143_));
  aoi21  g099(.a(x31), .b(x30), .c(new_n121_), .O(new_n144_));
  nand2  g100(.a(new_n117_), .b(new_n93_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n121_), .c(new_n144_), .O(new_n146_));
  oai21  g102(.a(new_n116_), .b(new_n113_), .c(new_n146_), .O(new_n147_));
  nand4  g103(.a(new_n146_), .b(new_n137_), .c(new_n135_), .d(x33), .O(new_n148_));
  nor2   g104(.a(x26), .b(new_n45_), .O(new_n149_));
  oai21  g105(.a(new_n148_), .b(new_n133_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n147_), .b(new_n143_), .c(new_n150_), .O(z9));
endmodule
