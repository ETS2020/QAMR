...
module FAU ( 
  ...
  nand3  g040(.a(new_n84_), .b(new_n48_), .c(new_n74_), .O(new_n85_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n84_), .d(new_n48_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z5));
  inv1   g053(.a(new_n95_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(x30), .O(new_n99_));
  nand2  g055(.a(x33), .b(x30), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n95_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n84_), .O(new_n102_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n104_), .c(new_n84_), .d(new_n48_), .O(z7));
  inv1   g064(.a(x17), .O(new_n109_));
  inv1   g065(.a(x18), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x16), .c(x15), .O(new_n112_));
  nand3  g068(.a(x18), .b(x17), .c(x11), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(x16), .c(x19), .O(new_n115_));
  inv1   g071(.a(x15), .O(new_n116_));
  nand3  g072(.a(new_n111_), .b(x16), .c(x10), .O(new_n117_));
  ...
  aoi21  g077(.a(new_n115_), .b(new_n112_), .c(new_n121_), .O(new_n122_));
  inv1   g078(.a(new_n112_), .O(new_n123_));
  inv1   g079(.a(x19), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x14), .O(new_n125_));
  oai21  g081(.a(x18), .b(x13), .c(x31), .O(new_n126_));
  aoi21  g082(.a(new_n125_), .b(new_n123_), .c(new_n126_), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n122_), .c(new_n46_), .O(new_n128_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n128_), .c(x32), .O(new_n132_));
  nand3  g088(.a(new_n124_), .b(x18), .c(x14), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n110_), .c(x13), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n109_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x18), .c(new_n109_), .d(x12), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(x16), .O(new_n138_));
  inv1   g094(.a(x16), .O(new_n139_));
  nand3  g095(.a(new_n114_), .b(x19), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nor3   g097(.a(new_n117_), .b(new_n124_), .c(x15), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(x15), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n129_), .b(new_n100_), .O(new_n144_));
  nand3  g100(.a(new_n90_), .b(x30), .c(x29), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n50_), .d(x31), .O(new_n146_));
  or2    g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g103(.a(new_n82_), .b(x00), .O(new_n148_));
  aoi21  g104(.a(new_n147_), .b(new_n132_), .c(new_n148_), .O(z8));
  nand3  g105(.a(new_n53_), .b(new_n105_), .c(new_n45_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n143_), .c(new_n100_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n129_), .O(new_n152_));
  inv1   g108(.a(new_n122_), .O(new_n153_));
  nand2  g109(.a(new_n125_), .b(new_n123_), .O(new_n154_));
  nand2  g110(.a(new_n130_), .b(new_n105_), .O(new_n155_));
  inv1   g111(.a(x13), .O(new_n156_));
  aoi22  g112(.a(x31), .b(new_n45_), .c(new_n110_), .d(new_n156_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n155_), .c(new_n154_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n153_), .c(x33), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n152_), .c(new_n148_), .O(z9));
endmodule
