...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x01), .O(new_n45_));
  ...
  inv1   g011(.a(x18), .O(new_n56_));
  nand2  g012(.a(x03), .b(x02), .O(new_n57_));
  nand2  g013(.a(new_n47_), .b(new_n49_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n57_), .c(x01), .O(new_n59_));
  inv1   g015(.a(x01), .O(new_n60_));
  nand2  g016(.a(x05), .b(new_n47_), .O(new_n61_));
  nand3  g017(.a(new_n61_), .b(x06), .c(new_n49_), .O(new_n62_));
  ...
  oai21  g021(.a(new_n65_), .b(new_n56_), .c(new_n59_), .O(new_n66_));
  xnor2a g022(.a(x07), .b(x04), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  inv1   g025(.a(new_n45_), .O(new_n70_));
  nand4  g026(.a(new_n67_), .b(new_n65_), .c(new_n59_), .d(new_n70_), .O(new_n71_));
  inv1   g027(.a(x09), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(x08), .O(new_n73_));
  aoi21  g029(.a(new_n71_), .b(new_n69_), .c(new_n73_), .O(z2));
  ...
  nand3  g043(.a(new_n87_), .b(new_n85_), .c(new_n75_), .O(new_n88_));
  ...
  nand2  g057(.a(new_n80_), .b(new_n60_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n85_), .c(new_n101_), .d(x25), .O(new_n103_));
  nand3  g059(.a(new_n91_), .b(x30), .c(x29), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nand2  g061(.a(new_n98_), .b(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n103_), .c(new_n70_), .O(z6));
  inv1   g064(.a(new_n103_), .O(new_n109_));
  xor2a  g065(.a(new_n104_), .b(x31), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n45_), .O(z7));
  ...
  nand3  g071(.a(x19), .b(new_n56_), .c(x13), .O(new_n116_));
  ...
  nor2   g081(.a(new_n56_), .b(new_n113_), .O(new_n126_));
  ...
  nand2  g105(.a(new_n56_), .b(new_n149_), .O(new_n150_));
  ...
  aoi21  g118(.a(new_n56_), .b(new_n149_), .c(new_n48_), .O(new_n163_));
  ...
  nand2  g121(.a(new_n165_), .b(new_n70_), .O(z9));
endmodule
