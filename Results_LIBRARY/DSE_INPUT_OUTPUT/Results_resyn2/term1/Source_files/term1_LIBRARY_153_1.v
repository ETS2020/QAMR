...
module FAU ( 
  ...
  nand4  g038(.a(new_n82_), .b(new_n59_), .c(new_n72_), .d(x25), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(new_n45_), .c(x27), .O(z3));
  ...
  oai21  g045(.a(new_n89_), .b(new_n83_), .c(new_n57_), .O(z4));
  nor2   g046(.a(new_n45_), .b(new_n87_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n85_), .b(new_n45_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n83_), .c(new_n57_), .O(z5));
  ...
  oai21  g055(.a(new_n99_), .b(new_n83_), .c(new_n57_), .O(z6));
  nand2  g056(.a(new_n83_), .b(new_n57_), .O(new_n101_));
  inv1   g057(.a(x31), .O(new_n102_));
  nand2  g058(.a(new_n98_), .b(new_n102_), .O(new_n103_));
  nor2   g059(.a(new_n102_), .b(new_n96_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(x28), .c(new_n86_), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(new_n103_), .c(x31), .d(new_n45_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n101_), .O(z7));
  xnor2a g063(.a(x30), .b(x29), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n102_), .O(new_n109_));
  ...
  nor3   g081(.a(new_n125_), .b(new_n76_), .c(x15), .O(new_n126_));
  aoi21  g082(.a(new_n123_), .b(x15), .c(new_n126_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n110_), .c(new_n53_), .O(new_n128_));
  nand2  g084(.a(new_n72_), .b(x00), .O(new_n129_));
  ...
  nand2  g095(.a(new_n137_), .b(new_n76_), .O(new_n140_));
  ...
  nand2  g102(.a(new_n146_), .b(new_n57_), .O(z8));
  nor3   g103(.a(x31), .b(x30), .c(x29), .O(new_n148_));
  aoi21  g104(.a(new_n104_), .b(x29), .c(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n127_), .c(new_n49_), .O(new_n150_));
  nor2   g106(.a(new_n149_), .b(new_n49_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n142_), .c(new_n129_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n57_), .O(z9));
endmodule
