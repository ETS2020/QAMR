...
module FAU ( 
  ...
  oai21  g027(.a(x24), .b(x19), .c(new_n71_), .O(new_n72_));
  ...
  oai21  g032(.a(new_n76_), .b(x27), .c(new_n57_), .O(z3));
  inv1   g033(.a(x19), .O(new_n78_));
  oai21  g034(.a(x27), .b(new_n45_), .c(new_n78_), .O(new_n79_));
  ...
  aoi21  g040(.a(new_n84_), .b(new_n45_), .c(new_n83_), .O(new_n85_));
  nand3  g041(.a(new_n85_), .b(new_n80_), .c(new_n75_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n57_), .O(z4));
  inv1   g043(.a(new_n76_), .O(new_n88_));
  inv1   g044(.a(x29), .O(new_n89_));
  inv1   g045(.a(new_n83_), .O(new_n90_));
  aoi21  g046(.a(new_n90_), .b(new_n57_), .c(new_n89_), .O(new_n91_));
  ...
  nand2  g051(.a(x29), .b(x27), .O(new_n96_));
  aoi21  g052(.a(new_n82_), .b(new_n45_), .c(new_n96_), .O(new_n97_));
  xor2a  g053(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n76_), .c(new_n57_), .O(z6));
  nor2   g055(.a(new_n95_), .b(new_n89_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n83_), .O(new_n101_));
  oai21  g057(.a(new_n46_), .b(x31), .c(new_n101_), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  nand3  g059(.a(new_n100_), .b(new_n83_), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n102_), .c(new_n88_), .O(z7));
  inv1   g061(.a(x15), .O(new_n106_));
  inv1   g062(.a(x17), .O(new_n107_));
  nand3  g063(.a(new_n78_), .b(x18), .c(x14), .O(new_n108_));
  ...
  nor3   g077(.a(new_n121_), .b(new_n78_), .c(x15), .O(new_n122_));
  nor2   g078(.a(x32), .b(new_n103_), .O(new_n123_));
  ...
  aoi21  g087(.a(new_n126_), .b(new_n95_), .c(new_n131_), .O(new_n132_));
  ...
  nor3   g098(.a(new_n142_), .b(new_n141_), .c(new_n103_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n133_), .c(new_n129_), .O(new_n146_));
  nand2  g102(.a(new_n73_), .b(x00), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n57_), .O(z8));
  nor2   g106(.a(new_n122_), .b(new_n119_), .O(new_n151_));
  nor2   g107(.a(x31), .b(x30), .O(new_n152_));
  nor2   g108(.a(new_n84_), .b(new_n103_), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(new_n100_), .c(new_n152_), .d(new_n127_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n151_), .c(new_n54_), .O(new_n155_));
  nor4   g111(.a(new_n154_), .b(new_n142_), .c(new_n141_), .d(new_n54_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n140_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n155_), .c(new_n148_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n57_), .O(z9));
endmodule
